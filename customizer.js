/* Wholesaling CRM Customizer v0.5.7 — built 2026-05-16T03:41:01.602Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var w="[wholesaling-crm-customizer]",te="__WS_CRM_DEBUG",oe=()=>!!window[te],i={info(...e){console.log(w,...e)},warn(...e){console.warn(w,...e)},error(...e){console.error(w,...e)},debug(...e){oe()&&console.log(w,"[debug]",...e)}};var F=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},E="",y="other",M=new Set,k=()=>{if(window.location.pathname!==E){E=window.location.pathname,y=F(),i.debug("Page changed:",y,E);for(let e of M)try{e(y)}catch(t){i.error("Subscriber threw:",t)}}},R=e=>(M.add(e),setTimeout(()=>e(y),0),()=>{M.delete(e)}),B=()=>{y=F(),E=window.location.pathname,i.debug("Router init, current page:",y);let e=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(o,r,a){e(o,r,a),k()},history.replaceState=function(o,r,a){t(o,r,a),k()},window.addEventListener("popstate",k),setInterval(k,1e3)};var _="0.5.7",C="2026-05-16T03:41:01.603Z";var re=/\/contacts\/detail\/([A-Za-z0-9]+)/,ae=/\/v2\/location\/([A-Za-z0-9]+)/,m=()=>{let e=window.location.pathname,t=e.match(re);if(!t)return null;let o=e.match(ae);return{contactId:t[1],locationId:o?o[1]:null}};var v=(e,t={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=t;return new Promise((n,d)=>{let l=a.querySelector(e);if(l){n(l);return}let c,u,g=()=>{f&&f.disconnect(),c!==void 0&&window.clearTimeout(c),u!==void 0&&window.clearInterval(u)},f=new MutationObserver(()=>{let h=a.querySelector(e);h&&(g(),n(h))});f.observe(document.body,{childList:!0,subtree:!0}),u=window.setInterval(()=>{let h=a.querySelector(e);h&&(g(),n(h))},r),c=window.setTimeout(()=>{g(),i.warn(`waitForElement timed out for selector: ${e}`),d(new Error(`Selector not found within ${o}ms: ${e}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},b={sm:"4px",md:"6px",lg:"10px",pill:"999px"},p={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},D={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},O=e=>{let t=e==="emerald"?s.emeraldGlow:e==="amber"?s.amberGlow:s.slate,o=e==="emerald"?s.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=e==="emerald"?s.emerald:e==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var x="ws-crm-claim-release-pill",P=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ne=({contactId:e,mode:t})=>{let o=document.createElement("button");o.id=x,o.type="button",o.dataset.contactId=e,o.dataset.mode=t;let r=t==="claim"?"emerald":"amber",a=t==="claim"?s.emerald:s.amber;return o.style.cssText=O(r),o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,o.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{i.info(`Claim/Release pill clicked for contact ${e}: ${t}`);let n=o.lastElementChild,d=n?.textContent??"";n&&(n.textContent="Working\u2026"),o.style.opacity="0.7",o.disabled=!0,setTimeout(()=>{n&&(n.textContent=d),o.style.opacity="1",o.disabled=!1},700)}),o},se=async(e,t=1e4)=>{let o=Date.now();for(;Date.now()-o<t;){let r=P(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},H=(e,t)=>{let o=ne({contactId:t,mode:"claim"}),r=document.createElement("span");r.id=`${x}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),e.appendChild(r)},ie=async()=>{let e=m();if(!e){document.getElementById(x)?.remove();return}let t=document.getElementById(x);if(!(t&&t.dataset.contactId===e.contactId)){t&&t.remove();try{let o=await v("#record-details-lhs",{timeoutMs:1e4}),r=await se(o),a=m();if(!a||a.contactId!==e.contactId)return;if(!r){i.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}H(r,e.contactId),i.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(document.getElementById(x))return;let l=P(o);l&&(H(l,e.contactId),i.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(o,{childList:!0,subtree:!0})}catch(o){i.warn("Could not mount Claim/Release pill:",o)}}},N=()=>{ie()};var le="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ce=()=>{let e=window.WS_CRM_USER_ID;if(e&&/^[A-Za-z0-9]{15,30}$/.test(e))return e;let t=window,o=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let r of o)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let d=JSON.parse(n),l=d.id??d._id;if(l&&/^[A-Za-z0-9]{15,30}$/.test(l))return l}catch{}}}catch{}return null},de=async({contactId:e,locationId:t,status:o,userId:r})=>{let n=await fetch(le,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:e,location:{id:t},customData:{call_status:o,triggered_by_user_id:r??""}}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},T="ws-crm-contact-actions-bar",pe="ws-crm-call-status-dropdown",G="ws-crm-offer-made-modal",ue=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],me=[".central-panel","[class*='central-panel']"],be=async()=>{for(let e of me)try{let t=await v(e,{timeoutMs:3e3});if(t)return t}catch{}try{return(await v("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},he=e=>{let t=document.createElement("div");t.id=pe,t.style.cssText="position: relative; flex-shrink: 0;";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,ue.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=s.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{i.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let d=o.firstElementChild,l=o.children[1],c=o.children[2];d&&(d.style.background=D[a.color]),l&&(l.textContent=a.label),r.style.display="none";let g=m()?.locationId,f=ce();if(!g){i.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),l&&(l.textContent=`${a.label} (no tenant!)`),l&&(l.style.color=s.amber);return}if(a.color==="green"&&!f){i.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),l&&(l.textContent=`${a.label} (no user!)`),l&&(l.style.color=s.amber);return}let h=c?.textContent??"\u25BE";c&&(c.textContent="\u2026"),o.style.opacity="0.75";try{await de({contactId:e,locationId:g,status:a.label,userId:f}),c&&(c.textContent="\u2713"),setTimeout(()=>{c&&(c.textContent=h),o.style.opacity="1"},900)}catch(ee){i.warn("Call Status webhook failed:",ee),c&&(c.textContent="\u2717"),l&&(l.style.color=s.amber),o.style.opacity="1",setTimeout(()=>{c&&(c.textContent=h),l&&(l.style.color=s.bone)},1800)}}),r.appendChild(n)}),o.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{t.contains(a.target)||(r.style.display="none")}),t.appendChild(o),t.appendChild(r),t},ge=e=>{document.getElementById(G)?.remove();let t=document.createElement("div");t.id=G,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(o),document.body.appendChild(t);let n=()=>t.remove();t.addEventListener("click",d=>{d.target===t&&n()}),o.querySelector("#ws-offer-cancel")?.addEventListener("click",n),o.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let d=(o.querySelector("#ws-offer-amount")?.value??"").trim(),l=o.querySelector("#ws-offer-expires")?.value??"";if(!d||Number(d)<=0){i.warn("Offer Made submit blocked \u2014 invalid amount");return}i.info(`Offer Made recorded for contact ${e}: $${d}, expires ${l}`),n()}),setTimeout(()=>{o.querySelector("#ws-offer-amount")?.focus()},0)},z=e=>{let t=document.createElement("div");t.id=T,t.dataset.contactId=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    flex-shrink: 0;
  `,t.appendChild(he(e));let o=document.createElement("button");return o.type="button",o.style.cssText=A,o.textContent="Offer Made",o.addEventListener("click",()=>ge(e)),t.appendChild(o),t},fe=async()=>{let e=m();if(!e){document.getElementById(T)?.remove();return}let t=document.getElementById(T);if(t&&t.dataset.contactId===e.contactId)return;t&&t.remove();let o=await be();if(!o){i.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=m();if(!r||r.contactId!==e.contactId)return;let a=z(e.contactId);a.dataset.mountTarget=o.className||"central-panel",o.insertBefore(a,o.firstChild),i.debug(`Mounted contact actions bar for ${e.contactId}`);let n=null;n=new MutationObserver(()=>{let d=document.getElementById(T);if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(!d){let c=z(e.contactId);c.dataset.mountTarget=a.dataset.mountTarget??"",o.insertBefore(c,o.firstChild),i.debug(`Re-mounted actions bar after React wipe for ${e.contactId}`)}}),n.observe(o,{childList:!0})},U=()=>{fe()};var W="reos-theme-stylesheet",V="reos-theme-fonts",ye=()=>{if(document.getElementById(V))return;let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.googleapis.com",document.head.appendChild(e);let t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.gstatic.com",t.crossOrigin="anonymous",document.head.appendChild(t);let o=document.createElement("link");o.id=V,o.rel="stylesheet",o.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(o)},ve=`
/* ============================================
...
/* 19c-pre. EMPTY-VALUE displays \u2014 fields whose value is unset render
   their empty state in different ways depending on field type:
   - Dropdowns / text inputs: "--" placeholder INSIDE the slate input box
   - Date / monetary / numerical / datetime: "--" rendered as a separate
     element ABOVE the input, with no slate fill and inconsistent text color

   Coerce the standalone empty-value displays to LOOK like a proper field
   box (slate fill + steel border + ash text) so all field rows render
   consistently. Common class hints GHL ships: field-value / field-display
   / empty-value / field-empty / value-display. Cast wide. */
[class*="field-value"],
[class*="field-display"],
[class*="empty-value"],
[class*="field-empty"],
...
`,xe=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar__text, .hr-avatar__text p, .hr-avatar p",styles:{color:"#0A0D12"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3","background-color":"#1A1F28","border-color":"#252C36","border-style":"solid","border-width":"1px","border-radius":"4px",padding:"8px 12px","min-height":"38px",display:"flex","align-items":"center","box-sizing":"border-box"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff']",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}}],S=()=>{for(let e of xe){let t;try{t=document.querySelectorAll(e.selector)}catch{continue}t.forEach(o=>{for(let[r,a]of Object.entries(e.styles)){let n=o.style.getPropertyPriority(r),d=o.style.getPropertyValue(r);n==="important"&&d===a||o.style.setProperty(r,a,"important")}})}},K="#1A1F28",we=26,ke=31,Ee=40,q=new Set,j=new Set,L=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0||(t.textContent||"").trim()!=="--")return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;t.style.setProperty("background-color",K,"important"),t.style.setProperty("border","1px solid #252C36","important"),t.style.setProperty("border-radius","4px","important"),t.style.setProperty("padding","8px 12px","important"),t.style.setProperty("min-height","38px","important"),t.style.setProperty("display","flex","important"),t.style.setProperty("align-items","center","important"),t.style.setProperty("box-sizing","border-box","important"),t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let a=t.className?.toString()||"<no class>";!j.has(a)&&a!=="<no class>"&&(j.add(a),i.debug(`Boxed empty-state "--" placeholder: "${a}"`))})},I=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=window.getComputedStyle(t).backgroundColor;if(!o||o==="rgba(0, 0, 0, 0)"||o==="transparent")return;let r=o.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),n=parseInt(r[2],10),d=parseInt(r[3],10);if(!(a<we&&n<ke&&d<Ee))return;let c=t.getBoundingClientRect();if(c.width===0||c.height===0||c.width>800||c.height>200)return;t.style.setProperty("background-color",K,"important");let u=t.className?.toString()||"<no class>";!q.has(u)&&u!=="<no class>"&&(q.add(u),i.debug(`Coerced dark bg to slate (${c.width.toFixed(0)}x${c.height.toFixed(0)}, rgb(${a},${n},${d})): "${u}"`))})},Y=()=>{let e,t=()=>{e===void 0&&(e=window.setTimeout(()=>{e=void 0,S(),I(),L()},100))};S(),I(),L(),window.setTimeout(()=>{S(),I(),L()},500),window.setTimeout(()=>{S(),I(),L()},1500),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Z=()=>{if(ye(),!document.getElementById(W)){let e=document.createElement("style");e.id=W,e.textContent=ve,document.head.appendChild(e),i.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Y():window.addEventListener("DOMContentLoaded",Y))};var J="ws-crm-customizer-version-badge",X=()=>{if(document.getElementById(J))return;let e=document.createElement("div");e.id=J,e.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
