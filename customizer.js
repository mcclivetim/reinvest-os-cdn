/* Wholesaling CRM Customizer v0.25.3 — built 2026-06-10T02:18:21.302Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var It="[wholesaling-crm-customizer]",Pi="__WS_CRM_DEBUG",Hi=()=>!!window[Pi],p={info(...t){console.log(It,...t)},warn(...t){console.warn(It,...t)},error(...t){console.error(It,...t)},debug(...t){Hi()&&console.log(It,"[debug]",...t)}};var Fi=/\/v2\/location\/([A-Za-z0-9]+)/,Bi=new Set(["8ntUQzMflUkR0YvrRgVk"]),$e=()=>{let t=window.location.pathname.match(Fi);return t?t[1]:null},Ho=()=>{let t=$e();return t!==null&&Bi.has(t)};var hn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fo=/\/v2\/location\/([A-Za-z0-9]+)/,Ri=t=>{let e=t.match(hn);if(!e)return null;let o=t.match(Fo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Ni=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(hn);if(!a)continue;let i=r.match(Fo)||window.location.pathname.match(Fo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Ri(window.location.pathname);return t||Ni()};var mn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},$t="",Bo=null,Me="other",Ro=new Set,Lt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==$t)&&!(t!==Bo))){$t=window.location.pathname,Bo=t,Me=mn(),p.debug("Page/context changed:",Me,$t,"contact:",t);for(let r of Ro)try{r(Me)}catch(a){p.error("Subscriber threw:",a)}}},Mt=t=>(Ro.add(t),setTimeout(()=>t(Me),0),()=>{Ro.delete(t)}),un=()=>{Me=mn(),$t=window.location.pathname,Bo=P()?.contactId??null,p.debug("Router init, current page:",Me);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Lt()},history.replaceState=function(o,r,a){e(o,r,a),Lt()},window.addEventListener("popstate",Lt),setInterval(Lt,1e3)};var Ot="0.25.3",Dt="2026-06-10T02:18:21.303Z";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},No={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},vn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var zi=/^[A-Za-z0-9]{15,30}$/,Je=t=>typeof t=="string"&&zi.test(t),_n=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Gi=()=>{let t=window.WS_CRM_USER_ID;return Je(t)?t:null},qi=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Je(o))return o;return null},Ui=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);if(!o)return null;let r=o.uid;if(Je(r))return r;let a=o.claims;if(a&&Je(a.user_id))return a.user_id}catch{}return null},Vi=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Je(a))return a}catch{}}}catch{}return null},L=()=>Gi()||qi()||Ui()||Vi()||null,Wi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);return o?o.claims??o:null}catch{return null}},yn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Wi()?.type==="agency"};var xn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ji=`${xn}/active-follow-up-get`,Ki=`${xn}/active-follow-up-set`,we="ws-crm-active-follow-up-button",Go={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Yi=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ji=async t=>{let e=await fetch(ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xi=async(t,e)=>{let o=await fetch(Ki,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},xe=(t,e)=>{let o=Go[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},gn=t=>{let e=document.createElement("button");return e.type="button",e.id=we,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,xe(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Yi();if(!(!r||r.contactId!==t)){xe(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Xi(r,L()),i=a&&a.state&&a.state in Go?a.state:"blue";xe(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),xe(e,"error"),setTimeout(()=>void Pt(e,r),4e3)}}}),e},Pt=async(t,e)=>{xe(t,"loading");try{let o=await Ji(e),r=o&&o.state&&o.state in Go?o.state:"gray",a=document.getElementById(we);if(!a||a.dataset.contactId!==e.contactId)return;xe(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),xe(t,"error")}},Qi=[".central-panel","[class*='central-panel']"],zo="ws-crm-contact-actions-bar",Zi=async()=>{for(let t of Qi)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},es=async(t,e)=>{let o=e.querySelector(`#${zo}`);if(!o)try{o=await M(`#${zo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${zo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},ts=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},os=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},rs=async t=>{if(t==="url"){let o=await Zi();return o?{kind:"contact-detail",target:o}:null}let e=ts();return e?{kind:"conversations",target:e}:null},fn=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await es(t,e.target);return o}return os(t,e.target),"conversations-header"},ns=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(we)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(we);if(o&&o.dataset.contactId===e.contactId){Pt(o,e);return}o&&o.remove();let r=await rs(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=gn(e.contactId),s=await fn(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),wn();let l=document.getElementById(we)??i;Pt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(we);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=gn(e.contactId);fn(m,r).then(()=>{wn(),Pt(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Xe=null,kn=()=>{let t=P()?.contactId??null;if(Xe&&Xe.contactId===t)return;let e=ns().finally(()=>{Xe?.promise===e&&(Xe=null)});Xe={contactId:t,promise:e}},wn=()=>{let t=document.querySelectorAll(`#${we}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var as="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Qe=new Map,Ht=async(t,e)=>{if(!t)return null;if(Qe.has(t))return Qe.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${as}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),Qe.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Qe.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),Qe.set(t,null),null}};var Ft=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var Sn="ws-buybox-nav-icon",Vo="ws-buybox-panel",En="ws-buybox-modal",is="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Wo="https://mcclivetim.github.io/reinvest-os-cdn/geo",Bt=null,Ze=null,et=null,Uo=async()=>{if(Bt)return Bt;try{let t=await fetch(`${Wo}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Bt=await t.json(),Bt}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},ss=async t=>{if(!Ze)try{let e=await fetch(`${Wo}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Ze=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return Ze?.[t]??[]},ls=async t=>{if(!et)try{let e=await fetch(`${Wo}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);et=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return et?.[t]??[]},jo=async t=>await(await fetch(is,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ds=(t,e)=>jo({tenant_id:t,action:"list",buyer_contact_id:e}),cs=(t,e,o,r)=>jo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),ps=(t,e)=>jo({tenant_id:t,action:"remove",entry_id:e}),B=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),bs=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},hs='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',ms='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',us="nav.w-13, nav[class*='w-13']",vs=".flex-1.h-full.relative.overflow-hidden.rounded-lg",_s=async()=>{try{return await M(us,{timeoutMs:2500})}catch{return null}},ys=async()=>{try{return await M(vs,{timeoutMs:2500})}catch{return null}},gs=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,fs=(t,e)=>{let o=document.createElement("div");return o.id=Vo,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Es(t,e,()=>Ko(t,e))}),o},Ko=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ds(t,e),Uo()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${B(r.error||"Failed to load buy-box entries")}</div>`;return}ws(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${B(r.message)}</div>`}},ws=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?bs(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,ps(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}Ko(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Rt=!1,An=(t,e)=>{Rt=e;let o=gs(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=xs,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Ko(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Cn,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Cn="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",xs="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",ks=t=>{let e=document.createElement("button");return e.id=Sn,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Cn,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${hs.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Rt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),An(r,a)}),e},Es=(t,e,o)=>{let r=document.getElementById(En);r&&r.remove();let a=document.createElement("div");a.id=En,a.style.cssText=`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let H=await cs(t,e,s.granularity,g);if(!H.ok){T&&(T.textContent=H.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(H){T&&(T.textContent=`Network error: ${H.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},qo=!1,Oe=null,tt=null,Tn=()=>{document.getElementById(Sn)?.remove(),document.getElementById(Vo)?.remove(),tt&&Oe&&Oe.nav.removeEventListener("click",tt,!0),tt=null,Oe=null,Rt=!1},In=()=>{Ts()},Ts=async()=>{if(!qo){qo=!0;try{let t=P();if(!t){Tn();return}let e=document.getElementById(Vo);if(e&&e.dataset.buyerContactId===t.contactId&&Oe)return;Tn();let o=null;try{o=await Ht(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Ft(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([_s(),ys()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=fs(t.locationId,t.contactId),d=ks(()=>Oe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Oe=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),tt=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Rt&&An(c,!1)},a.addEventListener("click",tt,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{qo=!1}}};var me="ws-crm-claim-release-pill",Ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",As="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Cs=async t=>{let e=await fetch(Ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Is=async t=>{let e=await fetch(As,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Mn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},De=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=vn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Ut();!o||!o.locationId||o.oppId!==t||nl({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=D)},4e3)}})}),e},il=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],sl=async()=>{for(let t of il)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qt=!1,er=async()=>{if(!qt){qt=!0;try{await ll()}finally{qt=!1}}},ll=async()=>{let t=Ut();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),nt();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),nt());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=await sl();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ut();if(!a||a.oppId!==t.oppId)return;let i=al(t.oppId),s=document.createElement("span");s.id=`${oe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),dl(t.oppId)},rt=null,Zo=null,nt=()=>{rt?.disconnect(),rt=null,Zo=null},dl=t=>{if(rt&&Zo===t)return;nt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zo=t,rt=new MutationObserver(()=>{let o=Ut();if(!o||o.oppId!==t){nt();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),nt();return}document.getElementById(oe)||er()}),rt.observe(e,{childList:!0,subtree:!0}))},Xo=null,Qo,cl=()=>{Xo||(Xo=new MutationObserver(()=>{Qo===void 0&&(Qo=window.setTimeout(()=>{Qo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!qt&&er()},300))}),Xo.observe(document.body,{childList:!0,subtree:!0}))},Wn=()=>{cl(),er()};var pl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",re="ws-crm-not-interested-button",bl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hl=/\/v2\/location\/([A-Za-z0-9]+)/,Wt=()=>{let t=window.location.pathname,e=t.match(bl);if(!e)return null;let o=t.match(hl);return{oppId:e[1],locationId:o?o[1]:null}},ml=async t=>{let e=await fetch(pl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},ul=t=>{let e=document.createElement("button");return e.id=re,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Wt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await ml({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},vl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_l=async()=>{for(let t of vl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vt=!1,nr=async()=>{if(!Vt){Vt=!0;try{await yl()}finally{Vt=!1}}},yl=async()=>{let t=Wt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),it();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),it());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await _l();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Wt();if(!a||a.oppId!==t.oppId)return;let i=ul(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    ...
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),gl(t.oppId)},at=null,rr=null,it=()=>{at?.disconnect(),at=null,rr=null},gl=t=>{if(at&&rr===t)return;it();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(rr=t,at=new MutationObserver(()=>{let o=Wt();if(!o||o.oppId!==t){it();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),it();return}document.getElementById(re)||nr()}),at.observe(e,{childList:!0,subtree:!0}))},tr=null,or,fl=()=>{tr||(tr=new MutationObserver(()=>{or===void 0&&(or=window.setTimeout(()=>{or=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!Vt&&nr()},300))}),tr.observe(document.body,{childList:!0,subtree:!0}))},jn=()=>{fl(),nr()};var wl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",He="ws-crm-resend-deal-link-wrap",xl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kl=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(xl);if(!e)return null;let o=t.match(kl);return{oppId:e[1],locationId:o?o[1]:null}},El=async t=>{let e=await fetch(wl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Tl=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Kn=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,lr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=D,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Kn(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Sl(t,e)),t.appendChild(o)},Sl=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Al(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>lr(t,e)),o.appendChild(s),t.appendChild(o)},Al=async(t,e,o,r)=>{let a=Kt();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await El({oppId:a.oppId,locationId:a.locationId,channel:o,userId:L()});if(i?.ok)r.innerHTML=`${Kn(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Tl(s)}</span>`}window.setTimeout(()=>lr(t,e),3500)}},Cl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Il=async()=>{for(let t of Cl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},jt=!1,dr=async()=>{if(!jt){jt=!0;try{await Ll()}finally{jt=!1}}},Ll=async()=>{let t=Kt();if(!t||!t.locationId){document.getElementById(He)?.remove(),lt();return}let e=document.getElementById(He);if(e&&e.dataset.oppId===t.oppId){let s=O();s!==null&&s!=="Marketing Tracker"&&(e.remove(),lt());return}e&&e.remove();let o=await Il();if(!o)return;let r=await U();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Kt();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=He,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),lr(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),$l(t.oppId)},st=null,sr=null,lt=()=>{st?.disconnect(),st=null,sr=null},$l=t=>{if(st&&sr===t)return;lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(sr=t,st=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t){lt();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(He)?.remove(),lt();return}document.getElementById(He)||dr()}),st.observe(e,{childList:!0,subtree:!0}))},ar=null,ir,Ml=()=>{ar||(ar=new MutationObserver(()=>{ir===void 0&&(ir=window.setTimeout(()=>{ir=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(He)&&!jt&&dr()},300))}),ar.observe(document.body,{childList:!0,subtree:!0}))},Yn=()=>{Ml(),dr()};var Jn="ws-crm-dispo-action-row",Fe=t=>{let e=document.getElementById(Jn);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Jn,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Ol="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ne="ws-crm-reduce-price-button",Xn="ws-crm-reduce-price-modal",Dl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Pl=/\/v2\/location\/([A-Za-z0-9]+)/,Xt=()=>{let t=window.location.pathname,e=t.match(Dl);if(!e)return null;let o=t.match(Pl);return{oppId:e[1],locationId:o?o[1]:null}},Hl=async t=>{let e=await fetch(Ol,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Yt=()=>{document.getElementById(Xn)?.remove()},Fl=t=>{Yt();let e=document.createElement("div");e.id=Xn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Xt();!r||!r.locationId||r.oppId!==t||Fl({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=D,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Rl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Nl=async()=>{for(let t of Rl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Jt=!1,hr=async()=>{if(!Jt){Jt=!0;try{await zl()}finally{Jt=!1}}},zl=async()=>{let t=Xt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),ct();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),ct());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await Nl();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Xt();if(!a||a.oppId!==t.oppId)return;let i=Bl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Fe(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Gl(t.oppId)},dt=null,br=null,ct=()=>{dt?.disconnect(),dt=null,br=null},Gl=t=>{if(dt&&br===t)return;ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(br=t,dt=new MutationObserver(()=>{let o=Xt();if(!o||o.oppId!==t){ct();return}let r=O();if(r!==null&&r!=="Disposition"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),ct();return}document.getElementById(ne)||hr()}),dt.observe(e,{childList:!0,subtree:!0}))},cr=null,pr,ql=()=>{cr||(cr=new MutationObserver(()=>{pr===void 0&&(pr=window.setTimeout(()=>{pr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!Jt&&hr()},300))}),cr.observe(document.body,{childList:!0,subtree:!0}))},Qn=()=>{ql(),hr()};var Be="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Qt="deals.reinvestos.com";var ae="ws-crm-edit-landing-button",Ul=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Vl=/\/v2\/location\/([A-Za-z0-9]+)/,eo=()=>{let t=window.location.pathname,e=t.match(Ul);if(!e)return null;let o=t.match(Vl);return{oppId:e[1],locationId:o?o[1]:null}},Wl=(t,e)=>{let o=new URL(`https://${Qt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Be);let r=L();return r&&o.searchParams.set("user",r),o.toString()},jl=(t,e)=>{let o=document.createElement("button");return o.id=ae,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=eo();if(!r||!r.locationId||r.oppId!==t)return;if(!Be){p.warn("[edit-landing] editor session key not configured in this build");return}let a=Wl(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Kl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yl=async()=>{for(let t of Kl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Zt=!1,_r=async()=>{if(!Zt){Zt=!0;try{await Jl()}finally{Zt=!1}}},Jl=async()=>{let t=eo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Yl();if(!o)return;let r=await U();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=eo();if(!a||a.oppId!==t.oppId)return;let i=jl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Fe(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Xl(t.oppId)},pt=null,vr=null,bt=()=>{pt?.disconnect(),pt=null,vr=null},Xl=t=>{if(pt&&vr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(vr=t,pt=new MutationObserver(()=>{let o=eo();if(!o||o.oppId!==t){bt();return}let r=O();if(r!==null&&r!=="Disposition"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}document.getElementById(ae)||_r()}),pt.observe(e,{childList:!0,subtree:!0}))},mr=null,ur,Ql=()=>{mr||(mr=new MutationObserver(()=>{ur===void 0&&(ur=window.setTimeout(()=>{ur=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!Zt&&_r()},300))}),mr.observe(document.body,{childList:!0,subtree:!0}))},Zn=()=>{Ql(),_r()};var ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Re="ws-crm-publish-button",ht="ws-crm-publish-wrap",oo="ws-crm-publish-dropdown",Zl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ed=/\/v2\/location\/([A-Za-z0-9]+)/,fr=()=>{let t=window.location.pathname,e=t.match(Zl);if(!e)return null;let o=t.match(ed);return{oppId:e[1],locationId:o?o[1]:null}},td=async(t,e)=>{try{let o=await fetch(ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:L()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},od=async(t,e)=>{let o=await fetch(ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:L()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},rd=(t,e)=>{if(!Be){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Qt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Be);let r=L();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},pe=()=>{document.getElementById(oo)?.remove()},ea=(t,e,o,r,a)=>{pe();let i=document.createElement("div");i.id=oo;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),$d(t.oppId)},vt=null,Cr=null,_t=()=>{vt?.disconnect(),vt=null,Cr=null},$d=t=>{if(vt&&Cr===t)return;_t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Cr=t,vt=new MutationObserver(()=>{let o=so();if(!o||o.oppId!==t){_t();return}let r=O();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ue)?.remove(),document.getElementById(Ee)?.remove(),ie(),_t();return}document.getElementById(ue)||Ir()}),vt.observe(e,{childList:!0,subtree:!0}))},Sr=null,Ar,Md=()=>{Sr||(Sr=new MutationObserver(()=>{Ar===void 0&&(Ar=window.setTimeout(()=>{Ar=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ue);if(t&&!e&&!ao){let o=so();if(o&&lo.has(o.oppId))return;Ir()}},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},ua=()=>{Md(),Ir()};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Od=`${ga}/tc/welcome-call-prefill`,Dd=`${ga}/tc/welcome-call-save`,Mr="ws-crm-welcome-call-overlay",Pd=["Regular Contract","Subject To","Seller Finance","Novation"],Hd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Fd=["Gas","Electric","Propane","Oil"],Bd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Rd=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ve=["Yes","No"],Nd=["Yes","No","Unknown"],zd=["Professional Photographer","Seller","Tenant"],Gd=["Month-to-Month","Annual"],va=["Current","Behind"],qd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],_e=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Or=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,fa="margin-bottom:12px;",wa=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Ud=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,_a=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),G=(t,e,o)=>{let r=_a(o);return`<select id="${t}" style="${Or}"><option value=""></option>${e.map(a=>`<option ${r!==""&&_a(a)===r?"selected":""}>${_e(a)}</option>`).join("")}</select>`},V=(t,e,o="")=>`<input id="${t}" type="text" value="${_e(e)}" placeholder="${_e(o)}" style="${Or}">`,Vd=(t,e)=>`<textarea id="${t}" rows="3" style="${Or}resize:vertical;">${_e(e)}</textarea>`,$=(t,e)=>`<div style="${fa}"><label style="${wa}">${_e(t)}</label>${e}</div>`,Lr=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${qd.map(r=>`<label style="${Ud}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},be=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${_e(t)}</div>`,Ne=()=>{document.getElementById(Mr)?.remove()},co=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Wd=t=>{let e=t.tenant||{};return`
    ...
    <div id="wc-hoa-detail" style="display:none;">${$("HOA monthly fee",V("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${$("HOA rental restriction?",G("wc-hoa_rental_restriction",Nd,t.hoa_rental_restriction))}</div>

    ${be("Photos & Access")}
    ${$("Who is providing photos?",G("wc-photos_provided_by",zd,t.photos_provided_by))}
    <div style="${fa}">
      <label style="${wa}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
  ...
  `},C=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},$r=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),ya=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",C("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",C("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",C("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",C("wc-occupancy")==="Tenant Occupied")},jd=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:C("wc-contract_type"),property_type:C("wc-property_type"),beds:C("wc-beds"),baths:C("wc-baths"),sqft:C("wc-sqft"),utilities:C("wc-utilities"),heat_source:C("wc-heat_source"),has_mortgage:C("wc-has_mortgage"),mortgage_payment_status:C("wc-mortgage_payment_status"),has_other_liens:C("wc-has_other_liens"),has_permit_issues:C("wc-has_permit_issues"),in_probate:C("wc-in_probate"),occupancy:C("wc-occupancy"),selling_with_tenant:C("wc-selling_with_tenant"),in_hoa:C("wc-in_hoa"),hoa_rental_restriction:C("wc-hoa_rental_restriction"),hoa_monthly_fee:C("wc-hoa_monthly_fee"),photos_provided_by:C("wc-photos_provided_by"),photos_avail_mornings:$r("photos_avail_mornings"),photos_avail_afternoons:$r("photos_avail_afternoons"),photos_avail_evenings:$r("photos_avail_evenings"),lockbox_needed:C("wc-lockbox_needed"),lockbox_code:C("wc-lockbox_code"),lockbox_recipient_name:C("wc-lockbox_recipient_name"),lockbox_recipient_phone:C("wc-lockbox_recipient_phone"),lockbox_mailing_address:C("wc-lockbox_mailing_address"),welcome_call_notes:C("wc-welcome_call_notes"),tenant:C("wc-occupancy")==="Tenant Occupied"?{first_name:C("wc-tenant_first_name"),last_name:C("wc-tenant_last_name"),phone:C("wc-tenant_phone"),email:C("wc-tenant_email"),lease_type:C("wc-tenant_lease_type"),monthly_rent:C("wc-tenant_monthly_rent"),rent_due_day:C("wc-tenant_rent_due_day"),rent_status:C("wc-tenant_rent_status"),last_rent_paid:C("wc-tenant_last_rent_paid"),lease_on_hand:C("wc-tenant_lease_on_hand"),security_deposit:C("wc-tenant_security_deposit")}:void 0}),Kd=t=>{Ne();let e=document.createElement("div");e.id=Mr,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Wd(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",a=>{a.target===e&&Ne()}),document.getElementById("wc-close")?.addEventListener("click",Ne),document.getElementById("wc-cancel")?.addEventListener("click",Ne),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(a=>{document.getElementById(a)?.addEventListener("change",ya)}),ya();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!C("wc-occupancy")){co("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(jd(t)),credentials:"omit"})).ok?(Ne(),co("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,co("Save failed \u2014 try again.","err"))}catch(a){p.warn("[welcome-call] save failed:",a),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,co("Couldn't reach the save handler. Try again.","err")}})},xa=async(t,e)=>{Ne();let o=document.createElement("div");o.id=Mr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Od}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,Kd(r)};var Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Yd=`${Ta}/tc/confirm-photo-appointment`,Jd=`${Ta}/tc/order-lockbox`,Fr="ws-crm-opp-action-bar",Sa="ws-crm-opp-action-menu",Aa="ws-crm-opp-action-popover",Ca=".hr-card.hr-modal.crm-opportunities-modal",Xd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qd=/\/v2\/location\/([A-Za-z0-9]+)/,Ia="Welcome Call Needed",La="Scheduling Photos",$a="Photos Scheduled",Zd=[Ia,La,$a,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Ma=()=>{let t=window.location.pathname,e=t.match(Xd);if(!e)return null;let o=t.match(Qd);return o?{oppId:e[1],locationId:o[1]}:null},ec=()=>{let t=document.querySelector(Ca);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(Zd.includes(r))return r}return null},Se=()=>{document.getElementById(Sa)?.remove(),document.getElementById(Aa)?.remove()},Te=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Se(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},bo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=q:o.style.cssText=`
      ...
      border: 1px solid ${n.steel};
    `,o.textContent=t,o},nc=()=>{let t=bo("\u22EF","ghost");return t.style.padding="6px 11px",t.style.fontWeight="700",t.style.lineHeight="1",t},ac=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Ia){let r=bo("Start Welcome Call","primary");return r.addEventListener("click",()=>tc(t)),o.appendChild(r),o}if(e===La){let r=bo("Confirm Photo Appointment","primary");r.addEventListener("click",()=>oc(t,r));let a=nc();return a.addEventListener("click",i=>{i.stopPropagation(),rc([{label:"Re-order Lockbox",onClick:()=>void ka(t)}],a)}),o.appendChild(r),o.appendChild(a),o}if(e===$a){let r=bo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void ka(t)),o.appendChild(r),o}return null},ic=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],sc=async()=>{for(let t of ic)try{let e=await M(t,{timeoutMs:1200});if(e)return e}catch{}return null},po=()=>{document.getElementById(Fr)?.remove(),Se()},ho=!1,Rr=async()=>{if(!ho){ho=!0;try{let t=Ma();if(!t){po();return}let e=O();if(e===null)return;if(e!=="Transaction Coordination"){po();return}let o=ec(),r=document.getElementById(Fr);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=ac(t,o);if(!a){po();return}let i=await sc();if(!i)return;po();let s=document.createElement("span");s.id=Fr,s.dataset.oppId=t.oppId,s.dataset.stage=o??"",s.style.cssText="display:inline-flex;align-items:center;margin-left:auto;flex-shrink:0;vertical-align:middle;",s.appendChild(a),i.classList.contains("description")&&(i.style.display="flex",i.style.alignItems="center",i.style.gap="16px",i.style.flexWrap="wrap"),i.appendChild(s),lc(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{ho=!1}}},yt=null,Br=null,Dr,Ea=()=>{yt?.disconnect(),yt=null,Br=null},lc=t=>{if(yt&&Br===t)return;Ea();let e=document.querySelector(Ca);e&&(Br=t,yt=new MutationObserver(()=>{let o=Ma();if(!o||o.oppId!==t){Ea();return}Dr===void 0&&(Dr=window.setTimeout(()=>{Dr=void 0,Rr()},250))}),yt.observe(e,{childList:!0,subtree:!0}))},Pr=null,Hr,dc=()=>{Pr||(Pr=new MutationObserver(()=>{Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!ho&&Rr()},300))}),Pr.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{dc(),Rr()};var Da="ws-support-modal",Pa="ws-support-toast",cc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ha="ws-support-submitter-name",Fa="ws-support-submitter-email",Ba="ws-support-submitter-role",pc=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ae=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),bc=(t,e="success",o)=>{let r=document.getElementById(Pa);r&&r.remove();let a=document.createElement("div");a.id=Pa;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},hc=()=>{document.getElementById(Da)?.remove();let t=(localStorage.getItem(Ha)??"").trim(),e=(localStorage.getItem(Fa)??"").trim(),o=(localStorage.getItem(Ba)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Da,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=$e();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ha,r.submitterName),localStorage.setItem(Fa,r.submitterEmail),r.submitterRole&&localStorage.setItem(Ba,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(cc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";bc(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},mc=["/support-ticket","ws-support-modal","ws-support"],uc=/\/custom-menu-link\//,Nr=!1,Ra=()=>{if(Nr||!uc.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return mc.some(s=>i.includes(s))});if(r){Nr=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{hc(),Nr=!1},50);return}t<10&&setTimeout(e,150)};e()},Na=!1,za=()=>{Na||(Na=!0,Mt(()=>setTimeout(Ra,50)),Ra(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var vc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",_c="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",yc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ua="tc_closing_agent",gc="tc_closing_office",se="ws-crm-closing-agent-picker-button",Va="ws-crm-closing-agent-picker-modal",fc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,wc=/\/v2\/location\/([A-Za-z0-9]+)/,wt=()=>{let t=window.location.pathname,e=t.match(fc);if(!e)return null;let o=t.match(wc);return{oppId:e[1],locationId:o?o[1]:null}},Kr=async t=>{let e=await fetch(vc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ga=async t=>{let e=await fetch(_c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},xc=async(t,e)=>{try{let o=await fetch(yc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Ua}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Kr({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},Ce=null,kc=60*60*1e3,Yr=t=>`ws-crm-to-cache:${t}`,Wa=t=>{try{let e=window.localStorage.getItem(Yr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>kc||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},ja=(t,e,o)=>{try{window.localStorage.setItem(Yr(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Ec=t=>{try{window.localStorage.removeItem(Yr(t))}catch{}},Ur="ws-crm-closing-agent-field-link",Tc=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ur}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},zr=!1,Jr=async t=>{if(zr)return;let e=Ka();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){zr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Kr({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Vr(a.id,a.name,t);let i=document.getElementById(se);if(i){ye(i,{status:"linked",contactName:a.name});let s=wt();s&&ja(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{zr=!1}}},Sc=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ka=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();Sc.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Vr=(t,e,o)=>{let r=Ka();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Ur}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Ur,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},mo=()=>{document.getElementById(Va)?.remove()},Ac=t=>{mo();let e=document.createElement("div");e.id=Va,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};ye(o,r);let a=Wa(t);return a&&(r={status:"linked",contactName:a.contactName},ye(o,r),Ce={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await xc(t,e);s?(r={status:"linked",contactName:s.name},ye(o,r),Ce={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Vr(s.id,s.name,e)):a||(r={status:"empty"},ye(o,r),Ce?.oppId===t&&(Ce=null),Tc(),Ec(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Ac({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ye(o,r);try{let l=[Ga({tenantId:e,oppId:t,fieldKey:Ua,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ga({tenantId:e,oppId:t,fieldKey:gc,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ye(o,r),Ce={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},ja(t,s.id,s.name),Vr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},ye(o,r)}}})}),o},Ic=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Lc=async()=>{for(let t of Ic)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},gt=!1,_o=async()=>{if(!gt){gt=!0;try{await $c()}finally{gt=!1}}},$c=async()=>{let t=wt();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),vo();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let d=O();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),vo());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=O();if(o!==null&&o!=="Transaction Coordination")return;let r=await Lc();if(!r||!(Wa(t.oppId)!==null||Ce!==null&&Ce.oppId===t.oppId)&&await U()!=="Transaction Coordination")return;let i=wt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Cc(t.oppId,i.locationId),l=document.createElement("span");l.id=`${se}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Mc(t.oppId),Jr(i.locationId)},ft=null,Wr=null,jr=null,vo=()=>{ft?.disconnect(),ft=null,Wr=null,jr=null},Mc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ft&&Wr===t&&jr===e||(vo(),Wr=t,jr=e,ft=new MutationObserver(()=>{let o=wt();if(!o||o.oppId!==t||!o.locationId){vo();return}document.getElementById(se)||_o(),Jr(o.locationId)}),ft.observe(e,{childList:!0,subtree:!0})))},Gr=null,qr,Oc=()=>{Gr||(Gr=new MutationObserver(()=>{qr===void 0&&(qr=window.setTimeout(()=>{qr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!gt&&_o()},300))}),Gr.observe(document.body,{childList:!0,subtree:!0}))},qa,Dc=()=>{qa===void 0&&(qa=window.setInterval(()=>{let t=wt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(se)&&!gt&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),_o()),Jr(t.locationId)},2e3))},Ya=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Oc(),Dc(),_o()};var Pc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",fe="ws-crm-manage-team-cta",Ja="ws-crm-manage-team-modal",Hc=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Xa={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Fc={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Qa=()=>{let t=window.location.pathname.match(Hc);return t?{tenantId:t[1]}:null},go=async t=>{let e=await fetch(Pc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},te=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ge=t=>te(t),Xr="ws-crm-manage-team-toast",en=(t,e="info",o=4e3)=>{document.getElementById(Xr)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Xr,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Xr)===a&&a.remove()},o)},Qr=()=>{document.getElementById(Ja)?.remove()},Bc=(t,e)=>{let o=Fc[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${te(e)}</span>
  `},Rc=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Bc(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>Rc(r,e)).join(""),fo=async t=>{Qr();let e=document.createElement("div");e.id=Ja,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Qr);let r;try{r=await go({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Nc(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{zc(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;Gc(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;qc(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},zc=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.addEventListener("click",()=>{fo(t)}),yo(e),setTimeout(()=>yo(e),200),setTimeout(()=>yo(e),800),window.addEventListener("resize",()=>yo(e)),e},Zr=!1,Qc=()=>{if(!Zr){Zr=!0;try{let t=Qa();if(!t){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}let e=document.getElementById(fe);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${fe}-floater`)?.remove();let o=document.createElement("div");o.id=`${fe}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Xc(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Zr=!1}}},Za=()=>{if(!Qa()){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}Qc()};var Zc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",rn="ws-crm-prepare-contract-button",ei="ws-crm-prepare-contract-menu",ce="ws-crm-prepare-contract-modal",ti="ws-crm-modal-date-style",he="https://services.leadconnectorhq.com",si=()=>{if(document.getElementById(ti))return;let t=document.createElement("style");t.id=ti,t.textContent=`
  ...
  `,document.head.appendChild(t)},nn="__WS_CRM_CAPTURED_AUTH",ep=50*60*1e3,Eo=()=>{try{let t=localStorage.getItem(nn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>ep?(localStorage.removeItem(nn),null):e:null}catch{return null}},tp=t=>{try{localStorage.setItem(nn,JSON.stringify(t))}catch{}},Ge=()=>{let t=Eo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},oi=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Eo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),ze=async(t,e={},o=2)=>{let r=Eo()?.capturedAt??0,a;try{a={...Ge(),...e.headers??{}}}catch(s){if(o>0&&await oi(r,4e3))return ze(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await oi(r,4e3)?ze(t,e,o-1):i},ri=!1,op=()=>{if(ri)return;ri=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Eo()?.authorization;tp({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},li=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},rp=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:li()},np=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},di="__WS_CRM_TEMPLATES_CACHE_V1",ap=24*60*60*1e3,ni=t=>{try{let e=window.localStorage.getItem(di);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>ap?null:o.templates}catch{return null}},ip=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(di,JSON.stringify(o))}catch{}},sp=async t=>{let e=`${he}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await ze(e,{method:"GET"})}catch(s){let l=ni(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ni(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:np(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&ip(t,i),i},lp=async(t,e)=>{let o=await ze(`${he}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await ze(`${he}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},dp=async(t,e)=>{let o=await ze(`${he}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${he}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ge()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},cp=async t=>{let e=await fetch(Zc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},pp=async(t,e,o)=>{let r=`${he}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ge()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},bp=async(t,e)=>{let o=await fetch(`${he}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ge()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},hp=async t=>{let e=await fetch(`${he}/contacts/${t}`,{method:"GET",headers:Ge()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},mp=async(t,e,o,r)=>{let a;try{a=await bp(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await hp(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${he}/proposals/document/${e}`,{method:"PUT",headers:{...Ge(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},up=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},xo="__WS_CRM_PENDING_INSTRUCTIONS",vp=60*1e3,_p=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],yp=t=>{let e=(t||"").toLowerCase();for(let o of _p)if(e.includes(o.matches.toLowerCase()))return o;return null},gp=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(xo,JSON.stringify(r))}catch{}},fp=()=>{try{let t=localStorage.getItem(xo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>vp?(localStorage.removeItem(xo),null):e}catch{return null}},wp=()=>{try{localStorage.removeItem(xo)}catch{}},xp=(t,e)=>{document.getElementById(ce)?.remove();let o=document.createElement("div");o.id=ce,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},kp=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ep=()=>{let t=window.location.pathname.match(kp);if(!t)return;let e=t[1],o=fp();o&&o.proposalId===e&&(wp(),window.setTimeout(()=>{xp(o.title,o.bodyHtml)},600))},ai="ws-crm-prepare-contract-toast",W=(t,e="info",o=4e3)=>{document.getElementById(ai)?.remove();let r=document.createElement("div");r.id=ai;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await sp(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await dp(e.tenantId,e.contactId)}catch(f){W(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){W("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await ii(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);W("Reading contract data\u2026","info",2500);let E;try{E=await ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:c})}catch(y){W(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){W("Could not resolve buyer contact for this opp.","error",6e3);return}Sp({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){W("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await lp(e.tenantId,e.contactId)}catch(_){W(`Failed to load ACQ opps: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){W("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await ii(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,p.info(`[prepare-contract] picked ACQ opp ${m}`)}W("Reading contract data\u2026","info",2500);let h;try{h=await ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(_){W(`Failed to prepare contract: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",_);return}Tp({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){W("This template needs to be started from a contact page.","error",6e3);return}W(`Opening ${i.name}\u2026`,"info",2500);try{await ln(e.tenantId,e.contactId,i)}catch(b){W(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),W(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},ci=()=>{let t=document.createElement("button");return t.id=rn,t.type="button",t.style.cssText=`${D} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Ap(t)}),t},Cp="ws-crm-contact-actions-bar",Ip=async()=>{let t=li();if(!t){document.getElementById(rn)?.remove();return}let e=null;try{e=await M(`#${Cp}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(rn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=ci();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ie="ws-crm-prepare-contract-button-opp",xt=`${Ie}-wrap`,Lp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$p=/\/v2\/location\/([A-Za-z0-9]+)/,Mp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],an=()=>{let t=window.location.pathname,e=t.match(Lp);if(!e)return null;let o=t.match($p);return o?{oppId:e[1],tenantId:o[1]}:null},Op=async()=>{for(let t of Mp)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wo=!1,kt=null,sn=null,tn=null,on,Et=()=>{kt?.disconnect(),kt=null,sn=null},Dp=t=>{if(kt&&sn===t)return;Et();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(sn=t,kt=new MutationObserver(()=>{let o=an();if(!o||o.oppId!==t){Et();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ie)?.remove(),document.getElementById(xt)?.remove(),Et();return}document.getElementById(Ie)||pi()}),kt.observe(e,{childList:!0,subtree:!0}))},Pp=()=>{tn||(tn=new MutationObserver(()=>{on===void 0&&(on=window.setTimeout(()=>{on=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ie);t&&!e&&!wo&&pi()},300))}),tn.observe(document.body,{childList:!0,subtree:!0}))},pi=async()=>{if(!wo){wo=!0;try{let t=an();if(!t){document.getElementById(Ie)?.remove(),document.getElementById(xt)?.remove(),Et();return}let e=document.getElementById(Ie);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(xt)?.remove(),Et());return}e&&(e.remove(),document.getElementById(xt)?.remove());let o=await Op();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await U();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=an();if(!a||a.oppId!==t.oppId)return;let i=ci();i.id=Ie,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=xt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Dp(t.oppId)}finally{wo=!1}}},bi=()=>{Ep(),Ip()};op();function X(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function de(t){return X(t)}var Lo="reos-theme-stylesheet",Li="reos-theme-fonts",Hp=()=>{let t=document.getElementById(Li);t&&t.remove()},Fp=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var F=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Oi=()=>{if(p.info(`Loaded v${Ot} (built ${Dt})`),Ho()){p.info(`[main] customizer disabled for excluded location ${$e()} \u2014 bailing`);return}F("mountVersionBadge (initial)",Mo),F("mountFavicon",Un),F("mountThemeStylesheet",$i),F("mountHideLaunchpad",Tr),F("initPageRouter",un),p.info("[main] registering onPageChange subscriber"),Mt(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),Ho()){p.info(`[main] page change into excluded location ${$e()} \u2014 skipping mounts`);return}F("mountVersionBadge",Mo),F("mountHideLaunchpad",Tr),F("mountClaimReleaseToggle",On),F("mountContactActionsBar",Gn),F("mountActiveFollowUpButton",kn),F("mountMtOfferMadeButton",Wn),F("mountNotInterestedButton",jn),F("mountResendDealLinkButton",Yn),F("mountReducePriceButton",Qn),F("mountEditLandingPageButton",Zn),F("mountPublishButton",oa),F("mountContactMapLinks",la),F("mountSendToClosingOfficeButton",ua),F("mountOppActionBar",Oa),F("mountClosingAgentPickerButton",Ya),F("mountPrepareContractButton",bi),F("mountManageTeam",Za),F("mountBuyBoxWidget",In),F("mountSupportNavItem",za)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oi):Oi();})();
