/* Wholesaling CRM Customizer v0.13.58 — built 2026-05-26T22:19:52.089Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var re="[wholesaling-crm-customizer]",Gt="__WS_CRM_DEBUG",$t=()=>!!window[Gt],c={info(...o){console.log(re,...o)},warn(...o){console.warn(re,...o)},error(...o){console.error(re,...o)},debug(...o){$t()&&console.log(re,"[debug]",...o)}};var qe=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Se=/\/v2\/location\/([A-Za-z0-9]+)/,Vt=o=>{let e=o.match(qe);if(!e)return null;let t=o.match(Se);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ut=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(qe);if(!n)continue;let a=r.match(Se)||window.location.pathname.match(Se);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},E=()=>{let o=Vt(window.location.pathname);return o||Ut()};var ze=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ae="",Ce=null,$="other",Ae=new Set,ne=()=>{let o=E()?.contactId??null;if(!(!(window.location.pathname!==ae)&&!(o!==Ce))){ae=window.location.pathname,Ce=o,$=ze(),c.debug("Page/context changed:",$,ae,"contact:",o);for(let r of Ae)try{r($)}catch(n){c.error("Subscriber threw:",n)}}},We=o=>(Ae.add(o),setTimeout(()=>o($),0),()=>{Ae.delete(o)}),je=()=>{$=ze(),ae=window.location.pathname,Ce=E()?.contactId??null,c.debug("Router init, current page:",$);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ne()},history.replaceState=function(t,r,n){e(t,r,n),ne()},window.addEventListener("popstate",ne),setInterval(ne,1e3)};var se="0.13.58",ie="2026-05-26T22:19:52.089Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},x={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ie={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},le=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var qt=/^[A-Za-z0-9]{15,30}$/,W=o=>typeof o=="string"&&qt.test(o),zt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Wt=()=>{let o=window.WS_CRM_USER_ID;return W(o)?o:null},jt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(W(t))return t;return null},Kt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=zt(e);if(!t)return null;let r=t.uid;if(W(r))return r;let n=t.claims;if(n&&W(n.user_id))return n.user_id}catch{}return null},Yt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(W(n))return n}catch{}}}catch{}return null},I=()=>Wt()||jt()||Kt()||Yt()||null;var Je="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Xt=`${Je}/active-follow-up-get`,Jt=`${Je}/active-follow-up-set`,O="ws-crm-active-follow-up-button",Fe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Qt=()=>{let o=E();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zt=async o=>{let e=await fetch(Xt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},eo=async(o,e)=>{let t=await fetch(Jt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},R=(o,e)=>{let t=Fe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ke=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,R(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Qt();if(!(!r||r.contactId!==o)){R(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await eo(r,I()),a=n&&n.state&&n.state in Fe?n.state:"blue";R(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),R(e,"error"),setTimeout(()=>void de(e,r),4e3)}}}),e},de=async(o,e)=>{R(o,"loading");try{let t=await Zt(e),r=t&&t.state&&t.state in Fe?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;R(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),R(o,"error")}},to=[".central-panel","[class*='central-panel']"],Le="ws-crm-contact-actions-bar",oo=async()=>{for(let o of to)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ro=async(o,e)=>{let t=e.querySelector(`#${Le}`);if(!t)try{t=await C(`#${Le}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,F(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let v=await Ko(o,e);if(!v){r={status:"error",message:"Check failed \u2014 click to retry"},F(t,r);return}if(v.rate_limited){h=Date.now()+m,r={status:"error",checks:r.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},F(t,r),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(h).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){r={status:"error",message:v.error||"Check failed \u2014 click to retry"},F(t,r),c.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){c.info(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}let g=v.checks;if(r.checks&&r.checks.length===v.checks.length){let w=new Set;g=v.checks.map((k,T)=>r.checks[T]?.filled&&!k.filled?n.has(k.label)?k:(w.add(k.label),{...k,filled:!0}):k),n=w}else n=new Set;r={status:g.every(w=>w.filled)?"ready":"incomplete",checks:g,previouslySentAt:v.previously_sent_at??null},F(t,r),document.getElementById(ue)&&me(g,v.previously_sent_at,t)},i=async()=>{let v=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},F(t,r),D();try{let _=await Yo(o,e,v);if(_.needs_confirm){r={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t);return}if(_.ok){r={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},F(t,r),window.setTimeout(()=>{u()},3500);return}r={status:"error",checks:_.checks,message:_.error||"Validation failed"},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t)}catch(_){c.error("[stc] send failed:",_),r={status:"error",message:"Network error \u2014 click to retry"},F(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(ue)?D():r.checks&&me(r.checks,r.previouslySentAt,t);break}case"error":case"sent":u();break}});let s,d=!1,b=Date.now(),p=1e4,m=5*60*1e3,h=0,u=async()=>{if(!d){if(Date.now()<h){c.info(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(h).toLocaleTimeString()}`);return}d=!0,b=Date.now();try{await a()}finally{d=!1}}};u();let f=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(f){let v=new MutationObserver(()=>{if(s!==void 0||d)return;let g=Date.now()-b,y=Math.max(1500,p-g);s=window.setTimeout(()=>{s=void 0,r.status!=="sending"&&u()},y)});v.observe(f,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),s!==void 0&&window.clearTimeout(s),window.clearInterval(_))},5e3)}return t},Zo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],er=async()=>{for(let o of Zo)try{let e=await C(o,{timeoutMs:1500});if(e)return c.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_e=!1,Ve=async()=>{if(_e){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_e=!0;try{await tr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{_e=!1}},tr=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let o=Ge();if(!o||!o.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D();return}c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let i=B();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(q)?.remove(),D(),Z());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(q)?.remove(),D()),c.debug("[stc] mount:04 calling findMountTarget");let t=await er();if(!t){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=Ge();if(!r||r.oppId!==o.oppId||!r.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${r?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let n=Qo(o.oppId,r.locationId),a=document.createElement("span");a.id=q,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(n),t.appendChild(a),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(n)}`),or(o.oppId)},Q=null,$e=null,Z=()=>{Q?.disconnect(),Q=null,$e=null},or=o=>{if(Q&&$e===o)return;Z();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($e=o,Q=new MutationObserver(()=>{let t=Ge();if(!t||t.oppId!==o){Z();return}let r=B();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}document.getElementById(G)||Ve()}),Q.observe(e,{childList:!0,subtree:!0}))},Re=null,Be,rr=()=>{Re||(Re=new MutationObserver(()=>{Be===void 0&&(Be=window.setTimeout(()=>{Be=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(G);o&&!e&&!_e&&Ve()},300))}),Re.observe(document.body,{childList:!0,subtree:!0}))},ft=()=>{rr(),Ve()};var xe="reos-theme-stylesheet",Pt="reos-theme-fonts",nr=()=>{let o=document.getElementById(Pt);o&&o.remove()},ar=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},Bt=()=>{c.info(`Loaded v${se} (built ${ie})`),M("mountVersionBadge (initial)",Te),M("mountFavicon",_t),M("mountThemeStylesheet",Ot),M("initPageRouter",je),c.info("[main] registering onPageChange subscriber"),We(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",Te),M("mountClaimReleaseToggle",ot),M("mountContactActionsBar",pt),M("mountActiveFollowUpButton",Qe),M("mountNotInterestedButton",vt),M("mountSendToTitleCoButton",ft)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Bt):Bt();})();
