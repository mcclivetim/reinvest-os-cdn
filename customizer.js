/* Wholesaling CRM Customizer v0.16.7 — built 2026-05-31T19:31:39.680Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Xe="[wholesaling-crm-customizer]",hn="__WS_CRM_DEBUG",pn=()=>!!window[hn],b={info(...t){console.log(Xe,...t)},warn(...t){console.warn(Xe,...t)},error(...t){console.error(Xe,...t)},debug(...t){pn()&&console.log(Xe,"[debug]",...t)}};var Fo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nt=/\/v2\/location\/([A-Za-z0-9]+)/,mn=t=>{let e=t.match(Fo);if(!e)return null;let o=t.match(Nt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},un=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(Fo);if(!n)continue;let i=r.match(Nt)||window.location.pathname.match(Nt);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},L=()=>{let t=mn(window.location.pathname);return t||un()};var Oo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Qe="",Rt=null,ve="other",Bt=new Set,Je=()=>{let t=L()?.contactId??null;if(!(!(window.location.pathname!==Qe)&&!(t!==Rt))){Qe=window.location.pathname,Rt=t,ve=Oo(),b.debug("Page/context changed:",ve,Qe,"contact:",t);for(let r of Bt)try{r(ve)}catch(n){b.error("Subscriber threw:",n)}}},Po=t=>(Bt.add(t),setTimeout(()=>t(ve),0),()=>{Bt.delete(t)}),Ho=()=>{ve=Oo(),Qe=window.location.pathname,Rt=L()?.contactId??null,b.debug("Router init, current page:",ve);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Je()},history.replaceState=function(o,r,n){e(o,r,n),Je()},window.addEventListener("popstate",Je),setInterval(Je,1e3)};var Ze="0.16.7",et="2026-05-31T19:31:39.681Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,s)=>{let l=n.querySelector(t);if(l){i(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),i(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),i(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var a={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},f={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Gt={purple:"#8B5CF6",green:a.emerald,orange:a.amber,red:a.crimson},No=t=>{let e=t==="emerald"?a.emeraldGlow:t==="amber"?a.amberGlow:a.slate,o=t==="emerald"?a.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":a.steel,r=t==="emerald"?a.emerald:t==="amber"?a.amber:a.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var vn=/^[A-Za-z0-9]{15,30}$/,Ce=t=>typeof t=="string"&&vn.test(t),_n=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},yn=()=>{let t=window.WS_CRM_USER_ID;return Ce(t)?t:null},gn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ce(o))return o;return null},fn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);if(!o)return null;let r=o.uid;if(Ce(r))return r;let n=o.claims;if(n&&Ce(n.user_id))return n.user_id}catch{}return null},wn=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(Ce(n))return n}catch{}}}catch{}return null},A=()=>yn()||gn()||fn()||wn()||null;var zo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",xn=`${zo}/active-follow-up-get`,kn=`${zo}/active-follow-up-set`,ce="ws-crm-active-follow-up-button",qt={amber:{label:"Add to Active Follow Up",bg:a.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:a.amber,clickable:!0,dotColor:a.amber},blue:{label:"In Active Follow Up",bg:a.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:a.blue,clickable:!1,dotColor:a.blue},gray:{label:"Not in Follow Up",bg:a.slate,border:a.steel,color:a.coolGray,clickable:!1,dotColor:a.coolGray},loading:{label:"Active Follow Up\u2026",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.ash},error:{label:"Follow Up status unavailable",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.crimson}},En=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Tn=async t=>{let e=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Sn=async(t,e)=>{let o=await fetch(kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},be=(t,e)=>{let o=qt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},Ro=t=>{let e=document.createElement("button");return e.type="button",e.id=ce,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=it();!o||!o.locationId||o.oppId!==t||pa({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=a.emeraldGlow,e.style.color=a.emeraldBright,e.style.borderColor=a.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=C)},4e3)}})}),e},ua=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],va=async()=>{for(let t of ua)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},at=!1,Yt=async()=>{if(!at){at=!0;try{await _a()}finally{at=!1}}},_a=async()=>{let t=it();if(!t||!t.locationId){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e();return}let e=document.getElementById(U);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e());return}e&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove());let o=await va();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=it();if(!n||n.oppId!==t.oppId)return;let i=ma(t.oppId),s=document.createElement("span");s.id=`${U}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ya(t.oppId)},Me=null,Kt=null,$e=()=>{Me?.disconnect(),Me=null,Kt=null},ya=t=>{if(Me&&Kt===t)return;$e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kt=t,Me=new MutationObserver(()=>{let o=it();if(!o||o.oppId!==t){$e();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e();return}document.getElementById(U)||Yt()}),Me.observe(e,{childList:!0,subtree:!0}))},Wt=null,jt,ga=()=>{Wt||(Wt=new MutationObserver(()=>{jt===void 0&&(jt=window.setTimeout(()=>{jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);t&&!e&&!at&&Yt()},300))}),Wt.observe(document.body,{childList:!0,subtree:!0}))},lr=()=>{ga(),Yt()};var fa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",V="ws-crm-not-interested-button",wa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xa=/\/v2\/location\/([A-Za-z0-9]+)/,lt=()=>{let t=window.location.pathname,e=t.match(wa);if(!e)return null;let o=t.match(xa);return{oppId:e[1],locationId:o?o[1]:null}},ka=async t=>{let e=await fetch(fa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ea=t=>{let e=document.createElement("button");return e.id=V,e.type="button",e.dataset.oppId=t,e.style.cssText=C,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=lt();if(!o||!o.locationId||o.oppId!==t)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await ka({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=a.crimsonGlow,e.style.color=a.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Ta=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sa=async()=>{for(let t of Ta)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},st=!1,Zt=async()=>{if(!st){st=!0;try{await Ca()}finally{st=!1}}},Ca=async()=>{let t=lt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await Sa();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=lt();if(!n||n.oppId!==t.oppId)return;let i=Ea(t.oppId),s=document.createElement("span");s.id=`${V}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ia(t.oppId)},De=null,Qt=null,Fe=()=>{De?.disconnect(),De=null,Qt=null},Ia=t=>{if(De&&Qt===t)return;Fe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qt=t,De=new MutationObserver(()=>{let o=lt();if(!o||o.oppId!==t){Fe();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}document.getElementById(V)||Zt()}),De.observe(e,{childList:!0,subtree:!0}))},Xt=null,Jt,Aa=()=>{Xt||(Xt=new MutationObserver(()=>{Jt===void 0&&(Jt=window.setTimeout(()=>{Jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!st&&Zt()},300))}),Xt.observe(document.body,{childList:!0,subtree:!0}))},dr=()=>{Aa(),Zt()};var La="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",W="ws-crm-reduce-price-button",cr="ws-crm-reduce-price-modal",Ma=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$a=/\/v2\/location\/([A-Za-z0-9]+)/,bt=()=>{let t=window.location.pathname,e=t.match(Ma);if(!e)return null;let o=t.match($a);return{oppId:e[1],locationId:o?o[1]:null}},Da=async t=>{let e=await fetch(La,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},dt=()=>{document.getElementById(cr)?.remove()},Fa=t=>{dt();let e=document.createElement("div");e.id=cr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&dt()}),i?.addEventListener("click",()=>{dt()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Da({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:A()}),dt(),t.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},Oa=(t,e)=>{let o=document.createElement("button");return o.id=W,o.type="button",o.dataset.oppId=t,o.style.cssText=C,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),ti(t.oppId)},He=null,io=null,Ne=()=>{He?.disconnect(),He=null,io=null},ti=t=>{if(He&&io===t)return;Ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(io=t,He=new MutationObserver(()=>{let o=ut();if(!o||o.oppId!==t){Ne();return}let r=$();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ae)?.remove(),document.getElementById(he)?.remove(),j(),Ne();return}document.getElementById(ae)||so()}),He.observe(e,{childList:!0,subtree:!0}))},no=null,ao,oi=()=>{no||(no=new MutationObserver(()=>{ao===void 0&&(ao=window.setTimeout(()=>{ao=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);if(t&&!e&&!pt){let o=ut();if(o&&vt.has(o.oppId))return;so()}},300))}),no.observe(document.body,{childList:!0,subtree:!0}))},vr=()=>{oi(),so()};var ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ni="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ai="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",gr="ldtyB2UXKi9vOp8nLUH7",ii="WVD2gb9swLsgcdBEtDVq",K="ws-crm-closing-agent-picker-button",fr="ws-crm-closing-agent-picker-modal",si=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,li=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let t=window.location.pathname,e=t.match(si);if(!e)return null;let o=t.match(li);return{oppId:e[1],locationId:o?o[1]:null}},vo=async t=>{let e=await fetch(ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},_r=async t=>{let e=await fetch(ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},di=async(t,e)=>{try{let o=await fetch(ai,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:gr}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await vo({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},pe=null,ci=60*60*1e3,_o=t=>`ws-crm-to-cache:${t}`,wr=t=>{try{let e=window.localStorage.getItem(_o(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ci||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},xr=(t,e,o)=>{try{window.localStorage.setItem(_o(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},bi=t=>{try{window.localStorage.removeItem(_o(t))}catch{}},ho="ws-crm-closing-agent-field-link",hi=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${ho}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},lo=!1,yo=async t=>{if(lo)return;let e=kr();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){lo=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await vo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),po(n.id,n.name,t);let i=document.getElementById(K);if(i){ie(i,{status:"linked",contactName:n.name});let s=Ge();s&&xr(s.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{lo=!1}}},pi=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,kr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();pi.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},po=(t,e,o)=>{let r=kr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${ho}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=ho,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${f.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},_t=()=>{document.getElementById(fr)?.remove()},mi=t=>{_t();let e=document.createElement("div");e.id=fr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&_t()}),i?.addEventListener("click",_t);let s,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${a.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
      ...
      <div style="padding: 16px; color: ${a.ash}; font-size: 13px; text-align: center;">
        ...
        `,p.addEventListener("mouseenter",()=>{p.style.background=a.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{_t(),t.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          ...
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},yt=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ie=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",i=a.amber,s=a.bone,l="transparent",d=a.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",i=a.coolGray,s=a.ash,c="wait";break;case"empty":n="Link Closing Agent",i=a.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=a.emerald,l=a.emeraldGlow,d=a.emeraldBorder,s=a.emeraldBright;break;case"saving":n="Linking\u2026",i=a.coolGray,s=a.ash,c="wait";break}o&&(o.textContent=n),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=c},ui=(t,e)=>{let o=document.createElement("button");o.id=K,o.type="button",o.dataset.oppId=t,o.style.cssText=C,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ie(o,r);let n=wr(t);return n&&(r={status:"linked",contactName:n.contactName},ie(o,r),pe={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let s=await di(t,e);s?(r={status:"linked",contactName:s.name},ie(o,r),pe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},po(s.id,s.name,e)):n||(r={status:"empty"},ie(o,r),pe?.oppId===t&&(pe=null),hi(),bi(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||mi({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ie(o,r);try{let l=[_r({tenantId:e,oppId:t,fieldId:gr,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(_r({tenantId:e,oppId:t,fieldId:ii,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ie(o,r),pe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},xr(t,s.id,s.name),po(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},ie(o,r)}}})}),o},vi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],_i=async()=>{for(let t of vi)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Re=!1,ft=async()=>{if(!Re){Re=!0;try{await yi()}finally{Re=!1}}},yi=async()=>{let t=Ge();if(!t||!t.locationId){document.getElementById(K)?.remove(),document.getElementById(`${K}-wrap`)?.remove(),gt();return}let e=document.getElementById(K);if(e&&e.dataset.oppId===t.oppId){let d=$();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${K}-wrap`)?.remove(),gt());return}e&&(e.remove(),document.getElementById(`${K}-wrap`)?.remove());let o=$();if(o!==null&&o!=="Transaction Coordination")return;let r=await _i();if(!r||!(wr(t.oppId)!==null||pe!==null&&pe.oppId===t.oppId)&&await X()!=="Transaction Coordination")return;let i=Ge();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=ui(t.oppId,i.locationId),l=document.createElement("span");l.id=`${K}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),gi(t.oppId),yo(i.locationId)},Be=null,mo=null,uo=null,gt=()=>{Be?.disconnect(),Be=null,mo=null,uo=null},gi=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Be&&mo===t&&uo===e||(gt(),mo=t,uo=e,Be=new MutationObserver(()=>{let o=Ge();if(!o||o.oppId!==t||!o.locationId){gt();return}document.getElementById(K)||ft(),yo(o.locationId)}),Be.observe(e,{childList:!0,subtree:!0})))},co=null,bo,fi=()=>{co||(co=new MutationObserver(()=>{bo===void 0&&(bo=window.setTimeout(()=>{bo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(K);t&&!e&&!Re&&ft()},300))}),co.observe(document.body,{childList:!0,subtree:!0}))},yr,wi=()=>{yr===void 0&&(yr=window.setInterval(()=>{let t=Ge();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(K)&&!Re&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),ft()),yo(t.locationId)},2e3))},Er=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),fi(),wi(),ft()};var xi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",ge="ws-crm-manage-team-cta",Sr="ws-crm-manage-team-modal",ki=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Cr={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Ei={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:a.blue},acq:{bg:a.emeraldGlow,fg:a.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:a.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:a.crimson}},Ir=()=>{let t=window.location.pathname.match(ki);return t?{tenantId:t[1]}:null},xt=async t=>{let e=await fetch(xi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},q=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),se=t=>q(t),go="ws-crm-manage-team-toast",xo=(t,e="info",o=4e3)=>{document.getElementById(go)?.remove();let r=e==="success"?a.emerald:e==="error"?a.crimson:a.ash,n=document.createElement("div");n.id=go,n.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,n.textContent=t,document.body.appendChild(n),o>0&&window.setTimeout(()=>{document.getElementById(go)===n&&n.remove()},o)},fo=()=>{document.getElementById(Sr)?.remove()},Ti=(t,e)=>{let o=Ei[t]||{bg:a.slate,fg:a.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${q(e)}</span>
  `},Si=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Ti(s.key,s.display)).join(""),n=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${n}" ${i}>
        <button class="ws-team-edit" data-email="${se(t.email)}" data-user-id="${se(t.id)}" data-name="${se(o)}" data-current-roles="${se(t.role_keys.join(","))}" style="${C} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${se(t.email)}" data-name="${se(o)}" data-role-count="${se(String(t.role_keys.length))}" style="${C} font-size: 11px; padding: 5px 10px; border-color: ${a.crimson}; color: ${a.crimson};">Remove</button>
      </div>
    </div>
  `},Ci=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Si(r,e)).join(""),kt=async t=>{fo();let e=document.createElement("div");e.id=Sr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",fo);let r;try{r=await xt({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
      ...
      `);return}let n=A(),i=!!(n&&r.roster.some(d=>d.id===n&&d.role_keys.includes("manager"))),s=r.summary?`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Ci(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Ii(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let h=c.currentTarget;Ai(t,{email:h.dataset.email||"",name:h.dataset.name||"",currentRoles:(h.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let h=c.currentTarget;Li(t,{email:h.dataset.email||"",name:h.dataset.name||"",roleCount:parseInt(h.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Ii=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(i),document.body.appendChild(o),i.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),i.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let s=(i.querySelector("#ws-team-add-first")?.value||"").trim(),l=(i.querySelector("#ws-team-add-last")?.value||"").trim(),d=(i.querySelector("#ws-team-add-email")?.value||"").trim(),c=(i.querySelector("#ws-team-add-mobile")?.value||"").trim(),h=(i.querySelector("#ws-team-add-role")?.value||"").trim(),m=i.querySelector("#ws-team-add-error"),p=i.querySelector("#ws-team-add-submit");if(!s||!l||!d||!c||!h){m&&(m.textContent="All fields are required.");return}p&&(p.disabled=!0,p.textContent="Adding\u2026",p.style.opacity="0.7"),m&&(m.textContent="");try{let v=await xt({tenant_id:t,action:"add",first_name:s,last_name:l,email:d,mobile:c,role:h,triggered_by_user_id:A()});if(!v.ok){m&&(m.textContent=v.error||"Failed to add employee"),p&&(p.disabled=!1,p.textContent="Add Employee",p.style.opacity="1");return}o.remove(),xo(`Added ${s} ${l} as ${Cr[h]||h}.`,"success"),await kt(t)}catch(v){m&&(m.textContent=v.message),p&&(p.disabled=!1,p.textContent="Add Employee",p.style.opacity="1")}})},Ai=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${a.slate}; border: 1px solid ${a.steel}; border-radius: ${f.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${q(Cr[s])}</span>
      </label>
    `};n.innerHTML=`
  ...
  `,document.head.appendChild(t)},So="__WS_CRM_CAPTURED_AUTH",zi=50*60*1e3,Hr=()=>{try{let t=localStorage.getItem(So);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>zi?(localStorage.removeItem(So),null):e:null}catch{return null}},qi=t=>{try{localStorage.setItem(So,JSON.stringify(t))}catch{}},oe=()=>{let t=Hr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},$r=!1,Ui=()=>{if($r)return;$r=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=Hr()?.authorization;qi({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,v)=>m[v.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,v])=>m[p.toLowerCase()]=v);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Nr=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Vi=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Nr()},Wi=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Rr="__WS_CRM_TEMPLATES_CACHE_V1",ji=24*60*60*1e3,Dr=t=>{try{let e=window.localStorage.getItem(Rr);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>ji?null:o.templates}catch{return null}},Ki=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Rr,JSON.stringify(o))}catch{}},Yi=async t=>{let e=`${te}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:oe()})}catch(s){let l=Dr(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Dr(t);if(s)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items);let i=n.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Wi(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Ki(t,i),i},Xi=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},Ji=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Qi=async t=>{let e=await fetch(Gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Zi=async(t,e,o)=>{let r=`${te}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:oe()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let i=await n.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},es=async(t,e)=>{let o=await fetch(`${te}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},ts=async t=>{let e=await fetch(`${te}/contacts/${t}`,{method:"GET",headers:oe()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},os=async(t,e,o,r)=>{let n;try{n=await es(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await ts(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${te}/proposals/document/${e}`,{method:"PUT",headers:{...oe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let v=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:v}}return{ok:!0}},rs=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Tt="__WS_CRM_PENDING_INSTRUCTIONS",ns=60*1e3,as=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],is=t=>{let e=(t||"").toLowerCase();for(let o of as)if(e.includes(o.matches.toLowerCase()))return o;return null},ss=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Tt,JSON.stringify(r))}catch{}},ls=()=>{try{let t=localStorage.getItem(Tt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ns?(localStorage.removeItem(Tt),null):e}catch{return null}},ds=()=>{try{localStorage.removeItem(Tt)}catch{}},cs=(t,e)=>{document.getElementById(Z)?.remove();let o=document.createElement("div");o.id=Z,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},bs=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,hs=()=>{let t=window.location.pathname.match(bs);if(!t)return;let e=t[1],o=ls();o&&o.proposalId===e&&(ds(),window.setTimeout(()=>{cs(o.title,o.bodyHtml)},600))},Fr="ws-crm-prepare-contract-toast",F=(t,e="info",o=4e3)=>{document.getElementById(Fr)?.remove();let r=document.createElement("div");r.id=Fr;let n=e==="error"?a.crimson:a.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Or=(t,e)=>new Promise(o=>{document.getElementById(Z)?.remove();let r=document.createElement("div");r.id=Z,r.style.cssText=`
    ...
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        ...
        ">
          ...
          ${d.updatedAt?`<div style="font-size: 11px; color: ${a.ash}; margin-top: 4px;">Last updated ${B(i(d.updatedAt))}</div>`:""}
        </button>
      `).join("");n.innerHTML=`
      <div style="
        font-family: ${u.mono};
  ...
  `,Ke=D=>['<option value="">(unset)</option>'].concat(k.map(O=>`<option value="${Q(O)}"${O===D?" selected":""}>${B(O)}</option>`)).join("");_.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${S}">
        ...
        <div style="${x}">${B(i||"(set on Property record)")}</div>
      </div>
      <div style="${S}">
        <div style="${y}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Q(s)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${S}">
  ...
  `,g.appendChild(_),document.body.appendChild(g);let R=_.querySelector("#ws-pc-purchase-price"),le=_.querySelector("#ws-pc-emd"),re=_.querySelector("#ws-pc-cash-at-close"),de=!1;re?.addEventListener("input",()=>{de=!0});let fe=()=>{if(de)return;let D=Number(R?.value||0),O=Number(le?.value||0);re&&(re.value=String(Math.max(0,D-O)))};R?.addEventListener("input",fe),le?.addEventListener("input",fe);let Ye=()=>g.remove();g.addEventListener("click",D=>{D.target===g&&Ye()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Ye);let z=_.querySelector("#ws-pc-submit"),G=_.querySelector("#ws-pc-error");z?.addEventListener("click",async()=>{if(z){G&&(G.textContent=""),z.disabled=!0,z.textContent="Opening\u2026";try{let D=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),O=Number(R?.value||0),we=Number(le?.value||0),xe=Number(re?.value||0),ke=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ee=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Te=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ue=(_.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Se=(_.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(D!==s&&(P.sellerName=D),O!==l&&(P.purchasePrice=O),we!==d&&(P.emd=we),xe!==c&&(P.cashAtClose=xe),ke!==h&&(P.daysToClose=ke),Ee!==m&&(P.inspectionDays=Ee),Te!==p&&(P.additionalTerms=Te),ue!==v&&(P.currentOccupancy=ue),Se!==w&&(P.occupancyAtClose=Se),Object.keys(P).length>0){b.info("[prepare-contract] PA modal submit with overrides:",P),z.textContent="Saving\u2026";let Ot=A(),Pt=await St({tenantId:t,contactId:e,template:o,userId:Ot,overrides:P});b.info("[prepare-contract] re-stage with overrides ok:",Pt),z.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let H=i?`${i} - Purchase Agreement`:void 0;await Ao(t,e,o,H)}catch(D){z.disabled=!1,z.textContent="Open Contract",G&&(G.textContent=D.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",D)}}})},ms=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(Z)?.remove(),Pr();let d=n.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,w=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",g=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",_=s,y=l,E="",T=document.createElement("div");T.id=Z,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Yi(e.tenantId)}catch(i){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${a.crimson}; font-size: 12px;">
        Failed to load templates: ${B(i.message)}
    ...
    `;let l=i.type==="PA"?a.emerald:i.type==="AA"?a.blue:a.coolGray;s.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${B(i.name)}</span>
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=a.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=A();try{if(i.type==="AA"){let h;if(e.oppId)h=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${h} directly`);else{let _;try{_=await Ji(e.tenantId,e.contactId)}catch(y){F(`Failed to load buyer's MT opps: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",y);return}if(_.length===0){F("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(_.length===1)h=_[0].id,b.info(`[prepare-contract] auto-selected MT opp ${h} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${_.length} opps)`);let y=await Or(_,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!y){b.info("[prepare-contract] MT opp picker cancelled");return}h=y,b.info(`[prepare-contract] picked MT opp ${h}`)}}let m=_=>{let y=_.getFullYear(),E=String(_.getMonth()+1).padStart(2,"0"),T=String(_.getDate()).padStart(2,"0");return`${y}-${E}-${T}`},p=_=>{let y=new Date;return y.setDate(y.getDate()+_),m(y)},v=p(45),w=p(7);F("Reading contract data\u2026","info",2500);let k;try{k=await St({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:h,closingDate:v,buyerEarnestDueDate:w,userId:c})}catch(_){F(`Failed to prepare contract: ${_.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",_);return}let g=e.contactId||k.contact_id||"";if(!g){F("Could not resolve buyer contact for this opp.","error",6e3);return}ms({tenantId:e.tenantId,contactId:g,template:i,oppId:h,staged:k,userId:c,defaultClosingDate:v,defaultEMDDueDate:w})}else if(i.type==="PA"){if(!e.contactId){F("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let h;try{h=await Xi(e.tenantId,e.contactId)}catch(v){F(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(h.length===0){F("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let v=await Or(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}F("Reading contract data\u2026","info",2500);let p;try{p=await St({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){F(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}ps({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:p})}else{if(!e.contactId){F("This template needs to be started from a contact page.","error",6e3);return}F(`Opening ${i.name}\u2026`,"info",2500);try{await Ao(e.tenantId,e.contactId,i)}catch(h){F(`Failed to open contract: ${h.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){b.warn("[prepare-contract] picker click handler failed:",h),F(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(s)}},Br=()=>{let t=document.createElement("button");return t.id=To,t.type="button",t.style.cssText=`${C} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${a.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=a.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=a.steel}),t.addEventListener("click",e=>{e.stopPropagation(),us(t)}),t},vs="ws-crm-contact-actions-bar",_s=async()=>{let t=Nr();if(!t){document.getElementById(To)?.remove();return}let e=null;try{e=await I(`#${vs}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(To);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Br();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},me="ws-crm-prepare-contract-button-opp",ze=`${me}-wrap`,ys=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gs=/\/v2\/location\/([A-Za-z0-9]+)/,fs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Co=()=>{let t=window.location.pathname,e=t.match(ys);if(!e)return null;let o=t.match(gs);return o?{oppId:e[1],tenantId:o[1]}:null},ws=async()=>{for(let t of fs)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Et=!1,qe=null,Io=null,ko=null,Eo,Ue=()=>{qe?.disconnect(),qe=null,Io=null},xs=t=>{if(qe&&Io===t)return;Ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Io=t,qe=new MutationObserver(()=>{let o=Co();if(!o||o.oppId!==t){Ue();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}document.getElementById(me)||Gr()}),qe.observe(e,{childList:!0,subtree:!0}))},ks=()=>{ko||(ko=new MutationObserver(()=>{Eo===void 0&&(Eo=window.setTimeout(()=>{Eo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(me);t&&!e&&!Et&&Gr()},300))}),ko.observe(document.body,{childList:!0,subtree:!0}))},Gr=async()=>{if(!Et){Et=!0;try{let t=Co();if(!t){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}let e=document.getElementById(me);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(ze)?.remove(),Ue());return}e&&(e.remove(),document.getElementById(ze)?.remove());let o=await ws();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Co();if(!n||n.oppId!==t.oppId)return;let i=Br();i.id=me,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=ze,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),xs(t.oppId)}finally{Et=!1}}},zr=()=>{hs(),_s()};Ui();function B(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(t){return B(t)}var $t="reos-theme-stylesheet",sn="reos-theme-fonts",Es=()=>{let t=document.getElementById(sn);t&&t.remove()},Ts=`
/* ============================================
