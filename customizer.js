/* Wholesaling CRM Customizer v0.14.16 — built 2026-05-30T03:32:49.992Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Te="[wholesaling-crm-customizer]",wr="__WS_CRM_DEBUG",xr=()=>!!window[wr],b={info(...t){console.log(Te,...t)},warn(...t){console.warn(Te,...t)},error(...t){console.error(Te,...t)},debug(...t){xr()&&console.log(Te,"[debug]",...t)}};var eo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,it=/\/v2\/location\/([A-Za-z0-9]+)/,kr=t=>{let e=t.match(eo);if(!e)return null;let o=t.match(it);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Er=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(eo);if(!n)continue;let a=r.match(it)||window.location.pathname.match(it);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let t=kr(window.location.pathname);return t||Er()};var to=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ce="",lt=null,te="other",dt=new Set,Se=()=>{let t=S()?.contactId??null;if(!(!(window.location.pathname!==Ce)&&!(t!==lt))){Ce=window.location.pathname,lt=t,te=to(),b.debug("Page/context changed:",te,Ce,"contact:",t);for(let r of dt)try{r(te)}catch(n){b.error("Subscriber threw:",n)}}},oo=t=>(dt.add(t),setTimeout(()=>t(te),0),()=>{dt.delete(t)}),ro=()=>{te=to(),Ce=window.location.pathname,lt=S()?.contactId??null,b.debug("Router init, current page:",te);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Se()},history.replaceState=function(o,r,n){e(o,r,n),Se()},window.addEventListener("popstate",Se),setInterval(Se,1e3)};var Ie="0.14.16",Ae="2026-05-30T03:32:49.993Z";var C=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let l=n.querySelector(t);if(l){a(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},_={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ct={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},no=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Tr=/^[A-Za-z0-9]{15,30}$/,ne=t=>typeof t=="string"&&Tr.test(t),Sr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Cr=()=>{let t=window.WS_CRM_USER_ID;return ne(t)?t:null},Ir=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ne(o))return o;return null},Ar=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Sr(e);if(!o)return null;let r=o.uid;if(ne(r))return r;let n=o.claims;if(n&&ne(n.user_id))return n.user_id}catch{}return null},Lr=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ne(n))return n}catch{}}}catch{}return null},I=()=>Cr()||Ir()||Ar()||Lr()||null;var lo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Mr=`${lo}/active-follow-up-get`,Dr=`${lo}/active-follow-up-set`,Y="ws-crm-active-follow-up-button",ht={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},Fr=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Hr=async t=>{let e=await fetch(Mr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Pr=async(t,e)=>{let o=await fetch(Dr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},X=(t,e)=>{let o=ht[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},ao=t=>{let e=document.createElement("button");return e.type="button",e.id=Y,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Pe();!o||!o.locationId||o.oppId!==t||kn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},Tn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sn=async()=>{for(let t of Tn)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,yt=async()=>{if(!He){He=!0;try{await Cn()}finally{He=!1}}},Cn=async()=>{let t=Pe();if(!t||!t.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),de();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),de());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let o=await Sn();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Pe();if(!n||n.oppId!==t.oppId)return;let a=En(t.oppId),i=document.createElement("span");i.id=`${H}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),In(t.oppId)},le=null,vt=null,de=()=>{le?.disconnect(),le=null,vt=null},In=t=>{if(le&&vt===t)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(vt=t,le=new MutationObserver(()=>{let o=Pe();if(!o||o.oppId!==t){de();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),de();return}document.getElementById(H)||yt()}),le.observe(e,{childList:!0,subtree:!0}))},ut=null,_t,An=()=>{ut||(ut=new MutationObserver(()=>{_t===void 0&&(_t=window.setTimeout(()=>{_t=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);t&&!e&&!He&&yt()},300))}),ut.observe(document.body,{childList:!0,subtree:!0}))},Ao=()=>{An(),yt()};var Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",P="ws-crm-not-interested-button",Mn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dn=/\/v2\/location\/([A-Za-z0-9]+)/,Oe=()=>{let t=window.location.pathname,e=t.match(Mn);if(!e)return null;let o=t.match(Dn);return{oppId:e[1],locationId:o?o[1]:null}},Fn=async t=>{let e=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Hn=t=>{let e=document.createElement("button");return e.id=P,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Oe();if(!o||!o.locationId||o.oppId!==t)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Fn({oppId:o.oppId,locationId:o.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Pn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$n=async()=>{for(let t of Pn)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$e=!1,xt=async()=>{if(!$e){$e=!0;try{await On()}finally{$e=!1}}},On=async()=>{let t=Oe();if(!t||!t.locationId){document.getElementById(P)?.remove(),document.getElementById(`${P}-wrap`)?.remove(),be();return}let e=document.getElementById(P);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove(),be());return}e&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove());let o=await $n();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Oe();if(!n||n.oppId!==t.oppId)return;let a=Hn(t.oppId),i=document.createElement("span");i.id=`${P}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Nn(t.oppId)},ce=null,wt=null,be=()=>{ce?.disconnect(),ce=null,wt=null},Nn=t=>{if(ce&&wt===t)return;be();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wt=t,ce=new MutationObserver(()=>{let o=Oe();if(!o||o.oppId!==t){be();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(P)?.remove(),document.getElementById(`${P}-wrap`)?.remove(),be();return}document.getElementById(P)||xt()}),ce.observe(e,{childList:!0,subtree:!0}))},gt=null,ft,Bn=()=>{gt||(gt=new MutationObserver(()=>{ft===void 0&&(ft=window.setTimeout(()=>{ft=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(P);t&&!e&&!$e&&xt()},300))}),gt.observe(document.body,{childList:!0,subtree:!0}))},Lo=()=>{Bn(),xt()};var Rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",$="ws-crm-reduce-price-button",Mo="ws-crm-reduce-price-modal",Gn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zn=/\/v2\/location\/([A-Za-z0-9]+)/,Re=()=>{let t=window.location.pathname,e=t.match(Gn);if(!e)return null;let o=t.match(zn);return{oppId:e[1],locationId:o?o[1]:null}},Un=async t=>{let e=await fetch(Rn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ne=()=>{document.getElementById(Mo)?.remove()},qn=t=>{Ne();let e=document.createElement("div");e.id=Mo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),a=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Ne()}),a?.addEventListener("click",()=>{Ne()}),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{await Un({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:I()}),Ne(),t.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",a&&(a.disabled=!1)}})},Vn=(t,e)=>{let o=document.createElement("button");return o.id=$,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Re();!r||!r.locationId||r.oppId!==t||qn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),a=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,a&&(a.style.background=s.emerald,a.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=L,a&&(a.style.background=s.amber,a.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},Wn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jn=async()=>{for(let t of Wn)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Be=!1,St=async()=>{if(!Be){Be=!0;try{await Kn()}finally{Be=!1}}},Kn=async()=>{let t=Re();if(!t||!t.locationId){document.getElementById($)?.remove(),document.getElementById(`${$}-wrap`)?.remove(),pe();return}let e=document.getElementById($);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${$}-wrap`)?.remove(),pe());return}e&&(e.remove(),document.getElementById(`${$}-wrap`)?.remove());let o=await jn();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Re();if(!n||n.oppId!==t.oppId)return;let a=Vn(t.oppId,t.locationId),i=document.createElement("span");i.id=`${$}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Yn(t.oppId)},he=null,Tt=null,pe=()=>{he?.disconnect(),he=null,Tt=null},Yn=t=>{if(he&&Tt===t)return;pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Tt=t,he=new MutationObserver(()=>{let o=Re();if(!o||o.oppId!==t){pe();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById($)?.remove(),document.getElementById(`${$}-wrap`)?.remove(),pe();return}document.getElementById($)||St()}),he.observe(e,{childList:!0,subtree:!0}))},kt=null,Et,Xn=()=>{kt||(kt=new MutationObserver(()=>{Et===void 0&&(Et=window.setTimeout(()=>{Et=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById($);t&&!e&&!Be&&St()},300))}),kt.observe(document.body,{childList:!0,subtree:!0}))},Do=()=>{Xn(),St()};var Po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",j="ws-crm-send-to-closing-office-button",J="ws-crm-send-to-title-co-wrap",Ue="ws-crm-stc-dropdown",Jn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zn=/\/v2\/location\/([A-Za-z0-9]+)/,qe=()=>{let t=window.location.pathname,e=t.match(Jn);if(!e)return null;let o=t.match(Zn);return{oppId:e[1],locationId:o?o[1]:null}},Qn=5*60*1e3,$o=t=>`ws-crm-stc-cache:${t}`,ea=t=>{try{let e=window.localStorage.getItem($o(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Qn||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},ta=(t,e)=>{try{window.localStorage.setItem($o(t),JSON.stringify(e))}catch{}},oa=async(t,e)=>{try{let o=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},ra=async(t,e,o)=>{let r=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},na=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},Fo=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},aa=(t,e)=>{if(e&&na(e)){window.setTimeout(()=>Fo(t),300);return}Fo(t)},O=()=>{document.getElementById(Ue)?.remove()},Ge=(t,e,o)=>{O();let r=document.createElement("div");r.id=Ue;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(a)}`),ba(t.oppId)},me=null,At=null,ue=()=>{me?.disconnect(),me=null,At=null},ba=t=>{if(me&&At===t)return;ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(At=t,me=new MutationObserver(()=>{let o=qe();if(!o||o.oppId!==t){ue();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(j)?.remove(),document.getElementById(J)?.remove(),O(),ue();return}document.getElementById(j)||Lt()}),me.observe(e,{childList:!0,subtree:!0}))},Ct=null,It,ha=()=>{Ct||(Ct=new MutationObserver(()=>{It===void 0&&(It=window.setTimeout(()=>{It=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);if(t&&!e&&!ze){let o=qe();if(o&&Ve.has(o.oppId))return;Lt()}},300))}),Ct.observe(document.body,{childList:!0,subtree:!0}))},Oo=()=>{ha(),Lt()};var pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ma="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ua="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ro="ldtyB2UXKi9vOp8nLUH7",_a="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",Go="ws-crm-closing-agent-picker-modal",va=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ya=/\/v2\/location\/([A-Za-z0-9]+)/,ye=()=>{let t=window.location.pathname,e=t.match(va);if(!e)return null;let o=t.match(ya);return{oppId:e[1],locationId:o?o[1]:null}},Nt=async t=>{let e=await fetch(pa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},No=async t=>{let e=await fetch(ma,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ga=async(t,e)=>{try{let o=await fetch(ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Ro}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Nt({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},Z=null,fa=60*60*1e3,Bt=t=>`ws-crm-to-cache:${t}`,zo=t=>{try{let e=window.localStorage.getItem(Bt(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>fa||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Uo=(t,e,o)=>{try{window.localStorage.setItem(Bt(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},wa=t=>{try{window.localStorage.removeItem(Bt(t))}catch{}},Ht="ws-crm-closing-agent-field-link",xa=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ht}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Mt=!1,Rt=async t=>{if(Mt)return;let e=qo();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Mt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Nt({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Pt(n.id,n.name,t);let a=document.getElementById(N);if(a){K(a,{status:"linked",contactName:n.name});let i=ye();i&&Uo(i.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Mt=!1}}},ka=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,qo=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();ka.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Pt=(t,e,o)=>{let r=qo();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${Ht}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=Ht,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},We=()=>{document.getElementById(Go)?.remove()},Ea=t=>{We();let e=document.createElement("div");e.id=Go,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),a=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&We()}),a?.addEventListener("click",We);let i,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},za=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(Xe)?.remove();let n=r.debug||{},a=typeof n.propertyAddress=="string"?n.propertyAddress:"",i=typeof n.sellerName=="string"?n.sellerName:"",l=typeof n.purchasePrice=="number"?n.purchasePrice:0,d=typeof n.emd=="number"?n.emd:0,c=typeof n.cashAtClose=="number"?n.cashAtClose:l-d,h=n.daysToClose===void 0||n.daysToClose===null||n.daysToClose===""?"":String(n.daysToClose),m=n.inspectionDays===void 0||n.inspectionDays===null||n.inspectionDays===""?"":String(n.inspectionDays),p=typeof n.additionalTerms=="string"?n.additionalTerms:"",u=document.createElement("div");u.id=Xe,u.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,u.appendChild(v),document.body.appendChild(u);let T=v.querySelector("#ws-pc-purchase-price"),k=v.querySelector("#ws-pc-emd"),A=v.querySelector("#ws-pc-cash-at-close"),F=!1;A?.addEventListener("input",()=>{F=!0});let ee=()=>{if(F)return;let G=Number(T?.value||0),Ee=Number(k?.value||0);A&&(A.value=String(Math.max(0,G-Ee)))};T?.addEventListener("input",ee),k?.addEventListener("input",ee);let Kt=()=>u.remove();u.addEventListener("click",G=>{G.target===u&&Kt()}),v.querySelector("#ws-pc-cancel")?.addEventListener("click",Kt);let q=v.querySelector("#ws-pc-submit"),ke=v.querySelector("#ws-pc-error");q?.addEventListener("click",async()=>{if(q){ke&&(ke.textContent=""),q.disabled=!0,q.textContent="Opening\u2026";try{let G=(v.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ee=Number(T?.value||0),Yt=Number(k?.value||0),Xt=Number(A?.value||0),Jt=(v.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Zt=(v.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Qt=(v.querySelector("#ws-pc-additional-terms")?.value??"").trim(),B={};if(G!==i&&(B.sellerName=G),Ee!==l&&(B.purchasePrice=Ee),Yt!==d&&(B.emd=Yt),Xt!==c&&(B.cashAtClose=Xt),Jt!==h&&(B.daysToClose=Jt),Zt!==m&&(B.inspectionDays=Zt),Qt!==p&&(B.additionalTerms=Qt),Object.keys(B).length>0){b.info("[prepare-contract] PA modal submit with overrides:",B),q.textContent="Saving\u2026";let gr=I(),fr=await Ut({tenantId:t,contactId:e,template:o,userId:gr,overrides:B});b.info("[prepare-contract] re-stage with overrides ok:",fr),q.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");await qt(t,e,o)}catch(G){q.disabled=!1,q.textContent="Open Contract",ke&&(ke.textContent=G.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",G)}}})},Ua=({tenantId:t,contactId:e,template:o,mtOpps:r,userId:n})=>{document.getElementById(Xe)?.remove();let a=document.createElement("div");a.id=Xe,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Oa(e.tenantId)}catch(a){o.innerHTML=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),qa(t)}),t},Wa="ws-crm-contact-actions-bar",ja=async()=>{let t=Xo();if(!t){document.getElementById(Gt)?.remove();return}let e=null;try{e=await C(`#${Wa}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Gt);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Va();r.dataset.contactId=t.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Jo=()=>{ja()};Pa();function U(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ge(t){return U(t)}var nt="reos-theme-stylesheet",ur="reos-theme-fonts",Ka=()=>{let t=document.getElementById(ur);t&&t.remove()},Ya=`
/* ============================================
