/* Wholesaling CRM Customizer v0.13.52 — built 2026-05-26T18:28:03.201Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var oe="[wholesaling-crm-customizer]",Gt="__WS_CRM_DEBUG",$t=()=>!!window[Gt],c={info(...o){console.log(oe,...o)},warn(...o){console.warn(oe,...o)},error(...o){console.error(oe,...o)},debug(...o){$t()&&console.log(oe,"[debug]",...o)}};var ze=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ce=/\/v2\/location\/([A-Za-z0-9]+)/,Vt=o=>{let e=o.match(ze);if(!e)return null;let t=o.match(Ce);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ut=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ze);if(!n)continue;let a=r.match(Ce)||window.location.pathname.match(Ce);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},T=()=>{let o=Vt(window.location.pathname);return o||Ut()};var We=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ne="",Ae=null,G="other",Ie=new Set,re=()=>{let o=T()?.contactId??null;if(!(!(window.location.pathname!==ne)&&!(o!==Ae))){ne=window.location.pathname,Ae=o,G=We(),c.debug("Page/context changed:",G,ne,"contact:",o);for(let r of Ie)try{r(G)}catch(n){c.error("Subscriber threw:",n)}}},je=o=>(Ie.add(o),setTimeout(()=>o(G),0),()=>{Ie.delete(o)}),Ke=()=>{G=We(),ne=window.location.pathname,Ae=T()?.contactId??null,c.debug("Router init, current page:",G);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),re()},history.replaceState=function(t,r,n){e(t,r,n),re()},window.addEventListener("popstate",re),setInterval(re,1e3)};var ae="0.13.52",se="2026-05-26T18:28:03.202Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},w={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Le={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},ie=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var qt=/^[A-Za-z0-9]{15,30}$/,z=o=>typeof o=="string"&&qt.test(o),zt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Wt=()=>{let o=window.WS_CRM_USER_ID;return z(o)?o:null},jt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(z(t))return t;return null},Kt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=zt(e);if(!t)return null;let r=t.uid;if(z(r))return r;let n=t.claims;if(n&&z(n.user_id))return n.user_id}catch{}return null},Yt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(z(n))return n}catch{}}}catch{}return null},A=()=>Wt()||jt()||Kt()||Yt()||null;var Qe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Xt=`${Qe}/active-follow-up-get`,Jt=`${Qe}/active-follow-up-set`,O="ws-crm-active-follow-up-button",De={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Qt=()=>{let o=T();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zt=async o=>{let e=await fetch(Xt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},eo=async(o,e)=>{let t=await fetch(Jt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},B=(o,e)=>{let t=De[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ye=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,B(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Qt();if(!(!r||r.contactId!==o)){B(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await eo(r,A()),a=n&&n.state&&n.state in De?n.state:"blue";B(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),B(e,"error"),setTimeout(()=>void le(e,r),4e3)}}}),e},le=async(o,e)=>{B(o,"loading");try{let t=await Zt(e),r=t&&t.state&&t.state in De?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;B(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),B(o,"error")}},to=[".central-panel","[class*='central-panel']"],Fe="ws-crm-contact-actions-bar",oo=async()=>{for(let o of to)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ro=async(o,e)=>{let t=e.querySelector(`#${Fe}`);if(!t)try{t=await C(`#${Fe}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,t.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Le[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=l.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=Le[d.color]),m&&(m.textContent=d.label),s.style.display="none";let v=T()?.locationId,y=A();if(!v){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!y){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let g=h?.textContent??"\u25BE",f=async u=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await go({contactId:o,locationId:v,status:d.label,userId:y,deadReason:u,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=g),i.style.opacity="1"},900)}catch(x){c.warn("Call Status webhook failed:",x),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=g),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let u=m?.textContent??"";Co(x=>{f(x)},()=>{m&&(m.textContent=u)});return}if(e==="seller"&&d.value==="appointment-booked"){let u=m?.textContent??"";try{(await fo({contactId:o,tenantId:v})).ok?await f():Ao(()=>{f()},()=>{m&&(m.textContent=u)})}catch(x){c.warn("Appointment sanity check failed; firing anyway:",x),await f()}return}await f()}),s.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},So=o=>{document.getElementById(st)?.remove();let e=document.createElement("div");e.id=st,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(_=>{p[_.group]||(p[_.group]=[]),p[_.group].push(_)});let m=[...b.filter(_=>p[_]),...Object.keys(p).filter(_=>!b.includes(_))];for(let _ of m){let v=p[_],y=document.createElement("div");y.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${w.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${l.steel};
    `,g.textContent=_,y.appendChild(g),v.forEach(f=>{let u=document.createElement("div"),x=!f.filled&&f.navigable&&f.field_id;u.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${x?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,x&&(u.addEventListener("mouseenter",()=>{u.style.background=l.slate}),u.addEventListener("mouseleave",()=>{u.style.background="transparent"}),u.addEventListener("click",I=>{I.stopPropagation(),f.field_id&&(Jo(f.field_id,f.folder),M())}));let S=f.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=x?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";u.innerHTML=`${S}<span style="flex: 1;">${f.label}</span>${k}`,y.appendChild(u)}),r.appendChild(y)}document.body.appendChild(r);let h=_=>{let v=_.target;!r.contains(v)&&!t.contains(v)&&(M(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},D=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,s=l.bone,d,b="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",i=l.steel,s=l.ash,d=l.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let _=e.checks?.filter(y=>y.filled).length??0,v=e.checks?.length??0;a="transparent",i=l.amber,s=l.amber,d=l.amber,b=`${_} of ${v} fields ready`,p="\u25BE";break}case"sending":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=l.amber,s=l.amber,d=l.amber,b=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=s,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=b),n&&(n.textContent=p)},Qo=(o,e)=>{let t=document.createElement("button");t.id=U,t.type="button",t.dataset.oppId=o;let r={status:"checking"};t.style.cssText=`
    ${P}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,D(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let m=await Ko(o,e);if(!m){r={status:"error",message:"Check failed \u2014 click to retry"},D(t,r);return}if(!Array.isArray(m.checks)||m.checks.length===0){r={status:"error",message:m.error||"Check failed \u2014 click to retry"},D(t,r),c.warn("[stc] dry_run returned no checks:",m);return}let h=m.checks;if(r.checks&&r.checks.length===m.checks.length){let v=new Set;h=m.checks.map((y,g)=>r.checks[g]?.filled&&!y.filled?n.has(y.label)?y:(v.add(y.label),{...y,filled:!0}):y),n=v}else n=new Set;r={status:h.every(v=>v.filled)?"ready":"incomplete",checks:h,previouslySentAt:m.previously_sent_at??null},D(t,r),document.getElementById(ve)&&me(h,m.previously_sent_at,t)},i=async()=>{let m=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},D(t,r),M();try{let h=await Yo(o,e,m);if(h.needs_confirm){r={status:"ready",checks:h.checks,previouslySentAt:h.previously_sent_at},D(t,r),h.checks&&me(h.checks,h.previously_sent_at,t);return}if(h.ok){r={status:"sent",checks:h.checks,previouslySentAt:new Date().toISOString()},D(t,r),window.setTimeout(()=>{a()},3500);return}r={status:"error",checks:h.checks,message:h.error||"Validation failed"},D(t,r),h.checks&&me(h.checks,h.previously_sent_at,t)}catch(h){c.error("[stc] send failed:",h),r={status:"error",message:"Network error \u2014 click to retry"},D(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(ve)?M():r.checks&&me(r.checks,r.previouslySentAt,t);break}case"error":case"sent":a();break}}),a();let s,d=Date.now(),b=5e3,p=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(p){let m=new MutationObserver(()=>{if(s!==void 0)return;let _=Date.now()-d,v=Math.max(1500,b-_);s=window.setTimeout(()=>{s=void 0,r.status!=="sending"&&(d=Date.now(),a())},v)});m.observe(p,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let h=window.setInterval(()=>{document.body.contains(t)||(m.disconnect(),s!==void 0&&window.clearTimeout(s),window.clearInterval(h))},5e3)}return t},Zo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],er=async()=>{for(let o of Zo)try{let e=await C(o,{timeoutMs:1500});if(e)return c.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_e=!1,Ue=async()=>{if(_e){c.info("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_e=!0;try{await tr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{_e=!1}},tr=async()=>{c.info("[stc] mount:01 ensureMountedImpl entered");let o=$e();if(!o||!o.locationId){c.info(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(U)?.remove(),document.getElementById(J)?.remove(),M();return}c.info(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(U);if(e&&e.dataset.oppId===o.oppId){c.info("[stc] mount:03-SKIP existing button for same opp");let s=R();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(J)?.remove(),M(),ue());return}e&&(c.info("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(J)?.remove(),M()),c.info("[stc] mount:04 calling findMountTarget");let t=await er();if(!t){c.info("[stc] mount:04-BAIL findMountTarget returned null");return}c.info(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`),c.info("[stc] mount:05 calling waitForOppPipelineName");let r=await be();if(c.info(`[stc] mount:05 pipeline detected = "${r}"`),r!=="Transaction Coordination"){c.info(`[stc] mount:05-BAIL gated off \u2014 pipeline="${r}" (expected Transaction Coordination)`);return}let n=$e();if(!n||n.oppId!==o.oppId||!n.locationId){c.info(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}c.info("[stc] mount:06 building button");let a=Qo(o.oppId,n.locationId),i=document.createElement("span");i.id=J,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.info(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),or(o.oppId)},Q=null,Ve=null,ue=()=>{Q?.disconnect(),Q=null,Ve=null},or=o=>{if(Q&&Ve===o)return;ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ve=o,Q=new MutationObserver(()=>{let t=$e();if(!t||t.oppId!==o){ue();return}let r=R();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(U)?.remove(),document.getElementById(J)?.remove(),M(),ue();return}document.getElementById(U)||Ue()}),Q.observe(e,{childList:!0,subtree:!0}))},Re=null,Ge,rr=()=>{Re||(Re=new MutationObserver(()=>{Ge===void 0&&(Ge=window.setTimeout(()=>{Ge=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);o&&!e&&!_e&&Ue()},300))}),Re.observe(document.body,{childList:!0,subtree:!0}))},ft=()=>{rr(),Ue()};var ke="reos-theme-stylesheet",Pt="reos-theme-fonts",nr=()=>{let o=document.getElementById(Pt);o&&o.remove()},ar=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var F=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},Rt=()=>{c.info(`Loaded v${ae} (built ${se})`),F("mountVersionBadge (initial)",Ee),F("mountFavicon",ut),F("mountThemeStylesheet",Ot),F("initPageRouter",Ke),c.info("[main] registering onPageChange subscriber"),je(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),F("mountVersionBadge",Ee),F("mountClaimReleaseToggle",rt),F("mountContactActionsBar",mt),F("mountActiveFollowUpButton",Ze),F("mountNotInterestedButton",vt),F("mountSendToTitleCoButton",ft)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Rt):Rt();})();
