/* Wholesaling CRM Customizer v0.26.7 — built 2026-06-10T04:06:26.938Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var $t="[wholesaling-crm-customizer]",Fi="__WS_CRM_DEBUG",Bi=()=>!!window[Fi],p={info(...t){console.log($t,...t)},warn(...t){console.warn($t,...t)},error(...t){console.error($t,...t)},debug(...t){Bi()&&console.log($t,"[debug]",...t)}};var Ri=/\/v2\/location\/([A-Za-z0-9]+)/,Ni=new Set(["8ntUQzMflUkR0YvrRgVk"]),Me=()=>{let t=window.location.pathname.match(Ri);return t?t[1]:null},Ro=()=>{let t=Me();return t!==null&&Ni.has(t)};var yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,No=/\/v2\/location\/([A-Za-z0-9]+)/,zi=t=>{let e=t.match(yn);if(!e)return null;let o=t.match(No);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Gi=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(yn);if(!a)continue;let i=r.match(No)||window.location.pathname.match(No);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=zi(window.location.pathname);return t||Gi()};var gn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ot="",zo=null,Oe="other",Go=new Set,Mt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Ot)&&!(t!==zo))){Ot=window.location.pathname,zo=t,Oe=gn(),p.debug("Page/context changed:",Oe,Ot,"contact:",t);for(let r of Go)try{r(Oe)}catch(a){p.error("Subscriber threw:",a)}}},Dt=t=>(Go.add(t),setTimeout(()=>t(Oe),0),()=>{Go.delete(t)}),fn=()=>{Oe=gn(),Ot=window.location.pathname,zo=P()?.contactId??null,p.debug("Router init, current page:",Oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Mt()},history.replaceState=function(o,r,a){e(o,r,a),Mt()},window.addEventListener("popstate",Mt),setInterval(Mt,1e3)};var Pt="0.26.7",Ht="2026-06-10T04:06:26.939Z";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},qo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},wn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var qi=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&qi.test(t),xn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ui=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},Vi=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},Wi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xn(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},ji=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},L=()=>Ui()||Vi()||Wi()||ji()||null,Ki=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xn(e);return o?o.claims??o:null}catch{return null}},kn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ki()?.type==="agency"};var Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Yi=`${Cn}/active-follow-up-get`,Ji=`${Cn}/active-follow-up-set`,we="ws-crm-active-follow-up-button",Vo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Xi=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Qi=async t=>{let e=await fetch(Yi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Zi=async(t,e)=>{let o=await fetch(Ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},xe=(t,e)=>{let o=Vo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},En=t=>{let e=document.createElement("button");return e.type="button",e.id=we,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,xe(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Xi();if(!(!r||r.contactId!==t)){xe(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Zi(r,L()),i=a&&a.state&&a.state in Vo?a.state:"blue";xe(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),xe(e,"error"),setTimeout(()=>void Ft(e,r),4e3)}}}),e},Ft=async(t,e)=>{xe(t,"loading");try{let o=await Qi(e),r=o&&o.state&&o.state in Vo?o.state:"gray",a=document.getElementById(we);if(!a||a.dataset.contactId!==e.contactId)return;xe(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),xe(t,"error")}},es=[".central-panel","[class*='central-panel']"],Uo="ws-crm-contact-actions-bar",ts=async()=>{for(let t of es)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},os=async(t,e)=>{let o=e.querySelector(`#${Uo}`);if(!o)try{o=await M(`#${Uo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,C=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let H=await bs(t,e,s.granularity,g);if(!H.ok){T&&(T.textContent=H.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(H){T&&(T.textContent=`Network error: ${H.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Wo=!1,De=null,ot=null,Ln=()=>{document.getElementById($n)?.remove(),document.getElementById(Ko)?.remove(),ot&&De&&De.nav.removeEventListener("click",ot,!0),ot=null,De=null,zt=!1},Dn=()=>{Cs()},Cs=async()=>{if(!Wo){Wo=!0;try{let t=P();if(!t){Ln();return}let e=document.getElementById(Ko);if(e&&e.dataset.buyerContactId===t.contactId&&De)return;Ln();let o=null;try{o=await Bt(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Rt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([gs(),fs()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=xs(t.locationId,t.contactId),d=Ts(()=>De),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};De=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),ot=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&zt&&Mn(c,!1)},a.addEventListener("click",ot,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Wo=!1}}};var ue="ws-crm-claim-release-pill",As="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Is="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Ls=async t=>{let e=await fetch(As,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},$s=async t=>{let e=await fetch(Is,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Fn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Pe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=wn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Wt();!o||!o.locationId||o.oppId!==t||il({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},ll=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dl=async()=>{for(let t of ll)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vt=!1,rr=async()=>{if(!Vt){Vt=!0;try{await cl()}finally{Vt=!1}}},cl=async()=>{let t=Wt();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=await dl();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Wt();if(!a||a.oppId!==t.oppId)return;let i=sl(t.oppId),s=document.createElement("span");s.id=`${oe}-wrap`,s.style.cssText=`
    ...
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),pl(t.oppId)},nt=null,or=null,at=()=>{nt?.disconnect(),nt=null,or=null},pl=t=>{if(nt&&or===t)return;at();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(or=t,nt=new MutationObserver(()=>{let o=Wt();if(!o||o.oppId!==t){at();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at();return}document.getElementById(oe)||rr()}),nt.observe(e,{childList:!0,subtree:!0}))},er=null,tr,bl=()=>{er||(er=new MutationObserver(()=>{tr===void 0&&(tr=window.setTimeout(()=>{tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!Vt&&rr()},300))}),er.observe(document.body,{childList:!0,subtree:!0}))},Xn=()=>{bl(),rr()};var hl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",re="ws-crm-not-interested-button",ml=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ul=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(ml);if(!e)return null;let o=t.match(ul);return{oppId:e[1],locationId:o?o[1]:null}},vl=async t=>{let e=await fetch(hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},_l=t=>{let e=document.createElement("button");return e.id=re,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Zt();!r||!r.locationId||r.oppId!==t||Rl({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},zl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gl=async()=>{for(let t of zl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qt=!1,vr=async()=>{if(!Qt){Qt=!0;try{await ql()}finally{Qt=!1}}},ql=async()=>{let t=Zt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await Gl();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Zt();if(!a||a.oppId!==t.oppId)return;let i=Nl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Be(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Ul(t.oppId)},ct=null,ur=null,pt=()=>{ct?.disconnect(),ct=null,ur=null},Ul=t=>{if(ct&&ur===t)return;pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ur=t,ct=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==t){pt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt();return}document.getElementById(ne)||vr()}),ct.observe(e,{childList:!0,subtree:!0}))},hr=null,mr,Vl=()=>{hr||(hr=new MutationObserver(()=>{mr===void 0&&(mr=window.setTimeout(()=>{mr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!Qt&&vr()},300))}),hr.observe(document.body,{childList:!0,subtree:!0}))},ra=()=>{Vl(),vr()};var Re="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",eo="deals.reinvestos.com";var ae="ws-crm-edit-landing-button",Wl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jl=/\/v2\/location\/([A-Za-z0-9]+)/,oo=()=>{let t=window.location.pathname,e=t.match(Wl);if(!e)return null;let o=t.match(jl);return{oppId:e[1],locationId:o?o[1]:null}},Kl=(t,e)=>{let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();return r&&o.searchParams.set("user",r),o.toString()},Yl=(t,e)=>{let o=document.createElement("button");return o.id=ae,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=oo();if(!r||!r.locationId||r.oppId!==t)return;if(!Re){p.warn("[edit-landing] editor session key not configured in this build");return}let a=Kl(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Jl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xl=async()=>{for(let t of Jl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},to=!1,fr=async()=>{if(!to){to=!0;try{await Ql()}finally{to=!1}}},Ql=async()=>{let t=oo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Xl();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=oo();if(!a||a.oppId!==t.oppId)return;let i=Yl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Be(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Zl(t.oppId)},bt=null,gr=null,ht=()=>{bt?.disconnect(),bt=null,gr=null},Zl=t=>{if(bt&&gr===t)return;ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gr=t,bt=new MutationObserver(()=>{let o=oo();if(!o||o.oppId!==t){ht();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}document.getElementById(ae)||fr()}),bt.observe(e,{childList:!0,subtree:!0}))},_r=null,yr,ed=()=>{_r||(_r=new MutationObserver(()=>{yr===void 0&&(yr=window.setTimeout(()=>{yr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!to&&fr()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},na=()=>{ed(),fr()};var ia="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ne="ws-crm-publish-button",mt="ws-crm-publish-wrap",no="ws-crm-publish-dropdown",td=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,od=/\/v2\/location\/([A-Za-z0-9]+)/,kr=()=>{let t=window.location.pathname,e=t.match(td);if(!e)return null;let o=t.match(od);return{oppId:e[1],locationId:o?o[1]:null}},rd=async(t,e)=>{try{let o=await fetch(ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:L()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},nd=async(t,e)=>{let o=await fetch(ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:L()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ad=(t,e)=>{if(!Re){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},be=()=>{document.getElementById(no)?.remove()},aa=(t,e,o,r,a)=>{be();let i=document.createElement("div");i.id=no;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,le(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Ed(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},le(o,a);return}if(w.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},le(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},le(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),po.add(t),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie(),yt();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},kd(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),le(o,a),document.getElementById(lo)&&io(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},le(o,a),ie();try{let y=await Td(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},le(o,a),y.checks&&io(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},le(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},le(o,a),y.checks&&io(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},le(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(lo)?ie():a.checks&&io(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!c){if(Date.now()<_){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,C=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},C)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Id=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ld=async()=>{for(let t of Id)try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},po=new Set,_a=null,$d=t=>{t&&t!==_a&&(po.clear(),_a=t)},so=!1,Mr=async()=>{if(so){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}so=!0;try{await Md()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{so=!1}},Md=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=co();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),$d(t.oppId),po.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie();return}let e=document.getElementById(ve);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=D();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Ee)?.remove(),ie(),yt());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Ee)?.remove(),ie()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Ld();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=D();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=co();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Ad(t.oppId,a.locationId),s=document.createElement("span");s.id=Ee,s.style.cssText=`
    ...
    vertical-align: middle;
    order: 3;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Od(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Od=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=co();if(!o||o.oppId!==t){yt();return}let r=D();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie(),yt();return}document.getElementById(ve)||Mr()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Dd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ve);if(t&&!e&&!so){let o=co();if(o&&po.has(o.oppId))return;Mr()}},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},fa=()=>{Dd(),Mr()};var Pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Pd=`${Pr}/tc/welcome-call-prefill`,Hd=`${Pr}/tc/welcome-call-save`,Fd=`${Pr}/tc/order-lockbox`,gt="ws-crm-welcome-call-overlay",Bd=["Regular Contract","Subject To","Seller Finance","Novation"],Rd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Nd=["Gas","Electric","Propane","Oil"],zd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Gd=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],_e=["Yes","No"],qd=["Yes","No","Unknown"],Ud=["Professional Photographer","Seller","Tenant"],Vd=["Month-to-Month","Annual"],wa=["Current","Behind"],Wd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],de=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),ho=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ea="margin-bottom:12px;",Ta=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,jd=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,xa=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),G=(t,e,o)=>{let r=xa(o);return`<select id="${t}" style="${ho}"><option value=""></option>${e.map(a=>`<option ${r!==""&&xa(a)===r?"selected":""}>${de(a)}</option>`).join("")}</select>`},K=(t,e,o="")=>`<input id="${t}" type="text" value="${de(e)}" placeholder="${de(o)}" style="${ho}">`,Kd=(t,e)=>`<textarea id="${t}" rows="3" style="${ho}resize:vertical;">${de(e)}</textarea>`,Yd=(t,e)=>`<input id="${t}" type="date" value="${de(e)}" style="${ho}">`,$=(t,e)=>`<div style="${Ea}"><label style="${Ta}">${de(t)}</label>${e}</div>`,Or=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Wd.map(r=>`<label style="${jd}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},he=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${de(t)}</div>`,ze=()=>{document.getElementById(gt)?.remove()},Te=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Jd=t=>{let e=t.tenant||{};return`
    ${he("Identifiers")}
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(Zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){p.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let c=d.target;!o.contains(c)&&!e.contains(c)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},lc=(t,e)=>{Ce();let o=document.createElement("div");o.id=Ia;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},uo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=J:o.style.cssText=O,o.textContent=t,o},dc=()=>{let t=uo("\u22EE","ghost");return t.style.padding="6px 11px",t.style.fontWeight="700",t.style.lineHeight="1",t},cc=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===$a){let r=uo("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>ic(t)),o.appendChild(r),o}if(e===qr){let r=uo("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>sc(t,r)),o.appendChild(r),o}if(e===Ma){let r=uo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Da(t)),o.appendChild(r),o}return null},pc=(t,e)=>{let o=[];if(e===qr&&(o=[{label:"Re-order Lockbox",onClick:()=>void Da(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Aa,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=dc();return a.addEventListener("click",i=>{i.stopPropagation(),lc(o,a)}),r.appendChild(a),r},bc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],hc=async()=>{for(let t of bc)try{let e=await M(t,{timeoutMs:1200});if(e)return e}catch{}return null},mo=()=>{document.getElementById(Rr)?.remove(),document.getElementById(Aa)?.remove(),Ce()},vo=!1,Ur=async()=>{if(!vo){vo=!0;try{let t=Oa();if(!t){mo();return}let e=D();if(e===null)return;if(e!=="Transaction Coordination"){mo();return}let o=ac(),r=document.getElementById(Rr);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=cc(t,o);if(!a){mo();return}let i=await hc();if(!i)return;mo();let s=document.createElement("span");s.id=Rr,s.dataset.oppId=t.oppId,s.dataset.stage=o??"",s.style.cssText="display:inline-flex;align-items:center;margin-left:auto;flex-shrink:0;vertical-align:middle;order:1;",s.appendChild(a),i.classList.contains("description")&&(i.style.display="flex",i.style.alignItems="center",i.style.gap="16px",i.style.flexWrap="wrap"),i.appendChild(s);let l=pc(t,o);l&&i.appendChild(l),mc(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{vo=!1}}},ft=null,zr=null,Hr,Ca=()=>{ft?.disconnect(),ft=null,zr=null},mc=t=>{if(ft&&zr===t)return;Ca();let e=document.querySelector(La);e&&(zr=t,ft=new MutationObserver(()=>{let o=Oa();if(!o||o.oppId!==t){Ca();return}Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0,Ur()},250))}),ft.observe(e,{childList:!0,subtree:!0}))},Fr=null,Br,uc=()=>{Fr||(Fr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!vo&&Ur()},300))}),Fr.observe(document.body,{childList:!0,subtree:!0}))},Pa=()=>{uc(),Ur()};var Ha="ws-support-modal",Fa="ws-support-toast",vc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ba="ws-support-submitter-name",Ra="ws-support-submitter-email",Na="ws-support-submitter-role",_c=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ae=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),yc=(t,e="success",o)=>{let r=document.getElementById(Fa);r&&r.remove();let a=document.createElement("div");a.id=Fa;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `;let r={status:"loading"};ye(o,r);let a=Ka(t);return a&&(r={status:"linked",contactName:a.contactName},ye(o,r),Ie={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Ac(t,e);s?(r={status:"linked",contactName:s.name},ye(o,r),Ie={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Jr(s.id,s.name,e)):a||(r={status:"empty"},ye(o,r),Ie?.oppId===t&&(Ie=null),$c(),Lc(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Oc({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ye(o,r);try{let l=[Ua({tenantId:e,oppId:t,fieldKey:Wa,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ua({tenantId:e,oppId:t,fieldKey:Tc,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ye(o,r),Ie={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Ya(t,s.id,s.name),Jr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},ye(o,r)}}})}),o},Pc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Hc=async()=>{for(let t of Pc)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wt=!1,fo=async()=>{if(!wt){wt=!0;try{await Fc()}finally{wt=!1}}},Fc=async()=>{let t=kt();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),go();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let d=D();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),go());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=D();if(o!==null&&o!=="Transaction Coordination")return;let r=await Hc();if(!r||!(Ka(t.oppId)!==null||Ie!==null&&Ie.oppId===t.oppId)&&await q()!=="Transaction Coordination")return;let i=kt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Dc(t.oppId,i.locationId),l=document.createElement("span");l.id=`${se}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Bc(t.oppId),tn(i.locationId)},xt=null,Xr=null,Qr=null,go=()=>{xt?.disconnect(),xt=null,Xr=null,Qr=null},Bc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt&&Xr===t&&Qr===e||(go(),Xr=t,Qr=e,xt=new MutationObserver(()=>{let o=kt();if(!o||o.oppId!==t||!o.locationId){go();return}document.getElementById(se)||fo(),tn(o.locationId)}),xt.observe(e,{childList:!0,subtree:!0})))},jr=null,Kr,Rc=()=>{jr||(jr=new MutationObserver(()=>{Kr===void 0&&(Kr=window.setTimeout(()=>{Kr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!wt&&fo()},300))}),jr.observe(document.body,{childList:!0,subtree:!0}))},Va,Nc=()=>{Va===void 0&&(Va=window.setInterval(()=>{let t=kt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(se)&&!wt&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),fo()),tn(t.locationId)},2e3))},Xa=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Rc(),Nc(),fo()};var zc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",fe="ws-crm-manage-team-cta",Qa="ws-crm-manage-team-modal",Gc=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Za={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},qc={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ei=()=>{let t=window.location.pathname.match(Gc);return t?{tenantId:t[1]}:null},xo=async t=>{let e=await fetch(zc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},te=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ge=t=>te(t),on="ws-crm-manage-team-toast",an=(t,e="info",o=4e3)=>{document.getElementById(on)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=on,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${te(Za[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{ko(t)}),wo(e),setTimeout(()=>wo(e),200),setTimeout(()=>wo(e),800),window.addEventListener("resize",()=>wo(e)),e},nn=!1,np=()=>{if(!nn){nn=!0;try{let t=ei();if(!t){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}let e=document.getElementById(fe);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${fe}-floater`)?.remove();let o=document.createElement("div");o.id=`${fe}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=rp(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{nn=!1}}},ti=()=>{if(!ei()){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}np()};var ap="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",dn="ws-crm-prepare-contract-button",oi="ws-crm-prepare-contract-menu",pe="ws-crm-prepare-contract-modal",ri="ws-crm-modal-date-style",me="https://services.leadconnectorhq.com",di=()=>{if(document.getElementById(ri))return;let t=document.createElement("style");t.id=ri,t.textContent=`
  ...
  `,document.head.appendChild(t)},cn="__WS_CRM_CAPTURED_AUTH",ip=50*60*1e3,Co=()=>{try{let t=localStorage.getItem(cn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>ip?(localStorage.removeItem(cn),null):e:null}catch{return null}},sp=t=>{try{localStorage.setItem(cn,JSON.stringify(t))}catch{}},qe=()=>{let t=Co(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ni=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Co()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ge=async(t,e={},o=2)=>{let r=Co()?.capturedAt??0,a;try{a={...qe(),...e.headers??{}}}catch(s){if(o>0&&await ni(r,4e3))return Ge(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await ni(r,4e3)?Ge(t,e,o-1):i},ai=!1,lp=()=>{if(ai)return;ai=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Co()?.authorization;sp({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ci=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},dp=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ci()},cp=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},pi="__WS_CRM_TEMPLATES_CACHE_V1",pp=24*60*60*1e3,ii=t=>{try{let e=window.localStorage.getItem(pi);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>pp?null:o.templates}catch{return null}},bp=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(pi,JSON.stringify(o))}catch{}},hp=async t=>{let e=`${me}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ge(e,{method:"GET"})}catch(s){let l=ii(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ii(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:cp(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&bp(t,i),i},mp=async(t,e)=>{let o=await Ge(`${me}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Ge(`${me}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},up=async(t,e)=>{let o=await Ge(`${me}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${me}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:qe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},vp=async t=>{let e=await fetch(ap,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},_p=async(t,e,o)=>{let r=`${me}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:qe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},yp=async(t,e)=>{let o=await fetch(`${me}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:qe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},gp=async t=>{let e=await fetch(`${me}/contacts/${t}`,{method:"GET",headers:qe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},fp=async(t,e,o,r)=>{let a;try{a=await yp(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await gp(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${me}/proposals/document/${e}`,{method:"PUT",headers:{...qe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},wp=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},To="__WS_CRM_PENDING_INSTRUCTIONS",xp=60*1e3,kp=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ep=t=>{let e=(t||"").toLowerCase();for(let o of kp)if(e.includes(o.matches.toLowerCase()))return o;return null},Tp=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(To,JSON.stringify(r))}catch{}},Sp=()=>{try{let t=localStorage.getItem(To);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>xp?(localStorage.removeItem(To),null):e}catch{return null}},Cp=()=>{try{localStorage.removeItem(To)}catch{}},Ap=(t,e)=>{document.getElementById(pe)?.remove();let o=document.createElement("div");o.id=pe,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},li=(t,e)=>new Promise(o=>{document.getElementById(pe)?.remove();let r=document.createElement("div");r.id=pe,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Op(t)}),t},Dp="ws-crm-contact-actions-bar",Pp=async()=>{let t=ci();if(!t){document.getElementById(dn)?.remove();return}let e=null;try{e=await M(`#${Dp}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(dn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=bi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Le="ws-crm-prepare-contract-button-opp",Et=`${Le}-wrap`,Hp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fp=/\/v2\/location\/([A-Za-z0-9]+)/,Bp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pn=()=>{let t=window.location.pathname,e=t.match(Hp);if(!e)return null;let o=t.match(Fp);return o?{oppId:e[1],tenantId:o[1]}:null},Rp=async()=>{for(let t of Bp)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Eo=!1,Tt=null,bn=null,sn=null,ln,St=()=>{Tt?.disconnect(),Tt=null,bn=null},Np=t=>{if(Tt&&bn===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(bn=t,Tt=new MutationObserver(()=>{let o=pn();if(!o||o.oppId!==t){St();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Le)?.remove(),document.getElementById(Et)?.remove(),St();return}document.getElementById(Le)||hi()}),Tt.observe(e,{childList:!0,subtree:!0}))},zp=()=>{sn||(sn=new MutationObserver(()=>{ln===void 0&&(ln=window.setTimeout(()=>{ln=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Le);t&&!e&&!Eo&&hi()},300))}),sn.observe(document.body,{childList:!0,subtree:!0}))},hi=async()=>{if(!Eo){Eo=!0;try{let t=pn();if(!t){document.getElementById(Le)?.remove(),document.getElementById(Et)?.remove(),St();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Et)?.remove(),St());return}e&&(e.remove(),document.getElementById(Et)?.remove());let o=await Rp();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=pn();if(!a||a.oppId!==t.oppId)return;let i=bi();i.id=Le,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Et,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Np(t.oppId)}finally{Eo=!1}}},mi=()=>{Lp(),Pp()};lp();function X(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ce(t){return X(t)}var Oo="reos-theme-stylesheet",Mi="reos-theme-fonts",Gp=()=>{let t=document.getElementById(Mi);t&&t.remove()},qp=`
/* ============================================
