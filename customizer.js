...
/* 16e. INLINE LIGHT-NEUTRAL BORDERS \u2014 REVERTED in v0.7.59. v0.7.58
   targeted inline rgb(234, 236, 240) borders to remap them to steel,
   but Tim reported the white border was still showing AND the right
   side nav was missing on the Internal Chat page. Reverting until
   I get more specific info on the actual border source. The right
   nav being missing on Internal Chat may just be by GHL's design
   (no contact panel for internal chat) but reverting just in case. */
