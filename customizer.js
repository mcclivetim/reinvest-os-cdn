/* Wholesaling CRM Customizer v0.37.4 — built 2026-06-14T12:27:06.373Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Qt="[wholesaling-crm-customizer]",kl="__WS_CRM_DEBUG",El=()=>!!window[kl],c={info(...t){console.log(Qt,...t)},warn(...t){console.warn(Qt,...t)},error(...t){console.error(Qt,...t)},debug(...t){El()&&console.log(Qt,"[debug]",...t)}};var Tl=/\/v2\/location\/([A-Za-z0-9]+)/,Sl=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let t=window.location.pathname.match(Tl);return t?t[1]:null},dr=()=>{let t=re();return t!==null&&Sl.has(t)};var da=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,cr=/\/v2\/location\/([A-Za-z0-9]+)/,Cl=t=>{let e=t.match(da);if(!e)return null;let o=t.match(cr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Al=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(da);if(!a)continue;let i=r.match(cr)||window.location.pathname.match(cr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},B=()=>{let t=Cl(window.location.pathname);return t||Al()};var ca=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},eo="",pr=null,Me="other",br=new Set,Zt=()=>{let t=B()?.contactId??null;if(!(!(window.location.pathname!==eo)&&!(t!==pr))){eo=window.location.pathname,pr=t,Me=ca(),c.debug("Page/context changed:",Me,eo,"contact:",t);for(let r of br)try{r(Me)}catch(a){c.error("Subscriber threw:",a)}}},we=t=>(br.add(t),setTimeout(()=>t(Me),0),()=>{br.delete(t)}),pa=()=>{Me=ca(),eo=window.location.pathname,pr=B()?.contactId??null,c.debug("Router init, current page:",Me);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Zt()},history.replaceState=function(o,r,a){e(o,r,a),Zt()},window.addEventListener("popstate",Zt),setInterval(Zt,1e3)},ba=()=>Me;var to="0.37.4",oo="2026-06-14T12:27:06.373Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},mr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ma=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,M=`
  ...
  flex-shrink: 0;
`;var $l=/^[A-Za-z0-9]{15,30}$/,bt=t=>typeof t=="string"&&$l.test(t),ha=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ll=()=>{let t=window.WS_CRM_USER_ID;return bt(t)?t:null},Il=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(bt(o))return o;return null},Ml=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ha(e);if(!o)return null;let r=o.uid;if(bt(r))return r;let a=o.claims;if(a&&bt(a.user_id))return a.user_id}catch{}return null},Ol=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(bt(a))return a}catch{}}}catch{}return null},O=()=>Ll()||Il()||Ml()||Ol()||null,Dl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ha(e);return o?o.claims??o:null}catch{return null}},Ve=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Dl()?.type==="agency"};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Hl=`${ga}/active-follow-up-get`,Pl=`${ga}/active-follow-up-set`,Oe="ws-crm-active-follow-up-button",ur={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Rl=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Bl=async t=>{let e=await fetch(Hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Fl=async(t,e)=>{let o=await fetch(Pl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},De=(t,e)=>{let o=ur[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ua=t=>{let e=document.createElement("button");return e.type="button",e.id=Oe,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,De(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Rl();if(!(!r||r.contactId!==t)){De(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Fl(r,O()),i=a&&a.state&&a.state in ur?a.state:"blue";De(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),De(e,"error"),setTimeout(()=>void ro(e,r),4e3)}}}),e},ro=async(t,e)=>{De(t,"loading");try{let o=await Bl(e),r=o&&o.state&&o.state in ur?o.state:"gray",a=document.getElementById(Oe);if(!a||a.dataset.contactId!==e.contactId)return;De(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),De(t,"error")}},Nl=[".central-panel","[class*='central-panel']"],hr="ws-crm-contact-actions-bar",zl=async()=>{for(let t of Nl)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Gl=async(t,e)=>{let o=e.querySelector(`#${hr}`);if(!o)try{o=await L(`#${hr}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${hr}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},ql=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},Ul=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Vl=async t=>{if(t==="url"){let o=await zl();return o?{kind:"contact-detail",target:o}:null}let e=ql();return e?{kind:"conversations",target:e}:null},va=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Gl(t,e.target);return o}return Ul(t,e.target),"conversations-header"},Wl=async()=>{let t=B();if(!t||!t.locationId){document.getElementById(Oe)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Oe);if(o&&o.dataset.contactId===e.contactId){ro(o,e);return}o&&o.remove();let r=await Vl(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=B();if(!a||a.contactId!==e.contactId)return;let i=ua(e.contactId),s=await va(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),_a();let l=document.getElementById(Oe)??i;ro(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(Oe);if(!(B()?.contactId===e.contactId)){d.disconnect();return}if(!p){let m=ua(e.contactId);va(m,r).then(()=>{_a(),ro(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},mt=null,ya=()=>{let t=B()?.contactId??null;if(mt&&mt.contactId===t)return;let e=Wl().finally(()=>{mt?.promise===e&&(mt=null)});mt={contactId:t,promise:e}},_a=()=>{let t=document.querySelectorAll(`#${Oe}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ht=new Map,We=async(t,e)=>{if(!t)return null;if(ht.has(t))return ht.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${jl}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),ht.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ht.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),ht.set(t,null),null}};var je=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var wa="ws-buybox-nav-icon",gr="ws-buybox-panel",fa="ws-buybox-modal",Kl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",yr="https://mcclivetim.github.io/reinvest-os-cdn/geo",no=null,ut=null,vt=null,_r=async()=>{if(no)return no;try{let t=await fetch(`${yr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return no=await t.json(),no}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Yl=async t=>{if(!ut)try{let e=await fetch(`${yr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ut=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return ut?.[t]??[]},Jl=async t=>{if(!vt)try{let e=await fetch(`${yr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);vt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return vt?.[t]??[]},fr=async t=>await(await fetch(Kl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Xl=(t,e)=>fr({tenant_id:t,action:"list",buyer_contact_id:e}),Ql=(t,e,o,r)=>fr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Zl=(t,e)=>fr({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ed=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},td='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',od='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',rd="nav.w-13, nav[class*='w-13']",nd=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ad=async()=>{try{return await L(rd,{timeoutMs:2500})}catch{return null}},id=async()=>{try{return await L(nd,{timeoutMs:2500})}catch{return null}},sd=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,ld=(t,e)=>{let o=document.createElement("div");return o.id=gr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{bd(t,e,()=>xr(t,e))}),o},xr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Xl(t,e),_r()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}dd(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},dd=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?ed(b.geo_value,o):b.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${G(m)}</span>
              <button type="button" data-entry-id="${G(b.id)}" data-entry-label="${G(m)}" class="ws-buybox-remove" aria-label="Remove ${G(m)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${od}</button>
            </div>
          `}).join("");return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Zl(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}xr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},ao=!1,ka=(t,e)=>{ao=e;let o=sd(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=cd,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",xr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Ea,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Ea="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",cd="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",pd=t=>{let e=document.createElement("button");return e.id=wa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Ea,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${td.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!ao;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ka(r,a)}),e},bd=(t,e,o)=>{let r=document.getElementById(fa);r&&r.remove();let a=document.createElement("div");a.id=fa,a.style.cssText=`
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let s={step:1,granularity:null,stateCode:null,value:null},l=async()=>{if(s.step===1)i.innerHTML=d(),p();else if(s.step===2){i.innerHTML=b();let w=await _r();i.innerHTML=m(w),h(w)}else if(s.step===3)if(s.granularity==="zip")i.innerHTML=x(),S();else if(s.granularity==="state"){let w=await _r();i.innerHTML=k(w),y(w)}else s.granularity==="county"?(i.innerHTML=_(s.stateCode||""),await Yl(s.stateCode||""),i.innerHTML=f("County"),g()):s.granularity==="city"&&(i.innerHTML=_(s.stateCode||""),await Jl(s.stateCode||""),i.innerHTML=f("City"),g())},d=()=>`
  ...
  `,p=()=>{i.querySelectorAll(".ws-buybox-tile").forEach(w=>{w.addEventListener("mouseenter",()=>{w.style.borderColor=n.emerald,w.style.background=n.emeraldGlow}),w.addEventListener("mouseleave",()=>{w.style.borderColor=n.steel,w.style.background=n.steel}),w.addEventListener("click",()=>{let T=w.dataset.granularity;s.granularity=T,s.step=T==="zip"?3:2,l()})}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove())},b=()=>`
  ...
  `,h=w=>{let T=i.querySelector("#ws-buybox-state-search"),$=i.querySelectorAll(".ws-buybox-state-row");$.forEach(P=>{P.addEventListener("mouseenter",()=>{P.style.background=n.emeraldGlow}),P.addEventListener("mouseleave",()=>{P.style.background="transparent"}),P.addEventListener("click",()=>{s.stateCode=P.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let P=(T.value||"").toLowerCase().trim();w.forEach((q,z)=>{let N=$[z];if(!N)return;let R=!P||q.name.toLowerCase().includes(P)||q.code.toLowerCase()===P;N.style.display=R?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=w=>`
  ...
  `,k=w=>{let T=w.find($=>$.code===s.stateCode);return`
    ...
    `},y=w=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},f=w=>{let T=s.granularity==="county"?ut?.[s.stateCode||""]??[]:vt?.[s.stateCode||""]??[];return`
      ...
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${T.length.toLocaleString()} ${G(w).toLowerCase()}s in ${G(s.stateCode||"")}.</div>
  ...
  `,S=()=>{let w=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),w.addEventListener("keydown",$=>{$.key==="Enter"&&($.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>w.focus(),0))},C=async()=>{let w=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),$=(w?.value||"").trim();if(!/^\d{5}$/.test($)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E($)},E=async w=>{if(!s.granularity||!w)return;let T=i.querySelector("#ws-buybox-err"),$=i.querySelector("#ws-buybox-save");$&&($.disabled=!0,$.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await Ql(t,e,s.granularity,w);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),$&&($.disabled=!1,$.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),$&&($.disabled=!1,$.textContent="Add")}};l()},vr=!1,Ke=null,_t=null,xa=()=>{document.getElementById(wa)?.remove(),document.getElementById(gr)?.remove(),_t&&Ke&&Ke.nav.removeEventListener("click",_t,!0),_t=null,Ke=null,ao=!1},Ta=()=>{md()},md=async()=>{if(!vr){vr=!0;try{let t=B();if(!t){xa();return}let e=document.getElementById(gr);if(e&&e.dataset.buyerContactId===t.contactId&&Ke)return;xa();let o=null;try{o=await We(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(je(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ad(),id()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=B();if(!s||s.contactId!==t.contactId)return;let l=ld(t.locationId,t.contactId),d=pd(()=>Ke),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ke=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),_t=m=>{let h=m.target;if(!h||p.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&ao&&ka(p,!1)},a.addEventListener("click",_t,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{vr=!1}}};var ke="ws-crm-claim-release-pill",hd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ud="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",vd=async t=>{let e=await fetch(hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},_d=async t=>{let e=await fetch(ud,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Aa=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ye=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=ma(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},gd=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ke,o.type="button",o.dataset.contactId=t,Ye(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=B();if(!a||!a.locationId||a.contactId!==t)return;let i=O();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Ye(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Ye(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await _d({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Ye(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),Ye(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Sa=async(t,e)=>{try{let o=await vd({contactId:e.contactId,locationId:e.locationId,userId:O()}),r=document.getElementById(ke);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Ye(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},yd=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Aa(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Ca=(t,e)=>{let o=gd({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ke}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},fd=async()=>{let t=B();if(!t){document.getElementById(ke)?.remove();return}let e=document.getElementById(ke);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await yd(o),a=B();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ca(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ke);i&&t.locationId&&Sa(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(B()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ke))return;let d=Aa(o);if(d){Ca(d,t.contactId);let p=document.getElementById(ke);p&&t.locationId&&Sa(p,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},$a=()=>{fd()};var Pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",xd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var wd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",kd=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||Pa,d;if(s==="buyer"){let b=Ra.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Ed=async({contactId:t,tenantId:e})=>{let o=await fetch(wd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Je="ws-crm-contact-actions-bar",Td="ws-crm-call-status-dropdown",La="ws-crm-offer-made-modal",Sd=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Ra=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Cd=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Ad=async()=>{for(let t of Cd)try{let e=await L(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},$d=({contactId:t,kind:e})=>{let o=e==="buyer"?Ra:Sd,r=e==="buyer"?xd:Pa,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Td,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=M,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${mr[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=mr[d.color]),m&&(m.textContent=d.label),l.style.display="none";let k=B()?.locationId,y=O();if(!k){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!y){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let f=h?.textContent??"\u25BE",g=async x=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await kd({contactId:t,locationId:k,status:d.label,userId:y,deadReason:x,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=f),s.style.opacity="1"},900)}catch(S){c.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=f),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let x=m?.textContent??"";Od(S=>{g(S)},()=>{m&&(m.textContent=x)});return}if(e==="seller"&&d.value==="appointment-booked"){let x=m?.textContent??"";try{(await Ed({contactId:t,tenantId:k})).ok?await g():Dd(()=>{g()},()=>{m&&(m.textContent=x)})}catch(S){c.warn("Appointment sanity check failed; firing anyway:",S),await g()}return}await g()}),l.appendChild(p)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},Ld="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Id=async t=>{let e=await fetch(Ld,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Md=(t,e="seller")=>{document.getElementById(La)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=La,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,s.appendChild(l),document.body.appendChild(s);let m=()=>s.remove();s.addEventListener("click",y=>{y.target===s&&m()});let h=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),k=l.querySelector("#ws-offer-submit");_?.addEventListener("click",m),k?.addEventListener("click",async()=>{let y=(l.querySelector("#ws-offer-amount")?.value??"").trim(),f=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!y||Number(y)<=0){h&&(h.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let g=Number(y);if(g<100){h&&(h.textContent=`That looks low \u2014 did you mean $${(g*1e3).toLocaleString("en-US")}?`);return}let S=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),C=S?S[1]:null;if(!C){h&&(h.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}h&&(h.textContent=""),k&&(k.disabled=!0,k.textContent="Recording\u2026",k.style.opacity="0.7"),_&&(_.disabled=!0);try{let E=await Id({tenantId:C,contactId:t,kind:e,amount:g,expiresAt:f||null,userId:O()});if(!E.ok){h&&(h.textContent=E.error??"Something went wrong."),k&&(k.disabled=!1,k.textContent="Record Offer",k.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${g} on ${E.opp_pipeline} opp (stage: ${E.opp_stage_name??"?"})`),m()}catch(E){c.error("Offer Made webhook failed",E),h&&(h.textContent=E instanceof Error?E.message:"Network error \u2014 try again."),k&&(k.disabled=!1,k.textContent="Record Offer",k.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Ia="ws-crm-dead-deal-modal",Od=(t,e)=>{document.getElementById(Ia)?.remove();let o=document.createElement("div");o.id=Ia,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},Oa=(t,e)=>{let o=document.createElement("div");if(o.id=Je,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=M,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Md(t,e)),o.appendChild(r),o.appendChild($d({contactId:t,kind:e}))}return o},wr=!1,Da=()=>{document.querySelectorAll(`[id="${Je}"]`).forEach(t=>t.remove())},Ba=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),wr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}wr=!0;try{await Hd()}finally{wr=!1}},Hd=async()=>{let t=B();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Da();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Da();return}let e="seller";try{let p=await We(t.contactId,t.locationId),b=je(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=B();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Je}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Ad();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=B();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Oa(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Je)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(B()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Je}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=Oa(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Ha=null,Pd=()=>{Ha===null&&(Ha=window.setInterval(()=>{let t=B();t&&(document.getElementById(Je)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ba()))},3e3))},Fa=()=>{Pd(),Ba()};var io="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Rd=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),gt="data-ws-crm-favicon",kr=t=>t.hasAttribute(gt),Na=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Rd.has(e)},so=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Na(r)&&!kr(r)&&r.remove()});let e=document.head.querySelector(`link[${gt}="1"]`);e?e.href!==io&&(e.href=io):(e=document.createElement("link"),e.setAttribute(gt,"1"),e.rel="icon",e.type="image/png",e.href=io,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${gt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(gt,"apple"),o.rel="apple-touch-icon",o.href=io,document.head.appendChild(o))},za=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)so();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),so())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Na(s)&&!kr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&kr(s)&&(a=!0)});a&&so()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,so(),e>=5&&window.clearInterval(o)},1e3)};var Bd=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Fd=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Nd=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Nd);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Fd);if(a){let i=a[1];if(Bd.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ga="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(Ga);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ga,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var zd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ie="ws-crm-mt-offer-made-button",qa="ws-crm-mt-offer-made-modal",Gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,qd=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(Gd);if(!e)return null;let o=t.match(qd);return{oppId:e[1],locationId:o?o[1]:null}},Ud=async t=>{let e=await fetch(zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},lo=()=>{document.getElementById(qa)?.remove()},Vd=t=>{lo();let e=document.createElement("div");e.id=qa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&lo()}),i?.addEventListener("click",()=>lo()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let p=Number(d);if(p<100){a.textContent=`That looks low \u2014 did you mean $${(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let b=await Ud({oppId:t.oppId,locationId:t.locationId,amount:p,userId:O()});if(!b.ok){a.textContent=b.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}lo(),t.onSuccess()}catch(b){c.error("MT Offer Made webhook failed",b),a.textContent=b instanceof Error?b.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},Wd=t=>{let e=document.createElement("button");return e.id=ie,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=po();!o||!o.locationId||o.oppId!==t||Vd({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=M)},4e3)}})}),e},jd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Kd=async()=>{for(let t of jd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Cr=async()=>{if(!co){co=!0;try{await Yd()}finally{co=!1}}},Yd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await Kd();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=Wd(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Jd(t.oppId)},yt=null,Sr=null,ft=()=>{yt?.disconnect(),yt=null,Sr=null},Jd=t=>{if(yt&&Sr===t)return;ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Sr=t,yt=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){ft();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft();return}document.getElementById(ie)||Cr()}),yt.observe(e,{childList:!0,subtree:!0}))},Er=null,Tr,Xd=()=>{Er||(Er=new MutationObserver(()=>{Tr===void 0&&(Tr=window.setTimeout(()=>{Tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!co&&Cr()},300))}),Er.observe(document.body,{childList:!0,subtree:!0}))},Ua=()=>{Xd(),Cr()};var Qd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",se="ws-crm-not-interested-button",Zd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ec=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(Zd);if(!e)return null;let o=t.match(ec);return{oppId:e[1],locationId:o?o[1]:null}},tc=async t=>{let e=await fetch(Qd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},oc=t=>{let e=document.createElement("button");return e.id=se,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=mo();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await tc({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},rc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],nc=async()=>{for(let t of rc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},bo=!1,Ir=async()=>{if(!bo){bo=!0;try{await ac()}finally{bo=!1}}},ac=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await nc();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=oc(t.oppId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),ic(t.oppId)},xt=null,Lr=null,wt=()=>{xt?.disconnect(),xt=null,Lr=null},ic=t=>{if(xt&&Lr===t)return;wt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Lr=t,xt=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){wt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}document.getElementById(se)||Ir()}),xt.observe(e,{childList:!0,subtree:!0}))},Ar=null,$r,sc=()=>{Ar||(Ar=new MutationObserver(()=>{$r===void 0&&($r=window.setTimeout(()=>{$r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!bo&&Ir()},300))}),Ar.observe(document.body,{childList:!0,subtree:!0}))},Va=()=>{sc(),Ir()};var lc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ne="ws-crm-schedule-walkthrough-button",Mr="ws-crm-schedule-walkthrough-modal",dc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cc=/\/v2\/location\/([A-Za-z0-9]+)/,vo=()=>{let t=window.location.pathname,e=t.match(dc);if(!e)return null;let o=t.match(cc);return{oppId:e[1],locationId:o?o[1]:null}},ho=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},pc=(t,e)=>{document.getElementById(Mr)?.remove();let o=document.createElement("div");o.id=Mr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Mr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",p=document.getElementById("wsw-dur")?.value||"30";if(!d){ho("Pick a date and time.","err");return}let b=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(lc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:b,duration_min:Number(p)}),credentials:"omit"})).ok){s(),ho("Walkthrough scheduled \u2713");let h=document.querySelector(`#${ne} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",ho("Scheduling failed \u2014 try again.","err")}catch(m){c.warn("[schedule-walkthrough] failed:",m),l.disabled=!1,l.textContent="Schedule",ho("Couldn't reach the scheduler. Try again.","err")}})},bc=t=>{let e=document.createElement("button");return e.id=ne,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=vo();!o||!o.locationId||o.oppId!==t||pc(o.oppId,o.locationId)}),e},mc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],hc=async()=>{for(let t of mc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},uo=!1,Pr=async()=>{if(!uo){uo=!0;try{await uc()}finally{uo=!1}}},uc=async()=>{let t=vo();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await hc();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=vo();if(!a||a.oppId!==t.oppId)return;let i=bc(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),vc(t.oppId)},kt=null,Hr=null,Et=()=>{kt?.disconnect(),kt=null,Hr=null},vc=t=>{if(kt&&Hr===t)return;Et();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Hr=t,kt=new MutationObserver(()=>{let o=vo();if(!o||o.oppId!==t){Et();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et();return}document.getElementById(ne)||Pr()}),kt.observe(e,{childList:!0,subtree:!0}))},Or=null,Dr,_c=()=>{Or||(Or=new MutationObserver(()=>{Dr===void 0&&(Dr=window.setTimeout(()=>{Dr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!uo&&Pr()},300))}),Or.observe(document.body,{childList:!0,subtree:!0}))},Wa=()=>{_c(),Pr()};var gc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Xe="ws-crm-resend-deal-link-wrap",yc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fc=/\/v2\/location\/([A-Za-z0-9]+)/,go=()=>{let t=window.location.pathname,e=t.match(yc);if(!e)return null;let o=t.match(fc);return{oppId:e[1],locationId:o?o[1]:null}},xc=async t=>{let e=await fetch(gc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},wc=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),ja=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Nr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=M,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${ja(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>kc(t,e)),t.appendChild(o)},kc=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Ec(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Nr(t,e)),o.appendChild(s),t.appendChild(o)},Ec=async(t,e,o,r)=>{let a=go();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await xc({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${ja(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${wc(s)}</span>`}window.setTimeout(()=>Nr(t,e),3500)}},Tc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sc=async()=>{for(let t of Tc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_o=!1,zr=async()=>{if(!_o){_o=!0;try{await Cc()}finally{_o=!1}}},Cc=async()=>{let t=go();if(!t||!t.locationId){document.getElementById(Xe)?.remove(),St();return}let e=document.getElementById(Xe);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),St());return}e&&e.remove();let o=await Sc();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=go();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Xe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Nr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Ac(t.oppId)},Tt=null,Fr=null,St=()=>{Tt?.disconnect(),Tt=null,Fr=null},Ac=t=>{if(Tt&&Fr===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fr=t,Tt=new MutationObserver(()=>{let o=go();if(!o||o.oppId!==t){St();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Xe)?.remove(),St();return}document.getElementById(Xe)||zr()}),Tt.observe(e,{childList:!0,subtree:!0}))},Rr=null,Br,$c=()=>{Rr||(Rr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Xe)&&!_o&&zr()},300))}),Rr.observe(document.body,{childList:!0,subtree:!0}))},Ka=()=>{$c(),zr()};var Lc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",le="ws-crm-reduce-price-button",Ya="ws-crm-reduce-price-modal",Ic=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mc=/\/v2\/location\/([A-Za-z0-9]+)/,xo=()=>{let t=window.location.pathname,e=t.match(Ic);if(!e)return null;let o=t.match(Mc);return{oppId:e[1],locationId:o?o[1]:null}},Oc=async t=>{let e=await fetch(Lc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},yo=()=>{document.getElementById(Ya)?.remove()},Dc=t=>{yo();let e=document.createElement("div");e.id=Ya,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let p=r.value.replace(/[^0-9.]/g,"").split(".");r.value=p[0]+(p.length>1?"."+p.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&yo()}),i?.addEventListener("click",()=>{yo()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let p=parseFloat(d);if(!Number.isFinite(p)||p<=0){a.textContent="Price must be a positive number.",r.focus();return}if(p<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Oc({oppId:t.oppId,locationId:t.locationId,newPrice:p,userId:O()}),yo(),t.onSuccess()}catch(b){c.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},Hc=(t,e)=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=xo();!r||!r.locationId||r.oppId!==t||Dc({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=M,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Pc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Rc=async()=>{for(let t of Pc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fo=!1,Vr=async()=>{if(!fo){fo=!0;try{await Bc()}finally{fo=!1}}},Bc=async()=>{let t=xo();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),At();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),At());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await Rc();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=xo();if(!a||a.oppId!==t.oppId)return;let i=Hc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Fc(t.oppId)},Ct=null,Ur=null,At=()=>{Ct?.disconnect(),Ct=null,Ur=null},Fc=t=>{if(Ct&&Ur===t)return;At();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ur=t,Ct=new MutationObserver(()=>{let o=xo();if(!o||o.oppId!==t){At();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),At();return}document.getElementById(le)||Vr()}),Ct.observe(e,{childList:!0,subtree:!0}))},Gr=null,qr,Nc=()=>{Gr||(Gr=new MutationObserver(()=>{qr===void 0&&(qr=window.setTimeout(()=>{qr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!fo&&Vr()},300))}),Gr.observe(document.body,{childList:!0,subtree:!0}))},Ja=()=>{Nc(),Vr()};var Qe="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",wo="deals.reinvestos.com";var de="ws-crm-edit-landing-button",zc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(zc);if(!e)return null;let o=t.match(Gc);return{oppId:e[1],locationId:o?o[1]:null}},qc=(t,e)=>{let o=new URL(`https://${wo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Qe);let r=O();return r&&o.searchParams.set("user",r),o.toString()},Uc=(t,e)=>{let o=document.createElement("button");return o.id=de,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Eo();if(!r||!r.locationId||r.oppId!==t)return;if(!Qe){c.warn("[edit-landing] editor session key not configured in this build");return}let a=qc(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Vc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wc=async()=>{for(let t of Vc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ko=!1,Yr=async()=>{if(!ko){ko=!0;try{await jc()}finally{ko=!1}}},jc=async()=>{let t=Eo();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await Wc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Eo();if(!a||a.oppId!==t.oppId)return;let i=Uc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Kc(t.oppId)},$t=null,Kr=null,Lt=()=>{$t?.disconnect(),$t=null,Kr=null},Kc=t=>{if($t&&Kr===t)return;Lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kr=t,$t=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){Lt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt();return}document.getElementById(de)||Yr()}),$t.observe(e,{childList:!0,subtree:!0}))},Wr=null,jr,Yc=()=>{Wr||(Wr=new MutationObserver(()=>{jr===void 0&&(jr=window.setTimeout(()=>{jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!ko&&Yr()},300))}),Wr.observe(document.body,{childList:!0,subtree:!0}))},Xa=()=>{Yc(),Yr()};var Za="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ze="ws-crm-publish-button",It="ws-crm-publish-wrap",So="ws-crm-publish-dropdown",Jc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xc=/\/v2\/location\/([A-Za-z0-9]+)/,Qr=()=>{let t=window.location.pathname,e=t.match(Jc);if(!e)return null;let o=t.match(Xc);return{oppId:e[1],locationId:o?o[1]:null}},Qc=async(t,e)=>{try{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},Zc=async(t,e)=>{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ep=(t,e)=>{if(!Qe){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${wo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Qe);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},_e=()=>{document.getElementById(So)?.remove()},Qa=(t,e,o,r,a)=>{_e();let i=document.createElement("div");i.id=So;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let l=t.length,d=t.filter(y=>y.filled).length,p=d===l,b=document.createElement("div");b.innerHTML=`
    <div style="
  ...
  `,i.appendChild(b),t.forEach(y=>{let f=document.createElement("div");f.style.cssText=`
      display: flex; align-items: center; gap: 10px;
      padding: 6px 4px; font-size: 12px;
      color: ${y.filled?n.bone:n.ash};
    `;let g=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;f.innerHTML=`${g}<span style="flex: 1;">${y.label}</span>`,i.appendChild(f)});let m=document.createElement("div");m.style.cssText=`
    display: flex; align-items: center; gap: 10px;
  ...
  `;let h=document.createElement("button");h.type="button",h.textContent="Open editor to finish \u2192",h.style.cssText=`
    ...
    color: ${n.emerald};
  `,h.addEventListener("click",y=>{y.stopPropagation(),ep(o,r)}),m.appendChild(h);let _=document.createElement("button");_.type="button",_.textContent="Re-check",_.title="Re-check after editing the page",_.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,_.addEventListener("click",y=>{y.stopPropagation(),_e(),a()}),m.appendChild(_),i.appendChild(m),document.body.appendChild(i);let k=y=>{let f=y.target;!i.contains(f)&&!e.contains(f)&&(_e(),document.removeEventListener("click",k))};window.setTimeout(()=>document.addEventListener("click",k),0)},He=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),i="transparent",s=n.steel,l=n.bone,d=n.coolGray,p="Publish Deal",b="",m="pointer",h="1";switch(e.status){case"checking":s=n.steel,l=n.ash,p="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publish Deal";break;case"incomplete":{let _=e.checks?.filter(y=>y.filled).length??0,k=e.checks?.length??0;s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${k} ready`,b="\u25BE";break}case"publishing":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publishing\u2026",m="wait",h="0.8";break;case"published":i="transparent",s=n.steel,l=n.ash,d=n.emerald,p="Deal Published",m="default",h="0.9";break;case"error":s=n.amber,l=n.amber,d=n.amber,p=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=b)},tp=(t,e)=>{let o=document.createElement("button");o.id=Ze,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${K}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};He(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await Qc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},He(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},He(o,r),document.getElementById(So)&&r.checks&&Qa(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},He(o,r),_e();try{let m=await Zc(t,e);if(m.ok&&m.published)r={status:"published"},He(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},He(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},He(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(So)?_e():r.checks&&Qa(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},op=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rp=async()=>{for(let t of op)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},To=!1,en=async()=>{if(!To){To=!0;try{await np()}finally{To=!1}}},np=async()=>{let t=Qr();if(!t||!t.locationId){document.getElementById(Ze)?.remove(),document.getElementById(It)?.remove(),_e(),Ot();return}let e=document.getElementById(Ze);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(It)?.remove(),_e(),Ot());return}e&&(e.remove(),document.getElementById(It)?.remove(),_e());let o=await rp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Qr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=tp(t.oppId,a.locationId),s=document.createElement("span");s.id=It,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),ap(t.oppId)},Mt=null,Zr=null,Ot=()=>{Mt?.disconnect(),Mt=null,Zr=null},ap=t=>{if(Mt&&Zr===t)return;Ot();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zr=t,Mt=new MutationObserver(()=>{let o=Qr();if(!o||o.oppId!==t){Ot();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(Ze)?.remove(),document.getElementById(It)?.remove(),_e(),Ot();return}document.getElementById(Ze)||en()}),Mt.observe(e,{childList:!0,subtree:!0}))},Jr=null,Xr,ip=()=>{Jr||(Jr=new MutationObserver(()=>{Xr===void 0&&(Xr=window.setTimeout(()=>{Xr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ze)&&!To&&en()},300))}),Jr.observe(document.body,{childList:!0,subtree:!0}))},ei=()=>{ip(),en()};var ti="data:image/png;base64,",oi="data:image/png;base64,";var sp=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],ri=t=>`ws-crm-map-links-${t}`,Co=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},ni=t=>{let e=Co(t.addr),o=Co(t.city),r=Co(t.state),a=Co(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},lp=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,dp=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,cp=(t,e)=>{let{full:o,hasAny:r}=ni(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},pp=t=>{let e=document.createElement("span");e.id=ri(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),cp(t,s)}),l};return e.appendChild(r(ti,"Open in Google Maps",lp)),e.appendChild(r(oi,"Search on Zillow",dp)),e},bp=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},ai=()=>{for(let t of sp){if(document.getElementById(ri(t.key)))continue;let{hasAny:e}=ni(t);if(!e)continue;let o=bp(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(pp(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},tn=null,on,mp=()=>{tn||(tn=new MutationObserver(()=>{on===void 0&&(on=window.setTimeout(()=>{on=void 0;try{ai()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),tn.observe(document.body,{childList:!0,subtree:!0}))},ii=()=>{mp(),ai()};var si="ws-crm-hide-launchpad",li=/\/launchpad\/?$/,rn=()=>{if(!Ve()){if(!document.getElementById(si)){let t=document.createElement("style");t.id=si,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(li.test(location.pathname)){let t=location.pathname.replace(li,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var hp=[{label:"Buy-Box Entries"},{label:"Memberships"}],di=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},nn=()=>{let t=Ve(),e=new Set(hp.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){di(e);for(let o of[150,500,1200,2500])setTimeout(()=>di(e),o)}};var up=[{from:"Payments",to:"Contracts"}],vp=".nav-title, .topmenu-navtitle",ci=()=>{document.querySelectorAll(vp).forEach(t=>{let e=(t.textContent||"").trim(),o=up.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},an=()=>{ci();for(let t of[150,500,1200,2500])setTimeout(ci,t)};var pi="/payments/proposals-estimates",_p=/\/payments\/invoices\/?$/,gp=/\/payments\//,yp='#sb_payments, a[meta="payments"]',mi=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(pi)&&!(t>3&&!gp.test(e))){if(_p.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(pi));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>mi(t+1),120)}},bi=!1,fp=()=>{bi||(bi=!0,document.addEventListener("click",t=>{t.target?.closest?.(yp)&&setTimeout(()=>mi(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},sn=()=>{fp()};var hi=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ui="ws-crm-hide-topmenu-tabs",ln=()=>{if(document.getElementById(ui))return;let t=hi.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ui,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${hi.length} top tabs`)};var gi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Ee="ws-crm-send-to-closing-office-button",Pe="ws-crm-send-to-title-co-wrap",Lo="ws-crm-stc-dropdown",xp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,wp=/\/v2\/location\/([A-Za-z0-9]+)/,Io=()=>{let t=window.location.pathname,e=t.match(xp);if(!e)return null;let o=t.match(wp);return{oppId:e[1],locationId:o?o[1]:null}},kp=5*60*1e3,yi=t=>`ws-crm-stc-cache:${t}`,Ep=t=>{try{let e=window.localStorage.getItem(yi(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>kp||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Tp=(t,e)=>{try{window.localStorage.setItem(yi(t),JSON.stringify(e))}catch{}},Sp=async(t,e)=>{try{let o=await fetch(gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Cp=async(t,e,o)=>{let r=await fetch(gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Ap=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},vi=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},$p=(t,e)=>{if(e&&Ap(e)){window.setTimeout(()=>vi(t),300);return}vi(t)},ce=()=>{document.getElementById(Lo)?.remove()},Ao=(t,e,o)=>{ce();let r=document.createElement("div");r.id=Lo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let p=["TC","ACQ","MT","DISPO","Property"],b={};t.forEach(_=>{b[_.group]||(b[_.group]=[]),b[_.group].push(_)});let m=[...p.filter(_=>b[_]),...Object.keys(b).filter(_=>!p.includes(_))];for(let _ of m){let k=b[_],y=document.createElement("div");y.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,f.textContent=_,y.appendChild(f),k.forEach(g=>{let x=document.createElement("div"),S=!g.filled&&g.navigable&&g.field_id;x.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${S?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,S&&(x.addEventListener("mouseenter",()=>{x.style.background=n.slate}),x.addEventListener("mouseleave",()=>{x.style.background="transparent"}),x.addEventListener("click",w=>{w.stopPropagation(),g.field_id&&($p(g.field_id,g.folder),ce())}));let C=g.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=S?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";x.innerHTML=`${C}<span style="flex: 1;">${g.label}</span>${E}`,y.appendChild(x)}),r.appendChild(y)}document.body.appendChild(r);let h=_=>{let k=_.target;!r.contains(k)&&!o.contains(k)&&(ce(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},be=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,p="Send to Closing Office",b="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,p="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(y=>y.filled).length??0,k=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${k} Fields Ready`;break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,p=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=b)},Lp=(t,e)=>{let o=document.createElement("button");o.id=Ee,o.type="button",o.dataset.oppId=t;let r=Ep(t),a=r?{status:r.checks.every(f=>f.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${M}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,be(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Sp(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},be(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},be(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},be(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let g=f.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Mo.add(t),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce(),Ht();return}let x=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;x=f.checks.map((E,w)=>a.checks[w]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:x.every(C=>C.filled)?"ready":"incomplete",checks:x,previouslySentAt:f.previously_sent_at??null},Tp(t,{checks:x,previously_sent_at:f.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),be(o,a),document.getElementById(Lo)&&Ao(x,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},be(o,a),ce();try{let g=await Cp(t,e,f);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},be(o,a),g.checks&&Ao(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},be(o,a),window.setTimeout(()=>{k()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},be(o,a),g.checks&&Ao(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},be(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Lo)?ce():a.checks&&Ao(a.checks,a.previouslySentAt,o);break}case"error":case"sent":k();break}});let d,p=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,k=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};k();let y=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(y){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let x=Date.now()-b,S=Math.max(1500,m-x);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&k()},S)});f.observe(y,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},Ip=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mp=async()=>{for(let t of Ip)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Mo=new Set,_i=null,Op=t=>{t&&t!==_i&&(Mo.clear(),_i=t)},$o=!1,bn=async()=>{if($o){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}$o=!0;try{await Dp()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{$o=!1}},Dp=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Io();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Op(t.oppId),Mo.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Pe)?.remove(),ce(),Ht());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Pe)?.remove(),ce()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Mp();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Io();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Lp(t.oppId,a.locationId),s=document.createElement("span");s.id=Pe,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Hp(t.oppId)},Dt=null,pn=null,Ht=()=>{Dt?.disconnect(),Dt=null,pn=null},Hp=t=>{if(Dt&&pn===t)return;Ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pn=t,Dt=new MutationObserver(()=>{let o=Io();if(!o||o.oppId!==t){Ht();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce(),Ht();return}document.getElementById(Ee)||bn()}),Dt.observe(e,{childList:!0,subtree:!0}))},dn=null,cn,Pp=()=>{dn||(dn=new MutationObserver(()=>{cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ee);if(t&&!e&&!$o){let o=Io();if(o&&Mo.has(o.oppId))return;bn()}},300))}),dn.observe(document.body,{childList:!0,subtree:!0}))},fi=()=>{Pp(),bn()};var un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Rp=`${un}/tc/welcome-call-prefill`,Bp=`${un}/tc/welcome-call-save`,Fp=`${un}/tc/order-lockbox`,Pt="ws-crm-welcome-call-overlay",Np=["Regular Contract","Subject To","Seller Finance","Novation"],zp=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Gp=["Gas","Electric","Propane","Oil"],qp=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Up=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Te=["Yes","No"],Vp=["Yes","No","Unknown"],Wp=["Professional Photographer","Seller","Tenant"],jp=["Month-to-Month","Annual"],xi=["Current","Behind"],Kp=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],me=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Do=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ei="margin-bottom:12px;",Ti=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Yp=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,wi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=wi(o);return`<select id="${t}" style="${Do}"><option value=""></option>${e.map(a=>`<option ${r!==""&&wi(a)===r?"selected":""}>${me(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${me(e)}" placeholder="${me(o)}" style="${Do}">`,Jp=(t,e)=>`<textarea id="${t}" rows="3" style="${Do}resize:vertical;">${me(e)}</textarea>`,Xp=(t,e)=>`<input id="${t}" type="date" value="${me(e)}" style="${Do}">`,D=(t,e)=>`<div style="${Ei}"><label style="${Ti}">${me(t)}</label>${e}</div>`,mn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Kp.map(r=>`<label style="${Yp}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ge=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${me(t)}</div>`,et=()=>{document.getElementById(Pt)?.remove()},Re=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Qp=t=>{let e=t.tenant||{};return`
    ${ge("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${me(t.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${me(t.deal_address)||"(no address on file)"}</div>

    ${ge("Contract")}
    ${D("Type of Contract",j("wc-contract_type",Np,t.contract_type))}

    ${ge("Property")}
    ${D("Property Type",j("wc-property_type",qp,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",zp,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",Gp,t.heat_source))}

    ${ge("Liens & Permits")}
    ${D("Is there a mortgage?",j("wc-has_mortgage",Te,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${D("Mortgage payment status",j("wc-mortgage_payment_status",xi,t.mortgage_payment_status))}</div>
    ...
    ${ge("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",Up,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",jp,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Rent status",j("wc-tenant_rent_status",xi,e.rent_status))}</div>
        <div style="flex:1;">${D("Last rent paid",Xp("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",Vp,t.hoa_rental_restriction))}</div>

    ${ge("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",Wp,t.photos_provided_by))}
    <div style="${Ei}">
      <label style="${Ti}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${mn("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${mn("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${mn("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${Oo(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Oo(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Oo(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${Oo(t).text}</span>
      </div>
    </div>

    ${ge("Notes")}
    ${D("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",Jp("wc-welcome_call_notes",t.welcome_call_notes))}
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},hn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),ki=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Oo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?me(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Zp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:hn("photos_avail_mornings"),photos_avail_afternoons:hn("photos_avail_afternoons"),photos_avail_evenings:hn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),eb=t=>{et();let e=document.createElement("div");e.id=Pt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${Pt} input[type="date"]::-webkit-calendar-picker-indicator,#${Pt} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${Qp(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",i=>{i.target===e&&et()}),document.getElementById("wc-close")?.addEventListener("click",et),document.getElementById("wc-cancel")?.addEventListener("click",et),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",ki)}),ki();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!A("wc-occupancy")){Re("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Zp(t)),credentials:"omit"})).ok?(et(),Re("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Re("Save failed \u2014 try again.","err"))}catch(i){c.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Re("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Fp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:A("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:A("wc-lockbox_recipient_name"),recipient_phone:A("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),Re("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,Re("Lockbox order failed \u2014 try again.","err"))}catch(s){c.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,Re("Couldn't reach the lockbox handler. Try again.","err")}})},Si=async(t,e)=>{et();let o=document.createElement("div");o.id=Pt,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Rp}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else c.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){c.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,eb(r)};var kn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",tb=`${kn}/tc/confirm-photo-appointment`,ob=`${kn}/tc/order-lockbox`,rb=`${kn}/tc/welcome-call-prefill`,fn="ws-crm-opp-action-bar",Ai="ws-crm-opp-overflow",$i="ws-crm-opp-action-menu",xn="ws-crm-opp-action-popover",Li="ws-crm-reorder-lockbox-modal",Ii=".hr-card.hr-modal.crm-opportunities-modal",nb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ab=/\/v2\/location\/([A-Za-z0-9]+)/,Mi="Welcome Call Needed",En="Scheduling Photos",Oi="Photos Scheduled",ib=[Mi,En,Oi,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Di=()=>{let t=window.location.pathname,e=t.match(nb);if(!e)return null;let o=t.match(ab);return o?{oppId:e[1],locationId:o[1]}:null},sb=()=>{let t=document.querySelector(Ii);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(ib.includes(r))return r}return null},Ce=()=>{document.getElementById($i)?.remove(),document.getElementById(xn)?.remove(),document.getElementById(Li)?.remove()},vn=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Se=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},lb=t=>{Si(t.oppId,t.locationId)},db=async(t,e,o)=>(await fetch(ob,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,cb=(t,e)=>{Ce();let o=document.createElement("div");o.id=Li,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${vn(e.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${vn(e.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${vn(s)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",b=document.getElementById("wsrl-phone")?.value.trim()||"",m=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!m){Se("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await db(t,e,{recipient_name:p,recipient_phone:b,ship_to:m})?(l(),Se("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",Se("Re-order failed \u2014 try again.","err"))}catch(h){c.warn("[action-bar] reorder lockbox failed:",h),d.disabled=!1,d.textContent="Order Lockbox",Se("Couldn't reach the lockbox handler. Try again.","err")}}})},Hi=async t=>{Ce();let e={};try{e=await fetch(`${rb}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}cb(t,e)},pb=(t,e)=>{Ce();let o=document.createElement("div");o.id=xn;let r=e.getBoundingClientRect();o.style.cssText=`
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(tb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},bb=(t,e)=>{Ce();let o=document.createElement("div");o.id=$i;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Po=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=M,o.textContent=t,o},mb=()=>{let t=Po("\u22EE","ghost");return t.style.lineHeight="1",t},hb=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Mi){let r=Po("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>lb(t)),o.appendChild(r),o}if(e===En){let r=Po("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>pb(t,r)),o.appendChild(r),o}if(e===Oi){let r=Po("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Hi(t)),o.appendChild(r),o}return null},ub=(t,e)=>{let o=[];if(e===En&&(o=[{label:"Re-order Lockbox",onClick:()=>void Hi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Ai,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=mb();return a.addEventListener("click",i=>{i.stopPropagation(),bb(o,a)}),r.appendChild(a),r},vb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],_b=async()=>{for(let t of vb)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ho=()=>{document.getElementById(fn)?.remove(),document.getElementById(Ai)?.remove(),Ce()},Ro=!1,Tn=async()=>{if(!Ro){Ro=!0;try{let t=Di();if(!t){Ho();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ho();return}let o=sb(),r=document.getElementById(fn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=hb(t,o);if(!a){Ho();return}let i=await _b();if(!i)return;Ho();let s=U(i),l=document.createElement("span");l.id=fn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=ub(t,o);d&&s.appendChild(d),gb(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Ro=!1}}},Rt=null,wn=null,_n,Ci=()=>{Rt?.disconnect(),Rt=null,wn=null},gb=t=>{if(Rt&&wn===t)return;Ci();let e=document.querySelector(Ii);e&&(wn=t,Rt=new MutationObserver(()=>{let o=Di();if(!o||o.oppId!==t){Ci();return}_n===void 0&&(_n=window.setTimeout(()=>{_n=void 0,Tn()},250))}),Rt.observe(e,{childList:!0,subtree:!0}))},gn=null,yn,yb=()=>{gn||(gn=new MutationObserver(()=>{yn===void 0&&(yn=window.setTimeout(()=>{yn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Ro&&Tn()},300))}),gn.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{yb(),Tn()};var Ri="ws-support-modal",Bi="ws-support-toast",fb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Fi="ws-support-submitter-name",Ni="ws-support-submitter-email",zi="ws-support-submitter-role",xb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Be=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),wb=(t,e="success",o)=>{let r=document.getElementById(Bi);r&&r.remove();let a=document.createElement("div");a.id=Bi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${Be(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${Be(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},kb=()=>{document.getElementById(Ri)?.remove();let t=(localStorage.getItem(Fi)??"").trim(),e=(localStorage.getItem(Ni)??"").trim(),o=(localStorage.getItem(zi)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ri,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${Be(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Be(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Be(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Be(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Fi,r.submitterName),localStorage.setItem(Ni,r.submitterEmail),r.submitterRole&&localStorage.setItem(zi,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";wb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Eb=["/support-ticket","ws-support-modal","ws-support"],Tb=/\/custom-menu-link\//,Sn=!1,Gi=()=>{if(Sn||!Tb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Eb.some(s=>i.includes(s))});if(r){Sn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{kb(),Sn=!1},50);return}t<10&&setTimeout(e,150)};e()},qi=!1,Ui=()=>{qi||(qi=!0,we(()=>setTimeout(Gi,50)),Gi(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Vi="ws-phone-assignments-modal",Wi="ws-phone-assignments-toast",Sb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Cb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Ab=["ACQ","DISPO","TC"],An="",he=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),$b=(t,e="success",o)=>{document.getElementById(Wi)?.remove();let r=document.createElement("div");r.id=Wi;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${he(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${he(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},ji=(t,e,o)=>{let r=[`<option value="" ${o===An?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${he(a)}" ${o===a?"selected":""}>${he(a)}</option>`)].join("");return`<select data-assign="${he(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Ki=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,$n=async t=>{document.getElementById(Vi)?.remove();let e=t||re(),o=document.createElement("div");o.id=Vi,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div style="font-size:13px;color:${n.ash};margin-bottom:18px;">Map each rep and each phone number to a team. Local-presence dialing then keeps each team on its own numbers, so callbacks route to the right people.</div>
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",y=>{y.target===o&&o.remove()}),!e){let y=r.querySelector("#ws-pa-body");y&&(y.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Sb}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(y){c.error("[phone-assignments] GET failed",y);let f=r.querySelector("#ws-pa-body");f&&(f.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${he(y.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:Ab,s=a.numbers??[],l=a.users??[],d={...a.config?.numberTeam??{}},p={...a.config?.repTeam??{}},b=y=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${y} found.</div>`,m=l.length?l.map(y=>`<div style="${Ki}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${he(y.name||y.id)}</div>
              ${y.email?`<div style="color:${n.coolGray};font-size:11px;">${he(y.email)}</div>`:""}
            </div>
            ${ji(`rep:${y.id}`,i,p[y.id]??An)}
          </div>`).join(""):b("users"),h=s.length?s.map(y=>`<div style="${Ki}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${he(y.label||y.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${u.mono};">${he(y.e164)}</div>
            </div>
            ${ji(`num:${y.e164}`,i,d[y.e164]??An)}
          </div>`).join(""):b("phone numbers"),_=y=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${y}</div>`,k=r.querySelector("#ws-pa-body");k&&(k.innerHTML=`
    ${_("Reps \u2192 Team")}
    <div style="border:1px solid ${n.steel};border-radius:${v.md};overflow:hidden;">${m}</div>
    ${_("Numbers \u2192 Team")}
    <div style="border:1px solid ${n.steel};border-radius:${v.md};overflow:hidden;">${h}</div>
    ...
    </div>`,k.querySelectorAll("select[data-assign]").forEach(y=>{y.addEventListener("change",()=>{let f=y.getAttribute("data-assign")||"",[g,...x]=f.split(":"),S=x.join(":");g==="rep"?y.value?p[S]=y.value:delete p[S]:g==="num"&&(y.value?d[S]=y.value:delete d[S])})}),k.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),k.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let y=k.querySelector("#ws-pa-err"),f=x=>{y&&(y.textContent=x)};f("");let g=k.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let S=await(await fetch(Cb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d,repTeam:p})})).json();if(!S.ok){f(S.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),$b("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){f(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},Lb=["ws-phone-assignments","phone-assignments"],Ib=/\/custom-menu-link\//,Cn=!1,Yi=()=>{if(Cn||!Ib.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Lb.some(s=>i.includes(s))});if(r){Cn=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{$n(i),Cn=!1},50);return}t<10&&setTimeout(e,150)};e()},Ji=!1,Xi=()=>{if(Ji)return;Ji=!0,we(()=>setTimeout(Yi,50)),Yi();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&$n()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void $n(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var Zi="powerDialerApp",Mb=".dialer",Ob='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Db=".dial-item.dial-btn.dial-btn-enabled",Fe=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Ln=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},es=()=>{try{let e=window[Zi]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){c.debug("[dialer-bridge] getEmitter failed",t)}return null},tt=()=>document.querySelector(Mb),ts=()=>es()!==null||tt()!==null?!0:!!window[Zi],Bo=(t,e)=>{let o=es();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return c.error(`[dialer-bridge] emit ${t} threw`,r),!1}},os=()=>{if(tt())return;let t=document.querySelector(Ob);t?Fe(t):c.warn("[dialer-bridge] Voice Calling button not found")},Hb=()=>{let t=document.querySelector(".number-list-container")||tt();if(!t)return[];let e=[...t.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of e){let i=Ln(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},Qi=()=>{let t=document.querySelector(".number-config .ui-text-sm-medium");if(t){let o=Ln(t.innerText);if(o)return o}let e=document.querySelector(".number-config");return e?Ln(e.innerText):null},rs=t=>{if(Qi()===t)return!0;let e=document.querySelector(".number-config, .dialer-config");e&&Fe(e);let o=Hb().find(r=>r.e164===t);return o?(Fe(o.el),Qi()===t):(c.warn(`[dialer-bridge] Calling From ${t} not available to this rep`),!1)},ns=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(t=>/local/i.test(t.innerText||""))||null,Pb=()=>{let t=ns();return t?!/bg-gray-100/.test(t.className):!1},as=t=>{let e=ns();e&&Pb()!==t&&Fe(e)},is=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Bo("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&Fe(a)}},ss=()=>{let t=tt();if(!t)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(Db)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Fe(e),!0):Bo("makeCall",{provider:"twilio"})};var In=()=>{let t=tt();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Fe(e.closest("button")||e):Bo("closeCallBox")},ls=()=>{Bo("closeCallBox")},ds=t=>{let e=!1,o=()=>{let i=tt()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(e=!0),e&&l){e=!1;try{t()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var Rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Bt=null,cs=null,Bb=async(t=!1)=>{let e={numberTeam:{},repTeam:{}},o=re();if(!o)return e;if(!t&&Bt&&cs===o)return Bt;try{let a=await(await fetch(`${Rb}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json();return Bt={numberTeam:a?.config?.numberTeam??{},repTeam:a?.config?.repTeam??{}},cs=o,Bt}catch(r){return c.warn("[silo] config load failed",r),Bt??e}},ps=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},Fb=t=>{let e=O();return e&&t.repTeam[e]||null},Nb=(t,e)=>Object.entries(t.numberTeam).filter(([,o])=>o===e).map(([o])=>o),bs=async t=>{let e=await Bb(),o=Fb(e);if(!o)return c.debug("[silo] current rep not mapped to a team; leaving GHL default"),null;let r=Nb(e,o);if(!r.length)return c.debug(`[silo] team ${o} has no numbers; leaving GHL default`),null;let a=ps(t),i=a?r.find(d=>ps(d)===a):void 0,s=i||r[0];try{as(!1)}catch{}return rs(s)?(c.info(`[silo] team ${o}: calling ${t} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} in the dialer (not available to this rep?)`),null)};var zb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ms="data-ws-pd",hs="ws-pd-panel",us="ws-pd-session",Ne=t=>new Promise(e=>setTimeout(e,t)),Ft=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Gb=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},qb=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},Ub=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),e.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},Vb=async t=>{let e=Gb(t);if(!e)return[];let o=qb(e),r=-1;for(let a=0;a<60;a++){let i=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ne(550)}return o.scrollTop=0,Ub(e)},Wb=async(t,e)=>{try{let r=await(await fetch(zb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},jb=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,Kb=(t,e)=>{document.getElementById(hs)?.remove();let o=document.createElement("div");o.id=hs,o.style.cssText=jb;let r=document.createElement("div");r.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let a=e.map((d,p)=>`<label data-row="${p}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${p}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Ft(d.name||d.contactId)}</span>
    ...
    <div style="font-size:14px;font-weight:600;margin:2px 0 2px;">${Ft(t)}</div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:12px;">${e.length} opportunit${e.length===1?"y":"ies"} loaded. Pick who to call.</div>
    ...
    <div id="ws-pd-list" style="flex:1;overflow-y:auto;border:1px solid ${n.steel};border-radius:${v.md};min-height:120px;">${a||`<div style="padding:14px;color:${n.coolGray};font-size:12px;">No opportunities found in this stage.</div>`}</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
    ...
    </div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",d=>{d.target===o&&o.remove()});let i=r.querySelector("#ws-pd-list"),s=r.querySelector("#ws-pd-count"),l=()=>{let d=r.querySelectorAll(".ws-pd-cb:checked").length;s&&(s.textContent=`${d} selected`)};l(),i?.addEventListener("change",l),r.querySelector("#ws-pd-search")?.addEventListener("input",d=>{let p=d.target.value.toLowerCase();r.querySelectorAll("[data-row]").forEach(b=>{let m=(b.textContent||"").toLowerCase();b.style.display=m.includes(p)?"flex":"none"})}),r.querySelector("#ws-pd-all")?.addEventListener("change",d=>{let p=d.target.checked;r.querySelectorAll("[data-row]").forEach(b=>{if(b.style.display==="none")return;let m=b.querySelector(".ws-pd-cb");m&&(m.checked=p)}),l()}),r.querySelector("#ws-pd-cancel")?.addEventListener("click",()=>o.remove()),r.querySelector("#ws-pd-start")?.addEventListener("click",()=>{let d=[];r.querySelectorAll(".ws-pd-cb:checked").forEach(b=>{let m=Number(b.getAttribute("data-i"));e[m]&&d.push(e[m])});let p=r.querySelector("#ws-pd-auto")?.checked??!0;o.remove(),d.length&&vs(t,d,p)})},vs=async(t,e,o)=>{let r=re();if(!r)return;document.getElementById(us)?.remove();let a={skip:!1,paused:!1,stopped:!1,advance:!1},i=document.createElement("div");i.id=us,i.style.cssText=`position:fixed;bottom:24px;left:24px;z-index:100002;width:300px;background:${n.graphite};border:1px solid ${n.steel};border-left:4px solid ${n.emerald};border-radius:${v.md};padding:14px 16px;color:${n.bone};font-family:${u.sans};box-shadow:0 10px 30px rgba(0,0,0,0.5);`,document.body.appendChild(i);let s=(l,d,p)=>{i.innerHTML=`
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${Ft(t)} \xB7 ${d+1} of ${e.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Ft(p)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${Ft(l)}</div>
      ...
      </div>`,i.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{In()}catch{}i.remove()}),i.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{In()}catch{}}),i.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),i.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let l=0;l<e.length&&!a.stopped;l++){let d=e[l];a.skip=!1,a.advance=!1,s("Resolving number\u2026",l,d.name);let p=d._phone?{name:d.name,phone:d._phone}:await Wb(r,d.contactId);if(a.stopped)break;if(!p||!p.phone){s("No phone on file \u2014 skipping",l,d.name||p?.name||d.contactId),await Ne(1400);continue}let b=p.name||d.name;if(await bs(p.phone),a.stopped)break;s(`Calling ${p.phone}\u2026`,l,b);try{os(),await Ne(250),is(p.phone),await Ne(250),ss()}catch(m){c.error("[bulk-dialer] dial failed",m)}if(await new Promise(m=>{let h=!1,_=()=>{h||(h=!0,k(),m())},k=ds(_),y=window.setInterval(()=>{(a.stopped||a.skip)&&(window.clearInterval(y),_())},300)}),a.stopped)break;try{ls()}catch{}if(l<e.length-1)if(o)for(let m=5;m>0&&!a.stopped&&!a.advance;m--){for(s(`Next call in ${m}s\u2026`,l,b);a.paused&&!a.stopped&&!a.advance;)await Ne(200);if(a.advance||a.stopped)break;await Ne(1e3)}else for(s("Ready \u2014 press Call Next",l,b);!a.advance&&!a.stopped;)await Ne(200)}a.stopped||(i.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>i.remove(),5e3))},Yb='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Jb=()=>{try{if(localStorage.getItem("ws-pd")==="1")return!0}catch{}return Ve()},Xb=()=>{if(ba()!=="opportunity-list"||!Jb()||!ts())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${ms}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(ms,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Yb}<span>DIAL</span>`,a.addEventListener("click",async i=>{i.stopPropagation(),i.preventDefault();let s=a.querySelector("span"),l=s?.textContent||"DIAL";s&&(s.textContent="Loading\u2026"),a.style.opacity="0.7";try{let d=await Vb(e);Kb(r,d)}catch(d){c.error("[bulk-dialer] harvest failed",d)}finally{s&&(s.textContent=l),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},ot=null,Mn,_s=()=>{window.WS_CRM_PD_TEST=e=>void vs("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Mn!==void 0&&window.clearTimeout(Mn),Mn=window.setTimeout(Xb,400)};we(e=>{e==="opportunity-list"?(t(),ot||(ot=new MutationObserver(t),ot.observe(document.body,{childList:!0,subtree:!0}))):ot&&(ot.disconnect(),ot=null)})};var Qb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Zb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",em="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",fs="tc_closing_agent",tm="tc_closing_office",pe="ws-crm-closing-agent-picker-button",xs="ws-crm-closing-agent-picker-modal",om=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rm=/\/v2\/location\/([A-Za-z0-9]+)/,Gt=()=>{let t=window.location.pathname,e=t.match(om);if(!e)return null;let o=t.match(rm);return{oppId:e[1],locationId:o?o[1]:null}},Nn=async t=>{let e=await fetch(Qb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},gs=async t=>{let e=await fetch(Zb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},nm=async(t,e)=>{try{let o=await fetch(em,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:fs}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Nn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},ze=null,am=60*60*1e3,zn=t=>`ws-crm-to-cache:${t}`,ws=t=>{try{let e=window.localStorage.getItem(zn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>am||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},ks=(t,e,o)=>{try{window.localStorage.setItem(zn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},im=t=>{try{window.localStorage.removeItem(zn(t))}catch{}},Pn="ws-crm-closing-agent-field-link",sm=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Pn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},On=!1,Gn=async t=>{if(On)return;let e=Es();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){On=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Nn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Rn(a.id,a.name,t);let i=document.getElementById(pe);if(i){Ae(i,{status:"linked",contactName:a.name});let s=Gt();s&&ks(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{On=!1}}},lm=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Es=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();lm.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Rn=(t,e,o)=>{let r=Es();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Pn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Pn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Fo=()=>{document.getElementById(xs)?.remove()},dm=t=>{Fo();let e=document.createElement("div");e.id=xs,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&Fo()}),i?.addEventListener("click",Fo);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await Nn({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",b.results.forEach(m=>{let h=document.createElement("button");h.type="button",h.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${No(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${No(m.email||"(no email)")} \xB7 ${No(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${No(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Fo(),t.onPick(m)}),a.appendChild(h)})}catch(b){c.error("Closing Agent picker search failed",b),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let p=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(p)},250)})},No=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ae=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,p="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,p="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,p="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=p},cm=(t,e)=>{let o=document.createElement("button");o.id=pe,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Ae(o,r);let a=ws(t);return a&&(r={status:"linked",contactName:a.contactName},Ae(o,r),ze={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await nm(t,e);s?(r={status:"linked",contactName:s.name},Ae(o,r),ze={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Rn(s.id,s.name,e)):a||(r={status:"empty"},Ae(o,r),ze?.oppId===t&&(ze=null),sm(),im(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||dm({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ae(o,r);try{let l=[gs({tenantId:e,oppId:t,fieldKey:fs,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(gs({tenantId:e,oppId:t,fieldKey:tm,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ae(o,r),ze={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},ks(t,s.id,s.name),Rn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ae(o,r)}}})}),o},pm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],bm=async()=>{for(let t of pm)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Nt=!1,Go=async()=>{if(!Nt){Nt=!0;try{await mm()}finally{Nt=!1}}},mm=async()=>{let t=Gt();if(!t||!t.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),zo();return}let e=document.getElementById(pe);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove(),zo());return}e&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await bm();if(!r||!(ws(t.oppId)!==null||ze!==null&&ze.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Gt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=cm(t.oppId,i.locationId),l=document.createElement("span");l.id=`${pe}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),hm(t.oppId),Gn(i.locationId)},zt=null,Bn=null,Fn=null,zo=()=>{zt?.disconnect(),zt=null,Bn=null,Fn=null},hm=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(zt&&Bn===t&&Fn===e||(zo(),Bn=t,Fn=e,zt=new MutationObserver(()=>{let o=Gt();if(!o||o.oppId!==t||!o.locationId){zo();return}document.getElementById(pe)||Go(),Gn(o.locationId)}),zt.observe(e,{childList:!0,subtree:!0})))},Dn=null,Hn,um=()=>{Dn||(Dn=new MutationObserver(()=>{Hn===void 0&&(Hn=window.setTimeout(()=>{Hn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(pe);t&&!e&&!Nt&&Go()},300))}),Dn.observe(document.body,{childList:!0,subtree:!0}))},ys,vm=()=>{ys===void 0&&(ys=window.setInterval(()=>{let t=Gt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(pe)&&!Nt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Go()),Gn(t.locationId)},2e3))},Ts=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),um(),vm(),Go()};var _m="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Le="ws-crm-manage-team-cta",Ss="ws-crm-manage-team-modal",gm=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Cs={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},ym={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},As=()=>{let t=window.location.pathname.match(gm);return t?{tenantId:t[1]}:null},Uo=async t=>{let e=await fetch(_m,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ae=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$e=t=>ae(t),qn="ws-crm-manage-team-toast",Wn=(t,e="info",o=4e3)=>{document.getElementById(qn)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=qn,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(qn)===a&&a.remove()},o)},Un=()=>{document.getElementById(Ss)?.remove()},fm=(t,e)=>{let o=ym[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ae(e)}</span>
  `},xm=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>fm(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${$e(t.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${ae(t.email)}${t.phone?` &middot; ${ae(t.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${$e(t.email)}" data-user-id="${$e(t.id)}" data-name="${$e(o)}" data-current-roles="${$e(t.role_keys.join(","))}" style="${M} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${$e(t.email)}" data-name="${$e(o)}" data-role-count="${$e(String(t.role_keys.length))}" style="${M} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},wm=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>xm(r,e)).join(""),Vo=async t=>{Un();let e=document.createElement("div");e.id=Ss,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&Un()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <button id="ws-team-close" style="${M} font-size: 12px;">Close</button>
    </div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Un);let r;try{r=await Uo({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
      ...
      `);return}let a=O(),i=!!(a&&r.roster.some(d=>d.id===a&&d.role_keys.includes("manager"))),s=r.summary?`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+wm(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{km(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;Em(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;Tm(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},km=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,i.innerHTML=`
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
      <button id="ws-team-add-cancel" style="${M} font-size: 12px;">Cancel</button>
  ...
  `,o.appendChild(i),document.body.appendChild(o),i.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),i.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let s=(i.querySelector("#ws-team-add-first")?.value||"").trim(),l=(i.querySelector("#ws-team-add-last")?.value||"").trim(),d=(i.querySelector("#ws-team-add-email")?.value||"").trim(),p=(i.querySelector("#ws-team-add-mobile")?.value||"").trim(),b=(i.querySelector("#ws-team-add-role")?.value||"").trim(),m=i.querySelector("#ws-team-add-error"),h=i.querySelector("#ws-team-add-submit");if(!s||!l||!d||!p||!b){m&&(m.textContent="All fields are required.");return}h&&(h.disabled=!0,h.textContent="Adding\u2026",h.style.opacity="0.7"),m&&(m.textContent="");try{let _=await Uo({tenant_id:t,action:"add",first_name:s,last_name:l,email:d,mobile:p,role:b,triggered_by_user_id:O()});if(!_.ok){m&&(m.textContent=_.error||"Failed to add employee"),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1");return}o.remove(),Wn(`Added ${s} ${l} as ${Cs[b]||b}.`,"success"),await Vo(t)}catch(_){m&&(m.textContent=_.message),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1")}})},Em=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ae(Cs[s])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${ae(e.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${ae(e.email)}</div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-edit-cancel" style="${M} font-size: 12px;">Cancel</button>
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${ae(e.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${ae(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-remove-cancel" style="${M} font-size: 12px;">Cancel</button>
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await Uo({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:O()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),Wn(`Removed ${e.name} from the team.`,"success"),await Vo(t)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},Sm=89,Cm=93,Am=310,$m=34,Lm=14,Im=14,Mm=3,qo=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+Sm;t.style.right=`${Math.max(r,16)}px`},Om=t=>{let e=document.createElement("button");return e.id=Le,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${Cm}px;
    right: 24px;
    width: ${Am}px;
  ...
  `,e.addEventListener("click",()=>{Vo(t)}),qo(e),setTimeout(()=>qo(e),200),setTimeout(()=>qo(e),800),window.addEventListener("resize",()=>qo(e)),e},Vn=!1,Dm=()=>{if(!Vn){Vn=!0;try{let t=As();if(!t){document.getElementById(Le)?.remove(),document.getElementById(`${Le}-floater`)?.remove();return}let e=document.getElementById(Le);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Le}-floater`)?.remove();let o=document.createElement("div");o.id=`${Le}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Om(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Vn=!1}}},$s=()=>{if(!As()){document.getElementById(Le)?.remove(),document.getElementById(`${Le}-floater`)?.remove();return}Dm()};var Hm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Yn="ws-crm-prepare-contract-button",Ls="ws-crm-prepare-contract-menu",ve="ws-crm-prepare-contract-modal",Is="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Rs=()=>{if(document.getElementById(Is))return;let t=document.createElement("style");t.id=Is,t.textContent=`
  ...
  `,document.head.appendChild(t)},Jn="__WS_CRM_CAPTURED_AUTH",Pm=50*60*1e3,Yo=()=>{try{let t=localStorage.getItem(Jn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Pm?(localStorage.removeItem(Jn),null):e:null}catch{return null}},Rm=t=>{try{localStorage.setItem(Jn,JSON.stringify(t))}catch{}},nt=()=>{let t=Yo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Ms=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Yo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),rt=async(t,e={},o=2)=>{let r=Yo()?.capturedAt??0,a;try{a={...nt(),...e.headers??{}}}catch(s){if(o>0&&await Ms(r,4e3))return rt(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await Ms(r,4e3)?rt(t,e,o-1):i},Os=!1,Bm=()=>{if(Os)return;Os=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Yo()?.authorization;Rm({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Bs=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Fm=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Bs()},Nm=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Fs="__WS_CRM_TEMPLATES_CACHE_V1",zm=24*60*60*1e3,Ds=t=>{try{let e=window.localStorage.getItem(Fs);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>zm?null:o.templates}catch{return null}},Gm=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Fs,JSON.stringify(o))}catch{}},qm=async t=>{let e=`${ye}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await rt(e,{method:"GET"})}catch(s){let l=Ds(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Ds(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Nm(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Gm(t,i),i},Um=async(t,e)=>{let o=await rt(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await rt(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},Vm=async(t,e)=>{let o=await rt(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:nt()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Wm=async t=>{let e=await fetch(Hm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},jm=async(t,e,o)=>{let r=`${ye}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:nt()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Km=async(t,e)=>{let o=await fetch(`${ye}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:nt()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Ym=async t=>{let e=await fetch(`${ye}/contacts/${t}`,{method:"GET",headers:nt()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Jm=async(t,e,o,r)=>{let a;try{a=await Km(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Ym(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ye}/proposals/document/${e}`,{method:"PUT",headers:{...nt(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},Xm=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},jo="__WS_CRM_PENDING_INSTRUCTIONS",Qm=60*1e3,Zm=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],eh=t=>{let e=(t||"").toLowerCase();for(let o of Zm)if(e.includes(o.matches.toLowerCase()))return o;return null},th=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(jo,JSON.stringify(r))}catch{}},oh=()=>{try{let t=localStorage.getItem(jo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Qm?(localStorage.removeItem(jo),null):e}catch{return null}},rh=()=>{try{localStorage.removeItem(jo)}catch{}},nh=(t,e)=>{document.getElementById(ve)?.remove();let o=document.createElement("div");o.id=ve,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},ah=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,ih=()=>{let t=window.location.pathname.match(ah);if(!t)return;let e=t[1],o=oh();o&&o.proposalId===e&&(rh(),window.setTimeout(()=>{nh(o.title,o.bodyHtml)},600))},Hs="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(Hs)?.remove();let r=document.createElement("div");r.id=Hs;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Ps=(t,e)=>new Promise(o=>{document.getElementById(ve)?.remove();let r=document.createElement("div");r.id=ve,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${ue(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${n.slate};
    ...
    `,r.appendChild(a),document.body.appendChild(r);let l=d=>{r.remove(),o(d)};r.addEventListener("click",d=>{d.target===r&&l(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>l(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.borderColor=n.emerald,d.style.background=n.graphite}),d.addEventListener("mouseleave",()=>{d.style.borderColor=n.steel,d.style.background=n.slate}),d.addEventListener("click",p=>{p.stopPropagation(),p.preventDefault();let b=d.dataset.oppId||"";b&&l(b)})})}),sh=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(ve)?.remove(),Rs();let a=r.debug||{},i=typeof a.propertyAddress=="string"?a.propertyAddress:"",s=typeof a.sellerName=="string"?a.sellerName:"",l=typeof a.purchasePrice=="number"?a.purchasePrice:0,d=typeof a.emd=="number"?a.emd:0,p=typeof a.cashAtClose=="number"?a.cashAtClose:l-d,b=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),m=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),h=typeof a.additionalTerms=="string"?a.additionalTerms:"",_=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",k=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",y=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],f=document.createElement("div");f.id=ve,f.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,$=`
    ...
    padding-right: 28px;
  `,P=V=>['<option value="">(unset)</option>'].concat(y.map(J=>`<option value="${ue(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ue(s)}" placeholder="Seller name" style="${S}" />
      </div>
      <div style="${w}">
      ...
      <div style="${w}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ue(b)}" placeholder="e.g. 30" style="${S}" />
      </div>
      <div style="${w}">
        <div style="${x}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${ue(m)}" placeholder="e.g. 10" style="${S}" />
      </div>
      <div style="${w}">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-occupancy-at-close" style="${$}">${P(k)}</select>
      </div>
      <div style="${w} align-items: flex-start;">
        <div style="${x}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${S} resize: vertical; min-height: 60px; font-family: ${u.sans};">${te(h)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,f.appendChild(g),document.body.appendChild(f);let q=g.querySelector("#ws-pc-purchase-price"),z=g.querySelector("#ws-pc-emd"),N=g.querySelector("#ws-pc-cash-at-close"),R=!1;N?.addEventListener("input",()=>{R=!0});let fe=()=>{if(R)return;let V=Number(q?.value||0),J=Number(z?.value||0);N&&(N.value=String(Math.max(0,V-J)))};q?.addEventListener("input",fe),z?.addEventListener("input",fe);let xe=()=>f.remove();f.addEventListener("click",V=>{V.target===f&&xe()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",xe);let ee=g.querySelector("#ws-pc-submit"),oe=g.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){oe&&(oe.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let V=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(q?.value||0),it=Number(z?.value||0),st=Number(N?.value||0),lt=(g.querySelector("#ws-pc-days-to-close")?.value??"").trim(),dt=(g.querySelector("#ws-pc-inspection-days")?.value??"").trim(),ct=(g.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Ue=(g.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),pt=(g.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),it!==d&&(X.emd=it),st!==p&&(X.cashAtClose=st),lt!==b&&(X.daysToClose=lt),dt!==m&&(X.inspectionDays=dt),ct!==h&&(X.additionalTerms=ct),Ue!==_&&(X.currentOccupancy=Ue),pt!==k&&(X.occupancyAtClose=pt),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),ee.textContent="Saving\u2026";let ir=O(),sr=await Ko({tenantId:t,contactId:e,template:o,userId:ir,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",sr),ee.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await Zn(t,e,o,Q)}catch(V){ee.disabled=!1,ee.textContent="Open Contract",oe&&(oe.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},lh=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ve)?.remove(),Rs();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,k=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,y=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",g=s,x=l,S="",C=document.createElement("div");C.id=ve,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ue(b)}" placeholder="Seller name" style="${T}" />
      </div>
      <div style="${q}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${ue(f)}" placeholder="Buyer's entity / LLC name" style="${T}" />
      </div>
      <div style="${q}">
        <div style="${w}">Assignment Price</div>
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${m}" style="${$}" />
        </div>
      </div>
      <div style="${q}">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${ue(y)}" placeholder="Title company" style="${T}" />
      </div>
      <div style="${q}">
        <div style="${w}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${ue(g)}" style="${T}" />
      </div>
      <div style="${q}">
        <div style="${w}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${ue(x)}" style="${T}" />
      </div>
      <div style="${q}">
    ...
    <div style="
      ...
      margin: 0 0 14px;
      line-height: 1.4;
    ">Assignment Fee = Assignment Price \u2212 Original Purchase ($${k.toLocaleString("en-US",{minimumFractionDigits:2})}), auto-recalculated on Price edit. Type a value to override.</div>
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),R=E.querySelector("#ws-pc-assignment-fee"),fe=!1;R?.addEventListener("input",()=>{fe=!0});let xe=()=>{if(fe)return;let J=Number(N?.value||0);R&&(R.value=String(Math.max(0,J-k)))};N?.addEventListener("input",xe);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),it=Number(N?.value||0),st=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),lt=Number(R?.value||0),dt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),ct=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Ue=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),pt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Ue){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),it!==m&&(Q.assignmentPrice=it),st!==h&&(Q.buyerEMD=st),lt!==_&&(Q.assignmentFee=lt),dt!==y&&(Q.closingOffice=dt),ct!==f&&(Q.buyerCompanyName=ct);let ir=Ue!==g||pt!==x||X!==S,sr=Object.keys(Q).length>0||ir,lr=a;sr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",lr=await Ko({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Ue,buyerEarnestDueDate:pt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",lr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let la=lr?.debug?.propertyAddress||p,wl=la?`${la} - Assignment Agreement`:void 0;await Zn(t,e,o,wl),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},Ko=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Wm({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Zn=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await jm(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Jm(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=eh(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),th(a,s.title,s.bodyHtml)),Xm(t,a)},dh=async t=>{let e=Fm(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(Ls)?.remove();let o=document.createElement("div");o.id=Ls,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await qm(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let g;try{g=await Vm(e.tenantId,e.contactId)}catch(x){Y(`Failed to load buyer's MT opps: ${x.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",x);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)b=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let x=await Ps(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!x){c.info("[prepare-contract] MT opp picker cancelled");return}b=x,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=g=>{let x=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),C=String(g.getDate()).padStart(2,"0");return`${x}-${S}-${C}`},h=g=>{let x=new Date;return x.setDate(x.getDate()+g),m(x)},_=h(45),k=h(7);Y("Reading contract data\u2026","info",2500);let y;try{y=await Ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:k,userId:p})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let f=e.contactId||y.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}lh({tenantId:e.tenantId,contactId:f,template:i,oppId:b,staged:y,userId:p,defaultClosingDate:_,defaultEMDDueDate:k})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Um(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await Ps(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await Ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}sh({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await Zn(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Ns=()=>{let t=document.createElement("button");return t.id=Yn,t.type="button",t.style.cssText=`${M} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),dh(t)}),t},ch="ws-crm-contact-actions-bar",ph=async()=>{let t=Bs();if(!t){document.getElementById(Yn)?.remove();return}let e=null;try{e=await L(`#${ch}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Yn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Ns();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ge="ws-crm-prepare-contract-button-opp",qt=`${Ge}-wrap`,bh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,mh=/\/v2\/location\/([A-Za-z0-9]+)/,hh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xn=()=>{let t=window.location.pathname,e=t.match(bh);if(!e)return null;let o=t.match(mh);return o?{oppId:e[1],tenantId:o[1]}:null},uh=async()=>{for(let t of hh)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Wo=!1,Ut=null,Qn=null,jn=null,Kn,Vt=()=>{Ut?.disconnect(),Ut=null,Qn=null},vh=t=>{if(Ut&&Qn===t)return;Vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qn=t,Ut=new MutationObserver(()=>{let o=Xn();if(!o||o.oppId!==t){Vt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ge)?.remove(),document.getElementById(qt)?.remove(),Vt();return}document.getElementById(Ge)||zs()}),Ut.observe(e,{childList:!0,subtree:!0}))},_h=()=>{jn||(jn=new MutationObserver(()=>{Kn===void 0&&(Kn=window.setTimeout(()=>{Kn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ge);t&&!e&&!Wo&&zs()},300))}),jn.observe(document.body,{childList:!0,subtree:!0}))},zs=async()=>{if(!Wo){Wo=!0;try{let t=Xn();if(!t){document.getElementById(Ge)?.remove(),document.getElementById(qt)?.remove(),Vt();return}let e=document.getElementById(Ge);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(qt)?.remove(),Vt());return}e&&(e.remove(),document.getElementById(qt)?.remove());let o=await uh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Xn();if(!a||a.oppId!==t.oppId)return;let i=Ns();i.id=Ge,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=qt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),vh(t.oppId)}finally{Wo=!1}}},Gs=()=>{ih(),ph()};Bm();function te(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ue(t){return te(t)}var gh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",qe="ws-crm-compute-offer-button",oa="ws-crm-compute-offer-popover",Js="ws-crm-offer-modal",qs="ws-crm-contact-actions-bar",yh=[".central-panel","[class*='central-panel']"],Ie=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",ea=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},fh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Us=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${fh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Vs=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,ta=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(gh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},at=()=>{document.getElementById(oa)?.remove(),document.removeEventListener("mousedown",Xs,!0)};function Xs(t){let e=document.getElementById(oa),o=document.getElementById(qe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&at()}var Qs=(t,e)=>{at();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=oa;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Xs,!0),0)},Jo=(t,e)=>{Qs(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},xh=(t,e,o)=>{Qs(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{at(),o(a.property_record_id)}),r.appendChild(i)})})},Xo=()=>{document.getElementById(Js)?.remove(),document.removeEventListener("keydown",Zs,!0)};function Zs(t){t.key==="Escape"&&Xo()}var Ws=(t,e,o)=>{Xo(),at();let r=o,a=!1,i="",s=document.createElement("div");s.id=Js,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&Xo()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,m,h)=>{a||(a=!0,i="",p(),ta({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,m=!!b.has_comps;l.innerHTML="";let h=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"-"));let k=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");k.type="button",k.addEventListener("click",Xo),h.append(_,k),l.appendChild(h);let y=F("div","padding:14px 18px 18px;");l.appendChild(y);let f=F("select",Vs());(b.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(b.tier||b.property_condition)&&(N.selected=!0),f.appendChild(N)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let g=F("input",Vs());g.type="number",g.placeholder="uses the level",g.value=b.repair_override!=null?String(b.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let x=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");x.appendChild(F("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${Us(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,g.value.trim())),x.append(S),y.appendChild(x),b.low_confidence&&m&&y.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${b.comp_count??0} comps in window.`));let C=b.current_offer!=null;y.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${Ie(b.current_offer)}${b.current_offer_date?` \xB7 ${Us(b.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=F("div","");w.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(f);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(w,T),y.appendChild(E);let $=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),P=(z,N,R)=>{let fe=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${R?.strong?"font-weight:700;":""}`),xe=F("div","");xe.appendChild(F("div",`font-size:${R?.strong?"13":"12"}px;color:${n.bone};`,z)),R?.sub&&xe.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,R.sub));let ee=F("div",`font-size:${R?.strong?"15":"12"}px;color:${R?.color||n.bone};white-space:nowrap;`,N);fe.append(xe,ee),$.appendChild(fe)};if(m&&b.imv!=null){P("Investor Market Value (IMV)",Ie(b.imv)),b.arv!=null&&P("After Repair Value (ARV)",Ie(b.arv),{color:n.ash});let z=b.repair_adjustment??0,N=-z,R=b.repair_override?"Repair override":b.property_condition_label||"Repairs";z===0?P(`Repairs (${R})`,"Included",{color:n.ash,sub:`${Ie(b.repair_total)} in repairs included at IMV`}):P(`Repairs (${R})`,ea(N),{color:N<0?n.crimson:n.emerald,sub:`${Ie(b.repair_total)} total, ${Ie(b.baseline_repairs)} included at IMV`}),P("Min. Profit Target",ea(-(b.profit_target??0)),{color:n.ash}),P("Maximum Cash Offer (MAO)",Ie(b.mao),{strong:!0,color:n.blue}),P("Target Profit",ea(-(b.ico_delta??0)),{color:n.ash}),P("Initial Cash Offer (ICO)",Ie(b.ico),{strong:!0,color:n.blue})}else $.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));y.appendChild($);let q=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);q.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),y.appendChild(q)}p(),document.body.appendChild(s),document.addEventListener("keydown",Zs,!0)},js=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=qe,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){xh(o,s.properties,l=>{a(!0),ta({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?Ws(e,d.property_record_id,d):Jo(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Jo(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?Ws(e,s.property_record_id,s):Jo(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await ta({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Jo(o,"Request failed. Try again.")}finally{a(!1)}}}),o},wh=async()=>{for(let t of yh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Ks=async(t,e)=>{let o=e.querySelector(`#${qs}`);if(!o)try{o=await L(`#${qs}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Ys=()=>{let t=document.querySelectorAll(`#${qe}`);for(let e=1;e<t.length;e++)t[e].remove()},kh=async()=>{let t=B();if(!t||!t.locationId||t.source!=="url"){document.getElementById(qe)?.remove(),at();return}let e=t.locationId,o=document.getElementById(qe);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),at();let r="seller";try{r=je(await We(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(qe)?.remove();return}let a=await wh();if(!a){c.warn("[compute-offer] no central panel found");return}let i=B();if(!i||i.contactId!==t.contactId)return;let s=js(t.contactId,e);if(!await Ks(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}Ys(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(B()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(qe)){let d=js(t.contactId,e);Ks(d,a).then(()=>Ys())}});l.observe(a,{childList:!0})},Wt=null,el=()=>{let t=B()?.contactId??null;if(Wt&&Wt.id===t)return;let e=kh().finally(()=>{Wt?.promise===e&&(Wt=null)});Wt={id:t,promise:e}};var Jt="reos-theme-stylesheet",ia="reos-theme-fonts",Xt=!1,Eh=()=>{let t=document.getElementById(ia);t&&t.remove()},Th=`
/* ============================================
...
`,Sh=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],Ch=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},Ah=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),$h=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Qo=new WeakSet,tl=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Qo.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;let b=e.style.getPropertyValue("background-color");if(b==="rgb(18, 22, 29)"){Qo.add(e);return}if(e.closest(".hr-button")&&!(e.classList&&e.classList.contains("hr-button"))){b!=="transparent"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important")),Qo.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Qo.add(e)}catch{}})}catch{}},ra=new WeakSet,jt=()=>{document.querySelectorAll($h.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(ra.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],p=+s[3];if(!(l<230||d<230||p<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),ra.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),ra.add(r)}})})},ol=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},rl=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},nl=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Zo=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],p=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&p>=180&&l+d+p>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},al=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Kt=()=>{if(!Xt)for(let t of Sh){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=Ah.has(r)?Ch(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},nr="#1A1F28",Lh=26,Ih=31,Mh=40,il=new Set,sl=new Set,er=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!sl.has(a)&&a!=="<no class>"&&(sl.add(a),c.debug(`Hid empty "--" leaf: "${a}"`))})},Oh=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Dh=["trash","Trash","TRASH","delete","Delete","DELETE"],Hh=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Dh.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";Oh.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Ph=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Rh=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Ph.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},ll=new Set,dl=new WeakSet,Bh=()=>{document.body.querySelectorAll("*").forEach(e=>{if(dl.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),dl.add(e);let b=e.className?.toString()||"<no class>";!ll.has(b)&&b!=="<no class>"&&(ll.add(b),c.debug(`Remapped pure-white text -> bone: "${b}"`))})},cl=new Set,Fh=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,p=l.backgroundImage||"",b=!1;if(p!=="none"&&p.includes("gradient"))b=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let C=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(C&&parseFloat(C[1])<.6)return;let E=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(E){let w=parseInt(E[1],10),T=parseInt(E[2],10),$=parseInt(E[3],10);(w>=60||T>=60||$>=60)&&(w>230&&T>230&&$>230||(w>=80||T>=80||$>=80)&&(b=!0))}}if(!b)return;let h=(i.textContent||"").trim(),_=s,k=Array.from(i.querySelectorAll("*")).map(C=>(C.className?.toString()||"").toLowerCase()).join(" "),y=h.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),f=_.includes("bg-clip-text")||_.includes("text-transparent")||k.includes("bg-clip-text")||k.includes("text-transparent"),g=Array.from(i.querySelectorAll("*")).some(C=>{let E=window.getComputedStyle(C),w=E.getPropertyValue("-webkit-background-clip")||"",T=E.getPropertyValue("background-clip")||"";return w.includes("text")||T.includes("text")});if(y||f||g){let C=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],E=w=>{C.forEach(T=>w.style.removeProperty(T))};E(i),i.querySelectorAll("*").forEach(E);return}let x="#12161D";i.style.setProperty("color",x,"important"),i.querySelectorAll("*").forEach(C=>{let E=C.tagName.toLowerCase();E==="svg"||E==="path"||E==="circle"||E==="rect"||E==="polygon"||E==="polyline"||E==="line"||E==="g"?(C.style.setProperty("fill",x,"important"),C.style.setProperty("stroke",x,"important"),C.style.setProperty("color",x,"important")):(C.style.setProperty("color",x,"important"),C.style.setProperty("-webkit-text-fill-color",x,"important"))});let S=i.className?.toString()||"<no class>";!cl.has(S)&&S!=="<no class>"&&(cl.add(S),c.debug(`Darkened SVG icons on colored button: "${S}"`))})})},pl=new Set,Nh=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let p=d;if(p.closest("[id^='ws-crm-']"))return;let b=d.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let m=b.left<r.right&&b.right>r.left,h=b.top<r.bottom&&b.bottom>r.top;if(!(m&&h)||b.top+b.height/2<a)return;let k=b.width*b.height/(r.width*r.height);if(k>.55)return;let y=p,f=p.parentElement,g=0;for(;f&&f!==e&&g<3;){let S=f.getBoundingClientRect();if(S.width>0&&S.width<=30&&S.height<=30)y=f;else break;f=f.parentElement,g++}y.style.setProperty("transform","translateY(11px)","important");let x=(y.className?.toString()||"")+" "+y.tagName;pl.has(x)||(pl.add(x),c.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${k.toFixed(2)}): "${x}"`))})})},zh="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Gh=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",zh,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},bl=new Set,qh=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),p=parseInt(s[3],10);if(!(l>200&&d>200&&p>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let b=r.className?.toString()||"<no class>";!bl.has(b)&&b!=="<no class>"&&(bl.add(b),c.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${p})): "${b}"`))})})},ml=new Set,Uh=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!ml.has(l)&&l!=="<no class>"&&(ml.add(l),c.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},hl=new Set,Vh=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let f=s.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let f=s.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let p=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!p)return;let b=parseInt(p[1],10),m=parseInt(p[2],10),h=parseInt(p[3],10);if(!(b>200&&m>200&&h>200))return;let k=s.getBoundingClientRect();if(k.width<24||k.height<16||k.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let y=s.className?.toString()||"<no class>";!hl.has(y)&&y!=="<no class>"&&(hl.add(y),c.debug(`Coerced light bg (${k.width.toFixed(0)}x${k.height.toFixed(0)}, rgb(${b},${m},${h})): "${y}"`))})})},ul=new Set,Wh=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let x=o.getAttribute("style")||"";(x.includes("color")||x.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let x=0;x<4&&a;x++){let S=a.nextElementSibling;if(S&&(S.matches(t)||S.querySelector(t)!==null)){i=S;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),p=l.className?.toString()||"",b=p.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=p.includes("hl-form-item")||p.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(p.includes("hr-form-item-blank")||p.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=p.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=p.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=p.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!b&&!m&&!_&&!k&&!y&&!f&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",nr,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let g=o.className?.toString()||"<no class>";!ul.has(g)&&g!=="<no class>"&&(ul.add(g),c.debug(`Colored field label "${r.slice(0,30)}": "${g}"`))})},vl=new Set,jh=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(p=>{p.tagName==="svg"||p.tagName==="SVG"||p.tagName!=="IMG"&&(p.style.setProperty("font-size",`${l}px`,"important"),p.style.setProperty("line-height","1","important"),p.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!vl.has(d)&&d!=="<no class>"&&(vl.add(d),c.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},_l=new Set,Kh=new Set(["Enter Dashboard Name"]),Yh=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Kh.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",nr,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",nr,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!_l.has(i)&&i!=="<no class>"&&(_l.add(i),c.debug(`Forced input slate bg: "${i}"`))})},tr=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<Lh&&l<Ih&&d<Mh))return;let b=e.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;e.style.setProperty("background-color",nr,"important");let m=e.className?.toString()||"<no class>";!il.has(m)&&m!=="<no class>"&&(il.add(m),c.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},or=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let p=d,b=!1;if(e.forEach(_=>{p.includes(_)&&(p=p.split(_).join(t),b=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{p.includes(_)&&(p=p.split(_).join("transparent"),b=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(k=>{p.includes(k)&&(p=p.split(k).join("#EDEEF0"),b=!0)}),!!b)try{let _=btoa(p);i.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},rr=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Jh=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Yt=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=p=>{let b=r.querySelector(".ui-upload-icon svg");b&&(b.style.setProperty("color",p,"important"),b.style.setProperty("stroke",p,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",p,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},na=new WeakSet,Xh=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!na.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){na.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
        html, body {
          background-color: #FFFFFF !important;
          color: #101828 !important;
        }
        body { padding: 16px !important; }
      `,o.head.appendChild(r),e.style.background="#FFFFFF",e.style.borderRadius="6px",na.add(e)}catch{}})},gl=()=>{let t,o=()=>{Xt||t===void 0&&(t=window.setTimeout(()=>{t=void 0,rr(),Kt(),Yh(),tr(),er(),Wh(),Xh(),Vh(),Uh(),qh(),Gh(),Fh(),jh(),Nh(),Bh(),or(),Rh(),Hh(),Yt(),jt(),tl(),nl(),al(),Zo(),Jh(),Yt(),ol(),rl()},800))};rr(),Kt(),tr(),er(),or(),Yt(),jt(),tl(),nl(),al(),Zo(),ol(),rl(),window.setTimeout(()=>{rr(),Kt(),tr(),er(),or(),Yt(),jt(),Zo()},500),window.setTimeout(()=>{rr(),Kt(),tr(),er(),or(),Yt(),jt(),Zo()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{jt(),Kt()});let r=!1;new MutationObserver(()=>{r||(r=!0,requestAnimationFrame(()=>{r=!1,o()}))}).observe(document.body,{childList:!0,subtree:!0})},aa,Qh=()=>{let t=()=>{if(Xt)return;let o=document.getElementById(Jt);!o||!document.head||document.head.lastElementChild===o||document.head.appendChild(o)};new MutationObserver(o=>{let r=!1;for(let a of o){for(let i of Array.from(a.addedNodes)){if(!(i instanceof Element))continue;let s=i.tagName.toLowerCase();if(s==="style"||s==="link"){if(i.id===Jt||i.id===ia)continue;r=!0;break}}if(r)break}r&&aa===void 0&&(aa=window.setTimeout(()=>{aa=void 0,t()},150))}).observe(document.head,{childList:!0}),t()},sa=()=>{if(Xt=!1,Eh(),!document.getElementById(Jt)){let t=document.createElement("style");t.id=Jt,t.textContent=Th,document.head.appendChild(t),c.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?gl():window.addEventListener("DOMContentLoaded",gl)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,Qh())},yl=()=>{Xt=!0,document.getElementById(Jt)?.remove(),document.getElementById(ia)?.remove(),c.info("REInvest OS theme stylesheet unmounted (excluded location)")};var fl="ws-crm-customizer-version-badge",ar=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",ar,{once:!0});return}if(document.getElementById(fl))return;let t=document.createElement("div");t.id=fl,t.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,t.textContent=`Customizer v${to}`,t.title=`Built ${oo}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var I=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},xl=()=>{c.info(`Loaded v${to} (built ${oo})`),dr()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):(I("mountVersionBadge (initial)",ar),I("mountFavicon",za),I("mountThemeStylesheet",sa),I("mountHideLaunchpad",rn),I("mountHideNavItems",nn),I("mountRelabelNav",an),I("mountHideTopmenuTabs",ln),I("mountContractsSection",sn)),I("initPageRouter",pa),c.info("[main] registering onPageChange subscriber"),we(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),dr()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),I("unmountThemeStylesheet",yl);return}I("mountThemeStylesheet",sa),I("mountVersionBadge",ar),I("mountHideLaunchpad",rn),I("mountHideNavItems",nn),I("mountRelabelNav",an),I("mountHideTopmenuTabs",ln),I("mountContractsSection",sn),I("mountClaimReleaseToggle",$a),I("mountContactActionsBar",Fa),I("mountActiveFollowUpButton",ya),I("mountMtOfferMadeButton",Ua),I("mountNotInterestedButton",Va),I("mountScheduleWalkthroughButton",Wa),I("mountResendDealLinkButton",Ka),I("mountReducePriceButton",Ja),I("mountEditLandingPageButton",Xa),I("mountPublishButton",ei),I("mountContactMapLinks",ii),I("mountSendToClosingOfficeButton",fi),I("mountOppActionBar",Pi),I("mountClosingAgentPickerButton",Ts),I("mountPrepareContractButton",Gs),I("mountComputeOfferButton",el),I("mountManageTeam",$s),I("mountBuyBoxWidget",Ta),I("mountSupportNavItem",Ui),I("mountPhoneAssignmentsWidget",Xi),I("mountBulkPowerDialer",_s)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",xl):xl();})();
