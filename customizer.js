...
/* Disabled (unclickable, out-of-range) cells \u2014 cool-gray.
   v0.9.89: one shade darker than ash per Tim. Cool-gray
   #5A6470 sits between bone (clickable) and steel (invisible),
   giving a clear "this is unclickable" cue without dropping
   below readability. */
...
/* Combined excluded + disabled (other-month AND out-of-range)
   \u2014 same cool-gray, no further muting. */
