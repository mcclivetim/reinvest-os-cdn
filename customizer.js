...
html body .sidebar-option-button svg path[fill="none"],
html body button[class*="sidebar-option-button"] svg path[fill="none"] {
  fill: none !important;
}
...
html body .sidebar-option-button:hover svg path[fill="none"],
html body button[class*="sidebar-option-button"]:hover svg path[fill="none"] {
  fill: none !important;
}
...
html body .sidebar-option-button[class*="text-blue-600"]:not([class*="hover:text-blue-600"]) svg path[fill="none"],
html body button[class*="sidebar-option-button"][class*="text-blue-600"]:not([class*="hover:text-blue-600"]) svg path[fill="none"] {
  fill: none !important;
}
