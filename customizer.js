...
`,A=`
  ...
  flex-shrink: 0;
`;var br=/^[A-Za-z0-9]{15,30}$/,ee=o=>typeof o=="string"&&br.test(o),hr=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},pr=()=>{let o=window.WS_CRM_USER_ID;return ee(o)?o:null},mr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(ee(t))return t;return null},ur=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=hr(e);if(!t)return null;let r=t.uid;if(ee(r))return r;let n=t.claims;if(n&&ee(n.user_id))return n.user_id}catch{}return null},_r=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(ee(n))return n}catch{}}}catch{}return null},I=()=>pr()||mr()||ur()||_r()||null;var jt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",vr=`${jt}/active-follow-up-get`,yr=`${jt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",st={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},gr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},fr=async o=>{let e=await fetch(vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},wr=async(o,e)=>{let t=await fetch(yr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=st[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},qt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,W(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=gr();if(!(!r||r.contactId!==o)){W(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await wr(r,I()),a=n&&n.state&&n.state in st?n.state:"blue";W(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),W(e,"error"),setTimeout(()=>void Se(e,r),4e3)}}}),e},Se=async(o,e)=>{W(o,"loading");try{let t=await fr(e),r=t&&t.state&&t.state in st?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;W(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),W(o,"error")}},xr=[".central-panel","[class*='central-panel']"],at="ws-crm-contact-actions-bar",kr=async()=>{for(let o of xr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Er=async(o,e)=>{let t=e.querySelector(`#${at}`);if(!t)try{t=await C(`#${at}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Fe();!t||!t.locationId||t.oppId!==o||dn({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=A)},4e3)}})}),e},bn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hn=async()=>{for(let o of bn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Le=!1,ht=async()=>{if(!Le){Le=!0;try{await pn()}finally{Le=!1}}},pn=async()=>{let o=Fe();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await hn();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Fe();if(!n||n.oppId!==o.oppId)return;let a=cn(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),mn(o.oppId)},ne=null,bt=null,ae=()=>{ne?.disconnect(),ne=null,bt=null},mn=o=>{if(ne&&bt===o)return;ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(bt=o,ne=new MutationObserver(()=>{let t=Fe();if(!t||t.oppId!==o){ae();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae();return}document.getElementById(D)||ht()}),ne.observe(e,{childList:!0,subtree:!0}))},dt=null,ct,un=()=>{dt||(dt=new MutationObserver(()=>{ct===void 0&&(ct=window.setTimeout(()=>{ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!Le&&ht()},300))}),dt.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{un(),ht()};var _n="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",H="ws-crm-not-interested-button",vn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,yn=/\/v2\/location\/([A-Za-z0-9]+)/,De=()=>{let o=window.location.pathname,e=o.match(vn);if(!e)return null;let t=o.match(yn);return{oppId:e[1],locationId:t?t[1]:null}},gn=async o=>{let e=await fetch(_n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},fn=o=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=o,e.style.cssText=A,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=De();if(!t||!t.locationId||t.oppId!==o)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await gn({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},wn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xn=async()=>{for(let o of wn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Me=!1,_t=async()=>{if(!Me){Me=!0;try{await kn()}finally{Me=!1}}},kn=async()=>{let o=De();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await xn();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=De();if(!n||n.oppId!==o.oppId)return;let a=fn(o.oppId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),En(o.oppId)},se=null,ut=null,ie=()=>{se?.disconnect(),se=null,ut=null},En=o=>{if(se&&ut===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,se=new MutationObserver(()=>{let t=De();if(!t||t.oppId!==o){ie();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||_t()}),se.observe(e,{childList:!0,subtree:!0}))},pt=null,mt,Tn=()=>{pt||(pt=new MutationObserver(()=>{mt===void 0&&(mt=window.setTimeout(()=>{mt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Me&&_t()},300))}),pt.observe(document.body,{childList:!0,subtree:!0}))},uo=()=>{Tn(),_t()};var Sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",O="ws-crm-reduce-price-button",_o="ws-crm-reduce-price-modal",Cn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,In=/\/v2\/location\/([A-Za-z0-9]+)/,Pe=()=>{let o=window.location.pathname,e=o.match(Cn);if(!e)return null;let t=o.match(In);return{oppId:e[1],locationId:t?t[1]:null}},An=async o=>{let e=await fetch(Sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},He=()=>{document.getElementById(_o)?.remove()},Ln=o=>{He();let e=document.createElement("div");e.id=_o,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Pe();!r||!r.locationId||r.oppId!==o||Ln({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=A,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},Mn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Dn=async()=>{for(let o of Mn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,ft=async()=>{if(!Oe){Oe=!0;try{await Hn()}finally{Oe=!1}}},Hn=async()=>{let o=Pe();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),de());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Dn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Pe();if(!n||n.oppId!==o.oppId)return;let a=Fn(o.oppId,o.locationId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),On(o.oppId)},le=null,gt=null,de=()=>{le?.disconnect(),le=null,gt=null},On=o=>{if(le&&gt===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gt=o,le=new MutationObserver(()=>{let t=Pe();if(!t||t.oppId!==o){de();return}let r=L();if(r!==null&&r!=="Disposition"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}document.getElementById(O)||ft()}),le.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,Pn=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Oe&&ft()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{Pn(),ft()};var fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-closing-office-button",j="ws-crm-send-to-title-co-wrap",$e="ws-crm-stc-dropdown",Nn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bn=/\/v2\/location\/([A-Za-z0-9]+)/,Re=()=>{let o=window.location.pathname,e=o.match(Nn);if(!e)return null;let t=o.match(Bn);return{oppId:e[1],locationId:t?t[1]:null}},$n=5*60*1e3,wo=o=>`ws-crm-stc-cache:${o}`,Rn=o=>{try{let e=window.localStorage.getItem(wo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>$n||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},Gn=(o,e)=>{try{window.localStorage.setItem(wo(o),JSON.stringify(e))}catch{}},Un=async(o,e)=>{try{let t=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},zn=async(o,e,t)=>{let r=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},qn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},yo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Vn=(o,e)=>{if(e&&qn(e)){window.setTimeout(()=>yo(o),300);return}yo(o)},P=()=>{document.getElementById($e)?.remove()},Ne=(o,e,t)=>{P();let r=document.createElement("div");r.id=$e;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let a=o.length,s=o.filter(v=>v.filled).length,l=s===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,B(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let y=await Un(o,e);if(!y){n={status:"error",message:"Check failed \u2014 click to retry"},B(t,n);return}if(y.rate_limited){v=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},B(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){n={status:"error",message:y.error||"Check failed \u2014 click to retry"},B(t,n),b.warn("[stc] dry_run returned no checks:",y);return}let _=y.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button + caching`),Ge.add(o),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P(),be();return}let f=y.checks;if(n.checks&&n.checks.length===y.checks.length){let T=new Set;f=y.checks.map((k,M)=>n.checks[M]?.filled&&!k.filled?a.has(k.label)?k:(T.add(k.label),{...k,filled:!0}):k),a=T}else a=new Set;n={status:f.every(T=>T.filled)?"ready":"incomplete",checks:f,previouslySentAt:y.previously_sent_at??null},Gn(o,{checks:f,previously_sent_at:y.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),B(t,n),document.getElementById($e)&&Ne(f,y.previously_sent_at,t)},l=async()=>{let y=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},B(t,n),P();try{let _=await zn(o,e,y);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},B(t,n),_.checks&&Ne(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},B(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},B(t,n),_.checks&&Ne(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},B(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById($e)?P():n.checks&&Ne(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,v=0,g=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let y=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-h,E=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});y.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},jn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Kn=async()=>{for(let o of jn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ge=new Set,go=null,Yn=o=>{o&&o!==go&&(Ge.clear(),go=o)},Be=!1,Et=async()=>{if(Be){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Be=!0;try{await Xn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Be=!1}},Xn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=Re();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`),Yn(o.oppId),Ge.has(o.oppId)){b.debug(`[stc] mount:02-BAIL opp ${o.oppId} previously confirmed non-TC this session`),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P();return}let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=L();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(j)?.remove(),P(),be());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(j)?.remove(),P()),b.debug("[stc] mount:04 calling findMountTarget");let t=await Kn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=L();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Re();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=Wn(o.oppId,n.locationId),s=document.createElement("span");s.id=j,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Jn(o.oppId)},ce=null,kt=null,be=()=>{ce?.disconnect(),ce=null,kt=null},Jn=o=>{if(ce&&kt===o)return;be();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,ce=new MutationObserver(()=>{let t=Re();if(!t||t.oppId!==o){be();return}let r=L();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P(),be();return}document.getElementById(z)||Et()}),ce.observe(e,{childList:!0,subtree:!0}))},wt=null,xt,Zn=()=>{wt||(wt=new MutationObserver(()=>{xt===void 0&&(xt=window.setTimeout(()=>{xt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);if(o&&!e&&!Be){let t=Re();if(t&&Ge.has(t.oppId))return;Et()}},300))}),wt.observe(document.body,{childList:!0,subtree:!0}))},xo=()=>{Zn(),Et()};var Qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",To="ldtyB2UXKi9vOp8nLUH7",oa="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",So="ws-crm-closing-agent-picker-modal",ra=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,na=/\/v2\/location\/([A-Za-z0-9]+)/,me=()=>{let o=window.location.pathname,e=o.match(ra);if(!e)return null;let t=o.match(na);return{oppId:e[1],locationId:t?t[1]:null}},Mt=async o=>{let e=await fetch(Qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,contact_type:o.contactType??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ko=async o=>{let e=await fetch(ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},aa=async(o,e)=>{try{let t=await fetch(ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:To}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Mt({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[closing-agent] fetchCurrent failed:",t),null}},K=null,sa=60*60*1e3,Dt=o=>`ws-crm-to-cache:${o}`,Co=o=>{try{let e=window.localStorage.getItem(Dt(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>sa||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},Io=(o,e,t)=>{try{window.localStorage.setItem(Dt(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},ia=o=>{try{window.localStorage.removeItem(Dt(o))}catch{}},It="ws-crm-closing-agent-field-link",la=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${It}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Tt=!1,Ht=async o=>{if(Tt)return;let e=Ao();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[closing-agent] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==t){Tt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${t}`);let r=await Mt({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),At(n.id,n.name,o);let a=document.getElementById(N);if(a){q(a,{status:"linked",contactName:n.name});let s=me();s&&Io(s.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Tt=!1}}},da=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ao=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();da.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=t[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},At=(o,e,t)=>{let r=Ao();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${It}`).forEach(s=>s.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=o,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=It,l.href=`/v2/location/${t}/contacts/detail/${o}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${w.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},Ue=()=>{document.getElementById(So)?.remove()},ca=o=>{Ue();let e=document.createElement("div");e.id=So,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};q(t,r);let n=Co(o);return n&&(r={status:"linked",contactName:n.contactName},q(t,r),K={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let s=await aa(o,e);s?(r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},At(s.id,s.name,e)):n||(r={status:"empty"},q(t,r),K?.oppId===o&&(K=null),la(),ia(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ca({oppId:o,locationId:e,onPick:async s=>{r={status:"saving"},q(t,r);try{let l=[ko({tenantId:e,oppId:o,fieldId:To,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(ko({tenantId:e,oppId:o,fieldId:oa,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},Io(o,s.id,s.name),At(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},q(t,r)}}})}),t},ha=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],pa=async()=>{for(let o of ha)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Ve=async()=>{if(!he){he=!0;try{await ma()}finally{he=!1}}},ma=async()=>{let o=me();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),qe();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let d=L();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),qe());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=L();if(t!==null&&t!=="Transaction Coordination")return;let r=await pa();if(!r||!(Co(o.oppId)!==null||K!==null&&K.oppId===o.oppId)&&await U()!=="Transaction Coordination")return;let a=me();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=ba(o.oppId,a.locationId),l=document.createElement("span");l.id=`${N}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${o.oppId}`),ua(o.oppId),Ht(a.locationId)},pe=null,Lt=null,Ft=null,qe=()=>{pe?.disconnect(),pe=null,Lt=null,Ft=null},ua=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pe&&Lt===o&&Ft===e||(qe(),Lt=o,Ft=e,pe=new MutationObserver(()=>{let t=me();if(!t||t.oppId!==o||!t.locationId){qe();return}document.getElementById(N)||Ve(),Ht(t.locationId)}),pe.observe(e,{childList:!0,subtree:!0})))},St=null,Ct,_a=()=>{St||(St=new MutationObserver(()=>{Ct===void 0&&(Ct=window.setTimeout(()=>{Ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!he&&Ve()},300))}),St.observe(document.body,{childList:!0,subtree:!0}))},Eo,va=()=>{Eo===void 0&&(Eo=window.setInterval(()=>{let o=me();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(N)&&!he&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ve()),Ht(o.locationId)},2e3))},Lo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),_a(),va(),Ve()};var ya="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ot="ws-crm-prepare-contract-button",Fo="ws-crm-prepare-contract-menu",Mo="ws-crm-prepare-contract-modal",_e="https://services.leadconnectorhq.com",Z=null,ve=()=>{if(!Z)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:Z.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return Z.tokenId&&(o["token-id"]=Z.tokenId),o},Do=(o,e)=>{if(!o)return null;let t=e.toLowerCase();if(o instanceof Headers)return o.get(e)||o.get(t);if(Array.isArray(o)){for(let[n,a]of o)if(n.toLowerCase()===t)return a;return null}let r=o;for(let n of Object.keys(r))if(n.toLowerCase()===t)return r[n];return null},Ho=!1,ga=()=>{if(Ho)return;Ho=!0;let o=window.fetch;window.fetch=async function(...e){let t=typeof e[0]=="string"?e[0]:e[0]instanceof URL?e[0].toString():e[0].url,r=e[1]||{};if(t.includes("services.leadconnectorhq.com")){let n=r.headers;!n&&e[0]instanceof Request&&(n=e[0].headers);let a=Do(n,"authorization");if(a){let s=Do(n,"token-id")||void 0,l=Z?.authorization;Z={authorization:a,tokenId:s,capturedAt:Date.now()},l!==a&&b.debug(`[prepare-contract] captured fresh GHL auth (${a.slice(0,24)}\u2026)`)}if(window.__WS_CRM_LOG_GHL){let s={};n instanceof Headers?n.forEach((l,d)=>s[d]=l):Array.isArray(n)?n.forEach(([l,d])=>s[l]=d):n&&typeof n=="object"&&Object.assign(s,n),console.log("[ws-crm GHL fetch]",{url:t,method:r.method||"GET",headers:s})}}return o.apply(this,e)}},No=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},fa=o=>{let e=(o||"").trim();return/^\[?\s*PA\s*\]?\s*[-\s]/i.test(e)?"PA":/^\[?\s*AA\s*\]?\s*[-\s]/i.test(e)?"AA":"passthrough"},wa=async o=>{let e=`${_e}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(o)}&skip=0&limit=100`,t=await fetch(e,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Templates fetch returned ${t.status} ${t.statusText}`);let r=await t.json();return(r.templates||r.items||[]).map(a=>({id:(a._id??a.id)||"",name:a.name||"(unnamed template)",type:fa(a.name||"")})).filter(a=>!!a.id)},xa=async(o,e)=>{let t=await fetch(`${_e}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${_e}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ve()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},ka=async o=>{let e=await fetch(ya,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,template_id:o.templateId,template_type:o.templateType,opp_id:o.oppId,closing_date:o.closingDate,buyer_earnest_due_date:o.buyerEarnestDueDate,lender_source:o.lenderSource,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Ea=async(o,e)=>{let t=await fetch(`${_e}/proposals/templates/to-proposal/${o}/${e}?locale=en-US`,{method:"POST",headers:ve()});if(!t.ok)throw new Error(`to-proposal HTTP ${t.status} ${t.statusText}`);let r=await t.json(),n=r._id||r.id||r.proposal?._id||r.proposal?.id;if(!n)throw new Error("to-proposal returned no proposal id");return n},Ta=async(o,e)=>{let t=await fetch(`${_e}/proposals/document/${o}`,{method:"PUT",headers:{...ve(),"Content-Type":"application/json"},body:JSON.stringify({contactId:e})});if(!t.ok)throw new Error(`assign-contact HTTP ${t.status} ${t.statusText}`)},Sa=(o,e)=>{let t=`/v2/location/${o}/payments/proposals-estimates/edit/${e}`;window.location.href=t},Oo="ws-crm-prepare-contract-toast",ue=(o,e="info",t=4e3)=>{document.getElementById(Oo)?.remove();let r=document.createElement("div");r.id=Oo;let n=e==="error"?i.crimson:i.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=o,document.body.appendChild(r),window.setTimeout(()=>r.remove(),t)},Ca=({tenantId:o,contactId:e,template:t,mtOpps:r,userId:n})=>{document.getElementById(Mo)?.remove();let a=document.createElement("div");a.id=Mo,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        ...
        <input type="hidden" id="ws-pc-opp-id" value="${Po(r[0].id)}" />
      `;let y=r.map(_=>`<option value="${Po(_.id)}">${Q(_.propertyAddress||_.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${u.mono};
        font-size: 10px;
  ...
  `,a.appendChild(s),document.body.appendChild(a);let v=()=>a.remove();if(a.addEventListener("click",y=>{y.target===a&&v()}),s.querySelector("#ws-pc-cancel")?.addEventListener("click",v),p)return;let g=s.querySelector("#ws-pc-submit"),x=s.querySelector("#ws-pc-error");g?.addEventListener("click",async()=>{if(!g)return;let y=s.querySelector("#ws-pc-opp-id"),_=(s.querySelector("#ws-pc-closing-date")?.value??"").trim(),f=(s.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(s.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(y?.value||"").trim();if(!T){x&&(x.textContent="Pick a subject property.");return}if(!_){x&&(x.textContent="Closing Date is required.");return}x&&(x.textContent=""),g.disabled=!0,g.textContent="Preparing\u2026";try{await Bo({tenantId:o,contactId:e,template:t,oppId:T,closingDate:_,buyerEarnestDueDate:f,lenderSource:E,userId:n}),v()}catch(k){g.disabled=!1,g.textContent="Stage & Open Contract",x&&(x.textContent=k.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",k)}})},Bo=async({tenantId:o,contactId:e,template:t,oppId:r,closingDate:n,buyerEarnestDueDate:a,lenderSource:s,userId:l})=>{b.info(`[prepare-contract] starting flow for template "${t.name}" (${t.type})`);let d=await ka({tenantId:o,contactId:e,templateId:t.id,templateType:t.type,oppId:r,closingDate:n,buyerEarnestDueDate:a,lenderSource:s,userId:l});if(!d.ok)throw new Error(d.error||"Contract.Stage returned not ok");let c=await Ea(o,t.id);b.info(`[prepare-contract] proposal created: ${c}`),await Ta(c,e),b.info(`[prepare-contract] contact ${e} assigned to proposal ${c}`),Sa(o,c)},Ia=async o=>{let e=No();if(!e){ue("Could not resolve contact context.","error");return}document.getElementById(Fo)?.remove();let t=document.createElement("div");t.id=Fo,t.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,t.innerHTML=`
    ...
    `;let l=a.type==="PA"?i.emerald:a.type==="AA"?i.blue:i.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{t.remove(),document.removeEventListener("click",r,!0);let d=I();try{if(a.type==="AA"){let c;try{c=await xa(e.tenantId,e.contactId)}catch(h){ue(`Failed to load buyer's MT opps: ${h.message}`,"error");return}Ca({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:c,userId:d})}else{ue(`Preparing ${a.name}\u2026`,"info",2500);try{await Bo({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:d})}catch(c){ue(`Failed to prepare contract: ${c.message}`,"error",6e3),b.warn("[prepare-contract] flow failed:",c)}}}catch(c){b.warn("[prepare-contract] picker click handler failed:",c),ue(`Unexpected error: ${c.message}`,"error",6e3)}}),t.appendChild(s)}},Aa=()=>{let o=document.createElement("button");return o.id=Ot,o.type="button",o.style.cssText=`
    position: relative;
    background: ${i.slate};
    border: 1px solid ${i.steel};
    border-radius: ${w.sm};
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.borderColor=i.emerald}),o.addEventListener("mouseleave",()=>{o.style.borderColor=i.steel}),o.addEventListener("click",e=>{e.stopPropagation(),Ia(o)}),o},La="ws-crm-contact-actions-bar",Fa=async()=>{let o=No();if(!o){document.getElementById(Ot)?.remove();return}let e=null;try{e=await C(`#${La}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let t=document.getElementById(Ot);if(t){if(t.dataset.contactId===o.contactId)return;t.remove()}let r=Aa();r.dataset.contactId=o.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${o.contactId}`)},$o=()=>{ga(),Fa()};function Q(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Po(o){return Q(o)}var Je="reos-theme-stylesheet",rr="reos-theme-fonts",Ma=()=>{let o=document.getElementById(rr);o&&o.remove()},Da=`
/* ============================================
