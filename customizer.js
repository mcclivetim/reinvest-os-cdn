...
/* hr-tooltip / hr-popover-shared (collapsed-icon labels: "My Inbox",
   ...
   icon being hovered. No white/black flash.

   Treatment:
   - bg \u2192 obsidian so the tooltip stands out clearly against the
     panel/page (which are graphite). Reads as a deliberate tooltip
     rather than a fade.
   - color \u2192 bone, no border, slight radius, subtle shadow for lift.
   - transition \u2192 none (kills the Naive UI bg-interpolation that
     coerceLightBgsInUI was catching mid-animation; without this
     the tooltip flashed white\u2192dark\u2192white on every hover).
   - Arrow visible, same obsidian fill, no border. */
...
/* Popover arrow \u2014 solid obsidian triangle pointing at the icon, no
   border, no shadow. Naive UI uses an inner element (the colored
   fill) inside .hr-popover-arrow-wrapper; paint both to obsidian
   so the arrow doesn't show a graphite/steel rim. */
