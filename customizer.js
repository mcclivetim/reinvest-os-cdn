/* Wholesaling CRM Customizer v0.16.3 — built 2026-05-31T15:34:04.607Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Xe="[wholesaling-crm-customizer]",hn="__WS_CRM_DEBUG",pn=()=>!!window[hn],b={info(...t){console.log(Xe,...t)},warn(...t){console.warn(Xe,...t)},error(...t){console.error(Xe,...t)},debug(...t){pn()&&console.log(Xe,"[debug]",...t)}};var Fo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nt=/\/v2\/location\/([A-Za-z0-9]+)/,mn=t=>{let e=t.match(Fo);if(!e)return null;let o=t.match(Nt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},un=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(Fo);if(!n)continue;let s=r.match(Nt)||window.location.pathname.match(Nt);return{contactId:n[1],locationId:s?s[1]:null,source:"dom"}}return null},L=()=>{let t=mn(window.location.pathname);return t||un()};var Po=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Qe="",Rt=null,ve="other",Bt=new Set,Je=()=>{let t=L()?.contactId??null;if(!(!(window.location.pathname!==Qe)&&!(t!==Rt))){Qe=window.location.pathname,Rt=t,ve=Po(),b.debug("Page/context changed:",ve,Qe,"contact:",t);for(let r of Bt)try{r(ve)}catch(n){b.error("Subscriber threw:",n)}}},Oo=t=>(Bt.add(t),setTimeout(()=>t(ve),0),()=>{Bt.delete(t)}),Ho=()=>{ve=Po(),Qe=window.location.pathname,Rt=L()?.contactId??null,b.debug("Router init, current page:",ve);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Je()},history.replaceState=function(o,r,n){e(o,r,n),Je()},window.addEventListener("popstate",Je),setInterval(Je,1e3)};var Ze="0.16.3",et="2026-05-31T15:34:04.608Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((s,i)=>{let l=n.querySelector(t);if(l){s(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),s(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),s(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var a={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},f={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Gt={purple:"#8B5CF6",green:a.emerald,orange:a.amber,red:a.crimson},No=t=>{let e=t==="emerald"?a.emeraldGlow:t==="amber"?a.amberGlow:a.slate,o=t==="emerald"?a.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":a.steel,r=t==="emerald"?a.emerald:t==="amber"?a.amber:a.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var vn=/^[A-Za-z0-9]{15,30}$/,Ce=t=>typeof t=="string"&&vn.test(t),_n=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},yn=()=>{let t=window.WS_CRM_USER_ID;return Ce(t)?t:null},gn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ce(o))return o;return null},fn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);if(!o)return null;let r=o.uid;if(Ce(r))return r;let n=o.claims;if(n&&Ce(n.user_id))return n.user_id}catch{}return null},wn=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(Ce(n))return n}catch{}}}catch{}return null},A=()=>yn()||gn()||fn()||wn()||null;var zo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",xn=`${zo}/active-follow-up-get`,kn=`${zo}/active-follow-up-set`,ce="ws-crm-active-follow-up-button",qt={amber:{label:"Add to Active Follow Up",bg:a.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:a.amber,clickable:!0,dotColor:a.amber},blue:{label:"In Active Follow Up",bg:a.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:a.blue,clickable:!1,dotColor:a.blue},gray:{label:"Not in Follow Up",bg:a.slate,border:a.steel,color:a.coolGray,clickable:!1,dotColor:a.coolGray},loading:{label:"Active Follow Up\u2026",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.ash},error:{label:"Follow Up status unavailable",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.crimson}},En=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Tn=async t=>{let e=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Sn=async(t,e)=>{let o=await fetch(kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},be=(t,e)=>{let o=qt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},Ro=t=>{let e=document.createElement("button");return e.type="button",e.id=ce,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.background="transparent",e.style.color=a.emerald}),e.addEventListener("mouseleave",()=>{e.style.background=a.emerald,e.style.color=a.obsidian}),e.innerHTML=`
    <span style="display: inline-block; width: 8px; height: 8px; border-radius: 50%; background: ${a.obsidian}; flex-shrink: 0;"></span>
    <span>Manage Team</span>
  `,e.addEventListener("click",()=>{kt(t)}),wt(e),setTimeout(()=>wt(e),200),setTimeout(()=>wt(e),800),window.addEventListener("resize",()=>wt(e)),e},Ps=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],Os=async()=>{for(let t of Ps)try{let e=await I(t,{timeoutMs:1500});if(e)return e}catch{}return null},wo=!1,Hs=async()=>{if(!wo){wo=!0;try{let t=Ir();if(!t){document.getElementById(ge)?.remove();return}let e=document.getElementById(ge);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await Os();if(!o){let s=document.createElement("div");s.id=`${ge}-floater`,s.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let i=Tr(t.tenantId);i.dataset.tenantId=t.tenantId,s.appendChild(i),document.body.appendChild(s),b.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=Tr(t.tenantId);r.dataset.tenantId=t.tenantId;let n=document.createElement("span");n.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",n.appendChild(r),o.appendChild(n),b.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{wo=!1}}},Ar=()=>{if(!Ir()){document.getElementById(ge)?.remove(),document.getElementById(`${ge}-floater`)?.remove();return}Hs()};var Ns="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",To="ws-crm-prepare-contract-button",Lr="ws-crm-prepare-contract-menu",Z="ws-crm-prepare-contract-modal",Mr="ws-crm-modal-date-style",te="https://services.leadconnectorhq.com",Or=()=>{if(document.getElementById(Mr))return;let t=document.createElement("style");t.id=Mr,t.textContent=`
  ...
  `,document.head.appendChild(t)},So="__WS_CRM_CAPTURED_AUTH",Rs=50*60*1e3,Hr=()=>{try{let t=localStorage.getItem(So);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Rs?(localStorage.removeItem(So),null):e:null}catch{return null}},Bs=t=>{try{localStorage.setItem(So,JSON.stringify(t))}catch{}},oe=()=>{let t=Hr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},$r=!1,Gs=()=>{if($r)return;$r=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=Hr()?.authorization;Bs({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,v)=>m[v.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,v])=>m[p.toLowerCase()]=v);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,s=r.setRequestHeader,i=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),s.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),i.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Nr=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},zs=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Nr()},qs=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Rr="__WS_CRM_TEMPLATES_CACHE_V1",Us=24*60*60*1e3,Dr=t=>{try{let e=window.localStorage.getItem(Rr);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Us?null:o.templates}catch{return null}},Vs=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Rr,JSON.stringify(o))}catch{}},Ws=async t=>{let e=`${te}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:oe()})}catch(i){let l=Dr(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw i}if(!o.ok){let i=Dr(t);if(i)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items);let s=n.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:qs(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Vs(t,s),s},js=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let s=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},Ks=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Ys=async t=>{let e=await fetch(Ns,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Xs=async(t,e,o)=>{let r=`${te}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:oe()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let s=await n.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Js=async(t,e)=>{let o=await fetch(`${te}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},Qs=async t=>{let e=await fetch(`${te}/contacts/${t}`,{method:"GET",headers:oe()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Zs=async(t,e,o,r)=>{let n;try{n=await Js(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let s;try{s=await Qs(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,l={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${te}/proposals/document/${e}`,{method:"PUT",headers:{...oe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let v=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:v}}return{ok:!0}},ei=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Tt="__WS_CRM_PENDING_INSTRUCTIONS",ti=60*1e3,oi=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],ri=t=>{let e=(t||"").toLowerCase();for(let o of oi)if(e.includes(o.matches.toLowerCase()))return o;return null},ni=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Tt,JSON.stringify(r))}catch{}},ai=()=>{try{let t=localStorage.getItem(Tt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ti?(localStorage.removeItem(Tt),null):e}catch{return null}},si=()=>{try{localStorage.removeItem(Tt)}catch{}},ii=(t,e)=>{document.getElementById(Z)?.remove();let o=document.createElement("div");o.id=Z,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},li=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,di=()=>{let t=window.location.pathname.match(li);if(!t)return;let e=t[1],o=ai();o&&o.proposalId===e&&(si(),window.setTimeout(()=>{ii(o.title,o.bodyHtml)},600))},Fr="ws-crm-prepare-contract-toast",F=(t,e="info",o=4e3)=>{document.getElementById(Fr)?.remove();let r=document.createElement("div");r.id=Fr;let n=e==="error"?a.crimson:a.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Pr=(t,e)=>new Promise(o=>{document.getElementById(Z)?.remove();let r=document.createElement("div");r.id=Z,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,Y=`
    ...
    padding-right: 28px;
  `,Ke=D=>['<option value="">(unset)</option>'].concat(k.map(P=>`<option value="${Q(P)}"${P===D?" selected":""}>${B(P)}</option>`)).join("");_.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,g.appendChild(_),document.body.appendChild(g);let R=_.querySelector("#ws-pc-purchase-price"),le=_.querySelector("#ws-pc-emd"),re=_.querySelector("#ws-pc-cash-at-close"),de=!1;re?.addEventListener("input",()=>{de=!0});let fe=()=>{if(de)return;let D=Number(R?.value||0),P=Number(le?.value||0);re&&(re.value=String(Math.max(0,D-P)))};R?.addEventListener("input",fe),le?.addEventListener("input",fe);let Ye=()=>g.remove();g.addEventListener("click",D=>{D.target===g&&Ye()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Ye);let z=_.querySelector("#ws-pc-submit"),G=_.querySelector("#ws-pc-error");z?.addEventListener("click",async()=>{if(z){G&&(G.textContent=""),z.disabled=!0,z.textContent="Opening\u2026";try{let D=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),P=Number(R?.value||0),we=Number(le?.value||0),xe=Number(re?.value||0),ke=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ee=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Te=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ue=(_.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Se=(_.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),O={};if(D!==i&&(O.sellerName=D),P!==l&&(O.purchasePrice=P),we!==d&&(O.emd=we),xe!==c&&(O.cashAtClose=xe),ke!==h&&(O.daysToClose=ke),Ee!==m&&(O.inspectionDays=Ee),Te!==p&&(O.additionalTerms=Te),ue!==v&&(O.currentOccupancy=ue),Se!==w&&(O.occupancyAtClose=Se),Object.keys(O).length>0){b.info("[prepare-contract] PA modal submit with overrides:",O),z.textContent="Saving\u2026";let Pt=A(),Ot=await St({tenantId:t,contactId:e,template:o,userId:Pt,overrides:O});b.info("[prepare-contract] re-stage with overrides ok:",Ot),z.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let H=s?`${s} - Purchase Agreement`:void 0;await Ao(t,e,o,H)}catch(D){z.disabled=!1,z.textContent="Open Contract",G&&(G.textContent=D.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",D)}}})},bi=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:s,defaultClosingDate:i,defaultEMDDueDate:l})=>{document.getElementById(Z)?.remove(),Or();let d=n.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,w=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",g=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",_=i,y=l,E="",T=document.createElement("div");T.id=Z,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,T.appendChild(x),document.body.appendChild(T);let re=x.querySelector("#ws-pc-assignment-price"),de=x.querySelector("#ws-pc-assignment-fee"),fe=!1;de?.addEventListener("input",()=>{fe=!0});let Ye=()=>{if(fe)return;let P=Number(re?.value||0);de&&(de.value=String(Math.max(0,P-w)))};re?.addEventListener("input",Ye);let z=()=>T.remove();T.addEventListener("click",P=>{P.target===T&&z()}),x.querySelector("#ws-pc-cancel")?.addEventListener("click",z);let G=x.querySelector("#ws-pc-submit"),D=x.querySelector("#ws-pc-error");G?.addEventListener("click",async()=>{if(!G)return;D&&(D.textContent="");let P=(x.querySelector("#ws-pc-seller-name")?.value||"").trim(),we=Number(re?.value||0),xe=Number(x.querySelector("#ws-pc-buyer-emd")?.value||0),ke=Number(de?.value||0),Ee=(x.querySelector("#ws-pc-closing-office")?.value||"").trim(),Te=(x.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ue=(x.querySelector("#ws-pc-closing-date")?.value||"").trim(),Se=(x.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),O=(x.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ue){D&&(D.textContent="Closing Date is required.");return}G.disabled=!0,G.textContent="Opening\u2026";try{let H={};P!==h&&(H.sellerName=P),we!==m&&(H.assignmentPrice=we),xe!==p&&(H.buyerEMD=xe),ke!==v&&(H.assignmentFee=ke),Ee!==k&&(H.closingOffice=Ee),Te!==g&&(H.buyerCompanyName=Te);let Pt=ue!==_||Se!==y||O!==E,Ot=Object.keys(H).length>0||Pt,Ht=n;Ot?(b.info("[prepare-contract] AA modal submit, re-staging with overrides:",H),G.textContent="Saving\u2026",Ht=await St({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ue,buyerEarnestDueDate:Se,lenderSource:O,userId:s,overrides:Object.keys(H).length>0?H:void 0}),b.info("[prepare-contract] AA re-stage ok:",Ht),G.textContent="Opening\u2026"):b.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Do=Ht?.debug?.propertyAddress||c,bn=Do?`${Do} - Assignment Agreement`:void 0;await Ao(t,e,o,bn),z()}catch(H){G.disabled=!1,G.textContent="Open Contract",D&&(D.textContent=H.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",H)}})},St=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ys({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Ao=async(t,e,o,r)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await Xs(t,o.id,e);b.info(`[prepare-contract] proposal created: ${n}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let s=await Zs(t,n,e,r);s.ok?b.info(`[prepare-contract] contact attached to proposal ${n}`):(b.warn(`[prepare-contract] attach failed (status=${s.status??"n/a"}): ${s.body?.slice(0,300)??"no body"}`),F(`Proposal created but couldn't auto-attach contact (HTTP ${s.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",s.body));let i=ri(o.name);i&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),ni(n,i.title,i.bodyHtml)),ei(t,n)},hi=async t=>{let e=zs(t);if(!e){F("Could not resolve contact context.","error");return}document.getElementById(Lr)?.remove();let o=document.createElement("div");o.id=Lr,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Ws(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let l=s.type==="PA"?a.emerald:s.type==="AA"?a.blue:a.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=a.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=A();try{if(s.type==="AA"){let h;if(e.oppId)h=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${h} directly`);else{let _;try{_=await Ks(e.tenantId,e.contactId)}catch(y){F(`Failed to load buyer's MT opps: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",y);return}if(_.length===0){F("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(_.length===1)h=_[0].id,b.info(`[prepare-contract] auto-selected MT opp ${h} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${_.length} opps)`);let y=await Pr(_,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!y){b.info("[prepare-contract] MT opp picker cancelled");return}h=y,b.info(`[prepare-contract] picked MT opp ${h}`)}}let m=_=>{let y=_.getFullYear(),E=String(_.getMonth()+1).padStart(2,"0"),T=String(_.getDate()).padStart(2,"0");return`${y}-${E}-${T}`},p=_=>{let y=new Date;return y.setDate(y.getDate()+_),m(y)},v=p(45),w=p(7);F("Reading contract data\u2026","info",2500);let k;try{k=await St({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:h,closingDate:v,buyerEarnestDueDate:w,userId:c})}catch(_){F(`Failed to prepare contract: ${_.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",_);return}let g=e.contactId||k.contact_id||"";if(!g){F("Could not resolve buyer contact for this opp.","error",6e3);return}bi({tenantId:e.tenantId,contactId:g,template:s,oppId:h,staged:k,userId:c,defaultClosingDate:v,defaultEMDDueDate:w})}else if(s.type==="PA"){if(!e.contactId){F("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let h;try{h=await js(e.tenantId,e.contactId)}catch(v){F(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(h.length===0){F("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let v=await Pr(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}F("Reading contract data\u2026","info",2500);let p;try{p=await St({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,userId:c})}catch(v){F(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}ci({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:p})}else{if(!e.contactId){F("This template needs to be started from a contact page.","error",6e3);return}F(`Opening ${s.name}\u2026`,"info",2500);try{await Ao(e.tenantId,e.contactId,s)}catch(h){F(`Failed to open contract: ${h.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){b.warn("[prepare-contract] picker click handler failed:",h),F(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(i)}},Br=()=>{let t=document.createElement("button");return t.id=To,t.type="button",t.style.cssText=`${C} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${a.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=a.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=a.steel}),t.addEventListener("click",e=>{e.stopPropagation(),hi(t)}),t},pi="ws-crm-contact-actions-bar",mi=async()=>{let t=Nr();if(!t){document.getElementById(To)?.remove();return}let e=null;try{e=await I(`#${pi}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(To);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Br();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},me="ws-crm-prepare-contract-button-opp",ze=`${me}-wrap`,ui=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vi=/\/v2\/location\/([A-Za-z0-9]+)/,_i=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Co=()=>{let t=window.location.pathname,e=t.match(ui);if(!e)return null;let o=t.match(vi);return o?{oppId:e[1],tenantId:o[1]}:null},yi=async()=>{for(let t of _i)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Et=!1,qe=null,Io=null,ko=null,Eo,Ue=()=>{qe?.disconnect(),qe=null,Io=null},gi=t=>{if(qe&&Io===t)return;Ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Io=t,qe=new MutationObserver(()=>{let o=Co();if(!o||o.oppId!==t){Ue();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}document.getElementById(me)||Gr()}),qe.observe(e,{childList:!0,subtree:!0}))},fi=()=>{ko||(ko=new MutationObserver(()=>{Eo===void 0&&(Eo=window.setTimeout(()=>{Eo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(me);t&&!e&&!Et&&Gr()},300))}),ko.observe(document.body,{childList:!0,subtree:!0}))},Gr=async()=>{if(!Et){Et=!0;try{let t=Co();if(!t){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}let e=document.getElementById(me);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(ze)?.remove(),Ue());return}e&&(e.remove(),document.getElementById(ze)?.remove());let o=await yi();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Co();if(!n||n.oppId!==t.oppId)return;let s=Br();s.id=me,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=ze,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),gi(t.oppId)}finally{Et=!1}}},zr=()=>{di(),mi()};Gs();function B(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(t){return B(t)}var $t="reos-theme-stylesheet",sn="reos-theme-fonts",wi=()=>{let t=document.getElementById(sn);t&&t.remove()},xi=`
/* ============================================
