/* Wholesaling CRM Customizer v0.14.20 — built 2026-05-30T13:38:38.021Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ce="[wholesaling-crm-customizer]",Lr="__WS_CRM_DEBUG",Mr=()=>!!window[Lr],b={info(...t){console.log(Ce,...t)},warn(...t){console.warn(Ce,...t)},error(...t){console.error(Ce,...t)},debug(...t){Mr()&&console.log(Ce,"[debug]",...t)}};var io=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ct=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=t=>{let e=t.match(io);if(!e)return null;let o=t.match(ct);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Fr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(io);if(!n)continue;let i=r.match(ct)||window.location.pathname.match(ct);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},S=()=>{let t=Dr(window.location.pathname);return t||Fr()};var lo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ie="",bt=null,oe="other",ht=new Set,Ae=()=>{let t=S()?.contactId??null;if(!(!(window.location.pathname!==Ie)&&!(t!==bt))){Ie=window.location.pathname,bt=t,oe=lo(),b.debug("Page/context changed:",oe,Ie,"contact:",t);for(let r of ht)try{r(oe)}catch(n){b.error("Subscriber threw:",n)}}},co=t=>(ht.add(t),setTimeout(()=>t(oe),0),()=>{ht.delete(t)}),bo=()=>{oe=lo(),Ie=window.location.pathname,bt=S()?.contactId??null,b.debug("Router init, current page:",oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Ae()},history.replaceState=function(o,r,n){e(o,r,n),Ae()},window.addEventListener("popstate",Ae),setInterval(Ae,1e3)};var Le="0.14.20",Me="2026-05-30T13:38:38.022Z";var C=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,a)=>{let l=n.querySelector(t);if(l){i(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),i(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),i(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),a(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},pt={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},ho=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var $r=/^[A-Za-z0-9]{15,30}$/,ie=t=>typeof t=="string"&&$r.test(t),Pr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Or=()=>{let t=window.WS_CRM_USER_ID;return ie(t)?t:null},Hr=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ie(o))return o;return null},Nr=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Pr(e);if(!o)return null;let r=o.uid;if(ie(r))return r;let n=o.claims;if(n&&ie(n.user_id))return n.user_id}catch{}return null},Br=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ie(n))return n}catch{}}}catch{}return null},A=()=>Or()||Hr()||Nr()||Br()||null;var _o="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Rr=`${_o}/active-follow-up-get`,Gr=`${_o}/active-follow-up-set`,J="ws-crm-active-follow-up-button",ut={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},zr=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},qr=async t=>{let e=await fetch(Rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ur=async(t,e)=>{let o=await fetch(Gr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Z=(t,e)=>{let o=ut[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},po=t=>{let e=document.createElement("button");return e.type="button",e.id=J,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=He();!o||!o.locationId||o.oppId!==t||Dn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},$n=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pn=async()=>{for(let t of $n)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,wt=async()=>{if(!Oe){Oe=!0;try{await On()}finally{Oe=!1}}},On=async()=>{let t=He();if(!t||!t.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),he();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),he());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let o=await Pn();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await j();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=He();if(!n||n.oppId!==t.oppId)return;let i=Fn(t.oppId),a=document.createElement("span");a.id=`${O}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Hn(t.oppId)},be=null,ft=null,he=()=>{be?.disconnect(),be=null,ft=null},Hn=t=>{if(be&&ft===t)return;he();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ft=t,be=new MutationObserver(()=>{let o=He();if(!o||o.oppId!==t){he();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),he();return}document.getElementById(O)||wt()}),be.observe(e,{childList:!0,subtree:!0}))},yt=null,gt,Nn=()=>{yt||(yt=new MutationObserver(()=>{gt===void 0&&(gt=window.setTimeout(()=>{gt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);t&&!e&&!Oe&&wt()},300))}),yt.observe(document.body,{childList:!0,subtree:!0}))},Oo=()=>{Nn(),wt()};var Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",H="ws-crm-not-interested-button",Rn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gn=/\/v2\/location\/([A-Za-z0-9]+)/,Be=()=>{let t=window.location.pathname,e=t.match(Rn);if(!e)return null;let o=t.match(Gn);return{oppId:e[1],locationId:o?o[1]:null}},zn=async t=>{let e=await fetch(Bn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},qn=t=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Be();if(!o||!o.locationId||o.oppId!==t)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await zn({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Un=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vn=async()=>{for(let t of Un)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ne=!1,Tt=async()=>{if(!Ne){Ne=!0;try{await Wn()}finally{Ne=!1}}},Wn=async()=>{let t=Be();if(!t||!t.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),me());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let o=await Vn();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await j();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Be();if(!n||n.oppId!==t.oppId)return;let i=qn(t.oppId),a=document.createElement("span");a.id=`${H}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),jn(t.oppId)},pe=null,Et=null,me=()=>{pe?.disconnect(),pe=null,Et=null},jn=t=>{if(pe&&Et===t)return;me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Et=t,pe=new MutationObserver(()=>{let o=Be();if(!o||o.oppId!==t){me();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}document.getElementById(H)||Tt()}),pe.observe(e,{childList:!0,subtree:!0}))},xt=null,kt,Kn=()=>{xt||(xt=new MutationObserver(()=>{kt===void 0&&(kt=window.setTimeout(()=>{kt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);t&&!e&&!Ne&&Tt()},300))}),xt.observe(document.body,{childList:!0,subtree:!0}))},Ho=()=>{Kn(),Tt()};var Yn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",N="ws-crm-reduce-price-button",No="ws-crm-reduce-price-modal",Xn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jn=/\/v2\/location\/([A-Za-z0-9]+)/,ze=()=>{let t=window.location.pathname,e=t.match(Xn);if(!e)return null;let o=t.match(Jn);return{oppId:e[1],locationId:o?o[1]:null}},Zn=async t=>{let e=await fetch(Yn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Re=()=>{document.getElementById(No)?.remove()},Qn=t=>{Re();let e=document.createElement("div");e.id=No,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),a=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Re()}),i?.addEventListener("click",()=>{Re()}),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Reducing\u2026",a.style.opacity="0.7",i&&(i.disabled=!0);try{await Zn({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:A()}),Re(),t.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",a.disabled=!1,a.textContent="Reduce Price",a.style.opacity="1",i&&(i.disabled=!1)}})},ea=(t,e)=>{let o=document.createElement("button");return o.id=N,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=ze();!r||!r.locationId||r.oppId!==t||Qn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,i&&(i.style.background=s.emerald,i.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=L,i&&(i.style.background=s.amber,i.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},ta=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],oa=async()=>{for(let t of ta)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ge=!1,It=async()=>{if(!Ge){Ge=!0;try{await ra()}finally{Ge=!1}}},ra=async()=>{let t=ze();if(!t||!t.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let o=await oa();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await j();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=ze();if(!n||n.oppId!==t.oppId)return;let i=ea(t.oppId,t.locationId),a=document.createElement("span");a.id=`${N}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),na(t.oppId)},ue=null,At=null,_e=()=>{ue?.disconnect(),ue=null,At=null},na=t=>{if(ue&&At===t)return;_e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(At=t,ue=new MutationObserver(()=>{let o=ze();if(!o||o.oppId!==t){_e();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e();return}document.getElementById(N)||It()}),ue.observe(e,{childList:!0,subtree:!0}))},St=null,Ct,aa=()=>{St||(St=new MutationObserver(()=>{Ct===void 0&&(Ct=window.setTimeout(()=>{Ct=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);t&&!e&&!Ge&&It()},300))}),St.observe(document.body,{childList:!0,subtree:!0}))},Bo=()=>{aa(),It()};var zo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",K="ws-crm-send-to-closing-office-button",Q="ws-crm-send-to-title-co-wrap",Ve="ws-crm-stc-dropdown",sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ia=/\/v2\/location\/([A-Za-z0-9]+)/,We=()=>{let t=window.location.pathname,e=t.match(sa);if(!e)return null;let o=t.match(ia);return{oppId:e[1],locationId:o?o[1]:null}},la=5*60*1e3,qo=t=>`ws-crm-stc-cache:${t}`,da=t=>{try{let e=window.localStorage.getItem(qo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>la||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},ca=(t,e)=>{try{window.localStorage.setItem(qo(t),JSON.stringify(e))}catch{}},ba=async(t,e)=>{try{let o=await fetch(zo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},ha=async(t,e,o)=>{let r=await fetch(zo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},pa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},Ro=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ma=(t,e)=>{if(e&&pa(e)){window.setTimeout(()=>Ro(t),300);return}Ro(t)},B=()=>{document.getElementById(Ve)?.remove()},qe=(t,e,o)=>{B();let r=document.createElement("div");r.id=Ve;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),fa(t.oppId)},ve=null,Dt=null,ye=()=>{ve?.disconnect(),ve=null,Dt=null},fa=t=>{if(ve&&Dt===t)return;ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dt=t,ve=new MutationObserver(()=>{let o=We();if(!o||o.oppId!==t){ye();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(K)?.remove(),document.getElementById(Q)?.remove(),B(),ye();return}document.getElementById(K)||Ft()}),ve.observe(e,{childList:!0,subtree:!0}))},Lt=null,Mt,wa=()=>{Lt||(Lt=new MutationObserver(()=>{Mt===void 0&&(Mt=window.setTimeout(()=>{Mt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(K);if(t&&!e&&!Ue){let o=We();if(o&&je.has(o.oppId))return;Ft()}},300))}),Lt.observe(document.body,{childList:!0,subtree:!0}))},Uo=()=>{wa(),Ft()};var xa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",jo="ldtyB2UXKi9vOp8nLUH7",Ta="WVD2gb9swLsgcdBEtDVq",R="ws-crm-closing-agent-picker-button",Ko="ws-crm-closing-agent-picker-modal",Sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ca=/\/v2\/location\/([A-Za-z0-9]+)/,we=()=>{let t=window.location.pathname,e=t.match(Sa);if(!e)return null;let o=t.match(Ca);return{oppId:e[1],locationId:o?o[1]:null}},Gt=async t=>{let e=await fetch(xa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Vo=async t=>{let e=await fetch(ka,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Aa=async(t,e)=>{try{let o=await fetch(Ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:jo}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await Gt({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let a=i.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},ee=null,Ia=60*60*1e3,zt=t=>`ws-crm-to-cache:${t}`,Yo=t=>{try{let e=window.localStorage.getItem(zt(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ia||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Xo=(t,e,o)=>{try{window.localStorage.setItem(zt(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},La=t=>{try{window.localStorage.removeItem(zt(t))}catch{}},Ht="ws-crm-closing-agent-field-link",Ma=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ht}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},$t=!1,qt=async t=>{if($t)return;let e=Jo();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){$t=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Gt({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Nt(n.id,n.name,t);let i=document.getElementById(R);if(i){Y(i,{status:"linked",contactName:n.name});let a=we();a&&Xo(a.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{$t=!1}}},Da=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Jo=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();Da.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=o[0].parentElement,l=0;for(;a&&l<8;){let d=a.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;a=a.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Nt=(t,e,o)=>{let r=Jo();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${Ht}`).forEach(a=>a.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Ht,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Ke=()=>{document.getElementById(Ko)?.remove()},Fa=t=>{Ke();let e=document.createElement("div");e.id=Ko,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ke()}),i?.addEventListener("click",Ke);let a,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
      ...
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${Ye(m.name)}</div>
          <div style="color: ${s.ash}; font-size: 11px; margin-top: 2px;">
            ${Ye(m.email||"(no email)")} \xB7 ${Ye(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Ye(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{Ke(),t.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${s.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;a!==void 0&&clearTimeout(a),a=window.setTimeout(()=>{d(c)},250)})},Ye=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Y=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",i=s.amber,a=s.bone,l="transparent",d=s.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",i=s.coolGray,a=s.ash,c="wait";break;case"empty":n="Link Closing Agent",i=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,a=s.emeraldBright;break;case"saving":n="Linking\u2026",i=s.coolGray,a=s.ash,c="wait";break}o&&(o.textContent=n),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=a,t.style.cursor=c},$a=(t,e)=>{let o=document.createElement("button");o.id=R,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Y(o,r);let n=Yo(t);return n&&(r={status:"linked",contactName:n.contactName},Y(o,r),ee={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await Aa(t,e);a?(r={status:"linked",contactName:a.name},Y(o,r),ee={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},Nt(a.id,a.name,e)):n||(r={status:"empty"},Y(o,r),ee?.oppId===t&&(ee=null),Ma(),La(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Fa({oppId:t,locationId:e,onPick:async a=>{r={status:"saving"},Y(o,r);try{let l=[Vo({tenantId:e,oppId:t,fieldId:jo,value:a.id})];a.companyName&&a.companyName.trim()&&l.push(Vo({tenantId:e,oppId:t,fieldId:Ta,value:a.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},Y(o,r),ee={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},Xo(t,a.id,a.name),Nt(a.id,a.name,e),b.info(`Closing Agent linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},Y(o,r)}}})}),o},Pa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Oa=async()=>{for(let t of Pa)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ge=!1,Je=async()=>{if(!ge){ge=!0;try{await Ha()}finally{ge=!1}}},Ha=async()=>{let t=we();if(!t||!t.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Xe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Xe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await Oa();if(!r||!(Yo(t.oppId)!==null||ee!==null&&ee.oppId===t.oppId)&&await j()!=="Transaction Coordination")return;let i=we();if(!i||i.oppId!==t.oppId||!i.locationId)return;let a=$a(t.oppId,i.locationId),l=document.createElement("span");l.id=`${R}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(a),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Na(t.oppId),qt(i.locationId)},fe=null,Bt=null,Rt=null,Xe=()=>{fe?.disconnect(),fe=null,Bt=null,Rt=null},Na=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(fe&&Bt===t&&Rt===e||(Xe(),Bt=t,Rt=e,fe=new MutationObserver(()=>{let o=we();if(!o||o.oppId!==t||!o.locationId){Xe();return}document.getElementById(R)||Je(),qt(o.locationId)}),fe.observe(e,{childList:!0,subtree:!0})))},Pt=null,Ot,Ba=()=>{Pt||(Pt=new MutationObserver(()=>{Ot===void 0&&(Ot=window.setTimeout(()=>{Ot=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);t&&!e&&!ge&&Je()},300))}),Pt.observe(document.body,{childList:!0,subtree:!0}))},Wo,Ra=()=>{Wo===void 0&&(Wo=window.setInterval(()=>{let t=we();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(R)&&!ge&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Je()),qt(t.locationId)},2e3))},Zo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Ba(),Ra(),Je()};var Ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ut="ws-crm-prepare-contract-button",Qo="ws-crm-prepare-contract-menu",se="ws-crm-prepare-contract-modal",Ze="https://services.leadconnectorhq.com",Vt="__WS_CRM_CAPTURED_AUTH",za=50*60*1e3,rr=()=>{try{let t=localStorage.getItem(Vt);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>za?(localStorage.removeItem(Vt),null):e:null}catch{return null}},qa=t=>{try{localStorage.setItem(Vt,JSON.stringify(t))}catch{}},Qe=()=>{let t=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o};var Ua=/\.(leadconnectorhq|gohighlevel|highlevel)\.com/i,er=(t,e)=>Ua.test(t)?e&&e.toUpperCase()!=="GET"?!0:/\/(proposals|recipients?|document|estimate|sign)/i.test(t):!1,nr=150,tr=!1,Va=()=>{if(tr)return;tr=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null},t.__WS_CRM_PROPOSAL_CALLS=t.__WS_CRM_PROPOSAL_CALLS||[];let e=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS;for(c.push(d);c.length>nr;)c.shift();return d};t.__WS_CRM_DUMP_PROPOSAL_CALLS=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS||[],h=d?c.filter(m=>m.url.includes(d)):c;return console.log(`[ws-crm-customizer] ${h.length} proposal calls captured${d?` (filter="${d}")`:""}`),h.forEach((m,p)=>{console.log(`
#${p+1} [${m.source}] ${m.method} ${m.url}`),console.log("  reqBody:",m.reqBody),console.log(`  \u2192 ${m.status??"?"}:`,m.resBody)}),h};let o=(d,c,h)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:d,headers:c,source:h};let m=c.authorization||c.Authorization;if(!m){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${h} no-auth]`,{url:d.split("?")[0],headerKeys:Object.keys(c)});return}h==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let p=c["token-id"]||c["Token-Id"]||void 0,u=rr()?.authorization;qa({authorization:m,tokenId:p,capturedAt:Date.now()}),u!==m&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${h}] captured GHL auth from ${d.split("?")[0]} (${m.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...d){let c=typeof d[0]=="string"?d[0]:d[0]instanceof URL?d[0].toString():d[0].url,h=d[1]||{};if(c&&c.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let u=h.headers;!u&&d[0]instanceof Request&&(u=d[0].headers);let y={};if(u instanceof Headers)u.forEach((w,g)=>y[g.toLowerCase()]=w);else if(Array.isArray(u))u.forEach(([w,g])=>y[w.toLowerCase()]=g);else if(u&&typeof u=="object")for(let w of Object.keys(u))y[w.toLowerCase()]=u[w];o(c,y,"fetch")}let m=d[0]instanceof Request?d[0]:null,p=(h.method||m?.method||"GET").toUpperCase();if(c&&er(c,p)){let u=m,y=p,w=null;try{if(h.body!=null)w=typeof h.body=="string"?h.body:h.body instanceof URLSearchParams?h.body.toString():(()=>{try{return JSON.stringify(h.body)}catch{return"(non-serializable body)"}})();else if(u)try{w=await u.clone().text()}catch{}}catch{w=null}let g=e({ts:Date.now(),source:"fetch",method:y,url:c,reqBody:w});return r.apply(this,d).then(async _=>{try{g.status=_.status,g.resBody=await _.clone().text()}catch{}return _})}return r.apply(this,d)};let n=XMLHttpRequest.prototype,i=n.open,a=n.setRequestHeader,l=n.send;n.open=function(d,c,...h){return this.__wsCrmUrl=c,this.__wsCrmMethod=(d||"GET").toUpperCase(),this.__wsCrmHeaders={},i.call(this,d,c,...h)},n.setRequestHeader=function(d,c){return this.__wsCrmHeaders&&typeof d=="string"&&(this.__wsCrmHeaders[d.toLowerCase()]=c),a.call(this,d,c)},n.send=function(d){let c=this.__wsCrmUrl,h=this.__wsCrmMethod,m=this.__wsCrmHeaders;if(c&&c.includes("services.leadconnectorhq.com")&&m&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),c&&h&&er(c,h)){let p=null;try{d==null?p=null:typeof d=="string"?p=d:d instanceof URLSearchParams?p=d.toString():p="(non-string body)"}catch{p=null}let u=e({ts:Date.now(),source:"xhr",method:h||"GET",url:c,reqBody:p}),y=this;this.addEventListener("loadend",()=>{try{if(u.status=y.status,y.responseType===""||y.responseType==="text")u.resBody=y.responseText;else try{u.resBody=JSON.stringify(y.response)}catch{u.resBody=`(responseType=${y.responseType})`}}catch{}})}return l.call(this,d)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ar=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Wa=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ja=async t=>{let e=`${Ze}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:Qe()});if(!o.ok){let i="";try{i=await o.text()}catch{}let a=i?` \u2014 ${i.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${a}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Wa(i.name||i.title||"")})).filter(i=>!!i.id)},Ka=async(t,e)=>{let o=await fetch(`${Ze}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Qe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${Ze}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Qe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Ya=async t=>{let e=await fetch(Ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Xa=async(t,e,o)=>{let r=`${Ze}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:Qe()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let i=await n.json(),a=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!a)throw new Error("to-proposal returned no proposal id");return a},Ja=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},or="ws-crm-prepare-contract-toast",X=(t,e="info",o=4e3)=>{document.getElementById(or)?.remove();let r=document.createElement("div");r.id=or;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,$=`
    ...
    padding-right: 28px;
  `,te=P=>['<option value="">(unset)</option>'].concat(w.map(V=>`<option value="${ae(V)}"${V===P?" selected":""}>${G(V)}</option>`)).join("");_.innerHTML=`
    <div style="
      font-family: ${v.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${k}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ae(a)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${k}">
      ...
      <div style="${k}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ae(h)}" placeholder="e.g. 30" style="${E}" />
      </div>
      <div style="${k}">
        <div style="${f}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${ae(m)}" placeholder="e.g. 10" style="${E}" />
      </div>
      <div style="${k}">
        <div style="${f}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${$}">${te(u)}</select>
      </div>
      <div style="${k}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${$}">${te(y)}</select>
      </div>
  ...
  `,g.appendChild(_),document.body.appendChild(g);let lt=_.querySelector("#ws-pc-purchase-price"),dt=_.querySelector("#ws-pc-emd"),Te=_.querySelector("#ws-pc-cash-at-close"),Jt=!1;Te?.addEventListener("input",()=>{Jt=!0});let Zt=()=>{if(Jt)return;let P=Number(lt?.value||0),V=Number(dt?.value||0);Te&&(Te.value=String(Math.max(0,P-V)))};lt?.addEventListener("input",Zt),dt?.addEventListener("input",Zt);let Qt=()=>g.remove();g.addEventListener("click",P=>{P.target===g&&Qt()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Qt);let U=_.querySelector("#ws-pc-submit"),Se=_.querySelector("#ws-pc-error");U?.addEventListener("click",async()=>{if(U){Se&&(Se.textContent=""),U.disabled=!0,U.textContent="Opening\u2026";try{let P=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),V=Number(lt?.value||0),eo=Number(dt?.value||0),to=Number(Te?.value||0),oo=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),ro=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),no=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ao=(_.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),so=(_.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),F={};if(P!==a&&(F.sellerName=P),V!==l&&(F.purchasePrice=V),eo!==d&&(F.emd=eo),to!==c&&(F.cashAtClose=to),oo!==h&&(F.daysToClose=oo),ro!==m&&(F.inspectionDays=ro),no!==p&&(F.additionalTerms=no),ao!==u&&(F.currentOccupancy=ao),so!==y&&(F.occupancyAtClose=so),Object.keys(F).length>0){b.info("[prepare-contract] PA modal submit with overrides:",F),U.textContent="Saving\u2026";let Ar=A(),Ir=await Wt({tenantId:t,contactId:e,template:o,userId:Ar,overrides:F});b.info("[prepare-contract] re-stage with overrides ok:",Ir),U.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");await jt(t,e,o)}catch(P){U.disabled=!1,U.textContent="Open Contract",Se&&(Se.textContent=P.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",P)}}})},Qa=({tenantId:t,contactId:e,template:o,mtOpps:r,userId:n})=>{document.getElementById(se)?.remove();let i=document.createElement("div");i.id=se,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=g=>g.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        ...
        <input type="hidden" id="ws-pc-opp-id" value="${ae(r[0].id)}" />
      `;let g=r.map(_=>`<option value="${ae(_.id)}">${G(_.propertyAddress||_.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${v.mono};
        font-size: 10px;
  ...
  `,o.innerHTML=`
    ...
    `,o.appendChild(a);let l=document.createElement("button");l.type="button",l.style.cssText=`
      ...
      padding: 8px 14px;
      cursor: pointer;
    `,l.textContent="\u{1F50D} View captured proposal calls",l.addEventListener("mouseenter",()=>{l.style.background=s.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",d=>{d.stopPropagation(),d.preventDefault(),o.remove(),document.removeEventListener("click",r,!0),ts()}),o.appendChild(l)};o.innerHTML="";for(let a of n){let l=document.createElement("button");l.type="button",l.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
    ...
    `;let d=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;l.innerHTML=`
      ...
      </div>`,l.addEventListener("mouseenter",()=>{l.style.background=s.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",async c=>{c.stopPropagation(),c.preventDefault(),b.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let h=A();try{if(a.type==="AA"){let m;try{m=await Ka(e.tenantId,e.contactId)}catch(p){X(`Failed to load buyer's MT opps: ${p.message}`,"error");return}Qa({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:m,userId:h})}else if(a.type==="PA"){X("Reading contract data\u2026","info",2500);let m;try{m=await Wt({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:h})}catch(p){X(`Failed to prepare contract: ${p.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",p);return}Za({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:m})}else{X(`Opening ${a.name}\u2026`,"info",2500);try{await jt(e.tenantId,e.contactId,a)}catch(m){X(`Failed to open contract: ${m.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){b.warn("[prepare-contract] picker click handler failed:",m),X(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(l)}i()},ts=async()=>{document.getElementById(se)?.remove();let t=window,e=t.__WS_CRM_PROPOSAL_CALLS||[],o=e.length===0?"(no proposal calls captured yet \u2014 try navigating to a proposal editor and adding a recipient manually, then re-open this viewer)":e.map((a,l)=>{let d=a.url.includes("?")?a.url.split("?")[1]:"",c=a.url.split("?")[0];return[`\u2500\u2500 #${l+1} ${a.method} ${c}`,d?`   query: ${d}`:"",`   req body: ${a.reqBody||"(empty)"}`,`   \u2192 ${a.status??"?"}: ${a.resBody||"(empty)"}`].filter(Boolean).join(`
`)}).join(`

`),r=document.createElement("div");r.id=se,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),es(t)}),t},rs="ws-crm-contact-actions-bar",ns=async()=>{let t=ar();if(!t){document.getElementById(Ut)?.remove();return}let e=null;try{e=await C(`#${rs}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Ut);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=os();r.dataset.contactId=t.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},sr=()=>{ns()};Va();function G(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ae(t){return G(t)}var at="reos-theme-stylesheet",Er="reos-theme-fonts",as=()=>{let t=document.getElementById(Er);t&&t.remove()},ss=`
/* ============================================
