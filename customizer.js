/* Wholesaling CRM Customizer v0.36.3 — built 2026-06-13T19:55:40.830Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Ms="__WS_CRM_DEBUG",Os=()=>!!window[Ms],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Os()&&console.log(qt,"[debug]",...t)}};var Ds=/\/v2\/location\/([A-Za-z0-9]+)/,Hs=new Set(["8ntUQzMflUkR0YvrRgVk"]),Re=()=>{let t=window.location.pathname.match(Ds);return t?t[1]:null},tr=()=>{let t=Re();return t!==null&&Hs.has(t)};var Kn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,or=/\/v2\/location\/([A-Za-z0-9]+)/,Ps=t=>{let e=t.match(Kn);if(!e)return null;let o=t.match(or);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Bs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Kn);if(!a)continue;let i=r.match(or)||window.location.pathname.match(or);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Ps(window.location.pathname);return t||Bs()};var Yn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",rr=null,Fe="other",nr=new Set,Ut=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==rr))){Vt=window.location.pathname,rr=t,Fe=Yn(),c.debug("Page/context changed:",Fe,Vt,"contact:",t);for(let r of nr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(nr.add(t),setTimeout(()=>t(Fe),0),()=>{nr.delete(t)}),Jn=()=>{Fe=Yn(),Vt=window.location.pathname,rr=P()?.contactId??null,c.debug("Router init, current page:",Fe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.3",Kt="2026-06-13T19:55:40.831Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ar={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Xn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Rs=/^[A-Za-z0-9]{15,30}$/,nt=t=>typeof t=="string"&&Rs.test(t),Qn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Fs=()=>{let t=window.WS_CRM_USER_ID;return nt(t)?t:null},Ns=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(nt(o))return o;return null},zs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Qn(e);if(!o)return null;let r=o.uid;if(nt(r))return r;let a=o.claims;if(a&&nt(a.user_id))return a.user_id}catch{}return null},Gs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(nt(a))return a}catch{}}}catch{}return null},O=()=>Fs()||Ns()||zs()||Gs()||null,qs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Qn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:qs()?.type==="agency"};var oa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Us=`${oa}/active-follow-up-get`,Vs=`${oa}/active-follow-up-set`,Ce="ws-crm-active-follow-up-button",sr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ws=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},js=async t=>{let e=await fetch(Us,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ks=async(t,e)=>{let o=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Ae=(t,e)=>{let o=sr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Zn=t=>{let e=document.createElement("button");return e.type="button",e.id=Ce,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,Ae(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ws();if(!(!r||r.contactId!==t)){Ae(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Ks(r,O()),i=a&&a.state&&a.state in sr?a.state:"blue";Ae(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Ae(e,"error"),setTimeout(()=>void Jt(e,r),4e3)}}}),e},Jt=async(t,e)=>{Ae(t,"loading");try{let o=await js(e),r=o&&o.state&&o.state in sr?o.state:"gray",a=document.getElementById(Ce);if(!a||a.dataset.contactId!==e.contactId)return;Ae(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Ae(t,"error")}},Ys=[".central-panel","[class*='central-panel']"],ir="ws-crm-contact-actions-bar",Js=async()=>{for(let t of Ys)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Xs=async(t,e)=>{let o=e.querySelector(`#${ir}`);if(!o)try{o=await L(`#${ir}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{wl(t,e,()=>hr(t,e))}),o},hr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([il(t,e),dr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}yl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},yl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=lo();!o||!o.locationId||o.oppId!==t||fd(o.oppId,o.locationId)}),e},xd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],kd=async()=>{for(let t of xd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,Ar=async()=>{if(!so){so=!0;try{await Ed()}finally{so=!1}}},Ed=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await kd();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=wd(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    ...
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Td(t.oppId)},ut=null,Cr=null,vt=()=>{ut?.disconnect(),ut=null,Cr=null},Td=t=>{if(ut&&Cr===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Cr=t,ut=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){vt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}document.getElementById(re)||Ar()}),ut.observe(e,{childList:!0,subtree:!0}))},Tr=null,Sr,Sd=()=>{Tr||(Tr=new MutationObserver(()=>{Sr===void 0&&(Sr=window.setTimeout(()=>{Sr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!so&&Ar()},300))}),Tr.observe(document.body,{childList:!0,subtree:!0}))},La=()=>{Sd(),Ar()};var Cd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ve="ws-crm-resend-deal-link-wrap",Ad=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Id=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(Ad);if(!e)return null;let o=t.match(Id);return{oppId:e[1],locationId:o?o[1]:null}},Ld=async t=>{let e=await fetch(Cd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},$d=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),$a=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Mr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${$a(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Md(t,e)),t.appendChild(o)},Md=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Od(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Mr(t,e)),o.appendChild(s),t.appendChild(o)},Od=async(t,e,o,r)=>{let a=po();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Ld({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${$a(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${$d(s)}</span>`}window.setTimeout(()=>Mr(t,e),3500)}},Dd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Hd=async()=>{for(let t of Dd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Or=async()=>{if(!co){co=!0;try{await Pd()}finally{co=!1}}},Pd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(Ve)?.remove(),yt();return}let e=document.getElementById(Ve);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),yt());return}e&&e.remove();let o=await Hd();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ve,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Mr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Bd(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Bd=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){yt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ve)?.remove(),yt();return}document.getElementById(Ve)||Or()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Rd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ve)&&!co&&Or()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},Ma=()=>{Rd(),Or()};var Fd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",se="ws-crm-reduce-price-button",Oa="ws-crm-reduce-price-modal",Nd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zd=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(Nd);if(!e)return null;let o=t.match(zd);return{oppId:e[1],locationId:o?o[1]:null}},Gd=async t=>{let e=await fetch(Fd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},bo=()=>{document.getElementById(Oa)?.remove()},qd=t=>{bo();let e=document.createElement("div");e.id=Oa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){xe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(cp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(ke(),xe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",xe("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",xe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(ke(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},wp=(t,e)=>{ke();let o=document.createElement("div");o.id=hi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(ke(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=$,o.textContent=t,o},xp=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},kp=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===vi){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>_p(t)),o.appendChild(r),o}if(e===vn){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>fp(t,r)),o.appendChild(r),o}if(e===_i){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void gi(t)),o.appendChild(r),o}return null},Ep=(t,e)=>{let o=[];if(e===vn&&(o=[{label:"Re-order Lockbox",onClick:()=>void gi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=bi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=xp();return a.addEventListener("click",i=>{i.stopPropagation(),wp(o,a)}),r.appendChild(a),r},Tp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Sp=async()=>{for(let t of Tp)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ao=()=>{document.getElementById(bn)?.remove(),document.getElementById(bi)?.remove(),ke()},Lo=!1,_n=async()=>{if(!Lo){Lo=!0;try{let t=yi();if(!t){Ao();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ao();return}let o=vp(),r=document.getElementById(bn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=kp(t,o);if(!a){Ao();return}let i=await Sp();if(!i)return;Ao();let s=U(i),l=document.createElement("span");l.id=bn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ep(t,o);d&&s.appendChild(d),Cp(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},It=null,mn=null,dn,pi=()=>{It?.disconnect(),It=null,mn=null},Cp=t=>{if(It&&mn===t)return;pi();let e=document.querySelector(ui);e&&(mn=t,It=new MutationObserver(()=>{let o=yi();if(!o||o.oppId!==t){pi();return}dn===void 0&&(dn=window.setTimeout(()=>{dn=void 0,_n()},250))}),It.observe(e,{childList:!0,subtree:!0}))},cn=null,pn,Ap=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&_n()},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},fi=()=>{Ap(),_n()};var wi="ws-support-modal",xi="ws-support-toast",Ip="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",ki="ws-support-submitter-name",Ei="ws-support-submitter-email",Ti="ws-support-submitter-role",Lp=["Bug","Feature Request","Question","Billing","Onboarding Help"],Me=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),$p=(t,e="success",o)=>{let r=document.getElementById(xi);r&&r.remove();let a=document.createElement("div");a.id=xi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&$o()}),i?.addEventListener("click",$o);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await Sn({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};Ee(o,r);let a=Oi(t);return a&&(r={status:"linked",contactName:a.contactName},Ee(o,r),Oe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await zp(t,e);s?(r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},kn(s.id,s.name,e)):a||(r={status:"empty"},Ee(o,r),Oe?.oppId===t&&(Oe=null),Up(),qp(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Wp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ee(o,r);try{let l=[Ii({tenantId:e,oppId:t,fieldKey:$i,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ii({tenantId:e,oppId:t,fieldKey:Rp,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Di(t,s.id,s.name),kn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ee(o,r)}}})}),o},Kp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Yp=async()=>{for(let t of Kp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lt=!1,Do=async()=>{if(!Lt){Lt=!0;try{await Jp()}finally{Lt=!1}}},Jp=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Yp();if(!r||!(Oi(t.oppId)!==null||Oe!==null&&Oe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Mt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=jp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Xp(t.oppId),An(i.locationId)},$t=null,En=null,Tn=null,Oo=()=>{$t?.disconnect(),$t=null,En=null,Tn=null},Xp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($t&&En===t&&Tn===e||(Oo(),En=t,Tn=e,$t=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t||!o.locationId){Oo();return}document.getElementById(ce)||Do(),An(o.locationId)}),$t.observe(e,{childList:!0,subtree:!0})))},fn=null,wn,Qp=()=>{fn||(fn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lt&&Do()},300))}),fn.observe(document.body,{childList:!0,subtree:!0}))},Li,Zp=()=>{Li===void 0&&(Li=window.setInterval(()=>{let t=Mt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!Lt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Do()),An(t.locationId)},2e3))},Pi=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Qp(),Zp(),Do()};var eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Se="ws-crm-manage-team-cta",Bi="ws-crm-manage-team-modal",tb=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ri={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},ob={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Fi=()=>{let t=window.location.pathname.match(tb);return t?{tenantId:t[1]}:null},Po=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Te=t=>ne(t),In="ws-crm-manage-team-toast",Mn=(t,e="info",o=4e3)=>{document.getElementById(In)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=In,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(In)===a&&a.remove()},o)},Ln=()=>{document.getElementById(Bi)?.remove()},rb=(t,e)=>{let o=ob[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
  ...
  `+t.map(r=>nb(r,e)).join(""),Bo=async t=>{Ln();let e=document.createElement("div");e.id=Bi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ln);let r;try{r=await Po({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Ho(e),setTimeout(()=>Ho(e),200),setTimeout(()=>Ho(e),800),window.addEventListener("resize",()=>Ho(e)),e},$n=!1,_b=()=>{if(!$n){$n=!0;try{let t=Fi();if(!t){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}let e=document.getElementById(Se);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Se}-floater`)?.remove();let o=document.createElement("div");o.id=`${Se}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=vb(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{$n=!1}}},Ni=()=>{if(!Fi()){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}_b()};var yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Hn="ws-crm-prepare-contract-button",zi="ws-crm-prepare-contract-menu",me="ws-crm-prepare-contract-modal",Gi="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Ki=()=>{if(document.getElementById(Gi))return;let t=document.createElement("style");t.id=Gi,t.textContent=`
  ...
  `,C.appendChild(E),document.body.appendChild(C);let G=E.querySelector("#ws-pc-assignment-price"),N=E.querySelector("#ws-pc-assignment-fee"),ue=!1;N?.addEventListener("input",()=>{ue=!0});let Pe=()=>{if(ue)return;let J=Number(G?.value||0);N&&(N.value=String(Math.max(0,J-x)))};G?.addEventListener("input",Pe);let oe=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&oe()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",oe);let te=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");te?.addEventListener("click",async()=>{if(!te)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),Qe=Number(G?.value||0),Ze=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),et=Number(N?.value||0),tt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),ot=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Be=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),rt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Be){V&&(V.textContent="Closing Date is required.");return}te.disabled=!0,te.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),Qe!==m&&(Q.assignmentPrice=Qe),Ze!==h&&(Q.buyerEMD=Ze),et!==_&&(Q.assignmentFee=et),tt!==k&&(Q.closingOffice=tt),ot!==f&&(Q.buyerCompanyName=ot);let Qo=Be!==y||rt!==w||X!==S,Zo=Object.keys(Q).length>0||Qo,er=a;Zo?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),te.textContent="Saving\u2026",er=await No({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Be,buyerEarnestDueDate:rt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",er),te.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let jn=er?.debug?.propertyAddress||p,$s=jn?`${jn} - Assignment Agreement`:void 0;await Fn(t,e,o,$s),oe()}catch(Q){te.disabled=!1,te.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},No=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ib({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Fn=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Lb(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Ob(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Bb(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Rb(a,s.title,s.bodyHtml)),Db(t,a)},Wb=async t=>{let e=xb(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(zi)?.remove();let o=document.createElement("div");o.id=zi,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
