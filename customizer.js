/* Wholesaling CRM Customizer v0.6.2 — built 2026-05-16T19:46:27.105Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var $="[wholesaling-crm-customizer]",Te="__WS_CRM_DEBUG",Ce=()=>!!window[Te],d={info(...o){console.log($,...o)},warn(...o){console.warn($,...o)},error(...o){console.error($,...o)},debug(...o){Ce()&&console.log($,"[debug]",...o)}};var Z=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},D="",T="other",U=new Set,F=()=>{if(window.location.pathname!==D){D=window.location.pathname,T=Z(),d.debug("Page changed:",T,D);for(let o of U)try{o(T)}catch(t){d.error("Subscriber threw:",t)}}},K=o=>(U.add(o),setTimeout(()=>o(T),0),()=>{U.delete(o)}),J=()=>{T=Z(),D=window.location.pathname,d.debug("Router init, current page:",T);let o=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(e,r,a){o(e,r,a),F()},history.replaceState=function(e,r,a){t(e,r,a),F()},window.addEventListener("popstate",F),setInterval(F,1e3)};var R="0.6.2",H="2026-05-16T19:46:27.106Z";var Ie=/\/contacts\/detail\/([A-Za-z0-9]+)/,Me=/\/v2\/location\/([A-Za-z0-9]+)/,k=()=>{let o=window.location.pathname,t=o.match(Ie);if(!t)return null;let e=o.match(Me);return{contactId:t[1],locationId:e?e[1]:null}};var C=(o,t={})=>{let{timeoutMs:e=8e3,pollMs:r=100,root:a=document}=t;return new Promise((n,i)=>{let s=a.querySelector(o);if(s){n(s);return}let c,p,f=()=>{u&&u.disconnect(),c!==void 0&&window.clearTimeout(c),p!==void 0&&window.clearInterval(p)},u=new MutationObserver(()=>{let b=a.querySelector(o);b&&(f(),n(b))});u.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let b=a.querySelector(o);b&&(f(),n(b))},r),c=window.setTimeout(()=>{f(),d.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${e}ms: ${o}`))},e)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},g={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},W={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},X=o=>{let t=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,e=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,B=`
  ...
  flex-shrink: 0;
`;var I="ws-crm-claim-release-pill",ee=o=>{let t=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ae=({contactId:o,mode:t})=>{let e=document.createElement("button");e.id=I,e.type="button",e.dataset.contactId=o,e.dataset.mode=t;let r=t==="claim"?"emerald":"amber",a=t==="claim"?l.emerald:l.amber;return e.style.cssText=X(r),e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{d.info(`Claim/Release pill clicked for contact ${o}: ${t}`);let n=e.lastElementChild,i=n?.textContent??"";n&&(n.textContent="Working\u2026"),e.style.opacity="0.7",e.disabled=!0,setTimeout(()=>{n&&(n.textContent=i),e.style.opacity="1",e.disabled=!1},700)}),e},$e=async(o,t=1e4)=>{let e=Date.now();for(;Date.now()-e<t;){let r=ee(o);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Q=(o,t)=>{let e=Ae({contactId:t,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(e),o.appendChild(r)},Fe=async()=>{let o=k();if(!o){document.getElementById(I)?.remove();return}let t=document.getElementById(I);if(!(t&&t.dataset.contactId===o.contactId)){t&&t.remove();try{let e=await C("#record-details-lhs",{timeoutMs:1e4}),r=await $e(e),a=k();if(!a||a.contactId!==o.contactId)return;if(!r){d.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Q(r,o.contactId),d.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(k()?.contactId===o.contactId)){n?.disconnect();return}if(document.getElementById(I))return;let s=ee(e);s&&(Q(s,o.contactId),d.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(e,{childList:!0,subtree:!0})}catch(e){d.warn("Could not mount Claim/Release pill:",e)}}},te=()=>{Fe()};var De="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Re=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let r of e)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let i=JSON.parse(n),s=i.id??i._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}catch{}}}catch{}return null},He=async({contactId:o,locationId:t,status:e,userId:r,deadReason:a})=>{let n={call_status:e,triggered_by_user_id:r??""};a&&(n.dead_reason=a);let s=await fetch(De,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:t},customData:n}),credentials:"omit"});if(!s.ok)throw new Error(`Webhook returned ${s.status} ${s.statusText}`)},O="ws-crm-contact-actions-bar",Pe="ws-crm-call-status-dropdown",oe="ws-crm-offer-made-modal",Be=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Oe=[".central-panel","[class*='central-panel']"],Ne=async()=>{for(let o of Oe)try{let t=await C(o,{timeoutMs:3e3});if(t)return t}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ge=o=>{let t=document.createElement("div");t.id=Pe,t.style.cssText="position: relative; flex-shrink: 0;";let e=document.createElement("button");e.type="button",e.style.cssText=B,e.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,Be.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=l.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{d.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${o}`);let i=e.firstElementChild,s=e.children[1],c=e.children[2];i&&(i.style.background=W[a.color]),s&&(s.textContent=a.label),r.style.display="none";let f=k()?.locationId,u=Re();if(!f){d.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),s&&(s.textContent=`${a.label} (no tenant!)`),s&&(s.style.color=l.amber);return}if(a.color==="green"&&!u){d.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),s&&(s.textContent=`${a.label} (no user!)`),s&&(s.style.color=l.amber);return}let b=c?.textContent??"\u25BE",_=async x=>{c&&(c.textContent="\u2026"),e.style.opacity="0.75";try{await He({contactId:o,locationId:f,status:a.label,userId:u,deadReason:x}),c&&(c.textContent="\u2713"),setTimeout(()=>{c&&(c.textContent=b),e.style.opacity="1"},900)}catch(y){d.warn("Call Status webhook failed:",y),c&&(c.textContent="\u2717"),s&&(s.style.color=l.amber),e.style.opacity="1",setTimeout(()=>{c&&(c.textContent=b),s&&(s.style.color=l.bone)},1800)}};if(a.value==="dead-deal"){let x=s?.textContent??"";qe(y=>{_(y)},()=>{s&&(s.textContent=x)});return}await _()}),r.appendChild(n)}),e.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{t.contains(a.target)||(r.style.display="none")}),t.appendChild(e),t.appendChild(r),t},ze=o=>{document.getElementById(oe)?.remove();let t=document.createElement("div");t.id=oe,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(e),document.body.appendChild(t);let n=()=>t.remove();t.addEventListener("click",i=>{i.target===t&&n()}),e.querySelector("#ws-offer-cancel")?.addEventListener("click",n),e.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let i=(e.querySelector("#ws-offer-amount")?.value??"").trim(),s=e.querySelector("#ws-offer-expires")?.value??"";if(!i||Number(i)<=0){d.warn("Offer Made submit blocked \u2014 invalid amount");return}d.info(`Offer Made recorded for contact ${o}: $${i}, expires ${s}`),n()}),setTimeout(()=>{e.querySelector("#ws-offer-amount")?.focus()},0)},re="ws-crm-dead-deal-modal",qe=(o,t)=>{document.getElementById(re)?.remove();let e=document.createElement("div");e.id=re,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(r),document.body.appendChild(e);let a=()=>e.remove(),n=()=>{a(),t()};e.addEventListener("click",s=>{s.target===e&&n()}),r.querySelector("#ws-dead-cancel")?.addEventListener("click",n);let i=()=>{let s=r.querySelector("#ws-dead-reason"),c=r.querySelector("#ws-dead-error"),p=(s?.value??"").trim();if(!p){c&&(c.textContent="Please enter a reason."),s?.focus();return}if(p.length<4){c&&(c.textContent="Please enter at least a few words."),s?.focus();return}a(),o(p)};r.querySelector("#ws-dead-submit")?.addEventListener("click",i),r.querySelector("#ws-dead-reason")?.addEventListener("keydown",s=>{s.key==="Enter"&&(s.metaKey||s.ctrlKey)&&(s.preventDefault(),i()),s.key==="Escape"&&n()}),setTimeout(()=>{r.querySelector("#ws-dead-reason")?.focus()},0)},ae=o=>{let t=document.createElement("div");t.id=O,t.dataset.contactId=o,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    flex-shrink: 0;
  `,t.appendChild(Ge(o));let e=document.createElement("button");return e.type="button",e.style.cssText=P,e.textContent="Offer Made",e.addEventListener("click",()=>ze(o)),t.appendChild(e),t},Ue=async()=>{let o=k();if(!o){document.getElementById(O)?.remove();return}let t=document.getElementById(O);if(t&&t.dataset.contactId===o.contactId)return;t&&t.remove();let e=await Ne();if(!e){d.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=k();if(!r||r.contactId!==o.contactId)return;let a=ae(o.contactId);a.dataset.mountTarget=e.className||"central-panel",e.insertBefore(a,e.firstChild),d.debug(`Mounted contact actions bar for ${o.contactId}`);let n=null;n=new MutationObserver(()=>{let i=document.getElementById(O);if(!(k()?.contactId===o.contactId)){n?.disconnect();return}if(!i){let c=ae(o.contactId);c.dataset.mountTarget=a.dataset.mountTarget??"",e.insertBefore(c,e.firstChild),d.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),n.observe(e,{childList:!0})},ne=()=>{Ue()};var ie="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",We=1.25,N=64,Ve=()=>new Promise(o=>{let t=new Image;t.crossOrigin="anonymous",t.onload=()=>{try{let e=document.createElement("canvas");e.width=N,e.height=N;let r=e.getContext("2d");if(!r){o(null);return}let a=N*We,n=(N-a)/2;r.imageSmoothingEnabled=!0,r.imageSmoothingQuality="high",r.drawImage(t,n,n,a,a);let i=e.toDataURL("image/png");o(i)}catch(e){d.debug("Favicon zoom render failed:",e),o(null)}},t.onerror=()=>o(null),t.src=ie}),V=null,se=!1,je=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),A="data-ws-crm-favicon",j=o=>o.hasAttribute(A),le=o=>{if(o.tagName!=="LINK")return!1;let t=(o.getAttribute("rel")??"").toLowerCase();return je.has(t)},M=()=>{let o=V??ie;document.head.querySelectorAll("link[rel]").forEach(a=>{le(a)&&!j(a)&&a.remove()});let e=document.head.querySelector(`link[${A}="1"]`);e?e.href!==o&&(e.href=o):(e=document.createElement("link"),e.setAttribute(A,"1"),e.rel="icon",e.type="image/png",e.href=o,document.head.appendChild(e),d.debug(`Favicon installed (${V?"zoomed":"original"})`));let r=document.head.querySelector(`link[${A}="apple"]`);r?r.href!==o&&(r.href=o):(r=document.createElement("link"),r.setAttribute(A,"apple"),r.rel="apple-touch-icon",r.href=o,document.head.appendChild(r))},ce=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,se||(se=!0,Ve().then(r=>{r&&(V=r,M())})),document.head)M();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),M())},50)}new MutationObserver(r=>{let a=!1;for(let n of r)n.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&le(i)&&!j(i)&&(a=!0)}),n.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&j(i)&&(a=!0)});a&&M()}).observe(document.head,{childList:!0,subtree:!1});let t=0,e=window.setInterval(()=>{t+=1,M(),t>=5&&window.clearInterval(e)},1e3)};var de="reos-theme-stylesheet",pe="reos-theme-fonts",Ye=()=>{if(document.getElementById(pe))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com",document.head.appendChild(o);let t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.gstatic.com",t.crossOrigin="anonymous",document.head.appendChild(t);let e=document.createElement("link");e.id=pe,e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(e)},Ze=`
/* ============================================
...
`,Ke=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar'], [class*='avatar'] span, [class*='avatar'] p, [class*='avatar'] div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff']",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}}],G=()=>{for(let o of Ke){let t;try{t=document.querySelectorAll(o.selector)}catch{continue}t.forEach(e=>{for(let[r,a]of Object.entries(o.styles)){let n=e.style.getPropertyPriority(r),i=e.style.getPropertyValue(r);n==="important"&&i===a||e.style.setProperty(r,a,"important")}})}},Y="#1A1F28",Je=26,Xe=31,Qe=40,ue=new Set,me=new Set,z=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0||(t.textContent||"").trim()!=="--")return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;t.style.setProperty("display","none","important");let a=t.className?.toString()||"<no class>";!me.has(a)&&a!=="<no class>"&&(me.add(a),d.debug(`Hid empty "--" leaf: "${a}"`))})},he=new Set,et=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();if(e.includes("ai-button")||e.includes("ask-ai")||e.includes("bg-clip-text")||e.includes("text-transparent")||t.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=t.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g"||window.getComputedStyle(t).color!=="rgb(255, 255, 255)")return;t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let i=t.className?.toString()||"<no class>";!he.has(i)&&i!=="<no class>"&&(he.add(i),d.debug(`Remapped pure-white text -> bone: "${i}"`))})},be=new Set,tt=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, aside.default-bg-color").forEach(t=>{t.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar"))return;let n=window.getComputedStyle(r),i=n.backgroundColor,s=n.backgroundImage||"",c=!1;if(s!=="none"&&s.includes("gradient"))c=!0;else if(i&&i!=="rgba(0, 0, 0, 0)"&&i!=="transparent"){let m=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(m){let h=parseInt(m[1],10),S=parseInt(m[2],10),L=parseInt(m[3],10);(h>=60||S>=60||L>=60)&&(h>230&&S>230&&L>230||(h>=80||S>=80||L>=80)&&(c=!0))}}if(!c)return;let f=(r.textContent||"").trim(),u=a,b=Array.from(r.querySelectorAll("*")).map(m=>(m.className?.toString()||"").toLowerCase()).join(" "),_=f.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),x=u.includes("bg-clip-text")||u.includes("text-transparent")||b.includes("bg-clip-text")||b.includes("text-transparent"),y=Array.from(r.querySelectorAll("*")).some(m=>{let h=window.getComputedStyle(m),S=h.getPropertyValue("-webkit-background-clip")||"",L=h.getPropertyValue("background-clip")||"";return S.includes("text")||L.includes("text")});if(_||x||y){let m=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],h=S=>{m.forEach(L=>S.style.removeProperty(L))};h(r),r.querySelectorAll("*").forEach(h);return}let w="#12161D";r.style.setProperty("color",w,"important"),r.querySelectorAll("*").forEach(m=>{let h=m.tagName.toLowerCase();h==="svg"||h==="path"||h==="circle"||h==="rect"||h==="polygon"||h==="polyline"||h==="line"||h==="g"?(m.style.setProperty("fill",w,"important"),m.style.setProperty("stroke",w,"important"),m.style.setProperty("color",w,"important")):(m.style.setProperty("color",w,"important"),m.style.setProperty("-webkit-text-fill-color",w,"important"))});let E=r.className?.toString()||"<no class>";!be.has(E)&&E!=="<no class>"&&(be.add(E),d.debug(`Darkened SVG icons on colored button: "${E}"`))})})},ge=new Set,ot=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0||e.width<20||e.width>64||e.height<20||e.height>64)return;let r=e.top+e.height/2;(t.parentElement||t).querySelectorAll("svg, img").forEach(s=>{let c=s;if(c.closest("[id^='ws-crm-']"))return;let p=s.getBoundingClientRect();if(p.width===0||p.width>28||p.height>28)return;let f=p.left<e.right&&p.right>e.left,u=p.top<e.bottom&&p.bottom>e.top;if(!(f&&u)||p.top+p.height/2<r)return;let _=p.width*p.height/(e.width*e.height);if(_>.55)return;let x=c,y=c.parentElement,w=0;for(;y&&y!==t&&w<3;){let m=y.getBoundingClientRect();if(m.width>0&&m.width<=30&&m.height<=30)x=y;else break;y=y.parentElement,w++}x.style.setProperty("transform","translateY(11px)","important");let E=(x.className?.toString()||"")+" "+x.tagName;ge.has(E)||(ge.add(E),d.debug(`Dropped activity badge 11px (${p.width.toFixed(0)}x${p.height.toFixed(0)} icon, ratio ${_.toFixed(2)}): "${E}"`))})})},fe=new Set,rt=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.parentElement,r=0;for(;e&&r<3&&!e.closest("[id^='ws-crm-']");){let a=(e.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=e.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){e.style.setProperty("background-color","#12161D","important"),e.style.setProperty("background-image","none","important");let s=e.className?.toString()||"<no class>";!fe.has(s)&&s!=="<no class>"&&(fe.add(s),d.debug(`Painted Ask AI wrapper graphite: "${s}"`))}}e=e.parentElement,r++}})},ye=new Set,at=()=>{document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(t=>{t.querySelectorAll("*").forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator")||a.includes("ai-button")||a.includes("ask-ai")||a.includes("bg-clip-text")||a.includes("text-transparent")||r.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let n=window.getComputedStyle(r).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let i=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),c=parseInt(i[2],10),p=parseInt(i[3],10);if(!(s>200&&c>200&&p>200))return;let u=r.getBoundingClientRect();if(u.width<24||u.height<16||u.width>1400)return;r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important");let b=r.className?.toString()||"<no class>";!ye.has(b)&&b!=="<no class>"&&(ye.add(b),d.debug(`Coerced light bg (${u.width.toFixed(0)}x${u.height.toFixed(0)}, rgb(${s},${c},${p})): "${b}"`))})})},ve=new Set,nt=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0)return;let r=(e.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||e.closest(o)||e.closest("[class*='avatar'], [class*='hr-avatar']")||e.closest("[class*='hr-collapse'], [class*='collapse-item'], [class*='collapse-header'], [class*='folder-header'], [class*='field-folder']"))return;let a=e,n=null;for(let f=0;f<4&&a;f++){let u=a.nextElementSibling;if(u&&(u.matches(o)||u.querySelector(o)!==null)){n=u;break}a=a.parentElement}if(!n)return;let i=e.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;e.style.setProperty("color","#9098A3","important"),e.style.setProperty("-webkit-text-fill-color","#9098A3","important");let s=n,c=s.getBoundingClientRect();c.width>0&&c.width<=800&&c.height>0&&c.height<=100&&(s.style.setProperty("background-color",Y,"important"),s.style.setProperty("border-color","#252C36","important"),s.style.setProperty("border-style","solid","important"),s.style.setProperty("border-width","1px","important"),s.style.setProperty("border-radius","4px","important"));let p=e.className?.toString()||"<no class>";!ve.has(p)&&p!=="<no class>"&&(ve.add(p),d.debug(`Colored field label "${r.slice(0,30)}": "${p}"`))})},xe=new Set,st=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0||e.height>80||t.querySelector("svg, img")!==null)return;let a=(t.textContent||"").trim();if(a.length===0||a.length>4)return;let n=Math.min(e.width,e.height),i=Math.max(16,Math.min(24,Math.round(n*.6)));t.style.setProperty("font-size",`${i}px`,"important"),t.style.setProperty("line-height","1","important"),t.style.setProperty("display","flex","important"),t.style.setProperty("align-items","center","important"),t.style.setProperty("justify-content","center","important"),t.style.setProperty("text-align","center","important"),t.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${i}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let s=t.className?.toString()||"<no class>";!xe.has(s)&&s!=="<no class>"&&(xe.add(s),d.debug(`Resized avatar text to ${i}px (circle ${n.toFixed(0)}px): "${s}"`))})},we=new Set,it=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;t.style.setProperty("background-color",Y,"important"),t.style.setProperty("border-color","#252C36","important"),t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=t.className?.toString()||"<no class>";!we.has(r)&&r!=="<no class>"&&(we.add(r),d.debug(`Forced input slate bg: "${r}"`))})},q=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.closest("[class*='hr-collapse'], [class*='collapse-item'], [class*='collapse-header'], [class*='folder-header'], [class*='field-folder']"))return;let e=window.getComputedStyle(t).backgroundColor;if(!e||e==="rgba(0, 0, 0, 0)"||e==="transparent")return;let r=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),n=parseInt(r[2],10),i=parseInt(r[3],10);if(!(a<Je&&n<Xe&&i<Qe))return;let c=t.getBoundingClientRect();if(c.width===0||c.height===0||c.width>800||c.height>200)return;t.style.setProperty("background-color",Y,"important");let p=t.className?.toString()||"<no class>";!ue.has(p)&&p!=="<no class>"&&(ue.add(p),d.debug(`Coerced dark bg to slate (${c.width.toFixed(0)}x${c.height.toFixed(0)}, rgb(${a},${n},${i})): "${p}"`))})},ke=()=>{let o,t=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,G(),it(),q(),z(),nt(),at(),rt(),tt(),st(),ot(),et()},100))};G(),q(),z(),window.setTimeout(()=>{G(),q(),z()},500),window.setTimeout(()=>{G(),q(),z()},1500),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Ee=()=>{if(Ye(),!document.getElementById(de)){let o=document.createElement("style");o.id=de,o.textContent=Ze,document.head.appendChild(o),d.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?ke():window.addEventListener("DOMContentLoaded",ke))};var Se="ws-crm-customizer-version-badge",_e=()=>{if(document.getElementById(Se))return;let o=document.createElement("div");o.id=Se,o.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,o.textContent=`Customizer v${R}`,o.title=`Built ${H}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Le=()=>{d.info(`Loaded v${R} (built ${H})`),ce(),Ee(),J(),K(o=>{d.debug("Page handler firing for:",o),_e(),te(),ne()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Le):Le();})();
