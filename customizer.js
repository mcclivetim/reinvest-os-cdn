/* Wholesaling CRM Customizer v0.12.11 — built 2026-05-24T21:27:13.867Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var U="[wholesaling-crm-customizer]",ot="__WS_CRM_DEBUG",rt=()=>!!window[ot],h={info(...o){console.log(U,...o)},warn(...o){console.warn(U,...o)},error(...o){console.error(U,...o)},debug(...o){rt()&&console.log(U,"[debug]",...o)}};var _e=/\/contacts\/detail\/([A-Za-z0-9]+)/,ie=/\/v2\/location\/([A-Za-z0-9]+)/,nt=o=>{let e=o.match(_e);if(!e)return null;let t=o.match(ie);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},at=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(_e);if(!n)continue;let a=r.match(ie)||window.location.pathname.match(ie);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},x=()=>{let o=nt(window.location.pathname);return o||at()};var ve=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},z="",le=null,H="other",de=new Set,q=()=>{let o=x()?.contactId??null;if(!(!(window.location.pathname!==z)&&!(o!==le))){z=window.location.pathname,le=o,H=ve(),h.debug("Page/context changed:",H,z,"contact:",o);for(let r of de)try{r(H)}catch(n){h.error("Subscriber threw:",n)}}},ue=o=>(de.add(o),setTimeout(()=>o(H),0),()=>{de.delete(o)}),ye=()=>{H=ve(),z=window.location.pathname,le=x()?.contactId??null,h.debug("Router init, current page:",H);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),q()},history.replaceState=function(t,r,n){e(t,r,n),q()},window.addEventListener("popstate",q),setInterval(q,1e3)};var W="0.12.11",j="2026-05-24T21:27:13.868Z";var S=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let c=n.querySelector(o);c&&(p(),a(c))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let c=n.querySelector(o);c&&(p(),a(c))},r),d=window.setTimeout(()=>{p(),h.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ce={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},K=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,P=`
  ...
  flex-shrink: 0;
`;var st=/^[A-Za-z0-9]{15,30}$/,R=o=>typeof o=="string"&&st.test(o),it=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},lt=()=>{let o=window.WS_CRM_USER_ID;return R(o)?o:null},dt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(R(t))return t;return null},ct=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=it(e);if(!t)return null;let r=t.uid;if(R(r))return r;let n=t.claims;if(n&&R(n.user_id))return n.user_id}catch{}return null},bt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(R(n))return n}catch{}}}catch{}return null},F=()=>lt()||dt()||ct()||bt()||null;var xe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ht=`${xe}/active-follow-up-get`,pt=`${xe}/active-follow-up-set`,O="ws-crm-active-follow-up-button",be={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},mt=()=>{let o=x();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},_t=async o=>{let e=await fetch(ht,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},vt=async(o,e)=>{let t=await fetch(pt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},D=(o,e)=>{let t=be[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},ge=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,D(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=mt();if(!(!r||r.contactId!==o)){D(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await vt(r,F()),a=n&&n.state&&n.state in be?n.state:"blue";D(e,a),h.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){h.error("Active Follow Up Set webhook failed",n),D(e,"error"),setTimeout(()=>void Y(e,r),4e3)}}}),e},Y=async(o,e)=>{D(o,"loading");try{let t=await _t(e),r=t&&t.state&&t.state in be?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;D(n,r)}catch(t){h.warn("Active Follow Up Get webhook failed",t),D(o,"error")}},ut=[".central-panel","[class*='central-panel']"],fe="ws-crm-contact-actions-bar",yt=async()=>{for(let o of ut)try{let e=await S(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await S("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},gt=(o,e)=>{let t=e.querySelector(`#${fe}`);if(t)return t.appendChild(o),{container:t,placement:"actions-bar"};let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${fe}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},ft=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},wt=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},xt=async o=>{if(o==="url"){let t=await yt();return t?{kind:"contact-detail",target:t}:null}let e=ft();return e?{kind:"conversations",target:e}:null},we=(o,e)=>e.kind==="contact-detail"?gt(o,e.target).placement:(wt(o,e.target),"conversations-header"),kt=async()=>{let o=x();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){Y(t,e);return}t&&t.remove();let r=await xt(o.source);if(!r){h.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=x();if(!n||n.contactId!==e.contactId)return;let a=ge(e.contactId),i=we(a,r);h.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Y(a,e);let s=new MutationObserver(()=>{let d=document.getElementById(O);if(!(x()?.contactId===e.contactId)){s.disconnect();return}if(!d){let p=ge(e.contactId);we(p,r),Y(p,e),h.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});s.observe(r.target,{childList:!0})},ke=()=>{kt()};var I="ws-crm-claim-release-pill",Et="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Tt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",St=async o=>{let e=await fetch(Et,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ct=async o=>{let e=await fetch(Tt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Se=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},M=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=K(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},At=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=I,t.type="button",t.dataset.contactId=o,M(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=x();if(!n||!n.locationId||n.contactId!==o)return;let a=F();if(!a){h.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>M(t,r),2500);return}h.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";M(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await Ct({contactId:o,locationId:n.locationId,userId:a,action:r}),d=s?.mode==="claim"||s?.mode==="release"?s.mode:i;M(t,d),h.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(s){h.error("Claim/Release Set webhook failed",s),M(t,r);let d=t.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Ee=async(o,e)=>{try{let t=await St({contactId:e.contactId,locationId:e.locationId,userId:F()}),r=document.getElementById(I);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";M(r,n)}catch(t){h.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Ft=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Se(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Te=(o,e)=>{let t=At({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},It=async()=>{let o=x();if(!o){document.getElementById(I)?.remove();return}let e=document.getElementById(I);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await S("#record-details-lhs",{timeoutMs:1e4}),r=await Ft(t),n=x();if(!n||n.contactId!==o.contactId)return;if(!r){h.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Te(r,o.contactId),h.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(I);a&&o.locationId&&Ee(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(x()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(I))return;let d=Se(t);if(d){Te(d,o.contactId);let b=document.getElementById(I);b&&o.locationId&&Ee(b,{contactId:o.contactId,locationId:o.locationId}),h.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){h.warn("Could not mount Claim/Release pill:",t)}}},Ce=()=>{It()};var Lt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var Dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ht=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n})=>{let a={call_status:t,triggered_by_user_id:r??""};n&&(a.dead_reason=n);let s=await fetch(Lt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:e},customData:a}),credentials:"omit"});if(!s.ok)throw new Error(`Webhook returned ${s.status} ${s.statusText}`)},Mt=async({contactId:o,tenantId:e})=>{let t=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var X="ws-crm-contact-actions-bar",Nt="ws-crm-call-status-dropdown",Ae="ws-crm-offer-made-modal",Pt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Rt=[".central-panel","[class*='central-panel']"],Ot=async()=>{for(let o of Rt)try{let e=await S(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await S("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Bt=o=>{let e=document.createElement("div");e.id=Nt,e.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=P,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,Pt.forEach(n=>{let a=document.createElement("button");a.type="button",a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,a.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${ce[n.color]};
        flex-shrink: 0;
      "></span>
      <span>${n.label}</span>
    `,a.addEventListener("mouseenter",()=>{a.style.background=l.slate}),a.addEventListener("mouseleave",()=>{a.style.background="transparent"}),a.addEventListener("click",async()=>{h.info(`Call Status set to "${n.label}" (${n.value}, ${n.color}) for contact ${o}`);let i=t.firstElementChild,s=t.children[1],d=t.children[2];i&&(i.style.background=ce[n.color]),s&&(s.textContent=n.label),r.style.display="none";let p=x()?.locationId,m=F();if(!p){h.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),s&&(s.textContent=`${n.label} (no tenant!)`),s&&(s.style.color=l.amber);return}if(n.color==="green"&&!m){h.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),s&&(s.textContent=`${n.label} (no user!)`),s&&(s.style.color=l.amber);return}let c=d?.textContent??"\u25BE",g=async y=>{d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await Ht({contactId:o,locationId:p,status:n.label,userId:m,deadReason:y}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=c),t.style.opacity="1"},900)}catch(u){h.warn("Call Status webhook failed:",u),d&&(d.textContent="\u2717"),s&&(s.style.color=l.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=c),s&&(s.style.color=l.bone)},1800)}};if(n.value==="dead-deal"){let y=s?.textContent??"";Vt(u=>{g(u)},()=>{s&&(s.textContent=y)});return}if(n.value==="appointment-booked"){let y=s?.textContent??"";try{(await Mt({contactId:o,tenantId:p})).ok?await g():$t(()=>{g()},()=>{s&&(s.textContent=y)})}catch(u){h.warn("Appointment sanity check failed; firing anyway:",u),await g()}return}await g()}),r.appendChild(a)}),t.addEventListener("click",n=>{n.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",n=>{e.contains(n.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},Gt=o=>{document.getElementById(Ae)?.remove();let e=document.createElement("div");e.id=Ae,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Le=o=>{let e=document.createElement("div");e.id=X,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let t=document.createElement("button");return t.type="button",t.style.cssText=N,t.textContent="Offer Made",t.addEventListener("click",()=>Gt(o)),e.appendChild(t),e.appendChild(Bt(o)),e},Ut=async()=>{let o=x();if(!o){document.getElementById(X)?.remove();return}let e=document.getElementById(X);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await Ot();if(!t){h.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=x();if(!r||r.contactId!==o.contactId)return;let n=Le(o.contactId);n.dataset.mountTarget=t.className||"central-panel",t.insertBefore(n,t.firstChild),h.debug(`Mounted contact actions bar for ${o.contactId}`);let a=null;a=new MutationObserver(()=>{let i=document.getElementById(X);if(!(x()?.contactId===o.contactId)){a?.disconnect();return}if(!i){let d=Le(o.contactId);d.dataset.mountTarget=n.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),h.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),a.observe(t,{childList:!0})},De=()=>{Ut()};var J="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",qt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),B="data-ws-crm-favicon",he=o=>o.hasAttribute(B),He=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return qt.has(e)},Z=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{He(r)&&!he(r)&&r.remove()});let e=document.head.querySelector(`link[${B}="1"]`);e?e.href!==J&&(e.href=J):(e=document.createElement("link"),e.setAttribute(B,"1"),e.rel="icon",e.type="image/png",e.href=J,document.head.appendChild(e),h.debug("Favicon installed"));let t=document.head.querySelector(`link[${B}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(B,"apple"),t.rel="apple-touch-icon",t.href=J,document.head.appendChild(t))},Me=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Z();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Z())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&He(i)&&!he(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&he(i)&&(n=!0)});n&&Z()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Z(),e>=5&&window.clearInterval(t)},1e3)};var zt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",G="ws-crm-not-interested-button",Wt=/\/opportunities\/detail\/([A-Za-z0-9]+)/,jt=/\/v2\/location\/([A-Za-z0-9]+)/,Q=()=>{let o=window.location.pathname,e=o.match(Wt);if(!e)return null;let t=o.match(jt);return{oppId:e[1],locationId:t?t[1]:null}},Kt=async o=>{let e=await fetch(zt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ne=o=>{let e=document.createElement("button");return e.id=G,e.type="button",e.dataset.oppId=o,e.style.cssText=K("neutral"),e.style.fontFamily=v.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Q();if(!t||!t.locationId||t.oppId!==o)return;let r=F(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Kt({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,h.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){h.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Yt=["[data-testid='OPPORTUNITY_HEADER']","[class*='opportunity-header']","[class*='opp-header']","header.flex.items-center"],Xt=async()=>{for(let o of Yt)try{let e=await S(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Jt=async()=>{let o=Q();if(!o||!o.locationId){document.getElementById(G)?.remove();return}let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId)return;e&&e.remove();let t=await Xt();if(!t){h.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=Q();if(!r||r.oppId!==o.oppId)return;let n=Ne(o.oppId),a=document.createElement("span");a.id=`${G}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,a.appendChild(n),t.appendChild(a),h.debug(`Mounted Not Interested button on opp ${o.oppId}`);let i=new MutationObserver(()=>{let s=document.getElementById(G);if(!(Q()?.oppId===o.oppId)){i.disconnect();return}if(!s){let b=Ne(o.oppId);a.appendChild(b),h.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});i.observe(t,{childList:!0})},Pe=()=>{Jt()};var ne="reos-theme-stylesheet",Ze="reos-theme-fonts",Zt=()=>{let o=document.getElementById(Ze);o&&o.remove()},Qt=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var tt=()=>{h.info(`Loaded v${W} (built ${j})`);try{ae()}catch(o){h.warn("mountVersionBadge failed:",o)}Me(),Qe(),ye(),ue(o=>{h.debug("Page handler firing for:",o),ae(),Ce(),De(),ke(),Pe()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",tt):tt();})();
