/* Wholesaling CRM Customizer v0.36.7 — built 2026-06-13T20:39:46.418Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Os="__WS_CRM_DEBUG",Ds=()=>!!window[Os],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Ds()&&console.log(qt,"[debug]",...t)}};var Hs=/\/v2\/location\/([A-Za-z0-9]+)/,Ps=new Set(["8ntUQzMflUkR0YvrRgVk"]),Fe=()=>{let t=window.location.pathname.match(Hs);return t?t[1]:null},tr=()=>{let t=Fe();return t!==null&&Ps.has(t)};var Yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,or=/\/v2\/location\/([A-Za-z0-9]+)/,Bs=t=>{let e=t.match(Yn);if(!e)return null;let o=t.match(or);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Rs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Yn);if(!a)continue;let i=r.match(or)||window.location.pathname.match(or);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Bs(window.location.pathname);return t||Rs()};var Jn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",rr=null,Ne="other",nr=new Set,Ut=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==rr))){Vt=window.location.pathname,rr=t,Ne=Jn(),c.debug("Page/context changed:",Ne,Vt,"contact:",t);for(let r of nr)try{r(Ne)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(nr.add(t),setTimeout(()=>t(Ne),0),()=>{nr.delete(t)}),Xn=()=>{Ne=Jn(),Vt=window.location.pathname,rr=P()?.contactId??null,c.debug("Router init, current page:",Ne);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.7",Kt="2026-06-13T20:39:46.419Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ar={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Qn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Fs=/^[A-Za-z0-9]{15,30}$/,at=t=>typeof t=="string"&&Fs.test(t),Zn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ns=()=>{let t=window.WS_CRM_USER_ID;return at(t)?t:null},zs=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(at(o))return o;return null},Gs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);if(!o)return null;let r=o.uid;if(at(r))return r;let a=o.claims;if(a&&at(a.user_id))return a.user_id}catch{}return null},qs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(at(a))return a}catch{}}}catch{}return null},O=()=>Ns()||zs()||Gs()||qs()||null,Us=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Us()?.type==="agency"};var ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Vs=`${ra}/active-follow-up-get`,Ws=`${ra}/active-follow-up-set`,Ce="ws-crm-active-follow-up-button",sr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},js=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ks=async t=>{let e=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ys=async(t,e)=>{let o=await fetch(Ws,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Ae=(t,e)=>{let o=sr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ea=t=>{let e=document.createElement("button");return e.type="button",e.id=Ce,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{xl(t,e,()=>hr(t,e))}),o},hr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([sl(t,e),dr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}gl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},gl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
  ...
  `,h=g=>{let T=i.querySelector("#ws-buybox-state-search"),C=i.querySelectorAll(".ws-buybox-state-row");C.forEach(F=>{F.addEventListener("mouseenter",()=>{F.style.background=n.emeraldGlow}),F.addEventListener("mouseleave",()=>{F.style.background="transparent"}),F.addEventListener("click",()=>{s.stateCode=F.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let F=(T.value||"").toLowerCase().trim();g.forEach((B,q)=>{let N=C[q];if(!N)return;let z=!F||B.name.toLowerCase().includes(F)||B.code.toLowerCase()===F;N.style.display=z?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=g=>`
  ...
  `,x=g=>{let T=g.find(C=>C.code===s.stateCode);return`
    ...
    `},y=()=>{let g=s.granularity==="county"?lt?.[s.stateCode||""]??[]:dt?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),C=i.querySelector("#ws-buybox-value-list");if(!T||!C)return;let F=B=>{let q=B.toLowerCase().trim();if(!q){C.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=g.filter(z=>z.toLowerCase().includes(q)).slice(0,50);if(N.length===0){C.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(s.stateCode||"")}.</div>`;return}C.innerHTML=N.map(z=>`
        <div data-value="${G(z)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${G(z)}
        </div>
      `).join(""),C.querySelectorAll(".ws-buybox-value-row").forEach(z=>{z.addEventListener("mouseenter",()=>{z.style.background=n.emeraldGlow}),z.addEventListener("mouseleave",()=>{z.style.background="transparent"}),z.addEventListener("click",()=>{s.value=z.dataset.value||"",E(s.value)})})};T.addEventListener("input",()=>F(T.value)),F(""),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T.focus(),0)},w=()=>`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",C=>{C.key==="Enter"&&(C.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),C=(g?.value||"").trim();if(!/^\d{5}$/.test(C)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(C)},E=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),C=i.querySelector("#ws-buybox-save");C&&(C.disabled=!0,C.textContent="Adding\u2026"),T&&(T.textContent="");try{let F=await ll(t,e,s.granularity,g);if(!F.ok){T&&(T.textContent=F.error||"Failed to add entry."),C&&(C.disabled=!1,C.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(F){T&&(T.textContent=`Network error: ${F.message}`),C&&(C.disabled=!1,C.textContent="Add")}};l()},lr=!1,qe=null,ct=null,ia=()=>{document.getElementById(sa)?.remove(),document.getElementById(cr)?.remove(),ct&&qe&&qe.nav.removeEventListener("click",ct,!0),ct=null,qe=null,Qt=!1},ca=()=>{kl()},kl=async()=>{if(!lr){lr=!0;try{let t=P();if(!t){ia();return}let e=document.getElementById(cr);if(e&&e.dataset.buyerContactId===t.contactId&&qe)return;ia();let o=null;try{o=await ze(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(Ge(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ul(),vl()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=yl(t.locationId,t.contactId),d=wl(()=>qe),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};qe=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),ct=m=>{let h=m.target;if(!h||p.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Qt&&la(p,!1)},a.addEventListener("click",ct,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{lr=!1}}};var ge="ws-crm-claim-release-pill",El="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Tl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Sl=async t=>{let e=await fetch(El,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Cl=async t=>{let e=await fetch(Tl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ha=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ue=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Qn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,F=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${he(J)}"${J===V?" selected":""}>${ee(J)}</option>`)).join("");y.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${g}">
        ...
        <select id="ws-pc-current-occupancy" style="${C}">${F(_)}</select>
      </div>
      <div style="${g}">
        <div style="${w}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${C}">${F(x)}</select>
      </div>
  ...
  `,f.appendChild(y),document.body.appendChild(f);let B=y.querySelector("#ws-pc-purchase-price"),q=y.querySelector("#ws-pc-emd"),N=y.querySelector("#ws-pc-cash-at-close"),z=!1;N?.addEventListener("input",()=>{z=!0});let ue=()=>{if(z)return;let V=Number(B?.value||0),J=Number(q?.value||0);N&&(N.value=String(Math.max(0,V-J)))};B?.addEventListener("input",ue),q?.addEventListener("input",ue);let Be=()=>f.remove();f.addEventListener("click",V=>{V.target===f&&Be()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Be);let oe=y.querySelector("#ws-pc-submit"),te=y.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(oe){te&&(te.textContent=""),oe.disabled=!0,oe.textContent="Opening\u2026";try{let V=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(B?.value||0),Ze=Number(q?.value||0),et=Number(N?.value||0),tt=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),ot=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),rt=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Re=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),nt=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),Ze!==d&&(X.emd=Ze),et!==p&&(X.cashAtClose=et),tt!==b&&(X.daysToClose=tt),ot!==m&&(X.inspectionDays=ot),rt!==h&&(X.additionalTerms=rt),Re!==_&&(X.currentOccupancy=Re),nt!==x&&(X.occupancyAtClose=nt),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),oe.textContent="Saving\u2026";let Qo=O(),Zo=await No({tenantId:t,contactId:e,template:o,userId:Qo,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",Zo),oe.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await Fn(t,e,o,Q)}catch(V){oe.disabled=!1,oe.textContent="Open Contract",te&&(te.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},Wb=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(me)?.remove(),Yi();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,w=l,S="",A=document.createElement("div");A.id=me,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${B}">
        ...
        <div style="${q}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${m}" style="${C}" />
        </div>
      </div>
      <div style="${B}">
        ...
        <div style="${q}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${h}" style="${C}" />
        </div>
      </div>
      <div style="${B}">
        ...
        <div style="${q}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${_}" style="${C}" />
        </div>
      </div>
      <div style="${B}">
  ...
  `,o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await Ib(e.tenantId,e.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(y.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let w=await Ki(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}b=w,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let w=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${w}-${S}-${A}`},h=y=>{let w=new Date;return w.setDate(w.getDate()+y),m(w)},_=h(45),x=h(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(y){Y(`Failed to prepare contract: ${y.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",y);return}let f=e.contactId||k.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}Wb({tenantId:e.tenantId,contactId:f,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Ab(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await Ki(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Vb({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await Fn(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Qi=()=>{let t=document.createElement("button");return t.id=Hn,t.type="button",t.style.cssText=`${$} position: relative; order: 4;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),jb(t)}),t},Kb="ws-crm-contact-actions-bar",Yb=async()=>{let t=Ji();if(!t){document.getElementById(Hn)?.remove();return}let e=null;try{e=await L(`#${Kb}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Hn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Qi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},De="ws-crm-prepare-contract-button-opp",Dt=`${De}-wrap`,Jb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xb=/\/v2\/location\/([A-Za-z0-9]+)/,Qb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Bn=()=>{let t=window.location.pathname,e=t.match(Jb);if(!e)return null;let o=t.match(Xb);return o?{oppId:e[1],tenantId:o[1]}:null},Zb=async()=>{for(let t of Qb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ro=!1,Ht=null,Rn=null,On=null,Dn,Pt=()=>{Ht?.disconnect(),Ht=null,Rn=null},eh=t=>{if(Ht&&Rn===t)return;Pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rn=t,Ht=new MutationObserver(()=>{let o=Bn();if(!o||o.oppId!==t){Pt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(De)?.remove(),document.getElementById(Dt)?.remove(),Pt();return}document.getElementById(De)||Zi()}),Ht.observe(e,{childList:!0,subtree:!0}))},th=()=>{On||(On=new MutationObserver(()=>{Dn===void 0&&(Dn=window.setTimeout(()=>{Dn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(De);t&&!e&&!Ro&&Zi()},300))}),On.observe(document.body,{childList:!0,subtree:!0}))},Zi=async()=>{if(!Ro){Ro=!0;try{let t=Bn();if(!t){document.getElementById(De)?.remove(),document.getElementById(Dt)?.remove(),Pt();return}let e=document.getElementById(De);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Dt)?.remove(),Pt());return}e&&(e.remove(),document.getElementById(Dt)?.remove());let o=await Zb();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Bn();if(!a||a.oppId!==t.oppId)return;let i=Qi();i.id=De,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Dt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),eh(t.oppId)}finally{Ro=!1}}},es=()=>{Ub(),Yb()};xb();function ee(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function he(t){return ee(t)}var oh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",Pe="ws-crm-compute-offer-button",Gn="ws-crm-compute-offer-popover",ss="ws-crm-offer-modal",ts="ws-crm-contact-actions-bar",rh=[".central-panel","[class*='central-panel']"],He=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",Nn=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},nh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ah=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${nh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},R=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},os=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,zn=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(oh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Qe=()=>{document.getElementById(Gn)?.remove(),document.removeEventListener("mousedown",ls,!0)};function ls(t){let e=document.getElementById(Gn),o=document.getElementById(Pe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Qe()}var ds=(t,e)=>{Qe();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Gn;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",ls,!0),0)},Go=(t,e)=>{ds(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(R("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(R("div",`color:${n.bone};font-size:12px;`,e))})},ih=(t,e,o)=>{ds(t,r=>{r.appendChild(R("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=R("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{Qe(),o(a.property_record_id)}),r.appendChild(i)})})},qo=()=>{document.getElementById(ss)?.remove(),document.removeEventListener("keydown",cs,!0)};function cs(t){t.key==="Escape"&&qo()}var rs=(t,e,o)=>{qo(),Qe();let r=o,a=!1,i="",s=document.createElement("div");s.id=ss,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&qo()});let l=R("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,m,h)=>{a||(a=!0,i="",p(),zn({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r=_:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,m=!!b.has_comps;l.innerHTML="";let h=R("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=R("div","");_.appendChild(R("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(R("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"-"));let x=R("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",qo),h.append(_,x),l.appendChild(h);let k=R("div","padding:14px 18px 18px;");l.appendChild(k);let f=R("select",os());(b.rehab_levels||[]).forEach(B=>{let q=document.createElement("option");q.value=B.key,q.textContent=B.label,B.key===(b.tier||b.property_condition)&&(q.selected=!0),f.appendChild(q)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let y=R("input",os());y.type="number",y.placeholder="uses the level",y.value=b.repair_override!=null?String(b.repair_override):"",y.disabled=a,y.addEventListener("keydown",B=>{B.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let w=R("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(R("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${ah(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=R("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,y.value.trim())),w.append(S),k.appendChild(w),b.low_confidence&&m&&k.appendChild(R("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${b.comp_count??0} comps in window.`));let A=R("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),E=R("div","");E.appendChild(R("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),E.appendChild(f);let g=R("div","");g.appendChild(R("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),g.appendChild(y),A.append(E,g),k.appendChild(A);let T=R("div",`border-top:1px solid ${n.steel};padding-top:12px;`),C=(B,q,N)=>{let z=R("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),ue=R("div","");ue.appendChild(R("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,B)),N?.sub&&ue.appendChild(R("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let Be=R("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,q);z.append(ue,Be),T.appendChild(z)};if(m&&b.imv!=null){C("Investor Market Value (IMV)",He(b.imv)),b.arv!=null&&C("After Repair Value (ARV)",He(b.arv),{color:n.ash});let B=b.repair_adjustment??0,q=-B,N=b.repair_override?"Repair override":b.property_condition_label||"Repairs";B===0?C(`Repairs (${N})`,"Included",{color:n.ash,sub:`${He(b.repair_total)} in repairs included at IMV`}):C(`Repairs (${N})`,Nn(q),{color:q<0?n.crimson:n.emerald,sub:`${He(b.repair_total)} total, ${He(b.baseline_repairs)} included at IMV`}),C("Min. Profit Target",Nn(-(b.profit_target??0)),{color:n.ash}),C("Maximum Cash Offer (MAO)",He(b.mao),{strong:!0,color:n.blue}),C("ICO discount",Nn(-(b.ico_delta??0)),{color:n.ash,sub:"opening / initial offer"}),C("Initial Cash Offer (ICO)",He(b.ico),{strong:!0,color:n.blue})}else T.appendChild(R("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(T);let F=R("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);F.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),k.appendChild(F)}p(),document.body.appendChild(s),document.addEventListener("keydown",cs,!0)},ns=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=Pe,o.dataset.contactId=t,o.style.cssText=`
