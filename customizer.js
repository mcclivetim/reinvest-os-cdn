/* Wholesaling CRM Customizer v0.7.11 — built 2026-05-16T23:20:27.286Z */
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var _e=()=>{d.info(`Loaded v${H} (built ${N})`),ie(),we(),Z(),Y(o=>{d.debug("Page handler firing for:",o),Ee(),ee(),ae()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_e):_e();})();
