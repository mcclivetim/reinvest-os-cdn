...
/* Delete / destructive option \u2014 crimson on hover (matches the
   delete-conversation icon pattern from section 15i). Only via
   class signature; CSS can't reliably match by text content
   without :has-text (non-standard). */
