/* Wholesaling CRM Customizer v0.36.6 — built 2026-06-13T20:17:26.208Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Os="__WS_CRM_DEBUG",Ds=()=>!!window[Os],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Ds()&&console.log(qt,"[debug]",...t)}};var Hs=/\/v2\/location\/([A-Za-z0-9]+)/,Ps=new Set(["8ntUQzMflUkR0YvrRgVk"]),Re=()=>{let t=window.location.pathname.match(Hs);return t?t[1]:null},tr=()=>{let t=Re();return t!==null&&Ps.has(t)};var Yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,or=/\/v2\/location\/([A-Za-z0-9]+)/,Bs=t=>{let e=t.match(Yn);if(!e)return null;let o=t.match(or);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Rs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Yn);if(!a)continue;let i=r.match(or)||window.location.pathname.match(or);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Bs(window.location.pathname);return t||Rs()};var Jn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",rr=null,Fe="other",nr=new Set,Ut=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==rr))){Vt=window.location.pathname,rr=t,Fe=Jn(),c.debug("Page/context changed:",Fe,Vt,"contact:",t);for(let r of nr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(nr.add(t),setTimeout(()=>t(Fe),0),()=>{nr.delete(t)}),Xn=()=>{Fe=Jn(),Vt=window.location.pathname,rr=P()?.contactId??null,c.debug("Router init, current page:",Fe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.6",Kt="2026-06-13T20:17:26.209Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ar={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Qn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var Fs=/^[A-Za-z0-9]{15,30}$/,nt=t=>typeof t=="string"&&Fs.test(t),Zn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ns=()=>{let t=window.WS_CRM_USER_ID;return nt(t)?t:null},zs=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(nt(o))return o;return null},Gs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);if(!o)return null;let r=o.uid;if(nt(r))return r;let a=o.claims;if(a&&nt(a.user_id))return a.user_id}catch{}return null},qs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(nt(a))return a}catch{}}}catch{}return null},O=()=>Ns()||zs()||Gs()||qs()||null,Us=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Us()?.type==="agency"};var ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Vs=`${ra}/active-follow-up-get`,Ws=`${ra}/active-follow-up-set`,Ce="ws-crm-active-follow-up-button",sr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},js=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ks=async t=>{let e=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ys=async(t,e)=>{let o=await fetch(Ws,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Ae=(t,e)=>{let o=sr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ea=t=>{let e=document.createElement("button");return e.type="button",e.id=Ce,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Ae(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=js();if(!(!r||r.contactId!==t)){Ae(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Ys(r,O()),i=a&&a.state&&a.state in sr?a.state:"blue";Ae(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Ae(e,"error"),setTimeout(()=>void Jt(e,r),4e3)}}}),e},Jt=async(t,e)=>{Ae(t,"loading");try{let o=await Ks(e),r=o&&o.state&&o.state in sr?o.state:"gray",a=document.getElementById(Ce);if(!a||a.dataset.contactId!==e.contactId)return;Ae(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Ae(t,"error")}},Js=[".central-panel","[class*='central-panel']"],ir="ws-crm-contact-actions-bar",Xs=async()=>{for(let t of Js)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Qs=async(t,e)=>{let o=e.querySelector(`#${ir}`);if(!o)try{o=await L(`#${ir}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${ir}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Zs=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},el=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},tl=async t=>{if(t==="url"){let o=await Xs();return o?{kind:"contact-detail",target:o}:null}let e=Zs();return e?{kind:"conversations",target:e}:null},ta=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Qs(t,e.target);return o}return el(t,e.target),"conversations-header"},ol=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(Ce)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Ce);if(o&&o.dataset.contactId===e.contactId){Jt(o,e);return}o&&o.remove();let r=await tl(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=ea(e.contactId),s=await ta(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),oa();let l=document.getElementById(Ce)??i;Jt(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(Ce);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!p){let m=ea(e.contactId);ta(m,r).then(()=>{oa(),Jt(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},at=null,na=()=>{let t=P()?.contactId??null;if(at&&at.contactId===t)return;let e=ol().finally(()=>{at?.promise===e&&(at=null)});at={contactId:t,promise:e}},oa=()=>{let t=document.querySelectorAll(`#${Ce}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var rl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",it=new Map,Ne=async(t,e)=>{if(!t)return null;if(it.has(t))return it.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${rl}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),it.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return it.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),it.set(t,null),null}};var ze=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var sa="ws-buybox-nav-icon",cr="ws-buybox-panel",aa="ws-buybox-modal",nl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",pr="https://mcclivetim.github.io/reinvest-os-cdn/geo",Xt=null,st=null,lt=null,dr=async()=>{if(Xt)return Xt;try{let t=await fetch(`${pr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Xt=await t.json(),Xt}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},al=async t=>{if(!st)try{let e=await fetch(`${pr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);st=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return st?.[t]??[]},il=async t=>{if(!lt)try{let e=await fetch(`${pr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);lt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return lt?.[t]??[]},br=async t=>await(await fetch(nl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),sl=(t,e)=>br({tenant_id:t,action:"list",buyer_contact_id:e}),ll=(t,e,o,r)=>br({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),dl=(t,e)=>br({tenant_id:t,action:"remove",entry_id:e}),q=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),cl=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},pl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',bl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',hl="nav.w-13, nav[class*='w-13']",ml=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ul=async()=>{try{return await L(hl,{timeoutMs:2500})}catch{return null}},vl=async()=>{try{return await L(ml,{timeoutMs:2500})}catch{return null}},_l=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,yl=(t,e)=>{let o=document.createElement("div");return o.id=cr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{xl(t,e,()=>hr(t,e))}),o},hr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([sl(t,e),dr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}gl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},gl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?cl(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,dl(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}hr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Qt=!1,la=(t,e)=>{Qt=e;let o=_l(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=fl,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",hr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=da,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},da="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",fl="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",wl=t=>{let e=document.createElement("button");return e.id=sa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=da,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${pl.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Qt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),la(r,a)}),e},xl=(t,e,o)=>{let r=document.getElementById(aa);r&&r.remove();let a=document.createElement("div");a.id=aa,a.style.cssText=`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),A=(g?.value||"").trim();if(!/^\d{5}$/.test(A)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(A)},E=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),A=i.querySelector("#ws-buybox-save");A&&(A.disabled=!0,A.textContent="Adding\u2026"),T&&(T.textContent="");try{let F=await ll(t,e,s.granularity,g);if(!F.ok){T&&(T.textContent=F.error||"Failed to add entry."),A&&(A.disabled=!1,A.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(F){T&&(T.textContent=`Network error: ${F.message}`),A&&(A.disabled=!1,A.textContent="Add")}};l()},lr=!1,Ge=null,dt=null,ia=()=>{document.getElementById(sa)?.remove(),document.getElementById(cr)?.remove(),dt&&Ge&&Ge.nav.removeEventListener("click",dt,!0),dt=null,Ge=null,Qt=!1},ca=()=>{kl()},kl=async()=>{if(!lr){lr=!0;try{let t=P();if(!t){ia();return}let e=document.getElementById(cr);if(e&&e.dataset.buyerContactId===t.contactId&&Ge)return;ia();let o=null;try{o=await Ne(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(ze(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ul(),vl()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=yl(t.locationId,t.contactId),d=wl(()=>Ge),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ge=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),dt=m=>{let h=m.target;if(!h||p.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Qt&&la(p,!1)},a.addEventListener("click",dt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{lr=!1}}};var ge="ws-crm-claim-release-pill",El="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Tl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Sl=async t=>{let e=await fetch(El,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Cl=async t=>{let e=await fetch(Tl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ha=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},qe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Qn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Al=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ge,o.type="button",o.dataset.contactId=t,qe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=P();if(!a||!a.locationId||a.contactId!==t)return;let i=O();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>qe(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";qe(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Cl({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;qe(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),qe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},pa=async(t,e)=>{try{let o=await Sl({contactId:e.contactId,locationId:e.locationId,userId:O()}),r=document.getElementById(ge);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";qe(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Il=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=ha(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},ba=(t,e)=>{let o=Al({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ge}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Ll=async()=>{let t=P();if(!t){document.getElementById(ge)?.remove();return}let e=document.getElementById(ge);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await Il(o),a=P();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ba(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ge);i&&t.locationId&&pa(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(P()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ge))return;let d=ha(o);if(d){ba(d,t.contactId);let p=document.getElementById(ge);p&&t.locationId&&pa(p,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},ma=()=>{Ll()};var wa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",$l="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Ml="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ol=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||wa,d;if(s==="buyer"){let b=xa.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Dl=async({contactId:t,tenantId:e})=>{let o=await fetch(Ml,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Ue="ws-crm-contact-actions-bar",Hl="ws-crm-call-status-dropdown",ua="ws-crm-offer-made-modal",Pl=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],xa=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Bl=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Rl=async()=>{for(let t of Bl)try{let e=await L(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Fl=({contactId:t,kind:e})=>{let o=e==="buyer"?xa:Pl,r=e==="buyer"?$l:wa,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Hl,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=$,r.style.order="3",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Gl(t,e)),o.appendChild(r),o.appendChild(Fl({contactId:t,kind:e}))}return o},mr=!1,ga=()=>{document.querySelectorAll(`[id="${Ue}"]`).forEach(t=>t.remove())},ka=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),mr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}mr=!0;try{await Vl()}finally{mr=!1}},Vl=async()=>{let t=P();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),ga();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),ga();return}let e="seller";try{let p=await Ne(t.contactId,t.locationId),b=ze(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=P();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Ue}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Rl();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=P();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ya(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Ue)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(P()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Ue}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=ya(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},fa=null,Wl=()=>{fa===null&&(fa=window.setInterval(()=>{let t=P();t&&(document.getElementById(Ue)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ka()))},3e3))},Ea=()=>{Wl(),ka()};var Zt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",jl=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),ct="data-ws-crm-favicon",ur=t=>t.hasAttribute(ct),Ta=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return jl.has(e)},eo=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ta(r)&&!ur(r)&&r.remove()});let e=document.head.querySelector(`link[${ct}="1"]`);e?e.href!==Zt&&(e.href=Zt):(e=document.createElement("link"),e.setAttribute(ct,"1"),e.rel="icon",e.type="image/png",e.href=Zt,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${ct}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(ct,"apple"),o.rel="apple-touch-icon",o.href=Zt,document.head.appendChild(o))},Sa=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)eo();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),eo())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ta(s)&&!ur(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ur(s)&&(a=!0)});a&&eo()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,eo(),e>=5&&window.clearInterval(o)},1e3)};var Kl=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Yl=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Jl=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Jl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Yl);if(a){let i=a[1];if(Kl.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ca="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(Ca);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ca,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Xl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ae="ws-crm-mt-offer-made-button",Aa="ws-crm-mt-offer-made-modal",Ql=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zl=/\/v2\/location\/([A-Za-z0-9]+)/,ro=()=>{let t=window.location.pathname,e=t.match(Ql);if(!e)return null;let o=t.match(Zl);return{oppId:e[1],locationId:o?o[1]:null}},ed=async t=>{let e=await fetch(Xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},to=()=>{document.getElementById(Aa)?.remove()},td=t=>{to();let e=document.createElement("div");e.id=Aa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ro();!o||!o.locationId||o.oppId!==t||td({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},rd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],nd=async()=>{for(let t of rd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},oo=!1,gr=async()=>{if(!oo){oo=!0;try{await ad()}finally{oo=!1}}},ad=async()=>{let t=ro();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await nd();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ro();if(!a||a.oppId!==t.oppId)return;let i=od(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),id(t.oppId)},pt=null,yr=null,bt=()=>{pt?.disconnect(),pt=null,yr=null},id=t=>{if(pt&&yr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yr=t,pt=new MutationObserver(()=>{let o=ro();if(!o||o.oppId!==t){bt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}document.getElementById(ae)||gr()}),pt.observe(e,{childList:!0,subtree:!0}))},vr=null,_r,sd=()=>{vr||(vr=new MutationObserver(()=>{_r===void 0&&(_r=window.setTimeout(()=>{_r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!oo&&gr()},300))}),vr.observe(document.body,{childList:!0,subtree:!0}))},Ia=()=>{sd(),gr()};var ld="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ie="ws-crm-not-interested-button",dd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cd=/\/v2\/location\/([A-Za-z0-9]+)/,ao=()=>{let t=window.location.pathname,e=t.match(dd);if(!e)return null;let o=t.match(cd);return{oppId:e[1],locationId:o?o[1]:null}},pd=async t=>{let e=await fetch(ld,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},bd=t=>{let e=document.createElement("button");return e.id=ie,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=ao();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await pd({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},hd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],md=async()=>{for(let t of hd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,kr=async()=>{if(!no){no=!0;try{await ud()}finally{no=!1}}},ud=async()=>{let t=ao();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await md();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ao();if(!a||a.oppId!==t.oppId)return;let i=bd(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),vd(t.oppId)},ht=null,xr=null,mt=()=>{ht?.disconnect(),ht=null,xr=null},vd=t=>{if(ht&&xr===t)return;mt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xr=t,ht=new MutationObserver(()=>{let o=ao();if(!o||o.oppId!==t){mt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}document.getElementById(ie)||kr()}),ht.observe(e,{childList:!0,subtree:!0}))},fr=null,wr,_d=()=>{fr||(fr=new MutationObserver(()=>{wr===void 0&&(wr=window.setTimeout(()=>{wr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!no&&kr()},300))}),fr.observe(document.body,{childList:!0,subtree:!0}))},La=()=>{_d(),kr()};var yd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",re="ws-crm-schedule-walkthrough-button",Er="ws-crm-schedule-walkthrough-modal",gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fd=/\/v2\/location\/([A-Za-z0-9]+)/,lo=()=>{let t=window.location.pathname,e=t.match(gd);if(!e)return null;let o=t.match(fd);return{oppId:e[1],locationId:o?o[1]:null}},io=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},wd=(t,e)=>{document.getElementById(Er)?.remove();let o=document.createElement("div");o.id=Er,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=lo();!o||!o.locationId||o.oppId!==t||wd(o.oppId,o.locationId)}),e},kd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ed=async()=>{for(let t of kd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,Ar=async()=>{if(!so){so=!0;try{await Td()}finally{so=!1}}},Td=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await Ed();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=xd(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Sd(t.oppId)},ut=null,Cr=null,vt=()=>{ut?.disconnect(),ut=null,Cr=null},Sd=t=>{if(ut&&Cr===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Cr=t,ut=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){vt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}document.getElementById(re)||Ar()}),ut.observe(e,{childList:!0,subtree:!0}))},Tr=null,Sr,Cd=()=>{Tr||(Tr=new MutationObserver(()=>{Sr===void 0&&(Sr=window.setTimeout(()=>{Sr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!so&&Ar()},300))}),Tr.observe(document.body,{childList:!0,subtree:!0}))},$a=()=>{Cd(),Ar()};var Ad="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ve="ws-crm-resend-deal-link-wrap",Id=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ld=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(Id);if(!e)return null;let o=t.match(Ld);return{oppId:e[1],locationId:o?o[1]:null}},$d=async t=>{let e=await fetch(Ad,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Md=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Ma=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Mr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Ma(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Od(t,e)),t.appendChild(o)},Od=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Dd(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Mr(t,e)),o.appendChild(s),t.appendChild(o)},Dd=async(t,e,o,r)=>{let a=po();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await $d({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${Ma(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Md(s)}</span>`}window.setTimeout(()=>Mr(t,e),3500)}},Hd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pd=async()=>{for(let t of Hd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Or=async()=>{if(!co){co=!0;try{await Bd()}finally{co=!1}}},Bd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(Ve)?.remove(),yt();return}let e=document.getElementById(Ve);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),yt());return}e&&e.remove();let o=await Pd();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ve,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Mr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Rd(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Rd=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){yt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ve)?.remove(),yt();return}document.getElementById(Ve)||Or()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Fd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ve)&&!co&&Or()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{Fd(),Or()};var Nd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",se="ws-crm-reduce-price-button",Da="ws-crm-reduce-price-modal",zd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gd=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(zd);if(!e)return null;let o=t.match(Gd);return{oppId:e[1],locationId:o?o[1]:null}},qd=async t=>{let e=await fetch(Nd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},bo=()=>{document.getElementById(Da)?.remove()},Ud=t=>{bo();let e=document.createElement("div");e.id=Da,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=mo();!r||!r.locationId||r.oppId!==t||Ud({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Wd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jd=async()=>{for(let t of Wd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ho=!1,Br=async()=>{if(!ho){ho=!0;try{await Kd()}finally{ho=!1}}},Kd=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await jd();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=Vd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Yd(t.oppId)},gt=null,Pr=null,ft=()=>{gt?.disconnect(),gt=null,Pr=null},Yd=t=>{if(gt&&Pr===t)return;ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pr=t,gt=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){ft();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft();return}document.getElementById(se)||Br()}),gt.observe(e,{childList:!0,subtree:!0}))},Dr=null,Hr,Jd=()=>{Dr||(Dr=new MutationObserver(()=>{Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!ho&&Br()},300))}),Dr.observe(document.body,{childList:!0,subtree:!0}))},Ha=()=>{Jd(),Br()};var We="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",uo="deals.reinvestos.com";var le="ws-crm-edit-landing-button",Xd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qd=/\/v2\/location\/([A-Za-z0-9]+)/,_o=()=>{let t=window.location.pathname,e=t.match(Xd);if(!e)return null;let o=t.match(Qd);return{oppId:e[1],locationId:o?o[1]:null}},Zd=(t,e)=>{let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",We);let r=O();return r&&o.searchParams.set("user",r),o.toString()},ec=(t,e)=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=_o();if(!r||!r.locationId||r.oppId!==t)return;if(!We){c.warn("[edit-landing] editor session key not configured in this build");return}let a=Zd(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},tc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],oc=async()=>{for(let t of tc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vo=!1,zr=async()=>{if(!vo){vo=!0;try{await rc()}finally{vo=!1}}},rc=async()=>{let t=_o();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await oc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=_o();if(!a||a.oppId!==t.oppId)return;let i=ec(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),nc(t.oppId)},wt=null,Nr=null,xt=()=>{wt?.disconnect(),wt=null,Nr=null},nc=t=>{if(wt&&Nr===t)return;xt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Nr=t,wt=new MutationObserver(()=>{let o=_o();if(!o||o.oppId!==t){xt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt();return}document.getElementById(le)||zr()}),wt.observe(e,{childList:!0,subtree:!0}))},Rr=null,Fr,ac=()=>{Rr||(Rr=new MutationObserver(()=>{Fr===void 0&&(Fr=window.setTimeout(()=>{Fr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!vo&&zr()},300))}),Rr.observe(document.body,{childList:!0,subtree:!0}))},Pa=()=>{ac(),zr()};var Ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",je="ws-crm-publish-button",kt="ws-crm-publish-wrap",go="ws-crm-publish-dropdown",ic=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sc=/\/v2\/location\/([A-Za-z0-9]+)/,Ur=()=>{let t=window.location.pathname,e=t.match(ic);if(!e)return null;let o=t.match(sc);return{oppId:e[1],locationId:o?o[1]:null}},lc=async(t,e)=>{try{let o=await fetch(Ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},dc=async(t,e)=>{let o=await fetch(Ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},cc=(t,e)=>{if(!We){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",We);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ve=()=>{document.getElementById(go)?.remove()},Ba=(t,e,o,r,a)=>{ve();let i=document.createElement("div");i.id=go;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Ie(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await lc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ie(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Ie(o,r),document.getElementById(go)&&r.checks&&Ba(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Ie(o,r),ve();try{let m=await dc(t,e);if(m.ok&&m.published)r={status:"published"},Ie(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ie(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Ie(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(go)?ve():r.checks&&Ba(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},bc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hc=async()=>{for(let t of bc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yo=!1,Wr=async()=>{if(!yo){yo=!0;try{await mc()}finally{yo=!1}}},mc=async()=>{let t=Ur();if(!t||!t.locationId){document.getElementById(je)?.remove(),document.getElementById(kt)?.remove(),ve(),Tt();return}let e=document.getElementById(je);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(kt)?.remove(),ve(),Tt());return}e&&(e.remove(),document.getElementById(kt)?.remove(),ve());let o=await hc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Ur();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=pc(t.oppId,a.locationId),s=document.createElement("span");s.id=kt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),uc(t.oppId)},Et=null,Vr=null,Tt=()=>{Et?.disconnect(),Et=null,Vr=null},uc=t=>{if(Et&&Vr===t)return;Tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Vr=t,Et=new MutationObserver(()=>{let o=Ur();if(!o||o.oppId!==t){Tt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(je)?.remove(),document.getElementById(kt)?.remove(),ve(),Tt();return}document.getElementById(je)||Wr()}),Et.observe(e,{childList:!0,subtree:!0}))},Gr=null,qr,vc=()=>{Gr||(Gr=new MutationObserver(()=>{qr===void 0&&(qr=window.setTimeout(()=>{qr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(je)&&!yo&&Wr()},300))}),Gr.observe(document.body,{childList:!0,subtree:!0}))},Fa=()=>{vc(),Wr()};var Na="data:image/png;base64,",za="data:image/png;base64,";var _c=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Ga=t=>`ws-crm-map-links-${t}`,fo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},qa=t=>{let e=fo(t.addr),o=fo(t.city),r=fo(t.state),a=fo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},yc=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,gc=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,fc=(t,e)=>{let{full:o,hasAny:r}=qa(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},wc=t=>{let e=document.createElement("span");e.id=Ga(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),fc(t,s)}),l};return e.appendChild(r(Na,"Open in Google Maps",yc)),e.appendChild(r(za,"Search on Zillow",gc)),e},xc=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ua=()=>{for(let t of _c){if(document.getElementById(Ga(t.key)))continue;let{hasAny:e}=qa(t);if(!e)continue;let o=xc(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(wc(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},jr=null,Kr,kc=()=>{jr||(jr=new MutationObserver(()=>{Kr===void 0&&(Kr=window.setTimeout(()=>{Kr=void 0;try{Ua()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),jr.observe(document.body,{childList:!0,subtree:!0}))},Va=()=>{kc(),Ua()};var Wa="ws-crm-hide-launchpad",ja=/\/launchpad\/?$/,Yr=()=>{if(!Yt()){if(!document.getElementById(Wa)){let t=document.createElement("style");t.id=Wa,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ja.test(location.pathname)){let t=location.pathname.replace(ja,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var Ec=[{label:"Buy-Box Entries"},{label:"Memberships"}],Ka=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Jr=()=>{let t=Yt(),e=new Set(Ec.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Ka(e);for(let o of[150,500,1200,2500])setTimeout(()=>Ka(e),o)}};var Tc=[{from:"Payments",to:"Contracts"}],Sc=".nav-title, .topmenu-navtitle",Ya=()=>{document.querySelectorAll(Sc).forEach(t=>{let e=(t.textContent||"").trim(),o=Tc.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Xr=()=>{Ya();for(let t of[150,500,1200,2500])setTimeout(Ya,t)};var Ja="/payments/proposals-estimates",Cc=/\/payments\/invoices\/?$/,Ac=/\/payments\//,Ic='#sb_payments, a[meta="payments"]',Qa=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ja)&&!(t>3&&!Ac.test(e))){if(Cc.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ja));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Qa(t+1),120)}},Xa=!1,Lc=()=>{Xa||(Xa=!0,document.addEventListener("click",t=>{t.target?.closest?.(Ic)&&setTimeout(()=>Qa(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},Qr=()=>{Lc()};var Za=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ei="ws-crm-hide-topmenu-tabs",Zr=()=>{if(document.getElementById(ei))return;let t=Za.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ei,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${Za.length} top tabs`)};var ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",fe="ws-crm-send-to-closing-office-button",Le="ws-crm-send-to-title-co-wrap",ko="ws-crm-stc-dropdown",$c=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match($c);if(!e)return null;let o=t.match(Mc);return{oppId:e[1],locationId:o?o[1]:null}},Oc=5*60*1e3,ni=t=>`ws-crm-stc-cache:${t}`,Dc=t=>{try{let e=window.localStorage.getItem(ni(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Oc||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Hc=(t,e)=>{try{window.localStorage.setItem(ni(t),JSON.stringify(e))}catch{}},Pc=async(t,e)=>{try{let o=await fetch(ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Bc=async(t,e,o)=>{let r=await fetch(ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Rc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},ti=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Fc=(t,e)=>{if(e&&Rc(e)){window.setTimeout(()=>ti(t),300);return}ti(t)},de=()=>{document.getElementById(ko)?.remove()},wo=(t,e,o)=>{de();let r=document.createElement("div");r.id=ko;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,pe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Pc(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},pe(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},pe(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},pe(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let y=f.pipeline_name;if(y&&y!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),To.add(t),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de(),Ct();return}let w=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;w=f.checks.map((E,g)=>a.checks[g]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:f.previously_sent_at??null},Hc(t,{checks:w,previously_sent_at:f.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),pe(o,a),document.getElementById(ko)&&wo(w,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},pe(o,a),de();try{let y=await Bc(t,e,f);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},pe(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o)}catch(y){c.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},pe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(ko)?de():a.checks&&wo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let w=Date.now()-b,S=Math.max(1500,m-w);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},zc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gc=async()=>{for(let t of zc)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},To=new Set,oi=null,qc=t=>{t&&t!==oi&&(To.clear(),oi=t)},xo=!1,rn=async()=>{if(xo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}xo=!0;try{await Uc()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{xo=!1}},Uc=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Eo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),qc(t.oppId),To.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Le)?.remove(),de(),Ct());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Le)?.remove(),de()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Gc();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Eo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Nc(t.oppId,a.locationId),s=document.createElement("span");s.id=Le,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Vc(t.oppId)},St=null,on=null,Ct=()=>{St?.disconnect(),St=null,on=null},Vc=t=>{if(St&&on===t)return;Ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(on=t,St=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){Ct();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de(),Ct();return}document.getElementById(fe)||rn()}),St.observe(e,{childList:!0,subtree:!0}))},en=null,tn,Wc=()=>{en||(en=new MutationObserver(()=>{tn===void 0&&(tn=window.setTimeout(()=>{tn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);if(t&&!e&&!xo){let o=Eo();if(o&&To.has(o.oppId))return;rn()}},300))}),en.observe(document.body,{childList:!0,subtree:!0}))},ai=()=>{Wc(),rn()};var sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",jc=`${sn}/tc/welcome-call-prefill`,Kc=`${sn}/tc/welcome-call-save`,Yc=`${sn}/tc/order-lockbox`,At="ws-crm-welcome-call-overlay",Jc=["Regular Contract","Subject To","Seller Finance","Novation"],Xc=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Qc=["Gas","Electric","Propane","Oil"],Zc=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],ep=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],we=["Yes","No"],tp=["Yes","No","Unknown"],op=["Professional Photographer","Seller","Tenant"],rp=["Month-to-Month","Annual"],ii=["Current","Behind"],np=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],be=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Co=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,di="margin-bottom:12px;",ci=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,ap=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,si=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=si(o);return`<select id="${t}" style="${Co}"><option value=""></option>${e.map(a=>`<option ${r!==""&&si(a)===r?"selected":""}>${be(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${be(e)}" placeholder="${be(o)}" style="${Co}">`,ip=(t,e)=>`<textarea id="${t}" rows="3" style="${Co}resize:vertical;">${be(e)}</textarea>`,sp=(t,e)=>`<input id="${t}" type="date" value="${be(e)}" style="${Co}">`,D=(t,e)=>`<div style="${di}"><label style="${ci}">${be(t)}</label>${e}</div>`,nn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${np.map(r=>`<label style="${ap}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},_e=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${be(t)}</div>`,Ke=()=>{document.getElementById(At)?.remove()},$e=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},lp=t=>{let e=t.tenant||{};return`
    ${_e("Identifiers")}
    ...
    ${_e("Contract")}
    ${D("Type of Contract",j("wc-contract_type",Jc,t.contract_type))}

    ${_e("Property")}
    ${D("Property Type",j("wc-property_type",Zc,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",Xc,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",Qc,t.heat_source))}
    ...
    ${_e("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",ep,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",rp,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${D("Last rent paid",sp("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",tp,t.hoa_rental_restriction))}</div>

    ${_e("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",op,t.photos_provided_by))}
    <div style="${di}">
  ...
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},an=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),li=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},So=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?be(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},dp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:an("photos_avail_mornings"),photos_avail_afternoons:an("photos_avail_afternoons"),photos_avail_evenings:an("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),cp=t=>{Ke();let e=document.createElement("div");e.id=At,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${lp(t)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){xe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(ke(),xe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",xe("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",xe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(ke(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},xp=(t,e)=>{ke();let o=document.createElement("div");o.id=mi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(ke(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=$,o.textContent=t,o},kp=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},Ep=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===_i){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>yp(t)),o.appendChild(r),o}if(e===vn){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>wp(t,r)),o.appendChild(r),o}if(e===yi){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void fi(t)),o.appendChild(r),o}return null},Tp=(t,e)=>{let o=[];if(e===vn&&(o=[{label:"Re-order Lockbox",onClick:()=>void fi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=hi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=kp();return a.addEventListener("click",i=>{i.stopPropagation(),xp(o,a)}),r.appendChild(a),r},Sp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Cp=async()=>{for(let t of Sp)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ao=()=>{document.getElementById(bn)?.remove(),document.getElementById(hi)?.remove(),ke()},Lo=!1,_n=async()=>{if(!Lo){Lo=!0;try{let t=gi();if(!t){Ao();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ao();return}let o=_p(),r=document.getElementById(bn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Ep(t,o);if(!a){Ao();return}let i=await Cp();if(!i)return;Ao();let s=U(i),l=document.createElement("span");l.id=bn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Tp(t,o);d&&s.appendChild(d),Ap(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},It=null,mn=null,dn,bi=()=>{It?.disconnect(),It=null,mn=null},Ap=t=>{if(It&&mn===t)return;bi();let e=document.querySelector(vi);e&&(mn=t,It=new MutationObserver(()=>{let o=gi();if(!o||o.oppId!==t){bi();return}dn===void 0&&(dn=window.setTimeout(()=>{dn=void 0,_n()},250))}),It.observe(e,{childList:!0,subtree:!0}))},cn=null,pn,Ip=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&_n()},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},wi=()=>{Ip(),_n()};var xi="ws-support-modal",ki="ws-support-toast",Lp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ei="ws-support-submitter-name",Ti="ws-support-submitter-email",Si="ws-support-submitter-role",$p=["Bug","Feature Request","Question","Billing","Onboarding Help"],Me=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Mp=(t,e="success",o)=>{let r=document.getElementById(ki);r&&r.remove();let a=document.createElement("div");a.id=ki;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Op=()=>{document.getElementById(xi)?.remove();let t=(localStorage.getItem(Ei)??"").trim(),e=(localStorage.getItem(Ti)??"").trim(),o=(localStorage.getItem(Si)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=xi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=Re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ei,r.submitterName),localStorage.setItem(Ti,r.submitterEmail),r.submitterRole&&localStorage.setItem(Si,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Lp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";Mp(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Dp=["/support-ticket","ws-support-modal","ws-support"],Hp=/\/custom-menu-link\//,yn=!1,Ci=()=>{if(yn||!Hp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Dp.some(s=>i.includes(s))});if(r){yn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Op(),yn=!1},50);return}t<10&&setTimeout(e,150)};e()},Ai=!1,Ii=()=>{Ai||(Ai=!0,Wt(()=>setTimeout(Ci,50)),Ci(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Bp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Rp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Mi="tc_closing_agent",Fp="tc_closing_office",ce="ws-crm-closing-agent-picker-button",Oi="ws-crm-closing-agent-picker-modal",Np=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zp=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(Np);if(!e)return null;let o=t.match(zp);return{oppId:e[1],locationId:o?o[1]:null}},Sn=async t=>{let e=await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Li=async t=>{let e=await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Gp=async(t,e)=>{try{let o=await fetch(Rp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Mi}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Sn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Oe=null,qp=60*60*1e3,Cn=t=>`ws-crm-to-cache:${t}`,Di=t=>{try{let e=window.localStorage.getItem(Cn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>qp||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Hi=(t,e,o)=>{try{window.localStorage.setItem(Cn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Up=t=>{try{window.localStorage.removeItem(Cn(t))}catch{}},xn="ws-crm-closing-agent-field-link",Vp=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${xn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},gn=!1,An=async t=>{if(gn)return;let e=Pi();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){gn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Sn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),kn(a.id,a.name,t);let i=document.getElementById(ce);if(i){Ee(i,{status:"linked",contactName:a.name});let s=Mt();s&&Hi(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{gn=!1}}},Wp=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Pi=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();Wp.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},kn=(t,e,o)=>{let r=Pi();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${xn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=xn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},$o=()=>{document.getElementById(Oi)?.remove()},jp=t=>{$o();let e=document.createElement("div");e.id=Oi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Ee(o,r);let a=Di(t);return a&&(r={status:"linked",contactName:a.contactName},Ee(o,r),Oe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Gp(t,e);s?(r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},kn(s.id,s.name,e)):a||(r={status:"empty"},Ee(o,r),Oe?.oppId===t&&(Oe=null),Vp(),Up(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||jp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ee(o,r);try{let l=[Li({tenantId:e,oppId:t,fieldKey:Mi,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Li({tenantId:e,oppId:t,fieldKey:Fp,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Hi(t,s.id,s.name),kn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ee(o,r)}}})}),o},Yp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Jp=async()=>{for(let t of Yp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lt=!1,Do=async()=>{if(!Lt){Lt=!0;try{await Xp()}finally{Lt=!1}}},Xp=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Jp();if(!r||!(Di(t.oppId)!==null||Oe!==null&&Oe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Mt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Kp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Qp(t.oppId),An(i.locationId)},$t=null,En=null,Tn=null,Oo=()=>{$t?.disconnect(),$t=null,En=null,Tn=null},Qp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($t&&En===t&&Tn===e||(Oo(),En=t,Tn=e,$t=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t||!o.locationId){Oo();return}document.getElementById(ce)||Do(),An(o.locationId)}),$t.observe(e,{childList:!0,subtree:!0})))},fn=null,wn,Zp=()=>{fn||(fn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lt&&Do()},300))}),fn.observe(document.body,{childList:!0,subtree:!0}))},$i,eb=()=>{$i===void 0&&($i=window.setInterval(()=>{let t=Mt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!Lt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Do()),An(t.locationId)},2e3))},Bi=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Zp(),eb(),Do()};var tb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Se="ws-crm-manage-team-cta",Ri="ws-crm-manage-team-modal",ob=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Fi={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},rb={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ni=()=>{let t=window.location.pathname.match(ob);return t?{tenantId:t[1]}:null},Po=async t=>{let e=await fetch(tb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Te=t=>ne(t),In="ws-crm-manage-team-toast",Mn=(t,e="info",o=4e3)=>{document.getElementById(In)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=In,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(In)===a&&a.remove()},o)},Ln=()=>{document.getElementById(Ri)?.remove()},nb=(t,e)=>{let o=rb[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ne(e)}</span>
  `},ab=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>nb(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>ab(r,e)).join(""),Bo=async t=>{Ln();let e=document.createElement("div");e.id=Ri,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ln);let r;try{r=await Po({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+ib(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{sb(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;lb(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;db(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Ho(e),setTimeout(()=>Ho(e),200),setTimeout(()=>Ho(e),800),window.addEventListener("resize",()=>Ho(e)),e},$n=!1,yb=()=>{if(!$n){$n=!0;try{let t=Ni();if(!t){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}let e=document.getElementById(Se);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Se}-floater`)?.remove();let o=document.createElement("div");o.id=`${Se}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=_b(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{$n=!1}}},zi=()=>{if(!Ni()){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}yb()};var gb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Hn="ws-crm-prepare-contract-button",Gi="ws-crm-prepare-contract-menu",me="ws-crm-prepare-contract-modal",qi="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Yi=()=>{if(document.getElementById(qi))return;let t=document.createElement("style");t.id=qi,t.textContent=`
  ...
  `,document.head.appendChild(t)},Pn="__WS_CRM_CAPTURED_AUTH",fb=50*60*1e3,zo=()=>{try{let t=localStorage.getItem(Pn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>fb?(localStorage.removeItem(Pn),null):e:null}catch{return null}},wb=t=>{try{localStorage.setItem(Pn,JSON.stringify(t))}catch{}},Je=()=>{let t=zo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Ui=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((zo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ye=async(t,e={},o=2)=>{let r=zo()?.capturedAt??0,a;try{a={...Je(),...e.headers??{}}}catch(s){if(o>0&&await Ui(r,4e3))return Ye(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await Ui(r,4e3)?Ye(t,e,o-1):i},Vi=!1,xb=()=>{if(Vi)return;Vi=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=zo()?.authorization;wb({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Ji=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},kb=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Ji()},Eb=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Xi="__WS_CRM_TEMPLATES_CACHE_V1",Tb=24*60*60*1e3,Wi=t=>{try{let e=window.localStorage.getItem(Xi);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Tb?null:o.templates}catch{return null}},Sb=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Xi,JSON.stringify(o))}catch{}},Cb=async t=>{let e=`${ye}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ye(e,{method:"GET"})}catch(s){let l=Wi(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Wi(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Eb(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Sb(t,i),i},Ab=async(t,e)=>{let o=await Ye(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Ye(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},Ib=async(t,e)=>{let o=await Ye(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Je()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Lb=async t=>{let e=await fetch(gb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},$b=async(t,e,o)=>{let r=`${ye}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Je()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Mb=async(t,e)=>{let o=await fetch(`${ye}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Je()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Ob=async t=>{let e=await fetch(`${ye}/contacts/${t}`,{method:"GET",headers:Je()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Db=async(t,e,o,r)=>{let a;try{a=await Mb(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Ob(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ye}/proposals/document/${e}`,{method:"PUT",headers:{...Je(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},Hb=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Fo="__WS_CRM_PENDING_INSTRUCTIONS",Pb=60*1e3,Bb=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Rb=t=>{let e=(t||"").toLowerCase();for(let o of Bb)if(e.includes(o.matches.toLowerCase()))return o;return null},Fb=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Fo,JSON.stringify(r))}catch{}},Nb=()=>{try{let t=localStorage.getItem(Fo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Pb?(localStorage.removeItem(Fo),null):e}catch{return null}},zb=()=>{try{localStorage.removeItem(Fo)}catch{}},Gb=(t,e)=>{document.getElementById(me)?.remove();let o=document.createElement("div");o.id=me,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},qb=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ub=()=>{let t=window.location.pathname.match(qb);if(!t)return;let e=t[1],o=Nb();o&&o.proposalId===e&&(zb(),window.setTimeout(()=>{Gb(o.title,o.bodyHtml)},600))},ji="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(ji)?.remove();let r=document.createElement("div");r.id=ji;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Cb(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await Ib(e.tenantId,e.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(y.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let w=await Ki(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}b=w,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let w=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${w}-${S}-${C}`},h=y=>{let w=new Date;return w.setDate(w.getDate()+y),m(w)},_=h(45),x=h(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(y){Y(`Failed to prepare contract: ${y.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",y);return}let f=e.contactId||k.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}Wb({tenantId:e.tenantId,contactId:f,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Ab(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await Ki(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Vb({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await Fn(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Qi=()=>{let t=document.createElement("button");return t.id=Hn,t.type="button",t.style.cssText=`${$} position: relative; order: 4;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),jb(t)}),t},Kb="ws-crm-contact-actions-bar",Yb=async()=>{let t=Ji();if(!t){document.getElementById(Hn)?.remove();return}let e=null;try{e=await L(`#${Kb}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Hn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Qi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},De="ws-crm-prepare-contract-button-opp",Ot=`${De}-wrap`,Jb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xb=/\/v2\/location\/([A-Za-z0-9]+)/,Qb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Bn=()=>{let t=window.location.pathname,e=t.match(Jb);if(!e)return null;let o=t.match(Xb);return o?{oppId:e[1],tenantId:o[1]}:null},Zb=async()=>{for(let t of Qb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ro=!1,Dt=null,Rn=null,On=null,Dn,Ht=()=>{Dt?.disconnect(),Dt=null,Rn=null},eh=t=>{if(Dt&&Rn===t)return;Ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rn=t,Dt=new MutationObserver(()=>{let o=Bn();if(!o||o.oppId!==t){Ht();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(De)?.remove(),document.getElementById(Ot)?.remove(),Ht();return}document.getElementById(De)||Zi()}),Dt.observe(e,{childList:!0,subtree:!0}))},th=()=>{On||(On=new MutationObserver(()=>{Dn===void 0&&(Dn=window.setTimeout(()=>{Dn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(De);t&&!e&&!Ro&&Zi()},300))}),On.observe(document.body,{childList:!0,subtree:!0}))},Zi=async()=>{if(!Ro){Ro=!0;try{let t=Bn();if(!t){document.getElementById(De)?.remove(),document.getElementById(Ot)?.remove(),Ht();return}let e=document.getElementById(De);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Ot)?.remove(),Ht());return}e&&(e.remove(),document.getElementById(Ot)?.remove());let o=await Zb();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Bn();if(!a||a.oppId!==t.oppId)return;let i=Qi();i.id=De,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Ot,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),eh(t.oppId)}finally{Ro=!1}}},es=()=>{Ub(),Yb()};xb();function ee(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function he(t){return ee(t)}var oh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",He="ws-crm-compute-offer-button",Gn="ws-crm-compute-offer-popover",ss="ws-crm-offer-modal",ts="ws-crm-contact-actions-bar",rh=[".central-panel","[class*='central-panel']"],Pt=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"\u2014",Nn=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},nh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ah=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${nh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},B=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},os=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,zn=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(oh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Xe=()=>{document.getElementById(Gn)?.remove(),document.removeEventListener("mousedown",ls,!0)};function ls(t){let e=document.getElementById(Gn),o=document.getElementById(He),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Xe()}var ds=(t,e)=>{Xe();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Gn;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",ls,!0),0)},Go=(t,e)=>{ds(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(B("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(B("div",`color:${n.bone};font-size:12px;`,e))})},ih=(t,e,o)=>{ds(t,r=>{r.appendChild(B("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties \u2014 which one?")),e.forEach(a=>{let i=B("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{Xe(),o(a.property_record_id)}),r.appendChild(i)})})},qo=()=>{document.getElementById(ss)?.remove(),document.removeEventListener("keydown",cs,!0)};function cs(t){t.key==="Escape"&&qo()}var rs=(t,e,o)=>{qo(),Xe();let r=o,a=!1,i="",s=document.createElement("div");s.id=ss,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&qo()});let l=B("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,m,h)=>{a||(a=!0,i="",p(),zn({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r=_:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed \u2014 try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,m=!!b.has_comps;l.innerHTML="";let h=B("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=B("div","");_.appendChild(B("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(B("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"\u2014"));let x=B("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",qo),h.append(_,x),l.appendChild(h);let k=B("div","padding:14px 18px 18px;");l.appendChild(k);let f=B("select",os());(b.rehab_levels||[]).forEach(R=>{let z=document.createElement("option");z.value=R.key,z.textContent=R.label,R.key===(b.tier||b.property_condition)&&(z.selected=!0),f.appendChild(z)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let y=B("input",os());y.type="number",y.placeholder="uses the level",y.value=b.repair_override!=null?String(b.repair_override):"",y.disabled=a,y.addEventListener("keydown",R=>{R.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let w=B("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(B("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${ah(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=B("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,y.value.trim())),w.append(S),k.appendChild(w),b.low_confidence&&m&&k.appendChild(B("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence \u2014 only ${b.comp_count??0} comps in window.`));let C=B("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),E=B("div","");E.appendChild(B("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),E.appendChild(f);let g=B("div","");g.appendChild(B("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),g.appendChild(y),C.append(E,g),k.appendChild(C);let T=B("div",`border-top:1px solid ${n.steel};padding-top:12px;`),A=(R,z,G)=>{let N=B("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${G?.strong?"font-weight:700;":""}`),ue=B("div","");ue.appendChild(B("div",`font-size:${G?.strong?"13":"12"}px;color:${n.bone};`,R)),G?.sub&&ue.appendChild(B("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,G.sub));let Pe=B("div",`font-size:${G?.strong?"15":"12"}px;color:${G?.color||n.bone};white-space:nowrap;`,z);N.append(ue,Pe),T.appendChild(N)};if(m&&b.imv!=null){A("Investor Market Value",Pt(b.imv));let z=-(b.repair_adjustment??0),G=b.repair_override?"Repair override":b.property_condition_label||"Repairs";A(`Repairs \u2014 ${G}`,Nn(z),{color:z<0?n.crimson:z>0?n.emerald:n.ash,sub:`${Pt(b.repair_total)} total vs ${Pt(b.baseline_repairs)} baseline`}),A("Profit target",Nn(-(b.profit_target??0)),{color:n.ash}),A("MAO \u2014 Maximum Cash Offer",Pt(b.mao),{strong:!0,color:n.blue}),A("ICO discount",Nn(-(b.ico_delta??0)),{color:n.ash,sub:"opening / initial offer"}),A("ICO \u2014 Initial Cash Offer",Pt(b.ico),{strong:!0,color:n.blue})}else T.appendChild(B("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(T);let F=B("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);F.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),k.appendChild(F)}p(),document.body.appendChild(s),document.addEventListener("keydown",cs,!0)},ns=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=He,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Pull Comps")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){ih(o,s.properties,l=>{a(!0),zn({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?rs(e,d.property_record_id,d):Go(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Go(o,"Request failed \u2014 try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?rs(e,s.property_record_id,s):Go(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await zn({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Go(o,"Request failed \u2014 try again.")}finally{a(!1)}}}),o},sh=async()=>{for(let t of rh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},as=async(t,e)=>{let o=e.querySelector(`#${ts}`);if(!o)try{o=await L(`#${ts}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="5",o.appendChild(t),!0):!1},is=()=>{let t=document.querySelectorAll(`#${He}`);for(let e=1;e<t.length;e++)t[e].remove()},lh=async()=>{let t=P();if(!t||!t.locationId||t.source!=="url"){document.getElementById(He)?.remove(),Xe();return}let e=t.locationId,o=document.getElementById(He);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Xe();let r="seller";try{r=ze(await Ne(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw \u2014 defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off \u2014 kind=${r}`),document.getElementById(He)?.remove();return}let a=await sh();if(!a){c.warn("[compute-offer] no central panel found");return}let i=P();if(!i||i.contactId!==t.contactId)return;let s=ns(t.contactId,e);if(!await as(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}is(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(P()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(He)){let d=ns(t.contactId,e);as(d,a).then(()=>is())}});l.observe(a,{childList:!0})},Bt=null,ps=()=>{let t=P()?.contactId??null;if(Bt&&Bt.id===t)return;let e=lh().finally(()=>{Bt?.promise===e&&(Bt=null)});Bt={id:t,promise:e}};var zt="reos-theme-stylesheet",Wn="reos-theme-fonts",Gt=!1,dh=()=>{let t=document.getElementById(Wn);t&&t.remove()},ch=`
/* ============================================
