/* Wholesaling CRM Customizer v0.34.4 — built 2026-06-12T03:25:50.946Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Pt="[wholesaling-crm-customizer]",cs="__WS_CRM_DEBUG",ps=()=>!!window[cs],c={info(...t){console.log(Pt,...t)},warn(...t){console.warn(Pt,...t)},error(...t){console.error(Pt,...t)},debug(...t){ps()&&console.log(Pt,"[debug]",...t)}};var bs=/\/v2\/location\/([A-Za-z0-9]+)/,hs=new Set(["8ntUQzMflUkR0YvrRgVk"]),De=()=>{let t=window.location.pathname.match(bs);return t?t[1]:null},jo=()=>{let t=De();return t!==null&&hs.has(t)};var Rn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ko=/\/v2\/location\/([A-Za-z0-9]+)/,ms=t=>{let e=t.match(Rn);if(!e)return null;let o=t.match(Ko);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},us=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Rn);if(!a)continue;let i=r.match(Ko)||window.location.pathname.match(Ko);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=ms(window.location.pathname);return t||us()};var Fn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Rt="",Yo=null,He="other",Jo=new Set,Bt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Rt)&&!(t!==Yo))){Rt=window.location.pathname,Yo=t,He=Fn(),c.debug("Page/context changed:",He,Rt,"contact:",t);for(let r of Jo)try{r(He)}catch(a){c.error("Subscriber threw:",a)}}},Ft=t=>(Jo.add(t),setTimeout(()=>t(He),0),()=>{Jo.delete(t)}),Nn=()=>{He=Fn(),Rt=window.location.pathname,Yo=P()?.contactId??null,c.debug("Router init, current page:",He);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Bt()},history.replaceState=function(o,r,a){e(o,r,a),Bt()},window.addEventListener("popstate",Bt),setInterval(Bt,1e3)};var Nt="0.34.4",zt="2026-06-12T03:25:50.947Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Xo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},zn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var vs=/^[A-Za-z0-9]{15,30}$/,Qe=t=>typeof t=="string"&&vs.test(t),Gn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},_s=()=>{let t=window.WS_CRM_USER_ID;return Qe(t)?t:null},ys=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Qe(o))return o;return null},gs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Gn(e);if(!o)return null;let r=o.uid;if(Qe(r))return r;let a=o.claims;if(a&&Qe(a.user_id))return a.user_id}catch{}return null},fs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Qe(a))return a}catch{}}}catch{}return null},M=()=>_s()||ys()||gs()||fs()||null,ws=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Gn(e);return o?o.claims??o:null}catch{return null}},Gt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ws()?.type==="agency"};var Wn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",xs=`${Wn}/active-follow-up-get`,ks=`${Wn}/active-follow-up-set`,Te="ws-crm-active-follow-up-button",Zo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Es=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ts=async t=>{let e=await fetch(xs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ss=async(t,e)=>{let o=await fetch(ks,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Se=(t,e)=>{let o=Zo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},qn=t=>{let e=document.createElement("button");return e.type="button",e.id=Te,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Se(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Es();if(!(!r||r.contactId!==t)){Se(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Ss(r,M()),i=a&&a.state&&a.state in Zo?a.state:"blue";Se(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Se(e,"error"),setTimeout(()=>void qt(e,r),4e3)}}}),e},qt=async(t,e)=>{Se(t,"loading");try{let o=await Ts(e),r=o&&o.state&&o.state in Zo?o.state:"gray",a=document.getElementById(Te);if(!a||a.dataset.contactId!==e.contactId)return;Se(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Se(t,"error")}},Cs=[".central-panel","[class*='central-panel']"],Qo="ws-crm-contact-actions-bar",As=async()=>{for(let t of Cs)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Is=async(t,e)=>{let o=e.querySelector(`#${Qo}`);if(!o)try{o=await L(`#${Qo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Qo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Ls=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},$s=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Ms=async t=>{if(t==="url"){let o=await As();return o?{kind:"contact-detail",target:o}:null}let e=Ls();return e?{kind:"conversations",target:e}:null},Un=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Is(t,e.target);return o}return $s(t,e.target),"conversations-header"},Os=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(Te)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Te);if(o&&o.dataset.contactId===e.contactId){qt(o,e);return}o&&o.remove();let r=await Ms(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=qn(e.contactId),s=await Un(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Vn();let l=document.getElementById(Te)??i;qt(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(Te);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!p){let m=qn(e.contactId);Un(m,r).then(()=>{Vn(),qt(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ze=null,jn=()=>{let t=P()?.contactId??null;if(Ze&&Ze.contactId===t)return;let e=Os().finally(()=>{Ze?.promise===e&&(Ze=null)});Ze={contactId:t,promise:e}},Vn=()=>{let t=document.querySelectorAll(`#${Te}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var Ds="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",et=new Map,Ut=async(t,e)=>{if(!t)return null;if(et.has(t))return et.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${Ds}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),et.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return et.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),et.set(t,null),null}};var Vt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var Jn="ws-buybox-nav-icon",or="ws-buybox-panel",Kn="ws-buybox-modal",Hs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",rr="https://mcclivetim.github.io/reinvest-os-cdn/geo",Wt=null,tt=null,ot=null,tr=async()=>{if(Wt)return Wt;try{let t=await fetch(`${rr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Wt=await t.json(),Wt}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Ps=async t=>{if(!tt)try{let e=await fetch(`${rr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);tt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return tt?.[t]??[]},Bs=async t=>{if(!ot)try{let e=await fetch(`${rr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ot=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return ot?.[t]??[]},nr=async t=>await(await fetch(Hs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Rs=(t,e)=>nr({tenant_id:t,action:"list",buyer_contact_id:e}),Fs=(t,e,o,r)=>nr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Ns=(t,e)=>nr({tenant_id:t,action:"remove",entry_id:e}),R=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),zs=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Gs='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',qs='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Us="nav.w-13, nav[class*='w-13']",Vs=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Ws=async()=>{try{return await L(Us,{timeoutMs:2500})}catch{return null}},js=async()=>{try{return await L(Vs,{timeoutMs:2500})}catch{return null}},Ks=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Ys=(t,e)=>{let o=document.createElement("div");return o.id=or,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Zs(t,e,()=>ar(t,e))}),o},ar=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Rs(t,e),tr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${R(r.error||"Failed to load buy-box entries")}</div>`;return}Js(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${R(r.message)}</div>`}},Js=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?zs(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Ns(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}ar(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},jt=!1,Xn=(t,e)=>{jt=e;let o=Ks(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Xs,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",ar(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Qn,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Qn="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Xs="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Qs=t=>{let e=document.createElement("button");return e.id=Jn,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Qn,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Gs.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!jt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Xn(r,a)}),e},Zs=(t,e,o)=>{let r=document.getElementById(Kn);r&&r.remove();let a=document.createElement("div");a.id=Kn,a.style.cssText=`
  ...
  `,C=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let B=await Fs(t,e,s.granularity,g);if(!B.ok){T&&(T.textContent=B.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(B){T&&(T.textContent=`Network error: ${B.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},er=!1,Pe=null,rt=null,Yn=()=>{document.getElementById(Jn)?.remove(),document.getElementById(or)?.remove(),rt&&Pe&&Pe.nav.removeEventListener("click",rt,!0),rt=null,Pe=null,jt=!1},Zn=()=>{el()},el=async()=>{if(!er){er=!0;try{let t=P();if(!t){Yn();return}let e=document.getElementById(or);if(e&&e.dataset.buyerContactId===t.contactId&&Pe)return;Yn();let o=null;try{o=await Ut(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(Vt(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Ws(),js()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=Ys(t.locationId,t.contactId),d=Qs(()=>Pe),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Pe=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),rt=m=>{let h=m.target;if(!h||p.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&jt&&Xn(p,!1)},a.addEventListener("click",rt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{er=!1}}};var _e="ws-crm-claim-release-pill",tl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ol="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",rl=async t=>{let e=await fetch(tl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},nl=async t=>{let e=await fetch(ol,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},oa=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Be=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=zn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},al=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=_e,o.type="button",o.dataset.contactId=t,Be(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=P();if(!a||!a.locationId||a.contactId!==t)return;let i=M();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Be(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Be(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await nl({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Be(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),Be(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},ea=async(t,e)=>{try{let o=await rl({contactId:e.contactId,locationId:e.locationId,userId:M()}),r=document.getElementById(_e);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Be(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},il=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=oa(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},ta=(t,e)=>{let o=al({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${_e}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},sl=async()=>{let t=P();if(!t){document.getElementById(_e)?.remove();return}let e=document.getElementById(_e);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await il(o),a=P();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ta(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(_e);i&&t.locationId&&ea(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(P()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(_e))return;let d=oa(o);if(d){ta(d,t.contactId);let p=document.getElementById(_e);p&&t.locationId&&ea(p,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},ra=()=>{sl()};var da="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ll="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var dl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",cl=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||da,d;if(s==="buyer"){let b=ca.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},pl=async({contactId:t,tenantId:e})=>{let o=await fetch(dl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Re="ws-crm-contact-actions-bar",bl="ws-crm-call-status-dropdown",na="ws-crm-offer-made-modal",hl=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ca=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],ml=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],ul=async()=>{for(let t of ml)try{let e=await L(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},vl=({contactId:t,kind:e})=>{let o=e==="buyer"?ca:hl,r=e==="buyer"?ll:da,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=bl,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Xo[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=Xo[d.color]),m&&(m.textContent=d.label),l.style.display="none";let x=P()?.locationId,E=M();if(!x){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!E){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await cl({contactId:t,locationId:x,status:d.label,userId:E,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(C){c.warn("Call Status webhook failed:",C),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";fl(C=>{y(C)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await pl({contactId:t,tenantId:x})).ok?await y():wl(()=>{y()},()=>{m&&(m.textContent=f)})}catch(C){c.warn("Appointment sanity check failed; firing anyway:",C),await y()}return}await y()}),l.appendChild(p)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},_l="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",yl=async t=>{let e=await fetch(_l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},gl=(t,e="seller")=>{document.getElementById(na)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=na,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},sa=(t,e)=>{let o=document.createElement("div");if(o.id=Re,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=V,r.textContent="Offer Made",r.addEventListener("click",()=>gl(t,e)),o.appendChild(r),o.appendChild(vl({contactId:t,kind:e}))}return o},ir=!1,xl=()=>{document.querySelectorAll(`[id="${Re}"]`).forEach(t=>t.remove())},pa=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),ir){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}ir=!0;try{await kl()}finally{ir=!1}},kl=async()=>{let t=P();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),xl();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let p=await Ut(t.contactId,t.locationId),b=Vt(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=P();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Re}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await ul();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=P();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=sa(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Re)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(P()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Re}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=sa(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},la=null,El=()=>{la===null&&(la=window.setInterval(()=>{let t=P();t&&(document.getElementById(Re)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),pa()))},3e3))},ba=()=>{El(),pa()};var Kt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Tl=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),nt="data-ws-crm-favicon",sr=t=>t.hasAttribute(nt),ha=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Tl.has(e)},Yt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ha(r)&&!sr(r)&&r.remove()});let e=document.head.querySelector(`link[${nt}="1"]`);e?e.href!==Kt&&(e.href=Kt):(e=document.createElement("link"),e.setAttribute(nt,"1"),e.rel="icon",e.type="image/png",e.href=Kt,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${nt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(nt,"apple"),o.rel="apple-touch-icon",o.href=Kt,document.head.appendChild(o))},ma=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Yt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Yt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ha(s)&&!sr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&sr(s)&&(a=!0)});a&&Yt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Yt(),e>=5&&window.clearInterval(o)},1e3)};var Sl=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Cl=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Al=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Al);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Cl);if(a){let i=a[1];if(Sl.includes(i))return i}}return null},q=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ua="ws-crm-dispo-action-row",N=t=>{let e=document.getElementById(ua);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=ua,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Il="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ne="ws-crm-mt-offer-made-button",va="ws-crm-mt-offer-made-modal",Ll=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$l=/\/v2\/location\/([A-Za-z0-9]+)/,Qt=()=>{let t=window.location.pathname,e=t.match(Ll);if(!e)return null;let o=t.match($l);return{oppId:e[1],locationId:o?o[1]:null}},Ml=async t=>{let e=await fetch(Il,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Jt=()=>{document.getElementById(va)?.remove()},Ol=t=>{Jt();let e=document.createElement("div");e.id=va,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Qt();!o||!o.locationId||o.oppId!==t||Ol({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},Hl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pl=async()=>{for(let t of Hl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Xt=!1,pr=async()=>{if(!Xt){Xt=!0;try{await Bl()}finally{Xt=!1}}},Bl=async()=>{let t=Qt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await Pl();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Qt();if(!a||a.oppId!==t.oppId)return;let i=Dl(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Rl(t.oppId)},at=null,cr=null,it=()=>{at?.disconnect(),at=null,cr=null},Rl=t=>{if(at&&cr===t)return;it();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(cr=t,at=new MutationObserver(()=>{let o=Qt();if(!o||o.oppId!==t){it();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it();return}document.getElementById(ne)||pr()}),at.observe(e,{childList:!0,subtree:!0}))},lr=null,dr,Fl=()=>{lr||(lr=new MutationObserver(()=>{dr===void 0&&(dr=window.setTimeout(()=>{dr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!Xt&&pr()},300))}),lr.observe(document.body,{childList:!0,subtree:!0}))},_a=()=>{Fl(),pr()};var Nl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ae="ws-crm-not-interested-button",zl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gl=/\/v2\/location\/([A-Za-z0-9]+)/,eo=()=>{let t=window.location.pathname,e=t.match(zl);if(!e)return null;let o=t.match(Gl);return{oppId:e[1],locationId:o?o[1]:null}},ql=async t=>{let e=await fetch(Nl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ul=t=>{let e=document.createElement("button");return e.id=ae,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=eo();if(!o||!o.locationId||o.oppId!==t)return;let r=M(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await ql({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Vl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wl=async()=>{for(let t of Vl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Zt=!1,ur=async()=>{if(!Zt){Zt=!0;try{await jl()}finally{Zt=!1}}},jl=async()=>{let t=eo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Wl();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=eo();if(!a||a.oppId!==t.oppId)return;let i=Ul(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Kl(t.oppId)},st=null,mr=null,lt=()=>{st?.disconnect(),st=null,mr=null},Kl=t=>{if(st&&mr===t)return;lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(mr=t,st=new MutationObserver(()=>{let o=eo();if(!o||o.oppId!==t){lt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt();return}document.getElementById(ae)||ur()}),st.observe(e,{childList:!0,subtree:!0}))},br=null,hr,Yl=()=>{br||(br=new MutationObserver(()=>{hr===void 0&&(hr=window.setTimeout(()=>{hr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!Zt&&ur()},300))}),br.observe(document.body,{childList:!0,subtree:!0}))},ya=()=>{Yl(),ur()};var Jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",oe="ws-crm-schedule-walkthrough-button",vr="ws-crm-schedule-walkthrough-modal",Xl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ql=/\/v2\/location\/([A-Za-z0-9]+)/,ro=()=>{let t=window.location.pathname,e=t.match(Xl);if(!e)return null;let o=t.match(Ql);return{oppId:e[1],locationId:o?o[1]:null}},to=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Zl=(t,e)=>{document.getElementById(vr)?.remove();let o=document.createElement("div");o.id=vr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${vr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",p=document.getElementById("wsw-dur")?.value||"30";if(!d){to("Pick a date and time.","err");return}let b=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(Jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:b,duration_min:Number(p)}),credentials:"omit"})).ok){s(),to("Walkthrough scheduled \u2713");let h=document.querySelector(`#${oe} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",to("Scheduling failed \u2014 try again.","err")}catch(m){c.warn("[schedule-walkthrough] failed:",m),l.disabled=!1,l.textContent="Schedule",to("Couldn't reach the scheduler. Try again.","err")}})},ed=t=>{let e=document.createElement("button");return e.id=oe,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ro();!o||!o.locationId||o.oppId!==t||Zl(o.oppId,o.locationId)}),e},td=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],od=async()=>{for(let t of td)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},oo=!1,fr=async()=>{if(!oo){oo=!0;try{await rd()}finally{oo=!1}}},rd=async()=>{let t=ro();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=await od();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=ro();if(!a||a.oppId!==t.oppId)return;let i=ed(t.oppId),s=document.createElement("span");s.id=`${oe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),nd(t.oppId)},dt=null,gr=null,ct=()=>{dt?.disconnect(),dt=null,gr=null},nd=t=>{if(dt&&gr===t)return;ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gr=t,dt=new MutationObserver(()=>{let o=ro();if(!o||o.oppId!==t){ct();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct();return}document.getElementById(oe)||fr()}),dt.observe(e,{childList:!0,subtree:!0}))},_r=null,yr,ad=()=>{_r||(_r=new MutationObserver(()=>{yr===void 0&&(yr=window.setTimeout(()=>{yr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!oo&&fr()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},ga=()=>{ad(),fr()};var id="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Fe="ws-crm-resend-deal-link-wrap",sd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ld=/\/v2\/location\/([A-Za-z0-9]+)/,ao=()=>{let t=window.location.pathname,e=t.match(sd);if(!e)return null;let o=t.match(ld);return{oppId:e[1],locationId:o?o[1]:null}},dd=async t=>{let e=await fetch(id,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},cd=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),fa=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Er=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${fa(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>pd(t,e)),t.appendChild(o)},pd=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void bd(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Er(t,e)),o.appendChild(s),t.appendChild(o)},bd=async(t,e,o,r)=>{let a=ao();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await dd({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${fa(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${cd(s)}</span>`}window.setTimeout(()=>Er(t,e),3500)}},hd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],md=async()=>{for(let t of hd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,Tr=async()=>{if(!no){no=!0;try{await ud()}finally{no=!1}}},ud=async()=>{let t=ao();if(!t||!t.locationId){document.getElementById(Fe)?.remove(),bt();return}let e=document.getElementById(Fe);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),bt());return}e&&e.remove();let o=await md();if(!o)return;let r=await q();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ao();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Fe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",N(o).appendChild(i),Er(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),vd(t.oppId)},pt=null,kr=null,bt=()=>{pt?.disconnect(),pt=null,kr=null},vd=t=>{if(pt&&kr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kr=t,pt=new MutationObserver(()=>{let o=ao();if(!o||o.oppId!==t){bt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Fe)?.remove(),bt();return}document.getElementById(Fe)||Tr()}),pt.observe(e,{childList:!0,subtree:!0}))},wr=null,xr,_d=()=>{wr||(wr=new MutationObserver(()=>{xr===void 0&&(xr=window.setTimeout(()=>{xr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Fe)&&!no&&Tr()},300))}),wr.observe(document.body,{childList:!0,subtree:!0}))},wa=()=>{_d(),Tr()};var yd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ie="ws-crm-reduce-price-button",xa="ws-crm-reduce-price-modal",gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fd=/\/v2\/location\/([A-Za-z0-9]+)/,lo=()=>{let t=window.location.pathname,e=t.match(gd);if(!e)return null;let o=t.match(fd);return{oppId:e[1],locationId:o?o[1]:null}},wd=async t=>{let e=await fetch(yd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},io=()=>{document.getElementById(xa)?.remove()},xd=t=>{io();let e=document.createElement("div");e.id=xa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let p=r.value.replace(/[^0-9.]/g,"").split(".");r.value=p[0]+(p.length>1?"."+p.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&io()}),i?.addEventListener("click",()=>{io()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let p=parseFloat(d);if(!Number.isFinite(p)||p<=0){a.textContent="Price must be a positive number.",r.focus();return}if(p<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await wd({oppId:t.oppId,locationId:t.locationId,newPrice:p,userId:M()}),io(),t.onSuccess()}catch(b){c.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},kd=(t,e)=>{let o=document.createElement("button");return o.id=ie,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=lo();!r||!r.locationId||r.oppId!==t||xd({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Ed=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Td=async()=>{for(let t of Ed)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,Ir=async()=>{if(!so){so=!0;try{await Sd()}finally{so=!1}}},Sd=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await Td();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=kd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Cd(t.oppId)},ht=null,Ar=null,mt=()=>{ht?.disconnect(),ht=null,Ar=null},Cd=t=>{if(ht&&Ar===t)return;mt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ar=t,ht=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){mt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}document.getElementById(ie)||Ir()}),ht.observe(e,{childList:!0,subtree:!0}))},Sr=null,Cr,Ad=()=>{Sr||(Sr=new MutationObserver(()=>{Cr===void 0&&(Cr=window.setTimeout(()=>{Cr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!so&&Ir()},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},ka=()=>{Ad(),Ir()};var Ne="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",co="deals.reinvestos.com";var se="ws-crm-edit-landing-button",Id=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ld=/\/v2\/location\/([A-Za-z0-9]+)/,bo=()=>{let t=window.location.pathname,e=t.match(Id);if(!e)return null;let o=t.match(Ld);return{oppId:e[1],locationId:o?o[1]:null}},$d=(t,e)=>{let o=new URL(`https://${co}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ne);let r=M();return r&&o.searchParams.set("user",r),o.toString()},Md=(t,e)=>{let o=document.createElement("button");return o.id=se,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=bo();if(!r||!r.locationId||r.oppId!==t)return;if(!Ne){c.warn("[edit-landing] editor session key not configured in this build");return}let a=$d(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Od=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Dd=async()=>{for(let t of Od)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},po=!1,Or=async()=>{if(!po){po=!0;try{await Hd()}finally{po=!1}}},Hd=async()=>{let t=bo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await Dd();if(!o)return;let r=await q();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=bo();if(!a||a.oppId!==t.oppId)return;let i=Md(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Pd(t.oppId)},ut=null,Mr=null,vt=()=>{ut?.disconnect(),ut=null,Mr=null},Pd=t=>{if(ut&&Mr===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Mr=t,ut=new MutationObserver(()=>{let o=bo();if(!o||o.oppId!==t){vt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt();return}document.getElementById(se)||Or()}),ut.observe(e,{childList:!0,subtree:!0}))},Lr=null,$r,Bd=()=>{Lr||(Lr=new MutationObserver(()=>{$r===void 0&&($r=window.setTimeout(()=>{$r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!po&&Or()},300))}),Lr.observe(document.body,{childList:!0,subtree:!0}))},Ea=()=>{Bd(),Or()};var Sa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",ze="ws-crm-publish-button",_t="ws-crm-publish-wrap",mo="ws-crm-publish-dropdown",Rd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fd=/\/v2\/location\/([A-Za-z0-9]+)/,Pr=()=>{let t=window.location.pathname,e=t.match(Rd);if(!e)return null;let o=t.match(Fd);return{oppId:e[1],locationId:o?o[1]:null}},Nd=async(t,e)=>{try{let o=await fetch(Sa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},zd=async(t,e)=>{let o=await fetch(Sa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Gd=(t,e)=>{if(!Ne){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${co}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ne);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},me=()=>{document.getElementById(mo)?.remove()},Ta=(t,e,o,r,a)=>{me();let i=document.createElement("div");i.id=mo;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Ce(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await Nd(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ce(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Ce(o,r),document.getElementById(mo)&&r.checks&&Ta(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Ce(o,r),me();try{let m=await zd(t,e);if(m.ok&&m.published)r={status:"published"},Ce(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ce(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Ce(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(mo)?me():r.checks&&Ta(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},Ud=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vd=async()=>{for(let t of Ud)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ho=!1,Rr=async()=>{if(!ho){ho=!0;try{await Wd()}finally{ho=!1}}},Wd=async()=>{let t=Pr();if(!t||!t.locationId){document.getElementById(ze)?.remove(),document.getElementById(_t)?.remove(),me(),gt();return}let e=document.getElementById(ze);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(_t)?.remove(),me(),gt());return}e&&(e.remove(),document.getElementById(_t)?.remove(),me());let o=await Vd();if(!o)return;let r=await q();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Pr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=qd(t.oppId,a.locationId),s=document.createElement("span");s.id=_t,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),N(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),jd(t.oppId)},yt=null,Br=null,gt=()=>{yt?.disconnect(),yt=null,Br=null},jd=t=>{if(yt&&Br===t)return;gt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Br=t,yt=new MutationObserver(()=>{let o=Pr();if(!o||o.oppId!==t){gt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(ze)?.remove(),document.getElementById(_t)?.remove(),me(),gt();return}document.getElementById(ze)||Rr()}),yt.observe(e,{childList:!0,subtree:!0}))},Dr=null,Hr,Kd=()=>{Dr||(Dr=new MutationObserver(()=>{Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(ze)&&!ho&&Rr()},300))}),Dr.observe(document.body,{childList:!0,subtree:!0}))},Ca=()=>{Kd(),Rr()};var Aa="data:image/png;base64,",Ia="data:image/png;base64,";var Yd=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],La=t=>`ws-crm-map-links-${t}`,uo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},$a=t=>{let e=uo(t.addr),o=uo(t.city),r=uo(t.state),a=uo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Jd=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Xd=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Qd=(t,e)=>{let{full:o,hasAny:r}=$a(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Zd=t=>{let e=document.createElement("span");e.id=La(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),Qd(t,s)}),l};return e.appendChild(r(Aa,"Open in Google Maps",Jd)),e.appendChild(r(Ia,"Search on Zillow",Xd)),e},ec=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ma=()=>{for(let t of Yd){if(document.getElementById(La(t.key)))continue;let{hasAny:e}=$a(t);if(!e)continue;let o=ec(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Zd(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},Fr=null,Nr,tc=()=>{Fr||(Fr=new MutationObserver(()=>{Nr===void 0&&(Nr=window.setTimeout(()=>{Nr=void 0;try{Ma()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),Fr.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{tc(),Ma()};var Da="ws-crm-hide-launchpad",Ha=/\/launchpad\/?$/,zr=()=>{if(!Gt()){if(!document.getElementById(Da)){let t=document.createElement("style");t.id=Da,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Ha.test(location.pathname)){let t=location.pathname.replace(Ha,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var oc=[{label:"Buy-Box Entries"},{label:"Memberships"}],Pa=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Gr=()=>{let t=Gt(),e=new Set(oc.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Pa(e);for(let o of[150,500,1200,2500])setTimeout(()=>Pa(e),o)}};var rc=[{from:"Payments",to:"Contracts"}],nc=".nav-title, .topmenu-navtitle",Ba=()=>{document.querySelectorAll(nc).forEach(t=>{let e=(t.textContent||"").trim(),o=rc.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},qr=()=>{Ba();for(let t of[150,500,1200,2500])setTimeout(Ba,t)};var Ra="/payments/proposals-estimates",ac=/\/payments\/invoices\/?$/,ic=/\/payments\//,sc='#sb_payments, a[meta="payments"]',Na=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ra)&&!(t>3&&!ic.test(e))){if(ac.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ra));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Na(t+1),120)}},Fa=!1,lc=()=>{Fa||(Fa=!0,document.addEventListener("click",t=>{t.target?.closest?.(sc)&&setTimeout(()=>Na(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},Ur=()=>{lc()};var za=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Ga="ws-crm-hide-topmenu-tabs",Vr=()=>{if(document.getElementById(Ga))return;let t=za.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Ga,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${za.length} top tabs`)};var Va="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ye="ws-crm-send-to-closing-office-button",Ae="ws-crm-send-to-title-co-wrap",yo="ws-crm-stc-dropdown",dc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cc=/\/v2\/location\/([A-Za-z0-9]+)/,go=()=>{let t=window.location.pathname,e=t.match(dc);if(!e)return null;let o=t.match(cc);return{oppId:e[1],locationId:o?o[1]:null}},pc=5*60*1e3,Wa=t=>`ws-crm-stc-cache:${t}`,bc=t=>{try{let e=window.localStorage.getItem(Wa(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>pc||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},hc=(t,e)=>{try{window.localStorage.setItem(Wa(t),JSON.stringify(e))}catch{}},mc=async(t,e)=>{try{let o=await fetch(Va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},uc=async(t,e,o)=>{let r=await fetch(Va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},vc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},qa=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},_c=(t,e)=>{if(e&&vc(e)){window.setTimeout(()=>qa(t),300);return}qa(t)},le=()=>{document.getElementById(yo)?.remove()},vo=(t,e,o)=>{le();let r=document.createElement("div");r.id=yo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,ce(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await mc(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},ce(o,a);return}if(w.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},ce(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},ce(o,a),c.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),fo.add(t),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le(),wt();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},hc(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),ce(o,a),document.getElementById(yo)&&vo(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},ce(o,a),le();try{let y=await uc(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},ce(o,a),y.checks&&vo(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},ce(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},ce(o,a),y.checks&&vo(y.checks,y.previously_sent_at,o)}catch(y){c.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},ce(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(yo)?le():a.checks&&vo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||p)return;let f=Date.now()-b,C=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},C)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},gc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],fc=async()=>{for(let t of gc)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},fo=new Set,Ua=null,wc=t=>{t&&t!==Ua&&(fo.clear(),Ua=t)},_o=!1,Yr=async()=>{if(_o){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_o=!0;try{await xc()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{_o=!1}},xc=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=go();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),wc(t.oppId),fo.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le();return}let e=document.getElementById(ye);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Ae)?.remove(),le(),wt());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Ae)?.remove(),le()),c.debug("[stc] mount:04 calling findMountTarget");let o=await fc();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=go();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=yc(t.oppId,a.locationId),s=document.createElement("span");s.id=Ae,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),N(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),kc(t.oppId)},ft=null,Kr=null,wt=()=>{ft?.disconnect(),ft=null,Kr=null},kc=t=>{if(ft&&Kr===t)return;wt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kr=t,ft=new MutationObserver(()=>{let o=go();if(!o||o.oppId!==t){wt();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le(),wt();return}document.getElementById(ye)||Yr()}),ft.observe(e,{childList:!0,subtree:!0}))},Wr=null,jr,Ec=()=>{Wr||(Wr=new MutationObserver(()=>{jr===void 0&&(jr=window.setTimeout(()=>{jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ye);if(t&&!e&&!_o){let o=go();if(o&&fo.has(o.oppId))return;Yr()}},300))}),Wr.observe(document.body,{childList:!0,subtree:!0}))},ja=()=>{Ec(),Yr()};var Qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Tc=`${Qr}/tc/welcome-call-prefill`,Sc=`${Qr}/tc/welcome-call-save`,Cc=`${Qr}/tc/order-lockbox`,xt="ws-crm-welcome-call-overlay",Ac=["Regular Contract","Subject To","Seller Finance","Novation"],Ic=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Lc=["Gas","Electric","Propane","Oil"],$c=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Mc=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ge=["Yes","No"],Oc=["Yes","No","Unknown"],Dc=["Professional Photographer","Seller","Tenant"],Hc=["Month-to-Month","Annual"],Ka=["Current","Behind"],Pc=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],pe=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),xo=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Xa="margin-bottom:12px;",Qa=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Bc=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Ya=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),U=(t,e,o)=>{let r=Ya(o);return`<select id="${t}" style="${xo}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Ya(a)===r?"selected":""}>${pe(a)}</option>`).join("")}</select>`},J=(t,e,o="")=>`<input id="${t}" type="text" value="${pe(e)}" placeholder="${pe(o)}" style="${xo}">`,Rc=(t,e)=>`<textarea id="${t}" rows="3" style="${xo}resize:vertical;">${pe(e)}</textarea>`,Fc=(t,e)=>`<input id="${t}" type="date" value="${pe(e)}" style="${xo}">`,O=(t,e)=>`<div style="${Xa}"><label style="${Qa}">${pe(t)}</label>${e}</div>`,Jr=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Pc.map(r=>`<label style="${Bc}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ue=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${pe(t)}</div>`,Ge=()=>{document.getElementById(xt)?.remove()},Ie=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Nc=t=>{let e=t.tenant||{};return`
    ${ue("Identifiers")}
    ...
    ${ue("Contract")}
    ${O("Type of Contract",U("wc-contract_type",Ac,t.contract_type))}

    ${ue("Property")}
    ${O("Property Type",U("wc-property_type",$c,t.property_type))}
    ...
    ${O("Utilities",U("wc-utilities",Ic,t.utilities))}
    ${O("Heat Source",U("wc-heat_source",Lc,t.heat_source))}

    ${ue("Liens & Permits")}
    ${O("Is there a mortgage?",U("wc-has_mortgage",ge,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${O("Mortgage payment status",U("wc-mortgage_payment_status",Ka,t.mortgage_payment_status))}</div>
    ...
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${O("Lease type",U("wc-tenant_lease_type",Hc,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${O("Rent status",U("wc-tenant_rent_status",Ka,e.rent_status))}</div>
        <div style="flex:1;">${O("Last rent paid",Fc("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${O("HOA monthly fee",J("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${O("HOA rental restriction?",U("wc-hoa_rental_restriction",Oc,t.hoa_rental_restriction))}</div>

    ${ue("Photos & Access")}
    ${O("Who is providing photos?",U("wc-photos_provided_by",Dc,t.photos_provided_by))}
    <div style="${Xa}">
      <label style="${Qa}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Jr("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Jr("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Jr("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${wo(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${wo(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${wo(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${wo(t).text}</span>
      </div>
    </div>

    ${ue("Notes")}
    ${O("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",Rc("wc-welcome_call_notes",t.welcome_call_notes))}
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Xr=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Ja=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},wo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?pe(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},zc=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Xr("photos_avail_mornings"),photos_avail_afternoons:Xr("photos_avail_afternoons"),photos_avail_evenings:Xr("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),Gc=t=>{Ge();let e=document.createElement("div");e.id=xt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Nc(t)}</div>
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Jc=t=>{Za(t.oppId,t.locationId)},Xc=async(t,e,o)=>(await fetch(Uc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Qc=(t,e)=>{we();let o=document.createElement("div");o.id=ri,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Zr(e.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Zr(e.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Zr(s)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",b=document.getElementById("wsrl-phone")?.value.trim()||"",m=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!m){fe("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await Xc(t,e,{recipient_name:p,recipient_phone:b,ship_to:m})?(l(),fe("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",fe("Re-order failed \u2014 try again.","err"))}catch(h){c.warn("[action-bar] reorder lockbox failed:",h),d.disabled=!1,d.textContent="Order Lockbox",fe("Couldn't reach the lockbox handler. Try again.","err")}}})},li=async t=>{we();let e={};try{e=await fetch(`${Vc}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Qc(t,e)},Zc=(t,e)=>{we();let o=document.createElement("div");o.id=nn;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${u.sans};
  `,o.innerHTML=`
    <style>#${nn} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){fe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(qc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(we(),fe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",fe("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",fe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(we(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},ep=(t,e)=>{we();let o=document.createElement("div");o.id=oi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(we(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Eo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=V:o.style.cssText=$,o.textContent=t,o},tp=()=>{let t=Eo("\u22EE","ghost");return t.style.lineHeight="1",t},op=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===ai){let r=Eo("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Jc(t)),o.appendChild(r),o}if(e===ln){let r=Eo("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Zc(t,r)),o.appendChild(r),o}if(e===ii){let r=Eo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void li(t)),o.appendChild(r),o}return null},rp=(t,e)=>{let o=[];if(e===ln&&(o=[{label:"Re-order Lockbox",onClick:()=>void li(t)}]),!o.length)return null;let r=document.createElement("span");r.id=ti,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=tp();return a.addEventListener("click",i=>{i.stopPropagation(),ep(o,a)}),r.appendChild(a),r},np=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ap=async()=>{for(let t of np)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},ko=()=>{document.getElementById(rn)?.remove(),document.getElementById(ti)?.remove(),we()},To=!1,dn=async()=>{if(!To){To=!0;try{let t=si();if(!t){ko();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){ko();return}let o=Yc(),r=document.getElementById(rn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=op(t,o);if(!a){ko();return}let i=await ap();if(!i)return;ko();let s=N(i),l=document.createElement("span");l.id=rn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=rp(t,o);d&&s.appendChild(d),ip(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{To=!1}}},kt=null,an=null,en,ei=()=>{kt?.disconnect(),kt=null,an=null},ip=t=>{if(kt&&an===t)return;ei();let e=document.querySelector(ni);e&&(an=t,kt=new MutationObserver(()=>{let o=si();if(!o||o.oppId!==t){ei();return}en===void 0&&(en=window.setTimeout(()=>{en=void 0,dn()},250))}),kt.observe(e,{childList:!0,subtree:!0}))},tn=null,on,sp=()=>{tn||(tn=new MutationObserver(()=>{on===void 0&&(on=window.setTimeout(()=>{on=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!To&&dn()},300))}),tn.observe(document.body,{childList:!0,subtree:!0}))},di=()=>{sp(),dn()};var ci="ws-support-modal",pi="ws-support-toast",lp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",bi="ws-support-submitter-name",hi="ws-support-submitter-email",mi="ws-support-submitter-role",dp=["Bug","Feature Request","Question","Billing","Onboarding Help"],Le=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),cp=(t,e="success",o)=>{let r=document.getElementById(pi);r&&r.remove();let a=document.createElement("div");a.id=pi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},pp=()=>{document.getElementById(ci)?.remove();let t=(localStorage.getItem(bi)??"").trim(),e=(localStorage.getItem(hi)??"").trim(),o=(localStorage.getItem(mi)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=ci,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=De();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(bi,r.submitterName),localStorage.setItem(hi,r.submitterEmail),r.submitterRole&&localStorage.setItem(mi,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(lp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";cp(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},bp=["/support-ticket","ws-support-modal","ws-support"],hp=/\/custom-menu-link\//,cn=!1,ui=()=>{if(cn||!hp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return bp.some(s=>i.includes(s))});if(r){cn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{pp(),cn=!1},50);return}t<10&&setTimeout(e,150)};e()},vi=!1,_i=()=>{vi||(vi=!0,Ft(()=>setTimeout(ui,50)),ui(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var mp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",up="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",vp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",fi="tc_closing_agent",_p="tc_closing_office",de="ws-crm-closing-agent-picker-button",wi="ws-crm-closing-agent-picker-modal",yp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gp=/\/v2\/location\/([A-Za-z0-9]+)/,St=()=>{let t=window.location.pathname,e=t.match(yp);if(!e)return null;let o=t.match(gp);return{oppId:e[1],locationId:o?o[1]:null}},yn=async t=>{let e=await fetch(mp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},yi=async t=>{let e=await fetch(up,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},fp=async(t,e)=>{try{let o=await fetch(vp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:fi}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await yn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},$e=null,wp=60*60*1e3,gn=t=>`ws-crm-to-cache:${t}`,xi=t=>{try{let e=window.localStorage.getItem(gn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>wp||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},ki=(t,e,o)=>{try{window.localStorage.setItem(gn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},xp=t=>{try{window.localStorage.removeItem(gn(t))}catch{}},mn="ws-crm-closing-agent-field-link",kp=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${mn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},pn=!1,fn=async t=>{if(pn)return;let e=Ei();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){pn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await yn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),un(a.id,a.name,t);let i=document.getElementById(de);if(i){xe(i,{status:"linked",contactName:a.name});let s=St();s&&ki(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{pn=!1}}},Ep=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ei=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();Ep.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},un=(t,e,o)=>{let r=Ei();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${mn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=mn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},So=()=>{document.getElementById(wi)?.remove()},Tp=t=>{So();let e=document.createElement("div");e.id=wi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&So()}),i?.addEventListener("click",So);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await yn({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};xe(o,r);let a=xi(t);return a&&(r={status:"linked",contactName:a.contactName},xe(o,r),$e={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await fp(t,e);s?(r={status:"linked",contactName:s.name},xe(o,r),$e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},un(s.id,s.name,e)):a||(r={status:"empty"},xe(o,r),$e?.oppId===t&&($e=null),kp(),xp(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Tp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},xe(o,r);try{let l=[yi({tenantId:e,oppId:t,fieldKey:fi,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(yi({tenantId:e,oppId:t,fieldKey:_p,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},xe(o,r),$e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},ki(t,s.id,s.name),un(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},xe(o,r)}}})}),o},Cp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ap=async()=>{for(let t of Cp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Et=!1,Io=async()=>{if(!Et){Et=!0;try{await Ip()}finally{Et=!1}}},Ip=async()=>{let t=St();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Ao();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),Ao());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Ap();if(!r||!(xi(t.oppId)!==null||$e!==null&&$e.oppId===t.oppId)&&await q()!=="Transaction Coordination")return;let i=St();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Sp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${de}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),N(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Lp(t.oppId),fn(i.locationId)},Tt=null,vn=null,_n=null,Ao=()=>{Tt?.disconnect(),Tt=null,vn=null,_n=null},Lp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Tt&&vn===t&&_n===e||(Ao(),vn=t,_n=e,Tt=new MutationObserver(()=>{let o=St();if(!o||o.oppId!==t||!o.locationId){Ao();return}document.getElementById(de)||Io(),fn(o.locationId)}),Tt.observe(e,{childList:!0,subtree:!0})))},bn=null,hn,$p=()=>{bn||(bn=new MutationObserver(()=>{hn===void 0&&(hn=window.setTimeout(()=>{hn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!Et&&Io()},300))}),bn.observe(document.body,{childList:!0,subtree:!0}))},gi,Mp=()=>{gi===void 0&&(gi=window.setInterval(()=>{let t=St();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(de)&&!Et&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Io()),fn(t.locationId)},2e3))},Ti=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),$p(),Mp(),Io()};var Op="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ee="ws-crm-manage-team-cta",Si="ws-crm-manage-team-modal",Dp=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ci={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Hp={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ai=()=>{let t=window.location.pathname.match(Dp);return t?{tenantId:t[1]}:null},$o=async t=>{let e=await fetch(Op,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},re=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ke=t=>re(t),wn="ws-crm-manage-team-toast",En=(t,e="info",o=4e3)=>{document.getElementById(wn)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=wn,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(wn)===a&&a.remove()},o)},xn=()=>{document.getElementById(Si)?.remove()},Pp=(t,e)=>{let o=Hp[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${re(e)}</span>
  `},Bp=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Pp(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>Bp(r,e)).join(""),Mo=async t=>{xn();let e=document.createElement("div");e.id=Si,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&xn()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",xn);let r;try{r=await $o({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Rp(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Fp(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;Np(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;zp(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Fp=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${re(Ci[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await $o({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:M()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),En(`Removed ${e.name} from the team.`,"success"),await Mo(t)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},Gp=89,qp=93,Up=310,Vp=34,Wp=14,jp=14,Kp=3,Lo=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+Gp;t.style.right=`${Math.max(r,16)}px`},Yp=t=>{let e=document.createElement("button");return e.id=Ee,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${qp}px;
    right: 24px;
    width: ${Up}px;
  ...
  `,e.addEventListener("click",()=>{Mo(t)}),Lo(e),setTimeout(()=>Lo(e),200),setTimeout(()=>Lo(e),800),window.addEventListener("resize",()=>Lo(e)),e},kn=!1,Jp=()=>{if(!kn){kn=!0;try{let t=Ai();if(!t){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}let e=document.getElementById(Ee);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ee}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ee}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Yp(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{kn=!1}}},Ii=()=>{if(!Ai()){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}Jp()};var Xp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Cn="ws-crm-prepare-contract-button",Li="ws-crm-prepare-contract-menu",he="ws-crm-prepare-contract-modal",$i="ws-crm-modal-date-style",ve="https://services.leadconnectorhq.com",Bi=()=>{if(document.getElementById($i))return;let t=document.createElement("style");t.id=$i,t.textContent=`
  ...
  `,document.head.appendChild(t)},An="__WS_CRM_CAPTURED_AUTH",Qp=50*60*1e3,Po=()=>{try{let t=localStorage.getItem(An);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Qp?(localStorage.removeItem(An),null):e:null}catch{return null}},Zp=t=>{try{localStorage.setItem(An,JSON.stringify(t))}catch{}},Ue=()=>{let t=Po(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Mi=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Po()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),qe=async(t,e={},o=2)=>{let r=Po()?.capturedAt??0,a;try{a={...Ue(),...e.headers??{}}}catch(s){if(o>0&&await Mi(r,4e3))return qe(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await Mi(r,4e3)?qe(t,e,o-1):i},Oi=!1,eb=()=>{if(Oi)return;Oi=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Po()?.authorization;Zp({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Ri=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},tb=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Ri()},ob=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Fi="__WS_CRM_TEMPLATES_CACHE_V1",rb=24*60*60*1e3,Di=t=>{try{let e=window.localStorage.getItem(Fi);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>rb?null:o.templates}catch{return null}},nb=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Fi,JSON.stringify(o))}catch{}},ab=async t=>{let e=`${ve}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await qe(e,{method:"GET"})}catch(s){let l=Di(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Di(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:ob(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&nb(t,i),i},ib=async(t,e)=>{let o=await qe(`${ve}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await qe(`${ve}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},sb=async(t,e)=>{let o=await qe(`${ve}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ve}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ue()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},lb=async t=>{let e=await fetch(Xp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},db=async(t,e,o)=>{let r=`${ve}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ue()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},cb=async(t,e)=>{let o=await fetch(`${ve}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ue()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},pb=async t=>{let e=await fetch(`${ve}/contacts/${t}`,{method:"GET",headers:Ue()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},bb=async(t,e,o,r)=>{let a;try{a=await cb(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await pb(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ve}/proposals/document/${e}`,{method:"PUT",headers:{...Ue(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},hb=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Do="__WS_CRM_PENDING_INSTRUCTIONS",mb=60*1e3,ub=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],vb=t=>{let e=(t||"").toLowerCase();for(let o of ub)if(e.includes(o.matches.toLowerCase()))return o;return null},_b=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Do,JSON.stringify(r))}catch{}},yb=()=>{try{let t=localStorage.getItem(Do);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>mb?(localStorage.removeItem(Do),null):e}catch{return null}},gb=()=>{try{localStorage.removeItem(Do)}catch{}},fb=(t,e)=>{document.getElementById(he)?.remove();let o=document.createElement("div");o.id=he,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},wb=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,xb=()=>{let t=window.location.pathname.match(wb);if(!t)return;let e=t[1],o=yb();o&&o.proposalId===e&&(gb(),window.setTimeout(()=>{fb(o.title,o.bodyHtml)},600))},Hi="ws-crm-prepare-contract-toast",W=(t,e="info",o=4e3)=>{document.getElementById(Hi)?.remove();let r=document.createElement("div");r.id=Hi;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Pi=(t,e)=>new Promise(o=>{document.getElementById(he)?.remove();let r=document.createElement("div");r.id=he,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,w.appendChild(y),document.body.appendChild(w);let z=y.querySelector("#ws-pc-purchase-price"),ee=y.querySelector("#ws-pc-emd"),X=y.querySelector("#ws-pc-cash-at-close"),F=!1;X?.addEventListener("input",()=>{F=!0});let Ve=()=>{if(F)return;let G=Number(z?.value||0),j=Number(ee?.value||0);X&&(X.value=String(Math.max(0,G-j)))};z?.addEventListener("input",Ve),ee?.addEventListener("input",Ve);let Ht=()=>w.remove();w.addEventListener("click",G=>{G.target===w&&Ht()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Ht);let te=y.querySelector("#ws-pc-submit"),Z=y.querySelector("#ws-pc-error");te?.addEventListener("click",async()=>{if(te){Z&&(Z.textContent=""),te.disabled=!0,te.textContent="Opening\u2026";try{let G=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),j=Number(z?.value||0),We=Number(ee?.value||0),je=Number(X?.value||0),Ke=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Je=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Oe=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Xe=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),K={};if(G!==s&&(K.sellerName=G),j!==l&&(K.purchasePrice=j),We!==d&&(K.emd=We),je!==p&&(K.cashAtClose=je),Ke!==b&&(K.daysToClose=Ke),Ye!==m&&(K.inspectionDays=Ye),Je!==h&&(K.additionalTerms=Je),Oe!==_&&(K.currentOccupancy=Oe),Xe!==x&&(K.occupancyAtClose=Xe),Object.keys(K).length>0){c.info("[prepare-contract] PA modal submit with overrides:",K),te.textContent="Saving\u2026";let Uo=M(),Vo=await Ho({tenantId:t,contactId:e,template:o,userId:Uo,overrides:K});c.info("[prepare-contract] re-stage with overrides ok:",Vo),te.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Y=i?`${i} - Purchase Agreement`:void 0;await $n(t,e,o,Y)}catch(G){te.disabled=!1,te.textContent="Open Contract",Z&&(Z.textContent=G.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",G)}}})},Eb=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(he)?.remove(),Bi();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,C="",A=document.createElement("div");A.id=he,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(k),document.body.appendChild(A);let X=k.querySelector("#ws-pc-assignment-price"),F=k.querySelector("#ws-pc-assignment-fee"),Ve=!1;F?.addEventListener("input",()=>{Ve=!0});let Ht=()=>{if(Ve)return;let j=Number(X?.value||0);F&&(F.value=String(Math.max(0,j-x)))};X?.addEventListener("input",Ht);let te=()=>A.remove();A.addEventListener("click",j=>{j.target===A&&te()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",te);let Z=k.querySelector("#ws-pc-submit"),G=k.querySelector("#ws-pc-error");Z?.addEventListener("click",async()=>{if(!Z)return;G&&(G.textContent="");let j=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),We=Number(X?.value||0),je=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),Ke=Number(F?.value||0),Ye=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Je=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Oe=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Xe=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),K=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Oe){G&&(G.textContent="Closing Date is required.");return}Z.disabled=!0,Z.textContent="Opening\u2026";try{let Y={};j!==b&&(Y.sellerName=j),We!==m&&(Y.assignmentPrice=We),je!==h&&(Y.buyerEMD=je),Ke!==_&&(Y.assignmentFee=Ke),Ye!==E&&(Y.closingOffice=Ye),Je!==w&&(Y.buyerCompanyName=Je);let Uo=Oe!==y||Xe!==f||K!==C,Vo=Object.keys(Y).length>0||Uo,Wo=a;Vo?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Y),Z.textContent="Saving\u2026",Wo=await Ho({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Oe,buyerEarnestDueDate:Xe,lenderSource:K,userId:i,overrides:Object.keys(Y).length>0?Y:void 0}),c.info("[prepare-contract] AA re-stage ok:",Wo),Z.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Bn=Wo?.debug?.propertyAddress||p,ds=Bn?`${Bn} - Assignment Agreement`:void 0;await $n(t,e,o,ds),te()}catch(Y){Z.disabled=!1,Z.textContent="Open Contract",G&&(G.textContent=Y.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Y)}})},Ho=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await lb({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},$n=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await db(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await bb(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),W(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=vb(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),_b(a,s.title,s.bodyHtml)),hb(t,a)},Tb=async t=>{let e=tb(t);if(!e){W("Could not resolve contact context.","error");return}document.getElementById(Li)?.remove();let o=document.createElement("div");o.id=Li,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=M();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await sb(e.tenantId,e.contactId)}catch(f){W(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){W("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await Pi(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){c.info("[prepare-contract] MT opp picker cancelled");return}b=f,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),C=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${C}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);W("Reading contract data\u2026","info",2500);let E;try{E=await Ho({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(y){W(`Failed to prepare contract: ${y.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){W("Could not resolve buyer contact for this opp.","error",6e3);return}Eb({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){W("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await ib(e.tenantId,e.contactId)}catch(_){W(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){W("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await Pi(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}W("Reading contract data\u2026","info",2500);let h;try{h=await Ho({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){W(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}kb({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){W("This template needs to be started from a contact page.","error",6e3);return}W(`Opening ${i.name}\u2026`,"info",2500);try{await $n(e.tenantId,e.contactId,i)}catch(b){W(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),W(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Ni=()=>{let t=document.createElement("button");return t.id=Cn,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Tb(t)}),t},Sb="ws-crm-contact-actions-bar",Cb=async()=>{let t=Ri();if(!t){document.getElementById(Cn)?.remove();return}let e=null;try{e=await L(`#${Sb}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Cn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Ni();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Me="ws-crm-prepare-contract-button-opp",Ct=`${Me}-wrap`,Ab=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ib=/\/v2\/location\/([A-Za-z0-9]+)/,Lb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],In=()=>{let t=window.location.pathname,e=t.match(Ab);if(!e)return null;let o=t.match(Ib);return o?{oppId:e[1],tenantId:o[1]}:null},$b=async()=>{for(let t of Lb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Oo=!1,At=null,Ln=null,Tn=null,Sn,It=()=>{At?.disconnect(),At=null,Ln=null},Mb=t=>{if(At&&Ln===t)return;It();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ln=t,At=new MutationObserver(()=>{let o=In();if(!o||o.oppId!==t){It();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Me)?.remove(),document.getElementById(Ct)?.remove(),It();return}document.getElementById(Me)||zi()}),At.observe(e,{childList:!0,subtree:!0}))},Ob=()=>{Tn||(Tn=new MutationObserver(()=>{Sn===void 0&&(Sn=window.setTimeout(()=>{Sn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Me);t&&!e&&!Oo&&zi()},300))}),Tn.observe(document.body,{childList:!0,subtree:!0}))},zi=async()=>{if(!Oo){Oo=!0;try{let t=In();if(!t){document.getElementById(Me)?.remove(),document.getElementById(Ct)?.remove(),It();return}let e=document.getElementById(Me);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Ct)?.remove(),It());return}e&&(e.remove(),document.getElementById(Ct)?.remove());let o=await $b();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await q();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=In();if(!a||a.oppId!==t.oppId)return;let i=Ni();i.id=Me,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Ct,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Mb(t.oppId)}finally{Oo=!1}}},Gi=()=>{xb(),Cb()};eb();function Q(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function be(t){return Q(t)}var Ot="reos-theme-stylesheet",Hn="reos-theme-fonts",Dt=!1,Db=()=>{let t=document.getElementById(Hn);t&&t.remove()},Hb=`
/* ============================================
...
/* No vertical grid lines \u2014 Tabulator gives data cells + header columns a 1px
   right border (and the theme recolors it steel), drawing column separators.
   Strip the left/right borders; the horizontal row separators (the row/cell/
   header border-bottom) stay. Tim's preference: 1px horizontal lines only. */
html body .tabulator-cell:not(#__reos_never_id),
html body .tabulator-col:not(#__reos_never_id) {
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var D=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},ls=()=>{c.info(`Loaded v${Nt} (built ${zt})`),jo()?c.info(`[main] excluded location ${De()} \u2014 skipping initial mounts, tracking nav only`):(D("mountVersionBadge (initial)",qo),D("mountFavicon",ma),D("mountThemeStylesheet",Pn),D("mountHideLaunchpad",zr),D("mountHideNavItems",Gr),D("mountRelabelNav",qr),D("mountHideTopmenuTabs",Vr),D("mountContractsSection",Ur)),D("initPageRouter",Nn),c.info("[main] registering onPageChange subscriber"),Ft(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),jo()){c.info(`[main] page change into excluded location ${De()} \u2014 tearing down theme`),D("unmountThemeStylesheet",is);return}D("mountThemeStylesheet",Pn),D("mountVersionBadge",qo),D("mountHideLaunchpad",zr),D("mountHideNavItems",Gr),D("mountRelabelNav",qr),D("mountHideTopmenuTabs",Vr),D("mountContractsSection",Ur),D("mountClaimReleaseToggle",ra),D("mountContactActionsBar",ba),D("mountActiveFollowUpButton",jn),D("mountMtOfferMadeButton",_a),D("mountNotInterestedButton",ya),D("mountScheduleWalkthroughButton",ga),D("mountResendDealLinkButton",wa),D("mountReducePriceButton",ka),D("mountEditLandingPageButton",Ea),D("mountPublishButton",Ca),D("mountContactMapLinks",Oa),D("mountSendToClosingOfficeButton",ja),D("mountOppActionBar",di),D("mountClosingAgentPickerButton",Ti),D("mountPrepareContractButton",Gi),D("mountManageTeam",Ii),D("mountBuyBoxWidget",Zn),D("mountSupportNavItem",_i)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ls):ls();})();
