/* Wholesaling CRM Customizer v0.14.21 — built 2026-05-30T13:49:00.728Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ie="[wholesaling-crm-customizer]",Lr="__WS_CRM_DEBUG",Mr=()=>!!window[Lr],b={info(...t){console.log(Ie,...t)},warn(...t){console.warn(Ie,...t)},error(...t){console.error(Ie,...t)},debug(...t){Mr()&&console.log(Ie,"[debug]",...t)}};var io=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ct=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=t=>{let e=t.match(io);if(!e)return null;let o=t.match(ct);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Fr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(io);if(!n)continue;let i=r.match(ct)||window.location.pathname.match(ct);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},S=()=>{let t=Dr(window.location.pathname);return t||Fr()};var lo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Me="",bt=null,ne="other",ht=new Set,Le=()=>{let t=S()?.contactId??null;if(!(!(window.location.pathname!==Me)&&!(t!==bt))){Me=window.location.pathname,bt=t,ne=lo(),b.debug("Page/context changed:",ne,Me,"contact:",t);for(let r of ht)try{r(ne)}catch(n){b.error("Subscriber threw:",n)}}},co=t=>(ht.add(t),setTimeout(()=>t(ne),0),()=>{ht.delete(t)}),bo=()=>{ne=lo(),Me=window.location.pathname,bt=S()?.contactId??null,b.debug("Router init, current page:",ne);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Le()},history.replaceState=function(o,r,n){e(o,r,n),Le()},window.addEventListener("popstate",Le),setInterval(Le,1e3)};var De="0.14.21",Fe="2026-05-30T13:49:00.730Z";var C=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,a)=>{let l=n.querySelector(t);if(l){i(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),i(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),i(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),a(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},pt={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},ho=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,L=`
  ...
  flex-shrink: 0;
`;var $r=/^[A-Za-z0-9]{15,30}$/,de=t=>typeof t=="string"&&$r.test(t),Pr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Or=()=>{let t=window.WS_CRM_USER_ID;return de(t)?t:null},Hr=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(de(o))return o;return null},Nr=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Pr(e);if(!o)return null;let r=o.uid;if(de(r))return r;let n=o.claims;if(n&&de(n.user_id))return n.user_id}catch{}return null},Br=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(de(n))return n}catch{}}}catch{}return null},A=()=>Or()||Hr()||Nr()||Br()||null;var _o="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Rr=`${_o}/active-follow-up-get`,Gr=`${_o}/active-follow-up-set`,J="ws-crm-active-follow-up-button",ut={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},zr=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},qr=async t=>{let e=await fetch(Rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ur=async(t,e)=>{let o=await fetch(Gr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Z=(t,e)=>{let o=ut[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},po=t=>{let e=document.createElement("button");return e.type="button",e.id=J,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Z(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=zr();if(!(!r||r.contactId!==t)){Z(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Ur(r,A()),i=n&&n.state&&n.state in ut?n.state:"blue";Z(e,i),b.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),Z(e,"error"),setTimeout(()=>void $e(e,r),4e3)}}}),e},$e=async(t,e)=>{Z(t,"loading");try{let o=await qr(e),r=o&&o.state&&o.state in ut?o.state:"gray",n=document.getElementById(J);if(!n||n.dataset.contactId!==e.contactId)return;Z(n,r)}catch(o){b.warn("Active Follow Up Get webhook failed",o),Z(t,"error")}},Vr=[".central-panel","[class*='central-panel']"],mt="ws-crm-contact-actions-bar",Wr=async()=>{for(let t of Vr)try{let e=await C(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},jr=async(t,e)=>{let o=e.querySelector(`#${mt}`);if(!o)try{o=await C(`#${mt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${mt}`);i&&i.parentElement===e?e.insertBefore(n,i.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},Kr=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},Yr=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Xr=async t=>{if(t==="url"){let o=await Wr();return o?{kind:"contact-detail",target:o}:null}let e=Kr();return e?{kind:"conversations",target:e}:null},mo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await jr(t,e.target);return o}return Yr(t,e.target),"conversations-header"},Jr=async()=>{let t=S();if(!t||!t.locationId){document.getElementById(J)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(J);if(o&&o.dataset.contactId===e.contactId){$e(o,e);return}o&&o.remove();let r=await Xr(t.source);if(!r){b.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let i=po(e.contactId),a=await mo(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${a}) for ${e.contactId}`),uo();let l=document.getElementById(J)??i;$e(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(J);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=po(e.contactId);mo(m,r).then(()=>{uo(),$e(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},ce=null,vo=()=>{let t=S()?.contactId??null;if(ce&&ce.contactId===t)return;let e=Jr().finally(()=>{ce?.promise===e&&(ce=null)});ce={contactId:t,promise:e}},uo=()=>{let t=document.querySelectorAll(`#${J}`);if(!(t.length<=1)){b.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var j="ws-crm-claim-release-pill",Zr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",en=async t=>{let e=await fetch(Zr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},tn=async t=>{let e=await fetch(Qr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},fo=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ae=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;t.dataset.mode=e,t.style.cssText=ho(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},on=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=j,o.type="button",o.dataset.contactId=t,ae(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==t)return;let i=A();if(!i){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>ae(o,r),2500);return}b.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let a=r==="claim"?"release":"claim";ae(o,a),o.disabled=!0,o.style.opacity="0.8";try{let l=await tn({contactId:t,locationId:n.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:a;ae(o,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),ae(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},yo=async(t,e)=>{try{let o=await en({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(j);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";ae(r,n)}catch(o){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},rn=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=fo(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},go=(t,e)=>{let o=on({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${j}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},nn=async()=>{let t=S();if(!t){document.getElementById(j)?.remove();return}let e=document.getElementById(j);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await C("#record-details-lhs",{timeoutMs:1e4}),r=await rn(o),n=S();if(!n||n.contactId!==t.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}go(r,t.contactId),b.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(j);i&&t.locationId&&yo(i,{contactId:t.contactId,locationId:t.locationId});let a=null;a=new MutationObserver(async()=>{if(!(S()?.contactId===t.contactId)){a?.disconnect();return}if(document.getElementById(j))return;let d=fo(o);if(d){go(d,t.contactId);let c=document.getElementById(j);c&&t.locationId&&yo(c,{contactId:t.contactId,locationId:t.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),a.observe(o,{childList:!0,subtree:!0})}catch(o){b.warn("Could not mount Claim/Release pill:",o)}}},wo=()=>{nn()};var an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",be=new Map,xo=async(t,e)=>{if(!t)return null;if(be.has(t))return be.get(t)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${an}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return b.warn(`Contact Type fetch returned ${i.status} for ${t}`),be.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return be.set(t,l),b.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${t}:`,n),be.set(t,null),null}};var ko=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Io="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",dn=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:i,kind:a})=>{let l=i||Io,d;if(a==="buyer"){let h=Lo.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},cn=async({contactId:t,tenantId:e})=>{let o=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var se="ws-crm-contact-actions-bar",bn="ws-crm-call-status-dropdown",Eo="ws-crm-offer-made-modal",hn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Lo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],pn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],mn=async()=>{for(let t of pn)try{let e=await C(t,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await C("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(t,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},un=({contactId:t,kind:e})=>{let o=e==="buyer"?Lo:hn,r=e==="buyer"?sn:Io,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=bn,i.style.cssText="position: relative; flex-shrink: 0;";let a=document.createElement("button");a.type="button",a.style.cssText=L,a.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),i=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let a=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",a),i())};document.addEventListener("keydown",a)},Co=(t,e)=>{let o=document.createElement("div");if(o.id=se,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=q,r.textContent="Offer Made",r.addEventListener("click",()=>yn(t,e)),o.appendChild(r),o.appendChild(un({contactId:t,kind:e}))}return o},_t=!1,wn=()=>{document.querySelectorAll(`[id="${se}"]`).forEach(t=>t.remove())},Mo=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),_t){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}_t=!0;try{await xn()}finally{_t=!1}},xn=async()=>{let t=S();if(!t){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),wn();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await xo(t.contactId,t.locationId),h=ko(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=S();if(!o||o.contactId!==t.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${se}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await mn();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let i=S();if(!i||i.contactId!==t.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let a;try{a=Co(t.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}a.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(a,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(se)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${se}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Co(t.contactId,e);p.dataset.mountTarget=a.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},Ao=null,kn=()=>{Ao===null&&(Ao=window.setInterval(()=>{let t=S();t&&(document.getElementById(se)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Mo()))},3e3))},Do=()=>{kn(),Mo()};var Pe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",En=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),he="data-ws-crm-favicon",vt=t=>t.hasAttribute(he),Fo=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return En.has(e)},Oe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Fo(r)&&!vt(r)&&r.remove()});let e=document.head.querySelector(`link[${he}="1"]`);e?e.href!==Pe&&(e.href=Pe):(e=document.createElement("link"),e.setAttribute(he,"1"),e.rel="icon",e.type="image/png",e.href=Pe,document.head.appendChild(e),b.debug("Favicon installed"));let o=document.head.querySelector(`link[${he}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(he,"apple"),o.rel="apple-touch-icon",o.href=Pe,document.head.appendChild(o))},$o=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Oe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Oe())},50)}new MutationObserver(r=>{let n=!1;for(let i of r)i.addedNodes.forEach(a=>{a instanceof HTMLLinkElement&&Fo(a)&&!vt(a)&&(n=!0)}),i.removedNodes.forEach(a=>{a instanceof HTMLLinkElement&&vt(a)&&(n=!0)});n&&Oe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Oe(),e>=5&&window.clearInterval(o)},1e3)};var Tn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Sn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Cn=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(Cn);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(Sn);if(n){let i=n[1];if(Tn.includes(i))return i}}return null},K=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",O="ws-crm-mt-offer-made-button",Po="ws-crm-mt-offer-made-modal",In=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ln=/\/v2\/location\/([A-Za-z0-9]+)/,Be=()=>{let t=window.location.pathname,e=t.match(In);if(!e)return null;let o=t.match(Ln);return{oppId:e[1],locationId:o?o[1]:null}},Mn=async t=>{let e=await fetch(An,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},He=()=>{document.getElementById(Po)?.remove()},Dn=t=>{He();let e=document.createElement("div");e.id=Po,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Be();!o||!o.locationId||o.oppId!==t||Dn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},$n=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pn=async()=>{for(let t of $n)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ne=!1,wt=async()=>{if(!Ne){Ne=!0;try{await On()}finally{Ne=!1}}},On=async()=>{let t=Be();if(!t||!t.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),me();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),me());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let o=await Pn();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await K();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Be();if(!n||n.oppId!==t.oppId)return;let i=Fn(t.oppId),a=document.createElement("span");a.id=`${O}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Hn(t.oppId)},pe=null,ft=null,me=()=>{pe?.disconnect(),pe=null,ft=null},Hn=t=>{if(pe&&ft===t)return;me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ft=t,pe=new MutationObserver(()=>{let o=Be();if(!o||o.oppId!==t){me();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),me();return}document.getElementById(O)||wt()}),pe.observe(e,{childList:!0,subtree:!0}))},yt=null,gt,Nn=()=>{yt||(yt=new MutationObserver(()=>{gt===void 0&&(gt=window.setTimeout(()=>{gt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);t&&!e&&!Ne&&wt()},300))}),yt.observe(document.body,{childList:!0,subtree:!0}))},Oo=()=>{Nn(),wt()};var Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",H="ws-crm-not-interested-button",Rn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gn=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let t=window.location.pathname,e=t.match(Rn);if(!e)return null;let o=t.match(Gn);return{oppId:e[1],locationId:o?o[1]:null}},zn=async t=>{let e=await fetch(Bn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},qn=t=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Ge();if(!o||!o.locationId||o.oppId!==t)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await zn({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Un=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vn=async()=>{for(let t of Un)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Re=!1,Tt=async()=>{if(!Re){Re=!0;try{await Wn()}finally{Re=!1}}},Wn=async()=>{let t=Ge();if(!t||!t.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),_e();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),_e());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let o=await Vn();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await K();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ge();if(!n||n.oppId!==t.oppId)return;let i=qn(t.oppId),a=document.createElement("span");a.id=`${H}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),jn(t.oppId)},ue=null,Et=null,_e=()=>{ue?.disconnect(),ue=null,Et=null},jn=t=>{if(ue&&Et===t)return;_e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Et=t,ue=new MutationObserver(()=>{let o=Ge();if(!o||o.oppId!==t){_e();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),_e();return}document.getElementById(H)||Tt()}),ue.observe(e,{childList:!0,subtree:!0}))},xt=null,kt,Kn=()=>{xt||(xt=new MutationObserver(()=>{kt===void 0&&(kt=window.setTimeout(()=>{kt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);t&&!e&&!Re&&Tt()},300))}),xt.observe(document.body,{childList:!0,subtree:!0}))},Ho=()=>{Kn(),Tt()};var Yn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",N="ws-crm-reduce-price-button",No="ws-crm-reduce-price-modal",Xn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jn=/\/v2\/location\/([A-Za-z0-9]+)/,Ue=()=>{let t=window.location.pathname,e=t.match(Xn);if(!e)return null;let o=t.match(Jn);return{oppId:e[1],locationId:o?o[1]:null}},Zn=async t=>{let e=await fetch(Yn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ze=()=>{document.getElementById(No)?.remove()},Qn=t=>{ze();let e=document.createElement("div");e.id=No,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ue();!r||!r.locationId||r.oppId!==t||Qn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,i&&(i.style.background=s.emerald,i.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=L,i&&(i.style.background=s.amber,i.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},ta=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],oa=async()=>{for(let t of ta)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qe=!1,It=async()=>{if(!qe){qe=!0;try{await ra()}finally{qe=!1}}},ra=async()=>{let t=Ue();if(!t||!t.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ye();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),ye());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let o=await oa();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await K();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Ue();if(!n||n.oppId!==t.oppId)return;let i=ea(t.oppId,t.locationId),a=document.createElement("span");a.id=`${N}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),na(t.oppId)},ve=null,At=null,ye=()=>{ve?.disconnect(),ve=null,At=null},na=t=>{if(ve&&At===t)return;ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(At=t,ve=new MutationObserver(()=>{let o=Ue();if(!o||o.oppId!==t){ye();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ye();return}document.getElementById(N)||It()}),ve.observe(e,{childList:!0,subtree:!0}))},St=null,Ct,aa=()=>{St||(St=new MutationObserver(()=>{Ct===void 0&&(Ct=window.setTimeout(()=>{Ct=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);t&&!e&&!qe&&It()},300))}),St.observe(document.body,{childList:!0,subtree:!0}))},Bo=()=>{aa(),It()};var zo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Y="ws-crm-send-to-closing-office-button",Q="ws-crm-send-to-title-co-wrap",je="ws-crm-stc-dropdown",sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ia=/\/v2\/location\/([A-Za-z0-9]+)/,Ke=()=>{let t=window.location.pathname,e=t.match(sa);if(!e)return null;let o=t.match(ia);return{oppId:e[1],locationId:o?o[1]:null}},la=5*60*1e3,qo=t=>`ws-crm-stc-cache:${t}`,da=t=>{try{let e=window.localStorage.getItem(qo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>la||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},ca=(t,e)=>{try{window.localStorage.setItem(qo(t),JSON.stringify(e))}catch{}},ba=async(t,e)=>{try{let o=await fetch(zo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},ha=async(t,e,o)=>{let r=await fetch(zo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},pa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},Ro=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ma=(t,e)=>{if(e&&pa(e)){window.setTimeout(()=>Ro(t),300);return}Ro(t)},B=()=>{document.getElementById(je)?.remove()},Ve=(t,e,o)=>{B();let r=document.createElement("div");r.id=je;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,z(o,n);let i=new Set,a=async()=>{if(n.status==="sending")return;let g=await ba(t,e);if(!g){n={status:"error",message:"Check failed \u2014 click to retry"},z(o,n);return}if(g.rate_limited){u=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},z(o,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){n={status:"error",message:g.error||"Check failed \u2014 click to retry"},z(o,n),b.warn("[stc] dry_run returned no checks:",g);return}let _=g.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button + caching`),Ye.add(t),document.getElementById(Y)?.remove(),document.getElementById(Q)?.remove(),B(),fe();return}let f=g.checks;if(n.checks&&n.checks.length===g.checks.length){let T=new Set;f=g.checks.map((k,I)=>n.checks[I]?.filled&&!k.filled?i.has(k.label)?k:(T.add(k.label),{...k,filled:!0}):k),i=T}else i=new Set;n={status:f.every(T=>T.filled)?"ready":"incomplete",checks:f,previouslySentAt:g.previously_sent_at??null},ca(t,{checks:f,previously_sent_at:g.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),z(o,n),document.getElementById(je)&&Ve(f,g.previously_sent_at,o)},l=async()=>{let g=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},z(o,n),B();try{let _=await ha(t,e,g);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},z(o,n),_.checks&&Ve(_.checks,_.previously_sent_at,o);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},z(o,n),window.setTimeout(()=>{y()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},z(o,n),_.checks&&Ve(_.checks,_.previously_sent_at,o)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},z(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(je)?B():n.checks&&Ve(n.checks,n.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,u=0,y=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await a()}finally{c=!1}}};y();let w=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(w){let g=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-h,E=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&y()},E)});g.observe(w,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return o},_a=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],va=async()=>{for(let t of _a)try{let e=await C(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ye=new Set,Go=null,ya=t=>{t&&t!==Go&&(Ye.clear(),Go=t)},We=!1,Ft=async()=>{if(We){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}We=!0;try{await ga()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{We=!1}},ga=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=Ke();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Y)?.remove(),document.getElementById(Q)?.remove(),B();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),ya(t.oppId),Ye.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Y)?.remove(),document.getElementById(Q)?.remove(),B();return}let e=document.getElementById(Y);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Q)?.remove(),B(),fe());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Q)?.remove(),B()),b.debug("[stc] mount:04 calling findMountTarget");let o=await va();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Ke();if(!n||n.oppId!==t.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=ua(t.oppId,n.locationId),a=document.createElement("span");a.id=Q,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),fa(t.oppId)},ge=null,Dt=null,fe=()=>{ge?.disconnect(),ge=null,Dt=null},fa=t=>{if(ge&&Dt===t)return;fe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dt=t,ge=new MutationObserver(()=>{let o=Ke();if(!o||o.oppId!==t){fe();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Y)?.remove(),document.getElementById(Q)?.remove(),B(),fe();return}document.getElementById(Y)||Ft()}),ge.observe(e,{childList:!0,subtree:!0}))},Lt=null,Mt,wa=()=>{Lt||(Lt=new MutationObserver(()=>{Mt===void 0&&(Mt=window.setTimeout(()=>{Mt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Y);if(t&&!e&&!We){let o=Ke();if(o&&Ye.has(o.oppId))return;Ft()}},300))}),Lt.observe(document.body,{childList:!0,subtree:!0}))},Uo=()=>{wa(),Ft()};var xa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",jo="ldtyB2UXKi9vOp8nLUH7",Ta="WVD2gb9swLsgcdBEtDVq",R="ws-crm-closing-agent-picker-button",Ko="ws-crm-closing-agent-picker-modal",Sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ca=/\/v2\/location\/([A-Za-z0-9]+)/,ke=()=>{let t=window.location.pathname,e=t.match(Sa);if(!e)return null;let o=t.match(Ca);return{oppId:e[1],locationId:o?o[1]:null}},Gt=async t=>{let e=await fetch(xa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Vo=async t=>{let e=await fetch(ka,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Aa=async(t,e)=>{try{let o=await fetch(Ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:jo}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await Gt({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let a=i.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},ee=null,Ia=60*60*1e3,zt=t=>`ws-crm-to-cache:${t}`,Yo=t=>{try{let e=window.localStorage.getItem(zt(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ia||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Xo=(t,e,o)=>{try{window.localStorage.setItem(zt(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},La=t=>{try{window.localStorage.removeItem(zt(t))}catch{}},Ht="ws-crm-closing-agent-field-link",Ma=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ht}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},$t=!1,qt=async t=>{if($t)return;let e=Jo();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){$t=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Gt({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Nt(n.id,n.name,t);let i=document.getElementById(R);if(i){X(i,{status:"linked",contactName:n.name});let a=ke();a&&Xo(a.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{$t=!1}}},Da=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Jo=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();Da.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=o[0].parentElement,l=0;for(;a&&l<8;){let d=a.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;a=a.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Nt=(t,e,o)=>{let r=Jo();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${Ht}`).forEach(a=>a.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Ht,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Xe()}),i?.addEventListener("click",Xe);let a,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await Gt({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};X(o,r);let n=Yo(t);return n&&(r={status:"linked",contactName:n.contactName},X(o,r),ee={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await Aa(t,e);a?(r={status:"linked",contactName:a.name},X(o,r),ee={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},Nt(a.id,a.name,e)):n||(r={status:"empty"},X(o,r),ee?.oppId===t&&(ee=null),Ma(),La(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Fa({oppId:t,locationId:e,onPick:async a=>{r={status:"saving"},X(o,r);try{let l=[Vo({tenantId:e,oppId:t,fieldId:jo,value:a.id})];a.companyName&&a.companyName.trim()&&l.push(Vo({tenantId:e,oppId:t,fieldId:Ta,value:a.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},X(o,r),ee={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},Xo(t,a.id,a.name),Nt(a.id,a.name,e),b.info(`Closing Agent linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},X(o,r)}}})}),o},Pa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Oa=async()=>{for(let t of Pa)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},we=!1,Qe=async()=>{if(!we){we=!0;try{await Ha()}finally{we=!1}}},Ha=async()=>{let t=ke();if(!t||!t.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Ze();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Ze());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await Oa();if(!r||!(Yo(t.oppId)!==null||ee!==null&&ee.oppId===t.oppId)&&await K()!=="Transaction Coordination")return;let i=ke();if(!i||i.oppId!==t.oppId||!i.locationId)return;let a=$a(t.oppId,i.locationId),l=document.createElement("span");l.id=`${R}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(a),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Na(t.oppId),qt(i.locationId)},xe=null,Bt=null,Rt=null,Ze=()=>{xe?.disconnect(),xe=null,Bt=null,Rt=null},Na=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xe&&Bt===t&&Rt===e||(Ze(),Bt=t,Rt=e,xe=new MutationObserver(()=>{let o=ke();if(!o||o.oppId!==t||!o.locationId){Ze();return}document.getElementById(R)||Qe(),qt(o.locationId)}),xe.observe(e,{childList:!0,subtree:!0})))},Pt=null,Ot,Ba=()=>{Pt||(Pt=new MutationObserver(()=>{Ot===void 0&&(Ot=window.setTimeout(()=>{Ot=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);t&&!e&&!we&&Qe()},300))}),Pt.observe(document.body,{childList:!0,subtree:!0}))},Wo,Ra=()=>{Wo===void 0&&(Wo=window.setInterval(()=>{let t=ke();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(R)&&!we&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Qe()),qt(t.locationId)},2e3))},Zo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Ba(),Ra(),Qe()};var Ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ut="ws-crm-prepare-contract-button",Qo="ws-crm-prepare-contract-menu",le="ws-crm-prepare-contract-modal",te="https://services.leadconnectorhq.com",Vt="__WS_CRM_CAPTURED_AUTH",za=50*60*1e3,rr=()=>{try{let t=localStorage.getItem(Vt);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>za?(localStorage.removeItem(Vt),null):e:null}catch{return null}},qa=t=>{try{localStorage.setItem(Vt,JSON.stringify(t))}catch{}},oe=()=>{let t=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o};var Ua=/\.(leadconnectorhq|gohighlevel|highlevel)\.com/i,er=(t,e)=>Ua.test(t)?e&&e.toUpperCase()!=="GET"?!0:/\/(proposals|recipients?|document|estimate|sign)/i.test(t):!1,nr=150,tr=!1,Va=()=>{if(tr)return;tr=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null},t.__WS_CRM_PROPOSAL_CALLS=t.__WS_CRM_PROPOSAL_CALLS||[];let e=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS;for(c.push(d);c.length>nr;)c.shift();return d};t.__WS_CRM_DUMP_PROPOSAL_CALLS=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS||[],h=d?c.filter(m=>m.url.includes(d)):c;return console.log(`[ws-crm-customizer] ${h.length} proposal calls captured${d?` (filter="${d}")`:""}`),h.forEach((m,p)=>{console.log(`
#${p+1} [${m.source}] ${m.method} ${m.url}`),console.log("  reqBody:",m.reqBody),console.log(`  \u2192 ${m.status??"?"}:`,m.resBody)}),h};let o=(d,c,h)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:d,headers:c,source:h};let m=c.authorization||c.Authorization;if(!m){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${h} no-auth]`,{url:d.split("?")[0],headerKeys:Object.keys(c)});return}h==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let p=c["token-id"]||c["Token-Id"]||void 0,u=rr()?.authorization;qa({authorization:m,tokenId:p,capturedAt:Date.now()}),u!==m&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${h}] captured GHL auth from ${d.split("?")[0]} (${m.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...d){let c=typeof d[0]=="string"?d[0]:d[0]instanceof URL?d[0].toString():d[0].url,h=d[1]||{};if(c&&c.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let u=h.headers;!u&&d[0]instanceof Request&&(u=d[0].headers);let y={};if(u instanceof Headers)u.forEach((w,g)=>y[g.toLowerCase()]=w);else if(Array.isArray(u))u.forEach(([w,g])=>y[w.toLowerCase()]=g);else if(u&&typeof u=="object")for(let w of Object.keys(u))y[w.toLowerCase()]=u[w];o(c,y,"fetch")}let m=d[0]instanceof Request?d[0]:null,p=(h.method||m?.method||"GET").toUpperCase();if(c&&er(c,p)){let u=m,y=p,w=null;try{if(h.body!=null)w=typeof h.body=="string"?h.body:h.body instanceof URLSearchParams?h.body.toString():(()=>{try{return JSON.stringify(h.body)}catch{return"(non-serializable body)"}})();else if(u)try{w=await u.clone().text()}catch{}}catch{w=null}let g=e({ts:Date.now(),source:"fetch",method:y,url:c,reqBody:w});return r.apply(this,d).then(async _=>{try{g.status=_.status,g.resBody=await _.clone().text()}catch{}return _})}return r.apply(this,d)};let n=XMLHttpRequest.prototype,i=n.open,a=n.setRequestHeader,l=n.send;n.open=function(d,c,...h){return this.__wsCrmUrl=c,this.__wsCrmMethod=(d||"GET").toUpperCase(),this.__wsCrmHeaders={},i.call(this,d,c,...h)},n.setRequestHeader=function(d,c){return this.__wsCrmHeaders&&typeof d=="string"&&(this.__wsCrmHeaders[d.toLowerCase()]=c),a.call(this,d,c)},n.send=function(d){let c=this.__wsCrmUrl,h=this.__wsCrmMethod,m=this.__wsCrmHeaders;if(c&&c.includes("services.leadconnectorhq.com")&&m&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),c&&h&&er(c,h)){let p=null;try{d==null?p=null:typeof d=="string"?p=d:d instanceof URLSearchParams?p=d.toString():p="(non-string body)"}catch{p=null}let u=e({ts:Date.now(),source:"xhr",method:h||"GET",url:c,reqBody:p}),y=this;this.addEventListener("loadend",()=>{try{if(u.status=y.status,y.responseType===""||y.responseType==="text")u.resBody=y.responseText;else try{u.resBody=JSON.stringify(y.response)}catch{u.resBody=`(responseType=${y.responseType})`}}catch{}})}return l.call(this,d)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ar=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Wa=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ja=async t=>{let e=`${te}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:oe()});if(!o.ok){let i="";try{i=await o.text()}catch{}let a=i?` \u2014 ${i.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${a}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Wa(i.name||i.title||"")})).filter(i=>!!i.id)},Ka=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Ya=async t=>{let e=await fetch(Ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Xa=async(t,e,o)=>{let r=`${te}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:oe()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let i=await n.json(),a=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!a)throw new Error("to-proposal returned no proposal id");return a},Ja=async(t,e)=>{let o=await fetch(`${te}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},Za=async t=>{let e=await fetch(`${te}/contacts/${t}`,{method:"GET",headers:oe()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Qa=async(t,e,o)=>{let r;try{r=await Ja(t,e)}catch(p){return{ok:!1,body:`fetchProposalDocument: ${p.message}`}}let n;try{n=await Za(o)}catch(p){return{ok:!1,body:`fetchContactBasics: ${p.message}`}}let i=`${n.firstName} ${n.lastName}`.trim()||n.email||o,a={id:o,firstName:n.firstName,lastName:n.lastName,email:n.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},c=[...(Array.isArray(r.recipients)?r.recipients:[]).filter(p=>p?.entityName!=="contacts"),a],h={name:r.name,locationId:r.locationId||t,pages:r.pages||[],variables:r.variables||[],fillableFields:r.fillableFields||[],timezone:r.timezone||{},recipients:c,type:r.type,locale:r.locale,grandTotal:r.grandTotal,status:r.status,paymentStatus:r.paymentStatus},m=await fetch(`${te}/proposals/document/${e}`,{method:"PUT",headers:{...oe(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!m.ok){let p=await m.text().catch(()=>"");return{ok:!1,status:m.status,body:p}}return{ok:!0}},es=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},or="ws-crm-prepare-contract-toast",U=(t,e="info",o=4e3)=>{document.getElementById(or)?.remove();let r=document.createElement("div");r.id=or;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,g.appendChild(_),document.body.appendChild(g);let lt=_.querySelector("#ws-pc-purchase-price"),dt=_.querySelector("#ws-pc-emd"),Ce=_.querySelector("#ws-pc-cash-at-close"),Jt=!1;Ce?.addEventListener("input",()=>{Jt=!0});let Zt=()=>{if(Jt)return;let P=Number(lt?.value||0),W=Number(dt?.value||0);Ce&&(Ce.value=String(Math.max(0,P-W)))};lt?.addEventListener("input",Zt),dt?.addEventListener("input",Zt);let Qt=()=>g.remove();g.addEventListener("click",P=>{P.target===g&&Qt()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Qt);let V=_.querySelector("#ws-pc-submit"),Ae=_.querySelector("#ws-pc-error");V?.addEventListener("click",async()=>{if(V){Ae&&(Ae.textContent=""),V.disabled=!0,V.textContent="Opening\u2026";try{let P=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),W=Number(lt?.value||0),eo=Number(dt?.value||0),to=Number(Ce?.value||0),oo=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),ro=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),no=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ao=(_.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),so=(_.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),F={};if(P!==a&&(F.sellerName=P),W!==l&&(F.purchasePrice=W),eo!==d&&(F.emd=eo),to!==c&&(F.cashAtClose=to),oo!==h&&(F.daysToClose=oo),ro!==m&&(F.inspectionDays=ro),no!==p&&(F.additionalTerms=no),ao!==u&&(F.currentOccupancy=ao),so!==y&&(F.occupancyAtClose=so),Object.keys(F).length>0){b.info("[prepare-contract] PA modal submit with overrides:",F),V.textContent="Saving\u2026";let Ar=A(),Ir=await Wt({tenantId:t,contactId:e,template:o,userId:Ar,overrides:F});b.info("[prepare-contract] re-stage with overrides ok:",Ir),V.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");await jt(t,e,o)}catch(P){V.disabled=!1,V.textContent="Open Contract",Ae&&(Ae.textContent=P.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",P)}}})},os=({tenantId:t,contactId:e,template:o,mtOpps:r,userId:n})=>{document.getElementById(le)?.remove();let i=document.createElement("div");i.id=le,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,i.appendChild(a),document.body.appendChild(i);let u=()=>i.remove();if(i.addEventListener("click",g=>{g.target===i&&u()}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",u),p)return;let y=a.querySelector("#ws-pc-submit"),w=a.querySelector("#ws-pc-error");y?.addEventListener("click",async()=>{if(!y)return;let g=a.querySelector("#ws-pc-opp-id"),_=(a.querySelector("#ws-pc-closing-date")?.value??"").trim(),f=(a.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(a.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(g?.value||"").trim();if(!T){w&&(w.textContent="Pick a subject property.");return}if(!_){w&&(w.textContent="Closing Date is required.");return}w&&(w.textContent=""),y.disabled=!0,y.textContent="Preparing\u2026";try{await Wt({tenantId:t,contactId:e,template:o,oppId:T,closingDate:_,buyerEarnestDueDate:f,lenderSource:E,userId:n}),await jt(t,e,o),u()}catch(k){y.disabled=!1,y.textContent="Stage & Open Contract",w&&(w.textContent=k.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",k)}})},Wt=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ya({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},jt=async(t,e,o)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let r=await Xa(t,o.id,e);b.info(`[prepare-contract] proposal created: ${r}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer`);let n=await Qa(t,r,e);n.ok?b.info(`[prepare-contract] contact attached to proposal ${r}`):(b.warn(`[prepare-contract] attach failed (status=${n.status??"n/a"}): ${n.body?.slice(0,300)??"no body"}`),U(`Proposal created but couldn't auto-attach contact (HTTP ${n.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",n.body)),es(t,r)};var rs=async t=>{let e=ar();if(!e){U("Could not resolve contact context.","error");return}document.getElementById(Qo)?.remove();let o=document.createElement("div");o.id=Qo,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    `,o.appendChild(a);let l=document.createElement("button");l.type="button",l.style.cssText=`
      ...
      padding: 8px 14px;
      cursor: pointer;
    `,l.textContent="\u{1F50D} View captured proposal calls",l.addEventListener("mouseenter",()=>{l.style.background=s.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",d=>{d.stopPropagation(),d.preventDefault(),o.remove(),document.removeEventListener("click",r,!0),ns()}),o.appendChild(l)};o.innerHTML="";for(let a of n){let l=document.createElement("button");l.type="button",l.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
...
`),r=document.createElement("div");r.id=le,r.style.cssText=`
  ...
  `,n.innerHTML=`
    ...
    <div style="
      ...
      font-weight: 500;
      margin-bottom: 4px;
    ">${e.length} call${e.length===1?"":"s"} in buffer (max ${nr})</div>
    <div style="
      font-size: 12px;
      color: ${s.ash};
      margin-bottom: 14px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),rs(t)}),t},ss="ws-crm-contact-actions-bar",is=async()=>{let t=ar();if(!t){document.getElementById(Ut)?.remove();return}let e=null;try{e=await C(`#${ss}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Ut);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=as();r.dataset.contactId=t.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},sr=()=>{is()};Va();function G(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ie(t){return G(t)}var at="reos-theme-stylesheet",Er="reos-theme-fonts",ls=()=>{let t=document.getElementById(Er);t&&t.remove()},ds=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var D=(t,e)=>{try{b.info(`[main] calling ${t}`),e(),b.info(`[main] ${t} OK`)}catch(o){b.error(`[main:FAIL] ${t} threw:`,o)}},Cr=()=>{b.info(`Loaded v${De} (built ${Fe})`),D("mountVersionBadge (initial)",it),D("mountFavicon",$o),D("mountThemeStylesheet",Tr),D("initPageRouter",bo),b.info("[main] registering onPageChange subscriber"),co(t=>{b.info(`[main] onPageChange callback fired for page=${t}`),D("mountVersionBadge",it),D("mountClaimReleaseToggle",wo),D("mountContactActionsBar",Do),D("mountActiveFollowUpButton",vo),D("mountMtOfferMadeButton",Oo),D("mountNotInterestedButton",Ho),D("mountReducePriceButton",Bo),D("mountSendToClosingOfficeButton",Uo),D("mountClosingAgentPickerButton",Zo),D("mountPrepareContractButton",sr)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Cr):Cr();})();
