/* Wholesaling CRM Customizer v0.40.5 — built 2026-06-14T21:52:55.278Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var ro="[wholesaling-crm-customizer]",Yl="__WS_CRM_DEBUG",Jl=()=>!!window[Yl],c={info(...t){console.log(ro,...t)},warn(...t){console.warn(ro,...t)},error(...t){console.error(ro,...t)},debug(...t){Jl()&&console.log(ro,"[debug]",...t)}};var Xl=/\/v2\/location\/([A-Za-z0-9]+)/,Ql=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let t=window.location.pathname.match(Xl);return t?t[1]:null},vr=()=>{let t=re();return t!==null&&Ql.has(t)};var Ea=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,_r=/\/v2\/location\/([A-Za-z0-9]+)/,Zl=t=>{let e=t.match(Ea);if(!e)return null;let o=t.match(_r);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},ed=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ea);if(!a)continue;let i=r.match(_r)||window.location.pathname.match(_r);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},R=()=>{let t=Zl(window.location.pathname);return t||ed()};var Ta=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},ao="",gr=null,Oe="other",yr=new Set,no=()=>{let t=R()?.contactId??null;if(!(!(window.location.pathname!==ao)&&!(t!==gr))){ao=window.location.pathname,gr=t,Oe=Ta(),c.debug("Page/context changed:",Oe,ao,"contact:",t);for(let r of yr)try{r(Oe)}catch(a){c.error("Subscriber threw:",a)}}},ne=t=>(yr.add(t),setTimeout(()=>t(Oe),0),()=>{yr.delete(t)}),Sa=()=>{Oe=Ta(),ao=window.location.pathname,gr=R()?.contactId??null,c.debug("Router init, current page:",Oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),no()},history.replaceState=function(o,r,a){e(o,r,a),no()},window.addEventListener("popstate",no),setInterval(no,1e3)},io=()=>Oe;var so="0.40.5",lo="2026-06-14T21:52:55.278Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{h&&h.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},h=new MutationObserver(()=>{let m=a.querySelector(t);m&&(b(),i(m))});h.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let m=a.querySelector(t);m&&(b(),i(m))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},fr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ca=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var td=/^[A-Za-z0-9]{15,30}$/,ut=t=>typeof t=="string"&&td.test(t),Aa=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},od=()=>{let t=window.WS_CRM_USER_ID;return ut(t)?t:null},rd=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ut(o))return o;return null},nd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Aa(e);if(!o)return null;let r=o.uid;if(ut(r))return r;let a=o.claims;if(a&&ut(a.user_id))return a.user_id}catch{}return null},ad=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ut(a))return a}catch{}}}catch{}return null},M=()=>od()||rd()||nd()||ad()||null,id=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Aa(e);return o?o.claims??o:null}catch{return null}},me=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:id()?.type==="agency"};var Ma="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",sd=`${Ma}/active-follow-up-get`,ld=`${Ma}/active-follow-up-set`,De="ws-crm-active-follow-up-button",wr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},dd=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},cd=async t=>{let e=await fetch(sd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},pd=async(t,e)=>{let o=await fetch(ld,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},He=(t,e)=>{let o=wr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},La=t=>{let e=document.createElement("button");return e.type="button",e.id=De,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Rd(t,e,()=>Ar(t,e))}),o},Ar=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([kd(t,e),Er()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Hd(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Hd=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let h=d.key==="state"?Sd(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Td(r,p).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),d.disabled=!1;return}Ar(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),d.disabled=!1}))})})},bo=!1,Ba=(t,e)=>{bo=e;let o=Od(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Pd,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Ar(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Ra,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Ra="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Pd="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Bd=t=>{let e=document.createElement("button");return e.id=Pa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Ra,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Cd.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!bo;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Ba(r,a)}),e},Rd=(t,e,o)=>{let r=document.getElementById(Da);r&&r.remove();let a=document.createElement("div");a.id=Da,a.style.cssText=`
  ...
  `,x=f=>{let T=f.find(L=>L.code===s.stateCode);return`
    ...
    `},g=()=>{let f=s.granularity==="county"?gt?.[s.stateCode||""]??[]:yt?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),L=i.querySelector("#ws-buybox-value-list");if(!T||!L)return;let P=q=>{let z=q.toLowerCase().trim();if(!z){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=f.filter(B=>B.toLowerCase().includes(z)).slice(0,50);if(N.length===0){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(s.stateCode||"")}.</div>`;return}L.innerHTML=N.map(B=>`
  ...
  `,S=()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");f&&(f.addEventListener("input",()=>{f.value=f.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),f.addEventListener("keydown",L=>{L.key==="Enter"&&(L.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>f.focus(),0))},C=async()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),L=(f?.value||"").trim();if(!/^\d{5}$/.test(L)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(L)},E=async f=>{if(!s.granularity||!f)return;let T=i.querySelector("#ws-buybox-err"),L=i.querySelector("#ws-buybox-save");L&&(L.disabled=!0,L.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await Ed(t,e,s.granularity,f);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),L&&(L.disabled=!1,L.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),L&&(L.disabled=!1,L.textContent="Add")}};l()},kr=!1,Ye=null,ft=null,Ha=()=>{document.getElementById(Pa)?.remove(),document.getElementById(Tr)?.remove(),ft&&Ye&&Ye.nav.removeEventListener("click",ft,!0),ft=null,Ye=null,bo=!1},Fa=()=>{Fd()},Fd=async()=>{if(!kr){kr=!0;try{let t=R();if(!t){Ha();return}let e=document.getElementById(Tr);if(e&&e.dataset.buyerContactId===t.contactId&&Ye)return;Ha();let o=null;try{o=await je(t.contactId,t.locationId)}catch(h){c.warn("[buy-box] Contact Type fetch failed",h);return}if(Ke(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Id(),Md()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=R();if(!s||s.contactId!==t.contactId)return;let l=Dd(t.locationId,t.contactId),d=Bd(()=>Ye),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ye=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),ft=h=>{let m=h.target;if(!m||p.iconBtn.contains(m))return;m.closest("button.sidebar-option-button")&&bo&&Ba(p,!1)},a.addEventListener("click",ft,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{kr=!1}}};var ke="ws-crm-claim-release-pill",Nd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",zd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Gd=async t=>{let e=await fetch(Nd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},qd=async t=>{let e=await fetch(zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ga=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Je=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Ca(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=_o();!o||!o.locationId||o.oppId!==t||_c({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},yc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],fc=async()=>{for(let t of yc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vo=!1,Dr=async()=>{if(!vo){vo=!0;try{await xc()}finally{vo=!1}}},xc=async()=>{let t=_o();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await fc();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_o();if(!a||a.oppId!==t.oppId)return;let i=gc(t.oppId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),wc(t.oppId)},wt=null,Or=null,kt=()=>{wt?.disconnect(),wt=null,Or=null},wc=t=>{if(wt&&Or===t)return;kt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Or=t,wt=new MutationObserver(()=>{let o=_o();if(!o||o.oppId!==t){kt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}document.getElementById(se)||Dr()}),wt.observe(e,{childList:!0,subtree:!0}))},Ir=null,Mr,kc=()=>{Ir||(Ir=new MutationObserver(()=>{Mr===void 0&&(Mr=window.setTimeout(()=>{Mr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!vo&&Dr()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},ni=()=>{kc(),Dr()};var Ec="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",le="ws-crm-not-interested-button",Tc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Sc=/\/v2\/location\/([A-Za-z0-9]+)/,yo=()=>{let t=window.location.pathname,e=t.match(Tc);if(!e)return null;let o=t.match(Sc);return{oppId:e[1],locationId:o?o[1]:null}},Cc=async t=>{let e=await fetch(Ec,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ac=t=>{let e=document.createElement("button");return e.id=le,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=yo();if(!o||!o.locationId||o.oppId!==t)return;let r=M(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await Cc({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Lc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$c=async()=>{for(let t of Lc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},go=!1,Rr=async()=>{if(!go){go=!0;try{await Ic()}finally{go=!1}}},Ic=async()=>{let t=yo();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await $c();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=yo();if(!a||a.oppId!==t.oppId)return;let i=Ac(t.oppId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Mc(t.oppId)},Et=null,Br=null,Tt=()=>{Et?.disconnect(),Et=null,Br=null},Mc=t=>{if(Et&&Br===t)return;Tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Br=t,Et=new MutationObserver(()=>{let o=yo();if(!o||o.oppId!==t){Tt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt();return}document.getElementById(le)||Rr()}),Et.observe(e,{childList:!0,subtree:!0}))},Hr=null,Pr,Oc=()=>{Hr||(Hr=new MutationObserver(()=>{Pr===void 0&&(Pr=window.setTimeout(()=>{Pr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!go&&Rr()},300))}),Hr.observe(document.body,{childList:!0,subtree:!0}))},ai=()=>{Oc(),Rr()};var Dc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ae="ws-crm-schedule-walkthrough-button",Fr="ws-crm-schedule-walkthrough-modal",Hc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Pc=/\/v2\/location\/([A-Za-z0-9]+)/,wo=()=>{let t=window.location.pathname,e=t.match(Hc);if(!e)return null;let o=t.match(Pc);return{oppId:e[1],locationId:o?o[1]:null}},fo=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Bc=(t,e)=>{document.getElementById(Fr)?.remove();let o=document.createElement("div");o.id=Fr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=wo();!o||!o.locationId||o.oppId!==t||Bc(o.oppId,o.locationId)}),e},Fc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Nc=async()=>{for(let t of Fc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},xo=!1,qr=async()=>{if(!xo){xo=!0;try{await zc()}finally{xo=!1}}},zc=async()=>{let t=wo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ct();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ct());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Nc();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=wo();if(!a||a.oppId!==t.oppId)return;let i=Rc(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Gc(t.oppId)},St=null,Gr=null,Ct=()=>{St?.disconnect(),St=null,Gr=null},Gc=t=>{if(St&&Gr===t)return;Ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gr=t,St=new MutationObserver(()=>{let o=wo();if(!o||o.oppId!==t){Ct();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ct();return}document.getElementById(ae)||qr()}),St.observe(e,{childList:!0,subtree:!0}))},Nr=null,zr,qc=()=>{Nr||(Nr=new MutationObserver(()=>{zr===void 0&&(zr=window.setTimeout(()=>{zr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!xo&&qr()},300))}),Nr.observe(document.body,{childList:!0,subtree:!0}))},ii=()=>{qc(),qr()};var Uc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Qe="ws-crm-resend-deal-link-wrap",Vc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(Vc);if(!e)return null;let o=t.match(Wc);return{oppId:e[1],locationId:o?o[1]:null}},jc=async t=>{let e=await fetch(Uc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Kc=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),si=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,jr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${si(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Yc(t,e)),t.appendChild(o)},Yc=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Jc(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>jr(t,e)),o.appendChild(s),t.appendChild(o)},Jc=async(t,e,o,r)=>{let a=Eo();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await jc({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${si(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Kc(s)}</span>`}window.setTimeout(()=>jr(t,e),3500)}},Xc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qc=async()=>{for(let t of Xc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ko=!1,Kr=async()=>{if(!ko){ko=!0;try{await Zc()}finally{ko=!1}}},Zc=async()=>{let t=Eo();if(!t||!t.locationId){document.getElementById(Qe)?.remove(),Lt();return}let e=document.getElementById(Qe);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),Lt());return}e&&e.remove();let o=await Qc();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Eo();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Qe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),jr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),ep(t.oppId)},At=null,Wr=null,Lt=()=>{At?.disconnect(),At=null,Wr=null},ep=t=>{if(At&&Wr===t)return;Lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wr=t,At=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){Lt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Qe)?.remove(),Lt();return}document.getElementById(Qe)||Kr()}),At.observe(e,{childList:!0,subtree:!0}))},Ur=null,Vr,tp=()=>{Ur||(Ur=new MutationObserver(()=>{Vr===void 0&&(Vr=window.setTimeout(()=>{Vr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Qe)&&!ko&&Kr()},300))}),Ur.observe(document.body,{childList:!0,subtree:!0}))},li=()=>{tp(),Kr()};var op="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",de="ws-crm-reduce-price-button",di="ws-crm-reduce-price-modal",rp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,np=/\/v2\/location\/([A-Za-z0-9]+)/,Co=()=>{let t=window.location.pathname,e=t.match(rp);if(!e)return null;let o=t.match(np);return{oppId:e[1],locationId:o?o[1]:null}},ap=async t=>{let e=await fetch(op,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},To=()=>{document.getElementById(di)?.remove()},ip=t=>{To();let e=document.createElement("div");e.id=di,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Co();!r||!r.locationId||r.oppId!==t||ip({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},lp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dp=async()=>{for(let t of lp)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},So=!1,Qr=async()=>{if(!So){So=!0;try{await cp()}finally{So=!1}}},cp=async()=>{let t=Co();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),It());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await dp();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Co();if(!a||a.oppId!==t.oppId)return;let i=sp(t.oppId,t.locationId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),pp(t.oppId)},$t=null,Xr=null,It=()=>{$t?.disconnect(),$t=null,Xr=null},pp=t=>{if($t&&Xr===t)return;It();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Xr=t,$t=new MutationObserver(()=>{let o=Co();if(!o||o.oppId!==t){It();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}document.getElementById(de)||Qr()}),$t.observe(e,{childList:!0,subtree:!0}))},Yr=null,Jr,bp=()=>{Yr||(Yr=new MutationObserver(()=>{Jr===void 0&&(Jr=window.setTimeout(()=>{Jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!So&&Qr()},300))}),Yr.observe(document.body,{childList:!0,subtree:!0}))},ci=()=>{bp(),Qr()};var Ze="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Ao="deals.reinvestos.com";var ce="ws-crm-edit-landing-button",mp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hp=/\/v2\/location\/([A-Za-z0-9]+)/,$o=()=>{let t=window.location.pathname,e=t.match(mp);if(!e)return null;let o=t.match(hp);return{oppId:e[1],locationId:o?o[1]:null}},up=(t,e)=>{let o=new URL(`https://${Ao}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ze);let r=M();return r&&o.searchParams.set("user",r),o.toString()},vp=(t,e)=>{let o=document.createElement("button");return o.id=ce,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=$o();if(!r||!r.locationId||r.oppId!==t)return;if(!Ze){c.warn("[edit-landing] editor session key not configured in this build");return}let a=up(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},_p=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],gp=async()=>{for(let t of _p)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lo=!1,on=async()=>{if(!Lo){Lo=!0;try{await yp()}finally{Lo=!1}}},yp=async()=>{let t=$o();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Ot();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Ot());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=await gp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=$o();if(!a||a.oppId!==t.oppId)return;let i=vp(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ce}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),fp(t.oppId)},Mt=null,tn=null,Ot=()=>{Mt?.disconnect(),Mt=null,tn=null},fp=t=>{if(Mt&&tn===t)return;Ot();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(tn=t,Mt=new MutationObserver(()=>{let o=$o();if(!o||o.oppId!==t){Ot();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Ot();return}document.getElementById(ce)||on()}),Mt.observe(e,{childList:!0,subtree:!0}))},Zr=null,en,xp=()=>{Zr||(Zr=new MutationObserver(()=>{en===void 0&&(en=window.setTimeout(()=>{en=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lo&&on()},300))}),Zr.observe(document.body,{childList:!0,subtree:!0}))},pi=()=>{xp(),on()};var mi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",et="ws-crm-publish-button",Dt="ws-crm-publish-wrap",Mo="ws-crm-publish-dropdown",wp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kp=/\/v2\/location\/([A-Za-z0-9]+)/,an=()=>{let t=window.location.pathname,e=t.match(wp);if(!e)return null;let o=t.match(kp);return{oppId:e[1],locationId:o?o[1]:null}},Ep=async(t,e)=>{try{let o=await fetch(mi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},Tp=async(t,e)=>{let o=await fetch(mi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Sp=(t,e)=>{if(!Ze){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Ao}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ze);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ge=()=>{document.getElementById(Mo)?.remove()},bi=(t,e,o,r,a)=>{ge();let i=document.createElement("div");i.id=Mo;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(Cb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Rb=(t,e)=>{Ce();let o=document.createElement("div");o.id=qi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Go=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=t,o},Fb=()=>{let t=Go("\u22EE","ghost");return t.style.lineHeight="1",t},Nb=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Wi){let r=Go("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Db(t)),o.appendChild(r),o}if(e===In){let r=Go("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Bb(t,r)),o.appendChild(r),o}if(e===ji){let r=Go("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Yi(t)),o.appendChild(r),o}return null},zb=(t,e)=>{let o=[];if(e===In&&(o=[{label:"Re-order Lockbox",onClick:()=>void Yi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Gi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Fb();return a.addEventListener("click",i=>{i.stopPropagation(),Rb(o,a)}),r.appendChild(a),r},Gb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],qb=async()=>{for(let t of Gb)try{let e=await I(t,{timeoutMs:1200});if(e)return e}catch{}return null},zo=()=>{document.getElementById(Cn)?.remove(),document.getElementById(Gi)?.remove(),Ce()},qo=!1,Mn=async()=>{if(!qo){qo=!0;try{let t=Ki();if(!t){zo();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){zo();return}let o=Ob(),r=document.getElementById(Cn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Nb(t,o);if(!a){zo();return}let i=await qb();if(!i)return;zo();let s=U(i),l=document.createElement("span");l.id=Cn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=zb(t,o);d&&s.appendChild(d),Ub(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{qo=!1}}},Nt=null,Ln=null,En,zi=()=>{Nt?.disconnect(),Nt=null,Ln=null},Ub=t=>{if(Nt&&Ln===t)return;zi();let e=document.querySelector(Vi);e&&(Ln=t,Nt=new MutationObserver(()=>{let o=Ki();if(!o||o.oppId!==t){zi();return}En===void 0&&(En=window.setTimeout(()=>{En=void 0,Mn()},250))}),Nt.observe(e,{childList:!0,subtree:!0}))},Tn=null,Sn,Vb=()=>{Tn||(Tn=new MutationObserver(()=>{Sn===void 0&&(Sn=window.setTimeout(()=>{Sn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!qo&&Mn()},300))}),Tn.observe(document.body,{childList:!0,subtree:!0}))},Ji=()=>{Vb(),Mn()};var Xi="ws-support-modal",Qi="ws-support-toast",Wb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Zi="ws-support-submitter-name",es="ws-support-submitter-email",ts="ws-support-submitter-role",jb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Fe=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Kb=(t,e="success",o)=>{let r=document.getElementById(Qi);r&&r.remove();let a=document.createElement("div");a.id=Qi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Zi,r.submitterName),localStorage.setItem(es,r.submitterEmail),r.submitterRole&&localStorage.setItem(ts,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let m=await(await fetch(Wb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!m.ok){d(m.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=m.ticket_short_id||"submitted";Kb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Jb=["/support-ticket","ws-support-modal","ws-support"],Xb=/\/custom-menu-link\//,On=!1,os=()=>{if(On||!Xb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Jb.some(s=>i.includes(s))});if(r){On=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Yb(),On=!1},50);return}t<10&&setTimeout(e,150)};e()},rs=!1,ns=()=>{rs||(rs=!0,ne(()=>setTimeout(os,50)),os(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var as="ws-phone-assignments-modal",is="ws-phone-assignments-toast",Qb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Zb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",em=["ACQ","DISPO","TC"],ds="",Ae=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),tm=(t,e="success",o)=>{document.getElementById(is)?.remove();let r=document.createElement("div");r.id=is;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},jo=()=>{document.getElementById(js)?.remove()},Vm=t=>{jo();let e=document.createElement("div");e.id=js,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Le(o,r);let a=Ks(t);return a&&(r={status:"linked",contactName:a.contactName},Le(o,r),qe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Nm(t,e);s?(r={status:"linked",contactName:s.name},Le(o,r),qe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Qn(s.id,s.name,e)):a||(r={status:"empty"},Le(o,r),qe?.oppId===t&&(qe=null),qm(),Gm(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Vm({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Le(o,r);try{let l=[Us({tenantId:e,oppId:t,fieldKey:Ws,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Us({tenantId:e,oppId:t,fieldKey:Bm,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Le(o,r),qe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Ys(t,s.id,s.name),Qn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Le(o,r)}}})}),o},jm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Km=async()=>{for(let t of jm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vt=!1,Jo=async()=>{if(!Vt){Vt=!0;try{await Ym()}finally{Vt=!1}}},Ym=async()=>{let t=jt();if(!t||!t.locationId){document.getElementById(be)?.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo();return}let e=document.getElementById(be);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo());return}e&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Km();if(!r||!(Ks(t.oppId)!==null||qe!==null&&qe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=jt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Wm(t.oppId,i.locationId),l=document.createElement("span");l.id=`${be}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Jm(t.oppId),ra(i.locationId)},Wt=null,Zn=null,ea=null,Yo=()=>{Wt?.disconnect(),Wt=null,Zn=null,ea=null},Jm=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wt&&Zn===t&&ea===e||(Yo(),Zn=t,ea=e,Wt=new MutationObserver(()=>{let o=jt();if(!o||o.oppId!==t||!o.locationId){Yo();return}document.getElementById(be)||Jo(),ra(o.locationId)}),Wt.observe(e,{childList:!0,subtree:!0})))},Yn=null,Jn,Xm=()=>{Yn||(Yn=new MutationObserver(()=>{Jn===void 0&&(Jn=window.setTimeout(()=>{Jn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(be);t&&!e&&!Vt&&Jo()},300))}),Yn.observe(document.body,{childList:!0,subtree:!0}))},Vs,Qm=()=>{Vs===void 0&&(Vs=window.setInterval(()=>{let t=jt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(be)&&!Vt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Jo()),ra(t.locationId)},2e3))},Xs=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Xm(),Qm(),Jo()};var Zm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ie="ws-crm-manage-team-cta",Qs="ws-crm-manage-team-modal",eh=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Zs={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},th={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},el=()=>{let t=window.location.pathname.match(eh);return t?{tenantId:t[1]}:null},Qo=async t=>{let e=await fetch(Zm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ie=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$e=t=>ie(t),na="ws-crm-manage-team-toast",sa=(t,e="info",o=4e3)=>{document.getElementById(na)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=na,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `+t.map(r=>rh(r,e)).join(""),Zo=async t=>{aa();let e=document.createElement("div");e.id=Qs,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",aa);let r;try{r=await Qo({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
  ...
  `,document.head.appendChild(t)},pa="__WS_CRM_CAPTURED_AUTH",gh=50*60*1e3,rr=()=>{try{let t=localStorage.getItem(pa);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>gh?(localStorage.removeItem(pa),null):e:null}catch{return null}},yh=t=>{try{localStorage.setItem(pa,JSON.stringify(t))}catch{}},it=()=>{let t=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},nl=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((rr()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),at=async(t,e={},o=2)=>{let r=rr()?.capturedAt??0,a;try{a={...it(),...e.headers??{}}}catch(s){if(o>0&&await nl(r,4e3))return at(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await nl(r,4e3)?at(t,e,o-1):i},al=!1,fh=()=>{if(al)return;al=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,m=rr()?.authorization;yh({authorization:b,tokenId:h,capturedAt:Date.now()}),m!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let h={};if(b instanceof Headers)b.forEach((m,_)=>h[_.toLowerCase()]=m);else if(Array.isArray(b))b.forEach(([m,_])=>h[m.toLowerCase()]=_);else if(b&&typeof b=="object")for(let m of Object.keys(b))h[m.toLowerCase()]=b[m];e(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},cl=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},xh=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:cl()},wh=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},pl="__WS_CRM_TEMPLATES_CACHE_V1",kh=24*60*60*1e3,il=t=>{try{let e=window.localStorage.getItem(pl);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>kh?null:o.templates}catch{return null}},Eh=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(pl,JSON.stringify(o))}catch{}},Th=async t=>{let e=`${fe}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await at(e,{method:"GET"})}catch(s){let l=il(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=il(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:wh(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Eh(t,i),i},Sh=async(t,e)=>{let o=await at(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await at(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},Ch=async(t,e)=>{let o=await at(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:it()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Ah=async t=>{let e=await fetch(_h,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Lh=async(t,e,o)=>{let r=`${fe}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:it()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},$h=async(t,e)=>{let o=await fetch(`${fe}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:it()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Ih=async t=>{let e=await fetch(`${fe}/contacts/${t}`,{method:"GET",headers:it()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Mh=async(t,e,o,r)=>{let a;try{a=await $h(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Ih(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},m=await fetch(`${fe}/proposals/document/${e}`,{method:"PUT",headers:{...it(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!m.ok){let _=await m.text().catch(()=>"");return{ok:!1,status:m.status,body:_}}return{ok:!0}},Oh=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},tr="__WS_CRM_PENDING_INSTRUCTIONS",Dh=60*1e3,Hh=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ph=t=>{let e=(t||"").toLowerCase();for(let o of Hh)if(e.includes(o.matches.toLowerCase()))return o;return null},Bh=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(tr,JSON.stringify(r))}catch{}},Rh=()=>{try{let t=localStorage.getItem(tr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Dh?(localStorage.removeItem(tr),null):e}catch{return null}},Fh=()=>{try{localStorage.removeItem(tr)}catch{}},Nh=(t,e)=>{document.getElementById(_e)?.remove();let o=document.createElement("div");o.id=_e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},zh=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Gh=()=>{let t=window.location.pathname.match(zh);if(!t)return;let e=t[1],o=Rh();o&&o.proposalId===e&&(Fh(),window.setTimeout(()=>{Nh(o.title,o.bodyHtml)},600))},sl="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(sl)?.remove();let r=document.createElement("div");r.id=sl;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),B=E.querySelector("#ws-pc-assignment-fee"),xe=!1;B?.addEventListener("input",()=>{xe=!0});let we=()=>{if(xe)return;let J=Number(N?.value||0);B&&(B.value=String(Math.max(0,J-x)))};N?.addEventListener("input",we);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),dt=Number(N?.value||0),ct=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),pt=Number(B?.value||0),bt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),mt=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),We=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),ht=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!We){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),dt!==h&&(Q.assignmentPrice=dt),ct!==m&&(Q.buyerEMD=ct),pt!==_&&(Q.assignmentFee=pt),bt!==k&&(Q.closingOffice=bt),mt!==y&&(Q.buyerCompanyName=mt);let mr=We!==g||ht!==w||X!==S,hr=Object.keys(Q).length>0||mr,ur=a;hr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",ur=await or({tenantId:t,contactId:e,template:o,oppId:r,closingDate:We,buyerEarnestDueDate:ht,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",ur),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let ka=ur?.debug?.propertyAddress||p,Kl=ka?`${ka} - Assignment Agreement`:void 0;await ha(t,e,o,Kl),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},or=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ah({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ha=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Lh(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Mh(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Ph(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Bh(a,s.title,s.bodyHtml)),Oh(t,a)},Vh=async t=>{let e=xh(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(ol)?.remove();let o=document.createElement("div");o.id=ol,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){ru(o,s.properties,l=>{a(!0),va({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?gl(e,d.property_record_id,d):nr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),nr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?gl(e,s.property_record_id,s):nr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await va({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),nr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},nu=async()=>{for(let t of tu)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},fl=async(t,e)=>{let o=e.querySelector(`#${ul}`);if(!o)try{o=await I(`#${ul}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},xl=()=>{let t=document.querySelectorAll(`#${Ve}`);for(let e=1;e<t.length;e++)t[e].remove()},au=async()=>{let t=R();if(!t||!t.locationId||t.source!=="url"){document.getElementById(Ve)?.remove(),st();return}let e=t.locationId,o=document.getElementById(Ve);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),st();let r="seller";try{r=Ke(await je(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Ve)?.remove();return}let a=await nu();if(!a){c.warn("[compute-offer] no central panel found");return}let i=R();if(!i||i.contactId!==t.contactId)return;let s=yl(t.contactId,e);if(!await fl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}xl(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(R()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(Ve)){let d=yl(t.contactId,e);fl(d,a).then(()=>xl())}});l.observe(a,{childList:!0})},Xt=null,Sl=()=>{let t=R()?.contactId??null;if(Xt&&Xt.id===t)return;let e=au().finally(()=>{Xt?.promise===e&&(Xt=null)});Xt={id:t,promise:e}};var oo="reos-theme-stylesheet",xa="reos-theme-fonts",lt=!1,iu=()=>{let t=document.getElementById(xa);t&&t.remove()},su=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var $=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},jl=()=>{c.info(`Loaded v${so} (built ${lo})`),vr()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):($("mountVersionBadge (initial)",br),$("mountFavicon",ti),$("mountThemeStylesheet",wa),$("mountHideLaunchpad",pn),$("mountHideNavItems",bn),$("mountRelabelNav",mn),$("mountHideTopmenuTabs",un),$("mountContractsSection",hn)),$("initPageRouter",Sa),c.info("[main] registering onPageChange subscriber"),ne(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),vr()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),$("unmountThemeStylesheet",Vl);return}$("mountThemeStylesheet",wa),$("mountVersionBadge",br),$("mountHideLaunchpad",pn),$("mountHideNavItems",bn),$("mountRelabelNav",mn),$("mountHideTopmenuTabs",un),$("mountContractsSection",hn),$("mountClaimReleaseToggle",qa),$("mountContactActionsBar",Za),$("mountActiveFollowUpButton",Oa),$("mountMtOfferMadeButton",ni),$("mountNotInterestedButton",ai),$("mountScheduleWalkthroughButton",ii),$("mountResendDealLinkButton",li),$("mountReducePriceButton",ci),$("mountEditLandingPageButton",pi),$("mountPublishButton",hi),$("mountContactMapLinks",fi),$("mountSendToClosingOfficeButton",Di),$("mountOppActionBar",Ji),$("mountClosingAgentPickerButton",Xs),$("mountPrepareContractButton",hl),$("mountComputeOfferButton",Sl),$("mountManageTeam",tl),$("mountBuyBoxWidget",Fa),$("mountSupportNavItem",ns),$("mountPhoneAssignmentsWidget",cs),$("mountBulkPowerDialer",Os),$("mountBulkPowerDialerContacts",Ps),$("mountCallingAsChip",Rs),$("mountDialerThemeFix",qs)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jl):jl();})();
