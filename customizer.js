...
`;var Vo=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&Vo.test(o),qo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zo=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Wo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},jo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=qo(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},Ko=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>zo()||Wo()||jo()||Ko()||null;var Nt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Yo=`${Nt}/active-follow-up-get`,Xo=`${Nt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Jo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zo=async o=>{let e=await fetch(Yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Qo=async(o,e)=>{let t=await fetch(Xo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},q=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ot=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),In(o.oppId)},se=null,ut=null,le=()=>{se?.disconnect(),se=null,ut=null},In=o=>{if(se&&ut===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,se=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),N(),le();return}document.getElementById(z)||_t()}),se.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Ln=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);o&&!e&&!Ae&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},bo=()=>{Ln(),_t()};var An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",po="ldtyB2UXKi9vOp8nLUH7",Dn="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",mo="ws-crm-title-officer-picker-modal",On=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hn=/\/v2\/location\/([A-Za-z0-9]+)/,ft=()=>{let o=window.location.pathname,e=o.match(On);if(!e)return null;let t=o.match(Hn);return{oppId:e[1],locationId:t?t[1]:null}},Et=async o=>{let e=await fetch(An,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ho=async o=>{let e=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Pn=async(o,e)=>{try{let t=await fetch(Mn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:po}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Et({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(t){return c.warn("[title-officer] fetchCurrent failed:",t),null}},Me=null,wt="ws-crm-title-officer-field-link",Nn=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${wt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),delete e.dataset.wsTitleOfficerDecorated}))},vt=!1,uo=async o=>{if(vt)return;let e=_o();if(!e)return;let t=(e.value||"").trim();if(!t){c.info("[title-officer] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){c.info(`[title-officer] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsTitleOfficerDecorated!==t){vt=!0;try{c.info(`[title-officer] tryDecorate: looking up ${t}`);let r=await Et({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){c.warn(`[title-officer] tryDecorate: contact ${t} not found`);return}let n=r.results[0];c.info(`[title-officer] tryDecorate: applying ${n.name} (${n.id})`),xt(n.id,n.name,o)}catch(r){c.warn("[title-officer] tryDecorate lookup failed:",r)}finally{vt=!1}}},_o=()=>{let o=document.querySelector(".crm-opportunities-modal");if(!o)return c.info("[title-officer] findInput: no .crm-opportunities-modal in DOM"),null;let e=o.querySelectorAll("*"),t=[];for(let i of e)(i.textContent||"").trim()==="TC - Title Officer"&&t.push(i);if(c.info(`[title-officer] findInput: ${t.length} candidate label element(s) matched 'TC - Title Officer'`),t.length===0)return null;t.sort((i,s)=>i.querySelectorAll("*").length-s.querySelectorAll("*").length);let n=t[0].parentElement,a=0;for(;n&&a<8;){let i=n.querySelector("input");if(i)return c.info(`[title-officer] findInput: located input ${a} levels up from label`),i;n=n.parentElement,a+=1}return c.warn("[title-officer] findInput: label found but no <input> within 8 ancestors"),null},xt=(o,e,t)=>{let r=_o();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${wt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsTitleOfficerDecorated=o,r.style.color="transparent",r.style.caretColor="transparent",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let s=document.createElement("a");s.className=wt,s.href=`/v2/location/${t}/contacts/detail/${o}`,s.textContent=e,s.style.cssText=`
      ...
      pointer-events: auto;
      background: transparent;
    `,s.addEventListener("mouseenter",()=>{s.style.textDecoration="underline"}),s.addEventListener("mouseleave",()=>{s.style.textDecoration="none"}),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=s.href}),a.appendChild(s)}}},De=()=>{document.getElementById(mo)?.remove()},Bn=o=>{De();let e=document.createElement("div");e.id=mo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};return X(t,r),(async()=>{let a=await Pn(o,e);a?(r={status:"linked",contactName:a.name},X(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e)):(r={status:"empty"},X(t,r),Me?.oppId===o&&(Me=null),Nn())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Bn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},X(t,r);try{let i=[ho({tenantId:e,oppId:o,fieldId:po,value:a.id})];a.companyName&&a.companyName.trim()&&i.push(ho({tenantId:e,oppId:o,fieldId:Dn,value:a.companyName.trim()}));let d=(await Promise.all(i))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},X(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e),c.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(i){c.error("Title Officer link failed",i),r={status:"empty"},X(t,r)}}})}),t},$n=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Gn=async()=>{for(let o of $n)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,Tt=async()=>{if(!He){He=!0;try{await Un()}finally{He=!1}}},Un=async()=>{let o=ft();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Gn();if(!r||await U()!=="Transaction Coordination")return;let a=ft();if(!a||a.oppId!==o.oppId||!a.locationId)return;let i=Rn(o.oppId,a.locationId),s=document.createElement("span");s.id=`${R}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(i),r.appendChild(s),c.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Vn(o.oppId),uo(a.locationId)},de=null,kt=null,Pe=()=>{de?.disconnect(),de=null,kt=null},Vn=o=>{if(de&&kt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,de=new MutationObserver(()=>{let t=ft();if(!t||t.oppId!==o||!t.locationId){Pe();return}document.getElementById(R)||Tt(),uo(t.locationId)}),de.observe(e,{childList:!0,subtree:!0}))},yt=null,gt,qn=()=>{yt||(yt=new MutationObserver(()=>{gt===void 0&&(gt=window.setTimeout(()=>{gt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!He&&Tt()},300))}),yt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{qn(),Tt()};var Ue="reos-theme-stylesheet",Ho="reos-theme-fonts",zn=()=>{let o=document.getElementById(Ho);o&&o.remove()},Wn=`
/* ============================================
