/* Wholesaling CRM Customizer v0.15.12 — built 2026-05-30T20:16:24.554Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var je="[wholesaling-crm-customizer]",Xr="__WS_CRM_DEBUG",Jr=()=>!!window[Xr],c={info(...t){console.log(je,...t)},warn(...t){console.warn(je,...t)},error(...t){console.error(je,...t)},debug(...t){Jr()&&console.log(je,"[debug]",...t)}};var To=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dt=/\/v2\/location\/([A-Za-z0-9]+)/,Qr=t=>{let e=t.match(To);if(!e)return null;let o=t.match(Dt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Zr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(To);if(!n)continue;let a=r.match(Dt)||window.location.pathname.match(Dt);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},C=()=>{let t=Qr(window.location.pathname);return t||Zr()};var So=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ye="",Ft=null,me="other",$t=new Set,Ke=()=>{let t=C()?.contactId??null;if(!(!(window.location.pathname!==Ye)&&!(t!==Ft))){Ye=window.location.pathname,Ft=t,me=So(),c.debug("Page/context changed:",me,Ye,"contact:",t);for(let r of $t)try{r(me)}catch(n){c.error("Subscriber threw:",n)}}},Co=t=>($t.add(t),setTimeout(()=>t(me),0),()=>{$t.delete(t)}),Io=()=>{me=So(),Ye=window.location.pathname,Ft=C()?.contactId??null,c.debug("Router init, current page:",me);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Ke()},history.replaceState=function(o,r,n){e(o,r,n),Ke()},window.addEventListener("popstate",Ke),setInterval(Ke,1e3)};var Xe="0.15.12",Je="2026-05-30T20:16:24.555Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let l=n.querySelector(t);if(l){a(l);return}let d,b,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},y={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ot={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},Ao=t=>{let e=t==="emerald"?i.emeraldGlow:t==="amber"?i.amberGlow:i.slate,o=t==="emerald"?i.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=t==="emerald"?i.emerald:t==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,D=`
  ...
  flex-shrink: 0;
`;var en=/^[A-Za-z0-9]{15,30}$/,Ee=t=>typeof t=="string"&&en.test(t),tn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},on=()=>{let t=window.WS_CRM_USER_ID;return Ee(t)?t:null},rn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ee(o))return o;return null},nn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=tn(e);if(!o)return null;let r=o.uid;if(Ee(r))return r;let n=o.claims;if(n&&Ee(n.user_id))return n.user_id}catch{}return null},an=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(Ee(n))return n}catch{}}}catch{}return null},L=()=>on()||rn()||nn()||an()||null;var Fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",sn=`${Fo}/active-follow-up-get`,ln=`${Fo}/active-follow-up-set`,le="ws-crm-active-follow-up-button",Nt={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},dn=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},cn=async t=>{let e=await fetch(sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},bn=async(t,e)=>{let o=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},de=(t,e)=>{let o=Nt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},Lo=t=>{let e=document.createElement("button");return e.type="button",e.id=le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,de(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=dn();if(!(!r||r.contactId!==t)){de(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await bn(r,L()),a=n&&n.state&&n.state in Nt?n.state:"blue";de(e,a),c.info(`Active Follow Up set for ${t} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),de(e,"error"),setTimeout(()=>void Qe(e,r),4e3)}}}),e},Qe=async(t,e)=>{de(t,"loading");try{let o=await cn(e),r=o&&o.state&&o.state in Nt?o.state:"gray",n=document.getElementById(le);if(!n||n.dataset.contactId!==e.contactId)return;de(n,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),de(t,"error")}},hn=[".central-panel","[class*='central-panel']"],Pt="ws-crm-contact-actions-bar",pn=async()=>{for(let t of hn)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},mn=async(t,e)=>{let o=e.querySelector(`#${Pt}`);if(!o)try{o=await I(`#${Pt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Pt}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},un=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},_n=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},vn=async t=>{if(t==="url"){let o=await pn();return o?{kind:"contact-detail",target:o}:null}let e=un();return e?{kind:"conversations",target:e}:null},Mo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await mn(t,e.target);return o}return _n(t,e.target),"conversations-header"},yn=async()=>{let t=C();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(le);if(o&&o.dataset.contactId===e.contactId){Qe(o,e);return}o&&o.remove();let r=await vn(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=C();if(!n||n.contactId!==e.contactId)return;let a=Lo(e.contactId),s=await Mo(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Do();let l=document.getElementById(le)??a;Qe(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(le);if(!(C()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=Lo(e.contactId);Mo(m,r).then(()=>{Do(),Qe(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Te=null,$o=()=>{let t=C()?.contactId??null;if(Te&&Te.contactId===t)return;let e=yn().finally(()=>{Te?.promise===e&&(Te=null)});Te={contactId:t,promise:e}},Do=()=>{let t=document.querySelectorAll(`#${le}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var re="ws-crm-claim-release-pill",gn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",wn=async t=>{let e=await fetch(gn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},xn=async t=>{let e=await fetch(fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},No=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ue=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?i.emerald:i.amber;t.dataset.mode=e,t.style.cssText=Ao(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},kn=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=re,o.type="button",o.dataset.contactId=t,ue(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=C();if(!n||!n.locationId||n.contactId!==t)return;let a=L();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>ue(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${a}`);let s=r==="claim"?"release":"claim";ue(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await xn({contactId:t,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;ue(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),ue(o,r);let d=o.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Oo=async(t,e)=>{try{let o=await wn({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(re);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";ue(r,n)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},En=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=No(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Po=(t,e)=>{let o=kn({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${re}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Tn=async()=>{let t=C();if(!t){document.getElementById(re)?.remove();return}let e=document.getElementById(re);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await I("#record-details-lhs",{timeoutMs:1e4}),r=await En(o),n=C();if(!n||n.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Po(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let a=document.getElementById(re);a&&t.locationId&&Oo(a,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(C()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(re))return;let d=No(o);if(d){Po(d,t.contactId);let b=document.getElementById(re);b&&t.locationId&&Oo(b,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},Ho=()=>{Tn()};var Sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Se=new Map,Bo=async(t,e)=>{if(!t)return null;if(Se.has(t))return Se.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${Sn}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${t}`),Se.set(t,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return Se.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,n),Se.set(t,null),null}};var Ro=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Wo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",An=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:a,kind:s})=>{let l=a||Wo,d;if(s==="buyer"){let h=jo.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let b=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},Ln=async({contactId:t,tenantId:e})=>{let o=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var _e="ws-crm-contact-actions-bar",Mn="ws-crm-call-status-dropdown",Go="ws-crm-offer-made-modal",Dn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],jo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Fn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],$n=async()=>{for(let t of Fn)try{let e=await I(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await I("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},On=({contactId:t,kind:e})=>{let o=e==="buyer"?jo:Dn,r=e==="buyer"?Cn:Wo,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=Mn,a.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=D,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=i.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=s.firstElementChild,m=s.children[1],p=s.children[2];h&&(h.style.background=Ot[d.color]),m&&(m.textContent=d.label),l.style.display="none";let f=C()?.locationId,k=L();if(!f){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=i.amber);return}if(e==="seller"&&d.color==="green"&&!k){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=i.amber);return}let g=p?.textContent??"\u25BE",u=async v=>{p&&(p.textContent="\u2026"),s.style.opacity="0.75";try{await An({contactId:t,locationId:f,status:d.label,userId:k,deadReason:v,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=g),s.style.opacity="1"},900)}catch(E){c.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=i.amber),s.style.opacity="1",setTimeout(()=>{p&&(p.textContent=g),m&&(m.style.color=i.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let v=m?.textContent??"";Bn(E=>{u(E)},()=>{m&&(m.textContent=v)});return}if(e==="seller"&&d.value==="appointment-booked"){let v=m?.textContent??"";try{(await Ln({contactId:t,tenantId:f})).ok?await u():Rn(()=>{u()},()=>{m&&(m.textContent=v)})}catch(E){c.warn("Appointment sanity check failed; firing anyway:",E),await u()}return}await u()}),l.appendChild(b)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(s),a.appendChild(l),a},Pn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Nn=async t=>{let e=await fetch(Pn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Hn=(t,e="seller")=>{document.getElementById(Go)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=o?i.emerald:i.amber,s=document.createElement("div");s.id=Go,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,s.appendChild(l),document.body.appendChild(s);let m=()=>s.remove();s.addEventListener("click",k=>{k.target===s&&m()});let p=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),f=l.querySelector("#ws-offer-submit");_?.addEventListener("click",m),f?.addEventListener("click",async()=>{let k=(l.querySelector("#ws-offer-amount")?.value??"").trim(),g=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!k||Number(k)<=0){p&&(p.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let u=Number(k);if(u<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(u*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),f&&(f.disabled=!0,f.textContent="Recording\u2026",f.style.opacity="0.7"),_&&(_.disabled=!0);try{let w=await Nn({tenantId:T,contactId:t,kind:e,amount:u,expiresAt:g||null,userId:L()});if(!w.ok){p&&(p.textContent=w.error??"Something went wrong."),f&&(f.disabled=!1,f.textContent="Record Offer",f.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${u} on ${w.opp_pipeline} opp (stage: ${w.opp_stage_name??"?"})`),m()}catch(w){c.error("Offer Made webhook failed",w),p&&(p.textContent=w instanceof Error?w.message:"Network error \u2014 try again."),f&&(f.disabled=!1,f.textContent="Record Offer",f.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Uo="ws-crm-dead-deal-modal",Bn=(t,e)=>{document.getElementById(Uo)?.remove();let o=document.createElement("div");o.id=Uo,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),a=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},qo=(t,e)=>{let o=document.createElement("div");if(o.id=_e,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${i.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=Z,r.textContent="Offer Made",r.addEventListener("click",()=>Hn(t,e)),o.appendChild(r),o.appendChild(On({contactId:t,kind:e}))}return o},Ht=!1,Gn=()=>{document.querySelectorAll(`[id="${_e}"]`).forEach(t=>t.remove())},Ko=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ht){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ht=!0;try{await Un()}finally{Ht=!1}},Un=async()=>{let t=C();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Gn();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let b=await Bo(t.contactId,t.locationId),h=Ro(b);h==="buyer"?e="buyer":h==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=C();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${_e}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await $n();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=C();if(!a||a.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=qo(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(_e)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(C()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${_e}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=qo(t.contactId,e);p.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},Vo=null,zn=()=>{Vo===null&&(Vo=window.setInterval(()=>{let t=C();t&&(document.getElementById(_e)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ko()))},3e3))},Yo=()=>{zn(),Ko()};var Ze="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",qn=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ce="data-ws-crm-favicon",Bt=t=>t.hasAttribute(Ce),Xo=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return qn.has(e)},et=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Xo(r)&&!Bt(r)&&r.remove()});let e=document.head.querySelector(`link[${Ce}="1"]`);e?e.href!==Ze&&(e.href=Ze):(e=document.createElement("link"),e.setAttribute(Ce,"1"),e.rel="icon",e.type="image/png",e.href=Ze,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ce}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ce,"apple"),o.rel="apple-touch-icon",o.href=Ze,document.head.appendChild(o))},Jo=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)et();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),et())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Xo(s)&&!Bt(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Bt(s)&&(n=!0)});n&&et()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,et(),e>=5&&window.clearInterval(o)},1e3)};var Vn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Wn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,jn=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(jn);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(Wn);if(n){let a=n[1];if(Vn.includes(a))return a}}return null},Y=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Kn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",z="ws-crm-mt-offer-made-button",Qo="ws-crm-mt-offer-made-modal",Yn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xn=/\/v2\/location\/([A-Za-z0-9]+)/,rt=()=>{let t=window.location.pathname,e=t.match(Yn);if(!e)return null;let o=t.match(Xn);return{oppId:e[1],locationId:o?o[1]:null}},Jn=async t=>{let e=await fetch(Kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},tt=()=>{document.getElementById(Qo)?.remove()},Qn=t=>{tt();let e=document.createElement("div");e.id=Qo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),n=o.querySelector("#ws-mt-offer-error"),a=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&tt()}),a?.addEventListener("click",()=>tt()),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let b=Number(d);if(b<100){n.textContent=`That looks low \u2014 did you mean $${(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await Jn({oppId:t.oppId,locationId:t.locationId,amount:b,userId:L()});if(!h.ok){n.textContent=h.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1);return}tt(),t.onSuccess()}catch(h){c.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1)}})},Zn=t=>{let e=document.createElement("button");return e.id=z,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
      border-radius: 50%;
      background: ${i.emerald};
      box-shadow: 0 0 6px ${i.emerald};
      flex-shrink: 0;
    "></span>
    <span class="ws-mt-om-label">Mark Offer Made</span>
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=rt();!o||!o.locationId||o.oppId!==t||Qn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=D)},4e3)}})}),e},ea=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ta=async()=>{for(let t of ea)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ot=!1,zt=async()=>{if(!ot){ot=!0;try{await oa()}finally{ot=!1}}},oa=async()=>{let t=rt();if(!t||!t.locationId){document.getElementById(z)?.remove(),document.getElementById(`${z}-wrap`)?.remove(),Ae();return}let e=document.getElementById(z);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${z}-wrap`)?.remove(),Ae());return}e&&(e.remove(),document.getElementById(`${z}-wrap`)?.remove());let o=await ta();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=rt();if(!n||n.oppId!==t.oppId)return;let a=Zn(t.oppId),s=document.createElement("span");s.id=`${z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(a),o.appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ra(t.oppId)},Ie=null,Ut=null,Ae=()=>{Ie?.disconnect(),Ie=null,Ut=null},ra=t=>{if(Ie&&Ut===t)return;Ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ut=t,Ie=new MutationObserver(()=>{let o=rt();if(!o||o.oppId!==t){Ae();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(z)?.remove(),document.getElementById(`${z}-wrap`)?.remove(),Ae();return}document.getElementById(z)||zt()}),Ie.observe(e,{childList:!0,subtree:!0}))},Rt=null,Gt,na=()=>{Rt||(Rt=new MutationObserver(()=>{Gt===void 0&&(Gt=window.setTimeout(()=>{Gt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);t&&!e&&!ot&&zt()},300))}),Rt.observe(document.body,{childList:!0,subtree:!0}))},Zo=()=>{na(),zt()};var aa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",q="ws-crm-not-interested-button",sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ia=/\/v2\/location\/([A-Za-z0-9]+)/,at=()=>{let t=window.location.pathname,e=t.match(sa);if(!e)return null;let o=t.match(ia);return{oppId:e[1],locationId:o?o[1]:null}},la=async t=>{let e=await fetch(aa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},da=t=>{let e=document.createElement("button");return e.id=q,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
      border-radius: 50%;
      background: ${i.crimson};
      box-shadow: 0 0 6px ${i.crimson};
      flex-shrink: 0;
    "></span>
    <span class="ws-ni-label">Mark Not Interested</span>
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=at();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await la({oppId:o.oppId,locationId:o.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},ca=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ba=async()=>{for(let t of ca)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},nt=!1,jt=async()=>{if(!nt){nt=!0;try{await ha()}finally{nt=!1}}},ha=async()=>{let t=at();if(!t||!t.locationId){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Me();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove(),Me());return}e&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove());let o=await ba();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=at();if(!n||n.oppId!==t.oppId)return;let a=da(t.oppId),s=document.createElement("span");s.id=`${q}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(a),o.appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),pa(t.oppId)},Le=null,Wt=null,Me=()=>{Le?.disconnect(),Le=null,Wt=null},pa=t=>{if(Le&&Wt===t)return;Me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wt=t,Le=new MutationObserver(()=>{let o=at();if(!o||o.oppId!==t){Me();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Me();return}document.getElementById(q)||jt()}),Le.observe(e,{childList:!0,subtree:!0}))},qt=null,Vt,ma=()=>{qt||(qt=new MutationObserver(()=>{Vt===void 0&&(Vt=window.setTimeout(()=>{Vt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(q);t&&!e&&!nt&&jt()},300))}),qt.observe(document.body,{childList:!0,subtree:!0}))},er=()=>{ma(),jt()};var ua="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",V="ws-crm-reduce-price-button",tr="ws-crm-reduce-price-modal",_a=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,va=/\/v2\/location\/([A-Za-z0-9]+)/,lt=()=>{let t=window.location.pathname,e=t.match(_a);if(!e)return null;let o=t.match(va);return{oppId:e[1],locationId:o?o[1]:null}},ya=async t=>{let e=await fetch(ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},st=()=>{document.getElementById(tr)?.remove()},ga=t=>{st();let e=document.createElement("div");e.id=tr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),a=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let b=r.value.replace(/[^0-9.]/g,"").split(".");r.value=b[0]+(b.length>1?"."+b.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&st()}),a?.addEventListener("click",()=>{st()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let b=parseFloat(d);if(!Number.isFinite(b)||b<=0){n.textContent="Price must be a positive number.",r.focus();return}if(b<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await ya({oppId:t.oppId,locationId:t.locationId,newPrice:b,userId:L()}),st(),t.onSuccess()}catch(h){c.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},fa=(t,e)=>{let o=document.createElement("button");return o.id=V,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
      border-radius: 50%;
      background: ${i.amber};
      box-shadow: 0 0 6px ${i.amber};
      flex-shrink: 0;
    "></span>
    <span class="ws-rp-label">Reduce Price and Alert Buyers</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=lt();!r||!r.locationId||r.oppId!==t||ga({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),a=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=i.emeraldGlow,o.style.color=i.emeraldBright,o.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=D,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),o},wa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xa=async()=>{for(let t of wa)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},it=!1,Jt=async()=>{if(!it){it=!0;try{await ka()}finally{it=!1}}},ka=async()=>{let t=lt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await xa();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=lt();if(!n||n.oppId!==t.oppId)return;let a=fa(t.oppId,t.locationId),s=document.createElement("span");s.id=`${V}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(a),o.appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Ea(t.oppId)},De=null,Xt=null,Fe=()=>{De?.disconnect(),De=null,Xt=null},Ea=t=>{if(De&&Xt===t)return;Fe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Xt=t,De=new MutationObserver(()=>{let o=lt();if(!o||o.oppId!==t){Fe();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}document.getElementById(V)||Jt()}),De.observe(e,{childList:!0,subtree:!0}))},Kt=null,Yt,Ta=()=>{Kt||(Kt=new MutationObserver(()=>{Yt===void 0&&(Yt=window.setTimeout(()=>{Yt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!it&&Jt()},300))}),Kt.observe(document.body,{childList:!0,subtree:!0}))},or=()=>{Ta(),Jt()};var ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ne="ws-crm-send-to-closing-office-button",ce="ws-crm-send-to-title-co-wrap",bt="ws-crm-stc-dropdown",Sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ca=/\/v2\/location\/([A-Za-z0-9]+)/,ht=()=>{let t=window.location.pathname,e=t.match(Sa);if(!e)return null;let o=t.match(Ca);return{oppId:e[1],locationId:o?o[1]:null}},Ia=5*60*1e3,sr=t=>`ws-crm-stc-cache:${t}`,Aa=t=>{try{let e=window.localStorage.getItem(sr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ia||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},La=(t,e)=>{try{window.localStorage.setItem(sr(t),JSON.stringify(e))}catch{}},Ma=async(t,e)=>{try{let o=await fetch(ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Da=async(t,e,o)=>{let r=await fetch(ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Fa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},rr=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},$a=(t,e)=>{if(e&&Fa(e)){window.setTimeout(()=>rr(t),300);return}rr(t)},W=()=>{document.getElementById(bt)?.remove()},dt=(t,e,o)=>{W();let r=document.createElement("div");r.id=bt;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${y.sans};
  `;let a=t.length,s=t.filter(_=>_.filled).length,l=s===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${y.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
      text-transform: uppercase;
      color: ${l?i.emerald:i.amber};
      margin-bottom: 4px;
    ">${l?"Ready to send":"Required fields"}</div>
    <div style="font-size: 14px; font-weight: 500; color: ${i.bone}; margin-bottom: 6px;">${s} of ${a} ready</div>
    ${e?`<div style="
            font-size: 11px;
            color: ${i.amber};
            margin: 6px 0 4px;
            ...
            background: ${i.slate};
            border-radius: ${x.sm};
            border-left: 2px solid ${i.amber};
          ">Previously sent: ${new Date(e).toLocaleString()}.
          Clicking Send again will re-send.</div>`:""}
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...b.filter(_=>h[_]),...Object.keys(h).filter(_=>!b.includes(_))];for(let _ of m){let f=h[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${y.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${i.steel};
    `,g.textContent=_,k.appendChild(g),f.forEach(u=>{let v=document.createElement("div"),E=!u.filled&&u.navigable&&u.field_id;v.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${x.sm};
        font-size: 12px;
        color: ${u.filled?i.bone:i.ash};
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(v.addEventListener("mouseenter",()=>{v.style.background=i.slate}),v.addEventListener("mouseleave",()=>{v.style.background="transparent"}),v.addEventListener("click",S=>{S.stopPropagation(),u.field_id&&($a(u.field_id,u.folder),W())}));let T=u.filled?`<span style="color: ${i.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${i.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,w=E?`<span style="margin-left: auto; color: ${i.ash}; font-size: 11px;">\u2192</span>`:"";v.innerHTML=`${T}<span style="flex: 1;">${u.label}</span>${w}`,k.appendChild(v)}),r.appendChild(k)}document.body.appendChild(r);let p=_=>{let f=_.target;!r.contains(f)&&!o.contains(f)&&(W(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},X=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),n=t.querySelector(".ws-stc-chevron"),a,s,l=i.bone,d,b="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",s=i.steel,l=i.ash,d=i.coolGray,b="Checking\u2026",m="wait",p="0.8";break;case"ready":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,f=e.checks?.length??0;a="transparent",s=i.amber,l=i.amber,d=i.amber,b=`${_} of ${f} fields ready`,h="\u25BE";break}case"sending":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",p="0.8";break;case"sent":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",s=i.amber,l=i.amber,d=i.amber,b=e.message??"Try again";break}t.style.background=a,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=b),n&&(n.textContent=h)},Oa=(t,e)=>{let o=document.createElement("button");o.id=ne,o.type="button",o.dataset.oppId=t;let r=Aa(t),n=r?{status:r.checks.every(g=>g.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${Z}
    background: transparent;
    border: 1px solid ${i.steel};
    color: ${i.ash};
  ...
  `,X(o,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let g=await Ma(t,e);if(!g){n={status:"error",message:"Check failed \u2014 click to retry"},X(o,n);return}if(g.rate_limited){_=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},X(o,n),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){n={status:"error",message:g.error||"Check failed \u2014 click to retry"},X(o,n),c.warn("[stc] dry_run returned no checks:",g);return}let u=g.pipeline_name;if(u&&u!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${u}" (not TC) \u2014 retracting button + caching`),pt.add(t),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),Oe();return}let v=g.checks;if(n.checks&&n.checks.length===g.checks.length){let T=new Set;v=g.checks.map((w,S)=>n.checks[S]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:v.every(T=>T.filled)?"ready":"incomplete",checks:v,previouslySentAt:g.previously_sent_at??null},La(t,{checks:v,previously_sent_at:g.previously_sent_at??null,pipeline_name:u,ts:Date.now()}),X(o,n),document.getElementById(bt)&&dt(v,g.previously_sent_at,o)},l=async()=>{let g=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},X(o,n),W();try{let u=await Da(t,e,g);if(u.needs_confirm){n={status:"ready",checks:u.checks,previouslySentAt:u.previously_sent_at},X(o,n),u.checks&&dt(u.checks,u.previously_sent_at,o);return}if(u.ok){n={status:"sent",checks:u.checks,previouslySentAt:new Date().toISOString()},X(o,n),window.setTimeout(()=>{f()},3500);return}n={status:"error",checks:u.checks,message:u.error||"Validation failed"},X(o,n),u.checks&&dt(u.checks,u.previously_sent_at,o)}catch(u){c.error("[stc] send failed:",u),n={status:"error",message:"Network error \u2014 click to retry"},X(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(bt)?W():n.checks&&dt(n.checks,n.previouslySentAt,o);break}case"error":case"sent":f();break}});let d,b=!1,h=Date.now(),m=1e4,p=5*60*1e3,_=0,f=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,h=Date.now();try{await s()}finally{b=!1}}};f();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let g=new MutationObserver(()=>{if(d!==void 0||b)return;let v=Date.now()-h,E=Math.max(1500,m-v);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&f()},E)});g.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let u=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(u))},5e3)}return o},Pa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Na=async()=>{for(let t of Pa)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},pt=new Set,nr=null,Ha=t=>{t&&t!==nr&&(pt.clear(),nr=t)},ct=!1,to=async()=>{if(ct){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}ct=!0;try{await Ba()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{ct=!1}},Ba=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=ht();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Ha(t.oppId),pt.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(ce)?.remove(),W(),Oe());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ce)?.remove(),W()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Na();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=ht();if(!n||n.oppId!==t.oppId||!n.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=Oa(t.oppId,n.locationId),s=document.createElement("span");s.id=ce,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(a),o.appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(a)}`),Ra(t.oppId)},$e=null,eo=null,Oe=()=>{$e?.disconnect(),$e=null,eo=null},Ra=t=>{if($e&&eo===t)return;Oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(eo=t,$e=new MutationObserver(()=>{let o=ht();if(!o||o.oppId!==t){Oe();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),Oe();return}document.getElementById(ne)||to()}),$e.observe(e,{childList:!0,subtree:!0}))},Qt=null,Zt,Ga=()=>{Qt||(Qt=new MutationObserver(()=>{Zt===void 0&&(Zt=window.setTimeout(()=>{Zt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);if(t&&!e&&!ct){let o=ht();if(o&&pt.has(o.oppId))return;to()}},300))}),Qt.observe(document.body,{childList:!0,subtree:!0}))},ir=()=>{Ga(),to()};var Ua="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",za="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",qa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",cr="ldtyB2UXKi9vOp8nLUH7",Va="WVD2gb9swLsgcdBEtDVq",j="ws-crm-closing-agent-picker-button",br="ws-crm-closing-agent-picker-modal",Wa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ja=/\/v2\/location\/([A-Za-z0-9]+)/,He=()=>{let t=window.location.pathname,e=t.match(Wa);if(!e)return null;let o=t.match(ja);return{oppId:e[1],locationId:o?o[1]:null}},co=async t=>{let e=await fetch(Ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},lr=async t=>{let e=await fetch(za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ka=async(t,e)=>{try{let o=await fetch(qa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:cr}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await co({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},be=null,Ya=60*60*1e3,bo=t=>`ws-crm-to-cache:${t}`,hr=t=>{try{let e=window.localStorage.getItem(bo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ya||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},pr=(t,e,o)=>{try{window.localStorage.setItem(bo(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Xa=t=>{try{window.localStorage.removeItem(bo(t))}catch{}},ao="ws-crm-closing-agent-field-link",Ja=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${ao}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},oo=!1,ho=async t=>{if(oo)return;let e=mr();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){oo=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await co({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),so(n.id,n.name,t);let a=document.getElementById(j);if(a){ae(a,{status:"linked",contactName:n.name});let s=He();s&&pr(s.oppId,n.id,n.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{oo=!1}}},Qa=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,mr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let b=(d.textContent||"").trim();Qa.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&c.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},so=(t,e,o)=>{let r=mr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${ao}`).forEach(s=>s.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=ao,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},mt=()=>{document.getElementById(br)?.remove()},Za=t=>{mt();let e=document.createElement("div");e.id=br,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    <div id="ws-top-results"
      style="
        ...
        border: 1px solid ${i.steel};
        border-radius: ${x.sm};
        background: ${i.obsidian};
        margin-bottom: 16px;
      ">
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),a=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&mt()}),a?.addEventListener("click",mt);let s,l="",d=async b=>{if(n&&b!==l){if(l=b,!b.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
      ...
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
        ...
        `,p.innerHTML=`
          ...
          <div style="color: ${i.ash}; font-size: 11px; margin-top: 2px;">
            ${ut(m.email||"(no email)")} \xB7 ${ut(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${ut(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=i.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{mt(),t.onPick(m)}),n.appendChild(p)})}catch(h){c.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${i.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(b)},250)})},ut=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ae=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",a=i.amber,s=i.bone,l="transparent",d=i.steel,b="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=i.coolGray,s=i.ash,b="wait";break;case"empty":n="Link Closing Agent",a=i.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=i.emerald,l=i.emeraldGlow,d=i.emeraldBorder,s=i.emeraldBright;break;case"saving":n="Linking\u2026",a=i.coolGray,s=i.ash,b="wait";break}o&&(o.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=b},es=(t,e)=>{let o=document.createElement("button");o.id=j,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ae(o,r);let n=hr(t);return n&&(r={status:"linked",contactName:n.contactName},ae(o,r),be={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let s=await Ka(t,e);s?(r={status:"linked",contactName:s.name},ae(o,r),be={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},so(s.id,s.name,e)):n||(r={status:"empty"},ae(o,r),be?.oppId===t&&(be=null),Ja(),Xa(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Za({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ae(o,r);try{let l=[lr({tenantId:e,oppId:t,fieldId:cr,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(lr({tenantId:e,oppId:t,fieldId:Va,value:s.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:s.name},ae(o,r),be={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},pr(t,s.id,s.name),so(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},ae(o,r)}}})}),o},ts=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],os=async()=>{for(let t of ts)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Pe=!1,vt=async()=>{if(!Pe){Pe=!0;try{await rs()}finally{Pe=!1}}},rs=async()=>{let t=He();if(!t||!t.locationId){document.getElementById(j)?.remove(),document.getElementById(`${j}-wrap`)?.remove(),_t();return}let e=document.getElementById(j);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove(),_t());return}e&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await os();if(!r||!(hr(t.oppId)!==null||be!==null&&be.oppId===t.oppId)&&await Y()!=="Transaction Coordination")return;let a=He();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=es(t.oppId,a.locationId),l=document.createElement("span");l.id=`${j}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),ns(t.oppId),ho(a.locationId)},Ne=null,io=null,lo=null,_t=()=>{Ne?.disconnect(),Ne=null,io=null,lo=null},ns=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ne&&io===t&&lo===e||(_t(),io=t,lo=e,Ne=new MutationObserver(()=>{let o=He();if(!o||o.oppId!==t||!o.locationId){_t();return}document.getElementById(j)||vt(),ho(o.locationId)}),Ne.observe(e,{childList:!0,subtree:!0})))},ro=null,no,as=()=>{ro||(ro=new MutationObserver(()=>{no===void 0&&(no=window.setTimeout(()=>{no=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);t&&!e&&!Pe&&vt()},300))}),ro.observe(document.body,{childList:!0,subtree:!0}))},dr,ss=()=>{dr===void 0&&(dr=window.setInterval(()=>{let t=He();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(j)&&!Pe&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),vt()),ho(t.locationId)},2e3))},ur=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),as(),ss(),vt()};var is="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",uo="ws-crm-prepare-contract-button",_r="ws-crm-prepare-contract-menu",Q="ws-crm-prepare-contract-modal",vr="ws-crm-modal-date-style",ee="https://services.leadconnectorhq.com",xr=()=>{if(document.getElementById(vr))return;let t=document.createElement("style");t.id=vr,t.textContent=`
  ...
  `,document.head.appendChild(t)},_o="__WS_CRM_CAPTURED_AUTH",ls=50*60*1e3,kr=()=>{try{let t=localStorage.getItem(_o);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>ls?(localStorage.removeItem(_o),null):e:null}catch{return null}},ds=t=>{try{localStorage.setItem(_o,JSON.stringify(t))}catch{}},te=()=>{let t=kr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},yr=!1,cs=()=>{if(yr)return;yr=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=kr()?.authorization;ds({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=b.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,s=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Er=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},bs=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Er()},hs=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Tr="__WS_CRM_TEMPLATES_CACHE_V1",ps=24*60*60*1e3,gr=t=>{try{let e=window.localStorage.getItem(Tr);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>ps?null:o.templates}catch{return null}},ms=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Tr,JSON.stringify(o))}catch{}},us=async t=>{let e=`${ee}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:te()})}catch(s){let l=gr(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=gr(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items);let a=n.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:hs(s.name||s.title||"")})).filter(s=>!!s.id);return a.length>0&&ms(t,a),a},_s=async(t,e)=>{let o=await fetch(`${ee}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:te()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let a=await fetch(`${ee}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:te()});if(!a.ok)throw new Error(`ACQ opp search ${a.status}`);return((await a.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},vs=async(t,e)=>{let o=await fetch(`${ee}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:te()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${ee}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:te()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-h})},ys=async t=>{let e=await fetch(is,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},gs=async(t,e,o)=>{let r=`${ee}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:te()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let a=await n.json(),s=a._id||a.id||a.proposal?._id||a.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},fs=async(t,e)=>{let o=await fetch(`${ee}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:te()});if(!o.ok){let a=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${a.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},ws=async t=>{let e=await fetch(`${ee}/contacts/${t}`,{method:"GET",headers:te()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},xs=async(t,e,o,r)=>{let n;try{n=await fs(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let a;try{a=await ws(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${a.firstName} ${a.lastName}`.trim()||a.email||o,l={id:o,firstName:a.firstName,lastName:a.lastName,email:a.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${ee}/proposals/document/${e}`,{method:"PUT",headers:{...te(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let _=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:_}}return{ok:!0}},ks=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},gt="__WS_CRM_PENDING_INSTRUCTIONS",Es=60*1e3,Ts=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ss=t=>{let e=(t||"").toLowerCase();for(let o of Ts)if(e.includes(o.matches.toLowerCase()))return o;return null},Cs=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(gt,JSON.stringify(r))}catch{}},Is=()=>{try{let t=localStorage.getItem(gt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Es?(localStorage.removeItem(gt),null):e}catch{return null}},As=()=>{try{localStorage.removeItem(gt)}catch{}},Ls=(t,e)=>{document.getElementById(Q)?.remove();let o=document.createElement("div");o.id=Q,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let r=document.createElement("div");r.style.cssText=`
    ...
    overflow-y: auto;
    background: ${i.graphite};
    border: 1px solid ${i.emerald};
    border-left: 4px solid ${i.emerald};
    border-radius: ${x.lg};
    padding: 28px 32px;
    color: ${i.bone};
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Ms=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ds=()=>{let t=window.location.pathname.match(Ms);if(!t)return;let e=t[1],o=Is();o&&o.proposalId===e&&(As(),window.setTimeout(()=>{Ls(o.title,o.bodyHtml)},600))},fr="ws-crm-prepare-contract-toast",$=(t,e="info",o=4e3)=>{document.getElementById(fr)?.remove();let r=document.createElement("div");r.id=fr;let n=e==="error"?i.crimson:i.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},wr=(t,e)=>new Promise(o=>{document.getElementById(Q)?.remove();let r=document.createElement("div");r.id=Q,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let n=document.createElement("div");n.style.cssText=`
      ...
      color: ${i.bone};
      box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
    `;let a=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        ...
        ">
          ...
          ${d.updatedAt?`<div style="font-size: 11px; color: ${i.ash}; margin-top: 4px;">Last updated ${B(a(d.updatedAt))}</div>`:""}
        </button>
      `).join("");n.innerHTML=`
      <div style="
        font-family: ${y.mono};
    ...
    `,r.appendChild(n),document.body.appendChild(r);let l=d=>{r.remove(),o(d)};r.addEventListener("click",d=>{d.target===r&&l(null)}),n.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>l(null)),n.querySelectorAll(".ws-pc-acq-opp").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.borderColor=i.emerald,d.style.background=i.graphite}),d.addEventListener("mouseleave",()=>{d.style.borderColor=i.steel,d.style.background=i.slate}),d.addEventListener("click",b=>{b.stopPropagation(),b.preventDefault();let h=d.dataset.oppId||"";h&&l(h)})})}),Fs=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(Q)?.remove(),xr();let n=r.debug||{},a=typeof n.propertyAddress=="string"?n.propertyAddress:"",s=typeof n.sellerName=="string"?n.sellerName:"",l=typeof n.purchasePrice=="number"?n.purchasePrice:0,d=typeof n.emd=="number"?n.emd:0,b=typeof n.cashAtClose=="number"?n.cashAtClose:l-d,h=n.daysToClose===void 0||n.daysToClose===null||n.daysToClose===""?"":String(n.daysToClose),m=n.inspectionDays===void 0||n.inspectionDays===null||n.inspectionDays===""?"":String(n.inspectionDays),p=typeof n.additionalTerms=="string"?n.additionalTerms:"",_=typeof n.currentOccupancy=="string"?n.currentOccupancy:"",f=typeof n.occupancyAtClose=="string"?n.occupancyAtClose:"",k=Array.isArray(n.occupancyOptions)&&n.occupancyOptions.length>0?n.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],g=document.createElement("div");g.id=Q,g.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,K=`
    ...
    min-width: 0;
    appearance: none;
    background-image: linear-gradient(45deg, transparent 50%, ${i.ash} 50%), linear-gradient(135deg, ${i.ash} 50%, transparent 50%);
    background-position: calc(100% - 14px) 50%, calc(100% - 8px) 50%;
    background-size: 6px 6px;
    background-repeat: no-repeat;
    padding-right: 28px;
  `,Ve=F=>['<option value="">(unset)</option>'].concat(k.map(O=>`<option value="${J(O)}"${O===F?" selected":""}>${B(O)}</option>`)).join("");u.innerHTML=`
    <div style="
      font-family: ${y.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${S}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${J(s)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${v}">Purchase Price</div>
        <div style="${A}">
          <span style="color: ${i.ash}; font-size: 13px;">$</span>
      ...
      <div style="${S}">
        ...
        <select id="ws-pc-current-occupancy" style="${K}">${Ve(_)}</select>
      </div>
      <div style="${S}">
  ...
  `,g.appendChild(u),document.body.appendChild(g);let H=u.querySelector("#ws-pc-purchase-price"),se=u.querySelector("#ws-pc-emd"),oe=u.querySelector("#ws-pc-cash-at-close"),ie=!1;oe?.addEventListener("input",()=>{ie=!0});let ve=()=>{if(ie)return;let F=Number(H?.value||0),O=Number(se?.value||0);oe&&(oe.value=String(Math.max(0,F-O)))};H?.addEventListener("input",ve),se?.addEventListener("input",ve);let We=()=>g.remove();g.addEventListener("click",F=>{F.target===g&&We()}),u.querySelector("#ws-pc-cancel")?.addEventListener("click",We);let U=u.querySelector("#ws-pc-submit"),G=u.querySelector("#ws-pc-error");U?.addEventListener("click",async()=>{if(U){G&&(G.textContent=""),U.disabled=!0,U.textContent="Opening\u2026";try{let F=(u.querySelector("#ws-pc-seller-name")?.value||"").trim(),O=Number(H?.value||0),ye=Number(se?.value||0),ge=Number(oe?.value||0),fe=(u.querySelector("#ws-pc-days-to-close")?.value??"").trim(),we=(u.querySelector("#ws-pc-inspection-days")?.value??"").trim(),xe=(u.querySelector("#ws-pc-additional-terms")?.value??"").trim(),pe=(u.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),ke=(u.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(F!==s&&(P.sellerName=F),O!==l&&(P.purchasePrice=O),ye!==d&&(P.emd=ye),ge!==b&&(P.cashAtClose=ge),fe!==h&&(P.daysToClose=fe),we!==m&&(P.inspectionDays=we),xe!==p&&(P.additionalTerms=xe),pe!==_&&(P.currentOccupancy=pe),ke!==f&&(P.occupancyAtClose=ke),Object.keys(P).length>0){c.info("[prepare-contract] PA modal submit with overrides:",P),U.textContent="Saving\u2026";let At=L(),Lt=await ft({tenantId:t,contactId:e,template:o,userId:At,overrides:P});c.info("[prepare-contract] re-stage with overrides ok:",Lt),U.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let N=a?`${a} - Purchase Agreement`:void 0;await go(t,e,o,N)}catch(F){U.disabled=!1,U.textContent="Open Contract",G&&(G.textContent=F.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",F)}}})},$s=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:a,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(Q)?.remove(),xr();let d=n.debug||{},b=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,f=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",g=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",u=s,v=l,E="",T=document.createElement("div");T.id=Q,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;w.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${H}">
        <div style="${S}">Buyer LLC <span style="color: ${i.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${y.sans};">(assignee)</span></div>
        <input id="ws-pc-buyer-llc" type="text" value="${J(g)}" placeholder="Buyer's entity / LLC name" style="${A}" />
      </div>
      <div style="${H}">
      ...
      <div style="${H}">
        ...
        <div style="${se}">
          <span style="color: ${i.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${_}" style="${K}" />
        </div>
      </div>
      <div style="${H}">
      ...
      <div style="${H}">
        ...
        <input id="ws-pc-closing-date" type="date" value="${J(u)}" style="${A}" />
      </div>
      <div style="${H}">
        <div style="${S}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${J(v)}" style="${A}" />
      </div>
      <div style="${H}">
        <div style="${S}">Lender Source <span style="color: ${i.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${y.sans};">(optional)</span></div>
  ...
  `,T.appendChild(w),document.body.appendChild(T);let oe=w.querySelector("#ws-pc-assignment-price"),ie=w.querySelector("#ws-pc-assignment-fee"),ve=!1;ie?.addEventListener("input",()=>{ve=!0});let We=()=>{if(ve)return;let O=Number(oe?.value||0);ie&&(ie.value=String(Math.max(0,O-f)))};oe?.addEventListener("input",We);let U=()=>T.remove();T.addEventListener("click",O=>{O.target===T&&U()}),w.querySelector("#ws-pc-cancel")?.addEventListener("click",U);let G=w.querySelector("#ws-pc-submit"),F=w.querySelector("#ws-pc-error");G?.addEventListener("click",async()=>{if(!G)return;F&&(F.textContent="");let O=(w.querySelector("#ws-pc-seller-name")?.value||"").trim(),ye=Number(oe?.value||0),ge=Number(w.querySelector("#ws-pc-buyer-emd")?.value||0),fe=Number(ie?.value||0),we=(w.querySelector("#ws-pc-closing-office")?.value||"").trim(),xe=(w.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),pe=(w.querySelector("#ws-pc-closing-date")?.value||"").trim(),ke=(w.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),P=(w.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!pe){F&&(F.textContent="Closing Date is required.");return}G.disabled=!0,G.textContent="Opening\u2026";try{let N={};O!==h&&(N.sellerName=O),ye!==m&&(N.assignmentPrice=ye),ge!==p&&(N.buyerEMD=ge),fe!==_&&(N.assignmentFee=fe),we!==k&&(N.closingOffice=we),xe!==g&&(N.buyerCompanyName=xe);let At=pe!==u||ke!==v||P!==E,Lt=Object.keys(N).length>0||At,Mt=n;Lt?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",N),G.textContent="Saving\u2026",Mt=await ft({tenantId:t,contactId:e,template:o,oppId:r,closingDate:pe,buyerEarnestDueDate:ke,lenderSource:P,userId:a,overrides:Object.keys(N).length>0?N:void 0}),c.info("[prepare-contract] AA re-stage ok:",Mt),G.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Eo=Mt?.debug?.propertyAddress||b,Yr=Eo?`${Eo} - Assignment Agreement`:void 0;await go(t,e,o,Yr),U()}catch(N){G.disabled=!1,G.textContent="Open Contract",F&&(F.textContent=N.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",N)}})},ft=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await ys({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},go=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await gs(t,o.id,e);c.info(`[prepare-contract] proposal created: ${n}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let a=await xs(t,n,e,r);a.ok?c.info(`[prepare-contract] contact attached to proposal ${n}`):(c.warn(`[prepare-contract] attach failed (status=${a.status??"n/a"}): ${a.body?.slice(0,300)??"no body"}`),$(`Proposal created but couldn't auto-attach contact (HTTP ${a.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",a.body));let s=Ss(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Cs(n,s.title,s.bodyHtml)),ks(t,n)},Os=async t=>{let e=bs(t);if(!e){$("Could not resolve contact context.","error");return}document.getElementById(_r)?.remove();let o=document.createElement("div");o.id=_r,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await us(e.tenantId)}catch(a){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${i.crimson}; font-size: 12px;">
        Failed to load templates: ${B(a.message)}
      </div>`;return}if(n.length===0){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${i.ash}; font-size: 12px;">
        No proposal templates found on this tenant.
      </div>`;return}n.sort((a,s)=>{let l={PA:0,AA:1,passthrough:2};return l[a.type]!==l[s.type]?l[a.type]-l[s.type]:a.name.localeCompare(s.name)}),o.innerHTML="";for(let a of n){let s=document.createElement("button");s.type="button",s.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
      ...
      cursor: pointer;
      transition: background 0.1s ease;
    `;let l=a.type==="PA"?i.emerald:a.type==="AA"?i.blue:i.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let b=L();try{if(a.type==="AA"){let h;if(e.oppId)h=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${h} directly`);else{let u;try{u=await vs(e.tenantId,e.contactId)}catch(v){$(`Failed to load buyer's MT opps: ${v.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",v);return}if(u.length===0){$("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(u.length===1)h=u[0].id,c.info(`[prepare-contract] auto-selected MT opp ${h} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${u.length} opps)`);let v=await wr(u,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!v){c.info("[prepare-contract] MT opp picker cancelled");return}h=v,c.info(`[prepare-contract] picked MT opp ${h}`)}}let m=u=>{let v=u.getFullYear(),E=String(u.getMonth()+1).padStart(2,"0"),T=String(u.getDate()).padStart(2,"0");return`${v}-${E}-${T}`},p=u=>{let v=new Date;return v.setDate(v.getDate()+u),m(v)},_=p(45),f=p(7);$("Reading contract data\u2026","info",2500);let k;try{k=await ft({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:h,closingDate:_,buyerEarnestDueDate:f,userId:b})}catch(u){$(`Failed to prepare contract: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",u);return}let g=e.contactId||k.contact_id||"";if(!g){$("Could not resolve buyer contact for this opp.","error",6e3);return}$s({tenantId:e.tenantId,contactId:g,template:a,oppId:h,staged:k,userId:b,defaultClosingDate:_,defaultEMDDueDate:f})}else if(a.type==="PA"){if(!e.contactId){$("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let h;try{h=await _s(e.tenantId,e.contactId)}catch(_){$(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(h.length===0){$("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let _=await wr(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}$("Reading contract data\u2026","info",2500);let p;try{p=await ft({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,userId:b})}catch(_){$(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Fs({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:p})}else{if(!e.contactId){$("This template needs to be started from a contact page.","error",6e3);return}$(`Opening ${a.name}\u2026`,"info",2500);try{await go(e.tenantId,e.contactId,a)}catch(h){$(`Failed to open contract: ${h.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){c.warn("[prepare-contract] picker click handler failed:",h),$(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(s)}},Sr=()=>{let t=document.createElement("button");return t.id=uo,t.type="button",t.style.cssText=`${D} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${i.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=i.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=i.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Os(t)}),t},Ps="ws-crm-contact-actions-bar",Ns=async()=>{let t=Er();if(!t){document.getElementById(uo)?.remove();return}let e=null;try{e=await I(`#${Ps}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(uo);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Sr();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},he="ws-crm-prepare-contract-button-opp",Be=`${he}-wrap`,Hs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bs=/\/v2\/location\/([A-Za-z0-9]+)/,Rs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],vo=()=>{let t=window.location.pathname,e=t.match(Hs);if(!e)return null;let o=t.match(Bs);return o?{oppId:e[1],tenantId:o[1]}:null},Gs=async()=>{for(let t of Rs)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yt=!1,Re=null,yo=null,po=null,mo,Ge=()=>{Re?.disconnect(),Re=null,yo=null},Us=t=>{if(Re&&yo===t)return;Ge();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yo=t,Re=new MutationObserver(()=>{let o=vo();if(!o||o.oppId!==t){Ge();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(he)?.remove(),document.getElementById(Be)?.remove(),Ge();return}document.getElementById(he)||fo()}),Re.observe(e,{childList:!0,subtree:!0}))},zs=()=>{po||(po=new MutationObserver(()=>{mo===void 0&&(mo=window.setTimeout(()=>{mo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(he);t&&!e&&!yt&&fo()},300))}),po.observe(document.body,{childList:!0,subtree:!0}))},fo=async()=>{if(!yt){yt=!0;try{let t=vo();if(!t){document.getElementById(he)?.remove(),document.getElementById(Be)?.remove(),Ge();return}let e=document.getElementById(he);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Be)?.remove(),Ge());return}e&&(e.remove(),document.getElementById(Be)?.remove());let o=await Gs();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await Y();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=vo();if(!n||n.oppId!==t.oppId)return;let a=Sr();a.id=he,a.dataset.oppId=t.oppId,a.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Be,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(a),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Us(t.oppId)}finally{yt=!1}}},Cr=()=>{Ds(),Ns(),zs(),fo()};cs();function B(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function J(t){return B(t)}var St="reos-theme-stylesheet",Vr="reos-theme-fonts",qs=()=>{let t=document.getElementById(Vr);t&&t.remove()},Vs=`
/* ============================================
