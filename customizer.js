/* Wholesaling CRM Customizer v0.41.10 — built 2026-06-17T13:16:27.700Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var lo="[wholesaling-crm-customizer]",wd="__WS_CRM_DEBUG",kd=()=>!!window[wd],c={info(...e){console.log(lo,...e)},warn(...e){console.warn(lo,...e)},error(...e){console.error(lo,...e)},debug(...e){kd()&&console.log(lo,"[debug]",...e)}};var Ed=/\/v2\/location\/([A-Za-z0-9]+)/,Td=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let e=window.location.pathname.match(Ed);return e?e[1]:null},kr=()=>{let e=re();return e!==null&&Td.has(e)};var Na=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Er=/\/v2\/location\/([A-Za-z0-9]+)/,Sd=e=>{let t=e.match(Na);if(!t)return null;let o=e.match(Er);return{contactId:t[1],locationId:o?o[1]:null,source:"url"}},Cd=()=>{let e=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let t of e){let o=document.querySelector(t);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Na);if(!a)continue;let i=r.match(Er)||window.location.pathname.match(Er);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},H=()=>{let e=Sd(window.location.pathname);return e||Cd()};var za=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},po="",Tr=null,Fe="other",Sr=new Set,co=()=>{let e=H()?.contactId??null;if(!(!(window.location.pathname!==po)&&!(e!==Tr))){po=window.location.pathname,Tr=e,Fe=za(),c.debug("Page/context changed:",Fe,po,"contact:",e);for(let r of Sr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},ne=e=>(Sr.add(e),setTimeout(()=>e(Fe),0),()=>{Sr.delete(e)}),qa=()=>{Fe=za(),po=window.location.pathname,Tr=H()?.contactId??null,c.debug("Router init, current page:",Fe);let e=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(o,r,a){e(o,r,a),co()},history.replaceState=function(o,r,a){t(o,r,a),co()},window.addEventListener("popstate",co),setInterval(co,1e3)},mo=()=>Fe;var bo="0.41.10",ho="2026-06-17T13:16:27.701Z";var $=(e,t={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=t;return new Promise((i,s)=>{let l=a.querySelector(e);if(l){i(l);return}let d,p,m=()=>{h&&h.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},h=new MutationObserver(()=>{let b=a.querySelector(e);b&&(m(),i(b))});h.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let b=a.querySelector(e);b&&(m(),i(b))},r),d=window.setTimeout(()=>{m(),c.warn(`waitForElement timed out for selector: ${e}`),s(new Error(`Selector not found within ${o}ms: ${e}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Cr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ga=e=>{let t=e==="emerald"?n.emeraldGlow:e==="amber"?n.amberGlow:n.slate,o=e==="emerald"?n.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=e==="emerald"?n.emerald:e==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var Ad=/^[A-Za-z0-9]{15,30}$/,ft=e=>typeof e=="string"&&Ad.test(e),Ua=e=>{try{let t=e.split(".");if(t.length!==3)return null;let o=t[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},$d=()=>{let e=window.WS_CRM_USER_ID;return ft(e)?e:null},Ld=()=>{let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let o of t)if(ft(o))return o;return null},Id=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Ua(t);if(!o)return null;let r=o.uid;if(ft(r))return r;let a=o.claims;if(a&&ft(a.user_id))return a.user_id}catch{}return null},Md=()=>{try{let e=["user","tokenUser","currentUser","ghl_user"];for(let t of e){let o=localStorage.getItem(t);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ft(a))return a}catch{}}}catch{}return null},M=()=>$d()||Id()||Ld()||Md()||null,Od=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Ua(t);return o?o.claims??o:null}catch{return null}},Ze=()=>{let e=window.WS_CRM_FORCE_AGENCY;return typeof e=="boolean"?e:Od()?.type==="agency"};var Ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Dd=`${Ka}/active-follow-up-get`,Hd=`${Ka}/active-follow-up-set`,Ne="ws-crm-active-follow-up-button",$r={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Pd=()=>{let e=H();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},Bd=async e=>{let t=await fetch(Dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId}),credentials:"omit"});if(!t.ok)throw new Error(`Get webhook returned ${t.status} ${t.statusText}`);return await t.json()},Rd=async(e,t)=>{let o=await fetch(Hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,triggered_by_user_id:t??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ze=(e,t)=>{let o=$r[t];e.dataset.state=t,e.disabled=!o.clickable,e.style.cursor=o.clickable?"pointer":"default",e.style.background=o.bg,e.style.borderColor=o.border,e.style.color=o.color;let r=e.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=e.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Va=e=>{let t=document.createElement("button");return t.type="button",t.id=Ne,t.dataset.contactId=e,t.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{pc(e,t,()=>Hr(e,t))}),o},Hr=async(e,t)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Jd(e,t),Ir()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}lc(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,e,t)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},lc=(e,t,o,r,a)=>{if(t.state.length+t.county.length+t.city.length+t.zip.length===0){e.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>t[d.key].length>0).map(d=>{let p=t[d.key].map(m=>{let h=d.key==="state"?Zd(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");e.innerHTML=l,e.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",m=d.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(d.disabled=!0,Qd(r,p).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),d.disabled=!1;return}Hr(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),d.disabled=!1}))})})},_o=!1,Za=(e,t)=>{_o=t;let o=ic(e.panelArea);console.log(`[buy-box] setActive(${t}) \u2014 nativePanel=${!!o} panel=${!!e.panel} iconBtn=${!!e.iconBtn}`),t?(e.iconBtn.className=dc,e.iconBtn.dataset.active="true",o&&(e.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),e.panel.style.display="flex",Hr(e.tenantId,e.buyerContactId)):(e.iconBtn.className=ei,delete e.iconBtn.dataset.active,e.panel.style.display="none",o&&(o.style.display=e.nativePanelOriginalDisplay||""))},ei="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",dc="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",cc=e=>{let t=document.createElement("button");return t.id=Qa,t.type="button",t.title="Buy-Box",t.setAttribute("aria-label","Buy-Box"),t.className=ei,t.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${ec.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,t.addEventListener("click",o=>{o.stopPropagation();let r=e();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!_o;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Za(r,a)}),t},pc=(e,t,o)=>{let r=document.getElementById(Ja);r&&r.remove();let a=document.createElement("div");a.id=Ja,a.style.cssText=`
  ...
  `,C=()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");f&&(f.addEventListener("input",()=>{f.value=f.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),f.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),S())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void S()),setTimeout(()=>f.focus(),0))},S=async()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(f?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(I)},E=async f=>{if(!s.granularity||!f)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let B=await Xd(e,t,s.granularity,f);if(!B.ok){T&&(T.textContent=B.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(B){T&&(T.textContent=`Network error: ${B.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Lr=!1,et=null,Tt=null,Xa=()=>{document.getElementById(Qa)?.remove(),document.getElementById(Mr)?.remove(),Tt&&et&&et.nav.removeEventListener("click",Tt,!0),Tt=null,et=null,_o=!1},ti=()=>{mc()},mc=async()=>{if(!Lr){Lr=!0;try{let e=H();if(!e){Xa();return}let t=document.getElementById(Mr);if(t&&t.dataset.buyerContactId===e.contactId&&et)return;Xa();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(h){c.warn("[buy-box] Contact Type fetch failed",h);return}if(Ce(o)!=="buyer")return;if(!e.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([nc(),ac()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=H();if(!s||s.contactId!==e.contactId)return;let l=sc(e.locationId,e.contactId),d=cc(()=>et),p={buyerContactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};et=p;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(d):a.appendChild(d),i.appendChild(l),Tt=h=>{let b=h.target;if(!b||p.iconBtn.contains(b))return;b.closest("button.sidebar-option-button")&&_o&&Za(p,!1)},a.addEventListener("click",Tt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${e.contactId}`)}finally{Lr=!1}}};var ni="ws-properties-nav-icon",Br="ws-properties-panel",oi="ws-properties-modal",Rr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",bc=`${Rr}/list-for-contact`,hc=`${Rr}/create-with-opp`,uc=`${Rr}/add-contact`,vc=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],se=e=>(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),_c=(e,t)=>`/v2/location/${e}/objects/custom_objects.property/detail/${t}`,ai=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <button id="ws-prop-add" type="button" style="${Nr}">+ Add Property</button>
    </div>
    <div id="ws-prop-body" style="flex:1;overflow-y:auto;padding:14px 16px;font-size:13px;color:${n.bone};">
      <div style="color:${n.ash};font-style:italic;">Loading\u2026</div>
    </div>
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Cc(e,t,()=>zr(e,t))}),o},zr=async(e,t)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Fr(bc,{tenant_id:e,contact_id:t});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${se(r.error||"Failed to load properties")}</div>`;return}Sc(o,r.properties||[],e,t)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${se(r.message)}</div>`}},Sc=(e,t,o,r)=>{if(!t.length){e.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}e.innerHTML=t.map(a=>{let i=a.has_acq_opp?`<span style="font-size:10px;color:${n.emeraldBright};border:1px solid ${n.emeraldBorder};border-radius:${v.sm};padding:1px 6px;">Deal &#10003;</span>`:`<span style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 6px;">No deal</span>`,s=(a.roles||[]).map(l=>l==="seller_1"?"Seller 1":l==="seller_2"?"Seller 2":l==="tenant_contact"?"Tenant":l).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
          <div class="ws-prop-open" data-prop="${se(a.property_record_id)}" title="Open property record" style="font-size:13px;font-weight:500;color:${n.bone};cursor:pointer;display:inline-flex;align-items:center;gap:6px;">
            <span style="text-decoration:underline;text-decoration-color:${n.steel};text-underline-offset:3px;">${se(a.address)}</span>
            <span style="color:${n.emeraldBright};font-size:12px;line-height:1;">&#8599;</span>
          </div>
          ${i}
        </div>
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${se(s||"")}${a.property_type?" &middot; "+se(a.property_type):""}</div>
        <div style="margin-top:8px;">
          <button type="button" class="ws-prop-addperson" data-prop="${se(a.property_record_id)}" data-addr="${se(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${u.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${yc} Add person</button>
        </div>
      </div>
    `}).join(""),e.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{Ac(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>zr(o,r))})}),e.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let i=a.dataset.prop||"";i&&(window.location.href=_c(o,i))}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},li=()=>{document.getElementById(oi)?.remove();let e=document.createElement("div");e.id=oi,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`;let t=document.createElement("div");return t.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,e.appendChild(t),document.body.appendChild(e),e.addEventListener("click",o=>{o.target===e&&e.remove()}),{overlay:e,card:t}},Cc=(e,t,o)=>{let{overlay:r,card:a}=li();a.innerHTML=`
    ...
    <select id="wp-type" style="${ue}">
      ...
      ${vc.map(s=>`<option value="${se(s)}">${se(s)}</option>`).join("")}
    </select>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wp-save" type="button" style="${Nr}">Create property + deal</button>
    </div>
  `;let i=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let s=_=>(a.querySelector(_)?.value||"").trim(),l=s("#wp-address"),d=s("#wp-city"),p=s("#wp-state"),m=s("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!l&&!d&&!m){i&&(i.textContent="Enter at least a street address.");return}let b=a.querySelector("#wp-save");b&&(b.disabled=!0,b.textContent="Creating\u2026"),i&&(i.textContent="");try{let _=await Fr(hc,{tenant_id:e,contact_id:t,address:l,city:d,state:p,zip:m,property_type:h||void 0});if(!_.ok){i&&(i.textContent=_.error||"Failed to create property."),b&&(b.disabled=!1,b.textContent="Create property + deal");return}r.remove(),ai("Property + deal created \u2713"),o()}catch(_){i&&(i.textContent=`Network error: ${_.message}`),b&&(b.disabled=!1,b.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},Ac=(e,t,o,r)=>{let{overlay:a,card:i}=li();i.innerHTML=`
    <div style="font-size:17px;font-weight:500;margin-bottom:4px;">Add person</div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:16px;">Attach a person to ${se(o)}.</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wpp-save" type="button" style="${Nr}">Add person</button>
    </div>
  `;let s=i.querySelector("#wpp-err");i.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#wpp-save")?.addEventListener("click",async()=>{let l=i.querySelector("#wpp-role")?.value||"seller_2",d=y=>(i.querySelector(y)?.value||"").trim(),p=d("#wpp-first"),m=d("#wpp-last"),h=d("#wpp-phone"),b=d("#wpp-email");if(!p&&!m){s&&(s.textContent="Enter at least a first or last name.");return}let _=i.querySelector("#wpp-save");_&&(_.disabled=!0,_.textContent="Adding\u2026"),s&&(s.textContent="");try{let y=await Fr(uc,{tenant_id:e,property_record_id:t,role:l,new_contact:{firstName:p,lastName:m,phone:h||void 0,email:b||void 0}});if(!y.ok){s&&(s.textContent=y.error||"Failed to add person."),_&&(_.disabled=!1,_.textContent="Add person");return}a.remove(),ai("Person added \u2713"),r()}catch(y){s&&(s.textContent=`Network error: ${y.message}`),_&&(_.disabled=!1,_.textContent="Add person")}}),setTimeout(()=>i.querySelector("#wpp-first")?.focus(),0)},go=!1,le=null,Pr=!1,St=null,$c=(e,t)=>{let o=null;try{o=t.getBoundingClientRect()}catch{o=null}o&&o.width>40&&o.height>40?(e.style.top=`${Math.round(o.top)}px`,e.style.left=`${Math.round(o.left)}px`,e.style.width=`${Math.round(o.width)}px`,e.style.height=`${Math.round(o.height)}px`,e.style.right="auto",e.style.bottom="auto"):(e.style.top="140px",e.style.right="64px",e.style.left="auto",e.style.width="min(400px, 92vw)",e.style.bottom="16px",e.style.height="auto")},di=(e,t)=>{go=t,t?(e.iconBtn.className=wc,e.iconBtn.dataset.active="true",$c(e.panel,e.panelArea),e.panel.style.display="flex",zr(e.tenantId,e.contactId)):(e.iconBtn.className=ii,delete e.iconBtn.dataset.active,e.panel.style.display="none")},Lc=()=>{let e=document.createElement("button");return e.id=ni,e.type="button",e.title="Properties",e.setAttribute("aria-label","Properties"),e.className=ii,e.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${gc.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,e.addEventListener("click",t=>{t.stopPropagation(),le&&di(le,!go)}),e},ri=()=>{document.getElementById(ni)?.remove(),document.getElementById(Br)?.remove(),St&&le&&le.nav.removeEventListener("click",St,!0),St=null,le=null,go=!1},ci=()=>{Ic()},Ic=async()=>{if(!Pr){Pr=!0;try{let e=H();if(!e||!e.locationId){ri();return}let t=document.getElementById(Br);if(t&&t.dataset.contactId===e.contactId&&le)return;ri();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(m){c.warn("[properties] Contact Type fetch failed",m);return}if(Ce(o)==="buyer")return;let[a,i]=await Promise.all([kc(),Ec()]);if(!a||!i){c.warn("[properties] right-rail nav or panel area not found");return}let s=H();if(!s||s.contactId!==e.contactId)return;let l=Tc(e.locationId,e.contactId),d=Lc();le={contactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:i,iconBtn:d,panel:l},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(d),document.body.appendChild(l),St=m=>{let h=m.target;!h||le&&le.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&go&&le&&di(le,!1)},a.addEventListener("click",St,!0),c.info(`[properties] right-rail mount complete for seller ${e.contactId}`)}finally{Pr=!1}}};var Ae="ws-crm-claim-release-pill",Mc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Oc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Dc=async e=>{let t=await fetch(Mc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Get returned ${t.status} ${t.statusText}`);return await t.json()},Hc=async e=>{let t=await fetch(Oc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId,action:e.action}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Set returned ${t.status} ${t.statusText}`);return await t.json()},bi=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},tt=(e,t)=>{let o=t==="claim"?"emerald":"amber",r=t==="claim"?n.emerald:n.amber;e.dataset.mode=t,e.style.cssText=Ga(o),e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t==="seller"||t==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Jc(e,t)),o.appendChild(r),o.appendChild(jc({contactId:e,kind:t}))}return o},qr=!1,yi=()=>{document.querySelectorAll(`[id="${ot}"]`).forEach(e=>e.remove())},ki=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),qr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}qr=!0;try{await Zc()}finally{qr=!1}},Zc=async()=>{let e=H();if(!e){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),yi();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${e.contactId} locationId=${e.locationId??"(null)"} source=${e.source}`),e.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),yi();return}let t="seller";try{let p=await Se(e.contactId,e.locationId),m=Ce(p);m==="buyer"?t="buyer":m==="other"&&(t="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${t} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=H();if(!o||o.contactId!==e.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ot}"]`));if(r.length===1&&r[0].dataset.contactId===e.contactId&&r[0].dataset.contactKind===t){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${e.contactId} kind=${t} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Wc();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=H();if(!i||i.contactId!==e.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=gi(e.contactId,t)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(ot)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${e.contactId} kind=${t}`);let d=null;d=new MutationObserver(()=>{if(!(H()?.contactId===e.contactId)){d?.disconnect();return}let m=document.querySelectorAll(`[id="${ot}"]`);if(m.length>1){for(let h=1;h<m.length;h++)m[h].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${m.length-1} duplicate bar(s)`);return}if(m.length===0){let h=document.querySelector(".central-panel")||a,b=gi(e.contactId,t);b.dataset.mountTarget=s.dataset.mountTarget??"";try{h.insertBefore(b,h.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${e.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},fi=null,ep=()=>{fi===null&&(fi=window.setInterval(()=>{let e=H();e&&(document.getElementById(ot)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",e.contactId),ki()))},3e3))},Ei=()=>{ep(),ki()};var yo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",tp=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ct="data-ws-crm-favicon",Gr=e=>e.hasAttribute(Ct),Ti=e=>{if(e.tagName!=="LINK")return!1;let t=(e.getAttribute("rel")??"").toLowerCase();return tp.has(t)},fo=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ti(r)&&!Gr(r)&&r.remove()});let t=document.head.querySelector(`link[${Ct}="1"]`);t?t.href!==yo&&(t.href=yo):(t=document.createElement("link"),t.setAttribute(Ct,"1"),t.rel="icon",t.type="image/png",t.href=yo,document.head.appendChild(t),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ct}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ct,"apple"),o.rel="apple-touch-icon",o.href=yo,document.head.appendChild(o))},Si=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)fo();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),fo())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ti(s)&&!Gr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Gr(s)&&(a=!0)});a&&fo()}).observe(document.head,{childList:!0,subtree:!1});let t=0,o=window.setInterval(()=>{t+=1,fo(),t>=5&&window.clearInterval(o)},1e3)};var op=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],rp=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,np=".hr-card.hr-modal.crm-opportunities-modal",P=()=>{let e=document.querySelector(np);if(!e)return null;let t=e.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of t){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(rp);if(a){let i=a[1];if(op.includes(i))return i}}return null},W=async(e=2500)=>{let t=Date.now();for(;Date.now()-t<e;){let o=P();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ci="ws-crm-dispo-action-row",U=e=>{let t=document.getElementById(Ci);if(t)return t;e.classList.contains("description")&&(e.style.display="flex",e.style.alignItems="center",e.style.gap="12px",e.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ci,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",e.appendChild(o),o};var ap="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",de="ws-crm-mt-offer-made-button",Ai="ws-crm-mt-offer-made-modal",ip=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sp=/\/v2\/location\/([A-Za-z0-9]+)/,ko=()=>{let e=window.location.pathname,t=e.match(ip);if(!t)return null;let o=e.match(sp);return{oppId:t[1],locationId:o?o[1]:null}},lp=async e=>{let t=await fetch(ap,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,kind:"buyer",amount:e.amount,triggered_by_user_id:e.userId}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},xo=()=>{document.getElementById(Ai)?.remove()},dp=e=>{xo();let t=document.createElement("div");t.id=Ai,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=ko();!o||!o.locationId||o.oppId!==e||dp({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=t.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),t.style.background=n.emeraldGlow,t.style.color=n.emeraldBright,t.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",t.style.cssText=O)},4e3)}})}),t},pp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],mp=async()=>{for(let e of pp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},wo=!1,jr=async()=>{if(!wo){wo=!0;try{await bp()}finally{wo=!1}}},bp=async()=>{let e=ko();if(!e||!e.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t();return}let t=document.getElementById(de);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t());return}t&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await mp();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ko();if(!a||a.oppId!==e.oppId)return;let i=cp(e.oppId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${e.oppId}`),hp(e.oppId)},At=null,Wr=null,$t=()=>{At?.disconnect(),At=null,Wr=null},hp=e=>{if(At&&Wr===e)return;$t();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Wr=e,At=new MutationObserver(()=>{let o=ko();if(!o||o.oppId!==e){$t();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t();return}document.getElementById(de)||jr()}),At.observe(t,{childList:!0,subtree:!0}))},Ur=null,Vr,up=()=>{Ur||(Ur=new MutationObserver(()=>{Vr===void 0&&(Vr=window.setTimeout(()=>{Vr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(de);e&&!t&&!wo&&jr()},300))}),Ur.observe(document.body,{childList:!0,subtree:!0}))},$i=()=>{up(),jr()};var vp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ce="ws-crm-not-interested-button",_p=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gp=/\/v2\/location\/([A-Za-z0-9]+)/,To=()=>{let e=window.location.pathname,t=e.match(_p);if(!t)return null;let o=e.match(gp);return{oppId:t[1],locationId:o?o[1]:null}},yp=async e=>{let t=await fetch(vp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Not Interested webhook returned ${t.status} ${t.statusText}`);return await t.json()},fp=e=>{let t=document.createElement("button");return t.id=ce,t.type="button",t.dataset.oppId=e,t.style.cssText=O,t.title="Close this Marketing Tracker opp as Not Interested for THIS property only",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let o=To();if(!o||!o.locationId||o.oppId!==e)return;let r=M(),a=t.querySelector(".ws-ni-label");t.disabled=!0,t.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await yp({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),t.style.background=n.crimsonGlow,t.style.color=n.crimson,c.info(`Not Interested set for opp ${e} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),t.disabled=!1,t.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),t},xp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wp=async()=>{for(let e of xp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Eo=!1,Xr=async()=>{if(!Eo){Eo=!0;try{await kp()}finally{Eo=!1}}},kp=async()=>{let e=To();if(!e||!e.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It();return}let t=document.getElementById(ce);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It());return}t&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=await wp();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=To();if(!a||a.oppId!==e.oppId)return;let i=fp(e.oppId),s=document.createElement("span");s.id=`${ce}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${e.oppId}`),Ep(e.oppId)},Lt=null,Jr=null,It=()=>{Lt?.disconnect(),Lt=null,Jr=null},Ep=e=>{if(Lt&&Jr===e)return;It();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Jr=e,Lt=new MutationObserver(()=>{let o=To();if(!o||o.oppId!==e){It();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It();return}document.getElementById(ce)||Xr()}),Lt.observe(t,{childList:!0,subtree:!0}))},Kr=null,Yr,Tp=()=>{Kr||(Kr=new MutationObserver(()=>{Yr===void 0&&(Yr=window.setTimeout(()=>{Yr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ce);e&&!t&&!Eo&&Xr()},300))}),Kr.observe(document.body,{childList:!0,subtree:!0}))},Li=()=>{Tp(),Xr()};var Sp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ae="ws-crm-schedule-walkthrough-button",Qr="ws-crm-schedule-walkthrough-modal",Cp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ap=/\/v2\/location\/([A-Za-z0-9]+)/,Ao=()=>{let e=window.location.pathname,t=e.match(Cp);if(!t)return null;let o=e.match(Ap);return{oppId:t[1],locationId:o?o[1]:null}},So=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$p=(e,t)=>{document.getElementById(Qr)?.remove();let o=document.createElement("div");o.id=Qr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Qr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=Ao();!o||!o.locationId||o.oppId!==e||$p(o.oppId,o.locationId)}),t},Ip=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Mp=async()=>{for(let e of Ip)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Co=!1,on=async()=>{if(!Co){Co=!0;try{await Op()}finally{Co=!1}}},Op=async()=>{let e=Ao();if(!e||!e.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot();return}let t=document.getElementById(ae);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot());return}t&&(t.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Mp();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Ao();if(!a||a.oppId!==e.oppId)return;let i=Lp(e.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${e.oppId}`),Dp(e.oppId)},Mt=null,tn=null,Ot=()=>{Mt?.disconnect(),Mt=null,tn=null},Dp=e=>{if(Mt&&tn===e)return;Ot();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(tn=e,Mt=new MutationObserver(()=>{let o=Ao();if(!o||o.oppId!==e){Ot();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot();return}document.getElementById(ae)||on()}),Mt.observe(t,{childList:!0,subtree:!0}))},Zr=null,en,Hp=()=>{Zr||(Zr=new MutationObserver(()=>{en===void 0&&(en=window.setTimeout(()=>{en=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ae);e&&!t&&!Co&&on()},300))}),Zr.observe(document.body,{childList:!0,subtree:!0}))},Ii=()=>{Hp(),on()};var Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",rt="ws-crm-resend-deal-link-wrap",Bp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rp=/\/v2\/location\/([A-Za-z0-9]+)/,Lo=()=>{let e=window.location.pathname,t=e.match(Bp);if(!t)return null;let o=e.match(Rp);return{oppId:t[1],locationId:o?o[1]:null}},Fp=async e=>{let t=await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,channel:e.channel,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Resend webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Np=e=>e.replace(/[<>&]/g,t=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[t]||t),Mi=e=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${e};box-shadow:0 0 6px ${e};flex-shrink:0;"></span>`,sn=(e,t)=>{e.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Mi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>zp(e,t)),e.appendChild(o)},zp=(e,t)=>{e.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void qp(e,t,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>sn(e,t)),o.appendChild(s),e.appendChild(o)},qp=async(e,t,o,r)=>{let a=Lo();if(!(!a||!a.locationId||a.oppId!==t)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Fp({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${Mi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${t}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Np(s)}</span>`}window.setTimeout(()=>sn(e,t),3500)}},Gp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Up=async()=>{for(let e of Gp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},$o=!1,ln=async()=>{if(!$o){$o=!0;try{await Vp()}finally{$o=!1}}},Vp=async()=>{let e=Lo();if(!e||!e.locationId){document.getElementById(rt)?.remove(),Ht();return}let t=document.getElementById(rt);if(t&&t.dataset.oppId===e.oppId){let s=P();s!==null&&s!=="Marketing Tracker"&&(t.remove(),Ht());return}t&&t.remove();let o=await Up();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Lo();if(!a||a.oppId!==e.oppId)return;let i=document.createElement("span");i.id=rt,i.dataset.oppId=e.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),sn(i,e.oppId),c.debug(`Mounted Resend Deal Link button on opp ${e.oppId}`),Wp(e.oppId)},Dt=null,an=null,Ht=()=>{Dt?.disconnect(),Dt=null,an=null},Wp=e=>{if(Dt&&an===e)return;Ht();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(an=e,Dt=new MutationObserver(()=>{let o=Lo();if(!o||o.oppId!==e){Ht();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(rt)?.remove(),Ht();return}document.getElementById(rt)||ln()}),Dt.observe(t,{childList:!0,subtree:!0}))},rn=null,nn,jp=()=>{rn||(rn=new MutationObserver(()=>{nn===void 0&&(nn=window.setTimeout(()=>{nn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(rt)&&!$o&&ln()},300))}),rn.observe(document.body,{childList:!0,subtree:!0}))},Oi=()=>{jp(),ln()};var Kp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",pe="ws-crm-reduce-price-button",Di="ws-crm-reduce-price-modal",Yp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jp=/\/v2\/location\/([A-Za-z0-9]+)/,Oo=()=>{let e=window.location.pathname,t=e.match(Yp);if(!t)return null;let o=e.match(Jp);return{oppId:t[1],locationId:o?o[1]:null}},Xp=async e=>{let t=await fetch(Kp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,dispo_opp_id:e.oppId,new_price:e.newPrice,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Reduce Price webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Io=()=>{document.getElementById(Di)?.remove()},Qp=e=>{Io();let t=document.createElement("div");t.id=Di,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Oo();!r||!r.locationId||r.oppId!==e||Qp({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},em=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tm=async()=>{for(let e of em)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Mo=!1,mn=async()=>{if(!Mo){Mo=!0;try{await om()}finally{Mo=!1}}},om=async()=>{let e=Oo();if(!e||!e.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt();return}let t=document.getElementById(pe);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt());return}t&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=await tm();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Oo();if(!a||a.oppId!==e.oppId)return;let i=Zp(e.oppId,e.locationId),s=document.createElement("span");s.id=`${pe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${e.oppId}`),rm(e.oppId)},Pt=null,pn=null,Bt=()=>{Pt?.disconnect(),Pt=null,pn=null},rm=e=>{if(Pt&&pn===e)return;Bt();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(pn=e,Pt=new MutationObserver(()=>{let o=Oo();if(!o||o.oppId!==e){Bt();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt();return}document.getElementById(pe)||mn()}),Pt.observe(t,{childList:!0,subtree:!0}))},dn=null,cn,nm=()=>{dn||(dn=new MutationObserver(()=>{cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(pe);e&&!t&&!Mo&&mn()},300))}),dn.observe(document.body,{childList:!0,subtree:!0}))},Hi=()=>{nm(),mn()};var nt="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Do="deals.reinvestos.com";var me="ws-crm-edit-landing-button",am=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,im=/\/v2\/location\/([A-Za-z0-9]+)/,Po=()=>{let e=window.location.pathname,t=e.match(am);if(!t)return null;let o=e.match(im);return{oppId:t[1],locationId:o?o[1]:null}},sm=(e,t)=>{let o=new URL(`https://${Do}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();return r&&o.searchParams.set("user",r),o.toString()},lm=(e,t)=>{let o=document.createElement("button");return o.id=me,o.type="button",o.dataset.oppId=e,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Po();if(!r||!r.locationId||r.oppId!==e)return;if(!nt){c.warn("[edit-landing] editor session key not configured in this build");return}let a=sm(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},dm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cm=async()=>{for(let e of dm)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Ho=!1,vn=async()=>{if(!Ho){Ho=!0;try{await pm()}finally{Ho=!1}}},pm=async()=>{let e=Po();if(!e||!e.locationId){document.getElementById(me)?.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft();return}let t=document.getElementById(me);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft());return}t&&(t.remove(),document.getElementById(`${me}-wrap`)?.remove());let o=await cm();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Po();if(!a||a.oppId!==e.oppId)return;let i=lm(e.oppId,e.locationId),s=document.createElement("span");s.id=`${me}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${e.oppId}`),mm(e.oppId)},Rt=null,un=null,Ft=()=>{Rt?.disconnect(),Rt=null,un=null},mm=e=>{if(Rt&&un===e)return;Ft();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(un=e,Rt=new MutationObserver(()=>{let o=Po();if(!o||o.oppId!==e){Ft();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(me)?.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft();return}document.getElementById(me)||vn()}),Rt.observe(t,{childList:!0,subtree:!0}))},bn=null,hn,bm=()=>{bn||(bn=new MutationObserver(()=>{hn===void 0&&(hn=window.setTimeout(()=>{hn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(me);e&&!t&&!Ho&&vn()},300))}),bn.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{bm(),vn()};var Ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",at="ws-crm-publish-button",Nt="ws-crm-publish-wrap",Ro="ws-crm-publish-dropdown",hm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,um=/\/v2\/location\/([A-Za-z0-9]+)/,yn=()=>{let e=window.location.pathname,t=e.match(hm);if(!t)return null;let o=e.match(um);return{oppId:t[1],locationId:o?o[1]:null}},vm=async(e,t)=>{try{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},_m=async(e,t)=>{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},gm=(e,t)=>{if(!nt){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Do}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},xe=()=>{document.getElementById(Ro)?.remove()},Bi=(e,t,o,r,a)=>{xe();let i=document.createElement("div");i.id=Ro;let s=t.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,_e(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let x=await Um(e,t);if(!x){a={status:"error",message:"Check failed \u2014 click to retry"},_e(o,a);return}if(x.rate_limited){_=Date.now()+b,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},_e(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(x.checks)||x.checks.length===0){a={status:"error",message:x.error||"Check failed \u2014 click to retry"},_e(o,a),c.warn("[stc] dry_run returned no checks:",x);return}let g=x.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Uo.add(e),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be(),Ut();return}let w=x.checks;if(a.checks&&a.checks.length===x.checks.length){let S=new Set;w=x.checks.map((E,f)=>a.checks[f]?.filled&&!E.filled?i.has(E.label)?E:(S.add(E.label),{...E,filled:!0}):E),i=S}else i=new Set;a={status:w.every(S=>S.filled)?"ready":"incomplete",checks:w,previouslySentAt:x.previously_sent_at??null},Gm(e,{checks:w,previously_sent_at:x.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),_e(o,a),document.getElementById(qo)&&No(w,x.previously_sent_at,o)},l=async()=>{let x=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},_e(o,a),be();try{let g=await Vm(e,t,x);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},_e(o,a),window.setTimeout(()=>{y()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},_e(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(qo)?be():a.checks&&No(a.checks,a.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,p=!1,m=Date.now(),h=1e4,b=5*60*1e3,_=0,y=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,m=Date.now();try{await s()}finally{p=!1}}};y();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let x=new MutationObserver(()=>{if(d!==void 0||p)return;let C=Date.now()-m,S=Math.max(1500,h-C);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&y()},S)});x.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=C=>{let S=C.detail;if(!S||S.oppId!==e)return;ns(e);let E=0,f=()=>{if(p&&E<8){E+=1,window.setTimeout(f,500);return}y()};f()};window.addEventListener(In,g);let w=window.setInterval(()=>{document.body.contains(o)||(x.disconnect(),d!==void 0&&window.clearTimeout(d),window.removeEventListener(In,g),window.clearInterval(w))},5e3)}return o},Ym=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jm=async()=>{for(let e of Ym)try{let t=await $(e,{timeoutMs:1500});if(t)return c.debug(`[send-to-title-co] mount target: ${e}`),t}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Uo=new Set,os=null,Xm=e=>{e&&e!==os&&(Uo.clear(),os=e)},zo=!1,Dn=async()=>{if(zo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}zo=!0;try{await Qm()}catch(e){c.error("[stc] ensureMountedImpl threw:",e)}finally{zo=!1}},Qm=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let e=Go();if(!e||!e.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(e)}`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${e.oppId} locId=${e.locationId}`),Xm(e.oppId),Uo.has(e.oppId)){c.debug(`[stc] mount:02-BAIL opp ${e.oppId} previously confirmed non-TC this session`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be();return}let t=document.getElementById($e);if(t&&t.dataset.oppId===e.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=P();l!==null&&l!=="Transaction Coordination"&&(t.remove(),document.getElementById(Ge)?.remove(),be(),Ut());return}t&&(c.debug("[stc] mount:03 removing stale existing button"),t.remove(),document.getElementById(Ge)?.remove(),be()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Jm();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=P();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Go();if(!a||a.oppId!==e.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${e.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Km(e.oppId,a.locationId),s=document.createElement("span");s.id=Ge,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${e.oppId}, inDoc=${document.body.contains(i)}`),Zm(e.oppId)},Gt=null,Mn=null,Ut=()=>{Gt?.disconnect(),Gt=null,Mn=null},Zm=e=>{if(Gt&&Mn===e)return;Ut();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Mn=e,Gt=new MutationObserver(()=>{let o=Go();if(!o||o.oppId!==e){Ut();return}let r=P();if(r!==null&&r!=="Transaction Coordination"){document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be(),Ut();return}document.getElementById($e)||Dn()}),Gt.observe(t,{childList:!0,subtree:!0}))},$n=null,Ln,eb=()=>{$n||($n=new MutationObserver(()=>{Ln===void 0&&(Ln=window.setTimeout(()=>{Ln=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById($e);if(e&&!t&&!zo){let o=Go();if(o&&Uo.has(o.oppId))return;Dn()}},300))}),$n.observe(document.body,{childList:!0,subtree:!0}))},is=()=>{eb(),Dn()};var Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",tb=`${Bn}/tc/welcome-call-prefill`,ob=`${Bn}/tc/welcome-call-save`,rb=`${Bn}/tc/order-lockbox`,Vt="ws-crm-welcome-call-overlay",nb=["Regular Contract","Subject To","Seller Finance","Novation"],ab=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],ib=["Gas","Electric","Propane","Oil"],sb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],lb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Le=["Yes","No"],db=["Yes","No","Unknown"],cb=["Professional Photographer","Seller","Tenant"],pb=["Month-to-Month","Annual"],ss=["Current","Behind"],mb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ge=e=>(e==null?"":String(e)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Wo=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,cs="margin-bottom:12px;",ps=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,bb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ls=e=>String(e??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(e,t,o)=>{let r=ls(o);return`<select id="${e}" style="${Wo}"><option value=""></option>${t.map(a=>`<option ${r!==""&&ls(a)===r?"selected":""}>${ge(a)}</option>`).join("")}</select>`},Z=(e,t,o="")=>`<input id="${e}" type="text" value="${ge(t)}" placeholder="${ge(o)}" style="${Wo}">`,hb=(e,t)=>`<textarea id="${e}" rows="3" style="${Wo}resize:vertical;">${ge(t)}</textarea>`,ub=(e,t)=>`<input id="${e}" type="date" value="${ge(t)}" style="${Wo}">`,D=(e,t)=>`<div style="${cs}"><label style="${ps}">${ge(e)}</label>${t}</div>`,Hn=(e,t)=>{let o=Array.isArray(t)?t:[];return`<div style="margin-top:4px;">${mb.map(r=>`<label style="${bb}"><input type="checkbox" data-grp="${e}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},we=e=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ge(e)}</div>`,it=()=>{document.getElementById(Vt)?.remove()},Ue=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},vb=e=>{let t=e.tenant||{};return`
    ${we("Identifiers")}
    ...
    ${we("Contract")}
    ${D("Type of Contract",j("wc-contract_type",nb,e.contract_type))}

    ${we("Property")}
    ${D("Property Type",j("wc-property_type",sb,e.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${D("Beds",Z("wc-beds",e.beds))}</div>
      <div style="flex:1;">${D("Baths",Z("wc-baths",e.baths))}</div>
      <div style="flex:1;">${D("Sq Ft",Z("wc-sqft",e.sqft))}</div>
    </div>
    ${D("Utilities",j("wc-utilities",ab,e.utilities))}
    ${D("Heat Source",j("wc-heat_source",ib,e.heat_source))}

    ${we("Liens & Permits")}
    ${D("Is there a mortgage?",j("wc-has_mortgage",Le,e.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${D("Mortgage payment status",j("wc-mortgage_payment_status",ss,e.mortgage_payment_status))}</div>
    ${D("Any other liens? (back taxes, code violations, HELOC, etc.)",j("wc-has_other_liens",Le,e.has_other_liens))}
    ${D("Any open or expired permits?",j("wc-has_permit_issues",Le,e.has_permit_issues))}
    ${D("Is the property in probate?",j("wc-in_probate",Le,e.in_probate))}

    ${we("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",lb,e.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("First name",Z("wc-tenant_first_name",t.first_name))}</div>
        <div style="flex:1;">${D("Last name",Z("wc-tenant_last_name",t.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Phone",Z("wc-tenant_phone",t.phone))}</div>
        <div style="flex:1;">${D("Email",Z("wc-tenant_email",t.email))}</div>
      </div>
      ${D("Lease type",j("wc-tenant_lease_type",pb,t.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Monthly rent",Z("wc-tenant_monthly_rent",t.monthly_rent))}</div>
        <div style="flex:1;">${D("Rent due day",Z("wc-tenant_rent_due_day",t.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Rent status",j("wc-tenant_rent_status",ss,t.rent_status))}</div>
        <div style="flex:1;">${D("Last rent paid",ub("wc-tenant_last_rent_paid",t.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Lease on hand?",j("wc-tenant_lease_on_hand",Le,t.lease_on_hand))}</div>
        <div style="flex:1;">${D("Security deposit",Z("wc-tenant_security_deposit",t.security_deposit))}</div>
      </div>
      ${D("Selling with tenant in place?",j("wc-selling_with_tenant",Le,e.selling_with_tenant))}
    </div>

    ${we("HOA")}
    ${D("Part of an HOA?",j("wc-in_hoa",Le,e.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",e.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",db,e.hoa_rental_restriction))}</div>

    ${we("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",cb,e.photos_provided_by))}
    <div style="${cs}">
      ...
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Hn("photos_avail_mornings",e.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Hn("photos_avail_afternoons",e.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Hn("photos_avail_evenings",e.photos_avail_evenings)}
    </div>

    ${we("Lockbox")}
    ${D("Lockbox needed?",j("wc-lockbox_needed",Le,e.lockbox_needed))}
    ${D("Lockbox code (agree with the seller; recorded on the property for future use)",Z("wc-lockbox_code",e.lockbox_code))}
    <div id="wc-lockbox-detail" style="display:none;">
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Recipient name",Z("wc-lockbox_recipient_name",e.lockbox_recipient_name))}</div>
        <div style="flex:1;">${D("Recipient phone",Z("wc-lockbox_recipient_phone",e.lockbox_recipient_phone))}</div>
      </div>
      ${D("Mailing address (if different from property)",Z("wc-lockbox_mailing_address",e.lockbox_mailing_address))}
  ...
  `},A=e=>{let t=document.getElementById(e);return t?(t.value||"").trim():""},Pn=e=>Array.from(document.querySelectorAll(`input[data-grp="${e}"]:checked`)).map(t=>t.value),ds=()=>{let e=(t,o)=>{let r=document.getElementById(t);r&&(r.style.display=o?"block":"none")};e("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),e("wc-hoa-detail",A("wc-in_hoa")==="Yes"),e("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),e("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Vo=e=>{let t=e,o=String(t.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=t.lockbox_order_date?ge(t.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},_b=e=>({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:Pn("photos_avail_mornings"),photos_avail_afternoons:Pn("photos_avail_afternoons"),photos_avail_evenings:Pn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),gb=e=>{it();let t=document.createElement("div");t.id=Vt,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${vb(e)}</div>
  ...
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Sb=e=>{ms(e.oppId,e.locationId)},Cb=async(e,t,o)=>(await fetch(fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,contact_id:t.contact_id||"",property_record_id:t.property_record_id||"",deal_address:t.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Ab=(e,t)=>{Me();let o=document.createElement("div");o.id=vs,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=t.lockbox_mailing_address||t.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Rn(t.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Rn(t.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Rn(s)}</textarea>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Ie("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Me(),Ie("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Ie("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Ie("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!t.contains(p)&&(Me(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Lb=(e,t)=>{Me();let o=document.createElement("div");o.id=us;let r=t.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of e){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!t.contains(s)&&(Me(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Ko=(e,t)=>{let o=document.createElement("button");return o.type="button",t==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=e,o},Ib=()=>{let e=Ko("\u22EE","ghost");return e.style.lineHeight="1",e},Mb=(e,t)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",t===gs){let r=Ko("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Sb(e)),o.appendChild(r),o}if(t===Wn){let r=Ko("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>$b(e,r)),o.appendChild(r),o}if(t===ys){let r=Ko("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void xs(e)),o.appendChild(r),o}return null},Ob=(e,t)=>{let o=[];if(t===Wn&&(o=[{label:"Re-order Lockbox",onClick:()=>void xs(e)}]),!o.length)return null;let r=document.createElement("span");r.id=hs,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Ib();return a.addEventListener("click",i=>{i.stopPropagation(),Lb(o,a)}),r.appendChild(a),r},Db=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Hb=async()=>{for(let e of Db)try{let t=await $(e,{timeoutMs:1200});if(t)return t}catch{}return null},jo=()=>{document.getElementById(qn)?.remove(),document.getElementById(hs)?.remove(),Me()},Yo=!1,jn=async()=>{if(!Yo){Yo=!0;try{let e=fs();if(!e){jo();return}let t=P();if(t===null)return;if(t!=="Transaction Coordination"){jo();return}let o=Tb(),r=document.getElementById(qn);if(r&&r.dataset.oppId===e.oppId&&r.dataset.stage===(o??""))return;let a=Mb(e,o);if(!a){jo();return}let i=await Hb();if(!i)return;jo();let s=U(i),l=document.createElement("span");l.id=qn,l.dataset.oppId=e.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ob(e,o);d&&s.appendChild(d),Pb(e.oppId)}catch(e){c.error("[action-bar] ensureBar threw:",e)}finally{Yo=!1}}},Wt=null,Un=null,Fn,bs=()=>{Wt?.disconnect(),Wt=null,Un=null},Pb=e=>{if(Wt&&Un===e)return;bs();let t=document.querySelector(_s);t&&(Un=e,Wt=new MutationObserver(()=>{let o=fs();if(!o||o.oppId!==e){bs();return}Fn===void 0&&(Fn=window.setTimeout(()=>{Fn=void 0,jn()},250))}),Wt.observe(t,{childList:!0,subtree:!0}))},Nn=null,zn,Bb=()=>{Nn||(Nn=new MutationObserver(()=>{zn===void 0&&(zn=window.setTimeout(()=>{zn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Yo&&jn()},300))}),Nn.observe(document.body,{childList:!0,subtree:!0}))},ws=()=>{Bb(),jn()};var ks="ws-support-modal",Es="ws-support-toast",Rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ts="ws-support-submitter-name",Ss="ws-support-submitter-email",Cs="ws-support-submitter-role",Fb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ve=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Nb=(e,t="success",o)=>{let r=document.getElementById(Es);r&&r.remove();let a=document.createElement("div");a.id=Es;let i=t==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},zb=()=>{document.getElementById(ks)?.remove();let e=(localStorage.getItem(Ts)??"").trim(),t=(localStorage.getItem(Ss)??"").trim(),o=(localStorage.getItem(Cs)??"").trim(),r={category:null,title:"",description:"",submitterName:e,submitterEmail:t,submitterRole:o},a=document.createElement("div");a.id=ks,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ts,r.submitterName),localStorage.setItem(Ss,r.submitterEmail),r.submitterRole&&localStorage.setItem(Cs,r.submitterRole)}catch{}let m=i.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let b=await(await fetch(Rb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!b.ok){d(b.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let _=b.ticket_short_id||"submitted";Nb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},qb=["/support-ticket","ws-support-modal","ws-support"],Gb=/\/custom-menu-link\//,Kn=!1,As=()=>{if(Kn||!Gb.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return qb.some(s=>i.includes(s))});if(r){Kn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{zb(),Kn=!1},50);return}e<10&&setTimeout(t,150)};t()},$s=!1,Ls=()=>{$s||($s=!0,ne(()=>setTimeout(As,50)),As(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Is="ws-phone-assignments-modal",Ms="ws-phone-assignments-toast",Ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Vb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Wb=["ACQ","DISPO","TC"],Hs="",Oe=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),jb=(e,t="success",o)=>{document.getElementById(Ms)?.remove();let r=document.createElement("div");r.id=Ms;let a=t==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Oe(e)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Oe(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Kb=(e,t,o)=>{let r=[`<option value="" ${o===Hs?"selected":""}>\u2014 Unassigned \u2014</option>`,...t.map(a=>`<option value="${Oe(a)}" ${o===a?"selected":""}>${Oe(a)}</option>`)].join("");return`<select data-assign="${Oe(e)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Yb=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Jn=async e=>{document.getElementById(Is)?.remove();let t=e||re(),o=document.createElement("div");o.id=Is,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",b=>{b.target===o&&o.remove()}),!t){let b=r.querySelector("#ws-pa-body");b&&(b.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Ub}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(b){c.error("[phone-assignments] GET failed",b);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Oe(b.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:Wb,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=b=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${b} found.</div>`,p=s.length?s.map(b=>`<div style="${Yb}">
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(b=>{b.addEventListener("change",()=>{let _=b.getAttribute("data-assign")||"",[y,...k]=_.split(":"),x=k.join(":");y==="num"&&(b.value?l[x]=b.value:delete l[x])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let b=h.querySelector("#ws-pa-err"),_=k=>{b&&(b.textContent=k)};_("");let y=h.querySelector("#ws-pa-save");y&&(y.disabled=!0,y.textContent="Saving\u2026",y.style.opacity="0.7");try{let x=await(await fetch(Vb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:l})})).json();if(!x.ok){_(x.error||"Save failed."),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1");return}o.remove(),jb("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){_(`Network error: ${k.message}`),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1")}}))},Jb=["ws-phone-assignments","phone-assignments"],Xb=/\/custom-menu-link\//,Yn=!1,Os=()=>{if(Yn||!Xb.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Jb.some(s=>i.includes(s))});if(r){Yn=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{Jn(i),Yn=!1},50);return}e<10&&setTimeout(t,150)};t()},Ds=!1,Ps=()=>{if(Ds)return;Ds=!0,ne(()=>setTimeout(Os,50)),Os();let e=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Jn()};window.addEventListener("hashchange",e),e(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Jn(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var Rs="powerDialerApp",Qb=".dialer",Zb='button[aria-label="Voice Calling"], button[title="Voice Calling"]',eh=".dial-item.dial-btn.dial-btn-enabled",We=e=>{for(let t of["pointerdown","mousedown","pointerup","mouseup","click"])try{e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Xn=e=>{let t=(e||"").match(/\+\d{10,15}/);return t?t[0]:null},Fs=()=>{try{let t=window[Rs]?._context?.provides?.emitter;if(t&&typeof t.emit=="function")return t}catch(e){c.debug("[dialer-bridge] getEmitter failed",e)}return null},st=()=>document.querySelector(Qb),Jo=()=>Fs()!==null||st()!==null?!0:!!window[Rs],Xo=(e,t)=>{let o=Fs();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${e}`),!1;try{return o.emit(e,t),!0}catch(r){return c.error(`[dialer-bridge] emit ${e} threw`,r),!1}},Ns=()=>{if(st())return;let e=document.querySelector(Zb);e?We(e):c.warn("[dialer-bridge] Voice Calling button not found")},th=()=>{let e=document.querySelector(".number-list-container")||st();if(!e)return[];let t=[...e.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of t){let i=Xn(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},Bs=()=>{let e=document.querySelector(".number-config .ui-text-sm-medium");if(e){let o=Xn(e.innerText);if(o)return o}let t=document.querySelector(".number-config");return t?Xn(t.innerText):null},zs=e=>{if(Bs()===e)return!0;let t=document.querySelector(".number-config, .dialer-config");t&&We(t);let o=th().find(r=>r.e164===e);return o?(We(o.el),Bs()===e):(c.warn(`[dialer-bridge] Calling From ${e} not available to this rep`),!1)},qs=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(e=>/local/i.test(e.innerText||""))||null,oh=()=>{let e=qs();return e?!/bg-gray-100/.test(e.className):!1},Gs=e=>{let t=qs();t&&oh()!==e&&We(t)},Us=e=>{let t=e.replace(/[^\d*#+]/g,"");if(Xo("sendDigitToDial",{value:t,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of t){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&We(a)}},Vs=()=>{let e=st();if(!e)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let t=e.querySelector(eh)||[...e.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return t?(We(t),!0):Xo("makeCall",{provider:"twilio"})};var Qn=()=>{let e=st();if(!e)return;let t=[...e.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);t?We(t.closest("button")||t):Xo("closeCallBox")},Ws=()=>{Xo("closeCallBox")},js=e=>{let t=!1,o=()=>{let i=st()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(t=!0),t&&l){t=!1;try{e()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var rh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",nh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ks=["acq","dispo","tc"],Kt={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},jt=null,Ys=null,ah=async(e=!1)=>{let t=re();if(!t)return{};if(!e&&jt&&Ys===t)return jt;try{return jt=(await(await fetch(`${rh}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json())?.config?.numberTeam??{},Ys=t,jt}catch(o){return c.warn("[silo] number-team config load failed",o),jt??{}}},je=null,Js=null,Zn=async(e=!1)=>{let t=re(),o=M();if(!t||!o)return[];if(!e&&je&&Js===t)return je;try{let i=(await(await fetch(nh,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(s=>s.id===o);if(i){let s=i.role_keys??[];je=Ks.filter(l=>s.includes(l))}else Ze()?je=[...Ks]:je=[];return Js=t,je}catch(r){return c.warn("[silo] roster load failed",r),je??[]}},Qs=()=>`ws-pd-calling-as:${M()||"anon"}`,Zs=e=>{try{localStorage.setItem(Qs(),e)}catch{}},ea=async()=>{let e=await Zn();if(e.length===0)return null;if(e.length===1)return e[0];let t=null;try{t=localStorage.getItem(Qs())}catch{}return t&&e.includes(t)?t:e[0]},Xs=e=>{let t=(e||"").replace(/\D/g,"");return t.length===11&&t[0]==="1"?t.slice(1,4):t.length===10?t.slice(0,3):null},ih=(e,t)=>Object.entries(e).filter(([,o])=>o===t).map(([o])=>o),el=async e=>{let t=await ea();if(!t)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let o=await ah(),r=ih(o,t);if(!r.length)return c.debug(`[silo] ${t} has no numbers; leaving GHL default`),null;let a=Xs(e),i=a?r.find(d=>Xs(d)===a):void 0,s=i||r[0];try{Gs(!1)}catch{}return zs(s)?(c.info(`[silo] ${Kt[t]}: calling ${e} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} (not in this rep's picker?)`),null)};var sh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",tl="data-ws-pd",ol="ws-pd-panel",rl="ws-pd-session",Ke=e=>new Promise(t=>setTimeout(t,e)),Yt=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),lh=e=>{let t=e;for(let o=0;o<8&&t;o++){if(t.querySelector(".crm-opportunities-card-wrapper"))return t;t=t.parentElement}return null},dh=e=>{let t=[e,...Array.from(e.querySelectorAll("*"))];for(let o of t)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return e},ch=e=>{let t=[],o=new Set;for(let r of Array.from(e.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),t.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return t},ph=async e=>{let t=lh(e);if(!t)return[];let o=dh(t),r=-1;for(let a=0;a<60;a++){let i=t.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ke(550)}return o.scrollTop=0,ch(t)},mh=async(e,t)=>{try{let r=await(await fetch(sh,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,contact_id:t})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},bh=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,oa=(e,t,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(ol)?.remove();let r=document.createElement("div");r.id=ol,r.style.cssText=bh;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let i=t.map((p,m)=>`<label data-row="${m}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,i.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Qn()}catch{}i.remove()}),i.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Qn()}catch{}}),i.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),i.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let l=0;l<t.length&&!a.stopped;l++){let d=t[l];a.skip=!1,a.advance=!1,s("Resolving number\u2026",l,d.name);let p=d._phone?{name:d.name,phone:d._phone}:await mh(r,d.contactId);if(a.stopped)break;if(!p||!p.phone){s("No phone on file \u2014 skipping",l,d.name||p?.name||d.contactId),await Ke(1400);continue}let m=p.name||d.name;if(await el(p.phone),a.stopped)break;if(d.contactId&&d.contactId!=="__test__")try{let b=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${d.contactId}`;window.location.pathname!==b&&(history.pushState({},"",b),window.dispatchEvent(new PopStateEvent("popstate")))}catch(h){c.debug("[bulk-dialer] screen-follow nav failed",h)}s(`Calling ${p.phone}\u2026`,l,m);try{Ns(),await Ke(250),Us(p.phone),await Ke(250),Vs()}catch(h){c.error("[bulk-dialer] dial failed",h)}if(await new Promise(h=>{let b=!1,_=()=>{b||(b=!0,y(),h())},y=js(_),k=window.setInterval(()=>{(a.stopped||a.skip)&&(window.clearInterval(k),_())},300)}),a.stopped)break;try{Ws()}catch{}if(l<t.length-1)if(o)for(let h=5;h>0&&!a.stopped&&!a.advance;h--){for(s(`Next call in ${h}s\u2026`,l,m);a.paused&&!a.stopped&&!a.advance;)await Ke(200);if(a.advance||a.stopped)break;await Ke(1e3)}else for(s("Ready \u2014 press Call Next",l,m);!a.advance&&!a.stopped;)await Ke(200)}a.stopped||(i.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${t.length} contact${t.length===1?"":"s"} dialed.</div>`,setTimeout(()=>i.remove(),5e3))},ra='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',na=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},hh=()=>{if(mo()!=="opportunity-list"||!na()||!Jo())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(t=>{if(t.querySelector(`[${tl}]`))return;let o=t.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(tl,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${ra}<span>DIAL</span>`,a.addEventListener("click",async i=>{i.stopPropagation(),i.preventDefault();let s=a.querySelector("span"),l=s?.textContent||"DIAL";s&&(s.textContent="Loading\u2026"),a.style.opacity="0.7";try{let d=await ph(t);oa(r,d)}catch(d){c.error("[bulk-dialer] harvest failed",d)}finally{s&&(s.textContent=l),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},lt=null,ta,al=()=>{window.WS_CRM_PD_TEST=t=>void nl("Verification",[{oppId:"",contactId:"__test__",name:`Test ${t}`,_phone:t}],!1);let e=()=>{ta!==void 0&&window.clearTimeout(ta),ta=window.setTimeout(hh,400)};ne(t=>{t==="opportunity-list"?(e(),lt||(lt=new MutationObserver(e),lt.observe(document.body,{childList:!0,subtree:!0}))):lt&&(lt.disconnect(),lt=null)})};var il="ws-crm-pd-contacts-btn",uh=e=>new Promise(t=>setTimeout(t,e)),vh=e=>{let t=e.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return t?`+1${t[1]}${t[2]}${t[3]}`:""},_h=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,aa=(e,t)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(t){let d=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(d&&d.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||e.has(a))return;let i=(r?.textContent||"").replace(/\s+/g," ").trim(),s=vh(o.textContent||""),l=i&&i!=="-"?i:s||a;e.set(a,{oppId:"",contactId:a,name:l,_phone:s||void 0})})},gh=async e=>{let t=new Map;if(e)return aa(t,!0),[...t.values()];let o=document.querySelector(".tabulator-tableholder");if(aa(t,!1),!o)return[...t.values()];let r=-1,a=-1,i=0;for(let s=0;s<200&&(aa(t,!1),t.size===a?i++:(i=0,a=t.size),!(s>0&&o.scrollTop===r&&i>=2));s++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await uh(220);return o.scrollTop=0,[...t.values()]},yh=()=>{if(mo()!=="contact-list"||!na()||!Jo()||document.getElementById(il))return;let e=document.querySelector("#views-bar .bar");if(!e)return;let t=document.createElement("button");t.id=il,t.type="button",t.title="Power Dialer: call through this list, or the rows you've checked",t.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${u.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,t.innerHTML=`${ra}<span>Power Dialer</span>`;let o=t.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=t.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),t.style.setProperty("border-color",n.emerald,"important"),t.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let i=t.querySelector("span"),s=i?.textContent||"Power Dialer";i&&(i.textContent="Loading\u2026"),t.style.opacity="0.7";try{let l=_h(),d=await gh(l);oa(l?"Selected contacts":"Smart list",d,{one:"contact",many:"contacts"})}catch(l){c.error("[bulk-dialer-contacts] harvest failed",l)}finally{i&&(i.textContent=s),t.style.opacity="1"}}),e.appendChild(t)},dt=null,ia,sl=!1,ll=()=>{if(sl)return;sl=!0;let e=()=>{ia!==void 0&&window.clearTimeout(ia),ia=window.setTimeout(yh,400)};ne(t=>{t==="contact-list"?(e(),dt||(dt=new MutationObserver(e),dt.observe(document.body,{childList:!0,subtree:!0}))):dt&&(dt.disconnect(),dt=null)})};var Qo="ws-calling-as-chip",fh=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},sa=!1,dl=async()=>{if(!sa&&fh()&&!document.getElementById(Qo)){sa=!0;try{let e=await Zn();if(!e.length||document.getElementById(Qo))return;let t=await ea()??e[0],o=e.length>1,r=document.createElement("div");r.id=Qo,r.style.cssText="position:fixed;bottom:60px;right:20px;z-index:99998;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:8px;padding:7px 12px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${u.sans};font-size:12px;box-shadow:0 6px 18px rgba(0,0,0,0.35);cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${u.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Kt[t]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let i=s=>{let l=a.querySelector(".ws-ca-team");l&&(l.textContent=Kt[s])};if(o){let s=document.createElement("div");s.style.cssText=`position:absolute;bottom:calc(100% + 6px);right:0;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;`;let l=()=>{s.innerHTML="",e.forEach(d=>{let p=document.createElement("div"),m=d===t;p.style.cssText=`padding:9px 14px;font-family:${u.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,p.textContent=Kt[d],p.addEventListener("mouseenter",()=>{d!==t&&(p.style.background=n.steel)}),p.addEventListener("mouseleave",()=>{d!==t&&(p.style.background="transparent")}),p.addEventListener("click",h=>{h.stopPropagation(),t=d,Zs(d),i(d),l(),s.style.display="none"}),s.appendChild(p)})};l(),r.appendChild(s),a.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="block"?"none":"block"}),document.addEventListener("click",()=>{s.style.display="none"})}document.body.appendChild(r),c.info(`[calling-as] chip mounted (roles=${e.join(",")}, active=${t}, multi=${o})`)}catch(e){c.error("[calling-as] build failed",e)}finally{sa=!1}}},cl=()=>{dl(),ne(()=>{document.getElementById(Qo)||dl()})};var xh="#12161D",wh="#EDEEF0",pl=e=>{let o=getComputedStyle(e).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],i=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&i>=230},ml=e=>{e.style.setProperty("background-color",xh,"important"),e.style.setProperty("color",wh,"important")},kh=()=>{for(let e of Array.from(document.body.children)){if(e.tagName!=="DIV")continue;let t=e;if(!(t.id||t.className)&&getComputedStyle(t).position==="fixed")return t}return null},Eh=e=>{pl(e)&&ml(e);for(let t of Array.from(e.querySelectorAll("*")))pl(t)&&ml(t)},la=null,Jt=null,hl=()=>{Jt&&(Jt.disconnect(),Jt=null),la=null},Th=e=>{if(la===e)return;hl(),la=e;let t=!1,o=()=>{t=!1;try{Eh(e)}catch(a){c.debug("[dialer-theme] paint failed",a)}},r=()=>{t||(t=!0,requestAnimationFrame(o))};Jt=new MutationObserver(r),Jt.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),c.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},bl=!1,ul=()=>{if(bl)return;bl=!0;let e=()=>{let o=kh();o?Th(o):hl()};e(),new MutationObserver(e).observe(document.body,{childList:!0})};var Sh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ch="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ah="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",gl="tc_closing_agent",$h="tc_closing_office",he="ws-crm-closing-agent-picker-button",yl="ws-crm-closing-agent-picker-modal",Lh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ih=/\/v2\/location\/([A-Za-z0-9]+)/,Zt=()=>{let e=window.location.pathname,t=e.match(Lh);if(!t)return null;let o=e.match(Ih);return{oppId:t[1],locationId:o?o[1]:null}},va=async e=>{let t=await fetch(Sh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,query:e.query??"",contact_id:e.contactId??null,contact_type:e.contactType??null,limit:e.limit??20}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},vl=async e=>{let t=await fetch(Ch,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,opp_id:e.oppId,field_key:e.fieldKey,value:e.value}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},Mh=async(e,t)=>{try{let o=await fetch(Ah,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,field_key:gl}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await va({tenantId:t,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Ye=null,Oh=60*60*1e3,_a=e=>`ws-crm-to-cache:${e}`,fl=e=>{try{let t=window.localStorage.getItem(_a(e));if(!t)return null;let o=JSON.parse(t);return!o.ts||Date.now()-o.ts>Oh||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},xl=(e,t,o)=>{try{window.localStorage.setItem(_a(e),JSON.stringify({contactId:t,contactName:o,ts:Date.now()}))}catch{}},Dh=e=>{try{window.localStorage.removeItem(_a(e))}catch{}},ma="ws-crm-closing-agent-field-link",Hh=()=>{let e=document.querySelector(".crm-opportunities-modal");e&&(e.querySelectorAll(`.${ma}`).forEach(t=>t.remove()),e.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(t=>{t.style.removeProperty("color"),t.style.removeProperty("caret-color"),t.style.removeProperty("visibility"),delete t.dataset.wsClosingAgentDecorated}))},da=!1,ga=async e=>{if(da)return;let t=wl();if(!t)return;let o=(t.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(t.dataset.wsClosingAgentDecorated!==o){da=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await va({tenantId:e,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),ba(a.id,a.name,e);let i=document.getElementById(he);if(i){De(i,{status:"linked",contactName:a.name});let s=Zt();s&&xl(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{da=!1}}},Ph=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,wl=()=>{let t=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of t){let p=(d.textContent||"").trim();Ph.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let h=d.getAttribute(m);h&&/Title\s+Officer/i.test(h)&&a.push({tag:d.tagName.toLowerCase(),attr:m,value:h})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},ba=(e,t,o)=>{let r=wl();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==e){a&&r.parentElement?.querySelectorAll(`.${ma}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=e,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=ma,l.href=`/v2/location/${o}/contacts/detail/${e}`,l.textContent=t,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Zo=()=>{document.getElementById(yl)?.remove()},Bh=e=>{Zo();let t=document.createElement("div");t.id=yl,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),t.addEventListener("click",p=>{p.target===t&&Zo()}),i?.addEventListener("click",Zo);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await va({tenantId:e.locationId,query:p,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};De(o,r);let a=fl(e);return a&&(r={status:"linked",contactName:a.contactName},De(o,r),Ye={oppId:e,contactId:a.contactId,contactName:a.contactName,tenantId:t}),(async()=>{let s=await Mh(e,t);s?(r={status:"linked",contactName:s.name},De(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},ba(s.id,s.name,t)):a||(r={status:"empty"},De(o,r),Ye?.oppId===e&&(Ye=null),Hh(),Dh(e))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Bh({oppId:e,locationId:t,onPick:async s=>{r={status:"saving"},De(o,r);try{let l=await vl({tenantId:t,oppId:e,fieldKey:gl,value:s.id});if(!l.ok)throw new Error(l.error??"Save failed");s.companyName&&s.companyName.trim()&&await vl({tenantId:t,oppId:e,fieldKey:$h,value:s.companyName.trim()}),r={status:"linked",contactName:s.name},De(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},xl(e,s.id,s.name),ba(s.id,s.name,t),as(e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},De(o,r)}}})}),o},Fh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Nh=async()=>{for(let e of Fh)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Xt=!1,or=async()=>{if(!Xt){Xt=!0;try{await zh()}finally{Xt=!1}}},zh=async()=>{let e=Zt();if(!e||!e.locationId){document.getElementById(he)?.remove(),document.getElementById(`${he}-wrap`)?.remove(),tr();return}let t=document.getElementById(he);if(t&&t.dataset.oppId===e.oppId){let d=P();d!==null&&d!=="Transaction Coordination"&&(t.remove(),document.getElementById(`${he}-wrap`)?.remove(),tr());return}t&&(t.remove(),document.getElementById(`${he}-wrap`)?.remove());let o=P();if(o!==null&&o!=="Transaction Coordination")return;let r=await Nh();if(!r||!(fl(e.oppId)!==null||Ye!==null&&Ye.oppId===e.oppId)&&await W()!=="Transaction Coordination")return;let i=Zt();if(!i||i.oppId!==e.oppId||!i.locationId)return;let s=Rh(e.oppId,i.locationId),l=document.createElement("span");l.id=`${he}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${e.oppId}`),qh(e.oppId),ga(i.locationId)},Qt=null,ha=null,ua=null,tr=()=>{Qt?.disconnect(),Qt=null,ha=null,ua=null},qh=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Qt&&ha===e&&ua===t||(tr(),ha=e,ua=t,Qt=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==e||!o.locationId){tr();return}document.getElementById(he)||or(),ga(o.locationId)}),Qt.observe(t,{childList:!0,subtree:!0})))},ca=null,pa,Gh=()=>{ca||(ca=new MutationObserver(()=>{pa===void 0&&(pa=window.setTimeout(()=>{pa=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(he);e&&!t&&!Xt&&or()},300))}),ca.observe(document.body,{childList:!0,subtree:!0}))},_l,Uh=()=>{_l===void 0&&(_l=window.setInterval(()=>{let e=Zt();if(!e||!e.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(he)&&!Xt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),or()),ga(e.locationId)},2e3))},kl=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Gh(),Uh(),or()};var Vh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Pe="ws-crm-manage-team-cta",El="ws-crm-manage-team-modal",Wh=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Tl={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},jh={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Sl=()=>{let e=window.location.pathname.match(Wh);return e?{tenantId:e[1]}:null},nr=async e=>{let t=await fetch(Vh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!t.ok){let o="";try{o=await t.text()}catch{}throw new Error(`Team.Manage HTTP ${t.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await t.json()},ie=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),He=e=>ie(e),ya="ws-crm-manage-team-toast",wa=(e,t="info",o=4e3)=>{document.getElementById(ya)?.remove();let r=t==="success"?n.emerald:t==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ya,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=e,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ya)===a&&a.remove()},o)},fa=()=>{document.getElementById(El)?.remove()},Kh=(e,t)=>{let o=jh[e]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ie(t)}</span>
  `},Yh=(e,t)=>{let o=[e.first_name,e.last_name].filter(Boolean).join(" ")||"(no name)",r=e.roles.map(s=>Kh(s.key,s.display)).join(""),a=t?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=t?"":'title="Manager-only action"';return`
    <div data-user-id="${He(e.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${He(e.email)}" data-user-id="${He(e.id)}" data-name="${He(o)}" data-current-roles="${He(e.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${He(e.email)}" data-name="${He(o)}" data-role-count="${He(String(e.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Jh=(e,t)=>e.length===0?`
  ...
  `+e.map(r=>Yh(r,t)).join(""),ar=async e=>{fa();let t=document.createElement("div");t.id=El,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,t.addEventListener("click",d=>{d.target===t&&fa()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,t.appendChild(o),document.body.appendChild(t),o.querySelector("#ws-team-close")?.addEventListener("click",fa);let r;try{r=await nr({tenant_id:e,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Jh(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Xh(e)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;Qh(e,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;Zh(e,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Xh=e=>{let t="ws-crm-manage-team-add-modal";document.getElementById(t)?.remove();let o=document.createElement("div");o.id=t,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=t.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ie(Tl[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,document.head.appendChild(e)},Sa="__WS_CRM_CAPTURED_AUTH",cu=50*60*1e3,dr=()=>{try{let e=localStorage.getItem(Sa);if(!e)return null;let t=JSON.parse(e);return t?.authorization?Date.now()-(t.capturedAt||0)>cu?(localStorage.removeItem(Sa),null):t:null}catch{return null}},pu=e=>{try{localStorage.setItem(Sa,JSON.stringify(e))}catch{}},pt=()=>{let e=dr(),t=window;if(t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{},t.__WS_CRM_DIAG.authChecks=(t.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${t.__WS_CRM_DIAG.authChecks}]`,e?`present (captured ${Date.now()-e.capturedAt}ms ago, ${e.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!e)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:e.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return e.tokenId&&(o["token-id"]=e.tokenId),o},Ll=(e,t)=>new Promise(o=>{let r=Date.now(),a=()=>{if((dr()?.capturedAt??0)>e)return o(!0);if(Date.now()-r>t)return o(!1);window.setTimeout(a,250)};a()}),ct=async(e,t={},o=2)=>{let r=dr()?.capturedAt??0,a;try{a={...pt(),...t.headers??{}}}catch(s){if(o>0&&await Ll(r,4e3))return ct(e,t,o-1);throw s}let i=await fetch(e,{...t,headers:a});return i.status!==401||o<=0?i:await Ll(r,4e3)?ct(e,t,o-1):i},Il=!1,mu=()=>{if(Il)return;Il=!0;let e=window;e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let t=(l,d,p)=>{e.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let m=d.authorization||d.Authorization;if(!m){e.__WS_CRM_DIAG.fetchCalls+e.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?e.__WS_CRM_DIAG.fetchAuthSeen++:e.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,b=dr()?.authorization;pu({authorization:m,tokenId:h,capturedAt:Date.now()}),b!==m&&(e.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${m.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){e.__WS_CRM_DIAG.fetchCalls++;let m=p.headers;!m&&l[0]instanceof Request&&(m=l[0].headers);let h={};if(m instanceof Headers)m.forEach((b,_)=>h[_.toLowerCase()]=b);else if(Array.isArray(m))m.forEach(([b,_])=>h[b.toLowerCase()]=_);else if(m&&typeof m=="object")for(let b of Object.keys(m))h[b.toLowerCase()]=m[b];t(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(e.__WS_CRM_DIAG.xhrCalls++,t(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Pl=()=>{let e=H();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},bu=e=>{let t=e.dataset;return t.tenantId&&t.contactId?{tenantId:t.tenantId,contactId:t.contactId,oppId:t.oppId||void 0}:t.tenantId&&t.oppId?{tenantId:t.tenantId,contactId:"",oppId:t.oppId}:Pl()},hu=e=>{let t=(e||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(t)||/assignment.*(contract|agreement)/i.test(t)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(t)||/purchase.*(contract|agreement)/i.test(t)?"PA":"passthrough"},Bl="__WS_CRM_TEMPLATES_CACHE_V1",uu=24*60*60*1e3,Ml=e=>{try{let t=window.localStorage.getItem(Bl);if(!t)return null;let o=JSON.parse(t);return o.tenantId!==e||Date.now()-o.cachedAt>uu?null:o.templates}catch{return null}},vu=(e,t)=>{try{let o={tenantId:e,templates:t,cachedAt:Date.now()};window.localStorage.setItem(Bl,JSON.stringify(o))}catch{}},_u=async e=>{let t=`${ke}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(e)}&skip=0&limit=10`,o;try{o=await ct(t,{method:"GET"})}catch(s){let l=Ml(e);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Ml(e);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:hu(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&vu(e,i),i},gu=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await ct(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},yu=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET",headers:pt()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let m=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-m})},fu=async e=>{let t=await fetch(du,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,template_id:e.templateId,template_type:e.templateType,opp_id:e.oppId,closing_date:e.closingDate,buyer_earnest_due_date:e.buyerEarnestDueDate,lender_source:e.lenderSource,triggered_by_user_id:e.userId,overrides:e.overrides}),credentials:"omit"});if(!t.ok)throw new Error(`Contract.Stage HTTP ${t.status}`);return await t.json()},xu=async(e,t,o)=>{let r=`${ke}/proposals/templates/to-proposal/${e}/${t}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:pt()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},wu=async(e,t)=>{let o=await fetch(`${ke}/proposals/document/${t}?locationId=${encodeURIComponent(e)}`,{method:"GET",headers:pt()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${t} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},ku=async e=>{let t=await fetch(`${ke}/contacts/${e}`,{method:"GET",headers:pt()});if(!t.ok){let a=await t.text().catch(()=>"");throw new Error(`GET contact ${e} HTTP ${t.status} ${a.slice(0,200)}`)}let o=await t.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Eu=async(e,t,o,r)=>{let a;try{a=await wu(e,t)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await ku(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||e,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},b=await fetch(`${ke}/proposals/document/${t}`,{method:"PUT",headers:{...pt(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!b.ok){let _=await b.text().catch(()=>"");return{ok:!1,status:b.status,body:_}}return{ok:!0}},Tu=(e,t)=>{let o=`/v2/location/${e}/payments/proposals-estimates/edit/${t}`;window.location.href=o},sr="__WS_CRM_PENDING_INSTRUCTIONS",Su=60*1e3,Cu=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Au=e=>{let t=(e||"").toLowerCase();for(let o of Cu)if(t.includes(o.matches.toLowerCase()))return o;return null},$u=(e,t,o)=>{try{let r={proposalId:e,title:t,bodyHtml:o,ts:Date.now()};localStorage.setItem(sr,JSON.stringify(r))}catch{}},Lu=()=>{try{let e=localStorage.getItem(sr);if(!e)return null;let t=JSON.parse(e);return!t?.proposalId||!t?.title||!t?.bodyHtml||Date.now()-(t.ts||0)>Su?(localStorage.removeItem(sr),null):t}catch{return null}},Iu=()=>{try{localStorage.removeItem(sr)}catch{}},Mu=(e,t)=>{document.getElementById(fe)?.remove();let o=document.createElement("div");o.id=fe,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Ou=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Du=()=>{let e=window.location.pathname.match(Ou);if(!e)return;let t=e[1],o=Lu();o&&o.proposalId===t&&(Iu(),window.setTimeout(()=>{Mu(o.title,o.bodyHtml)},600))},Ol="ws-crm-prepare-contract-toast",Y=(e,t="info",o=4e3)=>{document.getElementById(Ol)?.remove();let r=document.createElement("div");r.id=Ol;let a=t==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=e,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Dl=(e,t)=>new Promise(o=>{document.getElementById(fe)?.remove();let r=document.createElement("div");r.id=fe,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,e.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==e&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await _u(t.tenantId)}catch(i){o.innerHTML=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){Yu(o,s.properties,l=>{a(!0),Ia({tenantId:t,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?Ul(t,d.property_record_id,d):cr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),cr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?Ul(t,s.property_record_id,s):cr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await Ia({tenantId:t,contactId:e,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),cr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Ju=async()=>{for(let e of ju)try{let t=await $(e,{timeoutMs:3e3});if(t)return t}catch{}return null},Wl=async(e,t)=>{let o=t.querySelector(`#${zl}`);if(!o)try{o=await $(`#${zl}`,{timeoutMs:3e3,root:t})}catch{o=null}return o?(e.style.order="3",o.appendChild(e),!0):!1},jl=()=>{let e=document.querySelectorAll(`#${Xe}`);for(let t=1;t<e.length;t++)e[t].remove()},Xu=async()=>{let e=H();if(!e||!e.locationId||e.source!=="url"){document.getElementById(Xe)?.remove(),mt();return}let t=e.locationId,o=document.getElementById(Xe);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove(),mt();let r="seller";try{r=Ce(await Se(e.contactId,t))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Xe)?.remove();return}let a=await Ju();if(!a){c.warn("[compute-offer] no central panel found");return}let i=H();if(!i||i.contactId!==e.contactId)return;let s=Vl(e.contactId,t);if(!await Wl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}jl(),c.debug(`[compute-offer] mounted for ${e.contactId}`);let l=new MutationObserver(()=>{if(H()?.contactId!==e.contactId){l.disconnect();return}if(!document.getElementById(Xe)){let d=Vl(e.contactId,t);Wl(d,a).then(()=>jl())}});l.observe(a,{childList:!0})},ro=null,Ql=()=>{let e=H()?.contactId??null;if(ro&&ro.id===e)return;let t=Xu().finally(()=>{ro?.promise===t&&(ro=null)});ro={id:e,promise:t}};var so="reos-theme-stylesheet",Ba="reos-theme-fonts",bt=!1,Qu=()=>{let e=document.getElementById(Ba);e&&e.remove()},Zu=`
/* ============================================
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};console.log("[ws-crm-customizer] bundle-loaded");var L=(e,t)=>{try{c.info(`[main] calling ${e}`),t(),c.info(`[main] ${e} OK`)}catch(o){c.error(`[main:FAIL] ${e} threw:`,o)}},fd=()=>{c.info(`Loaded v${bo} (built ${ho})`),kr()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):(L("mountVersionBadge (initial)",yr),L("mountFavicon",Si),L("mountThemeStylesheet",Ra),L("mountHideLaunchpad",En),L("mountHideNavItems",Tn),L("mountRelabelNav",Sn),L("mountHideTopmenuTabs",An),L("mountContractsSection",Cn)),L("initPageRouter",qa),c.info("[main] registering onPageChange subscriber"),ne(t=>{if(c.info(`[main] onPageChange callback fired for page=${t}`),kr()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),L("unmountThemeStylesheet",gd);return}L("mountThemeStylesheet",Ra),L("mountVersionBadge",yr),L("mountHideLaunchpad",En),L("mountHideNavItems",Tn),L("mountRelabelNav",Sn),L("mountHideTopmenuTabs",An),L("mountContractsSection",Cn),L("mountClaimReleaseToggle",hi),L("mountContactActionsBar",Ei),L("mountActiveFollowUpButton",Ya),L("mountMtOfferMadeButton",$i),L("mountNotInterestedButton",Li),L("mountScheduleWalkthroughButton",Ii),L("mountResendDealLinkButton",Oi),L("mountReducePriceButton",Hi),L("mountEditLandingPageButton",Pi),L("mountPublishButton",Fi),L("mountContactMapLinks",Vi),L("mountSendToClosingOfficeButton",is),L("mountOppActionBar",ws),L("mountClosingAgentPickerButton",kl),L("mountPrepareContractButton",Nl),L("mountComputeOfferButton",Ql),L("mountManageTeam",Cl),L("mountBuyBoxWidget",ti),L("mountPropertiesWidget",ci),L("mountSupportNavItem",Ls),L("mountPhoneAssignmentsWidget",Ps),L("mountBulkPowerDialer",al),L("mountBulkPowerDialerContacts",ll),L("mountCallingAsChip",cl),L("mountDialerThemeFix",ul)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fd):fd();})();
