/* Wholesaling CRM Customizer v0.13.75 — built 2026-05-28T00:11:17.045Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var me="[wholesaling-crm-customizer]",Po="__WS_CRM_DEBUG",No=()=>!!window[Po],b={info(...o){console.log(me,...o)},warn(...o){console.warn(me,...o)},error(...o){console.error(me,...o)},debug(...o){No()&&console.log(me,"[debug]",...o)}};var Ct=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,We=/\/v2\/location\/([A-Za-z0-9]+)/,Bo=o=>{let e=o.match(Ct);if(!e)return null;let t=o.match(We);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ro=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Ct);if(!n)continue;let a=r.match(We)||window.location.pathname.match(We);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Bo(window.location.pathname);return o||Ro()};var It=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},_e="",je=null,j="other",Ke=new Set,ue=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==_e)&&!(o!==je))){_e=window.location.pathname,je=o,j=It(),b.debug("Page/context changed:",j,_e,"contact:",o);for(let r of Ke)try{r(j)}catch(n){b.error("Subscriber threw:",n)}}},Lt=o=>(Ke.add(o),setTimeout(()=>o(j),0),()=>{Ke.delete(o)}),At=()=>{j=It(),_e=window.location.pathname,je=S()?.contactId??null,b.debug("Router init, current page:",j);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ue()},history.replaceState=function(t,r,n){e(t,r,n),ue()},window.addEventListener("popstate",ue),setInterval(ue,1e3)};var ve="0.13.75",ye="2026-05-28T00:11:17.046Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let l=n.querySelector(o);if(l){a(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ye={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},Ft=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var $o=/^[A-Za-z0-9]{15,30}$/,Z=o=>typeof o=="string"&&$o.test(o),Go=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Uo=()=>{let o=window.WS_CRM_USER_ID;return Z(o)?o:null},Vo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Z(t))return t;return null},qo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Go(e);if(!t)return null;let r=t.uid;if(Z(r))return r;let n=t.claims;if(n&&Z(n.user_id))return n.user_id}catch{}return null},zo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Z(n))return n}catch{}}}catch{}return null},L=()=>Uo()||Vo()||qo()||zo()||null;var Ht="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Wo=`${Ht}/active-follow-up-get`,jo=`${Ht}/active-follow-up-set`,q="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},Ko=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Yo=async o=>{let e=await fetch(Wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xo=async(o,e)=>{let t=await fetch(jo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},z=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Mt=o=>{let e=document.createElement("button");return e.type="button",e.id=q,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,z(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ko();if(!(!r||r.contactId!==o)){z(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Xo(r,L()),a=n&&n.state&&n.state in Je?n.state:"blue";z(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),z(e,"error"),setTimeout(()=>void ge(e,r),4e3)}}}),e},ge=async(o,e)=>{z(o,"loading");try{let t=await Yo(e),r=t&&t.state&&t.state in Je?t.state:"gray",n=document.getElementById(q);if(!n||n.dataset.contactId!==e.contactId)return;z(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),z(o,"error")}},Jo=[".central-panel","[class*='central-panel']"],Xe="ws-crm-contact-actions-bar",Zo=async()=>{for(let o of Jo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Qo=async(o,e)=>{let t=e.querySelector(`#${Xe}`);if(!t)try{t=await C(`#${Xe}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Xe}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},er=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},tr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},or=async o=>{if(o==="url"){let t=await Zo();return t?{kind:"contact-detail",target:t}:null}let e=er();return e?{kind:"conversations",target:e}:null},Dt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await Qo(o,e.target);return t}return tr(o,e.target),"conversations-header"},rr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(q)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(q);if(t&&t.dataset.contactId===e.contactId){ge(t,e);return}t&&t.remove();let r=await or(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=Mt(e.contactId),s=await Dt(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Ot();let l=document.getElementById(q)??a;ge(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(q);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Mt(e.contactId);Dt(m,r).then(()=>{Ot(),ge(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Q=null,Pt=()=>{let o=S()?.contactId??null;if(Q&&Q.contactId===o)return;let e=rr().finally(()=>{Q?.promise===e&&(Q=null)});Q={contactId:o,promise:e}},Ot=()=>{let o=document.querySelectorAll(`#${q}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var U="ws-crm-claim-release-pill",nr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",sr=async o=>{let e=await fetch(nr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},ir=async o=>{let e=await fetch(ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Rt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},K=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?i.emerald:i.amber;o.dataset.mode=e,o.style.cssText=Ft(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},lr=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=U,t.type="button",t.dataset.contactId=o,K(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let a=L();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=t.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>K(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let s=r==="claim"?"release":"claim";K(t,s),t.disabled=!0,t.style.opacity="0.8";try{let l=await ir({contactId:o,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;K(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),K(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Nt=async(o,e)=>{try{let t=await sr({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(U);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";K(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},dr=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Rt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Bt=(o,e)=>{let t=lr({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${U}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},cr=async()=>{let o=S();if(!o){document.getElementById(U)?.remove();return}let e=document.getElementById(U);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await dr(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Bt(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(U);a&&o.locationId&&Nt(a,{contactId:o.contactId,locationId:o.locationId});let s=null;s=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(U))return;let d=Rt(t);if(d){Bt(d,o.contactId);let c=document.getElementById(U);c&&o.locationId&&Nt(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},$t=()=>{cr()};var br="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ee=new Map,Gt=async(o,e)=>{if(!o)return null;if(ee.has(o))return ee.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${br}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),ee.set(o,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return ee.set(o,l),b.debug(`Resolved Contact Type for ${o}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),ee.set(o,null),null}};var Ut=o=>o==="buyer"?"buyer":"seller";var Kt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",hr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",mr=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:s})=>{let l=a||Kt,d;if(s==="buyer"){let h=Yt.find(p=>p.label===t),m=h?h.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:t,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:o,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},ur=async({contactId:o,tenantId:e})=>{let t=await fetch(pr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var Y="ws-crm-contact-actions-bar",_r="ws-crm-call-status-dropdown",Vt="ws-crm-offer-made-modal",vr=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Yt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],yr=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],gr=async()=>{for(let o of yr)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},fr=({contactId:o,kind:e})=>{let t=e==="buyer"?Yt:vr,r=e==="buyer"?hr:Kt,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=_r,a.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=I,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=i.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let h=s.firstElementChild,m=s.children[1],p=s.children[2];h&&(h.style.background=Ye[d.color]),m&&(m.textContent=d.label),l.style.display="none";let g=S()?.locationId,x=L();if(!g){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=i.amber);return}if(e==="seller"&&d.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=i.amber);return}let v=p?.textContent??"\u25BE",_=async y=>{p&&(p.textContent="\u2026"),s.style.opacity="0.75";try{await mr({contactId:o,locationId:g,status:d.label,userId:x,deadReason:y,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=v),s.style.opacity="1"},900)}catch(k){b.warn("Call Status webhook failed:",k),p&&(p.textContent="\u2717"),m&&(m.style.color=i.amber),s.style.opacity="1",setTimeout(()=>{p&&(p.textContent=v),m&&(m.style.color=i.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Er(k=>{_(k)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await ur({contactId:o,tenantId:g})).ok?await _():Tr(()=>{_()},()=>{m&&(m.textContent=y)})}catch(k){b.warn("Appointment sanity check failed; firing anyway:",k),await _()}return}await _()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(s),a.appendChild(l),a},wr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",xr=async o=>{let e=await fetch(wr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},kr=(o,e="seller")=>{document.getElementById(Vt)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=t?i.emerald:i.amber,s=document.createElement("div");s.id=Vt,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",l=>{l.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},Wt=(o,e)=>{let t=document.createElement("div");t.id=Y,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${i.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=B,r.textContent="Offer Made",r.addEventListener("click",()=>kr(o,e)),t.appendChild(r),t.appendChild(fr({contactId:o,kind:e})),t},Ze=!1,Sr=()=>{document.querySelectorAll(`[id="${Y}"]`).forEach(o=>o.remove())},Xt=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ze){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ze=!0;try{await Cr()}finally{Ze=!1}},Cr=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Sr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Gt(o.contactId,o.locationId);Ut(c)==="buyer"&&(e="buyer"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Y}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await gr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Wt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Y)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${Y}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Wt(o.contactId,e);p.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},jt=null,Ir=()=>{jt===null&&(jt=window.setInterval(()=>{let o=S();o&&(document.getElementById(Y)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Xt()))},3e3))},Jt=()=>{Ir(),Xt()};var fe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Lr=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),te="data-ws-crm-favicon",Qe=o=>o.hasAttribute(te),Zt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Lr.has(e)},we=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Zt(r)&&!Qe(r)&&r.remove()});let e=document.head.querySelector(`link[${te}="1"]`);e?e.href!==fe&&(e.href=fe):(e=document.createElement("link"),e.setAttribute(te,"1"),e.rel="icon",e.type="image/png",e.href=fe,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${te}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(te,"apple"),t.rel="apple-touch-icon",t.href=fe,document.head.appendChild(t))},Qt=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)we();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),we())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Zt(s)&&!Qe(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Qe(s)&&(n=!0)});n&&we()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,we(),e>=5&&window.clearInterval(t)},1e3)};var Ar=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Fr=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Mr=".hr-card.hr-modal.crm-opportunities-modal",A=()=>{let o=document.querySelector(Mr);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Fr);if(n){let a=n[1];if(Ar.includes(a))return a}}return null},V=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=A();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Dr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",eo="ws-crm-mt-offer-made-modal",Or=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hr=/\/v2\/location\/([A-Za-z0-9]+)/,Ee=()=>{let o=window.location.pathname,e=o.match(Or);if(!e)return null;let t=o.match(Hr);return{oppId:e[1],locationId:t?t[1]:null}},Pr=async o=>{let e=await fetch(Dr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},xe=()=>{document.getElementById(eo)?.remove()},Nr=o=>{xe();let e=document.createElement("div");e.id=eo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),a=t.querySelector("#ws-mt-offer-cancel"),s=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&xe()}),a?.addEventListener("click",()=>xe()),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await Pr({oppId:o.oppId,locationId:o.locationId,amount:c,userId:L()});if(!h.ok){n.textContent=h.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1);return}xe(),o.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1)}})},Br=o=>{let e=document.createElement("button");return e.id=D,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Ee();!t||!t.locationId||t.oppId!==o||Nr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Rr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$r=async()=>{for(let o of Rr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ke=!1,rt=async()=>{if(!ke){ke=!0;try{await Gr()}finally{ke=!1}}},Gr=async()=>{let o=Ee();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),re());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await $r();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ee();if(!n||n.oppId!==o.oppId)return;let a=Br(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Ur(o.oppId)},oe=null,ot=null,re=()=>{oe?.disconnect(),oe=null,ot=null},Ur=o=>{if(oe&&ot===o)return;re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ot=o,oe=new MutationObserver(()=>{let t=Ee();if(!t||t.oppId!==o){re();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}document.getElementById(D)||rt()}),oe.observe(e,{childList:!0,subtree:!0}))},et=null,tt,Vr=()=>{et||(et=new MutationObserver(()=>{tt===void 0&&(tt=window.setTimeout(()=>{tt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!ke&&rt()},300))}),et.observe(document.body,{childList:!0,subtree:!0}))},to=()=>{Vr(),rt()};var qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",zr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wr=/\/v2\/location\/([A-Za-z0-9]+)/,Se=()=>{let o=window.location.pathname,e=o.match(zr);if(!e)return null;let t=o.match(Wr);return{oppId:e[1],locationId:t?t[1]:null}},jr=async o=>{let e=await fetch(qr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Kr=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Se();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await jr({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Yr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xr=async()=>{for(let o of Yr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Te=!1,it=async()=>{if(!Te){Te=!0;try{await Jr()}finally{Te=!1}}},Jr=async()=>{let o=Se();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Xr();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Se();if(!n||n.oppId!==o.oppId)return;let a=Kr(o.oppId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),Zr(o.oppId)},ne=null,st=null,ae=()=>{ne?.disconnect(),ne=null,st=null},Zr=o=>{if(ne&&st===o)return;ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(st=o,ne=new MutationObserver(()=>{let t=Se();if(!t||t.oppId!==o){ae();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae();return}document.getElementById(O)||it()}),ne.observe(e,{childList:!0,subtree:!0}))},nt=null,at,Qr=()=>{nt||(nt=new MutationObserver(()=>{at===void 0&&(at=window.setTimeout(()=>{at=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Te&&it()},300))}),nt.observe(document.body,{childList:!0,subtree:!0}))},oo=()=>{Qr(),it()};var en="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",ro="ws-crm-reduce-price-modal",tn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,on=/\/v2\/location\/([A-Za-z0-9]+)/,Le=()=>{let o=window.location.pathname,e=o.match(tn);if(!e)return null;let t=o.match(on);return{oppId:e[1],locationId:t?t[1]:null}},rn=async o=>{let e=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ce=()=>{document.getElementById(ro)?.remove()},nn=o=>{Ce();let e=document.createElement("div");e.id=ro,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),s=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Ce()}),a?.addEventListener("click",()=>{Ce()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await rn({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:L()}),Ce(),o.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},an=(o,e)=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Le();!r||!r.locationId||r.oppId!==o||nn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},sn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ln=async()=>{for(let o of sn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ie=!1,bt=async()=>{if(!Ie){Ie=!0;try{await dn()}finally{Ie=!1}}},dn=async()=>{let o=Le();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await ln();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Le();if(!n||n.oppId!==o.oppId)return;let a=an(o.oppId,o.locationId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),cn(o.oppId)},se=null,ct=null,ie=()=>{se?.disconnect(),se=null,ct=null},cn=o=>{if(se&&ct===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ct=o,se=new MutationObserver(()=>{let t=Le();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||bt()}),se.observe(e,{childList:!0,subtree:!0}))},lt=null,dt,bn=()=>{lt||(lt=new MutationObserver(()=>{dt===void 0&&(dt=window.setTimeout(()=>{dt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ie&&bt()},300))}),lt.observe(document.body,{childList:!0,subtree:!0}))},no=()=>{bn(),bt()};var so="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",W="ws-crm-send-to-title-co-button",X="ws-crm-send-to-title-co-wrap",Me="ws-crm-stc-dropdown",hn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pn=/\/v2\/location\/([A-Za-z0-9]+)/,mt=()=>{let o=window.location.pathname,e=o.match(hn);if(!e)return null;let t=o.match(pn);return{oppId:e[1],locationId:t?t[1]:null}},mn=5*60*1e3,io=o=>`ws-crm-stc-cache:${o}`,un=o=>{try{let e=window.localStorage.getItem(io(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>mn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},_n=(o,e)=>{try{window.localStorage.setItem(io(o),JSON.stringify(e))}catch{}},vn=async(o,e)=>{try{let t=await fetch(so,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},yn=async(o,e,t)=>{let r=await fetch(so,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},gn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},ao=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},fn=(o,e)=>{if(e&&gn(e)){window.setTimeout(()=>ao(o),300);return}ao(o)},N=()=>{document.getElementById(Me)?.remove()},Ae=(o,e,t)=>{N();let r=document.createElement("div");r.id=Me;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${f.sans};
  `;let a=o.length,s=o.filter(u=>u.filled).length,l=s===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${f.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(u=>{h[u.group]||(h[u.group]=[]),h[u.group].push(u)});let m=[...c.filter(u=>h[u]),...Object.keys(h).filter(u=>!c.includes(u))];for(let u of m){let g=h[u],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let v=document.createElement("div");v.style.cssText=`
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${i.steel};
    `,v.textContent=u,x.appendChild(v),g.forEach(_=>{let y=document.createElement("div"),k=!_.filled&&_.navigable&&_.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${k?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,k&&(y.addEventListener("mouseenter",()=>{y.style.background=i.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",F=>{F.stopPropagation(),_.field_id&&(fn(_.field_id,_.folder),N())}));let T=_.filled?`<span style="color: ${i.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${i.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,w=k?`<span style="margin-left: auto; color: ${i.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${w}`,x.appendChild(y)}),r.appendChild(x)}document.body.appendChild(r);let p=u=>{let g=u.target;!r.contains(g)&&!t.contains(g)&&(N(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},P=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,s,l=i.bone,d,c="Send to Title Company",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",s=i.steel,l=i.ash,d=i.coolGray,c="Checking\u2026",m="wait",p="0.8";break;case"ready":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;a="transparent",s=i.amber,l=i.amber,d=i.amber,c=`${u} of ${g} fields ready`,h="\u25BE";break}case"sending":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",p="0.8";break;case"sent":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":a="transparent",s=i.amber,l=i.amber,d=i.amber,c=e.message??"Try again";break}o.style.background=a,o.style.borderColor=s,o.style.color=l,o.style.cursor=m,o.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=c),n&&(n.textContent=h)},wn=(o,e)=>{let t=document.createElement("button");t.id=W,t.type="button",t.dataset.oppId=o;let r=un(o),n=r?{status:r.checks.every(v=>v.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${B}
    background: transparent;
    border: 1px solid ${i.steel};
    color: ${i.ash};
  ...
  `,P(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let v=await vn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(v.rate_limited){u=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},P(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N(),de();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},_n(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(Me)&&Ae(y,v.previously_sent_at,t)},l=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),N();try{let _=await yn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(Me)?N():n.checks&&Ae(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-h,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},k)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},xn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kn=async()=>{for(let o of xn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Fe=!1,_t=async()=>{if(Fe){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Fe=!0;try{await En()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Fe=!1}},En=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=mt();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(W);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=A();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),N(),de());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),N()),b.debug("[stc] mount:04 calling findMountTarget");let t=await kn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=mt();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=wn(o.oppId,n.locationId),s=document.createElement("span");s.id=X,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Tn(o.oppId)},le=null,ut=null,de=()=>{le?.disconnect(),le=null,ut=null},Tn=o=>{if(le&&ut===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,le=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){de();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N(),de();return}document.getElementById(W)||_t()}),le.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Sn=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);o&&!e&&!Fe&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},lo=()=>{Sn(),_t()};var Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",bo="ldtyB2UXKi9vOp8nLUH7",An="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",ho="ws-crm-title-officer-picker-modal",Fn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mn=/\/v2\/location\/([A-Za-z0-9]+)/,gt=()=>{let o=window.location.pathname,e=o.match(Fn);if(!e)return null;let t=o.match(Mn);return{oppId:e[1],locationId:t?t[1]:null}},po=async o=>{let e=await fetch(Cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},co=async o=>{let e=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Dn=async(o,e)=>{try{let t=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:bo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await po({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},$=null,ft="ws-crm-title-officer-field-link",On=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${ft}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),delete e.dataset.wsTitleOfficerDecorated}))},wt=(o,e,t)=>{let r=document.querySelector(".crm-opportunities-modal");if(!r)return;r.querySelectorAll("input").forEach(a=>{if(a.value!==o)return;let s=a.dataset.wsTitleOfficerDecorated;if(s===o)return;s&&a.parentElement?.querySelectorAll(`.${ft}`).forEach(m=>m.remove());let l=a.parentElement;if(!l)return;a.dataset.wsTitleOfficerDecorated=o,a.style.color="transparent",a.style.caretColor="transparent",window.getComputedStyle(l).position==="static"&&(l.style.position="relative");let c=document.createElement("a");c.className=ft,c.href=`/v2/location/${t}/contacts/detail/${o}`,c.textContent=e,c.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      padding: 0 12px;
      color: ${i.emeraldBright};
      font-family: ${f.sans};
      font-size: 14px;
      font-weight: 500;
      ...
      pointer-events: auto;
      background: transparent;
    `,c.addEventListener("mouseenter",()=>{c.style.textDecoration="underline"}),c.addEventListener("mouseleave",()=>{c.style.textDecoration="none"}),c.addEventListener("click",h=>{h.preventDefault(),h.stopPropagation(),window.location.href=c.href}),l.appendChild(c)})},De=()=>{document.getElementById(ho)?.remove()},Hn=o=>{De();let e=document.createElement("div");e.id=ho,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&De()}),a?.addEventListener("click",De);let s,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await po({tenantId:o.locationId,query:c,limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${Oe(m.name)}</div>
          <div style="color: ${i.ash}; font-size: 11px; margin-top: 2px;">
            ${Oe(m.email||"(no email)")} \xB7 ${Oe(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Oe(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=i.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{De(),o.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Title Officer picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${i.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},Oe=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),J=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Title Officer",a=i.amber,s=i.bone,l="transparent",d=i.steel,c="pointer";switch(e.status){case"loading":n="Loading Title Officer\u2026",a=i.coolGray,s=i.ash,c="wait";break;case"empty":n="Link Title Officer",a=i.amber;break;case"linked":n=e.contactName?`Title Officer: ${e.contactName}`:"Title Officer: \u2713",a=i.emerald,l=i.emeraldGlow,d=i.emeraldBorder,s=i.emeraldBright;break;case"saving":n="Linking\u2026",a=i.coolGray,s=i.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=l,o.style.borderColor=d,o.style.color=s,o.style.cursor=c},Pn=(o,e)=>{let t=document.createElement("button");t.id=R,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Pick the Title Officer contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};return J(t,r),(async()=>{let a=await Dn(o,e);a?(r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},wt(a.id,a.name,e)):(r={status:"empty"},J(t,r),$?.oppId===o&&($=null),On())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Hn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},J(t,r);try{let s=[co({tenantId:e,oppId:o,fieldId:bo,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(co({tenantId:e,oppId:o,fieldId:An,value:a.companyName.trim()}));let d=(await Promise.all(s))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},wt(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},J(t,r)}}})}),t},Nn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Bn=async()=>{for(let o of Nn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,kt=async()=>{if(!He){He=!0;try{await Rn()}finally{He=!1}}},Rn=async()=>{let o=gt();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Bn();if(!r||await V()!=="Transaction Coordination")return;let a=gt();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=Pn(o.oppId,a.locationId),l=document.createElement("span");l.id=`${R}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),$n(o.oppId)},ce=null,xt=null,Pe=()=>{ce?.disconnect(),ce=null,xt=null},$n=o=>{if(ce&&xt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt=o,ce=new MutationObserver(()=>{let t=gt();if(!t||t.oppId!==o){Pe();return}document.getElementById(R)||kt(),$&&$.oppId===o&&wt($.contactId,$.contactName,$.tenantId)}),ce.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,Gn=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!He&&kt()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{Gn(),kt()};var Ue="reos-theme-stylesheet",Mo="reos-theme-fonts",Un=()=>{let o=document.getElementById(Mo);o&&o.remove()},Vn=`
/* ============================================
...
`,qn=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],zn=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${a})`}return`rgb(${t}, ${r}, ${n})`},Wn=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),jn=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Et=new WeakSet,uo=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Et.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let t=e.tagName;if(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="SCRIPT"||t==="STYLE"||t==="SVG"||t==="PATH"||t==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let s=+a[1],l=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Et.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Et.add(e)}catch{}})}catch{}},_o=new WeakSet,be=()=>{document.querySelectorAll(jn.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(_o.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let s=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),_o.add(r))})})},vo=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Ne=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let t=e.parentElement,r=0;for(;t&&r<6&&t!==document.body;){if(r+=1,t.id?.startsWith("ws-crm-")||t.classList.contains("hl_header")||t.classList.contains("app-header")||t.tagName==="MAIN"||t.tagName==="BODY")return;let s=window.getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&t.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"))}t=t.parentElement}})},yo=()=>{let o="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;(t.getAttribute("style")||"").includes(o)&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"))})},he=()=>{for(let o of qn){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let a=t.style.getPropertyPriority(r),s=t.style.getPropertyValue(r),l=Wn.has(r)?zn(n):n;a==="important"&&s===l||t.style.setProperty(r,n,"important")}})}},Ve="#1A1F28",Kn=26,Yn=31,Xn=40,go=new Set,fo=new Set,Be=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!fo.has(n)&&n!=="<no class>"&&(fo.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},Jn=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Zn=["trash","Trash","TRASH","delete","Delete","DELETE"],Qn=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(Zn.some(a=>n.includes(a))&&(r=!0),r||t.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";Jn.some(d=>l.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},ea=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),ta=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||ea.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},wo=new Set,xo=new WeakSet,oa=()=>{document.body.querySelectorAll("*").forEach(e=>{if(xo.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),xo.add(e);let h=e.className?.toString()||"<no class>";!wo.has(h)&&h!=="<no class>"&&(wo.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},ko=new Set,ra=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let s=(a.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(a),d=l.backgroundColor,c=l.backgroundImage||"",h=!1;if(c!=="none"&&c.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let w=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(w){let F=parseInt(w[1],10),G=parseInt(w[2],10),ze=parseInt(w[3],10);(F>=60||G>=60||ze>=60)&&(F>230&&G>230&&ze>230||(F>=80||G>=80||ze>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),u=s,g=Array.from(a.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),x=p.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),v=u.includes("bg-clip-text")||u.includes("text-transparent")||g.includes("bg-clip-text")||g.includes("text-transparent"),_=Array.from(a.querySelectorAll("*")).some(T=>{let w=window.getComputedStyle(T),F=w.getPropertyValue("-webkit-background-clip")||"",G=w.getPropertyValue("background-clip")||"";return F.includes("text")||G.includes("text")});if(x||v||_){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],w=F=>{T.forEach(G=>F.style.removeProperty(G))};w(a),a.querySelectorAll("*").forEach(w);return}let y="#12161D";a.style.setProperty("color",y,"important"),a.querySelectorAll("*").forEach(T=>{let w=T.tagName.toLowerCase();w==="svg"||w==="path"||w==="circle"||w==="rect"||w==="polygon"||w==="polyline"||w==="line"||w==="g"?(T.style.setProperty("fill",y,"important"),T.style.setProperty("stroke",y,"important"),T.style.setProperty("color",y,"important")):(T.style.setProperty("color",y,"important"),T.style.setProperty("-webkit-text-fill-color",y,"important"))});let k=a.className?.toString()||"<no class>";!ko.has(k)&&k!=="<no class>"&&(ko.add(k),b.debug(`Darkened SVG icons on colored button: "${k}"`))})})},Eo=new Set,na=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let g=h.width*h.height/(r.width*r.height);if(g>.55)return;let x=c,v=c.parentElement,_=0;for(;v&&v!==e&&_<3;){let k=v.getBoundingClientRect();if(k.width>0&&k.width<=30&&k.height<=30)x=v;else break;v=v.parentElement,_++}x.style.setProperty("transform","translateY(11px)","important");let y=(x.className?.toString()||"")+" "+x.tagName;Eo.has(y)||(Eo.add(y),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${g.toFixed(2)}): "${y}"`))})})},aa="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",sa=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",aa,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},To=new Set,ia=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!To.has(h)&&h!=="<no class>"&&(To.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${c})): "${h}"`))})})},So=new Set,la=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let s=t.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let l=t.className?.toString()||"<no class>";!So.has(l)&&l!=="<no class>"&&(So.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}t=t.parentElement,r++}})},Co=new Set,da=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let s=parseInt(a.zIndex,10);if(!isFinite(s)||s<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let v=s.getAttribute("style")||"";(v.includes("background-color")||v.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let v=s.getAttribute("style")||"";(v.includes("background-color")||v.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let h=parseInt(c[1],10),m=parseInt(c[2],10),p=parseInt(c[3],10);if(!(h>200&&m>200&&p>200))return;let g=s.getBoundingClientRect();if(g.width<24||g.height<16||g.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let x=s.className?.toString()||"<no class>";!Co.has(x)&&x!=="<no class>"&&(Co.add(x),b.debug(`Coerced light bg (${g.width.toFixed(0)}x${g.height.toFixed(0)}, rgb(${h},${m},${p})): "${x}"`))})})},Io=new Set,ca=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let y=t.getAttribute("style")||"";(y.includes("color")||y.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,a=null;for(let y=0;y<4&&n;y++){let k=n.nextElementSibling;if(k&&(k.matches(o)||k.querySelector(o)!==null)){a=k;break}n=n.parentElement}if(!a)return;let s=t.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=a,d=l.getBoundingClientRect(),c=l.className?.toString()||"",h=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",u=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);u&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let g=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let v=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;v&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!u&&!g&&!x&&!v&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Ve,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let _=t.className?.toString()||"<no class>";!Io.has(_)&&_!=="<no class>"&&(Io.add(_),b.debug(`Colored field label "${r.slice(0,30)}": "${_}"`))})},Lo=new Set,ba=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Lo.has(d)&&d!=="<no class>"&&(Lo.add(d),b.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Ao=new Set,ha=new Set(["Enter Dashboard Name"]),pa=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;let r=e.placeholder||"";if(ha.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Ve,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",Ve,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!Ao.has(a)&&a!=="<no class>"&&(Ao.add(a),b.debug(`Forced input slate bg: "${a}"`))})},Re=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>t.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let s=parseInt(a[1],10),l=parseInt(a[2],10),d=parseInt(a[3],10);if(!(s<Kn&&l<Yn&&d<Xn))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",Ve,"important");let m=e.className?.toString()||"<no class>";!go.has(m)&&m!=="<no class>"&&(go.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},$e=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let l=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,h=!1;if(e.forEach(u=>{c.includes(u)&&(c=c.split(u).join(o),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{c.includes(u)&&(c=c.split(u).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(g=>{c.includes(g)&&(c=c.split(g).join("#EDEEF0"),h=!0)}),!!h)try{let u=btoa(c);a.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let s=a.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;a.setAttribute("data-reos-masked","1");let l=`url("${s}")`;a.style.setProperty("-webkit-mask-image",l,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",l,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",t)})},Ge=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},ma=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color")||t.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},pe=()=>{let o=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{o(n),n.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||o(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{o(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",c,"important"),h.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(a)))})},Tt=new WeakSet,ua=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Tt.has(e))try{let t=e.contentDocument||e.contentWindow?.document;if(!t||!t.head)return;if(t.querySelector("style[data-ws-crm-email-fix]")){Tt.add(e);return}let r=t.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,o.textContent=`Customizer v${ve}`,o.title=`Built ${ye}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Ho=()=>{b.info(`Loaded v${ve} (built ${ye})`),M("mountVersionBadge (initial)",qe),M("mountFavicon",Qt),M("mountThemeStylesheet",Do),M("initPageRouter",At),b.info("[main] registering onPageChange subscriber"),Lt(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",qe),M("mountClaimReleaseToggle",$t),M("mountContactActionsBar",Jt),M("mountActiveFollowUpButton",Pt),M("mountMtOfferMadeButton",to),M("mountNotInterestedButton",oo),M("mountReducePriceButton",no),M("mountSendToTitleCoButton",lo),M("mountTitleOfficerPickerButton",mo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ho):Ho();})();
