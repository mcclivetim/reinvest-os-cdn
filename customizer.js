/* Wholesaling CRM Customizer v0.13.11 — built 2026-05-25T23:48:55.111Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var j="[wholesaling-crm-customizer]",pt="__WS_CRM_DEBUG",mt=()=>!!window[pt],b={info(...o){console.log(j,...o)},warn(...o){console.warn(j,...o)},error(...o){console.error(j,...o)},debug(...o){mt()&&console.log(j,"[debug]",...o)}};var fe=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,he=/\/v2\/location\/([A-Za-z0-9]+)/,_t=o=>{let e=o.match(fe);if(!e)return null;let t=o.match(he);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},vt=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(fe);if(!n)continue;let a=r.match(he)||window.location.pathname.match(he);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},y=()=>{let o=_t(window.location.pathname);return o||vt()};var we=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},Y="",pe=null,N="other",me=new Set,K=()=>{let o=y()?.contactId??null;if(!(!(window.location.pathname!==Y)&&!(o!==pe))){Y=window.location.pathname,pe=o,N=we(),b.debug("Page/context changed:",N,Y,"contact:",o);for(let r of me)try{r(N)}catch(n){b.error("Subscriber threw:",n)}}},xe=o=>(me.add(o),setTimeout(()=>o(N),0),()=>{me.delete(o)}),ke=()=>{N=we(),Y=window.location.pathname,pe=y()?.contactId??null,b.debug("Router init, current page:",N);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),K()},history.replaceState=function(t,r,n){e(t,r,n),K()},window.addEventListener("popstate",K),setInterval(K,1e3)};var X="0.13.11",J="2026-05-25T23:48:55.111Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let l,c,p=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),l=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var d={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},_e={purple:"#8B5CF6",green:d.emerald,orange:d.amber,red:d.crimson},Q=o=>{let e=o==="emerald"?d.emeraldGlow:o==="amber"?d.amberGlow:d.slate,t=o==="emerald"?d.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":d.steel,r=o==="emerald"?d.emerald:o==="amber"?d.amber:d.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var ut=/^[A-Za-z0-9]{15,30}$/,G=o=>typeof o=="string"&&ut.test(o),yt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},gt=()=>{let o=window.WS_CRM_USER_ID;return G(o)?o:null},ft=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(G(t))return t;return null},wt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=yt(e);if(!t)return null;let r=t.uid;if(G(r))return r;let n=t.claims;if(n&&G(n.user_id))return n.user_id}catch{}return null},xt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(G(n))return n}catch{}}}catch{}return null},F=()=>gt()||ft()||wt()||xt()||null;var Ce="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",kt=`${Ce}/active-follow-up-get`,Et=`${Ce}/active-follow-up-set`,H="ws-crm-active-follow-up-button",ue={amber:{label:"Add to Active Follow Up",bg:d.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:d.amber,clickable:!0,dotColor:d.amber},blue:{label:"In Active Follow Up",bg:d.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:d.blue,clickable:!1,dotColor:d.blue},gray:{label:"Not in Follow Up",bg:d.slate,border:d.steel,color:d.coolGray,clickable:!1,dotColor:d.coolGray},loading:{label:"Active Follow Up\u2026",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.ash},error:{label:"Follow Up status unavailable",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.crimson}},Tt=()=>{let o=y();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},St=async o=>{let e=await fetch(kt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ct=async(o,e)=>{let t=await fetch(Et,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},M=(o,e)=>{let t=ue[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ee=o=>{let e=document.createElement("button");return e.type="button",e.id=H,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,M(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Tt();if(!(!r||r.contactId!==o)){M(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Ct(r,F()),a=n&&n.state&&n.state in ue?n.state:"blue";M(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),M(e,"error"),setTimeout(()=>void Z(e,r),4e3)}}}),e},Z=async(o,e)=>{M(o,"loading");try{let t=await St(e),r=t&&t.state&&t.state in ue?t.state:"gray",n=document.getElementById(H);if(!n||n.dataset.contactId!==e.contactId)return;M(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),M(o,"error")}},At=[".central-panel","[class*='central-panel']"],ve="ws-crm-contact-actions-bar",Ft=async()=>{for(let o of At)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Lt=async(o,e)=>{let t=e.querySelector(`#${ve}`);if(!t)try{t=await C(`#${ve}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${ve}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},It=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Dt=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Ht=async o=>{if(o==="url"){let t=await Ft();return t?{kind:"contact-detail",target:t}:null}let e=It();return e?{kind:"conversations",target:e}:null},Te=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await Lt(o,e.target);return t}return Dt(o,e.target),"conversations-header"},Mt=async()=>{let o=y();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(H);if(t&&t.dataset.contactId===e.contactId){Z(t,e);return}t&&t.remove();let r=await Ht(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=y();if(!n||n.contactId!==e.contactId)return;let a=Ee(e.contactId),i=await Te(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Se();let s=document.getElementById(H)??a;Z(s,e);let l=new MutationObserver(()=>{let c=document.getElementById(H);if(!(y()?.contactId===e.contactId)){l.disconnect();return}if(!c){let m=Ee(e.contactId);Te(m,r).then(()=>{Se(),Z(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});l.observe(r.target,{childList:!0})},$=null,Ae=()=>{let o=y()?.contactId??null;if($&&$.contactId===o)return;let e=Mt().finally(()=>{$?.promise===e&&($=null)});$={contactId:o,promise:e}},Se=()=>{let o=document.querySelectorAll(`#${H}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var I="ws-crm-claim-release-pill",Nt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Pt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Rt=async o=>{let e=await fetch(Nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Bt=async o=>{let e=await fetch(Pt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ie=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},P=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?d.emerald:d.amber;o.dataset.mode=e,o.style.cssText=Q(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Ot=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=I,t.type="button",t.dataset.contactId=o,P(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=y();if(!n||!n.locationId||n.contactId!==o)return;let a=F();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>P(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";P(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await Bt({contactId:o,locationId:n.locationId,userId:a,action:r}),l=s?.mode==="claim"||s?.mode==="release"?s.mode:i;P(t,l),b.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(s){b.error("Claim/Release Set webhook failed",s),P(t,r);let l=t.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Fe=async(o,e)=>{try{let t=await Rt({contactId:e.contactId,locationId:e.locationId,userId:F()}),r=document.getElementById(I);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";P(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Gt=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Ie(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Le=(o,e)=>{let t=Ot({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},$t=async()=>{let o=y();if(!o){document.getElementById(I)?.remove();return}let e=document.getElementById(I);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Gt(t),n=y();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Le(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(I);a&&o.locationId&&Fe(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(y()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(I))return;let l=Ie(t);if(l){Le(l,o.contactId);let c=document.getElementById(I);c&&o.locationId&&Fe(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},De=()=>{$t()};var Vt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",V=new Map,He=async(o,e)=>{if(!o)return null;if(V.has(o))return V.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${Vt}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),V.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return V.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),V.set(o,null),null}};var Me=o=>o==="buyer"?"buyer":"seller";var Ge="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ut="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var qt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",zt=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||Ge,l;if(i==="buyer"){let p=$e.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),l={contact_id:o,location:{id:e},customData:p}}let c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Wt=async({contactId:o,tenantId:e})=>{let t=await fetch(qt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var R="ws-crm-contact-actions-bar",jt="ws-crm-call-status-dropdown",Ne="ws-crm-offer-made-modal",Kt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],$e=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Yt=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Xt=async()=>{for(let o of Yt)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Jt=({contactId:o,kind:e})=>{let t=e==="buyer"?$e:Kt,r=e==="buyer"?Ut:Ge,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=jt,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=O,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${_e[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=d.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=_e[l.color]),m&&(m.textContent=l.label),s.style.display="none";let w=y()?.locationId,x=F();if(!w){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${l.label} (no tenant!)`),m&&(m.style.color=d.amber);return}if(e==="seller"&&l.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${l.label} (no user!)`),m&&(m.style.color=d.amber);return}let u=h?.textContent??"\u25BE",E=async _=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await zt({contactId:o,locationId:w,status:l.label,userId:x,deadReason:_,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=u),i.style.opacity="1"},900)}catch(g){b.warn("Call Status webhook failed:",g),h&&(h.textContent="\u2717"),m&&(m.style.color=d.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=u),m&&(m.style.color=d.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let _=m?.textContent??"";Zt(g=>{E(g)},()=>{m&&(m.textContent=_)});return}if(e==="seller"&&l.value==="appointment-booked"){let _=m?.textContent??"";try{(await Wt({contactId:o,tenantId:w})).ok?await E():eo(()=>{E()},()=>{m&&(m.textContent=_)})}catch(g){b.warn("Appointment sanity check failed; firing anyway:",g),await E()}return}await E()}),s.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",l=>{a.contains(l.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},Qt=o=>{document.getElementById(Ne)?.remove();let e=document.createElement("div");e.id=Ne,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Be=(o,e)=>{let t=document.createElement("div");t.id=R,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${d.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=B,r.textContent="Offer Made",r.addEventListener("click",()=>Qt(o)),t.appendChild(r),t.appendChild(Jt({contactId:o,kind:e})),t},Ve=async()=>{b.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname);let o=y();if(!o){b.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),document.getElementById(R)?.remove();return}b.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await He(o.contactId,o.locationId);Me(c)==="buyer"&&(e="buyer"),b.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=y();if(!t||t.contactId!==o.contactId){b.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=document.getElementById(R);if(r&&r.dataset.contactId===o.contactId&&r.dataset.contactKind===e){b.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r&&(b.info(`[actions-bar:05] removing stale bar (was contact=${r.dataset.contactId} kind=${r.dataset.contactKind})`),r.remove());let n=await Xt();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=y();if(!a||a.contactId!==o.contactId){b.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Be(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(R)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let l=null;l=new MutationObserver(()=>{let c=document.getElementById(R);if(!(y()?.contactId===o.contactId)){l?.disconnect();return}if(!c){let m=document.querySelector(".central-panel")||n,h=Be(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(k){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",k)}}}),l.observe(n,{childList:!0})},Oe=null,to=()=>{Oe===null&&(Oe=window.setInterval(()=>{let o=y();o&&(document.getElementById(R)||(b.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Ve()))},3e3))},Ue=()=>{to(),Ve()};var ee="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",oo=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),U="data-ws-crm-favicon",ye=o=>o.hasAttribute(U),qe=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return oo.has(e)},te=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{qe(r)&&!ye(r)&&r.remove()});let e=document.head.querySelector(`link[${U}="1"]`);e?e.href!==ee&&(e.href=ee):(e=document.createElement("link"),e.setAttribute(U,"1"),e.rel="icon",e.type="image/png",e.href=ee,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${U}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(U,"apple"),t.rel="apple-touch-icon",t.href=ee,document.head.appendChild(t))},ze=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)te();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),te())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&qe(i)&&!ye(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ye(i)&&(n=!0)});n&&te()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,te(),e>=5&&window.clearInterval(t)},1e3)};var ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",q="ws-crm-not-interested-button",no=/\/opportunities\/detail\/([A-Za-z0-9]+)/,ao=/\/v2\/location\/([A-Za-z0-9]+)/,oe=()=>{let o=window.location.pathname,e=o.match(no);if(!e)return null;let t=o.match(ao);return{oppId:e[1],locationId:t?t[1]:null}},so=async o=>{let e=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},We=o=>{let e=document.createElement("button");return e.id=q,e.type="button",e.dataset.oppId=o,e.style.cssText=Q("neutral"),e.style.fontFamily=v.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=oe();if(!t||!t.locationId||t.oppId!==o)return;let r=F(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await so({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=d.crimsonGlow,e.style.color=d.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},io=["[data-testid='OPPORTUNITY_HEADER']","[class*='opportunity-header']","[class*='opp-header']","header.flex.items-center"],lo=async()=>{for(let o of io)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},co=async()=>{let o=oe();if(!o||!o.locationId){document.getElementById(q)?.remove();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===o.oppId)return;e&&e.remove();let t=await lo();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=oe();if(!r||r.oppId!==o.oppId)return;let n=We(o.oppId),a=document.createElement("span");a.id=`${q}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,a.appendChild(n),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`);let i=new MutationObserver(()=>{let s=document.getElementById(q);if(!(oe()?.oppId===o.oppId)){i.disconnect();return}if(!s){let c=We(o.oppId);a.appendChild(c),b.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});i.observe(t,{childList:!0})},je=()=>{co()};var le="reos-theme-stylesheet",dt="reos-theme-fonts",bo=()=>{let o=document.getElementById(dt);o&&o.remove()},ho=`
/* ============================================
