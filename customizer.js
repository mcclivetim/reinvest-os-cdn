/* Wholesaling CRM Customizer v0.4.1 — built 2026-05-13T00:51:06.873Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var y="[wholesaling-crm-customizer]",Y="__WS_CRM_DEBUG",j=()=>!!window[Y],i={info(...e){console.log(y,...e)},warn(...e){console.warn(y,...e)},error(...e){console.error(y,...e)},debug(...e){j()&&console.log(y,"[debug]",...e)}};var _=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},v="",b="other",I=new Set,x=()=>{if(window.location.pathname!==v){v=window.location.pathname,b=_(),i.debug("Page changed:",b,v);for(let e of I)try{e(b)}catch(o){i.error("Subscriber threw:",o)}}},B=e=>(I.add(e),setTimeout(()=>e(b),0),()=>{I.delete(e)}),R=()=>{b=_(),v=window.location.pathname,i.debug("Router init, current page:",b);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,n,a){e(t,n,a),x()},history.replaceState=function(t,n,a){o(t,n,a),x()},window.addEventListener("popstate",x),setInterval(x,1e3)};var w="0.4.1",E="2026-05-13T00:51:06.874Z";var K=/\/contacts\/detail\/([A-Za-z0-9]+)/,X=/\/v2\/location\/([A-Za-z0-9]+)/,m=()=>{let e=window.location.pathname,o=e.match(K);if(!o)return null;let t=e.match(X);return{contactId:o[1],locationId:t?t[1]:null}};var f=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:n=100,root:a=document}=o;return new Promise((s,l)=>{let d=a.querySelector(e);if(d){s(d);return}let u,T,L=()=>{C&&C.disconnect(),u!==void 0&&window.clearTimeout(u),T!==void 0&&window.clearInterval(T)},C=new MutationObserver(()=>{let g=a.querySelector(e);g&&(L(),s(g))});C.observe(document.body,{childList:!0,subtree:!0}),T=window.setInterval(()=>{let g=a.querySelector(e);g&&(L(),s(g))},n),u=window.setTimeout(()=>{L(),i.warn(`waitForElement timed out for selector: ${e}`),l(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var r={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},p={sm:"4px",md:"6px",lg:"10px",pill:"999px"},c={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},M={purple:"#8B5CF6",green:r.emerald,orange:r.amber,red:r.crimson},D=e=>{let o=e==="emerald"?r.emeraldGlow:e==="amber"?r.amberGlow:r.slate,t=e==="emerald"?r.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":r.steel,n=e==="emerald"?r.emerald:e==="amber"?r.amber:r.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var h="ws-crm-claim-release-pill",A=e=>{let o=Array.from(e.children).find(n=>{if(!(n instanceof HTMLElement))return!1;let a=n.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Z=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=h,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let n=o==="claim"?"emerald":"amber",a=o==="claim"?r.emerald:r.amber;return t.style.cssText=D(n),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
...
`,U=()=>{if(ie(),document.getElementById(z))return;let e=document.createElement("style");e.id=z,e.textContent=le,document.head.appendChild(e),i.info("REInvest OS theme stylesheet mounted")};var W="ws-crm-customizer-version-badge",V=()=>{if(document.getElementById(W))return;let e=document.createElement("div");e.id=W,e.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
