...
/* SVG sizing \u2014 render at 16x16 so the 3 dots have room to be
   distinguishable. At the original ~10x10 the stroked dots blur
   together into a solid blue blob (Tim's 'white/blue inner box'). */
...
/* Use FILL not stroke so each dot is a clean small circle.
   Stroke set to none above so we don't get a halo around the
   fill. */
