...
`,L=`
  ...
  flex-shrink: 0;
`;var I="ws-crm-claim-release-pill",re=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},De=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=I,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",a=e==="claim"?i.emerald:i.amber;return t.style.cssText=te(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{b.info(`Claim/Release pill clicked for contact ${o}: ${e}`);let l=t.lastElementChild,s=l?.textContent??"";l&&(l.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{l&&(l.textContent=s),t.style.opacity="1",t.disabled=!1},700)}),t},Ne=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=re(o);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},oe=(o,e)=>{let t=De({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},He=async()=>{let o=E();if(!o){document.getElementById(I)?.remove();return}let e=document.getElementById(I);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Ne(t),a=E();if(!a||a.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}oe(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let l=null;l=new MutationObserver(async()=>{if(!(E()?.contactId===o.contactId)){l?.disconnect();return}if(document.getElementById(I))return;let n=re(t);n&&(oe(n,o.contactId),b.debug("Re-mounted Claim/Release pill after React wipe"))}),l.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},ae=()=>{He()};var Re="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var Me="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Be=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),l=a.id??a._id;if(l&&/^[A-Za-z0-9]{15,30}$/.test(l))return l}for(let a of["tokenUser","currentUser","ghl_user"]){let l=localStorage.getItem(a);if(l)try{let s=JSON.parse(l),n=s.id??s._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}catch{}}}catch{}return null},Oe=async({contactId:o,locationId:e,status:t,userId:r,deadReason:a})=>{let l={call_status:t,triggered_by_user_id:r??""};a&&(l.dead_reason=a);let n=await fetch(Re,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:e},customData:l}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},Pe=async({contactId:o,tenantId:e})=>{let t=await fetch(Me,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var O="ws-crm-contact-actions-bar",Ge="ws-crm-call-status-dropdown",ne="ws-crm-offer-made-modal",$e=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Ue=[".central-panel","[class*='central-panel']"],Ve=async()=>{for(let o of Ue)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ze=o=>{let e=document.createElement("div");e.id=Ge,e.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=L,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,$e.forEach(a=>{let l=document.createElement("button");l.type="button",l.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,l.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,l.addEventListener("mouseenter",()=>{l.style.background=i.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",async()=>{b.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${o}`);let s=t.firstElementChild,n=t.children[1],d=t.children[2];s&&(s.style.background=j[a.color]),n&&(n.textContent=a.label),r.style.display="none";let p=E()?.locationId,m=Be();if(!p){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),n&&(n.textContent=`${a.label} (no tenant!)`),n&&(n.style.color=i.amber);return}if(a.color==="green"&&!m){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),n&&(n.textContent=`${a.label} (no user!)`),n&&(n.style.color=i.amber);return}let h=d?.textContent??"\u25BE",x=async v=>{d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await Oe({contactId:o,locationId:p,status:a.label,userId:m,deadReason:v}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=h),t.style.opacity="1"},900)}catch(u){b.warn("Call Status webhook failed:",u),d&&(d.textContent="\u2717"),n&&(n.style.color=i.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=h),n&&(n.style.color=i.bone)},1800)}};if(a.value==="dead-deal"){let v=n?.textContent??"";qe(u=>{x(u)},()=>{n&&(n.textContent=v)});return}if(a.value==="appointment-booked"){let v=n?.textContent??"";try{(await Pe({contactId:o,tenantId:p})).ok?await x():je(()=>{x()},()=>{n&&(n.textContent=v)})}catch(u){b.warn("Appointment sanity check failed; firing anyway:",u),await x()}return}await x()}),r.appendChild(l)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{e.contains(a.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},We=o=>{document.getElementById(ne)?.remove();let e=document.createElement("div");e.id=ne,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let l=()=>e.remove();e.addEventListener("click",s=>{s.target===e&&l()}),t.querySelector("#ws-offer-cancel")?.addEventListener("click",l),t.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let s=(t.querySelector("#ws-offer-amount")?.value??"").trim(),n=t.querySelector("#ws-offer-expires")?.value??"";if(!s||Number(s)<=0){b.warn("Offer Made submit blocked \u2014 invalid amount");return}b.info(`Offer Made recorded for contact ${o}: $${s}, expires ${n}`),l()}),setTimeout(()=>{t.querySelector("#ws-offer-amount")?.focus()},0)},se="ws-crm-dead-deal-modal",qe=(o,e)=>{document.getElementById(se)?.remove();let t=document.createElement("div");t.id=se,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),l=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&l()}),r.querySelector("#ws-dead-cancel")?.addEventListener("click",l);let s=()=>{let n=r.querySelector("#ws-dead-reason"),d=r.querySelector("#ws-dead-error"),c=(n?.value??"").trim();if(!c){d&&(d.textContent="Please enter a reason."),n?.focus();return}if(c.length<4){d&&(d.textContent="Please enter at least a few words."),n?.focus();return}a(),o(c)};r.querySelector("#ws-dead-submit")?.addEventListener("click",s),r.querySelector("#ws-dead-reason")?.addEventListener("keydown",n=>{n.key==="Enter"&&(n.metaKey||n.ctrlKey)&&(n.preventDefault(),s()),n.key==="Escape"&&l()}),setTimeout(()=>{r.querySelector("#ws-dead-reason")?.focus()},0)},le="ws-crm-appointment-sanity-modal",je=(o,e)=>{document.getElementById(le)?.remove();let t=document.createElement("div");t.id=le,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),l=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&l()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",l),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),o()});let s=n=>{n.key==="Escape"&&(document.removeEventListener("keydown",s),l())};document.addEventListener("keydown",s)},ie=o=>{let e=document.createElement("div");e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    flex-shrink: 0;
  `,e.appendChild(ze(o));let t=document.createElement("button");return t.type="button",t.style.cssText=A,t.textContent="Offer Made",t.addEventListener("click",()=>We(o)),e.appendChild(t),e},Ye=async()=>{let o=E();if(!o){document.getElementById(O)?.remove();return}let e=document.getElementById(O);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await Ve();if(!t){b.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=E();if(!r||r.contactId!==o.contactId)return;let a=ie(o.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),b.debug(`Mounted contact actions bar for ${o.contactId}`);let l=null;l=new MutationObserver(()=>{let s=document.getElementById(O);if(!(E()?.contactId===o.contactId)){l?.disconnect();return}if(!s){let d=ie(o.contactId);d.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),b.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),l.observe(t,{childList:!0})},de=()=>{Ye()};var P="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Ke=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),D="data-ws-crm-favicon",Y=o=>o.hasAttribute(D),ce=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Ke.has(e)},G=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ce(r)&&!Y(r)&&r.remove()});let e=document.head.querySelector(`link[${D}="1"]`);e?e.href!==P&&(e.href=P):(e=document.createElement("link"),e.setAttribute(D,"1"),e.rel="icon",e.type="image/png",e.href=P,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${D}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(D,"apple"),t.rel="apple-touch-icon",t.href=P,document.head.appendChild(t))},be=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)G();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),G())},50)}new MutationObserver(r=>{let a=!1;for(let l of r)l.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ce(s)&&!Y(s)&&(a=!0)}),l.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Y(s)&&(a=!0)});a&&G()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,G(),e>=5&&window.clearInterval(t)},1e3)};var z="reos-theme-stylesheet",X="reos-theme-fonts",Xe=()=>{if(document.getElementById(X))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com",document.head.appendChild(o);let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.gstatic.com",e.crossOrigin="anonymous",document.head.appendChild(e);let t=document.createElement("link");t.id=X,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},Je=`
/* ============================================
...
/* 18a-contact-name-link (v0.8.46). Contact rows on the smart-list
   page render names as <a class="contact-name-link"> with inline
   color: inherit. Default cascades to bone via the cell rule, but
   on hover GHL's generic 'a:hover' paints blue. Tim wants emerald
   on hover for the clickable affordance signal. */
html body .contact-name-link,
html body a.contact-name-link {
  color: var(--reos-bone) !important;
  -webkit-text-fill-color: var(--reos-bone) !important;
}
html body .contact-name-link:hover,
html body a.contact-name-link:hover {
  color: var(--reos-emerald) !important;
  -webkit-text-fill-color: var(--reos-emerald) !important;
...
`,Ze=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Qe=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(a))return o;if(e.length===8){let l=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${a}, ${l})`}return`rgb(${t}, ${r}, ${a})`},et=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),$=()=>{for(let o of Ze){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,a]of Object.entries(o.styles)){let l=t.style.getPropertyPriority(r),s=t.style.getPropertyValue(r),n=et.has(r)?Qe(a):a;l==="important"&&s===n||t.style.setProperty(r,a,"important")}})}},J="#1A1F28",tt=26,ot=31,rt=40,he=new Set,pe=new Set,U=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!pe.has(a)&&a!=="<no class>"&&(pe.add(a),b.debug(`Hid empty "--" leaf: "${a}"`))})},me=new Set,at=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let l=Array.from(e.children);if(l.length>0&&l.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let p=e.className?.toString()||"<no class>";!me.has(p)&&p!=="<no class>"&&(me.add(p),b.debug(`Remapped pure-white text -> bone: "${p}"`))})},ue=new Set,nt=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(e=>{e.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar"))return;let l=window.getComputedStyle(r),s=l.backgroundColor,n=l.backgroundImage||"",d=!1;if(n!=="none"&&n.includes("gradient"))d=!0;else if(s&&s!=="rgba(0, 0, 0, 0)"&&s!=="transparent"){let y=s.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(y&&parseFloat(y[1])<.6)return;let g=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let k=parseInt(g[1],10),S=parseInt(g[2],10),W=parseInt(g[3],10);(k>=60||S>=60||W>=60)&&(k>230&&S>230&&W>230||(k>=80||S>=80||W>=80)&&(d=!0))}}if(!d)return;let p=(r.textContent||"").trim(),m=a,h=Array.from(r.querySelectorAll("*")).map(y=>(y.className?.toString()||"").toLowerCase()).join(" "),x=p.toLowerCase()==="ask ai"||m.includes("ai-button")||m.includes("ask-ai")||m.includes("askai"),v=m.includes("bg-clip-text")||m.includes("text-transparent")||h.includes("bg-clip-text")||h.includes("text-transparent"),u=Array.from(r.querySelectorAll("*")).some(y=>{let g=window.getComputedStyle(y),k=g.getPropertyValue("-webkit-background-clip")||"",S=g.getPropertyValue("background-clip")||"";return k.includes("text")||S.includes("text")});if(x||v||u){let y=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=k=>{y.forEach(S=>k.style.removeProperty(S))};g(r),r.querySelectorAll("*").forEach(g);return}let w="#12161D";r.style.setProperty("color",w,"important"),r.querySelectorAll("*").forEach(y=>{let g=y.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(y.style.setProperty("fill",w,"important"),y.style.setProperty("stroke",w,"important"),y.style.setProperty("color",w,"important")):(y.style.setProperty("color",w,"important"),y.style.setProperty("-webkit-text-fill-color",w,"important"))});let T=r.className?.toString()||"<no class>";!ue.has(T)&&T!=="<no class>"&&(ue.add(T),b.debug(`Darkened SVG icons on colored button: "${T}"`))})})},ye=new Set,st=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0||t.width<20||t.width>64||t.height<20||t.height>64)return;let r=t.top+t.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(n=>{let d=n;if(d.closest("[id^='ws-crm-']"))return;let c=n.getBoundingClientRect();if(c.width===0||c.width>28||c.height>28)return;let p=c.left<t.right&&c.right>t.left,m=c.top<t.bottom&&c.bottom>t.top;if(!(p&&m)||c.top+c.height/2<r)return;let x=c.width*c.height/(t.width*t.height);if(x>.55)return;let v=d,u=d.parentElement,w=0;for(;u&&u!==e&&w<3;){let y=u.getBoundingClientRect();if(y.width>0&&y.width<=30&&y.height<=30)v=u;else break;u=u.parentElement,w++}v.style.setProperty("transform","translateY(11px)","important");let T=(v.className?.toString()||"")+" "+v.tagName;ye.has(T)||(ye.add(T),b.debug(`Dropped activity badge 11px (${c.width.toFixed(0)}x${c.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${T}"`))})})},lt="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",it=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",lt,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let l=a.style.color;(l==="rgb(18, 22, 29)"||l==="#12161D"||l==="#0FB57E"||l==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},ge=new Set,dt=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let n=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(n>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!ge.has(p)&&p!=="<no class>"&&(ge.add(p),b.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${n},${d},${c})): "${p}"`))})})},ve=new Set,ct=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let a=(t.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=t.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let n=t.className?.toString()||"<no class>";!ve.has(n)&&n!=="<no class>"&&(ve.add(n),b.debug(`Painted Ask AI wrapper graphite: "${n}"`))}}t=t.parentElement,r++}})},fe=new Set,bt=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let l=window.getComputedStyle(a);if(l.position!=="fixed"&&l.position!=="absolute")return;let s=parseInt(l.zIndex,10);if(!isFinite(s)||s<50)return;let n=a.getBoundingClientRect();n.width<240||n.height<120||n.width>1500||n.height>900||t.push(a)}),[...o,...t].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let n=(s.className?.toString()||"").toLowerCase();if(n.includes("avatar")||n.includes("notification-dot")||n.includes("indicator"))return;if(n.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(n.includes("tabulator")||n.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(n.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(n.includes("ai-button")||n.includes("ask-ai")||n.includes("bg-clip-text")||n.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let p=parseInt(c[1],10),m=parseInt(c[2],10),h=parseInt(c[3],10);if(!(p>200&&m>200&&h>200))return;let v=s.getBoundingClientRect();if(v.width<24||v.height<16||v.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let u=s.className?.toString()||"<no class>";!fe.has(u)&&u!=="<no class>"&&(fe.add(u),b.debug(`Coerced light bg (${v.width.toFixed(0)}x${v.height.toFixed(0)}, rgb(${p},${m},${h})): "${u}"`))})})},we=new Set,ht=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']")||t.matches("[role='heading']")||t.closest("[role='heading']")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']"))return;let a=t,l=null;for(let p=0;p<4&&a;p++){let m=a.nextElementSibling;if(m&&(m.matches(o)||m.querySelector(o)!==null)){l=m;break}a=a.parentElement}if(!l)return;let s=t.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let n=l,d=n.getBoundingClientRect();d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(n.style.setProperty("background-color",J,"important"),n.style.setProperty("border-color","#252C36","important"),n.style.setProperty("border-style","solid","important"),n.style.setProperty("border-width","1px","important"),n.style.setProperty("border-radius","4px","important"));let c=t.className?.toString()||"<no class>";!we.has(c)&&c!=="<no class>"&&(we.add(c),b.debug(`Colored field label "${r.slice(0,30)}": "${c}"`))})},_e=new Set,pt=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let l=(e.textContent||"").trim();if(l.length===0||l.length>4)return;let s=Math.min(r.width,r.height),n=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${n}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${n}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!_e.has(d)&&d!=="<no class>"&&(_e.add(d),b.debug(`Resized avatar text to ${n}px (circle ${s.toFixed(0)}px): "${d}"`))})},xe=new Set,mt=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;e.style.setProperty("background-color",J,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=e.className?.toString()||"<no class>";!xe.has(r)&&r!=="<no class>"&&(xe.add(r),b.debug(`Forced input slate bg: "${r}"`))})},V=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>t.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let l=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!l)return;let s=parseInt(l[1],10),n=parseInt(l[2],10),d=parseInt(l[3],10);if(!(s<tt&&n<ot&&d<rt))return;let p=e.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;e.style.setProperty("background-color",J,"important");let m=e.className?.toString()||"<no class>";!he.has(m)&&m!=="<no class>"&&(he.add(m),b.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${s},${n},${d})): "${m}"`))})},ke=()=>{let o,e=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,$(),mt(),V(),U(),ht(),bt(),ct(),dt(),it(),nt(),pt(),st(),at()},100))};$(),V(),U(),window.setTimeout(()=>{$(),V(),U()},500),window.setTimeout(()=>{$(),V(),U()},1500),new MutationObserver(()=>{e()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},K,ut=()=>{let o=()=>{let t=document.getElementById(z);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let a of t){for(let l of Array.from(a.addedNodes)){if(!(l instanceof Element))continue;let s=l.tagName.toLowerCase();if(s==="style"||s==="link"){if(l.id===z||l.id===X)continue;r=!0;break}}if(r)break}r&&K===void 0&&(K=window.setTimeout(()=>{K=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Ee=()=>{if(Xe(),!document.getElementById(z)){let o=document.createElement("style");o.id=z,o.textContent=Je,document.head.appendChild(o),b.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?ke():window.addEventListener("DOMContentLoaded",ke)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,ut())};var Te="ws-crm-customizer-version-badge",Se=()=>{if(document.getElementById(Te))return;let o=document.createElement("div");o.id=Te,o.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Fe=()=>{b.info(`Loaded v${M} (built ${B})`),be(),Ee(),ee(),Q(o=>{b.debug("Page handler firing for:",o),Se(),ae(),de()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fe):Fe();})();
