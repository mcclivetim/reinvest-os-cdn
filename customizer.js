...
html body .n-base-select-option--pending .n-base-select-option__content,
html body .n-base-select-option:hover .n-base-select-option__content {
  color: var(--reos-bone) !important;
  -webkit-text-fill-color: var(--reos-bone) !important;
}
