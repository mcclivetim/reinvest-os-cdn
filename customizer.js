/* Wholesaling CRM Customizer v0.13.73 — built 2026-05-27T23:45:20.233Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var pe="[wholesaling-crm-customizer]",Po="__WS_CRM_DEBUG",No=()=>!!window[Po],b={info(...o){console.log(pe,...o)},warn(...o){console.warn(pe,...o)},error(...o){console.error(pe,...o)},debug(...o){No()&&console.log(pe,"[debug]",...o)}};var Et=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ze=/\/v2\/location\/([A-Za-z0-9]+)/,Bo=o=>{let e=o.match(Et);if(!e)return null;let t=o.match(ze);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ro=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Et);if(!n)continue;let a=r.match(ze)||window.location.pathname.match(ze);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Bo(window.location.pathname);return o||Ro()};var Tt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ue="",We=null,W="other",je=new Set,me=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ue)&&!(o!==We))){ue=window.location.pathname,We=o,W=Tt(),b.debug("Page/context changed:",W,ue,"contact:",o);for(let r of je)try{r(W)}catch(n){b.error("Subscriber threw:",n)}}},St=o=>(je.add(o),setTimeout(()=>o(W),0),()=>{je.delete(o)}),Ct=()=>{W=Tt(),ue=window.location.pathname,We=S()?.contactId??null,b.debug("Router init, current page:",W);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),me()},history.replaceState=function(t,r,n){e(t,r,n),me()},window.addEventListener("popstate",me),setInterval(me,1e3)};var _e="0.13.73",ve="2026-05-27T23:45:20.233Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let i=n.querySelector(o);if(i){a(i);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ke={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},It=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var $o=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&$o.test(o),Go=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Uo=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Vo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},qo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Go(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},zo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>Uo()||Vo()||qo()||zo()||null;var Mt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Wo=`${Mt}/active-follow-up-get`,jo=`${Mt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",Xe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Ko=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Yo=async o=>{let e=await fetch(Wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xo=async(o,e)=>{let t=await fetch(jo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},q=(o,e)=>{let t=Xe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Lt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,q(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ko();if(!(!r||r.contactId!==o)){q(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Xo(r,L()),a=n&&n.state&&n.state in Xe?n.state:"blue";q(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),q(e,"error"),setTimeout(()=>void ye(e,r),4e3)}}}),e},ye=async(o,e)=>{q(o,"loading");try{let t=await Yo(e),r=t&&t.state&&t.state in Xe?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;q(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),q(o,"error")}},Jo=[".central-panel","[class*='central-panel']"],Ye="ws-crm-contact-actions-bar",Zo=async()=>{for(let o of Jo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Qo=async(o,e)=>{let t=e.querySelector(`#${Ye}`);if(!t)try{t=await C(`#${Ye}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Ye}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},er=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},tr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},or=async o=>{if(o==="url"){let t=await Zo();return t?{kind:"contact-detail",target:t}:null}let e=er();return e?{kind:"conversations",target:e}:null},At=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await Qo(o,e.target);return t}return tr(o,e.target),"conversations-header"},rr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(V)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(V);if(t&&t.dataset.contactId===e.contactId){ye(t,e);return}t&&t.remove();let r=await or(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=Lt(e.contactId),s=await At(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Ft();let i=document.getElementById(V)??a;ye(i,e);let d=new MutationObserver(()=>{let c=document.getElementById(V);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Lt(e.contactId);At(m,r).then(()=>{Ft(),ye(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Z=null,Dt=()=>{let o=S()?.contactId??null;if(Z&&Z.contactId===o)return;let e=rr().finally(()=>{Z?.promise===e&&(Z=null)});Z={contactId:o,promise:e}},Ft=()=>{let o=document.querySelectorAll(`#${V}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",nr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",sr=async o=>{let e=await fetch(nr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},ir=async o=>{let e=await fetch(ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Pt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},j=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=It(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",i=>{i.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=i=>{i.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},Vt=(o,e)=>{let t=document.createElement("div");t.id=K,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=ke();!t||!t.locationId||t.oppId!==o||Nr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Rr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$r=async()=>{for(let o of Rr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},xe=!1,ot=async()=>{if(!xe){xe=!0;try{await Gr()}finally{xe=!1}}},Gr=async()=>{let o=ke();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await $r();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=ke();if(!n||n.oppId!==o.oppId)return;let a=Br(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Ur(o.oppId)},te=null,tt=null,oe=()=>{te?.disconnect(),te=null,tt=null},Ur=o=>{if(te&&tt===o)return;oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(tt=o,te=new MutationObserver(()=>{let t=ke();if(!t||t.oppId!==o){oe();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}document.getElementById(D)||ot()}),te.observe(e,{childList:!0,subtree:!0}))},Qe=null,et,Vr=()=>{Qe||(Qe=new MutationObserver(()=>{et===void 0&&(et=window.setTimeout(()=>{et=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!xe&&ot()},300))}),Qe.observe(document.body,{childList:!0,subtree:!0}))},Zt=()=>{Vr(),ot()};var qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",zr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wr=/\/v2\/location\/([A-Za-z0-9]+)/,Te=()=>{let o=window.location.pathname,e=o.match(zr);if(!e)return null;let t=o.match(Wr);return{oppId:e[1],locationId:t?t[1]:null}},jr=async o=>{let e=await fetch(qr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Kr=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Te();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await jr({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Yr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xr=async()=>{for(let o of Yr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ee=!1,st=async()=>{if(!Ee){Ee=!0;try{await Jr()}finally{Ee=!1}}},Jr=async()=>{let o=Te();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Xr();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Te();if(!n||n.oppId!==o.oppId)return;let a=Kr(o.oppId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),Zr(o.oppId)},re=null,at=null,ne=()=>{re?.disconnect(),re=null,at=null},Zr=o=>{if(re&&at===o)return;ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(at=o,re=new MutationObserver(()=>{let t=Te();if(!t||t.oppId!==o){ne();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}document.getElementById(O)||st()}),re.observe(e,{childList:!0,subtree:!0}))},rt=null,nt,Qr=()=>{rt||(rt=new MutationObserver(()=>{nt===void 0&&(nt=window.setTimeout(()=>{nt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Ee&&st()},300))}),rt.observe(document.body,{childList:!0,subtree:!0}))},Qt=()=>{Qr(),st()};var en="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",eo="ws-crm-reduce-price-modal",tn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,on=/\/v2\/location\/([A-Za-z0-9]+)/,Ie=()=>{let o=window.location.pathname,e=o.match(tn);if(!e)return null;let t=o.match(on);return{oppId:e[1],locationId:t?t[1]:null}},rn=async o=>{let e=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Se=()=>{document.getElementById(eo)?.remove()},nn=o=>{Se();let e=document.createElement("div");e.id=eo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Ie();!r||!r.locationId||r.oppId!==o||nn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,a&&(a.style.background=l.emerald,a.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,a&&(a.style.background=l.amber,a.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},sn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ln=async()=>{for(let o of sn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ce=!1,ct=async()=>{if(!Ce){Ce=!0;try{await dn()}finally{Ce=!1}}},dn=async()=>{let o=Ie();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),se();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),se());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await ln();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Ie();if(!n||n.oppId!==o.oppId)return;let a=an(o.oppId,o.locationId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),cn(o.oppId)},ae=null,dt=null,se=()=>{ae?.disconnect(),ae=null,dt=null},cn=o=>{if(ae&&dt===o)return;se();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(dt=o,ae=new MutationObserver(()=>{let t=Ie();if(!t||t.oppId!==o){se();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),se();return}document.getElementById(H)||ct()}),ae.observe(e,{childList:!0,subtree:!0}))},it=null,lt,bn=()=>{it||(it=new MutationObserver(()=>{lt===void 0&&(lt=window.setTimeout(()=>{lt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ce&&ct()},300))}),it.observe(document.body,{childList:!0,subtree:!0}))},to=()=>{bn(),ct()};var ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-title-co-button",Y="ws-crm-send-to-title-co-wrap",Fe="ws-crm-stc-dropdown",hn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pn=/\/v2\/location\/([A-Za-z0-9]+)/,pt=()=>{let o=window.location.pathname,e=o.match(hn);if(!e)return null;let t=o.match(pn);return{oppId:e[1],locationId:t?t[1]:null}},mn=5*60*1e3,no=o=>`ws-crm-stc-cache:${o}`,un=o=>{try{let e=window.localStorage.getItem(no(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>mn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},_n=(o,e)=>{try{window.localStorage.setItem(no(o),JSON.stringify(e))}catch{}},vn=async(o,e)=>{try{let t=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},yn=async(o,e,t)=>{let r=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},gn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},oo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},fn=(o,e)=>{if(e&&gn(e)){window.setTimeout(()=>oo(o),300);return}oo(o)},N=()=>{document.getElementById(Fe)?.remove()},Le=(o,e,t)=>{N();let r=document.createElement("div");r.id=Fe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Tn(o.oppId)},ie=null,mt=null,le=()=>{ie?.disconnect(),ie=null,mt=null},Tn=o=>{if(ie&&mt===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(mt=o,ie=new MutationObserver(()=>{let t=pt();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),N(),le();return}document.getElementById(z)||ut()}),ie.observe(e,{childList:!0,subtree:!0}))},bt=null,ht,Sn=()=>{bt||(bt=new MutationObserver(()=>{ht===void 0&&(ht=window.setTimeout(()=>{ht=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);o&&!e&&!Ae&&ut()},300))}),bt.observe(document.body,{childList:!0,subtree:!0}))},ao=()=>{Sn(),ut()};var Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",lo="ldtyB2UXKi9vOp8nLUH7",An="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",co="ws-crm-title-officer-picker-modal",Fn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mn=/\/v2\/location\/([A-Za-z0-9]+)/,yt=()=>{let o=window.location.pathname,e=o.match(Fn);if(!e)return null;let t=o.match(Mn);return{oppId:e[1],locationId:t?t[1]:null}},bo=async o=>{let e=await fetch(Cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},so=async o=>{let e=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Dn=async(o,e)=>{try{let t=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:lo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await bo({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},ho="ws-crm-title-officer-field-link",po=()=>{document.querySelectorAll(`.${ho}`).forEach(o=>o.remove()),document.querySelectorAll('input[data-ws-title-officer-decorated="1"]').forEach(o=>{o.style.removeProperty("color"),o.style.removeProperty("caret-color"),delete o.dataset.wsTitleOfficerDecorated})},io=(o,e,t)=>{po(),document.querySelectorAll("input").forEach(n=>{if(n.value!==o||n.dataset.wsTitleOfficerDecorated==="1")return;let a=n.parentElement;if(!a)return;n.dataset.wsTitleOfficerDecorated="1",n.style.color="transparent",n.style.caretColor="transparent",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let i=document.createElement("a");i.className=ho,i.href=`/v2/location/${t}/contacts/detail/${o}`,i.textContent=e,i.style.cssText=`
      ...
      pointer-events: auto;
      background: transparent;
    `,i.addEventListener("mouseenter",()=>{i.style.textDecoration="underline"}),i.addEventListener("mouseleave",()=>{i.style.textDecoration="none"}),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=i.href}),a.appendChild(i)})},Me=()=>{document.getElementById(co)?.remove()},On=o=>{Me();let e=document.createElement("div");e.id=co,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Me()}),a?.addEventListener("click",Me);let s,i="",d=async c=>{if(n&&c!==i){if(i=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await bo({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};return X(t,r),(async()=>{let a=await Dn(o,e);a?(r={status:"linked",contactName:a.name},X(t,r),io(a.id,a.name,e)):(r={status:"empty"},X(t,r),po())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||On({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},X(t,r);try{let s=[so({tenantId:e,oppId:o,fieldId:lo,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(so({tenantId:e,oppId:o,fieldId:An,value:a.companyName.trim()}));let d=(await Promise.all(s))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},X(t,r),io(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},X(t,r)}}})}),t},Pn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Nn=async()=>{for(let o of Pn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,ft=async()=>{if(!Oe){Oe=!0;try{await Bn()}finally{Oe=!1}}},Bn=async()=>{let o=yt();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),He();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),He());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Nn();if(!r||await U()!=="Transaction Coordination")return;let a=yt();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=Hn(o.oppId,a.locationId),i=document.createElement("span");i.id=`${R}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),i.appendChild(s),r.appendChild(i),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Rn(o.oppId)},de=null,gt=null,He=()=>{de?.disconnect(),de=null,gt=null},Rn=o=>{if(de&&gt===o)return;He();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gt=o,de=new MutationObserver(()=>{let t=yt();if(!t||t.oppId!==o){He();return}document.getElementById(R)||ft()}),de.observe(e,{childList:!0,subtree:!0}))},_t=null,vt,$n=()=>{_t||(_t=new MutationObserver(()=>{vt===void 0&&(vt=window.setTimeout(()=>{vt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!Oe&&ft()},300))}),_t.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{$n(),ft()};var Ge="reos-theme-stylesheet",Mo="reos-theme-fonts",Gn=()=>{let o=document.getElementById(Mo);o&&o.remove()},Un=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Ho=()=>{b.info(`Loaded v${_e} (built ${ve})`),M("mountVersionBadge (initial)",Ve),M("mountFavicon",Xt),M("mountThemeStylesheet",Do),M("initPageRouter",Ct),b.info("[main] registering onPageChange subscriber"),St(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",Ve),M("mountClaimReleaseToggle",Nt),M("mountContactActionsBar",Kt),M("mountActiveFollowUpButton",Dt),M("mountMtOfferMadeButton",Zt),M("mountNotInterestedButton",Qt),M("mountReducePriceButton",to),M("mountSendToTitleCoButton",ao),M("mountTitleOfficerPickerButton",mo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ho):Ho();})();
