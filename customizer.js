/* Wholesaling CRM Customizer v0.5.18 — built 2026-05-16T04:34:49.303Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var w="[wholesaling-crm-customizer]",ne="__WS_CRM_DEBUG",se=()=>!!window[ne],d={info(...e){console.log(w,...e)},warn(...e){console.warn(w,...e)},error(...e){console.error(w,...e)},debug(...e){se()&&console.log(w,"[debug]",...e)}};var R=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},E="",y="other",M=new Set,k=()=>{if(window.location.pathname!==E){E=window.location.pathname,y=R(),d.debug("Page changed:",y,E);for(let e of M)try{e(y)}catch(o){d.error("Subscriber threw:",o)}}},B=e=>(M.add(e),setTimeout(()=>e(y),0),()=>{M.delete(e)}),H=()=>{y=R(),E=window.location.pathname,d.debug("Router init, current page:",y);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),k()},history.replaceState=function(t,r,a){o(t,r,a),k()},window.addEventListener("popstate",k),setInterval(k,1e3)};var _="0.5.18",S="2026-05-16T04:34:49.304Z";var ie=/\/contacts\/detail\/([A-Za-z0-9]+)/,le=/\/v2\/location\/([A-Za-z0-9]+)/,g=()=>{let e=window.location.pathname,o=e.match(ie);if(!o)return null;let t=e.match(le);return{contactId:o[1],locationId:t?t[1]:null}};var v=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,l)=>{let s=a.querySelector(e);if(s){n(s);return}let c,p,b=()=>{u&&u.disconnect(),c!==void 0&&window.clearTimeout(c),p!==void 0&&window.clearInterval(p)},u=new MutationObserver(()=>{let m=a.querySelector(e);m&&(b(),n(m))});u.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let m=a.querySelector(e);m&&(b(),n(m))},r),c=window.setTimeout(()=>{b(),d.warn(`waitForElement timed out for selector: ${e}`),l(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},f={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},D={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},O=e=>{let o=e==="emerald"?i.emeraldGlow:e==="amber"?i.amberGlow:i.slate,t=e==="emerald"?i.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=e==="emerald"?i.emerald:e==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var x="ws-crm-claim-release-pill",N=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ce=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=x,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?i.emerald:i.amber;return t.style.cssText=O(r),t.innerHTML=`
  ...
  `,ge.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=i.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{d.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let l=t.firstElementChild,s=t.children[1],c=t.children[2];l&&(l.style.background=D[a.color]),s&&(s.textContent=a.label),r.style.display="none";let b=g()?.locationId,u=me();if(!b){d.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),s&&(s.textContent=`${a.label} (no tenant!)`),s&&(s.style.color=i.amber);return}if(a.color==="green"&&!u){d.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),s&&(s.textContent=`${a.label} (no user!)`),s&&(s.style.color=i.amber);return}let m=c?.textContent??"\u25BE";c&&(c.textContent="\u2026"),t.style.opacity="0.75";try{await he({contactId:e,locationId:b,status:a.label,userId:u}),c&&(c.textContent="\u2713"),setTimeout(()=>{c&&(c.textContent=m),t.style.opacity="1"},900)}catch(ae){d.warn("Call Status webhook failed:",ae),c&&(c.textContent="\u2717"),s&&(s.style.color=i.amber),t.style.opacity="1",setTimeout(()=>{c&&(c.textContent=m),s&&(s.style.color=i.bone)},1800)}}),r.appendChild(n)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{o.contains(a.target)||(r.style.display="none")}),o.appendChild(t),o.appendChild(r),o},xe=e=>{document.getElementById(z)?.remove();let o=document.createElement("div");o.id=z,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let r=new Date,a=new Date(r.getTime()+5*24*60*60*1e3).toISOString().slice(0,10);t.innerHTML=`
    ...
    <div style="
      ...
      margin-bottom: 16px;
    ">
      <span style="color: ${i.ash}; font-family: ${h.mono}; font-size: 14px;">$</span>
