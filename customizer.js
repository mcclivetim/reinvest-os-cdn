/* Wholesaling CRM Customizer v0.5.10 — built 2026-05-16T03:51:46.462Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var w="[wholesaling-crm-customizer]",te="__WS_CRM_DEBUG",oe=()=>!!window[te],i={info(...e){console.log(w,...e)},warn(...e){console.warn(w,...e)},error(...e){console.error(w,...e)},debug(...e){oe()&&console.log(w,"[debug]",...e)}};var R=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},E="",y="other",M=new Set,k=()=>{if(window.location.pathname!==E){E=window.location.pathname,y=R(),i.debug("Page changed:",y,E);for(let e of M)try{e(y)}catch(t){i.error("Subscriber threw:",t)}}},B=e=>(M.add(e),setTimeout(()=>e(y),0),()=>{M.delete(e)}),O=()=>{y=R(),E=window.location.pathname,i.debug("Router init, current page:",y);let e=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(o,r,a){e(o,r,a),k()},history.replaceState=function(o,r,a){t(o,r,a),k()},window.addEventListener("popstate",k),setInterval(k,1e3)};var _="0.5.10",C="2026-05-16T03:51:46.463Z";var re=/\/contacts\/detail\/([A-Za-z0-9]+)/,ae=/\/v2\/location\/([A-Za-z0-9]+)/,m=()=>{let e=window.location.pathname,t=e.match(re);if(!t)return null;let o=e.match(ae);return{contactId:t[1],locationId:o?o[1]:null}};var v=(e,t={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=t;return new Promise((n,d)=>{let l=a.querySelector(e);if(l){n(l);return}let c,u,g=()=>{f&&f.disconnect(),c!==void 0&&window.clearTimeout(c),u!==void 0&&window.clearInterval(u)},f=new MutationObserver(()=>{let h=a.querySelector(e);h&&(g(),n(h))});f.observe(document.body,{childList:!0,subtree:!0}),u=window.setInterval(()=>{let h=a.querySelector(e);h&&(g(),n(h))},r),c=window.setTimeout(()=>{g(),i.warn(`waitForElement timed out for selector: ${e}`),d(new Error(`Selector not found within ${o}ms: ${e}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},b={sm:"4px",md:"6px",lg:"10px",pill:"999px"},p={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},D={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},P=e=>{let t=e==="emerald"?s.emeraldGlow:e==="amber"?s.amberGlow:s.slate,o=e==="emerald"?s.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=e==="emerald"?s.emerald:e==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,A=`
  ...
  flex-shrink: 0;
`;var x="ws-crm-claim-release-pill",N=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ne=({contactId:e,mode:t})=>{let o=document.createElement("button");o.id=x,o.type="button",o.dataset.contactId=e,o.dataset.mode=t;let r=t==="claim"?"emerald":"amber",a=t==="claim"?s.emerald:s.amber;return o.style.cssText=P(r),o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.appendChild(o),document.body.appendChild(t);let n=()=>t.remove();t.addEventListener("click",d=>{d.target===t&&n()}),o.querySelector("#ws-offer-cancel")?.addEventListener("click",n),o.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let d=(o.querySelector("#ws-offer-amount")?.value??"").trim(),l=o.querySelector("#ws-offer-expires")?.value??"";if(!d||Number(d)<=0){i.warn("Offer Made submit blocked \u2014 invalid amount");return}i.info(`Offer Made recorded for contact ${e}: $${d}, expires ${l}`),n()}),setTimeout(()=>{o.querySelector("#ws-offer-amount")?.focus()},0)},U=e=>{let t=document.createElement("div");t.id=T,t.dataset.contactId=e,t.style.cssText=`
    ...
    flex-shrink: 0;
  `,t.appendChild(he(e));let o=document.createElement("button");return o.type="button",o.style.cssText=$,o.textContent="Offer Made",o.addEventListener("click",()=>ge(e)),t.appendChild(o),t},fe=async()=>{let e=m();if(!e){document.getElementById(T)?.remove();return}let t=document.getElementById(T);if(t&&t.dataset.contactId===e.contactId)return;t&&t.remove();let o=await be();if(!o){i.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=m();if(!r||r.contactId!==e.contactId)return;let a=U(e.contactId);a.dataset.mountTarget=o.className||"central-panel",o.insertBefore(a,o.firstChild),i.debug(`Mounted contact actions bar for ${e.contactId}`);let n=null;n=new MutationObserver(()=>{let d=document.getElementById(T);if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(!d){let c=U(e.contactId);c.dataset.mountTarget=a.dataset.mountTarget??"",o.insertBefore(c,o.firstChild),i.debug(`Re-mounted actions bar after React wipe for ${e.contactId}`)}}),n.observe(o,{childList:!0})},W=()=>{fe()};var V="reos-theme-stylesheet",q="reos-theme-fonts",ye=()=>{if(document.getElementById(q))return;let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.googleapis.com",document.head.appendChild(e);let t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.gstatic.com",t.crossOrigin="anonymous",document.head.appendChild(t);let o=document.createElement("link");o.id=q,o.rel="stylesheet",o.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(o)},ve=`
/* ============================================
