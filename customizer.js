/* Wholesaling CRM Customizer v0.10.32 — built 2026-05-21T20:53:41.755Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var R="[wholesaling-crm-customizer]",Ne="__WS_CRM_DEBUG",Me=()=>!!window[Ne],h={info(...o){console.log(R,...o)},warn(...o){console.warn(R,...o)},error(...o){console.error(R,...o)},debug(...o){Me()&&console.log(R,"[debug]",...o)}};var oe=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},B="",C="other",J=new Set,O=()=>{if(window.location.pathname!==B){B=window.location.pathname,C=oe(),h.debug("Page changed:",C,B);for(let o of J)try{o(C)}catch(e){h.error("Subscriber threw:",e)}}},re=o=>(J.add(o),setTimeout(()=>o(C),0),()=>{J.delete(o)}),ne=()=>{C=oe(),B=window.location.pathname,h.debug("Router init, current page:",C);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,a){o(t,r,a),O()},history.replaceState=function(t,r,a){e(t,r,a),O()},window.addEventListener("popstate",O),setInterval(O,1e3)};var G="0.10.32",V="2026-05-21T20:53:41.756Z";var Pe=/\/contacts\/detail\/([A-Za-z0-9]+)/,Re=/\/v2\/location\/([A-Za-z0-9]+)/,F=()=>{let o=window.location.pathname,e=o.match(Pe);if(!e)return null;let t=o.match(Re);return{contactId:e[1],locationId:t?t[1]:null}};var L=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let n=a.querySelector(o);if(n){s(n);return}let l,c,p=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let d=a.querySelector(o);d&&(p(),s(d))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let d=a.querySelector(o);d&&(p(),s(d))},r),l=window.setTimeout(()=>{p(),h.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var b={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},k={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Z={purple:"#8B5CF6",green:b.emerald,orange:b.amber,red:b.crimson},ae=o=>{let e=o==="emerald"?b.emeraldGlow:o==="amber"?b.amberGlow:b.slate,t=o==="emerald"?b.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":b.steel,r=o==="emerald"?b.emerald:o==="amber"?b.amber:b.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var H="ws-crm-claim-release-pill",ie=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Oe=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=H,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",a=e==="claim"?b.emerald:b.amber;return t.style.cssText=ae(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,je.forEach(a=>{let s=document.createElement("button");s.type="button",s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,s.addEventListener("mouseenter",()=>{s.style.background=b.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{h.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${o}`);let i=t.firstElementChild,n=t.children[1],l=t.children[2];i&&(i.style.background=Z[a.color]),n&&(n.textContent=a.label),r.style.display="none";let p=F()?.locationId,m=$e();if(!p){h.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),n&&(n.textContent=`${a.label} (no tenant!)`),n&&(n.style.color=b.amber);return}if(a.color==="green"&&!m){h.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),n&&(n.textContent=`${a.label} (no user!)`),n&&(n.style.color=b.amber);return}let d=l?.textContent??"\u25BE",y=async u=>{l&&(l.textContent="\u2026"),t.style.opacity="0.75";try{await qe({contactId:o,locationId:p,status:a.label,userId:m,deadReason:u}),l&&(l.textContent="\u2713"),setTimeout(()=>{l&&(l.textContent=d),t.style.opacity="1"},900)}catch(v){h.warn("Call Status webhook failed:",v),l&&(l.textContent="\u2717"),n&&(n.style.color=b.amber),t.style.opacity="1",setTimeout(()=>{l&&(l.textContent=d),n&&(n.style.color=b.bone)},1800)}};if(a.value==="dead-deal"){let u=n?.textContent??"";Ze(v=>{y(v)},()=>{n&&(n.textContent=u)});return}if(a.value==="appointment-booked"){let u=n?.textContent??"";try{(await ze({contactId:o,tenantId:p})).ok?await y():Qe(()=>{y()},()=>{n&&(n.textContent=u)})}catch(v){h.warn("Appointment sanity check failed; firing anyway:",v),await y()}return}await y()}),r.appendChild(s)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{e.contains(a.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},Je=o=>{document.getElementById(de)?.remove();let e=document.createElement("div");e.id=de,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let r=new Date,a=new Date(r.getTime()+5*24*60*60*1e3).toISOString().slice(0,10);t.innerHTML=`
    ...
    <div style="
      ...
      margin-bottom: 16px;
    ">
      <span style="color: ${b.ash}; font-family: ${f.mono}; font-size: 14px;">$</span>
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),s=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&s()}),r.querySelector("#ws-dead-cancel")?.addEventListener("click",s);let i=()=>{let n=r.querySelector("#ws-dead-reason"),l=r.querySelector("#ws-dead-error"),c=(n?.value??"").trim();if(!c){l&&(l.textContent="Please enter a reason."),n?.focus();return}if(c.length<4){l&&(l.textContent="Please enter at least a few words."),n?.focus();return}a(),o(c)};r.querySelector("#ws-dead-submit")?.addEventListener("click",i),r.querySelector("#ws-dead-reason")?.addEventListener("keydown",n=>{n.key==="Enter"&&(n.metaKey||n.ctrlKey)&&(n.preventDefault(),i()),n.key==="Escape"&&s()}),setTimeout(()=>{r.querySelector("#ws-dead-reason")?.focus()},0)},be="ws-crm-appointment-sanity-modal",Qe=(o,e)=>{document.getElementById(be)?.remove();let t=document.createElement("div");t.id=be,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),s=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),o()});let i=n=>{n.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},he=o=>{let e=document.createElement("div");e.id=U,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    background: ${b.graphite};
    border-bottom: 1px solid ${b.steel};
    flex-shrink: 0;
  `,e.appendChild(Xe(o));let t=document.createElement("button");return t.type="button",t.style.cssText=D,t.textContent="Offer Made",t.addEventListener("click",()=>Je(o)),e.appendChild(t),e},et=async()=>{let o=F();if(!o){document.getElementById(U)?.remove();return}let e=document.getElementById(U);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await Ye();if(!t){h.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=F();if(!r||r.contactId!==o.contactId)return;let a=he(o.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),h.debug(`Mounted contact actions bar for ${o.contactId}`);let s=null;s=new MutationObserver(()=>{let i=document.getElementById(U);if(!(F()?.contactId===o.contactId)){s?.disconnect();return}if(!i){let l=he(o.contactId);l.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(l,t.firstChild),h.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),s.observe(t,{childList:!0})},pe=()=>{et()};var $="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",tt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),N="data-ws-crm-favicon",Q=o=>o.hasAttribute(N),me=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return tt.has(e)},q=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{me(r)&&!Q(r)&&r.remove()});let e=document.head.querySelector(`link[${N}="1"]`);e?e.href!==$&&(e.href=$):(e=document.createElement("link"),e.setAttribute(N,"1"),e.rel="icon",e.type="image/png",e.href=$,document.head.appendChild(e),h.debug("Favicon installed"));let t=document.head.querySelector(`link[${N}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(N,"apple"),t.rel="apple-touch-icon",t.href=$,document.head.appendChild(t))},_e=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)q();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),q())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&me(i)&&!Q(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Q(i)&&(a=!0)});a&&q()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,q(),e>=5&&window.clearInterval(t)},1e3)};var Y="reos-theme-stylesheet",Ce="reos-theme-fonts",ot=()=>{let o=document.getElementById(Ce);o&&o.remove()},rt=`
/* ============================================
...
`,nt=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar span, .default-avatar svg, .default-avatar svg path, .default-avatar i, .n-avatar.default-avatar, .n-avatar.default-avatar svg, .n-avatar.default-avatar svg path",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],at=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(a))return o;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${a}, ${s})`}return`rgb(${t}, ${r}, ${a})`},st=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),it=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']"],M=()=>{document.querySelectorAll(it.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let n=+i[1],l=+i[2],c=+i[3];n<230||l<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"))})})},ve=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},P=()=>{for(let o of nt){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,a]of Object.entries(o.styles)){let s=t.style.getPropertyPriority(r),i=t.style.getPropertyValue(r),n=st.has(r)?at(a):a;s==="important"&&i===n||t.style.setProperty(r,a,"important")}})}},te="#1A1F28",lt=26,dt=31,ct=40,ue=new Set,ye=new Set,z=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!ye.has(a)&&a!=="<no class>"&&(ye.add(a),h.debug(`Hid empty "--" leaf: "${a}"`))})},bt=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],ht=["trash","Trash","TRASH","delete","Delete","DELETE"],pt=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,a=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(ht.some(s=>a.includes(s))&&(r=!0),r||t.querySelectorAll("path").forEach(i=>{if(r)return;let n=i.getAttribute("d")||"";bt.some(l=>n.includes(l))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),n=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||n.includes("delete")||n.includes("remove")||n.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},mt=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),_t=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||mt.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},ge=new Set,vt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let s=Array.from(e.children);if(s.length>0&&s.every(m=>{let d=m.tagName.toLowerCase();return d==="svg"||d==="img"})&&!a)return;let l=window.getComputedStyle(e).color;if(!(l==="rgb(255, 255, 255)"||l==="rgba(255, 255, 255, 1)"||l==="#ffffff"||l==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let p=e.className?.toString()||"<no class>";!ge.has(p)&&p!=="<no class>"&&(ge.add(p),h.debug(`Remapped pure-white text -> bone: "${p}"`))})},fe=new Set,ut=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let n=window.getComputedStyle(s),l=n.backgroundColor,c=n.backgroundImage||"",p=!1;if(c!=="none"&&c.includes("gradient"))p=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let w=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(w&&parseFloat(w[1])<.6)return;let g=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let S=parseInt(g[1],10),A=parseInt(g[2],10),X=parseInt(g[3],10);(S>=60||A>=60||X>=60)&&(S>230&&A>230&&X>230||(S>=80||A>=80||X>=80)&&(p=!0))}}if(!p)return;let d=(s.textContent||"").trim(),y=i,u=Array.from(s.querySelectorAll("*")).map(w=>(w.className?.toString()||"").toLowerCase()).join(" "),v=d.toLowerCase()==="ask ai"||y.includes("ai-button")||y.includes("ask-ai")||y.includes("askai"),x=y.includes("bg-clip-text")||y.includes("text-transparent")||u.includes("bg-clip-text")||u.includes("text-transparent"),E=Array.from(s.querySelectorAll("*")).some(w=>{let g=window.getComputedStyle(w),S=g.getPropertyValue("-webkit-background-clip")||"",A=g.getPropertyValue("background-clip")||"";return S.includes("text")||A.includes("text")});if(v||x||E){let w=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=S=>{w.forEach(A=>S.style.removeProperty(A))};g(s),s.querySelectorAll("*").forEach(g);return}let _="#12161D";s.style.setProperty("color",_,"important"),s.querySelectorAll("*").forEach(w=>{let g=w.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(w.style.setProperty("fill",_,"important"),w.style.setProperty("stroke",_,"important"),w.style.setProperty("color",_,"important")):(w.style.setProperty("color",_,"important"),w.style.setProperty("-webkit-text-fill-color",_,"important"))});let T=s.className?.toString()||"<no class>";!fe.has(T)&&T!=="<no class>"&&(fe.add(T),h.debug(`Darkened SVG icons on colored button: "${T}"`))})})},we=new Set,yt=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0||t.width<20||t.width>64||t.height<20||t.height>64)return;let r=t.top+t.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(n=>{let l=n;if(l.closest("[id^='ws-crm-']"))return;let c=n.getBoundingClientRect();if(c.width===0||c.width>28||c.height>28)return;let p=c.left<t.right&&c.right>t.left,m=c.top<t.bottom&&c.bottom>t.top;if(!(p&&m)||c.top+c.height/2<r)return;let y=c.width*c.height/(t.width*t.height);if(y>.55)return;let u=l,v=l.parentElement,x=0;for(;v&&v!==e&&x<3;){let _=v.getBoundingClientRect();if(_.width>0&&_.width<=30&&_.height<=30)u=v;else break;v=v.parentElement,x++}u.style.setProperty("transform","translateY(11px)","important");let E=(u.className?.toString()||"")+" "+u.tagName;we.has(E)||(we.add(E),h.debug(`Dropped activity badge 11px (${c.width.toFixed(0)}x${c.height.toFixed(0)} icon, ratio ${y.toFixed(2)}): "${E}"`))})})},gt="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",ft=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",gt,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},xe=new Set,wt=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let n=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(n>200&&l>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!xe.has(p)&&p!=="<no class>"&&(xe.add(p),h.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${n},${l},${c})): "${p}"`))})})},ke=new Set,xt=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let a=(t.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=t.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let n=t.className?.toString()||"<no class>";!ke.has(n)&&n!=="<no class>"&&(ke.add(n),h.debug(`Painted Ask AI wrapper graphite: "${n}"`))}}t=t.parentElement,r++}})},Ee=new Set,kt=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let n=a.getBoundingClientRect();n.width<240||n.height<120||n.width>1500||n.height>900||t.push(a)}),[...o,...t].forEach(a=>{a.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let n=(i.className?.toString()||"").toLowerCase();if(n.includes("avatar")||n.includes("notification-dot")||n.includes("indicator"))return;if(n.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let x=i.getAttribute("style")||"";(x.includes("background-color")||x.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(n.includes("tabulator")||n.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(n.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let x=i.getAttribute("style")||"";(x.includes("background-color")||x.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(n.includes("ai-button")||n.includes("ask-ai")||n.includes("bg-clip-text")||n.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let c=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let p=parseInt(c[1],10),m=parseInt(c[2],10),d=parseInt(c[3],10);if(!(p>200&&m>200&&d>200))return;let u=i.getBoundingClientRect();if(u.width<24||u.height<16||u.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let v=i.className?.toString()||"<no class>";!Ee.has(v)&&v!=="<no class>"&&(Ee.add(v),h.debug(`Coerced light bg (${u.width.toFixed(0)}x${u.height.toFixed(0)}, rgb(${p},${m},${d})): "${v}"`))})})},Te=new Set,Et=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let _=t.getAttribute("style")||"";(_.includes("color")||_.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let a=t,s=null;for(let _=0;_<4&&a;_++){let T=a.nextElementSibling;if(T&&(T.matches(o)||T.querySelector(o)!==null)){s=T;break}a=a.parentElement}if(!s)return;let i=t.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let n=s,l=n.getBoundingClientRect(),c=n.className?.toString()||"",p=c.includes("schedule-ui-form-weekly-schedule-checkbox")||n.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||n.closest(".hl-form-item")!==null,d=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",y=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||n.matches(d))&&(n.matches(d)||n.querySelector(d)!==null);y&&(n.getAttribute("style")||"").includes("background-color")&&(n.style.removeProperty("background-color"),n.style.removeProperty("border-color"),n.style.removeProperty("border-style"),n.style.removeProperty("border-width"),n.style.removeProperty("border-radius"));let u=c.includes("hr-radio")||n.closest(".hr-radio, [class*='hr-radio']")!==null;u&&(n.getAttribute("style")||"").includes("background-color")&&(n.style.removeProperty("background-color"),n.style.removeProperty("border-color"),n.style.removeProperty("border-style"),n.style.removeProperty("border-width"),n.style.removeProperty("border-radius"));let v=c.includes("hr-breadcrumb")||n.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;v&&(n.getAttribute("style")||"").includes("background-color")&&(n.style.removeProperty("background-color"),n.style.removeProperty("border-color"),n.style.removeProperty("border-style"),n.style.removeProperty("border-width"),n.style.removeProperty("border-radius"));let x=c.includes("hr-header-lite")||n.closest("[class*='hr-header-lite']")!==null;x&&(n.getAttribute("style")||"").includes("background-color")&&(n.style.removeProperty("background-color"),n.style.removeProperty("border-color"),n.style.removeProperty("border-style"),n.style.removeProperty("border-width"),n.style.removeProperty("border-radius")),!p&&!m&&!y&&!u&&!v&&!x&&l.width>0&&l.width<=800&&l.height>0&&l.height<=100&&(n.style.setProperty("background-color",te,"important"),n.style.setProperty("border-color","#252C36","important"),n.style.setProperty("border-style","solid","important"),n.style.setProperty("border-width","1px","important"),n.style.setProperty("border-radius","4px","important"));let E=t.className?.toString()||"<no class>";!Te.has(E)&&E!=="<no class>"&&(Te.add(E),h.debug(`Colored field label "${r.slice(0,30)}": "${E}"`))})},Se=new Set,Tt=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),n=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${n}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${n}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!Se.has(l)&&l!=="<no class>"&&(Se.add(l),h.debug(`Resized avatar text to ${n}px (circle ${i.toFixed(0)}px): "${l}"`))})},Fe=new Set,St=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;e.style.setProperty("background-color",te,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=e.className?.toString()||"<no class>";!Fe.has(r)&&r!=="<no class>"&&(Fe.add(r),h.debug(`Forced input slate bg: "${r}"`))})},W=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(d=>t.includes(d))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("border-color")||d.includes("border-style")||d.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let d=e.getAttribute("style")||"";(d.includes("background-color")||d.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let s=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let i=parseInt(s[1],10),n=parseInt(s[2],10),l=parseInt(s[3],10);if(!(i<lt&&n<dt&&l<ct))return;let p=e.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;e.style.setProperty("background-color",te,"important");let m=e.className?.toString()||"<no class>";!ue.has(m)&&m!=="<no class>"&&(ue.add(m),h.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${i},${n},${l})): "${m}"`))})},j=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored]), .toolbar_button img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2]), #editor-toolbar img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1");let n=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!n)return;let l;try{l=atob(n[1])}catch{return}let c=l,p=!1;if(e.forEach(d=>{c.includes(d)&&(c=c.split(d).join(o),p=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(y=>{c.includes(y)&&(c=c.split(y).join("#EDEEF0"),p=!0)}),!!p)try{let d=btoa(c);s.setAttribute("src",`data:image/svg+xml;base64,${d}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let n=`url("${i}")`;s.style.setProperty("-webkit-mask-image",n,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",n,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",t)})},K=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Ae=()=>{let o,e=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,K(),P(),St(),W(),z(),Et(),kt(),xt(),wt(),ft(),ut(),Tt(),yt(),vt(),j(),_t(),pt(),M(),ve()},100))};K(),P(),W(),z(),j(),M(),ve(),window.setTimeout(()=>{K(),P(),W(),z(),j(),M()},500),window.setTimeout(()=>{K(),P(),W(),z(),j(),M()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{M(),P()}),new MutationObserver(()=>{e()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},ee,Ft=()=>{let o=()=>{let t=document.getElementById(Y);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let a of t){for(let s of Array.from(a.addedNodes)){if(!(s instanceof Element))continue;let i=s.tagName.toLowerCase();if(i==="style"||i==="link"){if(s.id===Y||s.id===Ce)continue;r=!0;break}}if(r)break}r&&ee===void 0&&(ee=window.setTimeout(()=>{ee=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Le=()=>{if(ot(),!document.getElementById(Y)){let o=document.createElement("style");o.id=Y,o.textContent=rt,document.head.appendChild(o),h.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Ae():window.addEventListener("DOMContentLoaded",Ae)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,Ft())};var De="ws-crm-customizer-version-badge",Ie=()=>{if(document.getElementById(De))return;let o=document.createElement("div");o.id=De,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${G}`,o.title=`Built ${V}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var He=()=>{h.info(`Loaded v${G} (built ${V})`),_e(),Le(),ne(),re(o=>{h.debug("Page handler firing for:",o),Ie(),le(),pe()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",He):He();})();
