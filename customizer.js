...
/* HR-alert family \u2014 GHL's Highrise alert component for inline
   ...
   from .hr-alert / .hr-alert-body. Theme to graphite + steel +
   amber accent for warning variant. */
...
html body .hr-alert .hr-alert-body__content:not(#__reos_never_id),
html body .hr-alert-body .hr-alert-body__content:not(#__reos_never_id) {
  background-color: transparent !important;
  background: transparent !important;
  color: var(--reos-amber) !important;
}
html body .hr-alert .body:not(#__reos_never_id),
html body .hr-alert-body .body:not(#__reos_never_id) {
  color: var(--reos-amber) !important;
  -webkit-text-fill-color: var(--reos-amber) !important;
}
