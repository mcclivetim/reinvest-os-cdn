/* Wholesaling CRM Customizer v0.36.8 — built 2026-06-13T21:36:58.015Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Ds="__WS_CRM_DEBUG",Hs=()=>!!window[Ds],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Hs()&&console.log(qt,"[debug]",...t)}};var Ps=/\/v2\/location\/([A-Za-z0-9]+)/,Bs=new Set(["8ntUQzMflUkR0YvrRgVk"]),Fe=()=>{let t=window.location.pathname.match(Ps);return t?t[1]:null},tr=()=>{let t=Fe();return t!==null&&Bs.has(t)};var Yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,or=/\/v2\/location\/([A-Za-z0-9]+)/,Rs=t=>{let e=t.match(Yn);if(!e)return null;let o=t.match(or);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Fs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Yn);if(!a)continue;let i=r.match(or)||window.location.pathname.match(or);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},R=()=>{let t=Rs(window.location.pathname);return t||Fs()};var Jn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",rr=null,Ne="other",nr=new Set,Ut=()=>{let t=R()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==rr))){Vt=window.location.pathname,rr=t,Ne=Jn(),c.debug("Page/context changed:",Ne,Vt,"contact:",t);for(let r of nr)try{r(Ne)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(nr.add(t),setTimeout(()=>t(Ne),0),()=>{nr.delete(t)}),Xn=()=>{Ne=Jn(),Vt=window.location.pathname,rr=R()?.contactId??null,c.debug("Router init, current page:",Ne);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.8",Kt="2026-06-13T21:36:58.016Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=a.querySelector(t);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ar={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Qn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Ns=/^[A-Za-z0-9]{15,30}$/,at=t=>typeof t=="string"&&Ns.test(t),Zn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zs=()=>{let t=window.WS_CRM_USER_ID;return at(t)?t:null},Gs=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(at(o))return o;return null},qs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);if(!o)return null;let r=o.uid;if(at(r))return r;let a=o.claims;if(a&&at(a.user_id))return a.user_id}catch{}return null},Us=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(at(a))return a}catch{}}}catch{}return null},O=()=>zs()||Gs()||qs()||Us()||null,Vs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Vs()?.type==="agency"};var ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Ws=`${ra}/active-follow-up-get`,js=`${ra}/active-follow-up-set`,Ie="ws-crm-active-follow-up-button",sr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ks=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ys=async t=>{let e=await fetch(Ws,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Js=async(t,e)=>{let o=await fetch(js,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Le=(t,e)=>{let o=sr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ea=t=>{let e=document.createElement("button");return e.type="button",e.id=Ie,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,Le(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ks();if(!(!r||r.contactId!==t)){Le(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Js(r,O()),i=a&&a.state&&a.state in sr?a.state:"blue";Le(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Le(e,"error"),setTimeout(()=>void Jt(e,r),4e3)}}}),e},Jt=async(t,e)=>{Le(t,"loading");try{let o=await Ys(e),r=o&&o.state&&o.state in sr?o.state:"gray",a=document.getElementById(Ie);if(!a||a.dataset.contactId!==e.contactId)return;Le(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Le(t,"error")}},Xs=[".central-panel","[class*='central-panel']"],ir="ws-crm-contact-actions-bar",Qs=async()=>{for(let t of Xs)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Zs=async(t,e)=>{let o=e.querySelector(`#${ir}`);if(!o)try{o=await L(`#${ir}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${ir}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},el=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},tl=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},ol=async t=>{if(t==="url"){let o=await Qs();return o?{kind:"contact-detail",target:o}:null}let e=el();return e?{kind:"conversations",target:e}:null},ta=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Zs(t,e.target);return o}return tl(t,e.target),"conversations-header"},rl=async()=>{let t=R();if(!t||!t.locationId){document.getElementById(Ie)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Ie);if(o&&o.dataset.contactId===e.contactId){Jt(o,e);return}o&&o.remove();let r=await ol(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=R();if(!a||a.contactId!==e.contactId)return;let i=ea(e.contactId),s=await ta(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),oa();let l=document.getElementById(Ie)??i;Jt(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(Ie);if(!(R()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=ea(e.contactId);ta(m,r).then(()=>{oa(),Jt(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},it=null,na=()=>{let t=R()?.contactId??null;if(it&&it.contactId===t)return;let e=rl().finally(()=>{it?.promise===e&&(it=null)});it={contactId:t,promise:e}},oa=()=>{let t=document.querySelectorAll(`#${Ie}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var nl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",st=new Map,ze=async(t,e)=>{if(!t)return null;if(st.has(t))return st.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${nl}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),st.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return st.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),st.set(t,null),null}};var Ge=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var sa="ws-buybox-nav-icon",cr="ws-buybox-panel",aa="ws-buybox-modal",al="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",pr="https://mcclivetim.github.io/reinvest-os-cdn/geo",Xt=null,lt=null,dt=null,dr=async()=>{if(Xt)return Xt;try{let t=await fetch(`${pr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Xt=await t.json(),Xt}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},il=async t=>{if(!lt)try{let e=await fetch(`${pr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);lt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return lt?.[t]??[]},sl=async t=>{if(!dt)try{let e=await fetch(`${pr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);dt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return dt?.[t]??[]},br=async t=>await(await fetch(al,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ll=(t,e)=>br({tenant_id:t,action:"list",buyer_contact_id:e}),dl=(t,e,o,r)=>br({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),cl=(t,e)=>br({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),pl=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},bl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',hl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',ml="nav.w-13, nav[class*='w-13']",ul=".flex-1.h-full.relative.overflow-hidden.rounded-lg",vl=async()=>{try{return await L(ml,{timeoutMs:2500})}catch{return null}},_l=async()=>{try{return await L(ul,{timeoutMs:2500})}catch{return null}},yl=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,gl=(t,e)=>{let o=document.createElement("div");return o.id=cr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{kl(t,e,()=>hr(t,e))}),o},hr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ll(t,e),dr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}fl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},fl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let b=e[d.key].map(p=>{let m=d.key==="state"?pl(p.geo_value,o):p.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let b=d.dataset.entryId||"",p=d.dataset.entryLabel||"this area";confirm(`Remove "${p}" from this buyer's buy-box?`)&&(d.disabled=!0,cl(r,b).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}hr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Qt=!1,la=(t,e)=>{Qt=e;let o=yl(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=wl,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",hr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=da,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},da="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",wl="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",xl=t=>{let e=document.createElement("button");return e.id=sa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=da,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${bl.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Qt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),la(r,a)}),e},kl=(t,e,o)=>{let r=document.getElementById(aa);r&&r.remove();let a=document.createElement("div");a.id=aa,a.style.cssText=`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(I)},E=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await dl(t,e,s.granularity,g);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},lr=!1,qe=null,ct=null,ia=()=>{document.getElementById(sa)?.remove(),document.getElementById(cr)?.remove(),ct&&qe&&qe.nav.removeEventListener("click",ct,!0),ct=null,qe=null,Qt=!1},ca=()=>{El()},El=async()=>{if(!lr){lr=!0;try{let t=R();if(!t){ia();return}let e=document.getElementById(cr);if(e&&e.dataset.buyerContactId===t.contactId&&qe)return;ia();let o=null;try{o=await ze(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(Ge(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([vl(),_l()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=R();if(!s||s.contactId!==t.contactId)return;let l=gl(t.locationId,t.contactId),d=xl(()=>qe),b={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};qe=b;let p=a.querySelector(".flex.flex-col.items-center.gap-2");p?p.appendChild(d):a.appendChild(d),i.appendChild(l),ct=m=>{let h=m.target;if(!h||b.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Qt&&la(b,!1)},a.addEventListener("click",ct,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{lr=!1}}};var fe="ws-crm-claim-release-pill",Tl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Sl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Cl=async t=>{let e=await fetch(Tl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Al=async t=>{let e=await fetch(Sl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ha=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ue=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Qn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},ya=(t,e)=>{let o=document.createElement("div");if(o.id=Ve,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=$,r.style.order="3",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>ql(t,e)),o.appendChild(r),o.appendChild(Nl({contactId:t,kind:e}))}return o},mr=!1,ga=()=>{document.querySelectorAll(`[id="${Ve}"]`).forEach(t=>t.remove())},ka=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),mr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}mr=!0;try{await Wl()}finally{mr=!1}},Wl=async()=>{let t=R();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),ga();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),ga();return}let e="seller";try{let b=await ze(t.contactId,t.locationId),p=Ge(b);p==="buyer"?e="buyer":p==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=R();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Ve}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let a=await Fl();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=R();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ya(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(Ve)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(R()?.contactId===t.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${Ve}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,h=ya(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},fa=null,jl=()=>{fa===null&&(fa=window.setInterval(()=>{let t=R();t&&(document.getElementById(Ve)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ka()))},3e3))},Ea=()=>{jl(),ka()};var Zt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Kl=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),pt="data-ws-crm-favicon",ur=t=>t.hasAttribute(pt),Ta=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Kl.has(e)},eo=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ta(r)&&!ur(r)&&r.remove()});let e=document.head.querySelector(`link[${pt}="1"]`);e?e.href!==Zt&&(e.href=Zt):(e=document.createElement("link"),e.setAttribute(pt,"1"),e.rel="icon",e.type="image/png",e.href=Zt,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${pt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(pt,"apple"),o.rel="apple-touch-icon",o.href=Zt,document.head.appendChild(o))},Sa=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)eo();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),eo())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ta(s)&&!ur(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ur(s)&&(a=!0)});a&&eo()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,eo(),e>=5&&window.clearInterval(o)},1e3)};var Yl=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Jl=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Xl=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Xl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Jl);if(a){let i=a[1];if(Yl.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ca="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(Ca);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ca,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Ql="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ae="ws-crm-mt-offer-made-button",Aa="ws-crm-mt-offer-made-modal",Zl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ed=/\/v2\/location\/([A-Za-z0-9]+)/,ro=()=>{let t=window.location.pathname,e=t.match(Zl);if(!e)return null;let o=t.match(ed);return{oppId:e[1],locationId:o?o[1]:null}},td=async t=>{let e=await fetch(Ql,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},to=()=>{document.getElementById(Aa)?.remove()},od=t=>{to();let e=document.createElement("div");e.id=Aa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ro();!o||!o.locationId||o.oppId!==t||od({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},nd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ad=async()=>{for(let t of nd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},oo=!1,gr=async()=>{if(!oo){oo=!0;try{await id()}finally{oo=!1}}},id=async()=>{let t=ro();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await ad();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ro();if(!a||a.oppId!==t.oppId)return;let i=rd(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),sd(t.oppId)},bt=null,yr=null,ht=()=>{bt?.disconnect(),bt=null,yr=null},sd=t=>{if(bt&&yr===t)return;ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yr=t,bt=new MutationObserver(()=>{let o=ro();if(!o||o.oppId!==t){ht();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}document.getElementById(ae)||gr()}),bt.observe(e,{childList:!0,subtree:!0}))},vr=null,_r,ld=()=>{vr||(vr=new MutationObserver(()=>{_r===void 0&&(_r=window.setTimeout(()=>{_r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!oo&&gr()},300))}),vr.observe(document.body,{childList:!0,subtree:!0}))},Ia=()=>{ld(),gr()};var dd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ie="ws-crm-not-interested-button",cd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pd=/\/v2\/location\/([A-Za-z0-9]+)/,ao=()=>{let t=window.location.pathname,e=t.match(cd);if(!e)return null;let o=t.match(pd);return{oppId:e[1],locationId:o?o[1]:null}},bd=async t=>{let e=await fetch(dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},hd=t=>{let e=document.createElement("button");return e.id=ie,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=ao();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await bd({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},md=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ud=async()=>{for(let t of md)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,kr=async()=>{if(!no){no=!0;try{await vd()}finally{no=!1}}},vd=async()=>{let t=ao();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ut();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ut());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await ud();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ao();if(!a||a.oppId!==t.oppId)return;let i=hd(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),_d(t.oppId)},mt=null,xr=null,ut=()=>{mt?.disconnect(),mt=null,xr=null},_d=t=>{if(mt&&xr===t)return;ut();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xr=t,mt=new MutationObserver(()=>{let o=ao();if(!o||o.oppId!==t){ut();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ut();return}document.getElementById(ie)||kr()}),mt.observe(e,{childList:!0,subtree:!0}))},fr=null,wr,yd=()=>{fr||(fr=new MutationObserver(()=>{wr===void 0&&(wr=window.setTimeout(()=>{wr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!no&&kr()},300))}),fr.observe(document.body,{childList:!0,subtree:!0}))},La=()=>{yd(),kr()};var gd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",re="ws-crm-schedule-walkthrough-button",Er="ws-crm-schedule-walkthrough-modal",fd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,wd=/\/v2\/location\/([A-Za-z0-9]+)/,lo=()=>{let t=window.location.pathname,e=t.match(fd);if(!e)return null;let o=t.match(wd);return{oppId:e[1],locationId:o?o[1]:null}},io=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},xd=(t,e)=>{document.getElementById(Er)?.remove();let o=document.createElement("div");o.id=Er,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=lo();!o||!o.locationId||o.oppId!==t||xd(o.oppId,o.locationId)}),e},Ed=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Td=async()=>{for(let t of Ed)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,Ar=async()=>{if(!so){so=!0;try{await Sd()}finally{so=!1}}},Sd=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),_t();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),_t());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await Td();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=kd(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Cd(t.oppId)},vt=null,Cr=null,_t=()=>{vt?.disconnect(),vt=null,Cr=null},Cd=t=>{if(vt&&Cr===t)return;_t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Cr=t,vt=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){_t();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),_t();return}document.getElementById(re)||Ar()}),vt.observe(e,{childList:!0,subtree:!0}))},Tr=null,Sr,Ad=()=>{Tr||(Tr=new MutationObserver(()=>{Sr===void 0&&(Sr=window.setTimeout(()=>{Sr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!so&&Ar()},300))}),Tr.observe(document.body,{childList:!0,subtree:!0}))},$a=()=>{Ad(),Ar()};var Id="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",We="ws-crm-resend-deal-link-wrap",Ld=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$d=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(Ld);if(!e)return null;let o=t.match($d);return{oppId:e[1],locationId:o?o[1]:null}},Md=async t=>{let e=await fetch(Id,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Od=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Ma=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Mr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Ma(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Dd(t,e)),t.appendChild(o)},Dd=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let b=document.createElement("button");return b.type="button",b.textContent=l,b.style.cssText=a,b.addEventListener("click",()=>void Hd(t,e,d,o)),b};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Mr(t,e)),o.appendChild(s),t.appendChild(o)},Hd=async(t,e,o,r)=>{let a=po();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Md({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${Ma(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Od(s)}</span>`}window.setTimeout(()=>Mr(t,e),3500)}},Pd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Bd=async()=>{for(let t of Pd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Or=async()=>{if(!co){co=!0;try{await Rd()}finally{co=!1}}},Rd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(We)?.remove(),gt();return}let e=document.getElementById(We);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),gt());return}e&&e.remove();let o=await Bd();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=We,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Mr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Fd(t.oppId)},yt=null,$r=null,gt=()=>{yt?.disconnect(),yt=null,$r=null},Fd=t=>{if(yt&&$r===t)return;gt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,yt=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){gt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(We)?.remove(),gt();return}document.getElementById(We)||Or()}),yt.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Nd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(We)&&!co&&Or()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{Nd(),Or()};var zd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",se="ws-crm-reduce-price-button",Da="ws-crm-reduce-price-modal",Gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,qd=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(Gd);if(!e)return null;let o=t.match(qd);return{oppId:e[1],locationId:o?o[1]:null}},Ud=async t=>{let e=await fetch(zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},bo=()=>{document.getElementById(Da)?.remove()},Vd=t=>{bo();let e=document.createElement("div");e.id=Da,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=mo();!r||!r.locationId||r.oppId!==t||Vd({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},jd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Kd=async()=>{for(let t of jd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ho=!1,Br=async()=>{if(!ho){ho=!0;try{await Yd()}finally{ho=!1}}},Yd=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await Kd();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=Wd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Jd(t.oppId)},ft=null,Pr=null,wt=()=>{ft?.disconnect(),ft=null,Pr=null},Jd=t=>{if(ft&&Pr===t)return;wt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pr=t,ft=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){wt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}document.getElementById(se)||Br()}),ft.observe(e,{childList:!0,subtree:!0}))},Dr=null,Hr,Xd=()=>{Dr||(Dr=new MutationObserver(()=>{Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!ho&&Br()},300))}),Dr.observe(document.body,{childList:!0,subtree:!0}))},Ha=()=>{Xd(),Br()};var je="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",uo="deals.reinvestos.com";var le="ws-crm-edit-landing-button",Qd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zd=/\/v2\/location\/([A-Za-z0-9]+)/,_o=()=>{let t=window.location.pathname,e=t.match(Qd);if(!e)return null;let o=t.match(Zd);return{oppId:e[1],locationId:o?o[1]:null}},ec=(t,e)=>{let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",je);let r=O();return r&&o.searchParams.set("user",r),o.toString()},tc=(t,e)=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=_o();if(!r||!r.locationId||r.oppId!==t)return;if(!je){c.warn("[edit-landing] editor session key not configured in this build");return}let a=ec(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},oc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rc=async()=>{for(let t of oc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vo=!1,zr=async()=>{if(!vo){vo=!0;try{await nc()}finally{vo=!1}}},nc=async()=>{let t=_o();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),kt();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),kt());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await rc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=_o();if(!a||a.oppId!==t.oppId)return;let i=tc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),ac(t.oppId)},xt=null,Nr=null,kt=()=>{xt?.disconnect(),xt=null,Nr=null},ac=t=>{if(xt&&Nr===t)return;kt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Nr=t,xt=new MutationObserver(()=>{let o=_o();if(!o||o.oppId!==t){kt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),kt();return}document.getElementById(le)||zr()}),xt.observe(e,{childList:!0,subtree:!0}))},Rr=null,Fr,ic=()=>{Rr||(Rr=new MutationObserver(()=>{Fr===void 0&&(Fr=window.setTimeout(()=>{Fr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!vo&&zr()},300))}),Rr.observe(document.body,{childList:!0,subtree:!0}))},Pa=()=>{ic(),zr()};var Ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ke="ws-crm-publish-button",Et="ws-crm-publish-wrap",go="ws-crm-publish-dropdown",sc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,lc=/\/v2\/location\/([A-Za-z0-9]+)/,Ur=()=>{let t=window.location.pathname,e=t.match(sc);if(!e)return null;let o=t.match(lc);return{oppId:e[1],locationId:o?o[1]:null}},dc=async(t,e)=>{try{let o=await fetch(Ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},cc=async(t,e)=>{let o=await fetch(Ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},pc=(t,e)=>{if(!je){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",je);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ue=()=>{document.getElementById(go)?.remove()},Ba=(t,e,o,r,a)=>{ue();let i=document.createElement("div");i.id=go;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};$e(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await dc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},$e(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},$e(o,r),document.getElementById(go)&&r.checks&&Ba(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},$e(o,r),ue();try{let m=await cc(t,e);if(m.ok&&m.published)r={status:"published"},$e(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},$e(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},$e(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(go)?ue():r.checks&&Ba(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),b=8e3,p=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(p){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,b-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(p,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},hc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],mc=async()=>{for(let t of hc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yo=!1,Wr=async()=>{if(!yo){yo=!0;try{await uc()}finally{yo=!1}}},uc=async()=>{let t=Ur();if(!t||!t.locationId){document.getElementById(Ke)?.remove(),document.getElementById(Et)?.remove(),ue(),St();return}let e=document.getElementById(Ke);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(Et)?.remove(),ue(),St());return}e&&(e.remove(),document.getElementById(Et)?.remove(),ue());let o=await mc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Ur();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=bc(t.oppId,a.locationId),s=document.createElement("span");s.id=Et,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),vc(t.oppId)},Tt=null,Vr=null,St=()=>{Tt?.disconnect(),Tt=null,Vr=null},vc=t=>{if(Tt&&Vr===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Vr=t,Tt=new MutationObserver(()=>{let o=Ur();if(!o||o.oppId!==t){St();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(Ke)?.remove(),document.getElementById(Et)?.remove(),ue(),St();return}document.getElementById(Ke)||Wr()}),Tt.observe(e,{childList:!0,subtree:!0}))},Gr=null,qr,_c=()=>{Gr||(Gr=new MutationObserver(()=>{qr===void 0&&(qr=window.setTimeout(()=>{qr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ke)&&!yo&&Wr()},300))}),Gr.observe(document.body,{childList:!0,subtree:!0}))},Fa=()=>{_c(),Wr()};var Na="data:image/png;base64,",za="data:image/png;base64,";var yc=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Ga=t=>`ws-crm-map-links-${t}`,fo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},qa=t=>{let e=fo(t.addr),o=fo(t.city),r=fo(t.state),a=fo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},gc=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,fc=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,wc=(t,e)=>{let{full:o,hasAny:r}=qa(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},xc=t=>{let e=document.createElement("span");e.id=Ga(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),wc(t,s)}),l};return e.appendChild(r(Na,"Open in Google Maps",gc)),e.appendChild(r(za,"Search on Zillow",fc)),e},kc=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ua=()=>{for(let t of yc){if(document.getElementById(Ga(t.key)))continue;let{hasAny:e}=qa(t);if(!e)continue;let o=kc(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(xc(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},jr=null,Kr,Ec=()=>{jr||(jr=new MutationObserver(()=>{Kr===void 0&&(Kr=window.setTimeout(()=>{Kr=void 0;try{Ua()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),jr.observe(document.body,{childList:!0,subtree:!0}))},Va=()=>{Ec(),Ua()};var Wa="ws-crm-hide-launchpad",ja=/\/launchpad\/?$/,Yr=()=>{if(!Yt()){if(!document.getElementById(Wa)){let t=document.createElement("style");t.id=Wa,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ja.test(location.pathname)){let t=location.pathname.replace(ja,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var Tc=[{label:"Buy-Box Entries"},{label:"Memberships"}],Ka=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Jr=()=>{let t=Yt(),e=new Set(Tc.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Ka(e);for(let o of[150,500,1200,2500])setTimeout(()=>Ka(e),o)}};var Sc=[{from:"Payments",to:"Contracts"}],Cc=".nav-title, .topmenu-navtitle",Ya=()=>{document.querySelectorAll(Cc).forEach(t=>{let e=(t.textContent||"").trim(),o=Sc.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Xr=()=>{Ya();for(let t of[150,500,1200,2500])setTimeout(Ya,t)};var Ja="/payments/proposals-estimates",Ac=/\/payments\/invoices\/?$/,Ic=/\/payments\//,Lc='#sb_payments, a[meta="payments"]',Qa=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ja)&&!(t>3&&!Ic.test(e))){if(Ac.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ja));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Qa(t+1),120)}},Xa=!1,$c=()=>{Xa||(Xa=!0,document.addEventListener("click",t=>{t.target?.closest?.(Lc)&&setTimeout(()=>Qa(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},Qr=()=>{$c()};var Za=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ei="ws-crm-hide-topmenu-tabs",Zr=()=>{if(document.getElementById(ei))return;let t=Za.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ei,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${Za.length} top tabs`)};var ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",we="ws-crm-send-to-closing-office-button",Me="ws-crm-send-to-title-co-wrap",ko="ws-crm-stc-dropdown",Mc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Oc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(Mc);if(!e)return null;let o=t.match(Oc);return{oppId:e[1],locationId:o?o[1]:null}},Dc=5*60*1e3,ni=t=>`ws-crm-stc-cache:${t}`,Hc=t=>{try{let e=window.localStorage.getItem(ni(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Dc||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Pc=(t,e)=>{try{window.localStorage.setItem(ni(t),JSON.stringify(e))}catch{}},Bc=async(t,e)=>{try{let o=await fetch(ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Rc=async(t,e,o)=>{let r=await fetch(ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Fc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},ti=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Nc=(t,e)=>{if(e&&Fc(e)){window.setTimeout(()=>ti(t),300);return}ti(t)},de=()=>{document.getElementById(ko)?.remove()},wo=(t,e,o)=>{de();let r=document.createElement("div");r.id=ko;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,pe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Bc(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},pe(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},pe(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},pe(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let y=f.pipeline_name;if(y&&y!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),To.add(t),document.getElementById(we)?.remove(),document.getElementById(Me)?.remove(),de(),At();return}let w=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;w=f.checks.map((E,g)=>a.checks[g]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:f.previously_sent_at??null},Pc(t,{checks:w,previously_sent_at:f.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),pe(o,a),document.getElementById(ko)&&wo(w,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},pe(o,a),de();try{let y=await Rc(t,e,f);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},pe(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o)}catch(y){c.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},pe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(ko)?de():a.checks&&wo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,b=!1,p=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,p=Date.now();try{await s()}finally{b=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||b)return;let w=Date.now()-p,S=Math.max(1500,m-w);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Gc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],qc=async()=>{for(let t of Gc)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},To=new Set,oi=null,Uc=t=>{t&&t!==oi&&(To.clear(),oi=t)},xo=!1,rn=async()=>{if(xo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}xo=!0;try{await Vc()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{xo=!1}},Vc=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Eo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(we)?.remove(),document.getElementById(Me)?.remove(),de();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Uc(t.oppId),To.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(we)?.remove(),document.getElementById(Me)?.remove(),de();return}let e=document.getElementById(we);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Me)?.remove(),de(),At());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Me)?.remove(),de()),c.debug("[stc] mount:04 calling findMountTarget");let o=await qc();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Eo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=zc(t.oppId,a.locationId),s=document.createElement("span");s.id=Me,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Wc(t.oppId)},Ct=null,on=null,At=()=>{Ct?.disconnect(),Ct=null,on=null},Wc=t=>{if(Ct&&on===t)return;At();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(on=t,Ct=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){At();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(we)?.remove(),document.getElementById(Me)?.remove(),de(),At();return}document.getElementById(we)||rn()}),Ct.observe(e,{childList:!0,subtree:!0}))},en=null,tn,jc=()=>{en||(en=new MutationObserver(()=>{tn===void 0&&(tn=window.setTimeout(()=>{tn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(we);if(t&&!e&&!xo){let o=Eo();if(o&&To.has(o.oppId))return;rn()}},300))}),en.observe(document.body,{childList:!0,subtree:!0}))},ai=()=>{jc(),rn()};var sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Kc=`${sn}/tc/welcome-call-prefill`,Yc=`${sn}/tc/welcome-call-save`,Jc=`${sn}/tc/order-lockbox`,It="ws-crm-welcome-call-overlay",Xc=["Regular Contract","Subject To","Seller Finance","Novation"],Qc=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Zc=["Gas","Electric","Propane","Oil"],ep=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],tp=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],xe=["Yes","No"],op=["Yes","No","Unknown"],rp=["Professional Photographer","Seller","Tenant"],np=["Month-to-Month","Annual"],ii=["Current","Behind"],ap=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],be=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Co=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,di="margin-bottom:12px;",ci=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,ip=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,si=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=si(o);return`<select id="${t}" style="${Co}"><option value=""></option>${e.map(a=>`<option ${r!==""&&si(a)===r?"selected":""}>${be(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${be(e)}" placeholder="${be(o)}" style="${Co}">`,sp=(t,e)=>`<textarea id="${t}" rows="3" style="${Co}resize:vertical;">${be(e)}</textarea>`,lp=(t,e)=>`<input id="${t}" type="date" value="${be(e)}" style="${Co}">`,D=(t,e)=>`<div style="${di}"><label style="${ci}">${be(t)}</label>${e}</div>`,nn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${ap.map(r=>`<label style="${ip}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ve=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${be(t)}</div>`,Ye=()=>{document.getElementById(It)?.remove()},Oe=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},dp=t=>{let e=t.tenant||{};return`
    ${ve("Identifiers")}
    ...
    ${ve("Contract")}
    ${D("Type of Contract",j("wc-contract_type",Xc,t.contract_type))}

    ${ve("Property")}
    ${D("Property Type",j("wc-property_type",ep,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",Qc,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",Zc,t.heat_source))}
    ...
    ${ve("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",tp,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",np,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${D("Last rent paid",lp("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",op,t.hoa_rental_restriction))}</div>

    ${ve("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",rp,t.photos_provided_by))}
    <div style="${di}">
  ...
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},an=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),li=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},So=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?be(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},cp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:an("photos_avail_mornings"),photos_avail_afternoons:an("photos_avail_afternoons"),photos_avail_evenings:an("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),pp=t=>{Ye();let e=document.createElement("div");e.id=It,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${dp(t)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){ke("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ee(),ke("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",ke("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",ke("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let b=d.target;!o.contains(b)&&!e.contains(b)&&(Ee(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},kp=(t,e)=>{Ee();let o=document.createElement("div");o.id=mi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ee(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=$,o.textContent=t,o},Ep=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},Tp=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===_i){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>gp(t)),o.appendChild(r),o}if(e===vn){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>xp(t,r)),o.appendChild(r),o}if(e===yi){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void fi(t)),o.appendChild(r),o}return null},Sp=(t,e)=>{let o=[];if(e===vn&&(o=[{label:"Re-order Lockbox",onClick:()=>void fi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=hi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Ep();return a.addEventListener("click",i=>{i.stopPropagation(),kp(o,a)}),r.appendChild(a),r},Cp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ap=async()=>{for(let t of Cp)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ao=()=>{document.getElementById(bn)?.remove(),document.getElementById(hi)?.remove(),Ee()},Lo=!1,_n=async()=>{if(!Lo){Lo=!0;try{let t=gi();if(!t){Ao();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ao();return}let o=yp(),r=document.getElementById(bn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Tp(t,o);if(!a){Ao();return}let i=await Ap();if(!i)return;Ao();let s=U(i),l=document.createElement("span");l.id=bn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Sp(t,o);d&&s.appendChild(d),Ip(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},Lt=null,mn=null,dn,bi=()=>{Lt?.disconnect(),Lt=null,mn=null},Ip=t=>{if(Lt&&mn===t)return;bi();let e=document.querySelector(vi);e&&(mn=t,Lt=new MutationObserver(()=>{let o=gi();if(!o||o.oppId!==t){bi();return}dn===void 0&&(dn=window.setTimeout(()=>{dn=void 0,_n()},250))}),Lt.observe(e,{childList:!0,subtree:!0}))},cn=null,pn,Lp=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&_n()},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},wi=()=>{Lp(),_n()};var xi="ws-support-modal",ki="ws-support-toast",$p="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ei="ws-support-submitter-name",Ti="ws-support-submitter-email",Si="ws-support-submitter-role",Mp=["Bug","Feature Request","Question","Billing","Onboarding Help"],De=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Op=(t,e="success",o)=>{let r=document.getElementById(ki);r&&r.remove();let a=document.createElement("div");a.id=ki;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Dp=()=>{document.getElementById(xi)?.remove();let t=(localStorage.getItem(Ei)??"").trim(),e=(localStorage.getItem(Ti)??"").trim(),o=(localStorage.getItem(Si)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=xi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let b=Fe();if(!b){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ei,r.submitterName),localStorage.setItem(Ti,r.submitterEmail),r.submitterRole&&localStorage.setItem(Si,r.submitterRole)}catch{}let p=i.querySelector("#ws-support-submit");p&&(p.disabled=!0,p.textContent="Submitting\u2026",p.style.opacity="0.7");try{let h=await(await fetch($p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:b,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";Op(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1")}})},Hp=["/support-ticket","ws-support-modal","ws-support"],Pp=/\/custom-menu-link\//,yn=!1,Ci=()=>{if(yn||!Pp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Hp.some(s=>i.includes(s))});if(r){yn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Dp(),yn=!1},50);return}t<10&&setTimeout(e,150)};e()},Ai=!1,Ii=()=>{Ai||(Ai=!0,Wt(()=>setTimeout(Ci,50)),Ci(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Bp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Rp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Fp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Mi="tc_closing_agent",Np="tc_closing_office",ce="ws-crm-closing-agent-picker-button",Oi="ws-crm-closing-agent-picker-modal",zp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gp=/\/v2\/location\/([A-Za-z0-9]+)/,Ot=()=>{let t=window.location.pathname,e=t.match(zp);if(!e)return null;let o=t.match(Gp);return{oppId:e[1],locationId:o?o[1]:null}},Sn=async t=>{let e=await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Li=async t=>{let e=await fetch(Rp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},qp=async(t,e)=>{try{let o=await fetch(Fp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Mi}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Sn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},He=null,Up=60*60*1e3,Cn=t=>`ws-crm-to-cache:${t}`,Di=t=>{try{let e=window.localStorage.getItem(Cn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Up||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Hi=(t,e,o)=>{try{window.localStorage.setItem(Cn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Vp=t=>{try{window.localStorage.removeItem(Cn(t))}catch{}},xn="ws-crm-closing-agent-field-link",Wp=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${xn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},gn=!1,An=async t=>{if(gn)return;let e=Pi();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){gn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Sn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),kn(a.id,a.name,t);let i=document.getElementById(ce);if(i){Te(i,{status:"linked",contactName:a.name});let s=Ot();s&&Hi(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{gn=!1}}},jp=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Pi=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let b=(d.textContent||"").trim();jp.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},kn=(t,e,o)=>{let r=Pi();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${xn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=xn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},$o=()=>{document.getElementById(Oi)?.remove()},Kp=t=>{$o();let e=document.createElement("div");e.id=Oi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Te(o,r);let a=Di(t);return a&&(r={status:"linked",contactName:a.contactName},Te(o,r),He={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await qp(t,e);s?(r={status:"linked",contactName:s.name},Te(o,r),He={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},kn(s.id,s.name,e)):a||(r={status:"empty"},Te(o,r),He?.oppId===t&&(He=null),Wp(),Vp(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Kp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Te(o,r);try{let l=[Li({tenantId:e,oppId:t,fieldKey:Mi,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Li({tenantId:e,oppId:t,fieldKey:Np,value:s.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:s.name},Te(o,r),He={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Hi(t,s.id,s.name),kn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Te(o,r)}}})}),o},Jp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Xp=async()=>{for(let t of Jp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$t=!1,Do=async()=>{if(!$t){$t=!0;try{await Qp()}finally{$t=!1}}},Qp=async()=>{let t=Ot();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Xp();if(!r||!(Di(t.oppId)!==null||He!==null&&He.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Ot();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Yp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Zp(t.oppId),An(i.locationId)},Mt=null,En=null,Tn=null,Oo=()=>{Mt?.disconnect(),Mt=null,En=null,Tn=null},Zp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Mt&&En===t&&Tn===e||(Oo(),En=t,Tn=e,Mt=new MutationObserver(()=>{let o=Ot();if(!o||o.oppId!==t||!o.locationId){Oo();return}document.getElementById(ce)||Do(),An(o.locationId)}),Mt.observe(e,{childList:!0,subtree:!0})))},fn=null,wn,eb=()=>{fn||(fn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!$t&&Do()},300))}),fn.observe(document.body,{childList:!0,subtree:!0}))},$i,tb=()=>{$i===void 0&&($i=window.setInterval(()=>{let t=Ot();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!$t&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Do()),An(t.locationId)},2e3))},Bi=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),eb(),tb(),Do()};var ob="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ce="ws-crm-manage-team-cta",Ri="ws-crm-manage-team-modal",rb=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Fi={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},nb={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ni=()=>{let t=window.location.pathname.match(rb);return t?{tenantId:t[1]}:null},Po=async t=>{let e=await fetch(ob,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Se=t=>ne(t),In="ws-crm-manage-team-toast",Mn=(t,e="info",o=4e3)=>{document.getElementById(In)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=In,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(In)===a&&a.remove()},o)},Ln=()=>{document.getElementById(Ri)?.remove()},ab=(t,e)=>{let o=nb[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ne(e)}</span>
  `},ib=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>ab(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>ib(r,e)).join(""),Bo=async t=>{Ln();let e=document.createElement("div");e.id=Ri,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ln);let r;try{r=await Po({tenant_id:t,action:"list"})}catch(d){let b=o.querySelector("#ws-team-content");b&&(b.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+sb(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{lb(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",b=>{let p=b.currentTarget;db(t,{email:p.dataset.email||"",name:p.dataset.name||"",currentRoles:(p.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",b=>{let p=b.currentTarget;cb(t,{email:p.dataset.email||"",name:p.dataset.name||"",roleCount:parseInt(p.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},lb=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Ho(e),setTimeout(()=>Ho(e),200),setTimeout(()=>Ho(e),800),window.addEventListener("resize",()=>Ho(e)),e},$n=!1,gb=()=>{if(!$n){$n=!0;try{let t=Ni();if(!t){document.getElementById(Ce)?.remove(),document.getElementById(`${Ce}-floater`)?.remove();return}let e=document.getElementById(Ce);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ce}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ce}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=yb(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{$n=!1}}},zi=()=>{if(!Ni()){document.getElementById(Ce)?.remove(),document.getElementById(`${Ce}-floater`)?.remove();return}gb()};var fb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Hn="ws-crm-prepare-contract-button",Gi="ws-crm-prepare-contract-menu",me="ws-crm-prepare-contract-modal",qi="ws-crm-modal-date-style",_e="https://services.leadconnectorhq.com",Yi=()=>{if(document.getElementById(qi))return;let t=document.createElement("style");t.id=qi,t.textContent=`
  ...
  `,document.head.appendChild(t)},Pn="__WS_CRM_CAPTURED_AUTH",wb=50*60*1e3,zo=()=>{try{let t=localStorage.getItem(Pn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>wb?(localStorage.removeItem(Pn),null):e:null}catch{return null}},xb=t=>{try{localStorage.setItem(Pn,JSON.stringify(t))}catch{}},Xe=()=>{let t=zo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Ui=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((zo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Je=async(t,e={},o=2)=>{let r=zo()?.capturedAt??0,a;try{a={...Xe(),...e.headers??{}}}catch(s){if(o>0&&await Ui(r,4e3))return Je(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await Ui(r,4e3)?Je(t,e,o-1):i},Vi=!1,kb=()=>{if(Vi)return;Vi=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let p=d.authorization||d.Authorization;if(!p){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=zo()?.authorization;xb({authorization:p,tokenId:m,capturedAt:Date.now()}),h!==p&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${p.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let p=b.headers;!p&&l[0]instanceof Request&&(p=l[0].headers);let m={};if(p instanceof Headers)p.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(p))p.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(p&&typeof p=="object")for(let h of Object.keys(p))m[h.toLowerCase()]=p[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Ji=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Eb=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Ji()},Tb=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Xi="__WS_CRM_TEMPLATES_CACHE_V1",Sb=24*60*60*1e3,Wi=t=>{try{let e=window.localStorage.getItem(Xi);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Sb?null:o.templates}catch{return null}},Cb=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Xi,JSON.stringify(o))}catch{}},Ab=async t=>{let e=`${_e}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Je(e,{method:"GET"})}catch(s){let l=Wi(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Wi(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Tb(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Cb(t,i),i},Ib=async(t,e)=>{let o=await Je(`${_e}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Je(`${_e}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},Lb=async(t,e)=>{let o=await Je(`${_e}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${_e}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Xe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-p})},$b=async t=>{let e=await fetch(fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Mb=async(t,e,o)=>{let r=`${_e}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Xe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Ob=async(t,e)=>{let o=await fetch(`${_e}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Xe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Db=async t=>{let e=await fetch(`${_e}/contacts/${t}`,{method:"GET",headers:Xe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Hb=async(t,e,o,r)=>{let a;try{a=await Ob(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Db(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},p=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:p,grandTotal:a.grandTotal},h=await fetch(`${_e}/proposals/document/${e}`,{method:"PUT",headers:{...Xe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},Pb=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Fo="__WS_CRM_PENDING_INSTRUCTIONS",Bb=60*1e3,Rb=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Fb=t=>{let e=(t||"").toLowerCase();for(let o of Rb)if(e.includes(o.matches.toLowerCase()))return o;return null},Nb=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Fo,JSON.stringify(r))}catch{}},zb=()=>{try{let t=localStorage.getItem(Fo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Bb?(localStorage.removeItem(Fo),null):e}catch{return null}},Gb=()=>{try{localStorage.removeItem(Fo)}catch{}},qb=(t,e)=>{document.getElementById(me)?.remove();let o=document.createElement("div");o.id=me,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Ub=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Vb=()=>{let t=window.location.pathname.match(Ub);if(!t)return;let e=t[1],o=zb();o&&o.proposalId===e&&(Gb(),window.setTimeout(()=>{qb(o.title,o.bodyHtml)},600))},ji="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(ji)?.remove();let r=document.createElement("div");r.id=ji;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Ab(e.tenantId)}catch(i){o.innerHTML=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Kb(t)}),t},Yb="ws-crm-contact-actions-bar",Jb=async()=>{let t=Ji();if(!t){document.getElementById(Hn)?.remove();return}let e=null;try{e=await L(`#${Yb}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Hn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Qi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Pe="ws-crm-prepare-contract-button-opp",Dt=`${Pe}-wrap`,Xb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qb=/\/v2\/location\/([A-Za-z0-9]+)/,Zb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Bn=()=>{let t=window.location.pathname,e=t.match(Xb);if(!e)return null;let o=t.match(Qb);return o?{oppId:e[1],tenantId:o[1]}:null},eh=async()=>{for(let t of Zb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ro=!1,Ht=null,Rn=null,On=null,Dn,Pt=()=>{Ht?.disconnect(),Ht=null,Rn=null},th=t=>{if(Ht&&Rn===t)return;Pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rn=t,Ht=new MutationObserver(()=>{let o=Bn();if(!o||o.oppId!==t){Pt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Pe)?.remove(),document.getElementById(Dt)?.remove(),Pt();return}document.getElementById(Pe)||Zi()}),Ht.observe(e,{childList:!0,subtree:!0}))},oh=()=>{On||(On=new MutationObserver(()=>{Dn===void 0&&(Dn=window.setTimeout(()=>{Dn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Pe);t&&!e&&!Ro&&Zi()},300))}),On.observe(document.body,{childList:!0,subtree:!0}))},Zi=async()=>{if(!Ro){Ro=!0;try{let t=Bn();if(!t){document.getElementById(Pe)?.remove(),document.getElementById(Dt)?.remove(),Pt();return}let e=document.getElementById(Pe);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Dt)?.remove(),Pt());return}e&&(e.remove(),document.getElementById(Dt)?.remove());let o=await eh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Bn();if(!a||a.oppId!==t.oppId)return;let i=Qi();i.id=Pe,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Dt,s.style.cssText=`
    ...
    transition:border-color 0.15s ease,background 0.15s ease;flex-shrink:0;order:5;
  `,o.innerHTML=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){ih(o,s.properties,l=>{a(!0),zn({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?ns(e,d.property_record_id,d):Go(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Go(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?ns(e,s.property_record_id,s):Go(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await zn({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Go(o,"Request failed. Try again.")}finally{a(!1)}}}),o},sh=async()=>{for(let t of nh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},is=async(t,e)=>{let o=e.querySelector(`#${ts}`);if(!o)try{o=await L(`#${ts}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="5",o.appendChild(t),!0):!1},ss=()=>{let t=document.querySelectorAll(`#${Be}`);for(let e=1;e<t.length;e++)t[e].remove()},lh=async()=>{let t=R();if(!t||!t.locationId||t.source!=="url"){document.getElementById(Be)?.remove(),Qe();return}let e=t.locationId,o=document.getElementById(Be);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Qe();let r="seller";try{r=Ge(await ze(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Be)?.remove();return}let a=await sh();if(!a){c.warn("[compute-offer] no central panel found");return}let i=R();if(!i||i.contactId!==t.contactId)return;let s=as(t.contactId,e);if(!await is(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}ss(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(R()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(Be)){let d=as(t.contactId,e);is(d,a).then(()=>ss())}});l.observe(a,{childList:!0})},Bt=null,bs=()=>{let t=R()?.contactId??null;if(Bt&&Bt.id===t)return;let e=lh().finally(()=>{Bt?.promise===e&&(Bt=null)});Bt={id:t,promise:e}};var zt="reos-theme-stylesheet",Wn="reos-theme-fonts",Gt=!1,dh=()=>{let t=document.getElementById(Wn);t&&t.remove()},ch=`
/* ============================================
