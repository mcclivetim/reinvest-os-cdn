/* Wholesaling CRM Customizer v0.15.3 — built 2026-05-30T19:35:26.411Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var ze="[wholesaling-crm-customizer]",Or="__WS_CRM_DEBUG",Nr=()=>!!window[Or],c={info(...t){console.log(ze,...t)},warn(...t){console.warn(ze,...t)},error(...t){console.error(ze,...t)},debug(...t){Nr()&&console.log(ze,"[debug]",...t)}};var mo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,St=/\/v2\/location\/([A-Za-z0-9]+)/,Hr=t=>{let e=t.match(mo);if(!e)return null;let o=t.match(St);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Br=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(mo);if(!n)continue;let a=r.match(St)||window.location.pathname.match(St);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},C=()=>{let t=Hr(window.location.pathname);return t||Br()};var uo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},qe="",Ct=null,pe="other",At=new Set,Ue=()=>{let t=C()?.contactId??null;if(!(!(window.location.pathname!==qe)&&!(t!==Ct))){qe=window.location.pathname,Ct=t,pe=uo(),c.debug("Page/context changed:",pe,qe,"contact:",t);for(let r of At)try{r(pe)}catch(n){c.error("Subscriber threw:",n)}}},_o=t=>(At.add(t),setTimeout(()=>t(pe),0),()=>{At.delete(t)}),vo=()=>{pe=uo(),qe=window.location.pathname,Ct=C()?.contactId??null,c.debug("Router init, current page:",pe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Ue()},history.replaceState=function(o,r,n){e(o,r,n),Ue()},window.addEventListener("popstate",Ue),setInterval(Ue,1e3)};var Ve="0.15.3",We="2026-05-30T19:35:26.412Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let l=n.querySelector(t);if(l){a(l);return}let d,b,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),c.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},It={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},yo=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,D=`
  ...
  flex-shrink: 0;
`;var Rr=/^[A-Za-z0-9]{15,30}$/,ke=t=>typeof t=="string"&&Rr.test(t),Gr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zr=()=>{let t=window.WS_CRM_USER_ID;return ke(t)?t:null},Ur=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ke(o))return o;return null},qr=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Gr(e);if(!o)return null;let r=o.uid;if(ke(r))return r;let n=o.claims;if(n&&ke(n.user_id))return n.user_id}catch{}return null},Vr=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ke(n))return n}catch{}}}catch{}return null},L=()=>zr()||Ur()||qr()||Vr()||null;var xo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Wr=`${xo}/active-follow-up-get`,jr=`${xo}/active-follow-up-set`,le="ws-crm-active-follow-up-button",Mt={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},Kr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Yr=async t=>{let e=await fetch(Wr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xr=async(t,e)=>{let o=await fetch(jr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},de=(t,e)=>{let o=Mt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},go=t=>{let e=document.createElement("button");return e.type="button",e.id=le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,de(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Kr();if(!(!r||r.contactId!==t)){de(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Xr(r,L()),a=n&&n.state&&n.state in Mt?n.state:"blue";de(e,a),c.info(`Active Follow Up set for ${t} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),de(e,"error"),setTimeout(()=>void je(e,r),4e3)}}}),e},je=async(t,e)=>{de(t,"loading");try{let o=await Yr(e),r=o&&o.state&&o.state in Mt?o.state:"gray",n=document.getElementById(le);if(!n||n.dataset.contactId!==e.contactId)return;de(n,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),de(t,"error")}},Jr=[".central-panel","[class*='central-panel']"],Lt="ws-crm-contact-actions-bar",Qr=async()=>{for(let t of Jr)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Zr=async(t,e)=>{let o=e.querySelector(`#${Lt}`);if(!o)try{o=await A(`#${Lt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Lt}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},en=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},tn=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},on=async t=>{if(t==="url"){let o=await Qr();return o?{kind:"contact-detail",target:o}:null}let e=en();return e?{kind:"conversations",target:e}:null},fo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Zr(t,e.target);return o}return tn(t,e.target),"conversations-header"},rn=async()=>{let t=C();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(le);if(o&&o.dataset.contactId===e.contactId){je(o,e);return}o&&o.remove();let r=await on(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=C();if(!n||n.contactId!==e.contactId)return;let a=go(e.contactId),i=await fo(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),wo();let l=document.getElementById(le)??a;je(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(le);if(!(C()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=go(e.contactId);fo(m,r).then(()=>{wo(),je(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ee=null,ko=()=>{let t=C()?.contactId??null;if(Ee&&Ee.contactId===t)return;let e=rn().finally(()=>{Ee?.promise===e&&(Ee=null)});Ee={contactId:t,promise:e}},wo=()=>{let t=document.querySelectorAll(`#${le}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var oe="ws-crm-claim-release-pill",nn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",sn=async t=>{let e=await fetch(nn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},ln=async t=>{let e=await fetch(an,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},So=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},me=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;t.dataset.mode=e,t.style.cssText=yo(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},dn=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=oe,o.type="button",o.dataset.contactId=t,me(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=C();if(!n||!n.locationId||n.contactId!==t)return;let a=L();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>me(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";me(o,i),o.disabled=!0,o.style.opacity="0.8";try{let l=await ln({contactId:t,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:i;me(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),me(o,r);let d=o.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Eo=async(t,e)=>{try{let o=await sn({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(oe);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";me(r,n)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},cn=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=So(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},To=(t,e)=>{let o=dn({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${oe}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},bn=async()=>{let t=C();if(!t){document.getElementById(oe)?.remove();return}let e=document.getElementById(oe);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await cn(o),n=C();if(!n||n.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}To(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let a=document.getElementById(oe);a&&t.locationId&&Eo(a,{contactId:t.contactId,locationId:t.locationId});let i=null;i=new MutationObserver(async()=>{if(!(C()?.contactId===t.contactId)){i?.disconnect();return}if(document.getElementById(oe))return;let d=So(o);if(d){To(d,t.contactId);let b=document.getElementById(oe);b&&t.locationId&&Eo(b,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},Co=()=>{bn()};var hn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Te=new Map,Ao=async(t,e)=>{if(!t)return null;if(Te.has(t))return Te.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${hn}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${t}`),Te.set(t,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return Te.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,n),Te.set(t,null),null}};var Io=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",pn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",un=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let l=a||Po,d;if(i==="buyer"){let h=Oo.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let b=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},_n=async({contactId:t,tenantId:e})=>{let o=await fetch(mn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var ue="ws-crm-contact-actions-bar",vn="ws-crm-call-status-dropdown",Lo="ws-crm-offer-made-modal",yn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Oo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],gn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],fn=async()=>{for(let t of gn)try{let e=await A(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},wn=({contactId:t,kind:e})=>{let o=e==="buyer"?Oo:yn,r=e==="buyer"?pn:Po,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=vn,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=D,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${It[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=s.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=It[d.color]),m&&(m.textContent=d.label),l.style.display="none";let w=C()?.locationId,E=L();if(!w){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=s.amber);return}if(e==="seller"&&d.color==="green"&&!E){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=s.amber);return}let f=p?.textContent??"\u25BE",u=async y=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await un({contactId:t,locationId:w,status:d.label,userId:E,deadReason:y,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=f),i.style.opacity="1"},900)}catch(k){c.warn("Call Status webhook failed:",k),p&&(p.textContent="\u2717"),m&&(m.style.color=s.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=f),m&&(m.style.color=s.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Tn(k=>{u(k)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await _n({contactId:t,tenantId:w})).ok?await u():Sn(()=>{u()},()=>{m&&(m.textContent=y)})}catch(k){c.warn("Appointment sanity check failed; firing anyway:",k),await u()}return}await u()}),l.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(i),a.appendChild(l),a},xn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",kn=async t=>{let e=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},En=(t,e="seller")=>{document.getElementById(Lo)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=o?s.emerald:s.amber,i=document.createElement("div");i.id=Lo,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let d=new Date,b=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),h=o?`
    ...
    <div style="
      ...
      margin-bottom: 16px;
    ">
      <span style="color: ${s.ash}; font-family: ${v.mono}; font-size: 14px;">$</span>
  ...
  `,i.appendChild(l),document.body.appendChild(i);let m=()=>i.remove();i.addEventListener("click",E=>{E.target===i&&m()});let p=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),w=l.querySelector("#ws-offer-submit");_?.addEventListener("click",m),w?.addEventListener("click",async()=>{let E=(l.querySelector("#ws-offer-amount")?.value??"").trim(),f=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!E||Number(E)<=0){p&&(p.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let u=Number(E);if(u<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(u*1e3).toLocaleString("en-US")}?`);return}let k=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=k?k[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),w&&(w.disabled=!0,w.textContent="Recording\u2026",w.style.opacity="0.7"),_&&(_.disabled=!0);try{let g=await kn({tenantId:T,contactId:t,kind:e,amount:u,expiresAt:f||null,userId:L()});if(!g.ok){p&&(p.textContent=g.error??"Something went wrong."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${u} on ${g.opp_pipeline} opp (stage: ${g.opp_stage_name??"?"})`),m()}catch(g){c.error("Offer Made webhook failed",g),p&&(p.textContent=g instanceof Error?g.message:"Network error \u2014 try again."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Mo="ws-crm-dead-deal-modal",Tn=(t,e)=>{document.getElementById(Mo)?.remove();let o=document.createElement("div");o.id=Mo,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),a=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let i=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Fo=(t,e)=>{let o=document.createElement("div");if(o.id=ue,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=J,r.textContent="Offer Made",r.addEventListener("click",()=>En(t,e)),o.appendChild(r),o.appendChild(wn({contactId:t,kind:e}))}return o},Dt=!1,Cn=()=>{document.querySelectorAll(`[id="${ue}"]`).forEach(t=>t.remove())},No=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Dt){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Dt=!0;try{await An()}finally{Dt=!1}},An=async()=>{let t=C();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Cn();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let b=await Ao(t.contactId,t.locationId),h=Io(b);h==="buyer"?e="buyer":h==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=C();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ue}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await fn();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=C();if(!a||a.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Fo(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(ue)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(C()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${ue}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Fo(t.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},$o=null,In=()=>{$o===null&&($o=window.setInterval(()=>{let t=C();t&&(document.getElementById(ue)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),No()))},3e3))},Ho=()=>{In(),No()};var Ke="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Ln=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Se="data-ws-crm-favicon",Ft=t=>t.hasAttribute(Se),Bo=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Ln.has(e)},Ye=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Bo(r)&&!Ft(r)&&r.remove()});let e=document.head.querySelector(`link[${Se}="1"]`);e?e.href!==Ke&&(e.href=Ke):(e=document.createElement("link"),e.setAttribute(Se,"1"),e.rel="icon",e.type="image/png",e.href=Ke,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Se}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Se,"apple"),o.rel="apple-touch-icon",o.href=Ke,document.head.appendChild(o))},Ro=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Ye();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Ye())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Bo(i)&&!Ft(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ft(i)&&(n=!0)});n&&Ye()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Ye(),e>=5&&window.clearInterval(o)},1e3)};var Mn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Dn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Fn=".hr-card.hr-modal.crm-opportunities-modal",F=()=>{let t=document.querySelector(Fn);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(Dn);if(n){let a=n[1];if(Mn.includes(a))return a}}return null},re=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=F();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var $n="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",U="ws-crm-mt-offer-made-button",Go="ws-crm-mt-offer-made-modal",Pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,On=/\/v2\/location\/([A-Za-z0-9]+)/,Qe=()=>{let t=window.location.pathname,e=t.match(Pn);if(!e)return null;let o=t.match(On);return{oppId:e[1],locationId:o?o[1]:null}},Nn=async t=>{let e=await fetch($n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Xe=()=>{document.getElementById(Go)?.remove()},Hn=t=>{Xe();let e=document.createElement("div");e.id=Go,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),n=o.querySelector("#ws-mt-offer-error"),a=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Xe()}),a?.addEventListener("click",()=>Xe()),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let b=Number(d);if(b<100){n.textContent=`That looks low \u2014 did you mean $${(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await Nn({oppId:t.oppId,locationId:t.locationId,amount:b,userId:L()});if(!h.ok){n.textContent=h.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1);return}Xe(),t.onSuccess()}catch(h){c.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1)}})},Bn=t=>{let e=document.createElement("button");return e.id=U,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Qe();!o||!o.locationId||o.oppId!==t||Hn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=D)},4e3)}})}),e},Rn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gn=async()=>{for(let t of Rn)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Je=!1,Nt=async()=>{if(!Je){Je=!0;try{await zn()}finally{Je=!1}}},zn=async()=>{let t=Qe();if(!t||!t.locationId){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}let e=document.getElementById(U);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae());return}e&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove());let o=await Gn();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Qe();if(!n||n.oppId!==t.oppId)return;let a=Bn(t.oppId),i=document.createElement("span");i.id=`${U}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Un(t.oppId)},Ce=null,Ot=null,Ae=()=>{Ce?.disconnect(),Ce=null,Ot=null},Un=t=>{if(Ce&&Ot===t)return;Ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ot=t,Ce=new MutationObserver(()=>{let o=Qe();if(!o||o.oppId!==t){Ae();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}document.getElementById(U)||Nt()}),Ce.observe(e,{childList:!0,subtree:!0}))},$t=null,Pt,qn=()=>{$t||($t=new MutationObserver(()=>{Pt===void 0&&(Pt=window.setTimeout(()=>{Pt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);t&&!e&&!Je&&Nt()},300))}),$t.observe(document.body,{childList:!0,subtree:!0}))},zo=()=>{qn(),Nt()};var Vn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",q="ws-crm-not-interested-button",Wn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jn=/\/v2\/location\/([A-Za-z0-9]+)/,et=()=>{let t=window.location.pathname,e=t.match(Wn);if(!e)return null;let o=t.match(jn);return{oppId:e[1],locationId:o?o[1]:null}},Kn=async t=>{let e=await fetch(Vn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Yn=t=>{let e=document.createElement("button");return e.id=q,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=et();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Kn({oppId:o.oppId,locationId:o.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Xn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jn=async()=>{for(let t of Xn)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ze=!1,Gt=async()=>{if(!Ze){Ze=!0;try{await Qn()}finally{Ze=!1}}},Qn=async()=>{let t=et();if(!t||!t.locationId){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le());return}e&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove());let o=await Jn();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=et();if(!n||n.oppId!==t.oppId)return;let a=Yn(t.oppId),i=document.createElement("span");i.id=`${q}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Zn(t.oppId)},Ie=null,Rt=null,Le=()=>{Ie?.disconnect(),Ie=null,Rt=null},Zn=t=>{if(Ie&&Rt===t)return;Le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rt=t,Ie=new MutationObserver(()=>{let o=et();if(!o||o.oppId!==t){Le();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}document.getElementById(q)||Gt()}),Ie.observe(e,{childList:!0,subtree:!0}))},Ht=null,Bt,ea=()=>{Ht||(Ht=new MutationObserver(()=>{Bt===void 0&&(Bt=window.setTimeout(()=>{Bt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(q);t&&!e&&!Ze&&Gt()},300))}),Ht.observe(document.body,{childList:!0,subtree:!0}))},Uo=()=>{ea(),Gt()};var ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",V="ws-crm-reduce-price-button",qo="ws-crm-reduce-price-modal",oa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ra=/\/v2\/location\/([A-Za-z0-9]+)/,rt=()=>{let t=window.location.pathname,e=t.match(oa);if(!e)return null;let o=t.match(ra);return{oppId:e[1],locationId:o?o[1]:null}},na=async t=>{let e=await fetch(ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},tt=()=>{document.getElementById(qo)?.remove()},aa=t=>{tt();let e=document.createElement("div");e.id=qo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),a=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let b=r.value.replace(/[^0-9.]/g,"").split(".");r.value=b[0]+(b.length>1?"."+b.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&tt()}),a?.addEventListener("click",()=>{tt()}),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let b=parseFloat(d);if(!Number.isFinite(b)||b<=0){n.textContent="Price must be a positive number.",r.focus();return}if(b<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{await na({oppId:t.oppId,locationId:t.locationId,newPrice:b,userId:L()}),tt(),t.onSuccess()}catch(h){c.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",a&&(a.disabled=!1)}})},sa=(t,e)=>{let o=document.createElement("button");return o.id=V,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=rt();!r||!r.locationId||r.oppId!==t||aa({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),a=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,a&&(a.style.background=s.emerald,a.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=D,a&&(a.style.background=s.amber,a.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},ia=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],la=async()=>{for(let t of ia)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ot=!1,Vt=async()=>{if(!ot){ot=!0;try{await da()}finally{ot=!1}}},da=async()=>{let t=rt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),De());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await la();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=rt();if(!n||n.oppId!==t.oppId)return;let a=sa(t.oppId,t.locationId),i=document.createElement("span");i.id=`${V}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),ca(t.oppId)},Me=null,qt=null,De=()=>{Me?.disconnect(),Me=null,qt=null},ca=t=>{if(Me&&qt===t)return;De();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(qt=t,Me=new MutationObserver(()=>{let o=rt();if(!o||o.oppId!==t){De();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}document.getElementById(V)||Vt()}),Me.observe(e,{childList:!0,subtree:!0}))},zt=null,Ut,ba=()=>{zt||(zt=new MutationObserver(()=>{Ut===void 0&&(Ut=window.setTimeout(()=>{Ut=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!ot&&Vt()},300))}),zt.observe(document.body,{childList:!0,subtree:!0}))},Vo=()=>{ba(),Vt()};var Ko="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ne="ws-crm-send-to-closing-office-button",ce="ws-crm-send-to-title-co-wrap",st="ws-crm-stc-dropdown",ha=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pa=/\/v2\/location\/([A-Za-z0-9]+)/,it=()=>{let t=window.location.pathname,e=t.match(ha);if(!e)return null;let o=t.match(pa);return{oppId:e[1],locationId:o?o[1]:null}},ma=5*60*1e3,Yo=t=>`ws-crm-stc-cache:${t}`,ua=t=>{try{let e=window.localStorage.getItem(Yo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ma||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},_a=(t,e)=>{try{window.localStorage.setItem(Yo(t),JSON.stringify(e))}catch{}},va=async(t,e)=>{try{let o=await fetch(Ko,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},ya=async(t,e,o)=>{let r=await fetch(Ko,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},ga=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},Wo=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},fa=(t,e)=>{if(e&&ga(e)){window.setTimeout(()=>Wo(t),300);return}Wo(t)},W=()=>{document.getElementById(st)?.remove()},nt=(t,e,o)=>{W();let r=document.createElement("div");r.id=st;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...b.filter(_=>h[_]),...Object.keys(h).filter(_=>!b.includes(_))];for(let _ of m){let w=h[_],E=document.createElement("div");E.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${v.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${s.steel};
    `,f.textContent=_,E.appendChild(f),w.forEach(u=>{let y=document.createElement("div"),k=!u.filled&&u.navigable&&u.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${k?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,k&&(y.addEventListener("mouseenter",()=>{y.style.background=s.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",S=>{S.stopPropagation(),u.field_id&&(fa(u.field_id,u.folder),W())}));let T=u.filled?`<span style="color: ${s.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${s.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,g=k?`<span style="margin-left: auto; color: ${s.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${u.label}</span>${g}`,E.appendChild(y)}),r.appendChild(E)}document.body.appendChild(r);let p=_=>{let w=_.target;!r.contains(w)&&!o.contains(w)&&(W(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},K=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),n=t.querySelector(".ws-stc-chevron"),a,i,l=s.bone,d,b="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",i=s.steel,l=s.ash,d=s.coolGray,b="Checking\u2026",m="wait",p="0.8";break;case"ready":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(E=>E.filled).length??0,w=e.checks?.length??0;a="transparent",i=s.amber,l=s.amber,d=s.amber,b=`${_} of ${w} fields ready`,h="\u25BE";break}case"sending":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",p="0.8";break;case"sent":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=s.amber,l=s.amber,d=s.amber,b=e.message??"Try again";break}t.style.background=a,t.style.borderColor=i,t.style.color=l,t.style.cursor=m,t.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=b),n&&(n.textContent=h)},wa=(t,e)=>{let o=document.createElement("button");o.id=ne,o.type="button",o.dataset.oppId=t;let r=ua(t),n=r?{status:r.checks.every(f=>f.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${J}
    background: transparent;
    border: 1px solid ${s.steel};
    color: ${s.ash};
  ...
  `,K(o,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let f=await va(t,e);if(!f){n={status:"error",message:"Check failed \u2014 click to retry"},K(o,n);return}if(f.rate_limited){_=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},K(o,n),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){n={status:"error",message:f.error||"Check failed \u2014 click to retry"},K(o,n),c.warn("[stc] dry_run returned no checks:",f);return}let u=f.pipeline_name;if(u&&u!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${u}" (not TC) \u2014 retracting button + caching`),lt.add(t),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),$e();return}let y=f.checks;if(n.checks&&n.checks.length===f.checks.length){let T=new Set;y=f.checks.map((g,S)=>n.checks[S]?.filled&&!g.filled?a.has(g.label)?g:(T.add(g.label),{...g,filled:!0}):g),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:f.previously_sent_at??null},_a(t,{checks:y,previously_sent_at:f.previously_sent_at??null,pipeline_name:u,ts:Date.now()}),K(o,n),document.getElementById(st)&&nt(y,f.previously_sent_at,o)},l=async()=>{let f=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},K(o,n),W();try{let u=await ya(t,e,f);if(u.needs_confirm){n={status:"ready",checks:u.checks,previouslySentAt:u.previously_sent_at},K(o,n),u.checks&&nt(u.checks,u.previously_sent_at,o);return}if(u.ok){n={status:"sent",checks:u.checks,previouslySentAt:new Date().toISOString()},K(o,n),window.setTimeout(()=>{w()},3500);return}n={status:"error",checks:u.checks,message:u.error||"Validation failed"},K(o,n),u.checks&&nt(u.checks,u.previously_sent_at,o)}catch(u){c.error("[stc] send failed:",u),n={status:"error",message:"Network error \u2014 click to retry"},K(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(st)?W():n.checks&&nt(n.checks,n.previouslySentAt,o);break}case"error":case"sent":w();break}});let d,b=!1,h=Date.now(),m=1e4,p=5*60*1e3,_=0,w=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,h=Date.now();try{await i()}finally{b=!1}}};w();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let f=new MutationObserver(()=>{if(d!==void 0||b)return;let y=Date.now()-h,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&w()},k)});f.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let u=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(u))},5e3)}return o},xa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ka=async()=>{for(let t of xa)try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},lt=new Set,jo=null,Ea=t=>{t&&t!==jo&&(lt.clear(),jo=t)},at=!1,Yt=async()=>{if(at){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}at=!0;try{await Ta()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{at=!1}},Ta=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=it();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Ea(t.oppId),lt.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=F();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(ce)?.remove(),W(),$e());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ce)?.remove(),W()),c.debug("[stc] mount:04 calling findMountTarget");let o=await ka();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=F();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=it();if(!n||n.oppId!==t.oppId||!n.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=wa(t.oppId,n.locationId),i=document.createElement("span");i.id=ce,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(a)}`),Sa(t.oppId)},Fe=null,Kt=null,$e=()=>{Fe?.disconnect(),Fe=null,Kt=null},Sa=t=>{if(Fe&&Kt===t)return;$e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kt=t,Fe=new MutationObserver(()=>{let o=it();if(!o||o.oppId!==t){$e();return}let r=F();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),$e();return}document.getElementById(ne)||Yt()}),Fe.observe(e,{childList:!0,subtree:!0}))},Wt=null,jt,Ca=()=>{Wt||(Wt=new MutationObserver(()=>{jt===void 0&&(jt=window.setTimeout(()=>{jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);if(t&&!e&&!at){let o=it();if(o&&lt.has(o.oppId))return;Yt()}},300))}),Wt.observe(document.body,{childList:!0,subtree:!0}))},Xo=()=>{Ca(),Yt()};var Aa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ia="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",La="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Zo="ldtyB2UXKi9vOp8nLUH7",Ma="WVD2gb9swLsgcdBEtDVq",j="ws-crm-closing-agent-picker-button",er="ws-crm-closing-agent-picker-modal",Da=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fa=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let t=window.location.pathname,e=t.match(Da);if(!e)return null;let o=t.match(Fa);return{oppId:e[1],locationId:o?o[1]:null}},ro=async t=>{let e=await fetch(Aa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Jo=async t=>{let e=await fetch(Ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$a=async(t,e)=>{try{let o=await fetch(La,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Zo}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await ro({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},be=null,Pa=60*60*1e3,no=t=>`ws-crm-to-cache:${t}`,tr=t=>{try{let e=window.localStorage.getItem(no(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Pa||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},or=(t,e,o)=>{try{window.localStorage.setItem(no(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Oa=t=>{try{window.localStorage.removeItem(no(t))}catch{}},Zt="ws-crm-closing-agent-field-link",Na=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Zt}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Xt=!1,ao=async t=>{if(Xt)return;let e=rr();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Xt=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await ro({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),eo(n.id,n.name,t);let a=document.getElementById(j);if(a){ae(a,{status:"linked",contactName:n.name});let i=Ne();i&&or(i.oppId,n.id,n.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Xt=!1}}},Ha=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,rr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let b=(d.textContent||"").trim();Ha.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&c.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let i=o[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},eo=(t,e,o)=>{let r=rr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${Zt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=Zt,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},dt=()=>{document.getElementById(er)?.remove()},Ba=t=>{dt();let e=document.createElement("div");e.id=er,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),a=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&dt()}),a?.addEventListener("click",dt);let i,l="",d=async b=>{if(n&&b!==l){if(l=b,!b.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await ro({tenantId:t.locationId,query:b,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{dt(),t.onPick(m)}),n.appendChild(p)})}catch(h){c.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${s.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(b)},250)})},ct=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ae=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",a=s.amber,i=s.bone,l="transparent",d=s.steel,b="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=s.coolGray,i=s.ash,b="wait";break;case"empty":n="Link Closing Agent",a=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,i=s.emeraldBright;break;case"saving":n="Linking\u2026",a=s.coolGray,i=s.ash,b="wait";break}o&&(o.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),t.style.background=l,t.style.borderColor=d,t.style.color=i,t.style.cursor=b},Ra=(t,e)=>{let o=document.createElement("button");o.id=j,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ae(o,r);let n=tr(t);return n&&(r={status:"linked",contactName:n.contactName},ae(o,r),be={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let i=await $a(t,e);i?(r={status:"linked",contactName:i.name},ae(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},eo(i.id,i.name,e)):n||(r={status:"empty"},ae(o,r),be?.oppId===t&&(be=null),Na(),Oa(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Ba({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},ae(o,r);try{let l=[Jo({tenantId:e,oppId:t,fieldId:Zo,value:i.id})];i.companyName&&i.companyName.trim()&&l.push(Jo({tenantId:e,oppId:t,fieldId:Ma,value:i.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:i.name},ae(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},or(t,i.id,i.name),eo(i.id,i.name,e),c.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},ae(o,r)}}})}),o},Ga=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],za=async()=>{for(let t of Ga)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Pe=!1,ht=async()=>{if(!Pe){Pe=!0;try{await Ua()}finally{Pe=!1}}},Ua=async()=>{let t=Ne();if(!t||!t.locationId){document.getElementById(j)?.remove(),document.getElementById(`${j}-wrap`)?.remove(),bt();return}let e=document.getElementById(j);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove(),bt());return}e&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove());let o=F();if(o!==null&&o!=="Transaction Coordination")return;let r=await za();if(!r||!(tr(t.oppId)!==null||be!==null&&be.oppId===t.oppId)&&await re()!=="Transaction Coordination")return;let a=Ne();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=Ra(t.oppId,a.locationId),l=document.createElement("span");l.id=`${j}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(i),r.appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),qa(t.oppId),ao(a.locationId)},Oe=null,to=null,oo=null,bt=()=>{Oe?.disconnect(),Oe=null,to=null,oo=null},qa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Oe&&to===t&&oo===e||(bt(),to=t,oo=e,Oe=new MutationObserver(()=>{let o=Ne();if(!o||o.oppId!==t||!o.locationId){bt();return}document.getElementById(j)||ht(),ao(o.locationId)}),Oe.observe(e,{childList:!0,subtree:!0})))},Jt=null,Qt,Va=()=>{Jt||(Jt=new MutationObserver(()=>{Qt===void 0&&(Qt=window.setTimeout(()=>{Qt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);t&&!e&&!Pe&&ht()},300))}),Jt.observe(document.body,{childList:!0,subtree:!0}))},Qo,Wa=()=>{Qo===void 0&&(Qo=window.setInterval(()=>{let t=Ne();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(j)&&!Pe&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),ht()),ao(t.locationId)},2e3))},nr=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Va(),Wa(),ht()};var ja="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",so="ws-crm-prepare-contract-button",ar="ws-crm-prepare-contract-menu",X="ws-crm-prepare-contract-modal",sr="ws-crm-modal-date-style",Q="https://services.leadconnectorhq.com",cr=()=>{if(document.getElementById(sr))return;let t=document.createElement("style");t.id=sr,t.textContent=`
    #${X} input[type="date"] { color-scheme: dark; }
  ...
  `,document.head.appendChild(t)},io="__WS_CRM_CAPTURED_AUTH",Ka=50*60*1e3,br=()=>{try{let t=localStorage.getItem(io);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Ka?(localStorage.removeItem(io),null):e:null}catch{return null}},Ya=t=>{try{localStorage.setItem(io,JSON.stringify(t))}catch{}},Z=()=>{let t=br(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ir=!1,Xa=()=>{if(ir)return;ir=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=br()?.authorization;Ya({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=b.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,i=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),i.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},hr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ja=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Qa=async t=>{let e=`${Q}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:Z()});if(!o.ok){let a="";try{a=await o.text()}catch{}let i=a?` \u2014 ${a.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${i}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(a=>({id:(a._id??a.id??a.templateId)||"",name:a.name||a.title||"(unnamed template)",type:Ja(a.name||a.title||"")})).filter(a=>!!a.id)},Za=async(t,e)=>{let o=await fetch(`${Q}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let a=await fetch(`${Q}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Z()});if(!a.ok)throw new Error(`ACQ opp search ${a.status}`);return((await a.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},es=async(t,e)=>{let o=await fetch(`${Q}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${Q}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Z()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-h})},ts=async t=>{let e=await fetch(ja,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},os=async(t,e,o)=>{let r=`${Q}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:Z()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let a=await n.json(),i=a._id||a.id||a.proposal?._id||a.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},rs=async(t,e)=>{let o=await fetch(`${Q}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok){let a=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${a.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},ns=async t=>{let e=await fetch(`${Q}/contacts/${t}`,{method:"GET",headers:Z()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},as=async(t,e,o,r)=>{let n;try{n=await rs(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let a;try{a=await ns(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let i=`${a.firstName} ${a.lastName}`.trim()||a.email||o,l={id:o,firstName:a.firstName,lastName:a.lastName,email:a.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${Q}/proposals/document/${e}`,{method:"PUT",headers:{...Z(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let _=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:_}}return{ok:!0}},ss=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},pt="__WS_CRM_PENDING_INSTRUCTIONS",is=60*1e3,ls=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],ds=t=>{let e=(t||"").toLowerCase();for(let o of ls)if(e.includes(o.matches.toLowerCase()))return o;return null},cs=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(pt,JSON.stringify(r))}catch{}},bs=()=>{try{let t=localStorage.getItem(pt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>is?(localStorage.removeItem(pt),null):e}catch{return null}},hs=()=>{try{localStorage.removeItem(pt)}catch{}},ps=(t,e)=>{document.getElementById(X)?.remove();let o=document.createElement("div");o.id=X,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},ms=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,us=()=>{let t=window.location.pathname.match(ms);if(!t)return;let e=t[1],o=bs();o&&o.proposalId===e&&(hs(),window.setTimeout(()=>{ps(o.title,o.bodyHtml)},600))},lr="ws-crm-prepare-contract-toast",G=(t,e="info",o=4e3)=>{document.getElementById(lr)?.remove();let r=document.createElement("div");r.id=lr;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},dr=(t,e)=>new Promise(o=>{document.getElementById(X)?.remove();let r=document.createElement("div");r.id=X,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let a=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},i=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${Y(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${s.slate};
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,ee=M=>['<option value="">(unset)</option>'].concat(E.map($=>`<option value="${Y($)}"${$===M?" selected":""}>${H($)}</option>`)).join("");u.innerHTML=`
    <div style="
      font-family: ${v.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${g}">
        ...
        <div style="${T}">${H(a||"(set on Property record)")}</div>
      </div>
      <div style="${g}">
        <div style="${y}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Y(i)}" placeholder="Seller name" style="${k}" />
      </div>
      <div style="${g}">
      ...
      <div style="${g}">
        ...
        <div style="${S}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-cash-at-close" type="number" min="0" step="0.01" value="${b}" style="${k}" />
        </div>
      </div>
      <div style="${g}">
        <div style="${y}">Days to Close</div>
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${Y(h)}" placeholder="e.g. 30" style="${k}" />
      </div>
      <div style="${g}">
        <div style="${y}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${Y(m)}" placeholder="e.g. 10" style="${k}" />
      </div>
      <div style="${g}">
        <div style="${y}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${I}">${ee(_)}</select>
      </div>
      <div style="${g}">
        <div style="${y}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${I}">${ee(w)}</select>
      </div>
      <div style="${g} align-items: flex-start;">
        <div style="${y}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${k} text-align: left; resize: vertical; min-height: 60px; font-family: ${v.sans};">${H(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,f.appendChild(u),document.body.appendChild(f);let N=u.querySelector("#ws-pc-purchase-price"),se=u.querySelector("#ws-pc-emd"),te=u.querySelector("#ws-pc-cash-at-close"),ie=!1;te?.addEventListener("input",()=>{ie=!0});let _e=()=>{if(ie)return;let M=Number(N?.value||0),$=Number(se?.value||0);te&&(te.value=String(Math.max(0,M-$)))};N?.addEventListener("input",_e),se?.addEventListener("input",_e);let Ge=()=>f.remove();f.addEventListener("click",M=>{M.target===f&&Ge()}),u.querySelector("#ws-pc-cancel")?.addEventListener("click",Ge);let z=u.querySelector("#ws-pc-submit"),R=u.querySelector("#ws-pc-error");z?.addEventListener("click",async()=>{if(z){R&&(R.textContent=""),z.disabled=!0,z.textContent="Opening\u2026";try{let M=(u.querySelector("#ws-pc-seller-name")?.value||"").trim(),$=Number(N?.value||0),ve=Number(se?.value||0),ye=Number(te?.value||0),ge=(u.querySelector("#ws-pc-days-to-close")?.value??"").trim(),fe=(u.querySelector("#ws-pc-inspection-days")?.value??"").trim(),we=(u.querySelector("#ws-pc-additional-terms")?.value??"").trim(),he=(u.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),xe=(u.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(M!==i&&(P.sellerName=M),$!==l&&(P.purchasePrice=$),ve!==d&&(P.emd=ve),ye!==b&&(P.cashAtClose=ye),ge!==h&&(P.daysToClose=ge),fe!==m&&(P.inspectionDays=fe),we!==p&&(P.additionalTerms=we),he!==_&&(P.currentOccupancy=he),xe!==w&&(P.occupancyAtClose=xe),Object.keys(P).length>0){c.info("[prepare-contract] PA modal submit with overrides:",P),z.textContent="Saving\u2026";let kt=L(),Et=await mt({tenantId:t,contactId:e,template:o,userId:kt,overrides:P});c.info("[prepare-contract] re-stage with overrides ok:",Et),z.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let O=a?`${a} - Purchase Agreement`:void 0;await lo(t,e,o,O)}catch(M){z.disabled=!1,z.textContent="Open Contract",R&&(R.textContent=M.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",M)}}})},vs=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:a,defaultClosingDate:i,defaultEMDDueDate:l})=>{document.getElementById(X)?.remove(),cr();let d=n.debug||{},b=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,w=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",u=i,y=l,k="",T=document.createElement("div");T.id=X,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;g.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${N}">
        ...
        <div style="${ee}">${H(b||"(set on Property record)")}</div>
      </div>
      <div style="${N}">
        <div style="${S}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Y(h)}" placeholder="Seller name" style="${I}" />
      </div>
      <div style="${N}">
        <div style="${S}">Buyer LLC <span style="color: ${s.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${v.sans};">(assignee)</span></div>
        <input id="ws-pc-buyer-llc" type="text" value="${Y(f)}" placeholder="Buyer's entity / LLC name" style="${I} text-align: left;" />
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <div style="${se}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${p}" style="${I}" />
        </div>
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${Y(E)}" placeholder="Title company" style="${I} text-align: left;" />
      </div>
      <div style="${N}">
        <div style="${S}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${Y(u)}" style="${I} text-align: left;" />
      </div>
      <div style="${N}">
        <div style="${S}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${Y(y)}" style="${I} text-align: left;" />
      </div>
      <div style="${N}">
        <div style="${S}">Lender Source <span style="color: ${s.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${v.sans};">(optional)</span></div>
        <input id="ws-pc-lender-source" type="text" placeholder="e.g. ABC Hard Money LLC" style="${I} text-align: left;" />
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,T.appendChild(g),document.body.appendChild(T);let te=g.querySelector("#ws-pc-assignment-price"),ie=g.querySelector("#ws-pc-assignment-fee"),_e=!1;ie?.addEventListener("input",()=>{_e=!0});let Ge=()=>{if(_e)return;let $=Number(te?.value||0);ie&&(ie.value=String(Math.max(0,$-w)))};te?.addEventListener("input",Ge);let z=()=>T.remove();T.addEventListener("click",$=>{$.target===T&&z()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",z);let R=g.querySelector("#ws-pc-submit"),M=g.querySelector("#ws-pc-error");R?.addEventListener("click",async()=>{if(!R)return;M&&(M.textContent="");let $=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),ve=Number(te?.value||0),ye=Number(g.querySelector("#ws-pc-buyer-emd")?.value||0),ge=Number(ie?.value||0),fe=(g.querySelector("#ws-pc-closing-office")?.value||"").trim(),we=(g.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),he=(g.querySelector("#ws-pc-closing-date")?.value||"").trim(),xe=(g.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),P=(g.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!he){M&&(M.textContent="Closing Date is required.");return}R.disabled=!0,R.textContent="Opening\u2026";try{let O={};$!==h&&(O.sellerName=$),ve!==m&&(O.assignmentPrice=ve),ye!==p&&(O.buyerEMD=ye),ge!==_&&(O.assignmentFee=ge),fe!==E&&(O.closingOffice=fe),we!==f&&(O.buyerCompanyName=we);let kt=he!==u||xe!==y||P!==k,Et=Object.keys(O).length>0||kt,Tt=n;Et?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",O),R.textContent="Saving\u2026",Tt=await mt({tenantId:t,contactId:e,template:o,oppId:r,closingDate:he,buyerEarnestDueDate:xe,lenderSource:P,userId:a,overrides:Object.keys(O).length>0?O:void 0}),c.info("[prepare-contract] AA re-stage ok:",Tt),R.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let po=Tt?.debug?.propertyAddress||b,Pr=po?`${po} - Assignment Agreement`:void 0;await lo(t,e,o,Pr),z()}catch(O){R.disabled=!1,R.textContent="Open Contract",M&&(M.textContent=O.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",O)}})},mt=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await ts({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},lo=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await os(t,o.id,e);c.info(`[prepare-contract] proposal created: ${n}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let a=await as(t,n,e,r);a.ok?c.info(`[prepare-contract] contact attached to proposal ${n}`):(c.warn(`[prepare-contract] attach failed (status=${a.status??"n/a"}): ${a.body?.slice(0,300)??"no body"}`),G(`Proposal created but couldn't auto-attach contact (HTTP ${a.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",a.body));let i=ds(o.name);i&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),cs(n,i.title,i.bodyHtml)),ss(t,n)},ys=async t=>{let e=hr();if(!e){G("Could not resolve contact context.","error");return}document.getElementById(ar)?.remove();let o=document.createElement("div");o.id=ar,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Qa(e.tenantId)}catch(a){o.innerHTML=`
    ...
    `;let l=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=s.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let b=L();try{if(a.type==="AA"){let h;try{h=await es(e.tenantId,e.contactId)}catch(u){G(`Failed to load buyer's MT opps: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",u);return}if(h.length===0){G("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${h.length} opps)`);let u=await dr(h,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!u){c.info("[prepare-contract] MT opp picker cancelled");return}m=u,c.info(`[prepare-contract] picked MT opp ${m}`)}let p=u=>{let y=u.getFullYear(),k=String(u.getMonth()+1).padStart(2,"0"),T=String(u.getDate()).padStart(2,"0");return`${y}-${k}-${T}`},_=u=>{let y=new Date;return y.setDate(y.getDate()+u),p(y)},w=_(45),E=_(7);G("Reading contract data\u2026","info",2500);let f;try{f=await mt({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,closingDate:w,buyerEarnestDueDate:E,userId:b})}catch(u){G(`Failed to prepare contract: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",u);return}vs({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,staged:f,userId:b,defaultClosingDate:w,defaultEMDDueDate:E})}else if(a.type==="PA"){let h;try{h=await Za(e.tenantId,e.contactId)}catch(_){G(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(h.length===0){G("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let _=await dr(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}G("Reading contract data\u2026","info",2500);let p;try{p=await mt({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,userId:b})}catch(_){G(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}_s({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:p})}else{G(`Opening ${a.name}\u2026`,"info",2500);try{await lo(e.tenantId,e.contactId,a)}catch(h){G(`Failed to open contract: ${h.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){c.warn("[prepare-contract] picker click handler failed:",h),G(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(i)}},gs=()=>{let t=document.createElement("button");return t.id=so,t.type="button",t.style.cssText=`
    position: relative;
    background: ${s.slate};
    border: 1px solid ${s.steel};
    border-radius: ${x.sm};
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),ys(t)}),t},fs="ws-crm-contact-actions-bar",ws=async()=>{let t=hr();if(!t){document.getElementById(so)?.remove();return}let e=null;try{e=await A(`#${fs}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(so);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=gs();r.dataset.contactId=t.contactId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},pr=()=>{us(),ws()};Xa();function H(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Y(t){return H(t)}var ft="reos-theme-stylesheet",Mr="reos-theme-fonts",xs=()=>{let t=document.getElementById(Mr);t&&t.remove()},ks=`
/* ============================================
...
`,Es=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Ts=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(n))return t;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${n}, ${a})`}return`rgb(${o}, ${r}, ${n})`},Ss=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Cs=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],co=new WeakSet,mr=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(co.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let i=+a[1],l=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||i<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){co.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),co.add(e)}catch{}})}catch{}},ur=new WeakSet,He=()=>{document.querySelectorAll(Cs.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(ur.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=+i[1],d=+i[2],b=+i[3];l<230||d<230||b<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),ur.add(r))})})},_r=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},ut=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let l=+i[1],d=+i[2],b=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&l>=180&&d>=180&&b>=180&&l+d+b>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},vr=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Be=()=>{for(let t of Es){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,n]of Object.entries(t.styles)){let a=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),l=Ss.has(r)?Ts(n):n;a==="important"&&i===l||o.style.setProperty(r,n,"important")}})}},wt="#1A1F28",As=26,Is=31,Ls=40,yr=new Set,gr=new Set,_t=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!gr.has(n)&&n!=="<no class>"&&(gr.add(n),c.debug(`Hid empty "--" leaf: "${n}"`))})},Ms=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Ds=["trash","Trash","TRASH","delete","Delete","DELETE"],Fs=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,n=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Ds.some(a=>n.includes(a))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let l=i.getAttribute("d")||"";Ms.some(d=>l.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},$s=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Ps=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||$s.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},fr=new Set,wr=new WeakSet,Os=()=>{document.body.querySelectorAll("*").forEach(e=>{if(wr.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),wr.add(e);let h=e.className?.toString()||"<no class>";!fr.has(h)&&h!=="<no class>"&&(fr.add(h),c.debug(`Remapped pure-white text -> bone: "${h}"`))})},xr=new Set,Ns=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let i=(a.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let l=window.getComputedStyle(a),d=l.backgroundColor,b=l.backgroundImage||"",h=!1;if(b!=="none"&&b.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let g=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let S=parseInt(g[1],10),I=parseInt(g[2],10),ee=parseInt(g[3],10);(S>=60||I>=60||ee>=60)&&(S>230&&I>230&&ee>230||(S>=80||I>=80||ee>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),_=i,w=Array.from(a.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),E=p.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),f=_.includes("bg-clip-text")||_.includes("text-transparent")||w.includes("bg-clip-text")||w.includes("text-transparent"),u=Array.from(a.querySelectorAll("*")).some(T=>{let g=window.getComputedStyle(T),S=g.getPropertyValue("-webkit-background-clip")||"",I=g.getPropertyValue("background-clip")||"";return S.includes("text")||I.includes("text")});if(E||f||u){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=S=>{T.forEach(I=>S.style.removeProperty(I))};g(a),a.querySelectorAll("*").forEach(g);return}let y="#12161D";a.style.setProperty("color",y,"important"),a.querySelectorAll("*").forEach(T=>{let g=T.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(T.style.setProperty("fill",y,"important"),T.style.setProperty("stroke",y,"important"),T.style.setProperty("color",y,"important")):(T.style.setProperty("color",y,"important"),T.style.setProperty("-webkit-text-fill-color",y,"important"))});let k=a.className?.toString()||"<no class>";!xr.has(k)&&k!=="<no class>"&&(xr.add(k),c.debug(`Darkened SVG icons on colored button: "${k}"`))})})},kr=new Set,Hs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let b=d;if(b.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let w=h.width*h.height/(r.width*r.height);if(w>.55)return;let E=b,f=b.parentElement,u=0;for(;f&&f!==e&&u<3;){let k=f.getBoundingClientRect();if(k.width>0&&k.width<=30&&k.height<=30)E=f;else break;f=f.parentElement,u++}E.style.setProperty("transform","translateY(11px)","important");let y=(E.className?.toString()||"")+" "+E.tagName;kr.has(y)||(kr.add(y),c.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${w.toFixed(2)}): "${y}"`))})})},Bs="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Rs=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Bs,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Er=new Set,Gs=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=parseInt(i[1],10),d=parseInt(i[2],10),b=parseInt(i[3],10);if(!(l>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!Er.has(h)&&h!=="<no class>"&&(Er.add(h),c.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${b})): "${h}"`))})})},Tr=new Set,zs=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let n=(o.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Tr.has(l)&&l!=="<no class>"&&(Tr.add(l),c.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},Sr=new Set,Us=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let i=parseInt(a.zIndex,10);if(!isFinite(i)||i<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(n)}),[...t,...o].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let l=(i.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let f=i.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(l.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let f=i.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let h=parseInt(b[1],10),m=parseInt(b[2],10),p=parseInt(b[3],10);if(!(h>200&&m>200&&p>200))return;let w=i.getBoundingClientRect();if(w.width<24||w.height<16||w.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let E=i.className?.toString()||"<no class>";!Sr.has(E)&&E!=="<no class>"&&(Sr.add(E),c.debug(`Coerced light bg (${w.width.toFixed(0)}x${w.height.toFixed(0)}, rgb(${h},${m},${p})): "${E}"`))})})},Cr=new Set,qs=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let y=o.getAttribute("style")||"";(y.includes("color")||y.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let n=o,a=null;for(let y=0;y<4&&n;y++){let k=n.nextElementSibling;if(k&&(k.matches(t)||k.querySelector(t)!==null)){a=k;break}n=n.parentElement}if(!a)return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=a,d=l.getBoundingClientRect(),b=l.className?.toString()||"",h=b.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(b.includes("hr-form-item-blank")||b.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=b.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let E=b.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;E&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=b.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!_&&!w&&!E&&!f&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",wt,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let u=o.className?.toString()||"<no class>";!Cr.has(u)&&u!=="<no class>"&&(Cr.add(u),c.debug(`Colored field label "${r.slice(0,30)}": "${u}"`))})},Ar=new Set,Vs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let i=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${l}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Ar.has(d)&&d!=="<no class>"&&(Ar.add(d),c.debug(`Resized avatar text to ${l}px (circle ${i.toFixed(0)}px): "${d}"`))})},Ir=new Set,Ws=new Set(["Enter Dashboard Name"]),js=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Ws.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",wt,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",wt,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!Ir.has(a)&&a!=="<no class>"&&(Ir.add(a),c.debug(`Forced input slate bg: "${a}"`))})},vt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>o.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let i=parseInt(a[1],10),l=parseInt(a[2],10),d=parseInt(a[3],10);if(!(i<As&&l<Is&&d<Ls))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",wt,"important");let m=e.className?.toString()||"<no class>";!yr.has(m)&&m!=="<no class>"&&(yr.add(m),c.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${i},${l},${d})): "${m}"`))})},yt=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let l=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let b=d,h=!1;if(e.forEach(_=>{b.includes(_)&&(b=b.split(_).join(t),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{b.includes(_)&&(b=b.split(_).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(w=>{b.includes(w)&&(b=b.split(w).join("#EDEEF0"),h=!0)}),!!h)try{let _=btoa(b);a.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let i=a.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;a.setAttribute("data-reos-masked","1");let l=`url("${i}")`;a.style.setProperty("-webkit-mask-image",l,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",l,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",o)})},gt=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Ks=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Re=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{t(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(i).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",i="rgb(0, 191, 124)",l=b=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",b,"important"),h.style.setProperty("stroke",b,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",b,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?i:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(i)),r.addEventListener("mouseleave",()=>l(a)))})},bo=new WeakSet,Ys=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!bo.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){bo.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Ve}`,t.title=`Built ${We}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var B=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},$r=()=>{c.info(`Loaded v${Ve} (built ${We})`),B("mountVersionBadge (initial)",xt),B("mountFavicon",Ro),B("mountThemeStylesheet",Dr),B("initPageRouter",vo),c.info("[main] registering onPageChange subscriber"),_o(t=>{c.info(`[main] onPageChange callback fired for page=${t}`),B("mountVersionBadge",xt),B("mountClaimReleaseToggle",Co),B("mountContactActionsBar",Ho),B("mountActiveFollowUpButton",ko),B("mountMtOfferMadeButton",zo),B("mountNotInterestedButton",Uo),B("mountReducePriceButton",Vo),B("mountSendToClosingOfficeButton",Xo),B("mountClosingAgentPickerButton",nr),B("mountPrepareContractButton",pr)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$r):$r();})();
