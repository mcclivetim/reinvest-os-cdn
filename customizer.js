/* Wholesaling CRM Customizer v0.14.5 — built 2026-05-30T02:13:15.187Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var we="[wholesaling-crm-customizer]",sr="__WS_CRM_DEBUG",ir=()=>!!window[sr],b={info(...o){console.log(we,...o)},warn(...o){console.warn(we,...o)},error(...o){console.error(we,...o)},debug(...o){ir()&&console.log(we,"[debug]",...o)}};var Rt=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,tt=/\/v2\/location\/([A-Za-z0-9]+)/,lr=o=>{let e=o.match(Rt);if(!e)return null;let t=o.match(tt);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},dr=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Rt);if(!n)continue;let a=r.match(tt)||window.location.pathname.match(tt);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=lr(window.location.pathname);return o||dr()};var $t=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ke="",ot=null,Y="other",rt=new Set,xe=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ke)&&!(o!==ot))){ke=window.location.pathname,ot=o,Y=$t(),b.debug("Page/context changed:",Y,ke,"contact:",o);for(let r of rt)try{r(Y)}catch(n){b.error("Subscriber threw:",n)}}},Gt=o=>(rt.add(o),setTimeout(()=>o(Y),0),()=>{rt.delete(o)}),Ut=()=>{Y=$t(),ke=window.location.pathname,ot=S()?.contactId??null,b.debug("Router init, current page:",Y);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),xe()},history.replaceState=function(t,r,n){e(t,r,n),xe()},window.addEventListener("popstate",xe),setInterval(xe,1e3)};var Ee="0.14.5",Te="2026-05-30T02:13:15.188Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let l=n.querySelector(o);if(l){a(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},w={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},nt={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},zt=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var cr=/^[A-Za-z0-9]{15,30}$/,ee=o=>typeof o=="string"&&cr.test(o),br=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},hr=()=>{let o=window.WS_CRM_USER_ID;return ee(o)?o:null},pr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(ee(t))return t;return null},mr=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=br(e);if(!t)return null;let r=t.uid;if(ee(r))return r;let n=t.claims;if(n&&ee(n.user_id))return n.user_id}catch{}return null},ur=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(ee(n))return n}catch{}}}catch{}return null},I=()=>hr()||pr()||mr()||ur()||null;var jt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",_r=`${jt}/active-follow-up-get`,vr=`${jt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",st={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},yr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},gr=async o=>{let e=await fetch(_r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},fr=async(o,e)=>{let t=await fetch(vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=st[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},qt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Pe();!r||!r.locationId||r.oppId!==o||An({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=A,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},Fn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mn=async()=>{for(let o of Fn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,ft=async()=>{if(!Oe){Oe=!0;try{await Dn()}finally{Oe=!1}}},Dn=async()=>{let o=Pe();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),de());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Mn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Pe();if(!n||n.oppId!==o.oppId)return;let a=Ln(o.oppId,o.locationId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),Hn(o.oppId)},le=null,gt=null,de=()=>{le?.disconnect(),le=null,gt=null},Hn=o=>{if(le&&gt===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gt=o,le=new MutationObserver(()=>{let t=Pe();if(!t||t.oppId!==o){de();return}let r=L();if(r!==null&&r!=="Disposition"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}document.getElementById(O)||ft()}),le.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,On=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Oe&&ft()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{On(),ft()};var fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-closing-office-button",j="ws-crm-send-to-title-co-wrap",Re="ws-crm-stc-dropdown",Pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nn=/\/v2\/location\/([A-Za-z0-9]+)/,$e=()=>{let o=window.location.pathname,e=o.match(Pn);if(!e)return null;let t=o.match(Nn);return{oppId:e[1],locationId:t?t[1]:null}},Bn=5*60*1e3,wo=o=>`ws-crm-stc-cache:${o}`,Rn=o=>{try{let e=window.localStorage.getItem(wo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>Bn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},$n=(o,e)=>{try{window.localStorage.setItem(wo(o),JSON.stringify(e))}catch{}},Gn=async(o,e)=>{try{let t=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Un=async(o,e,t)=>{let r=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},zn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},yo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},qn=(o,e)=>{if(e&&zn(e)){window.setTimeout(()=>yo(o),300);return}yo(o)},P=()=>{document.getElementById(Re)?.remove()},Ne=(o,e,t)=>{P();let r=document.createElement("div");r.id=Re;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Xn(o.oppId)},ce=null,kt=null,be=()=>{ce?.disconnect(),ce=null,kt=null},Xn=o=>{if(ce&&kt===o)return;be();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,ce=new MutationObserver(()=>{let t=$e();if(!t||t.oppId!==o){be();return}let r=L();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P(),be();return}document.getElementById(z)||Et()}),ce.observe(e,{childList:!0,subtree:!0}))},wt=null,xt,Jn=()=>{wt||(wt=new MutationObserver(()=>{xt===void 0&&(xt=window.setTimeout(()=>{xt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);if(o&&!e&&!Be){let t=$e();if(t&&Ge.has(t.oppId))return;Et()}},300))}),wt.observe(document.body,{childList:!0,subtree:!0}))},xo=()=>{Jn(),Et()};var Zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",To="ldtyB2UXKi9vOp8nLUH7",ta="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",So="ws-crm-closing-agent-picker-modal",oa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ra=/\/v2\/location\/([A-Za-z0-9]+)/,me=()=>{let o=window.location.pathname,e=o.match(oa);if(!e)return null;let t=o.match(ra);return{oppId:e[1],locationId:t?t[1]:null}},Mt=async o=>{let e=await fetch(Zn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,contact_type:o.contactType??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ko=async o=>{let e=await fetch(Qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},na=async(o,e)=>{try{let t=await fetch(ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:To}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Mt({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[closing-agent] fetchCurrent failed:",t),null}},K=null,aa=60*60*1e3,Dt=o=>`ws-crm-to-cache:${o}`,Co=o=>{try{let e=window.localStorage.getItem(Dt(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>aa||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},Io=(o,e,t)=>{try{window.localStorage.setItem(Dt(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},sa=o=>{try{window.localStorage.removeItem(Dt(o))}catch{}},It="ws-crm-closing-agent-field-link",ia=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${It}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Tt=!1,Ht=async o=>{if(Tt)return;let e=Ao();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[closing-agent] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==t){Tt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${t}`);let r=await Mt({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),At(n.id,n.name,o);let a=document.getElementById(N);if(a){q(a,{status:"linked",contactName:n.name});let s=me();s&&Io(s.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Tt=!1}}},la=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ao=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();la.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=t[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},At=(o,e,t)=>{let r=Ao();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${It}`).forEach(s=>s.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=o,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=It,l.href=`/v2/location/${t}/contacts/detail/${o}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${w.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},Ue=()=>{document.getElementById(So)?.remove()},da=o=>{Ue();let e=document.createElement("div");e.id=So,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ue()}),a?.addEventListener("click",Ue);let s,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
  ...
  `;let r={status:"loading"};q(t,r);let n=Co(o);return n&&(r={status:"linked",contactName:n.contactName},q(t,r),K={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let s=await na(o,e);s?(r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},At(s.id,s.name,e)):n||(r={status:"empty"},q(t,r),K?.oppId===o&&(K=null),ia(),sa(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||da({oppId:o,locationId:e,onPick:async s=>{r={status:"saving"},q(t,r);try{let l=[ko({tenantId:e,oppId:o,fieldId:To,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(ko({tenantId:e,oppId:o,fieldId:ta,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},Io(o,s.id,s.name),At(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},q(t,r)}}})}),t},ba=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ha=async()=>{for(let o of ba)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Ve=async()=>{if(!he){he=!0;try{await pa()}finally{he=!1}}},pa=async()=>{let o=me();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),qe();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let d=L();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),qe());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=L();if(t!==null&&t!=="Transaction Coordination")return;let r=await ha();if(!r||!(Co(o.oppId)!==null||K!==null&&K.oppId===o.oppId)&&await U()!=="Transaction Coordination")return;let a=me();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=ca(o.oppId,a.locationId),l=document.createElement("span");l.id=`${N}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${o.oppId}`),ma(o.oppId),Ht(a.locationId)},pe=null,Lt=null,Ft=null,qe=()=>{pe?.disconnect(),pe=null,Lt=null,Ft=null},ma=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pe&&Lt===o&&Ft===e||(qe(),Lt=o,Ft=e,pe=new MutationObserver(()=>{let t=me();if(!t||t.oppId!==o||!t.locationId){qe();return}document.getElementById(N)||Ve(),Ht(t.locationId)}),pe.observe(e,{childList:!0,subtree:!0})))},St=null,Ct,ua=()=>{St||(St=new MutationObserver(()=>{Ct===void 0&&(Ct=window.setTimeout(()=>{Ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!he&&Ve()},300))}),St.observe(document.body,{childList:!0,subtree:!0}))},Eo,_a=()=>{Eo===void 0&&(Eo=window.setInterval(()=>{let o=me();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(N)&&!he&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ve()),Ht(o.locationId)},2e3))},Lo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),ua(),_a(),Ve()};var va="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ot="ws-crm-prepare-contract-button",Fo="ws-crm-prepare-contract-menu",Mo="ws-crm-prepare-contract-modal",_e="https://services.leadconnectorhq.com",Z=null,ve=()=>{if(!Z)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:Z.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return Z.tokenId&&(o["token-id"]=Z.tokenId),o};var Do=!1,ya=()=>{if(Do)return;Do=!0;let o=window;o.__WS_CRM_DIAG=o.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{o.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){o.__WS_CRM_DIAG.fetchCalls+o.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?o.__WS_CRM_DIAG.fetchAuthSeen++:o.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=Z?.authorization;Z={authorization:h,tokenId:m,capturedAt:Date.now()},p!==h&&(o.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},t=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){o.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return t.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(o.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Po=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},ga=o=>{let e=(o||"").trim();return/^\[?\s*PA\s*\]?\s*[-\s]/i.test(e)?"PA":/^\[?\s*AA\s*\]?\s*[-\s]/i.test(e)?"AA":"passthrough"},fa=async o=>{let e=`${_e}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(o)}&skip=0&limit=100`,t=await fetch(e,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Templates fetch returned ${t.status} ${t.statusText}`);let r=await t.json();return(r.templates||r.items||[]).map(a=>({id:(a._id??a.id)||"",name:a.name||"(unnamed template)",type:ga(a.name||"")})).filter(a=>!!a.id)},wa=async(o,e)=>{let t=await fetch(`${_e}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${_e}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ve()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},xa=async o=>{let e=await fetch(va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,template_id:o.templateId,template_type:o.templateType,opp_id:o.oppId,closing_date:o.closingDate,buyer_earnest_due_date:o.buyerEarnestDueDate,lender_source:o.lenderSource,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},ka=async(o,e)=>{let t=await fetch(`${_e}/proposals/templates/to-proposal/${o}/${e}?locale=en-US`,{method:"POST",headers:ve()});if(!t.ok)throw new Error(`to-proposal HTTP ${t.status} ${t.statusText}`);let r=await t.json(),n=r._id||r.id||r.proposal?._id||r.proposal?.id;if(!n)throw new Error("to-proposal returned no proposal id");return n},Ea=async(o,e)=>{let t=await fetch(`${_e}/proposals/document/${o}`,{method:"PUT",headers:{...ve(),"Content-Type":"application/json"},body:JSON.stringify({contactId:e})});if(!t.ok)throw new Error(`assign-contact HTTP ${t.status} ${t.statusText}`)},Ta=(o,e)=>{let t=`/v2/location/${o}/payments/proposals-estimates/edit/${e}`;window.location.href=t},Ho="ws-crm-prepare-contract-toast",ue=(o,e="info",t=4e3)=>{document.getElementById(Ho)?.remove();let r=document.createElement("div");r.id=Ho;let n=e==="error"?i.crimson:i.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=o,document.body.appendChild(r),window.setTimeout(()=>r.remove(),t)},Sa=({tenantId:o,contactId:e,template:t,mtOpps:r,userId:n})=>{document.getElementById(Mo)?.remove();let a=document.createElement("div");a.id=Mo,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
      ...
      `;let y=r.map(v=>`<option value="${Oo(v.id)}">${Q(v.propertyAddress||v.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${u.mono};
        font-size: 10px;
  ...
  `,t.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,o.appendChild(t);let r=a=>{!t.contains(a.target)&&a.target!==o&&(t.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await fa(e.tenantId)}catch(a){t.innerHTML=`
      <div style="padding: 12px 14px; color: ${i.crimson}; font-size: 12px;">
        Failed to load templates: ${Q(a.message)}
    ...
    `;let l=a.type==="PA"?i.emerald:a.type==="AA"?i.blue:i.coolGray;s.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${Q(a.name)}</span>
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{t.remove(),document.removeEventListener("click",r,!0);let d=I();try{if(a.type==="AA"){let c;try{c=await wa(e.tenantId,e.contactId)}catch(h){ue(`Failed to load buyer's MT opps: ${h.message}`,"error");return}Sa({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:c,userId:d})}else{ue(`Preparing ${a.name}\u2026`,"info",2500);try{await No({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:d})}catch(c){ue(`Failed to prepare contract: ${c.message}`,"error",6e3),b.warn("[prepare-contract] flow failed:",c)}}}catch(c){b.warn("[prepare-contract] picker click handler failed:",c),ue(`Unexpected error: ${c.message}`,"error",6e3)}}),t.appendChild(s)}},Ia=()=>{let o=document.createElement("button");return o.id=Ot,o.type="button",o.style.cssText=`
    position: relative;
    background: ${i.slate};
    border: 1px solid ${i.steel};
    border-radius: ${w.sm};
