/* Wholesaling CRM Customizer v0.18.7 — built 2026-06-01T00:43:05.996Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var rt="[wholesaling-crm-customizer]",zn="__WS_CRM_DEBUG",Gn=()=>!!window[zn],b={info(...t){console.log(rt,...t)},warn(...t){console.warn(rt,...t)},error(...t){console.error(rt,...t)},debug(...t){Gn()&&console.log(rt,"[debug]",...t)}};var qn=/\/v2\/location\/([A-Za-z0-9]+)/,Un=new Set(["8ntUQzMflUkR0YvrRgVk"]),ge=()=>{let t=window.location.pathname.match(qn);return t?t[1]:null},Yt=()=>{let t=ge();return t!==null&&Un.has(t)};var Zo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xt=/\/v2\/location\/([A-Za-z0-9]+)/,Vn=t=>{let e=t.match(Zo);if(!e)return null;let o=t.match(Xt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Wn=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Zo);if(!a)continue;let i=r.match(Xt)||window.location.pathname.match(Xt);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},$=()=>{let t=Vn(window.location.pathname);return t||Wn()};var Qo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},at="",Jt=null,fe="other",Zt=new Set,nt=()=>{let t=$()?.contactId??null;if(!(!(window.location.pathname!==at)&&!(t!==Jt))){at=window.location.pathname,Jt=t,fe=Qo(),b.debug("Page/context changed:",fe,at,"contact:",t);for(let r of Zt)try{r(fe)}catch(a){b.error("Subscriber threw:",a)}}},er=t=>(Zt.add(t),setTimeout(()=>t(fe),0),()=>{Zt.delete(t)}),tr=()=>{fe=Qo(),at=window.location.pathname,Jt=$()?.contactId??null,b.debug("Router init, current page:",fe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),nt()},history.replaceState=function(o,r,a){e(o,r,a),nt()},window.addEventListener("popstate",nt),setInterval(nt,1e3)};var it="0.18.7",st="2026-06-01T00:43:05.999Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Qt={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},or=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,M=`
  ...
  flex-shrink: 0;
`;var jn=/^[A-Za-z0-9]{15,30}$/,Me=t=>typeof t=="string"&&jn.test(t),Kn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Yn=()=>{let t=window.WS_CRM_USER_ID;return Me(t)?t:null},Xn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Me(o))return o;return null},Jn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Kn(e);if(!o)return null;let r=o.uid;if(Me(r))return r;let a=o.claims;if(a&&Me(a.user_id))return a.user_id}catch{}return null},Zn=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Me(a))return a}catch{}}}catch{}return null},L=()=>Yn()||Xn()||Jn()||Zn()||null;var ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Qn=`${ir}/active-follow-up-get`,ea=`${ir}/active-follow-up-set`,pe="ws-crm-active-follow-up-button",to={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ta=()=>{let t=$();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},oa=async t=>{let e=await fetch(Qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ra=async(t,e)=>{let o=await fetch(ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},he=(t,e)=>{let o=to[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},rr=t=>{let e=document.createElement("button");return e.type="button",e.id=pe,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,he(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ta();if(!(!r||r.contactId!==t)){he(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await ra(r,L()),i=a&&a.state&&a.state in to?a.state:"blue";he(e,i),b.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){b.error("Active Follow Up Set webhook failed",a),he(e,"error"),setTimeout(()=>void lt(e,r),4e3)}}}),e},lt=async(t,e)=>{he(t,"loading");try{let o=await oa(e),r=o&&o.state&&o.state in to?o.state:"gray",a=document.getElementById(pe);if(!a||a.dataset.contactId!==e.contactId)return;he(a,r)}catch(o){b.warn("Active Follow Up Get webhook failed",o),he(t,"error")}},na=[".central-panel","[class*='central-panel']"],eo="ws-crm-contact-actions-bar",aa=async()=>{for(let t of na)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ia=async(t,e)=>{let o=e.querySelector(`#${eo}`);if(!o)try{o=await A(`#${eo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${eo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},sa=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},la=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},da=async t=>{if(t==="url"){let o=await aa();return o?{kind:"contact-detail",target:o}:null}let e=sa();return e?{kind:"conversations",target:e}:null},nr=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await ia(t,e.target);return o}return la(t,e.target),"conversations-header"},ca=async()=>{let t=$();if(!t||!t.locationId){document.getElementById(pe)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(pe);if(o&&o.dataset.contactId===e.contactId){lt(o,e);return}o&&o.remove();let r=await da(t.source);if(!r){b.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=$();if(!a||a.contactId!==e.contactId)return;let i=rr(e.contactId),s=await nr(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),ar();let l=document.getElementById(pe)??i;lt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(pe);if(!($()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=rr(e.contactId);nr(m,r).then(()=>{ar(),lt(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},De=null,sr=()=>{let t=$()?.contactId??null;if(De&&De.contactId===t)return;let e=ca().finally(()=>{De?.promise===e&&(De=null)});De={contactId:t,promise:e}},ar=()=>{let t=document.querySelectorAll(`#${pe}`);if(!(t.length<=1)){b.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ba="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Fe=new Map,dt=async(t,e)=>{if(!t)return null;if(Fe.has(t))return Fe.get(t)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ba}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return b.warn(`Contact Type fetch returned ${i.status} for ${t}`),Fe.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Fe.set(t,l),b.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${t}:`,a),Fe.set(t,null),null}};var ct=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var cr="ws-buybox-nav-icon",no="ws-buybox-panel",lr="ws-buybox-modal",pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",ao="https://mcclivetim.github.io/reinvest-os-cdn/geo",bt=null,He=null,Oe=null,ro=async()=>{if(bt)return bt;try{let t=await fetch(`${ao}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return bt=await t.json(),bt}catch(t){return b.error("[buy-box] failed to fetch states.json",t),[]}},ha=async t=>{if(!He)try{let e=await fetch(`${ao}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);He=await e.json()}catch(e){return b.error("[buy-box] failed to fetch counties.json",e),[]}return He?.[t]??[]},ma=async t=>{if(!Oe)try{let e=await fetch(`${ao}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Oe=await e.json()}catch(e){return b.error("[buy-box] failed to fetch cities.json",e),[]}return Oe?.[t]??[]},io=async t=>await(await fetch(pa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ua=(t,e)=>io({tenant_id:t,action:"list",buyer_contact_id:e}),va=(t,e,o,r)=>io({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),_a=(t,e)=>io({tenant_id:t,action:"remove",entry_id:e}),F=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ya=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},ga='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',fa='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',wa="nav.w-13, nav[class*='w-13']",xa=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ka=async()=>{try{return await A(wa,{timeoutMs:2500})}catch{return null}},Ea=async()=>{try{return await A(xa,{timeoutMs:2500})}catch{return null}},Ta=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Sa=(t,e)=>{let o=document.createElement("div");return o.id=no,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{La(t,e,()=>so(t,e))}),o},so=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ua(t,e),ro()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Ca(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Ca=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(p=>{let m=d.key==="state"?ya(p.geo_value,o):p.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",p=d.dataset.entryLabel||"this area";confirm(`Remove "${p}" from this buyer's buy-box?`)&&(d.disabled=!0,_a(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}so(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},pt=!1,br=(t,e)=>{pt=e;let o=Ta(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Ia,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",so(t.tenantId,t.buyerContactId)):(t.iconBtn.className=pr,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},pr="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ia="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Aa=t=>{let e=document.createElement("button");return e.id=cr,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=pr,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${ga.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!pt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),br(r,a)}),e},La=(t,e,o)=>{let r=document.getElementById(lr);r&&r.remove();let a=document.createElement("div");a.id=lr,a.style.cssText=`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),E=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),E=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await x(I)},x=async g=>{if(!s.granularity||!g)return;let E=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),E&&(E.textContent="");try{let D=await va(t,e,s.granularity,g);if(!D.ok){E&&(E.textContent=D.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(D){E&&(E.textContent=`Network error: ${D.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},oo=!1,we=null,Pe=null,dr=()=>{document.getElementById(cr)?.remove(),document.getElementById(no)?.remove(),Pe&&we&&we.nav.removeEventListener("click",Pe,!0),Pe=null,we=null,pt=!1},hr=()=>{$a()},$a=async()=>{if(!oo){oo=!0;try{let t=$();if(!t){dr();return}let e=document.getElementById(no);if(e&&e.dataset.buyerContactId===t.contactId&&we)return;dr();let o=null;try{o=await dt(t.contactId,t.locationId)}catch(m){b.warn("[buy-box] Contact Type fetch failed",m);return}if(ct(o)!=="buyer")return;if(!t.locationId){b.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ka(),Ea()]);if(!a||!i){b.warn("[buy-box] right-rail nav or panel area not found");return}let s=$();if(!s||s.contactId!==t.contactId)return;let l=Sa(t.locationId,t.contactId),d=Aa(()=>we),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};we=c;let p=a.querySelector(".flex.flex-col.items-center.gap-2");p?p.appendChild(d):a.appendChild(d),i.appendChild(l),Pe=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&pt&&br(c,!1)},a.addEventListener("click",Pe,!0),b.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{oo=!1}}};var le="ws-crm-claim-release-pill",Ma="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Da="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Fa=async t=>{let e=await fetch(Ma,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ha=async t=>{let e=await fetch(Da,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},vr=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},xe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=or(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Oa=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.contactId=t,xe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=$();if(!a||!a.locationId||a.contactId!==t)return;let i=L();if(!i){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>xe(o,r),2500);return}b.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";xe(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Ha({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;xe(o,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),xe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},mr=async(t,e)=>{try{let o=await Fa({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(le);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";xe(r,a)}catch(o){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Pa=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=vr(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},ur=(t,e)=>{let o=Oa({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${le}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Na=async()=>{let t=$();if(!t){document.getElementById(le)?.remove();return}let e=document.getElementById(le);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await Pa(o),a=$();if(!a||a.contactId!==t.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ur(r,t.contactId),b.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(le);i&&t.locationId&&mr(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!($()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(le))return;let d=vr(o);if(d){ur(d,t.contactId);let c=document.getElementById(le);c&&t.locationId&&mr(c,{contactId:t.contactId,locationId:t.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){b.warn("Could not mount Claim/Release pill:",o)}}},_r=()=>{Na()};var kr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ba="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",za=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||kr,d;if(s==="buyer"){let p=Er.find(h=>h.label===o),m=p?p.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:o,triggered_by_user_id:r??""};a&&(p.dead_reason=a),d={contact_id:t,location:{id:e},customData:p}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Ga=async({contactId:t,tenantId:e})=>{let o=await fetch(Ra,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var ke="ws-crm-contact-actions-bar",qa="ws-crm-call-status-dropdown",yr="ws-crm-offer-made-modal",Ua=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Er=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Va=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Wa=async()=>{for(let t of Va)try{let e=await A(t,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},ja=({contactId:t,kind:e})=>{let o=e==="buyer"?Er:Ua,r=e==="buyer"?Ba:kr,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=qa,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=M,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Qt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let p=s.firstElementChild,m=s.children[1],h=s.children[2];p&&(p.style.background=Qt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let k=$()?.locationId,T=L();if(!k){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!T){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await za({contactId:t,locationId:k,status:d.label,userId:T,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(S){b.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";Ja(S=>{y(S)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await Ga({contactId:t,tenantId:k})).ok?await y():Za(()=>{y()},()=>{m&&(m.textContent=f)})}catch(S){b.warn("Appointment sanity check failed; firing anyway:",S),await y()}return}await y()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},Ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Ya=async t=>{let e=await fetch(Ka,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Xa=(t,e="seller")=>{document.getElementById(yr)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=yr,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},wr=(t,e)=>{let o=document.createElement("div");if(o.id=ke,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=ae,r.textContent="Offer Made",r.addEventListener("click",()=>Xa(t,e)),o.appendChild(r),o.appendChild(ja({contactId:t,kind:e}))}return o},lo=!1,Qa=()=>{document.querySelectorAll(`[id="${ke}"]`).forEach(t=>t.remove())},Tr=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),lo){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}lo=!0;try{await ei()}finally{lo=!1}},ei=async()=>{let t=$();if(!t){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Qa();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await dt(t.contactId,t.locationId),p=ct(c);p==="buyer"?e="buyer":p==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=$();if(!o||o.contactId!==t.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ke}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await Wa();if(!a){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=$();if(!i||i.contactId!==t.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=wr(t.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(ke)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!($()?.contactId===t.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${ke}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,h=wr(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(a,{childList:!0})},xr=null,ti=()=>{xr===null&&(xr=window.setInterval(()=>{let t=$();t&&(document.getElementById(ke)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Tr()))},3e3))},Sr=()=>{ti(),Tr()};var ht="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",oi=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ne="data-ws-crm-favicon",co=t=>t.hasAttribute(Ne),Cr=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return oi.has(e)},mt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Cr(r)&&!co(r)&&r.remove()});let e=document.head.querySelector(`link[${Ne}="1"]`);e?e.href!==ht&&(e.href=ht):(e=document.createElement("link"),e.setAttribute(Ne,"1"),e.rel="icon",e.type="image/png",e.href=ht,document.head.appendChild(e),b.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ne}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ne,"apple"),o.rel="apple-touch-icon",o.href=ht,document.head.appendChild(o))},Ir=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)mt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),mt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Cr(s)&&!co(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&co(s)&&(a=!0)});a&&mt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,mt(),e>=5&&window.clearInterval(o)},1e3)};var ri=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ni=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,ai=".hr-card.hr-modal.crm-opportunities-modal",O=()=>{let t=document.querySelector(ai);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(ni);if(a){let i=a[1];if(ri.includes(i))return i}}return null},te=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=O();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ii="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",X="ws-crm-mt-offer-made-button",Ar="ws-crm-mt-offer-made-modal",si=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,li=/\/v2\/location\/([A-Za-z0-9]+)/,_t=()=>{let t=window.location.pathname,e=t.match(si);if(!e)return null;let o=t.match(li);return{oppId:e[1],locationId:o?o[1]:null}},di=async t=>{let e=await fetch(ii,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ut=()=>{document.getElementById(Ar)?.remove()},ci=t=>{ut();let e=document.createElement("div");e.id=Ar,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=_t();!o||!o.locationId||o.oppId!==t||ci({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=M)},4e3)}})}),e},pi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hi=async()=>{for(let t of pi)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vt=!1,mo=async()=>{if(!vt){vt=!0;try{await mi()}finally{vt=!1}}},mi=async()=>{let t=_t();if(!t||!t.locationId){document.getElementById(X)?.remove(),document.getElementById(`${X}-wrap`)?.remove(),Re();return}let e=document.getElementById(X);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${X}-wrap`)?.remove(),Re());return}e&&(e.remove(),document.getElementById(`${X}-wrap`)?.remove());let o=await hi();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_t();if(!a||a.oppId!==t.oppId)return;let i=bi(t.oppId),s=document.createElement("span");s.id=`${X}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ui(t.oppId)},Be=null,ho=null,Re=()=>{Be?.disconnect(),Be=null,ho=null},ui=t=>{if(Be&&ho===t)return;Re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ho=t,Be=new MutationObserver(()=>{let o=_t();if(!o||o.oppId!==t){Re();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(X)?.remove(),document.getElementById(`${X}-wrap`)?.remove(),Re();return}document.getElementById(X)||mo()}),Be.observe(e,{childList:!0,subtree:!0}))},bo=null,po,vi=()=>{bo||(bo=new MutationObserver(()=>{po===void 0&&(po=window.setTimeout(()=>{po=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(X);t&&!e&&!vt&&mo()},300))}),bo.observe(document.body,{childList:!0,subtree:!0}))},Lr=()=>{vi(),mo()};var _i="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",J="ws-crm-not-interested-button",yi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gi=/\/v2\/location\/([A-Za-z0-9]+)/,gt=()=>{let t=window.location.pathname,e=t.match(yi);if(!e)return null;let o=t.match(gi);return{oppId:e[1],locationId:o?o[1]:null}},fi=async t=>{let e=await fetch(_i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},wi=t=>{let e=document.createElement("button");return e.id=J,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=gt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await fi({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},xi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ki=async()=>{for(let t of xi)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yt=!1,yo=async()=>{if(!yt){yt=!0;try{await Ei()}finally{yt=!1}}},Ei=async()=>{let t=gt();if(!t||!t.locationId){document.getElementById(J)?.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge();return}let e=document.getElementById(J);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge());return}e&&(e.remove(),document.getElementById(`${J}-wrap`)?.remove());let o=await ki();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=gt();if(!a||a.oppId!==t.oppId)return;let i=wi(t.oppId),s=document.createElement("span");s.id=`${J}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ti(t.oppId)},ze=null,_o=null,Ge=()=>{ze?.disconnect(),ze=null,_o=null},Ti=t=>{if(ze&&_o===t)return;Ge();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(_o=t,ze=new MutationObserver(()=>{let o=gt();if(!o||o.oppId!==t){Ge();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(J)?.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge();return}document.getElementById(J)||yo()}),ze.observe(e,{childList:!0,subtree:!0}))},uo=null,vo,Si=()=>{uo||(uo=new MutationObserver(()=>{vo===void 0&&(vo=window.setTimeout(()=>{vo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(J);t&&!e&&!yt&&yo()},300))}),uo.observe(document.body,{childList:!0,subtree:!0}))},$r=()=>{Si(),yo()};var Ci="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",Z="ws-crm-reduce-price-button",Mr="ws-crm-reduce-price-modal",Ii=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ai=/\/v2\/location\/([A-Za-z0-9]+)/,xt=()=>{let t=window.location.pathname,e=t.match(Ii);if(!e)return null;let o=t.match(Ai);return{oppId:e[1],locationId:o?o[1]:null}},Li=async t=>{let e=await fetch(Ci,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ft=()=>{document.getElementById(Mr)?.remove()},$i=t=>{ft();let e=document.createElement("div");e.id=Mr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=xt();!r||!r.locationId||r.oppId!==t||$i({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=M,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Di=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Fi=async()=>{for(let t of Di)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wt=!1,xo=async()=>{if(!wt){wt=!0;try{await Hi()}finally{wt=!1}}},Hi=async()=>{let t=xt();if(!t||!t.locationId){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ue();return}let e=document.getElementById(Z);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ue());return}e&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove());let o=await Fi();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=xt();if(!a||a.oppId!==t.oppId)return;let i=Mi(t.oppId,t.locationId),s=document.createElement("span");s.id=`${Z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Oi(t.oppId)},qe=null,wo=null,Ue=()=>{qe?.disconnect(),qe=null,wo=null},Oi=t=>{if(qe&&wo===t)return;Ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wo=t,qe=new MutationObserver(()=>{let o=xt();if(!o||o.oppId!==t){Ue();return}let r=O();if(r!==null&&r!=="Disposition"){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ue();return}document.getElementById(Z)||xo()}),qe.observe(e,{childList:!0,subtree:!0}))},go=null,fo,Pi=()=>{go||(go=new MutationObserver(()=>{fo===void 0&&(fo=window.setTimeout(()=>{fo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Z);t&&!e&&!wt&&xo()},300))}),go.observe(document.body,{childList:!0,subtree:!0}))},Dr=()=>{Pi(),xo()};var Or="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",de="ws-crm-send-to-closing-office-button",me="ws-crm-send-to-title-co-wrap",Tt="ws-crm-stc-dropdown",Ni=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bi=/\/v2\/location\/([A-Za-z0-9]+)/,St=()=>{let t=window.location.pathname,e=t.match(Ni);if(!e)return null;let o=t.match(Bi);return{oppId:e[1],locationId:o?o[1]:null}},Ri=5*60*1e3,Pr=t=>`ws-crm-stc-cache:${t}`,zi=t=>{try{let e=window.localStorage.getItem(Pr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ri||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Gi=(t,e)=>{try{window.localStorage.setItem(Pr(t),JSON.stringify(e))}catch{}},qi=async(t,e)=>{try{let o=await fetch(Or,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},Ui=async(t,e,o)=>{let r=await fetch(Or,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Vi=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},Fr=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Wi=(t,e)=>{if(e&&Vi(e)){window.setTimeout(()=>Fr(t),300);return}Fr(t)},Q=()=>{document.getElementById(Tt)?.remove()},kt=(t,e,o)=>{Q();let r=document.createElement("div");r.id=Tt;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,oe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await qi(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},oe(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},oe(o,a),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},oe(o,a),b.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Ct.add(t),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q(),We();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let C=new Set;f=w.checks.map((x,g)=>a.checks[g]?.filled&&!x.filled?i.has(x.label)?x:(C.add(x.label),{...x,filled:!0}):x),i=C}else i=new Set;a={status:f.every(C=>C.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},Gi(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),oe(o,a),document.getElementById(Tt)&&kt(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},oe(o,a),Q();try{let y=await Ui(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},oe(o,a),y.checks&&kt(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},oe(o,a),window.setTimeout(()=>{k()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},oe(o,a),y.checks&&kt(y.checks,y.previously_sent_at,o)}catch(y){b.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},oe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Tt)?Q():a.checks&&kt(a.checks,a.previouslySentAt,o);break}case"error":case"sent":k();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,v=0,k=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await s()}finally{c=!1}}};k();let T=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(T){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-p,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&k()},S)});w.observe(T,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Ki=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yi=async()=>{for(let t of Ki)try{let e=await A(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ct=new Set,Hr=null,Xi=t=>{t&&t!==Hr&&(Ct.clear(),Hr=t)},Et=!1,So=async()=>{if(Et){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Et=!0;try{await Ji()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{Et=!1}},Ji=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=St();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Xi(t.oppId),Ct.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=O();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(me)?.remove(),Q(),We());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(me)?.remove(),Q()),b.debug("[stc] mount:04 calling findMountTarget");let o=await Yi();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=O();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=St();if(!a||a.oppId!==t.oppId||!a.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=ji(t.oppId,a.locationId),s=document.createElement("span");s.id=me,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Zi(t.oppId)},Ve=null,To=null,We=()=>{Ve?.disconnect(),Ve=null,To=null},Zi=t=>{if(Ve&&To===t)return;We();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(To=t,Ve=new MutationObserver(()=>{let o=St();if(!o||o.oppId!==t){We();return}let r=O();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q(),We();return}document.getElementById(de)||So()}),Ve.observe(e,{childList:!0,subtree:!0}))},ko=null,Eo,Qi=()=>{ko||(ko=new MutationObserver(()=>{Eo===void 0&&(Eo=window.setTimeout(()=>{Eo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);if(t&&!e&&!Et){let o=St();if(o&&Ct.has(o.oppId))return;So()}},300))}),ko.observe(document.body,{childList:!0,subtree:!0}))},Nr=()=>{Qi(),So()};var Br="ws-support-modal",Rr="ws-support-toast",es="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",zr="ws-support-submitter-name",Gr="ws-support-submitter-email",qr="ws-support-submitter-role",ts=["Bug","Feature Request","Question","Billing","Onboarding Help"],ue=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),os=(t,e="success",o)=>{let r=document.getElementById(Rr);r&&r.remove();let a=document.createElement("div");a.id=Rr;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},rs=()=>{document.getElementById(Br)?.remove();let t=(localStorage.getItem(zr)??"").trim(),e=(localStorage.getItem(Gr)??"").trim(),o=(localStorage.getItem(qr)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Br,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=ge();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(zr,r.submitterName),localStorage.setItem(Gr,r.submitterEmail),r.submitterRole&&localStorage.setItem(qr,r.submitterRole)}catch{}let p=i.querySelector("#ws-support-submit");p&&(p.disabled=!0,p.textContent="Submitting\u2026",p.style.opacity="0.7");try{let h=await(await fetch(es,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";os(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1")}})},ns=["#ws-support","/support-ticket","ws-support-modal"],as=t=>{if(!t||t.tagName!=="A")return!1;let o=t.getAttribute("href")||"";return ns.some(r=>o.includes(r))},is=t=>{let e=t.target;if(!e)return;let o=e.closest("a");!o||!as(o)||(t.preventDefault(),t.stopPropagation(),b.info("[support-nav] custom menu link clicked \u2192 opening modal"),rs())},Ur=!1,Vr=()=>{Ur||(document.addEventListener("click",is,!0),Ur=!0,b.info("[support-nav] click interceptor installed (listens for clicks on links with #ws-support in href)"))};var ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ls="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ds="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Kr="ldtyB2UXKi9vOp8nLUH7",cs="WVD2gb9swLsgcdBEtDVq",ee="ws-crm-closing-agent-picker-button",Yr="ws-crm-closing-agent-picker-modal",bs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ps=/\/v2\/location\/([A-Za-z0-9]+)/,Ye=()=>{let t=window.location.pathname,e=t.match(bs);if(!e)return null;let o=t.match(ps);return{oppId:e[1],locationId:o?o[1]:null}},Fo=async t=>{let e=await fetch(ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Wr=async t=>{let e=await fetch(ls,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},hs=async(t,e)=>{try{let o=await fetch(ds,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Kr}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Fo({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},ve=null,ms=60*60*1e3,Ho=t=>`ws-crm-to-cache:${t}`,Xr=t=>{try{let e=window.localStorage.getItem(Ho(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ms||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Jr=(t,e,o)=>{try{window.localStorage.setItem(Ho(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},us=t=>{try{window.localStorage.removeItem(Ho(t))}catch{}},Lo="ws-crm-closing-agent-field-link",vs=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Lo}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Co=!1,Oo=async t=>{if(Co)return;let e=Zr();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Co=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Fo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),$o(a.id,a.name,t);let i=document.getElementById(ee);if(i){ce(i,{status:"linked",contactName:a.name});let s=Ye();s&&Jr(s.oppId,a.id,a.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Co=!1}}},_s=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Zr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();_s.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&b.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},$o=(t,e,o)=>{let r=Zr();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Lo}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Lo,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},It=()=>{document.getElementById(Yr)?.remove()},ys=t=>{It();let e=document.createElement("div");e.id=Yr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&It()}),i?.addEventListener("click",It);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await Fo({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${At(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${At(m.email||"(no email)")} \xB7 ${At(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${At(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{It(),t.onPick(m)}),a.appendChild(h)})}catch(p){b.error("Closing Agent picker search failed",p),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},At=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ce=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,c="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=c},gs=(t,e)=>{let o=document.createElement("button");o.id=ee,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ce(o,r);let a=Xr(t);return a&&(r={status:"linked",contactName:a.contactName},ce(o,r),ve={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await hs(t,e);s?(r={status:"linked",contactName:s.name},ce(o,r),ve={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},$o(s.id,s.name,e)):a||(r={status:"empty"},ce(o,r),ve?.oppId===t&&(ve=null),vs(),us(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ys({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ce(o,r);try{let l=[Wr({tenantId:e,oppId:t,fieldId:Kr,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Wr({tenantId:e,oppId:t,fieldId:cs,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ce(o,r),ve={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Jr(t,s.id,s.name),$o(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},ce(o,r)}}})}),o},fs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ws=async()=>{for(let t of fs)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},je=!1,$t=async()=>{if(!je){je=!0;try{await xs()}finally{je=!1}}},xs=async()=>{let t=Ye();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Lt();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let d=O();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Lt());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=O();if(o!==null&&o!=="Transaction Coordination")return;let r=await ws();if(!r||!(Xr(t.oppId)!==null||ve!==null&&ve.oppId===t.oppId)&&await te()!=="Transaction Coordination")return;let i=Ye();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=gs(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ee}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),ks(t.oppId),Oo(i.locationId)},Ke=null,Mo=null,Do=null,Lt=()=>{Ke?.disconnect(),Ke=null,Mo=null,Do=null},ks=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ke&&Mo===t&&Do===e||(Lt(),Mo=t,Do=e,Ke=new MutationObserver(()=>{let o=Ye();if(!o||o.oppId!==t||!o.locationId){Lt();return}document.getElementById(ee)||$t(),Oo(o.locationId)}),Ke.observe(e,{childList:!0,subtree:!0})))},Io=null,Ao,Es=()=>{Io||(Io=new MutationObserver(()=>{Ao===void 0&&(Ao=window.setTimeout(()=>{Ao=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!je&&$t()},300))}),Io.observe(document.body,{childList:!0,subtree:!0}))},jr,Ts=()=>{jr===void 0&&(jr=window.setInterval(()=>{let t=Ye();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ee)&&!je&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),$t()),Oo(t.locationId)},2e3))},Qr=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Es(),Ts(),$t()};var Ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ee="ws-crm-manage-team-cta",tn="ws-crm-manage-team-modal",Cs=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,on={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Is={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},rn=()=>{let t=window.location.pathname.match(Cs);return t?{tenantId:t[1]}:null},Dt=async t=>{let e=await fetch(Ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},Y=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),be=t=>Y(t),Po="ws-crm-manage-team-toast",Ro=(t,e="info",o=4e3)=>{document.getElementById(Po)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Po,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Po)===a&&a.remove()},o)},No=()=>{document.getElementById(tn)?.remove()},As=(t,e)=>{let o=Is[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${Y(e)}</span>
  `},Ls=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>As(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>Ls(r,e)).join(""),Ft=async t=>{No();let e=document.createElement("div");e.id=tn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&No()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",No);let r;try{r=await Dt({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+$s(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Ms(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;Ds(t,{email:p.dataset.email||"",name:p.dataset.name||"",currentRoles:(p.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;Fs(t,{email:p.dataset.email||"",name:p.dataset.name||"",roleCount:parseInt(p.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Ms=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${Y(on[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Ft(t)}),Mt(e),setTimeout(()=>Mt(e),200),setTimeout(()=>Mt(e),800),window.addEventListener("resize",()=>Mt(e)),e},Gs=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],qs=async()=>{for(let t of Gs)try{let e=await A(t,{timeoutMs:1500});if(e)return e}catch{}return null},Bo=!1,Us=async()=>{if(!Bo){Bo=!0;try{let t=rn();if(!t){document.getElementById(Ee)?.remove();return}let e=document.getElementById(Ee);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await qs();if(!o){let i=document.createElement("div");i.id=`${Ee}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=en(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),b.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=en(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),b.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{Bo=!1}}},nn=()=>{if(!rn()){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}Us()};var Vs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",qo="ws-crm-prepare-contract-button",an="ws-crm-prepare-contract-menu",ne="ws-crm-prepare-contract-modal",sn="ws-crm-modal-date-style",ie="https://services.leadconnectorhq.com",pn=()=>{if(document.getElementById(sn))return;let t=document.createElement("style");t.id=sn,t.textContent=`
  ...
  `,document.head.appendChild(t)},Uo="__WS_CRM_CAPTURED_AUTH",Ws=50*60*1e3,hn=()=>{try{let t=localStorage.getItem(Uo);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Ws?(localStorage.removeItem(Uo),null):e:null}catch{return null}},js=t=>{try{localStorage.setItem(Uo,JSON.stringify(t))}catch{}},se=()=>{let t=hn(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ln=!1,Ks=()=>{if(ln)return;ln=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let p=d.authorization||d.Authorization;if(!p){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=hn()?.authorization;js({authorization:p,tokenId:m,capturedAt:Date.now()}),h!==p&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${p.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let p=c.headers;!p&&l[0]instanceof Request&&(p=l[0].headers);let m={};if(p instanceof Headers)p.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(p))p.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(p&&typeof p=="object")for(let h of Object.keys(p))m[h.toLowerCase()]=p[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},mn=()=>{let t=$();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ys=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:mn()},Xs=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},un="__WS_CRM_TEMPLATES_CACHE_V1",Js=24*60*60*1e3,dn=t=>{try{let e=window.localStorage.getItem(un);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Js?null:o.templates}catch{return null}},Zs=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(un,JSON.stringify(o))}catch{}},Qs=async t=>{let e=`${ie}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:se()})}catch(s){let l=dn(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=dn(t);if(s)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Xs(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Zs(t,i),i},el=async(t,e)=>{let o=await fetch(`${ie}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${ie}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:se()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},tl=async(t,e)=>{let o=await fetch(`${ie}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ie}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:se()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-p})},ol=async t=>{let e=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},rl=async(t,e,o)=>{let r=`${ie}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:se()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},nl=async(t,e)=>{let o=await fetch(`${ie}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},al=async t=>{let e=await fetch(`${ie}/contacts/${t}`,{method:"GET",headers:se()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},il=async(t,e,o,r)=>{let a;try{a=await nl(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await al(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},p=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:p,grandTotal:a.grandTotal},h=await fetch(`${ie}/proposals/document/${e}`,{method:"PUT",headers:{...se(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},sl=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Ot="__WS_CRM_PENDING_INSTRUCTIONS",ll=60*1e3,dl=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],cl=t=>{let e=(t||"").toLowerCase();for(let o of dl)if(e.includes(o.matches.toLowerCase()))return o;return null},bl=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Ot,JSON.stringify(r))}catch{}},pl=()=>{try{let t=localStorage.getItem(Ot);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ll?(localStorage.removeItem(Ot),null):e}catch{return null}},hl=()=>{try{localStorage.removeItem(Ot)}catch{}},ml=(t,e)=>{document.getElementById(ne)?.remove();let o=document.createElement("div");o.id=ne,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},ul=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,vl=()=>{let t=window.location.pathname.match(ul);if(!t)return;let e=t[1],o=pl();o&&o.proposalId===e&&(hl(),window.setTimeout(()=>{ml(o.title,o.bodyHtml)},600))},cn="ws-crm-prepare-contract-toast",R=(t,e="info",o=4e3)=>{document.getElementById(cn)?.remove();let r=document.createElement("div");r.id=cn;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},bn=(t,e)=>new Promise(o=>{document.getElementById(ne)?.remove();let r=document.createElement("div");r.id=ne,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,C.appendChild(x),document.body.appendChild(C);let U=x.querySelector("#ws-pc-assignment-price"),H=x.querySelector("#ws-pc-assignment-fee"),Te=!1;H?.addEventListener("input",()=>{Te=!0});let ot=()=>{if(Te)return;let z=Number(U?.value||0);H&&(H.value=String(Math.max(0,z-k)))};U?.addEventListener("input",ot);let K=()=>C.remove();C.addEventListener("click",z=>{z.target===C&&K()}),x.querySelector("#ws-pc-cancel")?.addEventListener("click",K);let W=x.querySelector("#ws-pc-submit"),N=x.querySelector("#ws-pc-error");W?.addEventListener("click",async()=>{if(!W)return;N&&(N.textContent="");let z=(x.querySelector("#ws-pc-seller-name")?.value||"").trim(),Se=Number(U?.value||0),Ce=Number(x.querySelector("#ws-pc-buyer-emd")?.value||0),Ie=Number(H?.value||0),Ae=(x.querySelector("#ws-pc-closing-office")?.value||"").trim(),Le=(x.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ye=(x.querySelector("#ws-pc-closing-date")?.value||"").trim(),$e=(x.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),G=(x.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ye){N&&(N.textContent="Closing Date is required.");return}W.disabled=!0,W.textContent="Opening\u2026";try{let q={};z!==p&&(q.sellerName=z),Se!==m&&(q.assignmentPrice=Se),Ce!==h&&(q.buyerEMD=Ce),Ie!==v&&(q.assignmentFee=Ie),Ae!==T&&(q.closingOffice=Ae),Le!==w&&(q.buyerCompanyName=Le);let Wt=ye!==y||$e!==f||G!==S,jt=Object.keys(q).length>0||Wt,Kt=a;jt?(b.info("[prepare-contract] AA modal submit, re-staging with overrides:",q),W.textContent="Saving\u2026",Kt=await Pt({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ye,buyerEarnestDueDate:$e,lenderSource:G,userId:i,overrides:Object.keys(q).length>0?q:void 0}),b.info("[prepare-contract] AA re-stage ok:",Kt),W.textContent="Opening\u2026"):b.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Jo=Kt?.debug?.propertyAddress||c,Rn=Jo?`${Jo} - Assignment Agreement`:void 0;await jo(t,e,o,Rn),K()}catch(q){W.disabled=!1,W.textContent="Open Contract",N&&(N.textContent=q.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",q)}})},Pt=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await ol({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},jo=async(t,e,o,r)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await rl(t,o.id,e);b.info(`[prepare-contract] proposal created: ${a}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await il(t,a,e,r);i.ok?b.info(`[prepare-contract] contact attached to proposal ${a}`):(b.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),R(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=cl(o.name);s&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),bl(a,s.title,s.bodyHtml)),sl(t,a)},gl=async t=>{let e=Ys(t);if(!e){R("Could not resolve contact context.","error");return}document.getElementById(an)?.remove();let o=document.createElement("div");o.id=an,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Qs(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let p;if(e.oppId)p=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${p} directly`);else{let y;try{y=await tl(e.tenantId,e.contactId)}catch(f){R(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){R("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)p=y[0].id,b.info(`[prepare-contract] auto-selected MT opp ${p} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await bn(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){b.info("[prepare-contract] MT opp picker cancelled");return}p=f,b.info(`[prepare-contract] picked MT opp ${p}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${C}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),k=h(7);R("Reading contract data\u2026","info",2500);let T;try{T=await Pt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:p,closingDate:v,buyerEarnestDueDate:k,userId:c})}catch(y){R(`Failed to prepare contract: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||T.contact_id||"";if(!w){R("Could not resolve buyer contact for this opp.","error",6e3);return}yl({tenantId:e.tenantId,contactId:w,template:i,oppId:p,staged:T,userId:c,defaultClosingDate:v,defaultEMDDueDate:k})}else if(i.type==="PA"){if(!e.contactId){R("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let p;try{p=await el(e.tenantId,e.contactId)}catch(v){R(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(p.length===0){R("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(p.length===1)m=p[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${p.length} opps)`);let v=await bn(p,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}R("Reading contract data\u2026","info",2500);let h;try{h=await Pt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){R(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}_l({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){R("This template needs to be started from a contact page.","error",6e3);return}R(`Opening ${i.name}\u2026`,"info",2500);try{await jo(e.tenantId,e.contactId,i)}catch(p){R(`Failed to open contract: ${p.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",p)}}}catch(p){b.warn("[prepare-contract] picker click handler failed:",p),R(`Unexpected error: ${p.message}`,"error",6e3)}}),o.appendChild(s)}},vn=()=>{let t=document.createElement("button");return t.id=qo,t.type="button",t.style.cssText=`${M} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),gl(t)}),t},fl="ws-crm-contact-actions-bar",wl=async()=>{let t=mn();if(!t){document.getElementById(qo)?.remove();return}let e=null;try{e=await A(`#${fl}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(qo);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=vn();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},_e="ws-crm-prepare-contract-button-opp",Xe=`${_e}-wrap`,xl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kl=/\/v2\/location\/([A-Za-z0-9]+)/,El=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vo=()=>{let t=window.location.pathname,e=t.match(xl);if(!e)return null;let o=t.match(kl);return o?{oppId:e[1],tenantId:o[1]}:null},Tl=async()=>{for(let t of El)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ht=!1,Je=null,Wo=null,zo=null,Go,Ze=()=>{Je?.disconnect(),Je=null,Wo=null},Sl=t=>{if(Je&&Wo===t)return;Ze();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wo=t,Je=new MutationObserver(()=>{let o=Vo();if(!o||o.oppId!==t){Ze();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(_e)?.remove(),document.getElementById(Xe)?.remove(),Ze();return}document.getElementById(_e)||_n()}),Je.observe(e,{childList:!0,subtree:!0}))},Cl=()=>{zo||(zo=new MutationObserver(()=>{Go===void 0&&(Go=window.setTimeout(()=>{Go=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(_e);t&&!e&&!Ht&&_n()},300))}),zo.observe(document.body,{childList:!0,subtree:!0}))},_n=async()=>{if(!Ht){Ht=!0;try{let t=Vo();if(!t){document.getElementById(_e)?.remove(),document.getElementById(Xe)?.remove(),Ze();return}let e=document.getElementById(_e);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Xe)?.remove(),Ze());return}e&&(e.remove(),document.getElementById(Xe)?.remove());let o=await Tl();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await te();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Vo();if(!a||a.oppId!==t.oppId)return;let i=vn();i.id=_e,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Xe,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Sl(t.oppId)}finally{Ht=!1}}},yn=()=>{vl(),wl()};Ks();function V(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function re(t){return V(t)}var qt="reos-theme-stylesheet",On="reos-theme-fonts",Il=()=>{let t=document.getElementById(On);t&&t.remove()},Al=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var B=(t,e)=>{try{b.info(`[main] calling ${t}`),e(),b.info(`[main] ${t} OK`)}catch(o){b.error(`[main:FAIL] ${t} threw:`,o)}},Bn=()=>{if(b.info(`Loaded v${it} (built ${st})`),Yt()){b.info(`[main] customizer disabled for excluded location ${ge()} \u2014 bailing`);return}B("mountVersionBadge (initial)",Vt),B("mountFavicon",Ir),B("mountThemeStylesheet",Pn),B("initPageRouter",tr),b.info("[main] registering onPageChange subscriber"),er(t=>{if(b.info(`[main] onPageChange callback fired for page=${t}`),Yt()){b.info(`[main] page change into excluded location ${ge()} \u2014 skipping mounts`);return}B("mountVersionBadge",Vt),B("mountClaimReleaseToggle",_r),B("mountContactActionsBar",Sr),B("mountActiveFollowUpButton",sr),B("mountMtOfferMadeButton",Lr),B("mountNotInterestedButton",$r),B("mountReducePriceButton",Dr),B("mountSendToClosingOfficeButton",Nr),B("mountClosingAgentPickerButton",Qr),B("mountPrepareContractButton",yn),B("mountManageTeam",nn),B("mountBuyBoxWidget",hr),B("mountSupportNavItem",Vr)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Bn):Bn();})();
