...
`;var Xo=/^[A-Za-z0-9]{15,30}$/,Z=o=>typeof o=="string"&&Xo.test(o),Jo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Zo=()=>{let o=window.WS_CRM_USER_ID;return Z(o)?o:null},Qo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Z(t))return t;return null},er=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Jo(e);if(!t)return null;let r=t.uid;if(Z(r))return r;let n=t.claims;if(n&&Z(n.user_id))return n.user_id}catch{}return null},tr=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Z(n))return n}catch{}}}catch{}return null},L=()=>Zo()||Qo()||er()||tr()||null;var Gt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",or=`${Gt}/active-follow-up-get`,rr=`${Gt}/active-follow-up-set`,z="ws-crm-active-follow-up-button",tt={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},nr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},ar=async o=>{let e=await fetch(or,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ir=async(o,e)=>{let t=await fetch(rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=tt[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Bt=o=>{let e=document.createElement("button");return e.type="button",e.id=z,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Se();!t||!t.locationId||t.oppId!==o||jr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Yr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xr=async()=>{for(let o of Yr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Te=!1,st=async()=>{if(!Te){Te=!0;try{await Jr()}finally{Te=!1}}},Jr=async()=>{let o=Se();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),re());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await Xr();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Se();if(!n||n.oppId!==o.oppId)return;let i=Kr(o.oppId),a=document.createElement("span");a.id=`${D}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Zr(o.oppId)},oe=null,it=null,re=()=>{oe?.disconnect(),oe=null,it=null},Zr=o=>{if(oe&&it===o)return;re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(it=o,oe=new MutationObserver(()=>{let t=Se();if(!t||t.oppId!==o){re();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}document.getElementById(D)||st()}),oe.observe(e,{childList:!0,subtree:!0}))},nt=null,at,Qr=()=>{nt||(nt=new MutationObserver(()=>{at===void 0&&(at=window.setTimeout(()=>{at=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!Te&&st()},300))}),nt.observe(document.body,{childList:!0,subtree:!0}))},so=()=>{Qr(),st()};var en="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",tn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,on=/\/v2\/location\/([A-Za-z0-9]+)/,Ie=()=>{let o=window.location.pathname,e=o.match(tn);if(!e)return null;let t=o.match(on);return{oppId:e[1],locationId:t?t[1]:null}},rn=async o=>{let e=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},nn=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Fe();!r||!r.locationId||r.oppId!==o||un({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),i=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,i&&(i.style.background=l.emerald,i.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,i&&(i.style.background=l.amber,i.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},vn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yn=async()=>{for(let o of vn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ae=!1,ut=async()=>{if(!Ae){Ae=!0;try{await gn()}finally{Ae=!1}}},gn=async()=>{let o=Fe();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),se();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Disposition"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),se());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=await yn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Fe();if(!n||n.oppId!==o.oppId)return;let i=_n(o.oppId,o.locationId),a=document.createElement("span");a.id=`${N}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),fn(o.oppId)},ie=null,mt=null,se=()=>{ie?.disconnect(),ie=null,mt=null},fn=o=>{if(ie&&mt===o)return;se();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(mt=o,ie=new MutationObserver(()=>{let t=Fe();if(!t||t.oppId!==o){se();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),se();return}document.getElementById(N)||ut()}),ie.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,wn=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!Ae&&ut()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},bo=()=>{wn(),ut()};var mo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",V="ws-crm-send-to-title-co-button",j="ws-crm-send-to-title-co-wrap",Oe="ws-crm-stc-dropdown",xn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kn=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let o=window.location.pathname,e=o.match(xn);if(!e)return null;let t=o.match(kn);return{oppId:e[1],locationId:t?t[1]:null}},En=5*60*1e3,uo=o=>`ws-crm-stc-cache:${o}`,Tn=o=>{try{let e=window.localStorage.getItem(uo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>En||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},Sn=(o,e)=>{try{window.localStorage.setItem(uo(o),JSON.stringify(e))}catch{}},Cn=async(o,e)=>{try{let t=await fetch(mo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},In=async(o,e,t)=>{let r=await fetch(mo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Ln=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},ho=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},An=(o,e)=>{if(e&&Ln(e)){window.setTimeout(()=>ho(o),300);return}ho(o)},H=()=>{document.getElementById(Oe)?.remove()},Me=(o,e,t)=>{H();let r=document.createElement("div");r.id=Oe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),i=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Pe()}),i?.addEventListener("click",Pe);let a,s="",d=async c=>{if(n&&c!==s){if(s=c,!c.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await Ct({tenantId:o.locationId,query:c,limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};q(t,r);let n=wo(o);return n&&(r={status:"linked",contactName:n.contactName},q(t,r),K={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await qn(o,e);a?(r={status:"linked",contactName:a.name},q(t,r),K={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},Et(a.id,a.name,e)):n||(r={status:"empty"},q(t,r),K?.oppId===o&&(K=null),jn(),Wn(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Yn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},q(t,r);try{let s=[vo({tenantId:e,oppId:o,fieldId:go,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(vo({tenantId:e,oppId:o,fieldId:Gn,value:a.companyName.trim()}));let c=(await Promise.all(s))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},q(t,r),K={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xo(o,a.id,a.name),Et(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},q(t,r)}}})}),t},Jn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Zn=async()=>{for(let o of Jn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ce=!1,$e=async()=>{if(!ce){ce=!0;try{await Qn()}finally{ce=!1}}},Qn=async()=>{let o=he();if(!o||!o.locationId){document.getElementById(P)?.remove(),document.getElementById(`${P}-wrap`)?.remove(),Re();return}let e=document.getElementById(P);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove(),Re());return}e&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Zn();if(!r||!(wo(o.oppId)!==null||K!==null&&K.oppId===o.oppId)&&await U()!=="Transaction Coordination")return;let i=he();if(!i||i.oppId!==o.oppId||!i.locationId)return;let a=Xn(o.oppId,i.locationId),s=document.createElement("span");s.id=`${P}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(a),r.appendChild(s),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),ea(o.oppId),Lt(i.locationId)},be=null,Tt=null,St=null,Re=()=>{be?.disconnect(),be=null,Tt=null,St=null},ea=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(be&&Tt===o&&St===e||(Re(),Tt=o,St=e,be=new MutationObserver(()=>{let t=he();if(!t||t.oppId!==o||!t.locationId){Re();return}document.getElementById(P)||$e(),Lt(t.locationId)}),be.observe(e,{childList:!0,subtree:!0})))},wt=null,xt,ta=()=>{wt||(wt=new MutationObserver(()=>{xt===void 0&&(xt=window.setTimeout(()=>{xt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(P);o&&!e&&!ce&&$e()},300))}),wt.observe(document.body,{childList:!0,subtree:!0}))},yo,oa=()=>{yo===void 0&&(yo=window.setInterval(()=>{let o=he();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(P)&&!ce&&(b.info("[title-officer] safety-net: button missing on opp page \u2014 remounting"),$e()),Lt(o.locationId)},2e3))},Eo=()=>{b.info("[title-officer] mountTitleOfficerPickerButton invoked"),ta(),oa(),$e()};var We="reos-theme-stylesheet",Uo="reos-theme-fonts",ra=()=>{let o=document.getElementById(Uo);o&&o.remove()},na=`
/* ============================================
