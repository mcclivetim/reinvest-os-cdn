...
`;var M="ws-crm-claim-release-pill",Q=o=>{let t=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ie=({contactId:o,mode:t})=>{let e=document.createElement("button");e.id=M,e.type="button",e.dataset.contactId=o,e.dataset.mode=t;let r=t==="claim"?"emerald":"amber",n=t==="claim"?l.emerald:l.amber;return e.style.cssText=J(r),e.innerHTML=`
  ...
  `,e.appendChild(r),document.body.appendChild(e);let n=()=>e.remove(),s=()=>{n(),t()};e.addEventListener("click",a=>{a.target===e&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=a=>{a.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},ne=o=>{let t=document.createElement("div");t.id=P,t.dataset.contactId=o,t.style.cssText=`
    ...
    flex-shrink: 0;
  `,t.appendChild(ze(o));let e=document.createElement("button");return e.type="button",e.style.cssText=I,e.textContent="Offer Made",e.addEventListener("click",()=>Ge(o)),t.appendChild(e),t},We=async()=>{let o=E();if(!o){document.getElementById(P)?.remove();return}let t=document.getElementById(P);if(t&&t.dataset.contactId===o.contactId)return;t&&t.remove();let e=await Be();if(!e){p.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=E();if(!r||r.contactId!==o.contactId)return;let n=ne(o.contactId);n.dataset.mountTarget=e.className||"central-panel",e.insertBefore(n,e.firstChild),p.debug(`Mounted contact actions bar for ${o.contactId}`);let s=null;s=new MutationObserver(()=>{let i=document.getElementById(P);if(!(E()?.contactId===o.contactId)){s?.disconnect();return}if(!i){let c=ne(o.contactId);c.dataset.mountTarget=n.dataset.mountTarget??"",e.insertBefore(c,e.firstChild),p.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),s.observe(e,{childList:!0})},ae=()=>{We()};var O="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Ve=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),$="data-ws-crm-favicon",V=o=>o.hasAttribute($),se=o=>{if(o.tagName!=="LINK")return!1;let t=(o.getAttribute("rel")??"").toLowerCase();return Ve.has(t)},B=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{se(r)&&!V(r)&&r.remove()});let t=document.head.querySelector(`link[${$}="1"]`);t?t.href!==O&&(t.href=O):(t=document.createElement("link"),t.setAttribute($,"1"),t.rel="icon",t.type="image/png",t.href=O,document.head.appendChild(t),p.debug("Favicon installed"));let e=document.head.querySelector(`link[${$}="apple"]`);e||(e=document.createElement("link"),e.setAttribute($,"apple"),e.rel="apple-touch-icon",e.href=O,document.head.appendChild(e))},ie=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)B();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),B())},50)}new MutationObserver(r=>{let n=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&se(i)&&!V(i)&&(n=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&V(i)&&(n=!0)});n&&B()}).observe(document.head,{childList:!0,subtree:!1});let t=0,e=window.setInterval(()=>{t+=1,B(),t>=5&&window.clearInterval(e)},1e3)};var le="reos-theme-stylesheet",ce="reos-theme-fonts",je=()=>{if(document.getElementById(ce))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com",document.head.appendChild(o);let t=document.createElement("link");t.rel="preconnect",t.href="https://fonts.gstatic.com",t.crossOrigin="anonymous",document.head.appendChild(t);let e=document.createElement("link");e.id=ce,e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(e)},Ke=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var _e=()=>{p.info(`Loaded v${H} (built ${N})`),ie(),we(),Z(),Y(o=>{p.debug("Page handler firing for:",o),Ee(),ee(),ae()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_e):_e();})();
