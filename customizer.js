/* Wholesaling CRM Customizer v0.11.2 — built 2026-05-21T22:13:41.365Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var B="[wholesaling-crm-customizer]",je="__WS_CRM_DEBUG",Ke=()=>!!window[je],p={info(...o){console.log(B,...o)},warn(...o){console.warn(B,...o)},error(...o){console.error(B,...o)},debug(...o){Ke()&&console.log(B,"[debug]",...o)}};var de=/\/contacts\/detail\/([A-Za-z0-9]+)/,te=/\/v2\/location\/([A-Za-z0-9]+)/,Ye=o=>{let e=o.match(de);if(!e)return null;let t=o.match(te);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Xe=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(de);if(!n)continue;let s=r.match(te)||window.location.pathname.match(te);return{contactId:n[1],locationId:s?s[1]:null,source:"dom"}}return null},k=()=>{let o=Ye(window.location.pathname);return o||Xe()};var ce=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},V="",oe=null,I="other",re=new Set,G=()=>{let o=k()?.contactId??null;if(!(!(window.location.pathname!==V)&&!(o!==oe))){V=window.location.pathname,oe=o,I=ce(),p.debug("Page/context changed:",I,V,"contact:",o);for(let r of re)try{r(I)}catch(n){p.error("Subscriber threw:",n)}}},be=o=>(re.add(o),setTimeout(()=>o(I),0),()=>{re.delete(o)}),he=()=>{I=ce(),V=window.location.pathname,oe=k()?.contactId??null,p.debug("Router init, current page:",I);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),G()},history.replaceState=function(t,r,n){e(t,r,n),G()},window.addEventListener("popstate",G),setInterval(G,1e3)};var U="0.11.2",$="2026-05-21T22:13:41.366Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((s,i)=>{let a=n.querySelector(o);if(a){s(a);return}let d,b,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let c=n.querySelector(o);c&&(h(),s(c))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let c=n.querySelector(o);c&&(h(),s(c))},r),d=window.setTimeout(()=>{h(),p.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},y={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ne={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},pe=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var ue="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Je=`${ue}/active-follow-up-get`,Ze=`${ue}/active-follow-up-set`,M="ws-crm-active-follow-up-button",ae={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},q=()=>{let o=k();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Qe=async o=>{let e=await fetch(Je,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},et=async(o,e)=>{let t=await fetch(Ze,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},tt=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let n=JSON.parse(r),s=n.id??n._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}for(let n of["tokenUser","currentUser","ghl_user"]){let s=localStorage.getItem(n);if(s)try{let i=JSON.parse(s),a=i.id??i._id;if(a&&/^[A-Za-z0-9]{15,30}$/.test(a))return a}catch{}}}catch{}return null},L=(o,e)=>{let t=ae[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},me=o=>{let e=document.createElement("button");return e.type="button",e.id=M,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,L(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=q();if(!(!r||r.contactId!==o)){L(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await et(r,tt()),s=n&&n.state&&n.state in ae?n.state:"blue";L(e,s),p.info(`Active Follow Up set for ${o} \u2192 ${s}`)}catch(n){p.error("Active Follow Up Set webhook failed",n),L(e,"error"),setTimeout(()=>void z(e,r),4e3)}}}),e},z=async(o,e)=>{L(o,"loading");try{let t=await Qe(e),r=t&&t.state&&t.state in ae?t.state:"gray",n=document.getElementById(M);if(!n||n.dataset.contactId!==e.contactId)return;L(n,r)}catch(t){p.warn("Active Follow Up Get webhook failed",t),L(o,"error")}},ot=[".central-panel","[class*='central-panel']"],_e="ws-crm-contact-actions-bar",rt=async()=>{for(let o of ot)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ve=(o,e)=>{let t=e.querySelector(`#${_e}`);if(t)return t.appendChild(o),{container:t,placement:"actions-bar"};let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${_e}`);s&&s.parentElement===e?e.insertBefore(n,s.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},nt=async()=>{let o=q();if(!o){document.getElementById(M)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e=document.getElementById(M);if(e&&e.dataset.contactId===o.contactId){z(e,o);return}e&&e.remove();let t=await rt();if(!t){p.warn("Active Follow Up: could not find central-panel mount target");return}let r=q();if(!r||r.contactId!==o.contactId)return;let n=me(o.contactId),{placement:s}=ve(n,t);p.debug(`Active Follow Up button mounted (${s}) for ${o.contactId}`),z(n,o);let i=new MutationObserver(()=>{let a=document.getElementById(M);if(!(q()?.contactId===o.contactId)){i.disconnect();return}if(!a){let b=me(o.contactId);ve(b,t),z(b,o),p.debug(`Active Follow Up re-mounted after wipe for ${o.contactId}`)}});i.observe(t,{childList:!0})},ye=()=>{nt()};var N="ws-crm-claim-release-pill",fe=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},at=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=N,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",n=e==="claim"?l.emerald:l.amber;return t.style.cssText=pe(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{p.info(`Claim/Release pill clicked for contact ${o}: ${e}`);let s=t.lastElementChild,i=s?.textContent??"";s&&(s.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{s&&(s.textContent=i),t.style.opacity="1",t.disabled=!1},700)}),t},st=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=fe(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},ge=(o,e)=>{let t=at({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${N}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},it=async()=>{let o=k();if(!o){document.getElementById(N)?.remove();return}let e=document.getElementById(N);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await st(t),n=k();if(!n||n.contactId!==o.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ge(r,o.contactId),p.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let s=null;s=new MutationObserver(async()=>{if(!(k()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(N))return;let a=fe(t);a&&(ge(a,o.contactId),p.debug("Re-mounted Claim/Release pill after React wipe"))}),s.observe(t,{childList:!0,subtree:!0})}catch(t){p.warn("Could not mount Claim/Release pill:",t)}}},we=()=>{it()};var lt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",ct=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let n=JSON.parse(r),s=n.id??n._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}for(let n of["tokenUser","currentUser","ghl_user"]){let s=localStorage.getItem(n);if(s)try{let i=JSON.parse(s),a=i.id??i._id;if(a&&/^[A-Za-z0-9]{15,30}$/.test(a))return a}catch{}}}catch{}return null},bt=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n})=>{let s={call_status:t,triggered_by_user_id:r??""};n&&(s.dead_reason=n);let a=await fetch(lt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:e},customData:s}),credentials:"omit"});if(!a.ok)throw new Error(`Webhook returned ${a.status} ${a.statusText}`)},ht=async({contactId:o,tenantId:e})=>{let t=await fetch(dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var W="ws-crm-contact-actions-bar",pt="ws-crm-call-status-dropdown",xe="ws-crm-offer-made-modal",mt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],_t=[".central-panel","[class*='central-panel']"],vt=async()=>{for(let o of _t)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ut=o=>{let e=document.createElement("div");e.id=pt,e.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=H,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,mt.forEach(n=>{let s=document.createElement("button");s.type="button",s.style.cssText=`
    ...
    `,s.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${ne[n.color]};
        flex-shrink: 0;
      "></span>
      <span>${n.label}</span>
    `,s.addEventListener("mouseenter",()=>{s.style.background=l.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{p.info(`Call Status set to "${n.label}" (${n.value}, ${n.color}) for contact ${o}`);let i=t.firstElementChild,a=t.children[1],d=t.children[2];i&&(i.style.background=ne[n.color]),a&&(a.textContent=n.label),r.style.display="none";let h=k()?.locationId,m=ct();if(!h){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),a&&(a.textContent=`${n.label} (no tenant!)`),a&&(a.style.color=l.amber);return}if(n.color==="green"&&!m){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),a&&(a.textContent=`${n.label} (no user!)`),a&&(a.style.color=l.amber);return}let c=d?.textContent??"\u25BE",g=async u=>{d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await bt({contactId:o,locationId:h,status:n.label,userId:m,deadReason:u}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=c),t.style.opacity="1"},900)}catch(v){p.warn("Call Status webhook failed:",v),d&&(d.textContent="\u2717"),a&&(a.style.color=l.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=c),a&&(a.style.color=l.bone)},1800)}};if(n.value==="dead-deal"){let u=a?.textContent??"";gt(v=>{g(v)},()=>{a&&(a.textContent=u)});return}if(n.value==="appointment-booked"){let u=a?.textContent??"";try{(await ht({contactId:o,tenantId:h})).ok?await g():ft(()=>{g()},()=>{a&&(a.textContent=u)})}catch(v){p.warn("Appointment sanity check failed; firing anyway:",v),await g()}return}await g()}),r.appendChild(s)}),t.addEventListener("click",n=>{n.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",n=>{e.contains(n.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},yt=o=>{document.getElementById(xe)?.remove();let e=document.createElement("div");e.id=xe,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),s=()=>{n(),e()};t.addEventListener("click",a=>{a.target===t&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=a=>{a.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},Te=o=>{let e=document.createElement("div");e.id=W,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let t=document.createElement("button");return t.type="button",t.style.cssText=D,t.textContent="Offer Made",t.addEventListener("click",()=>yt(o)),e.appendChild(t),e.appendChild(ut(o)),e},wt=async()=>{let o=k();if(!o){document.getElementById(W)?.remove();return}let e=document.getElementById(W);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await vt();if(!t){p.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=k();if(!r||r.contactId!==o.contactId)return;let n=Te(o.contactId);n.dataset.mountTarget=t.className||"central-panel",t.insertBefore(n,t.firstChild),p.debug(`Mounted contact actions bar for ${o.contactId}`);let s=null;s=new MutationObserver(()=>{let i=document.getElementById(W);if(!(k()?.contactId===o.contactId)){s?.disconnect();return}if(!i){let d=Te(o.contactId);d.dataset.mountTarget=n.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),p.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),s.observe(t,{childList:!0})},Se=()=>{wt()};var j="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",xt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),P="data-ws-crm-favicon",se=o=>o.hasAttribute(P),Ae=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return xt.has(e)},K=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ae(r)&&!se(r)&&r.remove()});let e=document.head.querySelector(`link[${P}="1"]`);e?e.href!==j&&(e.href=j):(e=document.createElement("link"),e.setAttribute(P,"1"),e.rel="icon",e.type="image/png",e.href=j,document.head.appendChild(e),p.debug("Favicon installed"));let t=document.head.querySelector(`link[${P}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(P,"apple"),t.rel="apple-touch-icon",t.href=j,document.head.appendChild(t))},Ce=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)K();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),K())},50)}new MutationObserver(r=>{let n=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ae(i)&&!se(i)&&(n=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&se(i)&&(n=!0)});n&&K()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,K(),e>=5&&window.clearInterval(t)},1e3)};var Q="reos-theme-stylesheet",Ue="reos-theme-fonts",kt=()=>{let o=document.getElementById(Ue);o&&o.remove()},Et=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var We=()=>{p.info(`Loaded v${U} (built ${$})`),Ce(),$e(),he(),be(o=>{p.debug("Page handler firing for:",o),ze(),we(),Se(),ye()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",We):We();})();
