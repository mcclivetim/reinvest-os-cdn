/* Wholesaling CRM Customizer v0.5.12 — built 2026-05-16T04:03:52.520Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var w="[wholesaling-crm-customizer]",te="__WS_CRM_DEBUG",oe=()=>!!window[te],c={info(...e){console.log(w,...e)},warn(...e){console.warn(w,...e)},error(...e){console.error(w,...e)},debug(...e){oe()&&console.log(w,"[debug]",...e)}};var F=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},E="",y="other",M=new Set,k=()=>{if(window.location.pathname!==E){E=window.location.pathname,y=F(),c.debug("Page changed:",y,E);for(let e of M)try{e(y)}catch(o){c.error("Subscriber threw:",o)}}},R=e=>(M.add(e),setTimeout(()=>e(y),0),()=>{M.delete(e)}),B=()=>{y=F(),E=window.location.pathname,c.debug("Router init, current page:",y);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),k()},history.replaceState=function(t,r,a){o(t,r,a),k()},window.addEventListener("popstate",k),setInterval(k,1e3)};var _="0.5.12",T="2026-05-16T04:03:52.521Z";var re=/\/contacts\/detail\/([A-Za-z0-9]+)/,ae=/\/v2\/location\/([A-Za-z0-9]+)/,m=()=>{let e=window.location.pathname,o=e.match(re);if(!o)return null;let t=e.match(ae);return{contactId:o[1],locationId:t?t[1]:null}};var v=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,d)=>{let l=a.querySelector(e);if(l){n(l);return}let i,u,g=()=>{f&&f.disconnect(),i!==void 0&&window.clearTimeout(i),u!==void 0&&window.clearInterval(u)},f=new MutationObserver(()=>{let h=a.querySelector(e);h&&(g(),n(h))});f.observe(document.body,{childList:!0,subtree:!0}),u=window.setInterval(()=>{let h=a.querySelector(e);h&&(g(),n(h))},r),i=window.setTimeout(()=>{g(),c.warn(`waitForElement timed out for selector: ${e}`),d(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},b={sm:"4px",md:"6px",lg:"10px",pill:"999px"},p={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},D={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},O=e=>{let o=e==="emerald"?s.emeraldGlow:e==="amber"?s.amberGlow:s.slate,t=e==="emerald"?s.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=e==="emerald"?s.emerald:e==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var x="ws-crm-claim-release-pill",N=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ne=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=x,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?s.emerald:s.amber;return t.style.cssText=O(r),t.innerHTML=`
  ...
  `,t.title=o==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{c.info(`Claim/Release pill clicked for contact ${e}: ${o}`);let n=t.lastElementChild,d=n?.textContent??"";n&&(n.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{n&&(n.textContent=d),t.style.opacity="1",t.disabled=!1},700)}),t},se=async(e,o=1e4)=>{let t=Date.now();for(;Date.now()-t<o;){let r=N(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},H=(e,o)=>{let t=ne({contactId:o,mode:"claim"}),r=document.createElement("span");r.id=`${x}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),e.appendChild(r)},le=async()=>{let e=m();if(!e){document.getElementById(x)?.remove();return}let o=document.getElementById(x);if(!(o&&o.dataset.contactId===e.contactId)){o&&o.remove();try{let t=await v("#record-details-lhs",{timeoutMs:1e4}),r=await se(t),a=m();if(!a||a.contactId!==e.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}H(r,e.contactId),c.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(document.getElementById(x))return;let l=N(t);l&&(H(l,e.contactId),c.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(t,{childList:!0,subtree:!0})}catch(t){c.warn("Could not mount Claim/Release pill:",t)}}},P=()=>{le()};var ie="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ce=()=>{let e=window.WS_CRM_USER_ID;if(e&&/^[A-Za-z0-9]{15,30}$/.test(e))return e;let o=window,t=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let d=JSON.parse(n),l=d.id??d._id;if(l&&/^[A-Za-z0-9]{15,30}$/.test(l))return l}catch{}}}catch{}return null},de=async({contactId:e,locationId:o,status:t,userId:r})=>{let n=await fetch(ie,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:e,location:{id:o},customData:{call_status:t,triggered_by_user_id:r??""}}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},C="ws-crm-contact-actions-bar",pe="ws-crm-call-status-dropdown",G="ws-crm-offer-made-modal",ue=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],me=[".central-panel","[class*='central-panel']"],be=async()=>{for(let e of me)try{let o=await v(e,{timeoutMs:3e3});if(o)return o}catch{}try{return(await v("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},he=e=>{let o=document.createElement("div");o.id=pe,o.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=$,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,ue.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=s.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{c.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let d=t.firstElementChild,l=t.children[1],i=t.children[2];d&&(d.style.background=D[a.color]),l&&(l.textContent=a.label),r.style.display="none";let g=m()?.locationId,f=ce();if(!g){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),l&&(l.textContent=`${a.label} (no tenant!)`),l&&(l.style.color=s.amber);return}if(a.color==="green"&&!f){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),l&&(l.textContent=`${a.label} (no user!)`),l&&(l.style.color=s.amber);return}let h=i?.textContent??"\u25BE";i&&(i.textContent="\u2026"),t.style.opacity="0.75";try{await de({contactId:e,locationId:g,status:a.label,userId:f}),i&&(i.textContent="\u2713"),setTimeout(()=>{i&&(i.textContent=h),t.style.opacity="1"},900)}catch(ee){c.warn("Call Status webhook failed:",ee),i&&(i.textContent="\u2717"),l&&(l.style.color=s.amber),t.style.opacity="1",setTimeout(()=>{i&&(i.textContent=h),l&&(l.style.color=s.bone)},1800)}}),r.appendChild(n)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{o.contains(a.target)||(r.style.display="none")}),o.appendChild(t),o.appendChild(r),o},ge=e=>{document.getElementById(G)?.remove();let o=document.createElement("div");o.id=G,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(t),document.body.appendChild(o);let n=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&n()}),t.querySelector("#ws-offer-cancel")?.addEventListener("click",n),t.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let d=(t.querySelector("#ws-offer-amount")?.value??"").trim(),l=t.querySelector("#ws-offer-expires")?.value??"";if(!d||Number(d)<=0){c.warn("Offer Made submit blocked \u2014 invalid amount");return}c.info(`Offer Made recorded for contact ${e}: $${d}, expires ${l}`),n()}),setTimeout(()=>{t.querySelector("#ws-offer-amount")?.focus()},0)},z=e=>{let o=document.createElement("div");o.id=C,o.dataset.contactId=e,o.style.cssText=`
    ...
    flex-shrink: 0;
  `,o.appendChild(he(e));let t=document.createElement("button");return t.type="button",t.style.cssText=A,t.textContent="Offer Made",t.addEventListener("click",()=>ge(e)),o.appendChild(t),o},fe=async()=>{let e=m();if(!e){document.getElementById(C)?.remove();return}let o=document.getElementById(C);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove();let t=await be();if(!t){c.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=m();if(!r||r.contactId!==e.contactId)return;let a=z(e.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),c.debug(`Mounted contact actions bar for ${e.contactId}`);let n=null;n=new MutationObserver(()=>{let d=document.getElementById(C);if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(!d){let i=z(e.contactId);i.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(i,t.firstChild),c.debug(`Re-mounted actions bar after React wipe for ${e.contactId}`)}}),n.observe(t,{childList:!0})},U=()=>{fe()};var W="reos-theme-stylesheet",q="reos-theme-fonts",ye=()=>{if(document.getElementById(q))return;let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.googleapis.com",document.head.appendChild(e);let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.gstatic.com",o.crossOrigin="anonymous",document.head.appendChild(o);let t=document.createElement("link");t.id=q,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},ve=`
/* ============================================
...
`,xe=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar__text, .hr-avatar__text p, .hr-avatar p",styles:{color:"#0A0D12"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff']",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}}],S=()=>{for(let e of xe){let o;try{o=document.querySelectorAll(e.selector)}catch{continue}o.forEach(t=>{for(let[r,a]of Object.entries(e.styles)){let n=t.style.getPropertyPriority(r),d=t.style.getPropertyValue(r);n==="important"&&d===a||t.style.setProperty(r,a,"important")}})}},we="#1A1F28",ke=26,Ee=31,_e=40,V=new Set,j=new Set,L=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let r=o.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;o.style.setProperty("display","none","important");let a=o.className?.toString()||"<no class>";!j.has(a)&&a!=="<no class>"&&(j.add(a),c.debug(`Hid empty "--" leaf: "${a}"`))})},Y=new Set,Te=()=>{document.querySelectorAll("input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']").forEach(o=>{if(o.closest("[id^='ws-crm-']"))return;let t=o.closest("[class*='form-item'], [class*='field-row'], [class*='form-row'], [class*='field-container'], .hr-form-item");if(t)for(let r of Array.from(t.children)){if(!!(r.tagName==="INPUT"||r.tagName==="SELECT"||r.tagName==="TEXTAREA"||r.querySelector("input, select, textarea, [class*='hr-input'], [class*='hr-select']")))continue;let n=(r.textContent||"").trim();if(n.length===0)continue;let d=r;d.style.setProperty("color","#9098A3","important"),d.style.setProperty("-webkit-text-fill-color","#9098A3","important"),d.querySelectorAll("*").forEach(i=>{i.tagName==="SVG"||i.tagName==="svg"||i.tagName!=="IMG"&&(i.style.setProperty("color","#9098A3","important"),i.style.setProperty("-webkit-text-fill-color","#9098A3","important"))});let l=d.className?.toString()||"<no class>";!Y.has(l)&&l!=="<no class>"&&(Y.add(l),c.debug(`Colored field label "${n.slice(0,30)}": "${l}"`));break}})},I=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let t=window.getComputedStyle(o).backgroundColor;if(!t||t==="rgba(0, 0, 0, 0)"||t==="transparent")return;let r=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),n=parseInt(r[2],10),d=parseInt(r[3],10);if(!(a<ke&&n<Ee&&d<_e))return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>800||i.height>200)return;o.style.setProperty("background-color",we,"important");let u=o.className?.toString()||"<no class>";!V.has(u)&&u!=="<no class>"&&(V.add(u),c.debug(`Coerced dark bg to slate (${i.width.toFixed(0)}x${i.height.toFixed(0)}, rgb(${a},${n},${d})): "${u}"`))})},Z=()=>{let e,o=()=>{e===void 0&&(e=window.setTimeout(()=>{e=void 0,S(),I(),L(),Te()},100))};S(),I(),L(),window.setTimeout(()=>{S(),I(),L()},500),window.setTimeout(()=>{S(),I(),L()},1500),new MutationObserver(()=>{o()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},K=()=>{if(ye(),!document.getElementById(W)){let e=document.createElement("style");e.id=W,e.textContent=ve,document.head.appendChild(e),c.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Z():window.addEventListener("DOMContentLoaded",Z))};var X="ws-crm-customizer-version-badge",J=()=>{if(document.getElementById(X))return;let e=document.createElement("div");e.id=X,e.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,e.textContent=`Customizer v${_}`,e.title=`Built ${T}
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var Q=()=>{c.info(`Loaded v${_} (built ${T})`),K(),B(),R(e=>{c.debug("Page handler firing for:",e),J(),P(),U()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Q):Q();})();
