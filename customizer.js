/* Wholesaling CRM Customizer v0.13.79 — built 2026-05-28T00:38:45.155Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var pe="[wholesaling-crm-customizer]",Ro="__WS_CRM_DEBUG",$o=()=>!!window[Ro],c={info(...o){console.log(pe,...o)},warn(...o){console.warn(pe,...o)},error(...o){console.error(pe,...o)},debug(...o){$o()&&console.log(pe,"[debug]",...o)}};var Lt=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,We=/\/v2\/location\/([A-Za-z0-9]+)/,Go=o=>{let e=o.match(Lt);if(!e)return null;let t=o.match(We);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Uo=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Lt);if(!n)continue;let a=r.match(We)||window.location.pathname.match(We);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Go(window.location.pathname);return o||Uo()};var At=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ue="",je=null,W="other",Ke=new Set,me=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ue)&&!(o!==je))){ue=window.location.pathname,je=o,W=At(),c.debug("Page/context changed:",W,ue,"contact:",o);for(let r of Ke)try{r(W)}catch(n){c.error("Subscriber threw:",n)}}},Ft=o=>(Ke.add(o),setTimeout(()=>o(W),0),()=>{Ke.delete(o)}),Mt=()=>{W=At(),ue=window.location.pathname,je=S()?.contactId??null,c.debug("Router init, current page:",W);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),me()},history.replaceState=function(t,r,n){e(t,r,n),me()},window.addEventListener("popstate",me),setInterval(me,1e3)};var _e="0.13.79",ve="2026-05-28T00:38:45.155Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ye={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},Dt=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Vo=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&Vo.test(o),qo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zo=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Wo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},jo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=qo(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},Ko=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>zo()||Wo()||jo()||Ko()||null;var Nt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Yo=`${Nt}/active-follow-up-get`,Xo=`${Nt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Jo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zo=async o=>{let e=await fetch(Yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Qo=async(o,e)=>{let t=await fetch(Xo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},q=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ot=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,q(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Jo();if(!(!r||r.contactId!==o)){q(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Qo(r,L()),a=n&&n.state&&n.state in Je?n.state:"blue";q(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),q(e,"error"),setTimeout(()=>void ye(e,r),4e3)}}}),e},ye=async(o,e)=>{q(o,"loading");try{let t=await Zo(e),r=t&&t.state&&t.state in Je?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;q(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),q(o,"error")}},er=[".central-panel","[class*='central-panel']"],Xe="ws-crm-contact-actions-bar",tr=async()=>{for(let o of er)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},or=async(o,e)=>{let t=e.querySelector(`#${Xe}`);if(!t)try{t=await C(`#${Xe}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `;let s=document.createElement("div");return s.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,t.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,b.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=l.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=Ye[d.color]),m&&(m.textContent=d.label),s.style.display="none";let g=S()?.locationId,x=L();if(!g){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!x){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let v=h?.textContent??"\u25BE",_=async y=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await vr({contactId:o,locationId:g,status:d.label,userId:x,deadReason:y,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=v),i.style.opacity="1"},900)}catch(k){c.warn("Call Status webhook failed:",k),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=v),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Cr(k=>{_(k)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await yr({contactId:o,tenantId:g})).ok?await _():Ir(()=>{_()},()=>{m&&(m.textContent=y)})}catch(k){c.warn("Appointment sanity check failed; firing anyway:",k),await _()}return}await _()}),s.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},Er="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Tr=async o=>{let e=await fetch(Er,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Sr=(o,e="seller")=>{document.getElementById(zt)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=t?l.emerald:l.amber,i=document.createElement("div");i.id=zt,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let d=new Date,b=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),p=t?`
    <label style="
      display: block;
      font-family: ${f.mono};
      font-size: 10px;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Kt=(o,e)=>{let t=document.createElement("div");t.id=K,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),a=t.querySelector("#ws-mt-offer-cancel"),i=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let s=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",s),e.addEventListener("click",d=>{d.target===e&&we()}),a?.addEventListener("click",()=>we()),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let b=Number(d);if(b<100){n.textContent=`That looks low \u2014 did you mean $${(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{let p=await Rr({oppId:o.oppId,locationId:o.locationId,amount:b,userId:L()});if(!p.ok){n.textContent=p.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1);return}we(),o.onSuccess()}catch(p){c.error("MT Offer Made webhook failed",p),n.textContent=p instanceof Error?p.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1)}})},Gr=o=>{let e=document.createElement("button");return e.id=D,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=ke();!t||!t.locationId||t.oppId!==o||$r({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Ur=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vr=async()=>{for(let o of Ur)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},xe=!1,rt=async()=>{if(!xe){xe=!0;try{await qr()}finally{xe=!1}}},qr=async()=>{let o=ke();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await Vr();if(!t){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=ke();if(!n||n.oppId!==o.oppId)return;let a=Gr(o.oppId),i=document.createElement("span");i.id=`${D}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),zr(o.oppId)},te=null,ot=null,oe=()=>{te?.disconnect(),te=null,ot=null},zr=o=>{if(te&&ot===o)return;oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ot=o,te=new MutationObserver(()=>{let t=ke();if(!t||t.oppId!==o){oe();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}document.getElementById(D)||rt()}),te.observe(e,{childList:!0,subtree:!0}))},et=null,tt,Wr=()=>{et||(et=new MutationObserver(()=>{tt===void 0&&(tt=window.setTimeout(()=>{tt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!xe&&rt()},300))}),et.observe(document.body,{childList:!0,subtree:!0}))},ro=()=>{Wr(),rt()};var jr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",Kr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yr=/\/v2\/location\/([A-Za-z0-9]+)/,Te=()=>{let o=window.location.pathname,e=o.match(Kr);if(!e)return null;let t=o.match(Yr);return{oppId:e[1],locationId:t?t[1]:null}},Xr=async o=>{let e=await fetch(jr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Jr=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Te();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Xr({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,c.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Zr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qr=async()=>{for(let o of Zr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ee=!1,st=async()=>{if(!Ee){Ee=!0;try{await en()}finally{Ee=!1}}},en=async()=>{let o=Te();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Qr();if(!t){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Te();if(!n||n.oppId!==o.oppId)return;let a=Jr(o.oppId),i=document.createElement("span");i.id=`${O}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted Not Interested button on opp ${o.oppId}`),tn(o.oppId)},re=null,it=null,ne=()=>{re?.disconnect(),re=null,it=null},tn=o=>{if(re&&it===o)return;ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(it=o,re=new MutationObserver(()=>{let t=Te();if(!t||t.oppId!==o){ne();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}document.getElementById(O)||st()}),re.observe(e,{childList:!0,subtree:!0}))},nt=null,at,on=()=>{nt||(nt=new MutationObserver(()=>{at===void 0&&(at=window.setTimeout(()=>{at=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Ee&&st()},300))}),nt.observe(document.body,{childList:!0,subtree:!0}))},no=()=>{on(),st()};var rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",ao="ws-crm-reduce-price-modal",nn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,an=/\/v2\/location\/([A-Za-z0-9]+)/,Ie=()=>{let o=window.location.pathname,e=o.match(nn);if(!e)return null;let t=o.match(an);return{oppId:e[1],locationId:t?t[1]:null}},sn=async o=>{let e=await fetch(rn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Se=()=>{document.getElementById(ao)?.remove()},ln=o=>{Se();let e=document.createElement("div");e.id=ao,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Ie();!r||!r.locationId||r.oppId!==o||ln({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,a&&(a.style.background=l.emerald,a.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,a&&(a.style.background=l.amber,a.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},cn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bn=async()=>{for(let o of cn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ce=!1,bt=async()=>{if(!Ce){Ce=!0;try{await hn()}finally{Ce=!1}}},hn=async()=>{let o=Ie();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await bn();if(!t){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Ie();if(!n||n.oppId!==o.oppId)return;let a=dn(o.oppId,o.locationId),i=document.createElement("span");i.id=`${H}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted Reduce Price button on opp ${o.oppId}`),pn(o.oppId)},ae=null,ct=null,ie=()=>{ae?.disconnect(),ae=null,ct=null},pn=o=>{if(ae&&ct===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ct=o,ae=new MutationObserver(()=>{let t=Ie();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||bt()}),ae.observe(e,{childList:!0,subtree:!0}))},lt=null,dt,mn=()=>{lt||(lt=new MutationObserver(()=>{dt===void 0&&(dt=window.setTimeout(()=>{dt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ce&&bt()},300))}),lt.observe(document.body,{childList:!0,subtree:!0}))},io=()=>{mn(),bt()};var lo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-title-co-button",Y="ws-crm-send-to-title-co-wrap",Fe="ws-crm-stc-dropdown",un=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_n=/\/v2\/location\/([A-Za-z0-9]+)/,mt=()=>{let o=window.location.pathname,e=o.match(un);if(!e)return null;let t=o.match(_n);return{oppId:e[1],locationId:t?t[1]:null}},vn=5*60*1e3,co=o=>`ws-crm-stc-cache:${o}`,yn=o=>{try{let e=window.localStorage.getItem(co(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>vn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},gn=(o,e)=>{try{window.localStorage.setItem(co(o),JSON.stringify(e))}catch{}},fn=async(o,e)=>{try{let t=await fetch(lo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(c.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return c.warn("[stc] dry_run fetch failed:",t),null}},wn=async(o,e,t)=>{let r=await fetch(lo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},xn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${o}"`),!1},so=o=>{let e=document.getElementById(o);if(!e){c.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},kn=(o,e)=>{if(e&&xn(e)){window.setTimeout(()=>so(o),300);return}so(o)},N=()=>{document.getElementById(Fe)?.remove()},Le=(o,e,t)=>{N();let r=document.createElement("div");r.id=Fe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${f.sans};
  `;let a=o.length,i=o.filter(u=>u.filled).length,s=i===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${f.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="font-size: 14px; font-weight: 500; color: ${l.bone}; margin-bottom: 6px;">${i} of ${a} ready</div>
    ${e?`<div style="
            font-size: 11px;
            color: ${l.amber};
            margin: 6px 0 4px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(u=>{p[u.group]||(p[u.group]=[]),p[u.group].push(u)});let m=[...b.filter(u=>p[u]),...Object.keys(p).filter(u=>!b.includes(u))];for(let u of m){let g=p[u],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let v=document.createElement("div");v.style.cssText=`
      font-family: ${f.mono};
      font-size: 9px;
    ...
    `,v.textContent=u,x.appendChild(v),g.forEach(_=>{let y=document.createElement("div"),k=!_.filled&&_.navigable&&_.field_id;y.style.cssText=`
        ...
        ${k?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,k&&(y.addEventListener("mouseenter",()=>{y.style.background=l.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",F=>{F.stopPropagation(),_.field_id&&(kn(_.field_id,_.folder),N())}));let T=_.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,w=k?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${w}`,x.appendChild(y)}),r.appendChild(x)}document.body.appendChild(r);let h=u=>{let g=u.target;!r.contains(g)&&!t.contains(g)&&(N(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},P=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,s=l.bone,d,b="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",i=l.steel,s=l.ash,d=l.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;a="transparent",i=l.amber,s=l.amber,d=l.amber,b=`${u} of ${g} fields ready`,p="\u25BE";break}case"sending":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=l.amber,s=l.amber,d=l.amber,b=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=s,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=b),n&&(n.textContent=p)},En=(o,e)=>{let t=document.createElement("button");t.id=z,t.type="button",t.dataset.oppId=o;let r=yn(o),n=r?{status:r.checks.every(v=>v.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${B}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,P(t,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let v=await fn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},P(t,n),c.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),N(),le();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},gn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(Fe)&&Le(y,v.previously_sent_at,t)},s=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),N();try{let _=await wn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t)}catch(_){c.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":s();break;case"incomplete":{document.getElementById(Fe)?N():n.checks&&Le(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,b=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!b){if(Date.now()<u){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}b=!0,p=Date.now();try{await i()}finally{b=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||b)return;let y=Date.now()-p,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},k)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},Tn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sn=async()=>{for(let o of Tn)try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ae=!1,_t=async()=>{if(Ae){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ae=!0;try{await Cn()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{Ae=!1}},Cn=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let o=mt();if(!o||!o.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),N();return}c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let s=A();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(Y)?.remove(),N(),le());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Y)?.remove(),N()),c.debug("[stc] mount:04 calling findMountTarget");let t=await Sn();if(!t){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=mt();if(!n||n.oppId!==o.oppId||!n.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=En(o.oppId,n.locationId),i=document.createElement("span");i.id=Y,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),In(o.oppId)},se=null,ut=null,le=()=>{se?.disconnect(),se=null,ut=null},In=o=>{if(se&&ut===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,se=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),N(),le();return}document.getElementById(z)||_t()}),se.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Ln=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);o&&!e&&!Ae&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},bo=()=>{Ln(),_t()};var An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",po="ldtyB2UXKi9vOp8nLUH7",Dn="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",mo="ws-crm-title-officer-picker-modal",On=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hn=/\/v2\/location\/([A-Za-z0-9]+)/,ft=()=>{let o=window.location.pathname,e=o.match(On);if(!e)return null;let t=o.match(Hn);return{oppId:e[1],locationId:t?t[1]:null}},Et=async o=>{let e=await fetch(An,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ho=async o=>{let e=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Pn=async(o,e)=>{try{let t=await fetch(Mn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:po}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Et({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(t){return c.warn("[title-officer] fetchCurrent failed:",t),null}},Me=null,wt="ws-crm-title-officer-field-link",Nn=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${wt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),delete e.dataset.wsTitleOfficerDecorated}))},vt=!1,uo=async o=>{if(vt)return;let e=_o();if(!e)return;let t=(e.value||"").trim();if(!t){c.info("[title-officer] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){c.info(`[title-officer] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsTitleOfficerDecorated!==t){vt=!0;try{c.info(`[title-officer] tryDecorate: looking up ${t}`);let r=await Et({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){c.warn(`[title-officer] tryDecorate: contact ${t} not found`);return}let n=r.results[0];c.info(`[title-officer] tryDecorate: applying ${n.name} (${n.id})`),xt(n.id,n.name,o)}catch(r){c.warn("[title-officer] tryDecorate lookup failed:",r)}finally{vt=!1}}},Bn=/^TC\s*[-‐–—]\s*Title\s+Officer$/i,_o=()=>{let o=document.querySelector(".crm-opportunities-modal");if(!o)return c.info("[title-officer] findInput: no .crm-opportunities-modal in DOM"),null;let e=o.querySelectorAll("*"),t=[],r=[];for(let s of e){let d=(s.textContent||"").trim();Bn.test(d)?t.push(s):d.length<80&&/Title\s+Officer/i.test(d)&&r.push(d)}if(c.info(`[title-officer] findInput: ${t.length} label candidate(s) (regex-matched)`),t.length===0)return r.length&&c.warn("[title-officer] findInput: no exact match. Near-matches found:",[...new Set(r)].slice(0,5)),null;t.sort((s,d)=>s.querySelectorAll("*").length-d.querySelectorAll("*").length);let a=t[0].parentElement,i=0;for(;a&&i<8;){let s=a.querySelector("input");if(s)return c.info(`[title-officer] findInput: located input ${i} levels up from label`),s;a=a.parentElement,i+=1}return c.warn("[title-officer] findInput: label found but no <input> within 8 ancestors"),null},xt=(o,e,t)=>{let r=_o();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${wt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsTitleOfficerDecorated=o,r.style.color="transparent",r.style.caretColor="transparent",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let s=document.createElement("a");s.className=wt,s.href=`/v2/location/${t}/contacts/detail/${o}`,s.textContent=e,s.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      pointer-events: auto;
      background: transparent;
    `,s.addEventListener("mouseenter",()=>{s.style.textDecoration="underline"}),s.addEventListener("mouseleave",()=>{s.style.textDecoration="none"}),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=s.href}),a.appendChild(s)}}},De=()=>{document.getElementById(mo)?.remove()},Rn=o=>{De();let e=document.createElement("div");e.id=mo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&De()}),a?.addEventListener("click",De);let i,s="",d=async b=>{if(n&&b!==s){if(s=b,!b.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await Et({tenantId:o.locationId,query:b,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=l.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{De(),o.onPick(m)}),n.appendChild(h)})}catch(p){c.error("Title Officer picker search failed",p),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${l.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(b)},250)})},Oe=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),X=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Title Officer",a=l.amber,i=l.bone,s="transparent",d=l.steel,b="pointer";switch(e.status){case"loading":n="Loading Title Officer\u2026",a=l.coolGray,i=l.ash,b="wait";break;case"empty":n="Link Title Officer",a=l.amber;break;case"linked":n=e.contactName?`Title Officer: ${e.contactName}`:"Title Officer: \u2713",a=l.emerald,s=l.emeraldGlow,d=l.emeraldBorder,i=l.emeraldBright;break;case"saving":n="Linking\u2026",a=l.coolGray,i=l.ash,b="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=s,o.style.borderColor=d,o.style.color=i,o.style.cursor=b},$n=(o,e)=>{let t=document.createElement("button");t.id=R,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Pick the Title Officer contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};return X(t,r),(async()=>{let a=await Pn(o,e);a?(r={status:"linked",contactName:a.name},X(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e)):(r={status:"empty"},X(t,r),Me?.oppId===o&&(Me=null),Nn())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},X(t,r);try{let i=[ho({tenantId:e,oppId:o,fieldId:po,value:a.id})];a.companyName&&a.companyName.trim()&&i.push(ho({tenantId:e,oppId:o,fieldId:Dn,value:a.companyName.trim()}));let d=(await Promise.all(i))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},X(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e),c.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(i){c.error("Title Officer link failed",i),r={status:"empty"},X(t,r)}}})}),t},Gn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Un=async()=>{for(let o of Gn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,Tt=async()=>{if(!He){He=!0;try{await Vn()}finally{He=!1}}},Vn=async()=>{let o=ft();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Un();if(!r||await U()!=="Transaction Coordination")return;let a=ft();if(!a||a.oppId!==o.oppId||!a.locationId)return;let i=$n(o.oppId,a.locationId),s=document.createElement("span");s.id=`${R}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(i),r.appendChild(s),c.debug(`Mounted Title Officer picker on opp ${o.oppId}`),qn(o.oppId),uo(a.locationId)},de=null,kt=null,Pe=()=>{de?.disconnect(),de=null,kt=null},qn=o=>{if(de&&kt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,de=new MutationObserver(()=>{let t=ft();if(!t||t.oppId!==o||!t.locationId){Pe();return}document.getElementById(R)||Tt(),uo(t.locationId)}),de.observe(e,{childList:!0,subtree:!0}))},yt=null,gt,zn=()=>{yt||(yt=new MutationObserver(()=>{gt===void 0&&(gt=window.setTimeout(()=>{gt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!He&&Tt()},300))}),yt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{zn(),Tt()};var Ue="reos-theme-stylesheet",Ho="reos-theme-fonts",Wn=()=>{let o=document.getElementById(Ho);o&&o.remove()},jn=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},Bo=()=>{c.info(`Loaded v${_e} (built ${ve})`),M("mountVersionBadge (initial)",qe),M("mountFavicon",to),M("mountThemeStylesheet",Po),M("initPageRouter",Mt),c.info("[main] registering onPageChange subscriber"),Ft(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",qe),M("mountClaimReleaseToggle",Ut),M("mountContactActionsBar",Qt),M("mountActiveFollowUpButton",Bt),M("mountMtOfferMadeButton",ro),M("mountNotInterestedButton",no),M("mountReducePriceButton",io),M("mountSendToTitleCoButton",bo),M("mountTitleOfficerPickerButton",vo)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Bo):Bo();})();
