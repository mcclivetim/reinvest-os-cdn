...
`;var sd=/^[A-Za-z0-9]{15,30}$/,vt=t=>typeof t=="string"&&sd.test(t),Ma=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ld=()=>{let t=window.WS_CRM_USER_ID;return vt(t)?t:null},dd=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(vt(o))return o;return null},cd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ma(e);if(!o)return null;let r=o.uid;if(vt(r))return r;let a=o.claims;if(a&&vt(a.user_id))return a.user_id}catch{}return null},pd=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(vt(a))return a}catch{}}}catch{}return null},M=()=>ld()||dd()||cd()||pd()||null,bd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ma(e);return o?o.claims??o:null}catch{return null}},je=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:bd()?.type==="agency"};var Pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",md=`${Pa}/active-follow-up-get`,hd=`${Pa}/active-follow-up-set`,De="ws-crm-active-follow-up-button",kr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ud=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},vd=async t=>{let e=await fetch(md,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},_d=async(t,e)=>{let o=await fetch(hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},He=(t,e)=>{let o=kr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Oa=t=>{let e=document.createElement("button");return e.type="button",e.id=De,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,x=y=>{let T=y.find(L=>L.code===s.stateCode);return`
  ...
  `,r.appendChild(d);let p=["TC","ACQ","MT","DISPO","Property"],b={};t.forEach(_=>{b[_.group]||(b[_.group]=[]),b[_.group].push(_)});let h=[...p.filter(_=>b[_]),...Object.keys(b).filter(_=>!p.includes(_))];for(let _ of h){let x=b[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,f.textContent=_,k.appendChild(f),x.forEach(g=>{let w=document.createElement("div"),C=!g.filled&&g.navigable&&g.field_id;w.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
  ...
  `,me(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await nb(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},me(o,a);return}if(f.rate_limited){_=Date.now()+m,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},me(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},me(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let g=f.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Ro.add(t),document.getElementById(ke)?.remove(),document.getElementById(Be)?.remove(),pe(),Ft();return}let w=f.checks;if(a.checks&&a.checks.length===f.checks.length){let S=new Set;w=f.checks.map((E,y)=>a.checks[y]?.filled&&!E.filled?i.has(E.label)?E:(S.add(E.label),{...E,filled:!0}):E),i=S}else i=new Set;a={status:w.every(S=>S.filled)?"ready":"incomplete",checks:w,previouslySentAt:f.previously_sent_at??null},rb(t,{checks:w,previously_sent_at:f.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),me(o,a),document.getElementById(Po)&&Do(w,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},me(o,a),pe();try{let g=await ab(t,e,f);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},me(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},me(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},me(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},me(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Po)?pe():a.checks&&Do(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),h=1e4,m=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let C=Date.now()-b,S=Math.max(1500,h-C);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=C=>{let S=C.detail;if(!S||S.oppId!==t)return;Bi(t);let E=0,y=()=>{if(p&&E<8){E+=1,window.setTimeout(y,500);return}x()};y()};window.addEventListener(yn,g);let w=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.removeEventListener(yn,g),window.clearInterval(w))},5e3)}return o},db=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cb=async()=>{for(let t of db)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ro=new Set,Hi=null,pb=t=>{t&&t!==Hi&&(Ro.clear(),Hi=t)},Ho=!1,wn=async()=>{if(Ho){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ho=!0;try{await bb()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{Ho=!1}},bb=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Bo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ke)?.remove(),document.getElementById(Be)?.remove(),pe();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),pb(t.oppId),Ro.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ke)?.remove(),document.getElementById(Be)?.remove(),pe();return}let e=document.getElementById(ke);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Be)?.remove(),pe(),Ft());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Be)?.remove(),pe()),c.debug("[stc] mount:04 calling findMountTarget");let o=await cb();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Bo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=lb(t.oppId,a.locationId),s=document.createElement("span");s.id=Be,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),mb(t.oppId)},Rt=null,fn=null,Ft=()=>{Rt?.disconnect(),Rt=null,fn=null},mb=t=>{if(Rt&&fn===t)return;Ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(fn=t,Rt=new MutationObserver(()=>{let o=Bo();if(!o||o.oppId!==t){Ft();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ke)?.remove(),document.getElementById(Be)?.remove(),pe(),Ft();return}document.getElementById(ke)||wn()}),Rt.observe(e,{childList:!0,subtree:!0}))},_n=null,gn,hb=()=>{_n||(_n=new MutationObserver(()=>{gn===void 0&&(gn=window.setTimeout(()=>{gn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ke);if(t&&!e&&!Ho){let o=Bo();if(o&&Ro.has(o.oppId))return;wn()}},300))}),_n.observe(document.body,{childList:!0,subtree:!0}))},Fi=()=>{hb(),wn()};var Tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ub=`${Tn}/tc/welcome-call-prefill`,vb=`${Tn}/tc/welcome-call-save`,_b=`${Tn}/tc/order-lockbox`,Nt="ws-crm-welcome-call-overlay",gb=["Regular Contract","Subject To","Seller Finance","Novation"],yb=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],fb=["Gas","Electric","Propane","Oil"],xb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],wb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Ee=["Yes","No"],kb=["Yes","No","Unknown"],Eb=["Professional Photographer","Seller","Tenant"],Tb=["Month-to-Month","Annual"],Ni=["Current","Behind"],Sb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],he=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),No=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,qi="margin-bottom:12px;",Ui=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Cb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,zi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=zi(o);return`<select id="${t}" style="${No}"><option value=""></option>${e.map(a=>`<option ${r!==""&&zi(a)===r?"selected":""}>${he(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${he(e)}" placeholder="${he(o)}" style="${No}">`,Ab=(t,e)=>`<textarea id="${t}" rows="3" style="${No}resize:vertical;">${he(e)}</textarea>`,Lb=(t,e)=>`<input id="${t}" type="date" value="${he(e)}" style="${No}">`,D=(t,e)=>`<div style="${qi}"><label style="${Ui}">${he(t)}</label>${e}</div>`,kn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Sb.map(r=>`<label style="${Cb}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ge=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${he(t)}</div>`,ot=()=>{document.getElementById(Nt)?.remove()},Re=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$b=t=>{let e=t.tenant||{};return`
    ${ge("Identifiers")}
    ...
    ${ge("Property")}
    ${D("Property Type",j("wc-property_type",xb,t.property_type))}
    ...
    ${ge("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",wb,t.occupancy))}
  ...
  `,e.addEventListener("click",()=>{Zo(t)}),Xo(e),setTimeout(()=>Xo(e),200),setTimeout(()=>Xo(e),800),window.addEventListener("resize",()=>Xo(e)),e},da=!1,wh=()=>{if(!da){da=!0;try{let t=al();if(!t){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}let e=document.getElementById($e);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${$e}-floater`)?.remove();let o=document.createElement("div");o.id=`${$e}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=xh(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{da=!1}}},il=()=>{if(!al()){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}wh()};var kh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ma="ws-crm-prepare-contract-button",sl="ws-crm-prepare-contract-menu",ve="ws-crm-prepare-contract-modal",ll="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",hl=()=>{if(document.getElementById(ll))return;let t=document.createElement("style");t.id=ll,t.textContent=`
  ...
  `,P=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${ue(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${y}">
        ...
        <select id="ws-pc-occupancy-at-close" style="${L}">${P(x)}</select>
      </div>
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-emd-due-date" type="date" value="${ue(w)}" style="${T}" />
      </div>
      <div style="${q}">
