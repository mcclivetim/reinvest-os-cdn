/* Wholesaling CRM Customizer v0.7.35 — built 2026-05-18T17:18:53.264Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var D="[wholesaling-crm-customizer]",Tt="__WS_CRM_DEBUG",Lt=()=>!!window[Tt],p={info(...o){console.log(D,...o)},warn(...o){console.warn(D,...o)},error(...o){console.error(D,...o)},debug(...o){Lt()&&console.log(D,"[debug]",...o)}};var Y=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},H="",T="other",W=new Set,B=()=>{if(window.location.pathname!==H){H=window.location.pathname,T=Y(),p.debug("Page changed:",T,H);for(let o of W)try{o(T)}catch(e){p.error("Subscriber threw:",e)}}},Z=o=>(W.add(o),setTimeout(()=>o(T),0),()=>{W.delete(o)}),J=()=>{T=Y(),H=window.location.pathname,p.debug("Router init, current page:",T);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,a){o(t,r,a),B()},history.replaceState=function(t,r,a){e(t,r,a),B()},window.addEventListener("popstate",B),setInterval(B,1e3)};var $="0.7.35",N="2026-05-18T17:18:53.264Z";var Ft=/\/contacts\/detail\/([A-Za-z0-9]+)/,At=/\/v2\/location\/([A-Za-z0-9]+)/,_=()=>{let o=window.location.pathname,e=o.match(Ft);if(!e)return null;let t=o.match(At);return{contactId:e[1],locationId:t?t[1]:null}};var L=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,l)=>{let n=a.querySelector(o);if(n){s(n);return}let c,d,m=()=>{h&&h.disconnect(),c!==void 0&&window.clearTimeout(c),d!==void 0&&window.clearInterval(d)},h=new MutationObserver(()=>{let v=a.querySelector(o);v&&(m(),s(v))});h.observe(document.body,{childList:!0,subtree:!0}),d=window.setInterval(()=>{let v=a.querySelector(o);v&&(m(),s(v))},r),c=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${o}`),l(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},w={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},V={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},X=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,A=`
  ...
  flex-shrink: 0;
`;var I="ws-crm-claim-release-pill",tt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},It=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=I,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",a=e==="claim"?i.emerald:i.amber;return t.style.cssText=X(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{p.info(`Claim/Release pill clicked for contact ${o}: ${e}`);let s=t.lastElementChild,l=s?.textContent??"";s&&(s.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{s&&(s.textContent=l),t.style.opacity="1",t.disabled=!1},700)}),t},Mt=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=tt(o);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Q=(o,e)=>{let t=It({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},Dt=async()=>{let o=_();if(!o){document.getElementById(I)?.remove();return}let e=document.getElementById(I);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await L("#record-details-lhs",{timeoutMs:1e4}),r=await Mt(t),a=_();if(!a||a.contactId!==o.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Q(r,o.contactId),p.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let s=null;s=new MutationObserver(async()=>{if(!(_()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(I))return;let n=tt(t);n&&(Q(n,o.contactId),p.debug("Re-mounted Claim/Release pill after React wipe"))}),s.observe(t,{childList:!0,subtree:!0})}catch(t){p.warn("Could not mount Claim/Release pill:",t)}}},et=()=>{Dt()};var Bt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var Ht="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",$t=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),s=a.id??a._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}for(let a of["tokenUser","currentUser","ghl_user"]){let s=localStorage.getItem(a);if(s)try{let l=JSON.parse(s),n=l.id??l._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}catch{}}}catch{}return null},Nt=async({contactId:o,locationId:e,status:t,userId:r,deadReason:a})=>{let s={call_status:t,triggered_by_user_id:r??""};a&&(s.dead_reason=a);let n=await fetch(Bt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:e},customData:s}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},Pt=async({contactId:o,tenantId:e})=>{let t=await fetch(Ht,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var P="ws-crm-contact-actions-bar",Rt="ws-crm-call-status-dropdown",ot="ws-crm-offer-made-modal",Ot=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Gt=[".central-panel","[class*='central-panel']"],zt=async()=>{for(let o of Gt)try{let e=await L(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ut=o=>{let e=document.createElement("div");e.id=Rt,e.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=A,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,Ot.forEach(a=>{let s=document.createElement("button");s.type="button",s.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,s.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{p.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${o}`);let l=t.firstElementChild,n=t.children[1],c=t.children[2];l&&(l.style.background=V[a.color]),n&&(n.textContent=a.label),r.style.display="none";let m=_()?.locationId,h=$t();if(!m){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),n&&(n.textContent=`${a.label} (no tenant!)`),n&&(n.style.color=i.amber);return}if(a.color==="green"&&!h){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),n&&(n.textContent=`${a.label} (no user!)`),n&&(n.style.color=i.amber);return}let v=c?.textContent??"\u25BE",x=async y=>{c&&(c.textContent="\u2026"),t.style.opacity="0.75";try{await Nt({contactId:o,locationId:m,status:a.label,userId:h,deadReason:y}),c&&(c.textContent="\u2713"),setTimeout(()=>{c&&(c.textContent=v),t.style.opacity="1"},900)}catch(b){p.warn("Call Status webhook failed:",b),c&&(c.textContent="\u2717"),n&&(n.style.color=i.amber),t.style.opacity="1",setTimeout(()=>{c&&(c.textContent=v),n&&(n.style.color=i.bone)},1800)}};if(a.value==="dead-deal"){let y=n?.textContent??"";Wt(b=>{x(b)},()=>{n&&(n.textContent=y)});return}if(a.value==="appointment-booked"){let y=n?.textContent??"";try{(await Pt({contactId:o,tenantId:m})).ok?await x():Vt(()=>{x()},()=>{n&&(n.textContent=y)})}catch(b){p.warn("Appointment sanity check failed; firing anyway:",b),await x()}return}await x()}),r.appendChild(s)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{e.contains(a.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},qt=o=>{document.getElementById(ot)?.remove();let e=document.createElement("div");e.id=ot,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),s=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),o()});let l=n=>{n.key==="Escape"&&(document.removeEventListener("keydown",l),s())};document.addEventListener("keydown",l)},nt=o=>{let e=document.createElement("div");e.id=P,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    flex-shrink: 0;
  `,e.appendChild(Ut(o));let t=document.createElement("button");return t.type="button",t.style.cssText=F,t.textContent="Offer Made",t.addEventListener("click",()=>qt(o)),e.appendChild(t),e},jt=async()=>{let o=_();if(!o){document.getElementById(P)?.remove();return}let e=document.getElementById(P);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await zt();if(!t){p.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=_();if(!r||r.contactId!==o.contactId)return;let a=nt(o.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),p.debug(`Mounted contact actions bar for ${o.contactId}`);let s=null;s=new MutationObserver(()=>{let l=document.getElementById(P);if(!(_()?.contactId===o.contactId)){s?.disconnect();return}if(!l){let c=nt(o.contactId);c.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(c,t.firstChild),p.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),s.observe(t,{childList:!0})},st=()=>{jt()};var R="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Kt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),M="data-ws-crm-favicon",j=o=>o.hasAttribute(M),lt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Kt.has(e)},O=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{lt(r)&&!j(r)&&r.remove()});let e=document.head.querySelector(`link[${M}="1"]`);e?e.href!==R&&(e.href=R):(e=document.createElement("link"),e.setAttribute(M,"1"),e.rel="icon",e.type="image/png",e.href=R,document.head.appendChild(e),p.debug("Favicon installed"));let t=document.head.querySelector(`link[${M}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(M,"apple"),t.rel="apple-touch-icon",t.href=R,document.head.appendChild(t))},it=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)O();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),O())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(l=>{l instanceof HTMLLinkElement&&lt(l)&&!j(l)&&(a=!0)}),s.removedNodes.forEach(l=>{l instanceof HTMLLinkElement&&j(l)&&(a=!0)});a&&O()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,O(),e>=5&&window.clearInterval(t)},1e3)};var ct="reos-theme-stylesheet",dt="reos-theme-fonts",Yt=()=>{if(document.getElementById(dt))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com",document.head.appendChild(o);let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.gstatic.com",e.crossOrigin="anonymous",document.head.appendChild(e);let t=document.createElement("link");t.id=dt,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},Zt=`
/* ============================================
...
`,Jt=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .hr-base-select-menu, .hr-popselect-menu, .hr-popover",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}}],G=()=>{for(let o of Jt){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,a]of Object.entries(o.styles)){let s=t.style.getPropertyPriority(r),l=t.style.getPropertyValue(r);s==="important"&&l===a||t.style.setProperty(r,a,"important")}})}},K="#1A1F28",Xt=26,Qt=31,te=40,pt=new Set,mt=new Set,z=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!mt.has(a)&&a!=="<no class>"&&(mt.add(a),p.debug(`Hid empty "--" leaf: "${a}"`))})},ht=new Set,ee=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g"||e.querySelector("svg, img")||(e.textContent||"").trim().length===0||window.getComputedStyle(e).color!=="rgb(255, 255, 255)")return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.className?.toString()||"<no class>";!ht.has(n)&&n!=="<no class>"&&(ht.add(n),p.debug(`Remapped pure-white text -> bone: "${n}"`))})},bt=new Set,oe=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(e=>{e.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar"))return;let s=window.getComputedStyle(r),l=s.backgroundColor,n=s.backgroundImage||"",c=!1;if(n!=="none"&&n.includes("gradient"))c=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let u=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(u&&parseFloat(u[1])<.6)return;let g=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let E=parseInt(g[1],10),C=parseInt(g[2],10),q=parseInt(g[3],10);(E>=60||C>=60||q>=60)&&(E>230&&C>230&&q>230||(E>=80||C>=80||q>=80)&&(c=!0))}}if(!c)return;let m=(r.textContent||"").trim(),h=a,v=Array.from(r.querySelectorAll("*")).map(u=>(u.className?.toString()||"").toLowerCase()).join(" "),x=m.toLowerCase()==="ask ai"||h.includes("ai-button")||h.includes("ask-ai")||h.includes("askai"),y=h.includes("bg-clip-text")||h.includes("text-transparent")||v.includes("bg-clip-text")||v.includes("text-transparent"),b=Array.from(r.querySelectorAll("*")).some(u=>{let g=window.getComputedStyle(u),E=g.getPropertyValue("-webkit-background-clip")||"",C=g.getPropertyValue("background-clip")||"";return E.includes("text")||C.includes("text")});if(x||y||b){let u=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=E=>{u.forEach(C=>E.style.removeProperty(C))};g(r),r.querySelectorAll("*").forEach(g);return}let k="#12161D";r.style.setProperty("color",k,"important"),r.querySelectorAll("*").forEach(u=>{let g=u.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(u.style.setProperty("fill",k,"important"),u.style.setProperty("stroke",k,"important"),u.style.setProperty("color",k,"important")):(u.style.setProperty("color",k,"important"),u.style.setProperty("-webkit-text-fill-color",k,"important"))});let S=r.className?.toString()||"<no class>";!bt.has(S)&&S!=="<no class>"&&(bt.add(S),p.debug(`Darkened SVG icons on colored button: "${S}"`))})})},ut=new Set,re=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0||t.width<20||t.width>64||t.height<20||t.height>64)return;let r=t.top+t.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(n=>{let c=n;if(c.closest("[id^='ws-crm-']"))return;let d=n.getBoundingClientRect();if(d.width===0||d.width>28||d.height>28)return;let m=d.left<t.right&&d.right>t.left,h=d.top<t.bottom&&d.bottom>t.top;if(!(m&&h)||d.top+d.height/2<r)return;let x=d.width*d.height/(t.width*t.height);if(x>.55)return;let y=c,b=c.parentElement,k=0;for(;b&&b!==e&&k<3;){let u=b.getBoundingClientRect();if(u.width>0&&u.width<=30&&u.height<=30)y=b;else break;b=b.parentElement,k++}y.style.setProperty("transform","translateY(11px)","important");let S=(y.className?.toString()||"")+" "+y.tagName;ut.has(S)||(ut.add(S),p.debug(`Dropped activity badge 11px (${d.width.toFixed(0)}x${d.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${S}"`))})})},ae="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",ne=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",ae,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},gt=new Set,se=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let l=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!l)return;let n=parseInt(l[1],10),c=parseInt(l[2],10),d=parseInt(l[3],10);if(!(n>200&&c>200&&d>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!gt.has(m)&&m!=="<no class>"&&(gt.add(m),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${n},${c},${d})): "${m}"`))})})},yt=new Set,le=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let a=(t.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let l=t.getBoundingClientRect();if(l.width>0&&l.height>0&&l.width<=400&&l.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let n=t.className?.toString()||"<no class>";!yt.has(n)&&n!=="<no class>"&&(yt.add(n),p.debug(`Painted Ask AI wrapper graphite: "${n}"`))}}t=t.parentElement,r++}})},ft=new Set,ie=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let l=parseInt(s.zIndex,10);if(!isFinite(l)||l<50)return;let n=a.getBoundingClientRect();n.width<240||n.height<120||n.width>1500||n.height>900||t.push(a)}),[...o,...t].forEach(a=>{a.querySelectorAll("*").forEach(l=>{if(l.id?.startsWith("ws-crm-")||l.closest("[id^='ws-crm-']"))return;let n=(l.className?.toString()||"").toLowerCase();if(n.includes("avatar")||n.includes("notification-dot")||n.includes("indicator")||n.includes("ai-button")||n.includes("ask-ai")||n.includes("bg-clip-text")||n.includes("text-transparent")||l.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let c=window.getComputedStyle(l).backgroundColor;if(!c||c==="rgba(0, 0, 0, 0)"||c==="transparent")return;let d=c.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!d)return;let m=parseInt(d[1],10),h=parseInt(d[2],10),v=parseInt(d[3],10);if(!(m>200&&h>200&&v>200))return;let y=l.getBoundingClientRect();if(y.width<24||y.height<16||y.width>1400)return;l.style.setProperty("background-color","#12161D","important"),l.style.setProperty("color","#EDEEF0","important");let b=l.className?.toString()||"<no class>";!ft.has(b)&&b!=="<no class>"&&(ft.add(b),p.debug(`Coerced light bg (${y.width.toFixed(0)}x${y.height.toFixed(0)}, rgb(${m},${h},${v})): "${b}"`))})})},vt=new Set,ce=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']")||t.matches("[role='heading']")||t.closest("[role='heading']")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']"))return;let a=t,s=null;for(let m=0;m<4&&a;m++){let h=a.nextElementSibling;if(h&&(h.matches(o)||h.querySelector(o)!==null)){s=h;break}a=a.parentElement}if(!s)return;let l=t.getBoundingClientRect();if(l.width===0||l.height===0||l.width>400||l.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let n=s,c=n.getBoundingClientRect();c.width>0&&c.width<=800&&c.height>0&&c.height<=100&&(n.style.setProperty("background-color",K,"important"),n.style.setProperty("border-color","#252C36","important"),n.style.setProperty("border-style","solid","important"),n.style.setProperty("border-width","1px","important"),n.style.setProperty("border-radius","4px","important"));let d=t.className?.toString()||"<no class>";!vt.has(d)&&d!=="<no class>"&&(vt.add(d),p.debug(`Colored field label "${r.slice(0,30)}": "${d}"`))})},wt=new Set,de=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let l=Math.min(r.width,r.height),n=Math.max(16,Math.min(24,Math.round(l*.6)));e.style.setProperty("font-size",`${n}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(d=>{d.tagName==="svg"||d.tagName==="SVG"||d.tagName!=="IMG"&&(d.style.setProperty("font-size",`${n}px`,"important"),d.style.setProperty("line-height","1","important"),d.style.setProperty("text-align","center","important"))});let c=e.className?.toString()||"<no class>";!wt.has(c)&&c!=="<no class>"&&(wt.add(c),p.debug(`Resized avatar text to ${n}px (circle ${l.toFixed(0)}px): "${c}"`))})},xt=new Set,pe=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;e.style.setProperty("background-color",K,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=e.className?.toString()||"<no class>";!xt.has(r)&&r!=="<no class>"&&(xt.add(r),p.debug(`Forced input slate bg: "${r}"`))})},U=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']"))return;let t=window.getComputedStyle(e).backgroundColor;if(!t||t==="rgba(0, 0, 0, 0)"||t==="transparent")return;let r=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),s=parseInt(r[2],10),l=parseInt(r[3],10);if(!(a<Xt&&s<Qt&&l<te))return;let c=e.getBoundingClientRect();if(c.width===0||c.height===0||c.width>800||c.height>200)return;e.style.setProperty("background-color",K,"important");let d=e.className?.toString()||"<no class>";!pt.has(d)&&d!=="<no class>"&&(pt.add(d),p.debug(`Coerced dark bg to slate (${c.width.toFixed(0)}x${c.height.toFixed(0)}, rgb(${a},${s},${l})): "${d}"`))})},kt=()=>{let o,e=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,G(),pe(),U(),z(),ce(),ie(),le(),se(),ne(),oe(),de(),re(),ee()},100))};G(),U(),z(),window.setTimeout(()=>{G(),U(),z()},500),window.setTimeout(()=>{G(),U(),z()},1500),new MutationObserver(()=>{e()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Et=()=>{if(Yt(),!document.getElementById(ct)){let o=document.createElement("style");o.id=ct,o.textContent=Zt,document.head.appendChild(o),p.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?kt():window.addEventListener("DOMContentLoaded",kt))};var _t="ws-crm-customizer-version-badge",St=()=>{if(document.getElementById(_t))return;let o=document.createElement("div");o.id=_t,o.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,o.textContent=`Customizer v${$}`,o.title=`Built ${N}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Ct=()=>{p.info(`Loaded v${$} (built ${N})`),it(),Et(),J(),Z(o=>{p.debug("Page handler firing for:",o),St(),et(),st()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ct):Ct();})();
