...
`;var Za=/^[A-Za-z0-9]{15,30}$/,Ne=t=>typeof t=="string"&&Za.test(t),Vr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ei=()=>{let t=window.WS_CRM_USER_ID;return Ne(t)?t:null},ti=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ne(o))return o;return null},oi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Vr(e);if(!o)return null;let r=o.uid;if(Ne(r))return r;let a=o.claims;if(a&&Ne(a.user_id))return a.user_id}catch{}return null},ri=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Ne(a))return a}catch{}}}catch{}return null},I=()=>ei()||ti()||oi()||ri()||null,ni=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Vr(e);return o?o.claims??o:null}catch{return null}},Wr=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ni()?.type==="agency"};var Jr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ai=`${Jr}/active-follow-up-get`,ii=`${Jr}/active-follow-up-set`,he="ws-crm-active-follow-up-button",Ao={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},si=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},li=async t=>{let e=await fetch(ai,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},di=async(t,e)=>{let o=await fetch(ii,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},me=(t,e)=>{let o=Ao[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},jr=t=>{let e=document.createElement("button");return e.type="button",e.id=he,e.dataset.contactId=t,e.style.cssText=`
  ...
  `;let r={status:"loading"};pe(o,r);let a=ra(t);return a&&(r={status:"linked",contactName:a.contactName},pe(o,r),ye={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await rd(t,e);s?(r={status:"linked",contactName:s.name},pe(o,r),ye={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},fr(s.id,s.name,e)):a||(r={status:"empty"},pe(o,r),ye?.oppId===t&&(ye=null),id(),ad(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ld({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},pe(o,r);try{let l=[Zn({tenantId:e,oppId:t,fieldKey:ta,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Zn({tenantId:e,oppId:t,fieldKey:ed,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},pe(o,r),ye={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},na(t,s.id,s.name),fr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},pe(o,r)}}})}),o},cd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],pd=async()=>{for(let t of cd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},lt=!1,to=async()=>{if(!lt){lt=!0;try{await bd()}finally{lt=!1}}},bd=async()=>{let t=ct();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),eo();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),eo());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await pd();if(!r||!(ra(t.oppId)!==null||ye!==null&&ye.oppId===t.oppId)&&await N()!=="Transaction Coordination")return;let i=ct();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=dd(t.oppId,i.locationId),l=document.createElement("span");l.id=`${re}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
