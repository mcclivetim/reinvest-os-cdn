...
/* Row hover. GHL ships
   ...
   :not(#__reos_never_id) for (0,1,7,2). Slate hover bg so the row
   reads as 'highlighted' against graphite without flashing white. */
