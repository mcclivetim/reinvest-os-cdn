...
/* 18c-flicker (v0.8.15): kill the white flash on accordion
   expand/collapse. Tim flagged that clicking the chevron on
   Opportunities / Workflows / Client portal sections briefly
   flashes white before settling on graphite.

   Cause: Vue's <transition> wrapper on the accordion expand
   adds transition-colors during enter/leave. The newly-rendered
   .hr-collapse-item__content-inner starts at Vue's default
   (white) for a frame before applyForceRules fires (~16-100ms
   later) and paints graphite inline.

   Fix: kill transition + animation on the entire hr-collapse
   family. The accordion still expands (display swap) but the
   bg color can't animate through white \u2014 it snaps directly to
   graphite. Also paint graphite via CSS preemptively so the
   first render is dark even before FORCE_RULE runs. */
html body .hr-collapse,
html body .hr-collapse-item,
html body .hr-collapse-item__header,
html body .hr-collapse-item__header-main,
html body .hr-collapse-item__header-extra,
html body .hr-collapse-item__content,
html body .hr-collapse-item__content-inner,
html body .hr-collapse-item__content-wrap,
html body .hr-collapse-item__content-wrapper,
