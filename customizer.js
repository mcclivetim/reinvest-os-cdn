...
`;var Ad=/^[A-Za-z0-9]{15,30}$/,ft=e=>typeof e=="string"&&Ad.test(e),Ua=e=>{try{let t=e.split(".");if(t.length!==3)return null;let o=t[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},$d=()=>{let e=window.WS_CRM_USER_ID;return ft(e)?e:null},Ld=()=>{let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let o of t)if(ft(o))return o;return null},Id=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Ua(t);if(!o)return null;let r=o.uid;if(ft(r))return r;let a=o.claims;if(a&&ft(a.user_id))return a.user_id}catch{}return null},Md=()=>{try{let e=["user","tokenUser","currentUser","ghl_user"];for(let t of e){let o=localStorage.getItem(t);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ft(a))return a}catch{}}}catch{}return null},M=()=>$d()||Id()||Ld()||Md()||null,Od=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Ua(t);return o?o.claims??o:null}catch{return null}},Ze=()=>{let e=window.WS_CRM_FORCE_AGENCY;return typeof e=="boolean"?e:Od()?.type==="agency"};var Ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Dd=`${Ka}/active-follow-up-get`,Hd=`${Ka}/active-follow-up-set`,Ne="ws-crm-active-follow-up-button",$r={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Pd=()=>{let e=H();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},Bd=async e=>{let t=await fetch(Dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId}),credentials:"omit"});if(!t.ok)throw new Error(`Get webhook returned ${t.status} ${t.statusText}`);return await t.json()},Rd=async(e,t)=>{let o=await fetch(Hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,triggered_by_user_id:t??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ze=(e,t)=>{let o=$r[t];e.dataset.state=t,e.disabled=!o.clickable,e.style.cursor=o.clickable?"pointer":"default",e.style.background=o.bg,e.style.borderColor=o.border,e.style.color=o.color;let r=e.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=e.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Va=e=>{let t=document.createElement("button");return t.type="button",t.id=Ne,t.dataset.contactId=e,t.style.cssText=`
  ...
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},_c='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',gc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',yc="nav.w-13, nav[class*='w-13']",fc=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ii="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",xc="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",wc=async()=>{try{return await $(yc,{timeoutMs:2500})}catch{return null}},kc=async()=>{try{return await $(fc,{timeoutMs:2500})}catch{return null}},Ec=e=>e.querySelector("div[class*='bg-contacts-panel']")??null,Fr=async(e,t)=>await(await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"})).json(),ue=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:13px;outline:none;margin-bottom:10px;`,ve=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,Nr=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${u.sans};font-size:13px;font-weight:600;`,si=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${u.sans};font-size:13px;`,Tc=(e,t)=>{let o=document.createElement("div");return o.id=Br,o.dataset.contactId=t,o.style.cssText=`
    width: 100%; height: 100%; background: ${n.graphite};
    border: 1px solid ${n.steel}; border-radius: ${v.lg};
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Cc(e,t,()=>zr(e,t))}),o},zr=async(e,t)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Fr(bc,{tenant_id:e,contact_id:t});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${he(r.error||"Failed to load properties")}</div>`;return}Sc(o,r.properties||[],e,t)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${he(r.message)}</div>`}},Sc=(e,t,o,r)=>{if(!t.length){e.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}e.innerHTML=t.map(a=>{let i=a.has_acq_opp?`<span style="font-size:10px;color:${n.emeraldBright};border:1px solid ${n.emeraldBorder};border-radius:${v.sm};padding:1px 6px;">Deal &#10003;</span>`:`<span style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 6px;">No deal</span>`,s=(a.roles||[]).map(l=>l==="seller_1"?"Seller 1":l==="seller_2"?"Seller 2":l==="tenant_contact"?"Tenant":l).join(", ");return`
    ...
    <select id="wp-type" style="${ue}">
      ...
      ${vc.map(s=>`<option value="${he(s)}">${he(s)}</option>`).join("")}
    </select>
  ...
  `;let s=i.querySelector("#wpp-err");i.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#wpp-save")?.addEventListener("click",async()=>{let l=i.querySelector("#wpp-role")?.value||"seller_2",d=y=>(i.querySelector(y)?.value||"").trim(),p=d("#wpp-first"),m=d("#wpp-last"),h=d("#wpp-phone"),b=d("#wpp-email");if(!p&&!m){s&&(s.textContent="Enter at least a first or last name.");return}let _=i.querySelector("#wpp-save");_&&(_.disabled=!0,_.textContent="Adding\u2026"),s&&(s.textContent="");try{let y=await Fr(uc,{tenant_id:e,property_record_id:t,role:l,new_contact:{firstName:p,lastName:m,phone:h||void 0,email:b||void 0}});if(!y.ok){s&&(s.textContent=y.error||"Failed to add person."),_&&(_.disabled=!1,_.textContent="Add person");return}a.remove(),ai("Person added \u2713"),r()}catch(y){s&&(s.textContent=`Network error: ${y.message}`),_&&(_.disabled=!1,_.textContent="Add person")}}),setTimeout(()=>i.querySelector("#wpp-first")?.focus(),0)},go=!1,se=null,Pr=!1,St=null,di=(e,t)=>{go=t;let o=Ec(e.panelArea);t?(e.iconBtn.className=xc,e.iconBtn.dataset.active="true",o&&(e.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),e.panel.style.display="flex",zr(e.tenantId,e.contactId)):(e.iconBtn.className=ii,delete e.iconBtn.dataset.active,e.panel.style.display="none",o&&(o.style.display=e.nativePanelOriginalDisplay||""))},$c=()=>{let e=document.createElement("button");return e.id=ni,e.type="button",e.title="Properties",e.setAttribute("aria-label","Properties"),e.className=ii,e.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${_c.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,e.addEventListener("click",t=>{t.stopPropagation(),se&&di(se,!go)}),e},ri=()=>{document.getElementById(ni)?.remove(),document.getElementById(Br)?.remove(),St&&se&&se.nav.removeEventListener("click",St,!0),St=null,se=null,go=!1},ci=()=>{Lc()},Lc=async()=>{if(!Pr){Pr=!0;try{let e=H();if(!e||!e.locationId){ri();return}let t=document.getElementById(Br);if(t&&t.dataset.contactId===e.contactId&&se)return;ri();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(m){c.warn("[properties] Contact Type fetch failed",m);return}if(Ce(o)==="buyer")return;let[a,i]=await Promise.all([wc(),kc()]);if(!a||!i){c.warn("[properties] right-rail nav or panel area not found");return}let s=H();if(!s||s.contactId!==e.contactId)return;let l=Tc(e.locationId,e.contactId),d=$c();se={contactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(d),i.appendChild(l),St=m=>{let h=m.target;!h||se&&se.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&go&&se&&di(se,!1)},a.addEventListener("click",St,!0),c.info(`[properties] right-rail mount complete for seller ${e.contactId}`)}finally{Pr=!1}}};var Ae="ws-crm-claim-release-pill",Ic="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Mc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Oc=async e=>{let t=await fetch(Ic,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Get returned ${t.status} ${t.statusText}`);return await t.json()},Dc=async e=>{let t=await fetch(Mc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId,action:e.action}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Set returned ${t.status} ${t.statusText}`);return await t.json()},bi=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},tt=(e,t)=>{let o=t==="claim"?"emerald":"amber",r=t==="claim"?n.emerald:n.amber;e.dataset.mode=t,e.style.cssText=Ga(o),e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=ko();!o||!o.locationId||o.oppId!==e||lp({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=t.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),t.style.background=n.emeraldGlow,t.style.color=n.emeraldBright,t.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",t.style.cssText=O)},4e3)}})}),t},cp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pp=async()=>{for(let e of cp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},wo=!1,jr=async()=>{if(!wo){wo=!0;try{await mp()}finally{wo=!1}}},mp=async()=>{let e=ko();if(!e||!e.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t();return}let t=document.getElementById(le);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t());return}t&&(t.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await pp();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ko();if(!a||a.oppId!==e.oppId)return;let i=dp(e.oppId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${e.oppId}`),bp(e.oppId)},At=null,Wr=null,$t=()=>{At?.disconnect(),At=null,Wr=null},bp=e=>{if(At&&Wr===e)return;$t();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Wr=e,At=new MutationObserver(()=>{let o=ko();if(!o||o.oppId!==e){$t();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t();return}document.getElementById(le)||jr()}),At.observe(t,{childList:!0,subtree:!0}))},Ur=null,Vr,hp=()=>{Ur||(Ur=new MutationObserver(()=>{Vr===void 0&&(Vr=window.setTimeout(()=>{Vr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(le);e&&!t&&!wo&&jr()},300))}),Ur.observe(document.body,{childList:!0,subtree:!0}))},$i=()=>{hp(),jr()};var up="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",de="ws-crm-not-interested-button",vp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_p=/\/v2\/location\/([A-Za-z0-9]+)/,To=()=>{let e=window.location.pathname,t=e.match(vp);if(!t)return null;let o=e.match(_p);return{oppId:t[1],locationId:o?o[1]:null}},gp=async e=>{let t=await fetch(up,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Not Interested webhook returned ${t.status} ${t.statusText}`);return await t.json()},yp=e=>{let t=document.createElement("button");return t.id=de,t.type="button",t.dataset.oppId=e,t.style.cssText=O,t.title="Close this Marketing Tracker opp as Not Interested for THIS property only",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let o=To();if(!o||!o.locationId||o.oppId!==e)return;let r=M(),a=t.querySelector(".ws-ni-label");t.disabled=!0,t.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await gp({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),t.style.background=n.crimsonGlow,t.style.color=n.crimson,c.info(`Not Interested set for opp ${e} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),t.disabled=!1,t.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),t},fp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xp=async()=>{for(let e of fp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Eo=!1,Xr=async()=>{if(!Eo){Eo=!0;try{await wp()}finally{Eo=!1}}},wp=async()=>{let e=To();if(!e||!e.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}let t=document.getElementById(de);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove(),It());return}t&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await xp();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=To();if(!a||a.oppId!==e.oppId)return;let i=yp(e.oppId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${e.oppId}`),kp(e.oppId)},Lt=null,Jr=null,It=()=>{Lt?.disconnect(),Lt=null,Jr=null},kp=e=>{if(Lt&&Jr===e)return;It();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Jr=e,Lt=new MutationObserver(()=>{let o=To();if(!o||o.oppId!==e){It();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}document.getElementById(de)||Xr()}),Lt.observe(t,{childList:!0,subtree:!0}))},Kr=null,Yr,Ep=()=>{Kr||(Kr=new MutationObserver(()=>{Yr===void 0&&(Yr=window.setTimeout(()=>{Yr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(de);e&&!t&&!Eo&&Xr()},300))}),Kr.observe(document.body,{childList:!0,subtree:!0}))},Li=()=>{Ep(),Xr()};var Tp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ae="ws-crm-schedule-walkthrough-button",Qr="ws-crm-schedule-walkthrough-modal",Sp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cp=/\/v2\/location\/([A-Za-z0-9]+)/,Ao=()=>{let e=window.location.pathname,t=e.match(Sp);if(!t)return null;let o=e.match(Cp);return{oppId:t[1],locationId:o?o[1]:null}},So=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Ap=(e,t)=>{document.getElementById(Qr)?.remove();let o=document.createElement("div");o.id=Qr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=Ao();!o||!o.locationId||o.oppId!==e||Ap(o.oppId,o.locationId)}),t},Lp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ip=async()=>{for(let e of Lp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Co=!1,on=async()=>{if(!Co){Co=!0;try{await Mp()}finally{Co=!1}}},Mp=async()=>{let e=Ao();if(!e||!e.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot();return}let t=document.getElementById(ae);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot());return}t&&(t.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Ip();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Ao();if(!a||a.oppId!==e.oppId)return;let i=$p(e.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${e.oppId}`),Op(e.oppId)},Mt=null,tn=null,Ot=()=>{Mt?.disconnect(),Mt=null,tn=null},Op=e=>{if(Mt&&tn===e)return;Ot();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(tn=e,Mt=new MutationObserver(()=>{let o=Ao();if(!o||o.oppId!==e){Ot();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),Ot();return}document.getElementById(ae)||on()}),Mt.observe(t,{childList:!0,subtree:!0}))},Zr=null,en,Dp=()=>{Zr||(Zr=new MutationObserver(()=>{en===void 0&&(en=window.setTimeout(()=>{en=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ae);e&&!t&&!Co&&on()},300))}),Zr.observe(document.body,{childList:!0,subtree:!0}))},Ii=()=>{Dp(),on()};var Hp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",rt="ws-crm-resend-deal-link-wrap",Pp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bp=/\/v2\/location\/([A-Za-z0-9]+)/,Lo=()=>{let e=window.location.pathname,t=e.match(Pp);if(!t)return null;let o=e.match(Bp);return{oppId:t[1],locationId:o?o[1]:null}},Rp=async e=>{let t=await fetch(Hp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,channel:e.channel,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Resend webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Fp=e=>e.replace(/[<>&]/g,t=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[t]||t),Mi=e=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${e};box-shadow:0 0 6px ${e};flex-shrink:0;"></span>`,sn=(e,t)=>{e.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Mi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Np(e,t)),e.appendChild(o)},Np=(e,t)=>{e.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void zp(e,t,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>sn(e,t)),o.appendChild(s),e.appendChild(o)},zp=async(e,t,o,r)=>{let a=Lo();if(!(!a||!a.locationId||a.oppId!==t)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Rp({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${Mi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${t}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Fp(s)}</span>`}window.setTimeout(()=>sn(e,t),3500)}},qp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gp=async()=>{for(let e of qp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},$o=!1,ln=async()=>{if(!$o){$o=!0;try{await Up()}finally{$o=!1}}},Up=async()=>{let e=Lo();if(!e||!e.locationId){document.getElementById(rt)?.remove(),Ht();return}let t=document.getElementById(rt);if(t&&t.dataset.oppId===e.oppId){let s=P();s!==null&&s!=="Marketing Tracker"&&(t.remove(),Ht());return}t&&t.remove();let o=await Gp();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Lo();if(!a||a.oppId!==e.oppId)return;let i=document.createElement("span");i.id=rt,i.dataset.oppId=e.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),sn(i,e.oppId),c.debug(`Mounted Resend Deal Link button on opp ${e.oppId}`),Vp(e.oppId)},Dt=null,an=null,Ht=()=>{Dt?.disconnect(),Dt=null,an=null},Vp=e=>{if(Dt&&an===e)return;Ht();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(an=e,Dt=new MutationObserver(()=>{let o=Lo();if(!o||o.oppId!==e){Ht();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(rt)?.remove(),Ht();return}document.getElementById(rt)||ln()}),Dt.observe(t,{childList:!0,subtree:!0}))},rn=null,nn,Wp=()=>{rn||(rn=new MutationObserver(()=>{nn===void 0&&(nn=window.setTimeout(()=>{nn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(rt)&&!$o&&ln()},300))}),rn.observe(document.body,{childList:!0,subtree:!0}))},Oi=()=>{Wp(),ln()};var jp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ce="ws-crm-reduce-price-button",Di="ws-crm-reduce-price-modal",Kp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yp=/\/v2\/location\/([A-Za-z0-9]+)/,Oo=()=>{let e=window.location.pathname,t=e.match(Kp);if(!t)return null;let o=e.match(Yp);return{oppId:t[1],locationId:o?o[1]:null}},Jp=async e=>{let t=await fetch(jp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,dispo_opp_id:e.oppId,new_price:e.newPrice,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Reduce Price webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Io=()=>{document.getElementById(Di)?.remove()},Xp=e=>{Io();let t=document.createElement("div");t.id=Di,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Oo();!r||!r.locationId||r.oppId!==e||Xp({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Zp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],em=async()=>{for(let e of Zp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Mo=!1,mn=async()=>{if(!Mo){Mo=!0;try{await tm()}finally{Mo=!1}}},tm=async()=>{let e=Oo();if(!e||!e.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Bt();return}let t=document.getElementById(ce);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Bt());return}t&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=await em();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Oo();if(!a||a.oppId!==e.oppId)return;let i=Qp(e.oppId,e.locationId),s=document.createElement("span");s.id=`${ce}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${e.oppId}`),om(e.oppId)},Pt=null,pn=null,Bt=()=>{Pt?.disconnect(),Pt=null,pn=null},om=e=>{if(Pt&&pn===e)return;Bt();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(pn=e,Pt=new MutationObserver(()=>{let o=Oo();if(!o||o.oppId!==e){Bt();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Bt();return}document.getElementById(ce)||mn()}),Pt.observe(t,{childList:!0,subtree:!0}))},dn=null,cn,rm=()=>{dn||(dn=new MutationObserver(()=>{cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ce);e&&!t&&!Mo&&mn()},300))}),dn.observe(document.body,{childList:!0,subtree:!0}))},Hi=()=>{rm(),mn()};var nt="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Do="deals.reinvestos.com";var pe="ws-crm-edit-landing-button",nm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,am=/\/v2\/location\/([A-Za-z0-9]+)/,Po=()=>{let e=window.location.pathname,t=e.match(nm);if(!t)return null;let o=e.match(am);return{oppId:t[1],locationId:o?o[1]:null}},im=(e,t)=>{let o=new URL(`https://${Do}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();return r&&o.searchParams.set("user",r),o.toString()},sm=(e,t)=>{let o=document.createElement("button");return o.id=pe,o.type="button",o.dataset.oppId=e,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Po();if(!r||!r.locationId||r.oppId!==e)return;if(!nt){c.warn("[edit-landing] editor session key not configured in this build");return}let a=im(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},lm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dm=async()=>{for(let e of lm)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Ho=!1,vn=async()=>{if(!Ho){Ho=!0;try{await cm()}finally{Ho=!1}}},cm=async()=>{let e=Po();if(!e||!e.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Ft();return}let t=document.getElementById(pe);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Ft());return}t&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=await dm();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Po();if(!a||a.oppId!==e.oppId)return;let i=sm(e.oppId,e.locationId),s=document.createElement("span");s.id=`${pe}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${e.oppId}`),pm(e.oppId)},Rt=null,un=null,Ft=()=>{Rt?.disconnect(),Rt=null,un=null},pm=e=>{if(Rt&&un===e)return;Ft();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(un=e,Rt=new MutationObserver(()=>{let o=Po();if(!o||o.oppId!==e){Ft();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Ft();return}document.getElementById(pe)||vn()}),Rt.observe(t,{childList:!0,subtree:!0}))},bn=null,hn,mm=()=>{bn||(bn=new MutationObserver(()=>{hn===void 0&&(hn=window.setTimeout(()=>{hn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(pe);e&&!t&&!Ho&&vn()},300))}),bn.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{mm(),vn()};var Ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",at="ws-crm-publish-button",Nt="ws-crm-publish-wrap",Ro="ws-crm-publish-dropdown",bm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hm=/\/v2\/location\/([A-Za-z0-9]+)/,yn=()=>{let e=window.location.pathname,t=e.match(bm);if(!t)return null;let o=e.match(hm);return{oppId:t[1],locationId:o?o[1]:null}},um=async(e,t)=>{try{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},vm=async(e,t)=>{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},_m=(e,t)=>{if(!nt){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Do}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},xe=()=>{document.getElementById(Ro)?.remove()},Bi=(e,t,o,r,a)=>{xe();let i=document.createElement("div");i.id=Ro;let s=t.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,_e(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let x=await Gm(e,t);if(!x){a={status:"error",message:"Check failed \u2014 click to retry"},_e(o,a);return}if(x.rate_limited){_=Date.now()+b,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},_e(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(x.checks)||x.checks.length===0){a={status:"error",message:x.error||"Check failed \u2014 click to retry"},_e(o,a),c.warn("[stc] dry_run returned no checks:",x);return}let g=x.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Uo.add(e),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),me(),Ut();return}let w=x.checks;if(a.checks&&a.checks.length===x.checks.length){let S=new Set;w=x.checks.map((E,f)=>a.checks[f]?.filled&&!E.filled?i.has(E.label)?E:(S.add(E.label),{...E,filled:!0}):E),i=S}else i=new Set;a={status:w.every(S=>S.filled)?"ready":"incomplete",checks:w,previouslySentAt:x.previously_sent_at??null},qm(e,{checks:w,previously_sent_at:x.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),_e(o,a),document.getElementById(qo)&&No(w,x.previously_sent_at,o)},l=async()=>{let x=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},_e(o,a),me();try{let g=await Um(e,t,x);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},_e(o,a),window.setTimeout(()=>{y()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},_e(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(qo)?me():a.checks&&No(a.checks,a.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,p=!1,m=Date.now(),h=1e4,b=5*60*1e3,_=0,y=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,m=Date.now();try{await s()}finally{p=!1}}};y();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let x=new MutationObserver(()=>{if(d!==void 0||p)return;let C=Date.now()-m,S=Math.max(1500,h-C);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&y()},S)});x.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=C=>{let S=C.detail;if(!S||S.oppId!==e)return;ns(e);let E=0,f=()=>{if(p&&E<8){E+=1,window.setTimeout(f,500);return}y()};f()};window.addEventListener(In,g);let w=window.setInterval(()=>{document.body.contains(o)||(x.disconnect(),d!==void 0&&window.clearTimeout(d),window.removeEventListener(In,g),window.clearInterval(w))},5e3)}return o},Km=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ym=async()=>{for(let e of Km)try{let t=await $(e,{timeoutMs:1500});if(t)return c.debug(`[send-to-title-co] mount target: ${e}`),t}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Uo=new Set,os=null,Jm=e=>{e&&e!==os&&(Uo.clear(),os=e)},zo=!1,Dn=async()=>{if(zo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}zo=!0;try{await Xm()}catch(e){c.error("[stc] ensureMountedImpl threw:",e)}finally{zo=!1}},Xm=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let e=Go();if(!e||!e.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(e)}`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),me();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${e.oppId} locId=${e.locationId}`),Jm(e.oppId),Uo.has(e.oppId)){c.debug(`[stc] mount:02-BAIL opp ${e.oppId} previously confirmed non-TC this session`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),me();return}let t=document.getElementById($e);if(t&&t.dataset.oppId===e.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=P();l!==null&&l!=="Transaction Coordination"&&(t.remove(),document.getElementById(Ge)?.remove(),me(),Ut());return}t&&(c.debug("[stc] mount:03 removing stale existing button"),t.remove(),document.getElementById(Ge)?.remove(),me()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Ym();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=P();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Go();if(!a||a.oppId!==e.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${e.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=jm(e.oppId,a.locationId),s=document.createElement("span");s.id=Ge,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${e.oppId}, inDoc=${document.body.contains(i)}`),Qm(e.oppId)},Gt=null,Mn=null,Ut=()=>{Gt?.disconnect(),Gt=null,Mn=null},Qm=e=>{if(Gt&&Mn===e)return;Ut();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Mn=e,Gt=new MutationObserver(()=>{let o=Go();if(!o||o.oppId!==e){Ut();return}let r=P();if(r!==null&&r!=="Transaction Coordination"){document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),me(),Ut();return}document.getElementById($e)||Dn()}),Gt.observe(t,{childList:!0,subtree:!0}))},$n=null,Ln,Zm=()=>{$n||($n=new MutationObserver(()=>{Ln===void 0&&(Ln=window.setTimeout(()=>{Ln=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById($e);if(e&&!t&&!zo){let o=Go();if(o&&Uo.has(o.oppId))return;Dn()}},300))}),$n.observe(document.body,{childList:!0,subtree:!0}))},is=()=>{Zm(),Dn()};var Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",eb=`${Bn}/tc/welcome-call-prefill`,tb=`${Bn}/tc/welcome-call-save`,ob=`${Bn}/tc/order-lockbox`,Vt="ws-crm-welcome-call-overlay",rb=["Regular Contract","Subject To","Seller Finance","Novation"],nb=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],ab=["Gas","Electric","Propane","Oil"],ib=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],sb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Le=["Yes","No"],lb=["Yes","No","Unknown"],db=["Professional Photographer","Seller","Tenant"],cb=["Month-to-Month","Annual"],ss=["Current","Behind"],pb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ge=e=>(e==null?"":String(e)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Wo=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,cs="margin-bottom:12px;",ps=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,mb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ls=e=>String(e??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(e,t,o)=>{let r=ls(o);return`<select id="${e}" style="${Wo}"><option value=""></option>${t.map(a=>`<option ${r!==""&&ls(a)===r?"selected":""}>${ge(a)}</option>`).join("")}</select>`},Z=(e,t,o="")=>`<input id="${e}" type="text" value="${ge(t)}" placeholder="${ge(o)}" style="${Wo}">`,bb=(e,t)=>`<textarea id="${e}" rows="3" style="${Wo}resize:vertical;">${ge(t)}</textarea>`,hb=(e,t)=>`<input id="${e}" type="date" value="${ge(t)}" style="${Wo}">`,D=(e,t)=>`<div style="${cs}"><label style="${ps}">${ge(e)}</label>${t}</div>`,Hn=(e,t)=>{let o=Array.isArray(t)?t:[];return`<div style="margin-top:4px;">${pb.map(r=>`<label style="${mb}"><input type="checkbox" data-grp="${e}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},we=e=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ge(e)}</div>`,it=()=>{document.getElementById(Vt)?.remove()},Ue=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},ub=e=>{let t=e.tenant||{};return`
    ${we("Identifiers")}
    ...
    ${we("Contract")}
    ${D("Type of Contract",j("wc-contract_type",rb,e.contract_type))}

    ${we("Property")}
    ${D("Property Type",j("wc-property_type",ib,e.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${D("Utilities",j("wc-utilities",nb,e.utilities))}
    ${D("Heat Source",j("wc-heat_source",ab,e.heat_source))}
    ...
    ${we("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",sb,e.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",cb,t.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${D("Last rent paid",hb("wc-tenant_last_rent_paid",t.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",e.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",lb,e.hoa_rental_restriction))}</div>

    ${we("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",db,e.photos_provided_by))}
    <div style="${cs}">
  ...
  `},A=e=>{let t=document.getElementById(e);return t?(t.value||"").trim():""},Pn=e=>Array.from(document.querySelectorAll(`input[data-grp="${e}"]:checked`)).map(t=>t.value),ds=()=>{let e=(t,o)=>{let r=document.getElementById(t);r&&(r.style.display=o?"block":"none")};e("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),e("wc-hoa-detail",A("wc-in_hoa")==="Yes"),e("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),e("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Vo=e=>{let t=e,o=String(t.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=t.lockbox_order_date?ge(t.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},vb=e=>({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:Pn("photos_avail_mornings"),photos_avail_afternoons:Pn("photos_avail_afternoons"),photos_avail_evenings:Pn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),_b=e=>{it();let t=document.createElement("div");t.id=Vt,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${ub(e)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Ie("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(gb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Me(),Ie("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Ie("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Ie("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!t.contains(p)&&(Me(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},$b=(e,t)=>{Me();let o=document.createElement("div");o.id=us;let r=t.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of e){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!t.contains(s)&&(Me(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Ko=(e,t)=>{let o=document.createElement("button");return o.type="button",t==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=e,o},Lb=()=>{let e=Ko("\u22EE","ghost");return e.style.lineHeight="1",e},Ib=(e,t)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",t===gs){let r=Ko("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Tb(e)),o.appendChild(r),o}if(t===Wn){let r=Ko("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Ab(e,r)),o.appendChild(r),o}if(t===ys){let r=Ko("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void xs(e)),o.appendChild(r),o}return null},Mb=(e,t)=>{let o=[];if(t===Wn&&(o=[{label:"Re-order Lockbox",onClick:()=>void xs(e)}]),!o.length)return null;let r=document.createElement("span");r.id=hs,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Lb();return a.addEventListener("click",i=>{i.stopPropagation(),$b(o,a)}),r.appendChild(a),r},Ob=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Db=async()=>{for(let e of Ob)try{let t=await $(e,{timeoutMs:1200});if(t)return t}catch{}return null},jo=()=>{document.getElementById(qn)?.remove(),document.getElementById(hs)?.remove(),Me()},Yo=!1,jn=async()=>{if(!Yo){Yo=!0;try{let e=fs();if(!e){jo();return}let t=P();if(t===null)return;if(t!=="Transaction Coordination"){jo();return}let o=Eb(),r=document.getElementById(qn);if(r&&r.dataset.oppId===e.oppId&&r.dataset.stage===(o??""))return;let a=Ib(e,o);if(!a){jo();return}let i=await Db();if(!i)return;jo();let s=U(i),l=document.createElement("span");l.id=qn,l.dataset.oppId=e.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Mb(e,o);d&&s.appendChild(d),Hb(e.oppId)}catch(e){c.error("[action-bar] ensureBar threw:",e)}finally{Yo=!1}}},Wt=null,Un=null,Fn,bs=()=>{Wt?.disconnect(),Wt=null,Un=null},Hb=e=>{if(Wt&&Un===e)return;bs();let t=document.querySelector(_s);t&&(Un=e,Wt=new MutationObserver(()=>{let o=fs();if(!o||o.oppId!==e){bs();return}Fn===void 0&&(Fn=window.setTimeout(()=>{Fn=void 0,jn()},250))}),Wt.observe(t,{childList:!0,subtree:!0}))},Nn=null,zn,Pb=()=>{Nn||(Nn=new MutationObserver(()=>{zn===void 0&&(zn=window.setTimeout(()=>{zn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Yo&&jn()},300))}),Nn.observe(document.body,{childList:!0,subtree:!0}))},ws=()=>{Pb(),jn()};var ks="ws-support-modal",Es="ws-support-toast",Bb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ts="ws-support-submitter-name",Ss="ws-support-submitter-email",Cs="ws-support-submitter-role",Rb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ve=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Fb=(e,t="success",o)=>{let r=document.getElementById(Es);r&&r.remove();let a=document.createElement("div");a.id=Es;let i=t==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Nb=()=>{document.getElementById(ks)?.remove();let e=(localStorage.getItem(Ts)??"").trim(),t=(localStorage.getItem(Ss)??"").trim(),o=(localStorage.getItem(Cs)??"").trim(),r={category:null,title:"",description:"",submitterName:e,submitterEmail:t,submitterRole:o},a=document.createElement("div");a.id=ks,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ts,r.submitterName),localStorage.setItem(Ss,r.submitterEmail),r.submitterRole&&localStorage.setItem(Cs,r.submitterRole)}catch{}let m=i.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let b=await(await fetch(Bb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!b.ok){d(b.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let _=b.ticket_short_id||"submitted";Fb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},zb=["/support-ticket","ws-support-modal","ws-support"],qb=/\/custom-menu-link\//,Kn=!1,As=()=>{if(Kn||!qb.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return zb.some(s=>i.includes(s))});if(r){Kn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Nb(),Kn=!1},50);return}e<10&&setTimeout(t,150)};t()},$s=!1,Ls=()=>{$s||($s=!0,ne(()=>setTimeout(As,50)),As(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Is="ws-phone-assignments-modal",Ms="ws-phone-assignments-toast",Gb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Vb=["ACQ","DISPO","TC"],Hs="",Oe=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Wb=(e,t="success",o)=>{document.getElementById(Ms)?.remove();let r=document.createElement("div");r.id=Ms;let a=t==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Oe(e)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Oe(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},jb=(e,t,o)=>{let r=[`<option value="" ${o===Hs?"selected":""}>\u2014 Unassigned \u2014</option>`,...t.map(a=>`<option value="${Oe(a)}" ${o===a?"selected":""}>${Oe(a)}</option>`)].join("");return`<select data-assign="${Oe(e)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Kb=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Jn=async e=>{document.getElementById(Is)?.remove();let t=e||re(),o=document.createElement("div");o.id=Is,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",b=>{b.target===o&&o.remove()}),!t){let b=r.querySelector("#ws-pa-body");b&&(b.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Gb}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(b){c.error("[phone-assignments] GET failed",b);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Oe(b.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:Vb,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=b=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${b} found.</div>`,p=s.length?s.map(b=>`<div style="${Kb}">
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(b=>{b.addEventListener("change",()=>{let _=b.getAttribute("data-assign")||"",[y,...k]=_.split(":"),x=k.join(":");y==="num"&&(b.value?l[x]=b.value:delete l[x])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let b=h.querySelector("#ws-pa-err"),_=k=>{b&&(b.textContent=k)};_("");let y=h.querySelector("#ws-pa-save");y&&(y.disabled=!0,y.textContent="Saving\u2026",y.style.opacity="0.7");try{let x=await(await fetch(Ub,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:l})})).json();if(!x.ok){_(x.error||"Save failed."),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1");return}o.remove(),Wb("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){_(`Network error: ${k.message}`),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1")}}))},Yb=["ws-phone-assignments","phone-assignments"],Jb=/\/custom-menu-link\//,Yn=!1,Os=()=>{if(Yn||!Jb.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Yb.some(s=>i.includes(s))});if(r){Yn=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{Jn(i),Yn=!1},50);return}e<10&&setTimeout(t,150)};t()},Ds=!1,Ps=()=>{if(Ds)return;Ds=!0,ne(()=>setTimeout(Os,50)),Os();let e=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Jn()};window.addEventListener("hashchange",e),e(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Jn(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var Rs="powerDialerApp",Xb=".dialer",Qb='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Zb=".dial-item.dial-btn.dial-btn-enabled",We=e=>{for(let t of["pointerdown","mousedown","pointerup","mouseup","click"])try{e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Xn=e=>{let t=(e||"").match(/\+\d{10,15}/);return t?t[0]:null},Fs=()=>{try{let t=window[Rs]?._context?.provides?.emitter;if(t&&typeof t.emit=="function")return t}catch(e){c.debug("[dialer-bridge] getEmitter failed",e)}return null},st=()=>document.querySelector(Xb),Jo=()=>Fs()!==null||st()!==null?!0:!!window[Rs],Xo=(e,t)=>{let o=Fs();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${e}`),!1;try{return o.emit(e,t),!0}catch(r){return c.error(`[dialer-bridge] emit ${e} threw`,r),!1}},Ns=()=>{if(st())return;let e=document.querySelector(Qb);e?We(e):c.warn("[dialer-bridge] Voice Calling button not found")},eh=()=>{let e=document.querySelector(".number-list-container")||st();if(!e)return[];let t=[...e.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of t){let i=Xn(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},Bs=()=>{let e=document.querySelector(".number-config .ui-text-sm-medium");if(e){let o=Xn(e.innerText);if(o)return o}let t=document.querySelector(".number-config");return t?Xn(t.innerText):null},zs=e=>{if(Bs()===e)return!0;let t=document.querySelector(".number-config, .dialer-config");t&&We(t);let o=eh().find(r=>r.e164===e);return o?(We(o.el),Bs()===e):(c.warn(`[dialer-bridge] Calling From ${e} not available to this rep`),!1)},qs=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(e=>/local/i.test(e.innerText||""))||null,th=()=>{let e=qs();return e?!/bg-gray-100/.test(e.className):!1},Gs=e=>{let t=qs();t&&th()!==e&&We(t)},Us=e=>{let t=e.replace(/[^\d*#+]/g,"");if(Xo("sendDigitToDial",{value:t,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of t){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&We(a)}},Vs=()=>{let e=st();if(!e)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let t=e.querySelector(Zb)||[...e.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return t?(We(t),!0):Xo("makeCall",{provider:"twilio"})};var Qn=()=>{let e=st();if(!e)return;let t=[...e.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);t?We(t.closest("button")||t):Xo("closeCallBox")},Ws=()=>{Xo("closeCallBox")},js=e=>{let t=!1,o=()=>{let i=st()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(t=!0),t&&l){t=!1;try{e()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var oh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",rh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ks=["acq","dispo","tc"],Kt={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},jt=null,Ys=null,nh=async(e=!1)=>{let t=re();if(!t)return{};if(!e&&jt&&Ys===t)return jt;try{return jt=(await(await fetch(`${oh}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json())?.config?.numberTeam??{},Ys=t,jt}catch(o){return c.warn("[silo] number-team config load failed",o),jt??{}}},je=null,Js=null,Zn=async(e=!1)=>{let t=re(),o=M();if(!t||!o)return[];if(!e&&je&&Js===t)return je;try{let i=(await(await fetch(rh,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(s=>s.id===o);if(i){let s=i.role_keys??[];je=Ks.filter(l=>s.includes(l))}else Ze()?je=[...Ks]:je=[];return Js=t,je}catch(r){return c.warn("[silo] roster load failed",r),je??[]}},Qs=()=>`ws-pd-calling-as:${M()||"anon"}`,Zs=e=>{try{localStorage.setItem(Qs(),e)}catch{}},ea=async()=>{let e=await Zn();if(e.length===0)return null;if(e.length===1)return e[0];let t=null;try{t=localStorage.getItem(Qs())}catch{}return t&&e.includes(t)?t:e[0]},Xs=e=>{let t=(e||"").replace(/\D/g,"");return t.length===11&&t[0]==="1"?t.slice(1,4):t.length===10?t.slice(0,3):null},ah=(e,t)=>Object.entries(e).filter(([,o])=>o===t).map(([o])=>o),el=async e=>{let t=await ea();if(!t)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let o=await nh(),r=ah(o,t);if(!r.length)return c.debug(`[silo] ${t} has no numbers; leaving GHL default`),null;let a=Xs(e),i=a?r.find(d=>Xs(d)===a):void 0,s=i||r[0];try{Gs(!1)}catch{}return zs(s)?(c.info(`[silo] ${Kt[t]}: calling ${e} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} (not in this rep's picker?)`),null)};var ih="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",tl="data-ws-pd",ol="ws-pd-panel",rl="ws-pd-session",Ke=e=>new Promise(t=>setTimeout(t,e)),Yt=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),sh=e=>{let t=e;for(let o=0;o<8&&t;o++){if(t.querySelector(".crm-opportunities-card-wrapper"))return t;t=t.parentElement}return null},lh=e=>{let t=[e,...Array.from(e.querySelectorAll("*"))];for(let o of t)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return e},dh=e=>{let t=[],o=new Set;for(let r of Array.from(e.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),t.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return t},ch=async e=>{let t=sh(e);if(!t)return[];let o=lh(t),r=-1;for(let a=0;a<60;a++){let i=t.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ke(550)}return o.scrollTop=0,dh(t)},ph=async(e,t)=>{try{let r=await(await fetch(ih,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,contact_id:t})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},mh=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,oa=(e,t,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(ol)?.remove();let r=document.createElement("div");r.id=ol,r.style.cssText=mh;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let i=t.map((p,m)=>`<label data-row="${m}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Zo=()=>{document.getElementById(yl)?.remove()},Ph=e=>{Zo();let t=document.createElement("div");t.id=yl,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};De(o,r);let a=fl(e);return a&&(r={status:"linked",contactName:a.contactName},De(o,r),Ye={oppId:e,contactId:a.contactId,contactName:a.contactName,tenantId:t}),(async()=>{let s=await Ih(e,t);s?(r={status:"linked",contactName:s.name},De(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},ba(s.id,s.name,t)):a||(r={status:"empty"},De(o,r),Ye?.oppId===e&&(Ye=null),Dh(),Oh(e))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Ph({oppId:e,locationId:t,onPick:async s=>{r={status:"saving"},De(o,r);try{let l=await vl({tenantId:t,oppId:e,fieldKey:gl,value:s.id});if(!l.ok)throw new Error(l.error??"Save failed");s.companyName&&s.companyName.trim()&&await vl({tenantId:t,oppId:e,fieldKey:Ah,value:s.companyName.trim()}),r={status:"linked",contactName:s.name},De(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},xl(e,s.id,s.name),ba(s.id,s.name,t),as(e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},De(o,r)}}})}),o},Rh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Fh=async()=>{for(let e of Rh)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Xt=!1,or=async()=>{if(!Xt){Xt=!0;try{await Nh()}finally{Xt=!1}}},Nh=async()=>{let e=Zt();if(!e||!e.locationId){document.getElementById(be)?.remove(),document.getElementById(`${be}-wrap`)?.remove(),tr();return}let t=document.getElementById(be);if(t&&t.dataset.oppId===e.oppId){let d=P();d!==null&&d!=="Transaction Coordination"&&(t.remove(),document.getElementById(`${be}-wrap`)?.remove(),tr());return}t&&(t.remove(),document.getElementById(`${be}-wrap`)?.remove());let o=P();if(o!==null&&o!=="Transaction Coordination")return;let r=await Fh();if(!r||!(fl(e.oppId)!==null||Ye!==null&&Ye.oppId===e.oppId)&&await W()!=="Transaction Coordination")return;let i=Zt();if(!i||i.oppId!==e.oppId||!i.locationId)return;let s=Bh(e.oppId,i.locationId),l=document.createElement("span");l.id=`${be}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${e.oppId}`),zh(e.oppId),ga(i.locationId)},Qt=null,ha=null,ua=null,tr=()=>{Qt?.disconnect(),Qt=null,ha=null,ua=null},zh=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Qt&&ha===e&&ua===t||(tr(),ha=e,ua=t,Qt=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==e||!o.locationId){tr();return}document.getElementById(be)||or(),ga(o.locationId)}),Qt.observe(t,{childList:!0,subtree:!0})))},ca=null,pa,qh=()=>{ca||(ca=new MutationObserver(()=>{pa===void 0&&(pa=window.setTimeout(()=>{pa=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(be);e&&!t&&!Xt&&or()},300))}),ca.observe(document.body,{childList:!0,subtree:!0}))},_l,Gh=()=>{_l===void 0&&(_l=window.setInterval(()=>{let e=Zt();if(!e||!e.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(be)&&!Xt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),or()),ga(e.locationId)},2e3))},kl=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),qh(),Gh(),or()};var Uh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Pe="ws-crm-manage-team-cta",El="ws-crm-manage-team-modal",Vh=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Tl={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Wh={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Sl=()=>{let e=window.location.pathname.match(Vh);return e?{tenantId:e[1]}:null},nr=async e=>{let t=await fetch(Uh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!t.ok){let o="";try{o=await t.text()}catch{}throw new Error(`Team.Manage HTTP ${t.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await t.json()},ie=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),He=e=>ie(e),ya="ws-crm-manage-team-toast",wa=(e,t="info",o=4e3)=>{document.getElementById(ya)?.remove();let r=t==="success"?n.emerald:t==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ya,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=e,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ya)===a&&a.remove()},o)},fa=()=>{document.getElementById(El)?.remove()},jh=(e,t)=>{let o=Wh[e]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ie(t)}</span>
  `},Kh=(e,t)=>{let o=[e.first_name,e.last_name].filter(Boolean).join(" ")||"(no name)",r=e.roles.map(s=>jh(s.key,s.display)).join(""),a=t?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=t?"":'title="Manager-only action"';return`
  ...
  `+e.map(r=>Kh(r,t)).join(""),ar=async e=>{fa();let t=document.createElement("div");t.id=El,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t),o.querySelector("#ws-team-close")?.addEventListener("click",fa);let r;try{r=await nr({tenant_id:e,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Yh(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Jh(e)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;Xh(e,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;Qh(e,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Jh=e=>{let t="ws-crm-manage-team-add-modal";document.getElementById(t)?.remove();let o=document.createElement("div");o.id=t,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,document.head.appendChild(e)},Sa="__WS_CRM_CAPTURED_AUTH",du=50*60*1e3,dr=()=>{try{let e=localStorage.getItem(Sa);if(!e)return null;let t=JSON.parse(e);return t?.authorization?Date.now()-(t.capturedAt||0)>du?(localStorage.removeItem(Sa),null):t:null}catch{return null}},cu=e=>{try{localStorage.setItem(Sa,JSON.stringify(e))}catch{}},pt=()=>{let e=dr(),t=window;if(t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{},t.__WS_CRM_DIAG.authChecks=(t.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${t.__WS_CRM_DIAG.authChecks}]`,e?`present (captured ${Date.now()-e.capturedAt}ms ago, ${e.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!e)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:e.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return e.tokenId&&(o["token-id"]=e.tokenId),o},Ll=(e,t)=>new Promise(o=>{let r=Date.now(),a=()=>{if((dr()?.capturedAt??0)>e)return o(!0);if(Date.now()-r>t)return o(!1);window.setTimeout(a,250)};a()}),ct=async(e,t={},o=2)=>{let r=dr()?.capturedAt??0,a;try{a={...pt(),...t.headers??{}}}catch(s){if(o>0&&await Ll(r,4e3))return ct(e,t,o-1);throw s}let i=await fetch(e,{...t,headers:a});return i.status!==401||o<=0?i:await Ll(r,4e3)?ct(e,t,o-1):i},Il=!1,pu=()=>{if(Il)return;Il=!0;let e=window;e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let t=(l,d,p)=>{e.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let m=d.authorization||d.Authorization;if(!m){e.__WS_CRM_DIAG.fetchCalls+e.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?e.__WS_CRM_DIAG.fetchAuthSeen++:e.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,b=dr()?.authorization;cu({authorization:m,tokenId:h,capturedAt:Date.now()}),b!==m&&(e.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${m.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){e.__WS_CRM_DIAG.fetchCalls++;let m=p.headers;!m&&l[0]instanceof Request&&(m=l[0].headers);let h={};if(m instanceof Headers)m.forEach((b,_)=>h[_.toLowerCase()]=b);else if(Array.isArray(m))m.forEach(([b,_])=>h[b.toLowerCase()]=_);else if(m&&typeof m=="object")for(let b of Object.keys(m))h[b.toLowerCase()]=m[b];t(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(e.__WS_CRM_DIAG.xhrCalls++,t(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Pl=()=>{let e=H();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},mu=e=>{let t=e.dataset;return t.tenantId&&t.contactId?{tenantId:t.tenantId,contactId:t.contactId,oppId:t.oppId||void 0}:t.tenantId&&t.oppId?{tenantId:t.tenantId,contactId:"",oppId:t.oppId}:Pl()},bu=e=>{let t=(e||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(t)||/assignment.*(contract|agreement)/i.test(t)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(t)||/purchase.*(contract|agreement)/i.test(t)?"PA":"passthrough"},Bl="__WS_CRM_TEMPLATES_CACHE_V1",hu=24*60*60*1e3,Ml=e=>{try{let t=window.localStorage.getItem(Bl);if(!t)return null;let o=JSON.parse(t);return o.tenantId!==e||Date.now()-o.cachedAt>hu?null:o.templates}catch{return null}},uu=(e,t)=>{try{let o={tenantId:e,templates:t,cachedAt:Date.now()};window.localStorage.setItem(Bl,JSON.stringify(o))}catch{}},vu=async e=>{let t=`${ke}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(e)}&skip=0&limit=10`,o;try{o=await ct(t,{method:"GET"})}catch(s){let l=Ml(e);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Ml(e);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:bu(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&uu(e,i),i},_u=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await ct(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},gu=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET",headers:pt()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let m=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-m})},yu=async e=>{let t=await fetch(lu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,template_id:e.templateId,template_type:e.templateType,opp_id:e.oppId,closing_date:e.closingDate,buyer_earnest_due_date:e.buyerEarnestDueDate,lender_source:e.lenderSource,triggered_by_user_id:e.userId,overrides:e.overrides}),credentials:"omit"});if(!t.ok)throw new Error(`Contract.Stage HTTP ${t.status}`);return await t.json()},fu=async(e,t,o)=>{let r=`${ke}/proposals/templates/to-proposal/${e}/${t}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:pt()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},xu=async(e,t)=>{let o=await fetch(`${ke}/proposals/document/${t}?locationId=${encodeURIComponent(e)}`,{method:"GET",headers:pt()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${t} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},wu=async e=>{let t=await fetch(`${ke}/contacts/${e}`,{method:"GET",headers:pt()});if(!t.ok){let a=await t.text().catch(()=>"");throw new Error(`GET contact ${e} HTTP ${t.status} ${a.slice(0,200)}`)}let o=await t.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},ku=async(e,t,o,r)=>{let a;try{a=await xu(e,t)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await wu(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||e,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},b=await fetch(`${ke}/proposals/document/${t}`,{method:"PUT",headers:{...pt(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!b.ok){let _=await b.text().catch(()=>"");return{ok:!1,status:b.status,body:_}}return{ok:!0}},Eu=(e,t)=>{let o=`/v2/location/${e}/payments/proposals-estimates/edit/${t}`;window.location.href=o},sr="__WS_CRM_PENDING_INSTRUCTIONS",Tu=60*1e3,Su=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Cu=e=>{let t=(e||"").toLowerCase();for(let o of Su)if(t.includes(o.matches.toLowerCase()))return o;return null},Au=(e,t,o)=>{try{let r={proposalId:e,title:t,bodyHtml:o,ts:Date.now()};localStorage.setItem(sr,JSON.stringify(r))}catch{}},$u=()=>{try{let e=localStorage.getItem(sr);if(!e)return null;let t=JSON.parse(e);return!t?.proposalId||!t?.title||!t?.bodyHtml||Date.now()-(t.ts||0)>Tu?(localStorage.removeItem(sr),null):t}catch{return null}},Lu=()=>{try{localStorage.removeItem(sr)}catch{}},Iu=(e,t)=>{document.getElementById(fe)?.remove();let o=document.createElement("div");o.id=fe,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Mu=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ou=()=>{let e=window.location.pathname.match(Mu);if(!e)return;let t=e[1],o=$u();o&&o.proposalId===t&&(Lu(),window.setTimeout(()=>{Iu(o.title,o.bodyHtml)},600))},Ol="ws-crm-prepare-contract-toast",Y=(e,t="info",o=4e3)=>{document.getElementById(Ol)?.remove();let r=document.createElement("div");r.id=Ol;let a=t==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,e.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==e&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await vu(t.tenantId)}catch(i){o.innerHTML=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){Ku(o,s.properties,l=>{a(!0),Ia({tenantId:t,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?Ul(t,d.property_record_id,d):cr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),cr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?Ul(t,s.property_record_id,s):cr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await Ia({tenantId:t,contactId:e,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),cr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Yu=async()=>{for(let e of Wu)try{let t=await $(e,{timeoutMs:3e3});if(t)return t}catch{}return null},Wl=async(e,t)=>{let o=t.querySelector(`#${zl}`);if(!o)try{o=await $(`#${zl}`,{timeoutMs:3e3,root:t})}catch{o=null}return o?(e.style.order="3",o.appendChild(e),!0):!1},jl=()=>{let e=document.querySelectorAll(`#${Xe}`);for(let t=1;t<e.length;t++)e[t].remove()},Ju=async()=>{let e=H();if(!e||!e.locationId||e.source!=="url"){document.getElementById(Xe)?.remove(),mt();return}let t=e.locationId,o=document.getElementById(Xe);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove(),mt();let r="seller";try{r=Ce(await Se(e.contactId,t))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Xe)?.remove();return}let a=await Yu();if(!a){c.warn("[compute-offer] no central panel found");return}let i=H();if(!i||i.contactId!==e.contactId)return;let s=Vl(e.contactId,t);if(!await Wl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}jl(),c.debug(`[compute-offer] mounted for ${e.contactId}`);let l=new MutationObserver(()=>{if(H()?.contactId!==e.contactId){l.disconnect();return}if(!document.getElementById(Xe)){let d=Vl(e.contactId,t);Wl(d,a).then(()=>jl())}});l.observe(a,{childList:!0})},ro=null,Ql=()=>{let e=H()?.contactId??null;if(ro&&ro.id===e)return;let t=Ju().finally(()=>{ro?.promise===t&&(ro=null)});ro={id:e,promise:t}};var so="reos-theme-stylesheet",Ba="reos-theme-fonts",bt=!1,Xu=()=>{let e=document.getElementById(Ba);e&&e.remove()},Qu=`
/* ============================================
