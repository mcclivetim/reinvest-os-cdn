...
`;var sp=/^[A-Za-z0-9]{15,30}$/,to=t=>typeof t=="string"&&sp.test(t),Hs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ip=()=>{let t=window.WS_CRM_USER_ID;return to(t)?t:null},lp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(to(o))return o;return null},dp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Hs(e);if(!o)return null;let r=o.uid;if(to(r))return r;let a=o.claims;if(a&&to(a.user_id))return a.user_id}catch{}return null},cp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(to(a))return a}catch{}}}catch{}return null},H=()=>ip()||dp()||lp()||cp()||null,pp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Hs(e);return o?o.claims??o:null}catch{return null}},ye=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:pp()?.type==="agency"};var Ns="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",mp=`${Ns}/active-follow-up-get`,bp=`${Ns}/active-follow-up-set`,re="ws-crm-active-follow-up-button",kn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},hp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},up=async t=>{let e=await fetch(mp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},_p=async(t,e)=>{let o=await fetch(bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ne=(t,e)=>{let o=kn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Ds=t=>{let e=document.createElement("button");return e.type="button",e.id=re,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{nm(t,e,()=>Pn(t,e))}),o},Pn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Up(t,e),Ln()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}em(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},em=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
  ...
  `,g=w=>{let E=w.find(L=>L.code===i.stateCode);return`
    ...
    `},y=()=>{let w=i.granularity==="county"?so?.[i.stateCode||""]??[]:io?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),L=s.querySelector("#ws-buybox-value-list");if(!E||!L)return;let B=j=>{let U=j.toLowerCase().trim();if(!U){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}L.innerHTML=W.map(N=>`
  ...
  `,Lt(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Kh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},Lt(o,a);return}if(y.rate_limited){b=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Lt(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},Lt(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Br.add(t),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt(),Lo();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Gh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),Lt(o,a),document.getElementById(Or)&&Mr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},Lt(o,a),kt();try{let f=await Vh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},Lt(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},Lt(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},Lt(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},Lt(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Or)?kt():a.checks&&Mr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,c=!1,m=Date.now(),u=1e4,_=5*60*1e3,b=0,g=!1,x=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=So();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let A=Date.now()-m,T=Math.max(1500,u-A);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=A=>{let T=A.detail;if(!T||T.oppId!==t)return;ml(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}x()};E()};window.addEventListener(_a,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(_a,f),window.clearInterval($))},5e3)}return o},Zh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xh=async()=>{for(let t of Zh)try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Br=new Set,cl=null,tu=t=>{t&&t!==cl&&(Br.clear(),cl=t)},Pr=!1,ga=async()=>{if(Pr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Pr=!0;try{await eu()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Pr=!1}},eu=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=So();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),tu(t.oppId),Br.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt();return}let e=document.getElementById(Gt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(le)?.remove(),kt(),Lo());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(le)?.remove(),kt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Xh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=So();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Qh(t.oppId,a.locationId),i=document.createElement("span");i.id=le,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),ou(t.oppId)},Ao=null,va=null,Lo=()=>{Ao?.disconnect(),Ao=null,va=null},ou=t=>{if(Ao&&va===t)return;Lo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(va=t,Ao=new MutationObserver(()=>{let o=So();if(!o||o.oppId!==t){Lo();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt(),Lo();return}document.getElementById(Gt)||ga()}),Ao.observe(e,{childList:!0,subtree:!0}))},ru=()=>{J("send-to-closing",tt,()=>{if(document.getElementById(Gt)||Pr)return;let t=So();t&&Br.has(t.oppId)||ga()})},hl=()=>{ru(),ga()};var wa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",nu=`${wa}/tc/welcome-call-prefill`,au=`${wa}/tc/welcome-call-save`,su=`${wa}/tc/order-lockbox`,Io="ws-crm-welcome-call-overlay",iu=["Regular Contract","Subject To","Seller Finance","Novation"],lu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],du=["Gas","Electric","Propane","Oil"],cu=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],pu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Kt=["Yes","No"],mu=["Yes","No","Unknown"],bu=["Professional Photographer","Seller","Tenant"],hu=["Month-to-Month","Annual"],ul=["Current","Behind"],uu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],St=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Hr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,yl="margin-bottom:12px;",gl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,_u=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,_l=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=_l(o);return`<select id="${t}" style="${Hr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&_l(a)===r?"selected":""}>${St(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${St(e)}" placeholder="${St(o)}" style="${Hr}">`,vu=(t,e)=>`<textarea id="${t}" rows="3" style="${Hr}resize:vertical;">${St(e)}</textarea>`,yu=(t,e)=>`<input id="${t}" type="date" value="${St(e)}" style="${Hr}">`,F=(t,e)=>`<div style="${yl}"><label style="${gl}">${St(t)}</label>${e}</div>`,fa=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${uu.map(r=>`<label style="${_u}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${St(t)}</div>`,Pe=()=>{document.getElementById(Io)?.remove()},de=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},gu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
  ...
  `,e.addEventListener("click",()=>{Jr(t)}),Vr(e),setTimeout(()=>Vr(e),200),setTimeout(()=>Vr(e),800),hv(),e},Sd=!1,hv=()=>{Sd||(Sd=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Ht);t instanceof HTMLButtonElement&&Vr(t)}))},ns=!1,uv=()=>{if(!ns){ns=!0;try{let t=Pd();if(!t){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}let e=document.getElementById(Ht);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ht}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ht}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
