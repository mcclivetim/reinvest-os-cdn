/* Wholesaling CRM Customizer v0.16.6 — built 2026-05-31T15:52:37.201Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Xe="[wholesaling-crm-customizer]",hn="__WS_CRM_DEBUG",pn=()=>!!window[hn],b={info(...t){console.log(Xe,...t)},warn(...t){console.warn(Xe,...t)},error(...t){console.error(Xe,...t)},debug(...t){pn()&&console.log(Xe,"[debug]",...t)}};var Fo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nt=/\/v2\/location\/([A-Za-z0-9]+)/,mn=t=>{let e=t.match(Fo);if(!e)return null;let o=t.match(Nt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},un=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(Fo);if(!n)continue;let s=r.match(Nt)||window.location.pathname.match(Nt);return{contactId:n[1],locationId:s?s[1]:null,source:"dom"}}return null},L=()=>{let t=mn(window.location.pathname);return t||un()};var Oo=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Qe="",Rt=null,ve="other",Bt=new Set,Je=()=>{let t=L()?.contactId??null;if(!(!(window.location.pathname!==Qe)&&!(t!==Rt))){Qe=window.location.pathname,Rt=t,ve=Oo(),b.debug("Page/context changed:",ve,Qe,"contact:",t);for(let r of Bt)try{r(ve)}catch(n){b.error("Subscriber threw:",n)}}},Po=t=>(Bt.add(t),setTimeout(()=>t(ve),0),()=>{Bt.delete(t)}),Ho=()=>{ve=Oo(),Qe=window.location.pathname,Rt=L()?.contactId??null,b.debug("Router init, current page:",ve);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Je()},history.replaceState=function(o,r,n){e(o,r,n),Je()},window.addEventListener("popstate",Je),setInterval(Je,1e3)};var Ze="0.16.6",et="2026-05-31T15:52:37.201Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((s,i)=>{let l=n.querySelector(t);if(l){s(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),s(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),s(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var a={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},f={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Gt={purple:"#8B5CF6",green:a.emerald,orange:a.amber,red:a.crimson},No=t=>{let e=t==="emerald"?a.emeraldGlow:t==="amber"?a.amberGlow:a.slate,o=t==="emerald"?a.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":a.steel,r=t==="emerald"?a.emerald:t==="amber"?a.amber:a.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,C=`
  ...
  flex-shrink: 0;
`;var vn=/^[A-Za-z0-9]{15,30}$/,Ce=t=>typeof t=="string"&&vn.test(t),_n=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},yn=()=>{let t=window.WS_CRM_USER_ID;return Ce(t)?t:null},gn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ce(o))return o;return null},fn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);if(!o)return null;let r=o.uid;if(Ce(r))return r;let n=o.claims;if(n&&Ce(n.user_id))return n.user_id}catch{}return null},wn=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(Ce(n))return n}catch{}}}catch{}return null},A=()=>yn()||gn()||fn()||wn()||null;var zo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",xn=`${zo}/active-follow-up-get`,kn=`${zo}/active-follow-up-set`,ce="ws-crm-active-follow-up-button",qt={amber:{label:"Add to Active Follow Up",bg:a.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:a.amber,clickable:!0,dotColor:a.amber},blue:{label:"In Active Follow Up",bg:a.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:a.blue,clickable:!1,dotColor:a.blue},gray:{label:"Not in Follow Up",bg:a.slate,border:a.steel,color:a.coolGray,clickable:!1,dotColor:a.coolGray},loading:{label:"Active Follow Up\u2026",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.ash},error:{label:"Follow Up status unavailable",bg:a.slate,border:a.steel,color:a.ash,clickable:!1,dotColor:a.crimson}},En=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Tn=async t=>{let e=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Sn=async(t,e)=>{let o=await fetch(kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},be=(t,e)=>{let o=qt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},Ro=t=>{let e=document.createElement("button");return e.type="button",e.id=ce,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,be(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=En();if(!(!r||r.contactId!==t)){be(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Sn(r,A()),s=n&&n.state&&n.state in qt?n.state:"blue";be(e,s),b.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),be(e,"error"),setTimeout(()=>void tt(e,r),4e3)}}}),e},tt=async(t,e)=>{be(t,"loading");try{let o=await Tn(e),r=o&&o.state&&o.state in qt?o.state:"gray",n=document.getElementById(ce);if(!n||n.dataset.contactId!==e.contactId)return;be(n,r)}catch(o){b.warn("Active Follow Up Get webhook failed",o),be(t,"error")}},Cn=[".central-panel","[class*='central-panel']"],zt="ws-crm-contact-actions-bar",In=async()=>{for(let t of Cn)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},An=async(t,e)=>{let o=e.querySelector(`#${zt}`);if(!o)try{o=await I(`#${zt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${zt}`);s&&s.parentElement===e?e.insertBefore(n,s.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},Ln=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},Mn=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},$n=async t=>{if(t==="url"){let o=await In();return o?{kind:"contact-detail",target:o}:null}let e=Ln();return e?{kind:"conversations",target:e}:null},Bo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await An(t,e.target);return o}return Mn(t,e.target),"conversations-header"},Dn=async()=>{let t=L();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(ce);if(o&&o.dataset.contactId===e.contactId){tt(o,e);return}o&&o.remove();let r=await $n(t.source);if(!r){b.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=L();if(!n||n.contactId!==e.contactId)return;let s=Ro(e.contactId),i=await Bo(s,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Go();let l=document.getElementById(ce)??s;tt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(ce);if(!(L()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Ro(e.contactId);Bo(m,r).then(()=>{Go(),tt(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ie=null,qo=()=>{let t=L()?.contactId??null;if(Ie&&Ie.contactId===t)return;let e=Dn().finally(()=>{Ie?.promise===e&&(Ie=null)});Ie={contactId:t,promise:e}},Go=()=>{let t=document.querySelectorAll(`#${ce}`);if(!(t.length<=1)){b.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ne="ws-crm-claim-release-pill",Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",On="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Pn=async t=>{let e=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Hn=async t=>{let e=await fetch(On,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Wo=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},_e=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?a.emerald:a.amber;t.dataset.mode=e,t.style.cssText=No(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Nn=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ne,o.type="button",o.dataset.contactId=t,_e(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=L();if(!n||!n.locationId||n.contactId!==t)return;let s=A();if(!s){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>_e(o,r),2500);return}b.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";_e(o,i),o.disabled=!0,o.style.opacity="0.8";try{let l=await Hn({contactId:t,locationId:n.locationId,userId:s,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:i;_e(o,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),_e(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Uo=async(t,e)=>{try{let o=await Pn({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(ne);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";_e(r,n)}catch(o){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Rn=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Wo(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Vo=(t,e)=>{let o=Nn({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ne}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Bn=async()=>{let t=L();if(!t){document.getElementById(ne)?.remove();return}let e=document.getElementById(ne);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await I("#record-details-lhs",{timeoutMs:1e4}),r=await Rn(o),n=L();if(!n||n.contactId!==t.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Vo(r,t.contactId),b.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let s=document.getElementById(ne);s&&t.locationId&&Uo(s,{contactId:t.contactId,locationId:t.locationId});let i=null;i=new MutationObserver(async()=>{if(!(L()?.contactId===t.contactId)){i?.disconnect();return}if(document.getElementById(ne))return;let d=Wo(o);if(d){Vo(d,t.contactId);let c=document.getElementById(ne);c&&t.locationId&&Uo(c,{contactId:t.contactId,locationId:t.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(o,{childList:!0,subtree:!0})}catch(o){b.warn("Could not mount Claim/Release pill:",o)}}},jo=()=>{Bn()};var Gn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Ae=new Map,Ko=async(t,e)=>{if(!t)return null;if(Ae.has(t))return Ae.get(t)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${Gn}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,s=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!s.ok)return b.warn(`Contact Type fetch returned ${s.status} for ${t}`),Ae.set(t,null),null;let l=((await s.json()).contact_type||"").toLowerCase().trim()||null;return Ae.set(t,l),b.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${t}:`,n),Ae.set(t,null),null}};var Yo=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var tr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Un=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:s,kind:i})=>{let l=s||tr,d;if(i==="buyer"){let h=or.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Vn=async({contactId:t,tenantId:e})=>{let o=await fetch(qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var ye="ws-crm-contact-actions-bar",Wn="ws-crm-call-status-dropdown",Xo="ws-crm-offer-made-modal",jn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],or=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Kn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Yn=async()=>{for(let t of Kn)try{let e=await I(t,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await I("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await I(t,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Xn=({contactId:t,kind:e})=>{let o=e==="buyer"?or:jn,r=e==="buyer"?zn:tr,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Wn,s.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=C,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Gt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=a.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=Gt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let w=L()?.locationId,k=A();if(!w){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=a.amber);return}if(e==="seller"&&d.color==="green"&&!k){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=a.amber);return}let g=p?.textContent??"\u25BE",_=async y=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await Un({contactId:t,locationId:w,status:d.label,userId:k,deadReason:y,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=g),i.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=a.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=g),m&&(m.style.color=a.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";ea(E=>{_(E)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await Vn({contactId:t,tenantId:w})).ok?await _():ta(()=>{_()},()=>{m&&(m.textContent=y)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await _()}return}await _()}),l.appendChild(c)}),i.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{s.contains(d.target)||(l.style.display="none")}),s.appendChild(i),s.appendChild(l),s},Jn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Qn=async t=>{let e=await fetch(Jn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Zn=(t,e="seller")=>{document.getElementById(Xo)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",s=o?a.emerald:a.amber,i=document.createElement("div");i.id=Xo,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let d=new Date,c=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),h=o?`
    <label style="
      display: block;
      font-family: ${u.mono};
      font-size: 10px;
  ...
  `,i.appendChild(l),document.body.appendChild(i);let m=()=>i.remove();i.addEventListener("click",k=>{k.target===i&&m()});let p=l.querySelector("#ws-offer-error"),v=l.querySelector("#ws-offer-cancel"),w=l.querySelector("#ws-offer-submit");v?.addEventListener("click",m),w?.addEventListener("click",async()=>{let k=(l.querySelector("#ws-offer-amount")?.value??"").trim(),g=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!k||Number(k)<=0){p&&(p.textContent="Enter a positive offer amount."),b.warn("Offer Made submit blocked \u2014 invalid amount");return}let _=Number(k);if(_<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(_*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),w&&(w.disabled=!0,w.textContent="Recording\u2026",w.style.opacity="0.7"),v&&(v.disabled=!0);try{let x=await Qn({tenantId:T,contactId:t,kind:e,amount:_,expiresAt:g||null,userId:A()});if(!x.ok){p&&(p.textContent=x.error??"Something went wrong."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),v&&(v.disabled=!1);return}b.info(`Offer Made (${e}) recorded for contact ${t}: $${_} on ${x.opp_pipeline} opp (stage: ${x.opp_stage_name??"?"})`),m()}catch(x){b.error("Offer Made webhook failed",x),p&&(p.textContent=x instanceof Error?x.message:"Network error \u2014 try again."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),v&&(v.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Jo="ws-crm-dead-deal-modal",ea=(t,e)=>{document.getElementById(Jo)?.remove();let o=document.createElement("div");o.id=Jo,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),s=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let i=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},Zo=(t,e)=>{let o=document.createElement("div");if(o.id=ye,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${a.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=ee,r.textContent="Offer Made",r.addEventListener("click",()=>Zn(t,e)),o.appendChild(r),o.appendChild(Xn({contactId:t,kind:e}))}return o},Ut=!1,oa=()=>{document.querySelectorAll(`[id="${ye}"]`).forEach(t=>t.remove())},rr=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ut){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ut=!0;try{await ra()}finally{Ut=!1}},ra=async()=>{let t=L();if(!t){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),oa();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Ko(t.contactId,t.locationId),h=Yo(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=L();if(!o||o.contactId!==t.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ye}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await Yn();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let s=L();if(!s||s.contactId!==t.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Zo(t.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(ye)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(L()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${ye}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Zo(t.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(n,{childList:!0})},er=null,na=()=>{er===null&&(er=window.setInterval(()=>{let t=L();t&&(document.getElementById(ye)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),rr()))},3e3))},nr=()=>{na(),rr()};var ot="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",aa=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Le="data-ws-crm-favicon",Vt=t=>t.hasAttribute(Le),ar=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return aa.has(e)},rt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ar(r)&&!Vt(r)&&r.remove()});let e=document.head.querySelector(`link[${Le}="1"]`);e?e.href!==ot&&(e.href=ot):(e=document.createElement("link"),e.setAttribute(Le,"1"),e.rel="icon",e.type="image/png",e.href=ot,document.head.appendChild(e),b.debug("Favicon installed"));let o=document.head.querySelector(`link[${Le}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Le,"apple"),o.rel="apple-touch-icon",o.href=ot,document.head.appendChild(o))},sr=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)rt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),rt())},50)}new MutationObserver(r=>{let n=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ar(i)&&!Vt(i)&&(n=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Vt(i)&&(n=!0)});n&&rt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,rt(),e>=5&&window.clearInterval(o)},1e3)};var sa=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ia=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,la=".hr-card.hr-modal.crm-opportunities-modal",$=()=>{let t=document.querySelector(la);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(ia);if(n){let s=n[1];if(sa.includes(s))return s}}return null},X=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=$();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var da="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",U="ws-crm-mt-offer-made-button",ir="ws-crm-mt-offer-made-modal",ca=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ba=/\/v2\/location\/([A-Za-z0-9]+)/,st=()=>{let t=window.location.pathname,e=t.match(ca);if(!e)return null;let o=t.match(ba);return{oppId:e[1],locationId:o?o[1]:null}},ha=async t=>{let e=await fetch(da,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},nt=()=>{document.getElementById(ir)?.remove()},pa=t=>{nt();let e=document.createElement("div");e.id=ir,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),n=o.querySelector("#ws-mt-offer-error"),s=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),s?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&nt()}),s?.addEventListener("click",()=>nt()),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{let h=await ha({oppId:t.oppId,locationId:t.locationId,amount:c,userId:A()});if(!h.ok){n.textContent=h.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1);return}nt(),t.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1)}})},ma=t=>{let e=document.createElement("button");return e.id=U,e.type="button",e.dataset.oppId=t,e.style.cssText=C,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=st();!o||!o.locationId||o.oppId!==t||pa({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=a.emeraldGlow,e.style.color=a.emeraldBright,e.style.borderColor=a.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=C)},4e3)}})}),e},ua=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],va=async()=>{for(let t of ua)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},at=!1,Yt=async()=>{if(!at){at=!0;try{await _a()}finally{at=!1}}},_a=async()=>{let t=st();if(!t||!t.locationId){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e();return}let e=document.getElementById(U);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e());return}e&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove());let o=await va();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=st();if(!n||n.oppId!==t.oppId)return;let s=ma(t.oppId),i=document.createElement("span");i.id=`${U}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ya(t.oppId)},Me=null,Kt=null,$e=()=>{Me?.disconnect(),Me=null,Kt=null},ya=t=>{if(Me&&Kt===t)return;$e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kt=t,Me=new MutationObserver(()=>{let o=st();if(!o||o.oppId!==t){$e();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),$e();return}document.getElementById(U)||Yt()}),Me.observe(e,{childList:!0,subtree:!0}))},Wt=null,jt,ga=()=>{Wt||(Wt=new MutationObserver(()=>{jt===void 0&&(jt=window.setTimeout(()=>{jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);t&&!e&&!at&&Yt()},300))}),Wt.observe(document.body,{childList:!0,subtree:!0}))},lr=()=>{ga(),Yt()};var fa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",V="ws-crm-not-interested-button",wa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xa=/\/v2\/location\/([A-Za-z0-9]+)/,lt=()=>{let t=window.location.pathname,e=t.match(wa);if(!e)return null;let o=t.match(xa);return{oppId:e[1],locationId:o?o[1]:null}},ka=async t=>{let e=await fetch(fa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ea=t=>{let e=document.createElement("button");return e.id=V,e.type="button",e.dataset.oppId=t,e.style.cssText=C,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=lt();if(!o||!o.locationId||o.oppId!==t)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let s=await ka({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=a.crimsonGlow,e.style.color=a.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){b.error("Not Interested webhook failed",s),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Ta=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sa=async()=>{for(let t of Ta)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},it=!1,Zt=async()=>{if(!it){it=!0;try{await Ca()}finally{it=!1}}},Ca=async()=>{let t=lt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await Sa();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=lt();if(!n||n.oppId!==t.oppId)return;let s=Ea(t.oppId),i=document.createElement("span");i.id=`${V}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ia(t.oppId)},De=null,Qt=null,Fe=()=>{De?.disconnect(),De=null,Qt=null},Ia=t=>{if(De&&Qt===t)return;Fe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qt=t,De=new MutationObserver(()=>{let o=lt();if(!o||o.oppId!==t){Fe();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),Fe();return}document.getElementById(V)||Zt()}),De.observe(e,{childList:!0,subtree:!0}))},Xt=null,Jt,Aa=()=>{Xt||(Xt=new MutationObserver(()=>{Jt===void 0&&(Jt=window.setTimeout(()=>{Jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!it&&Zt()},300))}),Xt.observe(document.body,{childList:!0,subtree:!0}))},dr=()=>{Aa(),Zt()};var La="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",W="ws-crm-reduce-price-button",cr="ws-crm-reduce-price-modal",Ma=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$a=/\/v2\/location\/([A-Za-z0-9]+)/,bt=()=>{let t=window.location.pathname,e=t.match(Ma);if(!e)return null;let o=t.match($a);return{oppId:e[1],locationId:o?o[1]:null}},Da=async t=>{let e=await fetch(La,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},dt=()=>{document.getElementById(cr)?.remove()},Fa=t=>{dt();let e=document.createElement("div");e.id=cr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),s=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),s?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&dt()}),s?.addEventListener("click",()=>{dt()}),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{await Da({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:A()}),dt(),t.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",s&&(s.disabled=!1)}})},Oa=(t,e)=>{let o=document.createElement("button");return o.id=W,o.type="button",o.dataset.oppId=t,o.style.cssText=C,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=bt();!r||!r.locationId||r.oppId!==t||Fa({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=a.emeraldGlow,o.style.color=a.emeraldBright,o.style.borderColor=a.emeraldBorder,s&&(s.style.background=a.emerald,s.style.boxShadow=`0 0 6px ${a.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=C,s&&(s.style.background=a.amber,s.style.boxShadow=`0 0 6px ${a.amber}`))},4e3)}})}),o},Pa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ha=async()=>{for(let t of Pa)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ct=!1,ro=async()=>{if(!ct){ct=!0;try{await Na()}finally{ct=!1}}},Na=async()=>{let t=bt();if(!t||!t.locationId){document.getElementById(W)?.remove(),document.getElementById(`${W}-wrap`)?.remove(),Pe();return}let e=document.getElementById(W);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${W}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${W}-wrap`)?.remove());let o=await Ha();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=bt();if(!n||n.oppId!==t.oppId)return;let s=Oa(t.oppId,t.locationId),i=document.createElement("span");i.id=`${W}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Ra(t.oppId)},Oe=null,oo=null,Pe=()=>{Oe?.disconnect(),Oe=null,oo=null},Ra=t=>{if(Oe&&oo===t)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(oo=t,Oe=new MutationObserver(()=>{let o=bt();if(!o||o.oppId!==t){Pe();return}let r=$();if(r!==null&&r!=="Disposition"){document.getElementById(W)?.remove(),document.getElementById(`${W}-wrap`)?.remove(),Pe();return}document.getElementById(W)||ro()}),Oe.observe(e,{childList:!0,subtree:!0}))},eo=null,to,Ba=()=>{eo||(eo=new MutationObserver(()=>{to===void 0&&(to=window.setTimeout(()=>{to=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);t&&!e&&!ct&&ro()},300))}),eo.observe(document.body,{childList:!0,subtree:!0}))},br=()=>{Ba(),ro()};var mr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ae="ws-crm-send-to-closing-office-button",he="ws-crm-send-to-title-co-wrap",mt="ws-crm-stc-dropdown",Ga=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,za=/\/v2\/location\/([A-Za-z0-9]+)/,ut=()=>{let t=window.location.pathname,e=t.match(Ga);if(!e)return null;let o=t.match(za);return{oppId:e[1],locationId:o?o[1]:null}},qa=5*60*1e3,ur=t=>`ws-crm-stc-cache:${t}`,Ua=t=>{try{let e=window.localStorage.getItem(ur(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>qa||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Va=(t,e)=>{try{window.localStorage.setItem(ur(t),JSON.stringify(e))}catch{}},Wa=async(t,e)=>{try{let o=await fetch(mr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},ja=async(t,e,o)=>{let r=await fetch(mr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:A()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Ka=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},hr=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${a.emerald}, 0 0 18px ${a.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Ya=(t,e)=>{if(e&&Ka(e)){window.setTimeout(()=>hr(t),300);return}hr(t)},j=()=>{document.getElementById(mt)?.remove()},ht=(t,e,o)=>{j();let r=document.createElement("div");r.id=mt;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(v=>{h[v.group]||(h[v.group]=[]),h[v.group].push(v)});let m=[...c.filter(v=>h[v]),...Object.keys(h).filter(v=>!c.includes(v))];for(let v of m){let w=h[v],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${a.steel};
    `,g.textContent=v,k.appendChild(g),w.forEach(_=>{let y=document.createElement("div"),E=!_.filled&&_.navigable&&_.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(y.addEventListener("mouseenter",()=>{y.style.background=a.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",S=>{S.stopPropagation(),_.field_id&&(Ya(_.field_id,_.folder),j())}));let T=_.filled?`<span style="color: ${a.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${a.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,x=E?`<span style="margin-left: auto; color: ${a.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${x}`,k.appendChild(y)}),r.appendChild(k)}document.body.appendChild(r);let p=v=>{let w=v.target;!r.contains(w)&&!o.contains(w)&&(j(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},J=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),n=t.querySelector(".ws-stc-chevron"),s,i,l=a.bone,d,c="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":s="transparent",i=a.steel,l=a.ash,d=a.coolGray,c="Checking\u2026",m="wait",p="0.8";break;case"ready":s=a.emerald,i=a.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let v=e.checks?.filter(k=>k.filled).length??0,w=e.checks?.length??0;s="transparent",i=a.amber,l=a.amber,d=a.amber,c=`${v} of ${w} fields ready`,h="\u25BE";break}case"sending":s=a.emerald,i=a.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",p="0.8";break;case"sent":s=a.emerald,i=a.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",i=a.amber,l=a.amber,d=a.amber,c=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=l,t.style.cursor=m,t.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=c),n&&(n.textContent=h)},Xa=(t,e)=>{let o=document.createElement("button");o.id=ae,o.type="button",o.dataset.oppId=t;let r=Ua(t),n=r?{status:r.checks.every(g=>g.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${ee}
    background: transparent;
    border: 1px solid ${a.steel};
    color: ${a.ash};
  ...
  `,J(o,n);let s=new Set,i=async()=>{if(n.status==="sending")return;let g=await Wa(t,e);if(!g){n={status:"error",message:"Check failed \u2014 click to retry"},J(o,n);return}if(g.rate_limited){v=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},J(o,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){n={status:"error",message:g.error||"Check failed \u2014 click to retry"},J(o,n),b.warn("[stc] dry_run returned no checks:",g);return}let _=g.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button + caching`),vt.add(t),document.getElementById(ae)?.remove(),document.getElementById(he)?.remove(),j(),Ne();return}let y=g.checks;if(n.checks&&n.checks.length===g.checks.length){let T=new Set;y=g.checks.map((x,S)=>n.checks[S]?.filled&&!x.filled?s.has(x.label)?x:(T.add(x.label),{...x,filled:!0}):x),s=T}else s=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:g.previously_sent_at??null},Va(t,{checks:y,previously_sent_at:g.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),J(o,n),document.getElementById(mt)&&ht(y,g.previously_sent_at,o)},l=async()=>{let g=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},J(o,n),j();try{let _=await ja(t,e,g);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},J(o,n),_.checks&&ht(_.checks,_.previously_sent_at,o);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},J(o,n),window.setTimeout(()=>{w()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},J(o,n),_.checks&&ht(_.checks,_.previously_sent_at,o)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},J(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(mt)?j():n.checks&&ht(n.checks,n.previouslySentAt,o);break}case"error":case"sent":w();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,v=0,w=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await i()}finally{c=!1}}};w();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let g=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-h,E=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&w()},E)});g.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return o},Ja=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qa=async()=>{for(let t of Ja)try{let e=await I(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},vt=new Set,pr=null,Za=t=>{t&&t!==pr&&(vt.clear(),pr=t)},pt=!1,io=async()=>{if(pt){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}pt=!0;try{await es()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{pt=!1}},es=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=ut();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ae)?.remove(),document.getElementById(he)?.remove(),j();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Za(t.oppId),vt.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ae)?.remove(),document.getElementById(he)?.remove(),j();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=$();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(he)?.remove(),j(),Ne());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(he)?.remove(),j()),b.debug("[stc] mount:04 calling findMountTarget");let o=await Qa();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=$();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=ut();if(!n||n.oppId!==t.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Xa(t.oppId,n.locationId),i=document.createElement("span");i.id=he,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),ts(t.oppId)},He=null,so=null,Ne=()=>{He?.disconnect(),He=null,so=null},ts=t=>{if(He&&so===t)return;Ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(so=t,He=new MutationObserver(()=>{let o=ut();if(!o||o.oppId!==t){Ne();return}let r=$();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ae)?.remove(),document.getElementById(he)?.remove(),j(),Ne();return}document.getElementById(ae)||io()}),He.observe(e,{childList:!0,subtree:!0}))},no=null,ao,os=()=>{no||(no=new MutationObserver(()=>{ao===void 0&&(ao=window.setTimeout(()=>{ao=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);if(t&&!e&&!pt){let o=ut();if(o&&vt.has(o.oppId))return;io()}},300))}),no.observe(document.body,{childList:!0,subtree:!0}))},vr=()=>{os(),io()};var rs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ns="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",as="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",gr="ldtyB2UXKi9vOp8nLUH7",ss="WVD2gb9swLsgcdBEtDVq",K="ws-crm-closing-agent-picker-button",fr="ws-crm-closing-agent-picker-modal",is=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ls=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let t=window.location.pathname,e=t.match(is);if(!e)return null;let o=t.match(ls);return{oppId:e[1],locationId:o?o[1]:null}},vo=async t=>{let e=await fetch(rs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},_r=async t=>{let e=await fetch(ns,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ds=async(t,e)=>{try{let o=await fetch(as,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:gr}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let s=await vo({tenantId:e,contactId:n,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},pe=null,cs=60*60*1e3,_o=t=>`ws-crm-to-cache:${t}`,wr=t=>{try{let e=window.localStorage.getItem(_o(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>cs||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},xr=(t,e,o)=>{try{window.localStorage.setItem(_o(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},bs=t=>{try{window.localStorage.removeItem(_o(t))}catch{}},ho="ws-crm-closing-agent-field-link",hs=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${ho}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},lo=!1,yo=async t=>{if(lo)return;let e=kr();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){lo=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await vo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),po(n.id,n.name,t);let s=document.getElementById(K);if(s){se(s,{status:"linked",contactName:n.name});let i=Ge();i&&xr(i.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{lo=!1}}},ps=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,kr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();ps.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},po=(t,e,o)=>{let r=kr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${ho}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let l=document.createElement("a");l.className=ho,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${f.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),s.appendChild(l)}}},_t=()=>{document.getElementById(fr)?.remove()},ms=t=>{_t();let e=document.createElement("div");e.id=fr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&_t()}),s?.addEventListener("click",_t);let i,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${a.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${a.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await vo({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${a.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}n.innerHTML="",h.results.forEach(m=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${yt(m.name)}</div>
          <div style="color: ${a.ash}; font-size: 11px; margin-top: 2px;">
            ${yt(m.email||"(no email)")} \xB7 ${yt(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${yt(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=a.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{_t(),t.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${a.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(c)},250)})},yt=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),se=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",s=a.amber,i=a.bone,l="transparent",d=a.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",s=a.coolGray,i=a.ash,c="wait";break;case"empty":n="Link Closing Agent",s=a.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=a.emerald,l=a.emeraldGlow,d=a.emeraldBorder,i=a.emeraldBright;break;case"saving":n="Linking\u2026",s=a.coolGray,i=a.ash,c="wait";break}o&&(o.textContent=n),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),t.style.background=l,t.style.borderColor=d,t.style.color=i,t.style.cursor=c},us=(t,e)=>{let o=document.createElement("button");o.id=K,o.type="button",o.dataset.oppId=t,o.style.cssText=C,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};se(o,r);let n=wr(t);return n&&(r={status:"linked",contactName:n.contactName},se(o,r),pe={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let i=await ds(t,e);i?(r={status:"linked",contactName:i.name},se(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},po(i.id,i.name,e)):n||(r={status:"empty"},se(o,r),pe?.oppId===t&&(pe=null),hs(),bs(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ms({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},se(o,r);try{let l=[_r({tenantId:e,oppId:t,fieldId:gr,value:i.id})];i.companyName&&i.companyName.trim()&&l.push(_r({tenantId:e,oppId:t,fieldId:ss,value:i.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:i.name},se(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},xr(t,i.id,i.name),po(i.id,i.name,e),b.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},se(o,r)}}})}),o},vs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],_s=async()=>{for(let t of vs)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Re=!1,ft=async()=>{if(!Re){Re=!0;try{await ys()}finally{Re=!1}}},ys=async()=>{let t=Ge();if(!t||!t.locationId){document.getElementById(K)?.remove(),document.getElementById(`${K}-wrap`)?.remove(),gt();return}let e=document.getElementById(K);if(e&&e.dataset.oppId===t.oppId){let d=$();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${K}-wrap`)?.remove(),gt());return}e&&(e.remove(),document.getElementById(`${K}-wrap`)?.remove());let o=$();if(o!==null&&o!=="Transaction Coordination")return;let r=await _s();if(!r||!(wr(t.oppId)!==null||pe!==null&&pe.oppId===t.oppId)&&await X()!=="Transaction Coordination")return;let s=Ge();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=us(t.oppId,s.locationId),l=document.createElement("span");l.id=`${K}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(i),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),gs(t.oppId),yo(s.locationId)},Be=null,mo=null,uo=null,gt=()=>{Be?.disconnect(),Be=null,mo=null,uo=null},gs=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Be&&mo===t&&uo===e||(gt(),mo=t,uo=e,Be=new MutationObserver(()=>{let o=Ge();if(!o||o.oppId!==t||!o.locationId){gt();return}document.getElementById(K)||ft(),yo(o.locationId)}),Be.observe(e,{childList:!0,subtree:!0})))},co=null,bo,fs=()=>{co||(co=new MutationObserver(()=>{bo===void 0&&(bo=window.setTimeout(()=>{bo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(K);t&&!e&&!Re&&ft()},300))}),co.observe(document.body,{childList:!0,subtree:!0}))},yr,ws=()=>{yr===void 0&&(yr=window.setInterval(()=>{let t=Ge();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(K)&&!Re&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),ft()),yo(t.locationId)},2e3))},Er=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),fs(),ws(),ft()};var xs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",ge="ws-crm-manage-team-cta",Sr="ws-crm-manage-team-modal",ks=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Cr={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Es={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:a.blue},acq:{bg:a.emeraldGlow,fg:a.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:a.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:a.crimson}},Ir=()=>{let t=window.location.pathname.match(ks);return t?{tenantId:t[1]}:null},xt=async t=>{let e=await fetch(xs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},q=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ie=t=>q(t),go="ws-crm-manage-team-toast",xo=(t,e="info",o=4e3)=>{document.getElementById(go)?.remove();let r=e==="success"?a.emerald:e==="error"?a.crimson:a.ash,n=document.createElement("div");n.id=go,n.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,n.textContent=t,document.body.appendChild(n),o>0&&window.setTimeout(()=>{document.getElementById(go)===n&&n.remove()},o)},fo=()=>{document.getElementById(Sr)?.remove()},Ts=(t,e)=>{let o=Es[t]||{bg:a.slate,fg:a.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${q(e)}</span>
  `},Ss=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>Ts(i.key,i.display)).join(""),n=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Manager-only action"';return`
    <div data-user-id="${ie(t.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${a.ash};">
          ${q(t.email)}${t.phone?` &middot; ${q(t.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${n}" ${s}>
        <button class="ws-team-edit" data-email="${ie(t.email)}" data-user-id="${ie(t.id)}" data-name="${ie(o)}" data-current-roles="${ie(t.role_keys.join(","))}" style="${C} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${ie(t.email)}" data-name="${ie(o)}" data-role-count="${ie(String(t.role_keys.length))}" style="${C} font-size: 11px; padding: 5px 10px; border-color: ${a.crimson}; color: ${a.crimson};">Remove</button>
      </div>
    </div>
  `},Cs=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Ss(r,e)).join(""),kt=async t=>{fo();let e=document.createElement("div");e.id=Sr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&fo()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <button id="ws-team-close" style="${C} font-size: 12px;">Close</button>
    </div>
    ...
    <div id="ws-team-actions" style="display: flex; gap: 8px; justify-content: flex-end; padding-top: 16px; border-top: 1px solid ${a.steel};">
      <button id="ws-team-add" style="background: ${a.emerald}; color: ${a.obsidian}; border: none; border-radius: ${f.sm}; padding: 10px 18px; font-family: ${u.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">+ Add Employee</button>
    </div>
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",fo);let r;try{r=await xt({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${a.crimson};">
          Failed to load roster: ${q(d.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let d=o.querySelector("#ws-team-content");d&&(d.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${a.crimson};">
          ${q(r.error||"Unknown error loading roster")}
        </div>
      `);return}let n=A(),s=!!(n&&r.roster.some(d=>d.id===n&&d.role_keys.includes("manager"))),i=r.summary?`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=i+Cs(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Is(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let h=c.currentTarget;As(t,{email:h.dataset.email||"",name:h.dataset.name||"",currentRoles:(h.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let h=c.currentTarget;Ls(t,{email:h.dataset.email||"",name:h.dataset.name||"",roleCount:parseInt(h.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Is=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,s.innerHTML=`
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
      <button id="ws-team-add-cancel" style="${C} font-size: 12px;">Cancel</button>
      <button id="ws-team-add-submit" style="background: ${a.emerald}; color: ${a.obsidian}; border: none; border-radius: ${f.sm}; padding: 8px 18px; font-family: ${u.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Add Employee</button>
    </div>
  `,o.appendChild(s),document.body.appendChild(o),s.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),s.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let i=(s.querySelector("#ws-team-add-first")?.value||"").trim(),l=(s.querySelector("#ws-team-add-last")?.value||"").trim(),d=(s.querySelector("#ws-team-add-email")?.value||"").trim(),c=(s.querySelector("#ws-team-add-mobile")?.value||"").trim(),h=(s.querySelector("#ws-team-add-role")?.value||"").trim(),m=s.querySelector("#ws-team-add-error"),p=s.querySelector("#ws-team-add-submit");if(!i||!l||!d||!c||!h){m&&(m.textContent="All fields are required.");return}p&&(p.disabled=!0,p.textContent="Adding\u2026",p.style.opacity="0.7"),m&&(m.textContent="");try{let v=await xt({tenant_id:t,action:"add",first_name:i,last_name:l,email:d,mobile:c,role:h,triggered_by_user_id:A()});if(!v.ok){m&&(m.textContent=v.error||"Failed to add employee"),p&&(p.disabled=!1,p.textContent="Add Employee",p.style.opacity="1");return}o.remove(),xo(`Added ${i} ${l} as ${Cr[h]||h}.`,"success"),await kt(t)}catch(v){m&&(m.textContent=v.message),p&&(p.disabled=!1,p.textContent="Add Employee",p.style.opacity="1")}})},As=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let s=i=>{let l=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${a.slate}; border: 1px solid ${a.steel}; border-radius: ${f.sm}; cursor: pointer; margin-bottom: 6px;">
        <input type="checkbox" data-role-key="${i}" ${l} style="cursor: pointer;" />
        <span style="font-size: 13px;">${q(Cr[i])}</span>
      </label>
    `};n.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${q(e.name)}</div>
    <div style="font-size: 12px; color: ${a.ash}; margin-bottom: 16px;">${q(e.email)}</div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-edit-cancel" style="${C} font-size: 12px;">Cancel</button>
      <button id="ws-team-edit-submit" style="background: ${a.emerald}; color: ${a.obsidian}; border: none; border-radius: ${f.sm}; padding: 8px 18px; font-family: ${u.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Save Roles</button>
    </div>
  `,r.appendChild(n),document.body.appendChild(r),n.querySelector("#ws-team-edit-cancel")?.addEventListener("click",()=>r.remove()),n.querySelector("#ws-team-edit-submit")?.addEventListener("click",async()=>{let i=Array.from(n.querySelectorAll('input[type="checkbox"]')).filter(c=>c.checked).map(c=>c.dataset.roleKey||"").filter(Boolean),l=n.querySelector("#ws-team-edit-error"),d=n.querySelector("#ws-team-edit-submit");if(i.length===0){l&&(l.textContent="Select at least one role. To fully offboard, use Remove instead.");return}d&&(d.disabled=!0,d.textContent="Saving\u2026",d.style.opacity="0.7"),l&&(l.textContent="");try{let c=await xt({tenant_id:t,action:"update",email:e.email,roles:i,triggered_by_user_id:A()});if(!c.ok){l&&(l.textContent=c.error||"Failed to update roles"),d&&(d.disabled=!1,d.textContent="Save Roles",d.style.opacity="1");return}r.remove(),xo(`Updated roles for ${e.name}.`,"success"),await kt(t)}catch(c){l&&(l.textContent=c.message),d&&(d.disabled=!1,d.textContent="Save Roles",d.style.opacity="1")}})},Ls=(t,e)=>{let o="ws-crm-manage-team-remove-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,n.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${q(e.name)}</div>
    <div style="font-size: 13px; color: ${a.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${q(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
    <div style="font-size: 12px; color: ${a.ash}; line-height: 1.5; margin-bottom: 16px;">
      Their GHL user account stays intact (deactivation is a Phase 2 feature). Their open deals will need to be reassigned manually for now (auto-reassign is Phase 2 also).
    </div>

    <div id="ws-team-remove-error" style="color: ${a.crimson}; font-size: 11px; min-height: 16px;"></div>

    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-remove-cancel" style="${C} font-size: 12px;">Cancel</button>
      <button id="ws-team-remove-submit" style="background: ${a.crimson}; color: ${a.bone}; border: none; border-radius: ${f.sm}; padding: 8px 18px; font-family: ${u.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Remove from Team</button>
    </div>
  `,r.appendChild(n),document.body.appendChild(r),n.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),n.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=n.querySelector("#ws-team-remove-error"),i=n.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let l=await xt({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:A()});if(!l.ok){s&&(s.textContent=l.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),xo(`Removed ${e.name} from the team.`,"success"),await kt(t)}catch(l){s&&(s.textContent=l.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},Ms=89,$s=93,Ds=310,Fs=34,Os=14,Ps=14,Hs=3,wt=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+Ms;t.style.right=`${Math.max(r,16)}px`},Tr=t=>{let e=document.createElement("button");return e.id=ge,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${$s}px;
    right: 24px;
    width: ${Ds}px;
  ...
  `,e.addEventListener("click",()=>{kt(t)}),wt(e),setTimeout(()=>wt(e),200),setTimeout(()=>wt(e),800),window.addEventListener("resize",()=>wt(e)),e},Ns=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],Rs=async()=>{for(let t of Ns)try{let e=await I(t,{timeoutMs:1500});if(e)return e}catch{}return null},wo=!1,Bs=async()=>{if(!wo){wo=!0;try{let t=Ir();if(!t){document.getElementById(ge)?.remove();return}let e=document.getElementById(ge);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await Rs();if(!o){let s=document.createElement("div");s.id=`${ge}-floater`,s.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let i=Tr(t.tenantId);i.dataset.tenantId=t.tenantId,s.appendChild(i),document.body.appendChild(s),b.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=Tr(t.tenantId);r.dataset.tenantId=t.tenantId;let n=document.createElement("span");n.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",n.appendChild(r),o.appendChild(n),b.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{wo=!1}}},Ar=()=>{if(!Ir()){document.getElementById(ge)?.remove(),document.getElementById(`${ge}-floater`)?.remove();return}Bs()};var Gs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",To="ws-crm-prepare-contract-button",Lr="ws-crm-prepare-contract-menu",Z="ws-crm-prepare-contract-modal",Mr="ws-crm-modal-date-style",te="https://services.leadconnectorhq.com",Pr=()=>{if(document.getElementById(Mr))return;let t=document.createElement("style");t.id=Mr,t.textContent=`
    #${Z} input[type="date"] { color-scheme: dark; }
    #${Z} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(t)},So="__WS_CRM_CAPTURED_AUTH",zs=50*60*1e3,Hr=()=>{try{let t=localStorage.getItem(So);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>zs?(localStorage.removeItem(So),null):e:null}catch{return null}},qs=t=>{try{localStorage.setItem(So,JSON.stringify(t))}catch{}},oe=()=>{let t=Hr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},$r=!1,Us=()=>{if($r)return;$r=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=Hr()?.authorization;qs({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,v)=>m[v.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,v])=>m[p.toLowerCase()]=v);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,s=r.setRequestHeader,i=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),s.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),i.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Nr=()=>{let t=L();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Vs=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Nr()},Ws=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Rr="__WS_CRM_TEMPLATES_CACHE_V1",js=24*60*60*1e3,Dr=t=>{try{let e=window.localStorage.getItem(Rr);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>js?null:o.templates}catch{return null}},Ks=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Rr,JSON.stringify(o))}catch{}},Ys=async t=>{let e=`${te}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:oe()})}catch(i){let l=Dr(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw i}if(!o.ok){let i=Dr(t);if(i)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items);let s=n.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Ws(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Ks(t,s),s},Xs=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let s=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},Js=async(t,e)=>{let o=await fetch(`${te}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${te}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:oe()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Qs=async t=>{let e=await fetch(Gs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Zs=async(t,e,o)=>{let r=`${te}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:oe()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let s=await n.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},ei=async(t,e)=>{let o=await fetch(`${te}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:oe()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},ti=async t=>{let e=await fetch(`${te}/contacts/${t}`,{method:"GET",headers:oe()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},oi=async(t,e,o,r)=>{let n;try{n=await ei(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let s;try{s=await ti(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,l={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${te}/proposals/document/${e}`,{method:"PUT",headers:{...oe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let v=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:v}}return{ok:!0}},ri=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Tt="__WS_CRM_PENDING_INSTRUCTIONS",ni=60*1e3,ai=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],si=t=>{let e=(t||"").toLowerCase();for(let o of ai)if(e.includes(o.matches.toLowerCase()))return o;return null},ii=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Tt,JSON.stringify(r))}catch{}},li=()=>{try{let t=localStorage.getItem(Tt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ni?(localStorage.removeItem(Tt),null):e}catch{return null}},di=()=>{try{localStorage.removeItem(Tt)}catch{}},ci=(t,e)=>{document.getElementById(Z)?.remove();let o=document.createElement("div");o.id=Z,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},bi=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,hi=()=>{let t=window.location.pathname.match(bi);if(!t)return;let e=t[1],o=li();o&&o.proposalId===e&&(di(),window.setTimeout(()=>{ci(o.title,o.bodyHtml)},600))},Fr="ws-crm-prepare-contract-toast",F=(t,e="info",o=4e3)=>{document.getElementById(Fr)?.remove();let r=document.createElement("div");r.id=Fr;let n=e==="error"?a.crimson:a.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Or=(t,e)=>new Promise(o=>{document.getElementById(Z)?.remove();let r=document.createElement("div");r.id=Z,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let s=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},i=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${Q(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${a.slate};
          ...
          font-family: ${u.sans};
        ">
          <div style="font-size: 14px; font-weight: 500; line-height: 1.3;">${B(d.propertyAddress||d.name)}</div>
          ${d.updatedAt?`<div style="font-size: 11px; color: ${a.ash}; margin-top: 4px;">Last updated ${B(s(d.updatedAt))}</div>`:""}
        </button>
      `).join("");n.innerHTML=`
      <div style="
        font-family: ${u.mono};
      ...
      <div style="
        ...
        font-weight: 500;
        margin-bottom: 4px;
      ">This ${B(e.perspective)} has ${t.length} open deals</div>
      <div style="
        font-size: 12px;
        color: ${a.ash};
        margin-bottom: 16px;
        line-height: 1.4;
      ">Which property is this contract for? The ${B(e.agreementLabel)} will use that opp's data.</div>
      <div>${i}</div>
      <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
    ...
    `,r.appendChild(n),document.body.appendChild(r);let l=d=>{r.remove(),o(d)};r.addEventListener("click",d=>{d.target===r&&l(null)}),n.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>l(null)),n.querySelectorAll(".ws-pc-acq-opp").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.borderColor=a.emerald,d.style.background=a.graphite}),d.addEventListener("mouseleave",()=>{d.style.borderColor=a.steel,d.style.background=a.slate}),d.addEventListener("click",c=>{c.stopPropagation(),c.preventDefault();let h=d.dataset.oppId||"";h&&l(h)})})}),pi=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(Z)?.remove(),Pr();let n=r.debug||{},s=typeof n.propertyAddress=="string"?n.propertyAddress:"",i=typeof n.sellerName=="string"?n.sellerName:"",l=typeof n.purchasePrice=="number"?n.purchasePrice:0,d=typeof n.emd=="number"?n.emd:0,c=typeof n.cashAtClose=="number"?n.cashAtClose:l-d,h=n.daysToClose===void 0||n.daysToClose===null||n.daysToClose===""?"":String(n.daysToClose),m=n.inspectionDays===void 0||n.inspectionDays===null||n.inspectionDays===""?"":String(n.inspectionDays),p=typeof n.additionalTerms=="string"?n.additionalTerms:"",v=typeof n.currentOccupancy=="string"?n.currentOccupancy:"",w=typeof n.occupancyAtClose=="string"?n.occupancyAtClose:"",k=Array.isArray(n.occupancyOptions)&&n.occupancyOptions.length>0?n.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],g=document.createElement("div");g.id=Z,g.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,Y=`
    ...
    padding-right: 28px;
  `,Ke=D=>['<option value="">(unset)</option>'].concat(k.map(O=>`<option value="${Q(O)}"${O===D?" selected":""}>${B(O)}</option>`)).join("");_.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${S}">
        ...
        <div style="${x}">${B(s||"(set on Property record)")}</div>
      </div>
      <div style="${S}">
        <div style="${y}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Q(i)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${y}">Purchase Price</div>
        <div style="${M}">
          <span style="color: ${a.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-purchase-price" type="number" min="0" step="0.01" value="${l}" style="${T}" />
        </div>
      </div>
      <div style="${S}">
        ...
        <div style="${M}">
          <span style="color: ${a.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-emd" type="number" min="0" step="0.01" value="${d}" style="${T}" />
        </div>
      </div>
      <div style="${S}">
      ...
      <div style="${S}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${Q(h)}" placeholder="e.g. 30" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${y}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${Q(m)}" placeholder="e.g. 10" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${y}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${Y}">${Ke(v)}</select>
      </div>
      <div style="${S}">
        <div style="${y}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${Y}">${Ke(w)}</select>
      </div>
      <div style="${S} align-items: flex-start;">
        <div style="${y}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${E} resize: vertical; min-height: 60px; font-family: ${u.sans};">${B(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,g.appendChild(_),document.body.appendChild(g);let R=_.querySelector("#ws-pc-purchase-price"),le=_.querySelector("#ws-pc-emd"),re=_.querySelector("#ws-pc-cash-at-close"),de=!1;re?.addEventListener("input",()=>{de=!0});let fe=()=>{if(de)return;let D=Number(R?.value||0),O=Number(le?.value||0);re&&(re.value=String(Math.max(0,D-O)))};R?.addEventListener("input",fe),le?.addEventListener("input",fe);let Ye=()=>g.remove();g.addEventListener("click",D=>{D.target===g&&Ye()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Ye);let z=_.querySelector("#ws-pc-submit"),G=_.querySelector("#ws-pc-error");z?.addEventListener("click",async()=>{if(z){G&&(G.textContent=""),z.disabled=!0,z.textContent="Opening\u2026";try{let D=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),O=Number(R?.value||0),we=Number(le?.value||0),xe=Number(re?.value||0),ke=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ee=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Te=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ue=(_.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Se=(_.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(D!==i&&(P.sellerName=D),O!==l&&(P.purchasePrice=O),we!==d&&(P.emd=we),xe!==c&&(P.cashAtClose=xe),ke!==h&&(P.daysToClose=ke),Ee!==m&&(P.inspectionDays=Ee),Te!==p&&(P.additionalTerms=Te),ue!==v&&(P.currentOccupancy=ue),Se!==w&&(P.occupancyAtClose=Se),Object.keys(P).length>0){b.info("[prepare-contract] PA modal submit with overrides:",P),z.textContent="Saving\u2026";let Ot=A(),Pt=await St({tenantId:t,contactId:e,template:o,userId:Ot,overrides:P});b.info("[prepare-contract] re-stage with overrides ok:",Pt),z.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let H=s?`${s} - Purchase Agreement`:void 0;await Ao(t,e,o,H)}catch(D){z.disabled=!1,z.textContent="Open Contract",G&&(G.textContent=D.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",D)}}})},mi=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:s,defaultClosingDate:i,defaultEMDDueDate:l})=>{document.getElementById(Z)?.remove(),Pr();let d=n.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,w=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",g=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",_=i,y=l,E="",T=document.createElement("div");T.id=Z,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;x.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${R}">
        <div style="${S}">Property Address</div>
        <div style="${Ke}">${B(c||"(set on Property record)")}</div>
      </div>
      <div style="${R}">
        <div style="${S}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Q(h)}" placeholder="Seller name" style="${M}" />
      </div>
      <div style="${R}">
        <div style="${S}">Buyer LLC <span style="color: ${a.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${u.sans};">(assignee)</span></div>
        <input id="ws-pc-buyer-llc" type="text" value="${Q(g)}" placeholder="Buyer's entity / LLC name" style="${M}" />
      </div>
      <div style="${R}">
        <div style="${S}">Assignment Price</div>
        <div style="${le}">
          <span style="color: ${a.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${m}" style="${Y}" />
        </div>
      </div>
      <div style="${R}">
        <div style="${S}">Buyer Earnest Money</div>
        <div style="${le}">
          <span style="color: ${a.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${p}" style="${Y}" />
        </div>
      </div>
      <div style="${R}">
        <div style="${S}">Assignment Fee</div>
        <div style="${le}">
          <span style="color: ${a.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${v}" style="${Y}" />
        </div>
      </div>
      <div style="${R}">
        <div style="${S}">Closing Office</div>
        <input id="ws-pc-closing-office" type="text" value="${Q(k)}" placeholder="Title company" style="${M}" />
      </div>
      <div style="${R}">
        <div style="${S}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${Q(_)}" style="${M}" />
      </div>
      <div style="${R}">
        <div style="${S}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${Q(y)}" style="${M}" />
      </div>
      <div style="${R}">
        <div style="${S}">Lender Source <span style="color: ${a.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${u.sans};">(optional)</span></div>
        <input id="ws-pc-lender-source" type="text" placeholder="e.g. ABC Hard Money LLC" style="${M}" />
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,T.appendChild(x),document.body.appendChild(T);let re=x.querySelector("#ws-pc-assignment-price"),de=x.querySelector("#ws-pc-assignment-fee"),fe=!1;de?.addEventListener("input",()=>{fe=!0});let Ye=()=>{if(fe)return;let O=Number(re?.value||0);de&&(de.value=String(Math.max(0,O-w)))};re?.addEventListener("input",Ye);let z=()=>T.remove();T.addEventListener("click",O=>{O.target===T&&z()}),x.querySelector("#ws-pc-cancel")?.addEventListener("click",z);let G=x.querySelector("#ws-pc-submit"),D=x.querySelector("#ws-pc-error");G?.addEventListener("click",async()=>{if(!G)return;D&&(D.textContent="");let O=(x.querySelector("#ws-pc-seller-name")?.value||"").trim(),we=Number(re?.value||0),xe=Number(x.querySelector("#ws-pc-buyer-emd")?.value||0),ke=Number(de?.value||0),Ee=(x.querySelector("#ws-pc-closing-office")?.value||"").trim(),Te=(x.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ue=(x.querySelector("#ws-pc-closing-date")?.value||"").trim(),Se=(x.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),P=(x.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ue){D&&(D.textContent="Closing Date is required.");return}G.disabled=!0,G.textContent="Opening\u2026";try{let H={};O!==h&&(H.sellerName=O),we!==m&&(H.assignmentPrice=we),xe!==p&&(H.buyerEMD=xe),ke!==v&&(H.assignmentFee=ke),Ee!==k&&(H.closingOffice=Ee),Te!==g&&(H.buyerCompanyName=Te);let Ot=ue!==_||Se!==y||P!==E,Pt=Object.keys(H).length>0||Ot,Ht=n;Pt?(b.info("[prepare-contract] AA modal submit, re-staging with overrides:",H),G.textContent="Saving\u2026",Ht=await St({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ue,buyerEarnestDueDate:Se,lenderSource:P,userId:s,overrides:Object.keys(H).length>0?H:void 0}),b.info("[prepare-contract] AA re-stage ok:",Ht),G.textContent="Opening\u2026"):b.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Do=Ht?.debug?.propertyAddress||c,bn=Do?`${Do} - Assignment Agreement`:void 0;await Ao(t,e,o,bn),z()}catch(H){G.disabled=!1,G.textContent="Open Contract",D&&(D.textContent=H.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",H)}})},St=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Qs({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Ao=async(t,e,o,r)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await Zs(t,o.id,e);b.info(`[prepare-contract] proposal created: ${n}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let s=await oi(t,n,e,r);s.ok?b.info(`[prepare-contract] contact attached to proposal ${n}`):(b.warn(`[prepare-contract] attach failed (status=${s.status??"n/a"}): ${s.body?.slice(0,300)??"no body"}`),F(`Proposal created but couldn't auto-attach contact (HTTP ${s.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",s.body));let i=si(o.name);i&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),ii(n,i.title,i.bodyHtml)),ri(t,n)},ui=async t=>{let e=Vs(t);if(!e){F("Could not resolve contact context.","error");return}document.getElementById(Lr)?.remove();let o=document.createElement("div");o.id=Lr,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Ys(e.tenantId)}catch(s){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${a.crimson}; font-size: 12px;">
        Failed to load templates: ${B(s.message)}
    ...
    `;let l=s.type==="PA"?a.emerald:s.type==="AA"?a.blue:a.coolGray;i.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${B(s.name)}</span>
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=a.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=A();try{if(s.type==="AA"){let h;if(e.oppId)h=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${h} directly`);else{let _;try{_=await Js(e.tenantId,e.contactId)}catch(y){F(`Failed to load buyer's MT opps: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",y);return}if(_.length===0){F("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(_.length===1)h=_[0].id,b.info(`[prepare-contract] auto-selected MT opp ${h} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${_.length} opps)`);let y=await Or(_,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!y){b.info("[prepare-contract] MT opp picker cancelled");return}h=y,b.info(`[prepare-contract] picked MT opp ${h}`)}}let m=_=>{let y=_.getFullYear(),E=String(_.getMonth()+1).padStart(2,"0"),T=String(_.getDate()).padStart(2,"0");return`${y}-${E}-${T}`},p=_=>{let y=new Date;return y.setDate(y.getDate()+_),m(y)},v=p(45),w=p(7);F("Reading contract data\u2026","info",2500);let k;try{k=await St({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:h,closingDate:v,buyerEarnestDueDate:w,userId:c})}catch(_){F(`Failed to prepare contract: ${_.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",_);return}let g=e.contactId||k.contact_id||"";if(!g){F("Could not resolve buyer contact for this opp.","error",6e3);return}mi({tenantId:e.tenantId,contactId:g,template:s,oppId:h,staged:k,userId:c,defaultClosingDate:v,defaultEMDDueDate:w})}else if(s.type==="PA"){if(!e.contactId){F("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let h;try{h=await Xs(e.tenantId,e.contactId)}catch(v){F(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(h.length===0){F("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let v=await Or(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}F("Reading contract data\u2026","info",2500);let p;try{p=await St({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,userId:c})}catch(v){F(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}pi({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:p})}else{if(!e.contactId){F("This template needs to be started from a contact page.","error",6e3);return}F(`Opening ${s.name}\u2026`,"info",2500);try{await Ao(e.tenantId,e.contactId,s)}catch(h){F(`Failed to open contract: ${h.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){b.warn("[prepare-contract] picker click handler failed:",h),F(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(i)}},Br=()=>{let t=document.createElement("button");return t.id=To,t.type="button",t.style.cssText=`${C} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${a.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=a.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=a.steel}),t.addEventListener("click",e=>{e.stopPropagation(),ui(t)}),t},vi="ws-crm-contact-actions-bar",_i=async()=>{let t=Nr();if(!t){document.getElementById(To)?.remove();return}let e=null;try{e=await I(`#${vi}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(To);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Br();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},me="ws-crm-prepare-contract-button-opp",ze=`${me}-wrap`,yi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gi=/\/v2\/location\/([A-Za-z0-9]+)/,fi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Co=()=>{let t=window.location.pathname,e=t.match(yi);if(!e)return null;let o=t.match(gi);return o?{oppId:e[1],tenantId:o[1]}:null},wi=async()=>{for(let t of fi)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Et=!1,qe=null,Io=null,ko=null,Eo,Ue=()=>{qe?.disconnect(),qe=null,Io=null},xi=t=>{if(qe&&Io===t)return;Ue();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Io=t,qe=new MutationObserver(()=>{let o=Co();if(!o||o.oppId!==t){Ue();return}let r=$();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}document.getElementById(me)||Gr()}),qe.observe(e,{childList:!0,subtree:!0}))},ki=()=>{ko||(ko=new MutationObserver(()=>{Eo===void 0&&(Eo=window.setTimeout(()=>{Eo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(me);t&&!e&&!Et&&Gr()},300))}),ko.observe(document.body,{childList:!0,subtree:!0}))},Gr=async()=>{if(!Et){Et=!0;try{let t=Co();if(!t){document.getElementById(me)?.remove(),document.getElementById(ze)?.remove(),Ue();return}let e=document.getElementById(me);if(e&&e.dataset.oppId===t.oppId){let l=$();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(ze)?.remove(),Ue());return}e&&(e.remove(),document.getElementById(ze)?.remove());let o=await wi();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Co();if(!n||n.oppId!==t.oppId)return;let s=Br();s.id=me,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=ze,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),xi(t.oppId)}finally{Et=!1}}},zr=()=>{hi(),_i()};Us();function B(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(t){return B(t)}var $t="reos-theme-stylesheet",sn="reos-theme-fonts",Ei=()=>{let t=document.getElementById(sn);t&&t.remove()},Ti=`
/* ============================================
...
/* \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
   v0.16.2: MY STAFF PAGE (Settings -> Staff -> Team)
   URL: /v2/location/{loc}/settings/staff/team

   Tim flagged this page as "still light" because GHL uses an older
   component set here that our other-page rules don't catch. We scope
   the canon to the staff team route via body[class*="staff"] AND broad
   ID/class selectors used on this page so unrelated pages aren't hit.
   Also de-prominences the native "Add User" button so reps reach for
   Manage Team instead.
   \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */

/* Page surface \u2014 repaint white to graphite. Target the common GHL
   settings-page wrappers + any element under a Staff route. */
html body [class*="staff"]:not([class*="ws-crm"]):not(button):not(input),
html body [class*="StaffTeam"]:not([class*="ws-crm"]),
html body [class*="staff-team"]:not([class*="ws-crm"]),
html body [class*="settings-content"][class*="staff" i],
html body [class*="StaffPage"],
html body [data-page="staff"],
html body [class*="settings-staff"] {
  background-color: var(--reos-graphite) !important;
  color: var(--reos-bone) !important;
}

/* Page heading + subheading. */
html body [class*="staff"] h1,
html body [class*="staff"] h2,
html body [class*="staff"] h3,
html body [class*="staff"] .page-title,
html body [class*="settings-content"] h1,
html body [class*="settings-content"] h2 {
  color: var(--reos-bone) !important;
  -webkit-text-fill-color: var(--reos-bone) !important;
}
html body [class*="staff"] .page-subtitle,
html body [class*="staff"] p.text-gray-500,
html body [class*="staff"] p.text-gray-600 {
  color: var(--reos-ash) !important;
  -webkit-text-fill-color: var(--reos-ash) !important;
}

/* Staff table \u2014 repaint Naive / Tailwind table defaults. */
html body [class*="staff"] table,
html body [class*="staff"] .table,
html body [class*="staff"] .hr-table,
html body [class*="staff"] [role="table"] {
  background-color: var(--reos-graphite) !important;
  color: var(--reos-bone) !important;
  border-color: var(--reos-steel) !important;
}
html body [class*="staff"] thead,
html body [class*="staff"] thead tr,
html body [class*="staff"] th,
html body [class*="staff"] [role="columnheader"] {
  background-color: var(--reos-slate) !important;
  color: var(--reos-bone) !important;
  border-color: var(--reos-steel) !important;
}
html body [class*="staff"] tbody tr,
html body [class*="staff"] tbody td,
html body [class*="staff"] [role="row"],
html body [class*="staff"] [role="cell"] {
  background-color: var(--reos-graphite) !important;
  color: var(--reos-bone) !important;
  border-color: var(--reos-steel) !important;
}
html body [class*="staff"] tbody tr:hover,
html body [class*="staff"] [role="row"]:hover {
  background-color: var(--reos-slate) !important;
}

/* Inputs + search bar on the page. */
html body [class*="staff"] input[type="text"],
html body [class*="staff"] input[type="email"],
html body [class*="staff"] input[type="search"],
html body [class*="staff"] .hr-input__input-el {
  background-color: var(--reos-slate) !important;
  color: var(--reos-bone) !important;
  -webkit-text-fill-color: var(--reos-bone) !important;
  border-color: var(--reos-steel) !important;
...
/* De-prominence the native GHL "Add User" button so reps use Manage
   Team instead. Target by visible label text (any case) via :has()
   on the button content slot. Selector matches the GHL primary
   button shape on staff pages.

   IMPORTANT: scoped to .hr-button INSIDE a staff-route container so
   we don't accidentally tone down "Add User" buttons that appear in
   other places (e.g., sub-account creation, contact owner picker). */
html body [class*="staff"] button.hr-button--primary:has(.hr-button__content-default-slot),
html body [class*="staff"] button[class*="primary"]:has(.hr-button__content-default-slot) {
  /* Default: keep the button accessible but visually quieter than
     our Manage Team CTA. Tertiary-style: transparent + ash + steel
     border. Reps can still click it but it doesn't shout. */
  --n-color: transparent !important;
  --n-color-hover: var(--reos-steel) !important;
  --n-color-pressed: var(--reos-steel) !important;
  --n-color-focus: var(--reos-steel) !important;
  ...
  --n-text-color-focus: var(--reos-bone) !important;
  --n-border: 1px solid var(--reos-steel) !important;
  --n-border-hover: 1px solid var(--reos-ash) !important;
  --n-border-pressed: 1px solid var(--reos-ash) !important;
  --n-border-focus: 1px solid var(--reos-ash) !important;
  opacity: 0.85 !important;
}

/* END MY STAFF PAGE BLOCK */

/* END REINVEST OS THEME */
`,Si=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Ci=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(n))return t;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${n}, ${s})`}return`rgb(${o}, ${r}, ${n})`},Ii=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Ai=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Lo=new WeakSet,qr=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Lo.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let s=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!s)return;let i=+s[1],l=+s[2],d=+s[3];if((s[4]!==void 0?+s[4]:1)<.5||i<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Lo.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Lo.add(e)}catch{}})}catch{}},Ur=new WeakSet,Ve=()=>{document.querySelectorAll(Ai.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(Ur.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=+i[1],d=+i[2],c=+i[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),Ur.add(r))})})},Vr=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Ct=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let l=+i[1],d=+i[2],c=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},Wr=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},We=()=>{for(let t of Si){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,n]of Object.entries(t.styles)){let s=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),l=Ii.has(r)?Ci(n):n;s==="important"&&i===l||o.style.setProperty(r,n,"important")}})}},Dt="#1A1F28",Li=26,Mi=31,$i=40,jr=new Set,Kr=new Set,It=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!Kr.has(n)&&n!=="<no class>"&&(Kr.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},Di=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Fi=["trash","Trash","TRASH","delete","Delete","DELETE"],Oi=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,n=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Fi.some(s=>n.includes(s))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let l=i.getAttribute("d")||"";Di.some(d=>l.includes(d))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Pi=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Hi=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Pi.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Yr=new Set,Xr=new WeakSet,Ni=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Xr.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let s=Array.from(e.children);if(s.length>0&&s.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Xr.add(e);let h=e.className?.toString()||"<no class>";!Yr.has(h)&&h!=="<no class>"&&(Yr.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},Jr=new Set,Ri=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let l=window.getComputedStyle(s),d=l.backgroundColor,c=l.backgroundImage||"",h=!1;if(c!=="none"&&c.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let x=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(x){let S=parseInt(x[1],10),M=parseInt(x[2],10),Y=parseInt(x[3],10);(S>=60||M>=60||Y>=60)&&(S>230&&M>230&&Y>230||(S>=80||M>=80||Y>=80)&&(h=!0))}}if(!h)return;let p=(s.textContent||"").trim(),v=i,w=Array.from(s.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),k=p.toLowerCase()==="ask ai"||v.includes("ai-button")||v.includes("ask-ai")||v.includes("askai"),g=v.includes("bg-clip-text")||v.includes("text-transparent")||w.includes("bg-clip-text")||w.includes("text-transparent"),_=Array.from(s.querySelectorAll("*")).some(T=>{let x=window.getComputedStyle(T),S=x.getPropertyValue("-webkit-background-clip")||"",M=x.getPropertyValue("background-clip")||"";return S.includes("text")||M.includes("text")});if(k||g||_){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],x=S=>{T.forEach(M=>S.style.removeProperty(M))};x(s),s.querySelectorAll("*").forEach(x);return}let y="#12161D";s.style.setProperty("color",y,"important"),s.querySelectorAll("*").forEach(T=>{let x=T.tagName.toLowerCase();x==="svg"||x==="path"||x==="circle"||x==="rect"||x==="polygon"||x==="polyline"||x==="line"||x==="g"?(T.style.setProperty("fill",y,"important"),T.style.setProperty("stroke",y,"important"),T.style.setProperty("color",y,"important")):(T.style.setProperty("color",y,"important"),T.style.setProperty("-webkit-text-fill-color",y,"important"))});let E=s.className?.toString()||"<no class>";!Jr.has(E)&&E!=="<no class>"&&(Jr.add(E),b.debug(`Darkened SVG icons on colored button: "${E}"`))})})},Qr=new Set,Bi=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let w=h.width*h.height/(r.width*r.height);if(w>.55)return;let k=c,g=c.parentElement,_=0;for(;g&&g!==e&&_<3;){let E=g.getBoundingClientRect();if(E.width>0&&E.width<=30&&E.height<=30)k=g;else break;g=g.parentElement,_++}k.style.setProperty("transform","translateY(11px)","important");let y=(k.className?.toString()||"")+" "+k.tagName;Qr.has(y)||(Qr.add(y),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${w.toFixed(2)}): "${y}"`))})})},Gi="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",zi=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Gi,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let s=n.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Zr=new Set,qi=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=parseInt(i[1],10),d=parseInt(i[2],10),c=parseInt(i[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!Zr.has(h)&&h!=="<no class>"&&(Zr.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${c})): "${h}"`))})})},en=new Set,Ui=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let n=(o.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!en.has(l)&&l!=="<no class>"&&(en.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},tn=new Set,Vi=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(n);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(n)}),[...t,...o].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let l=(i.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(l.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let h=parseInt(c[1],10),m=parseInt(c[2],10),p=parseInt(c[3],10);if(!(h>200&&m>200&&p>200))return;let w=i.getBoundingClientRect();if(w.width<24||w.height<16||w.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let k=i.className?.toString()||"<no class>";!tn.has(k)&&k!=="<no class>"&&(tn.add(k),b.debug(`Coerced light bg (${w.width.toFixed(0)}x${w.height.toFixed(0)}, rgb(${h},${m},${p})): "${k}"`))})})},on=new Set,Wi=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let y=o.getAttribute("style")||"";(y.includes("color")||y.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let n=o,s=null;for(let y=0;y<4&&n;y++){let E=n.nextElementSibling;if(E&&(E.matches(t)||E.querySelector(t)!==null)){s=E;break}n=n.parentElement}if(!s)return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=s,d=l.getBoundingClientRect(),c=l.className?.toString()||"",h=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",v=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);v&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let g=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!v&&!w&&!k&&!g&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Dt,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let _=o.className?.toString()||"<no class>";!on.has(_)&&_!=="<no class>"&&(on.add(_),b.debug(`Colored field label "${r.slice(0,30)}": "${_}"`))})},rn=new Set,ji=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!rn.has(d)&&d!=="<no class>"&&(rn.add(d),b.debug(`Resized avatar text to ${l}px (circle ${i.toFixed(0)}px): "${d}"`))})},nn=new Set,Ki=new Set(["Enter Dashboard Name"]),Yi=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Ki.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Dt,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",Dt,"important"),n.style.setProperty("border-color","#252C36","important"));let s=e.className?.toString()||"<no class>";!nn.has(s)&&s!=="<no class>"&&(nn.add(s),b.debug(`Forced input slate bg: "${s}"`))})},At=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>o.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let s=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let i=parseInt(s[1],10),l=parseInt(s[2],10),d=parseInt(s[3],10);if(!(i<Li&&l<Mi&&d<$i))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",Dt,"important");let m=e.className?.toString()||"<no class>";!jr.has(m)&&m!=="<no class>"&&(jr.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${i},${l},${d})): "${m}"`))})},Lt=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1"),s.setAttribute("data-reos-recolored-v3","1");let l=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,h=!1;if(e.forEach(v=>{c.includes(v)&&(c=c.split(v).join(t),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(v=>{c.includes(v)&&(c=c.split(v).join("transparent"),h=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(w=>{c.includes(w)&&(c=c.split(w).join("#EDEEF0"),h=!0)}),!!h)try{let v=btoa(c);s.setAttribute("src",`data:image/svg+xml;base64,${v}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let l=`url("${i}")`;s.style.setProperty("-webkit-mask-image",l,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",l,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",o)})},Mt=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Xi=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},je=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{t(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(i).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let s="rgb(150, 162, 173)",i="rgb(0, 191, 124)",l=c=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",c,"important"),h.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?i:s),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(i)),r.addEventListener("mouseleave",()=>l(s)))})},Mo=new WeakSet,Ji=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Mo.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Mo.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
        html, body {
          background-color: #FFFFFF !important;
          color: #101828 !important;
        }
        body { padding: 16px !important; }
      `,o.head.appendChild(r),e.style.background="#FFFFFF",e.style.borderRadius="6px",Mo.add(e)}catch{}})},an=()=>{let t,o=()=>{t===void 0&&(t=window.setTimeout(()=>{t=void 0,Mt(),We(),Yi(),At(),It(),Wi(),Ji(),Vi(),Ui(),qi(),zi(),Ri(),ji(),Bi(),Ni(),Lt(),Hi(),Oi(),je(),Ve(),qr(),Vr(),Wr(),Ct(),Xi(),je()},800))};Mt(),We(),At(),It(),Lt(),je(),Ve(),qr(),Vr(),Wr(),Ct(),window.setTimeout(()=>{Mt(),We(),At(),It(),Lt(),je(),Ve(),Ct()},500),window.setTimeout(()=>{Mt(),We(),At(),It(),Lt(),je(),Ve(),Ct()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{Ve(),We()}),new MutationObserver(()=>{o()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},$o,Qi=()=>{let t=()=>{let o=document.getElementById($t);!o||!document.head||document.head.lastElementChild===o||document.head.appendChild(o)};new MutationObserver(o=>{let r=!1;for(let n of o){for(let s of Array.from(n.addedNodes)){if(!(s instanceof Element))continue;let i=s.tagName.toLowerCase();if(i==="style"||i==="link"){if(s.id===$t||s.id===sn)continue;r=!0;break}}if(r)break}r&&$o===void 0&&($o=window.setTimeout(()=>{$o=void 0,t()},150))}).observe(document.head,{childList:!0}),t()},ln=()=>{if(Ei(),!document.getElementById($t)){let t=document.createElement("style");t.id=$t,t.textContent=Ti,document.head.appendChild(t),b.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?an():window.addEventListener("DOMContentLoaded",an)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,Qi())};var dn="ws-crm-customizer-version-badge",Ft=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",Ft,{once:!0});return}if(document.getElementById(dn))return;let t=document.createElement("div");t.id=dn,t.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,t.textContent=`Customizer v${Ze}`,t.title=`Built ${et}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var N=(t,e)=>{try{b.info(`[main] calling ${t}`),e(),b.info(`[main] ${t} OK`)}catch(o){b.error(`[main:FAIL] ${t} threw:`,o)}},cn=()=>{b.info(`Loaded v${Ze} (built ${et})`),N("mountVersionBadge (initial)",Ft),N("mountFavicon",sr),N("mountThemeStylesheet",ln),N("initPageRouter",Ho),b.info("[main] registering onPageChange subscriber"),Po(t=>{b.info(`[main] onPageChange callback fired for page=${t}`),N("mountVersionBadge",Ft),N("mountClaimReleaseToggle",jo),N("mountContactActionsBar",nr),N("mountActiveFollowUpButton",qo),N("mountMtOfferMadeButton",lr),N("mountNotInterestedButton",dr),N("mountReducePriceButton",br),N("mountSendToClosingOfficeButton",vr),N("mountClosingAgentPickerButton",Er),N("mountPrepareContractButton",zr),N("mountManageTeam",Ar)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",cn):cn();})();
