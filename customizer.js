/* Wholesaling CRM Customizer v0.23.0 — built 2026-06-03T17:35:06.055Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var _t="[wholesaling-crm-customizer]",Na="__WS_CRM_DEBUG",za=()=>!!window[Na],p={info(...t){console.log(_t,...t)},warn(...t){console.warn(_t,...t)},error(...t){console.error(_t,...t)},debug(...t){za()&&console.log(_t,"[debug]",...t)}};var Ga=/\/v2\/location\/([A-Za-z0-9]+)/,qa=new Set(["8ntUQzMflUkR0YvrRgVk"]),xe=()=>{let t=window.location.pathname.match(Ga);return t?t[1]:null},go=()=>{let t=xe();return t!==null&&qa.has(t)};var Rr=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,fo=/\/v2\/location\/([A-Za-z0-9]+)/,Ua=t=>{let e=t.match(Rr);if(!e)return null;let o=t.match(fo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Va=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Rr);if(!a)continue;let i=r.match(fo)||window.location.pathname.match(fo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},D=()=>{let t=Ua(window.location.pathname);return t||Va()};var Nr=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},gt="",wo=null,ke="other",xo=new Set,yt=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==gt)&&!(t!==wo))){gt=window.location.pathname,wo=t,ke=Nr(),p.debug("Page/context changed:",ke,gt,"contact:",t);for(let r of xo)try{r(ke)}catch(a){p.error("Subscriber threw:",a)}}},ft=t=>(xo.add(t),setTimeout(()=>t(ke),0),()=>{xo.delete(t)}),zr=()=>{ke=Nr(),gt=window.location.pathname,wo=D()?.contactId??null,p.debug("Router init, current page:",ke);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),yt()},history.replaceState=function(o,r,a){e(o,r,a),yt()},window.addEventListener("popstate",yt),setInterval(yt,1e3)};var wt="0.23.0",xt="2026-06-03T17:35:06.056Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ko={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Gr=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var Wa=/^[A-Za-z0-9]{15,30}$/,Re=t=>typeof t=="string"&&Wa.test(t),ja=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ka=()=>{let t=window.WS_CRM_USER_ID;return Re(t)?t:null},Ya=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Re(o))return o;return null},Ja=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ja(e);if(!o)return null;let r=o.uid;if(Re(r))return r;let a=o.claims;if(a&&Re(a.user_id))return a.user_id}catch{}return null},Xa=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Re(a))return a}catch{}}}catch{}return null},I=()=>Ka()||Ya()||Ja()||Xa()||null;var Wr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Qa=`${Wr}/active-follow-up-get`,Za=`${Wr}/active-follow-up-set`,me="ws-crm-active-follow-up-button",To={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ei=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},ti=async t=>{let e=await fetch(Qa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},oi=async(t,e)=>{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ue=(t,e)=>{let o=To[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},qr=t=>{let e=document.createElement("button");return e.type="button",e.id=me,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ue(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ei();if(!(!r||r.contactId!==t)){ue(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await oi(r,I()),i=a&&a.state&&a.state in To?a.state:"blue";ue(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ue(e,"error"),setTimeout(()=>void kt(e,r),4e3)}}}),e},kt=async(t,e)=>{ue(t,"loading");try{let o=await ti(e),r=o&&o.state&&o.state in To?o.state:"gray",a=document.getElementById(me);if(!a||a.dataset.contactId!==e.contactId)return;ue(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),ue(t,"error")}},ri=[".central-panel","[class*='central-panel']"],Eo="ws-crm-contact-actions-bar",ni=async()=>{for(let t of ri)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ai=async(t,e)=>{let o=e.querySelector(`#${Eo}`);if(!o)try{o=await L(`#${Eo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Eo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},ii=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},si=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},li=async t=>{if(t==="url"){let o=await ni();return o?{kind:"contact-detail",target:o}:null}let e=ii();return e?{kind:"conversations",target:e}:null},Ur=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await ai(t,e.target);return o}return si(t,e.target),"conversations-header"},di=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(me)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(me);if(o&&o.dataset.contactId===e.contactId){kt(o,e);return}o&&o.remove();let r=await li(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let i=qr(e.contactId),s=await Ur(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Vr();let l=document.getElementById(me)??i;kt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(me);if(!(D()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=qr(e.contactId);Ur(m,r).then(()=>{Vr(),kt(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ne=null,jr=()=>{let t=D()?.contactId??null;if(Ne&&Ne.contactId===t)return;let e=di().finally(()=>{Ne?.promise===e&&(Ne=null)});Ne={contactId:t,promise:e}},Vr=()=>{let t=document.querySelectorAll(`#${me}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ci="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ze=new Map,Et=async(t,e)=>{if(!t)return null;if(ze.has(t))return ze.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ci}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),ze.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ze.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),ze.set(t,null),null}};var Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Jr="ws-buybox-nav-icon",Co="ws-buybox-panel",Kr="ws-buybox-modal",pi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Io="https://mcclivetim.github.io/reinvest-os-cdn/geo",St=null,Ge=null,qe=null,Ao=async()=>{if(St)return St;try{let t=await fetch(`${Io}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return St=await t.json(),St}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},bi=async t=>{if(!Ge)try{let e=await fetch(`${Io}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Ge=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return Ge?.[t]??[]},hi=async t=>{if(!qe)try{let e=await fetch(`${Io}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);qe=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return qe?.[t]??[]},Lo=async t=>await(await fetch(pi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),mi=(t,e)=>Lo({tenant_id:t,action:"list",buyer_contact_id:e}),ui=(t,e,o,r)=>Lo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),vi=(t,e)=>Lo({tenant_id:t,action:"remove",entry_id:e}),F=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),_i=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},yi='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',gi='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',fi="nav.w-13, nav[class*='w-13']",wi=".flex-1.h-full.relative.overflow-hidden.rounded-lg",xi=async()=>{try{return await L(fi,{timeoutMs:2500})}catch{return null}},ki=async()=>{try{return await L(wi,{timeoutMs:2500})}catch{return null}},Ei=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Ti=(t,e)=>{let o=document.createElement("div");return o.id=Co,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ii(t,e,()=>$o(t,e))}),o},$o=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([mi(t,e),Ao()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Si(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Si=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?_i(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,vi(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}$o(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},At=!1,Xr=(t,e)=>{At=e;let o=Ei(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Ai,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",$o(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Qr,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Qr="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ai="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Ci=t=>{let e=document.createElement("button");return e.id=Jr,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Qr,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${yi.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!At;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Xr(r,a)}),e},Ii=(t,e,o)=>{let r=document.getElementById(Kr);r&&r.remove();let a=document.createElement("div");a.id=Kr,a.style.cssText=`
  ...
  `,x=g=>{let T=g.find(C=>C.code===s.stateCode);return`
    ...
    `},E=g=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>k(s.stateCode||""))},w=g=>{let T=s.granularity==="county"?Ge?.[s.stateCode||""]??[]:qe?.[s.stateCode||""]??[];return`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",C=>{C.key==="Enter"&&(C.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),C=(g?.value||"").trim();if(!/^\d{5}$/.test(C)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(C)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),C=i.querySelector("#ws-buybox-save");C&&(C.disabled=!0,C.textContent="Adding\u2026"),T&&(T.textContent="");try{let O=await ui(t,e,s.granularity,g);if(!O.ok){T&&(T.textContent=O.error||"Failed to add entry."),C&&(C.disabled=!1,C.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(O){T&&(T.textContent=`Network error: ${O.message}`),C&&(C.disabled=!1,C.textContent="Add")}};l()},So=!1,Ee=null,Ue=null,Yr=()=>{document.getElementById(Jr)?.remove(),document.getElementById(Co)?.remove(),Ue&&Ee&&Ee.nav.removeEventListener("click",Ue,!0),Ue=null,Ee=null,At=!1},Zr=()=>{Li()},Li=async()=>{if(!So){So=!0;try{let t=D();if(!t){Yr();return}let e=document.getElementById(Co);if(e&&e.dataset.buyerContactId===t.contactId&&Ee)return;Yr();let o=null;try{o=await Et(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([xi(),ki()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let l=Ti(t.locationId,t.contactId),d=Ci(()=>Ee),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ee=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),Ue=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&At&&Xr(c,!1)},a.addEventListener("click",Ue,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{So=!1}}};var ce="ws-crm-claim-release-pill",$i="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Mi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Di=async t=>{let e=await fetch($i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Oi=async t=>{let e=await fetch(Mi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},on=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Te=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Gr(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Fi=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ce,o.type="button",o.dataset.contactId=t,Te(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let i=I();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Te(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Te(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Oi({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Te(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),Te(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},en=async(t,e)=>{try{let o=await Di({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(ce);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Te(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Hi=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=on(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},tn=(t,e)=>{let o=Fi({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ce}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Pi=async()=>{let t=D();if(!t){document.getElementById(ce)?.remove();return}let e=document.getElementById(ce);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await Hi(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}tn(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ce);i&&t.locationId&&en(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ce))return;let d=on(o);if(d){tn(d,t.contactId);let c=document.getElementById(ce);c&&t.locationId&&en(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},rn=()=>{Pi()};var cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Bi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ni=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||cn,d;if(s==="buyer"){let b=pn.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},zi=async({contactId:t,tenantId:e})=>{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Se="ws-crm-contact-actions-bar",Gi="ws-crm-call-status-dropdown",nn="ws-crm-offer-made-modal",qi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],pn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Ui=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Vi=async()=>{for(let t of Ui)try{let e=await L(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Wi=({contactId:t,kind:e})=>{let o=e==="buyer"?pn:qi,r=e==="buyer"?Bi:cn,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Gi,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},ln=(t,e)=>{let o=document.createElement("div");if(o.id=Se,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=X,r.textContent="Offer Made",r.addEventListener("click",()=>Yi(t,e)),o.appendChild(r),o.appendChild(Wi({contactId:t,kind:e}))}return o},Mo=!1,Qi=()=>{document.querySelectorAll(`[id="${Se}"]`).forEach(t=>t.remove())},bn=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Mo){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Mo=!0;try{await Zi()}finally{Mo=!1}},Zi=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Qi();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Et(t.contactId,t.locationId),b=Tt(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Se}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await Vi();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=D();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ln(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Se)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Se}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=ln(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(a,{childList:!0})},dn=null,es=()=>{dn===null&&(dn=window.setInterval(()=>{let t=D();t&&(document.getElementById(Se)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),bn()))},3e3))},hn=()=>{es(),bn()};var Ct="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",ts=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ve="data-ws-crm-favicon",Do=t=>t.hasAttribute(Ve),mn=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return ts.has(e)},It=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{mn(r)&&!Do(r)&&r.remove()});let e=document.head.querySelector(`link[${Ve}="1"]`);e?e.href!==Ct&&(e.href=Ct):(e=document.createElement("link"),e.setAttribute(Ve,"1"),e.rel="icon",e.type="image/png",e.href=Ct,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ve}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ve,"apple"),o.rel="apple-touch-icon",o.href=Ct,document.head.appendChild(o))},un=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)It();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),It())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&mn(s)&&!Do(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Do(s)&&(a=!0)});a&&It()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,It(),e>=5&&window.clearInterval(o)},1e3)};var os=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],rs=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,ns=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(ns);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(rs);if(a){let i=a[1];if(os.includes(i))return i}}return null},N=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var as="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Q="ws-crm-mt-offer-made-button",vn="ws-crm-mt-offer-made-modal",is=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ss=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(is);if(!e)return null;let o=t.match(ss);return{oppId:e[1],locationId:o?o[1]:null}},ls=async t=>{let e=await fetch(as,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Lt=()=>{document.getElementById(vn)?.remove()},ds=t=>{Lt();let e=document.createElement("div");e.id=vn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Lt()}),i?.addEventListener("click",()=>Lt()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let b=await ls({oppId:t.oppId,locationId:t.locationId,amount:c,userId:I()});if(!b.ok){a.textContent=b.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}Lt(),t.onSuccess()}catch(b){p.error("MT Offer Made webhook failed",b),a.textContent=b instanceof Error?b.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},cs=t=>{let e=document.createElement("button");return e.id=Q,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Mt();!o||!o.locationId||o.oppId!==t||ds({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},ps=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bs=async()=>{for(let t of ps)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$t=!1,Po=async()=>{if(!$t){$t=!0;try{await hs()}finally{$t=!1}}},hs=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je();return}let e=document.getElementById(Q);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je());return}e&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove());let o=await bs();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Mt();if(!a||a.oppId!==t.oppId)return;let i=cs(t.oppId),s=document.createElement("span");s.id=`${Q}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ms(t.oppId)},We=null,Ho=null,je=()=>{We?.disconnect(),We=null,Ho=null},ms=t=>{if(We&&Ho===t)return;je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ho=t,We=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t){je();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je();return}document.getElementById(Q)||Po()}),We.observe(e,{childList:!0,subtree:!0}))},Oo=null,Fo,us=()=>{Oo||(Oo=new MutationObserver(()=>{Fo===void 0&&(Fo=window.setTimeout(()=>{Fo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Q);t&&!e&&!$t&&Po()},300))}),Oo.observe(document.body,{childList:!0,subtree:!0}))},_n=()=>{us(),Po()};var vs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",Z="ws-crm-not-interested-button",_s=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ys=/\/v2\/location\/([A-Za-z0-9]+)/,Ot=()=>{let t=window.location.pathname,e=t.match(_s);if(!e)return null;let o=t.match(ys);return{oppId:e[1],locationId:o?o[1]:null}},gs=async t=>{let e=await fetch(vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},fs=t=>{let e=document.createElement("button");return e.id=Z,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Ot();if(!o||!o.locationId||o.oppId!==t)return;let r=I(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await gs({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},ws=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xs=async()=>{for(let t of ws)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Dt=!1,zo=async()=>{if(!Dt){Dt=!0;try{await ks()}finally{Dt=!1}}},ks=async()=>{let t=Ot();if(!t||!t.locationId){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ye();return}let e=document.getElementById(Z);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ye());return}e&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove());let o=await xs();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ot();if(!a||a.oppId!==t.oppId)return;let i=fs(t.oppId),s=document.createElement("span");s.id=`${Z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Es(t.oppId)},Ke=null,No=null,Ye=()=>{Ke?.disconnect(),Ke=null,No=null},Es=t=>{if(Ke&&No===t)return;Ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(No=t,Ke=new MutationObserver(()=>{let o=Ot();if(!o||o.oppId!==t){Ye();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Ye();return}document.getElementById(Z)||zo()}),Ke.observe(e,{childList:!0,subtree:!0}))},Bo=null,Ro,Ts=()=>{Bo||(Bo=new MutationObserver(()=>{Ro===void 0&&(Ro=window.setTimeout(()=>{Ro=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Z);t&&!e&&!Dt&&zo()},300))}),Bo.observe(document.body,{childList:!0,subtree:!0}))},yn=()=>{Ts(),zo()};var Ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ae="ws-crm-resend-deal-link-wrap",As=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cs=/\/v2\/location\/([A-Za-z0-9]+)/,Ht=()=>{let t=window.location.pathname,e=t.match(As);if(!e)return null;let o=t.match(Cs);return{oppId:e[1],locationId:o?o[1]:null}},Is=async t=>{let e=await fetch(Ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Ls=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),gn=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Vo=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${gn(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>$s(t,e)),t.appendChild(o)},$s=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Ms(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Vo(t,e)),o.appendChild(s),t.appendChild(o)},Ms=async(t,e,o,r)=>{let a=Ht();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Is({oppId:a.oppId,locationId:a.locationId,channel:o,userId:I()});if(i?.ok)r.innerHTML=`${gn(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Ls(s)}</span>`}window.setTimeout(()=>Vo(t,e),3500)}},Ds=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Os=async()=>{for(let t of Ds)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ft=!1,Wo=async()=>{if(!Ft){Ft=!0;try{await Fs()}finally{Ft=!1}}},Fs=async()=>{let t=Ht();if(!t||!t.locationId){document.getElementById(Ae)?.remove(),Xe();return}let e=document.getElementById(Ae);if(e&&e.dataset.oppId===t.oppId){let s=M();s!==null&&s!=="Marketing Tracker"&&(e.remove(),Xe());return}e&&e.remove();let o=await Os();if(!o)return;let r=await N();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ht();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ae,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),Vo(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Hs(t.oppId)},Je=null,Uo=null,Xe=()=>{Je?.disconnect(),Je=null,Uo=null},Hs=t=>{if(Je&&Uo===t)return;Xe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Uo=t,Je=new MutationObserver(()=>{let o=Ht();if(!o||o.oppId!==t){Xe();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ae)?.remove(),Xe();return}document.getElementById(Ae)||Wo()}),Je.observe(e,{childList:!0,subtree:!0}))},Go=null,qo,Ps=()=>{Go||(Go=new MutationObserver(()=>{qo===void 0&&(qo=window.setTimeout(()=>{qo=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ae)&&!Ft&&Wo()},300))}),Go.observe(document.body,{childList:!0,subtree:!0}))},fn=()=>{Ps(),Wo()};var wn="ws-crm-dispo-action-row",Ce=t=>{let e=document.getElementById(wn);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=wn,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Bs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ee="ws-crm-reduce-price-button",xn="ws-crm-reduce-price-modal",Rs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ns=/\/v2\/location\/([A-Za-z0-9]+)/,Rt=()=>{let t=window.location.pathname,e=t.match(Rs);if(!e)return null;let o=t.match(Ns);return{oppId:e[1],locationId:o?o[1]:null}},zs=async t=>{let e=await fetch(Bs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Pt=()=>{document.getElementById(xn)?.remove()},Gs=t=>{Pt();let e=document.createElement("div");e.id=xn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Pt()}),i?.addEventListener("click",()=>{Pt()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await zs({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:I()}),Pt(),t.onSuccess()}catch(b){p.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},qs=(t,e)=>{let o=document.createElement("button");return o.id=ee,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Rt();!r||!r.locationId||r.oppId!==t||Gs({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Us=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vs=async()=>{for(let t of Us)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Bt=!1,Jo=async()=>{if(!Bt){Bt=!0;try{await Ws()}finally{Bt=!1}}},Ws=async()=>{let t=Rt();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Ze();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Ze());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=await Vs();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Rt();if(!a||a.oppId!==t.oppId)return;let i=qs(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ee}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),js(t.oppId)},Qe=null,Yo=null,Ze=()=>{Qe?.disconnect(),Qe=null,Yo=null},js=t=>{if(Qe&&Yo===t)return;Ze();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Yo=t,Qe=new MutationObserver(()=>{let o=Rt();if(!o||o.oppId!==t){Ze();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Ze();return}document.getElementById(ee)||Jo()}),Qe.observe(e,{childList:!0,subtree:!0}))},jo=null,Ko,Ks=()=>{jo||(jo=new MutationObserver(()=>{Ko===void 0&&(Ko=window.setTimeout(()=>{Ko=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!Bt&&Jo()},300))}),jo.observe(document.body,{childList:!0,subtree:!0}))},kn=()=>{Ks(),Jo()};var Ie="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Nt="deals.reinvestos.com";var te="ws-crm-edit-landing-button",Ys=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Js=/\/v2\/location\/([A-Za-z0-9]+)/,Gt=()=>{let t=window.location.pathname,e=t.match(Ys);if(!e)return null;let o=t.match(Js);return{oppId:e[1],locationId:o?o[1]:null}},Xs=(t,e)=>{let o=new URL(`https://${Nt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ie);let r=I();return r&&o.searchParams.set("user",r),o.toString()},Qs=(t,e)=>{let o=document.createElement("button");return o.id=te,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Gt();if(!r||!r.locationId||r.oppId!==t)return;if(!Ie){p.warn("[edit-landing] editor session key not configured in this build");return}let a=Xs(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Zs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],el=async()=>{for(let t of Zs)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},zt=!1,er=async()=>{if(!zt){zt=!0;try{await tl()}finally{zt=!1}}},tl=async()=>{let t=Gt();if(!t||!t.locationId){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt();return}let e=document.getElementById(te);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt());return}e&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove());let o=await el();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Gt();if(!a||a.oppId!==t.oppId)return;let i=Qs(t.oppId,t.locationId),s=document.createElement("span");s.id=`${te}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),ol(t.oppId)},et=null,Zo=null,tt=()=>{et?.disconnect(),et=null,Zo=null},ol=t=>{if(et&&Zo===t)return;tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zo=t,et=new MutationObserver(()=>{let o=Gt();if(!o||o.oppId!==t){tt();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt();return}document.getElementById(te)||er()}),et.observe(e,{childList:!0,subtree:!0}))},Xo=null,Qo,rl=()=>{Xo||(Xo=new MutationObserver(()=>{Qo===void 0&&(Qo=window.setTimeout(()=>{Qo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(te);t&&!e&&!zt&&er()},300))}),Xo.observe(document.body,{childList:!0,subtree:!0}))},En=()=>{rl(),er()};var Sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Le="ws-crm-publish-button",ot="ws-crm-publish-wrap",Ut="ws-crm-publish-dropdown",nl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,al=/\/v2\/location\/([A-Za-z0-9]+)/,rr=()=>{let t=window.location.pathname,e=t.match(nl);if(!e)return null;let o=t.match(al);return{oppId:e[1],locationId:o?o[1]:null}},il=async(t,e)=>{try{let o=await fetch(Sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:I()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},sl=async(t,e)=>{let o=await fetch(Sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:I()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ll=(t,e)=>{if(!Ie){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Nt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ie);let r=I();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},se=()=>{document.getElementById(Ut)?.remove()},Tn=(t,e,o,r,a)=>{se();let i=document.createElement("div");i.id=Ut;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};ve(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await il(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},ve(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},ve(o,r),document.getElementById(Ut)&&r.checks&&Tn(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},ve(o,r),se();try{let m=await sl(t,e);if(m.ok&&m.published)r={status:"published"},ve(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},ve(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},ve(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Ut)?se():r.checks&&Tn(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let v=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},v)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},cl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pl=async()=>{for(let t of cl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qt=!1,ar=async()=>{if(!qt){qt=!0;try{await bl()}finally{qt=!1}}},bl=async()=>{let t=rr();if(!t||!t.locationId){document.getElementById(Le)?.remove(),document.getElementById(ot)?.remove(),se(),nt();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(ot)?.remove(),se(),nt());return}e&&(e.remove(),document.getElementById(ot)?.remove(),se());let o=await pl();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=rr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=dl(t.oppId,a.locationId),s=document.createElement("span");s.id=ot,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),hl(t.oppId)},rt=null,nr=null,nt=()=>{rt?.disconnect(),rt=null,nr=null},hl=t=>{if(rt&&nr===t)return;nt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(nr=t,rt=new MutationObserver(()=>{let o=rr();if(!o||o.oppId!==t){nt();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(Le)?.remove(),document.getElementById(ot)?.remove(),se(),nt();return}document.getElementById(Le)||ar()}),rt.observe(e,{childList:!0,subtree:!0}))},tr=null,or,ml=()=>{tr||(tr=new MutationObserver(()=>{or===void 0&&(or=window.setTimeout(()=>{or=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Le)&&!qt&&ar()},300))}),tr.observe(document.body,{childList:!0,subtree:!0}))},An=()=>{ml(),ar()};var Cn="data:image/png;base64,",In="data:image/png;base64,";var lr="ws-crm-map-links",ul=/\/contacts\/detail\/[A-Za-z0-9]/,Vt=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let i=r.closest(".hr-form-item")?.querySelector("input, textarea");if(i)return(i.value||"").trim()}return""},Ln=()=>{let t=Vt("Street address"),e=Vt("City"),o=Vt("State"),r=Vt("Postal code"),a=[t,e,o,r].filter(Boolean);return{full:a.join(", "),hasAny:a.length>0}},vl=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,_l=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,yl=t=>{let{full:e,hasAny:o}=Ln();o&&window.open(t(e),"_blank","noopener,noreferrer")},gl=()=>{let t=document.createElement("span");t.id=lr,t.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let e=document.createElement("span");e.textContent="View maps:",e.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",t.appendChild(e);let o=(r,a,i)=>{let s=document.createElement("img");return s.src=r,s.title=a,s.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",s.addEventListener("mouseenter",()=>{s.style.transform="scale(1.12)"}),s.addEventListener("mouseleave",()=>{s.style.transform="scale(1)"}),s.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),yl(i)}),s};return t.appendChild(o(Cn,"Open in Google Maps",vl)),t.appendChild(o(In,"Search on Zillow",_l)),t},fl=()=>{let t=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']");for(let e of t)if((e.textContent||"").trim().toLowerCase()==="street address")return e.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||e.parentElement;return null},$n=()=>{if(!ul.test(window.location.pathname)){document.getElementById(lr)?.remove();return}if(document.getElementById(lr))return;let{hasAny:t}=Ln();if(!t)return;let e=fl();e&&(e.style.display="flex",e.style.alignItems="center",e.style.width="100%",e.appendChild(gl()),p.debug("[map-links] injected on Street address field"))},ir=null,sr,wl=()=>{ir||(ir=new MutationObserver(()=>{sr===void 0&&(sr=window.setTimeout(()=>{sr=void 0;try{$n()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),ir.observe(document.body,{childList:!0,subtree:!0}))},Mn=()=>{wl(),$n()};var Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",pe="ws-crm-send-to-closing-office-button",_e="ws-crm-send-to-title-co-wrap",Kt="ws-crm-stc-dropdown",xl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kl=/\/v2\/location\/([A-Za-z0-9]+)/,Yt=()=>{let t=window.location.pathname,e=t.match(xl);if(!e)return null;let o=t.match(kl);return{oppId:e[1],locationId:o?o[1]:null}},El=5*60*1e3,Hn=t=>`ws-crm-stc-cache:${t}`,Tl=t=>{try{let e=window.localStorage.getItem(Hn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>El||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Sl=(t,e)=>{try{window.localStorage.setItem(Hn(t),JSON.stringify(e))}catch{}},Al=async(t,e)=>{try{let o=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Cl=async(t,e,o)=>{let r=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Il=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},Dn=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Ll=(t,e)=>{if(e&&Il(e)){window.setTimeout(()=>Dn(t),300);return}Dn(t)},oe=()=>{document.getElementById(Kt)?.remove()},Wt=(t,e,o)=>{oe();let r=document.createElement("div");r.id=Kt;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,ne(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Al(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},ne(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},ne(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},ne(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Jt.add(t),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe(),it();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},Sl(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),ne(o,a),document.getElementById(Kt)&&Wt(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},ne(o,a),oe();try{let y=await Cl(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},ne(o,a),y.checks&&Wt(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},ne(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},ne(o,a),y.checks&&Wt(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},ne(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Kt)?oe():a.checks&&Wt(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,v=0,x=async()=>{if(!c){if(Date.now()<v){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Ml=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Dl=async()=>{for(let t of Ml)try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Jt=new Set,On=null,Ol=t=>{t&&t!==On&&(Jt.clear(),On=t)},jt=!1,br=async()=>{if(jt){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}jt=!0;try{await Fl()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{jt=!1}},Fl=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Yt();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Ol(t.oppId),Jt.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe();return}let e=document.getElementById(pe);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(_e)?.remove(),oe(),it());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(_e)?.remove(),oe()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Dl();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Yt();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=$l(t.oppId,a.locationId),s=document.createElement("span");s.id=_e,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Hl(t.oppId)},at=null,pr=null,it=()=>{at?.disconnect(),at=null,pr=null},Hl=t=>{if(at&&pr===t)return;it();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pr=t,at=new MutationObserver(()=>{let o=Yt();if(!o||o.oppId!==t){it();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe(),it();return}document.getElementById(pe)||br()}),at.observe(e,{childList:!0,subtree:!0}))},dr=null,cr,Pl=()=>{dr||(dr=new MutationObserver(()=>{cr===void 0&&(cr=window.setTimeout(()=>{cr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(pe);if(t&&!e&&!jt){let o=Yt();if(o&&Jt.has(o.oppId))return;br()}},300))}),dr.observe(document.body,{childList:!0,subtree:!0}))},Pn=()=>{Pl(),br()};var Bn="ws-support-modal",Rn="ws-support-toast",Bl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Nn="ws-support-submitter-name",zn="ws-support-submitter-email",Gn="ws-support-submitter-role",Rl=["Bug","Feature Request","Question","Billing","Onboarding Help"],ye=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Nl=(t,e="success",o)=>{let r=document.getElementById(Rn);r&&r.remove();let a=document.createElement("div");a.id=Rn;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},zl=()=>{document.getElementById(Bn)?.remove();let t=(localStorage.getItem(Nn)??"").trim(),e=(localStorage.getItem(zn)??"").trim(),o=(localStorage.getItem(Gn)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Bn,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=xe();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Nn,r.submitterName),localStorage.setItem(zn,r.submitterEmail),r.submitterRole&&localStorage.setItem(Gn,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Bl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:I()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";Nl(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Gl=["/support-ticket","ws-support-modal","ws-support"],ql=/\/custom-menu-link\//,hr=!1,qn=()=>{if(hr||!ql.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Gl.some(s=>i.includes(s))});if(r){hr=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{zl(),hr=!1},50);return}t<10&&setTimeout(e,150)};e()},Un=!1,Vn=()=>{Un||(Un=!0,ft(()=>setTimeout(qn,50)),qn(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Ul="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Vl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Wl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Kn="ldtyB2UXKi9vOp8nLUH7",jl="WVD2gb9swLsgcdBEtDVq",re="ws-crm-closing-agent-picker-button",Yn="ws-crm-closing-agent-picker-modal",Kl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yl=/\/v2\/location\/([A-Za-z0-9]+)/,dt=()=>{let t=window.location.pathname,e=t.match(Kl);if(!e)return null;let o=t.match(Yl);return{oppId:e[1],locationId:o?o[1]:null}},wr=async t=>{let e=await fetch(Ul,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Wn=async t=>{let e=await fetch(Vl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Jl=async(t,e)=>{try{let o=await fetch(Wl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Kn}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await wr({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ge=null,Xl=60*60*1e3,xr=t=>`ws-crm-to-cache:${t}`,Jn=t=>{try{let e=window.localStorage.getItem(xr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Xl||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Xn=(t,e,o)=>{try{window.localStorage.setItem(xr(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Ql=t=>{try{window.localStorage.removeItem(xr(t))}catch{}},_r="ws-crm-closing-agent-field-link",Zl=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${_r}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},mr=!1,kr=async t=>{if(mr)return;let e=Qn();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){mr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await wr({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),yr(a.id,a.name,t);let i=document.getElementById(re);if(i){be(i,{status:"linked",contactName:a.name});let s=dt();s&&Xn(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{mr=!1}}},ed=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Qn=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();ed.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},yr=(t,e,o)=>{let r=Qn();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${_r}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=_r,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Xt=()=>{document.getElementById(Yn)?.remove()},td=t=>{Xt();let e=document.createElement("div");e.id=Yn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Xt()}),i?.addEventListener("click",Xt);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await wr({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${Qt(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Qt(m.email||"(no email)")} \xB7 ${Qt(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Qt(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Xt(),t.onPick(m)}),a.appendChild(h)})}catch(b){p.error("Closing Agent picker search failed",b),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},Qt=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),be=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,c="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=c},od=(t,e)=>{let o=document.createElement("button");o.id=re,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};be(o,r);let a=Jn(t);return a&&(r={status:"linked",contactName:a.contactName},be(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Jl(t,e);s?(r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},yr(s.id,s.name,e)):a||(r={status:"empty"},be(o,r),ge?.oppId===t&&(ge=null),Zl(),Ql(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||td({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},be(o,r);try{let l=[Wn({tenantId:e,oppId:t,fieldId:Kn,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Wn({tenantId:e,oppId:t,fieldId:jl,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Xn(t,s.id,s.name),yr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},be(o,r)}}})}),o},rd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],nd=async()=>{for(let t of rd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},st=!1,eo=async()=>{if(!st){st=!0;try{await ad()}finally{st=!1}}},ad=async()=>{let t=dt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await nd();if(!r||!(Jn(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await N()!=="Transaction Coordination")return;let i=dt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=od(t.oppId,i.locationId),l=document.createElement("span");l.id=`${re}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),id(t.oppId),kr(i.locationId)},lt=null,gr=null,fr=null,Zt=()=>{lt?.disconnect(),lt=null,gr=null,fr=null},id=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(lt&&gr===t&&fr===e||(Zt(),gr=t,fr=e,lt=new MutationObserver(()=>{let o=dt();if(!o||o.oppId!==t||!o.locationId){Zt();return}document.getElementById(re)||eo(),kr(o.locationId)}),lt.observe(e,{childList:!0,subtree:!0})))},ur=null,vr,sd=()=>{ur||(ur=new MutationObserver(()=>{vr===void 0&&(vr=window.setTimeout(()=>{vr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!st&&eo()},300))}),ur.observe(document.body,{childList:!0,subtree:!0}))},jn,ld=()=>{jn===void 0&&(jn=window.setInterval(()=>{let t=dt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(re)&&!st&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),eo()),kr(t.locationId)},2e3))},Zn=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),sd(),ld(),eo()};var dd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",$e="ws-crm-manage-team-cta",ta="ws-crm-manage-team-modal",cd=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,oa={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},pd={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ra=()=>{let t=window.location.pathname.match(cd);return t?{tenantId:t[1]}:null},oo=async t=>{let e=await fetch(dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},J=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),he=t=>J(t),Er="ws-crm-manage-team-toast",Ar=(t,e="info",o=4e3)=>{document.getElementById(Er)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Er,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Er)===a&&a.remove()},o)},Tr=()=>{document.getElementById(ta)?.remove()},bd=(t,e)=>{let o=pd[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${J(e)}</span>
  `},hd=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>bd(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${he(t.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${he(t.email)}" data-user-id="${he(t.id)}" data-name="${he(o)}" data-current-roles="${he(t.role_keys.join(","))}" style="${$} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${he(t.email)}" data-name="${he(o)}" data-role-count="${he(String(t.role_keys.length))}" style="${$} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},md=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>hd(r,e)).join(""),ro=async t=>{Tr();let e=document.createElement("div");e.id=ta,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&Tr()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Tr);let r;try{r=await oo({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+md(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{ud(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;vd(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;_d(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},ud=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${J(oa[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{ro(t)}),to(e),setTimeout(()=>to(e),200),setTimeout(()=>to(e),800),window.addEventListener("resize",()=>to(e)),e},Td=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],Sd=async()=>{for(let t of Td)try{let e=await L(t,{timeoutMs:1500});if(e)return e}catch{}return null},Sr=!1,Ad=async()=>{if(!Sr){Sr=!0;try{let t=ra();if(!t){document.getElementById($e)?.remove();return}let e=document.getElementById($e);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await Sd();if(!o){let i=document.createElement("div");i.id=`${$e}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=ea(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),p.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=ea(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),p.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{Sr=!1}}},na=()=>{if(!ra()){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}Ad()};var Cd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Lr="ws-crm-prepare-contract-button",aa="ws-crm-prepare-contract-menu",ie="ws-crm-prepare-contract-modal",ia="ws-crm-modal-date-style",le="https://services.leadconnectorhq.com",pa=()=>{if(document.getElementById(ia))return;let t=document.createElement("style");t.id=ia,t.textContent=`
  ...
  `,document.head.appendChild(t)},$r="__WS_CRM_CAPTURED_AUTH",Id=50*60*1e3,ba=()=>{try{let t=localStorage.getItem($r);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Id?(localStorage.removeItem($r),null):e:null}catch{return null}},Ld=t=>{try{localStorage.setItem($r,JSON.stringify(t))}catch{}},de=()=>{let t=ba(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},sa=!1,$d=()=>{if(sa)return;sa=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=ba()?.authorization;Ld({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ha=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Md=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ha()},Dd=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ma="__WS_CRM_TEMPLATES_CACHE_V1",Od=24*60*60*1e3,la=t=>{try{let e=window.localStorage.getItem(ma);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Od?null:o.templates}catch{return null}},Fd=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(ma,JSON.stringify(o))}catch{}},Hd=async t=>{let e=`${le}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:de()})}catch(s){let l=la(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=la(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Dd(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Fd(t,i),i},Pd=async(t,e)=>{let o=await fetch(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:de()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},Bd=async(t,e)=>{let o=await fetch(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:de()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},Rd=async t=>{let e=await fetch(Cd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Nd=async(t,e,o)=>{let r=`${le}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:de()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},zd=async(t,e)=>{let o=await fetch(`${le}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Gd=async t=>{let e=await fetch(`${le}/contacts/${t}`,{method:"GET",headers:de()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},qd=async(t,e,o,r)=>{let a;try{a=await zd(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await Gd(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${le}/proposals/document/${e}`,{method:"PUT",headers:{...de(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},Ud=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},ao="__WS_CRM_PENDING_INSTRUCTIONS",Vd=60*1e3,Wd=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],jd=t=>{let e=(t||"").toLowerCase();for(let o of Wd)if(e.includes(o.matches.toLowerCase()))return o;return null},Kd=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(ao,JSON.stringify(r))}catch{}},Yd=()=>{try{let t=localStorage.getItem(ao);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Vd?(localStorage.removeItem(ao),null):e}catch{return null}},Jd=()=>{try{localStorage.removeItem(ao)}catch{}},Xd=(t,e)=>{document.getElementById(ie)?.remove();let o=document.createElement("div");o.id=ie,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Qd=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Zd=()=>{let t=window.location.pathname.match(Qd);if(!t)return;let e=t[1],o=Yd();o&&o.proposalId===e&&(Jd(),window.setTimeout(()=>{Xd(o.title,o.bodyHtml)},600))},da="ws-crm-prepare-contract-toast",z=(t,e="info",o=4e3)=>{document.getElementById(da)?.remove();let r=document.createElement("div");r.id=da;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},ca=(t,e)=>new Promise(o=>{document.getElementById(ie)?.remove();let r=document.createElement("div");r.id=ie,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,w.appendChild(y),document.body.appendChild(w);let B=y.querySelector("#ws-pc-purchase-price"),K=y.querySelector("#ws-pc-emd"),V=y.querySelector("#ws-pc-cash-at-close"),H=!1;V?.addEventListener("input",()=>{H=!0});let Me=()=>{if(H)return;let R=Number(B?.value||0),G=Number(K?.value||0);V&&(V.value=String(Math.max(0,R-G)))};B?.addEventListener("input",Me),K?.addEventListener("input",Me);let vt=()=>w.remove();w.addEventListener("click",R=>{R.target===w&&vt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",vt);let Y=y.querySelector("#ws-pc-submit"),j=y.querySelector("#ws-pc-error");Y?.addEventListener("click",async()=>{if(Y){j&&(j.textContent=""),Y.disabled=!0,Y.textContent="Opening\u2026";try{let R=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),G=Number(B?.value||0),De=Number(K?.value||0),Oe=Number(V?.value||0),Fe=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),He=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Pe=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),we=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Be=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),q={};if(R!==s&&(q.sellerName=R),G!==l&&(q.purchasePrice=G),De!==d&&(q.emd=De),Oe!==c&&(q.cashAtClose=Oe),Fe!==b&&(q.daysToClose=Fe),He!==m&&(q.inspectionDays=He),Pe!==h&&(q.additionalTerms=Pe),we!==v&&(q.currentOccupancy=we),Be!==x&&(q.occupancyAtClose=Be),Object.keys(q).length>0){p.info("[prepare-contract] PA modal submit with overrides:",q),Y.textContent="Saving\u2026";let vo=I(),_o=await io({tenantId:t,contactId:e,template:o,userId:vo,overrides:q});p.info("[prepare-contract] re-stage with overrides ok:",_o),Y.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let U=i?`${i} - Purchase Agreement`:void 0;await Or(t,e,o,U)}catch(R){Y.disabled=!1,Y.textContent="Open Contract",j&&(j.textContent=R.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",R)}}})},tc=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ie)?.remove(),pa();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,S="",A=document.createElement("div");A.id=ie,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(k),document.body.appendChild(A);let V=k.querySelector("#ws-pc-assignment-price"),H=k.querySelector("#ws-pc-assignment-fee"),Me=!1;H?.addEventListener("input",()=>{Me=!0});let vt=()=>{if(Me)return;let G=Number(V?.value||0);H&&(H.value=String(Math.max(0,G-x)))};V?.addEventListener("input",vt);let Y=()=>A.remove();A.addEventListener("click",G=>{G.target===A&&Y()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",Y);let j=k.querySelector("#ws-pc-submit"),R=k.querySelector("#ws-pc-error");j?.addEventListener("click",async()=>{if(!j)return;R&&(R.textContent="");let G=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),De=Number(V?.value||0),Oe=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),Fe=Number(H?.value||0),He=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Pe=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),we=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Be=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),q=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!we){R&&(R.textContent="Closing Date is required.");return}j.disabled=!0,j.textContent="Opening\u2026";try{let U={};G!==b&&(U.sellerName=G),De!==m&&(U.assignmentPrice=De),Oe!==h&&(U.buyerEMD=Oe),Fe!==v&&(U.assignmentFee=Fe),He!==E&&(U.closingOffice=He),Pe!==w&&(U.buyerCompanyName=Pe);let vo=we!==y||Be!==f||q!==S,_o=Object.keys(U).length>0||vo,yo=a;_o?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",U),j.textContent="Saving\u2026",yo=await io({tenantId:t,contactId:e,template:o,oppId:r,closingDate:we,buyerEarnestDueDate:Be,lenderSource:q,userId:i,overrides:Object.keys(U).length>0?U:void 0}),p.info("[prepare-contract] AA re-stage ok:",yo),j.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Br=yo?.debug?.propertyAddress||c,Ra=Br?`${Br} - Assignment Agreement`:void 0;await Or(t,e,o,Ra),Y()}catch(U){j.disabled=!1,j.textContent="Open Contract",R&&(R.textContent=U.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",U)}})},io=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Rd({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Or=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Nd(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await qd(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),z(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=jd(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Kd(a,s.title,s.bodyHtml)),Ud(t,a)},oc=async t=>{let e=Md(t);if(!e){z("Could not resolve contact context.","error");return}document.getElementById(aa)?.remove();let o=document.createElement("div");o.id=aa,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Hd(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=I();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await Bd(e.tenantId,e.contactId)}catch(f){z(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){z("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await ca(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),x=h(7);z("Reading contract data\u2026","info",2500);let E;try{E=await io({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:v,buyerEarnestDueDate:x,userId:c})}catch(y){z(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){z("Could not resolve buyer contact for this opp.","error",6e3);return}tc({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:v,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){z("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Pd(e.tenantId,e.contactId)}catch(v){z(`Failed to load ACQ opps: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",v);return}if(b.length===0){z("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let v=await ca(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,p.info(`[prepare-contract] picked ACQ opp ${m}`)}z("Reading contract data\u2026","info",2500);let h;try{h=await io({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){z(`Failed to prepare contract: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",v);return}ec({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){z("This template needs to be started from a contact page.","error",6e3);return}z(`Opening ${i.name}\u2026`,"info",2500);try{await Or(e.tenantId,e.contactId,i)}catch(b){z(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),z(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},ua=()=>{let t=document.createElement("button");return t.id=Lr,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),oc(t)}),t},rc="ws-crm-contact-actions-bar",nc=async()=>{let t=ha();if(!t){document.getElementById(Lr)?.remove();return}let e=null;try{e=await L(`#${rc}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Lr);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=ua();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},fe="ws-crm-prepare-contract-button-opp",ct=`${fe}-wrap`,ac=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ic=/\/v2\/location\/([A-Za-z0-9]+)/,sc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mr=()=>{let t=window.location.pathname,e=t.match(ac);if(!e)return null;let o=t.match(ic);return o?{oppId:e[1],tenantId:o[1]}:null},lc=async()=>{for(let t of sc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,pt=null,Dr=null,Cr=null,Ir,bt=()=>{pt?.disconnect(),pt=null,Dr=null},dc=t=>{if(pt&&Dr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dr=t,pt=new MutationObserver(()=>{let o=Mr();if(!o||o.oppId!==t){bt();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(fe)?.remove(),document.getElementById(ct)?.remove(),bt();return}document.getElementById(fe)||va()}),pt.observe(e,{childList:!0,subtree:!0}))},cc=()=>{Cr||(Cr=new MutationObserver(()=>{Ir===void 0&&(Ir=window.setTimeout(()=>{Ir=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);t&&!e&&!no&&va()},300))}),Cr.observe(document.body,{childList:!0,subtree:!0}))},va=async()=>{if(!no){no=!0;try{let t=Mr();if(!t){document.getElementById(fe)?.remove(),document.getElementById(ct)?.remove(),bt();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(ct)?.remove(),bt());return}e&&(e.remove(),document.getElementById(ct)?.remove());let o=await lc();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Mr();if(!a||a.oppId!==t.oppId)return;let i=ua();i.id=fe,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=ct,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),dc(t.oppId)}finally{no=!1}}},_a=()=>{Zd(),nc()};$d();function W(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ae(t){return W(t)}var ho="reos-theme-stylesheet",Fa="reos-theme-fonts",pc=()=>{let t=document.getElementById(Fa);t&&t.remove()},bc=`
/* ============================================
...
`,hc=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],mc=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},uc=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),vc=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Fr=new WeakSet,ya=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Fr.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Fr.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Fr.add(e)}catch{}})}catch{}},ga=new WeakSet,ht=()=>{document.querySelectorAll(vc.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(ga.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),ga.add(r))})})},fa=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},so=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},wa=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},mt=()=>{for(let t of hc){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=uc.has(r)?mc(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},mo="#1A1F28",_c=26,yc=31,gc=40,xa=new Set,ka=new Set,lo=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!ka.has(a)&&a!=="<no class>"&&(ka.add(a),p.debug(`Hid empty "--" leaf: "${a}"`))})},fc=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],wc=["trash","Trash","TRASH","delete","Delete","DELETE"],xc=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(wc.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";fc.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},kc=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Ec=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||kc.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Ea=new Set,Ta=new WeakSet,Tc=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Ta.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Ta.add(e);let b=e.className?.toString()||"<no class>";!Ea.has(b)&&b!=="<no class>"&&(Ea.add(b),p.debug(`Remapped pure-white text -> bone: "${b}"`))})},Sa=new Set,Sc=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,c=l.backgroundImage||"",b=!1;if(c!=="none"&&c.includes("gradient"))b=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let A=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(A&&parseFloat(A[1])<.6)return;let k=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let g=parseInt(k[1],10),T=parseInt(k[2],10),C=parseInt(k[3],10);(g>=60||T>=60||C>=60)&&(g>230&&T>230&&C>230||(g>=80||T>=80||C>=80)&&(b=!0))}}if(!b)return;let h=(i.textContent||"").trim(),v=s,x=Array.from(i.querySelectorAll("*")).map(A=>(A.className?.toString()||"").toLowerCase()).join(" "),E=h.toLowerCase()==="ask ai"||v.includes("ai-button")||v.includes("ask-ai")||v.includes("askai"),w=v.includes("bg-clip-text")||v.includes("text-transparent")||x.includes("bg-clip-text")||x.includes("text-transparent"),y=Array.from(i.querySelectorAll("*")).some(A=>{let k=window.getComputedStyle(A),g=k.getPropertyValue("-webkit-background-clip")||"",T=k.getPropertyValue("background-clip")||"";return g.includes("text")||T.includes("text")});if(E||w||y){let A=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=g=>{A.forEach(T=>g.style.removeProperty(T))};k(i),i.querySelectorAll("*").forEach(k);return}let f="#12161D";i.style.setProperty("color",f,"important"),i.querySelectorAll("*").forEach(A=>{let k=A.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(A.style.setProperty("fill",f,"important"),A.style.setProperty("stroke",f,"important"),A.style.setProperty("color",f,"important")):(A.style.setProperty("color",f,"important"),A.style.setProperty("-webkit-text-fill-color",f,"important"))});let S=i.className?.toString()||"<no class>";!Sa.has(S)&&S!=="<no class>"&&(Sa.add(S),p.debug(`Darkened SVG icons on colored button: "${S}"`))})})},Aa=new Set,Ac=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let b=d.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let m=b.left<r.right&&b.right>r.left,h=b.top<r.bottom&&b.bottom>r.top;if(!(m&&h)||b.top+b.height/2<a)return;let x=b.width*b.height/(r.width*r.height);if(x>.55)return;let E=c,w=c.parentElement,y=0;for(;w&&w!==e&&y<3;){let S=w.getBoundingClientRect();if(S.width>0&&S.width<=30&&S.height<=30)E=w;else break;w=w.parentElement,y++}E.style.setProperty("transform","translateY(11px)","important");let f=(E.className?.toString()||"")+" "+E.tagName;Aa.has(f)||(Aa.add(f),p.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${f}"`))})})},Cc="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Ic=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",Cc,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Ca=new Set,Lc=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let b=r.className?.toString()||"<no class>";!Ca.has(b)&&b!=="<no class>"&&(Ca.add(b),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${c})): "${b}"`))})})},Ia=new Set,$c=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Ia.has(l)&&l!=="<no class>"&&(Ia.add(l),p.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},La=new Set,Mc=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let b=parseInt(c[1],10),m=parseInt(c[2],10),h=parseInt(c[3],10);if(!(b>200&&m>200&&h>200))return;let x=s.getBoundingClientRect();if(x.width<24||x.height<16||x.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let E=s.className?.toString()||"<no class>";!La.has(E)&&E!=="<no class>"&&(La.add(E),p.debug(`Coerced light bg (${x.width.toFixed(0)}x${x.height.toFixed(0)}, rgb(${b},${m},${h})): "${E}"`))})})},$a=new Set,Dc=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=o.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let f=0;f<4&&a;f++){let S=a.nextElementSibling;if(S&&(S.matches(t)||S.querySelector(t)!==null)){i=S;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),c=l.className?.toString()||"",b=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",v=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);v&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let E=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;E&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!b&&!m&&!v&&!x&&!E&&!w&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",mo,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let y=o.className?.toString()||"<no class>";!$a.has(y)&&y!=="<no class>"&&($a.add(y),p.debug(`Colored field label "${r.slice(0,30)}": "${y}"`))})},Ma=new Set,Oc=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Ma.has(d)&&d!=="<no class>"&&(Ma.add(d),p.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Da=new Set,Fc=new Set(["Enter Dashboard Name"]),Hc=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Fc.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",mo,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",mo,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!Da.has(i)&&i!=="<no class>"&&(Da.add(i),p.debug(`Forced input slate bg: "${i}"`))})},co=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<_c&&l<yc&&d<gc))return;let b=e.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;e.style.setProperty("background-color",mo,"important");let m=e.className?.toString()||"<no class>";!xa.has(m)&&m!=="<no class>"&&(xa.add(m),p.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},po=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,b=!1;if(e.forEach(v=>{c.includes(v)&&(c=c.split(v).join(t),b=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(v=>{c.includes(v)&&(c=c.split(v).join("transparent"),b=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(x=>{c.includes(x)&&(c=c.split(x).join("#EDEEF0"),b=!0)}),!!b)try{let v=btoa(c);i.setAttribute("src",`data:image/svg+xml;base64,${v}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},bo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Pc=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},ut=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let b=r.querySelector(".ui-upload-icon svg");b&&(b.style.setProperty("color",c,"important"),b.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},Hr=new WeakSet,Bc=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Hr.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Hr.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${wt}`,t.title=`Built ${xt}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var P=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Ba=()=>{if(p.info(`Loaded v${wt} (built ${xt})`),go()){p.info(`[main] customizer disabled for excluded location ${xe()} \u2014 bailing`);return}P("mountVersionBadge (initial)",uo),P("mountFavicon",un),P("mountThemeStylesheet",Ha),P("initPageRouter",zr),p.info("[main] registering onPageChange subscriber"),ft(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),go()){p.info(`[main] page change into excluded location ${xe()} \u2014 skipping mounts`);return}P("mountVersionBadge",uo),P("mountClaimReleaseToggle",rn),P("mountContactActionsBar",hn),P("mountActiveFollowUpButton",jr),P("mountMtOfferMadeButton",_n),P("mountNotInterestedButton",yn),P("mountResendDealLinkButton",fn),P("mountReducePriceButton",kn),P("mountEditLandingPageButton",En),P("mountPublishButton",An),P("mountContactMapLinks",Mn),P("mountSendToClosingOfficeButton",Pn),P("mountClosingAgentPickerButton",Zn),P("mountPrepareContractButton",_a),P("mountManageTeam",na),P("mountBuyBoxWidget",Zr),P("mountSupportNavItem",Vn)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ba):Ba();})();
