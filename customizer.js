/* Wholesaling CRM Customizer v0.52.1 — built 2026-07-09T13:20:39.101Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Jo="[wholesaling-crm-customizer]",Xc="__WS_CRM_DEBUG",tp=()=>!!window[Xc],p={info(...t){console.log(Jo,...t)},warn(...t){console.warn(Jo,...t)},error(...t){console.error(Jo,...t)},debug(...t){tp()&&console.log(Jo,"[debug]",...t)}};var ep=/\/v2\/location\/([A-Za-z0-9]+)/,op=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match(ep);return t?t[1]:null},vn=()=>{let t=K();return t!==null&&op.has(t)};var Is=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,yn=/\/v2\/location\/([A-Za-z0-9]+)/,rp=t=>{let e=t.match(Is);if(!e)return null;let o=t.match(yn);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},np=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Is);if(!a)continue;let s=r.match(yn)||window.location.pathname.match(yn);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=rp(window.location.pathname);return t||np()};var Ms=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Zo="",gn=null,re="other",fn=new Set,Qo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Zo)&&!(t!==gn))){Zo=window.location.pathname,gn=t,re=Ms(),p.debug("Page/context changed:",re,Zo,"contact:",t);for(let r of fn)try{r(re)}catch(a){p.error("Subscriber threw:",a)}}},_t=t=>(fn.add(t),setTimeout(()=>t(re),0),()=>{fn.delete(t)}),Ps=()=>{re=Ms(),Zo=window.location.pathname,gn=D()?.contactId??null,p.debug("Router init, current page:",re);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Qo()},history.replaceState=function(o,r,a){e(o,r,a),Qo()},window.addEventListener("popstate",Qo),setInterval(Qo,1e3)},ye=()=>re;var ap=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Rs=null,Os=!1,Bs=t=>{let e=t.match(ap);e&&(Rs=e[1])},Hs=()=>{if(!Os){Os=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Bs(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Bs(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},Ut=()=>Rs;var Xo="0.52.1",tr="2026-07-09T13:20:39.101Z";var sp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",er=new Map,xn=new Map,ip=3e4,to=4e3,lp=to,$t=async(t,e)=>{if(!t)return null;let o=er.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<ip)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=xn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),lp);try{let l=`${sp}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),er.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let u=(m.contact_type||"").toLowerCase().trim()||null;return er.set(t,{type:u}),p.debug(`Resolved Contact Type for ${t}: ${u??"(unset)"}`),u}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),er.set(t,{type:null,failedAt:Date.now()}),null}})();xn.set(t,s);try{return await s}finally{xn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var P=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let u=a.querySelector(t);u&&(m(),s(u))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},wn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ds=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,H=`
  ...
  flex-shrink: 0;
`;var dp=/^[A-Za-z0-9]{15,30}$/,eo=t=>typeof t=="string"&&dp.test(t),Fs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},cp=()=>{let t=window.WS_CRM_USER_ID;return eo(t)?t:null},pp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(eo(o))return o;return null},mp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Fs(e);if(!o)return null;let r=o.uid;if(eo(r))return r;let a=o.claims;if(a&&eo(a.user_id))return a.user_id}catch{}return null},bp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(eo(a))return a}catch{}}}catch{}return null},R=()=>cp()||mp()||pp()||bp()||null,hp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Fs(e);return o?o.claims??o:null}catch{return null}},ge=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:hp()?.type==="agency"};var Us="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",up=`${Us}/active-follow-up-get`,_p=`${Us}/active-follow-up-set`,ne="ws-crm-active-follow-up-button",En={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},vp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},yp=async t=>{let e=await fetch(up,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},gp=async(t,e)=>{let o=await fetch(_p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ae=(t,e)=>{let o=En[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},zs=t=>{let e=document.createElement("button");return e.type="button",e.id=ne,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ae(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=vp();if(!(!r||r.contactId!==t)){ae(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await gp(r,R()),s=a&&a.state&&a.state in En?a.state:"blue";ae(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ae(e,"error"),setTimeout(()=>void rr(e,r),4e3)}}}),e},fp=3e4,rr=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),ae(t,"loading");try{let o=await yp(e),r=o&&o.state&&o.state in En?o.state:"gray",a=document.getElementById(ne);if(!a||a.dataset.contactId!==e.contactId)return;ae(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,ae(t,"error")}},xp=[".central-panel","[class*='central-panel']"],kn="ws-crm-contact-actions-bar",wp=async()=>{for(let t of xp)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await P("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},kp=async(t,e)=>{let o=e.querySelector(`#${kn}`);if(!o)try{o=await P(`#${kn}`,{timeoutMs:to+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{im(t,e,()=>On(t,e))}),o},On=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Gp(t,e),Ln()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}nm(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},nm=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let u=l.key==="state"?Yp(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Vp(r,c).then(u=>{if(!u.ok){alert(`Failed to remove: ${u.error||"unknown error"}`),l.disabled=!1;return}On(r,a)}).catch(u=>{alert(`Network error: ${u.message}`),l.disabled=!1}))})})},ir=!1,ti=(t,e)=>{ir=e;let o=om(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=am,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",On(t.tenantId,t.buyerContactId)):(t.iconBtn.className=ei,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},ei="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",am="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",sm=t=>{let e=document.createElement("button");return e.id=Xs,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=ei,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Jp.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!ir;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ti(r,a)}),e},im=(t,e,o)=>{let r=document.getElementById(Qs);r&&r.remove();let a=document.createElement("div");a.id=Qs,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await Ln();s.innerHTML=u(w),_(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let w=await Ln();s.innerHTML=g(w),x(w)}else i.granularity==="county"?(s.innerHTML=b(i.stateCode||""),await jp(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=b(i.stateCode||""),await Wp(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,$=()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),w.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),S())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void S()),setTimeout(()=>w.focus(),0))},S=async()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),A=(w?.value||"").trim();if(!/^\d{5}$/.test(A)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(A)},T=async w=>{if(!i.granularity||!w)return;let E=s.querySelector("#ws-buybox-err"),A=s.querySelector("#ws-buybox-save");A&&(A.disabled=!0,A.textContent="Adding\u2026"),E&&(E.textContent="");try{let B=await Kp(t,e,i.granularity,w);if(!B.ok){E&&(E.textContent=B.error||"Failed to add entry."),A&&(A.disabled=!1,A.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(B){E&&(E.textContent=`Network error: ${B.message}`),A&&(A.disabled=!1,A.textContent="Add")}};d()},An=!1,fe=null,co=null,Zs=()=>{document.getElementById(Xs)?.remove(),document.getElementById(In)?.remove(),co&&fe&&fe.nav.removeEventListener("click",co,!0),co=null,fe=null,ir=!1},oi=()=>{lm()},lm=async()=>{if(!An){An=!0;try{let t=D();if(!t){Zs();return}let e=document.getElementById(In);if(e&&e.dataset.buyerContactId===t.contactId&&fe)return;Zs();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(u){p.warn("[buy-box] Contact Type fetch failed",u);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([tm(),em()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=rm(t.locationId,t.contactId),l=sm(()=>fe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};fe=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),co=u=>{let _=u.target;if(!_||c.iconBtn.contains(_))return;_.closest("button.sidebar-option-button")&&ir&&ti(c,!1)},a.addEventListener("click",co,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{An=!1}}};var ai="ws-properties-nav-icon",Dn="ws-properties-panel",ri="ws-properties-modal",Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",dm=`${Fn}/list-for-contact`,cm=`${Fn}/create-with-opp`,pm=`${Fn}/add-contact`,mm=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),bm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,si=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},lr=t=>{let e=si(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},Bn=t=>{let e=si(t);return e===null?"&mdash;":e.toLocaleString()},ii={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},hm=t=>{let e=(t||"").toString().trim();return e?mt(ii[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},um=t=>{let e=(t||"").toString().trim();return e?ii[e]||e:""},_m={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},vm=t=>{let e=(t||"").toString().trim();return e?_m[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},jt=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,ym=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${jt("Baths",Bn(t.baths))}
    ${jt("Sq Ft",Bn(t.sqft))}
    ${jt("Rehab",hm(t.rehab_level),um(t.rehab_level))}
    ${jt("ARV",lr(t.arv))}
    ${jt("IMV",lr(t.imv))}
    ${jt("MAO",lr(t.mao))}
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},gm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',fm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',xm="nav.w-13, nav[class*='w-13']",wm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",di="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",km="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Em=async()=>{try{return await P(xm,{timeoutMs:2500})}catch{return null}},$m=async()=>{try{return await P(wm,{timeoutMs:2500})}catch{return null}},zn=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),Ct=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:13px;outline:none;margin-bottom:10px;`,St=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,Nn=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${h.sans};font-size:13px;font-weight:600;`,ci=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${h.sans};font-size:13px;`,Tm=(t,e)=>{let o=document.createElement("div");return o.id=Dn,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Sm(t,e,()=>qn(t,e))}),o},qn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await zn(dm,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}Cm(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},Cm=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
    ...
    <select id="wp-type" style="${Ct}">
      ...
      ${mm.map(i=>`<option value="${mt(i)}">${mt(i)}</option>`).join("")}
    </select>
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=_r();!o||!o.locationId||o.oppId!==t||ub({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=H)},4e3)}})}),e},vb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yb=async()=>{for(let t of vb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ur=!1,Yn=async()=>{if(!ur){ur=!0;try{await gb()}finally{ur=!1}}},gb=async()=>{let t=_r();if(!t||!t.locationId){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}let e=document.getElementById(gt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo());return}e&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove());let o=await yb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_r();if(!a||a.oppId!==t.oppId)return;let s=_b(t.oppId),i=document.createElement("span");i.id=`${gt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),fb(t.oppId)},ho=null,Vn=null,Ee,uo=()=>{ho?.disconnect(),ho=null,Vn=null,Ee!==void 0&&(window.clearTimeout(Ee),Ee=void 0)},fb=t=>{if(ho&&Vn===t)return;uo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Vn=t,ho=new MutationObserver(()=>{Ee===void 0&&(Ee=window.setTimeout(()=>{Ee=void 0;let o=_r();if(!o||o.oppId!==t){uo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}document.getElementById(gt)||Yn()},250))}),ho.observe(e,{childList:!0,subtree:!0}))},xb=()=>{J("mt-offer-made",tt,()=>{!document.getElementById(gt)&&!ur&&Yn()})},Ri=()=>{xb(),Yn()};var wb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ft="ws-crm-not-interested-button",kb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Eb=/\/v2\/location\/([A-Za-z0-9]+)/,yr=()=>{let t=window.location.pathname,e=t.match(kb),o=e?e[1]:Ut();if(!o)return null;let r=t.match(Eb);return{oppId:o,locationId:r?r[1]:null}},$b=async t=>{let e=await fetch(wb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Tb=t=>{let e=document.createElement("button");return e.id=ft,e.type="button",e.dataset.oppId=t,e.style.cssText=H,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=yr();if(!o||!o.locationId||o.oppId!==t)return;let r=R(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await $b({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Cb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sb=async()=>{for(let t of Cb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vr=!1,Qn=async()=>{if(!vr){vr=!0;try{await Ab()}finally{vr=!1}}},Ab=async()=>{let t=yr();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await Sb();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=yr();if(!a||a.oppId!==t.oppId)return;let s=Tb(t.oppId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Lb(t.oppId)},_o=null,Jn=null,vo=()=>{_o?.disconnect(),_o=null,Jn=null},Lb=t=>{if(_o&&Jn===t)return;vo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Jn=t,_o=new MutationObserver(()=>{let o=yr();if(!o||o.oppId!==t){vo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo();return}document.getElementById(ft)||Qn()}),_o.observe(e,{childList:!0,subtree:!0}))},Ib=()=>{J("not-interested",tt,()=>{!document.getElementById(ft)&&!vr&&Qn()})},Hi=()=>{Ib(),Qn()};var Mb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",vt="ws-crm-schedule-walkthrough-button",Zn="ws-crm-schedule-walkthrough-modal",Pb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ob=/\/v2\/location\/([A-Za-z0-9]+)/,xr=()=>{let t=window.location.pathname,e=t.match(Pb),o=e?e[1]:Ut();if(!o)return null;let r=t.match(Ob);return{oppId:o,locationId:r?r[1]:null}},gr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Bb=(t,e)=>{document.getElementById(Zn)?.remove();let o=document.createElement("div");o.id=Zn,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=xr();!o||!o.locationId||o.oppId!==t||Bb(o.oppId,o.locationId)}),e},Hb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Db=async()=>{for(let t of Hb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fr=!1,ta=async()=>{if(!fr){fr=!0;try{await Fb()}finally{fr=!1}}},Fb=async()=>{let t=xr();if(!t||!t.locationId){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go();return}let e=document.getElementById(vt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go());return}e&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove());let o=await Db();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=xr();if(!a||a.oppId!==t.oppId)return;let s=Rb(t.oppId),i=document.createElement("span");i.id=`${vt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),zb(t.oppId)},yo=null,Xn=null,$e,go=()=>{yo?.disconnect(),yo=null,Xn=null,$e!==void 0&&(window.clearTimeout($e),$e=void 0)},zb=t=>{if(yo&&Xn===t)return;go();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Xn=t,yo=new MutationObserver(()=>{$e===void 0&&($e=window.setTimeout(()=>{$e=void 0;let o=xr();if(!o||o.oppId!==t){go();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go();return}document.getElementById(vt)||ta()},250))}),yo.observe(e,{childList:!0,subtree:!0}))},Nb=()=>{J("schedule-walkthrough",tt,()=>{!document.getElementById(vt)&&!fr&&ta()})},Di=()=>{Nb(),ta()};var qb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Te="ws-crm-resend-deal-link-wrap",Ub=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jb=/\/v2\/location\/([A-Za-z0-9]+)/,kr=()=>{let t=window.location.pathname,e=t.match(Ub),o=e?e[1]:Ut();if(!o)return null;let r=t.match(jb);return{oppId:o,locationId:r?r[1]:null}},Wb=async t=>{let e=await fetch(qb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Gb=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Fi=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,oa=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=H,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Fi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Kb(t,e)),t.appendChild(o)},Kb=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Vb(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>oa(t,e)),o.appendChild(i),t.appendChild(o)},Vb=async(t,e,o,r)=>{let a=kr();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Wb({oppId:a.oppId,locationId:a.locationId,channel:o,userId:R()});if(s?.ok)r.innerHTML=`${Fi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Gb(i)}</span>`}window.setTimeout(()=>oa(t,e),3500)}},Yb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jb=async()=>{for(let t of Yb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wr=!1,ra=async()=>{if(!wr){wr=!0;try{await Qb()}finally{wr=!1}}},Qb=async()=>{let t=kr();if(!t||!t.locationId){document.getElementById(Te)?.remove(),xo();return}let e=document.getElementById(Te);if(e&&e.dataset.oppId===t.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(e.remove(),xo());return}e&&e.remove();let o=await Jb();if(!o)return;let r=await et();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=kr();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Te,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Q(o).appendChild(s),oa(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Zb(t.oppId)},fo=null,ea=null,xo=()=>{fo?.disconnect(),fo=null,ea=null},Zb=t=>{if(fo&&ea===t)return;xo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ea=t,fo=new MutationObserver(()=>{let o=kr();if(!o||o.oppId!==t){xo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Te)?.remove(),xo();return}document.getElementById(Te)||ra()}),fo.observe(e,{childList:!0,subtree:!0}))},Xb=()=>{J("resend-deal-link",tt,()=>{!document.getElementById(Te)&&!wr&&ra()})},zi=()=>{Xb(),ra()};var th="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",xt="ws-crm-reduce-price-button",Ni="ws-crm-reduce-price-modal",eh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,oh=/\/v2\/location\/([A-Za-z0-9]+)/,Tr=()=>{let t=window.location.pathname,e=t.match(eh);if(!e)return null;let o=t.match(oh);return{oppId:e[1],locationId:o?o[1]:null}},rh=async t=>{let e=await fetch(th,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Er=()=>{document.getElementById(Ni)?.remove()},nh=t=>{Er();let e=document.createElement("div");e.id=Ni,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Tr();!r||!r.locationId||r.oppId!==t||nh({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=H,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},sh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ih=async()=>{for(let t of sh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$r=!1,aa=async()=>{if(!$r){$r=!0;try{await lh()}finally{$r=!1}}},lh=async()=>{let t=Tr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await ih();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Tr();if(!a||a.oppId!==t.oppId)return;let s=ah(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),dh(t.oppId)},wo=null,na=null,Ce,ko=()=>{wo?.disconnect(),wo=null,na=null,Ce!==void 0&&(window.clearTimeout(Ce),Ce=void 0)},dh=t=>{if(wo&&na===t)return;ko();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(na=t,wo=new MutationObserver(()=>{Ce===void 0&&(Ce=window.setTimeout(()=>{Ce=void 0;let o=Tr();if(!o||o.oppId!==t){ko();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}document.getElementById(xt)||aa()},250))}),wo.observe(e,{childList:!0,subtree:!0}))},ch=()=>{J("reduce-price",tt,()=>{!document.getElementById(xt)&&!$r&&aa()})},qi=()=>{ch(),aa()};var Se="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Cr="deals.reinvestos.com";var wt="ws-crm-edit-landing-button",ph=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,mh=/\/v2\/location\/([A-Za-z0-9]+)/,Ar=()=>{let t=window.location.pathname,e=t.match(ph);if(!e)return null;let o=t.match(mh);return{oppId:e[1],locationId:o?o[1]:null}},bh=(t,e)=>{let o=new URL(`https://${Cr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Se);let r=R();return r&&o.searchParams.set("user",r),o.toString()},hh=(t,e)=>{let o=document.createElement("button");return o.id=wt,o.type="button",o.dataset.oppId=t,o.style.cssText=H,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ar();if(!r||!r.locationId||r.oppId!==t)return;if(!Se){p.warn("[edit-landing] editor session key not configured in this build");return}let a=bh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},uh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_h=async()=>{for(let t of uh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Sr=!1,ia=async()=>{if(!Sr){Sr=!0;try{await vh()}finally{Sr=!1}}},vh=async()=>{let t=Ar();if(!t||!t.locationId){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o();return}let e=document.getElementById(wt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o());return}e&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove());let o=await _h();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Ar();if(!a||a.oppId!==t.oppId)return;let s=hh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${wt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),yh(t.oppId)},Eo=null,sa=null,Ae,$o=()=>{Eo?.disconnect(),Eo=null,sa=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},yh=t=>{if(Eo&&sa===t)return;$o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(sa=t,Eo=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=Ar();if(!o||o.oppId!==t){$o();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o();return}document.getElementById(wt)||ia()},250))}),Eo.observe(e,{childList:!0,subtree:!0}))},gh=()=>{J("edit-landing-page",tt,()=>{!document.getElementById(wt)&&!Sr&&ia()})},Ui=()=>{gh(),ia()};var Gi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ie="ws-crm-publish-button",To="ws-crm-publish-wrap",Ir="ws-crm-publish-dropdown",fh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xh=/\/v2\/location\/([A-Za-z0-9]+)/,la=()=>{let t=window.location.pathname,e=t.match(fh);if(!e)return null;let o=t.match(xh);return{oppId:e[1],locationId:o?o[1]:null}},ji=async(t,e)=>{try{let o=await fetch(Gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:R()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},wh=async(t,e)=>{let o=await fetch(Gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:R()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},kh=(t,e)=>{if(!Se){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Cr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Se);let r=R();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Ir)?.remove()},Wi=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Ir;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `,At(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Jh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},At(o,a);return}if(y.rate_limited){b=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},At(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},At(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Rr.add(t),document.getElementById(Kt)?.remove(),document.getElementById(de)?.remove(),kt(),Lo();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Yh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),At(o,a),document.getElementById(Br)&&Pr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},At(o,a),kt();try{let f=await Qh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},At(o,a),f.checks&&Pr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},At(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},At(o,a),f.checks&&Pr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},At(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Br)?kt():a.checks&&Pr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,c=!1,m=Date.now(),u=1e4,_=5*60*1e3,b=0,g=!1,x=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=Io();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let S=Date.now()-m,T=Math.max(1500,u-S);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=S=>{let T=S.detail;if(!T||T.oppId!==t)return;hl(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}x()};E()};window.addEventListener(va,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(va,f),window.clearInterval($))},5e3)}return o},eu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ou=async()=>{for(let t of eu)try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Rr=new Set,ml=null,ru=t=>{t&&t!==ml&&(Rr.clear(),ml=t)},Or=!1,fa=async()=>{if(Or){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Or=!0;try{await nu()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Or=!1}},nu=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Io();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Kt)?.remove(),document.getElementById(de)?.remove(),kt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),ru(t.oppId),Rr.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Kt)?.remove(),document.getElementById(de)?.remove(),kt();return}let e=document.getElementById(Kt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(de)?.remove(),kt(),Lo());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(de)?.remove(),kt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await ou();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Io();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=tu(t.oppId,a.locationId),i=document.createElement("span");i.id=de,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),au(t.oppId)},Ao=null,ya=null,Lo=()=>{Ao?.disconnect(),Ao=null,ya=null},au=t=>{if(Ao&&ya===t)return;Lo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ya=t,Ao=new MutationObserver(()=>{let o=Io();if(!o||o.oppId!==t){Lo();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Kt)?.remove(),document.getElementById(de)?.remove(),kt(),Lo();return}document.getElementById(Kt)||fa()}),Ao.observe(e,{childList:!0,subtree:!0}))},su=()=>{J("send-to-closing",tt,()=>{if(document.getElementById(Kt)||Or)return;let t=Io();t&&Rr.has(t.oppId)||fa()})},_l=()=>{su(),fa()};var ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",iu=`${ka}/tc/welcome-call-prefill`,lu=`${ka}/tc/welcome-call-save`,du=`${ka}/tc/order-lockbox`,Mo="ws-crm-welcome-call-overlay",cu=["Regular Contract","Subject To","Seller Finance","Novation"],pu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],mu=["Gas","Electric","Propane","Oil"],bu=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],hu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Vt=["Yes","No"],uu=["Yes","No","Unknown"],_u=["Professional Photographer","Seller","Tenant"],vu=["Month-to-Month","Annual"],vl=["Current","Behind"],yu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Lt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Dr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,fl="margin-bottom:12px;",xl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,gu=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,yl=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=yl(o);return`<select id="${t}" style="${Dr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&yl(a)===r?"selected":""}>${Lt(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${Lt(e)}" placeholder="${Lt(o)}" style="${Dr}">`,fu=(t,e)=>`<textarea id="${t}" rows="3" style="${Dr}resize:vertical;">${Lt(e)}</textarea>`,xu=(t,e)=>`<input id="${t}" type="date" value="${Lt(e)}" style="${Dr}">`,F=(t,e)=>`<div style="${fl}"><label style="${xl}">${Lt(t)}</label>${e}</div>`,xa=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${yu.map(r=>`<label style="${gu}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${Lt(t)}</div>`,Oe=()=>{document.getElementById(Mo)?.remove()},ce=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},wu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    ...
    ${Rt("Contract")}
    ${F("Type of Contract",ot("wc-contract_type",cu,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",ot("wc-property_type",bu,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",ot("wc-utilities",pu,t.utilities))}
    ${F("Heat Source",ot("wc-heat_source",mu,t.heat_source))}
    ...
    ${Rt("Occupancy")}
    ${F("Property occupancy",ot("wc-occupancy",hu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",ot("wc-tenant_lease_type",vu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${F("Last rent paid",xu("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",ot("wc-hoa_rental_restriction",uu,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",ot("wc-photos_provided_by",_u,t.photos_provided_by))}
    <div style="${fl}">
  ...
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},wa=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),gl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},Hr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?Lt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},ku=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:wa("photos_avail_mornings"),photos_avail_afternoons:wa("photos_avail_afternoons"),photos_avail_evenings:wa("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),Eu=t=>{Oe();let e=document.createElement("div");e.id=Mo,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${h.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${wu(t)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Yt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch($u,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Jt(),Yt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Yt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Yt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Jt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},Ru=(t,e)=>{Jt();let o=document.createElement("div");o.id=$l;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${h.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Jt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},zr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=H,o.textContent=t,o},Hu=()=>{let t=zr("\u22EE","ghost");return t.style.lineHeight="1",t},Du=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Sl){let r=zr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Mu(t)),o.appendChild(r),o}if(e===La){let r=zr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Bu(t,r)),o.appendChild(r),o}if(e===Al){let r=zr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Il(t)),o.appendChild(r),o}return null},Fu=(t,e)=>{let o=[];if(e===La&&(o=[{label:"Re-order Lockbox",onClick:()=>void Il(t)}]),!o.length)return null;let r=document.createElement("span");r.id=El,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Hu();return a.addEventListener("click",s=>{s.stopPropagation(),Ru(o,a)}),r.appendChild(a),r},zu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Nu=async()=>{for(let t of zu)try{let e=await P(t,{timeoutMs:1200});if(e)return e}catch{}return null},Fr=()=>{document.getElementById(Ta)?.remove(),document.getElementById(El)?.remove(),Jt()},Nr=!1,Ia=async()=>{if(!Nr){Nr=!0;try{let t=Ll();if(!t){Fr();return}let e=z();if(e===null)return;if(e!=="Transaction Coordination"){Fr();return}let o=Iu(),r=document.getElementById(Ta);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Du(t,o);if(!a){Fr();return}let s=await Nu();if(!s)return;Fr();let i=Q(s),d=document.createElement("span");d.id=Ta,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Fu(t,o);l&&i.appendChild(l),qu(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{Nr=!1}}},Po=null,Sa=null,$a,kl=()=>{Po?.disconnect(),Po=null,Sa=null},qu=t=>{if(Po&&Sa===t)return;kl();let e=document.querySelector(Cl);e&&(Sa=t,Po=new MutationObserver(()=>{let o=Ll();if(!o||o.oppId!==t){kl();return}$a===void 0&&($a=window.setTimeout(()=>{$a=void 0,Ia()},250))}),Po.observe(e,{childList:!0,subtree:!0}))},Uu=()=>{J("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{Nr||Ia()})},Ml=()=>{Uu(),Ia()};var ju="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ma=null,Pl=null,Ol=async()=>{let t=K(),e=R();if(!t||!e)return null;if(Ma&&Pl===t)return Ma;try{let a=(await(await fetch(ju,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(i=>i.id===e);if(!a)return null;let s={name:[a.first_name,a.last_name].filter(Boolean).join(" ").trim(),email:(a.email??"").trim(),phone:(a.phone??"").trim(),role:(a.roles??[]).map(i=>i.display).filter(Boolean).join(", ")};return Ma=s,Pl=t,s}catch(o){return p.warn("[current-rep] roster load failed",o),null}};var Ht="ws-support-modal",Bl="ws-support-toast",Wu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Rl="ws-support-submitter-name",Hl="ws-support-submitter-email",Dl="ws-support-submitter-role",Gu=["Bug","Feature Request","Question","Billing","Onboarding Help"],pe=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ku=(t,e="success",o)=>{let r=document.getElementById(Bl);r&&r.remove();let a=document.createElement("div");a.id=Bl;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Vu=t=>{let e=(o,r,a)=>o.style.setProperty(r,a,"important");t.querySelectorAll("input, textarea").forEach(o=>{e(o,"background-color",n.obsidian),e(o,"color",n.bone),e(o,"-webkit-text-fill-color",n.bone),e(o,"border-color",n.steel);let r=o.previousElementSibling;r instanceof HTMLElement&&r.tagName==="DIV"&&(e(r,"color",n.bone),e(r,"-webkit-text-fill-color",n.bone))})},Yu=()=>{document.getElementById(Ht)?.remove();let t=(localStorage.getItem(Rl)??"").trim(),e=(localStorage.getItem(Hl)??"").trim(),o=(localStorage.getItem(Dl)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ht,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `,a.appendChild(s),document.body.appendChild(a);let d=()=>Vu(s);requestAnimationFrame(d),[50,150,400,800].forEach(l=>window.setTimeout(d,l)),Ol().then(l=>{if(!l||!document.getElementById(Ht))return;let c=(m,u)=>{let _=s.querySelector(m);_&&!_.value.trim()&&u&&(_.value=u)};c("#ws-support-name",l.name),c("#ws-support-email",l.email),c("#ws-support-role",l.role)}),a.addEventListener("click",l=>{l.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(c=>{c===l?(c.dataset.selected="true",c.style.borderColor=n.emerald,c.style.background=n.emeraldGlow,c.style.color=n.emeraldBright):(c.dataset.selected="false",c.style.borderColor=n.steel,c.style.background=n.steel,c.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=s.querySelector("#ws-support-err"),c=_=>{l&&(l.textContent=_)};if(c(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){c("Pick a category at the top.");return}if(!r.title){c("Add a title \u2014 a short summary.");return}if(!r.description){c("Add a description so we know what you're seeing.");return}if(!r.submitterName){c("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){c("Add a valid email so we can reply.");return}let m=K();if(!m){c("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Rl,r.submitterName),localStorage.setItem(Hl,r.submitterEmail),r.submitterRole&&localStorage.setItem(Dl,r.submitterRole)}catch{}let u=s.querySelector("#ws-support-submit");u&&(u.disabled=!0,u.textContent="Submitting\u2026",u.style.opacity="0.7");try{let b=await(await fetch(Wu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:m,category:r.category,title:r.title,description:r.description,submitter_user_id:R()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!b.ok){c(b.error||"Failed to submit ticket."),u&&(u.disabled=!1,u.textContent="Submit Ticket",u.style.opacity="1");return}a.remove();let g=b.ticket_short_id||"submitted";Ku(`Ticket ${g} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(_){c(`Network error: ${_.message}`),u&&(u.disabled=!1,u.textContent="Submit Ticket",u.style.opacity="1")}})},Ju=["/support-ticket","ws-support-modal","ws-support"],Qu=/\/custom-menu-link\//,Pa=!1,Fl=()=>{if(Pa||!Qu.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Ju.some(i=>s.includes(i))});if(r){Pa=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Yu(),Pa=!1},50);return}t<10&&setTimeout(e,150)};e()},zl=!1,Nl=()=>{zl||(zl=!0,_t(()=>setTimeout(Fl,50)),Fl(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var ql="ws-phone-assignments-modal",Ul="ws-phone-assignments-toast",Zu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Xu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",t_=["ACQ","DISPO","TC"],Gl="",Qt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),e_=(t,e="success",o)=>{document.getElementById(Ul)?.remove();let r=document.createElement("div");r.id=Ul;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Qt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Qt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},o_=(t,e,o)=>{let r=[`<option value="" ${o===Gl?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Qt(a)}" ${o===a?"selected":""}>${Qt(a)}</option>`)].join("");return`<select data-assign="${Qt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},r_=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Ba=async t=>{document.getElementById(ql)?.remove();let e=t||K(),o=document.createElement("div");o.id=ql,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Zu}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){p.error("[phone-assignments] GET failed",_);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Qt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:t_,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,c=i.length?i.map(_=>`<div style="${r_}">
    ...
    </div>`,u.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let b=_.getAttribute("data-assign")||"",[g,...x]=b.split(":"),k=x.join(":");g==="num"&&(_.value?d[k]=_.value:delete d[k])})}),u.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),u.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=u.querySelector("#ws-pa-err"),b=x=>{_&&(_.textContent=x)};b("");let g=u.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(Xu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){b(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),e_("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){b(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},n_=["ws-phone-assignments","phone-assignments"],a_=/\/custom-menu-link\//,Oa=!1,jl=()=>{if(Oa||!a_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return n_.some(i=>s.includes(i))});if(r){Oa=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Ba(s),Oa=!1},50);return}t<10&&setTimeout(e,150)};e()},Wl=!1,Kl=()=>{if(Wl)return;Wl=!0,_t(()=>setTimeout(jl,50)),jl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Ba()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Ba(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Vl="powerDialerApp",s_=".dialer",i_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',l_=".dial-item.dial-btn.dial-btn-enabled",Be=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},d_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},Ra=()=>{try{let e=window[Vl]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},Re=()=>document.querySelector(s_),qr=()=>Ra()!==null||Re()!==null?!0:!!window[Vl],Ur=(t,e)=>{let o=Ra();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},Yl=()=>{if(Re())return;let t=document.querySelector(i_);t?Be(t):p.warn("[dialer-bridge] Voice Calling button not found")},c_=()=>{let t=document.querySelector(".number-list-container")||Re();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Ha=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?d_(t.innerText):null},Jl=(t,e)=>{if(Ha()===t)return!0;let o=Ra();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Be(r);let a=c_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Be(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},Ql=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Ur("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Be(a)}},Zl=()=>{let t=Re();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(l_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Be(e),!0):Ur("makeCall",{provider:"twilio"})};var Da=()=>{let t=Re();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Be(e.closest("button")||e):Ur("closeCallBox")},Xl=()=>{Ur("closeCallBox")},td=t=>{let e=!1,o=()=>{let s=Re()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var p_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",m_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",ed=["acq","dispo","tc"],Bo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Oo=null,od=null,b_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&Oo&&od===o)return Oo;try{let a=await(await fetch(`${p_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Oo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},od=o,Oo}catch(r){return p.warn("[silo] config load failed",r),Oo??e}},me=null,rd=null,Fa=async(t=!1)=>{let e=K(),o=R();if(!e||!o)return[];if(!t&&me&&rd===e)return me;try{let s=(await(await fetch(m_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];me=ed.filter(d=>i.includes(d))}else ge()?me=[...ed]:me=[];return rd=e,me}catch(r){return p.warn("[silo] roster load failed",r),me??[]}},ad=()=>`ws-pd-calling-as:${R()||"anon"}`,sd=t=>{try{localStorage.setItem(ad(),t)}catch{}},za=async()=>{let t=await Fa();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(ad())}catch{}return e&&t.includes(e)?e:t[0]},nd=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},h_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),id=async t=>{let e=await za();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await b_(),a=h_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=nd(t),i=s?a.find(m=>nd(m)===s):void 0,d=i||a[0];if(!Jl(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Bo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Ha();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var u_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ld="data-ws-pd",dd="ws-crm-pd-panel",cd="ws-crm-pd-session",Zt=t=>new Promise(e=>setTimeout(e,t)),Ro=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),__=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},v_=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},y_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},g_=async t=>{let e=__(t);if(!e)return[];let o=v_(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Zt(550)}return o.scrollTop=0,y_(e)},f_=async(t,e)=>{try{let r=await(await fetch(u_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},x_=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,qa=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(dd)?.remove();let r=document.createElement("div");r.id=dd,r.style.cssText=x_;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((x,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Da()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Da()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await f_(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Zt(1200);continue}let u=l._phone||m?.phone||"",_=m?.name||l.name;if(!u){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Zt(1400);continue}if(await id(u),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(b){p.debug("[bulk-dialer] screen-follow nav failed",b)}i(`Calling ${u}\u2026`,d,_);try{Yl(),await Zt(250),Ql(u),await Zt(250),Zl()}catch(b){p.error("[bulk-dialer] dial failed",b)}if(await new Promise(b=>{let g=!1,x=()=>{g||(g=!0,window.clearInterval(y),k(),b())},k=td(x),y=window.setInterval(()=>{(a.stopped||a.skip)&&x()},300)}),a.stopped)break;try{Xl()}catch{}if(d<e.length-1)if(o)for(let b=5;b>0&&!a.stopped&&!a.advance;b--){for(i(`Next call in ${b}s\u2026`,d,_);a.paused&&!a.stopped&&!a.advance;)await Zt(200);if(a.advance||a.stopped)break;await Zt(1e3)}else for(i("Ready \u2014 press Call Next",d,_);!a.advance&&!a.stopped;)await Zt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Ua='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ja=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},w_=()=>{if(ye()!=="opportunity-list"||!ja()||!qr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${ld}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(ld,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Ua}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await g_(e);qa(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},He=null,Na,pd=!1,bd=()=>{if(pd)return;pd=!0,window.WS_CRM_PD_TEST=e=>void md("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Na!==void 0&&window.clearTimeout(Na),Na=window.setTimeout(w_,400)};_t(e=>{e==="opportunity-list"?(t(),He||(He=new MutationObserver(t),He.observe(document.body,{childList:!0,subtree:!0}))):He&&(He.disconnect(),He=null)})};var hd="ws-crm-pd-contacts-btn",k_=t=>new Promise(e=>setTimeout(e,t)),E_=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},$_=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Wa=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=E_(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},T_=async t=>{let e=new Map;if(t)return Wa(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(Wa(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(Wa(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await k_(220);return o.scrollTop=0,[...e.values()]},C_=()=>{if(ye()!=="contact-list"||!ja()||!qr()||document.getElementById(hd))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=hd,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${h.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${Ua}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=$_(),l=await T_(d);qa(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},De=null,Ga,ud=!1,_d=()=>{if(ud)return;ud=!0;let t=()=>{Ga!==void 0&&window.clearTimeout(Ga),Ga=window.setTimeout(C_,400)};_t(e=>{e==="contact-list"?(t(),De||(De=new MutationObserver(t),De.observe(document.body,{childList:!0,subtree:!0}))):De&&(De.disconnect(),De=null)})};var S_="ws-calling-as-chip",A_=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},Ka=!1,be=null,vd,gd=0,L_=3e4,I_=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},Va=()=>{if(!be||be.isConnected)return;let t=I_();t&&t.parent.insertBefore(be,t.before)},yd=async()=>{if(!(Ka||be)&&A_()){Ka=!0;try{let t=await Fa();if(!t.length)return;let e=await za()??t[0],o=t.length>1,r=document.createElement("div");r.id=S_,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${h.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${h.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Bo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Bo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${h.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Bo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",u=>{u.stopPropagation(),e=l,sd(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}be=r,Va(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{Ka=!1,gd=Date.now()}}},fd=()=>{be?Va():yd(),vd===void 0&&(vd=window.setInterval(()=>{be?Va():Date.now()-gd>=L_&&yd()},1500))};var M_="#12161D",P_="#EDEEF0",xd=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},wd=t=>{t.style.setProperty("background-color",M_,"important"),t.style.setProperty("color",P_,"important")},O_=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},B_=t=>{xd(t)&&wd(t);for(let e of Array.from(t.querySelectorAll("*")))xd(e)&&wd(e)},Ya=null,Ho=null,Ed=()=>{Ho&&(Ho.disconnect(),Ho=null),Ya=null},R_=t=>{if(Ya===t)return;Ed(),Ya=t;let e=!1,o=()=>{e=!1;try{B_(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Ho=new MutationObserver(r),Ho.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},kd=!1,jr=()=>{if(kd)return;kd=!0;let t=()=>{let o=O_();o?R_(o):Ed()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var H_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",D_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",F_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Cd="tc_closing_agent",z_="tc_closing_office",Et="ws-crm-closing-agent-picker-button",Sd="ws-crm-closing-agent-picker-modal",N_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,q_=/\/v2\/location\/([A-Za-z0-9]+)/,zo=()=>{let t=window.location.pathname,e=t.match(N_);if(!e)return null;let o=t.match(q_);return{oppId:e[1],locationId:o?o[1]:null}},es=async t=>{let e=await fetch(H_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$d=async t=>{let e=await fetch(D_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},U_=async(t,e)=>{try{let o=await fetch(F_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Cd}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await es({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},he=null,j_=60*60*1e3,os=t=>`ws-crm-to-cache:${t}`,Ad=t=>{try{let e=window.localStorage.getItem(os(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>j_||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Ld=(t,e,o)=>{try{window.localStorage.setItem(os(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},W_=t=>{try{window.localStorage.removeItem(os(t))}catch{}},Qa="ws-crm-closing-agent-field-link",G_=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Qa}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Ja=!1,rs=async t=>{if(Ja)return;let e=Id();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Ja=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await es({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Za(a.id,a.name,t);let s=document.getElementById(Et);if(s){Xt(s,{status:"linked",contactName:a.name});let i=zo();i&&Ld(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Ja=!1}}},K_=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Id=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();K_.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let u=l.getAttribute(m);u&&/Title\s+Officer/i.test(u)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:u})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Za=(t,e,o)=>{let r=Id();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Qa}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=Qa,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},Wr=()=>{document.getElementById(Sd)?.remove()},V_=t=>{Wr();let e=document.createElement("div");e.id=Sd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Xt(o,r);let a=Ad(t);return a&&(r={status:"linked",contactName:a.contactName},Xt(o,r),he={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await U_(t,e);i?(r={status:"linked",contactName:i.name},Xt(o,r),he={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Za(i.id,i.name,e)):a||(r={status:"empty"},Xt(o,r),he?.oppId===t&&(he=null),G_(),W_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||V_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Xt(o,r);try{let d=await $d({tenantId:e,oppId:t,fieldKey:Cd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await $d({tenantId:e,oppId:t,fieldKey:z_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Xt(o,r),he={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ld(t,i.id,i.name),Za(i.id,i.name,e),ul(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Xt(o,r)}}})}),o},J_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Q_=async()=>{for(let t of J_)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Do=!1,Vr=async()=>{if(!Do){Do=!0;try{await Z_()}finally{Do=!1}}},Z_=async()=>{let t=zo();if(!t||!t.locationId){document.getElementById(Et)?.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr();return}let e=document.getElementById(Et);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr());return}e&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await Q_();if(!r||!(Ad(t.oppId)!==null||he!==null&&he.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=zo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=Y_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${Et}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Q(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),X_(t.oppId),rs(s.locationId)},Fo=null,Xa=null,ts=null,Kr=()=>{Fo?.disconnect(),Fo=null,Xa=null,ts=null},X_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fo&&Xa===t&&ts===e||(Kr(),Xa=t,ts=e,Fo=new MutationObserver(()=>{let o=zo();if(!o||o.oppId!==t||!o.locationId){Kr();return}document.getElementById(Et)||Vr(),rs(o.locationId)}),Fo.observe(e,{childList:!0,subtree:!0})))},tv=()=>{J("closing-agent-picker",tt,()=>{!document.getElementById(Et)&&!Do&&Vr()})},Td,ev=()=>{Td===void 0&&(Td=window.setInterval(()=>{let t=zo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(Et)&&!Do&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Vr()),rs(t.locationId)},2e3))},Md=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),tv(),ev(),Vr()};var ov="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Dt="ws-crm-manage-team-cta",Od="ws-crm-manage-team-modal",rv=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Bd={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},nv={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Rd=()=>{let t=window.location.pathname.match(rv);return t?{tenantId:t[1]}:null},Jr=async t=>{let e=await fetch(ov,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},yt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),te=t=>yt(t),ns="ws-crm-manage-team-toast",is=(t,e="info",o=4e3)=>{document.getElementById(ns)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ns,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ns)===a&&a.remove()},o)},as=()=>{document.getElementById(Od)?.remove()},av=(t,e)=>{let o=nv[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${yt(e)}</span>
  `},sv=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>av(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>sv(r,e)).join(""),Qr=async t=>{as();let e=document.createElement("div");e.id=Od,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",as);let r;try{r=await Jr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+iv(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{lv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;dv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;cv(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},lv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${yt(Bd[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Qr(t)}),Yr(e),setTimeout(()=>Yr(e),200),setTimeout(()=>Yr(e),800),gv(),e},Pd=!1,gv=()=>{Pd||(Pd=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Dt);t instanceof HTMLButtonElement&&Yr(t)}))},ss=!1,fv=()=>{if(!ss){ss=!0;try{let t=Rd();if(!t){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}let e=document.getElementById(Dt);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Dt}-floater`)?.remove();let o=document.createElement("div");o.id=`${Dt}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=yv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{ss=!1}}},Hd=()=>{if(!Rd()){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}fv()};var xv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",cs="ws-crm-prepare-contract-button",Dd="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",Fd="ws-crm-modal-date-style",Ft="https://services.leadconnectorhq.com",Wd=()=>{if(document.getElementById(Fd))return;let t=document.createElement("style");t.id=Fd,t.textContent=`
  ...
  `,document.head.appendChild(t)},ps="__WS_CRM_CAPTURED_AUTH",wv=50*60*1e3,jo=()=>{try{let t=localStorage.getItem(ps);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>wv?(localStorage.removeItem(ps),null):e:null}catch{return null}},kv=t=>{try{localStorage.setItem(ps,JSON.stringify(t))}catch{}},ze=()=>{let t=jo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},zd=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((jo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Fe=async(t,e={},o=2)=>{let r=jo()?.capturedAt??0,a;try{a={...ze(),...e.headers??{}}}catch(i){if(o>0&&await zd(r,4e3))return Fe(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await zd(r,4e3)?Fe(t,e,o-1):s},Nd=!1,Ev=()=>{if(Nd)return;Nd=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=jo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let u=c.authorization||c.Authorization;if(!u){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=c["token-id"]||c["Token-Id"]||void 0,b=jo()?.authorization;kv({authorization:u,tokenId:_,capturedAt:Date.now()}),b!==u&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${u.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let u=m.headers;!u&&l[0]instanceof Request&&(u=l[0].headers);let _={};if(u instanceof Headers)u.forEach((b,g)=>_[g.toLowerCase()]=b);else if(Array.isArray(u))u.forEach(([b,g])=>_[b.toLowerCase()]=g);else if(u&&typeof u=="object")for(let b of Object.keys(u))_[b.toLowerCase()]=u[b];o(c,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Gd=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},$v=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Gd()},Tv=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Kd="__WS_CRM_TEMPLATES_CACHE_V1",Cv=24*60*60*1e3,qd=t=>{try{let e=window.localStorage.getItem(Kd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Cv?null:o.templates}catch{return null}},Sv=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Kd,JSON.stringify(o))}catch{}},Av=async t=>{let e=`${Ft}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Fe(e,{method:"GET"})}catch(i){let d=qd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=qd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Tv(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Sv(t,s),s},Lv=async(t,e)=>{let o=await Fe(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Fe(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},Iv=async(t,e)=>{let o=await Fe(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ze()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},Mv=async t=>{let e=await fetch(xv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Pv=async(t,e,o)=>{let r=`${Ft}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:ze()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Ov=async(t,e)=>{let o=await fetch(`${Ft}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:ze()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Vd=async t=>{let e=await fetch(`${Ft}/contacts/${t}`,{method:"GET",headers:ze()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Bv=async(t,e,o,r)=>{let a;try{a=await Ov(t,e)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await Vd(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],u={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Ft}/proposals/document/${e}`,{method:"PUT",headers:{...ze(),"Content-Type":"application/json"},body:JSON.stringify(u)});if(!_.ok){let b=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:b}}return{ok:!0}},Rv=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Xr="__WS_CRM_PENDING_INSTRUCTIONS",Hv=60*1e3,Dv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Fv=t=>{let e=(t||"").toLowerCase();for(let o of Dv)if(e.includes(o.matches.toLowerCase()))return o;return null},zv=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Xr,JSON.stringify(r))}catch{}},Nv=()=>{try{let t=localStorage.getItem(Xr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Hv?(localStorage.removeItem(Xr),null):e}catch{return null}},qv=()=>{try{localStorage.removeItem(Xr)}catch{}},Uv=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},jv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Wv=()=>{let t=window.location.pathname.match(jv);if(!t)return;let e=t[1],o=Nv();o&&o.proposalId===e&&(qv(),window.setTimeout(()=>{Uv(o.title,o.bodyHtml)},600))},Ud="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(Ud)?.remove();let r=document.createElement("div");r.id=Ud;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},jd=(t,e)=>new Promise(o=>{document.getElementById(Mt)?.remove();let r=document.createElement("div");r.id=Mt,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){sy(o,i.properties,d=>{a(!0),_s({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?ec(e,l.property_record_id,l):en(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),en(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?ec(e,i.property_record_id,i):en(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await _s({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),en(o,"Request failed. Try again.")}finally{a(!1)}}}),o},iy=async()=>{for(let t of ny)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}return null},rc=async(t,e)=>{let o=e.querySelector(`#${Zd}`);if(!o)try{o=await P(`#${Zd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},nc=()=>{let t=document.querySelectorAll(`#${_e}`);for(let e=1;e<t.length;e++)t[e].remove()},ly=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(_e)?.remove(),Ne();return}let e=t.locationId,o=document.getElementById(_e);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Ne();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(_e)?.remove();return}let a=await iy();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=oc(t.contactId,e);if(!await rc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}nc(),p.debug(`[compute-offer] mounted for ${t.contactId}`),on?.disconnect(),on=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){on?.disconnect();return}if(!document.getElementById(_e)){let d=oc(t.contactId,e);rc(d,a).then(()=>nc())}}),on.observe(a,{childList:!0})},on=null,Wo=null,dc=()=>{let t=D()?.contactId??null;if(Wo&&Wo.id===t)return;let e=ly().finally(()=>{Wo?.promise===e&&(Wo=null)});Wo={id:t,promise:e}};var cn="reos-theme-stylesheet",Ac="reos-theme-fonts",We=!1,dy=()=>{let t=document.getElementById(Ac);t&&t.remove()},cy=`
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var Es="https://services.leadconnectorhq.com",Ic="__WS_CRM_CAPTURED_AUTH";var zy=()=>{try{let t=localStorage.getItem(Ic);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(Ic),null):e:null}catch{return null}},Ny=()=>{let t=zy();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},$s=async(t,e={})=>{let o=Ny();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Dc=new Set(["ej0SqnTYIprechAMAPrd"]),Ge="contact-select-trigger",Fc="ws-crm-reply-from-warning",zc="contact-select-menu",Mc="ws-crm-rf-thread-opt",Ts="",Cs=!1,Vo=null,bn=null,Pc=!1,Yo="",Oc,oe=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Ss=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Pt=t=>(t||"").replace(/\D/g,"").slice(-10),Bc=t=>{let e=Pt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},qy=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Uy=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await $s(`${Es}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return oe("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},jy=async()=>{let t=await Uy();if(!t)return null;let e=await $s(`${Es}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return oe("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=qy(a);if(Pt(s).length===10)return s}return null},Ke=()=>document.getElementById(Fc)?.remove(),Nc=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Wy=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),qc=(t,e,o)=>{Ke();let r=document.getElementById(Ge);if(!r)return;let a=Nc(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Fc,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Wy(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${Bc(t)}</span>${i}. You're set to reply from ${Bc(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Gy=t=>{Vo?.disconnect();let e=document.getElementById(Ge);if(!e)return;let o=Nc(e)||e,r=Pt(Ss(e));Vo=new MutationObserver(()=>{let a=Ss(document.getElementById(Ge)),s=Pt(a);!s||s===r||(r=s,s===Pt(t)?Ke():qc(t,"",a))}),Vo.observe(o,{childList:!0,subtree:!0,characterData:!0})},Rc=()=>{let t=document.getElementById(zc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Yo&&(r=e.find(d=>Pt(o(d))===Pt(Yo))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),oe("decorateMenu: cache=",Yo,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(Mc);s&&s!==r&&s.removeAttribute("id"),r.id=Mc;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Ky=()=>{if(!Dc.has(K()||""))return;bn?.disconnect();let t=0,e=()=>{let o=document.getElementById(zc);if(o){Rc(),bn=new MutationObserver(()=>Rc()),bn.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Vy=t=>{let e=t.target;e&&e.closest&&e.closest("#"+Ge)&&(oe("From trigger clicked -> waiting for menu"),Ky())},Yy=async()=>{if(!Cs){Cs=!0;try{let t=document.getElementById(Ge);if(!t)return;let e=Ss(t),o=await jy();if(Yo=o||"",oe("check: from=",e,"thread=",o),!o){Ke();return}Pt(e)&&Pt(e)!==Pt(o)?(oe("MISMATCH -> banner"),qc(o,"",e)):(oe("match -> no banner"),Ke()),Gy(o)}finally{Cs=!1}}},Hc=()=>{if(!Dc.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){Ts="",Yo="",Vo?.disconnect(),bn?.disconnect(),Ke();return}let e=!!document.getElementById(Ge),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==Ts){if(Ts=r,!e){Vo?.disconnect(),Ke();return}oe("composer expanded on",o),Yy()}},Uc=()=>{Oc===void 0&&(Oc=window.setInterval(Hc,500)),Pc||(document.addEventListener("click",Vy,!0),Pc=!0),Hc()};var Jy="#1A1F28",Qy="#EDEEF0",As="#9098A3",Zy=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},Xy=t=>.2126*t.r+.7152*t.g+.0722*t.b,tg=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},jc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},eg=t=>{let e=Zy(getComputedStyle(t).backgroundColor);if(!e||Xy(e)<120)return;let o=tg(e);t.style.setProperty("background-color",Jy,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),jc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Qy),jc(t,"#note-date-added-text, [class*='475467']",As)},og=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",As,"important"),e.style.setProperty("-webkit-text-fill-color",As,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},Wc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)eg(t[e]),og(t[e])},Gc,Kc=()=>{Gc===void 0&&(Gc=window.setInterval(Wc,700)),Wc()};var rg='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',Vc=()=>{document.querySelectorAll(rg).forEach(t=>{t.setAttribute("autocomplete","off")})},Yc,Jc=()=>{Yc===void 0&&(Yc=window.setInterval(Vc,1e3)),Vc()};console.log("[ws-crm-customizer] bundle-loaded");var C=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Qc=()=>{p.info(`Loaded v${Xo} (built ${tr})`),vn()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Ko),C("mountDialerThemeFix",jr)):(C("mountVersionBadge (initial)",mn),C("mountFavicon",Mi),C("mountThemeStylesheet",Ko),C("mountHideLaunchpad",ma),C("mountHideNavItems",ba),C("mountRelabelNav",ha),C("mountHideTopmenuTabs",_a),C("mountContractsSection",ua)),C("installOppIdCapture",Hs),C("initPageRouter",Ps),p.info("[main] registering onPageChange subscriber"),_t(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),vn()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Ko),C("runThemeFastPass",ks),C("mountDialerThemeFix",jr),C("unmountContactMapLinks",ol);return}C("mountThemeStylesheet",Ko),C("runThemeFastPass",ks),C("mountVersionBadge",mn),C("mountHideLaunchpad",ma),C("mountHideNavItems",ba),C("mountRelabelNav",ha),C("mountHideTopmenuTabs",_a),C("mountContractsSection",ua),C("mountAnalyticsDashboard",Js),C("mountClaimReleaseToggle",yi),C("mountContactActionsBar",Li),C("mountActiveFollowUpButton",js),C("mountMtOfferMadeButton",Ri),C("mountNotInterestedButton",Hi),C("mountScheduleWalkthroughButton",Di),C("mountResendDealLinkButton",zi),C("mountReducePriceButton",qi),C("mountEditLandingPageButton",Ui),C("mountPublishButton",Ki),C("mountContactMapLinks",el),C("mountSendToClosingOfficeButton",_l),C("mountOppActionBar",Ml),C("mountClosingAgentPickerButton",Md),C("mountPrepareContractButton",Qd),C("mountComputeOfferButton",dc),C("mountManageTeam",Hd),C("mountBuyBoxWidget",oi),C("mountSellerContactFlag",hi),C("mountPropertiesWidget",mi),C("mountSupportNavItem",Nl),C("mountPhoneAssignmentsWidget",Kl),C("mountBulkPowerDialer",bd),C("mountBulkPowerDialerContacts",_d),C("mountCallingAsChip",fd),C("mountDialerThemeFix",jr),C("mountReplyFromWarning",Uc),C("mountNoteCanon",Kc),C("mountSuppressAutofill",Jc)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qc):Qc();})();
