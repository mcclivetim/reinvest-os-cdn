/* Wholesaling CRM Customizer v0.10.15 — built 2026-05-21T18:48:28.919Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var H="[wholesaling-crm-customizer]",Le="__WS_CRM_DEBUG",Ie=()=>!!window[Le],h={info(...o){console.log(H,...o)},warn(...o){console.warn(H,...o)},error(...o){console.error(H,...o)},debug(...o){Ie()&&console.log(H,"[debug]",...o)}};var Q=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},N="",F="other",K=new Set,M=()=>{if(window.location.pathname!==N){N=window.location.pathname,F=Q(),h.debug("Page changed:",F,N);for(let o of K)try{o(F)}catch(t){h.error("Subscriber threw:",t)}}},ee=o=>(K.add(o),setTimeout(()=>o(F),0),()=>{K.delete(o)}),te=()=>{F=Q(),N=window.location.pathname,h.debug("Router init, current page:",F);let o=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(e,r,n){o(e,r,n),M()},history.replaceState=function(e,r,n){t(e,r,n),M()},window.addEventListener("popstate",M),setInterval(M,1e3)};var P="0.10.15",R="2026-05-21T18:48:28.919Z";var De=/\/contacts\/detail\/([A-Za-z0-9]+)/,He=/\/v2\/location\/([A-Za-z0-9]+)/,T=()=>{let o=window.location.pathname,t=o.match(De);if(!t)return null;let e=o.match(He);return{contactId:t[1],locationId:e?e[1]:null}};var C=(o,t={})=>{let{timeoutMs:e=8e3,pollMs:r=100,root:n=document}=t;return new Promise((s,i)=>{let a=n.querySelector(o);if(a){s(a);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let l=n.querySelector(o);l&&(p(),s(l))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let l=n.querySelector(o);l&&(p(),s(l))},r),d=window.setTimeout(()=>{p(),h.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${e}ms: ${o}`))},e)})};var c={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},k={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Y={purple:"#8B5CF6",green:c.emerald,orange:c.amber,red:c.crimson},oe=o=>{let t=o==="emerald"?c.emeraldGlow:o==="amber"?c.amberGlow:c.slate,e=o==="emerald"?c.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":c.steel,r=o==="emerald"?c.emerald:o==="amber"?c.amber:c.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,L=`
  ...
  flex-shrink: 0;
`;var I="ws-crm-claim-release-pill",ne=o=>{let t=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Me=({contactId:o,mode:t})=>{let e=document.createElement("button");e.id=I,e.type="button",e.dataset.contactId=o,e.dataset.mode=t;let r=t==="claim"?"emerald":"amber",n=t==="claim"?c.emerald:c.amber;return e.style.cssText=oe(r),e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{h.info(`Claim/Release pill clicked for contact ${o}: ${t}`);let s=e.lastElementChild,i=s?.textContent??"";s&&(s.textContent="Working\u2026"),e.style.opacity="0.7",e.disabled=!0,setTimeout(()=>{s&&(s.textContent=i),e.style.opacity="1",e.disabled=!1},700)}),e},Ne=async(o,t=1e4)=>{let e=Date.now();for(;Date.now()-e<t;){let r=ne(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},re=(o,t)=>{let e=Me({contactId:t,mode:"claim"}),r=document.createElement("span");r.id=`${I}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(e),o.appendChild(r)},Pe=async()=>{let o=T();if(!o){document.getElementById(I)?.remove();return}let t=document.getElementById(I);if(!(t&&t.dataset.contactId===o.contactId)){t&&t.remove();try{let e=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Ne(e),n=T();if(!n||n.contactId!==o.contactId)return;if(!r){h.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}re(r,o.contactId),h.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let s=null;s=new MutationObserver(async()=>{if(!(T()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(I))return;let a=ne(e);a&&(re(a,o.contactId),h.debug("Re-mounted Claim/Release pill after React wipe"))}),s.observe(e,{childList:!0,subtree:!0})}catch(e){h.warn("Could not mount Claim/Release pill:",e)}}},ae=()=>{Pe()};var Re="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var Oe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Be=()=>{let o=window.WS_CRM_USER_ID;if(o&&/^[A-Za-z0-9]{15,30}$/.test(o))return o;let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let r of e)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let n=JSON.parse(r),s=n.id??n._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}for(let n of["tokenUser","currentUser","ghl_user"]){let s=localStorage.getItem(n);if(s)try{let i=JSON.parse(s),a=i.id??i._id;if(a&&/^[A-Za-z0-9]{15,30}$/.test(a))return a}catch{}}}catch{}return null},Ge=async({contactId:o,locationId:t,status:e,userId:r,deadReason:n})=>{let s={call_status:e,triggered_by_user_id:r??""};n&&(s.dead_reason=n);let a=await fetch(Re,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:t},customData:s}),credentials:"omit"});if(!a.ok)throw new Error(`Webhook returned ${a.status} ${a.statusText}`)},Ve=async({contactId:o,tenantId:t})=>{let e=await fetch(Oe,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:o}),credentials:"omit"});if(!e.ok)throw new Error(`Sanity check returned ${e.status} ${e.statusText}`);return await e.json()};var O="ws-crm-contact-actions-bar",Ue="ws-crm-call-status-dropdown",se="ws-crm-offer-made-modal",$e=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ze=[".central-panel","[class*='central-panel']"],qe=async()=>{for(let o of ze)try{let t=await C(o,{timeoutMs:3e3});if(t)return t}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},We=o=>{let t=document.createElement("div");t.id=Ue,t.style.cssText="position: relative; flex-shrink: 0;";let e=document.createElement("button");e.type="button",e.style.cssText=L,e.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,$e.forEach(n=>{let s=document.createElement("button");s.type="button",s.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,s.innerHTML=`
      ...
      "></span>
      <span>${n.label}</span>
    `,s.addEventListener("mouseenter",()=>{s.style.background=c.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{h.info(`Call Status set to "${n.label}" (${n.value}, ${n.color}) for contact ${o}`);let i=e.firstElementChild,a=e.children[1],d=e.children[2];i&&(i.style.background=Y[n.color]),a&&(a.textContent=n.label),r.style.display="none";let p=T()?.locationId,m=Be();if(!p){h.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),a&&(a.textContent=`${n.label} (no tenant!)`),a&&(a.style.color=c.amber);return}if(n.color==="green"&&!m){h.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),a&&(a.textContent=`${n.label} (no user!)`),a&&(a.style.color=c.amber);return}let l=d?.textContent??"\u25BE",w=async u=>{d&&(d.textContent="\u2026"),e.style.opacity="0.75";try{await Ge({contactId:o,locationId:p,status:n.label,userId:m,deadReason:u}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=l),e.style.opacity="1"},900)}catch(_){h.warn("Call Status webhook failed:",_),d&&(d.textContent="\u2717"),a&&(a.style.color=c.amber),e.style.opacity="1",setTimeout(()=>{d&&(d.textContent=l),a&&(a.style.color=c.bone)},1800)}};if(n.value==="dead-deal"){let u=a?.textContent??"";Ke(_=>{w(_)},()=>{a&&(a.textContent=u)});return}if(n.value==="appointment-booked"){let u=a?.textContent??"";try{(await Ve({contactId:o,tenantId:p})).ok?await w():Ye(()=>{w()},()=>{a&&(a.textContent=u)})}catch(_){h.warn("Appointment sanity check failed; firing anyway:",_),await w()}return}await w()}),r.appendChild(s)}),e.addEventListener("click",n=>{n.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",n=>{t.contains(n.target)||(r.style.display="none")}),t.appendChild(e),t.appendChild(r),t},je=o=>{document.getElementById(se)?.remove();let t=document.createElement("div");t.id=se,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.appendChild(r),document.body.appendChild(e);let n=()=>e.remove(),s=()=>{n(),t()};e.addEventListener("click",a=>{a.target===e&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=a=>{a.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},de=o=>{let t=document.createElement("div");t.id=O,t.dataset.contactId=o,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
...
/* Trigger overlay — ALWAYS transparent. State colors (hover,
   ...
   and (being 38×32 absolute-positioned over a 24×24 cell)
...
/* Selected (user-clicked start / end of range) — emerald bg on
   the cell (24×24, fits behind the number). */
...
/* 18a-availability-page (v0.8.94). Calendars → Availability page
   ...
   1) .schedule-banner (the 'NEW · Simplify your availability...'
...
`,et=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],tt=o=>{if(!o||o[0]!=="#")return o;let t=o.slice(1);if(t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t.length!==6&&t.length!==8)return o;let e=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),n=parseInt(t.slice(4,6),16);if(isNaN(e)||isNaN(r)||isNaN(n))return o;if(t.length===8){let s=parseInt(t.slice(6,8),16)/255;return`rgba(${e}, ${r}, ${n}, ${s})`}return`rgb(${e}, ${r}, ${n})`},ot=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),V=()=>{for(let o of et){let t;try{t=document.querySelectorAll(o.selector)}catch{continue}t.forEach(e=>{for(let[r,n]of Object.entries(o.styles)){let s=e.style.getPropertyPriority(r),i=e.style.getPropertyValue(r),a=ot.has(r)?tt(n):n;s==="important"&&i===a||e.style.setProperty(r,n,"important")}})}},Z="#1A1F28",rt=26,nt=31,at=40,pe=new Set,me=new Set,U=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0||(t.textContent||"").trim()!=="--")return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;t.style.setProperty("display","none","important");let n=t.className?.toString()||"<no class>";!me.has(n)&&n!=="<no class>"&&(me.add(n),h.debug(`Hid empty "--" leaf: "${n}"`))})},st=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],it=["trash","Trash","TRASH","delete","Delete","DELETE"],lt=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.getAttribute("data-reos-trash")==="true")return;let e=t.querySelector("svg");if(!e)return;let r=!1,n=(e.getAttribute("class")||"")+" "+(e.getAttribute("data-icon")||"");if(it.some(s=>n.includes(s))&&(r=!0),r||e.querySelectorAll("path").forEach(i=>{if(r)return;let a=i.getAttribute("d")||"";st.some(d=>a.includes(d))&&(r=!0)}),!r){let s=(t.id||"").toLowerCase(),i=(t.getAttribute("aria-label")||"").toLowerCase(),a=(t.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||a.includes("delete")||a.includes("remove")||a.includes("trash"))&&(r=!0)}r&&t.setAttribute("data-reos-trash","true")})},dt=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),ct=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let e=(t.textContent||"").trim();e.length===0||e.length>40||dt.has(e)&&t.style.display!=="none"&&(t.style.setProperty("display","none","important"),t.style.setProperty("visibility","hidden","important"),t.style.setProperty("opacity","0","important"),t.style.setProperty("pointer-events","none","important"))})},ve=new Set,bt=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();if(e.includes("ai-button")||e.includes("ask-ai")||e.includes("bg-clip-text")||e.includes("text-transparent")||t.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=t.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(t.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let s=Array.from(t.children);if(s.length>0&&s.every(m=>{let l=m.tagName.toLowerCase();return l==="svg"||l==="img"})&&!n)return;let d=window.getComputedStyle(t).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let p=t.className?.toString()||"<no class>";!ve.has(p)&&p!=="<no class>"&&(ve.add(p),h.debug(`Remapped pure-white text -> bone: "${p}"`))})},_e=new Set,ht=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(t=>{t.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=(r.className?.toString()||"").toLowerCase();if(n.includes("avatar"))return;let s=window.getComputedStyle(r),i=s.backgroundColor,a=s.backgroundImage||"",d=!1;if(a!=="none"&&a.includes("gradient"))d=!0;else if(i&&i!=="rgba(0, 0, 0, 0)"&&i!=="transparent"){let y=i.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(y&&parseFloat(y[1])<.6)return;let g=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let E=parseInt(g[1],10),S=parseInt(g[2],10),j=parseInt(g[3],10);(E>=60||S>=60||j>=60)&&(E>230&&S>230&&j>230||(E>=80||S>=80||j>=80)&&(d=!0))}}if(!d)return;let p=(r.textContent||"").trim(),m=n,l=Array.from(r.querySelectorAll("*")).map(y=>(y.className?.toString()||"").toLowerCase()).join(" "),w=p.toLowerCase()==="ask ai"||m.includes("ai-button")||m.includes("ask-ai")||m.includes("askai"),u=m.includes("bg-clip-text")||m.includes("text-transparent")||l.includes("bg-clip-text")||l.includes("text-transparent"),_=Array.from(r.querySelectorAll("*")).some(y=>{let g=window.getComputedStyle(y),E=g.getPropertyValue("-webkit-background-clip")||"",S=g.getPropertyValue("background-clip")||"";return E.includes("text")||S.includes("text")});if(w||u||_){let y=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=E=>{y.forEach(S=>E.style.removeProperty(S))};g(r),r.querySelectorAll("*").forEach(g);return}let v="#12161D";r.style.setProperty("color",v,"important"),r.querySelectorAll("*").forEach(y=>{let g=y.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(y.style.setProperty("fill",v,"important"),y.style.setProperty("stroke",v,"important"),y.style.setProperty("color",v,"important")):(y.style.setProperty("color",v,"important"),y.style.setProperty("-webkit-text-fill-color",v,"important"))});let x=r.className?.toString()||"<no class>";!_e.has(x)&&x!=="<no class>"&&(_e.add(x),h.debug(`Darkened SVG icons on colored button: "${x}"`))})})},ue=new Set,pt=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0||e.width<20||e.width>64||e.height<20||e.height>64)return;let r=e.top+e.height/2;(t.parentElement||t).querySelectorAll("svg, img").forEach(a=>{let d=a;if(d.closest("[id^='ws-crm-']"))return;let b=a.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let p=b.left<e.right&&b.right>e.left,m=b.top<e.bottom&&b.bottom>e.top;if(!(p&&m)||b.top+b.height/2<r)return;let w=b.width*b.height/(e.width*e.height);if(w>.55)return;let u=d,_=d.parentElement,v=0;for(;_&&_!==t&&v<3;){let y=_.getBoundingClientRect();if(y.width>0&&y.width<=30&&y.height<=30)u=_;else break;_=_.parentElement,v++}u.style.setProperty("transform","translateY(11px)","important");let x=(u.className?.toString()||"")+" "+u.tagName;ue.has(x)||(ue.add(x),h.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${w.toFixed(2)}): "${x}"`))})})},mt="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",vt=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();e.includes("active")||e.includes("router-link-active")?(t.style.setProperty("color","#0FB57E","important"),t.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),t.style.setProperty("opacity","1","important"),t.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),t.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",mt,"important")}),t.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((t.style.color==="rgb(18, 22, 29)"||t.style.color==="#12161D"||t.style.color==="#0FB57E"||t.style.color==="rgb(15, 181, 126)")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color")),t.querySelectorAll("span, p, div").forEach(n=>{let s=n.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),t.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},ye=new Set,_t=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;t.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let a=parseInt(i[1],10),d=parseInt(i[2],10),b=parseInt(i[3],10);if(!(a>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!ye.has(p)&&p!=="<no class>"&&(ye.add(p),h.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${a},${d},${b})): "${p}"`))})})},ge=new Set,ut=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.parentElement,r=0;for(;e&&r<3&&!e.closest("[id^='ws-crm-']");){let n=(e.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=e.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){e.style.setProperty("background-color","#12161D","important"),e.style.setProperty("background-image","none","important");let a=e.className?.toString()||"<no class>";!ge.has(a)&&a!=="<no class>"&&(ge.add(a),h.debug(`Painted Ask AI wrapper graphite: "${a}"`))}}e=e.parentElement,r++}})},fe=new Set,yt=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),t=document.querySelectorAll("div, section, aside"),e=[];t.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(n);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let a=n.getBoundingClientRect();a.width<240||a.height<120||a.width>1500||a.height>900||e.push(n)}),[...o,...e].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let a=(i.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator"))return;if(a.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let v=i.getAttribute("style")||"";(v.includes("background-color")||v.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("tabulator")||a.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(a.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let v=i.getAttribute("style")||"";(v.includes("background-color")||v.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("ai-button")||a.includes("ask-ai")||a.includes("bg-clip-text")||a.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let p=parseInt(b[1],10),m=parseInt(b[2],10),l=parseInt(b[3],10);if(!(p>200&&m>200&&l>200))return;let u=i.getBoundingClientRect();if(u.width<24||u.height<16||u.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let _=i.className?.toString()||"<no class>";!fe.has(_)&&_!=="<no class>"&&(fe.add(_),h.debug(`Coerced light bg (${u.width.toFixed(0)}x${u.height.toFixed(0)}, rgb(${p},${m},${l})): "${_}"`))})})},we=new Set,gt=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0)return;let r=(e.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||e.closest(o)||e.closest("[class*='avatar'], [class*='hr-avatar']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(e.matches("[role='heading']")||e.closest("[role='heading']")||e.matches("h1, h2, h3")||e.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){e.matches("h1, h2, h3")&&(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let v=e.getAttribute("style")||"";(v.includes("color")||v.includes("background"))&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("background-color"));return}if(e.closest("#SettingTexasSmsBlock")||e.matches("p.ui-text-sm-medium")&&e.parentElement?.classList?.contains("flex")&&e.parentElement?.classList?.contains("items-center")&&e.parentElement?.children?.length===1){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".hr-button, .n-button")||e.matches(".hr-button__content, .n-button__content")||e.closest(".hr-button__content, .n-button__content")){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".bg-primary-50, [class*='bg-primary-50']")){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}let n=e,s=null;for(let v=0;v<4&&n;v++){let x=n.nextElementSibling;if(x&&(x.matches(o)||x.querySelector(o)!==null)){s=x;break}n=n.parentElement}if(!s)return;let i=e.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;e.style.setProperty("color","#9098A3","important"),e.style.setProperty("-webkit-text-fill-color","#9098A3","important");let a=s,d=a.getBoundingClientRect(),b=a.className?.toString()||"",p=b.includes("schedule-ui-form-weekly-schedule-checkbox")||a.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||a.closest(".hl-form-item")!==null,l=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",w=(b.includes("hr-form-item-blank")||b.includes("hr-form-item")||a.matches(l))&&(a.matches(l)||a.querySelector(l)!==null);w&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius"));let u=b.includes("hr-radio")||a.closest(".hr-radio, [class*='hr-radio']")!==null;u&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius")),!p&&!m&&!w&&!u&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(a.style.setProperty("background-color",Z,"important"),a.style.setProperty("border-color","#252C36","important"),a.style.setProperty("border-style","solid","important"),a.style.setProperty("border-width","1px","important"),a.style.setProperty("border-radius","4px","important"));let _=e.className?.toString()||"<no class>";!we.has(_)&&_!=="<no class>"&&(we.add(_),h.debug(`Colored field label "${r.slice(0,30)}": "${_}"`))})},xe=new Set,ft=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();if(e.includes("dropdown")||e.includes("option-avatar"))return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||t.querySelector("svg, img")!==null)return;let s=(t.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),a=Math.max(16,Math.min(24,Math.round(i*.6)));t.style.setProperty("font-size",`${a}px`,"important"),t.style.setProperty("line-height","1","important"),t.style.setProperty("display","flex","important"),t.style.setProperty("align-items","center","important"),t.style.setProperty("justify-content","center","important"),t.style.setProperty("text-align","center","important"),t.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${a}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=t.className?.toString()||"<no class>";!xe.has(d)&&d!=="<no class>"&&(xe.add(d),h.debug(`Resized avatar text to ${a}px (circle ${i.toFixed(0)}px): "${d}"`))})},ke=new Set,wt=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;t.style.setProperty("background-color",Z,"important"),t.style.setProperty("border-color","#252C36","important"),t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=t.className?.toString()||"<no class>";!ke.has(r)&&r!=="<no class>"&&(ke.add(r),h.debug(`Forced input slate bg: "${r}"`))})},$=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.id==="chat-filter"||t.id==="phone-calls"||t.id==="archive-conversation"||t.id==="star-toggle"||t.id==="read-toggle"||t.id==="delete-conversation")return;if(t.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}let e=t.className?.toString()||"";if(e.includes("bg-inherit")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(t.closest(".pipeline-ribbon")&&e.split(" ").includes("count")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.split(" ").includes("tabulator-page")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(l=>e.includes(l))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("schedule-ui-form-weekly-schedule-checkbox")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("border-color")||l.includes("border-style")||l.includes("border-width"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"));return}if(e.includes("n-button")&&e.includes("icon-only")&&!e.includes("quaternary")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-button--tertiary-type")||e.includes("n-button--tertiary-type")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"),t.style.removeProperty("border-radius"));return}if(e.includes("hr-data-table-td")||e.includes("hr-data-table-tr")||e.includes("hr-data-table__body-cell")||e.includes("hr-data-table__cell")||e.includes("hr-data-table__header-cell")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("n-data-table-td--fixed-right")||e.includes("n-data-table-td--last-col")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(t.classList.contains("hr-tabs")||e.includes("hr-tabs-tab-wrapper")||e.includes("hr-tabs-nav")||e.includes("hr-tabs-nav-scroll-content")||e.includes("hr-tabs-content")||e.includes("hr-tabs-pane")||e.includes("hr-tabs-rail")||e.includes("hr-tabs-wrapper")||e.includes("hr-tabs-pane-wrapper")||e.includes("hr-tab-pane")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-date-panel")||e.includes("n-date-panel")||t.closest(".hr-date-panel, .n-date-panel")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-tag")&&e.includes("ui-default")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if((e.includes("bg-purple-50")||e.includes("bg-purple-100"))&&(e.includes("rounded-lg")||e.includes("rounded-md")||e.includes("rounded-full"))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("n-alert")||t.closest(".n-alert")||e.includes("hl-warning")||e.includes("hl-error")||e.includes("hl-info")||e.includes("hl-success")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-card")||t.closest(".hr-card")||t.id&&t.id.startsWith("opportunity-")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("bg-gray-50")||e.includes("bg-gray-100")||e.includes("bg-gray-200")||e.includes("bg-white")||e.includes("bg-blue-50")||e.includes("bg-blue-100")||e.includes("bg-sky-50")||e.includes("bg-indigo-50")||e.includes("bg-slate-50")||e.includes("bg-neutral-50")||e.includes("bg-zinc-50")||e.includes("bg-stone-50")||e.includes("F7F9FD")||e.includes("F9FAFB")||e.includes("ECEEF2")||e.includes("eceef2")||e.includes("EFF4FF")||e.includes("eff4ff")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-collapse-item")||e.includes("hr-collapse hr-accordion")||e.includes("hr-accordion"))return;if(e.includes("sidebar-option-button")||t.closest(".sidebar-option-button")||t.closest("nav[class*='w-13']")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(t.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let l=t.getAttribute("style")||"";(l.includes("background-color")||l.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}let n=window.getComputedStyle(t).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let s=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let i=parseInt(s[1],10),a=parseInt(s[2],10),d=parseInt(s[3],10);if(!(i<rt&&a<nt&&d<at))return;let p=t.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;t.style.setProperty("background-color",Z,"important");let m=t.className?.toString()||"<no class>";!pe.has(m)&&m!=="<no class>"&&(pe.add(m),h.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${i},${a},${d})): "${m}"`))})},z=()=>{let o="#4B8BF5",t=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],e="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored]), .toolbar_button img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2]), #editor-toolbar img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1");let a=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!a)return;let d;try{d=atob(a[1])}catch{return}let b=d,p=!1;if(t.forEach(l=>{b.includes(l)&&(b=b.split(l).join(o),p=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(w=>{b.includes(w)&&(b=b.split(w).join("#EDEEF0"),p=!0)}),!!p)try{let l=btoa(b);s.setAttribute("src",`data:image/svg+xml;base64,${l}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let a=`url("${i}")`;s.style.setProperty("-webkit-mask-image",a,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",a,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",e)})},q=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(t=>{[...t.classList].forEach(e=>{if(e.startsWith("n-date-panel")){let r="hr-date-panel"+e.slice(12);t.classList.contains(r)||t.classList.add(r)}})})},Ee=()=>{let o,t=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,q(),V(),wt(),$(),U(),gt(),yt(),ut(),_t(),vt(),ht(),ft(),pt(),bt(),z(),ct(),lt()},100))};q(),V(),$(),U(),z(),window.setTimeout(()=>{q(),V(),$(),U(),z()},500),window.setTimeout(()=>{q(),V(),$(),U(),z()},1500),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},J,xt=()=>{let o=()=>{let e=document.getElementById(W);!e||!document.head||document.head.lastElementChild===e||document.head.appendChild(e)};new MutationObserver(e=>{let r=!1;for(let n of e){for(let s of Array.from(n.addedNodes)){if(!(s instanceof Element))continue;let i=s.tagName.toLowerCase();if(i==="style"||i==="link"){if(s.id===W||s.id===Te)continue;r=!0;break}}if(r)break}r&&J===void 0&&(J=window.setTimeout(()=>{J=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Se=()=>{if(Ze(),!document.getElementById(W)){let o=document.createElement("style");o.id=W,o.textContent=Qe,document.head.appendChild(o),h.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Ee():window.addEventListener("DOMContentLoaded",Ee)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,xt())};var Fe="ws-crm-customizer-version-badge",Ce=()=>{if(document.getElementById(Fe))return;let o=document.createElement("div");o.id=Fe,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${P}`,o.title=`Built ${R}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Ae=()=>{h.info(`Loaded v${P} (built ${R})`),he(),Se(),te(),ee(o=>{h.debug("Page handler firing for:",o),Ce(),ae(),ce()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ae):Ae();})();
