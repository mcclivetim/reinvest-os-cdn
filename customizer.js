/* Wholesaling CRM Customizer v0.41.11 — built 2026-06-17T13:44:27.760Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var lo="[wholesaling-crm-customizer]",wd="__WS_CRM_DEBUG",kd=()=>!!window[wd],c={info(...e){console.log(lo,...e)},warn(...e){console.warn(lo,...e)},error(...e){console.error(lo,...e)},debug(...e){kd()&&console.log(lo,"[debug]",...e)}};var Ed=/\/v2\/location\/([A-Za-z0-9]+)/,Td=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let e=window.location.pathname.match(Ed);return e?e[1]:null},kr=()=>{let e=re();return e!==null&&Td.has(e)};var za=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Er=/\/v2\/location\/([A-Za-z0-9]+)/,Sd=e=>{let t=e.match(za);if(!t)return null;let o=e.match(Er);return{contactId:t[1],locationId:o?o[1]:null,source:"url"}},Cd=()=>{let e=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let t of e){let o=document.querySelector(t);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(za);if(!a)continue;let i=r.match(Er)||window.location.pathname.match(Er);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},D=()=>{let e=Sd(window.location.pathname);return e||Cd()};var qa=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},po="",Tr=null,Fe="other",Sr=new Set,co=()=>{let e=D()?.contactId??null;if(!(!(window.location.pathname!==po)&&!(e!==Tr))){po=window.location.pathname,Tr=e,Fe=qa(),c.debug("Page/context changed:",Fe,po,"contact:",e);for(let r of Sr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},ae=e=>(Sr.add(e),setTimeout(()=>e(Fe),0),()=>{Sr.delete(e)}),Ga=()=>{Fe=qa(),po=window.location.pathname,Tr=D()?.contactId??null,c.debug("Router init, current page:",Fe);let e=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(o,r,a){e(o,r,a),co()},history.replaceState=function(o,r,a){t(o,r,a),co()},window.addEventListener("popstate",co),setInterval(co,1e3)},mo=()=>Fe;var bo="0.41.11",ho="2026-06-17T13:44:27.761Z";var $=(e,t={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=t;return new Promise((i,s)=>{let l=a.querySelector(e);if(l){i(l);return}let d,p,m=()=>{h&&h.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},h=new MutationObserver(()=>{let b=a.querySelector(e);b&&(m(),i(b))});h.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let b=a.querySelector(e);b&&(m(),i(b))},r),d=window.setTimeout(()=>{m(),c.warn(`waitForElement timed out for selector: ${e}`),s(new Error(`Selector not found within ${o}ms: ${e}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Cr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ua=e=>{let t=e==="emerald"?n.emeraldGlow:e==="amber"?n.amberGlow:n.slate,o=e==="emerald"?n.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=e==="emerald"?n.emerald:e==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var Ad=/^[A-Za-z0-9]{15,30}$/,ft=e=>typeof e=="string"&&Ad.test(e),Va=e=>{try{let t=e.split(".");if(t.length!==3)return null;let o=t[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},$d=()=>{let e=window.WS_CRM_USER_ID;return ft(e)?e:null},Ld=()=>{let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let o of t)if(ft(o))return o;return null},Id=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Va(t);if(!o)return null;let r=o.uid;if(ft(r))return r;let a=o.claims;if(a&&ft(a.user_id))return a.user_id}catch{}return null},Md=()=>{try{let e=["user","tokenUser","currentUser","ghl_user"];for(let t of e){let o=localStorage.getItem(t);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ft(a))return a}catch{}}}catch{}return null},M=()=>$d()||Id()||Ld()||Md()||null,Od=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Va(t);return o?o.claims??o:null}catch{return null}},Ze=()=>{let e=window.WS_CRM_FORCE_AGENCY;return typeof e=="boolean"?e:Od()?.type==="agency"};var Ya="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Hd=`${Ya}/active-follow-up-get`,Dd=`${Ya}/active-follow-up-set`,Ne="ws-crm-active-follow-up-button",$r={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Pd=()=>{let e=D();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},Bd=async e=>{let t=await fetch(Hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId}),credentials:"omit"});if(!t.ok)throw new Error(`Get webhook returned ${t.status} ${t.statusText}`);return await t.json()},Rd=async(e,t)=>{let o=await fetch(Dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,triggered_by_user_id:t??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ze=(e,t)=>{let o=$r[t];e.dataset.state=t,e.disabled=!o.clickable,e.style.cursor=o.clickable?"pointer":"default",e.style.background=o.bg,e.style.borderColor=o.border,e.style.color=o.color;let r=e.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=e.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Wa=e=>{let t=document.createElement("button");return t.type="button",t.id=Ne,t.dataset.contactId=e,t.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ze(t,"loading"),t.addEventListener("click",async()=>{if(t.dataset.state!=="amber")return;let r=Pd();if(!(!r||r.contactId!==e)){ze(t,"blue"),t.style.transform="scale(0.97)",setTimeout(()=>t.style.transform="",120);try{let a=await Rd(r,M()),i=a&&a.state&&a.state in $r?a.state:"blue";ze(t,i),c.info(`Active Follow Up set for ${e} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),ze(t,"error"),setTimeout(()=>void uo(t,r),4e3)}}}),t},uo=async(e,t)=>{ze(e,"loading");try{let o=await Bd(t),r=o&&o.state&&o.state in $r?o.state:"gray",a=document.getElementById(Ne);if(!a||a.dataset.contactId!==t.contactId)return;ze(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),ze(e,"error")}},Fd=[".central-panel","[class*='central-panel']"],Ar="ws-crm-contact-actions-bar",Nd=async()=>{for(let e of Fd)try{let t=await $(e,{timeoutMs:3e3});if(t)return t}catch{}try{return(await $("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},zd=async(e,t)=>{let o=t.querySelector(`#${Ar}`);if(!o)try{o=await $(`#${Ar}`,{timeoutMs:3e3,root:t})}catch{o=null}if(o){let i=t.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),e.style.order="2",o.appendChild(e),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=t.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=t.querySelector(`#${Ar}`);i&&i.parentElement===t?t.insertBefore(a,i.nextSibling):t.insertBefore(a,t.firstChild)}return a.appendChild(e),{container:a,placement:"fallback"}},qd=()=>{let e=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!e)return null;let t=e;for(let o=0;o<8&&!(!t||!t.parentElement);o++){let r=t.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}t=r}return null},Gd=(e,t)=>{e.style.marginRight="4px",t.insertBefore(e,t.firstChild)},Ud=async e=>{if(e==="url"){let o=await Nd();return o?{kind:"contact-detail",target:o}:null}let t=qd();return t?{kind:"conversations",target:t}:null},ja=async(e,t)=>{if(t.kind==="contact-detail"){let{placement:o}=await zd(e,t.target);return o}return Gd(e,t.target),"conversations-header"},Vd=async()=>{let e=D();if(!e||!e.locationId){document.getElementById(Ne)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let t={contactId:e.contactId,tenantId:e.locationId},o=document.getElementById(Ne);if(o&&o.dataset.contactId===t.contactId){uo(o,t);return}o&&o.remove();let r=await Ud(e.source);if(!r){c.warn(`Active Follow Up: no mount target on ${e.source}-source page`);return}let a=D();if(!a||a.contactId!==t.contactId)return;let i=Wa(t.contactId),s=await ja(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${t.contactId}`),Ka();let l=document.getElementById(Ne)??i;uo(l,t);let d=new MutationObserver(()=>{let p=document.getElementById(Ne);if(!(D()?.contactId===t.contactId)){d.disconnect();return}if(!p){let h=Wa(t.contactId);ja(h,r).then(()=>{Ka(),uo(h,t)}),c.debug(`Active Follow Up re-mounted after wipe for ${t.contactId}`)}});d.observe(r.target,{childList:!0})},xt=null,Ja=()=>{let e=D()?.contactId??null;if(xt&&xt.contactId===e)return;let t=Vd().finally(()=>{xt?.promise===t&&(xt=null)});xt={contactId:e,promise:t}},Ka=()=>{let e=document.querySelectorAll(`#${Ne}`);if(!(e.length<=1)){c.debug(`Active Follow Up: found ${e.length} duplicate buttons, keeping first, removing ${e.length-1}`);for(let t=1;t<e.length;t++)e[t].remove()}};var Wd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",wt=new Map,Se=async(e,t)=>{if(!e)return null;if(wt.has(e))return wt.get(e)??null;if(!t)return c.warn(`Cannot fetch Contact Type for ${e} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${Wd}?contact_id=${encodeURIComponent(e)}&tenant_id=${encodeURIComponent(t)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${e}`),wt.set(e,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return wt.set(e,l),c.debug(`Resolved Contact Type for ${e}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${e}:`,a),wt.set(e,null),null}};var Ce=e=>e==="buyer"?"buyer":e==="seller"?"seller":e==="agent"||e==="closing_agent"||e==="closing_office"||e==="vendor"||e==="tenant"?"other":"seller";var Za="ws-buybox-nav-icon",Mr="ws-buybox-panel",Xa="ws-buybox-modal",jd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Or="https://mcclivetim.github.io/reinvest-os-cdn/geo",vo=null,kt=null,Et=null,Ir=async()=>{if(vo)return vo;try{let e=await fetch(`${Or}/states.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);return vo=await e.json(),vo}catch(e){return c.error("[buy-box] failed to fetch states.json",e),[]}},Kd=async e=>{if(!kt)try{let t=await fetch(`${Or}/counties.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);kt=await t.json()}catch(t){return c.error("[buy-box] failed to fetch counties.json",t),[]}return kt?.[e]??[]},Yd=async e=>{if(!Et)try{let t=await fetch(`${Or}/cities.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);Et=await t.json()}catch(t){return c.error("[buy-box] failed to fetch cities.json",t),[]}return Et?.[e]??[]},Hr=async e=>await(await fetch(jd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json(),Jd=(e,t)=>Hr({tenant_id:e,action:"list",buyer_contact_id:t}),Xd=(e,t,o,r)=>Hr({tenant_id:e,action:"add",buyer_contact_id:t,geo_level:o,geo_value:r}),Qd=(e,t)=>Hr({tenant_id:e,action:"remove",entry_id:t}),q=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Zd=(e,t)=>{let o=t.find(r=>r.code===e);return o?`${o.name} (${e})`:e},ec='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',tc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',oc="nav.w-13, nav[class*='w-13']",rc=".flex-1.h-full.relative.overflow-hidden.rounded-lg",nc=async()=>{try{return await $(oc,{timeoutMs:2500})}catch{return null}},ac=async()=>{try{return await $(rc,{timeoutMs:2500})}catch{return null}},ic=e=>e.querySelector("div[class*='bg-contacts-panel']")??null,sc=(e,t)=>{let o=document.createElement("div");return o.id=Mr,o.dataset.buyerContactId=t,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{pc(e,t,()=>Dr(e,t))}),o},Dr=async(e,t)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Jd(e,t),Ir()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}lc(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,e,t)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},lc=(e,t,o,r,a)=>{if(t.state.length+t.county.length+t.city.length+t.zip.length===0){e.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>t[d.key].length>0).map(d=>{let p=t[d.key].map(m=>{let h=d.key==="state"?Zd(m.geo_value,o):m.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${q(h)}</span>
              <button type="button" data-entry-id="${q(m.id)}" data-entry-label="${q(h)}" class="ws-buybox-remove" aria-label="Remove ${q(h)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${tc}</button>
            </div>
          `}).join("");return`
        <div style="margin-bottom: 18px;">
          <div style="font-family: ${u.mono}; font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase; color: ${n.ash}; margin-bottom: 6px;">${q(d.label)} (${t[d.key].length})</div>
          ${p}
        </div>
      `}).join("");e.innerHTML=l,e.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",m=d.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(d.disabled=!0,Qd(r,p).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),d.disabled=!1;return}Dr(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),d.disabled=!1}))})})},_o=!1,ei=(e,t)=>{_o=t;let o=ic(e.panelArea);console.log(`[buy-box] setActive(${t}) \u2014 nativePanel=${!!o} panel=${!!e.panel} iconBtn=${!!e.iconBtn}`),t?(e.iconBtn.className=dc,e.iconBtn.dataset.active="true",o&&(e.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),e.panel.style.display="flex",Dr(e.tenantId,e.buyerContactId)):(e.iconBtn.className=ti,delete e.iconBtn.dataset.active,e.panel.style.display="none",o&&(o.style.display=e.nativePanelOriginalDisplay||""))},ti="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",dc="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",cc=e=>{let t=document.createElement("button");return t.id=Za,t.type="button",t.title="Buy-Box",t.setAttribute("aria-label","Buy-Box"),t.className=ti,t.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${ec.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,t.addEventListener("click",o=>{o.stopPropagation();let r=e();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!_o;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ei(r,a)}),t},pc=(e,t,o)=>{let r=document.getElementById(Xa);r&&r.remove();let a=document.createElement("div");a.id=Xa,a.style.cssText=`
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",f=>{f.target===a&&a.remove()});let s={step:1,granularity:null,stateCode:null,value:null},l=async()=>{if(s.step===1)i.innerHTML=d(),p();else if(s.step===2){i.innerHTML=m();let f=await Ir();i.innerHTML=h(f),b(f)}else if(s.step===3)if(s.granularity==="zip")i.innerHTML=w(),C();else if(s.granularity==="state"){let f=await Ir();i.innerHTML=y(f),k(f)}else s.granularity==="county"?(i.innerHTML=_(s.stateCode||""),await Kd(s.stateCode||""),i.innerHTML=x("County"),g()):s.granularity==="city"&&(i.innerHTML=_(s.stateCode||""),await Yd(s.stateCode||""),i.innerHTML=x("City"),g())},d=()=>`
  ...
  `,h=f=>`
    ...
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 14px;">Which state is this ${q(s.granularity||"")} in?</div>
    ...
    <div id="ws-buybox-state-list" style="max-height: 280px; overflow-y: auto; border: 1px solid ${n.steel}; border-radius: ${v.sm};">
      ${f.map(T=>`
        <div data-state-code="${q(T.code)}" class="ws-buybox-state-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${q(T.name)} <span style="color: ${n.ash}; font-family: ${u.mono}; font-size: 11px;">(${q(T.code)})</span>
        </div>
      `).join("")}
    </div>
  ...
  `,b=f=>{let T=i.querySelector("#ws-buybox-state-search"),I=i.querySelectorAll(".ws-buybox-state-row");I.forEach(B=>{B.addEventListener("mouseenter",()=>{B.style.background=n.emeraldGlow}),B.addEventListener("mouseleave",()=>{B.style.background="transparent"}),B.addEventListener("click",()=>{s.stateCode=B.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let B=(T.value||"").toLowerCase().trim();f.forEach((G,z)=>{let N=I[z];if(!N)return;let R=!B||G.name.toLowerCase().includes(B)||G.code.toLowerCase()===B;N.style.display=R?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=f=>`
    ...
    <div style="color: ${n.ash}; padding: 20px 0; text-align: center;">Loading list for ${q(f)}\u2026</div>
  `,y=f=>{let T=f.find(I=>I.code===s.stateCode);return`
      ...
      <div style="background: ${n.emeraldGlow}; border: 1px solid ${n.emeraldBorder}; border-radius: ${v.md}; padding: 16px; margin-bottom: 20px;">
        <div style="font-size: 22px; font-weight: 500;">${q(T?T.name:s.stateCode||"")}</div>
        <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">This buyer will match every property in ${T?q(T.name):""} regardless of county / city / zip.</div>
      </div>
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; gap: 8px;">
          <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; padding: 8px 18px; cursor: pointer; font-family: ${u.sans}; font-size: 13px;">Close</button>
          <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${v.sm}; padding: 8px 22px; cursor: pointer; font-family: ${u.sans}; font-size: 13px; font-weight: 600;">Add ${T?q(T.name):"State"}</button>
        </div>
      </div>
    `},k=f=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},x=f=>{let T=s.granularity==="county"?kt?.[s.stateCode||""]??[]:Et?.[s.stateCode||""]??[];return`
      <div style="font-family: ${u.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${q(f)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${T.length.toLocaleString()} ${q(f).toLowerCase()}s in ${q(s.stateCode||"")}.</div>
    ...
    `},g=()=>{let f=s.granularity==="county"?kt?.[s.stateCode||""]??[]:Et?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),I=i.querySelector("#ws-buybox-value-list");if(!T||!I)return;let B=G=>{let z=G.toLowerCase().trim();if(!z){I.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=f.filter(R=>R.toLowerCase().includes(z)).slice(0,50);if(N.length===0){I.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${q(s.stateCode||"")}.</div>`;return}I.innerHTML=N.map(R=>`
        <div data-value="${q(R)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${q(R)}
        </div>
      `).join(""),I.querySelectorAll(".ws-buybox-value-row").forEach(R=>{R.addEventListener("mouseenter",()=>{R.style.background=n.emeraldGlow}),R.addEventListener("mouseleave",()=>{R.style.background="transparent"}),R.addEventListener("click",()=>{s.value=R.dataset.value||"",E(s.value)})})};T.addEventListener("input",()=>B(T.value)),B(""),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T.focus(),0)},w=()=>`
  ...
  `,C=()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");f&&(f.addEventListener("input",()=>{f.value=f.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),f.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),S())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void S()),setTimeout(()=>f.focus(),0))},S=async()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(f?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(I)},E=async f=>{if(!s.granularity||!f)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let B=await Xd(e,t,s.granularity,f);if(!B.ok){T&&(T.textContent=B.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
        <div style="text-align: center; padding: 40px 0;">
          <div style="font-size: 32px;">\u2713</div>
          <div style="font-size: 16px; margin-top: 8px;">Added <strong>${q(f)}</strong> to the buy-box.</div>
          <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${B.deduplicated?"(Already existed; not duplicated.)":""}</div>
        </div>
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(B){T&&(T.textContent=`Network error: ${B.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Lr=!1,et=null,Tt=null,Qa=()=>{document.getElementById(Za)?.remove(),document.getElementById(Mr)?.remove(),Tt&&et&&et.nav.removeEventListener("click",Tt,!0),Tt=null,et=null,_o=!1},oi=()=>{mc()},mc=async()=>{if(!Lr){Lr=!0;try{let e=D();if(!e){Qa();return}let t=document.getElementById(Mr);if(t&&t.dataset.buyerContactId===e.contactId&&et)return;Qa();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(h){c.warn("[buy-box] Contact Type fetch failed",h);return}if(Ce(o)!=="buyer")return;if(!e.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([nc(),ac()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=D();if(!s||s.contactId!==e.contactId)return;let l=sc(e.locationId,e.contactId),d=cc(()=>et),p={buyerContactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};et=p;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(d):a.appendChild(d),i.appendChild(l),Tt=h=>{let b=h.target;if(!b||p.iconBtn.contains(b))return;b.closest("button.sidebar-option-button")&&_o&&ei(p,!1)},a.addEventListener("click",Tt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${e.contactId}`)}finally{Lr=!1}}};var ai="ws-properties-nav-icon",Rr="ws-properties-panel",ri="ws-properties-modal",Fr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",bc=`${Fr}/list-for-contact`,hc=`${Fr}/create-with-opp`,uc=`${Fr}/add-contact`,vc=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],le=e=>(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),_c=(e,t)=>`/v2/location/${e}/objects/property/list?recordId=${t}`,ii=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},gc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',yc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',fc="nav.w-13, nav[class*='w-13']",xc=".flex-1.h-full.relative.overflow-hidden.rounded-lg",si="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",wc="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",kc=async()=>{try{return await $(fc,{timeoutMs:2500})}catch{return null}},Ec=async()=>{try{return await $(xc,{timeoutMs:2500})}catch{return null}},Nr=async(e,t)=>await(await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"})).json(),ue=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:13px;outline:none;margin-bottom:10px;`,ve=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,zr=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${u.sans};font-size:13px;font-weight:600;`,li=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${u.sans};font-size:13px;`,Tc=(e,t)=>{let o=document.createElement("div");return o.id=Rr,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${zr}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Cc(e,t,()=>qr(e,t))}),o},qr=async(e,t)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Nr(bc,{tenant_id:e,contact_id:t});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${le(r.error||"Failed to load properties")}</div>`;return}Sc(o,r.properties||[],e,t)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${le(r.message)}</div>`}},Sc=(e,t,o,r)=>{if(!t.length){e.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}e.innerHTML=t.map(a=>{let i=a.has_acq_opp?`<span style="font-size:10px;color:${n.emeraldBright};border:1px solid ${n.emeraldBorder};border-radius:${v.sm};padding:1px 6px;">Deal &#10003;</span>`:`<span style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 6px;">No deal</span>`,s=(a.roles||[]).map(l=>l==="seller_1"?"Seller 1":l==="seller_2"?"Seller 2":l==="tenant_contact"?"Tenant":l).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
          <div class="ws-prop-open" data-prop="${le(a.property_record_id)}" title="Open property record" style="font-size:13px;font-weight:500;color:${n.bone};cursor:pointer;display:inline-flex;align-items:center;gap:6px;">
            <span style="text-decoration:underline;text-decoration-color:${n.steel};text-underline-offset:3px;">${le(a.address)}</span>
            <span style="color:${n.emeraldBright};font-size:12px;line-height:1;">&#8599;</span>
          </div>
          ${i}
        </div>
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${le(s||"")}${a.property_type?" &middot; "+le(a.property_type):""}</div>
        <div style="margin-top:8px;">
          <button type="button" class="ws-prop-addperson" data-prop="${le(a.property_record_id)}" data-addr="${le(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${u.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${yc} Add person</button>
        </div>
      </div>
    `}).join(""),e.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{Ac(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>qr(o,r))})}),e.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let i=a.dataset.prop||"";i&&window.open(_c(o,i),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},di=()=>{document.getElementById(ri)?.remove();let e=document.createElement("div");e.id=ri,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`;let t=document.createElement("div");return t.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,e.appendChild(t),document.body.appendChild(e),e.addEventListener("click",o=>{o.target===e&&e.remove()}),{overlay:e,card:t}},Cc=(e,t,o)=>{let{overlay:r,card:a}=di();a.innerHTML=`
    ...
    <label style="${ve}">Street address</label>
    <input id="wp-address" type="text" style="${ue}" placeholder="123 Main St" />
    <div style="display:flex;gap:10px;">
      <div style="flex:2;"><label style="${ve}">City</label><input id="wp-city" type="text" style="${ue}" /></div>
      <div style="flex:1;"><label style="${ve}">State</label><input id="wp-state" type="text" maxlength="2" style="${ue}" placeholder="NC" /></div>
      <div style="flex:1;"><label style="${ve}">Zip</label><input id="wp-zip" type="text" maxlength="10" style="${ue}" /></div>
    </div>
    <label style="${ve}">Property type (optional)</label>
    <select id="wp-type" style="${ue}">
      <option value="">\u2014 select \u2014</option>
      ${vc.map(s=>`<option value="${le(s)}">${le(s)}</option>`).join("")}
    </select>
    <div id="wp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wp-cancel" type="button" style="${li}">Cancel</button>
      <button id="wp-save" type="button" style="${zr}">Create property + deal</button>
    </div>
  `;let i=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let s=_=>(a.querySelector(_)?.value||"").trim(),l=s("#wp-address"),d=s("#wp-city"),p=s("#wp-state"),m=s("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!l&&!d&&!m){i&&(i.textContent="Enter at least a street address.");return}let b=a.querySelector("#wp-save");b&&(b.disabled=!0,b.textContent="Creating\u2026"),i&&(i.textContent="");try{let _=await Nr(hc,{tenant_id:e,contact_id:t,address:l,city:d,state:p,zip:m,property_type:h||void 0});if(!_.ok){i&&(i.textContent=_.error||"Failed to create property."),b&&(b.disabled=!1,b.textContent="Create property + deal");return}r.remove(),ii("Property + deal created \u2713"),o()}catch(_){i&&(i.textContent=`Network error: ${_.message}`),b&&(b.disabled=!1,b.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},Ac=(e,t,o,r)=>{let{overlay:a,card:i}=di();i.innerHTML=`
    ...
    <label style="${ve}">Role</label>
    <select id="wpp-role" style="${ue}">
      <option value="seller_2">Second seller</option>
      <option value="tenant_contact">Tenant</option>
    </select>
    <div style="display:flex;gap:10px;">
      <div style="flex:1;"><label style="${ve}">First name</label><input id="wpp-first" type="text" style="${ue}" /></div>
      <div style="flex:1;"><label style="${ve}">Last name</label><input id="wpp-last" type="text" style="${ue}" /></div>
    </div>
    <label style="${ve}">Phone (optional)</label>
    <input id="wpp-phone" type="text" style="${ue}" placeholder="+1..." />
    <label style="${ve}">Email (optional)</label>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${li}">Cancel</button>
      <button id="wpp-save" type="button" style="${zr}">Add person</button>
    </div>
  `;let s=i.querySelector("#wpp-err");i.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#wpp-save")?.addEventListener("click",async()=>{let l=i.querySelector("#wpp-role")?.value||"seller_2",d=y=>(i.querySelector(y)?.value||"").trim(),p=d("#wpp-first"),m=d("#wpp-last"),h=d("#wpp-phone"),b=d("#wpp-email");if(!p&&!m){s&&(s.textContent="Enter at least a first or last name.");return}let _=i.querySelector("#wpp-save");_&&(_.disabled=!0,_.textContent="Adding\u2026"),s&&(s.textContent="");try{let y=await Nr(uc,{tenant_id:e,property_record_id:t,role:l,new_contact:{firstName:p,lastName:m,phone:h||void 0,email:b||void 0}});if(!y.ok){s&&(s.textContent=y.error||"Failed to add person."),_&&(_.disabled=!1,_.textContent="Add person");return}a.remove(),ii("Person added \u2713"),r()}catch(y){s&&(s.textContent=`Network error: ${y.message}`),_&&(_.disabled=!1,_.textContent="Add person")}}),setTimeout(()=>i.querySelector("#wpp-first")?.focus(),0)},go=!1,ne=null,Pr=!1,St=null,$c=(e,t,o)=>{let r=t.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let i=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),s=i&&a?Math.round(a.width):400,l=Math.round(i&&a?a.top:r.top),d=Math.round(i&&a?a.height:r.height),p=6;e.style.top=`${l}px`,e.style.height=`${d}px`,e.style.width=`${s}px`,e.style.left=`${Math.round(r.left-s-p)}px`,e.style.right="auto",e.style.bottom="auto"},Lc=()=>{try{let e=new URL(window.location.href);e.searchParams.get("view")!=="activities"&&(e.searchParams.set("view","activities"),history.replaceState(history.state,"",e.toString()))}catch{}},Br=(e,t)=>{go=t,t?(e.iconBtn.className=wc,e.iconBtn.dataset.active="true",Lc(),$c(e.panel,e.nav,e.panelArea),e.panel.style.display="flex",qr(e.tenantId,e.contactId)):(e.iconBtn.className=si,delete e.iconBtn.dataset.active,e.panel.style.display="none")},Ic=()=>{let e=document.createElement("button");return e.id=ai,e.type="button",e.title="Properties",e.setAttribute("aria-label","Properties"),e.className=si,e.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${gc.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,e.addEventListener("click",t=>{t.stopPropagation(),ne&&Br(ne,!go)}),e},ni=()=>{document.getElementById(ai)?.remove(),document.getElementById(Rr)?.remove(),St&&ne&&ne.nav.removeEventListener("click",St,!0),St=null,ne=null,go=!1},ci=()=>{Mc()},Mc=async()=>{if(!Pr){Pr=!0;try{let e=D();if(!e||!e.locationId){ni();return}let t=document.getElementById(Rr);if(t&&t.dataset.contactId===e.contactId&&ne)return;ni();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(m){c.warn("[properties] Contact Type fetch failed",m);return}if(Ce(o)==="buyer")return;let[a,i]=await Promise.all([kc(),Ec()]);if(!a||!i){c.warn("[properties] right-rail nav or panel area not found");return}let s=D();if(!s||s.contactId!==e.contactId)return;let l=Tc(e.locationId,e.contactId),d=Ic();ne={contactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:i,iconBtn:d,panel:l},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(d),document.body.appendChild(l),l.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ne&&Br(ne,!1)}),St=m=>{let h=m.target;!h||ne&&ne.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&go&&ne&&Br(ne,!1)},a.addEventListener("click",St,!0),c.info(`[properties] right-rail mount complete for seller ${e.contactId}`)}finally{Pr=!1}}};var Ae="ws-crm-claim-release-pill",Oc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Hc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Dc=async e=>{let t=await fetch(Oc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Get returned ${t.status} ${t.statusText}`);return await t.json()},Pc=async e=>{let t=await fetch(Hc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId,action:e.action}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Set returned ${t.status} ${t.statusText}`);return await t.json()},bi=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},tt=(e,t)=>{let o=t==="claim"?"emerald":"amber",r=t==="claim"?n.emerald:n.amber;e.dataset.mode=t,e.style.cssText=Ua(o),e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Bc=({contactId:e,mode:t})=>{let o=document.createElement("button");return o.id=Ae,o.type="button",o.dataset.contactId=e,tt(o,t),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==e)return;let i=M();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>tt(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${e} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";tt(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Pc({contactId:e,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;tt(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),tt(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},pi=async e=>{try{let t=await Dc({contactId:e.contactId,locationId:e.locationId,userId:M()}),o=document.getElementById(Ae);if(!o||o.dataset.contactId!==e.contactId)return;let r=t?.mode==="release"?"release":"claim";tt(o,r)}catch(t){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Rc=async(e,t=1e4)=>{let o=Date.now();for(;Date.now()-o<t;){let r=bi(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},mi=(e,t)=>{let o=Bc({contactId:t,mode:"claim"}),r=document.createElement("span");r.id=`${Ae}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),e.appendChild(r)},Fc=async()=>{let e=D();if(!e){document.getElementById(Ae)?.remove();return}let t=document.getElementById(Ae);if(!(t&&t.dataset.contactId===e.contactId)){t&&t.remove();try{let o=await $("#record-details-lhs",{timeoutMs:1e4}),r=await Rc(o),a=D();if(!a||a.contactId!==e.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}mi(r,e.contactId),c.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`),document.getElementById(Ae)&&e.locationId&&pi({contactId:e.contactId,locationId:e.locationId});let s=null;s=new MutationObserver(async()=>{if(!(D()?.contactId===e.contactId)){s?.disconnect();return}if(document.getElementById(Ae))return;let d=bi(o);d&&(mi(d,e.contactId),document.getElementById(Ae)&&e.locationId&&pi({contactId:e.contactId,locationId:e.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe"))}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},hi=()=>{Fc()};var xi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Nc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",zc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",qc=async({contactId:e,locationId:t,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||xi,d;if(s==="buyer"){let m=wi.find(b=>b.label===o),h=m?m.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:t,contact_id:e,new_status:h,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),d={contact_id:e,location:{id:t},customData:m}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Gc=async({contactId:e,tenantId:t})=>{let o=await fetch(zc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},ot="ws-crm-contact-actions-bar",Uc="ws-crm-call-status-dropdown",ui="ws-crm-offer-made-modal",Vc=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],wi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Wc=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],jc=async()=>{for(let e of Wc)try{let t=await $(e,{timeoutMs:2e3});if(t)return c.debug(`[actions-bar] mount target found via selector: ${e}`),t}catch{}try{let e=await $("#contact-conversation-panel",{timeoutMs:2e3});if(e.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),e.parentElement}catch{}for(let e of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let t=await $(e,{timeoutMs:1500});if(t)return c.debug(`[actions-bar] mount target via fallback: ${e}`),t.parentElement??t}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Kc=({contactId:e,kind:t})=>{let o=t==="buyer"?wi:Vc,r=t==="buyer"?Nc:xi,a=t==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Uc,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=O,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Cr[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${e}`);let m=s.firstElementChild,h=s.children[1],b=s.children[2];m&&(m.style.background=Cr[d.color]),h&&(h.textContent=d.label),l.style.display="none";let y=D()?.locationId,k=M();if(!y){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),h&&(h.textContent=`${d.label} (no tenant!)`),h&&(h.style.color=n.amber);return}if(t==="seller"&&d.color==="green"&&!k){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),h&&(h.textContent=`${d.label} (no user!)`),h&&(h.style.color=n.amber);return}let x=b?.textContent??"\u25BE",g=async w=>{b&&(b.textContent="\u2026"),s.style.opacity="0.75";try{await qc({contactId:e,locationId:y,status:d.label,userId:k,deadReason:w,webhookUrl:r,kind:t}),b&&(b.textContent="\u2713"),setTimeout(()=>{b&&(b.textContent=x),s.style.opacity="1"},900)}catch(C){c.warn("Call Status webhook failed:",C),b&&(b.textContent="\u2717"),h&&(h.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{b&&(b.textContent=x),h&&(h.style.color=n.bone)},1800)}};if(t==="seller"&&d.value==="dead-deal"){let w=h?.textContent??"";Qc(C=>{g(C)},()=>{h&&(h.textContent=w)});return}if(t==="seller"&&d.value==="appointment-booked"){let w=h?.textContent??"";try{(await Gc({contactId:e,tenantId:y})).ok?await g():Zc(()=>{g()},()=>{h&&(h.textContent=w)})}catch(C){c.warn("Appointment sanity check failed; firing anyway:",C),await g()}return}await g()}),l.appendChild(p)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},Yc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Jc=async e=>{let t=await fetch(Yc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,kind:e.kind,amount:e.amount,expires_at:e.expiresAt,triggered_by_user_id:e.userId}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},Xc=(e,t="seller")=>{document.getElementById(ui)?.remove();let o=t==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=ui,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let l=document.createElement("div");l.style.cssText=`
    ...
    color: ${n.bone};
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
  `;let d=new Date,p=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),m=o?`
    <label style="
      display: block;
      font-family: ${u.mono};
      font-size: 10px;
  ...
  `,s.appendChild(l),document.body.appendChild(s);let h=()=>s.remove();s.addEventListener("click",k=>{k.target===s&&h()});let b=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),y=l.querySelector("#ws-offer-submit");_?.addEventListener("click",h),y?.addEventListener("click",async()=>{let k=(l.querySelector("#ws-offer-amount")?.value??"").trim(),x=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!k||Number(k)<=0){b&&(b.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let g=Number(k);if(g<100){b&&(b.textContent=`That looks low \u2014 did you mean $${(g*1e3).toLocaleString("en-US")}?`);return}let C=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),S=C?C[1]:null;if(!S){b&&(b.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}b&&(b.textContent=""),y&&(y.disabled=!0,y.textContent="Recording\u2026",y.style.opacity="0.7"),_&&(_.disabled=!0);try{let E=await Jc({tenantId:S,contactId:e,kind:t,amount:g,expiresAt:x||null,userId:M()});if(!E.ok){b&&(b.textContent=E.error??"Something went wrong."),y&&(y.disabled=!1,y.textContent="Record Offer",y.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${t}) recorded for contact ${e}: $${g} on ${E.opp_pipeline} opp (stage: ${E.opp_stage_name??"?"})`),h()}catch(E){c.error("Offer Made webhook failed",E),b&&(b.textContent=E instanceof Error?E.message:"Network error \u2014 try again."),y&&(y.disabled=!1,y.textContent="Record Offer",y.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},vi="ws-crm-dead-deal-modal",Qc=(e,t)=>{document.getElementById(vi)?.remove();let o=document.createElement("div");o.id=vi,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),t()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-dead-cancel")?.addEventListener("click",i);let s=()=>{let l=r.querySelector("#ws-dead-reason"),d=r.querySelector("#ws-dead-error"),p=(l?.value??"").trim();if(!p){d&&(d.textContent="Please enter a reason."),l?.focus();return}if(p.length<4){d&&(d.textContent="Please enter at least a few words."),l?.focus();return}a(),e(p)};r.querySelector("#ws-dead-submit")?.addEventListener("click",s),r.querySelector("#ws-dead-reason")?.addEventListener("keydown",l=>{l.key==="Enter"&&(l.metaKey||l.ctrlKey)&&(l.preventDefault(),s()),l.key==="Escape"&&i()}),setTimeout(()=>{r.querySelector("#ws-dead-reason")?.focus()},0)},_i="ws-crm-appointment-sanity-modal",Zc=(e,t)=>{document.getElementById(_i)?.remove();let o=document.createElement("div");o.id=_i,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),t()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),e()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},gi=(e,t)=>{let o=document.createElement("div");if(o.id=ot,o.dataset.contactId=e,o.dataset.contactKind=t,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,t==="seller"||t==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Xc(e,t)),o.appendChild(r),o.appendChild(Kc({contactId:e,kind:t}))}return o},Gr=!1,yi=()=>{document.querySelectorAll(`[id="${ot}"]`).forEach(e=>e.remove())},ki=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Gr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Gr=!0;try{await ep()}finally{Gr=!1}},ep=async()=>{let e=D();if(!e){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),yi();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${e.contactId} locationId=${e.locationId??"(null)"} source=${e.source}`),e.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),yi();return}let t="seller";try{let p=await Se(e.contactId,e.locationId),m=Ce(p);m==="buyer"?t="buyer":m==="other"&&(t="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${t} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=D();if(!o||o.contactId!==e.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ot}"]`));if(r.length===1&&r[0].dataset.contactId===e.contactId&&r[0].dataset.contactKind===t){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${e.contactId} kind=${t} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await jc();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=D();if(!i||i.contactId!==e.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=gi(e.contactId,t)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(ot)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${e.contactId} kind=${t}`);let d=null;d=new MutationObserver(()=>{if(!(D()?.contactId===e.contactId)){d?.disconnect();return}let m=document.querySelectorAll(`[id="${ot}"]`);if(m.length>1){for(let h=1;h<m.length;h++)m[h].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${m.length-1} duplicate bar(s)`);return}if(m.length===0){let h=document.querySelector(".central-panel")||a,b=gi(e.contactId,t);b.dataset.mountTarget=s.dataset.mountTarget??"";try{h.insertBefore(b,h.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${e.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},fi=null,tp=()=>{fi===null&&(fi=window.setInterval(()=>{let e=D();e&&(document.getElementById(ot)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",e.contactId),ki()))},3e3))},Ei=()=>{tp(),ki()};var yo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",op=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ct="data-ws-crm-favicon",Ur=e=>e.hasAttribute(Ct),Ti=e=>{if(e.tagName!=="LINK")return!1;let t=(e.getAttribute("rel")??"").toLowerCase();return op.has(t)},fo=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ti(r)&&!Ur(r)&&r.remove()});let t=document.head.querySelector(`link[${Ct}="1"]`);t?t.href!==yo&&(t.href=yo):(t=document.createElement("link"),t.setAttribute(Ct,"1"),t.rel="icon",t.type="image/png",t.href=yo,document.head.appendChild(t),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ct}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ct,"apple"),o.rel="apple-touch-icon",o.href=yo,document.head.appendChild(o))},Si=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)fo();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),fo())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ti(s)&&!Ur(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ur(s)&&(a=!0)});a&&fo()}).observe(document.head,{childList:!0,subtree:!1});let t=0,o=window.setInterval(()=>{t+=1,fo(),t>=5&&window.clearInterval(o)},1e3)};var rp=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],np=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,ap=".hr-card.hr-modal.crm-opportunities-modal",P=()=>{let e=document.querySelector(ap);if(!e)return null;let t=e.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of t){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(np);if(a){let i=a[1];if(rp.includes(i))return i}}return null},W=async(e=2500)=>{let t=Date.now();for(;Date.now()-t<e;){let o=P();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ci="ws-crm-dispo-action-row",U=e=>{let t=document.getElementById(Ci);if(t)return t;e.classList.contains("description")&&(e.style.display="flex",e.style.alignItems="center",e.style.gap="12px",e.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ci,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",e.appendChild(o),o};var ip="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",de="ws-crm-mt-offer-made-button",Ai="ws-crm-mt-offer-made-modal",sp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,lp=/\/v2\/location\/([A-Za-z0-9]+)/,ko=()=>{let e=window.location.pathname,t=e.match(sp);if(!t)return null;let o=e.match(lp);return{oppId:t[1],locationId:o?o[1]:null}},dp=async e=>{let t=await fetch(ip,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,kind:"buyer",amount:e.amount,triggered_by_user_id:e.userId}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},xo=()=>{document.getElementById(Ai)?.remove()},cp=e=>{xo();let t=document.createElement("div");t.id=Ai,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),t.addEventListener("click",d=>{d.target===t&&xo()}),i?.addEventListener("click",()=>xo()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let p=Number(d);if(p<100){a.textContent=`That looks low \u2014 did you mean $${(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let m=await dp({oppId:e.oppId,locationId:e.locationId,amount:p,userId:M()});if(!m.ok){a.textContent=m.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}xo(),e.onSuccess()}catch(m){c.error("MT Offer Made webhook failed",m),a.textContent=m instanceof Error?m.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},pp=e=>{let t=document.createElement("button");return t.id=de,t.type="button",t.dataset.oppId=e,t.style.cssText=O,t.title="Record this buyer's offer on the property and advance to 'Made an Offer'",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=ko();!o||!o.locationId||o.oppId!==e||cp({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=t.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),t.style.background=n.emeraldGlow,t.style.color=n.emeraldBright,t.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",t.style.cssText=O)},4e3)}})}),t},mp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bp=async()=>{for(let e of mp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},wo=!1,Kr=async()=>{if(!wo){wo=!0;try{await hp()}finally{wo=!1}}},hp=async()=>{let e=ko();if(!e||!e.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t();return}let t=document.getElementById(de);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t());return}t&&(t.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await bp();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ko();if(!a||a.oppId!==e.oppId)return;let i=pp(e.oppId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${e.oppId}`),up(e.oppId)},At=null,jr=null,$t=()=>{At?.disconnect(),At=null,jr=null},up=e=>{if(At&&jr===e)return;$t();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(jr=e,At=new MutationObserver(()=>{let o=ko();if(!o||o.oppId!==e){$t();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),$t();return}document.getElementById(de)||Kr()}),At.observe(t,{childList:!0,subtree:!0}))},Vr=null,Wr,vp=()=>{Vr||(Vr=new MutationObserver(()=>{Wr===void 0&&(Wr=window.setTimeout(()=>{Wr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(de);e&&!t&&!wo&&Kr()},300))}),Vr.observe(document.body,{childList:!0,subtree:!0}))},$i=()=>{vp(),Kr()};var _p="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ce="ws-crm-not-interested-button",gp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,yp=/\/v2\/location\/([A-Za-z0-9]+)/,To=()=>{let e=window.location.pathname,t=e.match(gp);if(!t)return null;let o=e.match(yp);return{oppId:t[1],locationId:o?o[1]:null}},fp=async e=>{let t=await fetch(_p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Not Interested webhook returned ${t.status} ${t.statusText}`);return await t.json()},xp=e=>{let t=document.createElement("button");return t.id=ce,t.type="button",t.dataset.oppId=e,t.style.cssText=O,t.title="Close this Marketing Tracker opp as Not Interested for THIS property only",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let o=To();if(!o||!o.locationId||o.oppId!==e)return;let r=M(),a=t.querySelector(".ws-ni-label");t.disabled=!0,t.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await fp({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),t.style.background=n.crimsonGlow,t.style.color=n.crimson,c.info(`Not Interested set for opp ${e} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),t.disabled=!1,t.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),t},wp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kp=async()=>{for(let e of wp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Eo=!1,Qr=async()=>{if(!Eo){Eo=!0;try{await Ep()}finally{Eo=!1}}},Ep=async()=>{let e=To();if(!e||!e.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It();return}let t=document.getElementById(ce);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It());return}t&&(t.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=await kp();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=To();if(!a||a.oppId!==e.oppId)return;let i=xp(e.oppId),s=document.createElement("span");s.id=`${ce}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${e.oppId}`),Tp(e.oppId)},Lt=null,Xr=null,It=()=>{Lt?.disconnect(),Lt=null,Xr=null},Tp=e=>{if(Lt&&Xr===e)return;It();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Xr=e,Lt=new MutationObserver(()=>{let o=To();if(!o||o.oppId!==e){It();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),It();return}document.getElementById(ce)||Qr()}),Lt.observe(t,{childList:!0,subtree:!0}))},Yr=null,Jr,Sp=()=>{Yr||(Yr=new MutationObserver(()=>{Jr===void 0&&(Jr=window.setTimeout(()=>{Jr=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ce);e&&!t&&!Eo&&Qr()},300))}),Yr.observe(document.body,{childList:!0,subtree:!0}))},Li=()=>{Sp(),Qr()};var Cp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ie="ws-crm-schedule-walkthrough-button",Zr="ws-crm-schedule-walkthrough-modal",Ap=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$p=/\/v2\/location\/([A-Za-z0-9]+)/,Ao=()=>{let e=window.location.pathname,t=e.match(Ap);if(!t)return null;let o=e.match($p);return{oppId:t[1],locationId:o?o[1]:null}},So=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Lp=(e,t)=>{document.getElementById(Zr)?.remove();let o=document.createElement("div");o.id=Zr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Zr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",p=document.getElementById("wsw-dur")?.value||"30";if(!d){So("Pick a date and time.","err");return}let m=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(Cp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,start_time:m,duration_min:Number(p)}),credentials:"omit"})).ok){s(),So("Walkthrough scheduled \u2713");let b=document.querySelector(`#${ie} .ws-sw-label`);b&&(b.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",So("Scheduling failed \u2014 try again.","err")}catch(h){c.warn("[schedule-walkthrough] failed:",h),l.disabled=!1,l.textContent="Schedule",So("Couldn't reach the scheduler. Try again.","err")}})},Ip=e=>{let t=document.createElement("button");return t.id=ie,t.type="button",t.dataset.oppId=e,t.style.cssText=O,t.title="Schedule this buyer's property walkthrough",t.innerHTML=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=Ao();!o||!o.locationId||o.oppId!==e||Lp(o.oppId,o.locationId)}),t},Mp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Op=async()=>{for(let e of Mp)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Co=!1,rn=async()=>{if(!Co){Co=!0;try{await Hp()}finally{Co=!1}}},Hp=async()=>{let e=Ao();if(!e||!e.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),Ot();return}let t=document.getElementById(ie);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ie}-wrap`)?.remove(),Ot());return}t&&(t.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await Op();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Ao();if(!a||a.oppId!==e.oppId)return;let i=Ip(e.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${e.oppId}`),Dp(e.oppId)},Mt=null,on=null,Ot=()=>{Mt?.disconnect(),Mt=null,on=null},Dp=e=>{if(Mt&&on===e)return;Ot();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(on=e,Mt=new MutationObserver(()=>{let o=Ao();if(!o||o.oppId!==e){Ot();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),Ot();return}document.getElementById(ie)||rn()}),Mt.observe(t,{childList:!0,subtree:!0}))},en=null,tn,Pp=()=>{en||(en=new MutationObserver(()=>{tn===void 0&&(tn=window.setTimeout(()=>{tn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ie);e&&!t&&!Co&&rn()},300))}),en.observe(document.body,{childList:!0,subtree:!0}))},Ii=()=>{Pp(),rn()};var Bp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",rt="ws-crm-resend-deal-link-wrap",Rp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fp=/\/v2\/location\/([A-Za-z0-9]+)/,Lo=()=>{let e=window.location.pathname,t=e.match(Rp);if(!t)return null;let o=e.match(Fp);return{oppId:t[1],locationId:o?o[1]:null}},Np=async e=>{let t=await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,channel:e.channel,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Resend webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},zp=e=>e.replace(/[<>&]/g,t=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[t]||t),Mi=e=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${e};box-shadow:0 0 6px ${e};flex-shrink:0;"></span>`,ln=(e,t)=>{e.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Mi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>qp(e,t)),e.appendChild(o)},qp=(e,t)=>{e.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Gp(e,t,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>ln(e,t)),o.appendChild(s),e.appendChild(o)},Gp=async(e,t,o,r)=>{let a=Lo();if(!(!a||!a.locationId||a.oppId!==t)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Np({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${Mi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${t}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${zp(s)}</span>`}window.setTimeout(()=>ln(e,t),3500)}},Up=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vp=async()=>{for(let e of Up)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},$o=!1,dn=async()=>{if(!$o){$o=!0;try{await Wp()}finally{$o=!1}}},Wp=async()=>{let e=Lo();if(!e||!e.locationId){document.getElementById(rt)?.remove(),Dt();return}let t=document.getElementById(rt);if(t&&t.dataset.oppId===e.oppId){let s=P();s!==null&&s!=="Marketing Tracker"&&(t.remove(),Dt());return}t&&t.remove();let o=await Vp();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Lo();if(!a||a.oppId!==e.oppId)return;let i=document.createElement("span");i.id=rt,i.dataset.oppId=e.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),ln(i,e.oppId),c.debug(`Mounted Resend Deal Link button on opp ${e.oppId}`),jp(e.oppId)},Ht=null,sn=null,Dt=()=>{Ht?.disconnect(),Ht=null,sn=null},jp=e=>{if(Ht&&sn===e)return;Dt();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(sn=e,Ht=new MutationObserver(()=>{let o=Lo();if(!o||o.oppId!==e){Dt();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(rt)?.remove(),Dt();return}document.getElementById(rt)||dn()}),Ht.observe(t,{childList:!0,subtree:!0}))},nn=null,an,Kp=()=>{nn||(nn=new MutationObserver(()=>{an===void 0&&(an=window.setTimeout(()=>{an=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(rt)&&!$o&&dn()},300))}),nn.observe(document.body,{childList:!0,subtree:!0}))},Oi=()=>{Kp(),dn()};var Yp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",pe="ws-crm-reduce-price-button",Hi="ws-crm-reduce-price-modal",Jp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xp=/\/v2\/location\/([A-Za-z0-9]+)/,Oo=()=>{let e=window.location.pathname,t=e.match(Jp);if(!t)return null;let o=e.match(Xp);return{oppId:t[1],locationId:o?o[1]:null}},Qp=async e=>{let t=await fetch(Yp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,dispo_opp_id:e.oppId,new_price:e.newPrice,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Reduce Price webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Io=()=>{document.getElementById(Hi)?.remove()},Zp=e=>{Io();let t=document.createElement("div");t.id=Hi,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let p=r.value.replace(/[^0-9.]/g,"").split(".");r.value=p[0]+(p.length>1?"."+p.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),t.addEventListener("click",d=>{d.target===t&&Io()}),i?.addEventListener("click",()=>{Io()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let p=parseFloat(d);if(!Number.isFinite(p)||p<=0){a.textContent="Price must be a positive number.",r.focus();return}if(p<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Qp({oppId:e.oppId,locationId:e.locationId,newPrice:p,userId:M()}),Io(),e.onSuccess()}catch(m){c.error("Reduce Price webhook failed",m),a.textContent=m instanceof Error?m.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},em=(e,t)=>{let o=document.createElement("button");return o.id=pe,o.type="button",o.dataset.oppId=e,o.style.cssText=O,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Oo();!r||!r.locationId||r.oppId!==e||Zp({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},tm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],om=async()=>{for(let e of tm)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Mo=!1,bn=async()=>{if(!Mo){Mo=!0;try{await rm()}finally{Mo=!1}}},rm=async()=>{let e=Oo();if(!e||!e.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt();return}let t=document.getElementById(pe);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt());return}t&&(t.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=await om();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Oo();if(!a||a.oppId!==e.oppId)return;let i=em(e.oppId,e.locationId),s=document.createElement("span");s.id=`${pe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${e.oppId}`),nm(e.oppId)},Pt=null,mn=null,Bt=()=>{Pt?.disconnect(),Pt=null,mn=null},nm=e=>{if(Pt&&mn===e)return;Bt();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(mn=e,Pt=new MutationObserver(()=>{let o=Oo();if(!o||o.oppId!==e){Bt();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Bt();return}document.getElementById(pe)||bn()}),Pt.observe(t,{childList:!0,subtree:!0}))},cn=null,pn,am=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(pe);e&&!t&&!Mo&&bn()},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},Di=()=>{am(),bn()};var nt="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Ho="deals.reinvestos.com";var me="ws-crm-edit-landing-button",im=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sm=/\/v2\/location\/([A-Za-z0-9]+)/,Po=()=>{let e=window.location.pathname,t=e.match(im);if(!t)return null;let o=e.match(sm);return{oppId:t[1],locationId:o?o[1]:null}},lm=(e,t)=>{let o=new URL(`https://${Ho}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();return r&&o.searchParams.set("user",r),o.toString()},dm=(e,t)=>{let o=document.createElement("button");return o.id=me,o.type="button",o.dataset.oppId=e,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Po();if(!r||!r.locationId||r.oppId!==e)return;if(!nt){c.warn("[edit-landing] editor session key not configured in this build");return}let a=lm(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},cm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pm=async()=>{for(let e of cm)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Do=!1,_n=async()=>{if(!Do){Do=!0;try{await mm()}finally{Do=!1}}},mm=async()=>{let e=Po();if(!e||!e.locationId){document.getElementById(me)?.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft();return}let t=document.getElementById(me);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft());return}t&&(t.remove(),document.getElementById(`${me}-wrap`)?.remove());let o=await pm();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Po();if(!a||a.oppId!==e.oppId)return;let i=dm(e.oppId,e.locationId),s=document.createElement("span");s.id=`${me}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${e.oppId}`),bm(e.oppId)},Rt=null,vn=null,Ft=()=>{Rt?.disconnect(),Rt=null,vn=null},bm=e=>{if(Rt&&vn===e)return;Ft();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(vn=e,Rt=new MutationObserver(()=>{let o=Po();if(!o||o.oppId!==e){Ft();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(me)?.remove(),document.getElementById(`${me}-wrap`)?.remove(),Ft();return}document.getElementById(me)||_n()}),Rt.observe(t,{childList:!0,subtree:!0}))},hn=null,un,hm=()=>{hn||(hn=new MutationObserver(()=>{un===void 0&&(un=window.setTimeout(()=>{un=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(me);e&&!t&&!Do&&_n()},300))}),hn.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{hm(),_n()};var Ri="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",at="ws-crm-publish-button",Nt="ws-crm-publish-wrap",Ro="ws-crm-publish-dropdown",um=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vm=/\/v2\/location\/([A-Za-z0-9]+)/,fn=()=>{let e=window.location.pathname,t=e.match(um);if(!t)return null;let o=e.match(vm);return{oppId:t[1],locationId:o?o[1]:null}},_m=async(e,t)=>{try{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},gm=async(e,t)=>{let o=await fetch(Ri,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ym=(e,t)=>{if(!nt){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Ho}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",nt);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},xe=()=>{document.getElementById(Ro)?.remove()},Bi=(e,t,o,r,a)=>{xe();let i=document.createElement("div");i.id=Ro;let s=t.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let l=e.length,d=e.filter(k=>k.filled).length,p=d===l,m=document.createElement("div");m.innerHTML=`
    <div style="
  ...
  `,i.appendChild(m),e.forEach(k=>{let x=document.createElement("div");x.style.cssText=`
      display: flex; align-items: center; gap: 10px;
      padding: 6px 4px; font-size: 12px;
      color: ${k.filled?n.bone:n.ash};
    `;let g=k.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;x.innerHTML=`${g}<span style="flex: 1;">${k.label}</span>`,i.appendChild(x)});let h=document.createElement("div");h.style.cssText=`
    display: flex; align-items: center; gap: 10px;
  ...
  `;let b=document.createElement("button");b.type="button",b.textContent="Open editor to finish \u2192",b.style.cssText=`
    ...
    color: ${n.emerald};
  `,b.addEventListener("click",k=>{k.stopPropagation(),ym(o,r)}),h.appendChild(b);let _=document.createElement("button");_.type="button",_.textContent="Re-check",_.title="Re-check after editing the page",_.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,_.addEventListener("click",k=>{k.stopPropagation(),xe(),a()}),h.appendChild(_),i.appendChild(h),document.body.appendChild(i);let y=k=>{let x=k.target;!i.contains(x)&&!t.contains(x)&&(xe(),document.removeEventListener("click",y))};window.setTimeout(()=>document.addEventListener("click",y),0)},qe=(e,t)=>{let o=e.querySelector(".ws-pub-label"),r=e.querySelector(".ws-pub-dot"),a=e.querySelector(".ws-pub-chevron"),i="transparent",s=n.steel,l=n.bone,d=n.coolGray,p="Publish Deal",m="",h="pointer",b="1";switch(t.status){case"checking":s=n.steel,l=n.ash,p="Checking\u2026",h="wait",b="0.8";break;case"ready":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publish Deal";break;case"incomplete":{let _=t.checks?.filter(k=>k.filled).length??0,y=t.checks?.length??0;s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${y} ready`,m="\u25BE";break}case"publishing":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publishing\u2026",h="wait",b="0.8";break;case"published":i="transparent",s=n.steel,l=n.ash,d=n.emerald,p="Deal Published",h="default",b="0.9";break;case"error":s=n.amber,l=n.amber,d=n.amber,p=t.message??"Try again";break}e.style.background=i,e.style.borderColor=s,e.style.color=l,e.style.cursor=h,e.style.opacity=b,r&&(r.style.background=d,r.style.boxShadow=t.status==="ready"||t.status==="published"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},fm=(e,t)=>{let o=document.createElement("button");o.id=at,o.type="button",o.dataset.oppId=e,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${K}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};qe(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let h=await _m(e,t);if(!h||!Array.isArray(h.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},qe(o,r);return}r={status:h.published?"published":h.ready?"ready":"incomplete",checks:h.checks},qe(o,r),document.getElementById(Ro)&&r.checks&&Bi(r.checks,o,e,t,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},qe(o,r),xe();try{let h=await gm(e,t);if(h.ok&&h.published)r={status:"published"},qe(o,r),c.info(`[publish] published opp ${e}`);else if(h.missing&&h.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},qe(o,r);else throw new Error(h.error||"Publish failed")}catch(h){let b=h instanceof Error?h.message:"Publish failed";c.error("[publish] publish failed",h),r={status:"error",message:b.length>28?"Error \u2014 try again":b},qe(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Ro)?xe():r.checks&&Bi(r.checks,o,e,t,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,m=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(m){let h=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});h.observe(m,{childList:!0,subtree:!0});let b=window.setInterval(()=>{document.body.contains(o)||(h.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(b))},5e3)}return o},xm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wm=async()=>{for(let e of xm)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Bo=!1,wn=async()=>{if(!Bo){Bo=!0;try{await km()}finally{Bo=!1}}},km=async()=>{let e=fn();if(!e||!e.locationId){document.getElementById(at)?.remove(),document.getElementById(Nt)?.remove(),xe(),qt();return}let t=document.getElementById(at);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Disposition"&&(t.remove(),document.getElementById(Nt)?.remove(),xe(),qt());return}t&&(t.remove(),document.getElementById(Nt)?.remove(),xe());let o=await wm();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=fn();if(!a||a.oppId!==e.oppId||!a.locationId)return;let i=fm(e.oppId,a.locationId),s=document.createElement("span");s.id=Nt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${e.oppId}`),Em(e.oppId)},zt=null,xn=null,qt=()=>{zt?.disconnect(),zt=null,xn=null},Em=e=>{if(zt&&xn===e)return;qt();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(xn=e,zt=new MutationObserver(()=>{let o=fn();if(!o||o.oppId!==e){qt();return}let r=P();if(r!==null&&r!=="Disposition"){document.getElementById(at)?.remove(),document.getElementById(Nt)?.remove(),xe(),qt();return}document.getElementById(at)||wn()}),zt.observe(t,{childList:!0,subtree:!0}))},gn=null,yn,Tm=()=>{gn||(gn=new MutationObserver(()=>{yn===void 0&&(yn=window.setTimeout(()=>{yn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(at)&&!Bo&&wn()},300))}),gn.observe(document.body,{childList:!0,subtree:!0}))},Fi=()=>{Tm(),wn()};var Ni="data:image/png;base64,",zi="data:image/png;base64,";var Sm=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],qi=e=>`ws-crm-map-links-${e}`,Fo=e=>{let t=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},Gi=e=>{let t=Fo(e.addr),o=Fo(e.city),r=Fo(e.state),a=Fo(e.zip),i;return o&&t&&t.toLowerCase().includes(o.toLowerCase())?i=t:i=[t,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Cm=e=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(e)}`,Am=e=>`https://www.zillow.com/homes/${e.replace(/\s+/g,"-")}_rb`,$m=(e,t)=>{let{full:o,hasAny:r}=Gi(e);r&&window.open(t(o),"_blank","noopener,noreferrer")},Lm=e=>{let t=document.createElement("span");t.id=qi(e.key),t.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",t.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),$m(e,s)}),l};return t.appendChild(r(Ni,"Open in Google Maps",Cm)),t.appendChild(r(zi,"Search on Zillow",Am)),t},Im=e=>{let t=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ui=()=>{for(let e of Sm){if(document.getElementById(qi(e.key)))continue;let{hasAny:t}=Gi(e);if(!t)continue;let o=Im(e);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Lm(e)),c.debug(`[map-links] injected on "${e.addr}"`))}},kn=null,En,Mm=()=>{kn||(kn=new MutationObserver(()=>{En===void 0&&(En=window.setTimeout(()=>{En=void 0;try{Ui()}catch(e){c.warn("[map-links] ensureInjected failed",e)}},300))}),kn.observe(document.body,{childList:!0,subtree:!0}))},Vi=()=>{Mm(),Ui()};var Wi="ws-crm-hide-launchpad",ji=/\/launchpad\/?$/,Tn=()=>{if(!Ze()){if(!document.getElementById(Wi)){let e=document.createElement("style");e.id=Wi,e.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(e),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ji.test(location.pathname)){let e=location.pathname.replace(ji,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${e}`),location.replace(e)}}};var Om=[{label:"Buy-Box Entries"},{label:"Memberships"}],Ki=e=>{e.size!==0&&document.querySelectorAll(".nav-title").forEach(t=>{let o=(t.textContent||"").trim().toLowerCase();if(!e.has(o))return;let r=t.closest("a")||t.closest("li")||t.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${t.textContent?.trim()}"`))})},Sn=()=>{let e=Ze(),t=new Set(Om.filter(o=>o.agencyToo||!e).map(o=>o.label.trim().toLowerCase()));if(t.size!==0){Ki(t);for(let o of[150,500,1200,2500])setTimeout(()=>Ki(t),o)}};var Hm=[{from:"Payments",to:"Contracts"}],Dm=".nav-title, .topmenu-navtitle",Yi=()=>{document.querySelectorAll(Dm).forEach(e=>{let t=(e.textContent||"").trim(),o=Hm.find(r=>r.from===t);o&&(e.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Cn=()=>{Yi();for(let e of[150,500,1200,2500])setTimeout(Yi,e)};var Ji="/payments/proposals-estimates",Pm=/\/payments\/invoices\/?$/,Bm=/\/payments\//,Rm='#sb_payments, a[meta="payments"]',Qi=(e=0)=>{if(e>25)return;let t=location.pathname;if(!t.includes(Ji)&&!(e>3&&!Bm.test(t))){if(Pm.test(t)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ji));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Qi(e+1),120)}},Xi=!1,Fm=()=>{Xi||(Xi=!0,document.addEventListener("click",e=>{e.target?.closest?.(Rm)&&setTimeout(()=>Qi(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},An=()=>{Fm()};var Zi=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],es="ws-crm-hide-topmenu-tabs",$n=()=>{if(document.getElementById(es))return;let e=Zi.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),t=document.createElement("style");t.id=es,t.textContent=`${e}{display:none !important;}`,(document.head||document.documentElement).appendChild(t),c.info(`[hide-topmenu-tabs] hid ${Zi.length} top tabs`)};var rs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",$e="ws-crm-send-to-closing-office-button",Ge="ws-crm-send-to-title-co-wrap",qo="ws-crm-stc-dropdown",Nm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zm=/\/v2\/location\/([A-Za-z0-9]+)/,Go=()=>{let e=window.location.pathname,t=e.match(Nm);if(!t)return null;let o=e.match(zm);return{oppId:t[1],locationId:o?o[1]:null}},qm=5*60*1e3,Hn=e=>`ws-crm-stc-cache:${e}`,Gm=e=>{try{let t=window.localStorage.getItem(Hn(e));if(!t)return null;let o=JSON.parse(t);return!o.ts||Date.now()-o.ts>qm||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Um=(e,t)=>{try{window.localStorage.setItem(Hn(e),JSON.stringify(t))}catch{}},ns=e=>{try{window.localStorage.removeItem(Hn(e))}catch{}},Mn="ws-crm:opp-fields-updated",as=e=>{if(e){ns(e);try{window.dispatchEvent(new CustomEvent(Mn,{detail:{oppId:e}}))}catch{}}},Vm=async(e,t)=>{try{let o=await fetch(rs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,tc_opp_id:e,triggered_by_user_id:M()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Wm=async(e,t,o)=>{let r=await fetch(rs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,tc_opp_id:e,triggered_by_user_id:M()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},jm=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!t)return!1;let o=t.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===e)return a.click(),!0;let r=t.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===e)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${e}"`),!1},ts=e=>{let t=document.getElementById(e);if(!t){c.warn(`[stc] field ${e} not found in DOM \u2014 can't scroll to it`);return}t.scrollIntoView({behavior:"smooth",block:"center"});let o=t.style.boxShadow,r=t.style.transition;t.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",t.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{t.style.boxShadow=o,window.setTimeout(()=>{t.style.transition=r},400)},2800)},Km=(e,t)=>{if(t&&jm(t)){window.setTimeout(()=>ts(e),300);return}ts(e)},be=()=>{document.getElementById(qo)?.remove()},No=(e,t,o)=>{be();let r=document.createElement("div");r.id=qo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let i=e.length,s=e.filter(_=>_.filled).length,l=s===i,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,r.appendChild(d);let p=["TC","ACQ","MT","DISPO","Property"],m={};e.forEach(_=>{m[_.group]||(m[_.group]=[]),m[_.group].push(_)});let h=[...p.filter(_=>m[_]),...Object.keys(m).filter(_=>!p.includes(_))];for(let _ of h){let y=m[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let x=document.createElement("div");x.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,x.textContent=_,k.appendChild(x),y.forEach(g=>{let w=document.createElement("div"),C=!g.filled&&g.navigable&&g.field_id;w.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${C?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,C&&(w.addEventListener("mouseenter",()=>{w.style.background=n.slate}),w.addEventListener("mouseleave",()=>{w.style.background="transparent"}),w.addEventListener("click",f=>{f.stopPropagation(),g.field_id&&(Km(g.field_id,g.folder),be())}));let S=g.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=C?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";w.innerHTML=`${S}<span style="flex: 1;">${g.label}</span>${E}`,k.appendChild(w)}),r.appendChild(k)}document.body.appendChild(r);let b=_=>{let y=_.target;!r.contains(y)&&!o.contains(y)&&(be(),document.removeEventListener("click",b))};window.setTimeout(()=>document.addEventListener("click",b),0)},_e=(e,t)=>{let o=e.querySelector(".ws-stc-label"),r=e.querySelector(".ws-stc-dot"),a=e.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,p="Send to Closing Office",m="",h="pointer",b="1";switch(t.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,p="Checking\u2026",h="wait",b="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p=t.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=t.checks?.filter(k=>k.filled).length??0,y=t.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${y} Fields Ready`;break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sending\u2026",h="wait",b="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,p=t.message??"Try again";break}e.style.background=i,e.style.borderColor=s,e.style.color=l,e.style.cursor=h,e.style.opacity=b,r&&(r.style.background=d,r.style.boxShadow=t.status==="ready"||t.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},Ym=(e,t)=>{let o=document.createElement("button");o.id=$e,o.type="button",o.dataset.oppId=e;let r=Gm(e),a=r?{status:r.checks.every(x=>x.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${O}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,_e(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let x=await Vm(e,t);if(!x){a={status:"error",message:"Check failed \u2014 click to retry"},_e(o,a);return}if(x.rate_limited){_=Date.now()+b,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},_e(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(x.checks)||x.checks.length===0){a={status:"error",message:x.error||"Check failed \u2014 click to retry"},_e(o,a),c.warn("[stc] dry_run returned no checks:",x);return}let g=x.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Uo.add(e),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be(),Ut();return}let w=x.checks;if(a.checks&&a.checks.length===x.checks.length){let S=new Set;w=x.checks.map((E,f)=>a.checks[f]?.filled&&!E.filled?i.has(E.label)?E:(S.add(E.label),{...E,filled:!0}):E),i=S}else i=new Set;a={status:w.every(S=>S.filled)?"ready":"incomplete",checks:w,previouslySentAt:x.previously_sent_at??null},Um(e,{checks:w,previously_sent_at:x.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),_e(o,a),document.getElementById(qo)&&No(w,x.previously_sent_at,o)},l=async()=>{let x=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},_e(o,a),be();try{let g=await Wm(e,t,x);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},_e(o,a),window.setTimeout(()=>{y()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},_e(o,a),g.checks&&No(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},_e(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(qo)?be():a.checks&&No(a.checks,a.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,p=!1,m=Date.now(),h=1e4,b=5*60*1e3,_=0,y=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,m=Date.now();try{await s()}finally{p=!1}}};y();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let x=new MutationObserver(()=>{if(d!==void 0||p)return;let C=Date.now()-m,S=Math.max(1500,h-C);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&y()},S)});x.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=C=>{let S=C.detail;if(!S||S.oppId!==e)return;ns(e);let E=0,f=()=>{if(p&&E<8){E+=1,window.setTimeout(f,500);return}y()};f()};window.addEventListener(Mn,g);let w=window.setInterval(()=>{document.body.contains(o)||(x.disconnect(),d!==void 0&&window.clearTimeout(d),window.removeEventListener(Mn,g),window.clearInterval(w))},5e3)}return o},Jm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xm=async()=>{for(let e of Jm)try{let t=await $(e,{timeoutMs:1500});if(t)return c.debug(`[send-to-title-co] mount target: ${e}`),t}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Uo=new Set,os=null,Qm=e=>{e&&e!==os&&(Uo.clear(),os=e)},zo=!1,Dn=async()=>{if(zo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}zo=!0;try{await Zm()}catch(e){c.error("[stc] ensureMountedImpl threw:",e)}finally{zo=!1}},Zm=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let e=Go();if(!e||!e.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(e)}`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${e.oppId} locId=${e.locationId}`),Qm(e.oppId),Uo.has(e.oppId)){c.debug(`[stc] mount:02-BAIL opp ${e.oppId} previously confirmed non-TC this session`),document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be();return}let t=document.getElementById($e);if(t&&t.dataset.oppId===e.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=P();l!==null&&l!=="Transaction Coordination"&&(t.remove(),document.getElementById(Ge)?.remove(),be(),Ut());return}t&&(c.debug("[stc] mount:03 removing stale existing button"),t.remove(),document.getElementById(Ge)?.remove(),be()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Xm();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=P();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Go();if(!a||a.oppId!==e.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${e.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Ym(e.oppId,a.locationId),s=document.createElement("span");s.id=Ge,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${e.oppId}, inDoc=${document.body.contains(i)}`),eb(e.oppId)},Gt=null,On=null,Ut=()=>{Gt?.disconnect(),Gt=null,On=null},eb=e=>{if(Gt&&On===e)return;Ut();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(On=e,Gt=new MutationObserver(()=>{let o=Go();if(!o||o.oppId!==e){Ut();return}let r=P();if(r!==null&&r!=="Transaction Coordination"){document.getElementById($e)?.remove(),document.getElementById(Ge)?.remove(),be(),Ut();return}document.getElementById($e)||Dn()}),Gt.observe(t,{childList:!0,subtree:!0}))},Ln=null,In,tb=()=>{Ln||(Ln=new MutationObserver(()=>{In===void 0&&(In=window.setTimeout(()=>{In=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById($e);if(e&&!t&&!zo){let o=Go();if(o&&Uo.has(o.oppId))return;Dn()}},300))}),Ln.observe(document.body,{childList:!0,subtree:!0}))},is=()=>{tb(),Dn()};var Rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ob=`${Rn}/tc/welcome-call-prefill`,rb=`${Rn}/tc/welcome-call-save`,nb=`${Rn}/tc/order-lockbox`,Vt="ws-crm-welcome-call-overlay",ab=["Regular Contract","Subject To","Seller Finance","Novation"],ib=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],sb=["Gas","Electric","Propane","Oil"],lb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],db=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Le=["Yes","No"],cb=["Yes","No","Unknown"],pb=["Professional Photographer","Seller","Tenant"],mb=["Month-to-Month","Annual"],ss=["Current","Behind"],bb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ge=e=>(e==null?"":String(e)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Wo=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,cs="margin-bottom:12px;",ps=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,hb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ls=e=>String(e??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(e,t,o)=>{let r=ls(o);return`<select id="${e}" style="${Wo}"><option value=""></option>${t.map(a=>`<option ${r!==""&&ls(a)===r?"selected":""}>${ge(a)}</option>`).join("")}</select>`},Z=(e,t,o="")=>`<input id="${e}" type="text" value="${ge(t)}" placeholder="${ge(o)}" style="${Wo}">`,ub=(e,t)=>`<textarea id="${e}" rows="3" style="${Wo}resize:vertical;">${ge(t)}</textarea>`,vb=(e,t)=>`<input id="${e}" type="date" value="${ge(t)}" style="${Wo}">`,H=(e,t)=>`<div style="${cs}"><label style="${ps}">${ge(e)}</label>${t}</div>`,Pn=(e,t)=>{let o=Array.isArray(t)?t:[];return`<div style="margin-top:4px;">${bb.map(r=>`<label style="${hb}"><input type="checkbox" data-grp="${e}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},we=e=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ge(e)}</div>`,it=()=>{document.getElementById(Vt)?.remove()},Ue=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},_b=e=>{let t=e.tenant||{};return`
    ${we("Identifiers")}
    ...
    ${we("Contract")}
    ${H("Type of Contract",j("wc-contract_type",ab,e.contract_type))}

    ${we("Property")}
    ${H("Property Type",j("wc-property_type",lb,e.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${H("Beds",Z("wc-beds",e.beds))}</div>
      <div style="flex:1;">${H("Baths",Z("wc-baths",e.baths))}</div>
      <div style="flex:1;">${H("Sq Ft",Z("wc-sqft",e.sqft))}</div>
    </div>
    ${H("Utilities",j("wc-utilities",ib,e.utilities))}
    ${H("Heat Source",j("wc-heat_source",sb,e.heat_source))}

    ${we("Liens & Permits")}
    ${H("Is there a mortgage?",j("wc-has_mortgage",Le,e.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${H("Mortgage payment status",j("wc-mortgage_payment_status",ss,e.mortgage_payment_status))}</div>
    ${H("Any other liens? (back taxes, code violations, HELOC, etc.)",j("wc-has_other_liens",Le,e.has_other_liens))}
    ${H("Any open or expired permits?",j("wc-has_permit_issues",Le,e.has_permit_issues))}
    ${H("Is the property in probate?",j("wc-in_probate",Le,e.in_probate))}

    ${we("Occupancy")}
    ${H("Property occupancy",j("wc-occupancy",db,e.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("First name",Z("wc-tenant_first_name",t.first_name))}</div>
        <div style="flex:1;">${H("Last name",Z("wc-tenant_last_name",t.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("Phone",Z("wc-tenant_phone",t.phone))}</div>
        <div style="flex:1;">${H("Email",Z("wc-tenant_email",t.email))}</div>
      </div>
      ${H("Lease type",j("wc-tenant_lease_type",mb,t.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("Monthly rent",Z("wc-tenant_monthly_rent",t.monthly_rent))}</div>
        <div style="flex:1;">${H("Rent due day",Z("wc-tenant_rent_due_day",t.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("Rent status",j("wc-tenant_rent_status",ss,t.rent_status))}</div>
        <div style="flex:1;">${H("Last rent paid",vb("wc-tenant_last_rent_paid",t.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("Lease on hand?",j("wc-tenant_lease_on_hand",Le,t.lease_on_hand))}</div>
        <div style="flex:1;">${H("Security deposit",Z("wc-tenant_security_deposit",t.security_deposit))}</div>
      </div>
      ${H("Selling with tenant in place?",j("wc-selling_with_tenant",Le,e.selling_with_tenant))}
    </div>

    ${we("HOA")}
    ${H("Part of an HOA?",j("wc-in_hoa",Le,e.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${H("HOA monthly fee",Z("wc-hoa_monthly_fee",e.hoa_monthly_fee))}${H("HOA rental restriction?",j("wc-hoa_rental_restriction",cb,e.hoa_rental_restriction))}</div>

    ${we("Photos & Access")}
    ${H("Who is providing photos?",j("wc-photos_provided_by",pb,e.photos_provided_by))}
    <div style="${cs}">
      <label style="${ps}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Pn("photos_avail_mornings",e.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Pn("photos_avail_afternoons",e.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Pn("photos_avail_evenings",e.photos_avail_evenings)}
    </div>

    ${we("Lockbox")}
    ${H("Lockbox needed?",j("wc-lockbox_needed",Le,e.lockbox_needed))}
    ${H("Lockbox code (agree with the seller; recorded on the property for future use)",Z("wc-lockbox_code",e.lockbox_code))}
    <div id="wc-lockbox-detail" style="display:none;">
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${H("Recipient name",Z("wc-lockbox_recipient_name",e.lockbox_recipient_name))}</div>
        <div style="flex:1;">${H("Recipient phone",Z("wc-lockbox_recipient_phone",e.lockbox_recipient_phone))}</div>
      </div>
      ${H("Mailing address (if different from property)",Z("wc-lockbox_mailing_address",e.lockbox_mailing_address))}
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${Vo(e).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Vo(e).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Vo(e).on?n.emerald:n.amber};flex-shrink:0;"></span>${Vo(e).text}</span>
      </div>
    </div>

    ${we("Notes")}
    ${H("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",ub("wc-welcome_call_notes",e.welcome_call_notes))}
  `},A=e=>{let t=document.getElementById(e);return t?(t.value||"").trim():""},Bn=e=>Array.from(document.querySelectorAll(`input[data-grp="${e}"]:checked`)).map(t=>t.value),ds=()=>{let e=(t,o)=>{let r=document.getElementById(t);r&&(r.style.display=o?"block":"none")};e("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),e("wc-hoa-detail",A("wc-in_hoa")==="Yes"),e("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),e("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Vo=e=>{let t=e,o=String(t.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=t.lockbox_order_date?ge(t.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},gb=e=>({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:Bn("photos_avail_mornings"),photos_avail_afternoons:Bn("photos_avail_afternoons"),photos_avail_evenings:Bn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),yb=e=>{it();let t=document.createElement("div");t.id=Vt,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${Vt} input[type="date"]::-webkit-calendar-picker-indicator,#${Vt} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${_b(e)}</div>
  ...
  `,t.appendChild(o),document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&it()}),document.getElementById("wc-close")?.addEventListener("click",it),document.getElementById("wc-cancel")?.addEventListener("click",it),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",ds)}),ds();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!A("wc-occupancy")){Ue("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(rb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(gb(e)),credentials:"omit"})).ok?(it(),Ue("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Ue("Save failed \u2014 try again.","err"))}catch(i){c.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Ue("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(nb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,ship_to:A("wc-lockbox_mailing_address")||e.deal_address||"",recipient_name:A("wc-lockbox_recipient_name"),recipient_phone:A("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),Ue("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,Ue("Lockbox order failed \u2014 try again.","err"))}catch(s){c.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,Ue("Couldn't reach the lockbox handler. Try again.","err")}})},ms=async(e,t)=>{it();let o=document.createElement("div");o.id=Vt,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:e,tenant_id:t};try{let a=await fetch(`${ob}?tc_opp_id=${encodeURIComponent(e)}&tenant_id=${encodeURIComponent(t)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||e,tenant_id:t}}else c.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){c.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=t,yb(r)};var Wn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",fb=`${Wn}/tc/confirm-photo-appointment`,xb=`${Wn}/tc/order-lockbox`,wb=`${Wn}/tc/welcome-call-prefill`,Gn="ws-crm-opp-action-bar",hs="ws-crm-opp-overflow",us="ws-crm-opp-action-menu",Un="ws-crm-opp-action-popover",vs="ws-crm-reorder-lockbox-modal",_s=".hr-card.hr-modal.crm-opportunities-modal",kb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Eb=/\/v2\/location\/([A-Za-z0-9]+)/,gs="Welcome Call Needed",jn="Scheduling Photos",ys="Photos Scheduled",Tb=[gs,jn,ys,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],fs=()=>{let e=window.location.pathname,t=e.match(kb);if(!t)return null;let o=e.match(Eb);return o?{oppId:t[1],locationId:o[1]}:null},Sb=()=>{let e=document.querySelector(_s);if(!e)return null;let t=e.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of t){let r=o.textContent?.trim()??"";if(Tb.includes(r))return r}return null},Me=()=>{document.getElementById(us)?.remove(),document.getElementById(Un)?.remove(),document.getElementById(vs)?.remove()},Fn=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ie=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
    ...
    box-shadow: 0 12px 32px rgba(0,0,0,0.5);
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Cb=e=>{ms(e.oppId,e.locationId)},Ab=async(e,t,o)=>(await fetch(xb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,contact_id:t.contact_id||"",property_record_id:t.property_record_id||"",deal_address:t.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,$b=(e,t)=>{Me();let o=document.createElement("div");o.id=vs,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=t.lockbox_mailing_address||t.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Fn(t.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Fn(t.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Fn(s)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",h=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!h){Ie("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await Ab(e,t,{recipient_name:p,recipient_phone:m,ship_to:h})?(l(),Ie("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",Ie("Re-order failed \u2014 try again.","err"))}catch(b){c.warn("[action-bar] reorder lockbox failed:",b),d.disabled=!1,d.textContent="Order Lockbox",Ie("Couldn't reach the lockbox handler. Try again.","err")}}})},xs=async e=>{Me();let t={};try{t=await fetch(`${wb}?tc_opp_id=${encodeURIComponent(e.oppId)}&tenant_id=${encodeURIComponent(e.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}$b(e,t)},Lb=(e,t)=>{Me();let o=document.createElement("div");o.id=Un;let r=t.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${u.sans};
  `,o.innerHTML=`
    <style>#${Un} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Ie("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Me(),Ie("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Ie("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Ie("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!t.contains(p)&&(Me(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Ib=(e,t)=>{Me();let o=document.createElement("div");o.id=us;let r=t.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of e){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!t.contains(s)&&(Me(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Ko=(e,t)=>{let o=document.createElement("button");return o.type="button",t==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=e,o},Mb=()=>{let e=Ko("\u22EE","ghost");return e.style.lineHeight="1",e},Ob=(e,t)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",t===gs){let r=Ko("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Cb(e)),o.appendChild(r),o}if(t===jn){let r=Ko("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Lb(e,r)),o.appendChild(r),o}if(t===ys){let r=Ko("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void xs(e)),o.appendChild(r),o}return null},Hb=(e,t)=>{let o=[];if(t===jn&&(o=[{label:"Re-order Lockbox",onClick:()=>void xs(e)}]),!o.length)return null;let r=document.createElement("span");r.id=hs,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Mb();return a.addEventListener("click",i=>{i.stopPropagation(),Ib(o,a)}),r.appendChild(a),r},Db=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Pb=async()=>{for(let e of Db)try{let t=await $(e,{timeoutMs:1200});if(t)return t}catch{}return null},jo=()=>{document.getElementById(Gn)?.remove(),document.getElementById(hs)?.remove(),Me()},Yo=!1,Kn=async()=>{if(!Yo){Yo=!0;try{let e=fs();if(!e){jo();return}let t=P();if(t===null)return;if(t!=="Transaction Coordination"){jo();return}let o=Sb(),r=document.getElementById(Gn);if(r&&r.dataset.oppId===e.oppId&&r.dataset.stage===(o??""))return;let a=Ob(e,o);if(!a){jo();return}let i=await Pb();if(!i)return;jo();let s=U(i),l=document.createElement("span");l.id=Gn,l.dataset.oppId=e.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Hb(e,o);d&&s.appendChild(d),Bb(e.oppId)}catch(e){c.error("[action-bar] ensureBar threw:",e)}finally{Yo=!1}}},Wt=null,Vn=null,Nn,bs=()=>{Wt?.disconnect(),Wt=null,Vn=null},Bb=e=>{if(Wt&&Vn===e)return;bs();let t=document.querySelector(_s);t&&(Vn=e,Wt=new MutationObserver(()=>{let o=fs();if(!o||o.oppId!==e){bs();return}Nn===void 0&&(Nn=window.setTimeout(()=>{Nn=void 0,Kn()},250))}),Wt.observe(t,{childList:!0,subtree:!0}))},zn=null,qn,Rb=()=>{zn||(zn=new MutationObserver(()=>{qn===void 0&&(qn=window.setTimeout(()=>{qn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Yo&&Kn()},300))}),zn.observe(document.body,{childList:!0,subtree:!0}))},ws=()=>{Rb(),Kn()};var ks="ws-support-modal",Es="ws-support-toast",Fb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ts="ws-support-submitter-name",Ss="ws-support-submitter-email",Cs="ws-support-submitter-role",Nb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ve=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),zb=(e,t="success",o)=>{let r=document.getElementById(Es);r&&r.remove();let a=document.createElement("div");a.id=Es;let i=t==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${Ve(e)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${Ve(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},qb=()=>{document.getElementById(ks)?.remove();let e=(localStorage.getItem(Ts)??"").trim(),t=(localStorage.getItem(Ss)??"").trim(),o=(localStorage.getItem(Cs)??"").trim(),r={category:null,title:"",description:"",submitterName:e,submitterEmail:t,submitterRole:o},a=document.createElement("div");a.id=ks,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${Ve(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Ve(e)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Ve(t)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Ve(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ts,r.submitterName),localStorage.setItem(Ss,r.submitterEmail),r.submitterRole&&localStorage.setItem(Cs,r.submitterRole)}catch{}let m=i.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let b=await(await fetch(Fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!b.ok){d(b.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let _=b.ticket_short_id||"submitted";zb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Gb=["/support-ticket","ws-support-modal","ws-support"],Ub=/\/custom-menu-link\//,Yn=!1,As=()=>{if(Yn||!Ub.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Gb.some(s=>i.includes(s))});if(r){Yn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{qb(),Yn=!1},50);return}e<10&&setTimeout(t,150)};t()},$s=!1,Ls=()=>{$s||($s=!0,ae(()=>setTimeout(As,50)),As(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Is="ws-phone-assignments-modal",Ms="ws-phone-assignments-toast",Vb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Wb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",jb=["ACQ","DISPO","TC"],Ds="",Oe=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Kb=(e,t="success",o)=>{document.getElementById(Ms)?.remove();let r=document.createElement("div");r.id=Ms;let a=t==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Oe(e)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Oe(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Yb=(e,t,o)=>{let r=[`<option value="" ${o===Ds?"selected":""}>\u2014 Unassigned \u2014</option>`,...t.map(a=>`<option value="${Oe(a)}" ${o===a?"selected":""}>${Oe(a)}</option>`)].join("");return`<select data-assign="${Oe(e)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Jb=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Xn=async e=>{document.getElementById(Is)?.remove();let t=e||re(),o=document.createElement("div");o.id=Is,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",b=>{b.target===o&&o.remove()}),!t){let b=r.querySelector("#ws-pa-body");b&&(b.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Vb}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(b){c.error("[phone-assignments] GET failed",b);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Oe(b.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:jb,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=b=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${b} found.</div>`,p=s.length?s.map(b=>`<div style="${Jb}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${Oe(b.label||b.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${u.mono};">${Oe(b.e164)}</div>
            </div>
            ${Yb(`num:${b.e164}`,i,l[b.e164]??Ds)}
          </div>`).join(""):d("phone numbers"),m=b=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${b}</div>`,h=r.querySelector("#ws-pa-body");h&&(h.innerHTML=`
    ${m("Numbers \u2192 Team")}
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(b=>{b.addEventListener("change",()=>{let _=b.getAttribute("data-assign")||"",[y,...k]=_.split(":"),x=k.join(":");y==="num"&&(b.value?l[x]=b.value:delete l[x])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let b=h.querySelector("#ws-pa-err"),_=k=>{b&&(b.textContent=k)};_("");let y=h.querySelector("#ws-pa-save");y&&(y.disabled=!0,y.textContent="Saving\u2026",y.style.opacity="0.7");try{let x=await(await fetch(Wb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:l})})).json();if(!x.ok){_(x.error||"Save failed."),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1");return}o.remove(),Kb("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){_(`Network error: ${k.message}`),y&&(y.disabled=!1,y.textContent="Save",y.style.opacity="1")}}))},Xb=["ws-phone-assignments","phone-assignments"],Qb=/\/custom-menu-link\//,Jn=!1,Os=()=>{if(Jn||!Qb.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Xb.some(s=>i.includes(s))});if(r){Jn=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{Xn(i),Jn=!1},50);return}e<10&&setTimeout(t,150)};t()},Hs=!1,Ps=()=>{if(Hs)return;Hs=!0,ae(()=>setTimeout(Os,50)),Os();let e=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Xn()};window.addEventListener("hashchange",e),e(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Xn(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var Rs="powerDialerApp",Zb=".dialer",eh='button[aria-label="Voice Calling"], button[title="Voice Calling"]',th=".dial-item.dial-btn.dial-btn-enabled",We=e=>{for(let t of["pointerdown","mousedown","pointerup","mouseup","click"])try{e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Qn=e=>{let t=(e||"").match(/\+\d{10,15}/);return t?t[0]:null},Fs=()=>{try{let t=window[Rs]?._context?.provides?.emitter;if(t&&typeof t.emit=="function")return t}catch(e){c.debug("[dialer-bridge] getEmitter failed",e)}return null},st=()=>document.querySelector(Zb),Jo=()=>Fs()!==null||st()!==null?!0:!!window[Rs],Xo=(e,t)=>{let o=Fs();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${e}`),!1;try{return o.emit(e,t),!0}catch(r){return c.error(`[dialer-bridge] emit ${e} threw`,r),!1}},Ns=()=>{if(st())return;let e=document.querySelector(eh);e?We(e):c.warn("[dialer-bridge] Voice Calling button not found")},oh=()=>{let e=document.querySelector(".number-list-container")||st();if(!e)return[];let t=[...e.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of t){let i=Qn(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},Bs=()=>{let e=document.querySelector(".number-config .ui-text-sm-medium");if(e){let o=Qn(e.innerText);if(o)return o}let t=document.querySelector(".number-config");return t?Qn(t.innerText):null},zs=e=>{if(Bs()===e)return!0;let t=document.querySelector(".number-config, .dialer-config");t&&We(t);let o=oh().find(r=>r.e164===e);return o?(We(o.el),Bs()===e):(c.warn(`[dialer-bridge] Calling From ${e} not available to this rep`),!1)},qs=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(e=>/local/i.test(e.innerText||""))||null,rh=()=>{let e=qs();return e?!/bg-gray-100/.test(e.className):!1},Gs=e=>{let t=qs();t&&rh()!==e&&We(t)},Us=e=>{let t=e.replace(/[^\d*#+]/g,"");if(Xo("sendDigitToDial",{value:t,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of t){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&We(a)}},Vs=()=>{let e=st();if(!e)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let t=e.querySelector(th)||[...e.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return t?(We(t),!0):Xo("makeCall",{provider:"twilio"})};var Zn=()=>{let e=st();if(!e)return;let t=[...e.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);t?We(t.closest("button")||t):Xo("closeCallBox")},Ws=()=>{Xo("closeCallBox")},js=e=>{let t=!1,o=()=>{let i=st()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(t=!0),t&&l){t=!1;try{e()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var nh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",ah="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ks=["acq","dispo","tc"],Kt={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},jt=null,Ys=null,ih=async(e=!1)=>{let t=re();if(!t)return{};if(!e&&jt&&Ys===t)return jt;try{return jt=(await(await fetch(`${nh}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json())?.config?.numberTeam??{},Ys=t,jt}catch(o){return c.warn("[silo] number-team config load failed",o),jt??{}}},je=null,Js=null,ea=async(e=!1)=>{let t=re(),o=M();if(!t||!o)return[];if(!e&&je&&Js===t)return je;try{let i=(await(await fetch(ah,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(s=>s.id===o);if(i){let s=i.role_keys??[];je=Ks.filter(l=>s.includes(l))}else Ze()?je=[...Ks]:je=[];return Js=t,je}catch(r){return c.warn("[silo] roster load failed",r),je??[]}},Qs=()=>`ws-pd-calling-as:${M()||"anon"}`,Zs=e=>{try{localStorage.setItem(Qs(),e)}catch{}},ta=async()=>{let e=await ea();if(e.length===0)return null;if(e.length===1)return e[0];let t=null;try{t=localStorage.getItem(Qs())}catch{}return t&&e.includes(t)?t:e[0]},Xs=e=>{let t=(e||"").replace(/\D/g,"");return t.length===11&&t[0]==="1"?t.slice(1,4):t.length===10?t.slice(0,3):null},sh=(e,t)=>Object.entries(e).filter(([,o])=>o===t).map(([o])=>o),el=async e=>{let t=await ta();if(!t)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let o=await ih(),r=sh(o,t);if(!r.length)return c.debug(`[silo] ${t} has no numbers; leaving GHL default`),null;let a=Xs(e),i=a?r.find(d=>Xs(d)===a):void 0,s=i||r[0];try{Gs(!1)}catch{}return zs(s)?(c.info(`[silo] ${Kt[t]}: calling ${e} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} (not in this rep's picker?)`),null)};var lh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",tl="data-ws-pd",ol="ws-pd-panel",rl="ws-pd-session",Ke=e=>new Promise(t=>setTimeout(t,e)),Yt=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),dh=e=>{let t=e;for(let o=0;o<8&&t;o++){if(t.querySelector(".crm-opportunities-card-wrapper"))return t;t=t.parentElement}return null},ch=e=>{let t=[e,...Array.from(e.querySelectorAll("*"))];for(let o of t)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return e},ph=e=>{let t=[],o=new Set;for(let r of Array.from(e.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),t.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return t},mh=async e=>{let t=dh(e);if(!t)return[];let o=ch(t),r=-1;for(let a=0;a<60;a++){let i=t.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ke(550)}return o.scrollTop=0,ph(t)},bh=async(e,t)=>{try{let r=await(await fetch(lh,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,contact_id:t})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},hh=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,ra=(e,t,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(ol)?.remove();let r=document.createElement("div");r.id=ol,r.style.cssText=hh;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let i=t.map((p,m)=>`<label data-row="${m}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${m}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Yt(p.name||p.contactId)}</span>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
    ...
    </div>`,r.appendChild(a),document.body.appendChild(r),r.addEventListener("click",p=>{p.target===r&&r.remove()});let s=a.querySelector("#ws-pd-list"),l=a.querySelector("#ws-pd-count"),d=()=>{let p=a.querySelectorAll(".ws-pd-cb:checked").length;l&&(l.textContent=`${p} selected`)};d(),s?.addEventListener("change",d),a.querySelector("#ws-pd-search")?.addEventListener("input",p=>{let m=p.target.value.toLowerCase();a.querySelectorAll("[data-row]").forEach(h=>{let b=(h.textContent||"").toLowerCase();h.style.display=b.includes(m)?"flex":"none"})}),a.querySelector("#ws-pd-all")?.addEventListener("change",p=>{let m=p.target.checked;a.querySelectorAll("[data-row]").forEach(h=>{if(h.style.display==="none")return;let b=h.querySelector(".ws-pd-cb");b&&(b.checked=m)}),d()}),a.querySelector("#ws-pd-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-pd-start")?.addEventListener("click",()=>{let p=[];a.querySelectorAll(".ws-pd-cb:checked").forEach(h=>{let b=Number(h.getAttribute("data-i"));t[b]&&p.push(t[b])});let m=a.querySelector("#ws-pd-auto")?.checked??!0;r.remove(),p.length&&nl(e,p,m)})},nl=async(e,t,o)=>{let r=re();if(!r)return;document.getElementById(rl)?.remove();let a={skip:!1,paused:!1,stopped:!1,advance:!1},i=document.createElement("div");i.id=rl,i.style.cssText=`position:fixed;bottom:24px;left:24px;z-index:100002;width:300px;background:${n.graphite};border:1px solid ${n.steel};border-left:4px solid ${n.emerald};border-radius:${v.md};padding:14px 16px;color:${n.bone};font-family:${u.sans};box-shadow:0 10px 30px rgba(0,0,0,0.5);`,document.body.appendChild(i);let s=(l,d,p)=>{i.innerHTML=`
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${Yt(e)} \xB7 ${d+1} of ${t.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Yt(p)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${Yt(l)}</div>
      ...
      </div>`,i.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Zn()}catch{}i.remove()}),i.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Zn()}catch{}}),i.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),i.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let l=0;l<t.length&&!a.stopped;l++){let d=t[l];a.skip=!1,a.advance=!1,s("Resolving number\u2026",l,d.name);let p=d._phone?{name:d.name,phone:d._phone}:await bh(r,d.contactId);if(a.stopped)break;if(!p||!p.phone){s("No phone on file \u2014 skipping",l,d.name||p?.name||d.contactId),await Ke(1400);continue}let m=p.name||d.name;if(await el(p.phone),a.stopped)break;if(d.contactId&&d.contactId!=="__test__")try{let b=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${d.contactId}`;window.location.pathname!==b&&(history.pushState({},"",b),window.dispatchEvent(new PopStateEvent("popstate")))}catch(h){c.debug("[bulk-dialer] screen-follow nav failed",h)}s(`Calling ${p.phone}\u2026`,l,m);try{Ns(),await Ke(250),Us(p.phone),await Ke(250),Vs()}catch(h){c.error("[bulk-dialer] dial failed",h)}if(await new Promise(h=>{let b=!1,_=()=>{b||(b=!0,y(),h())},y=js(_),k=window.setInterval(()=>{(a.stopped||a.skip)&&(window.clearInterval(k),_())},300)}),a.stopped)break;try{Ws()}catch{}if(l<t.length-1)if(o)for(let h=5;h>0&&!a.stopped&&!a.advance;h--){for(s(`Next call in ${h}s\u2026`,l,m);a.paused&&!a.stopped&&!a.advance;)await Ke(200);if(a.advance||a.stopped)break;await Ke(1e3)}else for(s("Ready \u2014 press Call Next",l,m);!a.advance&&!a.stopped;)await Ke(200)}a.stopped||(i.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${t.length} contact${t.length===1?"":"s"} dialed.</div>`,setTimeout(()=>i.remove(),5e3))},na='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',aa=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},uh=()=>{if(mo()!=="opportunity-list"||!aa()||!Jo())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(t=>{if(t.querySelector(`[${tl}]`))return;let o=t.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(tl,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${na}<span>DIAL</span>`,a.addEventListener("click",async i=>{i.stopPropagation(),i.preventDefault();let s=a.querySelector("span"),l=s?.textContent||"DIAL";s&&(s.textContent="Loading\u2026"),a.style.opacity="0.7";try{let d=await mh(t);ra(r,d)}catch(d){c.error("[bulk-dialer] harvest failed",d)}finally{s&&(s.textContent=l),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},lt=null,oa,al=()=>{window.WS_CRM_PD_TEST=t=>void nl("Verification",[{oppId:"",contactId:"__test__",name:`Test ${t}`,_phone:t}],!1);let e=()=>{oa!==void 0&&window.clearTimeout(oa),oa=window.setTimeout(uh,400)};ae(t=>{t==="opportunity-list"?(e(),lt||(lt=new MutationObserver(e),lt.observe(document.body,{childList:!0,subtree:!0}))):lt&&(lt.disconnect(),lt=null)})};var il="ws-crm-pd-contacts-btn",vh=e=>new Promise(t=>setTimeout(t,e)),_h=e=>{let t=e.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return t?`+1${t[1]}${t[2]}${t[3]}`:""},gh=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,ia=(e,t)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(t){let d=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(d&&d.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||e.has(a))return;let i=(r?.textContent||"").replace(/\s+/g," ").trim(),s=_h(o.textContent||""),l=i&&i!=="-"?i:s||a;e.set(a,{oppId:"",contactId:a,name:l,_phone:s||void 0})})},yh=async e=>{let t=new Map;if(e)return ia(t,!0),[...t.values()];let o=document.querySelector(".tabulator-tableholder");if(ia(t,!1),!o)return[...t.values()];let r=-1,a=-1,i=0;for(let s=0;s<200&&(ia(t,!1),t.size===a?i++:(i=0,a=t.size),!(s>0&&o.scrollTop===r&&i>=2));s++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await vh(220);return o.scrollTop=0,[...t.values()]},fh=()=>{if(mo()!=="contact-list"||!aa()||!Jo()||document.getElementById(il))return;let e=document.querySelector("#views-bar .bar");if(!e)return;let t=document.createElement("button");t.id=il,t.type="button",t.title="Power Dialer: call through this list, or the rows you've checked",t.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${u.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,t.innerHTML=`${na}<span>Power Dialer</span>`;let o=t.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=t.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),t.style.setProperty("border-color",n.emerald,"important"),t.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let i=t.querySelector("span"),s=i?.textContent||"Power Dialer";i&&(i.textContent="Loading\u2026"),t.style.opacity="0.7";try{let l=gh(),d=await yh(l);ra(l?"Selected contacts":"Smart list",d,{one:"contact",many:"contacts"})}catch(l){c.error("[bulk-dialer-contacts] harvest failed",l)}finally{i&&(i.textContent=s),t.style.opacity="1"}}),e.appendChild(t)},dt=null,sa,sl=!1,ll=()=>{if(sl)return;sl=!0;let e=()=>{sa!==void 0&&window.clearTimeout(sa),sa=window.setTimeout(fh,400)};ae(t=>{t==="contact-list"?(e(),dt||(dt=new MutationObserver(e),dt.observe(document.body,{childList:!0,subtree:!0}))):dt&&(dt.disconnect(),dt=null)})};var Qo="ws-calling-as-chip",xh=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},la=!1,dl=async()=>{if(!la&&xh()&&!document.getElementById(Qo)){la=!0;try{let e=await ea();if(!e.length||document.getElementById(Qo))return;let t=await ta()??e[0],o=e.length>1,r=document.createElement("div");r.id=Qo,r.style.cssText="position:fixed;bottom:60px;right:20px;z-index:99998;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:8px;padding:7px 12px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${u.sans};font-size:12px;box-shadow:0 6px 18px rgba(0,0,0,0.35);cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${u.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Kt[t]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let i=s=>{let l=a.querySelector(".ws-ca-team");l&&(l.textContent=Kt[s])};if(o){let s=document.createElement("div");s.style.cssText=`position:absolute;bottom:calc(100% + 6px);right:0;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;`;let l=()=>{s.innerHTML="",e.forEach(d=>{let p=document.createElement("div"),m=d===t;p.style.cssText=`padding:9px 14px;font-family:${u.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,p.textContent=Kt[d],p.addEventListener("mouseenter",()=>{d!==t&&(p.style.background=n.steel)}),p.addEventListener("mouseleave",()=>{d!==t&&(p.style.background="transparent")}),p.addEventListener("click",h=>{h.stopPropagation(),t=d,Zs(d),i(d),l(),s.style.display="none"}),s.appendChild(p)})};l(),r.appendChild(s),a.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="block"?"none":"block"}),document.addEventListener("click",()=>{s.style.display="none"})}document.body.appendChild(r),c.info(`[calling-as] chip mounted (roles=${e.join(",")}, active=${t}, multi=${o})`)}catch(e){c.error("[calling-as] build failed",e)}finally{la=!1}}},cl=()=>{dl(),ae(()=>{document.getElementById(Qo)||dl()})};var wh="#12161D",kh="#EDEEF0",pl=e=>{let o=getComputedStyle(e).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],i=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&i>=230},ml=e=>{e.style.setProperty("background-color",wh,"important"),e.style.setProperty("color",kh,"important")},Eh=()=>{for(let e of Array.from(document.body.children)){if(e.tagName!=="DIV")continue;let t=e;if(!(t.id||t.className)&&getComputedStyle(t).position==="fixed")return t}return null},Th=e=>{pl(e)&&ml(e);for(let t of Array.from(e.querySelectorAll("*")))pl(t)&&ml(t)},da=null,Jt=null,hl=()=>{Jt&&(Jt.disconnect(),Jt=null),da=null},Sh=e=>{if(da===e)return;hl(),da=e;let t=!1,o=()=>{t=!1;try{Th(e)}catch(a){c.debug("[dialer-theme] paint failed",a)}},r=()=>{t||(t=!0,requestAnimationFrame(o))};Jt=new MutationObserver(r),Jt.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),c.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},bl=!1,ul=()=>{if(bl)return;bl=!0;let e=()=>{let o=Eh();o?Sh(o):hl()};e(),new MutationObserver(e).observe(document.body,{childList:!0})};var Ch="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ah="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",$h="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",gl="tc_closing_agent",Lh="tc_closing_office",he="ws-crm-closing-agent-picker-button",yl="ws-crm-closing-agent-picker-modal",Ih=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mh=/\/v2\/location\/([A-Za-z0-9]+)/,Zt=()=>{let e=window.location.pathname,t=e.match(Ih);if(!t)return null;let o=e.match(Mh);return{oppId:t[1],locationId:o?o[1]:null}},_a=async e=>{let t=await fetch(Ch,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,query:e.query??"",contact_id:e.contactId??null,contact_type:e.contactType??null,limit:e.limit??20}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},vl=async e=>{let t=await fetch(Ah,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,opp_id:e.oppId,field_key:e.fieldKey,value:e.value}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},Oh=async(e,t)=>{try{let o=await fetch($h,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,field_key:gl}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await _a({tenantId:t,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Ye=null,Hh=60*60*1e3,ga=e=>`ws-crm-to-cache:${e}`,fl=e=>{try{let t=window.localStorage.getItem(ga(e));if(!t)return null;let o=JSON.parse(t);return!o.ts||Date.now()-o.ts>Hh||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},xl=(e,t,o)=>{try{window.localStorage.setItem(ga(e),JSON.stringify({contactId:t,contactName:o,ts:Date.now()}))}catch{}},Dh=e=>{try{window.localStorage.removeItem(ga(e))}catch{}},ba="ws-crm-closing-agent-field-link",Ph=()=>{let e=document.querySelector(".crm-opportunities-modal");e&&(e.querySelectorAll(`.${ba}`).forEach(t=>t.remove()),e.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(t=>{t.style.removeProperty("color"),t.style.removeProperty("caret-color"),t.style.removeProperty("visibility"),delete t.dataset.wsClosingAgentDecorated}))},ca=!1,ya=async e=>{if(ca)return;let t=wl();if(!t)return;let o=(t.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(t.dataset.wsClosingAgentDecorated!==o){ca=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await _a({tenantId:e,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),ha(a.id,a.name,e);let i=document.getElementById(he);if(i){He(i,{status:"linked",contactName:a.name});let s=Zt();s&&xl(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{ca=!1}}},Bh=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,wl=()=>{let t=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of t){let p=(d.textContent||"").trim();Bh.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let h=d.getAttribute(m);h&&/Title\s+Officer/i.test(h)&&a.push({tag:d.tagName.toLowerCase(),attr:m,value:h})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},ha=(e,t,o)=>{let r=wl();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==e){a&&r.parentElement?.querySelectorAll(`.${ba}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=e,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=ba,l.href=`/v2/location/${o}/contacts/detail/${e}`,l.textContent=t,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Zo=()=>{document.getElementById(yl)?.remove()},Rh=e=>{Zo();let t=document.createElement("div");t.id=yl,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),t.addEventListener("click",p=>{p.target===t&&Zo()}),i?.addEventListener("click",Zo);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await _a({tenantId:e.locationId,query:p,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",m.results.forEach(h=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,b.innerHTML=`
          <div style="font-weight: 500;">${er(h.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${er(h.email||"(no email)")} \xB7 ${er(h.phone||"no phone")}
            ${h.companyName?` \xB7 ${er(h.companyName)}`:""}
          </div>
        `,b.addEventListener("mouseenter",()=>{b.style.background=n.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",()=>{Zo(),e.onPick(h)}),a.appendChild(b)})}catch(m){c.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let p=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(p)},250)})},er=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),He=(e,t)=>{let o=e.querySelector(".ws-top-label"),r=e.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,p="pointer";switch(t.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,p="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=t.contactName?`Closing Agent: ${t.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,p="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),e.style.background=l,e.style.borderColor=d,e.style.color=s,e.style.cursor=p},Fh=(e,t)=>{let o=document.createElement("button");o.id=he,o.type="button",o.dataset.oppId=e,o.style.cssText=O,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};He(o,r);let a=fl(e);return a&&(r={status:"linked",contactName:a.contactName},He(o,r),Ye={oppId:e,contactId:a.contactId,contactName:a.contactName,tenantId:t}),(async()=>{let s=await Oh(e,t);s?(r={status:"linked",contactName:s.name},He(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},ha(s.id,s.name,t)):a||(r={status:"empty"},He(o,r),Ye?.oppId===e&&(Ye=null),Ph(),Dh(e))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rh({oppId:e,locationId:t,onPick:async s=>{r={status:"saving"},He(o,r);try{let l=await vl({tenantId:t,oppId:e,fieldKey:gl,value:s.id});if(!l.ok)throw new Error(l.error??"Save failed");s.companyName&&s.companyName.trim()&&await vl({tenantId:t,oppId:e,fieldKey:Lh,value:s.companyName.trim()}),r={status:"linked",contactName:s.name},He(o,r),Ye={oppId:e,contactId:s.id,contactName:s.name,tenantId:t},xl(e,s.id,s.name),ha(s.id,s.name,t),as(e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},He(o,r)}}})}),o},Nh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],zh=async()=>{for(let e of Nh)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Xt=!1,or=async()=>{if(!Xt){Xt=!0;try{await qh()}finally{Xt=!1}}},qh=async()=>{let e=Zt();if(!e||!e.locationId){document.getElementById(he)?.remove(),document.getElementById(`${he}-wrap`)?.remove(),tr();return}let t=document.getElementById(he);if(t&&t.dataset.oppId===e.oppId){let d=P();d!==null&&d!=="Transaction Coordination"&&(t.remove(),document.getElementById(`${he}-wrap`)?.remove(),tr());return}t&&(t.remove(),document.getElementById(`${he}-wrap`)?.remove());let o=P();if(o!==null&&o!=="Transaction Coordination")return;let r=await zh();if(!r||!(fl(e.oppId)!==null||Ye!==null&&Ye.oppId===e.oppId)&&await W()!=="Transaction Coordination")return;let i=Zt();if(!i||i.oppId!==e.oppId||!i.locationId)return;let s=Fh(e.oppId,i.locationId),l=document.createElement("span");l.id=`${he}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${e.oppId}`),Gh(e.oppId),ya(i.locationId)},Qt=null,ua=null,va=null,tr=()=>{Qt?.disconnect(),Qt=null,ua=null,va=null},Gh=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Qt&&ua===e&&va===t||(tr(),ua=e,va=t,Qt=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==e||!o.locationId){tr();return}document.getElementById(he)||or(),ya(o.locationId)}),Qt.observe(t,{childList:!0,subtree:!0})))},pa=null,ma,Uh=()=>{pa||(pa=new MutationObserver(()=>{ma===void 0&&(ma=window.setTimeout(()=>{ma=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(he);e&&!t&&!Xt&&or()},300))}),pa.observe(document.body,{childList:!0,subtree:!0}))},_l,Vh=()=>{_l===void 0&&(_l=window.setInterval(()=>{let e=Zt();if(!e||!e.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(he)&&!Xt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),or()),ya(e.locationId)},2e3))},kl=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Uh(),Vh(),or()};var Wh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Pe="ws-crm-manage-team-cta",El="ws-crm-manage-team-modal",jh=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Tl={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Kh={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Sl=()=>{let e=window.location.pathname.match(jh);return e?{tenantId:e[1]}:null},nr=async e=>{let t=await fetch(Wh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!t.ok){let o="";try{o=await t.text()}catch{}throw new Error(`Team.Manage HTTP ${t.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await t.json()},se=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),De=e=>se(e),fa="ws-crm-manage-team-toast",ka=(e,t="info",o=4e3)=>{document.getElementById(fa)?.remove();let r=t==="success"?n.emerald:t==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=fa,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=e,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(fa)===a&&a.remove()},o)},xa=()=>{document.getElementById(El)?.remove()},Yh=(e,t)=>{let o=Kh[e]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${se(t)}</span>
  `},Jh=(e,t)=>{let o=[e.first_name,e.last_name].filter(Boolean).join(" ")||"(no name)",r=e.roles.map(s=>Yh(s.key,s.display)).join(""),a=t?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=t?"":'title="Manager-only action"';return`
    <div data-user-id="${De(e.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${se(e.email)}${e.phone?` &middot; ${se(e.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${De(e.email)}" data-user-id="${De(e.id)}" data-name="${De(o)}" data-current-roles="${De(e.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${De(e.email)}" data-name="${De(o)}" data-role-count="${De(String(e.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Xh=(e,t)=>e.length===0?`
  ...
  `+e.map(r=>Jh(r,t)).join(""),ar=async e=>{xa();let t=document.createElement("div");t.id=El,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,t.addEventListener("click",d=>{d.target===t&&xa()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,t.appendChild(o),document.body.appendChild(t),o.querySelector("#ws-team-close")?.addEventListener("click",xa);let r;try{r=await nr({tenant_id:e,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          Failed to load roster: ${se(d.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let d=o.querySelector("#ws-team-content");d&&(d.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          ${se(r.error||"Unknown error loading roster")}
        </div>
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Xh(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Qh(e)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;Zh(e,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let m=p.currentTarget;eu(e,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Qh=e=>{let t="ws-crm-manage-team-add-modal";document.getElementById(t)?.remove();let o=document.createElement("div");o.id=t,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(i),document.body.appendChild(o),i.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),i.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let s=(i.querySelector("#ws-team-add-first")?.value||"").trim(),l=(i.querySelector("#ws-team-add-last")?.value||"").trim(),d=(i.querySelector("#ws-team-add-email")?.value||"").trim(),p=(i.querySelector("#ws-team-add-mobile")?.value||"").trim(),m=(i.querySelector("#ws-team-add-role")?.value||"").trim(),h=i.querySelector("#ws-team-add-error"),b=i.querySelector("#ws-team-add-submit");if(!s||!l||!d||!p||!m){h&&(h.textContent="All fields are required.");return}b&&(b.disabled=!0,b.textContent="Adding\u2026",b.style.opacity="0.7"),h&&(h.textContent="");try{let _=await nr({tenant_id:e,action:"add",first_name:s,last_name:l,email:d,mobile:p,role:m,triggered_by_user_id:M()});if(!_.ok){h&&(h.textContent=_.error||"Failed to add employee"),b&&(b.disabled=!1,b.textContent="Add Employee",b.style.opacity="1");return}o.remove(),ka(`Added ${s} ${l} as ${Tl[m]||m}.`,"success"),await ar(e)}catch(_){h&&(h.textContent=_.message),b&&(b.disabled=!1,b.textContent="Add Employee",b.style.opacity="1")}})},Zh=(e,t)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,r.addEventListener("click",s=>{s.target===r&&r.remove()});let a=document.createElement("div");a.style.cssText=`
    ...
    color: ${n.bone};
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
  `;let i=s=>{let l=t.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${se(Tl[s])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${se(t.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${se(t.email)}</div>
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${se(t.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${se(t.email)} will be removed from all ${t.roleCount} role${t.roleCount===1?"":"s"}.
    </div>
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await nr({tenant_id:e,action:"remove",email:t.email,triggered_by_user_id:M()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),ka(`Removed ${t.name} from the team.`,"success"),await ar(e)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},tu=89,ou=93,ru=310,nu=34,au=14,iu=14,su=3,rr=e=>{let t=document.querySelector('iframe[name="settings-app"]');if(!t){e.style.right="24px";return}let o=t.getBoundingClientRect(),r=window.innerWidth-o.right+tu;e.style.right=`${Math.max(r,16)}px`},lu=e=>{let t=document.createElement("button");return t.id=Pe,t.type="button",t.style.cssText=`
    position: fixed;
    top: ${ou}px;
    right: 24px;
    width: ${ru}px;
  ...
  `,t.addEventListener("click",()=>{ar(e)}),rr(t),setTimeout(()=>rr(t),200),setTimeout(()=>rr(t),800),window.addEventListener("resize",()=>rr(t)),t},wa=!1,du=()=>{if(!wa){wa=!0;try{let e=Sl();if(!e){document.getElementById(Pe)?.remove(),document.getElementById(`${Pe}-floater`)?.remove();return}let t=document.getElementById(Pe);if(t&&t.dataset.tenantId===e.tenantId)return;document.getElementById(`${Pe}-floater`)?.remove();let o=document.createElement("div");o.id=`${Pe}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=lu(e.tenantId);r.dataset.tenantId=e.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${e.tenantId}`)}finally{wa=!1}}},Cl=()=>{if(!Sl()){document.getElementById(Pe)?.remove(),document.getElementById(`${Pe}-floater`)?.remove();return}du()};var cu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Sa="ws-crm-prepare-contract-button",Al="ws-crm-prepare-contract-menu",fe="ws-crm-prepare-contract-modal",$l="ws-crm-modal-date-style",ke="https://services.leadconnectorhq.com",Dl=()=>{if(document.getElementById($l))return;let e=document.createElement("style");e.id=$l,e.textContent=`
  ...
  `,document.head.appendChild(e)},Ca="__WS_CRM_CAPTURED_AUTH",pu=50*60*1e3,dr=()=>{try{let e=localStorage.getItem(Ca);if(!e)return null;let t=JSON.parse(e);return t?.authorization?Date.now()-(t.capturedAt||0)>pu?(localStorage.removeItem(Ca),null):t:null}catch{return null}},mu=e=>{try{localStorage.setItem(Ca,JSON.stringify(e))}catch{}},pt=()=>{let e=dr(),t=window;if(t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{},t.__WS_CRM_DIAG.authChecks=(t.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${t.__WS_CRM_DIAG.authChecks}]`,e?`present (captured ${Date.now()-e.capturedAt}ms ago, ${e.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!e)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:e.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return e.tokenId&&(o["token-id"]=e.tokenId),o},Ll=(e,t)=>new Promise(o=>{let r=Date.now(),a=()=>{if((dr()?.capturedAt??0)>e)return o(!0);if(Date.now()-r>t)return o(!1);window.setTimeout(a,250)};a()}),ct=async(e,t={},o=2)=>{let r=dr()?.capturedAt??0,a;try{a={...pt(),...t.headers??{}}}catch(s){if(o>0&&await Ll(r,4e3))return ct(e,t,o-1);throw s}let i=await fetch(e,{...t,headers:a});return i.status!==401||o<=0?i:await Ll(r,4e3)?ct(e,t,o-1):i},Il=!1,bu=()=>{if(Il)return;Il=!0;let e=window;e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let t=(l,d,p)=>{e.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let m=d.authorization||d.Authorization;if(!m){e.__WS_CRM_DIAG.fetchCalls+e.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?e.__WS_CRM_DIAG.fetchAuthSeen++:e.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,b=dr()?.authorization;mu({authorization:m,tokenId:h,capturedAt:Date.now()}),b!==m&&(e.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${m.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){e.__WS_CRM_DIAG.fetchCalls++;let m=p.headers;!m&&l[0]instanceof Request&&(m=l[0].headers);let h={};if(m instanceof Headers)m.forEach((b,_)=>h[_.toLowerCase()]=b);else if(Array.isArray(m))m.forEach(([b,_])=>h[b.toLowerCase()]=_);else if(m&&typeof m=="object")for(let b of Object.keys(m))h[b.toLowerCase()]=m[b];t(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(e.__WS_CRM_DIAG.xhrCalls++,t(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Pl=()=>{let e=D();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},hu=e=>{let t=e.dataset;return t.tenantId&&t.contactId?{tenantId:t.tenantId,contactId:t.contactId,oppId:t.oppId||void 0}:t.tenantId&&t.oppId?{tenantId:t.tenantId,contactId:"",oppId:t.oppId}:Pl()},uu=e=>{let t=(e||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(t)||/assignment.*(contract|agreement)/i.test(t)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(t)||/purchase.*(contract|agreement)/i.test(t)?"PA":"passthrough"},Bl="__WS_CRM_TEMPLATES_CACHE_V1",vu=24*60*60*1e3,Ml=e=>{try{let t=window.localStorage.getItem(Bl);if(!t)return null;let o=JSON.parse(t);return o.tenantId!==e||Date.now()-o.cachedAt>vu?null:o.templates}catch{return null}},_u=(e,t)=>{try{let o={tenantId:e,templates:t,cachedAt:Date.now()};window.localStorage.setItem(Bl,JSON.stringify(o))}catch{}},gu=async e=>{let t=`${ke}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(e)}&skip=0&limit=10`,o;try{o=await ct(t,{method:"GET"})}catch(s){let l=Ml(e);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Ml(e);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:uu(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&_u(e,i),i},yu=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await ct(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},fu=async(e,t)=>{let o=await ct(`${ke}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ke}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET",headers:pt()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let m=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-m})},xu=async e=>{let t=await fetch(cu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,template_id:e.templateId,template_type:e.templateType,opp_id:e.oppId,closing_date:e.closingDate,buyer_earnest_due_date:e.buyerEarnestDueDate,lender_source:e.lenderSource,triggered_by_user_id:e.userId,overrides:e.overrides}),credentials:"omit"});if(!t.ok)throw new Error(`Contract.Stage HTTP ${t.status}`);return await t.json()},wu=async(e,t,o)=>{let r=`${ke}/proposals/templates/to-proposal/${e}/${t}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:pt()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},ku=async(e,t)=>{let o=await fetch(`${ke}/proposals/document/${t}?locationId=${encodeURIComponent(e)}`,{method:"GET",headers:pt()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${t} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Eu=async e=>{let t=await fetch(`${ke}/contacts/${e}`,{method:"GET",headers:pt()});if(!t.ok){let a=await t.text().catch(()=>"");throw new Error(`GET contact ${e} HTTP ${t.status} ${a.slice(0,200)}`)}let o=await t.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Tu=async(e,t,o,r)=>{let a;try{a=await ku(e,t)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Eu(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||e,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},b=await fetch(`${ke}/proposals/document/${t}`,{method:"PUT",headers:{...pt(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!b.ok){let _=await b.text().catch(()=>"");return{ok:!1,status:b.status,body:_}}return{ok:!0}},Su=(e,t)=>{let o=`/v2/location/${e}/payments/proposals-estimates/edit/${t}`;window.location.href=o},sr="__WS_CRM_PENDING_INSTRUCTIONS",Cu=60*1e3,Au=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],$u=e=>{let t=(e||"").toLowerCase();for(let o of Au)if(t.includes(o.matches.toLowerCase()))return o;return null},Lu=(e,t,o)=>{try{let r={proposalId:e,title:t,bodyHtml:o,ts:Date.now()};localStorage.setItem(sr,JSON.stringify(r))}catch{}},Iu=()=>{try{let e=localStorage.getItem(sr);if(!e)return null;let t=JSON.parse(e);return!t?.proposalId||!t?.title||!t?.bodyHtml||Date.now()-(t.ts||0)>Cu?(localStorage.removeItem(sr),null):t}catch{return null}},Mu=()=>{try{localStorage.removeItem(sr)}catch{}},Ou=(e,t)=>{document.getElementById(fe)?.remove();let o=document.createElement("div");o.id=fe,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Hu=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Du=()=>{let e=window.location.pathname.match(Hu);if(!e)return;let t=e[1],o=Iu();o&&o.proposalId===t&&(Mu(),window.setTimeout(()=>{Ou(o.title,o.bodyHtml)},600))},Ol="ws-crm-prepare-contract-toast",Y=(e,t="info",o=4e3)=>{document.getElementById(Ol)?.remove();let r=document.createElement("div");r.id=Ol;let a=t==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=e,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Hl=(e,t)=>new Promise(o=>{document.getElementById(fe)?.remove();let r=document.createElement("div");r.id=fe,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let a=document.createElement("div");a.style.cssText=`
      ...
      color: ${n.bone};
      box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=e.map(d=>`
    ...
    `,r.appendChild(a),document.body.appendChild(r);let l=d=>{r.remove(),o(d)};r.addEventListener("click",d=>{d.target===r&&l(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>l(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.borderColor=n.emerald,d.style.background=n.graphite}),d.addEventListener("mouseleave",()=>{d.style.borderColor=n.steel,d.style.background=n.slate}),d.addEventListener("click",p=>{p.stopPropagation(),p.preventDefault();let m=d.dataset.oppId||"";m&&l(m)})})}),Pu=({tenantId:e,contactId:t,template:o,staged:r})=>{document.getElementById(fe)?.remove(),Dl();let a=r.debug||{},i=typeof a.propertyAddress=="string"?a.propertyAddress:"",s=typeof a.sellerName=="string"?a.sellerName:"",l=typeof a.purchasePrice=="number"?a.purchasePrice:0,d=typeof a.emd=="number"?a.emd:0,p=typeof a.cashAtClose=="number"?a.cashAtClose:l-d,m=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),h=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),b=typeof a.additionalTerms=="string"?a.additionalTerms:"",_=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",y=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",k=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],x=document.createElement("div");x.id=fe,x.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,B=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${ye(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${f}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ye(s)}" placeholder="Seller name" style="${C}" />
      </div>
      <div style="${f}">
      ...
      <div style="${f}">
        ...
        <div style="${T}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-cash-at-close" type="number" min="0" step="0.01" value="${p}" style="${S}" />
        </div>
      </div>
      <div style="${f}">
        <div style="${w}">Days to Close</div>
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ye(m)}" placeholder="e.g. 30" style="${C}" />
      </div>
      <div style="${f}">
        <div style="${w}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${ye(h)}" placeholder="e.g. 10" style="${C}" />
      </div>
      <div style="${f}">
        <div style="${w}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${I}">${B(_)}</select>
      </div>
      <div style="${f}">
        <div style="${w}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${I}">${B(y)}</select>
      </div>
      <div style="${f} align-items: flex-start;">
        <div style="${w}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${C} resize: vertical; min-height: 60px; font-family: ${u.sans};">${te(b)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,x.appendChild(g),document.body.appendChild(x);let G=g.querySelector("#ws-pc-purchase-price"),z=g.querySelector("#ws-pc-emd"),N=g.querySelector("#ws-pc-cash-at-close"),R=!1;N?.addEventListener("input",()=>{R=!0});let Ee=()=>{if(R)return;let V=Number(G?.value||0),J=Number(z?.value||0);N&&(N.value=String(Math.max(0,V-J)))};G?.addEventListener("input",Ee),z?.addEventListener("input",Ee);let Te=()=>x.remove();x.addEventListener("click",V=>{V.target===x&&Te()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",Te);let ee=g.querySelector("#ws-pc-submit"),oe=g.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){oe&&(oe.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let V=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(G?.value||0),ht=Number(z?.value||0),ut=Number(N?.value||0),vt=(g.querySelector("#ws-pc-days-to-close")?.value??"").trim(),_t=(g.querySelector("#ws-pc-inspection-days")?.value??"").trim(),gt=(g.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Qe=(g.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),yt=(g.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),ht!==d&&(X.emd=ht),ut!==p&&(X.cashAtClose=ut),vt!==m&&(X.daysToClose=vt),_t!==h&&(X.inspectionDays=_t),gt!==b&&(X.additionalTerms=gt),Qe!==_&&(X.currentOccupancy=Qe),yt!==y&&(X.occupancyAtClose=yt),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),ee.textContent="Saving\u2026";let fr=M(),xr=await lr({tenantId:e,contactId:t,template:o,userId:fr,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",xr),ee.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await La(e,t,o,Q)}catch(V){ee.disabled=!1,ee.textContent="Open Contract",oe&&(oe.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},Bu=({tenantId:e,contactId:t,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(fe)?.remove(),Dl();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",m=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",h=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,b=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,y=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",x=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",g=s,w=l,C="",S=document.createElement("div");S.id=fe,S.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${G}">
        ...
        <div style="${B}">${te(p||"(set on Property record)")}</div>
      </div>
      <div style="${G}">
        <div style="${f}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${ye(m)}" placeholder="Seller name" style="${T}" />
      </div>
      <div style="${G}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${ye(x)}" placeholder="Buyer's entity / LLC name" style="${T}" />
      </div>
      <div style="${G}">
        <div style="${f}">Assignment Price</div>
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${h}" style="${I}" />
        </div>
      </div>
      <div style="${G}">
        ...
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${b}" style="${I}" />
        </div>
      </div>
      <div style="${G}">
        ...
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${_}" style="${I}" />
        </div>
      </div>
      <div style="${G}">
        <div style="${f}">Closing Office</div>
        <input id="ws-pc-closing-office" type="text" value="${ye(k)}" placeholder="Title company" style="${T}" />
      </div>
      <div style="${G}">
        <div style="${f}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${ye(g)}" style="${T}" />
      </div>
      <div style="${G}">
        <div style="${f}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${ye(w)}" style="${T}" />
      </div>
      <div style="${G}">
  ...
  `,S.appendChild(E),document.body.appendChild(S);let N=E.querySelector("#ws-pc-assignment-price"),R=E.querySelector("#ws-pc-assignment-fee"),Ee=!1;R?.addEventListener("input",()=>{Ee=!0});let Te=()=>{if(Ee)return;let J=Number(N?.value||0);R&&(R.value=String(Math.max(0,J-y)))};N?.addEventListener("input",Te);let ee=()=>S.remove();S.addEventListener("click",J=>{J.target===S&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),ht=Number(N?.value||0),ut=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),vt=Number(R?.value||0),_t=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),gt=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Qe=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),yt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Qe){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==m&&(Q.sellerName=J),ht!==h&&(Q.assignmentPrice=ht),ut!==b&&(Q.buyerEMD=ut),vt!==_&&(Q.assignmentFee=vt),_t!==k&&(Q.closingOffice=_t),gt!==x&&(Q.buyerCompanyName=gt);let fr=Qe!==g||yt!==w||X!==C,xr=Object.keys(Q).length>0||fr,wr=a;xr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",wr=await lr({tenantId:e,contactId:t,template:o,oppId:r,closingDate:Qe,buyerEarnestDueDate:yt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",wr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Na=wr?.debug?.propertyAddress||p,xd=Na?`${Na} - Assignment Agreement`:void 0;await La(e,t,o,xd),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},lr=async e=>{c.info(`[prepare-contract] staging \u2014 template "${e.template.name}" (${e.template.type})`);let t=await xu({tenantId:e.tenantId,contactId:e.contactId,templateId:e.template.id,templateType:e.template.type,oppId:e.oppId,closingDate:e.closingDate,buyerEarnestDueDate:e.buyerEarnestDueDate,lenderSource:e.lenderSource,userId:e.userId,overrides:e.overrides});if(c.info(`[prepare-contract] stage response: ok=${t.ok}`,t),!t.ok)throw new Error(t.error||"Contract.Stage returned not ok");return t},La=async(e,t,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${t}`);let a=await wu(e,o.id,t);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${t} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Tu(e,a,t,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=$u(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Lu(a,s.title,s.bodyHtml)),Su(e,a)},Ru=async e=>{let t=hu(e);if(!t){Y("Could not resolve contact context.","error");return}document.getElementById(Al)?.remove();let o=document.createElement("div");o.id=Al,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,e.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==e&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await gu(t.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=M();try{if(i.type==="AA"){let m;if(t.oppId)m=t.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let g;try{g=await fu(t.tenantId,t.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)m=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let w=await Hl(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}m=w,c.info(`[prepare-contract] picked MT opp ${m}`)}}let h=g=>{let w=g.getFullYear(),C=String(g.getMonth()+1).padStart(2,"0"),S=String(g.getDate()).padStart(2,"0");return`${w}-${C}-${S}`},b=g=>{let w=new Date;return w.setDate(w.getDate()+g),h(w)},_=b(45),y=b(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await lr({tenantId:t.tenantId,contactId:t.contactId,template:i,oppId:m,closingDate:_,buyerEarnestDueDate:y,userId:p})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let x=t.contactId||k.contact_id||"";if(!x){Y("Could not resolve buyer contact for this opp.","error",6e3);return}Bu({tenantId:t.tenantId,contactId:x,template:i,oppId:m,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:y})}else if(i.type==="PA"){if(!t.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await yu(t.tenantId,t.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(m.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(m.length===1)h=m[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let _=await Hl(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}h=_,c.info(`[prepare-contract] picked ACQ opp ${h}`)}Y("Reading contract data\u2026","info",2500);let b;try{b=await lr({tenantId:t.tenantId,contactId:t.contactId,template:i,oppId:h,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Pu({tenantId:t.tenantId,contactId:t.contactId,template:i,staged:b})}else{if(!t.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await La(t.tenantId,t.contactId,i)}catch(m){Y(`Failed to open contract: ${m.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){c.warn("[prepare-contract] picker click handler failed:",m),Y(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(s)}},Rl=()=>{let e=document.createElement("button");return e.id=Sa,e.type="button",e.style.cssText=`${O} position: relative; order: 5;`,e.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,e.addEventListener("mouseenter",()=>{e.style.borderColor=n.emerald}),e.addEventListener("mouseleave",()=>{e.style.borderColor=n.steel}),e.addEventListener("click",t=>{t.stopPropagation(),Ru(e)}),e},Fu="ws-crm-contact-actions-bar",Nu=async()=>{let e=Pl();if(!e){document.getElementById(Sa)?.remove();return}let t=null;try{t=await $(`#${Fu}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!t)return;let o=document.getElementById(Sa);if(o){if(o.dataset.contactId===e.contactId)return;o.remove()}let r=Rl();r.dataset.contactId=e.contactId,r.dataset.tenantId=e.tenantId,t.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${e.contactId}`)},Je="ws-crm-prepare-contract-button-opp",eo=`${Je}-wrap`,zu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,qu=/\/v2\/location\/([A-Za-z0-9]+)/,Gu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Aa=()=>{let e=window.location.pathname,t=e.match(zu);if(!t)return null;let o=e.match(qu);return o?{oppId:t[1],tenantId:o[1]}:null},Uu=async()=>{for(let e of Gu)try{let t=await $(e,{timeoutMs:2e3});if(t)return t}catch{}return null},ir=!1,to=null,$a=null,Ea=null,Ta,oo=()=>{to?.disconnect(),to=null,$a=null},Vu=e=>{if(to&&$a===e)return;oo();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&($a=e,to=new MutationObserver(()=>{let o=Aa();if(!o||o.oppId!==e){oo();return}let r=P();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Je)?.remove(),document.getElementById(eo)?.remove(),oo();return}document.getElementById(Je)||Fl()}),to.observe(t,{childList:!0,subtree:!0}))},Wu=()=>{Ea||(Ea=new MutationObserver(()=>{Ta===void 0&&(Ta=window.setTimeout(()=>{Ta=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(Je);e&&!t&&!ir&&Fl()},300))}),Ea.observe(document.body,{childList:!0,subtree:!0}))},Fl=async()=>{if(!ir){ir=!0;try{let e=Aa();if(!e){document.getElementById(Je)?.remove(),document.getElementById(eo)?.remove(),oo();return}let t=document.getElementById(Je);if(t&&t.dataset.oppId===e.oppId){let l=P();l!==null&&l!=="Marketing Tracker"&&(t.remove(),document.getElementById(eo)?.remove(),oo());return}t&&(t.remove(),document.getElementById(eo)?.remove());let o=await Uu();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Aa();if(!a||a.oppId!==e.oppId)return;let i=Rl();i.id=Je,i.dataset.oppId=e.oppId,i.dataset.tenantId=e.tenantId;let s=document.createElement("span");s.id=eo,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${e.oppId} (contactId deferred to click)`),Vu(e.oppId)}finally{ir=!1}}},Nl=()=>{Du(),Nu()};bu();function te(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ye(e){return te(e)}var ju="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",Xe="ws-crm-compute-offer-button",Oa="ws-crm-compute-offer-popover",Kl="ws-crm-offer-modal",zl="ws-crm-contact-actions-bar",Ku=[".central-panel","[class*='central-panel']"],Be=e=>typeof e=="number"?`$${Math.round(e).toLocaleString("en-US")}`:"-",Ia=e=>{if(typeof e!="number"||Math.round(e)===0)return"$0";let t=`$${Math.abs(Math.round(e)).toLocaleString("en-US")}`;return e<0?`\u2212${t}`:`+${t}`},Yu=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ql=e=>{if(!e)return"";let t=String(e).split("-");return t.length!==3?String(e):`${Yu[Number(t[1])-1]||""} ${Number(t[2])}`.trim()},F=(e,t,o)=>{let r=document.createElement(e);return t&&(r.style.cssText=t),o!=null&&(r.textContent=o),r},Gl=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,Ma=async e=>{let t={tenant_id:e.tenantId,mode:e.mode};e.propertyRecordId?t.property_record_id=e.propertyRecordId:e.contactId&&(t.contact_id=e.contactId),e.mode!=="get"&&(e.propertyCondition!=null&&(t.property_condition=e.propertyCondition),e.repairOverride!==void 0&&(t.repair_override=e.repairOverride));let o=await fetch(ju,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},mt=()=>{document.getElementById(Oa)?.remove(),document.removeEventListener("mousedown",Yl,!0)};function Yl(e){let t=document.getElementById(Oa),o=document.getElementById(Xe),r=e.target;t&&!t.contains(r)&&o&&!o.contains(r)&&mt()}var Jl=(e,t)=>{mt();let o=e.getBoundingClientRect(),r=document.createElement("div");r.id=Oa;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,t(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Yl,!0),0)},cr=(e,t)=>{Jl(e,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,t))})},Ju=(e,t,o)=>{Jl(e,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),t.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{mt(),o(a.property_record_id)}),r.appendChild(i)})})},pr=()=>{document.getElementById(Kl)?.remove(),document.removeEventListener("keydown",Xl,!0)};function Xl(e){e.key==="Escape"&&pr()}var Ul=(e,t,o)=>{pr(),mt();let r=o,a=!1,i="",s=document.createElement("div");s.id=Kl,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",m=>{m.target===s&&pr()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(m,h,b)=>{a||(a=!0,i="",p(),Ma({tenantId:e,propertyRecordId:t,mode:m,propertyCondition:h,repairOverride:b}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let m=r,h=!!m.has_comps;l.innerHTML="";let b=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let y=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");y.type="button",y.addEventListener("click",pr),b.append(_,y),l.appendChild(b);let k=F("div","padding:14px 18px 18px;");l.appendChild(k);let x=F("select",Gl());(m.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(m.tier||m.property_condition)&&(N.selected=!0),x.appendChild(N)}),x.disabled=a,x.addEventListener("change",()=>d("recompute",x.value,g.value.trim()));let g=F("input",Gl());g.type="number",g.placeholder="uses the level",g.value=m.repair_override!=null?String(m.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",x.value,g.value.trim()));let w=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(F("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${ql(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let C=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");C.type="button",C.disabled=a,C.addEventListener("click",()=>d("pull",x.value,g.value.trim())),w.append(C),k.appendChild(w),m.low_confidence&&h&&k.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let S=m.current_offer!=null;k.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${S?n.bone:n.ash};`,S?`Last offer made: ${Be(m.current_offer)}${m.current_offer_date?` \xB7 ${ql(m.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),f=F("div","");f.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),f.appendChild(x);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(f,T),k.appendChild(E);let I=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),B=(z,N,R)=>{let Ee=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${R?.strong?"font-weight:700;":""}`),Te=F("div","");Te.appendChild(F("div",`font-size:${R?.strong?"13":"12"}px;color:${n.bone};`,z)),R?.sub&&Te.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,R.sub));let ee=F("div",`font-size:${R?.strong?"15":"12"}px;color:${R?.color||n.bone};white-space:nowrap;`,N);Ee.append(Te,ee),I.appendChild(Ee)};if(h&&m.imv!=null){B("Investor Market Value (IMV)",Be(m.imv)),m.arv!=null&&B("After Repair Value (ARV)",Be(m.arv),{color:n.ash});let z=m.repair_adjustment??0,N=-z,R=m.repair_override?"Repair override":m.property_condition_label||"Repairs";z===0?B(`Repairs (${R})`,"Included",{color:n.ash,sub:`${Be(m.repair_total)} in repairs included at IMV`}):B(`Repairs (${R})`,Ia(N),{color:N<0?n.crimson:n.emerald,sub:`${Be(m.repair_total)} total, ${Be(m.baseline_repairs)} included at IMV`}),B("Min. Profit Target",Ia(-(m.profit_target??0)),{color:n.ash}),B("Maximum Cash Offer (MAO)",Be(m.mao),{strong:!0,color:n.blue}),B("Target Profit",Ia(-(m.ico_delta??0)),{color:n.ash}),B("Initial Cash Offer (ICO)",Be(m.ico),{strong:!0,color:n.blue})}else I.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(I);let G=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);G.textContent=a?"Saving\u2026":i||(h?"Saved to the Property.":""),k.appendChild(G)}p(),document.body.appendChild(s),document.addEventListener("keydown",Xl,!0)},Vl=(e,t)=>{let o=document.createElement("button");o.type="button",o.id=Xe,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){Ju(o,s.properties,l=>{a(!0),Ma({tenantId:t,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?Ul(t,d.property_record_id,d):cr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),cr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?Ul(t,s.property_record_id,s):cr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await Ma({tenantId:t,contactId:e,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),cr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Xu=async()=>{for(let e of Ku)try{let t=await $(e,{timeoutMs:3e3});if(t)return t}catch{}return null},Wl=async(e,t)=>{let o=t.querySelector(`#${zl}`);if(!o)try{o=await $(`#${zl}`,{timeoutMs:3e3,root:t})}catch{o=null}return o?(e.style.order="3",o.appendChild(e),!0):!1},jl=()=>{let e=document.querySelectorAll(`#${Xe}`);for(let t=1;t<e.length;t++)e[t].remove()},Qu=async()=>{let e=D();if(!e||!e.locationId||e.source!=="url"){document.getElementById(Xe)?.remove(),mt();return}let t=e.locationId,o=document.getElementById(Xe);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove(),mt();let r="seller";try{r=Ce(await Se(e.contactId,t))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Xe)?.remove();return}let a=await Xu();if(!a){c.warn("[compute-offer] no central panel found");return}let i=D();if(!i||i.contactId!==e.contactId)return;let s=Vl(e.contactId,t);if(!await Wl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}jl(),c.debug(`[compute-offer] mounted for ${e.contactId}`);let l=new MutationObserver(()=>{if(D()?.contactId!==e.contactId){l.disconnect();return}if(!document.getElementById(Xe)){let d=Vl(e.contactId,t);Wl(d,a).then(()=>jl())}});l.observe(a,{childList:!0})},ro=null,Ql=()=>{let e=D()?.contactId??null;if(ro&&ro.id===e)return;let t=Qu().finally(()=>{ro?.promise===t&&(ro=null)});ro={id:e,promise:t}};var so="reos-theme-stylesheet",Ra="reos-theme-fonts",bt=!1,Zu=()=>{let e=document.getElementById(Ra);e&&e.remove()},ev=`
/* ============================================
...
/* Material Symbols icons (Google) use a FILL-based glyph in a
   "0 -960 960 960" viewBox, unlike the stroke-based Lucide icons the rest of
   the theme assumes. The global icon treatment strokes paths (right for Lucide)
   but leaves fill:none \u2014 which makes fill-based Material Symbols INVISIBLE.
   Diagnosed live via /browse 2026-06-14 on the phone-number Configure panel:
   the Voice AI + Business Phone Number icons rendered as empty placeholders
   while the Lucide IVR / Team / External icons showed. Fill them with the
   inherited icon color and drop the stroke so they render. Global \u2014 fixes every
   Material Symbols icon in the app, not just this panel.
   Scoped to GHL's .hr-icon component (where these render) on purpose: a bare
   svg[viewBox] rule would also flatten any non-icon artwork (funnel / page-
   builder / illustration SVGs) that happens to reuse Material's viewBox. */
...
/* Phone-number Configure modal: kill the redundant "box around a box". GHL wraps
   some controls (member/caller-ID dropdowns, the external-number input, the
   whisper + call-recording textareas) in a .rounded-lg.border.p-3 section box,
   but the control already draws its OWN border \u2014 so it reads as a box inside a
   box. Drop the wrapper's border ONLY where it actually contains a control
   (:has) so the standalone option cards that have no inner control (IVR, Voice
   AI, Business Phone) keep their single card border. Diagnosed live 2026-06-14. */
...
/* 18a-hr-date-panel NEW-PICKER COVERAGE (v0.41.7). GHL rolled out a
   second date-picker variant that carries an extra hr-datepicker__new
   class on the same .hr-date-panel popover. Two canon gaps on it:

   (1) Its month-nav arrows are STROKE-drawn chevrons (svg fill="none"
       stroke="currentColor"), unlike the old fill-drawn arrows. The
       v0.9.96 stroke-kill above (stroke:none / stroke-width:0) therefore
       erases them entirely \u2014 they're present but invisible. Restore a
       2px ash stroke (emerald on hover) ONLY for the new variant so the
       old picker's fill-only arrows are untouched.
   (2) It paints the selected / today ring with box-shadow/outline, which
       the v0.9.86 border-strip (border-width:0) does not remove, so a
       bright ring survives on the dark panel. Kill shadow + outline on
       the date cells and reassert the canon emerald selected fill. */
...
/* (2) Kill the box-shadow / outline ring on date cells (the border-strip
   only zeroes border-width). Scoped to cells + their trigger, NOT the
   panel, so the panel's own drop shadow is preserved. */
html body .hr-date-panel:not(#__reos_never_id) .hr-date-panel-date,
html body .hr-date-panel:not(#__reos_never_id) .hr-date-panel-date__trigger,
html body .hr-date-panel:not(#__reos_never_id) .hr-date-panel-date__trigger::before,
html body .hr-date-panel:not(#__reos_never_id) .hr-date-panel-date__trigger::after {
...
/* Reassert canon: selected date = emerald cell + obsidian text, covering
   the new picker's class spelling (--selected / --active / substrings). */
html body .hr-date-panel:not(#__reos_never_id) .hr-date-panel-date--selected,
...
/* 15e-4. v0.41.9: HIDE the native Associations right-rail icon on contact
   pages \u2014 replaced by the REOS Properties widget (lists the seller's
   properties + deals, Add Property, Add person). The rail buttons carry no
   stable id, so match the Associations icon by its unique SVG path prefix via
   :has() (Chrome 105+). Degrades safely: if :has() is unsupported or GHL
   changes the icon path, the rule simply no-ops and the icon stays visible. */
html body nav button:has(path[d^="M8.67153 7.67424C8.17071"]):not(#__reos_never_id) {
  display: none !important;
}
...
`,tv=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],ov=e=>{if(!e||e[0]!=="#")return e;let t=e.slice(1);if(t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t.length!==6&&t.length!==8)return e;let o=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),a=parseInt(t.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return e;if(t.length===8){let i=parseInt(t.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},rv=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),nv=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],mr=new WeakSet,Zl=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(t=>{try{if(mr.has(t)&&t.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.closest(".hl_header, header.hl_header, header.app-header")||t.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let o=t.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(t).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;let m=t.style.getPropertyValue("background-color");if(m==="rgb(18, 22, 29)"){mr.add(t);return}if(t.closest(".hr-button")&&!(t.classList&&t.classList.contains("hr-button"))){m!=="transparent"&&(t.style.setProperty("background-color","transparent","important"),t.style.setProperty("background-image","none","important")),mr.add(t);return}t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"),mr.add(t)}catch{}})}catch{}},Ha=new WeakSet,no=()=>{document.querySelectorAll(nv.join(", ")).forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=t.querySelectorAll("*");[t,...Array.from(o)].forEach(r=>{if(Ha.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH"||r.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],p=+s[3];if(!(l<230||d<230||p<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),Ha.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),Ha.add(r)}})})},ed=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.classList&&t.classList.contains("hr-button"))return;let o=t.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(t.style.setProperty("background-color","transparent","important"),t.style.setProperty("background-image","none","important"))})},td=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(e=>{e.style.setProperty("background-color","#252C36","important"),e.style.setProperty("background-image","none","important"),e.style.setProperty("color","#EDEEF0","important")})},od=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=t.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"),t.style.removeProperty("border-radius"))})},br=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(t=>{let o=t.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],p=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&p>=180&&l+d+p>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},rd=()=>{let e="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(e)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},ao=()=>{if(!bt)for(let e of tv){let t;try{t=document.querySelectorAll(e.selector)}catch{continue}t.forEach(o=>{for(let[r,a]of Object.entries(e.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=rv.has(r)?ov(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},gr="#1A1F28",av=26,iv=31,sv=40,nd=new Set,ad=new Set,hr=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0||(t.textContent||"").trim()!=="--")return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;t.style.setProperty("display","none","important");let a=t.className?.toString()||"<no class>";!ad.has(a)&&a!=="<no class>"&&(ad.add(a),c.debug(`Hid empty "--" leaf: "${a}"`))})},lv=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],dv=["trash","Trash","TRASH","delete","Delete","DELETE"],cv=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.getAttribute("data-reos-trash")==="true")return;let o=t.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(dv.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";lv.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(t.id||"").toLowerCase(),s=(t.getAttribute("aria-label")||"").toLowerCase(),l=(t.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&t.setAttribute("data-reos-trash","true")})},pv=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),mv=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=(t.textContent||"").trim();o.length===0||o.length>40||pv.has(o)&&t.style.display!=="none"&&(t.style.setProperty("display","none","important"),t.style.setProperty("visibility","hidden","important"),t.style.setProperty("opacity","0","important"),t.style.setProperty("pointer-events","none","important"))})},id=new Set,sd=new WeakSet,bv=()=>{document.body.querySelectorAll("*").forEach(t=>{if(sd.has(t)&&t.style.getPropertyValue("color")==="rgb(237, 238, 240)"||t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=(t.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||t.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=t.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let h of Array.from(t.childNodes))if(h.nodeType===Node.TEXT_NODE&&(h.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(t.children);if(i.length>0&&i.every(h=>{let b=h.tagName.toLowerCase();return b==="svg"||b==="img"})&&!a)return;let d=window.getComputedStyle(t).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),sd.add(t);let m=t.className?.toString()||"<no class>";!id.has(m)&&m!=="<no class>"&&(id.add(m),c.debug(`Remapped pure-white text -> bone: "${m}"`))})},ld=new Set,hv=()=>{let e=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),t="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(t)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),e.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,p=l.backgroundImage||"",m=!1;if(p!=="none"&&p.includes("gradient"))m=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let S=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(S&&parseFloat(S[1])<.6)return;let E=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(E){let f=parseInt(E[1],10),T=parseInt(E[2],10),I=parseInt(E[3],10);(f>=60||T>=60||I>=60)&&(f>230&&T>230&&I>230||(f>=80||T>=80||I>=80)&&(m=!0))}}if(!m)return;let b=(i.textContent||"").trim(),_=s,y=Array.from(i.querySelectorAll("*")).map(S=>(S.className?.toString()||"").toLowerCase()).join(" "),k=b.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),x=_.includes("bg-clip-text")||_.includes("text-transparent")||y.includes("bg-clip-text")||y.includes("text-transparent"),g=Array.from(i.querySelectorAll("*")).some(S=>{let E=window.getComputedStyle(S),f=E.getPropertyValue("-webkit-background-clip")||"",T=E.getPropertyValue("background-clip")||"";return f.includes("text")||T.includes("text")});if(k||x||g){let S=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],E=f=>{S.forEach(T=>f.style.removeProperty(T))};E(i),i.querySelectorAll("*").forEach(E);return}let w="#12161D";i.style.setProperty("color",w,"important"),i.querySelectorAll("*").forEach(S=>{let E=S.tagName.toLowerCase();E==="svg"||E==="path"||E==="circle"||E==="rect"||E==="polygon"||E==="polyline"||E==="line"||E==="g"?(S.style.setProperty("fill",w,"important"),S.style.setProperty("stroke",w,"important"),S.style.setProperty("color",w,"important")):(S.style.setProperty("color",w,"important"),S.style.setProperty("-webkit-text-fill-color",w,"important"))});let C=i.className?.toString()||"<no class>";!ld.has(C)&&C!=="<no class>"&&(ld.add(C),c.debug(`Darkened SVG icons on colored button: "${C}"`))})})},dd=new Set,uv=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;if((t.className?.toString()||"").toLowerCase().includes("default-avatar")){t.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(t.parentElement||t).querySelectorAll("svg, img").forEach(d=>{let p=d;if(p.closest("[id^='ws-crm-']"))return;let m=d.getBoundingClientRect();if(m.width===0||m.width>28||m.height>28)return;let h=m.left<r.right&&m.right>r.left,b=m.top<r.bottom&&m.bottom>r.top;if(!(h&&b)||m.top+m.height/2<a)return;let y=m.width*m.height/(r.width*r.height);if(y>.55)return;let k=p,x=p.parentElement,g=0;for(;x&&x!==t&&g<3;){let C=x.getBoundingClientRect();if(C.width>0&&C.width<=30&&C.height<=30)k=x;else break;x=x.parentElement,g++}k.style.setProperty("transform","translateY(11px)","important");let w=(k.className?.toString()||"")+" "+k.tagName;dd.has(w)||(dd.add(w),c.debug(`Dropped activity badge 11px (${m.width.toFixed(0)}x${m.height.toFixed(0)} icon, ratio ${y.toFixed(2)}): "${w}"`))})})},vv="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",_v=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let o=(t.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(t.style.setProperty("color","#0FB57E","important"),t.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),t.style.setProperty("opacity","1","important"),t.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),t.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",vv,"important")}),t.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((t.style.color==="rgb(18, 22, 29)"||t.style.color==="#12161D"||t.style.color==="#0FB57E"||t.style.color==="rgb(15, 181, 126)")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color")),t.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),t.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},cd=new Set,gv=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;t.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),p=parseInt(s[3],10);if(!(l>200&&d>200&&p>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!cd.has(m)&&m!=="<no class>"&&(cd.add(m),c.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${p})): "${m}"`))})})},pd=new Set,yv=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let o=t.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!pd.has(l)&&l!=="<no class>"&&(pd.add(l),c.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},md=new Set,fv=()=>{let e=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),t=document.querySelectorAll("div, section, aside"),o=[];t.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...e,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let x=s.getAttribute("style")||"";(x.includes("background-color")||x.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let x=s.getAttribute("style")||"";(x.includes("background-color")||x.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let p=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!p)return;let m=parseInt(p[1],10),h=parseInt(p[2],10),b=parseInt(p[3],10);if(!(m>200&&h>200&&b>200))return;let y=s.getBoundingClientRect();if(y.width<24||y.height<16||y.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let k=s.className?.toString()||"<no class>";!md.has(k)&&k!=="<no class>"&&(md.add(k),c.debug(`Coerced light bg (${y.width.toFixed(0)}x${y.height.toFixed(0)}, rgb(${m},${h},${b})): "${k}"`))})})},bd=new Set,xv=()=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(e)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let w=o.getAttribute("style")||"";(w.includes("color")||w.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let w=0;w<4&&a;w++){let C=a.nextElementSibling;if(C&&(C.matches(e)||C.querySelector(e)!==null)){i=C;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),p=l.className?.toString()||"",m=p.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,h=p.includes("hl-form-item")||p.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,b=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(p.includes("hr-form-item-blank")||p.includes("hr-form-item")||l.matches(b))&&(l.matches(b)||l.querySelector(b)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=p.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=p.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=p.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!m&&!h&&!_&&!y&&!k&&!x&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",gr,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let g=o.className?.toString()||"<no class>";!bd.has(g)&&g!=="<no class>"&&(bd.add(g),c.debug(`Colored field label "${r.slice(0,30)}": "${g}"`))})},hd=new Set,wv=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let o=(t.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||t.querySelector("svg, img")!==null)return;let i=(t.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));t.style.setProperty("font-size",`${l}px`,"important"),t.style.setProperty("line-height","1","important"),t.style.setProperty("display","flex","important"),t.style.setProperty("align-items","center","important"),t.style.setProperty("justify-content","center","important"),t.style.setProperty("text-align","center","important"),t.querySelectorAll("*").forEach(p=>{p.tagName==="svg"||p.tagName==="SVG"||p.tagName!=="IMG"&&(p.style.setProperty("font-size",`${l}px`,"important"),p.style.setProperty("line-height","1","important"),p.style.setProperty("text-align","center","important"))});let d=t.className?.toString()||"<no class>";!hd.has(d)&&d!=="<no class>"&&(hd.add(d),c.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},ud=new Set,kv=new Set(["Enter Dashboard Name"]),Ev=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let o=t.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=t.placeholder||"";if(kv.has(r)){(t.getAttribute("style")||"").includes("background-color")&&(t.style.removeProperty("background-color"),t.style.removeProperty("border-color"));return}t.style.setProperty("background-color",gr,"important"),t.style.setProperty("border-color","#252C36","important"),t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=t.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",gr,"important"),a.style.setProperty("border-color","#252C36","important"));let i=t.className?.toString()||"<no class>";!ud.has(i)&&i!=="<no class>"&&(ud.add(i),c.debug(`Forced input slate bg: "${i}"`))})},ur=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.id==="chat-filter"||t.id==="phone-calls"||t.id==="archive-conversation"||t.id==="star-toggle"||t.id==="read-toggle"||t.id==="delete-conversation")return;if(t.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(t.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}let o=t.className?.toString()||"";if(o.includes("bg-inherit")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(t.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(b=>o.includes(b))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("border-color")||b.includes("border-style")||b.includes("border-width"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"),t.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(t.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let b=t.getAttribute("style")||"";(b.includes("background-color: rgb(26, 31, 40)")||b.includes("background-color: #1A1F28")||b.includes("background-color: #1a1f28"))&&t.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||t.closest(".hr-date-panel, .n-date-panel")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("n-alert")||t.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("hr-card")||t.closest(".hr-card")||t.id&&t.id.startsWith("opportunity-")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||t.closest(".sidebar-option-button")||t.closest("nav[class*='w-13']")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(t.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let b=t.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}let a=window.getComputedStyle(t).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<av&&l<iv&&d<sv))return;let m=t.getBoundingClientRect();if(m.width===0||m.height===0||m.width>800||m.height>200)return;t.style.setProperty("background-color",gr,"important");let h=t.className?.toString()||"<no class>";!nd.has(h)&&h!=="<no class>"&&(nd.add(h),c.debug(`Coerced dark bg to slate (${m.width.toFixed(0)}x${m.height.toFixed(0)}, rgb(${s},${l},${d})): "${h}"`))})},vr=()=>{let e="#4B8BF5",t=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let p=d,m=!1;if(t.forEach(_=>{p.includes(_)&&(p=p.split(_).join(e),m=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{p.includes(_)&&(p=p.split(_).join("transparent"),m=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(y=>{p.includes(y)&&(p=p.split(y).join("#EDEEF0"),m=!0)}),!!m)try{let _=btoa(p);i.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},_r=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(t=>{[...t.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);t.classList.contains(r)||t.classList.add(r)}})})},Tv=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let o=t.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("background"))})},io=()=>{let e=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},t=document.querySelector(".crm-opportunities-modal");t&&t.querySelectorAll(".hr-base-selection").forEach(a=>{e(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||e(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{e(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=p=>{let m=r.querySelector(".ui-upload-icon svg");m&&(m.style.setProperty("color",p,"important"),m.style.setProperty("stroke",p,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(h=>{h.style.setProperty("stroke",p,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},Da=new WeakSet,Sv=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(t=>{if(!Da.has(t))try{let o=t.contentDocument||t.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Da.add(t);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
        html, body {
          background-color: #FFFFFF !important;
          color: #101828 !important;
        }
        body { padding: 16px !important; }
      `,o.head.appendChild(r),t.style.background="#FFFFFF",t.style.borderRadius="6px",Da.add(t)}catch{}})},Cv=()=>{let e=document.getElementById("edit-phone-number-modal");e&&e.querySelectorAll("textarea").forEach(t=>{let o=getComputedStyle(t).backgroundColor;o&&o!=="rgba(0, 0, 0, 0)"&&o!=="transparent"&&t.style.setProperty("border-color",o,"important")})},Re=!1,Ba=null,vd=!1,Av=()=>{if(vd)return;vd=!0;let e=null,t=0;document.addEventListener("pointerdown",r=>{r.isPrimary&&(e=r.clientX,t=r.clientY,Re=!1)},!0),document.addEventListener("pointermove",r=>{e!==null&&!Re&&Math.abs(r.clientX-e)+Math.abs(r.clientY-t)>6&&(Re=!0)},!0);let o=()=>{e=null,Re&&(Re=!1,Ba&&Ba())};document.addEventListener("pointerup",o,!0),document.addEventListener("pointercancel",o,!0)},_d=()=>{let e,o=()=>{bt||Re||(_r(),ao(),Ev(),ur(),hr(),xv(),Sv(),fv(),yv(),gv(),_v(),hv(),wv(),uv(),bv(),vr(),mv(),cv(),io(),no(),Zl(),od(),rd(),br(),Tv(),io(),ed(),td(),Cv())},r=()=>{bt||Re||e===void 0&&(e=window.setTimeout(()=>{e=void 0,o()},800))};_r(),ao(),ur(),hr(),vr(),io(),no(),Zl(),od(),rd(),br(),ed(),td(),window.setTimeout(()=>{_r(),ao(),ur(),hr(),vr(),io(),no(),br()},500),window.setTimeout(()=>{_r(),ao(),ur(),hr(),vr(),io(),no(),br()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{no(),ao()});let a=!1;Ba=()=>r(),Av(),new MutationObserver(()=>{Re||a||(a=!0,requestAnimationFrame(()=>{a=!1,r()}))}).observe(document.body,{childList:!0,subtree:!0})},Pa,$v=()=>{let e=()=>{if(bt)return;let o=document.getElementById(so);!o||!document.head||document.head.lastElementChild===o||document.head.appendChild(o)};new MutationObserver(o=>{let r=!1;for(let a of o){for(let i of Array.from(a.addedNodes)){if(!(i instanceof Element))continue;let s=i.tagName.toLowerCase();if(s==="style"||s==="link"){if(i.id===so||i.id===Ra)continue;r=!0;break}}if(r)break}r&&Pa===void 0&&(Pa=window.setTimeout(()=>{Pa=void 0,e()},150))}).observe(document.head,{childList:!0}),e()},Fa=()=>{if(bt=!1,Zu(),!document.getElementById(so)){let e=document.createElement("style");e.id=so,e.textContent=ev,document.head.appendChild(e),c.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?_d():window.addEventListener("DOMContentLoaded",_d)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,$v())},gd=()=>{bt=!0,document.getElementById(so)?.remove(),document.getElementById(Ra)?.remove(),c.info("REInvest OS theme stylesheet unmounted (excluded location)")};var yd="ws-crm-customizer-version-badge",yr=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",yr,{once:!0});return}if(document.getElementById(yd))return;let e=document.createElement("div");e.id=yd,e.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,e.textContent=`Customizer v${bo}`,e.title=`Built ${ho}
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};console.log("[ws-crm-customizer] bundle-loaded");var L=(e,t)=>{try{c.info(`[main] calling ${e}`),t(),c.info(`[main] ${e} OK`)}catch(o){c.error(`[main:FAIL] ${e} threw:`,o)}},fd=()=>{c.info(`Loaded v${bo} (built ${ho})`),kr()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):(L("mountVersionBadge (initial)",yr),L("mountFavicon",Si),L("mountThemeStylesheet",Fa),L("mountHideLaunchpad",Tn),L("mountHideNavItems",Sn),L("mountRelabelNav",Cn),L("mountHideTopmenuTabs",$n),L("mountContractsSection",An)),L("initPageRouter",Ga),c.info("[main] registering onPageChange subscriber"),ae(t=>{if(c.info(`[main] onPageChange callback fired for page=${t}`),kr()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),L("unmountThemeStylesheet",gd);return}L("mountThemeStylesheet",Fa),L("mountVersionBadge",yr),L("mountHideLaunchpad",Tn),L("mountHideNavItems",Sn),L("mountRelabelNav",Cn),L("mountHideTopmenuTabs",$n),L("mountContractsSection",An),L("mountClaimReleaseToggle",hi),L("mountContactActionsBar",Ei),L("mountActiveFollowUpButton",Ja),L("mountMtOfferMadeButton",$i),L("mountNotInterestedButton",Li),L("mountScheduleWalkthroughButton",Ii),L("mountResendDealLinkButton",Oi),L("mountReducePriceButton",Di),L("mountEditLandingPageButton",Pi),L("mountPublishButton",Fi),L("mountContactMapLinks",Vi),L("mountSendToClosingOfficeButton",is),L("mountOppActionBar",ws),L("mountClosingAgentPickerButton",kl),L("mountPrepareContractButton",Nl),L("mountComputeOfferButton",Ql),L("mountManageTeam",Cl),L("mountBuyBoxWidget",oi),L("mountPropertiesWidget",ci),L("mountSupportNavItem",Ls),L("mountPhoneAssignmentsWidget",Ps),L("mountBulkPowerDialer",al),L("mountBulkPowerDialerContacts",ll),L("mountCallingAsChip",cl),L("mountDialerThemeFix",ul)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fd):fd();})();
