/* Wholesaling CRM Customizer v0.15.5 — built 2026-05-30T19:52:06.264Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ue="[wholesaling-crm-customizer]",Nr="__WS_CRM_DEBUG",Hr=()=>!!window[Nr],c={info(...t){console.log(Ue,...t)},warn(...t){console.warn(Ue,...t)},error(...t){console.error(Ue,...t)},debug(...t){Hr()&&console.log(Ue,"[debug]",...t)}};var uo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ct=/\/v2\/location\/([A-Za-z0-9]+)/,Br=t=>{let e=t.match(uo);if(!e)return null;let o=t.match(Ct);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Rr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(uo);if(!n)continue;let a=r.match(Ct)||window.location.pathname.match(Ct);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},C=()=>{let t=Br(window.location.pathname);return t||Rr()};var _o=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ve="",At=null,pe="other",It=new Set,qe=()=>{let t=C()?.contactId??null;if(!(!(window.location.pathname!==Ve)&&!(t!==At))){Ve=window.location.pathname,At=t,pe=_o(),c.debug("Page/context changed:",pe,Ve,"contact:",t);for(let r of It)try{r(pe)}catch(n){c.error("Subscriber threw:",n)}}},vo=t=>(It.add(t),setTimeout(()=>t(pe),0),()=>{It.delete(t)}),yo=()=>{pe=_o(),Ve=window.location.pathname,At=C()?.contactId??null,c.debug("Router init, current page:",pe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),qe()},history.replaceState=function(o,r,n){e(o,r,n),qe()},window.addEventListener("popstate",qe),setInterval(qe,1e3)};var We="0.15.5",je="2026-05-30T19:52:06.265Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let l=n.querySelector(t);if(l){a(l);return}let d,b,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),c.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Lt={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},go=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,M=`
  ...
  flex-shrink: 0;
`;var Gr=/^[A-Za-z0-9]{15,30}$/,ke=t=>typeof t=="string"&&Gr.test(t),zr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ur=()=>{let t=window.WS_CRM_USER_ID;return ke(t)?t:null},qr=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ke(o))return o;return null},Vr=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=zr(e);if(!o)return null;let r=o.uid;if(ke(r))return r;let n=o.claims;if(n&&ke(n.user_id))return n.user_id}catch{}return null},Wr=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ke(n))return n}catch{}}}catch{}return null},L=()=>Ur()||qr()||Vr()||Wr()||null;var ko="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",jr=`${ko}/active-follow-up-get`,Kr=`${ko}/active-follow-up-set`,le="ws-crm-active-follow-up-button",Dt={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},Yr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Xr=async t=>{let e=await fetch(jr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Jr=async(t,e)=>{let o=await fetch(Kr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},de=(t,e)=>{let o=Dt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},fo=t=>{let e=document.createElement("button");return e.type="button",e.id=le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,de(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Yr();if(!(!r||r.contactId!==t)){de(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Jr(r,L()),a=n&&n.state&&n.state in Dt?n.state:"blue";de(e,a),c.info(`Active Follow Up set for ${t} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),de(e,"error"),setTimeout(()=>void Ke(e,r),4e3)}}}),e},Ke=async(t,e)=>{de(t,"loading");try{let o=await Xr(e),r=o&&o.state&&o.state in Dt?o.state:"gray",n=document.getElementById(le);if(!n||n.dataset.contactId!==e.contactId)return;de(n,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),de(t,"error")}},Qr=[".central-panel","[class*='central-panel']"],Mt="ws-crm-contact-actions-bar",Zr=async()=>{for(let t of Qr)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},en=async(t,e)=>{let o=e.querySelector(`#${Mt}`);if(!o)try{o=await A(`#${Mt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Mt}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},tn=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},on=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},rn=async t=>{if(t==="url"){let o=await Zr();return o?{kind:"contact-detail",target:o}:null}let e=tn();return e?{kind:"conversations",target:e}:null},wo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await en(t,e.target);return o}return on(t,e.target),"conversations-header"},nn=async()=>{let t=C();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(le);if(o&&o.dataset.contactId===e.contactId){Ke(o,e);return}o&&o.remove();let r=await rn(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=C();if(!n||n.contactId!==e.contactId)return;let a=fo(e.contactId),i=await wo(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),xo();let l=document.getElementById(le)??a;Ke(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(le);if(!(C()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=fo(e.contactId);wo(m,r).then(()=>{xo(),Ke(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ee=null,Eo=()=>{let t=C()?.contactId??null;if(Ee&&Ee.contactId===t)return;let e=nn().finally(()=>{Ee?.promise===e&&(Ee=null)});Ee={contactId:t,promise:e}},xo=()=>{let t=document.querySelectorAll(`#${le}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var oe="ws-crm-claim-release-pill",an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",ln=async t=>{let e=await fetch(an,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},dn=async t=>{let e=await fetch(sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Co=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},me=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;t.dataset.mode=e,t.style.cssText=go(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},cn=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=oe,o.type="button",o.dataset.contactId=t,me(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=C();if(!n||!n.locationId||n.contactId!==t)return;let a=L();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>me(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";me(o,i),o.disabled=!0,o.style.opacity="0.8";try{let l=await dn({contactId:t,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:i;me(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),me(o,r);let d=o.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},To=async(t,e)=>{try{let o=await ln({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(oe);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";me(r,n)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},bn=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Co(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},So=(t,e)=>{let o=cn({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${oe}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},hn=async()=>{let t=C();if(!t){document.getElementById(oe)?.remove();return}let e=document.getElementById(oe);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await bn(o),n=C();if(!n||n.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}So(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let a=document.getElementById(oe);a&&t.locationId&&To(a,{contactId:t.contactId,locationId:t.locationId});let i=null;i=new MutationObserver(async()=>{if(!(C()?.contactId===t.contactId)){i?.disconnect();return}if(document.getElementById(oe))return;let d=Co(o);if(d){So(d,t.contactId);let b=document.getElementById(oe);b&&t.locationId&&To(b,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},Ao=()=>{hn()};var pn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Te=new Map,Io=async(t,e)=>{if(!t)return null;if(Te.has(t))return Te.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${pn}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${t}`),Te.set(t,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return Te.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,n),Te.set(t,null),null}};var Lo=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Oo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",_n=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let l=a||Oo,d;if(i==="buyer"){let h=No.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let b=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},vn=async({contactId:t,tenantId:e})=>{let o=await fetch(un,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var ue="ws-crm-contact-actions-bar",yn="ws-crm-call-status-dropdown",Mo="ws-crm-offer-made-modal",gn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],No=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],fn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],wn=async()=>{for(let t of fn)try{let e=await A(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},xn=({contactId:t,kind:e})=>{let o=e==="buyer"?No:gn,r=e==="buyer"?mn:Oo,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=yn,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=M,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Lt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=s.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=Lt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let f=C()?.locationId,k=L();if(!f){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=s.amber);return}if(e==="seller"&&d.color==="green"&&!k){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=s.amber);return}let g=p?.textContent??"\u25BE",u=async y=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await _n({contactId:t,locationId:f,status:d.label,userId:k,deadReason:y,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=g),i.style.opacity="1"},900)}catch(E){c.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=s.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=g),m&&(m.style.color=s.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Sn(E=>{u(E)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await vn({contactId:t,tenantId:f})).ok?await u():Cn(()=>{u()},()=>{m&&(m.textContent=y)})}catch(E){c.warn("Appointment sanity check failed; firing anyway:",E),await u()}return}await u()}),l.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(i),a.appendChild(l),a},kn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",En=async t=>{let e=await fetch(kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Tn=(t,e="seller")=>{document.getElementById(Mo)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=o?s.emerald:s.amber,i=document.createElement("div");i.id=Mo,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),a=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let i=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},$o=(t,e)=>{let o=document.createElement("div");if(o.id=ue,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=Q,r.textContent="Offer Made",r.addEventListener("click",()=>Tn(t,e)),o.appendChild(r),o.appendChild(xn({contactId:t,kind:e}))}return o},Ft=!1,An=()=>{document.querySelectorAll(`[id="${ue}"]`).forEach(t=>t.remove())},Ho=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ft){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ft=!0;try{await In()}finally{Ft=!1}},In=async()=>{let t=C();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),An();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let b=await Io(t.contactId,t.locationId),h=Lo(b);h==="buyer"?e="buyer":h==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=C();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ue}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await wn();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=C();if(!a||a.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=$o(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(ue)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(C()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${ue}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=$o(t.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},Po=null,Ln=()=>{Po===null&&(Po=window.setInterval(()=>{let t=C();t&&(document.getElementById(ue)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ho()))},3e3))},Bo=()=>{Ln(),Ho()};var Ye="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Mn=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Se="data-ws-crm-favicon",$t=t=>t.hasAttribute(Se),Ro=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Mn.has(e)},Xe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ro(r)&&!$t(r)&&r.remove()});let e=document.head.querySelector(`link[${Se}="1"]`);e?e.href!==Ye&&(e.href=Ye):(e=document.createElement("link"),e.setAttribute(Se,"1"),e.rel="icon",e.type="image/png",e.href=Ye,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Se}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Se,"apple"),o.rel="apple-touch-icon",o.href=Ye,document.head.appendChild(o))},Go=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Xe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Xe())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ro(i)&&!$t(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&$t(i)&&(n=!0)});n&&Xe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Xe(),e>=5&&window.clearInterval(o)},1e3)};var Dn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Fn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,$n=".hr-card.hr-modal.crm-opportunities-modal",F=()=>{let t=document.querySelector($n);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(Fn);if(n){let a=n[1];if(Dn.includes(a))return a}}return null},re=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=F();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Pn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",U="ws-crm-mt-offer-made-button",zo="ws-crm-mt-offer-made-modal",On=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nn=/\/v2\/location\/([A-Za-z0-9]+)/,Ze=()=>{let t=window.location.pathname,e=t.match(On);if(!e)return null;let o=t.match(Nn);return{oppId:e[1],locationId:o?o[1]:null}},Hn=async t=>{let e=await fetch(Pn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Je=()=>{document.getElementById(zo)?.remove()},Bn=t=>{Je();let e=document.createElement("div");e.id=zo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),n=o.querySelector("#ws-mt-offer-error"),a=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Je()}),a?.addEventListener("click",()=>Je()),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let b=Number(d);if(b<100){n.textContent=`That looks low \u2014 did you mean $${(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await Hn({oppId:t.oppId,locationId:t.locationId,amount:b,userId:L()});if(!h.ok){n.textContent=h.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1);return}Je(),t.onSuccess()}catch(h){c.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1)}})},Rn=t=>{let e=document.createElement("button");return e.id=U,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Ze();!o||!o.locationId||o.oppId!==t||Bn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=M)},4e3)}})}),e},Gn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zn=async()=>{for(let t of Gn)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qe=!1,Ht=async()=>{if(!Qe){Qe=!0;try{await Un()}finally{Qe=!1}}},Un=async()=>{let t=Ze();if(!t||!t.locationId){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}let e=document.getElementById(U);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae());return}e&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove());let o=await zn();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ze();if(!n||n.oppId!==t.oppId)return;let a=Rn(t.oppId),i=document.createElement("span");i.id=`${U}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),qn(t.oppId)},Ce=null,Nt=null,Ae=()=>{Ce?.disconnect(),Ce=null,Nt=null},qn=t=>{if(Ce&&Nt===t)return;Ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Nt=t,Ce=new MutationObserver(()=>{let o=Ze();if(!o||o.oppId!==t){Ae();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}document.getElementById(U)||Ht()}),Ce.observe(e,{childList:!0,subtree:!0}))},Pt=null,Ot,Vn=()=>{Pt||(Pt=new MutationObserver(()=>{Ot===void 0&&(Ot=window.setTimeout(()=>{Ot=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);t&&!e&&!Qe&&Ht()},300))}),Pt.observe(document.body,{childList:!0,subtree:!0}))},Uo=()=>{Vn(),Ht()};var Wn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",q="ws-crm-not-interested-button",jn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Kn=/\/v2\/location\/([A-Za-z0-9]+)/,tt=()=>{let t=window.location.pathname,e=t.match(jn);if(!e)return null;let o=t.match(Kn);return{oppId:e[1],locationId:o?o[1]:null}},Yn=async t=>{let e=await fetch(Wn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xn=t=>{let e=document.createElement("button");return e.id=q,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=tt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Yn({oppId:o.oppId,locationId:o.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Jn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qn=async()=>{for(let t of Jn)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},et=!1,zt=async()=>{if(!et){et=!0;try{await Zn()}finally{et=!1}}},Zn=async()=>{let t=tt();if(!t||!t.locationId){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le());return}e&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove());let o=await Qn();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=tt();if(!n||n.oppId!==t.oppId)return;let a=Xn(t.oppId),i=document.createElement("span");i.id=`${q}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),ea(t.oppId)},Ie=null,Gt=null,Le=()=>{Ie?.disconnect(),Ie=null,Gt=null},ea=t=>{if(Ie&&Gt===t)return;Le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gt=t,Ie=new MutationObserver(()=>{let o=tt();if(!o||o.oppId!==t){Le();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}document.getElementById(q)||zt()}),Ie.observe(e,{childList:!0,subtree:!0}))},Bt=null,Rt,ta=()=>{Bt||(Bt=new MutationObserver(()=>{Rt===void 0&&(Rt=window.setTimeout(()=>{Rt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(q);t&&!e&&!et&&zt()},300))}),Bt.observe(document.body,{childList:!0,subtree:!0}))},qo=()=>{ta(),zt()};var oa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",V="ws-crm-reduce-price-button",Vo="ws-crm-reduce-price-modal",ra=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,na=/\/v2\/location\/([A-Za-z0-9]+)/,nt=()=>{let t=window.location.pathname,e=t.match(ra);if(!e)return null;let o=t.match(na);return{oppId:e[1],locationId:o?o[1]:null}},aa=async t=>{let e=await fetch(oa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ot=()=>{document.getElementById(Vo)?.remove()},sa=t=>{ot();let e=document.createElement("div");e.id=Vo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),a=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let b=r.value.replace(/[^0-9.]/g,"").split(".");r.value=b[0]+(b.length>1?"."+b.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&ot()}),a?.addEventListener("click",()=>{ot()}),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let b=parseFloat(d);if(!Number.isFinite(b)||b<=0){n.textContent="Price must be a positive number.",r.focus();return}if(b<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{await aa({oppId:t.oppId,locationId:t.locationId,newPrice:b,userId:L()}),ot(),t.onSuccess()}catch(h){c.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",a&&(a.disabled=!1)}})},ia=(t,e)=>{let o=document.createElement("button");return o.id=V,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=nt();!r||!r.locationId||r.oppId!==t||sa({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),a=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,a&&(a.style.background=s.emerald,a.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=M,a&&(a.style.background=s.amber,a.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},la=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],da=async()=>{for(let t of la)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},rt=!1,Wt=async()=>{if(!rt){rt=!0;try{await ca()}finally{rt=!1}}},ca=async()=>{let t=nt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),De());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await da();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await re();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=nt();if(!n||n.oppId!==t.oppId)return;let a=ia(t.oppId,t.locationId),i=document.createElement("span");i.id=`${V}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),ba(t.oppId)},Me=null,Vt=null,De=()=>{Me?.disconnect(),Me=null,Vt=null},ba=t=>{if(Me&&Vt===t)return;De();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Vt=t,Me=new MutationObserver(()=>{let o=nt();if(!o||o.oppId!==t){De();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}document.getElementById(V)||Wt()}),Me.observe(e,{childList:!0,subtree:!0}))},Ut=null,qt,ha=()=>{Ut||(Ut=new MutationObserver(()=>{qt===void 0&&(qt=window.setTimeout(()=>{qt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!rt&&Wt()},300))}),Ut.observe(document.body,{childList:!0,subtree:!0}))},Wo=()=>{ha(),Wt()};var Yo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ne="ws-crm-send-to-closing-office-button",ce="ws-crm-send-to-title-co-wrap",it="ws-crm-stc-dropdown",pa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ma=/\/v2\/location\/([A-Za-z0-9]+)/,lt=()=>{let t=window.location.pathname,e=t.match(pa);if(!e)return null;let o=t.match(ma);return{oppId:e[1],locationId:o?o[1]:null}},ua=5*60*1e3,Xo=t=>`ws-crm-stc-cache:${t}`,_a=t=>{try{let e=window.localStorage.getItem(Xo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ua||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},va=(t,e)=>{try{window.localStorage.setItem(Xo(t),JSON.stringify(e))}catch{}},ya=async(t,e)=>{try{let o=await fetch(Yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},ga=async(t,e,o)=>{let r=await fetch(Yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},fa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},jo=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},wa=(t,e)=>{if(e&&fa(e)){window.setTimeout(()=>jo(t),300);return}jo(t)},W=()=>{document.getElementById(it)?.remove()},at=(t,e,o)=>{W();let r=document.createElement("div");r.id=it;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...b.filter(_=>h[_]),...Object.keys(h).filter(_=>!b.includes(_))];for(let _ of m){let f=h[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${s.steel};
    `,g.textContent=_,k.appendChild(g),f.forEach(u=>{let y=document.createElement("div"),E=!u.filled&&u.navigable&&u.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
  ...
  `,Y(o,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let g=await ya(t,e);if(!g){n={status:"error",message:"Check failed \u2014 click to retry"},Y(o,n);return}if(g.rate_limited){_=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Y(o,n),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){n={status:"error",message:g.error||"Check failed \u2014 click to retry"},Y(o,n),c.warn("[stc] dry_run returned no checks:",g);return}let u=g.pipeline_name;if(u&&u!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${u}" (not TC) \u2014 retracting button + caching`),dt.add(t),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),$e();return}let y=g.checks;if(n.checks&&n.checks.length===g.checks.length){let T=new Set;y=g.checks.map((w,S)=>n.checks[S]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:g.previously_sent_at??null},va(t,{checks:y,previously_sent_at:g.previously_sent_at??null,pipeline_name:u,ts:Date.now()}),Y(o,n),document.getElementById(it)&&at(y,g.previously_sent_at,o)},l=async()=>{let g=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},Y(o,n),W();try{let u=await ga(t,e,g);if(u.needs_confirm){n={status:"ready",checks:u.checks,previouslySentAt:u.previously_sent_at},Y(o,n),u.checks&&at(u.checks,u.previously_sent_at,o);return}if(u.ok){n={status:"sent",checks:u.checks,previouslySentAt:new Date().toISOString()},Y(o,n),window.setTimeout(()=>{f()},3500);return}n={status:"error",checks:u.checks,message:u.error||"Validation failed"},Y(o,n),u.checks&&at(u.checks,u.previously_sent_at,o)}catch(u){c.error("[stc] send failed:",u),n={status:"error",message:"Network error \u2014 click to retry"},Y(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(it)?W():n.checks&&at(n.checks,n.previouslySentAt,o);break}case"error":case"sent":f();break}});let d,b=!1,h=Date.now(),m=1e4,p=5*60*1e3,_=0,f=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,h=Date.now();try{await i()}finally{b=!1}}};f();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let g=new MutationObserver(()=>{if(d!==void 0||b)return;let y=Date.now()-h,E=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&f()},E)});g.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let u=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(u))},5e3)}return o},ka=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ea=async()=>{for(let t of ka)try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},dt=new Set,Ko=null,Ta=t=>{t&&t!==Ko&&(dt.clear(),Ko=t)},st=!1,Xt=async()=>{if(st){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}st=!0;try{await Sa()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{st=!1}},Sa=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=lt();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Ta(t.oppId),dt.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=F();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(ce)?.remove(),W(),$e());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ce)?.remove(),W()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Ea();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=F();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=lt();if(!n||n.oppId!==t.oppId||!n.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=xa(t.oppId,n.locationId),i=document.createElement("span");i.id=ce,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(a)}`),Ca(t.oppId)},Fe=null,Yt=null,$e=()=>{Fe?.disconnect(),Fe=null,Yt=null},Ca=t=>{if(Fe&&Yt===t)return;$e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Yt=t,Fe=new MutationObserver(()=>{let o=lt();if(!o||o.oppId!==t){$e();return}let r=F();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ne)?.remove(),document.getElementById(ce)?.remove(),W(),$e();return}document.getElementById(ne)||Xt()}),Fe.observe(e,{childList:!0,subtree:!0}))},jt=null,Kt,Aa=()=>{jt||(jt=new MutationObserver(()=>{Kt===void 0&&(Kt=window.setTimeout(()=>{Kt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);if(t&&!e&&!st){let o=lt();if(o&&dt.has(o.oppId))return;Xt()}},300))}),jt.observe(document.body,{childList:!0,subtree:!0}))},Jo=()=>{Aa(),Xt()};var Ia="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",La="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ma="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",er="ldtyB2UXKi9vOp8nLUH7",Da="WVD2gb9swLsgcdBEtDVq",j="ws-crm-closing-agent-picker-button",tr="ws-crm-closing-agent-picker-modal",Fa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$a=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let t=window.location.pathname,e=t.match(Fa);if(!e)return null;let o=t.match($a);return{oppId:e[1],locationId:o?o[1]:null}},no=async t=>{let e=await fetch(Ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Qo=async t=>{let e=await fetch(La,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Pa=async(t,e)=>{try{let o=await fetch(Ma,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:er}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await no({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},be=null,Oa=60*60*1e3,ao=t=>`ws-crm-to-cache:${t}`,or=t=>{try{let e=window.localStorage.getItem(ao(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Oa||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},rr=(t,e,o)=>{try{window.localStorage.setItem(ao(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Na=t=>{try{window.localStorage.removeItem(ao(t))}catch{}},eo="ws-crm-closing-agent-field-link",Ha=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${eo}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Jt=!1,so=async t=>{if(Jt)return;let e=nr();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Jt=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await no({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),to(n.id,n.name,t);let a=document.getElementById(j);if(a){ae(a,{status:"linked",contactName:n.name});let i=Ne();i&&rr(i.oppId,n.id,n.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Jt=!1}}},Ba=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,nr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let b=(d.textContent||"").trim();Ba.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&c.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let i=o[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},to=(t,e,o)=>{let r=nr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${eo}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=eo,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},ct=()=>{document.getElementById(tr)?.remove()},Ra=t=>{ct();let e=document.createElement("div");e.id=tr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),a=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&ct()}),a?.addEventListener("click",ct);let i,l="",d=async b=>{if(n&&b!==l){if(l=b,!b.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await no({tenantId:t.locationId,query:b,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${bt(m.name)}</div>
          <div style="color: ${s.ash}; font-size: 11px; margin-top: 2px;">
            ${bt(m.email||"(no email)")} \xB7 ${bt(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${bt(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{ct(),t.onPick(m)}),n.appendChild(p)})}catch(h){c.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${s.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(b)},250)})},bt=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ae=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",a=s.amber,i=s.bone,l="transparent",d=s.steel,b="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=s.coolGray,i=s.ash,b="wait";break;case"empty":n="Link Closing Agent",a=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,i=s.emeraldBright;break;case"saving":n="Linking\u2026",a=s.coolGray,i=s.ash,b="wait";break}o&&(o.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),t.style.background=l,t.style.borderColor=d,t.style.color=i,t.style.cursor=b},Ga=(t,e)=>{let o=document.createElement("button");o.id=j,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ae(o,r);let n=or(t);return n&&(r={status:"linked",contactName:n.contactName},ae(o,r),be={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let i=await Pa(t,e);i?(r={status:"linked",contactName:i.name},ae(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},to(i.id,i.name,e)):n||(r={status:"empty"},ae(o,r),be?.oppId===t&&(be=null),Ha(),Na(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Ra({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},ae(o,r);try{let l=[Qo({tenantId:e,oppId:t,fieldId:er,value:i.id})];i.companyName&&i.companyName.trim()&&l.push(Qo({tenantId:e,oppId:t,fieldId:Da,value:i.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:i.name},ae(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},rr(t,i.id,i.name),to(i.id,i.name,e),c.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},ae(o,r)}}})}),o},za=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ua=async()=>{for(let t of za)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Pe=!1,pt=async()=>{if(!Pe){Pe=!0;try{await qa()}finally{Pe=!1}}},qa=async()=>{let t=Ne();if(!t||!t.locationId){document.getElementById(j)?.remove(),document.getElementById(`${j}-wrap`)?.remove(),ht();return}let e=document.getElementById(j);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove());let o=F();if(o!==null&&o!=="Transaction Coordination")return;let r=await Ua();if(!r||!(or(t.oppId)!==null||be!==null&&be.oppId===t.oppId)&&await re()!=="Transaction Coordination")return;let a=Ne();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=Ga(t.oppId,a.locationId),l=document.createElement("span");l.id=`${j}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(i),r.appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Va(t.oppId),so(a.locationId)},Oe=null,oo=null,ro=null,ht=()=>{Oe?.disconnect(),Oe=null,oo=null,ro=null},Va=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Oe&&oo===t&&ro===e||(ht(),oo=t,ro=e,Oe=new MutationObserver(()=>{let o=Ne();if(!o||o.oppId!==t||!o.locationId){ht();return}document.getElementById(j)||pt(),so(o.locationId)}),Oe.observe(e,{childList:!0,subtree:!0})))},Qt=null,Zt,Wa=()=>{Qt||(Qt=new MutationObserver(()=>{Zt===void 0&&(Zt=window.setTimeout(()=>{Zt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);t&&!e&&!Pe&&pt()},300))}),Qt.observe(document.body,{childList:!0,subtree:!0}))},Zo,ja=()=>{Zo===void 0&&(Zo=window.setInterval(()=>{let t=Ne();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(j)&&!Pe&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),pt()),so(t.locationId)},2e3))},ar=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Wa(),ja(),pt()};var Ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",io="ws-crm-prepare-contract-button",sr="ws-crm-prepare-contract-menu",J="ws-crm-prepare-contract-modal",ir="ws-crm-modal-date-style",Z="https://services.leadconnectorhq.com",br=()=>{if(document.getElementById(ir))return;let t=document.createElement("style");t.id=ir,t.textContent=`
    #${J} input[type="date"] { color-scheme: dark; }
    #${J} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(t)},lo="__WS_CRM_CAPTURED_AUTH",Ya=50*60*1e3,hr=()=>{try{let t=localStorage.getItem(lo);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Ya?(localStorage.removeItem(lo),null):e:null}catch{return null}},Xa=t=>{try{localStorage.setItem(lo,JSON.stringify(t))}catch{}},ee=()=>{let t=hr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},lr=!1,Ja=()=>{if(lr)return;lr=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=hr()?.authorization;Xa({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=b.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,i=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),i.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},pr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Qa=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Za=async t=>{let e=`${Z}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:ee()});if(!o.ok){let a="";try{a=await o.text()}catch{}let i=a?` \u2014 ${a.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${i}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(a=>({id:(a._id??a.id??a.templateId)||"",name:a.name||a.title||"(unnamed template)",type:Qa(a.name||a.title||"")})).filter(a=>!!a.id)},es=async(t,e)=>{let o=await fetch(`${Z}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:ee()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let a=await fetch(`${Z}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ee()});if(!a.ok)throw new Error(`ACQ opp search ${a.status}`);return((await a.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},ts=async(t,e)=>{let o=await fetch(`${Z}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:ee()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${Z}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ee()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-h})},os=async t=>{let e=await fetch(Ka,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},rs=async(t,e,o)=>{let r=`${Z}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:ee()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let a=await n.json(),i=a._id||a.id||a.proposal?._id||a.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},ns=async(t,e)=>{let o=await fetch(`${Z}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:ee()});if(!o.ok){let a=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${a.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},as=async t=>{let e=await fetch(`${Z}/contacts/${t}`,{method:"GET",headers:ee()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},ss=async(t,e,o,r)=>{let n;try{n=await ns(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let a;try{a=await as(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let i=`${a.firstName} ${a.lastName}`.trim()||a.email||o,l={id:o,firstName:a.firstName,lastName:a.lastName,email:a.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${Z}/proposals/document/${e}`,{method:"PUT",headers:{...ee(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let _=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:_}}return{ok:!0}},is=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},mt="__WS_CRM_PENDING_INSTRUCTIONS",ls=60*1e3,ds=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],cs=t=>{let e=(t||"").toLowerCase();for(let o of ds)if(e.includes(o.matches.toLowerCase()))return o;return null},bs=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(mt,JSON.stringify(r))}catch{}},hs=()=>{try{let t=localStorage.getItem(mt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ls?(localStorage.removeItem(mt),null):e}catch{return null}},ps=()=>{try{localStorage.removeItem(mt)}catch{}},ms=(t,e)=>{document.getElementById(J)?.remove();let o=document.createElement("div");o.id=J,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},us=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,_s=()=>{let t=window.location.pathname.match(us);if(!t)return;let e=t[1],o=hs();o&&o.proposalId===e&&(ps(),window.setTimeout(()=>{ms(o.title,o.bodyHtml)},600))},dr="ws-crm-prepare-contract-toast",G=(t,e="info",o=4e3)=>{document.getElementById(dr)?.remove();let r=document.createElement("div");r.id=dr;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},cr=(t,e)=>new Promise(o=>{document.getElementById(J)?.remove();let r=document.createElement("div");r.id=J,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let a=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},i=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${X(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${s.slate};
  ...
  `,K=`
    ...
    padding-right: 28px;
  `,Ge=D=>['<option value="">(unset)</option>'].concat(k.map($=>`<option value="${X($)}"${$===D?" selected":""}>${H($)}</option>`)).join("");u.innerHTML=`
    <div style="
      font-family: ${v.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${S}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${X(i)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${S}">
      ...
      <div style="${S}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${X(h)}" placeholder="e.g. 30" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${y}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${X(m)}" placeholder="e.g. 10" style="${E}" />
      </div>
      <div style="${S}">
        <div style="${y}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${K}">${Ge(_)}</select>
      </div>
      <div style="${S}">
        <div style="${y}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${K}">${Ge(f)}</select>
      </div>
      <div style="${S} align-items: flex-start;">
        <div style="${y}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${E} resize: vertical; min-height: 60px; font-family: ${v.sans};">${H(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,g.appendChild(u),document.body.appendChild(g);let N=u.querySelector("#ws-pc-purchase-price"),se=u.querySelector("#ws-pc-emd"),te=u.querySelector("#ws-pc-cash-at-close"),ie=!1;te?.addEventListener("input",()=>{ie=!0});let _e=()=>{if(ie)return;let D=Number(N?.value||0),$=Number(se?.value||0);te&&(te.value=String(Math.max(0,D-$)))};N?.addEventListener("input",_e),se?.addEventListener("input",_e);let ze=()=>g.remove();g.addEventListener("click",D=>{D.target===g&&ze()}),u.querySelector("#ws-pc-cancel")?.addEventListener("click",ze);let z=u.querySelector("#ws-pc-submit"),R=u.querySelector("#ws-pc-error");z?.addEventListener("click",async()=>{if(z){R&&(R.textContent=""),z.disabled=!0,z.textContent="Opening\u2026";try{let D=(u.querySelector("#ws-pc-seller-name")?.value||"").trim(),$=Number(N?.value||0),ve=Number(se?.value||0),ye=Number(te?.value||0),ge=(u.querySelector("#ws-pc-days-to-close")?.value??"").trim(),fe=(u.querySelector("#ws-pc-inspection-days")?.value??"").trim(),we=(u.querySelector("#ws-pc-additional-terms")?.value??"").trim(),he=(u.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),xe=(u.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(D!==i&&(P.sellerName=D),$!==l&&(P.purchasePrice=$),ve!==d&&(P.emd=ve),ye!==b&&(P.cashAtClose=ye),ge!==h&&(P.daysToClose=ge),fe!==m&&(P.inspectionDays=fe),we!==p&&(P.additionalTerms=we),he!==_&&(P.currentOccupancy=he),xe!==f&&(P.occupancyAtClose=xe),Object.keys(P).length>0){c.info("[prepare-contract] PA modal submit with overrides:",P),z.textContent="Saving\u2026";let Et=L(),Tt=await ut({tenantId:t,contactId:e,template:o,userId:Et,overrides:P});c.info("[prepare-contract] re-stage with overrides ok:",Tt),z.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let O=a?`${a} - Purchase Agreement`:void 0;await co(t,e,o,O)}catch(D){z.disabled=!1,z.textContent="Open Contract",R&&(R.textContent=D.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",D)}}})},ys=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:a,defaultClosingDate:i,defaultEMDDueDate:l})=>{document.getElementById(J)?.remove(),br();let d=n.debug||{},b=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,f=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",g=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",u=i,y=l,E="",T=document.createElement("div");T.id=J,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;w.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${N}">
        ...
        <div style="${Ge}">${H(b||"(set on Property record)")}</div>
      </div>
      <div style="${N}">
        <div style="${S}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${X(h)}" placeholder="Seller name" style="${I}" />
      </div>
      <div style="${N}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${X(g)}" placeholder="Buyer's entity / LLC name" style="${I}" />
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${X(k)}" placeholder="Title company" style="${I}" />
      </div>
      <div style="${N}">
        <div style="${S}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${X(u)}" style="${I}" />
      </div>
      <div style="${N}">
        <div style="${S}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${X(y)}" style="${I}" />
      </div>
      <div style="${N}">
        ...
        <input id="ws-pc-lender-source" type="text" placeholder="e.g. ABC Hard Money LLC" style="${I}" />
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,T.appendChild(w),document.body.appendChild(T);let te=w.querySelector("#ws-pc-assignment-price"),ie=w.querySelector("#ws-pc-assignment-fee"),_e=!1;ie?.addEventListener("input",()=>{_e=!0});let ze=()=>{if(_e)return;let $=Number(te?.value||0);ie&&(ie.value=String(Math.max(0,$-f)))};te?.addEventListener("input",ze);let z=()=>T.remove();T.addEventListener("click",$=>{$.target===T&&z()}),w.querySelector("#ws-pc-cancel")?.addEventListener("click",z);let R=w.querySelector("#ws-pc-submit"),D=w.querySelector("#ws-pc-error");R?.addEventListener("click",async()=>{if(!R)return;D&&(D.textContent="");let $=(w.querySelector("#ws-pc-seller-name")?.value||"").trim(),ve=Number(te?.value||0),ye=Number(w.querySelector("#ws-pc-buyer-emd")?.value||0),ge=Number(ie?.value||0),fe=(w.querySelector("#ws-pc-closing-office")?.value||"").trim(),we=(w.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),he=(w.querySelector("#ws-pc-closing-date")?.value||"").trim(),xe=(w.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),P=(w.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!he){D&&(D.textContent="Closing Date is required.");return}R.disabled=!0,R.textContent="Opening\u2026";try{let O={};$!==h&&(O.sellerName=$),ve!==m&&(O.assignmentPrice=ve),ye!==p&&(O.buyerEMD=ye),ge!==_&&(O.assignmentFee=ge),fe!==k&&(O.closingOffice=fe),we!==g&&(O.buyerCompanyName=we);let Et=he!==u||xe!==y||P!==E,Tt=Object.keys(O).length>0||Et,St=n;Tt?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",O),R.textContent="Saving\u2026",St=await ut({tenantId:t,contactId:e,template:o,oppId:r,closingDate:he,buyerEarnestDueDate:xe,lenderSource:P,userId:a,overrides:Object.keys(O).length>0?O:void 0}),c.info("[prepare-contract] AA re-stage ok:",St),R.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let mo=St?.debug?.propertyAddress||b,Or=mo?`${mo} - Assignment Agreement`:void 0;await co(t,e,o,Or),z()}catch(O){R.disabled=!1,R.textContent="Open Contract",D&&(D.textContent=O.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",O)}})},ut=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await os({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},co=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await rs(t,o.id,e);c.info(`[prepare-contract] proposal created: ${n}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let a=await ss(t,n,e,r);a.ok?c.info(`[prepare-contract] contact attached to proposal ${n}`):(c.warn(`[prepare-contract] attach failed (status=${a.status??"n/a"}): ${a.body?.slice(0,300)??"no body"}`),G(`Proposal created but couldn't auto-attach contact (HTTP ${a.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",a.body));let i=cs(o.name);i&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),bs(n,i.title,i.bodyHtml)),is(t,n)},gs=async t=>{let e=pr();if(!e){G("Could not resolve contact context.","error");return}document.getElementById(sr)?.remove();let o=document.createElement("div");o.id=sr,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Za(e.tenantId)}catch(a){o.innerHTML=`
    ...
    `;let l=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=s.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let b=L();try{if(a.type==="AA"){let h;try{h=await ts(e.tenantId,e.contactId)}catch(u){G(`Failed to load buyer's MT opps: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",u);return}if(h.length===0){G("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${h.length} opps)`);let u=await cr(h,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!u){c.info("[prepare-contract] MT opp picker cancelled");return}m=u,c.info(`[prepare-contract] picked MT opp ${m}`)}let p=u=>{let y=u.getFullYear(),E=String(u.getMonth()+1).padStart(2,"0"),T=String(u.getDate()).padStart(2,"0");return`${y}-${E}-${T}`},_=u=>{let y=new Date;return y.setDate(y.getDate()+u),p(y)},f=_(45),k=_(7);G("Reading contract data\u2026","info",2500);let g;try{g=await ut({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,closingDate:f,buyerEarnestDueDate:k,userId:b})}catch(u){G(`Failed to prepare contract: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",u);return}ys({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,staged:g,userId:b,defaultClosingDate:f,defaultEMDDueDate:k})}else if(a.type==="PA"){let h;try{h=await es(e.tenantId,e.contactId)}catch(_){G(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(h.length===0){G("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let _=await cr(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}G("Reading contract data\u2026","info",2500);let p;try{p=await ut({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,userId:b})}catch(_){G(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}vs({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:p})}else{G(`Opening ${a.name}\u2026`,"info",2500);try{await co(e.tenantId,e.contactId,a)}catch(h){G(`Failed to open contract: ${h.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){c.warn("[prepare-contract] picker click handler failed:",h),G(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(i)}},fs=()=>{let t=document.createElement("button");return t.id=io,t.type="button",t.style.cssText=`${M} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${s.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),gs(t)}),t},ws="ws-crm-contact-actions-bar",xs=async()=>{let t=pr();if(!t){document.getElementById(io)?.remove();return}let e=null;try{e=await A(`#${ws}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(io);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=fs();r.dataset.contactId=t.contactId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},mr=()=>{_s(),xs()};Ja();function H(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function X(t){return H(t)}var wt="reos-theme-stylesheet",Dr="reos-theme-fonts",ks=()=>{let t=document.getElementById(Dr);t&&t.remove()},Es=`
/* ============================================
...
`,Ts=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Ss=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(n))return t;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${n}, ${a})`}return`rgb(${o}, ${r}, ${n})`},Cs=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),As=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],bo=new WeakSet,ur=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(bo.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let i=+a[1],l=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||i<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){bo.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),bo.add(e)}catch{}})}catch{}},_r=new WeakSet,He=()=>{document.querySelectorAll(As.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(_r.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=+i[1],d=+i[2],b=+i[3];l<230||d<230||b<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),_r.add(r))})})},vr=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},_t=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let l=+i[1],d=+i[2],b=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&l>=180&&d>=180&&b>=180&&l+d+b>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},yr=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Be=()=>{for(let t of Ts){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,n]of Object.entries(t.styles)){let a=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),l=Cs.has(r)?Ss(n):n;a==="important"&&i===l||o.style.setProperty(r,n,"important")}})}},xt="#1A1F28",Is=26,Ls=31,Ms=40,gr=new Set,fr=new Set,vt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!fr.has(n)&&n!=="<no class>"&&(fr.add(n),c.debug(`Hid empty "--" leaf: "${n}"`))})},Ds=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Fs=["trash","Trash","TRASH","delete","Delete","DELETE"],$s=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,n=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Fs.some(a=>n.includes(a))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let l=i.getAttribute("d")||"";Ds.some(d=>l.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Ps=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Os=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Ps.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},wr=new Set,xr=new WeakSet,Ns=()=>{document.body.querySelectorAll("*").forEach(e=>{if(xr.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),xr.add(e);let h=e.className?.toString()||"<no class>";!wr.has(h)&&h!=="<no class>"&&(wr.add(h),c.debug(`Remapped pure-white text -> bone: "${h}"`))})},kr=new Set,Hs=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let i=(a.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let l=window.getComputedStyle(a),d=l.backgroundColor,b=l.backgroundImage||"",h=!1;if(b!=="none"&&b.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let w=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(w){let S=parseInt(w[1],10),I=parseInt(w[2],10),K=parseInt(w[3],10);(S>=60||I>=60||K>=60)&&(S>230&&I>230&&K>230||(S>=80||I>=80||K>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),_=i,f=Array.from(a.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),k=p.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),g=_.includes("bg-clip-text")||_.includes("text-transparent")||f.includes("bg-clip-text")||f.includes("text-transparent"),u=Array.from(a.querySelectorAll("*")).some(T=>{let w=window.getComputedStyle(T),S=w.getPropertyValue("-webkit-background-clip")||"",I=w.getPropertyValue("background-clip")||"";return S.includes("text")||I.includes("text")});if(k||g||u){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],w=S=>{T.forEach(I=>S.style.removeProperty(I))};w(a),a.querySelectorAll("*").forEach(w);return}let y="#12161D";a.style.setProperty("color",y,"important"),a.querySelectorAll("*").forEach(T=>{let w=T.tagName.toLowerCase();w==="svg"||w==="path"||w==="circle"||w==="rect"||w==="polygon"||w==="polyline"||w==="line"||w==="g"?(T.style.setProperty("fill",y,"important"),T.style.setProperty("stroke",y,"important"),T.style.setProperty("color",y,"important")):(T.style.setProperty("color",y,"important"),T.style.setProperty("-webkit-text-fill-color",y,"important"))});let E=a.className?.toString()||"<no class>";!kr.has(E)&&E!=="<no class>"&&(kr.add(E),c.debug(`Darkened SVG icons on colored button: "${E}"`))})})},Er=new Set,Bs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let b=d;if(b.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let f=h.width*h.height/(r.width*r.height);if(f>.55)return;let k=b,g=b.parentElement,u=0;for(;g&&g!==e&&u<3;){let E=g.getBoundingClientRect();if(E.width>0&&E.width<=30&&E.height<=30)k=g;else break;g=g.parentElement,u++}k.style.setProperty("transform","translateY(11px)","important");let y=(k.className?.toString()||"")+" "+k.tagName;Er.has(y)||(Er.add(y),c.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${f.toFixed(2)}): "${y}"`))})})},Rs="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Gs=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Rs,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Tr=new Set,zs=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=parseInt(i[1],10),d=parseInt(i[2],10),b=parseInt(i[3],10);if(!(l>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!Tr.has(h)&&h!=="<no class>"&&(Tr.add(h),c.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${b})): "${h}"`))})})},Sr=new Set,Us=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let n=(o.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Sr.has(l)&&l!=="<no class>"&&(Sr.add(l),c.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},Cr=new Set,qs=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let i=parseInt(a.zIndex,10);if(!isFinite(i)||i<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(n)}),[...t,...o].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let l=(i.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(l.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let h=parseInt(b[1],10),m=parseInt(b[2],10),p=parseInt(b[3],10);if(!(h>200&&m>200&&p>200))return;let f=i.getBoundingClientRect();if(f.width<24||f.height<16||f.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let k=i.className?.toString()||"<no class>";!Cr.has(k)&&k!=="<no class>"&&(Cr.add(k),c.debug(`Coerced light bg (${f.width.toFixed(0)}x${f.height.toFixed(0)}, rgb(${h},${m},${p})): "${k}"`))})})},Ar=new Set,Vs=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let y=o.getAttribute("style")||"";(y.includes("color")||y.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let n=o,a=null;for(let y=0;y<4&&n;y++){let E=n.nextElementSibling;if(E&&(E.matches(t)||E.querySelector(t)!==null)){a=E;break}n=n.parentElement}if(!a)return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=a,d=l.getBoundingClientRect(),b=l.className?.toString()||"",h=b.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(b.includes("hr-form-item-blank")||b.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=b.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=b.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let g=b.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!_&&!f&&!k&&!g&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",xt,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let u=o.className?.toString()||"<no class>";!Ar.has(u)&&u!=="<no class>"&&(Ar.add(u),c.debug(`Colored field label "${r.slice(0,30)}": "${u}"`))})},Ir=new Set,Ws=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let i=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${l}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Ir.has(d)&&d!=="<no class>"&&(Ir.add(d),c.debug(`Resized avatar text to ${l}px (circle ${i.toFixed(0)}px): "${d}"`))})},Lr=new Set,js=new Set(["Enter Dashboard Name"]),Ks=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(js.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",xt,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",xt,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!Lr.has(a)&&a!=="<no class>"&&(Lr.add(a),c.debug(`Forced input slate bg: "${a}"`))})},yt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>o.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let i=parseInt(a[1],10),l=parseInt(a[2],10),d=parseInt(a[3],10);if(!(i<Is&&l<Ls&&d<Ms))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",xt,"important");let m=e.className?.toString()||"<no class>";!gr.has(m)&&m!=="<no class>"&&(gr.add(m),c.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${i},${l},${d})): "${m}"`))})},gt=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let l=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let b=d,h=!1;if(e.forEach(_=>{b.includes(_)&&(b=b.split(_).join(t),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{b.includes(_)&&(b=b.split(_).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(f=>{b.includes(f)&&(b=b.split(f).join("#EDEEF0"),h=!0)}),!!h)try{let _=btoa(b);a.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let i=a.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;a.setAttribute("data-reos-masked","1");let l=`url("${i}")`;a.style.setProperty("-webkit-mask-image",l,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",l,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",o)})},ft=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Ys=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Re=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{t(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(i).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",i="rgb(0, 191, 124)",l=b=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",b,"important"),h.style.setProperty("stroke",b,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",b,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?i:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(i)),r.addEventListener("mouseleave",()=>l(a)))})},ho=new WeakSet,Xs=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!ho.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){ho.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${We}`,t.title=`Built ${je}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var B=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Pr=()=>{c.info(`Loaded v${We} (built ${je})`),B("mountVersionBadge (initial)",kt),B("mountFavicon",Go),B("mountThemeStylesheet",Fr),B("initPageRouter",yo),c.info("[main] registering onPageChange subscriber"),vo(t=>{c.info(`[main] onPageChange callback fired for page=${t}`),B("mountVersionBadge",kt),B("mountClaimReleaseToggle",Ao),B("mountContactActionsBar",Bo),B("mountActiveFollowUpButton",Eo),B("mountMtOfferMadeButton",Uo),B("mountNotInterestedButton",qo),B("mountReducePriceButton",Wo),B("mountSendToClosingOfficeButton",Jo),B("mountClosingAgentPickerButton",ar),B("mountPrepareContractButton",mr)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pr):Pr();})();
