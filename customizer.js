/* Wholesaling CRM Customizer v0.26.0 — built 2026-06-10T03:05:37.434Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var $t="[wholesaling-crm-customizer]",Hi="__WS_CRM_DEBUG",Fi=()=>!!window[Hi],p={info(...t){console.log($t,...t)},warn(...t){console.warn($t,...t)},error(...t){console.error($t,...t)},debug(...t){Fi()&&console.log($t,"[debug]",...t)}};var Bi=/\/v2\/location\/([A-Za-z0-9]+)/,Ri=new Set(["8ntUQzMflUkR0YvrRgVk"]),Me=()=>{let t=window.location.pathname.match(Bi);return t?t[1]:null},Ro=()=>{let t=Me();return t!==null&&Ri.has(t)};var _n=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,No=/\/v2\/location\/([A-Za-z0-9]+)/,Ni=t=>{let e=t.match(_n);if(!e)return null;let o=t.match(No);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},zi=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(_n);if(!a)continue;let i=r.match(No)||window.location.pathname.match(No);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Ni(window.location.pathname);return t||zi()};var yn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ot="",zo=null,Oe="other",Go=new Set,Mt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Ot)&&!(t!==zo))){Ot=window.location.pathname,zo=t,Oe=yn(),p.debug("Page/context changed:",Oe,Ot,"contact:",t);for(let r of Go)try{r(Oe)}catch(a){p.error("Subscriber threw:",a)}}},Dt=t=>(Go.add(t),setTimeout(()=>t(Oe),0),()=>{Go.delete(t)}),gn=()=>{Oe=yn(),Ot=window.location.pathname,zo=P()?.contactId??null,p.debug("Router init, current page:",Oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Mt()},history.replaceState=function(o,r,a){e(o,r,a),Mt()},window.addEventListener("popstate",Mt),setInterval(Mt,1e3)};var Pt="0.26.0",Ht="2026-06-10T03:05:37.435Z";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},qo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},fn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var Gi=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&Gi.test(t),wn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},qi=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},Ui=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},Vi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=wn(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},Wi=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},L=()=>qi()||Ui()||Vi()||Wi()||null,ji=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=wn(e);return o?o.claims??o:null}catch{return null}},xn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ji()?.type==="agency"};var Sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Ki=`${Sn}/active-follow-up-get`,Yi=`${Sn}/active-follow-up-set`,we="ws-crm-active-follow-up-button",Vo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ji=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Xi=async t=>{let e=await fetch(Ki,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Qi=async(t,e)=>{let o=await fetch(Yi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},xe=(t,e)=>{let o=Vo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},kn=t=>{let e=document.createElement("button");return e.type="button",e.id=we,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,xe(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ji();if(!(!r||r.contactId!==t)){xe(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Qi(r,L()),i=a&&a.state&&a.state in Vo?a.state:"blue";xe(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),xe(e,"error"),setTimeout(()=>void Ft(e,r),4e3)}}}),e},Ft=async(t,e)=>{xe(t,"loading");try{let o=await Xi(e),r=o&&o.state&&o.state in Vo?o.state:"gray",a=document.getElementById(we);if(!a||a.dataset.contactId!==e.contactId)return;xe(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),xe(t,"error")}},Zi=[".central-panel","[class*='central-panel']"],Uo="ws-crm-contact-actions-bar",es=async()=>{for(let t of Zi)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ts=async(t,e)=>{let o=e.querySelector(`#${Uo}`);if(!o)try{o=await M(`#${Uo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Uo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},os=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},rs=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},ns=async t=>{if(t==="url"){let o=await es();return o?{kind:"contact-detail",target:o}:null}let e=os();return e?{kind:"conversations",target:e}:null},En=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await ts(t,e.target);return o}return rs(t,e.target),"conversations-header"},as=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(we)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(we);if(o&&o.dataset.contactId===e.contactId){Ft(o,e);return}o&&o.remove();let r=await ns(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=kn(e.contactId),s=await En(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Tn();let l=document.getElementById(we)??i;Ft(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(we);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=kn(e.contactId);En(m,r).then(()=>{Tn(),Ft(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Qe=null,Cn=()=>{let t=P()?.contactId??null;if(Qe&&Qe.contactId===t)return;let e=as().finally(()=>{Qe?.promise===e&&(Qe=null)});Qe={contactId:t,promise:e}},Tn=()=>{let t=document.querySelectorAll(`#${we}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var is="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Ze=new Map,Bt=async(t,e)=>{if(!t)return null;if(Ze.has(t))return Ze.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${is}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),Ze.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Ze.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),Ze.set(t,null),null}};var Rt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var Ln="ws-buybox-nav-icon",Ko="ws-buybox-panel",An="ws-buybox-modal",ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Yo="https://mcclivetim.github.io/reinvest-os-cdn/geo",Nt=null,et=null,tt=null,jo=async()=>{if(Nt)return Nt;try{let t=await fetch(`${Yo}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Nt=await t.json(),Nt}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},ls=async t=>{if(!et)try{let e=await fetch(`${Yo}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);et=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return et?.[t]??[]},ds=async t=>{if(!tt)try{let e=await fetch(`${Yo}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);tt=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return tt?.[t]??[]},Jo=async t=>await(await fetch(ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),cs=(t,e)=>Jo({tenant_id:t,action:"list",buyer_contact_id:e}),ps=(t,e,o,r)=>Jo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),bs=(t,e)=>Jo({tenant_id:t,action:"remove",entry_id:e}),B=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),hs=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},ms='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',us='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',vs="nav.w-13, nav[class*='w-13']",_s=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ys=async()=>{try{return await M(vs,{timeoutMs:2500})}catch{return null}},gs=async()=>{try{return await M(_s,{timeoutMs:2500})}catch{return null}},fs=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,ws=(t,e)=>{let o=document.createElement("div");return o.id=Ko,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ts(t,e,()=>Xo(t,e))}),o},Xo=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([cs(t,e),jo()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${B(r.error||"Failed to load buy-box entries")}</div>`;return}xs(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${B(r.message)}</div>`}},xs=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?hs(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,bs(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}Xo(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},zt=!1,$n=(t,e)=>{zt=e;let o=fs(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=ks,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Xo(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Mn,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Mn="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",ks="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Es=t=>{let e=document.createElement("button");return e.id=Ln,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Mn,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${ms.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!zt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),$n(r,a)}),e},Ts=(t,e,o)=>{let r=document.getElementById(An);r&&r.remove();let a=document.createElement("div");a.id=An,a.style.cssText=`
  ...
  `,h=g=>{let T=i.querySelector("#ws-buybox-state-search"),I=i.querySelectorAll(".ws-buybox-state-row");I.forEach(H=>{H.addEventListener("mouseenter",()=>{H.style.background=n.emeraldGlow}),H.addEventListener("mouseleave",()=>{H.style.background="transparent"}),H.addEventListener("click",()=>{s.stateCode=H.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let H=(T.value||"").toLowerCase().trim();g.forEach((N,Z)=>{let Y=I[Z];if(!Y)return;let R=!H||N.name.toLowerCase().includes(H)||N.code.toLowerCase()===H;Y.style.display=R?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=g=>`
  ...
  `,C=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let H=await ps(t,e,s.granularity,g);if(!H.ok){T&&(T.textContent=H.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(H){T&&(T.textContent=`Network error: ${H.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Wo=!1,De=null,ot=null,In=()=>{document.getElementById(Ln)?.remove(),document.getElementById(Ko)?.remove(),ot&&De&&De.nav.removeEventListener("click",ot,!0),ot=null,De=null,zt=!1},On=()=>{Ss()},Ss=async()=>{if(!Wo){Wo=!0;try{let t=P();if(!t){In();return}let e=document.getElementById(Ko);if(e&&e.dataset.buyerContactId===t.contactId&&De)return;In();let o=null;try{o=await Bt(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Rt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ys(),gs()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=ws(t.locationId,t.contactId),d=Es(()=>De),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};De=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),ot=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&zt&&$n(c,!1)},a.addEventListener("click",ot,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Wo=!1}}};var ue="ws-crm-claim-release-pill",Cs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",As="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Is=async t=>{let e=await fetch(Cs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ls=async t=>{let e=await fetch(As,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Hn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Pe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=fn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},$s=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ue,o.type="button",o.dataset.contactId=t,Pe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=P();if(!a||!a.locationId||a.contactId!==t)return;let i=L();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Pe(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Pe(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Ls({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Pe(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),Pe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Dn=async(t,e)=>{try{let o=await Is({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(ue);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Pe(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Ms=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Hn(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Pn=(t,e)=>{let o=$s({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ue}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Os=async()=>{let t=P();if(!t){document.getElementById(ue)?.remove();return}let e=document.getElementById(ue);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await M("#record-details-lhs",{timeoutMs:1e4}),r=await Ms(o),a=P();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Pn(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ue);i&&t.locationId&&Dn(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(P()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ue))return;let d=Hn(o);if(d){Pn(d,t.contactId);let c=document.getElementById(ue);c&&t.locationId&&Dn(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Fn=()=>{Os()};var qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ds="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Ps="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Hs=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||qn,d;if(s==="buyer"){let b=Un.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Fs=async({contactId:t,tenantId:e})=>{let o=await fetch(Ps,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var He="ws-crm-contact-actions-bar",Bs="ws-crm-call-status-dropdown",Bn="ws-crm-offer-made-modal",Rs=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Un=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Ns=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],zs=async()=>{for(let t of Ns)try{let e=await M(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await M("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Gs=({contactId:t,kind:e})=>{let o=e==="buyer"?Un:Rs,r=e==="buyer"?Ds:qn,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Bs,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=O,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=qo[d.color]),m&&(m.textContent=d.label),l.style.display="none";let x=P()?.locationId,E=L();if(!x){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!E){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await Hs({contactId:t,locationId:x,status:d.label,userId:E,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(C){p.warn("Call Status webhook failed:",C),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";Ws(C=>{y(C)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await Fs({contactId:t,tenantId:x})).ok?await y():js(()=>{y()},()=>{m&&(m.textContent=f)})}catch(C){p.warn("Appointment sanity check failed; firing anyway:",C),await y()}return}await y()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},qs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Us=async t=>{let e=await fetch(qs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Vs=(t,e="seller")=>{document.getElementById(Bn)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=Bn,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},zn=(t,e)=>{let o=document.createElement("div");if(o.id=He,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=J,r.textContent="Offer Made",r.addEventListener("click",()=>Vs(t,e)),o.appendChild(r),o.appendChild(Gs({contactId:t,kind:e}))}return o},Qo=!1,Ks=()=>{document.querySelectorAll(`[id="${He}"]`).forEach(t=>t.remove())},Vn=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Qo){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Qo=!0;try{await Ys()}finally{Qo=!1}},Ys=async()=>{let t=P();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Ks();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Bt(t.contactId,t.locationId),b=Rt(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=P();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${He}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await zs();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=P();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=zn(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(He)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(P()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${He}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=zn(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Gn=null,Js=()=>{Gn===null&&(Gn=window.setInterval(()=>{let t=P();t&&(document.getElementById(He)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Vn()))},3e3))},Wn=()=>{Js(),Vn()};var Gt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Xs=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),rt="data-ws-crm-favicon",Zo=t=>t.hasAttribute(rt),jn=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Xs.has(e)},qt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{jn(r)&&!Zo(r)&&r.remove()});let e=document.head.querySelector(`link[${rt}="1"]`);e?e.href!==Gt&&(e.href=Gt):(e=document.createElement("link"),e.setAttribute(rt,"1"),e.rel="icon",e.type="image/png",e.href=Gt,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${rt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(rt,"apple"),o.rel="apple-touch-icon",o.href=Gt,document.head.appendChild(o))},Kn=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)qt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),qt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&jn(s)&&!Zo(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Zo(s)&&(a=!0)});a&&qt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,qt(),e>=5&&window.clearInterval(o)},1e3)};var Qs=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Zs=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,el=".hr-card.hr-modal.crm-opportunities-modal",D=()=>{let t=document.querySelector(el);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Zs);if(a){let i=a[1];if(Qs.includes(i))return i}}return null},q=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=D();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var tl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",oe="ws-crm-mt-offer-made-button",Yn="ws-crm-mt-offer-made-modal",ol=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rl=/\/v2\/location\/([A-Za-z0-9]+)/,Wt=()=>{let t=window.location.pathname,e=t.match(ol);if(!e)return null;let o=t.match(rl);return{oppId:e[1],locationId:o?o[1]:null}},nl=async t=>{let e=await fetch(tl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ut=()=>{document.getElementById(Yn)?.remove()},al=t=>{Ut();let e=document.createElement("div");e.id=Yn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Wt();!o||!o.locationId||o.oppId!==t||al({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},sl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ll=async()=>{for(let t of sl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vt=!1,rr=async()=>{if(!Vt){Vt=!0;try{await dl()}finally{Vt=!1}}},dl=async()=>{let t=Wt();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=await ll();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Wt();if(!a||a.oppId!==t.oppId)return;let i=il(t.oppId),s=document.createElement("span");s.id=`${oe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),cl(t.oppId)},nt=null,or=null,at=()=>{nt?.disconnect(),nt=null,or=null},cl=t=>{if(nt&&or===t)return;at();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(or=t,nt=new MutationObserver(()=>{let o=Wt();if(!o||o.oppId!==t){at();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),at();return}document.getElementById(oe)||rr()}),nt.observe(e,{childList:!0,subtree:!0}))},er=null,tr,pl=()=>{er||(er=new MutationObserver(()=>{tr===void 0&&(tr=window.setTimeout(()=>{tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!Vt&&rr()},300))}),er.observe(document.body,{childList:!0,subtree:!0}))},Jn=()=>{pl(),rr()};var bl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",re="ws-crm-not-interested-button",hl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ml=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(hl);if(!e)return null;let o=t.match(ml);return{oppId:e[1],locationId:o?o[1]:null}},ul=async t=>{let e=await fetch(bl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},vl=t=>{let e=document.createElement("button");return e.id=re,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Kt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await ul({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},_l=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yl=async()=>{for(let t of _l)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},jt=!1,sr=async()=>{if(!jt){jt=!0;try{await gl()}finally{jt=!1}}},gl=async()=>{let t=Kt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),st();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),st());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await yl();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Kt();if(!a||a.oppId!==t.oppId)return;let i=vl(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),fl(t.oppId)},it=null,ir=null,st=()=>{it?.disconnect(),it=null,ir=null},fl=t=>{if(it&&ir===t)return;st();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ir=t,it=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t){st();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),st();return}document.getElementById(re)||sr()}),it.observe(e,{childList:!0,subtree:!0}))},nr=null,ar,wl=()=>{nr||(nr=new MutationObserver(()=>{ar===void 0&&(ar=window.setTimeout(()=>{ar=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!jt&&sr()},300))}),nr.observe(document.body,{childList:!0,subtree:!0}))},Xn=()=>{wl(),sr()};var xl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Fe="ws-crm-resend-deal-link-wrap",kl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,El=/\/v2\/location\/([A-Za-z0-9]+)/,Jt=()=>{let t=window.location.pathname,e=t.match(kl);if(!e)return null;let o=t.match(El);return{oppId:e[1],locationId:o?o[1]:null}},Tl=async t=>{let e=await fetch(xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Sl=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Qn=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,pr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Qn(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Cl(t,e)),t.appendChild(o)},Cl=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Al(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>pr(t,e)),o.appendChild(s),t.appendChild(o)},Al=async(t,e,o,r)=>{let a=Jt();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Tl({oppId:a.oppId,locationId:a.locationId,channel:o,userId:L()});if(i?.ok)r.innerHTML=`${Qn(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Sl(s)}</span>`}window.setTimeout(()=>pr(t,e),3500)}},Il=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ll=async()=>{for(let t of Il)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Yt=!1,br=async()=>{if(!Yt){Yt=!0;try{await $l()}finally{Yt=!1}}},$l=async()=>{let t=Jt();if(!t||!t.locationId){document.getElementById(Fe)?.remove(),dt();return}let e=document.getElementById(Fe);if(e&&e.dataset.oppId===t.oppId){let s=D();s!==null&&s!=="Marketing Tracker"&&(e.remove(),dt());return}e&&e.remove();let o=await Ll();if(!o)return;let r=await q();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Jt();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Fe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),pr(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Ml(t.oppId)},lt=null,cr=null,dt=()=>{lt?.disconnect(),lt=null,cr=null},Ml=t=>{if(lt&&cr===t)return;dt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(cr=t,lt=new MutationObserver(()=>{let o=Jt();if(!o||o.oppId!==t){dt();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Fe)?.remove(),dt();return}document.getElementById(Fe)||br()}),lt.observe(e,{childList:!0,subtree:!0}))},lr=null,dr,Ol=()=>{lr||(lr=new MutationObserver(()=>{dr===void 0&&(dr=window.setTimeout(()=>{dr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Fe)&&!Yt&&br()},300))}),lr.observe(document.body,{childList:!0,subtree:!0}))},Zn=()=>{Ol(),br()};var ea="ws-crm-dispo-action-row",Be=t=>{let e=document.getElementById(ea);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=ea,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Dl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ne="ws-crm-reduce-price-button",ta="ws-crm-reduce-price-modal",Pl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hl=/\/v2\/location\/([A-Za-z0-9]+)/,Zt=()=>{let t=window.location.pathname,e=t.match(Pl);if(!e)return null;let o=t.match(Hl);return{oppId:e[1],locationId:o?o[1]:null}},Fl=async t=>{let e=await fetch(Dl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Xt=()=>{document.getElementById(ta)?.remove()},Bl=t=>{Xt();let e=document.createElement("div");e.id=ta,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Zt();!r||!r.locationId||r.oppId!==t||Bl({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Nl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zl=async()=>{for(let t of Nl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qt=!1,vr=async()=>{if(!Qt){Qt=!0;try{await Gl()}finally{Qt=!1}}},Gl=async()=>{let t=Zt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await zl();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Zt();if(!a||a.oppId!==t.oppId)return;let i=Rl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Be(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),ql(t.oppId)},ct=null,ur=null,pt=()=>{ct?.disconnect(),ct=null,ur=null},ql=t=>{if(ct&&ur===t)return;pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ur=t,ct=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==t){pt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),pt();return}document.getElementById(ne)||vr()}),ct.observe(e,{childList:!0,subtree:!0}))},hr=null,mr,Ul=()=>{hr||(hr=new MutationObserver(()=>{mr===void 0&&(mr=window.setTimeout(()=>{mr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!Qt&&vr()},300))}),hr.observe(document.body,{childList:!0,subtree:!0}))},oa=()=>{Ul(),vr()};var Re="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",eo="deals.reinvestos.com";var ae="ws-crm-edit-landing-button",Vl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wl=/\/v2\/location\/([A-Za-z0-9]+)/,oo=()=>{let t=window.location.pathname,e=t.match(Vl);if(!e)return null;let o=t.match(Wl);return{oppId:e[1],locationId:o?o[1]:null}},jl=(t,e)=>{let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();return r&&o.searchParams.set("user",r),o.toString()},Kl=(t,e)=>{let o=document.createElement("button");return o.id=ae,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=oo();if(!r||!r.locationId||r.oppId!==t)return;if(!Re){p.warn("[edit-landing] editor session key not configured in this build");return}let a=jl(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Yl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jl=async()=>{for(let t of Yl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},to=!1,fr=async()=>{if(!to){to=!0;try{await Xl()}finally{to=!1}}},Xl=async()=>{let t=oo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Jl();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=oo();if(!a||a.oppId!==t.oppId)return;let i=Kl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Be(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Ql(t.oppId)},bt=null,gr=null,ht=()=>{bt?.disconnect(),bt=null,gr=null},Ql=t=>{if(bt&&gr===t)return;ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gr=t,bt=new MutationObserver(()=>{let o=oo();if(!o||o.oppId!==t){ht();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ht();return}document.getElementById(ae)||fr()}),bt.observe(e,{childList:!0,subtree:!0}))},_r=null,yr,Zl=()=>{_r||(_r=new MutationObserver(()=>{yr===void 0&&(yr=window.setTimeout(()=>{yr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!to&&fr()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},ra=()=>{Zl(),fr()};var aa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ne="ws-crm-publish-button",mt="ws-crm-publish-wrap",no="ws-crm-publish-dropdown",ed=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,td=/\/v2\/location\/([A-Za-z0-9]+)/,kr=()=>{let t=window.location.pathname,e=t.match(ed);if(!e)return null;let o=t.match(td);return{oppId:e[1],locationId:o?o[1]:null}},od=async(t,e)=>{try{let o=await fetch(aa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:L()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},rd=async(t,e)=>{let o=await fetch(aa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:L()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},nd=(t,e)=>{if(!Re){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},be=()=>{document.getElementById(no)?.remove()},na=(t,e,o,r,a)=>{be();let i=document.createElement("div");i.id=no;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};ke(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await od(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},ke(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},ke(o,r),document.getElementById(no)&&r.checks&&na(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},ke(o,r),be();try{let m=await rd(t,e);if(m.ok&&m.published)r={status:"published"},ke(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},ke(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},ke(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(no)?be():r.checks&&na(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},id=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],sd=async()=>{for(let t of id)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ro=!1,Tr=async()=>{if(!ro){ro=!0;try{await ld()}finally{ro=!1}}},ld=async()=>{let t=kr();if(!t||!t.locationId){document.getElementById(Ne)?.remove(),document.getElementById(mt)?.remove(),be(),vt();return}let e=document.getElementById(Ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(mt)?.remove(),be(),vt());return}e&&(e.remove(),document.getElementById(mt)?.remove(),be());let o=await sd();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=kr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=ad(t.oppId,a.locationId),s=document.createElement("span");s.id=mt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),Be(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),dd(t.oppId)},ut=null,Er=null,vt=()=>{ut?.disconnect(),ut=null,Er=null},dd=t=>{if(ut&&Er===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Er=t,ut=new MutationObserver(()=>{let o=kr();if(!o||o.oppId!==t){vt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(Ne)?.remove(),document.getElementById(mt)?.remove(),be(),vt();return}document.getElementById(Ne)||Tr()}),ut.observe(e,{childList:!0,subtree:!0}))},wr=null,xr,cd=()=>{wr||(wr=new MutationObserver(()=>{xr===void 0&&(xr=window.setTimeout(()=>{xr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ne)&&!ro&&Tr()},300))}),wr.observe(document.body,{childList:!0,subtree:!0}))},ia=()=>{cd(),Tr()};var sa="data:image/png;base64,",la="data:image/png;base64,";var pd=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],da=t=>`ws-crm-map-links-${t}`,ao=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},ca=t=>{let e=ao(t.addr),o=ao(t.city),r=ao(t.state),a=ao(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},bd=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,hd=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,md=(t,e)=>{let{full:o,hasAny:r}=ca(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},ud=t=>{let e=document.createElement("span");e.id=da(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),md(t,s)}),l};return e.appendChild(r(sa,"Open in Google Maps",bd)),e.appendChild(r(la,"Search on Zillow",hd)),e},vd=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},pa=()=>{for(let t of pd){if(document.getElementById(da(t.key)))continue;let{hasAny:e}=ca(t);if(!e)continue;let o=vd(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(ud(t)),p.debug(`[map-links] injected on "${t.addr}"`))}},Sr=null,Cr,_d=()=>{Sr||(Sr=new MutationObserver(()=>{Cr===void 0&&(Cr=window.setTimeout(()=>{Cr=void 0;try{pa()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},ba=()=>{_d(),pa()};var ha="ws-crm-hide-launchpad",ma=/\/launchpad\/?$/,Ar=()=>{if(!xn()){if(!document.getElementById(ha)){let t=document.createElement("style");t.id=ha,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ma.test(location.pathname)){let t=location.pathname.replace(ma,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var _a="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ve="ws-crm-send-to-closing-office-button",Ee="ws-crm-send-to-title-co-wrap",lo="ws-crm-stc-dropdown",yd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gd=/\/v2\/location\/([A-Za-z0-9]+)/,co=()=>{let t=window.location.pathname,e=t.match(yd);if(!e)return null;let o=t.match(gd);return{oppId:e[1],locationId:o?o[1]:null}},fd=5*60*1e3,ya=t=>`ws-crm-stc-cache:${t}`,wd=t=>{try{let e=window.localStorage.getItem(ya(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>fd||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},xd=(t,e)=>{try{window.localStorage.setItem(ya(t),JSON.stringify(e))}catch{}},kd=async(t,e)=>{try{let o=await fetch(_a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Ed=async(t,e,o)=>{let r=await fetch(_a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Td=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},ua=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Sd=(t,e)=>{if(e&&Td(e)){window.setTimeout(()=>ua(t),300);return}ua(t)},ie=()=>{document.getElementById(lo)?.remove()},io=(t,e,o)=>{ie();let r=document.createElement("div");r.id=lo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],b={};t.forEach(_=>{b[_.group]||(b[_.group]=[]),b[_.group].push(_)});let m=[...c.filter(_=>b[_]),...Object.keys(b).filter(_=>!c.includes(_))];for(let _ of m){let x=b[_],E=document.createElement("div");E.style.cssText="margin-top: 12px;";let w=document.createElement("div");w.style.cssText=`
    ...
    `,w.textContent=_,E.appendChild(w),x.forEach(y=>{let f=document.createElement("div"),C=!y.filled&&y.navigable&&y.field_id;f.style.cssText=`
        ...
        ${C?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,C&&(f.addEventListener("mouseenter",()=>{f.style.background=n.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",g=>{g.stopPropagation(),y.field_id&&(Sd(y.field_id,y.folder),ie())}));let A=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=C?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${A}<span style="flex: 1;">${y.label}</span>${k}`,E.appendChild(f)}),r.appendChild(E)}document.body.appendChild(r);let h=_=>{let x=_.target;!r.contains(x)&&!o.contains(x)&&(ie(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},le=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,c="Send to Closing Office",b="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,c="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(E=>E.filled).length??0,x=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,c=`${_} of ${x} fields ready`,b="\u25BE";break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,c=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=c),a&&(a.textContent=b)},Cd=(t,e)=>{let o=document.createElement("button");o.id=ve,o.type="button",o.dataset.oppId=t;let r=wd(t),a=r?{status:r.checks.every(w=>w.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${O}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,le(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await kd(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},le(o,a);return}if(w.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},le(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},le(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),po.add(t),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie(),yt();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},xd(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),le(o,a),document.getElementById(lo)&&io(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},le(o,a),ie();try{let y=await Ed(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},le(o,a),y.checks&&io(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},le(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},le(o,a),y.checks&&io(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},le(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(lo)?ie():a.checks&&io(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!c){if(Date.now()<_){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,C=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},C)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Ad=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Id=async()=>{for(let t of Ad)try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},po=new Set,va=null,Ld=t=>{t&&t!==va&&(po.clear(),va=t)},so=!1,Mr=async()=>{if(so){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}so=!0;try{await $d()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{so=!1}},$d=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=co();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Ld(t.oppId),po.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie();return}let e=document.getElementById(ve);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=D();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Ee)?.remove(),ie(),yt());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Ee)?.remove(),ie()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Id();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=D();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=co();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Cd(t.oppId,a.locationId),s=document.createElement("span");s.id=Ee,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Md(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Md=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=co();if(!o||o.oppId!==t){yt();return}let r=D();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ve)?.remove(),document.getElementById(Ee)?.remove(),ie(),yt();return}document.getElementById(ve)||Mr()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Od=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ve);if(t&&!e&&!so){let o=co();if(o&&po.has(o.oppId))return;Mr()}},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},ga=()=>{Od(),Mr()};var Pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Dd=`${Pr}/tc/welcome-call-prefill`,Pd=`${Pr}/tc/welcome-call-save`,Hd=`${Pr}/tc/order-lockbox`,gt="ws-crm-welcome-call-overlay",Fd=["Regular Contract","Subject To","Seller Finance","Novation"],Bd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Rd=["Gas","Electric","Propane","Oil"],Nd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],zd=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],_e=["Yes","No"],Gd=["Yes","No","Unknown"],qd=["Professional Photographer","Seller","Tenant"],Ud=["Month-to-Month","Annual"],fa=["Current","Behind"],Vd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],de=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),ho=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,ka="margin-bottom:12px;",Ea=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Wd=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,wa=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),G=(t,e,o)=>{let r=wa(o);return`<select id="${t}" style="${ho}"><option value=""></option>${e.map(a=>`<option ${r!==""&&wa(a)===r?"selected":""}>${de(a)}</option>`).join("")}</select>`},K=(t,e,o="")=>`<input id="${t}" type="text" value="${de(e)}" placeholder="${de(o)}" style="${ho}">`,jd=(t,e)=>`<textarea id="${t}" rows="3" style="${ho}resize:vertical;">${de(e)}</textarea>`,Kd=(t,e)=>`<input id="${t}" type="date" value="${de(e)}" style="${ho}">`,$=(t,e)=>`<div style="${ka}"><label style="${Ea}">${de(t)}</label>${e}</div>`,Or=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Vd.map(r=>`<label style="${Wd}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},he=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${de(t)}</div>`,ze=()=>{document.getElementById(gt)?.remove()},Te=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Yd=t=>{let e=t.tenant||{};return`
    ${he("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${de(t.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${de(t.deal_address)||"(no address on file)"}</div>

    ${he("Contract")}
    ${$("Type of Contract",G("wc-contract_type",Fd,t.contract_type))}

    ${he("Property")}
    ${$("Property Type",G("wc-property_type",Nd,t.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${$("Beds",K("wc-beds",t.beds))}</div>
      <div style="flex:1;">${$("Baths",K("wc-baths",t.baths))}</div>
      <div style="flex:1;">${$("Sq Ft",K("wc-sqft",t.sqft))}</div>
    </div>
    ${$("Utilities",G("wc-utilities",Bd,t.utilities))}
    ${$("Heat Source",G("wc-heat_source",Rd,t.heat_source))}

    ${he("Liens & Permits")}
    ${$("Is there a mortgage?",G("wc-has_mortgage",_e,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${$("Mortgage payment status",G("wc-mortgage_payment_status",fa,t.mortgage_payment_status))}</div>
    ${$("Any other liens? (back taxes, code violations, HELOC, etc.)",G("wc-has_other_liens",_e,t.has_other_liens))}
    ${$("Any open or expired permits?",G("wc-has_permit_issues",_e,t.has_permit_issues))}
    ${$("Is the property in probate?",G("wc-in_probate",_e,t.in_probate))}

    ${he("Occupancy")}
    ${$("Property occupancy",G("wc-occupancy",zd,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("First name",K("wc-tenant_first_name",e.first_name))}</div>
        <div style="flex:1;">${$("Last name",K("wc-tenant_last_name",e.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Phone",K("wc-tenant_phone",e.phone))}</div>
        <div style="flex:1;">${$("Email",K("wc-tenant_email",e.email))}</div>
      </div>
      ${$("Lease type",G("wc-tenant_lease_type",Ud,e.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Monthly rent",K("wc-tenant_monthly_rent",e.monthly_rent))}</div>
        <div style="flex:1;">${$("Rent due day",K("wc-tenant_rent_due_day",e.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Rent status",G("wc-tenant_rent_status",fa,e.rent_status))}</div>
        <div style="flex:1;">${$("Last rent paid",Kd("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Lease on hand?",G("wc-tenant_lease_on_hand",_e,e.lease_on_hand))}</div>
        <div style="flex:1;">${$("Security deposit",K("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${$("Selling with tenant in place?",G("wc-selling_with_tenant",_e,t.selling_with_tenant))}
    </div>

    ${he("HOA")}
    ${$("Part of an HOA?",G("wc-in_hoa",_e,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${$("HOA monthly fee",K("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${$("HOA rental restriction?",G("wc-hoa_rental_restriction",Gd,t.hoa_rental_restriction))}</div>

    ${he("Photos & Access")}
    ${$("Who is providing photos?",G("wc-photos_provided_by",qd,t.photos_provided_by))}
    <div style="${ka}">
      <label style="${Ea}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
    ...
    ${he("Lockbox")}
    ${$("Lockbox needed?",G("wc-lockbox_needed",_e,t.lockbox_needed))}
    ${$("Lockbox code (agree with the seller; recorded on the property for future use)",K("wc-lockbox_code",t.lockbox_code))}
    <div id="wc-lockbox-detail" style="display:none;">
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Recipient name",K("wc-lockbox_recipient_name",t.lockbox_recipient_name))}</div>
        <div style="flex:1;">${$("Recipient phone",K("wc-lockbox_recipient_phone",t.lockbox_recipient_phone))}</div>
      </div>
      ${$("Mailing address (if different from property)",K("wc-lockbox_mailing_address",t.lockbox_mailing_address))}
      ...
      <div style="font-size:11px;color:${n.ash};margin-top:6px;line-height:1.4;">Deliberate action \u2014 this pings ops to ship a lockbox (billed to the tenant). Completing the call alone does not order one.</div>
    </div>
  ...
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Dr=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),xa=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},bo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?de(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Jd=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Dr("photos_avail_mornings"),photos_avail_afternoons:Dr("photos_avail_afternoons"),photos_avail_evenings:Dr("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),Xd=t=>{ze();let e=document.createElement("div");e.id=gt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Yd(t)}</div>
    <div style="position:sticky;bottom:0;background:${n.graphite};border-top:1px solid ${n.steel};border-radius:0 0 ${v.lg} ${v.lg};padding:14px 20px;display:flex;justify-content:flex-end;gap:10px;">
      ...
      <button id="wc-save" type="button" style="${J}">Complete Welcome Call</button>
    </div>
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",i=>{i.target===e&&ze()}),document.getElementById("wc-close")?.addEventListener("click",ze),document.getElementById("wc-cancel")?.addEventListener("click",ze),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",xa)}),xa();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!S("wc-occupancy")){Te("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Pd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Jd(t)),credentials:"omit"})).ok?(ze(),Te("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Te("Save failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Te("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? This pings ops to ship one (billed to the tenant)."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:S("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:S("wc-lockbox_recipient_name"),recipient_phone:S("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),Te("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,Te("Lockbox order failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,Te("Couldn't reach the lockbox handler. Try again.","err")}})},Ta=async(t,e)=>{ze();let o=document.createElement("div");o.id=gt,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Dd}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,Xd(r)};var Gr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Qd=`${Gr}/tc/confirm-photo-appointment`,Zd=`${Gr}/tc/order-lockbox`,ec=`${Gr}/tc/welcome-call-prefill`,Rr="ws-crm-opp-action-bar",Aa="ws-crm-opp-action-menu",Nr="ws-crm-opp-action-popover",Ia=".hr-card.hr-modal.crm-opportunities-modal",tc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,oc=/\/v2\/location\/([A-Za-z0-9]+)/,La="Welcome Call Needed",$a="Scheduling Photos",Ma="Photos Scheduled",rc=[La,$a,Ma,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Oa=()=>{let t=window.location.pathname,e=t.match(tc);if(!e)return null;let o=t.match(oc);return o?{oppId:e[1],locationId:o[1]}:null},nc=()=>{let t=document.querySelector(Ia);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(rc.includes(r))return r}return null},Ce=()=>{document.getElementById(Aa)?.remove(),document.getElementById(Nr)?.remove()},Se=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    ...
    box-shadow: 0 12px 32px rgba(0,0,0,0.5);
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},ac=t=>{Ta(t.oppId,t.locationId)},Sa=async t=>{if(Ce(),!!window.confirm("Order a lockbox for this deal? This pings ops to ship one (billed to the tenant)."))try{let e={};try{e=await fetch(`${ec}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(r=>r.json())}catch{}(await fetch(Zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:e.lockbox_mailing_address||e.deal_address||"",recipient_name:e.lockbox_recipient_name||"",recipient_phone:e.lockbox_recipient_phone||"",source:"tc-reorder"}),credentials:"omit"})).ok?Se("Lockbox order sent to ops \u2713"):Se("Lockbox order failed \u2014 check the Google Chat webhook env var.","err")}catch(e){p.warn("[action-bar] order lockbox failed:",e),Se("Couldn't reach the lockbox handler. Try again.","err")}},ic=(t,e)=>{Ce();let o=document.createElement("div");o.id=Nr;let r=e.getBoundingClientRect();o.style.cssText=`
  ...
  `,o.innerHTML=`
    ...
    <div style="font-size:10px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};margin-bottom:10px;">Confirm Photo Appointment</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(Qd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){p.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let c=d.target;!o.contains(c)&&!e.contains(c)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},sc=(t,e)=>{Ce();let o=document.createElement("div");o.id=Aa;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},uo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=J:o.style.cssText=O,o.textContent=t,o},lc=()=>{let t=uo("\u22EF","ghost");return t.style.padding="6px 11px",t.style.fontWeight="700",t.style.lineHeight="1",t},dc=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===La){let r=uo("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>ac(t)),o.appendChild(r),o}if(e===$a){let r=uo("Confirm Photo Appointment","primary");r.addEventListener("click",()=>ic(t,r));let a=lc();return a.addEventListener("click",i=>{i.stopPropagation(),sc([{label:"Re-order Lockbox",onClick:()=>void Sa(t)}],a)}),o.appendChild(r),o.appendChild(a),o}if(e===Ma){let r=uo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Sa(t)),o.appendChild(r),o}return null},cc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],pc=async()=>{for(let t of cc)try{let e=await M(t,{timeoutMs:1200});if(e)return e}catch{}return null},mo=()=>{document.getElementById(Rr)?.remove(),Ce()},vo=!1,qr=async()=>{if(!vo){vo=!0;try{let t=Oa();if(!t){mo();return}let e=D();if(e===null)return;if(e!=="Transaction Coordination"){mo();return}let o=nc(),r=document.getElementById(Rr);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=dc(t,o);if(!a){mo();return}let i=await pc();if(!i)return;mo();let s=document.createElement("span");s.id=Rr,s.dataset.oppId=t.oppId,s.dataset.stage=o??"",s.style.cssText="display:inline-flex;align-items:center;margin-left:auto;flex-shrink:0;vertical-align:middle;order:1;",s.appendChild(a),i.classList.contains("description")&&(i.style.display="flex",i.style.alignItems="center",i.style.gap="16px",i.style.flexWrap="wrap"),i.appendChild(s),bc(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{vo=!1}}},ft=null,zr=null,Hr,Ca=()=>{ft?.disconnect(),ft=null,zr=null},bc=t=>{if(ft&&zr===t)return;Ca();let e=document.querySelector(Ia);e&&(zr=t,ft=new MutationObserver(()=>{let o=Oa();if(!o||o.oppId!==t){Ca();return}Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0,qr()},250))}),ft.observe(e,{childList:!0,subtree:!0}))},Fr=null,Br,hc=()=>{Fr||(Fr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!vo&&qr()},300))}),Fr.observe(document.body,{childList:!0,subtree:!0}))},Da=()=>{hc(),qr()};var Pa="ws-support-modal",Ha="ws-support-toast",mc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Fa="ws-support-submitter-name",Ba="ws-support-submitter-email",Ra="ws-support-submitter-role",uc=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ae=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),vc=(t,e="success",o)=>{let r=document.getElementById(Ha);r&&r.remove();let a=document.createElement("div");a.id=Ha;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${Ae(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${Ae(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},_c=()=>{document.getElementById(Pa)?.remove();let t=(localStorage.getItem(Fa)??"").trim(),e=(localStorage.getItem(Ba)??"").trim(),o=(localStorage.getItem(Ra)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Pa,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${Ae(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Ae(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Ae(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Ae(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=Me();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Fa,r.submitterName),localStorage.setItem(Ba,r.submitterEmail),r.submitterRole&&localStorage.setItem(Ra,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(mc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";vc(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},yc=["/support-ticket","ws-support-modal","ws-support"],gc=/\/custom-menu-link\//,Ur=!1,Na=()=>{if(Ur||!gc.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return yc.some(s=>i.includes(s))});if(r){Ur=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{_c(),Ur=!1},50);return}t<10&&setTimeout(e,150)};e()},za=!1,Ga=()=>{za||(za=!0,Dt(()=>setTimeout(Na,50)),Na(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var fc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",wc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",xc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Va="tc_closing_agent",kc="tc_closing_office",se="ws-crm-closing-agent-picker-button",Wa="ws-crm-closing-agent-picker-modal",Ec=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tc=/\/v2\/location\/([A-Za-z0-9]+)/,kt=()=>{let t=window.location.pathname,e=t.match(Ec);if(!e)return null;let o=t.match(Tc);return{oppId:e[1],locationId:o?o[1]:null}},Qr=async t=>{let e=await fetch(fc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},qa=async t=>{let e=await fetch(wc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Sc=async(t,e)=>{try{let o=await fetch(xc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Va}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Qr({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},Ie=null,Cc=60*60*1e3,Zr=t=>`ws-crm-to-cache:${t}`,ja=t=>{try{let e=window.localStorage.getItem(Zr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Cc||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Ka=(t,e,o)=>{try{window.localStorage.setItem(Zr(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Ac=t=>{try{window.localStorage.removeItem(Zr(t))}catch{}},Kr="ws-crm-closing-agent-field-link",Ic=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Kr}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Vr=!1,en=async t=>{if(Vr)return;let e=Ya();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Vr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Qr({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Yr(a.id,a.name,t);let i=document.getElementById(se);if(i){ye(i,{status:"linked",contactName:a.name});let s=kt();s&&Ka(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Vr=!1}}},Lc=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ya=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();Lc.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Yr=(t,e,o)=>{let r=Ya();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Kr}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Kr,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},_o=()=>{document.getElementById(Wa)?.remove()},$c=t=>{_o();let e=document.createElement("div");e.id=Wa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&_o()}),i?.addEventListener("click",_o);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await Qr({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};ye(o,r);let a=ja(t);return a&&(r={status:"linked",contactName:a.contactName},ye(o,r),Ie={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Sc(t,e);s?(r={status:"linked",contactName:s.name},ye(o,r),Ie={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Yr(s.id,s.name,e)):a||(r={status:"empty"},ye(o,r),Ie?.oppId===t&&(Ie=null),Ic(),Ac(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||$c({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ye(o,r);try{let l=[qa({tenantId:e,oppId:t,fieldKey:Va,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(qa({tenantId:e,oppId:t,fieldKey:kc,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ye(o,r),Ie={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Ka(t,s.id,s.name),Yr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},ye(o,r)}}})}),o},Oc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Dc=async()=>{for(let t of Oc)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wt=!1,fo=async()=>{if(!wt){wt=!0;try{await Pc()}finally{wt=!1}}},Pc=async()=>{let t=kt();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),go();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let d=D();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),go());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=D();if(o!==null&&o!=="Transaction Coordination")return;let r=await Dc();if(!r||!(ja(t.oppId)!==null||Ie!==null&&Ie.oppId===t.oppId)&&await q()!=="Transaction Coordination")return;let i=kt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Mc(t.oppId,i.locationId),l=document.createElement("span");l.id=`${se}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Hc(t.oppId),en(i.locationId)},xt=null,Jr=null,Xr=null,go=()=>{xt?.disconnect(),xt=null,Jr=null,Xr=null},Hc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt&&Jr===t&&Xr===e||(go(),Jr=t,Xr=e,xt=new MutationObserver(()=>{let o=kt();if(!o||o.oppId!==t||!o.locationId){go();return}document.getElementById(se)||fo(),en(o.locationId)}),xt.observe(e,{childList:!0,subtree:!0})))},Wr=null,jr,Fc=()=>{Wr||(Wr=new MutationObserver(()=>{jr===void 0&&(jr=window.setTimeout(()=>{jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!wt&&fo()},300))}),Wr.observe(document.body,{childList:!0,subtree:!0}))},Ua,Bc=()=>{Ua===void 0&&(Ua=window.setInterval(()=>{let t=kt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(se)&&!wt&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),fo()),en(t.locationId)},2e3))},Ja=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Fc(),Bc(),fo()};var Rc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",fe="ws-crm-manage-team-cta",Xa="ws-crm-manage-team-modal",Nc=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Qa={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},zc={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Za=()=>{let t=window.location.pathname.match(Nc);return t?{tenantId:t[1]}:null},xo=async t=>{let e=await fetch(Rc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},te=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ge=t=>te(t),tn="ws-crm-manage-team-toast",nn=(t,e="info",o=4e3)=>{document.getElementById(tn)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=tn,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(tn)===a&&a.remove()},o)},on=()=>{document.getElementById(Xa)?.remove()},Gc=(t,e)=>{let o=zc[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${te(e)}</span>
  `},qc=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Gc(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${ge(t.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${te(t.email)}${t.phone?` &middot; ${te(t.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${ge(t.email)}" data-user-id="${ge(t.id)}" data-name="${ge(o)}" data-current-roles="${ge(t.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${ge(t.email)}" data-name="${ge(o)}" data-role-count="${ge(String(t.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Uc=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>qc(r,e)).join(""),ko=async t=>{on();let e=document.createElement("div");e.id=Xa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&on()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",on);let r;try{r=await xo({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          Failed to load roster: ${te(d.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let d=o.querySelector("#ws-team-content");d&&(d.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          ${te(r.error||"Unknown error loading roster")}
        </div>
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Uc(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Vc(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;Wc(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;jc(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Vc=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${te(Qa[s])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${te(e.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${te(e.email)}</div>
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${te(e.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${te(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
  ...
  `,e.addEventListener("click",()=>{ko(t)}),wo(e),setTimeout(()=>wo(e),200),setTimeout(()=>wo(e),800),window.addEventListener("resize",()=>wo(e)),e},rn=!1,op=()=>{if(!rn){rn=!0;try{let t=Za();if(!t){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}let e=document.getElementById(fe);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${fe}-floater`)?.remove();let o=document.createElement("div");o.id=`${fe}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=tp(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{rn=!1}}},ei=()=>{if(!Za()){document.getElementById(fe)?.remove(),document.getElementById(`${fe}-floater`)?.remove();return}op()};var rp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ln="ws-crm-prepare-contract-button",ti="ws-crm-prepare-contract-menu",pe="ws-crm-prepare-contract-modal",oi="ws-crm-modal-date-style",me="https://services.leadconnectorhq.com",li=()=>{if(document.getElementById(oi))return;let t=document.createElement("style");t.id=oi,t.textContent=`
    #${pe} input[type="date"] { color-scheme: dark; }
    #${pe} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(t)},dn="__WS_CRM_CAPTURED_AUTH",np=50*60*1e3,Co=()=>{try{let t=localStorage.getItem(dn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>np?(localStorage.removeItem(dn),null):e:null}catch{return null}},ap=t=>{try{localStorage.setItem(dn,JSON.stringify(t))}catch{}},qe=()=>{let t=Co(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ri=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Co()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ge=async(t,e={},o=2)=>{let r=Co()?.capturedAt??0,a;try{a={...qe(),...e.headers??{}}}catch(s){if(o>0&&await ri(r,4e3))return Ge(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await ri(r,4e3)?Ge(t,e,o-1):i},ni=!1,ip=()=>{if(ni)return;ni=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Co()?.authorization;ap({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},di=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},sp=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:di()},lp=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ci="__WS_CRM_TEMPLATES_CACHE_V1",dp=24*60*60*1e3,ai=t=>{try{let e=window.localStorage.getItem(ci);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>dp?null:o.templates}catch{return null}},cp=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(ci,JSON.stringify(o))}catch{}},pp=async t=>{let e=`${me}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ge(e,{method:"GET"})}catch(s){let l=ai(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ai(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:lp(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&cp(t,i),i},bp=async(t,e)=>{let o=await Ge(`${me}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Ge(`${me}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},hp=async(t,e)=>{let o=await Ge(`${me}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${me}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:qe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},mp=async t=>{let e=await fetch(rp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},up=async(t,e,o)=>{let r=`${me}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:qe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},vp=async(t,e)=>{let o=await fetch(`${me}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:qe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},_p=async t=>{let e=await fetch(`${me}/contacts/${t}`,{method:"GET",headers:qe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},yp=async(t,e,o,r)=>{let a;try{a=await vp(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await _p(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${me}/proposals/document/${e}`,{method:"PUT",headers:{...qe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},gp=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},To="__WS_CRM_PENDING_INSTRUCTIONS",fp=60*1e3,wp=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],xp=t=>{let e=(t||"").toLowerCase();for(let o of wp)if(e.includes(o.matches.toLowerCase()))return o;return null},kp=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(To,JSON.stringify(r))}catch{}},Ep=()=>{try{let t=localStorage.getItem(To);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>fp?(localStorage.removeItem(To),null):e}catch{return null}},Tp=()=>{try{localStorage.removeItem(To)}catch{}},Sp=(t,e)=>{document.getElementById(pe)?.remove();let o=document.createElement("div");o.id=pe,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Cp=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ap=()=>{let t=window.location.pathname.match(Cp);if(!t)return;let e=t[1],o=Ep();o&&o.proposalId===e&&(Tp(),window.setTimeout(()=>{Sp(o.title,o.bodyHtml)},600))},ii="ws-crm-prepare-contract-toast",U=(t,e="info",o=4e3)=>{document.getElementById(ii)?.remove();let r=document.createElement("div");r.id=ii;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},si=(t,e)=>new Promise(o=>{document.getElementById(pe)?.remove();let r=document.createElement("div");r.id=pe,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${ce(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${n.slate};
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,H=z=>['<option value="">(unset)</option>'].concat(E.map(V=>`<option value="${ce(V)}"${V===z?" selected":""}>${X(V)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${g}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ce(s)}" placeholder="Seller name" style="${C}" />
      </div>
      <div style="${g}">
      ...
      <div style="${g}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ce(b)}" placeholder="e.g. 30" style="${C}" />
      </div>
      <div style="${g}">
        <div style="${f}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${ce(m)}" placeholder="e.g. 10" style="${C}" />
      </div>
      <div style="${g}">
        <div style="${f}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${I}">${H(_)}</select>
      </div>
      <div style="${g}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${I}">${H(x)}</select>
      </div>
  ...
  `,w.appendChild(y),document.body.appendChild(w);let N=y.querySelector("#ws-pc-purchase-price"),Z=y.querySelector("#ws-pc-emd"),Y=y.querySelector("#ws-pc-cash-at-close"),R=!1;Y?.addEventListener("input",()=>{R=!0});let Ue=()=>{if(R)return;let z=Number(N?.value||0),V=Number(Z?.value||0);Y&&(Y.value=String(Math.max(0,z-V)))};N?.addEventListener("input",Ue),Z?.addEventListener("input",Ue);let Lt=()=>w.remove();w.addEventListener("click",z=>{z.target===w&&Lt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Lt);let ee=y.querySelector("#ws-pc-submit"),Q=y.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){Q&&(Q.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let z=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),V=Number(N?.value||0),Ve=Number(Z?.value||0),We=Number(Y?.value||0),je=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ke=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),$e=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Je=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),W={};if(z!==s&&(W.sellerName=z),V!==l&&(W.purchasePrice=V),Ve!==d&&(W.emd=Ve),We!==c&&(W.cashAtClose=We),je!==b&&(W.daysToClose=je),Ke!==m&&(W.inspectionDays=Ke),Ye!==h&&(W.additionalTerms=Ye),$e!==_&&(W.currentOccupancy=$e),Je!==x&&(W.occupancyAtClose=Je),Object.keys(W).length>0){p.info("[prepare-contract] PA modal submit with overrides:",W),ee.textContent="Saving\u2026";let Ho=L(),Fo=await So({tenantId:t,contactId:e,template:o,userId:Ho,overrides:W});p.info("[prepare-contract] re-stage with overrides ok:",Fo),ee.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let j=i?`${i} - Purchase Agreement`:void 0;await bn(t,e,o,j)}catch(z){ee.disabled=!1,ee.textContent="Open Contract",Q&&(Q.textContent=z.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",z)}}})},Lp=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(pe)?.remove(),li();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,C="",A=document.createElement("div");A.id=pe,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;k.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${N}">
        ...
        <div style="${H}">${X(c||"(set on Property record)")}</div>
      </div>
      <div style="${N}">
        <div style="${g}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${ce(b)}" placeholder="Seller name" style="${T}" />
      </div>
      <div style="${N}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${ce(w)}" placeholder="Buyer's entity / LLC name" style="${T}" />
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${ce(E)}" placeholder="Title company" style="${T}" />
      </div>
      <div style="${N}">
        <div style="${g}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${ce(y)}" style="${T}" />
      </div>
      <div style="${N}">
        <div style="${g}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${ce(f)}" style="${T}" />
      </div>
      <div style="${N}">
  ...
  `,A.appendChild(k),document.body.appendChild(A);let Y=k.querySelector("#ws-pc-assignment-price"),R=k.querySelector("#ws-pc-assignment-fee"),Ue=!1;R?.addEventListener("input",()=>{Ue=!0});let Lt=()=>{if(Ue)return;let V=Number(Y?.value||0);R&&(R.value=String(Math.max(0,V-x)))};Y?.addEventListener("input",Lt);let ee=()=>A.remove();A.addEventListener("click",V=>{V.target===A&&ee()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let Q=k.querySelector("#ws-pc-submit"),z=k.querySelector("#ws-pc-error");Q?.addEventListener("click",async()=>{if(!Q)return;z&&(z.textContent="");let V=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ve=Number(Y?.value||0),We=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),je=Number(R?.value||0),Ke=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Ye=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),$e=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Je=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),W=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!$e){z&&(z.textContent="Closing Date is required.");return}Q.disabled=!0,Q.textContent="Opening\u2026";try{let j={};V!==b&&(j.sellerName=V),Ve!==m&&(j.assignmentPrice=Ve),We!==h&&(j.buyerEMD=We),je!==_&&(j.assignmentFee=je),Ke!==E&&(j.closingOffice=Ke),Ye!==w&&(j.buyerCompanyName=Ye);let Ho=$e!==y||Je!==f||W!==C,Fo=Object.keys(j).length>0||Ho,Bo=a;Fo?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",j),Q.textContent="Saving\u2026",Bo=await So({tenantId:t,contactId:e,template:o,oppId:r,closingDate:$e,buyerEarnestDueDate:Je,lenderSource:W,userId:i,overrides:Object.keys(j).length>0?j:void 0}),p.info("[prepare-contract] AA re-stage ok:",Bo),Q.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let vn=Bo?.debug?.propertyAddress||c,Pi=vn?`${vn} - Assignment Agreement`:void 0;await bn(t,e,o,Pi),ee()}catch(j){Q.disabled=!1,Q.textContent="Open Contract",z&&(z.textContent=j.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",j)}})},So=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await mp({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},bn=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await up(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await yp(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),U(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=xp(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),kp(a,s.title,s.bodyHtml)),gp(t,a)},$p=async t=>{let e=sp(t);if(!e){U("Could not resolve contact context.","error");return}document.getElementById(ti)?.remove();let o=document.createElement("div");o.id=ti,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await pp(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await hp(e.tenantId,e.contactId)}catch(f){U(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){U("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await si(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),C=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${C}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);U("Reading contract data\u2026","info",2500);let E;try{E=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:c})}catch(y){U(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){U("Could not resolve buyer contact for this opp.","error",6e3);return}Lp({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){U("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await bp(e.tenantId,e.contactId)}catch(_){U(`Failed to load ACQ opps: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){U("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await si(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,p.info(`[prepare-contract] picked ACQ opp ${m}`)}U("Reading contract data\u2026","info",2500);let h;try{h=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(_){U(`Failed to prepare contract: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",_);return}Ip({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){U("This template needs to be started from a contact page.","error",6e3);return}U(`Opening ${i.name}\u2026`,"info",2500);try{await bn(e.tenantId,e.contactId,i)}catch(b){U(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),U(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},pi=()=>{let t=document.createElement("button");return t.id=ln,t.type="button",t.style.cssText=`${O} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),$p(t)}),t},Mp="ws-crm-contact-actions-bar",Op=async()=>{let t=di();if(!t){document.getElementById(ln)?.remove();return}let e=null;try{e=await M(`#${Mp}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(ln);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=pi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Le="ws-crm-prepare-contract-button-opp",Et=`${Le}-wrap`,Dp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Pp=/\/v2\/location\/([A-Za-z0-9]+)/,Hp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cn=()=>{let t=window.location.pathname,e=t.match(Dp);if(!e)return null;let o=t.match(Pp);return o?{oppId:e[1],tenantId:o[1]}:null},Fp=async()=>{for(let t of Hp)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Eo=!1,Tt=null,pn=null,an=null,sn,St=()=>{Tt?.disconnect(),Tt=null,pn=null},Bp=t=>{if(Tt&&pn===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pn=t,Tt=new MutationObserver(()=>{let o=cn();if(!o||o.oppId!==t){St();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Le)?.remove(),document.getElementById(Et)?.remove(),St();return}document.getElementById(Le)||bi()}),Tt.observe(e,{childList:!0,subtree:!0}))},Rp=()=>{an||(an=new MutationObserver(()=>{sn===void 0&&(sn=window.setTimeout(()=>{sn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Le);t&&!e&&!Eo&&bi()},300))}),an.observe(document.body,{childList:!0,subtree:!0}))},bi=async()=>{if(!Eo){Eo=!0;try{let t=cn();if(!t){document.getElementById(Le)?.remove(),document.getElementById(Et)?.remove(),St();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Et)?.remove(),St());return}e&&(e.remove(),document.getElementById(Et)?.remove());let o=await Fp();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=cn();if(!a||a.oppId!==t.oppId)return;let i=pi();i.id=Le,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Et,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Bp(t.oppId)}finally{Eo=!1}}},hi=()=>{Ap(),Op()};ip();function X(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ce(t){return X(t)}var Oo="reos-theme-stylesheet",$i="reos-theme-fonts",Np=()=>{let t=document.getElementById($i);t&&t.remove()},zp=`
/* ============================================
...
`,Gp=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],qp=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},Up=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Vp=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],hn=new WeakSet,mi=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(hn.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){hn.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),hn.add(e)}catch{}})}catch{}},ui=new WeakSet,Ct=()=>{document.querySelectorAll(Vp.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(ui.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),ui.add(r))})})},vi=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Ao=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},_i=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},At=()=>{for(let t of Gp){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=Up.has(r)?qp(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},Do="#1A1F28",Wp=26,jp=31,Kp=40,yi=new Set,gi=new Set,Io=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!gi.has(a)&&a!=="<no class>"&&(gi.add(a),p.debug(`Hid empty "--" leaf: "${a}"`))})},Yp=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Jp=["trash","Trash","TRASH","delete","Delete","DELETE"],Xp=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Jp.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";Yp.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Qp=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Zp=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Qp.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},fi=new Set,wi=new WeakSet,eb=()=>{document.body.querySelectorAll("*").forEach(e=>{if(wi.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),wi.add(e);let b=e.className?.toString()||"<no class>";!fi.has(b)&&b!=="<no class>"&&(fi.add(b),p.debug(`Remapped pure-white text -> bone: "${b}"`))})},xi=new Set,tb=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,c=l.backgroundImage||"",b=!1;if(c!=="none"&&c.includes("gradient"))b=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let A=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(A&&parseFloat(A[1])<.6)return;let k=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let g=parseInt(k[1],10),T=parseInt(k[2],10),I=parseInt(k[3],10);(g>=60||T>=60||I>=60)&&(g>230&&T>230&&I>230||(g>=80||T>=80||I>=80)&&(b=!0))}}if(!b)return;let h=(i.textContent||"").trim(),_=s,x=Array.from(i.querySelectorAll("*")).map(A=>(A.className?.toString()||"").toLowerCase()).join(" "),E=h.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),w=_.includes("bg-clip-text")||_.includes("text-transparent")||x.includes("bg-clip-text")||x.includes("text-transparent"),y=Array.from(i.querySelectorAll("*")).some(A=>{let k=window.getComputedStyle(A),g=k.getPropertyValue("-webkit-background-clip")||"",T=k.getPropertyValue("background-clip")||"";return g.includes("text")||T.includes("text")});if(E||w||y){let A=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=g=>{A.forEach(T=>g.style.removeProperty(T))};k(i),i.querySelectorAll("*").forEach(k);return}let f="#12161D";i.style.setProperty("color",f,"important"),i.querySelectorAll("*").forEach(A=>{let k=A.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(A.style.setProperty("fill",f,"important"),A.style.setProperty("stroke",f,"important"),A.style.setProperty("color",f,"important")):(A.style.setProperty("color",f,"important"),A.style.setProperty("-webkit-text-fill-color",f,"important"))});let C=i.className?.toString()||"<no class>";!xi.has(C)&&C!=="<no class>"&&(xi.add(C),p.debug(`Darkened SVG icons on colored button: "${C}"`))})})},ki=new Set,ob=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let b=d.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let m=b.left<r.right&&b.right>r.left,h=b.top<r.bottom&&b.bottom>r.top;if(!(m&&h)||b.top+b.height/2<a)return;let x=b.width*b.height/(r.width*r.height);if(x>.55)return;let E=c,w=c.parentElement,y=0;for(;w&&w!==e&&y<3;){let C=w.getBoundingClientRect();if(C.width>0&&C.width<=30&&C.height<=30)E=w;else break;w=w.parentElement,y++}E.style.setProperty("transform","translateY(11px)","important");let f=(E.className?.toString()||"")+" "+E.tagName;ki.has(f)||(ki.add(f),p.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${f}"`))})})},rb="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",nb=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",rb,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Ei=new Set,ab=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let b=r.className?.toString()||"<no class>";!Ei.has(b)&&b!=="<no class>"&&(Ei.add(b),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${c})): "${b}"`))})})},Ti=new Set,ib=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Ti.has(l)&&l!=="<no class>"&&(Ti.add(l),p.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},Si=new Set,sb=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let b=parseInt(c[1],10),m=parseInt(c[2],10),h=parseInt(c[3],10);if(!(b>200&&m>200&&h>200))return;let x=s.getBoundingClientRect();if(x.width<24||x.height<16||x.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let E=s.className?.toString()||"<no class>";!Si.has(E)&&E!=="<no class>"&&(Si.add(E),p.debug(`Coerced light bg (${x.width.toFixed(0)}x${x.height.toFixed(0)}, rgb(${b},${m},${h})): "${E}"`))})})},Ci=new Set,lb=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=o.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let f=0;f<4&&a;f++){let C=a.nextElementSibling;if(C&&(C.matches(t)||C.querySelector(t)!==null)){i=C;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),c=l.className?.toString()||"",b=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let E=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;E&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!b&&!m&&!_&&!x&&!E&&!w&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Do,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let y=o.className?.toString()||"<no class>";!Ci.has(y)&&y!=="<no class>"&&(Ci.add(y),p.debug(`Colored field label "${r.slice(0,30)}": "${y}"`))})},Ai=new Set,db=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Ai.has(d)&&d!=="<no class>"&&(Ai.add(d),p.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Ii=new Set,cb=new Set(["Enter Dashboard Name"]),pb=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(cb.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Do,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",Do,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!Ii.has(i)&&i!=="<no class>"&&(Ii.add(i),p.debug(`Forced input slate bg: "${i}"`))})},Lo=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<Wp&&l<jp&&d<Kp))return;let b=e.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;e.style.setProperty("background-color",Do,"important");let m=e.className?.toString()||"<no class>";!yi.has(m)&&m!=="<no class>"&&(yi.add(m),p.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},$o=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,b=!1;if(e.forEach(_=>{c.includes(_)&&(c=c.split(_).join(t),b=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{c.includes(_)&&(c=c.split(_).join("transparent"),b=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(x=>{c.includes(x)&&(c=c.split(x).join("#EDEEF0"),b=!0)}),!!b)try{let _=btoa(c);i.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},Mo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},bb=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},It=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let b=r.querySelector(".ui-upload-icon svg");b&&(b.style.setProperty("color",c,"important"),b.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},mn=new WeakSet,hb=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!mn.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){mn.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Pt}`,t.title=`Built ${Ht}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var F=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Di=()=>{if(p.info(`Loaded v${Pt} (built ${Ht})`),Ro()){p.info(`[main] customizer disabled for excluded location ${Me()} \u2014 bailing`);return}F("mountVersionBadge (initial)",Po),F("mountFavicon",Kn),F("mountThemeStylesheet",Mi),F("mountHideLaunchpad",Ar),F("initPageRouter",gn),p.info("[main] registering onPageChange subscriber"),Dt(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),Ro()){p.info(`[main] page change into excluded location ${Me()} \u2014 skipping mounts`);return}F("mountVersionBadge",Po),F("mountHideLaunchpad",Ar),F("mountClaimReleaseToggle",Fn),F("mountContactActionsBar",Wn),F("mountActiveFollowUpButton",Cn),F("mountMtOfferMadeButton",Jn),F("mountNotInterestedButton",Xn),F("mountResendDealLinkButton",Zn),F("mountReducePriceButton",oa),F("mountEditLandingPageButton",ra),F("mountPublishButton",ia),F("mountContactMapLinks",ba),F("mountSendToClosingOfficeButton",ga),F("mountOppActionBar",Da),F("mountClosingAgentPickerButton",Ja),F("mountPrepareContractButton",hi),F("mountManageTeam",ei),F("mountBuyBoxWidget",On),F("mountSupportNavItem",Ga)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Di):Di();})();
