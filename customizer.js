/* Wholesaling CRM Customizer v0.41.0 — built 2026-06-15T00:33:30.302Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var ro="[wholesaling-crm-customizer]",Ql="__WS_CRM_DEBUG",Zl=()=>!!window[Ql],c={info(...t){console.log(ro,...t)},warn(...t){console.warn(ro,...t)},error(...t){console.error(ro,...t)},debug(...t){Zl()&&console.log(ro,"[debug]",...t)}};var ed=/\/v2\/location\/([A-Za-z0-9]+)/,td=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let t=window.location.pathname.match(ed);return t?t[1]:null},_r=()=>{let t=re();return t!==null&&td.has(t)};var Sa=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,gr=/\/v2\/location\/([A-Za-z0-9]+)/,od=t=>{let e=t.match(Sa);if(!e)return null;let o=t.match(gr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},rd=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Sa);if(!a)continue;let i=r.match(gr)||window.location.pathname.match(gr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},R=()=>{let t=od(window.location.pathname);return t||rd()};var Ca=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},ao="",yr=null,De="other",fr=new Set,no=()=>{let t=R()?.contactId??null;if(!(!(window.location.pathname!==ao)&&!(t!==yr))){ao=window.location.pathname,yr=t,De=Ca(),c.debug("Page/context changed:",De,ao,"contact:",t);for(let r of fr)try{r(De)}catch(a){c.error("Subscriber threw:",a)}}},ne=t=>(fr.add(t),setTimeout(()=>t(De),0),()=>{fr.delete(t)}),Aa=()=>{De=Ca(),ao=window.location.pathname,yr=R()?.contactId??null,c.debug("Router init, current page:",De);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),no()},history.replaceState=function(o,r,a){e(o,r,a),no()},window.addEventListener("popstate",no),setInterval(no,1e3)},io=()=>De;var so="0.41.0",lo="2026-06-15T00:33:30.303Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{h&&h.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},h=new MutationObserver(()=>{let m=a.querySelector(t);m&&(b(),i(m))});h.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let m=a.querySelector(t);m&&(b(),i(m))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},xr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},La=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var nd=/^[A-Za-z0-9]{15,30}$/,vt=t=>typeof t=="string"&&nd.test(t),$a=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ad=()=>{let t=window.WS_CRM_USER_ID;return vt(t)?t:null},id=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(vt(o))return o;return null},sd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=$a(e);if(!o)return null;let r=o.uid;if(vt(r))return r;let a=o.claims;if(a&&vt(a.user_id))return a.user_id}catch{}return null},ld=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(vt(a))return a}catch{}}}catch{}return null},M=()=>ad()||id()||sd()||ld()||null,dd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=$a(e);return o?o.claims??o:null}catch{return null}},me=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:dd()?.type==="agency"};var Da="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",cd=`${Da}/active-follow-up-get`,pd=`${Da}/active-follow-up-set`,He="ws-crm-active-follow-up-button",kr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},bd=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},md=async t=>{let e=await fetch(cd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},hd=async(t,e)=>{let o=await fetch(pd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Pe=(t,e)=>{let o=kr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Ia=t=>{let e=document.createElement("button");return e.type="button",e.id=He,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Pe(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=bd();if(!(!r||r.contactId!==t)){Pe(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await hd(r,M()),i=a&&a.state&&a.state in kr?a.state:"blue";Pe(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Pe(e,"error"),setTimeout(()=>void co(e,r),4e3)}}}),e},co=async(t,e)=>{Pe(t,"loading");try{let o=await md(e),r=o&&o.state&&o.state in kr?o.state:"gray",a=document.getElementById(He);if(!a||a.dataset.contactId!==e.contactId)return;Pe(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Pe(t,"error")}},ud=[".central-panel","[class*='central-panel']"],wr="ws-crm-contact-actions-bar",vd=async()=>{for(let t of ud)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},_d=async(t,e)=>{let o=e.querySelector(`#${wr}`);if(!o)try{o=await I(`#${wr}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${wr}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},gd=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},yd=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},fd=async t=>{if(t==="url"){let o=await vd();return o?{kind:"contact-detail",target:o}:null}let e=gd();return e?{kind:"conversations",target:e}:null},Ma=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await _d(t,e.target);return o}return yd(t,e.target),"conversations-header"},xd=async()=>{let t=R();if(!t||!t.locationId){document.getElementById(He)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(He);if(o&&o.dataset.contactId===e.contactId){co(o,e);return}o&&o.remove();let r=await fd(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=R();if(!a||a.contactId!==e.contactId)return;let i=Ia(e.contactId),s=await Ma(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Oa();let l=document.getElementById(He)??i;co(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(He);if(!(R()?.contactId===e.contactId)){d.disconnect();return}if(!p){let h=Ia(e.contactId);Ma(h,r).then(()=>{Oa(),co(h,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},_t=null,Ha=()=>{let t=R()?.contactId??null;if(_t&&_t.contactId===t)return;let e=xd().finally(()=>{_t?.promise===e&&(_t=null)});_t={contactId:t,promise:e}},Oa=()=>{let t=document.querySelectorAll(`#${He}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var wd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",gt=new Map,Ke=async(t,e)=>{if(!t)return null;if(gt.has(t))return gt.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${wd}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),gt.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return gt.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),gt.set(t,null),null}};var Ye=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var Ra="ws-buybox-nav-icon",Sr="ws-buybox-panel",Pa="ws-buybox-modal",kd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Cr="https://mcclivetim.github.io/reinvest-os-cdn/geo",po=null,yt=null,ft=null,Tr=async()=>{if(po)return po;try{let t=await fetch(`${Cr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return po=await t.json(),po}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Ed=async t=>{if(!yt)try{let e=await fetch(`${Cr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);yt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return yt?.[t]??[]},Td=async t=>{if(!ft)try{let e=await fetch(`${Cr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ft=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return ft?.[t]??[]},Ar=async t=>await(await fetch(kd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Sd=(t,e)=>Ar({tenant_id:t,action:"list",buyer_contact_id:e}),Cd=(t,e,o,r)=>Ar({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Ad=(t,e)=>Ar({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ld=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},$d='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Id='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Md="nav.w-13, nav[class*='w-13']",Od=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Dd=async()=>{try{return await I(Md,{timeoutMs:2500})}catch{return null}},Hd=async()=>{try{return await I(Od,{timeoutMs:2500})}catch{return null}},Pd=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Bd=(t,e)=>{let o=document.createElement("div");return o.id=Sr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{zd(t,e,()=>Lr(t,e))}),o},Lr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Sd(t,e),Tr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Rd(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Rd=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let h=d.key==="state"?Ld(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Ad(r,p).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),d.disabled=!1;return}Lr(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),d.disabled=!1}))})})},bo=!1,Fa=(t,e)=>{bo=e;let o=Pd(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Fd,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Lr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Na,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Na="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Fd="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Nd=t=>{let e=document.createElement("button");return e.id=Ra,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Na,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${$d.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!bo;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Fa(r,a)}),e},zd=(t,e,o)=>{let r=document.getElementById(Pa);r&&r.remove();let a=document.createElement("div");a.id=Pa,a.style.cssText=`
  ...
  `,m=f=>{let T=i.querySelector("#ws-buybox-state-search"),L=i.querySelectorAll(".ws-buybox-state-row");L.forEach(P=>{P.addEventListener("mouseenter",()=>{P.style.background=n.emeraldGlow}),P.addEventListener("mouseleave",()=>{P.style.background="transparent"}),P.addEventListener("click",()=>{s.stateCode=P.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let P=(T.value||"").toLowerCase().trim();f.forEach((q,z)=>{let N=L[z];if(!N)return;let B=!P||q.name.toLowerCase().includes(P)||q.code.toLowerCase()===P;N.style.display=B?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=f=>`
  ...
  `,x=f=>{let T=f.find(L=>L.code===s.stateCode);return`
    ...
    `},k=f=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},y=f=>{let T=s.granularity==="county"?yt?.[s.stateCode||""]??[]:ft?.[s.stateCode||""]??[];return`
    ...
    `},g=()=>{let f=s.granularity==="county"?yt?.[s.stateCode||""]??[]:ft?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),L=i.querySelector("#ws-buybox-value-list");if(!T||!L)return;let P=q=>{let z=q.toLowerCase().trim();if(!z){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=f.filter(B=>B.toLowerCase().includes(z)).slice(0,50);if(N.length===0){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(s.stateCode||"")}.</div>`;return}L.innerHTML=N.map(B=>`
  ...
  `,S=()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");f&&(f.addEventListener("input",()=>{f.value=f.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),f.addEventListener("keydown",L=>{L.key==="Enter"&&(L.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>f.focus(),0))},C=async()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),L=(f?.value||"").trim();if(!/^\d{5}$/.test(L)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(L)},E=async f=>{if(!s.granularity||!f)return;let T=i.querySelector("#ws-buybox-err"),L=i.querySelector("#ws-buybox-save");L&&(L.disabled=!0,L.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await Cd(t,e,s.granularity,f);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),L&&(L.disabled=!1,L.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),L&&(L.disabled=!1,L.textContent="Add")}};l()},Er=!1,Je=null,xt=null,Ba=()=>{document.getElementById(Ra)?.remove(),document.getElementById(Sr)?.remove(),xt&&Je&&Je.nav.removeEventListener("click",xt,!0),xt=null,Je=null,bo=!1},za=()=>{Gd()},Gd=async()=>{if(!Er){Er=!0;try{let t=R();if(!t){Ba();return}let e=document.getElementById(Sr);if(e&&e.dataset.buyerContactId===t.contactId&&Je)return;Ba();let o=null;try{o=await Ke(t.contactId,t.locationId)}catch(h){c.warn("[buy-box] Contact Type fetch failed",h);return}if(Ye(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Dd(),Hd()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=R();if(!s||s.contactId!==t.contactId)return;let l=Bd(t.locationId,t.contactId),d=Nd(()=>Je),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Je=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),xt=h=>{let m=h.target;if(!m||p.iconBtn.contains(m))return;m.closest("button.sidebar-option-button")&&bo&&Fa(p,!1)},a.addEventListener("click",xt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Er=!1}}};var ke="ws-crm-claim-release-pill",qd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Ud="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Vd=async t=>{let e=await fetch(qd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Wd=async t=>{let e=await fetch(Ud,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ua=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Xe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=La(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},jd=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ke,o.type="button",o.dataset.contactId=t,Xe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=R();if(!a||!a.locationId||a.contactId!==t)return;let i=M();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Xe(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Xe(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Wd({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Xe(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),Xe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Ga=async(t,e)=>{try{let o=await Vd({contactId:e.contactId,locationId:e.locationId,userId:M()}),r=document.getElementById(ke);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Xe(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Kd=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Ua(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},qa=(t,e)=>{let o=jd({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ke}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Yd=async()=>{let t=R();if(!t){document.getElementById(ke)?.remove();return}let e=document.getElementById(ke);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await I("#record-details-lhs",{timeoutMs:1e4}),r=await Kd(o),a=R();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}qa(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ke);i&&t.locationId&&Ga(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(R()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ke))return;let d=Ua(o);if(d){qa(d,t.contactId);let p=document.getElementById(ke);p&&t.locationId&&Ga(p,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},Va=()=>{Yd()};var Qa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Jd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Xd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Qd=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||Qa,d;if(s==="buyer"){let b=Za.find(m=>m.label===o),h=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:h,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Zd=async({contactId:t,tenantId:e})=>{let o=await fetch(Xd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Qe="ws-crm-contact-actions-bar",ec="ws-crm-call-status-dropdown",Wa="ws-crm-offer-made-modal",tc=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Za=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],oc=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],rc=async()=>{for(let t of oc)try{let e=await I(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await I("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},nc=({contactId:t,kind:e})=>{let o=e==="buyer"?Za:tc,r=e==="buyer"?Jd:Qa,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=ec,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=O,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>sc(t,e)),o.appendChild(r),o.appendChild(nc({contactId:t,kind:e}))}return o},$r=!1,Ja=()=>{document.querySelectorAll(`[id="${Qe}"]`).forEach(t=>t.remove())},ei=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),$r){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}$r=!0;try{await cc()}finally{$r=!1}},cc=async()=>{let t=R();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Ja();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Ja();return}let e="seller";try{let p=await Ke(t.contactId,t.locationId),b=Ye(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=R();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Qe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await rc();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=R();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Ya(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Qe)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(R()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Qe}"]`);if(b.length>1){for(let h=1;h<b.length;h++)b[h].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let h=document.querySelector(".central-panel")||a,m=Ya(t.contactId,e);m.dataset.mountTarget=s.dataset.mountTarget??"";try{h.insertBefore(m,h.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Xa=null,pc=()=>{Xa===null&&(Xa=window.setInterval(()=>{let t=R();t&&(document.getElementById(Qe)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ei()))},3e3))},ti=()=>{pc(),ei()};var mo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",bc=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),wt="data-ws-crm-favicon",Ir=t=>t.hasAttribute(wt),oi=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return bc.has(e)},ho=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{oi(r)&&!Ir(r)&&r.remove()});let e=document.head.querySelector(`link[${wt}="1"]`);e?e.href!==mo&&(e.href=mo):(e=document.createElement("link"),e.setAttribute(wt,"1"),e.rel="icon",e.type="image/png",e.href=mo,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${wt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(wt,"apple"),o.rel="apple-touch-icon",o.href=mo,document.head.appendChild(o))},ri=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)ho();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),ho())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&oi(s)&&!Ir(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ir(s)&&(a=!0)});a&&ho()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,ho(),e>=5&&window.clearInterval(o)},1e3)};var mc=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],hc=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,uc=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(uc);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(hc);if(a){let i=a[1];if(mc.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ni="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(ni);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=ni,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var vc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",se="ws-crm-mt-offer-made-button",ai="ws-crm-mt-offer-made-modal",_c=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gc=/\/v2\/location\/([A-Za-z0-9]+)/,_o=()=>{let t=window.location.pathname,e=t.match(_c);if(!e)return null;let o=t.match(gc);return{oppId:e[1],locationId:o?o[1]:null}},yc=async t=>{let e=await fetch(vc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},uo=()=>{document.getElementById(ai)?.remove()},fc=t=>{uo();let e=document.createElement("div");e.id=ai,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=_o();!o||!o.locationId||o.oppId!==t||fc({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},wc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kc=async()=>{for(let t of wc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vo=!1,Hr=async()=>{if(!vo){vo=!0;try{await Ec()}finally{vo=!1}}},Ec=async()=>{let t=_o();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),Et();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),Et());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await kc();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_o();if(!a||a.oppId!==t.oppId)return;let i=xc(t.oppId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Tc(t.oppId)},kt=null,Dr=null,Et=()=>{kt?.disconnect(),kt=null,Dr=null},Tc=t=>{if(kt&&Dr===t)return;Et();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dr=t,kt=new MutationObserver(()=>{let o=_o();if(!o||o.oppId!==t){Et();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),Et();return}document.getElementById(se)||Hr()}),kt.observe(e,{childList:!0,subtree:!0}))},Mr=null,Or,Sc=()=>{Mr||(Mr=new MutationObserver(()=>{Or===void 0&&(Or=window.setTimeout(()=>{Or=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!vo&&Hr()},300))}),Mr.observe(document.body,{childList:!0,subtree:!0}))},ii=()=>{Sc(),Hr()};var Cc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",le="ws-crm-not-interested-button",Ac=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Lc=/\/v2\/location\/([A-Za-z0-9]+)/,yo=()=>{let t=window.location.pathname,e=t.match(Ac);if(!e)return null;let o=t.match(Lc);return{oppId:e[1],locationId:o?o[1]:null}},$c=async t=>{let e=await fetch(Cc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ic=t=>{let e=document.createElement("button");return e.id=le,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=yo();if(!o||!o.locationId||o.oppId!==t)return;let r=M(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await $c({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Mc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Oc=async()=>{for(let t of Mc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},go=!1,Fr=async()=>{if(!go){go=!0;try{await Dc()}finally{go=!1}}},Dc=async()=>{let t=yo();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),St();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),St());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await Oc();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=yo();if(!a||a.oppId!==t.oppId)return;let i=Ic(t.oppId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Hc(t.oppId)},Tt=null,Rr=null,St=()=>{Tt?.disconnect(),Tt=null,Rr=null},Hc=t=>{if(Tt&&Rr===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rr=t,Tt=new MutationObserver(()=>{let o=yo();if(!o||o.oppId!==t){St();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),St();return}document.getElementById(le)||Fr()}),Tt.observe(e,{childList:!0,subtree:!0}))},Pr=null,Br,Pc=()=>{Pr||(Pr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!go&&Fr()},300))}),Pr.observe(document.body,{childList:!0,subtree:!0}))},si=()=>{Pc(),Fr()};var Bc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ae="ws-crm-schedule-walkthrough-button",Nr="ws-crm-schedule-walkthrough-modal",Rc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fc=/\/v2\/location\/([A-Za-z0-9]+)/,wo=()=>{let t=window.location.pathname,e=t.match(Rc);if(!e)return null;let o=t.match(Fc);return{oppId:e[1],locationId:o?o[1]:null}},fo=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Nc=(t,e)=>{document.getElementById(Nr)?.remove();let o=document.createElement("div");o.id=Nr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=wo();!o||!o.locationId||o.oppId!==t||Nc(o.oppId,o.locationId)}),e},Gc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],qc=async()=>{for(let t of Gc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},xo=!1,Ur=async()=>{if(!xo){xo=!0;try{await Uc()}finally{xo=!1}}},Uc=async()=>{let t=wo();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),At();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),At());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await qc();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=wo();if(!a||a.oppId!==t.oppId)return;let i=zc(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Vc(t.oppId)},Ct=null,qr=null,At=()=>{Ct?.disconnect(),Ct=null,qr=null},Vc=t=>{if(Ct&&qr===t)return;At();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(qr=t,Ct=new MutationObserver(()=>{let o=wo();if(!o||o.oppId!==t){At();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),At();return}document.getElementById(ae)||Ur()}),Ct.observe(e,{childList:!0,subtree:!0}))},zr=null,Gr,Wc=()=>{zr||(zr=new MutationObserver(()=>{Gr===void 0&&(Gr=window.setTimeout(()=>{Gr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!xo&&Ur()},300))}),zr.observe(document.body,{childList:!0,subtree:!0}))},li=()=>{Wc(),Ur()};var jc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ze="ws-crm-resend-deal-link-wrap",Kc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(Kc);if(!e)return null;let o=t.match(Yc);return{oppId:e[1],locationId:o?o[1]:null}},Jc=async t=>{let e=await fetch(jc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Xc=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),di=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Kr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${di(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Qc(t,e)),t.appendChild(o)},Qc=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Zc(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Kr(t,e)),o.appendChild(s),t.appendChild(o)},Zc=async(t,e,o,r)=>{let a=Eo();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Jc({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${di(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Xc(s)}</span>`}window.setTimeout(()=>Kr(t,e),3500)}},ep=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tp=async()=>{for(let t of ep)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ko=!1,Yr=async()=>{if(!ko){ko=!0;try{await op()}finally{ko=!1}}},op=async()=>{let t=Eo();if(!t||!t.locationId){document.getElementById(Ze)?.remove(),$t();return}let e=document.getElementById(Ze);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),$t());return}e&&e.remove();let o=await tp();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Eo();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ze,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Kr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),rp(t.oppId)},Lt=null,jr=null,$t=()=>{Lt?.disconnect(),Lt=null,jr=null},rp=t=>{if(Lt&&jr===t)return;$t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jr=t,Lt=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){$t();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ze)?.remove(),$t();return}document.getElementById(Ze)||Yr()}),Lt.observe(e,{childList:!0,subtree:!0}))},Vr=null,Wr,np=()=>{Vr||(Vr=new MutationObserver(()=>{Wr===void 0&&(Wr=window.setTimeout(()=>{Wr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ze)&&!ko&&Yr()},300))}),Vr.observe(document.body,{childList:!0,subtree:!0}))},ci=()=>{np(),Yr()};var ap="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",de="ws-crm-reduce-price-button",pi="ws-crm-reduce-price-modal",ip=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sp=/\/v2\/location\/([A-Za-z0-9]+)/,Co=()=>{let t=window.location.pathname,e=t.match(ip);if(!e)return null;let o=t.match(sp);return{oppId:e[1],locationId:o?o[1]:null}},lp=async t=>{let e=await fetch(ap,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},To=()=>{document.getElementById(pi)?.remove()},dp=t=>{To();let e=document.createElement("div");e.id=pi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Co();!r||!r.locationId||r.oppId!==t||dp({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},pp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bp=async()=>{for(let t of pp)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},So=!1,Zr=async()=>{if(!So){So=!0;try{await mp()}finally{So=!1}}},mp=async()=>{let t=Co();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Mt();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),Mt());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await bp();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Co();if(!a||a.oppId!==t.oppId)return;let i=cp(t.oppId,t.locationId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),hp(t.oppId)},It=null,Qr=null,Mt=()=>{It?.disconnect(),It=null,Qr=null},hp=t=>{if(It&&Qr===t)return;Mt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qr=t,It=new MutationObserver(()=>{let o=Co();if(!o||o.oppId!==t){Mt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Mt();return}document.getElementById(de)||Zr()}),It.observe(e,{childList:!0,subtree:!0}))},Jr=null,Xr,up=()=>{Jr||(Jr=new MutationObserver(()=>{Xr===void 0&&(Xr=window.setTimeout(()=>{Xr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!So&&Zr()},300))}),Jr.observe(document.body,{childList:!0,subtree:!0}))},bi=()=>{up(),Zr()};var et="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Ao="deals.reinvestos.com";var ce="ws-crm-edit-landing-button",vp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_p=/\/v2\/location\/([A-Za-z0-9]+)/,$o=()=>{let t=window.location.pathname,e=t.match(vp);if(!e)return null;let o=t.match(_p);return{oppId:e[1],locationId:o?o[1]:null}},gp=(t,e)=>{let o=new URL(`https://${Ao}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",et);let r=M();return r&&o.searchParams.set("user",r),o.toString()},yp=(t,e)=>{let o=document.createElement("button");return o.id=ce,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=$o();if(!r||!r.locationId||r.oppId!==t)return;if(!et){c.warn("[edit-landing] editor session key not configured in this build");return}let a=gp(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},fp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xp=async()=>{for(let t of fp)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lo=!1,rn=async()=>{if(!Lo){Lo=!0;try{await wp()}finally{Lo=!1}}},wp=async()=>{let t=$o();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Dt();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Dt());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=await xp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=$o();if(!a||a.oppId!==t.oppId)return;let i=yp(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ce}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),kp(t.oppId)},Ot=null,on=null,Dt=()=>{Ot?.disconnect(),Ot=null,on=null},kp=t=>{if(Ot&&on===t)return;Dt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(on=t,Ot=new MutationObserver(()=>{let o=$o();if(!o||o.oppId!==t){Dt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Dt();return}document.getElementById(ce)||rn()}),Ot.observe(e,{childList:!0,subtree:!0}))},en=null,tn,Ep=()=>{en||(en=new MutationObserver(()=>{tn===void 0&&(tn=window.setTimeout(()=>{tn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lo&&rn()},300))}),en.observe(document.body,{childList:!0,subtree:!0}))},mi=()=>{Ep(),rn()};var ui="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",tt="ws-crm-publish-button",Ht="ws-crm-publish-wrap",Mo="ws-crm-publish-dropdown",Tp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Sp=/\/v2\/location\/([A-Za-z0-9]+)/,sn=()=>{let t=window.location.pathname,e=t.match(Tp);if(!e)return null;let o=t.match(Sp);return{oppId:e[1],locationId:o?o[1]:null}},Cp=async(t,e)=>{try{let o=await fetch(ui,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},Ap=async(t,e)=>{let o=await fetch(ui,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Lp=(t,e)=>{if(!et){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Ao}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",et);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ge=()=>{document.getElementById(Mo)?.remove()},hi=(t,e,o,r,a)=>{ge();let i=document.createElement("div");i.id=Mo;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Be(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let h=await Cp(t,e);if(!h||!Array.isArray(h.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Be(o,r);return}r={status:h.published?"published":h.ready?"ready":"incomplete",checks:h.checks},Be(o,r),document.getElementById(Mo)&&r.checks&&hi(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Be(o,r),ge();try{let h=await Ap(t,e);if(h.ok&&h.published)r={status:"published"},Be(o,r),c.info(`[publish] published opp ${t}`);else if(h.missing&&h.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Be(o,r);else throw new Error(h.error||"Publish failed")}catch(h){let m=h instanceof Error?h.message:"Publish failed";c.error("[publish] publish failed",h),r={status:"error",message:m.length>28?"Error \u2014 try again":m},Be(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Mo)?ge():r.checks&&hi(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let h=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});h.observe(b,{childList:!0,subtree:!0});let m=window.setInterval(()=>{document.body.contains(o)||(h.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(m))},5e3)}return o},Ip=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mp=async()=>{for(let t of Ip)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Io=!1,dn=async()=>{if(!Io){Io=!0;try{await Op()}finally{Io=!1}}},Op=async()=>{let t=sn();if(!t||!t.locationId){document.getElementById(tt)?.remove(),document.getElementById(Ht)?.remove(),ge(),Bt();return}let e=document.getElementById(tt);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(Ht)?.remove(),ge(),Bt());return}e&&(e.remove(),document.getElementById(Ht)?.remove(),ge());let o=await Mp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=sn();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=$p(t.oppId,a.locationId),s=document.createElement("span");s.id=Ht,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),Dp(t.oppId)},Pt=null,ln=null,Bt=()=>{Pt?.disconnect(),Pt=null,ln=null},Dp=t=>{if(Pt&&ln===t)return;Bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ln=t,Pt=new MutationObserver(()=>{let o=sn();if(!o||o.oppId!==t){Bt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(tt)?.remove(),document.getElementById(Ht)?.remove(),ge(),Bt();return}document.getElementById(tt)||dn()}),Pt.observe(e,{childList:!0,subtree:!0}))},nn=null,an,Hp=()=>{nn||(nn=new MutationObserver(()=>{an===void 0&&(an=window.setTimeout(()=>{an=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(tt)&&!Io&&dn()},300))}),nn.observe(document.body,{childList:!0,subtree:!0}))},vi=()=>{Hp(),dn()};var _i="data:image/png;base64,",gi="data:image/png;base64,";var Pp=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],yi=t=>`ws-crm-map-links-${t}`,Oo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},fi=t=>{let e=Oo(t.addr),o=Oo(t.city),r=Oo(t.state),a=Oo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Bp=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Rp=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Fp=(t,e)=>{let{full:o,hasAny:r}=fi(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Np=t=>{let e=document.createElement("span");e.id=yi(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),Fp(t,s)}),l};return e.appendChild(r(_i,"Open in Google Maps",Bp)),e.appendChild(r(gi,"Search on Zillow",Rp)),e},zp=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},xi=()=>{for(let t of Pp){if(document.getElementById(yi(t.key)))continue;let{hasAny:e}=fi(t);if(!e)continue;let o=zp(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Np(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},cn=null,pn,Gp=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0;try{xi()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},wi=()=>{Gp(),xi()};var ki="ws-crm-hide-launchpad",Ei=/\/launchpad\/?$/,bn=()=>{if(!me()){if(!document.getElementById(ki)){let t=document.createElement("style");t.id=ki,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Ei.test(location.pathname)){let t=location.pathname.replace(Ei,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var qp=[{label:"Buy-Box Entries"},{label:"Memberships"}],Ti=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},mn=()=>{let t=me(),e=new Set(qp.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Ti(e);for(let o of[150,500,1200,2500])setTimeout(()=>Ti(e),o)}};var Up=[{from:"Payments",to:"Contracts"}],Vp=".nav-title, .topmenu-navtitle",Si=()=>{document.querySelectorAll(Vp).forEach(t=>{let e=(t.textContent||"").trim(),o=Up.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},hn=()=>{Si();for(let t of[150,500,1200,2500])setTimeout(Si,t)};var Ci="/payments/proposals-estimates",Wp=/\/payments\/invoices\/?$/,jp=/\/payments\//,Kp='#sb_payments, a[meta="payments"]',Li=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ci)&&!(t>3&&!jp.test(e))){if(Wp.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ci));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Li(t+1),120)}},Ai=!1,Yp=()=>{Ai||(Ai=!0,document.addEventListener("click",t=>{t.target?.closest?.(Kp)&&setTimeout(()=>Li(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},un=()=>{Yp()};var $i=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Ii="ws-crm-hide-topmenu-tabs",vn=()=>{if(document.getElementById(Ii))return;let t=$i.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Ii,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${$i.length} top tabs`)};var Di="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Ee="ws-crm-send-to-closing-office-button",Re="ws-crm-send-to-title-co-wrap",Po="ws-crm-stc-dropdown",Jp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xp=/\/v2\/location\/([A-Za-z0-9]+)/,Bo=()=>{let t=window.location.pathname,e=t.match(Jp);if(!e)return null;let o=t.match(Xp);return{oppId:e[1],locationId:o?o[1]:null}},Qp=5*60*1e3,Hi=t=>`ws-crm-stc-cache:${t}`,Zp=t=>{try{let e=window.localStorage.getItem(Hi(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Qp||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},eb=(t,e)=>{try{window.localStorage.setItem(Hi(t),JSON.stringify(e))}catch{}},tb=async(t,e)=>{try{let o=await fetch(Di,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},ob=async(t,e,o)=>{let r=await fetch(Di,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},rb=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},Mi=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},nb=(t,e)=>{if(e&&rb(e)){window.setTimeout(()=>Mi(t),300);return}Mi(t)},pe=()=>{document.getElementById(Po)?.remove()},Do=(t,e,o)=>{pe();let r=document.createElement("div");r.id=Po;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,he(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let y=await tb(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},he(o,a);return}if(y.rate_limited){_=Date.now()+m,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},he(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},he(o,a),c.warn("[stc] dry_run returned no checks:",y);return}let g=y.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Ro.add(t),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe(),Ft();return}let w=y.checks;if(a.checks&&a.checks.length===y.checks.length){let C=new Set;w=y.checks.map((E,f)=>a.checks[f]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:y.previously_sent_at??null},eb(t,{checks:w,previously_sent_at:y.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),he(o,a),document.getElementById(Po)&&Do(w,y.previously_sent_at,o)},l=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},he(o,a),pe();try{let g=await ob(t,e,y);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},he(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},he(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},he(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},he(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Po)?pe():a.checks&&Do(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),h=1e4,m=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(d!==void 0||p)return;let w=Date.now()-b,S=Math.max(1500,h-w);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},ib=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],sb=async()=>{for(let t of ib)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ro=new Set,Oi=null,lb=t=>{t&&t!==Oi&&(Ro.clear(),Oi=t)},Ho=!1,fn=async()=>{if(Ho){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ho=!0;try{await db()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{Ho=!1}},db=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Bo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),lb(t.oppId),Ro.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Re)?.remove(),pe(),Ft());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Re)?.remove(),pe()),c.debug("[stc] mount:04 calling findMountTarget");let o=await sb();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Bo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=ab(t.oppId,a.locationId),s=document.createElement("span");s.id=Re,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),cb(t.oppId)},Rt=null,yn=null,Ft=()=>{Rt?.disconnect(),Rt=null,yn=null},cb=t=>{if(Rt&&yn===t)return;Ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yn=t,Rt=new MutationObserver(()=>{let o=Bo();if(!o||o.oppId!==t){Ft();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe(),Ft();return}document.getElementById(Ee)||fn()}),Rt.observe(e,{childList:!0,subtree:!0}))},_n=null,gn,pb=()=>{_n||(_n=new MutationObserver(()=>{gn===void 0&&(gn=window.setTimeout(()=>{gn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ee);if(t&&!e&&!Ho){let o=Bo();if(o&&Ro.has(o.oppId))return;fn()}},300))}),_n.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{pb(),fn()};var kn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",bb=`${kn}/tc/welcome-call-prefill`,mb=`${kn}/tc/welcome-call-save`,hb=`${kn}/tc/order-lockbox`,Nt="ws-crm-welcome-call-overlay",ub=["Regular Contract","Subject To","Seller Finance","Novation"],vb=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],_b=["Gas","Electric","Propane","Oil"],gb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],yb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Te=["Yes","No"],fb=["Yes","No","Unknown"],xb=["Professional Photographer","Seller","Tenant"],wb=["Month-to-Month","Annual"],Bi=["Current","Behind"],kb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ue=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),No=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ni="margin-bottom:12px;",zi=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Eb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Ri=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=Ri(o);return`<select id="${t}" style="${No}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Ri(a)===r?"selected":""}>${ue(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${ue(e)}" placeholder="${ue(o)}" style="${No}">`,Tb=(t,e)=>`<textarea id="${t}" rows="3" style="${No}resize:vertical;">${ue(e)}</textarea>`,Sb=(t,e)=>`<input id="${t}" type="date" value="${ue(e)}" style="${No}">`,D=(t,e)=>`<div style="${Ni}"><label style="${zi}">${ue(t)}</label>${e}</div>`,xn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${kb.map(r=>`<label style="${Eb}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ye=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ue(t)}</div>`,ot=()=>{document.getElementById(Nt)?.remove()},Fe=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Cb=t=>{let e=t.tenant||{};return`
    ${ye("Identifiers")}
    ...
    ${ye("Contract")}
    ${D("Type of Contract",j("wc-contract_type",ub,t.contract_type))}

    ${ye("Property")}
    ${D("Property Type",j("wc-property_type",gb,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",vb,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",_b,t.heat_source))}

    ${ye("Liens & Permits")}
    ${D("Is there a mortgage?",j("wc-has_mortgage",Te,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${D("Mortgage payment status",j("wc-mortgage_payment_status",Bi,t.mortgage_payment_status))}</div>
    ...
    ${ye("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",yb,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",wb,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Rent status",j("wc-tenant_rent_status",Bi,e.rent_status))}</div>
        <div style="flex:1;">${D("Last rent paid",Sb("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",fb,t.hoa_rental_restriction))}</div>

    ${ye("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",xb,t.photos_provided_by))}
    <div style="${Ni}">
      <label style="${zi}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${xn("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${xn("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${xn("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
  ...
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},wn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Fi=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Fo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?ue(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Ab=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:wn("photos_avail_mornings"),photos_avail_afternoons:wn("photos_avail_afternoons"),photos_avail_evenings:wn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),Lb=t=>{ot();let e=document.createElement("div");e.id=Nt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Cb(t)}</div>
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Bb=t=>{Gi(t.oppId,t.locationId)},Rb=async(t,e,o)=>(await fetch(Ib,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Fb=(t,e)=>{Ce();let o=document.createElement("div");o.id=Wi,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${En(e.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${En(e.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${En(s)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",b=document.getElementById("wsrl-phone")?.value.trim()||"",h=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!h){Se("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await Rb(t,e,{recipient_name:p,recipient_phone:b,ship_to:h})?(l(),Se("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",Se("Re-order failed \u2014 try again.","err"))}catch(m){c.warn("[action-bar] reorder lockbox failed:",m),d.disabled=!1,d.textContent="Order Lockbox",Se("Couldn't reach the lockbox handler. Try again.","err")}}})},Xi=async t=>{Ce();let e={};try{e=await fetch(`${Mb}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Fb(t,e)},Nb=(t,e)=>{Ce();let o=document.createElement("div");o.id=Ln;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${u.sans};
  `,o.innerHTML=`
    <style>#${Ln} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch($b,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},zb=(t,e)=>{Ce();let o=document.createElement("div");o.id=Vi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Go=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=t,o},Gb=()=>{let t=Go("\u22EE","ghost");return t.style.lineHeight="1",t},qb=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Ki){let r=Go("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Bb(t)),o.appendChild(r),o}if(e===Mn){let r=Go("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Nb(t,r)),o.appendChild(r),o}if(e===Yi){let r=Go("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Xi(t)),o.appendChild(r),o}return null},Ub=(t,e)=>{let o=[];if(e===Mn&&(o=[{label:"Re-order Lockbox",onClick:()=>void Xi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Ui,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Gb();return a.addEventListener("click",i=>{i.stopPropagation(),zb(o,a)}),r.appendChild(a),r},Vb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Wb=async()=>{for(let t of Vb)try{let e=await I(t,{timeoutMs:1200});if(e)return e}catch{}return null},zo=()=>{document.getElementById(An)?.remove(),document.getElementById(Ui)?.remove(),Ce()},qo=!1,On=async()=>{if(!qo){qo=!0;try{let t=Ji();if(!t){zo();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){zo();return}let o=Pb(),r=document.getElementById(An);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=qb(t,o);if(!a){zo();return}let i=await Wb();if(!i)return;zo();let s=U(i),l=document.createElement("span");l.id=An,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ub(t,o);d&&s.appendChild(d),jb(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{qo=!1}}},zt=null,$n=null,Tn,qi=()=>{zt?.disconnect(),zt=null,$n=null},jb=t=>{if(zt&&$n===t)return;qi();let e=document.querySelector(ji);e&&($n=t,zt=new MutationObserver(()=>{let o=Ji();if(!o||o.oppId!==t){qi();return}Tn===void 0&&(Tn=window.setTimeout(()=>{Tn=void 0,On()},250))}),zt.observe(e,{childList:!0,subtree:!0}))},Sn=null,Cn,Kb=()=>{Sn||(Sn=new MutationObserver(()=>{Cn===void 0&&(Cn=window.setTimeout(()=>{Cn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!qo&&On()},300))}),Sn.observe(document.body,{childList:!0,subtree:!0}))},Qi=()=>{Kb(),On()};var Zi="ws-support-modal",es="ws-support-toast",Yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",ts="ws-support-submitter-name",os="ws-support-submitter-email",rs="ws-support-submitter-role",Jb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ne=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Xb=(t,e="success",o)=>{let r=document.getElementById(es);r&&r.remove();let a=document.createElement("div");a.id=es;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Qb=()=>{document.getElementById(Zi)?.remove();let t=(localStorage.getItem(ts)??"").trim(),e=(localStorage.getItem(os)??"").trim(),o=(localStorage.getItem(rs)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Zi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(ts,r.submitterName),localStorage.setItem(os,r.submitterEmail),r.submitterRole&&localStorage.setItem(rs,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let m=await(await fetch(Yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!m.ok){d(m.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=m.ticket_short_id||"submitted";Xb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Zb=["/support-ticket","ws-support-modal","ws-support"],em=/\/custom-menu-link\//,Dn=!1,ns=()=>{if(Dn||!em.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Zb.some(s=>i.includes(s))});if(r){Dn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Qb(),Dn=!1},50);return}t<10&&setTimeout(e,150)};e()},as=!1,is=()=>{as||(as=!0,ne(()=>setTimeout(ns,50)),ns(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var ss="ws-phone-assignments-modal",ls="ws-phone-assignments-toast",tm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",om="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",rm=["ACQ","DISPO","TC"],ps="",Ae=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),nm=(t,e="success",o)=>{document.getElementById(ls)?.remove();let r=document.createElement("div");r.id=ls;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Ae(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Ae(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},am=(t,e,o)=>{let r=[`<option value="" ${o===ps?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Ae(a)}" ${o===a?"selected":""}>${Ae(a)}</option>`)].join("");return`<select data-assign="${Ae(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},im=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Pn=async t=>{document.getElementById(ss)?.remove();let e=t||re(),o=document.createElement("div");o.id=ss,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",m=>{m.target===o&&o.remove()}),!e){let m=r.querySelector("#ws-pa-body");m&&(m.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${tm}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(m){c.error("[phone-assignments] GET failed",m);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Ae(m.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:rm,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=m=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${m} found.</div>`,p=s.length?s.map(m=>`<div style="${im}">
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(m=>{m.addEventListener("change",()=>{let _=m.getAttribute("data-assign")||"",[x,...k]=_.split(":"),y=k.join(":");x==="num"&&(m.value?l[y]=m.value:delete l[y])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let m=h.querySelector("#ws-pa-err"),_=k=>{m&&(m.textContent=k)};_("");let x=h.querySelector("#ws-pa-save");x&&(x.disabled=!0,x.textContent="Saving\u2026",x.style.opacity="0.7");try{let y=await(await fetch(om,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:l})})).json();if(!y.ok){_(y.error||"Save failed."),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1");return}o.remove(),nm("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){_(`Network error: ${k.message}`),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1")}}))},sm=["ws-phone-assignments","phone-assignments"],lm=/\/custom-menu-link\//,Hn=!1,ds=()=>{if(Hn||!lm.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return sm.some(s=>i.includes(s))});if(r){Hn=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{Pn(i),Hn=!1},50);return}t<10&&setTimeout(e,150)};e()},cs=!1,bs=()=>{if(cs)return;cs=!0,ne(()=>setTimeout(ds,50)),ds();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Pn()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Pn(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var hs="powerDialerApp",dm=".dialer",cm='button[aria-label="Voice Calling"], button[title="Voice Calling"]',pm=".dial-item.dial-btn.dial-btn-enabled",ze=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Bn=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},us=()=>{try{let e=window[hs]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){c.debug("[dialer-bridge] getEmitter failed",t)}return null},rt=()=>document.querySelector(dm),Uo=()=>us()!==null||rt()!==null?!0:!!window[hs],Vo=(t,e)=>{let o=us();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return c.error(`[dialer-bridge] emit ${t} threw`,r),!1}},vs=()=>{if(rt())return;let t=document.querySelector(cm);t?ze(t):c.warn("[dialer-bridge] Voice Calling button not found")},bm=()=>{let t=document.querySelector(".number-list-container")||rt();if(!t)return[];let e=[...t.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of e){let i=Bn(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},ms=()=>{let t=document.querySelector(".number-config .ui-text-sm-medium");if(t){let o=Bn(t.innerText);if(o)return o}let e=document.querySelector(".number-config");return e?Bn(e.innerText):null},_s=t=>{if(ms()===t)return!0;let e=document.querySelector(".number-config, .dialer-config");e&&ze(e);let o=bm().find(r=>r.e164===t);return o?(ze(o.el),ms()===t):(c.warn(`[dialer-bridge] Calling From ${t} not available to this rep`),!1)},gs=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(t=>/local/i.test(t.innerText||""))||null,mm=()=>{let t=gs();return t?!/bg-gray-100/.test(t.className):!1},ys=t=>{let e=gs();e&&mm()!==t&&ze(e)},fs=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Vo("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&ze(a)}},xs=()=>{let t=rt();if(!t)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(pm)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(ze(e),!0):Vo("makeCall",{provider:"twilio"})};var Rn=()=>{let t=rt();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?ze(e.closest("button")||e):Vo("closeCallBox")},ws=()=>{Vo("closeCallBox")},ks=t=>{let e=!1,o=()=>{let i=rt()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(e=!0),e&&l){e=!1;try{t()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var hm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",um="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Es=["acq","dispo","tc"],qt={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Gt=null,Ts=null,vm=async(t=!1)=>{let e=re();if(!e)return{};if(!t&&Gt&&Ts===e)return Gt;try{return Gt=(await(await fetch(`${hm}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json())?.config?.numberTeam??{},Ts=e,Gt}catch(o){return c.warn("[silo] number-team config load failed",o),Gt??{}}},Ge=null,Ss=null,Fn=async(t=!1)=>{let e=re(),o=M();if(!e||!o)return[];if(!t&&Ge&&Ss===e)return Ge;try{let i=(await(await fetch(um,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(s=>s.id===o);if(i){let s=i.role_keys??[];Ge=Es.filter(l=>s.includes(l))}else me()?Ge=[...Es]:Ge=[];return Ss=e,Ge}catch(r){return c.warn("[silo] roster load failed",r),Ge??[]}},As=()=>`ws-pd-calling-as:${M()||"anon"}`,Ls=t=>{try{localStorage.setItem(As(),t)}catch{}},Nn=async()=>{let t=await Fn();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(As())}catch{}return e&&t.includes(e)?e:t[0]},Cs=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},_m=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),$s=async t=>{let e=await Nn();if(!e)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let o=await vm(),r=_m(o,e);if(!r.length)return c.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let a=Cs(t),i=a?r.find(d=>Cs(d)===a):void 0,s=i||r[0];try{ys(!1)}catch{}return _s(s)?(c.info(`[silo] ${qt[e]}: calling ${t} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} (not in this rep's picker?)`),null)};var gm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",Is="data-ws-pd",Ms="ws-pd-panel",Os="ws-pd-session",qe=t=>new Promise(e=>setTimeout(e,t)),Ut=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ym=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},fm=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},xm=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),e.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},wm=async t=>{let e=ym(t);if(!e)return[];let o=fm(e),r=-1;for(let a=0;a<60;a++){let i=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await qe(550)}return o.scrollTop=0,xm(e)},km=async(t,e)=>{try{let r=await(await fetch(gm,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},Em=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,Gn=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(Ms)?.remove();let r=document.createElement("div");r.id=Ms,r.style.cssText=Em;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let i=e.map((p,b)=>`<label data-row="${b}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,i.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Rn()}catch{}i.remove()}),i.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Rn()}catch{}}),i.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),i.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let l=0;l<e.length&&!a.stopped;l++){let d=e[l];a.skip=!1,a.advance=!1,s("Resolving number\u2026",l,d.name);let p=d._phone?{name:d.name,phone:d._phone}:await km(r,d.contactId);if(a.stopped)break;if(!p||!p.phone){s("No phone on file \u2014 skipping",l,d.name||p?.name||d.contactId),await qe(1400);continue}let b=p.name||d.name;if(await $s(p.phone),a.stopped)break;s(`Calling ${p.phone}\u2026`,l,b);try{vs(),await qe(250),fs(p.phone),await qe(250),xs()}catch(h){c.error("[bulk-dialer] dial failed",h)}if(await new Promise(h=>{let m=!1,_=()=>{m||(m=!0,x(),h())},x=ks(_),k=window.setInterval(()=>{(a.stopped||a.skip)&&(window.clearInterval(k),_())},300)}),a.stopped)break;try{ws()}catch{}if(l<e.length-1)if(o)for(let h=5;h>0&&!a.stopped&&!a.advance;h--){for(s(`Next call in ${h}s\u2026`,l,b);a.paused&&!a.stopped&&!a.advance;)await qe(200);if(a.advance||a.stopped)break;await qe(1e3)}else for(s("Ready \u2014 press Call Next",l,b);!a.advance&&!a.stopped;)await qe(200)}a.stopped||(i.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>i.remove(),5e3))},qn='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Un=()=>{try{if(localStorage.getItem("ws-pd")==="1")return!0}catch{}return me()},Tm=()=>{if(io()!=="opportunity-list"||!Un()||!Uo())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${Is}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(Is,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${qn}<span>DIAL</span>`,a.addEventListener("click",async i=>{i.stopPropagation(),i.preventDefault();let s=a.querySelector("span"),l=s?.textContent||"DIAL";s&&(s.textContent="Loading\u2026"),a.style.opacity="0.7";try{let d=await wm(e);Gn(r,d)}catch(d){c.error("[bulk-dialer] harvest failed",d)}finally{s&&(s.textContent=l),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},nt=null,zn,Hs=()=>{window.WS_CRM_PD_TEST=e=>void Ds("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{zn!==void 0&&window.clearTimeout(zn),zn=window.setTimeout(Tm,400)};ne(e=>{e==="opportunity-list"?(t(),nt||(nt=new MutationObserver(t),nt.observe(document.body,{childList:!0,subtree:!0}))):nt&&(nt.disconnect(),nt=null)})};var Ps="ws-crm-pd-contacts-btn",Sm=t=>new Promise(e=>setTimeout(e,t)),Cm=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},Am=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Vn=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let d=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(d&&d.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let i=(r?.textContent||"").replace(/\s+/g," ").trim(),s=Cm(o.textContent||""),l=i&&i!=="-"?i:s||a;t.set(a,{oppId:"",contactId:a,name:l,_phone:s||void 0})})},Lm=async t=>{let e=new Map;if(t)return Vn(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(Vn(e,!1),!o)return[...e.values()];let r=-1,a=-1,i=0;for(let s=0;s<200&&(Vn(e,!1),e.size===a?i++:(i=0,a=e.size),!(s>0&&o.scrollTop===r&&i>=2));s++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await Sm(220);return o.scrollTop=0,[...e.values()]},$m=()=>{if(io()!=="contact-list"||!Un()||!Uo()||document.getElementById(Ps))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=Ps,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${u.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${qn}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let i=e.querySelector("span"),s=i?.textContent||"Power Dialer";i&&(i.textContent="Loading\u2026"),e.style.opacity="0.7";try{let l=Am(),d=await Lm(l);Gn(l?"Selected contacts":"Smart list",d,{one:"contact",many:"contacts"})}catch(l){c.error("[bulk-dialer-contacts] harvest failed",l)}finally{i&&(i.textContent=s),e.style.opacity="1"}}),t.appendChild(e)},at=null,Wn,Bs=!1,Rs=()=>{if(Bs)return;Bs=!0;let t=()=>{Wn!==void 0&&window.clearTimeout(Wn),Wn=window.setTimeout($m,400)};ne(e=>{e==="contact-list"?(t(),at||(at=new MutationObserver(t),at.observe(document.body,{childList:!0,subtree:!0}))):at&&(at.disconnect(),at=null)})};var Wo="ws-calling-as-chip",Im=()=>{try{if(localStorage.getItem("ws-pd")==="1")return!0}catch{}return me()},jn=!1,Fs=async()=>{if(!jn&&Im()&&!document.getElementById(Wo)){jn=!0;try{let t=await Fn();if(!t.length||document.getElementById(Wo))return;let e=await Nn()??t[0],o=t.length>1,r=document.createElement("div");r.id=Wo,r.style.cssText="position:fixed;bottom:60px;right:20px;z-index:99998;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:8px;padding:7px 12px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${u.sans};font-size:12px;box-shadow:0 6px 18px rgba(0,0,0,0.35);cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${u.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${qt[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let i=s=>{let l=a.querySelector(".ws-ca-team");l&&(l.textContent=qt[s])};if(o){let s=document.createElement("div");s.style.cssText=`position:absolute;bottom:calc(100% + 6px);right:0;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;`;let l=()=>{s.innerHTML="",t.forEach(d=>{let p=document.createElement("div"),b=d===e;p.style.cssText=`padding:9px 14px;font-family:${u.sans};font-size:13px;color:${b?n.emeraldBright:n.bone};cursor:pointer;background:${b?n.emeraldGlow:"transparent"};`,p.textContent=qt[d],p.addEventListener("mouseenter",()=>{d!==e&&(p.style.background=n.steel)}),p.addEventListener("mouseleave",()=>{d!==e&&(p.style.background="transparent")}),p.addEventListener("click",h=>{h.stopPropagation(),e=d,Ls(d),i(d),l(),s.style.display="none"}),s.appendChild(p)})};l(),r.appendChild(s),a.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="block"?"none":"block"}),document.addEventListener("click",()=>{s.style.display="none"})}document.body.appendChild(r),c.info(`[calling-as] chip mounted (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){c.error("[calling-as] build failed",t)}finally{jn=!1}}},Ns=()=>{Fs(),ne(()=>{document.getElementById(Wo)||Fs()})};var Mm="#12161D",Om="#EDEEF0",zs=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],i=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&i>=230},Gs=t=>{t.style.setProperty("background-color",Mm,"important"),t.style.setProperty("color",Om,"important")},Dm=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},Hm=t=>{zs(t)&&Gs(t);for(let e of Array.from(t.querySelectorAll("*")))zs(e)&&Gs(e)},Kn=null,Vt=null,Us=()=>{Vt&&(Vt.disconnect(),Vt=null),Kn=null},Pm=t=>{if(Kn===t)return;Us(),Kn=t;let e=!1,o=()=>{e=!1;try{Hm(t)}catch(a){c.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Vt=new MutationObserver(r),Vt.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),c.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},qs=!1,Vs=()=>{if(qs)return;qs=!0;let t=()=>{let o=Dm();o?Pm(o):Us()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var Bm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Rm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Fm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ks="tc_closing_agent",Nm="tc_closing_office",be="ws-crm-closing-agent-picker-button",Ys="ws-crm-closing-agent-picker-modal",zm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gm=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(zm);if(!e)return null;let o=t.match(Gm);return{oppId:e[1],locationId:o?o[1]:null}},oa=async t=>{let e=await fetch(Bm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ws=async t=>{let e=await fetch(Rm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},qm=async(t,e)=>{try{let o=await fetch(Fm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Ks}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await oa({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Ue=null,Um=60*60*1e3,ra=t=>`ws-crm-to-cache:${t}`,Js=t=>{try{let e=window.localStorage.getItem(ra(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Um||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Xs=(t,e,o)=>{try{window.localStorage.setItem(ra(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Vm=t=>{try{window.localStorage.removeItem(ra(t))}catch{}},Qn="ws-crm-closing-agent-field-link",Wm=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Qn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Yn=!1,na=async t=>{if(Yn)return;let e=Qs();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Yn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await oa({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Zn(a.id,a.name,t);let i=document.getElementById(be);if(i){Le(i,{status:"linked",contactName:a.name});let s=Kt();s&&Xs(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Yn=!1}}},jm=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Qs=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();jm.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let h=d.getAttribute(b);h&&/Title\s+Officer/i.test(h)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:h})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Zn=(t,e,o)=>{let r=Qs();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Qn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Qn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},jo=()=>{document.getElementById(Ys)?.remove()},Km=t=>{jo();let e=document.createElement("div");e.id=Ys,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&jo()}),i?.addEventListener("click",jo);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await oa({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};Le(o,r);let a=Js(t);return a&&(r={status:"linked",contactName:a.contactName},Le(o,r),Ue={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await qm(t,e);s?(r={status:"linked",contactName:s.name},Le(o,r),Ue={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Zn(s.id,s.name,e)):a||(r={status:"empty"},Le(o,r),Ue?.oppId===t&&(Ue=null),Wm(),Vm(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Km({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Le(o,r);try{let l=[Ws({tenantId:e,oppId:t,fieldKey:Ks,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ws({tenantId:e,oppId:t,fieldKey:Nm,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Le(o,r),Ue={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Xs(t,s.id,s.name),Zn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Le(o,r)}}})}),o},Jm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Xm=async()=>{for(let t of Jm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Wt=!1,Jo=async()=>{if(!Wt){Wt=!0;try{await Qm()}finally{Wt=!1}}},Qm=async()=>{let t=Kt();if(!t||!t.locationId){document.getElementById(be)?.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo();return}let e=document.getElementById(be);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo());return}e&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Xm();if(!r||!(Js(t.oppId)!==null||Ue!==null&&Ue.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Kt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Ym(t.oppId,i.locationId),l=document.createElement("span");l.id=`${be}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Zm(t.oppId),na(i.locationId)},jt=null,ea=null,ta=null,Yo=()=>{jt?.disconnect(),jt=null,ea=null,ta=null},Zm=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jt&&ea===t&&ta===e||(Yo(),ea=t,ta=e,jt=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t||!o.locationId){Yo();return}document.getElementById(be)||Jo(),na(o.locationId)}),jt.observe(e,{childList:!0,subtree:!0})))},Jn=null,Xn,eh=()=>{Jn||(Jn=new MutationObserver(()=>{Xn===void 0&&(Xn=window.setTimeout(()=>{Xn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(be);t&&!e&&!Wt&&Jo()},300))}),Jn.observe(document.body,{childList:!0,subtree:!0}))},js,th=()=>{js===void 0&&(js=window.setInterval(()=>{let t=Kt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(be)&&!Wt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Jo()),na(t.locationId)},2e3))},Zs=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),eh(),th(),Jo()};var oh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ie="ws-crm-manage-team-cta",el="ws-crm-manage-team-modal",rh=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,tl={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},nh={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ol=()=>{let t=window.location.pathname.match(rh);return t?{tenantId:t[1]}:null},Qo=async t=>{let e=await fetch(oh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ie=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$e=t=>ie(t),aa="ws-crm-manage-team-toast",la=(t,e="info",o=4e3)=>{document.getElementById(aa)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=aa,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(aa)===a&&a.remove()},o)},ia=()=>{document.getElementById(el)?.remove()},ah=(t,e)=>{let o=nh[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ie(e)}</span>
  `},ih=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>ah(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>ih(r,e)).join(""),Zo=async t=>{ia();let e=document.createElement("div");e.id=el,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&ia()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",ia);let r;try{r=await Qo({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+sh(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{lh(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;dh(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;ch(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},lh=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.addEventListener("click",()=>{Zo(t)}),Xo(e),setTimeout(()=>Xo(e),200),setTimeout(()=>Xo(e),800),window.addEventListener("resize",()=>Xo(e)),e},sa=!1,yh=()=>{if(!sa){sa=!0;try{let t=ol();if(!t){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}let e=document.getElementById(Ie);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ie}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ie}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=gh(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{sa=!1}}},rl=()=>{if(!ol()){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}yh()};var fh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",pa="ws-crm-prepare-contract-button",nl="ws-crm-prepare-contract-menu",_e="ws-crm-prepare-contract-modal",al="ws-crm-modal-date-style",fe="https://services.leadconnectorhq.com",pl=()=>{if(document.getElementById(al))return;let t=document.createElement("style");t.id=al,t.textContent=`
  ...
  `,document.head.appendChild(t)},ba="__WS_CRM_CAPTURED_AUTH",xh=50*60*1e3,rr=()=>{try{let t=localStorage.getItem(ba);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>xh?(localStorage.removeItem(ba),null):e:null}catch{return null}},wh=t=>{try{localStorage.setItem(ba,JSON.stringify(t))}catch{}},st=()=>{let t=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},il=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((rr()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),it=async(t,e={},o=2)=>{let r=rr()?.capturedAt??0,a;try{a={...st(),...e.headers??{}}}catch(s){if(o>0&&await il(r,4e3))return it(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await il(r,4e3)?it(t,e,o-1):i},sl=!1,kh=()=>{if(sl)return;sl=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,m=rr()?.authorization;wh({authorization:b,tokenId:h,capturedAt:Date.now()}),m!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let h={};if(b instanceof Headers)b.forEach((m,_)=>h[_.toLowerCase()]=m);else if(Array.isArray(b))b.forEach(([m,_])=>h[m.toLowerCase()]=_);else if(b&&typeof b=="object")for(let m of Object.keys(b))h[m.toLowerCase()]=b[m];e(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},bl=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Eh=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:bl()},Th=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ml="__WS_CRM_TEMPLATES_CACHE_V1",Sh=24*60*60*1e3,ll=t=>{try{let e=window.localStorage.getItem(ml);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Sh?null:o.templates}catch{return null}},Ch=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(ml,JSON.stringify(o))}catch{}},Ah=async t=>{let e=`${fe}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await it(e,{method:"GET"})}catch(s){let l=ll(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ll(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Th(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Ch(t,i),i},Lh=async(t,e)=>{let o=await it(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await it(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},$h=async(t,e)=>{let o=await it(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:st()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Ih=async t=>{let e=await fetch(fh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Mh=async(t,e,o)=>{let r=`${fe}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:st()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Oh=async(t,e)=>{let o=await fetch(`${fe}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:st()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Dh=async t=>{let e=await fetch(`${fe}/contacts/${t}`,{method:"GET",headers:st()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Hh=async(t,e,o,r)=>{let a;try{a=await Oh(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Dh(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},m=await fetch(`${fe}/proposals/document/${e}`,{method:"PUT",headers:{...st(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!m.ok){let _=await m.text().catch(()=>"");return{ok:!1,status:m.status,body:_}}return{ok:!0}},Ph=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},tr="__WS_CRM_PENDING_INSTRUCTIONS",Bh=60*1e3,Rh=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Fh=t=>{let e=(t||"").toLowerCase();for(let o of Rh)if(e.includes(o.matches.toLowerCase()))return o;return null},Nh=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(tr,JSON.stringify(r))}catch{}},zh=()=>{try{let t=localStorage.getItem(tr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Bh?(localStorage.removeItem(tr),null):e}catch{return null}},Gh=()=>{try{localStorage.removeItem(tr)}catch{}},qh=(t,e)=>{document.getElementById(_e)?.remove();let o=document.createElement("div");o.id=_e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Uh=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Vh=()=>{let t=window.location.pathname.match(Uh);if(!t)return;let e=t[1],o=zh();o&&o.proposalId===e&&(Gh(),window.setTimeout(()=>{qh(o.title,o.bodyHtml)},600))},dl="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(dl)?.remove();let r=document.createElement("div");r.id=dl;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},cl=(t,e)=>new Promise(o=>{document.getElementById(_e)?.remove();let r=document.createElement("div");r.id=_e,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),B=E.querySelector("#ws-pc-assignment-fee"),xe=!1;B?.addEventListener("input",()=>{xe=!0});let we=()=>{if(xe)return;let J=Number(N?.value||0);B&&(B.value=String(Math.max(0,J-x)))};N?.addEventListener("input",we);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),ct=Number(N?.value||0),pt=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),bt=Number(B?.value||0),mt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),ht=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),je=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),ut=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!je){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),ct!==h&&(Q.assignmentPrice=ct),pt!==m&&(Q.buyerEMD=pt),bt!==_&&(Q.assignmentFee=bt),mt!==k&&(Q.closingOffice=mt),ht!==y&&(Q.buyerCompanyName=ht);let hr=je!==g||ut!==w||X!==S,ur=Object.keys(Q).length>0||hr,vr=a;ur?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",vr=await or({tenantId:t,contactId:e,template:o,oppId:r,closingDate:je,buyerEarnestDueDate:ut,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",vr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Ta=vr?.debug?.propertyAddress||p,Xl=Ta?`${Ta} - Assignment Agreement`:void 0;await ua(t,e,o,Xl),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},or=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ih({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ua=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Mh(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Hh(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Fh(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Nh(a,s.title,s.bodyHtml)),Ph(t,a)},Kh=async t=>{let e=Eh(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(nl)?.remove();let o=document.createElement("div");o.id=nl,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Ah(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=M();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let g;try{g=await $h(e.tenantId,e.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)b=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let w=await cl(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}b=w,c.info(`[prepare-contract] picked MT opp ${b}`)}}let h=g=>{let w=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),C=String(g.getDate()).padStart(2,"0");return`${w}-${S}-${C}`},m=g=>{let w=new Date;return w.setDate(w.getDate()+g),h(w)},_=m(45),x=m(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await or({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let y=e.contactId||k.contact_id||"";if(!y){Y("Could not resolve buyer contact for this opp.","error",6e3);return}jh({tenantId:e.tenantId,contactId:y,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Lh(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(b.length===1)h=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await cl(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}h=_,c.info(`[prepare-contract] picked ACQ opp ${h}`)}Y("Reading contract data\u2026","info",2500);let m;try{m=await or({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:h,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Wh({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:m})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await ua(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},hl=()=>{let t=document.createElement("button");return t.id=pa,t.type="button",t.style.cssText=`${O} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Kh(t)}),t},Yh="ws-crm-contact-actions-bar",Jh=async()=>{let t=bl();if(!t){document.getElementById(pa)?.remove();return}let e=null;try{e=await I(`#${Yh}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(pa);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=hl();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ve="ws-crm-prepare-contract-button-opp",Yt=`${Ve}-wrap`,Xh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qh=/\/v2\/location\/([A-Za-z0-9]+)/,Zh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ma=()=>{let t=window.location.pathname,e=t.match(Xh);if(!e)return null;let o=t.match(Qh);return o?{oppId:e[1],tenantId:o[1]}:null},eu=async()=>{for(let t of Zh)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},er=!1,Jt=null,ha=null,da=null,ca,Xt=()=>{Jt?.disconnect(),Jt=null,ha=null},tu=t=>{if(Jt&&ha===t)return;Xt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ha=t,Jt=new MutationObserver(()=>{let o=ma();if(!o||o.oppId!==t){Xt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ve)?.remove(),document.getElementById(Yt)?.remove(),Xt();return}document.getElementById(Ve)||ul()}),Jt.observe(e,{childList:!0,subtree:!0}))},ou=()=>{da||(da=new MutationObserver(()=>{ca===void 0&&(ca=window.setTimeout(()=>{ca=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ve);t&&!e&&!er&&ul()},300))}),da.observe(document.body,{childList:!0,subtree:!0}))},ul=async()=>{if(!er){er=!0;try{let t=ma();if(!t){document.getElementById(Ve)?.remove(),document.getElementById(Yt)?.remove(),Xt();return}let e=document.getElementById(Ve);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Yt)?.remove(),Xt());return}e&&(e.remove(),document.getElementById(Yt)?.remove());let o=await eu();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ma();if(!a||a.oppId!==t.oppId)return;let i=hl();i.id=Ve,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Yt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),tu(t.oppId)}finally{er=!1}}},vl=()=>{Vh(),Jh()};kh();function te(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ve(t){return te(t)}var ru="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",We="ws-crm-compute-offer-button",ga="ws-crm-compute-offer-popover",El="ws-crm-offer-modal",_l="ws-crm-contact-actions-bar",nu=[".central-panel","[class*='central-panel']"],Me=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",va=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},au=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],gl=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${au[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},yl=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,_a=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(ru,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},lt=()=>{document.getElementById(ga)?.remove(),document.removeEventListener("mousedown",Tl,!0)};function Tl(t){let e=document.getElementById(ga),o=document.getElementById(We),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&lt()}var Sl=(t,e)=>{lt();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=ga;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Tl,!0),0)},nr=(t,e)=>{Sl(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},iu=(t,e,o)=>{Sl(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{lt(),o(a.property_record_id)}),r.appendChild(i)})})},ar=()=>{document.getElementById(El)?.remove(),document.removeEventListener("keydown",Cl,!0)};function Cl(t){t.key==="Escape"&&ar()}var fl=(t,e,o)=>{ar(),lt();let r=o,a=!1,i="",s=document.createElement("div");s.id=El,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&ar()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,h,m)=>{a||(a=!0,i="",p(),_a({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:h,repairOverride:m}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,h=!!b.has_comps;l.innerHTML="";let m=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"-"));let x=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",ar),m.append(_,x),l.appendChild(m);let k=F("div","padding:14px 18px 18px;");l.appendChild(k);let y=F("select",yl());(b.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(b.tier||b.property_condition)&&(N.selected=!0),y.appendChild(N)}),y.disabled=a,y.addEventListener("change",()=>d("recompute",y.value,g.value.trim()));let g=F("input",yl());g.type="number",g.placeholder="uses the level",g.value=b.repair_override!=null?String(b.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",y.value,g.value.trim()));let w=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(F("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${gl(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",y.value,g.value.trim())),w.append(S),k.appendChild(w),b.low_confidence&&h&&k.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${b.comp_count??0} comps in window.`));let C=b.current_offer!=null;k.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${Me(b.current_offer)}${b.current_offer_date?` \xB7 ${gl(b.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),f=F("div","");f.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),f.appendChild(y);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(f,T),k.appendChild(E);let L=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),P=(z,N,B)=>{let xe=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${B?.strong?"font-weight:700;":""}`),we=F("div","");we.appendChild(F("div",`font-size:${B?.strong?"13":"12"}px;color:${n.bone};`,z)),B?.sub&&we.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,B.sub));let ee=F("div",`font-size:${B?.strong?"15":"12"}px;color:${B?.color||n.bone};white-space:nowrap;`,N);xe.append(we,ee),L.appendChild(xe)};if(h&&b.imv!=null){P("Investor Market Value (IMV)",Me(b.imv)),b.arv!=null&&P("After Repair Value (ARV)",Me(b.arv),{color:n.ash});let z=b.repair_adjustment??0,N=-z,B=b.repair_override?"Repair override":b.property_condition_label||"Repairs";z===0?P(`Repairs (${B})`,"Included",{color:n.ash,sub:`${Me(b.repair_total)} in repairs included at IMV`}):P(`Repairs (${B})`,va(N),{color:N<0?n.crimson:n.emerald,sub:`${Me(b.repair_total)} total, ${Me(b.baseline_repairs)} included at IMV`}),P("Min. Profit Target",va(-(b.profit_target??0)),{color:n.ash}),P("Maximum Cash Offer (MAO)",Me(b.mao),{strong:!0,color:n.blue}),P("Target Profit",va(-(b.ico_delta??0)),{color:n.ash}),P("Initial Cash Offer (ICO)",Me(b.ico),{strong:!0,color:n.blue})}else L.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(L);let q=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);q.textContent=a?"Saving\u2026":i||(h?"Saved to the Property.":""),k.appendChild(q)}p(),document.body.appendChild(s),document.addEventListener("keydown",Cl,!0)},xl=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=We,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){iu(o,s.properties,l=>{a(!0),_a({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?fl(e,d.property_record_id,d):nr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),nr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?fl(e,s.property_record_id,s):nr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await _a({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),nr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},su=async()=>{for(let t of nu)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},wl=async(t,e)=>{let o=e.querySelector(`#${_l}`);if(!o)try{o=await I(`#${_l}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},kl=()=>{let t=document.querySelectorAll(`#${We}`);for(let e=1;e<t.length;e++)t[e].remove()},lu=async()=>{let t=R();if(!t||!t.locationId||t.source!=="url"){document.getElementById(We)?.remove(),lt();return}let e=t.locationId,o=document.getElementById(We);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),lt();let r="seller";try{r=Ye(await Ke(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(We)?.remove();return}let a=await su();if(!a){c.warn("[compute-offer] no central panel found");return}let i=R();if(!i||i.contactId!==t.contactId)return;let s=xl(t.contactId,e);if(!await wl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}kl(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(R()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(We)){let d=xl(t.contactId,e);wl(d,a).then(()=>kl())}});l.observe(a,{childList:!0})},Qt=null,Al=()=>{let t=R()?.contactId??null;if(Qt&&Qt.id===t)return;let e=lu().finally(()=>{Qt?.promise===e&&(Qt=null)});Qt={id:t,promise:e}};var oo="reos-theme-stylesheet",ka="reos-theme-fonts",dt=!1,du=()=>{let t=document.getElementById(ka);t&&t.remove()},cu=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var $=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Jl=()=>{c.info(`Loaded v${so} (built ${lo})`),_r()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):($("mountVersionBadge (initial)",mr),$("mountFavicon",ri),$("mountThemeStylesheet",Ea),$("mountHideLaunchpad",bn),$("mountHideNavItems",mn),$("mountRelabelNav",hn),$("mountHideTopmenuTabs",vn),$("mountContractsSection",un)),$("initPageRouter",Aa),c.info("[main] registering onPageChange subscriber"),ne(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),_r()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),$("unmountThemeStylesheet",Kl);return}$("mountThemeStylesheet",Ea),$("mountVersionBadge",mr),$("mountHideLaunchpad",bn),$("mountHideNavItems",mn),$("mountRelabelNav",hn),$("mountHideTopmenuTabs",vn),$("mountContractsSection",un),$("mountClaimReleaseToggle",Va),$("mountContactActionsBar",ti),$("mountActiveFollowUpButton",Ha),$("mountMtOfferMadeButton",ii),$("mountNotInterestedButton",si),$("mountScheduleWalkthroughButton",li),$("mountResendDealLinkButton",ci),$("mountReducePriceButton",bi),$("mountEditLandingPageButton",mi),$("mountPublishButton",vi),$("mountContactMapLinks",wi),$("mountSendToClosingOfficeButton",Pi),$("mountOppActionBar",Qi),$("mountClosingAgentPickerButton",Zs),$("mountPrepareContractButton",vl),$("mountComputeOfferButton",Al),$("mountManageTeam",rl),$("mountBuyBoxWidget",za),$("mountSupportNavItem",is),$("mountPhoneAssignmentsWidget",bs),$("mountBulkPowerDialer",Hs),$("mountBulkPowerDialerContacts",Rs),$("mountCallingAsChip",Ns),$("mountDialerThemeFix",Vs)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Jl):Jl();})();
