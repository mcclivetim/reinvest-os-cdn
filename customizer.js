/* Wholesaling CRM Customizer v0.49.0 — built 2026-07-06T19:08:04.721Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ko="[wholesaling-crm-customizer]",Gc="__WS_CRM_DEBUG",Kc=()=>!!window[Gc],c={info(...t){console.log(Ko,...t)},warn(...t){console.warn(Ko,...t)},error(...t){console.error(Ko,...t)},debug(...t){Kc()&&console.log(Ko,"[debug]",...t)}};var Vc=/\/v2\/location\/([A-Za-z0-9]+)/,Yc=new Set(["8ntUQzMflUkR0YvrRgVk"]),J=()=>{let t=window.location.pathname.match(Vc);return t?t[1]:null},un=()=>{let t=J();return t!==null&&Yc.has(t)};var Ts=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,_n=/\/v2\/location\/([A-Za-z0-9]+)/,Jc=t=>{let e=t.match(Ts);if(!e)return null;let o=t.match(_n);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Qc=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ts);if(!a)continue;let s=r.match(_n)||window.location.pathname.match(_n);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=Jc(window.location.pathname);return t||Qc()};var Cs=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Yo="",vn=null,oe="other",yn=new Set,Vo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Yo)&&!(t!==vn))){Yo=window.location.pathname,vn=t,oe=Cs(),c.debug("Page/context changed:",oe,Yo,"contact:",t);for(let r of yn)try{r(oe)}catch(a){c.error("Subscriber threw:",a)}}},Et=t=>(yn.add(t),setTimeout(()=>t(oe),0),()=>{yn.delete(t)}),As=()=>{oe=Cs(),Yo=window.location.pathname,vn=D()?.contactId??null,c.debug("Router init, current page:",oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Vo()},history.replaceState=function(o,r,a){e(o,r,a),Vo()},window.addEventListener("popstate",Vo),setInterval(Vo,1e3)},ue=()=>oe;var Zc=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Is=null,Ls=!1,Ss=t=>{let e=t.match(Zc);e&&(Is=e[1])},Ms=()=>{if(!Ls){Ls=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Ss(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Ss(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},c.debug("[opp-id-capture] installed")}catch(t){c.warn("[opp-id-capture] install failed",t)}}},qt=()=>Is;var Jo="0.49.0",Qo="2026-07-06T19:08:04.722Z";var Xc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Zo=new Map,gn=new Map,tp=3e4,Ze=4e3,ep=Ze,$t=async(t,e)=>{if(!t)return null;let o=Zo.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<tp)return null}if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=gn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),ep);try{let l=`${Xc}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,p=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!p.ok)return clearTimeout(d),c.warn(`Contact Type fetch returned ${p.status} for ${t}`),Zo.set(t,{type:null,failedAt:Date.now()}),null;let m=await p.json();clearTimeout(d);let h=(m.contact_type||"").toLowerCase().trim()||null;return Zo.set(t,{type:h}),c.debug(`Resolved Contact Type for ${t}: ${h??"(unset)"}`),h}catch(l){return clearTimeout(d),c.warn(`Contact Type fetch failed for ${t}:`,l),Zo.set(t,{type:null,failedAt:Date.now()}),null}})();gn.set(t,s);try{return await s}finally{gn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,p,m=()=>{l!==void 0&&window.clearTimeout(l),p!==void 0&&window.clearInterval(p)};p=window.setInterval(()=>{let h=a.querySelector(t);h&&(m(),s(h))},r),l=window.setTimeout(()=>{m(),c.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},b={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},fn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ps=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var op=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&op.test(t),Os=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},rp=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},np=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},ap=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Os(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},sp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},H=()=>rp()||ap()||np()||sp()||null,ip=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Os(e);return o?o.claims??o:null}catch{return null}},_e=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ip()?.type==="agency"};var Ds="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",lp=`${Ds}/active-follow-up-get`,dp=`${Ds}/active-follow-up-set`,re="ws-crm-active-follow-up-button",wn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},cp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},pp=async t=>{let e=await fetch(lp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},mp=async(t,e)=>{let o=await fetch(dp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ne=(t,e)=>{let o=wn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Bs=t=>{let e=document.createElement("button");return e.type="button",e.id=re,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,ne(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=cp();if(!(!r||r.contactId!==t)){ne(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await mp(r,H()),s=a&&a.state&&a.state in wn?a.state:"blue";ne(e,s),c.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),ne(e,"error"),setTimeout(()=>void tr(e,r),4e3)}}}),e},bp=3e4,tr=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),ne(t,"loading");try{let o=await pp(e),r=o&&o.state&&o.state in wn?o.state:"gray",a=document.getElementById(re);if(!a||a.dataset.contactId!==e.contactId)return;ne(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,ne(t,"error")}},hp=[".central-panel","[class*='central-panel']"],xn="ws-crm-contact-actions-bar",up=async()=>{for(let t of hp)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},_p=async(t,e)=>{let o=e.querySelector(`#${xn}`);if(!o)try{o=await M(`#${xn}`,{timeoutMs:Ze+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${xn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},vp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},yp=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},gp=async t=>{if(t==="url"){let o=await up();return o?{kind:"contact-detail",target:o}:null}let e=vp();return e?{kind:"conversations",target:e}:null},Rs=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await _p(t,e.target);return o}return yp(t,e.target),"conversations-header"},fp=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(re);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=bp&&tr(o,e);return}o&&o.remove();let r=await gp(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=Bs(e.contactId),i=await Rs(s,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Hs();let d=document.getElementById(re)??s;tr(d,e),Xo?.disconnect(),Xo=new MutationObserver(()=>{let l=document.getElementById(re);if(!(D()?.contactId===e.contactId)){Xo?.disconnect();return}if(!l){let m=Bs(e.contactId);Rs(m,r).then(()=>{Hs(),tr(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),Xo.observe(r.target,{childList:!0})},Xo=null,to=null,Fs=()=>{let t=D()?.contactId??null;if(to&&to.contactId===t)return;let e=fp().finally(()=>{to?.promise===e&&(to=null)});to={contactId:t,promise:e}},Hs=()=>{let t=document.querySelectorAll(`#${re}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var xp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",zs="ws-crm-analytics-launcher",er="ws-crm-analytics-overlay",wp=[{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],kp=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],P={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},K=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},B=t=>(Number(t)||0).toLocaleString("en-US"),kn=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},or=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},Ep=()=>`${P.range}|${P.customStart}|${P.customEnd}`,ve=async(t=!1)=>{let e=Ep();if(!t&&P.cache.has(e)){P.data=P.cache.get(e),P.error=null,ae();return}let o=J();if(!o){P.error="Could not resolve the sub-account id from the URL.",ae();return}P.loading=!0,P.error=null,ae();try{let r={tenant_id:o,range:P.range,tz_offset_minutes:new Date().getTimezoneOffset()};P.range==="custom"&&(r.start=P.customStart,r.end=P.customEnd);let a=await fetch(xp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);P.data=s,P.cache.set(e,s)}catch(r){P.error=r instanceof Error?r.message:String(r)}finally{P.loading=!1,ae()}},L=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},ot=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ro=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${_.lg};padding:16px 18px;min-width:0;`,En=`font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=L("div",ro+"flex:1;min-width:150px;");return r.appendChild(L("div",En+"margin-bottom:8px;",ot(t))),r.appendChild(L("div",`font-family:${b.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,ot(e))),o&&r.appendChild(L("div",`font-family:${b.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,ot(o))),r},Q=(t,e)=>{let o=L("div",ro);if(o.appendChild(L("div",En,ot(t))),!e.length)return o.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=L("div","margin:0 0 10px;"),i=L("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(L("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,ot(a.label)));let d=L("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,ot(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${ot(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=L("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(L("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(L("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},rr=(t,e,o)=>{let r=L("div",ro+"overflow-x:auto;");if(r.appendChild(L("div",En,ot(t))),!o.length)return r.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${ot(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${ot(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(L("div","",i)),r},rt=(t,e)=>{let o=L("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},oo=t=>{let e=L("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Ot=t=>(t||[]).map(e=>({label:e.label,primary:B(e.count),barVal:e.count})),$p=t=>(t||[]).map(e=>({label:e.label,primary:K(e.sum),secondary:`\xB7 ${B(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),Ns=(t,e)=>{let o=t.calls||{};if(!o.available)return[L("div",`${ro}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${ot(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=o[e]||[],a=o.other||[],s=r.concat(a),i=s.filter(l=>l.dials>0||l.connects>0).map(l=>({label:l.label,primary:`${B(l.dials)} dials`,secondary:`\xB7 ${B(l.connects)} connected \xB7 ${B(l.inbound)} inbound`,barVal:l.dials})),d=s.filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:or(l.talk_seconds),secondary:l.talk_per_contract_seconds!=null?`\xB7 ${or(l.talk_per_contract_seconds)} per contract`:"",barVal:l.talk_seconds}));return[Q("Call volume per rep (dials)",i),Q("Talk time per rep",d)]},Tp=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(oo([dt("Closed revenue \u2014 365d",K(o.closed_revenue_365),`${B(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",K(o.avg_deal_size_365)),dt("Left to close this month",K(r.sum),`${B(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${B(r.missing_est_close)} missing est. close date`:"")),dt("New leads",B(o.total_leads),"in selected range")])),e.appendChild(oo([dt("Contracts",`${B((o.contracts||{}).count)}`,K((o.contracts||{}).sum)+" projected"),dt("Assignments",`${B((o.assignments||{}).count)}`,K((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${B((o.closed||{}).count)}`,K((o.closed||{}).sum)+" closed")])),e.appendChild(rt("1fr 1fr 1fr",[Q("New leads by source",Ot(o.new_leads_by_source)),Q("Contacts per closer (all time)",Ot(o.contacts_per_closer)),Q("Dispo deals per rep (all time)",Ot(o.dispo_deals_per_rep))]))},Cp=(t,e)=>{let o=t.acq||{};e.appendChild(rt("1fr 1fr",[Q("Offers made per rep",Ot(o.offers_per_rep)),Q("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:B(a.count),secondary:`\xB7 ${K(a.sum)} projected`,barVal:a.count})))])),e.appendChild(rt("1fr 1fr",[Q("Projected revenue per closer (open escrows)",$p(o.projected_per_closer)),Q("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:K(a.sum),secondary:`\xB7 ${B(a.count)} closings \xB7 avg ${K(a.avg)}`,barVal:a.sum})))]));let r=Ns(t,"acq");e.appendChild(r.length===2?rt("1fr 1fr",r):rt("1fr",r))},Ap=(t,e)=>{let o=t.dispo||{};e.appendChild(rt("1fr 1fr",[Q("Buyers qualified per dispo rep",Ot(o.buyers_qualified_per_rep)),Q("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:B(a.count),secondary:`\xB7 ${K(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(rt("1fr",[Q("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:K(a.sum),secondary:`\xB7 ${B(a.count)} closings \xB7 avg ${K(a.avg)}`,barVal:a.sum})))]));let r=Ns(t,"dispo");e.appendChild(r.length===2?rt("1fr 1fr",r):rt("1fr",r))},Lp=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(oo([dt("Open leads",B(r.open)),dt("Won (under contract+)",B(r.won)),dt("Lost / dead",B(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,B(i.leads),B(i.offers),B(i.contracts),`${B(i.assigned_count)} / ${K(i.assigned_sum)}`,`${B(i.closed_count)} / ${K(i.closed_sum)}`,K(i.avg_deal)]);e.appendChild(rt("1fr",[rr("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,B(i.leads),B(i.offers),B(i.contracts),`${B(i.assigned_count)} / ${K(i.assigned_sum)}`,`${B(i.closed_count)} / ${K(i.closed_sum)}`,K(i.avg_deal)]);e.appendChild(rt("1fr",[rr("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(rt("1fr 1fr",[Q("Dead leads by channel",Ot(o.dead_by_channel)),Q("Dead leads by city",Ot(o.dead_by_city))]))},Sp=(t,e)=>{let o=t.tc||{};e.appendChild(oo([dt("Contracted",B(o.contracted),"in selected range"),dt("Closed",B(o.closed)),dt("Lost in escrow",B(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(rt("1fr 1fr",[Q("Deals per TC (contracted in range)",Ot(o.per_tc)),Q("Open escrows by stage",Ot(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,K(a.value),kn(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(rt("1fr",[rr("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Ip=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(oo([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${B(r.offers)} offers \xB7 ${B(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${B(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(rt("1fr 1fr",[Q("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Q("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,B(d.leads),B(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(rt("1fr",[rr("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${or(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${or(l.talk_seconds)} total \xB7 ${B(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(rt("1fr",[Q("Talk time per contract per rep",d)]))}else e.appendChild(L("div",`${ro}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${ot(i.note||"")}`))},eo=t=>`padding:5px 12px;border-radius:${_.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${b.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,ae=()=>{let t=document.getElementById(er);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=L("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let m of wp){let h=L("button",eo(P.range===m.key),ot(m.label));h.onclick=()=>{P.range=m.key,m.key!=="custom"?ve():ae()},r.appendChild(h)}if(P.range==="custom"){let m=`background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,h=L("input",m);h.type="date",h.value=P.customStart;let v=L("input",m);v.type="date",v.value=P.customEnd;let u=L("button",eo(!0),"Apply");u.onclick=()=>{P.customStart=h.value,P.customEnd=v.value,P.customStart&&P.customEnd&&ve()},r.appendChild(h),r.appendChild(v),r.appendChild(u)}let a=L("button",eo(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ve(!0),r.appendChild(a),o.appendChild(r);let s=L("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let m of kp){let h=L("button",eo(P.tab===m.key),ot(m.label));h.onclick=()=>{P.tab=m.key,ae()},s.appendChild(h)}if(o.appendChild(s),e.innerHTML="",P.loading){e.appendChild(L("div",`padding:60px;text-align:center;color:${n.ash};font-family:${b.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(P.error){let m=L("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${b.sans};font-size:13px;`,`Couldn't load analytics: ${ot(P.error)}`),h=L("button",eo(!0)+"margin:14px auto 0;display:inline-block;","Retry");h.onclick=()=>void ve(!0);let v=L("div","text-align:center;");v.appendChild(m),v.appendChild(h),e.appendChild(v);return}let i=P.data;if(!i){ve();return}let d=i.range||{};e.appendChild(L("div",`font-family:${b.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${ot(d.label||"")} \xB7 ${kn(d.start)} \u2192 ${kn(d.end)} \xB7 ${B((i.meta||{}).opps)} opps \xB7 ${B((i.meta||{}).contacts)} contacts`));let l=i.insights||[];if(l.length){let m=L("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let h of l.slice(0,6)){let v=h.level==="warn";m.appendChild(L("div",`padding:8px 12px;border-left:3px solid ${v?n.amber:n.blue};background:${v?n.amberGlow:n.blueGlow};border-radius:0 ${_.sm} ${_.sm} 0;font-family:${b.sans};font-size:12px;color:${n.bone};`,ot(h.text)))}e.appendChild(m)}let p=L("div","");P.tab==="company"?Tp(i,p):P.tab==="acq"?Cp(i,p):P.tab==="dispo"?Ap(i,p):P.tab==="marketing"?Lp(i,p):P.tab==="tc"?Sp(i,p):Ip(i,p),e.appendChild(p)},Mp=()=>{if(document.getElementById(er))return;P.open=!0;let t=L("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${b.sans};`);t.id=er;let e=L("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=L("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(L("div",`font-family:${b.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=L("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${_.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=Us,o.appendChild(r),e.appendChild(o),e.appendChild(L("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=L("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",qs),ae(),P.data||ve()},qs=t=>{t.key==="Escape"&&Us()},Us=()=>{P.open=!1,document.getElementById(er)?.remove(),document.removeEventListener("keydown",qs)},js=()=>{let t=window.location.pathname.includes("/dashboard"),e=document.getElementById(zs);if(!t){e?.remove();return}if(e)return;let o=L("button",`position:fixed;bottom:52px;right:16px;z-index:99990;display:inline-flex;align-items:center;gap:8px;padding:9px 16px;background:${n.emerald};color:${n.obsidian};border:none;border-radius:${_.pill};font-family:${b.mono};font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;cursor:pointer;box-shadow:0 8px 24px rgba(15,181,126,0.35);`,"\u25A6 Analytics");o.id=zs,o.onclick=Mp,document.body.appendChild(o),c.debug("[analytics] launcher mounted")};var Ks="ws-buybox-nav-icon",Cn="ws-buybox-panel",Ws="ws-buybox-modal",Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",An="https://mcclivetim.github.io/reinvest-os-cdn/geo",nr=null,no=null,ao=null,Tn=async()=>{if(nr)return nr;try{let t=await fetch(`${An}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return nr=await t.json(),nr}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Op=async t=>{if(!no)try{let e=await fetch(`${An}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);no=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return no?.[t]??[]},Bp=async t=>{if(!ao)try{let e=await fetch(`${An}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ao=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return ao?.[t]??[]},Ln=async t=>await(await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Rp=(t,e)=>Ln({tenant_id:t,action:"list",buyer_contact_id:e}),Hp=(t,e,o,r)=>Ln({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Dp=(t,e)=>Ln({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Fp=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},zp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Np='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',qp="nav.w-13, nav[class*='w-13']",Up=".flex-1.h-full.relative.overflow-hidden.rounded-lg",jp=async()=>{try{return await M(qp,{timeoutMs:2500})}catch{return null}},Wp=async()=>{try{return await M(Up,{timeoutMs:2500})}catch{return null}},Gp=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Kp=(t,e)=>{let o=document.createElement("div");return o.id=Cn,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Qp(t,e,()=>Sn(t,e))}),o},Sn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Rp(t,e),Tn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Vp(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Vp=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let p=e[l.key].map(m=>{let h=l.key==="state"?Fp(m.geo_value,o):m.geo_value;return`
  ...
  `,v=w=>{let E=s.querySelector("#ws-buybox-state-search"),S=s.querySelectorAll(".ws-buybox-state-row");S.forEach(O=>{O.addEventListener("mouseenter",()=>{O.style.background=n.emeraldGlow}),O.addEventListener("mouseleave",()=>{O.style.background="transparent"}),O.addEventListener("click",()=>{i.stateCode=O.dataset.stateCode||"",i.step=3,d()})}),E?.addEventListener("input",()=>{let O=(E.value||"").toLowerCase().trim();w.forEach((j,U)=>{let W=S[U];if(!W)return;let N=!O||j.name.toLowerCase().includes(O)||j.code.toLowerCase()===O;W.style.display=N?"":"none"})}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>E?.focus(),0)},u=w=>`
  ...
  `,x=w=>{let E=w.find(S=>S.code===i.stateCode);return`
    ...
    `},f=w=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>T(i.stateCode||""))},k=w=>{let E=i.granularity==="county"?no?.[i.stateCode||""]??[]:ao?.[i.stateCode||""]??[];return`
    ...
    `},y=()=>{let w=i.granularity==="county"?no?.[i.stateCode||""]??[]:ao?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),S=s.querySelector("#ws-buybox-value-list");if(!E||!S)return;let O=j=>{let U=j.toLowerCase().trim();if(!U){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}S.innerHTML=W.map(N=>`
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{ym(t,e,()=>Dn(t,e))}),o},Dn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Rn(Xp,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}vm(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},vm=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,p=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${_.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${mt(p||"")}${a.property_type?" &middot; "+mt(im(a.property_type)):""}</div>
        ${lm(a)}
  ...
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=u=>(a.querySelector(u)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),p=i("#wp-state"),m=i("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let v=a.querySelector("#wp-save");v&&(v.disabled=!0,v.textContent="Creating\u2026"),s&&(s.textContent="");try{let u=await Rn(tm,{tenant_id:t,contact_id:e,address:d,city:l,state:p,zip:m,property_type:h||void 0});if(!u.ok){s&&(s.textContent=u.error||"Failed to create property."),v&&(v.disabled=!1,v.textContent="Create property + deal");return}r.remove(),oi("Property + deal created \u2713"),o()}catch(u){s&&(s.textContent=`Network error: ${u.message}`),v&&(v.disabled=!1,v.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},gm=(t,e,o,r)=>{let{overlay:a,card:s}=ai();s.innerHTML=`
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=R,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){lo(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){lo(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await jm(s,t)}catch(m){c.warn("[offer-made] deal lookup failed, using legacy path",m),d(),lo(t,e);return}if(d(),l.length<=1){lo(t,e,l[0]);return}let p=await Wm(l);p&&lo(t,e,p)}),o.appendChild(r),o.appendChild(zm({contactId:t,kind:e}))}return o},Fn=!1,vi=()=>{document.querySelectorAll(`[id="${xe}"]`).forEach(t=>t.remove())},ki=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Fn){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Fn=!0;try{await Vm()}finally{Fn=!1}},Vm=async()=>{let t=D();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),vi();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),vi();return}let e="seller";try{let l=await $t(t.contactId,t.locationId),p=Tt(l);p==="buyer"?e="buyer":p==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${xe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Fm();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=_i(t.contactId,e)}catch(l){c.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){c.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(xe)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),lr?.disconnect(),lr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){lr?.disconnect();return}let p=document.querySelectorAll(`[id="${xe}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,h=_i(t.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),lr.observe(a,{childList:!0})},lr=null,yi=null,Ym=()=>{yi===null&&(yi=window.setInterval(()=>{let t=D();t&&(document.getElementById(xe)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ki()))},3e3))},Ei=()=>{Ym(),ki()};var cr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Jm=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),co="data-ws-crm-favicon",Nn=t=>t.hasAttribute(co),$i=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Jm.has(e)},pr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{$i(r)&&!Nn(r)&&r.remove()});let e=document.head.querySelector(`link[${co}="1"]`);e?e.href!==cr&&(e.href=cr):(e=document.createElement("link"),e.setAttribute(co,"1"),e.rel="icon",e.type="image/png",e.href=cr,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${co}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(co,"apple"),o.rel="apple-touch-icon",o.href=cr,document.head.appendChild(o))},Ti=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)pr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),pr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&$i(i)&&!Nn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Nn(i)&&(a=!0)});a&&pr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,pr(),e>=5&&window.clearInterval(o)},1e3)};var X=".crm-opportunities-modal .ui-modal-heading .description",Ci=new Map,qn=null,Un,Qm=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Ci){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){c.error(`[arrival-watcher] callback "${e}" threw`,s)}}},V=(t,e,o)=>{Ci.set(t,{selector:e,cb:o}),!qn&&(qn=new MutationObserver(()=>{Un===void 0&&(Un=window.setTimeout(()=>{Un=void 0,Qm()},300))}),qn.observe(document.body,{childList:!0,subtree:!0}))};var Zm=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Xm=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,tb=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let t=document.querySelector(tb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Xm);if(a){let s=a[1];if(Zm.includes(s))return s}}return null},tt=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ai="ws-crm-dispo-action-row",Y=t=>{let e=document.getElementById(Ai);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ai,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",yt="ws-crm-mt-offer-made-button",Li="ws-crm-mt-offer-made-modal",ob=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rb=/\/v2\/location\/([A-Za-z0-9]+)/,hr=()=>{let t=window.location.pathname,e=t.match(ob),o=e?e[1]:qt();if(!o)return null;let r=t.match(rb);return{oppId:o,locationId:r?r[1]:null}},nb=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},mr=()=>{document.getElementById(Li)?.remove()},ab=t=>{mr();let e=document.createElement("div");e.id=Li,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Er();!r||!r.locationId||r.oppId!==t||Vb({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=R,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Jb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qb=async()=>{for(let t of Jb)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},kr=!1,ea=async()=>{if(!kr){kr=!0;try{await Zb()}finally{kr=!1}}},Zb=async()=>{let t=Er();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),fo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),fo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await Qb();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await tt();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Er();if(!a||a.oppId!==t.oppId)return;let s=Yb(t.oppId,t.locationId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Xb(t.oppId)},go=null,ta=null,$e,fo=()=>{go?.disconnect(),go=null,ta=null,$e!==void 0&&(window.clearTimeout($e),$e=void 0)},Xb=t=>{if(go&&ta===t)return;fo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ta=t,go=new MutationObserver(()=>{$e===void 0&&($e=window.setTimeout(()=>{$e=void 0;let o=Er();if(!o||o.oppId!==t){fo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),fo();return}document.getElementById(ft)||ea()},250))}),go.observe(e,{childList:!0,subtree:!0}))},th=()=>{V("reduce-price",X,()=>{!document.getElementById(ft)&&!kr&&ea()})},Ri=()=>{th(),ea()};var Te="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",$r="deals.reinvestos.com";var xt="ws-crm-edit-landing-button",eh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,oh=/\/v2\/location\/([A-Za-z0-9]+)/,Cr=()=>{let t=window.location.pathname,e=t.match(eh);if(!e)return null;let o=t.match(oh);return{oppId:e[1],locationId:o?o[1]:null}},rh=(t,e)=>{let o=new URL(`https://${$r}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Te);let r=H();return r&&o.searchParams.set("user",r),o.toString()},nh=(t,e)=>{let o=document.createElement("button");return o.id=xt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Cr();if(!r||!r.locationId||r.oppId!==t)return;if(!Te){c.warn("[edit-landing] editor session key not configured in this build");return}let a=rh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},ah=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],sh=async()=>{for(let t of ah)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Tr=!1,ra=async()=>{if(!Tr){Tr=!0;try{await ih()}finally{Tr=!1}}},ih=async()=>{let t=Cr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await sh();if(!o)return;let r=await tt();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Cr();if(!a||a.oppId!==t.oppId)return;let s=nh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),lh(t.oppId)},xo=null,oa=null,Ce,wo=()=>{xo?.disconnect(),xo=null,oa=null,Ce!==void 0&&(window.clearTimeout(Ce),Ce=void 0)},lh=t=>{if(xo&&oa===t)return;wo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(oa=t,xo=new MutationObserver(()=>{Ce===void 0&&(Ce=window.setTimeout(()=>{Ce=void 0;let o=Cr();if(!o||o.oppId!==t){wo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo();return}document.getElementById(xt)||ra()},250))}),xo.observe(e,{childList:!0,subtree:!0}))},dh=()=>{V("edit-landing-page",X,()=>{!document.getElementById(xt)&&!Tr&&ra()})},Hi=()=>{dh(),ra()};var zi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Le="ws-crm-publish-button",ko="ws-crm-publish-wrap",Lr="ws-crm-publish-dropdown",ch=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ph=/\/v2\/location\/([A-Za-z0-9]+)/,na=()=>{let t=window.location.pathname,e=t.match(ch);if(!e)return null;let o=t.match(ph);return{oppId:e[1],locationId:o?o[1]:null}},Di=async(t,e)=>{try{let o=await fetch(zi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:H()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},mh=async(t,e)=>{let o=await fetch(zi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:H()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},bh=(t,e)=>{if(!Te){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${$r}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Te);let r=H();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Lr)?.remove()},Fi=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Lr;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `,u.addEventListener("click",f=>{f.stopPropagation(),Bt(),a()}),h.appendChild(u),s.appendChild(h),document.body.appendChild(s);let x=f=>{let k=f.target;!s.contains(k)&&!e.contains(k)&&(Bt(),document.removeEventListener("click",x))};window.setTimeout(()=>document.addEventListener("click",x),0)},Wt=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),s="transparent",i=n.steel,d=n.bone,l=n.coolGray,p="Publish Deal",m="",h="pointer",v="1";switch(e.status){case"checking":i=n.steel,d=n.ash,p="Checking\u2026",h="wait",v="0.8";break;case"ready":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,p="Publish Deal";break;case"incomplete":{let u=e.checks?.filter(f=>f.filled).length??0,x=e.checks?.length??0;i=n.amber,d=n.amber,l=n.amber,p=`${u} of ${x} ready`,m="\u25BE";break}case"publishing":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,p="Publishing\u2026",h="wait",v="0.8";break;case"published":s="transparent",i=n.steel,d=n.ash,l=n.emerald,p="Deal Published",h="default",v="0.9";break;case"error":i=n.amber,d=n.amber,l=n.amber,p=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=h,t.style.opacity=v,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${l}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},hh=(t,e)=>{let o=document.createElement("button");o.id=Le,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${at}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,r.appendChild(l);let p=["TC","ACQ","MT","DISPO","Property"],m={};t.forEach(u=>{m[u.group]||(m[u.group]=[]),m[u.group].push(u)});let h=[...p.filter(u=>m[u]),...Object.keys(m).filter(u=>!p.includes(u))];for(let u of h){let x=m[u],f=document.createElement("div");f.style.cssText="margin-top: 12px;";let k=document.createElement("div");k.style.cssText=`
    ...
    `,k.textContent=u,f.appendChild(k),x.forEach(y=>{let g=document.createElement("div"),$=!y.filled&&y.navigable&&y.field_id;g.style.cssText=`
        ...
        ${$?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,$&&(g.addEventListener("mouseenter",()=>{g.style.background=n.slate}),g.addEventListener("mouseleave",()=>{g.style.background="transparent"}),g.addEventListener("click",w=>{w.stopPropagation(),y.field_id&&(Uh(y.field_id,y.folder),wt())}));let A=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=$?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";g.innerHTML=`${A}<span style="flex: 1;">${y.label}</span>${T}`,f.appendChild(g)}),r.appendChild(f)}document.body.appendChild(r);let v=u=>{let x=u.target;!r.contains(x)&&!o.contains(x)&&(wt(),document.removeEventListener("click",v))};window.setTimeout(()=>document.addEventListener("click",v),0)},Lt=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,p="Send to Closing Office",m="",h="pointer",v="1";switch(e.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,p="Checking\u2026",h="wait",v="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(f=>f.filled).length??0,x=e.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,p=`${u} of ${x} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p="Sending\u2026",h="wait",v="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,p=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=h,t.style.opacity=v,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},jh=(t,e)=>{let o=document.createElement("button");o.id=Gt,o.type="button",o.dataset.oppId=t;let r=Dh(t),a=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${R}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,Lt(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await zh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},Lt(o,a);return}if(y.rate_limited){u=Date.now()+v,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Lt(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},Lt(o,a),c.warn("[stc] dry_run returned no checks:",y);return}let g=y.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Or.add(t),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt(),Co();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Fh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),Lt(o,a),document.getElementById(Pr)&&Ir($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},Lt(o,a),wt();try{let g=await Nh(t,e,y);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},Lt(o,a),g.checks&&Ir(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},Lt(o,a),window.setTimeout(()=>{f()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},Lt(o,a),g.checks&&Ir(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},Lt(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Pr)?wt():a.checks&&Ir(a.checks,a.previouslySentAt,o);break}case"error":case"sent":f();break}});let l,p=!1,m=Date.now(),h=1e4,v=5*60*1e3,u=0,x=!1,f=async()=>{if(o.isConnected&&(x=!0),x&&!o.isConnected)return;let y=Ao();if(!(!y||y.oppId!==t)&&!p){if(Date.now()<u){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}p=!0,m=Date.now();try{await i()}finally{p=!1}}};f();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||p)return;let A=Date.now()-m,T=Math.max(1500,h-A);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&f()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=A=>{let T=A.detail;if(!T||T.oppId!==t)return;ll(t);let w=0,E=()=>{if(p&&w<8){w+=1,window.setTimeout(E,500);return}f()};E()};window.addEventListener(ba,g);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(ba,g),window.clearInterval($))},5e3)}return o},Wh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gh=async()=>{for(let t of Wh)try{let e=await M(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Or=new Set,sl=null,Kh=t=>{t&&t!==sl&&(Or.clear(),sl=t)},Mr=!1,_a=async()=>{if(Mr){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Mr=!0;try{await Vh()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{Mr=!1}},Vh=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Ao();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Kh(t.oppId),Or.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt();return}let e=document.getElementById(Gt);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(se)?.remove(),wt(),Co());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(se)?.remove(),wt()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Gh();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Ao();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=jh(t.oppId,a.locationId),i=document.createElement("span");i.id=se,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Y(o).appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),Yh(t.oppId)},To=null,ha=null,Co=()=>{To?.disconnect(),To=null,ha=null},Yh=t=>{if(To&&ha===t)return;Co();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ha=t,To=new MutationObserver(()=>{let o=Ao();if(!o||o.oppId!==t){Co();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt(),Co();return}document.getElementById(Gt)||_a()}),To.observe(e,{childList:!0,subtree:!0}))},Jh=()=>{V("send-to-closing",X,()=>{if(document.getElementById(Gt)||Mr)return;let t=Ao();t&&Or.has(t.oppId)||_a()})},cl=()=>{Jh(),_a()};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Qh=`${ga}/tc/welcome-call-prefill`,Zh=`${ga}/tc/welcome-call-save`,Xh=`${ga}/tc/order-lockbox`,Lo="ws-crm-welcome-call-overlay",tu=["Regular Contract","Subject To","Seller Finance","Novation"],eu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],ou=["Gas","Electric","Propane","Oil"],ru=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],nu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Kt=["Yes","No"],au=["Yes","No","Unknown"],su=["Professional Photographer","Seller","Tenant"],iu=["Month-to-Month","Annual"],pl=["Current","Behind"],lu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],St=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Rr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;margin-top:4px;`,hl="margin-bottom:12px;",ul=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,du=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ml=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),et=(t,e,o)=>{let r=ml(o);return`<select id="${t}" style="${Rr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&ml(a)===r?"selected":""}>${St(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${St(e)}" placeholder="${St(o)}" style="${Rr}">`,cu=(t,e)=>`<textarea id="${t}" rows="3" style="${Rr}resize:vertical;">${St(e)}</textarea>`,pu=(t,e)=>`<input id="${t}" type="date" value="${St(e)}" style="${Rr}">`,F=(t,e)=>`<div style="${hl}"><label style="${ul}">${St(t)}</label>${e}</div>`,va=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${lu.map(r=>`<label style="${du}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${b.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${St(t)}</div>`,Me=()=>{document.getElementById(Lo)?.remove()},ie=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},mu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    ...
    ${Rt("Contract")}
    ${F("Type of Contract",et("wc-contract_type",tu,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",et("wc-property_type",ru,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",et("wc-utilities",eu,t.utilities))}
    ${F("Heat Source",et("wc-heat_source",ou,t.heat_source))}

    ${Rt("Liens & Permits")}
    ${F("Is there a mortgage?",et("wc-has_mortgage",Kt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",et("wc-mortgage_payment_status",pl,t.mortgage_payment_status))}</div>
    ${F("Any other liens? (back taxes, code violations, HELOC, etc.)",et("wc-has_other_liens",Kt,t.has_other_liens))}
    ${F("Any open or expired permits?",et("wc-has_permit_issues",Kt,t.has_permit_issues))}
    ${F("Is the property in probate?",et("wc-in_probate",Kt,t.in_probate))}

    ${Rt("Occupancy")}
    ${F("Property occupancy",et("wc-occupancy",nu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",et("wc-tenant_lease_type",iu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",et("wc-tenant_rent_status",pl,e.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",pu("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Lease on hand?",et("wc-tenant_lease_on_hand",Kt,e.lease_on_hand))}</div>
        <div style="flex:1;">${F("Security deposit",ct("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${F("Selling with tenant in place?",et("wc-selling_with_tenant",Kt,t.selling_with_tenant))}
    </div>

    ${Rt("HOA")}
    ${F("Part of an HOA?",et("wc-in_hoa",Kt,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",et("wc-hoa_rental_restriction",au,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",et("wc-photos_provided_by",su,t.photos_provided_by))}
    <div style="${hl}">
    ...
    ${Rt("Lockbox")}
    ${F("Lockbox needed?",et("wc-lockbox_needed",Kt,t.lockbox_needed))}
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=h=>{d&&(d.textContent=h)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let p=J();if(!p){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ll,r.submitterName),localStorage.setItem(Sl,r.submitterEmail),r.submitterRole&&localStorage.setItem(Il,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let v=await(await fetch(Ou,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:H()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!v.ok){l(v.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let u=v.ticket_short_id||"submitted";Ru(`Ticket ${u} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){l(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Du=["/support-ticket","ws-support-modal","ws-support"],Fu=/\/custom-menu-link\//,Aa=!1,Ml=()=>{if(Aa||!Fu.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Du.some(i=>s.includes(i))});if(r){Aa=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Hu(),Aa=!1},50);return}t<10&&setTimeout(e,150)};e()},Pl=!1,Ol=()=>{Pl||(Pl=!0,Et(()=>setTimeout(Ml,50)),Ml(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Bl="ws-phone-assignments-modal",Rl="ws-phone-assignments-toast",zu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Nu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",qu=["ACQ","DISPO","TC"],Fl="",Jt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Uu=(t,e="success",o)=>{document.getElementById(Rl)?.remove();let r=document.createElement("div");r.id=Rl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",v=>{v.target===o&&o.remove()}),!e){let v=r.querySelector("#ws-pa-body");v&&(v.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${zu}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(v){c.error("[phone-assignments] GET failed",v);let u=r.querySelector("#ws-pa-body");u&&(u.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Jt(v.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:qu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=v=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${v} found.</div>`,p=i.length?i.map(v=>`<div style="${Wu}">
    ...
    <div style="font-size:14px;font-weight:600;margin:2px 0 2px;">${Po(t)}</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${Po(t)} \xB7 ${l+1} of ${e.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Po(p)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${Po(d)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&Ur()}),s?.addEventListener("click",Ur);let i,d="",l=async p=>{if(a&&p!==d){if(d=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await Ja({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};Zt(o,r);let a=wd(t);return a&&(r={status:"linked",contactName:a.contactName},Zt(o,r),pe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await I_(t,e);i?(r={status:"linked",contactName:i.name},Zt(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ka(i.id,i.name,e)):a||(r={status:"empty"},Zt(o,r),pe?.oppId===t&&(pe=null),O_(),P_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||R_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Zt(o,r);try{let d=await yd({tenantId:e,oppId:t,fieldKey:fd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await yd({tenantId:e,oppId:t,fieldKey:A_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Zt(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},kd(t,i.id,i.name),Ka(i.id,i.name,e),dl(t),c.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){c.error("Closing Agent link failed",d),r={status:"empty"},Zt(o,r)}}})}),o},D_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],F_=async()=>{for(let t of D_)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Bo=!1,Gr=async()=>{if(!Bo){Bo=!0;try{await z_()}finally{Bo=!1}}},z_=async()=>{let t=Ho();if(!t||!t.locationId){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Wr();return}let e=document.getElementById(kt);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Wr());return}e&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await F_();if(!r||!(wd(t.oppId)!==null||pe!==null&&pe.oppId===t.oppId)&&await tt()!=="Transaction Coordination")return;let s=Ho();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=H_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${kt}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Y(r).appendChild(d),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),N_(t.oppId),Za(s.locationId)},Ro=null,Va=null,Ya=null,Wr=()=>{Ro?.disconnect(),Ro=null,Va=null,Ya=null},N_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ro&&Va===t&&Ya===e||(Wr(),Va=t,Ya=e,Ro=new MutationObserver(()=>{let o=Ho();if(!o||o.oppId!==t||!o.locationId){Wr();return}document.getElementById(kt)||Gr(),Za(o.locationId)}),Ro.observe(e,{childList:!0,subtree:!0})))},q_=()=>{V("closing-agent-picker",X,()=>{!document.getElementById(kt)&&!Bo&&Gr()})},gd,U_=()=>{gd===void 0&&(gd=window.setInterval(()=>{let t=Ho();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(kt)&&!Bo&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Gr()),Za(t.locationId)},2e3))},$d=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),q_(),U_(),Gr()};var j_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ht="ws-crm-manage-team-cta",Cd="ws-crm-manage-team-modal",W_=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ad={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},G_={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ld=()=>{let t=window.location.pathname.match(W_);return t?{tenantId:t[1]}:null},Vr=async t=>{let e=await fetch(j_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},vt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Xt=t=>vt(t),Xa="ws-crm-manage-team-toast",os=(t,e="info",o=4e3)=>{document.getElementById(Xa)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Xa,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",ts);let r;try{r=await Vr({tenant_id:t,action:"list"})}catch(l){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+Y_(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{J_(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",p=>{let m=p.currentTarget;Q_(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",p=>{let m=p.currentTarget;Z_(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
  ...
  `,S=`
    ...
    padding-right: 28px;
  `,O=Z=>['<option value="">(unset)</option>'].concat(f.map(st=>`<option value="${It(st)}"${st===Z?" selected":""}>${bt(st)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${b.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-current-occupancy" style="${S}">${O(u)}</select>
      </div>
      <div style="${w}">
        <div style="${g}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${S}">${O(x)}</select>
      </div>
  ...
  `,k.appendChild(y),document.body.appendChild(k);let j=y.querySelector("#ws-pc-purchase-price"),U=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),N=!1;W?.addEventListener("input",()=>{N=!0});let zt=()=>{if(N)return;let Z=Number(j?.value||0),st=Number(U?.value||0);W&&(W.value=String(Math.max(0,Z-st)))};j?.addEventListener("input",zt),U?.addEventListener("input",zt);let Nt=()=>k.remove();k.addEventListener("click",Z=>{Z.target===k&&Nt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Nt);let pt=y.querySelector("#ws-pc-submit"),ht=y.querySelector("#ws-pc-error");pt?.addEventListener("click",async()=>{if(pt){ht&&(ht.textContent=""),pt.disabled=!0,pt.textContent="Opening\u2026";try{let Z=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(j?.value||0),Ge=Number(U?.value||0),Ke=Number(W?.value||0),Ve=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Je=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),he=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Qe=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),it={};if(Z!==i&&(it.sellerName=Z),st!==d&&(it.purchasePrice=st),Ge!==l&&(it.emd=Ge),Ke!==p&&(it.cashAtClose=Ke),Ve!==m&&(it.daysToClose=Ve),Ye!==h&&(it.inspectionDays=Ye),Je!==v&&(it.additionalTerms=Je),he!==u&&(it.currentOccupancy=he),Qe!==x&&(it.occupancyAtClose=Qe),Object.keys(it).length>0){c.info("[prepare-contract] PA modal submit with overrides:",it),pt.textContent="Saving\u2026";let mn=H(),bn=await Zr({tenantId:t,contactId:e,template:o,userId:mn,overrides:it});c.info("[prepare-contract] re-stage with overrides ok:",bn),pt.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let lt=s?`${s} - Purchase Agreement`:void 0;await ds(t,e,o,lt)}catch(Z){pt.disabled=!1,pt.textContent="Open Contract",ht&&(ht.textContent=Z.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",Z)}}})},Bv=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Mt)?.remove(),Dd();let l=a.debug||{},p=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",h=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,v=typeof l.buyerEMD=="number"?l.buyerEMD:0,u=typeof l.assignmentFee=="number"?l.assignmentFee:0,x=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,f=typeof l.closingOffice=="string"?l.closingOffice:"",k=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,g=d,$="",A=document.createElement("div");A.id=Mt,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;T.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${j}">
        ...
        <div style="${O}">${bt(p||"(set on Property record)")}</div>
      </div>
      <div style="${j}">
  ...
  `,A.appendChild(T),document.body.appendChild(A);let W=T.querySelector("#ws-pc-assignment-price"),N=T.querySelector("#ws-pc-assignment-fee"),zt=!1;N?.addEventListener("input",()=>{zt=!0});let Nt=()=>{if(zt)return;let st=Number(W?.value||0);N&&(N.value=String(Math.max(0,st-x)))};W?.addEventListener("input",Nt);let pt=()=>A.remove();A.addEventListener("click",st=>{st.target===A&&pt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",pt);let ht=T.querySelector("#ws-pc-submit"),Z=T.querySelector("#ws-pc-error");ht?.addEventListener("click",async()=>{if(!ht)return;Z&&(Z.textContent="");let st=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ge=Number(W?.value||0),Ke=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),Ve=Number(N?.value||0),Ye=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),Je=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),he=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),Qe=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),it=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!he){Z&&(Z.textContent="Closing Date is required.");return}ht.disabled=!0,ht.textContent="Opening\u2026";try{let lt={};st!==m&&(lt.sellerName=st),Ge!==h&&(lt.assignmentPrice=Ge),Ke!==v&&(lt.buyerEMD=Ke),Ve!==u&&(lt.assignmentFee=Ve),Ye!==f&&(lt.closingOffice=Ye),Je!==k&&(lt.buyerCompanyName=Je);let mn=he!==y||Qe!==g||it!==$,bn=Object.keys(lt).length>0||mn,hn=a;bn?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",lt),ht.textContent="Saving\u2026",hn=await Zr({tenantId:t,contactId:e,template:o,oppId:r,closingDate:he,buyerEarnestDueDate:Qe,lenderSource:it,userId:s,overrides:Object.keys(lt).length>0?lt:void 0}),c.info("[prepare-contract] AA re-stage ok:",hn),ht.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let $s=hn?.debug?.propertyAddress||p,Wc=$s?`${$s} - Assignment Agreement`:void 0;await ds(t,e,o,Wc),pt()}catch(lt){ht.disabled=!1,ht.textContent="Open Contract",Z&&(Z.textContent=lt.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",lt)}})},Zr=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await fv({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ds=async(t,e,o,r)=>{let a=null;try{a=(await Nd(e)).email||""}catch(l){c.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){nt("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),c.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await xv(t,o.id,e);c.info(`[prepare-contract] proposal created: ${s}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await kv(t,s,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${s}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),nt(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Cv(o.name);d&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Av(s,d.title,d.bodyHtml)),Ev(t,s)},Rv=async t=>{let e=bv(t);if(!e){nt("Could not resolve contact context.","error");return}document.getElementById(Id)?.remove();let o=document.createElement("div");o.id=Id,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){Vv(o,i.properties,d=>{a(!0),ps({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Vd(e,l.property_record_id,l):Xr(o,l.error||"Couldn't load that property.")}).catch(l=>{c.error("[compute-offer] get failed:",l),Xr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Vd(e,i.property_record_id,i):Xr(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await ps({tenantId:e,contactId:t,mode:"get"}))}catch(i){c.error("[compute-offer] webhook failed:",i),Xr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Yv=async()=>{for(let t of Gv)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Jd=async(t,e)=>{let o=e.querySelector(`#${Wd}`);if(!o)try{o=await M(`#${Wd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Qd=()=>{let t=document.querySelectorAll(`#${be}`);for(let e=1;e<t.length;e++)t[e].remove()},Jv=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(be)?.remove(),Fe();return}let e=t.locationId,o=document.getElementById(be);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Fe();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(be)?.remove();return}let a=await Yv();if(!a){c.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Yd(t.contactId,e);if(!await Jd(i,a)){c.warn("[compute-offer] actions bar not found after waiting");return}Qd(),c.debug(`[compute-offer] mounted for ${t.contactId}`),tn?.disconnect(),tn=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){tn?.disconnect();return}if(!document.getElementById(be)){let d=Yd(t.contactId,e);Jd(d,a).then(()=>Qd())}}),tn.observe(a,{childList:!0})},tn=null,qo=null,oc=()=>{let t=D()?.contactId??null;if(qo&&qo.id===t)return;let e=Jv().finally(()=>{qo?.promise===e&&(qo=null)});qo={id:t,promise:e}};var ln="reos-theme-stylesheet",wc="reos-theme-fonts",Ue=!1,Qv=()=>{let t=document.getElementById(wc);t&&t.remove()},Zv=`
