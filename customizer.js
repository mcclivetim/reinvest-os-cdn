/* Wholesaling CRM Customizer v0.27.0 — built 2026-06-10T04:15:51.602Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var $t="[wholesaling-crm-customizer]",Fi="__WS_CRM_DEBUG",Bi=()=>!!window[Fi],p={info(...t){console.log($t,...t)},warn(...t){console.warn($t,...t)},error(...t){console.error($t,...t)},debug(...t){Bi()&&console.log($t,"[debug]",...t)}};var Ri=/\/v2\/location\/([A-Za-z0-9]+)/,Ni=new Set(["8ntUQzMflUkR0YvrRgVk"]),Oe=()=>{let t=window.location.pathname.match(Ri);return t?t[1]:null},Ro=()=>{let t=Oe();return t!==null&&Ni.has(t)};var yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,No=/\/v2\/location\/([A-Za-z0-9]+)/,zi=t=>{let e=t.match(yn);if(!e)return null;let o=t.match(No);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Gi=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(yn);if(!a)continue;let i=r.match(No)||window.location.pathname.match(No);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=zi(window.location.pathname);return t||Gi()};var gn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ot="",zo=null,De="other",Go=new Set,Mt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Ot)&&!(t!==zo))){Ot=window.location.pathname,zo=t,De=gn(),p.debug("Page/context changed:",De,Ot,"contact:",t);for(let r of Go)try{r(De)}catch(a){p.error("Subscriber threw:",a)}}},Dt=t=>(Go.add(t),setTimeout(()=>t(De),0),()=>{Go.delete(t)}),fn=()=>{De=gn(),Ot=window.location.pathname,zo=P()?.contactId??null,p.debug("Router init, current page:",De);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Mt()},history.replaceState=function(o,r,a){e(o,r,a),Mt()},window.addEventListener("popstate",Mt),setInterval(Mt,1e3)};var Pt="0.27.0",Ht="2026-06-10T04:15:51.603Z";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},qo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},wn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var qi=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&qi.test(t),xn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ui=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},Vi=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},Wi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xn(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},ji=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},L=()=>Ui()||Vi()||Wi()||ji()||null,Ki=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xn(e);return o?o.claims??o:null}catch{return null}},kn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ki()?.type==="agency"};var Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Yi=`${Cn}/active-follow-up-get`,Ji=`${Cn}/active-follow-up-set`,xe="ws-crm-active-follow-up-button",Vo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Xi=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Qi=async t=>{let e=await fetch(Yi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Zi=async(t,e)=>{let o=await fetch(Ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ke=(t,e)=>{let o=Vo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},En=t=>{let e=document.createElement("button");return e.type="button",e.id=xe,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ke(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Xi();if(!(!r||r.contactId!==t)){ke(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Zi(r,L()),i=a&&a.state&&a.state in Vo?a.state:"blue";ke(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ke(e,"error"),setTimeout(()=>void Ft(e,r),4e3)}}}),e},Ft=async(t,e)=>{ke(t,"loading");try{let o=await Qi(e),r=o&&o.state&&o.state in Vo?o.state:"gray",a=document.getElementById(xe);if(!a||a.dataset.contactId!==e.contactId)return;ke(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),ke(t,"error")}},es=[".central-panel","[class*='central-panel']"],Uo="ws-crm-contact-actions-bar",ts=async()=>{for(let t of es)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},os=async(t,e)=>{let o=e.querySelector(`#${Uo}`);if(!o)try{o=await M(`#${Uo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Uo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},rs=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},ns=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},as=async t=>{if(t==="url"){let o=await ts();return o?{kind:"contact-detail",target:o}:null}let e=rs();return e?{kind:"conversations",target:e}:null},Tn=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await os(t,e.target);return o}return ns(t,e.target),"conversations-header"},is=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(xe)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(xe);if(o&&o.dataset.contactId===e.contactId){Ft(o,e);return}o&&o.remove();let r=await as(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=En(e.contactId),s=await Tn(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Sn();let l=document.getElementById(xe)??i;Ft(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(xe);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=En(e.contactId);Tn(m,r).then(()=>{Sn(),Ft(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Qe=null,An=()=>{let t=P()?.contactId??null;if(Qe&&Qe.contactId===t)return;let e=is().finally(()=>{Qe?.promise===e&&(Qe=null)});Qe={contactId:t,promise:e}},Sn=()=>{let t=document.querySelectorAll(`#${xe}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Ze=new Map,Bt=async(t,e)=>{if(!t)return null;if(Ze.has(t))return Ze.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ss}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),Ze.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Ze.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),Ze.set(t,null),null}};var Rt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var $n="ws-buybox-nav-icon",Ko="ws-buybox-panel",In="ws-buybox-modal",ls="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Yo="https://mcclivetim.github.io/reinvest-os-cdn/geo",Nt=null,et=null,tt=null,jo=async()=>{if(Nt)return Nt;try{let t=await fetch(`${Yo}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Nt=await t.json(),Nt}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},ds=async t=>{if(!et)try{let e=await fetch(`${Yo}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);et=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return et?.[t]??[]},cs=async t=>{if(!tt)try{let e=await fetch(`${Yo}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);tt=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return tt?.[t]??[]},Jo=async t=>await(await fetch(ls,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ps=(t,e)=>Jo({tenant_id:t,action:"list",buyer_contact_id:e}),bs=(t,e,o,r)=>Jo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),hs=(t,e)=>Jo({tenant_id:t,action:"remove",entry_id:e}),B=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ms=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},us='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',vs='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',_s="nav.w-13, nav[class*='w-13']",ys=".flex-1.h-full.relative.overflow-hidden.rounded-lg",gs=async()=>{try{return await M(_s,{timeoutMs:2500})}catch{return null}},fs=async()=>{try{return await M(ys,{timeoutMs:2500})}catch{return null}},ws=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,xs=(t,e)=>{let o=document.createElement("div");return o.id=Ko,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ss(t,e,()=>Xo(t,e))}),o},Xo=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ps(t,e),jo()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${B(r.error||"Failed to load buy-box entries")}</div>`;return}ks(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${B(r.message)}</div>`}},ks=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?ms(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,hs(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}Xo(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},zt=!1,Mn=(t,e)=>{zt=e;let o=ws(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Es,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Xo(t.tenantId,t.buyerContactId)):(t.iconBtn.className=On,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},On="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Es="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Ts=t=>{let e=document.createElement("button");return e.id=$n,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=On,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${us.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!zt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Mn(r,a)}),e},Ss=(t,e,o)=>{let r=document.getElementById(In);r&&r.remove();let a=document.createElement("div");a.id=In,a.style.cssText=`
  ...
  `,C=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let H=await bs(t,e,s.granularity,g);if(!H.ok){T&&(T.textContent=H.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(H){T&&(T.textContent=`Network error: ${H.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Wo=!1,Pe=null,ot=null,Ln=()=>{document.getElementById($n)?.remove(),document.getElementById(Ko)?.remove(),ot&&Pe&&Pe.nav.removeEventListener("click",ot,!0),ot=null,Pe=null,zt=!1},Dn=()=>{Cs()},Cs=async()=>{if(!Wo){Wo=!0;try{let t=P();if(!t){Ln();return}let e=document.getElementById(Ko);if(e&&e.dataset.buyerContactId===t.contactId&&Pe)return;Ln();let o=null;try{o=await Bt(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Rt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([gs(),fs()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=xs(t.locationId,t.contactId),d=Ts(()=>Pe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Pe=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),ot=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&zt&&Mn(c,!1)},a.addEventListener("click",ot,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Wo=!1}}};var ve="ws-crm-claim-release-pill",As="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Is="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Ls=async t=>{let e=await fetch(As,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},$s=async t=>{let e=await fetch(Is,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Fn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},He=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=wn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Ms=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ve,o.type="button",o.dataset.contactId=t,He(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=P();if(!a||!a.locationId||a.contactId!==t)return;let i=L();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>He(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";He(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await $s({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;He(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),He(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Pn=async(t,e)=>{try{let o=await Ls({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(ve);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";He(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Os=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Fn(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Hn=(t,e)=>{let o=Ms({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ve}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Ds=async()=>{let t=P();if(!t){document.getElementById(ve)?.remove();return}let e=document.getElementById(ve);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await M("#record-details-lhs",{timeoutMs:1e4}),r=await Os(o),a=P();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Hn(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ve);i&&t.locationId&&Pn(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(P()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ve))return;let d=Fn(o);if(d){Hn(d,t.contactId);let c=document.getElementById(ve);c&&t.locationId&&Pn(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Bn=()=>{Ds()};var Un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ps="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Hs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Fs=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||Un,d;if(s==="buyer"){let b=Vn.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Bs=async({contactId:t,tenantId:e})=>{let o=await fetch(Hs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Fe="ws-crm-contact-actions-bar",Rs="ws-crm-call-status-dropdown",Rn="ws-crm-offer-made-modal",Ns=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Vn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],zs=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Gs=async()=>{for(let t of zs)try{let e=await M(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await M("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},qs=({contactId:t,kind:e})=>{let o=e==="buyer"?Vn:Ns,r=e==="buyer"?Ps:Un,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Rs,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=O,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},Gn=(t,e)=>{let o=document.createElement("div");if(o.id=Fe,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=J,r.textContent="Offer Made",r.addEventListener("click",()=>Ws(t,e)),o.appendChild(r),o.appendChild(qs({contactId:t,kind:e}))}return o},Qo=!1,Ys=()=>{document.querySelectorAll(`[id="${Fe}"]`).forEach(t=>t.remove())},Wn=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Qo){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Qo=!0;try{await Js()}finally{Qo=!1}},Js=async()=>{let t=P();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Ys();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Bt(t.contactId,t.locationId),b=Rt(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=P();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Fe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await Gs();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=P();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Gn(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Fe)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(P()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Fe}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=Gn(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},qn=null,Xs=()=>{qn===null&&(qn=window.setInterval(()=>{let t=P();t&&(document.getElementById(Fe)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Wn()))},3e3))},jn=()=>{Xs(),Wn()};var Gt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Qs=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),rt="data-ws-crm-favicon",Zo=t=>t.hasAttribute(rt),Kn=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Qs.has(e)},qt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Kn(r)&&!Zo(r)&&r.remove()});let e=document.head.querySelector(`link[${rt}="1"]`);e?e.href!==Gt&&(e.href=Gt):(e=document.createElement("link"),e.setAttribute(rt,"1"),e.rel="icon",e.type="image/png",e.href=Gt,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${rt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(rt,"apple"),o.rel="apple-touch-icon",o.href=Gt,document.head.appendChild(o))},Yn=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)qt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),qt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Kn(s)&&!Zo(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Zo(s)&&(a=!0)});a&&qt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,qt(),e>=5&&window.clearInterval(o)},1e3)};var Zs=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],el=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,tl=".hr-card.hr-modal.crm-opportunities-modal",D=()=>{let t=document.querySelector(tl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(el);if(a){let i=a[1];if(Zs.includes(i))return i}}return null},q=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=D();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ol="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",re="ws-crm-mt-offer-made-button",Jn="ws-crm-mt-offer-made-modal",rl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,nl=/\/v2\/location\/([A-Za-z0-9]+)/,Wt=()=>{let t=window.location.pathname,e=t.match(rl);if(!e)return null;let o=t.match(nl);return{oppId:e[1],locationId:o?o[1]:null}},al=async t=>{let e=await fetch(ol,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ut=()=>{document.getElementById(Jn)?.remove()},il=t=>{Ut();let e=document.createElement("div");e.id=Jn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Wt();!o||!o.locationId||o.oppId!==t||il({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},ll=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dl=async()=>{for(let t of ll)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vt=!1,rr=async()=>{if(!Vt){Vt=!0;try{await cl()}finally{Vt=!1}}},cl=async()=>{let t=Wt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),at();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),at());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await dl();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Wt();if(!a||a.oppId!==t.oppId)return;let i=sl(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),pl(t.oppId)},nt=null,or=null,at=()=>{nt?.disconnect(),nt=null,or=null},pl=t=>{if(nt&&or===t)return;at();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(or=t,nt=new MutationObserver(()=>{let o=Wt();if(!o||o.oppId!==t){at();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),at();return}document.getElementById(re)||rr()}),nt.observe(e,{childList:!0,subtree:!0}))},er=null,tr,bl=()=>{er||(er=new MutationObserver(()=>{tr===void 0&&(tr=window.setTimeout(()=>{tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!Vt&&rr()},300))}),er.observe(document.body,{childList:!0,subtree:!0}))},Xn=()=>{bl(),rr()};var hl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ne="ws-crm-not-interested-button",ml=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ul=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(ml);if(!e)return null;let o=t.match(ul);return{oppId:e[1],locationId:o?o[1]:null}},vl=async t=>{let e=await fetch(hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},_l=t=>{let e=document.createElement("button");return e.id=ne,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Kt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await vl({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},yl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],gl=async()=>{for(let t of yl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},jt=!1,sr=async()=>{if(!jt){jt=!0;try{await fl()}finally{jt=!1}}},fl=async()=>{let t=Kt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),st();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),st());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await gl();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Kt();if(!a||a.oppId!==t.oppId)return;let i=_l(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),wl(t.oppId)},it=null,ir=null,st=()=>{it?.disconnect(),it=null,ir=null},wl=t=>{if(it&&ir===t)return;st();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ir=t,it=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t){st();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),st();return}document.getElementById(ne)||sr()}),it.observe(e,{childList:!0,subtree:!0}))},nr=null,ar,xl=()=>{nr||(nr=new MutationObserver(()=>{ar===void 0&&(ar=window.setTimeout(()=>{ar=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!jt&&sr()},300))}),nr.observe(document.body,{childList:!0,subtree:!0}))},Qn=()=>{xl(),sr()};var kl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Be="ws-crm-resend-deal-link-wrap",El=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tl=/\/v2\/location\/([A-Za-z0-9]+)/,Jt=()=>{let t=window.location.pathname,e=t.match(El);if(!e)return null;let o=t.match(Tl);return{oppId:e[1],locationId:o?o[1]:null}},Sl=async t=>{let e=await fetch(kl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Cl=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Zn=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,pr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Zn(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Al(t,e)),t.appendChild(o)},Al=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Il(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>pr(t,e)),o.appendChild(s),t.appendChild(o)},Il=async(t,e,o,r)=>{let a=Jt();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Sl({oppId:a.oppId,locationId:a.locationId,channel:o,userId:L()});if(i?.ok)r.innerHTML=`${Zn(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Cl(s)}</span>`}window.setTimeout(()=>pr(t,e),3500)}},Ll=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$l=async()=>{for(let t of Ll)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Yt=!1,br=async()=>{if(!Yt){Yt=!0;try{await Ml()}finally{Yt=!1}}},Ml=async()=>{let t=Jt();if(!t||!t.locationId){document.getElementById(Be)?.remove(),dt();return}let e=document.getElementById(Be);if(e&&e.dataset.oppId===t.oppId){let s=D();s!==null&&s!=="Marketing Tracker"&&(e.remove(),dt());return}e&&e.remove();let o=await $l();if(!o)return;let r=await q();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Jt();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Be,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),pr(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Ol(t.oppId)},lt=null,cr=null,dt=()=>{lt?.disconnect(),lt=null,cr=null},Ol=t=>{if(lt&&cr===t)return;dt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(cr=t,lt=new MutationObserver(()=>{let o=Jt();if(!o||o.oppId!==t){dt();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Be)?.remove(),dt();return}document.getElementById(Be)||br()}),lt.observe(e,{childList:!0,subtree:!0}))},lr=null,dr,Dl=()=>{lr||(lr=new MutationObserver(()=>{dr===void 0&&(dr=window.setTimeout(()=>{dr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Be)&&!Yt&&br()},300))}),lr.observe(document.body,{childList:!0,subtree:!0}))},ea=()=>{Dl(),br()};var ta="ws-crm-dispo-action-row",te=t=>{let e=document.getElementById(ta);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=ta,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Pl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ae="ws-crm-reduce-price-button",oa="ws-crm-reduce-price-modal",Hl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fl=/\/v2\/location\/([A-Za-z0-9]+)/,Zt=()=>{let t=window.location.pathname,e=t.match(Hl);if(!e)return null;let o=t.match(Fl);return{oppId:e[1],locationId:o?o[1]:null}},Bl=async t=>{let e=await fetch(Pl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Xt=()=>{document.getElementById(oa)?.remove()},Rl=t=>{Xt();let e=document.createElement("div");e.id=oa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Zt();!r||!r.locationId||r.oppId!==t||Rl({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},zl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gl=async()=>{for(let t of zl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qt=!1,vr=async()=>{if(!Qt){Qt=!0;try{await ql()}finally{Qt=!1}}},ql=async()=>{let t=Zt();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),pt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),pt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Gl();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Zt();if(!a||a.oppId!==t.oppId)return;let i=Nl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),te(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Ul(t.oppId)},ct=null,ur=null,pt=()=>{ct?.disconnect(),ct=null,ur=null},Ul=t=>{if(ct&&ur===t)return;pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ur=t,ct=new MutationObserver(()=>{let o=Zt();if(!o||o.oppId!==t){pt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),pt();return}document.getElementById(ae)||vr()}),ct.observe(e,{childList:!0,subtree:!0}))},hr=null,mr,Vl=()=>{hr||(hr=new MutationObserver(()=>{mr===void 0&&(mr=window.setTimeout(()=>{mr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!Qt&&vr()},300))}),hr.observe(document.body,{childList:!0,subtree:!0}))},ra=()=>{Vl(),vr()};var Re="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",eo="deals.reinvestos.com";var ie="ws-crm-edit-landing-button",Wl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jl=/\/v2\/location\/([A-Za-z0-9]+)/,oo=()=>{let t=window.location.pathname,e=t.match(Wl);if(!e)return null;let o=t.match(jl);return{oppId:e[1],locationId:o?o[1]:null}},Kl=(t,e)=>{let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();return r&&o.searchParams.set("user",r),o.toString()},Yl=(t,e)=>{let o=document.createElement("button");return o.id=ie,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=oo();if(!r||!r.locationId||r.oppId!==t)return;if(!Re){p.warn("[edit-landing] editor session key not configured in this build");return}let a=Kl(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Jl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xl=async()=>{for(let t of Jl)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},to=!1,fr=async()=>{if(!to){to=!0;try{await Ql()}finally{to=!1}}},Ql=async()=>{let t=oo();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ht();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await Xl();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=oo();if(!a||a.oppId!==t.oppId)return;let i=Yl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),te(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),Zl(t.oppId)},bt=null,gr=null,ht=()=>{bt?.disconnect(),bt=null,gr=null},Zl=t=>{if(bt&&gr===t)return;ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gr=t,bt=new MutationObserver(()=>{let o=oo();if(!o||o.oppId!==t){ht();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ht();return}document.getElementById(ie)||fr()}),bt.observe(e,{childList:!0,subtree:!0}))},_r=null,yr,ed=()=>{_r||(_r=new MutationObserver(()=>{yr===void 0&&(yr=window.setTimeout(()=>{yr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!to&&fr()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},na=()=>{ed(),fr()};var ia="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ne="ws-crm-publish-button",mt="ws-crm-publish-wrap",no="ws-crm-publish-dropdown",td=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,od=/\/v2\/location\/([A-Za-z0-9]+)/,kr=()=>{let t=window.location.pathname,e=t.match(td);if(!e)return null;let o=t.match(od);return{oppId:e[1],locationId:o?o[1]:null}},rd=async(t,e)=>{try{let o=await fetch(ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:L()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},nd=async(t,e)=>{let o=await fetch(ia,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:L()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ad=(t,e)=>{if(!Re){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=L();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},he=()=>{document.getElementById(no)?.remove()},aa=(t,e,o,r,a)=>{he();let i=document.createElement("div");i.id=no;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Ee(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await rd(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ee(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Ee(o,r),document.getElementById(no)&&r.checks&&aa(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Ee(o,r),he();try{let m=await nd(t,e);if(m.ok&&m.published)r={status:"published"},Ee(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ee(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Ee(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(no)?he():r.checks&&aa(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},sd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ld=async()=>{for(let t of sd)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ro=!1,Tr=async()=>{if(!ro){ro=!0;try{await dd()}finally{ro=!1}}},dd=async()=>{let t=kr();if(!t||!t.locationId){document.getElementById(Ne)?.remove(),document.getElementById(mt)?.remove(),he(),vt();return}let e=document.getElementById(Ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(mt)?.remove(),he(),vt());return}e&&(e.remove(),document.getElementById(mt)?.remove(),he());let o=await ld();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=kr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=id(t.oppId,a.locationId),s=document.createElement("span");s.id=mt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),te(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),cd(t.oppId)},ut=null,Er=null,vt=()=>{ut?.disconnect(),ut=null,Er=null},cd=t=>{if(ut&&Er===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Er=t,ut=new MutationObserver(()=>{let o=kr();if(!o||o.oppId!==t){vt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(Ne)?.remove(),document.getElementById(mt)?.remove(),he(),vt();return}document.getElementById(Ne)||Tr()}),ut.observe(e,{childList:!0,subtree:!0}))},wr=null,xr,pd=()=>{wr||(wr=new MutationObserver(()=>{xr===void 0&&(xr=window.setTimeout(()=>{xr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ne)&&!ro&&Tr()},300))}),wr.observe(document.body,{childList:!0,subtree:!0}))},sa=()=>{pd(),Tr()};var la="data:image/png;base64,",da="data:image/png;base64,";var bd=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],ca=t=>`ws-crm-map-links-${t}`,ao=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},pa=t=>{let e=ao(t.addr),o=ao(t.city),r=ao(t.state),a=ao(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},hd=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,md=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,ud=(t,e)=>{let{full:o,hasAny:r}=pa(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},vd=t=>{let e=document.createElement("span");e.id=ca(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),ud(t,s)}),l};return e.appendChild(r(la,"Open in Google Maps",hd)),e.appendChild(r(da,"Search on Zillow",md)),e},_d=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},ba=()=>{for(let t of bd){if(document.getElementById(ca(t.key)))continue;let{hasAny:e}=pa(t);if(!e)continue;let o=_d(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(vd(t)),p.debug(`[map-links] injected on "${t.addr}"`))}},Sr=null,Cr,yd=()=>{Sr||(Sr=new MutationObserver(()=>{Cr===void 0&&(Cr=window.setTimeout(()=>{Cr=void 0;try{ba()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},ha=()=>{yd(),ba()};var ma="ws-crm-hide-launchpad",ua=/\/launchpad\/?$/,Ar=()=>{if(!kn()){if(!document.getElementById(ma)){let t=document.createElement("style");t.id=ma,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ua.test(location.pathname)){let t=location.pathname.replace(ua,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var ya="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",_e="ws-crm-send-to-closing-office-button",Te="ws-crm-send-to-title-co-wrap",lo="ws-crm-stc-dropdown",gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fd=/\/v2\/location\/([A-Za-z0-9]+)/,co=()=>{let t=window.location.pathname,e=t.match(gd);if(!e)return null;let o=t.match(fd);return{oppId:e[1],locationId:o?o[1]:null}},wd=5*60*1e3,ga=t=>`ws-crm-stc-cache:${t}`,xd=t=>{try{let e=window.localStorage.getItem(ga(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>wd||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},kd=(t,e)=>{try{window.localStorage.setItem(ga(t),JSON.stringify(e))}catch{}},Ed=async(t,e)=>{try{let o=await fetch(ya,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Td=async(t,e,o)=>{let r=await fetch(ya,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Sd=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},va=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Cd=(t,e)=>{if(e&&Sd(e)){window.setTimeout(()=>va(t),300);return}va(t)},se=()=>{document.getElementById(lo)?.remove()},io=(t,e,o)=>{se();let r=document.createElement("div");r.id=lo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,de(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Ed(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},de(o,a);return}if(w.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},de(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},de(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),po.add(t),document.getElementById(_e)?.remove(),document.getElementById(Te)?.remove(),se(),yt();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},kd(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),de(o,a),document.getElementById(lo)&&io(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},de(o,a),se();try{let y=await Td(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},de(o,a),y.checks&&io(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},de(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},de(o,a),y.checks&&io(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},de(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(lo)?se():a.checks&&io(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!c){if(Date.now()<_){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,C=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},C)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Id=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ld=async()=>{for(let t of Id)try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},po=new Set,_a=null,$d=t=>{t&&t!==_a&&(po.clear(),_a=t)},so=!1,Mr=async()=>{if(so){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}so=!0;try{await Md()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{so=!1}},Md=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=co();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(_e)?.remove(),document.getElementById(Te)?.remove(),se();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),$d(t.oppId),po.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(_e)?.remove(),document.getElementById(Te)?.remove(),se();return}let e=document.getElementById(_e);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=D();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Te)?.remove(),se(),yt());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Te)?.remove(),se()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Ld();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=D();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=co();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Ad(t.oppId,a.locationId),s=document.createElement("span");s.id=Te,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),te(o).appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Od(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Od=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=co();if(!o||o.oppId!==t){yt();return}let r=D();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(_e)?.remove(),document.getElementById(Te)?.remove(),se(),yt();return}document.getElementById(_e)||Mr()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Dd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(_e);if(t&&!e&&!so){let o=co();if(o&&po.has(o.oppId))return;Mr()}},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},fa=()=>{Dd(),Mr()};var Pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Pd=`${Pr}/tc/welcome-call-prefill`,Hd=`${Pr}/tc/welcome-call-save`,Fd=`${Pr}/tc/order-lockbox`,gt="ws-crm-welcome-call-overlay",Bd=["Regular Contract","Subject To","Seller Finance","Novation"],Rd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Nd=["Gas","Electric","Propane","Oil"],zd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Gd=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ye=["Yes","No"],qd=["Yes","No","Unknown"],Ud=["Professional Photographer","Seller","Tenant"],Vd=["Month-to-Month","Annual"],wa=["Current","Behind"],Wd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ce=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),ho=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ea="margin-bottom:12px;",Ta=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,jd=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,xa=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),G=(t,e,o)=>{let r=xa(o);return`<select id="${t}" style="${ho}"><option value=""></option>${e.map(a=>`<option ${r!==""&&xa(a)===r?"selected":""}>${ce(a)}</option>`).join("")}</select>`},K=(t,e,o="")=>`<input id="${t}" type="text" value="${ce(e)}" placeholder="${ce(o)}" style="${ho}">`,Kd=(t,e)=>`<textarea id="${t}" rows="3" style="${ho}resize:vertical;">${ce(e)}</textarea>`,Yd=(t,e)=>`<input id="${t}" type="date" value="${ce(e)}" style="${ho}">`,$=(t,e)=>`<div style="${Ea}"><label style="${Ta}">${ce(t)}</label>${e}</div>`,Or=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Wd.map(r=>`<label style="${jd}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},me=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ce(t)}</div>`,ze=()=>{document.getElementById(gt)?.remove()},Se=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Jd=t=>{let e=t.tenant||{};return`
    ${me("Identifiers")}
    ...
    ${me("Contract")}
    ${$("Type of Contract",G("wc-contract_type",Bd,t.contract_type))}

    ${me("Property")}
    ${$("Property Type",G("wc-property_type",zd,t.property_type))}
    ...
    ${$("Utilities",G("wc-utilities",Rd,t.utilities))}
    ${$("Heat Source",G("wc-heat_source",Nd,t.heat_source))}

    ${me("Liens & Permits")}
    ${$("Is there a mortgage?",G("wc-has_mortgage",ye,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${$("Mortgage payment status",G("wc-mortgage_payment_status",wa,t.mortgage_payment_status))}</div>
    ...
    ${me("Occupancy")}
    ${$("Property occupancy",G("wc-occupancy",Gd,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${$("Lease type",G("wc-tenant_lease_type",Vd,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Rent status",G("wc-tenant_rent_status",wa,e.rent_status))}</div>
        <div style="flex:1;">${$("Last rent paid",Yd("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${$("HOA monthly fee",K("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${$("HOA rental restriction?",G("wc-hoa_rental_restriction",qd,t.hoa_rental_restriction))}</div>

    ${me("Photos & Access")}
    ${$("Who is providing photos?",G("wc-photos_provided_by",Ud,t.photos_provided_by))}
    <div style="${Ea}">
      <label style="${Ta}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
  ...
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Dr=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),ka=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},bo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?ce(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Xd=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Dr("photos_avail_mornings"),photos_avail_afternoons:Dr("photos_avail_afternoons"),photos_avail_evenings:Dr("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),Qd=t=>{ze();let e=document.createElement("div");e.id=gt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Jd(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",i=>{i.target===e&&ze()}),document.getElementById("wc-close")?.addEventListener("click",ze),document.getElementById("wc-cancel")?.addEventListener("click",ze),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",ka)}),ka();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!S("wc-occupancy")){Se("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Xd(t)),credentials:"omit"})).ok?(ze(),Se("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Se("Save failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Se("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Fd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:S("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:S("wc-lockbox_recipient_name"),recipient_phone:S("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),Se("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,Se("Lockbox order failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,Se("Couldn't reach the lockbox handler. Try again.","err")}})},Sa=async(t,e)=>{ze();let o=document.createElement("div");o.id=gt,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Pd}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,Qd(r)};var Gr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Zd=`${Gr}/tc/confirm-photo-appointment`,ec=`${Gr}/tc/order-lockbox`,tc=`${Gr}/tc/welcome-call-prefill`,Rr="ws-crm-opp-action-bar",Aa="ws-crm-opp-overflow",Ia="ws-crm-opp-action-menu",Nr="ws-crm-opp-action-popover",La=".hr-card.hr-modal.crm-opportunities-modal",oc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rc=/\/v2\/location\/([A-Za-z0-9]+)/,$a="Welcome Call Needed",qr="Scheduling Photos",Ma="Photos Scheduled",nc=[$a,qr,Ma,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Oa=()=>{let t=window.location.pathname,e=t.match(oc);if(!e)return null;let o=t.match(rc);return o?{oppId:e[1],locationId:o[1]}:null},ac=()=>{let t=document.querySelector(La);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(nc.includes(r))return r}return null},Ae=()=>{document.getElementById(Ia)?.remove(),document.getElementById(Nr)?.remove()},Ce=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    ...
    box-shadow: 0 12px 32px rgba(0,0,0,0.5);
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},ic=t=>{Sa(t.oppId,t.locationId)},Da=async t=>{if(Ae(),!!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))try{let e={};try{e=await fetch(`${tc}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(r=>r.json())}catch{}(await fetch(ec,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:e.lockbox_mailing_address||e.deal_address||"",recipient_name:e.lockbox_recipient_name||"",recipient_phone:e.lockbox_recipient_phone||"",source:"tc-reorder"}),credentials:"omit"})).ok?Ce("Lockbox order sent to ops \u2713"):Ce("Lockbox order failed \u2014 check the Google Chat webhook env var.","err")}catch(e){p.warn("[action-bar] order lockbox failed:",e),Ce("Couldn't reach the lockbox handler. Try again.","err")}},sc=(t,e)=>{Ae();let o=document.createElement("div");o.id=Nr;let r=e.getBoundingClientRect();o.style.cssText=`
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Ce("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(Zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ae(),Ce("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Ce("Booking failed \u2014 try again.","err"))}catch(d){p.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Ce("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let c=d.target;!o.contains(c)&&!e.contains(c)&&(Ae(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},lc=(t,e)=>{Ae();let o=document.createElement("div");o.id=Ia;let r=e.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ae(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},uo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=J:o.style.cssText=O,o.textContent=t,o},dc=()=>{let t=uo("\u22EE","ghost");return t.style.lineHeight="1",t},cc=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===$a){let r=uo("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>ic(t)),o.appendChild(r),o}if(e===qr){let r=uo("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>sc(t,r)),o.appendChild(r),o}if(e===Ma){let r=uo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Da(t)),o.appendChild(r),o}return null},pc=(t,e)=>{let o=[];if(e===qr&&(o=[{label:"Re-order Lockbox",onClick:()=>void Da(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Aa,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=dc();return a.addEventListener("click",i=>{i.stopPropagation(),lc(o,a)}),r.appendChild(a),r},bc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],hc=async()=>{for(let t of bc)try{let e=await M(t,{timeoutMs:1200});if(e)return e}catch{}return null},mo=()=>{document.getElementById(Rr)?.remove(),document.getElementById(Aa)?.remove(),Ae()},vo=!1,Ur=async()=>{if(!vo){vo=!0;try{let t=Oa();if(!t){mo();return}let e=D();if(e===null)return;if(e!=="Transaction Coordination"){mo();return}let o=ac(),r=document.getElementById(Rr);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=cc(t,o);if(!a){mo();return}let i=await hc();if(!i)return;mo();let s=te(i),l=document.createElement("span");l.id=Rr,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=pc(t,o);d&&s.appendChild(d),mc(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{vo=!1}}},ft=null,zr=null,Hr,Ca=()=>{ft?.disconnect(),ft=null,zr=null},mc=t=>{if(ft&&zr===t)return;Ca();let e=document.querySelector(La);e&&(zr=t,ft=new MutationObserver(()=>{let o=Oa();if(!o||o.oppId!==t){Ca();return}Hr===void 0&&(Hr=window.setTimeout(()=>{Hr=void 0,Ur()},250))}),ft.observe(e,{childList:!0,subtree:!0}))},Fr=null,Br,uc=()=>{Fr||(Fr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!vo&&Ur()},300))}),Fr.observe(document.body,{childList:!0,subtree:!0}))},Pa=()=>{uc(),Ur()};var Ha="ws-support-modal",Fa="ws-support-toast",vc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ba="ws-support-submitter-name",Ra="ws-support-submitter-email",Na="ws-support-submitter-role",_c=["Bug","Feature Request","Question","Billing","Onboarding Help"],Ie=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),yc=(t,e="success",o)=>{let r=document.getElementById(Fa);r&&r.remove();let a=document.createElement("div");a.id=Fa;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},gc=()=>{document.getElementById(Ha)?.remove();let t=(localStorage.getItem(Ba)??"").trim(),e=(localStorage.getItem(Ra)??"").trim(),o=(localStorage.getItem(Na)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ha,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=Oe();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ba,r.submitterName),localStorage.setItem(Ra,r.submitterEmail),r.submitterRole&&localStorage.setItem(Na,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(vc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";yc(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},fc=["/support-ticket","ws-support-modal","ws-support"],wc=/\/custom-menu-link\//,Vr=!1,za=()=>{if(Vr||!wc.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return fc.some(s=>i.includes(s))});if(r){Vr=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{gc(),Vr=!1},50);return}t<10&&setTimeout(e,150)};e()},Ga=!1,qa=()=>{Ga||(Ga=!0,Dt(()=>setTimeout(za,50)),za(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var xc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",kc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ec="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Wa="tc_closing_agent",Tc="tc_closing_office",le="ws-crm-closing-agent-picker-button",ja="ws-crm-closing-agent-picker-modal",Sc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cc=/\/v2\/location\/([A-Za-z0-9]+)/,kt=()=>{let t=window.location.pathname,e=t.match(Sc);if(!e)return null;let o=t.match(Cc);return{oppId:e[1],locationId:o?o[1]:null}},Zr=async t=>{let e=await fetch(xc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ua=async t=>{let e=await fetch(kc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ac=async(t,e)=>{try{let o=await fetch(Ec,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Wa}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Zr({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},Le=null,Ic=60*60*1e3,en=t=>`ws-crm-to-cache:${t}`,Ka=t=>{try{let e=window.localStorage.getItem(en(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ic||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Ya=(t,e,o)=>{try{window.localStorage.setItem(en(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Lc=t=>{try{window.localStorage.removeItem(en(t))}catch{}},Yr="ws-crm-closing-agent-field-link",$c=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Yr}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Wr=!1,tn=async t=>{if(Wr)return;let e=Ja();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Wr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Zr({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Jr(a.id,a.name,t);let i=document.getElementById(le);if(i){ge(i,{status:"linked",contactName:a.name});let s=kt();s&&Ya(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Wr=!1}}},Mc=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ja=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();Mc.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Jr=(t,e,o)=>{let r=Ja();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Yr}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Yr,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},_o=()=>{document.getElementById(ja)?.remove()},Oc=t=>{_o();let e=document.createElement("div");e.id=ja,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&_o()}),i?.addEventListener("click",_o);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await Zr({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};ge(o,r);let a=Ka(t);return a&&(r={status:"linked",contactName:a.contactName},ge(o,r),Le={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Ac(t,e);s?(r={status:"linked",contactName:s.name},ge(o,r),Le={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Jr(s.id,s.name,e)):a||(r={status:"empty"},ge(o,r),Le?.oppId===t&&(Le=null),$c(),Lc(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Oc({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ge(o,r);try{let l=[Ua({tenantId:e,oppId:t,fieldKey:Wa,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ua({tenantId:e,oppId:t,fieldKey:Tc,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ge(o,r),Le={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Ya(t,s.id,s.name),Jr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},ge(o,r)}}})}),o},Pc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Hc=async()=>{for(let t of Pc)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wt=!1,fo=async()=>{if(!wt){wt=!0;try{await Fc()}finally{wt=!1}}},Fc=async()=>{let t=kt();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),go();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let d=D();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),go());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=D();if(o!==null&&o!=="Transaction Coordination")return;let r=await Hc();if(!r||!(Ka(t.oppId)!==null||Le!==null&&Le.oppId===t.oppId)&&await q()!=="Transaction Coordination")return;let i=kt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Dc(t.oppId,i.locationId),l=document.createElement("span");l.id=`${le}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),te(r).appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Bc(t.oppId),tn(i.locationId)},xt=null,Xr=null,Qr=null,go=()=>{xt?.disconnect(),xt=null,Xr=null,Qr=null},Bc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt&&Xr===t&&Qr===e||(go(),Xr=t,Qr=e,xt=new MutationObserver(()=>{let o=kt();if(!o||o.oppId!==t||!o.locationId){go();return}document.getElementById(le)||fo(),tn(o.locationId)}),xt.observe(e,{childList:!0,subtree:!0})))},jr=null,Kr,Rc=()=>{jr||(jr=new MutationObserver(()=>{Kr===void 0&&(Kr=window.setTimeout(()=>{Kr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!wt&&fo()},300))}),jr.observe(document.body,{childList:!0,subtree:!0}))},Va,Nc=()=>{Va===void 0&&(Va=window.setInterval(()=>{let t=kt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(le)&&!wt&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),fo()),tn(t.locationId)},2e3))},Xa=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Rc(),Nc(),fo()};var zc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",we="ws-crm-manage-team-cta",Qa="ws-crm-manage-team-modal",Gc=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Za={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},qc={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ei=()=>{let t=window.location.pathname.match(Gc);return t?{tenantId:t[1]}:null},xo=async t=>{let e=await fetch(zc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},oe=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),fe=t=>oe(t),on="ws-crm-manage-team-toast",an=(t,e="info",o=4e3)=>{document.getElementById(on)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=on,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(on)===a&&a.remove()},o)},rn=()=>{document.getElementById(Qa)?.remove()},Uc=(t,e)=>{let o=qc[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${oe(e)}</span>
  `},Vc=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Uc(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${fe(t.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${fe(t.email)}" data-user-id="${fe(t.id)}" data-name="${fe(o)}" data-current-roles="${fe(t.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${fe(t.email)}" data-name="${fe(o)}" data-role-count="${fe(String(t.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Wc=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Vc(r,e)).join(""),ko=async t=>{rn();let e=document.createElement("div");e.id=Qa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&rn()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",rn);let r;try{r=await xo({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Wc(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{jc(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;Kc(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;Yc(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},jc=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${oe(Za[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{ko(t)}),wo(e),setTimeout(()=>wo(e),200),setTimeout(()=>wo(e),800),window.addEventListener("resize",()=>wo(e)),e},nn=!1,np=()=>{if(!nn){nn=!0;try{let t=ei();if(!t){document.getElementById(we)?.remove(),document.getElementById(`${we}-floater`)?.remove();return}let e=document.getElementById(we);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${we}-floater`)?.remove();let o=document.createElement("div");o.id=`${we}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=rp(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{nn=!1}}},ti=()=>{if(!ei()){document.getElementById(we)?.remove(),document.getElementById(`${we}-floater`)?.remove();return}np()};var ap="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",dn="ws-crm-prepare-contract-button",oi="ws-crm-prepare-contract-menu",be="ws-crm-prepare-contract-modal",ri="ws-crm-modal-date-style",ue="https://services.leadconnectorhq.com",di=()=>{if(document.getElementById(ri))return;let t=document.createElement("style");t.id=ri,t.textContent=`
  ...
  `,document.head.appendChild(t)},cn="__WS_CRM_CAPTURED_AUTH",ip=50*60*1e3,Co=()=>{try{let t=localStorage.getItem(cn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>ip?(localStorage.removeItem(cn),null):e:null}catch{return null}},sp=t=>{try{localStorage.setItem(cn,JSON.stringify(t))}catch{}},qe=()=>{let t=Co(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ni=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Co()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ge=async(t,e={},o=2)=>{let r=Co()?.capturedAt??0,a;try{a={...qe(),...e.headers??{}}}catch(s){if(o>0&&await ni(r,4e3))return Ge(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await ni(r,4e3)?Ge(t,e,o-1):i},ai=!1,lp=()=>{if(ai)return;ai=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Co()?.authorization;sp({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ci=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},dp=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ci()},cp=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},pi="__WS_CRM_TEMPLATES_CACHE_V1",pp=24*60*60*1e3,ii=t=>{try{let e=window.localStorage.getItem(pi);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>pp?null:o.templates}catch{return null}},bp=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(pi,JSON.stringify(o))}catch{}},hp=async t=>{let e=`${ue}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ge(e,{method:"GET"})}catch(s){let l=ii(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ii(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:cp(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&bp(t,i),i},mp=async(t,e)=>{let o=await Ge(`${ue}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Ge(`${ue}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},up=async(t,e)=>{let o=await Ge(`${ue}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ue}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:qe()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},vp=async t=>{let e=await fetch(ap,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},_p=async(t,e,o)=>{let r=`${ue}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:qe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},yp=async(t,e)=>{let o=await fetch(`${ue}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:qe()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},gp=async t=>{let e=await fetch(`${ue}/contacts/${t}`,{method:"GET",headers:qe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},fp=async(t,e,o,r)=>{let a;try{a=await yp(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await gp(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ue}/proposals/document/${e}`,{method:"PUT",headers:{...qe(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},wp=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},To="__WS_CRM_PENDING_INSTRUCTIONS",xp=60*1e3,kp=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ep=t=>{let e=(t||"").toLowerCase();for(let o of kp)if(e.includes(o.matches.toLowerCase()))return o;return null},Tp=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(To,JSON.stringify(r))}catch{}},Sp=()=>{try{let t=localStorage.getItem(To);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>xp?(localStorage.removeItem(To),null):e}catch{return null}},Cp=()=>{try{localStorage.removeItem(To)}catch{}},Ap=(t,e)=>{document.getElementById(be)?.remove();let o=document.createElement("div");o.id=be,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Ip=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Lp=()=>{let t=window.location.pathname.match(Ip);if(!t)return;let e=t[1],o=Sp();o&&o.proposalId===e&&(Cp(),window.setTimeout(()=>{Ap(o.title,o.bodyHtml)},600))},si="ws-crm-prepare-contract-toast",U=(t,e="info",o=4e3)=>{document.getElementById(si)?.remove();let r=document.createElement("div");r.id=si;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},li=(t,e)=>new Promise(o=>{document.getElementById(be)?.remove();let r=document.createElement("div");r.id=be,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,H=z=>['<option value="">(unset)</option>'].concat(E.map(V=>`<option value="${pe(V)}"${V===z?" selected":""}>${X(V)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,A.appendChild(k),document.body.appendChild(A);let Y=k.querySelector("#ws-pc-assignment-price"),R=k.querySelector("#ws-pc-assignment-fee"),Ue=!1;R?.addEventListener("input",()=>{Ue=!0});let Lt=()=>{if(Ue)return;let V=Number(Y?.value||0);R&&(R.value=String(Math.max(0,V-x)))};Y?.addEventListener("input",Lt);let ee=()=>A.remove();A.addEventListener("click",V=>{V.target===A&&ee()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let Q=k.querySelector("#ws-pc-submit"),z=k.querySelector("#ws-pc-error");Q?.addEventListener("click",async()=>{if(!Q)return;z&&(z.textContent="");let V=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ve=Number(Y?.value||0),We=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),je=Number(R?.value||0),Ke=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Ye=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Me=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Je=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),W=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Me){z&&(z.textContent="Closing Date is required.");return}Q.disabled=!0,Q.textContent="Opening\u2026";try{let j={};V!==b&&(j.sellerName=V),Ve!==m&&(j.assignmentPrice=Ve),We!==h&&(j.buyerEMD=We),je!==_&&(j.assignmentFee=je),Ke!==E&&(j.closingOffice=Ke),Ye!==w&&(j.buyerCompanyName=Ye);let Ho=Me!==y||Je!==f||W!==C,Fo=Object.keys(j).length>0||Ho,Bo=a;Fo?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",j),Q.textContent="Saving\u2026",Bo=await So({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Me,buyerEarnestDueDate:Je,lenderSource:W,userId:i,overrides:Object.keys(j).length>0?j:void 0}),p.info("[prepare-contract] AA re-stage ok:",Bo),Q.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let _n=Bo?.debug?.propertyAddress||c,Hi=_n?`${_n} - Assignment Agreement`:void 0;await hn(t,e,o,Hi),ee()}catch(j){Q.disabled=!1,Q.textContent="Open Contract",z&&(z.textContent=j.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",j)}})},So=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await vp({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},hn=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await _p(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await fp(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),U(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Ep(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Tp(a,s.title,s.bodyHtml)),wp(t,a)},Op=async t=>{let e=dp(t);if(!e){U("Could not resolve contact context.","error");return}document.getElementById(oi)?.remove();let o=document.createElement("div");o.id=oi,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await hp(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await up(e.tenantId,e.contactId)}catch(f){U(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){U("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await li(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),C=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${C}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);U("Reading contract data\u2026","info",2500);let E;try{E=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:c})}catch(y){U(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){U("Could not resolve buyer contact for this opp.","error",6e3);return}Mp({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){U("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await mp(e.tenantId,e.contactId)}catch(_){U(`Failed to load ACQ opps: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){U("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await li(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,p.info(`[prepare-contract] picked ACQ opp ${m}`)}U("Reading contract data\u2026","info",2500);let h;try{h=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(_){U(`Failed to prepare contract: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",_);return}$p({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){U("This template needs to be started from a contact page.","error",6e3);return}U(`Opening ${i.name}\u2026`,"info",2500);try{await hn(e.tenantId,e.contactId,i)}catch(b){U(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),U(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},bi=()=>{let t=document.createElement("button");return t.id=dn,t.type="button",t.style.cssText=`${O} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Op(t)}),t},Dp="ws-crm-contact-actions-bar",Pp=async()=>{let t=ci();if(!t){document.getElementById(dn)?.remove();return}let e=null;try{e=await M(`#${Dp}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(dn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=bi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},$e="ws-crm-prepare-contract-button-opp",Et=`${$e}-wrap`,Hp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fp=/\/v2\/location\/([A-Za-z0-9]+)/,Bp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pn=()=>{let t=window.location.pathname,e=t.match(Hp);if(!e)return null;let o=t.match(Fp);return o?{oppId:e[1],tenantId:o[1]}:null},Rp=async()=>{for(let t of Bp)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Eo=!1,Tt=null,bn=null,sn=null,ln,St=()=>{Tt?.disconnect(),Tt=null,bn=null},Np=t=>{if(Tt&&bn===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(bn=t,Tt=new MutationObserver(()=>{let o=pn();if(!o||o.oppId!==t){St();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById($e)?.remove(),document.getElementById(Et)?.remove(),St();return}document.getElementById($e)||hi()}),Tt.observe(e,{childList:!0,subtree:!0}))},zp=()=>{sn||(sn=new MutationObserver(()=>{ln===void 0&&(ln=window.setTimeout(()=>{ln=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById($e);t&&!e&&!Eo&&hi()},300))}),sn.observe(document.body,{childList:!0,subtree:!0}))},hi=async()=>{if(!Eo){Eo=!0;try{let t=pn();if(!t){document.getElementById($e)?.remove(),document.getElementById(Et)?.remove(),St();return}let e=document.getElementById($e);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Et)?.remove(),St());return}e&&(e.remove(),document.getElementById(Et)?.remove());let o=await Rp();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=pn();if(!a||a.oppId!==t.oppId)return;let i=bi();i.id=$e,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Et,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Np(t.oppId)}finally{Eo=!1}}},mi=()=>{Lp(),Pp()};lp();function X(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function pe(t){return X(t)}var Oo="reos-theme-stylesheet",Mi="reos-theme-fonts",Gp=()=>{let t=document.getElementById(Mi);t&&t.remove()},qp=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var F=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Pi=()=>{if(p.info(`Loaded v${Pt} (built ${Ht})`),Ro()){p.info(`[main] customizer disabled for excluded location ${Oe()} \u2014 bailing`);return}F("mountVersionBadge (initial)",Po),F("mountFavicon",Yn),F("mountThemeStylesheet",Oi),F("mountHideLaunchpad",Ar),F("initPageRouter",fn),p.info("[main] registering onPageChange subscriber"),Dt(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),Ro()){p.info(`[main] page change into excluded location ${Oe()} \u2014 skipping mounts`);return}F("mountVersionBadge",Po),F("mountHideLaunchpad",Ar),F("mountClaimReleaseToggle",Bn),F("mountContactActionsBar",jn),F("mountActiveFollowUpButton",An),F("mountMtOfferMadeButton",Xn),F("mountNotInterestedButton",Qn),F("mountResendDealLinkButton",ea),F("mountReducePriceButton",ra),F("mountEditLandingPageButton",na),F("mountPublishButton",sa),F("mountContactMapLinks",ha),F("mountSendToClosingOfficeButton",fa),F("mountOppActionBar",Pa),F("mountClosingAgentPickerButton",Xa),F("mountPrepareContractButton",mi),F("mountManageTeam",ti),F("mountBuyBoxWidget",Dn),F("mountSupportNavItem",qa)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pi):Pi();})();
