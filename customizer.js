/* Wholesaling CRM Customizer v0.13.10 — built 2026-05-25T23:44:27.375Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var W="[wholesaling-crm-customizer]",bt="__WS_CRM_DEBUG",ht=()=>!!window[bt],b={info(...o){console.log(W,...o)},warn(...o){console.warn(W,...o)},error(...o){console.error(W,...o)},debug(...o){ht()&&console.log(W,"[debug]",...o)}};var ge=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,be=/\/v2\/location\/([A-Za-z0-9]+)/,pt=o=>{let e=o.match(ge);if(!e)return null;let t=o.match(be);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},mt=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ge);if(!n)continue;let a=r.match(be)||window.location.pathname.match(be);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},g=()=>{let o=pt(window.location.pathname);return o||mt()};var fe=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},K="",he=null,M="other",pe=new Set,j=()=>{let o=g()?.contactId??null;if(!(!(window.location.pathname!==K)&&!(o!==he))){K=window.location.pathname,he=o,M=fe(),b.debug("Page/context changed:",M,K,"contact:",o);for(let r of pe)try{r(M)}catch(n){b.error("Subscriber threw:",n)}}},we=o=>(pe.add(o),setTimeout(()=>o(M),0),()=>{pe.delete(o)}),xe=()=>{M=fe(),K=window.location.pathname,he=g()?.contactId??null,b.debug("Router init, current page:",M);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),j()},history.replaceState=function(t,r,n){e(t,r,n),j()},window.addEventListener("popstate",j),setInterval(j,1e3)};var Y="0.13.10",X="2026-05-25T23:44:27.376Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let l,c,p=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),l=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var d={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},me={purple:"#8B5CF6",green:d.emerald,orange:d.amber,red:d.crimson},J=o=>{let e=o==="emerald"?d.emeraldGlow:o==="amber"?d.amberGlow:d.slate,t=o==="emerald"?d.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":d.steel,r=o==="emerald"?d.emerald:o==="amber"?d.amber:d.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var _t=/^[A-Za-z0-9]{15,30}$/,O=o=>typeof o=="string"&&_t.test(o),vt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ut=()=>{let o=window.WS_CRM_USER_ID;return O(o)?o:null},yt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(O(t))return t;return null},gt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=vt(e);if(!t)return null;let r=t.uid;if(O(r))return r;let n=t.claims;if(n&&O(n.user_id))return n.user_id}catch{}return null},ft=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(O(n))return n}catch{}}}catch{}return null},F=()=>ut()||yt()||gt()||ft()||null;var Te="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",wt=`${Te}/active-follow-up-get`,xt=`${Te}/active-follow-up-set`,G="ws-crm-active-follow-up-button",ve={amber:{label:"Add to Active Follow Up",bg:d.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:d.amber,clickable:!0,dotColor:d.amber},blue:{label:"In Active Follow Up",bg:d.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:d.blue,clickable:!1,dotColor:d.blue},gray:{label:"Not in Follow Up",bg:d.slate,border:d.steel,color:d.coolGray,clickable:!1,dotColor:d.coolGray},loading:{label:"Active Follow Up\u2026",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.ash},error:{label:"Follow Up status unavailable",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.crimson}},kt=()=>{let o=g();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Et=async o=>{let e=await fetch(wt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Tt=async(o,e)=>{let t=await fetch(xt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},H=(o,e)=>{let t=ve[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},ke=o=>{let e=document.createElement("button");return e.type="button",e.id=G,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,H(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=kt();if(!(!r||r.contactId!==o)){H(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Tt(r,F()),a=n&&n.state&&n.state in ve?n.state:"blue";H(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),H(e,"error"),setTimeout(()=>void Q(e,r),4e3)}}}),e},Q=async(o,e)=>{H(o,"loading");try{let t=await Et(e),r=t&&t.state&&t.state in ve?t.state:"gray",n=document.getElementById(G);if(!n||n.dataset.contactId!==e.contactId)return;H(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),H(o,"error")}},St=[".central-panel","[class*='central-panel']"],_e="ws-crm-contact-actions-bar",Ct=async()=>{for(let o of St)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},At=async(o,e)=>{let t=e.querySelector(`#${_e}`);if(!t)try{t=await C(`#${_e}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
