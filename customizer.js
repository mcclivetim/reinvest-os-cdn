...
`;var Vi=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&Vi.test(t),kn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Wi=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},ji=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},Ki=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=kn(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},Yi=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},L=()=>Wi()||ji()||Ki()||Yi()||null,Ji=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=kn(e);return o?o.claims??o:null}catch{return null}},En=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ji()?.type==="agency"};var An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Xi=`${An}/active-follow-up-get`,Qi=`${An}/active-follow-up-set`,Ee="ws-crm-active-follow-up-button",Vo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Zi=()=>{let t=H();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},es=async t=>{let e=await fetch(Xi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ts=async(t,e)=>{let o=await fetch(Qi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Te=(t,e)=>{let o=Vo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Tn=t=>{let e=document.createElement("button");return e.type="button",e.id=Ee,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,s.appendChild(i),G(o).appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Hd(t.oppId)},_t=null,$r=null,yt=()=>{_t?.disconnect(),_t=null,$r=null},Hd=t=>{if(_t&&$r===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,_t=new MutationObserver(()=>{let o=co();if(!o||o.oppId!==t){yt();return}let r=D();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(_e)?.remove(),document.getElementById(Ce)?.remove(),se(),yt();return}document.getElementById(_e)||Mr()}),_t.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Pd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(_e);if(t&&!e&&!so){let o=co();if(o&&po.has(o.oppId))return;Mr()}},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},wa=()=>{Pd(),Mr()};var Hr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Fd=`${Hr}/tc/welcome-call-prefill`,Bd=`${Hr}/tc/welcome-call-save`,Rd=`${Hr}/tc/order-lockbox`,gt="ws-crm-welcome-call-overlay",Nd=["Regular Contract","Subject To","Seller Finance","Novation"],zd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Gd=["Gas","Electric","Propane","Oil"],qd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Ud=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ye=["Yes","No"],Vd=["Yes","No","Unknown"],Wd=["Professional Photographer","Seller","Tenant"],jd=["Month-to-Month","Annual"],xa=["Current","Behind"],Kd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ce=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),ho=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ta="margin-bottom:12px;",Sa=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Yd=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ka=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),q=(t,e,o)=>{let r=ka(o);return`<select id="${t}" style="${ho}"><option value=""></option>${e.map(a=>`<option ${r!==""&&ka(a)===r?"selected":""}>${ce(a)}</option>`).join("")}</select>`},J=(t,e,o="")=>`<input id="${t}" type="text" value="${ce(e)}" placeholder="${ce(o)}" style="${ho}">`,Jd=(t,e)=>`<textarea id="${t}" rows="3" style="${ho}resize:vertical;">${ce(e)}</textarea>`,Xd=(t,e)=>`<input id="${t}" type="date" value="${ce(e)}" style="${ho}">`,$=(t,e)=>`<div style="${Ta}"><label style="${Sa}">${ce(t)}</label>${e}</div>`,Or=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Kd.map(r=>`<label style="${Yd}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},me=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ce(t)}</div>`,ze=()=>{document.getElementById(gt)?.remove()},Ae=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Qd=t=>{let e=t.tenant||{};return`
    ...
    ${me("Contract")}
    ${$("Type of Contract",q("wc-contract_type",Nd,t.contract_type))}

    ${me("Property")}
    ${$("Property Type",q("wc-property_type",qd,t.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${$("Beds",J("wc-beds",t.beds))}</div>
      <div style="flex:1;">${$("Baths",J("wc-baths",t.baths))}</div>
      <div style="flex:1;">${$("Sq Ft",J("wc-sqft",t.sqft))}</div>
    </div>
    ${$("Utilities",q("wc-utilities",zd,t.utilities))}
    ${$("Heat Source",q("wc-heat_source",Gd,t.heat_source))}

    ${me("Liens & Permits")}
    ${$("Is there a mortgage?",q("wc-has_mortgage",ye,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${$("Mortgage payment status",q("wc-mortgage_payment_status",xa,t.mortgage_payment_status))}</div>
    ${$("Any other liens? (back taxes, code violations, HELOC, etc.)",q("wc-has_other_liens",ye,t.has_other_liens))}
    ${$("Any open or expired permits?",q("wc-has_permit_issues",ye,t.has_permit_issues))}
    ${$("Is the property in probate?",q("wc-in_probate",ye,t.in_probate))}

    ${me("Occupancy")}
    ${$("Property occupancy",q("wc-occupancy",Ud,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("First name",J("wc-tenant_first_name",e.first_name))}</div>
        <div style="flex:1;">${$("Last name",J("wc-tenant_last_name",e.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Phone",J("wc-tenant_phone",e.phone))}</div>
        <div style="flex:1;">${$("Email",J("wc-tenant_email",e.email))}</div>
      </div>
      ${$("Lease type",q("wc-tenant_lease_type",jd,e.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Monthly rent",J("wc-tenant_monthly_rent",e.monthly_rent))}</div>
        <div style="flex:1;">${$("Rent due day",J("wc-tenant_rent_due_day",e.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Rent status",q("wc-tenant_rent_status",xa,e.rent_status))}</div>
        <div style="flex:1;">${$("Last rent paid",Xd("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Lease on hand?",q("wc-tenant_lease_on_hand",ye,e.lease_on_hand))}</div>
        <div style="flex:1;">${$("Security deposit",J("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${$("Selling with tenant in place?",q("wc-selling_with_tenant",ye,t.selling_with_tenant))}
    </div>

    ${me("HOA")}
    ${$("Part of an HOA?",q("wc-in_hoa",ye,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${$("HOA monthly fee",J("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${$("HOA rental restriction?",q("wc-hoa_rental_restriction",Vd,t.hoa_rental_restriction))}</div>

    ${me("Photos & Access")}
    ${$("Who is providing photos?",q("wc-photos_provided_by",Wd,t.photos_provided_by))}
    <div style="${Ta}">
    ...
    ${me("Lockbox")}
    ${$("Lockbox needed?",q("wc-lockbox_needed",ye,t.lockbox_needed))}
    ${$("Lockbox code (agree with the seller; recorded on the property for future use)",J("wc-lockbox_code",t.lockbox_code))}
    <div id="wc-lockbox-detail" style="display:none;">
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${$("Recipient name",J("wc-lockbox_recipient_name",t.lockbox_recipient_name))}</div>
        <div style="flex:1;">${$("Recipient phone",J("wc-lockbox_recipient_phone",t.lockbox_recipient_phone))}</div>
      </div>
      ${$("Mailing address (if different from property)",J("wc-lockbox_mailing_address",t.lockbox_mailing_address))}
  ...
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Dr=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Ea=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},bo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?ce(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Zd=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Dr("photos_avail_mornings"),photos_avail_afternoons:Dr("photos_avail_afternoons"),photos_avail_evenings:Dr("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),ec=t=>{ze();let e=document.createElement("div");e.id=gt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="position:sticky;bottom:0;background:${n.graphite};border-top:1px solid ${n.steel};border-radius:0 0 ${v.lg} ${v.lg};padding:14px 20px;display:flex;justify-content:flex-end;gap:10px;">
      ...
      <button id="wc-save" type="button" style="${Y}">Complete Welcome Call</button>
    </div>
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},lc=t=>{Ca(t.oppId,t.locationId)},dc=async(t,e,o)=>(await fetch(oc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,cc=(t,e)=>{fe();let o=document.createElement("div");o.id=$a,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <div style="display:flex;gap:8px;justify-content:flex-end;">
      ...
      <button id="wsrl-submit" type="button" style="${Y}">Order Lockbox</button>
    </div>
  ...
  `,o.innerHTML=`
    ...
    <button id="wsap-confirm" type="button" style="${Y} width:100%; justify-content:center;">Confirm &amp; Advance</button>
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,P=z=>['<option value="">(unset)</option>'].concat(E.map(W=>`<option value="${pe(W)}"${W===z?" selected":""}>${Q(W)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,w.appendChild(y),document.body.appendChild(w);let N=y.querySelector("#ws-pc-purchase-price"),ee=y.querySelector("#ws-pc-emd"),X=y.querySelector("#ws-pc-cash-at-close"),R=!1;X?.addEventListener("input",()=>{R=!0});let Ue=()=>{if(R)return;let z=Number(N?.value||0),W=Number(ee?.value||0);X&&(X.value=String(Math.max(0,z-W)))};N?.addEventListener("input",Ue),ee?.addEventListener("input",Ue);let Lt=()=>w.remove();w.addEventListener("click",z=>{z.target===w&&Lt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Lt);let te=y.querySelector("#ws-pc-submit"),Z=y.querySelector("#ws-pc-error");te?.addEventListener("click",async()=>{if(te){Z&&(Z.textContent=""),te.disabled=!0,te.textContent="Opening\u2026";try{let z=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),W=Number(N?.value||0),Ve=Number(ee?.value||0),We=Number(X?.value||0),je=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ke=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Me=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Je=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),j={};if(z!==s&&(j.sellerName=z),W!==l&&(j.purchasePrice=W),Ve!==d&&(j.emd=Ve),We!==c&&(j.cashAtClose=We),je!==b&&(j.daysToClose=je),Ke!==m&&(j.inspectionDays=Ke),Ye!==h&&(j.additionalTerms=Ye),Me!==_&&(j.currentOccupancy=Me),Je!==x&&(j.occupancyAtClose=Je),Object.keys(j).length>0){p.info("[prepare-contract] PA modal submit with overrides:",j),te.textContent="Saving\u2026";let Po=L(),Fo=await So({tenantId:t,contactId:e,template:o,userId:Po,overrides:j});p.info("[prepare-contract] re-stage with overrides ok:",Fo),te.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let K=i?`${i} - Purchase Agreement`:void 0;await mn(t,e,o,K)}catch(z){te.disabled=!1,te.textContent="Open Contract",Z&&(Z.textContent=z.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",z)}}})},Pp=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(be)?.remove(),pi();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,C="",A=document.createElement("div");A.id=be,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;k.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${N}">
        ...
        <div style="${P}">${Q(c||"(set on Property record)")}</div>
      </div>
      <div style="${N}">
  ...
  `,A.appendChild(k),document.body.appendChild(A);let X=k.querySelector("#ws-pc-assignment-price"),R=k.querySelector("#ws-pc-assignment-fee"),Ue=!1;R?.addEventListener("input",()=>{Ue=!0});let Lt=()=>{if(Ue)return;let W=Number(X?.value||0);R&&(R.value=String(Math.max(0,W-x)))};X?.addEventListener("input",Lt);let te=()=>A.remove();A.addEventListener("click",W=>{W.target===A&&te()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",te);let Z=k.querySelector("#ws-pc-submit"),z=k.querySelector("#ws-pc-error");Z?.addEventListener("click",async()=>{if(!Z)return;z&&(z.textContent="");let W=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ve=Number(X?.value||0),We=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),je=Number(R?.value||0),Ke=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Ye=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Me=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Je=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),j=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Me){z&&(z.textContent="Closing Date is required.");return}Z.disabled=!0,Z.textContent="Opening\u2026";try{let K={};W!==b&&(K.sellerName=W),Ve!==m&&(K.assignmentPrice=Ve),We!==h&&(K.buyerEMD=We),je!==_&&(K.assignmentFee=je),Ke!==E&&(K.closingOffice=Ke),Ye!==w&&(K.buyerCompanyName=Ye);let Po=Me!==y||Je!==f||j!==C,Fo=Object.keys(K).length>0||Po,Bo=a;Fo?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",K),Z.textContent="Saving\u2026",Bo=await So({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Me,buyerEarnestDueDate:Je,lenderSource:j,userId:i,overrides:Object.keys(K).length>0?K:void 0}),p.info("[prepare-contract] AA re-stage ok:",Bo),Z.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let yn=Bo?.debug?.propertyAddress||c,Bi=yn?`${yn} - Assignment Agreement`:void 0;await mn(t,e,o,Bi),te()}catch(K){Z.disabled=!1,Z.textContent="Open Contract",z&&(z.textContent=K.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",K)}})},So=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await fp({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},mn=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await wp(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Ep(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),V(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Ap(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Ip(a,s.title,s.bodyHtml)),Tp(t,a)},Fp=async t=>{let e=hp(t);if(!e){V("Could not resolve contact context.","error");return}document.getElementById(ni)?.remove();let o=document.createElement("div");o.id=ni,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await gp(e.tenantId,e.contactId)}catch(f){V(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){V("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await ci(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),C=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${C}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);V("Reading contract data\u2026","info",2500);let E;try{E=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:c})}catch(y){V(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){V("Could not resolve buyer contact for this opp.","error",6e3);return}Pp({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){V("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await yp(e.tenantId,e.contactId)}catch(_){V(`Failed to load ACQ opps: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){V("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await ci(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,p.info(`[prepare-contract] picked ACQ opp ${m}`)}V("Reading contract data\u2026","info",2500);let h;try{h=await So({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(_){V(`Failed to prepare contract: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",_);return}Hp({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){V("This template needs to be started from a contact page.","error",6e3);return}V(`Opening ${i.name}\u2026`,"info",2500);try{await mn(e.tenantId,e.contactId,i)}catch(b){V(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),V(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},mi=()=>{let t=document.createElement("button");return t.id=cn,t.type="button",t.style.cssText=`${O} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Fp(t)}),t},Bp="ws-crm-contact-actions-bar",Rp=async()=>{let t=bi();if(!t){document.getElementById(cn)?.remove();return}let e=null;try{e=await M(`#${Bp}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(cn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=mi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},$e="ws-crm-prepare-contract-button-opp",Et=`${$e}-wrap`,Np=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zp=/\/v2\/location\/([A-Za-z0-9]+)/,Gp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bn=()=>{let t=window.location.pathname,e=t.match(Np);if(!e)return null;let o=t.match(zp);return o?{oppId:e[1],tenantId:o[1]}:null},qp=async()=>{for(let t of Gp)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Eo=!1,Tt=null,hn=null,ln=null,dn,St=()=>{Tt?.disconnect(),Tt=null,hn=null},Up=t=>{if(Tt&&hn===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(hn=t,Tt=new MutationObserver(()=>{let o=bn();if(!o||o.oppId!==t){St();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById($e)?.remove(),document.getElementById(Et)?.remove(),St();return}document.getElementById($e)||ui()}),Tt.observe(e,{childList:!0,subtree:!0}))},Vp=()=>{ln||(ln=new MutationObserver(()=>{dn===void 0&&(dn=window.setTimeout(()=>{dn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById($e);t&&!e&&!Eo&&ui()},300))}),ln.observe(document.body,{childList:!0,subtree:!0}))},ui=async()=>{if(!Eo){Eo=!0;try{let t=bn();if(!t){document.getElementById($e)?.remove(),document.getElementById(Et)?.remove(),St();return}let e=document.getElementById($e);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Et)?.remove(),St());return}e&&(e.remove(),document.getElementById(Et)?.remove());let o=await qp();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await U();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=bn();if(!a||a.oppId!==t.oppId)return;let i=mi();i.id=$e,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Et,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Up(t.oppId)}finally{Eo=!1}}},vi=()=>{Dp(),Rp()};bp();function Q(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function pe(t){return Q(t)}var Oo="reos-theme-stylesheet",Di="reos-theme-fonts",Wp=()=>{let t=document.getElementById(Di);t&&t.remove()},jp=`
/* ============================================
