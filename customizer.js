...
/* 15b. EMPTY-STATE ICON BADGES \u2014 .hl-empty-icon is GHL's circular badge
   used across the UI to indicate empty/no-data states (no contacts found,
   no results, etc.). Ships with a light/white circular background that
   reads as a bright ring on the dark surface. Switch to graphite fill +
   steel hairline + emerald icon so the badge feels native to the theme.
   The SVG inside uses stroke="currentColor", so setting color on the
   badge cascades into the stroke. */
