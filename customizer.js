/* Wholesaling CRM Customizer v0.54.1 — built 2026-07-09T23:31:01.994Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var nr="[wholesaling-crm-customizer]",Ep="__WS_CRM_DEBUG",$p=()=>!!window[Ep],p={info(...t){console.log(nr,...t)},warn(...t){console.warn(nr,...t)},error(...t){console.error(nr,...t)},debug(...t){$p()&&console.log(nr,"[debug]",...t)}};var Tp=/\/v2\/location\/([A-Za-z0-9]+)/,Cp=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match(Tp);return t?t[1]:null},Sn=()=>{let t=K();return t!==null&&Cp.has(t)};var Qs=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,An=/\/v2\/location\/([A-Za-z0-9]+)/,Lp=t=>{let e=t.match(Qs);if(!e)return null;let o=t.match(An);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Sp=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Qs);if(!a)continue;let s=r.match(An)||window.location.pathname.match(An);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=Lp(window.location.pathname);return t||Sp()};var Zs=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},sr="",In=null,ae="other",Mn=new Set,ar=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==sr)&&!(t!==In))){sr=window.location.pathname,In=t,ae=Zs(),p.debug("Page/context changed:",ae,sr,"contact:",t);for(let r of Mn)try{r(ae)}catch(a){p.error("Subscriber threw:",a)}}},_t=t=>(Mn.add(t),setTimeout(()=>t(ae),0),()=>{Mn.delete(t)}),Xs=()=>{ae=Zs(),sr=window.location.pathname,In=D()?.contactId??null,p.debug("Router init, current page:",ae);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),ar()},history.replaceState=function(o,r,a){e(o,r,a),ar()},window.addEventListener("popstate",ar),setInterval(ar,1e3)},ke=()=>ae;var Ap=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,oi=null,ti=!1,ei=t=>{let e=t.match(Ap);e&&(oi=e[1])},ri=()=>{if(!ti){ti=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&ei(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{ei(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},Tt=()=>oi;var ir="0.54.1",lr="2026-07-09T23:31:01.994Z";var Ip="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",dr=new Map,Pn=new Map,Mp=3e4,se=4e3,Pp=se,Ct=async(t,e)=>{if(!t)return null;let o=dr.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<Mp)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=Pn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),Pp);try{let l=`${Ip}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),dr.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let h=(m.contact_type||"").toLowerCase().trim()||null;return dr.set(t,{type:h}),p.debug(`Resolved Contact Type for ${t}: ${h??"(unset)"}`),h}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),dr.set(t,{type:null,failedAt:Date.now()}),null}})();Pn.set(t,s);try{return await s}finally{Pn.delete(t)}},Lt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let h=a.querySelector(t);h&&(m(),s(h))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},b={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},On={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ni=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var Bn="https://services.leadconnectorhq.com",ai="__WS_CRM_CAPTURED_AUTH";var Rn=()=>{try{let t=localStorage.getItem(ai);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(ai),null):e:null}catch{return null}},Op=()=>{let t=Rn();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},Hn=async(t,e={})=>{let o=Op();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Bp=/^[A-Za-z0-9]{15,30}$/,ie=t=>typeof t=="string"&&Bp.test(t),Dn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Rp=()=>{let t=window.WS_CRM_USER_ID;return ie(t)?t:null},Hp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ie(o))return o;return null},Dp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);if(!o)return null;let r=o.uid;if(ie(r))return r;let a=o.claims;if(a&&ie(a.user_id))return a.user_id}catch{}return null},Fp=()=>{try{let t=Rn();if(!t?.authorization)return null;let e=t.authorization.replace(/^Bearer\s+/i,""),o=Dn(e);if(!o)return null;if(o.authClass==="User"&&ie(o.authClassId))return o.authClassId;if(ie(o.primaryAuthClassId))return o.primaryAuthClassId}catch{}return null},zp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ie(a))return a}catch{}}}catch{}return null},B=()=>Rp()||Dp()||Fp()||Hp()||zp()||null,Np=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);return o?o.claims??o:null}catch{return null}},Ee=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Np()?.type==="agency"};var di="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",qp=`${di}/active-follow-up-get`,Up=`${di}/active-follow-up-set`,le="ws-crm-active-follow-up-button",zn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},jp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Wp=async t=>{let e=await fetch(qp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Gp=async(t,e)=>{let o=await fetch(Up,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},de=(t,e)=>{let o=zn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},si=t=>{let e=document.createElement("button");return e.type="button",e.id=le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,de(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=jp();if(!(!r||r.contactId!==t)){de(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Gp(r,B()),s=a&&a.state&&a.state in zn?a.state:"blue";de(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),de(e,"error"),setTimeout(()=>void pr(e,r),4e3)}}}),e},Kp=3e4,pr=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),de(t,"loading");try{let o=await Wp(e),r=o&&o.state&&o.state in zn?o.state:"gray",a=document.getElementById(le);if(!a||a.dataset.contactId!==e.contactId)return;de(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,de(t,"error")}},Vp=[".central-panel","[class*='central-panel']"],Fn="ws-crm-contact-actions-bar",Yp=async()=>{for(let t of Vp)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Jp=async(t,e)=>{let o=e.querySelector(`#${Fn}`);if(!o)try{o=await A(`#${Fn}`,{timeoutMs:se+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${Fn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Qp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},Zp=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Xp=async t=>{if(t==="url"){let o=await Yp();return o?{kind:"contact-detail",target:o}:null}let e=Qp();return e?{kind:"conversations",target:e}:null},ii=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Jp(t,e.target);return o}return Zp(t,e.target),"conversations-header"},tm=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(le);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=Kp&&pr(o,e);return}o&&o.remove();let r=await Xp(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=si(e.contactId),i=await ii(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),li();let d=document.getElementById(le)??s;pr(d,e),cr?.disconnect(),cr=new MutationObserver(()=>{let l=document.getElementById(le);if(!(D()?.contactId===e.contactId)){cr?.disconnect();return}if(!l){let m=si(e.contactId);ii(m,r).then(()=>{li(),pr(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),cr.observe(r.target,{childList:!0})},cr=null,lo=null,ci=()=>{let t=D()?.contactId??null;if(lo&&lo.contactId===t)return;let e=tm().finally(()=>{lo?.promise===e&&(lo=null)});lo={contactId:t,promise:e}},li=()=>{let t=document.querySelectorAll(`#${le}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var em="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",om="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/callstats/sweep-run",mr="ws-crm-analytics-overlay",rm=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],nm=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],P={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},J=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},R=t=>(Number(t)||0).toLocaleString("en-US"),qn=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},po=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},am=()=>`${P.range}|${P.customStart}|${P.customEnd}`,ce=async(t=!1)=>{let e=am();if(!t&&P.cache.has(e)){P.data=P.cache.get(e),P.error=null,pe();return}let o=K();if(!o){P.error="Could not resolve the sub-account id from the URL.",pe();return}P.loading=!0,P.error=null,pe();try{let r={tenant_id:o,range:P.range,tz_offset_minutes:new Date().getTimezoneOffset()};P.range==="custom"&&(r.start=P.customStart,r.end=P.customEnd);let a=await fetch(em,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);P.data=s,P.cache.set(e,s)}catch(r){P.error=r instanceof Error?r.message:String(r)}finally{P.loading=!1,pe()}},I=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},rt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),bo=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${_.lg};padding:16px 18px;min-width:0;`,jn=`font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=I("div",bo+"flex:1;min-width:150px;");return r.appendChild(I("div",jn+"margin-bottom:8px;",rt(t))),r.appendChild(I("div",`font-family:${b.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,rt(e))),o&&r.appendChild(I("div",`font-family:${b.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,rt(o))),r},Q=(t,e)=>{let o=I("div",bo);if(o.appendChild(I("div",jn,rt(t))),!e.length)return o.appendChild(I("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=I("div","margin:0 0 10px;"),i=I("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(I("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,rt(a.label)));let d=I("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,rt(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${rt(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=I("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(I("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(I("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},br=(t,e,o)=>{let r=I("div",bo+"overflow-x:auto;");if(r.appendChild(I("div",jn,rt(t))),!o.length)return r.appendChild(I("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${rt(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${rt(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(I("div","",i)),r},tt=(t,e)=>{let o=I("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},mo=t=>{let e=I("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Rt=t=>(t||[]).map(e=>({label:e.label,primary:R(e.count),barVal:e.count})),sm=t=>(t||[]).map(e=>({label:e.label,primary:J(e.sum),secondary:`\xB7 ${R(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),bi=(t,e)=>{let o=t.calls||{};if(!o.available)return[I("div",`${bo}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${rt(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=e==="acq"?"Seller":"Buyer",a=o[e]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${R(c.dials)} dials`,secondary:`\xB7 ${R(c.connects)} connected \xB7 ${R(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:po(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${po(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[Q(`${r} calls per rep (dials)`,s),Q(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(Q("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${R(c.dials)} dials`,secondary:`\xB7 ${po(c.talk_seconds)} talk`,barVal:c.dials})))),d},im=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(mo([dt("Closed revenue \u2014 365d",J(o.closed_revenue_365),`${R(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",J(o.avg_deal_size_365)),dt("Left to close this month",J(r.sum),`${R(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${R(r.missing_est_close)} missing est. close date`:"")),dt("New leads",R(o.total_leads),"in selected range")])),e.appendChild(mo([dt("Contracts",`${R((o.contracts||{}).count)}`,J((o.contracts||{}).sum)+" projected"),dt("Assignments",`${R((o.assignments||{}).count)}`,J((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${R((o.closed||{}).count)}`,J((o.closed||{}).sum)+" closed")])),e.appendChild(tt("1fr 1fr 1fr",[Q("New leads by source",Rt(o.new_leads_by_source)),Q("Contacts per closer (all time)",Rt(o.contacts_per_closer)),Q("Dispo deals per rep (all time)",Rt(o.dispo_deals_per_rep))]))},lm=(t,e)=>{let o=t.acq||{};e.appendChild(tt("1fr 1fr",[Q("Offers made per rep",Rt(o.offers_per_rep)),Q("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:R(a.count),secondary:`\xB7 ${J(a.sum)} projected`,barVal:a.count})))])),e.appendChild(tt("1fr 1fr",[Q("Projected revenue per closer (open escrows)",sm(o.projected_per_closer)),Q("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:J(a.sum),secondary:`\xB7 ${R(a.count)} closings \xB7 avg ${J(a.avg)}`,barVal:a.sum})))]));let r=bi(t,"acq");e.appendChild(r.length>=2?tt("1fr 1fr",r.slice(0,2)):tt("1fr",r)),r.length>2&&e.appendChild(tt("1fr",r.slice(2)))},dm=(t,e)=>{let o=t.dispo||{};e.appendChild(tt("1fr 1fr",[Q("Buyers qualified per dispo rep",Rt(o.buyers_qualified_per_rep)),Q("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:R(a.count),secondary:`\xB7 ${J(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(tt("1fr",[Q("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:J(a.sum),secondary:`\xB7 ${R(a.count)} closings \xB7 avg ${J(a.avg)}`,barVal:a.sum})))]));let r=bi(t,"dispo");e.appendChild(r.length>=2?tt("1fr 1fr",r.slice(0,2)):tt("1fr",r)),r.length>2&&e.appendChild(tt("1fr",r.slice(2)))},cm=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(mo([dt("Open leads",R(r.open)),dt("Won (under contract+)",R(r.won)),dt("Lost / dead",R(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,R(i.leads),R(i.offers),R(i.contracts),`${R(i.assigned_count)} / ${J(i.assigned_sum)}`,`${R(i.closed_count)} / ${J(i.closed_sum)}`,J(i.avg_deal)]);e.appendChild(tt("1fr",[br("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,R(i.leads),R(i.offers),R(i.contracts),`${R(i.assigned_count)} / ${J(i.assigned_sum)}`,`${R(i.closed_count)} / ${J(i.closed_sum)}`,J(i.avg_deal)]);e.appendChild(tt("1fr",[br("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(tt("1fr 1fr",[Q("Dead leads by channel",Rt(o.dead_by_channel)),Q("Dead leads by city",Rt(o.dead_by_city))]))},pm=(t,e)=>{let o=t.tc||{};e.appendChild(mo([dt("Contracted",R(o.contracted),"in selected range"),dt("Closed",R(o.closed)),dt("Lost in escrow",R(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(tt("1fr 1fr",[Q("Deals per TC (contracted in range)",Rt(o.per_tc)),Q("Open escrows by stage",Rt(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,J(a.value),qn(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(tt("1fr",[br("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},mm=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(mo([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${R(r.offers)} offers \xB7 ${R(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${R(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(tt("1fr 1fr",[Q("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Q("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,R(d.leads),R(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(tt("1fr",[br("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${po(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${po(l.talk_seconds)} total \xB7 ${R(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(tt("1fr",[Q("Talk time per contract per rep",d)]))}else e.appendChild(I("div",`${bo}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${rt(i.note||"")}`))},co=t=>`padding:5px 12px;border-radius:${_.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${b.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,pe=()=>{let t=document.getElementById(mr);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=I("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let v of rm){let u=I("button",co(P.range===v.key),rt(v.label));u.onclick=()=>{P.range=v.key,v.key!=="custom"?ce():pe()},r.appendChild(u)}if(P.range==="custom"){let v=`background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,u=I("input",v);u.type="date",u.value=P.customStart;let g=I("input",v);g.type="date",g.value=P.customEnd;let w=I("button",co(!0),"Apply");w.onclick=()=>{P.customStart=u.value,P.customEnd=g.value,P.customStart&&P.customEnd&&ce()},r.appendChild(u),r.appendChild(g),r.appendChild(w)}let a=I("button",co(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ce(!0),r.appendChild(a),o.appendChild(r);let s=I("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let v of nm){let u=I("button",co(P.tab===v.key),rt(v.label));u.onclick=()=>{P.tab=v.key,pe()},s.appendChild(u)}if(o.appendChild(s),e.innerHTML="",P.loading){e.appendChild(I("div",`padding:60px;text-align:center;color:${n.ash};font-family:${b.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(P.error){let v=I("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${b.sans};font-size:13px;`,`Couldn't load analytics: ${rt(P.error)}`),u=I("button",co(!0)+"margin:14px auto 0;display:inline-block;","Retry");u.onclick=()=>void ce(!0);let g=I("div","text-align:center;");g.appendChild(v),g.appendChild(u),e.appendChild(g);return}let i=P.data;if(!i){ce();return}let d=i.range||{},l=Number((i.calls||{}).last_swept)||0,c=l>0?` \xB7 calls as of ${new Date(l).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})} (syncing)`:"";e.appendChild(I("div",`font-family:${b.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${rt(d.label||"")} \xB7 ${qn(d.start)} \u2192 ${qn(d.end)} \xB7 ${R((i.meta||{}).opps)} opps \xB7 ${R((i.meta||{}).contacts)} contacts${c}`));let m=i.insights||[];if(m.length){let v=I("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let u of m.slice(0,6)){let g=u.level==="warn";v.appendChild(I("div",`padding:8px 12px;border-left:3px solid ${g?n.amber:n.blue};background:${g?n.amberGlow:n.blueGlow};border-radius:0 ${_.sm} ${_.sm} 0;font-family:${b.sans};font-size:12px;color:${n.bone};`,rt(u.text)))}e.appendChild(v)}let h=I("div","");P.tab==="company"?im(i,h):P.tab==="acq"?lm(i,h):P.tab==="dispo"?dm(i,h):P.tab==="marketing"?cm(i,h):P.tab==="tc"?pm(i,h):mm(i,h),e.appendChild(h)},me=null,bm=()=>{let t=K();if(t){try{fetch(om,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mode:"sync",tenant_id:t})}).catch(()=>{})}catch{}me&&window.clearTimeout(me),me=window.setTimeout(()=>{me=null,P.open&&(P.cache.clear(),ce(!0))},9e4)}},Un=()=>{if(document.getElementById(mr))return;P.open=!0,bm();let t=I("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${b.sans};`);t.id=mr;let e=I("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=I("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(I("div",`font-family:${b.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=I("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${_.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=hi,o.appendChild(r),e.appendChild(o),e.appendChild(I("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=I("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",ui),pe(),P.data||ce()},ui=t=>{t.key==="Escape"&&hi()},hi=()=>{P.open=!1,me&&(window.clearTimeout(me),me=null),document.getElementById(mr)?.remove(),document.removeEventListener("keydown",ui)},um=["/kpis","ws-kpis","ws-analytics"],hm=/\/custom-menu-link\//,Nn=!1,pi=()=>{if(Nn||!hm.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return um.some(i=>s.includes(i))});if(r){Nn=!0,p.info(`[analytics] custom-menu-link route detected (src=${r.src}) \u2014 opening overlay`);try{history.back()}catch{}setTimeout(()=>{Un(),Nn=!1},50);return}t<10&&setTimeout(e,150)};e()},mi=!1,_i=()=>{if(mi)return;mi=!0,_t(()=>setTimeout(pi,50)),pi();let t=()=>{let e=window.location.hash.replace("#","");(e==="ws-analytics"||e==="ws-kpis")&&Un()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_ANALYTICS=()=>Un(),p.info("[analytics] mounted (menu-link route + hash + window trigger)")};var gi="ws-buybox-nav-icon",Kn="ws-buybox-panel",vi="ws-buybox-modal",_m="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Vn="https://mcclivetim.github.io/reinvest-os-cdn/geo",ur=null,uo=null,ho=null,Gn=async()=>{if(ur)return ur;try{let t=await fetch(`${Vn}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return ur=await t.json(),ur}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},vm=async t=>{if(!uo)try{let e=await fetch(`${Vn}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);uo=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return uo?.[t]??[]},ym=async t=>{if(!ho)try{let e=await fetch(`${Vn}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ho=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return ho?.[t]??[]},Yn=async t=>await(await fetch(_m,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),gm=(t,e)=>Yn({tenant_id:t,action:"list",buyer_contact_id:e}),fm=(t,e,o,r)=>Yn({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),xm=(t,e)=>Yn({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),wm=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},km='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Em='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',$m="nav.w-13, nav[class*='w-13']",Tm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Cm=async()=>{try{return await A($m,{timeoutMs:2500})}catch{return null}},Lm=async()=>{try{return await A(Tm,{timeoutMs:2500})}catch{return null}},Sm=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Am=(t,e)=>{let o=document.createElement("div");return o.id=Kn,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    ...
    ">
      ...
      <button id="ws-buybox-add" type="button" style="
        ...
        border-radius: ${_.sm}; padding: 7px 14px; cursor: pointer;
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Om(t,e,()=>Jn(t,e))}),o},Jn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([gm(t,e),Gn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Im(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Im=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let h=l.key==="state"?wm(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,xm(r,c).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),l.disabled=!1;return}Jn(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),l.disabled=!1}))})})},hr=!1,fi=(t,e)=>{hr=e;let o=Sm(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Mm,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Jn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=xi,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},xi="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Mm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Pm=t=>{let e=document.createElement("button");return e.id=gi,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=xi,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${km.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!hr;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),fi(r,a)}),e},Om=(t,e,o)=>{let r=document.getElementById(vi);r&&r.remove();let a=document.createElement("div");a.id=vi,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",x=>{x.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let x=await Gn();s.innerHTML=h(x),v(x)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let x=await Gn();s.innerHTML=g(x),w(x)}else i.granularity==="county"?(s.innerHTML=u(i.stateCode||""),await vm(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=u(i.stateCode||""),await ym(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 20px;">
      ${["state","county","city","zip"].map(x=>`
        <button type="button" data-granularity="${x}" class="ws-buybox-tile" style="
          background: ${n.steel}; color: ${n.bone};
          border: 1px solid ${n.steel}; border-radius: ${_.md};
          padding: 20px 16px; cursor: pointer; font-family: ${b.sans};
          font-size: 14px; font-weight: 500; text-align: center;
        ">${x.charAt(0).toUpperCase()+x.slice(1)}</button>
      `).join("")}
    </div>
    <div style="display: flex; justify-content: flex-end;">
      <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
    </div>
  `,c=()=>{s.querySelectorAll(".ws-buybox-tile").forEach(x=>{x.addEventListener("mouseenter",()=>{x.style.borderColor=n.emerald,x.style.background=n.emeraldGlow}),x.addEventListener("mouseleave",()=>{x.style.borderColor=n.steel,x.style.background=n.steel}),x.addEventListener("click",()=>{let E=x.dataset.granularity;i.granularity=E,i.step=E==="zip"?3:2,d()})}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove())},m=()=>`
  ...
  `,h=x=>`
    ...
    <input id="ws-buybox-state-search" type="text" placeholder="Filter\u2026" autofocus style="
      ...
      border: 1px solid ${n.steel}; border-radius: ${_.sm};
      font-family: ${b.sans}; font-size: 13px; margin-bottom: 10px;
    ">
    <div id="ws-buybox-state-list" style="max-height: 280px; overflow-y: auto; border: 1px solid ${n.steel}; border-radius: ${_.sm};">
      ${x.map(E=>`
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 16px;">
      <button id="ws-buybox-back" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Back</button>
      <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
    </div>
  `,v=x=>{let E=s.querySelector("#ws-buybox-state-search"),S=s.querySelectorAll(".ws-buybox-state-row");S.forEach(H=>{H.addEventListener("mouseenter",()=>{H.style.background=n.emeraldGlow}),H.addEventListener("mouseleave",()=>{H.style.background="transparent"}),H.addEventListener("click",()=>{i.stateCode=H.dataset.stateCode||"",i.step=3,d()})}),E?.addEventListener("input",()=>{let H=(E.value||"").toLowerCase().trim();x.forEach((j,U)=>{let W=S[U];if(!W)return;let N=!H||j.name.toLowerCase().includes(H)||j.code.toLowerCase()===H;W.style.display=N?"":"none"})}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>E?.focus(),0)},u=x=>`
    ...
    <div style="color: ${n.ash}; padding: 20px 0; text-align: center;">Loading list for ${G(x)}\u2026</div>
  `,g=x=>{let E=x.find(S=>S.code===i.stateCode);return`
      ...
      <div style="background: ${n.emeraldGlow}; border: 1px solid ${n.emeraldBorder}; border-radius: ${_.md}; padding: 16px; margin-bottom: 20px;">
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; gap: 8px;">
          <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
          <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600;">Add ${E?G(E.name):"State"}</button>
        </div>
      </div>
    `},w=x=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>T(i.stateCode||""))},k=x=>{let E=i.granularity==="county"?uo?.[i.stateCode||""]??[]:ho?.[i.stateCode||""]??[];return`
      <div style="font-family: ${b.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${G(x)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${E.length.toLocaleString()} ${G(x).toLowerCase()}s in ${G(i.stateCode||"")}.</div>
      <input id="ws-buybox-value-search" type="text" placeholder="Start typing\u2026" autofocus style="
        ...
        font-family: ${b.sans}; font-size: 13px; margin-bottom: 10px;
      ">
      <div id="ws-buybox-value-list" style="max-height: 280px; overflow-y: auto; border: 1px solid ${n.steel}; border-radius: ${_.sm};"></div>
      <div id="ws-buybox-err" style="color: ${n.crimson}; font-size: 12px; min-height: 16px; margin-top: 8px;"></div>
      <div style="display: flex; justify-content: space-between; margin-top: 12px;">
        <button id="ws-buybox-back" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Back</button>
        <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
      </div>
    `},y=()=>{let x=i.granularity==="county"?uo?.[i.stateCode||""]??[]:ho?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),S=s.querySelector("#ws-buybox-value-list");if(!E||!S)return;let H=j=>{let U=j.toLowerCase().trim();if(!U){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=x.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}S.innerHTML=W.map(N=>`
        <div data-value="${G(N)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${G(N)}
        </div>
      `).join(""),S.querySelectorAll(".ws-buybox-value-row").forEach(N=>{N.addEventListener("mouseenter",()=>{N.style.background=n.emeraldGlow}),N.addEventListener("mouseleave",()=>{N.style.background="transparent"}),N.addEventListener("click",()=>{i.value=N.dataset.value||"",T(i.value)})})};E.addEventListener("input",()=>H(E.value)),H(""),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>E.focus(),0)},f=()=>`
    ...
    <div style="display: flex; justify-content: space-between;">
      ...
      <div style="display: flex; gap: 8px;">
        <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
        <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600;">Add Zip</button>
      </div>
    </div>
  `,$=()=>{let x=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");x&&(x.addEventListener("input",()=>{x.value=x.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),x.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),C())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>x.focus(),0))},C=async()=>{let x=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),S=(x?.value||"").trim();if(!/^\d{5}$/.test(S)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(S)},T=async x=>{if(!i.granularity||!x)return;let E=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),E&&(E.textContent="");try{let H=await fm(t,e,i.granularity,x);if(!H.ok){E&&(E.textContent=H.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
        <div style="text-align: center; padding: 40px 0;">
          <div style="font-size: 32px;">\u2713</div>
          <div style="font-size: 16px; margin-top: 8px;">Added <strong>${G(x)}</strong> to the buy-box.</div>
          <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${H.deduplicated?"(Already existed; not duplicated.)":""}</div>
        </div>
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(H){E&&(E.textContent=`Network error: ${H.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},Wn=!1,$e=null,_o=null,yi=()=>{document.getElementById(gi)?.remove(),document.getElementById(Kn)?.remove(),_o&&$e&&$e.nav.removeEventListener("click",_o,!0),_o=null,$e=null,hr=!1},wi=()=>{Bm()},Bm=async()=>{if(!Wn){Wn=!0;try{let t=D();if(!t){yi();return}let e=document.getElementById(Kn);if(e&&e.dataset.buyerContactId===t.contactId&&$e)return;yi();let o=null;try{o=await Ct(t.contactId,t.locationId)}catch(h){p.warn("[buy-box] Contact Type fetch failed",h);return}if(Lt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([Cm(),Lm()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Am(t.locationId,t.contactId),l=Pm(()=>$e),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};$e=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),_o=h=>{let v=h.target;if(!v||c.iconBtn.contains(v))return;v.closest("button.sidebar-option-button")&&hr&&fi(c,!1)},a.addEventListener("click",_o,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Wn=!1}}};var $i="ws-properties-nav-icon",ta="ws-properties-panel",ki="ws-properties-modal",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",Rm=`${ea}/list-for-contact`,Hm=`${ea}/create-with-opp`,Dm=`${ea}/add-contact`,Fm=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),zm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,Ti=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},_r=t=>{let e=Ti(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},Qn=t=>{let e=Ti(t);return e===null?"&mdash;":e.toLocaleString()},Ci={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},Nm=t=>{let e=(t||"").toString().trim();return e?mt(Ci[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},qm=t=>{let e=(t||"").toString().trim();return e?Ci[e]||e:""},Um={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},jm=t=>{let e=(t||"").toString().trim();return e?Um[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Gt=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,Wm=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Gt("Baths",Qn(t.baths))}
    ${Gt("Sq Ft",Qn(t.sqft))}
    ${Gt("Rehab",Nm(t.rehab_level),qm(t.rehab_level))}
    ${Gt("ARV",_r(t.arv))}
    ${Gt("IMV",_r(t.imv))}
    ${Gt("MAO",_r(t.mao))}
    ${Gt("Ask",_r(t.asking_price))}
  </div>`,Li=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
    z-index: 1000001; padding: 10px 18px; border-radius: ${_.sm};
    background: ${e==="ok"?n.emerald:n.crimson}; color: ${n.bone};
    font-family: ${b.sans}; font-size: 13px; box-shadow: 0 8px 24px rgba(0,0,0,0.5);
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},Gm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',Km='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',Vm="nav.w-13, nav[class*='w-13']",Ym=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Si="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Jm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Qm=async()=>{try{return await A(Vm,{timeoutMs:2500})}catch{return null}},Zm=async()=>{try{return await A(Ym,{timeoutMs:2500})}catch{return null}},oa=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),St=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:13px;outline:none;margin-bottom:10px;`,At=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,ra=`background:${n.emerald};color:${n.bone};border:none;border-radius:${_.sm};padding:8px 18px;cursor:pointer;font-family:${b.sans};font-size:13px;font-weight:600;`,Ai=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 16px;cursor:pointer;font-family:${b.sans};font-size:13px;`,Xm=(t,e)=>{let o=document.createElement("div");return o.id=ta,o.dataset.contactId=e,o.style.cssText=`
    position: fixed; z-index: 9998; display: none;
    background: ${n.graphite}; border: 1px solid ${n.steel};
    border-radius: ${_.lg}; flex-direction: column; overflow: hidden;
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${ra}">+ Add Property</button>
        <button id="ws-prop-close" type="button" title="Close" aria-label="Close" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};width:30px;height:30px;cursor:pointer;font-size:18px;line-height:1;display:flex;align-items:center;justify-content:center;flex:0 0 auto;">&times;</button>
      </div>
    </div>
    <div id="ws-prop-body" style="flex:1;overflow-y:auto;padding:14px 16px;font-size:13px;color:${n.bone};">
      <div style="color:${n.ash};font-style:italic;">Loading\u2026</div>
    </div>
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{eb(t,e,()=>na(t,e))}),o},na=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await oa(Rm,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}tb(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},tb=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${_.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${mt(c||"")}${a.property_type?" &middot; "+mt(jm(a.property_type)):""}</div>
        ${Wm(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${mt(a.property_record_id)}" data-addr="${mt(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};padding:4px 10px;cursor:pointer;font-family:${b.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${Km} Add person</button>
        </div>
      </div>
    `}).join(""),t.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{ob(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>na(o,r))})}),t.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(zm(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},Ii=()=>{document.getElementById(ki)?.remove();let t=document.createElement("div");t.id=ki,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let e=document.createElement("div");return e.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,t.appendChild(e),document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()}),{overlay:t,card:e}},eb=(t,e,o)=>{let{overlay:r,card:a}=Ii();a.innerHTML=`
    ...
    <input id="wp-address" type="text" style="${St}" placeholder="123 Main St" />
    <div style="display:flex;gap:10px;">
      <div style="flex:2;"><label style="${At}">City</label><input id="wp-city" type="text" style="${St}" /></div>
      <div style="flex:1;"><label style="${At}">State</label><input id="wp-state" type="text" maxlength="2" style="${St}" placeholder="NC" /></div>
      <div style="flex:1;"><label style="${At}">Zip</label><input id="wp-zip" type="text" maxlength="10" style="${St}" /></div>
    </div>
    <label style="${At}">Property type (optional)</label>
    <select id="wp-type" style="${St}">
      <option value="">\u2014 select \u2014</option>
      ${Fm.map(i=>`<option value="${mt(i)}">${mt(i)}</option>`).join("")}
    </select>
    <div id="wp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wp-cancel" type="button" style="${Ai}">Cancel</button>
      <button id="wp-save" type="button" style="${ra}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=u=>(a.querySelector(u)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let v=a.querySelector("#wp-save");v&&(v.disabled=!0,v.textContent="Creating\u2026"),s&&(s.textContent="");try{let u=await oa(Hm,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:h||void 0});if(!u.ok){s&&(s.textContent=u.error||"Failed to create property."),v&&(v.disabled=!1,v.textContent="Create property + deal");return}r.remove(),Li("Property + deal created \u2713"),o()}catch(u){s&&(s.textContent=`Network error: ${u.message}`),v&&(v.disabled=!1,v.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},ob=(t,e,o,r)=>{let{overlay:a,card:s}=Ii();s.innerHTML=`
    ...
    <select id="wpp-role" style="${St}">
      <option value="seller_2">Second seller</option>
      <option value="tenant_contact">Tenant</option>
    </select>
    <div style="display:flex;gap:10px;">
      <div style="flex:1;"><label style="${At}">First name</label><input id="wpp-first" type="text" style="${St}" /></div>
      <div style="flex:1;"><label style="${At}">Last name</label><input id="wpp-last" type="text" style="${St}" /></div>
    </div>
    <label style="${At}">Phone (optional)</label>
    <input id="wpp-phone" type="text" style="${St}" placeholder="+1..." />
    <label style="${At}">Email (optional)</label>
    <input id="wpp-email" type="text" style="${St}" />
    <div id="wpp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${Ai}">Cancel</button>
      <button id="wpp-save" type="button" style="${ra}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=g=>(s.querySelector(g)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),h=l("#wpp-phone"),v=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let u=s.querySelector("#wpp-save");u&&(u.disabled=!0,u.textContent="Adding\u2026"),i&&(i.textContent="");try{let g=await oa(Dm,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:h||void 0,email:v||void 0}});if(!g.ok){i&&(i.textContent=g.error||"Failed to add person."),u&&(u.disabled=!1,u.textContent="Add person");return}a.remove(),Li("Person added \u2713"),r()}catch(g){i&&(i.textContent=`Network error: ${g.message}`),u&&(u.disabled=!1,u.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},vr=!1,ht=null,Zn=!1,vo=null,rb=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},nb=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},Xn=(t,e)=>{vr=e,e?(t.iconBtn.className=Jm,t.iconBtn.dataset.active="true",nb(),rb(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",na(t.tenantId,t.contactId)):(t.iconBtn.className=Si,delete t.iconBtn.dataset.active,t.panel.style.display="none")},ab=()=>{let t=document.createElement("button");return t.id=$i,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=Si,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${Gm.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ht&&Xn(ht,!vr)}),t},Ei=()=>{document.getElementById($i)?.remove(),document.getElementById(ta)?.remove(),vo&&ht&&ht.nav.removeEventListener("click",vo,!0),vo=null,ht=null,vr=!1},Mi=()=>{sb()},sb=async()=>{if(!Zn){Zn=!0;try{let t=D();if(!t||!t.locationId){Ei();return}let e=document.getElementById(ta);if(e&&e.dataset.contactId===t.contactId&&ht)return;Ei();let o=null;try{o=await Ct(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Lt(o)!=="seller")return;let[a,s]=await Promise.all([Qm(),Zm()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Xm(t.locationId,t.contactId),l=ab();ht={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ht&&Xn(ht,!1)}),vo=m=>{let h=m.target;!h||ht&&ht.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&vr&&ht&&Xn(ht,!1)},a.addEventListener("click",vo,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{Zn=!1}}};var Pi="ws-non-seller-contact",Oi=()=>{ib()},ib=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(Pi);return}let e="seller";try{e=Lt(await Ct(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(Pi,e!=="seller")};var Kt="ws-crm-claim-release-pill",lb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",db="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",cb=async t=>{let e=await fetch(lb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},pb=async t=>{let e=await fetch(db,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Hi=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ce=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=ni(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},mb=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=Kt,o.type="button",o.dataset.contactId=t,Ce(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=B();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>Ce(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";Ce(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await pb({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;Ce(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),Ce(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Bi=async t=>{try{let e=await cb({contactId:t.contactId,locationId:t.locationId,userId:B()}),o=document.getElementById(Kt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";Ce(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},bb=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Hi(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Ri=(t,e)=>{let o=mb({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${Kt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Te=null,ub=async()=>{let t=D();if(!t){Te?.disconnect(),Te=null,document.getElementById(Kt)?.remove();return}let e=document.getElementById(Kt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await bb(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ri(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(Kt)&&t.locationId&&Bi({contactId:t.contactId,locationId:t.locationId}),Te?.disconnect(),Te=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){Te?.disconnect();return}if(document.getElementById(Kt))return;let d=Hi(o);d&&(Ri(d,t.contactId),document.getElementById(Kt)&&t.locationId&&Bi({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),Te.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Di=()=>{ub()};var Wi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",hb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",_b="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",vb=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||Wi,l;if(i==="buyer"){let m=Vi.find(v=>v.label===o),h=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:h,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},yb=async({contactId:t,tenantId:e})=>{let o=await fetch(_b,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},Le="ws-crm-contact-actions-bar",Gi="ws-crm-call-status-dropdown",Ki="ws-crm-call-status-menu",gr="ws-crm-offer-made-modal",Fi=!1,gb=()=>{Fi||(Fi=!0,document.addEventListener("click",t=>{let e=document.getElementById(Ki);if(!e||e.style.display==="none")return;let o=document.getElementById(Gi);o&&!o.contains(t.target)&&(e.style.display="none")}))},fb=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"no-show",label:"No Show",color:"orange"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Vi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],xb=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],wb=async()=>{for(let t of xb)try{let e=await A(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},kb=({contactId:t,kind:e})=>{let o=e==="buyer"?Vi:fb,r=e==="buyer"?hb:Wi,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Gi,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=O,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=Ki,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${On[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,h=i.children[1],v=i.children[2];m&&(m.style.background=On[l.color]),h&&(h.textContent=l.label),d.style.display="none";let g=D()?.locationId,w=B();if(!g){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),h&&(h.textContent=`${l.label} (no tenant!)`),h&&(h.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!w){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),h&&(h.textContent=`${l.label} (no user!)`),h&&(h.style.color=n.amber);return}let k=v?.textContent??"\u25BE",y=async f=>{v&&(v.textContent="\u2026"),i.style.opacity="0.75";try{await vb({contactId:t,locationId:g,status:l.label,userId:w,deadReason:f,webhookUrl:r,kind:e}),v&&(v.textContent="\u2713"),setTimeout(()=>{v&&(v.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),v&&(v.textContent="\u2717"),h&&(h.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{v&&(v.textContent=k),h&&(h.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let f=h?.textContent??"";Sb($=>{y($)},()=>{h&&(h.textContent=f)});return}if(e==="seller"&&l.value==="appointment-booked"){let f=h?.textContent??"";try{(await yb({contactId:t,tenantId:g})).ok?await y():Ab(()=>{y()},()=>{h&&(h.textContent=f)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),gb(),s.appendChild(i),s.appendChild(d),s},Eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",$b=async t=>{let e=await fetch(Eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Tb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",sa=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Cb=async(t,e)=>{let o=await fetch(Tb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},Lb=t=>new Promise(e=>{document.getElementById(gr)?.remove();let o=document.createElement("div");o.id=gr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${b.sans};">
        <div style="font-size:14px;font-weight:500;">${sa(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${sa(i.dealStage)}</div>`:""}
      ...
      <div style="display:flex;justify-content:flex-end;margin-top:8px;">
        <button id="ws-deal-cancel" type="button" style="${O} padding:8px 16px;font-size:13px;">Cancel</button>
      </div>`,o.appendChild(r),document.body.appendChild(o);let s=i=>{o.remove(),e(i)};o.addEventListener("click",i=>{i.target===o&&s(null)}),r.querySelector("#ws-deal-cancel")?.addEventListener("click",()=>s(null)),r.querySelectorAll(".ws-deal-pick").forEach(i=>{i.addEventListener("click",()=>s(t[Number(i.dataset.i)]??null))})}),yo=(t,e="seller",o)=>{document.getElementById(gr)?.remove();let r=e==="seller",a=r?"Record Your Offer":"Record Buyer's Offer",s=r?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=r?n.emerald:n.amber,d=document.createElement("div");d.id=gr,d.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),h=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",v=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${sa(o.address)}</strong></div>`:"",u=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",g=r&&o&&o.propertyRecordId?`
    ...
    <div style="display:flex;align-items:center;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:0 12px;margin-bottom:16px;">
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},qi=(t,e)=>{let o=document.createElement("div");if(o.id=Le,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){yo(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){yo(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await Cb(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),yo(t,e);return}if(d(),l.length<=1){yo(t,e,l[0]);return}let c=await Lb(l);c&&yo(t,e,c)}),o.appendChild(r),o.appendChild(kb({contactId:t,kind:e}))}return o},aa=!1,Ui=()=>{document.querySelectorAll(`[id="${Le}"]`).forEach(t=>t.remove())},Yi=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),aa){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}aa=!0;try{await Ib()}finally{aa=!1}},Ib=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Ui();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Ui();return}let e="seller";try{let l=await Ct(t.contactId,t.locationId),c=Lt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Le}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await wb();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=qi(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(Le)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),yr?.disconnect(),yr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){yr?.disconnect();return}let c=document.querySelectorAll(`[id="${Le}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,h=qi(t.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),yr.observe(a,{childList:!0})},yr=null,ji=null,Mb=()=>{ji===null&&(ji=window.setInterval(()=>{let t=D();t&&(document.getElementById(Le)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Yi()))},3e3))},Ji=()=>{Mb(),Yi()};var fr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Pb=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),go="data-ws-crm-favicon",ia=t=>t.hasAttribute(go),Qi=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Pb.has(e)},xr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Qi(r)&&!ia(r)&&r.remove()});let e=document.head.querySelector(`link[${go}="1"]`);e?e.href!==fr&&(e.href=fr):(e=document.createElement("link"),e.setAttribute(go,"1"),e.rel="icon",e.type="image/png",e.href=fr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${go}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(go,"apple"),o.rel="apple-touch-icon",o.href=fr,document.head.appendChild(o))},Zi=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)xr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),xr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Qi(i)&&!ia(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ia(i)&&(a=!0)});a&&xr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,xr(),e>=5&&window.clearInterval(o)},1e3)};var Z=".crm-opportunities-modal .ui-modal-heading .description",Xi=new Map,la=null,da,Ob=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Xi){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},V=(t,e,o)=>{Xi.set(t,{selector:e,cb:o}),!la&&(la=new MutationObserver(()=>{da===void 0&&(da=window.setTimeout(()=>{da=void 0,Ob()},300))}),la.observe(document.body,{childList:!0,subtree:!0}))};var Bb=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Rb=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Hb=".hr-card.hr-modal.crm-opportunities-modal",F=()=>{let t=document.querySelector(Hb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Rb);if(a){let s=a[1];if(Bb.includes(s))return s}}return null},X=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=F();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var tl="ws-crm-dispo-action-row",Y=t=>{let e=document.getElementById(tl);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=tl,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Db="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ft="ws-crm-mt-offer-made-button",el="ws-crm-mt-offer-made-modal",Fb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zb=/\/v2\/location\/([A-Za-z0-9]+)/,Er=()=>{let t=window.location.pathname,e=t.match(Fb),o=e?e[1]:Tt();if(!o)return null;let r=t.match(zb);return{oppId:o,locationId:r?r[1]:null}},Nb=async t=>{let e=await fetch(Db,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},wr=()=>{document.getElementById(el)?.remove()},qb=t=>{wr();let e=document.createElement("div");e.id=el,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),s=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&wr()}),s?.addEventListener("click",()=>wr()),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l||Number(l)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(l);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{let m=await Nb({oppId:t.oppId,locationId:t.locationId,amount:c,userId:B()});if(!m.ok){a.textContent=m.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1);return}wr(),t.onSuccess()}catch(m){p.error("MT Offer Made webhook failed",m),a.textContent=m instanceof Error?m.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1)}})},Ub=t=>{let e=document.createElement("button");return e.id=ft,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Er();!o||!o.locationId||o.oppId!==t||qb({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},jb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wb=async()=>{for(let t of jb)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},kr=!1,pa=async()=>{if(!kr){kr=!0;try{await Gb()}finally{kr=!1}}},Gb=async()=>{let t=Er();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await Wb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Er();if(!a||a.oppId!==t.oppId)return;let s=Ub(t.oppId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Kb(t.oppId)},fo=null,ca=null,Se,xo=()=>{fo?.disconnect(),fo=null,ca=null,Se!==void 0&&(window.clearTimeout(Se),Se=void 0)},Kb=t=>{if(fo&&ca===t)return;xo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ca=t,fo=new MutationObserver(()=>{Se===void 0&&(Se=window.setTimeout(()=>{Se=void 0;let o=Er();if(!o||o.oppId!==t){xo();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}document.getElementById(ft)||pa()},250))}),fo.observe(e,{childList:!0,subtree:!0}))},Vb=()=>{V("mt-offer-made",Z,()=>{!document.getElementById(ft)&&!kr&&pa()})},ol=()=>{Vb(),pa()};var Yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",xt="ws-crm-not-interested-button",Jb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qb=/\/v2\/location\/([A-Za-z0-9]+)/,Tr=()=>{let t=window.location.pathname,e=t.match(Jb),o=e?e[1]:Tt();if(!o)return null;let r=t.match(Qb);return{oppId:o,locationId:r?r[1]:null}},Zb=async t=>{let e=await fetch(Yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xb=t=>{let e=document.createElement("button");return e.id=xt,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Tr();if(!o||!o.locationId||o.oppId!==t)return;let r=B(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await Zb({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},tu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],eu=async()=>{for(let t of tu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$r=!1,ba=async()=>{if(!$r){$r=!0;try{await ou()}finally{$r=!1}}},ou=async()=>{let t=Tr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await eu();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Tr();if(!a||a.oppId!==t.oppId)return;let s=Xb(t.oppId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),ru(t.oppId)},wo=null,ma=null,ko=()=>{wo?.disconnect(),wo=null,ma=null},ru=t=>{if(wo&&ma===t)return;ko();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ma=t,wo=new MutationObserver(()=>{let o=Tr();if(!o||o.oppId!==t){ko();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}document.getElementById(xt)||ba()}),wo.observe(e,{childList:!0,subtree:!0}))},nu=()=>{V("not-interested",Z,()=>{!document.getElementById(xt)&&!$r&&ba()})},rl=()=>{nu(),ba()};var au="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",vt="ws-crm-schedule-walkthrough-button",ua="ws-crm-schedule-walkthrough-modal",su=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,iu=/\/v2\/location\/([A-Za-z0-9]+)/,Sr=()=>{let t=window.location.pathname,e=t.match(su),o=e?e[1]:Tt();if(!o)return null;let r=t.match(iu);return{oppId:o,locationId:r?r[1]:null}},Cr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},lu=(t,e)=>{document.getElementById(ua)?.remove();let o=document.createElement("div");o.id=ua,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${ua} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:4px;">
      <button id="wsw-cancel" type="button" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};padding:8px 16px;font-size:13px;font-weight:500;font-family:${b.sans};cursor:pointer;">Cancel</button>
      <button id="wsw-submit" type="button" style="${at}">Schedule</button>
    </div>
  `,o.appendChild(r),document.body.appendChild(o);let i=()=>o.remove();o.addEventListener("click",l=>{l.target===o&&i()}),document.getElementById("wsw-cancel")?.addEventListener("click",i);let d=document.getElementById("wsw-submit");d?.addEventListener("click",async()=>{let l=document.getElementById("wsw-dt")?.value||"",c=document.getElementById("wsw-dur")?.value||"30";if(!l){Cr("Pick a date and time.","err");return}let m=new Date(l).toISOString();d.disabled=!0,d.textContent="Scheduling\u2026";try{if((await fetch(au,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:m,duration_min:Number(c)}),credentials:"omit"})).ok){i(),Cr("Walkthrough scheduled \u2713");let v=document.querySelector(`#${vt} .ws-sw-label`);v&&(v.textContent="Walkthrough Scheduled")}else d.disabled=!1,d.textContent="Schedule",Cr("Scheduling failed \u2014 try again.","err")}catch(h){p.warn("[schedule-walkthrough] failed:",h),d.disabled=!1,d.textContent="Schedule",Cr("Couldn't reach the scheduler. Try again.","err")}})},du=t=>{let e=document.createElement("button");return e.id=vt,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Sr();!o||!o.locationId||o.oppId!==t||lu(o.oppId,o.locationId)}),e},cu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],pu=async()=>{for(let t of cu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lr=!1,_a=async()=>{if(!Lr){Lr=!0;try{await mu()}finally{Lr=!1}}},mu=async()=>{let t=Sr();if(!t||!t.locationId){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o();return}let e=document.getElementById(vt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o());return}e&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove());let o=await pu();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Sr();if(!a||a.oppId!==t.oppId)return;let s=du(t.oppId),i=document.createElement("span");i.id=`${vt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),bu(t.oppId)},Eo=null,ha=null,Ae,$o=()=>{Eo?.disconnect(),Eo=null,ha=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},bu=t=>{if(Eo&&ha===t)return;$o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ha=t,Eo=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=Sr();if(!o||o.oppId!==t){$o();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o();return}document.getElementById(vt)||_a()},250))}),Eo.observe(e,{childList:!0,subtree:!0}))},uu=()=>{V("schedule-walkthrough",Z,()=>{!document.getElementById(vt)&&!Lr&&_a()})},nl=()=>{uu(),_a()};var hu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ie="ws-crm-resend-deal-link-wrap",_u=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vu=/\/v2\/location\/([A-Za-z0-9]+)/,Ir=()=>{let t=window.location.pathname,e=t.match(_u),o=e?e[1]:Tt();if(!o)return null;let r=t.match(vu);return{oppId:o,locationId:r?r[1]:null}},yu=async t=>{let e=await fetch(hu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},gu=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),al=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,ya=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${al(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>fu(t,e)),t.appendChild(o)},fu=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void xu(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>ya(t,e)),o.appendChild(i),t.appendChild(o)},xu=async(t,e,o,r)=>{let a=Ir();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await yu({oppId:a.oppId,locationId:a.locationId,channel:o,userId:B()});if(s?.ok)r.innerHTML=`${al(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${gu(i)}</span>`}window.setTimeout(()=>ya(t,e),3500)}},wu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ku=async()=>{for(let t of wu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ar=!1,ga=async()=>{if(!Ar){Ar=!0;try{await Eu()}finally{Ar=!1}}},Eu=async()=>{let t=Ir();if(!t||!t.locationId){document.getElementById(Ie)?.remove(),Co();return}let e=document.getElementById(Ie);if(e&&e.dataset.oppId===t.oppId){let i=F();i!==null&&i!=="Marketing Tracker"&&(e.remove(),Co());return}e&&e.remove();let o=await ku();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ir();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Ie,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Y(o).appendChild(s),ya(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),$u(t.oppId)},To=null,va=null,Co=()=>{To?.disconnect(),To=null,va=null},$u=t=>{if(To&&va===t)return;Co();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(va=t,To=new MutationObserver(()=>{let o=Ir();if(!o||o.oppId!==t){Co();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ie)?.remove(),Co();return}document.getElementById(Ie)||ga()}),To.observe(e,{childList:!0,subtree:!0}))},Tu=()=>{V("resend-deal-link",Z,()=>{!document.getElementById(Ie)&&!Ar&&ga()})},sl=()=>{Tu(),ga()};var Cu=t=>{let e=(o,r,a)=>o.style.setProperty(r,a,"important");t.querySelectorAll("input, textarea, select").forEach(o=>{if(o instanceof HTMLInputElement&&o.type==="checkbox")return;e(o,"background-color",n.obsidian),e(o,"color",n.bone),e(o,"-webkit-text-fill-color",n.bone),e(o,"border-color",n.steel);let r=o.previousElementSibling;r instanceof HTMLElement&&r.tagName==="DIV"&&(e(r,"color",n.bone),e(r,"-webkit-text-fill-color",n.bone))}),t.querySelectorAll("div").forEach(o=>{e(o,"background-color","transparent"),e(o,"border-style","none")})},Mr=(t,e=8e3)=>{let o=null,r=()=>{o?.disconnect(),Cu(t),o?.observe(t,{attributes:!0,attributeFilter:["style"],subtree:!0})};o=new MutationObserver(r),r(),window.setTimeout(()=>{o?.disconnect(),o=null},e)};var Lu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/referred",Su="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/mt-opps",Oe="ws-crm-add-referral-wrap",Pr="ws-crm-add-referral-contact-btn",xa="ws-crm-contact-actions-bar",yt="ws-referral-modal",Au=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Iu=/\/v2\/location\/([A-Za-z0-9]+)/,Ht=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),dl=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Mu=async t=>{try{return await navigator.clipboard.writeText(t),!0}catch{}try{let e=document.createElement("textarea");e.value=t,e.style.cssText="position:fixed;opacity:0;pointer-events:none;",document.body.appendChild(e),e.select();let o=document.execCommand("copy");return e.remove(),o}catch{return!1}},Pu=t=>{let e=t.trim();if(!e)return{ok:!0,value:""};let o=e.replace(/\D/g,"");return o.length===11&&o.startsWith("1")&&(o=o.slice(1)),o.length!==10?{ok:!1,value:""}:{ok:!0,value:`+1${o}`}},be=`width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;`,Me=t=>`<div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">${t}</div>`,Ea=t=>{document.getElementById(yt)?.remove();let e=document.createElement("div");e.id=yt,e.style.cssText=`
  ...
  `;let r=t.propertyLabel?`<div style="font-size: 12px; color: ${n.emeraldBright}; margin-bottom: 14px;">Property: ${Ht(t.propertyLabel)}</div>`:'<div style="margin-bottom: 14px;"></div>';o.innerHTML=`
    <style id="ws-referral-modal-style">
      ...
      #${yt} input:-webkit-autofill:hover,
      #${yt} input:-webkit-autofill:focus,
      #${yt} input:-webkit-autofill:active {
      ...
      #${yt} input[type="checkbox"] { accent-color: ${n.emerald}; width: 15px; height: 15px; cursor: pointer; }
    </style>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ${Me("First Name *")}
        <input id="ws-ref-first" type="text" autocomplete="off" placeholder="Jane" style="${be}">
      </div>
      <div>
        ${Me("Last Name")}
        <input id="ws-ref-last" type="text" autocomplete="off" placeholder="Doe" style="${be}">
      </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ${Me("Phone")}
        <input id="ws-ref-phone" type="tel" autocomplete="off" placeholder="(555) 555-0100" style="${be}">
      </div>
      <div>
        ${Me("Email")}
        <input id="ws-ref-email" type="email" autocomplete="off" placeholder="jane@company.com" style="${be}">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      ${Me("Buyer Status")}
      <select id="ws-ref-status" style="${be} cursor: pointer;">
    ...
    <div style="margin-bottom: 14px;">
      ${Me("Note (optional)")}
      <textarea id="ws-ref-note" rows="2" autocomplete="off" placeholder="e.g. Husband makes the buying decisions \u2014 wife is on the deed" style="${be} resize: vertical;"></textarea>
    </div>
    ...
    <div style="display: flex; justify-content: flex-end; gap: 8px;">
      <button id="ws-ref-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Cancel</button>
      <button id="ws-ref-submit" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600;">Add Buyer</button>
    </div>
  `,e.appendChild(o),document.body.appendChild(e),Mr(o),e.addEventListener("click",c=>{c.target===e&&e.remove()}),o.querySelector("#ws-ref-cancel")?.addEventListener("click",()=>e.remove());let a=o.querySelector("#ws-ref-first"),s=o.querySelector("#ws-ref-phone"),i=o.querySelector("#ws-ref-email"),d=o.querySelector("#ws-ref-send-label");window.setTimeout(()=>a?.focus(),0);let l=()=>{if(!d)return;let c=!!s?.value.trim(),m=!!i?.value.trim();d.textContent=!c&&m?"Email them the link now":"Text them the link now"};s?.addEventListener("input",l),i?.addEventListener("input",l),o.querySelector("#ws-ref-submit")?.addEventListener("click",async()=>{let c=o.querySelector("#ws-ref-err"),m=x=>{c&&(c.textContent=x)};m("");let h=(a?.value||"").trim(),v=(o.querySelector("#ws-ref-last")?.value||"").trim(),u=(s?.value||"").trim(),g=(i?.value||"").trim().toLowerCase(),w=o.querySelector("#ws-ref-status")?.value||"Unqualified",k=(o.querySelector("#ws-ref-note")?.value||"").trim(),y=o.querySelector("#ws-ref-send")?.checked??!0,f=o.querySelector("#ws-ref-close")?.checked??!1;if(!h){m("First name is required.");return}let $=Pu(u);if(!$.ok){m("Phone must be a 10-digit US number.");return}if(g&&!/.+@.+\..+/.test(g)){m("That email doesn't look valid.");return}if(!$.value&&!g){m("Add a phone or an email for the new buyer.");return}let C=o.querySelector("#ws-ref-submit");C&&(C.disabled=!0,C.textContent="Adding\u2026",C.style.opacity="0.7");let T=()=>{C&&(C.disabled=!1,C.textContent="Add Buyer",C.style.opacity="1")};try{let x=await fetch(Lu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,referring_mt_opp_id:t.referringOppId,referred:{first_name:h,last_name:v,phone:$.value,email:g,buyer_status:w,note:k},send_link:y,close_original:f,triggered_by_user_id:B()||""}),credentials:"omit"});if(!x.ok)throw new Error(`Webhook returned ${x.status} ${x.statusText}`);let E=await x.json(),S=Array.isArray(E)?E[0]:E;if(!S?.ok){m(S?.error||"Something went wrong \u2014 try again."),T();return}p.info(`Referral buyer added (opp ${S.mt_opp_id||"?"})`),Ou(o,S,t,`${h} ${v}`.trim())}catch(x){p.error("Add referral buyer failed",x),m(`Network error: ${x instanceof Error?x.message:"request failed"}`),T()}})},Pe=(t,e)=>{let o=e==="good"?n.emerald:e==="warn"?n.amber:n.ash;return`<span style="display:inline-flex;align-items:center;gap:6px;background:${e==="good"?n.emeraldGlow:"transparent"};border:1px solid ${o};border-radius:999px;padding:4px 12px;font-size:12px;color:${o};margin:0 6px 6px 0;">${t}</span>`},Ou=(t,e,o,r)=>{let a=[];e.contact_created===!1&&a.push(Pe("Existing buyer \u2014 profile reused","info")),e.mt_opp_deduped?a.push(Pe(`Existing deal reused${e.mt_opp_stage?` \u2014 ${Ht(e.mt_opp_stage)}`:""}`,"info")):e.mt_opp_created&&a.push(Pe(`Deal created${e.mt_opp_stage?` \u2014 ${Ht(e.mt_opp_stage)}`:""}`,"good")),e.sent?a.push(Pe(e.sent_channel==="email"?"Email sent \u2713":"Text sent \u2713","good")):e.send_error&&a.push(Pe(`Not sent \u2014 ${Ht(e.send_error)}`,"warn")),e.original_closed&&a.push(Pe("Original buyer's deal closed (Lost - Withdrew)","info"));let s=(e.warnings||[]).map(l=>`<div style="font-size:11px;color:${n.ash};margin-top:4px;">\xB7 ${Ht(l)}</div>`).join(""),i=e.link?`
      <div style="margin: 16px 0 4px;">
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Their personalized deal link</div>
        <span style="display:flex;gap:8px;align-items:center;">
          <input id="ws-ref-link" type="text" readonly value="${Ht(e.link)}" style="${be} flex:1; font-family:${b.mono}; font-size:12px;">
          <button id="ws-ref-copy" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 16px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600; flex-shrink:0;">Copy</button>
        </span>
      </div>`:`<div style="margin: 16px 0 4px; color:${n.amber}; font-size:13px;">No deal link available \u2014 check the property's landing page setup.</div>`;t.innerHTML=`
    ...
    <div style="font-size: 17px; font-weight: 600; margin-bottom: 10px;">${Ht(r||"Buyer")} is set up</div>
    <div style="line-height: 1;">${a.join("")}</div>
    ${s}
    ${i}
    <div style="display: flex; justify-content: flex-end; gap: 8px; margin-top: 18px;">
      <button id="ws-ref-another" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Add Another</button>
      <button id="ws-ref-done" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600;">Done</button>
    </div>
  `,t.querySelector("#ws-ref-done")?.addEventListener("click",()=>{document.getElementById(yt)?.remove()}),t.querySelector("#ws-ref-another")?.addEventListener("click",()=>{Ea(o)});let d=t.querySelector("#ws-ref-copy");d?.addEventListener("click",async()=>{let l=await Mu(e.link||"");d.textContent=l?"Copied \u2713":"Copy failed",window.setTimeout(()=>{d.textContent="Copy"},2e3)})},Bu=t=>new Promise(e=>{document.getElementById(yt)?.remove();let o=document.createElement("div");o.id=yt,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-ref-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${b.sans};">
        <div style="font-size:14px;font-weight:500;">${Ht(i.property_address||"(no address)")}</div>
        ${i.stage_name?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${Ht(i.stage_name)}</div>`:""}
      </button>`).join("");r.innerHTML=`
      <div style="font-family:${b.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin-bottom:8px;">Pick a Property</div>
      <div style="font-size:18px;font-weight:500;margin-bottom:4px;">This buyer is on ${t.length} properties</div>
      <div style="font-size:12px;color:${n.ash};margin-bottom:16px;line-height:1.4;">Which property is the referral about?</div>
      <div>${a}</div>
      <div style="display:flex;justify-content:flex-end;margin-top:8px;">
        <button id="ws-ref-pick-cancel" type="button" style="${O} padding:8px 16px;font-size:13px;">Cancel</button>
      </div>`,o.appendChild(r),document.body.appendChild(o);let s=i=>{o.remove(),e(i)};o.addEventListener("click",i=>{i.target===o&&s(null)}),r.querySelector("#ws-ref-pick-cancel")?.addEventListener("click",()=>s(null)),r.querySelectorAll(".ws-ref-pick").forEach(i=>{i.addEventListener("click",()=>s(t[Number(i.dataset.i)]??null))})}),Or=()=>{let t=window.location.pathname,e=t.match(Au),o=e?e[1]:Tt();if(!o)return null;let r=t.match(Iu);return{oppId:o,locationId:r?r[1]:null}},Ru=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Hu=async()=>{for(let t of Ru)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Br=!1,wa=async()=>{if(!Br){Br=!0;try{await Du()}finally{Br=!1}}},Du=async()=>{let t=Or();if(!t||!t.locationId){document.getElementById(Oe)?.remove(),So();return}let e=document.getElementById(Oe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),So());return}e&&e.remove();let o=await Hu();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[add-referral] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Or();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Oe,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:3;flex-shrink:0;vertical-align:middle;";let i=document.createElement("button");i.type="button",i.style.cssText=O,i.title="The buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal for this property and gets their personalized link",i.innerHTML=`${dl(n.amber)}<span>Add Referral Buyer</span>`,i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-1px)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)"}),i.addEventListener("click",()=>{let d=Or();!d||!d.locationId||Ea({tenantId:d.locationId,referringOppId:d.oppId})}),s.appendChild(i),Y(o).appendChild(s),p.debug(`Mounted Add Referral Buyer button on opp ${t.oppId}`),Fu(t.oppId)},Lo=null,ka=null,So=()=>{Lo?.disconnect(),Lo=null,ka=null},Fu=t=>{if(Lo&&ka===t)return;So();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ka=t,Lo=new MutationObserver(()=>{let o=Or();if(!o||o.oppId!==t){So();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Oe)?.remove(),So();return}document.getElementById(Oe)||wa()}),Lo.observe(e,{childList:!0,subtree:!0}))},il=(t,e)=>{let o=t.querySelector("span");if(!o)return;let r=t.style.color;o.textContent=e.length>72?`${e.slice(0,69)}\u2026`:e,t.style.color=n.crimson,window.setTimeout(()=>{o.textContent="Add Referral Buyer",t.style.color=r},4500)},zu=async t=>{let e=D();if(!e||!e.locationId)return;let o=t.querySelector("span");o&&(o.textContent="Loading deals\u2026"),t.disabled=!0;try{let r=await fetch(`${Su}?tenant_id=${encodeURIComponent(e.locationId)}&contact_id=${encodeURIComponent(e.contactId)}`,{credentials:"omit"}),a=await r.json(),s=Array.isArray(a)?a[0]:a;if(!s?.ok)throw new Error(s?.error||`Lookup failed (${r.status})`);let i=s.opps||[];if(o&&(o.textContent="Add Referral Buyer"),t.disabled=!1,!i.length){il(t,"No open Marketing Tracker deals for this buyer");return}let d=i.length===1?i[0]:await Bu(i);if(!d)return;Ea({tenantId:e.locationId,referringOppId:d.mt_opp_id,propertyLabel:d.property_address})}catch(r){p.error("Add referral buyer lookup failed",r),o&&(o.textContent="Add Referral Buyer"),t.disabled=!1,il(t,r instanceof Error?r.message:"Lookup failed")}},fa=!1,cl=async()=>{if(!fa){fa=!0;try{await Nu()}finally{fa=!1}}},Nu=async()=>{if(!D())return;let e=document.getElementById(xa);if(!e)try{e=await A(`#${xa}`,{timeoutMs:se+2e3})}catch{e=null}if(!e)return;if(e.dataset.contactKind!=="buyer"){document.getElementById(Pr)?.remove();return}let o=D();if(!o||!o.locationId)return;let r=document.getElementById(Pr);if(r&&r.dataset.contactId===o.contactId&&r.parentElement===e)return;r?.remove();let a=document.createElement("button");a.type="button",a.id=Pr,a.dataset.contactId=o.contactId,a.style.cssText=O,a.style.order="6",a.title="This buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal and gets their personalized link",a.innerHTML=`${dl(n.amber)}<span>Add Referral Buyer</span>`,a.addEventListener("click",()=>void zu(a)),e.appendChild(a),p.debug(`Mounted Add Referral Buyer on buyer contact ${o.contactId}`)},ll=!1,qu=()=>{ll||(ll=!0,window.setInterval(()=>{let t=document.getElementById(xa);!t||t.dataset.contactKind!=="buyer"||document.getElementById(Pr)||cl()},3e3))},pl=()=>{V("add-referral-buyer",Z,()=>{!document.getElementById(Oe)&&!Br&&wa()}),wa(),cl(),qu()};var Uu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",wt="ws-crm-reduce-price-button",ml="ws-crm-reduce-price-modal",ju=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wu=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=()=>{let t=window.location.pathname,e=t.match(ju);if(!e)return null;let o=t.match(Wu);return{oppId:e[1],locationId:o?o[1]:null}},Gu=async t=>{let e=await fetch(Uu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Rr=()=>{document.getElementById(ml)?.remove()},Ku=t=>{Rr();let e=document.createElement("div");e.id=ml,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),s=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&Rr()}),s?.addEventListener("click",()=>{Rr()}),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(l);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{await Gu({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:B()}),Rr(),t.onSuccess()}catch(m){p.error("Reduce Price webhook failed",m),a.textContent=m instanceof Error?m.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",s&&(s.disabled=!1)}})},Vu=(t,e)=>{let o=document.createElement("button");return o.id=wt,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Dr();!r||!r.locationId||r.oppId!==t||Ku({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Yu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ju=async()=>{for(let t of Yu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Hr=!1,Ta=async()=>{if(!Hr){Hr=!0;try{await Qu()}finally{Hr=!1}}},Qu=async()=>{let t=Dr();if(!t||!t.locationId){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io();return}let e=document.getElementById(wt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io());return}e&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove());let o=await Ju();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Dr();if(!a||a.oppId!==t.oppId)return;let s=Vu(t.oppId,t.locationId),i=document.createElement("span");i.id=`${wt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Zu(t.oppId)},Ao=null,$a=null,Be,Io=()=>{Ao?.disconnect(),Ao=null,$a=null,Be!==void 0&&(window.clearTimeout(Be),Be=void 0)},Zu=t=>{if(Ao&&$a===t)return;Io();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($a=t,Ao=new MutationObserver(()=>{Be===void 0&&(Be=window.setTimeout(()=>{Be=void 0;let o=Dr();if(!o||o.oppId!==t){Io();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io();return}document.getElementById(wt)||Ta()},250))}),Ao.observe(e,{childList:!0,subtree:!0}))},Xu=()=>{V("reduce-price",Z,()=>{!document.getElementById(wt)&&!Hr&&Ta()})},bl=()=>{Xu(),Ta()};var Re="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Fr="deals.reinvestos.com";var kt="ws-crm-edit-landing-button",th=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,eh=/\/v2\/location\/([A-Za-z0-9]+)/,Nr=()=>{let t=window.location.pathname,e=t.match(th);if(!e)return null;let o=t.match(eh);return{oppId:e[1],locationId:o?o[1]:null}},oh=(t,e)=>{let o=new URL(`https://${Fr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=B();return r&&o.searchParams.set("user",r),o.toString()},rh=(t,e)=>{let o=document.createElement("button");return o.id=kt,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Nr();if(!r||!r.locationId||r.oppId!==t)return;if(!Re){p.warn("[edit-landing] editor session key not configured in this build");return}let a=oh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},nh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ah=async()=>{for(let t of nh)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},zr=!1,La=async()=>{if(!zr){zr=!0;try{await sh()}finally{zr=!1}}},sh=async()=>{let t=Nr();if(!t||!t.locationId){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po();return}let e=document.getElementById(kt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po());return}e&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove());let o=await ah();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Nr();if(!a||a.oppId!==t.oppId)return;let s=rh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${kt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),ih(t.oppId)},Mo=null,Ca=null,He,Po=()=>{Mo?.disconnect(),Mo=null,Ca=null,He!==void 0&&(window.clearTimeout(He),He=void 0)},ih=t=>{if(Mo&&Ca===t)return;Po();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ca=t,Mo=new MutationObserver(()=>{He===void 0&&(He=window.setTimeout(()=>{He=void 0;let o=Nr();if(!o||o.oppId!==t){Po();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po();return}document.getElementById(kt)||La()},250))}),Mo.observe(e,{childList:!0,subtree:!0}))},lh=()=>{V("edit-landing-page",Z,()=>{!document.getElementById(kt)&&!zr&&La()})},ul=()=>{lh(),La()};var vl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Fe="ws-crm-publish-button",Oo="ws-crm-publish-wrap",Ur="ws-crm-publish-dropdown",dh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ch=/\/v2\/location\/([A-Za-z0-9]+)/,Sa=()=>{let t=window.location.pathname,e=t.match(dh);if(!e)return null;let o=t.match(ch);return{oppId:e[1],locationId:o?o[1]:null}},hl=async(t,e)=>{try{let o=await fetch(vl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:B()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},ph=async(t,e)=>{let o=await fetch(vl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:B()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},mh=(t,e)=>{if(!Re){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Fr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=B();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Dt=()=>{document.getElementById(Ur)?.remove()},_l=(t,e,o,r,a)=>{Dt();let s=document.createElement("div");s.id=Ur;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${b.sans};
  `;let d=t.length,l=t.filter(w=>w.filled).length,c=l===d,m=document.createElement("div");m.innerHTML=`
    <div style="
  ...
  `,s.appendChild(m),t.forEach(w=>{let k=document.createElement("div");k.style.cssText=`
      display: flex; align-items: center; gap: 10px;
      padding: 6px 4px; font-size: 12px;
      color: ${w.filled?n.bone:n.ash};
    `;let y=w.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;k.innerHTML=`${y}<span style="flex: 1;">${w.label}</span>`,s.appendChild(k)});let h=document.createElement("div");h.style.cssText=`
    display: flex; align-items: center; gap: 10px;
    margin-top: 12px; padding-top: 12px; border-top: 1px solid ${n.steel};
  `;let v=document.createElement("button");v.type="button",v.textContent="Open editor to finish \u2192",v.style.cssText=`
    cursor: pointer; font-family: inherit; font-size: 12px; font-weight: 600;
    padding: 7px 12px; border-radius: ${_.sm};
    background: ${n.emeraldGlow}; border: 1px solid ${n.emeraldBorder};
    color: ${n.emerald};
  `,v.addEventListener("click",w=>{w.stopPropagation(),mh(o,r)}),h.appendChild(v);let u=document.createElement("button");u.type="button",u.textContent="Re-check",u.title="Re-check after editing the page",u.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,u.addEventListener("click",w=>{w.stopPropagation(),Dt(),a()}),h.appendChild(u),s.appendChild(h),document.body.appendChild(s);let g=w=>{let k=w.target;!s.contains(k)&&!e.contains(k)&&(Dt(),document.removeEventListener("click",g))};window.setTimeout(()=>document.addEventListener("click",g),0)},Vt=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),s="transparent",i=n.steel,d=n.bone,l=n.coolGray,c="Publish Deal",m="",h="pointer",v="1";switch(e.status){case"checking":i=n.steel,d=n.ash,c="Checking\u2026",h="wait",v="0.8";break;case"ready":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,c="Publish Deal";break;case"incomplete":{let u=e.checks?.filter(w=>w.filled).length??0,g=e.checks?.length??0;i=n.amber,d=n.amber,l=n.amber,c=`${u} of ${g} ready`,m="\u25BE";break}case"publishing":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,c="Publishing\u2026",h="wait",v="0.8";break;case"published":s="transparent",i=n.steel,d=n.ash,l=n.emerald,c="Deal Published",h="default",v="0.9";break;case"error":i=n.amber,d=n.amber,l=n.amber,c=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=h,t.style.opacity=v,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},bh=(t,e)=>{let o=document.createElement("button");o.id=Fe,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${at}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};Vt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let u=await hl(t,e);if(!u||!Array.isArray(u.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Vt(o,r);return}r={status:u.published?"published":u.ready?"ready":"incomplete",checks:u.checks},Vt(o,r),document.getElementById(Ur)&&r.checks&&_l(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Vt(o,r),Dt();try{if((await hl(t,e))?.published){r={status:"published"},Vt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let g=await ph(t,e);if(g.ok&&g.published)r={status:"published"},Vt(o,r),p.info(`[publish] published opp ${t}`);else if(g.missing&&g.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Vt(o,r);else throw new Error(g.error||"Publish failed")}catch(u){let g=u instanceof Error?u.message:"Publish failed";p.error("[publish] publish failed",u),r={status:"error",message:g.length>28?"Error \u2014 try again":g},Vt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Ur)?Dt():r.checks&&_l(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),h=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",h);let v=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",h),window.clearInterval(v))},5e3);return o},uh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hh=async()=>{for(let t of uh)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qr=!1,Ia=async()=>{if(!qr){qr=!0;try{await _h()}finally{qr=!1}}},_h=async()=>{let t=Sa();if(!t||!t.locationId){document.getElementById(Fe)?.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro();return}let e=document.getElementById(Fe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro());return}e&&(e.remove(),document.getElementById(Oo)?.remove(),Dt());let o=await hh();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Sa();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=bh(t.oppId,a.locationId),i=document.createElement("span");i.id=Oo,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),vh(t.oppId)},Bo=null,Aa=null,De,Ro=()=>{Bo?.disconnect(),Bo=null,Aa=null,De!==void 0&&(window.clearTimeout(De),De=void 0)},vh=t=>{if(Bo&&Aa===t)return;Ro();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Aa=t,Bo=new MutationObserver(()=>{De===void 0&&(De=window.setTimeout(()=>{De=void 0;let o=Sa();if(!o||o.oppId!==t){Ro();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(Fe)?.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro();return}document.getElementById(Fe)||Ia()},250))}),Bo.observe(e,{childList:!0,subtree:!0}))},yh=()=>{V("publish-button",Z,()=>{!document.getElementById(Fe)&&!qr&&Ia()})},yl=()=>{yh(),Ia()};var gl="data:image/png;base64,",fl="data:image/png;base64,";var gh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],xl=t=>`ws-crm-map-links-${t}`,wl=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),jr=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},kl=(t,e=wl())=>{let o=jr(e,t.addr),r=jr(e,t.city),a=jr(e,t.state),s=jr(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},fh=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,xh=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,wh=(t,e)=>{let{full:o,hasAny:r}=kl(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},kh=t=>{let e=document.createElement("span");e.id=xl(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),wh(t,i)}),d};return e.appendChild(r(gl,"Open in Google Maps",fh)),e.appendChild(r(fl,"Search on Zillow",xh)),e},Eh=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},El=()=>{let t=wl();if(t.length)for(let e of gh){if(document.getElementById(xl(e.key)))continue;let{hasAny:o}=kl(e,t);if(!o)continue;let r=Eh(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(kh(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},ze=null,Ne,$h=()=>{let t=ke();return t==="contact-detail"||t==="other"},Th=()=>{ze||(ze=new MutationObserver(()=>{Ne===void 0&&(Ne=window.setTimeout(()=>{Ne=void 0;try{El()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),ze.observe(document.body,{childList:!0,subtree:!0}))},$l=()=>{ze&&(ze.disconnect(),ze=null),Ne!==void 0&&(window.clearTimeout(Ne),Ne=void 0)},Tl=()=>{if(!$h()){$l();return}Th(),El()},Cl=()=>{$l()};var Ll="ws-crm-hide-launchpad",Ma=/\/launchpad\/?$/,Pa=()=>{if(!Ee()){if(!document.getElementById(Ll)){let t=document.createElement("style");t.id=Ll,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Ma.test(location.pathname)){let t=location.pathname.replace(Ma,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!Ma.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Ch=[{label:"Buy-Box Entries"},{label:"Memberships"}],Sl=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Oa=()=>{let t=Ee(),e=new Set(Ch.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Sl(e);for(let o of[150,500,1200,2500])setTimeout(()=>Sl(e),o)}};var Lh=[{from:"Payments",to:"Contracts"}],Sh=".nav-title, .topmenu-navtitle",Al=()=>{document.querySelectorAll(Sh).forEach(t=>{let e=(t.textContent||"").trim(),o=Lh.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Ba=()=>{Al();for(let t of[150,500,1200,2500])setTimeout(Al,t)};var Il="/payments/proposals-estimates",Ah=/\/payments\/invoices\/?$/,Ih=/\/payments\//,Mh='#sb_payments, a[meta="payments"]',Pl=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Il)&&!(t>3&&!Ih.test(e))){if(Ah.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Il));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Pl(t+1),120)}},Ml=!1,Ph=()=>{Ml||(Ml=!0,document.addEventListener("click",t=>{t.target?.closest?.(Mh)&&setTimeout(()=>Pl(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},Ra=()=>{Ph()};var Ol=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Bl="ws-crm-hide-topmenu-tabs",Ha=()=>{if(document.getElementById(Bl))return;let t=Ol.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Bl,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${Ol.length} top tabs`)};var Dl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Yt="ws-crm-send-to-closing-office-button",ue="ws-crm-send-to-title-co-wrap",Kr="ws-crm-stc-dropdown",Oh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bh=/\/v2\/location\/([A-Za-z0-9]+)/,Fo=()=>{let t=window.location.pathname,e=t.match(Oh);if(!e)return null;let o=t.match(Bh);return{oppId:e[1],locationId:o?o[1]:null}},Rh=5*60*1e3,za=t=>`ws-crm-stc-cache:${t}`,Hh=t=>{try{let e=window.localStorage.getItem(za(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Rh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Dh=(t,e)=>{try{window.localStorage.setItem(za(t),JSON.stringify(e))}catch{}},Fl=t=>{try{window.localStorage.removeItem(za(t))}catch{}},Da="ws-crm:opp-fields-updated",zl=t=>{if(t){Fl(t);try{window.dispatchEvent(new CustomEvent(Da,{detail:{oppId:t}}))}catch{}}},Fh=async(t,e)=>{try{let o=await fetch(Dl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:B()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},zh=async(t,e,o)=>{let r=await fetch(Dl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:B()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Nh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},Rl=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},qh=(t,e)=>{if(e&&Nh(e)){window.setTimeout(()=>Rl(t),300);return}Rl(t)},Et=()=>{document.getElementById(Kr)?.remove()},Wr=(t,e,o)=>{Et();let r=document.createElement("div");r.id=Kr;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(l);let c=["TC","ACQ","MT","DISPO","Property"],m={};t.forEach(u=>{m[u.group]||(m[u.group]=[]),m[u.group].push(u)});let h=[...c.filter(u=>m[u]),...Object.keys(m).filter(u=>!c.includes(u))];for(let u of h){let g=m[u],w=document.createElement("div");w.style.cssText="margin-top: 12px;";let k=document.createElement("div");k.style.cssText=`
      font-family: ${b.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,k.textContent=u,w.appendChild(k),g.forEach(y=>{let f=document.createElement("div"),$=!y.filled&&y.navigable&&y.field_id;f.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${$?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,$&&(f.addEventListener("mouseenter",()=>{f.style.background=n.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",x=>{x.stopPropagation(),y.field_id&&(qh(y.field_id,y.folder),Et())}));let C=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=$?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${C}<span style="flex: 1;">${y.label}</span>${T}`,w.appendChild(f)}),r.appendChild(w)}document.body.appendChild(r);let v=u=>{let g=u.target;!r.contains(g)&&!o.contains(g)&&(Et(),document.removeEventListener("click",v))};window.setTimeout(()=>document.addEventListener("click",v),0)},It=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,c="Send to Closing Office",m="",h="pointer",v="1";switch(e.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,c="Checking\u2026",h="wait",v="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(w=>w.filled).length??0,g=e.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,c=`${u} of ${g} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sending\u2026",h="wait",v="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,c=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=h,t.style.opacity=v,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},Uh=(t,e)=>{let o=document.createElement("button");o.id=Yt,o.type="button",o.dataset.oppId=t;let r=Hh(t),a=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${O}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,It(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Fh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},It(o,a);return}if(y.rate_limited){u=Date.now()+v,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},It(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},It(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Vr.add(t),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et(),Do();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((x,E)=>a.checks[E]?.filled&&!x.filled?s.has(x.label)?x:(T.add(x.label),{...x,filled:!0}):x),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Dh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),It(o,a),document.getElementById(Kr)&&Wr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},It(o,a),Et();try{let f=await zh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},It(o,a),f.checks&&Wr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},It(o,a),window.setTimeout(()=>{w()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},It(o,a),f.checks&&Wr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},It(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Kr)?Et():a.checks&&Wr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":w();break}});let l,c=!1,m=Date.now(),h=1e4,v=5*60*1e3,u=0,g=!1,w=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=Fo();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<u){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};w();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let C=Date.now()-m,T=Math.max(1500,h-C);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&w()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=C=>{let T=C.detail;if(!T||T.oppId!==t)return;Fl(t);let x=0,E=()=>{if(c&&x<8){x+=1,window.setTimeout(E,500);return}w()};E()};window.addEventListener(Da,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(Da,f),window.clearInterval($))},5e3)}return o},jh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wh=async()=>{for(let t of jh)try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Vr=new Set,Hl=null,Gh=t=>{t&&t!==Hl&&(Vr.clear(),Hl=t)},Gr=!1,Na=async()=>{if(Gr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Gr=!0;try{await Kh()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Gr=!1}},Kh=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Fo();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Gh(t.oppId),Vr.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et();return}let e=document.getElementById(Yt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=F();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(ue)?.remove(),Et(),Do());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ue)?.remove(),Et()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Wh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=F();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Fo();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Uh(t.oppId,a.locationId),i=document.createElement("span");i.id=ue,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),Vh(t.oppId)},Ho=null,Fa=null,Do=()=>{Ho?.disconnect(),Ho=null,Fa=null},Vh=t=>{if(Ho&&Fa===t)return;Do();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fa=t,Ho=new MutationObserver(()=>{let o=Fo();if(!o||o.oppId!==t){Do();return}let r=F();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et(),Do();return}document.getElementById(Yt)||Na()}),Ho.observe(e,{childList:!0,subtree:!0}))},Yh=()=>{V("send-to-closing",Z,()=>{if(document.getElementById(Yt)||Gr)return;let t=Fo();t&&Vr.has(t.oppId)||Na()})},Nl=()=>{Yh(),Na()};var ja="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Jh=`${ja}/tc/welcome-call-prefill`,Qh=`${ja}/tc/welcome-call-save`,Zh=`${ja}/tc/order-lockbox`,zo="ws-crm-welcome-call-overlay",Xh=["Regular Contract","Subject To","Seller Finance","Novation"],t_=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],e_=["Gas","Electric","Propane","Oil"],o_=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],r_=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Jt=["Yes","No"],n_=["Yes","No","Unknown"],a_=["Professional Photographer","Seller","Tenant"],s_=["Month-to-Month","Annual"],ql=["Current","Behind"],i_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Mt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Jr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;margin-top:4px;`,Wl="margin-bottom:12px;",Gl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,l_=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Ul=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=Ul(o);return`<select id="${t}" style="${Jr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Ul(a)===r?"selected":""}>${Mt(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${Mt(e)}" placeholder="${Mt(o)}" style="${Jr}">`,d_=(t,e)=>`<textarea id="${t}" rows="3" style="${Jr}resize:vertical;">${Mt(e)}</textarea>`,c_=(t,e)=>`<input id="${t}" type="date" value="${Mt(e)}" style="${Jr}">`,z=(t,e)=>`<div style="${Wl}"><label style="${Gl}">${Mt(t)}</label>${e}</div>`,qa=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${i_.map(r=>`<label style="${l_}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Ft=t=>`<div style="font-family:${b.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${Mt(t)}</div>`,qe=()=>{document.getElementById(zo)?.remove()},he=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},p_=t=>{let e=t.tenant||{};return`
    ${Ft("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${Mt(t.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${Mt(t.deal_address)||"(no address on file)"}</div>

    ${Ft("Contract")}
    ${z("Type of Contract",ot("wc-contract_type",Xh,t.contract_type))}

    ${Ft("Property")}
    ${z("Property Type",ot("wc-property_type",o_,t.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${z("Beds",ct("wc-beds",t.beds))}</div>
      <div style="flex:1;">${z("Baths",ct("wc-baths",t.baths))}</div>
      <div style="flex:1;">${z("Sq Ft",ct("wc-sqft",t.sqft))}</div>
    </div>
    ${z("Utilities",ot("wc-utilities",t_,t.utilities))}
    ${z("Heat Source",ot("wc-heat_source",e_,t.heat_source))}

    ${Ft("Liens & Permits")}
    ${z("Is there a mortgage?",ot("wc-has_mortgage",Jt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${z("Mortgage payment status",ot("wc-mortgage_payment_status",ql,t.mortgage_payment_status))}</div>
    ${z("Any other liens? (back taxes, code violations, HELOC, etc.)",ot("wc-has_other_liens",Jt,t.has_other_liens))}
    ${z("Any open or expired permits?",ot("wc-has_permit_issues",Jt,t.has_permit_issues))}
    ${z("Is the property in probate?",ot("wc-in_probate",Jt,t.in_probate))}

    ${Ft("Occupancy")}
    ${z("Property occupancy",ot("wc-occupancy",r_,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("First name",ct("wc-tenant_first_name",e.first_name))}</div>
        <div style="flex:1;">${z("Last name",ct("wc-tenant_last_name",e.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Phone",ct("wc-tenant_phone",e.phone))}</div>
        <div style="flex:1;">${z("Email",ct("wc-tenant_email",e.email))}</div>
      </div>
      ${z("Lease type",ot("wc-tenant_lease_type",s_,e.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Monthly rent",ct("wc-tenant_monthly_rent",e.monthly_rent))}</div>
        <div style="flex:1;">${z("Rent due day",ct("wc-tenant_rent_due_day",e.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Rent status",ot("wc-tenant_rent_status",ql,e.rent_status))}</div>
        <div style="flex:1;">${z("Last rent paid",c_("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Lease on hand?",ot("wc-tenant_lease_on_hand",Jt,e.lease_on_hand))}</div>
        <div style="flex:1;">${z("Security deposit",ct("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${z("Selling with tenant in place?",ot("wc-selling_with_tenant",Jt,t.selling_with_tenant))}
    </div>

    ${Ft("HOA")}
    ${z("Part of an HOA?",ot("wc-in_hoa",Jt,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${z("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${z("HOA rental restriction?",ot("wc-hoa_rental_restriction",n_,t.hoa_rental_restriction))}</div>

    ${Ft("Photos & Access")}
    ${z("Who is providing photos?",ot("wc-photos_provided_by",a_,t.photos_provided_by))}
    <div style="${Wl}">
      <label style="${Gl}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${qa("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${qa("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${qa("photos_avail_evenings",t.photos_avail_evenings)}
    </div>

    ${Ft("Lockbox")}
    ${z("Lockbox needed?",ot("wc-lockbox_needed",Jt,t.lockbox_needed))}
    ${z("Lockbox code (agree with the seller; recorded on the property for future use)",ct("wc-lockbox_code",t.lockbox_code))}
    <div id="wc-lockbox-detail" style="display:none;">
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Recipient name",ct("wc-lockbox_recipient_name",t.lockbox_recipient_name))}</div>
        <div style="flex:1;">${z("Recipient phone",ct("wc-lockbox_recipient_phone",t.lockbox_recipient_phone))}</div>
      </div>
      ${z("Mailing address (if different from property)",ct("wc-lockbox_mailing_address",t.lockbox_mailing_address))}
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${_.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${b.sans};cursor:pointer;flex-shrink:0;">${Yr(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Yr(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Yr(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${Yr(t).text}</span>
      </div>
    </div>

    ${Ft("Notes")}
    ${z("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",d_("wc-welcome_call_notes",t.welcome_call_notes))}
  `},M=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Ua=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),jl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",M("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",M("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",M("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",M("wc-occupancy")==="Tenant Occupied")},Yr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?Mt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Wa=t=>t==="charge_failed"?"Payment declined \u2014 check the card on file.":t==="no_billing_profile"?"No card on file for this account \u2014 the owner needs to add one.":"Lockbox order failed \u2014 try again.",m_=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:M("wc-contract_type"),property_type:M("wc-property_type"),beds:M("wc-beds"),baths:M("wc-baths"),sqft:M("wc-sqft"),utilities:M("wc-utilities"),heat_source:M("wc-heat_source"),has_mortgage:M("wc-has_mortgage"),mortgage_payment_status:M("wc-mortgage_payment_status"),has_other_liens:M("wc-has_other_liens"),has_permit_issues:M("wc-has_permit_issues"),in_probate:M("wc-in_probate"),occupancy:M("wc-occupancy"),selling_with_tenant:M("wc-selling_with_tenant"),in_hoa:M("wc-in_hoa"),hoa_rental_restriction:M("wc-hoa_rental_restriction"),hoa_monthly_fee:M("wc-hoa_monthly_fee"),photos_provided_by:M("wc-photos_provided_by"),photos_avail_mornings:Ua("photos_avail_mornings"),photos_avail_afternoons:Ua("photos_avail_afternoons"),photos_avail_evenings:Ua("photos_avail_evenings"),lockbox_needed:M("wc-lockbox_needed"),lockbox_code:M("wc-lockbox_code"),lockbox_recipient_name:M("wc-lockbox_recipient_name"),lockbox_recipient_phone:M("wc-lockbox_recipient_phone"),lockbox_mailing_address:M("wc-lockbox_mailing_address"),welcome_call_notes:M("wc-welcome_call_notes"),tenant:M("wc-occupancy")==="Tenant Occupied"?{first_name:M("wc-tenant_first_name"),last_name:M("wc-tenant_last_name"),phone:M("wc-tenant_phone"),email:M("wc-tenant_email"),lease_type:M("wc-tenant_lease_type"),monthly_rent:M("wc-tenant_monthly_rent"),rent_due_day:M("wc-tenant_rent_due_day"),rent_status:M("wc-tenant_rent_status"),last_rent_paid:M("wc-tenant_last_rent_paid"),lease_on_hand:M("wc-tenant_lease_on_hand"),security_deposit:M("wc-tenant_security_deposit")}:void 0}),b_=t=>{qe();let e=document.createElement("div");e.id=zo,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${b.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${zo} input[type="date"]::-webkit-calendar-picker-indicator,#${zo} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    <div style="position:sticky;top:0;background:${n.graphite};border-bottom:1px solid ${n.steel};border-radius:${_.lg} ${_.lg} 0 0;padding:16px 20px;display:flex;align-items:center;justify-content:space-between;z-index:2;">
      <div>
      ...
      <button id="wc-close" type="button" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};width:30px;height:30px;font-size:16px;cursor:pointer;line-height:1;">\xD7</button>
    </div>
    <div style="padding:8px 20px 16px;">${p_(t)}</div>
    <div style="position:sticky;bottom:0;background:${n.graphite};border-top:1px solid ${n.steel};border-radius:0 0 ${_.lg} ${_.lg};padding:14px 20px;display:flex;justify-content:flex-end;gap:10px;">
      <button id="wc-cancel" type="button" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};padding:9px 16px;font-size:13px;font-weight:500;font-family:${b.sans};cursor:pointer;">Cancel</button>
      <button id="wc-save" type="button" style="${at}">Complete Welcome Call</button>
    </div>
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&qe()}),document.getElementById("wc-close")?.addEventListener("click",qe),document.getElementById("wc-cancel")?.addEventListener("click",qe),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",jl)}),jl();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!M("wc-occupancy")){he("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Qh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(m_(t)),credentials:"omit"})).ok?(qe(),he("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,he("Save failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,he("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{let i=await fetch(Zh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:M("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:M("wc-lockbox_recipient_name"),recipient_phone:M("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"});if(i.ok)a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),he("Lockbox order sent to ops \u2713");else{let d="";try{d=String((await i.json()).reason??"")}catch{}a.textContent="Order Lockbox",a.disabled=!1,he(Wa(d),"err")}}catch(i){p.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,he("Couldn't reach the lockbox handler. Try again.","err")}})},Kl=async(t,e)=>{qe();let o=document.createElement("div");o.id=zo,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${b.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Jh}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,b_(r)};var Qa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",u_=`${Qa}/tc/confirm-photo-appointment`,h_=`${Qa}/tc/order-lockbox`,__=`${Qa}/tc/welcome-call-prefill`,Va="ws-crm-opp-action-bar",Yl="ws-crm-opp-overflow",Jl="ws-crm-opp-action-menu",Ya="ws-crm-opp-action-popover",Ql="ws-crm-reorder-lockbox-modal",Zl=".hr-card.hr-modal.crm-opportunities-modal",v_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,y_=/\/v2\/location\/([A-Za-z0-9]+)/,Xl="Welcome Call Needed",Za="Scheduling Photos",td="Photos Scheduled",g_=[Xl,Za,td,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],ed=()=>{let t=window.location.pathname,e=t.match(v_);if(!e)return null;let o=t.match(y_);return o?{oppId:e[1],locationId:o[1]}:null},f_=()=>{let t=document.querySelector(Zl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(g_.includes(r))return r}return null},Zt=()=>{document.getElementById(Jl)?.remove(),document.getElementById(Ya)?.remove(),document.getElementById(Ql)?.remove()},Ga=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Qt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
    z-index: 1000000; padding: 10px 16px; border-radius: ${_.md};
    background: ${n.graphite};
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},x_=t=>{Kl(t.oppId,t.locationId)},w_=async(t,e,o)=>{let r=await fetch(h_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"});if(r.ok)return{ok:!0,reason:""};let a="";try{a=String((await r.json()).reason??"")}catch{}return{ok:!1,reason:a}},k_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Ql,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <div style="display:flex;gap:8px;justify-content:flex-end;">
      <button id="wsrl-cancel" type="button" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};padding:8px 16px;font-size:13px;font-weight:500;font-family:${b.sans};cursor:pointer;">Cancel</button>
      <button id="wsrl-submit" type="button" style="${at}">Order Lockbox</button>
    </div>
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",h=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!h){Qt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{let v=await w_(t,e,{recipient_name:c,recipient_phone:m,ship_to:h});v.ok?(d(),Qt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Qt(Wa(v.reason),"err"))}catch(v){p.warn("[action-bar] reorder lockbox failed:",v),l.disabled=!1,l.textContent="Order Lockbox",Qt("Couldn't reach the lockbox handler. Try again.","err")}}})},od=async t=>{Zt();let e={};try{e=await fetch(`${__}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}k_(t,e)},E_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Ya;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    background: ${n.graphite}; border: 1px solid ${n.steel};
    border-radius: ${_.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${b.sans};
  `,o.innerHTML=`
    ...
    <input id="wsap-dt" type="datetime-local" style="width:100%;box-sizing:border-box;margin-bottom:10px;padding:7px 8px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:12px;" />
    <label style="display:block;font-size:11px;color:${n.ash};margin-bottom:4px;">Photo vendor</label>
    <input id="wsap-vendor" type="text" placeholder="e.g. SnapPro Media" style="width:100%;box-sizing:border-box;margin-bottom:12px;padding:7px 8px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:12px;" />
    <button id="wsap-confirm" type="button" style="${at} width:100%; justify-content:center;">Confirm &amp; Advance</button>
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Qt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(u_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Zt(),Qt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Qt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Qt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Zt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},$_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Jl;let r=e.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${_.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${b.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${_.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Zt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Zr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=O,o.textContent=t,o},T_=()=>{let t=Zr("\u22EE","ghost");return t.style.lineHeight="1",t},C_=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Xl){let r=Zr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>x_(t)),o.appendChild(r),o}if(e===Za){let r=Zr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>E_(t,r)),o.appendChild(r),o}if(e===td){let r=Zr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void od(t)),o.appendChild(r),o}return null},L_=(t,e)=>{let o=[];if(e===Za&&(o=[{label:"Re-order Lockbox",onClick:()=>void od(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Yl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=T_();return a.addEventListener("click",s=>{s.stopPropagation(),$_(o,a)}),r.appendChild(a),r},S_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],A_=async()=>{for(let t of S_)try{let e=await A(t,{timeoutMs:1200});if(e)return e}catch{}return null},Qr=()=>{document.getElementById(Va)?.remove(),document.getElementById(Yl)?.remove(),Zt()},Xr=!1,Xa=async()=>{if(!Xr){Xr=!0;try{let t=ed();if(!t){Qr();return}let e=F();if(e===null)return;if(e!=="Transaction Coordination"){Qr();return}let o=f_(),r=document.getElementById(Va);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=C_(t,o);if(!a){Qr();return}let s=await A_();if(!s)return;Qr();let i=Y(s),d=document.createElement("span");d.id=Va,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=L_(t,o);l&&i.appendChild(l),I_(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{Xr=!1}}},No=null,Ja=null,Ka,Vl=()=>{No?.disconnect(),No=null,Ja=null},I_=t=>{if(No&&Ja===t)return;Vl();let e=document.querySelector(Zl);e&&(Ja=t,No=new MutationObserver(()=>{let o=ed();if(!o||o.oppId!==t){Vl();return}Ka===void 0&&(Ka=window.setTimeout(()=>{Ka=void 0,Xa()},250))}),No.observe(e,{childList:!0,subtree:!0}))},M_=()=>{V("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{Xr||Xa()})},rd=()=>{M_(),Xa()};var P_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",ts=null,nd=null,ad=async()=>{let t=K(),e=B();if(!t||!e)return null;if(ts&&nd===t)return ts;try{let a=(await(await fetch(P_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(i=>i.id===e);if(!a)return null;let s={name:[a.first_name,a.last_name].filter(Boolean).join(" ").trim(),email:(a.email??"").trim(),phone:(a.phone??"").trim(),role:(a.roles??[])[0]?.display??""};return ts=s,nd=t,s}catch(o){return p.warn("[current-rep] roster load failed",o),null}};var zt="ws-support-modal",sd="ws-support-toast",O_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",id="ws-support-submitter-name",ld="ws-support-submitter-email",dd="ws-support-submitter-role",B_=["Bug","Feature Request","Question","Billing","Onboarding Help"],_e=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),R_=(t,e="success",o)=>{let r=document.getElementById(sd);r&&r.remove();let a=document.createElement("div");a.id=sd;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${_e(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${_e(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},md=()=>{document.getElementById(zt)?.remove();let t=(localStorage.getItem(id)??"").trim(),e=(localStorage.getItem(ld)??"").trim(),o=(localStorage.getItem(dd)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=zt,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${b.sans};
  `;let s=document.createElement("div");s.style.cssText=`
    ...
    box-shadow: 0 16px 40px rgba(0, 0, 0, 0.5);
  `;let i=d=>`
    <button type="button" data-category="${_e(d)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${_.md};
  ...
  `;s.innerHTML=`
    <style id="ws-support-modal-style">
      ...
      #${zt} input:-webkit-autofill:hover,
      #${zt} input:-webkit-autofill:focus,
      #${zt} input:-webkit-autofill:active {
        -webkit-text-fill-color: ${n.bone};
        -webkit-box-shadow: 0 0 0 1000px ${n.obsidian} inset;
        box-shadow: 0 0 0 1000px ${n.obsidian} inset;
        caret-color: ${n.bone};
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" autocomplete="off" value="${_e(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" autocomplete="off" value="${_e(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" autocomplete="off" value="${_e(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Title</div>
      <input id="ws-support-title" type="text" autocomplete="off" placeholder="Short summary" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
    </div>

    <div style="margin-bottom: 16px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Description</div>
      <textarea id="ws-support-description" rows="5" autocomplete="off" placeholder="Walk us through what happened. The more detail the faster we can help." style="width: 100%; box-sizing: border-box; padding: 10px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px; resize: vertical;"></textarea>
    </div>

    <div id="ws-support-err" style="color: ${n.crimson}; font-size: 12px; min-height: 18px; margin-bottom: 8px;"></div>

    <div style="display: flex; justify-content: flex-end; gap: 8px;">
      <button id="ws-support-close" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${b.sans}; font-size: 13px;">Close</button>
      <button id="ws-support-submit" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${b.sans}; font-size: 13px; font-weight: 600;">Submit Ticket</button>
    </div>
  `,a.appendChild(s),document.body.appendChild(a),Mr(s),ad().then(d=>{if(!d||!document.getElementById(zt))return;let l=(c,m)=>{let h=s.querySelector(c);h&&!h.value.trim()&&m&&(h.value=m)};l("#ws-support-name",d.name),l("#ws-support-email",d.email),l("#ws-support-role",d.role)}),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=h=>{d&&(d.textContent=h)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(id,r.submitterName),localStorage.setItem(ld,r.submitterEmail),r.submitterRole&&localStorage.setItem(dd,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let v=await(await fetch(O_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:B()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!v.ok){l(v.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let u=v.ticket_short_id||"submitted";R_(`Ticket ${u} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){l(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},H_=["/support-ticket","ws-support-modal","ws-support"],D_=/\/custom-menu-link\//,es=!1,cd=()=>{if(es||!D_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return H_.some(i=>s.includes(i))});if(r){es=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{md(),es=!1},50);return}t<10&&setTimeout(e,150)};e()},F_=t=>{if(!(t instanceof Element))return!1;let e=t.closest("a.custom-link");return!!e&&/^\s*Support\s*$/.test(e.textContent||"")},pd=!1,bd=()=>{pd||(pd=!0,document.addEventListener("click",t=>{F_(t.target)&&(t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),p.info("[support-nav] intercepted Support click (capture) \u2014 opening modal in place, no GHL navigation"),md())},!0),_t(()=>setTimeout(cd,50)),cd(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var ud="ws-phone-assignments-modal",hd="ws-phone-assignments-toast",z_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",N_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",q_=["ACQ","DISPO","TC"],yd="",Xt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),U_=(t,e="success",o)=>{document.getElementById(hd)?.remove();let r=document.createElement("div");r.id=hd;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    position: fixed; bottom: 32px; right: 32px; z-index: 100001;
    background: ${n.graphite}; border: 1px solid ${a};
    border-left: 4px solid ${a}; border-radius: ${_.md};
    padding: 14px 20px; color: ${n.bone}; font-family: ${b.sans};
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Xt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Xt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},j_=(t,e,o)=>{let r=[`<option value="" ${o===yd?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Xt(a)}" ${o===a?"selected":""}>${Xt(a)}</option>`)].join("");return`<select data-assign="${Xt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${_.sm};
    font-family: ${b.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},W_=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,rs=async t=>{document.getElementById(ud)?.remove();let e=t||K(),o=document.createElement("div");o.id=ud,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    background:${n.graphite}; border:1px solid ${n.steel};
    border-radius:${_.lg}; padding:28px 32px; color:${n.bone};
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",v=>{v.target===o&&o.remove()}),!e){let v=r.querySelector("#ws-pa-body");v&&(v.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${z_}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(v){p.error("[phone-assignments] GET failed",v);let u=r.querySelector("#ws-pa-body");u&&(u.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Xt(v.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:q_,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=v=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${v} found.</div>`,c=i.length?i.map(v=>`<div style="${W_}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${Xt(v.label||v.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${b.mono};">${Xt(v.e164)}</div>
            </div>
            ${j_(`num:${v.e164}`,s,d[v.e164]??yd)}
          </div>`).join(""):l("phone numbers"),m=v=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${v}</div>`,h=r.querySelector("#ws-pa-body");h&&(h.innerHTML=`
    ${m("Numbers \u2192 Team")}
    <div style="border:1px solid ${n.steel};border-radius:${_.md};overflow:hidden;">${c}</div>
    <div id="ws-pa-err" style="color:${n.crimson};font-size:12px;min-height:18px;margin-top:10px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:8px;">
      <button id="ws-pa-close" type="button" style="background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 18px;cursor:pointer;font-family:${b.sans};font-size:13px;">Close</button>
      <button id="ws-pa-save" type="button" style="background:${n.emerald};color:${n.obsidian};border:none;border-radius:${_.sm};padding:8px 22px;cursor:pointer;font-family:${b.sans};font-size:13px;font-weight:600;">Save</button>
    </div>`,h.querySelectorAll("select[data-assign]").forEach(v=>{v.addEventListener("change",()=>{let u=v.getAttribute("data-assign")||"",[g,...w]=u.split(":"),k=w.join(":");g==="num"&&(v.value?d[k]=v.value:delete d[k])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let v=h.querySelector("#ws-pa-err"),u=w=>{v&&(v.textContent=w)};u("");let g=h.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(N_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){u(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),U_("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(w){u(`Network error: ${w.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},G_=["ws-phone-assignments","phone-assignments"],K_=/\/custom-menu-link\//,os=!1,_d=()=>{if(os||!K_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return G_.some(i=>s.includes(i))});if(r){os=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{rs(s),os=!1},50);return}t<10&&setTimeout(e,150)};e()},vd=!1,gd=()=>{if(vd)return;vd=!0,_t(()=>setTimeout(_d,50)),_d();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&rs()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void rs(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var fd="powerDialerApp",V_=".dialer",Y_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',J_=".dial-item.dial-btn.dial-btn-enabled",Ue=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Q_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},ns=()=>{try{let e=window[fd]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},je=()=>document.querySelector(V_),tn=()=>ns()!==null||je()!==null?!0:!!window[fd],en=(t,e)=>{let o=ns();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},xd=()=>{if(je())return;let t=document.querySelector(Y_);t?Ue(t):p.warn("[dialer-bridge] Voice Calling button not found")},Z_=()=>{let t=document.querySelector(".number-list-container")||je();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},as=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?Q_(t.innerText):null},wd=(t,e)=>{if(as()===t)return!0;let o=ns();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Ue(r);let a=Z_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Ue(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},kd=t=>{let e=t.replace(/[^\d*#+]/g,"");if(en("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Ue(a)}},Ed=()=>{let t=je();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(J_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Ue(e),!0):en("makeCall",{provider:"twilio"})};var ss=()=>{let t=je();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Ue(e.closest("button")||e):en("closeCallBox")},$d=()=>{en("closeCallBox")},Td=t=>{let e=!1,o=()=>{let s=je()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var X_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",tv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Cd=["acq","dispo","tc"],Uo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},qo=null,Ld=null,ev=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&qo&&Ld===o)return qo;try{let a=await(await fetch(`${X_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return qo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},Ld=o,qo}catch(r){return p.warn("[silo] config load failed",r),qo??e}},ve=null,Sd=null,is=async(t=!1)=>{let e=K(),o=B();if(!e||!o)return[];if(!t&&ve&&Sd===e)return ve;try{let s=(await(await fetch(tv,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];ve=Cd.filter(d=>i.includes(d))}else Ee()?ve=[...Cd]:ve=[];return Sd=e,ve}catch(r){return p.warn("[silo] roster load failed",r),ve??[]}},Id=()=>`ws-pd-calling-as:${B()||"anon"}`,Md=t=>{try{localStorage.setItem(Id(),t)}catch{}},ls=async()=>{let t=await is();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(Id())}catch{}return e&&t.includes(e)?e:t[0]},Ad=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},ov=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),Pd=async t=>{let e=await ls();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await ev(),a=ov(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=Ad(t),i=s?a.find(m=>Ad(m)===s):void 0,d=i||a[0];if(!wd(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Uo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=as();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var rv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",Od="data-ws-pd",Bd="ws-crm-pd-panel",Rd="ws-crm-pd-session",te=t=>new Promise(e=>setTimeout(e,t)),jo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),nv=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},av=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},sv=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},iv=async t=>{let e=nv(t);if(!e)return[];let o=av(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await te(550)}return o.scrollTop=0,sv(e)},lv=async(t,e)=>{try{let r=await(await fetch(rv,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},dv=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`,cs=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(Bd)?.remove();let r=document.createElement("div");r.id=Bd,r.style.cssText=dv;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((w,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${k}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${jo(w.name||w.contactId)}</span>
    ...
    <div id="ws-pd-auto-bar" role="switch" aria-checked="true" tabindex="0" title="Toggle auto-advance" style="display:flex;align-items:center;justify-content:space-between;gap:14px;padding:11px 13px;margin-bottom:12px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};border-radius:${_.md};cursor:pointer;user-select:none;outline:none;">
      ...
      <span id="ws-pd-auto-track" style="position:relative;flex:none;width:40px;height:22px;border-radius:${_.pill};background:${n.emerald};transition:background .15s ease;">
    ...
    <input id="ws-pd-search" type="text" placeholder="Filter by name or address\u2026" style="width:100%;box-sizing:border-box;padding:8px 12px;margin-bottom:10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-size:13px;font-family:${b.sans};" />
    ...
    <div id="ws-pd-list" style="flex:1;overflow-y:auto;border:1px solid ${n.steel};border-radius:${_.md};min-height:120px;">${s||`<div style="padding:14px;color:${n.coolGray};font-size:12px;">No ${o.many} found.</div>`}</div>
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      <button id="ws-pd-cancel" type="button" style="background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 18px;cursor:pointer;font-size:13px;font-family:${b.sans};">Cancel</button>
      <button id="ws-pd-start" type="button" style="background:${n.emerald};color:${n.obsidian};border:none;border-radius:${_.sm};padding:8px 22px;cursor:pointer;font-size:13px;font-weight:600;font-family:${b.sans};">Start Calling</button>
    </div>`,r.appendChild(a),document.body.appendChild(r),r.addEventListener("click",w=>{w.target===r&&r.remove()});let i=a.querySelector("#ws-pd-list"),d=a.querySelector("#ws-pd-count"),l=()=>{let w=a.querySelectorAll(".ws-pd-cb:checked").length;d&&(d.textContent=`${w} selected`)};l(),i?.addEventListener("change",l);let c=a.querySelector("#ws-pd-auto-bar"),m=a.querySelector("#ws-pd-auto"),h=a.querySelector("#ws-pd-auto-track"),v=a.querySelector("#ws-pd-auto-knob"),u=()=>{let w=!!m?.checked;h&&(h.style.background=w?n.emerald:n.steel),v&&(v.style.left=w?"20px":"2px"),c?.setAttribute("aria-checked",String(w))},g=()=>{m&&(m.checked=!m.checked,u())};c?.addEventListener("click",g),c?.addEventListener("keydown",w=>{(w.key===" "||w.key==="Enter")&&(w.preventDefault(),g())}),u(),a.querySelector("#ws-pd-search")?.addEventListener("input",w=>{let k=w.target.value.toLowerCase();a.querySelectorAll("[data-row]").forEach(y=>{let f=(y.textContent||"").toLowerCase();y.style.display=f.includes(k)?"flex":"none"})}),a.querySelector("#ws-pd-all")?.addEventListener("change",w=>{let k=w.target.checked;a.querySelectorAll("[data-row]").forEach(y=>{if(y.style.display==="none")return;let f=y.querySelector(".ws-pd-cb");f&&(f.checked=k)}),l()}),a.querySelector("#ws-pd-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-pd-start")?.addEventListener("click",()=>{let w=[];a.querySelectorAll(".ws-pd-cb:checked").forEach(y=>{let f=Number(y.getAttribute("data-i"));e[f]&&w.push(e[f])});let k=a.querySelector("#ws-pd-auto")?.checked??!0;r.remove(),w.length&&Dd(t,w,k)})},Dd=async(t,e,o)=>{let r=K();if(!r)return;document.getElementById(Rd)?.remove();let a={skip:!1,paused:!1,stopped:!1,advance:!1},s=document.createElement("div");s.id=Rd,s.style.cssText=`position:fixed;bottom:24px;left:24px;z-index:100002;width:300px;background:${n.graphite};border:1px solid ${n.steel};border-left:4px solid ${n.emerald};border-radius:${_.md};padding:14px 16px;color:${n.bone};font-family:${b.sans};box-shadow:0 10px 30px rgba(0,0,0,0.5);`,document.body.appendChild(s);let i=(d,l,c)=>{s.innerHTML=`
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${jo(t)} \xB7 ${l+1} of ${e.length}</div>
      ...
      <div style="display:flex;gap:6px;">
        <button id="ws-pd-skip" style="flex:1;background:${n.steel};color:${n.bone};border:none;border-radius:${_.sm};padding:6px;cursor:pointer;font-size:12px;">Skip</button>
        <button id="ws-pd-pause" style="flex:1;background:${n.steel};color:${n.bone};border:none;border-radius:${_.sm};padding:6px;cursor:pointer;font-size:12px;">${a.paused?"Resume":"Pause"}</button>
        <button id="ws-pd-next" style="flex:1;background:${n.emerald};color:${n.obsidian};border:none;border-radius:${_.sm};padding:6px;cursor:pointer;font-size:12px;font-weight:600;">Call Next</button>
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{ss()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{ss()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await lv(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await te(1200);continue}let h=l._phone||m?.phone||"",v=m?.name||l.name;if(!h){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await te(1400);continue}if(await Pd(h),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(u){p.debug("[bulk-dialer] screen-follow nav failed",u)}i(`Calling ${h}\u2026`,d,v);try{xd(),await te(250),kd(h),await te(250),Ed()}catch(u){p.error("[bulk-dialer] dial failed",u)}if(await new Promise(u=>{let g=!1,w=()=>{g||(g=!0,window.clearInterval(y),k(),u())},k=Td(w),y=window.setInterval(()=>{(a.stopped||a.skip)&&w()},300)}),a.stopped)break;try{$d()}catch{}if(d<e.length-1)if(o)for(let u=5;u>0&&!a.stopped&&!a.advance;u--){for(i(`Next call in ${u}s\u2026`,d,v);a.paused&&!a.stopped&&!a.advance;)await te(200);if(a.advance||a.stopped)break;await te(1e3)}else for(i("Ready \u2014 press Call Next",d,v);!a.advance&&!a.stopped;)await te(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},ps='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ms=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},cv=()=>{if(ke()!=="opportunity-list"||!ms()||!tn())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${Od}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(Od,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${_.pill};cursor:pointer;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${ps}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await iv(e);cs(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},We=null,ds,Hd=!1,Fd=()=>{if(Hd)return;Hd=!0,window.WS_CRM_PD_TEST=e=>void Dd("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{ds!==void 0&&window.clearTimeout(ds),ds=window.setTimeout(cv,400)};_t(e=>{e==="opportunity-list"?(t(),We||(We=new MutationObserver(t),We.observe(document.body,{childList:!0,subtree:!0}))):We&&(We.disconnect(),We=null)})};var zd="ws-crm-pd-contacts-btn",pv=t=>new Promise(e=>setTimeout(e,t)),mv=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},bv=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,bs=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=mv(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},uv=async t=>{let e=new Map;if(t)return bs(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(bs(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(bs(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await pv(220);return o.scrollTop=0,[...e.values()]},hv=()=>{if(ke()!=="contact-list"||!ms()||!tn()||document.getElementById(zd))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=zd,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${_.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${b.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${ps}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=bv(),l=await uv(d);cs(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},Ge=null,us,Nd=!1,qd=()=>{if(Nd)return;Nd=!0;let t=()=>{us!==void 0&&window.clearTimeout(us),us=window.setTimeout(hv,400)};_t(e=>{e==="contact-list"?(t(),Ge||(Ge=new MutationObserver(t),Ge.observe(document.body,{childList:!0,subtree:!0}))):Ge&&(Ge.disconnect(),Ge=null)})};var _v="ws-calling-as-chip",vv=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},hs=!1,ye=null,Ud,Wd=0,yv=3e4,gv=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},_s=()=>{if(!ye||ye.isConnected)return;let t=gv();t&&t.parent.insertBefore(ye,t.before)},jd=async()=>{if(!(hs||ye)&&vv()){hs=!0;try{let t=await is();if(!t.length)return;let e=await ls()??t[0],o=t.length>1,r=document.createElement("div");r.id=_v,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${_.pill};color:${n.bone};font-family:${b.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${b.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Uo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Uo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${b.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Uo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",h=>{h.stopPropagation(),e=l,Md(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}ye=r,_s(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{hs=!1,Wd=Date.now()}}},Gd=()=>{ye?_s():jd(),Ud===void 0&&(Ud=window.setInterval(()=>{ye?_s():Date.now()-Wd>=yv&&jd()},1500))};var fv="#12161D",xv="#EDEEF0",Kd=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},Vd=t=>{t.style.setProperty("background-color",fv,"important"),t.style.setProperty("color",xv,"important")},wv=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},kv=t=>{Kd(t)&&Vd(t);for(let e of Array.from(t.querySelectorAll("*")))Kd(e)&&Vd(e)},vs=null,Wo=null,Jd=()=>{Wo&&(Wo.disconnect(),Wo=null),vs=null},Ev=t=>{if(vs===t)return;Jd(),vs=t;let e=!1,o=()=>{e=!1;try{kv(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Wo=new MutationObserver(r),Wo.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},Yd=!1,on=()=>{if(Yd)return;Yd=!0;let t=()=>{let o=wv();o?Ev(o):Jd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var $v="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Tv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Cv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Xd="tc_closing_agent",Lv="tc_closing_office",$t="ws-crm-closing-agent-picker-button",tc="ws-crm-closing-agent-picker-modal",Sv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Av=/\/v2\/location\/([A-Za-z0-9]+)/,Vo=()=>{let t=window.location.pathname,e=t.match(Sv);if(!e)return null;let o=t.match(Av);return{oppId:e[1],locationId:o?o[1]:null}},ks=async t=>{let e=await fetch($v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Qd=async t=>{let e=await fetch(Tv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Iv=async(t,e)=>{try{let o=await fetch(Cv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Xd}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await ks({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ge=null,Mv=60*60*1e3,Es=t=>`ws-crm-to-cache:${t}`,ec=t=>{try{let e=window.localStorage.getItem(Es(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Mv||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},oc=(t,e,o)=>{try{window.localStorage.setItem(Es(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Pv=t=>{try{window.localStorage.removeItem(Es(t))}catch{}},gs="ws-crm-closing-agent-field-link",Ov=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${gs}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},ys=!1,$s=async t=>{if(ys)return;let e=rc();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){ys=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await ks({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),fs(a.id,a.name,t);let s=document.getElementById($t);if(s){ee(s,{status:"linked",contactName:a.name});let i=Vo();i&&oc(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{ys=!1}}},Bv=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,rc=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();Bv.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let h=l.getAttribute(m);h&&/Title\s+Officer/i.test(h)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:h})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},fs=(t,e,o)=>{let r=rc();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${gs}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=gs,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},rn=()=>{document.getElementById(tc)?.remove()},Rv=t=>{rn();let e=document.createElement("div");e.id=tc,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&rn()}),s?.addEventListener("click",rn);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await ks({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",m.results.forEach(h=>{let v=document.createElement("button");v.type="button",v.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,v.innerHTML=`
          <div style="font-weight: 500;">${nn(h.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${nn(h.email||"(no email)")} \xB7 ${nn(h.phone||"no phone")}
            ${h.companyName?` \xB7 ${nn(h.companyName)}`:""}
          </div>
        `,v.addEventListener("mouseenter",()=>{v.style.background=n.slate}),v.addEventListener("mouseleave",()=>{v.style.background="transparent"}),v.addEventListener("click",()=>{rn(),t.onPick(h)}),a.appendChild(v)})}catch(m){p.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{l(c)},250)})},nn=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ee=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",s=n.amber,i=n.bone,d="transparent",l=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",s=n.coolGray,i=n.ash,c="wait";break;case"empty":a="Link Closing Agent",s=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=n.emerald,d=n.emeraldGlow,l=n.emeraldBorder,i=n.emeraldBright;break;case"saving":a="Linking\u2026",s=n.coolGray,i=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),t.style.background=d,t.style.borderColor=l,t.style.color=i,t.style.cursor=c},Hv=(t,e)=>{let o=document.createElement("button");o.id=$t,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};ee(o,r);let a=ec(t);return a&&(r={status:"linked",contactName:a.contactName},ee(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await Iv(t,e);i?(r={status:"linked",contactName:i.name},ee(o,r),ge={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},fs(i.id,i.name,e)):a||(r={status:"empty"},ee(o,r),ge?.oppId===t&&(ge=null),Ov(),Pv(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rv({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},ee(o,r);try{let d=await Qd({tenantId:e,oppId:t,fieldKey:Xd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await Qd({tenantId:e,oppId:t,fieldKey:Lv,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},ee(o,r),ge={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},oc(t,i.id,i.name),fs(i.id,i.name,e),zl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},ee(o,r)}}})}),o},Dv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Fv=async()=>{for(let t of Dv)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Go=!1,sn=async()=>{if(!Go){Go=!0;try{await zv()}finally{Go=!1}}},zv=async()=>{let t=Vo();if(!t||!t.locationId){document.getElementById($t)?.remove(),document.getElementById(`${$t}-wrap`)?.remove(),an();return}let e=document.getElementById($t);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${$t}-wrap`)?.remove(),an());return}e&&(e.remove(),document.getElementById(`${$t}-wrap`)?.remove());let o=F();if(o!==null&&o!=="Transaction Coordination")return;let r=await Fv();if(!r||!(ec(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await X()!=="Transaction Coordination")return;let s=Vo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=Hv(t.oppId,s.locationId),d=document.createElement("span");d.id=`${$t}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Y(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Nv(t.oppId),$s(s.locationId)},Ko=null,xs=null,ws=null,an=()=>{Ko?.disconnect(),Ko=null,xs=null,ws=null},Nv=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ko&&xs===t&&ws===e||(an(),xs=t,ws=e,Ko=new MutationObserver(()=>{let o=Vo();if(!o||o.oppId!==t||!o.locationId){an();return}document.getElementById($t)||sn(),$s(o.locationId)}),Ko.observe(e,{childList:!0,subtree:!0})))},qv=()=>{V("closing-agent-picker",Z,()=>{!document.getElementById($t)&&!Go&&sn()})},Zd,Uv=()=>{Zd===void 0&&(Zd=window.setInterval(()=>{let t=Vo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById($t)&&!Go&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),sn()),$s(t.locationId)},2e3))},nc=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),qv(),Uv(),sn()};var jv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Nt="ws-crm-manage-team-cta",sc="ws-crm-manage-team-modal",Wv=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,ic={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},Gv={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},lc=()=>{let t=window.location.pathname.match(Wv);return t?{tenantId:t[1]}:null},dn=async t=>{let e=await fetch(jv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},gt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),oe=t=>gt(t),Ts="ws-crm-manage-team-toast",Ss=(t,e="info",o=4e3)=>{document.getElementById(Ts)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Ts,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Ts)===a&&a.remove()},o)},Cs=()=>{document.getElementById(sc)?.remove()},Kv=(t,e)=>{let o=Gv[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${gt(e)}</span>
  `},Vv=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>Kv(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
    <div data-user-id="${oe(t.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${gt(t.email)}${t.phone?` &middot; ${gt(t.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${s}>
        <button class="ws-team-edit" data-email="${oe(t.email)}" data-user-id="${oe(t.id)}" data-name="${oe(o)}" data-current-roles="${oe(t.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${oe(t.email)}" data-name="${oe(o)}" data-role-count="${oe(String(t.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Yv=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Vv(r,e)).join(""),cn=async t=>{Cs();let e=document.createElement("div");e.id=sc,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${b.sans};
  `,e.addEventListener("click",l=>{l.target===e&&Cs()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.innerHTML=`
    ...
    <div id="ws-team-actions" style="display: flex; gap: 8px; justify-content: flex-end; padding-top: 16px; border-top: 1px solid ${n.steel};">
      <button id="ws-team-add" style="background: ${n.emerald}; color: ${n.obsidian}; border: none; border-radius: ${_.sm}; padding: 10px 18px; font-family: ${b.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">+ Add Employee</button>
    </div>
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Cs);let r;try{r=await dn({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          Failed to load roster: ${gt(l.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let l=o.querySelector("#ws-team-content");l&&(l.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          ${gt(r.error||"Unknown error loading roster")}
        </div>
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+Yv(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Jv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Qv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Zv(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},Jv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,s.innerHTML=`
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
      ...
      <button id="ws-team-add-submit" style="background: ${n.emerald}; color: ${n.obsidian}; border: none; border-radius: ${_.sm}; padding: 8px 18px; font-family: ${b.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Add Employee</button>
    </div>
  `,o.appendChild(s),document.body.appendChild(o),s.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),s.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let i=(s.querySelector("#ws-team-add-first")?.value||"").trim(),d=(s.querySelector("#ws-team-add-last")?.value||"").trim(),l=(s.querySelector("#ws-team-add-email")?.value||"").trim(),c=(s.querySelector("#ws-team-add-mobile")?.value||"").trim(),m=(s.querySelector("#ws-team-add-role")?.value||"").trim(),h=s.querySelector("#ws-team-add-error"),v=s.querySelector("#ws-team-add-submit");if(!i||!d||!l||!c||!m){h&&(h.textContent="All fields are required.");return}v&&(v.disabled=!0,v.textContent="Adding\u2026",v.style.opacity="0.7"),h&&(h.textContent="");try{let u=await dn({tenant_id:t,action:"add",first_name:i,last_name:d,email:l,mobile:c,role:m,triggered_by_user_id:B()});if(!u.ok){h&&(h.textContent=u.error||"Failed to add employee"),v&&(v.disabled=!1,v.textContent="Add Employee",v.style.opacity="1");return}o.remove(),Ss(`Added ${i} ${d} as ${ic[m]||m}.`,"success"),await cn(t)}catch(u){h&&(h.textContent=u.message),v&&(v.disabled=!1,v.textContent="Add Employee",v.style.opacity="1")}})},Qv=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        <input type="checkbox" data-role-key="${i}" ${d} style="cursor: pointer;" />
        <span style="font-size: 13px;">${gt(ic[i])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${gt(e.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${gt(e.email)}</div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      ...
      <button id="ws-team-edit-submit" style="background: ${n.emerald}; color: ${n.obsidian}; border: none; border-radius: ${_.sm}; padding: 8px 18px; font-family: ${b.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Save Roles</button>
    </div>
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-edit-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-edit-submit")?.addEventListener("click",async()=>{let i=Array.from(a.querySelectorAll('input[type="checkbox"]')).filter(c=>c.checked).map(c=>c.dataset.roleKey||"").filter(Boolean),d=a.querySelector("#ws-team-edit-error"),l=a.querySelector("#ws-team-edit-submit");if(i.length===0){d&&(d.textContent="Select at least one role. To fully offboard, use Remove instead.");return}l&&(l.disabled=!0,l.textContent="Saving\u2026",l.style.opacity="0.7"),d&&(d.textContent="");try{let c=await dn({tenant_id:t,action:"update",email:e.email,roles:i,triggered_by_user_id:B()});if(!c.ok){d&&(d.textContent=c.error||"Failed to update roles"),l&&(l.disabled=!1,l.textContent="Save Roles",l.style.opacity="1");return}r.remove(),Ss(`Updated roles for ${e.name}.`,"success"),await cn(t)}catch(c){d&&(d.textContent=c.message),l&&(l.disabled=!1,l.textContent="Save Roles",l.style.opacity="1")}})},Zv=(t,e)=>{let o="ws-crm-manage-team-remove-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${gt(e.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${gt(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      ...
      <button id="ws-team-remove-submit" style="background: ${n.crimson}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 18px; font-family: ${b.sans}; font-size: 13px; font-weight: 600; cursor: pointer;">Remove from Team</button>
    </div>
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=a.querySelector("#ws-team-remove-error"),i=a.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let d=await dn({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:B()});if(!d.ok){s&&(s.textContent=d.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),Ss(`Removed ${e.name} from the team.`,"success"),await cn(t)}catch(d){s&&(s.textContent=d.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},Xv=89,ty=93,ey=310,oy=34,ry=14,ny=14,ay=3,ln=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+Xv;t.style.right=`${Math.max(r,16)}px`},sy=t=>{let e=document.createElement("button");return e.id=Nt,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${ty}px;
    right: 24px;
    width: ${ey}px;
  ...
  `,e.addEventListener("click",()=>{cn(t)}),ln(e),setTimeout(()=>ln(e),200),setTimeout(()=>ln(e),800),iy(),e},ac=!1,iy=()=>{ac||(ac=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Nt);t instanceof HTMLButtonElement&&ln(t)}))},Ls=!1,ly=()=>{if(!Ls){Ls=!0;try{let t=lc();if(!t){document.getElementById(Nt)?.remove(),document.getElementById(`${Nt}-floater`)?.remove();return}let e=document.getElementById(Nt);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Nt}-floater`)?.remove();let o=document.createElement("div");o.id=`${Nt}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=sy(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Ls=!1}}},dc=()=>{if(!lc()){document.getElementById(Nt)?.remove(),document.getElementById(`${Nt}-floater`)?.remove();return}ly()};var dy="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ms="ws-crm-prepare-contract-button",cc="ws-crm-prepare-contract-menu",Ot="ws-crm-prepare-contract-modal",pc="ws-crm-modal-date-style",qt="https://services.leadconnectorhq.com",vc=()=>{if(document.getElementById(pc))return;let t=document.createElement("style");t.id=pc,t.textContent=`
    #${Ot} input[type="date"] { color-scheme: dark; }
    #${Ot} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(t)},Ps="__WS_CRM_CAPTURED_AUTH",cy=50*60*1e3,Zo=()=>{try{let t=localStorage.getItem(Ps);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>cy?(localStorage.removeItem(Ps),null):e:null}catch{return null}},py=t=>{try{localStorage.setItem(Ps,JSON.stringify(t))}catch{}},Ve=()=>{let t=Zo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},mc=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Zo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ke=async(t,e={},o=2)=>{let r=Zo()?.capturedAt??0,a;try{a={...Ve(),...e.headers??{}}}catch(i){if(o>0&&await mc(r,4e3))return Ke(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await mc(r,4e3)?Ke(t,e,o-1):s},bc=!1,my=()=>{if(bc)return;bc=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=Zo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let h=c.authorization||c.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let v=c["token-id"]||c["Token-Id"]||void 0,u=Zo()?.authorization;py({authorization:h,tokenId:v,capturedAt:Date.now()}),u!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let h=m.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let v={};if(h instanceof Headers)h.forEach((u,g)=>v[g.toLowerCase()]=u);else if(Array.isArray(h))h.forEach(([u,g])=>v[u.toLowerCase()]=g);else if(h&&typeof h=="object")for(let u of Object.keys(h))v[u.toLowerCase()]=h[u];o(c,v,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},yc=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},by=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:yc()},uy=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},gc="__WS_CRM_TEMPLATES_CACHE_V1",hy=24*60*60*1e3,uc=t=>{try{let e=window.localStorage.getItem(gc);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>hy?null:o.templates}catch{return null}},_y=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(gc,JSON.stringify(o))}catch{}},vy=async t=>{let e=`${qt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ke(e,{method:"GET"})}catch(i){let d=uc(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=uc(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:uy(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&_y(t,s),s},yy=async(t,e)=>{let o=await Ke(`${qt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Ke(`${qt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},gy=async(t,e)=>{let o=await Ke(`${qt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${qt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ve()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},fy=async t=>{let e=await fetch(dy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},xy=async(t,e,o)=>{let r=`${qt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ve()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},wy=async(t,e)=>{let o=await fetch(`${qt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ve()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},fc=async t=>{let e=await fetch(`${qt}/contacts/${t}`,{method:"GET",headers:Ve()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},ky=async(t,e,o,r)=>{let a;try{a=await wy(t,e)}catch(u){return{ok:!1,body:`fetchProposalDocument: ${u.message}`}}let s;try{s=await fc(o)}catch(u){return{ok:!1,body:`fetchContactBasics: ${u.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(u=>u?.entityName!=="contacts"),d],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},v=await fetch(`${qt}/proposals/document/${e}`,{method:"PUT",headers:{...Ve(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!v.ok){let u=await v.text().catch(()=>"");return{ok:!1,status:v.status,body:u}}return{ok:!0}},Ey=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},mn="__WS_CRM_PENDING_INSTRUCTIONS",$y=60*1e3,Ty=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Cy=t=>{let e=(t||"").toLowerCase();for(let o of Ty)if(e.includes(o.matches.toLowerCase()))return o;return null},Ly=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(mn,JSON.stringify(r))}catch{}},Sy=()=>{try{let t=localStorage.getItem(mn);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>$y?(localStorage.removeItem(mn),null):e}catch{return null}},Ay=()=>{try{localStorage.removeItem(mn)}catch{}},Iy=(t,e)=>{document.getElementById(Ot)?.remove();let o=document.createElement("div");o.id=Ot,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},My=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Py=()=>{let t=window.location.pathname.match(My);if(!t)return;let e=t[1],o=Sy();o&&o.proposalId===e&&(Ay(),window.setTimeout(()=>{Iy(o.title,o.bodyHtml)},600))},hc="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(hc)?.remove();let r=document.createElement("div");r.id=hc;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},_c=(t,e)=>new Promise(o=>{document.getElementById(Ot)?.remove();let r=document.createElement("div");r.id=Ot,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let s=l=>{if(!l)return"";try{return new Date(l).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return l}},i=t.map(l=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${Pt(l.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${n.slate};
    ...
    `,r.appendChild(a),document.body.appendChild(r);let d=l=>{r.remove(),o(l)};r.addEventListener("click",l=>{l.target===r&&d(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>d(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.borderColor=n.emerald,l.style.background=n.graphite}),l.addEventListener("mouseleave",()=>{l.style.borderColor=n.steel,l.style.background=n.slate}),l.addEventListener("click",c=>{c.stopPropagation(),c.preventDefault();let m=l.dataset.oppId||"";m&&d(m)})})}),Oy=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(Ot)?.remove(),vc();let a=r.debug||{},s=typeof a.propertyAddress=="string"?a.propertyAddress:"",i=typeof a.sellerName=="string"?a.sellerName:"",d=typeof a.purchasePrice=="number"?a.purchasePrice:0,l=typeof a.emd=="number"?a.emd:0,c=typeof a.cashAtClose=="number"?a.cashAtClose:d-l,m=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),h=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),v=typeof a.additionalTerms=="string"?a.additionalTerms:"",u=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",g=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",w=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],k=document.createElement("div");k.id=Ot,k.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,S=`
    ...
    padding-right: 28px;
  `,H=et=>['<option value="">(unset)</option>'].concat(w.map(st=>`<option value="${Pt(st)}"${st===et?" selected":""}>${bt(st)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${b.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${x}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${Pt(i)}" placeholder="Seller name" style="${$}" />
      </div>
      <div style="${x}">
      ...
      <div style="${x}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${Pt(m)}" placeholder="e.g. 30" style="${$}" />
      </div>
      <div style="${x}">
        <div style="${f}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${Pt(h)}" placeholder="e.g. 10" style="${$}" />
      </div>
      <div style="${x}">
        <div style="${f}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${S}">${H(u)}</select>
      </div>
      <div style="${x}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${S}">${H(g)}</select>
      </div>
      <div style="${x} align-items: flex-start;">
        <div style="${f}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${$} resize: vertical; min-height: 60px; font-family: ${b.sans};">${bt(v)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,k.appendChild(y),document.body.appendChild(k);let j=y.querySelector("#ws-pc-purchase-price"),U=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),N=!1;W?.addEventListener("input",()=>{N=!0});let jt=()=>{if(N)return;let et=Number(j?.value||0),st=Number(U?.value||0);W&&(W.value=String(Math.max(0,et-st)))};j?.addEventListener("input",jt),U?.addEventListener("input",jt);let Wt=()=>k.remove();k.addEventListener("click",et=>{et.target===k&&Wt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Wt);let pt=y.querySelector("#ws-pc-submit"),ut=y.querySelector("#ws-pc-error");pt?.addEventListener("click",async()=>{if(pt){ut&&(ut.textContent=""),pt.disabled=!0,pt.textContent="Opening\u2026";try{let et=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(j?.value||0),oo=Number(U?.value||0),ro=Number(W?.value||0),no=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),ao=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),so=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),we=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),io=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),it={};if(et!==i&&(it.sellerName=et),st!==d&&(it.purchasePrice=st),oo!==l&&(it.emd=oo),ro!==c&&(it.cashAtClose=ro),no!==m&&(it.daysToClose=no),ao!==h&&(it.inspectionDays=ao),so!==v&&(it.additionalTerms=so),we!==u&&(it.currentOccupancy=we),io!==g&&(it.occupancyAtClose=io),Object.keys(it).length>0){p.info("[prepare-contract] PA modal submit with overrides:",it),pt.textContent="Saving\u2026";let Tn=B(),Cn=await bn({tenantId:t,contactId:e,template:o,userId:Tn,overrides:it});p.info("[prepare-contract] re-stage with overrides ok:",Cn),pt.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let lt=s?`${s} - Purchase Agreement`:void 0;await Rs(t,e,o,lt)}catch(et){pt.disabled=!1,pt.textContent="Open Contract",ut&&(ut.textContent=et.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",et)}}})},By=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Ot)?.remove(),vc();let l=a.debug||{},c=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",h=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,v=typeof l.buyerEMD=="number"?l.buyerEMD:0,u=typeof l.assignmentFee=="number"?l.assignmentFee:0,g=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,w=typeof l.closingOffice=="string"?l.closingOffice:"",k=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,f=d,$="",C=document.createElement("div");C.id=Ot,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;T.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${j}">
        ...
        <div style="${H}">${bt(c||"(set on Property record)")}</div>
      </div>
      <div style="${j}">
        <div style="${x}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Pt(m)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${j}">
        <div style="${x}">Buyer LLC <span style="color: ${n.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${b.sans};">(assignee)</span></div>
        <input id="ws-pc-buyer-llc" type="text" value="${Pt(k)}" placeholder="Buyer's entity / LLC name" style="${E}" />
      </div>
      <div style="${j}">
        <div style="${x}">Assignment Price</div>
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
      ...
      <div style="${j}">
        <div style="${x}">Buyer Earnest Money</div>
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${v}" style="${S}" />
        </div>
      </div>
      <div style="${j}">
        <div style="${x}">Assignment Fee</div>
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
      ...
      <div style="${j}">
        <div style="${x}">Closing Office</div>
        <input id="ws-pc-closing-office" type="text" value="${Pt(w)}" placeholder="Title company" style="${E}" />
      </div>
      <div style="${j}">
        <div style="${x}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${Pt(y)}" style="${E}" />
      </div>
      <div style="${j}">
        <div style="${x}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${Pt(f)}" style="${E}" />
      </div>
      <div style="${j}">
        <div style="${x}">Lender Source <span style="color: ${n.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${b.sans};">(optional)</span></div>
  ...
  `,C.appendChild(T),document.body.appendChild(C);let W=T.querySelector("#ws-pc-assignment-price"),N=T.querySelector("#ws-pc-assignment-fee"),jt=!1;N?.addEventListener("input",()=>{jt=!0});let Wt=()=>{if(jt)return;let st=Number(W?.value||0);N&&(N.value=String(Math.max(0,st-g)))};W?.addEventListener("input",Wt);let pt=()=>C.remove();C.addEventListener("click",st=>{st.target===C&&pt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",pt);let ut=T.querySelector("#ws-pc-submit"),et=T.querySelector("#ws-pc-error");ut?.addEventListener("click",async()=>{if(!ut)return;et&&(et.textContent="");let st=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),oo=Number(W?.value||0),ro=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),no=Number(N?.value||0),ao=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),so=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),we=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),io=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),it=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!we){et&&(et.textContent="Closing Date is required.");return}ut.disabled=!0,ut.textContent="Opening\u2026";try{let lt={};st!==m&&(lt.sellerName=st),oo!==h&&(lt.assignmentPrice=oo),ro!==v&&(lt.buyerEMD=ro),no!==u&&(lt.assignmentFee=no),ao!==w&&(lt.closingOffice=ao),so!==k&&(lt.buyerCompanyName=so);let Tn=we!==y||io!==f||it!==$,Cn=Object.keys(lt).length>0||Tn,Ln=a;Cn?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",lt),ut.textContent="Saving\u2026",Ln=await bn({tenantId:t,contactId:e,template:o,oppId:r,closingDate:we,buyerEarnestDueDate:io,lenderSource:it,userId:s,overrides:Object.keys(lt).length>0?lt:void 0}),p.info("[prepare-contract] AA re-stage ok:",Ln),ut.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Js=Ln?.debug?.propertyAddress||c,kp=Js?`${Js} - Assignment Agreement`:void 0;await Rs(t,e,o,kp),pt()}catch(lt){ut.disabled=!1,ut.textContent="Open Contract",et&&(et.textContent=lt.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",lt)}})},bn=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await fy({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Rs=async(t,e,o,r)=>{let a=null;try{a=(await fc(e)).email||""}catch(l){p.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){nt("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),p.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await xy(t,o.id,e);p.info(`[prepare-contract] proposal created: ${s}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await ky(t,s,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${s}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),nt(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Cy(o.name);d&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Ly(s,d.title,d.bodyHtml)),Ey(t,s)},Ry=async t=>{let e=by(t);if(!e){nt("Could not resolve contact context.","error");return}document.getElementById(cc)?.remove();let o=document.createElement("div");o.id=cc,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await vy(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=B();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await gy(e.tenantId,e.contactId)}catch(f){nt(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await _c(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}m=f,p.info(`[prepare-contract] picked MT opp ${m}`)}}let h=y=>{let f=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${$}-${C}`},v=y=>{let f=new Date;return f.setDate(f.getDate()+y),h(f)},u=v(45),g=v(7);nt("Reading contract data\u2026","info",2500);let w;try{w=await bn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:u,buyerEarnestDueDate:g,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||w.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}By({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:w,userId:c,defaultClosingDate:u,defaultEMDDueDate:g})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await yy(e.tenantId,e.contactId)}catch(u){nt(`Failed to load ACQ opps: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",u);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(m.length===1)h=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let u=await _c(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!u){p.info("[prepare-contract] ACQ opp picker cancelled");return}h=u,p.info(`[prepare-contract] picked ACQ opp ${h}`)}nt("Reading contract data\u2026","info",2500);let v;try{v=await bn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:h,userId:c})}catch(u){nt(`Failed to prepare contract: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",u);return}Oy({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:v})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await Rs(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},xc=()=>{let t=document.createElement("button");return t.id=Ms,t.type="button",t.style.cssText=`${O} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Ry(t)}),t},Hy="ws-crm-contact-actions-bar",Dy=async()=>{let t=yc();if(!t){document.getElementById(Ms)?.remove();return}let e=null;try{e=await A(`#${Hy}`,{timeoutMs:se+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Ms);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=xc();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},fe="ws-crm-prepare-contract-button-opp",Yo=`${fe}-wrap`,Fy=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zy=/\/v2\/location\/([A-Za-z0-9]+)/,Ny=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Os=()=>{let t=window.location.pathname,e=t.match(Fy);if(!e)return null;let o=t.match(zy);return o?{oppId:e[1],tenantId:o[1]}:null},qy=async()=>{for(let t of Ny)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},pn=!1,Jo=null,Bs=null,As=null,Is,Qo=()=>{Jo?.disconnect(),Jo=null,Bs=null},Uy=t=>{if(Jo&&Bs===t)return;Qo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Bs=t,Jo=new MutationObserver(()=>{let o=Os();if(!o||o.oppId!==t){Qo();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(fe)?.remove(),document.getElementById(Yo)?.remove(),Qo();return}document.getElementById(fe)||wc()}),Jo.observe(e,{childList:!0,subtree:!0}))},jy=()=>{As||(As=new MutationObserver(()=>{Is===void 0&&(Is=window.setTimeout(()=>{Is=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);t&&!e&&!pn&&wc()},300))}),As.observe(document.body,{childList:!0,subtree:!0}))},wc=async()=>{if(!pn){pn=!0;try{let t=Os();if(!t){document.getElementById(fe)?.remove(),document.getElementById(Yo)?.remove(),Qo();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(Yo)?.remove(),Qo());return}e&&(e.remove(),document.getElementById(Yo)?.remove());let o=await qy();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Os();if(!a||a.oppId!==t.oppId)return;let s=xc();s.id=fe,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=Yo,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Uy(t.oppId)}finally{pn=!1}}},kc=()=>{Py(),Dy()};my();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Pt(t){return bt(t)}var Wy="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",xe="ws-crm-compute-offer-button",Fs="ws-crm-compute-offer-popover",Ic="ws-crm-offer-modal",Ec="ws-crm-contact-actions-bar",Gy=[".central-panel","[class*='central-panel']"],re=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",Hs=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},Ky=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],$c=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${Ky[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Tc=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;outline:none;`,Ds=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(Wy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Ye=()=>{document.getElementById(Fs)?.remove(),document.removeEventListener("mousedown",Mc,!0)};function Mc(t){let e=document.getElementById(Fs),o=document.getElementById(xe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Ye()}var Pc=(t,e)=>{Ye();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Fs;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${_.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${b.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Mc,!0),0)},un=(t,e)=>{Pc(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},Vy=(t,e,o)=>{Pc(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{Ye(),o(a.property_record_id)}),r.appendChild(s)})})},_n=()=>{document.getElementById(Ic)?.remove(),document.removeEventListener("keydown",Oc,!0)};function Oc(t){t.key==="Escape"&&_n()}var Cc=(t,e,o)=>{_n(),Ye();let r=o,a=!1,s="",i=document.createElement("div");i.id=Ic,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${b.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&_n()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,h,v)=>{a||(a=!0,s="",c(),Ds({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:h,repairOverride:v}).then(u=>{u&&u.ok?r={...u,current_offer:u.current_offer??r.current_offer,current_offer_date:u.current_offer_date??r.current_offer_date}:s=u&&u.error||"Request failed."}).catch(u=>{p.error("[compute-offer] worksheet request failed:",u),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,h=!!m.has_comps;d.innerHTML="";let v=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),u=q("div","");u.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),u.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let g=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");g.type="button",g.addEventListener("click",_n),v.append(u,g),d.appendChild(v);let w=q("div","padding:14px 18px 18px;");d.appendChild(w);let k=q("select",Tc());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",Tc());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let f=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");f.appendChild(q("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${$c(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${_.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${b.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),f.append($),w.appendChild(f),m.low_confidence&&h&&w.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let C=m.current_offer!=null;w.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${_.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${re(m.current_offer)}${m.current_offer_date?` \xB7 ${$c(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),x=q("div","");x.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),x.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(x,E),w.appendChild(T);let S=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),H=(U,W,N)=>{let jt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),Wt=q("div","");Wt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&Wt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);jt.append(Wt,pt),S.appendChild(jt)};if(h&&m.imv!=null){H("Investor Market Value (IMV)",re(m.imv)),m.arv!=null&&H("After Repair Value (ARV)",re(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?H(`Repairs (${N})`,"Included",{color:n.ash,sub:`${re(m.repair_total)} in repairs included at IMV`}):H(`Repairs (${N})`,Hs(W),{color:W<0?n.crimson:n.emerald,sub:`${re(m.repair_total)} total, ${re(m.baseline_repairs)} included at IMV`}),H("Min. Profit Target",Hs(-(m.profit_target??0)),{color:n.ash}),H("Maximum Cash Offer (MAO)",re(m.mao),{strong:!0,color:n.blue}),H("Target Profit",Hs(-(m.ico_delta??0)),{color:n.ash}),H("Initial Cash Offer (ICO)",re(m.ico),{strong:!0,color:n.blue})}else S.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));w.appendChild(S);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(h?"Saved to the Property.":""),w.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",Oc,!0)},Lc=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=xe,o.dataset.contactId=t,o.style.cssText=`
    display:inline-flex;align-items:center;gap:8px;padding:6px 12px;
    background:transparent;color:${n.bone};border:1px solid ${n.steel};
    border-radius:${_.sm};font-family:${b.sans};font-size:12px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){Vy(o,i.properties,d=>{a(!0),Ds({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Cc(e,l.property_record_id,l):un(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),un(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Cc(e,i.property_record_id,i):un(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await Ds({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),un(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Yy=async()=>{for(let t of Gy)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Sc=async(t,e)=>{let o=e.querySelector(`#${Ec}`);if(!o)try{o=await A(`#${Ec}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Ac=()=>{let t=document.querySelectorAll(`#${xe}`);for(let e=1;e<t.length;e++)t[e].remove()},Jy=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(xe)?.remove(),Ye();return}let e=t.locationId,o=document.getElementById(xe);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Ye();let r="seller";try{r=Lt(await Ct(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(xe)?.remove();return}let a=await Yy();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Lc(t.contactId,e);if(!await Sc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}Ac(),p.debug(`[compute-offer] mounted for ${t.contactId}`),hn?.disconnect(),hn=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){hn?.disconnect();return}if(!document.getElementById(xe)){let d=Lc(t.contactId,e);Sc(d,a).then(()=>Ac())}}),hn.observe(a,{childList:!0})},hn=null,Xo=null,Bc=()=>{let t=D()?.contactId??null;if(Xo&&Xo.id===t)return;let e=Jy().finally(()=>{Xo?.promise===e&&(Xo=null)});Xo={id:t,promise:e}};var wn="reos-theme-stylesheet",ep="reos-theme-fonts",Xe=!1,Qy=()=>{let t=document.getElementById(ep);t&&t.remove()},Zy=`
...
`,Xy=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],tg=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${s})`}return`rgb(${o}, ${r}, ${a})`},eg=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),og=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],vn=new WeakSet,Rc=t=>{try{if(!document.body)return;(t??document.body.querySelectorAll("*")).forEach(o=>{try{if(o.classList&&(o.classList.contains("hr-drawer-container")||o.classList.contains("hr-detached-container"))){(o.getAttribute("style")||"").includes("background")&&(o.style.removeProperty("background-color"),o.style.removeProperty("background-image"));return}if(vn.has(o)&&o.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest(".hl_header, header.hl_header, header.app-header")||o.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let r=o.tagName;if(r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||r==="SCRIPT"||r==="STYLE"||r==="SVG"||r==="PATH"||r==="IMG")return;let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||d<230||l<230||c<230)return;let h=o.style.getPropertyValue("background-color");if(h==="rgb(18, 22, 29)"){vn.add(o);return}if(o.closest(".hr-button")&&!(o.classList&&o.classList.contains("hr-button"))){h!=="transparent"&&(o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important")),vn.add(o);return}o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"),vn.add(o)}catch{}})}catch{}},zs=new WeakSet,Je=()=>{document.querySelectorAll(og.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(r.classList&&(r.classList.contains("hr-drawer-container")||r.classList.contains("hr-detached-container"))){(r.getAttribute("style")||"").includes("background")&&(r.style.removeProperty("background-color"),r.style.removeProperty("background-image"));return}if(zs.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH"||r.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if(!(d<230||l<230||c<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),zs.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),zs.add(r)}})})},Hc=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},Dc=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},Fc=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},yn=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let d=+i[1],l=+i[2],c=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&d>=180&&l>=180&&c>=180&&d+l+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},zc=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Qe=()=>{if(!Xe)for(let t of Xy){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let s=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),d=eg.has(r)?tg(a):a;s==="important"&&i===d||o.style.setProperty(r,a,"important")}})}},kn="#1A1F28",rg=26,ng=31,ag=40,Nc=new Set,qc=new Set,gn=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let a=o.getBoundingClientRect();if(a.width===0||a.height===0||a.width>800)return;o.style.setProperty("display","none","important");let s=o.className?.toString()||"<no class>";!qc.has(s)&&s!=="<no class>"&&(qc.add(s),p.debug(`Hid empty "--" leaf: "${s}"`))})},sg=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],ig=["trash","Trash","TRASH","delete","Delete","DELETE"],lg=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(ig.some(s=>a.includes(s))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let d=i.getAttribute("d")||"";sg.some(l=>d.includes(l))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),d=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||d.includes("delete")||d.includes("remove")||d.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},dg=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),cg=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||dg.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Uc=new Set,jc=new WeakSet,pg=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(jc.has(o)&&o.style.getPropertyValue("color")==="rgb(237, 238, 240)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let r=(o.className?.toString()||"").toLowerCase();if(r.includes("ai-button")||r.includes("ask-ai")||r.includes("bg-clip-text")||r.includes("text-transparent")||o.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let a=o.tagName.toLowerCase();if(a==="svg"||a==="path"||a==="circle"||a==="rect"||a==="polygon"||a==="polyline"||a==="line"||a==="g")return;let s=!1;for(let v of Array.from(o.childNodes))if(v.nodeType===Node.TEXT_NODE&&(v.textContent||"").trim()){s=!0;break}if(!s)return;let i=Array.from(o.children);if(i.length>0&&i.every(v=>{let u=v.tagName.toLowerCase();return u==="svg"||u==="img"})&&!s)return;let c=window.getComputedStyle(o).color;if(!(c==="rgb(255, 255, 255)"||c==="rgba(255, 255, 255, 1)"||c==="#ffffff"||c==="white"))return;o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),jc.add(o);let h=o.className?.toString()||"<no class>";!Uc.has(h)&&h!=="<no class>"&&(Uc.add(h),p.debug(`Remapped pure-white text -> bone: "${h}"`))})},Wc=new Set,mg=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let d=window.getComputedStyle(s),l=d.backgroundColor,c=d.backgroundImage||"",m=!1;if(c!=="none"&&c.includes("gradient"))m=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let C=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(C&&parseFloat(C[1])<.6)return;let T=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(T){let x=parseInt(T[1],10),E=parseInt(T[2],10),S=parseInt(T[3],10);(x>=60||E>=60||S>=60)&&(x>230&&E>230&&S>230||(x>=80||E>=80||S>=80)&&(m=!0))}}if(!m)return;let v=(s.textContent||"").trim(),u=i,g=Array.from(s.querySelectorAll("*")).map(C=>(C.className?.toString()||"").toLowerCase()).join(" "),w=v.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),k=u.includes("bg-clip-text")||u.includes("text-transparent")||g.includes("bg-clip-text")||g.includes("text-transparent"),y=Array.from(s.querySelectorAll("*")).some(C=>{let T=window.getComputedStyle(C),x=T.getPropertyValue("-webkit-background-clip")||"",E=T.getPropertyValue("background-clip")||"";return x.includes("text")||E.includes("text")});if(w||k||y){let C=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],T=x=>{C.forEach(E=>x.style.removeProperty(E))};T(s),s.querySelectorAll("*").forEach(T);return}let f="#12161D";s.style.setProperty("color",f,"important"),s.querySelectorAll("*").forEach(C=>{let T=C.tagName.toLowerCase();T==="svg"||T==="path"||T==="circle"||T==="rect"||T==="polygon"||T==="polyline"||T==="line"||T==="g"?(C.style.setProperty("fill",f,"important"),C.style.setProperty("stroke",f,"important"),C.style.setProperty("color",f,"important")):(C.style.setProperty("color",f,"important"),C.style.setProperty("-webkit-text-fill-color",f,"important"))});let $=s.className?.toString()||"<no class>";!Wc.has($)&&$!=="<no class>"&&(Wc.add($),p.debug(`Darkened SVG icons on colored button: "${$}"`))})})},Gc=new Set,bg=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(l=>{(l.getAttribute("style")||"").includes("translateY(11px)")&&l.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(l=>{let c=l;if(c.closest("[id^='ws-crm-']"))return;let m=l.getBoundingClientRect();if(m.width===0||m.width>28||m.height>28)return;let h=m.left<r.right&&m.right>r.left,v=m.top<r.bottom&&m.bottom>r.top;if(!(h&&v)||m.top+m.height/2<a)return;let g=m.width*m.height/(r.width*r.height);if(g>.55)return;let w=c,k=c.parentElement,y=0;for(;k&&k!==e&&y<3;){let $=k.getBoundingClientRect();if($.width>0&&$.width<=30&&$.height<=30)w=k;else break;k=k.parentElement,y++}w.style.setProperty("transform","translateY(11px)","important");let f=(w.className?.toString()||"")+" "+w.tagName;Gc.has(f)||(Gc.add(f),p.debug(`Dropped activity badge 11px (${m.width.toFixed(0)}x${m.height.toFixed(0)} icon, ratio ${g.toFixed(2)}): "${f}"`))})})},ug="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",hg=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",ug,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Kc=new Set,_g=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d>200&&l>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!Kc.has(m)&&m!=="<no class>"&&(Kc.add(m),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${d},${l},${c})): "${m}"`))})})},Vc=new Set,vg=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let d=o.className?.toString()||"<no class>";!Vc.has(d)&&d!=="<no class>"&&(Vc.add(d),p.debug(`Painted Ask AI wrapper graphite: "${d}"`))}}o=o.parentElement,r++}})},Yc=new Set,yg=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let d=a.getBoundingClientRect();d.width<240||d.height<120||d.width>1500||d.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let d=(i.className?.toString()||"").toLowerCase();if(d.includes("avatar")||d.includes("notification-dot")||d.includes("indicator"))return;if(d.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("tabulator")||d.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(d.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("ai-button")||d.includes("ask-ai")||d.includes("bg-clip-text")||d.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let c=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let m=parseInt(c[1],10),h=parseInt(c[2],10),v=parseInt(c[3],10);if(!(m>200&&h>200&&v>200))return;let g=i.getBoundingClientRect();if(g.width<24||g.height<16||g.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let w=i.className?.toString()||"<no class>";!Yc.has(w)&&w!=="<no class>"&&(Yc.add(w),p.debug(`Coerced light bg (${g.width.toFixed(0)}x${g.height.toFixed(0)}, rgb(${m},${h},${v})): "${w}"`))})})},Jc=new Set,gg=t=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";(t??document.body.querySelectorAll("*")).forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']")||r.children.length>0)return;let a=(r.textContent||"").trim();if(a.length===0||a.length>80||a==="--"||r.closest(e)||r.closest("[class*='avatar'], [class*='hr-avatar']")||r.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||r.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(r.matches("[role='heading']")||r.closest("[role='heading']")||r.matches("h1, h2, h3")||r.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){r.matches("h1, h2, h3")&&(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let $=r.getAttribute("style")||"";($.includes("color")||$.includes("background"))&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"),r.style.removeProperty("background-color"));return}if(r.closest("#SettingTexasSmsBlock")||r.matches("p.ui-text-sm-medium")&&r.parentElement?.classList?.contains("flex")&&r.parentElement?.classList?.contains("items-center")&&r.parentElement?.children?.length===1){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-button, .n-button")||r.matches(".hr-button__content, .n-button__content")||r.closest(".hr-button__content, .n-button__content")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".bg-primary-50, [class*='bg-primary-50']")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}let s=r,i=null;for(let $=0;$<4&&s;$++){let C=s.nextElementSibling;if(C&&(C.matches(e)||C.querySelector(e)!==null)){i=C;break}s=s.parentElement}if(!i)return;let d=r.getBoundingClientRect();if(d.width===0||d.height===0||d.width>400||d.height>60)return;r.style.setProperty("color","#9098A3","important"),r.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,c=l.getBoundingClientRect(),m=l.className?.toString()||"",h=m.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,v=m.includes("hl-form-item")||m.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,u=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",g=(m.includes("hr-form-item-blank")||m.includes("hr-form-item")||l.matches(u))&&(l.matches(u)||l.querySelector(u)!==null);g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=m.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=m.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=m.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!v&&!g&&!w&&!k&&!y&&c.width>0&&c.width<=800&&c.height>0&&c.height<=100&&(l.style.setProperty("background-color",kn,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let f=r.className?.toString()||"<no class>";!Jc.has(f)&&f!=="<no class>"&&(Jc.add(f),p.debug(`Colored field label "${a.slice(0,30)}": "${f}"`))})},Qc=new Set,fg=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),d=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${d}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${d}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!Qc.has(l)&&l!=="<no class>"&&(Qc.add(l),p.debug(`Resized avatar text to ${d}px (circle ${i.toFixed(0)}px): "${l}"`))})},Zc=new Set,xg=new Set(["Enter Dashboard Name"]),wg=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(xg.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",kn,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",kn,"important"),a.style.setProperty("border-color","#252C36","important"));let s=e.className?.toString()||"<no class>";!Zc.has(s)&&s!=="<no class>"&&(Zc.add(s),p.debug(`Forced input slate bg: "${s}"`))})},fn=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.id==="chat-filter"||o.id==="phone-calls"||o.id==="archive-conversation"||o.id==="star-toggle"||o.id==="read-toggle"||o.id==="delete-conversation")return;if(o.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}let r=o.className?.toString()||"";if(r.includes("bg-inherit")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.closest(".pipeline-ribbon")&&r.split(" ").includes("count")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.split(" ").includes("tabulator-page")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(u=>r.includes(u))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("schedule-ui-form-weekly-schedule-checkbox")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("border-color")||u.includes("border-style")||u.includes("border-width"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"));return}if(r.includes("n-button")&&r.includes("icon-only")&&!r.includes("quaternary")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-button--tertiary-type")||r.includes("n-button--tertiary-type")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"),o.style.removeProperty("border-radius"));return}if(r.includes("hr-data-table-td")||r.includes("hr-data-table-tr")||r.includes("hr-data-table__body-cell")||r.includes("hr-data-table__cell")||r.includes("hr-data-table__header-cell")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-data-table-td--fixed-right")||r.includes("n-data-table-td--last-col")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.classList.contains("hr-tabs")||r.includes("hr-tabs-tab-wrapper")||r.includes("hr-tabs-nav")||r.includes("hr-tabs-nav-scroll-content")||r.includes("hr-tabs-content")||r.includes("hr-tabs-pane")||r.includes("hr-tabs-rail")||r.includes("hr-tabs-wrapper")||r.includes("hr-tabs-pane-wrapper")||r.includes("hr-tab-pane")){let u=o.getAttribute("style")||"";(u.includes("background-color: rgb(26, 31, 40)")||u.includes("background-color: #1A1F28")||u.includes("background-color: #1a1f28"))&&o.style.removeProperty("background-color");return}if(r.includes("hr-date-panel")||r.includes("n-date-panel")||o.closest(".hr-date-panel, .n-date-panel")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-tag")&&r.includes("ui-default")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if((r.includes("bg-purple-50")||r.includes("bg-purple-100"))&&(r.includes("rounded-lg")||r.includes("rounded-md")||r.includes("rounded-full"))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-alert")||o.closest(".n-alert")||r.includes("hl-warning")||r.includes("hl-error")||r.includes("hl-info")||r.includes("hl-success")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-card")||o.closest(".hr-card")||o.id&&o.id.startsWith("opportunity-")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("bg-gray-50")||r.includes("bg-gray-100")||r.includes("bg-gray-200")||r.includes("bg-white")||r.includes("bg-blue-50")||r.includes("bg-blue-100")||r.includes("bg-sky-50")||r.includes("bg-indigo-50")||r.includes("bg-slate-50")||r.includes("bg-neutral-50")||r.includes("bg-zinc-50")||r.includes("bg-stone-50")||r.includes("F7F9FD")||r.includes("F9FAFB")||r.includes("ECEEF2")||r.includes("eceef2")||r.includes("EFF4FF")||r.includes("eff4ff")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-collapse-item")||r.includes("hr-collapse hr-accordion")||r.includes("hr-accordion"))return;if(r.includes("sidebar-option-button")||o.closest(".sidebar-option-button")||o.closest("nav[class*='w-13']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d<rg&&l<ng&&c<ag))return;let h=o.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;o.style.setProperty("background-color",kn,"important");let v=o.className?.toString()||"<no class>";!Nc.has(v)&&v!=="<no class>"&&(Nc.add(v),p.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${d},${l},${c})): "${v}"`))})},xn=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1"),s.setAttribute("data-reos-recolored-v3","1");let d=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!d)return;let l;try{l=atob(d[1])}catch{return}let c=l,m=!1;if(e.forEach(u=>{c.includes(u)&&(c=c.split(u).join(t),m=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{c.includes(u)&&(c=c.split(u).join("transparent"),m=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(g=>{c.includes(g)&&(c=c.split(g).join("#EDEEF0"),m=!0)}),!!m)try{let u=btoa(c);s.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let d=`url("${i}")`;s.style.setProperty("-webkit-mask-image",d,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",d,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",o)})},tr=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},kg=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Ze=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let d=window.getComputedStyle(i).backgroundColor;d==="rgba(0, 0, 0, 0)"||d==="transparent"||!d||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let s="rgb(150, 162, 173)",i="rgb(0, 191, 124)",d=c=>{let m=r.querySelector(".ui-upload-icon svg");m&&(m.style.setProperty("color",c,"important"),m.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(h=>{h.style.setProperty("stroke",c,"important")})},l=!1;try{l=r.matches(":hover")}catch{}d(l?i:s),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>d(i)),r.addEventListener("mouseleave",()=>d(s)))})},Ns=new WeakSet,Eg=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Ns.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Ns.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${ir}`,t.title=`Built ${lr}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var dp=new Set(["ej0SqnTYIprechAMAPrd"]),to="contact-select-trigger",cp="ws-crm-reply-from-warning",pp="contact-select-menu",rp="ws-crm-rf-thread-opt",Gs="",Ks=!1,or=null,$n=null,np=!1,rr="",ap,ne=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Vs=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Bt=t=>(t||"").replace(/\D/g,"").slice(-10),sp=t=>{let e=Bt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Lg=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Sg=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await Hn(`${Bn}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return ne("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Ag=async()=>{let t=await Sg();if(!t)return null;let e=await Hn(`${Bn}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return ne("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Lg(a);if(Bt(s).length===10)return s}return null},eo=()=>document.getElementById(cp)?.remove(),mp=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Ig=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),bp=(t,e,o)=>{eo();let r=document.getElementById(to);if(!r)return;let a=mp(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=cp,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Ig(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${sp(t)}</span>${i}. You're set to reply from ${sp(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Mg=t=>{or?.disconnect();let e=document.getElementById(to);if(!e)return;let o=mp(e)||e,r=Bt(Vs(e));or=new MutationObserver(()=>{let a=Vs(document.getElementById(to)),s=Bt(a);!s||s===r||(r=s,s===Bt(t)?eo():bp(t,"",a))}),or.observe(o,{childList:!0,subtree:!0,characterData:!0})},ip=()=>{let t=document.getElementById(pp);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(rr&&(r=e.find(d=>Bt(o(d))===Bt(rr))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),ne("decorateMenu: cache=",rr,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(rp);s&&s!==r&&s.removeAttribute("id"),r.id=rp;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Pg=()=>{if(!dp.has(K()||""))return;$n?.disconnect();let t=0,e=()=>{let o=document.getElementById(pp);if(o){ip(),$n=new MutationObserver(()=>ip()),$n.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Og=t=>{let e=t.target;e&&e.closest&&e.closest("#"+to)&&(ne("From trigger clicked -> waiting for menu"),Pg())},Bg=async()=>{if(!Ks){Ks=!0;try{let t=document.getElementById(to);if(!t)return;let e=Vs(t),o=await Ag();if(rr=o||"",ne("check: from=",e,"thread=",o),!o){eo();return}Bt(e)&&Bt(e)!==Bt(o)?(ne("MISMATCH -> banner"),bp(o,"",e)):(ne("match -> no banner"),eo()),Mg(o)}finally{Ks=!1}}},lp=()=>{if(!dp.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){Gs="",rr="",or?.disconnect(),$n?.disconnect(),eo();return}let e=!!document.getElementById(to),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==Gs){if(Gs=r,!e){or?.disconnect(),eo();return}ne("composer expanded on",o),Bg()}},up=()=>{ap===void 0&&(ap=window.setInterval(lp,500)),np||(document.addEventListener("click",Og,!0),np=!0),lp()};var Rg="#1A1F28",Hg="#EDEEF0",Ys="#9098A3",Dg=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},Fg=t=>.2126*t.r+.7152*t.g+.0722*t.b,zg=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},hp=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},Ng=t=>{let e=Dg(getComputedStyle(t).backgroundColor);if(!e||Fg(e)<120)return;let o=zg(e);t.style.setProperty("background-color",Rg,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),hp(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Hg),hp(t,"#note-date-added-text, [class*='475467']",Ys)},qg=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",Ys,"important"),e.style.setProperty("-webkit-text-fill-color",Ys,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},_p=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)Ng(t[e]),qg(t[e])},vp,yp=()=>{vp===void 0&&(vp=window.setInterval(_p,700)),_p()};var Ug='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',gp=()=>{document.querySelectorAll(Ug).forEach(t=>{t.setAttribute("autocomplete","off")})},fp,xp=()=>{fp===void 0&&(fp=window.setInterval(gp,1e3)),gp()};console.log("[ws-crm-customizer] bundle-loaded");var L=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},wp=()=>{p.info(`Loaded v${ir} (built ${lr})`),Sn()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",er),L("mountDialerThemeFix",on)):(L("mountVersionBadge (initial)",En),L("mountFavicon",Zi),L("mountThemeStylesheet",er),L("mountHideLaunchpad",Pa),L("mountHideNavItems",Oa),L("mountRelabelNav",Ba),L("mountHideTopmenuTabs",Ha),L("mountContractsSection",Ra)),L("installOppIdCapture",ri),L("initPageRouter",Xs),p.info("[main] registering onPageChange subscriber"),_t(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),Sn()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",er),L("runThemeFastPass",Ws),L("mountDialerThemeFix",on),L("unmountContactMapLinks",Cl);return}L("mountThemeStylesheet",er),L("runThemeFastPass",Ws),L("mountVersionBadge",En),L("mountHideLaunchpad",Pa),L("mountHideNavItems",Oa),L("mountRelabelNav",Ba),L("mountHideTopmenuTabs",Ha),L("mountContractsSection",Ra),L("mountAnalyticsDashboard",_i),L("mountClaimReleaseToggle",Di),L("mountContactActionsBar",Ji),L("mountActiveFollowUpButton",ci),L("mountMtOfferMadeButton",ol),L("mountNotInterestedButton",rl),L("mountScheduleWalkthroughButton",nl),L("mountResendDealLinkButton",sl),L("mountAddReferralBuyer",pl),L("mountReducePriceButton",bl),L("mountEditLandingPageButton",ul),L("mountPublishButton",yl),L("mountContactMapLinks",Tl),L("mountSendToClosingOfficeButton",Nl),L("mountOppActionBar",rd),L("mountClosingAgentPickerButton",nc),L("mountPrepareContractButton",kc),L("mountComputeOfferButton",Bc),L("mountManageTeam",dc),L("mountBuyBoxWidget",wi),L("mountSellerContactFlag",Oi),L("mountPropertiesWidget",Mi),L("mountSupportNavItem",bd),L("mountPhoneAssignmentsWidget",gd),L("mountBulkPowerDialer",Fd),L("mountBulkPowerDialerContacts",qd),L("mountCallingAsChip",Gd),L("mountDialerThemeFix",on),L("mountReplyFromWarning",up),L("mountNoteCanon",yp),L("mountSuppressAutofill",xp)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",wp):wp();})();
