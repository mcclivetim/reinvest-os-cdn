/* Wholesaling CRM Customizer v0.24.4 — built 2026-06-06T02:05:36.948Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var yt="[wholesaling-crm-customizer]",Wa="__WS_CRM_DEBUG",ja=()=>!!window[Wa],p={info(...t){console.log(yt,...t)},warn(...t){console.warn(yt,...t)},error(...t){console.error(yt,...t)},debug(...t){ja()&&console.log(yt,"[debug]",...t)}};var Ka=/\/v2\/location\/([A-Za-z0-9]+)/,Ya=new Set(["8ntUQzMflUkR0YvrRgVk"]),xe=()=>{let t=window.location.pathname.match(Ka);return t?t[1]:null},wo=()=>{let t=xe();return t!==null&&Ya.has(t)};var zr=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,xo=/\/v2\/location\/([A-Za-z0-9]+)/,Ja=t=>{let e=t.match(zr);if(!e)return null;let o=t.match(xo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Xa=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(zr);if(!a)continue;let i=r.match(xo)||window.location.pathname.match(xo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},D=()=>{let t=Ja(window.location.pathname);return t||Xa()};var Gr=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},ft="",ko=null,ke="other",Eo=new Set,gt=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==ft)&&!(t!==ko))){ft=window.location.pathname,ko=t,ke=Gr(),p.debug("Page/context changed:",ke,ft,"contact:",t);for(let r of Eo)try{r(ke)}catch(a){p.error("Subscriber threw:",a)}}},wt=t=>(Eo.add(t),setTimeout(()=>t(ke),0),()=>{Eo.delete(t)}),qr=()=>{ke=Gr(),ft=window.location.pathname,ko=D()?.contactId??null,p.debug("Router init, current page:",ke);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),gt()},history.replaceState=function(o,r,a){e(o,r,a),gt()},window.addEventListener("popstate",gt),setInterval(gt,1e3)};var xt="0.24.4",kt="2026-06-06T02:05:36.949Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},To={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ur=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var Qa=/^[A-Za-z0-9]{15,30}$/,Ne=t=>typeof t=="string"&&Qa.test(t),Vr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Za=()=>{let t=window.WS_CRM_USER_ID;return Ne(t)?t:null},ei=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ne(o))return o;return null},ti=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Vr(e);if(!o)return null;let r=o.uid;if(Ne(r))return r;let a=o.claims;if(a&&Ne(a.user_id))return a.user_id}catch{}return null},oi=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Ne(a))return a}catch{}}}catch{}return null},I=()=>Za()||ei()||ti()||oi()||null,ri=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Vr(e);return o?o.claims??o:null}catch{return null}},Wr=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ri()?.type==="agency"};var Jr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ni=`${Jr}/active-follow-up-get`,ai=`${Jr}/active-follow-up-set`,me="ws-crm-active-follow-up-button",Ao={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ii=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},si=async t=>{let e=await fetch(ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},li=async(t,e)=>{let o=await fetch(ai,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ue=(t,e)=>{let o=Ao[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},jr=t=>{let e=document.createElement("button");return e.type="button",e.id=me,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ue(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ii();if(!(!r||r.contactId!==t)){ue(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await li(r,I()),i=a&&a.state&&a.state in Ao?a.state:"blue";ue(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ue(e,"error"),setTimeout(()=>void Et(e,r),4e3)}}}),e},Et=async(t,e)=>{ue(t,"loading");try{let o=await si(e),r=o&&o.state&&o.state in Ao?o.state:"gray",a=document.getElementById(me);if(!a||a.dataset.contactId!==e.contactId)return;ue(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),ue(t,"error")}},di=[".central-panel","[class*='central-panel']"],So="ws-crm-contact-actions-bar",ci=async()=>{for(let t of di)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},pi=async(t,e)=>{let o=e.querySelector(`#${So}`);if(!o)try{o=await L(`#${So}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${So}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},bi=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},hi=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},mi=async t=>{if(t==="url"){let o=await ci();return o?{kind:"contact-detail",target:o}:null}let e=bi();return e?{kind:"conversations",target:e}:null},Kr=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await pi(t,e.target);return o}return hi(t,e.target),"conversations-header"},ui=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(me)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(me);if(o&&o.dataset.contactId===e.contactId){Et(o,e);return}o&&o.remove();let r=await mi(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let i=jr(e.contactId),s=await Kr(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Yr();let l=document.getElementById(me)??i;Et(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(me);if(!(D()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=jr(e.contactId);Kr(m,r).then(()=>{Yr(),Et(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},ze=null,Xr=()=>{let t=D()?.contactId??null;if(ze&&ze.contactId===t)return;let e=ui().finally(()=>{ze?.promise===e&&(ze=null)});ze={contactId:t,promise:e}},Yr=()=>{let t=document.querySelectorAll(`#${me}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var vi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Ge=new Map,Tt=async(t,e)=>{if(!t)return null;if(Ge.has(t))return Ge.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${vi}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),Ge.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Ge.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),Ge.set(t,null),null}};var St=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var en="ws-buybox-nav-icon",Lo="ws-buybox-panel",Qr="ws-buybox-modal",_i="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",$o="https://mcclivetim.github.io/reinvest-os-cdn/geo",At=null,qe=null,Ue=null,Io=async()=>{if(At)return At;try{let t=await fetch(`${$o}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return At=await t.json(),At}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},yi=async t=>{if(!qe)try{let e=await fetch(`${$o}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);qe=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return qe?.[t]??[]},gi=async t=>{if(!Ue)try{let e=await fetch(`${$o}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Ue=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return Ue?.[t]??[]},Mo=async t=>await(await fetch(_i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),fi=(t,e)=>Mo({tenant_id:t,action:"list",buyer_contact_id:e}),wi=(t,e,o,r)=>Mo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),xi=(t,e)=>Mo({tenant_id:t,action:"remove",entry_id:e}),F=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ki=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Ei='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Ti='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Si="nav.w-13, nav[class*='w-13']",Ai=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Ci=async()=>{try{return await L(Si,{timeoutMs:2500})}catch{return null}},Ii=async()=>{try{return await L(Ai,{timeoutMs:2500})}catch{return null}},Li=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,$i=(t,e)=>{let o=document.createElement("div");return o.id=Lo,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Fi(t,e,()=>Do(t,e))}),o},Do=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([fi(t,e),Io()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Mi(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Mi=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?ki(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,xi(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}Do(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Ct=!1,tn=(t,e)=>{Ct=e;let o=Li(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Di,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Do(t.tenantId,t.buyerContactId)):(t.iconBtn.className=on,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},on="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Di="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Oi=t=>{let e=document.createElement("button");return e.id=en,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=on,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Ei.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Ct;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),tn(r,a)}),e},Fi=(t,e,o)=>{let r=document.getElementById(Qr);r&&r.remove();let a=document.createElement("div");a.id=Qr,a.style.cssText=`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",C=>{C.key==="Enter"&&(C.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),C=(g?.value||"").trim();if(!/^\d{5}$/.test(C)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(C)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),C=i.querySelector("#ws-buybox-save");C&&(C.disabled=!0,C.textContent="Adding\u2026"),T&&(T.textContent="");try{let O=await wi(t,e,s.granularity,g);if(!O.ok){T&&(T.textContent=O.error||"Failed to add entry."),C&&(C.disabled=!1,C.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(O){T&&(T.textContent=`Network error: ${O.message}`),C&&(C.disabled=!1,C.textContent="Add")}};l()},Co=!1,Ee=null,Ve=null,Zr=()=>{document.getElementById(en)?.remove(),document.getElementById(Lo)?.remove(),Ve&&Ee&&Ee.nav.removeEventListener("click",Ve,!0),Ve=null,Ee=null,Ct=!1},rn=()=>{Hi()},Hi=async()=>{if(!Co){Co=!0;try{let t=D();if(!t){Zr();return}let e=document.getElementById(Lo);if(e&&e.dataset.buyerContactId===t.contactId&&Ee)return;Zr();let o=null;try{o=await Tt(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(St(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Ci(),Ii()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let l=$i(t.locationId,t.contactId),d=Oi(()=>Ee),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ee=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),Ve=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Ct&&tn(c,!1)},a.addEventListener("click",Ve,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Co=!1}}};var de="ws-crm-claim-release-pill",Pi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Bi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Ri=async t=>{let e=await fetch(Pi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ni=async t=>{let e=await fetch(Bi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},sn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Te=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Ur(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},zi=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=de,o.type="button",o.dataset.contactId=t,Te(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let i=I();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Te(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Te(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Ni({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Te(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),Te(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},nn=async(t,e)=>{try{let o=await Ri({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(de);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Te(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Gi=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=sn(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},an=(t,e)=>{let o=zi({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${de}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},qi=async()=>{let t=D();if(!t){document.getElementById(de)?.remove();return}let e=document.getElementById(de);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await Gi(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}an(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(de);i&&t.locationId&&nn(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(de))return;let d=sn(o);if(d){an(d,t.contactId);let c=document.getElementById(de);c&&t.locationId&&nn(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},ln=()=>{qi()};var mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ui="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Vi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Wi=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||mn,d;if(s==="buyer"){let b=un.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},ji=async({contactId:t,tenantId:e})=>{let o=await fetch(Vi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Se="ws-crm-contact-actions-bar",Ki="ws-crm-call-status-dropdown",dn="ws-crm-offer-made-modal",Yi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],un=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Ji=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Xi=async()=>{for(let t of Ji)try{let e=await L(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Qi=({contactId:t,kind:e})=>{let o=e==="buyer"?un:Yi,r=e==="buyer"?Ui:mn,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Ki,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},bn=(t,e)=>{let o=document.createElement("div");if(o.id=Se,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=X,r.textContent="Offer Made",r.addEventListener("click",()=>ts(t,e)),o.appendChild(r),o.appendChild(Qi({contactId:t,kind:e}))}return o},Oo=!1,ns=()=>{document.querySelectorAll(`[id="${Se}"]`).forEach(t=>t.remove())},vn=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Oo){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Oo=!0;try{await as()}finally{Oo=!1}},as=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),ns();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Tt(t.contactId,t.locationId),b=St(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Se}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await Xi();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=D();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=bn(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Se)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Se}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=bn(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(a,{childList:!0})},hn=null,is=()=>{hn===null&&(hn=window.setInterval(()=>{let t=D();t&&(document.getElementById(Se)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),vn()))},3e3))},_n=()=>{is(),vn()};var It="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",ss=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),We="data-ws-crm-favicon",Fo=t=>t.hasAttribute(We),yn=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return ss.has(e)},Lt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{yn(r)&&!Fo(r)&&r.remove()});let e=document.head.querySelector(`link[${We}="1"]`);e?e.href!==It&&(e.href=It):(e=document.createElement("link"),e.setAttribute(We,"1"),e.rel="icon",e.type="image/png",e.href=It,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${We}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(We,"apple"),o.rel="apple-touch-icon",o.href=It,document.head.appendChild(o))},gn=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Lt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Lt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&yn(s)&&!Fo(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Fo(s)&&(a=!0)});a&&Lt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Lt(),e>=5&&window.clearInterval(o)},1e3)};var ls=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ds=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,cs=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(cs);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(ds);if(a){let i=a[1];if(ls.includes(i))return i}}return null},N=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ps="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Q="ws-crm-mt-offer-made-button",fn="ws-crm-mt-offer-made-modal",bs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hs=/\/v2\/location\/([A-Za-z0-9]+)/,Dt=()=>{let t=window.location.pathname,e=t.match(bs);if(!e)return null;let o=t.match(hs);return{oppId:e[1],locationId:o?o[1]:null}},ms=async t=>{let e=await fetch(ps,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$t=()=>{document.getElementById(fn)?.remove()},us=t=>{$t();let e=document.createElement("div");e.id=fn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Dt();!o||!o.locationId||o.oppId!==t||us({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},_s=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ys=async()=>{for(let t of _s)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Mt=!1,Ro=async()=>{if(!Mt){Mt=!0;try{await gs()}finally{Mt=!1}}},gs=async()=>{let t=Dt();if(!t||!t.locationId){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ke();return}let e=document.getElementById(Q);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ke());return}e&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove());let o=await ys();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Dt();if(!a||a.oppId!==t.oppId)return;let i=vs(t.oppId),s=document.createElement("span");s.id=`${Q}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),fs(t.oppId)},je=null,Bo=null,Ke=()=>{je?.disconnect(),je=null,Bo=null},fs=t=>{if(je&&Bo===t)return;Ke();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Bo=t,je=new MutationObserver(()=>{let o=Dt();if(!o||o.oppId!==t){Ke();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ke();return}document.getElementById(Q)||Ro()}),je.observe(e,{childList:!0,subtree:!0}))},Ho=null,Po,ws=()=>{Ho||(Ho=new MutationObserver(()=>{Po===void 0&&(Po=window.setTimeout(()=>{Po=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Q);t&&!e&&!Mt&&Ro()},300))}),Ho.observe(document.body,{childList:!0,subtree:!0}))},wn=()=>{ws(),Ro()};var xs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",Z="ws-crm-not-interested-button",ks=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Es=/\/v2\/location\/([A-Za-z0-9]+)/,Ft=()=>{let t=window.location.pathname,e=t.match(ks);if(!e)return null;let o=t.match(Es);return{oppId:e[1],locationId:o?o[1]:null}},Ts=async t=>{let e=await fetch(xs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ss=t=>{let e=document.createElement("button");return e.id=Z,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Ft();if(!o||!o.locationId||o.oppId!==t)return;let r=I(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await Ts({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},As=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Cs=async()=>{for(let t of As)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ot=!1,qo=async()=>{if(!Ot){Ot=!0;try{await Is()}finally{Ot=!1}}},Is=async()=>{let t=Ft();if(!t||!t.locationId){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Je();return}let e=document.getElementById(Z);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Je());return}e&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove());let o=await Cs();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ft();if(!a||a.oppId!==t.oppId)return;let i=Ss(t.oppId),s=document.createElement("span");s.id=`${Z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ls(t.oppId)},Ye=null,Go=null,Je=()=>{Ye?.disconnect(),Ye=null,Go=null},Ls=t=>{if(Ye&&Go===t)return;Je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Go=t,Ye=new MutationObserver(()=>{let o=Ft();if(!o||o.oppId!==t){Je();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),Je();return}document.getElementById(Z)||qo()}),Ye.observe(e,{childList:!0,subtree:!0}))},No=null,zo,$s=()=>{No||(No=new MutationObserver(()=>{zo===void 0&&(zo=window.setTimeout(()=>{zo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Z);t&&!e&&!Ot&&qo()},300))}),No.observe(document.body,{childList:!0,subtree:!0}))},xn=()=>{$s(),qo()};var Ms="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ae="ws-crm-resend-deal-link-wrap",Ds=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Os=/\/v2\/location\/([A-Za-z0-9]+)/,Pt=()=>{let t=window.location.pathname,e=t.match(Ds);if(!e)return null;let o=t.match(Os);return{oppId:e[1],locationId:o?o[1]:null}},Fs=async t=>{let e=await fetch(Ms,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Hs=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),kn=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,jo=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${kn(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Ps(t,e)),t.appendChild(o)},Ps=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Bs(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>jo(t,e)),o.appendChild(s),t.appendChild(o)},Bs=async(t,e,o,r)=>{let a=Pt();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Fs({oppId:a.oppId,locationId:a.locationId,channel:o,userId:I()});if(i?.ok)r.innerHTML=`${kn(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Hs(s)}</span>`}window.setTimeout(()=>jo(t,e),3500)}},Rs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ns=async()=>{for(let t of Rs)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ht=!1,Ko=async()=>{if(!Ht){Ht=!0;try{await zs()}finally{Ht=!1}}},zs=async()=>{let t=Pt();if(!t||!t.locationId){document.getElementById(Ae)?.remove(),Qe();return}let e=document.getElementById(Ae);if(e&&e.dataset.oppId===t.oppId){let s=M();s!==null&&s!=="Marketing Tracker"&&(e.remove(),Qe());return}e&&e.remove();let o=await Ns();if(!o)return;let r=await N();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Pt();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ae,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),jo(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Gs(t.oppId)},Xe=null,Wo=null,Qe=()=>{Xe?.disconnect(),Xe=null,Wo=null},Gs=t=>{if(Xe&&Wo===t)return;Qe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wo=t,Xe=new MutationObserver(()=>{let o=Pt();if(!o||o.oppId!==t){Qe();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ae)?.remove(),Qe();return}document.getElementById(Ae)||Ko()}),Xe.observe(e,{childList:!0,subtree:!0}))},Uo=null,Vo,qs=()=>{Uo||(Uo=new MutationObserver(()=>{Vo===void 0&&(Vo=window.setTimeout(()=>{Vo=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ae)&&!Ht&&Ko()},300))}),Uo.observe(document.body,{childList:!0,subtree:!0}))},En=()=>{qs(),Ko()};var Tn="ws-crm-dispo-action-row",Ce=t=>{let e=document.getElementById(Tn);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Tn,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Us="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ee="ws-crm-reduce-price-button",Sn="ws-crm-reduce-price-modal",Vs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ws=/\/v2\/location\/([A-Za-z0-9]+)/,Nt=()=>{let t=window.location.pathname,e=t.match(Vs);if(!e)return null;let o=t.match(Ws);return{oppId:e[1],locationId:o?o[1]:null}},js=async t=>{let e=await fetch(Us,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Bt=()=>{document.getElementById(Sn)?.remove()},Ks=t=>{Bt();let e=document.createElement("div");e.id=Sn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Nt();!r||!r.locationId||r.oppId!==t||Ks({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Js=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xs=async()=>{for(let t of Js)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Rt=!1,Qo=async()=>{if(!Rt){Rt=!0;try{await Qs()}finally{Rt=!1}}},Qs=async()=>{let t=Nt();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),et();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),et());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=await Xs();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Nt();if(!a||a.oppId!==t.oppId)return;let i=Ys(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ee}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Zs(t.oppId)},Ze=null,Xo=null,et=()=>{Ze?.disconnect(),Ze=null,Xo=null},Zs=t=>{if(Ze&&Xo===t)return;et();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Xo=t,Ze=new MutationObserver(()=>{let o=Nt();if(!o||o.oppId!==t){et();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),et();return}document.getElementById(ee)||Qo()}),Ze.observe(e,{childList:!0,subtree:!0}))},Yo=null,Jo,el=()=>{Yo||(Yo=new MutationObserver(()=>{Jo===void 0&&(Jo=window.setTimeout(()=>{Jo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!Rt&&Qo()},300))}),Yo.observe(document.body,{childList:!0,subtree:!0}))},An=()=>{el(),Qo()};var Ie="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",zt="deals.reinvestos.com";var te="ws-crm-edit-landing-button",tl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ol=/\/v2\/location\/([A-Za-z0-9]+)/,qt=()=>{let t=window.location.pathname,e=t.match(tl);if(!e)return null;let o=t.match(ol);return{oppId:e[1],locationId:o?o[1]:null}},rl=(t,e)=>{let o=new URL(`https://${zt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ie);let r=I();return r&&o.searchParams.set("user",r),o.toString()},nl=(t,e)=>{let o=document.createElement("button");return o.id=te,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=qt();if(!r||!r.locationId||r.oppId!==t)return;if(!Ie){p.warn("[edit-landing] editor session key not configured in this build");return}let a=rl(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},al=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],il=async()=>{for(let t of al)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Gt=!1,or=async()=>{if(!Gt){Gt=!0;try{await sl()}finally{Gt=!1}}},sl=async()=>{let t=qt();if(!t||!t.locationId){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),ot();return}let e=document.getElementById(te);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove(),ot());return}e&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove());let o=await il();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=qt();if(!a||a.oppId!==t.oppId)return;let i=nl(t.oppId,t.locationId),s=document.createElement("span");s.id=`${te}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),ll(t.oppId)},tt=null,tr=null,ot=()=>{tt?.disconnect(),tt=null,tr=null},ll=t=>{if(tt&&tr===t)return;ot();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(tr=t,tt=new MutationObserver(()=>{let o=qt();if(!o||o.oppId!==t){ot();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),ot();return}document.getElementById(te)||or()}),tt.observe(e,{childList:!0,subtree:!0}))},Zo=null,er,dl=()=>{Zo||(Zo=new MutationObserver(()=>{er===void 0&&(er=window.setTimeout(()=>{er=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(te);t&&!e&&!Gt&&or()},300))}),Zo.observe(document.body,{childList:!0,subtree:!0}))},Cn=()=>{dl(),or()};var Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Le="ws-crm-publish-button",rt="ws-crm-publish-wrap",Vt="ws-crm-publish-dropdown",cl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pl=/\/v2\/location\/([A-Za-z0-9]+)/,ar=()=>{let t=window.location.pathname,e=t.match(cl);if(!e)return null;let o=t.match(pl);return{oppId:e[1],locationId:o?o[1]:null}},bl=async(t,e)=>{try{let o=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:I()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},hl=async(t,e)=>{let o=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:I()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ml=(t,e)=>{if(!Ie){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${zt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ie);let r=I();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},se=()=>{document.getElementById(Vt)?.remove()},In=(t,e,o,r,a)=>{se();let i=document.createElement("div");i.id=Vt;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};ve(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await bl(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},ve(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},ve(o,r),document.getElementById(Vt)&&r.checks&&In(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},ve(o,r),se();try{let m=await hl(t,e);if(m.ok&&m.published)r={status:"published"},ve(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},ve(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},ve(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Vt)?se():r.checks&&In(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let v=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},v)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},vl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_l=async()=>{for(let t of vl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ut=!1,sr=async()=>{if(!Ut){Ut=!0;try{await yl()}finally{Ut=!1}}},yl=async()=>{let t=ar();if(!t||!t.locationId){document.getElementById(Le)?.remove(),document.getElementById(rt)?.remove(),se(),at();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(rt)?.remove(),se(),at());return}e&&(e.remove(),document.getElementById(rt)?.remove(),se());let o=await _l();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=ar();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=ul(t.oppId,a.locationId),s=document.createElement("span");s.id=rt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),Ce(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),gl(t.oppId)},nt=null,ir=null,at=()=>{nt?.disconnect(),nt=null,ir=null},gl=t=>{if(nt&&ir===t)return;at();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ir=t,nt=new MutationObserver(()=>{let o=ar();if(!o||o.oppId!==t){at();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(Le)?.remove(),document.getElementById(rt)?.remove(),se(),at();return}document.getElementById(Le)||sr()}),nt.observe(e,{childList:!0,subtree:!0}))},rr=null,nr,fl=()=>{rr||(rr=new MutationObserver(()=>{nr===void 0&&(nr=window.setTimeout(()=>{nr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Le)&&!Ut&&sr()},300))}),rr.observe(document.body,{childList:!0,subtree:!0}))},$n=()=>{fl(),sr()};var Mn="data:image/png;base64,",Dn="data:image/png;base64,";var wl=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],On=t=>`ws-crm-map-links-${t}`,Wt=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},Fn=t=>{let e=Wt(t.addr),o=Wt(t.city),r=Wt(t.state),a=Wt(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},xl=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,kl=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,El=(t,e)=>{let{full:o,hasAny:r}=Fn(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Tl=t=>{let e=document.createElement("span");e.id=On(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),El(t,s)}),l};return e.appendChild(r(Mn,"Open in Google Maps",xl)),e.appendChild(r(Dn,"Search on Zillow",kl)),e},Sl=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Hn=()=>{for(let t of wl){if(document.getElementById(On(t.key)))continue;let{hasAny:e}=Fn(t);if(!e)continue;let o=Sl(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Tl(t)),p.debug(`[map-links] injected on "${t.addr}"`))}},lr=null,dr,Al=()=>{lr||(lr=new MutationObserver(()=>{dr===void 0&&(dr=window.setTimeout(()=>{dr=void 0;try{Hn()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),lr.observe(document.body,{childList:!0,subtree:!0}))},Pn=()=>{Al(),Hn()};var Bn="ws-crm-hide-launchpad",Rn=/\/launchpad\/?$/,cr=()=>{if(!Wr()){if(!document.getElementById(Bn)){let t=document.createElement("style");t.id=Bn,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Rn.test(location.pathname)){let t=location.pathname.replace(Rn,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var Gn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ce="ws-crm-send-to-closing-office-button",_e="ws-crm-send-to-title-co-wrap",Yt="ws-crm-stc-dropdown",Cl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Il=/\/v2\/location\/([A-Za-z0-9]+)/,Jt=()=>{let t=window.location.pathname,e=t.match(Cl);if(!e)return null;let o=t.match(Il);return{oppId:e[1],locationId:o?o[1]:null}},Ll=5*60*1e3,qn=t=>`ws-crm-stc-cache:${t}`,$l=t=>{try{let e=window.localStorage.getItem(qn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ll||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Ml=(t,e)=>{try{window.localStorage.setItem(qn(t),JSON.stringify(e))}catch{}},Dl=async(t,e)=>{try{let o=await fetch(Gn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Ol=async(t,e,o)=>{let r=await fetch(Gn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Fl=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},Nn=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Hl=(t,e)=>{if(e&&Fl(e)){window.setTimeout(()=>Nn(t),300);return}Nn(t)},oe=()=>{document.getElementById(Yt)?.remove()},jt=(t,e,o)=>{oe();let r=document.createElement("div");r.id=Yt;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,ne(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Dl(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},ne(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},ne(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},ne(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Xt.add(t),document.getElementById(ce)?.remove(),document.getElementById(_e)?.remove(),oe(),st();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},Ml(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),ne(o,a),document.getElementById(Yt)&&jt(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},ne(o,a),oe();try{let y=await Ol(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},ne(o,a),y.checks&&jt(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},ne(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},ne(o,a),y.checks&&jt(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},ne(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Yt)?oe():a.checks&&jt(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,v=0,x=async()=>{if(!c){if(Date.now()<v){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Bl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Rl=async()=>{for(let t of Bl)try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Xt=new Set,zn=null,Nl=t=>{t&&t!==zn&&(Xt.clear(),zn=t)},Kt=!1,mr=async()=>{if(Kt){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Kt=!0;try{await zl()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Kt=!1}},zl=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Jt();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ce)?.remove(),document.getElementById(_e)?.remove(),oe();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Nl(t.oppId),Xt.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ce)?.remove(),document.getElementById(_e)?.remove(),oe();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(_e)?.remove(),oe(),st());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(_e)?.remove(),oe()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Rl();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Jt();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Pl(t.oppId,a.locationId),s=document.createElement("span");s.id=_e,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Gl(t.oppId)},it=null,hr=null,st=()=>{it?.disconnect(),it=null,hr=null},Gl=t=>{if(it&&hr===t)return;st();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(hr=t,it=new MutationObserver(()=>{let o=Jt();if(!o||o.oppId!==t){st();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ce)?.remove(),document.getElementById(_e)?.remove(),oe(),st();return}document.getElementById(ce)||mr()}),it.observe(e,{childList:!0,subtree:!0}))},pr=null,br,ql=()=>{pr||(pr=new MutationObserver(()=>{br===void 0&&(br=window.setTimeout(()=>{br=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);if(t&&!e&&!Kt){let o=Jt();if(o&&Xt.has(o.oppId))return;mr()}},300))}),pr.observe(document.body,{childList:!0,subtree:!0}))},Un=()=>{ql(),mr()};var Vn="ws-support-modal",Wn="ws-support-toast",Ul="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",jn="ws-support-submitter-name",Kn="ws-support-submitter-email",Yn="ws-support-submitter-role",Vl=["Bug","Feature Request","Question","Billing","Onboarding Help"],ye=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Wl=(t,e="success",o)=>{let r=document.getElementById(Wn);r&&r.remove();let a=document.createElement("div");a.id=Wn;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${ye(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${ye(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},jl=()=>{document.getElementById(Vn)?.remove();let t=(localStorage.getItem(jn)??"").trim(),e=(localStorage.getItem(Kn)??"").trim(),o=(localStorage.getItem(Yn)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Vn,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${ye(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${_.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${ye(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${ye(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${ye(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=xe();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(jn,r.submitterName),localStorage.setItem(Kn,r.submitterEmail),r.submitterRole&&localStorage.setItem(Yn,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Ul,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:I()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";Wl(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Kl=["/support-ticket","ws-support-modal","ws-support"],Yl=/\/custom-menu-link\//,ur=!1,Jn=()=>{if(ur||!Yl.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Kl.some(s=>i.includes(s))});if(r){ur=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{jl(),ur=!1},50);return}t<10&&setTimeout(e,150)};e()},Xn=!1,Qn=()=>{Xn||(Xn=!0,wt(()=>setTimeout(Jn,50)),Jn(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Xl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ql="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",ta="tc_closing_agent",Zl="tc_closing_office",re="ws-crm-closing-agent-picker-button",oa="ws-crm-closing-agent-picker-modal",ed=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,td=/\/v2\/location\/([A-Za-z0-9]+)/,ct=()=>{let t=window.location.pathname,e=t.match(ed);if(!e)return null;let o=t.match(td);return{oppId:e[1],locationId:o?o[1]:null}},kr=async t=>{let e=await fetch(Jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Zn=async t=>{let e=await fetch(Xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},od=async(t,e)=>{try{let o=await fetch(Ql,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:ta}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await kr({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ge=null,rd=60*60*1e3,Er=t=>`ws-crm-to-cache:${t}`,ra=t=>{try{let e=window.localStorage.getItem(Er(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>rd||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},na=(t,e,o)=>{try{window.localStorage.setItem(Er(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},nd=t=>{try{window.localStorage.removeItem(Er(t))}catch{}},gr="ws-crm-closing-agent-field-link",ad=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${gr}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},vr=!1,Tr=async t=>{if(vr)return;let e=aa();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){vr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await kr({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),fr(a.id,a.name,t);let i=document.getElementById(re);if(i){pe(i,{status:"linked",contactName:a.name});let s=ct();s&&na(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{vr=!1}}},id=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,aa=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();id.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},fr=(t,e,o)=>{let r=aa();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${gr}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=gr,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Qt=()=>{document.getElementById(oa)?.remove()},sd=t=>{Qt();let e=document.createElement("div");e.id=oa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};pe(o,r);let a=ra(t);return a&&(r={status:"linked",contactName:a.contactName},pe(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await od(t,e);s?(r={status:"linked",contactName:s.name},pe(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},fr(s.id,s.name,e)):a||(r={status:"empty"},pe(o,r),ge?.oppId===t&&(ge=null),ad(),nd(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||sd({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},pe(o,r);try{let l=[Zn({tenantId:e,oppId:t,fieldKey:ta,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Zn({tenantId:e,oppId:t,fieldKey:Zl,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},pe(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},na(t,s.id,s.name),fr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},pe(o,r)}}})}),o},dd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],cd=async()=>{for(let t of dd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},lt=!1,to=async()=>{if(!lt){lt=!0;try{await pd()}finally{lt=!1}}},pd=async()=>{let t=ct();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),eo();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),eo());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await cd();if(!r||!(ra(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await N()!=="Transaction Coordination")return;let i=ct();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=ld(t.oppId,i.locationId),l=document.createElement("span");l.id=`${re}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),bd(t.oppId),Tr(i.locationId)},dt=null,wr=null,xr=null,eo=()=>{dt?.disconnect(),dt=null,wr=null,xr=null},bd=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(dt&&wr===t&&xr===e||(eo(),wr=t,xr=e,dt=new MutationObserver(()=>{let o=ct();if(!o||o.oppId!==t||!o.locationId){eo();return}document.getElementById(re)||to(),Tr(o.locationId)}),dt.observe(e,{childList:!0,subtree:!0})))},_r=null,yr,hd=()=>{_r||(_r=new MutationObserver(()=>{yr===void 0&&(yr=window.setTimeout(()=>{yr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!lt&&to()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},ea,md=()=>{ea===void 0&&(ea=window.setInterval(()=>{let t=ct();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(re)&&!lt&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),to()),Tr(t.locationId)},2e3))},ia=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),hd(),md(),to()};var ud="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",he="ws-crm-manage-team-cta",sa="ws-crm-manage-team-modal",vd=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,la={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},_d={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},da=()=>{let t=window.location.pathname.match(vd);return t?{tenantId:t[1]}:null},ro=async t=>{let e=await fetch(ud,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},J=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),be=t=>J(t),Sr="ws-crm-manage-team-toast",Ir=(t,e="info",o=4e3)=>{document.getElementById(Sr)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Sr,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Sr)===a&&a.remove()},o)},Ar=()=>{document.getElementById(sa)?.remove()},yd=(t,e)=>{let o=_d[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${J(e)}</span>
  `},gd=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>yd(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>gd(r,e)).join(""),no=async t=>{Ar();let e=document.createElement("div");e.id=sa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ar);let r;try{r=await ro({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+fd(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{wd(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;xd(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;kd(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},wd=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${J(la[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{no(t)}),oo(e),setTimeout(()=>oo(e),200),setTimeout(()=>oo(e),800),window.addEventListener("resize",()=>oo(e)),e},Cr=!1,Md=()=>{if(!Cr){Cr=!0;try{let t=da();if(!t){document.getElementById(he)?.remove(),document.getElementById(`${he}-floater`)?.remove();return}let e=document.getElementById(he);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${he}-floater`)?.remove();let o=document.createElement("div");o.id=`${he}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=$d(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Cr=!1}}},ca=()=>{if(!da()){document.getElementById(he)?.remove(),document.getElementById(`${he}-floater`)?.remove();return}Md()};var Dd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Mr="ws-crm-prepare-contract-button",pa="ws-crm-prepare-contract-menu",ie="ws-crm-prepare-contract-modal",ba="ws-crm-modal-date-style",le="https://services.leadconnectorhq.com",ya=()=>{if(document.getElementById(ba))return;let t=document.createElement("style");t.id=ba,t.textContent=`
  ...
  `,document.head.appendChild(t)},Dr="__WS_CRM_CAPTURED_AUTH",Od=50*60*1e3,lo=()=>{try{let t=localStorage.getItem(Dr);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Od?(localStorage.removeItem(Dr),null):e:null}catch{return null}},Fd=t=>{try{localStorage.setItem(Dr,JSON.stringify(t))}catch{}},Me=()=>{let t=lo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ha=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((lo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),$e=async(t,e={},o=2)=>{let r=lo()?.capturedAt??0,a;try{a={...Me(),...e.headers??{}}}catch(s){if(o>0&&await ha(r,4e3))return $e(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await ha(r,4e3)?$e(t,e,o-1):i},ma=!1,Hd=()=>{if(ma)return;ma=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=lo()?.authorization;Fd({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ga=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Pd=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ga()},Bd=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},fa="__WS_CRM_TEMPLATES_CACHE_V1",Rd=24*60*60*1e3,ua=t=>{try{let e=window.localStorage.getItem(fa);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Rd?null:o.templates}catch{return null}},Nd=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(fa,JSON.stringify(o))}catch{}},zd=async t=>{let e=`${le}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await $e(e,{method:"GET"})}catch(s){let l=ua(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=ua(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Bd(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Nd(t,i),i},Gd=async(t,e)=>{let o=await $e(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await $e(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},qd=async(t,e)=>{let o=await $e(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Me()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},Ud=async t=>{let e=await fetch(Dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Vd=async(t,e,o)=>{let r=`${le}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Me()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Wd=async(t,e)=>{let o=await fetch(`${le}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Me()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},jd=async t=>{let e=await fetch(`${le}/contacts/${t}`,{method:"GET",headers:Me()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Kd=async(t,e,o,r)=>{let a;try{a=await Wd(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await jd(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${le}/proposals/document/${e}`,{method:"PUT",headers:{...Me(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},Yd=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},io="__WS_CRM_PENDING_INSTRUCTIONS",Jd=60*1e3,Xd=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Qd=t=>{let e=(t||"").toLowerCase();for(let o of Xd)if(e.includes(o.matches.toLowerCase()))return o;return null},Zd=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(io,JSON.stringify(r))}catch{}},ec=()=>{try{let t=localStorage.getItem(io);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Jd?(localStorage.removeItem(io),null):e}catch{return null}},tc=()=>{try{localStorage.removeItem(io)}catch{}},oc=(t,e)=>{document.getElementById(ie)?.remove();let o=document.createElement("div");o.id=ie,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},rc=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,nc=()=>{let t=window.location.pathname.match(rc);if(!t)return;let e=t[1],o=ec();o&&o.proposalId===e&&(tc(),window.setTimeout(()=>{oc(o.title,o.bodyHtml)},600))},va="ws-crm-prepare-contract-toast",z=(t,e="info",o=4e3)=>{document.getElementById(va)?.remove();let r=document.createElement("div");r.id=va;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},_a=(t,e)=>new Promise(o=>{document.getElementById(ie)?.remove();let r=document.createElement("div");r.id=ie,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,w.appendChild(y),document.body.appendChild(w);let B=y.querySelector("#ws-pc-purchase-price"),K=y.querySelector("#ws-pc-emd"),V=y.querySelector("#ws-pc-cash-at-close"),P=!1;V?.addEventListener("input",()=>{P=!0});let De=()=>{if(P)return;let R=Number(B?.value||0),G=Number(K?.value||0);V&&(V.value=String(Math.max(0,R-G)))};B?.addEventListener("input",De),K?.addEventListener("input",De);let _t=()=>w.remove();w.addEventListener("click",R=>{R.target===w&&_t()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",_t);let Y=y.querySelector("#ws-pc-submit"),j=y.querySelector("#ws-pc-error");Y?.addEventListener("click",async()=>{if(Y){j&&(j.textContent=""),Y.disabled=!0,Y.textContent="Opening\u2026";try{let R=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),G=Number(B?.value||0),Oe=Number(K?.value||0),Fe=Number(V?.value||0),He=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Pe=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Be=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),we=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Re=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),q={};if(R!==s&&(q.sellerName=R),G!==l&&(q.purchasePrice=G),Oe!==d&&(q.emd=Oe),Fe!==c&&(q.cashAtClose=Fe),He!==b&&(q.daysToClose=He),Pe!==m&&(q.inspectionDays=Pe),Be!==h&&(q.additionalTerms=Be),we!==v&&(q.currentOccupancy=we),Re!==x&&(q.occupancyAtClose=Re),Object.keys(q).length>0){p.info("[prepare-contract] PA modal submit with overrides:",q),Y.textContent="Saving\u2026";let yo=I(),go=await so({tenantId:t,contactId:e,template:o,userId:yo,overrides:q});p.info("[prepare-contract] re-stage with overrides ok:",go),Y.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let U=i?`${i} - Purchase Agreement`:void 0;await Hr(t,e,o,U)}catch(R){Y.disabled=!1,Y.textContent="Open Contract",j&&(j.textContent=R.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",R)}}})},ic=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ie)?.remove(),ya();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,S="",A=document.createElement("div");A.id=ie,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(k),document.body.appendChild(A);let V=k.querySelector("#ws-pc-assignment-price"),P=k.querySelector("#ws-pc-assignment-fee"),De=!1;P?.addEventListener("input",()=>{De=!0});let _t=()=>{if(De)return;let G=Number(V?.value||0);P&&(P.value=String(Math.max(0,G-x)))};V?.addEventListener("input",_t);let Y=()=>A.remove();A.addEventListener("click",G=>{G.target===A&&Y()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",Y);let j=k.querySelector("#ws-pc-submit"),R=k.querySelector("#ws-pc-error");j?.addEventListener("click",async()=>{if(!j)return;R&&(R.textContent="");let G=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),Oe=Number(V?.value||0),Fe=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),He=Number(P?.value||0),Pe=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Be=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),we=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Re=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),q=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!we){R&&(R.textContent="Closing Date is required.");return}j.disabled=!0,j.textContent="Opening\u2026";try{let U={};G!==b&&(U.sellerName=G),Oe!==m&&(U.assignmentPrice=Oe),Fe!==h&&(U.buyerEMD=Fe),He!==v&&(U.assignmentFee=He),Pe!==E&&(U.closingOffice=Pe),Be!==w&&(U.buyerCompanyName=Be);let yo=we!==y||Re!==f||q!==S,go=Object.keys(U).length>0||yo,fo=a;go?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",U),j.textContent="Saving\u2026",fo=await so({tenantId:t,contactId:e,template:o,oppId:r,closingDate:we,buyerEarnestDueDate:Re,lenderSource:q,userId:i,overrides:Object.keys(U).length>0?U:void 0}),p.info("[prepare-contract] AA re-stage ok:",fo),j.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Nr=fo?.debug?.propertyAddress||c,Va=Nr?`${Nr} - Assignment Agreement`:void 0;await Hr(t,e,o,Va),Y()}catch(U){j.disabled=!1,j.textContent="Open Contract",R&&(R.textContent=U.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",U)}})},so=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ud({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Hr=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Vd(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Kd(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),z(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Qd(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Zd(a,s.title,s.bodyHtml)),Yd(t,a)},sc=async t=>{let e=Pd(t);if(!e){z("Could not resolve contact context.","error");return}document.getElementById(pa)?.remove();let o=document.createElement("div");o.id=pa,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await zd(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=I();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await qd(e.tenantId,e.contactId)}catch(f){z(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){z("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await _a(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),x=h(7);z("Reading contract data\u2026","info",2500);let E;try{E=await so({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:v,buyerEarnestDueDate:x,userId:c})}catch(y){z(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){z("Could not resolve buyer contact for this opp.","error",6e3);return}ic({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:v,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){z("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Gd(e.tenantId,e.contactId)}catch(v){z(`Failed to load ACQ opps: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",v);return}if(b.length===0){z("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let v=await _a(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,p.info(`[prepare-contract] picked ACQ opp ${m}`)}z("Reading contract data\u2026","info",2500);let h;try{h=await so({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){z(`Failed to prepare contract: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",v);return}ac({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){z("This template needs to be started from a contact page.","error",6e3);return}z(`Opening ${i.name}\u2026`,"info",2500);try{await Hr(e.tenantId,e.contactId,i)}catch(b){z(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),z(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},wa=()=>{let t=document.createElement("button");return t.id=Mr,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),sc(t)}),t},lc="ws-crm-contact-actions-bar",dc=async()=>{let t=ga();if(!t){document.getElementById(Mr)?.remove();return}let e=null;try{e=await L(`#${lc}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Mr);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=wa();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},fe="ws-crm-prepare-contract-button-opp",pt=`${fe}-wrap`,cc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pc=/\/v2\/location\/([A-Za-z0-9]+)/,bc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Or=()=>{let t=window.location.pathname,e=t.match(cc);if(!e)return null;let o=t.match(pc);return o?{oppId:e[1],tenantId:o[1]}:null},hc=async()=>{for(let t of bc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ao=!1,bt=null,Fr=null,Lr=null,$r,ht=()=>{bt?.disconnect(),bt=null,Fr=null},mc=t=>{if(bt&&Fr===t)return;ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fr=t,bt=new MutationObserver(()=>{let o=Or();if(!o||o.oppId!==t){ht();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(fe)?.remove(),document.getElementById(pt)?.remove(),ht();return}document.getElementById(fe)||xa()}),bt.observe(e,{childList:!0,subtree:!0}))},uc=()=>{Lr||(Lr=new MutationObserver(()=>{$r===void 0&&($r=window.setTimeout(()=>{$r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);t&&!e&&!ao&&xa()},300))}),Lr.observe(document.body,{childList:!0,subtree:!0}))},xa=async()=>{if(!ao){ao=!0;try{let t=Or();if(!t){document.getElementById(fe)?.remove(),document.getElementById(pt)?.remove(),ht();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(pt)?.remove(),ht());return}e&&(e.remove(),document.getElementById(pt)?.remove());let o=await hc();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Or();if(!a||a.oppId!==t.oppId)return;let i=wa();i.id=fe,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=pt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),mc(t.oppId)}finally{ao=!1}}},ka=()=>{nc(),dc()};Hd();function W(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ae(t){return W(t)}var uo="reos-theme-stylesheet",za="reos-theme-fonts",vc=()=>{let t=document.getElementById(za);t&&t.remove()},_c=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var H=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Ua=()=>{if(p.info(`Loaded v${xt} (built ${kt})`),wo()){p.info(`[main] customizer disabled for excluded location ${xe()} \u2014 bailing`);return}H("mountVersionBadge (initial)",_o),H("mountFavicon",gn),H("mountThemeStylesheet",Ga),H("mountHideLaunchpad",cr),H("initPageRouter",qr),p.info("[main] registering onPageChange subscriber"),wt(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),wo()){p.info(`[main] page change into excluded location ${xe()} \u2014 skipping mounts`);return}H("mountVersionBadge",_o),H("mountHideLaunchpad",cr),H("mountClaimReleaseToggle",ln),H("mountContactActionsBar",_n),H("mountActiveFollowUpButton",Xr),H("mountMtOfferMadeButton",wn),H("mountNotInterestedButton",xn),H("mountResendDealLinkButton",En),H("mountReducePriceButton",An),H("mountEditLandingPageButton",Cn),H("mountPublishButton",$n),H("mountContactMapLinks",Pn),H("mountSendToClosingOfficeButton",Un),H("mountClosingAgentPickerButton",ia),H("mountPrepareContractButton",ka),H("mountManageTeam",ca),H("mountBuyBoxWidget",rn),H("mountSupportNavItem",Qn)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ua):Ua();})();
