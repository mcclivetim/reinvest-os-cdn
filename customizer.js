/* Wholesaling CRM Customizer v0.34.6 — built 2026-06-12T04:03:56.020Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Pt="[wholesaling-crm-customizer]",cs="__WS_CRM_DEBUG",ps=()=>!!window[cs],c={info(...t){console.log(Pt,...t)},warn(...t){console.warn(Pt,...t)},error(...t){console.error(Pt,...t)},debug(...t){ps()&&console.log(Pt,"[debug]",...t)}};var bs=/\/v2\/location\/([A-Za-z0-9]+)/,hs=new Set(["8ntUQzMflUkR0YvrRgVk"]),De=()=>{let t=window.location.pathname.match(bs);return t?t[1]:null},jo=()=>{let t=De();return t!==null&&hs.has(t)};var Rn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ko=/\/v2\/location\/([A-Za-z0-9]+)/,ms=t=>{let e=t.match(Rn);if(!e)return null;let o=t.match(Ko);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},us=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Rn);if(!a)continue;let i=r.match(Ko)||window.location.pathname.match(Ko);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=ms(window.location.pathname);return t||us()};var Fn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Rt="",Yo=null,He="other",Jo=new Set,Bt=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Rt)&&!(t!==Yo))){Rt=window.location.pathname,Yo=t,He=Fn(),c.debug("Page/context changed:",He,Rt,"contact:",t);for(let r of Jo)try{r(He)}catch(a){c.error("Subscriber threw:",a)}}},Ft=t=>(Jo.add(t),setTimeout(()=>t(He),0),()=>{Jo.delete(t)}),Nn=()=>{He=Fn(),Rt=window.location.pathname,Yo=P()?.contactId??null,c.debug("Router init, current page:",He);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Bt()},history.replaceState=function(o,r,a){e(o,r,a),Bt()},window.addEventListener("popstate",Bt),setInterval(Bt,1e3)};var Nt="0.34.6",zt="2026-06-12T04:03:56.020Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Xo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},zn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
