/* Wholesaling CRM Customizer v0.13.84 — built 2026-05-28T01:28:20.523Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var me="[wholesaling-crm-customizer]",Uo="__WS_CRM_DEBUG",Vo=()=>!!window[Uo],b={info(...o){console.log(me,...o)},warn(...o){console.warn(me,...o)},error(...o){console.error(me,...o)},debug(...o){Vo()&&console.log(me,"[debug]",...o)}};var Ft=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,je=/\/v2\/location\/([A-Za-z0-9]+)/,qo=o=>{let e=o.match(Ft);if(!e)return null;let t=o.match(je);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},zo=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Ft);if(!n)continue;let i=r.match(je)||window.location.pathname.match(je);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},S=()=>{let o=qo(window.location.pathname);return o||zo()};var Mt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},_e="",Ke=null,j="other",Ye=new Set,ue=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==_e)&&!(o!==Ke))){_e=window.location.pathname,Ke=o,j=Mt(),b.debug("Page/context changed:",j,_e,"contact:",o);for(let r of Ye)try{r(j)}catch(n){b.error("Subscriber threw:",n)}}},Dt=o=>(Ye.add(o),setTimeout(()=>o(j),0),()=>{Ye.delete(o)}),Ot=()=>{j=Mt(),_e=window.location.pathname,Ke=S()?.contactId??null,b.debug("Router init, current page:",j);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ue()},history.replaceState=function(t,r,n){e(t,r,n),ue()},window.addEventListener("popstate",ue),setInterval(ue,1e3)};var ve="0.13.84",ye="2026-05-28T01:28:20.523Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,a)=>{let s=n.querySelector(o);if(s){i(s);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),a(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},k={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Xe={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},Ht=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var Wo=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&Wo.test(o),jo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ko=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Yo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},Xo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=jo(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},Jo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>Ko()||Yo()||Xo()||Jo()||null;var Rt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Zo=`${Rt}/active-follow-up-get`,Qo=`${Rt}/active-follow-up-set`,q="ws-crm-active-follow-up-button",Ze={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},er=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},tr=async o=>{let e=await fetch(Zo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},or=async(o,e)=>{let t=await fetch(Qo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},z=(o,e)=>{let t=Ze[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Nt=o=>{let e=document.createElement("button");return e.type="button",e.id=q,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,z(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=er();if(!(!r||r.contactId!==o)){z(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await or(r,L()),i=n&&n.state&&n.state in Ze?n.state:"blue";z(e,i),b.info(`Active Follow Up set for ${o} \u2192 ${i}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),z(e,"error"),setTimeout(()=>void ge(e,r),4e3)}}}),e},ge=async(o,e)=>{z(o,"loading");try{let t=await tr(e),r=t&&t.state&&t.state in Ze?t.state:"gray",n=document.getElementById(q);if(!n||n.dataset.contactId!==e.contactId)return;z(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),z(o,"error")}},rr=[".central-panel","[class*='central-panel']"],Je="ws-crm-contact-actions-bar",nr=async()=>{for(let o of rr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ar=async(o,e)=>{let t=e.querySelector(`#${Je}`);if(!t)try{t=await C(`#${Je}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Je}`);i&&i.parentElement===e?e.insertBefore(n,i.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},ir=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},sr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},lr=async o=>{if(o==="url"){let t=await nr();return t?{kind:"contact-detail",target:t}:null}let e=ir();return e?{kind:"conversations",target:e}:null},Pt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await ar(o,e.target);return t}return sr(o,e.target),"conversations-header"},dr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(q)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(q);if(t&&t.dataset.contactId===e.contactId){ge(t,e);return}t&&t.remove();let r=await lr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let i=Nt(e.contactId),a=await Pt(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${a}) for ${e.contactId}`),Bt();let s=document.getElementById(q)??i;ge(s,e);let d=new MutationObserver(()=>{let c=document.getElementById(q);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Nt(e.contactId);Pt(m,r).then(()=>{Bt(),ge(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Z=null,$t=()=>{let o=S()?.contactId??null;if(Z&&Z.contactId===o)return;let e=dr().finally(()=>{Z?.promise===e&&(Z=null)});Z={contactId:o,promise:e}},Bt=()=>{let o=document.querySelectorAll(`#${q}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",cr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",br="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",hr=async o=>{let e=await fetch(cr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},pr=async o=>{let e=await fetch(br,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Vt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},K=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=Ht(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},mr=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=G,t.type="button",t.dataset.contactId=o,K(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let i=L();if(!i){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>K(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${i}`);let a=r==="claim"?"release":"claim";K(t,a),t.disabled=!0,t.style.opacity="0.8";try{let s=await pr({contactId:o,locationId:n.locationId,userId:i,action:r}),d=s?.mode==="claim"||s?.mode==="release"?s.mode:a;K(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(s){b.error("Claim/Release Set webhook failed",s),K(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Gt=async(o,e)=>{try{let t=await hr({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(G);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";K(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},ur=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Vt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Ut=(o,e)=>{let t=mr({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${G}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},_r=async()=>{let o=S();if(!o){document.getElementById(G)?.remove();return}let e=document.getElementById(G);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await ur(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ut(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let i=document.getElementById(G);i&&o.locationId&&Gt(i,{contactId:o.contactId,locationId:o.locationId});let a=null;a=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){a?.disconnect();return}if(document.getElementById(G))return;let d=Vt(t);if(d){Ut(d,o.contactId);let c=document.getElementById(G);c&&o.locationId&&Gt(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),a.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},qt=()=>{_r()};var vr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Q=new Map,zt=async(o,e)=>{if(!o)return null;if(Q.has(o))return Q.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${vr}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!i.ok)return b.warn(`Contact Type fetch returned ${i.status} for ${o}`),Q.set(o,null),null;let s=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Q.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),Q.set(o,null),null}};var Wt=o=>o==="buyer"?"buyer":"seller";var Zt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",yr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var gr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",fr=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:i,kind:a})=>{let s=i||Zt,d;if(a==="buyer"){let p=Qt.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},wr=async({contactId:o,tenantId:e})=>{let t=await fetch(gr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var Y="ws-crm-contact-actions-bar",xr="ws-crm-call-status-dropdown",jt="ws-crm-offer-made-modal",kr=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Qt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Er=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Tr=async()=>{for(let o of Er)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Sr=({contactId:o,kind:e})=>{let t=e==="buyer"?Qt:kr,r=e==="buyer"?yr:Zt,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=xr,i.style.cssText="position: relative; flex-shrink: 0;";let a=document.createElement("button");a.type="button",a.style.cssText=I,a.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),i=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let a=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",a),i())};document.addEventListener("keydown",a)},Xt=(o,e)=>{let t=document.createElement("div");t.id=Y,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=R,r.textContent="Offer Made",r.addEventListener("click",()=>Lr(o,e)),t.appendChild(r),t.appendChild(Sr({contactId:o,kind:e})),t},Qe=!1,Mr=()=>{document.querySelectorAll(`[id="${Y}"]`).forEach(o=>o.remove())},eo=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Qe){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Qe=!0;try{await Dr()}finally{Qe=!1}},Dr=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Mr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await zt(o.contactId,o.locationId);Wt(c)==="buyer"&&(e="buyer"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Y}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await Tr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let i=S();if(!i||i.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let a;try{a=Xt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}a.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(a,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Y)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${Y}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=Xt(o.contactId,e);h.dataset.mountTarget=a.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},Jt=null,Or=()=>{Jt===null&&(Jt=window.setInterval(()=>{let o=S();o&&(document.getElementById(Y)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),eo()))},3e3))},to=()=>{Or(),eo()};var fe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Hr=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),ee="data-ws-crm-favicon",et=o=>o.hasAttribute(ee),oo=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Hr.has(e)},we=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{oo(r)&&!et(r)&&r.remove()});let e=document.head.querySelector(`link[${ee}="1"]`);e?e.href!==fe&&(e.href=fe):(e=document.createElement("link"),e.setAttribute(ee,"1"),e.rel="icon",e.type="image/png",e.href=fe,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${ee}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(ee,"apple"),t.rel="apple-touch-icon",t.href=fe,document.head.appendChild(t))},ro=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)we();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),we())},50)}new MutationObserver(r=>{let n=!1;for(let i of r)i.addedNodes.forEach(a=>{a instanceof HTMLLinkElement&&oo(a)&&!et(a)&&(n=!0)}),i.removedNodes.forEach(a=>{a instanceof HTMLLinkElement&&et(a)&&(n=!0)});n&&we()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,we(),e>=5&&window.clearInterval(t)},1e3)};var Nr=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Pr=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Br=".hr-card.hr-modal.crm-opportunities-modal",A=()=>{let o=document.querySelector(Br);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Pr);if(n){let i=n[1];if(Nr.includes(i))return i}}return null},U=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=A();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Rr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",no="ws-crm-mt-offer-made-modal",$r=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gr=/\/v2\/location\/([A-Za-z0-9]+)/,Ee=()=>{let o=window.location.pathname,e=o.match($r);if(!e)return null;let t=o.match(Gr);return{oppId:e[1],locationId:t?t[1]:null}},Ur=async o=>{let e=await fetch(Rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},xe=()=>{document.getElementById(no)?.remove()},Vr=o=>{xe();let e=document.createElement("div");e.id=no,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),i=t.querySelector("#ws-mt-offer-cancel"),a=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let s=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};t.addEventListener("keydown",s),e.addEventListener("click",d=>{d.target===e&&xe()}),i?.addEventListener("click",()=>xe()),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Recording\u2026",a.style.opacity="0.7",i&&(i.disabled=!0);try{let p=await Ur({oppId:o.oppId,locationId:o.locationId,amount:c,userId:L()});if(!p.ok){n.textContent=p.error??"Something went wrong.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",i&&(i.disabled=!1);return}xe(),o.onSuccess()}catch(p){b.error("MT Offer Made webhook failed",p),n.textContent=p instanceof Error?p.message:"Network error \u2014 try again.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",i&&(i.disabled=!1)}})},qr=o=>{let e=document.createElement("button");return e.id=D,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Ee();!t||!t.locationId||t.oppId!==o||Vr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},zr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wr=async()=>{for(let o of zr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ke=!1,nt=async()=>{if(!ke){ke=!0;try{await jr()}finally{ke=!1}}},jr=async()=>{let o=Ee();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await Wr();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ee();if(!n||n.oppId!==o.oppId)return;let i=qr(o.oppId),a=document.createElement("span");a.id=`${D}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Kr(o.oppId)},te=null,rt=null,oe=()=>{te?.disconnect(),te=null,rt=null},Kr=o=>{if(te&&rt===o)return;oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(rt=o,te=new MutationObserver(()=>{let t=Ee();if(!t||t.oppId!==o){oe();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}document.getElementById(D)||nt()}),te.observe(e,{childList:!0,subtree:!0}))},tt=null,ot,Yr=()=>{tt||(tt=new MutationObserver(()=>{ot===void 0&&(ot=window.setTimeout(()=>{ot=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!ke&&nt()},300))}),tt.observe(document.body,{childList:!0,subtree:!0}))},ao=()=>{Yr(),nt()};var Xr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",Jr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zr=/\/v2\/location\/([A-Za-z0-9]+)/,Se=()=>{let o=window.location.pathname,e=o.match(Jr);if(!e)return null;let t=o.match(Zr);return{oppId:e[1],locationId:t?t[1]:null}},Qr=async o=>{let e=await fetch(Xr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},en=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Se();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await Qr({oppId:t.oppId,locationId:t.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},tn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],on=async()=>{for(let o of tn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Te=!1,lt=async()=>{if(!Te){Te=!0;try{await rn()}finally{Te=!1}}},rn=async()=>{let o=Se();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await on();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Se();if(!n||n.oppId!==o.oppId)return;let i=en(o.oppId),a=document.createElement("span");a.id=`${O}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),nn(o.oppId)},re=null,st=null,ne=()=>{re?.disconnect(),re=null,st=null},nn=o=>{if(re&&st===o)return;ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(st=o,re=new MutationObserver(()=>{let t=Se();if(!t||t.oppId!==o){ne();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}document.getElementById(O)||lt()}),re.observe(e,{childList:!0,subtree:!0}))},at=null,it,an=()=>{at||(at=new MutationObserver(()=>{it===void 0&&(it=window.setTimeout(()=>{it=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Te&&lt()},300))}),at.observe(document.body,{childList:!0,subtree:!0}))},io=()=>{an(),lt()};var sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",so="ws-crm-reduce-price-modal",ln=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dn=/\/v2\/location\/([A-Za-z0-9]+)/,Le=()=>{let o=window.location.pathname,e=o.match(ln);if(!e)return null;let t=o.match(dn);return{oppId:e[1],locationId:t?t[1]:null}},cn=async o=>{let e=await fetch(sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ce=()=>{document.getElementById(so)?.remove()},bn=o=>{Ce();let e=document.createElement("div");e.id=so,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),i=t.querySelector("#ws-reduce-cancel"),a=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let s=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};t.addEventListener("keydown",s),e.addEventListener("click",d=>{d.target===e&&Ce()}),i?.addEventListener("click",()=>{Ce()}),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Reducing\u2026",a.style.opacity="0.7",i&&(i.disabled=!0);try{await cn({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:L()}),Ce(),o.onSuccess()}catch(p){b.error("Reduce Price webhook failed",p),n.textContent=p instanceof Error?p.message:"Something went wrong. Try again.",a.disabled=!1,a.textContent="Reduce Price",a.style.opacity="1",i&&(i.disabled=!1)}})},hn=(o,e)=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Le();!r||!r.locationId||r.oppId!==o||bn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),i=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,i&&(i.style.background=l.emerald,i.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,i&&(i.style.background=l.amber,i.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},pn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],mn=async()=>{for(let o of pn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ie=!1,ht=async()=>{if(!Ie){Ie=!0;try{await un()}finally{Ie=!1}}},un=async()=>{let o=Le();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await mn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Le();if(!n||n.oppId!==o.oppId)return;let i=hn(o.oppId,o.locationId),a=document.createElement("span");a.id=`${H}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),_n(o.oppId)},ae=null,bt=null,ie=()=>{ae?.disconnect(),ae=null,bt=null},_n=o=>{if(ae&&bt===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(bt=o,ae=new MutationObserver(()=>{let t=Le();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||ht()}),ae.observe(e,{childList:!0,subtree:!0}))},dt=null,ct,vn=()=>{dt||(dt=new MutationObserver(()=>{ct===void 0&&(ct=window.setTimeout(()=>{ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ie&&ht()},300))}),dt.observe(document.body,{childList:!0,subtree:!0}))},lo=()=>{vn(),ht()};var bo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",W="ws-crm-send-to-title-co-button",X="ws-crm-send-to-title-co-wrap",Me="ws-crm-stc-dropdown",yn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gn=/\/v2\/location\/([A-Za-z0-9]+)/,ut=()=>{let o=window.location.pathname,e=o.match(yn);if(!e)return null;let t=o.match(gn);return{oppId:e[1],locationId:t?t[1]:null}},fn=5*60*1e3,ho=o=>`ws-crm-stc-cache:${o}`,wn=o=>{try{let e=window.localStorage.getItem(ho(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>fn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},xn=(o,e)=>{try{window.localStorage.setItem(ho(o),JSON.stringify(e))}catch{}},kn=async(o,e)=>{try{let t=await fetch(bo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},En=async(o,e,t)=>{let r=await fetch(bo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Tn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},co=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Sn=(o,e)=>{if(e&&Tn(e)){window.setTimeout(()=>co(o),300);return}co(o)},P=()=>{document.getElementById(Me)?.remove()},Ae=(o,e,t)=>{P();let r=document.createElement("div");r.id=Me;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,N(t,n);let i=new Set,a=async()=>{if(n.status==="sending")return;let v=await kn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},N(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},N(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},N(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),P(),le();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?i.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),i=T}else i=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},xn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),N(t,n),document.getElementById(Me)&&Ae(y,v.previously_sent_at,t)},s=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},N(t,n),P();try{let _=await En(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},N(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},N(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},N(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},N(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":s();break;case"incomplete":{document.getElementById(Me)?P():n.checks&&Ae(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await a()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-p,E=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},In=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ln=async()=>{for(let o of In)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Fe=!1,vt=async()=>{if(Fe){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Fe=!0;try{await An()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Fe=!1}},An=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=ut();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),P();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(W);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let s=A();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),P(),le());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),P()),b.debug("[stc] mount:04 calling findMountTarget");let t=await Ln();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=ut();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Cn(o.oppId,n.locationId),a=document.createElement("span");a.id=X,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(i)}`),Fn(o.oppId)},se=null,_t=null,le=()=>{se?.disconnect(),se=null,_t=null},Fn=o=>{if(se&&_t===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(_t=o,se=new MutationObserver(()=>{let t=ut();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),P(),le();return}document.getElementById(W)||vt()}),se.observe(e,{childList:!0,subtree:!0}))},pt=null,mt,Mn=()=>{pt||(pt=new MutationObserver(()=>{mt===void 0&&(mt=window.setTimeout(()=>{mt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);o&&!e&&!Fe&&vt()},300))}),pt.observe(document.body,{childList:!0,subtree:!0}))},po=()=>{Mn(),vt()};var Dn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",On="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Hn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",uo="ldtyB2UXKi9vOp8nLUH7",Nn="WVD2gb9swLsgcdBEtDVq",B="ws-crm-title-officer-picker-button",_o="ws-crm-title-officer-picker-modal",Pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bn=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let o=window.location.pathname,e=o.match(Pn);if(!e)return null;let t=o.match(Bn);return{oppId:e[1],locationId:t?t[1]:null}},Tt=async o=>{let e=await fetch(Dn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},mo=async o=>{let e=await fetch(On,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Rn=async(o,e)=>{try{let t=await fetch(Hn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:uo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await Tt({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let a=i.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},de=null,$n=60*60*1e3,St=o=>`ws-crm-to-cache:${o}`,Gn=o=>{try{let e=window.localStorage.getItem(St(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>$n||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},vo=(o,e,t)=>{try{window.localStorage.setItem(St(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},Un=o=>{try{window.localStorage.removeItem(St(o))}catch{}},wt="ws-crm-title-officer-field-link",Vn=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${wt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsTitleOfficerDecorated}))},yt=!1,yo=async o=>{if(yt)return;let e=go();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[title-officer] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[title-officer] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsTitleOfficerDecorated!==t){yt=!0;try{b.info(`[title-officer] tryDecorate: looking up ${t}`);let r=await Tt({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[title-officer] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[title-officer] tryDecorate: applying ${n.name} (${n.id})`),xt(n.id,n.name,o);let i=document.getElementById(B);if(i){V(i,{status:"linked",contactName:n.name});let a=Ne();a&&vo(a.oppId,n.id,n.name)}}catch(r){b.warn("[title-officer] tryDecorate lookup failed:",r)}finally{yt=!1}}},qn=/^TC\s*[-‐–—]\s*Title\s+Officer$/i,go=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();qn.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[title-officer] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[title-officer] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[title-officer] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=t[0].parentElement,s=0;for(;a&&s<8;){let d=a.querySelector("input");if(d)return b.info(`[title-officer] findInput: located input ${s} levels up from label`),d;a=a.parentElement,s+=1}return b.warn("[title-officer] findInput: label found but no <input> within 8 ancestors"),null},xt=(o,e,t)=>{let r=go();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${wt}`).forEach(a=>a.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsTitleOfficerDecorated=o,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let s=document.createElement("a");s.className=wt,s.href=`/v2/location/${t}/contacts/detail/${o}`,s.textContent=e,s.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${k.sm};
      z-index: 2;
    `,s.addEventListener("mouseenter",()=>{s.style.textDecoration="underline"}),s.addEventListener("mouseleave",()=>{s.style.textDecoration="none"}),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=s.href}),i.appendChild(s)}}},De=()=>{document.getElementById(_o)?.remove()},zn=o=>{De();let e=document.createElement("div");e.id=_o,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),i=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&De()}),i?.addEventListener("click",De);let a,s="",d=async c=>{if(n&&c!==s){if(s=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await Tt({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=l.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{De(),o.onPick(m)}),n.appendChild(h)})}catch(p){b.error("Title Officer picker search failed",p),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${l.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;a!==void 0&&clearTimeout(a),a=window.setTimeout(()=>{d(c)},250)})},Oe=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),V=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Title Officer",i=l.amber,a=l.bone,s="transparent",d=l.steel,c="pointer";switch(e.status){case"loading":n="Loading Title Officer\u2026",i=l.coolGray,a=l.ash,c="wait";break;case"empty":n="Link Title Officer",i=l.amber;break;case"linked":n=e.contactName?`Title Officer: ${e.contactName}`:"Title Officer: \u2713",i=l.emerald,s=l.emeraldGlow,d=l.emeraldBorder,a=l.emeraldBright;break;case"saving":n="Linking\u2026",i=l.coolGray,a=l.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),o.style.background=s,o.style.borderColor=d,o.style.color=a,o.style.cursor=c},Wn=(o,e)=>{let t=document.createElement("button");t.id=B,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Pick the Title Officer contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};V(t,r);let n=Gn(o);return n&&(r={status:"linked",contactName:n.contactName},V(t,r),de={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await Rn(o,e);a?(r={status:"linked",contactName:a.name},V(t,r),de={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e)):n||(r={status:"empty"},V(t,r),de?.oppId===o&&(de=null),Vn(),Un(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||zn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},V(t,r);try{let s=[mo({tenantId:e,oppId:o,fieldId:uo,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(mo({tenantId:e,oppId:o,fieldId:Nn,value:a.companyName.trim()}));let c=(await Promise.all(s))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},V(t,r),de={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},vo(o,a.id,a.name),xt(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},V(t,r)}}})}),t},jn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Kn=async()=>{for(let o of jn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,Ct=async()=>{if(!He){He=!0;try{await Yn()}finally{He=!1}}},Yn=async()=>{let o=Ne();if(!o||!o.locationId){document.getElementById(B)?.remove(),document.getElementById(`${B}-wrap`)?.remove(),Pe();return}let e=document.getElementById(B);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Kn();if(!r||await U()!=="Transaction Coordination")return;let i=Ne();if(!i||i.oppId!==o.oppId||!i.locationId)return;let a=Wn(o.oppId,i.locationId),s=document.createElement("span");s.id=`${B}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(a),r.appendChild(s),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Xn(o.oppId),yo(i.locationId)},ce=null,kt=null,Et=null,Pe=()=>{ce?.disconnect(),ce=null,kt=null,Et=null},Xn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ce&&kt===o&&Et===e||(Pe(),kt=o,Et=e,ce=new MutationObserver(()=>{let t=Ne();if(!t||t.oppId!==o||!t.locationId){Pe();return}document.getElementById(B)||Ct(),yo(t.locationId)}),ce.observe(e,{childList:!0,subtree:!0})))},gt=null,ft,Jn=()=>{gt||(gt=new MutationObserver(()=>{ft===void 0&&(ft=window.setTimeout(()=>{ft=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(B);o&&!e&&!He&&Ct()},300))}),gt.observe(document.body,{childList:!0,subtree:!0}))},fo=()=>{Jn(),Ct()};var Ve="reos-theme-stylesheet",Bo="reos-theme-fonts",Zn=()=>{let o=document.getElementById(Bo);o&&o.remove()},Qn=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Go=()=>{b.info(`Loaded v${ve} (built ${ye})`),M("mountVersionBadge (initial)",ze),M("mountFavicon",ro),M("mountThemeStylesheet",Ro),M("initPageRouter",Ot),b.info("[main] registering onPageChange subscriber"),Dt(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",ze),M("mountClaimReleaseToggle",qt),M("mountContactActionsBar",to),M("mountActiveFollowUpButton",$t),M("mountMtOfferMadeButton",ao),M("mountNotInterestedButton",io),M("mountReducePriceButton",lo),M("mountSendToTitleCoButton",po),M("mountTitleOfficerPickerButton",fo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Go):Go();})();
