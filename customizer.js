/* Wholesaling CRM Customizer v0.13.47 — built 2026-05-26T15:32:42.510Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Z="[wholesaling-crm-customizer]",Ct="__WS_CRM_DEBUG",At=()=>!!window[Ct],b={info(...o){console.log(Z,...o)},warn(...o){console.warn(Z,...o)},error(...o){console.error(Z,...o)},debug(...o){At()&&console.log(Z,"[debug]",...o)}};var Fe=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,we=/\/v2\/location\/([A-Za-z0-9]+)/,Lt=o=>{let e=o.match(Fe);if(!e)return null;let t=o.match(we);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},It=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Fe);if(!n)continue;let a=r.match(we)||window.location.pathname.match(we);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},T=()=>{let o=Lt(window.location.pathname);return o||It()};var De=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},te="",xe=null,B="other",ke=new Set,ee=()=>{let o=T()?.contactId??null;if(!(!(window.location.pathname!==te)&&!(o!==xe))){te=window.location.pathname,xe=o,B=De(),b.debug("Page/context changed:",B,te,"contact:",o);for(let r of ke)try{r(B)}catch(n){b.error("Subscriber threw:",n)}}},Me=o=>(ke.add(o),setTimeout(()=>o(B),0),()=>{ke.delete(o)}),He=()=>{B=De(),te=window.location.pathname,xe=T()?.contactId??null,b.debug("Router init, current page:",B);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ee()},history.replaceState=function(t,r,n){e(t,r,n),ee()},window.addEventListener("popstate",ee),setInterval(ee,1e3)};var oe="0.13.47",re="2026-05-26T15:32:42.511Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let l,d,h=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),d!==void 0&&window.clearInterval(d)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),d=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),l=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var c={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},y={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Te={purple:"#8B5CF6",green:c.emerald,orange:c.amber,red:c.crimson},ne=o=>{let e=o==="emerald"?c.emeraldGlow:o==="amber"?c.amberGlow:c.slate,t=o==="emerald"?c.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":c.steel,r=o==="emerald"?c.emerald:o==="amber"?c.amber:c.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,U=`
  ...
  flex-shrink: 0;
`;var Ft=/^[A-Za-z0-9]{15,30}$/,q=o=>typeof o=="string"&&Ft.test(o),Dt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Mt=()=>{let o=window.WS_CRM_USER_ID;return q(o)?o:null},Ht=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(q(t))return t;return null},Nt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Dt(e);if(!t)return null;let r=t.uid;if(q(r))return r;let n=t.claims;if(n&&q(n.user_id))return n.user_id}catch{}return null},Pt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(q(n))return n}catch{}}}catch{}return null},A=()=>Mt()||Ht()||Nt()||Pt()||null;var Re="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Ot=`${Re}/active-follow-up-get`,Rt=`${Re}/active-follow-up-set`,P="ws-crm-active-follow-up-button",Se={amber:{label:"Add to Active Follow Up",bg:c.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:c.amber,clickable:!0,dotColor:c.amber},blue:{label:"In Active Follow Up",bg:c.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:c.blue,clickable:!1,dotColor:c.blue},gray:{label:"Not in Follow Up",bg:c.slate,border:c.steel,color:c.coolGray,clickable:!1,dotColor:c.coolGray},loading:{label:"Active Follow Up\u2026",bg:c.slate,border:c.steel,color:c.ash,clickable:!1,dotColor:c.ash},error:{label:"Follow Up status unavailable",bg:c.slate,border:c.steel,color:c.ash,clickable:!1,dotColor:c.crimson}},Bt=()=>{let o=T();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Gt=async o=>{let e=await fetch(Ot,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},$t=async(o,e)=>{let t=await fetch(Rt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},O=(o,e)=>{let t=Se[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ne=o=>{let e=document.createElement("button");return e.type="button",e.id=P,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,O(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Bt();if(!(!r||r.contactId!==o)){O(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await $t(r,A()),a=n&&n.state&&n.state in Se?n.state:"blue";O(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),O(e,"error"),setTimeout(()=>void ae(e,r),4e3)}}}),e},ae=async(o,e)=>{O(o,"loading");try{let t=await Gt(e),r=t&&t.state&&t.state in Se?t.state:"gray",n=document.getElementById(P);if(!n||n.dataset.contactId!==e.contactId)return;O(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),O(o,"error")}},Vt=[".central-panel","[class*='central-panel']"],Ee="ws-crm-contact-actions-bar",Ut=async()=>{for(let o of Vt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},qt=async(o,e)=>{let t=e.querySelector(`#${Ee}`);if(!t)try{t=await C(`#${Ee}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Ee}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},zt=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Wt=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},jt=async o=>{if(o==="url"){let t=await Ut();return t?{kind:"contact-detail",target:t}:null}let e=zt();return e?{kind:"conversations",target:e}:null},Pe=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await qt(o,e.target);return t}return Wt(o,e.target),"conversations-header"},Kt=async()=>{let o=T();if(!o||!o.locationId){document.getElementById(P)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(P);if(t&&t.dataset.contactId===e.contactId){ae(t,e);return}t&&t.remove();let r=await jt(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=T();if(!n||n.contactId!==e.contactId)return;let a=Ne(e.contactId),i=await Pe(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Oe();let s=document.getElementById(P)??a;ae(s,e);let l=new MutationObserver(()=>{let d=document.getElementById(P);if(!(T()?.contactId===e.contactId)){l.disconnect();return}if(!d){let m=Ne(e.contactId);Pe(m,r).then(()=>{Oe(),ae(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});l.observe(r.target,{childList:!0})},z=null,Be=()=>{let o=T()?.contactId??null;if(z&&z.contactId===o)return;let e=Kt().finally(()=>{z?.promise===e&&(z=null)});z={contactId:o,promise:e}},Oe=()=>{let o=document.querySelectorAll(`#${P}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var M="ws-crm-claim-release-pill",Yt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Xt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Jt=async o=>{let e=await fetch(Yt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Qt=async o=>{let e=await fetch(Xt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ve=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},G=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?c.emerald:c.amber;o.dataset.mode=e,o.style.cssText=ne(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Zt=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=M,t.type="button",t.dataset.contactId=o,G(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=T();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>G(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";G(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await Qt({contactId:o,locationId:n.locationId,userId:a,action:r}),l=s?.mode==="claim"||s?.mode==="release"?s.mode:i;G(t,l),b.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(s){b.error("Claim/Release Set webhook failed",s),G(t,r);let l=t.querySelector(".ws-cr-label");if(l){let d=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=d)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Ge=async(o,e)=>{try{let t=await Jt({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(M);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";G(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},eo=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Ve(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},$e=(o,e)=>{let t=Zt({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${M}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},to=async()=>{let o=T();if(!o){document.getElementById(M)?.remove();return}let e=document.getElementById(M);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await eo(t),n=T();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}$e(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(M);a&&o.locationId&&Ge(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(T()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(M))return;let l=Ve(t);if(l){$e(l,o.contactId);let d=document.getElementById(M);d&&o.locationId&&Ge(d,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Ue=()=>{to()};var oo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",W=new Map,qe=async(o,e)=>{if(!o)return null;if(W.has(o))return W.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${oo}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),W.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return W.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),W.set(o,null),null}};var ze=o=>o==="buyer"?"buyer":"seller";var Je="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var no="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",ao=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||Je,l;if(i==="buyer"){let h=Qe.find(p=>p.label===t),m=h?h.value:t.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:t,triggered_by_user_id:r??""};n&&(h.dead_reason=n),l={contact_id:o,location:{id:e},customData:h}}let d=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!d.ok)throw new Error(`Webhook returned ${d.status} ${d.statusText}`)},so=async({contactId:o,tenantId:e})=>{let t=await fetch(no,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var $="ws-crm-contact-actions-bar",io="ws-crm-call-status-dropdown",We="ws-crm-offer-made-modal",lo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Qe=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],co=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],bo=async()=>{for(let o of co)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},ho=({contactId:o,kind:e})=>{let t=e==="buyer"?Qe:lo,r=e==="buyer"?ro:Je,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=io,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=U,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let s=document.createElement("div");return s.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,t.forEach(l=>{let d=document.createElement("button");d.type="button",d.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,d.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Te[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,d.addEventListener("mouseenter",()=>{d.style.background=c.slate}),d.addEventListener("mouseleave",()=>{d.style.background="transparent"}),d.addEventListener("click",async()=>{b.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${o}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=Te[l.color]),m&&(m.textContent=l.label),s.style.display="none";let v=T()?.locationId,f=A();if(!v){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${l.label} (no tenant!)`),m&&(m.style.color=c.amber);return}if(e==="seller"&&l.color==="green"&&!f){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${l.label} (no user!)`),m&&(m.style.color=c.amber);return}let g=p?.textContent??"\u25BE",w=async u=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await ao({contactId:o,locationId:v,status:l.label,userId:f,deadReason:u,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=g),i.style.opacity="1"},900)}catch(x){b.warn("Call Status webhook failed:",x),p&&(p.textContent="\u2717"),m&&(m.style.color=c.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=g),m&&(m.style.color=c.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let u=m?.textContent??"";mo(x=>{w(x)},()=>{m&&(m.textContent=u)});return}if(e==="seller"&&l.value==="appointment-booked"){let u=m?.textContent??"";try{(await so({contactId:o,tenantId:v})).ok?await w():_o(()=>{w()},()=>{m&&(m.textContent=u)})}catch(x){b.warn("Appointment sanity check failed; firing anyway:",x),await w()}return}await w()}),s.appendChild(d)}),i.addEventListener("click",l=>{l.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",l=>{a.contains(l.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},po=o=>{document.getElementById(We)?.remove();let e=document.createElement("div");e.id=We,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let r=new Date,n=new Date(r.getTime()+5*24*60*60*1e3).toISOString().slice(0,10);t.innerHTML=`
    ...
    <div style="
      ...
      margin-bottom: 16px;
    ">
      <span style="color: ${c.ash}; font-family: ${y.mono}; font-size: 14px;">$</span>
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Ye=(o,e)=>{let t=document.createElement("div");t.id=$,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${c.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=N,r.textContent="Offer Made",r.addEventListener("click",()=>po(o)),t.appendChild(r),t.appendChild(ho({contactId:o,kind:e})),t},Ce=!1,uo=()=>{document.querySelectorAll(`[id="${$}"]`).forEach(o=>o.remove())},Ze=async()=>{if(b.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ce){b.info("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ce=!0;try{await vo()}finally{Ce=!1}},vo=async()=>{let o=T();if(!o){b.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),uo();return}b.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let d=await qe(o.contactId,o.locationId);ze(d)==="buyer"&&(e="buyer"),b.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${d??"(null)"})`)}catch(d){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",d)}let t=T();if(!t||t.contactId!==o.contactId){b.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${$}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.info(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(d=>d.remove()));let n=await bo();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=T();if(!a||a.contactId!==o.contactId){b.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Ye(o.contactId,e)}catch(d){b.error("[actions-bar:08-FAIL] buildBar threw:",d);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(d){b.error("[actions-bar:09-FAIL] insertBefore threw:",d);return}if(!document.getElementById($)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let l=null;l=new MutationObserver(()=>{if(!(T()?.contactId===o.contactId)){l?.disconnect();return}let h=document.querySelectorAll(`[id="${$}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.info(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Ye(o.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(_){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),l.observe(n,{childList:!0})},Xe=null,yo=()=>{Xe===null&&(Xe=window.setInterval(()=>{let o=T();o&&(document.getElementById($)||(b.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Ze()))},3e3))},et=()=>{yo(),Ze()};var se="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",go=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),j="data-ws-crm-favicon",Ae=o=>o.hasAttribute(j),tt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return go.has(e)},ie=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{tt(r)&&!Ae(r)&&r.remove()});let e=document.head.querySelector(`link[${j}="1"]`);e?e.href!==se&&(e.href=se):(e=document.createElement("link"),e.setAttribute(j,"1"),e.rel="icon",e.type="image/png",e.href=se,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${j}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(j,"apple"),t.rel="apple-touch-icon",t.href=se,document.head.appendChild(t))},ot=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)ie();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),ie())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&tt(i)&&!Ae(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ae(i)&&(n=!0)});n&&ie()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,ie(),e>=5&&window.clearInterval(t)},1e3)};var fo=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],wo=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,xo=".hr-card.hr-modal.crm-opportunities-modal",R=()=>{let o=document.querySelector(xo);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(wo);if(n){let a=n[1];if(fo.includes(a))return a}}return null},le=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=R();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var ko="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",V="ws-crm-not-interested-button",To=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Eo=/\/v2\/location\/([A-Za-z0-9]+)/,de=()=>{let o=window.location.pathname,e=o.match(To);if(!e)return null;let t=o.match(Eo);return{oppId:e[1],locationId:t?t[1]:null}},So=async o=>{let e=await fetch(ko,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},rt=o=>{let e=document.createElement("button");return e.id=V,e.type="button",e.dataset.oppId=o,e.style.cssText=ne("neutral"),e.style.fontFamily=y.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
      background: ${c.crimson};
      box-shadow: 0 0 6px ${c.crimson};
      flex-shrink: 0;
    "></span>
    <span class="ws-ni-label">Mark Not Interested</span>
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=de();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await So({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=c.crimsonGlow,e.style.color=c.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Co=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ao=async()=>{for(let o of Co)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Lo=async()=>{let o=de();if(!o||!o.locationId){document.getElementById(V)?.remove();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===o.oppId){let l=R();l!==null&&l!=="Marketing Tracker"&&e.remove();return}e&&e.remove();let t=await Ao();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await le();if(r!=="Marketing Tracker"){b.info(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=de();if(!n||n.oppId!==o.oppId)return;let a=rt(o.oppId),i=document.createElement("span");i.id=`${V}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Not Interested button on opp ${o.oppId}`);let s=new MutationObserver(()=>{if(!(de()?.oppId===o.oppId)){s.disconnect();return}let d=R();if(d!==null&&d!=="Marketing Tracker"){document.getElementById(V)?.remove(),s.disconnect();return}if(!document.getElementById(V)){let m=rt(o.oppId);i.appendChild(m),b.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});s.observe(t,{childList:!0})},nt=()=>{Lo()};var st="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Y="ws-crm-send-to-title-co-button",K="ws-crm-send-to-title-co-wrap",be="ws-crm-stc-dropdown",Io=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fo=/\/v2\/location\/([A-Za-z0-9]+)/,Le=()=>{let o=window.location.pathname,e=o.match(Io);if(!e)return null;let t=o.match(Fo);return{oppId:e[1],locationId:t?t[1]:null}},Do=async(o,e)=>{try{let t=await fetch(st,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Mo=async(o,e,t)=>{let r=await fetch(st,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Ho=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease",e.style.boxShadow=`0 0 0 3px ${c.emerald}, 0 0 12px ${c.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2400)},D=()=>{document.getElementById(be)?.remove()},ce=(o,e,t)=>{D();let r=document.createElement("div");r.id=be;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${y.sans};
  `;let a=o.length,i=o.filter(_=>_.filled).length,s=i===a,l=document.createElement("div");l.innerHTML=`
    <div style="
      font-family: ${y.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
      text-transform: uppercase;
      color: ${s?c.emerald:c.amber};
      margin-bottom: 4px;
    ">${s?"Ready to send":"Required fields"}</div>
    <div style="font-size: 14px; font-weight: 500; color: ${c.bone}; margin-bottom: 6px;">${i} of ${a} ready</div>
    ${e?`<div style="
            font-size: 11px;
            color: ${c.amber};
            margin: 6px 0 4px;
  ...
  `,r.appendChild(l);let d=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...d.filter(_=>h[_]),...Object.keys(h).filter(_=>!d.includes(_))];for(let _ of m){let v=h[_],f=document.createElement("div");f.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${y.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${c.steel};
    `,g.textContent=_,f.appendChild(g),v.forEach(w=>{let u=document.createElement("div"),x=!w.filled&&w.navigable&&w.field_id;u.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${E.sm};
        font-size: 12px;
        color: ${w.filled?c.bone:c.ash};
        ${x?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,x&&(u.addEventListener("mouseenter",()=>{u.style.background=c.slate}),u.addEventListener("mouseleave",()=>{u.style.background="transparent"}),u.addEventListener("click",L=>{L.stopPropagation(),w.field_id&&(Ho(w.field_id),D())}));let S=w.filled?`<span style="color: ${c.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${c.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=x?`<span style="margin-left: auto; color: ${c.ash}; font-size: 11px;">\u2192</span>`:"";u.innerHTML=`${S}<span style="flex: 1;">${w.label}</span>${k}`,f.appendChild(u)}),r.appendChild(f)}document.body.appendChild(r);let p=_=>{let v=_.target;!r.contains(v)&&!t.contains(v)&&(D(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},F=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,s=c.bone,l,d="Send to Title Company",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",i=c.steel,s=c.ash,l=c.coolGray,d="Checking\u2026",m="wait",p="0.8";break;case"ready":a=c.emerald,i=c.emerald,s="#0a0e14",l="#0a0e14",d=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let _=e.checks?.filter(f=>f.filled).length??0,v=e.checks?.length??0;a="transparent",i=c.amber,s=c.amber,l=c.amber,d=`${_} of ${v} fields ready`,h="\u25BE";break}case"sending":a=c.emerald,i=c.emerald,s="#0a0e14",l="#0a0e14",d="Sending\u2026",m="wait",p="0.8";break;case"sent":a=c.emerald,i=c.emerald,s="#0a0e14",l="#0a0e14",d="Sent \u2713";break;case"error":a="transparent",i=c.amber,s=c.amber,l=c.amber,d=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=s,o.style.cursor=m,o.style.opacity=p,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),t&&(t.textContent=d),n&&(n.textContent=h)},at=(o,e)=>{let t=document.createElement("button");t.id=Y,t.type="button",t.dataset.oppId=o;let r={status:"checking"};t.style.cssText=`
    ${N}
    background: transparent;
    border: 1px solid ${c.steel};
    color: ${c.ash};
  ...
  `,F(t,r);let n=async()=>{if(r.status==="sending")return;let l=await Do(o,e);if(!l){r={status:"error",message:"Check failed \u2014 click to retry"},F(t,r);return}if(!Array.isArray(l.checks)||l.checks.length===0){r={status:"error",message:l.error||"Check failed \u2014 click to retry"},F(t,r),b.warn("[stc] dry_run returned no checks:",l);return}r={status:l.ok?"ready":"incomplete",checks:l.checks,previouslySentAt:l.previously_sent_at??null},F(t,r),document.getElementById(be)&&ce(l.checks,l.previously_sent_at,t)},a=async()=>{let l=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},F(t,r),D();try{let d=await Mo(o,e,l);if(d.needs_confirm){r={status:"ready",checks:d.checks,previouslySentAt:d.previously_sent_at},F(t,r),d.checks&&ce(d.checks,d.previously_sent_at,t);return}if(d.ok){r={status:"sent",checks:d.checks,previouslySentAt:new Date().toISOString()},F(t,r),window.setTimeout(()=>{n()},3500);return}r={status:"error",checks:d.checks,message:d.error||"Validation failed"},F(t,r),d.checks&&ce(d.checks,d.previously_sent_at,t)}catch(d){b.error("[stc] send failed:",d),r={status:"error",message:"Network error \u2014 click to retry"},F(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":a();break;case"incomplete":{document.getElementById(be)?D():r.checks&&ce(r.checks,r.previouslySentAt,t);break}case"error":case"sent":n();break}}),n();let i,s=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(s){let l=new MutationObserver(()=>{i!==void 0&&window.clearTimeout(i),i=window.setTimeout(()=>{r.status!=="sending"&&n()},1500)});l.observe(s,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let d=window.setInterval(()=>{document.body.contains(t)||(l.disconnect(),i!==void 0&&window.clearTimeout(i),window.clearInterval(d))},5e3)}return t},No=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Po=async()=>{for(let o of No)try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Oo=async()=>{let o=Le();if(!o||!o.locationId){document.getElementById(Y)?.remove(),document.getElementById(K)?.remove(),D();return}let e=document.getElementById(Y);if(e&&e.dataset.oppId===o.oppId){let l=R();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(K)?.remove(),D());return}e&&(e.remove(),document.getElementById(K)?.remove(),D());let t=await Po();if(!t)return;let r=await le();if(r!=="Transaction Coordination"){b.info(`[send-to-title-co] gated off \u2014 pipeline="${r}" (expected Transaction Coordination)`);return}let n=Le();if(!n||n.oppId!==o.oppId||!n.locationId)return;let a=at(o.oppId,n.locationId),i=document.createElement("span");i.id=K,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Send to Title Co button on opp ${o.oppId}`);let s=new MutationObserver(()=>{if(!(Le()?.oppId===o.oppId)){s.disconnect();return}let d=R();if(d!==null&&d!=="Transaction Coordination"){document.getElementById(Y)?.remove(),document.getElementById(K)?.remove(),D(),s.disconnect();return}if(!document.getElementById(Y)){let h=at(o.oppId,o.locationId);i.appendChild(h)}});s.observe(t,{childList:!0})},it=()=>{Oo()};var ve="reos-theme-stylesheet",kt="reos-theme-fonts",Ro=()=>{let o=document.getElementById(kt);o&&o.remove()},Bo=`
/* ============================================
...
`,Go=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],$o=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${a})`}return`rgb(${t}, ${r}, ${n})`},Vo=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Uo=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],lt=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let t=e.tagName;if(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="SCRIPT"||t==="STYLE"||t==="SVG"||t==="PATH"||t==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let i=+a[1],s=+a[2],l=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||i<230||s<230||l<230||e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)")return;e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important")}catch{}})}catch{}},X=()=>{document.querySelectorAll(Uo.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];s<230||l<230||d<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"))})})},dt=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},he=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let t=e.parentElement,r=0;for(;t&&r<6&&t!==document.body;){if(r+=1,t.id?.startsWith("ws-crm-")||t.classList.contains("hl_header")||t.classList.contains("app-header")||t.tagName==="MAIN"||t.tagName==="BODY")return;let i=window.getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let s=+i[1],l=+i[2],d=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&s>=180&&l>=180&&d>=180&&s+l+d>=600&&t.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"))}t=t.parentElement}})},ct=()=>{let o="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;(t.getAttribute("style")||"").includes(o)&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"))})},J=()=>{for(let o of Go){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let a=t.style.getPropertyPriority(r),i=t.style.getPropertyValue(r),s=Vo.has(r)?$o(n):n;a==="important"&&i===s||t.style.setProperty(r,n,"important")}})}},ye="#1A1F28",qo=26,zo=31,Wo=40,bt=new Set,ht=new Set,pe=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!ht.has(n)&&n!=="<no class>"&&(ht.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},jo=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Ko=["trash","Trash","TRASH","delete","Delete","DELETE"],Yo=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(Ko.some(a=>n.includes(a))&&(r=!0),r||t.querySelectorAll("path").forEach(i=>{if(r)return;let s=i.getAttribute("d")||"";jo.some(l=>s.includes(l))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),s=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Xo=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Jo=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||Xo.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},pt=new Set,Qo=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let l=window.getComputedStyle(e).color;if(!(l==="rgb(255, 255, 255)"||l==="rgba(255, 255, 255, 1)"||l==="#ffffff"||l==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let h=e.className?.toString()||"<no class>";!pt.has(h)&&h!=="<no class>"&&(pt.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},mt=new Set,Zo=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let i=(a.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let s=window.getComputedStyle(a),l=s.backgroundColor,d=s.backgroundImage||"",h=!1;if(d!=="none"&&d.includes("gradient"))h=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let S=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(S&&parseFloat(S[1])<.6)return;let k=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let L=parseInt(k[1],10),H=parseInt(k[2],10),fe=parseInt(k[3],10);(L>=60||H>=60||fe>=60)&&(L>230&&H>230&&fe>230||(L>=80||H>=80||fe>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),_=i,v=Array.from(a.querySelectorAll("*")).map(S=>(S.className?.toString()||"").toLowerCase()).join(" "),f=p.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),g=_.includes("bg-clip-text")||_.includes("text-transparent")||v.includes("bg-clip-text")||v.includes("text-transparent"),w=Array.from(a.querySelectorAll("*")).some(S=>{let k=window.getComputedStyle(S),L=k.getPropertyValue("-webkit-background-clip")||"",H=k.getPropertyValue("background-clip")||"";return L.includes("text")||H.includes("text")});if(f||g||w){let S=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=L=>{S.forEach(H=>L.style.removeProperty(H))};k(a),a.querySelectorAll("*").forEach(k);return}let u="#12161D";a.style.setProperty("color",u,"important"),a.querySelectorAll("*").forEach(S=>{let k=S.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(S.style.setProperty("fill",u,"important"),S.style.setProperty("stroke",u,"important"),S.style.setProperty("color",u,"important")):(S.style.setProperty("color",u,"important"),S.style.setProperty("-webkit-text-fill-color",u,"important"))});let x=a.className?.toString()||"<no class>";!mt.has(x)&&x!=="<no class>"&&(mt.add(x),b.debug(`Darkened SVG icons on colored button: "${x}"`))})})},_t=new Set,er=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(l=>{(l.getAttribute("style")||"").includes("translateY(11px)")&&l.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(l=>{let d=l;if(d.closest("[id^='ws-crm-']"))return;let h=l.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let v=h.width*h.height/(r.width*r.height);if(v>.55)return;let f=d,g=d.parentElement,w=0;for(;g&&g!==e&&w<3;){let x=g.getBoundingClientRect();if(x.width>0&&x.width<=30&&x.height<=30)f=g;else break;g=g.parentElement,w++}f.style.setProperty("transform","translateY(11px)","important");let u=(f.className?.toString()||"")+" "+f.tagName;_t.has(u)||(_t.add(u),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${v.toFixed(2)}): "${u}"`))})})},tr="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",or=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",tr,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},ut=new Set,rr=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s>200&&l>200&&d>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!ut.has(h)&&h!=="<no class>"&&(ut.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${s},${l},${d})): "${h}"`))})})},vt=new Set,nr=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=t.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let s=t.className?.toString()||"<no class>";!vt.has(s)&&s!=="<no class>"&&(vt.add(s),b.debug(`Painted Ask AI wrapper graphite: "${s}"`))}}t=t.parentElement,r++}})},yt=new Set,ar=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let i=parseInt(a.zIndex,10);if(!isFinite(i)||i<50)return;let s=n.getBoundingClientRect();s.width<240||s.height<120||s.width>1500||s.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar")||s.includes("notification-dot")||s.includes("indicator"))return;if(s.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(s.includes("tabulator")||s.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(s.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(s.includes("ai-button")||s.includes("ask-ai")||s.includes("bg-clip-text")||s.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let d=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!d)return;let h=parseInt(d[1],10),m=parseInt(d[2],10),p=parseInt(d[3],10);if(!(h>200&&m>200&&p>200))return;let v=i.getBoundingClientRect();if(v.width<24||v.height<16||v.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let f=i.className?.toString()||"<no class>";!yt.has(f)&&f!=="<no class>"&&(yt.add(f),b.debug(`Coerced light bg (${v.width.toFixed(0)}x${v.height.toFixed(0)}, rgb(${h},${m},${p})): "${f}"`))})})},gt=new Set,sr=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let u=t.getAttribute("style")||"";(u.includes("color")||u.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,a=null;for(let u=0;u<4&&n;u++){let x=n.nextElementSibling;if(x&&(x.matches(o)||x.querySelector(o)!==null)){a=x;break}n=n.parentElement}if(!a)return;let i=t.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let s=a,l=s.getBoundingClientRect(),d=s.className?.toString()||"",h=d.includes("schedule-ui-form-weekly-schedule-checkbox")||s.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=d.includes("hl-form-item")||d.includes("n-form-item--top-labelled")||s.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(d.includes("hr-form-item-blank")||d.includes("hr-form-item")||s.matches(p))&&(s.matches(p)||s.querySelector(p)!==null);_&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let v=d.includes("hr-radio")||s.closest(".hr-radio, [class*='hr-radio']")!==null;v&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let f=d.includes("hr-breadcrumb")||s.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;f&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let g=d.includes("hr-header-lite")||s.closest("[class*='hr-header-lite']")!==null;g&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius")),!h&&!m&&!_&&!v&&!f&&!g&&l.width>0&&l.width<=800&&l.height>0&&l.height<=100&&(s.style.setProperty("background-color",ye,"important"),s.style.setProperty("border-color","#252C36","important"),s.style.setProperty("border-style","solid","important"),s.style.setProperty("border-width","1px","important"),s.style.setProperty("border-radius","4px","important"));let w=t.className?.toString()||"<no class>";!gt.has(w)&&w!=="<no class>"&&(gt.add(w),b.debug(`Colored field label "${r.slice(0,30)}": "${w}"`))})},ft=new Set,ir=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let i=Math.min(r.width,r.height),s=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${s}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(d=>{d.tagName==="svg"||d.tagName==="SVG"||d.tagName!=="IMG"&&(d.style.setProperty("font-size",`${s}px`,"important"),d.style.setProperty("line-height","1","important"),d.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!ft.has(l)&&l!=="<no class>"&&(ft.add(l),b.debug(`Resized avatar text to ${s}px (circle ${i.toFixed(0)}px): "${l}"`))})},wt=new Set,lr=new Set(["Enter Dashboard Name"]),dr=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;let r=e.placeholder||"";if(lr.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",ye,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",ye,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!wt.has(a)&&a!=="<no class>"&&(wt.add(a),b.debug(`Forced input slate bg: "${a}"`))})},me=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>t.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let i=parseInt(a[1],10),s=parseInt(a[2],10),l=parseInt(a[3],10);if(!(i<qo&&s<zo&&l<Wo))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",ye,"important");let m=e.className?.toString()||"<no class>";!bt.has(m)&&m!=="<no class>"&&(bt.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${i},${s},${l})): "${m}"`))})},_e=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let s=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!s)return;let l;try{l=atob(s[1])}catch{return}let d=l,h=!1;if(e.forEach(_=>{d.includes(_)&&(d=d.split(_).join(o),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{d.includes(_)&&(d=d.split(_).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(v=>{d.includes(v)&&(d=d.split(v).join("#EDEEF0"),h=!0)}),!!h)try{let _=btoa(d);a.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let i=a.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;a.setAttribute("data-reos-masked","1");let s=`url("${i}")`;a.style.setProperty("-webkit-mask-image",s,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",s,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",t)})},ue=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},cr=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color")||t.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Q=()=>{let o=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{o(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let s=window.getComputedStyle(i).backgroundColor;s==="rgba(0, 0, 0, 0)"||s==="transparent"||!s||o(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{o(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",i="rgb(0, 191, 124)",s=d=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",d,"important"),h.style.setProperty("stroke",d,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",d,"important")})},l=!1;try{l=r.matches(":hover")}catch{}s(l?i:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>s(i)),r.addEventListener("mouseleave",()=>s(a)))})},xt=()=>{let o,e=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,ue(),J(),dr(),me(),pe(),sr(),ar(),nr(),rr(),or(),Zo(),ir(),er(),Qo(),_e(),Jo(),Yo(),Q(),X(),lt(),dt(),ct(),he(),cr(),Q()},100))};ue(),J(),me(),pe(),_e(),Q(),X(),lt(),dt(),ct(),he(),window.setTimeout(()=>{ue(),J(),me(),pe(),_e(),Q(),X(),he()},500),window.setTimeout(()=>{ue(),J(),me(),pe(),_e(),Q(),X(),he()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{X(),J()}),new MutationObserver(()=>{e()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Ie,br=()=>{let o=()=>{let t=document.getElementById(ve);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let n of t){for(let a of Array.from(n.addedNodes)){if(!(a instanceof Element))continue;let i=a.tagName.toLowerCase();if(i==="style"||i==="link"){if(a.id===ve||a.id===kt)continue;r=!0;break}}if(r)break}r&&Ie===void 0&&(Ie=window.setTimeout(()=>{Ie=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Tt=()=>{if(Ro(),!document.getElementById(ve)){let o=document.createElement("style");o.id=ve,o.textContent=Bo,document.head.appendChild(o),b.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?xt():window.addEventListener("DOMContentLoaded",xt)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,br())};var Et="ws-crm-customizer-version-badge",ge=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",ge,{once:!0});return}if(document.getElementById(Et))return;let o=document.createElement("div");o.id=Et,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${oe}`,o.title=`Built ${re}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var I=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},St=()=>{b.info(`Loaded v${oe} (built ${re})`),I("mountVersionBadge (initial)",ge),I("mountFavicon",ot),I("mountThemeStylesheet",Tt),I("initPageRouter",He),b.info("[main] registering onPageChange subscriber"),Me(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),I("mountVersionBadge",ge),I("mountClaimReleaseToggle",Ue),I("mountContactActionsBar",et),I("mountActiveFollowUpButton",Be),I("mountNotInterestedButton",nt),I("mountSendToTitleCoButton",it)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",St):St();})();
