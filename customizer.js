/* Wholesaling CRM Customizer v0.13.63 — built 2026-05-27T15:33:12.668Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var ie="[wholesaling-crm-customizer]",to="__WS_CRM_DEBUG",oo=()=>!!window[to],c={info(...o){console.log(ie,...o)},warn(...o){console.warn(ie,...o)},error(...o){console.error(ie,...o)},debug(...o){oo()&&console.log(ie,"[debug]",...o)}};var ot=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Me=/\/v2\/location\/([A-Za-z0-9]+)/,ro=o=>{let e=o.match(ot);if(!e)return null;let t=o.match(Me);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},no=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ot);if(!n)continue;let a=r.match(Me)||window.location.pathname.match(Me);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=ro(window.location.pathname);return o||no()};var rt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},de="",He=null,U="other",Pe=new Set,le=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==de)&&!(o!==He))){de=window.location.pathname,He=o,U=rt(),c.debug("Page/context changed:",U,de,"contact:",o);for(let r of Pe)try{r(U)}catch(n){c.error("Subscriber threw:",n)}}},nt=o=>(Pe.add(o),setTimeout(()=>o(U),0),()=>{Pe.delete(o)}),at=()=>{U=rt(),de=window.location.pathname,He=S()?.contactId??null,c.debug("Router init, current page:",U);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),le()},history.replaceState=function(t,r,n){e(t,r,n),le()},window.addEventListener("popstate",le),setInterval(le,1e3)};var ce="0.13.63",be="2026-05-27T15:33:12.669Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let i=n.querySelector(o);if(i){a(i);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},T={sm:"4px",md:"6px",lg:"10px",pill:"999px"},g={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ne={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},R=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,j=`
  ...
  flex-shrink: 0;
`;var ao=/^[A-Za-z0-9]{15,30}$/,K=o=>typeof o=="string"&&ao.test(o),so=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},io=()=>{let o=window.WS_CRM_USER_ID;return K(o)?o:null},lo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(K(t))return t;return null},co=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=so(e);if(!t)return null;let r=t.uid;if(K(r))return r;let n=t.claims;if(n&&K(n.user_id))return n.user_id}catch{}return null},bo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(K(n))return n}catch{}}}catch{}return null},A=()=>io()||lo()||co()||bo()||null;var dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ho=`${dt}/active-follow-up-get`,po=`${dt}/active-follow-up-set`,G="ws-crm-active-follow-up-button",Re={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},mo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},_o=async o=>{let e=await fetch(ho,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},uo=async(o,e)=>{let t=await fetch(po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},$=(o,e)=>{let t=Re[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},st=o=>{let e=document.createElement("button");return e.type="button",e.id=G,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,$(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=mo();if(!(!r||r.contactId!==o)){$(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await uo(r,A()),a=n&&n.state&&n.state in Re?n.state:"blue";$(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),$(e,"error"),setTimeout(()=>void he(e,r),4e3)}}}),e},he=async(o,e)=>{$(o,"loading");try{let t=await _o(e),r=t&&t.state&&t.state in Re?t.state:"gray",n=document.getElementById(G);if(!n||n.dataset.contactId!==e.contactId)return;$(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),$(o,"error")}},vo=[".central-panel","[class*='central-panel']"],Oe="ws-crm-contact-actions-bar",yo=async()=>{for(let o of vo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},go=async(o,e)=>{let t=e.querySelector(`#${Oe}`);if(!t)try{t=await C(`#${Oe}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Oe}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},fo=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},wo=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},xo=async o=>{if(o==="url"){let t=await yo();return t?{kind:"contact-detail",target:t}:null}let e=fo();return e?{kind:"conversations",target:e}:null},it=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await go(o,e.target);return t}return wo(o,e.target),"conversations-header"},ko=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(G)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(G);if(t&&t.dataset.contactId===e.contactId){he(t,e);return}t&&t.remove();let r=await xo(o.source);if(!r){c.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=st(e.contactId),s=await it(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),lt();let i=document.getElementById(G)??a;he(i,e);let d=new MutationObserver(()=>{let b=document.getElementById(G);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=st(e.contactId);it(m,r).then(()=>{lt(),he(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Y=null,ct=()=>{let o=S()?.contactId??null;if(Y&&Y.contactId===o)return;let e=ko().finally(()=>{Y?.promise===e&&(Y=null)});Y={contactId:o,promise:e}},lt=()=>{let o=document.querySelectorAll(`#${G}`);if(!(o.length<=1)){c.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var N="ws-crm-claim-release-pill",Eo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",To="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",So=async o=>{let e=await fetch(Eo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Co=async o=>{let e=await fetch(To,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},pt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},q=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=R(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Ao=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=N,t.type="button",t.dataset.contactId=o,q(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let i=t.querySelector(".ws-cr-label");i&&(i.textContent="Sign-in needed"),setTimeout(()=>q(t,r),2500);return}c.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let s=r==="claim"?"release":"claim";q(t,s),t.disabled=!0,t.style.opacity="0.8";try{let i=await Co({contactId:o,locationId:n.locationId,userId:a,action:r}),d=i?.mode==="claim"||i?.mode==="release"?i.mode:s;q(t,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(i){c.error("Claim/Release Set webhook failed",i),q(t,r);let d=t.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},bt=async(o,e)=>{try{let t=await So({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(N);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";q(r,n)}catch(t){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Io=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=pt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},ht=(o,e)=>{let t=Ao({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${N}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},Lo=async()=>{let o=S();if(!o){document.getElementById(N)?.remove();return}let e=document.getElementById(N);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Io(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ht(r,o.contactId),c.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(N);a&&o.locationId&&bt(a,{contactId:o.contactId,locationId:o.locationId});let s=null;s=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(N))return;let d=pt(t);if(d){ht(d,o.contactId);let b=document.getElementById(N);b&&o.locationId&&bt(b,{contactId:o.contactId,locationId:o.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(t,{childList:!0,subtree:!0})}catch(t){c.warn("Could not mount Claim/Release pill:",t)}}},mt=()=>{Lo()};var Fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",X=new Map,_t=async(o,e)=>{if(!o)return null;if(X.has(o))return X.get(o)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${Fo}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${o}`),X.set(o,null),null;let i=((await a.json()).contact_type||"").toLowerCase().trim()||null;return X.set(o,i),c.debug(`Resolved Contact Type for ${o}: ${i??"(unset)"}`),i}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${o}:`,n),X.set(o,null),null}};var ut=o=>o==="buyer"?"buyer":"seller";var xt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Do="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Mo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ho=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:s})=>{let i=a||xt,d;if(s==="buyer"){let p=kt.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let b=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},Po=async({contactId:o,tenantId:e})=>{let t=await fetch(Mo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var z="ws-crm-contact-actions-bar",No="ws-crm-call-status-dropdown",vt="ws-crm-offer-made-modal",Oo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],kt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Ro=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Bo=async()=>{for(let o of Ro)try{let e=await C(o,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Go=({contactId:o,kind:e})=>{let t=e==="buyer"?kt:Oo,r=e==="buyer"?Do:xt,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=No,a.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=j,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=l.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=s.firstElementChild,m=s.children[1],h=s.children[2];p&&(p.style.background=Ne[d.color]),m&&(m.textContent=d.label),i.style.display="none";let w=S()?.locationId,v=A();if(!w){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!v){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let _=h?.textContent??"\u25BE",f=async y=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await Ho({contactId:o,locationId:w,status:d.label,userId:v,deadReason:y,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=_),s.style.opacity="1"},900)}catch(x){c.warn("Call Status webhook failed:",x),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=_),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Vo(x=>{f(x)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await Po({contactId:o,tenantId:w})).ok?await f():Uo(()=>{f()},()=>{m&&(m.textContent=y)})}catch(x){c.warn("Appointment sanity check failed; firing anyway:",x),await f()}return}await f()}),i.appendChild(b)}),s.addEventListener("click",d=>{d.stopPropagation(),i.style.display=i.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(i.style.display="none")}),a.appendChild(s),a.appendChild(i),a},$o=o=>{document.getElementById(vt)?.remove();let e=document.createElement("div");e.id=vt,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let a=()=>e.remove();e.addEventListener("click",s=>{s.target===e&&a()}),t.querySelector("#ws-offer-cancel")?.addEventListener("click",a),t.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let s=(t.querySelector("#ws-offer-amount")?.value??"").trim(),i=t.querySelector("#ws-offer-expires")?.value??"";if(!s||Number(s)<=0){c.warn("Offer Made submit blocked \u2014 invalid amount");return}c.info(`Offer Made recorded for contact ${o}: $${s}, expires ${i}`),a()}),setTimeout(()=>{t.querySelector("#ws-offer-amount")?.focus()},0)},yt="ws-crm-dead-deal-modal",Vo=(o,e)=>{document.getElementById(yt)?.remove();let t=document.createElement("div");t.id=yt,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",i=>{i.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=i=>{i.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},ft=(o,e)=>{let t=document.createElement("div");t.id=z,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=B,r.textContent="Offer Made",r.addEventListener("click",()=>$o(o)),t.appendChild(r),t.appendChild(Go({contactId:o,kind:e})),t},Be=!1,qo=()=>{document.querySelectorAll(`[id="${z}"]`).forEach(o=>o.remove())},Et=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Be){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Be=!0;try{await zo()}finally{Be=!1}},zo=async()=>{let o=S();if(!o){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),qo();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let b=await _t(o.contactId,o.locationId);ut(b)==="buyer"&&(e="buyer"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let t=S();if(!t||t.contactId!==o.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${z}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await Bo();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ft(o.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(z)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${z}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=ft(o.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},wt=null,Wo=()=>{wt===null&&(wt=window.setInterval(()=>{let o=S();o&&(document.getElementById(z)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Et()))},3e3))},Tt=()=>{Wo(),Et()};var pe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",jo=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),J="data-ws-crm-favicon",Ge=o=>o.hasAttribute(J),St=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return jo.has(e)},me=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{St(r)&&!Ge(r)&&r.remove()});let e=document.head.querySelector(`link[${J}="1"]`);e?e.href!==pe&&(e.href=pe):(e=document.createElement("link"),e.setAttribute(J,"1"),e.rel="icon",e.type="image/png",e.href=pe,document.head.appendChild(e),c.debug("Favicon installed"));let t=document.head.querySelector(`link[${J}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(J,"apple"),t.rel="apple-touch-icon",t.href=pe,document.head.appendChild(t))},Ct=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)me();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),me())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&St(s)&&!Ge(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ge(s)&&(n=!0)});n&&me()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,me(),e>=5&&window.clearInterval(t)},1e3)};var Ko=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Yo=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Xo=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let o=document.querySelector(Xo);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Yo);if(n){let a=n[1];if(Ko.includes(a))return a}}return null},_e=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=M();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Jo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",L="ws-crm-not-interested-button",Qo=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zo=/\/v2\/location\/([A-Za-z0-9]+)/,ve=()=>{let o=window.location.pathname,e=o.match(Qo);if(!e)return null;let t=o.match(Zo);return{oppId:e[1],locationId:t?t[1]:null}},er=async o=>{let e=await fetch(Jo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},tr=o=>{let e=document.createElement("button");return e.id=L,e.type="button",e.dataset.oppId=o,e.style.cssText=R("neutral"),e.style.fontFamily=g.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=ve();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await er({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,c.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},or=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rr=async()=>{for(let o of or)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ue=!1,qe=async()=>{if(!ue){ue=!0;try{await nr()}finally{ue=!1}}},nr=async()=>{let o=ve();if(!o||!o.locationId){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),Z();return}let e=document.getElementById(L);if(e&&e.dataset.oppId===o.oppId){let i=M();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove(),Z());return}e&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove());let t=await rr();if(!t){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await _e();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=ve();if(!n||n.oppId!==o.oppId)return;let a=tr(o.oppId),s=document.createElement("span");s.id=`${L}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),c.debug(`Mounted Not Interested button on opp ${o.oppId}`),ar(o.oppId)},Q=null,Ue=null,Z=()=>{Q?.disconnect(),Q=null,Ue=null},ar=o=>{if(Q&&Ue===o)return;Z();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ue=o,Q=new MutationObserver(()=>{let t=ve();if(!t||t.oppId!==o){Z();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),Z();return}document.getElementById(L)||qe()}),Q.observe(e,{childList:!0,subtree:!0}))},$e=null,Ve,sr=()=>{$e||($e=new MutationObserver(()=>{Ve===void 0&&(Ve=window.setTimeout(()=>{Ve=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(L);o&&!e&&!ue&&qe()},300))}),$e.observe(document.body,{childList:!0,subtree:!0}))},At=()=>{sr(),qe()};var ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",F="ws-crm-reduce-price-button",It="ws-crm-reduce-price-modal",lr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dr=/\/v2\/location\/([A-Za-z0-9]+)/,fe=()=>{let o=window.location.pathname,e=o.match(lr);if(!e)return null;let t=o.match(dr);return{oppId:e[1],locationId:t?t[1]:null}},cr=async o=>{let e=await fetch(ir,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ye=()=>{document.getElementById(It)?.remove()},br=o=>{ye();let e=document.createElement("div");e.id=It,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),s=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let b=r.value.replace(/[^0-9.]/g,"").split(".");r.value=b[0]+(b.length>1?"."+b.slice(1).join(""):"")});let i=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",i),e.addEventListener("click",d=>{d.target===e&&ye()}),a?.addEventListener("click",()=>{ye()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let b=parseFloat(d);if(!Number.isFinite(b)||b<=0){n.textContent="Price must be a positive number.",r.focus();return}if(b<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(b*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await cr({oppId:o.oppId,locationId:o.locationId,newPrice:b,userId:A()}),ye(),o.onSuccess()}catch(p){c.error("Reduce Price webhook failed",p),n.textContent=p instanceof Error?p.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},hr=(o,e)=>{let t=document.createElement("button");return t.id=F,t.type="button",t.dataset.oppId=o,t.style.cssText=R("amber"),t.style.fontFamily=g.sans,t.style.fontSize="12px",t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=fe();!r||!r.locationId||r.oppId!==o||br({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label");n&&(n.textContent="Reduced + blasted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,setTimeout(()=>{n&&n.textContent==="Reduced + blasted"&&(n.textContent="Reduce Price",t.style.cssText=R("amber"),t.style.fontFamily=g.sans,t.style.fontSize="12px")},4e3)}})}),t},pr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],mr=async()=>{for(let o of pr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ge=!1,Ke=async()=>{if(!ge){ge=!0;try{await _r()}finally{ge=!1}}},_r=async()=>{let o=fe();if(!o||!o.locationId){document.getElementById(F)?.remove(),document.getElementById(`${F}-wrap`)?.remove(),te();return}let e=document.getElementById(F);if(e&&e.dataset.oppId===o.oppId){let i=M();i!==null&&i!=="Disposition"&&(e.remove(),document.getElementById(`${F}-wrap`)?.remove(),te());return}e&&(e.remove(),document.getElementById(`${F}-wrap`)?.remove());let t=await mr();if(!t){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await _e();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=fe();if(!n||n.oppId!==o.oppId)return;let a=hr(o.oppId,o.locationId),s=document.createElement("span");s.id=`${F}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 8px;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),c.debug(`Mounted Reduce Price button on opp ${o.oppId}`),ur(o.oppId)},ee=null,je=null,te=()=>{ee?.disconnect(),ee=null,je=null},ur=o=>{if(ee&&je===o)return;te();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(je=o,ee=new MutationObserver(()=>{let t=fe();if(!t||t.oppId!==o){te();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(F)?.remove(),document.getElementById(`${F}-wrap`)?.remove(),te();return}document.getElementById(F)||Ke()}),ee.observe(e,{childList:!0,subtree:!0}))},ze=null,We,vr=()=>{ze||(ze=new MutationObserver(()=>{We===void 0&&(We=window.setTimeout(()=>{We=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(F);o&&!e&&!ge&&Ke()},300))}),ze.observe(document.body,{childList:!0,subtree:!0}))},Lt=()=>{vr(),Ke()};var Dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",V="ws-crm-send-to-title-co-button",W="ws-crm-send-to-title-co-wrap",ke="ws-crm-stc-dropdown",yr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gr=/\/v2\/location\/([A-Za-z0-9]+)/,Je=()=>{let o=window.location.pathname,e=o.match(yr);if(!e)return null;let t=o.match(gr);return{oppId:e[1],locationId:t?t[1]:null}},fr=async(o,e)=>{try{let t=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(c.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return c.warn("[stc] dry_run fetch failed:",t),null}},wr=async(o,e,t)=>{let r=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},xr=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${o}"`),!1},Ft=o=>{let e=document.getElementById(o);if(!e){c.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},kr=(o,e)=>{if(e&&xr(e)){window.setTimeout(()=>Ft(o),300);return}Ft(o)},P=()=>{document.getElementById(ke)?.remove()},we=(o,e,t)=>{P();let r=document.createElement("div");r.id=ke;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(u=>{p[u.group]||(p[u.group]=[]),p[u.group].push(u)});let m=[...b.filter(u=>p[u]),...Object.keys(p).filter(u=>!b.includes(u))];for(let u of m){let w=p[u],v=document.createElement("div");v.style.cssText="margin-top: 12px;";let _=document.createElement("div");_.style.cssText=`
      font-family: ${g.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${l.steel};
    `,_.textContent=u,v.appendChild(_),w.forEach(f=>{let y=document.createElement("div"),x=!f.filled&&f.navigable&&f.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${T.sm};
        font-size: 12px;
        color: ${f.filled?l.bone:l.ash};
        ${x?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,x&&(y.addEventListener("mouseenter",()=>{y.style.background=l.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",I=>{I.stopPropagation(),f.field_id&&(kr(f.field_id,f.folder),P())}));let k=f.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=x?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${k}<span style="flex: 1;">${f.label}</span>${E}`,v.appendChild(y)}),r.appendChild(v)}document.body.appendChild(r);let h=u=>{let w=u.target;!r.contains(w)&&!t.contains(w)&&(P(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},H=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,s,i=l.bone,d,b="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",s=l.steel,i=l.ash,d=l.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":a=l.emerald,s=l.emerald,i="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(v=>v.filled).length??0,w=e.checks?.length??0;a="transparent",s=l.amber,i=l.amber,d=l.amber,b=`${u} of ${w} fields ready`,p="\u25BE";break}case"sending":a=l.emerald,s=l.emerald,i="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":a=l.emerald,s=l.emerald,i="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",s=l.amber,i=l.amber,d=l.amber,b=e.message??"Try again";break}o.style.background=a,o.style.borderColor=s,o.style.color=i,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=b),n&&(n.textContent=p)},Er=(o,e)=>{let t=document.createElement("button");t.id=V,t.type="button",t.dataset.oppId=o;let r={status:"checking"};t.style.cssText=`
    ${B}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,H(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let v=await fr(o,e);if(!v){r={status:"error",message:"Check failed \u2014 click to retry"},H(t,r);return}if(v.rate_limited){h=Date.now()+m,r={status:"error",checks:r.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},H(t,r),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(h).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){r={status:"error",message:v.error||"Check failed \u2014 click to retry"},H(t,r),c.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),P(),re();return}let f=v.checks;if(r.checks&&r.checks.length===v.checks.length){let x=new Set;f=v.checks.map((k,E)=>r.checks[E]?.filled&&!k.filled?n.has(k.label)?k:(x.add(k.label),{...k,filled:!0}):k),n=x}else n=new Set;r={status:f.every(x=>x.filled)?"ready":"incomplete",checks:f,previouslySentAt:v.previously_sent_at??null},H(t,r),document.getElementById(ke)&&we(f,v.previously_sent_at,t)},s=async()=>{let v=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},H(t,r),P();try{let _=await wr(o,e,v);if(_.needs_confirm){r={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},H(t,r),_.checks&&we(_.checks,_.previously_sent_at,t);return}if(_.ok){r={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},H(t,r),window.setTimeout(()=>{u()},3500);return}r={status:"error",checks:_.checks,message:_.error||"Validation failed"},H(t,r),_.checks&&we(_.checks,_.previously_sent_at,t)}catch(_){c.error("[stc] send failed:",_),r={status:"error",message:"Network error \u2014 click to retry"},H(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(ke)?P():r.checks&&we(r.checks,r.previouslySentAt,t);break}case"error":case"sent":u();break}});let i,d=!1,b=Date.now(),p=1e4,m=5*60*1e3,h=0,u=async()=>{if(!d){if(Date.now()<h){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(h).toLocaleTimeString()}`);return}d=!0,b=Date.now();try{await a()}finally{d=!1}}};u();let w=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(w){let v=new MutationObserver(()=>{if(i!==void 0||d)return;let f=Date.now()-b,y=Math.max(1500,p-f);i=window.setTimeout(()=>{i=void 0,r.status!=="sending"&&u()},y)});v.observe(w,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),i!==void 0&&window.clearTimeout(i),window.clearInterval(_))},5e3)}return t},Tr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sr=async()=>{for(let o of Tr)try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},xe=!1,Ze=async()=>{if(xe){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}xe=!0;try{await Cr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{xe=!1}},Cr=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let o=Je();if(!o||!o.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),P();return}c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(V);if(e&&e.dataset.oppId===o.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let s=M();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(W)?.remove(),P(),re());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(W)?.remove(),P()),c.debug("[stc] mount:04 calling findMountTarget");let t=await Sr();if(!t){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=Je();if(!r||r.oppId!==o.oppId||!r.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${r?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let n=Er(o.oppId,r.locationId),a=document.createElement("span");a.id=W,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(n),t.appendChild(a),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(n)}`),Ar(o.oppId)},oe=null,Qe=null,re=()=>{oe?.disconnect(),oe=null,Qe=null},Ar=o=>{if(oe&&Qe===o)return;re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qe=o,oe=new MutationObserver(()=>{let t=Je();if(!t||t.oppId!==o){re();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),P(),re();return}document.getElementById(V)||Ze()}),oe.observe(e,{childList:!0,subtree:!0}))},Ye=null,Xe,Ir=()=>{Ye||(Ye=new MutationObserver(()=>{Xe===void 0&&(Xe=window.setTimeout(()=>{Xe=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);o&&!e&&!xe&&Ze()},300))}),Ye.observe(document.body,{childList:!0,subtree:!0}))},Mt=()=>{Ir(),Ze()};var Ie="reos-theme-stylesheet",Jt="reos-theme-fonts",Lr=()=>{let o=document.getElementById(Jt);o&&o.remove()},Fr=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var D=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},eo=()=>{c.info(`Loaded v${ce} (built ${be})`),D("mountVersionBadge (initial)",Fe),D("mountFavicon",Ct),D("mountThemeStylesheet",Qt),D("initPageRouter",at),c.info("[main] registering onPageChange subscriber"),nt(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),D("mountVersionBadge",Fe),D("mountClaimReleaseToggle",mt),D("mountContactActionsBar",Tt),D("mountActiveFollowUpButton",ct),D("mountNotInterestedButton",At),D("mountReducePriceButton",Lt),D("mountSendToTitleCoButton",Mt)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",eo):eo();})();
