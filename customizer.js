...
/* Data rows \u2014 graphite, bone text. Odd/even both same so we don't
   get zebra striping (Tim's canon prefers uniform graphite). No
   inter-row grid lines: the steel bottom border on the row + cell is
   removed for a clean, borderless list (Tim's request). */
