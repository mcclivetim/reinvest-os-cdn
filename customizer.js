/* Wholesaling CRM Customizer v0.5.13 — built 2026-05-16T04:08:20.791Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var w="[wholesaling-crm-customizer]",te="__WS_CRM_DEBUG",oe=()=>!!window[te],l={info(...e){console.log(w,...e)},warn(...e){console.warn(w,...e)},error(...e){console.error(w,...e)},debug(...e){oe()&&console.log(w,"[debug]",...e)}};var F=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},E="",y="other",M=new Set,k=()=>{if(window.location.pathname!==E){E=window.location.pathname,y=F(),l.debug("Page changed:",y,E);for(let e of M)try{e(y)}catch(o){l.error("Subscriber threw:",o)}}},R=e=>(M.add(e),setTimeout(()=>e(y),0),()=>{M.delete(e)}),B=()=>{y=F(),E=window.location.pathname,l.debug("Router init, current page:",y);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),k()},history.replaceState=function(t,r,a){o(t,r,a),k()},window.addEventListener("popstate",k),setInterval(k,1e3)};var _="0.5.13",C="2026-05-16T04:08:20.792Z";var re=/\/contacts\/detail\/([A-Za-z0-9]+)/,ae=/\/v2\/location\/([A-Za-z0-9]+)/,m=()=>{let e=window.location.pathname,o=e.match(re);if(!o)return null;let t=e.match(ae);return{contactId:o[1],locationId:t?t[1]:null}};var v=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,c)=>{let i=a.querySelector(e);if(i){n(i);return}let d,p,g=()=>{f&&f.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},f=new MutationObserver(()=>{let h=a.querySelector(e);h&&(g(),n(h))});f.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(e);h&&(g(),n(h))},r),d=window.setTimeout(()=>{g(),l.warn(`waitForElement timed out for selector: ${e}`),c(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},b={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},D={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},O=e=>{let o=e==="emerald"?s.emeraldGlow:e==="amber"?s.amberGlow:s.slate,t=e==="emerald"?s.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=e==="emerald"?s.emerald:e==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var x="ws-crm-claim-release-pill",N=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ne=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=x,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?s.emerald:s.amber;return t.style.cssText=O(r),t.innerHTML=`
  ...
  `,ue.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=s.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{l.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let c=t.firstElementChild,i=t.children[1],d=t.children[2];c&&(c.style.background=D[a.color]),i&&(i.textContent=a.label),r.style.display="none";let g=m()?.locationId,f=ce();if(!g){l.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),i&&(i.textContent=`${a.label} (no tenant!)`),i&&(i.style.color=s.amber);return}if(a.color==="green"&&!f){l.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),i&&(i.textContent=`${a.label} (no user!)`),i&&(i.style.color=s.amber);return}let h=d?.textContent??"\u25BE";d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await de({contactId:e,locationId:g,status:a.label,userId:f}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=h),t.style.opacity="1"},900)}catch(ee){l.warn("Call Status webhook failed:",ee),d&&(d.textContent="\u2717"),i&&(i.style.color=s.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=h),i&&(i.style.color=s.bone)},1800)}}),r.appendChild(n)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{o.contains(a.target)||(r.style.display="none")}),o.appendChild(t),o.appendChild(r),o},ge=e=>{document.getElementById(G)?.remove();let o=document.createElement("div");o.id=G,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(t),document.body.appendChild(o);let n=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&n()}),t.querySelector("#ws-offer-cancel")?.addEventListener("click",n),t.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let c=(t.querySelector("#ws-offer-amount")?.value??"").trim(),i=t.querySelector("#ws-offer-expires")?.value??"";if(!c||Number(c)<=0){l.warn("Offer Made submit blocked \u2014 invalid amount");return}l.info(`Offer Made recorded for contact ${e}: $${c}, expires ${i}`),n()}),setTimeout(()=>{t.querySelector("#ws-offer-amount")?.focus()},0)},z=e=>{let o=document.createElement("div");o.id=S,o.dataset.contactId=e,o.style.cssText=`
    ...
    flex-shrink: 0;
  `,o.appendChild(he(e));let t=document.createElement("button");return t.type="button",t.style.cssText=$,t.textContent="Offer Made",t.addEventListener("click",()=>ge(e)),o.appendChild(t),o},fe=async()=>{let e=m();if(!e){document.getElementById(S)?.remove();return}let o=document.getElementById(S);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove();let t=await be();if(!t){l.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=m();if(!r||r.contactId!==e.contactId)return;let a=z(e.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),l.debug(`Mounted contact actions bar for ${e.contactId}`);let n=null;n=new MutationObserver(()=>{let c=document.getElementById(S);if(!(m()?.contactId===e.contactId)){n?.disconnect();return}if(!c){let d=z(e.contactId);d.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),l.debug(`Re-mounted actions bar after React wipe for ${e.contactId}`)}}),n.observe(t,{childList:!0})},U=()=>{fe()};var W="reos-theme-stylesheet",q="reos-theme-fonts",ye=()=>{if(document.getElementById(q))return;let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.googleapis.com",document.head.appendChild(e);let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.gstatic.com",o.crossOrigin="anonymous",document.head.appendChild(o);let t=document.createElement("link");t.id=q,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},ve=`
/* ============================================
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var Q=()=>{l.info(`Loaded v${_} (built ${C})`),K(),B(),R(e=>{l.debug("Page handler firing for:",e),X(),P(),U()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Q):Q();})();
