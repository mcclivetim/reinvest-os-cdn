/* Wholesaling CRM Customizer v0.14.4 — built 2026-05-30T02:07:58.934Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var we="[wholesaling-crm-customizer]",sr="__WS_CRM_DEBUG",ir=()=>!!window[sr],b={info(...o){console.log(we,...o)},warn(...o){console.warn(we,...o)},error(...o){console.error(we,...o)},debug(...o){ir()&&console.log(we,"[debug]",...o)}};var $t=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,tt=/\/v2\/location\/([A-Za-z0-9]+)/,lr=o=>{let e=o.match($t);if(!e)return null;let t=o.match(tt);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},dr=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match($t);if(!n)continue;let s=r.match(tt)||window.location.pathname.match(tt);return{contactId:n[1],locationId:s?s[1]:null,source:"dom"}}return null},S=()=>{let o=lr(window.location.pathname);return o||dr()};var Rt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ke="",ot=null,Y="other",rt=new Set,xe=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ke)&&!(o!==ot))){ke=window.location.pathname,ot=o,Y=Rt(),b.debug("Page/context changed:",Y,ke,"contact:",o);for(let r of rt)try{r(Y)}catch(n){b.error("Subscriber threw:",n)}}},Gt=o=>(rt.add(o),setTimeout(()=>o(Y),0),()=>{rt.delete(o)}),Ut=()=>{Y=Rt(),ke=window.location.pathname,ot=S()?.contactId??null,b.debug("Router init, current page:",Y);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),xe()},history.replaceState=function(t,r,n){e(t,r,n),xe()},window.addEventListener("popstate",xe),setInterval(xe,1e3)};var Ee="0.14.4",Te="2026-05-30T02:07:58.936Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((s,a)=>{let l=n.querySelector(o);if(l){s(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),s(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),s(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),a(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},w={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},nt={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},qt=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,A=`
  ...
  flex-shrink: 0;
`;var cr=/^[A-Za-z0-9]{15,30}$/,ee=o=>typeof o=="string"&&cr.test(o),br=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},hr=()=>{let o=window.WS_CRM_USER_ID;return ee(o)?o:null},pr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(ee(t))return t;return null},mr=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=br(e);if(!t)return null;let r=t.uid;if(ee(r))return r;let n=t.claims;if(n&&ee(n.user_id))return n.user_id}catch{}return null},ur=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(ee(n))return n}catch{}}}catch{}return null},I=()=>hr()||pr()||mr()||ur()||null;var jt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",_r=`${jt}/active-follow-up-get`,vr=`${jt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",st={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},yr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},gr=async o=>{let e=await fetch(_r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},fr=async(o,e)=>{let t=await fetch(vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=st[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},zt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,W(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=yr();if(!(!r||r.contactId!==o)){W(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await fr(r,I()),s=n&&n.state&&n.state in st?n.state:"blue";W(e,s),b.info(`Active Follow Up set for ${o} \u2192 ${s}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),W(e,"error"),setTimeout(()=>void Se(e,r),4e3)}}}),e},Se=async(o,e)=>{W(o,"loading");try{let t=await gr(e),r=t&&t.state&&t.state in st?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;W(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),W(o,"error")}},wr=[".central-panel","[class*='central-panel']"],at="ws-crm-contact-actions-bar",xr=async()=>{for(let o of wr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},kr=async(o,e)=>{let t=e.querySelector(`#${at}`);if(!t)try{t=await C(`#${at}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${at}`);s&&s.parentElement===e?e.insertBefore(n,s.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Er=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},Tr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Sr=async o=>{if(o==="url"){let t=await xr();return t?{kind:"contact-detail",target:t}:null}let e=Er();return e?{kind:"conversations",target:e}:null},Vt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await kr(o,e.target);return t}return Tr(o,e.target),"conversations-header"},Cr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(V)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(V);if(t&&t.dataset.contactId===e.contactId){Se(t,e);return}t&&t.remove();let r=await Sr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let s=zt(e.contactId),a=await Vt(s,r);b.debug(`Active Follow Up mounted (${r.kind}/${a}) for ${e.contactId}`),Wt();let l=document.getElementById(V)??s;Se(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(V);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=zt(e.contactId);Vt(m,r).then(()=>{Wt(),Se(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},te=null,Kt=()=>{let o=S()?.contactId??null;if(te&&te.contactId===o)return;let e=Cr().finally(()=>{te?.promise===e&&(te=null)});te={contactId:o,promise:e}},Wt=()=>{let o=document.querySelectorAll(`#${V}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",Ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Lr=async o=>{let e=await fetch(Ir,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Fr=async o=>{let e=await fetch(Ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Jt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},X=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?i.emerald:i.amber;o.dataset.mode=e,o.style.cssText=qt(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${nt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=i.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let h=a.firstElementChild,m=a.children[1],p=a.children[2];h&&(h.style.background=nt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let g=S()?.locationId,x=I();if(!g){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=i.amber);return}if(e==="seller"&&d.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=i.amber);return}let y=p?.textContent??"\u25BE",_=async f=>{p&&(p.textContent="\u2026"),a.style.opacity="0.75";try{await Br({contactId:o,locationId:g,status:d.label,userId:x,deadReason:f,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=y),a.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=i.amber),a.style.opacity="1",setTimeout(()=>{p&&(p.textContent=y),m&&(m.style.color=i.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";Kr(E=>{_(E)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await $r({contactId:o,tenantId:g})).ok?await _():Yr(()=>{_()},()=>{m&&(m.textContent=f)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await _()}return}await _()}),l.appendChild(c)}),a.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{s.contains(d.target)||(l.style.display="none")}),s.appendChild(a),s.appendChild(l),s},Vr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Wr=async o=>{let e=await fetch(Vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},jr=(o,e="seller")=>{document.getElementById(to)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",s=t?i.emerald:i.amber,a=document.createElement("div");a.id=to,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,a.appendChild(l),document.body.appendChild(a);let m=()=>a.remove();a.addEventListener("click",x=>{x.target===a&&m()});let p=l.querySelector("#ws-offer-error"),v=l.querySelector("#ws-offer-cancel"),g=l.querySelector("#ws-offer-submit");v?.addEventListener("click",m),g?.addEventListener("click",async()=>{let x=(l.querySelector("#ws-offer-amount")?.value??"").trim(),y=t?l.querySelector("#ws-offer-expires")?.value??"":"";if(!x||Number(x)<=0){p&&(p.textContent="Enter a positive offer amount."),b.warn("Offer Made submit blocked \u2014 invalid amount");return}let _=Number(x);if(_<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(_*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),g&&(g.disabled=!0,g.textContent="Recording\u2026",g.style.opacity="0.7"),v&&(v.disabled=!0);try{let k=await Wr({tenantId:T,contactId:o,kind:e,amount:_,expiresAt:y||null,userId:I()});if(!k.ok){p&&(p.textContent=k.error??"Something went wrong."),g&&(g.disabled=!1,g.textContent="Record Offer",g.style.opacity="1"),v&&(v.disabled=!1);return}b.info(`Offer Made (${e}) recorded for contact ${o}: $${_} on ${k.opp_pipeline} opp (stage: ${k.opp_stage_name??"?"})`),m()}catch(k){b.error("Offer Made webhook failed",k),p&&(p.textContent=k instanceof Error?k.message:"Network error \u2014 try again."),g&&(g.disabled=!1,g.textContent="Record Offer",g.style.opacity="1"),v&&(v.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},oo="ws-crm-dead-deal-modal",Kr=(o,e)=>{document.getElementById(oo)?.remove();let t=document.createElement("div");t.id=oo,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),s=()=>{n(),e()};t.addEventListener("click",l=>{l.target===t&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let a=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",a),s())};document.addEventListener("keydown",a)},no=(o,e)=>{let t=document.createElement("div");if(t.id=J,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${i.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=$,r.textContent="Offer Made",r.addEventListener("click",()=>jr(o,e)),t.appendChild(r),t.appendChild(zr({contactId:o,kind:e}))}return t},it=!1,Xr=()=>{document.querySelectorAll(`[id="${J}"]`).forEach(o=>o.remove())},lo=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),it){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}it=!0;try{await Jr()}finally{it=!1}},Jr=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Xr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Qt(o.contactId,o.locationId),h=eo(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${J}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await qr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let s=S();if(!s||s.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let a;try{a=no(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}a.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(a,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(J)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${J}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=no(o.contactId,e);p.dataset.mountTarget=a.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(v){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(n,{childList:!0})},ao=null,Zr=()=>{ao===null&&(ao=window.setInterval(()=>{let o=S();o&&(document.getElementById(J)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),lo()))},3e3))},co=()=>{Zr(),lo()};var Ce="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Qr=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),re="data-ws-crm-favicon",lt=o=>o.hasAttribute(re),bo=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Qr.has(e)},Ie=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{bo(r)&&!lt(r)&&r.remove()});let e=document.head.querySelector(`link[${re}="1"]`);e?e.href!==Ce&&(e.href=Ce):(e=document.createElement("link"),e.setAttribute(re,"1"),e.rel="icon",e.type="image/png",e.href=Ce,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${re}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(re,"apple"),t.rel="apple-touch-icon",t.href=Ce,document.head.appendChild(t))},ho=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Ie();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Ie())},50)}new MutationObserver(r=>{let n=!1;for(let s of r)s.addedNodes.forEach(a=>{a instanceof HTMLLinkElement&&bo(a)&&!lt(a)&&(n=!0)}),s.removedNodes.forEach(a=>{a instanceof HTMLLinkElement&&lt(a)&&(n=!0)});n&&Ie()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Ie(),e>=5&&window.clearInterval(t)},1e3)};var en=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],tn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,on=".hr-card.hr-modal.crm-opportunities-modal",L=()=>{let o=document.querySelector(on);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(tn);if(n){let s=n[1];if(en.includes(s))return s}}return null},U=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=L();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",po="ws-crm-mt-offer-made-modal",nn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,an=/\/v2\/location\/([A-Za-z0-9]+)/,Fe=()=>{let o=window.location.pathname,e=o.match(nn);if(!e)return null;let t=o.match(an);return{oppId:e[1],locationId:t?t[1]:null}},sn=async o=>{let e=await fetch(rn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ae=()=>{document.getElementById(po)?.remove()},ln=o=>{Ae();let e=document.createElement("div");e.id=po,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),s=t.querySelector("#ws-mt-offer-cancel"),a=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),s?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Ae()}),s?.addEventListener("click",()=>Ae()),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Recording\u2026",a.style.opacity="0.7",s&&(s.disabled=!0);try{let h=await sn({oppId:o.oppId,locationId:o.locationId,amount:c,userId:I()});if(!h.ok){n.textContent=h.error??"Something went wrong.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",s&&(s.disabled=!1);return}Ae(),o.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",s&&(s.disabled=!1)}})},dn=o=>{let e=document.createElement("button");return e.id=D,e.type="button",e.dataset.oppId=o,e.style.cssText=A,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Fe();!t||!t.locationId||t.oppId!==o||ln({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=A)},4e3)}})}),e},cn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bn=async()=>{for(let o of cn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Le=!1,ht=async()=>{if(!Le){Le=!0;try{await hn()}finally{Le=!1}}},hn=async()=>{let o=Fe();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await bn();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Fe();if(!n||n.oppId!==o.oppId)return;let s=dn(o.oppId),a=document.createElement("span");a.id=`${D}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(s),t.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),pn(o.oppId)},ne=null,bt=null,ae=()=>{ne?.disconnect(),ne=null,bt=null},pn=o=>{if(ne&&bt===o)return;ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(bt=o,ne=new MutationObserver(()=>{let t=Fe();if(!t||t.oppId!==o){ae();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ae();return}document.getElementById(D)||ht()}),ne.observe(e,{childList:!0,subtree:!0}))},dt=null,ct,mn=()=>{dt||(dt=new MutationObserver(()=>{ct===void 0&&(ct=window.setTimeout(()=>{ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!Le&&ht()},300))}),dt.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{mn(),ht()};var un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",H="ws-crm-not-interested-button",_n=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vn=/\/v2\/location\/([A-Za-z0-9]+)/,De=()=>{let o=window.location.pathname,e=o.match(_n);if(!e)return null;let t=o.match(vn);return{oppId:e[1],locationId:t?t[1]:null}},yn=async o=>{let e=await fetch(un,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},gn=o=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=o,e.style.cssText=A,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=De();if(!t||!t.locationId||t.oppId!==o)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let s=await yn({oppId:t.oppId,locationId:t.locationId,userId:r});if(s?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){b.error("Not Interested webhook failed",s),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},fn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wn=async()=>{for(let o of fn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Me=!1,_t=async()=>{if(!Me){Me=!0;try{await xn()}finally{Me=!1}}},xn=async()=>{let o=De();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await wn();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=De();if(!n||n.oppId!==o.oppId)return;let s=gn(o.oppId),a=document.createElement("span");a.id=`${H}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(s),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),kn(o.oppId)},se=null,ut=null,ie=()=>{se?.disconnect(),se=null,ut=null},kn=o=>{if(se&&ut===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,se=new MutationObserver(()=>{let t=De();if(!t||t.oppId!==o){ie();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||_t()}),se.observe(e,{childList:!0,subtree:!0}))},pt=null,mt,En=()=>{pt||(pt=new MutationObserver(()=>{mt===void 0&&(mt=window.setTimeout(()=>{mt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Me&&_t()},300))}),pt.observe(document.body,{childList:!0,subtree:!0}))},uo=()=>{En(),_t()};var Tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",O="ws-crm-reduce-price-button",_o="ws-crm-reduce-price-modal",Sn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cn=/\/v2\/location\/([A-Za-z0-9]+)/,Pe=()=>{let o=window.location.pathname,e=o.match(Sn);if(!e)return null;let t=o.match(Cn);return{oppId:e[1],locationId:t?t[1]:null}},In=async o=>{let e=await fetch(Tn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},He=()=>{document.getElementById(_o)?.remove()},An=o=>{He();let e=document.createElement("div");e.id=_o,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),s=t.querySelector("#ws-reduce-cancel"),a=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),s?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&He()}),s?.addEventListener("click",()=>{He()}),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Reducing\u2026",a.style.opacity="0.7",s&&(s.disabled=!0);try{await In({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:I()}),He(),o.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",a.disabled=!1,a.textContent="Reduce Price",a.style.opacity="1",s&&(s.disabled=!1)}})},Ln=(o,e)=>{let t=document.createElement("button");return t.id=O,t.type="button",t.dataset.oppId=o,t.style.cssText=A,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Pe();!r||!r.locationId||r.oppId!==o||An({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),s=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,s&&(s.style.background=i.emerald,s.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=A,s&&(s.style.background=i.amber,s.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},Fn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mn=async()=>{for(let o of Fn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,ft=async()=>{if(!Oe){Oe=!0;try{await Dn()}finally{Oe=!1}}},Dn=async()=>{let o=Pe();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),de());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Mn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Pe();if(!n||n.oppId!==o.oppId)return;let s=Ln(o.oppId,o.locationId),a=document.createElement("span");a.id=`${O}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(s),t.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),Hn(o.oppId)},le=null,gt=null,de=()=>{le?.disconnect(),le=null,gt=null},Hn=o=>{if(le&&gt===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gt=o,le=new MutationObserver(()=>{let t=Pe();if(!t||t.oppId!==o){de();return}let r=L();if(r!==null&&r!=="Disposition"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),de();return}document.getElementById(O)||ft()}),le.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,On=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Oe&&ft()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{On(),ft()};var fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",q="ws-crm-send-to-closing-office-button",j="ws-crm-send-to-title-co-wrap",$e="ws-crm-stc-dropdown",Pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nn=/\/v2\/location\/([A-Za-z0-9]+)/,Re=()=>{let o=window.location.pathname,e=o.match(Pn);if(!e)return null;let t=o.match(Nn);return{oppId:e[1],locationId:t?t[1]:null}},Bn=5*60*1e3,wo=o=>`ws-crm-stc-cache:${o}`,$n=o=>{try{let e=window.localStorage.getItem(wo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>Bn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},Rn=(o,e)=>{try{window.localStorage.setItem(wo(o),JSON.stringify(e))}catch{}},Gn=async(o,e)=>{try{let t=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Un=async(o,e,t)=>{let r=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},qn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},yo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},zn=(o,e)=>{if(e&&qn(e)){window.setTimeout(()=>yo(o),300);return}yo(o)},P=()=>{document.getElementById($e)?.remove()},Ne=(o,e,t)=>{P();let r=document.createElement("div");r.id=$e;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let s=o.length,a=o.filter(v=>v.filled).length,l=a===s,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="font-size: 14px; font-weight: 500; color: ${i.bone}; margin-bottom: 6px;">${a} of ${s} ready</div>
    ${e?`<div style="
            font-size: 11px;
            color: ${i.amber};
            margin: 6px 0 4px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(v=>{h[v.group]||(h[v.group]=[]),h[v.group].push(v)});let m=[...c.filter(v=>h[v]),...Object.keys(h).filter(v=>!c.includes(v))];for(let v of m){let g=h[v],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let y=document.createElement("div");y.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${i.steel};
    `,y.textContent=v,x.appendChild(y),g.forEach(_=>{let f=document.createElement("div"),E=!_.filled&&_.navigable&&_.field_id;f.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${w.sm};
        font-size: 12px;
        color: ${_.filled?i.bone:i.ash};
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(f.addEventListener("mouseenter",()=>{f.style.background=i.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",M=>{M.stopPropagation(),_.field_id&&(zn(_.field_id,_.folder),P())}));let T=_.filled?`<span style="color: ${i.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${i.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=E?`<span style="margin-left: auto; color: ${i.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${k}`,x.appendChild(f)}),r.appendChild(x)}document.body.appendChild(r);let p=v=>{let g=v.target;!r.contains(g)&&!t.contains(g)&&(P(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},B=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),s,a,l=i.bone,d,c="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":s="transparent",a=i.steel,l=i.ash,d=i.coolGray,c="Checking\u2026",m="wait",p="0.8";break;case"ready":s=i.emerald,a=i.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let v=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;s="transparent",a=i.amber,l=i.amber,d=i.amber,c=`${v} of ${g} fields ready`,h="\u25BE";break}case"sending":s=i.emerald,a=i.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",p="0.8";break;case"sent":s=i.emerald,a=i.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",a=i.amber,l=i.amber,d=i.amber,c=e.message??"Try again";break}o.style.background=s,o.style.borderColor=a,o.style.color=l,o.style.cursor=m,o.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=c),n&&(n.textContent=h)},Vn=(o,e)=>{let t=document.createElement("button");t.id=q,t.type="button",t.dataset.oppId=o;let r=$n(o),n=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${$}
    background: transparent;
    border: 1px solid ${i.steel};
    color: ${i.ash};
  ...
  `,B(t,n);let s=new Set,a=async()=>{if(n.status==="sending")return;let y=await Gn(o,e);if(!y){n={status:"error",message:"Check failed \u2014 click to retry"},B(t,n);return}if(y.rate_limited){v=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},B(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){n={status:"error",message:y.error||"Check failed \u2014 click to retry"},B(t,n),b.warn("[stc] dry_run returned no checks:",y);return}let _=y.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button + caching`),Ge.add(o),document.getElementById(q)?.remove(),document.getElementById(j)?.remove(),P(),be();return}let f=y.checks;if(n.checks&&n.checks.length===y.checks.length){let T=new Set;f=y.checks.map((k,M)=>n.checks[M]?.filled&&!k.filled?s.has(k.label)?k:(T.add(k.label),{...k,filled:!0}):k),s=T}else s=new Set;n={status:f.every(T=>T.filled)?"ready":"incomplete",checks:f,previouslySentAt:y.previously_sent_at??null},Rn(o,{checks:f,previously_sent_at:y.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),B(t,n),document.getElementById($e)&&Ne(f,y.previously_sent_at,t)},l=async()=>{let y=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},B(t,n),P();try{let _=await Un(o,e,y);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},B(t,n),_.checks&&Ne(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},B(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},B(t,n),_.checks&&Ne(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},B(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById($e)?P():n.checks&&Ne(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,v=0,g=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await a()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let y=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-h,E=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});y.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},Wn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jn=async()=>{for(let o of Wn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ge=new Set,go=null,Kn=o=>{o&&o!==go&&(Ge.clear(),go=o)},Be=!1,Et=async()=>{if(Be){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Be=!0;try{await Yn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Be=!1}},Yn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=Re();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(q)?.remove(),document.getElementById(j)?.remove(),P();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`),Kn(o.oppId),Ge.has(o.oppId)){b.debug(`[stc] mount:02-BAIL opp ${o.oppId} previously confirmed non-TC this session`),document.getElementById(q)?.remove(),document.getElementById(j)?.remove(),P();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=L();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(j)?.remove(),P(),be());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(j)?.remove(),P()),b.debug("[stc] mount:04 calling findMountTarget");let t=await jn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=L();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Re();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Vn(o.oppId,n.locationId),a=document.createElement("span");a.id=j,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(s),t.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(s)}`),Xn(o.oppId)},ce=null,kt=null,be=()=>{ce?.disconnect(),ce=null,kt=null},Xn=o=>{if(ce&&kt===o)return;be();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,ce=new MutationObserver(()=>{let t=Re();if(!t||t.oppId!==o){be();return}let r=L();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(q)?.remove(),document.getElementById(j)?.remove(),P(),be();return}document.getElementById(q)||Et()}),ce.observe(e,{childList:!0,subtree:!0}))},wt=null,xt,Jn=()=>{wt||(wt=new MutationObserver(()=>{xt===void 0&&(xt=window.setTimeout(()=>{xt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(q);if(o&&!e&&!Be){let t=Re();if(t&&Ge.has(t.oppId))return;Et()}},300))}),wt.observe(document.body,{childList:!0,subtree:!0}))},xo=()=>{Jn(),Et()};var Zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",To="ldtyB2UXKi9vOp8nLUH7",ta="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",So="ws-crm-closing-agent-picker-modal",oa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ra=/\/v2\/location\/([A-Za-z0-9]+)/,me=()=>{let o=window.location.pathname,e=o.match(oa);if(!e)return null;let t=o.match(ra);return{oppId:e[1],locationId:t?t[1]:null}},Mt=async o=>{let e=await fetch(Zn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,contact_type:o.contactType??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ko=async o=>{let e=await fetch(Qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},na=async(o,e)=>{try{let t=await fetch(ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:To}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let s=await Mt({tenantId:e,contactId:n,limit:1});if(!s.ok||!s.results.length)return null;let a=s.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(t){return b.warn("[closing-agent] fetchCurrent failed:",t),null}},K=null,aa=60*60*1e3,Dt=o=>`ws-crm-to-cache:${o}`,Co=o=>{try{let e=window.localStorage.getItem(Dt(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>aa||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},Io=(o,e,t)=>{try{window.localStorage.setItem(Dt(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},sa=o=>{try{window.localStorage.removeItem(Dt(o))}catch{}},It="ws-crm-closing-agent-field-link",ia=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${It}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Tt=!1,Ht=async o=>{if(Tt)return;let e=Ao();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[closing-agent] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==t){Tt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${t}`);let r=await Mt({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),At(n.id,n.name,o);let s=document.getElementById(N);if(s){z(s,{status:"linked",contactName:n.name});let a=me();a&&Io(a.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Tt=!1}}},la=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ao=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();la.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=t[0].parentElement,l=0;for(;a&&l<8;){let d=a.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;a=a.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},At=(o,e,t)=>{let r=Ao();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${It}`).forEach(a=>a.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=o,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let l=document.createElement("a");l.className=It,l.href=`/v2/location/${t}/contacts/detail/${o}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${w.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),s.appendChild(l)}}},Ue=()=>{document.getElementById(So)?.remove()},da=o=>{Ue();let e=document.createElement("div");e.id=So,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),s=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ue()}),s?.addEventListener("click",Ue);let a,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await Mt({tenantId:o.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${qe(m.name)}</div>
          <div style="color: ${i.ash}; font-size: 11px; margin-top: 2px;">
            ${qe(m.email||"(no email)")} \xB7 ${qe(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${qe(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=i.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{Ue(),o.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${i.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;a!==void 0&&clearTimeout(a),a=window.setTimeout(()=>{d(c)},250)})},qe=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),z=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Closing Agent",s=i.amber,a=i.bone,l="transparent",d=i.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",s=i.coolGray,a=i.ash,c="wait";break;case"empty":n="Link Closing Agent",s=i.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=i.emerald,l=i.emeraldGlow,d=i.emeraldBorder,a=i.emeraldBright;break;case"saving":n="Linking\u2026",s=i.coolGray,a=i.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),o.style.background=l,o.style.borderColor=d,o.style.color=a,o.style.cursor=c},ca=(o,e)=>{let t=document.createElement("button");t.id=N,t.type="button",t.dataset.oppId=o,t.style.cssText=A,t.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};z(t,r);let n=Co(o);return n&&(r={status:"linked",contactName:n.contactName},z(t,r),K={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await na(o,e);a?(r={status:"linked",contactName:a.name},z(t,r),K={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},At(a.id,a.name,e)):n||(r={status:"empty"},z(t,r),K?.oppId===o&&(K=null),ia(),sa(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||da({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},z(t,r);try{let l=[ko({tenantId:e,oppId:o,fieldId:To,value:a.id})];a.companyName&&a.companyName.trim()&&l.push(ko({tenantId:e,oppId:o,fieldId:ta,value:a.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},z(t,r),K={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},Io(o,a.id,a.name),At(a.id,a.name,e),b.info(`Closing Agent linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},z(t,r)}}})}),t},ba=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ha=async()=>{for(let o of ba)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Ve=async()=>{if(!he){he=!0;try{await pa()}finally{he=!1}}},pa=async()=>{let o=me();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ze();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let d=L();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),ze());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=L();if(t!==null&&t!=="Transaction Coordination")return;let r=await ha();if(!r||!(Co(o.oppId)!==null||K!==null&&K.oppId===o.oppId)&&await U()!=="Transaction Coordination")return;let s=me();if(!s||s.oppId!==o.oppId||!s.locationId)return;let a=ca(o.oppId,s.locationId),l=document.createElement("span");l.id=`${N}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(a),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${o.oppId}`),ma(o.oppId),Ht(s.locationId)},pe=null,Lt=null,Ft=null,ze=()=>{pe?.disconnect(),pe=null,Lt=null,Ft=null},ma=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pe&&Lt===o&&Ft===e||(ze(),Lt=o,Ft=e,pe=new MutationObserver(()=>{let t=me();if(!t||t.oppId!==o||!t.locationId){ze();return}document.getElementById(N)||Ve(),Ht(t.locationId)}),pe.observe(e,{childList:!0,subtree:!0})))},St=null,Ct,ua=()=>{St||(St=new MutationObserver(()=>{Ct===void 0&&(Ct=window.setTimeout(()=>{Ct=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!he&&Ve()},300))}),St.observe(document.body,{childList:!0,subtree:!0}))},Eo,_a=()=>{Eo===void 0&&(Eo=window.setInterval(()=>{let o=me();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(N)&&!he&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ve()),Ht(o.locationId)},2e3))},Lo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),ua(),_a(),Ve()};var va="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ot="ws-crm-prepare-contract-button",Fo="ws-crm-prepare-contract-menu",Mo="ws-crm-prepare-contract-modal",_e="https://services.leadconnectorhq.com",Z=null,ve=()=>{if(!Z)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:Z.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return Z.tokenId&&(o["token-id"]=Z.tokenId),o};var Do=!1,ya=()=>{if(Do)return;Do=!0;let o=(a,l)=>{let d=l.authorization||l.Authorization;if(!d)return;let c=l["token-id"]||l["Token-Id"]||void 0,h=Z?.authorization;Z={authorization:d,tokenId:c,capturedAt:Date.now()},h!==d&&b.debug(`[prepare-contract] captured fresh GHL auth from ${a.split("?")[0]} (${d.slice(0,24)}\u2026)`),window.__WS_CRM_LOG_GHL&&console.log("[ws-crm GHL request]",{url:a,headers:l})},e=window.fetch;window.fetch=async function(...a){let l=typeof a[0]=="string"?a[0]:a[0]instanceof URL?a[0].toString():a[0].url,d=a[1]||{};if(l&&l.includes("services.leadconnectorhq.com")){let c=d.headers;!c&&a[0]instanceof Request&&(c=a[0].headers);let h={};if(c instanceof Headers)c.forEach((m,p)=>h[p.toLowerCase()]=m);else if(Array.isArray(c))c.forEach(([m,p])=>h[m.toLowerCase()]=p);else if(c&&typeof c=="object")for(let m of Object.keys(c))h[m.toLowerCase()]=c[m];o(l,h)}return e.apply(this,a)};let t=XMLHttpRequest.prototype,r=t.open,n=t.setRequestHeader,s=t.send;t.open=function(a,l,...d){return this.__wsCrmUrl=l,this.__wsCrmHeaders={},r.call(this,a,l,...d)},t.setRequestHeader=function(a,l){return this.__wsCrmHeaders&&typeof a=="string"&&(this.__wsCrmHeaders[a.toLowerCase()]=l),n.call(this,a,l)},t.send=function(a){let l=this.__wsCrmUrl,d=this.__wsCrmHeaders;return l&&l.includes("services.leadconnectorhq.com")&&d&&o(l,d),s.call(this,a)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Po=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},ga=o=>{let e=(o||"").trim();return/^\[?\s*PA\s*\]?\s*[-\s]/i.test(e)?"PA":/^\[?\s*AA\s*\]?\s*[-\s]/i.test(e)?"AA":"passthrough"},fa=async o=>{let e=`${_e}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(o)}&skip=0&limit=100`,t=await fetch(e,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Templates fetch returned ${t.status} ${t.statusText}`);let r=await t.json();return(r.templates||r.items||[]).map(s=>({id:(s._id??s.id)||"",name:s.name||"(unnamed template)",type:ga(s.name||"")})).filter(s=>!!s.id)},wa=async(o,e)=>{let t=await fetch(`${_e}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:ve()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${_e}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ve()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},xa=async o=>{let e=await fetch(va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,template_id:o.templateId,template_type:o.templateType,opp_id:o.oppId,closing_date:o.closingDate,buyer_earnest_due_date:o.buyerEarnestDueDate,lender_source:o.lenderSource,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},ka=async(o,e)=>{let t=await fetch(`${_e}/proposals/templates/to-proposal/${o}/${e}?locale=en-US`,{method:"POST",headers:ve()});if(!t.ok)throw new Error(`to-proposal HTTP ${t.status} ${t.statusText}`);let r=await t.json(),n=r._id||r.id||r.proposal?._id||r.proposal?.id;if(!n)throw new Error("to-proposal returned no proposal id");return n},Ea=async(o,e)=>{let t=await fetch(`${_e}/proposals/document/${o}`,{method:"PUT",headers:{...ve(),"Content-Type":"application/json"},body:JSON.stringify({contactId:e})});if(!t.ok)throw new Error(`assign-contact HTTP ${t.status} ${t.statusText}`)},Ta=(o,e)=>{let t=`/v2/location/${o}/payments/proposals-estimates/edit/${e}`;window.location.href=t},Ho="ws-crm-prepare-contract-toast",ue=(o,e="info",t=4e3)=>{document.getElementById(Ho)?.remove();let r=document.createElement("div");r.id=Ho;let n=e==="error"?i.crimson:i.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=o,document.body.appendChild(r),window.setTimeout(()=>r.remove(),t)},Sa=({tenantId:o,contactId:e,template:t,mtOpps:r,userId:n})=>{document.getElementById(Mo)?.remove();let s=document.createElement("div");s.id=Mo,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        ...
        <div style="
          ...
          font-size: 13px;
          color: ${i.bone};
        ">${Q(r[0].propertyAddress||r[0].name)}</div>
        <input type="hidden" id="ws-pc-opp-id" value="${Oo(r[0].id)}" />
      `;let y=r.map(_=>`<option value="${Oo(_.id)}">${Q(_.propertyAddress||_.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${u.mono};
        font-size: 10px;
  ...
  `,s.appendChild(a),document.body.appendChild(s);let v=()=>s.remove();if(s.addEventListener("click",y=>{y.target===s&&v()}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",v),p)return;let g=a.querySelector("#ws-pc-submit"),x=a.querySelector("#ws-pc-error");g?.addEventListener("click",async()=>{if(!g)return;let y=a.querySelector("#ws-pc-opp-id"),_=(a.querySelector("#ws-pc-closing-date")?.value??"").trim(),f=(a.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(a.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(y?.value||"").trim();if(!T){x&&(x.textContent="Pick a subject property.");return}if(!_){x&&(x.textContent="Closing Date is required.");return}x&&(x.textContent=""),g.disabled=!0,g.textContent="Preparing\u2026";try{await No({tenantId:o,contactId:e,template:t,oppId:T,closingDate:_,buyerEarnestDueDate:f,lenderSource:E,userId:n}),v()}catch(k){g.disabled=!1,g.textContent="Stage & Open Contract",x&&(x.textContent=k.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",k)}})},No=async({tenantId:o,contactId:e,template:t,oppId:r,closingDate:n,buyerEarnestDueDate:s,lenderSource:a,userId:l})=>{b.info(`[prepare-contract] starting flow for template "${t.name}" (${t.type})`);let d=await xa({tenantId:o,contactId:e,templateId:t.id,templateType:t.type,oppId:r,closingDate:n,buyerEarnestDueDate:s,lenderSource:a,userId:l});if(!d.ok)throw new Error(d.error||"Contract.Stage returned not ok");let c=await ka(o,t.id);b.info(`[prepare-contract] proposal created: ${c}`),await Ea(c,e),b.info(`[prepare-contract] contact ${e} assigned to proposal ${c}`),Ta(o,c)},Ca=async o=>{let e=Po();if(!e){ue("Could not resolve contact context.","error");return}document.getElementById(Fo)?.remove();let t=document.createElement("div");t.id=Fo,t.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,t.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,o.appendChild(t);let r=s=>{!t.contains(s.target)&&s.target!==o&&(t.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await fa(e.tenantId)}catch(s){t.innerHTML=`
      <div style="padding: 12px 14px; color: ${i.crimson}; font-size: 12px;">
        Failed to load templates: ${Q(s.message)}
      ...
      </div>`;return}n.sort((s,a)=>{let l={PA:0,AA:1,passthrough:2};return l[s.type]!==l[a.type]?l[s.type]-l[a.type]:s.name.localeCompare(a.name)}),t.innerHTML="";for(let s of n){let a=document.createElement("button");a.type="button",a.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
      ...
      cursor: pointer;
      transition: background 0.1s ease;
    `;let l=s.type==="PA"?i.emerald:s.type==="AA"?i.blue:i.coolGray;a.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${Q(s.name)}</span>
      </div>`,a.addEventListener("mouseenter",()=>{a.style.background=i.slate}),a.addEventListener("mouseleave",()=>{a.style.background="transparent"}),a.addEventListener("click",async()=>{t.remove(),document.removeEventListener("click",r,!0);let d=I();try{if(s.type==="AA"){let c;try{c=await wa(e.tenantId,e.contactId)}catch(h){ue(`Failed to load buyer's MT opps: ${h.message}`,"error");return}Sa({tenantId:e.tenantId,contactId:e.contactId,template:s,mtOpps:c,userId:d})}else{ue(`Preparing ${s.name}\u2026`,"info",2500);try{await No({tenantId:e.tenantId,contactId:e.contactId,template:s,userId:d})}catch(c){ue(`Failed to prepare contract: ${c.message}`,"error",6e3),b.warn("[prepare-contract] flow failed:",c)}}}catch(c){b.warn("[prepare-contract] picker click handler failed:",c),ue(`Unexpected error: ${c.message}`,"error",6e3)}}),t.appendChild(a)}},Ia=()=>{let o=document.createElement("button");return o.id=Ot,o.type="button",o.style.cssText=`
    position: relative;
    background: ${i.slate};
    border: 1px solid ${i.steel};
    border-radius: ${w.sm};
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.borderColor=i.emerald}),o.addEventListener("mouseleave",()=>{o.style.borderColor=i.steel}),o.addEventListener("click",e=>{e.stopPropagation(),Ca(o)}),o},Aa="ws-crm-contact-actions-bar",La=async()=>{let o=Po();if(!o){document.getElementById(Ot)?.remove();return}let e=null;try{e=await C(`#${Aa}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let t=document.getElementById(Ot);if(t){if(t.dataset.contactId===o.contactId)return;t.remove()}let r=Ia();r.dataset.contactId=o.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${o.contactId}`)},Bo=()=>{La()};ya();function Q(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Oo(o){return Q(o)}var Je="reos-theme-stylesheet",or="reos-theme-fonts",Fa=()=>{let o=document.getElementById(or);o&&o.remove()},Ma=`
/* ============================================
