...
/* 18a-pipeline-ribbon-count (v0.8.40). The contact count pill on
   the contacts smart-list page (.pipeline-ribbon .count, content
   '42 Contacts') was painted slate inline by coerceDarkDropdowns.
   Tim wants it without the slate pill surround \u2014 should just be
   bone text floating on the page.

   CSS: paint transparent at ID-level specificity. JS skip below
   prevents the coercer from repainting slate. */
