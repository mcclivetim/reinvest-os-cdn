...
/* 18a-affiliate-header-bg (v0.9.16). .hl_affiliate--header
   wrapper (Phone System / other settings sub-app top bars)
   ships with white bg by default. Override to obsidian. */
