/* Wholesaling CRM Customizer v0.13.74 — built 2026-05-28T00:03:57.496Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var me="[wholesaling-crm-customizer]",No="__WS_CRM_DEBUG",Bo=()=>!!window[No],b={info(...o){console.log(me,...o)},warn(...o){console.warn(me,...o)},error(...o){console.error(me,...o)},debug(...o){Bo()&&console.log(me,"[debug]",...o)}};var St=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,We=/\/v2\/location\/([A-Za-z0-9]+)/,Ro=o=>{let e=o.match(St);if(!e)return null;let t=o.match(We);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},$o=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(St);if(!n)continue;let a=r.match(We)||window.location.pathname.match(We);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Ro(window.location.pathname);return o||$o()};var Ct=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},_e="",je=null,j="other",Ke=new Set,ue=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==_e)&&!(o!==je))){_e=window.location.pathname,je=o,j=Ct(),b.debug("Page/context changed:",j,_e,"contact:",o);for(let r of Ke)try{r(j)}catch(n){b.error("Subscriber threw:",n)}}},It=o=>(Ke.add(o),setTimeout(()=>o(j),0),()=>{Ke.delete(o)}),Lt=()=>{j=Ct(),_e=window.location.pathname,je=S()?.contactId??null,b.debug("Router init, current page:",j);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ue()},history.replaceState=function(t,r,n){e(t,r,n),ue()},window.addEventListener("popstate",ue),setInterval(ue,1e3)};var ve="0.13.74",ye="2026-05-28T00:03:57.497Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let i=n.querySelector(o);if(i){a(i);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ye={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},At=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var Go=/^[A-Za-z0-9]{15,30}$/,Z=o=>typeof o=="string"&&Go.test(o),Uo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Vo=()=>{let o=window.WS_CRM_USER_ID;return Z(o)?o:null},qo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Z(t))return t;return null},zo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Uo(e);if(!t)return null;let r=t.uid;if(Z(r))return r;let n=t.claims;if(n&&Z(n.user_id))return n.user_id}catch{}return null},Wo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Z(n))return n}catch{}}}catch{}return null},L=()=>Vo()||qo()||zo()||Wo()||null;var Ot="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",jo=`${Ot}/active-follow-up-get`,Ko=`${Ot}/active-follow-up-set`,q="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Yo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Xo=async o=>{let e=await fetch(jo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Jo=async(o,e)=>{let t=await fetch(Ko,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},z=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ft=o=>{let e=document.createElement("button");return e.type="button",e.id=q,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,z(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Yo();if(!(!r||r.contactId!==o)){z(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Jo(r,L()),a=n&&n.state&&n.state in Je?n.state:"blue";z(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),z(e,"error"),setTimeout(()=>void ge(e,r),4e3)}}}),e},ge=async(o,e)=>{z(o,"loading");try{let t=await Xo(e),r=t&&t.state&&t.state in Je?t.state:"gray",n=document.getElementById(q);if(!n||n.dataset.contactId!==e.contactId)return;z(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),z(o,"error")}},Zo=[".central-panel","[class*='central-panel']"],Xe="ws-crm-contact-actions-bar",Qo=async()=>{for(let o of Zo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},er=async(o,e)=>{let t=e.querySelector(`#${Xe}`);if(!t)try{t=await C(`#${Xe}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Xe}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},tr=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},or=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},rr=async o=>{if(o==="url"){let t=await Qo();return t?{kind:"contact-detail",target:t}:null}let e=tr();return e?{kind:"conversations",target:e}:null},Mt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await er(o,e.target);return t}return or(o,e.target),"conversations-header"},nr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(q)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(q);if(t&&t.dataset.contactId===e.contactId){ge(t,e);return}t&&t.remove();let r=await rr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=Ft(e.contactId),s=await Mt(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Dt();let i=document.getElementById(q)??a;ge(i,e);let d=new MutationObserver(()=>{let c=document.getElementById(q);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Ft(e.contactId);Mt(m,r).then(()=>{Dt(),ge(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Q=null,Ht=()=>{let o=S()?.contactId??null;if(Q&&Q.contactId===o)return;let e=nr().finally(()=>{Q?.promise===e&&(Q=null)});Q={contactId:o,promise:e}},Dt=()=>{let o=document.querySelectorAll(`#${q}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var U="ws-crm-claim-release-pill",ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",sr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",ir=async o=>{let e=await fetch(ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},lr=async o=>{let e=await fetch(sr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Bt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},K=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=At(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},dr=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=U,t.type="button",t.dataset.contactId=o,K(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let a=L();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let i=t.querySelector(".ws-cr-label");i&&(i.textContent="Sign-in needed"),setTimeout(()=>K(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let s=r==="claim"?"release":"claim";K(t,s),t.disabled=!0,t.style.opacity="0.8";try{let i=await lr({contactId:o,locationId:n.locationId,userId:a,action:r}),d=i?.mode==="claim"||i?.mode==="release"?i.mode:s;K(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(i){b.error("Claim/Release Set webhook failed",i),K(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Pt=async(o,e)=>{try{let t=await ir({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(U);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";K(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},cr=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Bt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Nt=(o,e)=>{let t=dr({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${U}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},br=async()=>{let o=S();if(!o){document.getElementById(U)?.remove();return}let e=document.getElementById(U);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await cr(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Nt(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(U);a&&o.locationId&&Pt(a,{contactId:o.contactId,locationId:o.locationId});let s=null;s=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(U))return;let d=Bt(t);if(d){Nt(d,o.contactId);let c=document.getElementById(U);c&&o.locationId&&Pt(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Rt=()=>{br()};var hr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ee=new Map,$t=async(o,e)=>{if(!o)return null;if(ee.has(o))return ee.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${hr}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),ee.set(o,null),null;let i=((await a.json()).contact_type||"").toLowerCase().trim()||null;return ee.set(o,i),b.debug(`Resolved Contact Type for ${o}: ${i??"(unset)"}`),i}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),ee.set(o,null),null}};var Gt=o=>o==="buyer"?"buyer":"seller";var jt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var mr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",ur=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:s})=>{let i=a||jt,d;if(s==="buyer"){let p=Kt.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let c=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},_r=async({contactId:o,tenantId:e})=>{let t=await fetch(mr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var Y="ws-crm-contact-actions-bar",vr="ws-crm-call-status-dropdown",Ut="ws-crm-offer-made-modal",yr=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Kt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],gr=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],fr=async()=>{for(let o of gr)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},wr=({contactId:o,kind:e})=>{let t=e==="buyer"?Kt:yr,r=e==="buyer"?pr:jt,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=vr,a.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=I,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",i=>{i.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=i=>{i.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},zt=(o,e)=>{let t=document.createElement("div");t.id=Y,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=B,r.textContent="Offer Made",r.addEventListener("click",()=>Er(o,e)),t.appendChild(r),t.appendChild(wr({contactId:o,kind:e})),t},Ze=!1,Cr=()=>{document.querySelectorAll(`[id="${Y}"]`).forEach(o=>o.remove())},Yt=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Ze){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Ze=!0;try{await Ir()}finally{Ze=!1}},Ir=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Cr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await $t(o.contactId,o.locationId);Gt(c)==="buyer"&&(e="buyer"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Y}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await fr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=zt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Y)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${Y}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=zt(o.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},Wt=null,Lr=()=>{Wt===null&&(Wt=window.setInterval(()=>{let o=S();o&&(document.getElementById(Y)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Yt()))},3e3))},Xt=()=>{Lr(),Yt()};var fe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Ar=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),te="data-ws-crm-favicon",Qe=o=>o.hasAttribute(te),Jt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Ar.has(e)},we=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Jt(r)&&!Qe(r)&&r.remove()});let e=document.head.querySelector(`link[${te}="1"]`);e?e.href!==fe&&(e.href=fe):(e=document.createElement("link"),e.setAttribute(te,"1"),e.rel="icon",e.type="image/png",e.href=fe,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${te}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(te,"apple"),t.rel="apple-touch-icon",t.href=fe,document.head.appendChild(t))},Zt=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)we();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),we())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Jt(s)&&!Qe(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Qe(s)&&(n=!0)});n&&we()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,we(),e>=5&&window.clearInterval(t)},1e3)};var Fr=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Mr=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Dr=".hr-card.hr-modal.crm-opportunities-modal",A=()=>{let o=document.querySelector(Dr);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Mr);if(n){let a=n[1];if(Fr.includes(a))return a}}return null},V=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=A();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Or="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",Qt="ws-crm-mt-offer-made-modal",Hr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Pr=/\/v2\/location\/([A-Za-z0-9]+)/,Ee=()=>{let o=window.location.pathname,e=o.match(Hr);if(!e)return null;let t=o.match(Pr);return{oppId:e[1],locationId:t?t[1]:null}},Nr=async o=>{let e=await fetch(Or,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},xe=()=>{document.getElementById(Qt)?.remove()},Br=o=>{xe();let e=document.createElement("div");e.id=Qt,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Ee();!t||!t.locationId||t.oppId!==o||Br({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},$r=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gr=async()=>{for(let o of $r)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ke=!1,rt=async()=>{if(!ke){ke=!0;try{await Ur()}finally{ke=!1}}},Ur=async()=>{let o=Ee();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),re());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await Gr();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ee();if(!n||n.oppId!==o.oppId)return;let a=Rr(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Vr(o.oppId)},oe=null,ot=null,re=()=>{oe?.disconnect(),oe=null,ot=null},Vr=o=>{if(oe&&ot===o)return;re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ot=o,oe=new MutationObserver(()=>{let t=Ee();if(!t||t.oppId!==o){re();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}document.getElementById(D)||rt()}),oe.observe(e,{childList:!0,subtree:!0}))},et=null,tt,qr=()=>{et||(et=new MutationObserver(()=>{tt===void 0&&(tt=window.setTimeout(()=>{tt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!ke&&rt()},300))}),et.observe(document.body,{childList:!0,subtree:!0}))},eo=()=>{qr(),rt()};var zr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",Wr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jr=/\/v2\/location\/([A-Za-z0-9]+)/,Se=()=>{let o=window.location.pathname,e=o.match(Wr);if(!e)return null;let t=o.match(jr);return{oppId:e[1],locationId:t?t[1]:null}},Kr=async o=>{let e=await fetch(zr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Yr=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Se();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Kr({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Xr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jr=async()=>{for(let o of Xr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Te=!1,it=async()=>{if(!Te){Te=!0;try{await Zr()}finally{Te=!1}}},Zr=async()=>{let o=Se();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Jr();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Se();if(!n||n.oppId!==o.oppId)return;let a=Yr(o.oppId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),Qr(o.oppId)},ne=null,st=null,ae=()=>{ne?.disconnect(),ne=null,st=null},Qr=o=>{if(ne&&st===o)return;ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(st=o,ne=new MutationObserver(()=>{let t=Se();if(!t||t.oppId!==o){ae();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ae();return}document.getElementById(O)||it()}),ne.observe(e,{childList:!0,subtree:!0}))},nt=null,at,en=()=>{nt||(nt=new MutationObserver(()=>{at===void 0&&(at=window.setTimeout(()=>{at=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Te&&it()},300))}),nt.observe(document.body,{childList:!0,subtree:!0}))},to=()=>{en(),it()};var tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",oo="ws-crm-reduce-price-modal",on=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rn=/\/v2\/location\/([A-Za-z0-9]+)/,Le=()=>{let o=window.location.pathname,e=o.match(on);if(!e)return null;let t=o.match(rn);return{oppId:e[1],locationId:t?t[1]:null}},nn=async o=>{let e=await fetch(tn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ce=()=>{document.getElementById(oo)?.remove()},an=o=>{Ce();let e=document.createElement("div");e.id=oo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Le();!r||!r.locationId||r.oppId!==o||an({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,a&&(a.style.background=l.emerald,a.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,a&&(a.style.background=l.amber,a.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},ln=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dn=async()=>{for(let o of ln)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ie=!1,bt=async()=>{if(!Ie){Ie=!0;try{await cn()}finally{Ie=!1}}},cn=async()=>{let o=Le();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await dn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Le();if(!n||n.oppId!==o.oppId)return;let a=sn(o.oppId,o.locationId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),bn(o.oppId)},se=null,ct=null,ie=()=>{se?.disconnect(),se=null,ct=null},bn=o=>{if(se&&ct===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ct=o,se=new MutationObserver(()=>{let t=Le();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ie();return}document.getElementById(H)||bt()}),se.observe(e,{childList:!0,subtree:!0}))},lt=null,dt,hn=()=>{lt||(lt=new MutationObserver(()=>{dt===void 0&&(dt=window.setTimeout(()=>{dt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ie&&bt()},300))}),lt.observe(document.body,{childList:!0,subtree:!0}))},ro=()=>{hn(),bt()};var ao="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",W="ws-crm-send-to-title-co-button",X="ws-crm-send-to-title-co-wrap",Me="ws-crm-stc-dropdown",pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,mn=/\/v2\/location\/([A-Za-z0-9]+)/,mt=()=>{let o=window.location.pathname,e=o.match(pn);if(!e)return null;let t=o.match(mn);return{oppId:e[1],locationId:t?t[1]:null}},un=5*60*1e3,so=o=>`ws-crm-stc-cache:${o}`,_n=o=>{try{let e=window.localStorage.getItem(so(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>un||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},vn=(o,e)=>{try{window.localStorage.setItem(so(o),JSON.stringify(e))}catch{}},yn=async(o,e)=>{try{let t=await fetch(ao,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},gn=async(o,e,t)=>{let r=await fetch(ao,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},fn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},no=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},wn=(o,e)=>{if(e&&fn(e)){window.setTimeout(()=>no(o),300);return}no(o)},N=()=>{document.getElementById(Me)?.remove()},Ae=(o,e,t)=>{N();let r=document.createElement("div");r.id=Me;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,P(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let v=await yn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},P(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N(),de();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},vn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(Me)&&Ae(y,v.previously_sent_at,t)},i=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),N();try{let _=await gn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&Ae(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":i();break;case"incomplete":{document.getElementById(Me)?N():n.checks&&Ae(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-p,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},k)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},kn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],En=async()=>{for(let o of kn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Fe=!1,_t=async()=>{if(Fe){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Fe=!0;try{await Tn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Fe=!1}},Tn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=mt();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(W);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let i=A();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),N(),de());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),N()),b.debug("[stc] mount:04 calling findMountTarget");let t=await En();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=mt();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=xn(o.oppId,n.locationId),s=document.createElement("span");s.id=X,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Sn(o.oppId)},le=null,ut=null,de=()=>{le?.disconnect(),le=null,ut=null},Sn=o=>{if(le&&ut===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,le=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){de();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N(),de();return}document.getElementById(W)||_t()}),le.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Cn=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);o&&!e&&!Fe&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},io=()=>{Cn(),_t()};var In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",co="ldtyB2UXKi9vOp8nLUH7",Fn="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",bo="ws-crm-title-officer-picker-modal",Mn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dn=/\/v2\/location\/([A-Za-z0-9]+)/,gt=()=>{let o=window.location.pathname,e=o.match(Mn);if(!e)return null;let t=o.match(Dn);return{oppId:e[1],locationId:t?t[1]:null}},ho=async o=>{let e=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},lo=async o=>{let e=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},On=async(o,e)=>{try{let t=await fetch(An,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:co}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await ho({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},$=null,po="ws-crm-title-officer-field-link",mo=()=>{document.querySelectorAll(`.${po}`).forEach(o=>o.remove()),document.querySelectorAll('input[data-ws-title-officer-decorated="1"]').forEach(o=>{o.style.removeProperty("color"),o.style.removeProperty("caret-color"),delete o.dataset.wsTitleOfficerDecorated})},ft=(o,e,t)=>{mo(),document.querySelectorAll("input").forEach(n=>{if(n.value!==o||n.dataset.wsTitleOfficerDecorated==="1")return;let a=n.parentElement;if(!a)return;n.dataset.wsTitleOfficerDecorated="1",n.style.color="transparent",n.style.caretColor="transparent",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let i=document.createElement("a");i.className=po,i.href=`/v2/location/${t}/contacts/detail/${o}`,i.textContent=e,i.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      pointer-events: auto;
      background: transparent;
    `,i.addEventListener("mouseenter",()=>{i.style.textDecoration="underline"}),i.addEventListener("mouseleave",()=>{i.style.textDecoration="none"}),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=i.href}),a.appendChild(i)})},De=()=>{document.getElementById(bo)?.remove()},Hn=o=>{De();let e=document.createElement("div");e.id=bo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&De()}),a?.addEventListener("click",De);let s,i="",d=async c=>{if(n&&c!==i){if(i=c,!c.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await ho({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};return J(t,r),(async()=>{let a=await On(o,e);a?(r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},ft(a.id,a.name,e)):(r={status:"empty"},J(t,r),$?.oppId===o&&($=null),mo())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Hn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},J(t,r);try{let s=[lo({tenantId:e,oppId:o,fieldId:co,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(lo({tenantId:e,oppId:o,fieldId:Fn,value:a.companyName.trim()}));let d=(await Promise.all(s))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},ft(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},J(t,r)}}})}),t},Nn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Bn=async()=>{for(let o of Nn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,xt=async()=>{if(!He){He=!0;try{await Rn()}finally{He=!1}}},Rn=async()=>{let o=gt();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Bn();if(!r||await V()!=="Transaction Coordination")return;let a=gt();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=Pn(o.oppId,a.locationId),i=document.createElement("span");i.id=`${R}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),i.appendChild(s),r.appendChild(i),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),$n(o.oppId)},ce=null,wt=null,Pe=()=>{ce?.disconnect(),ce=null,wt=null},$n=o=>{if(ce&&wt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wt=o,ce=new MutationObserver(()=>{let t=gt();if(!t||t.oppId!==o){Pe();return}document.getElementById(R)||xt(),$&&$.oppId===o&&ft($.contactId,$.contactName,$.tenantId)}),ce.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,Gn=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!He&&xt()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},uo=()=>{Gn(),xt()};var Ue="reos-theme-stylesheet",Do="reos-theme-fonts",Un=()=>{let o=document.getElementById(Do);o&&o.remove()},Vn=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Po=()=>{b.info(`Loaded v${ve} (built ${ye})`),M("mountVersionBadge (initial)",qe),M("mountFavicon",Zt),M("mountThemeStylesheet",Oo),M("initPageRouter",Lt),b.info("[main] registering onPageChange subscriber"),It(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",qe),M("mountClaimReleaseToggle",Rt),M("mountContactActionsBar",Xt),M("mountActiveFollowUpButton",Ht),M("mountMtOfferMadeButton",eo),M("mountNotInterestedButton",to),M("mountReducePriceButton",ro),M("mountSendToTitleCoButton",io),M("mountTitleOfficerPickerButton",uo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Po):Po();})();
