/* Wholesaling CRM Customizer v0.14.9 — built 2026-05-30T02:36:52.106Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var fe="[wholesaling-crm-customizer]",sr="__WS_CRM_DEBUG",ir=()=>!!window[sr],b={info(...o){console.log(fe,...o)},warn(...o){console.warn(fe,...o)},error(...o){console.error(fe,...o)},debug(...o){ir()&&console.log(fe,"[debug]",...o)}};var Bt=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,et=/\/v2\/location\/([A-Za-z0-9]+)/,lr=o=>{let e=o.match(Bt);if(!e)return null;let t=o.match(et);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},dr=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Bt);if(!n)continue;let a=r.match(et)||window.location.pathname.match(et);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=lr(window.location.pathname);return o||dr()};var Rt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},xe="",tt=null,Y="other",ot=new Set,we=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==xe)&&!(o!==tt))){xe=window.location.pathname,tt=o,Y=Rt(),b.debug("Page/context changed:",Y,xe,"contact:",o);for(let r of ot)try{r(Y)}catch(n){b.error("Subscriber threw:",n)}}},$t=o=>(ot.add(o),setTimeout(()=>o(Y),0),()=>{ot.delete(o)}),Gt=()=>{Y=Rt(),xe=window.location.pathname,tt=S()?.contactId??null,b.debug("Router init, current page:",Y);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),we()},history.replaceState=function(t,r,n){e(t,r,n),we()},window.addEventListener("popstate",we),setInterval(we,1e3)};var ke="0.14.9",Ee="2026-05-30T02:36:52.107Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let l=n.querySelector(o);if(l){a(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},w={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},rt={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},Ut=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,A=`
  ...
  flex-shrink: 0;
`;var cr=/^[A-Za-z0-9]{15,30}$/,Q=o=>typeof o=="string"&&cr.test(o),br=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},hr=()=>{let o=window.WS_CRM_USER_ID;return Q(o)?o:null},pr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Q(t))return t;return null},mr=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=br(e);if(!t)return null;let r=t.uid;if(Q(r))return r;let n=t.claims;if(n&&Q(n.user_id))return n.user_id}catch{}return null},ur=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Q(n))return n}catch{}}}catch{}return null},I=()=>hr()||pr()||mr()||ur()||null;var Wt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",_r=`${Wt}/active-follow-up-get`,vr=`${Wt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",at={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},yr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},gr=async o=>{let e=await fetch(_r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},fr=async(o,e)=>{let t=await fetch(vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=at[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},zt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,W(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=yr();if(!(!r||r.contactId!==o)){W(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await fr(r,I()),a=n&&n.state&&n.state in at?n.state:"blue";W(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),W(e,"error"),setTimeout(()=>void Te(e,r),4e3)}}}),e},Te=async(o,e)=>{W(o,"loading");try{let t=await gr(e),r=t&&t.state&&t.state in at?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;W(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),W(o,"error")}},wr=[".central-panel","[class*='central-panel']"],nt="ws-crm-contact-actions-bar",xr=async()=>{for(let o of wr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},kr=async(o,e)=>{let t=e.querySelector(`#${nt}`);if(!t)try{t=await C(`#${nt}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${nt}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Er=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Tr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Sr=async o=>{if(o==="url"){let t=await xr();return t?{kind:"contact-detail",target:t}:null}let e=Er();return e?{kind:"conversations",target:e}:null},qt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await kr(o,e.target);return t}return Tr(o,e.target),"conversations-header"},Cr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(V)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(V);if(t&&t.dataset.contactId===e.contactId){Te(t,e);return}t&&t.remove();let r=await Sr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=zt(e.contactId),s=await qt(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Vt();let l=document.getElementById(V)??a;Te(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(V);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=zt(e.contactId);qt(m,r).then(()=>{Vt(),Te(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},ee=null,jt=()=>{let o=S()?.contactId??null;if(ee&&ee.contactId===o)return;let e=Cr().finally(()=>{ee?.promise===e&&(ee=null)});ee={contactId:o,promise:e}},Vt=()=>{let o=document.querySelectorAll(`#${V}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",Ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Ar="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Lr=async o=>{let e=await fetch(Ir,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Fr=async o=>{let e=await fetch(Ar,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Xt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},X=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?i.emerald:i.amber;o.dataset.mode=e,o.style.cssText=Ut(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Mr=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=G,t.type="button",t.dataset.contactId=o,X(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let a=I();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=t.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>X(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let s=r==="claim"?"release":"claim";X(t,s),t.disabled=!0,t.style.opacity="0.8";try{let l=await Fr({contactId:o,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;X(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),X(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Kt=async(o,e)=>{try{let t=await Lr({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(G);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";X(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Dr=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Xt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Yt=(o,e)=>{let t=Mr({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${G}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},Hr=async()=>{let o=S();if(!o){document.getElementById(G)?.remove();return}let e=document.getElementById(G);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Dr(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Yt(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(G);a&&o.locationId&&Kt(a,{contactId:o.contactId,locationId:o.locationId});let s=null;s=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(G))return;let d=Xt(t);if(d){Yt(d,o.contactId);let c=document.getElementById(G);c&&o.locationId&&Kt(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Jt=()=>{Hr()};var Or="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",te=new Map,Zt=async(o,e)=>{if(!o)return null;if(te.has(o))return te.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${Or}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),te.set(o,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return te.set(o,l),b.debug(`Resolved Contact Type for ${o}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),te.set(o,null),null}};var Qt=o=>o==="buyer"?"buyer":o==="seller"?"seller":o==="agent"||o==="closing_agent"||o==="closing_office"||o==="vendor"?"other":"seller";var ao="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Pr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Nr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Br=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:s})=>{let l=a||ao,d;if(s==="buyer"){let h=so.find(p=>p.label===t),m=h?h.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:t,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:o,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Rr=async({contactId:o,tenantId:e})=>{let t=await fetch(Nr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var J="ws-crm-contact-actions-bar",$r="ws-crm-call-status-dropdown",eo="ws-crm-offer-made-modal",Gr=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],so=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Ur=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],zr=async()=>{for(let o of Ur)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},qr=({contactId:o,kind:e})=>{let t=e==="buyer"?so:Gr,r=e==="buyer"?Pr:ao,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=$r,a.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=A,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${rt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=i.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let h=s.firstElementChild,m=s.children[1],p=s.children[2];h&&(h.style.background=rt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let g=S()?.locationId,x=I();if(!g){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=i.amber);return}if(e==="seller"&&d.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=i.amber);return}let y=p?.textContent??"\u25BE",v=async f=>{p&&(p.textContent="\u2026"),s.style.opacity="0.75";try{await Br({contactId:o,locationId:g,status:d.label,userId:x,deadReason:f,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=y),s.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=i.amber),s.style.opacity="1",setTimeout(()=>{p&&(p.textContent=y),m&&(m.style.color=i.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";Kr(E=>{v(E)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await Rr({contactId:o,tenantId:g})).ok?await v():Yr(()=>{v()},()=>{m&&(m.textContent=f)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await v()}return}await v()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(s),a.appendChild(l),a},Vr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Wr=async o=>{let e=await fetch(Vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},jr=(o,e="seller")=>{document.getElementById(eo)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=t?i.emerald:i.amber,s=document.createElement("div");s.id=eo,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",l=>{l.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},ro=(o,e)=>{let t=document.createElement("div");if(t.id=J,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${i.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=R,r.textContent="Offer Made",r.addEventListener("click",()=>jr(o,e)),t.appendChild(r),t.appendChild(qr({contactId:o,kind:e}))}return t},st=!1,Xr=()=>{document.querySelectorAll(`[id="${J}"]`).forEach(o=>o.remove())},io=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),st){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}st=!0;try{await Jr()}finally{st=!1}},Jr=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Xr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Zt(o.contactId,o.locationId),h=Qt(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${J}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await zr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ro(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(J)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${J}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=ro(o.contactId,e);p.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(_){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},no=null,Zr=()=>{no===null&&(no=window.setInterval(()=>{let o=S();o&&(document.getElementById(J)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),io()))},3e3))},lo=()=>{Zr(),io()};var Se="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Qr=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),oe="data-ws-crm-favicon",it=o=>o.hasAttribute(oe),co=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Qr.has(e)},Ce=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{co(r)&&!it(r)&&r.remove()});let e=document.head.querySelector(`link[${oe}="1"]`);e?e.href!==Se&&(e.href=Se):(e=document.createElement("link"),e.setAttribute(oe,"1"),e.rel="icon",e.type="image/png",e.href=Se,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${oe}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(oe,"apple"),t.rel="apple-touch-icon",t.href=Se,document.head.appendChild(t))},bo=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Ce();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Ce())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&co(s)&&!it(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&it(s)&&(n=!0)});n&&Ce()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Ce(),e>=5&&window.clearInterval(t)},1e3)};var en=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],tn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,on=".hr-card.hr-modal.crm-opportunities-modal",L=()=>{let o=document.querySelector(on);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(tn);if(n){let a=n[1];if(en.includes(a))return a}}return null},U=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=L();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",ho="ws-crm-mt-offer-made-modal",nn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,an=/\/v2\/location\/([A-Za-z0-9]+)/,Le=()=>{let o=window.location.pathname,e=o.match(nn);if(!e)return null;let t=o.match(an);return{oppId:e[1],locationId:t?t[1]:null}},sn=async o=>{let e=await fetch(rn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ie=()=>{document.getElementById(ho)?.remove()},ln=o=>{Ie();let e=document.createElement("div");e.id=ho,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),a=t.querySelector("#ws-mt-offer-cancel"),s=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Ie()}),a?.addEventListener("click",()=>Ie()),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await sn({oppId:o.oppId,locationId:o.locationId,amount:c,userId:I()});if(!h.ok){n.textContent=h.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1);return}Ie(),o.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",a&&(a.disabled=!1)}})},dn=o=>{let e=document.createElement("button");return e.id=D,e.type="button",e.dataset.oppId=o,e.style.cssText=A,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Le();!t||!t.locationId||t.oppId!==o||ln({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=A)},4e3)}})}),e},cn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bn=async()=>{for(let o of cn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ae=!1,bt=async()=>{if(!Ae){Ae=!0;try{await hn()}finally{Ae=!1}}},hn=async()=>{let o=Le();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ne();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),ne());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await bn();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Le();if(!n||n.oppId!==o.oppId)return;let a=dn(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),pn(o.oppId)},re=null,ct=null,ne=()=>{re?.disconnect(),re=null,ct=null},pn=o=>{if(re&&ct===o)return;ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ct=o,re=new MutationObserver(()=>{let t=Le();if(!t||t.oppId!==o){ne();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ne();return}document.getElementById(D)||bt()}),re.observe(e,{childList:!0,subtree:!0}))},lt=null,dt,mn=()=>{lt||(lt=new MutationObserver(()=>{dt===void 0&&(dt=window.setTimeout(()=>{dt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!Ae&&bt()},300))}),lt.observe(document.body,{childList:!0,subtree:!0}))},po=()=>{mn(),bt()};var un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",H="ws-crm-not-interested-button",_n=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vn=/\/v2\/location\/([A-Za-z0-9]+)/,Me=()=>{let o=window.location.pathname,e=o.match(_n);if(!e)return null;let t=o.match(vn);return{oppId:e[1],locationId:t?t[1]:null}},yn=async o=>{let e=await fetch(un,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},gn=o=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=o,e.style.cssText=A,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Me();if(!t||!t.locationId||t.oppId!==o)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await yn({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},fn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wn=async()=>{for(let o of fn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Fe=!1,ut=async()=>{if(!Fe){Fe=!0;try{await xn()}finally{Fe=!1}}},xn=async()=>{let o=Me();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),se();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),se());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await wn();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Me();if(!n||n.oppId!==o.oppId)return;let a=gn(o.oppId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),kn(o.oppId)},ae=null,mt=null,se=()=>{ae?.disconnect(),ae=null,mt=null},kn=o=>{if(ae&&mt===o)return;se();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(mt=o,ae=new MutationObserver(()=>{let t=Me();if(!t||t.oppId!==o){se();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),se();return}document.getElementById(H)||ut()}),ae.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,En=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Fe&&ut()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{En(),ut()};var Tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",O="ws-crm-reduce-price-button",uo="ws-crm-reduce-price-modal",Sn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cn=/\/v2\/location\/([A-Za-z0-9]+)/,Oe=()=>{let o=window.location.pathname,e=o.match(Sn);if(!e)return null;let t=o.match(Cn);return{oppId:e[1],locationId:t?t[1]:null}},In=async o=>{let e=await fetch(Tn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},De=()=>{document.getElementById(uo)?.remove()},An=o=>{De();let e=document.createElement("div");e.id=uo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),s=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&De()}),a?.addEventListener("click",()=>{De()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await In({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:I()}),De(),o.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},Ln=(o,e)=>{let t=document.createElement("button");return t.id=O,t.type="button",t.dataset.oppId=o,t.style.cssText=A,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Oe();!r||!r.locationId||r.oppId!==o||An({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=A,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},Fn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mn=async()=>{for(let o of Fn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,gt=async()=>{if(!He){He=!0;try{await Dn()}finally{He=!1}}},Dn=async()=>{let o=Oe();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),le();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=L();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),le());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await Mn();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Oe();if(!n||n.oppId!==o.oppId)return;let a=Ln(o.oppId,o.locationId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),Hn(o.oppId)},ie=null,yt=null,le=()=>{ie?.disconnect(),ie=null,yt=null},Hn=o=>{if(ie&&yt===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yt=o,ie=new MutationObserver(()=>{let t=Oe();if(!t||t.oppId!==o){le();return}let r=L();if(r!==null&&r!=="Disposition"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),le();return}document.getElementById(O)||gt()}),ie.observe(e,{childList:!0,subtree:!0}))},_t=null,vt,On=()=>{_t||(_t=new MutationObserver(()=>{vt===void 0&&(vt=window.setTimeout(()=>{vt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!He&&gt()},300))}),_t.observe(document.body,{childList:!0,subtree:!0}))},_o=()=>{On(),gt()};var go="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-closing-office-button",j="ws-crm-send-to-title-co-wrap",Be="ws-crm-stc-dropdown",Pn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nn=/\/v2\/location\/([A-Za-z0-9]+)/,Re=()=>{let o=window.location.pathname,e=o.match(Pn);if(!e)return null;let t=o.match(Nn);return{oppId:e[1],locationId:t?t[1]:null}},Bn=5*60*1e3,fo=o=>`ws-crm-stc-cache:${o}`,Rn=o=>{try{let e=window.localStorage.getItem(fo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>Bn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},$n=(o,e)=>{try{window.localStorage.setItem(fo(o),JSON.stringify(e))}catch{}},Gn=async(o,e)=>{try{let t=await fetch(go,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Un=async(o,e,t)=>{let r=await fetch(go,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},zn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},vo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},qn=(o,e)=>{if(e&&zn(e)){window.setTimeout(()=>vo(o),300);return}vo(o)},P=()=>{document.getElementById(Be)?.remove()},Pe=(o,e,t)=>{P();let r=document.createElement("div");r.id=Be;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let a=o.length,s=o.filter(_=>_.filled).length,l=s===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...c.filter(_=>h[_]),...Object.keys(h).filter(_=>!c.includes(_))];for(let _ of m){let g=h[_],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let y=document.createElement("div");y.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
  ...
  `,B(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let y=await Gn(o,e);if(!y){n={status:"error",message:"Check failed \u2014 click to retry"},B(t,n);return}if(y.rate_limited){_=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},B(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){n={status:"error",message:y.error||"Check failed \u2014 click to retry"},B(t,n),b.warn("[stc] dry_run returned no checks:",y);return}let v=y.pipeline_name;if(v&&v!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${v}" (not TC) \u2014 retracting button + caching`),$e.add(o),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P(),ce();return}let f=y.checks;if(n.checks&&n.checks.length===y.checks.length){let T=new Set;f=y.checks.map((k,M)=>n.checks[M]?.filled&&!k.filled?a.has(k.label)?k:(T.add(k.label),{...k,filled:!0}):k),a=T}else a=new Set;n={status:f.every(T=>T.filled)?"ready":"incomplete",checks:f,previouslySentAt:y.previously_sent_at??null},$n(o,{checks:f,previously_sent_at:y.previously_sent_at??null,pipeline_name:v,ts:Date.now()}),B(t,n),document.getElementById(Be)&&Pe(f,y.previously_sent_at,t)},l=async()=>{let y=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},B(t,n),P();try{let v=await Un(o,e,y);if(v.needs_confirm){n={status:"ready",checks:v.checks,previouslySentAt:v.previously_sent_at},B(t,n),v.checks&&Pe(v.checks,v.previously_sent_at,t);return}if(v.ok){n={status:"sent",checks:v.checks,previouslySentAt:new Date().toISOString()},B(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:v.checks,message:v.error||"Validation failed"},B(t,n),v.checks&&Pe(v.checks,v.previously_sent_at,t)}catch(v){b.error("[stc] send failed:",v),n={status:"error",message:"Network error \u2014 click to retry"},B(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(Be)?P():n.checks&&Pe(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,_=0,g=async()=>{if(!c){if(Date.now()<_){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let y=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-h,E=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});y.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let v=window.setInterval(()=>{document.body.contains(t)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(v))},5e3)}return t},Wn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jn=async()=>{for(let o of Wn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},$e=new Set,yo=null,Kn=o=>{o&&o!==yo&&($e.clear(),yo=o)},Ne=!1,kt=async()=>{if(Ne){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ne=!0;try{await Yn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Ne=!1}},Yn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=Re();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`),Kn(o.oppId),$e.has(o.oppId)){b.debug(`[stc] mount:02-BAIL opp ${o.oppId} previously confirmed non-TC this session`),document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P();return}let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=L();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(j)?.remove(),P(),ce());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(j)?.remove(),P()),b.debug("[stc] mount:04 calling findMountTarget");let t=await jn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=L();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Re();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=Vn(o.oppId,n.locationId),s=document.createElement("span");s.id=j,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Xn(o.oppId)},de=null,xt=null,ce=()=>{de?.disconnect(),de=null,xt=null},Xn=o=>{if(de&&xt===o)return;ce();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt=o,de=new MutationObserver(()=>{let t=Re();if(!t||t.oppId!==o){ce();return}let r=L();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(j)?.remove(),P(),ce();return}document.getElementById(z)||kt()}),de.observe(e,{childList:!0,subtree:!0}))},ft=null,wt,Jn=()=>{ft||(ft=new MutationObserver(()=>{wt===void 0&&(wt=window.setTimeout(()=>{wt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);if(o&&!e&&!Ne){let t=Re();if(t&&$e.has(t.oppId))return;kt()}},300))}),ft.observe(document.body,{childList:!0,subtree:!0}))},wo=()=>{Jn(),kt()};var Zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Qn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Eo="ldtyB2UXKi9vOp8nLUH7",ta="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",To="ws-crm-closing-agent-picker-modal",oa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ra=/\/v2\/location\/([A-Za-z0-9]+)/,pe=()=>{let o=window.location.pathname,e=o.match(oa);if(!e)return null;let t=o.match(ra);return{oppId:e[1],locationId:t?t[1]:null}},Ft=async o=>{let e=await fetch(Zn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,contact_type:o.contactType??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},xo=async o=>{let e=await fetch(Qn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},na=async(o,e)=>{try{let t=await fetch(ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:Eo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Ft({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[closing-agent] fetchCurrent failed:",t),null}},K=null,aa=60*60*1e3,Mt=o=>`ws-crm-to-cache:${o}`,So=o=>{try{let e=window.localStorage.getItem(Mt(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>aa||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},Co=(o,e,t)=>{try{window.localStorage.setItem(Mt(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},sa=o=>{try{window.localStorage.removeItem(Mt(o))}catch{}},Ct="ws-crm-closing-agent-field-link",ia=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${Ct}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Et=!1,Dt=async o=>{if(Et)return;let e=Io();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[closing-agent] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==t){Et=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${t}`);let r=await Ft({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),It(n.id,n.name,o);let a=document.getElementById(N);if(a){q(a,{status:"linked",contactName:n.name});let s=pe();s&&Co(s.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Et=!1}}},la=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Io=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();la.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=t[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},It=(o,e,t)=>{let r=Io();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${Ct}`).forEach(s=>s.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=o,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=Ct,l.href=`/v2/location/${t}/contacts/detail/${o}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${w.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},Ge=()=>{document.getElementById(To)?.remove()},da=o=>{Ge();let e=document.createElement("div");e.id=To,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ge()}),a?.addEventListener("click",Ge);let s,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await Ft({tenantId:o.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${Ue(m.name)}</div>
          <div style="color: ${i.ash}; font-size: 11px; margin-top: 2px;">
            ${Ue(m.email||"(no email)")} \xB7 ${Ue(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Ue(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=i.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{Ge(),o.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${i.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},Ue=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),q=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Closing Agent",a=i.amber,s=i.bone,l="transparent",d=i.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=i.coolGray,s=i.ash,c="wait";break;case"empty":n="Link Closing Agent",a=i.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=i.emerald,l=i.emeraldGlow,d=i.emeraldBorder,s=i.emeraldBright;break;case"saving":n="Linking\u2026",a=i.coolGray,s=i.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=l,o.style.borderColor=d,o.style.color=s,o.style.cursor=c},ca=(o,e)=>{let t=document.createElement("button");t.id=N,t.type="button",t.dataset.oppId=o,t.style.cssText=A,t.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};q(t,r);let n=So(o);return n&&(r={status:"linked",contactName:n.contactName},q(t,r),K={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let s=await na(o,e);s?(r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},It(s.id,s.name,e)):n||(r={status:"empty"},q(t,r),K?.oppId===o&&(K=null),ia(),sa(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||da({oppId:o,locationId:e,onPick:async s=>{r={status:"saving"},q(t,r);try{let l=[xo({tenantId:e,oppId:o,fieldId:Eo,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(xo({tenantId:e,oppId:o,fieldId:ta,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},q(t,r),K={oppId:o,contactId:s.id,contactName:s.name,tenantId:e},Co(o,s.id,s.name),It(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},q(t,r)}}})}),t},ba=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ha=async()=>{for(let o of ba)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},be=!1,qe=async()=>{if(!be){be=!0;try{await pa()}finally{be=!1}}},pa=async()=>{let o=pe();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ze();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let d=L();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),ze());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=L();if(t!==null&&t!=="Transaction Coordination")return;let r=await ha();if(!r||!(So(o.oppId)!==null||K!==null&&K.oppId===o.oppId)&&await U()!=="Transaction Coordination")return;let a=pe();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=ca(o.oppId,a.locationId),l=document.createElement("span");l.id=`${N}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${o.oppId}`),ma(o.oppId),Dt(a.locationId)},he=null,At=null,Lt=null,ze=()=>{he?.disconnect(),he=null,At=null,Lt=null},ma=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(he&&At===o&&Lt===e||(ze(),At=o,Lt=e,he=new MutationObserver(()=>{let t=pe();if(!t||t.oppId!==o||!t.locationId){ze();return}document.getElementById(N)||qe(),Dt(t.locationId)}),he.observe(e,{childList:!0,subtree:!0})))},Tt=null,St,ua=()=>{Tt||(Tt=new MutationObserver(()=>{St===void 0&&(St=window.setTimeout(()=>{St=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!be&&qe()},300))}),Tt.observe(document.body,{childList:!0,subtree:!0}))},ko,_a=()=>{ko===void 0&&(ko=window.setInterval(()=>{let o=pe();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(N)&&!be&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),qe()),Dt(o.locationId)},2e3))},Ao=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),ua(),_a(),qe()};var va="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ht="ws-crm-prepare-contract-button",Lo="ws-crm-prepare-contract-menu",Fo="ws-crm-prepare-contract-modal",ue="https://services.leadconnectorhq.com",Oo=()=>window.__WS_CRM_CAPTURED_AUTH||null,ya=o=>{window.__WS_CRM_CAPTURED_AUTH=o},_e=()=>{let o=Oo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,o?`present (captured ${Date.now()-o.capturedAt}ms ago, ${o.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!o)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let t={Authorization:o.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return o.tokenId&&(t["token-id"]=o.tokenId),t};var Mo=!1,ga=()=>{if(Mo)return;Mo=!0;let o=window;o.__WS_CRM_DIAG=o.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{o.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){o.__WS_CRM_DIAG.fetchCalls+o.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?o.__WS_CRM_DIAG.fetchAuthSeen++:o.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=Oo()?.authorization;ya({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(o.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},t=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){o.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return t.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(o.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Po=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},fa=o=>{let e=(o||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},wa=async o=>{let e=`${ue}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(o)}&skip=0&limit=10`,t=await fetch(e,{method:"GET",headers:_e()});if(!t.ok){let a="";try{a=await t.text()}catch{}let s=a?` \u2014 ${a.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${t.status} ${t.statusText}${s}`)}let r=await t.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(a=>({id:(a._id??a.id??a.templateId)||"",name:a.name||a.title||"(unnamed template)",type:fa(a.name||a.title||"")})).filter(a=>!!a.id)},xa=async(o,e)=>{let t=await fetch(`${ue}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:_e()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${ue}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:_e()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},ka=async o=>{let e=await fetch(va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,template_id:o.templateId,template_type:o.templateType,opp_id:o.oppId,closing_date:o.closingDate,buyer_earnest_due_date:o.buyerEarnestDueDate,lender_source:o.lenderSource,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Ea=async(o,e)=>{let t=await fetch(`${ue}/proposals/templates/to-proposal/${o}/${e}?locale=en-US`,{method:"POST",headers:_e()});if(!t.ok)throw new Error(`to-proposal HTTP ${t.status} ${t.statusText}`);let r=await t.json(),n=r._id||r.id||r.proposal?._id||r.proposal?.id;if(!n)throw new Error("to-proposal returned no proposal id");return n},Ta=async(o,e)=>{let t=await fetch(`${ue}/proposals/document/${o}`,{method:"PUT",headers:{..._e(),"Content-Type":"application/json"},body:JSON.stringify({contactId:e})});if(!t.ok)throw new Error(`assign-contact HTTP ${t.status} ${t.statusText}`)},Sa=(o,e)=>{let t=`/v2/location/${o}/payments/proposals-estimates/edit/${e}`;window.location.href=t},Do="ws-crm-prepare-contract-toast",me=(o,e="info",t=4e3)=>{document.getElementById(Do)?.remove();let r=document.createElement("div");r.id=Do;let n=e==="error"?i.crimson:i.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=o,document.body.appendChild(r),window.setTimeout(()=>r.remove(),t)},Ca=({tenantId:o,contactId:e,template:t,mtOpps:r,userId:n})=>{document.getElementById(Fo)?.remove();let a=document.createElement("div");a.id=Fo,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        ...
        <div style="
          ...
          font-size: 13px;
          color: ${i.bone};
        ">${Z(r[0].propertyAddress||r[0].name)}</div>
        <input type="hidden" id="ws-pc-opp-id" value="${Ho(r[0].id)}" />
      `;let y=r.map(v=>`<option value="${Ho(v.id)}">${Z(v.propertyAddress||v.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${u.mono};
        font-size: 10px;
  ...
  `,a.appendChild(s),document.body.appendChild(a);let _=()=>a.remove();if(a.addEventListener("click",y=>{y.target===a&&_()}),s.querySelector("#ws-pc-cancel")?.addEventListener("click",_),p)return;let g=s.querySelector("#ws-pc-submit"),x=s.querySelector("#ws-pc-error");g?.addEventListener("click",async()=>{if(!g)return;let y=s.querySelector("#ws-pc-opp-id"),v=(s.querySelector("#ws-pc-closing-date")?.value??"").trim(),f=(s.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(s.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(y?.value||"").trim();if(!T){x&&(x.textContent="Pick a subject property.");return}if(!v){x&&(x.textContent="Closing Date is required.");return}x&&(x.textContent=""),g.disabled=!0,g.textContent="Preparing\u2026";try{await No({tenantId:o,contactId:e,template:t,oppId:T,closingDate:v,buyerEarnestDueDate:f,lenderSource:E,userId:n}),_()}catch(k){g.disabled=!1,g.textContent="Stage & Open Contract",x&&(x.textContent=k.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",k)}})},No=async({tenantId:o,contactId:e,template:t,oppId:r,closingDate:n,buyerEarnestDueDate:a,lenderSource:s,userId:l})=>{b.info(`[prepare-contract] FLOW START \u2014 template "${t.name}" (${t.type}), contact=${e}`),b.info("[prepare-contract] step 1/4 \u2014 POST to Contract.Stage webhook");let d=await ka({tenantId:o,contactId:e,templateId:t.id,templateType:t.type,oppId:r,closingDate:n,buyerEarnestDueDate:a,lenderSource:s,userId:l});if(b.info(`[prepare-contract] stage response: ok=${d.ok}`,d),!d.ok)throw new Error(d.error||"Contract.Stage returned not ok");b.info("[prepare-contract] step 2/4 \u2014 POST /proposals/templates/to-proposal");let c=await Ea(o,t.id);b.info(`[prepare-contract] step 2/4 done \u2014 proposal created: ${c}`),b.info("[prepare-contract] step 3/4 \u2014 PUT /proposals/document/{id} (assign contact)"),await Ta(c,e),b.info("[prepare-contract] step 3/4 done \u2014 contact assigned"),b.info(`[prepare-contract] step 4/4 \u2014 redirecting to /payments/proposals-estimates/edit/${c}`),Sa(o,c)},Ia=async o=>{let e=Po();if(!e){me("Could not resolve contact context.","error");return}document.getElementById(Lo)?.remove();let t=document.createElement("div");t.id=Lo,t.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,t.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,o.appendChild(t);let r=a=>{!t.contains(a.target)&&a.target!==o&&(t.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await wa(e.tenantId)}catch(a){t.innerHTML=`
      <div style="padding: 12px 14px; color: ${i.crimson}; font-size: 12px;">
        Failed to load templates: ${Z(a.message)}
      ...
      </div>`;return}n.sort((a,s)=>{let l={PA:0,AA:1,passthrough:2};return l[a.type]!==l[s.type]?l[a.type]-l[s.type]:a.name.localeCompare(s.name)}),t.innerHTML="";for(let a of n){let s=document.createElement("button");s.type="button",s.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
    ...
    `;let l=a.type==="PA"?i.emerald:a.type==="AA"?i.blue:i.coolGray;s.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${Z(a.name)}</span>
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),t.remove(),document.removeEventListener("click",r,!0);let c=I();try{if(a.type==="AA"){let h;try{h=await xa(e.tenantId,e.contactId)}catch(m){me(`Failed to load buyer's MT opps: ${m.message}`,"error");return}Ca({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:h,userId:c})}else{me(`Preparing ${a.name}\u2026`,"info",2500);try{await No({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:c})}catch(h){me(`Failed to prepare contract: ${h.message}`,"error",6e3),b.warn("[prepare-contract] flow failed:",h)}}}catch(h){b.warn("[prepare-contract] picker click handler failed:",h),me(`Unexpected error: ${h.message}`,"error",6e3)}}),t.appendChild(s)}},Aa=()=>{let o=document.createElement("button");return o.id=Ht,o.type="button",o.style.cssText=`
    position: relative;
    background: ${i.slate};
    border: 1px solid ${i.steel};
    border-radius: ${w.sm};
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.borderColor=i.emerald}),o.addEventListener("mouseleave",()=>{o.style.borderColor=i.steel}),o.addEventListener("click",e=>{e.stopPropagation(),Ia(o)}),o},La="ws-crm-contact-actions-bar",Fa=async()=>{let o=Po();if(!o){document.getElementById(Ht)?.remove();return}let e=null;try{e=await C(`#${La}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let t=document.getElementById(Ht);if(t){if(t.dataset.contactId===o.contactId)return;t.remove()}let r=Aa();r.dataset.contactId=o.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${o.contactId}`)},Bo=()=>{Fa()};ga();function Z(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ho(o){return Z(o)}var Xe="reos-theme-stylesheet",or="reos-theme-fonts",Ma=()=>{let o=document.getElementById(or);o&&o.remove()},Da=`
/* ============================================
...
`,Ha=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Oa=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${a})`}return`rgb(${t}, ${r}, ${n})`},Pa=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Na=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Ot=new WeakSet,Ro=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Ot.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let t=e.tagName;if(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="SCRIPT"||t==="STYLE"||t==="SVG"||t==="PATH"||t==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let s=+a[1],l=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Ot.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Ot.add(e)}catch{}})}catch{}},$o=new WeakSet,ve=()=>{document.querySelectorAll(Na.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if($o.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let s=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),$o.add(r))})})},Go=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Ve=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let t=e.parentElement,r=0;for(;t&&r<6&&t!==document.body;){if(r+=1,t.id?.startsWith("ws-crm-")||t.classList.contains("hl_header")||t.classList.contains("app-header")||t.tagName==="MAIN"||t.tagName==="BODY")return;let s=window.getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&t.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"))}t=t.parentElement}})},Uo=()=>{let o="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;(t.getAttribute("style")||"").includes(o)&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"))})},ye=()=>{for(let o of Ha){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let a=t.style.getPropertyPriority(r),s=t.style.getPropertyValue(r),l=Pa.has(r)?Oa(n):n;a==="important"&&s===l||t.style.setProperty(r,n,"important")}})}},Je="#1A1F28",Ba=26,Ra=31,$a=40,zo=new Set,qo=new Set,We=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!qo.has(n)&&n!=="<no class>"&&(qo.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},Ga=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Ua=["trash","Trash","TRASH","delete","Delete","DELETE"],za=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(Ua.some(a=>n.includes(a))&&(r=!0),r||t.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";Ga.some(d=>l.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},qa=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Va=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||qa.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Vo=new Set,Wo=new WeakSet,Wa=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Wo.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Wo.add(e);let h=e.className?.toString()||"<no class>";!Vo.has(h)&&h!=="<no class>"&&(Vo.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},jo=new Set,ja=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let s=(a.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(a),d=l.backgroundColor,c=l.backgroundImage||"",h=!1;if(c!=="none"&&c.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let k=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let M=parseInt(k[1],10),$=parseInt(k[2],10),Qe=parseInt(k[3],10);(M>=60||$>=60||Qe>=60)&&(M>230&&$>230&&Qe>230||(M>=80||$>=80||Qe>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),_=s,g=Array.from(a.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),x=p.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),y=_.includes("bg-clip-text")||_.includes("text-transparent")||g.includes("bg-clip-text")||g.includes("text-transparent"),v=Array.from(a.querySelectorAll("*")).some(T=>{let k=window.getComputedStyle(T),M=k.getPropertyValue("-webkit-background-clip")||"",$=k.getPropertyValue("background-clip")||"";return M.includes("text")||$.includes("text")});if(x||y||v){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=M=>{T.forEach($=>M.style.removeProperty($))};k(a),a.querySelectorAll("*").forEach(k);return}let f="#12161D";a.style.setProperty("color",f,"important"),a.querySelectorAll("*").forEach(T=>{let k=T.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(T.style.setProperty("fill",f,"important"),T.style.setProperty("stroke",f,"important"),T.style.setProperty("color",f,"important")):(T.style.setProperty("color",f,"important"),T.style.setProperty("-webkit-text-fill-color",f,"important"))});let E=a.className?.toString()||"<no class>";!jo.has(E)&&E!=="<no class>"&&(jo.add(E),b.debug(`Darkened SVG icons on colored button: "${E}"`))})})},Ko=new Set,Ka=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let g=h.width*h.height/(r.width*r.height);if(g>.55)return;let x=c,y=c.parentElement,v=0;for(;y&&y!==e&&v<3;){let E=y.getBoundingClientRect();if(E.width>0&&E.width<=30&&E.height<=30)x=y;else break;y=y.parentElement,v++}x.style.setProperty("transform","translateY(11px)","important");let f=(x.className?.toString()||"")+" "+x.tagName;Ko.has(f)||(Ko.add(f),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${g.toFixed(2)}): "${f}"`))})})},Ya="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Xa=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Ya,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Yo=new Set,Ja=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!Yo.has(h)&&h!=="<no class>"&&(Yo.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${c})): "${h}"`))})})},Xo=new Set,Za=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let s=t.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let l=t.className?.toString()||"<no class>";!Xo.has(l)&&l!=="<no class>"&&(Xo.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}t=t.parentElement,r++}})},Jo=new Set,Qa=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let s=parseInt(a.zIndex,10);if(!isFinite(s)||s<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let y=s.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let y=s.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let h=parseInt(c[1],10),m=parseInt(c[2],10),p=parseInt(c[3],10);if(!(h>200&&m>200&&p>200))return;let g=s.getBoundingClientRect();if(g.width<24||g.height<16||g.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let x=s.className?.toString()||"<no class>";!Jo.has(x)&&x!=="<no class>"&&(Jo.add(x),b.debug(`Coerced light bg (${g.width.toFixed(0)}x${g.height.toFixed(0)}, rgb(${h},${m},${p})): "${x}"`))})})},Zo=new Set,es=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=t.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,a=null;for(let f=0;f<4&&n;f++){let E=n.nextElementSibling;if(E&&(E.matches(o)||E.querySelector(o)!==null)){a=E;break}n=n.parentElement}if(!a)return;let s=t.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=a,d=l.getBoundingClientRect(),c=l.className?.toString()||"",h=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let g=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!_&&!g&&!x&&!y&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Je,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let v=t.className?.toString()||"<no class>";!Zo.has(v)&&v!=="<no class>"&&(Zo.add(v),b.debug(`Colored field label "${r.slice(0,30)}": "${v}"`))})},Qo=new Set,ts=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Qo.has(d)&&d!=="<no class>"&&(Qo.add(d),b.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},er=new Set,os=new Set(["Enter Dashboard Name"]),rs=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;let r=e.placeholder||"";if(os.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Je,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",Je,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!er.has(a)&&a!=="<no class>"&&(er.add(a),b.debug(`Forced input slate bg: "${a}"`))})},je=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>t.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let s=parseInt(a[1],10),l=parseInt(a[2],10),d=parseInt(a[3],10);if(!(s<Ba&&l<Ra&&d<$a))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",Je,"important");let m=e.className?.toString()||"<no class>";!zo.has(m)&&m!=="<no class>"&&(zo.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},Ke=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let l=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,h=!1;if(e.forEach(_=>{c.includes(_)&&(c=c.split(_).join(o),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{c.includes(_)&&(c=c.split(_).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(g=>{c.includes(g)&&(c=c.split(g).join("#EDEEF0"),h=!0)}),!!h)try{let _=btoa(c);a.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let s=a.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;a.setAttribute("data-reos-masked","1");let l=`url("${s}")`;a.style.setProperty("-webkit-mask-image",l,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",l,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",t)})},Ye=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},ns=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color")||t.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},ge=()=>{let o=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{o(n),n.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||o(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{o(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",c,"important"),h.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(a)))})},Pt=new WeakSet,as=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Pt.has(e))try{let t=e.contentDocument||e.contentWindow?.document;if(!t||!t.head)return;if(t.querySelector("style[data-ws-crm-email-fix]")){Pt.add(e);return}let r=t.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,o.textContent=`Customizer v${ke}`,o.title=`Built ${Ee}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var F=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},ar=()=>{b.info(`Loaded v${ke} (built ${Ee})`),F("mountVersionBadge (initial)",Ze),F("mountFavicon",bo),F("mountThemeStylesheet",rr),F("initPageRouter",Gt),b.info("[main] registering onPageChange subscriber"),$t(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),F("mountVersionBadge",Ze),F("mountClaimReleaseToggle",Jt),F("mountContactActionsBar",lo),F("mountActiveFollowUpButton",jt),F("mountMtOfferMadeButton",po),F("mountNotInterestedButton",mo),F("mountReducePriceButton",_o),F("mountSendToClosingOfficeButton",wo),F("mountClosingAgentPickerButton",Ao),F("mountPrepareContractButton",Bo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ar):ar();})();
