...
`;var Wt=/^[A-Za-z0-9]{15,30}$/,W=o=>typeof o=="string"&&Wt.test(o),jt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Kt=()=>{let o=window.WS_CRM_USER_ID;return W(o)?o:null},Yt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(W(t))return t;return null},Xt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=jt(e);if(!t)return null;let r=t.uid;if(W(r))return r;let n=t.claims;if(n&&W(n.user_id))return n.user_id}catch{}return null},Jt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(W(n))return n}catch{}}}catch{}return null},I=()=>Kt()||Yt()||Xt()||Jt()||null;var Qe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Qt=`${Qe}/active-follow-up-get`,Zt=`${Qe}/active-follow-up-set`,O="ws-crm-active-follow-up-button",Fe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},eo=()=>{let o=E();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},to=async o=>{let e=await fetch(Qt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},oo=async(o,e)=>{let t=await fetch(Zt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},B=(o,e)=>{let t=Fe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ye=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,B(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=eo();if(!(!r||r.contactId!==o)){B(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await oo(r,I()),a=n&&n.state&&n.state in Fe?n.state:"blue";B(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),B(e,"error"),setTimeout(()=>void de(e,r),4e3)}}}),e},de=async(o,e)=>{B(o,"loading");try{let t=await to(e),r=t&&t.state&&t.state in Fe?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;B(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),B(o,"error")}},ro=[".central-panel","[class*='central-panel']"],Le="ws-crm-contact-actions-bar",no=async()=>{for(let o of ro)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ao=async(o,e)=>{let t=e.querySelector(`#${Le}`);if(!t)try{t=await C(`#${Le}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Le}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},so=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},io=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},lo=async o=>{if(o==="url"){let t=await no();return t?{kind:"contact-detail",target:t}:null}let e=so();return e?{kind:"conversations",target:e}:null},Xe=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await ao(o,e.target);return t}return io(o,e.target),"conversations-header"},co=async()=>{let o=E();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){de(t,e);return}t&&t.remove();let r=await lo(o.source);if(!r){c.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=E();if(!n||n.contactId!==e.contactId)return;let a=Ye(e.contactId),i=await Xe(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Je();let s=document.getElementById(O)??a;de(s,e);let d=new MutationObserver(()=>{let b=document.getElementById(O);if(!(E()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=Ye(e.contactId);Xe(m,r).then(()=>{Je(),de(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},j=null,Ze=()=>{let o=E()?.contactId??null;if(j&&j.contactId===o)return;let e=co().finally(()=>{j?.promise===e&&(j=null)});j={contactId:o,promise:e}},Je=()=>{let o=document.querySelectorAll(`#${O}`);if(!(o.length<=1)){c.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var H="ws-crm-claim-release-pill",bo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ho="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",po=async o=>{let e=await fetch(bo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},mo=async o=>{let e=await fetch(ho,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ot=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},V=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=le(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=pe();if(!t||!t.locationId||t.oppId!==o)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await $o({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,c.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Uo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],qo=async()=>{for(let o of Uo)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Oe=async()=>{if(!he){he=!0;try{await zo()}finally{he=!1}}},zo=async()=>{let o=pe();if(!o||!o.locationId){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}let e=document.getElementById(L);if(e&&e.dataset.oppId===o.oppId){let s=R();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove(),J());return}e&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove());let t=await qo();if(!t){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await vt();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=pe();if(!n||n.oppId!==o.oppId)return;let a=Vo(o.oppId),i=document.createElement("span");i.id=`${L}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted Not Interested button on opp ${o.oppId}`),Wo(o.oppId)},X=null,Pe=null,J=()=>{X?.disconnect(),X=null,Pe=null},Wo=o=>{if(X&&Pe===o)return;J();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pe=o,X=new MutationObserver(()=>{let t=pe();if(!t||t.oppId!==o){J();return}let r=R();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}document.getElementById(L)||Oe()}),X.observe(e,{childList:!0,subtree:!0}))},He=null,Ne,jo=()=>{He||(He=new MutationObserver(()=>{Ne===void 0&&(Ne=window.setTimeout(()=>{Ne=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(L);o&&!e&&!he&&Oe()},300))}),He.observe(document.body,{childList:!0,subtree:!0}))},yt=()=>{jo(),Oe()};var ft="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",G="ws-crm-send-to-title-co-button",q="ws-crm-send-to-title-co-wrap",ue="ws-crm-stc-dropdown",Ko=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yo=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let o=window.location.pathname,e=o.match(Ko);if(!e)return null;let t=o.match(Yo);return{oppId:e[1],locationId:t?t[1]:null}},Xo=async(o,e)=>{try{let t=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(c.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return c.warn("[stc] dry_run fetch failed:",t),null}},Jo=async(o,e,t)=>{let r=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Qo=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${o}"`),!1},gt=o=>{let e=document.getElementById(o);if(!e){c.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Zo=(o,e)=>{if(e&&Qo(e)){window.setTimeout(()=>gt(o),300);return}gt(o)},D=()=>{document.getElementById(ue)?.remove()},me=(o,e,t)=>{D();let r=document.createElement("div");r.id=ue;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,F(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let v=await Xo(o,e);if(!v){r={status:"error",message:"Check failed \u2014 click to retry"},F(t,r);return}if(v.rate_limited){h=Date.now()+m,r={status:"error",checks:r.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},F(t,r),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(h).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){r={status:"error",message:v.error||"Check failed \u2014 click to retry"},F(t,r),c.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}let g=v.checks;if(r.checks&&r.checks.length===v.checks.length){let w=new Set;g=v.checks.map((k,T)=>r.checks[T]?.filled&&!k.filled?n.has(k.label)?k:(w.add(k.label),{...k,filled:!0}):k),n=w}else n=new Set;r={status:g.every(w=>w.filled)?"ready":"incomplete",checks:g,previouslySentAt:v.previously_sent_at??null},F(t,r),document.getElementById(ue)&&me(g,v.previously_sent_at,t)},i=async()=>{let v=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},F(t,r),D();try{let _=await Jo(o,e,v);if(_.needs_confirm){r={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t);return}if(_.ok){r={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},F(t,r),window.setTimeout(()=>{u()},3500);return}r={status:"error",checks:_.checks,message:_.error||"Validation failed"},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t)}catch(_){c.error("[stc] send failed:",_),r={status:"error",message:"Network error \u2014 click to retry"},F(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(ue)?D():r.checks&&me(r.checks,r.previouslySentAt,t);break}case"error":case"sent":u();break}});let s,d=!1,b=Date.now(),p=1e4,m=5*60*1e3,h=0,u=async()=>{if(!d){if(Date.now()<h){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(h).toLocaleTimeString()}`);return}d=!0,b=Date.now();try{await a()}finally{d=!1}}};u();let f=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(f){let v=new MutationObserver(()=>{if(s!==void 0||d)return;let g=Date.now()-b,y=Math.max(1500,p-g);s=window.setTimeout(()=>{s=void 0,r.status!=="sending"&&u()},y)});v.observe(f,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),s!==void 0&&window.clearTimeout(s),window.clearInterval(_))},5e3)}return t},tr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],or=async()=>{for(let o of tr)try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_e=!1,Ve=async()=>{if(_e){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_e=!0;try{await rr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{_e=!1}},rr=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let o=Ge();if(!o||!o.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D();return}c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let i=R();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(q)?.remove(),D(),Z());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(q)?.remove(),D()),c.debug("[stc] mount:04 calling findMountTarget");let t=await or();if(!t){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=Ge();if(!r||r.oppId!==o.oppId||!r.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${r?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let n=er(o.oppId,r.locationId),a=document.createElement("span");a.id=q,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(n),t.appendChild(a),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(n)}`),nr(o.oppId)},Q=null,$e=null,Z=()=>{Q?.disconnect(),Q=null,$e=null},nr=o=>{if(Q&&$e===o)return;Z();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($e=o,Q=new MutationObserver(()=>{let t=Ge();if(!t||t.oppId!==o){Z();return}let r=R();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}document.getElementById(G)||Ve()}),Q.observe(e,{childList:!0,subtree:!0}))},Be=null,Re,ar=()=>{Be||(Be=new MutationObserver(()=>{Re===void 0&&(Re=window.setTimeout(()=>{Re=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(G);o&&!e&&!_e&&Ve()},300))}),Be.observe(document.body,{childList:!0,subtree:!0}))},wt=()=>{ar(),Ve()};var xe="reos-theme-stylesheet",Bt="reos-theme-fonts",sr=()=>{let o=document.getElementById(Bt);o&&o.remove()},ir=`
/* ============================================
