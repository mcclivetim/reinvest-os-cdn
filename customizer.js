/* Wholesaling CRM Customizer v0.13.49 — built 2026-05-26T16:33:30.309Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var oe="[wholesaling-crm-customizer]",Nt="__WS_CRM_DEBUG",Pt=()=>!!window[Nt],b={info(...o){console.log(oe,...o)},warn(...o){console.warn(oe,...o)},error(...o){console.error(oe,...o)},debug(...o){Pt()&&console.log(oe,"[debug]",...o)}};var Re=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ee=/\/v2\/location\/([A-Za-z0-9]+)/,Ot=o=>{let e=o.match(Re);if(!e)return null;let t=o.match(Ee);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Bt=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Re);if(!n)continue;let a=r.match(Ee)||window.location.pathname.match(Ee);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},T=()=>{let o=Ot(window.location.pathname);return o||Bt()};var Ge=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ne="",Se=null,G="other",Ce=new Set,re=()=>{let o=T()?.contactId??null;if(!(!(window.location.pathname!==ne)&&!(o!==Se))){ne=window.location.pathname,Se=o,G=Ge(),b.debug("Page/context changed:",G,ne,"contact:",o);for(let r of Ce)try{r(G)}catch(n){b.error("Subscriber threw:",n)}}},$e=o=>(Ce.add(o),setTimeout(()=>o(G),0),()=>{Ce.delete(o)}),Ve=()=>{G=Ge(),ne=window.location.pathname,Se=T()?.contactId??null,b.debug("Router init, current page:",G);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),re()},history.replaceState=function(t,r,n){e(t,r,n),re()},window.addEventListener("popstate",re),setInterval(re,1e3)};var ae="0.13.49",se="2026-05-26T16:33:30.309Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let l,c,p=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),l=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var d={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},y={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ae={purple:"#8B5CF6",green:d.emerald,orange:d.amber,red:d.crimson},ie=o=>{let e=o==="emerald"?d.emeraldGlow:o==="amber"?d.amberGlow:d.slate,t=o==="emerald"?d.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":d.steel,r=o==="emerald"?d.emerald:o==="amber"?d.amber:d.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,U=`
  ...
  flex-shrink: 0;
`;var Rt=/^[A-Za-z0-9]{15,30}$/,q=o=>typeof o=="string"&&Rt.test(o),Gt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},$t=()=>{let o=window.WS_CRM_USER_ID;return q(o)?o:null},Vt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(q(t))return t;return null},Ut=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Gt(e);if(!t)return null;let r=t.uid;if(q(r))return r;let n=t.claims;if(n&&q(n.user_id))return n.user_id}catch{}return null},qt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(q(n))return n}catch{}}}catch{}return null},A=()=>$t()||Vt()||Ut()||qt()||null;var We="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",zt=`${We}/active-follow-up-get`,Wt=`${We}/active-follow-up-set`,O="ws-crm-active-follow-up-button",Le={amber:{label:"Add to Active Follow Up",bg:d.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:d.amber,clickable:!0,dotColor:d.amber},blue:{label:"In Active Follow Up",bg:d.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:d.blue,clickable:!1,dotColor:d.blue},gray:{label:"Not in Follow Up",bg:d.slate,border:d.steel,color:d.coolGray,clickable:!1,dotColor:d.coolGray},loading:{label:"Active Follow Up\u2026",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.ash},error:{label:"Follow Up status unavailable",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.crimson}},jt=()=>{let o=T();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Kt=async o=>{let e=await fetch(zt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Yt=async(o,e)=>{let t=await fetch(Wt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},B=(o,e)=>{let t=Le[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ue=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,B(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=jt();if(!(!r||r.contactId!==o)){B(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Yt(r,A()),a=n&&n.state&&n.state in Le?n.state:"blue";B(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),B(e,"error"),setTimeout(()=>void le(e,r),4e3)}}}),e},le=async(o,e)=>{B(o,"loading");try{let t=await Kt(e),r=t&&t.state&&t.state in Le?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;B(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),B(o,"error")}},Xt=[".central-panel","[class*='central-panel']"],Ie="ws-crm-contact-actions-bar",Jt=async()=>{for(let o of Xt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Qt=async(o,e)=>{let t=e.querySelector(`#${Ie}`);if(!t)try{t=await C(`#${Ie}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Ie}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Zt=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},eo=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},to=async o=>{if(o==="url"){let t=await Jt();return t?{kind:"contact-detail",target:t}:null}let e=Zt();return e?{kind:"conversations",target:e}:null},qe=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await Qt(o,e.target);return t}return eo(o,e.target),"conversations-header"},oo=async()=>{let o=T();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){le(t,e);return}t&&t.remove();let r=await to(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=T();if(!n||n.contactId!==e.contactId)return;let a=Ue(e.contactId),i=await qe(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),ze();let s=document.getElementById(O)??a;le(s,e);let l=new MutationObserver(()=>{let c=document.getElementById(O);if(!(T()?.contactId===e.contactId)){l.disconnect();return}if(!c){let m=Ue(e.contactId);qe(m,r).then(()=>{ze(),le(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});l.observe(r.target,{childList:!0})},z=null,je=()=>{let o=T()?.contactId??null;if(z&&z.contactId===o)return;let e=oo().finally(()=>{z?.promise===e&&(z=null)});z={contactId:o,promise:e}},ze=()=>{let o=document.querySelectorAll(`#${O}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var H="ws-crm-claim-release-pill",ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",no="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",ao=async o=>{let e=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},so=async o=>{let e=await fetch(no,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Xe=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},$=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?d.emerald:d.amber;o.dataset.mode=e,o.style.cssText=ie(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},io=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.contactId=o,$(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=T();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>$(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";$(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await so({contactId:o,locationId:n.locationId,userId:a,action:r}),l=s?.mode==="claim"||s?.mode==="release"?s.mode:i;$(t,l),b.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(s){b.error("Claim/Release Set webhook failed",s),$(t,r);let l=t.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Ke=async(o,e)=>{try{let t=await ao({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(H);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";$(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},lo=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Xe(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Ye=(o,e)=>{let t=io({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${H}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},co=async()=>{let o=T();if(!o){document.getElementById(H)?.remove();return}let e=document.getElementById(H);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await lo(t),n=T();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ye(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(H);a&&o.locationId&&Ke(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(T()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(H))return;let l=Xe(t);if(l){Ye(l,o.contactId);let c=document.getElementById(H);c&&o.locationId&&Ke(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Je=()=>{co()};var bo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",W=new Map,Qe=async(o,e)=>{if(!o)return null;if(W.has(o))return W.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${bo}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),W.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return W.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),W.set(o,null),null}};var Ze=o=>o==="buyer"?"buyer":"seller";var at="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ho="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",mo=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||at,l;if(i==="buyer"){let p=st.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),l={contact_id:o,location:{id:e},customData:p}}let c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},_o=async({contactId:o,tenantId:e})=>{let t=await fetch(po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var V="ws-crm-contact-actions-bar",uo="ws-crm-call-status-dropdown",et="ws-crm-offer-made-modal",vo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],st=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],yo=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],go=async()=>{for(let o of yo)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},fo=({contactId:o,kind:e})=>{let t=e==="buyer"?st:vo,r=e==="buyer"?ho:at,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=uo,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=U,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Ae[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=d.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=Ae[l.color]),m&&(m.textContent=l.label),s.style.display="none";let v=T()?.locationId,f=A();if(!v){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${l.label} (no tenant!)`),m&&(m.style.color=d.amber);return}if(e==="seller"&&l.color==="green"&&!f){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${l.label} (no user!)`),m&&(m.style.color=d.amber);return}let g=h?.textContent??"\u25BE",w=async u=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await mo({contactId:o,locationId:v,status:l.label,userId:f,deadReason:u,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=g),i.style.opacity="1"},900)}catch(x){b.warn("Call Status webhook failed:",x),h&&(h.textContent="\u2717"),m&&(m.style.color=d.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=g),m&&(m.style.color=d.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let u=m?.textContent??"";xo(x=>{w(x)},()=>{m&&(m.textContent=u)});return}if(e==="seller"&&l.value==="appointment-booked"){let u=m?.textContent??"";try{(await _o({contactId:o,tenantId:v})).ok?await w():ko(()=>{w()},()=>{m&&(m.textContent=u)})}catch(x){b.warn("Appointment sanity check failed; firing anyway:",x),await w()}return}await w()}),s.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",l=>{a.contains(l.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},wo=o=>{document.getElementById(et)?.remove();let e=document.createElement("div");e.id=et,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},rt=(o,e)=>{let t=document.createElement("div");t.id=V,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${d.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=P,r.textContent="Offer Made",r.addEventListener("click",()=>wo(o)),t.appendChild(r),t.appendChild(fo({contactId:o,kind:e})),t},Fe=!1,To=()=>{document.querySelectorAll(`[id="${V}"]`).forEach(o=>o.remove())},it=async()=>{if(b.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Fe){b.info("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Fe=!0;try{await Eo()}finally{Fe=!1}},Eo=async()=>{let o=T();if(!o){b.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),To();return}b.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Qe(o.contactId,o.locationId);Ze(c)==="buyer"&&(e="buyer"),b.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=T();if(!t||t.contactId!==o.contactId){b.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${V}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.info(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await go();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=T();if(!a||a.contactId!==o.contactId){b.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=rt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(V)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let l=null;l=new MutationObserver(()=>{if(!(T()?.contactId===o.contactId)){l?.disconnect();return}let p=document.querySelectorAll(`[id="${V}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.info(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=rt(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(_){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),l.observe(n,{childList:!0})},nt=null,So=()=>{nt===null&&(nt=window.setInterval(()=>{let o=T();o&&(document.getElementById(V)||(b.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),it()))},3e3))},lt=()=>{So(),it()};var de="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Co=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),j="data-ws-crm-favicon",De=o=>o.hasAttribute(j),dt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Co.has(e)},ce=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{dt(r)&&!De(r)&&r.remove()});let e=document.head.querySelector(`link[${j}="1"]`);e?e.href!==de&&(e.href=de):(e=document.createElement("link"),e.setAttribute(j,"1"),e.rel="icon",e.type="image/png",e.href=de,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${j}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(j,"apple"),t.rel="apple-touch-icon",t.href=de,document.head.appendChild(t))},ct=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)ce();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),ce())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&dt(i)&&!De(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&De(i)&&(n=!0)});n&&ce()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,ce(),e>=5&&window.clearInterval(t)},1e3)};var Ao=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Io=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Lo=".hr-card.hr-modal.crm-opportunities-modal",R=()=>{let o=document.querySelector(Lo);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Io);if(n){let a=n[1];if(Ao.includes(a))return a}}return null},be=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=R();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",L="ws-crm-not-interested-button",Do=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mo=/\/v2\/location\/([A-Za-z0-9]+)/,he=()=>{let o=window.location.pathname,e=o.match(Do);if(!e)return null;let t=o.match(Mo);return{oppId:e[1],locationId:t?t[1]:null}},Ho=async o=>{let e=await fetch(Fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},No=o=>{let e=document.createElement("button");return e.id=L,e.type="button",e.dataset.oppId=o,e.style.cssText=ie("neutral"),e.style.fontFamily=y.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=he();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Ho({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=d.crimsonGlow,e.style.color=d.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Po=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Oo=async()=>{for(let o of Po)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Me=!1,bt=async()=>{if(!Me){Me=!0;try{await Bo()}finally{Me=!1}}},Bo=async()=>{let o=he();if(!o||!o.locationId){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),Y();return}let e=document.getElementById(L);if(e&&e.dataset.oppId===o.oppId){let s=R();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove(),Y());return}e&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove());let t=await Oo();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await be();if(r!=="Marketing Tracker"){b.info(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=he();if(!n||n.oppId!==o.oppId)return;let a=No(o.oppId),i=document.createElement("span");i.id=`${L}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),Ro(o.oppId)},K=null,He=null,Y=()=>{K?.disconnect(),K=null,He=null},Ro=o=>{if(K&&He===o)return;Y();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(He=o,K=new MutationObserver(()=>{let t=he();if(!t||t.oppId!==o){Y();return}let r=R();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),Y();return}document.getElementById(L)||bt()}),K.observe(e,{childList:!0,subtree:!0}))},ht=()=>{bt()};var pt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Q="ws-crm-send-to-title-co-button",X="ws-crm-send-to-title-co-wrap",_e="ws-crm-stc-dropdown",Go=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$o=/\/v2\/location\/([A-Za-z0-9]+)/,Pe=()=>{let o=window.location.pathname,e=o.match(Go);if(!e)return null;let t=o.match($o);return{oppId:e[1],locationId:t?t[1]:null}},Vo=async(o,e)=>{try{let t=await fetch(pt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Uo=async(o,e,t)=>{let r=await fetch(pt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},qo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease",e.style.boxShadow=`0 0 0 3px ${d.emerald}, 0 0 12px ${d.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2400)},M=()=>{document.getElementById(_e)?.remove()},pe=(o,e,t)=>{M();let r=document.createElement("div");r.id=_e;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,D(t,r);let n=async()=>{if(r.status==="sending")return;let l=await Vo(o,e);if(!l){r={status:"error",message:"Check failed \u2014 click to retry"},D(t,r);return}if(!Array.isArray(l.checks)||l.checks.length===0){r={status:"error",message:l.error||"Check failed \u2014 click to retry"},D(t,r),b.warn("[stc] dry_run returned no checks:",l);return}r={status:l.ok?"ready":"incomplete",checks:l.checks,previouslySentAt:l.previously_sent_at??null},D(t,r),document.getElementById(_e)&&pe(l.checks,l.previously_sent_at,t)},a=async()=>{let l=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},D(t,r),M();try{let c=await Uo(o,e,l);if(c.needs_confirm){r={status:"ready",checks:c.checks,previouslySentAt:c.previously_sent_at},D(t,r),c.checks&&pe(c.checks,c.previously_sent_at,t);return}if(c.ok){r={status:"sent",checks:c.checks,previouslySentAt:new Date().toISOString()},D(t,r),window.setTimeout(()=>{n()},3500);return}r={status:"error",checks:c.checks,message:c.error||"Validation failed"},D(t,r),c.checks&&pe(c.checks,c.previously_sent_at,t)}catch(c){b.error("[stc] send failed:",c),r={status:"error",message:"Network error \u2014 click to retry"},D(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":a();break;case"incomplete":{document.getElementById(_e)?M():r.checks&&pe(r.checks,r.previouslySentAt,t);break}case"error":case"sent":n();break}}),n();let i,s=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(s){let l=new MutationObserver(()=>{i!==void 0&&window.clearTimeout(i),i=window.setTimeout(()=>{r.status!=="sending"&&n()},1500)});l.observe(s,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let c=window.setInterval(()=>{document.body.contains(t)||(l.disconnect(),i!==void 0&&window.clearTimeout(i),window.clearInterval(c))},5e3)}return t},Wo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jo=async()=>{for(let o of Wo)try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ne=!1,mt=async()=>{if(Ne){b.info("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ne=!0;try{await Ko()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Ne=!1}},Ko=async()=>{b.info("[stc] mount:01 ensureMountedImpl entered");let o=Pe();if(!o||!o.locationId){b.info(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(Q)?.remove(),document.getElementById(X)?.remove(),M();return}b.info(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(Q);if(e&&e.dataset.oppId===o.oppId){b.info("[stc] mount:03-SKIP existing button for same opp");let s=R();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),M(),me());return}e&&(b.info("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),M()),b.info("[stc] mount:04 calling findMountTarget");let t=await jo();if(!t){b.info("[stc] mount:04-BAIL findMountTarget returned null");return}b.info(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`),b.info("[stc] mount:05 calling waitForOppPipelineName");let r=await be();if(b.info(`[stc] mount:05 pipeline detected = "${r}"`),r!=="Transaction Coordination"){b.info(`[stc] mount:05-BAIL gated off \u2014 pipeline="${r}" (expected Transaction Coordination)`);return}let n=Pe();if(!n||n.oppId!==o.oppId||!n.locationId){b.info(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.info("[stc] mount:06 building button");let a=zo(o.oppId,n.locationId),i=document.createElement("span");i.id=X,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.info(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Yo(o.oppId)},J=null,Oe=null,me=()=>{J?.disconnect(),J=null,Oe=null},Yo=o=>{if(J&&Oe===o)return;me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Oe=o,J=new MutationObserver(()=>{let t=Pe();if(!t||t.oppId!==o){me();return}let r=R();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Q)?.remove(),document.getElementById(X)?.remove(),M(),me();return}document.getElementById(Q)||mt()}),J.observe(e,{childList:!0,subtree:!0}))},_t=()=>{mt()};var we="reos-theme-stylesheet",Ft="reos-theme-fonts",Xo=()=>{let o=document.getElementById(Ft);o&&o.remove()},Jo=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var F=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Ht=()=>{b.info(`Loaded v${ae} (built ${se})`),F("mountVersionBadge (initial)",ke),F("mountFavicon",ct),F("mountThemeStylesheet",Dt),F("initPageRouter",Ve),b.info("[main] registering onPageChange subscriber"),$e(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),F("mountVersionBadge",ke),F("mountClaimReleaseToggle",Je),F("mountContactActionsBar",lt),F("mountActiveFollowUpButton",je),F("mountNotInterestedButton",ht),F("mountSendToTitleCoButton",_t)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ht):Ht();})();
