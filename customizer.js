/* Wholesaling CRM Customizer v0.13.45 — built 2026-05-26T14:57:41.427Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var X="[wholesaling-crm-customizer]",Tt="__WS_CRM_DEBUG",Et=()=>!!window[Tt],b={info(...o){console.log(X,...o)},warn(...o){console.warn(X,...o)},error(...o){console.error(X,...o)},debug(...o){Et()&&console.log(X,"[debug]",...o)}};var Se=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ue=/\/v2\/location\/([A-Za-z0-9]+)/,St=o=>{let e=o.match(Se);if(!e)return null;let t=o.match(ue);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ct=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Se);if(!n)continue;let a=r.match(ue)||window.location.pathname.match(ue);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},f=()=>{let o=St(window.location.pathname);return o||Ct()};var Ce=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},Q="",ye=null,R="other",ge=new Set,J=()=>{let o=f()?.contactId??null;if(!(!(window.location.pathname!==Q)&&!(o!==ye))){Q=window.location.pathname,ye=o,R=Ce(),b.debug("Page/context changed:",R,Q,"contact:",o);for(let r of ge)try{r(R)}catch(n){b.error("Subscriber threw:",n)}}},Ae=o=>(ge.add(o),setTimeout(()=>o(R),0),()=>{ge.delete(o)}),Ie=()=>{R=Ce(),Q=window.location.pathname,ye=f()?.contactId??null,b.debug("Router init, current page:",R);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),J()},history.replaceState=function(t,r,n){e(t,r,n),J()},window.addEventListener("popstate",J),setInterval(J,1e3)};var Z="0.13.45",ee="2026-05-26T14:57:41.427Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},T={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},fe={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},te=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,V=`
  ...
  flex-shrink: 0;
`;var At=/^[A-Za-z0-9]{15,30}$/,U=o=>typeof o=="string"&&At.test(o),It=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Lt=()=>{let o=window.WS_CRM_USER_ID;return U(o)?o:null},Ft=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(U(t))return t;return null},Dt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=It(e);if(!t)return null;let r=t.uid;if(U(r))return r;let n=t.claims;if(n&&U(n.user_id))return n.user_id}catch{}return null},Mt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(U(n))return n}catch{}}}catch{}return null},A=()=>Lt()||Ft()||Dt()||Mt()||null;var Me="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Ht=`${Me}/active-follow-up-get`,Nt=`${Me}/active-follow-up-set`,H="ws-crm-active-follow-up-button",xe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Pt=()=>{let o=f();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Rt=async o=>{let e=await fetch(Ht,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ot=async(o,e)=>{let t=await fetch(Nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},N=(o,e)=>{let t=xe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Le=o=>{let e=document.createElement("button");return e.type="button",e.id=H,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,N(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Pt();if(!(!r||r.contactId!==o)){N(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Ot(r,A()),a=n&&n.state&&n.state in xe?n.state:"blue";N(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),N(e,"error"),setTimeout(()=>void oe(e,r),4e3)}}}),e},oe=async(o,e)=>{N(o,"loading");try{let t=await Rt(e),r=t&&t.state&&t.state in xe?t.state:"gray",n=document.getElementById(H);if(!n||n.dataset.contactId!==e.contactId)return;N(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),N(o,"error")}},Bt=[".central-panel","[class*='central-panel']"],we="ws-crm-contact-actions-bar",Gt=async()=>{for(let o of Bt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},$t=async(o,e)=>{let t=e.querySelector(`#${we}`);if(!t)try{t=await C(`#${we}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${we}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Vt=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Ut=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},qt=async o=>{if(o==="url"){let t=await Gt();return t?{kind:"contact-detail",target:t}:null}let e=Vt();return e?{kind:"conversations",target:e}:null},Fe=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await $t(o,e.target);return t}return Ut(o,e.target),"conversations-header"},zt=async()=>{let o=f();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(H);if(t&&t.dataset.contactId===e.contactId){oe(t,e);return}t&&t.remove();let r=await qt(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=f();if(!n||n.contactId!==e.contactId)return;let a=Le(e.contactId),i=await Fe(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),De();let s=document.getElementById(H)??a;oe(s,e);let d=new MutationObserver(()=>{let c=document.getElementById(H);if(!(f()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Le(e.contactId);Fe(m,r).then(()=>{De(),oe(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},q=null,He=()=>{let o=f()?.contactId??null;if(q&&q.contactId===o)return;let e=zt().finally(()=>{q?.promise===e&&(q=null)});q={contactId:o,promise:e}},De=()=>{let o=document.querySelectorAll(`#${H}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var D="ws-crm-claim-release-pill",Wt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",jt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Kt=async o=>{let e=await fetch(Wt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Yt=async o=>{let e=await fetch(jt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Re=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},O=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=te(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Xt=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=D,t.type="button",t.dataset.contactId=o,O(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=f();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>O(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";O(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await Yt({contactId:o,locationId:n.locationId,userId:a,action:r}),d=s?.mode==="claim"||s?.mode==="release"?s.mode:i;O(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(s){b.error("Claim/Release Set webhook failed",s),O(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Ne=async(o,e)=>{try{let t=await Kt({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(D);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";O(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Jt=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Re(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Pe=(o,e)=>{let t=Xt({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${D}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},Qt=async()=>{let o=f();if(!o){document.getElementById(D)?.remove();return}let e=document.getElementById(D);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Jt(t),n=f();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Pe(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(D);a&&o.locationId&&Ne(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(f()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(D))return;let d=Re(t);if(d){Pe(d,o.contactId);let c=document.getElementById(D);c&&o.locationId&&Ne(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Oe=()=>{Qt()};var Zt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",z=new Map,Be=async(o,e)=>{if(!o)return null;if(z.has(o))return z.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${Zt}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),z.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return z.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),z.set(o,null),null}};var Ge=o=>o==="buyer"?"buyer":"seller";var We="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",eo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var to="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",oo=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||We,d;if(i==="buyer"){let p=je.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},ro=async({contactId:o,tenantId:e})=>{let t=await fetch(to,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var B="ws-crm-contact-actions-bar",no="ws-crm-call-status-dropdown",$e="ws-crm-offer-made-modal",ao=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],je=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],so=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],io=async()=>{for(let o of so)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},lo=({contactId:o,kind:e})=>{let t=e==="buyer"?je:ao,r=e==="buyer"?eo:We,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=no,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=V,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},qe=(o,e)=>{let t=document.createElement("div");t.id=B,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=F,r.textContent="Offer Made",r.addEventListener("click",()=>co(o)),t.appendChild(r),t.appendChild(lo({contactId:o,kind:e})),t},ke=!1,po=()=>{document.querySelectorAll(`[id="${B}"]`).forEach(o=>o.remove())},Ke=async()=>{if(b.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname),ke){b.info("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}ke=!0;try{await mo()}finally{ke=!1}},mo=async()=>{let o=f();if(!o){b.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),po();return}b.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Be(o.contactId,o.locationId);Ge(c)==="buyer"&&(e="buyer"),b.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=f();if(!t||t.contactId!==o.contactId){b.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${B}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.info(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await io();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=f();if(!a||a.contactId!==o.contactId){b.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=qe(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(B)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(f()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${B}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.info(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=qe(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},ze=null,_o=()=>{ze===null&&(ze=window.setInterval(()=>{let o=f();o&&(document.getElementById(B)||(b.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Ke()))},3e3))},Ye=()=>{_o(),Ke()};var re="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",vo=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),W="data-ws-crm-favicon",Te=o=>o.hasAttribute(W),Xe=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return vo.has(e)},ne=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Xe(r)&&!Te(r)&&r.remove()});let e=document.head.querySelector(`link[${W}="1"]`);e?e.href!==re&&(e.href=re):(e=document.createElement("link"),e.setAttribute(W,"1"),e.rel="icon",e.type="image/png",e.href=re,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${W}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(W,"apple"),t.rel="apple-touch-icon",t.href=re,document.head.appendChild(t))},Je=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)ne();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),ne())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Xe(i)&&!Te(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Te(i)&&(n=!0)});n&&ne()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,ne(),e>=5&&window.clearInterval(t)},1e3)};var uo=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],yo=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,go=".hr-card.hr-modal.crm-opportunities-modal",P=()=>{let o=document.querySelector(go);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(yo);if(n){let a=n[1];if(uo.includes(a))return a}}return null},ae=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=P();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",G="ws-crm-not-interested-button",wo=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xo=/\/v2\/location\/([A-Za-z0-9]+)/,se=()=>{let o=window.location.pathname,e=o.match(wo);if(!e)return null;let t=o.match(xo);return{oppId:e[1],locationId:t?t[1]:null}},ko=async o=>{let e=await fetch(fo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Qe=o=>{let e=document.createElement("button");return e.id=G,e.type="button",e.dataset.oppId=o,e.style.cssText=te("neutral"),e.style.fontFamily=v.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=se();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await ko({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},To=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Eo=async()=>{for(let o of To)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},So=async()=>{let o=se();if(!o||!o.locationId){document.getElementById(G)?.remove();return}let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){let d=P();d!==null&&d!=="Marketing Tracker"&&e.remove();return}e&&e.remove();let t=await Eo();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await ae();if(r!=="Marketing Tracker"){b.info(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=se();if(!n||n.oppId!==o.oppId)return;let a=Qe(o.oppId),i=document.createElement("span");i.id=`${G}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Not Interested button on opp ${o.oppId}`);let s=new MutationObserver(()=>{if(!(se()?.oppId===o.oppId)){s.disconnect();return}let c=P();if(c!==null&&c!=="Marketing Tracker"){document.getElementById(G)?.remove(),s.disconnect();return}if(!document.getElementById(G)){let m=Qe(o.oppId);i.appendChild(m),b.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});s.observe(t,{childList:!0})},Ze=()=>{So()};var Co="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",$="ws-crm-send-to-title-co-button",et="ws-crm-send-to-title-co-modal",Ao=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Io=/\/v2\/location\/([A-Za-z0-9]+)/,ie=()=>{let o=window.location.pathname,e=o.match(Ao);if(!e)return null;let t=o.match(Io);return{oppId:e[1],locationId:t?t[1]:null}},rt=async o=>{let e=await fetch(Co,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,tc_opp_id:o.oppId,triggered_by_user_id:o.userId??null,confirm_resend:o.confirmResend}),credentials:"omit"});if(!e.ok&&e.status!==200)throw new Error(`Send-to-Title-Co webhook returned ${e.status}`);return await e.json()},tt=o=>{document.getElementById(et)?.remove();let e=document.createElement("div");e.id=et,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=ie();if(!t||!t.locationId||t.oppId!==o)return;let r=e.querySelector(".ws-stc-label");e.disabled=!0,e.style.opacity="0.7",r&&(r.textContent="Checking\u2026");try{let n=await rt({oppId:t.oppId,locationId:t.locationId,userId:A(),confirmResend:!1});if(e.disabled=!1,e.style.opacity="1",r&&(r.textContent="Send to Title Company"),n.needs_confirm){tt({oppId:t.oppId,locationId:t.locationId,isResend:!0,previousSentAt:n.previously_sent_at??null,onConfirmed:()=>{r&&(r.textContent="Re-sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3)}});return}if(n.ok){r&&(r.textContent="Sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3);return}tt({oppId:t.oppId,locationId:t.locationId,isResend:!1,onConfirmed:()=>{r&&(r.textContent="Sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3)}})}catch(n){b.error("Send to Title Co preflight failed",n),e.disabled=!1,e.style.opacity="1",r&&(r.textContent="Try again"),setTimeout(()=>{r&&r.textContent==="Try again"&&(r.textContent="Send to Title Company")},3e3)}}),e},Lo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Fo=async()=>{for(let o of Lo)try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Do=async()=>{let o=ie();if(!o||!o.locationId){document.getElementById($)?.remove();return}let e=document.getElementById($);if(e&&e.dataset.oppId===o.oppId){let d=P();d!==null&&d!=="Transaction Coordination"&&e.remove();return}e&&e.remove();let t=await Fo();if(!t){b.warn("Send to Title Co: no opp-header mount target found within timeout");return}let r=await ae();if(r!=="Transaction Coordination"){b.info(`[send-to-title-co] gated off \u2014 pipeline="${r}" (expected Transaction Coordination)`);return}let n=ie();if(!n||n.oppId!==o.oppId)return;let a=ot(o.oppId),i=document.createElement("span");i.id=`${$}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Send to Title Co button on opp ${o.oppId}`);let s=new MutationObserver(()=>{if(!(ie()?.oppId===o.oppId)){s.disconnect();return}let c=P();if(c!==null&&c!=="Transaction Coordination"){document.getElementById($)?.remove(),s.disconnect();return}if(!document.getElementById($)){let m=ot(o.oppId);i.appendChild(m),b.debug(`Re-mounted Send to Title Co button after wipe for opp ${o.oppId}`)}});s.observe(t,{childList:!0})},nt=()=>{Do()};var pe="reos-theme-stylesheet",ft="reos-theme-fonts",Mo=()=>{let o=document.getElementById(ft);o&&o.remove()},Ho=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var I=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},kt=()=>{b.info(`Loaded v${Z} (built ${ee})`),I("mountVersionBadge (initial)",_e),I("mountFavicon",Je),I("mountThemeStylesheet",wt),I("initPageRouter",Ie),b.info("[main] registering onPageChange subscriber"),Ae(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),I("mountVersionBadge",_e),I("mountClaimReleaseToggle",Oe),I("mountContactActionsBar",Ye),I("mountActiveFollowUpButton",He),I("mountNotInterestedButton",Ze),I("mountSendToTitleCoButton",nt)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",kt):kt();})();
