/* Wholesaling CRM Customizer v0.13.62 — built 2026-05-27T13:48:44.035Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var re="[wholesaling-crm-customizer]",Ut="__WS_CRM_DEBUG",qt=()=>!!window[Ut],c={info(...o){console.log(re,...o)},warn(...o){console.warn(re,...o)},error(...o){console.error(re,...o)},debug(...o){qt()&&console.log(re,"[debug]",...o)}};var ze=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Se=/\/v2\/location\/([A-Za-z0-9]+)/,zt=o=>{let e=o.match(ze);if(!e)return null;let t=o.match(Se);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Wt=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ze);if(!n)continue;let a=r.match(Se)||window.location.pathname.match(Se);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},E=()=>{let o=zt(window.location.pathname);return o||Wt()};var We=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ae="",Ce=null,$="other",Ae=new Set,ne=()=>{let o=E()?.contactId??null;if(!(!(window.location.pathname!==ae)&&!(o!==Ce))){ae=window.location.pathname,Ce=o,$=We(),c.debug("Page/context changed:",$,ae,"contact:",o);for(let r of Ae)try{r($)}catch(n){c.error("Subscriber threw:",n)}}},je=o=>(Ae.add(o),setTimeout(()=>o($),0),()=>{Ae.delete(o)}),Ke=()=>{$=We(),ae=window.location.pathname,Ce=E()?.contactId??null,c.debug("Router init, current page:",$);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ne()},history.replaceState=function(t,r,n){e(t,r,n),ne()},window.addEventListener("popstate",ne),setInterval(ne,1e3)};var se="0.13.62",ie="2026-05-27T13:48:44.036Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},x={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ie={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},le=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,z=`
  ...
  flex-shrink: 0;
`;var jt=/^[A-Za-z0-9]{15,30}$/,W=o=>typeof o=="string"&&jt.test(o),Kt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Yt=()=>{let o=window.WS_CRM_USER_ID;return W(o)?o:null},Xt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(W(t))return t;return null},Jt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Kt(e);if(!t)return null;let r=t.uid;if(W(r))return r;let n=t.claims;if(n&&W(n.user_id))return n.user_id}catch{}return null},Qt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(W(n))return n}catch{}}}catch{}return null},I=()=>Yt()||Xt()||Jt()||Qt()||null;var Qe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Zt=`${Qe}/active-follow-up-get`,eo=`${Qe}/active-follow-up-set`,O="ws-crm-active-follow-up-button",Fe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},to=()=>{let o=E();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},oo=async o=>{let e=await fetch(Zt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ro=async(o,e)=>{let t=await fetch(eo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},B=(o,e)=>{let t=Fe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ye=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,B(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=to();if(!(!r||r.contactId!==o)){B(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await ro(r,I()),a=n&&n.state&&n.state in Fe?n.state:"blue";B(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),B(e,"error"),setTimeout(()=>void de(e,r),4e3)}}}),e},de=async(o,e)=>{B(o,"loading");try{let t=await oo(e),r=t&&t.state&&t.state in Fe?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;B(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),B(o,"error")}},no=[".central-panel","[class*='central-panel']"],Le="ws-crm-contact-actions-bar",ao=async()=>{for(let o of no)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},so=async(o,e)=>{let t=e.querySelector(`#${Le}`);if(!t)try{t=await C(`#${Le}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Le}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},io=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},lo=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},co=async o=>{if(o==="url"){let t=await ao();return t?{kind:"contact-detail",target:t}:null}let e=io();return e?{kind:"conversations",target:e}:null},Xe=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await so(o,e.target);return t}return lo(o,e.target),"conversations-header"},bo=async()=>{let o=E();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){de(t,e);return}t&&t.remove();let r=await co(o.source);if(!r){c.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=E();if(!n||n.contactId!==e.contactId)return;let a=Ye(e.contactId),i=await Xe(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Je();let s=document.getElementById(O)??a;de(s,e);let d=new MutationObserver(()=>{let b=document.getElementById(O);if(!(E()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=Ye(e.contactId);Xe(m,r).then(()=>{Je(),de(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},j=null,Ze=()=>{let o=E()?.contactId??null;if(j&&j.contactId===o)return;let e=bo().finally(()=>{j?.promise===e&&(j=null)});j={contactId:o,promise:e}},Je=()=>{let o=document.querySelectorAll(`#${O}`);if(!(o.length<=1)){c.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var H="ws-crm-claim-release-pill",ho="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",mo=async o=>{let e=await fetch(ho,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},_o=async o=>{let e=await fetch(po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ot=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},V=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=le(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},uo=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.contactId=o,V(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=E();if(!n||!n.locationId||n.contactId!==o)return;let a=I();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>V(t,r),2500);return}c.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";V(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await _o({contactId:o,locationId:n.locationId,userId:a,action:r}),d=s?.mode==="claim"||s?.mode==="release"?s.mode:i;V(t,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(s){c.error("Claim/Release Set webhook failed",s),V(t,r);let d=t.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},et=async(o,e)=>{try{let t=await mo({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(H);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";V(r,n)}catch(t){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},vo=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=ot(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},tt=(o,e)=>{let t=uo({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${H}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},yo=async()=>{let o=E();if(!o){document.getElementById(H)?.remove();return}let e=document.getElementById(H);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await vo(t),n=E();if(!n||n.contactId!==o.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}tt(r,o.contactId),c.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(H);a&&o.locationId&&et(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(E()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(H))return;let d=ot(t);if(d){tt(d,o.contactId);let b=document.getElementById(H);b&&o.locationId&&et(b,{contactId:o.contactId,locationId:o.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){c.warn("Could not mount Claim/Release pill:",t)}}},rt=()=>{yo()};var go="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",K=new Map,nt=async(o,e)=>{if(!o)return null;if(K.has(o))return K.get(o)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${go}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${o}`),K.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return K.set(o,s),c.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${o}:`,n),K.set(o,null),null}};var at=o=>o==="buyer"?"buyer":"seller";var bt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var wo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",xo=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||bt,d;if(i==="buyer"){let p=ht.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let b=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},ko=async({contactId:o,tenantId:e})=>{let t=await fetch(wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var U="ws-crm-contact-actions-bar",To="ws-crm-call-status-dropdown",st="ws-crm-offer-made-modal",Eo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ht=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],So=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Co=async()=>{for(let o of So)try{let e=await C(o,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Ao=({contactId:o,kind:e})=>{let t=e==="buyer"?ht:Eo,r=e==="buyer"?fo:bt,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=To,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=z,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Ie[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=l.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=Ie[d.color]),m&&(m.textContent=d.label),s.style.display="none";let f=E()?.locationId,v=I();if(!f){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!v){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let _=h?.textContent??"\u25BE",g=async y=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await xo({contactId:o,locationId:f,status:d.label,userId:v,deadReason:y,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=_),i.style.opacity="1"},900)}catch(w){c.warn("Call Status webhook failed:",w),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=_),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Lo(w=>{g(w)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await ko({contactId:o,tenantId:f})).ok?await g():Fo(()=>{g()},()=>{m&&(m.textContent=y)})}catch(w){c.warn("Appointment sanity check failed; firing anyway:",w),await g()}return}await g()}),s.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},Io=o=>{document.getElementById(st)?.remove();let e=document.createElement("div");e.id=st,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},dt=(o,e)=>{let t=document.createElement("div");t.id=U,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=P,r.textContent="Offer Made",r.addEventListener("click",()=>Io(o)),t.appendChild(r),t.appendChild(Ao({contactId:o,kind:e})),t},De=!1,Do=()=>{document.querySelectorAll(`[id="${U}"]`).forEach(o=>o.remove())},pt=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),De){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}De=!0;try{await Mo()}finally{De=!1}},Mo=async()=>{let o=E();if(!o){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Do();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let b=await nt(o.contactId,o.locationId);at(b)==="buyer"&&(e="buyer"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let t=E();if(!t||t.contactId!==o.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${U}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await Co();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=E();if(!a||a.contactId!==o.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=dt(o.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(U)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(E()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${U}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=dt(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},ct=null,Ho=()=>{ct===null&&(ct=window.setInterval(()=>{let o=E();o&&(document.getElementById(U)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),pt()))},3e3))},mt=()=>{Ho(),pt()};var ce="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",No=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Y="data-ws-crm-favicon",Me=o=>o.hasAttribute(Y),_t=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return No.has(e)},be=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{_t(r)&&!Me(r)&&r.remove()});let e=document.head.querySelector(`link[${Y}="1"]`);e?e.href!==ce&&(e.href=ce):(e=document.createElement("link"),e.setAttribute(Y,"1"),e.rel="icon",e.type="image/png",e.href=ce,document.head.appendChild(e),c.debug("Favicon installed"));let t=document.head.querySelector(`link[${Y}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(Y,"apple"),t.rel="apple-touch-icon",t.href=ce,document.head.appendChild(t))},ut=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)be();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),be())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&_t(i)&&!Me(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Me(i)&&(n=!0)});n&&be()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,be(),e>=5&&window.clearInterval(t)},1e3)};var Po=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Oo=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Bo=".hr-card.hr-modal.crm-opportunities-modal",R=()=>{let o=document.querySelector(Bo);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Oo);if(n){let a=n[1];if(Po.includes(a))return a}}return null},vt=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=R();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",L="ws-crm-not-interested-button",Go=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$o=/\/v2\/location\/([A-Za-z0-9]+)/,pe=()=>{let o=window.location.pathname,e=o.match(Go);if(!e)return null;let t=o.match($o);return{oppId:e[1],locationId:t?t[1]:null}},Vo=async o=>{let e=await fetch(Ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Uo=o=>{let e=document.createElement("button");return e.id=L,e.type="button",e.dataset.oppId=o,e.style.cssText=le("neutral"),e.style.fontFamily=x.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=pe();if(!t||!t.locationId||t.oppId!==o)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Vo({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,c.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},qo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zo=async()=>{for(let o of qo)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Oe=async()=>{if(!he){he=!0;try{await Wo()}finally{he=!1}}},Wo=async()=>{let o=pe();if(!o||!o.locationId){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}let e=document.getElementById(L);if(e&&e.dataset.oppId===o.oppId){let s=R();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove(),J());return}e&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove());let t=await zo();if(!t){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await vt();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=pe();if(!n||n.oppId!==o.oppId)return;let a=Uo(o.oppId),i=document.createElement("span");i.id=`${L}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted Not Interested button on opp ${o.oppId}`),jo(o.oppId)},X=null,Pe=null,J=()=>{X?.disconnect(),X=null,Pe=null},jo=o=>{if(X&&Pe===o)return;J();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pe=o,X=new MutationObserver(()=>{let t=pe();if(!t||t.oppId!==o){J();return}let r=R();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}document.getElementById(L)||Oe()}),X.observe(e,{childList:!0,subtree:!0}))},He=null,Ne,Ko=()=>{He||(He=new MutationObserver(()=>{Ne===void 0&&(Ne=window.setTimeout(()=>{Ne=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(L);o&&!e&&!he&&Oe()},300))}),He.observe(document.body,{childList:!0,subtree:!0}))},yt=()=>{Ko(),Oe()};var ft="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",G="ws-crm-send-to-title-co-button",q="ws-crm-send-to-title-co-wrap",ue="ws-crm-stc-dropdown",Yo=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xo=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let o=window.location.pathname,e=o.match(Yo);if(!e)return null;let t=o.match(Xo);return{oppId:e[1],locationId:t?t[1]:null}},Jo=async(o,e)=>{try{let t=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(c.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return c.warn("[stc] dry_run fetch failed:",t),null}},Qo=async(o,e,t)=>{let r=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:I()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Zo=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${o}"`),!1},gt=o=>{let e=document.getElementById(o);if(!e){c.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},er=(o,e)=>{if(e&&Zo(e)){window.setTimeout(()=>gt(o),300);return}gt(o)},D=()=>{document.getElementById(ue)?.remove()},me=(o,e,t)=>{D();let r=document.createElement("div");r.id=ue;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(u=>{p[u.group]||(p[u.group]=[]),p[u.group].push(u)});let m=[...b.filter(u=>p[u]),...Object.keys(p).filter(u=>!b.includes(u))];for(let u of m){let f=p[u],v=document.createElement("div");v.style.cssText="margin-top: 12px;";let _=document.createElement("div");_.style.cssText=`
      font-family: ${x.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${l.steel};
    `,_.textContent=u,v.appendChild(_),f.forEach(g=>{let y=document.createElement("div"),w=!g.filled&&g.navigable&&g.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${S.sm};
        font-size: 12px;
        color: ${g.filled?l.bone:l.ash};
        ${w?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,w&&(y.addEventListener("mouseenter",()=>{y.style.background=l.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",A=>{A.stopPropagation(),g.field_id&&(er(g.field_id,g.folder),D())}));let k=g.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=w?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${k}<span style="flex: 1;">${g.label}</span>${T}`,v.appendChild(y)}),r.appendChild(v)}document.body.appendChild(r);let h=u=>{let f=u.target;!r.contains(f)&&!t.contains(f)&&(D(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},F=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,s=l.bone,d,b="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",i=l.steel,s=l.ash,d=l.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(v=>v.filled).length??0,f=e.checks?.length??0;a="transparent",i=l.amber,s=l.amber,d=l.amber,b=`${u} of ${f} fields ready`,p="\u25BE";break}case"sending":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=l.amber,s=l.amber,d=l.amber,b=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=s,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=b),n&&(n.textContent=p)},tr=(o,e)=>{let t=document.createElement("button");t.id=G,t.type="button",t.dataset.oppId=o;let r={status:"checking"};t.style.cssText=`
    ${P}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,F(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let v=await Jo(o,e);if(!v){r={status:"error",message:"Check failed \u2014 click to retry"},F(t,r);return}if(v.rate_limited){h=Date.now()+m,r={status:"error",checks:r.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},F(t,r),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(h).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){r={status:"error",message:v.error||"Check failed \u2014 click to retry"},F(t,r),c.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}let g=v.checks;if(r.checks&&r.checks.length===v.checks.length){let w=new Set;g=v.checks.map((k,T)=>r.checks[T]?.filled&&!k.filled?n.has(k.label)?k:(w.add(k.label),{...k,filled:!0}):k),n=w}else n=new Set;r={status:g.every(w=>w.filled)?"ready":"incomplete",checks:g,previouslySentAt:v.previously_sent_at??null},F(t,r),document.getElementById(ue)&&me(g,v.previously_sent_at,t)},i=async()=>{let v=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},F(t,r),D();try{let _=await Qo(o,e,v);if(_.needs_confirm){r={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t);return}if(_.ok){r={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},F(t,r),window.setTimeout(()=>{u()},3500);return}r={status:"error",checks:_.checks,message:_.error||"Validation failed"},F(t,r),_.checks&&me(_.checks,_.previously_sent_at,t)}catch(_){c.error("[stc] send failed:",_),r={status:"error",message:"Network error \u2014 click to retry"},F(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(ue)?D():r.checks&&me(r.checks,r.previouslySentAt,t);break}case"error":case"sent":u();break}});let s,d=!1,b=Date.now(),p=1e4,m=5*60*1e3,h=0,u=async()=>{if(!d){if(Date.now()<h){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(h).toLocaleTimeString()}`);return}d=!0,b=Date.now();try{await a()}finally{d=!1}}};u();let f=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(f){let v=new MutationObserver(()=>{if(s!==void 0||d)return;let g=Date.now()-b,y=Math.max(1500,p-g);s=window.setTimeout(()=>{s=void 0,r.status!=="sending"&&u()},y)});v.observe(f,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),s!==void 0&&window.clearTimeout(s),window.clearInterval(_))},5e3)}return t},or=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rr=async()=>{for(let o of or)try{let e=await C(o,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_e=!1,Ve=async()=>{if(_e){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_e=!0;try{await nr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{_e=!1}},nr=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let o=Ge();if(!o||!o.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D();return}c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let i=R();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(q)?.remove(),D(),Z());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(q)?.remove(),D()),c.debug("[stc] mount:04 calling findMountTarget");let t=await rr();if(!t){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=Ge();if(!r||r.oppId!==o.oppId||!r.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${r?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let n=tr(o.oppId,r.locationId),a=document.createElement("span");a.id=q,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(n),t.appendChild(a),c.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(n)}`),ar(o.oppId)},Q=null,$e=null,Z=()=>{Q?.disconnect(),Q=null,$e=null},ar=o=>{if(Q&&$e===o)return;Z();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($e=o,Q=new MutationObserver(()=>{let t=Ge();if(!t||t.oppId!==o){Z();return}let r=R();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),D(),Z();return}document.getElementById(G)||Ve()}),Q.observe(e,{childList:!0,subtree:!0}))},Be=null,Re,sr=()=>{Be||(Be=new MutationObserver(()=>{Re===void 0&&(Re=window.setTimeout(()=>{Re=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(G);o&&!e&&!_e&&Ve()},300))}),Be.observe(document.body,{childList:!0,subtree:!0}))},wt=()=>{sr(),Ve()};var xe="reos-theme-stylesheet",Rt="reos-theme-fonts",ir=()=>{let o=document.getElementById(Rt);o&&o.remove()},lr=`
/* ============================================
...
`,dr=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],cr=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${a})`}return`rgb(${t}, ${r}, ${n})`},br=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),hr=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Ue=new WeakSet,xt=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Ue.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let t=e.tagName;if(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="SCRIPT"||t==="STYLE"||t==="SVG"||t==="PATH"||t==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let i=+a[1],s=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||i<230||s<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Ue.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Ue.add(e)}catch{}})}catch{}},kt=new WeakSet,ee=()=>{document.querySelectorAll(hr.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(kt.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=+i[1],d=+i[2],b=+i[3];s<230||d<230||b<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),kt.add(r))})})},Tt=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},ve=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let t=e.parentElement,r=0;for(;t&&r<6&&t!==document.body;){if(r+=1,t.id?.startsWith("ws-crm-")||t.classList.contains("hl_header")||t.classList.contains("app-header")||t.tagName==="MAIN"||t.tagName==="BODY")return;let i=window.getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let s=+i[1],d=+i[2],b=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&s>=180&&d>=180&&b>=180&&s+d+b>=600&&t.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"))}t=t.parentElement}})},Et=()=>{let o="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;(t.getAttribute("style")||"").includes(o)&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"))})},te=()=>{for(let o of dr){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let a=t.style.getPropertyPriority(r),i=t.style.getPropertyValue(r),s=br.has(r)?cr(n):n;a==="important"&&i===s||t.style.setProperty(r,n,"important")}})}},ke="#1A1F28",pr=26,mr=31,_r=40,St=new Set,Ct=new Set,ye=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!Ct.has(n)&&n!=="<no class>"&&(Ct.add(n),c.debug(`Hid empty "--" leaf: "${n}"`))})},ur=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],vr=["trash","Trash","TRASH","delete","Delete","DELETE"],yr=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(vr.some(a=>n.includes(a))&&(r=!0),r||t.querySelectorAll("path").forEach(i=>{if(r)return;let s=i.getAttribute("d")||"";ur.some(d=>s.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),s=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},gr=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),fr=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||gr.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},At=new Set,It=new WeakSet,wr=()=>{document.body.querySelectorAll("*").forEach(e=>{if(It.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),It.add(e);let p=e.className?.toString()||"<no class>";!At.has(p)&&p!=="<no class>"&&(At.add(p),c.debug(`Remapped pure-white text -> bone: "${p}"`))})},Lt=new Set,xr=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let i=(a.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let s=window.getComputedStyle(a),d=s.backgroundColor,b=s.backgroundImage||"",p=!1;if(b!=="none"&&b.includes("gradient"))p=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let k=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(k&&parseFloat(k[1])<.6)return;let T=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(T){let A=parseInt(T[1],10),N=parseInt(T[2],10),Ee=parseInt(T[3],10);(A>=60||N>=60||Ee>=60)&&(A>230&&N>230&&Ee>230||(A>=80||N>=80||Ee>=80)&&(p=!0))}}if(!p)return;let h=(a.textContent||"").trim(),u=i,f=Array.from(a.querySelectorAll("*")).map(k=>(k.className?.toString()||"").toLowerCase()).join(" "),v=h.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),_=u.includes("bg-clip-text")||u.includes("text-transparent")||f.includes("bg-clip-text")||f.includes("text-transparent"),g=Array.from(a.querySelectorAll("*")).some(k=>{let T=window.getComputedStyle(k),A=T.getPropertyValue("-webkit-background-clip")||"",N=T.getPropertyValue("background-clip")||"";return A.includes("text")||N.includes("text")});if(v||_||g){let k=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],T=A=>{k.forEach(N=>A.style.removeProperty(N))};T(a),a.querySelectorAll("*").forEach(T);return}let y="#12161D";a.style.setProperty("color",y,"important"),a.querySelectorAll("*").forEach(k=>{let T=k.tagName.toLowerCase();T==="svg"||T==="path"||T==="circle"||T==="rect"||T==="polygon"||T==="polyline"||T==="line"||T==="g"?(k.style.setProperty("fill",y,"important"),k.style.setProperty("stroke",y,"important"),k.style.setProperty("color",y,"important")):(k.style.setProperty("color",y,"important"),k.style.setProperty("-webkit-text-fill-color",y,"important"))});let w=a.className?.toString()||"<no class>";!Lt.has(w)&&w!=="<no class>"&&(Lt.add(w),c.debug(`Darkened SVG icons on colored button: "${w}"`))})})},Ft=new Set,kr=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let b=d;if(b.closest("[id^='ws-crm-']"))return;let p=d.getBoundingClientRect();if(p.width===0||p.width>28||p.height>28)return;let m=p.left<r.right&&p.right>r.left,h=p.top<r.bottom&&p.bottom>r.top;if(!(m&&h)||p.top+p.height/2<n)return;let f=p.width*p.height/(r.width*r.height);if(f>.55)return;let v=b,_=b.parentElement,g=0;for(;_&&_!==e&&g<3;){let w=_.getBoundingClientRect();if(w.width>0&&w.width<=30&&w.height<=30)v=_;else break;_=_.parentElement,g++}v.style.setProperty("transform","translateY(11px)","important");let y=(v.className?.toString()||"")+" "+v.tagName;Ft.has(y)||(Ft.add(y),c.debug(`Dropped activity badge 11px (${p.width.toFixed(0)}x${p.height.toFixed(0)} icon, ratio ${f.toFixed(2)}): "${y}"`))})})},Tr="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Er=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Tr,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Dt=new Set,Sr=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),d=parseInt(i[2],10),b=parseInt(i[3],10);if(!(s>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!Dt.has(p)&&p!=="<no class>"&&(Dt.add(p),c.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${s},${d},${b})): "${p}"`))})})},Mt=new Set,Cr=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=t.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let s=t.className?.toString()||"<no class>";!Mt.has(s)&&s!=="<no class>"&&(Mt.add(s),c.debug(`Painted Ask AI wrapper graphite: "${s}"`))}}t=t.parentElement,r++}})},Ht=new Set,Ar=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let i=parseInt(a.zIndex,10);if(!isFinite(i)||i<50)return;let s=n.getBoundingClientRect();s.width<240||s.height<120||s.width>1500||s.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar")||s.includes("notification-dot")||s.includes("indicator"))return;if(s.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let _=i.getAttribute("style")||"";(_.includes("background-color")||_.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(s.includes("tabulator")||s.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(s.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let _=i.getAttribute("style")||"";(_.includes("background-color")||_.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(s.includes("ai-button")||s.includes("ask-ai")||s.includes("bg-clip-text")||s.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let p=parseInt(b[1],10),m=parseInt(b[2],10),h=parseInt(b[3],10);if(!(p>200&&m>200&&h>200))return;let f=i.getBoundingClientRect();if(f.width<24||f.height<16||f.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let v=i.className?.toString()||"<no class>";!Ht.has(v)&&v!=="<no class>"&&(Ht.add(v),c.debug(`Coerced light bg (${f.width.toFixed(0)}x${f.height.toFixed(0)}, rgb(${p},${m},${h})): "${v}"`))})})},Nt=new Set,Ir=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let y=t.getAttribute("style")||"";(y.includes("color")||y.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,a=null;for(let y=0;y<4&&n;y++){let w=n.nextElementSibling;if(w&&(w.matches(o)||w.querySelector(o)!==null)){a=w;break}n=n.parentElement}if(!a)return;let i=t.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let s=a,d=s.getBoundingClientRect(),b=s.className?.toString()||"",p=b.includes("schedule-ui-form-weekly-schedule-checkbox")||s.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||s.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",u=(b.includes("hr-form-item-blank")||b.includes("hr-form-item")||s.matches(h))&&(s.matches(h)||s.querySelector(h)!==null);u&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let f=b.includes("hr-radio")||s.closest(".hr-radio, [class*='hr-radio']")!==null;f&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let v=b.includes("hr-breadcrumb")||s.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;v&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius"));let _=b.includes("hr-header-lite")||s.closest("[class*='hr-header-lite']")!==null;_&&(s.getAttribute("style")||"").includes("background-color")&&(s.style.removeProperty("background-color"),s.style.removeProperty("border-color"),s.style.removeProperty("border-style"),s.style.removeProperty("border-width"),s.style.removeProperty("border-radius")),!p&&!m&&!u&&!f&&!v&&!_&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(s.style.setProperty("background-color",ke,"important"),s.style.setProperty("border-color","#252C36","important"),s.style.setProperty("border-style","solid","important"),s.style.setProperty("border-width","1px","important"),s.style.setProperty("border-radius","4px","important"));let g=t.className?.toString()||"<no class>";!Nt.has(g)&&g!=="<no class>"&&(Nt.add(g),c.debug(`Colored field label "${r.slice(0,30)}": "${g}"`))})},Pt=new Set,Lr=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let i=Math.min(r.width,r.height),s=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${s}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${s}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Pt.has(d)&&d!=="<no class>"&&(Pt.add(d),c.debug(`Resized avatar text to ${s}px (circle ${i.toFixed(0)}px): "${d}"`))})},Ot=new Set,Fr=new Set(["Enter Dashboard Name"]),Dr=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;let r=e.placeholder||"";if(Fr.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",ke,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",ke,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!Ot.has(a)&&a!=="<no class>"&&(Ot.add(a),c.debug(`Forced input slate bg: "${a}"`))})},ge=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>t.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let i=parseInt(a[1],10),s=parseInt(a[2],10),d=parseInt(a[3],10);if(!(i<pr&&s<mr&&d<_r))return;let p=e.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;e.style.setProperty("background-color",ke,"important");let m=e.className?.toString()||"<no class>";!St.has(m)&&m!=="<no class>"&&(St.add(m),c.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${i},${s},${d})): "${m}"`))})},fe=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let s=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!s)return;let d;try{d=atob(s[1])}catch{return}let b=d,p=!1;if(e.forEach(u=>{b.includes(u)&&(b=b.split(u).join(o),p=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{b.includes(u)&&(b=b.split(u).join("transparent"),p=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(f=>{b.includes(f)&&(b=b.split(f).join("#EDEEF0"),p=!0)}),!!p)try{let u=btoa(b);a.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let i=a.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;a.setAttribute("data-reos-masked","1");let s=`url("${i}")`;a.style.setProperty("-webkit-mask-image",s,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",s,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",t)})},we=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Mr=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color")||t.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},oe=()=>{let o=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{o(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let s=window.getComputedStyle(i).backgroundColor;s==="rgba(0, 0, 0, 0)"||s==="transparent"||!s||o(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{o(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",i="rgb(0, 191, 124)",s=b=>{let p=r.querySelector(".ui-upload-icon svg");p&&(p.style.setProperty("color",b,"important"),p.style.setProperty("stroke",b,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",b,"important")})},d=!1;try{d=r.matches(":hover")}catch{}s(d?i:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>s(i)),r.addEventListener("mouseleave",()=>s(a)))})},Bt=()=>{let o,t=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,we(),te(),Dr(),ge(),ye(),Ir(),Ar(),Cr(),Sr(),Er(),xr(),Lr(),kr(),wr(),fe(),fr(),yr(),oe(),ee(),xt(),Tt(),Et(),ve(),Mr(),oe()},800))};we(),te(),ge(),ye(),fe(),oe(),ee(),xt(),Tt(),Et(),ve(),window.setTimeout(()=>{we(),te(),ge(),ye(),fe(),oe(),ee(),ve()},500),window.setTimeout(()=>{we(),te(),ge(),ye(),fe(),oe(),ee(),ve()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{ee(),te()}),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},qe,Hr=()=>{let o=()=>{let t=document.getElementById(xe);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let n of t){for(let a of Array.from(n.addedNodes)){if(!(a instanceof Element))continue;let i=a.tagName.toLowerCase();if(i==="style"||i==="link"){if(a.id===xe||a.id===Rt)continue;r=!0;break}}if(r)break}r&&qe===void 0&&(qe=window.setTimeout(()=>{qe=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Gt=()=>{if(ir(),!document.getElementById(xe)){let o=document.createElement("style");o.id=xe,o.textContent=lr,document.head.appendChild(o),c.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Bt():window.addEventListener("DOMContentLoaded",Bt)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,Hr())};var $t="ws-crm-customizer-version-badge",Te=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",Te,{once:!0});return}if(document.getElementById($t))return;let o=document.createElement("div");o.id=$t,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${se}`,o.title=`Built ${ie}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},Vt=()=>{c.info(`Loaded v${se} (built ${ie})`),M("mountVersionBadge (initial)",Te),M("mountFavicon",ut),M("mountThemeStylesheet",Gt),M("initPageRouter",Ke),c.info("[main] registering onPageChange subscriber"),je(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",Te),M("mountClaimReleaseToggle",rt),M("mountContactActionsBar",mt),M("mountActiveFollowUpButton",Ze),M("mountNotInterestedButton",yt),M("mountSendToTitleCoButton",wt)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Vt):Vt();})();
