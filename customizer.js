/* Wholesaling CRM Customizer v0.13.39 — built 2026-05-26T03:59:43.646Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Y="[wholesaling-crm-customizer]",xt="__WS_CRM_DEBUG",kt=()=>!!window[xt],b={info(...o){console.log(Y,...o)},warn(...o){console.warn(Y,...o)},error(...o){console.error(Y,...o)},debug(...o){kt()&&console.log(Y,"[debug]",...o)}};var Te=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,_e=/\/v2\/location\/([A-Za-z0-9]+)/,Tt=o=>{let e=o.match(Te);if(!e)return null;let t=o.match(_e);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Et=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Te);if(!n)continue;let a=r.match(_e)||window.location.pathname.match(_e);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},f=()=>{let o=Tt(window.location.pathname);return o||Et()};var Ee=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},J="",ve=null,P="other",ue=new Set,X=()=>{let o=f()?.contactId??null;if(!(!(window.location.pathname!==J)&&!(o!==ve))){J=window.location.pathname,ve=o,P=Ee(),b.debug("Page/context changed:",P,J,"contact:",o);for(let r of ue)try{r(P)}catch(n){b.error("Subscriber threw:",n)}}},Se=o=>(ue.add(o),setTimeout(()=>o(P),0),()=>{ue.delete(o)}),Ce=()=>{P=Ee(),J=window.location.pathname,ve=f()?.contactId??null,b.debug("Router init, current page:",P);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),X()},history.replaceState=function(t,r,n){e(t,r,n),X()},window.addEventListener("popstate",X),setInterval(X,1e3)};var Q="0.13.39",Z="2026-05-26T03:59:43.646Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},T={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ye={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},ee=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var St=/^[A-Za-z0-9]{15,30}$/,G=o=>typeof o=="string"&&St.test(o),Ct=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},At=()=>{let o=window.WS_CRM_USER_ID;return G(o)?o:null},It=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(G(t))return t;return null},Lt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Ct(e);if(!t)return null;let r=t.uid;if(G(r))return r;let n=t.claims;if(n&&G(n.user_id))return n.user_id}catch{}return null},Ft=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(G(n))return n}catch{}}}catch{}return null},A=()=>At()||It()||Lt()||Ft()||null;var Fe="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Dt=`${Fe}/active-follow-up-get`,Mt=`${Fe}/active-follow-up-set`,H="ws-crm-active-follow-up-button",fe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Ht=()=>{let o=f();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Nt=async o=>{let e=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Pt=async(o,e)=>{let t=await fetch(Mt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},N=(o,e)=>{let t=fe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ae=o=>{let e=document.createElement("button");return e.type="button",e.id=H,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,N(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ht();if(!(!r||r.contactId!==o)){N(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Pt(r,A()),a=n&&n.state&&n.state in fe?n.state:"blue";N(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),N(e,"error"),setTimeout(()=>void te(e,r),4e3)}}}),e},te=async(o,e)=>{N(o,"loading");try{let t=await Nt(e),r=t&&t.state&&t.state in fe?t.state:"gray",n=document.getElementById(H);if(!n||n.dataset.contactId!==e.contactId)return;N(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),N(o,"error")}},Rt=[".central-panel","[class*='central-panel']"],ge="ws-crm-contact-actions-bar",Ot=async()=>{for(let o of Rt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Bt=async(o,e)=>{let t=e.querySelector(`#${ge}`);if(!t)try{t=await C(`#${ge}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
...
/* v0.13.39: replace the default Tailwind gray-200 dashed border with
   a steel-colored dashed border (slate-themed, subtle against the
   slate dragger bg). Hover swaps to emerald to match the icon hover
   affordance. Unscoped: applies wherever a dragger renders, since the
   modal-scoped --n-dragger-border var doesn't catch draggers outside
   .crm-opportunities-modal (opp-detail page, contact widgets, etc.). */
.hr-upload-dragger {
  border: 1px dashed var(--reos-steel) !important;
  transition: border-color 0.15s ease !important;
}
.hr-upload-dragger:hover {
  border: 1px dashed var(--reos-emerald) !important;
}
