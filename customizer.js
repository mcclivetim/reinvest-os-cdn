...
`;var x="ws-crm-claim-release-pill",N=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ce=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=x,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?s.emerald:s.amber;return t.style.cssText=P(r),t.innerHTML=`
  ...
  `,ge.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
    ...
    `,n.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=s.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{d.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let c=t.firstElementChild,i=t.children[1],l=t.children[2];c&&(c.style.background=D[a.color]),i&&(i.textContent=a.label),r.style.display="none";let b=g()?.locationId,u=me();if(!b){d.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),i&&(i.textContent=`${a.label} (no tenant!)`),i&&(i.style.color=s.amber);return}if(a.color==="green"&&!u){d.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),i&&(i.textContent=`${a.label} (no user!)`),i&&(i.style.color=s.amber);return}let m=l?.textContent??"\u25BE";l&&(l.textContent="\u2026"),t.style.opacity="0.75";try{await he({contactId:e,locationId:b,status:a.label,userId:u}),l&&(l.textContent="\u2713"),setTimeout(()=>{l&&(l.textContent=m),t.style.opacity="1"},900)}catch(ae){d.warn("Call Status webhook failed:",ae),l&&(l.textContent="\u2717"),i&&(i.style.color=s.amber),t.style.opacity="1",setTimeout(()=>{l&&(l.textContent=m),i&&(i.style.color=s.bone)},1800)}}),r.appendChild(n)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{o.contains(a.target)||(r.style.display="none")}),o.appendChild(t),o.appendChild(r),o},xe=e=>{document.getElementById(z)?.remove();let o=document.createElement("div");o.id=z,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
