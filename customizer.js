/* Wholesaling CRM Customizer v0.30.1 — built 2026-06-10T14:57:13.337Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Dt="[wholesaling-crm-customizer]",Xi="__WS_CRM_DEBUG",Qi=()=>!!window[Xi],p={info(...t){console.log(Dt,...t)},warn(...t){console.warn(Dt,...t)},error(...t){console.error(Dt,...t)},debug(...t){Qi()&&console.log(Dt,"[debug]",...t)}};var Zi=/\/v2\/location\/([A-Za-z0-9]+)/,es=new Set(["8ntUQzMflUkR0YvrRgVk"]),De=()=>{let t=window.location.pathname.match(Zi);return t?t[1]:null},Vo=()=>{let t=De();return t!==null&&es.has(t)};var Ln=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wo=/\/v2\/location\/([A-Za-z0-9]+)/,ts=t=>{let e=t.match(Ln);if(!e)return null;let o=t.match(Wo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},os=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ln);if(!a)continue;let i=r.match(Wo)||window.location.pathname.match(Wo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},H=()=>{let t=ts(window.location.pathname);return t||os()};var $n=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Pt="",jo=null,He="other",Ko=new Set,Ht=()=>{let t=H()?.contactId??null;if(!(!(window.location.pathname!==Pt)&&!(t!==jo))){Pt=window.location.pathname,jo=t,He=$n(),p.debug("Page/context changed:",He,Pt,"contact:",t);for(let r of Ko)try{r(He)}catch(a){p.error("Subscriber threw:",a)}}},Bt=t=>(Ko.add(t),setTimeout(()=>t(He),0),()=>{Ko.delete(t)}),Mn=()=>{He=$n(),Pt=window.location.pathname,jo=H()?.contactId??null,p.debug("Router init, current page:",He);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ht()},history.replaceState=function(o,r,a){e(o,r,a),Ht()},window.addEventListener("popstate",Ht),setInterval(Ht,1e3)};var Ft="0.30.1",Rt="2026-06-10T14:57:13.338Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Yo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},On=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var rs=/^[A-Za-z0-9]{15,30}$/,Qe=t=>typeof t=="string"&&rs.test(t),Dn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ns=()=>{let t=window.WS_CRM_USER_ID;return Qe(t)?t:null},as=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Qe(o))return o;return null},is=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);if(!o)return null;let r=o.uid;if(Qe(r))return r;let a=o.claims;if(a&&Qe(a.user_id))return a.user_id}catch{}return null},ss=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Qe(a))return a}catch{}}}catch{}return null},M=()=>ns()||as()||is()||ss()||null,ls=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);return o?o.claims??o:null}catch{return null}},Hn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ls()?.type==="agency"};var Rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ds=`${Rn}/active-follow-up-get`,cs=`${Rn}/active-follow-up-set`,Te="ws-crm-active-follow-up-button",Xo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ps=()=>{let t=H();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},bs=async t=>{let e=await fetch(ds,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},hs=async(t,e)=>{let o=await fetch(cs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Se=(t,e)=>{let o=Xo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Pn=t=>{let e=document.createElement("button");return e.type="button",e.id=Te,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Se(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ps();if(!(!r||r.contactId!==t)){Se(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await hs(r,M()),i=a&&a.state&&a.state in Xo?a.state:"blue";Se(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),Se(e,"error"),setTimeout(()=>void Nt(e,r),4e3)}}}),e},Nt=async(t,e)=>{Se(t,"loading");try{let o=await bs(e),r=o&&o.state&&o.state in Xo?o.state:"gray",a=document.getElementById(Te);if(!a||a.dataset.contactId!==e.contactId)return;Se(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),Se(t,"error")}},ms=[".central-panel","[class*='central-panel']"],Jo="ws-crm-contact-actions-bar",us=async()=>{for(let t of ms)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},vs=async(t,e)=>{let o=e.querySelector(`#${Jo}`);if(!o)try{o=await L(`#${Jo}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Jo}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},_s=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},ys=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},gs=async t=>{if(t==="url"){let o=await us();return o?{kind:"contact-detail",target:o}:null}let e=_s();return e?{kind:"conversations",target:e}:null},Bn=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await vs(t,e.target);return o}return ys(t,e.target),"conversations-header"},fs=async()=>{let t=H();if(!t||!t.locationId){document.getElementById(Te)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Te);if(o&&o.dataset.contactId===e.contactId){Nt(o,e);return}o&&o.remove();let r=await gs(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=H();if(!a||a.contactId!==e.contactId)return;let i=Pn(e.contactId),s=await Bn(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Fn();let l=document.getElementById(Te)??i;Nt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(Te);if(!(H()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Pn(e.contactId);Bn(m,r).then(()=>{Fn(),Nt(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ze=null,Nn=()=>{let t=H()?.contactId??null;if(Ze&&Ze.contactId===t)return;let e=fs().finally(()=>{Ze?.promise===e&&(Ze=null)});Ze={contactId:t,promise:e}},Fn=()=>{let t=document.querySelectorAll(`#${Te}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ws="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",et=new Map,zt=async(t,e)=>{if(!t)return null;if(et.has(t))return et.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ws}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),et.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return et.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),et.set(t,null),null}};var Gt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var qn="ws-buybox-nav-icon",er="ws-buybox-panel",zn="ws-buybox-modal",xs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",tr="https://mcclivetim.github.io/reinvest-os-cdn/geo",qt=null,tt=null,ot=null,Zo=async()=>{if(qt)return qt;try{let t=await fetch(`${tr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return qt=await t.json(),qt}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},ks=async t=>{if(!tt)try{let e=await fetch(`${tr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);tt=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return tt?.[t]??[]},Es=async t=>{if(!ot)try{let e=await fetch(`${tr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ot=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return ot?.[t]??[]},or=async t=>await(await fetch(xs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Ts=(t,e)=>or({tenant_id:t,action:"list",buyer_contact_id:e}),Ss=(t,e,o,r)=>or({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Cs=(t,e)=>or({tenant_id:t,action:"remove",entry_id:e}),F=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),As=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Is='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Ls='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',$s="nav.w-13, nav[class*='w-13']",Ms=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Os=async()=>{try{return await L($s,{timeoutMs:2500})}catch{return null}},Ds=async()=>{try{return await L(Ms,{timeoutMs:2500})}catch{return null}},Hs=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Ps=(t,e)=>{let o=document.createElement("div");return o.id=er,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ns(t,e,()=>rr(t,e))}),o},rr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Ts(t,e),Zo()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Bs(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Bs=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?As(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Cs(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}rr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Ut=!1,Un=(t,e)=>{Ut=e;let o=Hs(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Fs,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",rr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Vn,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Vn="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Fs="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Rs=t=>{let e=document.createElement("button");return e.id=qn,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Vn,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Is.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Ut;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Un(r,a)}),e},Ns=(t,e,o)=>{let r=document.getElementById(zn);r&&r.remove();let a=document.createElement("div");a.id=zn,a.style.cssText=`
  ...
  `,C=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),A())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>g.focus(),0))},A=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let B=await Ss(t,e,s.granularity,g);if(!B.ok){T&&(T.textContent=B.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(B){T&&(T.textContent=`Network error: ${B.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},Qo=!1,Pe=null,rt=null,Gn=()=>{document.getElementById(qn)?.remove(),document.getElementById(er)?.remove(),rt&&Pe&&Pe.nav.removeEventListener("click",rt,!0),rt=null,Pe=null,Ut=!1},Wn=()=>{zs()},zs=async()=>{if(!Qo){Qo=!0;try{let t=H();if(!t){Gn();return}let e=document.getElementById(er);if(e&&e.dataset.buyerContactId===t.contactId&&Pe)return;Gn();let o=null;try{o=await zt(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Gt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Os(),Ds()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=H();if(!s||s.contactId!==t.contactId)return;let l=Ps(t.locationId,t.contactId),d=Rs(()=>Pe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Pe=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),rt=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Ut&&Un(c,!1)},a.addEventListener("click",rt,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Qo=!1}}};var _e="ws-crm-claim-release-pill",Gs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",qs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Us=async t=>{let e=await fetch(Gs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Vs=async t=>{let e=await fetch(qs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Yn=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Be=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=On(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Ws=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=_e,o.type="button",o.dataset.contactId=t,Be(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=H();if(!a||!a.locationId||a.contactId!==t)return;let i=M();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Be(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Be(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Vs({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Be(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),Be(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},jn=async(t,e)=>{try{let o=await Us({contactId:e.contactId,locationId:e.locationId,userId:M()}),r=document.getElementById(_e);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Be(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},js=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Yn(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Kn=(t,e)=>{let o=Ws({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${_e}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Ks=async()=>{let t=H();if(!t){document.getElementById(_e)?.remove();return}let e=document.getElementById(_e);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await js(o),a=H();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Kn(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(_e);i&&t.locationId&&jn(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(H()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(_e))return;let d=Yn(o);if(d){Kn(d,t.contactId);let c=document.getElementById(_e);c&&t.locationId&&jn(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Jn=()=>{Ks()};var oa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ys="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Js="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Xs=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||oa,d;if(s==="buyer"){let b=ra.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Qs=async({contactId:t,tenantId:e})=>{let o=await fetch(Js,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Fe="ws-crm-contact-actions-bar",Zs="ws-crm-call-status-dropdown",Xn="ws-crm-offer-made-modal",el=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ra=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],tl=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],ol=async()=>{for(let t of tl)try{let e=await L(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},rl=({contactId:t,kind:e})=>{let o=e==="buyer"?ra:el,r=e==="buyer"?Ys:oa,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Zs,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${Yo[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=Yo[d.color]),m&&(m.textContent=d.label),l.style.display="none";let x=H()?.locationId,E=M();if(!x){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!E){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await Xs({contactId:t,locationId:x,status:d.label,userId:E,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(C){p.warn("Call Status webhook failed:",C),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";sl(C=>{y(C)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await Qs({contactId:t,tenantId:x})).ok?await y():ll(()=>{y()},()=>{m&&(m.textContent=f)})}catch(C){p.warn("Appointment sanity check failed; firing anyway:",C),await y()}return}await y()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},nl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",al=async t=>{let e=await fetch(nl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},il=(t,e="seller")=>{document.getElementById(Xn)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=Xn,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},ea=(t,e)=>{let o=document.createElement("div");if(o.id=Fe,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=V,r.textContent="Offer Made",r.addEventListener("click",()=>il(t,e)),o.appendChild(r),o.appendChild(rl({contactId:t,kind:e}))}return o},nr=!1,dl=()=>{document.querySelectorAll(`[id="${Fe}"]`).forEach(t=>t.remove())},na=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),nr){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}nr=!0;try{await cl()}finally{nr=!1}},cl=async()=>{let t=H();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),dl();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await zt(t.contactId,t.locationId),b=Gt(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=H();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Fe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await ol();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=H();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=ea(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Fe)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(H()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Fe}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=ea(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},ta=null,pl=()=>{ta===null&&(ta=window.setInterval(()=>{let t=H();t&&(document.getElementById(Fe)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),na()))},3e3))},aa=()=>{pl(),na()};var Vt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",bl=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),nt="data-ws-crm-favicon",ar=t=>t.hasAttribute(nt),ia=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return bl.has(e)},Wt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ia(r)&&!ar(r)&&r.remove()});let e=document.head.querySelector(`link[${nt}="1"]`);e?e.href!==Vt&&(e.href=Vt):(e=document.createElement("link"),e.setAttribute(nt,"1"),e.rel="icon",e.type="image/png",e.href=Vt,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${nt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(nt,"apple"),o.rel="apple-touch-icon",o.href=Vt,document.head.appendChild(o))},sa=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Wt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Wt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ia(s)&&!ar(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ar(s)&&(a=!0)});a&&Wt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Wt(),e>=5&&window.clearInterval(o)},1e3)};var hl=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ml=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,ul=".hr-card.hr-modal.crm-opportunities-modal",D=()=>{let t=document.querySelector(ul);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(ml);if(a){let i=a[1];if(hl.includes(i))return i}}return null},q=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=D();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var la="ws-crm-dispo-action-row",N=t=>{let e=document.getElementById(la);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=la,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var vl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ne="ws-crm-mt-offer-made-button",da="ws-crm-mt-offer-made-modal",_l=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,yl=/\/v2\/location\/([A-Za-z0-9]+)/,Yt=()=>{let t=window.location.pathname,e=t.match(_l);if(!e)return null;let o=t.match(yl);return{oppId:e[1],locationId:o?o[1]:null}},gl=async t=>{let e=await fetch(vl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},jt=()=>{document.getElementById(da)?.remove()},fl=t=>{jt();let e=document.createElement("div");e.id=da,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&jt()}),i?.addEventListener("click",()=>jt()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let b=await gl({oppId:t.oppId,locationId:t.locationId,amount:c,userId:M()});if(!b.ok){a.textContent=b.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}jt(),t.onSuccess()}catch(b){p.error("MT Offer Made webhook failed",b),a.textContent=b instanceof Error?b.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},wl=t=>{let e=document.createElement("button");return e.id=ne,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Yt();!o||!o.locationId||o.oppId!==t||fl({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},xl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kl=async()=>{for(let t of xl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Kt=!1,dr=async()=>{if(!Kt){Kt=!0;try{await El()}finally{Kt=!1}}},El=async()=>{let t=Yt();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await kl();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Yt();if(!a||a.oppId!==t.oppId)return;let i=wl(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Tl(t.oppId)},at=null,lr=null,it=()=>{at?.disconnect(),at=null,lr=null},Tl=t=>{if(at&&lr===t)return;it();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(lr=t,at=new MutationObserver(()=>{let o=Yt();if(!o||o.oppId!==t){it();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),it();return}document.getElementById(ne)||dr()}),at.observe(e,{childList:!0,subtree:!0}))},ir=null,sr,Sl=()=>{ir||(ir=new MutationObserver(()=>{sr===void 0&&(sr=window.setTimeout(()=>{sr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!Kt&&dr()},300))}),ir.observe(document.body,{childList:!0,subtree:!0}))},ca=()=>{Sl(),dr()};var Cl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ae="ws-crm-not-interested-button",Al=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Il=/\/v2\/location\/([A-Za-z0-9]+)/,Xt=()=>{let t=window.location.pathname,e=t.match(Al);if(!e)return null;let o=t.match(Il);return{oppId:e[1],locationId:o?o[1]:null}},Ll=async t=>{let e=await fetch(Cl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},$l=t=>{let e=document.createElement("button");return e.id=ae,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Xt();if(!o||!o.locationId||o.oppId!==t)return;let r=M(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await Ll({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Ml=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ol=async()=>{for(let t of Ml)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Jt=!1,hr=async()=>{if(!Jt){Jt=!0;try{await Dl()}finally{Jt=!1}}},Dl=async()=>{let t=Xt();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await Ol();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Xt();if(!a||a.oppId!==t.oppId)return;let i=$l(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Hl(t.oppId)},st=null,br=null,lt=()=>{st?.disconnect(),st=null,br=null},Hl=t=>{if(st&&br===t)return;lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(br=t,st=new MutationObserver(()=>{let o=Xt();if(!o||o.oppId!==t){lt();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),lt();return}document.getElementById(ae)||hr()}),st.observe(e,{childList:!0,subtree:!0}))},cr=null,pr,Pl=()=>{cr||(cr=new MutationObserver(()=>{pr===void 0&&(pr=window.setTimeout(()=>{pr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!Jt&&hr()},300))}),cr.observe(document.body,{childList:!0,subtree:!0}))},pa=()=>{Pl(),hr()};var Bl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",oe="ws-crm-schedule-walkthrough-button",mr="ws-crm-schedule-walkthrough-modal",Fl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rl=/\/v2\/location\/([A-Za-z0-9]+)/,eo=()=>{let t=window.location.pathname,e=t.match(Fl);if(!e)return null;let o=t.match(Rl);return{oppId:e[1],locationId:o?o[1]:null}},Qt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Nl=(t,e)=>{document.getElementById(mr)?.remove();let o=document.createElement("div");o.id=mr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",c=document.getElementById("wsw-dur")?.value||"30";if(!d){Qt("Pick a date and time.","err");return}let b=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(Bl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:b,duration_min:Number(c)}),credentials:"omit"})).ok){s(),Qt("Walkthrough scheduled \u2713");let h=document.querySelector(`#${oe} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",Qt("Scheduling failed \u2014 try again.","err")}catch(m){p.warn("[schedule-walkthrough] failed:",m),l.disabled=!1,l.textContent="Schedule",Qt("Couldn't reach the scheduler. Try again.","err")}})},zl=t=>{let e=document.createElement("button");return e.id=oe,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=eo();!o||!o.locationId||o.oppId!==t||Nl(o.oppId,o.locationId)}),e},Gl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ql=async()=>{for(let t of Gl)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Zt=!1,yr=async()=>{if(!Zt){Zt=!0;try{await Ul()}finally{Zt=!1}}},Ul=async()=>{let t=eo();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=await ql();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=eo();if(!a||a.oppId!==t.oppId)return;let i=zl(t.oppId),s=document.createElement("span");s.id=`${oe}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Vl(t.oppId)},dt=null,_r=null,ct=()=>{dt?.disconnect(),dt=null,_r=null},Vl=t=>{if(dt&&_r===t)return;ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(_r=t,dt=new MutationObserver(()=>{let o=eo();if(!o||o.oppId!==t){ct();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),ct();return}document.getElementById(oe)||yr()}),dt.observe(e,{childList:!0,subtree:!0}))},ur=null,vr,Wl=()=>{ur||(ur=new MutationObserver(()=>{vr===void 0&&(vr=window.setTimeout(()=>{vr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!Zt&&yr()},300))}),ur.observe(document.body,{childList:!0,subtree:!0}))},ba=()=>{Wl(),yr()};var jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Re="ws-crm-resend-deal-link-wrap",Kl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yl=/\/v2\/location\/([A-Za-z0-9]+)/,oo=()=>{let t=window.location.pathname,e=t.match(Kl);if(!e)return null;let o=t.match(Yl);return{oppId:e[1],locationId:o?o[1]:null}},Jl=async t=>{let e=await fetch(jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Xl=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),ha=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,xr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${ha(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Ql(t,e)),t.appendChild(o)},Ql=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void Zl(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>xr(t,e)),o.appendChild(s),t.appendChild(o)},Zl=async(t,e,o,r)=>{let a=oo();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Jl({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${ha(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Xl(s)}</span>`}window.setTimeout(()=>xr(t,e),3500)}},ed=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],td=async()=>{for(let t of ed)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},to=!1,kr=async()=>{if(!to){to=!0;try{await od()}finally{to=!1}}},od=async()=>{let t=oo();if(!t||!t.locationId){document.getElementById(Re)?.remove(),bt();return}let e=document.getElementById(Re);if(e&&e.dataset.oppId===t.oppId){let s=D();s!==null&&s!=="Marketing Tracker"&&(e.remove(),bt());return}e&&e.remove();let o=await td();if(!o)return;let r=await q();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=oo();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Re,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",N(o).appendChild(i),xr(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),rd(t.oppId)},pt=null,wr=null,bt=()=>{pt?.disconnect(),pt=null,wr=null},rd=t=>{if(pt&&wr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wr=t,pt=new MutationObserver(()=>{let o=oo();if(!o||o.oppId!==t){bt();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Re)?.remove(),bt();return}document.getElementById(Re)||kr()}),pt.observe(e,{childList:!0,subtree:!0}))},gr=null,fr,nd=()=>{gr||(gr=new MutationObserver(()=>{fr===void 0&&(fr=window.setTimeout(()=>{fr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Re)&&!to&&kr()},300))}),gr.observe(document.body,{childList:!0,subtree:!0}))},ma=()=>{nd(),kr()};var ad="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ie="ws-crm-reduce-price-button",ua="ws-crm-reduce-price-modal",id=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sd=/\/v2\/location\/([A-Za-z0-9]+)/,ao=()=>{let t=window.location.pathname,e=t.match(id);if(!e)return null;let o=t.match(sd);return{oppId:e[1],locationId:o?o[1]:null}},ld=async t=>{let e=await fetch(ad,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ro=()=>{document.getElementById(ua)?.remove()},dd=t=>{ro();let e=document.createElement("div");e.id=ua,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&ro()}),i?.addEventListener("click",()=>{ro()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await ld({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:M()}),ro(),t.onSuccess()}catch(b){p.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},cd=(t,e)=>{let o=document.createElement("button");return o.id=ie,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=ao();!r||!r.locationId||r.oppId!==t||dd({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},pd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bd=async()=>{for(let t of pd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,Cr=async()=>{if(!no){no=!0;try{await hd()}finally{no=!1}}},hd=async()=>{let t=ao();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await bd();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await q();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=ao();if(!a||a.oppId!==t.oppId)return;let i=cd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),md(t.oppId)},ht=null,Sr=null,mt=()=>{ht?.disconnect(),ht=null,Sr=null},md=t=>{if(ht&&Sr===t)return;mt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Sr=t,ht=new MutationObserver(()=>{let o=ao();if(!o||o.oppId!==t){mt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}document.getElementById(ie)||Cr()}),ht.observe(e,{childList:!0,subtree:!0}))},Er=null,Tr,ud=()=>{Er||(Er=new MutationObserver(()=>{Tr===void 0&&(Tr=window.setTimeout(()=>{Tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!no&&Cr()},300))}),Er.observe(document.body,{childList:!0,subtree:!0}))},va=()=>{ud(),Cr()};var Ne="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",io="deals.reinvestos.com";var se="ws-crm-edit-landing-button",vd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_d=/\/v2\/location\/([A-Za-z0-9]+)/,lo=()=>{let t=window.location.pathname,e=t.match(vd);if(!e)return null;let o=t.match(_d);return{oppId:e[1],locationId:o?o[1]:null}},yd=(t,e)=>{let o=new URL(`https://${io}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ne);let r=M();return r&&o.searchParams.set("user",r),o.toString()},gd=(t,e)=>{let o=document.createElement("button");return o.id=se,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=lo();if(!r||!r.locationId||r.oppId!==t)return;if(!Ne){p.warn("[edit-landing] editor session key not configured in this build");return}let a=yd(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},fd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wd=async()=>{for(let t of fd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,$r=async()=>{if(!so){so=!0;try{await xd()}finally{so=!1}}},xd=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await wd();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=gd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),kd(t.oppId)},ut=null,Lr=null,vt=()=>{ut?.disconnect(),ut=null,Lr=null},kd=t=>{if(ut&&Lr===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Lr=t,ut=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){vt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),vt();return}document.getElementById(se)||$r()}),ut.observe(e,{childList:!0,subtree:!0}))},Ar=null,Ir,Ed=()=>{Ar||(Ar=new MutationObserver(()=>{Ir===void 0&&(Ir=window.setTimeout(()=>{Ir=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!so&&$r()},300))}),Ar.observe(document.body,{childList:!0,subtree:!0}))},_a=()=>{Ed(),$r()};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",ze="ws-crm-publish-button",_t="ws-crm-publish-wrap",po="ws-crm-publish-dropdown",Td=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Sd=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=()=>{let t=window.location.pathname,e=t.match(Td);if(!e)return null;let o=t.match(Sd);return{oppId:e[1],locationId:o?o[1]:null}},Cd=async(t,e)=>{try{let o=await fetch(ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},Ad=async(t,e)=>{let o=await fetch(ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Id=(t,e)=>{if(!Ne){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${io}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ne);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},me=()=>{document.getElementById(po)?.remove()},ya=(t,e,o,r,a)=>{me();let i=document.createElement("div");i.id=po;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Ce(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await Cd(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ce(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Ce(o,r),document.getElementById(po)&&r.checks&&ya(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Ce(o,r),me();try{let m=await Ad(t,e);if(m.ok&&m.published)r={status:"published"},Ce(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ce(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Ce(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(po)?me():r.checks&&ya(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},$d=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Md=async()=>{for(let t of $d)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Pr=async()=>{if(!co){co=!0;try{await Od()}finally{co=!1}}},Od=async()=>{let t=Dr();if(!t||!t.locationId){document.getElementById(ze)?.remove(),document.getElementById(_t)?.remove(),me(),gt();return}let e=document.getElementById(ze);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(_t)?.remove(),me(),gt());return}e&&(e.remove(),document.getElementById(_t)?.remove(),me());let o=await Md();if(!o)return;let r=await q();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Dr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=Ld(t.oppId,a.locationId),s=document.createElement("span");s.id=_t,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),N(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),Dd(t.oppId)},yt=null,Hr=null,gt=()=>{yt?.disconnect(),yt=null,Hr=null},Dd=t=>{if(yt&&Hr===t)return;gt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Hr=t,yt=new MutationObserver(()=>{let o=Dr();if(!o||o.oppId!==t){gt();return}let r=D();if(r!==null&&r!=="Disposition"){document.getElementById(ze)?.remove(),document.getElementById(_t)?.remove(),me(),gt();return}document.getElementById(ze)||Pr()}),yt.observe(e,{childList:!0,subtree:!0}))},Mr=null,Or,Hd=()=>{Mr||(Mr=new MutationObserver(()=>{Or===void 0&&(Or=window.setTimeout(()=>{Or=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(ze)&&!co&&Pr()},300))}),Mr.observe(document.body,{childList:!0,subtree:!0}))},fa=()=>{Hd(),Pr()};var wa="data:image/png;base64,",xa="data:image/png;base64,";var Pd=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],ka=t=>`ws-crm-map-links-${t}`,bo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},Ea=t=>{let e=bo(t.addr),o=bo(t.city),r=bo(t.state),a=bo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Bd=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Fd=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Rd=(t,e)=>{let{full:o,hasAny:r}=Ea(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Nd=t=>{let e=document.createElement("span");e.id=ka(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),Rd(t,s)}),l};return e.appendChild(r(wa,"Open in Google Maps",Bd)),e.appendChild(r(xa,"Search on Zillow",Fd)),e},zd=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ta=()=>{for(let t of Pd){if(document.getElementById(ka(t.key)))continue;let{hasAny:e}=Ea(t);if(!e)continue;let o=zd(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Nd(t)),p.debug(`[map-links] injected on "${t.addr}"`))}},Br=null,Fr,Gd=()=>{Br||(Br=new MutationObserver(()=>{Fr===void 0&&(Fr=window.setTimeout(()=>{Fr=void 0;try{Ta()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Br.observe(document.body,{childList:!0,subtree:!0}))},Sa=()=>{Gd(),Ta()};var Ca="ws-crm-hide-launchpad",Aa=/\/launchpad\/?$/,Rr=()=>{if(!Hn()){if(!document.getElementById(Ca)){let t=document.createElement("style");t.id=Ca,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Aa.test(location.pathname)){let t=location.pathname.replace(Aa,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var $a="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ye="ws-crm-send-to-closing-office-button",Ae="ws-crm-send-to-title-co-wrap",uo="ws-crm-stc-dropdown",qd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ud=/\/v2\/location\/([A-Za-z0-9]+)/,vo=()=>{let t=window.location.pathname,e=t.match(qd);if(!e)return null;let o=t.match(Ud);return{oppId:e[1],locationId:o?o[1]:null}},Vd=5*60*1e3,Ma=t=>`ws-crm-stc-cache:${t}`,Wd=t=>{try{let e=window.localStorage.getItem(Ma(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Vd||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},jd=(t,e)=>{try{window.localStorage.setItem(Ma(t),JSON.stringify(e))}catch{}},Kd=async(t,e)=>{try{let o=await fetch($a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Yd=async(t,e,o)=>{let r=await fetch($a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Jd=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},Ia=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Xd=(t,e)=>{if(e&&Jd(e)){window.setTimeout(()=>Ia(t),300);return}Ia(t)},le=()=>{document.getElementById(uo)?.remove()},ho=(t,e,o)=>{le();let r=document.createElement("div");r.id=uo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,ce(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Kd(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},ce(o,a);return}if(w.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},ce(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},ce(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),_o.add(t),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le(),wt();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let A=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(A.add(k.label),{...k,filled:!0}):k),i=A}else i=new Set;a={status:f.every(A=>A.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},jd(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),ce(o,a),document.getElementById(uo)&&ho(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},ce(o,a),le();try{let y=await Yd(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},ce(o,a),y.checks&&ho(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},ce(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},ce(o,a),y.checks&&ho(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},ce(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(uo)?le():a.checks&&ho(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!c){if(Date.now()<_){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,C=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},C)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Zd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ec=async()=>{for(let t of Zd)try{let e=await L(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_o=new Set,La=null,tc=t=>{t&&t!==La&&(_o.clear(),La=t)},mo=!1,qr=async()=>{if(mo){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}mo=!0;try{await oc()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{mo=!1}},oc=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=vo();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),tc(t.oppId),_o.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le();return}let e=document.getElementById(ye);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=D();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Ae)?.remove(),le(),wt());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Ae)?.remove(),le()),p.debug("[stc] mount:04 calling findMountTarget");let o=await ec();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=D();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=vo();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Qd(t.oppId,a.locationId),s=document.createElement("span");s.id=Ae,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),N(o).appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),rc(t.oppId)},ft=null,Gr=null,wt=()=>{ft?.disconnect(),ft=null,Gr=null},rc=t=>{if(ft&&Gr===t)return;wt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gr=t,ft=new MutationObserver(()=>{let o=vo();if(!o||o.oppId!==t){wt();return}let r=D();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ye)?.remove(),document.getElementById(Ae)?.remove(),le(),wt();return}document.getElementById(ye)||qr()}),ft.observe(e,{childList:!0,subtree:!0}))},Nr=null,zr,nc=()=>{Nr||(Nr=new MutationObserver(()=>{zr===void 0&&(zr=window.setTimeout(()=>{zr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ye);if(t&&!e&&!mo){let o=vo();if(o&&_o.has(o.oppId))return;qr()}},300))}),Nr.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{nc(),qr()};var Wr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ac=`${Wr}/tc/welcome-call-prefill`,ic=`${Wr}/tc/welcome-call-save`,sc=`${Wr}/tc/order-lockbox`,xt="ws-crm-welcome-call-overlay",lc=["Regular Contract","Subject To","Seller Finance","Novation"],dc=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],cc=["Gas","Electric","Propane","Oil"],pc=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],bc=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ge=["Yes","No"],hc=["Yes","No","Unknown"],mc=["Professional Photographer","Seller","Tenant"],uc=["Month-to-Month","Annual"],Da=["Current","Behind"],vc=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],pe=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),go=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ba="margin-bottom:12px;",Fa=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,_c=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Ha=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),U=(t,e,o)=>{let r=Ha(o);return`<select id="${t}" style="${go}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Ha(a)===r?"selected":""}>${pe(a)}</option>`).join("")}</select>`},J=(t,e,o="")=>`<input id="${t}" type="text" value="${pe(e)}" placeholder="${pe(o)}" style="${go}">`,yc=(t,e)=>`<textarea id="${t}" rows="3" style="${go}resize:vertical;">${pe(e)}</textarea>`,gc=(t,e)=>`<input id="${t}" type="date" value="${pe(e)}" style="${go}">`,O=(t,e)=>`<div style="${Ba}"><label style="${Fa}">${pe(t)}</label>${e}</div>`,Ur=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${vc.map(r=>`<label style="${_c}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ue=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${pe(t)}</div>`,Ge=()=>{document.getElementById(xt)?.remove()},Ie=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},fc=t=>{let e=t.tenant||{};return`
    ${ue("Identifiers")}
    ...
    ${ue("Contract")}
    ${O("Type of Contract",U("wc-contract_type",lc,t.contract_type))}

    ${ue("Property")}
    ${O("Property Type",U("wc-property_type",pc,t.property_type))}
    ...
    ${O("Utilities",U("wc-utilities",dc,t.utilities))}
    ${O("Heat Source",U("wc-heat_source",cc,t.heat_source))}

    ${ue("Liens & Permits")}
    ${O("Is there a mortgage?",U("wc-has_mortgage",ge,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${O("Mortgage payment status",U("wc-mortgage_payment_status",Da,t.mortgage_payment_status))}</div>
    ...
    ${ue("Occupancy")}
    ${O("Property occupancy",U("wc-occupancy",bc,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${O("Lease type",U("wc-tenant_lease_type",uc,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${O("Rent status",U("wc-tenant_rent_status",Da,e.rent_status))}</div>
        <div style="flex:1;">${O("Last rent paid",gc("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${O("HOA monthly fee",J("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${O("HOA rental restriction?",U("wc-hoa_rental_restriction",hc,t.hoa_rental_restriction))}</div>

    ${ue("Photos & Access")}
    ${O("Who is providing photos?",U("wc-photos_provided_by",mc,t.photos_provided_by))}
    <div style="${Ba}">
      <label style="${Fa}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Ur("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Ur("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Ur("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${yo(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${yo(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${yo(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${yo(t).text}</span>
      </div>
    </div>

    ${ue("Notes")}
    ${O("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",yc("wc-welcome_call_notes",t.welcome_call_notes))}
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Vr=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Pa=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},yo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?pe(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},wc=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Vr("photos_avail_mornings"),photos_avail_afternoons:Vr("photos_avail_afternoons"),photos_avail_evenings:Vr("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),xc=t=>{Ge();let e=document.createElement("div");e.id=xt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${fc(t)}</div>
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Lc=t=>{Ra(t.oppId,t.locationId)},$c=async(t,e,o)=>(await fetch(Ec,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Mc=(t,e)=>{we();let o=document.createElement("div");o.id=qa,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${jr(e.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${jr(e.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${jr(s)}</textarea>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){fe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(kc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(we(),fe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",fe("Booking failed \u2014 try again.","err"))}catch(d){p.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",fe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let c=d.target;!o.contains(c)&&!e.contains(c)&&(we(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Dc=(t,e)=>{we();let o=document.createElement("div");o.id=Ga;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(we(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},wo=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=V:o.style.cssText=$,o.textContent=t,o},Hc=()=>{let t=wo("\u22EE","ghost");return t.style.lineHeight="1",t},Pc=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Va){let r=wo("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Lc(t)),o.appendChild(r),o}if(e===tn){let r=wo("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Oc(t,r)),o.appendChild(r),o}if(e===Wa){let r=wo("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Ka(t)),o.appendChild(r),o}return null},Bc=(t,e)=>{let o=[];if(e===tn&&(o=[{label:"Re-order Lockbox",onClick:()=>void Ka(t)}]),!o.length)return null;let r=document.createElement("span");r.id=za,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Hc();return a.addEventListener("click",i=>{i.stopPropagation(),Dc(o,a)}),r.appendChild(a),r},Fc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Rc=async()=>{for(let t of Fc)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},fo=()=>{document.getElementById(Xr)?.remove(),document.getElementById(za)?.remove(),we()},xo=!1,on=async()=>{if(!xo){xo=!0;try{let t=ja();if(!t){fo();return}let e=D();if(e===null)return;if(e!=="Transaction Coordination"){fo();return}let o=Ic(),r=document.getElementById(Xr);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Pc(t,o);if(!a){fo();return}let i=await Rc();if(!i)return;fo();let s=N(i),l=document.createElement("span");l.id=Xr,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Bc(t,o);d&&s.appendChild(d),Nc(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{xo=!1}}},kt=null,Zr=null,Kr,Na=()=>{kt?.disconnect(),kt=null,Zr=null},Nc=t=>{if(kt&&Zr===t)return;Na();let e=document.querySelector(Ua);e&&(Zr=t,kt=new MutationObserver(()=>{let o=ja();if(!o||o.oppId!==t){Na();return}Kr===void 0&&(Kr=window.setTimeout(()=>{Kr=void 0,on()},250))}),kt.observe(e,{childList:!0,subtree:!0}))},Yr=null,Jr,zc=()=>{Yr||(Yr=new MutationObserver(()=>{Jr===void 0&&(Jr=window.setTimeout(()=>{Jr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!xo&&on()},300))}),Yr.observe(document.body,{childList:!0,subtree:!0}))},Ya=()=>{zc(),on()};var Ja="ws-support-modal",Xa="ws-support-toast",Gc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Qa="ws-support-submitter-name",Za="ws-support-submitter-email",ei="ws-support-submitter-role",qc=["Bug","Feature Request","Question","Billing","Onboarding Help"],Le=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Uc=(t,e="success",o)=>{let r=document.getElementById(Xa);r&&r.remove();let a=document.createElement("div");a.id=Xa;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Vc=()=>{document.getElementById(Ja)?.remove();let t=(localStorage.getItem(Qa)??"").trim(),e=(localStorage.getItem(Za)??"").trim(),o=(localStorage.getItem(ei)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ja,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=De();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Qa,r.submitterName),localStorage.setItem(Za,r.submitterEmail),r.submitterRole&&localStorage.setItem(ei,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Gc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";Uc(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Wc=["/support-ticket","ws-support-modal","ws-support"],jc=/\/custom-menu-link\//,rn=!1,ti=()=>{if(rn||!jc.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Wc.some(s=>i.includes(s))});if(r){rn=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Vc(),rn=!1},50);return}t<10&&setTimeout(e,150)};e()},oi=!1,ri=()=>{oi||(oi=!0,Bt(()=>setTimeout(ti,50)),ti(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Kc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Yc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Jc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",ii="tc_closing_agent",Xc="tc_closing_office",de="ws-crm-closing-agent-picker-button",si="ws-crm-closing-agent-picker-modal",Qc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zc=/\/v2\/location\/([A-Za-z0-9]+)/,St=()=>{let t=window.location.pathname,e=t.match(Qc);if(!e)return null;let o=t.match(Zc);return{oppId:e[1],locationId:o?o[1]:null}},bn=async t=>{let e=await fetch(Kc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ni=async t=>{let e=await fetch(Yc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ep=async(t,e)=>{try{let o=await fetch(Jc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:ii}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await bn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},$e=null,tp=60*60*1e3,hn=t=>`ws-crm-to-cache:${t}`,li=t=>{try{let e=window.localStorage.getItem(hn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>tp||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},di=(t,e,o)=>{try{window.localStorage.setItem(hn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},op=t=>{try{window.localStorage.removeItem(hn(t))}catch{}},ln="ws-crm-closing-agent-field-link",rp=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${ln}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},nn=!1,mn=async t=>{if(nn)return;let e=ci();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){nn=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await bn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),dn(a.id,a.name,t);let i=document.getElementById(de);if(i){xe(i,{status:"linked",contactName:a.name});let s=St();s&&di(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{nn=!1}}},np=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,ci=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();np.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},dn=(t,e,o)=>{let r=ci();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${ln}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=ln,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},ko=()=>{document.getElementById(si)?.remove()},ap=t=>{ko();let e=document.createElement("div");e.id=si,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&ko()}),i?.addEventListener("click",ko);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await bn({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${Eo(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Eo(m.email||"(no email)")} \xB7 ${Eo(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Eo(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{ko(),t.onPick(m)}),a.appendChild(h)})}catch(b){p.error("Closing Agent picker search failed",b),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},Eo=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),xe=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,c="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=c},ip=(t,e)=>{let o=document.createElement("button");o.id=de,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};xe(o,r);let a=li(t);return a&&(r={status:"linked",contactName:a.contactName},xe(o,r),$e={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await ep(t,e);s?(r={status:"linked",contactName:s.name},xe(o,r),$e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},dn(s.id,s.name,e)):a||(r={status:"empty"},xe(o,r),$e?.oppId===t&&($e=null),rp(),op(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ap({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},xe(o,r);try{let l=[ni({tenantId:e,oppId:t,fieldKey:ii,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(ni({tenantId:e,oppId:t,fieldKey:Xc,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},xe(o,r),$e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},di(t,s.id,s.name),dn(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},xe(o,r)}}})}),o},sp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],lp=async()=>{for(let t of sp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Et=!1,So=async()=>{if(!Et){Et=!0;try{await dp()}finally{Et=!1}}},dp=async()=>{let t=St();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),To();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let d=D();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),To());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=D();if(o!==null&&o!=="Transaction Coordination")return;let r=await lp();if(!r||!(li(t.oppId)!==null||$e!==null&&$e.oppId===t.oppId)&&await q()!=="Transaction Coordination")return;let i=St();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=ip(t.oppId,i.locationId),l=document.createElement("span");l.id=`${de}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),N(r).appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),cp(t.oppId),mn(i.locationId)},Tt=null,cn=null,pn=null,To=()=>{Tt?.disconnect(),Tt=null,cn=null,pn=null},cp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Tt&&cn===t&&pn===e||(To(),cn=t,pn=e,Tt=new MutationObserver(()=>{let o=St();if(!o||o.oppId!==t||!o.locationId){To();return}document.getElementById(de)||So(),mn(o.locationId)}),Tt.observe(e,{childList:!0,subtree:!0})))},an=null,sn,pp=()=>{an||(an=new MutationObserver(()=>{sn===void 0&&(sn=window.setTimeout(()=>{sn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!Et&&So()},300))}),an.observe(document.body,{childList:!0,subtree:!0}))},ai,bp=()=>{ai===void 0&&(ai=window.setInterval(()=>{let t=St();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(de)&&!Et&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),So()),mn(t.locationId)},2e3))},pi=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),pp(),bp(),So()};var hp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ee="ws-crm-manage-team-cta",bi="ws-crm-manage-team-modal",mp=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,hi={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},up={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},mi=()=>{let t=window.location.pathname.match(mp);return t?{tenantId:t[1]}:null},Ao=async t=>{let e=await fetch(hp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},re=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ke=t=>re(t),un="ws-crm-manage-team-toast",yn=(t,e="info",o=4e3)=>{document.getElementById(un)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=un,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(un)===a&&a.remove()},o)},vn=()=>{document.getElementById(bi)?.remove()},vp=(t,e)=>{let o=up[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${re(e)}</span>
  `},_p=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>vp(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>_p(r,e)).join(""),Io=async t=>{vn();let e=document.createElement("div");e.id=bi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&vn()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",vn);let r;try{r=await Ao({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+yp(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{gp(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;fp(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;wp(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},gp=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${re(hi[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Io(t)}),Co(e),setTimeout(()=>Co(e),200),setTimeout(()=>Co(e),800),window.addEventListener("resize",()=>Co(e)),e},_n=!1,Lp=()=>{if(!_n){_n=!0;try{let t=mi();if(!t){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}let e=document.getElementById(Ee);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ee}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ee}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Ip(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{_n=!1}}},ui=()=>{if(!mi()){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}Lp()};var $p="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",wn="ws-crm-prepare-contract-button",vi="ws-crm-prepare-contract-menu",he="ws-crm-prepare-contract-modal",_i="ws-crm-modal-date-style",ve="https://services.leadconnectorhq.com",ki=()=>{if(document.getElementById(_i))return;let t=document.createElement("style");t.id=_i,t.textContent=`
  ...
  `,document.head.appendChild(t)},xn="__WS_CRM_CAPTURED_AUTH",Mp=50*60*1e3,Oo=()=>{try{let t=localStorage.getItem(xn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Mp?(localStorage.removeItem(xn),null):e:null}catch{return null}},Op=t=>{try{localStorage.setItem(xn,JSON.stringify(t))}catch{}},Ue=()=>{let t=Oo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},yi=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Oo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),qe=async(t,e={},o=2)=>{let r=Oo()?.capturedAt??0,a;try{a={...Ue(),...e.headers??{}}}catch(s){if(o>0&&await yi(r,4e3))return qe(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await yi(r,4e3)?qe(t,e,o-1):i},gi=!1,Dp=()=>{if(gi)return;gi=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Oo()?.authorization;Op({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Ei=()=>{let t=H();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Hp=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Ei()},Pp=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Ti="__WS_CRM_TEMPLATES_CACHE_V1",Bp=24*60*60*1e3,fi=t=>{try{let e=window.localStorage.getItem(Ti);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Bp?null:o.templates}catch{return null}},Fp=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Ti,JSON.stringify(o))}catch{}},Rp=async t=>{let e=`${ve}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await qe(e,{method:"GET"})}catch(s){let l=fi(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=fi(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Pp(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Fp(t,i),i},Np=async(t,e)=>{let o=await qe(`${ve}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await qe(`${ve}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},zp=async(t,e)=>{let o=await qe(`${ve}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ve}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ue()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},Gp=async t=>{let e=await fetch($p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},qp=async(t,e,o)=>{let r=`${ve}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ue()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Up=async(t,e)=>{let o=await fetch(`${ve}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ue()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Vp=async t=>{let e=await fetch(`${ve}/contacts/${t}`,{method:"GET",headers:Ue()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Wp=async(t,e,o,r)=>{let a;try{a=await Up(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Vp(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ve}/proposals/document/${e}`,{method:"PUT",headers:{...Ue(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},jp=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},$o="__WS_CRM_PENDING_INSTRUCTIONS",Kp=60*1e3,Yp=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Jp=t=>{let e=(t||"").toLowerCase();for(let o of Yp)if(e.includes(o.matches.toLowerCase()))return o;return null},Xp=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem($o,JSON.stringify(r))}catch{}},Qp=()=>{try{let t=localStorage.getItem($o);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Kp?(localStorage.removeItem($o),null):e}catch{return null}},Zp=()=>{try{localStorage.removeItem($o)}catch{}},eb=(t,e)=>{document.getElementById(he)?.remove();let o=document.createElement("div");o.id=he,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},tb=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,ob=()=>{let t=window.location.pathname.match(tb);if(!t)return;let e=t[1],o=Qp();o&&o.proposalId===e&&(Zp(),window.setTimeout(()=>{eb(o.title,o.bodyHtml)},600))},wi="ws-crm-prepare-contract-toast",W=(t,e="info",o=4e3)=>{document.getElementById(wi)?.remove();let r=document.createElement("div");r.id=wi;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},xi=(t,e)=>new Promise(o=>{document.getElementById(he)?.remove();let r=document.createElement("div");r.id=he,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,w.appendChild(y),document.body.appendChild(w);let z=y.querySelector("#ws-pc-purchase-price"),ee=y.querySelector("#ws-pc-emd"),X=y.querySelector("#ws-pc-cash-at-close"),R=!1;X?.addEventListener("input",()=>{R=!0});let Ve=()=>{if(R)return;let G=Number(z?.value||0),j=Number(ee?.value||0);X&&(X.value=String(Math.max(0,G-j)))};z?.addEventListener("input",Ve),ee?.addEventListener("input",Ve);let Ot=()=>w.remove();w.addEventListener("click",G=>{G.target===w&&Ot()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Ot);let te=y.querySelector("#ws-pc-submit"),Z=y.querySelector("#ws-pc-error");te?.addEventListener("click",async()=>{if(te){Z&&(Z.textContent=""),te.disabled=!0,te.textContent="Opening\u2026";try{let G=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),j=Number(z?.value||0),We=Number(ee?.value||0),je=Number(X?.value||0),Ke=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Je=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Oe=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Xe=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),K={};if(G!==s&&(K.sellerName=G),j!==l&&(K.purchasePrice=j),We!==d&&(K.emd=We),je!==c&&(K.cashAtClose=je),Ke!==b&&(K.daysToClose=Ke),Ye!==m&&(K.inspectionDays=Ye),Je!==h&&(K.additionalTerms=Je),Oe!==_&&(K.currentOccupancy=Oe),Xe!==x&&(K.occupancyAtClose=Xe),Object.keys(K).length>0){p.info("[prepare-contract] PA modal submit with overrides:",K),te.textContent="Saving\u2026";let Go=M(),qo=await Mo({tenantId:t,contactId:e,template:o,userId:Go,overrides:K});p.info("[prepare-contract] re-stage with overrides ok:",qo),te.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Y=i?`${i} - Purchase Agreement`:void 0;await Tn(t,e,o,Y)}catch(G){te.disabled=!1,te.textContent="Open Contract",Z&&(Z.textContent=G.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",G)}}})},nb=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(he)?.remove(),ki();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,C="",A=document.createElement("div");A.id=he,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(k),document.body.appendChild(A);let X=k.querySelector("#ws-pc-assignment-price"),R=k.querySelector("#ws-pc-assignment-fee"),Ve=!1;R?.addEventListener("input",()=>{Ve=!0});let Ot=()=>{if(Ve)return;let j=Number(X?.value||0);R&&(R.value=String(Math.max(0,j-x)))};X?.addEventListener("input",Ot);let te=()=>A.remove();A.addEventListener("click",j=>{j.target===A&&te()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",te);let Z=k.querySelector("#ws-pc-submit"),G=k.querySelector("#ws-pc-error");Z?.addEventListener("click",async()=>{if(!Z)return;G&&(G.textContent="");let j=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),We=Number(X?.value||0),je=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),Ke=Number(R?.value||0),Ye=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Je=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Oe=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Xe=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),K=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Oe){G&&(G.textContent="Closing Date is required.");return}Z.disabled=!0,Z.textContent="Opening\u2026";try{let Y={};j!==b&&(Y.sellerName=j),We!==m&&(Y.assignmentPrice=We),je!==h&&(Y.buyerEMD=je),Ke!==_&&(Y.assignmentFee=Ke),Ye!==E&&(Y.closingOffice=Ye),Je!==w&&(Y.buyerCompanyName=Je);let Go=Oe!==y||Xe!==f||K!==C,qo=Object.keys(Y).length>0||Go,Uo=a;qo?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",Y),Z.textContent="Saving\u2026",Uo=await Mo({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Oe,buyerEarnestDueDate:Xe,lenderSource:K,userId:i,overrides:Object.keys(Y).length>0?Y:void 0}),p.info("[prepare-contract] AA re-stage ok:",Uo),Z.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let In=Uo?.debug?.propertyAddress||c,Ji=In?`${In} - Assignment Agreement`:void 0;await Tn(t,e,o,Ji),te()}catch(Y){Z.disabled=!1,Z.textContent="Open Contract",G&&(G.textContent=Y.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",Y)}})},Mo=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Gp({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Tn=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await qp(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Wp(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),W(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Jp(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Xp(a,s.title,s.bodyHtml)),jp(t,a)},ab=async t=>{let e=Hp(t);if(!e){W("Could not resolve contact context.","error");return}document.getElementById(vi)?.remove();let o=document.createElement("div");o.id=vi,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Rp(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=M();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await zp(e.tenantId,e.contactId)}catch(f){W(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){W("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await xi(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),C=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${C}-${A}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},_=h(45),x=h(7);W("Reading contract data\u2026","info",2500);let E;try{E=await Mo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:c})}catch(y){W(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){W("Could not resolve buyer contact for this opp.","error",6e3);return}nb({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){W("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Np(e.tenantId,e.contactId)}catch(_){W(`Failed to load ACQ opps: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){W("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await xi(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,p.info(`[prepare-contract] picked ACQ opp ${m}`)}W("Reading contract data\u2026","info",2500);let h;try{h=await Mo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(_){W(`Failed to prepare contract: ${_.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",_);return}rb({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){W("This template needs to be started from a contact page.","error",6e3);return}W(`Opening ${i.name}\u2026`,"info",2500);try{await Tn(e.tenantId,e.contactId,i)}catch(b){W(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),W(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Si=()=>{let t=document.createElement("button");return t.id=wn,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),ab(t)}),t},ib="ws-crm-contact-actions-bar",sb=async()=>{let t=Ei();if(!t){document.getElementById(wn)?.remove();return}let e=null;try{e=await L(`#${ib}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(wn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Si();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Me="ws-crm-prepare-contract-button-opp",Ct=`${Me}-wrap`,lb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,db=/\/v2\/location\/([A-Za-z0-9]+)/,cb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kn=()=>{let t=window.location.pathname,e=t.match(lb);if(!e)return null;let o=t.match(db);return o?{oppId:e[1],tenantId:o[1]}:null},pb=async()=>{for(let t of cb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lo=!1,At=null,En=null,gn=null,fn,It=()=>{At?.disconnect(),At=null,En=null},bb=t=>{if(At&&En===t)return;It();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(En=t,At=new MutationObserver(()=>{let o=kn();if(!o||o.oppId!==t){It();return}let r=D();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Me)?.remove(),document.getElementById(Ct)?.remove(),It();return}document.getElementById(Me)||Ci()}),At.observe(e,{childList:!0,subtree:!0}))},hb=()=>{gn||(gn=new MutationObserver(()=>{fn===void 0&&(fn=window.setTimeout(()=>{fn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Me);t&&!e&&!Lo&&Ci()},300))}),gn.observe(document.body,{childList:!0,subtree:!0}))},Ci=async()=>{if(!Lo){Lo=!0;try{let t=kn();if(!t){document.getElementById(Me)?.remove(),document.getElementById(Ct)?.remove(),It();return}let e=document.getElementById(Me);if(e&&e.dataset.oppId===t.oppId){let l=D();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Ct)?.remove(),It());return}e&&(e.remove(),document.getElementById(Ct)?.remove());let o=await pb();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await q();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=kn();if(!a||a.oppId!==t.oppId)return;let i=Si();i.id=Me,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Ct,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),bb(t.oppId)}finally{Lo=!1}}},Ai=()=>{ob(),sb()};Dp();function Q(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function be(t){return Q(t)}var Ro="reos-theme-stylesheet",Wi="reos-theme-fonts",mb=()=>{let t=document.getElementById(Wi);t&&t.remove()},ub=`
/* ============================================
...
`,vb=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],_b=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},yb=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),gb=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Sn=new WeakSet,Ii=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Sn.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Sn.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Sn.add(e)}catch{}})}catch{}},Li=new WeakSet,Lt=()=>{document.querySelectorAll(gb.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(Li.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),Li.add(r))})})},$i=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Do=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},Mi=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},$t=()=>{for(let t of vb){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=yb.has(r)?_b(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},No="#1A1F28",fb=26,wb=31,xb=40,Oi=new Set,Di=new Set,Ho=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!Di.has(a)&&a!=="<no class>"&&(Di.add(a),p.debug(`Hid empty "--" leaf: "${a}"`))})},kb=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Eb=["trash","Trash","TRASH","delete","Delete","DELETE"],Tb=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Eb.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";kb.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Sb=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Cb=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Sb.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Hi=new Set,Pi=new WeakSet,Ab=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Pi.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Pi.add(e);let b=e.className?.toString()||"<no class>";!Hi.has(b)&&b!=="<no class>"&&(Hi.add(b),p.debug(`Remapped pure-white text -> bone: "${b}"`))})},Bi=new Set,Ib=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,c=l.backgroundImage||"",b=!1;if(c!=="none"&&c.includes("gradient"))b=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let A=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(A&&parseFloat(A[1])<.6)return;let k=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let g=parseInt(k[1],10),T=parseInt(k[2],10),I=parseInt(k[3],10);(g>=60||T>=60||I>=60)&&(g>230&&T>230&&I>230||(g>=80||T>=80||I>=80)&&(b=!0))}}if(!b)return;let h=(i.textContent||"").trim(),_=s,x=Array.from(i.querySelectorAll("*")).map(A=>(A.className?.toString()||"").toLowerCase()).join(" "),E=h.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),w=_.includes("bg-clip-text")||_.includes("text-transparent")||x.includes("bg-clip-text")||x.includes("text-transparent"),y=Array.from(i.querySelectorAll("*")).some(A=>{let k=window.getComputedStyle(A),g=k.getPropertyValue("-webkit-background-clip")||"",T=k.getPropertyValue("background-clip")||"";return g.includes("text")||T.includes("text")});if(E||w||y){let A=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=g=>{A.forEach(T=>g.style.removeProperty(T))};k(i),i.querySelectorAll("*").forEach(k);return}let f="#12161D";i.style.setProperty("color",f,"important"),i.querySelectorAll("*").forEach(A=>{let k=A.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(A.style.setProperty("fill",f,"important"),A.style.setProperty("stroke",f,"important"),A.style.setProperty("color",f,"important")):(A.style.setProperty("color",f,"important"),A.style.setProperty("-webkit-text-fill-color",f,"important"))});let C=i.className?.toString()||"<no class>";!Bi.has(C)&&C!=="<no class>"&&(Bi.add(C),p.debug(`Darkened SVG icons on colored button: "${C}"`))})})},Fi=new Set,Lb=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let b=d.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let m=b.left<r.right&&b.right>r.left,h=b.top<r.bottom&&b.bottom>r.top;if(!(m&&h)||b.top+b.height/2<a)return;let x=b.width*b.height/(r.width*r.height);if(x>.55)return;let E=c,w=c.parentElement,y=0;for(;w&&w!==e&&y<3;){let C=w.getBoundingClientRect();if(C.width>0&&C.width<=30&&C.height<=30)E=w;else break;w=w.parentElement,y++}E.style.setProperty("transform","translateY(11px)","important");let f=(E.className?.toString()||"")+" "+E.tagName;Fi.has(f)||(Fi.add(f),p.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${f}"`))})})},$b="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Mb=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",$b,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Ri=new Set,Ob=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let b=r.className?.toString()||"<no class>";!Ri.has(b)&&b!=="<no class>"&&(Ri.add(b),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${c})): "${b}"`))})})},Ni=new Set,Db=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Ni.has(l)&&l!=="<no class>"&&(Ni.add(l),p.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},zi=new Set,Hb=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let b=parseInt(c[1],10),m=parseInt(c[2],10),h=parseInt(c[3],10);if(!(b>200&&m>200&&h>200))return;let x=s.getBoundingClientRect();if(x.width<24||x.height<16||x.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let E=s.className?.toString()||"<no class>";!zi.has(E)&&E!=="<no class>"&&(zi.add(E),p.debug(`Coerced light bg (${x.width.toFixed(0)}x${x.height.toFixed(0)}, rgb(${b},${m},${h})): "${E}"`))})})},Gi=new Set,Pb=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=o.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let f=0;f<4&&a;f++){let C=a.nextElementSibling;if(C&&(C.matches(t)||C.querySelector(t)!==null)){i=C;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),c=l.className?.toString()||"",b=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let E=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;E&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!b&&!m&&!_&&!x&&!E&&!w&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",No,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let y=o.className?.toString()||"<no class>";!Gi.has(y)&&y!=="<no class>"&&(Gi.add(y),p.debug(`Colored field label "${r.slice(0,30)}": "${y}"`))})},qi=new Set,Bb=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!qi.has(d)&&d!=="<no class>"&&(qi.add(d),p.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Ui=new Set,Fb=new Set(["Enter Dashboard Name"]),Rb=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Fb.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",No,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",No,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!Ui.has(i)&&i!=="<no class>"&&(Ui.add(i),p.debug(`Forced input slate bg: "${i}"`))})},Po=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<fb&&l<wb&&d<xb))return;let b=e.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;e.style.setProperty("background-color",No,"important");let m=e.className?.toString()||"<no class>";!Oi.has(m)&&m!=="<no class>"&&(Oi.add(m),p.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},Bo=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,b=!1;if(e.forEach(_=>{c.includes(_)&&(c=c.split(_).join(t),b=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{c.includes(_)&&(c=c.split(_).join("transparent"),b=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(x=>{c.includes(x)&&(c=c.split(x).join("#EDEEF0"),b=!0)}),!!b)try{let _=btoa(c);i.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},Fo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Nb=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Mt=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let b=r.querySelector(".ui-upload-icon svg");b&&(b.style.setProperty("color",c,"important"),b.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},Cn=new WeakSet,zb=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Cn.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Cn.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Ft}`,t.title=`Built ${Rt}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var P=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Yi=()=>{if(p.info(`Loaded v${Ft} (built ${Rt})`),Vo()){p.info(`[main] customizer disabled for excluded location ${De()} \u2014 bailing`);return}P("mountVersionBadge (initial)",zo),P("mountFavicon",sa),P("mountThemeStylesheet",ji),P("mountHideLaunchpad",Rr),P("initPageRouter",Mn),p.info("[main] registering onPageChange subscriber"),Bt(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),Vo()){p.info(`[main] page change into excluded location ${De()} \u2014 skipping mounts`);return}P("mountVersionBadge",zo),P("mountHideLaunchpad",Rr),P("mountClaimReleaseToggle",Jn),P("mountContactActionsBar",aa),P("mountActiveFollowUpButton",Nn),P("mountMtOfferMadeButton",ca),P("mountNotInterestedButton",pa),P("mountScheduleWalkthroughButton",ba),P("mountResendDealLinkButton",ma),P("mountReducePriceButton",va),P("mountEditLandingPageButton",_a),P("mountPublishButton",fa),P("mountContactMapLinks",Sa),P("mountSendToClosingOfficeButton",Oa),P("mountOppActionBar",Ya),P("mountClosingAgentPickerButton",pi),P("mountPrepareContractButton",Ai),P("mountManageTeam",ui),P("mountBuyBoxWidget",Wn),P("mountSupportNavItem",ri)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Yi):Yi();})();
