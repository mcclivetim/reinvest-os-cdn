/* Wholesaling CRM Customizer v0.15.2 — built 2026-05-30T19:24:41.897Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ue="[wholesaling-crm-customizer]",Dr="__WS_CRM_DEBUG",Fr=()=>!!window[Dr],c={info(...t){console.log(Ue,...t)},warn(...t){console.warn(Ue,...t)},error(...t){console.error(Ue,...t)},debug(...t){Fr()&&console.log(Ue,"[debug]",...t)}};var ho=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tt=/\/v2\/location\/([A-Za-z0-9]+)/,$r=t=>{let e=t.match(ho);if(!e)return null;let o=t.match(Tt);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Pr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(ho);if(!n)continue;let a=r.match(Tt)||window.location.pathname.match(Tt);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},C=()=>{let t=$r(window.location.pathname);return t||Pr()};var po=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ve="",St=null,pe="other",Ct=new Set,qe=()=>{let t=C()?.contactId??null;if(!(!(window.location.pathname!==Ve)&&!(t!==St))){Ve=window.location.pathname,St=t,pe=po(),c.debug("Page/context changed:",pe,Ve,"contact:",t);for(let r of Ct)try{r(pe)}catch(n){c.error("Subscriber threw:",n)}}},mo=t=>(Ct.add(t),setTimeout(()=>t(pe),0),()=>{Ct.delete(t)}),uo=()=>{pe=po(),Ve=window.location.pathname,St=C()?.contactId??null,c.debug("Router init, current page:",pe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),qe()},history.replaceState=function(o,r,n){e(o,r,n),qe()},window.addEventListener("popstate",qe),setInterval(qe,1e3)};var We="0.15.2",je="2026-05-30T19:24:41.897Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let l=n.querySelector(t);if(l){a(l);return}let d,b,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),c.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},At={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},_o=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,D=`
  ...
  flex-shrink: 0;
`;var Or=/^[A-Za-z0-9]{15,30}$/,ke=t=>typeof t=="string"&&Or.test(t),Nr=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Hr=()=>{let t=window.WS_CRM_USER_ID;return ke(t)?t:null},Rr=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ke(o))return o;return null},Br=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Nr(e);if(!o)return null;let r=o.uid;if(ke(r))return r;let n=o.claims;if(n&&ke(n.user_id))return n.user_id}catch{}return null},Gr=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ke(n))return n}catch{}}}catch{}return null},I=()=>Hr()||Rr()||Br()||Gr()||null;var fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",zr=`${fo}/active-follow-up-get`,Ur=`${fo}/active-follow-up-set`,ie="ws-crm-active-follow-up-button",Lt={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},qr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Vr=async t=>{let e=await fetch(zr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Wr=async(t,e)=>{let o=await fetch(Ur,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},le=(t,e)=>{let o=Lt[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},vo=t=>{let e=document.createElement("button");return e.type="button",e.id=ie,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,le(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=qr();if(!(!r||r.contactId!==t)){le(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Wr(r,I()),a=n&&n.state&&n.state in Lt?n.state:"blue";le(e,a),c.info(`Active Follow Up set for ${t} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),le(e,"error"),setTimeout(()=>void Ke(e,r),4e3)}}}),e},Ke=async(t,e)=>{le(t,"loading");try{let o=await Vr(e),r=o&&o.state&&o.state in Lt?o.state:"gray",n=document.getElementById(ie);if(!n||n.dataset.contactId!==e.contactId)return;le(n,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),le(t,"error")}},jr=[".central-panel","[class*='central-panel']"],It="ws-crm-contact-actions-bar",Kr=async()=>{for(let t of jr)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Yr=async(t,e)=>{let o=e.querySelector(`#${It}`);if(!o)try{o=await A(`#${It}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${It}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},Xr=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Jr=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Qr=async t=>{if(t==="url"){let o=await Kr();return o?{kind:"contact-detail",target:o}:null}let e=Xr();return e?{kind:"conversations",target:e}:null},yo=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Yr(t,e.target);return o}return Jr(t,e.target),"conversations-header"},Zr=async()=>{let t=C();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(ie);if(o&&o.dataset.contactId===e.contactId){Ke(o,e);return}o&&o.remove();let r=await Qr(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=C();if(!n||n.contactId!==e.contactId)return;let a=vo(e.contactId),i=await yo(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),go();let l=document.getElementById(ie)??a;Ke(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(ie);if(!(C()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=vo(e.contactId);yo(m,r).then(()=>{go(),Ke(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ee=null,wo=()=>{let t=C()?.contactId??null;if(Ee&&Ee.contactId===t)return;let e=Zr().finally(()=>{Ee?.promise===e&&(Ee=null)});Ee={contactId:t,promise:e}},go=()=>{let t=document.querySelectorAll(`#${ie}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ee="ws-crm-claim-release-pill",en="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",on=async t=>{let e=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},rn=async t=>{let e=await fetch(tn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Eo=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},me=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;t.dataset.mode=e,t.style.cssText=_o(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},nn=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ee,o.type="button",o.dataset.contactId=t,me(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=C();if(!n||!n.locationId||n.contactId!==t)return;let a=I();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>me(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";me(o,i),o.disabled=!0,o.style.opacity="0.8";try{let l=await rn({contactId:t,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:i;me(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),me(o,r);let d=o.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},xo=async(t,e)=>{try{let o=await on({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(ee);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";me(r,n)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},an=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Eo(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},ko=(t,e)=>{let o=nn({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ee}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},sn=async()=>{let t=C();if(!t){document.getElementById(ee)?.remove();return}let e=document.getElementById(ee);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await an(o),n=C();if(!n||n.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ko(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let a=document.getElementById(ee);a&&t.locationId&&xo(a,{contactId:t.contactId,locationId:t.locationId});let i=null;i=new MutationObserver(async()=>{if(!(C()?.contactId===t.contactId)){i?.disconnect();return}if(document.getElementById(ee))return;let d=Eo(o);if(d){ko(d,t.contactId);let b=document.getElementById(ee);b&&t.locationId&&xo(b,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},To=()=>{sn()};var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Te=new Map,So=async(t,e)=>{if(!t)return null;if(Te.has(t))return Te.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${ln}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${t}`),Te.set(t,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return Te.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,n),Te.set(t,null),null}};var Co=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Fo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",dn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",bn=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let l=a||Fo,d;if(i==="buyer"){let h=$o.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let b=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},hn=async({contactId:t,tenantId:e})=>{let o=await fetch(cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var ue="ws-crm-contact-actions-bar",pn="ws-crm-call-status-dropdown",Ao="ws-crm-offer-made-modal",mn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],$o=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],un=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],_n=async()=>{for(let t of un)try{let e=await A(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},vn=({contactId:t,kind:e})=>{let o=e==="buyer"?$o:mn,r=e==="buyer"?dn:Fo,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=pn,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=D,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${At[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=s.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=At[d.color]),m&&(m.textContent=d.label),l.style.display="none";let w=C()?.locationId,T=I();if(!w){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=s.amber);return}if(e==="seller"&&d.color==="green"&&!T){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=s.amber);return}let g=p?.textContent??"\u25BE",u=async y=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await bn({contactId:t,locationId:w,status:d.label,userId:T,deadReason:y,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=g),i.style.opacity="1"},900)}catch(k){c.warn("Call Status webhook failed:",k),p&&(p.textContent="\u2717"),m&&(m.style.color=s.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=g),m&&(m.style.color=s.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";wn(k=>{u(k)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await hn({contactId:t,tenantId:w})).ok?await u():xn(()=>{u()},()=>{m&&(m.textContent=y)})}catch(k){c.warn("Appointment sanity check failed; firing anyway:",k),await u()}return}await u()}),l.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(i),a.appendChild(l),a},yn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",gn=async t=>{let e=await fetch(yn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},fn=(t,e="seller")=>{document.getElementById(Ao)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=o?s.emerald:s.amber,i=document.createElement("div");i.id=Ao,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,i.appendChild(l),document.body.appendChild(i);let m=()=>i.remove();i.addEventListener("click",T=>{T.target===i&&m()});let p=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),w=l.querySelector("#ws-offer-submit");_?.addEventListener("click",m),w?.addEventListener("click",async()=>{let T=(l.querySelector("#ws-offer-amount")?.value??"").trim(),g=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!T||Number(T)<=0){p&&(p.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let u=Number(T);if(u<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(u*1e3).toLocaleString("en-US")}?`);return}let k=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),E=k?k[1]:null;if(!E){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),w&&(w.disabled=!0,w.textContent="Recording\u2026",w.style.opacity="0.7"),_&&(_.disabled=!0);try{let f=await gn({tenantId:E,contactId:t,kind:e,amount:u,expiresAt:g||null,userId:I()});if(!f.ok){p&&(p.textContent=f.error??"Something went wrong."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${u} on ${f.opp_pipeline} opp (stage: ${f.opp_stage_name??"?"})`),m()}catch(f){c.error("Offer Made webhook failed",f),p&&(p.textContent=f instanceof Error?f.message:"Network error \u2014 try again."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Io="ws-crm-dead-deal-modal",wn=(t,e)=>{document.getElementById(Io)?.remove();let o=document.createElement("div");o.id=Io,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),a=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let i=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Mo=(t,e)=>{let o=document.createElement("div");if(o.id=ue,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=X,r.textContent="Offer Made",r.addEventListener("click",()=>fn(t,e)),o.appendChild(r),o.appendChild(vn({contactId:t,kind:e}))}return o},Mt=!1,kn=()=>{document.querySelectorAll(`[id="${ue}"]`).forEach(t=>t.remove())},Po=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Mt){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Mt=!0;try{await En()}finally{Mt=!1}},En=async()=>{let t=C();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),kn();return}c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let b=await So(t.contactId,t.locationId),h=Co(b);h==="buyer"?e="buyer":h==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=C();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ue}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await _n();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=C();if(!a||a.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Mo(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(ue)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(C()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${ue}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Mo(t.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},Do=null,Tn=()=>{Do===null&&(Do=window.setInterval(()=>{let t=C();t&&(document.getElementById(ue)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Po()))},3e3))},Oo=()=>{Tn(),Po()};var Ye="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Sn=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Se="data-ws-crm-favicon",Dt=t=>t.hasAttribute(Se),No=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Sn.has(e)},Xe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{No(r)&&!Dt(r)&&r.remove()});let e=document.head.querySelector(`link[${Se}="1"]`);e?e.href!==Ye&&(e.href=Ye):(e=document.createElement("link"),e.setAttribute(Se,"1"),e.rel="icon",e.type="image/png",e.href=Ye,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Se}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Se,"apple"),o.rel="apple-touch-icon",o.href=Ye,document.head.appendChild(o))},Ho=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Xe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Xe())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&No(i)&&!Dt(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Dt(i)&&(n=!0)});n&&Xe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Xe(),e>=5&&window.clearInterval(o)},1e3)};var Cn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],An=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,In=".hr-card.hr-modal.crm-opportunities-modal",F=()=>{let t=document.querySelector(In);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(An);if(n){let a=n[1];if(Cn.includes(a))return a}}return null},te=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=F();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",U="ws-crm-mt-offer-made-button",Ro="ws-crm-mt-offer-made-modal",Mn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dn=/\/v2\/location\/([A-Za-z0-9]+)/,Ze=()=>{let t=window.location.pathname,e=t.match(Mn);if(!e)return null;let o=t.match(Dn);return{oppId:e[1],locationId:o?o[1]:null}},Fn=async t=>{let e=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Je=()=>{document.getElementById(Ro)?.remove()},$n=t=>{Je();let e=document.createElement("div");e.id=Ro,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Ze();!o||!o.locationId||o.oppId!==t||$n({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=D)},4e3)}})}),e},On=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Nn=async()=>{for(let t of On)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qe=!1,Ot=async()=>{if(!Qe){Qe=!0;try{await Hn()}finally{Qe=!1}}},Hn=async()=>{let t=Ze();if(!t||!t.locationId){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}let e=document.getElementById(U);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae());return}e&&(e.remove(),document.getElementById(`${U}-wrap`)?.remove());let o=await Nn();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ze();if(!n||n.oppId!==t.oppId)return;let a=Pn(t.oppId),i=document.createElement("span");i.id=`${U}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Rn(t.oppId)},Ce=null,Pt=null,Ae=()=>{Ce?.disconnect(),Ce=null,Pt=null},Rn=t=>{if(Ce&&Pt===t)return;Ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pt=t,Ce=new MutationObserver(()=>{let o=Ze();if(!o||o.oppId!==t){Ae();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(U)?.remove(),document.getElementById(`${U}-wrap`)?.remove(),Ae();return}document.getElementById(U)||Ot()}),Ce.observe(e,{childList:!0,subtree:!0}))},Ft=null,$t,Bn=()=>{Ft||(Ft=new MutationObserver(()=>{$t===void 0&&($t=window.setTimeout(()=>{$t=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(U);t&&!e&&!Qe&&Ot()},300))}),Ft.observe(document.body,{childList:!0,subtree:!0}))},Bo=()=>{Bn(),Ot()};var Gn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",q="ws-crm-not-interested-button",zn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Un=/\/v2\/location\/([A-Za-z0-9]+)/,tt=()=>{let t=window.location.pathname,e=t.match(zn);if(!e)return null;let o=t.match(Un);return{oppId:e[1],locationId:o?o[1]:null}},qn=async t=>{let e=await fetch(Gn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Vn=t=>{let e=document.createElement("button");return e.id=q,e.type="button",e.dataset.oppId=t,e.style.cssText=D,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=tt();if(!o||!o.locationId||o.oppId!==t)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await qn({oppId:o.oppId,locationId:o.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},Wn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jn=async()=>{for(let t of Wn)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},et=!1,Bt=async()=>{if(!et){et=!0;try{await Kn()}finally{et=!1}}},Kn=async()=>{let t=tt();if(!t||!t.locationId){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le());return}e&&(e.remove(),document.getElementById(`${q}-wrap`)?.remove());let o=await jn();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=tt();if(!n||n.oppId!==t.oppId)return;let a=Vn(t.oppId),i=document.createElement("span");i.id=`${q}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Yn(t.oppId)},Ie=null,Rt=null,Le=()=>{Ie?.disconnect(),Ie=null,Rt=null},Yn=t=>{if(Ie&&Rt===t)return;Le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rt=t,Ie=new MutationObserver(()=>{let o=tt();if(!o||o.oppId!==t){Le();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(q)?.remove(),document.getElementById(`${q}-wrap`)?.remove(),Le();return}document.getElementById(q)||Bt()}),Ie.observe(e,{childList:!0,subtree:!0}))},Nt=null,Ht,Xn=()=>{Nt||(Nt=new MutationObserver(()=>{Ht===void 0&&(Ht=window.setTimeout(()=>{Ht=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(q);t&&!e&&!et&&Bt()},300))}),Nt.observe(document.body,{childList:!0,subtree:!0}))},Go=()=>{Xn(),Bt()};var Jn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",V="ws-crm-reduce-price-button",zo="ws-crm-reduce-price-modal",Qn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zn=/\/v2\/location\/([A-Za-z0-9]+)/,nt=()=>{let t=window.location.pathname,e=t.match(Qn);if(!e)return null;let o=t.match(Zn);return{oppId:e[1],locationId:o?o[1]:null}},ea=async t=>{let e=await fetch(Jn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ot=()=>{document.getElementById(zo)?.remove()},ta=t=>{ot();let e=document.createElement("div");e.id=zo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=nt();!r||!r.locationId||r.oppId!==t||ta({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),a=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,a&&(a.style.background=s.emerald,a.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=D,a&&(a.style.background=s.amber,a.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},ra=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],na=async()=>{for(let t of ra)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},rt=!1,qt=async()=>{if(!rt){rt=!0;try{await aa()}finally{rt=!1}}},aa=async()=>{let t=nt();if(!t||!t.locationId){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}let e=document.getElementById(V);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove(),De());return}e&&(e.remove(),document.getElementById(`${V}-wrap`)?.remove());let o=await na();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await te();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=nt();if(!n||n.oppId!==t.oppId)return;let a=oa(t.oppId,t.locationId),i=document.createElement("span");i.id=`${V}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),sa(t.oppId)},Me=null,Ut=null,De=()=>{Me?.disconnect(),Me=null,Ut=null},sa=t=>{if(Me&&Ut===t)return;De();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ut=t,Me=new MutationObserver(()=>{let o=nt();if(!o||o.oppId!==t){De();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(V)?.remove(),document.getElementById(`${V}-wrap`)?.remove(),De();return}document.getElementById(V)||qt()}),Me.observe(e,{childList:!0,subtree:!0}))},Gt=null,zt,ia=()=>{Gt||(Gt=new MutationObserver(()=>{zt===void 0&&(zt=window.setTimeout(()=>{zt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);t&&!e&&!rt&&qt()},300))}),Gt.observe(document.body,{childList:!0,subtree:!0}))},Uo=()=>{ia(),qt()};var Wo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",oe="ws-crm-send-to-closing-office-button",de="ws-crm-send-to-title-co-wrap",it="ws-crm-stc-dropdown",la=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,da=/\/v2\/location\/([A-Za-z0-9]+)/,lt=()=>{let t=window.location.pathname,e=t.match(la);if(!e)return null;let o=t.match(da);return{oppId:e[1],locationId:o?o[1]:null}},ca=5*60*1e3,jo=t=>`ws-crm-stc-cache:${t}`,ba=t=>{try{let e=window.localStorage.getItem(jo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ca||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},ha=(t,e)=>{try{window.localStorage.setItem(jo(t),JSON.stringify(e))}catch{}},pa=async(t,e)=>{try{let o=await fetch(Wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},ma=async(t,e,o)=>{let r=await fetch(Wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},ua=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},qo=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},_a=(t,e)=>{if(e&&ua(e)){window.setTimeout(()=>qo(t),300);return}qo(t)},W=()=>{document.getElementById(it)?.remove()},at=(t,e,o)=>{W();let r=document.createElement("div");r.id=it;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(_=>{h[_.group]||(h[_.group]=[]),h[_.group].push(_)});let m=[...b.filter(_=>h[_]),...Object.keys(h).filter(_=>!b.includes(_))];for(let _ of m){let w=h[_],T=document.createElement("div");T.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${v.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${s.steel};
    `,g.textContent=_,T.appendChild(g),w.forEach(u=>{let y=document.createElement("div"),k=!u.filled&&u.navigable&&u.field_id;y.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${k?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,k&&(y.addEventListener("mouseenter",()=>{y.style.background=s.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",S=>{S.stopPropagation(),u.field_id&&(_a(u.field_id,u.folder),W())}));let E=u.filled?`<span style="color: ${s.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${s.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,f=k?`<span style="margin-left: auto; color: ${s.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${E}<span style="flex: 1;">${u.label}</span>${f}`,T.appendChild(y)}),r.appendChild(T)}document.body.appendChild(r);let p=_=>{let w=_.target;!r.contains(w)&&!o.contains(w)&&(W(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},K=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),n=t.querySelector(".ws-stc-chevron"),a,i,l=s.bone,d,b="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",i=s.steel,l=s.ash,d=s.coolGray,b="Checking\u2026",m="wait",p="0.8";break;case"ready":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(T=>T.filled).length??0,w=e.checks?.length??0;a="transparent",i=s.amber,l=s.amber,d=s.amber,b=`${_} of ${w} fields ready`,h="\u25BE";break}case"sending":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",p="0.8";break;case"sent":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=s.amber,l=s.amber,d=s.amber,b=e.message??"Try again";break}t.style.background=a,t.style.borderColor=i,t.style.color=l,t.style.cursor=m,t.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=b),n&&(n.textContent=h)},va=(t,e)=>{let o=document.createElement("button");o.id=oe,o.type="button",o.dataset.oppId=t;let r=ba(t),n=r?{status:r.checks.every(g=>g.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${X}
    background: transparent;
    border: 1px solid ${s.steel};
    color: ${s.ash};
  ...
  `,K(o,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let g=await pa(t,e);if(!g){n={status:"error",message:"Check failed \u2014 click to retry"},K(o,n);return}if(g.rate_limited){_=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},K(o,n),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){n={status:"error",message:g.error||"Check failed \u2014 click to retry"},K(o,n),c.warn("[stc] dry_run returned no checks:",g);return}let u=g.pipeline_name;if(u&&u!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${u}" (not TC) \u2014 retracting button + caching`),dt.add(t),document.getElementById(oe)?.remove(),document.getElementById(de)?.remove(),W(),$e();return}let y=g.checks;if(n.checks&&n.checks.length===g.checks.length){let E=new Set;y=g.checks.map((f,S)=>n.checks[S]?.filled&&!f.filled?a.has(f.label)?f:(E.add(f.label),{...f,filled:!0}):f),a=E}else a=new Set;n={status:y.every(E=>E.filled)?"ready":"incomplete",checks:y,previouslySentAt:g.previously_sent_at??null},ha(t,{checks:y,previously_sent_at:g.previously_sent_at??null,pipeline_name:u,ts:Date.now()}),K(o,n),document.getElementById(it)&&at(y,g.previously_sent_at,o)},l=async()=>{let g=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},K(o,n),W();try{let u=await ma(t,e,g);if(u.needs_confirm){n={status:"ready",checks:u.checks,previouslySentAt:u.previously_sent_at},K(o,n),u.checks&&at(u.checks,u.previously_sent_at,o);return}if(u.ok){n={status:"sent",checks:u.checks,previouslySentAt:new Date().toISOString()},K(o,n),window.setTimeout(()=>{w()},3500);return}n={status:"error",checks:u.checks,message:u.error||"Validation failed"},K(o,n),u.checks&&at(u.checks,u.previously_sent_at,o)}catch(u){c.error("[stc] send failed:",u),n={status:"error",message:"Network error \u2014 click to retry"},K(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(it)?W():n.checks&&at(n.checks,n.previouslySentAt,o);break}case"error":case"sent":w();break}});let d,b=!1,h=Date.now(),m=1e4,p=5*60*1e3,_=0,w=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,h=Date.now();try{await i()}finally{b=!1}}};w();let T=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(T){let g=new MutationObserver(()=>{if(d!==void 0||b)return;let y=Date.now()-h,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&w()},k)});g.observe(T,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let u=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(u))},5e3)}return o},ya=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ga=async()=>{for(let t of ya)try{let e=await A(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},dt=new Set,Vo=null,fa=t=>{t&&t!==Vo&&(dt.clear(),Vo=t)},st=!1,Kt=async()=>{if(st){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}st=!0;try{await wa()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{st=!1}},wa=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=lt();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(oe)?.remove(),document.getElementById(de)?.remove(),W();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),fa(t.oppId),dt.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(oe)?.remove(),document.getElementById(de)?.remove(),W();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=F();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(de)?.remove(),W(),$e());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(de)?.remove(),W()),c.debug("[stc] mount:04 calling findMountTarget");let o=await ga();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=F();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=lt();if(!n||n.oppId!==t.oppId||!n.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=va(t.oppId,n.locationId),i=document.createElement("span");i.id=de,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(a),o.appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(a)}`),xa(t.oppId)},Fe=null,jt=null,$e=()=>{Fe?.disconnect(),Fe=null,jt=null},xa=t=>{if(Fe&&jt===t)return;$e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jt=t,Fe=new MutationObserver(()=>{let o=lt();if(!o||o.oppId!==t){$e();return}let r=F();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(oe)?.remove(),document.getElementById(de)?.remove(),W(),$e();return}document.getElementById(oe)||Kt()}),Fe.observe(e,{childList:!0,subtree:!0}))},Vt=null,Wt,ka=()=>{Vt||(Vt=new MutationObserver(()=>{Wt===void 0&&(Wt=window.setTimeout(()=>{Wt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);if(t&&!e&&!st){let o=lt();if(o&&dt.has(o.oppId))return;Kt()}},300))}),Vt.observe(document.body,{childList:!0,subtree:!0}))},Ko=()=>{ka(),Kt()};var Ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Sa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Jo="ldtyB2UXKi9vOp8nLUH7",Ca="WVD2gb9swLsgcdBEtDVq",j="ws-crm-closing-agent-picker-button",Qo="ws-crm-closing-agent-picker-modal",Aa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ia=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let t=window.location.pathname,e=t.match(Aa);if(!e)return null;let o=t.match(Ia);return{oppId:e[1],locationId:o?o[1]:null}},oo=async t=>{let e=await fetch(Ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Yo=async t=>{let e=await fetch(Ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},La=async(t,e)=>{try{let o=await fetch(Sa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Jo}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await oo({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},ce=null,Ma=60*60*1e3,ro=t=>`ws-crm-to-cache:${t}`,Zo=t=>{try{let e=window.localStorage.getItem(ro(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Ma||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},er=(t,e,o)=>{try{window.localStorage.setItem(ro(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Da=t=>{try{window.localStorage.removeItem(ro(t))}catch{}},Qt="ws-crm-closing-agent-field-link",Fa=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Qt}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Yt=!1,no=async t=>{if(Yt)return;let e=tr();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Yt=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await oo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Zt(n.id,n.name,t);let a=document.getElementById(j);if(a){re(a,{status:"linked",contactName:n.name});let i=Ne();i&&er(i.oppId,n.id,n.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Yt=!1}}},$a=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,tr=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let b=(d.textContent||"").trim();$a.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&c.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let i=o[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Zt=(t,e,o)=>{let r=tr();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${Qt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=Qt,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},ct=()=>{document.getElementById(Qo)?.remove()},Pa=t=>{ct();let e=document.createElement("div");e.id=Qo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),a=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&ct()}),a?.addEventListener("click",ct);let i,l="",d=async b=>{if(n&&b!==l){if(l=b,!b.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await oo({tenantId:t.locationId,query:b,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{ct(),t.onPick(m)}),n.appendChild(p)})}catch(h){c.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          ...
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(b)},250)})},bt=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),re=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",a=s.amber,i=s.bone,l="transparent",d=s.steel,b="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=s.coolGray,i=s.ash,b="wait";break;case"empty":n="Link Closing Agent",a=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,i=s.emeraldBright;break;case"saving":n="Linking\u2026",a=s.coolGray,i=s.ash,b="wait";break}o&&(o.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),t.style.background=l,t.style.borderColor=d,t.style.color=i,t.style.cursor=b},Oa=(t,e)=>{let o=document.createElement("button");o.id=j,o.type="button",o.dataset.oppId=t,o.style.cssText=D,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};re(o,r);let n=Zo(t);return n&&(r={status:"linked",contactName:n.contactName},re(o,r),ce={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let i=await La(t,e);i?(r={status:"linked",contactName:i.name},re(o,r),ce={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Zt(i.id,i.name,e)):n||(r={status:"empty"},re(o,r),ce?.oppId===t&&(ce=null),Fa(),Da(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Pa({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},re(o,r);try{let l=[Yo({tenantId:e,oppId:t,fieldId:Jo,value:i.id})];i.companyName&&i.companyName.trim()&&l.push(Yo({tenantId:e,oppId:t,fieldId:Ca,value:i.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:i.name},re(o,r),ce={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},er(t,i.id,i.name),Zt(i.id,i.name,e),c.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},re(o,r)}}})}),o},Na=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ha=async()=>{for(let t of Na)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Pe=!1,pt=async()=>{if(!Pe){Pe=!0;try{await Ra()}finally{Pe=!1}}},Ra=async()=>{let t=Ne();if(!t||!t.locationId){document.getElementById(j)?.remove(),document.getElementById(`${j}-wrap`)?.remove(),ht();return}let e=document.getElementById(j);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove(),ht());return}e&&(e.remove(),document.getElementById(`${j}-wrap`)?.remove());let o=F();if(o!==null&&o!=="Transaction Coordination")return;let r=await Ha();if(!r||!(Zo(t.oppId)!==null||ce!==null&&ce.oppId===t.oppId)&&await te()!=="Transaction Coordination")return;let a=Ne();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=Oa(t.oppId,a.locationId),l=document.createElement("span");l.id=`${j}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(i),r.appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Ba(t.oppId),no(a.locationId)},Oe=null,eo=null,to=null,ht=()=>{Oe?.disconnect(),Oe=null,eo=null,to=null},Ba=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Oe&&eo===t&&to===e||(ht(),eo=t,to=e,Oe=new MutationObserver(()=>{let o=Ne();if(!o||o.oppId!==t||!o.locationId){ht();return}document.getElementById(j)||pt(),no(o.locationId)}),Oe.observe(e,{childList:!0,subtree:!0})))},Xt=null,Jt,Ga=()=>{Xt||(Xt=new MutationObserver(()=>{Jt===void 0&&(Jt=window.setTimeout(()=>{Jt=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);t&&!e&&!Pe&&pt()},300))}),Xt.observe(document.body,{childList:!0,subtree:!0}))},Xo,za=()=>{Xo===void 0&&(Xo=window.setInterval(()=>{let t=Ne();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(j)&&!Pe&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),pt()),no(t.locationId)},2e3))},or=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Ga(),za(),pt()};var Ua="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ao="ws-crm-prepare-contract-button",rr="ws-crm-prepare-contract-menu",ne="ws-crm-prepare-contract-modal",Q="https://services.leadconnectorhq.com",so="__WS_CRM_CAPTURED_AUTH",qa=50*60*1e3,ir=()=>{try{let t=localStorage.getItem(so);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>qa?(localStorage.removeItem(so),null):e:null}catch{return null}},Va=t=>{try{localStorage.setItem(so,JSON.stringify(t))}catch{}},Z=()=>{let t=ir(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},nr=!1,Wa=()=>{if(nr)return;nr=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let h=d.authorization||d.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=ir()?.authorization;Va({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let h=b.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,_)=>m[_.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,_])=>m[p.toLowerCase()]=_);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,i=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),i.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},lr=()=>{let t=C();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},ja=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Ka=async t=>{let e=`${Q}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:Z()});if(!o.ok){let a="";try{a=await o.text()}catch{}let i=a?` \u2014 ${a.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${i}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(a=>({id:(a._id??a.id??a.templateId)||"",name:a.name||a.title||"(unnamed template)",type:ja(a.name||a.title||"")})).filter(a=>!!a.id)},Ya=async(t,e)=>{let o=await fetch(`${Q}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let a=await fetch(`${Q}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Z()});if(!a.ok)throw new Error(`ACQ opp search ${a.status}`);return((await a.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},Xa=async(t,e)=>{let o=await fetch(`${Q}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${Q}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Z()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-h})},Ja=async t=>{let e=await fetch(Ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Qa=async(t,e,o)=>{let r=`${Q}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:Z()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let a=await n.json(),i=a._id||a.id||a.proposal?._id||a.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Za=async(t,e)=>{let o=await fetch(`${Q}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Z()});if(!o.ok){let a=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${a.slice(0,200)}`)}let r=await o.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},es=async t=>{let e=await fetch(`${Q}/contacts/${t}`,{method:"GET",headers:Z()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${n.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},ts=async(t,e,o,r)=>{let n;try{n=await Za(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let a;try{a=await es(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let i=`${a.firstName} ${a.lastName}`.trim()||a.email||o,l={id:o,firstName:a.firstName,lastName:a.lastName,email:a.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||t,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${Q}/proposals/document/${e}`,{method:"PUT",headers:{...Z(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let _=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:_}}return{ok:!0}},os=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},mt="__WS_CRM_PENDING_INSTRUCTIONS",rs=60*1e3,ns=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],as=t=>{let e=(t||"").toLowerCase();for(let o of ns)if(e.includes(o.matches.toLowerCase()))return o;return null},ss=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(mt,JSON.stringify(r))}catch{}},is=()=>{try{let t=localStorage.getItem(mt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>rs?(localStorage.removeItem(mt),null):e}catch{return null}},ls=()=>{try{localStorage.removeItem(mt)}catch{}},ds=(t,e)=>{document.getElementById(ne)?.remove();let o=document.createElement("div");o.id=ne,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},cs=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,bs=()=>{let t=window.location.pathname.match(cs);if(!t)return;let e=t[1],o=is();o&&o.proposalId===e&&(ls(),window.setTimeout(()=>{ds(o.title,o.bodyHtml)},600))},ar="ws-crm-prepare-contract-toast",B=(t,e="info",o=4e3)=>{document.getElementById(ar)?.remove();let r=document.createElement("div");r.id=ar;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},sr=(t,e)=>new Promise(o=>{document.getElementById(ne)?.remove();let r=document.createElement("div");r.id=ne,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let a=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},i=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${J(d.id)}" style="
          ...
          font-family: ${v.sans};
        ">
          <div style="font-size: 14px; font-weight: 500; line-height: 1.3;">${N(d.propertyAddress||d.name)}</div>
          ${d.updatedAt?`<div style="font-size: 11px; color: ${s.ash}; margin-top: 4px;">Last updated ${N(a(d.updatedAt))}</div>`:""}
        </button>
      `).join("");n.innerHTML=`
      <div style="
        font-family: ${v.mono};
      ...
      <div style="
        ...
        font-weight: 500;
        margin-bottom: 4px;
      ">This ${N(e.perspective)} has ${t.length} open deals</div>
      <div style="
        font-size: 12px;
        color: ${s.ash};
        margin-bottom: 16px;
        line-height: 1.4;
      ">Which property is this contract for? The ${N(e.agreementLabel)} will use that opp's data.</div>
      <div>${i}</div>
  ...
  `,R=`
    ...
    padding-right: 28px;
  `,$=L=>['<option value="">(unset)</option>'].concat(T.map(z=>`<option value="${J(z)}"${z===L?" selected":""}>${N(z)}</option>`)).join("");u.innerHTML=`
    <div style="
      font-family: ${v.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${f}">
        ...
        <div style="${E}">${N(a||"(set on Property record)")}</div>
      </div>
      <div style="${f}">
        <div style="${y}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${J(i)}" placeholder="Seller name" style="${k}" />
      </div>
      <div style="${f}">
      ...
      <div style="${f}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${J(h)}" placeholder="e.g. 30" style="${k}" />
      </div>
      <div style="${f}">
        <div style="${y}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${J(m)}" placeholder="e.g. 10" style="${k}" />
      </div>
      <div style="${f}">
        <div style="${y}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${R}">${$(_)}</select>
      </div>
      <div style="${f}">
        <div style="${y}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${R}">${$(w)}</select>
      </div>
      <div style="${f} align-items: flex-start;">
        <div style="${y}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${k} text-align: left; resize: vertical; min-height: 60px; font-family: ${v.sans};">${N(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,g.appendChild(u),document.body.appendChild(g);let ae=u.querySelector("#ws-pc-purchase-price"),se=u.querySelector("#ws-pc-emd"),Y=u.querySelector("#ws-pc-cash-at-close"),_e=!1;Y?.addEventListener("input",()=>{_e=!0});let Ge=()=>{if(_e)return;let L=Number(ae?.value||0),z=Number(se?.value||0);Y&&(Y.value=String(Math.max(0,L-z)))};ae?.addEventListener("input",Ge),se?.addEventListener("input",Ge);let be=()=>g.remove();g.addEventListener("click",L=>{L.target===g&&be()}),u.querySelector("#ws-pc-cancel")?.addEventListener("click",be);let M=u.querySelector("#ws-pc-submit"),G=u.querySelector("#ws-pc-error");M?.addEventListener("click",async()=>{if(M){G&&(G.textContent=""),M.disabled=!0,M.textContent="Opening\u2026";try{let L=(u.querySelector("#ws-pc-seller-name")?.value||"").trim(),z=Number(ae?.value||0),ve=Number(se?.value||0),ye=Number(Y?.value||0),ge=(u.querySelector("#ws-pc-days-to-close")?.value??"").trim(),he=(u.querySelector("#ws-pc-inspection-days")?.value??"").trim(),fe=(u.querySelector("#ws-pc-additional-terms")?.value??"").trim(),we=(u.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),P=(u.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),O={};if(L!==i&&(O.sellerName=L),z!==l&&(O.purchasePrice=z),ve!==d&&(O.emd=ve),ye!==b&&(O.cashAtClose=ye),ge!==h&&(O.daysToClose=ge),he!==m&&(O.inspectionDays=he),fe!==p&&(O.additionalTerms=fe),we!==_&&(O.currentOccupancy=we),P!==w&&(O.occupancyAtClose=P),Object.keys(O).length>0){c.info("[prepare-contract] PA modal submit with overrides:",O),M.textContent="Saving\u2026";let xe=I(),ze=await ut({tenantId:t,contactId:e,template:o,userId:xe,overrides:O});c.info("[prepare-contract] re-stage with overrides ok:",ze),M.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Et=a?`${a} - Purchase Agreement`:void 0;await io(t,e,o,Et)}catch(L){M.disabled=!1,M.textContent="Open Contract",G&&(G.textContent=L.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",L)}}})},ps=({tenantId:t,contactId:e,template:o,oppId:r,staged:n,userId:a,defaultClosingDate:i,defaultEMDDueDate:l})=>{document.getElementById(ne)?.remove();let d=n.debug||{},b=typeof d.propertyAddress=="string"?d.propertyAddress:"",h=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,p=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,w=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,T=typeof d.closingOffice=="string"?d.closingOffice:"",g=i,u=l,y="",k=document.createElement("div");k.id=ne,k.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${$}">
        ...
        <div style="${R}">${N(b||"(set on Property record)")}</div>
      </div>
      <div style="${$}">
        <div style="${f}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${J(h)}" placeholder="Seller name" style="${S}" />
      </div>
      <div style="${$}">
        <div style="${f}">Assignment Price</div>
        <div style="${ae}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${m}" style="${S}" />
        </div>
      </div>
      <div style="${$}">
        ...
        <div style="${ae}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${p}" style="${S}" />
        </div>
      </div>
      <div style="${$}">
      ...
      <div style="${$}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${J(T)}" placeholder="Title company" style="${S} text-align: left;" />
      </div>
      <div style="${$}">
        <div style="${f}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${J(g)}" style="${S} text-align: left;" />
      </div>
      <div style="${$}">
        <div style="${f}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${J(u)}" style="${S} text-align: left;" />
      </div>
      <div style="${$}">
        <div style="${f}">Lender Source <span style="color: ${s.coolGray}; text-transform: none; letter-spacing: 0; font-family: ${v.sans};">(optional)</span></div>
        <input id="ws-pc-lender-source" type="text" placeholder="e.g. ABC Hard Money LLC" style="${S} text-align: left;" />
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,k.appendChild(E),document.body.appendChild(k);let se=E.querySelector("#ws-pc-assignment-price"),Y=E.querySelector("#ws-pc-assignment-fee"),_e=!1;Y?.addEventListener("input",()=>{_e=!0});let Ge=()=>{if(_e)return;let L=Number(se?.value||0);Y&&(Y.value=String(Math.max(0,L-w)))};se?.addEventListener("input",Ge);let be=()=>k.remove();k.addEventListener("click",L=>{L.target===k&&be()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",be);let M=E.querySelector("#ws-pc-submit"),G=E.querySelector("#ws-pc-error");M?.addEventListener("click",async()=>{if(!M)return;G&&(G.textContent="");let L=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),z=Number(se?.value||0),ve=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),ye=Number(Y?.value||0),ge=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),he=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),fe=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),we=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!he){G&&(G.textContent="Closing Date is required.");return}M.disabled=!0,M.textContent="Opening\u2026";try{let P={};L!==h&&(P.sellerName=L),z!==m&&(P.assignmentPrice=z),ve!==p&&(P.buyerEMD=ve),ye!==_&&(P.assignmentFee=ye),ge!==T&&(P.closingOffice=ge);let O=he!==g||fe!==u||we!==y,Et=Object.keys(P).length>0||O,xe=n;Et?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",P),M.textContent="Saving\u2026",xe=await ut({tenantId:t,contactId:e,template:o,oppId:r,closingDate:he,buyerEarnestDueDate:fe,lenderSource:we,userId:a,overrides:Object.keys(P).length>0?P:void 0}),c.info("[prepare-contract] AA re-stage ok:",xe),M.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let ze=xe?.debug?.propertyAddress||b,Mr=ze?`${ze} - Assignment Agreement`:void 0;await io(t,e,o,Mr),be()}catch(P){M.disabled=!1,M.textContent="Open Contract",G&&(G.textContent=P.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",P)}})},ut=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ja({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},io=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let n=await Qa(t,o.id,e);c.info(`[prepare-contract] proposal created: ${n}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let a=await ts(t,n,e,r);a.ok?c.info(`[prepare-contract] contact attached to proposal ${n}`):(c.warn(`[prepare-contract] attach failed (status=${a.status??"n/a"}): ${a.body?.slice(0,300)??"no body"}`),B(`Proposal created but couldn't auto-attach contact (HTTP ${a.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",a.body));let i=as(o.name);i&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),ss(n,i.title,i.bodyHtml)),os(t,n)},ms=async t=>{let e=lr();if(!e){B("Could not resolve contact context.","error");return}document.getElementById(rr)?.remove();let o=document.createElement("div");o.id=rr,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Ka(e.tenantId)}catch(a){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${s.crimson}; font-size: 12px;">
        Failed to load templates: ${N(a.message)}
    ...
    `;let l=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;i.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${N(a.name)}</span>
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=s.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let b=I();try{if(a.type==="AA"){let h;try{h=await Xa(e.tenantId,e.contactId)}catch(u){B(`Failed to load buyer's MT opps: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",u);return}if(h.length===0){B("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${h.length} opps)`);let u=await sr(h,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!u){c.info("[prepare-contract] MT opp picker cancelled");return}m=u,c.info(`[prepare-contract] picked MT opp ${m}`)}let p=u=>{let y=u.getFullYear(),k=String(u.getMonth()+1).padStart(2,"0"),E=String(u.getDate()).padStart(2,"0");return`${y}-${k}-${E}`},_=u=>{let y=new Date;return y.setDate(y.getDate()+u),p(y)},w=_(45),T=_(7);B("Reading contract data\u2026","info",2500);let g;try{g=await ut({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,closingDate:w,buyerEarnestDueDate:T,userId:b})}catch(u){B(`Failed to prepare contract: ${u.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",u);return}ps({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,staged:g,userId:b,defaultClosingDate:w,defaultEMDDueDate:T})}else if(a.type==="PA"){let h;try{h=await Ya(e.tenantId,e.contactId)}catch(_){B(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(h.length===0){B("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let _=await sr(h,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}B("Reading contract data\u2026","info",2500);let p;try{p=await ut({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,userId:b})}catch(_){B(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}hs({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:p})}else{B(`Opening ${a.name}\u2026`,"info",2500);try{await io(e.tenantId,e.contactId,a)}catch(h){B(`Failed to open contract: ${h.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){c.warn("[prepare-contract] picker click handler failed:",h),B(`Unexpected error: ${h.message}`,"error",6e3)}}),o.appendChild(i)}},us=()=>{let t=document.createElement("button");return t.id=ao,t.type="button",t.style.cssText=`
    position: relative;
    background: ${s.slate};
    border: 1px solid ${s.steel};
    border-radius: ${x.sm};
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),ms(t)}),t},_s="ws-crm-contact-actions-bar",vs=async()=>{let t=lr();if(!t){document.getElementById(ao)?.remove();return}let e=null;try{e=await A(`#${_s}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(ao);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=us();r.dataset.contactId=t.contactId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},dr=()=>{bs(),vs()};Wa();function N(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function J(t){return N(t)}var wt="reos-theme-stylesheet",Cr="reos-theme-fonts",ys=()=>{let t=document.getElementById(Cr);t&&t.remove()},gs=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var H=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Lr=()=>{c.info(`Loaded v${We} (built ${je})`),H("mountVersionBadge (initial)",kt),H("mountFavicon",Ho),H("mountThemeStylesheet",Ar),H("initPageRouter",uo),c.info("[main] registering onPageChange subscriber"),mo(t=>{c.info(`[main] onPageChange callback fired for page=${t}`),H("mountVersionBadge",kt),H("mountClaimReleaseToggle",To),H("mountContactActionsBar",Oo),H("mountActiveFollowUpButton",wo),H("mountMtOfferMadeButton",Bo),H("mountNotInterestedButton",Go),H("mountReducePriceButton",Uo),H("mountSendToClosingOfficeButton",Ko),H("mountClosingAgentPickerButton",or),H("mountPrepareContractButton",dr)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Lr):Lr();})();
