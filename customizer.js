/* Wholesaling CRM Customizer v0.46.1 — built 2026-07-03T15:59:31.919Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Mo="[wholesaling-crm-customizer]",gc="__WS_CRM_DEBUG",fc=()=>!!window[gc],c={info(...t){console.log(Mo,...t)},warn(...t){console.warn(Mo,...t)},error(...t){console.error(Mo,...t)},debug(...t){fc()&&console.log(Mo,"[debug]",...t)}};var xc=/\/v2\/location\/([A-Za-z0-9]+)/,wc=new Set(["8ntUQzMflUkR0YvrRgVk"]),J=()=>{let t=window.location.pathname.match(xc);return t?t[1]:null},Jr=()=>{let t=J();return t!==null&&wc.has(t)};var as=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qr=/\/v2\/location\/([A-Za-z0-9]+)/,kc=t=>{let e=t.match(as);if(!e)return null;let o=t.match(Qr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Ec=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(as);if(!a)continue;let s=r.match(Qr)||window.location.pathname.match(Qr);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},B=()=>{let t=kc(window.location.pathname);return t||Ec()};var ss=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Oo="",Zr=null,Gt="other",Xr=new Set,Po=()=>{let t=B()?.contactId??null;if(!(!(window.location.pathname!==Oo)&&!(t!==Zr))){Oo=window.location.pathname,Zr=t,Gt=ss(),c.debug("Page/context changed:",Gt,Oo,"contact:",t);for(let r of Xr)try{r(Gt)}catch(a){c.error("Subscriber threw:",a)}}},_t=t=>(Xr.add(t),setTimeout(()=>t(Gt),0),()=>{Xr.delete(t)}),is=()=>{Gt=ss(),Oo=window.location.pathname,Zr=B()?.contactId??null,c.debug("Router init, current page:",Gt);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Po()},history.replaceState=function(o,r,a){e(o,r,a),Po()},window.addEventListener("popstate",Po),setInterval(Po,1e3)},ae=()=>Gt;var $c=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,cs=null,ls=!1,ds=t=>{let e=t.match($c);e&&(cs=e[1])},ps=()=>{if(!ls){ls=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&ds(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{ds(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},c.debug("[opp-id-capture] installed")}catch(t){c.warn("[opp-id-capture] install failed",t)}}},Pt=()=>cs;var Bo="0.46.1",Ro="2026-07-03T15:59:31.920Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,p,m=()=>{l!==void 0&&window.clearTimeout(l),p!==void 0&&window.clearInterval(p)};p=window.setInterval(()=>{let b=a.querySelector(t);b&&(m(),s(b))},r),l=window.setTimeout(()=>{m(),c.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},tn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ms=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,P=`
  ...
  flex-shrink: 0;
`;var Tc=/^[A-Za-z0-9]{15,30}$/,Ne=t=>typeof t=="string"&&Tc.test(t),bs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Cc=()=>{let t=window.WS_CRM_USER_ID;return Ne(t)?t:null},Ac=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Ne(o))return o;return null},Lc=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=bs(e);if(!o)return null;let r=o.uid;if(Ne(r))return r;let a=o.claims;if(a&&Ne(a.user_id))return a.user_id}catch{}return null},Sc=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Ne(a))return a}catch{}}}catch{}return null},O=()=>Cc()||Lc()||Ac()||Sc()||null,Ic=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=bs(e);return o?o.claims??o:null}catch{return null}},se=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ic()?.type==="agency"};var vs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Mc=`${vs}/active-follow-up-get`,Pc=`${vs}/active-follow-up-set`,Kt="ws-crm-active-follow-up-button",on={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Oc=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Bc=async t=>{let e=await fetch(Mc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Rc=async(t,e)=>{let o=await fetch(Pc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Vt=(t,e)=>{let o=on[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},hs=t=>{let e=document.createElement("button");return e.type="button",e.id=Kt,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Vt(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Oc();if(!(!r||r.contactId!==t)){Vt(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Rc(r,O()),s=a&&a.state&&a.state in on?a.state:"blue";Vt(e,s),c.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Vt(e,"error"),setTimeout(()=>void Do(e,r),4e3)}}}),e},Do=async(t,e)=>{Vt(t,"loading");try{let o=await Bc(e),r=o&&o.state&&o.state in on?o.state:"gray",a=document.getElementById(Kt);if(!a||a.dataset.contactId!==e.contactId)return;Vt(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Vt(t,"error")}},Hc=[".central-panel","[class*='central-panel']"],en="ws-crm-contact-actions-bar",Dc=async()=>{for(let t of Hc)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Fc=async(t,e)=>{let o=e.querySelector(`#${en}`);if(!o)try{o=await I(`#${en}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${en}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},zc=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},Nc=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},qc=async t=>{if(t==="url"){let o=await Dc();return o?{kind:"contact-detail",target:o}:null}let e=zc();return e?{kind:"conversations",target:e}:null},us=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Fc(t,e.target);return o}return Nc(t,e.target),"conversations-header"},Uc=async()=>{let t=B();if(!t||!t.locationId){document.getElementById(Kt)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Kt);if(o&&o.dataset.contactId===e.contactId){Do(o,e);return}o&&o.remove();let r=await qc(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=B();if(!a||a.contactId!==e.contactId)return;let s=hs(e.contactId),i=await us(s,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),_s();let d=document.getElementById(Kt)??s;Do(d,e),Ho?.disconnect(),Ho=new MutationObserver(()=>{let l=document.getElementById(Kt);if(!(B()?.contactId===e.contactId)){Ho?.disconnect();return}if(!l){let m=hs(e.contactId);us(m,r).then(()=>{_s(),Do(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),Ho.observe(r.target,{childList:!0})},Ho=null,qe=null,ys=()=>{let t=B()?.contactId??null;if(qe&&qe.contactId===t)return;let e=Uc().finally(()=>{qe?.promise===e&&(qe=null)});qe={contactId:t,promise:e}},_s=()=>{let t=document.querySelectorAll(`#${Kt}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var jc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Ue=new Map,vt=async(t,e)=>{if(!t)return null;if(Ue.has(t))return Ue.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${jc}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,s=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!s.ok)return c.warn(`Contact Type fetch returned ${s.status} for ${t}`),Ue.set(t,null),null;let d=((await s.json()).contact_type||"").toLowerCase().trim()||null;return Ue.set(t,d),c.debug(`Resolved Contact Type for ${t}: ${d??"(unset)"}`),d}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),Ue.set(t,null),null}};var yt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var xs="ws-buybox-nav-icon",an="ws-buybox-panel",gs="ws-buybox-modal",Wc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",sn="https://mcclivetim.github.io/reinvest-os-cdn/geo",Fo=null,je=null,We=null,nn=async()=>{if(Fo)return Fo;try{let t=await fetch(`${sn}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Fo=await t.json(),Fo}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Gc=async t=>{if(!je)try{let e=await fetch(`${sn}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);je=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return je?.[t]??[]},Kc=async t=>{if(!We)try{let e=await fetch(`${sn}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);We=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return We?.[t]??[]},ln=async t=>await(await fetch(Wc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Vc=(t,e)=>ln({tenant_id:t,action:"list",buyer_contact_id:e}),Yc=(t,e,o,r)=>ln({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Jc=(t,e)=>ln({tenant_id:t,action:"remove",entry_id:e}),U=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Qc=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Zc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Xc='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',tp="nav.w-13, nav[class*='w-13']",ep=".flex-1.h-full.relative.overflow-hidden.rounded-lg",op=async()=>{try{return await I(tp,{timeoutMs:2500})}catch{return null}},rp=async()=>{try{return await I(ep,{timeoutMs:2500})}catch{return null}},np=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,ap=(t,e)=>{let o=document.createElement("div");return o.id=an,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{dp(t,e,()=>dn(t,e))}),o},dn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Vc(t,e),nn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${U(r.error||"Failed to load buy-box entries")}</div>`;return}sp(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${U(r.message)}</div>`}},sp=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let p=e[l.key].map(m=>{let b=l.key==="state"?Qc(m.geo_value,o):m.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${U(b)}</span>
              <button type="button" data-entry-id="${U(m.id)}" data-entry-label="${U(b)}" class="ws-buybox-remove" aria-label="Remove ${U(b)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${Xc}</button>
            </div>
          `}).join("");return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let p=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Jc(r,p).then(b=>{if(!b.ok){alert(`Failed to remove: ${b.error||"unknown error"}`),l.disabled=!1;return}dn(r,a)}).catch(b=>{alert(`Network error: ${b.message}`),l.disabled=!1}))})})},zo=!1,ws=(t,e)=>{zo=e;let o=np(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=ip,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",dn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=ks,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},ks="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",ip="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",lp=t=>{let e=document.createElement("button");return e.id=xs,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=ks,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Zc.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!zo;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ws(r,a)}),e},dp=(t,e,o)=>{let r=document.getElementById(gs);r&&r.remove();let a=document.createElement("div");a.id=gs,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",k=>{k.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),p();else if(i.step===2){s.innerHTML=m();let k=await nn();s.innerHTML=b(k),_(k)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=w(),$();else if(i.granularity==="state"){let k=await nn();s.innerHTML=x(k),f(k)}else i.granularity==="county"?(s.innerHTML=u(i.stateCode||""),await Gc(i.stateCode||""),s.innerHTML=g("County"),y()):i.granularity==="city"&&(s.innerHTML=u(i.stateCode||""),await Kc(i.stateCode||""),s.innerHTML=g("City"),y())},l=()=>`
  ...
  `,p=()=>{s.querySelectorAll(".ws-buybox-tile").forEach(k=>{k.addEventListener("mouseenter",()=>{k.style.borderColor=n.emerald,k.style.background=n.emeraldGlow}),k.addEventListener("mouseleave",()=>{k.style.borderColor=n.steel,k.style.background=n.steel}),k.addEventListener("click",()=>{let E=k.dataset.granularity;i.granularity=E,i.step=E==="zip"?3:2,d()})}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove())},m=()=>`
  ...
  `,_=k=>{let E=s.querySelector("#ws-buybox-state-search"),L=s.querySelectorAll(".ws-buybox-state-row");L.forEach(M=>{M.addEventListener("mouseenter",()=>{M.style.background=n.emeraldGlow}),M.addEventListener("mouseleave",()=>{M.style.background="transparent"}),M.addEventListener("click",()=>{i.stateCode=M.dataset.stateCode||"",i.step=3,d()})}),E?.addEventListener("input",()=>{let M=(E.value||"").toLowerCase().trim();k.forEach((N,z)=>{let q=L[z];if(!q)return;let D=!M||N.name.toLowerCase().includes(M)||N.code.toLowerCase()===M;q.style.display=D?"":"none"})}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>E?.focus(),0)},u=k=>`
    ...
    <div style="color: ${n.ash}; padding: 20px 0; text-align: center;">Loading list for ${U(k)}\u2026</div>
  `,x=k=>{let E=k.find(L=>L.code===i.stateCode);return`
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; gap: 8px;">
          <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; padding: 8px 18px; cursor: pointer; font-family: ${h.sans}; font-size: 13px;">Close</button>
          <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${v.sm}; padding: 8px 22px; cursor: pointer; font-family: ${h.sans}; font-size: 13px; font-weight: 600;">Add ${E?U(E.name):"State"}</button>
        </div>
      </div>
    `},f=k=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>T(i.stateCode||""))},g=k=>{let E=i.granularity==="county"?je?.[i.stateCode||""]??[]:We?.[i.stateCode||""]??[];return`
      <div style="font-family: ${h.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${U(k)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${E.length.toLocaleString()} ${U(k).toLowerCase()}s in ${U(i.stateCode||"")}.</div>
    ...
    `},y=()=>{let k=i.granularity==="county"?je?.[i.stateCode||""]??[]:We?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),L=s.querySelector("#ws-buybox-value-list");if(!E||!L)return;let M=N=>{let z=N.toLowerCase().trim();if(!z){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let q=k.filter(D=>D.toLowerCase().includes(z)).slice(0,50);if(q.length===0){L.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${U(i.stateCode||"")}.</div>`;return}L.innerHTML=q.map(D=>`
        <div data-value="${U(D)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${U(D)}
        </div>
      `).join(""),L.querySelectorAll(".ws-buybox-value-row").forEach(D=>{D.addEventListener("mouseenter",()=>{D.style.background=n.emeraldGlow}),D.addEventListener("mouseleave",()=>{D.style.background="transparent"}),D.addEventListener("click",()=>{i.value=D.dataset.value||"",T(i.value)})})};E.addEventListener("input",()=>M(E.value)),M(""),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>E.focus(),0)},w=()=>`
  ...
  `,$=()=>{let k=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");k&&(k.addEventListener("input",()=>{k.value=k.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),k.addEventListener("keydown",L=>{L.key==="Enter"&&(L.preventDefault(),C())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>k.focus(),0))},C=async()=>{let k=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),L=(k?.value||"").trim();if(!/^\d{5}$/.test(L)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(L)},T=async k=>{if(!i.granularity||!k)return;let E=s.querySelector("#ws-buybox-err"),L=s.querySelector("#ws-buybox-save");L&&(L.disabled=!0,L.textContent="Adding\u2026"),E&&(E.textContent="");try{let M=await Yc(t,e,i.granularity,k);if(!M.ok){E&&(E.textContent=M.error||"Failed to add entry."),L&&(L.disabled=!1,L.textContent="Add");return}o(),s.innerHTML=`
        <div style="text-align: center; padding: 40px 0;">
          <div style="font-size: 32px;">\u2713</div>
          <div style="font-size: 16px; margin-top: 8px;">Added <strong>${U(k)}</strong> to the buy-box.</div>
          <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${M.deduplicated?"(Already existed; not duplicated.)":""}</div>
        </div>
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(M){E&&(E.textContent=`Network error: ${M.message}`),L&&(L.disabled=!1,L.textContent="Add")}};d()},rn=!1,ie=null,Ge=null,fs=()=>{document.getElementById(xs)?.remove(),document.getElementById(an)?.remove(),Ge&&ie&&ie.nav.removeEventListener("click",Ge,!0),Ge=null,ie=null,zo=!1},Es=()=>{cp()},cp=async()=>{if(!rn){rn=!0;try{let t=B();if(!t){fs();return}let e=document.getElementById(an);if(e&&e.dataset.buyerContactId===t.contactId&&ie)return;fs();let o=null;try{o=await vt(t.contactId,t.locationId)}catch(b){c.warn("[buy-box] Contact Type fetch failed",b);return}if(yt(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([op(),rp()]);if(!a||!s){c.warn("[buy-box] right-rail nav or panel area not found");return}let i=B();if(!i||i.contactId!==t.contactId)return;let d=ap(t.locationId,t.contactId),l=lp(()=>ie),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};ie=p;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),Ge=b=>{let _=b.target;if(!_||p.iconBtn.contains(_))return;_.closest("button.sidebar-option-button")&&zo&&ws(p,!1)},a.addEventListener("click",Ge,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{rn=!1}}};var Cs="ws-properties-nav-icon",bn="ws-properties-panel",$s="ws-properties-modal",hn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",pp=`${hn}/list-for-contact`,mp=`${hn}/create-with-opp`,bp=`${hn}/add-contact`,hp=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],nt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),up=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,As=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},No=t=>{let e=As(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},cn=t=>{let e=As(t);return e===null?"&mdash;":e.toLocaleString()},Ls={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},_p=t=>{let e=(t||"").toString().trim();return e?nt(Ls[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},vp=t=>{let e=(t||"").toString().trim();return e?Ls[e]||e:""},yp={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},gp=t=>{let e=(t||"").toString().trim();return e?yp[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Ot=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${nt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,fp=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Ot("Baths",cn(t.baths))}
    ${Ot("Sq Ft",cn(t.sqft))}
    ${Ot("Rehab",_p(t.rehab_level),vp(t.rehab_level))}
    ${Ot("ARV",No(t.arv))}
    ${Ot("IMV",No(t.imv))}
    ${Ot("MAO",No(t.mao))}
    ${Ot("Ask",No(t.asking_price))}
  </div>`,Ss=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},xp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',wp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',kp="nav.w-13, nav[class*='w-13']",Ep=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Is="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",$p="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Tp=async()=>{try{return await I(kp,{timeoutMs:2500})}catch{return null}},Cp=async()=>{try{return await I(Ep,{timeoutMs:2500})}catch{return null}},un=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),gt=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:13px;outline:none;margin-bottom:10px;`,ft=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,_n=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${h.sans};font-size:13px;font-weight:600;`,Ms=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${h.sans};font-size:13px;`,Ap=(t,e)=>{let o=document.createElement("div");return o.id=bn,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${_n}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Sp(t,e,()=>vn(t,e))}),o},vn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await un(pp,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${nt(r.error||"Failed to load properties")}</div>`;return}Lp(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${nt(r.message)}</div>`}},Lp=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${nt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,p=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${nt(p||"")}${a.property_type?" &middot; "+nt(gp(a.property_type)):""}</div>
        ${fp(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${nt(a.property_record_id)}" data-addr="${nt(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${h.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${wp} Add person</button>
        </div>
      </div>
    `}).join(""),t.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{Ip(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>vn(o,r))})}),t.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(up(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},Ps=()=>{document.getElementById($s)?.remove();let t=document.createElement("div");t.id=$s,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let e=document.createElement("div");return e.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,t.appendChild(e),document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()}),{overlay:t,card:e}},Sp=(t,e,o)=>{let{overlay:r,card:a}=Ps();a.innerHTML=`
    ...
    <select id="wp-type" style="${gt}">
      ...
      ${hp.map(i=>`<option value="${nt(i)}">${nt(i)}</option>`).join("")}
    </select>
    <div id="wp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wp-cancel" type="button" style="${Ms}">Cancel</button>
      <button id="wp-save" type="button" style="${_n}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=u=>(a.querySelector(u)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),p=i("#wp-state"),m=i("#wp-zip"),b=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let _=a.querySelector("#wp-save");_&&(_.disabled=!0,_.textContent="Creating\u2026"),s&&(s.textContent="");try{let u=await un(mp,{tenant_id:t,contact_id:e,address:d,city:l,state:p,zip:m,property_type:b||void 0});if(!u.ok){s&&(s.textContent=u.error||"Failed to create property."),_&&(_.disabled=!1,_.textContent="Create property + deal");return}r.remove(),Ss("Property + deal created \u2713"),o()}catch(u){s&&(s.textContent=`Network error: ${u.message}`),_&&(_.disabled=!1,_.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},Ip=(t,e,o,r)=>{let{overlay:a,card:s}=Ps();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${Ms}">Cancel</button>
      <button id="wpp-save" type="button" style="${_n}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=x=>(s.querySelector(x)?.value||"").trim(),p=l("#wpp-first"),m=l("#wpp-last"),b=l("#wpp-phone"),_=l("#wpp-email");if(!p&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let u=s.querySelector("#wpp-save");u&&(u.disabled=!0,u.textContent="Adding\u2026"),i&&(i.textContent="");try{let x=await un(bp,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:p,lastName:m,phone:b||void 0,email:_||void 0}});if(!x.ok){i&&(i.textContent=x.error||"Failed to add person."),u&&(u.disabled=!1,u.textContent="Add person");return}a.remove(),Ss("Person added \u2713"),r()}catch(x){i&&(i.textContent=`Network error: ${x.message}`),u&&(u.disabled=!1,u.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},qo=!1,it=null,pn=!1,Ke=null,Mp=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),p=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-p)}px`,t.style.right="auto",t.style.bottom="auto"},Pp=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},mn=(t,e)=>{qo=e,e?(t.iconBtn.className=$p,t.iconBtn.dataset.active="true",Pp(),Mp(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",vn(t.tenantId,t.contactId)):(t.iconBtn.className=Is,delete t.iconBtn.dataset.active,t.panel.style.display="none")},Op=()=>{let t=document.createElement("button");return t.id=Cs,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=Is,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${xp.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),it&&mn(it,!qo)}),t},Ts=()=>{document.getElementById(Cs)?.remove(),document.getElementById(bn)?.remove(),Ke&&it&&it.nav.removeEventListener("click",Ke,!0),Ke=null,it=null,qo=!1},Os=()=>{Bp()},Bp=async()=>{if(!pn){pn=!0;try{let t=B();if(!t||!t.locationId){Ts();return}let e=document.getElementById(bn);if(e&&e.dataset.contactId===t.contactId&&it)return;Ts();let o=null;try{o=await vt(t.contactId,t.locationId)}catch(m){c.warn("[properties] Contact Type fetch failed",m);return}if(yt(o)!=="seller")return;let[a,s]=await Promise.all([Tp(),Cp()]);if(!a||!s){c.warn("[properties] right-rail nav or panel area not found");return}let i=B();if(!i||i.contactId!==t.contactId)return;let d=Ap(t.locationId,t.contactId),l=Op();it={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{it&&mn(it,!1)}),Ke=m=>{let b=m.target;!b||it&&it.iconBtn.contains(b)||b.closest("button.sidebar-option-button")&&qo&&it&&mn(it,!1)},a.addEventListener("click",Ke,!0),c.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{pn=!1}}};var Bs="ws-non-seller-contact",Rs=()=>{Rp()},Rp=async()=>{let t=B();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(Bs);return}let e="seller";try{e=yt(await vt(t.contactId,t.locationId))}catch(o){c.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(Bs,e!=="seller")};var Bt="ws-crm-claim-release-pill",Hp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Dp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Fp=async t=>{let e=await fetch(Hp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},zp=async t=>{let e=await fetch(Dp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Fs=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},de=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=ms(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Np=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=Bt,o.type="button",o.dataset.contactId=t,de(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=B();if(!a||!a.locationId||a.contactId!==t)return;let s=O();if(!s){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>de(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";de(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await zp({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;de(o,l),c.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){c.error("Claim/Release Set webhook failed",d),de(o,r);let l=o.querySelector(".ws-cr-label");if(l){let p=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Hs=async t=>{try{let e=await Fp({contactId:t.contactId,locationId:t.locationId,userId:O()}),o=document.getElementById(Bt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";de(o,r)}catch(e){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},qp=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Fs(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Ds=(t,e)=>{let o=Np({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${Bt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},le=null,Up=async()=>{let t=B();if(!t){le?.disconnect(),le=null,document.getElementById(Bt)?.remove();return}let e=document.getElementById(Bt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await I("#record-details-lhs",{timeoutMs:1e4}),r=await qp(o),a=B();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ds(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(Bt)&&t.locationId&&Hs({contactId:t.contactId,locationId:t.locationId}),le?.disconnect(),le=new MutationObserver(async()=>{if(!(B()?.contactId===t.contactId)){le?.disconnect();return}if(document.getElementById(Bt))return;let d=Fs(o);d&&(Ds(d,t.contactId),document.getElementById(Bt)&&t.locationId&&Hs({contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe"))}),le.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},zs=()=>{Up()};var Ks="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",jp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",Wp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Gp=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||Ks,l;if(i==="buyer"){let m=Js.find(_=>_.label===o),b=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:b,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let p=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Kp=async({contactId:t,tenantId:e})=>{let o=await fetch(Wp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},ce="ws-crm-contact-actions-bar",Vs="ws-crm-call-status-dropdown",Ys="ws-crm-call-status-menu",jo="ws-crm-offer-made-modal",Ns=!1,Vp=()=>{Ns||(Ns=!0,document.addEventListener("click",t=>{let e=document.getElementById(Ys);if(!e||e.style.display==="none")return;let o=document.getElementById(Vs);o&&!o.contains(t.target)&&(e.style.display="none")}))},Yp=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Js=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Jp=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Qp=async()=>{for(let t of Jp)try{let e=await I(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await I("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Zp=({contactId:t,kind:e})=>{let o=e==="buyer"?Js:Yp,r=e==="buyer"?jp:Ks,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Vs,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=P,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=Ys,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${tn[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,b=i.children[1],_=i.children[2];m&&(m.style.background=tn[l.color]),b&&(b.textContent=l.label),d.style.display="none";let x=B()?.locationId,f=O();if(!x){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),b&&(b.textContent=`${l.label} (no tenant!)`),b&&(b.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!f){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),b&&(b.textContent=`${l.label} (no user!)`),b&&(b.style.color=n.amber);return}let g=_?.textContent??"\u25BE",y=async w=>{_&&(_.textContent="\u2026"),i.style.opacity="0.75";try{await Gp({contactId:t,locationId:x,status:l.label,userId:f,deadReason:w,webhookUrl:r,kind:e}),_&&(_.textContent="\u2713"),setTimeout(()=>{_&&(_.textContent=g),i.style.opacity="1"},900)}catch($){c.warn("Call Status webhook failed:",$),_&&(_.textContent="\u2717"),b&&(b.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{_&&(_.textContent=g),b&&(b.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let w=b?.textContent??"";nm($=>{y($)},()=>{b&&(b.textContent=w)});return}if(e==="seller"&&l.value==="appointment-booked"){let w=b?.textContent??"";try{(await Kp({contactId:t,tenantId:x})).ok?await y():am(()=>{y()},()=>{b&&(b.textContent=w)})}catch($){c.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(p)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Vp(),s.appendChild(i),s.appendChild(d),s},Xp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",tm=async t=>{let e=await fetch(Xp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},em="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",gn=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),om=async(t,e)=>{let o=await fetch(em,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},rm=t=>new Promise(e=>{document.getElementById(jo)?.remove();let o=document.createElement("div");o.id=jo,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${h.sans};">
        <div style="font-size:14px;font-weight:500;">${gn(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${gn(i.dealStage)}</div>`:""}
  ...
  `;let l=document.createElement("div");l.style.cssText=`
    ...
    color: ${n.bone};
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
  `;let p=new Date,m=new Date(p.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),b=r?`
    <label style="
      display: block;
      font-family: ${h.mono};
      font-size: 10px;
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",_=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${gn(o.address)}</strong></div>`:"",u=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",x=r&&o&&o.propertyRecordId?`
    ...
    <div style="display:flex;align-items:center;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:0 12px;margin-bottom:16px;">
      ...
      <input id="ws-offer-asking" type="number" min="0" step="100" placeholder="0" value="${u}" style="flex:1;background:transparent;border:none;outline:none;color:${n.bone};font-family:${h.mono};font-size:14px;padding:10px 8px;" />
    </div>`:"";l.innerHTML=`
    <div style="
      font-family: ${h.mono};
      font-size: 10px;
  ...
  `,d.appendChild(l),document.body.appendChild(d);let f=()=>d.remove();d.addEventListener("click",$=>{$.target===d&&f()});let g=l.querySelector("#ws-offer-error"),y=l.querySelector("#ws-offer-cancel"),w=l.querySelector("#ws-offer-submit");y?.addEventListener("click",f),w?.addEventListener("click",async()=>{let $=(l.querySelector("#ws-offer-amount")?.value??"").trim(),C=r?l.querySelector("#ws-offer-expires")?.value??"":"";if(!$||Number($)<=0){g&&(g.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let T=Number($);if(T<100){g&&(g.textContent=`That looks low \u2014 did you mean $${(T*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),L=E?E[1]:null;if(!L){g&&(g.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}g&&(g.textContent=""),w&&(w.disabled=!0,w.textContent="Recording\u2026",w.style.opacity="0.7"),y&&(y.disabled=!0);try{let M=(l.querySelector("#ws-offer-asking")?.value??"").trim(),N=M?Number(M):null,z=await tm({tenantId:L,contactId:t,kind:e,amount:T,expiresAt:C||null,userId:O(),oppId:o?.oppId??null,propertyRecordId:o?.propertyRecordId??null,askingPrice:N&&N>0?N:null});if(!z.ok){g&&(g.textContent=z.error??"Something went wrong."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),y&&(y.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${T} on ${z.opp_pipeline} opp (stage: ${z.opp_stage_name??"?"})`),f()}catch(M){c.error("Offer Made webhook failed",M),g&&(g.textContent=M instanceof Error?M.message:"Network error \u2014 try again."),w&&(w.disabled=!1,w.textContent="Record Offer",w.style.opacity="1"),y&&(y.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},qs="ws-crm-dead-deal-modal",nm=(t,e)=>{document.getElementById(qs)?.remove();let o=document.createElement("div");o.id=qs,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},js=(t,e)=>{let o=document.createElement("div");if(o.id=ce,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=P,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){Ve(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){Ve(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await om(s,t)}catch(m){c.warn("[offer-made] deal lookup failed, using legacy path",m),d(),Ve(t,e);return}if(d(),l.length<=1){Ve(t,e,l[0]);return}let p=await rm(l);p&&Ve(t,e,p)}),o.appendChild(r),o.appendChild(Zp({contactId:t,kind:e}))}return o},yn=!1,Ws=()=>{document.querySelectorAll(`[id="${ce}"]`).forEach(t=>t.remove())},Qs=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),yn){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}yn=!0;try{await sm()}finally{yn=!1}},sm=async()=>{let t=B();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Ws();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Ws();return}let e="seller";try{let l=await vt(t.contactId,t.locationId),p=yt(l);p==="buyer"?e="buyer":p==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=B();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${ce}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Qp();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=B();if(!s||s.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=js(t.contactId,e)}catch(l){c.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){c.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(ce)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),Uo?.disconnect(),Uo=new MutationObserver(()=>{if(!(B()?.contactId===t.contactId)){Uo?.disconnect();return}let p=document.querySelectorAll(`[id="${ce}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,b=js(t.contactId,e);b.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(b,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),Uo.observe(a,{childList:!0})},Uo=null,Gs=null,im=()=>{Gs===null&&(Gs=window.setInterval(()=>{let t=B();t&&(document.getElementById(ce)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Qs()))},3e3))},Zs=()=>{im(),Qs()};var Wo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",lm=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ye="data-ws-crm-favicon",fn=t=>t.hasAttribute(Ye),Xs=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return lm.has(e)},Go=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Xs(r)&&!fn(r)&&r.remove()});let e=document.head.querySelector(`link[${Ye}="1"]`);e?e.href!==Wo&&(e.href=Wo):(e=document.createElement("link"),e.setAttribute(Ye,"1"),e.rel="icon",e.type="image/png",e.href=Wo,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ye}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ye,"apple"),o.rel="apple-touch-icon",o.href=Wo,document.head.appendChild(o))},ti=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Go();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Go())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Xs(i)&&!fn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&fn(i)&&(a=!0)});a&&Go()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Go(),e>=5&&window.clearInterval(o)},1e3)};var K=".crm-opportunities-modal .ui-modal-heading .description",ei=new Map,xn=null,wn,dm=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of ei){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){c.error(`[arrival-watcher] callback "${e}" threw`,s)}}},j=(t,e,o)=>{ei.set(t,{selector:e,cb:o}),!xn&&(xn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0,dm()},300))}),xn.observe(document.body,{childList:!0,subtree:!0}))};var cm=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],pm=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,mm=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(mm);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(pm);if(a){let s=a[1];if(cm.includes(s))return s}}return null},V=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var oi="ws-crm-dispo-action-row",W=t=>{let e=document.getElementById(oi);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=oi,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var bm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ct="ws-crm-mt-offer-made-button",ri="ws-crm-mt-offer-made-modal",hm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,um=/\/v2\/location\/([A-Za-z0-9]+)/,Yo=()=>{let t=window.location.pathname,e=t.match(hm),o=e?e[1]:Pt();if(!o)return null;let r=t.match(um);return{oppId:o,locationId:r?r[1]:null}},_m=async t=>{let e=await fetch(bm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ko=()=>{document.getElementById(ri)?.remove()},vm=t=>{Ko();let e=document.createElement("div");e.id=ri,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),s=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&Ko()}),s?.addEventListener("click",()=>Ko()),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l||Number(l)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let p=Number(l);if(p<100){a.textContent=`That looks low \u2014 did you mean $${(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{let m=await _m({oppId:t.oppId,locationId:t.locationId,amount:p,userId:O()});if(!m.ok){a.textContent=m.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1);return}Ko(),t.onSuccess()}catch(m){c.error("MT Offer Made webhook failed",m),a.textContent=m instanceof Error?m.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1)}})},ym=t=>{let e=document.createElement("button");return e.id=ct,e.type="button",e.dataset.oppId=t,e.style.cssText=P,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Yo();!o||!o.locationId||o.oppId!==t||vm({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=P)},4e3)}})}),e},gm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],fm=async()=>{for(let t of gm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Vo=!1,En=async()=>{if(!Vo){Vo=!0;try{await xm()}finally{Vo=!1}}},xm=async()=>{let t=Yo();if(!t||!t.locationId){document.getElementById(ct)?.remove(),document.getElementById(`${ct}-wrap`)?.remove(),Qe();return}let e=document.getElementById(ct);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ct}-wrap`)?.remove(),Qe());return}e&&(e.remove(),document.getElementById(`${ct}-wrap`)?.remove());let o=await fm();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Yo();if(!a||a.oppId!==t.oppId)return;let s=ym(t.oppId),i=document.createElement("span");i.id=`${ct}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),wm(t.oppId)},Je=null,kn=null,pe,Qe=()=>{Je?.disconnect(),Je=null,kn=null,pe!==void 0&&(window.clearTimeout(pe),pe=void 0)},wm=t=>{if(Je&&kn===t)return;Qe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kn=t,Je=new MutationObserver(()=>{pe===void 0&&(pe=window.setTimeout(()=>{pe=void 0;let o=Yo();if(!o||o.oppId!==t){Qe();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ct)?.remove(),document.getElementById(`${ct}-wrap`)?.remove(),Qe();return}document.getElementById(ct)||En()},250))}),Je.observe(e,{childList:!0,subtree:!0}))},km=()=>{j("mt-offer-made",K,()=>{!document.getElementById(ct)&&!Vo&&En()})},ni=()=>{km(),En()};var Em="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",pt="ws-crm-not-interested-button",$m=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tm=/\/v2\/location\/([A-Za-z0-9]+)/,Qo=()=>{let t=window.location.pathname,e=t.match($m),o=e?e[1]:Pt();if(!o)return null;let r=t.match(Tm);return{oppId:o,locationId:r?r[1]:null}},Cm=async t=>{let e=await fetch(Em,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Am=t=>{let e=document.createElement("button");return e.id=pt,e.type="button",e.dataset.oppId=t,e.style.cssText=P,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Qo();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await Cm({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){c.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Lm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sm=async()=>{for(let t of Lm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Jo=!1,Tn=async()=>{if(!Jo){Jo=!0;try{await Im()}finally{Jo=!1}}},Im=async()=>{let t=Qo();if(!t||!t.locationId){document.getElementById(pt)?.remove(),document.getElementById(`${pt}-wrap`)?.remove(),Xe();return}let e=document.getElementById(pt);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${pt}-wrap`)?.remove(),Xe());return}e&&(e.remove(),document.getElementById(`${pt}-wrap`)?.remove());let o=await Sm();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Qo();if(!a||a.oppId!==t.oppId)return;let s=Am(t.oppId),i=document.createElement("span");i.id=`${pt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Mm(t.oppId)},Ze=null,$n=null,Xe=()=>{Ze?.disconnect(),Ze=null,$n=null},Mm=t=>{if(Ze&&$n===t)return;Xe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($n=t,Ze=new MutationObserver(()=>{let o=Qo();if(!o||o.oppId!==t){Xe();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(pt)?.remove(),document.getElementById(`${pt}-wrap`)?.remove(),Xe();return}document.getElementById(pt)||Tn()}),Ze.observe(e,{childList:!0,subtree:!0}))},Pm=()=>{j("not-interested",K,()=>{!document.getElementById(pt)&&!Jo&&Tn()})},ai=()=>{Pm(),Tn()};var Om="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",lt="ws-crm-schedule-walkthrough-button",Cn="ws-crm-schedule-walkthrough-modal",Bm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rm=/\/v2\/location\/([A-Za-z0-9]+)/,tr=()=>{let t=window.location.pathname,e=t.match(Bm),o=e?e[1]:Pt();if(!o)return null;let r=t.match(Rm);return{oppId:o,locationId:r?r[1]:null}},Zo=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Hm=(t,e)=>{document.getElementById(Cn)?.remove();let o=document.createElement("div");o.id=Cn,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let i=()=>o.remove();o.addEventListener("click",l=>{l.target===o&&i()}),document.getElementById("wsw-cancel")?.addEventListener("click",i);let d=document.getElementById("wsw-submit");d?.addEventListener("click",async()=>{let l=document.getElementById("wsw-dt")?.value||"",p=document.getElementById("wsw-dur")?.value||"30";if(!l){Zo("Pick a date and time.","err");return}let m=new Date(l).toISOString();d.disabled=!0,d.textContent="Scheduling\u2026";try{if((await fetch(Om,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:m,duration_min:Number(p)}),credentials:"omit"})).ok){i(),Zo("Walkthrough scheduled \u2713");let _=document.querySelector(`#${lt} .ws-sw-label`);_&&(_.textContent="Walkthrough Scheduled")}else d.disabled=!1,d.textContent="Schedule",Zo("Scheduling failed \u2014 try again.","err")}catch(b){c.warn("[schedule-walkthrough] failed:",b),d.disabled=!1,d.textContent="Schedule",Zo("Couldn't reach the scheduler. Try again.","err")}})},Dm=t=>{let e=document.createElement("button");return e.id=lt,e.type="button",e.dataset.oppId=t,e.style.cssText=P,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=tr();!o||!o.locationId||o.oppId!==t||Hm(o.oppId,o.locationId)}),e},Fm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],zm=async()=>{for(let t of Fm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Xo=!1,Ln=async()=>{if(!Xo){Xo=!0;try{await Nm()}finally{Xo=!1}}},Nm=async()=>{let t=tr();if(!t||!t.locationId){document.getElementById(lt)?.remove(),document.getElementById(`${lt}-wrap`)?.remove(),eo();return}let e=document.getElementById(lt);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${lt}-wrap`)?.remove(),eo());return}e&&(e.remove(),document.getElementById(`${lt}-wrap`)?.remove());let o=await zm();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=tr();if(!a||a.oppId!==t.oppId)return;let s=Dm(t.oppId),i=document.createElement("span");i.id=`${lt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),qm(t.oppId)},to=null,An=null,me,eo=()=>{to?.disconnect(),to=null,An=null,me!==void 0&&(window.clearTimeout(me),me=void 0)},qm=t=>{if(to&&An===t)return;eo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(An=t,to=new MutationObserver(()=>{me===void 0&&(me=window.setTimeout(()=>{me=void 0;let o=tr();if(!o||o.oppId!==t){eo();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(lt)?.remove(),document.getElementById(`${lt}-wrap`)?.remove(),eo();return}document.getElementById(lt)||Ln()},250))}),to.observe(e,{childList:!0,subtree:!0}))},Um=()=>{j("schedule-walkthrough",K,()=>{!document.getElementById(lt)&&!Xo&&Ln()})},si=()=>{Um(),Ln()};var jm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",be="ws-crm-resend-deal-link-wrap",Wm=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gm=/\/v2\/location\/([A-Za-z0-9]+)/,or=()=>{let t=window.location.pathname,e=t.match(Wm),o=e?e[1]:Pt();if(!o)return null;let r=t.match(Gm);return{oppId:o,locationId:r?r[1]:null}},Km=async t=>{let e=await fetch(jm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Vm=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),ii=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,In=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=P,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${ii(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Ym(t,e)),t.appendChild(o)},Ym=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let p=document.createElement("button");return p.type="button",p.textContent=d,p.style.cssText=a,p.addEventListener("click",()=>void Jm(t,e,l,o)),p};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>In(t,e)),o.appendChild(i),t.appendChild(o)},Jm=async(t,e,o,r)=>{let a=or();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Km({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(s?.ok)r.innerHTML=`${ii(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";c.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Vm(i)}</span>`}window.setTimeout(()=>In(t,e),3500)}},Qm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Zm=async()=>{for(let t of Qm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},er=!1,Mn=async()=>{if(!er){er=!0;try{await Xm()}finally{er=!1}}},Xm=async()=>{let t=or();if(!t||!t.locationId){document.getElementById(be)?.remove(),ro();return}let e=document.getElementById(be);if(e&&e.dataset.oppId===t.oppId){let i=H();i!==null&&i!=="Marketing Tracker"&&(e.remove(),ro());return}e&&e.remove();let o=await Zm();if(!o)return;let r=await V();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=or();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=be,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",W(o).appendChild(s),In(s,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),tb(t.oppId)},oo=null,Sn=null,ro=()=>{oo?.disconnect(),oo=null,Sn=null},tb=t=>{if(oo&&Sn===t)return;ro();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Sn=t,oo=new MutationObserver(()=>{let o=or();if(!o||o.oppId!==t){ro();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(be)?.remove(),ro();return}document.getElementById(be)||Mn()}),oo.observe(e,{childList:!0,subtree:!0}))},eb=()=>{j("resend-deal-link",K,()=>{!document.getElementById(be)&&!er&&Mn()})},li=()=>{eb(),Mn()};var ob="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",mt="ws-crm-reduce-price-button",di="ws-crm-reduce-price-modal",rb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,nb=/\/v2\/location\/([A-Za-z0-9]+)/,ar=()=>{let t=window.location.pathname,e=t.match(rb);if(!e)return null;let o=t.match(nb);return{oppId:e[1],locationId:o?o[1]:null}},ab=async t=>{let e=await fetch(ob,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},rr=()=>{document.getElementById(di)?.remove()},sb=t=>{rr();let e=document.createElement("div");e.id=di,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),s=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let p=r.value.replace(/[^0-9.]/g,"").split(".");r.value=p[0]+(p.length>1?"."+p.slice(1).join(""):"")});let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&rr()}),s?.addEventListener("click",()=>{rr()}),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l){a.textContent="Enter a new listing price.",r.focus();return}let p=parseFloat(l);if(!Number.isFinite(p)||p<=0){a.textContent="Price must be a positive number.",r.focus();return}if(p<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{await ab({oppId:t.oppId,locationId:t.locationId,newPrice:p,userId:O()}),rr(),t.onSuccess()}catch(m){c.error("Reduce Price webhook failed",m),a.textContent=m instanceof Error?m.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",s&&(s.disabled=!1)}})},ib=(t,e)=>{let o=document.createElement("button");return o.id=mt,o.type="button",o.dataset.oppId=t,o.style.cssText=P,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=ar();!r||!r.locationId||r.oppId!==t||sb({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=P,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},lb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],db=async()=>{for(let t of lb)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},nr=!1,On=async()=>{if(!nr){nr=!0;try{await cb()}finally{nr=!1}}},cb=async()=>{let t=ar();if(!t||!t.locationId){document.getElementById(mt)?.remove(),document.getElementById(`${mt}-wrap`)?.remove(),ao();return}let e=document.getElementById(mt);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${mt}-wrap`)?.remove(),ao());return}e&&(e.remove(),document.getElementById(`${mt}-wrap`)?.remove());let o=await db();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=ar();if(!a||a.oppId!==t.oppId)return;let s=ib(t.oppId,t.locationId),i=document.createElement("span");i.id=`${mt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),pb(t.oppId)},no=null,Pn=null,he,ao=()=>{no?.disconnect(),no=null,Pn=null,he!==void 0&&(window.clearTimeout(he),he=void 0)},pb=t=>{if(no&&Pn===t)return;ao();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pn=t,no=new MutationObserver(()=>{he===void 0&&(he=window.setTimeout(()=>{he=void 0;let o=ar();if(!o||o.oppId!==t){ao();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(mt)?.remove(),document.getElementById(`${mt}-wrap`)?.remove(),ao();return}document.getElementById(mt)||On()},250))}),no.observe(e,{childList:!0,subtree:!0}))},mb=()=>{j("reduce-price",K,()=>{!document.getElementById(mt)&&!nr&&On()})},ci=()=>{mb(),On()};var ue="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",sr="deals.reinvestos.com";var bt="ws-crm-edit-landing-button",bb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hb=/\/v2\/location\/([A-Za-z0-9]+)/,lr=()=>{let t=window.location.pathname,e=t.match(bb);if(!e)return null;let o=t.match(hb);return{oppId:e[1],locationId:o?o[1]:null}},ub=(t,e)=>{let o=new URL(`https://${sr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",ue);let r=O();return r&&o.searchParams.set("user",r),o.toString()},_b=(t,e)=>{let o=document.createElement("button");return o.id=bt,o.type="button",o.dataset.oppId=t,o.style.cssText=P,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=lr();if(!r||!r.locationId||r.oppId!==t)return;if(!ue){c.warn("[edit-landing] editor session key not configured in this build");return}let a=ub(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},vb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yb=async()=>{for(let t of vb)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ir=!1,Rn=async()=>{if(!ir){ir=!0;try{await gb()}finally{ir=!1}}},gb=async()=>{let t=lr();if(!t||!t.locationId){document.getElementById(bt)?.remove(),document.getElementById(`${bt}-wrap`)?.remove(),io();return}let e=document.getElementById(bt);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${bt}-wrap`)?.remove(),io());return}e&&(e.remove(),document.getElementById(`${bt}-wrap`)?.remove());let o=await yb();if(!o)return;let r=await V();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=lr();if(!a||a.oppId!==t.oppId)return;let s=_b(t.oppId,t.locationId),i=document.createElement("span");i.id=`${bt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),fb(t.oppId)},so=null,Bn=null,_e,io=()=>{so?.disconnect(),so=null,Bn=null,_e!==void 0&&(window.clearTimeout(_e),_e=void 0)},fb=t=>{if(so&&Bn===t)return;io();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Bn=t,so=new MutationObserver(()=>{_e===void 0&&(_e=window.setTimeout(()=>{_e=void 0;let o=lr();if(!o||o.oppId!==t){io();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(bt)?.remove(),document.getElementById(`${bt}-wrap`)?.remove(),io();return}document.getElementById(bt)||Rn()},250))}),so.observe(e,{childList:!0,subtree:!0}))},xb=()=>{j("edit-landing-page",K,()=>{!document.getElementById(bt)&&!ir&&Rn()})},pi=()=>{xb(),Rn()};var bi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",ye="ws-crm-publish-button",lo="ws-crm-publish-wrap",cr="ws-crm-publish-dropdown",wb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kb=/\/v2\/location\/([A-Za-z0-9]+)/,Hn=()=>{let t=window.location.pathname,e=t.match(wb);if(!e)return null;let o=t.match(kb);return{oppId:e[1],locationId:o?o[1]:null}},Eb=async(t,e)=>{try{let o=await fetch(bi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},$b=async(t,e)=>{let o=await fetch(bi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Tb=(t,e)=>{if(!ue){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${sr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",ue);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Tt=()=>{document.getElementById(cr)?.remove()},mi=(t,e,o,r,a)=>{Tt();let s=document.createElement("div");s.id=cr;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `,s.appendChild(m),t.forEach(f=>{let g=document.createElement("div");g.style.cssText=`
      display: flex; align-items: center; gap: 10px;
      padding: 6px 4px; font-size: 12px;
      color: ${f.filled?n.bone:n.ash};
    `;let y=f.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;g.innerHTML=`${y}<span style="flex: 1;">${f.label}</span>`,s.appendChild(g)});let b=document.createElement("div");b.style.cssText=`
    display: flex; align-items: center; gap: 10px;
  ...
  `;let _=document.createElement("button");_.type="button",_.textContent="Open editor to finish \u2192",_.style.cssText=`
    ...
    color: ${n.emerald};
  `,_.addEventListener("click",f=>{f.stopPropagation(),Tb(o,r)}),b.appendChild(_);let u=document.createElement("button");u.type="button",u.textContent="Re-check",u.title="Re-check after editing the page",u.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,u.addEventListener("click",f=>{f.stopPropagation(),Tt(),a()}),b.appendChild(u),s.appendChild(b),document.body.appendChild(s);let x=f=>{let g=f.target;!s.contains(g)&&!e.contains(g)&&(Tt(),document.removeEventListener("click",x))};window.setTimeout(()=>document.addEventListener("click",x),0)},Yt=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),s="transparent",i=n.steel,d=n.bone,l=n.coolGray,p="Publish Deal",m="",b="pointer",_="1";switch(e.status){case"checking":i=n.steel,d=n.ash,p="Checking\u2026",b="wait",_="0.8";break;case"ready":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,p="Publish Deal";break;case"incomplete":{let u=e.checks?.filter(f=>f.filled).length??0,x=e.checks?.length??0;i=n.amber,d=n.amber,l=n.amber,p=`${u} of ${x} ready`,m="\u25BE";break}case"publishing":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,p="Publishing\u2026",b="wait",_="0.8";break;case"published":s="transparent",i=n.steel,d=n.ash,l=n.emerald,p="Deal Published",b="default",_="0.9";break;case"error":i=n.amber,d=n.amber,l=n.amber,p=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=b,t.style.opacity=_,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${l}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},Cb=(t,e)=>{let o=document.createElement("button");o.id=ye,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${Z}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};Yt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let b=await Eb(t,e);if(!b||!Array.isArray(b.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Yt(o,r);return}r={status:b.published?"published":b.ready?"ready":"incomplete",checks:b.checks},Yt(o,r),document.getElementById(cr)&&r.checks&&mi(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Yt(o,r),Tt();try{let b=await $b(t,e);if(b.ok&&b.published)r={status:"published"},Yt(o,r),c.info(`[publish] published opp ${t}`);else if(b.missing&&b.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Yt(o,r);else throw new Error(b.error||"Publish failed")}catch(b){let _=b instanceof Error?b.message:"Publish failed";c.error("[publish] publish failed",b),r={status:"error",message:_.length>28?"Error \u2014 try again":_},Yt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(cr)?Tt():r.checks&&mi(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d,l=Date.now(),p=8e3,m=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(m){let b=new MutationObserver(()=>{if(d!==void 0||a||r.status==="publishing"||r.status==="published")return;let u=Math.max(1500,p-(Date.now()-l));d=window.setTimeout(()=>{d=void 0,l=Date.now(),s()},u)});b.observe(m,{childList:!0,subtree:!0});let _=window.setInterval(()=>{document.body.contains(o)||(b.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return o},Ab=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Lb=async()=>{for(let t of Ab)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},dr=!1,Fn=async()=>{if(!dr){dr=!0;try{await Sb()}finally{dr=!1}}},Sb=async()=>{let t=Hn();if(!t||!t.locationId){document.getElementById(ye)?.remove(),document.getElementById(lo)?.remove(),Tt(),po();return}let e=document.getElementById(ye);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(lo)?.remove(),Tt(),po());return}e&&(e.remove(),document.getElementById(lo)?.remove(),Tt());let o=await Lb();if(!o)return;let r=await V();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Hn();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=Cb(t.oppId,a.locationId),i=document.createElement("span");i.id=lo,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),W(o).appendChild(i),c.debug(`Mounted Publish button on opp ${t.oppId}`),Ib(t.oppId)},co=null,Dn=null,ve,po=()=>{co?.disconnect(),co=null,Dn=null,ve!==void 0&&(window.clearTimeout(ve),ve=void 0)},Ib=t=>{if(co&&Dn===t)return;po();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dn=t,co=new MutationObserver(()=>{ve===void 0&&(ve=window.setTimeout(()=>{ve=void 0;let o=Hn();if(!o||o.oppId!==t){po();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(ye)?.remove(),document.getElementById(lo)?.remove(),Tt(),po();return}document.getElementById(ye)||Fn()},250))}),co.observe(e,{childList:!0,subtree:!0}))},Mb=()=>{j("publish-button",K,()=>{!document.getElementById(ye)&&!dr&&Fn()})},hi=()=>{Mb(),Fn()};var ui="data:image/png;base64,",_i="data:image/png;base64,";var Pb=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],vi=t=>`ws-crm-map-links-${t}`,yi=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),pr=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},gi=(t,e=yi())=>{let o=pr(e,t.addr),r=pr(e,t.city),a=pr(e,t.state),s=pr(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Ob=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Bb=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Rb=(t,e)=>{let{full:o,hasAny:r}=gi(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Hb=t=>{let e=document.createElement("span");e.id=vi(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),Rb(t,i)}),d};return e.appendChild(r(ui,"Open in Google Maps",Ob)),e.appendChild(r(_i,"Search on Zillow",Bb)),e},Db=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},fi=()=>{let t=yi();if(t.length)for(let e of Pb){if(document.getElementById(vi(e.key)))continue;let{hasAny:o}=gi(e,t);if(!o)continue;let r=Db(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Hb(e)),c.debug(`[map-links] injected on "${e.addr}"`))}},ge=null,fe,Fb=()=>{let t=ae();return t==="contact-detail"||t==="other"},zb=()=>{ge||(ge=new MutationObserver(()=>{fe===void 0&&(fe=window.setTimeout(()=>{fe=void 0;try{fi()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),ge.observe(document.body,{childList:!0,subtree:!0}))},xi=()=>{ge&&(ge.disconnect(),ge=null),fe!==void 0&&(window.clearTimeout(fe),fe=void 0)},wi=()=>{if(!Fb()){xi();return}zb(),fi()},ki=()=>{xi()};var Ei="ws-crm-hide-launchpad",zn=/\/launchpad\/?$/,Nn=()=>{if(!se()){if(!document.getElementById(Ei)){let t=document.createElement("style");t.id=Ei,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(zn.test(location.pathname)){let t=location.pathname.replace(zn,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!zn.test(location.pathname)&&(c.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){c.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Nb=[{label:"Buy-Box Entries"},{label:"Memberships"}],$i=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},qn=()=>{let t=se(),e=new Set(Nb.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){$i(e);for(let o of[150,500,1200,2500])setTimeout(()=>$i(e),o)}};var qb=[{from:"Payments",to:"Contracts"}],Ub=".nav-title, .topmenu-navtitle",Ti=()=>{document.querySelectorAll(Ub).forEach(t=>{let e=(t.textContent||"").trim(),o=qb.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Un=()=>{Ti();for(let t of[150,500,1200,2500])setTimeout(Ti,t)};var Ci="/payments/proposals-estimates",jb=/\/payments\/invoices\/?$/,Wb=/\/payments\//,Gb='#sb_payments, a[meta="payments"]',Li=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ci)&&!(t>3&&!Wb.test(e))){if(jb.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ci));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Li(t+1),120)}},Ai=!1,Kb=()=>{Ai||(Ai=!0,document.addEventListener("click",t=>{t.target?.closest?.(Gb)&&setTimeout(()=>Li(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},jn=()=>{Kb()};var Si=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Ii="ws-crm-hide-topmenu-tabs",Wn=()=>{if(document.getElementById(Ii))return;let t=Si.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Ii,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${Si.length} top tabs`)};var Oi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Rt="ws-crm-send-to-closing-office-button",Jt="ws-crm-send-to-title-co-wrap",hr="ws-crm-stc-dropdown",Vb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yb=/\/v2\/location\/([A-Za-z0-9]+)/,ur=()=>{let t=window.location.pathname,e=t.match(Vb);if(!e)return null;let o=t.match(Yb);return{oppId:e[1],locationId:o?o[1]:null}},Jb=5*60*1e3,Vn=t=>`ws-crm-stc-cache:${t}`,Qb=t=>{try{let e=window.localStorage.getItem(Vn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Jb||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Zb=(t,e)=>{try{window.localStorage.setItem(Vn(t),JSON.stringify(e))}catch{}},Bi=t=>{try{window.localStorage.removeItem(Vn(t))}catch{}},Gn="ws-crm:opp-fields-updated",Ri=t=>{if(t){Bi(t);try{window.dispatchEvent(new CustomEvent(Gn,{detail:{oppId:t}}))}catch{}}},Xb=async(t,e)=>{try{let o=await fetch(Oi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},th=async(t,e,o)=>{let r=await fetch(Oi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},eh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},Mi=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},oh=(t,e)=>{if(e&&eh(e)){window.setTimeout(()=>Mi(t),300);return}Mi(t)},ht=()=>{document.getElementById(hr)?.remove()},mr=(t,e,o)=>{ht();let r=document.createElement("div");r.id=hr;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(l);let p=["TC","ACQ","MT","DISPO","Property"],m={};t.forEach(u=>{m[u.group]||(m[u.group]=[]),m[u.group].push(u)});let b=[...p.filter(u=>m[u]),...Object.keys(m).filter(u=>!p.includes(u))];for(let u of b){let x=m[u],f=document.createElement("div");f.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${h.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,g.textContent=u,f.appendChild(g),x.forEach(y=>{let w=document.createElement("div"),$=!y.filled&&y.navigable&&y.field_id;w.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${$?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,$&&(w.addEventListener("mouseenter",()=>{w.style.background=n.slate}),w.addEventListener("mouseleave",()=>{w.style.background="transparent"}),w.addEventListener("click",k=>{k.stopPropagation(),y.field_id&&(oh(y.field_id,y.folder),ht())}));let C=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=$?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";w.innerHTML=`${C}<span style="flex: 1;">${y.label}</span>${T}`,f.appendChild(w)}),r.appendChild(f)}document.body.appendChild(r);let _=u=>{let x=u.target;!r.contains(x)&&!o.contains(x)&&(ht(),document.removeEventListener("click",_))};window.setTimeout(()=>document.addEventListener("click",_),0)},xt=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,p="Send to Closing Office",m="",b="pointer",_="1";switch(e.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,p="Checking\u2026",b="wait",_="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(f=>f.filled).length??0,x=e.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,p=`${u} of ${x} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p="Sending\u2026",b="wait",_="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",p="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,p=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=b,t.style.opacity=_,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=p),a&&(a.textContent=m)},rh=(t,e)=>{let o=document.createElement("button");o.id=Rt,o.type="button",o.dataset.oppId=t;let r=Qb(t),a=r?{status:r.checks.every(g=>g.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${P}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,xt(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let g=await Xb(t,e);if(!g){a={status:"error",message:"Check failed \u2014 click to retry"},xt(o,a);return}if(g.rate_limited){u=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},xt(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(g.checks)||g.checks.length===0){a={status:"error",message:g.error||"Check failed \u2014 click to retry"},xt(o,a),c.warn("[stc] dry_run returned no checks:",g);return}let y=g.pipeline_name;if(y&&y!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),_r.add(t),document.getElementById(Rt)?.remove(),document.getElementById(Jt)?.remove(),ht(),bo();return}let w=g.checks;if(a.checks&&a.checks.length===g.checks.length){let C=new Set;w=g.checks.map((T,k)=>a.checks[k]?.filled&&!T.filled?s.has(T.label)?T:(C.add(T.label),{...T,filled:!0}):T),s=C}else s=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:g.previously_sent_at??null},Zb(t,{checks:w,previously_sent_at:g.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),xt(o,a),document.getElementById(hr)&&mr(w,g.previously_sent_at,o)},d=async()=>{let g=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},xt(o,a),ht();try{let y=await th(t,e,g);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},xt(o,a),y.checks&&mr(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},xt(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},xt(o,a),y.checks&&mr(y.checks,y.previously_sent_at,o)}catch(y){c.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},xt(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(hr)?ht():a.checks&&mr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,p=!1,m=Date.now(),b=1e4,_=5*60*1e3,u=0,x=async()=>{if(!p){if(Date.now()<u){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}p=!0,m=Date.now();try{await i()}finally{p=!1}}};x();let f=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(f){let g=new MutationObserver(()=>{if(l!==void 0||p)return;let $=Date.now()-m,C=Math.max(1500,b-$);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},C)});g.observe(f,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=$=>{let C=$.detail;if(!C||C.oppId!==t)return;Bi(t);let T=0,k=()=>{if(p&&T<8){T+=1,window.setTimeout(k,500);return}x()};k()};window.addEventListener(Gn,y);let w=window.setInterval(()=>{document.body.contains(o)||(g.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(Gn,y),window.clearInterval(w))},5e3)}return o},nh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ah=async()=>{for(let t of nh)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_r=new Set,Pi=null,sh=t=>{t&&t!==Pi&&(_r.clear(),Pi=t)},br=!1,Yn=async()=>{if(br){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}br=!0;try{await ih()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{br=!1}},ih=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=ur();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Rt)?.remove(),document.getElementById(Jt)?.remove(),ht();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),sh(t.oppId),_r.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Rt)?.remove(),document.getElementById(Jt)?.remove(),ht();return}let e=document.getElementById(Rt);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(Jt)?.remove(),ht(),bo());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Jt)?.remove(),ht()),c.debug("[stc] mount:04 calling findMountTarget");let o=await ah();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=ur();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=rh(t.oppId,a.locationId),i=document.createElement("span");i.id=Jt,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),W(o).appendChild(i),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),lh(t.oppId)},mo=null,Kn=null,bo=()=>{mo?.disconnect(),mo=null,Kn=null},lh=t=>{if(mo&&Kn===t)return;bo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kn=t,mo=new MutationObserver(()=>{let o=ur();if(!o||o.oppId!==t){bo();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Rt)?.remove(),document.getElementById(Jt)?.remove(),ht(),bo();return}document.getElementById(Rt)||Yn()}),mo.observe(e,{childList:!0,subtree:!0}))},dh=()=>{j("send-to-closing",K,()=>{if(document.getElementById(Rt)||br)return;let t=ur();t&&_r.has(t.oppId)||Yn()})},Hi=()=>{dh(),Yn()};var Zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ch=`${Zn}/tc/welcome-call-prefill`,ph=`${Zn}/tc/welcome-call-save`,mh=`${Zn}/tc/order-lockbox`,ho="ws-crm-welcome-call-overlay",bh=["Regular Contract","Subject To","Seller Finance","Novation"],hh=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],uh=["Gas","Electric","Propane","Oil"],_h=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],vh=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Ht=["Yes","No"],yh=["Yes","No","Unknown"],gh=["Professional Photographer","Seller","Tenant"],fh=["Month-to-Month","Annual"],Di=["Current","Behind"],xh=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],wt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),yr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,Ni="margin-bottom:12px;",qi=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,wh=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Fi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),Y=(t,e,o)=>{let r=Fi(o);return`<select id="${t}" style="${yr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Fi(a)===r?"selected":""}>${wt(a)}</option>`).join("")}</select>`},ot=(t,e,o="")=>`<input id="${t}" type="text" value="${wt(e)}" placeholder="${wt(o)}" style="${yr}">`,kh=(t,e)=>`<textarea id="${t}" rows="3" style="${yr}resize:vertical;">${wt(e)}</textarea>`,Eh=(t,e)=>`<input id="${t}" type="date" value="${wt(e)}" style="${yr}">`,R=(t,e)=>`<div style="${Ni}"><label style="${qi}">${wt(t)}</label>${e}</div>`,Jn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${xh.map(r=>`<label style="${wh}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Ct=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${wt(t)}</div>`,xe=()=>{document.getElementById(ho)?.remove()},Qt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$h=t=>{let e=t.tenant||{};return`
    ${Ct("Identifiers")}
    ...
    ${Ct("Contract")}
    ${R("Type of Contract",Y("wc-contract_type",bh,t.contract_type))}

    ${Ct("Property")}
    ${R("Property Type",Y("wc-property_type",_h,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${R("Utilities",Y("wc-utilities",hh,t.utilities))}
    ${R("Heat Source",Y("wc-heat_source",uh,t.heat_source))}

    ${Ct("Liens & Permits")}
    ${R("Is there a mortgage?",Y("wc-has_mortgage",Ht,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${R("Mortgage payment status",Y("wc-mortgage_payment_status",Di,t.mortgage_payment_status))}</div>
    ${R("Any other liens? (back taxes, code violations, HELOC, etc.)",Y("wc-has_other_liens",Ht,t.has_other_liens))}
    ${R("Any open or expired permits?",Y("wc-has_permit_issues",Ht,t.has_permit_issues))}
    ${R("Is the property in probate?",Y("wc-in_probate",Ht,t.in_probate))}

    ${Ct("Occupancy")}
    ${R("Property occupancy",Y("wc-occupancy",vh,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${R("Lease type",Y("wc-tenant_lease_type",fh,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${R("Rent status",Y("wc-tenant_rent_status",Di,e.rent_status))}</div>
        <div style="flex:1;">${R("Last rent paid",Eh("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${R("Lease on hand?",Y("wc-tenant_lease_on_hand",Ht,e.lease_on_hand))}</div>
        <div style="flex:1;">${R("Security deposit",ot("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${R("Selling with tenant in place?",Y("wc-selling_with_tenant",Ht,t.selling_with_tenant))}
    </div>

    ${Ct("HOA")}
    ${R("Part of an HOA?",Y("wc-in_hoa",Ht,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${R("HOA monthly fee",ot("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${R("HOA rental restriction?",Y("wc-hoa_rental_restriction",yh,t.hoa_rental_restriction))}</div>

    ${Ct("Photos & Access")}
    ${R("Who is providing photos?",Y("wc-photos_provided_by",gh,t.photos_provided_by))}
    <div style="${Ni}">
      <label style="${qi}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Jn("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Jn("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Jn("photos_avail_evenings",t.photos_avail_evenings)}
    </div>

    ${Ct("Lockbox")}
    ${R("Lockbox needed?",Y("wc-lockbox_needed",Ht,t.lockbox_needed))}
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${h.sans};cursor:pointer;flex-shrink:0;">${vr(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${vr(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${vr(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${vr(t).text}</span>
      </div>
    </div>

    ${Ct("Notes")}
    ${R("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",kh("wc-welcome_call_notes",t.welcome_call_notes))}
  `},S=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Qn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),zi=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",S("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",S("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",S("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",S("wc-occupancy")==="Tenant Occupied")},vr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?wt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Th=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:S("wc-contract_type"),property_type:S("wc-property_type"),beds:S("wc-beds"),baths:S("wc-baths"),sqft:S("wc-sqft"),utilities:S("wc-utilities"),heat_source:S("wc-heat_source"),has_mortgage:S("wc-has_mortgage"),mortgage_payment_status:S("wc-mortgage_payment_status"),has_other_liens:S("wc-has_other_liens"),has_permit_issues:S("wc-has_permit_issues"),in_probate:S("wc-in_probate"),occupancy:S("wc-occupancy"),selling_with_tenant:S("wc-selling_with_tenant"),in_hoa:S("wc-in_hoa"),hoa_rental_restriction:S("wc-hoa_rental_restriction"),hoa_monthly_fee:S("wc-hoa_monthly_fee"),photos_provided_by:S("wc-photos_provided_by"),photos_avail_mornings:Qn("photos_avail_mornings"),photos_avail_afternoons:Qn("photos_avail_afternoons"),photos_avail_evenings:Qn("photos_avail_evenings"),lockbox_needed:S("wc-lockbox_needed"),lockbox_code:S("wc-lockbox_code"),lockbox_recipient_name:S("wc-lockbox_recipient_name"),lockbox_recipient_phone:S("wc-lockbox_recipient_phone"),lockbox_mailing_address:S("wc-lockbox_mailing_address"),welcome_call_notes:S("wc-welcome_call_notes"),tenant:S("wc-occupancy")==="Tenant Occupied"?{first_name:S("wc-tenant_first_name"),last_name:S("wc-tenant_last_name"),phone:S("wc-tenant_phone"),email:S("wc-tenant_email"),lease_type:S("wc-tenant_lease_type"),monthly_rent:S("wc-tenant_monthly_rent"),rent_due_day:S("wc-tenant_rent_due_day"),rent_status:S("wc-tenant_rent_status"),last_rent_paid:S("wc-tenant_last_rent_paid"),lease_on_hand:S("wc-tenant_lease_on_hand"),security_deposit:S("wc-tenant_security_deposit")}:void 0}),Ch=t=>{xe();let e=document.createElement("div");e.id=ho,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${h.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${ho} input[type="date"]::-webkit-calendar-picker-indicator,#${ho} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${$h(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&xe()}),document.getElementById("wc-close")?.addEventListener("click",xe),document.getElementById("wc-cancel")?.addEventListener("click",xe),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",zi)}),zi();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!S("wc-occupancy")){Qt("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(ph,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Th(t)),credentials:"omit"})).ok?(xe(),Qt("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Qt("Save failed \u2014 try again.","err"))}catch(s){c.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,Qt("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(mh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:S("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:S("wc-lockbox_recipient_name"),recipient_phone:S("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),Qt("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,Qt("Lockbox order failed \u2014 try again.","err"))}catch(i){c.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,Qt("Couldn't reach the lockbox handler. Try again.","err")}})},Ui=async(t,e)=>{xe();let o=document.createElement("div");o.id=ho,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${h.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${ch}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else c.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){c.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,Ch(r)};var na="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Ah=`${na}/tc/confirm-photo-appointment`,Lh=`${na}/tc/order-lockbox`,Sh=`${na}/tc/welcome-call-prefill`,ea="ws-crm-opp-action-bar",Wi="ws-crm-opp-overflow",Gi="ws-crm-opp-action-menu",oa="ws-crm-opp-action-popover",Ki="ws-crm-reorder-lockbox-modal",Vi=".hr-card.hr-modal.crm-opportunities-modal",Ih=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mh=/\/v2\/location\/([A-Za-z0-9]+)/,Yi="Welcome Call Needed",aa="Scheduling Photos",Ji="Photos Scheduled",Ph=[Yi,aa,Ji,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Qi=()=>{let t=window.location.pathname,e=t.match(Ih);if(!e)return null;let o=t.match(Mh);return o?{oppId:e[1],locationId:o[1]}:null},Oh=()=>{let t=document.querySelector(Vi);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(Ph.includes(r))return r}return null},Ft=()=>{document.getElementById(Gi)?.remove(),document.getElementById(oa)?.remove(),document.getElementById(Ki)?.remove()},Xn=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Dt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Bh=t=>{Ui(t.oppId,t.locationId)},Rh=async(t,e,o)=>(await fetch(Lh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Hh=(t,e)=>{Ft();let o=document.createElement("div");o.id=Ki,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Xn(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Xn(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Xn(i)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",b=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!b){Dt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{await Rh(t,e,{recipient_name:p,recipient_phone:m,ship_to:b})?(d(),Dt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Dt("Re-order failed \u2014 try again.","err"))}catch(_){c.warn("[action-bar] reorder lockbox failed:",_),l.disabled=!1,l.textContent="Order Lockbox",Dt("Couldn't reach the lockbox handler. Try again.","err")}}})},Zi=async t=>{Ft();let e={};try{e=await fetch(`${Sh}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Hh(t,e)},Dh=(t,e)=>{Ft();let o=document.createElement("div");o.id=oa;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${h.sans};
  `,o.innerHTML=`
    <style>#${oa} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Dt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(Ah,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Ft(),Dt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Dt("Booking failed \u2014 try again.","err"))}catch(l){c.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Dt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let p=l.target;!o.contains(p)&&!e.contains(p)&&(Ft(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},Fh=(t,e)=>{Ft();let o=document.createElement("div");o.id=Gi;let r=e.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${h.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Ft(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},fr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=Z:o.style.cssText=P,o.textContent=t,o},zh=()=>{let t=fr("\u22EE","ghost");return t.style.lineHeight="1",t},Nh=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Yi){let r=fr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Bh(t)),o.appendChild(r),o}if(e===aa){let r=fr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Dh(t,r)),o.appendChild(r),o}if(e===Ji){let r=fr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Zi(t)),o.appendChild(r),o}return null},qh=(t,e)=>{let o=[];if(e===aa&&(o=[{label:"Re-order Lockbox",onClick:()=>void Zi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Wi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=zh();return a.addEventListener("click",s=>{s.stopPropagation(),Fh(o,a)}),r.appendChild(a),r},Uh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],jh=async()=>{for(let t of Uh)try{let e=await I(t,{timeoutMs:1200});if(e)return e}catch{}return null},gr=()=>{document.getElementById(ea)?.remove(),document.getElementById(Wi)?.remove(),Ft()},xr=!1,sa=async()=>{if(!xr){xr=!0;try{let t=Qi();if(!t){gr();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){gr();return}let o=Oh(),r=document.getElementById(ea);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Nh(t,o);if(!a){gr();return}let s=await jh();if(!s)return;gr();let i=W(s),d=document.createElement("span");d.id=ea,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=qh(t,o);l&&i.appendChild(l),Wh(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{xr=!1}}},uo=null,ra=null,ta,ji=()=>{uo?.disconnect(),uo=null,ra=null},Wh=t=>{if(uo&&ra===t)return;ji();let e=document.querySelector(Vi);e&&(ra=t,uo=new MutationObserver(()=>{let o=Qi();if(!o||o.oppId!==t){ji();return}ta===void 0&&(ta=window.setTimeout(()=>{ta=void 0,sa()},250))}),uo.observe(e,{childList:!0,subtree:!0}))},Gh=()=>{j("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{xr||sa()})},Xi=()=>{Gh(),sa()};var tl="ws-support-modal",el="ws-support-toast",Kh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",ol="ws-support-submitter-name",rl="ws-support-submitter-email",nl="ws-support-submitter-role",Vh=["Bug","Feature Request","Question","Billing","Onboarding Help"],Zt=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Yh=(t,e="success",o)=>{let r=document.getElementById(el);r&&r.remove();let a=document.createElement("div");a.id=el;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Jh=()=>{document.getElementById(tl)?.remove();let t=(localStorage.getItem(ol)??"").trim(),e=(localStorage.getItem(rl)??"").trim(),o=(localStorage.getItem(nl)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=tl,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `;s.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Zt(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Zt(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Zt(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Title</div>
      <input id="ws-support-title" type="text" placeholder="Short summary" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=b=>{d&&(d.textContent=b)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let p=J();if(!p){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(ol,r.submitterName),localStorage.setItem(rl,r.submitterEmail),r.submitterRole&&localStorage.setItem(nl,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let _=await(await fetch(Kh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!_.ok){l(_.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let u=_.ticket_short_id||"submitted";Yh(`Ticket ${u} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(b){l(`Network error: ${b.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Qh=["/support-ticket","ws-support-modal","ws-support"],Zh=/\/custom-menu-link\//,ia=!1,al=()=>{if(ia||!Zh.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Qh.some(i=>s.includes(i))});if(r){ia=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Jh(),ia=!1},50);return}t<10&&setTimeout(e,150)};e()},sl=!1,il=()=>{sl||(sl=!0,_t(()=>setTimeout(al,50)),al(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var ll="ws-phone-assignments-modal",dl="ws-phone-assignments-toast",Xh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",tu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",eu=["ACQ","DISPO","TC"],ml="",zt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ou=(t,e="success",o)=>{document.getElementById(dl)?.remove();let r=document.createElement("div");r.id=dl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${zt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${zt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},ru=(t,e,o)=>{let r=[`<option value="" ${o===ml?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${zt(a)}" ${o===a?"selected":""}>${zt(a)}</option>`)].join("");return`<select data-assign="${zt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},nu=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,da=async t=>{document.getElementById(ll)?.remove();let e=t||J(),o=document.createElement("div");o.id=ll,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Xh}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){c.error("[phone-assignments] GET failed",_);let u=r.querySelector("#ws-pa-body");u&&(u.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${zt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:eu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,p=i.length?i.map(_=>`<div style="${nu}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${zt(_.label||_.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${h.mono};">${zt(_.e164)}</div>
            </div>
            ${ru(`num:${_.e164}`,s,d[_.e164]??ml)}
          </div>`).join(""):l("phone numbers"),m=_=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${_}</div>`,b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`
    ${m("Numbers \u2192 Team")}
    ...
    </div>`,b.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let u=_.getAttribute("data-assign")||"",[x,...f]=u.split(":"),g=f.join(":");x==="num"&&(_.value?d[g]=_.value:delete d[g])})}),b.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),b.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=b.querySelector("#ws-pa-err"),u=f=>{_&&(_.textContent=f)};u("");let x=b.querySelector("#ws-pa-save");x&&(x.disabled=!0,x.textContent="Saving\u2026",x.style.opacity="0.7");try{let g=await(await fetch(tu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!g.ok){u(g.error||"Save failed."),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1");return}o.remove(),ou("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(f){u(`Network error: ${f.message}`),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1")}}))},au=["ws-phone-assignments","phone-assignments"],su=/\/custom-menu-link\//,la=!1,cl=()=>{if(la||!su.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return au.some(i=>s.includes(i))});if(r){la=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{da(s),la=!1},50);return}t<10&&setTimeout(e,150)};e()},pl=!1,bl=()=>{if(pl)return;pl=!0,_t(()=>setTimeout(cl,50)),cl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&da()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void da(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var hl="powerDialerApp",iu=".dialer",lu='button[aria-label="Voice Calling"], button[title="Voice Calling"]',du=".dial-item.dial-btn.dial-btn-enabled",we=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},cu=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},ca=()=>{try{let e=window[hl]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){c.debug("[dialer-bridge] getEmitter failed",t)}return null},ke=()=>document.querySelector(iu),wr=()=>ca()!==null||ke()!==null?!0:!!window[hl],kr=(t,e)=>{let o=ca();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return c.error(`[dialer-bridge] emit ${t} threw`,r),!1}},ul=()=>{if(ke())return;let t=document.querySelector(lu);t?we(t):c.warn("[dialer-bridge] Voice Calling button not found")},pu=()=>{let t=document.querySelector(".number-list-container")||ke();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},pa=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?cu(t.innerText):null},_l=(t,e)=>{if(pa()===t)return!0;let o=ca();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){c.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&we(r);let a=pu(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return we(s.el),!0}return c.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},vl=t=>{let e=t.replace(/[^\d*#+]/g,"");if(kr("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&we(a)}},yl=()=>{let t=ke();if(!t)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(du)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(we(e),!0):kr("makeCall",{provider:"twilio"})};var ma=()=>{let t=ke();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?we(e.closest("button")||e):kr("closeCallBox")},gl=()=>{kr("closeCallBox")},fl=t=>{let e=!1,o=()=>{let s=ke()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){c.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var mu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",bu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",xl=["acq","dispo","tc"],vo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},_o=null,wl=null,hu=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=J();if(!o)return e;if(!t&&_o&&wl===o)return _o;try{let a=await(await fetch(`${mu}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return _o={numberTeam:a?.config?.numberTeam??{},numberLabel:s},wl=o,_o}catch(r){return c.warn("[silo] config load failed",r),_o??e}},Xt=null,kl=null,ba=async(t=!1)=>{let e=J(),o=O();if(!e||!o)return[];if(!t&&Xt&&kl===e)return Xt;try{let s=(await(await fetch(bu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];Xt=xl.filter(d=>i.includes(d))}else se()?Xt=[...xl]:Xt=[];return kl=e,Xt}catch(r){return c.warn("[silo] roster load failed",r),Xt??[]}},$l=()=>`ws-pd-calling-as:${O()||"anon"}`,Tl=t=>{try{localStorage.setItem($l(),t)}catch{}},ha=async()=>{let t=await ba();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem($l())}catch{}return e&&t.includes(e)?e:t[0]},El=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},uu=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),Cl=async t=>{let e=await ha();if(!e)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await hu(),a=uu(o,e);if(!a.length)return c.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=El(t),i=s?a.find(m=>El(m)===s):void 0,d=i||a[0];if(!_l(d,r[d]||void 0))return c.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;c.info(`[silo] ${vo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let p=pa();return p&&p!==d&&c.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${p} \u2014 GHL dialer DOM/event may have changed`),d};var _u="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",Al="data-ws-pd",Ll="ws-crm-pd-panel",Sl="ws-crm-pd-session",Nt=t=>new Promise(e=>setTimeout(e,t)),yo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),vu=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},yu=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},gu=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},fu=async t=>{let e=vu(t);if(!e)return[];let o=yu(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Nt(550)}return o.scrollTop=0,gu(e)},xu=async(t,e)=>{try{let r=await(await fetch(_u,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},wu=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,_a=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(Ll)?.remove();let r=document.createElement("div");r.id=Ll,r.style.cssText=wu;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((f,g)=>`<label data-row="${g}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${g}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${yo(f.name||f.contactId)}</span>
    ...
    <div style="font-size:14px;font-weight:600;margin:2px 0 2px;">${yo(t)}</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
    ...
    </div>`,r.appendChild(a),document.body.appendChild(r),r.addEventListener("click",f=>{f.target===r&&r.remove()});let i=a.querySelector("#ws-pd-list"),d=a.querySelector("#ws-pd-count"),l=()=>{let f=a.querySelectorAll(".ws-pd-cb:checked").length;d&&(d.textContent=`${f} selected`)};l(),i?.addEventListener("change",l);let p=a.querySelector("#ws-pd-auto-bar"),m=a.querySelector("#ws-pd-auto"),b=a.querySelector("#ws-pd-auto-track"),_=a.querySelector("#ws-pd-auto-knob"),u=()=>{let f=!!m?.checked;b&&(b.style.background=f?n.emerald:n.steel),_&&(_.style.left=f?"20px":"2px"),p?.setAttribute("aria-checked",String(f))},x=()=>{m&&(m.checked=!m.checked,u())};p?.addEventListener("click",x),p?.addEventListener("keydown",f=>{(f.key===" "||f.key==="Enter")&&(f.preventDefault(),x())}),u(),a.querySelector("#ws-pd-search")?.addEventListener("input",f=>{let g=f.target.value.toLowerCase();a.querySelectorAll("[data-row]").forEach(y=>{let w=(y.textContent||"").toLowerCase();y.style.display=w.includes(g)?"flex":"none"})}),a.querySelector("#ws-pd-all")?.addEventListener("change",f=>{let g=f.target.checked;a.querySelectorAll("[data-row]").forEach(y=>{if(y.style.display==="none")return;let w=y.querySelector(".ws-pd-cb");w&&(w.checked=g)}),l()}),a.querySelector("#ws-pd-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-pd-start")?.addEventListener("click",()=>{let f=[];a.querySelectorAll(".ws-pd-cb:checked").forEach(y=>{let w=Number(y.getAttribute("data-i"));e[w]&&f.push(e[w])});let g=a.querySelector("#ws-pd-auto")?.checked??!0;r.remove(),f.length&&Ml(t,f,g)})},Ml=async(t,e,o)=>{let r=J();if(!r)return;document.getElementById(Sl)?.remove();let a={skip:!1,paused:!1,stopped:!1,advance:!1},s=document.createElement("div");s.id=Sl,s.style.cssText=`position:fixed;bottom:24px;left:24px;z-index:100002;width:300px;background:${n.graphite};border:1px solid ${n.steel};border-left:4px solid ${n.emerald};border-radius:${v.md};padding:14px 16px;color:${n.bone};font-family:${h.sans};box-shadow:0 10px 30px rgba(0,0,0,0.5);`,document.body.appendChild(s);let i=(d,l,p)=>{s.innerHTML=`
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${yo(t)} \xB7 ${l+1} of ${e.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${yo(p)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${yo(d)}</div>
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{ma()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{ma()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await xu(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Nt(1200);continue}let b=l._phone||m?.phone||"",_=m?.name||l.name;if(!b){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Nt(1400);continue}if(await Cl(b),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let x=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==x&&(history.pushState({},"",x),window.dispatchEvent(new PopStateEvent("popstate")))}catch(u){c.debug("[bulk-dialer] screen-follow nav failed",u)}i(`Calling ${b}\u2026`,d,_);try{ul(),await Nt(250),vl(b),await Nt(250),yl()}catch(u){c.error("[bulk-dialer] dial failed",u)}if(await new Promise(u=>{let x=!1,f=()=>{x||(x=!0,window.clearInterval(y),g(),u())},g=fl(f),y=window.setInterval(()=>{(a.stopped||a.skip)&&f()},300)}),a.stopped)break;try{gl()}catch{}if(d<e.length-1)if(o)for(let u=5;u>0&&!a.stopped&&!a.advance;u--){for(i(`Next call in ${u}s\u2026`,d,_);a.paused&&!a.stopped&&!a.advance;)await Nt(200);if(a.advance||a.stopped)break;await Nt(1e3)}else for(i("Ready \u2014 press Call Next",d,_);!a.advance&&!a.stopped;)await Nt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},va='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ya=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},ku=()=>{if(ae()!=="opportunity-list"||!ya()||!wr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${Al}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(Al,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${va}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await fu(e);_a(r,l)}catch(l){c.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},Ee=null,ua,Il=!1,Pl=()=>{if(Il)return;Il=!0,window.WS_CRM_PD_TEST=e=>void Ml("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{ua!==void 0&&window.clearTimeout(ua),ua=window.setTimeout(ku,400)};_t(e=>{e==="opportunity-list"?(t(),Ee||(Ee=new MutationObserver(t),Ee.observe(document.body,{childList:!0,subtree:!0}))):Ee&&(Ee.disconnect(),Ee=null)})};var Ol="ws-crm-pd-contacts-btn",Eu=t=>new Promise(e=>setTimeout(e,t)),$u=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},Tu=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,ga=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=$u(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},Cu=async t=>{let e=new Map;if(t)return ga(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(ga(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(ga(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await Eu(220);return o.scrollTop=0,[...e.values()]},Au=()=>{if(ae()!=="contact-list"||!ya()||!wr()||document.getElementById(Ol))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=Ol,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${h.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${va}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=Tu(),l=await Cu(d);_a(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){c.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},$e=null,fa,Bl=!1,Rl=()=>{if(Bl)return;Bl=!0;let t=()=>{fa!==void 0&&window.clearTimeout(fa),fa=window.setTimeout(Au,400)};_t(e=>{e==="contact-list"?(t(),$e||($e=new MutationObserver(t),$e.observe(document.body,{childList:!0,subtree:!0}))):$e&&($e.disconnect(),$e=null)})};var Lu="ws-calling-as-chip",Su=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},xa=!1,te=null,Hl,Fl=0,Iu=3e4,Mu=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},wa=()=>{if(!te||te.isConnected)return;let t=Mu();t&&t.parent.insertBefore(te,t.before)},Dl=async()=>{if(!(xa||te)&&Su()){xa=!0;try{let t=await ba();if(!t.length)return;let e=await ha()??t[0],o=t.length>1,r=document.createElement("div");r.id=Lu,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${h.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${h.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${vo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=vo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let p=document.createElement("div"),m=l===e;p.style.cssText=`padding:9px 14px;font-family:${h.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,p.textContent=vo[l],p.addEventListener("mouseenter",()=>{l!==e&&(p.style.background=n.steel)}),p.addEventListener("mouseleave",()=>{l!==e&&(p.style.background="transparent")}),p.addEventListener("click",b=>{b.stopPropagation(),e=l,Tl(l),s(l),d(),i.style.display="none"}),i.appendChild(p)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let p=a.getBoundingClientRect();i.style.top=`${Math.round(p.bottom+6)}px`,i.style.left=`${Math.round(p.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}te=r,wa(),c.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){c.error("[calling-as] build failed",t)}finally{xa=!1,Fl=Date.now()}}},zl=()=>{te?wa():Dl(),Hl===void 0&&(Hl=window.setInterval(()=>{te?wa():Date.now()-Fl>=Iu&&Dl()},1500))};var Pu="#12161D",Ou="#EDEEF0",Nl=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},ql=t=>{t.style.setProperty("background-color",Pu,"important"),t.style.setProperty("color",Ou,"important")},Bu=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},Ru=t=>{Nl(t)&&ql(t);for(let e of Array.from(t.querySelectorAll("*")))Nl(e)&&ql(e)},ka=null,go=null,jl=()=>{go&&(go.disconnect(),go=null),ka=null},Hu=t=>{if(ka===t)return;jl(),ka=t;let e=!1,o=()=>{e=!1;try{Ru(t)}catch(a){c.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};go=new MutationObserver(r),go.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),c.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},Ul=!1,Er=()=>{if(Ul)return;Ul=!0;let t=()=>{let o=Bu();o?Hu(o):jl()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var Du="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Fu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",zu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Kl="tc_closing_agent",Nu="tc_closing_office",ut="ws-crm-closing-agent-picker-button",Vl="ws-crm-closing-agent-picker-modal",qu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Uu=/\/v2\/location\/([A-Za-z0-9]+)/,wo=()=>{let t=window.location.pathname,e=t.match(qu);if(!e)return null;let o=t.match(Uu);return{oppId:e[1],locationId:o?o[1]:null}},La=async t=>{let e=await fetch(Du,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Wl=async t=>{let e=await fetch(Fu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ju=async(t,e)=>{try{let o=await fetch(zu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Kl}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await La({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},ee=null,Wu=60*60*1e3,Sa=t=>`ws-crm-to-cache:${t}`,Yl=t=>{try{let e=window.localStorage.getItem(Sa(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Wu||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Jl=(t,e,o)=>{try{window.localStorage.setItem(Sa(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Gu=t=>{try{window.localStorage.removeItem(Sa(t))}catch{}},$a="ws-crm-closing-agent-field-link",Ku=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${$a}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Ea=!1,Ia=async t=>{if(Ea)return;let e=Ql();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Ea=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await La({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Ta(a.id,a.name,t);let s=document.getElementById(ut);if(s){qt(s,{status:"linked",contactName:a.name});let i=wo();i&&Jl(i.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Ea=!1}}},Vu=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ql=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let p=(l.textContent||"").trim();Vu.test(p)?o.push(l):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let b=l.getAttribute(m);b&&/Title\s+Officer/i.test(b)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:b})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,p)=>l.querySelectorAll("*").length-p.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return c.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Ta=(t,e,o)=>{let r=Ql();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${$a}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=$a,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},$r=()=>{document.getElementById(Vl)?.remove()},Yu=t=>{$r();let e=document.createElement("div");e.id=Vl,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&$r()}),s?.addEventListener("click",$r);let i,d="",l=async p=>{if(a&&p!==d){if(d=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await La({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",m.results.forEach(b=>{let _=document.createElement("button");_.type="button",_.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,_.innerHTML=`
          <div style="font-weight: 500;">${Tr(b.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Tr(b.email||"(no email)")} \xB7 ${Tr(b.phone||"no phone")}
            ${b.companyName?` \xB7 ${Tr(b.companyName)}`:""}
          </div>
        `,_.addEventListener("mouseenter",()=>{_.style.background=n.slate}),_.addEventListener("mouseleave",()=>{_.style.background="transparent"}),_.addEventListener("click",()=>{$r(),t.onPick(b)}),a.appendChild(_)})}catch(m){c.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let p=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{l(p)},250)})},Tr=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),qt=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",s=n.amber,i=n.bone,d="transparent",l=n.steel,p="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",s=n.coolGray,i=n.ash,p="wait";break;case"empty":a="Link Closing Agent",s=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=n.emerald,d=n.emeraldGlow,l=n.emeraldBorder,i=n.emeraldBright;break;case"saving":a="Linking\u2026",s=n.coolGray,i=n.ash,p="wait";break}o&&(o.textContent=a),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),t.style.background=d,t.style.borderColor=l,t.style.color=i,t.style.cursor=p},Ju=(t,e)=>{let o=document.createElement("button");o.id=ut,o.type="button",o.dataset.oppId=t,o.style.cssText=P,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};qt(o,r);let a=Yl(t);return a&&(r={status:"linked",contactName:a.contactName},qt(o,r),ee={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await ju(t,e);i?(r={status:"linked",contactName:i.name},qt(o,r),ee={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ta(i.id,i.name,e)):a||(r={status:"empty"},qt(o,r),ee?.oppId===t&&(ee=null),Ku(),Gu(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Yu({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},qt(o,r);try{let d=await Wl({tenantId:e,oppId:t,fieldKey:Kl,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await Wl({tenantId:e,oppId:t,fieldKey:Nu,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},qt(o,r),ee={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Jl(t,i.id,i.name),Ta(i.id,i.name,e),Ri(t),c.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){c.error("Closing Agent link failed",d),r={status:"empty"},qt(o,r)}}})}),o},Qu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Zu=async()=>{for(let t of Qu)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fo=!1,Ar=async()=>{if(!fo){fo=!0;try{await Xu()}finally{fo=!1}}},Xu=async()=>{let t=wo();if(!t||!t.locationId){document.getElementById(ut)?.remove(),document.getElementById(`${ut}-wrap`)?.remove(),Cr();return}let e=document.getElementById(ut);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ut}-wrap`)?.remove(),Cr());return}e&&(e.remove(),document.getElementById(`${ut}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Zu();if(!r||!(Yl(t.oppId)!==null||ee!==null&&ee.oppId===t.oppId)&&await V()!=="Transaction Coordination")return;let s=wo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=Ju(t.oppId,s.locationId),d=document.createElement("span");d.id=`${ut}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),W(r).appendChild(d),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),t_(t.oppId),Ia(s.locationId)},xo=null,Ca=null,Aa=null,Cr=()=>{xo?.disconnect(),xo=null,Ca=null,Aa=null},t_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xo&&Ca===t&&Aa===e||(Cr(),Ca=t,Aa=e,xo=new MutationObserver(()=>{let o=wo();if(!o||o.oppId!==t||!o.locationId){Cr();return}document.getElementById(ut)||Ar(),Ia(o.locationId)}),xo.observe(e,{childList:!0,subtree:!0})))},e_=()=>{j("closing-agent-picker",K,()=>{!document.getElementById(ut)&&!fo&&Ar()})},Gl,o_=()=>{Gl===void 0&&(Gl=window.setInterval(()=>{let t=wo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ut)&&!fo&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ar()),Ia(t.locationId)},2e3))},Zl=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),e_(),o_(),Ar()};var r_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",At="ws-crm-manage-team-cta",td="ws-crm-manage-team-modal",n_=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,ed={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},a_={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},od=()=>{let t=window.location.pathname.match(n_);return t?{tenantId:t[1]}:null},Sr=async t=>{let e=await fetch(r_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},dt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ut=t=>dt(t),Ma="ws-crm-manage-team-toast",Ba=(t,e="info",o=4e3)=>{document.getElementById(Ma)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Ma,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Ma)===a&&a.remove()},o)},Pa=()=>{document.getElementById(td)?.remove()},s_=(t,e)=>{let o=a_[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${dt(e)}</span>
  `},i_=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>s_(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
    <div data-user-id="${Ut(t.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${s}>
        <button class="ws-team-edit" data-email="${Ut(t.email)}" data-user-id="${Ut(t.id)}" data-name="${Ut(o)}" data-current-roles="${Ut(t.role_keys.join(","))}" style="${P} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${Ut(t.email)}" data-name="${Ut(o)}" data-role-count="${Ut(String(t.role_keys.length))}" style="${P} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},l_=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>i_(r,e)).join(""),Ir=async t=>{Pa();let e=document.createElement("div");e.id=td,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${h.sans};
  `,e.addEventListener("click",l=>{l.target===e&&Pa()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Pa);let r;try{r=await Sr({tenant_id:t,action:"list"})}catch(l){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+l_(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{d_(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",p=>{let m=p.currentTarget;c_(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",p=>{let m=p.currentTarget;p_(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},d_=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(s),document.body.appendChild(o),s.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),s.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let i=(s.querySelector("#ws-team-add-first")?.value||"").trim(),d=(s.querySelector("#ws-team-add-last")?.value||"").trim(),l=(s.querySelector("#ws-team-add-email")?.value||"").trim(),p=(s.querySelector("#ws-team-add-mobile")?.value||"").trim(),m=(s.querySelector("#ws-team-add-role")?.value||"").trim(),b=s.querySelector("#ws-team-add-error"),_=s.querySelector("#ws-team-add-submit");if(!i||!d||!l||!p||!m){b&&(b.textContent="All fields are required.");return}_&&(_.disabled=!0,_.textContent="Adding\u2026",_.style.opacity="0.7"),b&&(b.textContent="");try{let u=await Sr({tenant_id:t,action:"add",first_name:i,last_name:d,email:l,mobile:p,role:m,triggered_by_user_id:O()});if(!u.ok){b&&(b.textContent=u.error||"Failed to add employee"),_&&(_.disabled=!1,_.textContent="Add Employee",_.style.opacity="1");return}o.remove(),Ba(`Added ${i} ${d} as ${ed[m]||m}.`,"success"),await Ir(t)}catch(u){b&&(b.textContent=u.message),_&&(_.disabled=!1,_.textContent="Add Employee",_.style.opacity="1")}})},c_=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${dt(ed[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=a.querySelector("#ws-team-remove-error"),i=a.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let d=await Sr({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:O()});if(!d.ok){s&&(s.textContent=d.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),Ba(`Removed ${e.name} from the team.`,"success"),await Ir(t)}catch(d){s&&(s.textContent=d.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},m_=89,b_=93,h_=310,u_=34,__=14,v_=14,y_=3,Lr=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+m_;t.style.right=`${Math.max(r,16)}px`},g_=t=>{let e=document.createElement("button");return e.id=At,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${b_}px;
    right: 24px;
    width: ${h_}px;
  ...
  `,e.addEventListener("click",()=>{Ir(t)}),Lr(e),setTimeout(()=>Lr(e),200),setTimeout(()=>Lr(e),800),f_(),e},Xl=!1,f_=()=>{Xl||(Xl=!0,window.addEventListener("resize",()=>{let t=document.getElementById(At);t instanceof HTMLButtonElement&&Lr(t)}))},Oa=!1,x_=()=>{if(!Oa){Oa=!0;try{let t=od();if(!t){document.getElementById(At)?.remove(),document.getElementById(`${At}-floater`)?.remove();return}let e=document.getElementById(At);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${At}-floater`)?.remove();let o=document.createElement("div");o.id=`${At}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=g_(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Oa=!1}}},rd=()=>{if(!od()){document.getElementById(At)?.remove(),document.getElementById(`${At}-floater`)?.remove();return}x_()};var w_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Da="ws-crm-prepare-contract-button",nd="ws-crm-prepare-contract-menu",Et="ws-crm-prepare-contract-modal",ad="ws-crm-modal-date-style",Lt="https://services.leadconnectorhq.com",pd=()=>{if(document.getElementById(ad))return;let t=document.createElement("style");t.id=ad,t.textContent=`
  ...
  `,document.head.appendChild(t)},Fa="__WS_CRM_CAPTURED_AUTH",k_=50*60*1e3,To=()=>{try{let t=localStorage.getItem(Fa);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>k_?(localStorage.removeItem(Fa),null):e:null}catch{return null}},E_=t=>{try{localStorage.setItem(Fa,JSON.stringify(t))}catch{}},Ce=()=>{let t=To(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},sd=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((To()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Te=async(t,e={},o=2)=>{let r=To()?.capturedAt??0,a;try{a={...Ce(),...e.headers??{}}}catch(i){if(o>0&&await sd(r,4e3))return Te(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await sd(r,4e3)?Te(t,e,o-1):s},id=!1,$_=()=>{if(id)return;id=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=To();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,p,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:p,source:m};let b=p.authorization||p.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(p)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=p["token-id"]||p["Token-Id"]||void 0,u=To()?.authorization;E_({authorization:b,tokenId:_,capturedAt:Date.now()}),u!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let p=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(p&&p.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let b=m.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let _={};if(b instanceof Headers)b.forEach((u,x)=>_[x.toLowerCase()]=u);else if(Array.isArray(b))b.forEach(([u,x])=>_[u.toLowerCase()]=x);else if(b&&typeof b=="object")for(let u of Object.keys(b))_[u.toLowerCase()]=b[u];o(p,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,p,...m){return this.__wsCrmUrl=p,this.__wsCrmHeaders={},s.call(this,l,p,...m)},a.setRequestHeader=function(l,p){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=p),i.call(this,l,p)},a.send=function(l){let p=this.__wsCrmUrl,m=this.__wsCrmHeaders;return p&&p.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(p,m,"xhr")),d.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},md=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},T_=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:md()},C_=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},bd="__WS_CRM_TEMPLATES_CACHE_V1",A_=24*60*60*1e3,ld=t=>{try{let e=window.localStorage.getItem(bd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>A_?null:o.templates}catch{return null}},L_=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(bd,JSON.stringify(o))}catch{}},S_=async t=>{let e=`${Lt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Te(e,{method:"GET"})}catch(i){let d=ld(t);if(d)return c.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=ld(t);if(i)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:C_(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&L_(t,s),s},I_=async(t,e)=>{let o=await Te(`${Lt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Te(`${Lt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-p})},M_=async(t,e)=>{let o=await Te(`${Lt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Lt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ce()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,p)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-m})},P_=async t=>{let e=await fetch(w_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},O_=async(t,e,o)=>{let r=`${Lt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ce()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},B_=async(t,e)=>{let o=await fetch(`${Lt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ce()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},hd=async t=>{let e=await fetch(`${Lt}/contacts/${t}`,{method:"GET",headers:Ce()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},R_=async(t,e,o,r)=>{let a;try{a=await B_(t,e)}catch(u){return{ok:!1,body:`fetchProposalDocument: ${u.message}`}}let s;try{s=await hd(o)}catch(u){return{ok:!1,body:`fetchContactBasics: ${u.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(u=>u?.entityName!=="contacts"),d],b={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Lt}/proposals/document/${e}`,{method:"PUT",headers:{...Ce(),"Content-Type":"application/json"},body:JSON.stringify(b)});if(!_.ok){let u=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:u}}return{ok:!0}},H_=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Pr="__WS_CRM_PENDING_INSTRUCTIONS",D_=60*1e3,F_=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],z_=t=>{let e=(t||"").toLowerCase();for(let o of F_)if(e.includes(o.matches.toLowerCase()))return o;return null},N_=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Pr,JSON.stringify(r))}catch{}},q_=()=>{try{let t=localStorage.getItem(Pr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>D_?(localStorage.removeItem(Pr),null):e}catch{return null}},U_=()=>{try{localStorage.removeItem(Pr)}catch{}},j_=(t,e)=>{document.getElementById(Et)?.remove();let o=document.createElement("div");o.id=Et,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},W_=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,G_=()=>{let t=window.location.pathname.match(W_);if(!t)return;let e=t[1],o=q_();o&&o.proposalId===e&&(U_(),window.setTimeout(()=>{j_(o.title,o.bodyHtml)},600))},dd="ws-crm-prepare-contract-toast",Q=(t,e="info",o=4e3)=>{document.getElementById(dd)?.remove();let r=document.createElement("div");r.id=dd;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},cd=(t,e)=>new Promise(o=>{document.getElementById(Et)?.remove();let r=document.createElement("div");r.id=Et,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `,r.appendChild(a),document.body.appendChild(r);let d=l=>{r.remove(),o(l)};r.addEventListener("click",l=>{l.target===r&&d(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>d(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.borderColor=n.emerald,l.style.background=n.graphite}),l.addEventListener("mouseleave",()=>{l.style.borderColor=n.steel,l.style.background=n.slate}),l.addEventListener("click",p=>{p.stopPropagation(),p.preventDefault();let m=l.dataset.oppId||"";m&&d(m)})})}),K_=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(Et)?.remove(),pd();let a=r.debug||{},s=typeof a.propertyAddress=="string"?a.propertyAddress:"",i=typeof a.sellerName=="string"?a.sellerName:"",d=typeof a.purchasePrice=="number"?a.purchasePrice:0,l=typeof a.emd=="number"?a.emd:0,p=typeof a.cashAtClose=="number"?a.cashAtClose:d-l,m=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),b=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),_=typeof a.additionalTerms=="string"?a.additionalTerms:"",u=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",x=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",f=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],g=document.createElement("div");g.id=Et,g.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,M=G=>['<option value="">(unset)</option>'].concat(f.map(X=>`<option value="${kt(X)}"${X===G?" selected":""}>${at(X)}</option>`)).join("");y.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${k}">
        ...
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${kt(b)}" placeholder="e.g. 10" style="${$}" />
      </div>
      <div style="${k}">
        <div style="${w}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${L}">${M(u)}</select>
      </div>
      <div style="${k}">
        <div style="${w}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${L}">${M(x)}</select>
      </div>
      <div style="${k} align-items: flex-start;">
        <div style="${w}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${$} resize: vertical; min-height: 60px; font-family: ${h.sans};">${at(_)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,g.appendChild(y),document.body.appendChild(g);let N=y.querySelector("#ws-pc-purchase-price"),z=y.querySelector("#ws-pc-emd"),q=y.querySelector("#ws-pc-cash-at-close"),D=!1;q?.addEventListener("input",()=>{D=!0});let It=()=>{if(D)return;let G=Number(N?.value||0),X=Number(z?.value||0);q&&(q.value=String(Math.max(0,G-X)))};N?.addEventListener("input",It),z?.addEventListener("input",It);let Mt=()=>g.remove();g.addEventListener("click",G=>{G.target===g&&Mt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Mt);let rt=y.querySelector("#ws-pc-submit"),st=y.querySelector("#ws-pc-error");rt?.addEventListener("click",async()=>{if(rt){st&&(st.textContent=""),rt.disabled=!0,rt.textContent="Opening\u2026";try{let G=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),X=Number(N?.value||0),Be=Number(z?.value||0),Re=Number(q?.value||0),He=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),De=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Fe=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ne=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),ze=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),tt={};if(G!==i&&(tt.sellerName=G),X!==d&&(tt.purchasePrice=X),Be!==l&&(tt.emd=Be),Re!==p&&(tt.cashAtClose=Re),He!==m&&(tt.daysToClose=He),De!==b&&(tt.inspectionDays=De),Fe!==_&&(tt.additionalTerms=Fe),ne!==u&&(tt.currentOccupancy=ne),ze!==x&&(tt.occupancyAtClose=ze),Object.keys(tt).length>0){c.info("[prepare-contract] PA modal submit with overrides:",tt),rt.textContent="Saving\u2026";let Kr=O(),Vr=await Or({tenantId:t,contactId:e,template:o,userId:Kr,overrides:tt});c.info("[prepare-contract] re-stage with overrides ok:",Vr),rt.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let et=s?`${s} - Purchase Agreement`:void 0;await qa(t,e,o,et)}catch(G){rt.disabled=!1,rt.textContent="Open Contract",st&&(st.textContent=G.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",G)}}})},V_=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Et)?.remove(),pd();let l=a.debug||{},p=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",b=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,_=typeof l.buyerEMD=="number"?l.buyerEMD:0,u=typeof l.assignmentFee=="number"?l.assignmentFee:0,x=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,f=typeof l.closingOffice=="string"?l.closingOffice:"",g=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,w=d,$="",C=document.createElement("div");C.id=Et,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;T.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${N}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${kt(g)}" placeholder="Buyer's entity / LLC name" style="${E}" />
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <input id="ws-pc-emd-due-date" type="date" value="${kt(w)}" style="${E}" />
      </div>
      <div style="${N}">
  ...
  `,C.appendChild(T),document.body.appendChild(C);let q=T.querySelector("#ws-pc-assignment-price"),D=T.querySelector("#ws-pc-assignment-fee"),It=!1;D?.addEventListener("input",()=>{It=!0});let Mt=()=>{if(It)return;let X=Number(q?.value||0);D&&(D.value=String(Math.max(0,X-x)))};q?.addEventListener("input",Mt);let rt=()=>C.remove();C.addEventListener("click",X=>{X.target===C&&rt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",rt);let st=T.querySelector("#ws-pc-submit"),G=T.querySelector("#ws-pc-error");st?.addEventListener("click",async()=>{if(!st)return;G&&(G.textContent="");let X=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),Be=Number(q?.value||0),Re=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),He=Number(D?.value||0),De=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),Fe=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ne=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),ze=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),tt=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ne){G&&(G.textContent="Closing Date is required.");return}st.disabled=!0,st.textContent="Opening\u2026";try{let et={};X!==m&&(et.sellerName=X),Be!==b&&(et.assignmentPrice=Be),Re!==_&&(et.buyerEMD=Re),He!==u&&(et.assignmentFee=He),De!==f&&(et.closingOffice=De),Fe!==g&&(et.buyerCompanyName=Fe);let Kr=ne!==y||ze!==w||tt!==$,Vr=Object.keys(et).length>0||Kr,Yr=a;Vr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",et),st.textContent="Saving\u2026",Yr=await Or({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ne,buyerEarnestDueDate:ze,lenderSource:tt,userId:s,overrides:Object.keys(et).length>0?et:void 0}),c.info("[prepare-contract] AA re-stage ok:",Yr),st.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let ns=Yr?.debug?.propertyAddress||p,yc=ns?`${ns} - Assignment Agreement`:void 0;await qa(t,e,o,yc),rt()}catch(et){st.disabled=!1,st.textContent="Open Contract",G&&(G.textContent=et.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",et)}})},Or=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await P_({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},qa=async(t,e,o,r)=>{let a=null;try{a=(await hd(e)).email||""}catch(l){c.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){Q("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),c.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await O_(t,o.id,e);c.info(`[prepare-contract] proposal created: ${s}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await R_(t,s,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${s}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Q(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=z_(o.name);d&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),N_(s,d.title,d.bodyHtml)),H_(t,s)},Y_=async t=>{let e=T_(t);if(!e){Q("Could not resolve contact context.","error");return}document.getElementById(nd)?.remove();let o=document.createElement("div");o.id=nd,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await S_(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),c.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await M_(e.tenantId,e.contactId)}catch(w){Q(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(y.length===0){Q("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,c.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let w=await cd(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}m=w,c.info(`[prepare-contract] picked MT opp ${m}`)}}let b=y=>{let w=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${w}-${$}-${C}`},_=y=>{let w=new Date;return w.setDate(w.getDate()+y),b(w)},u=_(45),x=_(7);Q("Reading contract data\u2026","info",2500);let f;try{f=await Or({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:u,buyerEarnestDueDate:x,userId:p})}catch(y){Q(`Failed to prepare contract: ${y.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",y);return}let g=e.contactId||f.contact_id||"";if(!g){Q("Could not resolve buyer contact for this opp.","error",6e3);return}V_({tenantId:e.tenantId,contactId:g,template:s,oppId:m,staged:f,userId:p,defaultClosingDate:u,defaultEMDDueDate:x})}else if(s.type==="PA"){if(!e.contactId){Q("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await I_(e.tenantId,e.contactId)}catch(u){Q(`Failed to load ACQ opps: ${u.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",u);return}if(m.length===0){Q("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let b;if(m.length===1)b=m[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${b} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let u=await cd(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!u){c.info("[prepare-contract] ACQ opp picker cancelled");return}b=u,c.info(`[prepare-contract] picked ACQ opp ${b}`)}Q("Reading contract data\u2026","info",2500);let _;try{_=await Or({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:b,userId:p})}catch(u){Q(`Failed to prepare contract: ${u.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",u);return}K_({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:_})}else{if(!e.contactId){Q("This template needs to be started from a contact page.","error",6e3);return}Q(`Opening ${s.name}\u2026`,"info",2500);try{await qa(e.tenantId,e.contactId,s)}catch(m){Q(`Failed to open contract: ${m.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){c.warn("[prepare-contract] picker click handler failed:",m),Q(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},ud=()=>{let t=document.createElement("button");return t.id=Da,t.type="button",t.style.cssText=`${P} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Y_(t)}),t},J_="ws-crm-contact-actions-bar",Q_=async()=>{let t=md();if(!t){document.getElementById(Da)?.remove();return}let e=null;try{e=await I(`#${J_}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Da);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=ud();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},oe="ws-crm-prepare-contract-button-opp",ko=`${oe}-wrap`,Z_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,X_=/\/v2\/location\/([A-Za-z0-9]+)/,tv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],za=()=>{let t=window.location.pathname,e=t.match(Z_);if(!e)return null;let o=t.match(X_);return o?{oppId:e[1],tenantId:o[1]}:null},ev=async()=>{for(let t of tv)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Mr=!1,Eo=null,Na=null,Ra=null,Ha,$o=()=>{Eo?.disconnect(),Eo=null,Na=null},ov=t=>{if(Eo&&Na===t)return;$o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Na=t,Eo=new MutationObserver(()=>{let o=za();if(!o||o.oppId!==t){$o();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(oe)?.remove(),document.getElementById(ko)?.remove(),$o();return}document.getElementById(oe)||_d()}),Eo.observe(e,{childList:!0,subtree:!0}))},rv=()=>{Ra||(Ra=new MutationObserver(()=>{Ha===void 0&&(Ha=window.setTimeout(()=>{Ha=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!Mr&&_d()},300))}),Ra.observe(document.body,{childList:!0,subtree:!0}))},_d=async()=>{if(!Mr){Mr=!0;try{let t=za();if(!t){document.getElementById(oe)?.remove(),document.getElementById(ko)?.remove(),$o();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(ko)?.remove(),$o());return}e&&(e.remove(),document.getElementById(ko)?.remove());let o=await ev();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await V();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=za();if(!a||a.oppId!==t.oppId)return;let s=ud();s.id=oe,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=ko,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),ov(t.oppId)}finally{Mr=!1}}},vd=()=>{G_(),Q_()};$_();function at(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function kt(t){return at(t)}var nv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",re="ws-crm-compute-offer-button",Wa="ws-crm-compute-offer-popover",$d="ws-crm-offer-modal",yd="ws-crm-contact-actions-bar",av=[".central-panel","[class*='central-panel']"],jt=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",Ua=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},sv=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],gd=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${sv[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},fd=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;outline:none;`,ja=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(nv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Ae=()=>{document.getElementById(Wa)?.remove(),document.removeEventListener("mousedown",Td,!0)};function Td(t){let e=document.getElementById(Wa),o=document.getElementById(re),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Ae()}var Cd=(t,e)=>{Ae();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Wa;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${h.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Td,!0),0)},Br=(t,e)=>{Cd(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},iv=(t,e,o)=>{Cd(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{Ae(),o(a.property_record_id)}),r.appendChild(s)})})},Hr=()=>{document.getElementById($d)?.remove(),document.removeEventListener("keydown",Ad,!0)};function Ad(t){t.key==="Escape"&&Hr()}var xd=(t,e,o)=>{Hr(),Ae();let r=o,a=!1,s="",i=document.createElement("div");i.id=$d,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${h.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&Hr()});let d=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,b,_)=>{a||(a=!0,s="",p(),ja({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:b,repairOverride:_}).then(u=>{u&&u.ok?r={...u,current_offer:u.current_offer??r.current_offer,current_offer_date:u.current_offer_date??r.current_offer_date}:s=u&&u.error||"Request failed."}).catch(u=>{c.error("[compute-offer] worksheet request failed:",u),s="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let m=r,b=!!m.has_comps;d.innerHTML="";let _=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),u=F("div","");u.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),u.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let x=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",Hr),_.append(u,x),d.appendChild(_);let f=F("div","padding:14px 18px 18px;");d.appendChild(f);let g=F("select",fd());(m.rehab_levels||[]).forEach(z=>{let q=document.createElement("option");q.value=z.key,q.textContent=z.label,z.key===(m.tier||m.property_condition)&&(q.selected=!0),g.appendChild(q)}),g.disabled=a,g.addEventListener("change",()=>l("recompute",g.value,y.value.trim()));let y=F("input",fd());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",z=>{z.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",g.value,y.value.trim()));let w=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(F("div",`font-size:12px;color:${b?n.bone:n.amber};`,b?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${gd(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${b?"transparent":n.blue};color:${b?n.blue:"#fff"};font-family:${h.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":b?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",g.value,y.value.trim())),w.append($),f.appendChild(w),m.low_confidence&&b&&f.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let C=m.current_offer!=null;f.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${jt(m.current_offer)}${m.current_offer_date?` \xB7 ${gd(m.current_offer_date)}`:""}`:"No offer made yet."));let T=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),k=F("div","");k.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),k.appendChild(g);let E=F("div","");E.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(k,E),f.appendChild(T);let L=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),M=(z,q,D)=>{let It=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${D?.strong?"font-weight:700;":""}`),Mt=F("div","");Mt.appendChild(F("div",`font-size:${D?.strong?"13":"12"}px;color:${n.bone};`,z)),D?.sub&&Mt.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,D.sub));let rt=F("div",`font-size:${D?.strong?"15":"12"}px;color:${D?.color||n.bone};white-space:nowrap;`,q);It.append(Mt,rt),L.appendChild(It)};if(b&&m.imv!=null){M("Investor Market Value (IMV)",jt(m.imv)),m.arv!=null&&M("After Repair Value (ARV)",jt(m.arv),{color:n.ash});let z=m.repair_adjustment??0,q=-z,D=m.repair_override?"Repair override":m.property_condition_label||"Repairs";z===0?M(`Repairs (${D})`,"Included",{color:n.ash,sub:`${jt(m.repair_total)} in repairs included at IMV`}):M(`Repairs (${D})`,Ua(q),{color:q<0?n.crimson:n.emerald,sub:`${jt(m.repair_total)} total, ${jt(m.baseline_repairs)} included at IMV`}),M("Min. Profit Target",Ua(-(m.profit_target??0)),{color:n.ash}),M("Maximum Cash Offer (MAO)",jt(m.mao),{strong:!0,color:n.blue}),M("Target Profit",Ua(-(m.ico_delta??0)),{color:n.ash}),M("Initial Cash Offer (ICO)",jt(m.ico),{strong:!0,color:n.blue})}else L.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));f.appendChild(L);let N=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);N.textContent=a?"Saving\u2026":s||(b?"Saved to the Property.":""),f.appendChild(N)}p(),document.body.appendChild(i),document.addEventListener("keydown",Ad,!0)},wd=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=re,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){iv(o,i.properties,d=>{a(!0),ja({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?xd(e,l.property_record_id,l):Br(o,l.error||"Couldn't load that property.")}).catch(l=>{c.error("[compute-offer] get failed:",l),Br(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?xd(e,i.property_record_id,i):Br(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await ja({tenantId:e,contactId:t,mode:"get"}))}catch(i){c.error("[compute-offer] webhook failed:",i),Br(o,"Request failed. Try again.")}finally{a(!1)}}}),o},lv=async()=>{for(let t of av)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},kd=async(t,e)=>{let o=e.querySelector(`#${yd}`);if(!o)try{o=await I(`#${yd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Ed=()=>{let t=document.querySelectorAll(`#${re}`);for(let e=1;e<t.length;e++)t[e].remove()},dv=async()=>{let t=B();if(!t||!t.locationId||t.source!=="url"){document.getElementById(re)?.remove(),Ae();return}let e=t.locationId,o=document.getElementById(re);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Ae();let r="seller";try{r=yt(await vt(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(re)?.remove();return}let a=await lv();if(!a){c.warn("[compute-offer] no central panel found");return}let s=B();if(!s||s.contactId!==t.contactId)return;let i=wd(t.contactId,e);if(!await kd(i,a)){c.warn("[compute-offer] actions bar not found after waiting");return}Ed(),c.debug(`[compute-offer] mounted for ${t.contactId}`),Rr?.disconnect(),Rr=new MutationObserver(()=>{if(B()?.contactId!==t.contactId){Rr?.disconnect();return}if(!document.getElementById(re)){let d=wd(t.contactId,e);kd(d,a).then(()=>Ed())}}),Rr.observe(a,{childList:!0})},Rr=null,Co=null,Ld=()=>{let t=B()?.contactId??null;if(Co&&Co.id===t)return;let e=dv().finally(()=>{Co?.promise===e&&(Co=null)});Co={id:t,promise:e}};var Ur="reos-theme-stylesheet",Yd="reos-theme-fonts",Me=!1,cv=()=>{let t=document.getElementById(Yd);t&&t.remove()},pv=`
...
`,mv=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],bv=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${s})`}return`rgb(${o}, ${r}, ${a})`},hv=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),uv=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Dr=new WeakSet,Sd=t=>{try{if(!document.body)return;(t??document.body.querySelectorAll("*")).forEach(o=>{try{if(o.classList&&(o.classList.contains("hr-drawer-container")||o.classList.contains("hr-detached-container"))){(o.getAttribute("style")||"").includes("background")&&(o.style.removeProperty("background-color"),o.style.removeProperty("background-image"));return}if(Dr.has(o)&&o.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest(".hl_header, header.hl_header, header.app-header")||o.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let r=o.tagName;if(r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||r==="SCRIPT"||r==="STYLE"||r==="SVG"||r==="PATH"||r==="IMG")return;let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let d=+i[1],l=+i[2],p=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||d<230||l<230||p<230)return;let b=o.style.getPropertyValue("background-color");if(b==="rgb(18, 22, 29)"){Dr.add(o);return}if(o.closest(".hr-button")&&!(o.classList&&o.classList.contains("hr-button"))){b!=="transparent"&&(o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important")),Dr.add(o);return}o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"),Dr.add(o)}catch{}})}catch{}},Ga=new WeakSet,Le=()=>{document.querySelectorAll(uv.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(r.classList&&(r.classList.contains("hr-drawer-container")||r.classList.contains("hr-detached-container"))){(r.getAttribute("style")||"").includes("background")&&(r.style.removeProperty("background-color"),r.style.removeProperty("background-image"));return}if(Ga.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH"||r.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=+i[1],l=+i[2],p=+i[3];if(!(d<230||l<230||p<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),Ga.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),Ga.add(r)}})})},Id=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},Md=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},Pd=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Fr=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let d=+i[1],l=+i[2],p=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&d>=180&&l>=180&&p>=180&&d+l+p>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},Od=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Se=()=>{if(!Me)for(let t of mv){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let s=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),d=hv.has(r)?bv(a):a;s==="important"&&i===d||o.style.setProperty(r,a,"important")}})}},jr="#1A1F28",_v=26,vv=31,yv=40,Bd=new Set,Rd=new Set,zr=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let a=o.getBoundingClientRect();if(a.width===0||a.height===0||a.width>800)return;o.style.setProperty("display","none","important");let s=o.className?.toString()||"<no class>";!Rd.has(s)&&s!=="<no class>"&&(Rd.add(s),c.debug(`Hid empty "--" leaf: "${s}"`))})},gv=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],fv=["trash","Trash","TRASH","delete","Delete","DELETE"],xv=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(fv.some(s=>a.includes(s))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let d=i.getAttribute("d")||"";gv.some(l=>d.includes(l))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),d=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||d.includes("delete")||d.includes("remove")||d.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},wv=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),kv=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||wv.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Hd=new Set,Dd=new WeakSet,Ev=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(Dd.has(o)&&o.style.getPropertyValue("color")==="rgb(237, 238, 240)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let r=(o.className?.toString()||"").toLowerCase();if(r.includes("ai-button")||r.includes("ask-ai")||r.includes("bg-clip-text")||r.includes("text-transparent")||o.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let a=o.tagName.toLowerCase();if(a==="svg"||a==="path"||a==="circle"||a==="rect"||a==="polygon"||a==="polyline"||a==="line"||a==="g")return;let s=!1;for(let _ of Array.from(o.childNodes))if(_.nodeType===Node.TEXT_NODE&&(_.textContent||"").trim()){s=!0;break}if(!s)return;let i=Array.from(o.children);if(i.length>0&&i.every(_=>{let u=_.tagName.toLowerCase();return u==="svg"||u==="img"})&&!s)return;let p=window.getComputedStyle(o).color;if(!(p==="rgb(255, 255, 255)"||p==="rgba(255, 255, 255, 1)"||p==="#ffffff"||p==="white"))return;o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Dd.add(o);let b=o.className?.toString()||"<no class>";!Hd.has(b)&&b!=="<no class>"&&(Hd.add(b),c.debug(`Remapped pure-white text -> bone: "${b}"`))})},Fd=new Set,$v=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let d=window.getComputedStyle(s),l=d.backgroundColor,p=d.backgroundImage||"",m=!1;if(p!=="none"&&p.includes("gradient"))m=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let C=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(C&&parseFloat(C[1])<.6)return;let T=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(T){let k=parseInt(T[1],10),E=parseInt(T[2],10),L=parseInt(T[3],10);(k>=60||E>=60||L>=60)&&(k>230&&E>230&&L>230||(k>=80||E>=80||L>=80)&&(m=!0))}}if(!m)return;let _=(s.textContent||"").trim(),u=i,x=Array.from(s.querySelectorAll("*")).map(C=>(C.className?.toString()||"").toLowerCase()).join(" "),f=_.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),g=u.includes("bg-clip-text")||u.includes("text-transparent")||x.includes("bg-clip-text")||x.includes("text-transparent"),y=Array.from(s.querySelectorAll("*")).some(C=>{let T=window.getComputedStyle(C),k=T.getPropertyValue("-webkit-background-clip")||"",E=T.getPropertyValue("background-clip")||"";return k.includes("text")||E.includes("text")});if(f||g||y){let C=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],T=k=>{C.forEach(E=>k.style.removeProperty(E))};T(s),s.querySelectorAll("*").forEach(T);return}let w="#12161D";s.style.setProperty("color",w,"important"),s.querySelectorAll("*").forEach(C=>{let T=C.tagName.toLowerCase();T==="svg"||T==="path"||T==="circle"||T==="rect"||T==="polygon"||T==="polyline"||T==="line"||T==="g"?(C.style.setProperty("fill",w,"important"),C.style.setProperty("stroke",w,"important"),C.style.setProperty("color",w,"important")):(C.style.setProperty("color",w,"important"),C.style.setProperty("-webkit-text-fill-color",w,"important"))});let $=s.className?.toString()||"<no class>";!Fd.has($)&&$!=="<no class>"&&(Fd.add($),c.debug(`Darkened SVG icons on colored button: "${$}"`))})})},zd=new Set,Tv=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(l=>{(l.getAttribute("style")||"").includes("translateY(11px)")&&l.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(l=>{let p=l;if(p.closest("[id^='ws-crm-']"))return;let m=l.getBoundingClientRect();if(m.width===0||m.width>28||m.height>28)return;let b=m.left<r.right&&m.right>r.left,_=m.top<r.bottom&&m.bottom>r.top;if(!(b&&_)||m.top+m.height/2<a)return;let x=m.width*m.height/(r.width*r.height);if(x>.55)return;let f=p,g=p.parentElement,y=0;for(;g&&g!==e&&y<3;){let $=g.getBoundingClientRect();if($.width>0&&$.width<=30&&$.height<=30)f=g;else break;g=g.parentElement,y++}f.style.setProperty("transform","translateY(11px)","important");let w=(f.className?.toString()||"")+" "+f.tagName;zd.has(w)||(zd.add(w),c.debug(`Dropped activity badge 11px (${m.width.toFixed(0)}x${m.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${w}"`))})})},Cv="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Av=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",Cv,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Nd=new Set,Lv=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),p=parseInt(i[3],10);if(!(d>200&&l>200&&p>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!Nd.has(m)&&m!=="<no class>"&&(Nd.add(m),c.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${d},${l},${p})): "${m}"`))})})},qd=new Set,Sv=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let d=o.className?.toString()||"<no class>";!qd.has(d)&&d!=="<no class>"&&(qd.add(d),c.debug(`Painted Ask AI wrapper graphite: "${d}"`))}}o=o.parentElement,r++}})},Ud=new Set,Iv=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let d=a.getBoundingClientRect();d.width<240||d.height<120||d.width>1500||d.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let d=(i.className?.toString()||"").toLowerCase();if(d.includes("avatar")||d.includes("notification-dot")||d.includes("indicator"))return;if(d.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("tabulator")||d.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(d.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let g=i.getAttribute("style")||"";(g.includes("background-color")||g.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("ai-button")||d.includes("ask-ai")||d.includes("bg-clip-text")||d.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let p=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!p)return;let m=parseInt(p[1],10),b=parseInt(p[2],10),_=parseInt(p[3],10);if(!(m>200&&b>200&&_>200))return;let x=i.getBoundingClientRect();if(x.width<24||x.height<16||x.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let f=i.className?.toString()||"<no class>";!Ud.has(f)&&f!=="<no class>"&&(Ud.add(f),c.debug(`Coerced light bg (${x.width.toFixed(0)}x${x.height.toFixed(0)}, rgb(${m},${b},${_})): "${f}"`))})})},jd=new Set,Mv=t=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";(t??document.body.querySelectorAll("*")).forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']")||r.children.length>0)return;let a=(r.textContent||"").trim();if(a.length===0||a.length>80||a==="--"||r.closest(e)||r.closest("[class*='avatar'], [class*='hr-avatar']")||r.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||r.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(r.matches("[role='heading']")||r.closest("[role='heading']")||r.matches("h1, h2, h3")||r.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){r.matches("h1, h2, h3")&&(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let $=r.getAttribute("style")||"";($.includes("color")||$.includes("background"))&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"),r.style.removeProperty("background-color"));return}if(r.closest("#SettingTexasSmsBlock")||r.matches("p.ui-text-sm-medium")&&r.parentElement?.classList?.contains("flex")&&r.parentElement?.classList?.contains("items-center")&&r.parentElement?.children?.length===1){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-button, .n-button")||r.matches(".hr-button__content, .n-button__content")||r.closest(".hr-button__content, .n-button__content")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".bg-primary-50, [class*='bg-primary-50']")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}let s=r,i=null;for(let $=0;$<4&&s;$++){let C=s.nextElementSibling;if(C&&(C.matches(e)||C.querySelector(e)!==null)){i=C;break}s=s.parentElement}if(!i)return;let d=r.getBoundingClientRect();if(d.width===0||d.height===0||d.width>400||d.height>60)return;r.style.setProperty("color","#9098A3","important"),r.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,p=l.getBoundingClientRect(),m=l.className?.toString()||"",b=m.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,_=m.includes("hl-form-item")||m.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,u=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",x=(m.includes("hr-form-item-blank")||m.includes("hr-form-item")||l.matches(u))&&(l.matches(u)||l.querySelector(u)!==null);x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=m.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let g=m.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=m.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!b&&!_&&!x&&!f&&!g&&!y&&p.width>0&&p.width<=800&&p.height>0&&p.height<=100&&(l.style.setProperty("background-color",jr,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let w=r.className?.toString()||"<no class>";!jd.has(w)&&w!=="<no class>"&&(jd.add(w),c.debug(`Colored field label "${a.slice(0,30)}": "${w}"`))})},Wd=new Set,Pv=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),d=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${d}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(p=>{p.tagName==="svg"||p.tagName==="SVG"||p.tagName!=="IMG"&&(p.style.setProperty("font-size",`${d}px`,"important"),p.style.setProperty("line-height","1","important"),p.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!Wd.has(l)&&l!=="<no class>"&&(Wd.add(l),c.debug(`Resized avatar text to ${d}px (circle ${i.toFixed(0)}px): "${l}"`))})},Gd=new Set,Ov=new Set(["Enter Dashboard Name"]),Bv=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Ov.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",jr,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",jr,"important"),a.style.setProperty("border-color","#252C36","important"));let s=e.className?.toString()||"<no class>";!Gd.has(s)&&s!=="<no class>"&&(Gd.add(s),c.debug(`Forced input slate bg: "${s}"`))})},Nr=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.id==="chat-filter"||o.id==="phone-calls"||o.id==="archive-conversation"||o.id==="star-toggle"||o.id==="read-toggle"||o.id==="delete-conversation")return;if(o.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}let r=o.className?.toString()||"";if(r.includes("bg-inherit")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.closest(".pipeline-ribbon")&&r.split(" ").includes("count")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.split(" ").includes("tabulator-page")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(u=>r.includes(u))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("schedule-ui-form-weekly-schedule-checkbox")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("border-color")||u.includes("border-style")||u.includes("border-width"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"));return}if(r.includes("n-button")&&r.includes("icon-only")&&!r.includes("quaternary")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-button--tertiary-type")||r.includes("n-button--tertiary-type")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"),o.style.removeProperty("border-radius"));return}if(r.includes("hr-data-table-td")||r.includes("hr-data-table-tr")||r.includes("hr-data-table__body-cell")||r.includes("hr-data-table__cell")||r.includes("hr-data-table__header-cell")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-data-table-td--fixed-right")||r.includes("n-data-table-td--last-col")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.classList.contains("hr-tabs")||r.includes("hr-tabs-tab-wrapper")||r.includes("hr-tabs-nav")||r.includes("hr-tabs-nav-scroll-content")||r.includes("hr-tabs-content")||r.includes("hr-tabs-pane")||r.includes("hr-tabs-rail")||r.includes("hr-tabs-wrapper")||r.includes("hr-tabs-pane-wrapper")||r.includes("hr-tab-pane")){let u=o.getAttribute("style")||"";(u.includes("background-color: rgb(26, 31, 40)")||u.includes("background-color: #1A1F28")||u.includes("background-color: #1a1f28"))&&o.style.removeProperty("background-color");return}if(r.includes("hr-date-panel")||r.includes("n-date-panel")||o.closest(".hr-date-panel, .n-date-panel")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-tag")&&r.includes("ui-default")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if((r.includes("bg-purple-50")||r.includes("bg-purple-100"))&&(r.includes("rounded-lg")||r.includes("rounded-md")||r.includes("rounded-full"))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-alert")||o.closest(".n-alert")||r.includes("hl-warning")||r.includes("hl-error")||r.includes("hl-info")||r.includes("hl-success")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-card")||o.closest(".hr-card")||o.id&&o.id.startsWith("opportunity-")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("bg-gray-50")||r.includes("bg-gray-100")||r.includes("bg-gray-200")||r.includes("bg-white")||r.includes("bg-blue-50")||r.includes("bg-blue-100")||r.includes("bg-sky-50")||r.includes("bg-indigo-50")||r.includes("bg-slate-50")||r.includes("bg-neutral-50")||r.includes("bg-zinc-50")||r.includes("bg-stone-50")||r.includes("F7F9FD")||r.includes("F9FAFB")||r.includes("ECEEF2")||r.includes("eceef2")||r.includes("EFF4FF")||r.includes("eff4ff")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-collapse-item")||r.includes("hr-collapse hr-accordion")||r.includes("hr-accordion"))return;if(r.includes("sidebar-option-button")||o.closest(".sidebar-option-button")||o.closest("nav[class*='w-13']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),p=parseInt(i[3],10);if(!(d<_v&&l<vv&&p<yv))return;let b=o.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;o.style.setProperty("background-color",jr,"important");let _=o.className?.toString()||"<no class>";!Bd.has(_)&&_!=="<no class>"&&(Bd.add(_),c.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${d},${l},${p})): "${_}"`))})},qr=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1"),s.setAttribute("data-reos-recolored-v3","1");let d=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!d)return;let l;try{l=atob(d[1])}catch{return}let p=l,m=!1;if(e.forEach(u=>{p.includes(u)&&(p=p.split(u).join(t),m=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{p.includes(u)&&(p=p.split(u).join("transparent"),m=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(x=>{p.includes(x)&&(p=p.split(x).join("#EDEEF0"),m=!0)}),!!m)try{let u=btoa(p);s.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let d=`url("${i}")`;s.style.setProperty("-webkit-mask-image",d,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",d,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",o)})},Ao=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Rv=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Ie=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let d=window.getComputedStyle(i).backgroundColor;d==="rgba(0, 0, 0, 0)"||d==="transparent"||!d||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let s="rgb(150, 162, 173)",i="rgb(0, 191, 124)",d=p=>{let m=r.querySelector(".ui-upload-icon svg");m&&(m.style.setProperty("color",p,"important"),m.style.setProperty("stroke",p,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(b=>{b.style.setProperty("stroke",p,"important")})},l=!1;try{l=r.matches(":hover")}catch{}d(l?i:s),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>d(i)),r.addEventListener("mouseleave",()=>d(s)))})},Ka=new WeakSet,Hv=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Ka.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Ka.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Bo}`,t.title=`Built ${Ro}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var Za="https://services.leadconnectorhq.com",Qd="__WS_CRM_CAPTURED_AUTH";var Nv=()=>{try{let t=localStorage.getItem(Qd);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(Qd),null):e:null}catch{return null}},qv=()=>{let t=Nv();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},Xa=async(t,e={})=>{let o=qv();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var nc=new Set(["ej0SqnTYIprechAMAPrd"]),Pe="contact-select-trigger",ac="ws-crm-reply-from-warning",sc="contact-select-menu",Zd="ws-crm-rf-thread-opt",ts="",es=!1,So=null,Gr=null,Xd=!1,Io="",tc,Wt=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},os=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},$t=t=>(t||"").replace(/\D/g,"").slice(-10),ec=t=>{let e=$t(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Uv=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},jv=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=J();if(!r)return null;let a=await Xa(`${Za}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return Wt("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Wv=async()=>{let t=await jv();if(!t)return null;let e=await Xa(`${Za}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return Wt("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Uv(a);if($t(s).length===10)return s}return null},Oe=()=>document.getElementById(ac)?.remove(),ic=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Gv=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),lc=(t,e,o)=>{Oe();let r=document.getElementById(Pe);if(!r)return;let a=ic(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=ac,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Gv(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${ec(t)}</span>${i}. You're set to reply from ${ec(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Kv=t=>{So?.disconnect();let e=document.getElementById(Pe);if(!e)return;let o=ic(e)||e,r=$t(os(e));So=new MutationObserver(()=>{let a=os(document.getElementById(Pe)),s=$t(a);!s||s===r||(r=s,s===$t(t)?Oe():lc(t,"",a))}),So.observe(o,{childList:!0,subtree:!0,characterData:!0})},oc=()=>{let t=document.getElementById(sc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Io&&(r=e.find(d=>$t(o(d))===$t(Io))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),Wt("decorateMenu: cache=",Io,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(Zd);s&&s!==r&&s.removeAttribute("id"),r.id=Zd;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Vv=()=>{if(!nc.has(J()||""))return;Gr?.disconnect();let t=0,e=()=>{let o=document.getElementById(sc);if(o){oc(),Gr=new MutationObserver(()=>oc()),Gr.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Yv=t=>{let e=t.target;e&&e.closest&&e.closest("#"+Pe)&&(Wt("From trigger clicked -> waiting for menu"),Vv())},Jv=async()=>{if(!es){es=!0;try{let t=document.getElementById(Pe);if(!t)return;let e=os(t),o=await Wv();if(Io=o||"",Wt("check: from=",e,"thread=",o),!o){Oe();return}$t(e)&&$t(e)!==$t(o)?(Wt("MISMATCH -> banner"),lc(o,"",e)):(Wt("match -> no banner"),Oe()),Kv(o)}finally{es=!1}}},rc=()=>{if(!nc.has(J()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){ts="",Io="",So?.disconnect(),Gr?.disconnect(),Oe();return}let e=!!document.getElementById(Pe),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==ts){if(ts=r,!e){So?.disconnect(),Oe();return}Wt("composer expanded on",o),Jv()}},dc=()=>{tc===void 0&&(tc=window.setInterval(rc,500)),Xd||(document.addEventListener("click",Yv,!0),Xd=!0),rc()};var Qv="#1A1F28",Zv="#EDEEF0",rs="#9098A3",Xv=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},ty=t=>.2126*t.r+.7152*t.g+.0722*t.b,ey=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,p=0;return d!==0&&(p=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,p)*100)}%, 60%)`},cc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},oy=t=>{let e=Xv(getComputedStyle(t).backgroundColor);if(!e||ty(e)<120)return;let o=ey(e);t.style.setProperty("background-color",Qv,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),cc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Zv),cc(t,"#note-date-added-text, [class*='475467']",rs)},ry=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",rs,"important"),e.style.setProperty("-webkit-text-fill-color",rs,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},pc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)oy(t[e]),ry(t[e])},mc,bc=()=>{mc===void 0&&(mc=window.setInterval(pc,700)),pc()};var ny='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',hc=()=>{document.querySelectorAll(ny).forEach(t=>{t.setAttribute("autocomplete","off")})},uc,_c=()=>{uc===void 0&&(uc=window.setInterval(hc,1e3)),hc()};console.log("[ws-crm-customizer] bundle-loaded");var A=(t,e)=>{try{c.debug(`[main] calling ${t}`),e(),c.debug(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},vc=()=>{c.info(`Loaded v${Bo} (built ${Ro})`),Jr()?(c.info(`[main] excluded location ${J()} \u2014 theme only, skipping feature mounts`),A("mountThemeStylesheet",Lo),A("mountDialerThemeFix",Er)):(A("mountVersionBadge (initial)",Wr),A("mountFavicon",ti),A("mountThemeStylesheet",Lo),A("mountHideLaunchpad",Nn),A("mountHideNavItems",qn),A("mountRelabelNav",Un),A("mountHideTopmenuTabs",Wn),A("mountContractsSection",jn)),A("installOppIdCapture",ps),A("initPageRouter",is),c.info("[main] registering onPageChange subscriber"),_t(e=>{if(c.debug(`[main] onPageChange callback fired for page=${e}`),Jr()){c.info(`[main] page change into excluded location ${J()} \u2014 theme only, skipping feature mounts`),A("mountThemeStylesheet",Lo),A("runThemeFastPass",Qa),A("mountDialerThemeFix",Er),A("unmountContactMapLinks",ki);return}A("mountThemeStylesheet",Lo),A("runThemeFastPass",Qa),A("mountVersionBadge",Wr),A("mountHideLaunchpad",Nn),A("mountHideNavItems",qn),A("mountRelabelNav",Un),A("mountHideTopmenuTabs",Wn),A("mountContractsSection",jn),A("mountClaimReleaseToggle",zs),A("mountContactActionsBar",Zs),A("mountActiveFollowUpButton",ys),A("mountMtOfferMadeButton",ni),A("mountNotInterestedButton",ai),A("mountScheduleWalkthroughButton",si),A("mountResendDealLinkButton",li),A("mountReducePriceButton",ci),A("mountEditLandingPageButton",pi),A("mountPublishButton",hi),A("mountContactMapLinks",wi),A("mountSendToClosingOfficeButton",Hi),A("mountOppActionBar",Xi),A("mountClosingAgentPickerButton",Zl),A("mountPrepareContractButton",vd),A("mountComputeOfferButton",Ld),A("mountManageTeam",rd),A("mountBuyBoxWidget",Es),A("mountSellerContactFlag",Rs),A("mountPropertiesWidget",Os),A("mountSupportNavItem",il),A("mountPhoneAssignmentsWidget",bl),A("mountBulkPowerDialer",Pl),A("mountBulkPowerDialerContacts",Rl),A("mountCallingAsChip",zl),A("mountDialerThemeFix",Er),A("mountReplyFromWarning",dc),A("mountNoteCanon",bc),A("mountSuppressAutofill",_c)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",vc):vc();})();
