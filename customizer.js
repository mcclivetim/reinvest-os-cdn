...
`;var sd=/^[A-Za-z0-9]{15,30}$/,vt=t=>typeof t=="string"&&sd.test(t),Ma=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ld=()=>{let t=window.WS_CRM_USER_ID;return vt(t)?t:null},dd=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(vt(o))return o;return null},cd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ma(e);if(!o)return null;let r=o.uid;if(vt(r))return r;let a=o.claims;if(a&&vt(a.user_id))return a.user_id}catch{}return null},pd=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(vt(a))return a}catch{}}}catch{}return null},M=()=>ld()||dd()||cd()||pd()||null,bd=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ma(e);return o?o.claims??o:null}catch{return null}},me=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:bd()?.type==="agency"};var Pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",md=`${Pa}/active-follow-up-get`,hd=`${Pa}/active-follow-up-set`,He="ws-crm-active-follow-up-button",kr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ud=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},vd=async t=>{let e=await fetch(md,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},_d=async(t,e)=>{let o=await fetch(hd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Pe=(t,e)=>{let o=kr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Oa=t=>{let e=document.createElement("button");return e.type="button",e.id=He,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,Pe(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ud();if(!(!r||r.contactId!==t)){Pe(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await _d(r,M()),i=a&&a.state&&a.state in kr?a.state:"blue";Pe(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Pe(e,"error"),setTimeout(()=>void co(e,r),4e3)}}}),e},co=async(t,e)=>{Pe(t,"loading");try{let o=await vd(e),r=o&&o.state&&o.state in kr?o.state:"gray",a=document.getElementById(He);if(!a||a.dataset.contactId!==e.contactId)return;Pe(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Pe(t,"error")}},gd=[".central-panel","[class*='central-panel']"],wr="ws-crm-contact-actions-bar",yd=async()=>{for(let t of gd)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},fd=async(t,e)=>{let o=e.querySelector(`#${wr}`);if(!o)try{o=await I(`#${wr}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,he(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await nb(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},he(o,a);return}if(f.rate_limited){_=Date.now()+m,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},he(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},he(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let g=f.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Ro.add(t),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe(),Ft();return}let w=f.checks;if(a.checks&&a.checks.length===f.checks.length){let S=new Set;w=f.checks.map((E,y)=>a.checks[y]?.filled&&!E.filled?i.has(E.label)?E:(S.add(E.label),{...E,filled:!0}):E),i=S}else i=new Set;a={status:w.every(S=>S.filled)?"ready":"incomplete",checks:w,previouslySentAt:f.previously_sent_at??null},rb(t,{checks:w,previously_sent_at:f.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),he(o,a),document.getElementById(Po)&&Do(w,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},he(o,a),pe();try{let g=await ab(t,e,f);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},he(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},he(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},he(o,a),g.checks&&Do(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},he(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Po)?pe():a.checks&&Do(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),h=1e4,m=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let C=Date.now()-b,S=Math.max(1500,h-C);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=C=>{let S=C.detail;if(!S||S.oppId!==t)return;Bi(t);let E=0,y=()=>{if(p&&E<8){E+=1,window.setTimeout(y,500);return}x()};y()};window.addEventListener(yn,g);let w=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.removeEventListener(yn,g),window.clearInterval(w))},5e3)}return o},db=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cb=async()=>{for(let t of db)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ro=new Set,Hi=null,pb=t=>{t&&t!==Hi&&(Ro.clear(),Hi=t)},Ho=!1,wn=async()=>{if(Ho){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ho=!0;try{await bb()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{Ho=!1}},bb=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Bo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),pb(t.oppId),Ro.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Re)?.remove(),pe(),Ft());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Re)?.remove(),pe()),c.debug("[stc] mount:04 calling findMountTarget");let o=await cb();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Bo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=lb(t.oppId,a.locationId),s=document.createElement("span");s.id=Re,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),mb(t.oppId)},Rt=null,fn=null,Ft=()=>{Rt?.disconnect(),Rt=null,fn=null},mb=t=>{if(Rt&&fn===t)return;Ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(fn=t,Rt=new MutationObserver(()=>{let o=Bo();if(!o||o.oppId!==t){Ft();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Ee)?.remove(),document.getElementById(Re)?.remove(),pe(),Ft();return}document.getElementById(Ee)||wn()}),Rt.observe(e,{childList:!0,subtree:!0}))},_n=null,gn,hb=()=>{_n||(_n=new MutationObserver(()=>{gn===void 0&&(gn=window.setTimeout(()=>{gn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ee);if(t&&!e&&!Ho){let o=Bo();if(o&&Ro.has(o.oppId))return;wn()}},300))}),_n.observe(document.body,{childList:!0,subtree:!0}))},Fi=()=>{hb(),wn()};var Tn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ub=`${Tn}/tc/welcome-call-prefill`,vb=`${Tn}/tc/welcome-call-save`,_b=`${Tn}/tc/order-lockbox`,Nt="ws-crm-welcome-call-overlay",gb=["Regular Contract","Subject To","Seller Finance","Novation"],yb=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],fb=["Gas","Electric","Propane","Oil"],xb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],wb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Te=["Yes","No"],kb=["Yes","No","Unknown"],Eb=["Professional Photographer","Seller","Tenant"],Tb=["Month-to-Month","Annual"],Ni=["Current","Behind"],Sb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ue=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),No=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,qi="margin-bottom:12px;",Ui=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Cb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,zi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=zi(o);return`<select id="${t}" style="${No}"><option value=""></option>${e.map(a=>`<option ${r!==""&&zi(a)===r?"selected":""}>${ue(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${ue(e)}" placeholder="${ue(o)}" style="${No}">`,Ab=(t,e)=>`<textarea id="${t}" rows="3" style="${No}resize:vertical;">${ue(e)}</textarea>`,Lb=(t,e)=>`<input id="${t}" type="date" value="${ue(e)}" style="${No}">`,D=(t,e)=>`<div style="${qi}"><label style="${Ui}">${ue(t)}</label>${e}</div>`,kn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Sb.map(r=>`<label style="${Cb}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ye=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ue(t)}</div>`,ot=()=>{document.getElementById(Nt)?.remove()},Fe=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$b=t=>{let e=t.tenant||{};return`
    ${ye("Identifiers")}
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${Ne(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${Ne(o)}</div>`:""}
  ...
  `;let s=l=>`
    <button type="button" data-category="${Ne(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Ne(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Ne(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Ne(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(ns,r.submitterName),localStorage.setItem(as,r.submitterEmail),r.submitterRole&&localStorage.setItem(is,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let m=await(await fetch(Qb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!m.ok){d(m.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=m.ticket_short_id||"submitted";em(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},om=["/support-ticket","ws-support-modal","ws-support"],rm=/\/custom-menu-link\//,Pn=!1,ss=()=>{if(Pn||!rm.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return om.some(s=>i.includes(s))});if(r){Pn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{tm(),Pn=!1},50);return}t<10&&setTimeout(e,150)};e()},ls=!1,ds=()=>{ls||(ls=!0,ne(()=>setTimeout(ss,50)),ss(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var cs="ws-phone-assignments-modal",ps="ws-phone-assignments-toast",nm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",am="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",im=["ACQ","DISPO","TC"],hs="",Ae=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),sm=(t,e="success",o)=>{document.getElementById(ps)?.remove();let r=document.createElement("div");r.id=ps;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Ae(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Ae(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},lm=(t,e,o)=>{let r=[`<option value="" ${o===hs?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Ae(a)}" ${o===a?"selected":""}>${Ae(a)}</option>`)].join("");return`<select data-assign="${Ae(t)}" style="
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",m=>{m.target===o&&o.remove()}),!e){let m=r.querySelector("#ws-pa-body");m&&(m.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${nm}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(m){c.error("[phone-assignments] GET failed",m);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Ae(m.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:im,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=m=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${m} found.</div>`,p=s.length?s.map(m=>`<div style="${dm}">
  ...
  `;let r={status:"loading"};Le(o,r);let a=Zs(t);return a&&(r={status:"linked",contactName:a.contactName},Le(o,r),Ue={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Wm(t,e);s?(r={status:"linked",contactName:s.name},Le(o,r),Ue={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},ta(s.id,s.name,e)):a||(r={status:"empty"},Le(o,r),Ue?.oppId===t&&(Ue=null),Ym(),Km(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Xm({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Le(o,r);try{let l=await Ys({tenantId:e,oppId:t,fieldKey:Xs,value:s.id});if(!l.ok)throw new Error(l.error??"Save failed");s.companyName&&s.companyName.trim()&&await Ys({tenantId:e,oppId:t,fieldKey:qm,value:s.companyName.trim()}),r={status:"linked",contactName:s.name},Le(o,r),Ue={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},el(t,s.id,s.name),ta(s.id,s.name,e),Ri(t),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Le(o,r)}}})}),o},Zm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],eh=async()=>{for(let t of Zm)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Wt=!1,Jo=async()=>{if(!Wt){Wt=!0;try{await th()}finally{Wt=!1}}},th=async()=>{let t=Kt();if(!t||!t.locationId){document.getElementById(be)?.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo();return}let e=document.getElementById(be);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove(),Yo());return}e&&(e.remove(),document.getElementById(`${be}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await eh();if(!r||!(Zs(t.oppId)!==null||Ue!==null&&Ue.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Kt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Qm(t.oppId,i.locationId),l=document.createElement("span");l.id=`${be}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),oh(t.oppId),ia(i.locationId)},jt=null,oa=null,ra=null,Yo=()=>{jt?.disconnect(),jt=null,oa=null,ra=null},oh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jt&&oa===t&&ra===e||(Yo(),oa=t,ra=e,jt=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t||!o.locationId){Yo();return}document.getElementById(be)||Jo(),ia(o.locationId)}),jt.observe(e,{childList:!0,subtree:!0})))},Qn=null,Zn,rh=()=>{Qn||(Qn=new MutationObserver(()=>{Zn===void 0&&(Zn=window.setTimeout(()=>{Zn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(be);t&&!e&&!Wt&&Jo()},300))}),Qn.observe(document.body,{childList:!0,subtree:!0}))},Js,nh=()=>{Js===void 0&&(Js=window.setInterval(()=>{let t=Kt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(be)&&!Wt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Jo()),ia(t.locationId)},2e3))},ol=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),rh(),nh(),Jo()};var ah="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ie="ws-crm-manage-team-cta",rl="ws-crm-manage-team-modal",ih=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,nl={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},sh={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},al=()=>{let t=window.location.pathname.match(ih);return t?{tenantId:t[1]}:null},Qo=async t=>{let e=await fetch(ah,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ie=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$e=t=>ie(t),sa="ws-crm-manage-team-toast",ca=(t,e="info",o=4e3)=>{document.getElementById(sa)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=sa,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `},dh=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>lh(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${$e(t.email)}" data-user-id="${$e(t.id)}" data-name="${$e(o)}" data-current-roles="${$e(t.role_keys.join(","))}" style="${O} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${$e(t.email)}" data-name="${$e(o)}" data-role-count="${$e(String(t.role_keys.length))}" style="${O} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},ch=(t,e)=>t.length===0?`
  ...
  `,e.addEventListener("click",()=>{Zo(t)}),Xo(e),setTimeout(()=>Xo(e),200),setTimeout(()=>Xo(e),800),window.addEventListener("resize",()=>Xo(e)),e},da=!1,wh=()=>{if(!da){da=!0;try{let t=al();if(!t){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}let e=document.getElementById(Ie);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ie}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ie}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=xh(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{da=!1}}},il=()=>{if(!al()){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}wh()};var kh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ma="ws-crm-prepare-contract-button",sl="ws-crm-prepare-contract-menu",_e="ws-crm-prepare-contract-modal",ll="ws-crm-modal-date-style",fe="https://services.leadconnectorhq.com",hl=()=>{if(document.getElementById(ll))return;let t=document.createElement("style");t.id=ll,t.textContent=`
  ...
  `,document.head.appendChild(t)},ha="__WS_CRM_CAPTURED_AUTH",Eh=50*60*1e3,rr=()=>{try{let t=localStorage.getItem(ha);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Eh?(localStorage.removeItem(ha),null):e:null}catch{return null}},Th=t=>{try{localStorage.setItem(ha,JSON.stringify(t))}catch{}},st=()=>{let t=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},dl=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((rr()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),it=async(t,e={},o=2)=>{let r=rr()?.capturedAt??0,a;try{a={...st(),...e.headers??{}}}catch(s){if(o>0&&await dl(r,4e3))return it(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await dl(r,4e3)?it(t,e,o-1):i},cl=!1,Sh=()=>{if(cl)return;cl=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,m=rr()?.authorization;Th({authorization:b,tokenId:h,capturedAt:Date.now()}),m!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let h={};if(b instanceof Headers)b.forEach((m,_)=>h[_.toLowerCase()]=m);else if(Array.isArray(b))b.forEach(([m,_])=>h[m.toLowerCase()]=_);else if(b&&typeof b=="object")for(let m of Object.keys(b))h[m.toLowerCase()]=b[m];e(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ul=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ch=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ul()},Ah=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},vl="__WS_CRM_TEMPLATES_CACHE_V1",Lh=24*60*60*1e3,pl=t=>{try{let e=window.localStorage.getItem(vl);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Lh?null:o.templates}catch{return null}},$h=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(vl,JSON.stringify(o))}catch{}},Ih=async t=>{let e=`${fe}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await it(e,{method:"GET"})}catch(s){let l=pl(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=pl(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:Ah(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&$h(t,i),i},Mh=async(t,e)=>{let o=await it(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await it(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},Oh=async(t,e)=>{let o=await it(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:st()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Dh=async t=>{let e=await fetch(kh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Hh=async(t,e,o)=>{let r=`${fe}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:st()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Ph=async(t,e)=>{let o=await fetch(`${fe}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:st()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Bh=async t=>{let e=await fetch(`${fe}/contacts/${t}`,{method:"GET",headers:st()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Rh=async(t,e,o,r)=>{let a;try{a=await Ph(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Bh(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},m=await fetch(`${fe}/proposals/document/${e}`,{method:"PUT",headers:{...st(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!m.ok){let _=await m.text().catch(()=>"");return{ok:!1,status:m.status,body:_}}return{ok:!0}},Fh=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},tr="__WS_CRM_PENDING_INSTRUCTIONS",Nh=60*1e3,zh=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Gh=t=>{let e=(t||"").toLowerCase();for(let o of zh)if(e.includes(o.matches.toLowerCase()))return o;return null},qh=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(tr,JSON.stringify(r))}catch{}},Uh=()=>{try{let t=localStorage.getItem(tr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Nh?(localStorage.removeItem(tr),null):e}catch{return null}},Vh=()=>{try{localStorage.removeItem(tr)}catch{}},Wh=(t,e)=>{document.getElementById(_e)?.remove();let o=document.createElement("div");o.id=_e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},ml=(t,e)=>new Promise(o=>{document.getElementById(_e)?.remove();let r=document.createElement("div");r.id=_e,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,P=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${ve(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${y}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ve(s)}" placeholder="Seller name" style="${C}" />
      </div>
      <div style="${y}">
      ...
      <div style="${y}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ve(b)}" placeholder="e.g. 30" style="${C}" />
      </div>
      <div style="${y}">
        <div style="${w}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${ve(h)}" placeholder="e.g. 10" style="${C}" />
      </div>
      <div style="${y}">
  ...
  `,f.appendChild(g),document.body.appendChild(f);let q=g.querySelector("#ws-pc-purchase-price"),z=g.querySelector("#ws-pc-emd"),N=g.querySelector("#ws-pc-cash-at-close"),B=!1;N?.addEventListener("input",()=>{B=!0});let xe=()=>{if(B)return;let V=Number(q?.value||0),J=Number(z?.value||0);N&&(N.value=String(Math.max(0,V-J)))};q?.addEventListener("input",xe),z?.addEventListener("input",xe);let we=()=>f.remove();f.addEventListener("click",V=>{V.target===f&&we()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",we);let ee=g.querySelector("#ws-pc-submit"),oe=g.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){oe&&(oe.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let V=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(q?.value||0),ct=Number(z?.value||0),pt=Number(N?.value||0),bt=(g.querySelector("#ws-pc-days-to-close")?.value??"").trim(),mt=(g.querySelector("#ws-pc-inspection-days")?.value??"").trim(),ht=(g.querySelector("#ws-pc-additional-terms")?.value??"").trim(),je=(g.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),ut=(g.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),ct!==d&&(X.emd=ct),pt!==p&&(X.cashAtClose=pt),bt!==b&&(X.daysToClose=bt),mt!==h&&(X.inspectionDays=mt),ht!==m&&(X.additionalTerms=ht),je!==_&&(X.currentOccupancy=je),ut!==x&&(X.occupancyAtClose=ut),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),ee.textContent="Saving\u2026";let hr=M(),ur=await or({tenantId:t,contactId:e,template:o,userId:hr,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",ur),ee.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await _a(t,e,o,Q)}catch(V){ee.disabled=!1,ee.textContent="Open Contract",oe&&(oe.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},Jh=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(_e)?.remove(),hl();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",h=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,m=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",g=s,w=l,C="",S=document.createElement("div");S.id=_e,S.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${ve(f)}" placeholder="Buyer's entity / LLC name" style="${T}" />
      </div>
      <div style="${q}">
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){du(o,s.properties,l=>{a(!0),ya({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?kl(e,d.property_record_id,d):nr(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),nr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?kl(e,s.property_record_id,s):nr(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await ya({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),nr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},cu=async()=>{for(let t of su)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Tl=async(t,e)=>{let o=e.querySelector(`#${fl}`);if(!o)try{o=await I(`#${fl}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Sl=()=>{let t=document.querySelectorAll(`#${We}`);for(let e=1;e<t.length;e++)t[e].remove()},pu=async()=>{let t=R();if(!t||!t.locationId||t.source!=="url"){document.getElementById(We)?.remove(),lt();return}let e=t.locationId,o=document.getElementById(We);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),lt();let r="seller";try{r=Ye(await Ke(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(We)?.remove();return}let a=await cu();if(!a){c.warn("[compute-offer] no central panel found");return}let i=R();if(!i||i.contactId!==t.contactId)return;let s=El(t.contactId,e);if(!await Tl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}Sl(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(R()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(We)){let d=El(t.contactId,e);Tl(d,a).then(()=>Sl())}});l.observe(a,{childList:!0})},Qt=null,Il=()=>{let t=R()?.contactId??null;if(Qt&&Qt.id===t)return;let e=pu().finally(()=>{Qt?.promise===e&&(Qt=null)});Qt={id:t,promise:e}};var oo="reos-theme-stylesheet",Ta="reos-theme-fonts",dt=!1,bu=()=>{let t=document.getElementById(Ta);t&&t.remove()},mu=`
/* ============================================
