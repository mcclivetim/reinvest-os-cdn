...
`;var I="ws-crm-claim-release-pill",re=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},De=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=I,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",a=e==="claim"?l.emerald:l.amber;return t.style.cssText=te(r),t.innerHTML=`
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,$e.forEach(a=>{let i=document.createElement("button");i.type="button",i.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,i.innerHTML=`
      ...
      "></span>
      <span>${a.label}</span>
    `,i.addEventListener("mouseenter",()=>{i.style.background=l.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async()=>{b.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${o}`);let s=t.firstElementChild,n=t.children[1],d=t.children[2];s&&(s.style.background=j[a.color]),n&&(n.textContent=a.label),r.style.display="none";let p=E()?.locationId,m=Be();if(!p){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),n&&(n.textContent=`${a.label} (no tenant!)`),n&&(n.style.color=l.amber);return}if(a.color==="green"&&!m){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),n&&(n.textContent=`${a.label} (no user!)`),n&&(n.style.color=l.amber);return}let h=d?.textContent??"\u25BE",x=async g=>{d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await Oe({contactId:o,locationId:p,status:a.label,userId:m,deadReason:g}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=h),t.style.opacity="1"},900)}catch(u){b.warn("Call Status webhook failed:",u),d&&(d.textContent="\u2717"),n&&(n.style.color=l.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=h),n&&(n.style.color=l.bone)},1800)}};if(a.value==="dead-deal"){let g=n?.textContent??"";qe(u=>{x(u)},()=>{n&&(n.textContent=g)});return}if(a.value==="appointment-booked"){let g=n?.textContent??"";try{(await Pe({contactId:o,tenantId:p})).ok?await x():je(()=>{x()},()=>{n&&(n.textContent=g)})}catch(u){b.warn("Appointment sanity check failed; firing anyway:",u),await x()}return}await x()}),r.appendChild(i)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{e.contains(a.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},We=o=>{document.getElementById(ne)?.remove();let e=document.createElement("div");e.id=ne,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let a=()=>t.remove(),i=()=>{a(),e()};t.addEventListener("click",n=>{n.target===t&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),o()});let s=n=>{n.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},le=o=>{let e=document.createElement("div");e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    flex-shrink: 0;
  `,e.appendChild(ze(o));let t=document.createElement("button");return t.type="button",t.style.cssText=A,t.textContent="Offer Made",t.addEventListener("click",()=>We(o)),e.appendChild(t),e},Ke=async()=>{let o=E();if(!o){document.getElementById(O)?.remove();return}let e=document.getElementById(O);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await Ue();if(!t){b.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=E();if(!r||r.contactId!==o.contactId)return;let a=le(o.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),b.debug(`Mounted contact actions bar for ${o.contactId}`);let i=null;i=new MutationObserver(()=>{let s=document.getElementById(O);if(!(E()?.contactId===o.contactId)){i?.disconnect();return}if(!s){let d=le(o.contactId);d.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),b.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),i.observe(t,{childList:!0})},de=()=>{Ke()};var P="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Xe=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),D="data-ws-crm-favicon",K=o=>o.hasAttribute(D),ce=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Xe.has(e)},G=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ce(r)&&!K(r)&&r.remove()});let e=document.head.querySelector(`link[${D}="1"]`);e?e.href!==P&&(e.href=P):(e=document.createElement("link"),e.setAttribute(D,"1"),e.rel="icon",e.type="image/png",e.href=P,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${D}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(D,"apple"),t.rel="apple-touch-icon",t.href=P,document.head.appendChild(t))},be=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)G();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),G())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&ce(s)&&!K(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&K(s)&&(a=!0)});a&&G()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,G(),e>=5&&window.clearInterval(t)},1e3)};var z="reos-theme-stylesheet",Y="reos-theme-fonts",Ye=()=>{if(document.getElementById(Y))return;let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com",document.head.appendChild(o);let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.gstatic.com",e.crossOrigin="anonymous",document.head.appendChild(e);let t=document.createElement("link");t.id=Y,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},Je=`
/* ============================================
...
/* 18a-modal-element-boxes (v0.8.75). Inside .hl-modal / .n-card, the
   form fields and alert panels were getting an inline steel border
   painted around each whole field (from our coercer remapping
   GHL's original gray-200 inline border). With the dark-theme bg
   contrast, those steel-on-graphite boxes read as "thin steel
   line around each element" \u2014 cheap-looking against an already
   well-separated layout (each component already has its own
   visual padding / typography).

   Strip the box border on:
     .n-form-item-blank   (form-field wrapper, non-error)
     .n-select.hl-select  (select wrapper)
     .n-alert             (Important Notice + similar callouts)
   Preserve the error-state border (red) by excluding
   .n-form-item-blank--error from the removal. */
html body .n-card .n-form-item-blank:not(.n-form-item-blank--error):not(#__reos_never_id),
html body .n-modal .n-form-item-blank:not(.n-form-item-blank--error):not(#__reos_never_id),
html body .hl-modal .n-form-item-blank:not(.n-form-item-blank--error):not(#__reos_never_id),
html body .n-card .n-select.hl-select:not(.n-select--error):not(#__reos_never_id),
html body .n-modal .n-select.hl-select:not(.n-select--error):not(#__reos_never_id),
html body .hl-modal .n-select.hl-select:not(.n-select--error):not(#__reos_never_id),
html body .n-card .n-alert:not(#__reos_never_id),
html body .n-modal .n-alert:not(#__reos_never_id),
html body .hl-modal .n-alert:not(#__reos_never_id) {
  border: none !important;
  border-width: 0 !important;
  border-color: transparent !important;
  box-shadow: none !important;
}
/* The .n-alert internal __border overlay also paints a stripe. */
html body .n-card .n-alert .n-alert__border:not(#__reos_never_id),
html body .n-modal .n-alert .n-alert__border:not(#__reos_never_id),
html body .hl-modal .n-alert .n-alert__border:not(#__reos_never_id) {
  border: none !important;
  border-color: transparent !important;
  box-shadow: none !important;
}
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Fe=()=>{b.info(`Loaded v${R} (built ${B})`),be(),Ee(),ee(),Q(o=>{b.debug("Page handler firing for:",o),Se(),ae(),de()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fe):Fe();})();
