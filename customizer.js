/* Wholesaling CRM Customizer v0.13.72 — built 2026-05-27T23:01:20.271Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var pe="[wholesaling-crm-customizer]",Fo="__WS_CRM_DEBUG",Mo=()=>!!window[Fo],b={info(...o){console.log(pe,...o)},warn(...o){console.warn(pe,...o)},error(...o){console.error(pe,...o)},debug(...o){Mo()&&console.log(pe,"[debug]",...o)}};var Et=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ze=/\/v2\/location\/([A-Za-z0-9]+)/,Do=o=>{let e=o.match(Et);if(!e)return null;let t=o.match(ze);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Oo=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Et);if(!n)continue;let a=r.match(ze)||window.location.pathname.match(ze);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Do(window.location.pathname);return o||Oo()};var Tt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ue="",We=null,W="other",je=new Set,me=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ue)&&!(o!==We))){ue=window.location.pathname,We=o,W=Tt(),b.debug("Page/context changed:",W,ue,"contact:",o);for(let r of je)try{r(W)}catch(n){b.error("Subscriber threw:",n)}}},St=o=>(je.add(o),setTimeout(()=>o(W),0),()=>{je.delete(o)}),Ct=()=>{W=Tt(),ue=window.location.pathname,We=S()?.contactId??null,b.debug("Router init, current page:",W);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),me()},history.replaceState=function(t,r,n){e(t,r,n),me()},window.addEventListener("popstate",me),setInterval(me,1e3)};var _e="0.13.72",ve="2026-05-27T23:01:20.272Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let l=n.querySelector(o);if(l){a(l);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var i={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ke={purple:"#8B5CF6",green:i.emerald,orange:i.amber,red:i.crimson},It=o=>{let e=o==="emerald"?i.emeraldGlow:o==="amber"?i.amberGlow:i.slate,t=o==="emerald"?i.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":i.steel,r=o==="emerald"?i.emerald:o==="amber"?i.amber:i.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var Ho=/^[A-Za-z0-9]{15,30}$/,X=o=>typeof o=="string"&&Ho.test(o),Po=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},No=()=>{let o=window.WS_CRM_USER_ID;return X(o)?o:null},Bo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(X(t))return t;return null},Ro=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Po(e);if(!t)return null;let r=t.uid;if(X(r))return r;let n=t.claims;if(n&&X(n.user_id))return n.user_id}catch{}return null},$o=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(X(n))return n}catch{}}}catch{}return null},L=()=>No()||Bo()||Ro()||$o()||null;var Mt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Go=`${Mt}/active-follow-up-get`,Uo=`${Mt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",Xe={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},Vo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},qo=async o=>{let e=await fetch(Go,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},zo=async(o,e)=>{let t=await fetch(Uo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},q=(o,e)=>{let t=Xe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Lt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,q(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Vo();if(!(!r||r.contactId!==o)){q(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await zo(r,L()),a=n&&n.state&&n.state in Xe?n.state:"blue";q(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),q(e,"error"),setTimeout(()=>void ye(e,r),4e3)}}}),e},ye=async(o,e)=>{q(o,"loading");try{let t=await qo(e),r=t&&t.state&&t.state in Xe?t.state:"gray",n=document.getElementById(V);if(!n||n.dataset.contactId!==e.contactId)return;q(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),q(o,"error")}},Wo=[".central-panel","[class*='central-panel']"],Ye="ws-crm-contact-actions-bar",jo=async()=>{for(let o of Wo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ko=async(o,e)=>{let t=e.querySelector(`#${Ye}`);if(!t)try{t=await C(`#${Ye}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Ye}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Yo=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Xo=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Jo=async o=>{if(o==="url"){let t=await jo();return t?{kind:"contact-detail",target:t}:null}let e=Yo();return e?{kind:"conversations",target:e}:null},At=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await Ko(o,e.target);return t}return Xo(o,e.target),"conversations-header"},Zo=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(V)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(V);if(t&&t.dataset.contactId===e.contactId){ye(t,e);return}t&&t.remove();let r=await Jo(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=Lt(e.contactId),s=await At(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),Ft();let l=document.getElementById(V)??a;ye(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(V);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Lt(e.contactId);At(m,r).then(()=>{Ft(),ye(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},J=null,Dt=()=>{let o=S()?.contactId??null;if(J&&J.contactId===o)return;let e=Zo().finally(()=>{J?.promise===e&&(J=null)});J={contactId:o,promise:e}},Ft=()=>{let o=document.querySelectorAll(`#${V}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",Qo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",er="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",tr=async o=>{let e=await fetch(Qo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},or=async o=>{let e=await fetch(er,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Pt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},j=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?i.emerald:i.amber;o.dataset.mode=e,o.style.cssText=It(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=i.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=s.firstElementChild,m=s.children[1],h=s.children[2];p&&(p.style.background=Ke[d.color]),m&&(m.textContent=d.label),l.style.display="none";let g=S()?.locationId,x=L();if(!g){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=i.amber);return}if(e==="seller"&&d.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=i.amber);return}let v=h?.textContent??"\u25BE",_=async y=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await dr({contactId:o,locationId:g,status:d.label,userId:x,deadReason:y,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=v),s.style.opacity="1"},900)}catch(k){b.warn("Call Status webhook failed:",k),h&&(h.textContent="\u2717"),m&&(m.style.color=i.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=v),m&&(m.style.color=i.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";gr(k=>{_(k)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await cr({contactId:o,tenantId:g})).ok?await _():fr(()=>{_()},()=>{m&&(m.textContent=y)})}catch(k){b.warn("Appointment sanity check failed; firing anyway:",k),await _()}return}await _()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(s),a.appendChild(l),a},_r="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",vr=async o=>{let e=await fetch(_r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},yr=(o,e="seller")=>{document.getElementById($t)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=t?i.emerald:i.amber,s=document.createElement("div");s.id=$t,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",l=>{l.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},Vt=(o,e)=>{let t=document.createElement("div");t.id=K,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${i.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=P,r.textContent="Offer Made",r.addEventListener("click",()=>yr(o,e)),t.appendChild(r),t.appendChild(ur({contactId:o,kind:e})),t},Je=!1,wr=()=>{document.querySelectorAll(`[id="${K}"]`).forEach(o=>o.remove())},jt=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Je){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Je=!0;try{await xr()}finally{Je=!1}},xr=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),wr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Bt(o.contactId,o.locationId);Rt(c)==="buyer"&&(e="buyer"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${K}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await mr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Vt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(s,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(K)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${K}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=Vt(o.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},qt=null,kr=()=>{qt===null&&(qt=window.setInterval(()=>{let o=S();o&&(document.getElementById(K)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),jt()))},3e3))},Kt=()=>{kr(),jt()};var ge="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Er=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Q="data-ws-crm-favicon",Ze=o=>o.hasAttribute(Q),Yt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Er.has(e)},fe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Yt(r)&&!Ze(r)&&r.remove()});let e=document.head.querySelector(`link[${Q}="1"]`);e?e.href!==ge&&(e.href=ge):(e=document.createElement("link"),e.setAttribute(Q,"1"),e.rel="icon",e.type="image/png",e.href=ge,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${Q}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(Q,"apple"),t.rel="apple-touch-icon",t.href=ge,document.head.appendChild(t))},Xt=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)fe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),fe())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Yt(s)&&!Ze(s)&&(n=!0)}),a.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ze(s)&&(n=!0)});n&&fe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,fe(),e>=5&&window.clearInterval(t)},1e3)};var Tr=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Sr=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Cr=".hr-card.hr-modal.crm-opportunities-modal",A=()=>{let o=document.querySelector(Cr);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Sr);if(n){let a=n[1];if(Tr.includes(a))return a}}return null},U=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=A();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",Jt="ws-crm-mt-offer-made-modal",Lr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ar=/\/v2\/location\/([A-Za-z0-9]+)/,ke=()=>{let o=window.location.pathname,e=o.match(Lr);if(!e)return null;let t=o.match(Ar);return{oppId:e[1],locationId:t?t[1]:null}},Fr=async o=>{let e=await fetch(Ir,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},we=()=>{document.getElementById(Jt)?.remove()},Mr=o=>{we();let e=document.createElement("div");e.id=Jt,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=ke();!t||!t.locationId||t.oppId!==o||Mr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=i.emeraldGlow,e.style.color=i.emeraldBright,e.style.borderColor=i.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Or=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Hr=async()=>{for(let o of Or)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},xe=!1,ot=async()=>{if(!xe){xe=!0;try{await Pr()}finally{xe=!1}}},Pr=async()=>{let o=ke();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),te();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),te());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await Hr();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=ke();if(!n||n.oppId!==o.oppId)return;let a=Dr(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Nr(o.oppId)},ee=null,tt=null,te=()=>{ee?.disconnect(),ee=null,tt=null},Nr=o=>{if(ee&&tt===o)return;te();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(tt=o,ee=new MutationObserver(()=>{let t=ke();if(!t||t.oppId!==o){te();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),te();return}document.getElementById(D)||ot()}),ee.observe(e,{childList:!0,subtree:!0}))},Qe=null,et,Br=()=>{Qe||(Qe=new MutationObserver(()=>{et===void 0&&(et=window.setTimeout(()=>{et=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!xe&&ot()},300))}),Qe.observe(document.body,{childList:!0,subtree:!0}))},Zt=()=>{Br(),ot()};var Rr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",$r=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gr=/\/v2\/location\/([A-Za-z0-9]+)/,Te=()=>{let o=window.location.pathname,e=o.match($r);if(!e)return null;let t=o.match(Gr);return{oppId:e[1],locationId:t?t[1]:null}},Ur=async o=>{let e=await fetch(Rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Vr=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Te();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Ur({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=i.crimsonGlow,e.style.color=i.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},qr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zr=async()=>{for(let o of qr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ee=!1,st=async()=>{if(!Ee){Ee=!0;try{await Wr()}finally{Ee=!1}}},Wr=async()=>{let o=Te();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),re();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),re());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await zr();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Te();if(!n||n.oppId!==o.oppId)return;let a=Vr(o.oppId),s=document.createElement("span");s.id=`${O}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),jr(o.oppId)},oe=null,at=null,re=()=>{oe?.disconnect(),oe=null,at=null},jr=o=>{if(oe&&at===o)return;re();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(at=o,oe=new MutationObserver(()=>{let t=Te();if(!t||t.oppId!==o){re();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),re();return}document.getElementById(O)||st()}),oe.observe(e,{childList:!0,subtree:!0}))},rt=null,nt,Kr=()=>{rt||(rt=new MutationObserver(()=>{nt===void 0&&(nt=window.setTimeout(()=>{nt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Ee&&st()},300))}),rt.observe(document.body,{childList:!0,subtree:!0}))},Qt=()=>{Kr(),st()};var Yr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",eo="ws-crm-reduce-price-modal",Xr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jr=/\/v2\/location\/([A-Za-z0-9]+)/,Ie=()=>{let o=window.location.pathname,e=o.match(Xr);if(!e)return null;let t=o.match(Jr);return{oppId:e[1],locationId:t?t[1]:null}},Zr=async o=>{let e=await fetch(Yr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Se=()=>{document.getElementById(eo)?.remove()},Qr=o=>{Se();let e=document.createElement("div");e.id=eo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),s=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Se()}),a?.addEventListener("click",()=>{Se()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await Zr({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:L()}),Se(),o.onSuccess()}catch(p){b.error("Reduce Price webhook failed",p),n.textContent=p instanceof Error?p.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},en=(o,e)=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Ie();!r||!r.locationId||r.oppId!==o||Qr({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=i.emeraldGlow,t.style.color=i.emeraldBright,t.style.borderColor=i.emeraldBorder,a&&(a.style.background=i.emerald,a.style.boxShadow=`0 0 6px ${i.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,a&&(a.style.background=i.amber,a.style.boxShadow=`0 0 6px ${i.amber}`))},4e3)}})}),t},tn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],on=async()=>{for(let o of tn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ce=!1,ct=async()=>{if(!Ce){Ce=!0;try{await rn()}finally{Ce=!1}}},rn=async()=>{let o=Ie();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ae();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=A();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),ae());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await on();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Ie();if(!n||n.oppId!==o.oppId)return;let a=en(o.oppId,o.locationId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),nn(o.oppId)},ne=null,dt=null,ae=()=>{ne?.disconnect(),ne=null,dt=null},nn=o=>{if(ne&&dt===o)return;ae();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(dt=o,ne=new MutationObserver(()=>{let t=Ie();if(!t||t.oppId!==o){ae();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),ae();return}document.getElementById(H)||ct()}),ne.observe(e,{childList:!0,subtree:!0}))},it=null,lt,an=()=>{it||(it=new MutationObserver(()=>{lt===void 0&&(lt=window.setTimeout(()=>{lt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ce&&ct()},300))}),it.observe(document.body,{childList:!0,subtree:!0}))},to=()=>{an(),ct()};var ro="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-title-co-button",Y="ws-crm-send-to-title-co-wrap",Fe="ws-crm-stc-dropdown",sn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ln=/\/v2\/location\/([A-Za-z0-9]+)/,pt=()=>{let o=window.location.pathname,e=o.match(sn);if(!e)return null;let t=o.match(ln);return{oppId:e[1],locationId:t?t[1]:null}},dn=5*60*1e3,no=o=>`ws-crm-stc-cache:${o}`,cn=o=>{try{let e=window.localStorage.getItem(no(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>dn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},bn=(o,e)=>{try{window.localStorage.setItem(no(o),JSON.stringify(e))}catch{}},hn=async(o,e)=>{try{let t=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},pn=async(o,e,t)=>{let r=await fetch(ro,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},mn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},oo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${i.emerald}, 0 0 18px ${i.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},un=(o,e)=>{if(e&&mn(e)){window.setTimeout(()=>oo(o),300);return}oo(o)},B=()=>{document.getElementById(Fe)?.remove()},Le=(o,e,t)=>{B();let r=document.createElement("div");r.id=Fe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(u=>{p[u.group]||(p[u.group]=[]),p[u.group].push(u)});let m=[...c.filter(u=>p[u]),...Object.keys(p).filter(u=>!c.includes(u))];for(let u of m){let g=p[u],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let v=document.createElement("div");v.style.cssText=`
    ...
    `,v.textContent=u,x.appendChild(v),g.forEach(_=>{let y=document.createElement("div"),k=!_.filled&&_.navigable&&_.field_id;y.style.cssText=`
        ...
        ${k?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,k&&(y.addEventListener("mouseenter",()=>{y.style.background=i.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",F=>{F.stopPropagation(),_.field_id&&(un(_.field_id,_.folder),B())}));let T=_.filled?`<span style="color: ${i.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${i.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,w=k?`<span style="margin-left: auto; color: ${i.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${w}`,x.appendChild(y)}),r.appendChild(x)}document.body.appendChild(r);let h=u=>{let g=u.target;!r.contains(g)&&!t.contains(g)&&(B(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},N=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,s,l=i.bone,d,c="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",s=i.steel,l=i.ash,d=i.coolGray,c="Checking\u2026",m="wait",h="0.8";break;case"ready":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;a="transparent",s=i.amber,l=i.amber,d=i.amber,c=`${u} of ${g} fields ready`,p="\u25BE";break}case"sending":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",h="0.8";break;case"sent":a=i.emerald,s=i.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":a="transparent",s=i.amber,l=i.amber,d=i.amber,c=e.message??"Try again";break}o.style.background=a,o.style.borderColor=s,o.style.color=l,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=c),n&&(n.textContent=p)},_n=(o,e)=>{let t=document.createElement("button");t.id=z,t.type="button",t.dataset.oppId=o;let r=cn(o),n=r?{status:r.checks.every(v=>v.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${P}
    background: transparent;
    border: 1px solid ${i.steel};
    color: ${i.ash};
  ...
  `,N(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let v=await hn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},N(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},N(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},N(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),B(),ie();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},bn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),N(t,n),document.getElementById(Fe)&&Le(y,v.previously_sent_at,t)},l=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},N(t,n),B();try{let _=await pn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},N(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},N(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},N(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},N(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(Fe)?B():n.checks&&Le(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-p,k=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},k)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},vn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yn=async()=>{for(let o of vn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ae=!1,ut=async()=>{if(Ae){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ae=!0;try{await gn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Ae=!1}},gn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=pt();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),B();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=A();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Y)?.remove(),B(),ie());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Y)?.remove(),B()),b.debug("[stc] mount:04 calling findMountTarget");let t=await yn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=pt();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=_n(o.oppId,n.locationId),s=document.createElement("span");s.id=Y,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),fn(o.oppId)},se=null,mt=null,ie=()=>{se?.disconnect(),se=null,mt=null},fn=o=>{if(se&&mt===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(mt=o,se=new MutationObserver(()=>{let t=pt();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(Y)?.remove(),B(),ie();return}document.getElementById(z)||ut()}),se.observe(e,{childList:!0,subtree:!0}))},bt=null,ht,wn=()=>{bt||(bt=new MutationObserver(()=>{ht===void 0&&(ht=window.setTimeout(()=>{ht=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);o&&!e&&!Ae&&ut()},300))}),bt.observe(document.body,{childList:!0,subtree:!0}))},ao=()=>{wn(),ut()};var xn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",kn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",so="ldtyB2UXKi9vOp8nLUH7",R="ws-crm-title-officer-picker-button",io="ws-crm-title-officer-picker-modal",En=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tn=/\/v2\/location\/([A-Za-z0-9]+)/,yt=()=>{let o=window.location.pathname,e=o.match(En);if(!e)return null;let t=o.match(Tn);return{oppId:e[1],locationId:t?t[1]:null}},Sn=async o=>{let e=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Cn=async o=>{let e=await fetch(kn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()};var Me=()=>{document.getElementById(io)?.remove()},In=o=>{Me();let e=document.createElement("div");e.id=io,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Me()}),a?.addEventListener("click",Me);let s,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await Sn({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${i.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=i.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Me(),o.onPick(m)}),n.appendChild(h)})}catch(p){b.error("Title Officer picker search failed",p),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${i.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},De=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),le=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Title Officer",a=i.amber,s=i.bone,l="transparent",d=i.steel,c="pointer";switch(e.status){case"loading":n="Loading Title Officer\u2026",a=i.coolGray,s=i.ash,c="wait";break;case"empty":n="Link Title Officer",a=i.amber;break;case"linked":n=e.contactName?`Title Officer: ${e.contactName}`:"Title Officer: \u2713",a=i.emerald,l=i.emeraldGlow,d=i.emeraldBorder,s=i.emeraldBright;break;case"saving":n="Linking\u2026",a=i.coolGray,s=i.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=l,o.style.borderColor=d,o.style.color=s,o.style.cursor=c},Ln=(o,e)=>{let t=document.createElement("button");t.id=R,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Pick the Title Officer contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};return le(t,r),(async()=>{let a="";try{let s=window.localStorage.getItem(`ws-crm-stc-cache:${o}`);s&&(JSON.parse(s).checks||[]).find(c=>c.field_id===so)?.filled}catch{}r={status:"empty"},le(t,r)})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||In({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},le(t,r);try{let s=await Cn({tenantId:e,oppId:o,fieldId:so,value:a.id});if(!s.ok)throw new Error(s.error??"Save failed");r={status:"linked",contactName:a.name},le(t,r),b.info(`Title Officer linked: ${a.name} (${a.id})`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},le(t,r)}}})}),t},An=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Fn=async()=>{for(let o of An)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,ft=async()=>{if(!Oe){Oe=!0;try{await Mn()}finally{Oe=!1}}},Mn=async()=>{let o=yt();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),He();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),He());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Fn();if(!r||await U()!=="Transaction Coordination")return;let a=yt();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=Ln(o.oppId,a.locationId),l=document.createElement("span");l.id=`${R}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Dn(o.oppId)},de=null,gt=null,He=()=>{de?.disconnect(),de=null,gt=null},Dn=o=>{if(de&&gt===o)return;He();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(gt=o,de=new MutationObserver(()=>{let t=yt();if(!t||t.oppId!==o){He();return}document.getElementById(R)||ft()}),de.observe(e,{childList:!0,subtree:!0}))},_t=null,vt,On=()=>{_t||(_t=new MutationObserver(()=>{vt===void 0&&(vt=window.setTimeout(()=>{vt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!Oe&&ft()},300))}),_t.observe(document.body,{childList:!0,subtree:!0}))},lo=()=>{On(),ft()};var Ge="reos-theme-stylesheet",Co="reos-theme-fonts",Hn=()=>{let o=document.getElementById(Co);o&&o.remove()},Pn=`
/* ============================================
