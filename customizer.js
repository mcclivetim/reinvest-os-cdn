...
`;var Wl=/^[A-Za-z0-9]{15,30}$/,mt=t=>typeof t=="string"&&Wl.test(t),xa=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},jl=()=>{let t=window.WS_CRM_USER_ID;return mt(t)?t:null},Kl=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(mt(o))return o;return null},Yl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xa(e);if(!o)return null;let r=o.uid;if(mt(r))return r;let a=o.claims;if(a&&mt(a.user_id))return a.user_id}catch{}return null},Jl=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(mt(a))return a}catch{}}}catch{}return null},M=()=>jl()||Kl()||Yl()||Jl()||null,Xl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=xa(e);return o?o.claims??o:null}catch{return null}},me=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Xl()?.type==="agency"};var Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Ql=`${Ta}/active-follow-up-get`,Zl=`${Ta}/active-follow-up-set`,De="ws-crm-active-follow-up-button",yr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ed=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},td=async t=>{let e=await fetch(Ql,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},od=async(t,e)=>{let o=await fetch(Zl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},He=(t,e)=>{let o=yr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},wa=t=>{let e=document.createElement("button");return e.type="button",e.id=De,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Dh(t)}),t},Hh="ws-crm-contact-actions-bar",Ph=async()=>{let t=tl();if(!t){document.getElementById(oa)?.remove();return}let e=null;try{e=await I(`#${Hh}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(oa);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=rl();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ue="ws-crm-prepare-contract-button-opp",Wt=`${Ue}-wrap`,Rh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bh=/\/v2\/location\/([A-Za-z0-9]+)/,Fh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],na=()=>{let t=window.location.pathname,e=t.match(Rh);if(!e)return null;let o=t.match(Bh);return o?{oppId:e[1],tenantId:o[1]}:null},Nh=async()=>{for(let t of Fh)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Jo=!1,jt=null,aa=null,ea=null,ta,Kt=()=>{jt?.disconnect(),jt=null,aa=null},zh=t=>{if(jt&&aa===t)return;Kt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(aa=t,jt=new MutationObserver(()=>{let o=na();if(!o||o.oppId!==t){Kt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ue)?.remove(),document.getElementById(Wt)?.remove(),Kt();return}document.getElementById(Ue)||nl()}),jt.observe(e,{childList:!0,subtree:!0}))},Gh=()=>{ea||(ea=new MutationObserver(()=>{ta===void 0&&(ta=window.setTimeout(()=>{ta=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ue);t&&!e&&!Jo&&nl()},300))}),ea.observe(document.body,{childList:!0,subtree:!0}))},nl=async()=>{if(!Jo){Jo=!0;try{let t=na();if(!t){document.getElementById(Ue)?.remove(),document.getElementById(Wt)?.remove(),Kt();return}let e=document.getElementById(Ue);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Wt)?.remove(),Kt());return}e&&(e.remove(),document.getElementById(Wt)?.remove());let o=await Nh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=na();if(!a||a.oppId!==t.oppId)return;let i=rl();i.id=Ue,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Wt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
