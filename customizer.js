...
`;var Tt=/^[A-Za-z0-9]{15,30}$/,G=o=>typeof o=="string"&&Tt.test(o),Et=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},St=()=>{let o=window.WS_CRM_USER_ID;return G(o)?o:null},Ct=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(G(t))return t;return null},At=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Et(e);if(!t)return null;let r=t.uid;if(G(r))return r;let n=t.claims;if(n&&G(n.user_id))return n.user_id}catch{}return null},It=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(G(n))return n}catch{}}}catch{}return null},A=()=>St()||Ct()||At()||It()||null;var Ie="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Lt=`${Ie}/active-follow-up-get`,Ft=`${Ie}/active-follow-up-set`,H="ws-crm-active-follow-up-button",ge={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Dt=()=>{let o=f();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Mt=async o=>{let e=await fetch(Lt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ht=async(o,e)=>{let t=await fetch(Ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},N=(o,e)=>{let t=ge[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Se=o=>{let e=document.createElement("button");return e.type="button",e.id=H,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,N(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Dt();if(!(!r||r.contactId!==o)){N(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Ht(r,A()),a=n&&n.state&&n.state in ge?n.state:"blue";N(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),N(e,"error"),setTimeout(()=>void ee(e,r),4e3)}}}),e},ee=async(o,e)=>{N(o,"loading");try{let t=await Mt(e),r=t&&t.state&&t.state in ge?t.state:"gray",n=document.getElementById(H);if(!n||n.dataset.contactId!==e.contactId)return;N(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),N(o,"error")}},Nt=[".central-panel","[class*='central-panel']"],ye="ws-crm-contact-actions-bar",Pt=async()=>{for(let o of Nt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Rt=async(o,e)=>{let t=e.querySelector(`#${ye}`);if(!t)try{t=await C(`#${ye}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Ge=(o,e)=>{let t=document.createElement("div");t.id=O,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=re();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await mo({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},_o=["[data-testid='OPPORTUNITY_HEADER']","[class*='opportunity-header']","[class*='opp-header']","header.flex.items-center"],vo=async()=>{for(let o of _o)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},uo=async()=>{let o=re();if(!o||!o.locationId){document.getElementById(q)?.remove();return}let e=document.getElementById(q);if(e&&e.dataset.oppId===o.oppId)return;e&&e.remove();let t=await vo();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=re();if(!r||r.oppId!==o.oppId)return;let n=Ke(o.oppId),a=document.createElement("span");a.id=`${q}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,a.appendChild(n),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`);let i=new MutationObserver(()=>{let s=document.getElementById(q);if(!(re()?.oppId===o.oppId)){i.disconnect();return}if(!s){let c=Ke(o.oppId);a.appendChild(c),b.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});i.observe(t,{childList:!0})},Ye=()=>{uo()};var yo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",z="ws-crm-send-to-title-co-button",Xe="ws-crm-send-to-title-co-modal",go=/\/opportunities\/detail\/([A-Za-z0-9]+)/,fo=/\/v2\/location\/([A-Za-z0-9]+)/,ne=()=>{let o=window.location.pathname,e=o.match(go);if(!e)return null;let t=o.match(fo);return{oppId:e[1],locationId:t?t[1]:null}},Ze=async o=>{let e=await fetch(yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,tc_opp_id:o.oppId,triggered_by_user_id:o.userId??null,confirm_resend:o.confirmResend}),credentials:"omit"});if(!e.ok&&e.status!==200)throw new Error(`Send-to-Title-Co webhook returned ${e.status}`);return await e.json()},Je=o=>{document.getElementById(Xe)?.remove();let e=document.createElement("div");e.id=Xe,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=ne();if(!t||!t.locationId||t.oppId!==o)return;let r=e.querySelector(".ws-stc-label");e.disabled=!0,e.style.opacity="0.7",r&&(r.textContent="Checking\u2026");try{let n=await Ze({oppId:t.oppId,locationId:t.locationId,userId:A(),confirmResend:!1});if(e.disabled=!1,e.style.opacity="1",r&&(r.textContent="Send to Title Company"),n.needs_confirm){Je({oppId:t.oppId,locationId:t.locationId,isResend:!0,previousSentAt:n.previously_sent_at??null,onConfirmed:()=>{r&&(r.textContent="Re-sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3)}});return}if(n.ok){r&&(r.textContent="Sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3);return}Je({oppId:t.oppId,locationId:t.locationId,isResend:!1,onConfirmed:()=>{r&&(r.textContent="Sent \u2713"),e.style.background=l.emerald,setTimeout(()=>{r&&(r.textContent="Send to Title Company"),e.style.background=""},4e3)}})}catch(n){b.error("Send to Title Co preflight failed",n),e.disabled=!1,e.style.opacity="1",r&&(r.textContent="Try again"),setTimeout(()=>{r&&r.textContent==="Try again"&&(r.textContent="Send to Title Company")},3e3)}}),e},wo=["[data-testid='OPPORTUNITY_HEADER']","[class*='opportunity-header']","[class*='opp-header']","header.flex.items-center"],xo=async()=>{for(let o of wo)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ko=async()=>{let o=ne();if(!o||!o.locationId){document.getElementById(z)?.remove();return}let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId)return;e&&e.remove();let t=await xo();if(!t){b.warn("Send to Title Co: no opp-header mount target found within timeout");return}let r=ne();if(!r||r.oppId!==o.oppId)return;let n=Qe(o.oppId),a=document.createElement("span");a.id=`${z}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,a.appendChild(n),t.appendChild(a),b.debug(`Mounted Send to Title Co button on opp ${o.oppId}`);let i=new MutationObserver(()=>{let s=document.getElementById(z);if(!(ne()?.oppId===o.oppId)){i.disconnect();return}if(!s){let c=Qe(o.oppId);a.appendChild(c),b.debug(`Re-mounted Send to Title Co button after wipe for opp ${o.oppId}`)}});i.observe(t,{childList:!0})},et=()=>{ko()};var ce="reos-theme-stylesheet",vt="reos-theme-fonts",To=()=>{let o=document.getElementById(vt);o&&o.remove()},Eo=`
/* ============================================
