/* Wholesaling CRM Customizer v0.5.29 — built 2026-05-16T15:50:55.560Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var S="[wholesaling-crm-customizer]",ce="__WS_CRM_DEBUG",de=()=>!!window[ce],d={info(...e){console.log(S,...e)},warn(...e){console.warn(S,...e)},error(...e){console.error(S,...e)},debug(...e){de()&&console.log(S,"[debug]",...e)}};var O=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},T="",w="other",F=new Set,C=()=>{if(window.location.pathname!==T){T=window.location.pathname,w=O(),d.debug("Page changed:",w,T);for(let e of F)try{e(w)}catch(o){d.error("Subscriber threw:",o)}}},N=e=>(F.add(e),setTimeout(()=>e(w),0),()=>{F.delete(e)}),G=()=>{w=O(),T=window.location.pathname,d.debug("Router init, current page:",w);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),C()},history.replaceState=function(t,r,a){o(t,r,a),C()},window.addEventListener("popstate",C),setInterval(C,1e3)};var L="0.5.29",I="2026-05-16T15:50:55.561Z";var pe=/\/contacts\/detail\/([A-Za-z0-9]+)/,ue=/\/v2\/location\/([A-Za-z0-9]+)/,y=()=>{let e=window.location.pathname,o=e.match(pe);if(!o)return null;let t=e.match(ue);return{contactId:o[1],locationId:t?t[1]:null}};var k=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,c)=>{let s=a.querySelector(e);if(s){n(s);return}let i,u,b=()=>{p&&p.disconnect(),i!==void 0&&window.clearTimeout(i),u!==void 0&&window.clearInterval(u)},p=new MutationObserver(()=>{let m=a.querySelector(e);m&&(b(),n(m))});p.observe(document.body,{childList:!0,subtree:!0}),u=window.setInterval(()=>{let m=a.querySelector(e);m&&(b(),n(m))},r),i=window.setTimeout(()=>{b(),d.warn(`waitForElement timed out for selector: ${e}`),c(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},R={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},z=e=>{let o=e==="emerald"?l.emeraldGlow:e==="amber"?l.amberGlow:l.slate,t=e==="emerald"?l.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=e==="emerald"?l.emerald:e==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var E="ws-crm-claim-release-pill",W=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},me=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=E,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?l.emerald:l.amber;return t.style.cssText=z(r),t.innerHTML=`
  ...
  `,t.title=o==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{d.info(`Claim/Release pill clicked for contact ${e}: ${o}`);let n=t.lastElementChild,c=n?.textContent??"";n&&(n.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{n&&(n.textContent=c),t.style.opacity="1",t.disabled=!1},700)}),t},he=async(e,o=1e4)=>{let t=Date.now();for(;Date.now()-t<o;){let r=W(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},U=(e,o)=>{let t=me({contactId:o,mode:"claim"}),r=document.createElement("span");r.id=`${E}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),e.appendChild(r)},be=async()=>{let e=y();if(!e){document.getElementById(E)?.remove();return}let o=document.getElementById(E);if(!(o&&o.dataset.contactId===e.contactId)){o&&o.remove();try{let t=await k("#record-details-lhs",{timeoutMs:1e4}),r=await he(t),a=y();if(!a||a.contactId!==e.contactId)return;if(!r){d.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}U(r,e.contactId),d.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(y()?.contactId===e.contactId)){n?.disconnect();return}if(document.getElementById(E))return;let s=W(t);s&&(U(s,e.contactId),d.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(t,{childList:!0,subtree:!0})}catch(t){d.warn("Could not mount Claim/Release pill:",t)}}},q=()=>{be()};var ge="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",fe=()=>{let e=window.WS_CRM_USER_ID;if(e&&/^[A-Za-z0-9]{15,30}$/.test(e))return e;let o=window,t=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let c=JSON.parse(n),s=c.id??c._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}catch{}}}catch{}return null},ye=async({contactId:e,locationId:o,status:t,userId:r})=>{let n=await fetch(ge,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:e,location:{id:o},customData:{call_status:t,triggered_by_user_id:r??""}}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},M="ws-crm-contact-actions-bar",ve="ws-crm-call-status-dropdown",V="ws-crm-offer-made-modal",xe=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],we=[".central-panel","[class*='central-panel']"],ke=async()=>{for(let e of we)try{let o=await k(e,{timeoutMs:3e3});if(o)return o}catch{}try{return(await k("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ee=e=>{let o=document.createElement("div");o.id=ve,o.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=P,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
...
`,Le=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar'], [class*='avatar'] span, [class*='avatar'] p, [class*='avatar'] div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff']",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}}],A=()=>{for(let e of Le){let o;try{o=document.querySelectorAll(e.selector)}catch{continue}o.forEach(t=>{for(let[r,a]of Object.entries(e.styles)){let n=t.style.getPropertyPriority(r),c=t.style.getPropertyValue(r);n==="important"&&c===a||t.style.setProperty(r,a,"important")}})}},H="#1A1F28",Ie=26,Me=31,Ae=40,K=new Set,X=new Set,D=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let r=o.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;o.style.setProperty("display","none","important");let a=o.className?.toString()||"<no class>";!X.has(a)&&a!=="<no class>"&&(X.add(a),d.debug(`Hid empty "--" leaf: "${a}"`))})},Q=new Set,De=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, aside.default-bg-color").forEach(o=>{o.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']")||(r.className?.toString()||"").toLowerCase().includes("avatar"))return;let n=window.getComputedStyle(r),c=n.backgroundColor,s=n.backgroundImage||"",i=!1;if(s!=="none"&&s.includes("gradient"))i=!0;else if(c&&c!=="rgba(0, 0, 0, 0)"&&c!=="transparent"){let h=c.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(h){let g=parseInt(h[1],10),_=parseInt(h[2],10),x=parseInt(h[3],10);(g>=60||_>=60||x>=60)&&(g>230&&_>230&&x>230||(g>=80||_>=80||x>=80)&&(i=!0))}}if(!i)return;let b="#9098A3",p="#12161D";r.style.setProperty("color",p,"important"),r.querySelectorAll("*").forEach(h=>{let g=h.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(h.style.setProperty("fill",b,"important"),h.style.setProperty("stroke",b,"important"),h.style.setProperty("color",b,"important")):(h.style.setProperty("color",p,"important"),h.style.setProperty("-webkit-text-fill-color",p,"important"));let x=(h.className?.toString()||"").toLowerCase();(x.includes("bg-clip-text")||x.includes("text-transparent"))&&(h.style.setProperty("background-image","none","important"),h.style.setProperty("background","none","important"),h.style.setProperty("-webkit-background-clip","border-box","important"),h.style.setProperty("background-clip","border-box","important"))});let m=r.className?.toString()||"<no class>";!Q.has(m)&&m!=="<no class>"&&(Q.add(m),d.debug(`Darkened SVG icons on colored button: "${m}"`))})})},ee=new Set,$e=()=>{document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(o=>{o.querySelectorAll("*").forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator"))return;let n=window.getComputedStyle(r).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let c=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let s=parseInt(c[1],10),i=parseInt(c[2],10),u=parseInt(c[3],10);if(!(s>200&&i>200&&u>200))return;let p=r.getBoundingClientRect();if(p.width<24||p.height<16||p.width>1400)return;r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important");let m=r.className?.toString()||"<no class>";!ee.has(m)&&m!=="<no class>"&&(ee.add(m),d.debug(`Coerced light bg (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${s},${i},${u})): "${m}"`))})})},te=new Set,Fe=()=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(e)||t.closest("[class*='avatar'], [class*='hr-avatar']"))return;let a=t,n=null;for(let b=0;b<4&&a;b++){let p=a.nextElementSibling;if(p&&(p.matches(e)||p.querySelector(e)!==null)){n=p;break}a=a.parentElement}if(!n)return;let c=t.getBoundingClientRect();if(c.width===0||c.height===0||c.width>400||c.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let s=n,i=s.getBoundingClientRect();i.width>0&&i.width<=800&&i.height>0&&i.height<=100&&(s.style.setProperty("background-color",H,"important"),s.style.setProperty("border-color","#252C36","important"),s.style.setProperty("border-style","solid","important"),s.style.setProperty("border-width","1px","important"),s.style.setProperty("border-radius","4px","important"));let u=t.className?.toString()||"<no class>";!te.has(u)&&u!=="<no class>"&&(te.add(u),d.debug(`Colored field label "${r.slice(0,30)}": "${u}"`))})},oe=new Set,Re=()=>{document.querySelectorAll("[class*='avatar']").forEach(o=>{if(o.closest("[id^='ws-crm-']"))return;let t=o.getBoundingClientRect();if(t.width===0||t.height===0||t.height>80||o.querySelector("svg, img")!==null)return;let a=(o.textContent||"").trim();if(a.length===0||a.length>4)return;let n=Math.min(t.width,t.height),c=Math.max(16,Math.min(24,Math.round(n*.6)));o.style.setProperty("font-size",`${c}px`,"important"),o.style.setProperty("line-height","1","important"),o.style.setProperty("display","flex","important"),o.style.setProperty("align-items","center","important"),o.style.setProperty("justify-content","center","important"),o.style.setProperty("text-align","center","important"),o.querySelectorAll("*").forEach(i=>{i.tagName==="svg"||i.tagName==="SVG"||i.tagName!=="IMG"&&(i.style.setProperty("font-size",`${c}px`,"important"),i.style.setProperty("line-height","1","important"),i.style.setProperty("text-align","center","important"))});let s=o.className?.toString()||"<no class>";!oe.has(s)&&s!=="<no class>"&&(oe.add(s),d.debug(`Resized avatar text to ${c}px (circle ${n.toFixed(0)}px): "${s}"`))})},re=new Set,Be=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(o=>{if(o.closest("[id^='ws-crm-']"))return;let t=o.getBoundingClientRect();if(t.width===0||t.height===0)return;o.style.setProperty("background-color",H,"important"),o.style.setProperty("border-color","#252C36","important"),o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=o.className?.toString()||"<no class>";!re.has(r)&&r!=="<no class>"&&(re.add(r),d.debug(`Forced input slate bg: "${r}"`))})},$=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let t=window.getComputedStyle(o).backgroundColor;if(!t||t==="rgba(0, 0, 0, 0)"||t==="transparent")return;let r=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),n=parseInt(r[2],10),c=parseInt(r[3],10);if(!(a<Ie&&n<Me&&c<Ae))return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>800||i.height>200)return;o.style.setProperty("background-color",H,"important");let u=o.className?.toString()||"<no class>";!K.has(u)&&u!=="<no class>"&&(K.add(u),d.debug(`Coerced dark bg to slate (${i.width.toFixed(0)}x${i.height.toFixed(0)}, rgb(${a},${n},${c})): "${u}"`))})},ae=()=>{let e,o=()=>{e===void 0&&(e=window.setTimeout(()=>{e=void 0,A(),Be(),$(),D(),Fe(),$e(),De(),Re()},100))};A(),$(),D(),window.setTimeout(()=>{A(),$(),D()},500),window.setTimeout(()=>{A(),$(),D()},1500),new MutationObserver(()=>{o()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},ne=()=>{if(Ce(),!document.getElementById(Z)){let e=document.createElement("style");e.id=Z,e.textContent=Te,document.head.appendChild(e),d.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?ae():window.addEventListener("DOMContentLoaded",ae))};var se="ws-crm-customizer-version-badge",le=()=>{if(document.getElementById(se))return;let e=document.createElement("div");e.id=se,e.style.cssText=`
  ...
  `,e.textContent=`Customizer v${L}`,e.title=`Built ${I}
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var ie=()=>{d.info(`Loaded v${L} (built ${I})`),ne(),G(),N(e=>{d.debug("Page handler firing for:",e),le(),q(),Y()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie();})();
