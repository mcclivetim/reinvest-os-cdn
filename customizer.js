...
`,Qe=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],et=o=>{if(!o||o[0]!=="#")return o;let t=o.slice(1);if(t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t.length!==6&&t.length!==8)return o;let e=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),n=parseInt(t.slice(4,6),16);if(isNaN(e)||isNaN(r)||isNaN(n))return o;if(t.length===8){let s=parseInt(t.slice(6,8),16)/255;return`rgba(${e}, ${r}, ${n}, ${s})`}return`rgb(${e}, ${r}, ${n})`},tt=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),V=()=>{for(let o of Qe){let t;try{t=document.querySelectorAll(o.selector)}catch{continue}t.forEach(e=>{for(let[r,n]of Object.entries(o.styles)){let s=e.style.getPropertyPriority(r),i=e.style.getPropertyValue(r),a=tt.has(r)?et(n):n;s==="important"&&i===a||e.style.setProperty(r,n,"important")}})}},J="#1A1F28",ot=26,rt=31,nt=40,he=new Set,pe=new Set,$=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0||(t.textContent||"").trim()!=="--")return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;t.style.setProperty("display","none","important");let n=t.className?.toString()||"<no class>";!pe.has(n)&&n!=="<no class>"&&(pe.add(n),h.debug(`Hid empty "--" leaf: "${n}"`))})},me=new Set,at=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();if(e.includes("ai-button")||e.includes("ask-ai")||e.includes("bg-clip-text")||e.includes("text-transparent")||t.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=t.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(t.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let s=Array.from(t.children);if(s.length>0&&s.every(m=>{let c=m.tagName.toLowerCase();return c==="svg"||c==="img"})&&!n)return;let d=window.getComputedStyle(t).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let p=t.className?.toString()||"<no class>";!me.has(p)&&p!=="<no class>"&&(me.add(p),h.debug(`Remapped pure-white text -> bone: "${p}"`))})},ue=new Set,st=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(t=>{t.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=(r.className?.toString()||"").toLowerCase();if(n.includes("avatar"))return;let s=window.getComputedStyle(r),i=s.backgroundColor,a=s.backgroundImage||"",d=!1;if(a!=="none"&&a.includes("gradient"))d=!0;else if(i&&i!=="rgba(0, 0, 0, 0)"&&i!=="transparent"){let _=i.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(_&&parseFloat(_[1])<.6)return;let g=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(g){let k=parseInt(g[1],10),S=parseInt(g[2],10),W=parseInt(g[3],10);(k>=60||S>=60||W>=60)&&(k>230&&S>230&&W>230||(k>=80||S>=80||W>=80)&&(d=!0))}}if(!d)return;let p=(r.textContent||"").trim(),m=n,c=Array.from(r.querySelectorAll("*")).map(_=>(_.className?.toString()||"").toLowerCase()).join(" "),v=p.toLowerCase()==="ask ai"||m.includes("ai-button")||m.includes("ask-ai")||m.includes("askai"),u=m.includes("bg-clip-text")||m.includes("text-transparent")||c.includes("bg-clip-text")||c.includes("text-transparent"),y=Array.from(r.querySelectorAll("*")).some(_=>{let g=window.getComputedStyle(_),k=g.getPropertyValue("-webkit-background-clip")||"",S=g.getPropertyValue("background-clip")||"";return k.includes("text")||S.includes("text")});if(v||u||y){let _=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],g=k=>{_.forEach(S=>k.style.removeProperty(S))};g(r),r.querySelectorAll("*").forEach(g);return}let w="#12161D";r.style.setProperty("color",w,"important"),r.querySelectorAll("*").forEach(_=>{let g=_.tagName.toLowerCase();g==="svg"||g==="path"||g==="circle"||g==="rect"||g==="polygon"||g==="polyline"||g==="line"||g==="g"?(_.style.setProperty("fill",w,"important"),_.style.setProperty("stroke",w,"important"),_.style.setProperty("color",w,"important")):(_.style.setProperty("color",w,"important"),_.style.setProperty("-webkit-text-fill-color",w,"important"))});let T=r.className?.toString()||"<no class>";!ue.has(T)&&T!=="<no class>"&&(ue.add(T),h.debug(`Darkened SVG icons on colored button: "${T}"`))})})},ve=new Set,it=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0||e.width<20||e.width>64||e.height<20||e.height>64)return;let r=e.top+e.height/2;(t.parentElement||t).querySelectorAll("svg, img").forEach(a=>{let d=a;if(d.closest("[id^='ws-crm-']"))return;let b=a.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let p=b.left<e.right&&b.right>e.left,m=b.top<e.bottom&&b.bottom>e.top;if(!(p&&m)||b.top+b.height/2<r)return;let v=b.width*b.height/(e.width*e.height);if(v>.55)return;let u=d,y=d.parentElement,w=0;for(;y&&y!==t&&w<3;){let _=y.getBoundingClientRect();if(_.width>0&&_.width<=30&&_.height<=30)u=y;else break;y=y.parentElement,w++}u.style.setProperty("transform","translateY(11px)","important");let T=(u.className?.toString()||"")+" "+u.tagName;ve.has(T)||(ve.add(T),h.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${v.toFixed(2)}): "${T}"`))})})},lt="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",dt=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();e.includes("active")||e.includes("router-link-active")?(t.style.setProperty("color","#0FB57E","important"),t.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),t.style.setProperty("opacity","1","important"),t.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),t.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",lt,"important")}),t.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((t.style.color==="rgb(18, 22, 29)"||t.style.color==="#12161D"||t.style.color==="#0FB57E"||t.style.color==="rgb(15, 181, 126)")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color")),t.querySelectorAll("span, p, div").forEach(n=>{let s=n.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),t.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},ye=new Set,ct=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;t.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let a=parseInt(i[1],10),d=parseInt(i[2],10),b=parseInt(i[3],10);if(!(a>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!ye.has(p)&&p!=="<no class>"&&(ye.add(p),h.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${a},${d},${b})): "${p}"`))})})},_e=new Set,bt=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.parentElement,r=0;for(;e&&r<3&&!e.closest("[id^='ws-crm-']");){let n=(e.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=e.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){e.style.setProperty("background-color","#12161D","important"),e.style.setProperty("background-image","none","important");let a=e.className?.toString()||"<no class>";!_e.has(a)&&a!=="<no class>"&&(_e.add(a),h.debug(`Painted Ask AI wrapper graphite: "${a}"`))}}e=e.parentElement,r++}})},ge=new Set,ht=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),t=document.querySelectorAll("div, section, aside"),e=[];t.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(n);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let a=n.getBoundingClientRect();a.width<240||a.height<120||a.width>1500||a.height>900||e.push(n)}),[...o,...e].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let a=(i.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator"))return;if(a.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let w=i.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("tabulator")||a.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(a.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let w=i.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("ai-button")||a.includes("ask-ai")||a.includes("bg-clip-text")||a.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let p=parseInt(b[1],10),m=parseInt(b[2],10),c=parseInt(b[3],10);if(!(p>200&&m>200&&c>200))return;let u=i.getBoundingClientRect();if(u.width<24||u.height<16||u.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let y=i.className?.toString()||"<no class>";!ge.has(y)&&y!=="<no class>"&&(ge.add(y),h.debug(`Coerced light bg (${u.width.toFixed(0)}x${u.height.toFixed(0)}, rgb(${p},${m},${c})): "${y}"`))})})},fe=new Set,pt=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0)return;let r=(e.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||e.closest(o)||e.closest("[class*='avatar'], [class*='hr-avatar']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(e.matches("[role='heading']")||e.closest("[role='heading']")||e.matches("h1, h2, h3")||e.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){e.matches("h1, h2, h3")&&(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let v=e.getAttribute("style")||"";(v.includes("color")||v.includes("background"))&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("background-color"));return}if(e.closest("#SettingTexasSmsBlock")||e.matches("p.ui-text-sm-medium")&&e.parentElement?.classList?.contains("flex")&&e.parentElement?.classList?.contains("items-center")&&e.parentElement?.children?.length===1){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".hr-button, .n-button")||e.matches(".hr-button__content, .n-button__content")||e.closest(".hr-button__content, .n-button__content")){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}if(e.closest(".bg-primary-50, [class*='bg-primary-50']")){(e.getAttribute("style")||"").includes("color")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"));return}let n=e,s=null;for(let v=0;v<4&&n;v++){let u=n.nextElementSibling;if(u&&(u.matches(o)||u.querySelector(o)!==null)){s=u;break}n=n.parentElement}if(!s)return;let i=e.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;e.style.setProperty("color","#9098A3","important"),e.style.setProperty("-webkit-text-fill-color","#9098A3","important");let a=s,d=a.getBoundingClientRect(),b=a.className?.toString()||"",p=b.includes("schedule-ui-form-weekly-schedule-checkbox")||a.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||a.closest(".hl-form-item")!==null;!p&&!m&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(a.style.setProperty("background-color",J,"important"),a.style.setProperty("border-color","#252C36","important"),a.style.setProperty("border-style","solid","important"),a.style.setProperty("border-width","1px","important"),a.style.setProperty("border-radius","4px","important"));let c=e.className?.toString()||"<no class>";!fe.has(c)&&c!=="<no class>"&&(fe.add(c),h.debug(`Colored field label "${r.slice(0,30)}": "${c}"`))})},we=new Set,mt=()=>{document.querySelectorAll("[class*='avatar']").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=(t.className?.toString()||"").toLowerCase();if(e.includes("dropdown")||e.includes("option-avatar"))return;let r=t.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||t.querySelector("svg, img")!==null)return;let s=(t.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),a=Math.max(16,Math.min(24,Math.round(i*.6)));t.style.setProperty("font-size",`${a}px`,"important"),t.style.setProperty("line-height","1","important"),t.style.setProperty("display","flex","important"),t.style.setProperty("align-items","center","important"),t.style.setProperty("justify-content","center","important"),t.style.setProperty("text-align","center","important"),t.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${a}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=t.className?.toString()||"<no class>";!we.has(d)&&d!=="<no class>"&&(we.add(d),h.debug(`Resized avatar text to ${a}px (circle ${i.toFixed(0)}px): "${d}"`))})},xe=new Set,ut=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(t=>{if(t.closest("[id^='ws-crm-']"))return;let e=t.getBoundingClientRect();if(e.width===0||e.height===0)return;t.style.setProperty("background-color",J,"important"),t.style.setProperty("border-color","#252C36","important"),t.style.setProperty("color","#EDEEF0","important"),t.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=t.className?.toString()||"<no class>";!xe.has(r)&&r!=="<no class>"&&(xe.add(r),h.debug(`Forced input slate bg: "${r}"`))})},U=()=>{document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.id==="chat-filter"||t.id==="phone-calls"||t.id==="archive-conversation"||t.id==="star-toggle"||t.id==="read-toggle"||t.id==="delete-conversation")return;if(t.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let c=t.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}let e=t.className?.toString()||"";if(e.includes("bg-inherit")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(t.closest(".pipeline-ribbon")&&e.split(" ").includes("count")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.split(" ").includes("tabulator-page")){let c=t.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(c=>e.includes(c))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("schedule-ui-form-weekly-schedule-checkbox")){let c=t.getAttribute("style")||"";(c.includes("background-color")||c.includes("border-color")||c.includes("border-style")||c.includes("border-width"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("border-color"),t.style.removeProperty("border-style"),t.style.removeProperty("border-width"));return}if(e.includes("n-button")&&e.includes("icon-only")&&!e.includes("quaternary")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-data-table-td")||e.includes("hr-data-table-tr")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("n-data-table-td--fixed-right")||e.includes("n-data-table-td--last-col")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-tag")&&e.includes("ui-default")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if((e.includes("bg-purple-50")||e.includes("bg-purple-100"))&&(e.includes("rounded-lg")||e.includes("rounded-md")||e.includes("rounded-full"))){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("n-alert")||t.closest(".n-alert")||e.includes("hl-warning")||e.includes("hl-error")||e.includes("hl-info")||e.includes("hl-success")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-card")||t.closest(".hr-card")||t.id&&t.id.startsWith("opportunity-")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("bg-gray-50")||e.includes("bg-gray-100")||e.includes("bg-gray-200")||e.includes("bg-white")||e.includes("bg-blue-50")||e.includes("bg-blue-100")||e.includes("bg-sky-50")||e.includes("bg-indigo-50")||e.includes("bg-slate-50")||e.includes("bg-neutral-50")||e.includes("bg-zinc-50")||e.includes("bg-stone-50")||e.includes("F7F9FD")||e.includes("F9FAFB")||e.includes("ECEEF2")||e.includes("eceef2")||e.includes("EFF4FF")||e.includes("eff4ff")){(t.getAttribute("style")||"").includes("background-color")&&t.style.removeProperty("background-color");return}if(e.includes("hr-collapse-item")||e.includes("hr-collapse hr-accordion")||e.includes("hr-accordion"))return;if(e.includes("sidebar-option-button")||t.closest(".sidebar-option-button")||t.closest("nav[class*='w-13']")){let c=t.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}if(t.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let c=t.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(t.style.removeProperty("background-color"),t.style.removeProperty("color"));return}let n=window.getComputedStyle(t).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let s=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let i=parseInt(s[1],10),a=parseInt(s[2],10),d=parseInt(s[3],10);if(!(i<ot&&a<rt&&d<nt))return;let p=t.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;t.style.setProperty("background-color",J,"important");let m=t.className?.toString()||"<no class>";!he.has(m)&&m!=="<no class>"&&(he.add(m),h.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${i},${a},${d})): "${m}"`))})},q=()=>{let o="#4B8BF5",t=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],e="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored])").forEach(s=>{s.setAttribute("data-reos-recolored","1");let a=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!a)return;let d;try{d=atob(a[1])}catch{return}let b=d,p=!1;if(t.forEach(m=>{b.includes(m)&&(b=b.split(m).join(o),p=!0)}),!!p)try{let m=btoa(b);s.setAttribute("src",`data:image/svg+xml;base64,${m}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let a=`url("${i}")`;s.style.setProperty("-webkit-mask-image",a,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",a,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",e)})},ke=()=>{let o,t=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,V(),ut(),U(),$(),pt(),ht(),bt(),ct(),dt(),st(),mt(),it(),at(),q()},100))};V(),U(),$(),q(),window.setTimeout(()=>{V(),U(),$(),q()},500),window.setTimeout(()=>{V(),U(),$(),q()},1500),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Y,vt=()=>{let o=()=>{let e=document.getElementById(z);!e||!document.head||document.head.lastElementChild===e||document.head.appendChild(e)};new MutationObserver(e=>{let r=!1;for(let n of e){for(let s of Array.from(n.addedNodes)){if(!(s instanceof Element))continue;let i=s.tagName.toLowerCase();if(i==="style"||i==="link"){if(s.id===z||s.id===Ee)continue;r=!0;break}}if(r)break}r&&Y===void 0&&(Y=window.setTimeout(()=>{Y=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Te=()=>{if(Je(),!document.getElementById(z)){let o=document.createElement("style");o.id=z,o.textContent=Ze,document.head.appendChild(o),h.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?ke():window.addEventListener("DOMContentLoaded",ke)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,vt())};var Se="ws-crm-customizer-version-badge",Fe=()=>{if(document.getElementById(Se))return;let o=document.createElement("div");o.id=Se,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${M}`,o.title=`Built ${P}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var Ce=()=>{h.info(`Loaded v${M} (built ${P})`),be(),Te(),ee(),Q(o=>{h.debug("Page handler firing for:",o),Fe(),ne(),de()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ce):Ce();})();
