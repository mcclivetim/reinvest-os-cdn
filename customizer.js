...
/* 18a-availability-weekly-schedule (v0.8.99). The Sun/Mon/Tue/...
   day rows in the Availability schedule panel come in mixed states:
   - Resting rows: transparent bg + 1px gray-200 bottom border
   - Hovered row: slate bg + steel borders top + bottom
   Tim wants ALL rows obsidian regardless of state, with steel
   divider lines (no gray-200), so only the time input fields
   (.n-input \u2014 handled separately) carry slate fill. */
