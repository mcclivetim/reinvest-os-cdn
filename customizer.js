/* Wholesaling CRM Customizer v0.11.5 — built 2026-05-21T23:32:12.865Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var G="[wholesaling-crm-customizer]",Ke="__WS_CRM_DEBUG",Ye=()=>!!window[Ke],p={info(...o){console.log(G,...o)},warn(...o){console.warn(G,...o)},error(...o){console.error(G,...o)},debug(...o){Ye()&&console.log(G,"[debug]",...o)}};var ce=/\/contacts\/detail\/([A-Za-z0-9]+)/,oe=/\/v2\/location\/([A-Za-z0-9]+)/,Xe=o=>{let e=o.match(ce);if(!e)return null;let t=o.match(oe);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Je=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ce);if(!n)continue;let s=r.match(oe)||window.location.pathname.match(oe);return{contactId:n[1],locationId:s?s[1]:null,source:"dom"}}return null},x=()=>{let o=Xe(window.location.pathname);return o||Je()};var be=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},U="",re=null,I="other",ne=new Set,V=()=>{let o=x()?.contactId??null;if(!(!(window.location.pathname!==U)&&!(o!==re))){U=window.location.pathname,re=o,I=be(),p.debug("Page/context changed:",I,U,"contact:",o);for(let r of ne)try{r(I)}catch(n){p.error("Subscriber threw:",n)}}},he=o=>(ne.add(o),setTimeout(()=>o(I),0),()=>{ne.delete(o)}),pe=()=>{I=be(),U=window.location.pathname,re=x()?.contactId??null,p.debug("Router init, current page:",I);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),V()},history.replaceState=function(t,r,n){e(t,r,n),V()},window.addEventListener("popstate",V),setInterval(V,1e3)};var $="0.11.5",q="2026-05-21T23:32:12.866Z";var A=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((s,i)=>{let a=n.querySelector(o);if(a){s(a);return}let d,h,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),h!==void 0&&window.clearInterval(h)},m=new MutationObserver(()=>{let c=n.querySelector(o);c&&(b(),s(c))});m.observe(document.body,{childList:!0,subtree:!0}),h=window.setInterval(()=>{let c=n.querySelector(o);c&&(b(),s(c))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},y={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ae={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},me=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,H=`
  ...
  flex-shrink: 0;
`;var Ze=/^[A-Za-z0-9]{15,30}$/,M=o=>typeof o=="string"&&Ze.test(o),Qe=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},et=()=>{let o=window.WS_CRM_USER_ID;return M(o)?o:null},tt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(M(t))return t;return null},ot=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Qe(e);if(!t)return null;let r=t.uid;if(M(r))return r;let n=t.claims;if(n&&M(n.user_id))return n.user_id}catch{}return null},rt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(M(n))return n}catch{}}}catch{}return null},z=()=>et()||tt()||ot()||rt()||null;var ye="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",nt=`${ye}/active-follow-up-get`,at=`${ye}/active-follow-up-set`,N="ws-crm-active-follow-up-button",se={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},st=()=>{let o=x();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},it=async o=>{let e=await fetch(nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},lt=async(o,e)=>{let t=await fetch(at,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},L=(o,e)=>{let t=se[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},_e=o=>{let e=document.createElement("button");return e.type="button",e.id=N,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,L(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=st();if(!(!r||r.contactId!==o)){L(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await lt(r,z()),s=n&&n.state&&n.state in se?n.state:"blue";L(e,s),p.info(`Active Follow Up set for ${o} \u2192 ${s}`)}catch(n){p.error("Active Follow Up Set webhook failed",n),L(e,"error"),setTimeout(()=>void W(e,r),4e3)}}}),e},W=async(o,e)=>{L(o,"loading");try{let t=await it(e),r=t&&t.state&&t.state in se?t.state:"gray",n=document.getElementById(N);if(!n||n.dataset.contactId!==e.contactId)return;L(n,r)}catch(t){p.warn("Active Follow Up Get webhook failed",t),L(o,"error")}},dt=[".central-panel","[class*='central-panel']"],ue="ws-crm-contact-actions-bar",ct=async()=>{for(let o of dt)try{let e=await A(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},bt=(o,e)=>{let t=e.querySelector(`#${ue}`);if(t)return t.appendChild(o),{container:t,placement:"actions-bar"};let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${ue}`);s&&s.parentElement===e?e.insertBefore(n,s.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},ht=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},pt=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},mt=async o=>{if(o==="url"){let t=await ct();return t?{kind:"contact-detail",target:t}:null}let e=ht();return e?{kind:"conversations",target:e}:null},ve=(o,e)=>e.kind==="contact-detail"?bt(o,e.target).placement:(pt(o,e.target),"conversations-header"),_t=async()=>{let o=x();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(N);if(t&&t.dataset.contactId===e.contactId){W(t,e);return}t&&t.remove();let r=await mt(o.source);if(!r){p.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=x();if(!n||n.contactId!==e.contactId)return;let s=_e(e.contactId),i=ve(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),W(s,e);let a=new MutationObserver(()=>{let d=document.getElementById(N);if(!(x()?.contactId===e.contactId)){a.disconnect();return}if(!d){let b=_e(e.contactId);ve(b,r),W(b,e),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});a.observe(r.target,{childList:!0})},ge=()=>{_t()};var P="ws-crm-claim-release-pill",we=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ut=({contactId:o,mode:e})=>{let t=document.createElement("button");t.id=P,t.type="button",t.dataset.contactId=o,t.dataset.mode=e;let r=e==="claim"?"emerald":"amber",n=e==="claim"?l.emerald:l.amber;return t.style.cssText=me(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{p.info(`Claim/Release pill clicked for contact ${o}: ${e}`);let s=t.lastElementChild,i=s?.textContent??"";s&&(s.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{s&&(s.textContent=i),t.style.opacity="1",t.disabled=!1},700)}),t},vt=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=we(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},fe=(o,e)=>{let t=ut({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${P}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},yt=async()=>{let o=x();if(!o){document.getElementById(P)?.remove();return}let e=document.getElementById(P);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await A("#record-details-lhs",{timeoutMs:1e4}),r=await vt(t),n=x();if(!n||n.contactId!==o.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}fe(r,o.contactId),p.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let s=null;s=new MutationObserver(async()=>{if(!(x()?.contactId===o.contactId)){s?.disconnect();return}if(document.getElementById(P))return;let a=we(t);a&&(fe(a,o.contactId),p.debug("Re-mounted Claim/Release pill after React wipe"))}),s.observe(t,{childList:!0,subtree:!0})}catch(t){p.warn("Could not mount Claim/Release pill:",t)}}},xe=()=>{yt()};var gt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set";var ft="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",wt=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n})=>{let s={call_status:t,triggered_by_user_id:r??""};n&&(s.dead_reason=n);let a=await fetch(gt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:o,location:{id:e},customData:s}),credentials:"omit"});if(!a.ok)throw new Error(`Webhook returned ${a.status} ${a.statusText}`)},xt=async({contactId:o,tenantId:e})=>{let t=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var j="ws-crm-contact-actions-bar",kt="ws-crm-call-status-dropdown",ke="ws-crm-offer-made-modal",Et=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Tt=[".central-panel","[class*='central-panel']"],St=async()=>{for(let o of Tt)try{let e=await A(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ct=o=>{let e=document.createElement("div");e.id=kt,e.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=H,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,Et.forEach(n=>{let s=document.createElement("button");s.type="button",s.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,s.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${ae[n.color]};
        flex-shrink: 0;
      "></span>
      <span>${n.label}</span>
    `,s.addEventListener("mouseenter",()=>{s.style.background=l.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{p.info(`Call Status set to "${n.label}" (${n.value}, ${n.color}) for contact ${o}`);let i=t.firstElementChild,a=t.children[1],d=t.children[2];i&&(i.style.background=ae[n.color]),a&&(a.textContent=n.label),r.style.display="none";let b=x()?.locationId,m=z();if(!b){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),a&&(a.textContent=`${n.label} (no tenant!)`),a&&(a.style.color=l.amber);return}if(n.color==="green"&&!m){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),a&&(a.textContent=`${n.label} (no user!)`),a&&(a.style.color=l.amber);return}let c=d?.textContent??"\u25BE",g=async v=>{d&&(d.textContent="\u2026"),t.style.opacity="0.75";try{await wt({contactId:o,locationId:b,status:n.label,userId:m,deadReason:v}),d&&(d.textContent="\u2713"),setTimeout(()=>{d&&(d.textContent=c),t.style.opacity="1"},900)}catch(u){p.warn("Call Status webhook failed:",u),d&&(d.textContent="\u2717"),a&&(a.style.color=l.amber),t.style.opacity="1",setTimeout(()=>{d&&(d.textContent=c),a&&(a.style.color=l.bone)},1800)}};if(n.value==="dead-deal"){let v=a?.textContent??"";Ft(u=>{g(u)},()=>{a&&(a.textContent=v)});return}if(n.value==="appointment-booked"){let v=a?.textContent??"";try{(await xt({contactId:o,tenantId:b})).ok?await g():Lt(()=>{g()},()=>{a&&(a.textContent=v)})}catch(u){p.warn("Appointment sanity check failed; firing anyway:",u),await g()}return}await g()}),r.appendChild(s)}),t.addEventListener("click",n=>{n.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",n=>{e.contains(n.target)||(r.style.display="none")}),e.appendChild(t),e.appendChild(r),e},At=o=>{document.getElementById(ke)?.remove();let e=document.createElement("div");e.id=ke,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),s=()=>{n(),e()};t.addEventListener("click",a=>{a.target===t&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=a=>{a.key==="Escape"&&(document.removeEventListener("keydown",i),s())};document.addEventListener("keydown",i)},Se=o=>{let e=document.createElement("div");e.id=j,e.dataset.contactId=o,e.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let t=document.createElement("button");return t.type="button",t.style.cssText=D,t.textContent="Offer Made",t.addEventListener("click",()=>At(o)),e.appendChild(t),e.appendChild(Ct(o)),e},It=async()=>{let o=x();if(!o){document.getElementById(j)?.remove();return}let e=document.getElementById(j);if(e&&e.dataset.contactId===o.contactId)return;e&&e.remove();let t=await St();if(!t){p.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=x();if(!r||r.contactId!==o.contactId)return;let n=Se(o.contactId);n.dataset.mountTarget=t.className||"central-panel",t.insertBefore(n,t.firstChild),p.debug(`Mounted contact actions bar for ${o.contactId}`);let s=null;s=new MutationObserver(()=>{let i=document.getElementById(j);if(!(x()?.contactId===o.contactId)){s?.disconnect();return}if(!i){let d=Se(o.contactId);d.dataset.mountTarget=n.dataset.mountTarget??"",t.insertBefore(d,t.firstChild),p.debug(`Re-mounted actions bar after React wipe for ${o.contactId}`)}}),s.observe(t,{childList:!0})},Ce=()=>{It()};var K="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Dt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),R="data-ws-crm-favicon",ie=o=>o.hasAttribute(R),Ae=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Dt.has(e)},Y=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ae(r)&&!ie(r)&&r.remove()});let e=document.head.querySelector(`link[${R}="1"]`);e?e.href!==K&&(e.href=K):(e=document.createElement("link"),e.setAttribute(R,"1"),e.rel="icon",e.type="image/png",e.href=K,document.head.appendChild(e),p.debug("Favicon installed"));let t=document.head.querySelector(`link[${R}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(R,"apple"),t.rel="apple-touch-icon",t.href=K,document.head.appendChild(t))},Fe=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Y();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Y())},50)}new MutationObserver(r=>{let n=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ae(i)&&!ie(i)&&(n=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ie(i)&&(n=!0)});n&&Y()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Y(),e>=5&&window.clearInterval(t)},1e3)};var ee="reos-theme-stylesheet",$e="reos-theme-fonts",Ht=()=>{let o=document.getElementById($e);o&&o.remove()},Mt=`
/* ============================================
...
`,Nt=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Pt=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${s})`}return`rgb(${t}, ${r}, ${n})`},Rt=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Bt=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']"],B=()=>{document.querySelectorAll(Bt.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let a=+i[1],d=+i[2],h=+i[3];a<230||d<230||h<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"))})})},Le=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},O=()=>{for(let o of Nt){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let s=t.style.getPropertyPriority(r),i=t.style.getPropertyValue(r),a=Rt.has(r)?Pt(n):n;s==="important"&&i===a||t.style.setProperty(r,n,"important")}})}},de="#1A1F28",Ot=26,Gt=31,Vt=40,Ie=new Set,De=new Set,X=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!De.has(n)&&n!=="<no class>"&&(De.add(n),p.debug(`Hid empty "--" leaf: "${n}"`))})},Ut=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],$t=["trash","Trash","TRASH","delete","Delete","DELETE"],qt=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if($t.some(s=>n.includes(s))&&(r=!0),r||t.querySelectorAll("path").forEach(i=>{if(r)return;let a=i.getAttribute("d")||"";Ut.some(d=>a.includes(d))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),a=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||a.includes("delete")||a.includes("remove")||a.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},zt=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Wt=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||zt.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},He=new Set,jt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let s=Array.from(e.children);if(s.length>0&&s.every(m=>{let c=m.tagName.toLowerCase();return c==="svg"||c==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let b=e.className?.toString()||"<no class>";!He.has(b)&&b!=="<no class>"&&(He.add(b),p.debug(`Remapped pure-white text -> bone: "${b}"`))})},Me=new Set,Kt=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let a=window.getComputedStyle(s),d=a.backgroundColor,h=a.backgroundImage||"",b=!1;if(h!=="none"&&h.includes("gradient"))b=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let k=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(k&&parseFloat(k[1])<.6)return;let f=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(f){let C=parseInt(f[1],10),F=parseInt(f[2],10),te=parseInt(f[3],10);(C>=60||F>=60||te>=60)&&(C>230&&F>230&&te>230||(C>=80||F>=80||te>=80)&&(b=!0))}}if(!b)return;let c=(s.textContent||"").trim(),g=i,v=Array.from(s.querySelectorAll("*")).map(k=>(k.className?.toString()||"").toLowerCase()).join(" "),u=c.toLowerCase()==="ask ai"||g.includes("ai-button")||g.includes("ask-ai")||g.includes("askai"),w=g.includes("bg-clip-text")||g.includes("text-transparent")||v.includes("bg-clip-text")||v.includes("text-transparent"),S=Array.from(s.querySelectorAll("*")).some(k=>{let f=window.getComputedStyle(k),C=f.getPropertyValue("-webkit-background-clip")||"",F=f.getPropertyValue("background-clip")||"";return C.includes("text")||F.includes("text")});if(u||w||S){let k=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],f=C=>{k.forEach(F=>C.style.removeProperty(F))};f(s),s.querySelectorAll("*").forEach(f);return}let _="#12161D";s.style.setProperty("color",_,"important"),s.querySelectorAll("*").forEach(k=>{let f=k.tagName.toLowerCase();f==="svg"||f==="path"||f==="circle"||f==="rect"||f==="polygon"||f==="polyline"||f==="line"||f==="g"?(k.style.setProperty("fill",_,"important"),k.style.setProperty("stroke",_,"important"),k.style.setProperty("color",_,"important")):(k.style.setProperty("color",_,"important"),k.style.setProperty("-webkit-text-fill-color",_,"important"))});let T=s.className?.toString()||"<no class>";!Me.has(T)&&T!=="<no class>"&&(Me.add(T),p.debug(`Darkened SVG icons on colored button: "${T}"`))})})},Ne=new Set,Yt=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let h=d;if(h.closest("[id^='ws-crm-']"))return;let b=d.getBoundingClientRect();if(b.width===0||b.width>28||b.height>28)return;let m=b.left<r.right&&b.right>r.left,c=b.top<r.bottom&&b.bottom>r.top;if(!(m&&c)||b.top+b.height/2<n)return;let v=b.width*b.height/(r.width*r.height);if(v>.55)return;let u=h,w=h.parentElement,S=0;for(;w&&w!==e&&S<3;){let T=w.getBoundingClientRect();if(T.width>0&&T.width<=30&&T.height<=30)u=w;else break;w=w.parentElement,S++}u.style.setProperty("transform","translateY(11px)","important");let _=(u.className?.toString()||"")+" "+u.tagName;Ne.has(_)||(Ne.add(_),p.debug(`Dropped activity badge 11px (${b.width.toFixed(0)}x${b.height.toFixed(0)} icon, ratio ${v.toFixed(2)}): "${_}"`))})})},Xt="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Jt=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",Xt,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let s=n.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},Pe=new Set,Zt=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let a=parseInt(i[1],10),d=parseInt(i[2],10),h=parseInt(i[3],10);if(!(a>200&&d>200&&h>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let b=r.className?.toString()||"<no class>";!Pe.has(b)&&b!=="<no class>"&&(Pe.add(b),p.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${a},${d},${h})): "${b}"`))})})},Re=new Set,Qt=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=t.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let a=t.className?.toString()||"<no class>";!Re.has(a)&&a!=="<no class>"&&(Re.add(a),p.debug(`Painted Ask AI wrapper graphite: "${a}"`))}}t=t.parentElement,r++}})},Be=new Set,eo=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(n);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let a=n.getBoundingClientRect();a.width<240||a.height<120||a.width>1500||a.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let a=(i.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator"))return;if(a.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let w=i.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("tabulator")||a.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(a.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let w=i.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(a.includes("ai-button")||a.includes("ask-ai")||a.includes("bg-clip-text")||a.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let h=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!h)return;let b=parseInt(h[1],10),m=parseInt(h[2],10),c=parseInt(h[3],10);if(!(b>200&&m>200&&c>200))return;let v=i.getBoundingClientRect();if(v.width<24||v.height<16||v.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let u=i.className?.toString()||"<no class>";!Be.has(u)&&u!=="<no class>"&&(Be.add(u),p.debug(`Coerced light bg (${v.width.toFixed(0)}x${v.height.toFixed(0)}, rgb(${b},${m},${c})): "${u}"`))})})},Oe=new Set,to=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let _=t.getAttribute("style")||"";(_.includes("color")||_.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,s=null;for(let _=0;_<4&&n;_++){let T=n.nextElementSibling;if(T&&(T.matches(o)||T.querySelector(o)!==null)){s=T;break}n=n.parentElement}if(!s)return;let i=t.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let a=s,d=a.getBoundingClientRect(),h=a.className?.toString()||"",b=h.includes("schedule-ui-form-weekly-schedule-checkbox")||a.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=h.includes("hl-form-item")||h.includes("n-form-item--top-labelled")||a.closest(".hl-form-item")!==null,c=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",g=(h.includes("hr-form-item-blank")||h.includes("hr-form-item")||a.matches(c))&&(a.matches(c)||a.querySelector(c)!==null);g&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius"));let v=h.includes("hr-radio")||a.closest(".hr-radio, [class*='hr-radio']")!==null;v&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius"));let u=h.includes("hr-breadcrumb")||a.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;u&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius"));let w=h.includes("hr-header-lite")||a.closest("[class*='hr-header-lite']")!==null;w&&(a.getAttribute("style")||"").includes("background-color")&&(a.style.removeProperty("background-color"),a.style.removeProperty("border-color"),a.style.removeProperty("border-style"),a.style.removeProperty("border-width"),a.style.removeProperty("border-radius")),!b&&!m&&!g&&!v&&!u&&!w&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(a.style.setProperty("background-color",de,"important"),a.style.setProperty("border-color","#252C36","important"),a.style.setProperty("border-style","solid","important"),a.style.setProperty("border-width","1px","important"),a.style.setProperty("border-radius","4px","important"));let S=t.className?.toString()||"<no class>";!Oe.has(S)&&S!=="<no class>"&&(Oe.add(S),p.debug(`Colored field label "${r.slice(0,30)}": "${S}"`))})},Ge=new Set,oo=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),a=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${a}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(h=>{h.tagName==="svg"||h.tagName==="SVG"||h.tagName!=="IMG"&&(h.style.setProperty("font-size",`${a}px`,"important"),h.style.setProperty("line-height","1","important"),h.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Ge.has(d)&&d!=="<no class>"&&(Ge.add(d),p.debug(`Resized avatar text to ${a}px (circle ${i.toFixed(0)}px): "${d}"`))})},Ve=new Set,ro=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;e.style.setProperty("background-color",de,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=e.className?.toString()||"<no class>";!Ve.has(r)&&r!=="<no class>"&&(Ve.add(r),p.debug(`Forced input slate bg: "${r}"`))})},J=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(c=>t.includes(c))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("border-color")||c.includes("border-style")||c.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let c=e.getAttribute("style")||"";(c.includes("background-color")||c.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let s=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let i=parseInt(s[1],10),a=parseInt(s[2],10),d=parseInt(s[3],10);if(!(i<Ot&&a<Gt&&d<Vt))return;let b=e.getBoundingClientRect();if(b.width===0||b.height===0||b.width>800||b.height>200)return;e.style.setProperty("background-color",de,"important");let m=e.className?.toString()||"<no class>";!Ie.has(m)&&m!=="<no class>"&&(Ie.add(m),p.debug(`Coerced dark bg to slate (${b.width.toFixed(0)}x${b.height.toFixed(0)}, rgb(${i},${a},${d})): "${m}"`))})},Z=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored]), .toolbar_button img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2]), #editor-toolbar img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v2])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1");let a=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!a)return;let d;try{d=atob(a[1])}catch{return}let h=d,b=!1;if(e.forEach(c=>{h.includes(c)&&(h=h.split(c).join(o),b=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(g=>{h.includes(g)&&(h=h.split(g).join("#EDEEF0"),b=!0)}),!!b)try{let c=btoa(h);s.setAttribute("src",`data:image/svg+xml;base64,${c}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let a=`url("${i}")`;s.style.setProperty("-webkit-mask-image",a,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",a,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",t)})},Q=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Ue=()=>{let o,e=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,Q(),O(),ro(),J(),X(),to(),eo(),Qt(),Zt(),Jt(),Kt(),oo(),Yt(),jt(),Z(),Wt(),qt(),B(),Le()},100))};Q(),O(),J(),X(),Z(),B(),Le(),window.setTimeout(()=>{Q(),O(),J(),X(),Z(),B()},500),window.setTimeout(()=>{Q(),O(),J(),X(),Z(),B()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{B(),O()}),new MutationObserver(()=>{e()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},le,no=()=>{let o=()=>{let t=document.getElementById(ee);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let n of t){for(let s of Array.from(n.addedNodes)){if(!(s instanceof Element))continue;let i=s.tagName.toLowerCase();if(i==="style"||i==="link"){if(s.id===ee||s.id===$e)continue;r=!0;break}}if(r)break}r&&le===void 0&&(le=window.setTimeout(()=>{le=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},qe=()=>{if(Ht(),!document.getElementById(ee)){let o=document.createElement("style");o.id=ee,o.textContent=Mt,document.head.appendChild(o),p.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?Ue():window.addEventListener("DOMContentLoaded",Ue)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,no())};var ze="ws-crm-customizer-version-badge",We=()=>{if(document.getElementById(ze))return;let o=document.createElement("div");o.id=ze,o.style.cssText=`
  ...
  `,o.textContent=`Customizer v${$}`,o.title=`Built ${q}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};var je=()=>{p.info(`Loaded v${$} (built ${q})`),Fe(),qe(),pe(),he(o=>{p.debug("Page handler firing for:",o),We(),xe(),Ce(),ge()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",je):je();})();
