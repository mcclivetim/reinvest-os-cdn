...
/* 16d. CHART TOOLTIPS \u2014 cursor-following floating tooltips that chart
   libraries (Apache ECharts, Highcharts, ApexCharts, Recharts) render
   as separate DOM elements outside their SVG. Default styling is
   white-on-dark across all of them, which on our dark theme produces
   a white flash before settling.

   Apply graphite + bone + steel hairline to every common tooltip class.
   Inline-white inline styles are ALSO caught by the FORCE_RULE
   inline-white selector (extended to handle 'background:' shorthand
   in v0.7.53) for chart libs that don't use a class. */
html body .echarts-tooltip,
html body .echart-tooltip,
html body [class*='echarts-tooltip'],
html body .highcharts-tooltip,
html body [class*='highcharts-tooltip'],
html body .apexcharts-tooltip,
html body [class*='apexcharts-tooltip'],
html body .recharts-tooltip-wrapper,
html body .recharts-default-tooltip,
html body [class*='recharts-tooltip'],
html body [class*='chart-tooltip'],
html body [class*='tooltip-container'],
html body [class*='tooltip-content']:not(.n-popover *):not(.hr-popover *) {
  background-color: var(--reos-graphite) !important;
  background: var(--reos-graphite) !important;
  color: var(--reos-bone) !important;
  border: 1px solid var(--reos-steel) !important;
