/* Wholesaling CRM Customizer v0.37.8 — built 2026-06-14T14:07:14.805Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var eo="[wholesaling-crm-customizer]",zl="__WS_CRM_DEBUG",Gl=()=>!!window[zl],c={info(...t){console.log(eo,...t)},warn(...t){console.warn(eo,...t)},error(...t){console.error(eo,...t)},debug(...t){Gl()&&console.log(eo,"[debug]",...t)}};var ql=/\/v2\/location\/([A-Za-z0-9]+)/,Ul=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let t=window.location.pathname.match(ql);return t?t[1]:null},br=()=>{let t=re();return t!==null&&Ul.has(t)};var ha=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,mr=/\/v2\/location\/([A-Za-z0-9]+)/,Vl=t=>{let e=t.match(ha);if(!e)return null;let o=t.match(mr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Wl=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(ha);if(!a)continue;let i=r.match(mr)||window.location.pathname.match(mr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},R=()=>{let t=Vl(window.location.pathname);return t||Wl()};var ua=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},oo="",hr=null,Oe="other",ur=new Set,to=()=>{let t=R()?.contactId??null;if(!(!(window.location.pathname!==oo)&&!(t!==hr))){oo=window.location.pathname,hr=t,Oe=ua(),c.debug("Page/context changed:",Oe,oo,"contact:",t);for(let r of ur)try{r(Oe)}catch(a){c.error("Subscriber threw:",a)}}},be=t=>(ur.add(t),setTimeout(()=>t(Oe),0),()=>{ur.delete(t)}),va=()=>{Oe=ua(),oo=window.location.pathname,hr=R()?.contactId??null,c.debug("Router init, current page:",Oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),to()},history.replaceState=function(o,r,a){e(o,r,a),to()},window.addEventListener("popstate",to),setInterval(to,1e3)},_a=()=>Oe;var ro="0.37.8",no="2026-06-14T14:07:14.806Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{h&&h.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},h=new MutationObserver(()=>{let m=a.querySelector(t);m&&(b(),i(m))});h.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let m=a.querySelector(t);m&&(b(),i(m))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},vr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ga=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var jl=/^[A-Za-z0-9]{15,30}$/,mt=t=>typeof t=="string"&&jl.test(t),ya=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Kl=()=>{let t=window.WS_CRM_USER_ID;return mt(t)?t:null},Yl=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(mt(o))return o;return null},Jl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ya(e);if(!o)return null;let r=o.uid;if(mt(r))return r;let a=o.claims;if(a&&mt(a.user_id))return a.user_id}catch{}return null},Xl=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(mt(a))return a}catch{}}}catch{}return null},M=()=>Kl()||Yl()||Jl()||Xl()||null,Ql=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ya(e);return o?o.claims??o:null}catch{return null}},me=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ql()?.type==="agency"};var ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Zl=`${ka}/active-follow-up-get`,ed=`${ka}/active-follow-up-set`,De="ws-crm-active-follow-up-button",gr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},td=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},od=async t=>{let e=await fetch(Zl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},rd=async(t,e)=>{let o=await fetch(ed,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},He=(t,e)=>{let o=gr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},fa=t=>{let e=document.createElement("button");return e.type="button",e.id=De,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,He(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=td();if(!(!r||r.contactId!==t)){He(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await rd(r,M()),i=a&&a.state&&a.state in gr?a.state:"blue";He(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),He(e,"error"),setTimeout(()=>void ao(e,r),4e3)}}}),e},ao=async(t,e)=>{He(t,"loading");try{let o=await od(e),r=o&&o.state&&o.state in gr?o.state:"gray",a=document.getElementById(De);if(!a||a.dataset.contactId!==e.contactId)return;He(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),He(t,"error")}},nd=[".central-panel","[class*='central-panel']"],_r="ws-crm-contact-actions-bar",ad=async()=>{for(let t of nd)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},id=async(t,e)=>{let o=e.querySelector(`#${_r}`);if(!o)try{o=await I(`#${_r}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${_r}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},sd=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},ld=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},dd=async t=>{if(t==="url"){let o=await ad();return o?{kind:"contact-detail",target:o}:null}let e=sd();return e?{kind:"conversations",target:e}:null},xa=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await id(t,e.target);return o}return ld(t,e.target),"conversations-header"},cd=async()=>{let t=R();if(!t||!t.locationId){document.getElementById(De)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(De);if(o&&o.dataset.contactId===e.contactId){ao(o,e);return}o&&o.remove();let r=await dd(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=R();if(!a||a.contactId!==e.contactId)return;let i=fa(e.contactId),s=await xa(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),wa();let l=document.getElementById(De)??i;ao(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(De);if(!(R()?.contactId===e.contactId)){d.disconnect();return}if(!p){let h=fa(e.contactId);xa(h,r).then(()=>{wa(),ao(h,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},ht=null,Ea=()=>{let t=R()?.contactId??null;if(ht&&ht.contactId===t)return;let e=cd().finally(()=>{ht?.promise===e&&(ht=null)});ht={contactId:t,promise:e}},wa=()=>{let t=document.querySelectorAll(`#${De}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var pd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ut=new Map,je=async(t,e)=>{if(!t)return null;if(ut.has(t))return ut.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${pd}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),ut.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ut.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),ut.set(t,null),null}};var Ke=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var Ca="ws-buybox-nav-icon",xr="ws-buybox-panel",Ta="ws-buybox-modal",bd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",wr="https://mcclivetim.github.io/reinvest-os-cdn/geo",io=null,vt=null,_t=null,fr=async()=>{if(io)return io;try{let t=await fetch(`${wr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return io=await t.json(),io}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},md=async t=>{if(!vt)try{let e=await fetch(`${wr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);vt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return vt?.[t]??[]},hd=async t=>{if(!_t)try{let e=await fetch(`${wr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);_t=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return _t?.[t]??[]},kr=async t=>await(await fetch(bd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ud=(t,e)=>kr({tenant_id:t,action:"list",buyer_contact_id:e}),vd=(t,e,o,r)=>kr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),_d=(t,e)=>kr({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),gd=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},yd='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',fd='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',xd="nav.w-13, nav[class*='w-13']",wd=".flex-1.h-full.relative.overflow-hidden.rounded-lg",kd=async()=>{try{return await I(xd,{timeoutMs:2500})}catch{return null}},Ed=async()=>{try{return await I(wd,{timeoutMs:2500})}catch{return null}},Td=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Sd=(t,e)=>{let o=document.createElement("div");return o.id=xr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ld(t,e,()=>Er(t,e))}),o},Er=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ud(t,e),fr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Cd(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Cd=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let h=d.key==="state"?gd(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,_d(r,p).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),d.disabled=!1;return}Er(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),d.disabled=!1}))})})},so=!1,Aa=(t,e)=>{so=e;let o=Td(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Ad,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Er(t.tenantId,t.buyerContactId)):(t.iconBtn.className=$a,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},$a="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ad="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",$d=t=>{let e=document.createElement("button");return e.id=Ca,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=$a,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${yd.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!so;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Aa(r,a)}),e},Ld=(t,e,o)=>{let r=document.getElementById(Ta);r&&r.remove();let a=document.createElement("div");a.id=Ta,a.style.cssText=`
  ...
  `,x=f=>{let T=f.find($=>$.code===s.stateCode);return`
    ...
    `},k=f=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},y=f=>{let T=s.granularity==="county"?vt?.[s.stateCode||""]??[]:_t?.[s.stateCode||""]??[];return`
    ...
    `},g=()=>{let f=s.granularity==="county"?vt?.[s.stateCode||""]??[]:_t?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),$=i.querySelector("#ws-buybox-value-list");if(!T||!$)return;let P=q=>{let z=q.toLowerCase().trim();if(!z){$.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=f.filter(B=>B.toLowerCase().includes(z)).slice(0,50);if(N.length===0){$.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(s.stateCode||"")}.</div>`;return}$.innerHTML=N.map(B=>`
  ...
  `,S=()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");f&&(f.addEventListener("input",()=>{f.value=f.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),f.addEventListener("keydown",$=>{$.key==="Enter"&&($.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>f.focus(),0))},C=async()=>{let f=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),$=(f?.value||"").trim();if(!/^\d{5}$/.test($)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E($)},E=async f=>{if(!s.granularity||!f)return;let T=i.querySelector("#ws-buybox-err"),$=i.querySelector("#ws-buybox-save");$&&($.disabled=!0,$.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await vd(t,e,s.granularity,f);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),$&&($.disabled=!1,$.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),$&&($.disabled=!1,$.textContent="Add")}};l()},yr=!1,Ye=null,gt=null,Sa=()=>{document.getElementById(Ca)?.remove(),document.getElementById(xr)?.remove(),gt&&Ye&&Ye.nav.removeEventListener("click",gt,!0),gt=null,Ye=null,so=!1},La=()=>{Id()},Id=async()=>{if(!yr){yr=!0;try{let t=R();if(!t){Sa();return}let e=document.getElementById(xr);if(e&&e.dataset.buyerContactId===t.contactId&&Ye)return;Sa();let o=null;try{o=await je(t.contactId,t.locationId)}catch(h){c.warn("[buy-box] Contact Type fetch failed",h);return}if(Ke(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([kd(),Ed()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=R();if(!s||s.contactId!==t.contactId)return;let l=Sd(t.locationId,t.contactId),d=$d(()=>Ye),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ye=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),gt=h=>{let m=h.target;if(!m||p.iconBtn.contains(m))return;m.closest("button.sidebar-option-button")&&so&&Aa(p,!1)},a.addEventListener("click",gt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{yr=!1}}};var ke="ws-crm-claim-release-pill",Md="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Od="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Dd=async t=>{let e=await fetch(Md,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Hd=async t=>{let e=await fetch(Od,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Oa=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Je=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=ga(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Jd(t,e)),o.appendChild(r),o.appendChild(jd({contactId:t,kind:e}))}return o},Tr=!1,Fa=()=>{document.querySelectorAll(`[id="${Xe}"]`).forEach(t=>t.remove())},qa=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Tr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Tr=!0;try{await Zd()}finally{Tr=!1}},Zd=async()=>{let t=R();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Fa();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Fa();return}let e="seller";try{let p=await je(t.contactId,t.locationId),b=Ke(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=R();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Xe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Wd();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=R();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Ra(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Xe)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(R()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Xe}"]`);if(b.length>1){for(let h=1;h<b.length;h++)b[h].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let h=document.querySelector(".central-panel")||a,m=Ra(t.contactId,e);m.dataset.mountTarget=s.dataset.mountTarget??"";try{h.insertBefore(m,h.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Na=null,ec=()=>{Na===null&&(Na=window.setInterval(()=>{let t=R();t&&(document.getElementById(Xe)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),qa()))},3e3))},Ua=()=>{ec(),qa()};var lo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",tc=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),yt="data-ws-crm-favicon",Sr=t=>t.hasAttribute(yt),Va=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return tc.has(e)},co=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Va(r)&&!Sr(r)&&r.remove()});let e=document.head.querySelector(`link[${yt}="1"]`);e?e.href!==lo&&(e.href=lo):(e=document.createElement("link"),e.setAttribute(yt,"1"),e.rel="icon",e.type="image/png",e.href=lo,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${yt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(yt,"apple"),o.rel="apple-touch-icon",o.href=lo,document.head.appendChild(o))},Wa=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)co();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),co())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Va(s)&&!Sr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Sr(s)&&(a=!0)});a&&co()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,co(),e>=5&&window.clearInterval(o)},1e3)};var oc=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],rc=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,nc=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(nc);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(rc);if(a){let i=a[1];if(oc.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var ja="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(ja);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=ja,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var ac="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ie="ws-crm-mt-offer-made-button",Ka="ws-crm-mt-offer-made-modal",ic=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sc=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(ic);if(!e)return null;let o=t.match(sc);return{oppId:e[1],locationId:o?o[1]:null}},lc=async t=>{let e=await fetch(ac,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},po=()=>{document.getElementById(Ka)?.remove()},dc=t=>{po();let e=document.createElement("div");e.id=Ka,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=mo();!o||!o.locationId||o.oppId!==t||dc({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},pc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bc=async()=>{for(let t of pc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},bo=!1,Lr=async()=>{if(!bo){bo=!0;try{await mc()}finally{bo=!1}}},mc=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),xt();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),xt());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await bc();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=cc(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),hc(t.oppId)},ft=null,$r=null,xt=()=>{ft?.disconnect(),ft=null,$r=null},hc=t=>{if(ft&&$r===t)return;xt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($r=t,ft=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){xt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),xt();return}document.getElementById(ie)||Lr()}),ft.observe(e,{childList:!0,subtree:!0}))},Cr=null,Ar,uc=()=>{Cr||(Cr=new MutationObserver(()=>{Ar===void 0&&(Ar=window.setTimeout(()=>{Ar=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!bo&&Lr()},300))}),Cr.observe(document.body,{childList:!0,subtree:!0}))},Ya=()=>{uc(),Lr()};var vc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",se="ws-crm-not-interested-button",_c=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gc=/\/v2\/location\/([A-Za-z0-9]+)/,uo=()=>{let t=window.location.pathname,e=t.match(_c);if(!e)return null;let o=t.match(gc);return{oppId:e[1],locationId:o?o[1]:null}},yc=async t=>{let e=await fetch(vc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},fc=t=>{let e=document.createElement("button");return e.id=se,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=uo();if(!o||!o.locationId||o.oppId!==t)return;let r=M(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await yc({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},xc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wc=async()=>{for(let t of xc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ho=!1,Dr=async()=>{if(!ho){ho=!0;try{await kc()}finally{ho=!1}}},kc=async()=>{let t=uo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await wc();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=uo();if(!a||a.oppId!==t.oppId)return;let i=fc(t.oppId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ec(t.oppId)},wt=null,Or=null,kt=()=>{wt?.disconnect(),wt=null,Or=null},Ec=t=>{if(wt&&Or===t)return;kt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Or=t,wt=new MutationObserver(()=>{let o=uo();if(!o||o.oppId!==t){kt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}document.getElementById(se)||Dr()}),wt.observe(e,{childList:!0,subtree:!0}))},Ir=null,Mr,Tc=()=>{Ir||(Ir=new MutationObserver(()=>{Mr===void 0&&(Mr=window.setTimeout(()=>{Mr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!ho&&Dr()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},Ja=()=>{Tc(),Dr()};var Sc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ne="ws-crm-schedule-walkthrough-button",Hr="ws-crm-schedule-walkthrough-modal",Cc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ac=/\/v2\/location\/([A-Za-z0-9]+)/,go=()=>{let t=window.location.pathname,e=t.match(Cc);if(!e)return null;let o=t.match(Ac);return{oppId:e[1],locationId:o?o[1]:null}},vo=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$c=(t,e)=>{document.getElementById(Hr)?.remove();let o=document.createElement("div");o.id=Hr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=go();!o||!o.locationId||o.oppId!==t||$c(o.oppId,o.locationId)}),e},Ic=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Mc=async()=>{for(let t of Ic)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_o=!1,Fr=async()=>{if(!_o){_o=!0;try{await Oc()}finally{_o=!1}}},Oc=async()=>{let t=go();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Tt();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Tt());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await Mc();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=go();if(!a||a.oppId!==t.oppId)return;let i=Lc(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Dc(t.oppId)},Et=null,Rr=null,Tt=()=>{Et?.disconnect(),Et=null,Rr=null},Dc=t=>{if(Et&&Rr===t)return;Tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rr=t,Et=new MutationObserver(()=>{let o=go();if(!o||o.oppId!==t){Tt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Tt();return}document.getElementById(ne)||Fr()}),Et.observe(e,{childList:!0,subtree:!0}))},Pr=null,Br,Hc=()=>{Pr||(Pr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!_o&&Fr()},300))}),Pr.observe(document.body,{childList:!0,subtree:!0}))},Xa=()=>{Hc(),Fr()};var Pc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Qe="ws-crm-resend-deal-link-wrap",Bc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rc=/\/v2\/location\/([A-Za-z0-9]+)/,fo=()=>{let t=window.location.pathname,e=t.match(Bc);if(!e)return null;let o=t.match(Rc);return{oppId:e[1],locationId:o?o[1]:null}},Fc=async t=>{let e=await fetch(Pc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Nc=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Qa=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,qr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Qa(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>zc(t,e)),t.appendChild(o)},zc=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Gc(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>qr(t,e)),o.appendChild(s),t.appendChild(o)},Gc=async(t,e,o,r)=>{let a=fo();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Fc({oppId:a.oppId,locationId:a.locationId,channel:o,userId:M()});if(i?.ok)r.innerHTML=`${Qa(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Nc(s)}</span>`}window.setTimeout(()=>qr(t,e),3500)}},qc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Uc=async()=>{for(let t of qc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yo=!1,Ur=async()=>{if(!yo){yo=!0;try{await Vc()}finally{yo=!1}}},Vc=async()=>{let t=fo();if(!t||!t.locationId){document.getElementById(Qe)?.remove(),Ct();return}let e=document.getElementById(Qe);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),Ct());return}e&&e.remove();let o=await Uc();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=fo();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Qe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),qr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Wc(t.oppId)},St=null,Gr=null,Ct=()=>{St?.disconnect(),St=null,Gr=null},Wc=t=>{if(St&&Gr===t)return;Ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gr=t,St=new MutationObserver(()=>{let o=fo();if(!o||o.oppId!==t){Ct();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Qe)?.remove(),Ct();return}document.getElementById(Qe)||Ur()}),St.observe(e,{childList:!0,subtree:!0}))},Nr=null,zr,jc=()=>{Nr||(Nr=new MutationObserver(()=>{zr===void 0&&(zr=window.setTimeout(()=>{zr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Qe)&&!yo&&Ur()},300))}),Nr.observe(document.body,{childList:!0,subtree:!0}))},Za=()=>{jc(),Ur()};var Kc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",le="ws-crm-reduce-price-button",ei="ws-crm-reduce-price-modal",Yc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jc=/\/v2\/location\/([A-Za-z0-9]+)/,ko=()=>{let t=window.location.pathname,e=t.match(Yc);if(!e)return null;let o=t.match(Jc);return{oppId:e[1],locationId:o?o[1]:null}},Xc=async t=>{let e=await fetch(Kc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},xo=()=>{document.getElementById(ei)?.remove()},Qc=t=>{xo();let e=document.createElement("div");e.id=ei,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=ko();!r||!r.locationId||r.oppId!==t||Qc({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},ep=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tp=async()=>{for(let t of ep)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wo=!1,Kr=async()=>{if(!wo){wo=!0;try{await op()}finally{wo=!1}}},op=async()=>{let t=ko();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await tp();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=ko();if(!a||a.oppId!==t.oppId)return;let i=Zc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),rp(t.oppId)},At=null,jr=null,$t=()=>{At?.disconnect(),At=null,jr=null},rp=t=>{if(At&&jr===t)return;$t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jr=t,At=new MutationObserver(()=>{let o=ko();if(!o||o.oppId!==t){$t();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),$t();return}document.getElementById(le)||Kr()}),At.observe(e,{childList:!0,subtree:!0}))},Vr=null,Wr,np=()=>{Vr||(Vr=new MutationObserver(()=>{Wr===void 0&&(Wr=window.setTimeout(()=>{Wr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!wo&&Kr()},300))}),Vr.observe(document.body,{childList:!0,subtree:!0}))},ti=()=>{np(),Kr()};var Ze="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Eo="deals.reinvestos.com";var de="ws-crm-edit-landing-button",ap=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ip=/\/v2\/location\/([A-Za-z0-9]+)/,So=()=>{let t=window.location.pathname,e=t.match(ap);if(!e)return null;let o=t.match(ip);return{oppId:e[1],locationId:o?o[1]:null}},sp=(t,e)=>{let o=new URL(`https://${Eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ze);let r=M();return r&&o.searchParams.set("user",r),o.toString()},lp=(t,e)=>{let o=document.createElement("button");return o.id=de,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=So();if(!r||!r.locationId||r.oppId!==t)return;if(!Ze){c.warn("[edit-landing] editor session key not configured in this build");return}let a=sp(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},dp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cp=async()=>{for(let t of dp)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},To=!1,Qr=async()=>{if(!To){To=!0;try{await pp()}finally{To=!1}}},pp=async()=>{let t=So();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),It());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await cp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=So();if(!a||a.oppId!==t.oppId)return;let i=lp(t.oppId,t.locationId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),bp(t.oppId)},Lt=null,Xr=null,It=()=>{Lt?.disconnect(),Lt=null,Xr=null},bp=t=>{if(Lt&&Xr===t)return;It();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Xr=t,Lt=new MutationObserver(()=>{let o=So();if(!o||o.oppId!==t){It();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),It();return}document.getElementById(de)||Qr()}),Lt.observe(e,{childList:!0,subtree:!0}))},Yr=null,Jr,mp=()=>{Yr||(Yr=new MutationObserver(()=>{Jr===void 0&&(Jr=window.setTimeout(()=>{Jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!To&&Qr()},300))}),Yr.observe(document.body,{childList:!0,subtree:!0}))},oi=()=>{mp(),Qr()};var ni="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",et="ws-crm-publish-button",Mt="ws-crm-publish-wrap",Ao="ws-crm-publish-dropdown",hp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,up=/\/v2\/location\/([A-Za-z0-9]+)/,tn=()=>{let t=window.location.pathname,e=t.match(hp);if(!e)return null;let o=t.match(up);return{oppId:e[1],locationId:o?o[1]:null}},vp=async(t,e)=>{try{let o=await fetch(ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:M()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},_p=async(t,e)=>{let o=await fetch(ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:M()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},gp=(t,e)=>{if(!Ze){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Eo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ze);let r=M();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ge=()=>{document.getElementById(Ao)?.remove()},ri=(t,e,o,r,a)=>{ge();let i=document.createElement("div");i.id=Ao;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Pe(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let h=await vp(t,e);if(!h||!Array.isArray(h.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Pe(o,r);return}r={status:h.published?"published":h.ready?"ready":"incomplete",checks:h.checks},Pe(o,r),document.getElementById(Ao)&&r.checks&&ri(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Pe(o,r),ge();try{let h=await _p(t,e);if(h.ok&&h.published)r={status:"published"},Pe(o,r),c.info(`[publish] published opp ${t}`);else if(h.missing&&h.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Pe(o,r);else throw new Error(h.error||"Publish failed")}catch(h){let m=h instanceof Error?h.message:"Publish failed";c.error("[publish] publish failed",h),r={status:"error",message:m.length>28?"Error \u2014 try again":m},Pe(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Ao)?ge():r.checks&&ri(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let h=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});h.observe(b,{childList:!0,subtree:!0});let m=window.setInterval(()=>{document.body.contains(o)||(h.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(m))},5e3)}return o},fp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xp=async()=>{for(let t of fp)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Co=!1,rn=async()=>{if(!Co){Co=!0;try{await wp()}finally{Co=!1}}},wp=async()=>{let t=tn();if(!t||!t.locationId){document.getElementById(et)?.remove(),document.getElementById(Mt)?.remove(),ge(),Dt();return}let e=document.getElementById(et);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(Mt)?.remove(),ge(),Dt());return}e&&(e.remove(),document.getElementById(Mt)?.remove(),ge());let o=await xp();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=tn();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=yp(t.oppId,a.locationId),s=document.createElement("span");s.id=Mt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),kp(t.oppId)},Ot=null,on=null,Dt=()=>{Ot?.disconnect(),Ot=null,on=null},kp=t=>{if(Ot&&on===t)return;Dt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(on=t,Ot=new MutationObserver(()=>{let o=tn();if(!o||o.oppId!==t){Dt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(et)?.remove(),document.getElementById(Mt)?.remove(),ge(),Dt();return}document.getElementById(et)||rn()}),Ot.observe(e,{childList:!0,subtree:!0}))},Zr=null,en,Ep=()=>{Zr||(Zr=new MutationObserver(()=>{en===void 0&&(en=window.setTimeout(()=>{en=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(et)&&!Co&&rn()},300))}),Zr.observe(document.body,{childList:!0,subtree:!0}))},ai=()=>{Ep(),rn()};var ii="data:image/png;base64,",si="data:image/png;base64,";var Tp=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],li=t=>`ws-crm-map-links-${t}`,$o=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},di=t=>{let e=$o(t.addr),o=$o(t.city),r=$o(t.state),a=$o(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Sp=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Cp=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Ap=(t,e)=>{let{full:o,hasAny:r}=di(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},$p=t=>{let e=document.createElement("span");e.id=li(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),Ap(t,s)}),l};return e.appendChild(r(ii,"Open in Google Maps",Sp)),e.appendChild(r(si,"Search on Zillow",Cp)),e},Lp=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},ci=()=>{for(let t of Tp){if(document.getElementById(li(t.key)))continue;let{hasAny:e}=di(t);if(!e)continue;let o=Lp(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild($p(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},nn=null,an,Ip=()=>{nn||(nn=new MutationObserver(()=>{an===void 0&&(an=window.setTimeout(()=>{an=void 0;try{ci()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),nn.observe(document.body,{childList:!0,subtree:!0}))},pi=()=>{Ip(),ci()};var bi="ws-crm-hide-launchpad",mi=/\/launchpad\/?$/,sn=()=>{if(!me()){if(!document.getElementById(bi)){let t=document.createElement("style");t.id=bi,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(mi.test(location.pathname)){let t=location.pathname.replace(mi,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var Mp=[{label:"Buy-Box Entries"},{label:"Memberships"}],hi=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},ln=()=>{let t=me(),e=new Set(Mp.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){hi(e);for(let o of[150,500,1200,2500])setTimeout(()=>hi(e),o)}};var Op=[{from:"Payments",to:"Contracts"}],Dp=".nav-title, .topmenu-navtitle",ui=()=>{document.querySelectorAll(Dp).forEach(t=>{let e=(t.textContent||"").trim(),o=Op.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},dn=()=>{ui();for(let t of[150,500,1200,2500])setTimeout(ui,t)};var vi="/payments/proposals-estimates",Hp=/\/payments\/invoices\/?$/,Pp=/\/payments\//,Bp='#sb_payments, a[meta="payments"]',gi=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(vi)&&!(t>3&&!Pp.test(e))){if(Hp.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(vi));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>gi(t+1),120)}},_i=!1,Rp=()=>{_i||(_i=!0,document.addEventListener("click",t=>{t.target?.closest?.(Bp)&&setTimeout(()=>gi(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},cn=()=>{Rp()};var yi=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],fi="ws-crm-hide-topmenu-tabs",pn=()=>{if(document.getElementById(fi))return;let t=yi.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=fi,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${yi.length} top tabs`)};var ki="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Ee="ws-crm-send-to-closing-office-button",Be="ws-crm-send-to-title-co-wrap",Mo="ws-crm-stc-dropdown",Fp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Np=/\/v2\/location\/([A-Za-z0-9]+)/,Oo=()=>{let t=window.location.pathname,e=t.match(Fp);if(!e)return null;let o=t.match(Np);return{oppId:e[1],locationId:o?o[1]:null}},zp=5*60*1e3,Ei=t=>`ws-crm-stc-cache:${t}`,Gp=t=>{try{let e=window.localStorage.getItem(Ei(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>zp||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},qp=(t,e)=>{try{window.localStorage.setItem(Ei(t),JSON.stringify(e))}catch{}},Up=async(t,e)=>{try{let o=await fetch(ki,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Vp=async(t,e,o)=>{let r=await fetch(ki,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:M()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Wp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},xi=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},jp=(t,e)=>{if(e&&Wp(e)){window.setTimeout(()=>xi(t),300);return}xi(t)},ce=()=>{document.getElementById(Mo)?.remove()},Lo=(t,e,o)=>{ce();let r=document.createElement("div");r.id=Mo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,he(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let y=await Up(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},he(o,a);return}if(y.rate_limited){_=Date.now()+m,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},he(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},he(o,a),c.warn("[stc] dry_run returned no checks:",y);return}let g=y.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Do.add(t),document.getElementById(Ee)?.remove(),document.getElementById(Be)?.remove(),ce(),Pt();return}let w=y.checks;if(a.checks&&a.checks.length===y.checks.length){let C=new Set;w=y.checks.map((E,f)=>a.checks[f]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:y.previously_sent_at??null},qp(t,{checks:w,previously_sent_at:y.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),he(o,a),document.getElementById(Mo)&&Lo(w,y.previously_sent_at,o)},l=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},he(o,a),ce();try{let g=await Vp(t,e,y);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},he(o,a),g.checks&&Lo(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},he(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},he(o,a),g.checks&&Lo(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},he(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Mo)?ce():a.checks&&Lo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),h=1e4,m=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(d!==void 0||p)return;let w=Date.now()-b,S=Math.max(1500,h-w);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},Yp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Jp=async()=>{for(let t of Yp)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Do=new Set,wi=null,Xp=t=>{t&&t!==wi&&(Do.clear(),wi=t)},Io=!1,un=async()=>{if(Io){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Io=!0;try{await Qp()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{Io=!1}},Qp=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Oo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Ee)?.remove(),document.getElementById(Be)?.remove(),ce();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Xp(t.oppId),Do.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Ee)?.remove(),document.getElementById(Be)?.remove(),ce();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Be)?.remove(),ce(),Pt());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Be)?.remove(),ce()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Jp();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Oo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Kp(t.oppId,a.locationId),s=document.createElement("span");s.id=Be,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Zp(t.oppId)},Ht=null,hn=null,Pt=()=>{Ht?.disconnect(),Ht=null,hn=null},Zp=t=>{if(Ht&&hn===t)return;Pt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(hn=t,Ht=new MutationObserver(()=>{let o=Oo();if(!o||o.oppId!==t){Pt();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Ee)?.remove(),document.getElementById(Be)?.remove(),ce(),Pt();return}document.getElementById(Ee)||un()}),Ht.observe(e,{childList:!0,subtree:!0}))},bn=null,mn,eb=()=>{bn||(bn=new MutationObserver(()=>{mn===void 0&&(mn=window.setTimeout(()=>{mn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ee);if(t&&!e&&!Io){let o=Oo();if(o&&Do.has(o.oppId))return;un()}},300))}),bn.observe(document.body,{childList:!0,subtree:!0}))},Ti=()=>{eb(),un()};var gn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",tb=`${gn}/tc/welcome-call-prefill`,ob=`${gn}/tc/welcome-call-save`,rb=`${gn}/tc/order-lockbox`,Bt="ws-crm-welcome-call-overlay",nb=["Regular Contract","Subject To","Seller Finance","Novation"],ab=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],ib=["Gas","Electric","Propane","Oil"],sb=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],lb=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Te=["Yes","No"],db=["Yes","No","Unknown"],cb=["Professional Photographer","Seller","Tenant"],pb=["Month-to-Month","Annual"],Si=["Current","Behind"],bb=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ue=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Po=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,$i="margin-bottom:12px;",Li=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,mb=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,Ci=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=Ci(o);return`<select id="${t}" style="${Po}"><option value=""></option>${e.map(a=>`<option ${r!==""&&Ci(a)===r?"selected":""}>${ue(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${ue(e)}" placeholder="${ue(o)}" style="${Po}">`,hb=(t,e)=>`<textarea id="${t}" rows="3" style="${Po}resize:vertical;">${ue(e)}</textarea>`,ub=(t,e)=>`<input id="${t}" type="date" value="${ue(e)}" style="${Po}">`,D=(t,e)=>`<div style="${$i}"><label style="${Li}">${ue(t)}</label>${e}</div>`,vn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${bb.map(r=>`<label style="${mb}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ye=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ue(t)}</div>`,tt=()=>{document.getElementById(Bt)?.remove()},Re=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},vb=t=>{let e=t.tenant||{};return`
    ${ye("Identifiers")}
    ...
    ${ye("Contract")}
    ${D("Type of Contract",j("wc-contract_type",nb,t.contract_type))}

    ${ye("Property")}
    ${D("Property Type",j("wc-property_type",sb,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",ab,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",ib,t.heat_source))}
    ...
    ${ye("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",lb,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",pb,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${D("Last rent paid",ub("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",db,t.hoa_rental_restriction))}</div>

    ${ye("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",cb,t.photos_provided_by))}
    <div style="${$i}">
  ...
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},_n=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Ai=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Ho=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?ue(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},_b=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:_n("photos_avail_mornings"),photos_avail_afternoons:_n("photos_avail_afternoons"),photos_avail_evenings:_n("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),gb=t=>{tt();let e=document.createElement("div");e.id=Bt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${vb(t)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Lb=(t,e)=>{Ce();let o=document.createElement("div");o.id=Di;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Ro=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=O,o.textContent=t,o},Ib=()=>{let t=Ro("\u22EE","ghost");return t.style.lineHeight="1",t},Mb=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Bi){let r=Ro("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Sb(t)),o.appendChild(r),o}if(e===Cn){let r=Ro("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>$b(t,r)),o.appendChild(r),o}if(e===Ri){let r=Ro("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Ni(t)),o.appendChild(r),o}return null},Ob=(t,e)=>{let o=[];if(e===Cn&&(o=[{label:"Re-order Lockbox",onClick:()=>void Ni(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Oi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Ib();return a.addEventListener("click",i=>{i.stopPropagation(),Lb(o,a)}),r.appendChild(a),r},Db=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Hb=async()=>{for(let t of Db)try{let e=await I(t,{timeoutMs:1200});if(e)return e}catch{}return null},Bo=()=>{document.getElementById(kn)?.remove(),document.getElementById(Oi)?.remove(),Ce()},Fo=!1,An=async()=>{if(!Fo){Fo=!0;try{let t=Fi();if(!t){Bo();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Bo();return}let o=Tb(),r=document.getElementById(kn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Mb(t,o);if(!a){Bo();return}let i=await Hb();if(!i)return;Bo();let s=U(i),l=document.createElement("span");l.id=kn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ob(t,o);d&&s.appendChild(d),Pb(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Fo=!1}}},Rt=null,Tn=null,fn,Mi=()=>{Rt?.disconnect(),Rt=null,Tn=null},Pb=t=>{if(Rt&&Tn===t)return;Mi();let e=document.querySelector(Pi);e&&(Tn=t,Rt=new MutationObserver(()=>{let o=Fi();if(!o||o.oppId!==t){Mi();return}fn===void 0&&(fn=window.setTimeout(()=>{fn=void 0,An()},250))}),Rt.observe(e,{childList:!0,subtree:!0}))},xn=null,wn,Bb=()=>{xn||(xn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Fo&&An()},300))}),xn.observe(document.body,{childList:!0,subtree:!0}))},zi=()=>{Bb(),An()};var Gi="ws-support-modal",qi="ws-support-toast",Rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ui="ws-support-submitter-name",Vi="ws-support-submitter-email",Wi="ws-support-submitter-role",Fb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Fe=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Nb=(t,e="success",o)=>{let r=document.getElementById(qi);r&&r.remove();let a=document.createElement("div");a.id=qi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},zb=()=>{document.getElementById(Gi)?.remove();let t=(localStorage.getItem(Ui)??"").trim(),e=(localStorage.getItem(Vi)??"").trim(),o=(localStorage.getItem(Wi)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Gi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=h=>{l&&(l.textContent=h)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ui,r.submitterName),localStorage.setItem(Vi,r.submitterEmail),r.submitterRole&&localStorage.setItem(Wi,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let m=await(await fetch(Rb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:M()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!m.ok){d(m.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=m.ticket_short_id||"submitted";Nb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){d(`Network error: ${h.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Gb=["/support-ticket","ws-support-modal","ws-support"],qb=/\/custom-menu-link\//,$n=!1,ji=()=>{if($n||!qb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Gb.some(s=>i.includes(s))});if(r){$n=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{zb(),$n=!1},50);return}t<10&&setTimeout(e,150)};e()},Ki=!1,Yi=()=>{Ki||(Ki=!0,be(()=>setTimeout(ji,50)),ji(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Ji="ws-phone-assignments-modal",Xi="ws-phone-assignments-toast",Ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Vb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Wb=["ACQ","DISPO","TC"],es="",Ae=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),jb=(t,e="success",o)=>{document.getElementById(Xi)?.remove();let r=document.createElement("div");r.id=Xi;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Ae(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Ae(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Kb=(t,e,o)=>{let r=[`<option value="" ${o===es?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Ae(a)}" ${o===a?"selected":""}>${Ae(a)}</option>`)].join("");return`<select data-assign="${Ae(t)}" style="
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",m=>{m.target===o&&o.remove()}),!e){let m=r.querySelector("#ws-pa-body");m&&(m.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Ub}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(m){c.error("[phone-assignments] GET failed",m);let _=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Ae(m.message)}). The backend may not be wired yet.</span>`);return}let i=a.teams&&a.teams.length?a.teams:Wb,s=a.numbers??[],l={...a.config?.numberTeam??{}},d=m=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${m} found.</div>`,p=s.length?s.map(m=>`<div style="${Yb}">
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(m=>{m.addEventListener("change",()=>{let _=m.getAttribute("data-assign")||"",[x,...k]=_.split(":"),y=k.join(":");x==="num"&&(m.value?l[y]=m.value:delete l[y])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let m=h.querySelector("#ws-pa-err"),_=k=>{m&&(m.textContent=k)};_("");let x=h.querySelector("#ws-pa-save");x&&(x.disabled=!0,x.textContent="Saving\u2026",x.style.opacity="0.7");try{let y=await(await fetch(Vb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:l})})).json();if(!y.ok){_(y.error||"Save failed."),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1");return}o.remove(),jb("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){_(`Network error: ${k.message}`),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1")}}))},Jb=["ws-phone-assignments","phone-assignments"],Xb=/\/custom-menu-link\//,Ln=!1,Qi=()=>{if(Ln||!Xb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Jb.some(s=>i.includes(s))});if(r){Ln=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),i=a?a[1]:void 0;c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${i})`);try{history.back()}catch{}setTimeout(()=>{In(i),Ln=!1},50);return}t<10&&setTimeout(e,150)};e()},Zi=!1,ts=()=>{if(Zi)return;Zi=!0,be(()=>setTimeout(Qi,50)),Qi();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&In()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void In(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var rs="powerDialerApp",Qb=".dialer",Zb='button[aria-label="Voice Calling"], button[title="Voice Calling"]',em=".dial-item.dial-btn.dial-btn-enabled",Ne=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Mn=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},ns=()=>{try{let e=window[rs]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){c.debug("[dialer-bridge] getEmitter failed",t)}return null},ot=()=>document.querySelector(Qb),as=()=>ns()!==null||ot()!==null?!0:!!window[rs],No=(t,e)=>{let o=ns();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return c.error(`[dialer-bridge] emit ${t} threw`,r),!1}},is=()=>{if(ot())return;let t=document.querySelector(Zb);t?Ne(t):c.warn("[dialer-bridge] Voice Calling button not found")},tm=()=>{let t=document.querySelector(".number-list-container")||ot();if(!t)return[];let e=[...t.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of e){let i=Mn(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},os=()=>{let t=document.querySelector(".number-config .ui-text-sm-medium");if(t){let o=Mn(t.innerText);if(o)return o}let e=document.querySelector(".number-config");return e?Mn(e.innerText):null},ss=t=>{if(os()===t)return!0;let e=document.querySelector(".number-config, .dialer-config");e&&Ne(e);let o=tm().find(r=>r.e164===t);return o?(Ne(o.el),os()===t):(c.warn(`[dialer-bridge] Calling From ${t} not available to this rep`),!1)},ls=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(t=>/local/i.test(t.innerText||""))||null,om=()=>{let t=ls();return t?!/bg-gray-100/.test(t.className):!1},ds=t=>{let e=ls();e&&om()!==t&&Ne(e)},cs=t=>{let e=t.replace(/[^\d*#+]/g,"");if(No("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&Ne(a)}},ps=()=>{let t=ot();if(!t)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(em)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Ne(e),!0):No("makeCall",{provider:"twilio"})};var On=()=>{let t=ot();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Ne(e.closest("button")||e):No("closeCallBox")},bs=()=>{No("closeCallBox")},ms=t=>{let e=!1,o=()=>{let i=ot()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(e=!0),e&&l){e=!1;try{t()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var rm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",nm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",hs=["acq","dispo","tc"],Nt={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Ft=null,us=null,am=async(t=!1)=>{let e=re();if(!e)return{};if(!t&&Ft&&us===e)return Ft;try{return Ft=(await(await fetch(`${rm}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json())?.config?.numberTeam??{},us=e,Ft}catch(o){return c.warn("[silo] number-team config load failed",o),Ft??{}}},ze=null,vs=null,Dn=async(t=!1)=>{let e=re(),o=M();if(!e||!o)return[];if(!t&&ze&&vs===e)return ze;try{let i=(await(await fetch(nm,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(s=>s.id===o);if(i){let s=i.role_keys??[];ze=hs.filter(l=>s.includes(l))}else me()?ze=[...hs]:ze=[];return vs=e,ze}catch(r){return c.warn("[silo] roster load failed",r),ze??[]}},gs=()=>`ws-pd-calling-as:${M()||"anon"}`,ys=t=>{try{localStorage.setItem(gs(),t)}catch{}},Hn=async()=>{let t=await Dn();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(gs())}catch{}return e&&t.includes(e)?e:t[0]},_s=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},im=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),fs=async t=>{let e=await Hn();if(!e)return c.debug("[silo] no active team for current rep; leaving GHL default"),null;let o=await am(),r=im(o,e);if(!r.length)return c.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let a=_s(t),i=a?r.find(d=>_s(d)===a):void 0,s=i||r[0];try{ds(!1)}catch{}return ss(s)?(c.info(`[silo] ${Nt[e]}: calling ${t} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} (not in this rep's picker?)`),null)};var sm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",xs="data-ws-pd",ws="ws-pd-panel",ks="ws-pd-session",Ge=t=>new Promise(e=>setTimeout(e,t)),zt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),lm=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},dm=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},cm=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),e.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},pm=async t=>{let e=lm(t);if(!e)return[];let o=dm(e),r=-1;for(let a=0;a<60;a++){let i=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ge(550)}return o.scrollTop=0,cm(e)},bm=async(t,e)=>{try{let r=await(await fetch(sm,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},mm=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,hm=(t,e)=>{document.getElementById(ws)?.remove();let o=document.createElement("div");o.id=ws,o.style.cssText=mm;let r=document.createElement("div");r.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let a=e.map((d,p)=>`<label data-row="${p}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,i.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{On()}catch{}i.remove()}),i.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{On()}catch{}}),i.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),i.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let l=0;l<e.length&&!a.stopped;l++){let d=e[l];a.skip=!1,a.advance=!1,s("Resolving number\u2026",l,d.name);let p=d._phone?{name:d.name,phone:d._phone}:await bm(r,d.contactId);if(a.stopped)break;if(!p||!p.phone){s("No phone on file \u2014 skipping",l,d.name||p?.name||d.contactId),await Ge(1400);continue}let b=p.name||d.name;if(await fs(p.phone),a.stopped)break;s(`Calling ${p.phone}\u2026`,l,b);try{is(),await Ge(250),cs(p.phone),await Ge(250),ps()}catch(h){c.error("[bulk-dialer] dial failed",h)}if(await new Promise(h=>{let m=!1,_=()=>{m||(m=!0,x(),h())},x=ms(_),k=window.setInterval(()=>{(a.stopped||a.skip)&&(window.clearInterval(k),_())},300)}),a.stopped)break;try{bs()}catch{}if(l<e.length-1)if(o)for(let h=5;h>0&&!a.stopped&&!a.advance;h--){for(s(`Next call in ${h}s\u2026`,l,b);a.paused&&!a.stopped&&!a.advance;)await Ge(200);if(a.advance||a.stopped)break;await Ge(1e3)}else for(s("Ready \u2014 press Call Next",l,b);!a.advance&&!a.stopped;)await Ge(200)}a.stopped||(i.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>i.remove(),5e3))},um='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',vm=()=>{try{if(localStorage.getItem("ws-pd")==="1")return!0}catch{}return me()},_m=()=>{if(_a()!=="opportunity-list"||!vm()||!as())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${xs}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(xs,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${um}<span>DIAL</span>`,a.addEventListener("click",async i=>{i.stopPropagation(),i.preventDefault();let s=a.querySelector("span"),l=s?.textContent||"DIAL";s&&(s.textContent="Loading\u2026"),a.style.opacity="0.7";try{let d=await pm(e);hm(r,d)}catch(d){c.error("[bulk-dialer] harvest failed",d)}finally{s&&(s.textContent=l),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},rt=null,Pn,Ts=()=>{window.WS_CRM_PD_TEST=e=>void Es("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Pn!==void 0&&window.clearTimeout(Pn),Pn=window.setTimeout(_m,400)};be(e=>{e==="opportunity-list"?(t(),rt||(rt=new MutationObserver(t),rt.observe(document.body,{childList:!0,subtree:!0}))):rt&&(rt.disconnect(),rt=null)})};var zo="ws-calling-as-chip",gm=()=>{try{if(localStorage.getItem("ws-pd")==="1")return!0}catch{}return me()},Bn=!1,Ss=async()=>{if(!Bn&&gm()&&!document.getElementById(zo)){Bn=!0;try{let t=await Dn();if(!t.length||document.getElementById(zo))return;let e=await Hn()??t[0],o=t.length>1,r=document.createElement("div");r.id=zo,r.style.cssText="position:fixed;bottom:60px;right:20px;z-index:99998;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:8px;padding:7px 12px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${u.sans};font-size:12px;box-shadow:0 6px 18px rgba(0,0,0,0.35);cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${u.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Nt[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let i=s=>{let l=a.querySelector(".ws-ca-team");l&&(l.textContent=Nt[s])};if(o){let s=document.createElement("div");s.style.cssText=`position:absolute;bottom:calc(100% + 6px);right:0;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;`;let l=()=>{s.innerHTML="",t.forEach(d=>{let p=document.createElement("div"),b=d===e;p.style.cssText=`padding:9px 14px;font-family:${u.sans};font-size:13px;color:${b?n.emeraldBright:n.bone};cursor:pointer;background:${b?n.emeraldGlow:"transparent"};`,p.textContent=Nt[d],p.addEventListener("mouseenter",()=>{d!==e&&(p.style.background=n.steel)}),p.addEventListener("mouseleave",()=>{d!==e&&(p.style.background="transparent")}),p.addEventListener("click",h=>{h.stopPropagation(),e=d,ys(d),i(d),l(),s.style.display="none"}),s.appendChild(p)})};l(),r.appendChild(s),a.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="block"?"none":"block"}),document.addEventListener("click",()=>{s.style.display="none"})}document.body.appendChild(r),c.info(`[calling-as] chip mounted (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){c.error("[calling-as] build failed",t)}finally{Bn=!1}}},Cs=()=>{Ss(),be(()=>{document.getElementById(zo)||Ss()})};var As="template-power-dialer",$s="#12161D",Ls="#EDEEF0",Is=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],i=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&i>=230},ym=t=>{Is(t)&&(t.style.setProperty("background-color",$s,"important"),t.style.setProperty("color",Ls,"important"));let e=t.querySelectorAll("*");for(let o of e)Is(o)&&(o.style.setProperty("background-color",$s,"important"),o.style.setProperty("color",Ls,"important"))},Ms=!1,Os=()=>{if(Ms)return!0;let t=document.getElementById(As);if(!t)return!1;Ms=!0;let e=!1,o=()=>{e=!1;try{ym(t)}catch(i){c.debug("[dialer-theme] paint failed",i)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};return new MutationObserver(r).observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),c.info("[dialer-theme] fast white-flash guard attached to #"+As),!0},Ds=!1,Hs=()=>{if(Ds||(Ds=!0,Os()))return;let t=0,e=window.setInterval(()=>{t+=1,(Os()||t>60)&&window.clearInterval(e)},250)};var fm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",xm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",wm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Rs="tc_closing_agent",km="tc_closing_office",pe="ws-crm-closing-agent-picker-button",Fs="ws-crm-closing-agent-picker-modal",Em=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Tm=/\/v2\/location\/([A-Za-z0-9]+)/,Ut=()=>{let t=window.location.pathname,e=t.match(Em);if(!e)return null;let o=t.match(Tm);return{oppId:e[1],locationId:o?o[1]:null}},Vn=async t=>{let e=await fetch(fm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ps=async t=>{let e=await fetch(xm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Sm=async(t,e)=>{try{let o=await fetch(wm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Rs}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Vn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},qe=null,Cm=60*60*1e3,Wn=t=>`ws-crm-to-cache:${t}`,Ns=t=>{try{let e=window.localStorage.getItem(Wn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Cm||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},zs=(t,e,o)=>{try{window.localStorage.setItem(Wn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Am=t=>{try{window.localStorage.removeItem(Wn(t))}catch{}},zn="ws-crm-closing-agent-field-link",$m=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${zn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Rn=!1,jn=async t=>{if(Rn)return;let e=Gs();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Rn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Vn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Gn(a.id,a.name,t);let i=document.getElementById(pe);if(i){$e(i,{status:"linked",contactName:a.name});let s=Ut();s&&zs(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Rn=!1}}},Lm=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Gs=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();Lm.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let h=d.getAttribute(b);h&&/Title\s+Officer/i.test(h)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:h})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Gn=(t,e,o)=>{let r=Gs();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${zn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=zn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Go=()=>{document.getElementById(Fs)?.remove()},Im=t=>{Go();let e=document.createElement("div");e.id=Fs,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};$e(o,r);let a=Ns(t);return a&&(r={status:"linked",contactName:a.contactName},$e(o,r),qe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Sm(t,e);s?(r={status:"linked",contactName:s.name},$e(o,r),qe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Gn(s.id,s.name,e)):a||(r={status:"empty"},$e(o,r),qe?.oppId===t&&(qe=null),$m(),Am(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Im({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},$e(o,r);try{let l=[Ps({tenantId:e,oppId:t,fieldKey:Rs,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ps({tenantId:e,oppId:t,fieldKey:km,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},$e(o,r),qe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},zs(t,s.id,s.name),Gn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},$e(o,r)}}})}),o},Om=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Dm=async()=>{for(let t of Om)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Gt=!1,Vo=async()=>{if(!Gt){Gt=!0;try{await Hm()}finally{Gt=!1}}},Hm=async()=>{let t=Ut();if(!t||!t.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Uo();return}let e=document.getElementById(pe);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove(),Uo());return}e&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Dm();if(!r||!(Ns(t.oppId)!==null||qe!==null&&qe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Ut();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Mm(t.oppId,i.locationId),l=document.createElement("span");l.id=`${pe}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Pm(t.oppId),jn(i.locationId)},qt=null,qn=null,Un=null,Uo=()=>{qt?.disconnect(),qt=null,qn=null,Un=null},Pm=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(qt&&qn===t&&Un===e||(Uo(),qn=t,Un=e,qt=new MutationObserver(()=>{let o=Ut();if(!o||o.oppId!==t||!o.locationId){Uo();return}document.getElementById(pe)||Vo(),jn(o.locationId)}),qt.observe(e,{childList:!0,subtree:!0})))},Fn=null,Nn,Bm=()=>{Fn||(Fn=new MutationObserver(()=>{Nn===void 0&&(Nn=window.setTimeout(()=>{Nn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(pe);t&&!e&&!Gt&&Vo()},300))}),Fn.observe(document.body,{childList:!0,subtree:!0}))},Bs,Rm=()=>{Bs===void 0&&(Bs=window.setInterval(()=>{let t=Ut();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(pe)&&!Gt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Vo()),jn(t.locationId)},2e3))},qs=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Bm(),Rm(),Vo()};var Fm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ie="ws-crm-manage-team-cta",Us="ws-crm-manage-team-modal",Nm=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Vs={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},zm={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ws=()=>{let t=window.location.pathname.match(Nm);return t?{tenantId:t[1]}:null},jo=async t=>{let e=await fetch(Fm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ae=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Le=t=>ae(t),Kn="ws-crm-manage-team-toast",Xn=(t,e="info",o=4e3)=>{document.getElementById(Kn)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Kn,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Kn)===a&&a.remove()},o)},Yn=()=>{document.getElementById(Us)?.remove()},Gm=(t,e)=>{let o=zm[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ae(e)}</span>
  `},qm=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Gm(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>qm(r,e)).join(""),Ko=async t=>{Yn();let e=document.createElement("div");e.id=Us,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Yn);let r;try{r=await jo({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Um(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Vm(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;Wm(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;jm(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Vm=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ae(Vs[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Ko(t)}),Wo(e),setTimeout(()=>Wo(e),200),setTimeout(()=>Wo(e),800),window.addEventListener("resize",()=>Wo(e)),e},Jn=!1,oh=()=>{if(!Jn){Jn=!0;try{let t=Ws();if(!t){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}let e=document.getElementById(Ie);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ie}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ie}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=th(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Jn=!1}}},js=()=>{if(!Ws()){document.getElementById(Ie)?.remove(),document.getElementById(`${Ie}-floater`)?.remove();return}oh()};var rh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ea="ws-crm-prepare-contract-button",Ks="ws-crm-prepare-contract-menu",_e="ws-crm-prepare-contract-modal",Ys="ws-crm-modal-date-style",fe="https://services.leadconnectorhq.com",tl=()=>{if(document.getElementById(Ys))return;let t=document.createElement("style");t.id=Ys,t.textContent=`
  ...
  `,document.head.appendChild(t)},ta="__WS_CRM_CAPTURED_AUTH",nh=50*60*1e3,Qo=()=>{try{let t=localStorage.getItem(ta);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>nh?(localStorage.removeItem(ta),null):e:null}catch{return null}},ah=t=>{try{localStorage.setItem(ta,JSON.stringify(t))}catch{}},at=()=>{let t=Qo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Js=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Qo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),nt=async(t,e={},o=2)=>{let r=Qo()?.capturedAt??0,a;try{a={...at(),...e.headers??{}}}catch(s){if(o>0&&await Js(r,4e3))return nt(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await Js(r,4e3)?nt(t,e,o-1):i},Xs=!1,ih=()=>{if(Xs)return;Xs=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let h=d["token-id"]||d["Token-Id"]||void 0,m=Qo()?.authorization;ah({authorization:b,tokenId:h,capturedAt:Date.now()}),m!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let h={};if(b instanceof Headers)b.forEach((m,_)=>h[_.toLowerCase()]=m);else if(Array.isArray(b))b.forEach(([m,_])=>h[m.toLowerCase()]=_);else if(b&&typeof b=="object")for(let m of Object.keys(b))h[m.toLowerCase()]=b[m];e(d,h,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ol=()=>{let t=R();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},sh=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ol()},lh=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},rl="__WS_CRM_TEMPLATES_CACHE_V1",dh=24*60*60*1e3,Qs=t=>{try{let e=window.localStorage.getItem(rl);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>dh?null:o.templates}catch{return null}},ch=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(rl,JSON.stringify(o))}catch{}},ph=async t=>{let e=`${fe}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await nt(e,{method:"GET"})}catch(s){let l=Qs(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Qs(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:lh(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&ch(t,i),i},bh=async(t,e)=>{let o=await nt(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await nt(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},mh=async(t,e)=>{let o=await nt(`${fe}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${fe}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:at()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},hh=async t=>{let e=await fetch(rh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},uh=async(t,e,o)=>{let r=`${fe}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:at()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},vh=async(t,e)=>{let o=await fetch(`${fe}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:at()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},_h=async t=>{let e=await fetch(`${fe}/contacts/${t}`,{method:"GET",headers:at()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},gh=async(t,e,o,r)=>{let a;try{a=await vh(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await _h(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},m=await fetch(`${fe}/proposals/document/${e}`,{method:"PUT",headers:{...at(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!m.ok){let _=await m.text().catch(()=>"");return{ok:!1,status:m.status,body:_}}return{ok:!0}},yh=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Jo="__WS_CRM_PENDING_INSTRUCTIONS",fh=60*1e3,xh=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],wh=t=>{let e=(t||"").toLowerCase();for(let o of xh)if(e.includes(o.matches.toLowerCase()))return o;return null},kh=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Jo,JSON.stringify(r))}catch{}},Eh=()=>{try{let t=localStorage.getItem(Jo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>fh?(localStorage.removeItem(Jo),null):e}catch{return null}},Th=()=>{try{localStorage.removeItem(Jo)}catch{}},Sh=(t,e)=>{document.getElementById(_e)?.remove();let o=document.createElement("div");o.id=_e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Ch=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Ah=()=>{let t=window.location.pathname.match(Ch);if(!t)return;let e=t[1],o=Eh();o&&o.proposalId===e&&(Th(),window.setTimeout(()=>{Sh(o.title,o.bodyHtml)},600))},Zs="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(Zs)?.remove();let r=document.createElement("div");r.id=Zs;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},el=(t,e)=>new Promise(o=>{document.getElementById(_e)?.remove();let r=document.createElement("div");r.id=_e,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,y.appendChild(g),document.body.appendChild(y);let q=g.querySelector("#ws-pc-purchase-price"),z=g.querySelector("#ws-pc-emd"),N=g.querySelector("#ws-pc-cash-at-close"),B=!1;N?.addEventListener("input",()=>{B=!0});let xe=()=>{if(B)return;let V=Number(q?.value||0),J=Number(z?.value||0);N&&(N.value=String(Math.max(0,V-J)))};q?.addEventListener("input",xe),z?.addEventListener("input",xe);let we=()=>y.remove();y.addEventListener("click",V=>{V.target===y&&we()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",we);let ee=g.querySelector("#ws-pc-submit"),oe=g.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){oe&&(oe.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let V=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(q?.value||0),st=Number(z?.value||0),lt=Number(N?.value||0),dt=(g.querySelector("#ws-pc-days-to-close")?.value??"").trim(),ct=(g.querySelector("#ws-pc-inspection-days")?.value??"").trim(),pt=(g.querySelector("#ws-pc-additional-terms")?.value??"").trim(),We=(g.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),bt=(g.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),st!==d&&(X.emd=st),lt!==p&&(X.cashAtClose=lt),dt!==b&&(X.daysToClose=dt),ct!==h&&(X.inspectionDays=ct),pt!==m&&(X.additionalTerms=pt),We!==_&&(X.currentOccupancy=We),bt!==x&&(X.occupancyAtClose=bt),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),ee.textContent="Saving\u2026";let dr=M(),cr=await Xo({tenantId:t,contactId:e,template:o,userId:dr,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",cr),ee.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await na(t,e,o,Q)}catch(V){ee.disabled=!1,ee.textContent="Open Contract",oe&&(oe.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},Lh=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(_e)?.remove(),tl();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",h=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,m=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",y=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",g=s,w=l,S="",C=document.createElement("div");C.id=_e,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),B=E.querySelector("#ws-pc-assignment-fee"),xe=!1;B?.addEventListener("input",()=>{xe=!0});let we=()=>{if(xe)return;let J=Number(N?.value||0);B&&(B.value=String(Math.max(0,J-x)))};N?.addEventListener("input",we);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(N?.value||0),lt=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),dt=Number(B?.value||0),ct=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),pt=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),We=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),bt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!We){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),st!==h&&(Q.assignmentPrice=st),lt!==m&&(Q.buyerEMD=lt),dt!==_&&(Q.assignmentFee=dt),ct!==k&&(Q.closingOffice=ct),pt!==y&&(Q.buyerCompanyName=pt);let dr=We!==g||bt!==w||X!==S,cr=Object.keys(Q).length>0||dr,pr=a;cr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",pr=await Xo({tenantId:t,contactId:e,template:o,oppId:r,closingDate:We,buyerEarnestDueDate:bt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",pr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let ma=pr?.debug?.propertyAddress||p,Nl=ma?`${ma} - Assignment Agreement`:void 0;await na(t,e,o,Nl),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},Xo=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await hh({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},na=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await uh(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await gh(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=wh(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),kh(a,s.title,s.bodyHtml)),yh(t,a)},Ih=async t=>{let e=sh(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(Ks)?.remove();let o=document.createElement("div");o.id=Ks,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await ph(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=M();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let g;try{g=await mh(e.tenantId,e.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)b=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let w=await el(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}b=w,c.info(`[prepare-contract] picked MT opp ${b}`)}}let h=g=>{let w=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),C=String(g.getDate()).padStart(2,"0");return`${w}-${S}-${C}`},m=g=>{let w=new Date;return w.setDate(w.getDate()+g),h(w)},_=m(45),x=m(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await Xo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let y=e.contactId||k.contact_id||"";if(!y){Y("Could not resolve buyer contact for this opp.","error",6e3);return}Lh({tenantId:e.tenantId,contactId:y,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await bh(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(b.length===1)h=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await el(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}h=_,c.info(`[prepare-contract] picked ACQ opp ${h}`)}Y("Reading contract data\u2026","info",2500);let m;try{m=await Xo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:h,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}$h({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:m})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await na(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},nl=()=>{let t=document.createElement("button");return t.id=ea,t.type="button",t.style.cssText=`${O} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Ih(t)}),t},Mh="ws-crm-contact-actions-bar",Oh=async()=>{let t=ol();if(!t){document.getElementById(ea)?.remove();return}let e=null;try{e=await I(`#${Mh}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(ea);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=nl();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ue="ws-crm-prepare-contract-button-opp",Vt=`${Ue}-wrap`,Dh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hh=/\/v2\/location\/([A-Za-z0-9]+)/,Ph=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],oa=()=>{let t=window.location.pathname,e=t.match(Dh);if(!e)return null;let o=t.match(Hh);return o?{oppId:e[1],tenantId:o[1]}:null},Bh=async()=>{for(let t of Ph)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Yo=!1,Wt=null,ra=null,Qn=null,Zn,jt=()=>{Wt?.disconnect(),Wt=null,ra=null},Rh=t=>{if(Wt&&ra===t)return;jt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ra=t,Wt=new MutationObserver(()=>{let o=oa();if(!o||o.oppId!==t){jt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ue)?.remove(),document.getElementById(Vt)?.remove(),jt();return}document.getElementById(Ue)||al()}),Wt.observe(e,{childList:!0,subtree:!0}))},Fh=()=>{Qn||(Qn=new MutationObserver(()=>{Zn===void 0&&(Zn=window.setTimeout(()=>{Zn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ue);t&&!e&&!Yo&&al()},300))}),Qn.observe(document.body,{childList:!0,subtree:!0}))},al=async()=>{if(!Yo){Yo=!0;try{let t=oa();if(!t){document.getElementById(Ue)?.remove(),document.getElementById(Vt)?.remove(),jt();return}let e=document.getElementById(Ue);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Vt)?.remove(),jt());return}e&&(e.remove(),document.getElementById(Vt)?.remove());let o=await Bh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=oa();if(!a||a.oppId!==t.oppId)return;let i=nl();i.id=Ue,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Vt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Rh(t.oppId)}finally{Yo=!1}}},il=()=>{Ah(),Oh()};ih();function te(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ve(t){return te(t)}var Nh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",Ve="ws-crm-compute-offer-button",sa="ws-crm-compute-offer-popover",hl="ws-crm-offer-modal",sl="ws-crm-contact-actions-bar",zh=[".central-panel","[class*='central-panel']"],Me=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",aa=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},Gh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ll=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${Gh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},dl=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,ia=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(Nh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},it=()=>{document.getElementById(sa)?.remove(),document.removeEventListener("mousedown",ul,!0)};function ul(t){let e=document.getElementById(sa),o=document.getElementById(Ve),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&it()}var vl=(t,e)=>{it();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=sa;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",ul,!0),0)},Zo=(t,e)=>{vl(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},qh=(t,e,o)=>{vl(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{it(),o(a.property_record_id)}),r.appendChild(i)})})},er=()=>{document.getElementById(hl)?.remove(),document.removeEventListener("keydown",_l,!0)};function _l(t){t.key==="Escape"&&er()}var cl=(t,e,o)=>{er(),it();let r=o,a=!1,i="",s=document.createElement("div");s.id=hl,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&er()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,h,m)=>{a||(a=!0,i="",p(),ia({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:h,repairOverride:m}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,h=!!b.has_comps;l.innerHTML="";let m=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"-"));let x=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",er),m.append(_,x),l.appendChild(m);let k=F("div","padding:14px 18px 18px;");l.appendChild(k);let y=F("select",dl());(b.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(b.tier||b.property_condition)&&(N.selected=!0),y.appendChild(N)}),y.disabled=a,y.addEventListener("change",()=>d("recompute",y.value,g.value.trim()));let g=F("input",dl());g.type="number",g.placeholder="uses the level",g.value=b.repair_override!=null?String(b.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",y.value,g.value.trim()));let w=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(F("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${ll(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",y.value,g.value.trim())),w.append(S),k.appendChild(w),b.low_confidence&&h&&k.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${b.comp_count??0} comps in window.`));let C=b.current_offer!=null;k.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${Me(b.current_offer)}${b.current_offer_date?` \xB7 ${ll(b.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),f=F("div","");f.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),f.appendChild(y);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(f,T),k.appendChild(E);let $=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),P=(z,N,B)=>{let xe=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${B?.strong?"font-weight:700;":""}`),we=F("div","");we.appendChild(F("div",`font-size:${B?.strong?"13":"12"}px;color:${n.bone};`,z)),B?.sub&&we.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,B.sub));let ee=F("div",`font-size:${B?.strong?"15":"12"}px;color:${B?.color||n.bone};white-space:nowrap;`,N);xe.append(we,ee),$.appendChild(xe)};if(h&&b.imv!=null){P("Investor Market Value (IMV)",Me(b.imv)),b.arv!=null&&P("After Repair Value (ARV)",Me(b.arv),{color:n.ash});let z=b.repair_adjustment??0,N=-z,B=b.repair_override?"Repair override":b.property_condition_label||"Repairs";z===0?P(`Repairs (${B})`,"Included",{color:n.ash,sub:`${Me(b.repair_total)} in repairs included at IMV`}):P(`Repairs (${B})`,aa(N),{color:N<0?n.crimson:n.emerald,sub:`${Me(b.repair_total)} total, ${Me(b.baseline_repairs)} included at IMV`}),P("Min. Profit Target",aa(-(b.profit_target??0)),{color:n.ash}),P("Maximum Cash Offer (MAO)",Me(b.mao),{strong:!0,color:n.blue}),P("Target Profit",aa(-(b.ico_delta??0)),{color:n.ash}),P("Initial Cash Offer (ICO)",Me(b.ico),{strong:!0,color:n.blue})}else $.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild($);let q=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);q.textContent=a?"Saving\u2026":i||(h?"Saved to the Property.":""),k.appendChild(q)}p(),document.body.appendChild(s),document.addEventListener("keydown",_l,!0)},pl=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=Ve,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){qh(o,s.properties,l=>{a(!0),ia({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?cl(e,d.property_record_id,d):Zo(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Zo(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?cl(e,s.property_record_id,s):Zo(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await ia({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Zo(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Uh=async()=>{for(let t of zh)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},bl=async(t,e)=>{let o=e.querySelector(`#${sl}`);if(!o)try{o=await I(`#${sl}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},ml=()=>{let t=document.querySelectorAll(`#${Ve}`);for(let e=1;e<t.length;e++)t[e].remove()},Vh=async()=>{let t=R();if(!t||!t.locationId||t.source!=="url"){document.getElementById(Ve)?.remove(),it();return}let e=t.locationId,o=document.getElementById(Ve);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),it();let r="seller";try{r=Ke(await je(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Ve)?.remove();return}let a=await Uh();if(!a){c.warn("[compute-offer] no central panel found");return}let i=R();if(!i||i.contactId!==t.contactId)return;let s=pl(t.contactId,e);if(!await bl(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}ml(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(R()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(Ve)){let d=pl(t.contactId,e);bl(d,a).then(()=>ml())}});l.observe(a,{childList:!0})},Kt=null,gl=()=>{let t=R()?.contactId??null;if(Kt&&Kt.id===t)return;let e=Vh().finally(()=>{Kt?.promise===e&&(Kt=null)});Kt={id:t,promise:e}};var Qt="reos-theme-stylesheet",pa="reos-theme-fonts",Zt=!1,Wh=()=>{let t=document.getElementById(pa);t&&t.remove()},jh=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var L=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Fl=()=>{c.info(`Loaded v${ro} (built ${no})`),br()?c.info(`[main] excluded location ${re()} \u2014 skipping initial mounts, tracking nav only`):(L("mountVersionBadge (initial)",lr),L("mountFavicon",Wa),L("mountThemeStylesheet",ba),L("mountHideLaunchpad",sn),L("mountHideNavItems",ln),L("mountRelabelNav",dn),L("mountHideTopmenuTabs",pn),L("mountContractsSection",cn)),L("initPageRouter",va),c.info("[main] registering onPageChange subscriber"),be(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),br()){c.info(`[main] page change into excluded location ${re()} \u2014 tearing down theme`),L("unmountThemeStylesheet",Bl);return}L("mountThemeStylesheet",ba),L("mountVersionBadge",lr),L("mountHideLaunchpad",sn),L("mountHideNavItems",ln),L("mountRelabelNav",dn),L("mountHideTopmenuTabs",pn),L("mountContractsSection",cn),L("mountClaimReleaseToggle",Da),L("mountContactActionsBar",Ua),L("mountActiveFollowUpButton",Ea),L("mountMtOfferMadeButton",Ya),L("mountNotInterestedButton",Ja),L("mountScheduleWalkthroughButton",Xa),L("mountResendDealLinkButton",Za),L("mountReducePriceButton",ti),L("mountEditLandingPageButton",oi),L("mountPublishButton",ai),L("mountContactMapLinks",pi),L("mountSendToClosingOfficeButton",Ti),L("mountOppActionBar",zi),L("mountClosingAgentPickerButton",qs),L("mountPrepareContractButton",il),L("mountComputeOfferButton",gl),L("mountManageTeam",js),L("mountBuyBoxWidget",La),L("mountSupportNavItem",Yi),L("mountPhoneAssignmentsWidget",ts),L("mountBulkPowerDialer",Ts),L("mountCallingAsChip",Cs),L("mountDialerThemeFix",Hs)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fl):Fl();})();
