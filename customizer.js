/* Wholesaling CRM Customizer v0.37.2 — built 2026-06-14T03:35:23.034Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Qt="[wholesaling-crm-customizer]",wl="__WS_CRM_DEBUG",kl=()=>!!window[wl],c={info(...t){console.log(Qt,...t)},warn(...t){console.warn(Qt,...t)},error(...t){console.error(Qt,...t)},debug(...t){kl()&&console.log(Qt,"[debug]",...t)}};var El=/\/v2\/location\/([A-Za-z0-9]+)/,Tl=new Set(["8ntUQzMflUkR0YvrRgVk"]),re=()=>{let t=window.location.pathname.match(El);return t?t[1]:null},dr=()=>{let t=re();return t!==null&&Tl.has(t)};var da=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,cr=/\/v2\/location\/([A-Za-z0-9]+)/,Sl=t=>{let e=t.match(da);if(!e)return null;let o=t.match(cr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Cl=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(da);if(!a)continue;let i=r.match(cr)||window.location.pathname.match(cr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},B=()=>{let t=Sl(window.location.pathname);return t||Cl()};var ca=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},eo="",pr=null,Me="other",br=new Set,Zt=()=>{let t=B()?.contactId??null;if(!(!(window.location.pathname!==eo)&&!(t!==pr))){eo=window.location.pathname,pr=t,Me=ca(),c.debug("Page/context changed:",Me,eo,"contact:",t);for(let r of br)try{r(Me)}catch(a){c.error("Subscriber threw:",a)}}},we=t=>(br.add(t),setTimeout(()=>t(Me),0),()=>{br.delete(t)}),pa=()=>{Me=ca(),eo=window.location.pathname,pr=B()?.contactId??null,c.debug("Router init, current page:",Me);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Zt()},history.replaceState=function(o,r,a){e(o,r,a),Zt()},window.addEventListener("popstate",Zt),setInterval(Zt,1e3)},ba=()=>Me;var to="0.37.2",oo="2026-06-14T03:35:23.035Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},mr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ma=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,M=`
  ...
  flex-shrink: 0;
`;var Al=/^[A-Za-z0-9]{15,30}$/,bt=t=>typeof t=="string"&&Al.test(t),ha=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},$l=()=>{let t=window.WS_CRM_USER_ID;return bt(t)?t:null},Ll=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(bt(o))return o;return null},Il=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ha(e);if(!o)return null;let r=o.uid;if(bt(r))return r;let a=o.claims;if(a&&bt(a.user_id))return a.user_id}catch{}return null},Ml=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(bt(a))return a}catch{}}}catch{}return null},O=()=>$l()||Ll()||Il()||Ml()||null,Ol=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ha(e);return o?o.claims??o:null}catch{return null}},Ve=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Ol()?.type==="agency"};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Dl=`${ga}/active-follow-up-get`,Hl=`${ga}/active-follow-up-set`,Oe="ws-crm-active-follow-up-button",ur={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Pl=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Rl=async t=>{let e=await fetch(Dl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Bl=async(t,e)=>{let o=await fetch(Hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},De=(t,e)=>{let o=ur[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ua=t=>{let e=document.createElement("button");return e.type="button",e.id=Oe,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,De(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Pl();if(!(!r||r.contactId!==t)){De(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Bl(r,O()),i=a&&a.state&&a.state in ur?a.state:"blue";De(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),De(e,"error"),setTimeout(()=>void ro(e,r),4e3)}}}),e},ro=async(t,e)=>{De(t,"loading");try{let o=await Rl(e),r=o&&o.state&&o.state in ur?o.state:"gray",a=document.getElementById(Oe);if(!a||a.dataset.contactId!==e.contactId)return;De(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),De(t,"error")}},Fl=[".central-panel","[class*='central-panel']"],hr="ws-crm-contact-actions-bar",Nl=async()=>{for(let t of Fl)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},zl=async(t,e)=>{let o=e.querySelector(`#${hr}`);if(!o)try{o=await L(`#${hr}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${hr}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Gl=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},ql=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Ul=async t=>{if(t==="url"){let o=await Nl();return o?{kind:"contact-detail",target:o}:null}let e=Gl();return e?{kind:"conversations",target:e}:null},va=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await zl(t,e.target);return o}return ql(t,e.target),"conversations-header"},Vl=async()=>{let t=B();if(!t||!t.locationId){document.getElementById(Oe)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Oe);if(o&&o.dataset.contactId===e.contactId){ro(o,e);return}o&&o.remove();let r=await Ul(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=B();if(!a||a.contactId!==e.contactId)return;let i=ua(e.contactId),s=await va(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),_a();let l=document.getElementById(Oe)??i;ro(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(Oe);if(!(B()?.contactId===e.contactId)){d.disconnect();return}if(!p){let m=ua(e.contactId);va(m,r).then(()=>{_a(),ro(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},mt=null,ya=()=>{let t=B()?.contactId??null;if(mt&&mt.contactId===t)return;let e=Vl().finally(()=>{mt?.promise===e&&(mt=null)});mt={contactId:t,promise:e}},_a=()=>{let t=document.querySelectorAll(`#${Oe}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var Wl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ht=new Map,We=async(t,e)=>{if(!t)return null;if(ht.has(t))return ht.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${Wl}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),ht.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ht.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),ht.set(t,null),null}};var je=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var wa="ws-buybox-nav-icon",gr="ws-buybox-panel",fa="ws-buybox-modal",jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",yr="https://mcclivetim.github.io/reinvest-os-cdn/geo",no=null,ut=null,vt=null,_r=async()=>{if(no)return no;try{let t=await fetch(`${yr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return no=await t.json(),no}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},Kl=async t=>{if(!ut)try{let e=await fetch(`${yr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ut=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return ut?.[t]??[]},Yl=async t=>{if(!vt)try{let e=await fetch(`${yr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);vt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return vt?.[t]??[]},fr=async t=>await(await fetch(jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Jl=(t,e)=>fr({tenant_id:t,action:"list",buyer_contact_id:e}),Xl=(t,e,o,r)=>fr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Ql=(t,e)=>fr({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Zl=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},ed='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',td='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',od="nav.w-13, nav[class*='w-13']",rd=".flex-1.h-full.relative.overflow-hidden.rounded-lg",nd=async()=>{try{return await L(od,{timeoutMs:2500})}catch{return null}},ad=async()=>{try{return await L(rd,{timeoutMs:2500})}catch{return null}},id=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,sd=(t,e)=>{let o=document.createElement("div");return o.id=gr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{pd(t,e,()=>xr(t,e))}),o},xr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Jl(t,e),_r()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}ld(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},ld=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?Zl(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,Ql(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}xr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},ao=!1,ka=(t,e)=>{ao=e;let o=id(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=dd,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",xr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Ea,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Ea="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",dd="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",cd=t=>{let e=document.createElement("button");return e.id=wa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Ea,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${ed.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!ao;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ka(r,a)}),e},pd=(t,e,o)=>{let r=document.getElementById(fa);r&&r.remove();let a=document.createElement("div");a.id=fa,a.style.cssText=`
  ...
  `,y=w=>{let T=w.find($=>$.code===s.stateCode);return`
    ...
    `},k=w=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},f=w=>{let T=s.granularity==="county"?ut?.[s.stateCode||""]??[]:vt?.[s.stateCode||""]??[];return`
  ...
  `,o.forEach(d=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=mr[d.color]),m&&(m.textContent=d.label),l.style.display="none";let y=B()?.locationId,k=O();if(!y){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!k){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let f=h?.textContent??"\u25BE",g=async x=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await wd({contactId:t,locationId:y,status:d.label,userId:k,deadReason:x,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=f),s.style.opacity="1"},900)}catch(S){c.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=f),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let x=m?.textContent??"";Md(S=>{g(S)},()=>{m&&(m.textContent=x)});return}if(e==="seller"&&d.value==="appointment-booked"){let x=m?.textContent??"";try{(await kd({contactId:t,tenantId:y})).ok?await g():Od(()=>{g()},()=>{m&&(m.textContent=x)})}catch(S){c.warn("Appointment sanity check failed; firing anyway:",S),await g()}return}await g()}),l.appendChild(p)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},$d="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Ld=async t=>{let e=await fetch($d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Id=(t,e="seller")=>{document.getElementById(La)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=La,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,s.appendChild(l),document.body.appendChild(s);let m=()=>s.remove();s.addEventListener("click",k=>{k.target===s&&m()});let h=l.querySelector("#ws-offer-error"),_=l.querySelector("#ws-offer-cancel"),y=l.querySelector("#ws-offer-submit");_?.addEventListener("click",m),y?.addEventListener("click",async()=>{let k=(l.querySelector("#ws-offer-amount")?.value??"").trim(),f=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!k||Number(k)<=0){h&&(h.textContent="Enter a positive offer amount."),c.warn("Offer Made submit blocked \u2014 invalid amount");return}let g=Number(k);if(g<100){h&&(h.textContent=`That looks low \u2014 did you mean $${(g*1e3).toLocaleString("en-US")}?`);return}let S=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),C=S?S[1]:null;if(!C){h&&(h.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}h&&(h.textContent=""),y&&(y.disabled=!0,y.textContent="Recording\u2026",y.style.opacity="0.7"),_&&(_.disabled=!0);try{let E=await Ld({tenantId:C,contactId:t,kind:e,amount:g,expiresAt:f||null,userId:O()});if(!E.ok){h&&(h.textContent=E.error??"Something went wrong."),y&&(y.disabled=!1,y.textContent="Record Offer",y.style.opacity="1"),_&&(_.disabled=!1);return}c.info(`Offer Made (${e}) recorded for contact ${t}: $${g} on ${E.opp_pipeline} opp (stage: ${E.opp_stage_name??"?"})`),m()}catch(E){c.error("Offer Made webhook failed",E),h&&(h.textContent=E instanceof Error?E.message:"Network error \u2014 try again."),y&&(y.disabled=!1,y.textContent="Record Offer",y.style.opacity="1"),_&&(_.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},Ia="ws-crm-dead-deal-modal",Md=(t,e)=>{document.getElementById(Ia)?.remove();let o=document.createElement("div");o.id=Ia,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=M,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>Id(t,e)),o.appendChild(r),o.appendChild(Ad({contactId:t,kind:e}))}return o},wr=!1,Da=()=>{document.querySelectorAll(`[id="${Je}"]`).forEach(t=>t.remove())},Ba=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),wr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}wr=!0;try{await Dd()}finally{wr=!1}},Dd=async()=>{let t=B();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Da();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),Da();return}let e="seller";try{let p=await We(t.contactId,t.locationId),b=je(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=B();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Je}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Cd();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=B();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Oa(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Je)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(B()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Je}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=Oa(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Ha=null,Hd=()=>{Ha===null&&(Ha=window.setInterval(()=>{let t=B();t&&(document.getElementById(Je)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ba()))},3e3))},Fa=()=>{Hd(),Ba()};var io="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Pd=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),gt="data-ws-crm-favicon",kr=t=>t.hasAttribute(gt),Na=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Pd.has(e)},so=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Na(r)&&!kr(r)&&r.remove()});let e=document.head.querySelector(`link[${gt}="1"]`);e?e.href!==io&&(e.href=io):(e=document.createElement("link"),e.setAttribute(gt,"1"),e.rel="icon",e.type="image/png",e.href=io,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${gt}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(gt,"apple"),o.rel="apple-touch-icon",o.href=io,document.head.appendChild(o))},za=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)so();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),so())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Na(s)&&!kr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&kr(s)&&(a=!0)});a&&so()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,so(),e>=5&&window.clearInterval(o)},1e3)};var Rd=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Bd=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Fd=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Fd);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Bd);if(a){let i=a[1];if(Rd.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ga="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(Ga);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ga,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Nd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ie="ws-crm-mt-offer-made-button",qa="ws-crm-mt-offer-made-modal",zd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gd=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(zd);if(!e)return null;let o=t.match(Gd);return{oppId:e[1],locationId:o?o[1]:null}},qd=async t=>{let e=await fetch(Nd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},lo=()=>{document.getElementById(qa)?.remove()},Ud=t=>{lo();let e=document.createElement("div");e.id=qa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=po();!o||!o.locationId||o.oppId!==t||Ud({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=M)},4e3)}})}),e},Wd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jd=async()=>{for(let t of Wd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Cr=async()=>{if(!co){co=!0;try{await Kd()}finally{co=!1}}},Kd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await jd();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=Vd(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Yd(t.oppId)},yt=null,Sr=null,ft=()=>{yt?.disconnect(),yt=null,Sr=null},Yd=t=>{if(yt&&Sr===t)return;ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Sr=t,yt=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){ft();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),ft();return}document.getElementById(ie)||Cr()}),yt.observe(e,{childList:!0,subtree:!0}))},Er=null,Tr,Jd=()=>{Er||(Er=new MutationObserver(()=>{Tr===void 0&&(Tr=window.setTimeout(()=>{Tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!co&&Cr()},300))}),Er.observe(document.body,{childList:!0,subtree:!0}))},Ua=()=>{Jd(),Cr()};var Xd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",se="ws-crm-not-interested-button",Qd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zd=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(Qd);if(!e)return null;let o=t.match(Zd);return{oppId:e[1],locationId:o?o[1]:null}},ec=async t=>{let e=await fetch(Xd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},tc=t=>{let e=document.createElement("button");return e.id=se,e.type="button",e.dataset.oppId=t,e.style.cssText=M,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=mo();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await ec({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},oc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rc=async()=>{for(let t of oc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},bo=!1,Ir=async()=>{if(!bo){bo=!0;try{await nc()}finally{bo=!1}}},nc=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await rc();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=tc(t.oppId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),ac(t.oppId)},xt=null,Lr=null,wt=()=>{xt?.disconnect(),xt=null,Lr=null},ac=t=>{if(xt&&Lr===t)return;wt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Lr=t,xt=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){wt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),wt();return}document.getElementById(se)||Ir()}),xt.observe(e,{childList:!0,subtree:!0}))},Ar=null,$r,ic=()=>{Ar||(Ar=new MutationObserver(()=>{$r===void 0&&($r=window.setTimeout(()=>{$r=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!bo&&Ir()},300))}),Ar.observe(document.body,{childList:!0,subtree:!0}))},Va=()=>{ic(),Ir()};var sc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ne="ws-crm-schedule-walkthrough-button",Mr="ws-crm-schedule-walkthrough-modal",lc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dc=/\/v2\/location\/([A-Za-z0-9]+)/,vo=()=>{let t=window.location.pathname,e=t.match(lc);if(!e)return null;let o=t.match(dc);return{oppId:e[1],locationId:o?o[1]:null}},ho=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},cc=(t,e)=>{document.getElementById(Mr)?.remove();let o=document.createElement("div");o.id=Mr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=vo();!o||!o.locationId||o.oppId!==t||cc(o.oppId,o.locationId)}),e},bc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],mc=async()=>{for(let t of bc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},uo=!1,Pr=async()=>{if(!uo){uo=!0;try{await hc()}finally{uo=!1}}},hc=async()=>{let t=vo();if(!t||!t.locationId){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et();return}let e=document.getElementById(ne);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et());return}e&&(e.remove(),document.getElementById(`${ne}-wrap`)?.remove());let o=await mc();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=vo();if(!a||a.oppId!==t.oppId)return;let i=pc(t.oppId),s=document.createElement("span");s.id=`${ne}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),uc(t.oppId)},kt=null,Hr=null,Et=()=>{kt?.disconnect(),kt=null,Hr=null},uc=t=>{if(kt&&Hr===t)return;Et();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Hr=t,kt=new MutationObserver(()=>{let o=vo();if(!o||o.oppId!==t){Et();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ne)?.remove(),document.getElementById(`${ne}-wrap`)?.remove(),Et();return}document.getElementById(ne)||Pr()}),kt.observe(e,{childList:!0,subtree:!0}))},Or=null,Dr,vc=()=>{Or||(Or=new MutationObserver(()=>{Dr===void 0&&(Dr=window.setTimeout(()=>{Dr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ne);t&&!e&&!uo&&Pr()},300))}),Or.observe(document.body,{childList:!0,subtree:!0}))},Wa=()=>{vc(),Pr()};var _c="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Xe="ws-crm-resend-deal-link-wrap",gc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,yc=/\/v2\/location\/([A-Za-z0-9]+)/,go=()=>{let t=window.location.pathname,e=t.match(gc);if(!e)return null;let o=t.match(yc);return{oppId:e[1],locationId:o?o[1]:null}},fc=async t=>{let e=await fetch(_c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},xc=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),ja=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Nr=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=M,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${ja(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>wc(t,e)),t.appendChild(o)},wc=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void kc(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Nr(t,e)),o.appendChild(s),t.appendChild(o)},kc=async(t,e,o,r)=>{let a=go();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await fc({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${ja(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${xc(s)}</span>`}window.setTimeout(()=>Nr(t,e),3500)}},Ec=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Tc=async()=>{for(let t of Ec)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_o=!1,zr=async()=>{if(!_o){_o=!0;try{await Sc()}finally{_o=!1}}},Sc=async()=>{let t=go();if(!t||!t.locationId){document.getElementById(Xe)?.remove(),St();return}let e=document.getElementById(Xe);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),St());return}e&&e.remove();let o=await Tc();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=go();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Xe,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Nr(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Cc(t.oppId)},Tt=null,Fr=null,St=()=>{Tt?.disconnect(),Tt=null,Fr=null},Cc=t=>{if(Tt&&Fr===t)return;St();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fr=t,Tt=new MutationObserver(()=>{let o=go();if(!o||o.oppId!==t){St();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Xe)?.remove(),St();return}document.getElementById(Xe)||zr()}),Tt.observe(e,{childList:!0,subtree:!0}))},Rr=null,Br,Ac=()=>{Rr||(Rr=new MutationObserver(()=>{Br===void 0&&(Br=window.setTimeout(()=>{Br=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Xe)&&!_o&&zr()},300))}),Rr.observe(document.body,{childList:!0,subtree:!0}))},Ka=()=>{Ac(),zr()};var $c="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",le="ws-crm-reduce-price-button",Ya="ws-crm-reduce-price-modal",Lc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ic=/\/v2\/location\/([A-Za-z0-9]+)/,xo=()=>{let t=window.location.pathname,e=t.match(Lc);if(!e)return null;let o=t.match(Ic);return{oppId:e[1],locationId:o?o[1]:null}},Mc=async t=>{let e=await fetch($c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},yo=()=>{document.getElementById(Ya)?.remove()},Oc=t=>{yo();let e=document.createElement("div");e.id=Ya,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=xo();!r||!r.locationId||r.oppId!==t||Oc({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=M,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Hc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pc=async()=>{for(let t of Hc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fo=!1,Vr=async()=>{if(!fo){fo=!0;try{await Rc()}finally{fo=!1}}},Rc=async()=>{let t=xo();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),At();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),At());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await Pc();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=xo();if(!a||a.oppId!==t.oppId)return;let i=Dc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Bc(t.oppId)},Ct=null,Ur=null,At=()=>{Ct?.disconnect(),Ct=null,Ur=null},Bc=t=>{if(Ct&&Ur===t)return;At();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ur=t,Ct=new MutationObserver(()=>{let o=xo();if(!o||o.oppId!==t){At();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),At();return}document.getElementById(le)||Vr()}),Ct.observe(e,{childList:!0,subtree:!0}))},Gr=null,qr,Fc=()=>{Gr||(Gr=new MutationObserver(()=>{qr===void 0&&(qr=window.setTimeout(()=>{qr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!fo&&Vr()},300))}),Gr.observe(document.body,{childList:!0,subtree:!0}))},Ja=()=>{Fc(),Vr()};var Qe="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",wo="deals.reinvestos.com";var de="ws-crm-edit-landing-button",Nc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zc=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(Nc);if(!e)return null;let o=t.match(zc);return{oppId:e[1],locationId:o?o[1]:null}},Gc=(t,e)=>{let o=new URL(`https://${wo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Qe);let r=O();return r&&o.searchParams.set("user",r),o.toString()},qc=(t,e)=>{let o=document.createElement("button");return o.id=de,o.type="button",o.dataset.oppId=t,o.style.cssText=M,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Eo();if(!r||!r.locationId||r.oppId!==t)return;if(!Qe){c.warn("[edit-landing] editor session key not configured in this build");return}let a=Gc(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Uc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vc=async()=>{for(let t of Uc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ko=!1,Yr=async()=>{if(!ko){ko=!0;try{await Wc()}finally{ko=!1}}},Wc=async()=>{let t=Eo();if(!t||!t.locationId){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt());return}e&&(e.remove(),document.getElementById(`${de}-wrap`)?.remove());let o=await Vc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Eo();if(!a||a.oppId!==t.oppId)return;let i=qc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${de}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),jc(t.oppId)},$t=null,Kr=null,Lt=()=>{$t?.disconnect(),$t=null,Kr=null},jc=t=>{if($t&&Kr===t)return;Lt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kr=t,$t=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){Lt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(de)?.remove(),document.getElementById(`${de}-wrap`)?.remove(),Lt();return}document.getElementById(de)||Yr()}),$t.observe(e,{childList:!0,subtree:!0}))},Wr=null,jr,Kc=()=>{Wr||(Wr=new MutationObserver(()=>{jr===void 0&&(jr=window.setTimeout(()=>{jr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);t&&!e&&!ko&&Yr()},300))}),Wr.observe(document.body,{childList:!0,subtree:!0}))},Xa=()=>{Kc(),Yr()};var Za="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ze="ws-crm-publish-button",It="ws-crm-publish-wrap",So="ws-crm-publish-dropdown",Yc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jc=/\/v2\/location\/([A-Za-z0-9]+)/,Qr=()=>{let t=window.location.pathname,e=t.match(Yc);if(!e)return null;let o=t.match(Jc);return{oppId:e[1],locationId:o?o[1]:null}},Xc=async(t,e)=>{try{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},Qc=async(t,e)=>{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Zc=(t,e)=>{if(!Qe){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${wo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Qe);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},_e=()=>{document.getElementById(So)?.remove()},Qa=(t,e,o,r,a)=>{_e();let i=document.createElement("div");i.id=So;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `,i.appendChild(b),t.forEach(k=>{let f=document.createElement("div");f.style.cssText=`
      display: flex; align-items: center; gap: 10px;
      padding: 6px 4px; font-size: 12px;
      color: ${k.filled?n.bone:n.ash};
    `;let g=k.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;f.innerHTML=`${g}<span style="flex: 1;">${k.label}</span>`,i.appendChild(f)});let m=document.createElement("div");m.style.cssText=`
    display: flex; align-items: center; gap: 10px;
  ...
  `;let h=document.createElement("button");h.type="button",h.textContent="Open editor to finish \u2192",h.style.cssText=`
    ...
    color: ${n.emerald};
  `,h.addEventListener("click",k=>{k.stopPropagation(),Zc(o,r)}),m.appendChild(h);let _=document.createElement("button");_.type="button",_.textContent="Re-check",_.title="Re-check after editing the page",_.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,_.addEventListener("click",k=>{k.stopPropagation(),_e(),a()}),m.appendChild(_),i.appendChild(m),document.body.appendChild(i);let y=k=>{let f=k.target;!i.contains(f)&&!e.contains(f)&&(_e(),document.removeEventListener("click",y))};window.setTimeout(()=>document.addEventListener("click",y),0)},He=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),i="transparent",s=n.steel,l=n.bone,d=n.coolGray,p="Publish Deal",b="",m="pointer",h="1";switch(e.status){case"checking":s=n.steel,l=n.ash,p="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publish Deal";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,y=e.checks?.length??0;s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${y} ready`,b="\u25BE";break}case"publishing":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,p="Publishing\u2026",m="wait",h="0.8";break;case"published":i="transparent",s=n.steel,l=n.ash,d=n.emerald,p="Deal Published",m="default",h="0.9";break;case"error":s=n.amber,l=n.amber,d=n.amber,p=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=b)},ep=(t,e)=>{let o=document.createElement("button");o.id=Ze,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${K}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};He(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await Xc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},He(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},He(o,r),document.getElementById(So)&&r.checks&&Qa(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},He(o,r),_e();try{let m=await Qc(t,e);if(m.ok&&m.published)r={status:"published"},He(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},He(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},He(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(So)?_e():r.checks&&Qa(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},tp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],op=async()=>{for(let t of tp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},To=!1,en=async()=>{if(!To){To=!0;try{await rp()}finally{To=!1}}},rp=async()=>{let t=Qr();if(!t||!t.locationId){document.getElementById(Ze)?.remove(),document.getElementById(It)?.remove(),_e(),Ot();return}let e=document.getElementById(Ze);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(It)?.remove(),_e(),Ot());return}e&&(e.remove(),document.getElementById(It)?.remove(),_e());let o=await op();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Qr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=ep(t.oppId,a.locationId),s=document.createElement("span");s.id=It,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),np(t.oppId)},Mt=null,Zr=null,Ot=()=>{Mt?.disconnect(),Mt=null,Zr=null},np=t=>{if(Mt&&Zr===t)return;Ot();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zr=t,Mt=new MutationObserver(()=>{let o=Qr();if(!o||o.oppId!==t){Ot();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(Ze)?.remove(),document.getElementById(It)?.remove(),_e(),Ot();return}document.getElementById(Ze)||en()}),Mt.observe(e,{childList:!0,subtree:!0}))},Jr=null,Xr,ap=()=>{Jr||(Jr=new MutationObserver(()=>{Xr===void 0&&(Xr=window.setTimeout(()=>{Xr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ze)&&!To&&en()},300))}),Jr.observe(document.body,{childList:!0,subtree:!0}))},ei=()=>{ap(),en()};var ti="data:image/png;base64,",oi="data:image/png;base64,";var ip=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],ri=t=>`ws-crm-map-links-${t}`,Co=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},ni=t=>{let e=Co(t.addr),o=Co(t.city),r=Co(t.state),a=Co(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},sp=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,lp=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,dp=(t,e)=>{let{full:o,hasAny:r}=ni(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},cp=t=>{let e=document.createElement("span");e.id=ri(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),dp(t,s)}),l};return e.appendChild(r(ti,"Open in Google Maps",sp)),e.appendChild(r(oi,"Search on Zillow",lp)),e},pp=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},ai=()=>{for(let t of ip){if(document.getElementById(ri(t.key)))continue;let{hasAny:e}=ni(t);if(!e)continue;let o=pp(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(cp(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},tn=null,on,bp=()=>{tn||(tn=new MutationObserver(()=>{on===void 0&&(on=window.setTimeout(()=>{on=void 0;try{ai()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),tn.observe(document.body,{childList:!0,subtree:!0}))},ii=()=>{bp(),ai()};var si="ws-crm-hide-launchpad",li=/\/launchpad\/?$/,rn=()=>{if(!Ve()){if(!document.getElementById(si)){let t=document.createElement("style");t.id=si,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(li.test(location.pathname)){let t=location.pathname.replace(li,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var mp=[{label:"Buy-Box Entries"},{label:"Memberships"}],di=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},nn=()=>{let t=Ve(),e=new Set(mp.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){di(e);for(let o of[150,500,1200,2500])setTimeout(()=>di(e),o)}};var hp=[{from:"Payments",to:"Contracts"}],up=".nav-title, .topmenu-navtitle",ci=()=>{document.querySelectorAll(up).forEach(t=>{let e=(t.textContent||"").trim(),o=hp.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},an=()=>{ci();for(let t of[150,500,1200,2500])setTimeout(ci,t)};var pi="/payments/proposals-estimates",vp=/\/payments\/invoices\/?$/,_p=/\/payments\//,gp='#sb_payments, a[meta="payments"]',mi=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(pi)&&!(t>3&&!_p.test(e))){if(vp.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(pi));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>mi(t+1),120)}},bi=!1,yp=()=>{bi||(bi=!0,document.addEventListener("click",t=>{t.target?.closest?.(gp)&&setTimeout(()=>mi(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},sn=()=>{yp()};var hi=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ui="ws-crm-hide-topmenu-tabs",ln=()=>{if(document.getElementById(ui))return;let t=hi.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ui,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${hi.length} top tabs`)};var gi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Ee="ws-crm-send-to-closing-office-button",Pe="ws-crm-send-to-title-co-wrap",Lo="ws-crm-stc-dropdown",fp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xp=/\/v2\/location\/([A-Za-z0-9]+)/,Io=()=>{let t=window.location.pathname,e=t.match(fp);if(!e)return null;let o=t.match(xp);return{oppId:e[1],locationId:o?o[1]:null}},wp=5*60*1e3,yi=t=>`ws-crm-stc-cache:${t}`,kp=t=>{try{let e=window.localStorage.getItem(yi(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>wp||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Ep=(t,e)=>{try{window.localStorage.setItem(yi(t),JSON.stringify(e))}catch{}},Tp=async(t,e)=>{try{let o=await fetch(gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Sp=async(t,e,o)=>{let r=await fetch(gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Cp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},vi=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Ap=(t,e)=>{if(e&&Cp(e)){window.setTimeout(()=>vi(t),300);return}vi(t)},ce=()=>{document.getElementById(Lo)?.remove()},Ao=(t,e,o)=>{ce();let r=document.createElement("div");r.id=Lo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let p=["TC","ACQ","MT","DISPO","Property"],b={};t.forEach(_=>{b[_.group]||(b[_.group]=[]),b[_.group].push(_)});let m=[...p.filter(_=>b[_]),...Object.keys(b).filter(_=>!p.includes(_))];for(let _ of m){let y=b[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,f.textContent=_,k.appendChild(f),y.forEach(g=>{let x=document.createElement("div"),S=!g.filled&&g.navigable&&g.field_id;x.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${S?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,S&&(x.addEventListener("mouseenter",()=>{x.style.background=n.slate}),x.addEventListener("mouseleave",()=>{x.style.background="transparent"}),x.addEventListener("click",w=>{w.stopPropagation(),g.field_id&&(Ap(g.field_id,g.folder),ce())}));let C=g.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=S?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";x.innerHTML=`${C}<span style="flex: 1;">${g.label}</span>${E}`,k.appendChild(x)}),r.appendChild(k)}document.body.appendChild(r);let h=_=>{let y=_.target;!r.contains(y)&&!o.contains(y)&&(ce(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},be=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,p="Send to Closing Office",b="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,p="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,y=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${y} Fields Ready`;break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,p=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=b)},$p=(t,e)=>{let o=document.createElement("button");o.id=Ee,o.type="button",o.dataset.oppId=t;let r=kp(t),a=r?{status:r.checks.every(f=>f.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${M}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,be(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Tp(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},be(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},be(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},be(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let g=f.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Mo.add(t),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce(),Ht();return}let x=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;x=f.checks.map((E,w)=>a.checks[w]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:x.every(C=>C.filled)?"ready":"incomplete",checks:x,previouslySentAt:f.previously_sent_at??null},Ep(t,{checks:x,previously_sent_at:f.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),be(o,a),document.getElementById(Lo)&&Ao(x,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},be(o,a),ce();try{let g=await Sp(t,e,f);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},be(o,a),g.checks&&Ao(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},be(o,a),window.setTimeout(()=>{y()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},be(o,a),g.checks&&Ao(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},be(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Lo)?ce():a.checks&&Ao(a.checks,a.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,p=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,y=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};y();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let x=Date.now()-b,S=Math.max(1500,m-x);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&y()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},Lp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ip=async()=>{for(let t of Lp)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Mo=new Set,_i=null,Mp=t=>{t&&t!==_i&&(Mo.clear(),_i=t)},$o=!1,bn=async()=>{if($o){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}$o=!0;try{await Op()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{$o=!1}},Op=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Io();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Mp(t.oppId),Mo.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Pe)?.remove(),ce(),Ht());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Pe)?.remove(),ce()),c.debug("[stc] mount:04 calling findMountTarget");let o=await Ip();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Io();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=$p(t.oppId,a.locationId),s=document.createElement("span");s.id=Pe,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Dp(t.oppId)},Dt=null,pn=null,Ht=()=>{Dt?.disconnect(),Dt=null,pn=null},Dp=t=>{if(Dt&&pn===t)return;Ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(pn=t,Dt=new MutationObserver(()=>{let o=Io();if(!o||o.oppId!==t){Ht();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Ee)?.remove(),document.getElementById(Pe)?.remove(),ce(),Ht();return}document.getElementById(Ee)||bn()}),Dt.observe(e,{childList:!0,subtree:!0}))},dn=null,cn,Hp=()=>{dn||(dn=new MutationObserver(()=>{cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ee);if(t&&!e&&!$o){let o=Io();if(o&&Mo.has(o.oppId))return;bn()}},300))}),dn.observe(document.body,{childList:!0,subtree:!0}))},fi=()=>{Hp(),bn()};var un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Pp=`${un}/tc/welcome-call-prefill`,Rp=`${un}/tc/welcome-call-save`,Bp=`${un}/tc/order-lockbox`,Pt="ws-crm-welcome-call-overlay",Fp=["Regular Contract","Subject To","Seller Finance","Novation"],Np=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],zp=["Gas","Electric","Propane","Oil"],Gp=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],qp=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Te=["Yes","No"],Up=["Yes","No","Unknown"],Vp=["Professional Photographer","Seller","Tenant"],Wp=["Month-to-Month","Annual"],xi=["Current","Behind"],jp=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],me=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Do=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,Ei="margin-bottom:12px;",Ti=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,Kp=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,wi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=wi(o);return`<select id="${t}" style="${Do}"><option value=""></option>${e.map(a=>`<option ${r!==""&&wi(a)===r?"selected":""}>${me(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${me(e)}" placeholder="${me(o)}" style="${Do}">`,Yp=(t,e)=>`<textarea id="${t}" rows="3" style="${Do}resize:vertical;">${me(e)}</textarea>`,Jp=(t,e)=>`<input id="${t}" type="date" value="${me(e)}" style="${Do}">`,D=(t,e)=>`<div style="${Ei}"><label style="${Ti}">${me(t)}</label>${e}</div>`,mn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${jp.map(r=>`<label style="${Kp}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ge=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${me(t)}</div>`,et=()=>{document.getElementById(Pt)?.remove()},Re=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Xp=t=>{let e=t.tenant||{};return`
    ${ge("Identifiers")}
    ...
    ${ge("Contract")}
    ${D("Type of Contract",j("wc-contract_type",Fp,t.contract_type))}

    ${ge("Property")}
    ${D("Property Type",j("wc-property_type",Gp,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",Np,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",zp,t.heat_source))}
    ...
    ${ge("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",qp,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",Wp,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        ...
        <div style="flex:1;">${D("Last rent paid",Jp("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",Up,t.hoa_rental_restriction))}</div>

    ${ge("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",Vp,t.photos_provided_by))}
    <div style="${Ei}">
  ...
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},hn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),ki=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Oo=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?me(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Qp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:hn("photos_avail_mornings"),photos_avail_afternoons:hn("photos_avail_afternoons"),photos_avail_evenings:hn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),Zp=t=>{et();let e=document.createElement("div");e.id=Pt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Xp(t)}</div>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Se("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Ce(),Se("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Se("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Se("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(Ce(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},pb=(t,e)=>{Ce();let o=document.createElement("div");o.id=$i;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Ce(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Po=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=M,o.textContent=t,o},bb=()=>{let t=Po("\u22EE","ghost");return t.style.lineHeight="1",t},mb=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Mi){let r=Po("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>sb(t)),o.appendChild(r),o}if(e===En){let r=Po("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>cb(t,r)),o.appendChild(r),o}if(e===Oi){let r=Po("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Hi(t)),o.appendChild(r),o}return null},hb=(t,e)=>{let o=[];if(e===En&&(o=[{label:"Re-order Lockbox",onClick:()=>void Hi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Ai,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=bb();return a.addEventListener("click",i=>{i.stopPropagation(),pb(o,a)}),r.appendChild(a),r},ub=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],vb=async()=>{for(let t of ub)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ho=()=>{document.getElementById(fn)?.remove(),document.getElementById(Ai)?.remove(),Ce()},Ro=!1,Tn=async()=>{if(!Ro){Ro=!0;try{let t=Di();if(!t){Ho();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ho();return}let o=ib(),r=document.getElementById(fn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=mb(t,o);if(!a){Ho();return}let i=await vb();if(!i)return;Ho();let s=U(i),l=document.createElement("span");l.id=fn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=hb(t,o);d&&s.appendChild(d),_b(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Ro=!1}}},Rt=null,wn=null,_n,Ci=()=>{Rt?.disconnect(),Rt=null,wn=null},_b=t=>{if(Rt&&wn===t)return;Ci();let e=document.querySelector(Ii);e&&(wn=t,Rt=new MutationObserver(()=>{let o=Di();if(!o||o.oppId!==t){Ci();return}_n===void 0&&(_n=window.setTimeout(()=>{_n=void 0,Tn()},250))}),Rt.observe(e,{childList:!0,subtree:!0}))},gn=null,yn,gb=()=>{gn||(gn=new MutationObserver(()=>{yn===void 0&&(yn=window.setTimeout(()=>{yn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Ro&&Tn()},300))}),gn.observe(document.body,{childList:!0,subtree:!0}))},Pi=()=>{gb(),Tn()};var Ri="ws-support-modal",Bi="ws-support-toast",yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Fi="ws-support-submitter-name",Ni="ws-support-submitter-email",zi="ws-support-submitter-role",fb=["Bug","Feature Request","Question","Billing","Onboarding Help"],Be=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),xb=(t,e="success",o)=>{let r=document.getElementById(Bi);r&&r.remove();let a=document.createElement("div");a.id=Bi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Fi,r.submitterName),localStorage.setItem(Ni,r.submitterEmail),r.submitterRole&&localStorage.setItem(zi,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";xb(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},kb=["/support-ticket","ws-support-modal","ws-support"],Eb=/\/custom-menu-link\//,Sn=!1,Gi=()=>{if(Sn||!Eb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return kb.some(s=>i.includes(s))});if(r){Sn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{wb(),Sn=!1},50);return}t<10&&setTimeout(e,150)};e()},qi=!1,Ui=()=>{qi||(qi=!0,we(()=>setTimeout(Gi,50)),Gi(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Vi="ws-phone-assignments-modal",Wi="ws-phone-assignments-toast",Tb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Sb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Cb=["ACQ","DISPO","TC"],An="",he=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ab=(t,e="success",o)=>{document.getElementById(Wi)?.remove();let r=document.createElement("div");r.id=Wi;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Ki=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,$n=async()=>{document.getElementById(Vi)?.remove();let t=re(),e=document.createElement("div");e.id=Vi,e.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    background: rgba(10,13,18,0.75); display:flex; align-items:center;
    justify-content:center; font-family:${u.sans};`;let o=document.createElement("div");if(o.style.cssText=`width:min(620px,94vw); max-height:90vh; overflow-y:auto;
    background:${n.graphite}; border:1px solid ${n.steel};
    border-radius:${v.lg}; padding:28px 32px; color:${n.bone};
    box-shadow:0 16px 40px rgba(0,0,0,0.5);`,o.innerHTML=`
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",y=>{y.target===e&&e.remove()}),!t){let y=o.querySelector("#ws-pa-body");y&&(y.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let r={};try{r=await(await fetch(`${Tb}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(y){c.error("[phone-assignments] GET failed",y);let k=o.querySelector("#ws-pa-body");k&&(k.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${he(y.message)}). The backend may not be wired yet.</span>`);return}let a=r.teams&&r.teams.length?r.teams:Cb,i=r.numbers??[],s=r.users??[],l={...r.config?.numberTeam??{}},d={...r.config?.repTeam??{}},p=y=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${y} found.</div>`,b=s.length?s.map(y=>`<div style="${Ki}">
            ...
            ${ji(`rep:${y.id}`,a,d[y.id]??An)}
          </div>`).join(""):p("users"),m=i.length?i.map(y=>`<div style="${Ki}">
            <div style="min-width:0;">
            ...
            ${ji(`num:${y.e164}`,a,l[y.e164]??An)}
          </div>`).join(""):p("phone numbers"),h=y=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${y}</div>`,_=o.querySelector("#ws-pa-body");_&&(_.innerHTML=`
    ${h("Reps \u2192 Team")}
    <div style="border:1px solid ${n.steel};border-radius:${v.md};overflow:hidden;">${b}</div>
    ${h("Numbers \u2192 Team")}
    ...
    </div>`,_.querySelectorAll("select[data-assign]").forEach(y=>{y.addEventListener("change",()=>{let k=y.getAttribute("data-assign")||"",[f,...g]=k.split(":"),x=g.join(":");f==="rep"?y.value?d[x]=y.value:delete d[x]:f==="num"&&(y.value?l[x]=y.value:delete l[x])})}),_.querySelector("#ws-pa-close")?.addEventListener("click",()=>e.remove()),_.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let y=_.querySelector("#ws-pa-err"),k=g=>{y&&(y.textContent=g)};k("");let f=_.querySelector("#ws-pa-save");f&&(f.disabled=!0,f.textContent="Saving\u2026",f.style.opacity="0.7");try{let x=await(await fetch(Sb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:l,repTeam:d})})).json();if(!x.ok){k(x.error||"Save failed."),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1");return}e.remove(),Ab("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(g){k(`Network error: ${g.message}`),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1")}}))},$b=["ws-phone-assignments","phone-assignments"],Lb=/\/custom-menu-link\//,Cn=!1,Yi=()=>{if(Cn||!Lb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return $b.some(s=>i.includes(s))});if(r){Cn=!0,c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal`);try{history.back()}catch{}setTimeout(()=>{$n(),Cn=!1},50);return}t<10&&setTimeout(e,150)};e()},Ji=!1,Xi=()=>{if(Ji)return;Ji=!0,we(()=>setTimeout(Yi,50)),Yi();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&$n()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void $n(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var Zi="powerDialerApp",Ib=".dialer",Mb='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Ob=".dial-item.dial-btn.dial-btn-enabled",Fe=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Ln=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},es=()=>{try{let e=window[Zi]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){c.debug("[dialer-bridge] getEmitter failed",t)}return null},tt=()=>document.querySelector(Ib),ts=()=>es()!==null||tt()!==null?!0:!!window[Zi],Bo=(t,e)=>{let o=es();if(!o)return c.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return c.error(`[dialer-bridge] emit ${t} threw`,r),!1}},os=()=>{if(tt())return;let t=document.querySelector(Mb);t?Fe(t):c.warn("[dialer-bridge] Voice Calling button not found")},Db=()=>{let t=document.querySelector(".number-list-container")||tt();if(!t)return[];let e=[...t.querySelectorAll(".selected-number, .number-list-item, .number")],o=[],r=new Set;for(let a of e){let i=Ln(a.innerText||"");!i||r.has(i)||(r.add(i),o.push({e164:i,label:(a.innerText||"").replace(/\s+/g," ").trim().slice(0,60),el:a.closest(".number-list-item")||a}))}return o},Qi=()=>{let t=document.querySelector(".number-config .ui-text-sm-medium");if(t){let o=Ln(t.innerText);if(o)return o}let e=document.querySelector(".number-config");return e?Ln(e.innerText):null},rs=t=>{if(Qi()===t)return!0;let e=document.querySelector(".number-config, .dialer-config");e&&Fe(e);let o=Db().find(r=>r.e164===t);return o?(Fe(o.el),Qi()===t):(c.warn(`[dialer-bridge] Calling From ${t} not available to this rep`),!1)},ns=()=>[...document.querySelectorAll(".phone-number-type-pill")].find(t=>/local/i.test(t.innerText||""))||null,Hb=()=>{let t=ns();return t?!/bg-gray-100/.test(t.className):!1},as=t=>{let e=ns();e&&Hb()!==t&&Fe(e)},is=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Bo("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(i=>i.querySelector(".dial-number")?.textContent?.trim()===r);a&&Fe(a)}},ss=()=>{let t=tt();if(!t)return c.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(Ob)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let i=+a[1],s=+a[2],l=+a[3];return s>120&&s>i+40&&s>l+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Fe(e),!0):Bo("makeCall",{provider:"twilio"})};var In=()=>{let t=tt();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Fe(e.closest("button")||e):Bo("closeCallBox")},ls=()=>{Bo("closeCallBox")},ds=t=>{let e=!1,o=()=>{let i=tt()?.innerText||"",s=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(i)&&!/Call Summary|Call Ended/.test(i),l=/Call Summary|Call Ended/.test(i);if(s&&(e=!0),e&&l){e=!1;try{t()}catch(d){c.error("[dialer-bridge] onCallEnded cb threw",d)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var Pb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Bt=null,cs=null,Rb=async(t=!1)=>{let e={numberTeam:{},repTeam:{}},o=re();if(!o)return e;if(!t&&Bt&&cs===o)return Bt;try{let a=await(await fetch(`${Pb}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json();return Bt={numberTeam:a?.config?.numberTeam??{},repTeam:a?.config?.repTeam??{}},cs=o,Bt}catch(r){return c.warn("[silo] config load failed",r),Bt??e}},ps=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},Bb=t=>{let e=O();return e&&t.repTeam[e]||null},Fb=(t,e)=>Object.entries(t.numberTeam).filter(([,o])=>o===e).map(([o])=>o),bs=async t=>{let e=await Rb(),o=Bb(e);if(!o)return c.debug("[silo] current rep not mapped to a team; leaving GHL default"),null;let r=Fb(e,o);if(!r.length)return c.debug(`[silo] team ${o} has no numbers; leaving GHL default`),null;let a=ps(t),i=a?r.find(d=>ps(d)===a):void 0,s=i||r[0];try{as(!1)}catch{}return rs(s)?(c.info(`[silo] team ${o}: calling ${t} from ${s}${i?" (local match)":" (pool default)"}`),s):(c.warn(`[silo] could not select ${s} in the dialer (not available to this rep?)`),null)};var Nb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ms="data-ws-pd",hs="ws-pd-panel",us="ws-pd-session",Ne=t=>new Promise(e=>setTimeout(e,t)),Ft=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),zb=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},Gb=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},qb=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),i=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!i||o.has(i))continue;let s=Array.from(r.querySelectorAll("[id]")).find(l=>/^[A-Za-z0-9]{18,22}$/.test(l.id));o.add(i),e.push({oppId:s?.id||"",contactId:i,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},Ub=async t=>{let e=zb(t);if(!e)return[];let o=Gb(e),r=-1;for(let a=0;a<60;a++){let i=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(i===r)break;r=i,o.scrollTop=o.scrollHeight,await Ne(550)}return o.scrollTop=0,qb(e)},Vb=async(t,e)=>{try{let r=await(await fetch(Nb,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||""}:null}catch(o){return c.warn("[bulk-dialer] resolvePhone failed",o),null}},Wb=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,jb=(t,e)=>{document.getElementById(hs)?.remove();let o=document.createElement("div");o.id=hs,o.style.cssText=Wb;let r=document.createElement("div");r.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let a=e.map((d,p)=>`<label data-row="${p}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
  ...
  `;let r={status:"loading"};Ae(o,r);let a=xs(t);return a&&(r={status:"linked",contactName:a.contactName},Ae(o,r),ze={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await nm(t,e);s?(r={status:"linked",contactName:s.name},Ae(o,r),ze={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Rn(s.id,s.name,e)):a||(r={status:"empty"},Ae(o,r),ze?.oppId===t&&(ze=null),sm(),im(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||dm({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ae(o,r);try{let l=[_s({tenantId:e,oppId:t,fieldKey:ys,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(_s({tenantId:e,oppId:t,fieldKey:tm,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ae(o,r),ze={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},ws(t,s.id,s.name),Rn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ae(o,r)}}})}),o},pm=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],bm=async()=>{for(let t of pm)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Nt=!1,Go=async()=>{if(!Nt){Nt=!0;try{await mm()}finally{Nt=!1}}},mm=async()=>{let t=Gt();if(!t||!t.locationId){document.getElementById(pe)?.remove(),document.getElementById(`${pe}-wrap`)?.remove(),zo();return}let e=document.getElementById(pe);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove(),zo());return}e&&(e.remove(),document.getElementById(`${pe}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await bm();if(!r||!(xs(t.oppId)!==null||ze!==null&&ze.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Gt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=cm(t.oppId,i.locationId),l=document.createElement("span");l.id=`${pe}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),hm(t.oppId),Gn(i.locationId)},zt=null,Bn=null,Fn=null,zo=()=>{zt?.disconnect(),zt=null,Bn=null,Fn=null},hm=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(zt&&Bn===t&&Fn===e||(zo(),Bn=t,Fn=e,zt=new MutationObserver(()=>{let o=Gt();if(!o||o.oppId!==t||!o.locationId){zo();return}document.getElementById(pe)||Go(),Gn(o.locationId)}),zt.observe(e,{childList:!0,subtree:!0})))},Dn=null,Hn,um=()=>{Dn||(Dn=new MutationObserver(()=>{Hn===void 0&&(Hn=window.setTimeout(()=>{Hn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(pe);t&&!e&&!Nt&&Go()},300))}),Dn.observe(document.body,{childList:!0,subtree:!0}))},gs,vm=()=>{gs===void 0&&(gs=window.setInterval(()=>{let t=Gt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(pe)&&!Nt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Go()),Gn(t.locationId)},2e3))},Es=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),um(),vm(),Go()};var _m="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Le="ws-crm-manage-team-cta",Ts="ws-crm-manage-team-modal",gm=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ss={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},ym={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Cs=()=>{let t=window.location.pathname.match(gm);return t?{tenantId:t[1]}:null},Uo=async t=>{let e=await fetch(_m,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ae=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$e=t=>ae(t),qn="ws-crm-manage-team-toast",Wn=(t,e="info",o=4e3)=>{document.getElementById(qn)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=qn,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(qn)===a&&a.remove()},o)},Un=()=>{document.getElementById(Ts)?.remove()},fm=(t,e)=>{let o=ym[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
  ...
  `+t.map(r=>xm(r,e)).join(""),Vo=async t=>{Un();let e=document.createElement("div");e.id=Ts,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ae(Ss[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Vo(t)}),qo(e),setTimeout(()=>qo(e),200),setTimeout(()=>qo(e),800),window.addEventListener("resize",()=>qo(e)),e},Vn=!1,Dm=()=>{if(!Vn){Vn=!0;try{let t=Cs();if(!t){document.getElementById(Le)?.remove(),document.getElementById(`${Le}-floater`)?.remove();return}let e=document.getElementById(Le);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Le}-floater`)?.remove();let o=document.createElement("div");o.id=`${Le}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Om(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Vn=!1}}},As=()=>{if(!Cs()){document.getElementById(Le)?.remove(),document.getElementById(`${Le}-floater`)?.remove();return}Dm()};var Hm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Yn="ws-crm-prepare-contract-button",$s="ws-crm-prepare-contract-menu",ve="ws-crm-prepare-contract-modal",Ls="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Ps=()=>{if(document.getElementById(Ls))return;let t=document.createElement("style");t.id=Ls,t.textContent=`
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},ah=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,ih=()=>{let t=window.location.pathname.match(ah);if(!t)return;let e=t[1],o=oh();o&&o.proposalId===e&&(rh(),window.setTimeout(()=>{nh(o.title,o.bodyHtml)},600))},Ds="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(Ds)?.remove();let r=document.createElement("div");r.id=Ds;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Hs=(t,e)=>new Promise(o=>{document.getElementById(ve)?.remove();let r=document.createElement("div");r.id=ve,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,$=`
    ...
    padding-right: 28px;
  `,P=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${ue(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-occupancy-at-close" style="${$}">${P(y)}</select>
      </div>
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${ue(k)}" placeholder="Title company" style="${T}" />
      </div>
      <div style="${q}">
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),R=E.querySelector("#ws-pc-assignment-fee"),fe=!1;R?.addEventListener("input",()=>{fe=!0});let xe=()=>{if(fe)return;let J=Number(N?.value||0);R&&(R.value=String(Math.max(0,J-y)))};N?.addEventListener("input",xe);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),it=Number(N?.value||0),st=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),lt=Number(R?.value||0),dt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),ct=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Ue=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),pt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Ue){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),it!==m&&(Q.assignmentPrice=it),st!==h&&(Q.buyerEMD=st),lt!==_&&(Q.assignmentFee=lt),dt!==k&&(Q.closingOffice=dt),ct!==f&&(Q.buyerCompanyName=ct);let ir=Ue!==g||pt!==x||X!==S,sr=Object.keys(Q).length>0||ir,lr=a;sr?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",lr=await Ko({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Ue,buyerEarnestDueDate:pt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",lr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let la=lr?.debug?.propertyAddress||p,xl=la?`${la} - Assignment Agreement`:void 0;await Zn(t,e,o,xl),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},Ko=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Wm({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Zn=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await jm(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Jm(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=eh(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),th(a,s.title,s.bodyHtml)),Xm(t,a)},dh=async t=>{let e=Fm(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById($s)?.remove();let o=document.createElement("div");o.id=$s,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let g;try{g=await Vm(e.tenantId,e.contactId)}catch(x){Y(`Failed to load buyer's MT opps: ${x.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",x);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)b=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let x=await Hs(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!x){c.info("[prepare-contract] MT opp picker cancelled");return}b=x,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=g=>{let x=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),C=String(g.getDate()).padStart(2,"0");return`${x}-${S}-${C}`},h=g=>{let x=new Date;return x.setDate(x.getDate()+g),m(x)},_=h(45),y=h(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await Ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:y,userId:p})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let f=e.contactId||k.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}lh({tenantId:e.tenantId,contactId:f,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:y})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Um(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await Hs(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await Ko({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}sh({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await Zn(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Fs=()=>{let t=document.createElement("button");return t.id=Yn,t.type="button",t.style.cssText=`${M} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),dh(t)}),t},ch="ws-crm-contact-actions-bar",ph=async()=>{let t=Rs();if(!t){document.getElementById(Yn)?.remove();return}let e=null;try{e=await L(`#${ch}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Yn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Fs();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Ge="ws-crm-prepare-contract-button-opp",qt=`${Ge}-wrap`,bh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,mh=/\/v2\/location\/([A-Za-z0-9]+)/,hh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xn=()=>{let t=window.location.pathname,e=t.match(bh);if(!e)return null;let o=t.match(mh);return o?{oppId:e[1],tenantId:o[1]}:null},uh=async()=>{for(let t of hh)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Wo=!1,Ut=null,Qn=null,jn=null,Kn,Vt=()=>{Ut?.disconnect(),Ut=null,Qn=null},vh=t=>{if(Ut&&Qn===t)return;Vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qn=t,Ut=new MutationObserver(()=>{let o=Xn();if(!o||o.oppId!==t){Vt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ge)?.remove(),document.getElementById(qt)?.remove(),Vt();return}document.getElementById(Ge)||Ns()}),Ut.observe(e,{childList:!0,subtree:!0}))},_h=()=>{jn||(jn=new MutationObserver(()=>{Kn===void 0&&(Kn=window.setTimeout(()=>{Kn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Ge);t&&!e&&!Wo&&Ns()},300))}),jn.observe(document.body,{childList:!0,subtree:!0}))},Ns=async()=>{if(!Wo){Wo=!0;try{let t=Xn();if(!t){document.getElementById(Ge)?.remove(),document.getElementById(qt)?.remove(),Vt();return}let e=document.getElementById(Ge);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(qt)?.remove(),Vt());return}e&&(e.remove(),document.getElementById(qt)?.remove());let o=await uh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Xn();if(!a||a.oppId!==t.oppId)return;let i=Fs();i.id=Ge,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=qt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),vh(t.oppId)}finally{Wo=!1}}},zs=()=>{ih(),ph()};Bm();function te(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ue(t){return te(t)}var gh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",qe="ws-crm-compute-offer-button",oa="ws-crm-compute-offer-popover",Ys="ws-crm-offer-modal",Gs="ws-crm-contact-actions-bar",yh=[".central-panel","[class*='central-panel']"],Ie=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",ea=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},fh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],qs=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${fh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Us=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,ta=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(gh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},at=()=>{document.getElementById(oa)?.remove(),document.removeEventListener("mousedown",Js,!0)};function Js(t){let e=document.getElementById(oa),o=document.getElementById(qe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&at()}var Xs=(t,e)=>{at();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=oa;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Js,!0),0)},Jo=(t,e)=>{Xs(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},xh=(t,e,o)=>{Xs(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{at(),o(a.property_record_id)}),r.appendChild(i)})})},Xo=()=>{document.getElementById(Ys)?.remove(),document.removeEventListener("keydown",Qs,!0)};function Qs(t){t.key==="Escape"&&Xo()}var Vs=(t,e,o)=>{Xo(),at();let r=o,a=!1,i="",s=document.createElement("div");s.id=Ys,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&Xo()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,m,h)=>{a||(a=!0,i="",p(),ta({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,m=!!b.has_comps;l.innerHTML="";let h=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"-"));let y=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");y.type="button",y.addEventListener("click",Xo),h.append(_,y),l.appendChild(h);let k=F("div","padding:14px 18px 18px;");l.appendChild(k);let f=F("select",Us());(b.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(b.tier||b.property_condition)&&(N.selected=!0),f.appendChild(N)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let g=F("input",Us());g.type="number",g.placeholder="uses the level",g.value=b.repair_override!=null?String(b.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let x=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");x.appendChild(F("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${qs(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,g.value.trim())),x.append(S),k.appendChild(x),b.low_confidence&&m&&k.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${b.comp_count??0} comps in window.`));let C=b.current_offer!=null;k.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${Ie(b.current_offer)}${b.current_offer_date?` \xB7 ${qs(b.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=F("div","");w.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(f);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(w,T),k.appendChild(E);let $=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),P=(z,N,R)=>{let fe=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${R?.strong?"font-weight:700;":""}`),xe=F("div","");xe.appendChild(F("div",`font-size:${R?.strong?"13":"12"}px;color:${n.bone};`,z)),R?.sub&&xe.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,R.sub));let ee=F("div",`font-size:${R?.strong?"15":"12"}px;color:${R?.color||n.bone};white-space:nowrap;`,N);fe.append(xe,ee),$.appendChild(fe)};if(m&&b.imv!=null){P("Investor Market Value (IMV)",Ie(b.imv)),b.arv!=null&&P("After Repair Value (ARV)",Ie(b.arv),{color:n.ash});let z=b.repair_adjustment??0,N=-z,R=b.repair_override?"Repair override":b.property_condition_label||"Repairs";z===0?P(`Repairs (${R})`,"Included",{color:n.ash,sub:`${Ie(b.repair_total)} in repairs included at IMV`}):P(`Repairs (${R})`,ea(N),{color:N<0?n.crimson:n.emerald,sub:`${Ie(b.repair_total)} total, ${Ie(b.baseline_repairs)} included at IMV`}),P("Min. Profit Target",ea(-(b.profit_target??0)),{color:n.ash}),P("Maximum Cash Offer (MAO)",Ie(b.mao),{strong:!0,color:n.blue}),P("Target Profit",ea(-(b.ico_delta??0)),{color:n.ash}),P("Initial Cash Offer (ICO)",Ie(b.ico),{strong:!0,color:n.blue})}else $.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild($);let q=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);q.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),k.appendChild(q)}p(),document.body.appendChild(s),document.addEventListener("keydown",Qs,!0)},Ws=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=qe,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){xh(o,s.properties,l=>{a(!0),ta({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?Vs(e,d.property_record_id,d):Jo(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Jo(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?Vs(e,s.property_record_id,s):Jo(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await ta({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Jo(o,"Request failed. Try again.")}finally{a(!1)}}}),o},wh=async()=>{for(let t of yh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},js=async(t,e)=>{let o=e.querySelector(`#${Gs}`);if(!o)try{o=await L(`#${Gs}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Ks=()=>{let t=document.querySelectorAll(`#${qe}`);for(let e=1;e<t.length;e++)t[e].remove()},kh=async()=>{let t=B();if(!t||!t.locationId||t.source!=="url"){document.getElementById(qe)?.remove(),at();return}let e=t.locationId,o=document.getElementById(qe);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),at();let r="seller";try{r=je(await We(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(qe)?.remove();return}let a=await wh();if(!a){c.warn("[compute-offer] no central panel found");return}let i=B();if(!i||i.contactId!==t.contactId)return;let s=Ws(t.contactId,e);if(!await js(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}Ks(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(B()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(qe)){let d=Ws(t.contactId,e);js(d,a).then(()=>Ks())}});l.observe(a,{childList:!0})},Wt=null,Zs=()=>{let t=B()?.contactId??null;if(Wt&&Wt.id===t)return;let e=kh().finally(()=>{Wt?.promise===e&&(Wt=null)});Wt={id:t,promise:e}};var Jt="reos-theme-stylesheet",ia="reos-theme-fonts",Xt=!1,Eh=()=>{let t=document.getElementById(ia);t&&t.remove()},Th=`
/* ============================================
