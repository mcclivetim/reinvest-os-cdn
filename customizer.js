/* Wholesaling CRM Customizer v0.53.2 — built 2026-07-09T14:55:24.124Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Jo="[wholesaling-crm-customizer]",ep="__WS_CRM_DEBUG",op=()=>!!window[ep],p={info(...t){console.log(Jo,...t)},warn(...t){console.warn(Jo,...t)},error(...t){console.error(Jo,...t)},debug(...t){op()&&console.log(Jo,"[debug]",...t)}};var rp=/\/v2\/location\/([A-Za-z0-9]+)/,np=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match(rp);return t?t[1]:null},vn=()=>{let t=K();return t!==null&&np.has(t)};var Ps=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,yn=/\/v2\/location\/([A-Za-z0-9]+)/,ap=t=>{let e=t.match(Ps);if(!e)return null;let o=t.match(yn);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},sp=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ps);if(!a)continue;let s=r.match(yn)||window.location.pathname.match(yn);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=ap(window.location.pathname);return t||sp()};var Os=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Zo="",gn=null,re="other",fn=new Set,Qo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Zo)&&!(t!==gn))){Zo=window.location.pathname,gn=t,re=Os(),p.debug("Page/context changed:",re,Zo,"contact:",t);for(let r of fn)try{r(re)}catch(a){p.error("Subscriber threw:",a)}}},_t=t=>(fn.add(t),setTimeout(()=>t(re),0),()=>{fn.delete(t)}),Bs=()=>{re=Os(),Zo=window.location.pathname,gn=D()?.contactId??null,p.debug("Router init, current page:",re);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Qo()},history.replaceState=function(o,r,a){e(o,r,a),Qo()},window.addEventListener("popstate",Qo),setInterval(Qo,1e3)},ge=()=>re;var ip=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Ds=null,Rs=!1,Hs=t=>{let e=t.match(ip);e&&(Ds=e[1])},Fs=()=>{if(!Rs){Rs=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Hs(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Hs(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},Ut=()=>Ds;var Xo="0.53.2",tr="2026-07-09T14:55:24.125Z";var lp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",er=new Map,xn=new Map,dp=3e4,eo=4e3,cp=eo,$t=async(t,e)=>{if(!t)return null;let o=er.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<dp)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=xn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),cp);try{let l=`${lp}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),er.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let u=(m.contact_type||"").toLowerCase().trim()||null;return er.set(t,{type:u}),p.debug(`Resolved Contact Type for ${t}: ${u??"(unset)"}`),u}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),er.set(t,{type:null,failedAt:Date.now()}),null}})();xn.set(t,s);try{return await s}finally{xn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var P=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let u=a.querySelector(t);u&&(m(),s(u))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},wn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},zs=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,H=`
  ...
  flex-shrink: 0;
`;var kn="https://services.leadconnectorhq.com",Ns="__WS_CRM_CAPTURED_AUTH";var En=()=>{try{let t=localStorage.getItem(Ns);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(Ns),null):e:null}catch{return null}},pp=()=>{let t=En();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},$n=async(t,e={})=>{let o=pp();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var mp=/^[A-Za-z0-9]{15,30}$/,ne=t=>typeof t=="string"&&mp.test(t),Tn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},bp=()=>{let t=window.WS_CRM_USER_ID;return ne(t)?t:null},hp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ne(o))return o;return null},up=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Tn(e);if(!o)return null;let r=o.uid;if(ne(r))return r;let a=o.claims;if(a&&ne(a.user_id))return a.user_id}catch{}return null},_p=()=>{try{let t=En();if(!t?.authorization)return null;let e=t.authorization.replace(/^Bearer\s+/i,""),o=Tn(e);if(!o)return null;if(o.authClass==="User"&&ne(o.authClassId))return o.authClassId;if(ne(o.primaryAuthClassId))return o.primaryAuthClassId}catch{}return null},vp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ne(a))return a}catch{}}}catch{}return null},R=()=>bp()||up()||_p()||hp()||vp()||null,yp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Tn(e);return o?o.claims??o:null}catch{return null}},fe=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:yp()?.type==="agency"};var Ws="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",gp=`${Ws}/active-follow-up-get`,fp=`${Ws}/active-follow-up-set`,ae="ws-crm-active-follow-up-button",Sn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},xp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},wp=async t=>{let e=await fetch(gp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},kp=async(t,e)=>{let o=await fetch(fp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},se=(t,e)=>{let o=Sn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},qs=t=>{let e=document.createElement("button");return e.type="button",e.id=ae,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,se(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=xp();if(!(!r||r.contactId!==t)){se(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await kp(r,R()),s=a&&a.state&&a.state in Sn?a.state:"blue";se(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),se(e,"error"),setTimeout(()=>void rr(e,r),4e3)}}}),e},Ep=3e4,rr=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),se(t,"loading");try{let o=await wp(e),r=o&&o.state&&o.state in Sn?o.state:"gray",a=document.getElementById(ae);if(!a||a.dataset.contactId!==e.contactId)return;se(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,se(t,"error")}},$p=[".central-panel","[class*='central-panel']"],Cn="ws-crm-contact-actions-bar",Tp=async()=>{for(let t of $p)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await P("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Cp=async(t,e)=>{let o=e.querySelector(`#${Cn}`);if(!o)try{o=await P(`#${Cn}`,{timeoutMs:eo+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${Cn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Sp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},Ap=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Lp=async t=>{if(t==="url"){let o=await Tp();return o?{kind:"contact-detail",target:o}:null}let e=Sp();return e?{kind:"conversations",target:e}:null},Us=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Cp(t,e.target);return o}return Ap(t,e.target),"conversations-header"},Ip=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(ae);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=Ep&&rr(o,e);return}o&&o.remove();let r=await Lp(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=qs(e.contactId),i=await Us(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),js();let d=document.getElementById(ae)??s;rr(d,e),or?.disconnect(),or=new MutationObserver(()=>{let l=document.getElementById(ae);if(!(D()?.contactId===e.contactId)){or?.disconnect();return}if(!l){let m=qs(e.contactId);Us(m,r).then(()=>{js(),rr(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),or.observe(r.target,{childList:!0})},or=null,oo=null,Gs=()=>{let t=D()?.contactId??null;if(oo&&oo.contactId===t)return;let e=Ip().finally(()=>{oo?.promise===e&&(oo=null)});oo={contactId:t,promise:e}},js=()=>{let t=document.querySelectorAll(`#${ae}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var Mp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/callstats/sweep-run",nr="ws-crm-analytics-overlay",Op=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],Bp=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],M={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},V=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},O=t=>(Number(t)||0).toLocaleString("en-US"),Ln=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},no=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},Rp=()=>`${M.range}|${M.customStart}|${M.customEnd}`,ie=async(t=!1)=>{let e=Rp();if(!t&&M.cache.has(e)){M.data=M.cache.get(e),M.error=null,le();return}let o=K();if(!o){M.error="Could not resolve the sub-account id from the URL.",le();return}M.loading=!0,M.error=null,le();try{let r={tenant_id:o,range:M.range,tz_offset_minutes:new Date().getTimezoneOffset()};M.range==="custom"&&(r.start=M.customStart,r.end=M.customEnd);let a=await fetch(Mp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);M.data=s,M.cache.set(e,s)}catch(r){M.error=r instanceof Error?r.message:String(r)}finally{M.loading=!1,le()}},L=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},rt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),so=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${v.lg};padding:16px 18px;min-width:0;`,Mn=`font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=L("div",so+"flex:1;min-width:150px;");return r.appendChild(L("div",Mn+"margin-bottom:8px;",rt(t))),r.appendChild(L("div",`font-family:${h.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,rt(e))),o&&r.appendChild(L("div",`font-family:${h.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,rt(o))),r},Y=(t,e)=>{let o=L("div",so);if(o.appendChild(L("div",Mn,rt(t))),!e.length)return o.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=L("div","margin:0 0 10px;"),i=L("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(L("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,rt(a.label)));let d=L("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,rt(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${rt(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=L("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(L("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(L("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},ar=(t,e,o)=>{let r=L("div",so+"overflow-x:auto;");if(r.appendChild(L("div",Mn,rt(t))),!o.length)return r.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${rt(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${rt(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(L("div","",i)),r},Z=(t,e)=>{let o=L("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},ao=t=>{let e=L("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Ot=t=>(t||[]).map(e=>({label:e.label,primary:O(e.count),barVal:e.count})),Hp=t=>(t||[]).map(e=>({label:e.label,primary:V(e.sum),secondary:`\xB7 ${O(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),Ys=(t,e)=>{let o=t.calls||{};if(!o.available)return[L("div",`${so}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${rt(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=e==="acq"?"Seller":"Buyer",a=o[e]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${O(c.connects)} connected \xB7 ${O(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:no(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${no(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[Y(`${r} calls per rep (dials)`,s),Y(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(Y("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${no(c.talk_seconds)} talk`,barVal:c.dials})))),d},Dp=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(ao([dt("Closed revenue \u2014 365d",V(o.closed_revenue_365),`${O(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",V(o.avg_deal_size_365)),dt("Left to close this month",V(r.sum),`${O(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${O(r.missing_est_close)} missing est. close date`:"")),dt("New leads",O(o.total_leads),"in selected range")])),e.appendChild(ao([dt("Contracts",`${O((o.contracts||{}).count)}`,V((o.contracts||{}).sum)+" projected"),dt("Assignments",`${O((o.assignments||{}).count)}`,V((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${O((o.closed||{}).count)}`,V((o.closed||{}).sum)+" closed")])),e.appendChild(Z("1fr 1fr 1fr",[Y("New leads by source",Ot(o.new_leads_by_source)),Y("Contacts per closer (all time)",Ot(o.contacts_per_closer)),Y("Dispo deals per rep (all time)",Ot(o.dispo_deals_per_rep))]))},Fp=(t,e)=>{let o=t.acq||{};e.appendChild(Z("1fr 1fr",[Y("Offers made per rep",Ot(o.offers_per_rep)),Y("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} projected`,barVal:a.count})))])),e.appendChild(Z("1fr 1fr",[Y("Projected revenue per closer (open escrows)",Hp(o.projected_per_closer)),Y("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=Ys(t,"acq");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},zp=(t,e)=>{let o=t.dispo||{};e.appendChild(Z("1fr 1fr",[Y("Buyers qualified per dispo rep",Ot(o.buyers_qualified_per_rep)),Y("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(Z("1fr",[Y("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=Ys(t,"dispo");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Np=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(ao([dt("Open leads",O(r.open)),dt("Won (under contract+)",O(r.won)),dt("Lost / dead",O(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[ar("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[ar("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(Z("1fr 1fr",[Y("Dead leads by channel",Ot(o.dead_by_channel)),Y("Dead leads by city",Ot(o.dead_by_city))]))},qp=(t,e)=>{let o=t.tc||{};e.appendChild(ao([dt("Contracted",O(o.contracted),"in selected range"),dt("Closed",O(o.closed)),dt("Lost in escrow",O(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(Z("1fr 1fr",[Y("Deals per TC (contracted in range)",Ot(o.per_tc)),Y("Open escrows by stage",Ot(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,V(a.value),Ln(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(Z("1fr",[ar("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Up=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(ao([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${O(r.offers)} offers \xB7 ${O(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${O(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(Z("1fr 1fr",[Y("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Y("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,O(d.leads),O(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(Z("1fr",[ar("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${no(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${no(l.talk_seconds)} total \xB7 ${O(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(Z("1fr",[Y("Talk time per contract per rep",d)]))}else e.appendChild(L("div",`${so}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${rt(i.note||"")}`))},ro=t=>`padding:5px 12px;border-radius:${v.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${h.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,le=()=>{let t=document.getElementById(nr);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=L("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let _ of Op){let b=L("button",ro(M.range===_.key),rt(_.label));b.onclick=()=>{M.range=_.key,_.key!=="custom"?ie():le()},r.appendChild(b)}if(M.range==="custom"){let _=`background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,b=L("input",_);b.type="date",b.value=M.customStart;let g=L("input",_);g.type="date",g.value=M.customEnd;let x=L("button",ro(!0),"Apply");x.onclick=()=>{M.customStart=b.value,M.customEnd=g.value,M.customStart&&M.customEnd&&ie()},r.appendChild(b),r.appendChild(g),r.appendChild(x)}let a=L("button",ro(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ie(!0),r.appendChild(a),o.appendChild(r);let s=L("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let _ of Bp){let b=L("button",ro(M.tab===_.key),rt(_.label));b.onclick=()=>{M.tab=_.key,le()},s.appendChild(b)}if(o.appendChild(s),e.innerHTML="",M.loading){e.appendChild(L("div",`padding:60px;text-align:center;color:${n.ash};font-family:${h.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(M.error){let _=L("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${h.sans};font-size:13px;`,`Couldn't load analytics: ${rt(M.error)}`),b=L("button",ro(!0)+"margin:14px auto 0;display:inline-block;","Retry");b.onclick=()=>void ie(!0);let g=L("div","text-align:center;");g.appendChild(_),g.appendChild(b),e.appendChild(g);return}let i=M.data;if(!i){ie();return}let d=i.range||{},l=Number((i.calls||{}).last_swept)||0,c=l>0?` \xB7 calls as of ${new Date(l).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})} (syncing)`:"";e.appendChild(L("div",`font-family:${h.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${rt(d.label||"")} \xB7 ${Ln(d.start)} \u2192 ${Ln(d.end)} \xB7 ${O((i.meta||{}).opps)} opps \xB7 ${O((i.meta||{}).contacts)} contacts${c}`));let m=i.insights||[];if(m.length){let _=L("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let b of m.slice(0,6)){let g=b.level==="warn";_.appendChild(L("div",`padding:8px 12px;border-left:3px solid ${g?n.amber:n.blue};background:${g?n.amberGlow:n.blueGlow};border-radius:0 ${v.sm} ${v.sm} 0;font-family:${h.sans};font-size:12px;color:${n.bone};`,rt(b.text)))}e.appendChild(_)}let u=L("div","");M.tab==="company"?Dp(i,u):M.tab==="acq"?Fp(i,u):M.tab==="dispo"?zp(i,u):M.tab==="marketing"?Np(i,u):M.tab==="tc"?qp(i,u):Up(i,u),e.appendChild(u)},de=null,jp=()=>{let t=K();if(t){try{fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mode:"sync",tenant_id:t})}).catch(()=>{})}catch{}de&&window.clearTimeout(de),de=window.setTimeout(()=>{de=null,M.open&&(M.cache.clear(),ie(!0))},9e4)}},In=()=>{if(document.getElementById(nr))return;M.open=!0,jp();let t=L("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${h.sans};`);t.id=nr;let e=L("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=L("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(L("div",`font-family:${h.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=L("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${v.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=Qs,o.appendChild(r),e.appendChild(o),e.appendChild(L("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=L("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",Js),le(),M.data||ie()},Js=t=>{t.key==="Escape"&&Qs()},Qs=()=>{M.open=!1,de&&(window.clearTimeout(de),de=null),document.getElementById(nr)?.remove(),document.removeEventListener("keydown",Js)},Wp=["/kpis","ws-kpis","ws-analytics"],Gp=/\/custom-menu-link\//,An=!1,Ks=()=>{if(An||!Gp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Wp.some(i=>s.includes(i))});if(r){An=!0,p.info(`[analytics] custom-menu-link route detected (src=${r.src}) \u2014 opening overlay`);try{history.back()}catch{}setTimeout(()=>{In(),An=!1},50);return}t<10&&setTimeout(e,150)};e()},Vs=!1,Zs=()=>{if(Vs)return;Vs=!0,_t(()=>setTimeout(Ks,50)),Ks();let t=()=>{let e=window.location.hash.replace("#","");(e==="ws-analytics"||e==="ws-kpis")&&In()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_ANALYTICS=()=>In(),p.info("[analytics] mounted (menu-link route + hash + window trigger)")};var ei="ws-buybox-nav-icon",Bn="ws-buybox-panel",Xs="ws-buybox-modal",Kp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Rn="https://mcclivetim.github.io/reinvest-os-cdn/geo",sr=null,io=null,lo=null,On=async()=>{if(sr)return sr;try{let t=await fetch(`${Rn}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return sr=await t.json(),sr}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},Vp=async t=>{if(!io)try{let e=await fetch(`${Rn}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);io=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return io?.[t]??[]},Yp=async t=>{if(!lo)try{let e=await fetch(`${Rn}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);lo=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return lo?.[t]??[]},Hn=async t=>await(await fetch(Kp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Jp=(t,e)=>Hn({tenant_id:t,action:"list",buyer_contact_id:e}),Qp=(t,e,o,r)=>Hn({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Zp=(t,e)=>Hn({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Xp=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},tm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',em='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',om="nav.w-13, nav[class*='w-13']",rm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",nm=async()=>{try{return await P(om,{timeoutMs:2500})}catch{return null}},am=async()=>{try{return await P(rm,{timeoutMs:2500})}catch{return null}},sm=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,im=(t,e)=>{let o=document.createElement("div");return o.id=Bn,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{pm(t,e,()=>Dn(t,e))}),o},Dn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Jp(t,e),On()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}lm(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},lm=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let u=l.key==="state"?Xp(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Zp(r,c).then(u=>{if(!u.ok){alert(`Failed to remove: ${u.error||"unknown error"}`),l.disabled=!1;return}Dn(r,a)}).catch(u=>{alert(`Network error: ${u.message}`),l.disabled=!1}))})})},ir=!1,oi=(t,e)=>{ir=e;let o=sm(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=dm,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Dn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=ri,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},ri="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",dm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",cm=t=>{let e=document.createElement("button");return e.id=ei,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=ri,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${tm.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!ir;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),oi(r,a)}),e},pm=(t,e,o)=>{let r=document.getElementById(Xs);r&&r.remove();let a=document.createElement("div");a.id=Xs,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await On();s.innerHTML=u(w),_(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let w=await On();s.innerHTML=g(w),x(w)}else i.granularity==="county"?(s.innerHTML=b(i.stateCode||""),await Vp(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=b(i.stateCode||""),await Yp(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,g=w=>{let E=w.find(A=>A.code===i.stateCode);return`
    ...
    `},y=()=>{let w=i.granularity==="county"?io?.[i.stateCode||""]??[]:lo?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),A=s.querySelector("#ws-buybox-value-list");if(!E||!A)return;let B=j=>{let U=j.toLowerCase().trim();if(!U){A.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){A.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}A.innerHTML=W.map(N=>`
  ...
  `,$=()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),w.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),S())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void S()),setTimeout(()=>w.focus(),0))},S=async()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),A=(w?.value||"").trim();if(!/^\d{5}$/.test(A)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(A)},T=async w=>{if(!i.granularity||!w)return;let E=s.querySelector("#ws-buybox-err"),A=s.querySelector("#ws-buybox-save");A&&(A.disabled=!0,A.textContent="Adding\u2026"),E&&(E.textContent="");try{let B=await Qp(t,e,i.granularity,w);if(!B.ok){E&&(E.textContent=B.error||"Failed to add entry."),A&&(A.disabled=!1,A.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(B){E&&(E.textContent=`Network error: ${B.message}`),A&&(A.disabled=!1,A.textContent="Add")}};d()},Pn=!1,xe=null,co=null,ti=()=>{document.getElementById(ei)?.remove(),document.getElementById(Bn)?.remove(),co&&xe&&xe.nav.removeEventListener("click",co,!0),co=null,xe=null,ir=!1},ni=()=>{mm()},mm=async()=>{if(!Pn){Pn=!0;try{let t=D();if(!t){ti();return}let e=document.getElementById(Bn);if(e&&e.dataset.buyerContactId===t.contactId&&xe)return;ti();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(u){p.warn("[buy-box] Contact Type fetch failed",u);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([nm(),am()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=im(t.locationId,t.contactId),l=cm(()=>xe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};xe=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),co=u=>{let _=u.target;if(!_||c.iconBtn.contains(_))return;_.closest("button.sidebar-option-button")&&ir&&oi(c,!1)},a.addEventListener("click",co,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Pn=!1}}};var ii="ws-properties-nav-icon",qn="ws-properties-panel",ai="ws-properties-modal",Un="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",bm=`${Un}/list-for-contact`,hm=`${Un}/create-with-opp`,um=`${Un}/add-contact`,_m=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),vm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,li=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},lr=t=>{let e=li(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},Fn=t=>{let e=li(t);return e===null?"&mdash;":e.toLocaleString()},di={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},ym=t=>{let e=(t||"").toString().trim();return e?mt(di[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},gm=t=>{let e=(t||"").toString().trim();return e?di[e]||e:""},fm={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},xm=t=>{let e=(t||"").toString().trim();return e?fm[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},jt=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,wm=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${jt("Baths",Fn(t.baths))}
    ${jt("Sq Ft",Fn(t.sqft))}
    ${jt("Rehab",ym(t.rehab_level),gm(t.rehab_level))}
    ${jt("ARV",lr(t.arv))}
    ${jt("IMV",lr(t.imv))}
    ${jt("MAO",lr(t.mao))}
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},km='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',Em='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',$m="nav.w-13, nav[class*='w-13']",Tm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",pi="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Cm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Sm=async()=>{try{return await P($m,{timeoutMs:2500})}catch{return null}},Am=async()=>{try{return await P(Tm,{timeoutMs:2500})}catch{return null}},jn=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),Ct=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:13px;outline:none;margin-bottom:10px;`,St=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,Wn=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${h.sans};font-size:13px;font-weight:600;`,mi=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${h.sans};font-size:13px;`,Lm=(t,e)=>{let o=document.createElement("div");return o.id=qn,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${Wn}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{Mm(t,e,()=>Gn(t,e))}),o},Gn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await jn(bm,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}Im(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},Im=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
  ...
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=b=>(a.querySelector(b)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),u=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let _=a.querySelector("#wp-save");_&&(_.disabled=!0,_.textContent="Creating\u2026"),s&&(s.textContent="");try{let b=await jn(hm,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:u||void 0});if(!b.ok){s&&(s.textContent=b.error||"Failed to create property."),_&&(_.disabled=!1,_.textContent="Create property + deal");return}r.remove(),ci("Property + deal created \u2713"),o()}catch(b){s&&(s.textContent=`Network error: ${b.message}`),_&&(_.disabled=!1,_.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},Pm=(t,e,o,r)=>{let{overlay:a,card:s}=bi();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${mi}">Cancel</button>
      <button id="wpp-save" type="button" style="${Wn}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=g=>(s.querySelector(g)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),u=l("#wpp-phone"),_=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let b=s.querySelector("#wpp-save");b&&(b.disabled=!0,b.textContent="Adding\u2026"),i&&(i.textContent="");try{let g=await jn(um,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:u||void 0,email:_||void 0}});if(!g.ok){i&&(i.textContent=g.error||"Failed to add person."),b&&(b.disabled=!1,b.textContent="Add person");return}a.remove(),ci("Person added \u2713"),r()}catch(g){i&&(i.textContent=`Network error: ${g.message}`),b&&(b.disabled=!1,b.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},dr=!1,ut=null,zn=!1,po=null,Om=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},Bm=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},Nn=(t,e)=>{dr=e,e?(t.iconBtn.className=Cm,t.iconBtn.dataset.active="true",Bm(),Om(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",Gn(t.tenantId,t.contactId)):(t.iconBtn.className=pi,delete t.iconBtn.dataset.active,t.panel.style.display="none")},Rm=()=>{let t=document.createElement("button");return t.id=ii,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=pi,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${km.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ut&&Nn(ut,!dr)}),t},si=()=>{document.getElementById(ii)?.remove(),document.getElementById(qn)?.remove(),po&&ut&&ut.nav.removeEventListener("click",po,!0),po=null,ut=null,dr=!1},hi=()=>{Hm()},Hm=async()=>{if(!zn){zn=!0;try{let t=D();if(!t||!t.locationId){si();return}let e=document.getElementById(qn);if(e&&e.dataset.contactId===t.contactId&&ut)return;si();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Tt(o)!=="seller")return;let[a,s]=await Promise.all([Sm(),Am()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Lm(t.locationId,t.contactId),l=Rm();ut={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ut&&Nn(ut,!1)}),po=m=>{let u=m.target;!u||ut&&ut.iconBtn.contains(u)||u.closest("button.sidebar-option-button")&&dr&&ut&&Nn(ut,!1)},a.addEventListener("click",po,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{zn=!1}}};var ui="ws-non-seller-contact",_i=()=>{Dm()},Dm=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(ui);return}let e="seller";try{e=Tt(await $t(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(ui,e!=="seller")};var Wt="ws-crm-claim-release-pill",Fm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",zm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Nm=async t=>{let e=await fetch(Fm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},qm=async t=>{let e=await fetch(zm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},gi=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ke=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=zs(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Um=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=Wt,o.type="button",o.dataset.contactId=t,ke(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=R();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>ke(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";ke(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await qm({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;ke(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),ke(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},vi=async t=>{try{let e=await Nm({contactId:t.contactId,locationId:t.locationId,userId:R()}),o=document.getElementById(Wt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";ke(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},jm=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=gi(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},yi=(t,e)=>{let o=Um({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${Wt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},we=null,Wm=async()=>{let t=D();if(!t){we?.disconnect(),we=null,document.getElementById(Wt)?.remove();return}let e=document.getElementById(Wt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await P("#record-details-lhs",{timeoutMs:1e4}),r=await jm(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}yi(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(Wt)&&t.locationId&&vi({contactId:t.contactId,locationId:t.locationId}),we?.disconnect(),we=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){we?.disconnect();return}if(document.getElementById(Wt))return;let d=gi(o);d&&(yi(d,t.contactId),document.getElementById(Wt)&&t.locationId&&vi({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),we.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},fi=()=>{Wm()};var Ci="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Gm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",Km="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Vm=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||Ci,l;if(i==="buyer"){let m=Li.find(_=>_.label===o),u=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:u,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Ym=async({contactId:t,tenantId:e})=>{let o=await fetch(Km,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},Ee="ws-crm-contact-actions-bar",Si="ws-crm-call-status-dropdown",Ai="ws-crm-call-status-menu",pr="ws-crm-offer-made-modal",xi=!1,Jm=()=>{xi||(xi=!0,document.addEventListener("click",t=>{let e=document.getElementById(Ai);if(!e||e.style.display==="none")return;let o=document.getElementById(Si);o&&!o.contains(t.target)&&(e.style.display="none")}))},Qm=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"no-show",label:"No Show",color:"orange"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Li=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Zm=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Xm=async()=>{for(let t of Zm)try{let e=await P(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await P("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},tb=({contactId:t,kind:e})=>{let o=e==="buyer"?Li:Qm,r=e==="buyer"?Gm:Ci,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Si,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=H,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=Ai,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,u=i.children[1],_=i.children[2];m&&(m.style.background=wn[l.color]),u&&(u.textContent=l.label),d.style.display="none";let g=D()?.locationId,x=R();if(!g){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),u&&(u.textContent=`${l.label} (no tenant!)`),u&&(u.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!x){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),u&&(u.textContent=`${l.label} (no user!)`),u&&(u.style.color=n.amber);return}let k=_?.textContent??"\u25BE",y=async f=>{_&&(_.textContent="\u2026"),i.style.opacity="0.75";try{await Vm({contactId:t,locationId:g,status:l.label,userId:x,deadReason:f,webhookUrl:r,kind:e}),_&&(_.textContent="\u2713"),setTimeout(()=>{_&&(_.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),_&&(_.textContent="\u2717"),u&&(u.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{_&&(_.textContent=k),u&&(u.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let f=u?.textContent??"";sb($=>{y($)},()=>{u&&(u.textContent=f)});return}if(e==="seller"&&l.value==="appointment-booked"){let f=u?.textContent??"";try{(await Ym({contactId:t,tenantId:g})).ok?await y():ib(()=>{y()},()=>{u&&(u.textContent=f)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Jm(),s.appendChild(i),s.appendChild(d),s},eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ob=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",Vn=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),nb=async(t,e)=>{let o=await fetch(rb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},ab=t=>new Promise(e=>{document.getElementById(pr)?.remove();let o=document.createElement("div");o.id=pr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${h.sans};">
        <div style="font-size:14px;font-weight:500;">${Vn(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${Vn(i.dealStage)}</div>`:""}
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),u=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",_=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${Vn(o.address)}</strong></div>`:"",b=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",g=r&&o&&o.propertyRecordId?`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},Ei=(t,e)=>{let o=document.createElement("div");if(o.id=Ee,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=H,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){mo(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){mo(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await nb(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),mo(t,e);return}if(d(),l.length<=1){mo(t,e,l[0]);return}let c=await ab(l);c&&mo(t,e,c)}),o.appendChild(r),o.appendChild(tb({contactId:t,kind:e}))}return o},Kn=!1,$i=()=>{document.querySelectorAll(`[id="${Ee}"]`).forEach(t=>t.remove())},Ii=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Kn){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Kn=!0;try{await lb()}finally{Kn=!1}},lb=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),$i();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),$i();return}let e="seller";try{let l=await $t(t.contactId,t.locationId),c=Tt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Ee}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Xm();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Ei(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(Ee)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),cr?.disconnect(),cr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){cr?.disconnect();return}let c=document.querySelectorAll(`[id="${Ee}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,u=Ei(t.contactId,e);u.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(u,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),cr.observe(a,{childList:!0})},cr=null,Ti=null,db=()=>{Ti===null&&(Ti=window.setInterval(()=>{let t=D();t&&(document.getElementById(Ee)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ii()))},3e3))},Mi=()=>{db(),Ii()};var mr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",cb=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),bo="data-ws-crm-favicon",Yn=t=>t.hasAttribute(bo),Pi=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return cb.has(e)},br=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Pi(r)&&!Yn(r)&&r.remove()});let e=document.head.querySelector(`link[${bo}="1"]`);e?e.href!==mr&&(e.href=mr):(e=document.createElement("link"),e.setAttribute(bo,"1"),e.rel="icon",e.type="image/png",e.href=mr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${bo}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(bo,"apple"),o.rel="apple-touch-icon",o.href=mr,document.head.appendChild(o))},Oi=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)br();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),br())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Pi(i)&&!Yn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Yn(i)&&(a=!0)});a&&br()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,br(),e>=5&&window.clearInterval(o)},1e3)};var tt=".crm-opportunities-modal .ui-modal-heading .description",Bi=new Map,Jn=null,Qn,pb=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Bi){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},J=(t,e,o)=>{Bi.set(t,{selector:e,cb:o}),!Jn&&(Jn=new MutationObserver(()=>{Qn===void 0&&(Qn=window.setTimeout(()=>{Qn=void 0,pb()},300))}),Jn.observe(document.body,{childList:!0,subtree:!0}))};var mb=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],bb=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,hb=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let t=document.querySelector(hb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(bb);if(a){let s=a[1];if(mb.includes(s))return s}}return null},et=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ri="ws-crm-dispo-action-row",Q=t=>{let e=document.getElementById(Ri);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ri,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",gt="ws-crm-mt-offer-made-button",Hi="ws-crm-mt-offer-made-modal",_b=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vb=/\/v2\/location\/([A-Za-z0-9]+)/,_r=()=>{let t=window.location.pathname,e=t.match(_b),o=e?e[1]:Ut();if(!o)return null;let r=t.match(vb);return{oppId:o,locationId:r?r[1]:null}},yb=async t=>{let e=await fetch(ub,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},hr=()=>{document.getElementById(Hi)?.remove()},gb=t=>{hr();let e=document.createElement("div");e.id=Hi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=_r();!o||!o.locationId||o.oppId!==t||gb({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=H)},4e3)}})}),e},xb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wb=async()=>{for(let t of xb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ur=!1,Xn=async()=>{if(!ur){ur=!0;try{await kb()}finally{ur=!1}}},kb=async()=>{let t=_r();if(!t||!t.locationId){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}let e=document.getElementById(gt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo());return}e&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove());let o=await wb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_r();if(!a||a.oppId!==t.oppId)return;let s=fb(t.oppId),i=document.createElement("span");i.id=`${gt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Eb(t.oppId)},ho=null,Zn=null,$e,uo=()=>{ho?.disconnect(),ho=null,Zn=null,$e!==void 0&&(window.clearTimeout($e),$e=void 0)},Eb=t=>{if(ho&&Zn===t)return;uo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zn=t,ho=new MutationObserver(()=>{$e===void 0&&($e=window.setTimeout(()=>{$e=void 0;let o=_r();if(!o||o.oppId!==t){uo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}document.getElementById(gt)||Xn()},250))}),ho.observe(e,{childList:!0,subtree:!0}))},$b=()=>{J("mt-offer-made",tt,()=>{!document.getElementById(gt)&&!ur&&Xn()})},Di=()=>{$b(),Xn()};var Tb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ft="ws-crm-not-interested-button",Cb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Sb=/\/v2\/location\/([A-Za-z0-9]+)/,yr=()=>{let t=window.location.pathname,e=t.match(Cb),o=e?e[1]:Ut();if(!o)return null;let r=t.match(Sb);return{oppId:o,locationId:r?r[1]:null}},Ab=async t=>{let e=await fetch(Tb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Lb=t=>{let e=document.createElement("button");return e.id=ft,e.type="button",e.dataset.oppId=t,e.style.cssText=H,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=yr();if(!o||!o.locationId||o.oppId!==t)return;let r=R(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await Ab({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Ib=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Mb=async()=>{for(let t of Ib)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vr=!1,ea=async()=>{if(!vr){vr=!0;try{await Pb()}finally{vr=!1}}},Pb=async()=>{let t=yr();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await Mb();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=yr();if(!a||a.oppId!==t.oppId)return;let s=Lb(t.oppId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Ob(t.oppId)},_o=null,ta=null,vo=()=>{_o?.disconnect(),_o=null,ta=null},Ob=t=>{if(_o&&ta===t)return;vo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ta=t,_o=new MutationObserver(()=>{let o=yr();if(!o||o.oppId!==t){vo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),vo();return}document.getElementById(ft)||ea()}),_o.observe(e,{childList:!0,subtree:!0}))},Bb=()=>{J("not-interested",tt,()=>{!document.getElementById(ft)&&!vr&&ea()})},Fi=()=>{Bb(),ea()};var Rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",vt="ws-crm-schedule-walkthrough-button",oa="ws-crm-schedule-walkthrough-modal",Hb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Db=/\/v2\/location\/([A-Za-z0-9]+)/,xr=()=>{let t=window.location.pathname,e=t.match(Hb),o=e?e[1]:Ut();if(!o)return null;let r=t.match(Db);return{oppId:o,locationId:r?r[1]:null}},gr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Fb=(t,e)=>{document.getElementById(oa)?.remove();let o=document.createElement("div");o.id=oa,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=xr();!o||!o.locationId||o.oppId!==t||Fb(o.oppId,o.locationId)}),e},Nb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],qb=async()=>{for(let t of Nb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fr=!1,na=async()=>{if(!fr){fr=!0;try{await Ub()}finally{fr=!1}}},Ub=async()=>{let t=xr();if(!t||!t.locationId){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go();return}let e=document.getElementById(vt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go());return}e&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove());let o=await qb();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=xr();if(!a||a.oppId!==t.oppId)return;let s=zb(t.oppId),i=document.createElement("span");i.id=`${vt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),jb(t.oppId)},yo=null,ra=null,Te,go=()=>{yo?.disconnect(),yo=null,ra=null,Te!==void 0&&(window.clearTimeout(Te),Te=void 0)},jb=t=>{if(yo&&ra===t)return;go();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ra=t,yo=new MutationObserver(()=>{Te===void 0&&(Te=window.setTimeout(()=>{Te=void 0;let o=xr();if(!o||o.oppId!==t){go();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),go();return}document.getElementById(vt)||na()},250))}),yo.observe(e,{childList:!0,subtree:!0}))},Wb=()=>{J("schedule-walkthrough",tt,()=>{!document.getElementById(vt)&&!fr&&na()})},zi=()=>{Wb(),na()};var Gb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ce="ws-crm-resend-deal-link-wrap",Kb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Vb=/\/v2\/location\/([A-Za-z0-9]+)/,kr=()=>{let t=window.location.pathname,e=t.match(Kb),o=e?e[1]:Ut();if(!o)return null;let r=t.match(Vb);return{oppId:o,locationId:r?r[1]:null}},Yb=async t=>{let e=await fetch(Gb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Jb=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Ni=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,sa=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=H,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Ni(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Qb(t,e)),t.appendChild(o)},Qb=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Zb(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>sa(t,e)),o.appendChild(i),t.appendChild(o)},Zb=async(t,e,o,r)=>{let a=kr();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Yb({oppId:a.oppId,locationId:a.locationId,channel:o,userId:R()});if(s?.ok)r.innerHTML=`${Ni(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Jb(i)}</span>`}window.setTimeout(()=>sa(t,e),3500)}},Xb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],th=async()=>{for(let t of Xb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},wr=!1,ia=async()=>{if(!wr){wr=!0;try{await eh()}finally{wr=!1}}},eh=async()=>{let t=kr();if(!t||!t.locationId){document.getElementById(Ce)?.remove(),xo();return}let e=document.getElementById(Ce);if(e&&e.dataset.oppId===t.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(e.remove(),xo());return}e&&e.remove();let o=await th();if(!o)return;let r=await et();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=kr();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Ce,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Q(o).appendChild(s),sa(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),oh(t.oppId)},fo=null,aa=null,xo=()=>{fo?.disconnect(),fo=null,aa=null},oh=t=>{if(fo&&aa===t)return;xo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(aa=t,fo=new MutationObserver(()=>{let o=kr();if(!o||o.oppId!==t){xo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ce)?.remove(),xo();return}document.getElementById(Ce)||ia()}),fo.observe(e,{childList:!0,subtree:!0}))},rh=()=>{J("resend-deal-link",tt,()=>{!document.getElementById(Ce)&&!wr&&ia()})},qi=()=>{rh(),ia()};var nh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",xt="ws-crm-reduce-price-button",Ui="ws-crm-reduce-price-modal",ah=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sh=/\/v2\/location\/([A-Za-z0-9]+)/,Tr=()=>{let t=window.location.pathname,e=t.match(ah);if(!e)return null;let o=t.match(sh);return{oppId:e[1],locationId:o?o[1]:null}},ih=async t=>{let e=await fetch(nh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Er=()=>{document.getElementById(Ui)?.remove()},lh=t=>{Er();let e=document.createElement("div");e.id=Ui,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Tr();!r||!r.locationId||r.oppId!==t||lh({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=H,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},ch=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ph=async()=>{for(let t of ch)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$r=!1,da=async()=>{if(!$r){$r=!0;try{await mh()}finally{$r=!1}}},mh=async()=>{let t=Tr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await ph();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Tr();if(!a||a.oppId!==t.oppId)return;let s=dh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),bh(t.oppId)},wo=null,la=null,Se,ko=()=>{wo?.disconnect(),wo=null,la=null,Se!==void 0&&(window.clearTimeout(Se),Se=void 0)},bh=t=>{if(wo&&la===t)return;ko();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(la=t,wo=new MutationObserver(()=>{Se===void 0&&(Se=window.setTimeout(()=>{Se=void 0;let o=Tr();if(!o||o.oppId!==t){ko();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}document.getElementById(xt)||da()},250))}),wo.observe(e,{childList:!0,subtree:!0}))},hh=()=>{J("reduce-price",tt,()=>{!document.getElementById(xt)&&!$r&&da()})},ji=()=>{hh(),da()};var Ae="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Cr="deals.reinvestos.com";var wt="ws-crm-edit-landing-button",uh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_h=/\/v2\/location\/([A-Za-z0-9]+)/,Ar=()=>{let t=window.location.pathname,e=t.match(uh);if(!e)return null;let o=t.match(_h);return{oppId:e[1],locationId:o?o[1]:null}},vh=(t,e)=>{let o=new URL(`https://${Cr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ae);let r=R();return r&&o.searchParams.set("user",r),o.toString()},yh=(t,e)=>{let o=document.createElement("button");return o.id=wt,o.type="button",o.dataset.oppId=t,o.style.cssText=H,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ar();if(!r||!r.locationId||r.oppId!==t)return;if(!Ae){p.warn("[edit-landing] editor session key not configured in this build");return}let a=vh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},gh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],fh=async()=>{for(let t of gh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Sr=!1,pa=async()=>{if(!Sr){Sr=!0;try{await xh()}finally{Sr=!1}}},xh=async()=>{let t=Ar();if(!t||!t.locationId){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o();return}let e=document.getElementById(wt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o());return}e&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove());let o=await fh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Ar();if(!a||a.oppId!==t.oppId)return;let s=yh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${wt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),wh(t.oppId)},Eo=null,ca=null,Le,$o=()=>{Eo?.disconnect(),Eo=null,ca=null,Le!==void 0&&(window.clearTimeout(Le),Le=void 0)},wh=t=>{if(Eo&&ca===t)return;$o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ca=t,Eo=new MutationObserver(()=>{Le===void 0&&(Le=window.setTimeout(()=>{Le=void 0;let o=Ar();if(!o||o.oppId!==t){$o();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),$o();return}document.getElementById(wt)||pa()},250))}),Eo.observe(e,{childList:!0,subtree:!0}))},kh=()=>{J("edit-landing-page",tt,()=>{!document.getElementById(wt)&&!Sr&&pa()})},Wi=()=>{kh(),pa()};var Vi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Me="ws-crm-publish-button",To="ws-crm-publish-wrap",Ir="ws-crm-publish-dropdown",Eh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$h=/\/v2\/location\/([A-Za-z0-9]+)/,ma=()=>{let t=window.location.pathname,e=t.match(Eh);if(!e)return null;let o=t.match($h);return{oppId:e[1],locationId:o?o[1]:null}},Gi=async(t,e)=>{try{let o=await fetch(Vi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:R()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},Th=async(t,e)=>{let o=await fetch(Vi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:R()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Ch=(t,e)=>{if(!Ae){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Cr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ae);let r=R();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Ir)?.remove()},Ki=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Ir;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `;let r={status:"checking"};Gt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let b=await Gi(t,e);if(!b||!Array.isArray(b.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Gt(o,r);return}r={status:b.published?"published":b.ready?"ready":"incomplete",checks:b.checks},Gt(o,r),document.getElementById(Ir)&&r.checks&&Ki(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Gt(o,r),Bt();try{if((await Gi(t,e))?.published){r={status:"published"},Gt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let g=await Th(t,e);if(g.ok&&g.published)r={status:"published"},Gt(o,r),p.info(`[publish] published opp ${t}`);else if(g.missing&&g.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Gt(o,r);else throw new Error(g.error||"Publish failed")}catch(b){let g=b instanceof Error?b.message:"Publish failed";p.error("[publish] publish failed",b),r={status:"error",message:g.length>28?"Error \u2014 try again":g},Gt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Ir)?Bt():r.checks&&Ki(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),u=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",u);let _=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",u),window.clearInterval(_))},5e3);return o},Ah=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Lh=async()=>{for(let t of Ah)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lr=!1,ha=async()=>{if(!Lr){Lr=!0;try{await Ih()}finally{Lr=!1}}},Ih=async()=>{let t=ma();if(!t||!t.locationId){document.getElementById(Me)?.remove(),document.getElementById(To)?.remove(),Bt(),So();return}let e=document.getElementById(Me);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(To)?.remove(),Bt(),So());return}e&&(e.remove(),document.getElementById(To)?.remove(),Bt());let o=await Lh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=ma();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=Sh(t.oppId,a.locationId),i=document.createElement("span");i.id=To,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),Mh(t.oppId)},Co=null,ba=null,Ie,So=()=>{Co?.disconnect(),Co=null,ba=null,Ie!==void 0&&(window.clearTimeout(Ie),Ie=void 0)},Mh=t=>{if(Co&&ba===t)return;So();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ba=t,Co=new MutationObserver(()=>{Ie===void 0&&(Ie=window.setTimeout(()=>{Ie=void 0;let o=ma();if(!o||o.oppId!==t){So();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Me)?.remove(),document.getElementById(To)?.remove(),Bt(),So();return}document.getElementById(Me)||ha()},250))}),Co.observe(e,{childList:!0,subtree:!0}))},Ph=()=>{J("publish-button",tt,()=>{!document.getElementById(Me)&&!Lr&&ha()})},Yi=()=>{Ph(),ha()};var Ji="data:image/png;base64,",Qi="data:image/png;base64,";var Oh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Zi=t=>`ws-crm-map-links-${t}`,Xi=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),Mr=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},tl=(t,e=Xi())=>{let o=Mr(e,t.addr),r=Mr(e,t.city),a=Mr(e,t.state),s=Mr(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Bh=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Rh=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Hh=(t,e)=>{let{full:o,hasAny:r}=tl(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Dh=t=>{let e=document.createElement("span");e.id=Zi(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),Hh(t,i)}),d};return e.appendChild(r(Ji,"Open in Google Maps",Bh)),e.appendChild(r(Qi,"Search on Zillow",Rh)),e},Fh=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},el=()=>{let t=Xi();if(t.length)for(let e of Oh){if(document.getElementById(Zi(e.key)))continue;let{hasAny:o}=tl(e,t);if(!o)continue;let r=Fh(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Dh(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},Pe=null,Oe,zh=()=>{let t=ge();return t==="contact-detail"||t==="other"},Nh=()=>{Pe||(Pe=new MutationObserver(()=>{Oe===void 0&&(Oe=window.setTimeout(()=>{Oe=void 0;try{el()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Pe.observe(document.body,{childList:!0,subtree:!0}))},ol=()=>{Pe&&(Pe.disconnect(),Pe=null),Oe!==void 0&&(window.clearTimeout(Oe),Oe=void 0)},rl=()=>{if(!zh()){ol();return}Nh(),el()},nl=()=>{ol()};var al="ws-crm-hide-launchpad",ua=/\/launchpad\/?$/,_a=()=>{if(!fe()){if(!document.getElementById(al)){let t=document.createElement("style");t.id=al,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ua.test(location.pathname)){let t=location.pathname.replace(ua,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!ua.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var qh=[{label:"Buy-Box Entries"},{label:"Memberships"}],sl=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},va=()=>{let t=fe(),e=new Set(qh.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){sl(e);for(let o of[150,500,1200,2500])setTimeout(()=>sl(e),o)}};var Uh=[{from:"Payments",to:"Contracts"}],jh=".nav-title, .topmenu-navtitle",il=()=>{document.querySelectorAll(jh).forEach(t=>{let e=(t.textContent||"").trim(),o=Uh.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},ya=()=>{il();for(let t of[150,500,1200,2500])setTimeout(il,t)};var ll="/payments/proposals-estimates",Wh=/\/payments\/invoices\/?$/,Gh=/\/payments\//,Kh='#sb_payments, a[meta="payments"]',cl=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(ll)&&!(t>3&&!Gh.test(e))){if(Wh.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(ll));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>cl(t+1),120)}},dl=!1,Vh=()=>{dl||(dl=!0,document.addEventListener("click",t=>{t.target?.closest?.(Kh)&&setTimeout(()=>cl(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},ga=()=>{Vh()};var pl=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ml="ws-crm-hide-topmenu-tabs",fa=()=>{if(document.getElementById(ml))return;let t=pl.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ml,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${pl.length} top tabs`)};var ul="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Kt="ws-crm-send-to-closing-office-button",ce="ws-crm-send-to-title-co-wrap",Br="ws-crm-stc-dropdown",Yh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jh=/\/v2\/location\/([A-Za-z0-9]+)/,Io=()=>{let t=window.location.pathname,e=t.match(Yh);if(!e)return null;let o=t.match(Jh);return{oppId:e[1],locationId:o?o[1]:null}},Qh=5*60*1e3,ka=t=>`ws-crm-stc-cache:${t}`,Zh=t=>{try{let e=window.localStorage.getItem(ka(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Qh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Xh=(t,e)=>{try{window.localStorage.setItem(ka(t),JSON.stringify(e))}catch{}},_l=t=>{try{window.localStorage.removeItem(ka(t))}catch{}},xa="ws-crm:opp-fields-updated",vl=t=>{if(t){_l(t);try{window.dispatchEvent(new CustomEvent(xa,{detail:{oppId:t}}))}catch{}}},tu=async(t,e)=>{try{let o=await fetch(ul,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:R()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},eu=async(t,e,o)=>{let r=await fetch(ul,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:R()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},ou=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},bl=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ru=(t,e)=>{if(e&&ou(e)){window.setTimeout(()=>bl(t),300);return}bl(t)},kt=()=>{document.getElementById(Br)?.remove()},Pr=(t,e,o)=>{kt();let r=document.createElement("div");r.id=Br;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,At(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await tu(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},At(o,a);return}if(y.rate_limited){b=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},At(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},At(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Rr.add(t),document.getElementById(Kt)?.remove(),document.getElementById(ce)?.remove(),kt(),Lo();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Xh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),At(o,a),document.getElementById(Br)&&Pr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},At(o,a),kt();try{let f=await eu(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},At(o,a),f.checks&&Pr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},At(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},At(o,a),f.checks&&Pr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},At(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Br)?kt():a.checks&&Pr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,c=!1,m=Date.now(),u=1e4,_=5*60*1e3,b=0,g=!1,x=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=Io();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let S=Date.now()-m,T=Math.max(1500,u-S);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=S=>{let T=S.detail;if(!T||T.oppId!==t)return;_l(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}x()};E()};window.addEventListener(xa,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(xa,f),window.clearInterval($))},5e3)}return o},au=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],su=async()=>{for(let t of au)try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Rr=new Set,hl=null,iu=t=>{t&&t!==hl&&(Rr.clear(),hl=t)},Or=!1,Ea=async()=>{if(Or){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Or=!0;try{await lu()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Or=!1}},lu=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Io();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Kt)?.remove(),document.getElementById(ce)?.remove(),kt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),iu(t.oppId),Rr.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Kt)?.remove(),document.getElementById(ce)?.remove(),kt();return}let e=document.getElementById(Kt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(ce)?.remove(),kt(),Lo());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ce)?.remove(),kt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await su();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Io();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=nu(t.oppId,a.locationId),i=document.createElement("span");i.id=ce,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),du(t.oppId)},Ao=null,wa=null,Lo=()=>{Ao?.disconnect(),Ao=null,wa=null},du=t=>{if(Ao&&wa===t)return;Lo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wa=t,Ao=new MutationObserver(()=>{let o=Io();if(!o||o.oppId!==t){Lo();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Kt)?.remove(),document.getElementById(ce)?.remove(),kt(),Lo();return}document.getElementById(Kt)||Ea()}),Ao.observe(e,{childList:!0,subtree:!0}))},cu=()=>{J("send-to-closing",tt,()=>{if(document.getElementById(Kt)||Or)return;let t=Io();t&&Rr.has(t.oppId)||Ea()})},yl=()=>{cu(),Ea()};var Ca="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",pu=`${Ca}/tc/welcome-call-prefill`,mu=`${Ca}/tc/welcome-call-save`,bu=`${Ca}/tc/order-lockbox`,Mo="ws-crm-welcome-call-overlay",hu=["Regular Contract","Subject To","Seller Finance","Novation"],uu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],_u=["Gas","Electric","Propane","Oil"],vu=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],yu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Vt=["Yes","No"],gu=["Yes","No","Unknown"],fu=["Professional Photographer","Seller","Tenant"],xu=["Month-to-Month","Annual"],gl=["Current","Behind"],wu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Lt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Dr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,wl="margin-bottom:12px;",kl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,ku=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,fl=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=fl(o);return`<select id="${t}" style="${Dr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&fl(a)===r?"selected":""}>${Lt(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${Lt(e)}" placeholder="${Lt(o)}" style="${Dr}">`,Eu=(t,e)=>`<textarea id="${t}" rows="3" style="${Dr}resize:vertical;">${Lt(e)}</textarea>`,$u=(t,e)=>`<input id="${t}" type="date" value="${Lt(e)}" style="${Dr}">`,F=(t,e)=>`<div style="${wl}"><label style="${kl}">${Lt(t)}</label>${e}</div>`,$a=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${wu.map(r=>`<label style="${ku}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${Lt(t)}</div>`,Be=()=>{document.getElementById(Mo)?.remove()},pe=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Tu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    ...
    ${Rt("Contract")}
    ${F("Type of Contract",ot("wc-contract_type",hu,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",ot("wc-property_type",vu,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",ot("wc-utilities",uu,t.utilities))}
    ${F("Heat Source",ot("wc-heat_source",_u,t.heat_source))}

    ${Rt("Liens & Permits")}
    ${F("Is there a mortgage?",ot("wc-has_mortgage",Vt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",ot("wc-mortgage_payment_status",gl,t.mortgage_payment_status))}</div>
    ...
    ${Rt("Occupancy")}
    ${F("Property occupancy",ot("wc-occupancy",yu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",ot("wc-tenant_lease_type",xu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",ot("wc-tenant_rent_status",gl,e.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",$u("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",ot("wc-hoa_rental_restriction",gu,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",ot("wc-photos_provided_by",fu,t.photos_provided_by))}
    <div style="${wl}">
      <label style="${kl}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${$a("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${$a("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${$a("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
  ...
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Ta=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),xl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},Hr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?Lt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},Cu=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:Ta("photos_avail_mornings"),photos_avail_afternoons:Ta("photos_avail_afternoons"),photos_avail_evenings:Ta("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),Su=t=>{Be();let e=document.createElement("div");e.id=Mo,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${h.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${Tu(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&Be()}),document.getElementById("wc-close")?.addEventListener("click",Be),document.getElementById("wc-cancel")?.addEventListener("click",Be),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",xl)}),xl();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!I("wc-occupancy")){pe("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(mu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Cu(t)),credentials:"omit"})).ok?(Be(),pe("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,pe("Save failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,pe("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(bu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:I("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:I("wc-lockbox_recipient_name"),recipient_phone:I("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),pe("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,pe("Lockbox order failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,pe("Couldn't reach the lockbox handler. Try again.","err")}})},El=async(t,e)=>{Be();let o=document.createElement("div");o.id=Mo,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${h.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${pu}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,Su(r)};var Pa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Au=`${Pa}/tc/confirm-photo-appointment`,Lu=`${Pa}/tc/order-lockbox`,Iu=`${Pa}/tc/welcome-call-prefill`,La="ws-crm-opp-action-bar",Tl="ws-crm-opp-overflow",Cl="ws-crm-opp-action-menu",Ia="ws-crm-opp-action-popover",Sl="ws-crm-reorder-lockbox-modal",Al=".hr-card.hr-modal.crm-opportunities-modal",Mu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Pu=/\/v2\/location\/([A-Za-z0-9]+)/,Ll="Welcome Call Needed",Oa="Scheduling Photos",Il="Photos Scheduled",Ou=[Ll,Oa,Il,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],Ml=()=>{let t=window.location.pathname,e=t.match(Mu);if(!e)return null;let o=t.match(Pu);return o?{oppId:e[1],locationId:o[1]}:null},Bu=()=>{let t=document.querySelector(Al);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(Ou.includes(r))return r}return null},Jt=()=>{document.getElementById(Cl)?.remove(),document.getElementById(Ia)?.remove(),document.getElementById(Sl)?.remove()},Sa=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Yt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Ru=t=>{El(t.oppId,t.locationId)},Hu=async(t,e,o)=>(await fetch(Lu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Du=(t,e)=>{Jt();let o=document.createElement("div");o.id=Sl,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Sa(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Sa(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Sa(i)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",u=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!u){Yt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{await Hu(t,e,{recipient_name:c,recipient_phone:m,ship_to:u})?(d(),Yt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Yt("Re-order failed \u2014 try again.","err"))}catch(_){p.warn("[action-bar] reorder lockbox failed:",_),l.disabled=!1,l.textContent="Order Lockbox",Yt("Couldn't reach the lockbox handler. Try again.","err")}}})},Pl=async t=>{Jt();let e={};try{e=await fetch(`${Iu}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Du(t,e)},Fu=(t,e)=>{Jt();let o=document.createElement("div");o.id=Ia;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${h.sans};
  `,o.innerHTML=`
    <style>#${Ia} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Yt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(Au,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Jt(),Yt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Yt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Yt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Jt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},zu=(t,e)=>{Jt();let o=document.createElement("div");o.id=Cl;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${h.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Jt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},zr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=H,o.textContent=t,o},Nu=()=>{let t=zr("\u22EE","ghost");return t.style.lineHeight="1",t},qu=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Ll){let r=zr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Ru(t)),o.appendChild(r),o}if(e===Oa){let r=zr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Fu(t,r)),o.appendChild(r),o}if(e===Il){let r=zr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Pl(t)),o.appendChild(r),o}return null},Uu=(t,e)=>{let o=[];if(e===Oa&&(o=[{label:"Re-order Lockbox",onClick:()=>void Pl(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Tl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Nu();return a.addEventListener("click",s=>{s.stopPropagation(),zu(o,a)}),r.appendChild(a),r},ju=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Wu=async()=>{for(let t of ju)try{let e=await P(t,{timeoutMs:1200});if(e)return e}catch{}return null},Fr=()=>{document.getElementById(La)?.remove(),document.getElementById(Tl)?.remove(),Jt()},Nr=!1,Ba=async()=>{if(!Nr){Nr=!0;try{let t=Ml();if(!t){Fr();return}let e=z();if(e===null)return;if(e!=="Transaction Coordination"){Fr();return}let o=Bu(),r=document.getElementById(La);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=qu(t,o);if(!a){Fr();return}let s=await Wu();if(!s)return;Fr();let i=Q(s),d=document.createElement("span");d.id=La,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Uu(t,o);l&&i.appendChild(l),Gu(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{Nr=!1}}},Po=null,Ma=null,Aa,$l=()=>{Po?.disconnect(),Po=null,Ma=null},Gu=t=>{if(Po&&Ma===t)return;$l();let e=document.querySelector(Al);e&&(Ma=t,Po=new MutationObserver(()=>{let o=Ml();if(!o||o.oppId!==t){$l();return}Aa===void 0&&(Aa=window.setTimeout(()=>{Aa=void 0,Ba()},250))}),Po.observe(e,{childList:!0,subtree:!0}))},Ku=()=>{J("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{Nr||Ba()})},Ol=()=>{Ku(),Ba()};var Vu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ra=null,Bl=null,Rl=async()=>{let t=K(),e=R();if(!t||!e)return null;if(Ra&&Bl===t)return Ra;try{let a=(await(await fetch(Vu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(i=>i.id===e);if(!a)return null;let s={name:[a.first_name,a.last_name].filter(Boolean).join(" ").trim(),email:(a.email??"").trim(),phone:(a.phone??"").trim(),role:(a.roles??[])[0]?.display??""};return Ra=s,Bl=t,s}catch(o){return p.warn("[current-rep] roster load failed",o),null}};var Ht="ws-support-modal",Hl="ws-support-toast",Yu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Dl="ws-support-submitter-name",Fl="ws-support-submitter-email",zl="ws-support-submitter-role",Ju=["Bug","Feature Request","Question","Billing","Onboarding Help"],me=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Qu=(t,e="success",o)=>{let r=document.getElementById(Hl);r&&r.remove();let a=document.createElement("div");a.id=Hl;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${me(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${me(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Zu=t=>{let e=(o,r,a)=>o.style.setProperty(r,a,"important");t.querySelectorAll("input, textarea").forEach(o=>{e(o,"background-color",n.obsidian),e(o,"color",n.bone),e(o,"-webkit-text-fill-color",n.bone),e(o,"border-color",n.steel);let r=o.previousElementSibling;r instanceof HTMLElement&&r.tagName==="DIV"&&(e(r,"color",n.bone),e(r,"-webkit-text-fill-color",n.bone))}),t.querySelectorAll("div").forEach(o=>{e(o,"background-color","transparent"),e(o,"border-style","none")})},Ul=()=>{document.getElementById(Ht)?.remove();let t=(localStorage.getItem(Dl)??"").trim(),e=(localStorage.getItem(Fl)??"").trim(),o=(localStorage.getItem(zl)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ht,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `;let i=c=>`
    <button type="button" data-category="${me(c)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;s.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" autocomplete="off" value="${me(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" autocomplete="off" value="${me(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" autocomplete="off" value="${me(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(s),document.body.appendChild(a);let d=null,l=()=>{d?.disconnect(),Zu(s),d?.observe(s,{attributes:!0,attributeFilter:["style"],subtree:!0})};d=new MutationObserver(l),l(),window.setTimeout(()=>{d?.disconnect(),d=null},8e3),Rl().then(c=>{if(!c||!document.getElementById(Ht))return;let m=(u,_)=>{let b=s.querySelector(u);b&&!b.value.trim()&&_&&(b.value=_)};m("#ws-support-name",c.name),m("#ws-support-email",c.email),m("#ws-support-role",c.role)}),a.addEventListener("click",c=>{c.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(c=>{c.addEventListener("mouseenter",()=>{c.dataset.selected!=="true"&&(c.style.borderColor=n.emerald,c.style.background=n.emeraldGlow)}),c.addEventListener("mouseleave",()=>{c.dataset.selected!=="true"&&(c.style.borderColor=n.steel,c.style.background=n.steel)}),c.addEventListener("click",()=>{r.category=c.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(m=>{m===c?(m.dataset.selected="true",m.style.borderColor=n.emerald,m.style.background=n.emeraldGlow,m.style.color=n.emeraldBright):(m.dataset.selected="false",m.style.borderColor=n.steel,m.style.background=n.steel,m.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let c=s.querySelector("#ws-support-err"),m=b=>{c&&(c.textContent=b)};if(m(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){m("Pick a category at the top.");return}if(!r.title){m("Add a title \u2014 a short summary.");return}if(!r.description){m("Add a description so we know what you're seeing.");return}if(!r.submitterName){m("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){m("Add a valid email so we can reply.");return}let u=K();if(!u){m("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Dl,r.submitterName),localStorage.setItem(Fl,r.submitterEmail),r.submitterRole&&localStorage.setItem(zl,r.submitterRole)}catch{}let _=s.querySelector("#ws-support-submit");_&&(_.disabled=!0,_.textContent="Submitting\u2026",_.style.opacity="0.7");try{let g=await(await fetch(Yu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:u,category:r.category,title:r.title,description:r.description,submitter_user_id:R()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!g.ok){m(g.error||"Failed to submit ticket."),_&&(_.disabled=!1,_.textContent="Submit Ticket",_.style.opacity="1");return}a.remove();let x=g.ticket_short_id||"submitted";Qu(`Ticket ${x} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(b){m(`Network error: ${b.message}`),_&&(_.disabled=!1,_.textContent="Submit Ticket",_.style.opacity="1")}})},Xu=["/support-ticket","ws-support-modal","ws-support"],t_=/\/custom-menu-link\//,Ha=!1,Nl=()=>{if(Ha||!t_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Xu.some(i=>s.includes(i))});if(r){Ha=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Ul(),Ha=!1},50);return}t<10&&setTimeout(e,150)};e()},e_=t=>{if(!(t instanceof Element))return!1;let e=t.closest("a.custom-link");return!!e&&/^\s*Support\s*$/.test(e.textContent||"")},ql=!1,jl=()=>{ql||(ql=!0,document.addEventListener("click",t=>{e_(t.target)&&(t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),p.info("[support-nav] intercepted Support click (capture) \u2014 opening modal in place, no GHL navigation"),Ul())},!0),_t(()=>setTimeout(Nl,50)),Nl(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Wl="ws-phone-assignments-modal",Gl="ws-phone-assignments-toast",o_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",r_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",n_=["ACQ","DISPO","TC"],Yl="",Qt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),a_=(t,e="success",o)=>{document.getElementById(Gl)?.remove();let r=document.createElement("div");r.id=Gl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Qt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Qt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},s_=(t,e,o)=>{let r=[`<option value="" ${o===Yl?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Qt(a)}" ${o===a?"selected":""}>${Qt(a)}</option>`)].join("");return`<select data-assign="${Qt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},i_=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Fa=async t=>{document.getElementById(Wl)?.remove();let e=t||K(),o=document.createElement("div");o.id=Wl,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${o_}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){p.error("[phone-assignments] GET failed",_);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Qt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:n_,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,c=i.length?i.map(_=>`<div style="${i_}">
    ...
    </div>`,u.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let b=_.getAttribute("data-assign")||"",[g,...x]=b.split(":"),k=x.join(":");g==="num"&&(_.value?d[k]=_.value:delete d[k])})}),u.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),u.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=u.querySelector("#ws-pa-err"),b=x=>{_&&(_.textContent=x)};b("");let g=u.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(r_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){b(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),a_("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){b(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},l_=["ws-phone-assignments","phone-assignments"],d_=/\/custom-menu-link\//,Da=!1,Kl=()=>{if(Da||!d_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return l_.some(i=>s.includes(i))});if(r){Da=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Fa(s),Da=!1},50);return}t<10&&setTimeout(e,150)};e()},Vl=!1,Jl=()=>{if(Vl)return;Vl=!0,_t(()=>setTimeout(Kl,50)),Kl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Fa()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Fa(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Ql="powerDialerApp",c_=".dialer",p_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',m_=".dial-item.dial-btn.dial-btn-enabled",Re=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},b_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},za=()=>{try{let e=window[Ql]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},He=()=>document.querySelector(c_),qr=()=>za()!==null||He()!==null?!0:!!window[Ql],Ur=(t,e)=>{let o=za();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},Zl=()=>{if(He())return;let t=document.querySelector(p_);t?Re(t):p.warn("[dialer-bridge] Voice Calling button not found")},h_=()=>{let t=document.querySelector(".number-list-container")||He();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Na=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?b_(t.innerText):null},Xl=(t,e)=>{if(Na()===t)return!0;let o=za();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Re(r);let a=h_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Re(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},td=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Ur("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Re(a)}},ed=()=>{let t=He();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(m_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Re(e),!0):Ur("makeCall",{provider:"twilio"})};var qa=()=>{let t=He();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Re(e.closest("button")||e):Ur("closeCallBox")},od=()=>{Ur("closeCallBox")},rd=t=>{let e=!1,o=()=>{let s=He()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var u_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",__="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",nd=["acq","dispo","tc"],Bo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Oo=null,ad=null,v_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&Oo&&ad===o)return Oo;try{let a=await(await fetch(`${u_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Oo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},ad=o,Oo}catch(r){return p.warn("[silo] config load failed",r),Oo??e}},be=null,sd=null,Ua=async(t=!1)=>{let e=K(),o=R();if(!e||!o)return[];if(!t&&be&&sd===e)return be;try{let s=(await(await fetch(__,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];be=nd.filter(d=>i.includes(d))}else fe()?be=[...nd]:be=[];return sd=e,be}catch(r){return p.warn("[silo] roster load failed",r),be??[]}},ld=()=>`ws-pd-calling-as:${R()||"anon"}`,dd=t=>{try{localStorage.setItem(ld(),t)}catch{}},ja=async()=>{let t=await Ua();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(ld())}catch{}return e&&t.includes(e)?e:t[0]},id=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},y_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),cd=async t=>{let e=await ja();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await v_(),a=y_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=id(t),i=s?a.find(m=>id(m)===s):void 0,d=i||a[0];if(!Xl(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Bo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Na();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var g_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",pd="data-ws-pd",md="ws-crm-pd-panel",bd="ws-crm-pd-session",Zt=t=>new Promise(e=>setTimeout(e,t)),Ro=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),f_=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},x_=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},w_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},k_=async t=>{let e=f_(t);if(!e)return[];let o=x_(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Zt(550)}return o.scrollTop=0,w_(e)},E_=async(t,e)=>{try{let r=await(await fetch(g_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},$_=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,Ga=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(md)?.remove();let r=document.createElement("div");r.id=md,r.style.cssText=$_;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((x,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{qa()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{qa()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await E_(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Zt(1200);continue}let u=l._phone||m?.phone||"",_=m?.name||l.name;if(!u){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Zt(1400);continue}if(await cd(u),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(b){p.debug("[bulk-dialer] screen-follow nav failed",b)}i(`Calling ${u}\u2026`,d,_);try{Zl(),await Zt(250),td(u),await Zt(250),ed()}catch(b){p.error("[bulk-dialer] dial failed",b)}if(await new Promise(b=>{let g=!1,x=()=>{g||(g=!0,window.clearInterval(y),k(),b())},k=rd(x),y=window.setInterval(()=>{(a.stopped||a.skip)&&x()},300)}),a.stopped)break;try{od()}catch{}if(d<e.length-1)if(o)for(let b=5;b>0&&!a.stopped&&!a.advance;b--){for(i(`Next call in ${b}s\u2026`,d,_);a.paused&&!a.stopped&&!a.advance;)await Zt(200);if(a.advance||a.stopped)break;await Zt(1e3)}else for(i("Ready \u2014 press Call Next",d,_);!a.advance&&!a.stopped;)await Zt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Ka='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Va=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},T_=()=>{if(ge()!=="opportunity-list"||!Va()||!qr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${pd}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(pd,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Ka}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await k_(e);Ga(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},De=null,Wa,hd=!1,_d=()=>{if(hd)return;hd=!0,window.WS_CRM_PD_TEST=e=>void ud("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Wa!==void 0&&window.clearTimeout(Wa),Wa=window.setTimeout(T_,400)};_t(e=>{e==="opportunity-list"?(t(),De||(De=new MutationObserver(t),De.observe(document.body,{childList:!0,subtree:!0}))):De&&(De.disconnect(),De=null)})};var vd="ws-crm-pd-contacts-btn",C_=t=>new Promise(e=>setTimeout(e,t)),S_=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},A_=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Ya=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=S_(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},L_=async t=>{let e=new Map;if(t)return Ya(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(Ya(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(Ya(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await C_(220);return o.scrollTop=0,[...e.values()]},I_=()=>{if(ge()!=="contact-list"||!Va()||!qr()||document.getElementById(vd))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=vd,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${h.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${Ka}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=A_(),l=await L_(d);Ga(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},Fe=null,Ja,yd=!1,gd=()=>{if(yd)return;yd=!0;let t=()=>{Ja!==void 0&&window.clearTimeout(Ja),Ja=window.setTimeout(I_,400)};_t(e=>{e==="contact-list"?(t(),Fe||(Fe=new MutationObserver(t),Fe.observe(document.body,{childList:!0,subtree:!0}))):Fe&&(Fe.disconnect(),Fe=null)})};var M_="ws-calling-as-chip",P_=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},Qa=!1,he=null,fd,wd=0,O_=3e4,B_=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},Za=()=>{if(!he||he.isConnected)return;let t=B_();t&&t.parent.insertBefore(he,t.before)},xd=async()=>{if(!(Qa||he)&&P_()){Qa=!0;try{let t=await Ua();if(!t.length)return;let e=await ja()??t[0],o=t.length>1,r=document.createElement("div");r.id=M_,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${h.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${h.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Bo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Bo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${h.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Bo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",u=>{u.stopPropagation(),e=l,dd(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}he=r,Za(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{Qa=!1,wd=Date.now()}}},kd=()=>{he?Za():xd(),fd===void 0&&(fd=window.setInterval(()=>{he?Za():Date.now()-wd>=O_&&xd()},1500))};var R_="#12161D",H_="#EDEEF0",Ed=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},$d=t=>{t.style.setProperty("background-color",R_,"important"),t.style.setProperty("color",H_,"important")},D_=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},F_=t=>{Ed(t)&&$d(t);for(let e of Array.from(t.querySelectorAll("*")))Ed(e)&&$d(e)},Xa=null,Ho=null,Cd=()=>{Ho&&(Ho.disconnect(),Ho=null),Xa=null},z_=t=>{if(Xa===t)return;Cd(),Xa=t;let e=!1,o=()=>{e=!1;try{F_(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Ho=new MutationObserver(r),Ho.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},Td=!1,jr=()=>{if(Td)return;Td=!0;let t=()=>{let o=D_();o?z_(o):Cd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var N_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",q_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",U_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ld="tc_closing_agent",j_="tc_closing_office",Et="ws-crm-closing-agent-picker-button",Id="ws-crm-closing-agent-picker-modal",W_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,G_=/\/v2\/location\/([A-Za-z0-9]+)/,zo=()=>{let t=window.location.pathname,e=t.match(W_);if(!e)return null;let o=t.match(G_);return{oppId:e[1],locationId:o?o[1]:null}},as=async t=>{let e=await fetch(N_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Sd=async t=>{let e=await fetch(q_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},K_=async(t,e)=>{try{let o=await fetch(U_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Ld}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await as({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ue=null,V_=60*60*1e3,ss=t=>`ws-crm-to-cache:${t}`,Md=t=>{try{let e=window.localStorage.getItem(ss(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>V_||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Pd=(t,e,o)=>{try{window.localStorage.setItem(ss(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Y_=t=>{try{window.localStorage.removeItem(ss(t))}catch{}},es="ws-crm-closing-agent-field-link",J_=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${es}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},ts=!1,is=async t=>{if(ts)return;let e=Od();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){ts=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await as({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),os(a.id,a.name,t);let s=document.getElementById(Et);if(s){Xt(s,{status:"linked",contactName:a.name});let i=zo();i&&Pd(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{ts=!1}}},Q_=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Od=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();Q_.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let u=l.getAttribute(m);u&&/Title\s+Officer/i.test(u)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:u})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},os=(t,e,o)=>{let r=Od();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${es}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=es,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},Wr=()=>{document.getElementById(Id)?.remove()},Z_=t=>{Wr();let e=document.createElement("div");e.id=Id,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Wr()}),s?.addEventListener("click",Wr);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await as({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};Xt(o,r);let a=Md(t);return a&&(r={status:"linked",contactName:a.contactName},Xt(o,r),ue={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await K_(t,e);i?(r={status:"linked",contactName:i.name},Xt(o,r),ue={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},os(i.id,i.name,e)):a||(r={status:"empty"},Xt(o,r),ue?.oppId===t&&(ue=null),J_(),Y_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Z_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Xt(o,r);try{let d=await Sd({tenantId:e,oppId:t,fieldKey:Ld,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await Sd({tenantId:e,oppId:t,fieldKey:j_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Xt(o,r),ue={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Pd(t,i.id,i.name),os(i.id,i.name,e),vl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Xt(o,r)}}})}),o},tv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ev=async()=>{for(let t of tv)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Do=!1,Vr=async()=>{if(!Do){Do=!0;try{await ov()}finally{Do=!1}}},ov=async()=>{let t=zo();if(!t||!t.locationId){document.getElementById(Et)?.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr();return}let e=document.getElementById(Et);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr());return}e&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await ev();if(!r||!(Md(t.oppId)!==null||ue!==null&&ue.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=zo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=X_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${Et}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Q(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),rv(t.oppId),is(s.locationId)},Fo=null,rs=null,ns=null,Kr=()=>{Fo?.disconnect(),Fo=null,rs=null,ns=null},rv=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fo&&rs===t&&ns===e||(Kr(),rs=t,ns=e,Fo=new MutationObserver(()=>{let o=zo();if(!o||o.oppId!==t||!o.locationId){Kr();return}document.getElementById(Et)||Vr(),is(o.locationId)}),Fo.observe(e,{childList:!0,subtree:!0})))},nv=()=>{J("closing-agent-picker",tt,()=>{!document.getElementById(Et)&&!Do&&Vr()})},Ad,av=()=>{Ad===void 0&&(Ad=window.setInterval(()=>{let t=zo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(Et)&&!Do&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Vr()),is(t.locationId)},2e3))},Bd=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),nv(),av(),Vr()};var sv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Dt="ws-crm-manage-team-cta",Hd="ws-crm-manage-team-modal",iv=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Dd={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},lv={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Fd=()=>{let t=window.location.pathname.match(iv);return t?{tenantId:t[1]}:null},Jr=async t=>{let e=await fetch(sv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},yt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),te=t=>yt(t),ls="ws-crm-manage-team-toast",ps=(t,e="info",o=4e3)=>{document.getElementById(ls)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ls,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ls)===a&&a.remove()},o)},ds=()=>{document.getElementById(Hd)?.remove()},dv=(t,e)=>{let o=lv[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${yt(e)}</span>
  `},cv=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>dv(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>cv(r,e)).join(""),Qr=async t=>{ds();let e=document.createElement("div");e.id=Hd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${h.sans};
  `,e.addEventListener("click",l=>{l.target===e&&ds()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",ds);let r;try{r=await Jr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+pv(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{mv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;bv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;hv(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},mv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${yt(Dd[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Qr(t)}),Yr(e),setTimeout(()=>Yr(e),200),setTimeout(()=>Yr(e),800),kv(),e},Rd=!1,kv=()=>{Rd||(Rd=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Dt);t instanceof HTMLButtonElement&&Yr(t)}))},cs=!1,Ev=()=>{if(!cs){cs=!0;try{let t=Fd();if(!t){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}let e=document.getElementById(Dt);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Dt}-floater`)?.remove();let o=document.createElement("div");o.id=`${Dt}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=wv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{cs=!1}}},zd=()=>{if(!Fd()){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}Ev()};var $v="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",hs="ws-crm-prepare-contract-button",Nd="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",qd="ws-crm-modal-date-style",Ft="https://services.leadconnectorhq.com",Vd=()=>{if(document.getElementById(qd))return;let t=document.createElement("style");t.id=qd,t.textContent=`
  ...
  `,document.head.appendChild(t)},us="__WS_CRM_CAPTURED_AUTH",Tv=50*60*1e3,jo=()=>{try{let t=localStorage.getItem(us);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Tv?(localStorage.removeItem(us),null):e:null}catch{return null}},Cv=t=>{try{localStorage.setItem(us,JSON.stringify(t))}catch{}},Ne=()=>{let t=jo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Ud=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((jo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),ze=async(t,e={},o=2)=>{let r=jo()?.capturedAt??0,a;try{a={...Ne(),...e.headers??{}}}catch(i){if(o>0&&await Ud(r,4e3))return ze(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await Ud(r,4e3)?ze(t,e,o-1):s},jd=!1,Sv=()=>{if(jd)return;jd=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=jo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let u=c.authorization||c.Authorization;if(!u){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=c["token-id"]||c["Token-Id"]||void 0,b=jo()?.authorization;Cv({authorization:u,tokenId:_,capturedAt:Date.now()}),b!==u&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${u.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let u=m.headers;!u&&l[0]instanceof Request&&(u=l[0].headers);let _={};if(u instanceof Headers)u.forEach((b,g)=>_[g.toLowerCase()]=b);else if(Array.isArray(u))u.forEach(([b,g])=>_[b.toLowerCase()]=g);else if(u&&typeof u=="object")for(let b of Object.keys(u))_[b.toLowerCase()]=u[b];o(c,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Yd=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Av=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Yd()},Lv=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Jd="__WS_CRM_TEMPLATES_CACHE_V1",Iv=24*60*60*1e3,Wd=t=>{try{let e=window.localStorage.getItem(Jd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Iv?null:o.templates}catch{return null}},Mv=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Jd,JSON.stringify(o))}catch{}},Pv=async t=>{let e=`${Ft}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await ze(e,{method:"GET"})}catch(i){let d=Wd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=Wd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Lv(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Mv(t,s),s},Ov=async(t,e)=>{let o=await ze(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await ze(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},Bv=async(t,e)=>{let o=await ze(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ne()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},Rv=async t=>{let e=await fetch($v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Hv=async(t,e,o)=>{let r=`${Ft}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ne()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Dv=async(t,e)=>{let o=await fetch(`${Ft}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ne()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Qd=async t=>{let e=await fetch(`${Ft}/contacts/${t}`,{method:"GET",headers:Ne()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Fv=async(t,e,o,r)=>{let a;try{a=await Dv(t,e)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await Qd(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],u={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Ft}/proposals/document/${e}`,{method:"PUT",headers:{...Ne(),"Content-Type":"application/json"},body:JSON.stringify(u)});if(!_.ok){let b=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:b}}return{ok:!0}},zv=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Xr="__WS_CRM_PENDING_INSTRUCTIONS",Nv=60*1e3,qv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Uv=t=>{let e=(t||"").toLowerCase();for(let o of qv)if(e.includes(o.matches.toLowerCase()))return o;return null},jv=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Xr,JSON.stringify(r))}catch{}},Wv=()=>{try{let t=localStorage.getItem(Xr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Nv?(localStorage.removeItem(Xr),null):e}catch{return null}},Gv=()=>{try{localStorage.removeItem(Xr)}catch{}},Kv=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Vv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Yv=()=>{let t=window.location.pathname.match(Vv);if(!t)return;let e=t[1],o=Wv();o&&o.proposalId===e&&(Gv(),window.setTimeout(()=>{Kv(o.title,o.bodyHtml)},600))},Gd="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(Gd)?.remove();let r=document.createElement("div");r.id=Gd;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Kd=(t,e)=>new Promise(o=>{document.getElementById(Mt)?.remove();let r=document.createElement("div");r.id=Mt,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,B=X=>['<option value="">(unset)</option>'].concat(x.map(st=>`<option value="${It(st)}"${st===X?" selected":""}>${bt(st)}</option>`)).join("");y.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-current-occupancy" style="${A}">${B(b)}</select>
      </div>
      <div style="${w}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${A}">${B(g)}</select>
      </div>
  ...
  `,k.appendChild(y),document.body.appendChild(k);let j=y.querySelector("#ws-pc-purchase-price"),U=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),N=!1;W?.addEventListener("input",()=>{N=!0});let Nt=()=>{if(N)return;let X=Number(j?.value||0),st=Number(U?.value||0);W&&(W.value=String(Math.max(0,X-st)))};j?.addEventListener("input",Nt),U?.addEventListener("input",Nt);let qt=()=>k.remove();k.addEventListener("click",X=>{X.target===k&&qt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",qt);let pt=y.querySelector("#ws-pc-submit"),ht=y.querySelector("#ws-pc-error");pt?.addEventListener("click",async()=>{if(pt){ht&&(ht.textContent=""),pt.disabled=!0,pt.textContent="Opening\u2026";try{let X=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(j?.value||0),Ye=Number(U?.value||0),Je=Number(W?.value||0),Qe=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ze=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Xe=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ye=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),to=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),it={};if(X!==i&&(it.sellerName=X),st!==d&&(it.purchasePrice=st),Ye!==l&&(it.emd=Ye),Je!==c&&(it.cashAtClose=Je),Qe!==m&&(it.daysToClose=Qe),Ze!==u&&(it.inspectionDays=Ze),Xe!==_&&(it.additionalTerms=Xe),ye!==b&&(it.currentOccupancy=ye),to!==g&&(it.occupancyAtClose=to),Object.keys(it).length>0){p.info("[prepare-contract] PA modal submit with overrides:",it),pt.textContent="Saving\u2026";let hn=R(),un=await tn({tenantId:t,contactId:e,template:o,userId:hn,overrides:it});p.info("[prepare-contract] re-stage with overrides ok:",un),pt.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let lt=s?`${s} - Purchase Agreement`:void 0;await ys(t,e,o,lt)}catch(X){pt.disabled=!1,pt.textContent="Open Contract",ht&&(ht.textContent=X.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",X)}}})},Qv=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Mt)?.remove(),Vd();let l=a.debug||{},c=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",u=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,_=typeof l.buyerEMD=="number"?l.buyerEMD:0,b=typeof l.assignmentFee=="number"?l.assignmentFee:0,g=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,x=typeof l.closingOffice=="string"?l.closingOffice:"",k=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,f=d,$="",S=document.createElement("div");S.id=Mt,S.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;T.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${j}">
        ...
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${u}" style="${A}" />
        </div>
      </div>
      <div style="${j}">
        ...
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${_}" style="${A}" />
        </div>
      </div>
      <div style="${j}">
        ...
        <div style="${U}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${b}" style="${A}" />
        </div>
      </div>
      <div style="${j}">
  ...
  `,S.appendChild(T),document.body.appendChild(S);let W=T.querySelector("#ws-pc-assignment-price"),N=T.querySelector("#ws-pc-assignment-fee"),Nt=!1;N?.addEventListener("input",()=>{Nt=!0});let qt=()=>{if(Nt)return;let st=Number(W?.value||0);N&&(N.value=String(Math.max(0,st-g)))};W?.addEventListener("input",qt);let pt=()=>S.remove();S.addEventListener("click",st=>{st.target===S&&pt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",pt);let ht=T.querySelector("#ws-pc-submit"),X=T.querySelector("#ws-pc-error");ht?.addEventListener("click",async()=>{if(!ht)return;X&&(X.textContent="");let st=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ye=Number(W?.value||0),Je=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),Qe=Number(N?.value||0),Ze=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),Xe=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ye=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),to=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),it=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ye){X&&(X.textContent="Closing Date is required.");return}ht.disabled=!0,ht.textContent="Opening\u2026";try{let lt={};st!==m&&(lt.sellerName=st),Ye!==u&&(lt.assignmentPrice=Ye),Je!==_&&(lt.buyerEMD=Je),Qe!==b&&(lt.assignmentFee=Qe),Ze!==x&&(lt.closingOffice=Ze),Xe!==k&&(lt.buyerCompanyName=Xe);let hn=ye!==y||to!==f||it!==$,un=Object.keys(lt).length>0||hn,_n=a;un?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",lt),ht.textContent="Saving\u2026",_n=await tn({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ye,buyerEarnestDueDate:to,lenderSource:it,userId:s,overrides:Object.keys(lt).length>0?lt:void 0}),p.info("[prepare-contract] AA re-stage ok:",_n),ht.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Ms=_n?.debug?.propertyAddress||c,tp=Ms?`${Ms} - Assignment Agreement`:void 0;await ys(t,e,o,tp),pt()}catch(lt){ht.disabled=!1,ht.textContent="Open Contract",X&&(X.textContent=lt.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",lt)}})},tn=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Rv({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ys=async(t,e,o,r)=>{let a=null;try{a=(await Qd(e)).email||""}catch(l){p.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){nt("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),p.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await Hv(t,o.id,e);p.info(`[prepare-contract] proposal created: ${s}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Fv(t,s,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${s}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),nt(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Uv(o.name);d&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),jv(s,d.title,d.bodyHtml)),zv(t,s)},Zv=async t=>{let e=Av(t);if(!e){nt("Could not resolve contact context.","error");return}document.getElementById(Nd)?.remove();let o=document.createElement("div");o.id=Nd,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Pv(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=R();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await Bv(e.tenantId,e.contactId)}catch(f){nt(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await Kd(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}m=f,p.info(`[prepare-contract] picked MT opp ${m}`)}}let u=y=>{let f=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),S=String(y.getDate()).padStart(2,"0");return`${f}-${$}-${S}`},_=y=>{let f=new Date;return f.setDate(f.getDate()+y),u(f)},b=_(45),g=_(7);nt("Reading contract data\u2026","info",2500);let x;try{x=await tn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:b,buyerEarnestDueDate:g,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||x.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}Qv({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:x,userId:c,defaultClosingDate:b,defaultEMDDueDate:g})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await Ov(e.tenantId,e.contactId)}catch(b){nt(`Failed to load ACQ opps: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",b);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let u;if(m.length===1)u=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${u} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let b=await Kd(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!b){p.info("[prepare-contract] ACQ opp picker cancelled");return}u=b,p.info(`[prepare-contract] picked ACQ opp ${u}`)}nt("Reading contract data\u2026","info",2500);let _;try{_=await tn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:u,userId:c})}catch(b){nt(`Failed to prepare contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",b);return}Jv({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:_})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await ys(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},Zd=()=>{let t=document.createElement("button");return t.id=hs,t.type="button",t.style.cssText=`${H} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Zv(t)}),t},Xv="ws-crm-contact-actions-bar",ty=async()=>{let t=Yd();if(!t){document.getElementById(hs)?.remove();return}let e=null;try{e=await P(`#${Xv}`,{timeoutMs:eo+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(hs);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Zd();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},_e="ws-crm-prepare-contract-button-opp",No=`${_e}-wrap`,ey=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,oy=/\/v2\/location\/([A-Za-z0-9]+)/,ry=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_s=()=>{let t=window.location.pathname,e=t.match(ey);if(!e)return null;let o=t.match(oy);return o?{oppId:e[1],tenantId:o[1]}:null},ny=async()=>{for(let t of ry)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Zr=!1,qo=null,vs=null,ms=null,bs,Uo=()=>{qo?.disconnect(),qo=null,vs=null},ay=t=>{if(qo&&vs===t)return;Uo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(vs=t,qo=new MutationObserver(()=>{let o=_s();if(!o||o.oppId!==t){Uo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(_e)?.remove(),document.getElementById(No)?.remove(),Uo();return}document.getElementById(_e)||Xd()}),qo.observe(e,{childList:!0,subtree:!0}))},sy=()=>{ms||(ms=new MutationObserver(()=>{bs===void 0&&(bs=window.setTimeout(()=>{bs=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(_e);t&&!e&&!Zr&&Xd()},300))}),ms.observe(document.body,{childList:!0,subtree:!0}))},Xd=async()=>{if(!Zr){Zr=!0;try{let t=_s();if(!t){document.getElementById(_e)?.remove(),document.getElementById(No)?.remove(),Uo();return}let e=document.getElementById(_e);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(No)?.remove(),Uo());return}e&&(e.remove(),document.getElementById(No)?.remove());let o=await ny();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_s();if(!a||a.oppId!==t.oppId)return;let s=Zd();s.id=_e,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=No,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),ay(t.oppId)}finally{Zr=!1}}},tc=()=>{Yv(),ty()};Sv();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function It(t){return bt(t)}var iy="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",ve="ws-crm-compute-offer-button",xs="ws-crm-compute-offer-popover",lc="ws-crm-offer-modal",ec="ws-crm-contact-actions-bar",ly=[".central-panel","[class*='central-panel']"],ee=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",gs=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},dy=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],oc=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${dy[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},rc=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;outline:none;`,fs=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(iy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},qe=()=>{document.getElementById(xs)?.remove(),document.removeEventListener("mousedown",dc,!0)};function dc(t){let e=document.getElementById(xs),o=document.getElementById(ve),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&qe()}var cc=(t,e)=>{qe();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=xs;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${h.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",dc,!0),0)},en=(t,e)=>{cc(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},cy=(t,e,o)=>{cc(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{qe(),o(a.property_record_id)}),r.appendChild(s)})})},rn=()=>{document.getElementById(lc)?.remove(),document.removeEventListener("keydown",pc,!0)};function pc(t){t.key==="Escape"&&rn()}var nc=(t,e,o)=>{rn(),qe();let r=o,a=!1,s="",i=document.createElement("div");i.id=lc,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${h.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&rn()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,u,_)=>{a||(a=!0,s="",c(),fs({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:u,repairOverride:_}).then(b=>{b&&b.ok?r={...b,current_offer:b.current_offer??r.current_offer,current_offer_date:b.current_offer_date??r.current_offer_date}:s=b&&b.error||"Request failed."}).catch(b=>{p.error("[compute-offer] worksheet request failed:",b),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,u=!!m.has_comps;d.innerHTML="";let _=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),b=q("div","");b.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),b.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let g=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");g.type="button",g.addEventListener("click",rn),_.append(b,g),d.appendChild(_);let x=q("div","padding:14px 18px 18px;");d.appendChild(x);let k=q("select",rc());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",rc());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let f=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");f.appendChild(q("div",`font-size:12px;color:${u?n.bone:n.amber};`,u?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${oc(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${u?"transparent":n.blue};color:${u?n.blue:"#fff"};font-family:${h.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":u?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),f.append($),x.appendChild(f),m.low_confidence&&u&&x.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let S=m.current_offer!=null;x.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${S?n.bone:n.ash};`,S?`Last offer made: ${ee(m.current_offer)}${m.current_offer_date?` \xB7 ${oc(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=q("div","");w.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(w,E),x.appendChild(T);let A=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),B=(U,W,N)=>{let Nt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),qt=q("div","");qt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&qt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);Nt.append(qt,pt),A.appendChild(Nt)};if(u&&m.imv!=null){B("Investor Market Value (IMV)",ee(m.imv)),m.arv!=null&&B("After Repair Value (ARV)",ee(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?B(`Repairs (${N})`,"Included",{color:n.ash,sub:`${ee(m.repair_total)} in repairs included at IMV`}):B(`Repairs (${N})`,gs(W),{color:W<0?n.crimson:n.emerald,sub:`${ee(m.repair_total)} total, ${ee(m.baseline_repairs)} included at IMV`}),B("Min. Profit Target",gs(-(m.profit_target??0)),{color:n.ash}),B("Maximum Cash Offer (MAO)",ee(m.mao),{strong:!0,color:n.blue}),B("Target Profit",gs(-(m.ico_delta??0)),{color:n.ash}),B("Initial Cash Offer (ICO)",ee(m.ico),{strong:!0,color:n.blue})}else A.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));x.appendChild(A);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(u?"Saved to the Property.":""),x.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",pc,!0)},ac=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=ve,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){cy(o,i.properties,d=>{a(!0),fs({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?nc(e,l.property_record_id,l):en(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),en(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?nc(e,i.property_record_id,i):en(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await fs({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),en(o,"Request failed. Try again.")}finally{a(!1)}}}),o},py=async()=>{for(let t of ly)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}return null},sc=async(t,e)=>{let o=e.querySelector(`#${ec}`);if(!o)try{o=await P(`#${ec}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},ic=()=>{let t=document.querySelectorAll(`#${ve}`);for(let e=1;e<t.length;e++)t[e].remove()},my=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(ve)?.remove(),qe();return}let e=t.locationId,o=document.getElementById(ve);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),qe();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(ve)?.remove();return}let a=await py();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=ac(t.contactId,e);if(!await sc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}ic(),p.debug(`[compute-offer] mounted for ${t.contactId}`),on?.disconnect(),on=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){on?.disconnect();return}if(!document.getElementById(ve)){let d=ac(t.contactId,e);sc(d,a).then(()=>ic())}}),on.observe(a,{childList:!0})},on=null,Wo=null,mc=()=>{let t=D()?.contactId??null;if(Wo&&Wo.id===t)return;let e=my().finally(()=>{Wo?.promise===e&&(Wo=null)});Wo={id:t,promise:e}};var cn="reos-theme-stylesheet",Mc="reos-theme-fonts",Ge=!1,by=()=>{let t=document.getElementById(Mc);t&&t.remove()},hy=`
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var zc=new Set(["ej0SqnTYIprechAMAPrd"]),Ke="contact-select-trigger",Nc="ws-crm-reply-from-warning",qc="contact-select-menu",Oc="ws-crm-rf-thread-opt",Ss="",As=!1,Vo=null,bn=null,Bc=!1,Yo="",Rc,oe=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Ls=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Pt=t=>(t||"").replace(/\D/g,"").slice(-10),Hc=t=>{let e=Pt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},jy=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Wy=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await $n(`${kn}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return oe("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Gy=async()=>{let t=await Wy();if(!t)return null;let e=await $n(`${kn}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return oe("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=jy(a);if(Pt(s).length===10)return s}return null},Ve=()=>document.getElementById(Nc)?.remove(),Uc=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Ky=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),jc=(t,e,o)=>{Ve();let r=document.getElementById(Ke);if(!r)return;let a=Uc(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Nc,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Ky(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${Hc(t)}</span>${i}. You're set to reply from ${Hc(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Vy=t=>{Vo?.disconnect();let e=document.getElementById(Ke);if(!e)return;let o=Uc(e)||e,r=Pt(Ls(e));Vo=new MutationObserver(()=>{let a=Ls(document.getElementById(Ke)),s=Pt(a);!s||s===r||(r=s,s===Pt(t)?Ve():jc(t,"",a))}),Vo.observe(o,{childList:!0,subtree:!0,characterData:!0})},Dc=()=>{let t=document.getElementById(qc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Yo&&(r=e.find(d=>Pt(o(d))===Pt(Yo))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),oe("decorateMenu: cache=",Yo,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(Oc);s&&s!==r&&s.removeAttribute("id"),r.id=Oc;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Yy=()=>{if(!zc.has(K()||""))return;bn?.disconnect();let t=0,e=()=>{let o=document.getElementById(qc);if(o){Dc(),bn=new MutationObserver(()=>Dc()),bn.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Jy=t=>{let e=t.target;e&&e.closest&&e.closest("#"+Ke)&&(oe("From trigger clicked -> waiting for menu"),Yy())},Qy=async()=>{if(!As){As=!0;try{let t=document.getElementById(Ke);if(!t)return;let e=Ls(t),o=await Gy();if(Yo=o||"",oe("check: from=",e,"thread=",o),!o){Ve();return}Pt(e)&&Pt(e)!==Pt(o)?(oe("MISMATCH -> banner"),jc(o,"",e)):(oe("match -> no banner"),Ve()),Vy(o)}finally{As=!1}}},Fc=()=>{if(!zc.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){Ss="",Yo="",Vo?.disconnect(),bn?.disconnect(),Ve();return}let e=!!document.getElementById(Ke),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==Ss){if(Ss=r,!e){Vo?.disconnect(),Ve();return}oe("composer expanded on",o),Qy()}},Wc=()=>{Rc===void 0&&(Rc=window.setInterval(Fc,500)),Bc||(document.addEventListener("click",Jy,!0),Bc=!0),Fc()};var Zy="#1A1F28",Xy="#EDEEF0",Is="#9098A3",tg=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},eg=t=>.2126*t.r+.7152*t.g+.0722*t.b,og=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},Gc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},rg=t=>{let e=tg(getComputedStyle(t).backgroundColor);if(!e||eg(e)<120)return;let o=og(e);t.style.setProperty("background-color",Zy,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),Gc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Xy),Gc(t,"#note-date-added-text, [class*='475467']",Is)},ng=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",Is,"important"),e.style.setProperty("-webkit-text-fill-color",Is,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},Kc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)rg(t[e]),ng(t[e])},Vc,Yc=()=>{Vc===void 0&&(Vc=window.setInterval(Kc,700)),Kc()};var ag='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',Jc=()=>{document.querySelectorAll(ag).forEach(t=>{t.setAttribute("autocomplete","off")})},Qc,Zc=()=>{Qc===void 0&&(Qc=window.setInterval(Jc,1e3)),Jc()};console.log("[ws-crm-customizer] bundle-loaded");var C=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Xc=()=>{p.info(`Loaded v${Xo} (built ${tr})`),vn()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Ko),C("mountDialerThemeFix",jr)):(C("mountVersionBadge (initial)",mn),C("mountFavicon",Oi),C("mountThemeStylesheet",Ko),C("mountHideLaunchpad",_a),C("mountHideNavItems",va),C("mountRelabelNav",ya),C("mountHideTopmenuTabs",fa),C("mountContractsSection",ga)),C("installOppIdCapture",Fs),C("initPageRouter",Bs),p.info("[main] registering onPageChange subscriber"),_t(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),vn()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Ko),C("runThemeFastPass",Cs),C("mountDialerThemeFix",jr),C("unmountContactMapLinks",nl);return}C("mountThemeStylesheet",Ko),C("runThemeFastPass",Cs),C("mountVersionBadge",mn),C("mountHideLaunchpad",_a),C("mountHideNavItems",va),C("mountRelabelNav",ya),C("mountHideTopmenuTabs",fa),C("mountContractsSection",ga),C("mountAnalyticsDashboard",Zs),C("mountClaimReleaseToggle",fi),C("mountContactActionsBar",Mi),C("mountActiveFollowUpButton",Gs),C("mountMtOfferMadeButton",Di),C("mountNotInterestedButton",Fi),C("mountScheduleWalkthroughButton",zi),C("mountResendDealLinkButton",qi),C("mountReducePriceButton",ji),C("mountEditLandingPageButton",Wi),C("mountPublishButton",Yi),C("mountContactMapLinks",rl),C("mountSendToClosingOfficeButton",yl),C("mountOppActionBar",Ol),C("mountClosingAgentPickerButton",Bd),C("mountPrepareContractButton",tc),C("mountComputeOfferButton",mc),C("mountManageTeam",zd),C("mountBuyBoxWidget",ni),C("mountSellerContactFlag",_i),C("mountPropertiesWidget",hi),C("mountSupportNavItem",jl),C("mountPhoneAssignmentsWidget",Jl),C("mountBulkPowerDialer",_d),C("mountBulkPowerDialerContacts",gd),C("mountCallingAsChip",kd),C("mountDialerThemeFix",jr),C("mountReplyFromWarning",Wc),C("mountNoteCanon",Yc),C("mountSuppressAutofill",Zc)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xc):Xc();})();
