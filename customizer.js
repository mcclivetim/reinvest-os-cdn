/* Wholesaling CRM Customizer v0.13.55 — built 2026-05-26T21:56:21.869Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var re="[wholesaling-crm-customizer]",Gt="__WS_CRM_DEBUG",$t=()=>!!window[Gt],c={info(...o){console.log(re,...o)},warn(...o){console.warn(re,...o)},error(...o){console.error(re,...o)},debug(...o){$t()&&console.log(re,"[debug]",...o)}};var qe=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Se=/\/v2\/location\/([A-Za-z0-9]+)/,Vt=o=>{let e=o.match(qe);if(!e)return null;let t=o.match(Se);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Ut=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(qe);if(!n)continue;let a=r.match(Se)||window.location.pathname.match(Se);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},T=()=>{let o=Vt(window.location.pathname);return o||Ut()};var ze=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ae="",Ce=null,$="other",Ae=new Set,ne=()=>{let o=T()?.contactId??null;if(!(!(window.location.pathname!==ae)&&!(o!==Ce))){ae=window.location.pathname,Ce=o,$=ze(),c.debug("Page/context changed:",$,ae,"contact:",o);for(let r of Ae)try{r($)}catch(n){c.error("Subscriber threw:",n)}}},We=o=>(Ae.add(o),setTimeout(()=>o($),0),()=>{Ae.delete(o)}),je=()=>{$=ze(),ae=window.location.pathname,Ce=T()?.contactId??null,c.debug("Router init, current page:",$);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ne()},history.replaceState=function(t,r,n){e(t,r,n),ne()},window.addEventListener("popstate",ne),setInterval(ne,1e3)};var se="0.13.55",ie="2026-05-26T21:56:21.871Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},x={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Ie={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},le=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,z=`
  ...
  flex-shrink: 0;
`;var qt=/^[A-Za-z0-9]{15,30}$/,W=o=>typeof o=="string"&&qt.test(o),zt=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Wt=()=>{let o=window.WS_CRM_USER_ID;return W(o)?o:null},jt=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(W(t))return t;return null},Kt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=zt(e);if(!t)return null;let r=t.uid;if(W(r))return r;let n=t.claims;if(n&&W(n.user_id))return n.user_id}catch{}return null},Yt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(W(n))return n}catch{}}}catch{}return null},A=()=>Wt()||jt()||Kt()||Yt()||null;var Je="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Xt=`${Je}/active-follow-up-get`,Jt=`${Je}/active-follow-up-set`,O="ws-crm-active-follow-up-button",Fe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Qt=()=>{let o=T();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zt=async o=>{let e=await fetch(Xt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},eo=async(o,e)=>{let t=await fetch(Jt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},B=(o,e)=>{let t=Fe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ke=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,B(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Qt();if(!(!r||r.contactId!==o)){B(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await eo(r,A()),a=n&&n.state&&n.state in Fe?n.state:"blue";B(e,a),c.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){c.error("Active Follow Up Set webhook failed",n),B(e,"error"),setTimeout(()=>void de(e,r),4e3)}}}),e},de=async(o,e)=>{B(o,"loading");try{let t=await Zt(e),r=t&&t.state&&t.state in Fe?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;B(n,r)}catch(t){c.warn("Active Follow Up Get webhook failed",t),B(o,"error")}},to=[".central-panel","[class*='central-panel']"],Le="ws-crm-contact-actions-bar",oo=async()=>{for(let o of to)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ro=async(o,e)=>{let t=e.querySelector(`#${Le}`);if(!t)try{t=await C(`#${Le}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${Le}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},no=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},ao=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},so=async o=>{if(o==="url"){let t=await oo();return t?{kind:"contact-detail",target:t}:null}let e=no();return e?{kind:"conversations",target:e}:null},Ye=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await ro(o,e.target);return t}return ao(o,e.target),"conversations-header"},io=async()=>{let o=T();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){de(t,e);return}t&&t.remove();let r=await so(o.source);if(!r){c.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=T();if(!n||n.contactId!==e.contactId)return;let a=Ke(e.contactId),i=await Ye(a,r);c.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Xe();let s=document.getElementById(O)??a;de(s,e);let d=new MutationObserver(()=>{let b=document.getElementById(O);if(!(T()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=Ke(e.contactId);Ye(m,r).then(()=>{Xe(),de(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},j=null,Qe=()=>{let o=T()?.contactId??null;if(j&&j.contactId===o)return;let e=io().finally(()=>{j?.promise===e&&(j=null)});j={contactId:o,promise:e}},Xe=()=>{let o=document.querySelectorAll(`#${O}`);if(!(o.length<=1)){c.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var H="ws-crm-claim-release-pill",lo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",co="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",bo=async o=>{let e=await fetch(lo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},ho=async o=>{let e=await fetch(co,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},tt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},V=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=le(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},po=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=H,t.type="button",t.dataset.contactId=o,V(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=T();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>V(t,r),2500);return}c.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";V(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await ho({contactId:o,locationId:n.locationId,userId:a,action:r}),d=s?.mode==="claim"||s?.mode==="release"?s.mode:i;V(t,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(s){c.error("Claim/Release Set webhook failed",s),V(t,r);let d=t.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Ze=async(o,e)=>{try{let t=await bo({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(H);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";V(r,n)}catch(t){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},mo=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=tt(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},et=(o,e)=>{let t=po({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${H}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},_o=async()=>{let o=T();if(!o){document.getElementById(H)?.remove();return}let e=document.getElementById(H);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await mo(t),n=T();if(!n||n.contactId!==o.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}et(r,o.contactId),c.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(H);a&&o.locationId&&Ze(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(T()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(H))return;let d=tt(t);if(d){et(d,o.contactId);let b=document.getElementById(H);b&&o.locationId&&Ze(b,{contactId:o.contactId,locationId:o.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){c.warn("Could not mount Claim/Release pill:",t)}}},ot=()=>{_o()};var uo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",K=new Map,rt=async(o,e)=>{if(!o)return null;if(K.has(o))return K.get(o)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${uo}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return c.warn(`Contact Type fetch returned ${a.status} for ${o}`),K.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return K.set(o,s),c.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${o}:`,n),K.set(o,null),null}};var nt=o=>o==="buyer"?"buyer":"seller";var ct="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",vo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var yo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",go=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||ct,d;if(i==="buyer"){let p=bt.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),d={contact_id:o,location:{id:e},customData:p}}let b=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},fo=async({contactId:o,tenantId:e})=>{let t=await fetch(yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var U="ws-crm-contact-actions-bar",wo="ws-crm-call-status-dropdown",at="ws-crm-offer-made-modal",xo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],bt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],ko=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],To=async()=>{for(let o of ko)try{let e=await C(o,{timeoutMs:2e3});if(e)return c.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return c.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return c.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Eo=({contactId:o,kind:e})=>{let t=e==="buyer"?bt:xo,r=e==="buyer"?vo:ct,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=wo,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=z,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
    ...
    `,b.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,b.addEventListener("mouseenter",()=>{b.style.background=l.slate}),b.addEventListener("mouseleave",()=>{b.style.background="transparent"}),b.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=Ie[d.color]),m&&(m.textContent=d.label),s.style.display="none";let u=T()?.locationId,y=A();if(!u){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!y){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let f=h?.textContent??"\u25BE",g=async v=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await go({contactId:o,locationId:u,status:d.label,userId:y,deadReason:v,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=f),i.style.opacity="1"},900)}catch(w){c.warn("Call Status webhook failed:",w),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=f),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let v=m?.textContent??"";Co(w=>{g(w)},()=>{m&&(m.textContent=v)});return}if(e==="seller"&&d.value==="appointment-booked"){let v=m?.textContent??"";try{(await fo({contactId:o,tenantId:u})).ok?await g():Ao(()=>{g()},()=>{m&&(m.textContent=v)})}catch(w){c.warn("Appointment sanity check failed; firing anyway:",w),await g()}return}await g()}),s.appendChild(b)}),i.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},So=o=>{document.getElementById(at)?.remove();let e=document.createElement("div");e.id=at,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},lt=(o,e)=>{let t=document.createElement("div");t.id=U,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=P,r.textContent="Offer Made",r.addEventListener("click",()=>So(o)),t.appendChild(r),t.appendChild(Eo({contactId:o,kind:e})),t},De=!1,Io=()=>{document.querySelectorAll(`[id="${U}"]`).forEach(o=>o.remove())},ht=async()=>{if(c.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname),De){c.info("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}De=!0;try{await Lo()}finally{De=!1}},Lo=async()=>{let o=T();if(!o){c.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Io();return}c.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let b=await rt(o.contactId,o.locationId);nt(b)==="buyer"&&(e="buyer"),c.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let t=T();if(!t||t.contactId!==o.contactId){c.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${U}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){c.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.info(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let n=await To();if(!n){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=T();if(!a||a.contactId!==o.contactId){c.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=lt(o.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(U)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(T()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${U}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.info(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=lt(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(n,{childList:!0})},dt=null,Fo=()=>{dt===null&&(dt=window.setInterval(()=>{let o=T();o&&(document.getElementById(U)||(c.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),ht()))},3e3))},pt=()=>{Fo(),ht()};var ce="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Do=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Y="data-ws-crm-favicon",Me=o=>o.hasAttribute(Y),mt=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Do.has(e)},be=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{mt(r)&&!Me(r)&&r.remove()});let e=document.head.querySelector(`link[${Y}="1"]`);e?e.href!==ce&&(e.href=ce):(e=document.createElement("link"),e.setAttribute(Y,"1"),e.rel="icon",e.type="image/png",e.href=ce,document.head.appendChild(e),c.debug("Favicon installed"));let t=document.head.querySelector(`link[${Y}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(Y,"apple"),t.rel="apple-touch-icon",t.href=ce,document.head.appendChild(t))},_t=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)be();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),be())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&mt(i)&&!Me(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Me(i)&&(n=!0)});n&&be()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,be(),e>=5&&window.clearInterval(t)},1e3)};var Mo=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Ho=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,No=".hr-card.hr-modal.crm-opportunities-modal",R=()=>{let o=document.querySelector(No);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Ho);if(n){let a=n[1];if(Mo.includes(a))return a}}return null},ut=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=R();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var Po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",L="ws-crm-not-interested-button",Oo=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Bo=/\/v2\/location\/([A-Za-z0-9]+)/,pe=()=>{let o=window.location.pathname,e=o.match(Oo);if(!e)return null;let t=o.match(Bo);return{oppId:e[1],locationId:t?t[1]:null}},Ro=async o=>{let e=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Go=o=>{let e=document.createElement("button");return e.id=L,e.type="button",e.dataset.oppId=o,e.style.cssText=le("neutral"),e.style.fontFamily=x.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=pe();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await Ro({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,c.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){c.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},$o=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vo=async()=>{for(let o of $o)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},he=!1,Oe=async()=>{if(!he){he=!0;try{await Uo()}finally{he=!1}}},Uo=async()=>{let o=pe();if(!o||!o.locationId){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}let e=document.getElementById(L);if(e&&e.dataset.oppId===o.oppId){let s=R();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove(),J());return}e&&(e.remove(),document.getElementById(`${L}-wrap`)?.remove());let t=await Vo();if(!t){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await ut();if(r!=="Marketing Tracker"){c.info(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=pe();if(!n||n.oppId!==o.oppId)return;let a=Go(o.oppId),i=document.createElement("span");i.id=`${L}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),c.debug(`Mounted Not Interested button on opp ${o.oppId}`),qo(o.oppId)},X=null,Pe=null,J=()=>{X?.disconnect(),X=null,Pe=null},qo=o=>{if(X&&Pe===o)return;J();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Pe=o,X=new MutationObserver(()=>{let t=pe();if(!t||t.oppId!==o){J();return}let r=R();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(L)?.remove(),document.getElementById(`${L}-wrap`)?.remove(),J();return}document.getElementById(L)||Oe()}),X.observe(e,{childList:!0,subtree:!0}))},He=null,Ne,zo=()=>{He||(He=new MutationObserver(()=>{Ne===void 0&&(Ne=window.setTimeout(()=>{Ne=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(L);o&&!e&&!he&&Oe()},300))}),He.observe(document.body,{childList:!0,subtree:!0}))},vt=()=>{zo(),Oe()};var gt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",G="ws-crm-send-to-title-co-button",q="ws-crm-send-to-title-co-wrap",ue="ws-crm-stc-dropdown",Wo=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,jo=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let o=window.location.pathname,e=o.match(Wo);if(!e)return null;let t=o.match(jo);return{oppId:e[1],locationId:t?t[1]:null}},Ko=async(o,e)=>{try{let t=await fetch(gt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(c.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return c.warn("[stc] dry_run fetch failed:",t),null}},Yo=async(o,e,t)=>{let r=await fetch(gt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Xo=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return c.warn(`[stc] folder tab not found for "${o}"`),!1},yt=o=>{let e=document.getElementById(o);if(!e){c.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Jo=(o,e)=>{if(e&&Xo(e)){window.setTimeout(()=>yt(o),300);return}yt(o)},F=()=>{document.getElementById(ue)?.remove()},me=(o,e,t)=>{F();let r=document.createElement("div");r.id=ue;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(_=>{p[_.group]||(p[_.group]=[]),p[_.group].push(_)});let m=[...b.filter(_=>p[_]),...Object.keys(p).filter(_=>!b.includes(_))];for(let _ of m){let u=p[_],y=document.createElement("div");y.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${x.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${l.steel};
    `,f.textContent=_,y.appendChild(f),u.forEach(g=>{let v=document.createElement("div"),w=!g.filled&&g.navigable&&g.field_id;v.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${w?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,w&&(v.addEventListener("mouseenter",()=>{v.style.background=l.slate}),v.addEventListener("mouseleave",()=>{v.style.background="transparent"}),v.addEventListener("click",I=>{I.stopPropagation(),g.field_id&&(Jo(g.field_id,g.folder),F())}));let E=g.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=w?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";v.innerHTML=`${E}<span style="flex: 1;">${g.label}</span>${k}`,y.appendChild(v)}),r.appendChild(y)}document.body.appendChild(r);let h=_=>{let u=_.target;!r.contains(u)&&!t.contains(u)&&(F(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},M=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,s=l.bone,d,b="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":a="transparent",i=l.steel,s=l.ash,d=l.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let _=e.checks?.filter(y=>y.filled).length??0,u=e.checks?.length??0;a="transparent",i=l.amber,s=l.amber,d=l.amber,b=`${_} of ${u} fields ready`,p="\u25BE";break}case"sending":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":a=l.emerald,i=l.emerald,s="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":a="transparent",i=l.amber,s=l.amber,d=l.amber,b=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=s,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=b),n&&(n.textContent=p)},Qo=(o,e)=>{let t=document.createElement("button");t.id=G,t.type="button",t.dataset.oppId=o;let r={status:"checking"};t.style.cssText=`
    ${P}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,M(t,r);let n=new Set,a=async()=>{if(r.status==="sending")return;let _=await Ko(o,e);if(!_){r={status:"error",message:"Check failed \u2014 click to retry"},M(t,r);return}if(!Array.isArray(_.checks)||_.checks.length===0){r={status:"error",message:_.error||"Check failed \u2014 click to retry"},M(t,r),c.warn("[stc] dry_run returned no checks:",_);return}let u=_.pipeline_name;if(u&&u!=="Transaction Coordination"){c.info(`[stc] dry_run reports pipeline="${u}" (not TC) \u2014 retracting button`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),F(),Z();return}let y=_.checks;if(r.checks&&r.checks.length===_.checks.length){let g=new Set;y=_.checks.map((v,w)=>r.checks[w]?.filled&&!v.filled?n.has(v.label)?v:(g.add(v.label),{...v,filled:!0}):v),n=g}else n=new Set;r={status:y.every(g=>g.filled)?"ready":"incomplete",checks:y,previouslySentAt:_.previously_sent_at??null},M(t,r),document.getElementById(ue)&&me(y,_.previously_sent_at,t)},i=async()=>{let _=!!r.previouslySentAt;r={status:"sending",checks:r.checks,previouslySentAt:r.previouslySentAt},M(t,r),F();try{let u=await Yo(o,e,_);if(u.needs_confirm){r={status:"ready",checks:u.checks,previouslySentAt:u.previously_sent_at},M(t,r),u.checks&&me(u.checks,u.previously_sent_at,t);return}if(u.ok){r={status:"sent",checks:u.checks,previouslySentAt:new Date().toISOString()},M(t,r),window.setTimeout(()=>{m()},3500);return}r={status:"error",checks:u.checks,message:u.error||"Validation failed"},M(t,r),u.checks&&me(u.checks,u.previously_sent_at,t)}catch(u){c.error("[stc] send failed:",u),r={status:"error",message:"Network error \u2014 click to retry"},M(t,r)}};t.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(ue)?F():r.checks&&me(r.checks,r.previouslySentAt,t);break}case"error":case"sent":m();break}}),m();let s,d=!1,b=Date.now(),p=1e4,m=async()=>{if(!d){d=!0,b=Date.now();try{await a()}finally{d=!1}}},h=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(h){let _=new MutationObserver(()=>{if(s!==void 0||d)return;let y=Date.now()-b,f=Math.max(1500,p-y);s=window.setTimeout(()=>{s=void 0,r.status!=="sending"&&m()},f)});_.observe(h,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let u=window.setInterval(()=>{document.body.contains(t)||(_.disconnect(),s!==void 0&&window.clearTimeout(s),window.clearInterval(u))},5e3)}return t},Zo=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],er=async()=>{for(let o of Zo)try{let e=await C(o,{timeoutMs:1500});if(e)return c.info(`[send-to-title-co] mount target: ${o}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},_e=!1,Ve=async()=>{if(_e){c.info("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}_e=!0;try{await tr()}catch(o){c.error("[stc] ensureMountedImpl threw:",o)}finally{_e=!1}},tr=async()=>{c.info("[stc] mount:01 ensureMountedImpl entered");let o=Ge();if(!o||!o.locationId){c.info(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),F();return}c.info(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){c.info("[stc] mount:03-SKIP existing button for same opp");let i=R();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(q)?.remove(),F(),Z());return}e&&(c.info("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(q)?.remove(),F()),c.info("[stc] mount:04 calling findMountTarget");let t=await er();if(!t){c.info("[stc] mount:04-BAIL findMountTarget returned null");return}c.info(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=Ge();if(!r||r.oppId!==o.oppId||!r.locationId){c.info(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${r?.oppId}`);return}c.info("[stc] mount:06 building button (pipeline gate will run via dry_run)");let n=Qo(o.oppId,r.locationId),a=document.createElement("span");a.id=q,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(n),t.appendChild(a),c.info(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(n)}`),or(o.oppId)},Q=null,$e=null,Z=()=>{Q?.disconnect(),Q=null,$e=null},or=o=>{if(Q&&$e===o)return;Z();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($e=o,Q=new MutationObserver(()=>{let t=Ge();if(!t||t.oppId!==o){Z();return}let r=R();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(G)?.remove(),document.getElementById(q)?.remove(),F(),Z();return}document.getElementById(G)||Ve()}),Q.observe(e,{childList:!0,subtree:!0}))},Be=null,Re,rr=()=>{Be||(Be=new MutationObserver(()=>{Re===void 0&&(Re=window.setTimeout(()=>{Re=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(G);o&&!e&&!_e&&Ve()},300))}),Be.observe(document.body,{childList:!0,subtree:!0}))},ft=()=>{rr(),Ve()};var xe="reos-theme-stylesheet",Pt="reos-theme-fonts",nr=()=>{let o=document.getElementById(Pt);o&&o.remove()},ar=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var D=(o,e)=>{try{c.info(`[main] calling ${o}`),e(),c.info(`[main] ${o} OK`)}catch(t){c.error(`[main:FAIL] ${o} threw:`,t)}},Rt=()=>{c.info(`Loaded v${se} (built ${ie})`),D("mountVersionBadge (initial)",Te),D("mountFavicon",_t),D("mountThemeStylesheet",Ot),D("initPageRouter",je),c.info("[main] registering onPageChange subscriber"),We(o=>{c.info(`[main] onPageChange callback fired for page=${o}`),D("mountVersionBadge",Te),D("mountClaimReleaseToggle",ot),D("mountContactActionsBar",pt),D("mountActiveFollowUpButton",Qe),D("mountNotInterestedButton",vt),D("mountSendToTitleCoButton",ft)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Rt):Rt();})();
