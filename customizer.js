...
`;var Ni=/^[A-Za-z0-9]{15,30}$/,Je=t=>typeof t=="string"&&Ni.test(t),_n=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zi=()=>{let t=window.WS_CRM_USER_ID;return Je(t)?t:null},Gi=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Je(o))return o;return null},qi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);if(!o)return null;let r=o.uid;if(Je(r))return r;let a=o.claims;if(a&&Je(a.user_id))return a.user_id}catch{}return null},Ui=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Je(a))return a}catch{}}}catch{}return null},L=()=>zi()||Gi()||qi()||Ui()||null,Vi=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=_n(e);return o?o.claims??o:null}catch{return null}},yn=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:Vi()?.type==="agency"};var xn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Wi=`${xn}/active-follow-up-get`,ji=`${xn}/active-follow-up-set`,we="ws-crm-active-follow-up-button",Go={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ki=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Yi=async t=>{let e=await fetch(Wi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ji=async(t,e)=>{let o=await fetch(ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},xe=(t,e)=>{let o=Go[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},gn=t=>{let e=document.createElement("button");return e.type="button",e.id=we,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Ld(t.oppId)},vt=null,Cr=null,_t=()=>{vt?.disconnect(),vt=null,Cr=null},Ld=t=>{if(vt&&Cr===t)return;_t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Cr=t,vt=new MutationObserver(()=>{let o=so();if(!o||o.oppId!==t){_t();return}let r=O();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ue)?.remove(),document.getElementById(Ee)?.remove(),ie(),_t();return}document.getElementById(ue)||Ir()}),vt.observe(e,{childList:!0,subtree:!0}))},Sr=null,Ar,$d=()=>{Sr||(Sr=new MutationObserver(()=>{Ar===void 0&&(Ar=window.setTimeout(()=>{Ar=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ue);if(t&&!e&&!ao){let o=so();if(o&&lo.has(o.oppId))return;Ir()}},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},ua=()=>{$d(),Ir()};var ya="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Md=`${ya}/tc/welcome-call-prefill`,Od=`${ya}/tc/welcome-call-save`,Mr="ws-crm-welcome-call-overlay",Dd=["Regular Contract","Subject To","Seller Finance","Novation"],Pd=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Hd=["Gas","Electric","Propane","Oil"],Fd=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Bd=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],ve=["Yes","No"],Rd=["Yes","No","Unknown"],Nd=["Professional Photographer","Seller","Tenant"],zd=["Month-to-Month","Annual"],va=["Current","Behind"],Gd=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],_e=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Or=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,ga="margin-bottom:12px;",fa=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,qd=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,G=(t,e,o)=>`<select id="${t}" style="${Or}"><option value=""></option>${e.map(r=>`<option ${String(o)===r?"selected":""}>${_e(r)}</option>`).join("")}</select>`,Y=(t,e,o="")=>`<input id="${t}" type="text" value="${_e(e)}" placeholder="${_e(o)}" style="${Or}">`,Ud=(t,e)=>`<textarea id="${t}" rows="3" style="${Or}resize:vertical;">${_e(e)}</textarea>`,M=(t,e)=>`<div style="${ga}"><label style="${fa}">${_e(t)}</label>${e}</div>`,Lr=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${Gd.map(r=>`<label style="${qd}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},be=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${_e(t)}</div>`,Ne=()=>{document.getElementById(Mr)?.remove()},co=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Vd=t=>{let e=t.tenant||{};return`
    ...
    ${be("Contract")}
    ${M("Type of Contract",G("wc-contract_type",Dd,t.contract_type))}

    ${be("Property")}
    ${M("Property Type",G("wc-property_type",Fd,t.property_type))}
    <div style="display:flex;gap:10px;">
      <div style="flex:1;">${M("Beds",Y("wc-beds",t.beds))}</div>
      <div style="flex:1;">${M("Baths",Y("wc-baths",t.baths))}</div>
      <div style="flex:1;">${M("Sq Ft",Y("wc-sqft",t.sqft))}</div>
    </div>
    ${M("Utilities",G("wc-utilities",Pd,t.utilities))}
    ${M("Heat Source",G("wc-heat_source",Hd,t.heat_source))}

    ${be("Liens & Permits")}
    ${M("Is there a mortgage?",G("wc-has_mortgage",ve,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${M("Mortgage payment status",G("wc-mortgage_payment_status",va,t.mortgage_payment_status))}</div>
    ${M("Any other liens? (back taxes, code violations, HELOC, etc.)",G("wc-has_other_liens",ve,t.has_other_liens))}
    ${M("Any open or expired permits?",G("wc-has_permit_issues",ve,t.has_permit_issues))}
    ${M("Is the property in probate?",G("wc-in_probate",ve,t.in_probate))}

    ${be("Occupancy")}
    ${M("Property occupancy",G("wc-occupancy",Bd,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${M("First name",Y("wc-tenant_first_name",e.first_name))}</div>
        <div style="flex:1;">${M("Last name",Y("wc-tenant_last_name",e.last_name))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${M("Phone",Y("wc-tenant_phone",e.phone))}</div>
        <div style="flex:1;">${M("Email",Y("wc-tenant_email",e.email))}</div>
      </div>
      ${M("Lease type",G("wc-tenant_lease_type",zd,e.lease_type))}
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${M("Monthly rent",Y("wc-tenant_monthly_rent",e.monthly_rent))}</div>
        <div style="flex:1;">${M("Rent due day",Y("wc-tenant_rent_due_day",e.rent_due_day,"e.g. 1st"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${M("Rent status",G("wc-tenant_rent_status",va,e.rent_status))}</div>
        <div style="flex:1;">${M("Last rent paid",Y("wc-tenant_last_rent_paid",e.last_rent_paid,"date"))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${M("Lease on hand?",G("wc-tenant_lease_on_hand",ve,e.lease_on_hand))}</div>
        <div style="flex:1;">${M("Security deposit",Y("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${M("Selling with tenant in place?",G("wc-selling_with_tenant",ve,t.selling_with_tenant))}
    </div>

    ${be("HOA")}
    ${M("Part of an HOA?",G("wc-in_hoa",ve,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${M("HOA rental restriction?",G("wc-hoa_rental_restriction",Rd,t.hoa_rental_restriction))}</div>

    ${be("Photos & Access")}
    ${M("Who is providing photos?",G("wc-photos_provided_by",Nd,t.photos_provided_by))}
    <div style="${ga}">
  ...
  `,A.appendChild(k),document.body.appendChild(A);let J=k.querySelector("#ws-pc-assignment-price"),R=k.querySelector("#ws-pc-assignment-fee"),qe=!1;R?.addEventListener("input",()=>{qe=!0});let Ct=()=>{if(qe)return;let W=Number(J?.value||0);R&&(R.value=String(Math.max(0,W-x)))};J?.addEventListener("input",Ct);let ee=()=>A.remove();A.addEventListener("click",W=>{W.target===A&&ee()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let Q=k.querySelector("#ws-pc-submit"),z=k.querySelector("#ws-pc-error");Q?.addEventListener("click",async()=>{if(!Q)return;z&&(z.textContent="");let W=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ue=Number(J?.value||0),Ve=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),We=Number(R?.value||0),je=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Ke=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Le=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Ye=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),j=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Le){z&&(z.textContent="Closing Date is required.");return}Q.disabled=!0,Q.textContent="Opening\u2026";try{let K={};W!==b&&(K.sellerName=W),Ue!==m&&(K.assignmentPrice=Ue),Ve!==h&&(K.buyerEMD=Ve),We!==_&&(K.assignmentFee=We),je!==E&&(K.closingOffice=je),Ke!==w&&(K.buyerCompanyName=Ke);let Oo=Le!==y||Ye!==f||j!==S,Do=Object.keys(K).length>0||Oo,Po=a;Do?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",K),Q.textContent="Saving\u2026",Po=await ko({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Le,buyerEarnestDueDate:Ye,lenderSource:j,userId:i,overrides:Object.keys(K).length>0?K:void 0}),p.info("[prepare-contract] AA re-stage ok:",Po),Q.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let bn=Po?.debug?.propertyAddress||c,Oi=bn?`${bn} - Assignment Agreement`:void 0;await ln(t,e,o,Oi),ee()}catch(K){Q.disabled=!1,Q.textContent="Open Contract",z&&(z.textContent=K.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",K)}})},ko=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await dp({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ln=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await cp(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await hp(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),V(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=_p(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),yp(a,s.title,s.bodyHtml)),mp(t,a)},Sp=async t=>{let e=op(t);if(!e){V("Could not resolve contact context.","error");return}document.getElementById(Za)?.remove();let o=document.createElement("div");o.id=Za,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
