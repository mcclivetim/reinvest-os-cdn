...
`;var Yn=/^[A-Za-z0-9]{15,30}$/,Me=t=>typeof t=="string"&&Yn.test(t),Xn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Jn=()=>{let t=window.WS_CRM_USER_ID;return Me(t)?t:null},Zn=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Me(o))return o;return null},Qn=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Xn(e);if(!o)return null;let r=o.uid;if(Me(r))return r;let a=o.claims;if(a&&Me(a.user_id))return a.user_id}catch{}return null},ea=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Me(a))return a}catch{}}}catch{}return null},L=()=>Jn()||Zn()||Qn()||ea()||null;var lr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ta=`${lr}/active-follow-up-get`,oa=`${lr}/active-follow-up-set`,pe="ws-crm-active-follow-up-button",oo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ra=()=>{let t=$();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},na=async t=>{let e=await fetch(ta,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},aa=async(t,e)=>{let o=await fetch(oa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},he=(t,e)=>{let o=oo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ar=t=>{let e=document.createElement("button");return e.type="button",e.id=pe,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ma(t,e,()=>lo(t,e))}),o},lo=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([_a(t,e),no()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Aa(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Aa=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(p=>{let m=d.key==="state"?fa(p.geo_value,o):p.geo_value;return`
  ...
  `,oe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await Vi(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},oe(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},oe(o,a),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},oe(o,a),b.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Ct.add(t),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q(),We();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let C=new Set;f=w.checks.map((x,g)=>a.checks[g]?.filled&&!x.filled?i.has(x.label)?x:(C.add(x.label),{...x,filled:!0}):x),i=C}else i=new Set;a={status:f.every(C=>C.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},Ui(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),oe(o,a),document.getElementById(Tt)&&kt(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},oe(o,a),Q();try{let y=await Wi(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},oe(o,a),y.checks&&kt(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},oe(o,a),window.setTimeout(()=>{k()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},oe(o,a),y.checks&&kt(y.checks,y.previously_sent_at,o)}catch(y){b.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},oe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Tt)?Q():a.checks&&kt(a.checks,a.previouslySentAt,o);break}case"error":case"sent":k();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,v=0,k=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await s()}finally{c=!1}}};k();let T=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(T){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-p,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&k()},S)});w.observe(T,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Xi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ji=async()=>{for(let t of Xi)try{let e=await A(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ct=new Set,Pr=null,Zi=t=>{t&&t!==Pr&&(Ct.clear(),Pr=t)},Et=!1,Co=async()=>{if(Et){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Et=!0;try{await Qi()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{Et=!1}},Qi=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=St();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Zi(t.oppId),Ct.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q();return}let e=document.getElementById(de);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=O();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(me)?.remove(),Q(),We());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(me)?.remove(),Q()),b.debug("[stc] mount:04 calling findMountTarget");let o=await Ji();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=O();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=St();if(!a||a.oppId!==t.oppId||!a.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Yi(t.oppId,a.locationId),s=document.createElement("span");s.id=me,s.style.cssText=`
    ...
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),es(t.oppId)},Ve=null,So=null,We=()=>{Ve?.disconnect(),Ve=null,So=null},es=t=>{if(Ve&&So===t)return;We();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(So=t,Ve=new MutationObserver(()=>{let o=St();if(!o||o.oppId!==t){We();return}let r=O();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(de)?.remove(),document.getElementById(me)?.remove(),Q(),We();return}document.getElementById(de)||Co()}),Ve.observe(e,{childList:!0,subtree:!0}))},Eo=null,To,ts=()=>{Eo||(Eo=new MutationObserver(()=>{To===void 0&&(To=window.setTimeout(()=>{To=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(de);if(t&&!e&&!Et){let o=St();if(o&&Ct.has(o.oppId))return;Co()}},300))}),Eo.observe(document.body,{childList:!0,subtree:!0}))},Rr=()=>{ts(),Co()};var Io="ws-support-nav-item",Gr="ws-support-modal",zr="ws-support-toast",os="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",qr="ws-support-submitter-name",Ur="ws-support-submitter-email",Vr="ws-support-submitter-role",rs=["Bug","Feature Request","Question","Billing","Onboarding Help"],ue=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Wr=()=>{let t=["aside.default-bg-color",".sidebar-v2-location",".sidebar-v2","aside[class*='default-bg-color']","aside[class*='sidebar']","nav[class*='sidebar']"];for(let e of t){let o=document.querySelector(e);if(o)return o}return null},ns=t=>{let e=Array.from(t.querySelectorAll("a"));for(let o of e)if(o.href&&(o.querySelector("svg")||o.querySelector("img")||o.querySelector("i")))return o;return e[0]??null},as='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="rgb(237,238,240)"><path stroke-linecap="round" stroke-linejoin="round" d="M16.712 4.33a9.027 9.027 0 011.652 1.306c.51.51.944 1.064 1.306 1.652M16.712 4.33l-3.448 4.138m3.448-4.138a9.014 9.014 0 00-9.424 0M19.67 7.288l-4.138 3.448m4.138-3.448a9.014 9.014 0 010 9.424m-4.138-5.976a3.736 3.736 0 00-.88-1.388 3.737 3.737 0 00-1.388-.88m2.268 2.268a3.765 3.765 0 010 2.528m-2.268-4.796a3.765 3.765 0 00-2.528 0m4.796 4.796c-.181.506-.475.982-.88 1.388a3.736 3.736 0 01-1.388.88m2.268-2.268l4.138 3.448m0 0a9.027 9.027 0 01-1.306 1.652c-.51.51-1.064.944-1.652 1.306m0 0l-3.448-4.138m3.448 4.138a9.014 9.014 0 01-9.424 0m5.976-4.138a3.765 3.765 0 01-2.528 0m0 0a3.736 3.736 0 01-1.388-.88 3.737 3.737 0 01-.88-1.388m2.268 2.268L7.288 19.67m0 0a9.024 9.024 0 01-1.652-1.306 9.027 9.027 0 01-1.306-1.652m0 0l4.138-3.448M4.33 16.712a9.014 9.014 0 010-9.424m4.138 5.976a3.765 3.765 0 010-2.528m0 0c.181-.506.475-.982.88-1.388a3.736 3.736 0 011.388-.88m-2.268 2.268L4.33 7.288m6.406 1.18L7.288 4.33m0 0a9.024 9.024 0 00-1.652 1.306A9.025 9.025 0 004.33 7.288" /></svg>',is=`data:image/svg+xml,${encodeURIComponent(as)}`,ss="w-full group px-3 flex items-center justify-start lg:justify-start xl:justify-start text-sm font-medium rounded-md cursor-pointer font-medium opacity-70 hover:opacity-100 py-2 md:py-2",ls="md:mr-0 h-5 w-5 mr-0 md:mr-0 lg:mr-0 xl:mr-0",ds=(t,e)=>{let o=document.createElement("a");return o.id=Io,o.href="#ws-support",o.setAttribute("role","button"),o.setAttribute("aria-label","Support"),o.className=ss,o.innerHTML=`<img src="${is}" class="${ls}" alt="Support icon"><span class="hl_text-overflow sm:hidden md:hidden nav-title" style="color: rgb(237, 238, 240) !important; -webkit-text-fill-color: rgb(237, 238, 240) !important;">Support</span>`,o.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),t()}),o},cs=(t,e="success",o)=>{let r=document.getElementById(zr);r&&r.remove();let a=document.createElement("div");a.id=zr;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},bs=()=>{document.getElementById(Gr)?.remove();let t=(localStorage.getItem(qr)??"").trim(),e=(localStorage.getItem(Ur)??"").trim(),o=(localStorage.getItem(Vr)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Gr,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=ge();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(qr,r.submitterName),localStorage.setItem(Ur,r.submitterEmail),r.submitterRole&&localStorage.setItem(Vr,r.submitterRole)}catch{}let p=i.querySelector("#ws-support-submit");p&&(p.disabled=!0,p.textContent="Submitting\u2026",p.style.opacity="0.7");try{let h=await(await fetch(os,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";cs(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1")}})},It=()=>{if(document.getElementById(Io))return;let t=Wr();if(!t){b.debug("[support-nav] sidebar not found yet");return}let e=ns(t),o=ds(bs,e);(t.querySelector("[class*='overflow']")??t).appendChild(o),b.info("[support-nav] mounted Support nav item")},jr=()=>{It(),setTimeout(It,800),setTimeout(It,2e3);let t=new MutationObserver(()=>{document.getElementById(Io)||It()}),e=Wr();e&&t.observe(e,{childList:!0,subtree:!0})};var ps="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",hs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",ms="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Xr="ldtyB2UXKi9vOp8nLUH7",us="WVD2gb9swLsgcdBEtDVq",ee="ws-crm-closing-agent-picker-button",Jr="ws-crm-closing-agent-picker-modal",vs=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_s=/\/v2\/location\/([A-Za-z0-9]+)/,Ye=()=>{let t=window.location.pathname,e=t.match(vs);if(!e)return null;let o=t.match(_s);return{oppId:e[1],locationId:o?o[1]:null}},Oo=async t=>{let e=await fetch(ps,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Kr=async t=>{let e=await fetch(hs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ys=async(t,e)=>{try{let o=await fetch(ms,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Xr}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Oo({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},ve=null,gs=60*60*1e3,Po=t=>`ws-crm-to-cache:${t}`,Zr=t=>{try{let e=window.localStorage.getItem(Po(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>gs||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Qr=(t,e,o)=>{try{window.localStorage.setItem(Po(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},fs=t=>{try{window.localStorage.removeItem(Po(t))}catch{}},Mo="ws-crm-closing-agent-field-link",ws=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Mo}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Ao=!1,No=async t=>{if(Ao)return;let e=en();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Ao=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Oo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Do(a.id,a.name,t);let i=document.getElementById(ee);if(i){ce(i,{status:"linked",contactName:a.name});let s=Ye();s&&Qr(s.oppId,a.id,a.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Ao=!1}}},xs=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,en=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();xs.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&b.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Do=(t,e,o)=>{let r=en();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Mo}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Mo,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},At=()=>{document.getElementById(Jr)?.remove()},ks=t=>{At();let e=document.createElement("div");e.id=Jr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};ce(o,r);let a=Zr(t);return a&&(r={status:"linked",contactName:a.contactName},ce(o,r),ve={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await ys(t,e);s?(r={status:"linked",contactName:s.name},ce(o,r),ve={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Do(s.id,s.name,e)):a||(r={status:"empty"},ce(o,r),ve?.oppId===t&&(ve=null),ws(),fs(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ks({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},ce(o,r);try{let l=[Kr({tenantId:e,oppId:t,fieldId:Xr,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Kr({tenantId:e,oppId:t,fieldId:us,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},ce(o,r),ve={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Qr(t,s.id,s.name),Do(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},ce(o,r)}}})}),o},Ts=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ss=async()=>{for(let t of Ts)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},je=!1,Mt=async()=>{if(!je){je=!0;try{await Cs()}finally{je=!1}}},Cs=async()=>{let t=Ye();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),$t();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let d=O();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),$t());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=O();if(o!==null&&o!=="Transaction Coordination")return;let r=await Ss();if(!r||!(Zr(t.oppId)!==null||ve!==null&&ve.oppId===t.oppId)&&await te()!=="Transaction Coordination")return;let i=Ye();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Es(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ee}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Is(t.oppId),No(i.locationId)},Ke=null,Fo=null,Ho=null,$t=()=>{Ke?.disconnect(),Ke=null,Fo=null,Ho=null},Is=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ke&&Fo===t&&Ho===e||($t(),Fo=t,Ho=e,Ke=new MutationObserver(()=>{let o=Ye();if(!o||o.oppId!==t||!o.locationId){$t();return}document.getElementById(ee)||Mt(),No(o.locationId)}),Ke.observe(e,{childList:!0,subtree:!0})))},Lo=null,$o,As=()=>{Lo||(Lo=new MutationObserver(()=>{$o===void 0&&($o=window.setTimeout(()=>{$o=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!je&&Mt()},300))}),Lo.observe(document.body,{childList:!0,subtree:!0}))},Yr,Ls=()=>{Yr===void 0&&(Yr=window.setInterval(()=>{let t=Ye();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ee)&&!je&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Mt()),No(t.locationId)},2e3))},tn=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),As(),Ls(),Mt()};var $s="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ee="ws-crm-manage-team-cta",rn="ws-crm-manage-team-modal",Ms=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,nn={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Ds={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},an=()=>{let t=window.location.pathname.match(Ms);return t?{tenantId:t[1]}:null},Ft=async t=>{let e=await fetch($s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},Y=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),be=t=>Y(t),Bo="ws-crm-manage-team-toast",zo=(t,e="info",o=4e3)=>{document.getElementById(Bo)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Bo,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Bo)===a&&a.remove()},o)},Ro=()=>{document.getElementById(rn)?.remove()},Fs=(t,e)=>{let o=Ds[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${Y(e)}</span>
  `},Hs=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Fs(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
  ...
  `+t.map(r=>Hs(r,e)).join(""),Ht=async t=>{Ro();let e=document.createElement("div");e.id=rn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ro);let r;try{r=await Ft({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Os(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Ps(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;Ns(t,{email:p.dataset.email||"",name:p.dataset.name||"",currentRoles:(p.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;Bs(t,{email:p.dataset.email||"",name:p.dataset.name||"",roleCount:parseInt(p.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Ps=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.addEventListener("click",()=>{Ht(t)}),Dt(e),setTimeout(()=>Dt(e),200),setTimeout(()=>Dt(e),800),window.addEventListener("resize",()=>Dt(e)),e},js=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],Ks=async()=>{for(let t of js)try{let e=await A(t,{timeoutMs:1500});if(e)return e}catch{}return null},Go=!1,Ys=async()=>{if(!Go){Go=!0;try{let t=an();if(!t){document.getElementById(Ee)?.remove();return}let e=document.getElementById(Ee);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await Ks();if(!o){let i=document.createElement("div");i.id=`${Ee}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=on(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),b.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=on(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),b.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{Go=!1}}},sn=()=>{if(!an()){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-floater`)?.remove();return}Ys()};var Xs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Vo="ws-crm-prepare-contract-button",ln="ws-crm-prepare-contract-menu",ne="ws-crm-prepare-contract-modal",dn="ws-crm-modal-date-style",ie="https://services.leadconnectorhq.com",mn=()=>{if(document.getElementById(dn))return;let t=document.createElement("style");t.id=dn,t.textContent=`
  ...
  `,document.head.appendChild(t)},Wo="__WS_CRM_CAPTURED_AUTH",Js=50*60*1e3,un=()=>{try{let t=localStorage.getItem(Wo);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Js?(localStorage.removeItem(Wo),null):e:null}catch{return null}},Zs=t=>{try{localStorage.setItem(Wo,JSON.stringify(t))}catch{}},se=()=>{let t=un(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},cn=!1,Qs=()=>{if(cn)return;cn=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let p=d.authorization||d.Authorization;if(!p){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=un()?.authorization;Zs({authorization:p,tokenId:m,capturedAt:Date.now()}),h!==p&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${p.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let p=c.headers;!p&&l[0]instanceof Request&&(p=l[0].headers);let m={};if(p instanceof Headers)p.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(p))p.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(p&&typeof p=="object")for(let h of Object.keys(p))m[h.toLowerCase()]=p[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},vn=()=>{let t=$();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},el=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:vn()},tl=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},_n="__WS_CRM_TEMPLATES_CACHE_V1",ol=24*60*60*1e3,bn=t=>{try{let e=window.localStorage.getItem(_n);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>ol?null:o.templates}catch{return null}},rl=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(_n,JSON.stringify(o))}catch{}},nl=async t=>{let e=`${ie}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:se()})}catch(s){let l=bn(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=bn(t);if(s)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:tl(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&rl(t,i),i},al=async(t,e)=>{let o=await fetch(`${ie}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${ie}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:se()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},il=async(t,e)=>{let o=await fetch(`${ie}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ie}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:se()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-p})},sl=async t=>{let e=await fetch(Xs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},ll=async(t,e,o)=>{let r=`${ie}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:se()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},dl=async(t,e)=>{let o=await fetch(`${ie}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:se()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},cl=async t=>{let e=await fetch(`${ie}/contacts/${t}`,{method:"GET",headers:se()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},bl=async(t,e,o,r)=>{let a;try{a=await dl(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await cl(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},p=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:p,grandTotal:a.grandTotal},h=await fetch(`${ie}/proposals/document/${e}`,{method:"PUT",headers:{...se(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},pl=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Pt="__WS_CRM_PENDING_INSTRUCTIONS",hl=60*1e3,ml=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],ul=t=>{let e=(t||"").toLowerCase();for(let o of ml)if(e.includes(o.matches.toLowerCase()))return o;return null},vl=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Pt,JSON.stringify(r))}catch{}},_l=()=>{try{let t=localStorage.getItem(Pt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>hl?(localStorage.removeItem(Pt),null):e}catch{return null}},yl=()=>{try{localStorage.removeItem(Pt)}catch{}},gl=(t,e)=>{document.getElementById(ne)?.remove();let o=document.createElement("div");o.id=ne,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},fl=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,wl=()=>{let t=window.location.pathname.match(fl);if(!t)return;let e=t[1],o=_l();o&&o.proposalId===e&&(yl(),window.setTimeout(()=>{gl(o.title,o.bodyHtml)},600))},pn="ws-crm-prepare-contract-toast",R=(t,e="info",o=4e3)=>{document.getElementById(pn)?.remove();let r=document.createElement("div");r.id=pn;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,D=N=>['<option value="">(unset)</option>'].concat(T.map(G=>`<option value="${re(G)}"${G===N?" selected":""}>${V(G)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,w.appendChild(y),document.body.appendChild(w);let P=y.querySelector("#ws-pc-purchase-price"),j=y.querySelector("#ws-pc-emd"),U=y.querySelector("#ws-pc-cash-at-close"),H=!1;U?.addEventListener("input",()=>{H=!0});let Te=()=>{if(H)return;let N=Number(P?.value||0),G=Number(j?.value||0);U&&(U.value=String(Math.max(0,N-G)))};P?.addEventListener("input",Te),j?.addEventListener("input",Te);let ot=()=>w.remove();w.addEventListener("click",N=>{N.target===w&&ot()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",ot);let K=y.querySelector("#ws-pc-submit"),W=y.querySelector("#ws-pc-error");K?.addEventListener("click",async()=>{if(K){W&&(W.textContent=""),K.disabled=!0,K.textContent="Opening\u2026";try{let N=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),G=Number(P?.value||0),Se=Number(j?.value||0),Ce=Number(U?.value||0),Ie=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ae=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Le=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ye=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),$e=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),z={};if(N!==s&&(z.sellerName=N),G!==l&&(z.purchasePrice=G),Se!==d&&(z.emd=Se),Ce!==c&&(z.cashAtClose=Ce),Ie!==p&&(z.daysToClose=Ie),Ae!==m&&(z.inspectionDays=Ae),Le!==h&&(z.additionalTerms=Le),ye!==v&&(z.currentOccupancy=ye),$e!==k&&(z.occupancyAtClose=$e),Object.keys(z).length>0){b.info("[prepare-contract] PA modal submit with overrides:",z),K.textContent="Saving\u2026";let jt=L(),Kt=await Nt({tenantId:t,contactId:e,template:o,userId:jt,overrides:z});b.info("[prepare-contract] re-stage with overrides ok:",Kt),K.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let q=i?`${i} - Purchase Agreement`:void 0;await Yo(t,e,o,q)}catch(N){K.disabled=!1,K.textContent="Open Contract",W&&(W.textContent=N.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",N)}}})},kl=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ne)?.remove(),mn();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",p=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,k=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,T=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,S="",C=document.createElement("div");C.id=ne,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,C.appendChild(x),document.body.appendChild(C);let U=x.querySelector("#ws-pc-assignment-price"),H=x.querySelector("#ws-pc-assignment-fee"),Te=!1;H?.addEventListener("input",()=>{Te=!0});let ot=()=>{if(Te)return;let G=Number(U?.value||0);H&&(H.value=String(Math.max(0,G-k)))};U?.addEventListener("input",ot);let K=()=>C.remove();C.addEventListener("click",G=>{G.target===C&&K()}),x.querySelector("#ws-pc-cancel")?.addEventListener("click",K);let W=x.querySelector("#ws-pc-submit"),N=x.querySelector("#ws-pc-error");W?.addEventListener("click",async()=>{if(!W)return;N&&(N.textContent="");let G=(x.querySelector("#ws-pc-seller-name")?.value||"").trim(),Se=Number(U?.value||0),Ce=Number(x.querySelector("#ws-pc-buyer-emd")?.value||0),Ie=Number(H?.value||0),Ae=(x.querySelector("#ws-pc-closing-office")?.value||"").trim(),Le=(x.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ye=(x.querySelector("#ws-pc-closing-date")?.value||"").trim(),$e=(x.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),z=(x.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ye){N&&(N.textContent="Closing Date is required.");return}W.disabled=!0,W.textContent="Opening\u2026";try{let q={};G!==p&&(q.sellerName=G),Se!==m&&(q.assignmentPrice=Se),Ce!==h&&(q.buyerEMD=Ce),Ie!==v&&(q.assignmentFee=Ie),Ae!==T&&(q.closingOffice=Ae),Le!==w&&(q.buyerCompanyName=Le);let jt=ye!==y||$e!==f||z!==S,Kt=Object.keys(q).length>0||jt,Yt=a;Kt?(b.info("[prepare-contract] AA modal submit, re-staging with overrides:",q),W.textContent="Saving\u2026",Yt=await Nt({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ye,buyerEarnestDueDate:$e,lenderSource:z,userId:i,overrides:Object.keys(q).length>0?q:void 0}),b.info("[prepare-contract] AA re-stage ok:",Yt),W.textContent="Opening\u2026"):b.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Qo=Yt?.debug?.propertyAddress||c,zn=Qo?`${Qo} - Assignment Agreement`:void 0;await Yo(t,e,o,zn),K()}catch(q){W.disabled=!1,W.textContent="Open Contract",N&&(N.textContent=q.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",q)}})},Nt=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await sl({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Yo=async(t,e,o,r)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await ll(t,o.id,e);b.info(`[prepare-contract] proposal created: ${a}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await bl(t,a,e,r);i.ok?b.info(`[prepare-contract] contact attached to proposal ${a}`):(b.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),R(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=ul(o.name);s&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),vl(a,s.title,s.bodyHtml)),pl(t,a)},El=async t=>{let e=el(t);if(!e){R("Could not resolve contact context.","error");return}document.getElementById(ln)?.remove();let o=document.createElement("div");o.id=ln,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await nl(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let p;if(e.oppId)p=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${p} directly`);else{let y;try{y=await il(e.tenantId,e.contactId)}catch(f){R(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){R("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)p=y[0].id,b.info(`[prepare-contract] auto-selected MT opp ${p} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await hn(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){b.info("[prepare-contract] MT opp picker cancelled");return}p=f,b.info(`[prepare-contract] picked MT opp ${p}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${C}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),k=h(7);R("Reading contract data\u2026","info",2500);let T;try{T=await Nt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:p,closingDate:v,buyerEarnestDueDate:k,userId:c})}catch(y){R(`Failed to prepare contract: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||T.contact_id||"";if(!w){R("Could not resolve buyer contact for this opp.","error",6e3);return}kl({tenantId:e.tenantId,contactId:w,template:i,oppId:p,staged:T,userId:c,defaultClosingDate:v,defaultEMDDueDate:k})}else if(i.type==="PA"){if(!e.contactId){R("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let p;try{p=await al(e.tenantId,e.contactId)}catch(v){R(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(p.length===0){R("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(p.length===1)m=p[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${p.length} opps)`);let v=await hn(p,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}R("Reading contract data\u2026","info",2500);let h;try{h=await Nt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){R(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}xl({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){R("This template needs to be started from a contact page.","error",6e3);return}R(`Opening ${i.name}\u2026`,"info",2500);try{await Yo(e.tenantId,e.contactId,i)}catch(p){R(`Failed to open contract: ${p.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",p)}}}catch(p){b.warn("[prepare-contract] picker click handler failed:",p),R(`Unexpected error: ${p.message}`,"error",6e3)}}),o.appendChild(s)}},yn=()=>{let t=document.createElement("button");return t.id=Vo,t.type="button",t.style.cssText=`${M} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),El(t)}),t},Tl="ws-crm-contact-actions-bar",Sl=async()=>{let t=vn();if(!t){document.getElementById(Vo)?.remove();return}let e=null;try{e=await A(`#${Tl}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Vo);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=yn();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},_e="ws-crm-prepare-contract-button-opp",Xe=`${_e}-wrap`,Cl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Il=/\/v2\/location\/([A-Za-z0-9]+)/,Al=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jo=()=>{let t=window.location.pathname,e=t.match(Cl);if(!e)return null;let o=t.match(Il);return o?{oppId:e[1],tenantId:o[1]}:null},Ll=async()=>{for(let t of Al)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ot=!1,Je=null,Ko=null,qo=null,Uo,Ze=()=>{Je?.disconnect(),Je=null,Ko=null},$l=t=>{if(Je&&Ko===t)return;Ze();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ko=t,Je=new MutationObserver(()=>{let o=jo();if(!o||o.oppId!==t){Ze();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(_e)?.remove(),document.getElementById(Xe)?.remove(),Ze();return}document.getElementById(_e)||gn()}),Je.observe(e,{childList:!0,subtree:!0}))},Ml=()=>{qo||(qo=new MutationObserver(()=>{Uo===void 0&&(Uo=window.setTimeout(()=>{Uo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(_e);t&&!e&&!Ot&&gn()},300))}),qo.observe(document.body,{childList:!0,subtree:!0}))},gn=async()=>{if(!Ot){Ot=!0;try{let t=jo();if(!t){document.getElementById(_e)?.remove(),document.getElementById(Xe)?.remove(),Ze();return}let e=document.getElementById(_e);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Xe)?.remove(),Ze());return}e&&(e.remove(),document.getElementById(Xe)?.remove());let o=await Ll();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await te();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=jo();if(!a||a.oppId!==t.oppId)return;let i=yn();i.id=_e,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Xe,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),$l(t.oppId)}finally{Ot=!1}}},fn=()=>{wl(),Sl()};Qs();function V(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function re(t){return V(t)}var Ut="reos-theme-stylesheet",Nn="reos-theme-fonts",Dl=()=>{let t=document.getElementById(Nn);t&&t.remove()},Fl=`
/* ============================================
