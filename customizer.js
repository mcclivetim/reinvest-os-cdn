/* Wholesaling CRM Customizer v0.5.28 — built 2026-05-16T15:44:12.363Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var E="[wholesaling-crm-customizer]",le="__WS_CRM_DEBUG",ce=()=>!!window[le],d={info(...e){console.log(E,...e)},warn(...e){console.warn(E,...e)},error(...e){console.error(E,...e)},debug(...e){ce()&&console.log(E,"[debug]",...e)}};var H=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},S="",x="other",D=new Set,_=()=>{if(window.location.pathname!==S){S=window.location.pathname,x=H(),d.debug("Page changed:",x,S);for(let e of D)try{e(x)}catch(o){d.error("Subscriber threw:",o)}}},O=e=>(D.add(e),setTimeout(()=>e(x),0),()=>{D.delete(e)}),N=()=>{x=H(),S=window.location.pathname,d.debug("Router init, current page:",x);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),_()},history.replaceState=function(t,r,a){o(t,r,a),_()},window.addEventListener("popstate",_),setInterval(_,1e3)};var C="0.5.28",T="2026-05-16T15:44:12.363Z";var de=/\/contacts\/detail\/([A-Za-z0-9]+)/,pe=/\/v2\/location\/([A-Za-z0-9]+)/,f=()=>{let e=window.location.pathname,o=e.match(de);if(!o)return null;let t=e.match(pe);return{contactId:o[1],locationId:t?t[1]:null}};var w=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,c)=>{let s=a.querySelector(e);if(s){n(s);return}let i,p,h=()=>{u&&u.disconnect(),i!==void 0&&window.clearTimeout(i),p!==void 0&&window.clearInterval(p)},u=new MutationObserver(()=>{let m=a.querySelector(e);m&&(h(),n(m))});u.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let m=a.querySelector(e);m&&(h(),n(m))},r),i=window.setTimeout(()=>{h(),d.warn(`waitForElement timed out for selector: ${e}`),c(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},y={sm:"4px",md:"6px",lg:"10px",pill:"999px"},g={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},$={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},G=e=>{let o=e==="emerald"?l.emeraldGlow:e==="amber"?l.amberGlow:l.slate,t=e==="emerald"?l.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=e==="emerald"?l.emerald:e==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var ie=()=>{d.info(`Loaded v${C} (built ${T})`),ae(),N(),O(e=>{d.debug("Page handler firing for:",e),se(),W(),j()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie();})();
