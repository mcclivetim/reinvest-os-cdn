/* Wholesaling CRM Customizer v0.14.17 — built 2026-05-30T03:57:08.266Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Se="[wholesaling-crm-customizer]",kr="__WS_CRM_DEBUG",Er=()=>!!window[kr],b={info(...t){console.log(Se,...t)},warn(...t){console.warn(Se,...t)},error(...t){console.error(Se,...t)},debug(...t){Er()&&console.log(Se,"[debug]",...t)}};var eo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,it=/\/v2\/location\/([A-Za-z0-9]+)/,Tr=t=>{let e=t.match(eo);if(!e)return null;let o=t.match(it);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Sr=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",n=r.match(eo);if(!n)continue;let i=r.match(it)||window.location.pathname.match(it);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},S=()=>{let t=Tr(window.location.pathname);return t||Sr()};var to=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Ie="",lt=null,te="other",dt=new Set,Ce=()=>{let t=S()?.contactId??null;if(!(!(window.location.pathname!==Ie)&&!(t!==lt))){Ie=window.location.pathname,lt=t,te=to(),b.debug("Page/context changed:",te,Ie,"contact:",t);for(let r of dt)try{r(te)}catch(n){b.error("Subscriber threw:",n)}}},oo=t=>(dt.add(t),setTimeout(()=>t(te),0),()=>{dt.delete(t)}),ro=()=>{te=to(),Ie=window.location.pathname,lt=S()?.contactId??null,b.debug("Router init, current page:",te);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,n){t(o,r,n),Ce()},history.replaceState=function(o,r,n){e(o,r,n),Ce()},window.addEventListener("popstate",Ce),setInterval(Ce,1e3)};var Ae="0.14.17",Le="2026-05-30T03:57:08.267Z";var C=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,a)=>{let l=n.querySelector(t);if(l){i(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(t);p&&(h(),i(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(t);p&&(h(),i(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${t}`),a(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},x={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ct={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},no=t=>{let e=t==="emerald"?s.emeraldGlow:t==="amber"?s.amberGlow:s.slate,o=t==="emerald"?s.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=t==="emerald"?s.emerald:t==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,L=`
  ...
  flex-shrink: 0;
`;var Cr=/^[A-Za-z0-9]{15,30}$/,ae=t=>typeof t=="string"&&Cr.test(t),Ir=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ar=()=>{let t=window.WS_CRM_USER_ID;return ae(t)?t:null},Lr=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ae(o))return o;return null},Mr=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ir(e);if(!o)return null;let r=o.uid;if(ae(r))return r;let n=o.claims;if(n&&ae(n.user_id))return n.user_id}catch{}return null},Dr=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),n=r.id??r._id;if(ae(n))return n}catch{}}}catch{}return null},I=()=>Ar()||Lr()||Mr()||Dr()||null;var lo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Fr=`${lo}/active-follow-up-get`,$r=`${lo}/active-follow-up-set`,X="ws-crm-active-follow-up-button",ht={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},Pr=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Hr=async t=>{let e=await fetch(Fr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Or=async(t,e)=>{let o=await fetch($r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},J=(t,e)=>{let o=ht[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let n=t.querySelector(".ws-afu-label");n&&(n.textContent=o.label)},ao=t=>{let e=document.createElement("button");return e.type="button",e.id=X,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,J(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Pr();if(!(!r||r.contactId!==t)){J(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Or(r,I()),i=n&&n.state&&n.state in ht?n.state:"blue";J(e,i),b.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),J(e,"error"),setTimeout(()=>void Me(e,r),4e3)}}}),e},Me=async(t,e)=>{J(t,"loading");try{let o=await Hr(e),r=o&&o.state&&o.state in ht?o.state:"gray",n=document.getElementById(X);if(!n||n.dataset.contactId!==e.contactId)return;J(n,r)}catch(o){b.warn("Active Follow Up Get webhook failed",o),J(t,"error")}},Nr=[".central-panel","[class*='central-panel']"],bt="ws-crm-contact-actions-bar",Br=async()=>{for(let t of Nr)try{let e=await C(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Rr=async(t,e)=>{let o=e.querySelector(`#${bt}`);if(!o)try{o=await C(`#${bt}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${bt}`);i&&i.parentElement===e?e.insertBefore(n,i.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(t),{container:n,placement:"fallback"}},Gr=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},zr=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},qr=async t=>{if(t==="url"){let o=await Br();return o?{kind:"contact-detail",target:o}:null}let e=Gr();return e?{kind:"conversations",target:e}:null},so=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Rr(t,e.target);return o}return zr(t,e.target),"conversations-header"},Ur=async()=>{let t=S();if(!t||!t.locationId){document.getElementById(X)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(X);if(o&&o.dataset.contactId===e.contactId){Me(o,e);return}o&&o.remove();let r=await qr(t.source);if(!r){b.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let i=ao(e.contactId),a=await so(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${a}) for ${e.contactId}`),io();let l=document.getElementById(X)??i;Me(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(X);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=ao(e.contactId);so(m,r).then(()=>{io(),Me(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},se=null,co=()=>{let t=S()?.contactId??null;if(se&&se.contactId===t)return;let e=Ur().finally(()=>{se?.promise===e&&(se=null)});se={contactId:t,promise:e}},io=()=>{let t=document.querySelectorAll(`#${X}`);if(!(t.length<=1)){b.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var V="ws-crm-claim-release-pill",Vr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Wr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",jr=async t=>{let e=await fetch(Vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Kr=async t=>{let e=await fetch(Wr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},po=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},oe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;t.dataset.mode=e,t.style.cssText=no(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Yr=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=V,o.type="button",o.dataset.contactId=t,oe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==t)return;let i=I();if(!i){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>oe(o,r),2500);return}b.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let a=r==="claim"?"release":"claim";oe(o,a),o.disabled=!0,o.style.opacity="0.8";try{let l=await Kr({contactId:t,locationId:n.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:a;oe(o,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),oe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},bo=async(t,e)=>{try{let o=await jr({contactId:e.contactId,locationId:e.locationId,userId:I()}),r=document.getElementById(V);if(!r||r.dataset.contactId!==e.contactId)return;let n=o?.mode==="release"?"release":"claim";oe(r,n)}catch(o){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Xr=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=po(t);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},ho=(t,e)=>{let o=Yr({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${V}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Jr=async()=>{let t=S();if(!t){document.getElementById(V)?.remove();return}let e=document.getElementById(V);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Xr(o),n=S();if(!n||n.contactId!==t.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ho(r,t.contactId),b.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(V);i&&t.locationId&&bo(i,{contactId:t.contactId,locationId:t.locationId});let a=null;a=new MutationObserver(async()=>{if(!(S()?.contactId===t.contactId)){a?.disconnect();return}if(document.getElementById(V))return;let d=po(o);if(d){ho(d,t.contactId);let c=document.getElementById(V);c&&t.locationId&&bo(c,{contactId:t.contactId,locationId:t.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),a.observe(o,{childList:!0,subtree:!0})}catch(o){b.warn("Could not mount Claim/Release pill:",o)}}},mo=()=>{Jr()};var Zr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ie=new Map,uo=async(t,e)=>{if(!t)return null;if(ie.has(t))return ie.get(t)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let n=`${Zr}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return b.warn(`Contact Type fetch returned ${i.status} for ${t}`),ie.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ie.set(t,l),b.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${t}:`,n),ie.set(t,null),null}};var _o=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var xo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var en="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",tn=async({contactId:t,locationId:e,status:o,userId:r,deadReason:n,webhookUrl:i,kind:a})=>{let l=i||xo,d;if(a==="buyer"){let h=ko.find(p=>p.label===o),m=h?h.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:o,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:t,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},on=async({contactId:t,tenantId:e})=>{let o=await fetch(en,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var re="ws-crm-contact-actions-bar",rn="ws-crm-call-status-dropdown",vo="ws-crm-offer-made-modal",nn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ko=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],an=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],sn=async()=>{for(let t of an)try{let e=await C(t,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await C("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(t,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},ln=({contactId:t,kind:e})=>{let o=e==="buyer"?ko:nn,r=e==="buyer"?Qr:xo,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=rn,i.style.cssText="position: relative; flex-shrink: 0;";let a=document.createElement("button");a.type="button",a.style.cssText=L,a.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${ct[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=s.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let h=a.firstElementChild,m=a.children[1],p=a.children[2];h&&(h.style.background=ct[d.color]),m&&(m.textContent=d.label),l.style.display="none";let _=S()?.locationId,w=I();if(!_){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=s.amber);return}if(e==="seller"&&d.color==="green"&&!w){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=s.amber);return}let y=p?.textContent??"\u25BE",g=async f=>{p&&(p.textContent="\u2026"),a.style.opacity="0.75";try{await tn({contactId:t,locationId:_,status:d.label,userId:w,deadReason:f,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=y),a.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=s.amber),a.style.opacity="1",setTimeout(()=>{p&&(p.textContent=y),m&&(m.style.color=s.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";hn(E=>{g(E)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await on({contactId:t,tenantId:_})).ok?await g():pn(()=>{g()},()=>{m&&(m.textContent=f)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await g()}return}await g()}),l.appendChild(c)}),a.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(a),i.appendChild(l),i},dn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",cn=async t=>{let e=await fetch(dn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},bn=(t,e="seller")=>{document.getElementById(vo)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",n=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?s.emerald:s.amber,a=document.createElement("div");a.id=vo,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,a.appendChild(l),document.body.appendChild(a);let m=()=>a.remove();a.addEventListener("click",w=>{w.target===a&&m()});let p=l.querySelector("#ws-offer-error"),u=l.querySelector("#ws-offer-cancel"),_=l.querySelector("#ws-offer-submit");u?.addEventListener("click",m),_?.addEventListener("click",async()=>{let w=(l.querySelector("#ws-offer-amount")?.value??"").trim(),y=o?l.querySelector("#ws-offer-expires")?.value??"":"";if(!w||Number(w)<=0){p&&(p.textContent="Enter a positive offer amount."),b.warn("Offer Made submit blocked \u2014 invalid amount");return}let g=Number(w);if(g<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(g*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),_&&(_.disabled=!0,_.textContent="Recording\u2026",_.style.opacity="0.7"),u&&(u.disabled=!0);try{let k=await cn({tenantId:T,contactId:t,kind:e,amount:g,expiresAt:y||null,userId:I()});if(!k.ok){p&&(p.textContent=k.error??"Something went wrong."),_&&(_.disabled=!1,_.textContent="Record Offer",_.style.opacity="1"),u&&(u.disabled=!1);return}b.info(`Offer Made (${e}) recorded for contact ${t}: $${g} on ${k.opp_pipeline} opp (stage: ${k.opp_stage_name??"?"})`),m()}catch(k){b.error("Offer Made webhook failed",k),p&&(p.textContent=k instanceof Error?k.message:"Network error \u2014 try again."),_&&(_.disabled=!1,_.textContent="Record Offer",_.style.opacity="1"),u&&(u.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},yo="ws-crm-dead-deal-modal",hn=(t,e)=>{document.getElementById(yo)?.remove();let o=document.createElement("div");o.id=yo,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let n=()=>o.remove(),i=()=>{n(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),t()});let a=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",a),i())};document.addEventListener("keydown",a)},fo=(t,e)=>{let o=document.createElement("div");if(o.id=re,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=q,r.textContent="Offer Made",r.addEventListener("click",()=>bn(t,e)),o.appendChild(r),o.appendChild(ln({contactId:t,kind:e}))}return o},pt=!1,mn=()=>{document.querySelectorAll(`[id="${re}"]`).forEach(t=>t.remove())},Eo=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),pt){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}pt=!0;try{await un()}finally{pt=!1}},un=async()=>{let t=S();if(!t){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),mn();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await uo(t.contactId,t.locationId),h=_o(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=S();if(!o||o.contactId!==t.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${re}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await sn();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let i=S();if(!i||i.contactId!==t.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let a;try{a=fo(t.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}a.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(a,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(re)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===t.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${re}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=fo(t.contactId,e);p.dataset.mountTarget=a.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},wo=null,_n=()=>{wo===null&&(wo=window.setInterval(()=>{let t=S();t&&(document.getElementById(re)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Eo()))},3e3))},To=()=>{_n(),Eo()};var De="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",vn=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),le="data-ws-crm-favicon",mt=t=>t.hasAttribute(le),So=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return vn.has(e)},Fe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{So(r)&&!mt(r)&&r.remove()});let e=document.head.querySelector(`link[${le}="1"]`);e?e.href!==De&&(e.href=De):(e=document.createElement("link"),e.setAttribute(le,"1"),e.rel="icon",e.type="image/png",e.href=De,document.head.appendChild(e),b.debug("Favicon installed"));let o=document.head.querySelector(`link[${le}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(le,"apple"),o.rel="apple-touch-icon",o.href=De,document.head.appendChild(o))},Co=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Fe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Fe())},50)}new MutationObserver(r=>{let n=!1;for(let i of r)i.addedNodes.forEach(a=>{a instanceof HTMLLinkElement&&So(a)&&!mt(a)&&(n=!0)}),i.removedNodes.forEach(a=>{a instanceof HTMLLinkElement&&mt(a)&&(n=!0)});n&&Fe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Fe(),e>=5&&window.clearInterval(o)},1e3)};var yn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],gn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,fn=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(fn);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let n=r.match(gn);if(n){let i=n[1];if(yn.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var wn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",$="ws-crm-mt-offer-made-button",Io="ws-crm-mt-offer-made-modal",xn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kn=/\/v2\/location\/([A-Za-z0-9]+)/,He=()=>{let t=window.location.pathname,e=t.match(xn);if(!e)return null;let o=t.match(kn);return{oppId:e[1],locationId:o?o[1]:null}},En=async t=>{let e=await fetch(wn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$e=()=>{document.getElementById(Io)?.remove()},Tn=t=>{$e();let e=document.createElement("div");e.id=Io,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),n=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),a=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&$e()}),i?.addEventListener("click",()=>$e()),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Recording\u2026",a.style.opacity="0.7",i&&(i.disabled=!0);try{let h=await En({oppId:t.oppId,locationId:t.locationId,amount:c,userId:I()});if(!h.ok){n.textContent=h.error??"Something went wrong.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",i&&(i.disabled=!1);return}$e(),t.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",a.disabled=!1,a.textContent="Record Offer",a.style.opacity="1",i&&(i.disabled=!1)}})},Sn=t=>{let e=document.createElement("button");return e.id=$,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=He();!o||!o.locationId||o.oppId!==t||Tn({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},Cn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],In=async()=>{for(let t of Cn)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Pe=!1,yt=async()=>{if(!Pe){Pe=!0;try{await An()}finally{Pe=!1}}},An=async()=>{let t=He();if(!t||!t.locationId){document.getElementById($)?.remove(),document.getElementById(`${$}-wrap`)?.remove(),ce();return}let e=document.getElementById($);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${$}-wrap`)?.remove(),ce());return}e&&(e.remove(),document.getElementById(`${$}-wrap`)?.remove());let o=await In();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=He();if(!n||n.oppId!==t.oppId)return;let i=Sn(t.oppId),a=document.createElement("span");a.id=`${$}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Ln(t.oppId)},de=null,vt=null,ce=()=>{de?.disconnect(),de=null,vt=null},Ln=t=>{if(de&&vt===t)return;ce();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(vt=t,de=new MutationObserver(()=>{let o=He();if(!o||o.oppId!==t){ce();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById($)?.remove(),document.getElementById(`${$}-wrap`)?.remove(),ce();return}document.getElementById($)||yt()}),de.observe(e,{childList:!0,subtree:!0}))},ut=null,_t,Mn=()=>{ut||(ut=new MutationObserver(()=>{_t===void 0&&(_t=window.setTimeout(()=>{_t=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById($);t&&!e&&!Pe&&yt()},300))}),ut.observe(document.body,{childList:!0,subtree:!0}))},Ao=()=>{Mn(),yt()};var Dn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",P="ws-crm-not-interested-button",Fn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$n=/\/v2\/location\/([A-Za-z0-9]+)/,Ne=()=>{let t=window.location.pathname,e=t.match(Fn);if(!e)return null;let o=t.match($n);return{oppId:e[1],locationId:o?o[1]:null}},Pn=async t=>{let e=await fetch(Dn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Hn=t=>{let e=document.createElement("button");return e.id=P,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Ne();if(!o||!o.locationId||o.oppId!==t)return;let r=I(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await Pn({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},On=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Nn=async()=>{for(let t of On)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Oe=!1,xt=async()=>{if(!Oe){Oe=!0;try{await Bn()}finally{Oe=!1}}},Bn=async()=>{let t=Ne();if(!t||!t.locationId){document.getElementById(P)?.remove(),document.getElementById(`${P}-wrap`)?.remove(),he();return}let e=document.getElementById(P);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove(),he());return}e&&(e.remove(),document.getElementById(`${P}-wrap`)?.remove());let o=await Nn();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ne();if(!n||n.oppId!==t.oppId)return;let i=Hn(t.oppId),a=document.createElement("span");a.id=`${P}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Rn(t.oppId)},be=null,wt=null,he=()=>{be?.disconnect(),be=null,wt=null},Rn=t=>{if(be&&wt===t)return;he();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wt=t,be=new MutationObserver(()=>{let o=Ne();if(!o||o.oppId!==t){he();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(P)?.remove(),document.getElementById(`${P}-wrap`)?.remove(),he();return}document.getElementById(P)||xt()}),be.observe(e,{childList:!0,subtree:!0}))},gt=null,ft,Gn=()=>{gt||(gt=new MutationObserver(()=>{ft===void 0&&(ft=window.setTimeout(()=>{ft=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(P);t&&!e&&!Oe&&xt()},300))}),gt.observe(document.body,{childList:!0,subtree:!0}))},Lo=()=>{Gn(),xt()};var zn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",H="ws-crm-reduce-price-button",Mo="ws-crm-reduce-price-modal",qn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Un=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let t=window.location.pathname,e=t.match(qn);if(!e)return null;let o=t.match(Un);return{oppId:e[1],locationId:o?o[1]:null}},Vn=async t=>{let e=await fetch(zn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Be=()=>{document.getElementById(Mo)?.remove()},Wn=t=>{Be();let e=document.createElement("div");e.id=Mo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),n=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),a=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),a?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Be()}),i?.addEventListener("click",()=>{Be()}),a?.addEventListener("click",async()=>{if(!r||!n||!a)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",a.disabled=!0,a.textContent="Reducing\u2026",a.style.opacity="0.7",i&&(i.disabled=!0);try{await Vn({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:I()}),Be(),t.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",a.disabled=!1,a.textContent="Reduce Price",a.style.opacity="1",i&&(i.disabled=!1)}})},jn=(t,e)=>{let o=document.createElement("button");return o.id=H,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ge();!r||!r.locationId||r.oppId!==t||Wn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=s.emeraldGlow,o.style.color=s.emeraldBright,o.style.borderColor=s.emeraldBorder,i&&(i.style.background=s.emerald,i.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",o.style.cssText=L,i&&(i.style.background=s.amber,i.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),o},Kn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yn=async()=>{for(let t of Kn)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Re=!1,St=async()=>{if(!Re){Re=!0;try{await Xn()}finally{Re=!1}}},Xn=async()=>{let t=Ge();if(!t||!t.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),me());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let o=await Yn();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Ge();if(!n||n.oppId!==t.oppId)return;let i=jn(t.oppId,t.locationId),a=document.createElement("span");a.id=`${H}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Jn(t.oppId)},pe=null,Tt=null,me=()=>{pe?.disconnect(),pe=null,Tt=null},Jn=t=>{if(pe&&Tt===t)return;me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Tt=t,pe=new MutationObserver(()=>{let o=Ge();if(!o||o.oppId!==t){me();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}document.getElementById(H)||St()}),pe.observe(e,{childList:!0,subtree:!0}))},kt=null,Et,Zn=()=>{kt||(kt=new MutationObserver(()=>{Et===void 0&&(Et=window.setTimeout(()=>{Et=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);t&&!e&&!Re&&St()},300))}),kt.observe(document.body,{childList:!0,subtree:!0}))},Do=()=>{Zn(),St()};var Po="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",j="ws-crm-send-to-closing-office-button",Z="ws-crm-send-to-title-co-wrap",Ue="ws-crm-stc-dropdown",Qn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ea=/\/v2\/location\/([A-Za-z0-9]+)/,Ve=()=>{let t=window.location.pathname,e=t.match(Qn);if(!e)return null;let o=t.match(ea);return{oppId:e[1],locationId:o?o[1]:null}},ta=5*60*1e3,Ho=t=>`ws-crm-stc-cache:${t}`,oa=t=>{try{let e=window.localStorage.getItem(Ho(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ta||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},ra=(t,e)=>{try{window.localStorage.setItem(Ho(t),JSON.stringify(e))}catch{}},na=async(t,e)=>{try{let o=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},aa=async(t,e,o)=>{let r=await fetch(Po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:I()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},sa=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of o)if((n.textContent?.trim()??"")===t)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===t)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},Fo=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ia=(t,e)=>{if(e&&sa(e)){window.setTimeout(()=>Fo(t),300);return}Fo(t)},O=()=>{document.getElementById(Ue)?.remove()},ze=(t,e,o)=>{O();let r=document.createElement("div");r.id=Ue;let n=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};t.forEach(u=>{h[u.group]||(h[u.group]=[]),h[u.group].push(u)});let m=[...c.filter(u=>h[u]),...Object.keys(h).filter(u=>!c.includes(u))];for(let u of m){let _=h[u],w=document.createElement("div");w.style.cssText="margin-top: 12px;";let y=document.createElement("div");y.style.cssText=`
      font-family: ${v.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${s.steel};
    `,y.textContent=u,w.appendChild(y),_.forEach(g=>{let f=document.createElement("div"),E=!g.filled&&g.navigable&&g.field_id;f.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${x.sm};
        font-size: 12px;
        color: ${g.filled?s.bone:s.ash};
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(f.addEventListener("mouseenter",()=>{f.style.background=s.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",A=>{A.stopPropagation(),g.field_id&&(ia(g.field_id,g.folder),O())}));let T=g.filled?`<span style="color: ${s.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${s.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,k=E?`<span style="margin-left: auto; color: ${s.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${T}<span style="flex: 1;">${g.label}</span>${k}`,w.appendChild(f)}),r.appendChild(w)}document.body.appendChild(r);let p=u=>{let _=u.target;!r.contains(_)&&!o.contains(_)&&(O(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},R=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),n=t.querySelector(".ws-stc-chevron"),i,a,l=s.bone,d,c="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":i="transparent",a=s.steel,l=s.ash,d=s.coolGray,c="Checking\u2026",m="wait",p="0.8";break;case"ready":i=s.emerald,a=s.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(w=>w.filled).length??0,_=e.checks?.length??0;i="transparent",a=s.amber,l=s.amber,d=s.amber,c=`${u} of ${_} fields ready`,h="\u25BE";break}case"sending":i=s.emerald,a=s.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",p="0.8";break;case"sent":i=s.emerald,a=s.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":i="transparent",a=s.amber,l=s.amber,d=s.amber,c=e.message??"Try again";break}t.style.background=i,t.style.borderColor=a,t.style.color=l,t.style.cursor=m,t.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=c),n&&(n.textContent=h)},la=(t,e)=>{let o=document.createElement("button");o.id=j,o.type="button",o.dataset.oppId=t;let r=oa(t),n=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${q}
    background: transparent;
    border: 1px solid ${s.steel};
    color: ${s.ash};
  ...
  `,R(o,n);let i=new Set,a=async()=>{if(n.status==="sending")return;let y=await na(t,e);if(!y){n={status:"error",message:"Check failed \u2014 click to retry"},R(o,n);return}if(y.rate_limited){u=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},R(o,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){n={status:"error",message:y.error||"Check failed \u2014 click to retry"},R(o,n),b.warn("[stc] dry_run returned no checks:",y);return}let g=y.pipeline_name;if(g&&g!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),We.add(t),document.getElementById(j)?.remove(),document.getElementById(Z)?.remove(),O(),_e();return}let f=y.checks;if(n.checks&&n.checks.length===y.checks.length){let T=new Set;f=y.checks.map((k,A)=>n.checks[A]?.filled&&!k.filled?i.has(k.label)?k:(T.add(k.label),{...k,filled:!0}):k),i=T}else i=new Set;n={status:f.every(T=>T.filled)?"ready":"incomplete",checks:f,previouslySentAt:y.previously_sent_at??null},ra(t,{checks:f,previously_sent_at:y.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),R(o,n),document.getElementById(Ue)&&ze(f,y.previously_sent_at,o)},l=async()=>{let y=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},R(o,n),O();try{let g=await aa(t,e,y);if(g.needs_confirm){n={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},R(o,n),g.checks&&ze(g.checks,g.previously_sent_at,o);return}if(g.ok){n={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},R(o,n),window.setTimeout(()=>{_()},3500);return}n={status:"error",checks:g.checks,message:g.error||"Validation failed"},R(o,n),g.checks&&ze(g.checks,g.previously_sent_at,o)}catch(g){b.error("[stc] send failed:",g),n={status:"error",message:"Network error \u2014 click to retry"},R(o,n)}};o.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(Ue)?O():n.checks&&ze(n.checks,n.previouslySentAt,o);break}case"error":case"sent":_();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,u=0,_=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await a()}finally{c=!1}}};_();let w=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(w){let y=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-h,E=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&_()},E)});y.observe(w,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},da=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ca=async()=>{for(let t of da)try{let e=await C(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},We=new Set,$o=null,ba=t=>{t&&t!==$o&&(We.clear(),$o=t)},qe=!1,Lt=async()=>{if(qe){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}qe=!0;try{await ha()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{qe=!1}},ha=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=Ve();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(j)?.remove(),document.getElementById(Z)?.remove(),O();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),ba(t.oppId),We.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(j)?.remove(),document.getElementById(Z)?.remove(),O();return}let e=document.getElementById(j);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Z)?.remove(),O(),_e());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Z)?.remove(),O()),b.debug("[stc] mount:04 calling findMountTarget");let o=await ca();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Ve();if(!n||n.oppId!==t.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=la(t.oppId,n.locationId),a=document.createElement("span");a.id=Z,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),a.appendChild(i),o.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),pa(t.oppId)},ue=null,At=null,_e=()=>{ue?.disconnect(),ue=null,At=null},pa=t=>{if(ue&&At===t)return;_e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(At=t,ue=new MutationObserver(()=>{let o=Ve();if(!o||o.oppId!==t){_e();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(j)?.remove(),document.getElementById(Z)?.remove(),O(),_e();return}document.getElementById(j)||Lt()}),ue.observe(e,{childList:!0,subtree:!0}))},Ct=null,It,ma=()=>{Ct||(Ct=new MutationObserver(()=>{It===void 0&&(It=window.setTimeout(()=>{It=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(j);if(t&&!e&&!qe){let o=Ve();if(o&&We.has(o.oppId))return;Lt()}},300))}),Ct.observe(document.body,{childList:!0,subtree:!0}))},Oo=()=>{ma(),Lt()};var ua="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",_a="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",va="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ro="ldtyB2UXKi9vOp8nLUH7",ya="WVD2gb9swLsgcdBEtDVq",N="ws-crm-closing-agent-picker-button",Go="ws-crm-closing-agent-picker-modal",ga=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fa=/\/v2\/location\/([A-Za-z0-9]+)/,ge=()=>{let t=window.location.pathname,e=t.match(ga);if(!e)return null;let o=t.match(fa);return{oppId:e[1],locationId:o?o[1]:null}},Nt=async t=>{let e=await fetch(ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},No=async t=>{let e=await fetch(_a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},wa=async(t,e)=>{try{let o=await fetch(va,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Ro}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await Nt({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let a=i.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},Q=null,xa=60*60*1e3,Bt=t=>`ws-crm-to-cache:${t}`,zo=t=>{try{let e=window.localStorage.getItem(Bt(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>xa||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},qo=(t,e,o)=>{try{window.localStorage.setItem(Bt(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},ka=t=>{try{window.localStorage.removeItem(Bt(t))}catch{}},$t="ws-crm-closing-agent-field-link",Ea=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${$t}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Mt=!1,Rt=async t=>{if(Mt)return;let e=Uo();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Mt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Nt({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Pt(n.id,n.name,t);let i=document.getElementById(N);if(i){K(i,{status:"linked",contactName:n.name});let a=ge();a&&qo(a.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Mt=!1}}},Ta=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Uo=()=>{let e=document.querySelectorAll("*"),o=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();Ta.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=o[0].parentElement,l=0;for(;a&&l<8;){let d=a.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;a=a.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Pt=(t,e,o)=>{let r=Uo();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==t){n&&r.parentElement?.querySelectorAll(`.${$t}`).forEach(a=>a.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=$t,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${x.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},je=()=>{document.getElementById(Go)?.remove()},Sa=t=>{je();let e=document.createElement("div");e.id=Go,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),n=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&je()}),i?.addEventListener("click",je);let a,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await Nt({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,p.innerHTML=`
          <div style="font-weight: 500;">${Ke(m.name)}</div>
          <div style="color: ${s.ash}; font-size: 11px; margin-top: 2px;">
            ${Ke(m.email||"(no email)")} \xB7 ${Ke(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Ke(m.companyName)}`:""}
          </div>
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{je(),t.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${s.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;a!==void 0&&clearTimeout(a),a=window.setTimeout(()=>{d(c)},250)})},Ke=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),K=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),n="Link Closing Agent",i=s.amber,a=s.bone,l="transparent",d=s.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",i=s.coolGray,a=s.ash,c="wait";break;case"empty":n="Link Closing Agent",i=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,a=s.emeraldBright;break;case"saving":n="Linking\u2026",i=s.coolGray,a=s.ash,c="wait";break}o&&(o.textContent=n),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=a,t.style.cursor=c},Ca=(t,e)=>{let o=document.createElement("button");o.id=N,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};K(o,r);let n=zo(t);return n&&(r={status:"linked",contactName:n.contactName},K(o,r),Q={oppId:t,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await wa(t,e);a?(r={status:"linked",contactName:a.name},K(o,r),Q={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},Pt(a.id,a.name,e)):n||(r={status:"empty"},K(o,r),Q?.oppId===t&&(Q=null),Ea(),ka(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Sa({oppId:t,locationId:e,onPick:async a=>{r={status:"saving"},K(o,r);try{let l=[No({tenantId:e,oppId:t,fieldId:Ro,value:a.id})];a.companyName&&a.companyName.trim()&&l.push(No({tenantId:e,oppId:t,fieldId:ya,value:a.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},K(o,r),Q={oppId:t,contactId:a.id,contactName:a.name,tenantId:e},qo(t,a.id,a.name),Pt(a.id,a.name,e),b.info(`Closing Agent linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},K(o,r)}}})}),o},Ia=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Aa=async()=>{for(let t of Ia)try{let e=await C(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ve=!1,Xe=async()=>{if(!ve){ve=!0;try{await La()}finally{ve=!1}}},La=async()=>{let t=ge();if(!t||!t.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),Ye();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),Ye());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await Aa();if(!r||!(zo(t.oppId)!==null||Q!==null&&Q.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=ge();if(!i||i.oppId!==t.oppId||!i.locationId)return;let a=Ca(t.oppId,i.locationId),l=document.createElement("span");l.id=`${N}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(a),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Ma(t.oppId),Rt(i.locationId)},ye=null,Ht=null,Ot=null,Ye=()=>{ye?.disconnect(),ye=null,Ht=null,Ot=null},Ma=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ye&&Ht===t&&Ot===e||(Ye(),Ht=t,Ot=e,ye=new MutationObserver(()=>{let o=ge();if(!o||o.oppId!==t||!o.locationId){Ye();return}document.getElementById(N)||Xe(),Rt(o.locationId)}),ye.observe(e,{childList:!0,subtree:!0})))},Dt=null,Ft,Da=()=>{Dt||(Dt=new MutationObserver(()=>{Ft===void 0&&(Ft=window.setTimeout(()=>{Ft=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);t&&!e&&!ve&&Xe()},300))}),Dt.observe(document.body,{childList:!0,subtree:!0}))},Bo,Fa=()=>{Bo===void 0&&(Bo=window.setInterval(()=>{let t=ge();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(N)&&!ve&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Xe()),Rt(t.locationId)},2e3))},Vo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Da(),Fa(),Xe()};var $a="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Gt="ws-crm-prepare-contract-button",Wo="ws-crm-prepare-contract-menu",ne="ws-crm-prepare-contract-modal",Je="https://services.leadconnectorhq.com",zt="__WS_CRM_CAPTURED_AUTH",Pa=50*60*1e3,Xo=()=>{try{let t=localStorage.getItem(zt);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Pa?(localStorage.removeItem(zt),null):e:null}catch{return null}},Ha=t=>{try{localStorage.setItem(zt,JSON.stringify(t))}catch{}},Ze=()=>{let t=Xo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o};var jo=t=>t.includes("services.leadconnectorhq.com")&&/\/proposals\//.test(t),Jo=30,Ko=!1,Oa=()=>{if(Ko)return;Ko=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null},t.__WS_CRM_PROPOSAL_CALLS=t.__WS_CRM_PROPOSAL_CALLS||[];let e=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS;for(c.push(d);c.length>Jo;)c.shift();return d};t.__WS_CRM_DUMP_PROPOSAL_CALLS=d=>{let c=t.__WS_CRM_PROPOSAL_CALLS||[],h=d?c.filter(m=>m.url.includes(d)):c;return console.log(`[ws-crm-customizer] ${h.length} proposal calls captured${d?` (filter="${d}")`:""}`),h.forEach((m,p)=>{console.log(`
#${p+1} [${m.source}] ${m.method} ${m.url}`),console.log("  reqBody:",m.reqBody),console.log(`  \u2192 ${m.status??"?"}:`,m.resBody)}),h};let o=(d,c,h)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:d,headers:c,source:h};let m=c.authorization||c.Authorization;if(!m){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${h} no-auth]`,{url:d.split("?")[0],headerKeys:Object.keys(c)});return}h==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let p=c["token-id"]||c["Token-Id"]||void 0,u=Xo()?.authorization;Ha({authorization:m,tokenId:p,capturedAt:Date.now()}),u!==m&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${h}] captured GHL auth from ${d.split("?")[0]} (${m.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...d){let c=typeof d[0]=="string"?d[0]:d[0]instanceof URL?d[0].toString():d[0].url,h=d[1]||{};if(c&&c.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let m=h.headers;!m&&d[0]instanceof Request&&(m=d[0].headers);let p={};if(m instanceof Headers)m.forEach((u,_)=>p[_.toLowerCase()]=u);else if(Array.isArray(m))m.forEach(([u,_])=>p[u.toLowerCase()]=_);else if(m&&typeof m=="object")for(let u of Object.keys(m))p[u.toLowerCase()]=m[u];o(c,p,"fetch")}if(c&&jo(c)){let m=d[0]instanceof Request?d[0]:null,p=(h.method||m?.method||"GET").toUpperCase(),u=null;try{if(h.body!=null)u=typeof h.body=="string"?h.body:h.body instanceof URLSearchParams?h.body.toString():(()=>{try{return JSON.stringify(h.body)}catch{return"(non-serializable body)"}})();else if(m)try{u=await m.clone().text()}catch{}}catch{u=null}let _=e({ts:Date.now(),source:"fetch",method:p,url:c,reqBody:u});return r.apply(this,d).then(async w=>{try{_.status=w.status,_.resBody=await w.clone().text()}catch{}return w})}return r.apply(this,d)};let n=XMLHttpRequest.prototype,i=n.open,a=n.setRequestHeader,l=n.send;n.open=function(d,c,...h){return this.__wsCrmUrl=c,this.__wsCrmMethod=(d||"GET").toUpperCase(),this.__wsCrmHeaders={},i.call(this,d,c,...h)},n.setRequestHeader=function(d,c){return this.__wsCrmHeaders&&typeof d=="string"&&(this.__wsCrmHeaders[d.toLowerCase()]=c),a.call(this,d,c)},n.send=function(d){let c=this.__wsCrmUrl,h=this.__wsCrmMethod,m=this.__wsCrmHeaders;if(c&&c.includes("services.leadconnectorhq.com")&&m&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),c&&jo(c)){let p=null;try{d==null?p=null:typeof d=="string"?p=d:d instanceof URLSearchParams?p=d.toString():p="(non-string body)"}catch{p=null}let u=e({ts:Date.now(),source:"xhr",method:h||"GET",url:c,reqBody:p}),_=this;this.addEventListener("loadend",()=>{try{if(u.status=_.status,_.responseType===""||_.responseType==="text")u.resBody=_.responseText;else try{u.resBody=JSON.stringify(_.response)}catch{u.resBody=`(responseType=${_.responseType})`}}catch{}})}return l.call(this,d)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Zo=()=>{let t=S();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Na=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Ba=async t=>{let e=`${Je}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o=await fetch(e,{method:"GET",headers:Ze()});if(!o.ok){let i="";try{i=await o.text()}catch{}let a=i?` \u2014 ${i.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${a}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:Na(i.name||i.title||"")})).filter(i=>!!i.id)},Ra=async(t,e)=>{let o=await fetch(`${Je}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ze()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let n=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${Je}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ze()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Ga=async t=>{let e=await fetch($a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},za=async(t,e,o)=>{let r=`${Je}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,n=await fetch(r,{method:"POST",headers:Ze()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let i=await n.json(),a=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!a)throw new Error("to-proposal returned no proposal id");return a},qa=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Yo="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(Yo)?.remove();let r=document.createElement("div");r.id=Yo;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Ua=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(ne)?.remove();let n=r.debug||{},i=typeof n.propertyAddress=="string"?n.propertyAddress:"",a=typeof n.sellerName=="string"?n.sellerName:"",l=typeof n.purchasePrice=="number"?n.purchasePrice:0,d=typeof n.emd=="number"?n.emd:0,c=typeof n.cashAtClose=="number"?n.cashAtClose:l-d,h=n.daysToClose===void 0||n.daysToClose===null||n.daysToClose===""?"":String(n.daysToClose),m=n.inspectionDays===void 0||n.inspectionDays===null||n.inspectionDays===""?"":String(n.inspectionDays),p=typeof n.additionalTerms=="string"?n.additionalTerms:"",u=document.createElement("div");u.id=ne,u.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;_.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${f}">
        ...
        <div style="${g}">${G(i||"(set on Property record)")}</div>
      </div>
      <div style="${f}">
        <div style="${w}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${fe(a)}" placeholder="Seller name" style="${y}" />
      </div>
      <div style="${f}">
        <div style="${w}">Purchase Price</div>
        <div style="${E}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-purchase-price" type="number" min="0" step="0.01" value="${l}" style="${y}" />
        </div>
      </div>
      <div style="${f}">
        ...
        <div style="${E}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-emd" type="number" min="0" step="0.01" value="${d}" style="${y}" />
        </div>
      </div>
      <div style="${f}">
        ...
        <div style="${E}">
          <span style="color: ${s.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-cash-at-close" type="number" min="0" step="0.01" value="${c}" style="${y}" />
        </div>
      </div>
      <div style="${f}">
        <div style="${w}">Days to Close</div>
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${fe(h)}" placeholder="e.g. 30" style="${y}" />
      </div>
      <div style="${f}">
        <div style="${w}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${fe(m)}" placeholder="e.g. 10" style="${y}" />
      </div>
      <div style="${f} align-items: flex-start;">
        <div style="${w}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${y} text-align: left; resize: vertical; min-height: 60px; font-family: ${v.sans};">${G(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,u.appendChild(_),document.body.appendChild(u);let T=_.querySelector("#ws-pc-purchase-price"),k=_.querySelector("#ws-pc-emd"),A=_.querySelector("#ws-pc-cash-at-close"),F=!1;A?.addEventListener("input",()=>{F=!0});let ee=()=>{if(F)return;let z=Number(T?.value||0),Te=Number(k?.value||0);A&&(A.value=String(Math.max(0,z-Te)))};T?.addEventListener("input",ee),k?.addEventListener("input",ee);let Kt=()=>u.remove();u.addEventListener("click",z=>{z.target===u&&Kt()}),_.querySelector("#ws-pc-cancel")?.addEventListener("click",Kt);let U=_.querySelector("#ws-pc-submit"),Ee=_.querySelector("#ws-pc-error");U?.addEventListener("click",async()=>{if(U){Ee&&(Ee.textContent=""),U.disabled=!0,U.textContent="Opening\u2026";try{let z=(_.querySelector("#ws-pc-seller-name")?.value||"").trim(),Te=Number(T?.value||0),Yt=Number(k?.value||0),Xt=Number(A?.value||0),Jt=(_.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Zt=(_.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Qt=(_.querySelector("#ws-pc-additional-terms")?.value??"").trim(),B={};if(z!==a&&(B.sellerName=z),Te!==l&&(B.purchasePrice=Te),Yt!==d&&(B.emd=Yt),Xt!==c&&(B.cashAtClose=Xt),Jt!==h&&(B.daysToClose=Jt),Zt!==m&&(B.inspectionDays=Zt),Qt!==p&&(B.additionalTerms=Qt),Object.keys(B).length>0){b.info("[prepare-contract] PA modal submit with overrides:",B),U.textContent="Saving\u2026";let wr=I(),xr=await qt({tenantId:t,contactId:e,template:o,userId:wr,overrides:B});b.info("[prepare-contract] re-stage with overrides ok:",xr),U.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");await Ut(t,e,o)}catch(z){U.disabled=!1,U.textContent="Open Contract",Ee&&(Ee.textContent=z.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",z)}}})},Va=({tenantId:t,contactId:e,template:o,mtOpps:r,userId:n})=>{document.getElementById(ne)?.remove();let i=document.createElement("div");i.id=ne,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        ...
        <input type="hidden" id="ws-pc-opp-id" value="${fe(r[0].id)}" />
      `;let y=r.map(g=>`<option value="${fe(g.id)}">${G(g.propertyAddress||g.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${v.mono};
        font-size: 10px;
  ...
  `,i.appendChild(a),document.body.appendChild(i);let u=()=>i.remove();if(i.addEventListener("click",y=>{y.target===i&&u()}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",u),p)return;let _=a.querySelector("#ws-pc-submit"),w=a.querySelector("#ws-pc-error");_?.addEventListener("click",async()=>{if(!_)return;let y=a.querySelector("#ws-pc-opp-id"),g=(a.querySelector("#ws-pc-closing-date")?.value??"").trim(),f=(a.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(a.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(y?.value||"").trim();if(!T){w&&(w.textContent="Pick a subject property.");return}if(!g){w&&(w.textContent="Closing Date is required.");return}w&&(w.textContent=""),_.disabled=!0,_.textContent="Preparing\u2026";try{await qt({tenantId:t,contactId:e,template:o,oppId:T,closingDate:g,buyerEarnestDueDate:f,lenderSource:E,userId:n}),await Ut(t,e,o),u()}catch(k){_.disabled=!1,_.textContent="Stage & Open Contract",w&&(w.textContent=k.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",k)}})},qt=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ga({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Ut=async(t,e,o)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let r=await za(t,o.id,e);b.info(`[prepare-contract] proposal created with pre-assigned contact: ${r}, redirecting`),qa(t,r)};var Wa=async t=>{let e=Zo();if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(Wo)?.remove();let o=document.createElement("div");o.id=Wo,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=a=>{!o.contains(a.target)&&a.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Ba(e.tenantId)}catch(a){o.innerHTML=`
    ...
    `,o.appendChild(a);let l=document.createElement("button");l.type="button",l.style.cssText=`
      ...
      padding: 8px 14px;
      cursor: pointer;
    `,l.textContent="\u{1F50D} View captured proposal calls",l.addEventListener("mouseenter",()=>{l.style.background=s.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",d=>{d.stopPropagation(),d.preventDefault(),o.remove(),document.removeEventListener("click",r,!0),ja()}),o.appendChild(l)};o.innerHTML="";for(let a of n){let l=document.createElement("button");l.type="button",l.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
    ...
    `;let d=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;l.innerHTML=`
      ...
      </div>`,l.addEventListener("mouseenter",()=>{l.style.background=s.slate}),l.addEventListener("mouseleave",()=>{l.style.background="transparent"}),l.addEventListener("click",async c=>{c.stopPropagation(),c.preventDefault(),b.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),o.remove(),document.removeEventListener("click",r,!0);let h=I();try{if(a.type==="AA"){let m;try{m=await Ra(e.tenantId,e.contactId)}catch(p){Y(`Failed to load buyer's MT opps: ${p.message}`,"error");return}Va({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:m,userId:h})}else if(a.type==="PA"){Y("Reading contract data\u2026","info",2500);let m;try{m=await qt({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:h})}catch(p){Y(`Failed to prepare contract: ${p.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",p);return}Ua({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:m})}else{Y(`Opening ${a.name}\u2026`,"info",2500);try{await Ut(e.tenantId,e.contactId,a)}catch(m){Y(`Failed to open contract: ${m.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){b.warn("[prepare-contract] picker click handler failed:",m),Y(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(l)}i()},ja=async()=>{document.getElementById(ne)?.remove();let t=window,e=t.__WS_CRM_PROPOSAL_CALLS||[],o=e.length===0?"(no proposal calls captured yet \u2014 try navigating to a proposal editor and adding a recipient manually, then re-open this viewer)":e.map((a,l)=>{let d=a.url.includes("?")?a.url.split("?")[1]:"",c=a.url.split("?")[0];return[`\u2500\u2500 #${l+1} ${a.method} ${c}`,d?`   query: ${d}`:"",`   req body: ${a.reqBody||"(empty)"}`,`   \u2192 ${a.status??"?"}: ${a.resBody||"(empty)"}`].filter(Boolean).join(`
`)}).join(`

`),r=document.createElement("div");r.id=ne,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,n.innerHTML=`
    ...
    <div style="
      ...
      font-weight: 500;
      margin-bottom: 4px;
    ">${e.length} call${e.length===1?"":"s"} in buffer (max ${Jo})</div>
    <div style="
      font-size: 12px;
      color: ${s.ash};
      margin-bottom: 14px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=s.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=s.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Wa(t)}),t},Ya="ws-crm-contact-actions-bar",Xa=async()=>{let t=Zo();if(!t){document.getElementById(Gt)?.remove();return}let e=null;try{e=await C(`#${Ya}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Gt);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Ka();r.dataset.contactId=t.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Qo=()=>{Xa()};Oa();function G(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function fe(t){return G(t)}var nt="reos-theme-stylesheet",vr="reos-theme-fonts",Ja=()=>{let t=document.getElementById(vr);t&&t.remove()},Za=`
/* ============================================
...
`,Qa=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],es=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(n))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${n}, ${i})`}return`rgb(${o}, ${r}, ${n})`},ts=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),os=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Vt=new WeakSet,er=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Vt.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let i=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let a=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||a<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Vt.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Vt.add(e)}catch{}})}catch{}},tr=new WeakSet,we=()=>{document.querySelectorAll(os.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(tr.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let a=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let l=+a[1],d=+a[2],c=+a[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),tr.add(r))})})},or=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Qe=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let a=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(a){let l=+a[1],d=+a[2],c=+a[3];(a[4]!==void 0?+a[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},rr=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},xe=()=>{for(let t of Qa){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,n]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),a=o.style.getPropertyValue(r),l=ts.has(r)?es(n):n;i==="important"&&a===l||o.style.setProperty(r,n,"important")}})}},at="#1A1F28",rs=26,ns=31,as=40,nr=new Set,ar=new Set,et=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!ar.has(n)&&n!=="<no class>"&&(ar.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},ss=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],is=["trash","Trash","TRASH","delete","Delete","DELETE"],ls=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,n=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(is.some(i=>n.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(a=>{if(r)return;let l=a.getAttribute("d")||"";ss.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),a=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||a.includes("delete")||a.includes("remove")||a.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},ds=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),cs=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||ds.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},sr=new Set,ir=new WeakSet,bs=()=>{document.body.querySelectorAll("*").forEach(e=>{if(ir.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),ir.add(e);let h=e.className?.toString()||"<no class>";!sr.has(h)&&h!=="<no class>"&&(sr.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},lr=new Set,hs=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let a=(i.className?.toString()||"").toLowerCase();if(a.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,c=l.backgroundImage||"",h=!1;if(c!=="none"&&c.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let k=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(k){let A=parseInt(k[1],10),F=parseInt(k[2],10),ee=parseInt(k[3],10);(A>=60||F>=60||ee>=60)&&(A>230&&F>230&&ee>230||(A>=80||F>=80||ee>=80)&&(h=!0))}}if(!h)return;let p=(i.textContent||"").trim(),u=a,_=Array.from(i.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),w=p.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),y=u.includes("bg-clip-text")||u.includes("text-transparent")||_.includes("bg-clip-text")||_.includes("text-transparent"),g=Array.from(i.querySelectorAll("*")).some(T=>{let k=window.getComputedStyle(T),A=k.getPropertyValue("-webkit-background-clip")||"",F=k.getPropertyValue("background-clip")||"";return A.includes("text")||F.includes("text")});if(w||y||g){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],k=A=>{T.forEach(F=>A.style.removeProperty(F))};k(i),i.querySelectorAll("*").forEach(k);return}let f="#12161D";i.style.setProperty("color",f,"important"),i.querySelectorAll("*").forEach(T=>{let k=T.tagName.toLowerCase();k==="svg"||k==="path"||k==="circle"||k==="rect"||k==="polygon"||k==="polyline"||k==="line"||k==="g"?(T.style.setProperty("fill",f,"important"),T.style.setProperty("stroke",f,"important"),T.style.setProperty("color",f,"important")):(T.style.setProperty("color",f,"important"),T.style.setProperty("-webkit-text-fill-color",f,"important"))});let E=i.className?.toString()||"<no class>";!lr.has(E)&&E!=="<no class>"&&(lr.add(E),b.debug(`Darkened SVG icons on colored button: "${E}"`))})})},dr=new Set,ps=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let _=h.width*h.height/(r.width*r.height);if(_>.55)return;let w=c,y=c.parentElement,g=0;for(;y&&y!==e&&g<3;){let E=y.getBoundingClientRect();if(E.width>0&&E.width<=30&&E.height<=30)w=y;else break;y=y.parentElement,g++}w.style.setProperty("transform","translateY(11px)","important");let f=(w.className?.toString()||"")+" "+w.tagName;dr.has(f)||(dr.add(f),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${_.toFixed(2)}): "${f}"`))})})},ms="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",us=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",ms,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let i=n.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},cr=new Set,_s=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let a=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let l=parseInt(a[1],10),d=parseInt(a[2],10),c=parseInt(a[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!cr.has(h)&&h!=="<no class>"&&(cr.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${c})): "${h}"`))})})},br=new Set,vs=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let n=(o.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let a=o.getBoundingClientRect();if(a.width>0&&a.height>0&&a.width<=400&&a.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!br.has(l)&&l!=="<no class>"&&(br.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},hr=new Set,ys=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(n);if(i.position!=="fixed"&&i.position!=="absolute")return;let a=parseInt(i.zIndex,10);if(!isFinite(a)||a<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(n)}),[...t,...o].forEach(n=>{n.querySelectorAll("*").forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let l=(a.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||a.closest(".sidebar-option-button")||a.closest("nav[class*='w-13']")){let y=a.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(a.style.removeProperty("background-color"),a.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||a.closest("[class*='tabulator']")){(a.getAttribute("style")||"").includes("background-color")&&a.style.removeProperty("background-color");return}if(l.includes("hr-card")||a.closest(".hr-card")||a.id&&a.id.startsWith("opportunity-")){let y=a.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(a.style.removeProperty("background-color"),a.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||a.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(a).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let h=parseInt(c[1],10),m=parseInt(c[2],10),p=parseInt(c[3],10);if(!(h>200&&m>200&&p>200))return;let _=a.getBoundingClientRect();if(_.width<24||_.height<16||_.width>1400)return;a.style.setProperty("background-color","#12161D","important"),a.style.setProperty("color","#EDEEF0","important");let w=a.className?.toString()||"<no class>";!hr.has(w)&&w!=="<no class>"&&(hr.add(w),b.debug(`Coerced light bg (${_.width.toFixed(0)}x${_.height.toFixed(0)}, rgb(${h},${m},${p})): "${w}"`))})})},pr=new Set,gs=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=o.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let n=o,i=null;for(let f=0;f<4&&n;f++){let E=n.nextElementSibling;if(E&&(E.matches(t)||E.querySelector(t)!==null)){i=E;break}n=n.parentElement}if(!i)return;let a=o.getBoundingClientRect();if(a.width===0||a.height===0||a.width>400||a.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),c=l.className?.toString()||"",h=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",u=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);u&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let _=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!u&&!_&&!w&&!y&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",at,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let g=o.className?.toString()||"<no class>";!pr.has(g)&&g!=="<no class>"&&(pr.add(g),b.debug(`Colored field label "${r.slice(0,30)}": "${g}"`))})},mr=new Set,fs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let a=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(a*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!mr.has(d)&&d!=="<no class>"&&(mr.add(d),b.debug(`Resized avatar text to ${l}px (circle ${a.toFixed(0)}px): "${d}"`))})},ur=new Set,ws=new Set(["Enter Dashboard Name"]),xs=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(ws.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",at,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",at,"important"),n.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!ur.has(i)&&i!=="<no class>"&&(ur.add(i),b.debug(`Forced input slate bg: "${i}"`))})},tt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>o.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let i=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let a=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(a<rs&&l<ns&&d<as))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",at,"important");let m=e.className?.toString()||"<no class>";!nr.has(m)&&m!=="<no class>"&&(nr.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${a},${l},${d})): "${m}"`))})},ot=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,h=!1;if(e.forEach(u=>{c.includes(u)&&(c=c.split(u).join(t),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{c.includes(u)&&(c=c.split(u).join("transparent"),h=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(_=>{c.includes(_)&&(c=c.split(_).join("#EDEEF0"),h=!0)}),!!h)try{let u=btoa(c);i.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let a=i.getAttribute("src")||"";if(!a||a.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(a))return;i.setAttribute("data-reos-masked","1");let l=`url("${a}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},rt=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},ks=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},ke=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{t(n),n.querySelectorAll("div, span").forEach(a=>{if(a.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(a).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(a)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",a="rgb(0, 191, 124)",l=c=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",c,"important"),h.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?a:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(a)),r.addEventListener("mouseleave",()=>l(i)))})},Wt=new WeakSet,Es=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Wt.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Wt.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Ae}`,t.title=`Built ${Le}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var D=(t,e)=>{try{b.info(`[main] calling ${t}`),e(),b.info(`[main] ${t} OK`)}catch(o){b.error(`[main:FAIL] ${t} threw:`,o)}},fr=()=>{b.info(`Loaded v${Ae} (built ${Le})`),D("mountVersionBadge (initial)",st),D("mountFavicon",Co),D("mountThemeStylesheet",yr),D("initPageRouter",ro),b.info("[main] registering onPageChange subscriber"),oo(t=>{b.info(`[main] onPageChange callback fired for page=${t}`),D("mountVersionBadge",st),D("mountClaimReleaseToggle",mo),D("mountContactActionsBar",To),D("mountActiveFollowUpButton",co),D("mountMtOfferMadeButton",Ao),D("mountNotInterestedButton",Lo),D("mountReducePriceButton",Do),D("mountSendToClosingOfficeButton",Oo),D("mountClosingAgentPickerButton",Vo),D("mountPrepareContractButton",Qo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fr):fr();})();
