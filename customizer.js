/* Wholesaling CRM Customizer v0.5.31 — built 2026-05-16T15:58:11.067Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var E="[wholesaling-crm-customizer]",ie="__WS_CRM_DEBUG",ce=()=>!!window[ie],d={info(...e){console.log(E,...e)},warn(...e){console.warn(E,...e)},error(...e){console.error(E,...e)},debug(...e){ce()&&console.log(E,"[debug]",...e)}};var H=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},S="",v="other",$=new Set,_=()=>{if(window.location.pathname!==S){S=window.location.pathname,v=H(),d.debug("Page changed:",v,S);for(let e of $)try{e(v)}catch(o){d.error("Subscriber threw:",o)}}},O=e=>($.add(e),setTimeout(()=>e(v),0),()=>{$.delete(e)}),N=()=>{v=H(),S=window.location.pathname,d.debug("Router init, current page:",v);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),_()},history.replaceState=function(t,r,a){o(t,r,a),_()},window.addEventListener("popstate",_),setInterval(_,1e3)};var C="0.5.31",T="2026-05-16T15:58:11.068Z";var de=/\/contacts\/detail\/([A-Za-z0-9]+)/,pe=/\/v2\/location\/([A-Za-z0-9]+)/,f=()=>{let e=window.location.pathname,o=e.match(de);if(!o)return null;let t=e.match(pe);return{contactId:o[1],locationId:t?t[1]:null}};var x=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,c)=>{let s=a.querySelector(e);if(s){n(s);return}let i,m,h=()=>{u&&u.disconnect(),i!==void 0&&window.clearTimeout(i),m!==void 0&&window.clearInterval(m)},u=new MutationObserver(()=>{let p=a.querySelector(e);p&&(h(),n(p))});u.observe(document.body,{childList:!0,subtree:!0}),m=window.setInterval(()=>{let p=a.querySelector(e);p&&(h(),n(p))},r),i=window.setTimeout(()=>{h(),d.warn(`waitForElement timed out for selector: ${e}`),c(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},y={sm:"4px",md:"6px",lg:"10px",pill:"999px"},g={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},F={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},G=e=>{let o=e==="emerald"?l.emeraldGlow:e==="amber"?l.amberGlow:l.slate,t=e==="emerald"?l.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=e==="emerald"?l.emerald:e==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var w="ws-crm-claim-release-pill",U=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ue=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=w,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?l.emerald:l.amber;return t.style.cssText=G(r),t.innerHTML=`
  ...
  `,r.appendChild(t),e.appendChild(r)},he=async()=>{let e=f();if(!e){document.getElementById(w)?.remove();return}let o=document.getElementById(w);if(!(o&&o.dataset.contactId===e.contactId)){o&&o.remove();try{let t=await x("#record-details-lhs",{timeoutMs:1e4}),r=await me(t),a=f();if(!a||a.contactId!==e.contactId)return;if(!r){d.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}z(r,e.contactId),d.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(f()?.contactId===e.contactId)){n?.disconnect();return}if(document.getElementById(w))return;let s=U(t);s&&(z(s,e.contactId),d.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(t,{childList:!0,subtree:!0})}catch(t){d.warn("Could not mount Claim/Release pill:",t)}}},W=()=>{he()};var be="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ge=()=>{let e=window.WS_CRM_USER_ID;if(e&&/^[A-Za-z0-9]{15,30}$/.test(e))return e;let o=window,t=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let c=JSON.parse(n),s=c.id??c._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}catch{}}}catch{}return null},fe=async({contactId:e,locationId:o,status:t,userId:r})=>{let n=await fetch(be,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:e,location:{id:o},customData:{call_status:t,triggered_by_user_id:r??""}}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},L="ws-crm-contact-actions-bar",ye="ws-crm-call-status-dropdown",q="ws-crm-offer-made-modal",ve=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],xe=[".central-panel","[class*='central-panel']"],we=async()=>{for(let e of xe)try{let o=await x(e,{timeoutMs:3e3});if(o)return o}catch{}try{return(await x("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ke=e=>{let o=document.createElement("div");o.id=ye,o.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=B,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var le=()=>{d.info(`Loaded v${C} (built ${T})`),ae(),N(),O(e=>{d.debug("Page handler firing for:",e),se(),W(),j()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",le):le();})();
