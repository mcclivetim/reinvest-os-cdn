/* Wholesaling CRM Customizer v0.23.1 — built 2026-06-03T17:42:30.314Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var _t="[wholesaling-crm-customizer]",Na="__WS_CRM_DEBUG",za=()=>!!window[Na],p={info(...t){console.log(_t,...t)},warn(...t){console.warn(_t,...t)},error(...t){console.error(_t,...t)},debug(...t){za()&&console.log(_t,"[debug]",...t)}};var Ga=/\/v2\/location\/([A-Za-z0-9]+)/,qa=new Set(["8ntUQzMflUkR0YvrRgVk"]),xe=()=>{let t=window.location.pathname.match(Ga);return t?t[1]:null},go=()=>{let t=xe();return t!==null&&qa.has(t)};var Br=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,fo=/\/v2\/location\/([A-Za-z0-9]+)/,Ua=t=>{let e=t.match(Br);if(!e)return null;let o=t.match(fo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Va=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Br);if(!a)continue;let i=r.match(fo)||window.location.pathname.match(fo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},D=()=>{let t=Ua(window.location.pathname);return t||Va()};var Rr=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},gt="",wo=null,ke="other",xo=new Set,yt=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==gt)&&!(t!==wo))){gt=window.location.pathname,wo=t,ke=Rr(),p.debug("Page/context changed:",ke,gt,"contact:",t);for(let r of xo)try{r(ke)}catch(a){p.error("Subscriber threw:",a)}}},ft=t=>(xo.add(t),setTimeout(()=>t(ke),0),()=>{xo.delete(t)}),Nr=()=>{ke=Rr(),gt=window.location.pathname,wo=D()?.contactId??null,p.debug("Router init, current page:",ke);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),yt()},history.replaceState=function(o,r,a){e(o,r,a),yt()},window.addEventListener("popstate",yt),setInterval(yt,1e3)};var wt="0.23.1",xt="2026-06-03T17:42:30.314Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ko={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},zr=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Wa=/^[A-Za-z0-9]{15,30}$/,Re=t=>typeof t=="string"&&Wa.test(t),ja=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ka=()=>{let t=window.WS_CRM_USER_ID;return Re(t)?t:null},Ya=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Re(o))return o;return null},Ja=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ja(e);if(!o)return null;let r=o.uid;if(Re(r))return r;let a=o.claims;if(a&&Re(a.user_id))return a.user_id}catch{}return null},Xa=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Re(a))return a}catch{}}}catch{}return null},I=()=>Ka()||Ya()||Ja()||Xa()||null;var Vr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Qa=`${Vr}/active-follow-up-get`,Za=`${Vr}/active-follow-up-set`,me="ws-crm-active-follow-up-button",To={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ei=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},ti=async t=>{let e=await fetch(Qa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},oi=async(t,e)=>{let o=await fetch(Za,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ue=(t,e)=>{let o=To[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Gr=t=>{let e=document.createElement("button");return e.type="button",e.id=me,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ii(t,e,()=>$o(t,e))}),o},$o=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([mi(t,e),Ao()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Si(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Si=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?_i(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,vi(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}$o(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},At=!1,Jr=(t,e)=>{At=e;let o=Ei(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Ai,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",$o(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Xr,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Xr="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ai="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Ci=t=>{let e=document.createElement("button");return e.id=Yr,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Xr,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${yi.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!At;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Jr(r,a)}),e},Ii=(t,e,o)=>{let r=document.getElementById(jr);r&&r.remove();let a=document.createElement("div");a.id=jr,a.style.cssText=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Mt();!o||!o.locationId||o.oppId!==t||ds({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},ps=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bs=async()=>{for(let t of ps)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$t=!1,Po=async()=>{if(!$t){$t=!0;try{await hs()}finally{$t=!1}}},hs=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je();return}let e=document.getElementById(Q);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je());return}e&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove());let o=await bs();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Mt();if(!a||a.oppId!==t.oppId)return;let i=cs(t.oppId),s=document.createElement("span");s.id=`${Q}-wrap`,s.style.cssText=`
    ...
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ms(t.oppId)},We=null,Ho=null,je=()=>{We?.disconnect(),We=null,Ho=null},ms=t=>{if(We&&Ho===t)return;je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ho=t,We=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t){je();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),je();return}document.getElementById(Q)||Po()}),We.observe(e,{childList:!0,subtree:!0}))},Oo=null,Fo,us=()=>{Oo||(Oo=new MutationObserver(()=>{Fo===void 0&&(Fo=window.setTimeout(()=>{Fo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Q);t&&!e&&!$t&&Po()},300))}),Oo.observe(document.body,{childList:!0,subtree:!0}))},vn=()=>{us(),Po()};var vs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",Z="ws-crm-not-interested-button",_s=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ys=/\/v2\/location\/([A-Za-z0-9]+)/,Ot=()=>{let t=window.location.pathname,e=t.match(_s);if(!e)return null;let o=t.match(ys);return{oppId:e[1],locationId:o?o[1]:null}},gs=async t=>{let e=await fetch(vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},fs=t=>{let e=document.createElement("button");return e.id=Z,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Xt()}),i?.addEventListener("click",Xt);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await fr({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};be(o,r);let a=Jn(t);return a&&(r={status:"linked",contactName:a.contactName},be(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Jl(t,e);s?(r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},_r(s.id,s.name,e)):a||(r={status:"empty"},be(o,r),ge?.oppId===t&&(ge=null),Zl(),Ql(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||td({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},be(o,r);try{let l=[Wn({tenantId:e,oppId:t,fieldId:Kn,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Wn({tenantId:e,oppId:t,fieldId:jl,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Xn(t,s.id,s.name),_r(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},be(o,r)}}})}),o},rd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],nd=async()=>{for(let t of rd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},st=!1,eo=async()=>{if(!st){st=!0;try{await ad()}finally{st=!1}}},ad=async()=>{let t=dt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await nd();if(!r||!(Jn(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await N()!=="Transaction Coordination")return;let i=dt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=od(t.oppId,i.locationId),l=document.createElement("span");l.id=`${re}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),id(t.oppId),xr(i.locationId)},lt=null,yr=null,gr=null,Zt=()=>{lt?.disconnect(),lt=null,yr=null,gr=null},id=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(lt&&yr===t&&gr===e||(Zt(),yr=t,gr=e,lt=new MutationObserver(()=>{let o=dt();if(!o||o.oppId!==t||!o.locationId){Zt();return}document.getElementById(re)||eo(),xr(o.locationId)}),lt.observe(e,{childList:!0,subtree:!0})))},mr=null,ur,sd=()=>{mr||(mr=new MutationObserver(()=>{ur===void 0&&(ur=window.setTimeout(()=>{ur=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!st&&eo()},300))}),mr.observe(document.body,{childList:!0,subtree:!0}))},jn,ld=()=>{jn===void 0&&(jn=window.setInterval(()=>{let t=dt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(re)&&!st&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),eo()),xr(t.locationId)},2e3))},Zn=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),sd(),ld(),eo()};var dd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",$e="ws-crm-manage-team-cta",ta="ws-crm-manage-team-modal",cd=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,oa={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},pd={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ra=()=>{let t=window.location.pathname.match(cd);return t?{tenantId:t[1]}:null},oo=async t=>{let e=await fetch(dd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},J=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),he=t=>J(t),kr="ws-crm-manage-team-toast",Sr=(t,e="info",o=4e3)=>{document.getElementById(kr)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=kr,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(kr)===a&&a.remove()},o)},Er=()=>{document.getElementById(ta)?.remove()},bd=(t,e)=>{let o=pd[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
  ...
  `+t.map(r=>hd(r,e)).join(""),ro=async t=>{Er();let e=document.createElement("div");e.id=ta,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&Er()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Er);let r;try{r=await oo({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{ro(t)}),to(e),setTimeout(()=>to(e),200),setTimeout(()=>to(e),800),window.addEventListener("resize",()=>to(e)),e},Td=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],Sd=async()=>{for(let t of Td)try{let e=await L(t,{timeoutMs:1500});if(e)return e}catch{}return null},Tr=!1,Ad=async()=>{if(!Tr){Tr=!0;try{let t=ra();if(!t){document.getElementById($e)?.remove();return}let e=document.getElementById($e);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await Sd();if(!o){let i=document.createElement("div");i.id=`${$e}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=ea(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),p.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=ea(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),p.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{Tr=!1}}},na=()=>{if(!ra()){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}Ad()};var Cd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ir="ws-crm-prepare-contract-button",aa="ws-crm-prepare-contract-menu",ie="ws-crm-prepare-contract-modal",ia="ws-crm-modal-date-style",le="https://services.leadconnectorhq.com",pa=()=>{if(document.getElementById(ia))return;let t=document.createElement("style");t.id=ia,t.textContent=`
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var P=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Ba=()=>{if(p.info(`Loaded v${wt} (built ${xt})`),go()){p.info(`[main] customizer disabled for excluded location ${xe()} \u2014 bailing`);return}P("mountVersionBadge (initial)",uo),P("mountFavicon",mn),P("mountThemeStylesheet",Ha),P("initPageRouter",Nr),p.info("[main] registering onPageChange subscriber"),ft(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),go()){p.info(`[main] page change into excluded location ${xe()} \u2014 skipping mounts`);return}P("mountVersionBadge",uo),P("mountClaimReleaseToggle",on),P("mountContactActionsBar",bn),P("mountActiveFollowUpButton",Wr),P("mountMtOfferMadeButton",vn),P("mountNotInterestedButton",_n),P("mountResendDealLinkButton",gn),P("mountReducePriceButton",xn),P("mountEditLandingPageButton",kn),P("mountPublishButton",Sn),P("mountContactMapLinks",Mn),P("mountSendToClosingOfficeButton",Pn),P("mountClosingAgentPickerButton",Zn),P("mountPrepareContractButton",_a),P("mountManageTeam",na),P("mountBuyBoxWidget",Qr),P("mountSupportNavItem",Vn)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ba):Ba();})();
