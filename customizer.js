/* Wholesaling CRM Customizer v0.50.0 — built 2026-07-06T20:20:27.305Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Yo="[wholesaling-crm-customizer]",Kc="__WS_CRM_DEBUG",Vc=()=>!!window[Kc],p={info(...t){console.log(Yo,...t)},warn(...t){console.warn(Yo,...t)},error(...t){console.error(Yo,...t)},debug(...t){Vc()&&console.log(Yo,"[debug]",...t)}};var Yc=/\/v2\/location\/([A-Za-z0-9]+)/,Jc=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match(Yc);return t?t[1]:null},_n=()=>{let t=K();return t!==null&&Jc.has(t)};var Cs=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,vn=/\/v2\/location\/([A-Za-z0-9]+)/,Qc=t=>{let e=t.match(Cs);if(!e)return null;let o=t.match(vn);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Zc=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Cs);if(!a)continue;let s=r.match(vn)||window.location.pathname.match(vn);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=Qc(window.location.pathname);return t||Zc()};var As=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Qo="",yn=null,oe="other",gn=new Set,Jo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Qo)&&!(t!==yn))){Qo=window.location.pathname,yn=t,oe=As(),p.debug("Page/context changed:",oe,Qo,"contact:",t);for(let r of gn)try{r(oe)}catch(a){p.error("Subscriber threw:",a)}}},Et=t=>(gn.add(t),setTimeout(()=>t(oe),0),()=>{gn.delete(t)}),Ls=()=>{oe=As(),Qo=window.location.pathname,yn=D()?.contactId??null,p.debug("Router init, current page:",oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Jo()},history.replaceState=function(o,r,a){e(o,r,a),Jo()},window.addEventListener("popstate",Jo),setInterval(Jo,1e3)},ve=()=>oe;var Xc=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Ms=null,Ss=!1,Is=t=>{let e=t.match(Xc);e&&(Ms=e[1])},Ps=()=>{if(!Ss){Ss=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Is(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Is(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},qt=()=>Ms;var Zo="0.50.0",Xo="2026-07-06T20:20:27.306Z";var tp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",tr=new Map,fn=new Map,ep=3e4,Xe=4e3,op=Xe,$t=async(t,e)=>{if(!t)return null;let o=tr.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<ep)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=fn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),op);try{let l=`${tp}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),tr.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let u=(m.contact_type||"").toLowerCase().trim()||null;return tr.set(t,{type:u}),p.debug(`Resolved Contact Type for ${t}: ${u??"(unset)"}`),u}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),tr.set(t,{type:null,failedAt:Date.now()}),null}})();fn.set(t,s);try{return await s}finally{fn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var P=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let u=a.querySelector(t);u&&(m(),s(u))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},xn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Os=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,R=`
  ...
  flex-shrink: 0;
`;var rp=/^[A-Za-z0-9]{15,30}$/,to=t=>typeof t=="string"&&rp.test(t),Bs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},np=()=>{let t=window.WS_CRM_USER_ID;return to(t)?t:null},ap=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(to(o))return o;return null},sp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Bs(e);if(!o)return null;let r=o.uid;if(to(r))return r;let a=o.claims;if(a&&to(a.user_id))return a.user_id}catch{}return null},ip=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(to(a))return a}catch{}}}catch{}return null},H=()=>np()||sp()||ap()||ip()||null,lp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Bs(e);return o?o.claims??o:null}catch{return null}},ye=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:lp()?.type==="agency"};var Fs="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",dp=`${Fs}/active-follow-up-get`,cp=`${Fs}/active-follow-up-set`,re="ws-crm-active-follow-up-button",kn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},pp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},mp=async t=>{let e=await fetch(dp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},bp=async(t,e)=>{let o=await fetch(cp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ne=(t,e)=>{let o=kn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Rs=t=>{let e=document.createElement("button");return e.type="button",e.id=re,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ne(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=pp();if(!(!r||r.contactId!==t)){ne(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await bp(r,H()),s=a&&a.state&&a.state in kn?a.state:"blue";ne(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ne(e,"error"),setTimeout(()=>void or(e,r),4e3)}}}),e},hp=3e4,or=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),ne(t,"loading");try{let o=await mp(e),r=o&&o.state&&o.state in kn?o.state:"gray",a=document.getElementById(re);if(!a||a.dataset.contactId!==e.contactId)return;ne(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,ne(t,"error")}},up=[".central-panel","[class*='central-panel']"],wn="ws-crm-contact-actions-bar",_p=async()=>{for(let t of up)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await P("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},vp=async(t,e)=>{let o=e.querySelector(`#${wn}`);if(!o)try{o=await P(`#${wn}`,{timeoutMs:Xe+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${wn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},yp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},gp=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},fp=async t=>{if(t==="url"){let o=await _p();return o?{kind:"contact-detail",target:o}:null}let e=yp();return e?{kind:"conversations",target:e}:null},Hs=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await vp(t,e.target);return o}return gp(t,e.target),"conversations-header"},xp=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(re);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=hp&&or(o,e);return}o&&o.remove();let r=await fp(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=Rs(e.contactId),i=await Hs(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Ds();let d=document.getElementById(re)??s;or(d,e),er?.disconnect(),er=new MutationObserver(()=>{let l=document.getElementById(re);if(!(D()?.contactId===e.contactId)){er?.disconnect();return}if(!l){let m=Rs(e.contactId);Hs(m,r).then(()=>{Ds(),or(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),er.observe(r.target,{childList:!0})},er=null,eo=null,zs=()=>{let t=D()?.contactId??null;if(eo&&eo.contactId===t)return;let e=xp().finally(()=>{eo?.promise===e&&(eo=null)});eo={contactId:t,promise:e}},Ds=()=>{let t=document.querySelectorAll(`#${re}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var wp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",kp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/callstats/sweep-run",Ns="ws-crm-analytics-launcher",rr="ws-crm-analytics-overlay",Ep=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],$p=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],M={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},V=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},O=t=>(Number(t)||0).toLocaleString("en-US"),En=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},ro=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},Tp=()=>`${M.range}|${M.customStart}|${M.customEnd}`,ae=async(t=!1)=>{let e=Tp();if(!t&&M.cache.has(e)){M.data=M.cache.get(e),M.error=null,se();return}let o=K();if(!o){M.error="Could not resolve the sub-account id from the URL.",se();return}M.loading=!0,M.error=null,se();try{let r={tenant_id:o,range:M.range,tz_offset_minutes:new Date().getTimezoneOffset()};M.range==="custom"&&(r.start=M.customStart,r.end=M.customEnd);let a=await fetch(wp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);M.data=s,M.cache.set(e,s)}catch(r){M.error=r instanceof Error?r.message:String(r)}finally{M.loading=!1,se()}},L=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},rt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ao=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${v.lg};padding:16px 18px;min-width:0;`,$n=`font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=L("div",ao+"flex:1;min-width:150px;");return r.appendChild(L("div",$n+"margin-bottom:8px;",rt(t))),r.appendChild(L("div",`font-family:${h.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,rt(e))),o&&r.appendChild(L("div",`font-family:${h.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,rt(o))),r},Y=(t,e)=>{let o=L("div",ao);if(o.appendChild(L("div",$n,rt(t))),!e.length)return o.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=L("div","margin:0 0 10px;"),i=L("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(L("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,rt(a.label)));let d=L("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,rt(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${rt(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=L("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(L("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(L("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},nr=(t,e,o)=>{let r=L("div",ao+"overflow-x:auto;");if(r.appendChild(L("div",$n,rt(t))),!o.length)return r.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${rt(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${rt(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(L("div","",i)),r},Z=(t,e)=>{let o=L("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},no=t=>{let e=L("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Ot=t=>(t||[]).map(e=>({label:e.label,primary:O(e.count),barVal:e.count})),Cp=t=>(t||[]).map(e=>({label:e.label,primary:V(e.sum),secondary:`\xB7 ${O(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),qs=(t,e)=>{let o=t.calls||{};if(!o.available)return[L("div",`${ao}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${rt(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=e==="acq"?"Seller":"Buyer",a=o[e]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${O(c.connects)} connected \xB7 ${O(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:ro(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${ro(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[Y(`${r} calls per rep (dials)`,s),Y(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(Y("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${ro(c.talk_seconds)} talk`,barVal:c.dials})))),d},Ap=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(no([dt("Closed revenue \u2014 365d",V(o.closed_revenue_365),`${O(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",V(o.avg_deal_size_365)),dt("Left to close this month",V(r.sum),`${O(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${O(r.missing_est_close)} missing est. close date`:"")),dt("New leads",O(o.total_leads),"in selected range")])),e.appendChild(no([dt("Contracts",`${O((o.contracts||{}).count)}`,V((o.contracts||{}).sum)+" projected"),dt("Assignments",`${O((o.assignments||{}).count)}`,V((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${O((o.closed||{}).count)}`,V((o.closed||{}).sum)+" closed")])),e.appendChild(Z("1fr 1fr 1fr",[Y("New leads by source",Ot(o.new_leads_by_source)),Y("Contacts per closer (all time)",Ot(o.contacts_per_closer)),Y("Dispo deals per rep (all time)",Ot(o.dispo_deals_per_rep))]))},Lp=(t,e)=>{let o=t.acq||{};e.appendChild(Z("1fr 1fr",[Y("Offers made per rep",Ot(o.offers_per_rep)),Y("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} projected`,barVal:a.count})))])),e.appendChild(Z("1fr 1fr",[Y("Projected revenue per closer (open escrows)",Cp(o.projected_per_closer)),Y("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=qs(t,"acq");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Sp=(t,e)=>{let o=t.dispo||{};e.appendChild(Z("1fr 1fr",[Y("Buyers qualified per dispo rep",Ot(o.buyers_qualified_per_rep)),Y("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(Z("1fr",[Y("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=qs(t,"dispo");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Ip=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(no([dt("Open leads",O(r.open)),dt("Won (under contract+)",O(r.won)),dt("Lost / dead",O(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[nr("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[nr("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(Z("1fr 1fr",[Y("Dead leads by channel",Ot(o.dead_by_channel)),Y("Dead leads by city",Ot(o.dead_by_city))]))},Mp=(t,e)=>{let o=t.tc||{};e.appendChild(no([dt("Contracted",O(o.contracted),"in selected range"),dt("Closed",O(o.closed)),dt("Lost in escrow",O(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(Z("1fr 1fr",[Y("Deals per TC (contracted in range)",Ot(o.per_tc)),Y("Open escrows by stage",Ot(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,V(a.value),En(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(Z("1fr",[nr("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Pp=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(no([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${O(r.offers)} offers \xB7 ${O(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${O(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(Z("1fr 1fr",[Y("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Y("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,O(d.leads),O(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(Z("1fr",[nr("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${ro(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${ro(l.talk_seconds)} total \xB7 ${O(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(Z("1fr",[Y("Talk time per contract per rep",d)]))}else e.appendChild(L("div",`${ao}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${rt(i.note||"")}`))},oo=t=>`padding:5px 12px;border-radius:${v.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${h.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,se=()=>{let t=document.getElementById(rr);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=L("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let _ of Ep){let b=L("button",oo(M.range===_.key),rt(_.label));b.onclick=()=>{M.range=_.key,_.key!=="custom"?ae():se()},r.appendChild(b)}if(M.range==="custom"){let _=`background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,b=L("input",_);b.type="date",b.value=M.customStart;let g=L("input",_);g.type="date",g.value=M.customEnd;let x=L("button",oo(!0),"Apply");x.onclick=()=>{M.customStart=b.value,M.customEnd=g.value,M.customStart&&M.customEnd&&ae()},r.appendChild(b),r.appendChild(g),r.appendChild(x)}let a=L("button",oo(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ae(!0),r.appendChild(a),o.appendChild(r);let s=L("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let _ of $p){let b=L("button",oo(M.tab===_.key),rt(_.label));b.onclick=()=>{M.tab=_.key,se()},s.appendChild(b)}if(o.appendChild(s),e.innerHTML="",M.loading){e.appendChild(L("div",`padding:60px;text-align:center;color:${n.ash};font-family:${h.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(M.error){let _=L("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${h.sans};font-size:13px;`,`Couldn't load analytics: ${rt(M.error)}`),b=L("button",oo(!0)+"margin:14px auto 0;display:inline-block;","Retry");b.onclick=()=>void ae(!0);let g=L("div","text-align:center;");g.appendChild(_),g.appendChild(b),e.appendChild(g);return}let i=M.data;if(!i){ae();return}let d=i.range||{},l=Number((i.calls||{}).last_swept)||0,c=l>0?` \xB7 calls as of ${new Date(l).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})} (syncing)`:"";e.appendChild(L("div",`font-family:${h.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${rt(d.label||"")} \xB7 ${En(d.start)} \u2192 ${En(d.end)} \xB7 ${O((i.meta||{}).opps)} opps \xB7 ${O((i.meta||{}).contacts)} contacts${c}`));let m=i.insights||[];if(m.length){let _=L("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let b of m.slice(0,6)){let g=b.level==="warn";_.appendChild(L("div",`padding:8px 12px;border-left:3px solid ${g?n.amber:n.blue};background:${g?n.amberGlow:n.blueGlow};border-radius:0 ${v.sm} ${v.sm} 0;font-family:${h.sans};font-size:12px;color:${n.bone};`,rt(b.text)))}e.appendChild(_)}let u=L("div","");M.tab==="company"?Ap(i,u):M.tab==="acq"?Lp(i,u):M.tab==="dispo"?Sp(i,u):M.tab==="marketing"?Ip(i,u):M.tab==="tc"?Mp(i,u):Pp(i,u),e.appendChild(u)},ie=null,Op=()=>{let t=K();if(t){try{fetch(kp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mode:"sync",tenant_id:t})}).catch(()=>{})}catch{}ie&&window.clearTimeout(ie),ie=window.setTimeout(()=>{ie=null,M.open&&(M.cache.clear(),ae(!0))},9e4)}},Bp=()=>{if(document.getElementById(rr))return;M.open=!0,Op();let t=L("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${h.sans};`);t.id=rr;let e=L("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=L("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(L("div",`font-family:${h.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=L("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${v.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=js,o.appendChild(r),e.appendChild(o),e.appendChild(L("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=L("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",Us),se(),M.data||ae()},Us=t=>{t.key==="Escape"&&js()},js=()=>{M.open=!1,ie&&(window.clearTimeout(ie),ie=null),document.getElementById(rr)?.remove(),document.removeEventListener("keydown",Us)},Ws=()=>{let t=window.location.pathname.includes("/dashboard"),e=document.getElementById(Ns);if(!t){e?.remove();return}if(e)return;let o=L("button",`position:fixed;bottom:52px;right:16px;z-index:99990;display:inline-flex;align-items:center;gap:8px;padding:9px 16px;background:${n.emerald};color:${n.obsidian};border:none;border-radius:${v.pill};font-family:${h.mono};font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;cursor:pointer;box-shadow:0 8px 24px rgba(15,181,126,0.35);`,"\u25A6 Analytics");o.id=Ns,o.onclick=Bp,document.body.appendChild(o),p.debug("[analytics] launcher mounted")};var Vs="ws-buybox-nav-icon",An="ws-buybox-panel",Gs="ws-buybox-modal",Rp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Ln="https://mcclivetim.github.io/reinvest-os-cdn/geo",ar=null,so=null,io=null,Cn=async()=>{if(ar)return ar;try{let t=await fetch(`${Ln}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return ar=await t.json(),ar}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},Hp=async t=>{if(!so)try{let e=await fetch(`${Ln}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);so=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return so?.[t]??[]},Dp=async t=>{if(!io)try{let e=await fetch(`${Ln}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);io=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return io?.[t]??[]},Sn=async t=>await(await fetch(Rp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Fp=(t,e)=>Sn({tenant_id:t,action:"list",buyer_contact_id:e}),zp=(t,e,o,r)=>Sn({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Np=(t,e)=>Sn({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),qp=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Up='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',jp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Wp="nav.w-13, nav[class*='w-13']",Gp=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Kp=async()=>{try{return await P(Wp,{timeoutMs:2500})}catch{return null}},Vp=async()=>{try{return await P(Gp,{timeoutMs:2500})}catch{return null}},Yp=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Jp=(t,e)=>{let o=document.createElement("div");return o.id=An,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{tm(t,e,()=>In(t,e))}),o},In=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Fp(t,e),Cn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Qp(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Qp=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let u=l.key==="state"?qp(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Np(r,c).then(u=>{if(!u.ok){alert(`Failed to remove: ${u.error||"unknown error"}`),l.disabled=!1;return}In(r,a)}).catch(u=>{alert(`Network error: ${u.message}`),l.disabled=!1}))})})},sr=!1,Ys=(t,e)=>{sr=e;let o=Yp(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Zp,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",In(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Js,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Js="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Zp="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Xp=t=>{let e=document.createElement("button");return e.id=Vs,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Js,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Up.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!sr;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Ys(r,a)}),e},tm=(t,e,o)=>{let r=document.getElementById(Gs);r&&r.remove();let a=document.createElement("div");a.id=Gs,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await Cn();s.innerHTML=u(w),_(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let w=await Cn();s.innerHTML=g(w),x(w)}else i.granularity==="county"?(s.innerHTML=b(i.stateCode||""),await Hp(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=b(i.stateCode||""),await Dp(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,g=w=>{let E=w.find(S=>S.code===i.stateCode);return`
    ...
    `},x=w=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>T(i.stateCode||""))},k=w=>{let E=i.granularity==="county"?so?.[i.stateCode||""]??[]:io?.[i.stateCode||""]??[];return`
    ...
    `},y=()=>{let w=i.granularity==="county"?so?.[i.stateCode||""]??[]:io?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),S=s.querySelector("#ws-buybox-value-list");if(!E||!S)return;let B=j=>{let U=j.toLowerCase().trim();if(!U){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}S.innerHTML=W.map(N=>`
  ...
  `,$=()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),w.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),A())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>w.focus(),0))},A=async()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),S=(w?.value||"").trim();if(!/^\d{5}$/.test(S)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(S)},T=async w=>{if(!i.granularity||!w)return;let E=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),E&&(E.textContent="");try{let B=await zp(t,e,i.granularity,w);if(!B.ok){E&&(E.textContent=B.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(B){E&&(E.textContent=`Network error: ${B.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},Tn=!1,ge=null,lo=null,Ks=()=>{document.getElementById(Vs)?.remove(),document.getElementById(An)?.remove(),lo&&ge&&ge.nav.removeEventListener("click",lo,!0),lo=null,ge=null,sr=!1},Qs=()=>{em()},em=async()=>{if(!Tn){Tn=!0;try{let t=D();if(!t){Ks();return}let e=document.getElementById(An);if(e&&e.dataset.buyerContactId===t.contactId&&ge)return;Ks();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(u){p.warn("[buy-box] Contact Type fetch failed",u);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([Kp(),Vp()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Jp(t.locationId,t.contactId),l=Xp(()=>ge),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};ge=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),lo=u=>{let _=u.target;if(!_||c.iconBtn.contains(_))return;_.closest("button.sidebar-option-button")&&sr&&Ys(c,!1)},a.addEventListener("click",lo,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Tn=!1}}};var ti="ws-properties-nav-icon",Bn="ws-properties-panel",Zs="ws-properties-modal",Rn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",om=`${Rn}/list-for-contact`,rm=`${Rn}/create-with-opp`,nm=`${Rn}/add-contact`,am=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),sm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,ei=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},ir=t=>{let e=ei(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},Mn=t=>{let e=ei(t);return e===null?"&mdash;":e.toLocaleString()},oi={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},im=t=>{let e=(t||"").toString().trim();return e?mt(oi[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},lm=t=>{let e=(t||"").toString().trim();return e?oi[e]||e:""},dm={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},cm=t=>{let e=(t||"").toString().trim();return e?dm[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Ut=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,pm=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Ut("Baths",Mn(t.baths))}
    ${Ut("Sq Ft",Mn(t.sqft))}
    ${Ut("Rehab",im(t.rehab_level),lm(t.rehab_level))}
    ${Ut("ARV",ir(t.arv))}
    ${Ut("IMV",ir(t.imv))}
    ${Ut("MAO",ir(t.mao))}
    ${Ut("Ask",ir(t.asking_price))}
  </div>`,ri=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},mm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',bm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',hm="nav.w-13, nav[class*='w-13']",um=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ni="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",_m="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",vm=async()=>{try{return await P(hm,{timeoutMs:2500})}catch{return null}},ym=async()=>{try{return await P(um,{timeoutMs:2500})}catch{return null}},Hn=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),Ct=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:13px;outline:none;margin-bottom:10px;`,At=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,Dn=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${h.sans};font-size:13px;font-weight:600;`,ai=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${h.sans};font-size:13px;`,gm=(t,e)=>{let o=document.createElement("div");return o.id=Bn,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${Dn}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{xm(t,e,()=>Fn(t,e))}),o},Fn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Hn(om,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}fm(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},fm=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${mt(c||"")}${a.property_type?" &middot; "+mt(cm(a.property_type)):""}</div>
        ${pm(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${mt(a.property_record_id)}" data-addr="${mt(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${h.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${bm} Add person</button>
        </div>
      </div>
    `}).join(""),t.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{wm(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>Fn(o,r))})}),t.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(sm(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},si=()=>{document.getElementById(Zs)?.remove();let t=document.createElement("div");t.id=Zs,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let e=document.createElement("div");return e.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,t.appendChild(e),document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()}),{overlay:t,card:e}},xm=(t,e,o)=>{let{overlay:r,card:a}=si();a.innerHTML=`
    ...
    <select id="wp-type" style="${Ct}">
      ...
      ${am.map(i=>`<option value="${mt(i)}">${mt(i)}</option>`).join("")}
    </select>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wp-save" type="button" style="${Dn}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=b=>(a.querySelector(b)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),u=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let _=a.querySelector("#wp-save");_&&(_.disabled=!0,_.textContent="Creating\u2026"),s&&(s.textContent="");try{let b=await Hn(rm,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:u||void 0});if(!b.ok){s&&(s.textContent=b.error||"Failed to create property."),_&&(_.disabled=!1,_.textContent="Create property + deal");return}r.remove(),ri("Property + deal created \u2713"),o()}catch(b){s&&(s.textContent=`Network error: ${b.message}`),_&&(_.disabled=!1,_.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},wm=(t,e,o,r)=>{let{overlay:a,card:s}=si();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wpp-save" type="button" style="${Dn}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=g=>(s.querySelector(g)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),u=l("#wpp-phone"),_=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let b=s.querySelector("#wpp-save");b&&(b.disabled=!0,b.textContent="Adding\u2026"),i&&(i.textContent="");try{let g=await Hn(nm,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:u||void 0,email:_||void 0}});if(!g.ok){i&&(i.textContent=g.error||"Failed to add person."),b&&(b.disabled=!1,b.textContent="Add person");return}a.remove(),ri("Person added \u2713"),r()}catch(g){i&&(i.textContent=`Network error: ${g.message}`),b&&(b.disabled=!1,b.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},lr=!1,ut=null,Pn=!1,co=null,km=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},Em=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},On=(t,e)=>{lr=e,e?(t.iconBtn.className=_m,t.iconBtn.dataset.active="true",Em(),km(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",Fn(t.tenantId,t.contactId)):(t.iconBtn.className=ni,delete t.iconBtn.dataset.active,t.panel.style.display="none")},$m=()=>{let t=document.createElement("button");return t.id=ti,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=ni,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${mm.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ut&&On(ut,!lr)}),t},Xs=()=>{document.getElementById(ti)?.remove(),document.getElementById(Bn)?.remove(),co&&ut&&ut.nav.removeEventListener("click",co,!0),co=null,ut=null,lr=!1},ii=()=>{Tm()},Tm=async()=>{if(!Pn){Pn=!0;try{let t=D();if(!t||!t.locationId){Xs();return}let e=document.getElementById(Bn);if(e&&e.dataset.contactId===t.contactId&&ut)return;Xs();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Tt(o)!=="seller")return;let[a,s]=await Promise.all([vm(),ym()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=gm(t.locationId,t.contactId),l=$m();ut={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ut&&On(ut,!1)}),co=m=>{let u=m.target;!u||ut&&ut.iconBtn.contains(u)||u.closest("button.sidebar-option-button")&&lr&&ut&&On(ut,!1)},a.addEventListener("click",co,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{Pn=!1}}};var li="ws-non-seller-contact",di=()=>{Cm()},Cm=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(li);return}let e="seller";try{e=Tt(await $t(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(li,e!=="seller")};var jt="ws-crm-claim-release-pill",Am="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Lm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Sm=async t=>{let e=await fetch(Am,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Im=async t=>{let e=await fetch(Lm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},mi=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},xe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Os(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Mm=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=jt,o.type="button",o.dataset.contactId=t,xe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=H();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>xe(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";xe(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await Im({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;xe(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),xe(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},ci=async t=>{try{let e=await Sm({contactId:t.contactId,locationId:t.locationId,userId:H()}),o=document.getElementById(jt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";xe(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},Pm=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=mi(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},pi=(t,e)=>{let o=Mm({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${jt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},fe=null,Om=async()=>{let t=D();if(!t){fe?.disconnect(),fe=null,document.getElementById(jt)?.remove();return}let e=document.getElementById(jt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await P("#record-details-lhs",{timeoutMs:1e4}),r=await Pm(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}pi(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(jt)&&t.locationId&&ci({contactId:t.contactId,locationId:t.locationId}),fe?.disconnect(),fe=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){fe?.disconnect();return}if(document.getElementById(jt))return;let d=mi(o);d&&(pi(d,t.contactId),document.getElementById(jt)&&t.locationId&&ci({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),fe.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},bi=()=>{Om()};var fi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Bm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",Rm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Hm=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||fi,l;if(i==="buyer"){let m=ki.find(_=>_.label===o),u=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:u,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Dm=async({contactId:t,tenantId:e})=>{let o=await fetch(Rm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},we="ws-crm-contact-actions-bar",xi="ws-crm-call-status-dropdown",wi="ws-crm-call-status-menu",cr="ws-crm-offer-made-modal",hi=!1,Fm=()=>{hi||(hi=!0,document.addEventListener("click",t=>{let e=document.getElementById(wi);if(!e||e.style.display==="none")return;let o=document.getElementById(xi);o&&!o.contains(t.target)&&(e.style.display="none")}))},zm=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],ki=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Nm=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],qm=async()=>{for(let t of Nm)try{let e=await P(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await P("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Um=({contactId:t,kind:e})=>{let o=e==="buyer"?ki:zm,r=e==="buyer"?Bm:fi,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=xi,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=R,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=wi,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${xn[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,u=i.children[1],_=i.children[2];m&&(m.style.background=xn[l.color]),u&&(u.textContent=l.label),d.style.display="none";let g=D()?.locationId,x=H();if(!g){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),u&&(u.textContent=`${l.label} (no tenant!)`),u&&(u.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!x){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),u&&(u.textContent=`${l.label} (no user!)`),u&&(u.style.color=n.amber);return}let k=_?.textContent??"\u25BE",y=async f=>{_&&(_.textContent="\u2026"),i.style.opacity="0.75";try{await Hm({contactId:t,locationId:g,status:l.label,userId:x,deadReason:f,webhookUrl:r,kind:e}),_&&(_.textContent="\u2713"),setTimeout(()=>{_&&(_.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),_&&(_.textContent="\u2717"),u&&(u.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{_&&(_.textContent=k),u&&(u.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let f=u?.textContent??"";Ym($=>{y($)},()=>{u&&(u.textContent=f)});return}if(e==="seller"&&l.value==="appointment-booked"){let f=u?.textContent??"";try{(await Dm({contactId:t,tenantId:g})).ok?await y():Jm(()=>{y()},()=>{u&&(u.textContent=f)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Fm(),s.appendChild(i),s.appendChild(d),s},jm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Wm=async t=>{let e=await fetch(jm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Gm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",Nn=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Km=async(t,e)=>{let o=await fetch(Gm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},Vm=t=>new Promise(e=>{document.getElementById(cr)?.remove();let o=document.createElement("div");o.id=cr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${h.sans};">
        <div style="font-size:14px;font-weight:500;">${Nn(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${Nn(i.dealStage)}</div>`:""}
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),u=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",_=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${Nn(o.address)}</strong></div>`:"",b=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",g=r&&o&&o.propertyRecordId?`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},vi=(t,e)=>{let o=document.createElement("div");if(o.id=we,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=R,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){po(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){po(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await Km(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),po(t,e);return}if(d(),l.length<=1){po(t,e,l[0]);return}let c=await Vm(l);c&&po(t,e,c)}),o.appendChild(r),o.appendChild(Um({contactId:t,kind:e}))}return o},zn=!1,yi=()=>{document.querySelectorAll(`[id="${we}"]`).forEach(t=>t.remove())},Ei=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),zn){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}zn=!0;try{await Qm()}finally{zn=!1}},Qm=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),yi();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),yi();return}let e="seller";try{let l=await $t(t.contactId,t.locationId),c=Tt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${we}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await qm();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=vi(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(we)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),dr?.disconnect(),dr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){dr?.disconnect();return}let c=document.querySelectorAll(`[id="${we}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,u=vi(t.contactId,e);u.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(u,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),dr.observe(a,{childList:!0})},dr=null,gi=null,Zm=()=>{gi===null&&(gi=window.setInterval(()=>{let t=D();t&&(document.getElementById(we)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ei()))},3e3))},$i=()=>{Zm(),Ei()};var pr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Xm=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),mo="data-ws-crm-favicon",qn=t=>t.hasAttribute(mo),Ti=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Xm.has(e)},mr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ti(r)&&!qn(r)&&r.remove()});let e=document.head.querySelector(`link[${mo}="1"]`);e?e.href!==pr&&(e.href=pr):(e=document.createElement("link"),e.setAttribute(mo,"1"),e.rel="icon",e.type="image/png",e.href=pr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${mo}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(mo,"apple"),o.rel="apple-touch-icon",o.href=pr,document.head.appendChild(o))},Ci=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)mr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),mr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ti(i)&&!qn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&qn(i)&&(a=!0)});a&&mr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,mr(),e>=5&&window.clearInterval(o)},1e3)};var tt=".crm-opportunities-modal .ui-modal-heading .description",Ai=new Map,Un=null,jn,tb=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Ai){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},J=(t,e,o)=>{Ai.set(t,{selector:e,cb:o}),!Un&&(Un=new MutationObserver(()=>{jn===void 0&&(jn=window.setTimeout(()=>{jn=void 0,tb()},300))}),Un.observe(document.body,{childList:!0,subtree:!0}))};var eb=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ob=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,rb=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let t=document.querySelector(rb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(ob);if(a){let s=a[1];if(eb.includes(s))return s}}return null},et=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Li="ws-crm-dispo-action-row",Q=t=>{let e=document.getElementById(Li);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Li,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var nb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",yt="ws-crm-mt-offer-made-button",Si="ws-crm-mt-offer-made-modal",ab=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sb=/\/v2\/location\/([A-Za-z0-9]+)/,ur=()=>{let t=window.location.pathname,e=t.match(ab),o=e?e[1]:qt();if(!o)return null;let r=t.match(sb);return{oppId:o,locationId:r?r[1]:null}},ib=async t=>{let e=await fetch(nb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},br=()=>{document.getElementById(Si)?.remove()},lb=t=>{br();let e=document.createElement("div");e.id=Si,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),s=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&br()}),s?.addEventListener("click",()=>br()),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l||Number(l)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(l);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{let m=await ib({oppId:t.oppId,locationId:t.locationId,amount:c,userId:H()});if(!m.ok){a.textContent=m.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1);return}br(),t.onSuccess()}catch(m){p.error("MT Offer Made webhook failed",m),a.textContent=m instanceof Error?m.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1)}})},db=t=>{let e=document.createElement("button");return e.id=yt,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ur();!o||!o.locationId||o.oppId!==t||lb({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=R)},4e3)}})}),e},cb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],pb=async()=>{for(let t of cb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},hr=!1,Gn=async()=>{if(!hr){hr=!0;try{await mb()}finally{hr=!1}}},mb=async()=>{let t=ur();if(!t||!t.locationId){document.getElementById(yt)?.remove(),document.getElementById(`${yt}-wrap`)?.remove(),ho();return}let e=document.getElementById(yt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${yt}-wrap`)?.remove(),ho());return}e&&(e.remove(),document.getElementById(`${yt}-wrap`)?.remove());let o=await pb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ur();if(!a||a.oppId!==t.oppId)return;let s=db(t.oppId),i=document.createElement("span");i.id=`${yt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),bb(t.oppId)},bo=null,Wn=null,ke,ho=()=>{bo?.disconnect(),bo=null,Wn=null,ke!==void 0&&(window.clearTimeout(ke),ke=void 0)},bb=t=>{if(bo&&Wn===t)return;ho();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wn=t,bo=new MutationObserver(()=>{ke===void 0&&(ke=window.setTimeout(()=>{ke=void 0;let o=ur();if(!o||o.oppId!==t){ho();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(yt)?.remove(),document.getElementById(`${yt}-wrap`)?.remove(),ho();return}document.getElementById(yt)||Gn()},250))}),bo.observe(e,{childList:!0,subtree:!0}))},hb=()=>{J("mt-offer-made",tt,()=>{!document.getElementById(yt)&&!hr&&Gn()})},Ii=()=>{hb(),Gn()};var ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",gt="ws-crm-not-interested-button",_b=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vb=/\/v2\/location\/([A-Za-z0-9]+)/,vr=()=>{let t=window.location.pathname,e=t.match(_b),o=e?e[1]:qt();if(!o)return null;let r=t.match(vb);return{oppId:o,locationId:r?r[1]:null}},yb=async t=>{let e=await fetch(ub,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},gb=t=>{let e=document.createElement("button");return e.id=gt,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=vr();if(!o||!o.locationId||o.oppId!==t)return;let r=H(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await yb({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},fb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],xb=async()=>{for(let t of fb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_r=!1,Vn=async()=>{if(!_r){_r=!0;try{await wb()}finally{_r=!1}}},wb=async()=>{let t=vr();if(!t||!t.locationId){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),_o();return}let e=document.getElementById(gt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove(),_o());return}e&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove());let o=await xb();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=vr();if(!a||a.oppId!==t.oppId)return;let s=gb(t.oppId),i=document.createElement("span");i.id=`${gt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),kb(t.oppId)},uo=null,Kn=null,_o=()=>{uo?.disconnect(),uo=null,Kn=null},kb=t=>{if(uo&&Kn===t)return;_o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kn=t,uo=new MutationObserver(()=>{let o=vr();if(!o||o.oppId!==t){_o();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),_o();return}document.getElementById(gt)||Vn()}),uo.observe(e,{childList:!0,subtree:!0}))},Eb=()=>{J("not-interested",tt,()=>{!document.getElementById(gt)&&!_r&&Vn()})},Mi=()=>{Eb(),Vn()};var $b="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",_t="ws-crm-schedule-walkthrough-button",Yn="ws-crm-schedule-walkthrough-modal",Tb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Cb=/\/v2\/location\/([A-Za-z0-9]+)/,fr=()=>{let t=window.location.pathname,e=t.match(Tb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Cb);return{oppId:o,locationId:r?r[1]:null}},yr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Ab=(t,e)=>{document.getElementById(Yn)?.remove();let o=document.createElement("div");o.id=Yn,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Yn} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=fr();!o||!o.locationId||o.oppId!==t||Ab(o.oppId,o.locationId)}),e},Sb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ib=async()=>{for(let t of Sb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},gr=!1,Qn=async()=>{if(!gr){gr=!0;try{await Mb()}finally{gr=!1}}},Mb=async()=>{let t=fr();if(!t||!t.locationId){document.getElementById(_t)?.remove(),document.getElementById(`${_t}-wrap`)?.remove(),yo();return}let e=document.getElementById(_t);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${_t}-wrap`)?.remove(),yo());return}e&&(e.remove(),document.getElementById(`${_t}-wrap`)?.remove());let o=await Ib();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=fr();if(!a||a.oppId!==t.oppId)return;let s=Lb(t.oppId),i=document.createElement("span");i.id=`${_t}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Pb(t.oppId)},vo=null,Jn=null,Ee,yo=()=>{vo?.disconnect(),vo=null,Jn=null,Ee!==void 0&&(window.clearTimeout(Ee),Ee=void 0)},Pb=t=>{if(vo&&Jn===t)return;yo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Jn=t,vo=new MutationObserver(()=>{Ee===void 0&&(Ee=window.setTimeout(()=>{Ee=void 0;let o=fr();if(!o||o.oppId!==t){yo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(_t)?.remove(),document.getElementById(`${_t}-wrap`)?.remove(),yo();return}document.getElementById(_t)||Qn()},250))}),vo.observe(e,{childList:!0,subtree:!0}))},Ob=()=>{J("schedule-walkthrough",tt,()=>{!document.getElementById(_t)&&!gr&&Qn()})},Pi=()=>{Ob(),Qn()};var Bb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",$e="ws-crm-resend-deal-link-wrap",Rb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hb=/\/v2\/location\/([A-Za-z0-9]+)/,wr=()=>{let t=window.location.pathname,e=t.match(Rb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Hb);return{oppId:o,locationId:r?r[1]:null}},Db=async t=>{let e=await fetch(Bb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Fb=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Oi=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Xn=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=R,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Oi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>zb(t,e)),t.appendChild(o)},zb=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Nb(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>Xn(t,e)),o.appendChild(i),t.appendChild(o)},Nb=async(t,e,o,r)=>{let a=wr();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Db({oppId:a.oppId,locationId:a.locationId,channel:o,userId:H()});if(s?.ok)r.innerHTML=`${Oi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Fb(i)}</span>`}window.setTimeout(()=>Xn(t,e),3500)}},qb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ub=async()=>{for(let t of qb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},xr=!1,ta=async()=>{if(!xr){xr=!0;try{await jb()}finally{xr=!1}}},jb=async()=>{let t=wr();if(!t||!t.locationId){document.getElementById($e)?.remove(),fo();return}let e=document.getElementById($e);if(e&&e.dataset.oppId===t.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(e.remove(),fo());return}e&&e.remove();let o=await Ub();if(!o)return;let r=await et();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=wr();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=$e,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Q(o).appendChild(s),Xn(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Wb(t.oppId)},go=null,Zn=null,fo=()=>{go?.disconnect(),go=null,Zn=null},Wb=t=>{if(go&&Zn===t)return;fo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zn=t,go=new MutationObserver(()=>{let o=wr();if(!o||o.oppId!==t){fo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById($e)?.remove(),fo();return}document.getElementById($e)||ta()}),go.observe(e,{childList:!0,subtree:!0}))},Gb=()=>{J("resend-deal-link",tt,()=>{!document.getElementById($e)&&!xr&&ta()})},Bi=()=>{Gb(),ta()};var Kb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ft="ws-crm-reduce-price-button",Ri="ws-crm-reduce-price-modal",Vb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yb=/\/v2\/location\/([A-Za-z0-9]+)/,$r=()=>{let t=window.location.pathname,e=t.match(Vb);if(!e)return null;let o=t.match(Yb);return{oppId:e[1],locationId:o?o[1]:null}},Jb=async t=>{let e=await fetch(Kb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},kr=()=>{document.getElementById(Ri)?.remove()},Qb=t=>{kr();let e=document.createElement("div");e.id=Ri,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=$r();!r||!r.locationId||r.oppId!==t||Qb({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=R,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Xb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],th=async()=>{for(let t of Xb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Er=!1,oa=async()=>{if(!Er){Er=!0;try{await eh()}finally{Er=!1}}},eh=async()=>{let t=$r();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),wo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),wo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await th();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=$r();if(!a||a.oppId!==t.oppId)return;let s=Zb(t.oppId,t.locationId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),oh(t.oppId)},xo=null,ea=null,Te,wo=()=>{xo?.disconnect(),xo=null,ea=null,Te!==void 0&&(window.clearTimeout(Te),Te=void 0)},oh=t=>{if(xo&&ea===t)return;wo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ea=t,xo=new MutationObserver(()=>{Te===void 0&&(Te=window.setTimeout(()=>{Te=void 0;let o=$r();if(!o||o.oppId!==t){wo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),wo();return}document.getElementById(ft)||oa()},250))}),xo.observe(e,{childList:!0,subtree:!0}))},rh=()=>{J("reduce-price",tt,()=>{!document.getElementById(ft)&&!Er&&oa()})},Hi=()=>{rh(),oa()};var Ce="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Tr="deals.reinvestos.com";var xt="ws-crm-edit-landing-button",nh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ah=/\/v2\/location\/([A-Za-z0-9]+)/,Ar=()=>{let t=window.location.pathname,e=t.match(nh);if(!e)return null;let o=t.match(ah);return{oppId:e[1],locationId:o?o[1]:null}},sh=(t,e)=>{let o=new URL(`https://${Tr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ce);let r=H();return r&&o.searchParams.set("user",r),o.toString()},ih=(t,e)=>{let o=document.createElement("button");return o.id=xt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ar();if(!r||!r.locationId||r.oppId!==t)return;if(!Ce){p.warn("[edit-landing] editor session key not configured in this build");return}let a=sh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},lh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],dh=async()=>{for(let t of lh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Cr=!1,na=async()=>{if(!Cr){Cr=!0;try{await ch()}finally{Cr=!1}}},ch=async()=>{let t=Ar();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),Eo();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),Eo());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await dh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Ar();if(!a||a.oppId!==t.oppId)return;let s=ih(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),ph(t.oppId)},ko=null,ra=null,Ae,Eo=()=>{ko?.disconnect(),ko=null,ra=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},ph=t=>{if(ko&&ra===t)return;Eo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ra=t,ko=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=Ar();if(!o||o.oppId!==t){Eo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),Eo();return}document.getElementById(xt)||na()},250))}),ko.observe(e,{childList:!0,subtree:!0}))},mh=()=>{J("edit-landing-page",tt,()=>{!document.getElementById(xt)&&!Cr&&na()})},Di=()=>{mh(),na()};var Ni="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Se="ws-crm-publish-button",$o="ws-crm-publish-wrap",Sr="ws-crm-publish-dropdown",bh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hh=/\/v2\/location\/([A-Za-z0-9]+)/,aa=()=>{let t=window.location.pathname,e=t.match(bh);if(!e)return null;let o=t.match(hh);return{oppId:e[1],locationId:o?o[1]:null}},Fi=async(t,e)=>{try{let o=await fetch(Ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:H()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},uh=async(t,e)=>{let o=await fetch(Ni,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:H()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},_h=(t,e)=>{if(!Ce){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Tr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ce);let r=H();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Sr)?.remove()},zi=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Sr;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `;let r={status:"checking"};Wt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let b=await Fi(t,e);if(!b||!Array.isArray(b.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Wt(o,r);return}r={status:b.published?"published":b.ready?"ready":"incomplete",checks:b.checks},Wt(o,r),document.getElementById(Sr)&&r.checks&&zi(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Wt(o,r),Bt();try{if((await Fi(t,e))?.published){r={status:"published"},Wt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let g=await uh(t,e);if(g.ok&&g.published)r={status:"published"},Wt(o,r),p.info(`[publish] published opp ${t}`);else if(g.missing&&g.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Wt(o,r);else throw new Error(g.error||"Publish failed")}catch(b){let g=b instanceof Error?b.message:"Publish failed";p.error("[publish] publish failed",b),r={status:"error",message:g.length>28?"Error \u2014 try again":g},Wt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Sr)?Bt():r.checks&&zi(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),u=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",u);let _=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",u),window.clearInterval(_))},5e3);return o},yh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],gh=async()=>{for(let t of yh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lr=!1,ia=async()=>{if(!Lr){Lr=!0;try{await fh()}finally{Lr=!1}}},fh=async()=>{let t=aa();if(!t||!t.locationId){document.getElementById(Se)?.remove(),document.getElementById($o)?.remove(),Bt(),Co();return}let e=document.getElementById(Se);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById($o)?.remove(),Bt(),Co());return}e&&(e.remove(),document.getElementById($o)?.remove(),Bt());let o=await gh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=aa();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=vh(t.oppId,a.locationId),i=document.createElement("span");i.id=$o,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),xh(t.oppId)},To=null,sa=null,Le,Co=()=>{To?.disconnect(),To=null,sa=null,Le!==void 0&&(window.clearTimeout(Le),Le=void 0)},xh=t=>{if(To&&sa===t)return;Co();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(sa=t,To=new MutationObserver(()=>{Le===void 0&&(Le=window.setTimeout(()=>{Le=void 0;let o=aa();if(!o||o.oppId!==t){Co();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Se)?.remove(),document.getElementById($o)?.remove(),Bt(),Co();return}document.getElementById(Se)||ia()},250))}),To.observe(e,{childList:!0,subtree:!0}))},wh=()=>{J("publish-button",tt,()=>{!document.getElementById(Se)&&!Lr&&ia()})},qi=()=>{wh(),ia()};var Ui="data:image/png;base64,",ji="data:image/png;base64,";var kh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Wi=t=>`ws-crm-map-links-${t}`,Gi=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),Ir=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},Ki=(t,e=Gi())=>{let o=Ir(e,t.addr),r=Ir(e,t.city),a=Ir(e,t.state),s=Ir(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Eh=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,$h=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Th=(t,e)=>{let{full:o,hasAny:r}=Ki(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Ch=t=>{let e=document.createElement("span");e.id=Wi(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),Th(t,i)}),d};return e.appendChild(r(Ui,"Open in Google Maps",Eh)),e.appendChild(r(ji,"Search on Zillow",$h)),e},Ah=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Vi=()=>{let t=Gi();if(t.length)for(let e of kh){if(document.getElementById(Wi(e.key)))continue;let{hasAny:o}=Ki(e,t);if(!o)continue;let r=Ah(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Ch(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},Ie=null,Me,Lh=()=>{let t=ve();return t==="contact-detail"||t==="other"},Sh=()=>{Ie||(Ie=new MutationObserver(()=>{Me===void 0&&(Me=window.setTimeout(()=>{Me=void 0;try{Vi()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Ie.observe(document.body,{childList:!0,subtree:!0}))},Yi=()=>{Ie&&(Ie.disconnect(),Ie=null),Me!==void 0&&(window.clearTimeout(Me),Me=void 0)},Ji=()=>{if(!Lh()){Yi();return}Sh(),Vi()},Qi=()=>{Yi()};var Zi="ws-crm-hide-launchpad",la=/\/launchpad\/?$/,da=()=>{if(!ye()){if(!document.getElementById(Zi)){let t=document.createElement("style");t.id=Zi,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(la.test(location.pathname)){let t=location.pathname.replace(la,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!la.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Ih=[{label:"Buy-Box Entries"},{label:"Memberships"}],Xi=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},ca=()=>{let t=ye(),e=new Set(Ih.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Xi(e);for(let o of[150,500,1200,2500])setTimeout(()=>Xi(e),o)}};var Mh=[{from:"Payments",to:"Contracts"}],Ph=".nav-title, .topmenu-navtitle",tl=()=>{document.querySelectorAll(Ph).forEach(t=>{let e=(t.textContent||"").trim(),o=Mh.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},pa=()=>{tl();for(let t of[150,500,1200,2500])setTimeout(tl,t)};var el="/payments/proposals-estimates",Oh=/\/payments\/invoices\/?$/,Bh=/\/payments\//,Rh='#sb_payments, a[meta="payments"]',rl=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(el)&&!(t>3&&!Bh.test(e))){if(Oh.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(el));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>rl(t+1),120)}},ol=!1,Hh=()=>{ol||(ol=!0,document.addEventListener("click",t=>{t.target?.closest?.(Rh)&&setTimeout(()=>rl(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},ma=()=>{Hh()};var nl=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],al="ws-crm-hide-topmenu-tabs",ba=()=>{if(document.getElementById(al))return;let t=nl.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=al,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${nl.length} top tabs`)};var ll="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Gt="ws-crm-send-to-closing-office-button",le="ws-crm-send-to-title-co-wrap",Or="ws-crm-stc-dropdown",Dh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fh=/\/v2\/location\/([A-Za-z0-9]+)/,So=()=>{let t=window.location.pathname,e=t.match(Dh);if(!e)return null;let o=t.match(Fh);return{oppId:e[1],locationId:o?o[1]:null}},zh=5*60*1e3,_a=t=>`ws-crm-stc-cache:${t}`,Nh=t=>{try{let e=window.localStorage.getItem(_a(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>zh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},qh=(t,e)=>{try{window.localStorage.setItem(_a(t),JSON.stringify(e))}catch{}},dl=t=>{try{window.localStorage.removeItem(_a(t))}catch{}},ha="ws-crm:opp-fields-updated",cl=t=>{if(t){dl(t);try{window.dispatchEvent(new CustomEvent(ha,{detail:{oppId:t}}))}catch{}}},Uh=async(t,e)=>{try{let o=await fetch(ll,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},jh=async(t,e,o)=>{let r=await fetch(ll,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Wh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},sl=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Gh=(t,e)=>{if(e&&Wh(e)){window.setTimeout(()=>sl(t),300);return}sl(t)},wt=()=>{document.getElementById(Or)?.remove()},Mr=(t,e,o)=>{wt();let r=document.createElement("div");r.id=Or;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(l);let c=["TC","ACQ","MT","DISPO","Property"],m={};t.forEach(b=>{m[b.group]||(m[b.group]=[]),m[b.group].push(b)});let u=[...c.filter(b=>m[b]),...Object.keys(m).filter(b=>!c.includes(b))];for(let b of u){let g=m[b],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let k=document.createElement("div");k.style.cssText=`
    ...
    `,k.textContent=b,x.appendChild(k),g.forEach(y=>{let f=document.createElement("div"),$=!y.filled&&y.navigable&&y.field_id;f.style.cssText=`
        ...
        ${$?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,$&&(f.addEventListener("mouseenter",()=>{f.style.background=n.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",w=>{w.stopPropagation(),y.field_id&&(Gh(y.field_id,y.folder),wt())}));let A=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=$?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${A}<span style="flex: 1;">${y.label}</span>${T}`,x.appendChild(f)}),r.appendChild(x)}document.body.appendChild(r);let _=b=>{let g=b.target;!r.contains(g)&&!o.contains(g)&&(wt(),document.removeEventListener("click",_))};window.setTimeout(()=>document.addEventListener("click",_),0)},Lt=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,c="Send to Closing Office",m="",u="pointer",_="1";switch(e.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,c="Checking\u2026",u="wait",_="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let b=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,c=`${b} of ${g} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sending\u2026",u="wait",_="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,c=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=u,t.style.opacity=_,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},Kh=(t,e)=>{let o=document.createElement("button");o.id=Gt,o.type="button",o.dataset.oppId=t;let r=Nh(t),a=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${R}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,Lt(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Uh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},Lt(o,a);return}if(y.rate_limited){b=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Lt(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},Lt(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Br.add(t),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),wt(),Lo();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},qh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),Lt(o,a),document.getElementById(Or)&&Mr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},Lt(o,a),wt();try{let f=await jh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},Lt(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},Lt(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},Lt(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},Lt(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Or)?wt():a.checks&&Mr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,c=!1,m=Date.now(),u=1e4,_=5*60*1e3,b=0,g=!1,x=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=So();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let A=Date.now()-m,T=Math.max(1500,u-A);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=A=>{let T=A.detail;if(!T||T.oppId!==t)return;dl(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}x()};E()};window.addEventListener(ha,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(ha,f),window.clearInterval($))},5e3)}return o},Vh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yh=async()=>{for(let t of Vh)try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Br=new Set,il=null,Jh=t=>{t&&t!==il&&(Br.clear(),il=t)},Pr=!1,va=async()=>{if(Pr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Pr=!0;try{await Qh()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Pr=!1}},Qh=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=So();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),wt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Jh(t.oppId),Br.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),wt();return}let e=document.getElementById(Gt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(le)?.remove(),wt(),Lo());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(le)?.remove(),wt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Yh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=So();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Kh(t.oppId,a.locationId),i=document.createElement("span");i.id=le,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),Zh(t.oppId)},Ao=null,ua=null,Lo=()=>{Ao?.disconnect(),Ao=null,ua=null},Zh=t=>{if(Ao&&ua===t)return;Lo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ua=t,Ao=new MutationObserver(()=>{let o=So();if(!o||o.oppId!==t){Lo();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),wt(),Lo();return}document.getElementById(Gt)||va()}),Ao.observe(e,{childList:!0,subtree:!0}))},Xh=()=>{J("send-to-closing",tt,()=>{if(document.getElementById(Gt)||Pr)return;let t=So();t&&Br.has(t.oppId)||va()})},pl=()=>{Xh(),va()};var fa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",tu=`${fa}/tc/welcome-call-prefill`,eu=`${fa}/tc/welcome-call-save`,ou=`${fa}/tc/order-lockbox`,Io="ws-crm-welcome-call-overlay",ru=["Regular Contract","Subject To","Seller Finance","Novation"],nu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],au=["Gas","Electric","Propane","Oil"],su=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],iu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Kt=["Yes","No"],lu=["Yes","No","Unknown"],du=["Professional Photographer","Seller","Tenant"],cu=["Month-to-Month","Annual"],ml=["Current","Behind"],pu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],St=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Hr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,ul="margin-bottom:12px;",_l=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,mu=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,bl=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=bl(o);return`<select id="${t}" style="${Hr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&bl(a)===r?"selected":""}>${St(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${St(e)}" placeholder="${St(o)}" style="${Hr}">`,bu=(t,e)=>`<textarea id="${t}" rows="3" style="${Hr}resize:vertical;">${St(e)}</textarea>`,hu=(t,e)=>`<input id="${t}" type="date" value="${St(e)}" style="${Hr}">`,F=(t,e)=>`<div style="${ul}"><label style="${_l}">${St(t)}</label>${e}</div>`,ya=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${pu.map(r=>`<label style="${mu}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${St(t)}</div>`,Pe=()=>{document.getElementById(Io)?.remove()},de=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},uu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    ...
    ${Rt("Contract")}
    ${F("Type of Contract",ot("wc-contract_type",ru,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",ot("wc-property_type",su,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",ot("wc-utilities",nu,t.utilities))}
    ${F("Heat Source",ot("wc-heat_source",au,t.heat_source))}

    ${Rt("Liens & Permits")}
    ${F("Is there a mortgage?",ot("wc-has_mortgage",Kt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",ot("wc-mortgage_payment_status",ml,t.mortgage_payment_status))}</div>
    ...
    ${Rt("Occupancy")}
    ${F("Property occupancy",ot("wc-occupancy",iu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",ot("wc-tenant_lease_type",cu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",ot("wc-tenant_rent_status",ml,e.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",hu("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",ot("wc-hoa_rental_restriction",lu,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",ot("wc-photos_provided_by",du,t.photos_provided_by))}
    <div style="${ul}">
      <label style="${_l}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${ya("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${ya("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${ya("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${h.sans};cursor:pointer;flex-shrink:0;">${Rr(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Rr(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Rr(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${Rr(t).text}</span>
      </div>
    </div>

    ${Rt("Notes")}
    ${F("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",bu("wc-welcome_call_notes",t.welcome_call_notes))}
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},ga=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),hl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},Rr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?St(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},_u=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:ga("photos_avail_mornings"),photos_avail_afternoons:ga("photos_avail_afternoons"),photos_avail_evenings:ga("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),vu=t=>{Pe();let e=document.createElement("div");e.id=Io,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${h.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${Io} input[type="date"]::-webkit-calendar-picker-indicator,#${Io} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${uu(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&Pe()}),document.getElementById("wc-close")?.addEventListener("click",Pe),document.getElementById("wc-cancel")?.addEventListener("click",Pe),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",hl)}),hl();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!I("wc-occupancy")){de("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(eu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(_u(t)),credentials:"omit"})).ok?(Pe(),de("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,de("Save failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,de("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(ou,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:I("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:I("wc-lockbox_recipient_name"),recipient_phone:I("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),de("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,de("Lockbox order failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,de("Couldn't reach the lockbox handler. Try again.","err")}})},vl=async(t,e)=>{Pe();let o=document.createElement("div");o.id=Io,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${h.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${tu}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,vu(r)};var Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",yu=`${Ta}/tc/confirm-photo-appointment`,gu=`${Ta}/tc/order-lockbox`,fu=`${Ta}/tc/welcome-call-prefill`,ka="ws-crm-opp-action-bar",gl="ws-crm-opp-overflow",fl="ws-crm-opp-action-menu",Ea="ws-crm-opp-action-popover",xl="ws-crm-reorder-lockbox-modal",wl=".hr-card.hr-modal.crm-opportunities-modal",xu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,wu=/\/v2\/location\/([A-Za-z0-9]+)/,kl="Welcome Call Needed",Ca="Scheduling Photos",El="Photos Scheduled",ku=[kl,Ca,El,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],$l=()=>{let t=window.location.pathname,e=t.match(xu);if(!e)return null;let o=t.match(wu);return o?{oppId:e[1],locationId:o[1]}:null},Eu=()=>{let t=document.querySelector(wl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(ku.includes(r))return r}return null},Yt=()=>{document.getElementById(fl)?.remove(),document.getElementById(Ea)?.remove(),document.getElementById(xl)?.remove()},xa=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Vt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$u=t=>{vl(t.oppId,t.locationId)},Tu=async(t,e,o)=>(await fetch(gu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Cu=(t,e)=>{Yt();let o=document.createElement("div");o.id=xl,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${xa(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${xa(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${xa(i)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",u=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!u){Vt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{await Tu(t,e,{recipient_name:c,recipient_phone:m,ship_to:u})?(d(),Vt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Vt("Re-order failed \u2014 try again.","err"))}catch(_){p.warn("[action-bar] reorder lockbox failed:",_),l.disabled=!1,l.textContent="Order Lockbox",Vt("Couldn't reach the lockbox handler. Try again.","err")}}})},Tl=async t=>{Yt();let e={};try{e=await fetch(`${fu}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Cu(t,e)},Au=(t,e)=>{Yt();let o=document.createElement("div");o.id=Ea;let r=e.getBoundingClientRect();o.style.cssText=`
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Vt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(yu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Yt(),Vt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Vt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Vt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Yt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},Lu=(t,e)=>{Yt();let o=document.createElement("div");o.id=fl;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${h.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Yt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Fr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=R,o.textContent=t,o},Su=()=>{let t=Fr("\u22EE","ghost");return t.style.lineHeight="1",t},Iu=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===kl){let r=Fr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>$u(t)),o.appendChild(r),o}if(e===Ca){let r=Fr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Au(t,r)),o.appendChild(r),o}if(e===El){let r=Fr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Tl(t)),o.appendChild(r),o}return null},Mu=(t,e)=>{let o=[];if(e===Ca&&(o=[{label:"Re-order Lockbox",onClick:()=>void Tl(t)}]),!o.length)return null;let r=document.createElement("span");r.id=gl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Su();return a.addEventListener("click",s=>{s.stopPropagation(),Lu(o,a)}),r.appendChild(a),r},Pu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ou=async()=>{for(let t of Pu)try{let e=await P(t,{timeoutMs:1200});if(e)return e}catch{}return null},Dr=()=>{document.getElementById(ka)?.remove(),document.getElementById(gl)?.remove(),Yt()},zr=!1,Aa=async()=>{if(!zr){zr=!0;try{let t=$l();if(!t){Dr();return}let e=z();if(e===null)return;if(e!=="Transaction Coordination"){Dr();return}let o=Eu(),r=document.getElementById(ka);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Iu(t,o);if(!a){Dr();return}let s=await Ou();if(!s)return;Dr();let i=Q(s),d=document.createElement("span");d.id=ka,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Mu(t,o);l&&i.appendChild(l),Bu(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{zr=!1}}},Mo=null,$a=null,wa,yl=()=>{Mo?.disconnect(),Mo=null,$a=null},Bu=t=>{if(Mo&&$a===t)return;yl();let e=document.querySelector(wl);e&&($a=t,Mo=new MutationObserver(()=>{let o=$l();if(!o||o.oppId!==t){yl();return}wa===void 0&&(wa=window.setTimeout(()=>{wa=void 0,Aa()},250))}),Mo.observe(e,{childList:!0,subtree:!0}))},Ru=()=>{J("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{zr||Aa()})},Cl=()=>{Ru(),Aa()};var Al="ws-support-modal",Ll="ws-support-toast",Hu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Sl="ws-support-submitter-name",Il="ws-support-submitter-email",Ml="ws-support-submitter-role",Du=["Bug","Feature Request","Question","Billing","Onboarding Help"],ce=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Fu=(t,e="success",o)=>{let r=document.getElementById(Ll);r&&r.remove();let a=document.createElement("div");a.id=Ll;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,a.innerHTML=`
    <div style="font-weight: 500;">${ce(t)}</div>
    ${o?`<div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${ce(o)}</div>`:""}
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},zu=()=>{document.getElementById(Al)?.remove();let t=(localStorage.getItem(Sl)??"").trim(),e=(localStorage.getItem(Il)??"").trim(),o=(localStorage.getItem(Ml)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Al,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `;let i=d=>`
    <button type="button" data-category="${ce(d)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;s.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${ce(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${ce(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${ce(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${h.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=u=>{d&&(d.textContent=u)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Sl,r.submitterName),localStorage.setItem(Il,r.submitterEmail),r.submitterRole&&localStorage.setItem(Ml,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let _=await(await fetch(Hu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:H()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!_.ok){l(_.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let b=_.ticket_short_id||"submitted";Fu(`Ticket ${b} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(u){l(`Network error: ${u.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Nu=["/support-ticket","ws-support-modal","ws-support"],qu=/\/custom-menu-link\//,La=!1,Pl=()=>{if(La||!qu.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Nu.some(i=>s.includes(i))});if(r){La=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{zu(),La=!1},50);return}t<10&&setTimeout(e,150)};e()},Ol=!1,Bl=()=>{Ol||(Ol=!0,Et(()=>setTimeout(Pl,50)),Pl(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Rl="ws-phone-assignments-modal",Hl="ws-phone-assignments-toast",Uu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",ju="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Wu=["ACQ","DISPO","TC"],zl="",Jt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Gu=(t,e="success",o)=>{document.getElementById(Hl)?.remove();let r=document.createElement("div");r.id=Hl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Jt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Jt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Ku=(t,e,o)=>{let r=[`<option value="" ${o===zl?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Jt(a)}" ${o===a?"selected":""}>${Jt(a)}</option>`)].join("");return`<select data-assign="${Jt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Vu=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Ia=async t=>{document.getElementById(Rl)?.remove();let e=t||K(),o=document.createElement("div");o.id=Rl,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Uu}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){p.error("[phone-assignments] GET failed",_);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Jt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:Wu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,c=i.length?i.map(_=>`<div style="${Vu}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${Jt(_.label||_.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${h.mono};">${Jt(_.e164)}</div>
            </div>
            ${Ku(`num:${_.e164}`,s,d[_.e164]??zl)}
    ...
    </div>`,u.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let b=_.getAttribute("data-assign")||"",[g,...x]=b.split(":"),k=x.join(":");g==="num"&&(_.value?d[k]=_.value:delete d[k])})}),u.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),u.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=u.querySelector("#ws-pa-err"),b=x=>{_&&(_.textContent=x)};b("");let g=u.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(ju,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){b(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),Gu("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){b(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},Yu=["ws-phone-assignments","phone-assignments"],Ju=/\/custom-menu-link\//,Sa=!1,Dl=()=>{if(Sa||!Ju.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Yu.some(i=>s.includes(i))});if(r){Sa=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Ia(s),Sa=!1},50);return}t<10&&setTimeout(e,150)};e()},Fl=!1,Nl=()=>{if(Fl)return;Fl=!0,Et(()=>setTimeout(Dl,50)),Dl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Ia()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Ia(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var ql="powerDialerApp",Qu=".dialer",Zu='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Xu=".dial-item.dial-btn.dial-btn-enabled",Oe=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},t_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},Ma=()=>{try{let e=window[ql]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},Be=()=>document.querySelector(Qu),Nr=()=>Ma()!==null||Be()!==null?!0:!!window[ql],qr=(t,e)=>{let o=Ma();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},Ul=()=>{if(Be())return;let t=document.querySelector(Zu);t?Oe(t):p.warn("[dialer-bridge] Voice Calling button not found")},e_=()=>{let t=document.querySelector(".number-list-container")||Be();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Pa=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?t_(t.innerText):null},jl=(t,e)=>{if(Pa()===t)return!0;let o=Ma();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Oe(r);let a=e_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Oe(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},Wl=t=>{let e=t.replace(/[^\d*#+]/g,"");if(qr("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Oe(a)}},Gl=()=>{let t=Be();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(Xu)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Oe(e),!0):qr("makeCall",{provider:"twilio"})};var Oa=()=>{let t=Be();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Oe(e.closest("button")||e):qr("closeCallBox")},Kl=()=>{qr("closeCallBox")},Vl=t=>{let e=!1,o=()=>{let s=Be()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var o_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",r_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Yl=["acq","dispo","tc"],Oo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Po=null,Jl=null,n_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&Po&&Jl===o)return Po;try{let a=await(await fetch(`${o_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Po={numberTeam:a?.config?.numberTeam??{},numberLabel:s},Jl=o,Po}catch(r){return p.warn("[silo] config load failed",r),Po??e}},pe=null,Ql=null,Ba=async(t=!1)=>{let e=K(),o=H();if(!e||!o)return[];if(!t&&pe&&Ql===e)return pe;try{let s=(await(await fetch(r_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];pe=Yl.filter(d=>i.includes(d))}else ye()?pe=[...Yl]:pe=[];return Ql=e,pe}catch(r){return p.warn("[silo] roster load failed",r),pe??[]}},Xl=()=>`ws-pd-calling-as:${H()||"anon"}`,td=t=>{try{localStorage.setItem(Xl(),t)}catch{}},Ra=async()=>{let t=await Ba();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(Xl())}catch{}return e&&t.includes(e)?e:t[0]},Zl=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},a_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),ed=async t=>{let e=await Ra();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await n_(),a=a_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=Zl(t),i=s?a.find(m=>Zl(m)===s):void 0,d=i||a[0];if(!jl(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Oo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Pa();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var s_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",od="data-ws-pd",rd="ws-crm-pd-panel",nd="ws-crm-pd-session",Qt=t=>new Promise(e=>setTimeout(e,t)),Bo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),i_=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},l_=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},d_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},c_=async t=>{let e=i_(t);if(!e)return[];let o=l_(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Qt(550)}return o.scrollTop=0,d_(e)},p_=async(t,e)=>{try{let r=await(await fetch(s_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},m_=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,Da=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(rd)?.remove();let r=document.createElement("div");r.id=rd,r.style.cssText=m_;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((x,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${k}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Bo(x.name||x.contactId)}</span>
    ...
    <div style="font-size:14px;font-weight:600;margin:2px 0 2px;">${Bo(t)}</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${Bo(t)} \xB7 ${l+1} of ${e.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Bo(c)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${Bo(d)}</div>
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Oa()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Oa()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await p_(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Qt(1200);continue}let u=l._phone||m?.phone||"",_=m?.name||l.name;if(!u){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Qt(1400);continue}if(await ed(u),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(b){p.debug("[bulk-dialer] screen-follow nav failed",b)}i(`Calling ${u}\u2026`,d,_);try{Ul(),await Qt(250),Wl(u),await Qt(250),Gl()}catch(b){p.error("[bulk-dialer] dial failed",b)}if(await new Promise(b=>{let g=!1,x=()=>{g||(g=!0,window.clearInterval(y),k(),b())},k=Vl(x),y=window.setInterval(()=>{(a.stopped||a.skip)&&x()},300)}),a.stopped)break;try{Kl()}catch{}if(d<e.length-1)if(o)for(let b=5;b>0&&!a.stopped&&!a.advance;b--){for(i(`Next call in ${b}s\u2026`,d,_);a.paused&&!a.stopped&&!a.advance;)await Qt(200);if(a.advance||a.stopped)break;await Qt(1e3)}else for(i("Ready \u2014 press Call Next",d,_);!a.advance&&!a.stopped;)await Qt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Fa='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',za=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},b_=()=>{if(ve()!=="opportunity-list"||!za()||!Nr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${od}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(od,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Fa}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await c_(e);Da(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},Re=null,Ha,ad=!1,id=()=>{if(ad)return;ad=!0,window.WS_CRM_PD_TEST=e=>void sd("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Ha!==void 0&&window.clearTimeout(Ha),Ha=window.setTimeout(b_,400)};Et(e=>{e==="opportunity-list"?(t(),Re||(Re=new MutationObserver(t),Re.observe(document.body,{childList:!0,subtree:!0}))):Re&&(Re.disconnect(),Re=null)})};var ld="ws-crm-pd-contacts-btn",h_=t=>new Promise(e=>setTimeout(e,t)),u_=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},__=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Na=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=u_(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},v_=async t=>{let e=new Map;if(t)return Na(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(Na(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(Na(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await h_(220);return o.scrollTop=0,[...e.values()]},y_=()=>{if(ve()!=="contact-list"||!za()||!Nr()||document.getElementById(ld))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=ld,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${h.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${Fa}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=__(),l=await v_(d);Da(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},He=null,qa,dd=!1,cd=()=>{if(dd)return;dd=!0;let t=()=>{qa!==void 0&&window.clearTimeout(qa),qa=window.setTimeout(y_,400)};Et(e=>{e==="contact-list"?(t(),He||(He=new MutationObserver(t),He.observe(document.body,{childList:!0,subtree:!0}))):He&&(He.disconnect(),He=null)})};var g_="ws-calling-as-chip",f_=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},Ua=!1,me=null,pd,bd=0,x_=3e4,w_=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},ja=()=>{if(!me||me.isConnected)return;let t=w_();t&&t.parent.insertBefore(me,t.before)},md=async()=>{if(!(Ua||me)&&f_()){Ua=!0;try{let t=await Ba();if(!t.length)return;let e=await Ra()??t[0],o=t.length>1,r=document.createElement("div");r.id=g_,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${h.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${h.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Oo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Oo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${h.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Oo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",u=>{u.stopPropagation(),e=l,td(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}me=r,ja(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{Ua=!1,bd=Date.now()}}},hd=()=>{me?ja():md(),pd===void 0&&(pd=window.setInterval(()=>{me?ja():Date.now()-bd>=x_&&md()},1500))};var k_="#12161D",E_="#EDEEF0",ud=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},_d=t=>{t.style.setProperty("background-color",k_,"important"),t.style.setProperty("color",E_,"important")},$_=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},T_=t=>{ud(t)&&_d(t);for(let e of Array.from(t.querySelectorAll("*")))ud(e)&&_d(e)},Wa=null,Ro=null,yd=()=>{Ro&&(Ro.disconnect(),Ro=null),Wa=null},C_=t=>{if(Wa===t)return;yd(),Wa=t;let e=!1,o=()=>{e=!1;try{T_(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Ro=new MutationObserver(r),Ro.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},vd=!1,Ur=()=>{if(vd)return;vd=!0;let t=()=>{let o=$_();o?C_(o):yd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var A_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",L_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",S_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",xd="tc_closing_agent",I_="tc_closing_office",kt="ws-crm-closing-agent-picker-button",wd="ws-crm-closing-agent-picker-modal",M_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,P_=/\/v2\/location\/([A-Za-z0-9]+)/,Fo=()=>{let t=window.location.pathname,e=t.match(M_);if(!e)return null;let o=t.match(P_);return{oppId:e[1],locationId:o?o[1]:null}},Qa=async t=>{let e=await fetch(A_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},gd=async t=>{let e=await fetch(L_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},O_=async(t,e)=>{try{let o=await fetch(S_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:xd}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await Qa({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},be=null,B_=60*60*1e3,Za=t=>`ws-crm-to-cache:${t}`,kd=t=>{try{let e=window.localStorage.getItem(Za(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>B_||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Ed=(t,e,o)=>{try{window.localStorage.setItem(Za(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},R_=t=>{try{window.localStorage.removeItem(Za(t))}catch{}},Ka="ws-crm-closing-agent-field-link",H_=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ka}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Ga=!1,Xa=async t=>{if(Ga)return;let e=$d();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Ga=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Qa({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Va(a.id,a.name,t);let s=document.getElementById(kt);if(s){Zt(s,{status:"linked",contactName:a.name});let i=Fo();i&&Ed(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Ga=!1}}},D_=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,$d=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();D_.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let u=l.getAttribute(m);u&&/Title\s+Officer/i.test(u)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:u})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Va=(t,e,o)=>{let r=$d();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Ka}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=Ka,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},jr=()=>{document.getElementById(wd)?.remove()},F_=t=>{jr();let e=document.createElement("div");e.id=wd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&jr()}),s?.addEventListener("click",jr);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await Qa({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,_.innerHTML=`
          <div style="font-weight: 500;">${Wr(u.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Wr(u.email||"(no email)")} \xB7 ${Wr(u.phone||"no phone")}
            ${u.companyName?` \xB7 ${Wr(u.companyName)}`:""}
          </div>
        `,_.addEventListener("mouseenter",()=>{_.style.background=n.slate}),_.addEventListener("mouseleave",()=>{_.style.background="transparent"}),_.addEventListener("click",()=>{jr(),t.onPick(u)}),a.appendChild(_)})}catch(m){p.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{l(c)},250)})},Wr=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Zt=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",s=n.amber,i=n.bone,d="transparent",l=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",s=n.coolGray,i=n.ash,c="wait";break;case"empty":a="Link Closing Agent",s=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=n.emerald,d=n.emeraldGlow,l=n.emeraldBorder,i=n.emeraldBright;break;case"saving":a="Linking\u2026",s=n.coolGray,i=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),t.style.background=d,t.style.borderColor=l,t.style.color=i,t.style.cursor=c},z_=(t,e)=>{let o=document.createElement("button");o.id=kt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Zt(o,r);let a=kd(t);return a&&(r={status:"linked",contactName:a.contactName},Zt(o,r),be={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await O_(t,e);i?(r={status:"linked",contactName:i.name},Zt(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Va(i.id,i.name,e)):a||(r={status:"empty"},Zt(o,r),be?.oppId===t&&(be=null),H_(),R_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||F_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Zt(o,r);try{let d=await gd({tenantId:e,oppId:t,fieldKey:xd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await gd({tenantId:e,oppId:t,fieldKey:I_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Zt(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ed(t,i.id,i.name),Va(i.id,i.name,e),cl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Zt(o,r)}}})}),o},N_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],q_=async()=>{for(let t of N_)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ho=!1,Kr=async()=>{if(!Ho){Ho=!0;try{await U_()}finally{Ho=!1}}},U_=async()=>{let t=Fo();if(!t||!t.locationId){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Gr();return}let e=document.getElementById(kt);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Gr());return}e&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await q_();if(!r||!(kd(t.oppId)!==null||be!==null&&be.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=Fo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=z_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${kt}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Q(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),j_(t.oppId),Xa(s.locationId)},Do=null,Ya=null,Ja=null,Gr=()=>{Do?.disconnect(),Do=null,Ya=null,Ja=null},j_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Do&&Ya===t&&Ja===e||(Gr(),Ya=t,Ja=e,Do=new MutationObserver(()=>{let o=Fo();if(!o||o.oppId!==t||!o.locationId){Gr();return}document.getElementById(kt)||Kr(),Xa(o.locationId)}),Do.observe(e,{childList:!0,subtree:!0})))},W_=()=>{J("closing-agent-picker",tt,()=>{!document.getElementById(kt)&&!Ho&&Kr()})},fd,G_=()=>{fd===void 0&&(fd=window.setInterval(()=>{let t=Fo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(kt)&&!Ho&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Kr()),Xa(t.locationId)},2e3))},Td=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),W_(),G_(),Kr()};var K_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ht="ws-crm-manage-team-cta",Ad="ws-crm-manage-team-modal",V_=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ld={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},Y_={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Sd=()=>{let t=window.location.pathname.match(V_);return t?{tenantId:t[1]}:null},Yr=async t=>{let e=await fetch(K_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},vt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Xt=t=>vt(t),ts="ws-crm-manage-team-toast",rs=(t,e="info",o=4e3)=>{document.getElementById(ts)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ts,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ts)===a&&a.remove()},o)},es=()=>{document.getElementById(Ad)?.remove()},J_=(t,e)=>{let o=Y_[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${vt(e)}</span>
  `},Q_=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>J_(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>Q_(r,e)).join(""),Jr=async t=>{es();let e=document.createElement("div");e.id=Ad,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${h.sans};
  `,e.addEventListener("click",l=>{l.target===e&&es()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",es);let r;try{r=await Yr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+Z_(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{X_(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;tv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;ev(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},X_=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${vt(Ld[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=a.querySelector("#ws-team-remove-error"),i=a.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let d=await Yr({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:H()});if(!d.ok){s&&(s.textContent=d.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),rs(`Removed ${e.name} from the team.`,"success"),await Jr(t)}catch(d){s&&(s.textContent=d.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},ov=89,rv=93,nv=310,av=34,sv=14,iv=14,lv=3,Vr=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+ov;t.style.right=`${Math.max(r,16)}px`},dv=t=>{let e=document.createElement("button");return e.id=Ht,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${rv}px;
    right: 24px;
    width: ${nv}px;
  ...
  `,e.addEventListener("click",()=>{Jr(t)}),Vr(e),setTimeout(()=>Vr(e),200),setTimeout(()=>Vr(e),800),cv(),e},Cd=!1,cv=()=>{Cd||(Cd=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Ht);t instanceof HTMLButtonElement&&Vr(t)}))},os=!1,pv=()=>{if(!os){os=!0;try{let t=Sd();if(!t){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}let e=document.getElementById(Ht);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ht}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ht}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=dv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{os=!1}}},Id=()=>{if(!Sd()){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}pv()};var mv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ss="ws-crm-prepare-contract-button",Md="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",Pd="ws-crm-modal-date-style",Dt="https://services.leadconnectorhq.com",Fd=()=>{if(document.getElementById(Pd))return;let t=document.createElement("style");t.id=Pd,t.textContent=`
  ...
  `,document.head.appendChild(t)},is="__WS_CRM_CAPTURED_AUTH",bv=50*60*1e3,Uo=()=>{try{let t=localStorage.getItem(is);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>bv?(localStorage.removeItem(is),null):e:null}catch{return null}},hv=t=>{try{localStorage.setItem(is,JSON.stringify(t))}catch{}},Fe=()=>{let t=Uo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Od=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Uo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),De=async(t,e={},o=2)=>{let r=Uo()?.capturedAt??0,a;try{a={...Fe(),...e.headers??{}}}catch(i){if(o>0&&await Od(r,4e3))return De(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await Od(r,4e3)?De(t,e,o-1):s},Bd=!1,uv=()=>{if(Bd)return;Bd=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=Uo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let u=c.authorization||c.Authorization;if(!u){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=c["token-id"]||c["Token-Id"]||void 0,b=Uo()?.authorization;hv({authorization:u,tokenId:_,capturedAt:Date.now()}),b!==u&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${u.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let u=m.headers;!u&&l[0]instanceof Request&&(u=l[0].headers);let _={};if(u instanceof Headers)u.forEach((b,g)=>_[g.toLowerCase()]=b);else if(Array.isArray(u))u.forEach(([b,g])=>_[b.toLowerCase()]=g);else if(u&&typeof u=="object")for(let b of Object.keys(u))_[b.toLowerCase()]=u[b];o(c,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},zd=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},_v=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:zd()},vv=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Nd="__WS_CRM_TEMPLATES_CACHE_V1",yv=24*60*60*1e3,Rd=t=>{try{let e=window.localStorage.getItem(Nd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>yv?null:o.templates}catch{return null}},gv=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Nd,JSON.stringify(o))}catch{}},fv=async t=>{let e=`${Dt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await De(e,{method:"GET"})}catch(i){let d=Rd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=Rd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:vv(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&gv(t,s),s},xv=async(t,e)=>{let o=await De(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await De(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},wv=async(t,e)=>{let o=await De(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Fe()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},kv=async t=>{let e=await fetch(mv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Ev=async(t,e,o)=>{let r=`${Dt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Fe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},$v=async(t,e)=>{let o=await fetch(`${Dt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Fe()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},qd=async t=>{let e=await fetch(`${Dt}/contacts/${t}`,{method:"GET",headers:Fe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Tv=async(t,e,o,r)=>{let a;try{a=await $v(t,e)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await qd(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],u={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Dt}/proposals/document/${e}`,{method:"PUT",headers:{...Fe(),"Content-Type":"application/json"},body:JSON.stringify(u)});if(!_.ok){let b=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:b}}return{ok:!0}},Cv=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Zr="__WS_CRM_PENDING_INSTRUCTIONS",Av=60*1e3,Lv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Sv=t=>{let e=(t||"").toLowerCase();for(let o of Lv)if(e.includes(o.matches.toLowerCase()))return o;return null},Iv=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Zr,JSON.stringify(r))}catch{}},Mv=()=>{try{let t=localStorage.getItem(Zr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Av?(localStorage.removeItem(Zr),null):e}catch{return null}},Pv=()=>{try{localStorage.removeItem(Zr)}catch{}},Ov=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Bv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Rv=()=>{let t=window.location.pathname.match(Bv);if(!t)return;let e=t[1],o=Mv();o&&o.proposalId===e&&(Pv(),window.setTimeout(()=>{Ov(o.title,o.bodyHtml)},600))},Hd="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(Hd)?.remove();let r=document.createElement("div");r.id=Hd;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Dd=(t,e)=>new Promise(o=>{document.getElementById(Mt)?.remove();let r=document.createElement("div");r.id=Mt,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,B=X=>['<option value="">(unset)</option>'].concat(x.map(st=>`<option value="${It(st)}"${st===X?" selected":""}>${bt(st)}</option>`)).join("");y.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-current-occupancy" style="${S}">${B(b)}</select>
      </div>
      <div style="${w}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${S}">${B(g)}</select>
      </div>
  ...
  `,k.appendChild(y),document.body.appendChild(k);let j=y.querySelector("#ws-pc-purchase-price"),U=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),N=!1;W?.addEventListener("input",()=>{N=!0});let zt=()=>{if(N)return;let X=Number(j?.value||0),st=Number(U?.value||0);W&&(W.value=String(Math.max(0,X-st)))};j?.addEventListener("input",zt),U?.addEventListener("input",zt);let Nt=()=>k.remove();k.addEventListener("click",X=>{X.target===k&&Nt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Nt);let pt=y.querySelector("#ws-pc-submit"),ht=y.querySelector("#ws-pc-error");pt?.addEventListener("click",async()=>{if(pt){ht&&(ht.textContent=""),pt.disabled=!0,pt.textContent="Opening\u2026";try{let X=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(j?.value||0),Ke=Number(U?.value||0),Ve=Number(W?.value||0),Ye=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Je=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Qe=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),_e=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Ze=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),it={};if(X!==i&&(it.sellerName=X),st!==d&&(it.purchasePrice=st),Ke!==l&&(it.emd=Ke),Ve!==c&&(it.cashAtClose=Ve),Ye!==m&&(it.daysToClose=Ye),Je!==u&&(it.inspectionDays=Je),Qe!==_&&(it.additionalTerms=Qe),_e!==b&&(it.currentOccupancy=_e),Ze!==g&&(it.occupancyAtClose=Ze),Object.keys(it).length>0){p.info("[prepare-contract] PA modal submit with overrides:",it),pt.textContent="Saving\u2026";let bn=H(),hn=await Xr({tenantId:t,contactId:e,template:o,userId:bn,overrides:it});p.info("[prepare-contract] re-stage with overrides ok:",hn),pt.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let lt=s?`${s} - Purchase Agreement`:void 0;await cs(t,e,o,lt)}catch(X){pt.disabled=!1,pt.textContent="Open Contract",ht&&(ht.textContent=X.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",X)}}})},Dv=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Mt)?.remove(),Fd();let l=a.debug||{},c=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",u=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,_=typeof l.buyerEMD=="number"?l.buyerEMD:0,b=typeof l.assignmentFee=="number"?l.assignmentFee:0,g=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,x=typeof l.closingOffice=="string"?l.closingOffice:"",k=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,f=d,$="",A=document.createElement("div");A.id=Mt,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(T),document.body.appendChild(A);let W=T.querySelector("#ws-pc-assignment-price"),N=T.querySelector("#ws-pc-assignment-fee"),zt=!1;N?.addEventListener("input",()=>{zt=!0});let Nt=()=>{if(zt)return;let st=Number(W?.value||0);N&&(N.value=String(Math.max(0,st-g)))};W?.addEventListener("input",Nt);let pt=()=>A.remove();A.addEventListener("click",st=>{st.target===A&&pt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",pt);let ht=T.querySelector("#ws-pc-submit"),X=T.querySelector("#ws-pc-error");ht?.addEventListener("click",async()=>{if(!ht)return;X&&(X.textContent="");let st=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ke=Number(W?.value||0),Ve=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),Ye=Number(N?.value||0),Je=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),Qe=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),_e=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),Ze=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),it=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!_e){X&&(X.textContent="Closing Date is required.");return}ht.disabled=!0,ht.textContent="Opening\u2026";try{let lt={};st!==m&&(lt.sellerName=st),Ke!==u&&(lt.assignmentPrice=Ke),Ve!==_&&(lt.buyerEMD=Ve),Ye!==b&&(lt.assignmentFee=Ye),Je!==x&&(lt.closingOffice=Je),Qe!==k&&(lt.buyerCompanyName=Qe);let bn=_e!==y||Ze!==f||it!==$,hn=Object.keys(lt).length>0||bn,un=a;hn?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",lt),ht.textContent="Saving\u2026",un=await Xr({tenantId:t,contactId:e,template:o,oppId:r,closingDate:_e,buyerEarnestDueDate:Ze,lenderSource:it,userId:s,overrides:Object.keys(lt).length>0?lt:void 0}),p.info("[prepare-contract] AA re-stage ok:",un),ht.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Ts=un?.debug?.propertyAddress||c,Gc=Ts?`${Ts} - Assignment Agreement`:void 0;await cs(t,e,o,Gc),pt()}catch(lt){ht.disabled=!1,ht.textContent="Open Contract",X&&(X.textContent=lt.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",lt)}})},Xr=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await kv({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},cs=async(t,e,o,r)=>{let a=null;try{a=(await qd(e)).email||""}catch(l){p.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){nt("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),p.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await Ev(t,o.id,e);p.info(`[prepare-contract] proposal created: ${s}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Tv(t,s,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${s}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),nt(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Sv(o.name);d&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Iv(s,d.title,d.bodyHtml)),Cv(t,s)},Fv=async t=>{let e=_v(t);if(!e){nt("Could not resolve contact context.","error");return}document.getElementById(Md)?.remove();let o=document.createElement("div");o.id=Md,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await fv(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=H();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await wv(e.tenantId,e.contactId)}catch(f){nt(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await Dd(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}m=f,p.info(`[prepare-contract] picked MT opp ${m}`)}}let u=y=>{let f=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${$}-${A}`},_=y=>{let f=new Date;return f.setDate(f.getDate()+y),u(f)},b=_(45),g=_(7);nt("Reading contract data\u2026","info",2500);let x;try{x=await Xr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:b,buyerEarnestDueDate:g,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||x.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}Dv({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:x,userId:c,defaultClosingDate:b,defaultEMDDueDate:g})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await xv(e.tenantId,e.contactId)}catch(b){nt(`Failed to load ACQ opps: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",b);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let u;if(m.length===1)u=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${u} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let b=await Dd(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!b){p.info("[prepare-contract] ACQ opp picker cancelled");return}u=b,p.info(`[prepare-contract] picked ACQ opp ${u}`)}nt("Reading contract data\u2026","info",2500);let _;try{_=await Xr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:u,userId:c})}catch(b){nt(`Failed to prepare contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",b);return}Hv({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:_})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await cs(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},Ud=()=>{let t=document.createElement("button");return t.id=ss,t.type="button",t.style.cssText=`${R} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Fv(t)}),t},zv="ws-crm-contact-actions-bar",Nv=async()=>{let t=zd();if(!t){document.getElementById(ss)?.remove();return}let e=null;try{e=await P(`#${zv}`,{timeoutMs:Xe+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(ss);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Ud();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},he="ws-crm-prepare-contract-button-opp",zo=`${he}-wrap`,qv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Uv=/\/v2\/location\/([A-Za-z0-9]+)/,jv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ls=()=>{let t=window.location.pathname,e=t.match(qv);if(!e)return null;let o=t.match(Uv);return o?{oppId:e[1],tenantId:o[1]}:null},Wv=async()=>{for(let t of jv)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qr=!1,No=null,ds=null,ns=null,as,qo=()=>{No?.disconnect(),No=null,ds=null},Gv=t=>{if(No&&ds===t)return;qo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ds=t,No=new MutationObserver(()=>{let o=ls();if(!o||o.oppId!==t){qo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(he)?.remove(),document.getElementById(zo)?.remove(),qo();return}document.getElementById(he)||jd()}),No.observe(e,{childList:!0,subtree:!0}))},Kv=()=>{ns||(ns=new MutationObserver(()=>{as===void 0&&(as=window.setTimeout(()=>{as=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(he);t&&!e&&!Qr&&jd()},300))}),ns.observe(document.body,{childList:!0,subtree:!0}))},jd=async()=>{if(!Qr){Qr=!0;try{let t=ls();if(!t){document.getElementById(he)?.remove(),document.getElementById(zo)?.remove(),qo();return}let e=document.getElementById(he);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(zo)?.remove(),qo());return}e&&(e.remove(),document.getElementById(zo)?.remove());let o=await Wv();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ls();if(!a||a.oppId!==t.oppId)return;let s=Ud();s.id=he,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=zo,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Gv(t.oppId)}finally{Qr=!1}}},Wd=()=>{Rv(),Nv()};uv();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function It(t){return bt(t)}var Vv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",ue="ws-crm-compute-offer-button",bs="ws-crm-compute-offer-popover",Xd="ws-crm-offer-modal",Gd="ws-crm-contact-actions-bar",Yv=[".central-panel","[class*='central-panel']"],te=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",ps=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},Jv=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Kd=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${Jv[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Vd=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;outline:none;`,ms=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(Vv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},ze=()=>{document.getElementById(bs)?.remove(),document.removeEventListener("mousedown",tc,!0)};function tc(t){let e=document.getElementById(bs),o=document.getElementById(ue),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&ze()}var ec=(t,e)=>{ze();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=bs;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${h.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",tc,!0),0)},tn=(t,e)=>{ec(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},Qv=(t,e,o)=>{ec(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{ze(),o(a.property_record_id)}),r.appendChild(s)})})},on=()=>{document.getElementById(Xd)?.remove(),document.removeEventListener("keydown",oc,!0)};function oc(t){t.key==="Escape"&&on()}var Yd=(t,e,o)=>{on(),ze();let r=o,a=!1,s="",i=document.createElement("div");i.id=Xd,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${h.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&on()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,u,_)=>{a||(a=!0,s="",c(),ms({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:u,repairOverride:_}).then(b=>{b&&b.ok?r={...b,current_offer:b.current_offer??r.current_offer,current_offer_date:b.current_offer_date??r.current_offer_date}:s=b&&b.error||"Request failed."}).catch(b=>{p.error("[compute-offer] worksheet request failed:",b),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,u=!!m.has_comps;d.innerHTML="";let _=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),b=q("div","");b.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),b.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let g=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");g.type="button",g.addEventListener("click",on),_.append(b,g),d.appendChild(_);let x=q("div","padding:14px 18px 18px;");d.appendChild(x);let k=q("select",Vd());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",Vd());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let f=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");f.appendChild(q("div",`font-size:12px;color:${u?n.bone:n.amber};`,u?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${Kd(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${u?"transparent":n.blue};color:${u?n.blue:"#fff"};font-family:${h.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":u?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),f.append($),x.appendChild(f),m.low_confidence&&u&&x.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let A=m.current_offer!=null;x.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${A?n.bone:n.ash};`,A?`Last offer made: ${te(m.current_offer)}${m.current_offer_date?` \xB7 ${Kd(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=q("div","");w.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(w,E),x.appendChild(T);let S=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),B=(U,W,N)=>{let zt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),Nt=q("div","");Nt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&Nt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);zt.append(Nt,pt),S.appendChild(zt)};if(u&&m.imv!=null){B("Investor Market Value (IMV)",te(m.imv)),m.arv!=null&&B("After Repair Value (ARV)",te(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?B(`Repairs (${N})`,"Included",{color:n.ash,sub:`${te(m.repair_total)} in repairs included at IMV`}):B(`Repairs (${N})`,ps(W),{color:W<0?n.crimson:n.emerald,sub:`${te(m.repair_total)} total, ${te(m.baseline_repairs)} included at IMV`}),B("Min. Profit Target",ps(-(m.profit_target??0)),{color:n.ash}),B("Maximum Cash Offer (MAO)",te(m.mao),{strong:!0,color:n.blue}),B("Target Profit",ps(-(m.ico_delta??0)),{color:n.ash}),B("Initial Cash Offer (ICO)",te(m.ico),{strong:!0,color:n.blue})}else S.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));x.appendChild(S);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(u?"Saved to the Property.":""),x.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",oc,!0)},Jd=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=ue,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){Qv(o,i.properties,d=>{a(!0),ms({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Yd(e,l.property_record_id,l):tn(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),tn(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Yd(e,i.property_record_id,i):tn(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await ms({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),tn(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Zv=async()=>{for(let t of Yv)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Qd=async(t,e)=>{let o=e.querySelector(`#${Gd}`);if(!o)try{o=await P(`#${Gd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Zd=()=>{let t=document.querySelectorAll(`#${ue}`);for(let e=1;e<t.length;e++)t[e].remove()},Xv=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(ue)?.remove(),ze();return}let e=t.locationId,o=document.getElementById(ue);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),ze();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(ue)?.remove();return}let a=await Zv();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Jd(t.contactId,e);if(!await Qd(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}Zd(),p.debug(`[compute-offer] mounted for ${t.contactId}`),en?.disconnect(),en=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){en?.disconnect();return}if(!document.getElementById(ue)){let d=Jd(t.contactId,e);Qd(d,a).then(()=>Zd())}}),en.observe(a,{childList:!0})},en=null,jo=null,rc=()=>{let t=D()?.contactId??null;if(jo&&jo.id===t)return;let e=Xv().finally(()=>{jo?.promise===e&&(jo=null)});jo={id:t,promise:e}};var dn="reos-theme-stylesheet",kc="reos-theme-fonts",je=!1,ty=()=>{let t=document.getElementById(kc);t&&t.remove()},ey=`
...
`,oy=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],ry=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${s})`}return`rgb(${o}, ${r}, ${a})`},ny=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),ay=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],rn=new WeakSet,nc=t=>{try{if(!document.body)return;(t??document.body.querySelectorAll("*")).forEach(o=>{try{if(o.classList&&(o.classList.contains("hr-drawer-container")||o.classList.contains("hr-detached-container"))){(o.getAttribute("style")||"").includes("background")&&(o.style.removeProperty("background-color"),o.style.removeProperty("background-image"));return}if(rn.has(o)&&o.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest(".hl_header, header.hl_header, header.app-header")||o.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let r=o.tagName;if(r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||r==="SCRIPT"||r==="STYLE"||r==="SVG"||r==="PATH"||r==="IMG")return;let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||d<230||l<230||c<230)return;let u=o.style.getPropertyValue("background-color");if(u==="rgb(18, 22, 29)"){rn.add(o);return}if(o.closest(".hr-button")&&!(o.classList&&o.classList.contains("hr-button"))){u!=="transparent"&&(o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important")),rn.add(o);return}o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"),rn.add(o)}catch{}})}catch{}},hs=new WeakSet,Ne=()=>{document.querySelectorAll(ay.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(r.classList&&(r.classList.contains("hr-drawer-container")||r.classList.contains("hr-detached-container"))){(r.getAttribute("style")||"").includes("background")&&(r.style.removeProperty("background-color"),r.style.removeProperty("background-image"));return}if(hs.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH"||r.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if(!(d<230||l<230||c<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),hs.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),hs.add(r)}})})},ac=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},sc=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},ic=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},nn=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let d=+i[1],l=+i[2],c=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&d>=180&&l>=180&&c>=180&&d+l+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},lc=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},qe=()=>{if(!je)for(let t of oy){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let s=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),d=ny.has(r)?ry(a):a;s==="important"&&i===d||o.style.setProperty(r,a,"important")}})}},cn="#1A1F28",sy=26,iy=31,ly=40,dc=new Set,cc=new Set,an=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let a=o.getBoundingClientRect();if(a.width===0||a.height===0||a.width>800)return;o.style.setProperty("display","none","important");let s=o.className?.toString()||"<no class>";!cc.has(s)&&s!=="<no class>"&&(cc.add(s),p.debug(`Hid empty "--" leaf: "${s}"`))})},dy=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],cy=["trash","Trash","TRASH","delete","Delete","DELETE"],py=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(cy.some(s=>a.includes(s))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let d=i.getAttribute("d")||"";dy.some(l=>d.includes(l))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),d=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||d.includes("delete")||d.includes("remove")||d.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},my=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),by=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||my.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},pc=new Set,mc=new WeakSet,hy=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(mc.has(o)&&o.style.getPropertyValue("color")==="rgb(237, 238, 240)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let r=(o.className?.toString()||"").toLowerCase();if(r.includes("ai-button")||r.includes("ask-ai")||r.includes("bg-clip-text")||r.includes("text-transparent")||o.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let a=o.tagName.toLowerCase();if(a==="svg"||a==="path"||a==="circle"||a==="rect"||a==="polygon"||a==="polyline"||a==="line"||a==="g")return;let s=!1;for(let _ of Array.from(o.childNodes))if(_.nodeType===Node.TEXT_NODE&&(_.textContent||"").trim()){s=!0;break}if(!s)return;let i=Array.from(o.children);if(i.length>0&&i.every(_=>{let b=_.tagName.toLowerCase();return b==="svg"||b==="img"})&&!s)return;let c=window.getComputedStyle(o).color;if(!(c==="rgb(255, 255, 255)"||c==="rgba(255, 255, 255, 1)"||c==="#ffffff"||c==="white"))return;o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),mc.add(o);let u=o.className?.toString()||"<no class>";!pc.has(u)&&u!=="<no class>"&&(pc.add(u),p.debug(`Remapped pure-white text -> bone: "${u}"`))})},bc=new Set,uy=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let d=window.getComputedStyle(s),l=d.backgroundColor,c=d.backgroundImage||"",m=!1;if(c!=="none"&&c.includes("gradient"))m=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let A=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(A&&parseFloat(A[1])<.6)return;let T=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(T){let w=parseInt(T[1],10),E=parseInt(T[2],10),S=parseInt(T[3],10);(w>=60||E>=60||S>=60)&&(w>230&&E>230&&S>230||(w>=80||E>=80||S>=80)&&(m=!0))}}if(!m)return;let _=(s.textContent||"").trim(),b=i,g=Array.from(s.querySelectorAll("*")).map(A=>(A.className?.toString()||"").toLowerCase()).join(" "),x=_.toLowerCase()==="ask ai"||b.includes("ai-button")||b.includes("ask-ai")||b.includes("askai"),k=b.includes("bg-clip-text")||b.includes("text-transparent")||g.includes("bg-clip-text")||g.includes("text-transparent"),y=Array.from(s.querySelectorAll("*")).some(A=>{let T=window.getComputedStyle(A),w=T.getPropertyValue("-webkit-background-clip")||"",E=T.getPropertyValue("background-clip")||"";return w.includes("text")||E.includes("text")});if(x||k||y){let A=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],T=w=>{A.forEach(E=>w.style.removeProperty(E))};T(s),s.querySelectorAll("*").forEach(T);return}let f="#12161D";s.style.setProperty("color",f,"important"),s.querySelectorAll("*").forEach(A=>{let T=A.tagName.toLowerCase();T==="svg"||T==="path"||T==="circle"||T==="rect"||T==="polygon"||T==="polyline"||T==="line"||T==="g"?(A.style.setProperty("fill",f,"important"),A.style.setProperty("stroke",f,"important"),A.style.setProperty("color",f,"important")):(A.style.setProperty("color",f,"important"),A.style.setProperty("-webkit-text-fill-color",f,"important"))});let $=s.className?.toString()||"<no class>";!bc.has($)&&$!=="<no class>"&&(bc.add($),p.debug(`Darkened SVG icons on colored button: "${$}"`))})})},hc=new Set,_y=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(l=>{(l.getAttribute("style")||"").includes("translateY(11px)")&&l.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(l=>{let c=l;if(c.closest("[id^='ws-crm-']"))return;let m=l.getBoundingClientRect();if(m.width===0||m.width>28||m.height>28)return;let u=m.left<r.right&&m.right>r.left,_=m.top<r.bottom&&m.bottom>r.top;if(!(u&&_)||m.top+m.height/2<a)return;let g=m.width*m.height/(r.width*r.height);if(g>.55)return;let x=c,k=c.parentElement,y=0;for(;k&&k!==e&&y<3;){let $=k.getBoundingClientRect();if($.width>0&&$.width<=30&&$.height<=30)x=k;else break;k=k.parentElement,y++}x.style.setProperty("transform","translateY(11px)","important");let f=(x.className?.toString()||"")+" "+x.tagName;hc.has(f)||(hc.add(f),p.debug(`Dropped activity badge 11px (${m.width.toFixed(0)}x${m.height.toFixed(0)} icon, ratio ${g.toFixed(2)}): "${f}"`))})})},vy="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",yy=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",vy,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},uc=new Set,gy=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d>200&&l>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!uc.has(m)&&m!=="<no class>"&&(uc.add(m),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${d},${l},${c})): "${m}"`))})})},_c=new Set,fy=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let d=o.className?.toString()||"<no class>";!_c.has(d)&&d!=="<no class>"&&(_c.add(d),p.debug(`Painted Ask AI wrapper graphite: "${d}"`))}}o=o.parentElement,r++}})},vc=new Set,xy=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let d=a.getBoundingClientRect();d.width<240||d.height<120||d.width>1500||d.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let d=(i.className?.toString()||"").toLowerCase();if(d.includes("avatar")||d.includes("notification-dot")||d.includes("indicator"))return;if(d.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("tabulator")||d.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(d.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("ai-button")||d.includes("ask-ai")||d.includes("bg-clip-text")||d.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let c=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let m=parseInt(c[1],10),u=parseInt(c[2],10),_=parseInt(c[3],10);if(!(m>200&&u>200&&_>200))return;let g=i.getBoundingClientRect();if(g.width<24||g.height<16||g.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let x=i.className?.toString()||"<no class>";!vc.has(x)&&x!=="<no class>"&&(vc.add(x),p.debug(`Coerced light bg (${g.width.toFixed(0)}x${g.height.toFixed(0)}, rgb(${m},${u},${_})): "${x}"`))})})},yc=new Set,wy=t=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";(t??document.body.querySelectorAll("*")).forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']")||r.children.length>0)return;let a=(r.textContent||"").trim();if(a.length===0||a.length>80||a==="--"||r.closest(e)||r.closest("[class*='avatar'], [class*='hr-avatar']")||r.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||r.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(r.matches("[role='heading']")||r.closest("[role='heading']")||r.matches("h1, h2, h3")||r.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){r.matches("h1, h2, h3")&&(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let $=r.getAttribute("style")||"";($.includes("color")||$.includes("background"))&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"),r.style.removeProperty("background-color"));return}if(r.closest("#SettingTexasSmsBlock")||r.matches("p.ui-text-sm-medium")&&r.parentElement?.classList?.contains("flex")&&r.parentElement?.classList?.contains("items-center")&&r.parentElement?.children?.length===1){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-button, .n-button")||r.matches(".hr-button__content, .n-button__content")||r.closest(".hr-button__content, .n-button__content")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".bg-primary-50, [class*='bg-primary-50']")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}let s=r,i=null;for(let $=0;$<4&&s;$++){let A=s.nextElementSibling;if(A&&(A.matches(e)||A.querySelector(e)!==null)){i=A;break}s=s.parentElement}if(!i)return;let d=r.getBoundingClientRect();if(d.width===0||d.height===0||d.width>400||d.height>60)return;r.style.setProperty("color","#9098A3","important"),r.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,c=l.getBoundingClientRect(),m=l.className?.toString()||"",u=m.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,_=m.includes("hl-form-item")||m.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,b=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",g=(m.includes("hr-form-item-blank")||m.includes("hr-form-item")||l.matches(b))&&(l.matches(b)||l.querySelector(b)!==null);g&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let x=m.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=m.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=m.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!u&&!_&&!g&&!x&&!k&&!y&&c.width>0&&c.width<=800&&c.height>0&&c.height<=100&&(l.style.setProperty("background-color",cn,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let f=r.className?.toString()||"<no class>";!yc.has(f)&&f!=="<no class>"&&(yc.add(f),p.debug(`Colored field label "${a.slice(0,30)}": "${f}"`))})},gc=new Set,ky=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),d=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${d}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${d}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!gc.has(l)&&l!=="<no class>"&&(gc.add(l),p.debug(`Resized avatar text to ${d}px (circle ${i.toFixed(0)}px): "${l}"`))})},fc=new Set,Ey=new Set(["Enter Dashboard Name"]),$y=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Ey.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",cn,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",cn,"important"),a.style.setProperty("border-color","#252C36","important"));let s=e.className?.toString()||"<no class>";!fc.has(s)&&s!=="<no class>"&&(fc.add(s),p.debug(`Forced input slate bg: "${s}"`))})},sn=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.id==="chat-filter"||o.id==="phone-calls"||o.id==="archive-conversation"||o.id==="star-toggle"||o.id==="read-toggle"||o.id==="delete-conversation")return;if(o.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}let r=o.className?.toString()||"";if(r.includes("bg-inherit")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.closest(".pipeline-ribbon")&&r.split(" ").includes("count")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.split(" ").includes("tabulator-page")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(b=>r.includes(b))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("schedule-ui-form-weekly-schedule-checkbox")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("border-color")||b.includes("border-style")||b.includes("border-width"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"));return}if(r.includes("n-button")&&r.includes("icon-only")&&!r.includes("quaternary")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-button--tertiary-type")||r.includes("n-button--tertiary-type")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"),o.style.removeProperty("border-radius"));return}if(r.includes("hr-data-table-td")||r.includes("hr-data-table-tr")||r.includes("hr-data-table__body-cell")||r.includes("hr-data-table__cell")||r.includes("hr-data-table__header-cell")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-data-table-td--fixed-right")||r.includes("n-data-table-td--last-col")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.classList.contains("hr-tabs")||r.includes("hr-tabs-tab-wrapper")||r.includes("hr-tabs-nav")||r.includes("hr-tabs-nav-scroll-content")||r.includes("hr-tabs-content")||r.includes("hr-tabs-pane")||r.includes("hr-tabs-rail")||r.includes("hr-tabs-wrapper")||r.includes("hr-tabs-pane-wrapper")||r.includes("hr-tab-pane")){let b=o.getAttribute("style")||"";(b.includes("background-color: rgb(26, 31, 40)")||b.includes("background-color: #1A1F28")||b.includes("background-color: #1a1f28"))&&o.style.removeProperty("background-color");return}if(r.includes("hr-date-panel")||r.includes("n-date-panel")||o.closest(".hr-date-panel, .n-date-panel")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-tag")&&r.includes("ui-default")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if((r.includes("bg-purple-50")||r.includes("bg-purple-100"))&&(r.includes("rounded-lg")||r.includes("rounded-md")||r.includes("rounded-full"))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-alert")||o.closest(".n-alert")||r.includes("hl-warning")||r.includes("hl-error")||r.includes("hl-info")||r.includes("hl-success")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-card")||o.closest(".hr-card")||o.id&&o.id.startsWith("opportunity-")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("bg-gray-50")||r.includes("bg-gray-100")||r.includes("bg-gray-200")||r.includes("bg-white")||r.includes("bg-blue-50")||r.includes("bg-blue-100")||r.includes("bg-sky-50")||r.includes("bg-indigo-50")||r.includes("bg-slate-50")||r.includes("bg-neutral-50")||r.includes("bg-zinc-50")||r.includes("bg-stone-50")||r.includes("F7F9FD")||r.includes("F9FAFB")||r.includes("ECEEF2")||r.includes("eceef2")||r.includes("EFF4FF")||r.includes("eff4ff")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-collapse-item")||r.includes("hr-collapse hr-accordion")||r.includes("hr-accordion"))return;if(r.includes("sidebar-option-button")||o.closest(".sidebar-option-button")||o.closest("nav[class*='w-13']")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let b=o.getAttribute("style")||"";(b.includes("background-color")||b.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d<sy&&l<iy&&c<ly))return;let u=o.getBoundingClientRect();if(u.width===0||u.height===0||u.width>800||u.height>200)return;o.style.setProperty("background-color",cn,"important");let _=o.className?.toString()||"<no class>";!dc.has(_)&&_!=="<no class>"&&(dc.add(_),p.debug(`Coerced dark bg to slate (${u.width.toFixed(0)}x${u.height.toFixed(0)}, rgb(${d},${l},${c})): "${_}"`))})},ln=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1"),s.setAttribute("data-reos-recolored-v3","1");let d=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!d)return;let l;try{l=atob(d[1])}catch{return}let c=l,m=!1;if(e.forEach(b=>{c.includes(b)&&(c=c.split(b).join(t),m=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(b=>{c.includes(b)&&(c=c.split(b).join("transparent"),m=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(g=>{c.includes(g)&&(c=c.split(g).join("#EDEEF0"),m=!0)}),!!m)try{let b=btoa(c);s.setAttribute("src",`data:image/svg+xml;base64,${b}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let d=`url("${i}")`;s.style.setProperty("-webkit-mask-image",d,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",d,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",o)})},Wo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Ty=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Ue=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let d=window.getComputedStyle(i).backgroundColor;d==="rgba(0, 0, 0, 0)"||d==="transparent"||!d||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let s="rgb(150, 162, 173)",i="rgb(0, 191, 124)",d=c=>{let m=r.querySelector(".ui-upload-icon svg");m&&(m.style.setProperty("color",c,"important"),m.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(u=>{u.style.setProperty("stroke",c,"important")})},l=!1;try{l=r.matches(":hover")}catch{}d(l?i:s),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>d(i)),r.addEventListener("mouseleave",()=>d(s)))})},us=new WeakSet,Cy=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!us.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){us.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Zo}`,t.title=`Built ${Xo}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var fs="https://services.leadconnectorhq.com",$c="__WS_CRM_CAPTURED_AUTH";var Iy=()=>{try{let t=localStorage.getItem($c);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem($c),null):e:null}catch{return null}},My=()=>{let t=Iy();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},xs=async(t,e={})=>{let o=My();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Mc=new Set(["ej0SqnTYIprechAMAPrd"]),We="contact-select-trigger",Pc="ws-crm-reply-from-warning",Oc="contact-select-menu",Tc="ws-crm-rf-thread-opt",ws="",ks=!1,Ko=null,mn=null,Cc=!1,Vo="",Ac,ee=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Es=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Pt=t=>(t||"").replace(/\D/g,"").slice(-10),Lc=t=>{let e=Pt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Py=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Oy=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await xs(`${fs}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return ee("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},By=async()=>{let t=await Oy();if(!t)return null;let e=await xs(`${fs}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return ee("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Py(a);if(Pt(s).length===10)return s}return null},Ge=()=>document.getElementById(Pc)?.remove(),Bc=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Ry=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),Rc=(t,e,o)=>{Ge();let r=document.getElementById(We);if(!r)return;let a=Bc(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Pc,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Ry(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${Lc(t)}</span>${i}. You're set to reply from ${Lc(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Hy=t=>{Ko?.disconnect();let e=document.getElementById(We);if(!e)return;let o=Bc(e)||e,r=Pt(Es(e));Ko=new MutationObserver(()=>{let a=Es(document.getElementById(We)),s=Pt(a);!s||s===r||(r=s,s===Pt(t)?Ge():Rc(t,"",a))}),Ko.observe(o,{childList:!0,subtree:!0,characterData:!0})},Sc=()=>{let t=document.getElementById(Oc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Vo&&(r=e.find(d=>Pt(o(d))===Pt(Vo))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),ee("decorateMenu: cache=",Vo,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(Tc);s&&s!==r&&s.removeAttribute("id"),r.id=Tc;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Dy=()=>{if(!Mc.has(K()||""))return;mn?.disconnect();let t=0,e=()=>{let o=document.getElementById(Oc);if(o){Sc(),mn=new MutationObserver(()=>Sc()),mn.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Fy=t=>{let e=t.target;e&&e.closest&&e.closest("#"+We)&&(ee("From trigger clicked -> waiting for menu"),Dy())},zy=async()=>{if(!ks){ks=!0;try{let t=document.getElementById(We);if(!t)return;let e=Es(t),o=await By();if(Vo=o||"",ee("check: from=",e,"thread=",o),!o){Ge();return}Pt(e)&&Pt(e)!==Pt(o)?(ee("MISMATCH -> banner"),Rc(o,"",e)):(ee("match -> no banner"),Ge()),Hy(o)}finally{ks=!1}}},Ic=()=>{if(!Mc.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){ws="",Vo="",Ko?.disconnect(),mn?.disconnect(),Ge();return}let e=!!document.getElementById(We),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==ws){if(ws=r,!e){Ko?.disconnect(),Ge();return}ee("composer expanded on",o),zy()}},Hc=()=>{Ac===void 0&&(Ac=window.setInterval(Ic,500)),Cc||(document.addEventListener("click",Fy,!0),Cc=!0),Ic()};var Ny="#1A1F28",qy="#EDEEF0",$s="#9098A3",Uy=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},jy=t=>.2126*t.r+.7152*t.g+.0722*t.b,Wy=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},Dc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},Gy=t=>{let e=Uy(getComputedStyle(t).backgroundColor);if(!e||jy(e)<120)return;let o=Wy(e);t.style.setProperty("background-color",Ny,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),Dc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",qy),Dc(t,"#note-date-added-text, [class*='475467']",$s)},Ky=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",$s,"important"),e.style.setProperty("-webkit-text-fill-color",$s,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},Fc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)Gy(t[e]),Ky(t[e])},zc,Nc=()=>{zc===void 0&&(zc=window.setInterval(Fc,700)),Fc()};var Vy='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',qc=()=>{document.querySelectorAll(Vy).forEach(t=>{t.setAttribute("autocomplete","off")})},Uc,jc=()=>{Uc===void 0&&(Uc=window.setInterval(qc,1e3)),qc()};console.log("[ws-crm-customizer] bundle-loaded");var C=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Wc=()=>{p.info(`Loaded v${Zo} (built ${Xo})`),_n()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Go),C("mountDialerThemeFix",Ur)):(C("mountVersionBadge (initial)",pn),C("mountFavicon",Ci),C("mountThemeStylesheet",Go),C("mountHideLaunchpad",da),C("mountHideNavItems",ca),C("mountRelabelNav",pa),C("mountHideTopmenuTabs",ba),C("mountContractsSection",ma)),C("installOppIdCapture",Ps),C("initPageRouter",Ls),p.info("[main] registering onPageChange subscriber"),Et(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),_n()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Go),C("runThemeFastPass",gs),C("mountDialerThemeFix",Ur),C("unmountContactMapLinks",Qi);return}C("mountThemeStylesheet",Go),C("runThemeFastPass",gs),C("mountVersionBadge",pn),C("mountHideLaunchpad",da),C("mountHideNavItems",ca),C("mountRelabelNav",pa),C("mountHideTopmenuTabs",ba),C("mountContractsSection",ma),C("mountAnalyticsDashboard",Ws),C("mountClaimReleaseToggle",bi),C("mountContactActionsBar",$i),C("mountActiveFollowUpButton",zs),C("mountMtOfferMadeButton",Ii),C("mountNotInterestedButton",Mi),C("mountScheduleWalkthroughButton",Pi),C("mountResendDealLinkButton",Bi),C("mountReducePriceButton",Hi),C("mountEditLandingPageButton",Di),C("mountPublishButton",qi),C("mountContactMapLinks",Ji),C("mountSendToClosingOfficeButton",pl),C("mountOppActionBar",Cl),C("mountClosingAgentPickerButton",Td),C("mountPrepareContractButton",Wd),C("mountComputeOfferButton",rc),C("mountManageTeam",Id),C("mountBuyBoxWidget",Qs),C("mountSellerContactFlag",di),C("mountPropertiesWidget",ii),C("mountSupportNavItem",Bl),C("mountPhoneAssignmentsWidget",Nl),C("mountBulkPowerDialer",id),C("mountBulkPowerDialerContacts",cd),C("mountCallingAsChip",hd),C("mountDialerThemeFix",Ur),C("mountReplyFromWarning",Hc),C("mountNoteCanon",Nc),C("mountSuppressAutofill",jc)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wc):Wc();})();
