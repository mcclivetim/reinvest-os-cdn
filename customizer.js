/* Wholesaling CRM Customizer v0.37.0 — built 2026-06-14T01:38:08.960Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Vt="[wholesaling-crm-customizer]",Ws="__WS_CRM_DEBUG",js=()=>!!window[Ws],c={info(...t){console.log(Vt,...t)},warn(...t){console.warn(Vt,...t)},error(...t){console.error(Vt,...t)},debug(...t){js()&&console.log(Vt,"[debug]",...t)}};var Ks=/\/v2\/location\/([A-Za-z0-9]+)/,Ys=new Set(["8ntUQzMflUkR0YvrRgVk"]),xe=()=>{let t=window.location.pathname.match(Ks);return t?t[1]:null},or=()=>{let t=xe();return t!==null&&Ys.has(t)};var Zn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,rr=/\/v2\/location\/([A-Za-z0-9]+)/,Js=t=>{let e=t.match(Zn);if(!e)return null;let o=t.match(rr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Xs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Zn);if(!a)continue;let i=r.match(rr)||window.location.pathname.match(rr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},B=()=>{let t=Js(window.location.pathname);return t||Xs()};var ea=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},jt="",nr=null,ze="other",ar=new Set,Wt=()=>{let t=B()?.contactId??null;if(!(!(window.location.pathname!==jt)&&!(t!==nr))){jt=window.location.pathname,nr=t,ze=ea(),c.debug("Page/context changed:",ze,jt,"contact:",t);for(let r of ar)try{r(ze)}catch(a){c.error("Subscriber threw:",a)}}},Ge=t=>(ar.add(t),setTimeout(()=>t(ze),0),()=>{ar.delete(t)}),ta=()=>{ze=ea(),jt=window.location.pathname,nr=B()?.contactId??null,c.debug("Router init, current page:",ze);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Wt()},history.replaceState=function(o,r,a){e(o,r,a),Wt()},window.addEventListener("popstate",Wt),setInterval(Wt,1e3)};var Kt="0.37.0",Yt="2026-06-14T01:38:08.961Z";var I=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,b,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),b!==void 0&&window.clearInterval(b)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),b=window.setInterval(()=>{let h=a.querySelector(t);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ir={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},oa=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,L=`
  ...
  flex-shrink: 0;
`;var Qs=/^[A-Za-z0-9]{15,30}$/,st=t=>typeof t=="string"&&Qs.test(t),ra=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Zs=()=>{let t=window.WS_CRM_USER_ID;return st(t)?t:null},el=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(st(o))return o;return null},tl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ra(e);if(!o)return null;let r=o.uid;if(st(r))return r;let a=o.claims;if(a&&st(a.user_id))return a.user_id}catch{}return null},ol=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(st(a))return a}catch{}}}catch{}return null},O=()=>Zs()||el()||tl()||ol()||null,rl=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=ra(e);return o?o.claims??o:null}catch{return null}},Jt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:rl()?.type==="agency"};var sa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",nl=`${sa}/active-follow-up-get`,al=`${sa}/active-follow-up-set`,Le="ws-crm-active-follow-up-button",lr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},il=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},sl=async t=>{let e=await fetch(nl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ll=async(t,e)=>{let o=await fetch(al,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Me=(t,e)=>{let o=lr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},na=t=>{let e=document.createElement("button");return e.type="button",e.id=Le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Me(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=il();if(!(!r||r.contactId!==t)){Me(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await ll(r,O()),i=a&&a.state&&a.state in lr?a.state:"blue";Me(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Me(e,"error"),setTimeout(()=>void Xt(e,r),4e3)}}}),e},Xt=async(t,e)=>{Me(t,"loading");try{let o=await sl(e),r=o&&o.state&&o.state in lr?o.state:"gray",a=document.getElementById(Le);if(!a||a.dataset.contactId!==e.contactId)return;Me(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Me(t,"error")}},dl=[".central-panel","[class*='central-panel']"],sr="ws-crm-contact-actions-bar",cl=async()=>{for(let t of dl)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await I("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},pl=async(t,e)=>{let o=e.querySelector(`#${sr}`);if(!o)try{o=await I(`#${sr}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${sr}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},bl=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},hl=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},ml=async t=>{if(t==="url"){let o=await cl();return o?{kind:"contact-detail",target:o}:null}let e=bl();return e?{kind:"conversations",target:e}:null},aa=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await pl(t,e.target);return o}return hl(t,e.target),"conversations-header"},ul=async()=>{let t=B();if(!t||!t.locationId){document.getElementById(Le)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Le);if(o&&o.dataset.contactId===e.contactId){Xt(o,e);return}o&&o.remove();let r=await ml(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=B();if(!a||a.contactId!==e.contactId)return;let i=na(e.contactId),s=await aa(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),ia();let l=document.getElementById(Le)??i;Xt(l,e);let d=new MutationObserver(()=>{let b=document.getElementById(Le);if(!(B()?.contactId===e.contactId)){d.disconnect();return}if(!b){let m=na(e.contactId);aa(m,r).then(()=>{ia(),Xt(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},lt=null,la=()=>{let t=B()?.contactId??null;if(lt&&lt.contactId===t)return;let e=ul().finally(()=>{lt?.promise===e&&(lt=null)});lt={contactId:t,promise:e}},ia=()=>{let t=document.querySelectorAll(`#${Le}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var vl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",dt=new Map,qe=async(t,e)=>{if(!t)return null;if(dt.has(t))return dt.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${vl}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),dt.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return dt.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),dt.set(t,null),null}};var Ue=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var pa="ws-buybox-nav-icon",pr="ws-buybox-panel",da="ws-buybox-modal",_l="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",br="https://mcclivetim.github.io/reinvest-os-cdn/geo",Qt=null,ct=null,pt=null,cr=async()=>{if(Qt)return Qt;try{let t=await fetch(`${br}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Qt=await t.json(),Qt}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},gl=async t=>{if(!ct)try{let e=await fetch(`${br}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ct=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return ct?.[t]??[]},yl=async t=>{if(!pt)try{let e=await fetch(`${br}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);pt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return pt?.[t]??[]},hr=async t=>await(await fetch(_l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),fl=(t,e)=>hr({tenant_id:t,action:"list",buyer_contact_id:e}),xl=(t,e,o,r)=>hr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),wl=(t,e)=>hr({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),kl=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},El='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Tl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Sl="nav.w-13, nav[class*='w-13']",Cl=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Al=async()=>{try{return await I(Sl,{timeoutMs:2500})}catch{return null}},$l=async()=>{try{return await I(Cl,{timeoutMs:2500})}catch{return null}},Il=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Ll=(t,e)=>{let o=document.createElement("div");return o.id=pr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Hl(t,e,()=>mr(t,e))}),o},mr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([fl(t,e),cr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Ml(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Ml=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let b=e[d.key].map(p=>{let m=d.key==="state"?kl(p.geo_value,o):p.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${G(m)}</span>
              <button type="button" data-entry-id="${G(p.id)}" data-entry-label="${G(m)}" class="ws-buybox-remove" aria-label="Remove ${G(m)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${Tl}</button>
            </div>
          `}).join("");return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let b=d.dataset.entryId||"",p=d.dataset.entryLabel||"this area";confirm(`Remove "${p}" from this buyer's buy-box?`)&&(d.disabled=!0,wl(r,b).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}mr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Zt=!1,ba=(t,e)=>{Zt=e;let o=Il(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Ol,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",mr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=ha,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},ha="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ol="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Dl=t=>{let e=document.createElement("button");return e.id=pa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=ha,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${El.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Zt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),ba(r,a)}),e},Hl=(t,e,o)=>{let r=document.getElementById(da);r&&r.remove();let a=document.createElement("div");a.id=da,a.style.cssText=`
  ...
  `,b=()=>{i.querySelectorAll(".ws-buybox-tile").forEach(w=>{w.addEventListener("mouseenter",()=>{w.style.borderColor=n.emerald,w.style.background=n.emeraldGlow}),w.addEventListener("mouseleave",()=>{w.style.borderColor=n.steel,w.style.background=n.steel}),w.addEventListener("click",()=>{let T=w.dataset.granularity;s.granularity=T,s.step=T==="zip"?3:2,l()})}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove())},p=()=>`
  ...
  `,y=w=>{let T=w.find($=>$.code===s.stateCode);return`
    ...
    `},k=w=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},f=w=>{let T=s.granularity==="county"?ct?.[s.stateCode||""]??[]:pt?.[s.stateCode||""]??[];return`
    ...
    `},g=()=>{let w=s.granularity==="county"?ct?.[s.stateCode||""]??[]:pt?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),$=i.querySelector("#ws-buybox-value-list");if(!T||!$)return;let P=q=>{let z=q.toLowerCase().trim();if(!z){$.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let N=w.filter(R=>R.toLowerCase().includes(z)).slice(0,50);if(N.length===0){$.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(s.stateCode||"")}.</div>`;return}$.innerHTML=N.map(R=>`
  ...
  `,S=()=>{let w=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),w.addEventListener("keydown",$=>{$.key==="Enter"&&($.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>w.focus(),0))},C=async()=>{let w=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),$=(w?.value||"").trim();if(!/^\d{5}$/.test($)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E($)},E=async w=>{if(!s.granularity||!w)return;let T=i.querySelector("#ws-buybox-err"),$=i.querySelector("#ws-buybox-save");$&&($.disabled=!0,$.textContent="Adding\u2026"),T&&(T.textContent="");try{let P=await xl(t,e,s.granularity,w);if(!P.ok){T&&(T.textContent=P.error||"Failed to add entry."),$&&($.disabled=!1,$.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(P){T&&(T.textContent=`Network error: ${P.message}`),$&&($.disabled=!1,$.textContent="Add")}};l()},dr=!1,Ve=null,bt=null,ca=()=>{document.getElementById(pa)?.remove(),document.getElementById(pr)?.remove(),bt&&Ve&&Ve.nav.removeEventListener("click",bt,!0),bt=null,Ve=null,Zt=!1},ma=()=>{Pl()},Pl=async()=>{if(!dr){dr=!0;try{let t=B();if(!t){ca();return}let e=document.getElementById(pr);if(e&&e.dataset.buyerContactId===t.contactId&&Ve)return;ca();let o=null;try{o=await qe(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(Ue(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Al(),$l()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=B();if(!s||s.contactId!==t.contactId)return;let l=Ll(t.locationId,t.contactId),d=Dl(()=>Ve),b={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ve=b;let p=a.querySelector(".flex.flex-col.items-center.gap-2");p?p.appendChild(d):a.appendChild(d),i.appendChild(l),bt=m=>{let h=m.target;if(!h||b.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Zt&&ba(b,!1)},a.addEventListener("click",bt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{dr=!1}}};var we="ws-crm-claim-release-pill",Rl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Bl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Fl=async t=>{let e=await fetch(Rl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Nl=async t=>{let e=await fetch(Bl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},_a=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},We=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=oa(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},zl=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=we,o.type="button",o.dataset.contactId=t,We(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=B();if(!a||!a.locationId||a.contactId!==t)return;let i=O();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>We(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";We(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Nl({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;We(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),We(o,r);let d=o.querySelector(".ws-cr-label");if(d){let b=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=b)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},ua=async(t,e)=>{try{let o=await Fl({contactId:e.contactId,locationId:e.locationId,userId:O()}),r=document.getElementById(we);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";We(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Gl=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=_a(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},va=(t,e)=>{let o=zl({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${we}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},ql=async()=>{let t=B();if(!t){document.getElementById(we)?.remove();return}let e=document.getElementById(we);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await I("#record-details-lhs",{timeoutMs:1e4}),r=await Gl(o),a=B();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}va(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(we);i&&t.locationId&&ua(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(B()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(we))return;let d=_a(o);if(d){va(d,t.contactId);let b=document.getElementById(we);b&&t.locationId&&ua(b,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},ga=()=>{ql()};var Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ul="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Vl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Wl=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||Ta,d;if(s==="buyer"){let p=Sa.find(h=>h.label===o),m=p?p.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:o,triggered_by_user_id:r??""};a&&(p.dead_reason=a),d={contact_id:t,location:{id:e},customData:p}}let b=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!b.ok)throw new Error(`Webhook returned ${b.status} ${b.statusText}`)},jl=async({contactId:t,tenantId:e})=>{let o=await fetch(Vl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var je="ws-crm-contact-actions-bar",Kl="ws-crm-call-status-dropdown",ya="ws-crm-offer-made-modal",Yl=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Sa=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Jl=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Xl=async()=>{for(let t of Jl)try{let e=await I(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await I("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Ql=({contactId:t,kind:e})=>{let o=e==="buyer"?Sa:Yl,r=e==="buyer"?Ul:Ta,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Kl,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=L,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let l=document.createElement("div");return l.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,o.forEach(d=>{let b=document.createElement("button");b.type="button",b.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
  ...
  `;let l=document.createElement("div");l.style.cssText=`
    ...
    color: ${n.bone};
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
  `;let d=new Date,b=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),p=o?`
    <label style="
      display: block;
      font-family: ${u.mono};
      font-size: 10px;
      ...
      margin-bottom: 6px;
    ">Offer Expires</label>
    <input id="ws-offer-expires" type="date" value="${b}"
      style="
        width: 100%;
        background: ${n.slate};
        border: 1px solid ${n.steel};
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},wa=(t,e)=>{let o=document.createElement("div");if(o.id=je,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=L,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>td(t,e)),o.appendChild(r),o.appendChild(Ql({contactId:t,kind:e}))}return o},ur=!1,ka=()=>{document.querySelectorAll(`[id="${je}"]`).forEach(t=>t.remove())},Ca=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),ur){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}ur=!0;try{await nd()}finally{ur=!1}},nd=async()=>{let t=B();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),ka();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),ka();return}let e="seller";try{let b=await qe(t.contactId,t.locationId),p=Ue(b);p==="buyer"?e="buyer":p==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${b??"(null)"})`)}catch(b){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",b)}let o=B();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${je}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(b=>b.remove()));let a=await Xl();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=B();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=wa(t.contactId,e)}catch(b){c.error("[actions-bar:08-FAIL] buildBar threw:",b);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(b){c.error("[actions-bar:09-FAIL] insertBefore threw:",b);return}if(!document.getElementById(je)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(B()?.contactId===t.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${je}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,h=wa(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},Ea=null,ad=()=>{Ea===null&&(Ea=window.setInterval(()=>{let t=B();t&&(document.getElementById(je)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ca()))},3e3))},Aa=()=>{ad(),Ca()};var eo="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",id=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),ht="data-ws-crm-favicon",vr=t=>t.hasAttribute(ht),$a=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return id.has(e)},to=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{$a(r)&&!vr(r)&&r.remove()});let e=document.head.querySelector(`link[${ht}="1"]`);e?e.href!==eo&&(e.href=eo):(e=document.createElement("link"),e.setAttribute(ht,"1"),e.rel="icon",e.type="image/png",e.href=eo,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${ht}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(ht,"apple"),o.rel="apple-touch-icon",o.href=eo,document.head.appendChild(o))},Ia=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)to();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),to())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&$a(s)&&!vr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&vr(s)&&(a=!0)});a&&to()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,to(),e>=5&&window.clearInterval(o)},1e3)};var sd=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],ld=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,dd=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(dd);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(ld);if(a){let i=a[1];if(sd.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var La="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(La);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=La,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var cd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ae="ws-crm-mt-offer-made-button",Ma="ws-crm-mt-offer-made-modal",pd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,bd=/\/v2\/location\/([A-Za-z0-9]+)/,no=()=>{let t=window.location.pathname,e=t.match(pd);if(!e)return null;let o=t.match(bd);return{oppId:e[1],locationId:o?o[1]:null}},hd=async t=>{let e=await fetch(cd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},oo=()=>{document.getElementById(Ma)?.remove()},md=t=>{oo();let e=document.createElement("div");e.id=Ma,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&oo()}),i?.addEventListener("click",()=>oo()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let b=Number(d);if(b<100){a.textContent=`That looks low \u2014 did you mean $${(b*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let p=await hd({oppId:t.oppId,locationId:t.locationId,amount:b,userId:O()});if(!p.ok){a.textContent=p.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}oo(),t.onSuccess()}catch(p){c.error("MT Offer Made webhook failed",p),a.textContent=p instanceof Error?p.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},ud=t=>{let e=document.createElement("button");return e.id=ae,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=no();!o||!o.locationId||o.oppId!==t||md({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},vd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_d=async()=>{for(let t of vd)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ro=!1,fr=async()=>{if(!ro){ro=!0;try{await gd()}finally{ro=!1}}},gd=async()=>{let t=no();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ut();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ut());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await _d();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=no();if(!a||a.oppId!==t.oppId)return;let i=ud(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),yd(t.oppId)},mt=null,yr=null,ut=()=>{mt?.disconnect(),mt=null,yr=null},yd=t=>{if(mt&&yr===t)return;ut();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(yr=t,mt=new MutationObserver(()=>{let o=no();if(!o||o.oppId!==t){ut();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),ut();return}document.getElementById(ae)||fr()}),mt.observe(e,{childList:!0,subtree:!0}))},_r=null,gr,fd=()=>{_r||(_r=new MutationObserver(()=>{gr===void 0&&(gr=window.setTimeout(()=>{gr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!ro&&fr()},300))}),_r.observe(document.body,{childList:!0,subtree:!0}))},Oa=()=>{fd(),fr()};var xd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ie="ws-crm-not-interested-button",wd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,kd=/\/v2\/location\/([A-Za-z0-9]+)/,io=()=>{let t=window.location.pathname,e=t.match(wd);if(!e)return null;let o=t.match(kd);return{oppId:e[1],locationId:o?o[1]:null}},Ed=async t=>{let e=await fetch(xd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Td=t=>{let e=document.createElement("button");return e.id=ie,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=io();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await Ed({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Sd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Cd=async()=>{for(let t of Sd)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ao=!1,Er=async()=>{if(!ao){ao=!0;try{await Ad()}finally{ao=!1}}},Ad=async()=>{let t=io();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),_t();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),_t());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await Cd();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=io();if(!a||a.oppId!==t.oppId)return;let i=Td(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),$d(t.oppId)},vt=null,kr=null,_t=()=>{vt?.disconnect(),vt=null,kr=null},$d=t=>{if(vt&&kr===t)return;_t();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kr=t,vt=new MutationObserver(()=>{let o=io();if(!o||o.oppId!==t){_t();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),_t();return}document.getElementById(ie)||Er()}),vt.observe(e,{childList:!0,subtree:!0}))},xr=null,wr,Id=()=>{xr||(xr=new MutationObserver(()=>{wr===void 0&&(wr=window.setTimeout(()=>{wr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!ao&&Er()},300))}),xr.observe(document.body,{childList:!0,subtree:!0}))},Da=()=>{Id(),Er()};var Ld="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",re="ws-crm-schedule-walkthrough-button",Tr="ws-crm-schedule-walkthrough-modal",Md=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Od=/\/v2\/location\/([A-Za-z0-9]+)/,co=()=>{let t=window.location.pathname,e=t.match(Md);if(!e)return null;let o=t.match(Od);return{oppId:e[1],locationId:o?o[1]:null}},so=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Dd=(t,e)=>{document.getElementById(Tr)?.remove();let o=document.createElement("div");o.id=Tr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Tr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",b=document.getElementById("wsw-dur")?.value||"30";if(!d){so("Pick a date and time.","err");return}let p=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(Ld,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:p,duration_min:Number(b)}),credentials:"omit"})).ok){s(),so("Walkthrough scheduled \u2713");let h=document.querySelector(`#${re} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",so("Scheduling failed \u2014 try again.","err")}catch(m){c.warn("[schedule-walkthrough] failed:",m),l.disabled=!1,l.textContent="Schedule",so("Couldn't reach the scheduler. Try again.","err")}})},Hd=t=>{let e=document.createElement("button");return e.id=re,e.type="button",e.dataset.oppId=t,e.style.cssText=L,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=co();!o||!o.locationId||o.oppId!==t||Dd(o.oppId,o.locationId)}),e},Pd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Rd=async()=>{for(let t of Pd)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},lo=!1,$r=async()=>{if(!lo){lo=!0;try{await Bd()}finally{lo=!1}}},Bd=async()=>{let t=co();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),yt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),yt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await Rd();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=co();if(!a||a.oppId!==t.oppId)return;let i=Hd(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Fd(t.oppId)},gt=null,Ar=null,yt=()=>{gt?.disconnect(),gt=null,Ar=null},Fd=t=>{if(gt&&Ar===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ar=t,gt=new MutationObserver(()=>{let o=co();if(!o||o.oppId!==t){yt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),yt();return}document.getElementById(re)||$r()}),gt.observe(e,{childList:!0,subtree:!0}))},Sr=null,Cr,Nd=()=>{Sr||(Sr=new MutationObserver(()=>{Cr===void 0&&(Cr=window.setTimeout(()=>{Cr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!lo&&$r()},300))}),Sr.observe(document.body,{childList:!0,subtree:!0}))},Ha=()=>{Nd(),$r()};var zd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ke="ws-crm-resend-deal-link-wrap",Gd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,qd=/\/v2\/location\/([A-Za-z0-9]+)/,bo=()=>{let t=window.location.pathname,e=t.match(Gd);if(!e)return null;let o=t.match(qd);return{oppId:e[1],locationId:o?o[1]:null}},Ud=async t=>{let e=await fetch(zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Vd=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Pa=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Or=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=L,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Pa(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Wd(t,e)),t.appendChild(o)},Wd=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let b=document.createElement("button");return b.type="button",b.textContent=l,b.style.cssText=a,b.addEventListener("click",()=>void jd(t,e,d,o)),b};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Or(t,e)),o.appendChild(s),t.appendChild(o)},jd=async(t,e,o,r)=>{let a=bo();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Ud({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${Pa(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Vd(s)}</span>`}window.setTimeout(()=>Or(t,e),3500)}},Kd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yd=async()=>{for(let t of Kd)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},po=!1,Dr=async()=>{if(!po){po=!0;try{await Jd()}finally{po=!1}}},Jd=async()=>{let t=bo();if(!t||!t.locationId){document.getElementById(Ke)?.remove(),xt();return}let e=document.getElementById(Ke);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),xt());return}e&&e.remove();let o=await Yd();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=bo();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ke,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),Or(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Xd(t.oppId)},ft=null,Mr=null,xt=()=>{ft?.disconnect(),ft=null,Mr=null},Xd=t=>{if(ft&&Mr===t)return;xt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Mr=t,ft=new MutationObserver(()=>{let o=bo();if(!o||o.oppId!==t){xt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ke)?.remove(),xt();return}document.getElementById(Ke)||Dr()}),ft.observe(e,{childList:!0,subtree:!0}))},Ir=null,Lr,Qd=()=>{Ir||(Ir=new MutationObserver(()=>{Lr===void 0&&(Lr=window.setTimeout(()=>{Lr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ke)&&!po&&Dr()},300))}),Ir.observe(document.body,{childList:!0,subtree:!0}))},Ra=()=>{Qd(),Dr()};var Zd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",se="ws-crm-reduce-price-button",Ba="ws-crm-reduce-price-modal",ec=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,tc=/\/v2\/location\/([A-Za-z0-9]+)/,uo=()=>{let t=window.location.pathname,e=t.match(ec);if(!e)return null;let o=t.match(tc);return{oppId:e[1],locationId:o?o[1]:null}},oc=async t=>{let e=await fetch(Zd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ho=()=>{document.getElementById(Ba)?.remove()},rc=t=>{ho();let e=document.createElement("div");e.id=Ba,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let b=r.value.replace(/[^0-9.]/g,"").split(".");r.value=b[0]+(b.length>1?"."+b.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&ho()}),i?.addEventListener("click",()=>{ho()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let b=parseFloat(d);if(!Number.isFinite(b)||b<=0){a.textContent="Price must be a positive number.",r.focus();return}if(b<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(b*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await oc({oppId:t.oppId,locationId:t.locationId,newPrice:b,userId:O()}),ho(),t.onSuccess()}catch(p){c.error("Reduce Price webhook failed",p),a.textContent=p instanceof Error?p.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},nc=(t,e)=>{let o=document.createElement("button");return o.id=se,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=uo();!r||!r.locationId||r.oppId!==t||rc({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=L,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},ac=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ic=async()=>{for(let t of ac)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},mo=!1,Br=async()=>{if(!mo){mo=!0;try{await sc()}finally{mo=!1}}},sc=async()=>{let t=uo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await ic();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=uo();if(!a||a.oppId!==t.oppId)return;let i=nc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),lc(t.oppId)},wt=null,Rr=null,kt=()=>{wt?.disconnect(),wt=null,Rr=null},lc=t=>{if(wt&&Rr===t)return;kt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Rr=t,wt=new MutationObserver(()=>{let o=uo();if(!o||o.oppId!==t){kt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),kt();return}document.getElementById(se)||Br()}),wt.observe(e,{childList:!0,subtree:!0}))},Hr=null,Pr,dc=()=>{Hr||(Hr=new MutationObserver(()=>{Pr===void 0&&(Pr=window.setTimeout(()=>{Pr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!mo&&Br()},300))}),Hr.observe(document.body,{childList:!0,subtree:!0}))},Fa=()=>{dc(),Br()};var Ye="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",vo="deals.reinvestos.com";var le="ws-crm-edit-landing-button",cc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pc=/\/v2\/location\/([A-Za-z0-9]+)/,go=()=>{let t=window.location.pathname,e=t.match(cc);if(!e)return null;let o=t.match(pc);return{oppId:e[1],locationId:o?o[1]:null}},bc=(t,e)=>{let o=new URL(`https://${vo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ye);let r=O();return r&&o.searchParams.set("user",r),o.toString()},hc=(t,e)=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=go();if(!r||!r.locationId||r.oppId!==t)return;if(!Ye){c.warn("[edit-landing] editor session key not configured in this build");return}let a=bc(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},mc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],uc=async()=>{for(let t of mc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_o=!1,Gr=async()=>{if(!_o){_o=!0;try{await vc()}finally{_o=!1}}},vc=async()=>{let t=go();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await uc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=go();if(!a||a.oppId!==t.oppId)return;let i=hc(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),_c(t.oppId)},Et=null,zr=null,Tt=()=>{Et?.disconnect(),Et=null,zr=null},_c=t=>{if(Et&&zr===t)return;Tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(zr=t,Et=new MutationObserver(()=>{let o=go();if(!o||o.oppId!==t){Tt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),Tt();return}document.getElementById(le)||Gr()}),Et.observe(e,{childList:!0,subtree:!0}))},Fr=null,Nr,gc=()=>{Fr||(Fr=new MutationObserver(()=>{Nr===void 0&&(Nr=window.setTimeout(()=>{Nr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!_o&&Gr()},300))}),Fr.observe(document.body,{childList:!0,subtree:!0}))},Na=()=>{gc(),Gr()};var Ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Je="ws-crm-publish-button",St="ws-crm-publish-wrap",fo="ws-crm-publish-dropdown",yc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fc=/\/v2\/location\/([A-Za-z0-9]+)/,Vr=()=>{let t=window.location.pathname,e=t.match(yc);if(!e)return null;let o=t.match(fc);return{oppId:e[1],locationId:o?o[1]:null}},xc=async(t,e)=>{try{let o=await fetch(Ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},wc=async(t,e)=>{let o=await fetch(Ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},kc=(t,e)=>{if(!Ye){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${vo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ye);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ve=()=>{document.getElementById(fo)?.remove()},za=(t,e,o,r,a)=>{ve();let i=document.createElement("div");i.id=fo;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${u.sans};
  `;let l=t.length,d=t.filter(k=>k.filled).length,b=d===l,p=document.createElement("div");p.innerHTML=`
    <div style="
      font-family: ${u.mono}; font-size: 10px; letter-spacing: 0.14em;
      text-transform: uppercase; color: ${b?n.emerald:n.amber};
      margin-bottom: 4px;
    ">${b?"Ready to publish":"Finish the landing page"}</div>
    <div style="font-size: 14px; font-weight: 500; color: ${n.bone}; margin-bottom: 8px;">${d} of ${l} ready</div>
  `,i.appendChild(p),t.forEach(k=>{let f=document.createElement("div");f.style.cssText=`
  ...
  `;let h=document.createElement("button");h.type="button",h.textContent="Open editor to finish \u2192",h.style.cssText=`
    ...
    color: ${n.emerald};
  `,h.addEventListener("click",k=>{k.stopPropagation(),kc(o,r)}),m.appendChild(h);let _=document.createElement("button");_.type="button",_.textContent="Re-check",_.title="Re-check after editing the page",_.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,_.addEventListener("click",k=>{k.stopPropagation(),ve(),a()}),m.appendChild(_),i.appendChild(m),document.body.appendChild(i);let y=k=>{let f=k.target;!i.contains(f)&&!e.contains(f)&&(ve(),document.removeEventListener("click",y))};window.setTimeout(()=>document.addEventListener("click",y),0)},Oe=(t,e)=>{let o=t.querySelector(".ws-pub-label"),r=t.querySelector(".ws-pub-dot"),a=t.querySelector(".ws-pub-chevron"),i="transparent",s=n.steel,l=n.bone,d=n.coolGray,b="Publish Deal",p="",m="pointer",h="1";switch(e.status){case"checking":s=n.steel,l=n.ash,b="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,b="Publish Deal";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,y=e.checks?.length??0;s=n.amber,l=n.amber,d=n.amber,b=`${_} of ${y} ready`,p="\u25BE";break}case"publishing":i=n.emerald,s=n.emerald,l=n.obsidian,d=n.obsidian,b="Publishing\u2026",m="wait",h="0.8";break;case"published":i="transparent",s=n.steel,l=n.ash,d=n.emerald,b="Deal Published",m="default",h="0.9";break;case"error":s=n.amber,l=n.amber,d=n.amber,b=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="published"?`0 0 6px ${d}`:""),o&&(o.textContent=b),a&&(a.textContent=p)},Ec=(t,e)=>{let o=document.createElement("button");o.id=Je,o.type="button",o.dataset.oppId=t,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${K}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};Oe(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await xc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Oe(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Oe(o,r),document.getElementById(fo)&&r.checks&&za(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Oe(o,r),ve();try{let m=await wc(t,e);if(m.ok&&m.published)r={status:"published"},Oe(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Oe(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Oe(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(fo)?ve():r.checks&&za(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),b=8e3,p=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(p){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,b-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(p,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},Tc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sc=async()=>{for(let t of Tc)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yo=!1,jr=async()=>{if(!yo){yo=!0;try{await Cc()}finally{yo=!1}}},Cc=async()=>{let t=Vr();if(!t||!t.locationId){document.getElementById(Je)?.remove(),document.getElementById(St)?.remove(),ve(),At();return}let e=document.getElementById(Je);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(St)?.remove(),ve(),At());return}e&&(e.remove(),document.getElementById(St)?.remove(),ve());let o=await Sc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Vr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=Ec(t.oppId,a.locationId),s=document.createElement("span");s.id=St,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),Ac(t.oppId)},Ct=null,Wr=null,At=()=>{Ct?.disconnect(),Ct=null,Wr=null},Ac=t=>{if(Ct&&Wr===t)return;At();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Wr=t,Ct=new MutationObserver(()=>{let o=Vr();if(!o||o.oppId!==t){At();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(Je)?.remove(),document.getElementById(St)?.remove(),ve(),At();return}document.getElementById(Je)||jr()}),Ct.observe(e,{childList:!0,subtree:!0}))},qr=null,Ur,$c=()=>{qr||(qr=new MutationObserver(()=>{Ur===void 0&&(Ur=window.setTimeout(()=>{Ur=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Je)&&!yo&&jr()},300))}),qr.observe(document.body,{childList:!0,subtree:!0}))},qa=()=>{$c(),jr()};var Ua="data:image/png;base64,",Va="data:image/png;base64,";var Ic=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Wa=t=>`ws-crm-map-links-${t}`,xo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},ja=t=>{let e=xo(t.addr),o=xo(t.city),r=xo(t.state),a=xo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Lc=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Mc=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Oc=(t,e)=>{let{full:o,hasAny:r}=ja(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Dc=t=>{let e=document.createElement("span");e.id=Wa(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),Oc(t,s)}),l};return e.appendChild(r(Ua,"Open in Google Maps",Lc)),e.appendChild(r(Va,"Search on Zillow",Mc)),e},Hc=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ka=()=>{for(let t of Ic){if(document.getElementById(Wa(t.key)))continue;let{hasAny:e}=ja(t);if(!e)continue;let o=Hc(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(Dc(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},Kr=null,Yr,Pc=()=>{Kr||(Kr=new MutationObserver(()=>{Yr===void 0&&(Yr=window.setTimeout(()=>{Yr=void 0;try{Ka()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),Kr.observe(document.body,{childList:!0,subtree:!0}))},Ya=()=>{Pc(),Ka()};var Ja="ws-crm-hide-launchpad",Xa=/\/launchpad\/?$/,Jr=()=>{if(!Jt()){if(!document.getElementById(Ja)){let t=document.createElement("style");t.id=Ja,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Xa.test(location.pathname)){let t=location.pathname.replace(Xa,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var Rc=[{label:"Buy-Box Entries"},{label:"Memberships"}],Qa=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Xr=()=>{let t=Jt(),e=new Set(Rc.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Qa(e);for(let o of[150,500,1200,2500])setTimeout(()=>Qa(e),o)}};var Bc=[{from:"Payments",to:"Contracts"}],Fc=".nav-title, .topmenu-navtitle",Za=()=>{document.querySelectorAll(Fc).forEach(t=>{let e=(t.textContent||"").trim(),o=Bc.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Qr=()=>{Za();for(let t of[150,500,1200,2500])setTimeout(Za,t)};var ei="/payments/proposals-estimates",Nc=/\/payments\/invoices\/?$/,zc=/\/payments\//,Gc='#sb_payments, a[meta="payments"]',oi=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(ei)&&!(t>3&&!zc.test(e))){if(Nc.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(ei));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>oi(t+1),120)}},ti=!1,qc=()=>{ti||(ti=!0,document.addEventListener("click",t=>{t.target?.closest?.(Gc)&&setTimeout(()=>oi(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},Zr=()=>{qc()};var ri=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ni="ws-crm-hide-topmenu-tabs",en=()=>{if(document.getElementById(ni))return;let t=ri.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ni,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${ri.length} top tabs`)};var si="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ke="ws-crm-send-to-closing-office-button",De="ws-crm-send-to-title-co-wrap",Eo="ws-crm-stc-dropdown",Uc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Vc=/\/v2\/location\/([A-Za-z0-9]+)/,To=()=>{let t=window.location.pathname,e=t.match(Uc);if(!e)return null;let o=t.match(Vc);return{oppId:e[1],locationId:o?o[1]:null}},Wc=5*60*1e3,li=t=>`ws-crm-stc-cache:${t}`,jc=t=>{try{let e=window.localStorage.getItem(li(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Wc||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Kc=(t,e)=>{try{window.localStorage.setItem(li(t),JSON.stringify(e))}catch{}},Yc=async(t,e)=>{try{let o=await fetch(si,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Jc=async(t,e,o)=>{let r=await fetch(si,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Xc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},ai=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Qc=(t,e)=>{if(e&&Xc(e)){window.setTimeout(()=>ai(t),300);return}ai(t)},de=()=>{document.getElementById(Eo)?.remove()},wo=(t,e,o)=>{de();let r=document.createElement("div");r.id=Eo;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let b=["TC","ACQ","MT","DISPO","Property"],p={};t.forEach(_=>{p[_.group]||(p[_.group]=[]),p[_.group].push(_)});let m=[...b.filter(_=>p[_]),...Object.keys(p).filter(_=>!b.includes(_))];for(let _ of m){let y=p[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
    ...
    `,f.textContent=_,k.appendChild(f),y.forEach(g=>{let x=document.createElement("div"),S=!g.filled&&g.navigable&&g.field_id;x.style.cssText=`
        ...
        ${S?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,S&&(x.addEventListener("mouseenter",()=>{x.style.background=n.slate}),x.addEventListener("mouseleave",()=>{x.style.background="transparent"}),x.addEventListener("click",w=>{w.stopPropagation(),g.field_id&&(Qc(g.field_id,g.folder),de())}));let C=g.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=S?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";x.innerHTML=`${C}<span style="flex: 1;">${g.label}</span>${E}`,k.appendChild(x)}),r.appendChild(k)}document.body.appendChild(r);let h=_=>{let y=_.target;!r.contains(y)&&!o.contains(y)&&(de(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},pe=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,b="Send to Closing Office",p="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,b="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",b=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,y=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,b=`${_} of ${y} Fields Ready`;break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",b="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",b="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,b=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=b),a&&(a.textContent=p)},Zc=(t,e)=>{let o=document.createElement("button");o.id=ke,o.type="button",o.dataset.oppId=t;let r=jc(t),a=r?{status:r.checks.every(f=>f.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${L}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,pe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Yc(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},pe(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},pe(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},pe(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let g=f.pipeline_name;if(g&&g!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),So.add(t),document.getElementById(ke)?.remove(),document.getElementById(De)?.remove(),de(),It();return}let x=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;x=f.checks.map((E,w)=>a.checks[w]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:x.every(C=>C.filled)?"ready":"incomplete",checks:x,previouslySentAt:f.previously_sent_at??null},Kc(t,{checks:x,previously_sent_at:f.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),pe(o,a),document.getElementById(Eo)&&wo(x,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},pe(o,a),de();try{let g=await Jc(t,e,f);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},pe(o,a),g.checks&&wo(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},pe(o,a),window.setTimeout(()=>{y()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},pe(o,a),g.checks&&wo(g.checks,g.previously_sent_at,o)}catch(g){c.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},pe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(Eo)?de():a.checks&&wo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":y();break}});let d,b=!1,p=Date.now(),m=1e4,h=5*60*1e3,_=0,y=async()=>{if(!b){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}b=!0,p=Date.now();try{await s()}finally{b=!1}}};y();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||b)return;let x=Date.now()-p,S=Math.max(1500,m-x);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&y()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(g))},5e3)}return o},ep=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tp=async()=>{for(let t of ep)try{let e=await I(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},So=new Set,ii=null,op=t=>{t&&t!==ii&&(So.clear(),ii=t)},ko=!1,nn=async()=>{if(ko){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}ko=!0;try{await rp()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{ko=!1}},rp=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=To();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ke)?.remove(),document.getElementById(De)?.remove(),de();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),op(t.oppId),So.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ke)?.remove(),document.getElementById(De)?.remove(),de();return}let e=document.getElementById(ke);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(De)?.remove(),de(),It());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(De)?.remove(),de()),c.debug("[stc] mount:04 calling findMountTarget");let o=await tp();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=To();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Zc(t.oppId,a.locationId),s=document.createElement("span");s.id=De,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),np(t.oppId)},$t=null,rn=null,It=()=>{$t?.disconnect(),$t=null,rn=null},np=t=>{if($t&&rn===t)return;It();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(rn=t,$t=new MutationObserver(()=>{let o=To();if(!o||o.oppId!==t){It();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ke)?.remove(),document.getElementById(De)?.remove(),de(),It();return}document.getElementById(ke)||nn()}),$t.observe(e,{childList:!0,subtree:!0}))},tn=null,on,ap=()=>{tn||(tn=new MutationObserver(()=>{on===void 0&&(on=window.setTimeout(()=>{on=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ke);if(t&&!e&&!ko){let o=To();if(o&&So.has(o.oppId))return;nn()}},300))}),tn.observe(document.body,{childList:!0,subtree:!0}))},di=()=>{ap(),nn()};var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",ip=`${ln}/tc/welcome-call-prefill`,sp=`${ln}/tc/welcome-call-save`,lp=`${ln}/tc/order-lockbox`,Lt="ws-crm-welcome-call-overlay",dp=["Regular Contract","Subject To","Seller Finance","Novation"],cp=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],pp=["Gas","Electric","Propane","Oil"],bp=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],hp=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Ee=["Yes","No"],mp=["Yes","No","Unknown"],up=["Professional Photographer","Seller","Tenant"],vp=["Month-to-Month","Annual"],ci=["Current","Behind"],_p=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],be=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ao=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,hi="margin-bottom:12px;",mi=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,gp=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,pi=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=pi(o);return`<select id="${t}" style="${Ao}"><option value=""></option>${e.map(a=>`<option ${r!==""&&pi(a)===r?"selected":""}>${be(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${be(e)}" placeholder="${be(o)}" style="${Ao}">`,yp=(t,e)=>`<textarea id="${t}" rows="3" style="${Ao}resize:vertical;">${be(e)}</textarea>`,fp=(t,e)=>`<input id="${t}" type="date" value="${be(e)}" style="${Ao}">`,D=(t,e)=>`<div style="${hi}"><label style="${mi}">${be(t)}</label>${e}</div>`,an=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${_p.map(r=>`<label style="${gp}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},_e=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${be(t)}</div>`,Xe=()=>{document.getElementById(Lt)?.remove()},He=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},xp=t=>{let e=t.tenant||{};return`
    ${_e("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${be(t.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${be(t.deal_address)||"(no address on file)"}</div>

    ${_e("Contract")}
    ${D("Type of Contract",j("wc-contract_type",dp,t.contract_type))}

    ${_e("Property")}
    ${D("Property Type",j("wc-property_type",bp,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",cp,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",pp,t.heat_source))}

    ${_e("Liens & Permits")}
    ${D("Is there a mortgage?",j("wc-has_mortgage",Ee,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${D("Mortgage payment status",j("wc-mortgage_payment_status",ci,t.mortgage_payment_status))}</div>
    ...
    ${_e("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",hp,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",vp,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Rent status",j("wc-tenant_rent_status",ci,e.rent_status))}</div>
        <div style="flex:1;">${D("Last rent paid",fp("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",mp,t.hoa_rental_restriction))}</div>

    ${_e("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",up,t.photos_provided_by))}
    <div style="${hi}">
      <label style="${mi}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${an("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${an("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${an("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${Co(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Co(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Co(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${Co(t).text}</span>
      </div>
    </div>
  ...
  `},A=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},sn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),bi=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",A("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",A("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",A("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",A("wc-occupancy")==="Tenant Occupied")},Co=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?be(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},wp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:A("wc-contract_type"),property_type:A("wc-property_type"),beds:A("wc-beds"),baths:A("wc-baths"),sqft:A("wc-sqft"),utilities:A("wc-utilities"),heat_source:A("wc-heat_source"),has_mortgage:A("wc-has_mortgage"),mortgage_payment_status:A("wc-mortgage_payment_status"),has_other_liens:A("wc-has_other_liens"),has_permit_issues:A("wc-has_permit_issues"),in_probate:A("wc-in_probate"),occupancy:A("wc-occupancy"),selling_with_tenant:A("wc-selling_with_tenant"),in_hoa:A("wc-in_hoa"),hoa_rental_restriction:A("wc-hoa_rental_restriction"),hoa_monthly_fee:A("wc-hoa_monthly_fee"),photos_provided_by:A("wc-photos_provided_by"),photos_avail_mornings:sn("photos_avail_mornings"),photos_avail_afternoons:sn("photos_avail_afternoons"),photos_avail_evenings:sn("photos_avail_evenings"),lockbox_needed:A("wc-lockbox_needed"),lockbox_code:A("wc-lockbox_code"),lockbox_recipient_name:A("wc-lockbox_recipient_name"),lockbox_recipient_phone:A("wc-lockbox_recipient_phone"),lockbox_mailing_address:A("wc-lockbox_mailing_address"),welcome_call_notes:A("wc-welcome_call_notes"),tenant:A("wc-occupancy")==="Tenant Occupied"?{first_name:A("wc-tenant_first_name"),last_name:A("wc-tenant_last_name"),phone:A("wc-tenant_phone"),email:A("wc-tenant_email"),lease_type:A("wc-tenant_lease_type"),monthly_rent:A("wc-tenant_monthly_rent"),rent_due_day:A("wc-tenant_rent_due_day"),rent_status:A("wc-tenant_rent_status"),last_rent_paid:A("wc-tenant_last_rent_paid"),lease_on_hand:A("wc-tenant_lease_on_hand"),security_deposit:A("wc-tenant_security_deposit")}:void 0}),kp=t=>{Xe();let e=document.createElement("div");e.id=Lt,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${Lt} input[type="date"]::-webkit-calendar-picker-indicator,#${Lt} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",i=>{i.target===e&&Xe()}),document.getElementById("wc-close")?.addEventListener("click",Xe),document.getElementById("wc-cancel")?.addEventListener("click",Xe),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",bi)}),bi();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!A("wc-occupancy")){He("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(sp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(wp(t)),credentials:"omit"})).ok?(Xe(),He("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,He("Save failed \u2014 try again.","err"))}catch(i){c.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,He("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(lp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:A("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:A("wc-lockbox_recipient_name"),recipient_phone:A("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),He("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,He("Lockbox order failed \u2014 try again.","err"))}catch(s){c.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,He("Couldn't reach the lockbox handler. Try again.","err")}})},ui=async(t,e)=>{Xe();let o=document.createElement("div");o.id=Lt,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${ip}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else c.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){c.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,kp(r)};var vn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Ep=`${vn}/tc/confirm-photo-appointment`,Tp=`${vn}/tc/order-lockbox`,Sp=`${vn}/tc/welcome-call-prefill`,hn="ws-crm-opp-action-bar",_i="ws-crm-opp-overflow",gi="ws-crm-opp-action-menu",mn="ws-crm-opp-action-popover",yi="ws-crm-reorder-lockbox-modal",fi=".hr-card.hr-modal.crm-opportunities-modal",Cp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ap=/\/v2\/location\/([A-Za-z0-9]+)/,xi="Welcome Call Needed",_n="Scheduling Photos",wi="Photos Scheduled",$p=[xi,_n,wi,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],ki=()=>{let t=window.location.pathname,e=t.match(Cp);if(!e)return null;let o=t.match(Ap);return o?{oppId:e[1],locationId:o[1]}:null},Ip=()=>{let t=document.querySelector(fi);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if($p.includes(r))return r}return null},Se=()=>{document.getElementById(gi)?.remove(),document.getElementById(mn)?.remove(),document.getElementById(yi)?.remove()},dn=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Te=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Lp=t=>{ui(t.oppId,t.locationId)},Mp=async(t,e,o)=>(await fetch(Tp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Op=(t,e)=>{Se();let o=document.createElement("div");o.id=yi,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,s=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${dn(e.lockbox_recipient_name)}" />
    <label style="${i}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${dn(e.lockbox_recipient_phone)}" />
    <label style="${i}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${dn(s)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",b=>{b.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let b=document.getElementById("wsrl-name")?.value.trim()||"",p=document.getElementById("wsrl-phone")?.value.trim()||"",m=document.getElementById("wsrl-address")?.value.trim()||"";if(!b||!m){Te("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await Mp(t,e,{recipient_name:b,recipient_phone:p,ship_to:m})?(l(),Te("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",Te("Re-order failed \u2014 try again.","err"))}catch(h){c.warn("[action-bar] reorder lockbox failed:",h),d.disabled=!1,d.textContent="Order Lockbox",Te("Couldn't reach the lockbox handler. Try again.","err")}}})},Ei=async t=>{Se();let e={};try{e=await fetch(`${Sp}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Op(t,e)},Dp=(t,e)=>{Se();let o=document.createElement("div");o.id=mn;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${u.sans};
  `,o.innerHTML=`
    <style>#${mn} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){Te("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(Ep,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(Se(),Te("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",Te("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",Te("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let b=d.target;!o.contains(b)&&!e.contains(b)&&(Se(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},Hp=(t,e)=>{Se();let o=document.createElement("div");o.id=gi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(Se(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=L,o.textContent=t,o},Pp=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},Rp=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===xi){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Lp(t)),o.appendChild(r),o}if(e===_n){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Dp(t,r)),o.appendChild(r),o}if(e===wi){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Ei(t)),o.appendChild(r),o}return null},Bp=(t,e)=>{let o=[];if(e===_n&&(o=[{label:"Re-order Lockbox",onClick:()=>void Ei(t)}]),!o.length)return null;let r=document.createElement("span");r.id=_i,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Pp();return a.addEventListener("click",i=>{i.stopPropagation(),Hp(o,a)}),r.appendChild(a),r},Fp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Np=async()=>{for(let t of Fp)try{let e=await I(t,{timeoutMs:1200});if(e)return e}catch{}return null},$o=()=>{document.getElementById(hn)?.remove(),document.getElementById(_i)?.remove(),Se()},Lo=!1,gn=async()=>{if(!Lo){Lo=!0;try{let t=ki();if(!t){$o();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){$o();return}let o=Ip(),r=document.getElementById(hn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Rp(t,o);if(!a){$o();return}let i=await Np();if(!i)return;$o();let s=U(i),l=document.createElement("span");l.id=hn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Bp(t,o);d&&s.appendChild(d),zp(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},Mt=null,un=null,cn,vi=()=>{Mt?.disconnect(),Mt=null,un=null},zp=t=>{if(Mt&&un===t)return;vi();let e=document.querySelector(fi);e&&(un=t,Mt=new MutationObserver(()=>{let o=ki();if(!o||o.oppId!==t){vi();return}cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0,gn()},250))}),Mt.observe(e,{childList:!0,subtree:!0}))},pn=null,bn,Gp=()=>{pn||(pn=new MutationObserver(()=>{bn===void 0&&(bn=window.setTimeout(()=>{bn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&gn()},300))}),pn.observe(document.body,{childList:!0,subtree:!0}))},Ti=()=>{Gp(),gn()};var Si="ws-support-modal",Ci="ws-support-toast",qp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ai="ws-support-submitter-name",$i="ws-support-submitter-email",Ii="ws-support-submitter-role",Up=["Bug","Feature Request","Question","Billing","Onboarding Help"],Pe=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Vp=(t,e="success",o)=>{let r=document.getElementById(Ci);r&&r.remove();let a=document.createElement("div");a.id=Ci;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Wp=()=>{document.getElementById(Si)?.remove();let t=(localStorage.getItem(Ai)??"").trim(),e=(localStorage.getItem($i)??"").trim(),o=(localStorage.getItem(Ii)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Si,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${Pe(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Pe(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Pe(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Pe(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let b=xe();if(!b){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ai,r.submitterName),localStorage.setItem($i,r.submitterEmail),r.submitterRole&&localStorage.setItem(Ii,r.submitterRole)}catch{}let p=i.querySelector("#ws-support-submit");p&&(p.disabled=!0,p.textContent="Submitting\u2026",p.style.opacity="0.7");try{let h=await(await fetch(qp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:b,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";Vp(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1")}})},jp=["/support-ticket","ws-support-modal","ws-support"],Kp=/\/custom-menu-link\//,yn=!1,Li=()=>{if(yn||!Kp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return jp.some(s=>i.includes(s))});if(r){yn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Wp(),yn=!1},50);return}t<10&&setTimeout(e,150)};e()},Mi=!1,Oi=()=>{Mi||(Mi=!0,Ge(()=>setTimeout(Li,50)),Li(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Di="ws-phone-assignments-modal",Hi="ws-phone-assignments-toast",Yp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Jp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Xp=["ACQ","DISPO","TC"],xn="",he=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Qp=(t,e="success",o)=>{document.getElementById(Hi)?.remove();let r=document.createElement("div");r.id=Hi;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${he(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${he(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Pi=(t,e,o)=>{let r=[`<option value="" ${o===xn?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${he(a)}" ${o===a?"selected":""}>${he(a)}</option>`)].join("");return`<select data-assign="${he(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Ri=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,wn=async()=>{document.getElementById(Di)?.remove();let t=xe(),e=document.createElement("div");e.id=Di,e.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",y=>{y.target===e&&e.remove()}),!t){let y=o.querySelector("#ws-pa-body");y&&(y.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let r={};try{r=await(await fetch(`${Yp}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(y){c.error("[phone-assignments] GET failed",y);let k=o.querySelector("#ws-pa-body");k&&(k.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${he(y.message)}). The backend may not be wired yet.</span>`);return}let a=r.teams&&r.teams.length?r.teams:Xp,i=r.numbers??[],s=r.users??[],l={...r.config?.numberTeam??{}},d={...r.config?.repTeam??{}},b=y=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${y} found.</div>`,p=s.length?s.map(y=>`<div style="${Ri}">
            ...
            ${Pi(`rep:${y.id}`,a,d[y.id]??xn)}
          </div>`).join(""):b("users"),m=i.length?i.map(y=>`<div style="${Ri}">
            <div style="min-width:0;">
            ...
            ${Pi(`num:${y.e164}`,a,l[y.e164]??xn)}
          </div>`).join(""):b("phone numbers"),h=y=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${y}</div>`,_=o.querySelector("#ws-pa-body");_&&(_.innerHTML=`
    ${h("Reps \u2192 Team")}
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:8px;">
    ...
    </div>`,_.querySelectorAll("select[data-assign]").forEach(y=>{y.addEventListener("change",()=>{let k=y.getAttribute("data-assign")||"",[f,...g]=k.split(":"),x=g.join(":");f==="rep"?y.value?d[x]=y.value:delete d[x]:f==="num"&&(y.value?l[x]=y.value:delete l[x])})}),_.querySelector("#ws-pa-close")?.addEventListener("click",()=>e.remove()),_.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let y=_.querySelector("#ws-pa-err"),k=g=>{y&&(y.textContent=g)};k("");let f=_.querySelector("#ws-pa-save");f&&(f.disabled=!0,f.textContent="Saving\u2026",f.style.opacity="0.7");try{let x=await(await fetch(Jp,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:l,repTeam:d})})).json();if(!x.ok){k(x.error||"Save failed."),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1");return}e.remove(),Qp("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(g){k(`Network error: ${g.message}`),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1")}}))},Zp=["ws-phone-assignments","phone-assignments"],eb=/\/custom-menu-link\//,fn=!1,Bi=()=>{if(fn||!eb.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Zp.some(s=>i.includes(s))});if(r){fn=!0,c.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal`);try{history.back()}catch{}setTimeout(()=>{wn(),fn=!1},50);return}t<10&&setTimeout(e,150)};e()},Fi=!1,Ni=()=>{if(Fi)return;Fi=!0,Ge(()=>setTimeout(Bi,50)),Bi();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&wn()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void wn(),c.info("[phone-assignments] mounted (route + hash + window trigger)")};var tb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ob="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",rb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",qi="tc_closing_agent",nb="tc_closing_office",ce="ws-crm-closing-agent-picker-button",Ui="ws-crm-closing-agent-picker-modal",ab=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ib=/\/v2\/location\/([A-Za-z0-9]+)/,Ht=()=>{let t=window.location.pathname,e=t.match(ab);if(!e)return null;let o=t.match(ib);return{oppId:e[1],locationId:o?o[1]:null}},In=async t=>{let e=await fetch(tb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},zi=async t=>{let e=await fetch(ob,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},sb=async(t,e)=>{try{let o=await fetch(rb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:qi}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await In({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Re=null,lb=60*60*1e3,Ln=t=>`ws-crm-to-cache:${t}`,Vi=t=>{try{let e=window.localStorage.getItem(Ln(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>lb||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Wi=(t,e,o)=>{try{window.localStorage.setItem(Ln(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},db=t=>{try{window.localStorage.removeItem(Ln(t))}catch{}},Sn="ws-crm-closing-agent-field-link",cb=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Sn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},kn=!1,Mn=async t=>{if(kn)return;let e=ji();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){kn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await In({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Cn(a.id,a.name,t);let i=document.getElementById(ce);if(i){Ce(i,{status:"linked",contactName:a.name});let s=Ht();s&&Wi(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{kn=!1}}},pb=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,ji=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let b=(d.textContent||"").trim();pb.test(b)?o.push(d):b.length<80&&/Title\s+Officer/i.test(b)&&r.push(b);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,b)=>d.querySelectorAll("*").length-b.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Cn=(t,e,o)=>{let r=ji();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Sn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=Sn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Mo=()=>{document.getElementById(Ui)?.remove()},bb=t=>{Mo();let e=document.createElement("div");e.id=Ui,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",b=>{b.target===e&&Mo()}),i?.addEventListener("click",Mo);let s,l="",d=async b=>{if(a&&b!==l){if(l=b,!b.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await In({tenantId:t.locationId,query:b,contactType:"closing_agent",limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",p.results.forEach(m=>{let h=document.createElement("button");h.type="button",h.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${Oo(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Oo(m.email||"(no email)")} \xB7 ${Oo(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Oo(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Mo(),t.onPick(m)}),a.appendChild(h)})}catch(p){c.error("Closing Agent picker search failed",p),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let b=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(b)},250)})},Oo=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ce=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,b="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,b="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,b="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=b},hb=(t,e)=>{let o=document.createElement("button");o.id=ce,o.type="button",o.dataset.oppId=t,o.style.cssText=L,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Ce(o,r);let a=Vi(t);return a&&(r={status:"linked",contactName:a.contactName},Ce(o,r),Re={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await sb(t,e);s?(r={status:"linked",contactName:s.name},Ce(o,r),Re={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Cn(s.id,s.name,e)):a||(r={status:"empty"},Ce(o,r),Re?.oppId===t&&(Re=null),cb(),db(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||bb({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ce(o,r);try{let l=[zi({tenantId:e,oppId:t,fieldKey:qi,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(zi({tenantId:e,oppId:t,fieldKey:nb,value:s.companyName.trim()}));let b=(await Promise.all(l))[0];if(!b.ok)throw new Error(b.error??"Save failed");r={status:"linked",contactName:s.name},Ce(o,r),Re={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Wi(t,s.id,s.name),Cn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ce(o,r)}}})}),o},mb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],ub=async()=>{for(let t of mb)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ot=!1,Ho=async()=>{if(!Ot){Ot=!0;try{await vb()}finally{Ot=!1}}},vb=async()=>{let t=Ht();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Do();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Do());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await ub();if(!r||!(Vi(t.oppId)!==null||Re!==null&&Re.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Ht();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=hb(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),_b(t.oppId),Mn(i.locationId)},Dt=null,An=null,$n=null,Do=()=>{Dt?.disconnect(),Dt=null,An=null,$n=null},_b=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Dt&&An===t&&$n===e||(Do(),An=t,$n=e,Dt=new MutationObserver(()=>{let o=Ht();if(!o||o.oppId!==t||!o.locationId){Do();return}document.getElementById(ce)||Ho(),Mn(o.locationId)}),Dt.observe(e,{childList:!0,subtree:!0})))},En=null,Tn,gb=()=>{En||(En=new MutationObserver(()=>{Tn===void 0&&(Tn=window.setTimeout(()=>{Tn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Ot&&Ho()},300))}),En.observe(document.body,{childList:!0,subtree:!0}))},Gi,yb=()=>{Gi===void 0&&(Gi=window.setInterval(()=>{let t=Ht();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!Ot&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ho()),Mn(t.locationId)},2e3))},Ki=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),gb(),yb(),Ho()};var fb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",$e="ws-crm-manage-team-cta",Yi="ws-crm-manage-team-modal",xb=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ji={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},wb={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Xi=()=>{let t=window.location.pathname.match(xb);return t?{tenantId:t[1]}:null},Ro=async t=>{let e=await fetch(fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ae=t=>ne(t),On="ws-crm-manage-team-toast",Pn=(t,e="info",o=4e3)=>{document.getElementById(On)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=On,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(On)===a&&a.remove()},o)},Dn=()=>{document.getElementById(Yi)?.remove()},kb=(t,e)=>{let o=wb[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ne(e)}</span>
  `},Eb=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>kb(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${Ae(t.id)}" style="
      display: grid;
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${ne(t.email)}${t.phone?` &middot; ${ne(t.phone)}`:""}
        </div>
      </div>
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${Ae(t.email)}" data-user-id="${Ae(t.id)}" data-name="${Ae(o)}" data-current-roles="${Ae(t.role_keys.join(","))}" style="${L} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${Ae(t.email)}" data-name="${Ae(o)}" data-role-count="${Ae(String(t.role_keys.length))}" style="${L} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Tb=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Eb(r,e)).join(""),Bo=async t=>{Dn();let e=document.createElement("div");e.id=Yi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&Dn()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <button id="ws-team-close" style="${L} font-size: 12px;">Close</button>
    </div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Dn);let r;try{r=await Ro({tenant_id:t,action:"list"})}catch(d){let b=o.querySelector("#ws-team-content");b&&(b.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          Failed to load roster: ${ne(d.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let d=o.querySelector("#ws-team-content");d&&(d.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          ${ne(r.error||"Unknown error loading roster")}
        </div>
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Tb(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Sb(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",b=>{let p=b.currentTarget;Cb(t,{email:p.dataset.email||"",name:p.dataset.name||"",currentRoles:(p.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",b=>{let p=b.currentTarget;Ab(t,{email:p.dataset.email||"",name:p.dataset.name||"",roleCount:parseInt(p.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Sb=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,i.innerHTML=`
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
      <button id="ws-team-add-cancel" style="${L} font-size: 12px;">Cancel</button>
  ...
  `,o.appendChild(i),document.body.appendChild(o),i.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),i.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let s=(i.querySelector("#ws-team-add-first")?.value||"").trim(),l=(i.querySelector("#ws-team-add-last")?.value||"").trim(),d=(i.querySelector("#ws-team-add-email")?.value||"").trim(),b=(i.querySelector("#ws-team-add-mobile")?.value||"").trim(),p=(i.querySelector("#ws-team-add-role")?.value||"").trim(),m=i.querySelector("#ws-team-add-error"),h=i.querySelector("#ws-team-add-submit");if(!s||!l||!d||!b||!p){m&&(m.textContent="All fields are required.");return}h&&(h.disabled=!0,h.textContent="Adding\u2026",h.style.opacity="0.7"),m&&(m.textContent="");try{let _=await Ro({tenant_id:t,action:"add",first_name:s,last_name:l,email:d,mobile:b,role:p,triggered_by_user_id:O()});if(!_.ok){m&&(m.textContent=_.error||"Failed to add employee"),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1");return}o.remove(),Pn(`Added ${s} ${l} as ${Ji[p]||p}.`,"success"),await Bo(t)}catch(_){m&&(m.textContent=_.message),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1")}})},Cb=(t,e)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ne(Ji[s])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${ne(e.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${ne(e.email)}</div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-edit-cancel" style="${L} font-size: 12px;">Cancel</button>
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-edit-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-edit-submit")?.addEventListener("click",async()=>{let s=Array.from(a.querySelectorAll('input[type="checkbox"]')).filter(b=>b.checked).map(b=>b.dataset.roleKey||"").filter(Boolean),l=a.querySelector("#ws-team-edit-error"),d=a.querySelector("#ws-team-edit-submit");if(s.length===0){l&&(l.textContent="Select at least one role. To fully offboard, use Remove instead.");return}d&&(d.disabled=!0,d.textContent="Saving\u2026",d.style.opacity="0.7"),l&&(l.textContent="");try{let b=await Ro({tenant_id:t,action:"update",email:e.email,roles:s,triggered_by_user_id:O()});if(!b.ok){l&&(l.textContent=b.error||"Failed to update roles"),d&&(d.disabled=!1,d.textContent="Save Roles",d.style.opacity="1");return}r.remove(),Pn(`Updated roles for ${e.name}.`,"success"),await Bo(t)}catch(b){l&&(l.textContent=b.message),d&&(d.disabled=!1,d.textContent="Save Roles",d.style.opacity="1")}})},Ab=(t,e)=>{let o="ws-crm-manage-team-remove-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${ne(e.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${ne(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
    ...
    <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 12px;">
      <button id="ws-team-remove-cancel" style="${L} font-size: 12px;">Cancel</button>
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await Ro({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:O()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),Pn(`Removed ${e.name} from the team.`,"success"),await Bo(t)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},$b=89,Ib=93,Lb=310,Mb=34,Ob=14,Db=14,Hb=3,Po=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+$b;t.style.right=`${Math.max(r,16)}px`},Pb=t=>{let e=document.createElement("button");return e.id=$e,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${Ib}px;
    right: 24px;
    width: ${Lb}px;
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Po(e),setTimeout(()=>Po(e),200),setTimeout(()=>Po(e),800),window.addEventListener("resize",()=>Po(e)),e},Hn=!1,Rb=()=>{if(!Hn){Hn=!0;try{let t=Xi();if(!t){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}let e=document.getElementById($e);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${$e}-floater`)?.remove();let o=document.createElement("div");o.id=`${$e}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Pb(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Hn=!1}}},Qi=()=>{if(!Xi()){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}Rb()};var Bb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Fn="ws-crm-prepare-contract-button",Zi="ws-crm-prepare-contract-menu",ue="ws-crm-prepare-contract-modal",es="ws-crm-modal-date-style",ge="https://services.leadconnectorhq.com",is=()=>{if(document.getElementById(es))return;let t=document.createElement("style");t.id=es,t.textContent=`
    #${ue} input[type="date"] { color-scheme: dark; }
    #${ue} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(t)},Nn="__WS_CRM_CAPTURED_AUTH",Fb=50*60*1e3,Go=()=>{try{let t=localStorage.getItem(Nn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>Fb?(localStorage.removeItem(Nn),null):e:null}catch{return null}},Nb=t=>{try{localStorage.setItem(Nn,JSON.stringify(t))}catch{}},Ze=()=>{let t=Go(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},ts=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Go()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Qe=async(t,e={},o=2)=>{let r=Go()?.capturedAt??0,a;try{a={...Ze(),...e.headers??{}}}catch(s){if(o>0&&await ts(r,4e3))return Qe(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await ts(r,4e3)?Qe(t,e,o-1):i},os=!1,zb=()=>{if(os)return;os=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,b)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:b};let p=d.authorization||d.Authorization;if(!p){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${b} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}b==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Go()?.authorization;Nb({authorization:p,tokenId:m,capturedAt:Date.now()}),h!==p&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${b}] captured GHL auth from ${l.split("?")[0]} (${p.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,b=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let p=b.headers;!p&&l[0]instanceof Request&&(p=l[0].headers);let m={};if(p instanceof Headers)p.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(p))p.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(p&&typeof p=="object")for(let h of Object.keys(p))m[h.toLowerCase()]=p[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...b){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...b)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,b=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&b&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,b,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},ss=()=>{let t=B();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Gb=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:ss()},qb=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},ls="__WS_CRM_TEMPLATES_CACHE_V1",Ub=24*60*60*1e3,rs=t=>{try{let e=window.localStorage.getItem(ls);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Ub?null:o.templates}catch{return null}},Vb=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(ls,JSON.stringify(o))}catch{}},Wb=async t=>{let e=`${ge}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Qe(e,{method:"GET"})}catch(s){let l=rs(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=rs(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:qb(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Vb(t,i),i},jb=async(t,e)=>{let o=await Qe(`${ge}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Qe(`${ge}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let b=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-b})},Kb=async(t,e)=>{let o=await Qe(`${ge}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ge}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ze()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,b)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(b.updatedAt?Date.parse(b.updatedAt):0)-p})},Yb=async t=>{let e=await fetch(Bb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Jb=async(t,e,o)=>{let r=`${ge}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ze()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Xb=async(t,e)=>{let o=await fetch(`${ge}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ze()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Qb=async t=>{let e=await fetch(`${ge}/contacts/${t}`,{method:"GET",headers:Ze()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Zb=async(t,e,o,r)=>{let a;try{a=await Xb(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Qb(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},p=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:p,grandTotal:a.grandTotal},h=await fetch(`${ge}/proposals/document/${e}`,{method:"PUT",headers:{...Ze(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},eh=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},No="__WS_CRM_PENDING_INSTRUCTIONS",th=60*1e3,oh=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],rh=t=>{let e=(t||"").toLowerCase();for(let o of oh)if(e.includes(o.matches.toLowerCase()))return o;return null},nh=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(No,JSON.stringify(r))}catch{}},ah=()=>{try{let t=localStorage.getItem(No);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>th?(localStorage.removeItem(No),null):e}catch{return null}},ih=()=>{try{localStorage.removeItem(No)}catch{}},sh=(t,e)=>{document.getElementById(ue)?.remove();let o=document.createElement("div");o.id=ue,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},lh=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,dh=()=>{let t=window.location.pathname.match(lh);if(!t)return;let e=t[1],o=ah();o&&o.proposalId===e&&(ih(),window.setTimeout(()=>{sh(o.title,o.bodyHtml)},600))},ns="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(ns)?.remove();let r=document.createElement("div");r.id=ns;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},as=(t,e)=>new Promise(o=>{document.getElementById(ue)?.remove();let r=document.createElement("div");r.id=ue,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${me(d.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${n.slate};
    ...
    `,r.appendChild(a),document.body.appendChild(r);let l=d=>{r.remove(),o(d)};r.addEventListener("click",d=>{d.target===r&&l(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>l(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.borderColor=n.emerald,d.style.background=n.graphite}),d.addEventListener("mouseleave",()=>{d.style.borderColor=n.steel,d.style.background=n.slate}),d.addEventListener("click",b=>{b.stopPropagation(),b.preventDefault();let p=d.dataset.oppId||"";p&&l(p)})})}),ch=({tenantId:t,contactId:e,template:o,staged:r})=>{document.getElementById(ue)?.remove(),is();let a=r.debug||{},i=typeof a.propertyAddress=="string"?a.propertyAddress:"",s=typeof a.sellerName=="string"?a.sellerName:"",l=typeof a.purchasePrice=="number"?a.purchasePrice:0,d=typeof a.emd=="number"?a.emd:0,b=typeof a.cashAtClose=="number"?a.cashAtClose:l-d,p=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),m=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),h=typeof a.additionalTerms=="string"?a.additionalTerms:"",_=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",y=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",k=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],f=document.createElement("div");f.id=ue,f.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,$=`
    ...
    padding-right: 28px;
  `,P=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${me(J)}"${J===V?" selected":""}>${te(J)}</option>`)).join("");g.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${me(s)}" placeholder="Seller name" style="${S}" />
      </div>
      <div style="${w}">
      ...
      <div style="${w}">
        ...
        <div style="${T}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-cash-at-close" type="number" min="0" step="0.01" value="${b}" style="${C}" />
        </div>
      </div>
      <div style="${w}">
        <div style="${x}">Days to Close</div>
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${me(p)}" placeholder="e.g. 30" style="${S}" />
      </div>
      <div style="${w}">
        <div style="${x}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${me(m)}" placeholder="e.g. 10" style="${S}" />
      </div>
      <div style="${w}">
  ...
  `,f.appendChild(g),document.body.appendChild(f);let q=g.querySelector("#ws-pc-purchase-price"),z=g.querySelector("#ws-pc-emd"),N=g.querySelector("#ws-pc-cash-at-close"),R=!1;N?.addEventListener("input",()=>{R=!0});let ye=()=>{if(R)return;let V=Number(q?.value||0),J=Number(z?.value||0);N&&(N.value=String(Math.max(0,V-J)))};q?.addEventListener("input",ye),z?.addEventListener("input",ye);let fe=()=>f.remove();f.addEventListener("click",V=>{V.target===f&&fe()}),g.querySelector("#ws-pc-cancel")?.addEventListener("click",fe);let ee=g.querySelector("#ws-pc-submit"),oe=g.querySelector("#ws-pc-error");ee?.addEventListener("click",async()=>{if(ee){oe&&(oe.textContent=""),ee.disabled=!0,ee.textContent="Opening\u2026";try{let V=(g.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(q?.value||0),tt=Number(z?.value||0),ot=Number(N?.value||0),rt=(g.querySelector("#ws-pc-days-to-close")?.value??"").trim(),nt=(g.querySelector("#ws-pc-inspection-days")?.value??"").trim(),at=(g.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Ne=(g.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),it=(g.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),tt!==d&&(X.emd=tt),ot!==b&&(X.cashAtClose=ot),rt!==p&&(X.daysToClose=rt),nt!==m&&(X.inspectionDays=nt),at!==h&&(X.additionalTerms=at),Ne!==_&&(X.currentOccupancy=Ne),it!==y&&(X.occupancyAtClose=it),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),ee.textContent="Saving\u2026";let Zo=O(),er=await zo({tenantId:t,contactId:e,template:o,userId:Zo,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",er),ee.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await qn(t,e,o,Q)}catch(V){ee.disabled=!1,ee.textContent="Open Contract",oe&&(oe.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},ph=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ue)?.remove(),is();let d=a.debug||{},b=typeof d.propertyAddress=="string"?d.propertyAddress:"",p=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,y=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",g=s,x=l,S="",C=document.createElement("div");C.id=ue,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${q}">
        ...
        <div style="${P}">${te(b||"(set on Property record)")}</div>
      </div>
      <div style="${q}">
        <div style="${w}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${me(p)}" placeholder="Seller name" style="${T}" />
      </div>
      <div style="${q}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${me(f)}" placeholder="Buyer's entity / LLC name" style="${T}" />
      </div>
      <div style="${q}">
      ...
      <div style="${q}">
        ...
        <input id="ws-pc-closing-office" type="text" value="${me(k)}" placeholder="Title company" style="${T}" />
      </div>
      <div style="${q}">
        <div style="${w}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${me(g)}" style="${T}" />
      </div>
      <div style="${q}">
        <div style="${w}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${me(x)}" style="${T}" />
      </div>
      <div style="${q}">
  ...
  `,C.appendChild(E),document.body.appendChild(C);let N=E.querySelector("#ws-pc-assignment-price"),R=E.querySelector("#ws-pc-assignment-fee"),ye=!1;R?.addEventListener("input",()=>{ye=!0});let fe=()=>{if(ye)return;let J=Number(N?.value||0);R&&(R.value=String(Math.max(0,J-y)))};N?.addEventListener("input",fe);let ee=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&ee()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",ee);let oe=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(!oe)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),tt=Number(N?.value||0),ot=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),rt=Number(R?.value||0),nt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),at=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Ne=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),it=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Ne){V&&(V.textContent="Closing Date is required.");return}oe.disabled=!0,oe.textContent="Opening\u2026";try{let Q={};J!==p&&(Q.sellerName=J),tt!==m&&(Q.assignmentPrice=tt),ot!==h&&(Q.buyerEMD=ot),rt!==_&&(Q.assignmentFee=rt),nt!==k&&(Q.closingOffice=nt),at!==f&&(Q.buyerCompanyName=at);let Zo=Ne!==g||it!==x||X!==S,er=Object.keys(Q).length>0||Zo,tr=a;er?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),oe.textContent="Saving\u2026",tr=await zo({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Ne,buyerEarnestDueDate:it,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",tr),oe.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Qn=tr?.debug?.propertyAddress||b,Vs=Qn?`${Qn} - Assignment Agreement`:void 0;await qn(t,e,o,Vs),ee()}catch(Q){oe.disabled=!1,oe.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},zo=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Yb({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},qn=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Jb(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Zb(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=rh(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),nh(a,s.title,s.bodyHtml)),eh(t,a)},bh=async t=>{let e=Gb(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(Zi)?.remove();let o=document.createElement("div");o.id=Zi,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Wb(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let b=O();try{if(i.type==="AA"){let p;if(e.oppId)p=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${p} directly`);else{let g;try{g=await Kb(e.tenantId,e.contactId)}catch(x){Y(`Failed to load buyer's MT opps: ${x.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",x);return}if(g.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(g.length===1)p=g[0].id,c.info(`[prepare-contract] auto-selected MT opp ${p} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${g.length} opps)`);let x=await as(g,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!x){c.info("[prepare-contract] MT opp picker cancelled");return}p=x,c.info(`[prepare-contract] picked MT opp ${p}`)}}let m=g=>{let x=g.getFullYear(),S=String(g.getMonth()+1).padStart(2,"0"),C=String(g.getDate()).padStart(2,"0");return`${x}-${S}-${C}`},h=g=>{let x=new Date;return x.setDate(x.getDate()+g),m(x)},_=h(45),y=h(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await zo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:p,closingDate:_,buyerEarnestDueDate:y,userId:b})}catch(g){Y(`Failed to prepare contract: ${g.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",g);return}let f=e.contactId||k.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}ph({tenantId:e.tenantId,contactId:f,template:i,oppId:p,staged:k,userId:b,defaultClosingDate:_,defaultEMDDueDate:y})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let p;try{p=await jb(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(p.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(p.length===1)m=p[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${p.length} opps)`);let _=await as(p,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await zo({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:b})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}ch({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await qn(e.tenantId,e.contactId,i)}catch(p){Y(`Failed to open contract: ${p.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",p)}}}catch(p){c.warn("[prepare-contract] picker click handler failed:",p),Y(`Unexpected error: ${p.message}`,"error",6e3)}}),o.appendChild(s)}},ds=()=>{let t=document.createElement("button");return t.id=Fn,t.type="button",t.style.cssText=`${L} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),bh(t)}),t},hh="ws-crm-contact-actions-bar",mh=async()=>{let t=ss();if(!t){document.getElementById(Fn)?.remove();return}let e=null;try{e=await I(`#${hh}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Fn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=ds();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},Be="ws-crm-prepare-contract-button-opp",Pt=`${Be}-wrap`,uh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,vh=/\/v2\/location\/([A-Za-z0-9]+)/,_h=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zn=()=>{let t=window.location.pathname,e=t.match(uh);if(!e)return null;let o=t.match(vh);return o?{oppId:e[1],tenantId:o[1]}:null},gh=async()=>{for(let t of _h)try{let e=await I(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Fo=!1,Rt=null,Gn=null,Rn=null,Bn,Bt=()=>{Rt?.disconnect(),Rt=null,Gn=null},yh=t=>{if(Rt&&Gn===t)return;Bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gn=t,Rt=new MutationObserver(()=>{let o=zn();if(!o||o.oppId!==t){Bt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Be)?.remove(),document.getElementById(Pt)?.remove(),Bt();return}document.getElementById(Be)||cs()}),Rt.observe(e,{childList:!0,subtree:!0}))},fh=()=>{Rn||(Rn=new MutationObserver(()=>{Bn===void 0&&(Bn=window.setTimeout(()=>{Bn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Be);t&&!e&&!Fo&&cs()},300))}),Rn.observe(document.body,{childList:!0,subtree:!0}))},cs=async()=>{if(!Fo){Fo=!0;try{let t=zn();if(!t){document.getElementById(Be)?.remove(),document.getElementById(Pt)?.remove(),Bt();return}let e=document.getElementById(Be);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Pt)?.remove(),Bt());return}e&&(e.remove(),document.getElementById(Pt)?.remove());let o=await gh();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=zn();if(!a||a.oppId!==t.oppId)return;let i=ds();i.id=Be,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Pt,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),yh(t.oppId)}finally{Fo=!1}}},ps=()=>{dh(),mh()};zb();function te(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function me(t){return te(t)}var xh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",Fe="ws-crm-compute-offer-button",Wn="ws-crm-compute-offer-popover",ys="ws-crm-offer-modal",bs="ws-crm-contact-actions-bar",wh=[".central-panel","[class*='central-panel']"],Ie=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",Un=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},kh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],hs=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${kh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},F=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},ms=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,Vn=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(xh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},et=()=>{document.getElementById(Wn)?.remove(),document.removeEventListener("mousedown",fs,!0)};function fs(t){let e=document.getElementById(Wn),o=document.getElementById(Fe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&et()}var xs=(t,e)=>{et();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Wn;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",fs,!0),0)},qo=(t,e)=>{xs(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(F("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(F("div",`color:${n.bone};font-size:12px;`,e))})},Eh=(t,e,o)=>{xs(t,r=>{r.appendChild(F("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let i=F("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{et(),o(a.property_record_id)}),r.appendChild(i)})})},Uo=()=>{document.getElementById(ys)?.remove(),document.removeEventListener("keydown",ws,!0)};function ws(t){t.key==="Escape"&&Uo()}var us=(t,e,o)=>{Uo(),et();let r=o,a=!1,i="",s=document.createElement("div");s.id=ys,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",p=>{p.target===s&&Uo()});let l=F("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(p,m,h)=>{a||(a=!0,i="",b(),Vn({tenantId:t,propertyRecordId:e,mode:p,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r={..._,current_offer:_.current_offer??r.current_offer,current_offer_date:_.current_offer_date??r.current_offer_date}:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed. Try again."}).finally(()=>{a=!1,b()}))};function b(){let p=r,m=!!p.has_comps;l.innerHTML="";let h=F("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=F("div","");_.appendChild(F("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(F("div",`font-size:12px;color:${n.ash};margin-top:2px;`,p.address||"-"));let y=F("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");y.type="button",y.addEventListener("click",Uo),h.append(_,y),l.appendChild(h);let k=F("div","padding:14px 18px 18px;");l.appendChild(k);let f=F("select",ms());(p.rehab_levels||[]).forEach(z=>{let N=document.createElement("option");N.value=z.key,N.textContent=z.label,z.key===(p.tier||p.property_condition)&&(N.selected=!0),f.appendChild(N)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let g=F("input",ms());g.type="number",g.placeholder="uses the level",g.value=p.repair_override!=null?String(p.repair_override):"",g.disabled=a,g.addEventListener("keydown",z=>{z.key==="Enter"&&g.blur()}),g.addEventListener("change",()=>d("recompute",f.value,g.value.trim()));let x=F("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");x.appendChild(F("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${p.comp_price_per_sqft}/sqft \xB7 ${p.comp_count} comps${p.comp_pull_at?` \xB7 pulled ${hs(p.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=F("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,g.value.trim())),x.append(S),k.appendChild(x),p.low_confidence&&m&&k.appendChild(F("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${p.comp_count??0} comps in window.`));let C=p.current_offer!=null;k.appendChild(F("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${Ie(p.current_offer)}${p.current_offer_date?` \xB7 ${hs(p.current_offer_date)}`:""}`:"No offer made yet."));let E=F("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=F("div","");w.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(f);let T=F("div","");T.appendChild(F("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),T.appendChild(g),E.append(w,T),k.appendChild(E);let $=F("div",`border-top:1px solid ${n.steel};padding-top:12px;`),P=(z,N,R)=>{let ye=F("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${R?.strong?"font-weight:700;":""}`),fe=F("div","");fe.appendChild(F("div",`font-size:${R?.strong?"13":"12"}px;color:${n.bone};`,z)),R?.sub&&fe.appendChild(F("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,R.sub));let ee=F("div",`font-size:${R?.strong?"15":"12"}px;color:${R?.color||n.bone};white-space:nowrap;`,N);ye.append(fe,ee),$.appendChild(ye)};if(m&&p.imv!=null){P("Investor Market Value (IMV)",Ie(p.imv)),p.arv!=null&&P("After Repair Value (ARV)",Ie(p.arv),{color:n.ash});let z=p.repair_adjustment??0,N=-z,R=p.repair_override?"Repair override":p.property_condition_label||"Repairs";z===0?P(`Repairs (${R})`,"Included",{color:n.ash,sub:`${Ie(p.repair_total)} in repairs included at IMV`}):P(`Repairs (${R})`,Un(N),{color:N<0?n.crimson:n.emerald,sub:`${Ie(p.repair_total)} total, ${Ie(p.baseline_repairs)} included at IMV`}),P("Min. Profit Target",Un(-(p.profit_target??0)),{color:n.ash}),P("Maximum Cash Offer (MAO)",Ie(p.mao),{strong:!0,color:n.blue}),P("Target Profit",Un(-(p.ico_delta??0)),{color:n.ash}),P("Initial Cash Offer (ICO)",Ie(p.ico),{strong:!0,color:n.blue})}else $.appendChild(F("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild($);let q=F("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);q.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),k.appendChild(q)}b(),document.body.appendChild(s),document.addEventListener("keydown",ws,!0)},vs=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=Fe,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Offer Worksheet")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){Eh(o,s.properties,l=>{a(!0),Vn({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?us(e,d.property_record_id,d):qo(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),qo(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?us(e,s.property_record_id,s):qo(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await Vn({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),qo(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Th=async()=>{for(let t of wh)try{let e=await I(t,{timeoutMs:3e3});if(e)return e}catch{}return null},_s=async(t,e)=>{let o=e.querySelector(`#${bs}`);if(!o)try{o=await I(`#${bs}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},gs=()=>{let t=document.querySelectorAll(`#${Fe}`);for(let e=1;e<t.length;e++)t[e].remove()},Sh=async()=>{let t=B();if(!t||!t.locationId||t.source!=="url"){document.getElementById(Fe)?.remove(),et();return}let e=t.locationId,o=document.getElementById(Fe);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),et();let r="seller";try{r=Ue(await qe(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(Fe)?.remove();return}let a=await Th();if(!a){c.warn("[compute-offer] no central panel found");return}let i=B();if(!i||i.contactId!==t.contactId)return;let s=vs(t.contactId,e);if(!await _s(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}gs(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(B()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(Fe)){let d=vs(t.contactId,e);_s(d,a).then(()=>gs())}});l.observe(a,{childList:!0})},Ft=null,ks=()=>{let t=B()?.contactId??null;if(Ft&&Ft.id===t)return;let e=Sh().finally(()=>{Ft?.promise===e&&(Ft=null)});Ft={id:t,promise:e}};var qt="reos-theme-stylesheet",Jn="reos-theme-fonts",Ut=!1,Ch=()=>{let t=document.getElementById(Jn);t&&t.remove()},Ah=`
/* ============================================
...
`,$h=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],Ih=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},Lh=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),Mh=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Vo=new WeakSet,Es=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Vo.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;let p=e.style.getPropertyValue("background-color");if(p==="rgb(18, 22, 29)"){Vo.add(e);return}if(e.closest(".hr-button")&&!(e.classList&&e.classList.contains("hr-button"))){p!=="transparent"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important")),Vo.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Vo.add(e)}catch{}})}catch{}},jn=new WeakSet,Nt=()=>{document.querySelectorAll(Mh.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(jn.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],b=+s[3];if(!(l<230||d<230||b<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),jn.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),jn.add(r)}})})},Ts=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},Ss=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},Cs=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Wo=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],b=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&b>=180&&l+d+b>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},As=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},zt=()=>{if(!Ut)for(let t of $h){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=Lh.has(r)?Ih(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},Xo="#1A1F28",Oh=26,Dh=31,Hh=40,$s=new Set,Is=new Set,jo=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!Is.has(a)&&a!=="<no class>"&&(Is.add(a),c.debug(`Hid empty "--" leaf: "${a}"`))})},Ph=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Rh=["trash","Trash","TRASH","delete","Delete","DELETE"],Bh=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(Rh.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";Ph.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},Fh=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Nh=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||Fh.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Ls=new Set,Ms=new WeakSet,zh=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Ms.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Ms.add(e);let p=e.className?.toString()||"<no class>";!Ls.has(p)&&p!=="<no class>"&&(Ls.add(p),c.debug(`Remapped pure-white text -> bone: "${p}"`))})},Os=new Set,Gh=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,b=l.backgroundImage||"",p=!1;if(b!=="none"&&b.includes("gradient"))p=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let C=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(C&&parseFloat(C[1])<.6)return;let E=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(E){let w=parseInt(E[1],10),T=parseInt(E[2],10),$=parseInt(E[3],10);(w>=60||T>=60||$>=60)&&(w>230&&T>230&&$>230||(w>=80||T>=80||$>=80)&&(p=!0))}}if(!p)return;let h=(i.textContent||"").trim(),_=s,y=Array.from(i.querySelectorAll("*")).map(C=>(C.className?.toString()||"").toLowerCase()).join(" "),k=h.toLowerCase()==="ask ai"||_.includes("ai-button")||_.includes("ask-ai")||_.includes("askai"),f=_.includes("bg-clip-text")||_.includes("text-transparent")||y.includes("bg-clip-text")||y.includes("text-transparent"),g=Array.from(i.querySelectorAll("*")).some(C=>{let E=window.getComputedStyle(C),w=E.getPropertyValue("-webkit-background-clip")||"",T=E.getPropertyValue("background-clip")||"";return w.includes("text")||T.includes("text")});if(k||f||g){let C=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],E=w=>{C.forEach(T=>w.style.removeProperty(T))};E(i),i.querySelectorAll("*").forEach(E);return}let x="#12161D";i.style.setProperty("color",x,"important"),i.querySelectorAll("*").forEach(C=>{let E=C.tagName.toLowerCase();E==="svg"||E==="path"||E==="circle"||E==="rect"||E==="polygon"||E==="polyline"||E==="line"||E==="g"?(C.style.setProperty("fill",x,"important"),C.style.setProperty("stroke",x,"important"),C.style.setProperty("color",x,"important")):(C.style.setProperty("color",x,"important"),C.style.setProperty("-webkit-text-fill-color",x,"important"))});let S=i.className?.toString()||"<no class>";!Os.has(S)&&S!=="<no class>"&&(Os.add(S),c.debug(`Darkened SVG icons on colored button: "${S}"`))})})},Ds=new Set,qh=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let b=d;if(b.closest("[id^='ws-crm-']"))return;let p=d.getBoundingClientRect();if(p.width===0||p.width>28||p.height>28)return;let m=p.left<r.right&&p.right>r.left,h=p.top<r.bottom&&p.bottom>r.top;if(!(m&&h)||p.top+p.height/2<a)return;let y=p.width*p.height/(r.width*r.height);if(y>.55)return;let k=b,f=b.parentElement,g=0;for(;f&&f!==e&&g<3;){let S=f.getBoundingClientRect();if(S.width>0&&S.width<=30&&S.height<=30)k=f;else break;f=f.parentElement,g++}k.style.setProperty("transform","translateY(11px)","important");let x=(k.className?.toString()||"")+" "+k.tagName;Ds.has(x)||(Ds.add(x),c.debug(`Dropped activity badge 11px (${p.width.toFixed(0)}x${p.height.toFixed(0)} icon, ratio ${y.toFixed(2)}): "${x}"`))})})},Uh="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Vh=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",Uh,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},Hs=new Set,Wh=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),b=parseInt(s[3],10);if(!(l>200&&d>200&&b>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!Hs.has(p)&&p!=="<no class>"&&(Hs.add(p),c.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${b})): "${p}"`))})})},Ps=new Set,jh=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Ps.has(l)&&l!=="<no class>"&&(Ps.add(l),c.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},Rs=new Set,Kh=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let f=s.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let f=s.getAttribute("style")||"";(f.includes("background-color")||f.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let b=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!b)return;let p=parseInt(b[1],10),m=parseInt(b[2],10),h=parseInt(b[3],10);if(!(p>200&&m>200&&h>200))return;let y=s.getBoundingClientRect();if(y.width<24||y.height<16||y.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let k=s.className?.toString()||"<no class>";!Rs.has(k)&&k!=="<no class>"&&(Rs.add(k),c.debug(`Coerced light bg (${y.width.toFixed(0)}x${y.height.toFixed(0)}, rgb(${p},${m},${h})): "${k}"`))})})},Bs=new Set,Yh=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let x=o.getAttribute("style")||"";(x.includes("color")||x.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let x=0;x<4&&a;x++){let S=a.nextElementSibling;if(S&&(S.matches(t)||S.querySelector(t)!==null)){i=S;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),b=l.className?.toString()||"",p=b.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=b.includes("hl-form-item")||b.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",_=(b.includes("hr-form-item-blank")||b.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);_&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=b.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=b.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=b.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!p&&!m&&!_&&!y&&!k&&!f&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Xo,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let g=o.className?.toString()||"<no class>";!Bs.has(g)&&g!=="<no class>"&&(Bs.add(g),c.debug(`Colored field label "${r.slice(0,30)}": "${g}"`))})},Fs=new Set,Jh=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(b=>{b.tagName==="svg"||b.tagName==="SVG"||b.tagName!=="IMG"&&(b.style.setProperty("font-size",`${l}px`,"important"),b.style.setProperty("line-height","1","important"),b.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!Fs.has(d)&&d!=="<no class>"&&(Fs.add(d),c.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Ns=new Set,Xh=new Set(["Enter Dashboard Name"]),Qh=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(Xh.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Xo,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",Xo,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!Ns.has(i)&&i!=="<no class>"&&(Ns.add(i),c.debug(`Forced input slate bg: "${i}"`))})},Ko=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<Oh&&l<Dh&&d<Hh))return;let p=e.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;e.style.setProperty("background-color",Xo,"important");let m=e.className?.toString()||"<no class>";!$s.has(m)&&m!=="<no class>"&&($s.add(m),c.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},Yo=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let b=d,p=!1;if(e.forEach(_=>{b.includes(_)&&(b=b.split(_).join(t),p=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(_=>{b.includes(_)&&(b=b.split(_).join("transparent"),p=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(y=>{b.includes(y)&&(b=b.split(y).join("#EDEEF0"),p=!0)}),!!p)try{let _=btoa(b);i.setAttribute("src",`data:image/svg+xml;base64,${_}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},Jo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Zh=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Gt=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=b=>{let p=r.querySelector(".ui-upload-icon svg");p&&(p.style.setProperty("color",b,"important"),p.style.setProperty("stroke",b,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",b,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},Kn=new WeakSet,em=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Kn.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){Kn.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Kt}`,t.title=`Built ${Yt}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var M=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Us=()=>{c.info(`Loaded v${Kt} (built ${Yt})`),or()?c.info(`[main] excluded location ${xe()} \u2014 skipping initial mounts, tracking nav only`):(M("mountVersionBadge (initial)",Qo),M("mountFavicon",Ia),M("mountThemeStylesheet",Xn),M("mountHideLaunchpad",Jr),M("mountHideNavItems",Xr),M("mountRelabelNav",Qr),M("mountHideTopmenuTabs",en),M("mountContractsSection",Zr)),M("initPageRouter",ta),c.info("[main] registering onPageChange subscriber"),Ge(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),or()){c.info(`[main] page change into excluded location ${xe()} \u2014 tearing down theme`),M("unmountThemeStylesheet",Gs);return}M("mountThemeStylesheet",Xn),M("mountVersionBadge",Qo),M("mountHideLaunchpad",Jr),M("mountHideNavItems",Xr),M("mountRelabelNav",Qr),M("mountHideTopmenuTabs",en),M("mountContractsSection",Zr),M("mountClaimReleaseToggle",ga),M("mountContactActionsBar",Aa),M("mountActiveFollowUpButton",la),M("mountMtOfferMadeButton",Oa),M("mountNotInterestedButton",Da),M("mountScheduleWalkthroughButton",Ha),M("mountResendDealLinkButton",Ra),M("mountReducePriceButton",Fa),M("mountEditLandingPageButton",Na),M("mountPublishButton",qa),M("mountContactMapLinks",Ya),M("mountSendToClosingOfficeButton",di),M("mountOppActionBar",Ti),M("mountClosingAgentPickerButton",Ki),M("mountPrepareContractButton",ps),M("mountComputeOfferButton",ks),M("mountManageTeam",Qi),M("mountBuyBoxWidget",ma),M("mountSupportNavItem",Oi),M("mountPhoneAssignmentsWidget",Ni)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Us):Us();})();
