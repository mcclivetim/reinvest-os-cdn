/* Wholesaling CRM Customizer v0.5.32 — built 2026-05-16T16:01:08.753Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var _="[wholesaling-crm-customizer]",ce="__WS_CRM_DEBUG",de=()=>!!window[ce],d={info(...e){console.log(_,...e)},warn(...e){console.warn(_,...e)},error(...e){console.error(_,...e)},debug(...e){de()&&console.log(_,"[debug]",...e)}};var O=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities/")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},C="",x="other",F=new Set,S=()=>{if(window.location.pathname!==C){C=window.location.pathname,x=O(),d.debug("Page changed:",x,C);for(let e of F)try{e(x)}catch(o){d.error("Subscriber threw:",o)}}},N=e=>(F.add(e),setTimeout(()=>e(x),0),()=>{F.delete(e)}),G=()=>{x=O(),C=window.location.pathname,d.debug("Router init, current page:",x);let e=history.pushState.bind(history),o=history.replaceState.bind(history);history.pushState=function(t,r,a){e(t,r,a),S()},history.replaceState=function(t,r,a){o(t,r,a),S()},window.addEventListener("popstate",S),setInterval(S,1e3)};var T="0.5.32",L="2026-05-16T16:01:08.753Z";var pe=/\/contacts\/detail\/([A-Za-z0-9]+)/,ue=/\/v2\/location\/([A-Za-z0-9]+)/,y=()=>{let e=window.location.pathname,o=e.match(pe);if(!o)return null;let t=e.match(ue);return{contactId:o[1],locationId:t?t[1]:null}};var w=(e,o={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:a=document}=o;return new Promise((n,c)=>{let s=a.querySelector(e);if(s){n(s);return}let i,m,f=()=>{p&&p.disconnect(),i!==void 0&&window.clearTimeout(i),m!==void 0&&window.clearInterval(m)},p=new MutationObserver(()=>{let h=a.querySelector(e);h&&(f(),n(h))});p.observe(document.body,{childList:!0,subtree:!0}),m=window.setInterval(()=>{let h=a.querySelector(e);h&&(f(),n(h))},r),i=window.setTimeout(()=>{f(),d.warn(`waitForElement timed out for selector: ${e}`),c(new Error(`Selector not found within ${t}ms: ${e}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},g={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},P={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},z=e=>{let o=e==="emerald"?l.emeraldGlow:e==="amber"?l.amberGlow:l.slate,t=e==="emerald"?l.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=e==="emerald"?l.emerald:e==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,B=`
  ...
  flex-shrink: 0;
`;var k="ws-crm-claim-release-pill",W=e=>{let o=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return o?o.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},me=({contactId:e,mode:o})=>{let t=document.createElement("button");t.id=k,t.type="button",t.dataset.contactId=e,t.dataset.mode=o;let r=o==="claim"?"emerald":"amber",a=o==="claim"?l.emerald:l.amber;return t.style.cssText=z(r),t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.title=o==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{d.info(`Claim/Release pill clicked for contact ${e}: ${o}`);let n=t.lastElementChild,c=n?.textContent??"";n&&(n.textContent="Working\u2026"),t.style.opacity="0.7",t.disabled=!0,setTimeout(()=>{n&&(n.textContent=c),t.style.opacity="1",t.disabled=!1},700)}),t},he=async(e,o=1e4)=>{let t=Date.now();for(;Date.now()-t<o;){let r=W(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},U=(e,o)=>{let t=me({contactId:o,mode:"claim"}),r=document.createElement("span");r.id=`${k}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),e.appendChild(r)},be=async()=>{let e=y();if(!e){document.getElementById(k)?.remove();return}let o=document.getElementById(k);if(!(o&&o.dataset.contactId===e.contactId)){o&&o.remove();try{let t=await w("#record-details-lhs",{timeoutMs:1e4}),r=await he(t),a=y();if(!a||a.contactId!==e.contactId)return;if(!r){d.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}U(r,e.contactId),d.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`);let n=null;n=new MutationObserver(async()=>{if(!(y()?.contactId===e.contactId)){n?.disconnect();return}if(document.getElementById(k))return;let s=W(t);s&&(U(s,e.contactId),d.debug("Re-mounted Claim/Release pill after React wipe"))}),n.observe(t,{childList:!0,subtree:!0})}catch(t){d.warn("Could not mount Claim/Release pill:",t)}}},q=()=>{be()};var ge="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",fe=()=>{let e=window.WS_CRM_USER_ID;if(e&&/^[A-Za-z0-9]{15,30}$/.test(e))return e;let o=window,t=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let r of t)if(typeof r=="string"&&/^[A-Za-z0-9]{15,30}$/.test(r))return r;try{let r=localStorage.getItem("user");if(r){let a=JSON.parse(r),n=a.id??a._id;if(n&&/^[A-Za-z0-9]{15,30}$/.test(n))return n}for(let a of["tokenUser","currentUser","ghl_user"]){let n=localStorage.getItem(a);if(n)try{let c=JSON.parse(n),s=c.id??c._id;if(s&&/^[A-Za-z0-9]{15,30}$/.test(s))return s}catch{}}}catch{}return null},ye=async({contactId:e,locationId:o,status:t,userId:r})=>{let n=await fetch(ge,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contact_id:e,location:{id:o},customData:{call_status:t,triggered_by_user_id:r??""}}),credentials:"omit"});if(!n.ok)throw new Error(`Webhook returned ${n.status} ${n.statusText}`)},I="ws-crm-contact-actions-bar",ve="ws-crm-call-status-dropdown",V="ws-crm-offer-made-modal",xe=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],we=[".central-panel","[class*='central-panel']"],ke=async()=>{for(let e of we)try{let o=await w(e,{timeoutMs:3e3});if(o)return o}catch{}try{return(await w("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ee=e=>{let o=document.createElement("div");o.id=ve,o.style.cssText="position: relative; flex-shrink: 0;";let t=document.createElement("button");t.type="button",t.style.cssText=B,t.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `;let r=document.createElement("div");return r.style.cssText=`
    ...
    padding: 4px;
    display: none;
  `,xe.forEach(a=>{let n=document.createElement("button");n.type="button",n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      width: 100%;
    ...
    `,n.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${P[a.color]};
        flex-shrink: 0;
      "></span>
      <span>${a.label}</span>
    `,n.addEventListener("mouseenter",()=>{n.style.background=l.slate}),n.addEventListener("mouseleave",()=>{n.style.background="transparent"}),n.addEventListener("click",async()=>{d.info(`Call Status set to "${a.label}" (${a.value}, ${a.color}) for contact ${e}`);let c=t.firstElementChild,s=t.children[1],i=t.children[2];c&&(c.style.background=P[a.color]),s&&(s.textContent=a.label),r.style.display="none";let f=y()?.locationId,p=fe();if(!f){d.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),s&&(s.textContent=`${a.label} (no tenant!)`),s&&(s.style.color=l.amber);return}if(a.color==="green"&&!p){d.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),s&&(s.textContent=`${a.label} (no user!)`),s&&(s.style.color=l.amber);return}let h=i?.textContent??"\u25BE";i&&(i.textContent="\u2026"),t.style.opacity="0.75";try{await ye({contactId:e,locationId:f,status:a.label,userId:p}),i&&(i.textContent="\u2713"),setTimeout(()=>{i&&(i.textContent=h),t.style.opacity="1"},900)}catch(u){d.warn("Call Status webhook failed:",u),i&&(i.textContent="\u2717"),s&&(s.style.color=l.amber),t.style.opacity="1",setTimeout(()=>{i&&(i.textContent=h),s&&(s.style.color=l.bone)},1800)}}),r.appendChild(n)}),t.addEventListener("click",a=>{a.stopPropagation(),r.style.display=r.style.display==="none"?"block":"none"}),document.addEventListener("click",a=>{o.contains(a.target)||(r.style.display="none")}),o.appendChild(t),o.appendChild(r),o},_e=e=>{document.getElementById(V)?.remove();let o=document.createElement("div");o.id=V,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(t),document.body.appendChild(o);let n=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&n()}),t.querySelector("#ws-offer-cancel")?.addEventListener("click",n),t.querySelector("#ws-offer-submit")?.addEventListener("click",()=>{let c=(t.querySelector("#ws-offer-amount")?.value??"").trim(),s=t.querySelector("#ws-offer-expires")?.value??"";if(!c||Number(c)<=0){d.warn("Offer Made submit blocked \u2014 invalid amount");return}d.info(`Offer Made recorded for contact ${e}: $${c}, expires ${s}`),n()}),setTimeout(()=>{t.querySelector("#ws-offer-amount")?.focus()},0)},j=e=>{let o=document.createElement("div");o.id=I,o.dataset.contactId=e,o.style.cssText=`
    ...
    flex-shrink: 0;
  `,o.appendChild(Ee(e));let t=document.createElement("button");return t.type="button",t.style.cssText=R,t.textContent="Offer Made",t.addEventListener("click",()=>_e(e)),o.appendChild(t),o},Se=async()=>{let e=y();if(!e){document.getElementById(I)?.remove();return}let o=document.getElementById(I);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove();let t=await ke();if(!t){d.warn("Could not mount actions bar \u2014 central panel not found within timeout");return}let r=y();if(!r||r.contactId!==e.contactId)return;let a=j(e.contactId);a.dataset.mountTarget=t.className||"central-panel",t.insertBefore(a,t.firstChild),d.debug(`Mounted contact actions bar for ${e.contactId}`);let n=null;n=new MutationObserver(()=>{let c=document.getElementById(I);if(!(y()?.contactId===e.contactId)){n?.disconnect();return}if(!c){let i=j(e.contactId);i.dataset.mountTarget=a.dataset.mountTarget??"",t.insertBefore(i,t.firstChild),d.debug(`Re-mounted actions bar after React wipe for ${e.contactId}`)}}),n.observe(t,{childList:!0})},Y=()=>{Se()};var Z="reos-theme-stylesheet",J="reos-theme-fonts",Ce=()=>{if(document.getElementById(J))return;let e=document.createElement("link");e.rel="preconnect",e.href="https://fonts.googleapis.com",document.head.appendChild(e);let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.gstatic.com",o.crossOrigin="anonymous",document.head.appendChild(o);let t=document.createElement("link");t.id=J,t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap",document.head.appendChild(t)},Te=`
/* ============================================
...
`,Le=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"rgba(15, 181, 126, 0.12)",border:"1px solid rgba(15, 181, 126, 0.3)"}},{selector:".hr-avatar, .hr-avatar__text, .hr-avatar__text p, .hr-avatar p, .hr-avatar span, .hr-avatar div, [class*='avatar'], [class*='avatar'] span, [class*='avatar'] p, [class*='avatar'] div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff']",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}}],M=()=>{for(let e of Le){let o;try{o=document.querySelectorAll(e.selector)}catch{continue}o.forEach(t=>{for(let[r,a]of Object.entries(e.styles)){let n=t.style.getPropertyPriority(r),c=t.style.getPropertyValue(r);n==="important"&&c===a||t.style.setProperty(r,a,"important")}})}},H="#1A1F28",Ie=26,Me=31,Ae=40,K=new Set,X=new Set,A=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let r=o.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;o.style.setProperty("display","none","important");let a=o.className?.toString()||"<no class>";!X.has(a)&&a!=="<no class>"&&(X.add(a),d.debug(`Hid empty "--" leaf: "${a}"`))})},Q=new Set,De=()=>{document.querySelectorAll(".hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, aside.default-bg-color").forEach(o=>{o.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(r=>{if(r.closest("[id^='ws-crm-']")||(r.className?.toString()||"").toLowerCase().includes("avatar"))return;let n=window.getComputedStyle(r),c=n.backgroundColor,s=n.backgroundImage||"",i=!1;if(s!=="none"&&s.includes("gradient"))i=!0;else if(c&&c!=="rgba(0, 0, 0, 0)"&&c!=="transparent"){let u=c.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(u){let b=parseInt(u[1],10),E=parseInt(u[2],10),$=parseInt(u[3],10);(b>=60||E>=60||$>=60)&&(b>230&&E>230&&$>230||(b>=80||E>=80||$>=80)&&(i=!0))}}if(!i)return;if(Array.from(r.querySelectorAll("*")).some(u=>{let b=window.getComputedStyle(u);return b.getPropertyValue("-webkit-background-clip")==="text"||b.getPropertyValue("background-clip")==="text"})){r.style.removeProperty("color"),r.querySelectorAll("*").forEach(u=>{u.style.removeProperty("color"),u.style.removeProperty("-webkit-text-fill-color"),u.style.removeProperty("fill"),u.style.removeProperty("stroke"),u.style.removeProperty("background-image"),u.style.removeProperty("background"),u.style.removeProperty("-webkit-background-clip"),u.style.removeProperty("background-clip")});return}let p="#12161D";r.style.setProperty("color",p,"important"),r.querySelectorAll("*").forEach(u=>{let b=u.tagName.toLowerCase();b==="svg"||b==="path"||b==="circle"||b==="rect"||b==="polygon"||b==="polyline"||b==="line"||b==="g"?(u.style.setProperty("fill",p,"important"),u.style.setProperty("stroke",p,"important"),u.style.setProperty("color",p,"important")):(u.style.setProperty("color",p,"important"),u.style.setProperty("-webkit-text-fill-color",p,"important"))});let h=r.className?.toString()||"<no class>";!Q.has(h)&&h!=="<no class>"&&(Q.add(h),d.debug(`Darkened SVG icons on colored button: "${h}"`))})})},ee=new Set,$e=()=>{document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header").forEach(o=>{o.querySelectorAll("*").forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']"))return;let a=(r.className?.toString()||"").toLowerCase();if(a.includes("avatar")||a.includes("notification-dot")||a.includes("indicator"))return;let n=window.getComputedStyle(r).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let c=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let s=parseInt(c[1],10),i=parseInt(c[2],10),m=parseInt(c[3],10);if(!(s>200&&i>200&&m>200))return;let p=r.getBoundingClientRect();if(p.width<24||p.height<16||p.width>1400)return;r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important");let h=r.className?.toString()||"<no class>";!ee.has(h)&&h!=="<no class>"&&(ee.add(h),d.debug(`Coerced light bg (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${s},${i},${m})): "${h}"`))})})},te=new Set,Fe=()=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(e)||t.closest("[class*='avatar'], [class*='hr-avatar']"))return;let a=t,n=null;for(let f=0;f<4&&a;f++){let p=a.nextElementSibling;if(p&&(p.matches(e)||p.querySelector(e)!==null)){n=p;break}a=a.parentElement}if(!n)return;let c=t.getBoundingClientRect();if(c.width===0||c.height===0||c.width>400||c.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let s=n,i=s.getBoundingClientRect();i.width>0&&i.width<=800&&i.height>0&&i.height<=100&&(s.style.setProperty("background-color",H,"important"),s.style.setProperty("border-color","#252C36","important"),s.style.setProperty("border-style","solid","important"),s.style.setProperty("border-width","1px","important"),s.style.setProperty("border-radius","4px","important"));let m=t.className?.toString()||"<no class>";!te.has(m)&&m!=="<no class>"&&(te.add(m),d.debug(`Colored field label "${r.slice(0,30)}": "${m}"`))})},oe=new Set,Pe=()=>{document.querySelectorAll("[class*='avatar']").forEach(o=>{if(o.closest("[id^='ws-crm-']"))return;let t=o.getBoundingClientRect();if(t.width===0||t.height===0||t.height>80||o.querySelector("svg, img")!==null)return;let a=(o.textContent||"").trim();if(a.length===0||a.length>4)return;let n=Math.min(t.width,t.height),c=Math.max(16,Math.min(24,Math.round(n*.6)));o.style.setProperty("font-size",`${c}px`,"important"),o.style.setProperty("line-height","1","important"),o.style.setProperty("display","flex","important"),o.style.setProperty("align-items","center","important"),o.style.setProperty("justify-content","center","important"),o.style.setProperty("text-align","center","important"),o.querySelectorAll("*").forEach(i=>{i.tagName==="svg"||i.tagName==="SVG"||i.tagName!=="IMG"&&(i.style.setProperty("font-size",`${c}px`,"important"),i.style.setProperty("line-height","1","important"),i.style.setProperty("text-align","center","important"))});let s=o.className?.toString()||"<no class>";!oe.has(s)&&s!=="<no class>"&&(oe.add(s),d.debug(`Resized avatar text to ${c}px (circle ${n.toFixed(0)}px): "${s}"`))})},re=new Set,Re=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(o=>{if(o.closest("[id^='ws-crm-']"))return;let t=o.getBoundingClientRect();if(t.width===0||t.height===0)return;o.style.setProperty("background-color",H,"important"),o.style.setProperty("border-color","#252C36","important"),o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let r=o.className?.toString()||"<no class>";!re.has(r)&&r!=="<no class>"&&(re.add(r),d.debug(`Forced input slate bg: "${r}"`))})},D=()=>{document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let t=window.getComputedStyle(o).backgroundColor;if(!t||t==="rgba(0, 0, 0, 0)"||t==="transparent")return;let r=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!r)return;let a=parseInt(r[1],10),n=parseInt(r[2],10),c=parseInt(r[3],10);if(!(a<Ie&&n<Me&&c<Ae))return;let i=o.getBoundingClientRect();if(i.width===0||i.height===0||i.width>800||i.height>200)return;o.style.setProperty("background-color",H,"important");let m=o.className?.toString()||"<no class>";!K.has(m)&&m!=="<no class>"&&(K.add(m),d.debug(`Coerced dark bg to slate (${i.width.toFixed(0)}x${i.height.toFixed(0)}, rgb(${a},${n},${c})): "${m}"`))})},ae=()=>{let e,o=()=>{e===void 0&&(e=window.setTimeout(()=>{e=void 0,M(),Re(),D(),A(),Fe(),$e(),De(),Pe()},100))};M(),D(),A(),window.setTimeout(()=>{M(),D(),A()},500),window.setTimeout(()=>{M(),D(),A()},1500),new MutationObserver(()=>{o()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},ne=()=>{if(Ce(),!document.getElementById(Z)){let e=document.createElement("style");e.id=Z,e.textContent=Te,document.head.appendChild(e),d.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?ae():window.addEventListener("DOMContentLoaded",ae))};var se="ws-crm-customizer-version-badge",le=()=>{if(document.getElementById(se))return;let e=document.createElement("div");e.id=se,e.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var ie=()=>{d.info(`Loaded v${T} (built ${L})`),ne(),G(),N(e=>{d.debug("Page handler firing for:",e),le(),q(),Y()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie();})();
