/* Wholesaling CRM Customizer v0.36.1 — built 2026-06-13T18:56:35.699Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Ms="__WS_CRM_DEBUG",Os=()=>!!window[Ms],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Os()&&console.log(qt,"[debug]",...t)}};var Ds=/\/v2\/location\/([A-Za-z0-9]+)/,Hs=new Set(["8ntUQzMflUkR0YvrRgVk"]),Re=()=>{let t=window.location.pathname.match(Ds);return t?t[1]:null},er=()=>{let t=Re();return t!==null&&Hs.has(t)};var Kn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,tr=/\/v2\/location\/([A-Za-z0-9]+)/,Ps=t=>{let e=t.match(Kn);if(!e)return null;let o=t.match(tr);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Bs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Kn);if(!a)continue;let i=r.match(tr)||window.location.pathname.match(tr);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Ps(window.location.pathname);return t||Bs()};var Yn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",or=null,Fe="other",rr=new Set,Ut=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==or))){Vt=window.location.pathname,or=t,Fe=Yn(),c.debug("Page/context changed:",Fe,Vt,"contact:",t);for(let r of rr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(rr.add(t),setTimeout(()=>t(Fe),0),()=>{rr.delete(t)}),Jn=()=>{Fe=Yn(),Vt=window.location.pathname,or=P()?.contactId??null,c.debug("Router init, current page:",Fe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.1",Kt="2026-06-13T18:56:35.700Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},nr={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Xn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var Rs=/^[A-Za-z0-9]{15,30}$/,nt=t=>typeof t=="string"&&Rs.test(t),Qn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Fs=()=>{let t=window.WS_CRM_USER_ID;return nt(t)?t:null},Ns=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(nt(o))return o;return null},zs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Qn(e);if(!o)return null;let r=o.uid;if(nt(r))return r;let a=o.claims;if(a&&nt(a.user_id))return a.user_id}catch{}return null},Gs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(nt(a))return a}catch{}}}catch{}return null},O=()=>Fs()||Ns()||zs()||Gs()||null,qs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Qn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:qs()?.type==="agency"};var oa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Us=`${oa}/active-follow-up-get`,Vs=`${oa}/active-follow-up-set`,Ce="ws-crm-active-follow-up-button",ir={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ws=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},js=async t=>{let e=await fetch(Us,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ks=async(t,e)=>{let o=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Ae=(t,e)=>{let o=ir[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Zn=t=>{let e=document.createElement("button");return e.type="button",e.id=Ce,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,Ae(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Ws();if(!(!r||r.contactId!==t)){Ae(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Ks(r,O()),i=a&&a.state&&a.state in ir?a.state:"blue";Ae(e,i),c.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){c.error("Active Follow Up Set webhook failed",a),Ae(e,"error"),setTimeout(()=>void Jt(e,r),4e3)}}}),e},Jt=async(t,e)=>{Ae(t,"loading");try{let o=await js(e),r=o&&o.state&&o.state in ir?o.state:"gray",a=document.getElementById(Ce);if(!a||a.dataset.contactId!==e.contactId)return;Ae(a,r)}catch(o){c.warn("Active Follow Up Get webhook failed",o),Ae(t,"error")}},Ys=[".central-panel","[class*='central-panel']"],ar="ws-crm-contact-actions-bar",Js=async()=>{for(let t of Ys)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await L("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Xs=async(t,e)=>{let o=e.querySelector(`#${ar}`);if(!o)try{o=await L(`#${ar}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${ar}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Qs=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},Zs=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},el=async t=>{if(t==="url"){let o=await Js();return o?{kind:"contact-detail",target:o}:null}let e=Qs();return e?{kind:"conversations",target:e}:null},ea=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Xs(t,e.target);return o}return Zs(t,e.target),"conversations-header"},tl=async()=>{let t=P();if(!t||!t.locationId){document.getElementById(Ce)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(Ce);if(o&&o.dataset.contactId===e.contactId){Jt(o,e);return}o&&o.remove();let r=await el(t.source);if(!r){c.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=P();if(!a||a.contactId!==e.contactId)return;let i=Zn(e.contactId),s=await ea(i,r);c.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),ta();let l=document.getElementById(Ce)??i;Jt(l,e);let d=new MutationObserver(()=>{let p=document.getElementById(Ce);if(!(P()?.contactId===e.contactId)){d.disconnect();return}if(!p){let m=Zn(e.contactId);ea(m,r).then(()=>{ta(),Jt(m,e)}),c.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},at=null,ra=()=>{let t=P()?.contactId??null;if(at&&at.contactId===t)return;let e=tl().finally(()=>{at?.promise===e&&(at=null)});at={contactId:t,promise:e}},ta=()=>{let t=document.querySelectorAll(`#${Ce}`);if(!(t.length<=1)){c.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ol="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",it=new Map,Ne=async(t,e)=>{if(!t)return null;if(it.has(t))return it.get(t)??null;if(!e)return c.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ol}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return c.warn(`Contact Type fetch returned ${i.status} for ${t}`),it.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return it.set(t,l),c.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),c.warn(`Contact Type fetch failed for ${t}:`,a),it.set(t,null),null}};var ze=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var ia="ws-buybox-nav-icon",dr="ws-buybox-panel",na="ws-buybox-modal",rl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",cr="https://mcclivetim.github.io/reinvest-os-cdn/geo",Xt=null,st=null,lt=null,lr=async()=>{if(Xt)return Xt;try{let t=await fetch(`${cr}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return Xt=await t.json(),Xt}catch(t){return c.error("[buy-box] failed to fetch states.json",t),[]}},nl=async t=>{if(!st)try{let e=await fetch(`${cr}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);st=await e.json()}catch(e){return c.error("[buy-box] failed to fetch counties.json",e),[]}return st?.[t]??[]},al=async t=>{if(!lt)try{let e=await fetch(`${cr}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);lt=await e.json()}catch(e){return c.error("[buy-box] failed to fetch cities.json",e),[]}return lt?.[t]??[]},pr=async t=>await(await fetch(rl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),il=(t,e)=>pr({tenant_id:t,action:"list",buyer_contact_id:e}),sl=(t,e,o,r)=>pr({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),ll=(t,e)=>pr({tenant_id:t,action:"remove",entry_id:e}),q=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),dl=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},cl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',pl='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',bl="nav.w-13, nav[class*='w-13']",hl=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ml=async()=>{try{return await L(bl,{timeoutMs:2500})}catch{return null}},ul=async()=>{try{return await L(hl,{timeoutMs:2500})}catch{return null}},vl=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,_l=(t,e)=>{let o=document.createElement("div");return o.id=dr,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{wl(t,e,()=>br(t,e))}),o},br=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([il(t,e),lr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}yl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},yl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?dl(b.geo_value,o):b.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${q(m)}</span>
              <button type="button" data-entry-id="${q(b.id)}" data-entry-label="${q(m)}" class="ws-buybox-remove" aria-label="Remove ${q(m)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${pl}</button>
            </div>
          `}).join("");return`
        <div style="margin-bottom: 18px;">
          <div style="font-family: ${u.mono}; font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase; color: ${n.ash}; margin-bottom: 6px;">${q(d.label)} (${e[d.key].length})</div>
          ${p}
        </div>
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,ll(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}br(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Qt=!1,sa=(t,e)=>{Qt=e;let o=vl(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=gl,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",br(t.tenantId,t.buyerContactId)):(t.iconBtn.className=la,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},la="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",gl="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",fl=t=>{let e=document.createElement("button");return e.id=ia,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=la,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${cl.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Qt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),sa(r,a)}),e},wl=(t,e,o)=>{let r=document.getElementById(na);r&&r.remove();let a=document.createElement("div");a.id=na,a.style.cssText=`
  ...
  `,h=g=>{let T=i.querySelector("#ws-buybox-state-search"),A=i.querySelectorAll(".ws-buybox-state-row");A.forEach(F=>{F.addEventListener("mouseenter",()=>{F.style.background=n.emeraldGlow}),F.addEventListener("mouseleave",()=>{F.style.background="transparent"}),F.addEventListener("click",()=>{s.stateCode=F.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let F=(T.value||"").toLowerCase().trim();g.forEach((R,z)=>{let G=A[z];if(!G)return;let N=!F||R.name.toLowerCase().includes(F)||R.code.toLowerCase()===F;G.style.display=N?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},_=g=>`
    ...
    <div style="color: ${n.ash}; padding: 20px 0; text-align: center;">Loading list for ${q(g)}\u2026</div>
  `,x=g=>{let T=g.find(A=>A.code===s.stateCode);return`
    ...
    `},k=g=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>E(s.stateCode||""))},f=g=>{let T=s.granularity==="county"?st?.[s.stateCode||""]??[]:lt?.[s.stateCode||""]??[];return`
      <div style="font-family: ${u.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${q(g)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${T.length.toLocaleString()} ${q(g).toLowerCase()}s in ${q(s.stateCode||"")}.</div>
    ...
    `},y=()=>{let g=s.granularity==="county"?st?.[s.stateCode||""]??[]:lt?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),A=i.querySelector("#ws-buybox-value-list");if(!T||!A)return;let F=R=>{let z=R.toLowerCase().trim();if(!z){A.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let G=g.filter(N=>N.toLowerCase().includes(z)).slice(0,50);if(G.length===0){A.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${q(s.stateCode||"")}.</div>`;return}A.innerHTML=G.map(N=>`
        <div data-value="${q(N)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${q(N)}
        </div>
      `).join(""),A.querySelectorAll(".ws-buybox-value-row").forEach(N=>{N.addEventListener("mouseenter",()=>{N.style.background=n.emeraldGlow}),N.addEventListener("mouseleave",()=>{N.style.background="transparent"}),N.addEventListener("click",()=>{s.value=N.dataset.value||"",E(s.value)})})};T.addEventListener("input",()=>F(T.value)),F(""),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T.focus(),0)},w=()=>`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",A=>{A.key==="Enter"&&(A.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),A=(g?.value||"").trim();if(!/^\d{5}$/.test(A)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await E(A)},E=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),A=i.querySelector("#ws-buybox-save");A&&(A.disabled=!0,A.textContent="Adding\u2026"),T&&(T.textContent="");try{let F=await sl(t,e,s.granularity,g);if(!F.ok){T&&(T.textContent=F.error||"Failed to add entry."),A&&(A.disabled=!1,A.textContent="Add");return}o(),i.innerHTML=`
        <div style="text-align: center; padding: 40px 0;">
          <div style="font-size: 32px;">\u2713</div>
          <div style="font-size: 16px; margin-top: 8px;">Added <strong>${q(g)}</strong> to the buy-box.</div>
          <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${F.deduplicated?"(Already existed; not duplicated.)":""}</div>
        </div>
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(F){T&&(T.textContent=`Network error: ${F.message}`),A&&(A.disabled=!1,A.textContent="Add")}};l()},sr=!1,Ge=null,dt=null,aa=()=>{document.getElementById(ia)?.remove(),document.getElementById(dr)?.remove(),dt&&Ge&&Ge.nav.removeEventListener("click",dt,!0),dt=null,Ge=null,Qt=!1},da=()=>{xl()},xl=async()=>{if(!sr){sr=!0;try{let t=P();if(!t){aa();return}let e=document.getElementById(dr);if(e&&e.dataset.buyerContactId===t.contactId&&Ge)return;aa();let o=null;try{o=await Ne(t.contactId,t.locationId)}catch(m){c.warn("[buy-box] Contact Type fetch failed",m);return}if(ze(o)!=="buyer")return;if(!t.locationId){c.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([ml(),ul()]);if(!a||!i){c.warn("[buy-box] right-rail nav or panel area not found");return}let s=P();if(!s||s.contactId!==t.contactId)return;let l=_l(t.locationId,t.contactId),d=fl(()=>Ge),p={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ge=p;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),dt=m=>{let h=m.target;if(!h||p.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Qt&&sa(p,!1)},a.addEventListener("click",dt,!0),c.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{sr=!1}}};var ge="ws-crm-claim-release-pill",kl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",El="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Tl=async t=>{let e=await fetch(kl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Sl=async t=>{let e=await fetch(El,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ba=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},qe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Xn(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Cl=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ge,o.type="button",o.dataset.contactId=t,qe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=P();if(!a||!a.locationId||a.contactId!==t)return;let i=O();if(!i){c.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>qe(o,r),2500);return}c.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";qe(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Sl({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;qe(o,d),c.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){c.error("Claim/Release Set webhook failed",l),qe(o,r);let d=o.querySelector(".ws-cr-label");if(d){let p=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=p)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},ca=async(t,e)=>{try{let o=await Tl({contactId:e.contactId,locationId:e.locationId,userId:O()}),r=document.getElementById(ge);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";qe(r,a)}catch(o){c.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Al=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=ba(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},pa=(t,e)=>{let o=Cl({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ge}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Il=async()=>{let t=P();if(!t){document.getElementById(ge)?.remove();return}let e=document.getElementById(ge);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await L("#record-details-lhs",{timeoutMs:1e4}),r=await Al(o),a=P();if(!a||a.contactId!==t.contactId)return;if(!r){c.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}pa(r,t.contactId),c.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ge);i&&t.locationId&&ca(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(P()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ge))return;let d=ba(o);if(d){pa(d,t.contactId);let p=document.getElementById(ge);p&&t.locationId&&ca(p,{contactId:t.contactId,locationId:t.locationId}),c.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){c.warn("Could not mount Claim/Release pill:",o)}}},ha=()=>{Il()};var fa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Ll="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var $l="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ml=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||fa,d;if(s==="buyer"){let b=wa.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let p=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!p.ok)throw new Error(`Webhook returned ${p.status} ${p.statusText}`)},Ol=async({contactId:t,tenantId:e})=>{let o=await fetch($l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Ue="ws-crm-contact-actions-bar",Dl="ws-crm-call-status-dropdown",ma="ws-crm-offer-made-modal",Hl=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],wa=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Pl=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Bl=async()=>{for(let t of Pl)try{let e=await L(t,{timeoutMs:2e3});if(e)return c.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await L("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return c.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return c.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Rl=({contactId:t,kind:e})=>{let o=e==="buyer"?wa:Hl,r=e==="buyer"?Ll:fa,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Dl,i.style.cssText="position: relative; flex-shrink: 0; order: 1;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let p=document.createElement("button");p.type="button",p.style.cssText=`
    ...
    `,p.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${nr[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,p.addEventListener("mouseenter",()=>{p.style.background=n.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",async()=>{c.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=nr[d.color]),m&&(m.textContent=d.label),l.style.display="none";let x=P()?.locationId,k=O();if(!x){c.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!k){c.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let f=h?.textContent??"\u25BE",y=async w=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await Ml({contactId:t,locationId:x,status:d.label,userId:k,deadReason:w,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=f),s.style.opacity="1"},900)}catch(S){c.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=f),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let w=m?.textContent??"";Gl(S=>{y(S)},()=>{m&&(m.textContent=w)});return}if(e==="seller"&&d.value==="appointment-booked"){let w=m?.textContent??"";try{(await Ol({contactId:t,tenantId:x})).ok?await y():ql(()=>{y()},()=>{m&&(m.textContent=w)})}catch(S){c.warn("Appointment sanity check failed; firing anyway:",S),await y()}return}await y()}),l.appendChild(p)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},Fl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Nl=async t=>{let e=await fetch(Fl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},zl=(t,e="seller")=>{document.getElementById(ma)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=ma,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=$,r.style.order="3",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",()=>zl(t,e)),o.appendChild(r),o.appendChild(Rl({contactId:t,kind:e}))}return o},hr=!1,ya=()=>{document.querySelectorAll(`[id="${Ue}"]`).forEach(t=>t.remove())},xa=async()=>{if(c.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),hr){c.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}hr=!0;try{await Ul()}finally{hr=!1}},Ul=async()=>{let t=P();if(!t){c.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),ya();return}if(c.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){c.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),ya();return}let e="seller";try{let p=await Ne(t.contactId,t.locationId),b=ze(p);b==="buyer"?e="buyer":b==="other"&&(e="other"),c.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${p??"(null)"})`)}catch(p){c.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",p)}let o=P();if(!o||o.contactId!==t.contactId){c.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Ue}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){c.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(c.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(p=>p.remove()));let a=await Bl();if(!a){c.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}c.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=P();if(!i||i.contactId!==t.contactId){c.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=_a(t.contactId,e)}catch(p){c.error("[actions-bar:08-FAIL] buildBar threw:",p);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(p){c.error("[actions-bar:09-FAIL] insertBefore threw:",p);return}if(!document.getElementById(Ue)){c.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}c.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(P()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Ue}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();c.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=_a(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),c.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){c.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),d.observe(a,{childList:!0})},ga=null,Vl=()=>{ga===null&&(ga=window.setInterval(()=>{let t=P();t&&(document.getElementById(Ue)||(c.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),xa()))},3e3))},ka=()=>{Vl(),xa()};var Zt="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Wl=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),ct="data-ws-crm-favicon",mr=t=>t.hasAttribute(ct),Ea=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Wl.has(e)},eo=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ea(r)&&!mr(r)&&r.remove()});let e=document.head.querySelector(`link[${ct}="1"]`);e?e.href!==Zt&&(e.href=Zt):(e=document.createElement("link"),e.setAttribute(ct,"1"),e.rel="icon",e.type="image/png",e.href=Zt,document.head.appendChild(e),c.debug("Favicon installed"));let o=document.head.querySelector(`link[${ct}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(ct,"apple"),o.rel="apple-touch-icon",o.href=Zt,document.head.appendChild(o))},Ta=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)eo();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),eo())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Ea(s)&&!mr(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&mr(s)&&(a=!0)});a&&eo()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,eo(),e>=5&&window.clearInterval(o)},1e3)};var jl=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Kl=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Yl=".hr-card.hr-modal.crm-opportunities-modal",H=()=>{let t=document.querySelector(Yl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Kl);if(a){let i=a[1];if(jl.includes(i))return i}}return null},W=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=H();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Sa="ws-crm-dispo-action-row",U=t=>{let e=document.getElementById(Sa);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Sa,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ae="ws-crm-mt-offer-made-button",Ca="ws-crm-mt-offer-made-modal",Xl=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ql=/\/v2\/location\/([A-Za-z0-9]+)/,ro=()=>{let t=window.location.pathname,e=t.match(Xl);if(!e)return null;let o=t.match(Ql);return{oppId:e[1],locationId:o?o[1]:null}},Zl=async t=>{let e=await fetch(Jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},to=()=>{document.getElementById(Ca)?.remove()},ed=t=>{to();let e=document.createElement("div");e.id=Ca,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ro();!o||!o.locationId||o.oppId!==t||ed({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},od=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rd=async()=>{for(let t of od)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},oo=!1,yr=async()=>{if(!oo){oo=!0;try{await nd()}finally{oo=!1}}},nd=async()=>{let t=ro();if(!t||!t.locationId){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}let e=document.getElementById(ae);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt());return}e&&(e.remove(),document.getElementById(`${ae}-wrap`)?.remove());let o=await rd();if(!o){c.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ro();if(!a||a.oppId!==t.oppId)return;let i=td(t.oppId),s=document.createElement("span");s.id=`${ae}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),ad(t.oppId)},pt=null,_r=null,bt=()=>{pt?.disconnect(),pt=null,_r=null},ad=t=>{if(pt&&_r===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(_r=t,pt=new MutationObserver(()=>{let o=ro();if(!o||o.oppId!==t){bt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ae)?.remove(),document.getElementById(`${ae}-wrap`)?.remove(),bt();return}document.getElementById(ae)||yr()}),pt.observe(e,{childList:!0,subtree:!0}))},ur=null,vr,id=()=>{ur||(ur=new MutationObserver(()=>{vr===void 0&&(vr=window.setTimeout(()=>{vr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ae);t&&!e&&!oo&&yr()},300))}),ur.observe(document.body,{childList:!0,subtree:!0}))},Aa=()=>{id(),yr()};var sd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ie="ws-crm-not-interested-button",ld=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dd=/\/v2\/location\/([A-Za-z0-9]+)/,ao=()=>{let t=window.location.pathname,e=t.match(ld);if(!e)return null;let o=t.match(dd);return{oppId:e[1],locationId:o?o[1]:null}},cd=async t=>{let e=await fetch(sd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},pd=t=>{let e=document.createElement("button");return e.id=ie,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=ao();if(!o||!o.locationId||o.oppId!==t)return;let r=O(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await cd({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,c.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){c.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},bd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hd=async()=>{for(let t of bd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},no=!1,xr=async()=>{if(!no){no=!0;try{await md()}finally{no=!1}}},md=async()=>{let t=ao();if(!t||!t.locationId){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}let e=document.getElementById(ie);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt());return}e&&(e.remove(),document.getElementById(`${ie}-wrap`)?.remove());let o=await hd();if(!o){c.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ao();if(!a||a.oppId!==t.oppId)return;let i=pd(t.oppId),s=document.createElement("span");s.id=`${ie}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Not Interested button on opp ${t.oppId}`),ud(t.oppId)},ht=null,wr=null,mt=()=>{ht?.disconnect(),ht=null,wr=null},ud=t=>{if(ht&&wr===t)return;mt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wr=t,ht=new MutationObserver(()=>{let o=ao();if(!o||o.oppId!==t){mt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ie)?.remove(),document.getElementById(`${ie}-wrap`)?.remove(),mt();return}document.getElementById(ie)||xr()}),ht.observe(e,{childList:!0,subtree:!0}))},gr=null,fr,vd=()=>{gr||(gr=new MutationObserver(()=>{fr===void 0&&(fr=window.setTimeout(()=>{fr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ie);t&&!e&&!no&&xr()},300))}),gr.observe(document.body,{childList:!0,subtree:!0}))},Ia=()=>{vd(),xr()};var _d="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",re="ws-crm-schedule-walkthrough-button",kr="ws-crm-schedule-walkthrough-modal",yd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gd=/\/v2\/location\/([A-Za-z0-9]+)/,lo=()=>{let t=window.location.pathname,e=t.match(yd);if(!e)return null;let o=t.match(gd);return{oppId:e[1],locationId:o?o[1]:null}},io=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},fd=(t,e)=>{document.getElementById(kr)?.remove();let o=document.createElement("div");o.id=kr,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,i=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${kr} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let s=()=>o.remove();o.addEventListener("click",d=>{d.target===o&&s()}),document.getElementById("wsw-cancel")?.addEventListener("click",s);let l=document.getElementById("wsw-submit");l?.addEventListener("click",async()=>{let d=document.getElementById("wsw-dt")?.value||"",p=document.getElementById("wsw-dur")?.value||"30";if(!d){io("Pick a date and time.","err");return}let b=new Date(d).toISOString();l.disabled=!0,l.textContent="Scheduling\u2026";try{if((await fetch(_d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:b,duration_min:Number(p)}),credentials:"omit"})).ok){s(),io("Walkthrough scheduled \u2713");let h=document.querySelector(`#${re} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else l.disabled=!1,l.textContent="Schedule",io("Scheduling failed \u2014 try again.","err")}catch(m){c.warn("[schedule-walkthrough] failed:",m),l.disabled=!1,l.textContent="Schedule",io("Couldn't reach the scheduler. Try again.","err")}})},wd=t=>{let e=document.createElement("button");return e.id=re,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=lo();!o||!o.locationId||o.oppId!==t||fd(o.oppId,o.locationId)}),e},xd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],kd=async()=>{for(let t of xd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},so=!1,Cr=async()=>{if(!so){so=!0;try{await Ed()}finally{so=!1}}},Ed=async()=>{let t=lo();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=await kd();if(!o){c.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=lo();if(!a||a.oppId!==t.oppId)return;let i=wd(t.oppId),s=document.createElement("span");s.id=`${re}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Td(t.oppId)},ut=null,Sr=null,vt=()=>{ut?.disconnect(),ut=null,Sr=null},Td=t=>{if(ut&&Sr===t)return;vt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Sr=t,ut=new MutationObserver(()=>{let o=lo();if(!o||o.oppId!==t){vt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),vt();return}document.getElementById(re)||Cr()}),ut.observe(e,{childList:!0,subtree:!0}))},Er=null,Tr,Sd=()=>{Er||(Er=new MutationObserver(()=>{Tr===void 0&&(Tr=window.setTimeout(()=>{Tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!so&&Cr()},300))}),Er.observe(document.body,{childList:!0,subtree:!0}))},La=()=>{Sd(),Cr()};var Cd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ve="ws-crm-resend-deal-link-wrap",Ad=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Id=/\/v2\/location\/([A-Za-z0-9]+)/,po=()=>{let t=window.location.pathname,e=t.match(Ad);if(!e)return null;let o=t.match(Id);return{oppId:e[1],locationId:o?o[1]:null}},Ld=async t=>{let e=await fetch(Cd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},$d=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),$a=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,$r=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${$a(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Md(t,e)),t.appendChild(o)},Md=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let p=document.createElement("button");return p.type="button",p.textContent=l,p.style.cssText=a,p.addEventListener("click",()=>void Od(t,e,d,o)),p};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>$r(t,e)),o.appendChild(s),t.appendChild(o)},Od=async(t,e,o,r)=>{let a=po();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await Ld({oppId:a.oppId,locationId:a.locationId,channel:o,userId:O()});if(i?.ok)r.innerHTML=`${$a(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,c.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";c.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${$d(s)}</span>`}window.setTimeout(()=>$r(t,e),3500)}},Dd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Hd=async()=>{for(let t of Dd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},co=!1,Mr=async()=>{if(!co){co=!0;try{await Pd()}finally{co=!1}}},Pd=async()=>{let t=po();if(!t||!t.locationId){document.getElementById(Ve)?.remove(),yt();return}let e=document.getElementById(Ve);if(e&&e.dataset.oppId===t.oppId){let s=H();s!==null&&s!=="Marketing Tracker"&&(e.remove(),yt());return}e&&e.remove();let o=await Hd();if(!o)return;let r=await W();if(r!=="Marketing Tracker"){c.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=po();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ve,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",U(o).appendChild(i),$r(i,t.oppId),c.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Bd(t.oppId)},_t=null,Lr=null,yt=()=>{_t?.disconnect(),_t=null,Lr=null},Bd=t=>{if(_t&&Lr===t)return;yt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Lr=t,_t=new MutationObserver(()=>{let o=po();if(!o||o.oppId!==t){yt();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ve)?.remove(),yt();return}document.getElementById(Ve)||Mr()}),_t.observe(e,{childList:!0,subtree:!0}))},Ar=null,Ir,Rd=()=>{Ar||(Ar=new MutationObserver(()=>{Ir===void 0&&(Ir=window.setTimeout(()=>{Ir=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ve)&&!co&&Mr()},300))}),Ar.observe(document.body,{childList:!0,subtree:!0}))},Ma=()=>{Rd(),Mr()};var Fd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",se="ws-crm-reduce-price-button",Oa="ws-crm-reduce-price-modal",Nd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zd=/\/v2\/location\/([A-Za-z0-9]+)/,mo=()=>{let t=window.location.pathname,e=t.match(Nd);if(!e)return null;let o=t.match(zd);return{oppId:e[1],locationId:o?o[1]:null}},Gd=async t=>{let e=await fetch(Fd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},bo=()=>{document.getElementById(Oa)?.remove()},qd=t=>{bo();let e=document.createElement("div");e.id=Oa,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let p=r.value.replace(/[^0-9.]/g,"").split(".");r.value=p[0]+(p.length>1?"."+p.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&bo()}),i?.addEventListener("click",()=>{bo()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let p=parseFloat(d);if(!Number.isFinite(p)||p<=0){a.textContent="Price must be a positive number.",r.focus();return}if(p<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(p*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Gd({oppId:t.oppId,locationId:t.locationId,newPrice:p,userId:O()}),bo(),t.onSuccess()}catch(b){c.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},Ud=(t,e)=>{let o=document.createElement("button");return o.id=se,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=mo();!r||!r.locationId||r.oppId!==t||qd({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Vd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Wd=async()=>{for(let t of Vd)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ho=!1,Pr=async()=>{if(!ho){ho=!0;try{await jd()}finally{ho=!1}}},jd=async()=>{let t=mo();if(!t||!t.locationId){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft();return}let e=document.getElementById(se);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft());return}e&&(e.remove(),document.getElementById(`${se}-wrap`)?.remove());let o=await Wd();if(!o){c.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await W();if(r!=="Disposition"){c.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=mo();if(!a||a.oppId!==t.oppId)return;let i=Ud(t.oppId,t.locationId),s=document.createElement("span");s.id=`${se}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Kd(t.oppId)},gt=null,Hr=null,ft=()=>{gt?.disconnect(),gt=null,Hr=null},Kd=t=>{if(gt&&Hr===t)return;ft();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Hr=t,gt=new MutationObserver(()=>{let o=mo();if(!o||o.oppId!==t){ft();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(se)?.remove(),document.getElementById(`${se}-wrap`)?.remove(),ft();return}document.getElementById(se)||Pr()}),gt.observe(e,{childList:!0,subtree:!0}))},Or=null,Dr,Yd=()=>{Or||(Or=new MutationObserver(()=>{Dr===void 0&&(Dr=window.setTimeout(()=>{Dr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(se);t&&!e&&!ho&&Pr()},300))}),Or.observe(document.body,{childList:!0,subtree:!0}))},Da=()=>{Yd(),Pr()};var We="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",uo="deals.reinvestos.com";var le="ws-crm-edit-landing-button",Jd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xd=/\/v2\/location\/([A-Za-z0-9]+)/,_o=()=>{let t=window.location.pathname,e=t.match(Jd);if(!e)return null;let o=t.match(Xd);return{oppId:e[1],locationId:o?o[1]:null}},Qd=(t,e)=>{let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",We);let r=O();return r&&o.searchParams.set("user",r),o.toString()},Zd=(t,e)=>{let o=document.createElement("button");return o.id=le,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=_o();if(!r||!r.locationId||r.oppId!==t)return;if(!We){c.warn("[edit-landing] editor session key not configured in this build");return}let a=Qd(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},ec=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tc=async()=>{for(let t of ec)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},vo=!1,Nr=async()=>{if(!vo){vo=!0;try{await oc()}finally{vo=!1}}},oc=async()=>{let t=_o();if(!t||!t.locationId){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt();return}let e=document.getElementById(le);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt());return}e&&(e.remove(),document.getElementById(`${le}-wrap`)?.remove());let o=await tc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=_o();if(!a||a.oppId!==t.oppId)return;let i=Zd(t.oppId,t.locationId),s=document.createElement("span");s.id=`${le}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),rc(t.oppId)},wt=null,Fr=null,xt=()=>{wt?.disconnect(),wt=null,Fr=null},rc=t=>{if(wt&&Fr===t)return;xt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fr=t,wt=new MutationObserver(()=>{let o=_o();if(!o||o.oppId!==t){xt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(le)?.remove(),document.getElementById(`${le}-wrap`)?.remove(),xt();return}document.getElementById(le)||Nr()}),wt.observe(e,{childList:!0,subtree:!0}))},Br=null,Rr,nc=()=>{Br||(Br=new MutationObserver(()=>{Rr===void 0&&(Rr=window.setTimeout(()=>{Rr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(le);t&&!e&&!vo&&Nr()},300))}),Br.observe(document.body,{childList:!0,subtree:!0}))},Ha=()=>{nc(),Nr()};var Ba="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",je="ws-crm-publish-button",kt="ws-crm-publish-wrap",go="ws-crm-publish-dropdown",ac=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ic=/\/v2\/location\/([A-Za-z0-9]+)/,qr=()=>{let t=window.location.pathname,e=t.match(ac);if(!e)return null;let o=t.match(ic);return{oppId:e[1],locationId:o?o[1]:null}},sc=async(t,e)=>{try{let o=await fetch(Ba,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:O()??null}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[publish] dry_run fetch failed:",o),null}},lc=async(t,e)=>{let o=await fetch(Ba,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:O()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},dc=(t,e)=>{if(!We){c.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${uo}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",We);let r=O();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},ve=()=>{document.getElementById(go)?.remove()},Pa=(t,e,o,r,a)=>{ve();let i=document.createElement("div");i.id=go;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};Ie(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await sc(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ie(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},Ie(o,r),document.getElementById(go)&&r.checks&&Pa(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},Ie(o,r),ve();try{let m=await lc(t,e);if(m.ok&&m.published)r={status:"published"},Ie(o,r),c.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ie(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";c.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},Ie(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(go)?ve():r.checks&&Pa(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),p=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let _=Math.max(1500,p-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},_)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},pc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bc=async()=>{for(let t of pc)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yo=!1,Vr=async()=>{if(!yo){yo=!0;try{await hc()}finally{yo=!1}}},hc=async()=>{let t=qr();if(!t||!t.locationId){document.getElementById(je)?.remove(),document.getElementById(kt)?.remove(),ve(),Tt();return}let e=document.getElementById(je);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(kt)?.remove(),ve(),Tt());return}e&&(e.remove(),document.getElementById(kt)?.remove(),ve());let o=await bc();if(!o)return;let r=await W();if(r!=="Disposition"){c.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=qr();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=cc(t.oppId,a.locationId),s=document.createElement("span");s.id=kt,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),U(o).appendChild(s),c.debug(`Mounted Publish button on opp ${t.oppId}`),mc(t.oppId)},Et=null,Ur=null,Tt=()=>{Et?.disconnect(),Et=null,Ur=null},mc=t=>{if(Et&&Ur===t)return;Tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ur=t,Et=new MutationObserver(()=>{let o=qr();if(!o||o.oppId!==t){Tt();return}let r=H();if(r!==null&&r!=="Disposition"){document.getElementById(je)?.remove(),document.getElementById(kt)?.remove(),ve(),Tt();return}document.getElementById(je)||Vr()}),Et.observe(e,{childList:!0,subtree:!0}))},zr=null,Gr,uc=()=>{zr||(zr=new MutationObserver(()=>{Gr===void 0&&(Gr=window.setTimeout(()=>{Gr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(je)&&!yo&&Vr()},300))}),zr.observe(document.body,{childList:!0,subtree:!0}))},Ra=()=>{uc(),Vr()};var Fa="data:image/png;base64,",Na="data:image/png;base64,";var vc=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],za=t=>`ws-crm-map-links-${t}`,fo=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let i=a.querySelector("input, textarea");if(i&&(i.value||"").trim())return i.value.trim()}return""},Ga=t=>{let e=fo(t.addr),o=fo(t.city),r=fo(t.state),a=fo(t.zip),i;return o&&e&&e.toLowerCase().includes(o.toLowerCase())?i=e:i=[e,o,r,a].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},_c=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,yc=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,gc=(t,e)=>{let{full:o,hasAny:r}=Ga(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},fc=t=>{let e=document.createElement("span");e.id=za(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,i,s)=>{let l=document.createElement("img");return l.src=a,l.title=i,l.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",l.addEventListener("mouseenter",()=>{l.style.transform="scale(1.12)"}),l.addEventListener("mouseleave",()=>{l.style.transform="scale(1)"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),gc(t,s)}),l};return e.appendChild(r(Fa,"Open in Google Maps",_c)),e.appendChild(r(Na,"Search on Zillow",yc)),e},wc=t=>{let e=document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']"),o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},qa=()=>{for(let t of vc){if(document.getElementById(za(t.key)))continue;let{hasAny:e}=Ga(t);if(!e)continue;let o=wc(t);o&&(o.style.display="flex",o.style.alignItems="center",o.style.width="100%",o.appendChild(fc(t)),c.debug(`[map-links] injected on "${t.addr}"`))}},Wr=null,jr,xc=()=>{Wr||(Wr=new MutationObserver(()=>{jr===void 0&&(jr=window.setTimeout(()=>{jr=void 0;try{qa()}catch(t){c.warn("[map-links] ensureInjected failed",t)}},300))}),Wr.observe(document.body,{childList:!0,subtree:!0}))},Ua=()=>{xc(),qa()};var Va="ws-crm-hide-launchpad",Wa=/\/launchpad\/?$/,Kr=()=>{if(!Yt()){if(!document.getElementById(Va)){let t=document.createElement("style");t.id=Va,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),c.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Wa.test(location.pathname)){let t=location.pathname.replace(Wa,"/dashboard")+location.search;c.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`),location.replace(t)}}};var kc=[{label:"Buy-Box Entries"},{label:"Memberships"}],ja=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),c.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Yr=()=>{let t=Yt(),e=new Set(kc.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){ja(e);for(let o of[150,500,1200,2500])setTimeout(()=>ja(e),o)}};var Ec=[{from:"Payments",to:"Contracts"}],Tc=".nav-title, .topmenu-navtitle",Ka=()=>{document.querySelectorAll(Tc).forEach(t=>{let e=(t.textContent||"").trim(),o=Ec.find(r=>r.from===e);o&&(t.textContent=o.to,c.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Jr=()=>{Ka();for(let t of[150,500,1200,2500])setTimeout(Ka,t)};var Ya="/payments/proposals-estimates",Sc=/\/payments\/invoices\/?$/,Cc=/\/payments\//,Ac='#sb_payments, a[meta="payments"]',Xa=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Ya)&&!(t>3&&!Cc.test(e))){if(Sc.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Ya));if(o){c.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Xa(t+1),120)}},Ja=!1,Ic=()=>{Ja||(Ja=!0,document.addEventListener("click",t=>{t.target?.closest?.(Ac)&&setTimeout(()=>Xa(),80)},!0),c.info("[contracts-section] section-entry redirect armed"))},Xr=()=>{Ic()};var Qa=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Za="ws-crm-hide-topmenu-tabs",Qr=()=>{if(document.getElementById(Za))return;let t=Qa.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Za,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),c.info(`[hide-topmenu-tabs] hid ${Qa.length} top tabs`)};var oi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",fe="ws-crm-send-to-closing-office-button",Le="ws-crm-send-to-title-co-wrap",ko="ws-crm-stc-dropdown",Lc=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$c=/\/v2\/location\/([A-Za-z0-9]+)/,Eo=()=>{let t=window.location.pathname,e=t.match(Lc);if(!e)return null;let o=t.match($c);return{oppId:e[1],locationId:o?o[1]:null}},Mc=5*60*1e3,ri=t=>`ws-crm-stc-cache:${t}`,Oc=t=>{try{let e=window.localStorage.getItem(ri(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Mc||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Dc=(t,e)=>{try{window.localStorage.setItem(ri(t),JSON.stringify(e))}catch{}},Hc=async(t,e)=>{try{let o=await fetch(oi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(c.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return c.warn("[stc] dry_run fetch failed:",o),null}},Pc=async(t,e,o)=>{let r=await fetch(oi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:O()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Bc=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return c.warn(`[stc] folder tab not found for "${t}"`),!1},ei=t=>{let e=document.getElementById(t);if(!e){c.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Rc=(t,e)=>{if(e&&Bc(e)){window.setTimeout(()=>ei(t),300);return}ei(t)},de=()=>{document.getElementById(ko)?.remove()},wo=(t,e,o)=>{de();let r=document.createElement("div");r.id=ko;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let p=["TC","ACQ","MT","DISPO","Property"],b={};t.forEach(_=>{b[_.group]||(b[_.group]=[]),b[_.group].push(_)});let m=[...p.filter(_=>b[_]),...Object.keys(b).filter(_=>!p.includes(_))];for(let _ of m){let x=b[_],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let f=document.createElement("div");f.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
    ...
    `,f.textContent=_,k.appendChild(f),x.forEach(y=>{let w=document.createElement("div"),S=!y.filled&&y.navigable&&y.field_id;w.style.cssText=`
        ...
        ${S?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,S&&(w.addEventListener("mouseenter",()=>{w.style.background=n.slate}),w.addEventListener("mouseleave",()=>{w.style.background="transparent"}),w.addEventListener("click",g=>{g.stopPropagation(),y.field_id&&(Rc(y.field_id,y.folder),de())}));let C=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,E=S?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";w.innerHTML=`${C}<span style="flex: 1;">${y.label}</span>${E}`,k.appendChild(w)}),r.appendChild(k)}document.body.appendChild(r);let h=_=>{let x=_.target;!r.contains(x)&&!o.contains(x)&&(de(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},pe=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,p="Send to Closing Office",b="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,p="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let _=e.checks?.filter(k=>k.filled).length??0,x=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,p=`${_} of ${x} Fields Ready`;break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",p="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,p=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=p),a&&(a.textContent=b)},Fc=(t,e)=>{let o=document.createElement("button");o.id=fe,o.type="button",o.dataset.oppId=t;let r=Oc(t),a=r?{status:r.checks.every(f=>f.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${$}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,pe(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let f=await Hc(t,e);if(!f){a={status:"error",message:"Check failed \u2014 click to retry"},pe(o,a);return}if(f.rate_limited){_=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},pe(o,a),c.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(_).toLocaleTimeString()}`);return}if(!Array.isArray(f.checks)||f.checks.length===0){a={status:"error",message:f.error||"Check failed \u2014 click to retry"},pe(o,a),c.warn("[stc] dry_run returned no checks:",f);return}let y=f.pipeline_name;if(y&&y!=="Transaction Coordination"){c.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),To.add(t),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de(),Ct();return}let w=f.checks;if(a.checks&&a.checks.length===f.checks.length){let C=new Set;w=f.checks.map((E,g)=>a.checks[g]?.filled&&!E.filled?i.has(E.label)?E:(C.add(E.label),{...E,filled:!0}):E),i=C}else i=new Set;a={status:w.every(C=>C.filled)?"ready":"incomplete",checks:w,previouslySentAt:f.previously_sent_at??null},Dc(t,{checks:w,previously_sent_at:f.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),pe(o,a),document.getElementById(ko)&&wo(w,f.previously_sent_at,o)},l=async()=>{let f=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},pe(o,a),de();try{let y=await Pc(t,e,f);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},pe(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},pe(o,a),y.checks&&wo(y.checks,y.previously_sent_at,o)}catch(y){c.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},pe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(ko)?de():a.checks&&wo(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,p=!1,b=Date.now(),m=1e4,h=5*60*1e3,_=0,x=async()=>{if(!p){if(Date.now()<_){c.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(_).toLocaleTimeString()}`);return}p=!0,b=Date.now();try{await s()}finally{p=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let f=new MutationObserver(()=>{if(d!==void 0||p)return;let w=Date.now()-b,S=Math.max(1500,m-w);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});f.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(f.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},Nc=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zc=async()=>{for(let t of Nc)try{let e=await L(t,{timeoutMs:1500});if(e)return c.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return c.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},To=new Set,ti=null,Gc=t=>{t&&t!==ti&&(To.clear(),ti=t)},xo=!1,on=async()=>{if(xo){c.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}xo=!0;try{await qc()}catch(t){c.error("[stc] ensureMountedImpl threw:",t)}finally{xo=!1}},qc=async()=>{c.debug("[stc] mount:01 ensureMountedImpl entered");let t=Eo();if(!t||!t.locationId){c.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de();return}if(c.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Gc(t.oppId),To.has(t.oppId)){c.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){c.debug("[stc] mount:03-SKIP existing button for same opp");let l=H();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(Le)?.remove(),de(),Ct());return}e&&(c.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(Le)?.remove(),de()),c.debug("[stc] mount:04 calling findMountTarget");let o=await zc();if(!o){c.debug("[stc] mount:04-BAIL findMountTarget returned null");return}c.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=H();if(r!==null&&r!=="Transaction Coordination"){c.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Eo();if(!a||a.oppId!==t.oppId||!a.locationId){c.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}c.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=Fc(t.oppId,a.locationId),s=document.createElement("span");s.id=Le,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,s.appendChild(i),U(o).appendChild(s),c.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),Uc(t.oppId)},St=null,tn=null,Ct=()=>{St?.disconnect(),St=null,tn=null},Uc=t=>{if(St&&tn===t)return;Ct();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(tn=t,St=new MutationObserver(()=>{let o=Eo();if(!o||o.oppId!==t){Ct();return}let r=H();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(fe)?.remove(),document.getElementById(Le)?.remove(),de(),Ct();return}document.getElementById(fe)||on()}),St.observe(e,{childList:!0,subtree:!0}))},Zr=null,en,Vc=()=>{Zr||(Zr=new MutationObserver(()=>{en===void 0&&(en=window.setTimeout(()=>{en=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);if(t&&!e&&!xo){let o=Eo();if(o&&To.has(o.oppId))return;on()}},300))}),Zr.observe(document.body,{childList:!0,subtree:!0}))},ni=()=>{Vc(),on()};var an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Wc=`${an}/tc/welcome-call-prefill`,jc=`${an}/tc/welcome-call-save`,Kc=`${an}/tc/order-lockbox`,At="ws-crm-welcome-call-overlay",Yc=["Regular Contract","Subject To","Seller Finance","Novation"],Jc=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],Xc=["Gas","Electric","Propane","Oil"],Qc=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],Zc=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],we=["Yes","No"],ep=["Yes","No","Unknown"],tp=["Professional Photographer","Seller","Tenant"],op=["Month-to-Month","Annual"],ai=["Current","Behind"],rp=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],be=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Co=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,li="margin-bottom:12px;",di=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,np=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ii=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),j=(t,e,o)=>{let r=ii(o);return`<select id="${t}" style="${Co}"><option value=""></option>${e.map(a=>`<option ${r!==""&&ii(a)===r?"selected":""}>${be(a)}</option>`).join("")}</select>`},Z=(t,e,o="")=>`<input id="${t}" type="text" value="${be(e)}" placeholder="${be(o)}" style="${Co}">`,ap=(t,e)=>`<textarea id="${t}" rows="3" style="${Co}resize:vertical;">${be(e)}</textarea>`,ip=(t,e)=>`<input id="${t}" type="date" value="${be(e)}" style="${Co}">`,D=(t,e)=>`<div style="${li}"><label style="${di}">${be(t)}</label>${e}</div>`,rn=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${rp.map(r=>`<label style="${np}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},_e=t=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${be(t)}</div>`,Ke=()=>{document.getElementById(At)?.remove()},$e=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},sp=t=>{let e=t.tenant||{};return`
    ${_e("Identifiers")}
    ...
    ${_e("Contract")}
    ${D("Type of Contract",j("wc-contract_type",Yc,t.contract_type))}

    ${_e("Property")}
    ${D("Property Type",j("wc-property_type",Qc,t.property_type))}
    ...
    ${D("Utilities",j("wc-utilities",Jc,t.utilities))}
    ${D("Heat Source",j("wc-heat_source",Xc,t.heat_source))}

    ${_e("Liens & Permits")}
    ${D("Is there a mortgage?",j("wc-has_mortgage",we,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${D("Mortgage payment status",j("wc-mortgage_payment_status",ai,t.mortgage_payment_status))}</div>
    ${D("Any other liens? (back taxes, code violations, HELOC, etc.)",j("wc-has_other_liens",we,t.has_other_liens))}
    ${D("Any open or expired permits?",j("wc-has_permit_issues",we,t.has_permit_issues))}
    ${D("Is the property in probate?",j("wc-in_probate",we,t.in_probate))}

    ${_e("Occupancy")}
    ${D("Property occupancy",j("wc-occupancy",Zc,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${D("Lease type",j("wc-tenant_lease_type",op,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Rent status",j("wc-tenant_rent_status",ai,e.rent_status))}</div>
        <div style="flex:1;">${D("Last rent paid",ip("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${D("Lease on hand?",j("wc-tenant_lease_on_hand",we,e.lease_on_hand))}</div>
        <div style="flex:1;">${D("Security deposit",Z("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${D("Selling with tenant in place?",j("wc-selling_with_tenant",we,t.selling_with_tenant))}
    </div>

    ${_e("HOA")}
    ${D("Part of an HOA?",j("wc-in_hoa",we,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${D("HOA monthly fee",Z("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${D("HOA rental restriction?",j("wc-hoa_rental_restriction",ep,t.hoa_rental_restriction))}</div>

    ${_e("Photos & Access")}
    ${D("Who is providing photos?",j("wc-photos_provided_by",tp,t.photos_provided_by))}
    <div style="${li}">
      <label style="${di}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${rn("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${rn("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${rn("photos_avail_evenings",t.photos_avail_evenings)}
    </div>

    ${_e("Lockbox")}
    ${D("Lockbox needed?",j("wc-lockbox_needed",we,t.lockbox_needed))}
    ...
    ${_e("Notes")}
    ${D("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",ap("wc-welcome_call_notes",t.welcome_call_notes))}
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},nn=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),si=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},So=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?be(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},lp=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:nn("photos_avail_mornings"),photos_avail_afternoons:nn("photos_avail_afternoons"),photos_avail_evenings:nn("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),dp=t=>{Ke();let e=document.createElement("div");e.id=At,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${At} input[type="date"]::-webkit-calendar-picker-indicator,#${At} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${sp(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",i=>{i.target===e&&Ke()}),document.getElementById("wc-close")?.addEventListener("click",Ke),document.getElementById("wc-cancel")?.addEventListener("click",Ke),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(i=>{document.getElementById(i)?.addEventListener("change",si)}),si();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!I("wc-occupancy")){$e("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(jc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(lp(t)),credentials:"omit"})).ok?(Ke(),$e("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,$e("Save failed \u2014 try again.","err"))}catch(i){c.warn("[welcome-call] save failed:",i),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,$e("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let i=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Kc,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:I("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:I("wc-lockbox_recipient_name"),recipient_phone:I("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,i&&(i.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,i.style.color=n.emerald),$e("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,$e("Lockbox order failed \u2014 try again.","err"))}catch(s){c.warn("[welcome-call] order lockbox failed:",s),a.textContent="Order Lockbox",a.disabled=!1,$e("Couldn't reach the lockbox handler. Try again.","err")}})},ci=async(t,e)=>{Ke();let o=document.createElement("div");o.id=At,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Wc}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let i=await a.json();r={...i,opp_id:i.opp_id||t,tenant_id:e}}else c.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){c.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,dp(r)};var mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",cp=`${mn}/tc/confirm-photo-appointment`,pp=`${mn}/tc/order-lockbox`,bp=`${mn}/tc/welcome-call-prefill`,pn="ws-crm-opp-action-bar",bi="ws-crm-opp-overflow",hi="ws-crm-opp-action-menu",bn="ws-crm-opp-action-popover",mi="ws-crm-reorder-lockbox-modal",ui=".hr-card.hr-modal.crm-opportunities-modal",hp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,mp=/\/v2\/location\/([A-Za-z0-9]+)/,vi="Welcome Call Needed",un="Scheduling Photos",_i="Photos Scheduled",up=[vi,un,_i,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],yi=()=>{let t=window.location.pathname,e=t.match(hp);if(!e)return null;let o=t.match(mp);return o?{oppId:e[1],locationId:o[1]}:null},vp=()=>{let t=document.querySelector(ui);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(up.includes(r))return r}return null},ke=()=>{document.getElementById(hi)?.remove(),document.getElementById(bn)?.remove(),document.getElementById(mi)?.remove()},sn=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),xe=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let l=()=>o.remove();o.addEventListener("click",p=>{p.target===o&&l()}),document.getElementById("wsrl-cancel")?.addEventListener("click",l);let d=document.getElementById("wsrl-submit");d?.addEventListener("click",async()=>{let p=document.getElementById("wsrl-name")?.value.trim()||"",b=document.getElementById("wsrl-phone")?.value.trim()||"",m=document.getElementById("wsrl-address")?.value.trim()||"";if(!p||!m){xe("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){d.disabled=!0,d.textContent="Ordering\u2026";try{await yp(t,e,{recipient_name:p,recipient_phone:b,ship_to:m})?(l(),xe("Lockbox re-order sent to ops \u2713")):(d.disabled=!1,d.textContent="Order Lockbox",xe("Re-order failed \u2014 try again.","err"))}catch(h){c.warn("[action-bar] reorder lockbox failed:",h),d.disabled=!1,d.textContent="Order Lockbox",xe("Couldn't reach the lockbox handler. Try again.","err")}}})},gi=async t=>{ke();let e={};try{e=await fetch(`${bp}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}gp(t,e)},fp=(t,e)=>{ke();let o=document.createElement("div");o.id=bn;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${u.sans};
  `,o.innerHTML=`
    <style>#${bn} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){xe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(cp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(ke(),xe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",xe("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",xe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(ke(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},wp=(t,e)=>{ke();let o=document.createElement("div");o.id=hi;let r=e.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(ke(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=$,o.textContent=t,o},xp=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},kp=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===vi){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>_p(t)),o.appendChild(r),o}if(e===un){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>fp(t,r)),o.appendChild(r),o}if(e===_i){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void gi(t)),o.appendChild(r),o}return null},Ep=(t,e)=>{let o=[];if(e===un&&(o=[{label:"Re-order Lockbox",onClick:()=>void gi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=bi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=xp();return a.addEventListener("click",i=>{i.stopPropagation(),wp(o,a)}),r.appendChild(a),r},Tp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Sp=async()=>{for(let t of Tp)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ao=()=>{document.getElementById(pn)?.remove(),document.getElementById(bi)?.remove(),ke()},Lo=!1,vn=async()=>{if(!Lo){Lo=!0;try{let t=yi();if(!t){Ao();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ao();return}let o=vp(),r=document.getElementById(pn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=kp(t,o);if(!a){Ao();return}let i=await Sp();if(!i)return;Ao();let s=U(i),l=document.createElement("span");l.id=pn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ep(t,o);d&&s.appendChild(d),Cp(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},It=null,hn=null,ln,pi=()=>{It?.disconnect(),It=null,hn=null},Cp=t=>{if(It&&hn===t)return;pi();let e=document.querySelector(ui);e&&(hn=t,It=new MutationObserver(()=>{let o=yi();if(!o||o.oppId!==t){pi();return}ln===void 0&&(ln=window.setTimeout(()=>{ln=void 0,vn()},250))}),It.observe(e,{childList:!0,subtree:!0}))},dn=null,cn,Ap=()=>{dn||(dn=new MutationObserver(()=>{cn===void 0&&(cn=window.setTimeout(()=>{cn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&vn()},300))}),dn.observe(document.body,{childList:!0,subtree:!0}))},fi=()=>{Ap(),vn()};var wi="ws-support-modal",xi="ws-support-toast",Ip="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",ki="ws-support-submitter-name",Ei="ws-support-submitter-email",Ti="ws-support-submitter-role",Lp=["Bug","Feature Request","Question","Billing","Onboarding Help"],Me=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),$p=(t,e="success",o)=>{let r=document.getElementById(xi);r&&r.remove();let a=document.createElement("div");a.id=xi;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Mp=()=>{document.getElementById(wi)?.remove();let t=(localStorage.getItem(ki)??"").trim(),e=(localStorage.getItem(Ei)??"").trim(),o=(localStorage.getItem(Ti)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=wi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;let s=l=>`
    <button type="button" data-category="${Me(l)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;i.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${Me(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${Me(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${Me(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=Re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(ki,r.submitterName),localStorage.setItem(Ei,r.submitterEmail),r.submitterRole&&localStorage.setItem(Ti,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Ip,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";$p(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Op=["/support-ticket","ws-support-modal","ws-support"],Dp=/\/custom-menu-link\//,_n=!1,Si=()=>{if(_n||!Dp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Op.some(s=>i.includes(s))});if(r){_n=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Mp(),_n=!1},50);return}t<10&&setTimeout(e,150)};e()},Ci=!1,Ai=()=>{Ci||(Ci=!0,Wt(()=>setTimeout(Si,50)),Si(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Hp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Bp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",$i="tc_closing_agent",Rp="tc_closing_office",ce="ws-crm-closing-agent-picker-button",Mi="ws-crm-closing-agent-picker-modal",Fp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Np=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(Fp);if(!e)return null;let o=t.match(Np);return{oppId:e[1],locationId:o?o[1]:null}},Tn=async t=>{let e=await fetch(Hp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ii=async t=>{let e=await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},zp=async(t,e)=>{try{let o=await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:$i}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Tn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Oe=null,Gp=60*60*1e3,Sn=t=>`ws-crm-to-cache:${t}`,Oi=t=>{try{let e=window.localStorage.getItem(Sn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Gp||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Di=(t,e,o)=>{try{window.localStorage.setItem(Sn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},qp=t=>{try{window.localStorage.removeItem(Sn(t))}catch{}},wn="ws-crm-closing-agent-field-link",Up=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${wn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},yn=!1,Cn=async t=>{if(yn)return;let e=Hi();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){yn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Tn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),xn(a.id,a.name,t);let i=document.getElementById(ce);if(i){Ee(i,{status:"linked",contactName:a.name});let s=Mt();s&&Di(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{yn=!1}}},Vp=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Hi=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();Vp.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},xn=(t,e,o)=>{let r=Hi();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${wn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=wn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},$o=()=>{document.getElementById(Mi)?.remove()},Wp=t=>{$o();let e=document.createElement("div");e.id=Mi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",p=>{p.target===e&&$o()}),i?.addEventListener("click",$o);let s,l="",d=async p=>{if(a&&p!==l){if(l=p,!p.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await Tn({tenantId:t.locationId,query:p,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{$o(),t.onPick(m)}),a.appendChild(h)})}catch(b){c.error("Closing Agent picker search failed",b),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let p=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(p)},250)})},Mo=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Ee=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,p="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,p="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,p="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=p},jp=(t,e)=>{let o=document.createElement("button");o.id=ce,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Ee(o,r);let a=Oi(t);return a&&(r={status:"linked",contactName:a.contactName},Ee(o,r),Oe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await zp(t,e);s?(r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},xn(s.id,s.name,e)):a||(r={status:"empty"},Ee(o,r),Oe?.oppId===t&&(Oe=null),Up(),qp(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Wp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ee(o,r);try{let l=[Ii({tenantId:e,oppId:t,fieldKey:$i,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Ii({tenantId:e,oppId:t,fieldKey:Rp,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Di(t,s.id,s.name),xn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ee(o,r)}}})}),o},Kp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Yp=async()=>{for(let t of Kp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lt=!1,Do=async()=>{if(!Lt){Lt=!0;try{await Jp()}finally{Lt=!1}}},Jp=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Yp();if(!r||!(Oi(t.oppId)!==null||Oe!==null&&Oe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Mt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=jp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Xp(t.oppId),Cn(i.locationId)},$t=null,kn=null,En=null,Oo=()=>{$t?.disconnect(),$t=null,kn=null,En=null},Xp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($t&&kn===t&&En===e||(Oo(),kn=t,En=e,$t=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t||!o.locationId){Oo();return}document.getElementById(ce)||Do(),Cn(o.locationId)}),$t.observe(e,{childList:!0,subtree:!0})))},gn=null,fn,Qp=()=>{gn||(gn=new MutationObserver(()=>{fn===void 0&&(fn=window.setTimeout(()=>{fn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lt&&Do()},300))}),gn.observe(document.body,{childList:!0,subtree:!0}))},Li,Zp=()=>{Li===void 0&&(Li=window.setInterval(()=>{let t=Mt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!Lt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Do()),Cn(t.locationId)},2e3))},Pi=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Qp(),Zp(),Do()};var eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Se="ws-crm-manage-team-cta",Bi="ws-crm-manage-team-modal",tb=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ri={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},ob={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Fi=()=>{let t=window.location.pathname.match(tb);return t?{tenantId:t[1]}:null},Po=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Te=t=>ne(t),An="ws-crm-manage-team-toast",$n=(t,e="info",o=4e3)=>{document.getElementById(An)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=An,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(An)===a&&a.remove()},o)},In=()=>{document.getElementById(Bi)?.remove()},rb=(t,e)=>{let o=ob[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${ne(e)}</span>
  `},nb=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>rb(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${Te(t.email)}" data-user-id="${Te(t.id)}" data-name="${Te(o)}" data-current-roles="${Te(t.role_keys.join(","))}" style="${$} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${Te(t.email)}" data-name="${Te(o)}" data-role-count="${Te(String(t.role_keys.length))}" style="${$} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},ab=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>nb(r,e)).join(""),Bo=async t=>{In();let e=document.createElement("div");e.id=Bi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&In()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",In);let r;try{r=await Po({tenant_id:t,action:"list"})}catch(d){let p=o.querySelector("#ws-team-content");p&&(p.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+ab(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{ib(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;sb(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",p=>{let b=p.currentTarget;lb(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},ib=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${ne(Ri[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Ho(e),setTimeout(()=>Ho(e),200),setTimeout(()=>Ho(e),800),window.addEventListener("resize",()=>Ho(e)),e},Ln=!1,_b=()=>{if(!Ln){Ln=!0;try{let t=Fi();if(!t){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}let e=document.getElementById(Se);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Se}-floater`)?.remove();let o=document.createElement("div");o.id=`${Se}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=vb(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Ln=!1}}},Ni=()=>{if(!Fi()){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}_b()};var yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Dn="ws-crm-prepare-contract-button",zi="ws-crm-prepare-contract-menu",me="ws-crm-prepare-contract-modal",Gi="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Ki=()=>{if(document.getElementById(Gi))return;let t=document.createElement("style");t.id=Gi,t.textContent=`
  ...
  `,document.head.appendChild(t)},Hn="__WS_CRM_CAPTURED_AUTH",gb=50*60*1e3,zo=()=>{try{let t=localStorage.getItem(Hn);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>gb?(localStorage.removeItem(Hn),null):e:null}catch{return null}},fb=t=>{try{localStorage.setItem(Hn,JSON.stringify(t))}catch{}},Je=()=>{let t=zo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},qi=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((zo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ye=async(t,e={},o=2)=>{let r=zo()?.capturedAt??0,a;try{a={...Je(),...e.headers??{}}}catch(s){if(o>0&&await qi(r,4e3))return Ye(t,e,o-1);throw s}let i=await fetch(t,{...e,headers:a});return i.status!==401||o<=0?i:await qi(r,4e3)?Ye(t,e,o-1):i},Ui=!1,wb=()=>{if(Ui)return;Ui=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,p)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:p};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${p} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}p==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=zo()?.authorization;fb({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${p}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,p=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=p.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,_)=>m[_.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,_])=>m[h.toLowerCase()]=_);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...p){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...p)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,p=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&p&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,p,"xhr")),s.call(this,l)},c.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Yi=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},xb=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Yi()},kb=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Ji="__WS_CRM_TEMPLATES_CACHE_V1",Eb=24*60*60*1e3,Vi=t=>{try{let e=window.localStorage.getItem(Ji);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Eb?null:o.templates}catch{return null}},Tb=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Ji,JSON.stringify(o))}catch{}},Sb=async t=>{let e=`${ye}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ye(e,{method:"GET"})}catch(s){let l=Vi(t);if(l)return c.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Vi(t);if(s)return c.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:kb(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&Tb(t,i),i},Cb=async(t,e)=>{let o=await Ye(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await Ye(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let p=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-p})},Ab=async(t,e)=>{let o=await Ye(`${ye}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${ye}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Je()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,p)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(p.updatedAt?Date.parse(p.updatedAt):0)-b})},Ib=async t=>{let e=await fetch(yb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Lb=async(t,e,o)=>{let r=`${ye}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Je()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},$b=async(t,e)=>{let o=await fetch(`${ye}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Je()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Mb=async t=>{let e=await fetch(`${ye}/contacts/${t}`,{method:"GET",headers:Je()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Ob=async(t,e,o,r)=>{let a;try{a=await $b(t,e)}catch(_){return{ok:!1,body:`fetchProposalDocument: ${_.message}`}}let i;try{i=await Mb(o)}catch(_){return{ok:!1,body:`fetchContactBasics: ${_.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(_=>_?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${ye}/proposals/document/${e}`,{method:"PUT",headers:{...Je(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let _=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:_}}return{ok:!0}},Db=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Fo="__WS_CRM_PENDING_INSTRUCTIONS",Hb=60*1e3,Pb=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Bb=t=>{let e=(t||"").toLowerCase();for(let o of Pb)if(e.includes(o.matches.toLowerCase()))return o;return null},Rb=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Fo,JSON.stringify(r))}catch{}},Fb=()=>{try{let t=localStorage.getItem(Fo);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Hb?(localStorage.removeItem(Fo),null):e}catch{return null}},Nb=()=>{try{localStorage.removeItem(Fo)}catch{}},zb=(t,e)=>{document.getElementById(me)?.remove();let o=document.createElement("div");o.id=me,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Gb=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,qb=()=>{let t=window.location.pathname.match(Gb);if(!t)return;let e=t[1],o=Fb();o&&o.proposalId===e&&(Nb(),window.setTimeout(()=>{zb(o.title,o.bodyHtml)},600))},Wi="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(Wi)?.remove();let r=document.createElement("div");r.id=Wi;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},ji=(t,e)=>new Promise(o=>{document.getElementById(me)?.remove();let r=document.createElement("div");r.id=me,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let i=d=>{if(!d)return"";try{return new Date(d).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return d}},s=t.map(d=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${he(d.id)}" style="
          ...
          font-family: ${u.sans};
        ">
          <div style="font-size: 14px; font-weight: 500; line-height: 1.3;">${ee(d.propertyAddress||d.name)}</div>
          ${d.updatedAt?`<div style="font-size: 11px; color: ${n.ash}; margin-top: 4px;">Last updated ${ee(i(d.updatedAt))}</div>`:""}
        </button>
      `).join("");a.innerHTML=`
      <div style="
        font-family: ${u.mono};
      ...
      <div style="
        ...
        font-weight: 500;
        margin-bottom: 4px;
      ">This ${ee(e.perspective)} has ${t.length} open deals</div>
      <div style="
        font-size: 12px;
        color: ${n.ash};
        margin-bottom: 16px;
        line-height: 1.4;
      ">Which property is this contract for? The ${ee(e.agreementLabel)} will use that opp's data.</div>
      <div>${s}</div>
      <div style="display: flex; gap: 8px; justify-content: flex-end; margin-top: 16px;">
  ...
  `,A=`
    ...
    padding-right: 28px;
  `,F=V=>['<option value="">(unset)</option>'].concat(k.map(J=>`<option value="${he(J)}"${J===V?" selected":""}>${ee(J)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${g}">
        ...
        <div style="${E}">${ee(i||"(set on Property record)")}</div>
      </div>
      <div style="${g}">
      ...
      <div style="${g}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${he(b)}" placeholder="e.g. 30" style="${S}" />
      </div>
      <div style="${g}">
      ...
      <div style="${g}">
        ...
        <select id="ws-pc-current-occupancy" style="${A}">${F(_)}</select>
      </div>
      <div style="${g}">
        <div style="${w}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${A}">${F(x)}</select>
      </div>
      <div style="${g} align-items: flex-start;">
        <div style="${w}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${S} resize: vertical; min-height: 60px; font-family: ${u.sans};">${ee(h)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,f.appendChild(y),document.body.appendChild(f);let R=y.querySelector("#ws-pc-purchase-price"),z=y.querySelector("#ws-pc-emd"),G=y.querySelector("#ws-pc-cash-at-close"),N=!1;G?.addEventListener("input",()=>{N=!0});let ue=()=>{if(N)return;let V=Number(R?.value||0),J=Number(z?.value||0);G&&(G.value=String(Math.max(0,V-J)))};R?.addEventListener("input",ue),z?.addEventListener("input",ue);let Pe=()=>f.remove();f.addEventListener("click",V=>{V.target===f&&Pe()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Pe);let oe=y.querySelector("#ws-pc-submit"),te=y.querySelector("#ws-pc-error");oe?.addEventListener("click",async()=>{if(oe){te&&(te.textContent=""),oe.disabled=!0,oe.textContent="Opening\u2026";try{let V=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),J=Number(R?.value||0),Qe=Number(z?.value||0),Ze=Number(G?.value||0),et=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),tt=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),ot=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),Be=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),rt=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),X={};if(V!==s&&(X.sellerName=V),J!==l&&(X.purchasePrice=J),Qe!==d&&(X.emd=Qe),Ze!==p&&(X.cashAtClose=Ze),et!==b&&(X.daysToClose=et),tt!==m&&(X.inspectionDays=tt),ot!==h&&(X.additionalTerms=ot),Be!==_&&(X.currentOccupancy=Be),rt!==x&&(X.occupancyAtClose=rt),Object.keys(X).length>0){c.info("[prepare-contract] PA modal submit with overrides:",X),oe.textContent="Saving\u2026";let Xo=O(),Qo=await No({tenantId:t,contactId:e,template:o,userId:Xo,overrides:X});c.info("[prepare-contract] re-stage with overrides ok:",Qo),oe.textContent="Opening\u2026"}else c.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Q=i?`${i} - Purchase Agreement`:void 0;await Rn(t,e,o,Q)}catch(V){oe.disabled=!1,oe.textContent="Open Contract",te&&(te.textContent=V.message||"Failed to open contract."),c.warn("[prepare-contract] PA confirm submit failed:",V)}}})},Vb=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(me)?.remove(),Ki();let d=a.debug||{},p=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,_=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,k=typeof d.closingOffice=="string"?d.closingOffice:"",f=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,w=l,S="",C=document.createElement("div");C.id=me,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;E.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${R}">
        ...
        <div style="${F}">${ee(p||"(set on Property record)")}</div>
      </div>
      <div style="${R}">
        <div style="${g}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${he(b)}" placeholder="Seller name" style="${T}" />
      </div>
      <div style="${R}">
      ...
      <div style="${R}">
        ...
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-price" type="number" min="0" step="0.01" value="${m}" style="${A}" />
        </div>
      </div>
      <div style="${R}">
        ...
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-buyer-emd" type="number" min="0" step="0.01" value="${h}" style="${A}" />
        </div>
      </div>
      <div style="${R}">
        ...
        <div style="${z}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${_}" style="${A}" />
        </div>
      </div>
      <div style="${R}">
  ...
  `,C.appendChild(E),document.body.appendChild(C);let G=E.querySelector("#ws-pc-assignment-price"),N=E.querySelector("#ws-pc-assignment-fee"),ue=!1;N?.addEventListener("input",()=>{ue=!0});let Pe=()=>{if(ue)return;let J=Number(G?.value||0);N&&(N.value=String(Math.max(0,J-x)))};G?.addEventListener("input",Pe);let oe=()=>C.remove();C.addEventListener("click",J=>{J.target===C&&oe()}),E.querySelector("#ws-pc-cancel")?.addEventListener("click",oe);let te=E.querySelector("#ws-pc-submit"),V=E.querySelector("#ws-pc-error");te?.addEventListener("click",async()=>{if(!te)return;V&&(V.textContent="");let J=(E.querySelector("#ws-pc-seller-name")?.value||"").trim(),Qe=Number(G?.value||0),Ze=Number(E.querySelector("#ws-pc-buyer-emd")?.value||0),et=Number(N?.value||0),tt=(E.querySelector("#ws-pc-closing-office")?.value||"").trim(),ot=(E.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),Be=(E.querySelector("#ws-pc-closing-date")?.value||"").trim(),rt=(E.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),X=(E.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!Be){V&&(V.textContent="Closing Date is required.");return}te.disabled=!0,te.textContent="Opening\u2026";try{let Q={};J!==b&&(Q.sellerName=J),Qe!==m&&(Q.assignmentPrice=Qe),Ze!==h&&(Q.buyerEMD=Ze),et!==_&&(Q.assignmentFee=et),tt!==k&&(Q.closingOffice=tt),ot!==f&&(Q.buyerCompanyName=ot);let Xo=Be!==y||rt!==w||X!==S,Qo=Object.keys(Q).length>0||Xo,Zo=a;Qo?(c.info("[prepare-contract] AA modal submit, re-staging with overrides:",Q),te.textContent="Saving\u2026",Zo=await No({tenantId:t,contactId:e,template:o,oppId:r,closingDate:Be,buyerEarnestDueDate:rt,lenderSource:X,userId:i,overrides:Object.keys(Q).length>0?Q:void 0}),c.info("[prepare-contract] AA re-stage ok:",Zo),te.textContent="Opening\u2026"):c.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let jn=Zo?.debug?.propertyAddress||p,$s=jn?`${jn} - Assignment Agreement`:void 0;await Rn(t,e,o,$s),oe()}catch(Q){te.disabled=!1,te.textContent="Open Contract",V&&(V.textContent=Q.message||"Failed to prepare contract."),c.warn("[prepare-contract] AA submit failed:",Q)}})},No=async t=>{c.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await Ib({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(c.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Rn=async(t,e,o,r)=>{c.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Lb(t,o.id,e);c.info(`[prepare-contract] proposal created: ${a}`),c.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Ob(t,a,e,r);i.ok?c.info(`[prepare-contract] contact attached to proposal ${a}`):(c.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),Y(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Bb(o.name);s&&(c.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Rb(a,s.title,s.bodyHtml)),Db(t,a)},Wb=async t=>{let e=xb(t);if(!e){Y("Could not resolve contact context.","error");return}document.getElementById(zi)?.remove();let o=document.createElement("div");o.id=zi,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Sb(e.tenantId)}catch(i){o.innerHTML=`
      <div style="padding: 12px 14px; color: ${n.crimson}; font-size: 12px;">
        Failed to load templates: ${ee(i.message)}
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      <div style="display: flex; align-items: baseline; gap: 8px;">
        ...
        <span style="flex: 1;">${ee(i.name)}</span>
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),c.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let p=O();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,c.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await Ab(e.tenantId,e.contactId)}catch(w){Y(`Failed to load buyer's MT opps: ${w.message}`,"error",6e3),c.warn("[prepare-contract] AA fetch opps failed:",w);return}if(y.length===0){Y("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,c.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{c.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let w=await ji(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!w){c.info("[prepare-contract] MT opp picker cancelled");return}b=w,c.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let w=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${w}-${S}-${C}`},h=y=>{let w=new Date;return w.setDate(w.getDate()+y),m(w)},_=h(45),x=h(7);Y("Reading contract data\u2026","info",2500);let k;try{k=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:_,buyerEarnestDueDate:x,userId:p})}catch(y){Y(`Failed to prepare contract: ${y.message}`,"error",6e3),c.warn("[prepare-contract] AA stage failed:",y);return}let f=e.contactId||k.contact_id||"";if(!f){Y("Could not resolve buyer contact for this opp.","error",6e3);return}Vb({tenantId:e.tenantId,contactId:f,template:i,oppId:b,staged:k,userId:p,defaultClosingDate:_,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){Y("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await Cb(e.tenantId,e.contactId)}catch(_){Y(`Failed to load ACQ opps: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA fetch opps failed:",_);return}if(b.length===0){Y("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,c.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{c.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let _=await ji(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!_){c.info("[prepare-contract] ACQ opp picker cancelled");return}m=_,c.info(`[prepare-contract] picked ACQ opp ${m}`)}Y("Reading contract data\u2026","info",2500);let h;try{h=await No({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:p})}catch(_){Y(`Failed to prepare contract: ${_.message}`,"error",6e3),c.warn("[prepare-contract] PA stage failed:",_);return}Ub({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){Y("This template needs to be started from a contact page.","error",6e3);return}Y(`Opening ${i.name}\u2026`,"info",2500);try{await Rn(e.tenantId,e.contactId,i)}catch(b){Y(`Failed to open contract: ${b.message}`,"error",6e3),c.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){c.warn("[prepare-contract] picker click handler failed:",b),Y(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},Xi=()=>{let t=document.createElement("button");return t.id=Dn,t.type="button",t.style.cssText=`${$} position: relative; order: 4;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Wb(t)}),t},jb="ws-crm-contact-actions-bar",Kb=async()=>{let t=Yi();if(!t){document.getElementById(Dn)?.remove();return}let e=null;try{e=await L(`#${jb}`,{timeoutMs:3e3})}catch{c.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Dn);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Xi();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),c.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},De="ws-crm-prepare-contract-button-opp",Ot=`${De}-wrap`,Yb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jb=/\/v2\/location\/([A-Za-z0-9]+)/,Xb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pn=()=>{let t=window.location.pathname,e=t.match(Yb);if(!e)return null;let o=t.match(Jb);return o?{oppId:e[1],tenantId:o[1]}:null},Qb=async()=>{for(let t of Xb)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ro=!1,Dt=null,Bn=null,Mn=null,On,Ht=()=>{Dt?.disconnect(),Dt=null,Bn=null},Zb=t=>{if(Dt&&Bn===t)return;Ht();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Bn=t,Dt=new MutationObserver(()=>{let o=Pn();if(!o||o.oppId!==t){Ht();return}let r=H();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(De)?.remove(),document.getElementById(Ot)?.remove(),Ht();return}document.getElementById(De)||Qi()}),Dt.observe(e,{childList:!0,subtree:!0}))},eh=()=>{Mn||(Mn=new MutationObserver(()=>{On===void 0&&(On=window.setTimeout(()=>{On=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(De);t&&!e&&!Ro&&Qi()},300))}),Mn.observe(document.body,{childList:!0,subtree:!0}))},Qi=async()=>{if(!Ro){Ro=!0;try{let t=Pn();if(!t){document.getElementById(De)?.remove(),document.getElementById(Ot)?.remove(),Ht();return}let e=document.getElementById(De);if(e&&e.dataset.oppId===t.oppId){let l=H();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Ot)?.remove(),Ht());return}e&&(e.remove(),document.getElementById(Ot)?.remove());let o=await Qb();if(!o){c.debug("[prepare-contract] opp mount target not found");return}let r=await W();if(r!=="Marketing Tracker"){c.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Pn();if(!a||a.oppId!==t.oppId)return;let i=Xi();i.id=De,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Ot,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),c.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Zb(t.oppId)}finally{Ro=!1}}},Zi=()=>{qb(),Kb()};wb();function ee(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function he(t){return ee(t)}var th="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",He="ws-crm-compute-offer-button",zn="ws-crm-compute-offer-popover",is="ws-crm-offer-modal",es="ws-crm-contact-actions-bar",oh=[".central-panel","[class*='central-panel']"],Pt=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"\u2014",Fn=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},rh=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],nh=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${rh[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},B=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},ts=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,Nn=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(th,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Xe=()=>{document.getElementById(zn)?.remove(),document.removeEventListener("mousedown",ss,!0)};function ss(t){let e=document.getElementById(zn),o=document.getElementById(He),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Xe()}var ls=(t,e)=>{Xe();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=zn;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",ss,!0),0)},Go=(t,e)=>{ls(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(B("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(B("div",`color:${n.bone};font-size:12px;`,e))})},ah=(t,e,o)=>{ls(t,r=>{r.appendChild(B("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties \u2014 which one?")),e.forEach(a=>{let i=B("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);i.type="button",i.addEventListener("mouseenter",()=>i.style.borderColor=n.blue),i.addEventListener("mouseleave",()=>i.style.borderColor=n.steel),i.addEventListener("click",()=>{Xe(),o(a.property_record_id)}),r.appendChild(i)})})},qo=()=>{document.getElementById(is)?.remove(),document.removeEventListener("keydown",ds,!0)};function ds(t){t.key==="Escape"&&qo()}var os=(t,e,o)=>{qo(),Xe();let r=o,a=!1,i="",s=document.createElement("div");s.id=is,s.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,s.addEventListener("mousedown",b=>{b.target===s&&qo()});let l=B("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);s.appendChild(l);let d=(b,m,h)=>{a||(a=!0,i="",p(),Nn({tenantId:t,propertyRecordId:e,mode:b,propertyCondition:m,repairOverride:h}).then(_=>{_&&_.ok?r=_:i=_&&_.error||"Request failed."}).catch(_=>{c.error("[compute-offer] worksheet request failed:",_),i="Request failed \u2014 try again."}).finally(()=>{a=!1,p()}))};function p(){let b=r,m=!!b.has_comps;l.innerHTML="";let h=B("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),_=B("div","");_.appendChild(B("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),_.appendChild(B("div",`font-size:12px;color:${n.ash};margin-top:2px;`,b.address||"\u2014"));let x=B("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",qo),h.append(_,x),l.appendChild(h);let k=B("div","padding:14px 18px 18px;");l.appendChild(k);let f=B("select",ts());(b.rehab_levels||[]).forEach(R=>{let z=document.createElement("option");z.value=R.key,z.textContent=R.label,R.key===(b.tier||b.property_condition)&&(z.selected=!0),f.appendChild(z)}),f.disabled=a,f.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let y=B("input",ts());y.type="number",y.placeholder="uses the level",y.value=b.repair_override!=null?String(b.repair_override):"",y.disabled=a,y.addEventListener("keydown",R=>{R.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>d("recompute",f.value,y.value.trim()));let w=B("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");w.appendChild(B("div",`font-size:12px;color:${m?n.bone:n.amber};`,m?`Investor comps: $${b.comp_price_per_sqft}/sqft \xB7 ${b.comp_count} comps${b.comp_pull_at?` \xB7 pulled ${nh(b.comp_pull_at)}`:""}`:"No comps pulled yet."));let S=B("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${m?"transparent":n.blue};color:${m?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":m?"Re-pull Comps":"Pull Comps");S.type="button",S.disabled=a,S.addEventListener("click",()=>d("pull",f.value,y.value.trim())),w.append(S),k.appendChild(w),b.low_confidence&&m&&k.appendChild(B("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence \u2014 only ${b.comp_count??0} comps in window.`));let C=B("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),E=B("div","");E.appendChild(B("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),E.appendChild(f);let g=B("div","");g.appendChild(B("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),g.appendChild(y),C.append(E,g),k.appendChild(C);let T=B("div",`border-top:1px solid ${n.steel};padding-top:12px;`),A=(R,z,G)=>{let N=B("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${G?.strong?"font-weight:700;":""}`),ue=B("div","");ue.appendChild(B("div",`font-size:${G?.strong?"13":"12"}px;color:${n.bone};`,R)),G?.sub&&ue.appendChild(B("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,G.sub));let Pe=B("div",`font-size:${G?.strong?"15":"12"}px;color:${G?.color||n.bone};white-space:nowrap;`,z);N.append(ue,Pe),T.appendChild(N)};if(m&&b.imv!=null){A("Investor Market Value",Pt(b.imv));let z=-(b.repair_adjustment??0),G=b.repair_override?"Repair override":b.property_condition_label||"Repairs";A(`Repairs \u2014 ${G}`,Fn(z),{color:z<0?n.crimson:z>0?n.emerald:n.ash,sub:`${Pt(b.repair_total)} total vs ${Pt(b.baseline_repairs)} baseline`}),A("Profit target",Fn(-(b.profit_target??0)),{color:n.ash}),A("MAO \u2014 Maximum Cash Offer",Pt(b.mao),{strong:!0,color:n.blue}),A("ICO discount",Fn(-(b.ico_delta??0)),{color:n.ash,sub:"opening / initial offer"}),A("ICO \u2014 Initial Cash Offer",Pt(b.ico),{strong:!0,color:n.blue})}else T.appendChild(B("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(T);let F=B("div",`margin-top:12px;font-size:11px;min-height:14px;color:${i?n.crimson:n.ash};`);F.textContent=a?"Saving\u2026":i||(m?"Saved to the Property.":""),k.appendChild(F)}p(),document.body.appendChild(s),document.addEventListener("keydown",ds,!0)},rs=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=He,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Pull Comps")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){ah(o,s.properties,l=>{a(!0),Nn({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?os(e,d.property_record_id,d):Go(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Go(o,"Request failed \u2014 try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?os(e,s.property_record_id,s):Go(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await Nn({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Go(o,"Request failed \u2014 try again.")}finally{a(!1)}}}),o},ih=async()=>{for(let t of oh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},ns=async(t,e)=>{let o=e.querySelector(`#${es}`);if(!o)try{o=await L(`#${es}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="5",o.appendChild(t),!0):!1},as=()=>{let t=document.querySelectorAll(`#${He}`);for(let e=1;e<t.length;e++)t[e].remove()},sh=async()=>{let t=P();if(!t||!t.locationId||t.source!=="url"){document.getElementById(He)?.remove(),Xe();return}let e=t.locationId,o=document.getElementById(He);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Xe();let r="seller";try{r=ze(await Ne(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw \u2014 defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off \u2014 kind=${r}`),document.getElementById(He)?.remove();return}let a=await ih();if(!a){c.warn("[compute-offer] no central panel found");return}let i=P();if(!i||i.contactId!==t.contactId)return;let s=rs(t.contactId,e);if(!await ns(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}as(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(P()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(He)){let d=rs(t.contactId,e);ns(d,a).then(()=>as())}});l.observe(a,{childList:!0})},Bt=null,cs=()=>{let t=P()?.contactId??null;if(Bt&&Bt.id===t)return;let e=sh().finally(()=>{Bt?.promise===e&&(Bt=null)});Bt={id:t,promise:e}};var zt="reos-theme-stylesheet",Vn="reos-theme-fonts",Gt=!1,lh=()=>{let t=document.getElementById(Vn);t&&t.remove()},dh=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var M=(t,e)=>{try{c.info(`[main] calling ${t}`),e(),c.info(`[main] ${t} OK`)}catch(o){c.error(`[main:FAIL] ${t} threw:`,o)}},Ls=()=>{c.info(`Loaded v${jt} (built ${Kt})`),er()?c.info(`[main] excluded location ${Re()} \u2014 skipping initial mounts, tracking nav only`):(M("mountVersionBadge (initial)",Jo),M("mountFavicon",Ta),M("mountThemeStylesheet",Wn),M("mountHideLaunchpad",Kr),M("mountHideNavItems",Yr),M("mountRelabelNav",Jr),M("mountHideTopmenuTabs",Qr),M("mountContractsSection",Xr)),M("initPageRouter",Jn),c.info("[main] registering onPageChange subscriber"),Wt(e=>{if(c.info(`[main] onPageChange callback fired for page=${e}`),er()){c.info(`[main] page change into excluded location ${Re()} \u2014 tearing down theme`),M("unmountThemeStylesheet",As);return}M("mountThemeStylesheet",Wn),M("mountVersionBadge",Jo),M("mountHideLaunchpad",Kr),M("mountHideNavItems",Yr),M("mountRelabelNav",Jr),M("mountHideTopmenuTabs",Qr),M("mountContractsSection",Xr),M("mountClaimReleaseToggle",ha),M("mountContactActionsBar",ka),M("mountActiveFollowUpButton",ra),M("mountMtOfferMadeButton",Aa),M("mountNotInterestedButton",Ia),M("mountScheduleWalkthroughButton",La),M("mountResendDealLinkButton",Ma),M("mountReducePriceButton",Da),M("mountEditLandingPageButton",Ha),M("mountPublishButton",Ra),M("mountContactMapLinks",Ua),M("mountSendToClosingOfficeButton",ni),M("mountOppActionBar",fi),M("mountClosingAgentPickerButton",Pi),M("mountPrepareContractButton",Zi),M("mountComputeOfferButton",cs),M("mountManageTeam",Ni),M("mountBuyBoxWidget",da),M("mountSupportNavItem",Ai)}),c.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ls):Ls();})();
