...
`;var $o=/^[A-Za-z0-9]{15,30}$/,Z=o=>typeof o=="string"&&$o.test(o),Go=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Uo=()=>{let o=window.WS_CRM_USER_ID;return Z(o)?o:null},Vo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Z(t))return t;return null},qo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Go(e);if(!t)return null;let r=t.uid;if(Z(r))return r;let n=t.claims;if(n&&Z(n.user_id))return n.user_id}catch{}return null},zo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Z(n))return n}catch{}}}catch{}return null},L=()=>Uo()||Vo()||qo()||zo()||null;var Ht="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Wo=`${Ht}/active-follow-up-get`,jo=`${Ht}/active-follow-up-set`,q="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Ko=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Yo=async o=>{let e=await fetch(Wo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Xo=async(o,e)=>{let t=await fetch(jo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},z=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Mt=o=>{let e=document.createElement("button");return e.type="button",e.id=q,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",i=>{i.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let s=i=>{i.key==="Escape"&&(document.removeEventListener("keydown",s),a())};document.addEventListener("keydown",s)},Wt=(o,e)=>{let t=document.createElement("div");t.id=Y,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Ee();!t||!t.locationId||t.oppId!==o||Nr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Rr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$r=async()=>{for(let o of Rr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ke=!1,rt=async()=>{if(!ke){ke=!0;try{await Gr()}finally{ke=!1}}},Gr=async()=>{let o=Ee();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),re();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let i=A();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),re());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await $r();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await V();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ee();if(!n||n.oppId!==o.oppId)return;let a=Br(o.oppId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
  ...
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Tn(o.oppId)},le=null,ut=null,de=()=>{le?.disconnect(),le=null,ut=null},Tn=o=>{if(le&&ut===o)return;de();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,le=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){de();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),N(),de();return}document.getElementById(W)||_t()}),le.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Sn=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);o&&!e&&!Fe&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},lo=()=>{Sn(),_t()};var Cn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",bo="ldtyB2UXKi9vOp8nLUH7",An="WVD2gb9swLsgcdBEtDVq",R="ws-crm-title-officer-picker-button",ho="ws-crm-title-officer-picker-modal",Fn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Mn=/\/v2\/location\/([A-Za-z0-9]+)/,gt=()=>{let o=window.location.pathname,e=o.match(Fn);if(!e)return null;let t=o.match(Mn);return{oppId:e[1],locationId:t?t[1]:null}},po=async o=>{let e=await fetch(Cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},co=async o=>{let e=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Dn=async(o,e)=>{try{let t=await fetch(Ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:bo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await po({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let s=a.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},$=null,ft="ws-crm-title-officer-field-link",On=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${ft}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),delete e.dataset.wsTitleOfficerDecorated}))},Hn=()=>{let o=document.querySelector(".crm-opportunities-modal");if(!o)return null;let e=o.querySelectorAll("*"),t=null;for(let a of e){if(a.children.length>0)continue;if((a.textContent||"").trim()==="TC - Title Officer"){t=a;break}}if(!t)return null;let r=t.parentElement,n=0;for(;r&&n<5;){let a=r.querySelector("input");if(a)return a;r=r.parentElement,n+=1}return null},wt=(o,e,t)=>{let r=Hn();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${ft}`).forEach(s=>s.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsTitleOfficerDecorated=o,r.style.color="transparent",r.style.caretColor="transparent",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let i=document.createElement("a");i.className=ft,i.href=`/v2/location/${t}/contacts/detail/${o}`,i.textContent=e,i.style.cssText=`
      ...
      pointer-events: auto;
      background: transparent;
    `,i.addEventListener("mouseenter",()=>{i.style.textDecoration="underline"}),i.addEventListener("mouseleave",()=>{i.style.textDecoration="none"}),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=i.href}),a.appendChild(i)}}},De=()=>{document.getElementById(ho)?.remove()},Pn=o=>{De();let e=document.createElement("div");e.id=ho,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&De()}),a?.addEventListener("click",De);let s,i="",d=async c=>{if(n&&c!==i){if(i=c,!c.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await po({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};return J(t,r),(async()=>{let a=await Dn(o,e);a?(r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},wt(a.id,a.name,e)):(r={status:"empty"},J(t,r),$?.oppId===o&&($=null),On())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Pn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},J(t,r);try{let s=[co({tenantId:e,oppId:o,fieldId:bo,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(co({tenantId:e,oppId:o,fieldId:An,value:a.companyName.trim()}));let d=(await Promise.all(s))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},J(t,r),$={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},wt(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},J(t,r)}}})}),t},Bn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Rn=async()=>{for(let o of Bn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,kt=async()=>{if(!He){He=!0;try{await $n()}finally{He=!1}}},$n=async()=>{let o=gt();if(!o||!o.locationId){document.getElementById(R)?.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe();return}let e=document.getElementById(R);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${R}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Rn();if(!r||await V()!=="Transaction Coordination")return;let a=gt();if(!a||a.oppId!==o.oppId||!a.locationId)return;let s=Nn(o.oppId,a.locationId),i=document.createElement("span");i.id=`${R}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),i.appendChild(s),r.appendChild(i),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Gn(o.oppId)},ce=null,xt=null,Pe=()=>{ce?.disconnect(),ce=null,xt=null},Gn=o=>{if(ce&&xt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xt=o,ce=new MutationObserver(()=>{let t=gt();if(!t||t.oppId!==o){Pe();return}document.getElementById(R)||kt(),$&&$.oppId===o&&wt($.contactId,$.contactName,$.tenantId)}),ce.observe(e,{childList:!0,subtree:!0}))},vt=null,yt,Un=()=>{vt||(vt=new MutationObserver(()=>{yt===void 0&&(yt=window.setTimeout(()=>{yt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(R);o&&!e&&!He&&kt()},300))}),vt.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{Un(),kt()};var Ue="reos-theme-stylesheet",Mo="reos-theme-fonts",Vn=()=>{let o=document.getElementById(Mo);o&&o.remove()},qn=`
/* ============================================
