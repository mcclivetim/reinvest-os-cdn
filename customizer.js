/* Wholesaling CRM Customizer v0.36.4 — built 2026-06-13T20:02:08.907Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var qt="[wholesaling-crm-customizer]",Ms="__WS_CRM_DEBUG",Os=()=>!!window[Ms],c={info(...t){console.log(qt,...t)},warn(...t){console.warn(qt,...t)},error(...t){console.error(qt,...t)},debug(...t){Os()&&console.log(qt,"[debug]",...t)}};var Ds=/\/v2\/location\/([A-Za-z0-9]+)/,Hs=new Set(["8ntUQzMflUkR0YvrRgVk"]),Re=()=>{let t=window.location.pathname.match(Ds);return t?t[1]:null},tr=()=>{let t=Re();return t!==null&&Hs.has(t)};var Yn=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,or=/\/v2\/location\/([A-Za-z0-9]+)/,Ps=t=>{let e=t.match(Yn);if(!e)return null;let o=t.match(or);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Bs=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Yn);if(!a)continue;let i=r.match(or)||window.location.pathname.match(or);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},P=()=>{let t=Ps(window.location.pathname);return t||Bs()};var Jn=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Vt="",rr=null,Fe="other",nr=new Set,Ut=()=>{let t=P()?.contactId??null;if(!(!(window.location.pathname!==Vt)&&!(t!==rr))){Vt=window.location.pathname,rr=t,Fe=Jn(),c.debug("Page/context changed:",Fe,Vt,"contact:",t);for(let r of nr)try{r(Fe)}catch(a){c.error("Subscriber threw:",a)}}},Wt=t=>(nr.add(t),setTimeout(()=>t(Fe),0),()=>{nr.delete(t)}),Xn=()=>{Fe=Jn(),Vt=window.location.pathname,rr=P()?.contactId??null,c.debug("Router init, current page:",Fe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Ut()},history.replaceState=function(o,r,a){e(o,r,a),Ut()},window.addEventListener("popstate",Ut),setInterval(Ut,1e3)};var jt="0.36.4",Kt="2026-06-13T20:02:08.908Z";var L=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,p,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),p!==void 0&&window.clearInterval(p)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),p=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),c.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ar={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Qn=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var Rs=/^[A-Za-z0-9]{15,30}$/,nt=t=>typeof t=="string"&&Rs.test(t),Zn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Fs=()=>{let t=window.WS_CRM_USER_ID;return nt(t)?t:null},Ns=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(nt(o))return o;return null},zs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);if(!o)return null;let r=o.uid;if(nt(r))return r;let a=o.claims;if(a&&nt(a.user_id))return a.user_id}catch{}return null},Gs=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(nt(a))return a}catch{}}}catch{}return null},O=()=>Fs()||Ns()||zs()||Gs()||null,qs=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Zn(e);return o?o.claims??o:null}catch{return null}},Yt=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:qs()?.type==="agency"};var ra="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Us=`${ra}/active-follow-up-get`,Vs=`${ra}/active-follow-up-set`,Ce="ws-crm-active-follow-up-button",sr={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Ws=()=>{let t=P();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},js=async t=>{let e=await fetch(Us,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ks=async(t,e)=>{let o=await fetch(Vs,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},Ae=(t,e)=>{let o=sr[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ea=t=>{let e=document.createElement("button");return e.type="button",e.id=Ce,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{wl(t,e,()=>hr(t,e))}),o},hr=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([il(t,e),dr()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${q(r.error||"Failed to load buy-box entries")}</div>`;return}yl(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${q(r.message)}</div>`}},yl=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let p=e[d.key].map(b=>{let m=d.key==="state"?dl(b.geo_value,o):b.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let p=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,ll(r,p).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}hr(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Qt=!1,la=(t,e)=>{Qt=e;let o=vl(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=gl,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",hr(t.tenantId,t.buyerContactId)):(t.iconBtn.className=da,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},da="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",gl="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",fl=t=>{let e=document.createElement("button");return e.id=sa,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=da,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${cl.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Qt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),la(r,a)}),e},wl=(t,e,o)=>{let r=document.getElementById(aa);r&&r.remove();let a=document.createElement("div");a.id=aa,a.style.cssText=`
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),i=o.querySelector("#wsap-vendor"),s=o.querySelector("#wsap-confirm");s?.addEventListener("click",async()=>{if(!a?.value){xe("Pick the booked date and time first.","err");return}s.textContent="Booking\u2026",s.style.opacity="0.8";try{(await fetch(cp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:i?.value?.trim()||null}),credentials:"omit"})).ok?(ke(),xe("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(s.textContent="Confirm & advance",s.style.opacity="1",xe("Booking failed \u2014 try again.","err"))}catch(d){c.warn("[action-bar] confirm photo failed:",d),s.textContent="Confirm & advance",s.style.opacity="1",xe("Couldn't reach the booking handler. Try again.","err")}});let l=d=>{let p=d.target;!o.contains(p)&&!e.contains(p)&&(ke(),document.removeEventListener("click",l))};window.setTimeout(()=>document.addEventListener("click",l),0)},wp=(t,e)=>{ke();let o=document.createElement("div");o.id=mi;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let i of t){let s=document.createElement("div");s.textContent=i.label,s.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,s.addEventListener("mouseenter",()=>s.style.background=n.steel),s.addEventListener("mouseleave",()=>s.style.background="transparent"),s.addEventListener("click",l=>{l.stopPropagation(),i.onClick()}),o.appendChild(s)}document.body.appendChild(o);let a=i=>{let s=i.target;!o.contains(s)&&!e.contains(s)&&(ke(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Io=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=K:o.style.cssText=$,o.textContent=t,o},xp=()=>{let t=Io("\u22EE","ghost");return t.style.lineHeight="1",t},kp=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===_i){let r=Io("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>_p(t)),o.appendChild(r),o}if(e===vn){let r=Io("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>fp(t,r)),o.appendChild(r),o}if(e===yi){let r=Io("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void fi(t)),o.appendChild(r),o}return null},Ep=(t,e)=>{let o=[];if(e===vn&&(o=[{label:"Re-order Lockbox",onClick:()=>void fi(t)}]),!o.length)return null;let r=document.createElement("span");r.id=hi,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=xp();return a.addEventListener("click",i=>{i.stopPropagation(),wp(o,a)}),r.appendChild(a),r},Tp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Sp=async()=>{for(let t of Tp)try{let e=await L(t,{timeoutMs:1200});if(e)return e}catch{}return null},Ao=()=>{document.getElementById(bn)?.remove(),document.getElementById(hi)?.remove(),ke()},Lo=!1,_n=async()=>{if(!Lo){Lo=!0;try{let t=gi();if(!t){Ao();return}let e=H();if(e===null)return;if(e!=="Transaction Coordination"){Ao();return}let o=vp(),r=document.getElementById(bn);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=kp(t,o);if(!a){Ao();return}let i=await Sp();if(!i)return;Ao();let s=U(i),l=document.createElement("span");l.id=bn,l.dataset.oppId=t.oppId,l.dataset.stage=o??"",l.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",l.appendChild(a),s.appendChild(l);let d=Ep(t,o);d&&s.appendChild(d),Cp(t.oppId)}catch(t){c.error("[action-bar] ensureBar threw:",t)}finally{Lo=!1}}},It=null,mn=null,dn,bi=()=>{It?.disconnect(),It=null,mn=null},Cp=t=>{if(It&&mn===t)return;bi();let e=document.querySelector(vi);e&&(mn=t,It=new MutationObserver(()=>{let o=gi();if(!o||o.oppId!==t){bi();return}dn===void 0&&(dn=window.setTimeout(()=>{dn=void 0,_n()},250))}),It.observe(e,{childList:!0,subtree:!0}))},cn=null,pn,Ap=()=>{cn||(cn=new MutationObserver(()=>{pn===void 0&&(pn=window.setTimeout(()=>{pn=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading")&&!Lo&&_n()},300))}),cn.observe(document.body,{childList:!0,subtree:!0}))},wi=()=>{Ap(),_n()};var xi="ws-support-modal",ki="ws-support-toast",Ip="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ei="ws-support-submitter-name",Ti="ws-support-submitter-email",Si="ws-support-submitter-role",Lp=["Bug","Feature Request","Question","Billing","Onboarding Help"],Me=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),$p=(t,e="success",o)=>{let r=document.getElementById(ki);r&&r.remove();let a=document.createElement("div");a.id=ki;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Mp=()=>{document.getElementById(xi)?.remove();let t=(localStorage.getItem(Ei)??"").trim(),e=(localStorage.getItem(Ti)??"").trim(),o=(localStorage.getItem(Si)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=xi,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let p=Re();if(!p){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ei,r.submitterName),localStorage.setItem(Ti,r.submitterEmail),r.submitterRole&&localStorage.setItem(Si,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(Ip,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:p,category:r.category,title:r.title,description:r.description,submitter_user_id:O()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let _=h.ticket_short_id||"submitted";$p(`Ticket ${_} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Op=["/support-ticket","ws-support-modal","ws-support"],Dp=/\/custom-menu-link\//,yn=!1,Ci=()=>{if(yn||!Dp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Op.some(s=>i.includes(s))});if(r){yn=!0,c.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Mp(),yn=!1},50);return}t<10&&setTimeout(e,150)};e()},Ai=!1,Ii=()=>{Ai||(Ai=!0,Wt(()=>setTimeout(Ci,50)),Ci(),c.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Hp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Bp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Mi="tc_closing_agent",Rp="tc_closing_office",ce="ws-crm-closing-agent-picker-button",Oi="ws-crm-closing-agent-picker-modal",Fp=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Np=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(Fp);if(!e)return null;let o=t.match(Np);return{oppId:e[1],locationId:o?o[1]:null}},Sn=async t=>{let e=await fetch(Hp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Li=async t=>{let e=await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},zp=async(t,e)=>{try{let o=await fetch(Bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Mi}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Sn({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return c.warn("[closing-agent] fetchCurrent failed:",o),null}},Oe=null,Gp=60*60*1e3,Cn=t=>`ws-crm-to-cache:${t}`,Di=t=>{try{let e=window.localStorage.getItem(Cn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Gp||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Hi=(t,e,o)=>{try{window.localStorage.setItem(Cn(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},qp=t=>{try{window.localStorage.removeItem(Cn(t))}catch{}},xn="ws-crm-closing-agent-field-link",Up=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${xn}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},gn=!1,An=async t=>{if(gn)return;let e=Pi();if(!e)return;let o=(e.value||"").trim();if(!o){c.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){c.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){gn=!0;try{c.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Sn({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){c.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];c.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),kn(a.id,a.name,t);let i=document.getElementById(ce);if(i){Ee(i,{status:"linked",contactName:a.name});let s=Mt();s&&Hi(s.oppId,a.id,a.name)}}catch(r){c.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{gn=!1}}},Vp=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Pi=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let p=(d.textContent||"").trim();Vp.test(p)?o.push(d):p.length<80&&/Title\s+Officer/i.test(p)&&r.push(p);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(c.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&c.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&c.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,p)=>d.querySelectorAll("*").length-p.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return c.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return c.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},kn=(t,e,o)=>{let r=Pi();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${xn}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=xn,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},$o=()=>{document.getElementById(Oi)?.remove()},Wp=t=>{$o();let e=document.createElement("div");e.id=Oi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Ee(o,r);let a=Di(t);return a&&(r={status:"linked",contactName:a.contactName},Ee(o,r),Oe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await zp(t,e);s?(r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},kn(s.id,s.name,e)):a||(r={status:"empty"},Ee(o,r),Oe?.oppId===t&&(Oe=null),Up(),qp(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Wp({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},Ee(o,r);try{let l=[Li({tenantId:e,oppId:t,fieldKey:Mi,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Li({tenantId:e,oppId:t,fieldKey:Rp,value:s.companyName.trim()}));let p=(await Promise.all(l))[0];if(!p.ok)throw new Error(p.error??"Save failed");r={status:"linked",contactName:s.name},Ee(o,r),Oe={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Hi(t,s.id,s.name),kn(s.id,s.name,e),c.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){c.error("Closing Agent link failed",l),r={status:"empty"},Ee(o,r)}}})}),o},Kp=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Yp=async()=>{for(let t of Kp)try{let e=await L(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lt=!1,Do=async()=>{if(!Lt){Lt=!0;try{await Jp()}finally{Lt=!1}}},Jp=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(ce)?.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){let d=H();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove(),Oo());return}e&&(e.remove(),document.getElementById(`${ce}-wrap`)?.remove());let o=H();if(o!==null&&o!=="Transaction Coordination")return;let r=await Yp();if(!r||!(Di(t.oppId)!==null||Oe!==null&&Oe.oppId===t.oppId)&&await W()!=="Transaction Coordination")return;let i=Mt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=jp(t.oppId,i.locationId),l=document.createElement("span");l.id=`${ce}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,l.appendChild(s),U(r).appendChild(l),c.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Xp(t.oppId),An(i.locationId)},$t=null,En=null,Tn=null,Oo=()=>{$t?.disconnect(),$t=null,En=null,Tn=null},Xp=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($t&&En===t&&Tn===e||(Oo(),En=t,Tn=e,$t=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t||!o.locationId){Oo();return}document.getElementById(ce)||Do(),An(o.locationId)}),$t.observe(e,{childList:!0,subtree:!0})))},fn=null,wn,Qp=()=>{fn||(fn=new MutationObserver(()=>{wn===void 0&&(wn=window.setTimeout(()=>{wn=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);t&&!e&&!Lt&&Do()},300))}),fn.observe(document.body,{childList:!0,subtree:!0}))},$i,Zp=()=>{$i===void 0&&($i=window.setInterval(()=>{let t=Mt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(ce)&&!Lt&&(c.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Do()),An(t.locationId)},2e3))},Bi=()=>{c.info("[closing-agent] mountClosingAgentPickerButton invoked"),Qp(),Zp(),Do()};var eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Se="ws-crm-manage-team-cta",Ri="ws-crm-manage-team-modal",tb=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Fi={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},ob={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ni=()=>{let t=window.location.pathname.match(tb);return t?{tenantId:t[1]}:null},Po=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},ne=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Te=t=>ne(t),In="ws-crm-manage-team-toast",Mn=(t,e="info",o=4e3)=>{document.getElementById(In)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=In,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(In)===a&&a.remove()},o)},Ln=()=>{document.getElementById(Ri)?.remove()},rb=(t,e)=>{let o=ob[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
  ...
  `+t.map(r=>nb(r,e)).join(""),Bo=async t=>{Ln();let e=document.createElement("div");e.id=Ri,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("click",()=>{Bo(t)}),Ho(e),setTimeout(()=>Ho(e),200),setTimeout(()=>Ho(e),800),window.addEventListener("resize",()=>Ho(e)),e},$n=!1,_b=()=>{if(!$n){$n=!0;try{let t=Ni();if(!t){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}let e=document.getElementById(Se);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Se}-floater`)?.remove();let o=document.createElement("div");o.id=`${Se}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=vb(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),c.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{$n=!1}}},zi=()=>{if(!Ni()){document.getElementById(Se)?.remove(),document.getElementById(`${Se}-floater`)?.remove();return}_b()};var yb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Hn="ws-crm-prepare-contract-button",Gi="ws-crm-prepare-contract-menu",me="ws-crm-prepare-contract-modal",qi="ws-crm-modal-date-style",ye="https://services.leadconnectorhq.com",Yi=()=>{if(document.getElementById(qi))return;let t=document.createElement("style");t.id=qi,t.textContent=`
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Gb=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,qb=()=>{let t=window.location.pathname.match(Gb);if(!t)return;let e=t[1],o=Fb();o&&o.proposalId===e&&(Nb(),window.setTimeout(()=>{zb(o.title,o.bodyHtml)},600))},ji="ws-crm-prepare-contract-toast",Y=(t,e="info",o=4e3)=>{document.getElementById(ji)?.remove();let r=document.createElement("div");r.id=ji;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=s=>{o.disabled=s,o.style.cursor=s?"default":"pointer";let l=r();l&&(l.textContent=s?"Opening\u2026":"Pull Comps")},i=s=>{if(s.needs_property_selection&&s.properties&&s.properties.length){ah(o,s.properties,l=>{a(!0),zn({tenantId:e,propertyRecordId:l,mode:"get"}).then(d=>{d.ok&&d.property_record_id?rs(e,d.property_record_id,d):Go(o,d.error||"Couldn't load that property.")}).catch(d=>{c.error("[compute-offer] get failed:",d),Go(o,"Request failed \u2014 try again.")}).finally(()=>a(!1))});return}s.ok&&s.property_record_id?rs(e,s.property_record_id,s):Go(o,s.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{i(await zn({tenantId:e,contactId:t,mode:"get"}))}catch(s){c.error("[compute-offer] webhook failed:",s),Go(o,"Request failed \u2014 try again.")}finally{a(!1)}}}),o},ih=async()=>{for(let t of oh)try{let e=await L(t,{timeoutMs:3e3});if(e)return e}catch{}return null},as=async(t,e)=>{let o=e.querySelector(`#${ts}`);if(!o)try{o=await L(`#${ts}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="5",o.appendChild(t),!0):!1},is=()=>{let t=document.querySelectorAll(`#${He}`);for(let e=1;e<t.length;e++)t[e].remove()},sh=async()=>{let t=P();if(!t||!t.locationId||t.source!=="url"){document.getElementById(He)?.remove(),Xe();return}let e=t.locationId,o=document.getElementById(He);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Xe();let r="seller";try{r=ze(await Ne(t.contactId,e))}catch(d){c.warn("[compute-offer] contact-type fetch threw \u2014 defaulting seller:",d)}if(r!=="seller"){c.debug(`[compute-offer] gated off \u2014 kind=${r}`),document.getElementById(He)?.remove();return}let a=await ih();if(!a){c.warn("[compute-offer] no central panel found");return}let i=P();if(!i||i.contactId!==t.contactId)return;let s=ns(t.contactId,e);if(!await as(s,a)){c.warn("[compute-offer] actions bar not found after waiting");return}is(),c.debug(`[compute-offer] mounted for ${t.contactId}`);let l=new MutationObserver(()=>{if(P()?.contactId!==t.contactId){l.disconnect();return}if(!document.getElementById(He)){let d=ns(t.contactId,e);as(d,a).then(()=>is())}});l.observe(a,{childList:!0})},Bt=null,ps=()=>{let t=P()?.contactId??null;if(Bt&&Bt.id===t)return;let e=sh().finally(()=>{Bt?.promise===e&&(Bt=null)});Bt={id:t,promise:e}};var zt="reos-theme-stylesheet",Wn="reos-theme-fonts",Gt=!1,lh=()=>{let t=document.getElementById(Wn);t&&t.remove()},dh=`
/* ============================================
