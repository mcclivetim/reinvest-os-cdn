...
`;var cr=/^[A-Za-z0-9]{15,30}$/,Q=o=>typeof o=="string"&&cr.test(o),br=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},hr=()=>{let o=window.WS_CRM_USER_ID;return Q(o)?o:null},pr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(Q(t))return t;return null},mr=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=br(e);if(!t)return null;let r=t.uid;if(Q(r))return r;let n=t.claims;if(n&&Q(n.user_id))return n.user_id}catch{}return null},ur=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(Q(n))return n}catch{}}}catch{}return null},I=()=>hr()||pr()||mr()||ur()||null;var Wt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",_r=`${Wt}/active-follow-up-get`,vr=`${Wt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",at={amber:{label:"Add to Active Follow Up",bg:i.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:i.amber,clickable:!0,dotColor:i.amber},blue:{label:"In Active Follow Up",bg:i.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:i.blue,clickable:!1,dotColor:i.blue},gray:{label:"Not in Follow Up",bg:i.slate,border:i.steel,color:i.coolGray,clickable:!1,dotColor:i.coolGray},loading:{label:"Active Follow Up\u2026",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.ash},error:{label:"Follow Up status unavailable",bg:i.slate,border:i.steel,color:i.ash,clickable:!1,dotColor:i.crimson}},yr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},gr=async o=>{let e=await fetch(_r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},fr=async(o,e)=>{let t=await fetch(vr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},W=(o,e)=>{let t=at[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},zt=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,t.innerHTML=`
    ...
    `;let l=a.type==="PA"?i.emerald:a.type==="AA"?i.blue:i.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=i.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async()=>{t.remove(),document.removeEventListener("click",r,!0);let d=I();try{if(a.type==="AA"){let c;try{c=await xa(e.tenantId,e.contactId)}catch(h){me(`Failed to load buyer's MT opps: ${h.message}`,"error");return}Ca({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:c,userId:d})}else{me(`Preparing ${a.name}\u2026`,"info",2500);try{await No({tenantId:e.tenantId,contactId:e.contactId,template:a,userId:d})}catch(c){me(`Failed to prepare contract: ${c.message}`,"error",6e3),b.warn("[prepare-contract] flow failed:",c)}}}catch(c){b.warn("[prepare-contract] picker click handler failed:",c),me(`Unexpected error: ${c.message}`,"error",6e3)}}),t.appendChild(s)}},Aa=()=>{let o=document.createElement("button");return o.id=Ht,o.type="button",o.style.cssText=`
    position: relative;
    background: ${i.slate};
    border: 1px solid ${i.steel};
    border-radius: ${w.sm};
