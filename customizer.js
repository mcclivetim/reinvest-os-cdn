...
`;var dp=/^[A-Za-z0-9]{15,30}$/,eo=t=>typeof t=="string"&&dp.test(t),Fs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},cp=()=>{let t=window.WS_CRM_USER_ID;return eo(t)?t:null},pp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(eo(o))return o;return null},mp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Fs(e);if(!o)return null;let r=o.uid;if(eo(r))return r;let a=o.claims;if(a&&eo(a.user_id))return a.user_id}catch{}return null},bp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(eo(a))return a}catch{}}}catch{}return null},R=()=>cp()||mp()||pp()||bp()||null,hp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Fs(e);return o?o.claims??o:null}catch{return null}},ge=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:hp()?.type==="agency"};var Us="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",up=`${Us}/active-follow-up-get`,_p=`${Us}/active-follow-up-set`,ne="ws-crm-active-follow-up-button",En={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},vp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},yp=async t=>{let e=await fetch(up,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},gp=async(t,e)=>{let o=await fetch(_p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ae=(t,e)=>{let o=En[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},zs=t=>{let e=document.createElement("button");return e.type="button",e.id=ne,e.dataset.contactId=t,e.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Vu=()=>{document.getElementById(Ht)?.remove();let t=(localStorage.getItem(Rl)??"").trim(),e=(localStorage.getItem(Hl)??"").trim(),o=(localStorage.getItem(Dl)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ht,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `;let i=d=>`
    <button type="button" data-category="${pe(d)}" class="ws-support-tile" style="
      background: ${n.steel}; color: ${n.bone};
      border: 1px solid ${n.steel}; border-radius: ${v.md};
  ...
  `;s.innerHTML=`
    <style id="ws-support-modal-style">
      /* Muted placeholder ("helper") text inside every field. */
  ...
  `,a.appendChild(s),document.body.appendChild(a),Ol().then(d=>{if(!d||!document.getElementById(Ht))return;let l=(c,m)=>{let u=s.querySelector(c);u&&!u.value.trim()&&m&&(u.value=m)};l("#ws-support-name",d.name),l("#ws-support-email",d.email),l("#ws-support-role",d.role)}),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=u=>{d&&(d.textContent=u)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Rl,r.submitterName),localStorage.setItem(Hl,r.submitterEmail),r.submitterRole&&localStorage.setItem(Dl,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let _=await(await fetch(Wu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:R()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!_.ok){l(_.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let b=_.ticket_short_id||"submitted";Ku(`Ticket ${b} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(u){l(`Network error: ${u.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Yu=["/support-ticket","ws-support-modal","ws-support"],Ju=/\/custom-menu-link\//,Pa=!1,Fl=()=>{if(Pa||!Ju.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Yu.some(i=>s.includes(i))});if(r){Pa=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Vu(),Pa=!1},50);return}t<10&&setTimeout(e,150)};e()},zl=!1,Nl=()=>{zl||(zl=!0,_t(()=>setTimeout(Fl,50)),Fl(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var ql="ws-phone-assignments-modal",Ul="ws-phone-assignments-toast",Qu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Zu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Xu=["ACQ","DISPO","TC"],Gl="",Qt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),t_=(t,e="success",o)=>{document.getElementById(Ul)?.remove();let r=document.createElement("div");r.id=Ul;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Qt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Qt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},e_=(t,e,o)=>{let r=[`<option value="" ${o===Gl?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Qt(a)}" ${o===a?"selected":""}>${Qt(a)}</option>`)].join("");return`<select data-assign="${Qt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},o_=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Ba=async t=>{document.getElementById(ql)?.remove();let e=t||K(),o=document.createElement("div");o.id=ql,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Qu}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){p.error("[phone-assignments] GET failed",_);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Qt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:Xu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,c=i.length?i.map(_=>`<div style="${o_}">
    ...
    </div>`,u.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let b=_.getAttribute("data-assign")||"",[g,...x]=b.split(":"),k=x.join(":");g==="num"&&(_.value?d[k]=_.value:delete d[k])})}),u.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),u.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=u.querySelector("#ws-pa-err"),b=x=>{_&&(_.textContent=x)};b("");let g=u.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(Zu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){b(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),t_("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){b(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},r_=["ws-phone-assignments","phone-assignments"],n_=/\/custom-menu-link\//,Oa=!1,jl=()=>{if(Oa||!n_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return r_.some(i=>s.includes(i))});if(r){Oa=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Ba(s),Oa=!1},50);return}t<10&&setTimeout(e,150)};e()},Wl=!1,Kl=()=>{if(Wl)return;Wl=!0,_t(()=>setTimeout(jl,50)),jl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Ba()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Ba(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Vl="powerDialerApp",a_=".dialer",s_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',i_=".dial-item.dial-btn.dial-btn-enabled",Be=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},l_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},Ra=()=>{try{let e=window[Vl]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},Re=()=>document.querySelector(a_),qr=()=>Ra()!==null||Re()!==null?!0:!!window[Vl],Ur=(t,e)=>{let o=Ra();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},Yl=()=>{if(Re())return;let t=document.querySelector(s_);t?Be(t):p.warn("[dialer-bridge] Voice Calling button not found")},d_=()=>{let t=document.querySelector(".number-list-container")||Re();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Ha=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?l_(t.innerText):null},Jl=(t,e)=>{if(Ha()===t)return!0;let o=Ra();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Be(r);let a=d_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Be(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},Ql=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Ur("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Be(a)}},Zl=()=>{let t=Re();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(i_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Be(e),!0):Ur("makeCall",{provider:"twilio"})};var Da=()=>{let t=Re();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Be(e.closest("button")||e):Ur("closeCallBox")},Xl=()=>{Ur("closeCallBox")},td=t=>{let e=!1,o=()=>{let s=Re()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var c_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",p_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",ed=["acq","dispo","tc"],Bo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Oo=null,od=null,m_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&Oo&&od===o)return Oo;try{let a=await(await fetch(`${c_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Oo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},od=o,Oo}catch(r){return p.warn("[silo] config load failed",r),Oo??e}},me=null,rd=null,Fa=async(t=!1)=>{let e=K(),o=R();if(!e||!o)return[];if(!t&&me&&rd===e)return me;try{let s=(await(await fetch(p_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];me=ed.filter(d=>i.includes(d))}else ge()?me=[...ed]:me=[];return rd=e,me}catch(r){return p.warn("[silo] roster load failed",r),me??[]}},ad=()=>`ws-pd-calling-as:${R()||"anon"}`,sd=t=>{try{localStorage.setItem(ad(),t)}catch{}},za=async()=>{let t=await Fa();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(ad())}catch{}return e&&t.includes(e)?e:t[0]},nd=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},b_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),id=async t=>{let e=await za();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await m_(),a=b_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=nd(t),i=s?a.find(m=>nd(m)===s):void 0,d=i||a[0];if(!Jl(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Bo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Ha();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var h_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ld="data-ws-pd",dd="ws-crm-pd-panel",cd="ws-crm-pd-session",Zt=t=>new Promise(e=>setTimeout(e,t)),Ro=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),u_=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},__=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},v_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},y_=async t=>{let e=u_(t);if(!e)return[];let o=__(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Zt(550)}return o.scrollTop=0,v_(e)},g_=async(t,e)=>{try{let r=await(await fetch(h_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},f_=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,qa=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(dd)?.remove();let r=document.createElement("div");r.id=dd,r.style.cssText=f_;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((x,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},Wr=()=>{document.getElementById(Sd)?.remove()},K_=t=>{Wr();let e=document.createElement("div");e.id=Sd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let r={status:"loading"};Xt(o,r);let a=Ad(t);return a&&(r={status:"linked",contactName:a.contactName},Xt(o,r),he={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await q_(t,e);i?(r={status:"linked",contactName:i.name},Xt(o,r),he={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Za(i.id,i.name,e)):a||(r={status:"empty"},Xt(o,r),he?.oppId===t&&(he=null),W_(),j_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||K_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Xt(o,r);try{let d=await $d({tenantId:e,oppId:t,fieldKey:Cd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await $d({tenantId:e,oppId:t,fieldKey:F_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Xt(o,r),he={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ld(t,i.id,i.name),Za(i.id,i.name,e),ul(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Xt(o,r)}}})}),o},Y_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],J_=async()=>{for(let t of Y_)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Do=!1,Vr=async()=>{if(!Do){Do=!0;try{await Q_()}finally{Do=!1}}},Q_=async()=>{let t=zo();if(!t||!t.locationId){document.getElementById(Et)?.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr();return}let e=document.getElementById(Et);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Kr());return}e&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await J_();if(!r||!(Ad(t.oppId)!==null||he!==null&&he.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=zo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=V_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${Et}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Q(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Z_(t.oppId),rs(s.locationId)},Fo=null,Xa=null,ts=null,Kr=()=>{Fo?.disconnect(),Fo=null,Xa=null,ts=null},Z_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fo&&Xa===t&&ts===e||(Kr(),Xa=t,ts=e,Fo=new MutationObserver(()=>{let o=zo();if(!o||o.oppId!==t||!o.locationId){Kr();return}document.getElementById(Et)||Vr(),rs(o.locationId)}),Fo.observe(e,{childList:!0,subtree:!0})))},X_=()=>{J("closing-agent-picker",tt,()=>{!document.getElementById(Et)&&!Do&&Vr()})},Td,tv=()=>{Td===void 0&&(Td=window.setInterval(()=>{let t=zo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(Et)&&!Do&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Vr()),rs(t.locationId)},2e3))},Md=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),X_(),tv(),Vr()};var ev="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Dt="ws-crm-manage-team-cta",Od="ws-crm-manage-team-modal",ov=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Bd={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},rv={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Rd=()=>{let t=window.location.pathname.match(ov);return t?{tenantId:t[1]}:null},Jr=async t=>{let e=await fetch(ev,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},yt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),te=t=>yt(t),ns="ws-crm-manage-team-toast",is=(t,e="info",o=4e3)=>{document.getElementById(ns)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=ns,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(ns)===a&&a.remove()},o)},as=()=>{document.getElementById(Od)?.remove()},nv=(t,e)=>{let o=rv[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${yt(e)}</span>
  `},av=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>nv(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>av(r,e)).join(""),Qr=async t=>{as();let e=document.createElement("div");e.id=Od,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",as);let r;try{r=await Jr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+sv(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{iv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;lv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;dv(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},iv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,e.addEventListener("click",()=>{Qr(t)}),Yr(e),setTimeout(()=>Yr(e),200),setTimeout(()=>Yr(e),800),yv(),e},Pd=!1,yv=()=>{Pd||(Pd=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Dt);t instanceof HTMLButtonElement&&Yr(t)}))},ss=!1,gv=()=>{if(!ss){ss=!0;try{let t=Rd();if(!t){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}let e=document.getElementById(Dt);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Dt}-floater`)?.remove();let o=document.createElement("div");o.id=`${Dt}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=vv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{ss=!1}}},Hd=()=>{if(!Rd()){document.getElementById(Dt)?.remove(),document.getElementById(`${Dt}-floater`)?.remove();return}gv()};var fv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",cs="ws-crm-prepare-contract-button",Dd="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",Fd="ws-crm-modal-date-style",Ft="https://services.leadconnectorhq.com",Wd=()=>{if(document.getElementById(Fd))return;let t=document.createElement("style");t.id=Fd,t.textContent=`
  ...
  `,document.head.appendChild(t)},ps="__WS_CRM_CAPTURED_AUTH",xv=50*60*1e3,jo=()=>{try{let t=localStorage.getItem(ps);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>xv?(localStorage.removeItem(ps),null):e:null}catch{return null}},wv=t=>{try{localStorage.setItem(ps,JSON.stringify(t))}catch{}},ze=()=>{let t=jo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},zd=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((jo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Fe=async(t,e={},o=2)=>{let r=jo()?.capturedAt??0,a;try{a={...ze(),...e.headers??{}}}catch(i){if(o>0&&await zd(r,4e3))return Fe(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await zd(r,4e3)?Fe(t,e,o-1):s},Nd=!1,kv=()=>{if(Nd)return;Nd=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=jo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let u=c.authorization||c.Authorization;if(!u){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=c["token-id"]||c["Token-Id"]||void 0,b=jo()?.authorization;wv({authorization:u,tokenId:_,capturedAt:Date.now()}),b!==u&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${u.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let u=m.headers;!u&&l[0]instanceof Request&&(u=l[0].headers);let _={};if(u instanceof Headers)u.forEach((b,g)=>_[g.toLowerCase()]=b);else if(Array.isArray(u))u.forEach(([b,g])=>_[b.toLowerCase()]=g);else if(u&&typeof u=="object")for(let b of Object.keys(u))_[b.toLowerCase()]=u[b];o(c,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Gd=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Ev=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Gd()},$v=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Kd="__WS_CRM_TEMPLATES_CACHE_V1",Tv=24*60*60*1e3,qd=t=>{try{let e=window.localStorage.getItem(Kd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>Tv?null:o.templates}catch{return null}},Cv=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(Kd,JSON.stringify(o))}catch{}},Sv=async t=>{let e=`${Ft}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Fe(e,{method:"GET"})}catch(i){let d=qd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=qd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:$v(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Cv(t,s),s},Av=async(t,e)=>{let o=await Fe(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Fe(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},Lv=async(t,e)=>{let o=await Fe(`${Ft}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Ft}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:ze()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},Iv=async t=>{let e=await fetch(fv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Mv=async(t,e,o)=>{let r=`${Ft}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:ze()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Pv=async(t,e)=>{let o=await fetch(`${Ft}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:ze()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Vd=async t=>{let e=await fetch(`${Ft}/contacts/${t}`,{method:"GET",headers:ze()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Ov=async(t,e,o,r)=>{let a;try{a=await Pv(t,e)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await Vd(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],u={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Ft}/proposals/document/${e}`,{method:"PUT",headers:{...ze(),"Content-Type":"application/json"},body:JSON.stringify(u)});if(!_.ok){let b=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:b}}return{ok:!0}},Bv=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Xr="__WS_CRM_PENDING_INSTRUCTIONS",Rv=60*1e3,Hv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Dv=t=>{let e=(t||"").toLowerCase();for(let o of Hv)if(e.includes(o.matches.toLowerCase()))return o;return null},Fv=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Xr,JSON.stringify(r))}catch{}},zv=()=>{try{let t=localStorage.getItem(Xr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Rv?(localStorage.removeItem(Xr),null):e}catch{return null}},Nv=()=>{try{localStorage.removeItem(Xr)}catch{}},qv=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Uv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,jv=()=>{let t=window.location.pathname.match(Uv);if(!t)return;let e=t[1],o=zv();o&&o.proposalId===e&&(Nv(),window.setTimeout(()=>{qv(o.title,o.bodyHtml)},600))},Ud="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(Ud)?.remove();let r=document.createElement("div");r.id=Ud;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Sv(e.tenantId)}catch(s){o.innerHTML=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){ay(o,i.properties,d=>{a(!0),_s({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?ec(e,l.property_record_id,l):en(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),en(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?ec(e,i.property_record_id,i):en(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await _s({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),en(o,"Request failed. Try again.")}finally{a(!1)}}}),o},sy=async()=>{for(let t of ry)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}return null},rc=async(t,e)=>{let o=e.querySelector(`#${Zd}`);if(!o)try{o=await P(`#${Zd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},nc=()=>{let t=document.querySelectorAll(`#${_e}`);for(let e=1;e<t.length;e++)t[e].remove()},iy=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(_e)?.remove(),Ne();return}let e=t.locationId,o=document.getElementById(_e);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Ne();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(_e)?.remove();return}let a=await sy();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=oc(t.contactId,e);if(!await rc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}nc(),p.debug(`[compute-offer] mounted for ${t.contactId}`),on?.disconnect(),on=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){on?.disconnect();return}if(!document.getElementById(_e)){let d=oc(t.contactId,e);rc(d,a).then(()=>nc())}}),on.observe(a,{childList:!0})},on=null,Wo=null,dc=()=>{let t=D()?.contactId??null;if(Wo&&Wo.id===t)return;let e=iy().finally(()=>{Wo?.promise===e&&(Wo=null)});Wo={id:t,promise:e}};var cn="reos-theme-stylesheet",Ac="reos-theme-fonts",We=!1,ly=()=>{let t=document.getElementById(Ac);t&&t.remove()},dy=`
