/* Wholesaling CRM Customizer v0.13.85 — built 2026-05-28T01:32:02.120Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var _e="[wholesaling-crm-customizer]",Vo="__WS_CRM_DEBUG",qo=()=>!!window[Vo],b={info(...o){console.log(_e,...o)},warn(...o){console.warn(_e,...o)},error(...o){console.error(_e,...o)},debug(...o){qo()&&console.log(_e,"[debug]",...o)}};var Mt=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ke=/\/v2\/location\/([A-Za-z0-9]+)/,zo=o=>{let e=o.match(Mt);if(!e)return null;let t=o.match(Ke);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Wo=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(Mt);if(!n)continue;let i=r.match(Ke)||window.location.pathname.match(Ke);return{contactId:n[1],locationId:i?i[1]:null,source:"dom"}}return null},S=()=>{let o=zo(window.location.pathname);return o||Wo()};var Dt=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},ye="",Ye=null,j="other",Xe=new Set,ve=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==ye)&&!(o!==Ye))){ye=window.location.pathname,Ye=o,j=Dt(),b.debug("Page/context changed:",j,ye,"contact:",o);for(let r of Xe)try{r(j)}catch(n){b.error("Subscriber threw:",n)}}},Ot=o=>(Xe.add(o),setTimeout(()=>o(j),0),()=>{Xe.delete(o)}),Nt=()=>{j=Dt(),ye=window.location.pathname,Ye=S()?.contactId??null,b.debug("Router init, current page:",j);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ve()},history.replaceState=function(t,r,n){e(t,r,n),ve()},window.addEventListener("popstate",ve),setInterval(ve,1e3)};var ge="0.13.85",fe="2026-05-28T01:32:02.121Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((i,a)=>{let s=n.querySelector(o);if(s){i(s);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),a(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},k={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Je={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},Ht=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,I=`
  ...
  flex-shrink: 0;
`;var jo=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&jo.test(o),Ko=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Yo=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Xo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},Jo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Ko(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},Zo=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>Yo()||Xo()||Jo()||Zo()||null;var $t="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Qo=`${$t}/active-follow-up-get`,er=`${$t}/active-follow-up-set`,q="ws-crm-active-follow-up-button",Qe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},tr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},or=async o=>{let e=await fetch(Qo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},rr=async(o,e)=>{let t=await fetch(er,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},z=(o,e)=>{let t=Qe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Pt=o=>{let e=document.createElement("button");return e.type="button",e.id=q,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,z(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=tr();if(!(!r||r.contactId!==o)){z(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await rr(r,L()),i=n&&n.state&&n.state in Qe?n.state:"blue";z(e,i),b.info(`Active Follow Up set for ${o} \u2192 ${i}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),z(e,"error"),setTimeout(()=>void we(e,r),4e3)}}}),e},we=async(o,e)=>{z(o,"loading");try{let t=await or(e),r=t&&t.state&&t.state in Qe?t.state:"gray",n=document.getElementById(q);if(!n||n.dataset.contactId!==e.contactId)return;z(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),z(o,"error")}},nr=[".central-panel","[class*='central-panel']"],Ze="ws-crm-contact-actions-bar",ar=async()=>{for(let o of nr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},ir=async(o,e)=>{let t=e.querySelector(`#${Ze}`);if(!t)try{t=await C(`#${Ze}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${Ze}`);i&&i.parentElement===e?e.insertBefore(n,i.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},sr=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},lr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},dr=async o=>{if(o==="url"){let t=await ar();return t?{kind:"contact-detail",target:t}:null}let e=sr();return e?{kind:"conversations",target:e}:null},Bt=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await ir(o,e.target);return t}return lr(o,e.target),"conversations-header"},cr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(q)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(q);if(t&&t.dataset.contactId===e.contactId){we(t,e);return}t&&t.remove();let r=await dr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let i=Pt(e.contactId),a=await Bt(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${a}) for ${e.contactId}`),Rt();let s=document.getElementById(q)??i;we(s,e);let d=new MutationObserver(()=>{let c=document.getElementById(q);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Pt(e.contactId);Bt(m,r).then(()=>{Rt(),we(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Z=null,Gt=()=>{let o=S()?.contactId??null;if(Z&&Z.contactId===o)return;let e=cr().finally(()=>{Z?.promise===e&&(Z=null)});Z={contactId:o,promise:e}},Rt=()=>{let o=document.querySelectorAll(`#${q}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var G="ws-crm-claim-release-pill",br="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",hr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",pr=async o=>{let e=await fetch(br,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},mr=async o=>{let e=await fetch(hr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},qt=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},K=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?l.emerald:l.amber;o.dataset.mode=e,o.style.cssText=Ht(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=l.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let p=a.firstElementChild,m=a.children[1],h=a.children[2];p&&(p.style.background=Je[d.color]),m&&(m.textContent=d.label),s.style.display="none";let g=S()?.locationId,x=L();if(!g){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=l.amber);return}if(e==="seller"&&d.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=l.amber);return}let v=h?.textContent??"\u25BE",_=async y=>{h&&(h.textContent="\u2026"),a.style.opacity="0.75";try{await wr({contactId:o,locationId:g,status:d.label,userId:x,deadReason:y,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=v),a.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),h&&(h.textContent="\u2717"),m&&(m.style.color=l.amber),a.style.opacity="1",setTimeout(()=>{h&&(h.textContent=v),m&&(m.style.color=l.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let y=m?.textContent??"";Fr(E=>{_(E)},()=>{m&&(m.textContent=y)});return}if(e==="seller"&&d.value==="appointment-booked"){let y=m?.textContent??"";try{(await xr({contactId:o,tenantId:g})).ok?await _():Mr(()=>{_()},()=>{m&&(m.textContent=y)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await _()}return}await _()}),s.appendChild(c)}),a.addEventListener("click",d=>{d.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(s.style.display="none")}),i.appendChild(a),i.appendChild(s),i},Ir="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Lr=async o=>{let e=await fetch(Ir,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ar=(o,e="seller")=>{document.getElementById(Kt)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=t?l.emerald:l.amber,a=document.createElement("div");a.id=Kt,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let d=new Date,c=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),p=t?`
    <label style="
      display: block;
      font-family: ${f.mono};
      font-size: 10px;
  ...
  `,a.appendChild(s),document.body.appendChild(a);let m=()=>a.remove();a.addEventListener("click",x=>{x.target===a&&m()});let h=s.querySelector("#ws-offer-error"),u=s.querySelector("#ws-offer-cancel"),g=s.querySelector("#ws-offer-submit");u?.addEventListener("click",m),g?.addEventListener("click",async()=>{let x=(s.querySelector("#ws-offer-amount")?.value??"").trim(),v=t?s.querySelector("#ws-offer-expires")?.value??"":"";if(!x||Number(x)<=0){h&&(h.textContent="Enter a positive offer amount."),b.warn("Offer Made submit blocked \u2014 invalid amount");return}let _=Number(x);if(_<100){h&&(h.textContent=`That looks low \u2014 did you mean $${(_*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){h&&(h.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}h&&(h.textContent=""),g&&(g.disabled=!0,g.textContent="Recording\u2026",g.style.opacity="0.7"),u&&(u.disabled=!0);try{let w=await Lr({tenantId:T,contactId:o,kind:e,amount:_,expiresAt:v||null,userId:L()});if(!w.ok){h&&(h.textContent=w.error??"Something went wrong."),g&&(g.disabled=!1,g.textContent="Record Offer",g.style.opacity="1"),u&&(u.disabled=!1);return}b.info(`Offer Made (${e}) recorded for contact ${o}: $${_} on ${w.opp_pipeline} opp (stage: ${w.opp_stage_name??"?"})`),m()}catch(w){b.error("Offer Made webhook failed",w),h&&(h.textContent=w instanceof Error?w.message:"Network error \u2014 try again."),g&&(g.disabled=!1,g.textContent="Record Offer",g.style.opacity="1"),u&&(u.disabled=!1)}}),setTimeout(()=>{s.querySelector("#ws-offer-amount")?.focus()},0)},Yt="ws-crm-dead-deal-modal",Fr=(o,e)=>{document.getElementById(Yt)?.remove();let t=document.createElement("div");t.id=Yt,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),i=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let a=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",a),i())};document.addEventListener("keydown",a)},Jt=(o,e)=>{let t=document.createElement("div");t.id=Y,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    ...
    border-bottom: 1px solid ${l.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=R,r.textContent="Offer Made",r.addEventListener("click",()=>Ar(o,e)),t.appendChild(r),t.appendChild(Cr({contactId:o,kind:e})),t},et=!1,Dr=()=>{document.querySelectorAll(`[id="${Y}"]`).forEach(o=>o.remove())},to=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),et){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}et=!0;try{await Or()}finally{et=!1}},Or=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),Dr();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Wt(o.contactId,o.locationId);jt(c)==="buyer"&&(e="buyer"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Y}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await Sr();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let i=S();if(!i||i.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let a;try{a=Jt(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}a.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(a,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Y)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${Y}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||n,h=Jt(o.contactId,e);h.dataset.mountTarget=a.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},Zt=null,Nr=()=>{Zt===null&&(Zt=window.setInterval(()=>{let o=S();o&&(document.getElementById(Y)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),to()))},3e3))},oo=()=>{Nr(),to()};var xe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Hr=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),ee="data-ws-crm-favicon",tt=o=>o.hasAttribute(ee),ro=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Hr.has(e)},ke=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ro(r)&&!tt(r)&&r.remove()});let e=document.head.querySelector(`link[${ee}="1"]`);e?e.href!==xe&&(e.href=xe):(e=document.createElement("link"),e.setAttribute(ee,"1"),e.rel="icon",e.type="image/png",e.href=xe,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${ee}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(ee,"apple"),t.rel="apple-touch-icon",t.href=xe,document.head.appendChild(t))},no=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)ke();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),ke())},50)}new MutationObserver(r=>{let n=!1;for(let i of r)i.addedNodes.forEach(a=>{a instanceof HTMLLinkElement&&ro(a)&&!tt(a)&&(n=!0)}),i.removedNodes.forEach(a=>{a instanceof HTMLLinkElement&&tt(a)&&(n=!0)});n&&ke()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,ke(),e>=5&&window.clearInterval(t)},1e3)};var Pr=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Br=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Rr=".hr-card.hr-modal.crm-opportunities-modal",A=()=>{let o=document.querySelector(Rr);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Br);if(n){let i=n[1];if(Pr.includes(i))return i}}return null},U=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=A();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var $r="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",D="ws-crm-mt-offer-made-button",ao="ws-crm-mt-offer-made-modal",Gr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ur=/\/v2\/location\/([A-Za-z0-9]+)/,Se=()=>{let o=window.location.pathname,e=o.match(Gr);if(!e)return null;let t=o.match(Ur);return{oppId:e[1],locationId:t?t[1]:null}},Vr=async o=>{let e=await fetch($r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ee=()=>{document.getElementById(ao)?.remove()},qr=o=>{Ee();let e=document.createElement("div");e.id=ao,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Se();!t||!t.locationId||t.oppId!==o||qr({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=l.emeraldGlow,e.style.color=l.emeraldBright,e.style.borderColor=l.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=I)},4e3)}})}),e},Wr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jr=async()=>{for(let o of Wr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Te=!1,at=async()=>{if(!Te){Te=!0;try{await Kr()}finally{Te=!1}}},Kr=async()=>{let o=Se();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await jr();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Se();if(!n||n.oppId!==o.oppId)return;let i=zr(o.oppId),a=document.createElement("span");a.id=`${D}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Yr(o.oppId)},te=null,nt=null,oe=()=>{te?.disconnect(),te=null,nt=null},Yr=o=>{if(te&&nt===o)return;oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(nt=o,te=new MutationObserver(()=>{let t=Se();if(!t||t.oppId!==o){oe();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),oe();return}document.getElementById(D)||at()}),te.observe(e,{childList:!0,subtree:!0}))},ot=null,rt,Xr=()=>{ot||(ot=new MutationObserver(()=>{rt===void 0&&(rt=window.setTimeout(()=>{rt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!Te&&at()},300))}),ot.observe(document.body,{childList:!0,subtree:!0}))},io=()=>{Xr(),at()};var Jr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",O="ws-crm-not-interested-button",Zr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qr=/\/v2\/location\/([A-Za-z0-9]+)/,Ie=()=>{let o=window.location.pathname,e=o.match(Zr);if(!e)return null;let t=o.match(Qr);return{oppId:e[1],locationId:t?t[1]:null}},en=async o=>{let e=await fetch(Jr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},tn=o=>{let e=document.createElement("button");return e.id=O,e.type="button",e.dataset.oppId=o,e.style.cssText=I,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Ie();if(!t||!t.locationId||t.oppId!==o)return;let r=L(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let i=await en({oppId:t.oppId,locationId:t.locationId,userId:r});if(i?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},on=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rn=async()=>{for(let o of on)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ce=!1,dt=async()=>{if(!Ce){Ce=!0;try{await nn()}finally{Ce=!1}}},nn=async()=>{let o=Ie();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}let e=document.getElementById(O);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne());return}e&&(e.remove(),document.getElementById(`${O}-wrap`)?.remove());let t=await rn();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ie();if(!n||n.oppId!==o.oppId)return;let i=tn(o.oppId),a=document.createElement("span");a.id=`${O}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),an(o.oppId)},re=null,lt=null,ne=()=>{re?.disconnect(),re=null,lt=null},an=o=>{if(re&&lt===o)return;ne();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(lt=o,re=new MutationObserver(()=>{let t=Ie();if(!t||t.oppId!==o){ne();return}let r=A();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(O)?.remove(),document.getElementById(`${O}-wrap`)?.remove(),ne();return}document.getElementById(O)||dt()}),re.observe(e,{childList:!0,subtree:!0}))},it=null,st,sn=()=>{it||(it=new MutationObserver(()=>{st===void 0&&(st=window.setTimeout(()=>{st=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(O);o&&!e&&!Ce&&dt()},300))}),it.observe(document.body,{childList:!0,subtree:!0}))},so=()=>{sn(),dt()};var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",N="ws-crm-reduce-price-button",lo="ws-crm-reduce-price-modal",dn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cn=/\/v2\/location\/([A-Za-z0-9]+)/,Fe=()=>{let o=window.location.pathname,e=o.match(dn);if(!e)return null;let t=o.match(cn);return{oppId:e[1],locationId:t?t[1]:null}},bn=async o=>{let e=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Le=()=>{document.getElementById(lo)?.remove()},hn=o=>{Le();let e=document.createElement("div");e.id=lo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=Fe();!r||!r.locationId||r.oppId!==o||hn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),i=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,i&&(i.style.background=l.emerald,i.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=I,i&&(i.style.background=l.amber,i.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},mn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],un=async()=>{for(let o of mn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ae=!1,pt=async()=>{if(!Ae){Ae=!0;try{await _n()}finally{Ae=!1}}},_n=async()=>{let o=Fe();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ie();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let s=A();s!==null&&s!=="Disposition"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),ie());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=await un();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await U();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=Fe();if(!n||n.oppId!==o.oppId)return;let i=pn(o.oppId,o.locationId),a=document.createElement("span");a.id=`${N}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),vn(o.oppId)},ae=null,ht=null,ie=()=>{ae?.disconnect(),ae=null,ht=null},vn=o=>{if(ae&&ht===o)return;ie();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ht=o,ae=new MutationObserver(()=>{let t=Fe();if(!t||t.oppId!==o){ie();return}let r=A();if(r!==null&&r!=="Disposition"){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),ie();return}document.getElementById(N)||pt()}),ae.observe(e,{childList:!0,subtree:!0}))},ct=null,bt,yn=()=>{ct||(ct=new MutationObserver(()=>{bt===void 0&&(bt=window.setTimeout(()=>{bt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!Ae&&pt()},300))}),ct.observe(document.body,{childList:!0,subtree:!0}))},co=()=>{yn(),pt()};var ho="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",W="ws-crm-send-to-title-co-button",X="ws-crm-send-to-title-co-wrap",Oe="ws-crm-stc-dropdown",gn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fn=/\/v2\/location\/([A-Za-z0-9]+)/,_t=()=>{let o=window.location.pathname,e=o.match(gn);if(!e)return null;let t=o.match(fn);return{oppId:e[1],locationId:t?t[1]:null}},wn=5*60*1e3,po=o=>`ws-crm-stc-cache:${o}`,xn=o=>{try{let e=window.localStorage.getItem(po(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>wn||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},kn=(o,e)=>{try{window.localStorage.setItem(po(o),JSON.stringify(e))}catch{}},En=async(o,e)=>{try{let t=await fetch(ho,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Tn=async(o,e,t)=>{let r=await fetch(ho,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:L()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Sn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},bo=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Cn=(o,e)=>{if(e&&Sn(e)){window.setTimeout(()=>bo(o),300);return}bo(o)},B=()=>{document.getElementById(Oe)?.remove()},Me=(o,e,t)=>{B();let r=document.createElement("div");r.id=Oe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],p={};o.forEach(u=>{p[u.group]||(p[u.group]=[]),p[u.group].push(u)});let m=[...c.filter(u=>p[u]),...Object.keys(p).filter(u=>!c.includes(u))];for(let u of m){let g=p[u],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let v=document.createElement("div");v.style.cssText=`
      font-family: ${f.mono};
      font-size: 9px;
    ...
    `,v.textContent=u,x.appendChild(v),g.forEach(_=>{let y=document.createElement("div"),E=!_.filled&&_.navigable&&_.field_id;y.style.cssText=`
        ...
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(y.addEventListener("mouseenter",()=>{y.style.background=l.slate}),y.addEventListener("mouseleave",()=>{y.style.background="transparent"}),y.addEventListener("click",F=>{F.stopPropagation(),_.field_id&&(Cn(_.field_id,_.folder),B())}));let T=_.filled?`<span style="color: ${l.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${l.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,w=E?`<span style="margin-left: auto; color: ${l.ash}; font-size: 11px;">\u2192</span>`:"";y.innerHTML=`${T}<span style="flex: 1;">${_.label}</span>${w}`,x.appendChild(y)}),r.appendChild(x)}document.body.appendChild(r);let h=u=>{let g=u.target;!r.contains(g)&&!t.contains(g)&&(B(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},P=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),i,a,s=l.bone,d,c="Send to Title Company",p="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",a=l.steel,s=l.ash,d=l.coolGray,c="Checking\u2026",m="wait",h="0.8";break;case"ready":i=l.emerald,a=l.emerald,s="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Title Co":"Send to Title Company";break;case"incomplete":{let u=e.checks?.filter(x=>x.filled).length??0,g=e.checks?.length??0;i="transparent",a=l.amber,s=l.amber,d=l.amber,c=`${u} of ${g} fields ready`,p="\u25BE";break}case"sending":i=l.emerald,a=l.emerald,s="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",h="0.8";break;case"sent":i=l.emerald,a=l.emerald,s="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":i="transparent",a=l.amber,s=l.amber,d=l.amber,c=e.message??"Try again";break}o.style.background=i,o.style.borderColor=a,o.style.color=s,o.style.cursor=m,o.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=c),n&&(n.textContent=p)},In=(o,e)=>{let t=document.createElement("button");t.id=W,t.type="button",t.dataset.oppId=o;let r=xn(o),n=r?{status:r.checks.every(v=>v.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${R}
    background: transparent;
    border: 1px solid ${l.steel};
    color: ${l.ash};
  ...
  `,P(t,n);let i=new Set,a=async()=>{if(n.status==="sending")return;let v=await En(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},P(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),B(),le();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?i.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),i=T}else i=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},kn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(Oe)&&Me(y,v.previously_sent_at,t)},s=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),B();try{let _=await Tn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&Me(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&Me(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":s();break;case"incomplete":{document.getElementById(Oe)?B():n.checks&&Me(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await a()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-p,E=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},Ln=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],An=async()=>{for(let o of Ln)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},De=!1,yt=async()=>{if(De){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}De=!0;try{await Fn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{De=!1}},Fn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=_t();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),B();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(W);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let s=A();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),B(),le());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),B()),b.debug("[stc] mount:04 calling findMountTarget");let t=await An();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=_t();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=In(o.oppId,n.locationId),a=document.createElement("span");a.id=X,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),a.appendChild(i),t.appendChild(a),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(i)}`),Mn(o.oppId)},se=null,vt=null,le=()=>{se?.disconnect(),se=null,vt=null},Mn=o=>{if(se&&vt===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(vt=o,se=new MutationObserver(()=>{let t=_t();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(W)?.remove(),document.getElementById(X)?.remove(),B(),le();return}document.getElementById(W)||yt()}),se.observe(e,{childList:!0,subtree:!0}))},mt=null,ut,Dn=()=>{mt||(mt=new MutationObserver(()=>{ut===void 0&&(ut=window.setTimeout(()=>{ut=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(W);o&&!e&&!De&&yt()},300))}),mt.observe(document.body,{childList:!0,subtree:!0}))},mo=()=>{Dn(),yt()};var On="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Nn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Hn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",vo="ldtyB2UXKi9vOp8nLUH7",Pn="WVD2gb9swLsgcdBEtDVq",H="ws-crm-title-officer-picker-button",yo="ws-crm-title-officer-picker-modal",Bn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rn=/\/v2\/location\/([A-Za-z0-9]+)/,he=()=>{let o=window.location.pathname,e=o.match(Bn);if(!e)return null;let t=o.match(Rn);return{oppId:e[1],locationId:t?t[1]:null}},St=async o=>{let e=await fetch(On,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},uo=async o=>{let e=await fetch(Nn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$n=async(o,e)=>{try{let t=await fetch(Hn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:vo}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let i=await St({tenantId:e,contactId:n,limit:1});if(!i.ok||!i.results.length)return null;let a=i.results[0];return{id:a.id,name:a.name,companyName:a.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},de=null,Gn=60*60*1e3,Ct=o=>`ws-crm-to-cache:${o}`,Un=o=>{try{let e=window.localStorage.getItem(Ct(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>Gn||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},go=(o,e,t)=>{try{window.localStorage.setItem(Ct(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},Vn=o=>{try{window.localStorage.removeItem(Ct(o))}catch{}},xt="ws-crm-title-officer-field-link",qn=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${xt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsTitleOfficerDecorated}))},gt=!1,It=async o=>{if(gt)return;let e=fo();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[title-officer] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[title-officer] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsTitleOfficerDecorated!==t){gt=!0;try{b.info(`[title-officer] tryDecorate: looking up ${t}`);let r=await St({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[title-officer] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[title-officer] tryDecorate: applying ${n.name} (${n.id})`),kt(n.id,n.name,o);let i=document.getElementById(H);if(i){V(i,{status:"linked",contactName:n.name});let a=he();a&&go(a.oppId,n.id,n.name)}}catch(r){b.warn("[title-officer] tryDecorate lookup failed:",r)}finally{gt=!1}}},zn=/^TC\s*[-‐–—]\s*Title\s+Officer$/i,fo=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();zn.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[title-officer] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[title-officer] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[title-officer] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let a=t[0].parentElement,s=0;for(;a&&s<8;){let d=a.querySelector("input");if(d)return b.info(`[title-officer] findInput: located input ${s} levels up from label`),d;a=a.parentElement,s+=1}return b.warn("[title-officer] findInput: label found but no <input> within 8 ancestors"),null},kt=(o,e,t)=>{let r=fo();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${xt}`).forEach(a=>a.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsTitleOfficerDecorated=o,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let s=document.createElement("a");s.className=xt,s.href=`/v2/location/${t}/contacts/detail/${o}`,s.textContent=e,s.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),i=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ne()}),i?.addEventListener("click",Ne);let a,s="",d=async c=>{if(n&&c!==s){if(s=c,!c.trim()){n.innerHTML=`
      ...
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await St({tenantId:o.locationId,query:c,limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=l.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Ne(),o.onPick(m)}),n.appendChild(h)})}catch(p){b.error("Title Officer picker search failed",p),n&&(n.innerHTML=`
  ...
  `;let r={status:"loading"};V(t,r);let n=Un(o);return n&&(r={status:"linked",contactName:n.contactName},V(t,r),de={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let a=await $n(o,e);a?(r={status:"linked",contactName:a.name},V(t,r),de={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},kt(a.id,a.name,e)):n||(r={status:"empty"},V(t,r),de?.oppId===o&&(de=null),qn(),Vn(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Wn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},V(t,r);try{let s=[uo({tenantId:e,oppId:o,fieldId:vo,value:a.id})];a.companyName&&a.companyName.trim()&&s.push(uo({tenantId:e,oppId:o,fieldId:Pn,value:a.companyName.trim()}));let c=(await Promise.all(s))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:a.name},V(t,r),de={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},go(o,a.id,a.name),kt(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(s){b.error("Title Officer link failed",s),r={status:"empty"},V(t,r)}}})}),t},Kn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Yn=async()=>{for(let o of Kn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ce=!1,Be=async()=>{if(!ce){ce=!0;try{await Xn()}finally{ce=!1}}},Xn=async()=>{let o=he();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),Pe();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Yn();if(!r||await U()!=="Transaction Coordination")return;let i=he();if(!i||i.oppId!==o.oppId||!i.locationId)return;let a=jn(o.oppId,i.locationId),s=document.createElement("span");s.id=`${H}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(a),r.appendChild(s),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),Jn(o.oppId),It(i.locationId)},be=null,Et=null,Tt=null,Pe=()=>{be?.disconnect(),be=null,Et=null,Tt=null},Jn=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(be&&Et===o&&Tt===e||(Pe(),Et=o,Tt=e,be=new MutationObserver(()=>{let t=he();if(!t||t.oppId!==o||!t.locationId){Pe();return}document.getElementById(H)||Be(),It(t.locationId)}),be.observe(e,{childList:!0,subtree:!0})))},ft=null,wt,Zn=()=>{ft||(ft=new MutationObserver(()=>{wt===void 0&&(wt=window.setTimeout(()=>{wt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!ce&&Be()},300))}),ft.observe(document.body,{childList:!0,subtree:!0}))},_o,Qn=()=>{_o===void 0&&(_o=window.setInterval(()=>{let o=he();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(H)&&!ce&&(b.info("[title-officer] safety-net: button missing on opp page \u2014 remounting"),Be()),It(o.locationId)},2e3))},wo=()=>{b.info("[title-officer] mountTitleOfficerPickerButton invoked"),Zn(),Qn(),Be()};var qe="reos-theme-stylesheet",Ro="reos-theme-fonts",ea=()=>{let o=document.getElementById(Ro);o&&o.remove()},ta=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var M=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Uo=()=>{b.info(`Loaded v${ge} (built ${fe})`),M("mountVersionBadge (initial)",We),M("mountFavicon",no),M("mountThemeStylesheet",$o),M("initPageRouter",Nt),b.info("[main] registering onPageChange subscriber"),Ot(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),M("mountVersionBadge",We),M("mountClaimReleaseToggle",zt),M("mountContactActionsBar",oo),M("mountActiveFollowUpButton",Gt),M("mountMtOfferMadeButton",io),M("mountNotInterestedButton",so),M("mountReducePriceButton",co),M("mountSendToTitleCoButton",mo),M("mountTitleOfficerPickerButton",wo)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Uo):Uo();})();
