/* Wholesaling CRM Customizer v0.56.0 — built 2026-07-10T14:09:23.232Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var cr="[wholesaling-crm-customizer]",Dp="__WS_CRM_DEBUG",Fp=()=>!!window[Dp],p={info(...e){console.log(cr,...e)},warn(...e){console.warn(cr,...e)},error(...e){console.error(cr,...e)},debug(...e){Fp()&&console.log(cr,"[debug]",...e)}};var zp=/\/v2\/location\/([A-Za-z0-9]+)/,Np=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let e=window.location.pathname.match(zp);return e?e[1]:null},Rn=()=>{let e=K();return e!==null&&Np.has(e)};var mi=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dn=/\/v2\/location\/([A-Za-z0-9]+)/,qp=e=>{let t=e.match(mi);if(!t)return null;let o=e.match(Dn);return{contactId:t[1],locationId:o?o[1]:null,source:"url"}},Up=()=>{let e=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let t of e){let o=document.querySelector(t);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(mi);if(!a)continue;let s=r.match(Dn)||window.location.pathname.match(Dn);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let e=qp(window.location.pathname);return e||Up()};var bi=()=>{let e=window.location.pathname;return e.includes("/contacts/detail/")?"contact-detail":e.includes("/contacts/smart-list")||e.includes("/contacts/")?"contact-list":e.includes("/opportunities/detail/")?"opportunity-detail":e.includes("/opportunities")?"opportunity-list":e.includes("/calendars/")?"calendar":e.includes("/dashboard")?"dashboard":e.includes("/conversations")?"conversations":e.includes("/settings")?"settings":"other"},mr="",Fn=null,at="other",zn=new Set,pr=()=>{let e=D()?.contactId??null;if(!(!(window.location.pathname!==mr)&&!(e!==Fn))){mr=window.location.pathname,Fn=e,at=bi(),p.debug("Page/context changed:",at,mr,"contact:",e);for(let r of zn)try{r(at)}catch(a){p.error("Subscriber threw:",a)}}},ve=e=>(zn.add(e),setTimeout(()=>e(at),0),()=>{zn.delete(e)}),ui=()=>{at=bi(),mr=window.location.pathname,Fn=D()?.contactId??null,p.debug("Router init, current page:",at);let e=history.pushState.bind(history),t=history.replaceState.bind(history);history.pushState=function(o,r,a){e(o,r,a),pr()},history.replaceState=function(o,r,a){t(o,r,a),pr()},window.addEventListener("popstate",pr),setInterval(pr,1e3)},kt=()=>at;var jp=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,vi=null,hi=!1,_i=e=>{let t=e.match(jp);t&&(vi=t[1])},yi=()=>{if(!hi){hi=!0;try{let e=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&_i(a)}catch{}return e(o,r)};let t=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{_i(typeof r=="string"?r:r.href)}catch{}return t.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(e){p.warn("[opp-id-capture] install failed",e)}}},Le=()=>vi;var br="0.56.0",ur="2026-07-10T14:09:23.233Z";var Wp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",hr=new Map,Nn=new Map,Gp=3e4,st=4e3,Kp=st,Se=async(e,t)=>{if(!e)return null;let o=hr.get(e);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<Gp)return null}if(!t)return p.warn(`Cannot fetch Contact Type for ${e} \u2014 tenant_id missing from URL context`),null;let r=Nn.get(e);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),Kp);try{let l=`${Wp}?contact_id=${encodeURIComponent(e)}&tenant_id=${encodeURIComponent(t)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${e}`),hr.set(e,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let _=(m.contact_type||"").toLowerCase().trim()||null;return hr.set(e,{type:_}),p.debug(`Resolved Contact Type for ${e}: ${_??"(unset)"}`),_}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${e}:`,l),hr.set(e,{type:null,failedAt:Date.now()}),null}})();Nn.set(e,s);try{return await s}finally{Nn.delete(e)}},Ae=e=>e==="buyer"?"buyer":e==="seller"?"seller":e==="agent"||e==="closing_agent"||e==="closing_office"||e==="vendor"||e==="tenant"?"other":"seller";var M=(e,t={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=t;return new Promise((s,i)=>{let d=a.querySelector(e);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let _=a.querySelector(e);_&&(m(),s(_))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${e}`),i(new Error(`Selector not found within ${o}ms: ${e}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_r="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},qn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},gi=e=>{let t=e==="emerald"?n.emeraldGlow:e==="amber"?n.amberGlow:n.slate,o=e==="emerald"?n.emeraldBorder:e==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=e==="emerald"?n.emerald:e==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,B=`
  ...
  flex-shrink: 0;
`;var Un="https://services.leadconnectorhq.com",fi="__WS_CRM_CAPTURED_AUTH";var jn=()=>{try{let e=localStorage.getItem(fi);if(!e)return null;let t=JSON.parse(e);return t?.authorization?Date.now()-(t.capturedAt||0)>3e6?(localStorage.removeItem(fi),null):t:null}catch{return null}},Vp=()=>{let e=jn();if(!e)return null;let t={Authorization:e.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return e.tokenId&&(t["token-id"]=e.tokenId),t},Wn=async(e,t={})=>{let o=Vp();if(!o)return null;try{return await fetch(e,{...t,headers:{...o,...t.headers??{}}})}catch{return null}};var Yp=/^[A-Za-z0-9]{15,30}$/,it=e=>typeof e=="string"&&Yp.test(e),Gn=e=>{try{let t=e.split(".");if(t.length!==3)return null;let o=t[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Jp=()=>{let e=window.WS_CRM_USER_ID;return it(e)?e:null},Qp=()=>{let e=window,t=[e.appState?.user?.id,e.user?.id,e.currentUser?.id,e.LCUser?.id,e.HL?.user?.id];for(let o of t)if(it(o))return o;return null},Zp=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Gn(t);if(!o)return null;let r=o.uid;if(it(r))return r;let a=o.claims;if(a&&it(a.user_id))return a.user_id}catch{}return null},Xp=()=>{try{let e=jn();if(!e?.authorization)return null;let t=e.authorization.replace(/^Bearer\s+/i,""),o=Gn(t);if(!o)return null;if(o.authClass==="User"&&it(o.authClassId))return o.authClassId;if(it(o.primaryAuthClassId))return o.primaryAuthClassId}catch{}return null},em=()=>{try{let e=["user","tokenUser","currentUser","ghl_user"];for(let t of e){let o=localStorage.getItem(t);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(it(a))return a}catch{}}}catch{}return null},H=()=>Jp()||Zp()||Xp()||Qp()||em()||null,tm=()=>{try{let e=localStorage.getItem("refreshedToken");if(!e)return null;let t=e.startsWith('"')?e.slice(1,-1):e,o=Gn(t);return o?o.claims??o:null}catch{return null}},Et=()=>{let e=window.WS_CRM_FORCE_AGENCY;return typeof e=="boolean"?e:tm()?.type==="agency"};var Ei="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",om=`${Ei}/active-follow-up-get`,rm=`${Ei}/active-follow-up-set`,lt="ws-crm-active-follow-up-button",Vn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},nm=()=>{let e=D();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},am=async e=>{let t=await fetch(om,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId}),credentials:"omit"});if(!t.ok)throw new Error(`Get webhook returned ${t.status} ${t.statusText}`);return await t.json()},sm=async(e,t)=>{let o=await fetch(rm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,triggered_by_user_id:t??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},dt=(e,t)=>{let o=Vn[t];e.dataset.state=t,e.disabled=!o.clickable,e.style.cursor=o.clickable?"pointer":"default",e.style.background=o.bg,e.style.borderColor=o.border,e.style.color=o.color;let r=e.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=e.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},xi=e=>{let t=document.createElement("button");return t.type="button",t.id=lt,t.dataset.contactId=e,t.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,dt(t,"loading"),t.addEventListener("click",async()=>{if(t.dataset.state!=="amber")return;let r=nm();if(!(!r||r.contactId!==e)){dt(t,"blue"),t.style.transform="scale(0.97)",setTimeout(()=>t.style.transform="",120);try{let a=await sm(r,H()),s=a&&a.state&&a.state in Vn?a.state:"blue";dt(t,s),p.info(`Active Follow Up set for ${e} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),dt(t,"error"),setTimeout(()=>void yr(t,r),4e3)}}}),t},im=3e4,yr=async(e,t)=>{e.dataset.lastRefreshAt=String(Date.now()),dt(e,"loading");try{let o=await am(t),r=o&&o.state&&o.state in Vn?o.state:"gray",a=document.getElementById(lt);if(!a||a.dataset.contactId!==t.contactId)return;dt(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete e.dataset.lastRefreshAt,dt(e,"error")}},lm=[".central-panel","[class*='central-panel']"],Kn="ws-crm-contact-actions-bar",dm=async()=>{for(let e of lm)try{let t=await M(e,{timeoutMs:3e3});if(t)return t}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},cm=async(e,t)=>{let o=t.querySelector(`#${Kn}`);if(!o)try{o=await M(`#${Kn}`,{timeoutMs:st+2e3,root:t})}catch{o=null}if(o){let s=t.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),e.style.order="2",o.appendChild(e),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=t.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=t.querySelector(`#${Kn}`);s&&s.parentElement===t?t.insertBefore(a,s.nextSibling):t.insertBefore(a,t.firstChild)}return a.appendChild(e),{container:a,placement:"fallback"}},pm=()=>{let e=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!e)return null;let t=e;for(let o=0;o<8&&!(!t||!t.parentElement);o++){let r=t.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}t=r}return null},mm=(e,t)=>{e.style.marginRight="4px",t.insertBefore(e,t.firstChild)},bm=async e=>{if(e==="url"){let o=await dm();return o?{kind:"contact-detail",target:o}:null}let t=pm();return t?{kind:"conversations",target:t}:null},wi=async(e,t)=>{if(t.kind==="contact-detail"){let{placement:o}=await cm(e,t.target);return o}return mm(e,t.target),"conversations-header"},um=async()=>{let e=D();if(!e||!e.locationId){document.getElementById(lt)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let t={contactId:e.contactId,tenantId:e.locationId},o=document.getElementById(lt);if(o&&o.dataset.contactId===t.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=im&&yr(o,t);return}o&&o.remove();let r=await bm(e.source);if(!r){p.warn(`Active Follow Up: no mount target on ${e.source}-source page`);return}let a=D();if(!a||a.contactId!==t.contactId)return;let s=xi(t.contactId),i=await wi(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${t.contactId}`),ki();let d=document.getElementById(lt)??s;yr(d,t),vr?.disconnect(),vr=new MutationObserver(()=>{let l=document.getElementById(lt);if(!(D()?.contactId===t.contactId)){vr?.disconnect();return}if(!l){let m=xi(t.contactId);wi(m,r).then(()=>{ki(),yr(m,t)}),p.debug(`Active Follow Up re-mounted after wipe for ${t.contactId}`)}}),vr.observe(r.target,{childList:!0})},vr=null,po=null,$i=()=>{let e=D()?.contactId??null;if(po&&po.contactId===e)return;let t=um().finally(()=>{po?.promise===t&&(po=null)});po={contactId:e,promise:t}},ki=()=>{let e=document.querySelectorAll(`#${lt}`);if(!(e.length<=1)){p.debug(`Active Follow Up: found ${e.length} duplicate buttons, keeping first, removing ${e.length-1}`);for(let t=1;t<e.length;t++)e[t].remove()}};var hm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",_m="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/callstats/sweep-run",gr="ws-crm-analytics-overlay",vm=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],ym=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],P={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},J=e=>{let t=Number(e)||0;return"$"+Math.round(t).toLocaleString("en-US")},R=e=>(Number(e)||0).toLocaleString("en-US"),Jn=e=>{let t=Number(e);return!Number.isFinite(t)||t<=0?"\u2014":new Date(t).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},bo=e=>{let t=Math.round(Number(e)||0);if(t<60)return`${t}s`;let o=Math.floor(t/3600),r=Math.round(t%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},gm=()=>`${P.range}|${P.customStart}|${P.customEnd}`,ct=async(e=!1)=>{let t=gm();if(!e&&P.cache.has(t)){P.data=P.cache.get(t),P.error=null,pt();return}let o=K();if(!o){P.error="Could not resolve the sub-account id from the URL.",pt();return}P.loading=!0,P.error=null,pt();try{let r={tenant_id:o,range:P.range,tz_offset_minutes:new Date().getTimezoneOffset()};P.range==="custom"&&(r.start=P.customStart,r.end=P.customEnd);let a=await fetch(hm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);P.data=s,P.cache.set(t,s)}catch(r){P.error=r instanceof Error?r.message:String(r)}finally{P.loading=!1,pt()}},O=(e,t,o)=>{let r=document.createElement(e);return r.style.cssText=t,o!==void 0&&(r.innerHTML=o),r},ne=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ho=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${v.lg};padding:16px 18px;min-width:0;`,Zn=`font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,pe=(e,t,o)=>{let r=O("div",ho+"flex:1;min-width:150px;");return r.appendChild(O("div",Zn+"margin-bottom:8px;",ne(e))),r.appendChild(O("div",`font-family:${u.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,ne(t))),o&&r.appendChild(O("div",`font-family:${u.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,ne(o))),r},Q=(e,t)=>{let o=O("div",ho);if(o.appendChild(O("div",Zn,ne(e))),!t.length)return o.appendChild(O("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...t.map(a=>a.barVal),1);for(let a of t.slice(0,12)){let s=O("div","margin:0 0 10px;"),i=O("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(O("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,ne(a.label)));let d=O("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,ne(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${ne(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=O("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(O("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return t.length>12&&o.appendChild(O("div",`font-size:11px;color:${n.coolGray};`,`+${t.length-12} more`)),o},fr=(e,t,o)=>{let r=O("div",ho+"overflow-x:auto;");if(r.appendChild(O("div",Zn,ne(e))),!o.length)return r.appendChild(O("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${t.map(d=>`<th style="${a}">${ne(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${ne(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(O("div","",i)),r},ee=(e,t)=>{let o=O("div",`display:grid;grid-template-columns:${e};gap:14px;margin-bottom:14px;`);for(let r of t)o.appendChild(r);return o},uo=e=>{let t=O("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of e)t.appendChild(o);return t},Re=e=>(e||[]).map(t=>({label:t.label,primary:R(t.count),barVal:t.count})),fm=e=>(e||[]).map(t=>({label:t.label,primary:J(t.sum),secondary:`\xB7 ${R(t.count)} deal${t.count===1?"":"s"}`,barVal:t.sum})),Li=(e,t)=>{let o=e.calls||{};if(!o.available)return[O("div",`${ho}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${ne(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=t==="acq"?"Seller":"Buyer",a=o[t]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${R(c.dials)} dials`,secondary:`\xB7 ${R(c.connects)} connected \xB7 ${R(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:bo(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${bo(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[Q(`${r} calls per rep (dials)`,s),Q(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(Q("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${R(c.dials)} dials`,secondary:`\xB7 ${bo(c.talk_seconds)} talk`,barVal:c.dials})))),d},xm=(e,t)=>{let o=e.company||{},r=o.left_to_close_this_month||{};t.appendChild(uo([pe("Closed revenue \u2014 365d",J(o.closed_revenue_365),`${R(o.closed_count_365)} closings`),pe("Avg deal size \u2014 365d",J(o.avg_deal_size_365)),pe("Left to close this month",J(r.sum),`${R(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${R(r.missing_est_close)} missing est. close date`:"")),pe("New leads",R(o.total_leads),"in selected range")])),t.appendChild(uo([pe("Contracts",`${R((o.contracts||{}).count)}`,J((o.contracts||{}).sum)+" projected"),pe("Assignments",`${R((o.assignments||{}).count)}`,J((o.assignments||{}).sum)+" assigned"),pe("Deals closed",`${R((o.closed||{}).count)}`,J((o.closed||{}).sum)+" closed")])),t.appendChild(ee("1fr 1fr 1fr",[Q("New leads by source",Re(o.new_leads_by_source)),Q("Contacts per closer (all time)",Re(o.contacts_per_closer)),Q("Dispo deals per rep (all time)",Re(o.dispo_deals_per_rep))]))},wm=(e,t)=>{let o=e.acq||{};t.appendChild(ee("1fr 1fr",[Q("Offers made per rep",Re(o.offers_per_rep)),Q("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:R(a.count),secondary:`\xB7 ${J(a.sum)} projected`,barVal:a.count})))])),t.appendChild(ee("1fr 1fr",[Q("Projected revenue per closer (open escrows)",fm(o.projected_per_closer)),Q("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:J(a.sum),secondary:`\xB7 ${R(a.count)} closings \xB7 avg ${J(a.avg)}`,barVal:a.sum})))]));let r=Li(e,"acq");t.appendChild(r.length>=2?ee("1fr 1fr",r.slice(0,2)):ee("1fr",r)),r.length>2&&t.appendChild(ee("1fr",r.slice(2)))},km=(e,t)=>{let o=e.dispo||{};t.appendChild(ee("1fr 1fr",[Q("Buyers qualified per dispo rep",Re(o.buyers_qualified_per_rep)),Q("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:R(a.count),secondary:`\xB7 ${J(a.sum)} assigned`,barVal:a.count})))])),t.appendChild(ee("1fr",[Q("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:J(a.sum),secondary:`\xB7 ${R(a.count)} closings \xB7 avg ${J(a.avg)}`,barVal:a.sum})))]));let r=Li(e,"dispo");t.appendChild(r.length>=2?ee("1fr 1fr",r.slice(0,2)):ee("1fr",r)),r.length>2&&t.appendChild(ee("1fr",r.slice(2)))},Em=(e,t)=>{let o=e.marketing||{},r=o.lead_quality||{};t.appendChild(uo([pe("Open leads",R(r.open)),pe("Won (under contract+)",R(r.won)),pe("Lost / dead",R(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,R(i.leads),R(i.offers),R(i.contracts),`${R(i.assigned_count)} / ${J(i.assigned_sum)}`,`${R(i.closed_count)} / ${J(i.closed_sum)}`,J(i.avg_deal)]);t.appendChild(ee("1fr",[fr("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,R(i.leads),R(i.offers),R(i.contracts),`${R(i.assigned_count)} / ${J(i.assigned_sum)}`,`${R(i.closed_count)} / ${J(i.closed_sum)}`,J(i.avg_deal)]);t.appendChild(ee("1fr",[fr("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),t.appendChild(ee("1fr 1fr",[Q("Dead leads by channel",Re(o.dead_by_channel)),Q("Dead leads by city",Re(o.dead_by_city))]))},$m=(e,t)=>{let o=e.tc||{};t.appendChild(uo([pe("Contracted",R(o.contracted),"in selected range"),pe("Closed",R(o.closed)),pe("Lost in escrow",R(o.lost_in_escrow)),pe("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),t.appendChild(ee("1fr 1fr",[Q("Deals per TC (contracted in range)",Re(o.per_tc)),Q("Open escrows by stage",Re(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,J(a.value),Jn(a.est_close),a.acq_closer,a.dispo_rep]);t.appendChild(ee("1fr",[fr("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Tm=(e,t)=>{let o=e.velocity||{},r=o.offers_per_contract||{};t.appendChild(uo([pe("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${R(r.offers)} offers \xB7 ${R(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${R(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));t.appendChild(ee("1fr 1fr",[Q("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Q("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,R(d.leads),R(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);t.appendChild(ee("1fr",[fr("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${bo(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${bo(l.talk_seconds)} total \xB7 ${R(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));t.appendChild(ee("1fr",[Q("Talk time per contract per rep",d)]))}else t.appendChild(O("div",`${ho}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${ne(i.note||"")}`))},mo=e=>`padding:5px 12px;border-radius:${v.pill};border:1px solid ${e?n.emeraldBorder:n.steel};background:${e?n.emeraldGlow:"transparent"};color:${e?n.emerald:n.ash};font-family:${u.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,pt=()=>{let e=document.getElementById(gr);if(!e)return;let t=e.querySelector("[data-ws-analytics-body]"),o=e.querySelector("[data-ws-analytics-controls]");if(!t||!o)return;o.innerHTML="";let r=O("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let h of vm){let b=O("button",mo(P.range===h.key),ne(h.label));b.onclick=()=>{P.range=h.key,h.key!=="custom"?ct():pt()},r.appendChild(b)}if(P.range==="custom"){let h=`background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,b=O("input",h);b.type="date",b.value=P.customStart;let f=O("input",h);f.type="date",f.value=P.customEnd;let k=O("button",mo(!0),"Apply");k.onclick=()=>{P.customStart=b.value,P.customEnd=f.value,P.customStart&&P.customEnd&&ct()},r.appendChild(b),r.appendChild(f),r.appendChild(k)}let a=O("button",mo(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ct(!0),r.appendChild(a),o.appendChild(r);let s=O("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let h of ym){let b=O("button",mo(P.tab===h.key),ne(h.label));b.onclick=()=>{P.tab=h.key,pt()},s.appendChild(b)}if(o.appendChild(s),t.innerHTML="",P.loading){t.appendChild(O("div",`padding:60px;text-align:center;color:${n.ash};font-family:${u.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(P.error){let h=O("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${u.sans};font-size:13px;`,`Couldn't load analytics: ${ne(P.error)}`),b=O("button",mo(!0)+"margin:14px auto 0;display:inline-block;","Retry");b.onclick=()=>void ct(!0);let f=O("div","text-align:center;");f.appendChild(h),f.appendChild(b),t.appendChild(f);return}let i=P.data;if(!i){ct();return}let d=i.range||{},l=Number((i.calls||{}).last_swept)||0,c=l>0?` \xB7 calls as of ${new Date(l).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})} (syncing)`:"";t.appendChild(O("div",`font-family:${u.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${ne(d.label||"")} \xB7 ${Jn(d.start)} \u2192 ${Jn(d.end)} \xB7 ${R((i.meta||{}).opps)} opps \xB7 ${R((i.meta||{}).contacts)} contacts${c}`));let m=i.insights||[];if(m.length){let h=O("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let b of m.slice(0,6)){let f=b.level==="warn";h.appendChild(O("div",`padding:8px 12px;border-left:3px solid ${f?n.amber:n.blue};background:${f?n.amberGlow:n.blueGlow};border-radius:0 ${v.sm} ${v.sm} 0;font-family:${u.sans};font-size:12px;color:${n.bone};`,ne(b.text)))}t.appendChild(h)}let _=O("div","");P.tab==="company"?xm(i,_):P.tab==="acq"?wm(i,_):P.tab==="dispo"?km(i,_):P.tab==="marketing"?Em(i,_):P.tab==="tc"?$m(i,_):Tm(i,_),t.appendChild(_)},mt=null,Cm=()=>{let e=K();if(e){try{fetch(_m,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mode:"sync",tenant_id:e})}).catch(()=>{})}catch{}mt&&window.clearTimeout(mt),mt=window.setTimeout(()=>{mt=null,P.open&&(P.cache.clear(),ct(!0))},9e4)}},Qn=()=>{if(document.getElementById(gr))return;P.open=!0,Cm();let e=O("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${u.sans};`);e.id=gr;let t=O("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=O("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(O("div",`font-family:${u.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=O("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${v.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=Ai,o.appendChild(r),t.appendChild(o),t.appendChild(O("div","","")).setAttribute("data-ws-analytics-controls","1"),e.appendChild(t);let a=O("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),e.appendChild(a),document.body.appendChild(e),document.addEventListener("keydown",Si),pt(),P.data||ct()},Si=e=>{e.key==="Escape"&&Ai()},Ai=()=>{P.open=!1,mt&&(window.clearTimeout(mt),mt=null),document.getElementById(gr)?.remove(),document.removeEventListener("keydown",Si)},Lm=["/kpis","ws-kpis","ws-analytics"],Sm=/\/custom-menu-link\//,Yn=!1,Ti=()=>{if(Yn||!Sm.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Lm.some(i=>s.includes(i))});if(r){Yn=!0,p.info(`[analytics] custom-menu-link route detected (src=${r.src}) \u2014 opening overlay`);try{history.back()}catch{}setTimeout(()=>{Qn(),Yn=!1},50);return}e<10&&setTimeout(t,150)};t()},Ci=!1,Ii=()=>{if(Ci)return;Ci=!0,ve(()=>setTimeout(Ti,50)),Ti();let e=()=>{let t=window.location.hash.replace("#","");(t==="ws-analytics"||t==="ws-kpis")&&Qn()};window.addEventListener("hashchange",e),e(),window.WS_CRM_OPEN_ANALYTICS=()=>Qn(),p.info("[analytics] mounted (menu-link route + hash + window trigger)")};var Pi="ws-buybox-nav-icon",ta="ws-buybox-panel",Mi="ws-buybox-modal",Am="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",oa="https://mcclivetim.github.io/reinvest-os-cdn/geo",xr=null,_o=null,vo=null,ea=async()=>{if(xr)return xr;try{let e=await fetch(`${oa}/states.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);return xr=await e.json(),xr}catch(e){return p.error("[buy-box] failed to fetch states.json",e),[]}},Im=async e=>{if(!_o)try{let t=await fetch(`${oa}/counties.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);_o=await t.json()}catch(t){return p.error("[buy-box] failed to fetch counties.json",t),[]}return _o?.[e]??[]},Mm=async e=>{if(!vo)try{let t=await fetch(`${oa}/cities.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);vo=await t.json()}catch(t){return p.error("[buy-box] failed to fetch cities.json",t),[]}return vo?.[e]??[]},ra=async e=>await(await fetch(Am,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json(),Om=(e,t)=>ra({tenant_id:e,action:"list",buyer_contact_id:t}),Pm=(e,t,o,r)=>ra({tenant_id:e,action:"add",buyer_contact_id:t,geo_level:o,geo_value:r}),Bm=(e,t)=>ra({tenant_id:e,action:"remove",entry_id:t}),G=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Hm=(e,t)=>{let o=t.find(r=>r.code===e);return o?`${o.name} (${e})`:e},Rm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Dm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Fm="nav.w-13, nav[class*='w-13']",zm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Nm=async()=>{try{return await M(Fm,{timeoutMs:2500})}catch{return null}},qm=async()=>{try{return await M(zm,{timeoutMs:2500})}catch{return null}},Um=e=>e.querySelector("div[class*='bg-contacts-panel']")??null,jm=(e,t)=>{let o=document.createElement("div");return o.id=ta,o.dataset.buyerContactId=t,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Vm(e,t,()=>na(e,t))}),o},na=async(e,t)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Om(e,t),ea()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Wm(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,e,t)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Wm=(e,t,o,r,a)=>{if(t.state.length+t.county.length+t.city.length+t.zip.length===0){e.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>t[l.key].length>0).map(l=>{let c=t[l.key].map(m=>{let _=l.key==="state"?Hm(m.geo_value,o):m.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${G(_)}</span>
              <button type="button" data-entry-id="${G(m.id)}" data-entry-label="${G(_)}" class="ws-buybox-remove" aria-label="Remove ${G(_)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${v.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${Dm}</button>
            </div>
          `}).join("");return`
        <div style="margin-bottom: 18px;">
          <div style="font-family: ${u.mono}; font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase; color: ${n.ash}; margin-bottom: 6px;">${G(l.label)} (${t[l.key].length})</div>
          ${c}
        </div>
      `}).join("");e.innerHTML=d,e.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Bm(r,c).then(_=>{if(!_.ok){alert(`Failed to remove: ${_.error||"unknown error"}`),l.disabled=!1;return}na(r,a)}).catch(_=>{alert(`Network error: ${_.message}`),l.disabled=!1}))})})},wr=!1,Bi=(e,t)=>{wr=t;let o=Um(e.panelArea);console.log(`[buy-box] setActive(${t}) \u2014 nativePanel=${!!o} panel=${!!e.panel} iconBtn=${!!e.iconBtn}`),t?(e.iconBtn.className=Gm,e.iconBtn.dataset.active="true",o&&(e.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),e.panel.style.display="flex",na(e.tenantId,e.buyerContactId)):(e.iconBtn.className=Hi,delete e.iconBtn.dataset.active,e.panel.style.display="none",o&&(o.style.display=e.nativePanelOriginalDisplay||""))},Hi="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Gm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Km=e=>{let t=document.createElement("button");return t.id=Pi,t.type="button",t.title="Buy-Box",t.setAttribute("aria-label","Buy-Box"),t.className=Hi,t.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Rm.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,t.addEventListener("click",o=>{o.stopPropagation();let r=e();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!wr;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Bi(r,a)}),t},Vm=(e,t,o)=>{let r=document.getElementById(Mi);r&&r.remove();let a=document.createElement("div");a.id=Mi,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await ea();s.innerHTML=_(w),h(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=x(),E();else if(i.granularity==="state"){let w=await ea();s.innerHTML=f(w),k(w)}else i.granularity==="county"?(s.innerHTML=b(i.stateCode||""),await Im(i.stateCode||""),s.innerHTML=g("County"),y()):i.granularity==="city"&&(s.innerHTML=b(i.stateCode||""),await Mm(i.stateCode||""),s.innerHTML=g("City"),y())},l=()=>`
  ...
  `,_=w=>`
    ...
    <div id="ws-buybox-state-list" style="max-height: 280px; overflow-y: auto; border: 1px solid ${n.steel}; border-radius: ${v.sm};">
      ${w.map($=>`
        <div data-state-code="${G($.code)}" class="ws-buybox-state-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${G($.name)} <span style="color: ${n.ash}; font-family: ${u.mono}; font-size: 11px;">(${G($.code)})</span>
        </div>
      `).join("")}
    </div>
  ...
  `,h=w=>{let $=s.querySelector("#ws-buybox-state-search"),S=s.querySelectorAll(".ws-buybox-state-row");S.forEach(A=>{A.addEventListener("mouseenter",()=>{A.style.background=n.emeraldGlow}),A.addEventListener("mouseleave",()=>{A.style.background="transparent"}),A.addEventListener("click",()=>{i.stateCode=A.dataset.stateCode||"",i.step=3,d()})}),$?.addEventListener("input",()=>{let A=($.value||"").toLowerCase().trim();w.forEach((N,j)=>{let W=S[j];if(!W)return;let q=!A||N.name.toLowerCase().includes(A)||N.code.toLowerCase()===A;W.style.display=q?"":"none"})}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>$?.focus(),0)},b=w=>`
  ...
  `,f=w=>{let $=w.find(S=>S.code===i.stateCode);return`
      ...
      <div style="background: ${n.emeraldGlow}; border: 1px solid ${n.emeraldBorder}; border-radius: ${v.md}; padding: 16px; margin-bottom: 20px;">
        <div style="font-size: 22px; font-weight: 500;">${G($?$.name:i.stateCode||"")}</div>
        <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">This buyer will match every property in ${$?G($.name):""} regardless of county / city / zip.</div>
      </div>
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; gap: 8px;">
          <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; padding: 8px 18px; cursor: pointer; font-family: ${u.sans}; font-size: 13px;">Close</button>
          <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${v.sm}; padding: 8px 22px; cursor: pointer; font-family: ${u.sans}; font-size: 13px; font-weight: 600;">Add ${$?G($.name):"State"}</button>
        </div>
      </div>
    `},k=w=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>C(i.stateCode||""))},g=w=>{let $=i.granularity==="county"?_o?.[i.stateCode||""]??[]:vo?.[i.stateCode||""]??[];return`
      <div style="font-family: ${u.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${G(w)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${$.length.toLocaleString()} ${G(w).toLowerCase()}s in ${G(i.stateCode||"")}.</div>
    ...
    `},y=()=>{let w=i.granularity==="county"?_o?.[i.stateCode||""]??[]:vo?.[i.stateCode||""]??[],$=s.querySelector("#ws-buybox-value-search"),S=s.querySelector("#ws-buybox-value-list");if(!$||!S)return;let A=N=>{let j=N.toLowerCase().trim();if(!j){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(q=>q.toLowerCase().includes(j)).slice(0,50);if(W.length===0){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}S.innerHTML=W.map(q=>`
        <div data-value="${G(q)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${G(q)}
        </div>
      `).join(""),S.querySelectorAll(".ws-buybox-value-row").forEach(q=>{q.addEventListener("mouseenter",()=>{q.style.background=n.emeraldGlow}),q.addEventListener("mouseleave",()=>{q.style.background="transparent"}),q.addEventListener("click",()=>{i.value=q.dataset.value||"",C(i.value)})})};$.addEventListener("input",()=>A($.value)),A(""),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>$.focus(),0)},x=()=>`
  ...
  `,E=()=>{let w=s.querySelector("#ws-buybox-zip"),$=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),$&&($.textContent="")}),w.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),T())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void T()),setTimeout(()=>w.focus(),0))},T=async()=>{let w=s.querySelector("#ws-buybox-zip"),$=s.querySelector("#ws-buybox-err"),S=(w?.value||"").trim();if(!/^\d{5}$/.test(S)){$&&($.textContent="Zip must be exactly 5 digits.");return}await C(S)},C=async w=>{if(!i.granularity||!w)return;let $=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),$&&($.textContent="");try{let A=await Pm(e,t,i.granularity,w);if(!A.ok){$&&($.textContent=A.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(A){$&&($.textContent=`Network error: ${A.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},Xn=!1,$t=null,yo=null,Oi=()=>{document.getElementById(Pi)?.remove(),document.getElementById(ta)?.remove(),yo&&$t&&$t.nav.removeEventListener("click",yo,!0),yo=null,$t=null,wr=!1},Ri=()=>{Ym()},Ym=async()=>{if(!Xn){Xn=!0;try{let e=D();if(!e){Oi();return}let t=document.getElementById(ta);if(t&&t.dataset.buyerContactId===e.contactId&&$t)return;Oi();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(_){p.warn("[buy-box] Contact Type fetch failed",_);return}if(Ae(o)!=="buyer")return;if(!e.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([Nm(),qm()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==e.contactId)return;let d=jm(e.locationId,e.contactId),l=Km(()=>$t),c={buyerContactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};$t=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),yo=_=>{let h=_.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&wr&&Bi(c,!1)},a.addEventListener("click",yo,!0),p.info(`[buy-box] right-rail mount complete for buyer ${e.contactId}`)}finally{Xn=!1}}};var zi="ws-properties-nav-icon",la="ws-properties-panel",Di="ws-properties-modal",da="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",Jm=`${da}/list-for-contact`,Qm=`${da}/create-with-opp`,Zm=`${da}/add-contact`,Xm=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],be=e=>(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),eb=(e,t)=>`/v2/location/${e}/objects/property/list?recordId=${t}`,Ni=e=>{if(e==null||e==="")return null;let t=Number(String(e).replace(/[^0-9.\-]/g,""));return Number.isFinite(t)&&t!==0?t:null},kr=e=>{let t=Ni(e);if(t===null)return"&mdash;";let o=Math.abs(t);return o>=1e6?`$${(t/1e6).toFixed(t%1e6?1:0)}M`:o>=1e3?`$${Math.round(t/1e3)}k`:`$${Math.round(t)}`},aa=e=>{let t=Ni(e);return t===null?"&mdash;":t.toLocaleString()},qi={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},tb=e=>{let t=(e||"").toString().trim();return t?be(qi[t]||t.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},ob=e=>{let t=(e||"").toString().trim();return t?qi[t]||t:""},rb={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},nb=e=>{let t=(e||"").toString().trim();return t?rb[t]||t.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Ke=(e,t,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${e}</div><div title="${be(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${t}</div></div>`,ab=e=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Ke("Baths",aa(e.baths))}
    ${Ke("Sq Ft",aa(e.sqft))}
    ${Ke("Rehab",tb(e.rehab_level),ob(e.rehab_level))}
    ${Ke("ARV",kr(e.arv))}
    ${Ke("IMV",kr(e.imv))}
    ${Ke("MAO",kr(e.mao))}
    ${Ke("Ask",kr(e.asking_price))}
  </div>`,Ui=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},sb='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',ib='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',lb="nav.w-13, nav[class*='w-13']",db=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ji="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",cb="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",pb=async()=>{try{return await M(lb,{timeoutMs:2500})}catch{return null}},mb=async()=>{try{return await M(db,{timeoutMs:2500})}catch{return null}},ca=async(e,t)=>await(await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"})).json(),Ie=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:13px;outline:none;margin-bottom:10px;`,Me=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,pa=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${u.sans};font-size:13px;font-weight:600;`,Wi=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${u.sans};font-size:13px;`,bb=(e,t)=>{let o=document.createElement("div");return o.id=la,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${pa}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{hb(e,t,()=>ma(e,t))}),o},ma=async(e,t)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await ca(Jm,{tenant_id:e,contact_id:t});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${be(r.error||"Failed to load properties")}</div>`;return}ub(o,r.properties||[],e,t)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${be(r.message)}</div>`}},ub=(e,t,o,r)=>{if(!t.length){e.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}e.innerHTML=t.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${be(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${be(c||"")}${a.property_type?" &middot; "+be(nb(a.property_type)):""}</div>
        ${ab(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${be(a.property_record_id)}" data-addr="${be(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${u.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${ib} Add person</button>
        </div>
      </div>
    `}).join(""),e.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{_b(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>ma(o,r))})}),e.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(eb(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},Gi=()=>{document.getElementById(Di)?.remove();let e=document.createElement("div");e.id=Di,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`;let t=document.createElement("div");return t.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,e.appendChild(t),document.body.appendChild(e),e.addEventListener("click",o=>{o.target===e&&e.remove()}),{overlay:e,card:t}},hb=(e,t,o)=>{let{overlay:r,card:a}=Gi();a.innerHTML=`
    ...
    <label style="${Me}">Street address</label>
    <input id="wp-address" type="text" style="${Ie}" placeholder="123 Main St" />
    <div style="display:flex;gap:10px;">
      <div style="flex:2;"><label style="${Me}">City</label><input id="wp-city" type="text" style="${Ie}" /></div>
      <div style="flex:1;"><label style="${Me}">State</label><input id="wp-state" type="text" maxlength="2" style="${Ie}" placeholder="NC" /></div>
      <div style="flex:1;"><label style="${Me}">Zip</label><input id="wp-zip" type="text" maxlength="10" style="${Ie}" /></div>
    </div>
    <label style="${Me}">Property type (optional)</label>
    <select id="wp-type" style="${Ie}">
      <option value="">\u2014 select \u2014</option>
      ${Xm.map(i=>`<option value="${be(i)}">${be(i)}</option>`).join("")}
    </select>
    <div id="wp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wp-cancel" type="button" style="${Wi}">Cancel</button>
      <button id="wp-save" type="button" style="${pa}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=b=>(a.querySelector(b)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),_=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let h=a.querySelector("#wp-save");h&&(h.disabled=!0,h.textContent="Creating\u2026"),s&&(s.textContent="");try{let b=await ca(Qm,{tenant_id:e,contact_id:t,address:d,city:l,state:c,zip:m,property_type:_||void 0});if(!b.ok){s&&(s.textContent=b.error||"Failed to create property."),h&&(h.disabled=!1,h.textContent="Create property + deal");return}r.remove(),Ui("Property + deal created \u2713"),o()}catch(b){s&&(s.textContent=`Network error: ${b.message}`),h&&(h.disabled=!1,h.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},_b=(e,t,o,r)=>{let{overlay:a,card:s}=Gi();s.innerHTML=`
    ...
    <label style="${Me}">Role</label>
    <select id="wpp-role" style="${Ie}">
      <option value="seller_2">Second seller</option>
      <option value="tenant_contact">Tenant</option>
    </select>
    <div style="display:flex;gap:10px;">
      <div style="flex:1;"><label style="${Me}">First name</label><input id="wpp-first" type="text" style="${Ie}" /></div>
      <div style="flex:1;"><label style="${Me}">Last name</label><input id="wpp-last" type="text" style="${Ie}" /></div>
    </div>
    <label style="${Me}">Phone (optional)</label>
    <input id="wpp-phone" type="text" style="${Ie}" placeholder="+1..." />
    <label style="${Me}">Email (optional)</label>
    <input id="wpp-email" type="text" style="${Ie}" />
    <div id="wpp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${Wi}">Cancel</button>
      <button id="wpp-save" type="button" style="${pa}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=f=>(s.querySelector(f)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),_=l("#wpp-phone"),h=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let b=s.querySelector("#wpp-save");b&&(b.disabled=!0,b.textContent="Adding\u2026"),i&&(i.textContent="");try{let f=await ca(Zm,{tenant_id:e,property_record_id:t,role:d,new_contact:{firstName:c,lastName:m,phone:_||void 0,email:h||void 0}});if(!f.ok){i&&(i.textContent=f.error||"Failed to add person."),b&&(b.disabled=!1,b.textContent="Add person");return}a.remove(),Ui("Person added \u2713"),r()}catch(f){i&&(i.textContent=`Network error: ${f.message}`),b&&(b.disabled=!1,b.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},Er=!1,_e=null,sa=!1,go=null,vb=(e,t,o)=>{let r=t.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;e.style.top=`${d}px`,e.style.height=`${l}px`,e.style.width=`${i}px`,e.style.left=`${Math.round(r.left-i-c)}px`,e.style.right="auto",e.style.bottom="auto"},yb=()=>{try{let e=new URL(window.location.href);e.searchParams.get("view")!=="activities"&&(e.searchParams.set("view","activities"),history.replaceState(history.state,"",e.toString()))}catch{}},ia=(e,t)=>{Er=t,t?(e.iconBtn.className=cb,e.iconBtn.dataset.active="true",yb(),vb(e.panel,e.nav,e.panelArea),e.panel.style.display="flex",ma(e.tenantId,e.contactId)):(e.iconBtn.className=ji,delete e.iconBtn.dataset.active,e.panel.style.display="none")},gb=()=>{let e=document.createElement("button");return e.id=zi,e.type="button",e.title="Properties",e.setAttribute("aria-label","Properties"),e.className=ji,e.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${sb.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,e.addEventListener("click",t=>{t.stopPropagation(),_e&&ia(_e,!Er)}),e},Fi=()=>{document.getElementById(zi)?.remove(),document.getElementById(la)?.remove(),go&&_e&&_e.nav.removeEventListener("click",go,!0),go=null,_e=null,Er=!1},Ki=()=>{fb()},fb=async()=>{if(!sa){sa=!0;try{let e=D();if(!e||!e.locationId){Fi();return}let t=document.getElementById(la);if(t&&t.dataset.contactId===e.contactId&&_e)return;Fi();let o=null;try{o=await Se(e.contactId,e.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Ae(o)!=="seller")return;let[a,s]=await Promise.all([pb(),mb()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==e.contactId)return;let d=bb(e.locationId,e.contactId),l=gb();_e={contactId:e.contactId,tenantId:e.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{_e&&ia(_e,!1)}),go=m=>{let _=m.target;!_||_e&&_e.iconBtn.contains(_)||_.closest("button.sidebar-option-button")&&Er&&_e&&ia(_e,!1)},a.addEventListener("click",go,!0),p.info(`[properties] right-rail mount complete for seller ${e.contactId}`)}finally{sa=!1}}};var Vi="ws-non-seller-contact",Yi=()=>{xb()},xb=async()=>{let e=D();if(!e||!e.contactId||!e.locationId){document.documentElement.classList.remove(Vi);return}let t="seller";try{t=Ae(await Se(e.contactId,e.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(Vi,t!=="seller")};var Ve="ws-crm-claim-release-pill",wb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",kb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Eb=async e=>{let t=await fetch(wb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Get returned ${t.status} ${t.statusText}`);return await t.json()},$b=async e=>{let t=await fetch(kb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,contact_id:e.contactId,triggered_by_user_id:e.userId,action:e.action}),credentials:"omit"});if(!t.ok)throw new Error(`Claim/Release Set returned ${t.status} ${t.statusText}`);return await t.json()},Zi=e=>{let t=Array.from(e.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return t?t.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ct=(e,t)=>{let o=t==="claim"?"emerald":"amber",r=t==="claim"?n.emerald:n.amber;e.dataset.mode=t,e.style.cssText=gi(o),e.title=t==="claim"?"Take ownership of this lead":"Return this lead to the pool",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Tb=({contactId:e,mode:t})=>{let o=document.createElement("button");return o.id=Ve,o.type="button",o.dataset.contactId=e,Ct(o,t),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==e)return;let s=H();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>Ct(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${e} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";Ct(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await $b({contactId:e,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;Ct(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),Ct(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Ji=async e=>{try{let t=await Eb({contactId:e.contactId,locationId:e.locationId,userId:H()}),o=document.getElementById(Ve);if(!o||o.dataset.contactId!==e.contactId)return;let r=t?.mode==="release"?"release":"claim";Ct(o,r)}catch(t){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Cb=async(e,t=1e4)=>{let o=Date.now();for(;Date.now()-o<t;){let r=Zi(e);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Qi=(e,t)=>{let o=Tb({contactId:t,mode:"claim"}),r=document.createElement("span");r.id=`${Ve}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),e.appendChild(r)},Tt=null,Lb=async()=>{let e=D();if(!e){Tt?.disconnect(),Tt=null,document.getElementById(Ve)?.remove();return}let t=document.getElementById(Ve);if(!(t&&t.dataset.contactId===e.contactId)){t&&t.remove();try{let o=await M("#record-details-lhs",{timeoutMs:1e4}),r=await Cb(o),a=D();if(!a||a.contactId!==e.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Qi(r,e.contactId),p.debug(`Mounted Claim/Release pill next to name for ${e.contactId}`),document.getElementById(Ve)&&e.locationId&&Ji({contactId:e.contactId,locationId:e.locationId}),Tt?.disconnect(),Tt=new MutationObserver(async()=>{if(!(D()?.contactId===e.contactId)){Tt?.disconnect();return}if(document.getElementById(Ve))return;let d=Zi(o);d&&(Qi(d,e.contactId),document.getElementById(Ve)&&e.locationId&&Ji({contactId:e.contactId,locationId:e.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),Tt.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Xi=()=>{Lb()};var sl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Sb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",Ab="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Ib=async({contactId:e,locationId:t,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||sl,l;if(i==="buyer"){let m=dl.find(h=>h.label===o),_=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:t,contact_id:e,new_status:_,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:e,location:{id:t},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Mb=async({contactId:e,tenantId:t})=>{let o=await fetch(Ab,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},Lt="ws-crm-contact-actions-bar",il="ws-crm-call-status-dropdown",ll="ws-crm-call-status-menu",Tr="ws-crm-offer-made-modal",el=!1,Ob=()=>{el||(el=!0,document.addEventListener("click",e=>{let t=document.getElementById(ll);if(!t||t.style.display==="none")return;let o=document.getElementById(il);o&&!o.contains(e.target)&&(t.style.display="none")}))},Pb=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"no-show",label:"No Show",color:"orange"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],dl=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Bb=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Hb=async()=>{for(let e of Bb)try{let t=await M(e,{timeoutMs:2e3});if(t)return p.debug(`[actions-bar] mount target found via selector: ${e}`),t}catch{}try{let e=await M("#contact-conversation-panel",{timeoutMs:2e3});if(e.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),e.parentElement}catch{}for(let e of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let t=await M(e,{timeoutMs:1500});if(t)return p.debug(`[actions-bar] mount target via fallback: ${e}`),t.parentElement??t}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Rb=({contactId:e,kind:t})=>{let o=t==="buyer"?dl:Pb,r=t==="buyer"?Sb:sl,a=t==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=il,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=B,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=ll,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${qn[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${e}`);let m=i.firstElementChild,_=i.children[1],h=i.children[2];m&&(m.style.background=qn[l.color]),_&&(_.textContent=l.label),d.style.display="none";let f=D()?.locationId,k=H();if(!f){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),_&&(_.textContent=`${l.label} (no tenant!)`),_&&(_.style.color=n.amber);return}if(t==="seller"&&l.color==="green"&&!k){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),_&&(_.textContent=`${l.label} (no user!)`),_&&(_.style.color=n.amber);return}let g=h?.textContent??"\u25BE",y=async x=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await Ib({contactId:e,locationId:f,status:l.label,userId:k,deadReason:x,webhookUrl:r,kind:t}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=g),i.style.opacity="1"},900)}catch(E){p.warn("Call Status webhook failed:",E),h&&(h.textContent="\u2717"),_&&(_.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=g),_&&(_.style.color=n.bone)},1800)}};if(t==="seller"&&l.value==="dead-deal"){let x=_?.textContent??"";Ub(E=>{y(E)},()=>{_&&(_.textContent=x)});return}if(t==="seller"&&l.value==="appointment-booked"){let x=_?.textContent??"";try{(await Mb({contactId:e,tenantId:f})).ok?await y():jb(()=>{y()},()=>{_&&(_.textContent=x)})}catch(E){p.warn("Appointment sanity check failed; firing anyway:",E),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Ob(),s.appendChild(i),s.appendChild(d),s},Db="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Fb=async e=>{let t=await fetch(Db,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,kind:e.kind,amount:e.amount,expires_at:e.expiresAt,triggered_by_user_id:e.userId,opp_id:e.oppId??void 0,property_record_id:e.propertyRecordId??void 0,asking_price:e.askingPrice??void 0}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},zb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",ua=e=>(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),Nb=async(e,t)=>{let o=await fetch(zb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},qb=e=>new Promise(t=>{document.getElementById(Tr)?.remove();let o=document.createElement("div");o.id=Tr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=e.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${u.sans};">
        <div style="font-size:14px;font-weight:500;">${ua(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${ua(i.dealStage)}</div>`:""}
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),_=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",h=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${ua(o.address)}</strong></div>`:"",b=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",f=r&&o&&o.propertyRecordId?`
  ...
  `,d.appendChild(l),document.body.appendChild(d);let k=()=>d.remove();d.addEventListener("click",E=>{E.target===d&&k()});let g=l.querySelector("#ws-offer-error"),y=l.querySelector("#ws-offer-cancel"),x=l.querySelector("#ws-offer-submit");y?.addEventListener("click",k),x?.addEventListener("click",async()=>{let E=(l.querySelector("#ws-offer-amount")?.value??"").trim(),T=r?l.querySelector("#ws-offer-expires")?.value??"":"";if(!E||Number(E)<=0){g&&(g.textContent="Enter a positive offer amount."),p.warn("Offer Made submit blocked \u2014 invalid amount");return}let C=Number(E);if(C<100){g&&(g.textContent=`That looks low \u2014 did you mean $${(C*1e3).toLocaleString("en-US")}?`);return}let $=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),S=$?$[1]:null;if(!S){g&&(g.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}g&&(g.textContent=""),x&&(x.disabled=!0,x.textContent="Recording\u2026",x.style.opacity="0.7"),y&&(y.disabled=!0);try{let A=(l.querySelector("#ws-offer-asking")?.value??"").trim(),N=A?Number(A):null,j=await Fb({tenantId:S,contactId:e,kind:t,amount:C,expiresAt:T||null,userId:H(),oppId:o?.oppId??null,propertyRecordId:o?.propertyRecordId??null,askingPrice:N&&N>0?N:null});if(!j.ok){g&&(g.textContent=j.error??"Something went wrong."),x&&(x.disabled=!1,x.textContent="Record Offer",x.style.opacity="1"),y&&(y.disabled=!1);return}p.info(`Offer Made (${t}) recorded for contact ${e}: $${C} on ${j.opp_pipeline} opp (stage: ${j.opp_stage_name??"?"})`),k()}catch(A){p.error("Offer Made webhook failed",A),g&&(g.textContent=A instanceof Error?A.message:"Network error \u2014 try again."),x&&(x.disabled=!1,x.textContent="Record Offer",x.style.opacity="1"),y&&(y.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},tl="ws-crm-dead-deal-modal",Ub=(e,t)=>{document.getElementById(tl)?.remove();let o=document.createElement("div");o.id=tl,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),t()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),e()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},rl=(e,t)=>{let o=document.createElement("div");if(o.id=Lt,o.dataset.contactId=e,o.dataset.contactKind=t,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,t==="seller"||t==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=B,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(t!=="seller"){fo(e,t);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){fo(e,t);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await Nb(s,e)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),fo(e,t);return}if(d(),l.length<=1){fo(e,t,l[0]);return}let c=await qb(l);c&&fo(e,t,c)}),o.appendChild(r),o.appendChild(Rb({contactId:e,kind:t}))}return o},ba=!1,nl=()=>{document.querySelectorAll(`[id="${Lt}"]`).forEach(e=>e.remove())},cl=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),ba){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}ba=!0;try{await Wb()}finally{ba=!1}},Wb=async()=>{let e=D();if(!e){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),nl();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${e.contactId} locationId=${e.locationId??"(null)"} source=${e.source}`),e.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),nl();return}let t="seller";try{let l=await Se(e.contactId,e.locationId),c=Ae(l);c==="buyer"?t="buyer":c==="other"&&(t="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${t} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==e.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Lt}"]`));if(r.length===1&&r[0].dataset.contactId===e.contactId&&r[0].dataset.contactKind===t){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${e.contactId} kind=${t} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Hb();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==e.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=rl(e.contactId,t)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(Lt)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${e.contactId} kind=${t}`),$r?.disconnect(),$r=new MutationObserver(()=>{if(!(D()?.contactId===e.contactId)){$r?.disconnect();return}let c=document.querySelectorAll(`[id="${Lt}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,_=rl(e.contactId,t);_.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(_,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${e.contactId}`)}catch(h){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",h)}}}),$r.observe(a,{childList:!0})},$r=null,al=null,Gb=()=>{al===null&&(al=window.setInterval(()=>{let e=D();e&&(document.getElementById(Lt)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",e.contactId),cl()))},3e3))},pl=()=>{Gb(),cl()};var Cr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Kb=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),xo="data-ws-crm-favicon",ha=e=>e.hasAttribute(xo),ml=e=>{if(e.tagName!=="LINK")return!1;let t=(e.getAttribute("rel")??"").toLowerCase();return Kb.has(t)},Lr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{ml(r)&&!ha(r)&&r.remove()});let t=document.head.querySelector(`link[${xo}="1"]`);t?t.href!==Cr&&(t.href=Cr):(t=document.createElement("link"),t.setAttribute(xo,"1"),t.rel="icon",t.type="image/png",t.href=Cr,document.head.appendChild(t),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${xo}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(xo,"apple"),o.rel="apple-touch-icon",o.href=Cr,document.head.appendChild(o))},bl=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Lr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Lr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ml(i)&&!ha(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ha(i)&&(a=!0)});a&&Lr()}).observe(document.head,{childList:!0,subtree:!1});let t=0,o=window.setInterval(()=>{t+=1,Lr(),t>=5&&window.clearInterval(o)},1e3)};var Z=".crm-opportunities-modal .ui-modal-heading .description",ul=new Map,_a=null,va,Vb=()=>{let e=new Map;for(let[t,{selector:o,cb:r}]of ul){let a=e.get(o);if(a===void 0&&(a=!!document.querySelector(o),e.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${t}" threw`,s)}}},V=(e,t,o)=>{ul.set(e,{selector:t,cb:o}),!_a&&(_a=new MutationObserver(()=>{va===void 0&&(va=window.setTimeout(()=>{va=void 0,Vb()},300))}),_a.observe(document.body,{childList:!0,subtree:!0}))};var Yb=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Jb=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Qb=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let e=document.querySelector(Qb);if(!e)return null;let t=e.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of t){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Jb);if(a){let s=a[1];if(Yb.includes(s))return s}}return null},X=async(e=2500)=>{let t=Date.now();for(;Date.now()-t<e;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var hl="ws-crm-dispo-action-row",Y=e=>{let t=document.getElementById(hl);if(t)return t;e.classList.contains("description")&&(e.style.display="flex",e.style.alignItems="center",e.style.gap="12px",e.style.flexWrap="wrap");let o=document.createElement("span");return o.id=hl,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",e.appendChild(o),o};var Zb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",xe="ws-crm-mt-offer-made-button",_l="ws-crm-mt-offer-made-modal",Xb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,eu=/\/v2\/location\/([A-Za-z0-9]+)/,Ir=()=>{let e=window.location.pathname,t=e.match(Xb),o=t?t[1]:Le();if(!o)return null;let r=e.match(eu);return{oppId:o,locationId:r?r[1]:null}},tu=async e=>{let t=await fetch(Zb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,kind:"buyer",amount:e.amount,triggered_by_user_id:e.userId}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},Sr=()=>{document.getElementById(_l)?.remove()},ou=e=>{Sr();let t=document.createElement("div");t.id=_l,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=Ir();!o||!o.locationId||o.oppId!==e||ou({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=t.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),t.style.background=n.emeraldGlow,t.style.color=n.emeraldBright,t.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",t.style.cssText=B)},4e3)}})}),t},nu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],au=async()=>{for(let e of nu)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Ar=!1,ga=async()=>{if(!Ar){Ar=!0;try{await su()}finally{Ar=!1}}},su=async()=>{let e=Ir();if(!e||!e.locationId){document.getElementById(xe)?.remove(),document.getElementById(`${xe}-wrap`)?.remove(),ko();return}let t=document.getElementById(xe);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${xe}-wrap`)?.remove(),ko());return}t&&(t.remove(),document.getElementById(`${xe}-wrap`)?.remove());let o=await au();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ir();if(!a||a.oppId!==e.oppId)return;let s=ru(e.oppId),i=document.createElement("span");i.id=`${xe}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${e.oppId}`),iu(e.oppId)},wo=null,ya=null,St,ko=()=>{wo?.disconnect(),wo=null,ya=null,St!==void 0&&(window.clearTimeout(St),St=void 0)},iu=e=>{if(wo&&ya===e)return;ko();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(ya=e,wo=new MutationObserver(()=>{St===void 0&&(St=window.setTimeout(()=>{St=void 0;let o=Ir();if(!o||o.oppId!==e){ko();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(xe)?.remove(),document.getElementById(`${xe}-wrap`)?.remove(),ko();return}document.getElementById(xe)||ga()},250))}),wo.observe(t,{childList:!0,subtree:!0}))},lu=()=>{V("mt-offer-made",Z,()=>{!document.getElementById(xe)&&!Ar&&ga()})},vl=()=>{lu(),ga()};var du="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",we="ws-crm-not-interested-button",cu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,pu=/\/v2\/location\/([A-Za-z0-9]+)/,Or=()=>{let e=window.location.pathname,t=e.match(cu),o=t?t[1]:Le();if(!o)return null;let r=e.match(pu);return{oppId:o,locationId:r?r[1]:null}},mu=async e=>{let t=await fetch(du,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Not Interested webhook returned ${t.status} ${t.statusText}`);return await t.json()},bu=e=>{let t=document.createElement("button");return t.id=we,t.type="button",t.dataset.oppId=e,t.style.cssText=B,t.title="Close this Marketing Tracker opp as Not Interested for THIS property only",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let o=Or();if(!o||!o.locationId||o.oppId!==e)return;let r=H(),a=t.querySelector(".ws-ni-label");t.disabled=!0,t.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await mu({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),t.style.background=n.crimsonGlow,t.style.color=n.crimson,p.info(`Not Interested set for opp ${e} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),t.disabled=!1,t.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),t},uu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hu=async()=>{for(let e of uu)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Mr=!1,xa=async()=>{if(!Mr){Mr=!0;try{await _u()}finally{Mr=!1}}},_u=async()=>{let e=Or();if(!e||!e.locationId){document.getElementById(we)?.remove(),document.getElementById(`${we}-wrap`)?.remove(),$o();return}let t=document.getElementById(we);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${we}-wrap`)?.remove(),$o());return}t&&(t.remove(),document.getElementById(`${we}-wrap`)?.remove());let o=await hu();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Or();if(!a||a.oppId!==e.oppId)return;let s=bu(e.oppId),i=document.createElement("span");i.id=`${we}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${e.oppId}`),vu(e.oppId)},Eo=null,fa=null,$o=()=>{Eo?.disconnect(),Eo=null,fa=null},vu=e=>{if(Eo&&fa===e)return;$o();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(fa=e,Eo=new MutationObserver(()=>{let o=Or();if(!o||o.oppId!==e){$o();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(we)?.remove(),document.getElementById(`${we}-wrap`)?.remove(),$o();return}document.getElementById(we)||xa()}),Eo.observe(t,{childList:!0,subtree:!0}))},yu=()=>{V("not-interested",Z,()=>{!document.getElementById(we)&&!Mr&&xa()})},yl=()=>{yu(),xa()};var gu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",ye="ws-crm-schedule-walkthrough-button",wa="ws-crm-schedule-walkthrough-modal",fu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xu=/\/v2\/location\/([A-Za-z0-9]+)/,Hr=()=>{let e=window.location.pathname,t=e.match(fu),o=t?t[1]:Le();if(!o)return null;let r=e.match(xu);return{oppId:o,locationId:r?r[1]:null}},Pr=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},wu=(e,t)=>{document.getElementById(wa)?.remove();let o=document.createElement("div");o.id=wa,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let i=()=>o.remove();o.addEventListener("click",l=>{l.target===o&&i()}),document.getElementById("wsw-cancel")?.addEventListener("click",i);let d=document.getElementById("wsw-submit");d?.addEventListener("click",async()=>{let l=document.getElementById("wsw-dt")?.value||"",c=document.getElementById("wsw-dur")?.value||"30";if(!l){Pr("Pick a date and time.","err");return}let m=new Date(l).toISOString();d.disabled=!0,d.textContent="Scheduling\u2026";try{if((await fetch(gu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,start_time:m,duration_min:Number(c)}),credentials:"omit"})).ok){i(),Pr("Walkthrough scheduled \u2713");let h=document.querySelector(`#${ye} .ws-sw-label`);h&&(h.textContent="Walkthrough Scheduled")}else d.disabled=!1,d.textContent="Schedule",Pr("Scheduling failed \u2014 try again.","err")}catch(_){p.warn("[schedule-walkthrough] failed:",_),d.disabled=!1,d.textContent="Schedule",Pr("Couldn't reach the scheduler. Try again.","err")}})},ku=e=>{let t=document.createElement("button");return t.id=ye,t.type="button",t.dataset.oppId=e,t.style.cssText=B,t.title="Schedule this buyer's property walkthrough",t.innerHTML=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let o=Hr();!o||!o.locationId||o.oppId!==e||wu(o.oppId,o.locationId)}),t},Eu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],$u=async()=>{for(let e of Eu)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Br=!1,Ea=async()=>{if(!Br){Br=!0;try{await Tu()}finally{Br=!1}}},Tu=async()=>{let e=Hr();if(!e||!e.locationId){document.getElementById(ye)?.remove(),document.getElementById(`${ye}-wrap`)?.remove(),Co();return}let t=document.getElementById(ye);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(t.remove(),document.getElementById(`${ye}-wrap`)?.remove(),Co());return}t&&(t.remove(),document.getElementById(`${ye}-wrap`)?.remove());let o=await $u();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Hr();if(!a||a.oppId!==e.oppId)return;let s=ku(e.oppId),i=document.createElement("span");i.id=`${ye}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${e.oppId}`),Cu(e.oppId)},To=null,ka=null,At,Co=()=>{To?.disconnect(),To=null,ka=null,At!==void 0&&(window.clearTimeout(At),At=void 0)},Cu=e=>{if(To&&ka===e)return;Co();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(ka=e,To=new MutationObserver(()=>{At===void 0&&(At=window.setTimeout(()=>{At=void 0;let o=Hr();if(!o||o.oppId!==e){Co();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ye)?.remove(),document.getElementById(`${ye}-wrap`)?.remove(),Co();return}document.getElementById(ye)||Ea()},250))}),To.observe(t,{childList:!0,subtree:!0}))},Lu=()=>{V("schedule-walkthrough",Z,()=>{!document.getElementById(ye)&&!Br&&Ea()})},gl=()=>{Lu(),Ea()};var Su="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",It="ws-crm-resend-deal-link-wrap",Au=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Iu=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=()=>{let e=window.location.pathname,t=e.match(Au),o=t?t[1]:Le();if(!o)return null;let r=e.match(Iu);return{oppId:o,locationId:r?r[1]:null}},Mu=async e=>{let t=await fetch(Su,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,mt_opp_id:e.oppId,channel:e.channel,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Resend webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Ou=e=>e.replace(/[<>&]/g,t=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[t]||t),fl=e=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${e};box-shadow:0 0 6px ${e};flex-shrink:0;"></span>`,Ta=(e,t)=>{e.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=B,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${fl(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Pu(e,t)),e.appendChild(o)},Pu=(e,t)=>{e.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Bu(e,t,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>Ta(e,t)),o.appendChild(i),e.appendChild(o)},Bu=async(e,t,o,r)=>{let a=Dr();if(!(!a||!a.locationId||a.oppId!==t)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Mu({oppId:a.oppId,locationId:a.locationId,channel:o,userId:H()});if(s?.ok)r.innerHTML=`${fl(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${t}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Ou(i)}</span>`}window.setTimeout(()=>Ta(e,t),3500)}},Hu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ru=async()=>{for(let e of Hu)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Rr=!1,Ca=async()=>{if(!Rr){Rr=!0;try{await Du()}finally{Rr=!1}}},Du=async()=>{let e=Dr();if(!e||!e.locationId){document.getElementById(It)?.remove(),So();return}let t=document.getElementById(It);if(t&&t.dataset.oppId===e.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(t.remove(),So());return}t&&t.remove();let o=await Ru();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Dr();if(!a||a.oppId!==e.oppId)return;let s=document.createElement("span");s.id=It,s.dataset.oppId=e.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Y(o).appendChild(s),Ta(s,e.oppId),p.debug(`Mounted Resend Deal Link button on opp ${e.oppId}`),Fu(e.oppId)},Lo=null,$a=null,So=()=>{Lo?.disconnect(),Lo=null,$a=null},Fu=e=>{if(Lo&&$a===e)return;So();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&($a=e,Lo=new MutationObserver(()=>{let o=Dr();if(!o||o.oppId!==e){So();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(It)?.remove(),So();return}document.getElementById(It)||Ca()}),Lo.observe(t,{childList:!0,subtree:!0}))},zu=()=>{V("resend-deal-link",Z,()=>{!document.getElementById(It)&&!Rr&&Ca()})},xl=()=>{zu(),Ca()};var Nu=e=>{let t=(o,r,a)=>o.style.setProperty(r,a,"important");e.querySelectorAll("input, textarea, select").forEach(o=>{if(o instanceof HTMLInputElement&&o.type==="checkbox")return;t(o,"background-color",n.obsidian),t(o,"color",n.bone),t(o,"-webkit-text-fill-color",n.bone),t(o,"border-color",n.steel);let r=o.previousElementSibling;r instanceof HTMLElement&&r.tagName==="DIV"&&(t(r,"color",n.bone),t(r,"-webkit-text-fill-color",n.bone))}),e.querySelectorAll("div").forEach(o=>{t(o,"background-color","transparent"),t(o,"border-style","none")})},Fr=(e,t=8e3)=>{let o=null,r=()=>{o?.disconnect(),Nu(e),o?.observe(e,{attributes:!0,attributeFilter:["style"],subtree:!0})};o=new MutationObserver(r),r(),window.setTimeout(()=>{o?.disconnect(),o=null},t)};var qu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/referred",Uu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/mt-opps",Pt="ws-crm-add-referral-wrap",zr="ws-crm-add-referral-contact-btn",Sa="ws-crm-contact-actions-bar",ge="ws-referral-modal",ju=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Wu=/\/v2\/location\/([A-Za-z0-9]+)/,De=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),El=e=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${e};box-shadow:0 0 6px ${e};flex-shrink:0;"></span>`,Gu=async e=>{try{return await navigator.clipboard.writeText(e),!0}catch{}try{let t=document.createElement("textarea");t.value=e,t.style.cssText="position:fixed;opacity:0;pointer-events:none;",document.body.appendChild(t),t.select();let o=document.execCommand("copy");return t.remove(),o}catch{return!1}},Ku=e=>{let t=e.trim();if(!t)return{ok:!0,value:""};let o=t.replace(/\D/g,"");return o.length===11&&o.startsWith("1")&&(o=o.slice(1)),o.length!==10?{ok:!1,value:""}:{ok:!0,value:`+1${o}`}},bt=`width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;`,Mt=e=>`<div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">${e}</div>`,Ma=e=>{document.getElementById(ge)?.remove();let t=document.createElement("div");t.id=ge,t.style.cssText=`
  ...
  `;let r=e.propertyLabel?`<div style="font-size: 12px; color: ${n.emeraldBright}; margin-bottom: 14px;">Property: ${De(e.propertyLabel)}</div>`:'<div style="margin-bottom: 14px;"></div>';o.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ${Mt("First Name *")}
        <input id="ws-ref-first" type="text" autocomplete="off" placeholder="Jane" style="${bt}">
      </div>
      <div>
        ${Mt("Last Name")}
        <input id="ws-ref-last" type="text" autocomplete="off" placeholder="Doe" style="${bt}">
      </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ${Mt("Phone")}
        <input id="ws-ref-phone" type="tel" autocomplete="off" placeholder="(555) 555-0100" style="${bt}">
      </div>
      <div>
        ${Mt("Email")}
        <input id="ws-ref-email" type="email" autocomplete="off" placeholder="jane@company.com" style="${bt}">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      ${Mt("Buyer Status")}
      <select id="ws-ref-status" style="${bt} cursor: pointer;">
    ...
    <div style="margin-bottom: 14px;">
      ${Mt("Note (optional)")}
      <textarea id="ws-ref-note" rows="2" autocomplete="off" placeholder="e.g. Husband makes the buying decisions \u2014 wife is on the deed" style="${bt} resize: vertical;"></textarea>
    </div>
  ...
  `,t.appendChild(o),document.body.appendChild(t),Fr(o),t.addEventListener("click",c=>{c.target===t&&t.remove()}),o.querySelector("#ws-ref-cancel")?.addEventListener("click",()=>t.remove());let a=o.querySelector("#ws-ref-first"),s=o.querySelector("#ws-ref-phone"),i=o.querySelector("#ws-ref-email"),d=o.querySelector("#ws-ref-send-label");window.setTimeout(()=>a?.focus(),0);let l=()=>{if(!d)return;let c=!!s?.value.trim(),m=!!i?.value.trim();d.textContent=!c&&m?"Email them the link now":"Text them the link now"};s?.addEventListener("input",l),i?.addEventListener("input",l),o.querySelector("#ws-ref-submit")?.addEventListener("click",async()=>{let c=o.querySelector("#ws-ref-err"),m=w=>{c&&(c.textContent=w)};m("");let _=(a?.value||"").trim(),h=(o.querySelector("#ws-ref-last")?.value||"").trim(),b=(s?.value||"").trim(),f=(i?.value||"").trim().toLowerCase(),k=o.querySelector("#ws-ref-status")?.value||"Unqualified",g=(o.querySelector("#ws-ref-note")?.value||"").trim(),y=o.querySelector("#ws-ref-send")?.checked??!0,x=o.querySelector("#ws-ref-close")?.checked??!1;if(!_){m("First name is required.");return}let E=Ku(b);if(!E.ok){m("Phone must be a 10-digit US number.");return}if(f&&!/.+@.+\..+/.test(f)){m("That email doesn't look valid.");return}if(!E.value&&!f){m("Add a phone or an email for the new buyer.");return}let T=o.querySelector("#ws-ref-submit");T&&(T.disabled=!0,T.textContent="Adding\u2026",T.style.opacity="0.7");let C=()=>{T&&(T.disabled=!1,T.textContent="Add Buyer",T.style.opacity="1")};try{let w=await fetch(qu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,referring_mt_opp_id:e.referringOppId,referred:{first_name:_,last_name:h,phone:E.value,email:f,buyer_status:k,note:g},send_link:y,close_original:x,triggered_by_user_id:H()||""}),credentials:"omit"});if(!w.ok)throw new Error(`Webhook returned ${w.status} ${w.statusText}`);let $=await w.json(),S=Array.isArray($)?$[0]:$;if(!S?.ok){m(S?.error||"Something went wrong \u2014 try again."),C();return}p.info(`Referral buyer added (opp ${S.mt_opp_id||"?"})`),Vu(o,S,e,`${_} ${h}`.trim())}catch(w){p.error("Add referral buyer failed",w),m(`Network error: ${w instanceof Error?w.message:"request failed"}`),C()}})},Ot=(e,t)=>{let o=t==="good"?n.emerald:t==="warn"?n.amber:n.ash;return`<span style="display:inline-flex;align-items:center;gap:6px;background:${t==="good"?n.emeraldGlow:"transparent"};border:1px solid ${o};border-radius:999px;padding:4px 12px;font-size:12px;color:${o};margin:0 6px 6px 0;">${e}</span>`},Vu=(e,t,o,r)=>{let a=[];t.contact_created===!1&&a.push(Ot("Existing buyer \u2014 profile reused","info")),t.mt_opp_deduped?a.push(Ot(`Existing deal reused${t.mt_opp_stage?` \u2014 ${De(t.mt_opp_stage)}`:""}`,"info")):t.mt_opp_created&&a.push(Ot(`Deal created${t.mt_opp_stage?` \u2014 ${De(t.mt_opp_stage)}`:""}`,"good")),t.sent?a.push(Ot(t.sent_channel==="email"?"Email sent \u2713":"Text sent \u2713","good")):t.send_error&&a.push(Ot(`Not sent \u2014 ${De(t.send_error)}`,"warn")),t.original_closed&&a.push(Ot("Original buyer's deal closed (Lost - Withdrew)","info"));let s=(t.warnings||[]).map(l=>`<div style="font-size:11px;color:${n.ash};margin-top:4px;">\xB7 ${De(l)}</div>`).join(""),i=t.link?`
      <div style="margin: 16px 0 4px;">
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Their personalized deal link</div>
        <span style="display:flex;gap:8px;align-items:center;">
          <input id="ws-ref-link" type="text" readonly value="${De(t.link)}" style="${bt} flex:1; font-family:${u.mono}; font-size:12px;">
    ...
    <div style="font-size: 17px; font-weight: 600; margin-bottom: 10px;">${De(r||"Buyer")} is set up</div>
  ...
  `,e.querySelector("#ws-ref-done")?.addEventListener("click",()=>{document.getElementById(ge)?.remove()}),e.querySelector("#ws-ref-another")?.addEventListener("click",()=>{Ma(o)});let d=e.querySelector("#ws-ref-copy");d?.addEventListener("click",async()=>{let l=await Gu(t.link||"");d.textContent=l?"Copied \u2713":"Copy failed",window.setTimeout(()=>{d.textContent="Copy"},2e3)})},Yu=e=>new Promise(t=>{document.getElementById(ge)?.remove();let o=document.createElement("div");o.id=ge,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=e.map((i,d)=>`
      <button type="button" class="ws-ref-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${u.sans};">
        <div style="font-size:14px;font-weight:500;">${De(i.property_address||"(no address)")}</div>
        ${i.stage_name?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${De(i.stage_name)}</div>`:""}
      </button>`).join("");r.innerHTML=`
      <div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin-bottom:8px;">Pick a Property</div>
      ...
      <div>${a}</div>
      <div style="display:flex;justify-content:flex-end;margin-top:8px;">
        <button id="ws-ref-pick-cancel" type="button" style="${B} padding:8px 16px;font-size:13px;">Cancel</button>
      </div>`,o.appendChild(r),document.body.appendChild(o);let s=i=>{o.remove(),t(i)};o.addEventListener("click",i=>{i.target===o&&s(null)}),r.querySelector("#ws-ref-pick-cancel")?.addEventListener("click",()=>s(null)),r.querySelectorAll(".ws-ref-pick").forEach(i=>{i.addEventListener("click",()=>s(e[Number(i.dataset.i)]??null))})}),Nr=()=>{let e=window.location.pathname,t=e.match(ju),o=t?t[1]:Le();if(!o)return null;let r=e.match(Wu);return{oppId:o,locationId:r?r[1]:null}},Ju=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qu=async()=>{for(let e of Ju)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},qr=!1,Aa=async()=>{if(!qr){qr=!0;try{await Zu()}finally{qr=!1}}},Zu=async()=>{let e=Nr();if(!e||!e.locationId){document.getElementById(Pt)?.remove(),Io();return}let t=document.getElementById(Pt);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(t.remove(),Io());return}t&&t.remove();let o=await Qu();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[add-referral] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Nr();if(!a||a.oppId!==e.oppId)return;let s=document.createElement("span");s.id=Pt,s.dataset.oppId=e.oppId,s.style.cssText="display:inline-flex;align-items:center;order:3;flex-shrink:0;vertical-align:middle;";let i=document.createElement("button");i.type="button",i.style.cssText=B,i.title="The buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal for this property and gets their personalized link",i.innerHTML=`${El(n.amber)}<span>Add Referral Buyer</span>`,i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-1px)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)"}),i.addEventListener("click",()=>{let d=Nr();!d||!d.locationId||Ma({tenantId:d.locationId,referringOppId:d.oppId})}),s.appendChild(i),Y(o).appendChild(s),p.debug(`Mounted Add Referral Buyer button on opp ${e.oppId}`),Xu(e.oppId)},Ao=null,Ia=null,Io=()=>{Ao?.disconnect(),Ao=null,Ia=null},Xu=e=>{if(Ao&&Ia===e)return;Io();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Ia=e,Ao=new MutationObserver(()=>{let o=Nr();if(!o||o.oppId!==e){Io();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Pt)?.remove(),Io();return}document.getElementById(Pt)||Aa()}),Ao.observe(t,{childList:!0,subtree:!0}))},wl=(e,t)=>{let o=e.querySelector("span");if(!o)return;let r=e.style.color;o.textContent=t.length>72?`${t.slice(0,69)}\u2026`:t,e.style.color=n.crimson,window.setTimeout(()=>{o.textContent="Add Referral Buyer",e.style.color=r},4500)},eh=async e=>{let t=D();if(!t||!t.locationId)return;let o=e.querySelector("span");o&&(o.textContent="Loading deals\u2026"),e.disabled=!0;try{let r=await fetch(`${Uu}?tenant_id=${encodeURIComponent(t.locationId)}&contact_id=${encodeURIComponent(t.contactId)}`,{credentials:"omit"}),a=await r.json(),s=Array.isArray(a)?a[0]:a;if(!s?.ok)throw new Error(s?.error||`Lookup failed (${r.status})`);let i=s.opps||[];if(o&&(o.textContent="Add Referral Buyer"),e.disabled=!1,!i.length){wl(e,"No open Marketing Tracker deals for this buyer");return}let d=i.length===1?i[0]:await Yu(i);if(!d)return;Ma({tenantId:t.locationId,referringOppId:d.mt_opp_id,propertyLabel:d.property_address})}catch(r){p.error("Add referral buyer lookup failed",r),o&&(o.textContent="Add Referral Buyer"),e.disabled=!1,wl(e,r instanceof Error?r.message:"Lookup failed")}},La=!1,$l=async()=>{if(!La){La=!0;try{await th()}finally{La=!1}}},th=async()=>{if(!D())return;let t=document.getElementById(Sa);if(!t)try{t=await M(`#${Sa}`,{timeoutMs:st+2e3})}catch{t=null}if(!t)return;if(t.dataset.contactKind!=="buyer"){document.getElementById(zr)?.remove();return}let o=D();if(!o||!o.locationId)return;let r=document.getElementById(zr);if(r&&r.dataset.contactId===o.contactId&&r.parentElement===t)return;r?.remove();let a=document.createElement("button");a.type="button",a.id=zr,a.dataset.contactId=o.contactId,a.style.cssText=B,a.style.order="6",a.title="This buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal and gets their personalized link",a.innerHTML=`${El(n.amber)}<span>Add Referral Buyer</span>`,a.addEventListener("click",()=>void eh(a)),t.appendChild(a),p.debug(`Mounted Add Referral Buyer on buyer contact ${o.contactId}`)},kl=!1,oh=()=>{kl||(kl=!0,window.setInterval(()=>{let e=document.getElementById(Sa);!e||e.dataset.contactKind!=="buyer"||document.getElementById(zr)||$l()},3e3))},Tl=()=>{V("add-referral-buyer",Z,()=>{!document.getElementById(Pt)&&!qr&&Aa()}),Aa(),$l(),oh()};var rh="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ke="ws-crm-reduce-price-button",Cl="ws-crm-reduce-price-modal",nh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ah=/\/v2\/location\/([A-Za-z0-9]+)/,Wr=()=>{let e=window.location.pathname,t=e.match(nh);if(!t)return null;let o=e.match(ah);return{oppId:t[1],locationId:o?o[1]:null}},sh=async e=>{let t=await fetch(rh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,dispo_opp_id:e.oppId,new_price:e.newPrice,triggered_by_user_id:e.userId??null}),credentials:"omit"});if(!t.ok)throw new Error(`Reduce Price webhook returned ${t.status} ${t.statusText}`);let o=await t.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ur=()=>{document.getElementById(Cl)?.remove()},ih=e=>{Ur();let t=document.createElement("div");t.id=Cl,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Wr();!r||!r.locationId||r.oppId!==e||ih({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=B,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},dh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ch=async()=>{for(let e of dh)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},jr=!1,Pa=async()=>{if(!jr){jr=!0;try{await ph()}finally{jr=!1}}},ph=async()=>{let e=Wr();if(!e||!e.locationId){document.getElementById(ke)?.remove(),document.getElementById(`${ke}-wrap`)?.remove(),Oo();return}let t=document.getElementById(ke);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Disposition"&&(t.remove(),document.getElementById(`${ke}-wrap`)?.remove(),Oo());return}t&&(t.remove(),document.getElementById(`${ke}-wrap`)?.remove());let o=await ch();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Wr();if(!a||a.oppId!==e.oppId)return;let s=lh(e.oppId,e.locationId),i=document.createElement("span");i.id=`${ke}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${e.oppId}`),mh(e.oppId)},Mo=null,Oa=null,Bt,Oo=()=>{Mo?.disconnect(),Mo=null,Oa=null,Bt!==void 0&&(window.clearTimeout(Bt),Bt=void 0)},mh=e=>{if(Mo&&Oa===e)return;Oo();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Oa=e,Mo=new MutationObserver(()=>{Bt===void 0&&(Bt=window.setTimeout(()=>{Bt=void 0;let o=Wr();if(!o||o.oppId!==e){Oo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(ke)?.remove(),document.getElementById(`${ke}-wrap`)?.remove(),Oo();return}document.getElementById(ke)||Pa()},250))}),Mo.observe(t,{childList:!0,subtree:!0}))},bh=()=>{V("reduce-price",Z,()=>{!document.getElementById(ke)&&!jr&&Pa()})},Ll=()=>{bh(),Pa()};var Ht="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Gr="deals.reinvestos.com";var Ee="ws-crm-edit-landing-button",uh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hh=/\/v2\/location\/([A-Za-z0-9]+)/,Vr=()=>{let e=window.location.pathname,t=e.match(uh);if(!t)return null;let o=e.match(hh);return{oppId:t[1],locationId:o?o[1]:null}},_h=(e,t)=>{let o=new URL(`https://${Gr}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",Ht);let r=H();return r&&o.searchParams.set("user",r),o.toString()},vh=(e,t)=>{let o=document.createElement("button");return o.id=Ee,o.type="button",o.dataset.oppId=e,o.style.cssText=B,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Vr();if(!r||!r.locationId||r.oppId!==e)return;if(!Ht){p.warn("[edit-landing] editor session key not configured in this build");return}let a=_h(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},yh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],gh=async()=>{for(let e of yh)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Kr=!1,Ha=async()=>{if(!Kr){Kr=!0;try{await fh()}finally{Kr=!1}}},fh=async()=>{let e=Vr();if(!e||!e.locationId){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-wrap`)?.remove(),Bo();return}let t=document.getElementById(Ee);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Disposition"&&(t.remove(),document.getElementById(`${Ee}-wrap`)?.remove(),Bo());return}t&&(t.remove(),document.getElementById(`${Ee}-wrap`)?.remove());let o=await gh();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Vr();if(!a||a.oppId!==e.oppId)return;let s=vh(e.oppId,e.locationId),i=document.createElement("span");i.id=`${Ee}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${e.oppId}`),xh(e.oppId)},Po=null,Ba=null,Rt,Bo=()=>{Po?.disconnect(),Po=null,Ba=null,Rt!==void 0&&(window.clearTimeout(Rt),Rt=void 0)},xh=e=>{if(Po&&Ba===e)return;Bo();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Ba=e,Po=new MutationObserver(()=>{Rt===void 0&&(Rt=window.setTimeout(()=>{Rt=void 0;let o=Vr();if(!o||o.oppId!==e){Bo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Ee)?.remove(),document.getElementById(`${Ee}-wrap`)?.remove(),Bo();return}document.getElementById(Ee)||Ha()},250))}),Po.observe(t,{childList:!0,subtree:!0}))},wh=()=>{V("edit-landing-page",Z,()=>{!document.getElementById(Ee)&&!Kr&&Ha()})},Sl=()=>{wh(),Ha()};var Ml="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ft="ws-crm-publish-button",Ho="ws-crm-publish-wrap",Jr="ws-crm-publish-dropdown",kh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Eh=/\/v2\/location\/([A-Za-z0-9]+)/,Ra=()=>{let e=window.location.pathname,t=e.match(kh);if(!t)return null;let o=e.match(Eh);return{oppId:t[1],locationId:o?o[1]:null}},Al=async(e,t)=>{try{let o=await fetch(Ml,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,dry_run:!0,triggered_by_user_id:H()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},$h=async(e,t)=>{let o=await fetch(Ml,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,triggered_by_user_id:H()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Th=(e,t)=>{if(!Ht){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Gr}/editor`);o.searchParams.set("loc",t),o.searchParams.set("opp",e),o.searchParams.set("k",Ht);let r=H();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Fe=()=>{document.getElementById(Jr)?.remove()},Il=(e,t,o,r,a)=>{Fe();let s=document.createElement("div");s.id=Jr;let i=t.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `,s.appendChild(m),e.forEach(k=>{let g=document.createElement("div");g.style.cssText=`
    ...
    `;let y=k.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`;g.innerHTML=`${y}<span style="flex: 1;">${k.label}</span>`,s.appendChild(g)});let _=document.createElement("div");_.style.cssText=`
    display: flex; align-items: center; gap: 10px;
  ...
  `;let h=document.createElement("button");h.type="button",h.textContent="Open editor to finish \u2192",h.style.cssText=`
    ...
    color: ${n.emerald};
  `,h.addEventListener("click",k=>{k.stopPropagation(),Th(o,r)}),_.appendChild(h);let b=document.createElement("button");b.type="button",b.textContent="Re-check",b.title="Re-check after editing the page",b.style.cssText=`
    margin-left: auto; cursor: pointer; background: transparent; border: none;
    color: ${n.ash}; font-size: 12px; text-decoration: underline;
  `,b.addEventListener("click",k=>{k.stopPropagation(),Fe(),a()}),_.appendChild(b),s.appendChild(_),document.body.appendChild(s);let f=k=>{let g=k.target;!s.contains(g)&&!t.contains(g)&&(Fe(),document.removeEventListener("click",f))};window.setTimeout(()=>document.addEventListener("click",f),0)},Ye=(e,t)=>{let o=e.querySelector(".ws-pub-label"),r=e.querySelector(".ws-pub-dot"),a=e.querySelector(".ws-pub-chevron"),s="transparent",i=n.steel,d=n.bone,l=n.coolGray,c="Publish Deal",m="",_="pointer",h="1";switch(t.status){case"checking":i=n.steel,d=n.ash,c="Checking\u2026",_="wait",h="0.8";break;case"ready":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,c="Publish Deal";break;case"incomplete":{let b=t.checks?.filter(k=>k.filled).length??0,f=t.checks?.length??0;i=n.amber,d=n.amber,l=n.amber,c=`${b} of ${f} ready`,m="\u25BE";break}case"publishing":s=n.emerald,i=n.emerald,d=n.obsidian,l=n.obsidian,c="Publishing\u2026",_="wait",h="0.8";break;case"published":s="transparent",i=n.steel,d=n.ash,l=n.emerald,c="Deal Published",_="default",h="0.9";break;case"error":i=n.amber,d=n.amber,l=n.amber,c=t.message??"Try again";break}e.style.background=s,e.style.borderColor=i,e.style.color=d,e.style.cursor=_,e.style.opacity=h,r&&(r.style.background=l,r.style.boxShadow=t.status==="ready"||t.status==="published"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},Ch=(e,t)=>{let o=document.createElement("button");o.id=Ft,o.type="button",o.dataset.oppId=e,o.title="Publish this deal and send it to your buyers (requires a finished landing page)",o.style.cssText=`
    ${oe}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `;let r={status:"checking"};Ye(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let b=await Al(e,t);if(!b||!Array.isArray(b.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Ye(o,r);return}r={status:b.published?"published":b.ready?"ready":"incomplete",checks:b.checks},Ye(o,r),document.getElementById(Jr)&&r.checks&&Il(r.checks,o,e,t,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Ye(o,r),Fe();try{if((await Al(e,t))?.published){r={status:"published"},Ye(o,r),p.info(`[publish] pre-publish check: opp ${e} already published \u2014 skipping`);return}let f=await $h(e,t);if(f.ok&&f.published)r={status:"published"},Ye(o,r),p.info(`[publish] published opp ${e}`);else if(f.missing&&f.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Ye(o,r);else throw new Error(f.error||"Publish failed")}catch(b){let f=b instanceof Error?b.message:"Publish failed";p.error("[publish] publish failed",b),r={status:"error",message:f.length>28?"Error \u2014 try again":f},Ye(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Jr)?Fe():r.checks&&Il(r.checks,o,e,t,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),_=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",_);let h=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",_),window.clearInterval(h))},5e3);return o},Lh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sh=async()=>{for(let e of Lh)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Yr=!1,Fa=async()=>{if(!Yr){Yr=!0;try{await Ah()}finally{Yr=!1}}},Ah=async()=>{let e=Ra();if(!e||!e.locationId){document.getElementById(Ft)?.remove(),document.getElementById(Ho)?.remove(),Fe(),Do();return}let t=document.getElementById(Ft);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Disposition"&&(t.remove(),document.getElementById(Ho)?.remove(),Fe(),Do());return}t&&(t.remove(),document.getElementById(Ho)?.remove(),Fe());let o=await Sh();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Ra();if(!a||a.oppId!==e.oppId||!a.locationId)return;let s=Ch(e.oppId,a.locationId),i=document.createElement("span");i.id=Ho,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Publish button on opp ${e.oppId}`),Ih(e.oppId)},Ro=null,Da=null,Dt,Do=()=>{Ro?.disconnect(),Ro=null,Da=null,Dt!==void 0&&(window.clearTimeout(Dt),Dt=void 0)},Ih=e=>{if(Ro&&Da===e)return;Do();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Da=e,Ro=new MutationObserver(()=>{Dt===void 0&&(Dt=window.setTimeout(()=>{Dt=void 0;let o=Ra();if(!o||o.oppId!==e){Do();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Ft)?.remove(),document.getElementById(Ho)?.remove(),Fe(),Do();return}document.getElementById(Ft)||Fa()},250))}),Ro.observe(t,{childList:!0,subtree:!0}))},Mh=()=>{V("publish-button",Z,()=>{!document.getElementById(Ft)&&!Yr&&Fa()})},Ol=()=>{Mh(),Fa()};var Pl="data:image/png;base64,",Bl="data:image/png;base64,";var Oh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Hl=e=>`ws-crm-map-links-${e}`,Rl=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),Qr=(e,t)=>{let o=t.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},Dl=(e,t=Rl())=>{let o=Qr(t,e.addr),r=Qr(t,e.city),a=Qr(t,e.state),s=Qr(t,e.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Ph=e=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(e)}`,Bh=e=>`https://www.zillow.com/homes/${e.replace(/\s+/g,"-")}_rb`,Hh=(e,t)=>{let{full:o,hasAny:r}=Dl(e);r&&window.open(t(o),"_blank","noopener,noreferrer")},Rh=e=>{let t=document.createElement("span");t.id=Hl(e.key),t.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",t.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),Hh(e,i)}),d};return t.appendChild(r(Pl,"Open in Google Maps",Ph)),t.appendChild(r(Bl,"Search on Zillow",Bh)),t},Dh=(e,t)=>{let o=t.addr.toLowerCase();for(let r of e)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Fl=()=>{let e=Rl();if(e.length)for(let t of Oh){if(document.getElementById(Hl(t.key)))continue;let{hasAny:o}=Dl(t,e);if(!o)continue;let r=Dh(e,t);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Rh(t)),p.debug(`[map-links] injected on "${t.addr}"`))}},zt=null,Nt,Fh=()=>{let e=kt();return e==="contact-detail"||e==="other"},zh=()=>{zt||(zt=new MutationObserver(()=>{Nt===void 0&&(Nt=window.setTimeout(()=>{Nt=void 0;try{Fl()}catch(e){p.warn("[map-links] ensureInjected failed",e)}},300))}),zt.observe(document.body,{childList:!0,subtree:!0}))},zl=()=>{zt&&(zt.disconnect(),zt=null),Nt!==void 0&&(window.clearTimeout(Nt),Nt=void 0)},Nl=()=>{if(!Fh()){zl();return}zh(),Fl()},ql=()=>{zl()};var Ul="ws-crm-hide-launchpad",za=/\/launchpad\/?$/,Na=()=>{if(!Et()){if(!document.getElementById(Ul)){let e=document.createElement("style");e.id=Ul,e.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(e),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(za.test(location.pathname)){let e=location.pathname.replace(za,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${e}`);try{history.replaceState({},"",e),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!za.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(e))},2e3)}catch(t){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",t),location.replace(e)}}}};var Nh=[{label:"Buy-Box Entries"},{label:"Memberships"}],jl=e=>{e.size!==0&&document.querySelectorAll(".nav-title").forEach(t=>{let o=(t.textContent||"").trim().toLowerCase();if(!e.has(o))return;let r=t.closest("a")||t.closest("li")||t.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${t.textContent?.trim()}"`))})},qa=()=>{let e=Et(),t=new Set(Nh.filter(o=>o.agencyToo||!e).map(o=>o.label.trim().toLowerCase()));if(t.size!==0){jl(t);for(let o of[150,500,1200,2500])setTimeout(()=>jl(t),o)}};var qh=[{from:"Payments",to:"Contracts"}],Uh=".nav-title, .topmenu-navtitle",Wl=()=>{document.querySelectorAll(Uh).forEach(e=>{let t=(e.textContent||"").trim(),o=qh.find(r=>r.from===t);o&&(e.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Ua=()=>{Wl();for(let e of[150,500,1200,2500])setTimeout(Wl,e)};var Gl="/payments/proposals-estimates",jh=/\/payments\/invoices\/?$/,Wh=/\/payments\//,Gh='#sb_payments, a[meta="payments"]',Vl=(e=0)=>{if(e>25)return;let t=location.pathname;if(!t.includes(Gl)&&!(e>3&&!Wh.test(t))){if(jh.test(t)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Gl));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Vl(e+1),120)}},Kl=!1,Kh=()=>{Kl||(Kl=!0,document.addEventListener("click",e=>{e.target?.closest?.(Gh)&&setTimeout(()=>Vl(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},ja=()=>{Kh()};var Yl=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Jl="ws-crm-hide-topmenu-tabs",Wa=()=>{if(document.getElementById(Jl))return;let e=Yl.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),t=document.createElement("style");t.id=Jl,t.textContent=`${e}{display:none !important;}`,(document.head||document.documentElement).appendChild(t),p.info(`[hide-topmenu-tabs] hid ${Yl.length} top tabs`)};var Xl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Je="ws-crm-send-to-closing-office-button",ut="ws-crm-send-to-title-co-wrap",en="ws-crm-stc-dropdown",Vh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Yh=/\/v2\/location\/([A-Za-z0-9]+)/,No=()=>{let e=window.location.pathname,t=e.match(Vh);if(!t)return null;let o=e.match(Yh);return{oppId:t[1],locationId:o?o[1]:null}},Jh=5*60*1e3,Va=e=>`ws-crm-stc-cache:${e}`,Qh=e=>{try{let t=window.localStorage.getItem(Va(e));if(!t)return null;let o=JSON.parse(t);return!o.ts||Date.now()-o.ts>Jh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Zh=(e,t)=>{try{window.localStorage.setItem(Va(e),JSON.stringify(t))}catch{}},ed=e=>{try{window.localStorage.removeItem(Va(e))}catch{}},Ga="ws-crm:opp-fields-updated",td=e=>{if(e){ed(e);try{window.dispatchEvent(new CustomEvent(Ga,{detail:{oppId:e}}))}catch{}}},Xh=async(e,t)=>{try{let o=await fetch(Xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,tc_opp_id:e,triggered_by_user_id:H()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},e_=async(e,t,o)=>{let r=await fetch(Xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,tc_opp_id:e,triggered_by_user_id:H()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},t_=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!t)return!1;let o=t.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===e)return a.click(),!0;let r=t.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===e)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${e}"`),!1},Ql=e=>{let t=document.getElementById(e);if(!t){p.warn(`[stc] field ${e} not found in DOM \u2014 can't scroll to it`);return}t.scrollIntoView({behavior:"smooth",block:"center"});let o=t.style.boxShadow,r=t.style.transition;t.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",t.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{t.style.boxShadow=o,window.setTimeout(()=>{t.style.transition=r},400)},2800)},o_=(e,t)=>{if(t&&t_(t)){window.setTimeout(()=>Ql(e),300);return}Ql(e)},$e=()=>{document.getElementById(en)?.remove()},Zr=(e,t,o)=>{$e();let r=document.createElement("div");r.id=en;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(l);let c=["TC","ACQ","MT","DISPO","Property"],m={};e.forEach(b=>{m[b.group]||(m[b.group]=[]),m[b.group].push(b)});let _=[...c.filter(b=>m[b]),...Object.keys(m).filter(b=>!c.includes(b))];for(let b of _){let f=m[b],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let g=document.createElement("div");g.style.cssText=`
      font-family: ${u.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${n.steel};
    `,g.textContent=b,k.appendChild(g),f.forEach(y=>{let x=document.createElement("div"),E=!y.filled&&y.navigable&&y.field_id;x.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        ...
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(x.addEventListener("mouseenter",()=>{x.style.background=n.slate}),x.addEventListener("mouseleave",()=>{x.style.background="transparent"}),x.addEventListener("click",w=>{w.stopPropagation(),y.field_id&&(o_(y.field_id,y.folder),$e())}));let T=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,C=E?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";x.innerHTML=`${T}<span style="flex: 1;">${y.label}</span>${C}`,k.appendChild(x)}),r.appendChild(k)}document.body.appendChild(r);let h=b=>{let f=b.target;!r.contains(f)&&!o.contains(f)&&($e(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},Oe=(e,t)=>{let o=e.querySelector(".ws-stc-label"),r=e.querySelector(".ws-stc-dot"),a=e.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,c="Send to Closing Office",m="",_="pointer",h="1";switch(t.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,c="Checking\u2026",_="wait",h="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c=t.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let b=t.checks?.filter(k=>k.filled).length??0,f=t.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,c=`${b} of ${f} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sending\u2026",_="wait",h="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,c=t.message??"Try again";break}e.style.background=s,e.style.borderColor=i,e.style.color=d,e.style.cursor=_,e.style.opacity=h,r&&(r.style.background=l,r.style.boxShadow=t.status==="ready"||t.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},r_=(e,t)=>{let o=document.createElement("button");o.id=Je,o.type="button",o.dataset.oppId=e;let r=Qh(e),a=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${B}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,Oe(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Xh(e,t);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},Oe(o,a);return}if(y.rate_limited){b=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Oe(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},Oe(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let x=y.pipeline_name;if(x&&x!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${x}" (not TC) \u2014 retracting button + caching`),tn.add(e),document.getElementById(Je)?.remove(),document.getElementById(ut)?.remove(),$e(),zo();return}let E=y.checks;if(a.checks&&a.checks.length===y.checks.length){let C=new Set;E=y.checks.map((w,$)=>a.checks[$]?.filled&&!w.filled?s.has(w.label)?w:(C.add(w.label),{...w,filled:!0}):w),s=C}else s=new Set;a={status:E.every(C=>C.filled)?"ready":"incomplete",checks:E,previouslySentAt:y.previously_sent_at??null},Zh(e,{checks:E,previously_sent_at:y.previously_sent_at??null,pipeline_name:x,ts:Date.now()}),Oe(o,a),document.getElementById(en)&&Zr(E,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},Oe(o,a),$e();try{let x=await e_(e,t,y);if(x.needs_confirm){a={status:"ready",checks:x.checks,previouslySentAt:x.previously_sent_at},Oe(o,a),x.checks&&Zr(x.checks,x.previously_sent_at,o);return}if(x.ok){a={status:"sent",checks:x.checks,previouslySentAt:new Date().toISOString()},Oe(o,a),window.setTimeout(()=>{k()},3500);return}a={status:"error",checks:x.checks,message:x.error||"Validation failed"},Oe(o,a),x.checks&&Zr(x.checks,x.previously_sent_at,o)}catch(x){p.error("[stc] send failed:",x),a={status:"error",message:"Network error \u2014 click to retry"},Oe(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(en)?$e():a.checks&&Zr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":k();break}});let l,c=!1,m=Date.now(),_=1e4,h=5*60*1e3,b=0,f=!1,k=async()=>{if(o.isConnected&&(f=!0),f&&!o.isConnected)return;let y=No();if(!(!y||y.oppId!==e)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};k();let g=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(g){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let T=Date.now()-m,C=Math.max(1500,_-T);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&k()},C)});y.observe(g,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let x=T=>{let C=T.detail;if(!C||C.oppId!==e)return;ed(e);let w=0,$=()=>{if(c&&w<8){w+=1,window.setTimeout($,500);return}k()};$()};window.addEventListener(Ga,x);let E=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(Ga,x),window.clearInterval(E))},5e3)}return o},n_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],a_=async()=>{for(let e of n_)try{let t=await M(e,{timeoutMs:1500});if(t)return p.debug(`[send-to-title-co] mount target: ${e}`),t}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},tn=new Set,Zl=null,s_=e=>{e&&e!==Zl&&(tn.clear(),Zl=e)},Xr=!1,Ya=async()=>{if(Xr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Xr=!0;try{await i_()}catch(e){p.error("[stc] ensureMountedImpl threw:",e)}finally{Xr=!1}},i_=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let e=No();if(!e||!e.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(e)}`),document.getElementById(Je)?.remove(),document.getElementById(ut)?.remove(),$e();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${e.oppId} locId=${e.locationId}`),s_(e.oppId),tn.has(e.oppId)){p.debug(`[stc] mount:02-BAIL opp ${e.oppId} previously confirmed non-TC this session`),document.getElementById(Je)?.remove(),document.getElementById(ut)?.remove(),$e();return}let t=document.getElementById(Je);if(t&&t.dataset.oppId===e.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(t.remove(),document.getElementById(ut)?.remove(),$e(),zo());return}t&&(p.debug("[stc] mount:03 removing stale existing button"),t.remove(),document.getElementById(ut)?.remove(),$e()),p.debug("[stc] mount:04 calling findMountTarget");let o=await a_();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=No();if(!a||a.oppId!==e.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${e.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=r_(e.oppId,a.locationId),i=document.createElement("span");i.id=ut,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${e.oppId}, inDoc=${document.body.contains(s)}`),l_(e.oppId)},Fo=null,Ka=null,zo=()=>{Fo?.disconnect(),Fo=null,Ka=null},l_=e=>{if(Fo&&Ka===e)return;zo();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Ka=e,Fo=new MutationObserver(()=>{let o=No();if(!o||o.oppId!==e){zo();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Je)?.remove(),document.getElementById(ut)?.remove(),$e(),zo();return}document.getElementById(Je)||Ya()}),Fo.observe(t,{childList:!0,subtree:!0}))},d_=()=>{V("send-to-closing",Z,()=>{if(document.getElementById(Je)||Xr)return;let e=No();e&&tn.has(e.oppId)||Ya()})},od=()=>{d_(),Ya()};var Wo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",c_=`${Wo}/tc/welcome-call-prefill`,p_=`${Wo}/tc/welcome-call-save`,m_=`${Wo}/tc/order-lockbox`,b_=`${Wo}/tc/order-photos`,u_=`${Wo}/tc/photo-price-quote`,qo="ws-crm-welcome-call-overlay",Xa="ZqGLfSMNKm26UQP7ENj1",es=[{value:15,label:"15 photos"},{value:30,label:"30 photos"},{value:50,label:"50 photos"}],h_=[{value:"homejab",label:"Schedule photos right now with HomeJab"},{value:"later",label:"I'll schedule photos myself later"}],ts=[{value:"anytime",label:"Anytime"},{value:"8amto11am",label:"8\u201311 AM"},{value:"9amto12pm",label:"9 AM\u201312 PM"},{value:"10amto1pm",label:"10 AM\u20131 PM"},{value:"11amto2pm",label:"11 AM\u20132 PM"},{value:"12pmto3pm",label:"12\u20133 PM"},{value:"1pmto4pm",label:"1\u20134 PM"},{value:"2pmto5pm",label:"2\u20135 PM"},{value:"3pmto6pm",label:"3\u20136 PM"}],__=["Regular Contract","Subject To","Seller Finance","Novation"],v_=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],y_=["Gas","Electric","Propane","Oil"],g_=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],f_=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Qe=["Yes","No"],x_=["Yes","No","Unknown"],w_=["Professional Photographer","Seller","Tenant"],k_=["Month-to-Month","Annual"],rd=["Current","Behind"],E_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ie=e=>(e==null?"":String(e)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ut=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;margin-top:4px;`,os="margin-bottom:12px;",ad=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,$_=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,nd=e=>String(e??"").toLowerCase().replace(/[^a-z0-9]/g,""),re=(e,t,o)=>{let r=nd(o);return`<select id="${e}" style="${Ut}"><option value=""></option>${t.map(a=>`<option ${r!==""&&nd(a)===r?"selected":""}>${ie(a)}</option>`).join("")}</select>`},T_=(e,t,o)=>`<select id="${e}" style="${Ut}">${t.map(r=>`<option value="${ie(r.value)}" ${r.value===o?"selected":""}>${ie(r.label)}</option>`).join("")}</select>`,se=(e,t,o="")=>`<input id="${e}" type="text" value="${ie(t)}" placeholder="${ie(o)}" style="${Ut}">`,sd=(e,t)=>`<textarea id="${e}" rows="3" style="${Ut}resize:vertical;">${ie(t)}</textarea>`,C_=(e,t)=>`<input id="${e}" type="date" value="${ie(t)}" style="${Ut}">`,F=(e,t)=>`<div style="${os}"><label style="${ad}">${ie(e)}</label>${t}</div>`,Ja=(e,t)=>{let o=Array.isArray(t)?t:[];return`<div style="margin-top:4px;">${E_.map(r=>`<label style="${$_}"><input type="checkbox" data-grp="${e}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},ze=e=>`<div style="font-family:${u.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${ie(e)}</div>`,qt=()=>{document.getElementById(qo)?.remove()},ht=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${t==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${t==="ok"?n.emerald:n.crimson};font-family:${u.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},L_=e=>{let t=e.tenant||{},o=e.tenant_id===Xa,r=`
    ${F("Who is providing photos?",re("wc-photos_provided_by",w_,e.photos_provided_by))}
    <div style="${os}">
      ...
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${Ja("photos_avail_mornings",e.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${Ja("photos_avail_afternoons",e.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${Ja("photos_avail_evenings",e.photos_avail_evenings)}
    </div>
  `,a=o?`
      ${S_()}
      <div id="wc-photos-manual">${r}</div>
      <div id="wc-photos-homejab" style="display:none;">${A_()}</div>
    `:r;return`
    ${ze("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${ie(e.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${ie(e.deal_address)||"(no address on file)"}</div>

    ${ze("Contract")}
    ${F("Type of Contract",re("wc-contract_type",__,e.contract_type))}

    ${ze("Property")}
    ${F("Property Type",re("wc-property_type",g_,e.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",re("wc-utilities",v_,e.utilities))}
    ${F("Heat Source",re("wc-heat_source",y_,e.heat_source))}

    ${ze("Liens & Permits")}
    ${F("Is there a mortgage?",re("wc-has_mortgage",Qe,e.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",re("wc-mortgage_payment_status",rd,e.mortgage_payment_status))}</div>
    ${F("Any other liens? (back taxes, code violations, HELOC, etc.)",re("wc-has_other_liens",Qe,e.has_other_liens))}
    ${F("Any open or expired permits?",re("wc-has_permit_issues",Qe,e.has_permit_issues))}
    ${F("Is the property in probate?",re("wc-in_probate",Qe,e.in_probate))}

    ${ze("Occupancy")}
    ${F("Property occupancy",re("wc-occupancy",f_,e.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",re("wc-tenant_lease_type",k_,t.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",re("wc-tenant_rent_status",rd,t.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",C_("wc-tenant_last_rent_paid",t.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Lease on hand?",re("wc-tenant_lease_on_hand",Qe,t.lease_on_hand))}</div>
        <div style="flex:1;">${F("Security deposit",se("wc-tenant_security_deposit",t.security_deposit))}</div>
      </div>
      ${F("Selling with tenant in place?",re("wc-selling_with_tenant",Qe,e.selling_with_tenant))}
    </div>

    ${ze("HOA")}
    ${F("Part of an HOA?",re("wc-in_hoa",Qe,e.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",se("wc-hoa_monthly_fee",e.hoa_monthly_fee))}${F("HOA rental restriction?",re("wc-hoa_rental_restriction",x_,e.hoa_rental_restriction))}</div>

    ${ze("Photos & Access")}
    ${a}

    ${ze("Lockbox")}
    ${F("Lockbox needed?",re("wc-lockbox_needed",Qe,e.lockbox_needed))}
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${v.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${u.sans};cursor:pointer;flex-shrink:0;">${on(e).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${on(e).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${on(e).on?n.emerald:n.amber};flex-shrink:0;"></span>${on(e).text}</span>
      </div>
    </div>

    ${ze("Notes")}
    ${F("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",sd("wc-welcome_call_notes",e.welcome_call_notes))}
  `},I=e=>{let t=document.getElementById(e);return t?(t.value||"").trim():""},Qa=e=>Array.from(document.querySelectorAll(`input[data-grp="${e}"]:checked`)).map(t=>t.value),Za=()=>{let e=(o,r)=>{let a=document.getElementById(o);a&&(a.style.display=r?"block":"none")};e("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),e("wc-hoa-detail",I("wc-in_hoa")==="Yes"),e("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),e("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied");let t=document.querySelector('input[name="wc-photo-mode"]:checked')?.value??"later";e("wc-photos-manual",t!=="homejab"),e("wc-photos-homejab",t==="homejab")},on=e=>{let t=e,o=String(t.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=t.lockbox_order_date?ie(t.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},S_=()=>`
  <div style="${os}">
    ${h_.map(e=>`<label style="display:flex;align-items:center;gap:8px;font-size:13px;color:${n.bone};margin-bottom:6px;cursor:pointer;"><input type="radio" name="wc-photo-mode" value="${e.value}" ${e.value==="later"?"checked":""}>${ie(e.label)}</label>`).join("")}
  </div>
`,A_=()=>{let e=es.map((t,o)=>`<label style="display:flex;align-items:center;gap:8px;font-size:13px;color:${n.bone};margin-bottom:4px;"><input type="radio" name="wc-op-photocount" value="${t.value}" ${o===1?"checked":""}>${ie(t.label)}</label>`).join("");return`
    <div id="wc-op-form">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Shoot date",`<input id="wc-op-date" type="date" min="${ls()}" style="${Ut}">`)}</div>
        <div style="flex:1;">${F("Time window",T_("wc-op-time",ts,"anytime"))}</div>
      </div>
      ${F("Must-have shots",sd("wc-op-shots",""))}
  ...
  <div style="font-size:14px;font-weight:600;color:${n.bone};line-height:1.4;margin-bottom:8px;">Paid <span style="color:${n.emerald};">\u2713</span> $${rn(o)} \u2014 HomeJab order #${ie(t)} placed.</div>
...
`,I_=e=>({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:Qa("photos_avail_mornings"),photos_avail_afternoons:Qa("photos_avail_afternoons"),photos_avail_evenings:Qa("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),M_=e=>{qt();let t=document.createElement("div");t.id=qo,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${u.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${qo} input[type="date"]::-webkit-calendar-picker-indicator,#${qo} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}
    /* Task 2 (2026-07-10): Shoot Date gets the VAULT emerald calendar canon
       (theme-stylesheet.ts "18-vdp" \u2014 same #0FB57E icon-filter recipe as the
       sidebar's EMERALD_ICON_FILTER) instead of the generic blue every other
       date field in this overlay uses. Scoped to the id + !important because
       the blanket rule above already matches every input[type=date] in this
       overlay on higher specificity (it carries both a type-attribute AND a
       pseudo-element selector) and would otherwise win the cascade. */
    #wc-op-date{color-scheme:dark;}
    #wc-op-date::-webkit-calendar-picker-indicator{filter:${_r} !important;cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${L_(e)}</div>
  ...
  `,t.appendChild(o),document.body.appendChild(t),t.addEventListener("click",h=>{h.target===t&&qt()}),document.getElementById("wc-close")?.addEventListener("click",qt),document.getElementById("wc-cancel")?.addEventListener("click",qt);let r=null,a=0,s=h=>{let b=document.getElementById("wc-order-photos");b&&(b.disabled=h,b.style.opacity=h?"0.5":"1")},i=h=>{let b=document.getElementById("wc-op-error");b&&(b.textContent=h,b.style.display="block")},d=()=>{let h=document.getElementById("wc-op-error");h&&(h.style.display="none",h.textContent="")},l=async()=>{let h=document.getElementById("wc-op-total"),b=Number(document.querySelector('input[name="wc-op-photocount"]:checked')?.value||"30"),f=document.getElementById("wc-op-aerial")?.checked??!1,k=++a;r=null,s(!0),d(),h&&(h.innerHTML="Getting price\u2026");let g=await as(String(e.tenant_id??""),b,f);k===a&&(g.ok&&typeof g.tenant_price=="number"?(r={tenant_price:g.tenant_price},h&&(h.innerHTML=jo(g.tenant_price)),s(!1)):(h&&(h.textContent=""),i(Uo),s(!0)))};["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(h=>{document.getElementById(h)?.addEventListener("change",Za)}),document.querySelectorAll('input[name="wc-photo-mode"]').forEach(h=>{h.addEventListener("change",()=>{Za(),h.checked&&h.value==="homejab"&&l()})}),document.querySelectorAll('input[name="wc-op-photocount"]').forEach(h=>{h.addEventListener("change",()=>void l())}),document.getElementById("wc-op-aerial")?.addEventListener("change",()=>void l()),Za();let c=document.getElementById("wc-save");c?.addEventListener("click",async()=>{if(!I("wc-occupancy")){ht("Set the property occupancy before completing.","err");return}c.textContent="Saving\u2026",c.style.opacity="0.8",c.disabled=!0;try{(await fetch(p_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(I_(e)),credentials:"omit"})).ok?(qt(),ht("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(c.textContent="Complete Welcome Call",c.style.opacity="1",c.disabled=!1,ht("Save failed \u2014 try again.","err"))}catch(h){p.warn("[welcome-call] save failed:",h),c.textContent="Complete Welcome Call",c.style.opacity="1",c.disabled=!1,ht("Couldn't reach the save handler. Try again.","err")}});let m=document.getElementById("wc-order-lockbox");m?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let h=document.getElementById("wc-lockbox-status");m.disabled=!0,m.textContent="Ordering\u2026";try{let b=await fetch(m_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenant_id,opp_id:e.opp_id,contact_id:e.contact_id,property_record_id:e.property_record_id,deal_address:e.deal_address,ship_to:I("wc-lockbox_mailing_address")||e.deal_address||"",recipient_name:I("wc-lockbox_recipient_name"),recipient_phone:I("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"});if(b.ok)m.textContent="Re-order Lockbox",m.disabled=!1,h&&(h.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,h.style.color=n.emerald),ht("Lockbox order sent to ops \u2713");else{let f="";try{f=String((await b.json()).reason??"")}catch{}m.textContent="Order Lockbox",m.disabled=!1,ht(rs(f),"err")}}catch(b){p.warn("[welcome-call] order lockbox failed:",b),m.textContent="Order Lockbox",m.disabled=!1,ht("Couldn't reach the lockbox handler. Try again.","err")}});let _=document.getElementById("wc-order-photos");_?.addEventListener("click",async()=>{let h=document.getElementById("wc-op-date");if(!h?.value){i("Pick a shoot date first.");return}if(!r){i(Uo);return}if(!window.confirm(ss(r.tenant_price)))return;d();let b=document.querySelector('input[name="wc-op-photocount"]:checked')?.value||"30",f=document.getElementById("wc-op-aerial")?.checked??!1,k=document.getElementById("wc-op-time")?.value||"anytime";_.disabled=!0,_.textContent="Ordering\u2026";try{let g=await fetch(b_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenant_id,opp_id:e.opp_id,package:{photocount:Number(b),aerial:f},quoted_price:r.tenant_price,scheduling_date:h.value,scheduling_time:k,must_have_shots:I("wc-op-shots"),access_extra:I("wc-op-access")}),credentials:"omit"});if(g.ok){let E=await g.json().catch(()=>({})),T=String(E.hj_order_id??""),C=document.getElementById("wc-op-form");C&&(C.innerHTML=ds("wc-op",T,Number(E.tenant_price??r.tenant_price)),document.getElementById("wc-op-done")?.addEventListener("click",()=>{C.innerHTML=`<span style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${n.emerald};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered \u2014 HomeJab #${ie(T)}</span>`}));return}if(g.status===409){let E=null;try{let T=await g.json();T.reason==="reprice"&&typeof T.tenant_price=="number"&&(E=T.tenant_price)}catch{}if(E!==null){r={tenant_price:E};let T=document.getElementById("wc-op-total");T&&(T.innerHTML=jo(E)),i(is(E))}else i("HomeJab's price just changed. Refresh and try again.");_.disabled=!1,_.textContent="Order Photos";return}let y="",x;try{let E=await g.json();y=String(E.reason??""),x=E.refunded}catch{}_.disabled=!1,_.textContent="Order Photos",i(ns(y,x))}catch(g){p.warn("[welcome-call] order photos failed:",g),_.disabled=!1,_.textContent="Order Photos",i("Couldn't reach the photo order handler. Try again.")}})},id=async(e,t)=>{qt();let o=document.createElement("div");o.id=qo,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${u.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:e,tenant_id:t};try{let a=await fetch(`${c_}?tc_opp_id=${encodeURIComponent(e)}&tenant_id=${encodeURIComponent(t)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||e,tenant_id:t}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=t,M_(r)};var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",O_=`${ln}/tc/confirm-photo-appointment`,P_=`${ln}/tc/order-lockbox`,B_=`${ln}/tc/order-photos`,H_=`${ln}/tc/welcome-call-prefill`,ps="ws-crm-opp-action-bar",dd="ws-crm-opp-overflow",cd="ws-crm-opp-action-menu",sn="ws-crm-opp-action-popover",pd="ws-crm-reorder-lockbox-modal",md=".hr-card.hr-modal.crm-opportunities-modal",R_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,D_=/\/v2\/location\/([A-Za-z0-9]+)/,bd="Welcome Call Needed",bs="Scheduling Photos",ud="Photos Scheduled",F_=[bd,bs,ud,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],hd=()=>{let e=window.location.pathname,t=e.match(R_);if(!t)return null;let o=e.match(D_);return o?{oppId:t[1],locationId:o[1]}:null},z_=()=>{let e=document.querySelector(md);if(!e)return null;let t=e.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of t){let r=o.textContent?.trim()??"";if(F_.includes(r))return r}return null},Te=()=>{document.getElementById(cd)?.remove(),document.getElementById(sn)?.remove(),document.getElementById(pd)?.remove()},jt=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Ze=(e,t="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
    ...
    box-shadow: 0 12px 32px rgba(0,0,0,0.5);
  `,o.textContent=e,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},N_=e=>{id(e.oppId,e.locationId)},q_=async(e,t,o)=>{let r=await fetch(P_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,contact_id:t.contact_id||"",property_record_id:t.property_record_id||"",deal_address:t.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"});if(r.ok)return{ok:!0,reason:""};let a="";try{a=String((await r.json()).reason??"")}catch{}return{ok:!1,reason:a}},U_=(e,t)=>{Te();let o=document.createElement("div");o.id=pd,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${u.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=t.lockbox_mailing_address||t.deal_address||"";r.innerHTML=`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",_=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!_){Ze("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{let h=await q_(e,t,{recipient_name:c,recipient_phone:m,ship_to:_});h.ok?(d(),Ze("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Ze(rs(h.reason),"err"))}catch(h){p.warn("[action-bar] reorder lockbox failed:",h),l.disabled=!1,l.textContent="Order Lockbox",Ze("Couldn't reach the lockbox handler. Try again.","err")}}})},_d=async e=>{Te();let t={};try{t=await fetch(`${H_}?tc_opp_id=${encodeURIComponent(e.oppId)}&tenant_id=${encodeURIComponent(e.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}U_(e,t)},j_=(e,t)=>{Te();let o=document.createElement("div");o.id=sn;let r=t.getBoundingClientRect();o.style.cssText=`
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Ze("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(O_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Te(),Ze("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Ze("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Ze("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!t.contains(c)&&(Te(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},W_=(e,t)=>{Te();let o=document.createElement("div");o.id=sn;let r=t.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;let a=`width:100%;box-sizing:border-box;margin-bottom:10px;padding:7px 8px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${u.sans};font-size:12px;`,s=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,i=es.map((g,y)=>`<label style="display:flex;align-items:center;gap:8px;font-size:12.5px;color:${n.bone};margin-bottom:4px;"><input type="radio" name="wsop-photocount" value="${g.value}" ${y===1?"checked":""}>${jt(g.label)}</label>`).join(""),d=ts.map(g=>`<option value="${jt(g.value)}" ${g.value==="anytime"?"selected":""}>${jt(g.label)}</option>`).join("");o.innerHTML=`
    <style>
      /* Task 2 (2026-07-10): Shoot Date gets the VAULT emerald calendar canon
         (theme-stylesheet.ts "18-vdp" \u2014 same #0FB57E filter recipe as the
         sidebar's EMERALD_ICON_FILTER), matching the welcome-call panel's
         twin field. This popover has no other date/datetime-local input, so
         no specificity fight \u2014 no !important needed. */
      #wsop-date{color-scheme:dark;}
      #wsop-date::-webkit-calendar-picker-indicator{filter:${_r};cursor:pointer;opacity:1}
    </style>
    ...
    <div id="wsop-form">
      ...
      <input id="wsop-date" type="date" min="${ls()}" style="${a}" />
      ...
      <button id="wsop-submit" type="button" disabled style="${oe} width:100%; justify-content:center; opacity:0.5;">Order Photos</button>
    </div>
  `,document.body.appendChild(o);let l=null,c=0,m=g=>{let y=o.querySelector("#wsop-submit");y&&(y.disabled=g,y.style.opacity=g?"0.5":"1")},_=g=>{let y=o.querySelector("#wsop-error");y&&(y.textContent=g,y.style.display="block")},h=()=>{let g=o.querySelector("#wsop-error");g&&(g.style.display="none",g.textContent="")},b=async()=>{let g=o.querySelector("#wsop-total"),y=Number(o.querySelector('input[name="wsop-photocount"]:checked')?.value||"30"),x=o.querySelector("#wsop-aerial")?.checked??!1,E=++c;l=null,m(!0),h(),g&&(g.innerHTML="Getting price\u2026");let T=await as(e.locationId,y,x);E===c&&(T.ok&&typeof T.tenant_price=="number"?(l={tenant_price:T.tenant_price},g&&(g.innerHTML=jo(T.tenant_price)),m(!1)):(g&&(g.textContent=""),_(Uo),m(!0)))};o.querySelectorAll('input[name="wsop-photocount"]').forEach(g=>{g.addEventListener("change",()=>void b())}),o.querySelector("#wsop-aerial")?.addEventListener("change",()=>void b()),b();let f=o.querySelector("#wsop-submit");f?.addEventListener("click",async()=>{let g=o.querySelector("#wsop-date");if(!g?.value){_("Pick a shoot date first.");return}if(!l){_(Uo);return}if(!window.confirm(ss(l.tenant_price)))return;h();let y=o.querySelector('input[name="wsop-photocount"]:checked')?.value||"30",x=o.querySelector("#wsop-aerial")?.checked??!1,E=o.querySelector("#wsop-time")?.value||"anytime",T=o.querySelector("#wsop-shots")?.value.trim()||"",C=o.querySelector("#wsop-access")?.value.trim()||"";f.disabled=!0,f.textContent="Ordering\u2026";try{let w=await fetch(B_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.locationId,opp_id:e.oppId,package:{photocount:Number(y),aerial:x},quoted_price:l.tenant_price,scheduling_date:g.value,scheduling_time:E,must_have_shots:T,access_extra:C}),credentials:"omit"});if(w.ok){let A=await w.json().catch(()=>({})),N=o.querySelector("#wsop-form");N&&(N.innerHTML=ds("wsop",String(A.hj_order_id??""),Number(A.tenant_price??l.tenant_price)),o.querySelector("#wsop-done")?.addEventListener("click",()=>Te()));return}if(w.status===409){let A=null;try{let N=await w.json();N.reason==="reprice"&&typeof N.tenant_price=="number"&&(A=N.tenant_price)}catch{}if(A!==null){l={tenant_price:A};let N=o.querySelector("#wsop-total");N&&(N.innerHTML=jo(A)),_(is(A))}else _("HomeJab's price just changed. Refresh and try again.");f.disabled=!1,f.textContent="Order Photos";return}let $="",S;try{let A=await w.json();$=String(A.reason??""),S=A.refunded}catch{}f.disabled=!1,f.textContent="Order Photos",_(ns($,S))}catch(w){p.warn("[action-bar] order photos failed:",w),f.disabled=!1,f.textContent="Order Photos",_("Couldn't reach the photo order handler. Try again.")}});let k=g=>{let y=g.target;!o.contains(y)&&!t.contains(y)&&(Te(),document.removeEventListener("click",k))};window.setTimeout(()=>document.addEventListener("click",k),0)},G_=(e,t)=>{Te();let o=document.createElement("div");o.id=cd;let r=t.getBoundingClientRect();o.style.cssText=`
    position: fixed; top: ${r.bottom+6}px;
    right: ${Math.max(16,window.innerWidth-r.right)}px;
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${u.sans};
  `;for(let s of e){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!t.contains(i)&&(Te(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Go=(e,t)=>{let o=document.createElement("button");return o.type="button",t==="primary"?o.style.cssText=oe:o.style.cssText=B,o.textContent=e,o},K_=()=>{let e=Go("\u22EE","ghost");return e.style.lineHeight="1",e},V_=(e,t)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",t===bd){let r=Go("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>N_(e)),o.appendChild(r),o}if(t===bs){if(e.locationId===Xa){let a=Go("Order Photos","ghost");a.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Order Photos</span>`,a.addEventListener("click",()=>W_(e,a)),o.appendChild(a)}let r=Go("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>j_(e,r)),o.appendChild(r),o}if(t===ud){let r=Go("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void _d(e)),o.appendChild(r),o}return null},Y_=(e,t)=>{let o=[];if(t===bs&&(o=[{label:"Re-order Lockbox",onClick:()=>void _d(e)}]),!o.length)return null;let r=document.createElement("span");r.id=dd,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=K_();return a.addEventListener("click",s=>{s.stopPropagation(),G_(o,a)}),r.appendChild(a),r},J_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Q_=async()=>{for(let e of J_)try{let t=await M(e,{timeoutMs:1200});if(t)return t}catch{}return null},nn=()=>{document.getElementById(ps)?.remove(),document.getElementById(dd)?.remove(),Te()},an=!1,us=async()=>{if(!an){an=!0;try{let e=hd();if(!e){nn();return}let t=z();if(t===null)return;if(t!=="Transaction Coordination"){nn();return}let o=z_(),r=document.getElementById(ps);if(r&&r.dataset.oppId===e.oppId&&r.dataset.stage===(o??""))return;let a=V_(e,o);if(!a){nn();return}let s=await Q_();if(!s)return;nn();let i=Y(s),d=document.createElement("span");d.id=ps,d.dataset.oppId=e.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Y_(e,o);l&&i.appendChild(l),Z_(e.oppId)}catch(e){p.error("[action-bar] ensureBar threw:",e)}finally{an=!1}}},Ko=null,ms=null,cs,ld=()=>{Ko?.disconnect(),Ko=null,ms=null},Z_=e=>{if(Ko&&ms===e)return;ld();let t=document.querySelector(md);t&&(ms=e,Ko=new MutationObserver(()=>{let o=hd();if(!o||o.oppId!==e){ld();return}cs===void 0&&(cs=window.setTimeout(()=>{cs=void 0,us()},250))}),Ko.observe(t,{childList:!0,subtree:!0}))},X_=()=>{V("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{an||us()})},vd=()=>{X_(),us()};var ev="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",hs=null,yd=null,gd=async()=>{let e=K(),t=H();if(!e||!t)return null;if(hs&&yd===e)return hs;try{let a=(await(await fetch(ev,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===t);if(!a)return null;let s={name:[a.first_name,a.last_name].filter(Boolean).join(" ").trim(),email:(a.email??"").trim(),phone:(a.phone??"").trim(),role:(a.roles??[])[0]?.display??""};return hs=s,yd=e,s}catch(o){return p.warn("[current-rep] roster load failed",o),null}};var Ne="ws-support-modal",fd="ws-support-toast",tv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",xd="ws-support-submitter-name",wd="ws-support-submitter-email",kd="ws-support-submitter-role",ov=["Bug","Feature Request","Question","Billing","Onboarding Help"],_t=e=>e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),rv=(e,t="success",o)=>{let r=document.getElementById(fd);r&&r.remove();let a=document.createElement("div");a.id=fd;let s=t==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Td=()=>{document.getElementById(Ne)?.remove();let e=(localStorage.getItem(xd)??"").trim(),t=(localStorage.getItem(wd)??"").trim(),o=(localStorage.getItem(kd)??"").trim(),r={category:null,title:"",description:"",submitterName:e,submitterEmail:t,submitterRole:o},a=document.createElement("div");a.id=Ne,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `;s.innerHTML=`
    <style id="ws-support-modal-style">
      ...
      #${Ne} input:-webkit-autofill:active {
        -webkit-text-fill-color: ${n.bone};
        -webkit-box-shadow: 0 0 0 1000px ${n.obsidian} inset;
        box-shadow: 0 0 0 1000px ${n.obsidian} inset;
        caret-color: ${n.bone};
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" autocomplete="off" value="${_t(e)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" autocomplete="off" value="${_t(t)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" autocomplete="off" value="${_t(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; font-family: ${u.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(s),document.body.appendChild(a),Fr(s),gd().then(d=>{if(!d||!document.getElementById(Ne))return;let l=(c,m)=>{let _=s.querySelector(c);_&&!_.value.trim()&&m&&(_.value=m)};l("#ws-support-name",d.name),l("#ws-support-email",d.email),l("#ws-support-role",d.role)}),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=_=>{d&&(d.textContent=_)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(xd,r.submitterName),localStorage.setItem(wd,r.submitterEmail),r.submitterRole&&localStorage.setItem(kd,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let h=await(await fetch(tv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:H()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){l(h.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let b=h.ticket_short_id||"submitted";rv(`Ticket ${b} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(_){l(`Network error: ${_.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},nv=["/support-ticket","ws-support-modal","ws-support"],av=/\/custom-menu-link\//,_s=!1,Ed=()=>{if(_s||!av.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return nv.some(i=>s.includes(i))});if(r){_s=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Td(),_s=!1},50);return}e<10&&setTimeout(t,150)};t()},sv=e=>{if(!(e instanceof Element))return!1;let t=e.closest("a.custom-link");return!!t&&/^\s*Support\s*$/.test(t.textContent||"")},$d=!1,Cd=()=>{$d||($d=!0,document.addEventListener("click",e=>{sv(e.target)&&(e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),p.info("[support-nav] intercepted Support click (capture) \u2014 opening modal in place, no GHL navigation"),Td())},!0),ve(()=>setTimeout(Ed,50)),Ed(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Ld="ws-phone-assignments-modal",Sd="ws-phone-assignments-toast",iv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",lv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",dv=["ACQ","DISPO","TC"],Md="",Xe=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),cv=(e,t="success",o)=>{document.getElementById(Sd)?.remove();let r=document.createElement("div");r.id=Sd;let a=t==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Xe(e)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Xe(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},pv=(e,t,o)=>{let r=[`<option value="" ${o===Md?"selected":""}>\u2014 Unassigned \u2014</option>`,...t.map(a=>`<option value="${Xe(a)}" ${o===a?"selected":""}>${Xe(a)}</option>`)].join("");return`<select data-assign="${Xe(e)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${u.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},mv=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,ys=async e=>{document.getElementById(Ld)?.remove();let t=e||K(),o=document.createElement("div");o.id=Ld,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",h=>{h.target===o&&o.remove()}),!t){let h=r.querySelector("#ws-pa-body");h&&(h.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${iv}?tenant_id=${encodeURIComponent(t)}`,{method:"GET",credentials:"omit"})).json()}catch(h){p.error("[phone-assignments] GET failed",h);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Xe(h.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:dv,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=h=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${h} found.</div>`,c=i.length?i.map(h=>`<div style="${mv}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${Xe(h.label||h.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${u.mono};">${Xe(h.e164)}</div>
            </div>
            ${pv(`num:${h.e164}`,s,d[h.e164]??Md)}
          </div>`).join(""):l("phone numbers"),m=h=>`<div style="font-size:12px;font-weight:600;color:${n.bone};margin:18px 0 6px;letter-spacing:0.04em;text-transform:uppercase;">${h}</div>`,_=r.querySelector("#ws-pa-body");_&&(_.innerHTML=`
    ${m("Numbers \u2192 Team")}
    ...
    </div>`,_.querySelectorAll("select[data-assign]").forEach(h=>{h.addEventListener("change",()=>{let b=h.getAttribute("data-assign")||"",[f,...k]=b.split(":"),g=k.join(":");f==="num"&&(h.value?d[g]=h.value:delete d[g])})}),_.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),_.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let h=_.querySelector("#ws-pa-err"),b=k=>{h&&(h.textContent=k)};b("");let f=_.querySelector("#ws-pa-save");f&&(f.disabled=!0,f.textContent="Saving\u2026",f.style.opacity="0.7");try{let g=await(await fetch(lv,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,numberTeam:d})})).json();if(!g.ok){b(g.error||"Save failed."),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1");return}o.remove(),cv("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(k){b(`Network error: ${k.message}`),f&&(f.disabled=!1,f.textContent="Save",f.style.opacity="1")}}))},bv=["ws-phone-assignments","phone-assignments"],uv=/\/custom-menu-link\//,vs=!1,Ad=()=>{if(vs||!uv.test(window.location.pathname))return;let e=0,t=()=>{e++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return bv.some(i=>s.includes(i))});if(r){vs=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{ys(s),vs=!1},50);return}e<10&&setTimeout(t,150)};t()},Id=!1,Od=()=>{if(Id)return;Id=!0,ve(()=>setTimeout(Ad,50)),Ad();let e=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&ys()};window.addEventListener("hashchange",e),e(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void ys(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Pd="powerDialerApp",hv=".dialer",_v='button[aria-label="Voice Calling"], button[title="Voice Calling"]',vv=".dial-item.dial-btn.dial-btn-enabled",Wt=e=>{for(let t of["pointerdown","mousedown","pointerup","mouseup","click"])try{e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window}))}catch{}},yv=e=>{let t=(e||"").match(/\+\d{10,15}/);return t?t[0]:null},gs=()=>{try{let t=window[Pd]?._context?.provides?.emitter;if(t&&typeof t.emit=="function")return t}catch(e){p.debug("[dialer-bridge] getEmitter failed",e)}return null},Gt=()=>document.querySelector(hv),dn=()=>gs()!==null||Gt()!==null?!0:!!window[Pd],cn=(e,t)=>{let o=gs();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${e}`),!1;try{return o.emit(e,t),!0}catch(r){return p.error(`[dialer-bridge] emit ${e} threw`,r),!1}},Bd=()=>{if(Gt())return;let e=document.querySelector(_v);e?Wt(e):p.warn("[dialer-bridge] Voice Calling button not found")},gv=()=>{let e=document.querySelector(".number-list-container")||Gt();if(!e)return[];let t=[];for(let o of e.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||t.push({label:r,el:o})}return t},fs=()=>{let e=document.querySelector(".number-config, .dialer-config");return e?yv(e.innerText):null},Hd=(e,t)=>{if(fs()===e)return!0;let o=gs();if(o)try{return o.emit("selectNumber",{phoneNumber:e,friendlyName:t||e}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(t){let r=document.querySelector(".number-config, .dialer-config");r&&Wt(r);let a=gv(),s=a.find(i=>i.label===t)||a.find(i=>i.label.includes(t));if(s)return Wt(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${e} (${t||""})`),!1},Rd=e=>{let t=e.replace(/[^\d*#+]/g,"");if(cn("sendDigitToDial",{value:t,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of t){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Wt(a)}},Dd=()=>{let e=Gt();if(!e)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let t=e.querySelector(vv)||[...e.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return t?(Wt(t),!0):cn("makeCall",{provider:"twilio"})};var xs=()=>{let e=Gt();if(!e)return;let t=[...e.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);t?Wt(t.closest("button")||t):cn("closeCallBox")},Fd=()=>{cn("closeCallBox")},zd=e=>{let t=!1,o=()=>{let s=Gt()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(t=!0),t&&d){t=!1;try{e()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var fv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",xv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Nd=["acq","dispo","tc"],Yo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Vo=null,qd=null,wv=async(e=!1)=>{let t={numberTeam:{},numberLabel:{}},o=K();if(!o)return t;if(!e&&Vo&&qd===o)return Vo;try{let a=await(await fetch(`${fv}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Vo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},qd=o,Vo}catch(r){return p.warn("[silo] config load failed",r),Vo??t}},vt=null,Ud=null,ws=async(e=!1)=>{let t=K(),o=H();if(!t||!o)return[];if(!e&&vt&&Ud===t)return vt;try{let s=(await(await fetch(xv,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];vt=Nd.filter(d=>i.includes(d))}else Et()?vt=[...Nd]:vt=[];return Ud=t,vt}catch(r){return p.warn("[silo] roster load failed",r),vt??[]}},Wd=()=>`ws-pd-calling-as:${H()||"anon"}`,Gd=e=>{try{localStorage.setItem(Wd(),e)}catch{}},ks=async()=>{let e=await ws();if(e.length===0)return null;if(e.length===1)return e[0];let t=null;try{t=localStorage.getItem(Wd())}catch{}return t&&e.includes(t)?t:e[0]},jd=e=>{let t=(e||"").replace(/\D/g,"");return t.length===11&&t[0]==="1"?t.slice(1,4):t.length===10?t.slice(0,3):null},kv=(e,t)=>Object.entries(e).filter(([,o])=>o===t).map(([o])=>o),Kd=async e=>{let t=await ks();if(!t)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await wv(),a=kv(o,t);if(!a.length)return p.debug(`[silo] ${t} has no numbers; leaving GHL default`),null;let s=jd(e),i=s?a.find(m=>jd(m)===s):void 0,d=i||a[0];if(!Hd(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Yo[t]}: calling ${e} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=fs();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var Ev="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",Vd="data-ws-pd",Yd="ws-crm-pd-panel",Jd="ws-crm-pd-session",et=e=>new Promise(t=>setTimeout(t,e)),Jo=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t),$v=e=>{let t=e;for(let o=0;o<8&&t;o++){if(t.querySelector(".crm-opportunities-card-wrapper"))return t;t=t.parentElement}return null},Tv=e=>{let t=[e,...Array.from(e.querySelectorAll("*"))];for(let o of t)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return e},Cv=e=>{let t=[],o=new Set;for(let r of Array.from(e.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),t.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return t},Lv=async e=>{let t=$v(e);if(!t)return[];let o=Tv(t),r=-1;for(let a=0;a<60;a++){let s=t.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await et(550)}return o.scrollTop=0,Cv(t)},Sv=async(e,t)=>{try{let r=await(await fetch(Ev,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,contact_id:t})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},Av=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${u.sans};`,$s=(e,t,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(Yd)?.remove();let r=document.createElement("div");r.id=Yd,r.style.cssText=Av;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=t.map((k,g)=>`<label data-row="${g}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{xs()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{xs()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<t.length&&!a.stopped;d++){let l=t[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await Sv(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await et(1200);continue}let _=l._phone||m?.phone||"",h=m?.name||l.name;if(!_){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await et(1400);continue}if(await Kd(_),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let f=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==f&&(history.pushState({},"",f),window.dispatchEvent(new PopStateEvent("popstate")))}catch(b){p.debug("[bulk-dialer] screen-follow nav failed",b)}i(`Calling ${_}\u2026`,d,h);try{Bd(),await et(250),Rd(_),await et(250),Dd()}catch(b){p.error("[bulk-dialer] dial failed",b)}if(await new Promise(b=>{let f=!1,k=()=>{f||(f=!0,window.clearInterval(y),g(),b())},g=zd(k),y=window.setInterval(()=>{(a.stopped||a.skip)&&k()},300)}),a.stopped)break;try{Fd()}catch{}if(d<t.length-1)if(o)for(let b=5;b>0&&!a.stopped&&!a.advance;b--){for(i(`Next call in ${b}s\u2026`,d,h);a.paused&&!a.stopped&&!a.advance;)await et(200);if(a.advance||a.stopped)break;await et(1e3)}else for(i("Ready \u2014 press Call Next",d,h);!a.advance&&!a.stopped;)await et(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${t.length} contact${t.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Ts='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Cs=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},Iv=()=>{if(kt()!=="opportunity-list"||!Cs()||!dn())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(t=>{if(t.querySelector(`[${Vd}]`))return;let o=t.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(Vd,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${u.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Ts}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await Lv(t);$s(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},Kt=null,Es,Qd=!1,Xd=()=>{if(Qd)return;Qd=!0,window.WS_CRM_PD_TEST=t=>void Zd("Verification",[{oppId:"",contactId:"__test__",name:`Test ${t}`,_phone:t}],!1);let e=()=>{Es!==void 0&&window.clearTimeout(Es),Es=window.setTimeout(Iv,400)};ve(t=>{t==="opportunity-list"?(e(),Kt||(Kt=new MutationObserver(e),Kt.observe(document.body,{childList:!0,subtree:!0}))):Kt&&(Kt.disconnect(),Kt=null)})};var ec="ws-crm-pd-contacts-btn",Mv=e=>new Promise(t=>setTimeout(t,e)),Ov=e=>{let t=e.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return t?`+1${t[1]}${t[2]}${t[3]}`:""},Pv=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Ls=(e,t)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(t){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||e.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=Ov(o.textContent||""),d=s&&s!=="-"?s:i||a;e.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},Bv=async e=>{let t=new Map;if(e)return Ls(t,!0),[...t.values()];let o=document.querySelector(".tabulator-tableholder");if(Ls(t,!1),!o)return[...t.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(Ls(t,!1),t.size===a?s++:(s=0,a=t.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await Mv(220);return o.scrollTop=0,[...t.values()]},Hv=()=>{if(kt()!=="contact-list"||!Cs()||!dn()||document.getElementById(ec))return;let e=document.querySelector("#views-bar .bar");if(!e)return;let t=document.createElement("button");t.id=ec,t.type="button",t.title="Power Dialer: call through this list, or the rows you've checked",t.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${u.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,t.innerHTML=`${Ts}<span>Power Dialer</span>`;let o=t.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=t.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),t.style.setProperty("border-color",n.emerald,"important"),t.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=t.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),t.style.opacity="0.7";try{let d=Pv(),l=await Bv(d);$s(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),t.style.opacity="1"}}),e.appendChild(t)},Vt=null,Ss,tc=!1,oc=()=>{if(tc)return;tc=!0;let e=()=>{Ss!==void 0&&window.clearTimeout(Ss),Ss=window.setTimeout(Hv,400)};ve(t=>{t==="contact-list"?(e(),Vt||(Vt=new MutationObserver(e),Vt.observe(document.body,{childList:!0,subtree:!0}))):Vt&&(Vt.disconnect(),Vt=null)})};var Rv="ws-calling-as-chip",Dv=()=>{try{let e=localStorage.getItem("ws-pd");if(e==="1")return!0;if(e==="0")return!1}catch{}return!0},As=!1,yt=null,rc,ac=0,Fv=3e4,zv=()=>{let e=document.querySelector(".hl_header--controls");if(!e)return null;let t=e.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!t)return null;let o=t;for(;o&&o.parentElement!==e;)o=o.parentElement;return o?{parent:e,before:o}:null},Is=()=>{if(!yt||yt.isConnected)return;let e=zv();e&&e.parent.insertBefore(yt,e.before)},nc=async()=>{if(!(As||yt)&&Dv()){As=!0;try{let e=await ws();if(!e.length)return;let t=await ks()??e[0],o=e.length>1,r=document.createElement("div");r.id=Rv,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${u.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${u.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Yo[t]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Yo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",e.forEach(l=>{let c=document.createElement("div"),m=l===t;c.style.cssText=`padding:9px 14px;font-family:${u.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Yo[l],c.addEventListener("mouseenter",()=>{l!==t&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==t&&(c.style.background="transparent")}),c.addEventListener("click",_=>{_.stopPropagation(),t=l,Gd(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}yt=r,Is(),p.info(`[calling-as] chip mounted in header (roles=${e.join(",")}, active=${t}, multi=${o})`)}catch(e){p.error("[calling-as] build failed",e)}finally{As=!1,ac=Date.now()}}},sc=()=>{yt?Is():nc(),rc===void 0&&(rc=window.setInterval(()=>{yt?Is():Date.now()-ac>=Fv&&nc()},1500))};var Nv="#12161D",qv="#EDEEF0",ic=e=>{let o=getComputedStyle(e).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},lc=e=>{e.style.setProperty("background-color",Nv,"important"),e.style.setProperty("color",qv,"important")},Uv=()=>{for(let e of Array.from(document.body.children)){if(e.tagName!=="DIV")continue;let t=e;if(!(t.id||t.className)&&getComputedStyle(t).position==="fixed")return t}return null},jv=e=>{ic(e)&&lc(e);for(let t of Array.from(e.querySelectorAll("*")))ic(t)&&lc(t)},Ms=null,Qo=null,cc=()=>{Qo&&(Qo.disconnect(),Qo=null),Ms=null},Wv=e=>{if(Ms===e)return;cc(),Ms=e;let t=!1,o=()=>{t=!1;try{jv(e)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{t||(t=!0,requestAnimationFrame(o))};Qo=new MutationObserver(r),Qo.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},dc=!1,pn=()=>{if(dc)return;dc=!0;let e=()=>{let o=Uv();o?Wv(o):cc()};e(),new MutationObserver(e).observe(document.body,{childList:!0})};var Gv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Kv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Vv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",bc="tc_closing_agent",Yv="tc_closing_office",Ce="ws-crm-closing-agent-picker-button",uc="ws-crm-closing-agent-picker-modal",Jv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qv=/\/v2\/location\/([A-Za-z0-9]+)/,er=()=>{let e=window.location.pathname,t=e.match(Jv);if(!t)return null;let o=e.match(Qv);return{oppId:t[1],locationId:o?o[1]:null}},Ds=async e=>{let t=await fetch(Gv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,query:e.query??"",contact_id:e.contactId??null,contact_type:e.contactType??null,limit:e.limit??20}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},pc=async e=>{let t=await fetch(Kv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,opp_id:e.oppId,field_key:e.fieldKey,value:e.value}),credentials:"omit"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()},Zv=async(e,t)=>{try{let o=await fetch(Vv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,opp_id:e,field_key:bc}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await Ds({tenantId:t,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},gt=null,Xv=60*60*1e3,Fs=e=>`ws-crm-to-cache:${e}`,hc=e=>{try{let t=window.localStorage.getItem(Fs(e));if(!t)return null;let o=JSON.parse(t);return!o.ts||Date.now()-o.ts>Xv||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},_c=(e,t,o)=>{try{window.localStorage.setItem(Fs(e),JSON.stringify({contactId:t,contactName:o,ts:Date.now()}))}catch{}},ey=e=>{try{window.localStorage.removeItem(Fs(e))}catch{}},Ps="ws-crm-closing-agent-field-link",ty=()=>{let e=document.querySelector(".crm-opportunities-modal");e&&(e.querySelectorAll(`.${Ps}`).forEach(t=>t.remove()),e.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(t=>{t.style.removeProperty("color"),t.style.removeProperty("caret-color"),t.style.removeProperty("visibility"),delete t.dataset.wsClosingAgentDecorated}))},Os=!1,zs=async e=>{if(Os)return;let t=vc();if(!t)return;let o=(t.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(t.dataset.wsClosingAgentDecorated!==o){Os=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Ds({tenantId:e,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Bs(a.id,a.name,e);let s=document.getElementById(Ce);if(s){tt(s,{status:"linked",contactName:a.name});let i=er();i&&_c(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Os=!1}}},oy=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,vc=()=>{let t=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of t){let c=(l.textContent||"").trim();oy.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let _=l.getAttribute(m);_&&/Title\s+Officer/i.test(_)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:_})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Bs=(e,t,o)=>{let r=vc();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==e){a&&r.parentElement?.querySelectorAll(`.${Ps}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=e,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=Ps,d.href=`/v2/location/${o}/contacts/detail/${e}`,d.textContent=t,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},mn=()=>{document.getElementById(uc)?.remove()},ry=e=>{mn();let t=document.createElement("div");t.id=uc,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(o),document.body.appendChild(t);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),t.addEventListener("click",c=>{c.target===t&&mn()}),s?.addEventListener("click",mn);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await Ds({tenantId:e.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          </div>`;return}a.innerHTML="",m.results.forEach(_=>{let h=document.createElement("button");h.type="button",h.style.cssText=`
          display: block;
          width: 100%;
          text-align: left;
          padding: 10px 14px;
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${bn(_.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${bn(_.email||"(no email)")} \xB7 ${bn(_.phone||"no phone")}
            ${_.companyName?` \xB7 ${bn(_.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{mn(),e.onPick(_)}),a.appendChild(h)})}catch(m){p.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{l(c)},250)})},bn=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),tt=(e,t)=>{let o=e.querySelector(".ws-top-label"),r=e.querySelector(".ws-top-dot"),a="Link Closing Agent",s=n.amber,i=n.bone,d="transparent",l=n.steel,c="pointer";switch(t.status){case"loading":a="Loading Closing Agent\u2026",s=n.coolGray,i=n.ash,c="wait";break;case"empty":a="Link Closing Agent",s=n.amber;break;case"linked":a=t.contactName?`Closing Agent: ${t.contactName}`:"Closing Agent: \u2713",s=n.emerald,d=n.emeraldGlow,l=n.emeraldBorder,i=n.emeraldBright;break;case"saving":a="Linking\u2026",s=n.coolGray,i=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),e.style.background=d,e.style.borderColor=l,e.style.color=i,e.style.cursor=c},ny=(e,t)=>{let o=document.createElement("button");o.id=Ce,o.type="button",o.dataset.oppId=e,o.style.cssText=B,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};tt(o,r);let a=hc(e);return a&&(r={status:"linked",contactName:a.contactName},tt(o,r),gt={oppId:e,contactId:a.contactId,contactName:a.contactName,tenantId:t}),(async()=>{let i=await Zv(e,t);i?(r={status:"linked",contactName:i.name},tt(o,r),gt={oppId:e,contactId:i.id,contactName:i.name,tenantId:t},Bs(i.id,i.name,t)):a||(r={status:"empty"},tt(o,r),gt?.oppId===e&&(gt=null),ty(),ey(e))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||ry({oppId:e,locationId:t,onPick:async i=>{r={status:"saving"},tt(o,r);try{let d=await pc({tenantId:t,oppId:e,fieldKey:bc,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await pc({tenantId:t,oppId:e,fieldKey:Yv,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},tt(o,r),gt={oppId:e,contactId:i.id,contactName:i.name,tenantId:t},_c(e,i.id,i.name),Bs(i.id,i.name,t),td(e),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},tt(o,r)}}})}),o},ay=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],sy=async()=>{for(let e of ay)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},Zo=!1,hn=async()=>{if(!Zo){Zo=!0;try{await iy()}finally{Zo=!1}}},iy=async()=>{let e=er();if(!e||!e.locationId){document.getElementById(Ce)?.remove(),document.getElementById(`${Ce}-wrap`)?.remove(),un();return}let t=document.getElementById(Ce);if(t&&t.dataset.oppId===e.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(t.remove(),document.getElementById(`${Ce}-wrap`)?.remove(),un());return}t&&(t.remove(),document.getElementById(`${Ce}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await sy();if(!r||!(hc(e.oppId)!==null||gt!==null&&gt.oppId===e.oppId)&&await X()!=="Transaction Coordination")return;let s=er();if(!s||s.oppId!==e.oppId||!s.locationId)return;let i=ny(e.oppId,s.locationId),d=document.createElement("span");d.id=`${Ce}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Y(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${e.oppId}`),ly(e.oppId),zs(s.locationId)},Xo=null,Hs=null,Rs=null,un=()=>{Xo?.disconnect(),Xo=null,Hs=null,Rs=null},ly=e=>{let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Xo&&Hs===e&&Rs===t||(un(),Hs=e,Rs=t,Xo=new MutationObserver(()=>{let o=er();if(!o||o.oppId!==e||!o.locationId){un();return}document.getElementById(Ce)||hn(),zs(o.locationId)}),Xo.observe(t,{childList:!0,subtree:!0})))},dy=()=>{V("closing-agent-picker",Z,()=>{!document.getElementById(Ce)&&!Zo&&hn()})},mc,cy=()=>{mc===void 0&&(mc=window.setInterval(()=>{let e=er();if(!e||!e.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(Ce)&&!Zo&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),hn()),zs(e.locationId)},2e3))},yc=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),dy(),cy(),hn()};var py="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",qe="ws-crm-manage-team-cta",fc="ws-crm-manage-team-modal",my=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,xc={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},by={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},wc=()=>{let e=window.location.pathname.match(my);return e?{tenantId:e[1]}:null},vn=async e=>{let t=await fetch(py,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!t.ok){let o="";try{o=await t.text()}catch{}throw new Error(`Team.Manage HTTP ${t.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await t.json()},fe=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ot=e=>fe(e),Ns="ws-crm-manage-team-toast",js=(e,t="info",o=4e3)=>{document.getElementById(Ns)?.remove();let r=t==="success"?n.emerald:t==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Ns,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=e,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Ns)===a&&a.remove()},o)},qs=()=>{document.getElementById(fc)?.remove()},uy=(e,t)=>{let o=by[e]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${fe(t)}</span>
  `},hy=(e,t)=>{let o=[e.first_name,e.last_name].filter(Boolean).join(" ")||"(no name)",r=e.roles.map(i=>uy(i.key,i.display)).join(""),a=t?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=t?"":'title="Owner-only action"';return`
    <div data-user-id="${ot(e.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${s}>
        <button class="ws-team-edit" data-email="${ot(e.email)}" data-user-id="${ot(e.id)}" data-name="${ot(o)}" data-current-roles="${ot(e.role_keys.join(","))}" style="${B} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${ot(e.email)}" data-name="${ot(o)}" data-role-count="${ot(String(e.role_keys.length))}" style="${B} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},_y=(e,t)=>e.length===0?`
  ...
  `+e.map(r=>hy(r,t)).join(""),yn=async e=>{qs();let t=document.createElement("div");t.id=fc,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,t.addEventListener("click",l=>{l.target===t&&qs()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,t.appendChild(o),document.body.appendChild(t),o.querySelector("#ws-team-close")?.addEventListener("click",qs);let r;try{r=await vn({tenant_id:e,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
      ...
      `);return}let a=H(),s=!!(a&&r.roster.some(l=>l.id===a&&l.role_keys.includes("manager"))),i=r.summary?`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+_y(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{vy(e)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;yy(e,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;gy(e,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},vy=e=>{let t="ws-crm-manage-team-add-modal";document.getElementById(t)?.remove();let o=document.createElement("div");o.id=t,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(s),document.body.appendChild(o),s.querySelector("#ws-team-add-cancel")?.addEventListener("click",()=>o.remove()),s.querySelector("#ws-team-add-submit")?.addEventListener("click",async()=>{let i=(s.querySelector("#ws-team-add-first")?.value||"").trim(),d=(s.querySelector("#ws-team-add-last")?.value||"").trim(),l=(s.querySelector("#ws-team-add-email")?.value||"").trim(),c=(s.querySelector("#ws-team-add-mobile")?.value||"").trim(),m=(s.querySelector("#ws-team-add-role")?.value||"").trim(),_=s.querySelector("#ws-team-add-error"),h=s.querySelector("#ws-team-add-submit");if(!i||!d||!l||!c||!m){_&&(_.textContent="All fields are required.");return}h&&(h.disabled=!0,h.textContent="Adding\u2026",h.style.opacity="0.7"),_&&(_.textContent="");try{let b=await vn({tenant_id:e,action:"add",first_name:i,last_name:d,email:l,mobile:c,role:m,triggered_by_user_id:H()});if(!b.ok){_&&(_.textContent=b.error||"Failed to add employee"),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1");return}o.remove(),js(`Added ${i} ${d} as ${xc[m]||m}.`,"success"),await yn(e)}catch(b){_&&(_.textContent=b.message),h&&(h.disabled=!1,h.textContent="Add Employee",h.style.opacity="1")}})},yy=(e,t)=>{let o="ws-crm-manage-team-edit-modal";document.getElementById(o)?.remove();let r=document.createElement("div");r.id=o,r.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `;let s=i=>{let d=t.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${fe(xc[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=a.querySelector("#ws-team-remove-error"),i=a.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let d=await vn({tenant_id:e,action:"remove",email:t.email,triggered_by_user_id:H()});if(!d.ok){s&&(s.textContent=d.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),js(`Removed ${t.name} from the team.`,"success"),await yn(e)}catch(d){s&&(s.textContent=d.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},fy=89,xy=93,wy=310,ky=34,Ey=14,$y=14,Ty=3,_n=e=>{let t=document.querySelector('iframe[name="settings-app"]');if(!t){e.style.right="24px";return}let o=t.getBoundingClientRect(),r=window.innerWidth-o.right+fy;e.style.right=`${Math.max(r,16)}px`},Cy=e=>{let t=document.createElement("button");return t.id=qe,t.type="button",t.style.cssText=`
    position: fixed;
    top: ${xy}px;
    right: 24px;
    width: ${wy}px;
  ...
  `,t.addEventListener("click",()=>{yn(e)}),_n(t),setTimeout(()=>_n(t),200),setTimeout(()=>_n(t),800),Ly(),t},gc=!1,Ly=()=>{gc||(gc=!0,window.addEventListener("resize",()=>{let e=document.getElementById(qe);e instanceof HTMLButtonElement&&_n(e)}))},Us=!1,Sy=()=>{if(!Us){Us=!0;try{let e=wc();if(!e){document.getElementById(qe)?.remove(),document.getElementById(`${qe}-floater`)?.remove();return}let t=document.getElementById(qe);if(t&&t.dataset.tenantId===e.tenantId)return;document.getElementById(`${qe}-floater`)?.remove();let o=document.createElement("div");o.id=`${qe}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=Cy(e.tenantId);r.dataset.tenantId=e.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${e.tenantId}`)}finally{Us=!1}}},kc=()=>{if(!wc()){document.getElementById(qe)?.remove(),document.getElementById(`${qe}-floater`)?.remove();return}Sy()};var Ay="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Ks="ws-crm-prepare-contract-button",Ec="ws-crm-prepare-contract-menu",Be="ws-crm-prepare-contract-modal",$c="ws-crm-modal-date-style",Ue="https://services.leadconnectorhq.com",Ic=()=>{if(document.getElementById($c))return;let e=document.createElement("style");e.id=$c,e.textContent=`
    #${Be} input[type="date"] { color-scheme: dark; }
    #${Be} input[type="date"]::-webkit-calendar-picker-indicator {
      filter: invert(46%) sepia(89%) saturate(1500%) hue-rotate(199deg) brightness(101%) contrast(94%);
      cursor: pointer;
      opacity: 1;
    }
  `,document.head.appendChild(e)},Vs="__WS_CRM_CAPTURED_AUTH",Iy=50*60*1e3,nr=()=>{try{let e=localStorage.getItem(Vs);if(!e)return null;let t=JSON.parse(e);return t?.authorization?Date.now()-(t.capturedAt||0)>Iy?(localStorage.removeItem(Vs),null):t:null}catch{return null}},My=e=>{try{localStorage.setItem(Vs,JSON.stringify(e))}catch{}},Jt=()=>{let e=nr(),t=window;if(t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{},t.__WS_CRM_DIAG.authChecks=(t.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${t.__WS_CRM_DIAG.authChecks}]`,e?`present (captured ${Date.now()-e.capturedAt}ms ago, ${e.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!e)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:e.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return e.tokenId&&(o["token-id"]=e.tokenId),o},Tc=(e,t)=>new Promise(o=>{let r=Date.now(),a=()=>{if((nr()?.capturedAt??0)>e)return o(!0);if(Date.now()-r>t)return o(!1);window.setTimeout(a,250)};a()}),Yt=async(e,t={},o=2)=>{let r=nr()?.capturedAt??0,a;try{a={...Jt(),...t.headers??{}}}catch(i){if(o>0&&await Tc(r,4e3))return Yt(e,t,o-1);throw i}let s=await fetch(e,{...t,headers:a});return s.status!==401||o<=0?s:await Tc(r,4e3)?Yt(e,t,o-1):s},Cc=!1,Oy=()=>{if(Cc)return;Cc=!0;let e=window;e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let t=()=>{let l=nr();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{e.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let _=c.authorization||c.Authorization;if(!_){e.__WS_CRM_DIAG.fetchCalls+e.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?e.__WS_CRM_DIAG.fetchAuthSeen++:e.__WS_CRM_DIAG.xhrAuthSeen++;let h=c["token-id"]||c["Token-Id"]||void 0,b=nr()?.authorization;My({authorization:_,tokenId:h,capturedAt:Date.now()}),b!==_&&(e.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${_.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!t()){e.__WS_CRM_DIAG.fetchCalls++;let _=m.headers;!_&&l[0]instanceof Request&&(_=l[0].headers);let h={};if(_ instanceof Headers)_.forEach((b,f)=>h[f.toLowerCase()]=b);else if(Array.isArray(_))_.forEach(([b,f])=>h[b.toLowerCase()]=f);else if(_&&typeof _=="object")for(let b of Object.keys(_))h[b.toLowerCase()]=_[b];o(c,h,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!t()&&(e.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Mc=()=>{let e=D();return!e||!e.locationId?null:{contactId:e.contactId,tenantId:e.locationId}},Py=e=>{let t=e.dataset;return t.tenantId&&t.contactId?{tenantId:t.tenantId,contactId:t.contactId,oppId:t.oppId||void 0}:t.tenantId&&t.oppId?{tenantId:t.tenantId,contactId:"",oppId:t.oppId}:Mc()},By=e=>{let t=(e||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(t)||/assignment.*(contract|agreement)/i.test(t)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(t)||/purchase.*(contract|agreement)/i.test(t)?"PA":"passthrough"},Oc="__WS_CRM_TEMPLATES_CACHE_V1",Hy=24*60*60*1e3,Lc=e=>{try{let t=window.localStorage.getItem(Oc);if(!t)return null;let o=JSON.parse(t);return o.tenantId!==e||Date.now()-o.cachedAt>Hy?null:o.templates}catch{return null}},Ry=(e,t)=>{try{let o={tenantId:e,templates:t,cachedAt:Date.now()};window.localStorage.setItem(Oc,JSON.stringify(o))}catch{}},Dy=async e=>{let t=`${Ue}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(e)}&skip=0&limit=10`,o;try{o=await Yt(t,{method:"GET"})}catch(i){let d=Lc(e);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=Lc(e);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:By(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&Ry(e,s),s},Fy=async(e,t)=>{let o=await Yt(`${Ue}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Yt(`${Ue}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},zy=async(e,t)=>{let o=await Yt(`${Ue}/opportunities/pipelines?locationId=${encodeURIComponent(e)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Ue}/opportunities/search?location_id=${encodeURIComponent(e)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(t)}&status=open&limit=20`,{method:"GET",headers:Jt()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},Ny=async e=>{let t=await fetch(Ay,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e.tenantId,contact_id:e.contactId,template_id:e.templateId,template_type:e.templateType,opp_id:e.oppId,closing_date:e.closingDate,buyer_earnest_due_date:e.buyerEarnestDueDate,lender_source:e.lenderSource,triggered_by_user_id:e.userId,overrides:e.overrides}),credentials:"omit"});if(!t.ok)throw new Error(`Contract.Stage HTTP ${t.status}`);return await t.json()},qy=async(e,t,o)=>{let r=`${Ue}/proposals/templates/to-proposal/${e}/${t}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Jt()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Uy=async(e,t)=>{let o=await fetch(`${Ue}/proposals/document/${t}?locationId=${encodeURIComponent(e)}`,{method:"GET",headers:Jt()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${t} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Pc=async e=>{let t=await fetch(`${Ue}/contacts/${e}`,{method:"GET",headers:Jt()});if(!t.ok){let a=await t.text().catch(()=>"");throw new Error(`GET contact ${e} HTTP ${t.status} ${a.slice(0,200)}`)}let o=await t.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},jy=async(e,t,o,r)=>{let a;try{a=await Uy(e,t)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await Pc(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],_={name:r||a.name,locationId:a.locationId||e,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},h=await fetch(`${Ue}/proposals/document/${t}`,{method:"PUT",headers:{...Jt(),"Content-Type":"application/json"},body:JSON.stringify(_)});if(!h.ok){let b=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:b}}return{ok:!0}},Wy=(e,t)=>{let o=`/v2/location/${e}/payments/proposals-estimates/edit/${t}`;window.location.href=o},fn="__WS_CRM_PENDING_INSTRUCTIONS",Gy=60*1e3,Ky=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Vy=e=>{let t=(e||"").toLowerCase();for(let o of Ky)if(t.includes(o.matches.toLowerCase()))return o;return null},Yy=(e,t,o)=>{try{let r={proposalId:e,title:t,bodyHtml:o,ts:Date.now()};localStorage.setItem(fn,JSON.stringify(r))}catch{}},Jy=()=>{try{let e=localStorage.getItem(fn);if(!e)return null;let t=JSON.parse(e);return!t?.proposalId||!t?.title||!t?.bodyHtml||Date.now()-(t.ts||0)>Gy?(localStorage.removeItem(fn),null):t}catch{return null}},Qy=()=>{try{localStorage.removeItem(fn)}catch{}},Zy=(e,t)=>{document.getElementById(Be)?.remove();let o=document.createElement("div");o.id=Be,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Xy=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,eg=()=>{let e=window.location.pathname.match(Xy);if(!e)return;let t=e[1],o=Jy();o&&o.proposalId===t&&(Qy(),window.setTimeout(()=>{Zy(o.title,o.bodyHtml)},600))},Sc="ws-crm-prepare-contract-toast",ae=(e,t="info",o=4e3)=>{document.getElementById(Sc)?.remove();let r=document.createElement("div");r.id=Sc;let a=t==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=e,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Ac=(e,t)=>new Promise(o=>{document.getElementById(Be)?.remove();let r=document.createElement("div");r.id=Be,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let s=l=>{if(!l)return"";try{return new Date(l).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return l}},i=e.map(l=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${Pe(l.id)}" style="
          display: block;
          width: 100%;
          text-align: left;
          background: ${n.slate};
    ...
    `,r.appendChild(a),document.body.appendChild(r);let d=l=>{r.remove(),o(l)};r.addEventListener("click",l=>{l.target===r&&d(null)}),a.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>d(null)),a.querySelectorAll(".ws-pc-acq-opp").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.borderColor=n.emerald,l.style.background=n.graphite}),l.addEventListener("mouseleave",()=>{l.style.borderColor=n.steel,l.style.background=n.slate}),l.addEventListener("click",c=>{c.stopPropagation(),c.preventDefault();let m=l.dataset.oppId||"";m&&d(m)})})}),tg=({tenantId:e,contactId:t,template:o,staged:r})=>{document.getElementById(Be)?.remove(),Ic();let a=r.debug||{},s=typeof a.propertyAddress=="string"?a.propertyAddress:"",i=typeof a.sellerName=="string"?a.sellerName:"",d=typeof a.purchasePrice=="number"?a.purchasePrice:0,l=typeof a.emd=="number"?a.emd:0,c=typeof a.cashAtClose=="number"?a.cashAtClose:d-l,m=a.daysToClose===void 0||a.daysToClose===null||a.daysToClose===""?"":String(a.daysToClose),_=a.inspectionDays===void 0||a.inspectionDays===null||a.inspectionDays===""?"":String(a.inspectionDays),h=typeof a.additionalTerms=="string"?a.additionalTerms:"",b=typeof a.currentOccupancy=="string"?a.currentOccupancy:"",f=typeof a.occupancyAtClose=="string"?a.occupancyAtClose:"",k=Array.isArray(a.occupancyOptions)&&a.occupancyOptions.length>0?a.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],g=document.createElement("div");g.id=Be,g.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,S=`
    ...
    padding-right: 28px;
  `,A=te=>['<option value="">(unset)</option>'].concat(k.map(le=>`<option value="${Pe(le)}"${le===te?" selected":""}>${ue(le)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${w}">
        ...
        <div style="${C}">${ue(s||"(set on Property record)")}</div>
      </div>
      <div style="${w}">
        <div style="${x}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Pe(i)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${w}">
      ...
      <div style="${w}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${Pe(m)}" placeholder="e.g. 30" style="${E}" />
      </div>
      <div style="${w}">
        <div style="${x}">Inspection Period (Days)</div>
        <input id="ws-pc-inspection-days" type="number" min="0" step="1" value="${Pe(_)}" placeholder="e.g. 10" style="${E}" />
      </div>
      <div style="${w}">
        <div style="${x}">Current Occupancy</div>
        <select id="ws-pc-current-occupancy" style="${S}">${A(b)}</select>
      </div>
      <div style="${w}">
        <div style="${x}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${S}">${A(f)}</select>
      </div>
      <div style="${w} align-items: flex-start;">
        <div style="${x}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${E} resize: vertical; min-height: 60px; font-family: ${u.sans};">${ue(h)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,g.appendChild(y),document.body.appendChild(g);let N=y.querySelector("#ws-pc-purchase-price"),j=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),q=!1;W?.addEventListener("input",()=>{q=!0});let We=()=>{if(q)return;let te=Number(N?.value||0),le=Number(j?.value||0);W&&(W.value=String(Math.max(0,te-le)))};N?.addEventListener("input",We),j?.addEventListener("input",We);let Ge=()=>g.remove();g.addEventListener("click",te=>{te.target===g&&Ge()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Ge);let me=y.querySelector("#ws-pc-submit"),he=y.querySelector("#ws-pc-error");me?.addEventListener("click",async()=>{if(me){he&&(he.textContent=""),me.disabled=!0,me.textContent="Opening\u2026";try{let te=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),le=Number(N?.value||0),no=Number(j?.value||0),ao=Number(W?.value||0),so=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),io=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),lo=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),wt=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),co=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),de={};if(te!==i&&(de.sellerName=te),le!==d&&(de.purchasePrice=le),no!==l&&(de.emd=no),ao!==c&&(de.cashAtClose=ao),so!==m&&(de.daysToClose=so),io!==_&&(de.inspectionDays=io),lo!==h&&(de.additionalTerms=lo),wt!==b&&(de.currentOccupancy=wt),co!==f&&(de.occupancyAtClose=co),Object.keys(de).length>0){p.info("[prepare-contract] PA modal submit with overrides:",de),me.textContent="Saving\u2026";let Pn=H(),Bn=await xn({tenantId:e,contactId:t,template:o,userId:Pn,overrides:de});p.info("[prepare-contract] re-stage with overrides ok:",Bn),me.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let ce=s?`${s} - Purchase Agreement`:void 0;await Qs(e,t,o,ce)}catch(te){me.disabled=!1,me.textContent="Open Contract",he&&(he.textContent=te.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",te)}}})},og=({tenantId:e,contactId:t,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Be)?.remove(),Ic();let l=a.debug||{},c=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",_=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,h=typeof l.buyerEMD=="number"?l.buyerEMD:0,b=typeof l.assignmentFee=="number"?l.assignmentFee:0,f=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,k=typeof l.closingOffice=="string"?l.closingOffice:"",g=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,x=d,E="",T=document.createElement("div");T.id=Be,T.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;C.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      <div style="${N}">
        ...
        <div style="${A}">${ue(c||"(set on Property record)")}</div>
      </div>
      <div style="${N}">
        <div style="${w}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${Pe(m)}" placeholder="Seller name" style="${$}" />
      </div>
      <div style="${N}">
        ...
        <input id="ws-pc-buyer-llc" type="text" value="${Pe(g)}" placeholder="Buyer's entity / LLC name" style="${$}" />
      </div>
      <div style="${N}">
      ...
      <div style="${N}">
        ...
        <div style="${j}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${b}" style="${S}" />
        </div>
      </div>
      <div style="${N}">
        <div style="${w}">Closing Office</div>
        <input id="ws-pc-closing-office" type="text" value="${Pe(k)}" placeholder="Title company" style="${$}" />
      </div>
      <div style="${N}">
        <div style="${w}">Closing Date</div>
        <input id="ws-pc-closing-date" type="date" value="${Pe(y)}" style="${$}" />
      </div>
      <div style="${N}">
        <div style="${w}">Buyer EMD Due Date</div>
        <input id="ws-pc-emd-due-date" type="date" value="${Pe(x)}" style="${$}" />
      </div>
      <div style="${N}">
  ...
  `,T.appendChild(C),document.body.appendChild(T);let W=C.querySelector("#ws-pc-assignment-price"),q=C.querySelector("#ws-pc-assignment-fee"),We=!1;q?.addEventListener("input",()=>{We=!0});let Ge=()=>{if(We)return;let le=Number(W?.value||0);q&&(q.value=String(Math.max(0,le-f)))};W?.addEventListener("input",Ge);let me=()=>T.remove();T.addEventListener("click",le=>{le.target===T&&me()}),C.querySelector("#ws-pc-cancel")?.addEventListener("click",me);let he=C.querySelector("#ws-pc-submit"),te=C.querySelector("#ws-pc-error");he?.addEventListener("click",async()=>{if(!he)return;te&&(te.textContent="");let le=(C.querySelector("#ws-pc-seller-name")?.value||"").trim(),no=Number(W?.value||0),ao=Number(C.querySelector("#ws-pc-buyer-emd")?.value||0),so=Number(q?.value||0),io=(C.querySelector("#ws-pc-closing-office")?.value||"").trim(),lo=(C.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),wt=(C.querySelector("#ws-pc-closing-date")?.value||"").trim(),co=(C.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),de=(C.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!wt){te&&(te.textContent="Closing Date is required.");return}he.disabled=!0,he.textContent="Opening\u2026";try{let ce={};le!==m&&(ce.sellerName=le),no!==_&&(ce.assignmentPrice=no),ao!==h&&(ce.buyerEMD=ao),so!==b&&(ce.assignmentFee=so),io!==k&&(ce.closingOffice=io),lo!==g&&(ce.buyerCompanyName=lo);let Pn=wt!==y||co!==x||de!==E,Bn=Object.keys(ce).length>0||Pn,Hn=a;Bn?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",ce),he.textContent="Saving\u2026",Hn=await xn({tenantId:e,contactId:t,template:o,oppId:r,closingDate:wt,buyerEarnestDueDate:co,lenderSource:de,userId:s,overrides:Object.keys(ce).length>0?ce:void 0}),p.info("[prepare-contract] AA re-stage ok:",Hn),he.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let pi=Hn?.debug?.propertyAddress||c,Rp=pi?`${pi} - Assignment Agreement`:void 0;await Qs(e,t,o,Rp),me()}catch(ce){he.disabled=!1,he.textContent="Open Contract",te&&(te.textContent=ce.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",ce)}})},xn=async e=>{p.info(`[prepare-contract] staging \u2014 template "${e.template.name}" (${e.template.type})`);let t=await Ny({tenantId:e.tenantId,contactId:e.contactId,templateId:e.template.id,templateType:e.template.type,oppId:e.oppId,closingDate:e.closingDate,buyerEarnestDueDate:e.buyerEarnestDueDate,lenderSource:e.lenderSource,userId:e.userId,overrides:e.overrides});if(p.info(`[prepare-contract] stage response: ok=${t.ok}`,t),!t.ok)throw new Error(t.error||"Contract.Stage returned not ok");return t},Qs=async(e,t,o,r)=>{let a=null;try{a=(await Pc(t)).email||""}catch(l){p.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){ae("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),p.warn(`[prepare-contract] aborting \u2014 contact ${t} has no email; not creating an empty proposal`);return}p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${t}`);let s=await qy(e,o.id,t);p.info(`[prepare-contract] proposal created: ${s}`),p.info(`[prepare-contract] attaching contact ${t} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await jy(e,s,t,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${s}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),ae(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Vy(o.name);d&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Yy(s,d.title,d.bodyHtml)),Wy(e,s)},rg=async e=>{let t=Py(e);if(!t){ae("Could not resolve contact context.","error");return}document.getElementById(Ec)?.remove();let o=document.createElement("div");o.id=Ec,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,e.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==e&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Dy(t.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=H();try{if(s.type==="AA"){let m;if(t.oppId)m=t.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await zy(t.tenantId,t.contactId)}catch(x){ae(`Failed to load buyer's MT opps: ${x.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",x);return}if(y.length===0){ae("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let x=await Ac(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!x){p.info("[prepare-contract] MT opp picker cancelled");return}m=x,p.info(`[prepare-contract] picked MT opp ${m}`)}}let _=y=>{let x=y.getFullYear(),E=String(y.getMonth()+1).padStart(2,"0"),T=String(y.getDate()).padStart(2,"0");return`${x}-${E}-${T}`},h=y=>{let x=new Date;return x.setDate(x.getDate()+y),_(x)},b=h(45),f=h(7);ae("Reading contract data\u2026","info",2500);let k;try{k=await xn({tenantId:t.tenantId,contactId:t.contactId,template:s,oppId:m,closingDate:b,buyerEarnestDueDate:f,userId:c})}catch(y){ae(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let g=t.contactId||k.contact_id||"";if(!g){ae("Could not resolve buyer contact for this opp.","error",6e3);return}og({tenantId:t.tenantId,contactId:g,template:s,oppId:m,staged:k,userId:c,defaultClosingDate:b,defaultEMDDueDate:f})}else if(s.type==="PA"){if(!t.contactId){ae("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await Fy(t.tenantId,t.contactId)}catch(b){ae(`Failed to load ACQ opps: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",b);return}if(m.length===0){ae("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let _;if(m.length===1)_=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${_} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let b=await Ac(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!b){p.info("[prepare-contract] ACQ opp picker cancelled");return}_=b,p.info(`[prepare-contract] picked ACQ opp ${_}`)}ae("Reading contract data\u2026","info",2500);let h;try{h=await xn({tenantId:t.tenantId,contactId:t.contactId,template:s,oppId:_,userId:c})}catch(b){ae(`Failed to prepare contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",b);return}tg({tenantId:t.tenantId,contactId:t.contactId,template:s,staged:h})}else{if(!t.contactId){ae("This template needs to be started from a contact page.","error",6e3);return}ae(`Opening ${s.name}\u2026`,"info",2500);try{await Qs(t.tenantId,t.contactId,s)}catch(m){ae(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),ae(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},Bc=()=>{let e=document.createElement("button");return e.id=Ks,e.type="button",e.style.cssText=`${B} position: relative; order: 5;`,e.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,e.addEventListener("mouseenter",()=>{e.style.borderColor=n.emerald}),e.addEventListener("mouseleave",()=>{e.style.borderColor=n.steel}),e.addEventListener("click",t=>{t.stopPropagation(),rg(e)}),e},ng="ws-crm-contact-actions-bar",ag=async()=>{let e=Mc();if(!e){document.getElementById(Ks)?.remove();return}let t=null;try{t=await M(`#${ng}`,{timeoutMs:st+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!t)return;let o=document.getElementById(Ks);if(o){if(o.dataset.contactId===e.contactId)return;o.remove()}let r=Bc();r.dataset.contactId=e.contactId,r.dataset.tenantId=e.tenantId,t.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${e.contactId}`)},ft="ws-crm-prepare-contract-button-opp",tr=`${ft}-wrap`,sg=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ig=/\/v2\/location\/([A-Za-z0-9]+)/,lg=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ys=()=>{let e=window.location.pathname,t=e.match(sg);if(!t)return null;let o=e.match(ig);return o?{oppId:t[1],tenantId:o[1]}:null},dg=async()=>{for(let e of lg)try{let t=await M(e,{timeoutMs:2e3});if(t)return t}catch{}return null},gn=!1,or=null,Js=null,Ws=null,Gs,rr=()=>{or?.disconnect(),or=null,Js=null},cg=e=>{if(or&&Js===e)return;rr();let t=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");t&&(Js=e,or=new MutationObserver(()=>{let o=Ys();if(!o||o.oppId!==e){rr();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(tr)?.remove(),rr();return}document.getElementById(ft)||Hc()}),or.observe(t,{childList:!0,subtree:!0}))},pg=()=>{Ws||(Ws=new MutationObserver(()=>{Gs===void 0&&(Gs=window.setTimeout(()=>{Gs=void 0;let e=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),t=!!document.getElementById(ft);e&&!t&&!gn&&Hc()},300))}),Ws.observe(document.body,{childList:!0,subtree:!0}))},Hc=async()=>{if(!gn){gn=!0;try{let e=Ys();if(!e){document.getElementById(ft)?.remove(),document.getElementById(tr)?.remove(),rr();return}let t=document.getElementById(ft);if(t&&t.dataset.oppId===e.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(t.remove(),document.getElementById(tr)?.remove(),rr());return}t&&(t.remove(),document.getElementById(tr)?.remove());let o=await dg();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ys();if(!a||a.oppId!==e.oppId)return;let s=Bc();s.id=ft,s.dataset.oppId=e.oppId,s.dataset.tenantId=e.tenantId;let i=document.createElement("span");i.id=tr,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${e.oppId} (contactId deferred to click)`),cg(e.oppId)}finally{gn=!1}}},Rc=()=>{eg(),ag()};Oy();function ue(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Pe(e){return ue(e)}var mg="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",xt="ws-crm-compute-offer-button",ei="ws-crm-compute-offer-popover",Wc="ws-crm-offer-modal",Dc="ws-crm-contact-actions-bar",bg=[".central-panel","[class*='central-panel']"],rt=e=>typeof e=="number"?`$${Math.round(e).toLocaleString("en-US")}`:"-",Zs=e=>{if(typeof e!="number"||Math.round(e)===0)return"$0";let t=`$${Math.abs(Math.round(e)).toLocaleString("en-US")}`;return e<0?`\u2212${t}`:`+${t}`},ug=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Fc=e=>{if(!e)return"";let t=String(e).split("-");return t.length!==3?String(e):`${ug[Number(t[1])-1]||""} ${Number(t[2])}`.trim()},U=(e,t,o)=>{let r=document.createElement(e);return t&&(r.style.cssText=t),o!=null&&(r.textContent=o),r},zc=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;outline:none;`,Xs=async e=>{let t={tenant_id:e.tenantId,mode:e.mode};e.propertyRecordId?t.property_record_id=e.propertyRecordId:e.contactId&&(t.contact_id=e.contactId),e.mode!=="get"&&(e.propertyCondition!=null&&(t.property_condition=e.propertyCondition),e.repairOverride!==void 0&&(t.repair_override=e.repairOverride));let o=await fetch(mg,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Qt=()=>{document.getElementById(ei)?.remove(),document.removeEventListener("mousedown",Gc,!0)};function Gc(e){let t=document.getElementById(ei),o=document.getElementById(xt),r=e.target;t&&!t.contains(r)&&o&&!o.contains(r)&&Qt()}var Kc=(e,t)=>{Qt();let o=e.getBoundingClientRect(),r=document.createElement("div");r.id=ei;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${u.sans};color:${n.bone};font-size:13px;line-height:1.35;`,t(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Gc,!0),0)},wn=(e,t)=>{Kc(e,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(U("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(U("div",`color:${n.bone};font-size:12px;`,t))})},hg=(e,t,o)=>{Kc(e,r=>{r.appendChild(U("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),t.forEach(a=>{let s=U("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${u.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{Qt(),o(a.property_record_id)}),r.appendChild(s)})})},En=()=>{document.getElementById(Wc)?.remove(),document.removeEventListener("keydown",Vc,!0)};function Vc(e){e.key==="Escape"&&En()}var Nc=(e,t,o)=>{En(),Qt();let r=o,a=!1,s="",i=document.createElement("div");i.id=Wc,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${u.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&En()});let d=U("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,_,h)=>{a||(a=!0,s="",c(),Xs({tenantId:e,propertyRecordId:t,mode:m,propertyCondition:_,repairOverride:h}).then(b=>{b&&b.ok?r={...b,current_offer:b.current_offer??r.current_offer,current_offer_date:b.current_offer_date??r.current_offer_date}:s=b&&b.error||"Request failed."}).catch(b=>{p.error("[compute-offer] worksheet request failed:",b),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,_=!!m.has_comps;d.innerHTML="";let h=U("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),b=U("div","");b.appendChild(U("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),b.appendChild(U("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let f=U("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");f.type="button",f.addEventListener("click",En),h.append(b,f),d.appendChild(h);let k=U("div","padding:14px 18px 18px;");d.appendChild(k);let g=U("select",zc());(m.rehab_levels||[]).forEach(j=>{let W=document.createElement("option");W.value=j.key,W.textContent=j.label,j.key===(m.tier||m.property_condition)&&(W.selected=!0),g.appendChild(W)}),g.disabled=a,g.addEventListener("change",()=>l("recompute",g.value,y.value.trim()));let y=U("input",zc());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",j=>{j.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",g.value,y.value.trim()));let x=U("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");x.appendChild(U("div",`font-size:12px;color:${_?n.bone:n.amber};`,_?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${Fc(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let E=U("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${_?"transparent":n.blue};color:${_?n.blue:"#fff"};font-family:${u.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":_?"Re-pull Comps":"Pull Comps");E.type="button",E.disabled=a,E.addEventListener("click",()=>l("pull",g.value,y.value.trim())),x.append(E),k.appendChild(x),m.low_confidence&&_&&k.appendChild(U("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let T=m.current_offer!=null;k.appendChild(U("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${T?n.bone:n.ash};`,T?`Last offer made: ${rt(m.current_offer)}${m.current_offer_date?` \xB7 ${Fc(m.current_offer_date)}`:""}`:"No offer made yet."));let C=U("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=U("div","");w.appendChild(U("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(g);let $=U("div","");$.appendChild(U("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),$.appendChild(y),C.append(w,$),k.appendChild(C);let S=U("div",`border-top:1px solid ${n.steel};padding-top:12px;`),A=(j,W,q)=>{let We=U("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${q?.strong?"font-weight:700;":""}`),Ge=U("div","");Ge.appendChild(U("div",`font-size:${q?.strong?"13":"12"}px;color:${n.bone};`,j)),q?.sub&&Ge.appendChild(U("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,q.sub));let me=U("div",`font-size:${q?.strong?"15":"12"}px;color:${q?.color||n.bone};white-space:nowrap;`,W);We.append(Ge,me),S.appendChild(We)};if(_&&m.imv!=null){A("Investor Market Value (IMV)",rt(m.imv)),m.arv!=null&&A("After Repair Value (ARV)",rt(m.arv),{color:n.ash});let j=m.repair_adjustment??0,W=-j,q=m.repair_override?"Repair override":m.property_condition_label||"Repairs";j===0?A(`Repairs (${q})`,"Included",{color:n.ash,sub:`${rt(m.repair_total)} in repairs included at IMV`}):A(`Repairs (${q})`,Zs(W),{color:W<0?n.crimson:n.emerald,sub:`${rt(m.repair_total)} total, ${rt(m.baseline_repairs)} included at IMV`}),A("Min. Profit Target",Zs(-(m.profit_target??0)),{color:n.ash}),A("Maximum Cash Offer (MAO)",rt(m.mao),{strong:!0,color:n.blue}),A("Target Profit",Zs(-(m.ico_delta??0)),{color:n.ash}),A("Initial Cash Offer (ICO)",rt(m.ico),{strong:!0,color:n.blue})}else S.appendChild(U("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));k.appendChild(S);let N=U("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);N.textContent=a?"Saving\u2026":s||(_?"Saved to the Property.":""),k.appendChild(N)}c(),document.body.appendChild(i),document.addEventListener("keydown",Vc,!0)},qc=(e,t)=>{let o=document.createElement("button");o.type="button",o.id=xt,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){hg(o,i.properties,d=>{a(!0),Xs({tenantId:t,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Nc(t,l.property_record_id,l):wn(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),wn(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Nc(t,i.property_record_id,i):wn(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await Xs({tenantId:t,contactId:e,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),wn(o,"Request failed. Try again.")}finally{a(!1)}}}),o},_g=async()=>{for(let e of bg)try{let t=await M(e,{timeoutMs:3e3});if(t)return t}catch{}return null},Uc=async(e,t)=>{let o=t.querySelector(`#${Dc}`);if(!o)try{o=await M(`#${Dc}`,{timeoutMs:3e3,root:t})}catch{o=null}return o?(e.style.order="3",o.appendChild(e),!0):!1},jc=()=>{let e=document.querySelectorAll(`#${xt}`);for(let t=1;t<e.length;t++)e[t].remove()},vg=async()=>{let e=D();if(!e||!e.locationId||e.source!=="url"){document.getElementById(xt)?.remove(),Qt();return}let t=e.locationId,o=document.getElementById(xt);if(o&&o.dataset.contactId===e.contactId)return;o&&o.remove(),Qt();let r="seller";try{r=Ae(await Se(e.contactId,t))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(xt)?.remove();return}let a=await _g();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==e.contactId)return;let i=qc(e.contactId,t);if(!await Uc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}jc(),p.debug(`[compute-offer] mounted for ${e.contactId}`),kn?.disconnect(),kn=new MutationObserver(()=>{if(D()?.contactId!==e.contactId){kn?.disconnect();return}if(!document.getElementById(xt)){let d=qc(e.contactId,t);Uc(d,a).then(()=>jc())}}),kn.observe(a,{childList:!0})},kn=null,ar=null,Yc=()=>{let e=D()?.contactId??null;if(ar&&ar.id===e)return;let t=vg().finally(()=>{ar?.promise===t&&(ar=null)});ar={id:e,promise:t}};var An="reos-theme-stylesheet",hp="reos-theme-fonts",to=!1,yg=()=>{let e=document.getElementById(hp);e&&e.remove()},gg=`
...
Click to dismiss for this session`,e.addEventListener("mouseenter",()=>{e.style.transform="scale(1.05)"}),e.addEventListener("mouseleave",()=>{e.style.transform="scale(1)"}),e.addEventListener("click",()=>{e.style.opacity="0",setTimeout(()=>e.remove(),200)}),document.body.appendChild(e)};var kp=new Set(["ej0SqnTYIprechAMAPrd"]),oo="contact-select-trigger",Ep="ws-crm-reply-from-warning",$p="contact-select-menu",vp="ws-crm-rf-thread-opt",ii="",li=!1,lr=null,On=null,yp=!1,dr="",gp,nt=(...e)=>{try{console.log("[reply-from]",...e)}catch{}},di=e=>{let t=(e?.textContent||"").match(/\+?1?\d{10}\b/);return t?t[0]:""},He=e=>(e||"").replace(/\D/g,"").slice(-10),fp=e=>{let t=He(e);return t.length===10?`+1 ${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:e},Yg=e=>{let t=e.meta||{};return(e.direction||"").toLowerCase()==="inbound"?t.to||"":t.from||""},Jg=async()=>{let e=window.location.pathname,t=e.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(t){let r=K();if(!r)return null;let a=await Wn(`${Un}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(t[1])}`);if(!a||!a.ok)return nt("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=e.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Qg=async()=>{let e=await Jg();if(!e)return null;let t=await Wn(`${Un}/conversations/${e}/messages?limit=20`);if(!t||!t.ok)return nt("getThreadNumber: fetch miss",t?t.status:"null"),null;let o;try{o=await t.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Yg(a);if(He(s).length===10)return s}return null},ro=()=>document.getElementById(Ep)?.remove(),Tp=e=>{let t=e;for(let o=0;o<8&&t;o++){if(t.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return t;t=t.parentElement}return null},Zg=e=>e.replace(/[&<>"]/g,t=>t==="&"?"&amp;":t==="<"?"&lt;":t===">"?"&gt;":"&quot;"),Cp=(e,t,o)=>{ro();let r=document.getElementById(oo);if(!r)return;let a=Tp(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Ep,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=t?` (${Zg(t)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${fp(e)}</span>${i}. You're set to reply from ${fp(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Xg=e=>{lr?.disconnect();let t=document.getElementById(oo);if(!t)return;let o=Tp(t)||t,r=He(di(t));lr=new MutationObserver(()=>{let a=di(document.getElementById(oo)),s=He(a);!s||s===r||(r=s,s===He(e)?ro():Cp(e,"",a))}),lr.observe(o,{childList:!0,subtree:!0,characterData:!0})},xp=()=>{let e=document.getElementById($p);if(!e)return;let t=Array.from(e.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(dr&&(r=t.find(d=>He(o(d))===He(dr))||null,a="thread line"),r||(r=t.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),nt("decorateMenu: cache=",dr,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(vp);s&&s!==r&&s.removeAttribute("id"),r.id=vp;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},ef=()=>{if(!kp.has(K()||""))return;On?.disconnect();let e=0,t=()=>{let o=document.getElementById($p);if(o){xp(),On=new MutationObserver(()=>xp()),On.observe(o,{childList:!0,subtree:!0});return}++e<20&&window.setTimeout(t,50)};t()},tf=e=>{let t=e.target;t&&t.closest&&t.closest("#"+oo)&&(nt("From trigger clicked -> waiting for menu"),ef())},of=async()=>{if(!li){li=!0;try{let e=document.getElementById(oo);if(!e)return;let t=di(e),o=await Qg();if(dr=o||"",nt("check: from=",t,"thread=",o),!o){ro();return}He(t)&&He(t)!==He(o)?(nt("MISMATCH -> banner"),Cp(o,"",t)):(nt("match -> no banner"),ro()),Xg(o)}finally{li=!1}}},wp=()=>{if(!kp.has(K()||""))return;let e=window.location.pathname;if(!e.includes("/conversations")&&!e.includes("/contacts/detail/")){ii="",dr="",lr?.disconnect(),On?.disconnect(),ro();return}let t=!!document.getElementById(oo),o=e.split("/").filter(Boolean).pop()||"",r=(t?"T":"F")+"|"+o;if(r!==ii){if(ii=r,!t){lr?.disconnect(),ro();return}nt("composer expanded on",o),of()}},Lp=()=>{gp===void 0&&(gp=window.setInterval(wp,500)),yp||(document.addEventListener("click",tf,!0),yp=!0),wp()};var rf="#1A1F28",nf="#EDEEF0",ci="#9098A3",af=e=>{let t=(e||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return t?{r:+t[1],g:+t[2],b:+t[3]}:null},sf=e=>.2126*e.r+.7152*e.g+.0722*e.b,lf=e=>{let t=e.r/255,o=e.g/255,r=e.b/255,a=Math.max(t,o,r),s=Math.min(t,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===t?l=(o-r)/d%6:a===o?l=(r-t)/d+2:l=(t-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},Sp=(e,t,o)=>{e.querySelectorAll(t).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},df=e=>{let t=af(getComputedStyle(e).backgroundColor);if(!t||sf(t)<120)return;let o=lf(t);e.style.setProperty("background-color",rf,"important"),e.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),Sp(e,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",nf),Sp(e,"#note-date-added-text, [class*='475467']",ci)},cf=e=>{e.querySelectorAll("[class*='hr-tag__count']").forEach(t=>{t.style.setProperty("background-color","transparent","important")}),e.querySelectorAll(".hr-tag, .hr-tag *").forEach(t=>{t.style.setProperty("color",ci,"important"),t.style.setProperty("-webkit-text-fill-color",ci,"important")}),e.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(t=>{t.style.setProperty("border","none","important"),t.style.setProperty("box-shadow","none","important")})},Ap=()=>{let e=document.querySelectorAll(".note-card-accent");for(let t=0;t<e.length;t++)df(e[t]),cf(e[t])},Ip,Mp=()=>{Ip===void 0&&(Ip=window.setInterval(Ap,700)),Ap()};var pf='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',Op=()=>{document.querySelectorAll(pf).forEach(e=>{e.setAttribute("autocomplete","off")})},Pp,Bp=()=>{Pp===void 0&&(Pp=window.setInterval(Op,1e3)),Op()};console.log("[ws-crm-customizer] bundle-loaded");var L=(e,t)=>{try{p.debug(`[main] calling ${e}`),t(),p.debug(`[main] ${e} OK`)}catch(o){p.error(`[main:FAIL] ${e} threw:`,o)}},Hp=()=>{p.info(`Loaded v${br} (built ${ur})`),Rn()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",ir),L("mountDialerThemeFix",pn)):(L("mountVersionBadge (initial)",Mn),L("mountFavicon",bl),L("mountThemeStylesheet",ir),L("mountHideLaunchpad",Na),L("mountHideNavItems",qa),L("mountRelabelNav",Ua),L("mountHideTopmenuTabs",Wa),L("mountContractsSection",ja)),L("installOppIdCapture",yi),L("initPageRouter",ui),p.info("[main] registering onPageChange subscriber"),ve(t=>{if(p.debug(`[main] onPageChange callback fired for page=${t}`),Rn()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",ir),L("runThemeFastPass",si),L("mountDialerThemeFix",pn),L("unmountContactMapLinks",ql);return}L("mountThemeStylesheet",ir),L("runThemeFastPass",si),L("mountVersionBadge",Mn),L("mountHideLaunchpad",Na),L("mountHideNavItems",qa),L("mountRelabelNav",Ua),L("mountHideTopmenuTabs",Wa),L("mountContractsSection",ja),L("mountAnalyticsDashboard",Ii),L("mountClaimReleaseToggle",Xi),L("mountContactActionsBar",pl),L("mountActiveFollowUpButton",$i),L("mountMtOfferMadeButton",vl),L("mountNotInterestedButton",yl),L("mountScheduleWalkthroughButton",gl),L("mountResendDealLinkButton",xl),L("mountAddReferralBuyer",Tl),L("mountReducePriceButton",Ll),L("mountEditLandingPageButton",Sl),L("mountPublishButton",Ol),L("mountContactMapLinks",Nl),L("mountSendToClosingOfficeButton",od),L("mountOppActionBar",vd),L("mountClosingAgentPickerButton",yc),L("mountPrepareContractButton",Rc),L("mountComputeOfferButton",Yc),L("mountManageTeam",kc),L("mountBuyBoxWidget",Ri),L("mountSellerContactFlag",Yi),L("mountPropertiesWidget",Ki),L("mountSupportNavItem",Cd),L("mountPhoneAssignmentsWidget",Od),L("mountBulkPowerDialer",Xd),L("mountBulkPowerDialerContacts",oc),L("mountCallingAsChip",sc),L("mountDialerThemeFix",pn),L("mountReplyFromWarning",Lp),L("mountNoteCanon",Mp),L("mountSuppressAutofill",Bp)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Hp):Hp();})();
