/* Wholesaling CRM Customizer v0.22.2 — built 2026-06-03T16:25:55.296Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var _t="[wholesaling-crm-customizer]",$a="__WS_CRM_DEBUG",Ma=()=>!!window[$a],p={info(...t){console.log(_t,...t)},warn(...t){console.warn(_t,...t)},error(...t){console.error(_t,...t)},debug(...t){Ma()&&console.log(_t,"[debug]",...t)}};var Da=/\/v2\/location\/([A-Za-z0-9]+)/,Oa=new Set(["8ntUQzMflUkR0YvrRgVk"]),xe=()=>{let t=window.location.pathname.match(Da);return t?t[1]:null},yo=()=>{let t=xe();return t!==null&&Oa.has(t)};var Hr=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,go=/\/v2\/location\/([A-Za-z0-9]+)/,Ha=t=>{let e=t.match(Hr);if(!e)return null;let o=t.match(go);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Pa=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Hr);if(!a)continue;let i=r.match(go)||window.location.pathname.match(go);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},D=()=>{let t=Ha(window.location.pathname);return t||Pa()};var Pr=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},gt="",fo=null,ke="other",wo=new Set,yt=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==gt)&&!(t!==fo))){gt=window.location.pathname,fo=t,ke=Pr(),p.debug("Page/context changed:",ke,gt,"contact:",t);for(let r of wo)try{r(ke)}catch(a){p.error("Subscriber threw:",a)}}},ft=t=>(wo.add(t),setTimeout(()=>t(ke),0),()=>{wo.delete(t)}),Fr=()=>{ke=Pr(),gt=window.location.pathname,fo=D()?.contactId??null,p.debug("Router init, current page:",ke);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),yt()},history.replaceState=function(o,r,a){e(o,r,a),yt()},window.addEventListener("popstate",yt),setInterval(yt,1e3)};var wt="0.22.2",xt="2026-06-03T16:25:55.297Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,b=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(b(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(b(),i(h))},r),d=window.setTimeout(()=>{b(),p.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},xo={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Br=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var Fa=/^[A-Za-z0-9]{15,30}$/,Re=t=>typeof t=="string"&&Fa.test(t),Ba=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Ra=()=>{let t=window.WS_CRM_USER_ID;return Re(t)?t:null},Na=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Re(o))return o;return null},za=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Ba(e);if(!o)return null;let r=o.uid;if(Re(r))return r;let a=o.claims;if(a&&Re(a.user_id))return a.user_id}catch{}return null},Ga=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Re(a))return a}catch{}}}catch{}return null},L=()=>Ra()||Na()||za()||Ga()||null;var Gr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",qa=`${Gr}/active-follow-up-get`,Ua=`${Gr}/active-follow-up-set`,me="ws-crm-active-follow-up-button",Eo={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Va=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},Wa=async t=>{let e=await fetch(qa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},ja=async(t,e)=>{let o=await fetch(Ua,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ue=(t,e)=>{let o=Eo[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Rr=t=>{let e=document.createElement("button");return e.type="button",e.id=me,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ue(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Va();if(!(!r||r.contactId!==t)){ue(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await ja(r,L()),i=a&&a.state&&a.state in Eo?a.state:"blue";ue(e,i),p.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ue(e,"error"),setTimeout(()=>void kt(e,r),4e3)}}}),e},kt=async(t,e)=>{ue(t,"loading");try{let o=await Wa(e),r=o&&o.state&&o.state in Eo?o.state:"gray",a=document.getElementById(me);if(!a||a.dataset.contactId!==e.contactId)return;ue(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),ue(t,"error")}},Ka=[".central-panel","[class*='central-panel']"],ko="ws-crm-contact-actions-bar",Ya=async()=>{for(let t of Ka)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Xa=async(t,e)=>{let o=e.querySelector(`#${ko}`);if(!o)try{o=await A(`#${ko}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${ko}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},Ja=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},Za=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},Qa=async t=>{if(t==="url"){let o=await Ya();return o?{kind:"contact-detail",target:o}:null}let e=Ja();return e?{kind:"conversations",target:e}:null},Nr=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await Xa(t,e.target);return o}return Za(t,e.target),"conversations-header"},ei=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(me)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(me);if(o&&o.dataset.contactId===e.contactId){kt(o,e);return}o&&o.remove();let r=await Qa(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let i=Rr(e.contactId),s=await Nr(i,r);p.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),zr();let l=document.getElementById(me)??i;kt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(me);if(!(D()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=Rr(e.contactId);Nr(m,r).then(()=>{zr(),kt(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Ne=null,qr=()=>{let t=D()?.contactId??null;if(Ne&&Ne.contactId===t)return;let e=ei().finally(()=>{Ne?.promise===e&&(Ne=null)});Ne={contactId:t,promise:e}},zr=()=>{let t=document.querySelectorAll(`#${me}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var ti="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",ze=new Map,Et=async(t,e)=>{if(!t)return null;if(ze.has(t))return ze.get(t)??null;if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${ti}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return p.warn(`Contact Type fetch returned ${i.status} for ${t}`),ze.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return ze.set(t,l),p.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),p.warn(`Contact Type fetch failed for ${t}:`,a),ze.set(t,null),null}};var Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var Wr="ws-buybox-nav-icon",Co="ws-buybox-panel",Ur="ws-buybox-modal",oi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",Io="https://mcclivetim.github.io/reinvest-os-cdn/geo",St=null,Ge=null,qe=null,So=async()=>{if(St)return St;try{let t=await fetch(`${Io}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return St=await t.json(),St}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},ri=async t=>{if(!Ge)try{let e=await fetch(`${Io}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Ge=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return Ge?.[t]??[]},ni=async t=>{if(!qe)try{let e=await fetch(`${Io}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);qe=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return qe?.[t]??[]},Lo=async t=>await(await fetch(oi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),ai=(t,e)=>Lo({tenant_id:t,action:"list",buyer_contact_id:e}),ii=(t,e,o,r)=>Lo({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),si=(t,e)=>Lo({tenant_id:t,action:"remove",entry_id:e}),H=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),li=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},di='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',ci='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',pi="nav.w-13, nav[class*='w-13']",bi=".flex-1.h-full.relative.overflow-hidden.rounded-lg",hi=async()=>{try{return await A(pi,{timeoutMs:2500})}catch{return null}},mi=async()=>{try{return await A(bi,{timeoutMs:2500})}catch{return null}},ui=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,vi=(t,e)=>{let o=document.createElement("div");return o.id=Co,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{fi(t,e,()=>Ao(t,e))}),o},Ao=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ai(t,e),So()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${H(r.error||"Failed to load buy-box entries")}</div>`;return}_i(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${H(r.message)}</div>`}},_i=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(b=>{let m=d.key==="state"?li(b.geo_value,o):b.geo_value;return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid ${n.steel};">
              <span>${H(m)}</span>
              <button type="button" data-entry-id="${H(b.id)}" data-entry-label="${H(m)}" class="ws-buybox-remove" aria-label="Remove ${H(m)}" style="
                background: transparent; border: none; cursor: pointer;
                color: ${n.ash}; padding: 4px;
                border-radius: ${_.sm};
                display: inline-flex; align-items: center; justify-content: center;
                transition: color 0.12s;
              " title="Remove">${ci}</button>
            </div>
          `}).join("");return`
        <div style="margin-bottom: 18px;">
          <div style="font-family: ${u.mono}; font-size: 9px; letter-spacing: 0.18em; text-transform: uppercase; color: ${n.ash}; margin-bottom: 6px;">${H(d.label)} (${e[d.key].length})</div>
          ${c}
        </div>
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",b=d.dataset.entryLabel||"this area";confirm(`Remove "${b}" from this buyer's buy-box?`)&&(d.disabled=!0,si(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}Ao(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},Ct=!1,jr=(t,e)=>{Ct=e;let o=ui(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=yi,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Ao(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Kr,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Kr="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",yi="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",gi=t=>{let e=document.createElement("button");return e.id=Wr,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Kr,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${di.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!Ct;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),jr(r,a)}),e},fi=(t,e,o)=>{let r=document.getElementById(Ur);r&&r.remove();let a=document.createElement("div");a.id=Ur,a.style.cssText=`
  ...
  `,m=g=>`
    ...
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 14px;">Which state is this ${H(s.granularity||"")} in?</div>
    ...
    <div id="ws-buybox-state-list" style="max-height: 280px; overflow-y: auto; border: 1px solid ${n.steel}; border-radius: ${_.sm};">
      ${g.map(T=>`
        <div data-state-code="${H(T.code)}" class="ws-buybox-state-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${H(T.name)} <span style="color: ${n.ash}; font-family: ${u.mono}; font-size: 11px;">(${H(T.code)})</span>
        </div>
      `).join("")}
    </div>
  ...
  `,h=g=>{let T=i.querySelector("#ws-buybox-state-search"),I=i.querySelectorAll(".ws-buybox-state-row");I.forEach(O=>{O.addEventListener("mouseenter",()=>{O.style.background=n.emeraldGlow}),O.addEventListener("mouseleave",()=>{O.style.background="transparent"}),O.addEventListener("click",()=>{s.stateCode=O.dataset.stateCode||"",s.step=3,l()})}),T?.addEventListener("input",()=>{let O=(T.value||"").toLowerCase().trim();g.forEach((B,K)=>{let V=I[K];if(!V)return;let P=!O||B.name.toLowerCase().includes(O)||B.code.toLowerCase()===O;V.style.display=P?"":"none"})}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T?.focus(),0)},v=g=>`
    ...
    <div style="color: ${n.ash}; padding: 20px 0; text-align: center;">Loading list for ${H(g)}\u2026</div>
  `,x=g=>{let T=g.find(I=>I.code===s.stateCode);return`
      ...
      <div style="background: ${n.emeraldGlow}; border: 1px solid ${n.emeraldBorder}; border-radius: ${_.md}; padding: 16px; margin-bottom: 20px;">
        <div style="font-size: 22px; font-weight: 500;">${H(T?T.name:s.stateCode||"")}</div>
        <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">This buyer will match every property in ${T?H(T.name):""} regardless of county / city / zip.</div>
      </div>
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; gap: 8px;">
          <button id="ws-buybox-cancel" type="button" style="background: transparent; color: ${n.ash}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; padding: 8px 18px; cursor: pointer; font-family: ${u.sans}; font-size: 13px;">Close</button>
          <button id="ws-buybox-save" type="button" style="background: ${n.emerald}; color: ${n.bone}; border: none; border-radius: ${_.sm}; padding: 8px 22px; cursor: pointer; font-family: ${u.sans}; font-size: 13px; font-weight: 600;">Add ${T?H(T.name):"State"}</button>
        </div>
      </div>
    `},E=g=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>k(s.stateCode||""))},w=g=>{let T=s.granularity==="county"?Ge?.[s.stateCode||""]??[]:qe?.[s.stateCode||""]??[];return`
      <div style="font-family: ${u.mono}; font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: ${n.emeraldBright}; margin-bottom: 4px;">Step 3 of 3 \u2014 Pick a ${H(g)}</div>
      <div style="font-size: 14px; color: ${n.ash}; margin-bottom: 10px;">Type to filter ${T.length.toLocaleString()} ${H(g).toLowerCase()}s in ${H(s.stateCode||"")}.</div>
    ...
    `},y=()=>{let g=s.granularity==="county"?Ge?.[s.stateCode||""]??[]:qe?.[s.stateCode||""]??[],T=i.querySelector("#ws-buybox-value-search"),I=i.querySelector("#ws-buybox-value-list");if(!T||!I)return;let O=B=>{let K=B.toLowerCase().trim();if(!K){I.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let V=g.filter(P=>P.toLowerCase().includes(K)).slice(0,50);if(V.length===0){I.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${H(s.stateCode||"")}.</div>`;return}I.innerHTML=V.map(P=>`
        <div data-value="${H(P)}" class="ws-buybox-value-row" style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid ${n.steel};">
          ${H(P)}
        </div>
      `).join(""),I.querySelectorAll(".ws-buybox-value-row").forEach(P=>{P.addEventListener("mouseenter",()=>{P.style.background=n.emeraldGlow}),P.addEventListener("mouseleave",()=>{P.style.background="transparent"}),P.addEventListener("click",()=>{s.value=P.dataset.value||"",k(s.value)})})};T.addEventListener("input",()=>O(T.value)),O(""),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),setTimeout(()=>T.focus(),0)},f=()=>`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),T&&(T.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),T=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){T&&(T.textContent="Zip must be exactly 5 digits.");return}await k(I)},k=async g=>{if(!s.granularity||!g)return;let T=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),T&&(T.textContent="");try{let O=await ii(t,e,s.granularity,g);if(!O.ok){T&&(T.textContent=O.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
        <div style="text-align: center; padding: 40px 0;">
          <div style="font-size: 32px;">\u2713</div>
          <div style="font-size: 16px; margin-top: 8px;">Added <strong>${H(g)}</strong> to the buy-box.</div>
          <div style="font-size: 12px; color: ${n.ash}; margin-top: 4px;">${O.deduplicated?"(Already existed; not duplicated.)":""}</div>
        </div>
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(O){T&&(T.textContent=`Network error: ${O.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},To=!1,Ee=null,Ue=null,Vr=()=>{document.getElementById(Wr)?.remove(),document.getElementById(Co)?.remove(),Ue&&Ee&&Ee.nav.removeEventListener("click",Ue,!0),Ue=null,Ee=null,Ct=!1},Yr=()=>{wi()},wi=async()=>{if(!To){To=!0;try{let t=D();if(!t){Vr();return}let e=document.getElementById(Co);if(e&&e.dataset.buyerContactId===t.contactId&&Ee)return;Vr();let o=null;try{o=await Et(t.contactId,t.locationId)}catch(m){p.warn("[buy-box] Contact Type fetch failed",m);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([hi(),mi()]);if(!a||!i){p.warn("[buy-box] right-rail nav or panel area not found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let l=vi(t.locationId,t.contactId),d=gi(()=>Ee),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};Ee=c;let b=a.querySelector(".flex.flex-col.items-center.gap-2");b?b.appendChild(d):a.appendChild(d),i.appendChild(l),Ue=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&Ct&&jr(c,!1)},a.addEventListener("click",Ue,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{To=!1}}};var ce="ws-crm-claim-release-pill",xi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ki="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Ei=async t=>{let e=await fetch(xi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ti=async t=>{let e=await fetch(ki,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Zr=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Te=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Br(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Si=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=ce,o.type="button",o.dataset.contactId=t,Te(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let i=L();if(!i){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>Te(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";Te(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Ti({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;Te(o,d),p.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){p.error("Claim/Release Set webhook failed",l),Te(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Xr=async(t,e)=>{try{let o=await Ei({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(ce);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";Te(r,a)}catch(o){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Ci=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Zr(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Jr=(t,e)=>{let o=Si({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${ce}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Ii=async()=>{let t=D();if(!t){document.getElementById(ce)?.remove();return}let e=document.getElementById(ce);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await Ci(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Jr(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(ce);i&&t.locationId&&Xr(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(ce))return;let d=Zr(o);if(d){Jr(d,t.contactId);let c=document.getElementById(ce);c&&t.locationId&&Xr(c,{contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Qr=()=>{Ii()};var an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Li="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Ai="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",$i=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||an,d;if(s==="buyer"){let b=sn.find(h=>h.label===o),m=b?b.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let b={call_status:o,triggered_by_user_id:r??""};a&&(b.dead_reason=a),d={contact_id:t,location:{id:e},customData:b}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Mi=async({contactId:t,tenantId:e})=>{let o=await fetch(Ai,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Se="ws-crm-contact-actions-bar",Di="ws-crm-call-status-dropdown",en="ws-crm-offer-made-modal",Oi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],sn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Hi=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Pi=async()=>{for(let t of Hi)try{let e=await A(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Fi=({contactId:t,kind:e})=>{let o=e==="buyer"?sn:Oi,r=e==="buyer"?Li:an,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=Di,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let b=s.firstElementChild,m=s.children[1],h=s.children[2];b&&(b.style.background=xo[d.color]),m&&(m.textContent=d.label),l.style.display="none";let x=D()?.locationId,E=L();if(!x){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!E){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await $i({contactId:t,locationId:x,status:d.label,userId:E,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(S){p.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";zi(S=>{y(S)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await Mi({contactId:t,tenantId:x})).ok?await y():Gi(()=>{y()},()=>{m&&(m.textContent=f)})}catch(S){p.warn("Appointment sanity check failed; firing anyway:",S),await y()}return}await y()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},Bi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Ri=async t=>{let e=await fetch(Bi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ni=(t,e="seller")=>{document.getElementById(en)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=en,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},rn=(t,e)=>{let o=document.createElement("div");if(o.id=Se,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=J,r.textContent="Offer Made",r.addEventListener("click",()=>Ni(t,e)),o.appendChild(r),o.appendChild(Fi({contactId:t,kind:e}))}return o},$o=!1,qi=()=>{document.querySelectorAll(`[id="${Se}"]`).forEach(t=>t.remove())},ln=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),$o){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}$o=!0;try{await Ui()}finally{$o=!1}},Ui=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),qi();return}p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await Et(t.contactId,t.locationId),b=Tt(c);b==="buyer"?e="buyer":b==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Se}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await Pi();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=D();if(!i||i.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=rn(t.contactId,e)}catch(c){p.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){p.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Se)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){d?.disconnect();return}let b=document.querySelectorAll(`[id="${Se}"]`);if(b.length>1){for(let m=1;m<b.length;m++)b[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${b.length-1} duplicate bar(s)`);return}if(b.length===0){let m=document.querySelector(".central-panel")||a,h=rn(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(a,{childList:!0})},nn=null,Vi=()=>{nn===null&&(nn=window.setInterval(()=>{let t=D();t&&(document.getElementById(Se)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ln()))},3e3))},dn=()=>{Vi(),ln()};var It="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Wi=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Ve="data-ws-crm-favicon",Mo=t=>t.hasAttribute(Ve),cn=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Wi.has(e)},Lt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{cn(r)&&!Mo(r)&&r.remove()});let e=document.head.querySelector(`link[${Ve}="1"]`);e?e.href!==It&&(e.href=It):(e=document.createElement("link"),e.setAttribute(Ve,"1"),e.rel="icon",e.type="image/png",e.href=It,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${Ve}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Ve,"apple"),o.rel="apple-touch-icon",o.href=It,document.head.appendChild(o))},pn=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Lt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Lt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&cn(s)&&!Mo(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Mo(s)&&(a=!0)});a&&Lt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,Lt(),e>=5&&window.clearInterval(o)},1e3)};var ji=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Ki=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Yi=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let t=document.querySelector(Yi);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Ki);if(a){let i=a[1];if(ji.includes(i))return i}}return null},N=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=M();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Xi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Z="ws-crm-mt-offer-made-button",bn="ws-crm-mt-offer-made-modal",Ji=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Zi=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(Ji);if(!e)return null;let o=t.match(Zi);return{oppId:e[1],locationId:o?o[1]:null}},Qi=async t=>{let e=await fetch(Xi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},At=()=>{document.getElementById(bn)?.remove()},es=t=>{At();let e=document.createElement("div");e.id=bn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),i=o.querySelector("#ws-mt-offer-cancel"),s=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&At()}),i?.addEventListener("click",()=>At()),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d||Number(d)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Recording\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{let b=await Qi({oppId:t.oppId,locationId:t.locationId,amount:c,userId:L()});if(!b.ok){a.textContent=b.error??"Something went wrong.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1);return}At(),t.onSuccess()}catch(b){p.error("MT Offer Made webhook failed",b),a.textContent=b instanceof Error?b.message:"Network error \u2014 try again.",s.disabled=!1,s.textContent="Record Offer",s.style.opacity="1",i&&(i.disabled=!1)}})},ts=t=>{let e=document.createElement("button");return e.id=Z,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Mt();!o||!o.locationId||o.oppId!==t||es({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},os=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rs=async()=>{for(let t of os)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$t=!1,Po=async()=>{if(!$t){$t=!0;try{await ns()}finally{$t=!1}}},ns=async()=>{let t=Mt();if(!t||!t.locationId){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),je();return}let e=document.getElementById(Z);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove(),je());return}e&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove());let o=await rs();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Mt();if(!a||a.oppId!==t.oppId)return;let i=ts(t.oppId),s=document.createElement("span");s.id=`${Z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),as(t.oppId)},We=null,Ho=null,je=()=>{We?.disconnect(),We=null,Ho=null},as=t=>{if(We&&Ho===t)return;je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ho=t,We=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t){je();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),je();return}document.getElementById(Z)||Po()}),We.observe(e,{childList:!0,subtree:!0}))},Do=null,Oo,is=()=>{Do||(Do=new MutationObserver(()=>{Oo===void 0&&(Oo=window.setTimeout(()=>{Oo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Z);t&&!e&&!$t&&Po()},300))}),Do.observe(document.body,{childList:!0,subtree:!0}))},hn=()=>{is(),Po()};var ss="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",Q="ws-crm-not-interested-button",ls=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ds=/\/v2\/location\/([A-Za-z0-9]+)/,Ot=()=>{let t=window.location.pathname,e=t.match(ls);if(!e)return null;let o=t.match(ds);return{oppId:e[1],locationId:o?o[1]:null}},cs=async t=>{let e=await fetch(ss,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},ps=t=>{let e=document.createElement("button");return e.id=Q,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Ot();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await cs({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){p.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},bs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],hs=async()=>{for(let t of bs)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Dt=!1,No=async()=>{if(!Dt){Dt=!0;try{await ms()}finally{Dt=!1}}},ms=async()=>{let t=Ot();if(!t||!t.locationId){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ye();return}let e=document.getElementById(Q);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ye());return}e&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove());let o=await hs();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ot();if(!a||a.oppId!==t.oppId)return;let i=ps(t.oppId),s=document.createElement("span");s.id=`${Q}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),us(t.oppId)},Ke=null,Ro=null,Ye=()=>{Ke?.disconnect(),Ke=null,Ro=null},us=t=>{if(Ke&&Ro===t)return;Ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ro=t,Ke=new MutationObserver(()=>{let o=Ot();if(!o||o.oppId!==t){Ye();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ye();return}document.getElementById(Q)||No()}),Ke.observe(e,{childList:!0,subtree:!0}))},Fo=null,Bo,vs=()=>{Fo||(Fo=new MutationObserver(()=>{Bo===void 0&&(Bo=window.setTimeout(()=>{Bo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Q);t&&!e&&!Dt&&No()},300))}),Fo.observe(document.body,{childList:!0,subtree:!0}))},mn=()=>{vs(),No()};var _s="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ce="ws-crm-resend-deal-link-wrap",ys=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gs=/\/v2\/location\/([A-Za-z0-9]+)/,Pt=()=>{let t=window.location.pathname,e=t.match(ys);if(!e)return null;let o=t.match(gs);return{oppId:e[1],locationId:o?o[1]:null}},fs=async t=>{let e=await fetch(_s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},ws=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),un=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Uo=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=$,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${un(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>xs(t,e)),t.appendChild(o)},xs=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,i=(l,d)=>{let c=document.createElement("button");return c.type="button",c.textContent=l,c.style.cssText=a,c.addEventListener("click",()=>void ks(t,e,d,o)),c};o.appendChild(i("Text","sms")),o.appendChild(i("Email","email"));let s=document.createElement("button");s.type="button",s.textContent="\u2715",s.title="Cancel",s.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,s.addEventListener("click",()=>Uo(t,e)),o.appendChild(s),t.appendChild(o)},ks=async(t,e,o,r)=>{let a=Pt();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let i=await fs({oppId:a.oppId,locationId:a.locationId,channel:o,userId:L()});if(i?.ok)r.innerHTML=`${un(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(i?.error||"Send failed")}catch(i){let s=i instanceof Error?i.message:"Send failed";p.error("Resend deal link failed",i),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${ws(s)}</span>`}window.setTimeout(()=>Uo(t,e),3500)}},Es=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ts=async()=>{for(let t of Es)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ht=!1,Vo=async()=>{if(!Ht){Ht=!0;try{await Ss()}finally{Ht=!1}}},Ss=async()=>{let t=Pt();if(!t||!t.locationId){document.getElementById(Ce)?.remove(),Je();return}let e=document.getElementById(Ce);if(e&&e.dataset.oppId===t.oppId){let s=M();s!==null&&s!=="Marketing Tracker"&&(e.remove(),Je());return}e&&e.remove();let o=await Ts();if(!o)return;let r=await N();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Pt();if(!a||a.oppId!==t.oppId)return;let i=document.createElement("span");i.id=Ce,i.dataset.oppId=t.oppId,i.style.cssText="display:inline-flex;align-items:center;margin-left:auto;order:2;flex-shrink:0;vertical-align:middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),o.appendChild(i),Uo(i,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Cs(t.oppId)},Xe=null,qo=null,Je=()=>{Xe?.disconnect(),Xe=null,qo=null},Cs=t=>{if(Xe&&qo===t)return;Je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(qo=t,Xe=new MutationObserver(()=>{let o=Pt();if(!o||o.oppId!==t){Je();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ce)?.remove(),Je();return}document.getElementById(Ce)||Vo()}),Xe.observe(e,{childList:!0,subtree:!0}))},zo=null,Go,Is=()=>{zo||(zo=new MutationObserver(()=>{Go===void 0&&(Go=window.setTimeout(()=>{Go=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ce)&&!Ht&&Vo()},300))}),zo.observe(document.body,{childList:!0,subtree:!0}))},vn=()=>{Is(),Vo()};var _n="ws-crm-dispo-action-row",Ie=t=>{let e=document.getElementById(_n);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=_n,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Ls="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ee="ws-crm-reduce-price-button",yn="ws-crm-reduce-price-modal",As=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,$s=/\/v2\/location\/([A-Za-z0-9]+)/,Rt=()=>{let t=window.location.pathname,e=t.match(As);if(!e)return null;let o=t.match($s);return{oppId:e[1],locationId:o?o[1]:null}},Ms=async t=>{let e=await fetch(Ls,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Ft=()=>{document.getElementById(yn)?.remove()},Ds=t=>{Ft();let e=document.createElement("div");e.id=yn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Ft()}),i?.addEventListener("click",()=>{Ft()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Ms({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:L()}),Ft(),t.onSuccess()}catch(b){p.error("Reduce Price webhook failed",b),a.textContent=b instanceof Error?b.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},Os=(t,e)=>{let o=document.createElement("button");return o.id=ee,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Rt();!r||!r.locationId||r.oppId!==t||Ds({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Hs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ps=async()=>{for(let t of Hs)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Bt=!1,Yo=async()=>{if(!Bt){Bt=!0;try{await Fs()}finally{Bt=!1}}},Fs=async()=>{let t=Rt();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Qe();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Qe());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=await Ps();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await N();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Rt();if(!a||a.oppId!==t.oppId)return;let i=Os(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ee}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),Ie(o).appendChild(s),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Bs(t.oppId)},Ze=null,Ko=null,Qe=()=>{Ze?.disconnect(),Ze=null,Ko=null},Bs=t=>{if(Ze&&Ko===t)return;Qe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ko=t,Ze=new MutationObserver(()=>{let o=Rt();if(!o||o.oppId!==t){Qe();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),Qe();return}document.getElementById(ee)||Yo()}),Ze.observe(e,{childList:!0,subtree:!0}))},Wo=null,jo,Rs=()=>{Wo||(Wo=new MutationObserver(()=>{jo===void 0&&(jo=window.setTimeout(()=>{jo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!Bt&&Yo()},300))}),Wo.observe(document.body,{childList:!0,subtree:!0}))},gn=()=>{Rs(),Yo()};var Le="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Nt="deals.reinvestos.com";var te="ws-crm-edit-landing-button",Ns=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zs=/\/v2\/location\/([A-Za-z0-9]+)/,Gt=()=>{let t=window.location.pathname,e=t.match(Ns);if(!e)return null;let o=t.match(zs);return{oppId:e[1],locationId:o?o[1]:null}},Gs=(t,e)=>{let o=new URL(`https://${Nt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Le);let r=L();return r&&o.searchParams.set("user",r),o.toString()},qs=(t,e)=>{let o=document.createElement("button");return o.id=te,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Gt();if(!r||!r.locationId||r.oppId!==t)return;if(!Le){p.warn("[edit-landing] editor session key not configured in this build");return}let a=Gs(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},Us=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vs=async()=>{for(let t of Us)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},zt=!1,Qo=async()=>{if(!zt){zt=!0;try{await Ws()}finally{zt=!1}}},Ws=async()=>{let t=Gt();if(!t||!t.locationId){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt();return}let e=document.getElementById(te);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt());return}e&&(e.remove(),document.getElementById(`${te}-wrap`)?.remove());let o=await Vs();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Gt();if(!a||a.oppId!==t.oppId)return;let i=qs(t.oppId,t.locationId),s=document.createElement("span");s.id=`${te}-wrap`,s.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),Ie(o).appendChild(s),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),js(t.oppId)},et=null,Zo=null,tt=()=>{et?.disconnect(),et=null,Zo=null},js=t=>{if(et&&Zo===t)return;tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zo=t,et=new MutationObserver(()=>{let o=Gt();if(!o||o.oppId!==t){tt();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(te)?.remove(),document.getElementById(`${te}-wrap`)?.remove(),tt();return}document.getElementById(te)||Qo()}),et.observe(e,{childList:!0,subtree:!0}))},Xo=null,Jo,Ks=()=>{Xo||(Xo=new MutationObserver(()=>{Jo===void 0&&(Jo=window.setTimeout(()=>{Jo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(te);t&&!e&&!zt&&Qo()},300))}),Xo.observe(document.body,{childList:!0,subtree:!0}))},fn=()=>{Ks(),Qo()};var xn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Ae="ws-crm-publish-button",ot="ws-crm-publish-wrap",Ut="ws-crm-publish-dropdown",Ys=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xs=/\/v2\/location\/([A-Za-z0-9]+)/,or=()=>{let t=window.location.pathname,e=t.match(Ys);if(!e)return null;let o=t.match(Xs);return{oppId:e[1],locationId:o?o[1]:null}},Js=async(t,e)=>{try{let o=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:L()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},Zs=async(t,e)=>{let o=await fetch(xn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:L()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},Qs=(t,e)=>{if(!Le){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Nt}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Le);let r=L();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},se=()=>{document.getElementById(Ut)?.remove()},wn=(t,e,o,r,a)=>{se();let i=document.createElement("div");i.id=Ut;let s=e.getBoundingClientRect();i.style.cssText=`
    position: fixed;
    top: ${s.bottom+6}px;
  ...
  `;let r={status:"checking"};ve(o,r);let a=!1,i=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let m=await Js(t,e);if(!m||!Array.isArray(m.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},ve(o,r);return}r={status:m.published?"published":m.ready?"ready":"incomplete",checks:m.checks},ve(o,r),document.getElementById(Ut)&&r.checks&&wn(r.checks,o,t,e,()=>void i())}finally{a=!1}}},s=async()=>{r={status:"publishing",checks:r.checks},ve(o,r),se();try{let m=await Zs(t,e);if(m.ok&&m.published)r={status:"published"},ve(o,r),p.info(`[publish] published opp ${t}`);else if(m.missing&&m.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},ve(o,r);else throw new Error(m.error||"Publish failed")}catch(m){let h=m instanceof Error?m.message:"Publish failed";p.error("[publish] publish failed",m),r={status:"error",message:h.length>28?"Error \u2014 try again":h},ve(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":s();break;case"incomplete":{document.getElementById(Ut)?se():r.checks&&wn(r.checks,o,t,e,()=>void i());break}case"error":i();break}}),i();let l,d=Date.now(),c=8e3,b=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(b){let m=new MutationObserver(()=>{if(l!==void 0||a||r.status==="publishing"||r.status==="published")return;let v=Math.max(1500,c-(Date.now()-d));l=window.setTimeout(()=>{l=void 0,d=Date.now(),i()},v)});m.observe(b,{childList:!0,subtree:!0});let h=window.setInterval(()=>{document.body.contains(o)||(m.disconnect(),l!==void 0&&window.clearTimeout(l),window.clearInterval(h))},5e3)}return o},tl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ol=async()=>{for(let t of tl)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qt=!1,nr=async()=>{if(!qt){qt=!0;try{await rl()}finally{qt=!1}}},rl=async()=>{let t=or();if(!t||!t.locationId){document.getElementById(Ae)?.remove(),document.getElementById(ot)?.remove(),se(),nt();return}let e=document.getElementById(Ae);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(ot)?.remove(),se(),nt());return}e&&(e.remove(),document.getElementById(ot)?.remove(),se());let o=await ol();if(!o)return;let r=await N();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=or();if(!a||a.oppId!==t.oppId||!a.locationId)return;let i=el(t.oppId,a.locationId),s=document.createElement("span");s.id=ot,s.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",s.appendChild(i),Ie(o).appendChild(s),p.debug(`Mounted Publish button on opp ${t.oppId}`),nl(t.oppId)},rt=null,rr=null,nt=()=>{rt?.disconnect(),rt=null,rr=null},nl=t=>{if(rt&&rr===t)return;nt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(rr=t,rt=new MutationObserver(()=>{let o=or();if(!o||o.oppId!==t){nt();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(Ae)?.remove(),document.getElementById(ot)?.remove(),se(),nt();return}document.getElementById(Ae)||nr()}),rt.observe(e,{childList:!0,subtree:!0}))},er=null,tr,al=()=>{er||(er=new MutationObserver(()=>{tr===void 0&&(tr=window.setTimeout(()=>{tr=void 0,!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description")&&!document.getElementById(Ae)&&!qt&&nr()},300))}),er.observe(document.body,{childList:!0,subtree:!0}))},kn=()=>{al(),nr()};var Sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",pe="ws-crm-send-to-closing-office-button",_e="ws-crm-send-to-title-co-wrap",jt="ws-crm-stc-dropdown",il=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,sl=/\/v2\/location\/([A-Za-z0-9]+)/,Kt=()=>{let t=window.location.pathname,e=t.match(il);if(!e)return null;let o=t.match(sl);return{oppId:e[1],locationId:o?o[1]:null}},ll=5*60*1e3,Cn=t=>`ws-crm-stc-cache:${t}`,dl=t=>{try{let e=window.localStorage.getItem(Cn(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ll||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},cl=(t,e)=>{try{window.localStorage.setItem(Cn(t),JSON.stringify(e))}catch{}},pl=async(t,e)=>{try{let o=await fetch(Sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},bl=async(t,e,o)=>{let r=await fetch(Sn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},hl=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},En=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ml=(t,e)=>{if(e&&hl(e)){window.setTimeout(()=>En(t),300);return}En(t)},oe=()=>{document.getElementById(jt)?.remove()},Vt=(t,e,o)=>{oe();let r=document.createElement("div");r.id=jt;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,ne(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await pl(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},ne(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},ne(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},ne(o,a),p.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Yt.add(t),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe(),it();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let C=new Set;f=w.checks.map((k,g)=>a.checks[g]?.filled&&!k.filled?i.has(k.label)?k:(C.add(k.label),{...k,filled:!0}):k),i=C}else i=new Set;a={status:f.every(C=>C.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},cl(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),ne(o,a),document.getElementById(jt)&&Vt(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},ne(o,a),oe();try{let y=await bl(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},ne(o,a),y.checks&&Vt(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},ne(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},ne(o,a),y.checks&&Vt(y.checks,y.previously_sent_at,o)}catch(y){p.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},ne(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById(jt)?oe():a.checks&&Vt(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let d,c=!1,b=Date.now(),m=1e4,h=5*60*1e3,v=0,x=async()=>{if(!c){if(Date.now()<v){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,b=Date.now();try{await s()}finally{c=!1}}};x();let E=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(E){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-b,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&x()},S)});w.observe(E,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},vl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_l=async()=>{for(let t of vl)try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Yt=new Set,Tn=null,yl=t=>{t&&t!==Tn&&(Yt.clear(),Tn=t)},Wt=!1,lr=async()=>{if(Wt){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Wt=!0;try{await gl()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Wt=!1}},gl=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Kt();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),yl(t.oppId),Yt.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe();return}let e=document.getElementById(pe);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(_e)?.remove(),oe(),it());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(_e)?.remove(),oe()),p.debug("[stc] mount:04 calling findMountTarget");let o=await _l();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Kt();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=ul(t.oppId,a.locationId),s=document.createElement("span");s.id=_e,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),fl(t.oppId)},at=null,sr=null,it=()=>{at?.disconnect(),at=null,sr=null},fl=t=>{if(at&&sr===t)return;it();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(sr=t,at=new MutationObserver(()=>{let o=Kt();if(!o||o.oppId!==t){it();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(pe)?.remove(),document.getElementById(_e)?.remove(),oe(),it();return}document.getElementById(pe)||lr()}),at.observe(e,{childList:!0,subtree:!0}))},ar=null,ir,wl=()=>{ar||(ar=new MutationObserver(()=>{ir===void 0&&(ir=window.setTimeout(()=>{ir=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(pe);if(t&&!e&&!Wt){let o=Kt();if(o&&Yt.has(o.oppId))return;lr()}},300))}),ar.observe(document.body,{childList:!0,subtree:!0}))},In=()=>{wl(),lr()};var Ln="ws-support-modal",An="ws-support-toast",xl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",$n="ws-support-submitter-name",Mn="ws-support-submitter-email",Dn="ws-support-submitter-role",kl=["Bug","Feature Request","Question","Billing","Onboarding Help"],ye=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),El=(t,e="success",o)=>{let r=document.getElementById(An);r&&r.remove();let a=document.createElement("div");a.id=An;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Tl=()=>{document.getElementById(Ln)?.remove();let t=(localStorage.getItem($n)??"").trim(),e=(localStorage.getItem(Mn)??"").trim(),o=(localStorage.getItem(Dn)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Ln,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=xe();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem($n,r.submitterName),localStorage.setItem(Mn,r.submitterEmail),r.submitterRole&&localStorage.setItem(Dn,r.submitterRole)}catch{}let b=i.querySelector("#ws-support-submit");b&&(b.disabled=!0,b.textContent="Submitting\u2026",b.style.opacity="0.7");try{let h=await(await fetch(xl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";El(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),b&&(b.disabled=!1,b.textContent="Submit Ticket",b.style.opacity="1")}})},Sl=["/support-ticket","ws-support-modal","ws-support"],Cl=/\/custom-menu-link\//,dr=!1,On=()=>{if(dr||!Cl.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Sl.some(s=>i.includes(s))});if(r){dr=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Tl(),dr=!1},50);return}t<10&&setTimeout(e,150)};e()},Hn=!1,Pn=()=>{Hn||(Hn=!0,ft(()=>setTimeout(On,50)),On(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Il="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ll="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Al="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Rn="ldtyB2UXKi9vOp8nLUH7",$l="WVD2gb9swLsgcdBEtDVq",re="ws-crm-closing-agent-picker-button",Nn="ws-crm-closing-agent-picker-modal",Ml=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Dl=/\/v2\/location\/([A-Za-z0-9]+)/,dt=()=>{let t=window.location.pathname,e=t.match(Ml);if(!e)return null;let o=t.match(Dl);return{oppId:e[1],locationId:o?o[1]:null}},_r=async t=>{let e=await fetch(Il,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Fn=async t=>{let e=await fetch(Ll,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ol=async(t,e)=>{try{let o=await fetch(Al,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:Rn}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await _r({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ge=null,Hl=60*60*1e3,yr=t=>`ws-crm-to-cache:${t}`,zn=t=>{try{let e=window.localStorage.getItem(yr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Hl||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Gn=(t,e,o)=>{try{window.localStorage.setItem(yr(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Pl=t=>{try{window.localStorage.removeItem(yr(t))}catch{}},hr="ws-crm-closing-agent-field-link",Fl=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${hr}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},cr=!1,gr=async t=>{if(cr)return;let e=qn();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){cr=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await _r({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),mr(a.id,a.name,t);let i=document.getElementById(re);if(i){be(i,{status:"linked",contactName:a.name});let s=dt();s&&Gn(s.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{cr=!1}}},Bl=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,qn=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();Bl.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let b of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(b);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:b,value:m})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return p.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},mr=(t,e,o)=>{let r=qn();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${hr}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=hr,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Xt=()=>{document.getElementById(Nn)?.remove()},Rl=t=>{Xt();let e=document.createElement("div");e.id=Nn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Xt()}),i?.addEventListener("click",Xt);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let b=await _r({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!b.ok||!Array.isArray(b.results)||b.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${Jt(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Jt(m.email||"(no email)")} \xB7 ${Jt(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Jt(m.companyName)}`:""}
          </div>
  ...
  `;let r={status:"loading"};be(o,r);let a=zn(t);return a&&(r={status:"linked",contactName:a.contactName},be(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Ol(t,e);s?(r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},mr(s.id,s.name,e)):a||(r={status:"empty"},be(o,r),ge?.oppId===t&&(ge=null),Fl(),Pl(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rl({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},be(o,r);try{let l=[Fn({tenantId:e,oppId:t,fieldId:Rn,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(Fn({tenantId:e,oppId:t,fieldId:$l,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},be(o,r),ge={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},Gn(t,s.id,s.name),mr(s.id,s.name,e),p.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){p.error("Closing Agent link failed",l),r={status:"empty"},be(o,r)}}})}),o},zl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Gl=async()=>{for(let t of zl)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},st=!1,Qt=async()=>{if(!st){st=!0;try{await ql()}finally{st=!1}}},ql=async()=>{let t=dt();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt();return}let e=document.getElementById(re);if(e&&e.dataset.oppId===t.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove(),Zt());return}e&&(e.remove(),document.getElementById(`${re}-wrap`)?.remove());let o=M();if(o!==null&&o!=="Transaction Coordination")return;let r=await Gl();if(!r||!(zn(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await N()!=="Transaction Coordination")return;let i=dt();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Nl(t.oppId,i.locationId),l=document.createElement("span");l.id=`${re}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Ul(t.oppId),gr(i.locationId)},lt=null,ur=null,vr=null,Zt=()=>{lt?.disconnect(),lt=null,ur=null,vr=null},Ul=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(lt&&ur===t&&vr===e||(Zt(),ur=t,vr=e,lt=new MutationObserver(()=>{let o=dt();if(!o||o.oppId!==t||!o.locationId){Zt();return}document.getElementById(re)||Qt(),gr(o.locationId)}),lt.observe(e,{childList:!0,subtree:!0})))},pr=null,br,Vl=()=>{pr||(pr=new MutationObserver(()=>{br===void 0&&(br=window.setTimeout(()=>{br=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(re);t&&!e&&!st&&Qt()},300))}),pr.observe(document.body,{childList:!0,subtree:!0}))},Bn,Wl=()=>{Bn===void 0&&(Bn=window.setInterval(()=>{let t=dt();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(re)&&!st&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Qt()),gr(t.locationId)},2e3))},Un=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Vl(),Wl(),Qt()};var jl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",$e="ws-crm-manage-team-cta",Wn="ws-crm-manage-team-modal",Kl=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,jn={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Yl={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Kn=()=>{let t=window.location.pathname.match(Kl);return t?{tenantId:t[1]}:null},to=async t=>{let e=await fetch(jl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},X=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),he=t=>X(t),fr="ws-crm-manage-team-toast",kr=(t,e="info",o=4e3)=>{document.getElementById(fr)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=fr,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(fr)===a&&a.remove()},o)},wr=()=>{document.getElementById(Wn)?.remove()},Xl=(t,e)=>{let o=Yl[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${X(e)}</span>
  `},Jl=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Xl(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    ...
    ">
      <div>
        ...
        <div style="font-size: 12px; color: ${n.ash};">
          ${X(t.email)}${t.phone?` &middot; ${X(t.phone)}`:""}
        </div>
      </div>
  ...
  `+t.map(r=>Jl(r,e)).join(""),oo=async t=>{wr();let e=document.createElement("div");e.id=Wn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&wr()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",wr);let r;try{r=await to({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          Failed to load roster: ${X(d.message)}
        </div>
      `);return}if(!r.ok||!r.roster){let d=o.querySelector("#ws-team-content");d&&(d.innerHTML=`
        <div style="padding: 40px; text-align: center; color: ${n.crimson};">
          ${X(r.error||"Unknown error loading roster")}
        </div>
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Zl(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Ql(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;ed(t,{email:b.dataset.email||"",name:b.dataset.name||"",currentRoles:(b.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let b=c.currentTarget;td(t,{email:b.dataset.email||"",name:b.dataset.name||"",roleCount:parseInt(b.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
      ...
      `)}},Ql=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${X(jn[s])}</span>
      </label>
    `};a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 4px;">${X(e.name)}</div>
    <div style="font-size: 12px; color: ${n.ash}; margin-bottom: 16px;">${X(e.email)}</div>
  ...
  `,a.innerHTML=`
    ...
    <div style="font-size: 18px; font-weight: 500; margin-bottom: 12px;">${X(e.name)}</div>
    <div style="font-size: 13px; color: ${n.bone}; line-height: 1.5; margin-bottom: 8px;">
      ${X(e.email)} will be removed from all ${e.roleCount} role${e.roleCount===1?"":"s"}.
    </div>
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await to({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:L()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),kr(`Removed ${e.name} from the team.`,"success"),await oo(t)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},od=89,rd=93,nd=310,ad=34,id=14,sd=14,ld=3,eo=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+od;t.style.right=`${Math.max(r,16)}px`},Vn=t=>{let e=document.createElement("button");return e.id=$e,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${rd}px;
    right: 24px;
    width: ${nd}px;
  ...
  `,e.addEventListener("click",()=>{oo(t)}),eo(e),setTimeout(()=>eo(e),200),setTimeout(()=>eo(e),800),window.addEventListener("resize",()=>eo(e)),e},dd=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],cd=async()=>{for(let t of dd)try{let e=await A(t,{timeoutMs:1500});if(e)return e}catch{}return null},xr=!1,pd=async()=>{if(!xr){xr=!0;try{let t=Kn();if(!t){document.getElementById($e)?.remove();return}let e=document.getElementById($e);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await cd();if(!o){let i=document.createElement("div");i.id=`${$e}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=Vn(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),p.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=Vn(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),p.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{xr=!1}}},Yn=()=>{if(!Kn()){document.getElementById($e)?.remove(),document.getElementById(`${$e}-floater`)?.remove();return}pd()};var bd="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Sr="ws-crm-prepare-contract-button",Xn="ws-crm-prepare-contract-menu",ie="ws-crm-prepare-contract-modal",Jn="ws-crm-modal-date-style",le="https://services.leadconnectorhq.com",oa=()=>{if(document.getElementById(Jn))return;let t=document.createElement("style");t.id=Jn,t.textContent=`
  ...
  `,document.head.appendChild(t)},Cr="__WS_CRM_CAPTURED_AUTH",hd=50*60*1e3,ra=()=>{try{let t=localStorage.getItem(Cr);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>hd?(localStorage.removeItem(Cr),null):e:null}catch{return null}},md=t=>{try{localStorage.setItem(Cr,JSON.stringify(t))}catch{}},de=()=>{let t=ra(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Zn=!1,ud=()=>{if(Zn)return;Zn=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let b=d.authorization||d.Authorization;if(!b){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=ra()?.authorization;md({authorization:b,tokenId:m,capturedAt:Date.now()}),h!==b&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${b.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let b=c.headers;!b&&l[0]instanceof Request&&(b=l[0].headers);let m={};if(b instanceof Headers)b.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(b))b.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(b&&typeof b=="object")for(let h of Object.keys(b))m[h.toLowerCase()]=b[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},na=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},vd=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:na()},_d=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},aa="__WS_CRM_TEMPLATES_CACHE_V1",yd=24*60*60*1e3,Qn=t=>{try{let e=window.localStorage.getItem(aa);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>yd?null:o.templates}catch{return null}},gd=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(aa,JSON.stringify(o))}catch{}},fd=async t=>{let e=`${le}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:de()})}catch(s){let l=Qn(t);if(l)return p.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=Qn(t);if(s)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:_d(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&gd(t,i),i},wd=async(t,e)=>{let o=await fetch(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:de()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},xd=async(t,e)=>{let o=await fetch(`${le}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${le}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:de()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let b=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-b})},kd=async t=>{let e=await fetch(bd,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Ed=async(t,e,o)=>{let r=`${le}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:de()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Td=async(t,e)=>{let o=await fetch(`${le}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:de()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Sd=async t=>{let e=await fetch(`${le}/contacts/${t}`,{method:"GET",headers:de()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Cd=async(t,e,o,r)=>{let a;try{a=await Td(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await Sd(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},b=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:b,grandTotal:a.grandTotal},h=await fetch(`${le}/proposals/document/${e}`,{method:"PUT",headers:{...de(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},Id=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},no="__WS_CRM_PENDING_INSTRUCTIONS",Ld=60*1e3,Ad=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],$d=t=>{let e=(t||"").toLowerCase();for(let o of Ad)if(e.includes(o.matches.toLowerCase()))return o;return null},Md=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(no,JSON.stringify(r))}catch{}},Dd=()=>{try{let t=localStorage.getItem(no);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Ld?(localStorage.removeItem(no),null):e}catch{return null}},Od=()=>{try{localStorage.removeItem(no)}catch{}},Hd=(t,e)=>{document.getElementById(ie)?.remove();let o=document.createElement("div");o.id=ie,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Pd=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Fd=()=>{let t=window.location.pathname.match(Pd);if(!t)return;let e=t[1],o=Dd();o&&o.proposalId===e&&(Od(),window.setTimeout(()=>{Hd(o.title,o.bodyHtml)},600))},ea="ws-crm-prepare-contract-toast",z=(t,e="info",o=4e3)=>{document.getElementById(ea)?.remove();let r=document.createElement("div");r.id=ea;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},ta=(t,e)=>new Promise(o=>{document.getElementById(ie)?.remove();let r=document.createElement("div");r.id=ie,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,O=R=>['<option value="">(unset)</option>'].concat(E.map(G=>`<option value="${ae(G)}"${G===R?" selected":""}>${W(G)}</option>`)).join("");y.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${g}">
        ...
        <select id="ws-pc-current-occupancy" style="${I}">${O(v)}</select>
      </div>
      <div style="${g}">
        <div style="${f}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${I}">${O(x)}</select>
      </div>
  ...
  `,w.appendChild(y),document.body.appendChild(w);let B=y.querySelector("#ws-pc-purchase-price"),K=y.querySelector("#ws-pc-emd"),V=y.querySelector("#ws-pc-cash-at-close"),P=!1;V?.addEventListener("input",()=>{P=!0});let Me=()=>{if(P)return;let R=Number(B?.value||0),G=Number(K?.value||0);V&&(V.value=String(Math.max(0,R-G)))};B?.addEventListener("input",Me),K?.addEventListener("input",Me);let vt=()=>w.remove();w.addEventListener("click",R=>{R.target===w&&vt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",vt);let Y=y.querySelector("#ws-pc-submit"),j=y.querySelector("#ws-pc-error");Y?.addEventListener("click",async()=>{if(Y){j&&(j.textContent=""),Y.disabled=!0,Y.textContent="Opening\u2026";try{let R=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),G=Number(B?.value||0),De=Number(K?.value||0),Oe=Number(V?.value||0),He=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Pe=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Fe=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),we=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Be=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),q={};if(R!==s&&(q.sellerName=R),G!==l&&(q.purchasePrice=G),De!==d&&(q.emd=De),Oe!==c&&(q.cashAtClose=Oe),He!==b&&(q.daysToClose=He),Pe!==m&&(q.inspectionDays=Pe),Fe!==h&&(q.additionalTerms=Fe),we!==v&&(q.currentOccupancy=we),Be!==x&&(q.occupancyAtClose=Be),Object.keys(q).length>0){p.info("[prepare-contract] PA modal submit with overrides:",q),Y.textContent="Saving\u2026";let uo=L(),vo=await ao({tenantId:t,contactId:e,template:o,userId:uo,overrides:q});p.info("[prepare-contract] re-stage with overrides ok:",vo),Y.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let U=i?`${i} - Purchase Agreement`:void 0;await Ar(t,e,o,U)}catch(R){Y.disabled=!1,Y.textContent="Open Contract",j&&(j.textContent=R.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",R)}}})},Rd=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ie)?.remove(),oa();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",b=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,x=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,E=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,S="",C=document.createElement("div");C.id=ie,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;k.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${B}">
        ...
        <div style="${K}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-assignment-fee" type="number" min="0" step="0.01" value="${v}" style="${I}" />
        </div>
      </div>
      <div style="${B}">
  ...
  `,C.appendChild(k),document.body.appendChild(C);let V=k.querySelector("#ws-pc-assignment-price"),P=k.querySelector("#ws-pc-assignment-fee"),Me=!1;P?.addEventListener("input",()=>{Me=!0});let vt=()=>{if(Me)return;let G=Number(V?.value||0);P&&(P.value=String(Math.max(0,G-x)))};V?.addEventListener("input",vt);let Y=()=>C.remove();C.addEventListener("click",G=>{G.target===C&&Y()}),k.querySelector("#ws-pc-cancel")?.addEventListener("click",Y);let j=k.querySelector("#ws-pc-submit"),R=k.querySelector("#ws-pc-error");j?.addEventListener("click",async()=>{if(!j)return;R&&(R.textContent="");let G=(k.querySelector("#ws-pc-seller-name")?.value||"").trim(),De=Number(V?.value||0),Oe=Number(k.querySelector("#ws-pc-buyer-emd")?.value||0),He=Number(P?.value||0),Pe=(k.querySelector("#ws-pc-closing-office")?.value||"").trim(),Fe=(k.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),we=(k.querySelector("#ws-pc-closing-date")?.value||"").trim(),Be=(k.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),q=(k.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!we){R&&(R.textContent="Closing Date is required.");return}j.disabled=!0,j.textContent="Opening\u2026";try{let U={};G!==b&&(U.sellerName=G),De!==m&&(U.assignmentPrice=De),Oe!==h&&(U.buyerEMD=Oe),He!==v&&(U.assignmentFee=He),Pe!==E&&(U.closingOffice=Pe),Fe!==w&&(U.buyerCompanyName=Fe);let uo=we!==y||Be!==f||q!==S,vo=Object.keys(U).length>0||uo,_o=a;vo?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",U),j.textContent="Saving\u2026",_o=await ao({tenantId:t,contactId:e,template:o,oppId:r,closingDate:we,buyerEarnestDueDate:Be,lenderSource:q,userId:i,overrides:Object.keys(U).length>0?U:void 0}),p.info("[prepare-contract] AA re-stage ok:",_o),j.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let Or=_o?.debug?.propertyAddress||c,Aa=Or?`${Or} - Assignment Agreement`:void 0;await Ar(t,e,o,Aa),Y()}catch(U){j.disabled=!1,j.textContent="Open Contract",R&&(R.textContent=U.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",U)}})},ao=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await kd({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Ar=async(t,e,o,r)=>{p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Ed(t,o.id,e);p.info(`[prepare-contract] proposal created: ${a}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Cd(t,a,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${a}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),z(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=$d(o.name);s&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Md(a,s.title,s.bodyHtml)),Id(t,a)},Nd=async t=>{let e=vd(t);if(!e){z("Could not resolve contact context.","error");return}document.getElementById(Xn)?.remove();let o=document.createElement("div");o.id=Xn,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await fd(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),p.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let b;if(e.oppId)b=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${b} directly`);else{let y;try{y=await xd(e.tenantId,e.contactId)}catch(f){z(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){z("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)b=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${b} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await ta(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}b=f,p.info(`[prepare-contract] picked MT opp ${b}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${C}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),x=h(7);z("Reading contract data\u2026","info",2500);let E;try{E=await ao({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:b,closingDate:v,buyerEarnestDueDate:x,userId:c})}catch(y){z(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||E.contact_id||"";if(!w){z("Could not resolve buyer contact for this opp.","error",6e3);return}Rd({tenantId:e.tenantId,contactId:w,template:i,oppId:b,staged:E,userId:c,defaultClosingDate:v,defaultEMDDueDate:x})}else if(i.type==="PA"){if(!e.contactId){z("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let b;try{b=await wd(e.tenantId,e.contactId)}catch(v){z(`Failed to load ACQ opps: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",v);return}if(b.length===0){z("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(b.length===1)m=b[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${b.length} opps)`);let v=await ta(b,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){p.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,p.info(`[prepare-contract] picked ACQ opp ${m}`)}z("Reading contract data\u2026","info",2500);let h;try{h=await ao({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){z(`Failed to prepare contract: ${v.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",v);return}Bd({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){z("This template needs to be started from a contact page.","error",6e3);return}z(`Opening ${i.name}\u2026`,"info",2500);try{await Ar(e.tenantId,e.contactId,i)}catch(b){z(`Failed to open contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",b)}}}catch(b){p.warn("[prepare-contract] picker click handler failed:",b),z(`Unexpected error: ${b.message}`,"error",6e3)}}),o.appendChild(s)}},ia=()=>{let t=document.createElement("button");return t.id=Sr,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Nd(t)}),t},zd="ws-crm-contact-actions-bar",Gd=async()=>{let t=na();if(!t){document.getElementById(Sr)?.remove();return}let e=null;try{e=await A(`#${zd}`,{timeoutMs:3e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Sr);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=ia();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},fe="ws-crm-prepare-contract-button-opp",ct=`${fe}-wrap`,qd=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ud=/\/v2\/location\/([A-Za-z0-9]+)/,Vd=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ir=()=>{let t=window.location.pathname,e=t.match(qd);if(!e)return null;let o=t.match(Ud);return o?{oppId:e[1],tenantId:o[1]}:null},Wd=async()=>{for(let t of Vd)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ro=!1,pt=null,Lr=null,Er=null,Tr,bt=()=>{pt?.disconnect(),pt=null,Lr=null},jd=t=>{if(pt&&Lr===t)return;bt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Lr=t,pt=new MutationObserver(()=>{let o=Ir();if(!o||o.oppId!==t){bt();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(fe)?.remove(),document.getElementById(ct)?.remove(),bt();return}document.getElementById(fe)||sa()}),pt.observe(e,{childList:!0,subtree:!0}))},Kd=()=>{Er||(Er=new MutationObserver(()=>{Tr===void 0&&(Tr=window.setTimeout(()=>{Tr=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);t&&!e&&!ro&&sa()},300))}),Er.observe(document.body,{childList:!0,subtree:!0}))},sa=async()=>{if(!ro){ro=!0;try{let t=Ir();if(!t){document.getElementById(fe)?.remove(),document.getElementById(ct)?.remove(),bt();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(ct)?.remove(),bt());return}e&&(e.remove(),document.getElementById(ct)?.remove());let o=await Wd();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await N();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ir();if(!a||a.oppId!==t.oppId)return;let i=ia();i.id=fe,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=ct,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),jd(t.oppId)}finally{ro=!1}}},la=()=>{Fd(),Gd()};ud();function W(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ae(t){return W(t)}var bo="reos-theme-stylesheet",Sa="reos-theme-fonts",Yd=()=>{let t=document.getElementById(Sa);t&&t.remove()},Xd=`
/* ============================================
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var F=(t,e)=>{try{p.info(`[main] calling ${t}`),e(),p.info(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},La=()=>{if(p.info(`Loaded v${wt} (built ${xt})`),yo()){p.info(`[main] customizer disabled for excluded location ${xe()} \u2014 bailing`);return}F("mountVersionBadge (initial)",mo),F("mountFavicon",pn),F("mountThemeStylesheet",Ca),F("initPageRouter",Fr),p.info("[main] registering onPageChange subscriber"),ft(t=>{if(p.info(`[main] onPageChange callback fired for page=${t}`),yo()){p.info(`[main] page change into excluded location ${xe()} \u2014 skipping mounts`);return}F("mountVersionBadge",mo),F("mountClaimReleaseToggle",Qr),F("mountContactActionsBar",dn),F("mountActiveFollowUpButton",qr),F("mountMtOfferMadeButton",hn),F("mountNotInterestedButton",mn),F("mountResendDealLinkButton",vn),F("mountReducePriceButton",gn),F("mountEditLandingPageButton",fn),F("mountPublishButton",kn),F("mountSendToClosingOfficeButton",In),F("mountClosingAgentPickerButton",Un),F("mountPrepareContractButton",la),F("mountManageTeam",Yn),F("mountBuyBoxWidget",Yr),F("mountSupportNavItem",Pn)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",La):La();})();
