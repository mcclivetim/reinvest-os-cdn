/* Wholesaling CRM Customizer v0.20.0 — built 2026-06-02T14:46:19.331Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var it="[wholesaling-crm-customizer]",ta="__WS_CRM_DEBUG",oa=()=>!!window[ta],b={info(...t){console.log(it,...t)},warn(...t){console.warn(it,...t)},error(...t){console.error(it,...t)},debug(...t){oa()&&console.log(it,"[debug]",...t)}};var ra=/\/v2\/location\/([A-Za-z0-9]+)/,na=new Set(["8ntUQzMflUkR0YvrRgVk"]),fe=()=>{let t=window.location.pathname.match(ra);return t?t[1]:null},to=()=>{let t=fe();return t!==null&&na.has(t)};var cr=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,oo=/\/v2\/location\/([A-Za-z0-9]+)/,aa=t=>{let e=t.match(cr);if(!e)return null;let o=t.match(oo);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},ia=()=>{let t=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(cr);if(!a)continue;let i=r.match(oo)||window.location.pathname.match(oo);return{contactId:a[1],locationId:i?i[1]:null,source:"dom"}}return null},M=()=>{let t=aa(window.location.pathname);return t||ia()};var br=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities/")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},lt="",ro=null,we="other",no=new Set,st=()=>{let t=M()?.contactId??null;if(!(!(window.location.pathname!==lt)&&!(t!==ro))){lt=window.location.pathname,ro=t,we=br(),b.debug("Page/context changed:",we,lt,"contact:",t);for(let r of no)try{r(we)}catch(a){b.error("Subscriber threw:",a)}}},dt=t=>(no.add(t),setTimeout(()=>t(we),0),()=>{no.delete(t)}),pr=()=>{we=br(),lt=window.location.pathname,ro=M()?.contactId??null,b.debug("Router init, current page:",we);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),st()},history.replaceState=function(o,r,a){e(o,r,a),st()},window.addEventListener("popstate",st),setInterval(st,1e3)};var ct="0.20.0",bt="2026-06-02T14:46:19.332Z";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((i,s)=>{let l=a.querySelector(t);if(l){i(l);return}let d,c,p=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=a.querySelector(t);h&&(p(),i(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=a.querySelector(t);h&&(p(),i(h))},r),d=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${t}`),s(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},u={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},ao={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},hr=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,$=`
  ...
  flex-shrink: 0;
`;var sa=/^[A-Za-z0-9]{15,30}$/,De=t=>typeof t=="string"&&sa.test(t),la=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},da=()=>{let t=window.WS_CRM_USER_ID;return De(t)?t:null},ca=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(De(o))return o;return null},ba=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=la(e);if(!o)return null;let r=o.uid;if(De(r))return r;let a=o.claims;if(a&&De(a.user_id))return a.user_id}catch{}return null},pa=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(De(a))return a}catch{}}}catch{}return null},L=()=>da()||ca()||ba()||pa()||null;var _r="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ha=`${_r}/active-follow-up-get`,ma=`${_r}/active-follow-up-set`,he="ws-crm-active-follow-up-button",so={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},ua=()=>{let t=M();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},va=async t=>{let e=await fetch(ha,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},_a=async(t,e)=>{let o=await fetch(ma,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},me=(t,e)=>{let o=so[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},mr=t=>{let e=document.createElement("button");return e.type="button",e.id=he,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,me(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=ua();if(!(!r||r.contactId!==t)){me(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await _a(r,L()),i=a&&a.state&&a.state in so?a.state:"blue";me(e,i),b.info(`Active Follow Up set for ${t} \u2192 ${i}`)}catch(a){b.error("Active Follow Up Set webhook failed",a),me(e,"error"),setTimeout(()=>void pt(e,r),4e3)}}}),e},pt=async(t,e)=>{me(t,"loading");try{let o=await va(e),r=o&&o.state&&o.state in so?o.state:"gray",a=document.getElementById(he);if(!a||a.dataset.contactId!==e.contactId)return;me(a,r)}catch(o){b.warn("Active Follow Up Get webhook failed",o),me(t,"error")}},ya=[".central-panel","[class*='central-panel']"],io="ws-crm-contact-actions-bar",ga=async()=>{for(let t of ya)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},fa=async(t,e)=>{let o=e.querySelector(`#${io}`);if(!o)try{o=await A(`#${io}`,{timeoutMs:3e3,root:e})}catch{o=null}if(o){let i=e.querySelector("#ws-crm-afu-wrap");return i&&i.remove(),o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let i=e.querySelector(`#${io}`);i&&i.parentElement===e?e.insertBefore(a,i.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},wa=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let i=r.children[1];return i instanceof HTMLElement?i:r}e=r}return null},xa=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},ka=async t=>{if(t==="url"){let o=await ga();return o?{kind:"contact-detail",target:o}:null}let e=wa();return e?{kind:"conversations",target:e}:null},ur=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await fa(t,e.target);return o}return xa(t,e.target),"conversations-header"},Ea=async()=>{let t=M();if(!t||!t.locationId){document.getElementById(he)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(he);if(o&&o.dataset.contactId===e.contactId){pt(o,e);return}o&&o.remove();let r=await ka(t.source);if(!r){b.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=M();if(!a||a.contactId!==e.contactId)return;let i=mr(e.contactId),s=await ur(i,r);b.debug(`Active Follow Up mounted (${r.kind}/${s}) for ${e.contactId}`),vr();let l=document.getElementById(he)??i;pt(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(he);if(!(M()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=mr(e.contactId);ur(m,r).then(()=>{vr(),pt(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},Fe=null,yr=()=>{let t=M()?.contactId??null;if(Fe&&Fe.contactId===t)return;let e=Ea().finally(()=>{Fe?.promise===e&&(Fe=null)});Fe={contactId:t,promise:e}},vr=()=>{let t=document.querySelectorAll(`#${he}`);if(!(t.length<=1)){b.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var Ta="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Oe=new Map,ht=async(t,e)=>{if(!t)return null;if(Oe.has(t))return Oe.get(t)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let o=new AbortController,r=setTimeout(()=>o.abort(),1500);try{let a=`${Ta}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,i=await fetch(a,{method:"GET",headers:{Accept:"application/json"},signal:o.signal});if(clearTimeout(r),!i.ok)return b.warn(`Contact Type fetch returned ${i.status} for ${t}`),Oe.set(t,null),null;let l=((await i.json()).contact_type||"").toLowerCase().trim()||null;return Oe.set(t,l),b.debug(`Resolved Contact Type for ${t}: ${l??"(unset)"}`),l}catch(a){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${t}:`,a),Oe.set(t,null),null}};var mt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"?"other":"seller";var wr="ws-buybox-nav-icon",bo="ws-buybox-panel",gr="ws-buybox-modal",Sa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",po="https://mcclivetim.github.io/reinvest-os-cdn/geo",ut=null,He=null,Pe=null,co=async()=>{if(ut)return ut;try{let t=await fetch(`${po}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return ut=await t.json(),ut}catch(t){return b.error("[buy-box] failed to fetch states.json",t),[]}},Ca=async t=>{if(!He)try{let e=await fetch(`${po}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);He=await e.json()}catch(e){return b.error("[buy-box] failed to fetch counties.json",e),[]}return He?.[t]??[]},Ia=async t=>{if(!Pe)try{let e=await fetch(`${po}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);Pe=await e.json()}catch(e){return b.error("[buy-box] failed to fetch cities.json",e),[]}return Pe?.[t]??[]},ho=async t=>await(await fetch(Sa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Aa=(t,e)=>ho({tenant_id:t,action:"list",buyer_contact_id:e}),La=(t,e,o,r)=>ho({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),$a=(t,e)=>ho({tenant_id:t,action:"remove",entry_id:e}),F=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ma=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Da='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Fa='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Oa="nav.w-13, nav[class*='w-13']",Ha=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Pa=async()=>{try{return await A(Oa,{timeoutMs:2500})}catch{return null}},Na=async()=>{try{return await A(Ha,{timeoutMs:2500})}catch{return null}},Ba=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Ra=(t,e)=>{let o=document.createElement("div");return o.id=bo,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Ua(t,e,()=>mo(t,e))}),o},mo=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Aa(t,e),co()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${F(r.error||"Failed to load buy-box entries")}</div>`;return}Ga(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${F(r.message)}</div>`}},Ga=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let l=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(d=>e[d.key].length>0).map(d=>{let c=e[d.key].map(p=>{let m=d.key==="state"?Ma(p.geo_value,o):p.geo_value;return`
      ...
      `}).join("");t.innerHTML=l,t.querySelectorAll(".ws-buybox-remove").forEach(d=>{d.addEventListener("mouseenter",()=>{d.style.color=n.crimson}),d.addEventListener("mouseleave",()=>{d.style.color=n.ash}),d.addEventListener("click",()=>{let c=d.dataset.entryId||"",p=d.dataset.entryLabel||"this area";confirm(`Remove "${p}" from this buyer's buy-box?`)&&(d.disabled=!0,$a(r,c).then(m=>{if(!m.ok){alert(`Failed to remove: ${m.error||"unknown error"}`),d.disabled=!1;return}mo(r,a)}).catch(m=>{alert(`Network error: ${m.message}`),d.disabled=!1}))})})},vt=!1,xr=(t,e)=>{vt=e;let o=Ba(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=za,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",mo(t.tenantId,t.buyerContactId)):(t.iconBtn.className=kr,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},kr="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",za="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",qa=t=>{let e=document.createElement("button");return e.id=wr,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=kr,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Da.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!vt;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),xr(r,a)}),e},Ua=(t,e,o)=>{let r=document.getElementById(gr);r&&r.remove();let a=document.createElement("div");a.id=gr,a.style.cssText=`
  ...
  `,k=g=>{let E=g.find(I=>I.code===s.stateCode);return`
    ...
    `},T=g=>{i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=2,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>x(s.stateCode||""))},w=g=>{let E=s.granularity==="county"?He?.[s.stateCode||""]??[]:Pe?.[s.stateCode||""]??[];return`
  ...
  `,S=()=>{let g=i.querySelector("#ws-buybox-zip"),E=i.querySelector("#ws-buybox-err");g&&(g.addEventListener("input",()=>{g.value=g.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),g.addEventListener("keydown",I=>{I.key==="Enter"&&(I.preventDefault(),C())}),i.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{s.step=1,l()}),i.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>g.focus(),0))},C=async()=>{let g=i.querySelector("#ws-buybox-zip"),E=i.querySelector("#ws-buybox-err"),I=(g?.value||"").trim();if(!/^\d{5}$/.test(I)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await x(I)},x=async g=>{if(!s.granularity||!g)return;let E=i.querySelector("#ws-buybox-err"),I=i.querySelector("#ws-buybox-save");I&&(I.disabled=!0,I.textContent="Adding\u2026"),E&&(E.textContent="");try{let D=await La(t,e,s.granularity,g);if(!D.ok){E&&(E.textContent=D.error||"Failed to add entry."),I&&(I.disabled=!1,I.textContent="Add");return}o(),i.innerHTML=`
      ...
      `,setTimeout(()=>{s.step=1,s.granularity=null,s.stateCode=null,s.value=null,l()},900)}catch(D){E&&(E.textContent=`Network error: ${D.message}`),I&&(I.disabled=!1,I.textContent="Add")}};l()},lo=!1,xe=null,Ne=null,fr=()=>{document.getElementById(wr)?.remove(),document.getElementById(bo)?.remove(),Ne&&xe&&xe.nav.removeEventListener("click",Ne,!0),Ne=null,xe=null,vt=!1},Er=()=>{Va()},Va=async()=>{if(!lo){lo=!0;try{let t=M();if(!t){fr();return}let e=document.getElementById(bo);if(e&&e.dataset.buyerContactId===t.contactId&&xe)return;fr();let o=null;try{o=await ht(t.contactId,t.locationId)}catch(m){b.warn("[buy-box] Contact Type fetch failed",m);return}if(mt(o)!=="buyer")return;if(!t.locationId){b.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,i]=await Promise.all([Pa(),Na()]);if(!a||!i){b.warn("[buy-box] right-rail nav or panel area not found");return}let s=M();if(!s||s.contactId!==t.contactId)return;let l=Ra(t.locationId,t.contactId),d=qa(()=>xe),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:i,iconBtn:d,panel:l,nativePanelOriginalDisplay:""};xe=c;let p=a.querySelector(".flex.flex-col.items-center.gap-2");p?p.appendChild(d):a.appendChild(d),i.appendChild(l),Ne=m=>{let h=m.target;if(!h||c.iconBtn.contains(h))return;h.closest("button.sidebar-option-button")&&vt&&xr(c,!1)},a.addEventListener("click",Ne,!0),b.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{lo=!1}}};var de="ws-crm-claim-release-pill",Wa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",ja="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Ka=async t=>{let e=await fetch(Wa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Ya=async t=>{let e=await fetch(ja,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Cr=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ke=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=hr(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Xa=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=de,o.type="button",o.dataset.contactId=t,ke(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=M();if(!a||!a.locationId||a.contactId!==t)return;let i=L();if(!i){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=o.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>ke(o,r),2500);return}b.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${i}`);let s=r==="claim"?"release":"claim";ke(o,s),o.disabled=!0,o.style.opacity="0.8";try{let l=await Ya({contactId:t,locationId:a.locationId,userId:i,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:s;ke(o,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),ke(o,r);let d=o.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Tr=async(t,e)=>{try{let o=await Ka({contactId:e.contactId,locationId:e.locationId,userId:L()}),r=document.getElementById(de);if(!r||r.dataset.contactId!==e.contactId)return;let a=o?.mode==="release"?"release":"claim";ke(r,a)}catch(o){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",o)}},Ja=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Cr(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Sr=(t,e)=>{let o=Xa({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${de}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Za=async()=>{let t=M();if(!t){document.getElementById(de)?.remove();return}let e=document.getElementById(de);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await Ja(o),a=M();if(!a||a.contactId!==t.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Sr(r,t.contactId),b.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`);let i=document.getElementById(de);i&&t.locationId&&Tr(i,{contactId:t.contactId,locationId:t.locationId});let s=null;s=new MutationObserver(async()=>{if(!(M()?.contactId===t.contactId)){s?.disconnect();return}if(document.getElementById(de))return;let d=Cr(o);if(d){Sr(d,t.contactId);let c=document.getElementById(de);c&&t.locationId&&Tr(c,{contactId:t.contactId,locationId:t.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),s.observe(o,{childList:!0,subtree:!0})}catch(o){b.warn("Could not mount Claim/Release pill:",o)}}},Ir=()=>{Za()};var Fr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Qa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var ei="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",ti=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:i,kind:s})=>{let l=i||Fr,d;if(s==="buyer"){let p=Or.find(h=>h.label===o),m=p?p.value:o.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:t,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:o,triggered_by_user_id:r??""};a&&(p.dead_reason=a),d={contact_id:t,location:{id:e},customData:p}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},oi=async({contactId:t,tenantId:e})=>{let o=await fetch(ei,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()};var Ee="ws-crm-contact-actions-bar",ri="ws-crm-call-status-dropdown",Ar="ws-crm-offer-made-modal",ni=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Or=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],ai=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],ii=async()=>{for(let t of ai)try{let e=await A(t,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},si=({contactId:t,kind:e})=>{let o=e==="buyer"?Or:ni,r=e==="buyer"?Qa:Fr,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",i=document.createElement("div");i.id=ri,i.style.cssText="position: relative; flex-shrink: 0;";let s=document.createElement("button");s.type="button",s.style.cssText=$,s.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${ao[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${t}`);let p=s.firstElementChild,m=s.children[1],h=s.children[2];p&&(p.style.background=ao[d.color]),m&&(m.textContent=d.label),l.style.display="none";let k=M()?.locationId,T=L();if(!k){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=n.amber);return}if(e==="seller"&&d.color==="green"&&!T){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=n.amber);return}let w=h?.textContent??"\u25BE",y=async f=>{h&&(h.textContent="\u2026"),s.style.opacity="0.75";try{await ti({contactId:t,locationId:k,status:d.label,userId:T,deadReason:f,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=w),s.style.opacity="1"},900)}catch(S){b.warn("Call Status webhook failed:",S),h&&(h.textContent="\u2717"),m&&(m.style.color=n.amber),s.style.opacity="1",setTimeout(()=>{h&&(h.textContent=w),m&&(m.style.color=n.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let f=m?.textContent??"";bi(S=>{y(S)},()=>{m&&(m.textContent=f)});return}if(e==="seller"&&d.value==="appointment-booked"){let f=m?.textContent??"";try{(await oi({contactId:t,tenantId:k})).ok?await y():pi(()=>{y()},()=>{m&&(m.textContent=f)})}catch(S){b.warn("Appointment sanity check failed; firing anyway:",S),await y()}return}await y()}),l.appendChild(c)}),s.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{i.contains(d.target)||(l.style.display="none")}),i.appendChild(s),i.appendChild(l),i},li="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",di=async t=>{let e=await fetch(li,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ci=(t,e="seller")=>{document.getElementById(Ar)?.remove();let o=e==="seller",r=o?"Record Your Offer":"Record Buyer's Offer",a=o?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",i=o?n.emerald:n.amber,s=document.createElement("div");s.id=Ar,s.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>o.remove(),i=()=>{a(),e()};o.addEventListener("click",l=>{l.target===o&&i()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",i),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let s=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",s),i())};document.addEventListener("keydown",s)},Mr=(t,e)=>{let o=document.createElement("div");if(o.id=Ee,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=ie,r.textContent="Offer Made",r.addEventListener("click",()=>ci(t,e)),o.appendChild(r),o.appendChild(si({contactId:t,kind:e}))}return o},uo=!1,hi=()=>{document.querySelectorAll(`[id="${Ee}"]`).forEach(t=>t.remove())},Hr=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),uo){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}uo=!0;try{await mi()}finally{uo=!1}},mi=async()=>{let t=M();if(!t){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),hi();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`);let e="seller";try{let c=await ht(t.contactId,t.locationId),p=mt(c);p==="buyer"?e="buyer":p==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let o=M();if(!o||o.contactId!==t.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Ee}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let a=await ii();if(!a){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let i=M();if(!i||i.contactId!==t.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let s;try{s=Mr(t.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}s.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(s,a.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(Ee)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(M()?.contactId===t.contactId)){d?.disconnect();return}let p=document.querySelectorAll(`[id="${Ee}"]`);if(p.length>1){for(let m=1;m<p.length;m++)p[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${p.length-1} duplicate bar(s)`);return}if(p.length===0){let m=document.querySelector(".central-panel")||a,h=Mr(t.contactId,e);h.dataset.mountTarget=s.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),d.observe(a,{childList:!0})},Dr=null,ui=()=>{Dr===null&&(Dr=window.setInterval(()=>{let t=M();t&&(document.getElementById(Ee)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Hr()))},3e3))},Pr=()=>{ui(),Hr()};var _t="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",vi=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),Be="data-ws-crm-favicon",vo=t=>t.hasAttribute(Be),Nr=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return vi.has(e)},yt=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Nr(r)&&!vo(r)&&r.remove()});let e=document.head.querySelector(`link[${Be}="1"]`);e?e.href!==_t&&(e.href=_t):(e=document.createElement("link"),e.setAttribute(Be,"1"),e.rel="icon",e.type="image/png",e.href=_t,document.head.appendChild(e),b.debug("Favicon installed"));let o=document.head.querySelector(`link[${Be}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(Be,"apple"),o.rel="apple-touch-icon",o.href=_t,document.head.appendChild(o))},Br=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)yt();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),yt())},50)}new MutationObserver(r=>{let a=!1;for(let i of r)i.addedNodes.forEach(s=>{s instanceof HTMLLinkElement&&Nr(s)&&!vo(s)&&(a=!0)}),i.removedNodes.forEach(s=>{s instanceof HTMLLinkElement&&vo(s)&&(a=!0)});a&&yt()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,yt(),e>=5&&window.clearInterval(o)},1e3)};var _i=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],yi=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,gi=".hr-card.hr-modal.crm-opportunities-modal",O=()=>{let t=document.querySelector(gi);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(yi);if(a){let i=a[1];if(_i.includes(i))return i}}return null},Y=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=O();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var fi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",J="ws-crm-mt-offer-made-button",Rr="ws-crm-mt-offer-made-modal",wi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xi=/\/v2\/location\/([A-Za-z0-9]+)/,wt=()=>{let t=window.location.pathname,e=t.match(wi);if(!e)return null;let o=t.match(xi);return{oppId:e[1],locationId:o?o[1]:null}},ki=async t=>{let e=await fetch(fi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},gt=()=>{document.getElementById(Rr)?.remove()},Ei=t=>{gt();let e=document.createElement("div");e.id=Rr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=wt();!o||!o.locationId||o.oppId!==t||Ei({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=$)},4e3)}})}),e},Si=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ci=async()=>{for(let t of Si)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ft=!1,fo=async()=>{if(!ft){ft=!0;try{await Ii()}finally{ft=!1}}},Ii=async()=>{let t=wt();if(!t||!t.locationId){document.getElementById(J)?.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge();return}let e=document.getElementById(J);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge());return}e&&(e.remove(),document.getElementById(`${J}-wrap`)?.remove());let o=await Ci();if(!o){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=wt();if(!a||a.oppId!==t.oppId)return;let i=Ti(t.oppId),s=document.createElement("span");s.id=`${J}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Ai(t.oppId)},Re=null,go=null,Ge=()=>{Re?.disconnect(),Re=null,go=null},Ai=t=>{if(Re&&go===t)return;Ge();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(go=t,Re=new MutationObserver(()=>{let o=wt();if(!o||o.oppId!==t){Ge();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(J)?.remove(),document.getElementById(`${J}-wrap`)?.remove(),Ge();return}document.getElementById(J)||fo()}),Re.observe(e,{childList:!0,subtree:!0}))},_o=null,yo,Li=()=>{_o||(_o=new MutationObserver(()=>{yo===void 0&&(yo=window.setTimeout(()=>{yo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(J);t&&!e&&!ft&&fo()},300))}),_o.observe(document.body,{childList:!0,subtree:!0}))},Gr=()=>{Li(),fo()};var $i="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",Z="ws-crm-not-interested-button",Mi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Di=/\/v2\/location\/([A-Za-z0-9]+)/,kt=()=>{let t=window.location.pathname,e=t.match(Mi);if(!e)return null;let o=t.match(Di);return{oppId:e[1],locationId:o?o[1]:null}},Fi=async t=>{let e=await fetch($i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Oi=t=>{let e=document.createElement("button");return e.id=Z,e.type="button",e.dataset.oppId=t,e.style.cssText=$,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=kt();if(!o||!o.locationId||o.oppId!==t)return;let r=L(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let i=await Fi({oppId:o.oppId,locationId:o.locationId,userId:r});if(i?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,b.info(`Not Interested set for opp ${t} \u2192 ${i.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(i){b.error("Not Interested webhook failed",i),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Hi=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pi=async()=>{for(let t of Hi)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},xt=!1,Eo=async()=>{if(!xt){xt=!0;try{await Ni()}finally{xt=!1}}},Ni=async()=>{let t=kt();if(!t||!t.locationId){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),qe();return}let e=document.getElementById(Z);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove(),qe());return}e&&(e.remove(),document.getElementById(`${Z}-wrap`)?.remove());let o=await Pi();if(!o){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=kt();if(!a||a.oppId!==t.oppId)return;let i=Oi(t.oppId),s=document.createElement("span");s.id=`${Z}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Not Interested button on opp ${t.oppId}`),Bi(t.oppId)},ze=null,ko=null,qe=()=>{ze?.disconnect(),ze=null,ko=null},Bi=t=>{if(ze&&ko===t)return;qe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ko=t,ze=new MutationObserver(()=>{let o=kt();if(!o||o.oppId!==t){qe();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Z)?.remove(),document.getElementById(`${Z}-wrap`)?.remove(),qe();return}document.getElementById(Z)||Eo()}),ze.observe(e,{childList:!0,subtree:!0}))},wo=null,xo,Ri=()=>{wo||(wo=new MutationObserver(()=>{xo===void 0&&(xo=window.setTimeout(()=>{xo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Z);t&&!e&&!xt&&Eo()},300))}),wo.observe(document.body,{childList:!0,subtree:!0}))},zr=()=>{Ri(),Eo()};var Gi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",Q="ws-crm-reduce-price-button",qr="ws-crm-reduce-price-modal",zi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,qi=/\/v2\/location\/([A-Za-z0-9]+)/,St=()=>{let t=window.location.pathname,e=t.match(zi);if(!e)return null;let o=t.match(qi);return{oppId:e[1],locationId:o?o[1]:null}},Ui=async t=>{let e=await fetch(Gi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Et=()=>{document.getElementById(qr)?.remove()},Vi=t=>{Et();let e=document.createElement("div");e.id=qr,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),i=o.querySelector("#ws-reduce-cancel"),s=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),i?.click())};o.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&Et()}),i?.addEventListener("click",()=>{Et()}),s?.addEventListener("click",async()=>{if(!r||!a||!s)return;let d=r.value.trim();if(!d){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",i&&(i.disabled=!0);try{await Ui({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:L()}),Et(),t.onSuccess()}catch(p){b.error("Reduce Price webhook failed",p),a.textContent=p instanceof Error?p.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",i&&(i.disabled=!1)}})},Wi=(t,e)=>{let o=document.createElement("button");return o.id=Q,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=St();!r||!r.locationId||r.oppId!==t||Vi({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),i=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,i&&(i.style.background=n.emerald,i.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=$,i&&(i.style.background=n.amber,i.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},ji=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ki=async()=>{for(let t of ji)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Tt=!1,Io=async()=>{if(!Tt){Tt=!0;try{await Yi()}finally{Tt=!1}}},Yi=async()=>{let t=St();if(!t||!t.locationId){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ve();return}let e=document.getElementById(Q);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ve());return}e&&(e.remove(),document.getElementById(`${Q}-wrap`)?.remove());let o=await Ki();if(!o){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await Y();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=St();if(!a||a.oppId!==t.oppId)return;let i=Wi(t.oppId,t.locationId),s=document.createElement("span");s.id=`${Q}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Xi(t.oppId)},Ue=null,Co=null,Ve=()=>{Ue?.disconnect(),Ue=null,Co=null},Xi=t=>{if(Ue&&Co===t)return;Ve();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Co=t,Ue=new MutationObserver(()=>{let o=St();if(!o||o.oppId!==t){Ve();return}let r=O();if(r!==null&&r!=="Disposition"){document.getElementById(Q)?.remove(),document.getElementById(`${Q}-wrap`)?.remove(),Ve();return}document.getElementById(Q)||Io()}),Ue.observe(e,{childList:!0,subtree:!0}))},To=null,So,Ji=()=>{To||(To=new MutationObserver(()=>{So===void 0&&(So=window.setTimeout(()=>{So=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(Q);t&&!e&&!Tt&&Io()},300))}),To.observe(document.body,{childList:!0,subtree:!0}))},Ur=()=>{Ji(),Io()};var Ao="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Vr="deals.reinvestos.com";var ee="ws-crm-edit-landing-button",Zi=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Qi=/\/v2\/location\/([A-Za-z0-9]+)/,It=()=>{let t=window.location.pathname,e=t.match(Zi);if(!e)return null;let o=t.match(Qi);return{oppId:e[1],locationId:o?o[1]:null}},es=(t,e)=>{let o=new URL(`https://${Vr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ao);let r=L();return r&&o.searchParams.set("user",r),o.toString()},ts=(t,e)=>{let o=document.createElement("button");return o.id=ee,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=It();if(!r||!r.locationId||r.oppId!==t)return;if(!Ao){b.warn("[edit-landing] editor session key not configured in this build");return}let a=es(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let i=o.querySelector(".ws-elp-label");if(i){let s=i.textContent;i.textContent="Opening editor\u2026",setTimeout(()=>{i.textContent==="Opening editor\u2026"&&(i.textContent=s)},2500)}}),o},os=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rs=async()=>{for(let t of os)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ct=!1,Do=async()=>{if(!Ct){Ct=!0;try{await ns()}finally{Ct=!1}}},ns=async()=>{let t=It();if(!t||!t.locationId){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),je();return}let e=document.getElementById(ee);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove(),je());return}e&&(e.remove(),document.getElementById(`${ee}-wrap`)?.remove());let o=await rs();if(!o)return;let r=await Y();if(r!=="Disposition"){b.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=It();if(!a||a.oppId!==t.oppId)return;let i=ts(t.oppId,t.locationId),s=document.createElement("span");s.id=`${ee}-wrap`,s.style.cssText="display: inline-flex; align-items: center; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),as(t.oppId)},We=null,Mo=null,je=()=>{We?.disconnect(),We=null,Mo=null},as=t=>{if(We&&Mo===t)return;je();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Mo=t,We=new MutationObserver(()=>{let o=It();if(!o||o.oppId!==t){je();return}let r=O();if(r!==null&&r!=="Disposition"){document.getElementById(ee)?.remove(),document.getElementById(`${ee}-wrap`)?.remove(),je();return}document.getElementById(ee)||Do()}),We.observe(e,{childList:!0,subtree:!0}))},Lo=null,$o,is=()=>{Lo||(Lo=new MutationObserver(()=>{$o===void 0&&($o=window.setTimeout(()=>{$o=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ee);t&&!e&&!Ct&&Do()},300))}),Lo.observe(document.body,{childList:!0,subtree:!0}))},Wr=()=>{is(),Do()};var Yr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",ce="ws-crm-send-to-closing-office-button",ue="ws-crm-send-to-title-co-wrap",$t="ws-crm-stc-dropdown",ss=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ls=/\/v2\/location\/([A-Za-z0-9]+)/,Mt=()=>{let t=window.location.pathname,e=t.match(ss);if(!e)return null;let o=t.match(ls);return{oppId:e[1],locationId:o?o[1]:null}},ds=5*60*1e3,Xr=t=>`ws-crm-stc-cache:${t}`,cs=t=>{try{let e=window.localStorage.getItem(Xr(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>ds||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},bs=(t,e)=>{try{window.localStorage.setItem(Xr(t),JSON.stringify(e))}catch{}},ps=async(t,e)=>{try{let o=await fetch(Yr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(b.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return b.warn("[stc] dry_run fetch failed:",o),null}},hs=async(t,e,o)=>{let r=await fetch(Yr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:L()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},ms=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return b.warn(`[stc] folder tab not found for "${t}"`),!1},jr=t=>{let e=document.getElementById(t);if(!e){b.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},us=(t,e)=>{if(e&&ms(e)){window.setTimeout(()=>jr(t),300);return}jr(t)},te=()=>{document.getElementById($t)?.remove()},At=(t,e,o)=>{te();let r=document.createElement("div");r.id=$t;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],p={};t.forEach(v=>{p[v.group]||(p[v.group]=[]),p[v.group].push(v)});let m=[...c.filter(v=>p[v]),...Object.keys(p).filter(v=>!c.includes(v))];for(let v of m){let k=p[v],T=document.createElement("div");T.style.cssText="margin-top: 12px;";let w=document.createElement("div");w.style.cssText=`
    ...
    `,w.textContent=v,T.appendChild(w),k.forEach(y=>{let f=document.createElement("div"),S=!y.filled&&y.navigable&&y.field_id;f.style.cssText=`
        ...
        ${S?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,S&&(f.addEventListener("mouseenter",()=>{f.style.background=n.slate}),f.addEventListener("mouseleave",()=>{f.style.background="transparent"}),f.addEventListener("click",g=>{g.stopPropagation(),y.field_id&&(us(y.field_id,y.folder),te())}));let C=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,x=S?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";f.innerHTML=`${C}<span style="flex: 1;">${y.label}</span>${x}`,T.appendChild(f)}),r.appendChild(T)}document.body.appendChild(r);let h=v=>{let k=v.target;!r.contains(k)&&!o.contains(k)&&(te(),document.removeEventListener("click",h))};window.setTimeout(()=>document.addEventListener("click",h),0)},re=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),i,s,l=n.bone,d,c="Send to Closing Office",p="",m="pointer",h="1";switch(e.status){case"checking":i="transparent",s=n.steel,l=n.ash,d=n.coolGray,c="Checking\u2026",m="wait",h="0.8";break;case"ready":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let v=e.checks?.filter(T=>T.filled).length??0,k=e.checks?.length??0;i="transparent",s=n.amber,l=n.amber,d=n.amber,c=`${v} of ${k} fields ready`,p="\u25BE";break}case"sending":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",h="0.8";break;case"sent":i=n.emerald,s=n.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":i="transparent",s=n.amber,l=n.amber,d=n.amber,c=e.message??"Try again";break}t.style.background=i,t.style.borderColor=s,t.style.color=l,t.style.cursor=m,t.style.opacity=h,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),o&&(o.textContent=c),a&&(a.textContent=p)},vs=(t,e)=>{let o=document.createElement("button");o.id=ce,o.type="button",o.dataset.oppId=t;let r=cs(t),a=r?{status:r.checks.every(w=>w.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${ie}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,re(o,a);let i=new Set,s=async()=>{if(a.status==="sending")return;let w=await ps(t,e);if(!w){a={status:"error",message:"Check failed \u2014 click to retry"},re(o,a);return}if(w.rate_limited){v=Date.now()+h,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},re(o,a),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(v).toLocaleTimeString()}`);return}if(!Array.isArray(w.checks)||w.checks.length===0){a={status:"error",message:w.error||"Check failed \u2014 click to retry"},re(o,a),b.warn("[stc] dry_run returned no checks:",w);return}let y=w.pipeline_name;if(y&&y!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${y}" (not TC) \u2014 retracting button + caching`),Dt.add(t),document.getElementById(ce)?.remove(),document.getElementById(ue)?.remove(),te(),Ye();return}let f=w.checks;if(a.checks&&a.checks.length===w.checks.length){let C=new Set;f=w.checks.map((x,g)=>a.checks[g]?.filled&&!x.filled?i.has(x.label)?x:(C.add(x.label),{...x,filled:!0}):x),i=C}else i=new Set;a={status:f.every(C=>C.filled)?"ready":"incomplete",checks:f,previouslySentAt:w.previously_sent_at??null},bs(t,{checks:f,previously_sent_at:w.previously_sent_at??null,pipeline_name:y,ts:Date.now()}),re(o,a),document.getElementById($t)&&At(f,w.previously_sent_at,o)},l=async()=>{let w=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},re(o,a),te();try{let y=await hs(t,e,w);if(y.needs_confirm){a={status:"ready",checks:y.checks,previouslySentAt:y.previously_sent_at},re(o,a),y.checks&&At(y.checks,y.previously_sent_at,o);return}if(y.ok){a={status:"sent",checks:y.checks,previouslySentAt:new Date().toISOString()},re(o,a),window.setTimeout(()=>{k()},3500);return}a={status:"error",checks:y.checks,message:y.error||"Validation failed"},re(o,a),y.checks&&At(y.checks,y.previously_sent_at,o)}catch(y){b.error("[stc] send failed:",y),a={status:"error",message:"Network error \u2014 click to retry"},re(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":l();break;case"incomplete":{document.getElementById($t)?te():a.checks&&At(a.checks,a.previouslySentAt,o);break}case"error":case"sent":k();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,v=0,k=async()=>{if(!c){if(Date.now()<v){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(v).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await s()}finally{c=!1}}};k();let T=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(T){let w=new MutationObserver(()=>{if(d!==void 0||c)return;let f=Date.now()-p,S=Math.max(1500,m-f);d=window.setTimeout(()=>{d=void 0,a.status!=="sending"&&k()},S)});w.observe(T,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let y=window.setInterval(()=>{document.body.contains(o)||(w.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(y))},5e3)}return o},_s=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ys=async()=>{for(let t of _s)try{let e=await A(t,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Dt=new Set,Kr=null,gs=t=>{t&&t!==Kr&&(Dt.clear(),Kr=t)},Lt=!1,Po=async()=>{if(Lt){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Lt=!0;try{await fs()}catch(t){b.error("[stc] ensureMountedImpl threw:",t)}finally{Lt=!1}},fs=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let t=Mt();if(!t||!t.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(ce)?.remove(),document.getElementById(ue)?.remove(),te();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),gs(t.oppId),Dt.has(t.oppId)){b.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(ce)?.remove(),document.getElementById(ue)?.remove(),te();return}let e=document.getElementById(ce);if(e&&e.dataset.oppId===t.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=O();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(ue)?.remove(),te(),Ye());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ue)?.remove(),te()),b.debug("[stc] mount:04 calling findMountTarget");let o=await ys();if(!o){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=O();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Mt();if(!a||a.oppId!==t.oppId||!a.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let i=vs(t.oppId,a.locationId),s=document.createElement("span");s.id=ue,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(i)}`),ws(t.oppId)},Ke=null,Ho=null,Ye=()=>{Ke?.disconnect(),Ke=null,Ho=null},ws=t=>{if(Ke&&Ho===t)return;Ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ho=t,Ke=new MutationObserver(()=>{let o=Mt();if(!o||o.oppId!==t){Ye();return}let r=O();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(ce)?.remove(),document.getElementById(ue)?.remove(),te(),Ye();return}document.getElementById(ce)||Po()}),Ke.observe(e,{childList:!0,subtree:!0}))},Fo=null,Oo,xs=()=>{Fo||(Fo=new MutationObserver(()=>{Oo===void 0&&(Oo=window.setTimeout(()=>{Oo=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ce);if(t&&!e&&!Lt){let o=Mt();if(o&&Dt.has(o.oppId))return;Po()}},300))}),Fo.observe(document.body,{childList:!0,subtree:!0}))},Jr=()=>{xs(),Po()};var Zr="ws-support-modal",Qr="ws-support-toast",ks="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",en="ws-support-submitter-name",tn="ws-support-submitter-email",on="ws-support-submitter-role",Es=["Bug","Feature Request","Question","Billing","Onboarding Help"],ve=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ts=(t,e="success",o)=>{let r=document.getElementById(Qr);r&&r.remove();let a=document.createElement("div");a.id=Qr;let i=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Ss=()=>{document.getElementById(Zr)?.remove();let t=(localStorage.getItem(en)??"").trim(),e=(localStorage.getItem(tn)??"").trim(),o=(localStorage.getItem(on)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Zr,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${u.sans};
  ...
  `,a.appendChild(i),document.body.appendChild(a),a.addEventListener("click",l=>{l.target===a&&a.remove()}),i.querySelectorAll(".ws-support-tile").forEach(l=>{l.addEventListener("mouseenter",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow)}),l.addEventListener("mouseleave",()=>{l.dataset.selected!=="true"&&(l.style.borderColor=n.steel,l.style.background=n.steel)}),l.addEventListener("click",()=>{r.category=l.dataset.category||null,i.querySelectorAll(".ws-support-tile").forEach(d=>{d===l?(d.dataset.selected="true",d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow,d.style.color=n.emeraldBright):(d.dataset.selected="false",d.style.borderColor=n.steel,d.style.background=n.steel,d.style.color=n.bone)})})}),i.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),i.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let l=i.querySelector("#ws-support-err"),d=m=>{l&&(l.textContent=m)};if(d(""),r.title=(i.querySelector("#ws-support-title")?.value||"").trim(),r.description=(i.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(i.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(i.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(i.querySelector("#ws-support-role")?.value||"").trim(),!r.category){d("Pick a category at the top.");return}if(!r.title){d("Add a title \u2014 a short summary.");return}if(!r.description){d("Add a description so we know what you're seeing.");return}if(!r.submitterName){d("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){d("Add a valid email so we can reply.");return}let c=fe();if(!c){d("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(en,r.submitterName),localStorage.setItem(tn,r.submitterEmail),r.submitterRole&&localStorage.setItem(on,r.submitterRole)}catch{}let p=i.querySelector("#ws-support-submit");p&&(p.disabled=!0,p.textContent="Submitting\u2026",p.style.opacity="0.7");try{let h=await(await fetch(ks,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:L()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!h.ok){d(h.error||"Failed to submit ticket."),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1");return}a.remove();let v=h.ticket_short_id||"submitted";Ts(`Ticket ${v} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(m){d(`Network error: ${m.message}`),p&&(p.disabled=!1,p.textContent="Submit Ticket",p.style.opacity="1")}})},Cs=["/support-ticket","ws-support-modal","ws-support"],Is=/\/custom-menu-link\//,No=!1,rn=()=>{if(No||!Is.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let i=a.src||a.getAttribute("src")||"";return Cs.some(s=>i.includes(s))});if(r){No=!0,b.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Ss(),No=!1},50);return}t<10&&setTimeout(e,150)};e()},nn=!1,an=()=>{nn||(nn=!0,dt(()=>setTimeout(rn,50)),rn(),b.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var As="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Ls="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",$s="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",dn="ldtyB2UXKi9vOp8nLUH7",Ms="WVD2gb9swLsgcdBEtDVq",oe="ws-crm-closing-agent-picker-button",cn="ws-crm-closing-agent-picker-modal",Ds=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fs=/\/v2\/location\/([A-Za-z0-9]+)/,Ze=()=>{let t=window.location.pathname,e=t.match(Ds);if(!e)return null;let o=t.match(Fs);return{oppId:e[1],locationId:o?o[1]:null}},Wo=async t=>{let e=await fetch(As,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},sn=async t=>{let e=await fetch(Ls,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_id:t.fieldId,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Os=async(t,e)=>{try{let o=await fetch($s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_id:dn}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let i=await Wo({tenantId:e,contactId:a,limit:1});if(!i.ok||!i.results.length)return null;let s=i.results[0];return{id:s.id,name:s.name,companyName:s.companyName??""}}catch(o){return b.warn("[closing-agent] fetchCurrent failed:",o),null}},_e=null,Hs=60*60*1e3,jo=t=>`ws-crm-to-cache:${t}`,bn=t=>{try{let e=window.localStorage.getItem(jo(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Hs||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},pn=(t,e,o)=>{try{window.localStorage.setItem(jo(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Ps=t=>{try{window.localStorage.removeItem(jo(t))}catch{}},zo="ws-crm-closing-agent-field-link",Ns=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${zo}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Bo=!1,Ko=async t=>{if(Bo)return;let e=hn();if(!e)return;let o=(e.value||"").trim();if(!o){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){b.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Bo=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Wo({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),qo(a.id,a.name,t);let i=document.getElementById(oe);if(i){be(i,{status:"linked",contactName:a.name});let s=Ze();s&&pn(s.oppId,a.id,a.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Bo=!1}}},Bs=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,hn=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let d of e){let c=(d.textContent||"").trim();Bs.test(c)?o.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&a.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&b.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let s=o[0].parentElement,l=0;for(;s&&l<8;){let d=s.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;s=s.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},qo=(t,e,o)=>{let r=hn();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${zo}`).forEach(s=>s.remove());{let i=r.parentElement;if(!i)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(i).position==="static"&&(i.style.position="relative");let l=document.createElement("a");l.className=zo,l.href=`/v2/location/${o}/contacts/detail/${t}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),i.appendChild(l)}}},Ft=()=>{document.getElementById(cn)?.remove()},Rs=t=>{Ft();let e=document.createElement("div");e.id=cn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),i=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ft()}),i?.addEventListener("click",Ft);let s,l="",d=async c=>{if(a&&c!==l){if(l=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let p=await Wo({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!p.ok||!Array.isArray(p.results)||p.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,h.innerHTML=`
          <div style="font-weight: 500;">${Ot(m.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${Ot(m.email||"(no email)")} \xB7 ${Ot(m.phone||"no phone")}
            ${m.companyName?` \xB7 ${Ot(m.companyName)}`:""}
          </div>
        `,h.addEventListener("mouseenter",()=>{h.style.background=n.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{Ft(),t.onPick(m)}),a.appendChild(h)})}catch(p){b.error("Closing Agent picker search failed",p),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;s!==void 0&&clearTimeout(s),s=window.setTimeout(()=>{d(c)},250)})},Ot=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),be=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",i=n.amber,s=n.bone,l="transparent",d=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",i=n.coolGray,s=n.ash,c="wait";break;case"empty":a="Link Closing Agent",i=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",i=n.emerald,l=n.emeraldGlow,d=n.emeraldBorder,s=n.emeraldBright;break;case"saving":a="Linking\u2026",i=n.coolGray,s=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=i,r.style.boxShadow=`0 0 6px ${i}`),t.style.background=l,t.style.borderColor=d,t.style.color=s,t.style.cursor=c},Gs=(t,e)=>{let o=document.createElement("button");o.id=oe,o.type="button",o.dataset.oppId=t,o.style.cssText=$,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};be(o,r);let a=bn(t);return a&&(r={status:"linked",contactName:a.contactName},be(o,r),_e={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let s=await Os(t,e);s?(r={status:"linked",contactName:s.name},be(o,r),_e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},qo(s.id,s.name,e)):a||(r={status:"empty"},be(o,r),_e?.oppId===t&&(_e=null),Ns(),Ps(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rs({oppId:t,locationId:e,onPick:async s=>{r={status:"saving"},be(o,r);try{let l=[sn({tenantId:e,oppId:t,fieldId:dn,value:s.id})];s.companyName&&s.companyName.trim()&&l.push(sn({tenantId:e,oppId:t,fieldId:Ms,value:s.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:s.name},be(o,r),_e={oppId:t,contactId:s.id,contactName:s.name,tenantId:e},pn(t,s.id,s.name),qo(s.id,s.name,e),b.info(`Closing Agent linked: ${s.name} (${s.id})${s.companyName?` \u2014 Company: ${s.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},be(o,r)}}})}),o},zs=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],qs=async()=>{for(let t of zs)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Xe=!1,Pt=async()=>{if(!Xe){Xe=!0;try{await Us()}finally{Xe=!1}}},Us=async()=>{let t=Ze();if(!t||!t.locationId){document.getElementById(oe)?.remove(),document.getElementById(`${oe}-wrap`)?.remove(),Ht();return}let e=document.getElementById(oe);if(e&&e.dataset.oppId===t.oppId){let d=O();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove(),Ht());return}e&&(e.remove(),document.getElementById(`${oe}-wrap`)?.remove());let o=O();if(o!==null&&o!=="Transaction Coordination")return;let r=await qs();if(!r||!(bn(t.oppId)!==null||_e!==null&&_e.oppId===t.oppId)&&await Y()!=="Transaction Coordination")return;let i=Ze();if(!i||i.oppId!==t.oppId||!i.locationId)return;let s=Gs(t.oppId,i.locationId),l=document.createElement("span");l.id=`${oe}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(s),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),Vs(t.oppId),Ko(i.locationId)},Je=null,Uo=null,Vo=null,Ht=()=>{Je?.disconnect(),Je=null,Uo=null,Vo=null},Vs=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Je&&Uo===t&&Vo===e||(Ht(),Uo=t,Vo=e,Je=new MutationObserver(()=>{let o=Ze();if(!o||o.oppId!==t||!o.locationId){Ht();return}document.getElementById(oe)||Pt(),Ko(o.locationId)}),Je.observe(e,{childList:!0,subtree:!0})))},Ro=null,Go,Ws=()=>{Ro||(Ro=new MutationObserver(()=>{Go===void 0&&(Go=window.setTimeout(()=>{Go=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(oe);t&&!e&&!Xe&&Pt()},300))}),Ro.observe(document.body,{childList:!0,subtree:!0}))},ln,js=()=>{ln===void 0&&(ln=window.setInterval(()=>{let t=Ze();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(oe)&&!Xe&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Pt()),Ko(t.locationId)},2e3))},mn=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Ws(),js(),Pt()};var Ks="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Te="ws-crm-manage-team-cta",vn="ws-crm-manage-team-modal",Ys=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,_n={manager:"Manager",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator"},Xs={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},yn=()=>{let t=window.location.pathname.match(Ys);return t?{tenantId:t[1]}:null},Bt=async t=>{let e=await fetch(Ks,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},X=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),pe=t=>X(t),Yo="ws-crm-manage-team-toast",Zo=(t,e="info",o=4e3)=>{document.getElementById(Yo)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Yo,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Yo)===a&&a.remove()},o)},Xo=()=>{document.getElementById(vn)?.remove()},Js=(t,e)=>{let o=Xs[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${X(e)}</span>
  `},Zs=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(s=>Js(s.key,s.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",i=e?"":'title="Manager-only action"';return`
    <div data-user-id="${pe(t.id)}" style="
      display: grid;
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${i}>
        <button class="ws-team-edit" data-email="${pe(t.email)}" data-user-id="${pe(t.id)}" data-name="${pe(o)}" data-current-roles="${pe(t.role_keys.join(","))}" style="${$} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${pe(t.email)}" data-name="${pe(o)}" data-role-count="${pe(String(t.role_keys.length))}" style="${$} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Qs=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>Zs(r,e)).join(""),Rt=async t=>{Xo();let e=document.createElement("div");e.id=vn,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${u.sans};
  `,e.addEventListener("click",d=>{d.target===e&&Xo()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Xo);let r;try{r=await Bt({tenant_id:t,action:"list"})}catch(d){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",l=o.querySelector("#ws-team-content");if(l&&(l.innerHTML=s+Qs(r.roster,i)),i)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{el(t)}),o.querySelectorAll(".ws-team-edit").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;tl(t,{email:p.dataset.email||"",name:p.dataset.name||"",currentRoles:(p.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(d=>{d.addEventListener("click",c=>{let p=c.currentTarget;ol(t,{email:p.dataset.email||"",name:p.dataset.name||"",roleCount:parseInt(p.dataset.roleCount||"0",10)})})});else{let d=o.querySelector("#ws-team-actions");d&&(d.innerHTML=`
  ...
  `;let i=s=>{let l=e.currentRoles.includes(s)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${X(_n[s])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let i=a.querySelector("#ws-team-remove-error"),s=a.querySelector("#ws-team-remove-submit");s&&(s.disabled=!0,s.textContent="Removing\u2026",s.style.opacity="0.7"),i&&(i.textContent="");try{let l=await Bt({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:L()});if(!l.ok){i&&(i.textContent=l.error||"Failed to remove"),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1");return}r.remove(),Zo(`Removed ${e.name} from the team.`,"success"),await Rt(t)}catch(l){i&&(i.textContent=l.message),s&&(s.disabled=!1,s.textContent="Remove from Team",s.style.opacity="1")}})},rl=89,nl=93,al=310,il=34,sl=14,ll=14,dl=3,Nt=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+rl;t.style.right=`${Math.max(r,16)}px`},un=t=>{let e=document.createElement("button");return e.id=Te,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${nl}px;
    right: 24px;
    width: ${al}px;
  ...
  `,e.addEventListener("click",()=>{Rt(t)}),Nt(e),setTimeout(()=>Nt(e),200),setTimeout(()=>Nt(e),800),window.addEventListener("resize",()=>Nt(e)),e},cl=[".hr-card-header__main",".hr-page-header__main",".page-header h1",".page-header h2","h1.page-title","h2.page-title",".staff-page-wrapper",".settings-content"],bl=async()=>{for(let t of cl)try{let e=await A(t,{timeoutMs:1500});if(e)return e}catch{}return null},Jo=!1,pl=async()=>{if(!Jo){Jo=!0;try{let t=yn();if(!t){document.getElementById(Te)?.remove();return}let e=document.getElementById(Te);if(e){if(e.dataset.tenantId===t.tenantId)return;e.remove()}let o=await bl();if(!o){let i=document.createElement("div");i.id=`${Te}-floater`,i.style.cssText=`
        position: fixed;
        top: 88px;
        right: 32px;
        z-index: 99999;
      `;let s=un(t.tenantId);s.dataset.tenantId=t.tenantId,i.appendChild(s),document.body.appendChild(i),b.debug(`[manage-team] mounted (floater fallback) for tenant ${t.tenantId}`);return}let r=un(t.tenantId);r.dataset.tenantId=t.tenantId;let a=document.createElement("span");a.style.cssText="display: inline-flex; align-items: center; margin-left: 16px; vertical-align: middle;",a.appendChild(r),o.appendChild(a),b.debug(`[manage-team] mounted on My Staff page for tenant ${t.tenantId}`)}finally{Jo=!1}}},gn=()=>{if(!yn()){document.getElementById(Te)?.remove(),document.getElementById(`${Te}-floater`)?.remove();return}pl()};var hl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",tr="ws-crm-prepare-contract-button",fn="ws-crm-prepare-contract-menu",ae="ws-crm-prepare-contract-modal",wn="ws-crm-modal-date-style",se="https://services.leadconnectorhq.com",Sn=()=>{if(document.getElementById(wn))return;let t=document.createElement("style");t.id=wn,t.textContent=`
  ...
  `,document.head.appendChild(t)},or="__WS_CRM_CAPTURED_AUTH",ml=50*60*1e3,Cn=()=>{try{let t=localStorage.getItem(or);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>ml?(localStorage.removeItem(or),null):e:null}catch{return null}},ul=t=>{try{localStorage.setItem(or,JSON.stringify(t))}catch{}},le=()=>{let t=Cn(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},xn=!1,vl=()=>{if(xn)return;xn=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let p=d.authorization||d.Authorization;if(!p){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,h=Cn()?.authorization;ul({authorization:p,tokenId:m,capturedAt:Date.now()}),h!==p&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${p.slice(0,24)}\u2026)`))},o=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){t.__WS_CRM_DIAG.fetchCalls++;let p=c.headers;!p&&l[0]instanceof Request&&(p=l[0].headers);let m={};if(p instanceof Headers)p.forEach((h,v)=>m[v.toLowerCase()]=h);else if(Array.isArray(p))p.forEach(([h,v])=>m[h.toLowerCase()]=v);else if(p&&typeof p=="object")for(let h of Object.keys(p))m[h.toLowerCase()]=p[h];e(d,m,"fetch")}return o.apply(this,l)};let r=XMLHttpRequest.prototype,a=r.open,i=r.setRequestHeader,s=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},a.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),i.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(t.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),s.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},In=()=>{let t=M();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},_l=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:In()},yl=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},An="__WS_CRM_TEMPLATES_CACHE_V1",gl=24*60*60*1e3,kn=t=>{try{let e=window.localStorage.getItem(An);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>gl?null:o.templates}catch{return null}},fl=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(An,JSON.stringify(o))}catch{}},wl=async t=>{let e=`${se}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await fetch(e,{method:"GET",headers:le()})}catch(s){let l=kn(t);if(l)return b.info(`[prepare-contract] templates network failure, using cache (${l.length} items)`),l;throw s}if(!o.ok){let s=kn(t);if(s)return b.info(`[prepare-contract] templates fetch ${o.status}, using cache (${s.length} items)`),s;let l="";try{l=await o.text()}catch{}let d=l?` \u2014 ${l.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${d}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let i=a.map(s=>({id:(s._id??s.id??s.templateId)||"",name:s.name||s.title||"(unnamed template)",type:yl(s.name||s.title||"")})).filter(s=>!!s.id);return i.length>0&&fl(t,i),i},xl=async(t,e)=>{let o=await fetch(`${se}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:le()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let i=await fetch(`${se}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:le()});if(!i.ok)throw new Error(`ACQ opp search ${i.status}`);return((await i.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},kl=async(t,e)=>{let o=await fetch(`${se}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:le()});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let i=await fetch(`${se}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:le()});if(!i.ok)throw new Error(`MT opp search ${i.status}`);return((await i.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let p=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-p})},El=async t=>{let e=await fetch(hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Tl=async(t,e,o)=>{let r=`${se}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:le()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let i=await a.json(),s=i._id||i.id||i.proposal?._id||i.proposal?.id;if(!s)throw new Error("to-proposal returned no proposal id");return s},Sl=async(t,e)=>{let o=await fetch(`${se}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:le()});if(!o.ok){let i=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${i.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Cl=async t=>{let e=await fetch(`${se}/contacts/${t}`,{method:"GET",headers:le()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Il=async(t,e,o,r)=>{let a;try{a=await Sl(t,e)}catch(v){return{ok:!1,body:`fetchProposalDocument: ${v.message}`}}let i;try{i=await Cl(o)}catch(v){return{ok:!1,body:`fetchContactBasics: ${v.message}`}}let s=`${i.firstName} ${i.lastName}`.trim()||i.email||o,l={id:o,firstName:i.firstName,lastName:i.lastName,email:i.email,contactName:s,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},p=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(v=>v?.entityName!=="contacts"),l],m={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:p,grandTotal:a.grandTotal},h=await fetch(`${se}/proposals/document/${e}`,{method:"PUT",headers:{...le(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!h.ok){let v=await h.text().catch(()=>"");return{ok:!1,status:h.status,body:v}}return{ok:!0}},Al=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},zt="__WS_CRM_PENDING_INSTRUCTIONS",Ll=60*1e3,$l=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ml=t=>{let e=(t||"").toLowerCase();for(let o of $l)if(e.includes(o.matches.toLowerCase()))return o;return null},Dl=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(zt,JSON.stringify(r))}catch{}},Fl=()=>{try{let t=localStorage.getItem(zt);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Ll?(localStorage.removeItem(zt),null):e}catch{return null}},Ol=()=>{try{localStorage.removeItem(zt)}catch{}},Hl=(t,e)=>{document.getElementById(ae)?.remove();let o=document.createElement("div");o.id=ae,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Pl=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Nl=()=>{let t=window.location.pathname.match(Pl);if(!t)return;let e=t[1],o=Fl();o&&o.proposalId===e&&(Ol(),window.setTimeout(()=>{Hl(o.title,o.bodyHtml)},600))},En="ws-crm-prepare-contract-toast",R=(t,e="info",o=4e3)=>{document.getElementById(En)?.remove();let r=document.createElement("div");r.id=En;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Tn=(t,e)=>new Promise(o=>{document.getElementById(ae)?.remove();let r=document.createElement("div");r.id=ae,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,I=`
    ...
    padding-right: 28px;
  `,D=N=>['<option value="">(unset)</option>'].concat(T.map(G=>`<option value="${ne(G)}"${G===N?" selected":""}>${V(G)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${u.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${g}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ne(p)}" placeholder="e.g. 30" style="${S}" />
      </div>
      <div style="${g}">
  ...
  `,w.appendChild(y),document.body.appendChild(w);let P=y.querySelector("#ws-pc-purchase-price"),j=y.querySelector("#ws-pc-emd"),U=y.querySelector("#ws-pc-cash-at-close"),H=!1;U?.addEventListener("input",()=>{H=!0});let Se=()=>{if(H)return;let N=Number(P?.value||0),G=Number(j?.value||0);U&&(U.value=String(Math.max(0,N-G)))};P?.addEventListener("input",Se),j?.addEventListener("input",Se);let at=()=>w.remove();w.addEventListener("click",N=>{N.target===w&&at()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",at);let K=y.querySelector("#ws-pc-submit"),W=y.querySelector("#ws-pc-error");K?.addEventListener("click",async()=>{if(K){W&&(W.textContent=""),K.disabled=!0,K.textContent="Opening\u2026";try{let N=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),G=Number(P?.value||0),Ce=Number(j?.value||0),Ie=Number(U?.value||0),Ae=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Le=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),$e=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),ge=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Me=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),z={};if(N!==s&&(z.sellerName=N),G!==l&&(z.purchasePrice=G),Ce!==d&&(z.emd=Ce),Ie!==c&&(z.cashAtClose=Ie),Ae!==p&&(z.daysToClose=Ae),Le!==m&&(z.inspectionDays=Le),$e!==h&&(z.additionalTerms=$e),ge!==v&&(z.currentOccupancy=ge),Me!==k&&(z.occupancyAtClose=Me),Object.keys(z).length>0){b.info("[prepare-contract] PA modal submit with overrides:",z),K.textContent="Saving\u2026";let Zt=L(),Qt=await qt({tenantId:t,contactId:e,template:o,userId:Zt,overrides:z});b.info("[prepare-contract] re-stage with overrides ok:",Qt),K.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let q=i?`${i} - Purchase Agreement`:void 0;await ar(t,e,o,q)}catch(N){K.disabled=!1,K.textContent="Open Contract",W&&(W.textContent=N.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",N)}}})},Rl=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:i,defaultClosingDate:s,defaultEMDDueDate:l})=>{document.getElementById(ae)?.remove(),Sn();let d=a.debug||{},c=typeof d.propertyAddress=="string"?d.propertyAddress:"",p=typeof d.sellerDisplay=="string"?d.sellerDisplay:"",m=typeof d.assignmentPrice=="number"?d.assignmentPrice:0,h=typeof d.buyerEMD=="number"?d.buyerEMD:0,v=typeof d.assignmentFee=="number"?d.assignmentFee:0,k=typeof d.acqPurchasePrice=="number"?d.acqPurchasePrice:0,T=typeof d.closingOffice=="string"?d.closingOffice:"",w=typeof d.buyerCompanyName=="string"?d.buyerCompanyName:"",y=s,f=l,S="",C=document.createElement("div");C.id=ae,C.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;x.innerHTML=`
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${P}">
        ...
        <input id="ws-pc-seller-name" type="text" value="${ne(p)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${P}">
  ...
  `,C.appendChild(x),document.body.appendChild(C);let U=x.querySelector("#ws-pc-assignment-price"),H=x.querySelector("#ws-pc-assignment-fee"),Se=!1;H?.addEventListener("input",()=>{Se=!0});let at=()=>{if(Se)return;let G=Number(U?.value||0);H&&(H.value=String(Math.max(0,G-k)))};U?.addEventListener("input",at);let K=()=>C.remove();C.addEventListener("click",G=>{G.target===C&&K()}),x.querySelector("#ws-pc-cancel")?.addEventListener("click",K);let W=x.querySelector("#ws-pc-submit"),N=x.querySelector("#ws-pc-error");W?.addEventListener("click",async()=>{if(!W)return;N&&(N.textContent="");let G=(x.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ce=Number(U?.value||0),Ie=Number(x.querySelector("#ws-pc-buyer-emd")?.value||0),Ae=Number(H?.value||0),Le=(x.querySelector("#ws-pc-closing-office")?.value||"").trim(),$e=(x.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),ge=(x.querySelector("#ws-pc-closing-date")?.value||"").trim(),Me=(x.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),z=(x.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!ge){N&&(N.textContent="Closing Date is required.");return}W.disabled=!0,W.textContent="Opening\u2026";try{let q={};G!==p&&(q.sellerName=G),Ce!==m&&(q.assignmentPrice=Ce),Ie!==h&&(q.buyerEMD=Ie),Ae!==v&&(q.assignmentFee=Ae),Le!==T&&(q.closingOffice=Le),$e!==w&&(q.buyerCompanyName=$e);let Zt=ge!==y||Me!==f||z!==S,Qt=Object.keys(q).length>0||Zt,eo=a;Qt?(b.info("[prepare-contract] AA modal submit, re-staging with overrides:",q),W.textContent="Saving\u2026",eo=await qt({tenantId:t,contactId:e,template:o,oppId:r,closingDate:ge,buyerEarnestDueDate:Me,lenderSource:z,userId:i,overrides:Object.keys(q).length>0?q:void 0}),b.info("[prepare-contract] AA re-stage ok:",eo),W.textContent="Opening\u2026"):b.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let dr=eo?.debug?.propertyAddress||c,ea=dr?`${dr} - Assignment Agreement`:void 0;await ar(t,e,o,ea),K()}catch(q){W.disabled=!1,W.textContent="Open Contract",N&&(N.textContent=q.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",q)}})},qt=async t=>{b.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await El({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ar=async(t,e,o,r)=>{b.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let a=await Tl(t,o.id,e);b.info(`[prepare-contract] proposal created: ${a}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await Il(t,a,e,r);i.ok?b.info(`[prepare-contract] contact attached to proposal ${a}`):(b.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),R(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let s=Ml(o.name);s&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Dl(a,s.title,s.bodyHtml)),Al(t,a)},Gl=async t=>{let e=_l(t);if(!e){R("Could not resolve contact context.","error");return}document.getElementById(fn)?.remove();let o=document.createElement("div");o.id=fn,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=i=>{!o.contains(i.target)&&i.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await wl(e.tenantId)}catch(i){o.innerHTML=`
    ...
    `;let l=i.type==="PA"?n.emerald:i.type==="AA"?n.blue:n.coolGray;s.innerHTML=`
      ...
      </div>`,s.addEventListener("mouseenter",()=>{s.style.background=n.slate}),s.addEventListener("mouseleave",()=>{s.style.background="transparent"}),s.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${i.name} (type=${i.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=L();try{if(i.type==="AA"){let p;if(e.oppId)p=e.oppId,b.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${p} directly`);else{let y;try{y=await kl(e.tenantId,e.contactId)}catch(f){R(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),b.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){R("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)p=y[0].id,b.info(`[prepare-contract] auto-selected MT opp ${p} (only one)`);else{b.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await Tn(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){b.info("[prepare-contract] MT opp picker cancelled");return}p=f,b.info(`[prepare-contract] picked MT opp ${p}`)}}let m=y=>{let f=y.getFullYear(),S=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${S}-${C}`},h=y=>{let f=new Date;return f.setDate(f.getDate()+y),m(f)},v=h(45),k=h(7);R("Reading contract data\u2026","info",2500);let T;try{T=await qt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:p,closingDate:v,buyerEarnestDueDate:k,userId:c})}catch(y){R(`Failed to prepare contract: ${y.message}`,"error",6e3),b.warn("[prepare-contract] AA stage failed:",y);return}let w=e.contactId||T.contact_id||"";if(!w){R("Could not resolve buyer contact for this opp.","error",6e3);return}Rl({tenantId:e.tenantId,contactId:w,template:i,oppId:p,staged:T,userId:c,defaultClosingDate:v,defaultEMDDueDate:k})}else if(i.type==="PA"){if(!e.contactId){R("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let p;try{p=await xl(e.tenantId,e.contactId)}catch(v){R(`Failed to load ACQ opps: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",v);return}if(p.length===0){R("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(p.length===1)m=p[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${p.length} opps)`);let v=await Tn(p,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!v){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=v,b.info(`[prepare-contract] picked ACQ opp ${m}`)}R("Reading contract data\u2026","info",2500);let h;try{h=await qt({tenantId:e.tenantId,contactId:e.contactId,template:i,oppId:m,userId:c})}catch(v){R(`Failed to prepare contract: ${v.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",v);return}Bl({tenantId:e.tenantId,contactId:e.contactId,template:i,staged:h})}else{if(!e.contactId){R("This template needs to be started from a contact page.","error",6e3);return}R(`Opening ${i.name}\u2026`,"info",2500);try{await ar(e.tenantId,e.contactId,i)}catch(p){R(`Failed to open contract: ${p.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",p)}}}catch(p){b.warn("[prepare-contract] picker click handler failed:",p),R(`Unexpected error: ${p.message}`,"error",6e3)}}),o.appendChild(s)}},Ln=()=>{let t=document.createElement("button");return t.id=tr,t.type="button",t.style.cssText=`${$} position: relative;`,t.innerHTML=`
    <span>Prepare Contract</span>
    <span style="font-size: 10px; color: ${n.ash};">\u25BE</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Gl(t)}),t},zl="ws-crm-contact-actions-bar",ql=async()=>{let t=In();if(!t){document.getElementById(tr)?.remove();return}let e=null;try{e=await A(`#${zl}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(tr);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Ln();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},ye="ws-crm-prepare-contract-button-opp",Qe=`${ye}-wrap`,Ul=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Vl=/\/v2\/location\/([A-Za-z0-9]+)/,Wl=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],rr=()=>{let t=window.location.pathname,e=t.match(Ul);if(!e)return null;let o=t.match(Vl);return o?{oppId:e[1],tenantId:o[1]}:null},jl=async()=>{for(let t of Wl)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Gt=!1,et=null,nr=null,Qo=null,er,tt=()=>{et?.disconnect(),et=null,nr=null},Kl=t=>{if(et&&nr===t)return;tt();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(nr=t,et=new MutationObserver(()=>{let o=rr();if(!o||o.oppId!==t){tt();return}let r=O();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ye)?.remove(),document.getElementById(Qe)?.remove(),tt();return}document.getElementById(ye)||$n()}),et.observe(e,{childList:!0,subtree:!0}))},Yl=()=>{Qo||(Qo=new MutationObserver(()=>{er===void 0&&(er=window.setTimeout(()=>{er=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(ye);t&&!e&&!Gt&&$n()},300))}),Qo.observe(document.body,{childList:!0,subtree:!0}))},$n=async()=>{if(!Gt){Gt=!0;try{let t=rr();if(!t){document.getElementById(ye)?.remove(),document.getElementById(Qe)?.remove(),tt();return}let e=document.getElementById(ye);if(e&&e.dataset.oppId===t.oppId){let l=O();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(Qe)?.remove(),tt());return}e&&(e.remove(),document.getElementById(Qe)?.remove());let o=await jl();if(!o){b.debug("[prepare-contract] opp mount target not found");return}let r=await Y();if(r!=="Marketing Tracker"){b.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=rr();if(!a||a.oppId!==t.oppId)return;let i=Ln();i.id=ye,i.dataset.oppId=t.oppId,i.dataset.tenantId=t.tenantId;let s=document.createElement("span");s.id=Qe,s.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),s.appendChild(i),o.appendChild(s),b.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Kl(t.oppId)}finally{Gt=!1}}},Mn=()=>{Nl(),ql()};vl();function V(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ne(t){return V(t)}var Yt="reos-theme-stylesheet",Xn="reos-theme-fonts",Xl=()=>{let t=document.getElementById(Xn);t&&t.remove()},Jl=`
/* ============================================
...
`,Zl=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],Ql=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let i=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${i})`}return`rgb(${o}, ${r}, ${a})`},ed=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),td=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],ir=new WeakSet,Dn=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(ir.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let o=e.tagName;if(o==="INPUT"||o==="TEXTAREA"||o==="SELECT"||o==="SCRIPT"||o==="STYLE"||o==="SVG"||o==="PATH"||o==="IMG")return;let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let s=+i[1],l=+i[2],d=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||s<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){ir.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),ir.add(e)}catch{}})}catch{}},Fn=new WeakSet,ot=()=>{document.querySelectorAll(td.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(Fn.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let i=window.getComputedStyle(r).backgroundColor;if(!i||i==="rgba(0, 0, 0, 0)"||i==="transparent")return;let s=i.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=+s[1],d=+s[2],c=+s[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),Fn.add(r))})})},On=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},Ut=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let s=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(s){let l=+s[1],d=+s[2],c=+s[3];(s[4]!==void 0?+s[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},Hn=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},rt=()=>{for(let t of Zl){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let i=o.style.getPropertyPriority(r),s=o.style.getPropertyValue(r),l=ed.has(r)?Ql(a):a;i==="important"&&s===l||o.style.setProperty(r,a,"important")}})}},Xt="#1A1F28",od=26,rd=31,nd=40,Pn=new Set,Nn=new Set,Vt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let a=e.className?.toString()||"<no class>";!Nn.has(a)&&a!=="<no class>"&&(Nn.add(a),b.debug(`Hid empty "--" leaf: "${a}"`))})},ad=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],id=["trash","Trash","TRASH","delete","Delete","DELETE"],sd=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(id.some(i=>a.includes(i))&&(r=!0),r||o.querySelectorAll("path").forEach(s=>{if(r)return;let l=s.getAttribute("d")||"";ad.some(d=>l.includes(d))&&(r=!0)}),!r){let i=(e.id||"").toLowerCase(),s=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(i.includes("delete")||i.includes("remove")||i.includes("trash")||s.includes("delete")||s.includes("remove")||s.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},ld=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),dd=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||ld.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},Bn=new Set,Rn=new WeakSet,cd=()=>{document.body.querySelectorAll("*").forEach(e=>{if(Rn.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("ai-button")||o.includes("ask-ai")||o.includes("bg-clip-text")||o.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let a=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){a=!0;break}if(!a)return;let i=Array.from(e.children);if(i.length>0&&i.every(m=>{let h=m.tagName.toLowerCase();return h==="svg"||h==="img"})&&!a)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),Rn.add(e);let p=e.className?.toString()||"<no class>";!Bn.has(p)&&p!=="<no class>"&&(Bn.add(p),b.debug(`Remapped pure-white text -> bone: "${p}"`))})},Gn=new Set,bd=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(i=>{if(i.closest("[id^='ws-crm-']"))return;let s=(i.className?.toString()||"").toLowerCase();if(s.includes("avatar"))return;let l=window.getComputedStyle(i),d=l.backgroundColor,c=l.backgroundImage||"",p=!1;if(c!=="none"&&c.includes("gradient"))p=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let C=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(C&&parseFloat(C[1])<.6)return;let x=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(x){let g=parseInt(x[1],10),E=parseInt(x[2],10),I=parseInt(x[3],10);(g>=60||E>=60||I>=60)&&(g>230&&E>230&&I>230||(g>=80||E>=80||I>=80)&&(p=!0))}}if(!p)return;let h=(i.textContent||"").trim(),v=s,k=Array.from(i.querySelectorAll("*")).map(C=>(C.className?.toString()||"").toLowerCase()).join(" "),T=h.toLowerCase()==="ask ai"||v.includes("ai-button")||v.includes("ask-ai")||v.includes("askai"),w=v.includes("bg-clip-text")||v.includes("text-transparent")||k.includes("bg-clip-text")||k.includes("text-transparent"),y=Array.from(i.querySelectorAll("*")).some(C=>{let x=window.getComputedStyle(C),g=x.getPropertyValue("-webkit-background-clip")||"",E=x.getPropertyValue("background-clip")||"";return g.includes("text")||E.includes("text")});if(T||w||y){let C=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],x=g=>{C.forEach(E=>g.style.removeProperty(E))};x(i),i.querySelectorAll("*").forEach(x);return}let f="#12161D";i.style.setProperty("color",f,"important"),i.querySelectorAll("*").forEach(C=>{let x=C.tagName.toLowerCase();x==="svg"||x==="path"||x==="circle"||x==="rect"||x==="polygon"||x==="polyline"||x==="line"||x==="g"?(C.style.setProperty("fill",f,"important"),C.style.setProperty("stroke",f,"important"),C.style.setProperty("color",f,"important")):(C.style.setProperty("color",f,"important"),C.style.setProperty("-webkit-text-fill-color",f,"important"))});let S=i.className?.toString()||"<no class>";!Gn.has(S)&&S!=="<no class>"&&(Gn.add(S),b.debug(`Darkened SVG icons on colored button: "${S}"`))})})},zn=new Set,pd=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let p=d.getBoundingClientRect();if(p.width===0||p.width>28||p.height>28)return;let m=p.left<r.right&&p.right>r.left,h=p.top<r.bottom&&p.bottom>r.top;if(!(m&&h)||p.top+p.height/2<a)return;let k=p.width*p.height/(r.width*r.height);if(k>.55)return;let T=c,w=c.parentElement,y=0;for(;w&&w!==e&&y<3;){let S=w.getBoundingClientRect();if(S.width>0&&S.width<=30&&S.height<=30)T=w;else break;w=w.parentElement,y++}T.style.setProperty("transform","translateY(11px)","important");let f=(T.className?.toString()||"")+" "+T.tagName;zn.has(f)||(zn.add(f),b.debug(`Dropped activity badge 11px (${p.width.toFixed(0)}x${p.height.toFixed(0)} icon, ratio ${k.toFixed(2)}): "${f}"`))})})},hd="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",md=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",hd,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let i=a.style.color;(i==="rgb(18, 22, 29)"||i==="#12161D"||i==="#0FB57E"||i==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},qn=new Set,ud=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let s=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!s)return;let l=parseInt(s[1],10),d=parseInt(s[2],10),c=parseInt(s[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let p=r.className?.toString()||"<no class>";!qn.has(p)&&p!=="<no class>"&&(qn.add(p),b.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${l},${d},${c})): "${p}"`))})})},Un=new Set,vd=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let s=o.getBoundingClientRect();if(s.width>0&&s.height>0&&s.width<=400&&s.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let l=o.className?.toString()||"<no class>";!Un.has(l)&&l!=="<no class>"&&(Un.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}o=o.parentElement,r++}})},Vn=new Set,_d=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let i=window.getComputedStyle(a);if(i.position!=="fixed"&&i.position!=="absolute")return;let s=parseInt(i.zIndex,10);if(!isFinite(s)||s<50)return;let l=a.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(s=>{if(s.id?.startsWith("ws-crm-")||s.closest("[id^='ws-crm-']"))return;let l=(s.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||s.closest(".sidebar-option-button")||s.closest("nav[class*='w-13']")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||s.closest("[class*='tabulator']")){(s.getAttribute("style")||"").includes("background-color")&&s.style.removeProperty("background-color");return}if(l.includes("hr-card")||s.closest(".hr-card")||s.id&&s.id.startsWith("opportunity-")){let w=s.getAttribute("style")||"";(w.includes("background-color")||w.includes("color"))&&(s.style.removeProperty("background-color"),s.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||s.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(s).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let p=parseInt(c[1],10),m=parseInt(c[2],10),h=parseInt(c[3],10);if(!(p>200&&m>200&&h>200))return;let k=s.getBoundingClientRect();if(k.width<24||k.height<16||k.width>1400)return;s.style.setProperty("background-color","#12161D","important"),s.style.setProperty("color","#EDEEF0","important");let T=s.className?.toString()||"<no class>";!Vn.has(T)&&T!=="<no class>"&&(Vn.add(T),b.debug(`Coerced light bg (${k.width.toFixed(0)}x${k.height.toFixed(0)}, rgb(${p},${m},${h})): "${T}"`))})})},Wn=new Set,yd=()=>{let t="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0)return;let r=(o.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||o.closest(t)||o.closest("[class*='avatar'], [class*='hr-avatar']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(o.matches("[role='heading']")||o.closest("[role='heading']")||o.matches("h1, h2, h3")||o.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){o.matches("h1, h2, h3")&&(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let f=o.getAttribute("style")||"";(f.includes("color")||f.includes("background"))&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("background-color"));return}if(o.closest("#SettingTexasSmsBlock")||o.matches("p.ui-text-sm-medium")&&o.parentElement?.classList?.contains("flex")&&o.parentElement?.classList?.contains("items-center")&&o.parentElement?.children?.length===1){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".hr-button, .n-button")||o.matches(".hr-button__content, .n-button__content")||o.closest(".hr-button__content, .n-button__content")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}if(o.closest(".bg-primary-50, [class*='bg-primary-50']")){(o.getAttribute("style")||"").includes("color")&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"));return}let a=o,i=null;for(let f=0;f<4&&a;f++){let S=a.nextElementSibling;if(S&&(S.matches(t)||S.querySelector(t)!==null)){i=S;break}a=a.parentElement}if(!i)return;let s=o.getBoundingClientRect();if(s.width===0||s.height===0||s.width>400||s.height>60)return;o.style.setProperty("color","#9098A3","important"),o.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,d=l.getBoundingClientRect(),c=l.className?.toString()||"",p=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,h=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",v=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(h))&&(l.matches(h)||l.querySelector(h)!==null);v&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let T=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;T&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let w=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;w&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!p&&!m&&!v&&!k&&!T&&!w&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",Xt,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let y=o.className?.toString()||"<no class>";!Wn.has(y)&&y!=="<no class>"&&(Wn.add(y),b.debug(`Colored field label "${r.slice(0,30)}": "${y}"`))})},jn=new Set,gd=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let i=(e.textContent||"").trim();if(i.length===0||i.length>4)return;let s=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(s*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!jn.has(d)&&d!=="<no class>"&&(jn.add(d),b.debug(`Resized avatar text to ${l}px (circle ${s.toFixed(0)}px): "${d}"`))})},Kn=new Set,fd=new Set(["Enter Dashboard Name"]),wd=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(fd.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",Xt,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",Xt,"important"),a.style.setProperty("border-color","#252C36","important"));let i=e.className?.toString()||"<no class>";!Kn.has(i)&&i!=="<no class>"&&(Kn.add(i),b.debug(`Forced input slate bg: "${i}"`))})},Wt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let o=e.className?.toString()||"";if(o.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&o.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.split(" ").includes("tabulator-page")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(h=>o.includes(h))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("schedule-ui-form-weekly-schedule-checkbox")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("border-color")||h.includes("border-style")||h.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(o.includes("n-button")&&o.includes("icon-only")&&!o.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-button--tertiary-type")||o.includes("n-button--tertiary-type")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(o.includes("hr-data-table-td")||o.includes("hr-data-table-tr")||o.includes("hr-data-table__body-cell")||o.includes("hr-data-table__cell")||o.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-data-table-td--fixed-right")||o.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||o.includes("hr-tabs-tab-wrapper")||o.includes("hr-tabs-nav")||o.includes("hr-tabs-nav-scroll-content")||o.includes("hr-tabs-content")||o.includes("hr-tabs-pane")||o.includes("hr-tabs-rail")||o.includes("hr-tabs-wrapper")||o.includes("hr-tabs-pane-wrapper")||o.includes("hr-tab-pane")){let h=e.getAttribute("style")||"";(h.includes("background-color: rgb(26, 31, 40)")||h.includes("background-color: #1A1F28")||h.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(o.includes("hr-date-panel")||o.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-tag")&&o.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((o.includes("bg-purple-50")||o.includes("bg-purple-100"))&&(o.includes("rounded-lg")||o.includes("rounded-md")||o.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("n-alert")||e.closest(".n-alert")||o.includes("hl-warning")||o.includes("hl-error")||o.includes("hl-info")||o.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("bg-gray-50")||o.includes("bg-gray-100")||o.includes("bg-gray-200")||o.includes("bg-white")||o.includes("bg-blue-50")||o.includes("bg-blue-100")||o.includes("bg-sky-50")||o.includes("bg-indigo-50")||o.includes("bg-slate-50")||o.includes("bg-neutral-50")||o.includes("bg-zinc-50")||o.includes("bg-stone-50")||o.includes("F7F9FD")||o.includes("F9FAFB")||o.includes("ECEEF2")||o.includes("eceef2")||o.includes("EFF4FF")||o.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(o.includes("hr-collapse-item")||o.includes("hr-collapse hr-accordion")||o.includes("hr-accordion"))return;if(o.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let h=e.getAttribute("style")||"";(h.includes("background-color")||h.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let a=window.getComputedStyle(e).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let s=parseInt(i[1],10),l=parseInt(i[2],10),d=parseInt(i[3],10);if(!(s<od&&l<rd&&d<nd))return;let p=e.getBoundingClientRect();if(p.width===0||p.height===0||p.width>800||p.height>200)return;e.style.setProperty("background-color",Xt,"important");let m=e.className?.toString()||"<no class>";!Pn.has(m)&&m!=="<no class>"&&(Pn.add(m),b.debug(`Coerced dark bg to slate (${p.width.toFixed(0)}x${p.height.toFixed(0)}, rgb(${s},${l},${d})): "${m}"`))})},jt=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(i=>{i.setAttribute("data-reos-recolored","1"),i.setAttribute("data-reos-recolored-v2","1"),i.setAttribute("data-reos-recolored-v3","1");let l=(i.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,p=!1;if(e.forEach(v=>{c.includes(v)&&(c=c.split(v).join(t),p=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(v=>{c.includes(v)&&(c=c.split(v).join("transparent"),p=!0)}),i.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(k=>{c.includes(k)&&(c=c.split(k).join("#EDEEF0"),p=!0)}),!!p)try{let v=btoa(c);i.setAttribute("src",`data:image/svg+xml;base64,${v}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(i=>{let s=i.getAttribute("src")||"";if(!s||s.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(s))return;i.setAttribute("data-reos-masked","1");let l=`url("${s}")`;i.style.setProperty("-webkit-mask-image",l,"important"),i.style.setProperty("-webkit-mask-size","contain","important"),i.style.setProperty("-webkit-mask-repeat","no-repeat","important"),i.style.setProperty("-webkit-mask-position","center","important"),i.style.setProperty("mask-image",l,"important"),i.style.setProperty("mask-size","contain","important"),i.style.setProperty("mask-repeat","no-repeat","important"),i.style.setProperty("mask-position","center","important"),i.style.setProperty("background-color","var(--reos-blue)","important"),i.setAttribute("src",o)})},Kt=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},xd=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},nt=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(s=>{if(s.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(s).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||t(s)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let i="rgb(150, 162, 173)",s="rgb(0, 191, 124)",l=c=>{let p=r.querySelector(".ui-upload-icon svg");p&&(p.style.setProperty("color",c,"important"),p.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?s:i),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(s)),r.addEventListener("mouseleave",()=>l(i)))})},sr=new WeakSet,kd=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!sr.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){sr.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${ct}`,t.title=`Built ${bt}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};console.log("[ws-crm-customizer] bundle-loaded");var B=(t,e)=>{try{b.info(`[main] calling ${t}`),e(),b.info(`[main] ${t} OK`)}catch(o){b.error(`[main:FAIL] ${t} threw:`,o)}},Qn=()=>{if(b.info(`Loaded v${ct} (built ${bt})`),to()){b.info(`[main] customizer disabled for excluded location ${fe()} \u2014 bailing`);return}B("mountVersionBadge (initial)",Jt),B("mountFavicon",Br),B("mountThemeStylesheet",Jn),B("initPageRouter",pr),b.info("[main] registering onPageChange subscriber"),dt(t=>{if(b.info(`[main] onPageChange callback fired for page=${t}`),to()){b.info(`[main] page change into excluded location ${fe()} \u2014 skipping mounts`);return}B("mountVersionBadge",Jt),B("mountClaimReleaseToggle",Ir),B("mountContactActionsBar",Pr),B("mountActiveFollowUpButton",yr),B("mountMtOfferMadeButton",Gr),B("mountNotInterestedButton",zr),B("mountReducePriceButton",Ur),B("mountEditLandingPageButton",Wr),B("mountSendToClosingOfficeButton",Jr),B("mountClosingAgentPickerButton",mn),B("mountPrepareContractButton",Mn),B("mountManageTeam",gn),B("mountBuyBoxWidget",Er),B("mountSupportNavItem",an)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qn):Qn();})();
