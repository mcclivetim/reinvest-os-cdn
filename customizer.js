/* Wholesaling CRM Customizer v0.13.6 — built 2026-05-25T23:14:10.976Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var z="[wholesaling-crm-customizer]",ct="__WS_CRM_DEBUG",bt=()=>!!window[ct],b={info(...o){console.log(z,...o)},warn(...o){console.warn(z,...o)},error(...o){console.error(z,...o)},debug(...o){bt()&&console.log(z,"[debug]",...o)}};var ue=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,ce=/\/v2\/location\/([A-Za-z0-9]+)/,ht=o=>{let e=o.match(ue);if(!e)return null;let t=o.match(ce);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},pt=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']","[class*='conversation'] a[href*='/contacts/detail/']","a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(ue);if(!n)continue;let a=r.match(ce)||window.location.pathname.match(ce);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},g=()=>{let o=ht(window.location.pathname);return o||pt()};var ye=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},j="",be=null,H="other",he=new Set,W=()=>{let o=g()?.contactId??null;if(!(!(window.location.pathname!==j)&&!(o!==be))){j=window.location.pathname,be=o,H=ye(),b.debug("Page/context changed:",H,j,"contact:",o);for(let r of he)try{r(H)}catch(n){b.error("Subscriber threw:",n)}}},ge=o=>(he.add(o),setTimeout(()=>o(H),0),()=>{he.delete(o)}),fe=()=>{H=ye(),j=window.location.pathname,be=g()?.contactId??null,b.debug("Router init, current page:",H);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),W()},history.replaceState=function(t,r,n){e(t,r,n),W()},window.addEventListener("popstate",W),setInterval(W,1e3)};var K="0.13.6",Y="2026-05-25T23:14:10.976Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let s=n.querySelector(o);if(s){a(s);return}let l,c,p=()=>{m&&m.disconnect(),l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let h=n.querySelector(o);h&&(p(),a(h))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let h=n.querySelector(o);h&&(p(),a(h))},r),l=window.setTimeout(()=>{p(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var d={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},S={sm:"4px",md:"6px",lg:"10px",pill:"999px"},v={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},pe={purple:"#8B5CF6",green:d.emerald,orange:d.amber,red:d.crimson},X=o=>{let e=o==="emerald"?d.emeraldGlow:o==="amber"?d.amberGlow:d.slate,t=o==="emerald"?d.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":d.steel,r=o==="emerald"?d.emerald:o==="amber"?d.amber:d.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,R=`
  ...
  flex-shrink: 0;
`;var mt=/^[A-Za-z0-9]{15,30}$/,B=o=>typeof o=="string"&&mt.test(o),_t=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},vt=()=>{let o=window.WS_CRM_USER_ID;return B(o)?o:null},ut=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(B(t))return t;return null},yt=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=_t(e);if(!t)return null;let r=t.uid;if(B(r))return r;let n=t.claims;if(n&&B(n.user_id))return n.user_id}catch{}return null},gt=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(B(n))return n}catch{}}}catch{}return null},F=()=>vt()||ut()||yt()||gt()||null;var Ee="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",ft=`${Ee}/active-follow-up-get`,wt=`${Ee}/active-follow-up-set`,O="ws-crm-active-follow-up-button",me={amber:{label:"Add to Active Follow Up",bg:d.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:d.amber,clickable:!0,dotColor:d.amber},blue:{label:"In Active Follow Up",bg:d.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:d.blue,clickable:!1,dotColor:d.blue},gray:{label:"Not in Follow Up",bg:d.slate,border:d.steel,color:d.coolGray,clickable:!1,dotColor:d.coolGray},loading:{label:"Active Follow Up\u2026",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.ash},error:{label:"Follow Up status unavailable",bg:d.slate,border:d.steel,color:d.ash,clickable:!1,dotColor:d.crimson}},xt=()=>{let o=g();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},kt=async o=>{let e=await fetch(ft,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Et=async(o,e)=>{let t=await fetch(wt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},D=(o,e)=>{let t=me[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},we=o=>{let e=document.createElement("button");return e.type="button",e.id=O,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,D(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=xt();if(!(!r||r.contactId!==o)){D(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await Et(r,F()),a=n&&n.state&&n.state in me?n.state:"blue";D(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),D(e,"error"),setTimeout(()=>void J(e,r),4e3)}}}),e},J=async(o,e)=>{D(o,"loading");try{let t=await kt(e),r=t&&t.state&&t.state in me?t.state:"gray",n=document.getElementById(O);if(!n||n.dataset.contactId!==e.contactId)return;D(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),D(o,"error")}},Tt=[".central-panel","[class*='central-panel']"],xe="ws-crm-contact-actions-bar",St=async()=>{for(let o of Tt)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Ct=(o,e)=>{let t=e.querySelector(`#${xe}`);if(t)return t.appendChild(o),{container:t,placement:"actions-bar"};let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${xe}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},At=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Ft=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Lt=async o=>{if(o==="url"){let t=await St();return t?{kind:"contact-detail",target:t}:null}let e=At();return e?{kind:"conversations",target:e}:null},ke=(o,e)=>e.kind==="contact-detail"?Ct(o,e.target).placement:(Ft(o,e.target),"conversations-header"),It=async()=>{let o=g();if(!o||!o.locationId){document.getElementById(O)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(O);if(t&&t.dataset.contactId===e.contactId){J(t,e);return}t&&t.remove();let r=await Lt(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=g();if(!n||n.contactId!==e.contactId)return;let a=we(e.contactId),i=ke(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),J(a,e);let s=new MutationObserver(()=>{let l=document.getElementById(O);if(!(g()?.contactId===e.contactId)){s.disconnect();return}if(!l){let p=we(e.contactId);ke(p,r),J(p,e),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});s.observe(r.target,{childList:!0})},Te=()=>{It()};var L="ws-crm-claim-release-pill",Dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Ht="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Mt=async o=>{let e=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Nt=async o=>{let e=await fetch(Ht,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ae=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},M=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?d.emerald:d.amber;o.dataset.mode=e,o.style.cssText=X(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Pt=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=L,t.type="button",t.dataset.contactId=o,M(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=g();if(!n||!n.locationId||n.contactId!==o)return;let a=F();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let s=t.querySelector(".ws-cr-label");s&&(s.textContent="Sign-in needed"),setTimeout(()=>M(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";M(t,i),t.disabled=!0,t.style.opacity="0.8";try{let s=await Nt({contactId:o,locationId:n.locationId,userId:a,action:r}),l=s?.mode==="claim"||s?.mode==="release"?s.mode:i;M(t,l),b.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(s){b.error("Claim/Release Set webhook failed",s),M(t,r);let l=t.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},Se=async(o,e)=>{try{let t=await Mt({contactId:e.contactId,locationId:e.locationId,userId:F()}),r=document.getElementById(L);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";M(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},Rt=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=Ae(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},Ce=(o,e)=>{let t=Pt({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${L}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},Bt=async()=>{let o=g();if(!o){document.getElementById(L)?.remove();return}let e=document.getElementById(L);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await Rt(t),n=g();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Ce(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(L);a&&o.locationId&&Se(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(g()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(L))return;let l=Ae(t);if(l){Ce(l,o.contactId);let c=document.getElementById(L);c&&o.locationId&&Se(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},Fe=()=>{Bt()};var Ot="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",G=new Map,Le=async(o,e)=>{if(!o)return null;if(G.has(o))return G.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${Ot}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),G.set(o,null),null;let s=((await a.json()).contact_type||"").toLowerCase().trim()||null;return G.set(o,s),b.debug(`Resolved Contact Type for ${o}: ${s??"(unset)"}`),s}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),G.set(o,null),null}};var Ie=o=>o==="buyer"?"buyer":"seller";var Re="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Gt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var Vt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",$t=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let s=a||Re,l;if(i==="buyer"){let p=Be.find(h=>h.label===t),m=p?p.value:t.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let p={call_status:t,triggered_by_user_id:r??""};n&&(p.dead_reason=n),l={contact_id:o,location:{id:e},customData:p}}let c=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Ut=async({contactId:o,tenantId:e})=>{let t=await fetch(Vt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var N="ws-crm-contact-actions-bar",qt="ws-crm-call-status-dropdown",De="ws-crm-offer-made-modal",zt=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Be=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Wt=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],jt=async()=>{for(let o of Wt)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.info(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.info("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.info(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Kt=({contactId:o,kind:e})=>{let t=e==="buyer"?Be:zt,r=e==="buyer"?Gt:Re,n=e==="buyer"?"Buyer Status":"Call Status",a=document.createElement("div");a.id=qt,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=R,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=d.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${o}`);let p=i.firstElementChild,m=i.children[1],h=i.children[2];p&&(p.style.background=pe[l.color]),m&&(m.textContent=l.label),s.style.display="none";let w=g()?.locationId,x=F();if(!w){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${l.label} (no tenant!)`),m&&(m.style.color=d.amber);return}if(e==="seller"&&l.color==="green"&&!x){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${l.label} (no user!)`),m&&(m.style.color=d.amber);return}let u=h?.textContent??"\u25BE",E=async _=>{h&&(h.textContent="\u2026"),i.style.opacity="0.75";try{await $t({contactId:o,locationId:w,status:l.label,userId:x,deadReason:_,webhookUrl:r,kind:e}),h&&(h.textContent="\u2713"),setTimeout(()=>{h&&(h.textContent=u),i.style.opacity="1"},900)}catch(y){b.warn("Call Status webhook failed:",y),h&&(h.textContent="\u2717"),m&&(m.style.color=d.amber),i.style.opacity="1",setTimeout(()=>{h&&(h.textContent=u),m&&(m.style.color=d.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let _=m?.textContent??"";Xt(y=>{E(y)},()=>{m&&(m.textContent=_)});return}if(e==="seller"&&l.value==="appointment-booked"){let _=m?.textContent??"";try{(await Ut({contactId:o,tenantId:w})).ok?await E():Jt(()=>{E()},()=>{m&&(m.textContent=_)})}catch(y){b.warn("Appointment sanity check failed; firing anyway:",y),await E()}return}await E()}),s.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),s.style.display=s.style.display==="none"?"block":"none"}),document.addEventListener("click",l=>{a.contains(l.target)||(s.style.display="none")}),a.appendChild(i),a.appendChild(s),a},Yt=o=>{document.getElementById(De)?.remove();let e=document.createElement("div");e.id=De,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",s=>{s.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=s=>{s.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Ne=(o,e)=>{let t=document.createElement("div");t.id=N,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    ...
    border-bottom: 1px solid ${d.steel};
    flex-shrink: 0;
  `;let r=document.createElement("button");return r.type="button",r.style.cssText=P,r.textContent="Offer Made",r.addEventListener("click",()=>Yt(o)),t.appendChild(r),t.appendChild(Kt({contactId:o,kind:e})),t},Oe=async()=>{b.info("[actions-bar:01] ensureMounted called; url:",window.location.pathname);let o=g();if(!o){b.info("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),document.getElementById(N)?.remove();return}b.info(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await Le(o.contactId,o.locationId);Ie(c)==="buyer"&&(e="buyer"),b.info(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=g();if(!t||t.contactId!==o.contactId){b.info("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=document.getElementById(N);if(r&&r.dataset.contactId===o.contactId&&r.dataset.contactKind===e){b.info(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r&&(b.info(`[actions-bar:05] removing stale bar (was contact=${r.dataset.contactId} kind=${r.dataset.contactKind})`),r.remove());let n=await jt();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.info(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=g();if(!a||a.contactId!==o.contactId){b.info("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Ne(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(N)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.info(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let l=null;l=new MutationObserver(()=>{let c=document.getElementById(N);if(!(g()?.contactId===o.contactId)){l?.disconnect();return}if(!c){let m=document.querySelector(".central-panel")||n,h=Ne(o.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),b.info(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(k){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",k)}}}),l.observe(n,{childList:!0})},Pe=null,Qt=()=>{Pe===null&&(Pe=window.setInterval(()=>{let o=g();o&&(document.getElementById(N)||(b.info("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Oe()))},3e3))},Ge=()=>{Qt(),Oe()};var Q="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Zt=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),V="data-ws-crm-favicon",_e=o=>o.hasAttribute(V),Ve=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return Zt.has(e)},Z=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ve(r)&&!_e(r)&&r.remove()});let e=document.head.querySelector(`link[${V}="1"]`);e?e.href!==Q&&(e.href=Q):(e=document.createElement("link"),e.setAttribute(V,"1"),e.rel="icon",e.type="image/png",e.href=Q,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${V}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(V,"apple"),t.rel="apple-touch-icon",t.href=Q,document.head.appendChild(t))},$e=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Z();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Z())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ve(i)&&!_e(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&_e(i)&&(n=!0)});n&&Z()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Z(),e>=5&&window.clearInterval(t)},1e3)};var eo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",$="ws-crm-not-interested-button",to=/\/opportunities\/detail\/([A-Za-z0-9]+)/,oo=/\/v2\/location\/([A-Za-z0-9]+)/,ee=()=>{let o=window.location.pathname,e=o.match(to);if(!e)return null;let t=o.match(oo);return{oppId:e[1],locationId:t?t[1]:null}},ro=async o=>{let e=await fetch(eo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Ue=o=>{let e=document.createElement("button");return e.id=$,e.type="button",e.dataset.oppId=o,e.style.cssText=X("neutral"),e.style.fontFamily=v.sans,e.style.fontSize="12px",e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=ee();if(!t||!t.locationId||t.oppId!==o)return;let r=F(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await ro({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=d.crimsonGlow,e.style.color=d.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},no=["[data-testid='OPPORTUNITY_HEADER']","[class*='opportunity-header']","[class*='opp-header']","header.flex.items-center"],ao=async()=>{for(let o of no)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},so=async()=>{let o=ee();if(!o||!o.locationId){document.getElementById($)?.remove();return}let e=document.getElementById($);if(e&&e.dataset.oppId===o.oppId)return;e&&e.remove();let t=await ao();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=ee();if(!r||r.oppId!==o.oppId)return;let n=Ue(o.oppId),a=document.createElement("span");a.id=`${$}-wrap`,a.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,a.appendChild(n),t.appendChild(a),b.debug(`Mounted Not Interested button on opp ${o.oppId}`);let i=new MutationObserver(()=>{let s=document.getElementById($);if(!(ee()?.oppId===o.oppId)){i.disconnect();return}if(!s){let c=Ue(o.oppId);a.appendChild(c),b.debug(`Re-mounted Not Interested button after wipe for opp ${o.oppId}`)}});i.observe(t,{childList:!0})},qe=()=>{so()};var se="reos-theme-stylesheet",st="reos-theme-fonts",io=()=>{let o=document.getElementById(st);o&&o.remove()},lo=`
/* ============================================
...
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var dt=()=>{b.info(`Loaded v${K} (built ${Y})`);try{le()}catch(o){b.warn("mountVersionBadge failed:",o)}$e(),it(),fe(),ge(o=>{b.debug("Page handler firing for:",o),le(),Fe(),Ge(),Te(),qe()})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",dt):dt();})();
