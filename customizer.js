/* Wholesaling CRM Customizer v0.54.0 — built 2026-07-09T20:59:46.447Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var nr="[wholesaling-crm-customizer]",kp="__WS_CRM_DEBUG",Ep=()=>!!window[kp],p={info(...t){console.log(nr,...t)},warn(...t){console.warn(nr,...t)},error(...t){console.error(nr,...t)},debug(...t){Ep()&&console.log(nr,"[debug]",...t)}};var $p=/\/v2\/location\/([A-Za-z0-9]+)/,Tp=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match($p);return t?t[1]:null},Sn=()=>{let t=K();return t!==null&&Tp.has(t)};var Js=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,An=/\/v2\/location\/([A-Za-z0-9]+)/,Cp=t=>{let e=t.match(Js);if(!e)return null;let o=t.match(An);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Lp=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Js);if(!a)continue;let s=r.match(An)||window.location.pathname.match(An);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=Cp(window.location.pathname);return t||Lp()};var Qs=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},sr="",In=null,ae="other",Mn=new Set,ar=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==sr)&&!(t!==In))){sr=window.location.pathname,In=t,ae=Qs(),p.debug("Page/context changed:",ae,sr,"contact:",t);for(let r of Mn)try{r(ae)}catch(a){p.error("Subscriber threw:",a)}}},_t=t=>(Mn.add(t),setTimeout(()=>t(ae),0),()=>{Mn.delete(t)}),Zs=()=>{ae=Qs(),sr=window.location.pathname,In=D()?.contactId??null,p.debug("Router init, current page:",ae);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),ar()},history.replaceState=function(o,r,a){e(o,r,a),ar()},window.addEventListener("popstate",ar),setInterval(ar,1e3)},ke=()=>ae;var Sp=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,ei=null,Xs=!1,ti=t=>{let e=t.match(Sp);e&&(ei=e[1])},oi=()=>{if(!Xs){Xs=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&ti(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{ti(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},Tt=()=>ei;var ir="0.54.0",lr="2026-07-09T20:59:46.448Z";var Ap="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",dr=new Map,Pn=new Map,Ip=3e4,se=4e3,Mp=se,Ct=async(t,e)=>{if(!t)return null;let o=dr.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<Ip)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=Pn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),Mp);try{let l=`${Ap}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),dr.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let h=(m.contact_type||"").toLowerCase().trim()||null;return dr.set(t,{type:h}),p.debug(`Resolved Contact Type for ${t}: ${h??"(unset)"}`),h}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),dr.set(t,{type:null,failedAt:Date.now()}),null}})();Pn.set(t,s);try{return await s}finally{Pn.delete(t)}},Lt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var A=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let h=a.querySelector(t);h&&(m(),s(h))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},b={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},On={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},ri=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,O=`
  ...
  flex-shrink: 0;
`;var Bn="https://services.leadconnectorhq.com",ni="__WS_CRM_CAPTURED_AUTH";var Rn=()=>{try{let t=localStorage.getItem(ni);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(ni),null):e:null}catch{return null}},Pp=()=>{let t=Rn();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},Hn=async(t,e={})=>{let o=Pp();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Op=/^[A-Za-z0-9]{15,30}$/,ie=t=>typeof t=="string"&&Op.test(t),Dn=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Bp=()=>{let t=window.WS_CRM_USER_ID;return ie(t)?t:null},Rp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(ie(o))return o;return null},Hp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);if(!o)return null;let r=o.uid;if(ie(r))return r;let a=o.claims;if(a&&ie(a.user_id))return a.user_id}catch{}return null},Dp=()=>{try{let t=Rn();if(!t?.authorization)return null;let e=t.authorization.replace(/^Bearer\s+/i,""),o=Dn(e);if(!o)return null;if(o.authClass==="User"&&ie(o.authClassId))return o.authClassId;if(ie(o.primaryAuthClassId))return o.primaryAuthClassId}catch{}return null},Fp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(ie(a))return a}catch{}}}catch{}return null},B=()=>Bp()||Hp()||Dp()||Rp()||Fp()||null,zp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Dn(e);return o?o.claims??o:null}catch{return null}},Ee=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:zp()?.type==="agency"};var li="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Np=`${li}/active-follow-up-get`,qp=`${li}/active-follow-up-set`,le="ws-crm-active-follow-up-button",zn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},Up=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},jp=async t=>{let e=await fetch(Np,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Wp=async(t,e)=>{let o=await fetch(qp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},de=(t,e)=>{let o=zn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},ai=t=>{let e=document.createElement("button");return e.type="button",e.id=le,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,de(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=Up();if(!(!r||r.contactId!==t)){de(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await Wp(r,B()),s=a&&a.state&&a.state in zn?a.state:"blue";de(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),de(e,"error"),setTimeout(()=>void pr(e,r),4e3)}}}),e},Gp=3e4,pr=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),de(t,"loading");try{let o=await jp(e),r=o&&o.state&&o.state in zn?o.state:"gray",a=document.getElementById(le);if(!a||a.dataset.contactId!==e.contactId)return;de(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,de(t,"error")}},Kp=[".central-panel","[class*='central-panel']"],Fn="ws-crm-contact-actions-bar",Vp=async()=>{for(let t of Kp)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await A("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},Yp=async(t,e)=>{let o=e.querySelector(`#${Fn}`);if(!o)try{o=await A(`#${Fn}`,{timeoutMs:se+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Pm(t,e,()=>Jn(t,e))}),o},Jn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([ym(t,e),Gn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Am(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Am=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let h=l.key==="state"?xm(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,fm(r,c).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),l.disabled=!1;return}Jn(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),l.disabled=!1}))})})},hr=!1,gi=(t,e)=>{hr=e;let o=Lm(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Im,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Jn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=fi,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},fi="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Im="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Mm=t=>{let e=document.createElement("button");return e.id=yi,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=fi,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${wm.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!hr;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),gi(r,a)}),e},Pm=(t,e,o)=>{let r=document.getElementById(_i);r&&r.remove();let a=document.createElement("div");a.id=_i,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",x=>{x.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let x=await Gn();s.innerHTML=h(x),v(x)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let x=await Gn();s.innerHTML=g(x),w(x)}else i.granularity==="county"?(s.innerHTML=u(i.stateCode||""),await _m(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=u(i.stateCode||""),await vm(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,$=()=>{let x=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");x&&(x.addEventListener("input",()=>{x.value=x.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),x.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),C())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void C()),setTimeout(()=>x.focus(),0))},C=async()=>{let x=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),S=(x?.value||"").trim();if(!/^\d{5}$/.test(S)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(S)},T=async x=>{if(!i.granularity||!x)return;let E=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),E&&(E.textContent="");try{let H=await gm(t,e,i.granularity,x);if(!H.ok){E&&(E.textContent=H.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(H){E&&(E.textContent=`Network error: ${H.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},Wn=!1,$e=null,_o=null,vi=()=>{document.getElementById(yi)?.remove(),document.getElementById(Kn)?.remove(),_o&&$e&&$e.nav.removeEventListener("click",_o,!0),_o=null,$e=null,hr=!1},xi=()=>{Om()},Om=async()=>{if(!Wn){Wn=!0;try{let t=D();if(!t){vi();return}let e=document.getElementById(Kn);if(e&&e.dataset.buyerContactId===t.contactId&&$e)return;vi();let o=null;try{o=await Ct(t.contactId,t.locationId)}catch(h){p.warn("[buy-box] Contact Type fetch failed",h);return}if(Lt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([Tm(),Cm()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Sm(t.locationId,t.contactId),l=Mm(()=>$e),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};$e=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),_o=h=>{let v=h.target;if(!v||c.iconBtn.contains(v))return;v.closest("button.sidebar-option-button")&&hr&&gi(c,!1)},a.addEventListener("click",_o,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{Wn=!1}}};var Ei="ws-properties-nav-icon",ta="ws-properties-panel",wi="ws-properties-modal",ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",Bm=`${ea}/list-for-contact`,Rm=`${ea}/create-with-opp`,Hm=`${ea}/add-contact`,Dm=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Fm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,$i=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},_r=t=>{let e=$i(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},Qn=t=>{let e=$i(t);return e===null?"&mdash;":e.toLocaleString()},Ti={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},zm=t=>{let e=(t||"").toString().trim();return e?mt(Ti[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},Nm=t=>{let e=(t||"").toString().trim();return e?Ti[e]||e:""},qm={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},Um=t=>{let e=(t||"").toString().trim();return e?qm[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Gt=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,jm=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Gt("Baths",Qn(t.baths))}
    ${Gt("Sq Ft",Qn(t.sqft))}
    ${Gt("Rehab",zm(t.rehab_level),Nm(t.rehab_level))}
    ${Gt("ARV",_r(t.arv))}
    ${Gt("IMV",_r(t.imv))}
    ${Gt("MAO",_r(t.mao))}
    ${Gt("Ask",_r(t.asking_price))}
  </div>`,Ci=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},Wm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',Gm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',Km="nav.w-13, nav[class*='w-13']",Vm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Li="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Ym="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Jm=async()=>{try{return await A(Km,{timeoutMs:2500})}catch{return null}},Qm=async()=>{try{return await A(Vm,{timeoutMs:2500})}catch{return null}},oa=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),St=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:13px;outline:none;margin-bottom:10px;`,At=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,ra=`background:${n.emerald};color:${n.bone};border:none;border-radius:${_.sm};padding:8px 18px;cursor:pointer;font-family:${b.sans};font-size:13px;font-weight:600;`,Si=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 16px;cursor:pointer;font-family:${b.sans};font-size:13px;`,Zm=(t,e)=>{let o=document.createElement("div");return o.id=ta,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{tb(t,e,()=>na(t,e))}),o},na=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await oa(Bm,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}Xm(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},Xm=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
  ...
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=u=>(a.querySelector(u)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let v=a.querySelector("#wp-save");v&&(v.disabled=!0,v.textContent="Creating\u2026"),s&&(s.textContent="");try{let u=await oa(Rm,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:h||void 0});if(!u.ok){s&&(s.textContent=u.error||"Failed to create property."),v&&(v.disabled=!1,v.textContent="Create property + deal");return}r.remove(),Ci("Property + deal created \u2713"),o()}catch(u){s&&(s.textContent=`Network error: ${u.message}`),v&&(v.disabled=!1,v.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},eb=(t,e,o,r)=>{let{overlay:a,card:s}=Ai();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${Si}">Cancel</button>
      <button id="wpp-save" type="button" style="${ra}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=g=>(s.querySelector(g)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),h=l("#wpp-phone"),v=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let u=s.querySelector("#wpp-save");u&&(u.disabled=!0,u.textContent="Adding\u2026"),i&&(i.textContent="");try{let g=await oa(Hm,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:h||void 0,email:v||void 0}});if(!g.ok){i&&(i.textContent=g.error||"Failed to add person."),u&&(u.disabled=!1,u.textContent="Add person");return}a.remove(),Ci("Person added \u2713"),r()}catch(g){i&&(i.textContent=`Network error: ${g.message}`),u&&(u.disabled=!1,u.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},vr=!1,ht=null,Zn=!1,vo=null,ob=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},rb=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},Xn=(t,e)=>{vr=e,e?(t.iconBtn.className=Ym,t.iconBtn.dataset.active="true",rb(),ob(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",na(t.tenantId,t.contactId)):(t.iconBtn.className=Li,delete t.iconBtn.dataset.active,t.panel.style.display="none")},nb=()=>{let t=document.createElement("button");return t.id=Ei,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=Li,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${Wm.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ht&&Xn(ht,!vr)}),t},ki=()=>{document.getElementById(Ei)?.remove(),document.getElementById(ta)?.remove(),vo&&ht&&ht.nav.removeEventListener("click",vo,!0),vo=null,ht=null,vr=!1},Ii=()=>{ab()},ab=async()=>{if(!Zn){Zn=!0;try{let t=D();if(!t||!t.locationId){ki();return}let e=document.getElementById(ta);if(e&&e.dataset.contactId===t.contactId&&ht)return;ki();let o=null;try{o=await Ct(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Lt(o)!=="seller")return;let[a,s]=await Promise.all([Jm(),Qm()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Zm(t.locationId,t.contactId),l=nb();ht={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ht&&Xn(ht,!1)}),vo=m=>{let h=m.target;!h||ht&&ht.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&vr&&ht&&Xn(ht,!1)},a.addEventListener("click",vo,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{Zn=!1}}};var Mi="ws-non-seller-contact",Pi=()=>{sb()},sb=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(Mi);return}let e="seller";try{e=Lt(await Ct(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(Mi,e!=="seller")};var Kt="ws-crm-claim-release-pill",ib="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",lb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",db=async t=>{let e=await fetch(ib,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},cb=async t=>{let e=await fetch(lb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},Ri=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},Ce=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=ri(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},pb=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=Kt,o.type="button",o.dataset.contactId=t,Ce(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=B();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>Ce(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";Ce(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await cb({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;Ce(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),Ce(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},Oi=async t=>{try{let e=await db({contactId:t.contactId,locationId:t.locationId,userId:B()}),o=document.getElementById(Kt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";Ce(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},mb=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=Ri(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},Bi=(t,e)=>{let o=pb({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${Kt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},Te=null,bb=async()=>{let t=D();if(!t){Te?.disconnect(),Te=null,document.getElementById(Kt)?.remove();return}let e=document.getElementById(Kt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await A("#record-details-lhs",{timeoutMs:1e4}),r=await mb(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}Bi(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(Kt)&&t.locationId&&Oi({contactId:t.contactId,locationId:t.locationId}),Te?.disconnect(),Te=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){Te?.disconnect();return}if(document.getElementById(Kt))return;let d=Ri(o);d&&(Bi(d,t.contactId),document.getElementById(Kt)&&t.locationId&&Oi({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),Te.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},Hi=()=>{bb()};var ji="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",ub="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",hb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",_b=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||ji,l;if(i==="buyer"){let m=Ki.find(v=>v.label===o),h=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:h,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},vb=async({contactId:t,tenantId:e})=>{let o=await fetch(hb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},Le="ws-crm-contact-actions-bar",Wi="ws-crm-call-status-dropdown",Gi="ws-crm-call-status-menu",gr="ws-crm-offer-made-modal",Di=!1,yb=()=>{Di||(Di=!0,document.addEventListener("click",t=>{let e=document.getElementById(Gi);if(!e||e.style.display==="none")return;let o=document.getElementById(Wi);o&&!o.contains(t.target)&&(e.style.display="none")}))},gb=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"no-show",label:"No Show",color:"orange"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Ki=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],fb=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],xb=async()=>{for(let t of fb)try{let e=await A(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await A("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},wb=({contactId:t,kind:e})=>{let o=e==="buyer"?Ki:gb,r=e==="buyer"?ub:ji,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Wi,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=O,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,h=i.children[1],v=i.children[2];m&&(m.style.background=On[l.color]),h&&(h.textContent=l.label),d.style.display="none";let g=D()?.locationId,w=B();if(!g){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),h&&(h.textContent=`${l.label} (no tenant!)`),h&&(h.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!w){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),h&&(h.textContent=`${l.label} (no user!)`),h&&(h.style.color=n.amber);return}let k=v?.textContent??"\u25BE",y=async f=>{v&&(v.textContent="\u2026"),i.style.opacity="0.75";try{await _b({contactId:t,locationId:g,status:l.label,userId:w,deadReason:f,webhookUrl:r,kind:e}),v&&(v.textContent="\u2713"),setTimeout(()=>{v&&(v.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),v&&(v.textContent="\u2717"),h&&(h.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{v&&(v.textContent=k),h&&(h.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let f=h?.textContent??"";Lb($=>{y($)},()=>{h&&(h.textContent=f)});return}if(e==="seller"&&l.value==="appointment-booked"){let f=h?.textContent??"";try{(await vb({contactId:t,tenantId:g})).ok?await y():Sb(()=>{y()},()=>{h&&(h.textContent=f)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),yb(),s.appendChild(i),s.appendChild(d),s},kb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Eb=async t=>{let e=await fetch(kb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},$b="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",sa=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Tb=async(t,e)=>{let o=await fetch($b,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},Cb=t=>new Promise(e=>{document.getElementById(gr)?.remove();let o=document.createElement("div");o.id=gr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},Ni=(t,e)=>{let o=document.createElement("div");if(o.id=Le,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=O,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){yo(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){yo(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await Tb(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),yo(t,e);return}if(d(),l.length<=1){yo(t,e,l[0]);return}let c=await Cb(l);c&&yo(t,e,c)}),o.appendChild(r),o.appendChild(wb({contactId:t,kind:e}))}return o},aa=!1,qi=()=>{document.querySelectorAll(`[id="${Le}"]`).forEach(t=>t.remove())},Vi=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),aa){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}aa=!0;try{await Ab()}finally{aa=!1}},Ab=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),qi();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),qi();return}let e="seller";try{let l=await Ct(t.contactId,t.locationId),c=Lt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${Le}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await xb();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Ni(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(Le)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),yr?.disconnect(),yr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){yr?.disconnect();return}let c=document.querySelectorAll(`[id="${Le}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,h=Ni(t.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),yr.observe(a,{childList:!0})},yr=null,Ui=null,Ib=()=>{Ui===null&&(Ui=window.setInterval(()=>{let t=D();t&&(document.getElementById(Le)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Vi()))},3e3))},Yi=()=>{Ib(),Vi()};var fr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Mb=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),go="data-ws-crm-favicon",ia=t=>t.hasAttribute(go),Ji=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Mb.has(e)},xr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Ji(r)&&!ia(r)&&r.remove()});let e=document.head.querySelector(`link[${go}="1"]`);e?e.href!==fr&&(e.href=fr):(e=document.createElement("link"),e.setAttribute(go,"1"),e.rel="icon",e.type="image/png",e.href=fr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${go}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(go,"apple"),o.rel="apple-touch-icon",o.href=fr,document.head.appendChild(o))},Qi=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)xr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),xr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Ji(i)&&!ia(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&ia(i)&&(a=!0)});a&&xr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,xr(),e>=5&&window.clearInterval(o)},1e3)};var Z=".crm-opportunities-modal .ui-modal-heading .description",Zi=new Map,la=null,da,Pb=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Zi){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},V=(t,e,o)=>{Zi.set(t,{selector:e,cb:o}),!la&&(la=new MutationObserver(()=>{da===void 0&&(da=window.setTimeout(()=>{da=void 0,Pb()},300))}),la.observe(document.body,{childList:!0,subtree:!0}))};var Ob=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Bb=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Rb=".hr-card.hr-modal.crm-opportunities-modal",F=()=>{let t=document.querySelector(Rb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Bb);if(a){let s=a[1];if(Ob.includes(s))return s}}return null},X=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=F();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Xi="ws-crm-dispo-action-row",Y=t=>{let e=document.getElementById(Xi);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Xi,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var Hb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",ft="ws-crm-mt-offer-made-button",tl="ws-crm-mt-offer-made-modal",Db=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fb=/\/v2\/location\/([A-Za-z0-9]+)/,Er=()=>{let t=window.location.pathname,e=t.match(Db),o=e?e[1]:Tt();if(!o)return null;let r=t.match(Fb);return{oppId:o,locationId:r?r[1]:null}},zb=async t=>{let e=await fetch(Hb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},wr=()=>{document.getElementById(tl)?.remove()},Nb=t=>{wr();let e=document.createElement("div");e.id=tl,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Er();!o||!o.locationId||o.oppId!==t||Nb({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=O)},4e3)}})}),e},Ub=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jb=async()=>{for(let t of Ub)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},kr=!1,pa=async()=>{if(!kr){kr=!0;try{await Wb()}finally{kr=!1}}},Wb=async()=>{let t=Er();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await jb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Er();if(!a||a.oppId!==t.oppId)return;let s=qb(t.oppId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),Gb(t.oppId)},fo=null,ca=null,Se,xo=()=>{fo?.disconnect(),fo=null,ca=null,Se!==void 0&&(window.clearTimeout(Se),Se=void 0)},Gb=t=>{if(fo&&ca===t)return;xo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ca=t,fo=new MutationObserver(()=>{Se===void 0&&(Se=window.setTimeout(()=>{Se=void 0;let o=Er();if(!o||o.oppId!==t){xo();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}document.getElementById(ft)||pa()},250))}),fo.observe(e,{childList:!0,subtree:!0}))},Kb=()=>{V("mt-offer-made",Z,()=>{!document.getElementById(ft)&&!kr&&pa()})},el=()=>{Kb(),pa()};var Vb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",xt="ws-crm-not-interested-button",Yb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jb=/\/v2\/location\/([A-Za-z0-9]+)/,Tr=()=>{let t=window.location.pathname,e=t.match(Yb),o=e?e[1]:Tt();if(!o)return null;let r=t.match(Jb);return{oppId:o,locationId:r?r[1]:null}},Qb=async t=>{let e=await fetch(Vb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Zb=t=>{let e=document.createElement("button");return e.id=xt,e.type="button",e.dataset.oppId=t,e.style.cssText=O,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=Tr();if(!o||!o.locationId||o.oppId!==t)return;let r=B(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await Qb({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Xb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],tu=async()=>{for(let t of Xb)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},$r=!1,ba=async()=>{if(!$r){$r=!0;try{await eu()}finally{$r=!1}}},eu=async()=>{let t=Tr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await tu();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Tr();if(!a||a.oppId!==t.oppId)return;let s=Zb(t.oppId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),ou(t.oppId)},wo=null,ma=null,ko=()=>{wo?.disconnect(),wo=null,ma=null},ou=t=>{if(wo&&ma===t)return;ko();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ma=t,wo=new MutationObserver(()=>{let o=Tr();if(!o||o.oppId!==t){ko();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}document.getElementById(xt)||ba()}),wo.observe(e,{childList:!0,subtree:!0}))},ru=()=>{V("not-interested",Z,()=>{!document.getElementById(xt)&&!$r&&ba()})},ol=()=>{ru(),ba()};var nu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",vt="ws-crm-schedule-walkthrough-button",ua="ws-crm-schedule-walkthrough-modal",au=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,su=/\/v2\/location\/([A-Za-z0-9]+)/,Sr=()=>{let t=window.location.pathname,e=t.match(au),o=e?e[1]:Tt();if(!o)return null;let r=t.match(su);return{oppId:o,locationId:r?r[1]:null}},Cr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},iu=(t,e)=>{document.getElementById(ua)?.remove();let o=document.createElement("div");o.id=ua,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=Sr();!o||!o.locationId||o.oppId!==t||iu(o.oppId,o.locationId)}),e},du=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],cu=async()=>{for(let t of du)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Lr=!1,_a=async()=>{if(!Lr){Lr=!0;try{await pu()}finally{Lr=!1}}},pu=async()=>{let t=Sr();if(!t||!t.locationId){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o();return}let e=document.getElementById(vt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o());return}e&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove());let o=await cu();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=Sr();if(!a||a.oppId!==t.oppId)return;let s=lu(t.oppId),i=document.createElement("span");i.id=`${vt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),mu(t.oppId)},Eo=null,ha=null,Ae,$o=()=>{Eo?.disconnect(),Eo=null,ha=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},mu=t=>{if(Eo&&ha===t)return;$o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ha=t,Eo=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=Sr();if(!o||o.oppId!==t){$o();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),$o();return}document.getElementById(vt)||_a()},250))}),Eo.observe(e,{childList:!0,subtree:!0}))},bu=()=>{V("schedule-walkthrough",Z,()=>{!document.getElementById(vt)&&!Lr&&_a()})},rl=()=>{bu(),_a()};var uu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ie="ws-crm-resend-deal-link-wrap",hu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,_u=/\/v2\/location\/([A-Za-z0-9]+)/,Ir=()=>{let t=window.location.pathname,e=t.match(hu),o=e?e[1]:Tt();if(!o)return null;let r=t.match(_u);return{oppId:o,locationId:r?r[1]:null}},vu=async t=>{let e=await fetch(uu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},yu=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),nl=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,ya=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=O,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${nl(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>gu(t,e)),t.appendChild(o)},gu=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void fu(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>ya(t,e)),o.appendChild(i),t.appendChild(o)},fu=async(t,e,o,r)=>{let a=Ir();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await vu({oppId:a.oppId,locationId:a.locationId,channel:o,userId:B()});if(s?.ok)r.innerHTML=`${nl(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${yu(i)}</span>`}window.setTimeout(()=>ya(t,e),3500)}},xu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],wu=async()=>{for(let t of xu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ar=!1,ga=async()=>{if(!Ar){Ar=!0;try{await ku()}finally{Ar=!1}}},ku=async()=>{let t=Ir();if(!t||!t.locationId){document.getElementById(Ie)?.remove(),Co();return}let e=document.getElementById(Ie);if(e&&e.dataset.oppId===t.oppId){let i=F();i!==null&&i!=="Marketing Tracker"&&(e.remove(),Co());return}e&&e.remove();let o=await wu();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ir();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Ie,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Y(o).appendChild(s),ya(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Eu(t.oppId)},To=null,va=null,Co=()=>{To?.disconnect(),To=null,va=null},Eu=t=>{if(To&&va===t)return;Co();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(va=t,To=new MutationObserver(()=>{let o=Ir();if(!o||o.oppId!==t){Co();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ie)?.remove(),Co();return}document.getElementById(Ie)||ga()}),To.observe(e,{childList:!0,subtree:!0}))},$u=()=>{V("resend-deal-link",Z,()=>{!document.getElementById(Ie)&&!Ar&&ga()})},al=()=>{$u(),ga()};var Tu=t=>{let e=(o,r,a)=>o.style.setProperty(r,a,"important");t.querySelectorAll("input, textarea, select").forEach(o=>{if(o instanceof HTMLInputElement&&o.type==="checkbox")return;e(o,"background-color",n.obsidian),e(o,"color",n.bone),e(o,"-webkit-text-fill-color",n.bone),e(o,"border-color",n.steel);let r=o.previousElementSibling;r instanceof HTMLElement&&r.tagName==="DIV"&&(e(r,"color",n.bone),e(r,"-webkit-text-fill-color",n.bone))}),t.querySelectorAll("div").forEach(o=>{e(o,"background-color","transparent"),e(o,"border-style","none")})},Mr=(t,e=8e3)=>{let o=null,r=()=>{o?.disconnect(),Tu(t),o?.observe(t,{attributes:!0,attributeFilter:["style"],subtree:!0})};o=new MutationObserver(r),r(),window.setTimeout(()=>{o?.disconnect(),o=null},e)};var Cu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/referred",Lu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer/mt-opps",Oe="ws-crm-add-referral-wrap",Pr="ws-crm-add-referral-contact-btn",xa="ws-crm-contact-actions-bar",yt="ws-referral-modal",Su=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Au=/\/v2\/location\/([A-Za-z0-9]+)/,Ht=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),ll=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Iu=async t=>{try{return await navigator.clipboard.writeText(t),!0}catch{}try{let e=document.createElement("textarea");e.value=t,e.style.cssText="position:fixed;opacity:0;pointer-events:none;",document.body.appendChild(e),e.select();let o=document.execCommand("copy");return e.remove(),o}catch{return!1}},Mu=t=>{let e=t.trim();if(!e)return{ok:!0,value:""};let o=e.replace(/\D/g,"");return o.length===11&&o.startsWith("1")&&(o=o.slice(1)),o.length!==10?{ok:!1,value:""}:{ok:!0,value:`+1${o}`}},be=`width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;`,Me=t=>`<div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">${t}</div>`,Ea=t=>{document.getElementById(yt)?.remove();let e=document.createElement("div");e.id=yt,e.style.cssText=`
  ...
  `,t.querySelector("#ws-ref-done")?.addEventListener("click",()=>{document.getElementById(yt)?.remove()}),t.querySelector("#ws-ref-another")?.addEventListener("click",()=>{Ea(o)});let d=t.querySelector("#ws-ref-copy");d?.addEventListener("click",async()=>{let l=await Iu(e.link||"");d.textContent=l?"Copied \u2713":"Copy failed",window.setTimeout(()=>{d.textContent="Copy"},2e3)})},Ou=t=>new Promise(e=>{document.getElementById(yt)?.remove();let o=document.createElement("div");o.id=yt,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      ...
      </div>`,o.appendChild(r),document.body.appendChild(o);let s=i=>{o.remove(),e(i)};o.addEventListener("click",i=>{i.target===o&&s(null)}),r.querySelector("#ws-ref-pick-cancel")?.addEventListener("click",()=>s(null)),r.querySelectorAll(".ws-ref-pick").forEach(i=>{i.addEventListener("click",()=>s(t[Number(i.dataset.i)]??null))})}),Or=()=>{let t=window.location.pathname,e=t.match(Su),o=e?e[1]:Tt();if(!o)return null;let r=t.match(Au);return{oppId:o,locationId:r?r[1]:null}},Bu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ru=async()=>{for(let t of Bu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Br=!1,wa=async()=>{if(!Br){Br=!0;try{await Hu()}finally{Br=!1}}},Hu=async()=>{let t=Or();if(!t||!t.locationId){document.getElementById(Oe)?.remove(),So();return}let e=document.getElementById(Oe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),So());return}e&&e.remove();let o=await Ru();if(!o)return;let r=await X();if(r!=="Marketing Tracker"){p.debug(`[add-referral] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Or();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Oe,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:3;flex-shrink:0;vertical-align:middle;";let i=document.createElement("button");i.type="button",i.style.cssText=O,i.title="The buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal for this property and gets their personalized link",i.innerHTML=`${ll(n.amber)}<span>Add Referral Buyer</span>`,i.addEventListener("mouseenter",()=>{i.style.transform="translateY(-1px)"}),i.addEventListener("mouseleave",()=>{i.style.transform="translateY(0)"}),i.addEventListener("click",()=>{let d=Or();!d||!d.locationId||Ea({tenantId:d.locationId,referringOppId:d.oppId})}),s.appendChild(i),Y(o).appendChild(s),p.debug(`Mounted Add Referral Buyer button on opp ${t.oppId}`),Du(t.oppId)},Lo=null,ka=null,So=()=>{Lo?.disconnect(),Lo=null,ka=null},Du=t=>{if(Lo&&ka===t)return;So();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ka=t,Lo=new MutationObserver(()=>{let o=Or();if(!o||o.oppId!==t){So();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Oe)?.remove(),So();return}document.getElementById(Oe)||wa()}),Lo.observe(e,{childList:!0,subtree:!0}))},sl=(t,e)=>{let o=t.querySelector("span");if(!o)return;let r=t.style.color;o.textContent=e.length>72?`${e.slice(0,69)}\u2026`:e,t.style.color=n.crimson,window.setTimeout(()=>{o.textContent="Add Referral Buyer",t.style.color=r},4500)},Fu=async t=>{let e=D();if(!e||!e.locationId)return;let o=t.querySelector("span");o&&(o.textContent="Loading deals\u2026"),t.disabled=!0;try{let r=await fetch(`${Lu}?tenant_id=${encodeURIComponent(e.locationId)}&contact_id=${encodeURIComponent(e.contactId)}`,{credentials:"omit"}),a=await r.json(),s=Array.isArray(a)?a[0]:a;if(!s?.ok)throw new Error(s?.error||`Lookup failed (${r.status})`);let i=s.opps||[];if(o&&(o.textContent="Add Referral Buyer"),t.disabled=!1,!i.length){sl(t,"No open Marketing Tracker deals for this buyer");return}let d=i.length===1?i[0]:await Ou(i);if(!d)return;Ea({tenantId:e.locationId,referringOppId:d.mt_opp_id,propertyLabel:d.property_address})}catch(r){p.error("Add referral buyer lookup failed",r),o&&(o.textContent="Add Referral Buyer"),t.disabled=!1,sl(t,r instanceof Error?r.message:"Lookup failed")}},fa=!1,dl=async()=>{if(!fa){fa=!0;try{await zu()}finally{fa=!1}}},zu=async()=>{if(!D())return;let e=document.getElementById(xa);if(!e)try{e=await A(`#${xa}`,{timeoutMs:se+2e3})}catch{e=null}if(!e)return;if(e.dataset.contactKind!=="buyer"){document.getElementById(Pr)?.remove();return}let o=D();if(!o||!o.locationId)return;let r=document.getElementById(Pr);if(r&&r.dataset.contactId===o.contactId&&r.parentElement===e)return;r?.remove();let a=document.createElement("button");a.type="button",a.id=Pr,a.dataset.contactId=o.contactId,a.style.cssText=O,a.style.order="6",a.title="This buyer referred you to someone else? Add that person \u2014 creates their contact + Marketing Tracker deal and gets their personalized link",a.innerHTML=`${ll(n.amber)}<span>Add Referral Buyer</span>`,a.addEventListener("click",()=>void Fu(a)),e.appendChild(a),p.debug(`Mounted Add Referral Buyer on buyer contact ${o.contactId}`)},il=!1,Nu=()=>{il||(il=!0,window.setInterval(()=>{let t=document.getElementById(xa);!t||t.dataset.contactKind!=="buyer"||document.getElementById(Pr)||dl()},3e3))},cl=()=>{V("add-referral-buyer",Z,()=>{!document.getElementById(Oe)&&!Br&&wa()}),wa(),dl(),Nu()};var qu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",wt="ws-crm-reduce-price-button",pl="ws-crm-reduce-price-modal",Uu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ju=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=()=>{let t=window.location.pathname,e=t.match(Uu);if(!e)return null;let o=t.match(ju);return{oppId:e[1],locationId:o?o[1]:null}},Wu=async t=>{let e=await fetch(qu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},Rr=()=>{document.getElementById(pl)?.remove()},Gu=t=>{Rr();let e=document.createElement("div");e.id=pl,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Dr();!r||!r.locationId||r.oppId!==t||Gu({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=O,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Vu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Yu=async()=>{for(let t of Vu)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Hr=!1,Ta=async()=>{if(!Hr){Hr=!0;try{await Ju()}finally{Hr=!1}}},Ju=async()=>{let t=Dr();if(!t||!t.locationId){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io();return}let e=document.getElementById(wt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io());return}e&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove());let o=await Yu();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Dr();if(!a||a.oppId!==t.oppId)return;let s=Ku(t.oppId,t.locationId),i=document.createElement("span");i.id=`${wt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Qu(t.oppId)},Ao=null,$a=null,Be,Io=()=>{Ao?.disconnect(),Ao=null,$a=null,Be!==void 0&&(window.clearTimeout(Be),Be=void 0)},Qu=t=>{if(Ao&&$a===t)return;Io();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&($a=t,Ao=new MutationObserver(()=>{Be===void 0&&(Be=window.setTimeout(()=>{Be=void 0;let o=Dr();if(!o||o.oppId!==t){Io();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Io();return}document.getElementById(wt)||Ta()},250))}),Ao.observe(e,{childList:!0,subtree:!0}))},Zu=()=>{V("reduce-price",Z,()=>{!document.getElementById(wt)&&!Hr&&Ta()})},ml=()=>{Zu(),Ta()};var Re="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Fr="deals.reinvestos.com";var kt="ws-crm-edit-landing-button",Xu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,th=/\/v2\/location\/([A-Za-z0-9]+)/,Nr=()=>{let t=window.location.pathname,e=t.match(Xu);if(!e)return null;let o=t.match(th);return{oppId:e[1],locationId:o?o[1]:null}},eh=(t,e)=>{let o=new URL(`https://${Fr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=B();return r&&o.searchParams.set("user",r),o.toString()},oh=(t,e)=>{let o=document.createElement("button");return o.id=kt,o.type="button",o.dataset.oppId=t,o.style.cssText=O,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Nr();if(!r||!r.locationId||r.oppId!==t)return;if(!Re){p.warn("[edit-landing] editor session key not configured in this build");return}let a=eh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},rh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],nh=async()=>{for(let t of rh)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},zr=!1,La=async()=>{if(!zr){zr=!0;try{await ah()}finally{zr=!1}}},ah=async()=>{let t=Nr();if(!t||!t.locationId){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po();return}let e=document.getElementById(kt);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po());return}e&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove());let o=await nh();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Nr();if(!a||a.oppId!==t.oppId)return;let s=oh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${kt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),sh(t.oppId)},Mo=null,Ca=null,He,Po=()=>{Mo?.disconnect(),Mo=null,Ca=null,He!==void 0&&(window.clearTimeout(He),He=void 0)},sh=t=>{if(Mo&&Ca===t)return;Po();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ca=t,Mo=new MutationObserver(()=>{He===void 0&&(He=window.setTimeout(()=>{He=void 0;let o=Nr();if(!o||o.oppId!==t){Po();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Po();return}document.getElementById(kt)||La()},250))}),Mo.observe(e,{childList:!0,subtree:!0}))},ih=()=>{V("edit-landing-page",Z,()=>{!document.getElementById(kt)&&!zr&&La()})},bl=()=>{ih(),La()};var _l="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Fe="ws-crm-publish-button",Oo="ws-crm-publish-wrap",Ur="ws-crm-publish-dropdown",lh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dh=/\/v2\/location\/([A-Za-z0-9]+)/,Sa=()=>{let t=window.location.pathname,e=t.match(lh);if(!e)return null;let o=t.match(dh);return{oppId:e[1],locationId:o?o[1]:null}},ul=async(t,e)=>{try{let o=await fetch(_l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:B()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},ch=async(t,e)=>{let o=await fetch(_l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:B()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},ph=(t,e)=>{if(!Re){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Fr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Re);let r=B();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Dt=()=>{document.getElementById(Ur)?.remove()},hl=(t,e,o,r,a)=>{Dt();let s=document.createElement("div");s.id=Ur;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `;let r={status:"checking"};Vt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let u=await ul(t,e);if(!u||!Array.isArray(u.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Vt(o,r);return}r={status:u.published?"published":u.ready?"ready":"incomplete",checks:u.checks},Vt(o,r),document.getElementById(Ur)&&r.checks&&hl(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Vt(o,r),Dt();try{if((await ul(t,e))?.published){r={status:"published"},Vt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let g=await ch(t,e);if(g.ok&&g.published)r={status:"published"},Vt(o,r),p.info(`[publish] published opp ${t}`);else if(g.missing&&g.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Vt(o,r);else throw new Error(g.error||"Publish failed")}catch(u){let g=u instanceof Error?u.message:"Publish failed";p.error("[publish] publish failed",u),r={status:"error",message:g.length>28?"Error \u2014 try again":g},Vt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Ur)?Dt():r.checks&&hl(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),h=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",h);let v=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",h),window.clearInterval(v))},5e3);return o},bh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],uh=async()=>{for(let t of bh)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},qr=!1,Ia=async()=>{if(!qr){qr=!0;try{await hh()}finally{qr=!1}}},hh=async()=>{let t=Sa();if(!t||!t.locationId){document.getElementById(Fe)?.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro();return}let e=document.getElementById(Fe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro());return}e&&(e.remove(),document.getElementById(Oo)?.remove(),Dt());let o=await uh();if(!o)return;let r=await X();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=Sa();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=mh(t.oppId,a.locationId),i=document.createElement("span");i.id=Oo,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Y(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),_h(t.oppId)},Bo=null,Aa=null,De,Ro=()=>{Bo?.disconnect(),Bo=null,Aa=null,De!==void 0&&(window.clearTimeout(De),De=void 0)},_h=t=>{if(Bo&&Aa===t)return;Ro();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Aa=t,Bo=new MutationObserver(()=>{De===void 0&&(De=window.setTimeout(()=>{De=void 0;let o=Sa();if(!o||o.oppId!==t){Ro();return}let r=F();if(r!==null&&r!=="Disposition"){document.getElementById(Fe)?.remove(),document.getElementById(Oo)?.remove(),Dt(),Ro();return}document.getElementById(Fe)||Ia()},250))}),Bo.observe(e,{childList:!0,subtree:!0}))},vh=()=>{V("publish-button",Z,()=>{!document.getElementById(Fe)&&!qr&&Ia()})},vl=()=>{vh(),Ia()};var yl="data:image/png;base64,",gl="data:image/png;base64,";var yh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],fl=t=>`ws-crm-map-links-${t}`,xl=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),jr=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},wl=(t,e=xl())=>{let o=jr(e,t.addr),r=jr(e,t.city),a=jr(e,t.state),s=jr(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},gh=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,fh=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,xh=(t,e)=>{let{full:o,hasAny:r}=wl(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},wh=t=>{let e=document.createElement("span");e.id=fl(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),xh(t,i)}),d};return e.appendChild(r(yl,"Open in Google Maps",gh)),e.appendChild(r(gl,"Search on Zillow",fh)),e},kh=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},kl=()=>{let t=xl();if(t.length)for(let e of yh){if(document.getElementById(fl(e.key)))continue;let{hasAny:o}=wl(e,t);if(!o)continue;let r=kh(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(wh(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},ze=null,Ne,Eh=()=>{let t=ke();return t==="contact-detail"||t==="other"},$h=()=>{ze||(ze=new MutationObserver(()=>{Ne===void 0&&(Ne=window.setTimeout(()=>{Ne=void 0;try{kl()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),ze.observe(document.body,{childList:!0,subtree:!0}))},El=()=>{ze&&(ze.disconnect(),ze=null),Ne!==void 0&&(window.clearTimeout(Ne),Ne=void 0)},$l=()=>{if(!Eh()){El();return}$h(),kl()},Tl=()=>{El()};var Cl="ws-crm-hide-launchpad",Ma=/\/launchpad\/?$/,Pa=()=>{if(!Ee()){if(!document.getElementById(Cl)){let t=document.createElement("style");t.id=Cl,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(Ma.test(location.pathname)){let t=location.pathname.replace(Ma,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!Ma.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Th=[{label:"Buy-Box Entries"},{label:"Memberships"}],Ll=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},Oa=()=>{let t=Ee(),e=new Set(Th.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Ll(e);for(let o of[150,500,1200,2500])setTimeout(()=>Ll(e),o)}};var Ch=[{from:"Payments",to:"Contracts"}],Lh=".nav-title, .topmenu-navtitle",Sl=()=>{document.querySelectorAll(Lh).forEach(t=>{let e=(t.textContent||"").trim(),o=Ch.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},Ba=()=>{Sl();for(let t of[150,500,1200,2500])setTimeout(Sl,t)};var Al="/payments/proposals-estimates",Sh=/\/payments\/invoices\/?$/,Ah=/\/payments\//,Ih='#sb_payments, a[meta="payments"]',Ml=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(Al)&&!(t>3&&!Ah.test(e))){if(Sh.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(Al));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>Ml(t+1),120)}},Il=!1,Mh=()=>{Il||(Il=!0,document.addEventListener("click",t=>{t.target?.closest?.(Ih)&&setTimeout(()=>Ml(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},Ra=()=>{Mh()};var Pl=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],Ol="ws-crm-hide-topmenu-tabs",Ha=()=>{if(document.getElementById(Ol))return;let t=Pl.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=Ol,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${Pl.length} top tabs`)};var Hl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Yt="ws-crm-send-to-closing-office-button",ue="ws-crm-send-to-title-co-wrap",Kr="ws-crm-stc-dropdown",Ph=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Oh=/\/v2\/location\/([A-Za-z0-9]+)/,Fo=()=>{let t=window.location.pathname,e=t.match(Ph);if(!e)return null;let o=t.match(Oh);return{oppId:e[1],locationId:o?o[1]:null}},Bh=5*60*1e3,za=t=>`ws-crm-stc-cache:${t}`,Rh=t=>{try{let e=window.localStorage.getItem(za(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Bh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Hh=(t,e)=>{try{window.localStorage.setItem(za(t),JSON.stringify(e))}catch{}},Dl=t=>{try{window.localStorage.removeItem(za(t))}catch{}},Da="ws-crm:opp-fields-updated",Fl=t=>{if(t){Dl(t);try{window.dispatchEvent(new CustomEvent(Da,{detail:{oppId:t}}))}catch{}}},Dh=async(t,e)=>{try{let o=await fetch(Hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:B()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Fh=async(t,e,o)=>{let r=await fetch(Hl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:B()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},zh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},Bl=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Nh=(t,e)=>{if(e&&zh(e)){window.setTimeout(()=>Bl(t),300);return}Bl(t)},Et=()=>{document.getElementById(Kr)?.remove()},Wr=(t,e,o)=>{Et();let r=document.createElement("div");r.id=Kr;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,It(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Dh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},It(o,a);return}if(y.rate_limited){u=Date.now()+v,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},It(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},It(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Vr.add(t),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et(),Do();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((x,E)=>a.checks[E]?.filled&&!x.filled?s.has(x.label)?x:(T.add(x.label),{...x,filled:!0}):x),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Hh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),It(o,a),document.getElementById(Kr)&&Wr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},It(o,a),Et();try{let f=await Fh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},It(o,a),f.checks&&Wr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},It(o,a),window.setTimeout(()=>{w()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},It(o,a),f.checks&&Wr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},It(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Kr)?Et():a.checks&&Wr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":w();break}});let l,c=!1,m=Date.now(),h=1e4,v=5*60*1e3,u=0,g=!1,w=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=Fo();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<u){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};w();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let C=Date.now()-m,T=Math.max(1500,h-C);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&w()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=C=>{let T=C.detail;if(!T||T.oppId!==t)return;Dl(t);let x=0,E=()=>{if(c&&x<8){x+=1,window.setTimeout(E,500);return}w()};E()};window.addEventListener(Da,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(Da,f),window.clearInterval($))},5e3)}return o},Uh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],jh=async()=>{for(let t of Uh)try{let e=await A(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Vr=new Set,Rl=null,Wh=t=>{t&&t!==Rl&&(Vr.clear(),Rl=t)},Gr=!1,Na=async()=>{if(Gr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Gr=!0;try{await Gh()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Gr=!1}},Gh=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Fo();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Wh(t.oppId),Vr.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et();return}let e=document.getElementById(Yt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=F();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(ue)?.remove(),Et(),Do());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(ue)?.remove(),Et()),p.debug("[stc] mount:04 calling findMountTarget");let o=await jh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=F();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Fo();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=qh(t.oppId,a.locationId),i=document.createElement("span");i.id=ue,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Y(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),Kh(t.oppId)},Ho=null,Fa=null,Do=()=>{Ho?.disconnect(),Ho=null,Fa=null},Kh=t=>{if(Ho&&Fa===t)return;Do();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Fa=t,Ho=new MutationObserver(()=>{let o=Fo();if(!o||o.oppId!==t){Do();return}let r=F();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Yt)?.remove(),document.getElementById(ue)?.remove(),Et(),Do();return}document.getElementById(Yt)||Na()}),Ho.observe(e,{childList:!0,subtree:!0}))},Vh=()=>{V("send-to-closing",Z,()=>{if(document.getElementById(Yt)||Gr)return;let t=Fo();t&&Vr.has(t.oppId)||Na()})},zl=()=>{Vh(),Na()};var ja="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Yh=`${ja}/tc/welcome-call-prefill`,Jh=`${ja}/tc/welcome-call-save`,Qh=`${ja}/tc/order-lockbox`,zo="ws-crm-welcome-call-overlay",Zh=["Regular Contract","Subject To","Seller Finance","Novation"],Xh=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],t_=["Gas","Electric","Propane","Oil"],e_=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],o_=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Jt=["Yes","No"],r_=["Yes","No","Unknown"],n_=["Professional Photographer","Seller","Tenant"],a_=["Month-to-Month","Annual"],Nl=["Current","Behind"],s_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Mt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Jr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;margin-top:4px;`,jl="margin-bottom:12px;",Wl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,i_=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ql=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=ql(o);return`<select id="${t}" style="${Jr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&ql(a)===r?"selected":""}>${Mt(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${Mt(e)}" placeholder="${Mt(o)}" style="${Jr}">`,l_=(t,e)=>`<textarea id="${t}" rows="3" style="${Jr}resize:vertical;">${Mt(e)}</textarea>`,d_=(t,e)=>`<input id="${t}" type="date" value="${Mt(e)}" style="${Jr}">`,z=(t,e)=>`<div style="${jl}"><label style="${Wl}">${Mt(t)}</label>${e}</div>`,qa=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${s_.map(r=>`<label style="${i_}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Ft=t=>`<div style="font-family:${b.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${Mt(t)}</div>`,qe=()=>{document.getElementById(zo)?.remove()},he=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},c_=t=>{let e=t.tenant||{};return`
    ${Ft("Identifiers")}
    ...
    ${Ft("Contract")}
    ${z("Type of Contract",ot("wc-contract_type",Zh,t.contract_type))}

    ${Ft("Property")}
    ${z("Property Type",ot("wc-property_type",e_,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${z("Utilities",ot("wc-utilities",Xh,t.utilities))}
    ${z("Heat Source",ot("wc-heat_source",t_,t.heat_source))}

    ${Ft("Liens & Permits")}
    ${z("Is there a mortgage?",ot("wc-has_mortgage",Jt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${z("Mortgage payment status",ot("wc-mortgage_payment_status",Nl,t.mortgage_payment_status))}</div>
    ...
    ${Ft("Occupancy")}
    ${z("Property occupancy",ot("wc-occupancy",o_,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${z("Lease type",ot("wc-tenant_lease_type",a_,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${z("Rent status",ot("wc-tenant_rent_status",Nl,e.rent_status))}</div>
        <div style="flex:1;">${z("Last rent paid",d_("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${z("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${z("HOA rental restriction?",ot("wc-hoa_rental_restriction",r_,t.hoa_rental_restriction))}</div>

    ${Ft("Photos & Access")}
    ${z("Who is providing photos?",ot("wc-photos_provided_by",n_,t.photos_provided_by))}
    <div style="${jl}">
      <label style="${Wl}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
  ...
  `},M=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},Ua=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),Ul=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",M("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",M("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",M("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",M("wc-occupancy")==="Tenant Occupied")},Yr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?Mt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},p_=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:M("wc-contract_type"),property_type:M("wc-property_type"),beds:M("wc-beds"),baths:M("wc-baths"),sqft:M("wc-sqft"),utilities:M("wc-utilities"),heat_source:M("wc-heat_source"),has_mortgage:M("wc-has_mortgage"),mortgage_payment_status:M("wc-mortgage_payment_status"),has_other_liens:M("wc-has_other_liens"),has_permit_issues:M("wc-has_permit_issues"),in_probate:M("wc-in_probate"),occupancy:M("wc-occupancy"),selling_with_tenant:M("wc-selling_with_tenant"),in_hoa:M("wc-in_hoa"),hoa_rental_restriction:M("wc-hoa_rental_restriction"),hoa_monthly_fee:M("wc-hoa_monthly_fee"),photos_provided_by:M("wc-photos_provided_by"),photos_avail_mornings:Ua("photos_avail_mornings"),photos_avail_afternoons:Ua("photos_avail_afternoons"),photos_avail_evenings:Ua("photos_avail_evenings"),lockbox_needed:M("wc-lockbox_needed"),lockbox_code:M("wc-lockbox_code"),lockbox_recipient_name:M("wc-lockbox_recipient_name"),lockbox_recipient_phone:M("wc-lockbox_recipient_phone"),lockbox_mailing_address:M("wc-lockbox_mailing_address"),welcome_call_notes:M("wc-welcome_call_notes"),tenant:M("wc-occupancy")==="Tenant Occupied"?{first_name:M("wc-tenant_first_name"),last_name:M("wc-tenant_last_name"),phone:M("wc-tenant_phone"),email:M("wc-tenant_email"),lease_type:M("wc-tenant_lease_type"),monthly_rent:M("wc-tenant_monthly_rent"),rent_due_day:M("wc-tenant_rent_due_day"),rent_status:M("wc-tenant_rent_status"),last_rent_paid:M("wc-tenant_last_rent_paid"),lease_on_hand:M("wc-tenant_lease_on_hand"),security_deposit:M("wc-tenant_security_deposit")}:void 0}),m_=t=>{qe();let e=document.createElement("div");e.id=zo,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${b.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${c_(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&qe()}),document.getElementById("wc-close")?.addEventListener("click",qe),document.getElementById("wc-cancel")?.addEventListener("click",qe),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",Ul)}),Ul();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!M("wc-occupancy")){he("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Jh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(p_(t)),credentials:"omit"})).ok?(qe(),he("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,he("Save failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,he("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Qh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:M("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:M("wc-lockbox_recipient_name"),recipient_phone:M("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),he("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,he("Lockbox order failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,he("Couldn't reach the lockbox handler. Try again.","err")}})},Gl=async(t,e)=>{qe();let o=document.createElement("div");o.id=zo,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${b.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Yh}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,m_(r)};var Ja="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",b_=`${Ja}/tc/confirm-photo-appointment`,u_=`${Ja}/tc/order-lockbox`,h_=`${Ja}/tc/welcome-call-prefill`,Ka="ws-crm-opp-action-bar",Vl="ws-crm-opp-overflow",Yl="ws-crm-opp-action-menu",Va="ws-crm-opp-action-popover",Jl="ws-crm-reorder-lockbox-modal",Ql=".hr-card.hr-modal.crm-opportunities-modal",__=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,v_=/\/v2\/location\/([A-Za-z0-9]+)/,Zl="Welcome Call Needed",Qa="Scheduling Photos",Xl="Photos Scheduled",y_=[Zl,Qa,Xl,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],td=()=>{let t=window.location.pathname,e=t.match(__);if(!e)return null;let o=t.match(v_);return o?{oppId:e[1],locationId:o[1]}:null},g_=()=>{let t=document.querySelector(Ql);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(y_.includes(r))return r}return null},Zt=()=>{document.getElementById(Yl)?.remove(),document.getElementById(Va)?.remove(),document.getElementById(Jl)?.remove()},Wa=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Qt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},f_=t=>{Gl(t.oppId,t.locationId)},x_=async(t,e,o)=>(await fetch(u_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,w_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Jl,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${Wa(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${Wa(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${Wa(i)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",h=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!h){Qt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{await x_(t,e,{recipient_name:c,recipient_phone:m,ship_to:h})?(d(),Qt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Qt("Re-order failed \u2014 try again.","err"))}catch(v){p.warn("[action-bar] reorder lockbox failed:",v),l.disabled=!1,l.textContent="Order Lockbox",Qt("Couldn't reach the lockbox handler. Try again.","err")}}})},ed=async t=>{Zt();let e={};try{e=await fetch(`${h_}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}w_(t,e)},k_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Va;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${b.sans};
  `,o.innerHTML=`
    <style>#${Va} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Qt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(b_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Zt(),Qt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Qt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Qt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Zt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},E_=(t,e)=>{Zt();let o=document.createElement("div");o.id=Yl;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${_.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${b.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${_.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Zt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Zr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=O,o.textContent=t,o},$_=()=>{let t=Zr("\u22EE","ghost");return t.style.lineHeight="1",t},T_=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Zl){let r=Zr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>f_(t)),o.appendChild(r),o}if(e===Qa){let r=Zr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>k_(t,r)),o.appendChild(r),o}if(e===Xl){let r=Zr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void ed(t)),o.appendChild(r),o}return null},C_=(t,e)=>{let o=[];if(e===Qa&&(o=[{label:"Re-order Lockbox",onClick:()=>void ed(t)}]),!o.length)return null;let r=document.createElement("span");r.id=Vl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=$_();return a.addEventListener("click",s=>{s.stopPropagation(),E_(o,a)}),r.appendChild(a),r},L_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],S_=async()=>{for(let t of L_)try{let e=await A(t,{timeoutMs:1200});if(e)return e}catch{}return null},Qr=()=>{document.getElementById(Ka)?.remove(),document.getElementById(Vl)?.remove(),Zt()},Xr=!1,Za=async()=>{if(!Xr){Xr=!0;try{let t=td();if(!t){Qr();return}let e=F();if(e===null)return;if(e!=="Transaction Coordination"){Qr();return}let o=g_(),r=document.getElementById(Ka);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=T_(t,o);if(!a){Qr();return}let s=await S_();if(!s)return;Qr();let i=Y(s),d=document.createElement("span");d.id=Ka,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=C_(t,o);l&&i.appendChild(l),A_(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{Xr=!1}}},No=null,Ya=null,Ga,Kl=()=>{No?.disconnect(),No=null,Ya=null},A_=t=>{if(No&&Ya===t)return;Kl();let e=document.querySelector(Ql);e&&(Ya=t,No=new MutationObserver(()=>{let o=td();if(!o||o.oppId!==t){Kl();return}Ga===void 0&&(Ga=window.setTimeout(()=>{Ga=void 0,Za()},250))}),No.observe(e,{childList:!0,subtree:!0}))},I_=()=>{V("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{Xr||Za()})},od=()=>{I_(),Za()};var M_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Xa=null,rd=null,nd=async()=>{let t=K(),e=B();if(!t||!e)return null;if(Xa&&rd===t)return Xa;try{let a=(await(await fetch(M_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,action:"list"})})).json())?.roster?.find(i=>i.id===e);if(!a)return null;let s={name:[a.first_name,a.last_name].filter(Boolean).join(" ").trim(),email:(a.email??"").trim(),phone:(a.phone??"").trim(),role:(a.roles??[])[0]?.display??""};return Xa=s,rd=t,s}catch(o){return p.warn("[current-rep] roster load failed",o),null}};var zt="ws-support-modal",ad="ws-support-toast",P_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",sd="ws-support-submitter-name",id="ws-support-submitter-email",ld="ws-support-submitter-role",O_=["Bug","Feature Request","Question","Billing","Onboarding Help"],_e=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),B_=(t,e="success",o)=>{let r=document.getElementById(ad);r&&r.remove();let a=document.createElement("div");a.id=ad;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},pd=()=>{document.getElementById(zt)?.remove();let t=(localStorage.getItem(sd)??"").trim(),e=(localStorage.getItem(id)??"").trim(),o=(localStorage.getItem(ld)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=zt,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${b.sans};
  ...
  `,a.appendChild(s),document.body.appendChild(a),Mr(s),nd().then(d=>{if(!d||!document.getElementById(zt))return;let l=(c,m)=>{let h=s.querySelector(c);h&&!h.value.trim()&&m&&(h.value=m)};l("#ws-support-name",d.name),l("#ws-support-email",d.email),l("#ws-support-role",d.role)}),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=h=>{d&&(d.textContent=h)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(sd,r.submitterName),localStorage.setItem(id,r.submitterEmail),r.submitterRole&&localStorage.setItem(ld,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let v=await(await fetch(P_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:B()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!v.ok){l(v.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let u=v.ticket_short_id||"submitted";B_(`Ticket ${u} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){l(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},R_=["/support-ticket","ws-support-modal","ws-support"],H_=/\/custom-menu-link\//,ts=!1,dd=()=>{if(ts||!H_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return R_.some(i=>s.includes(i))});if(r){ts=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{pd(),ts=!1},50);return}t<10&&setTimeout(e,150)};e()},D_=t=>{if(!(t instanceof Element))return!1;let e=t.closest("a.custom-link");return!!e&&/^\s*Support\s*$/.test(e.textContent||"")},cd=!1,md=()=>{cd||(cd=!0,document.addEventListener("click",t=>{D_(t.target)&&(t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),p.info("[support-nav] intercepted Support click (capture) \u2014 opening modal in place, no GHL navigation"),pd())},!0),_t(()=>setTimeout(dd,50)),dd(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var bd="ws-phone-assignments-modal",ud="ws-phone-assignments-toast",F_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",z_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",N_=["ACQ","DISPO","TC"],vd="",Xt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),q_=(t,e="success",o)=>{document.getElementById(ud)?.remove();let r=document.createElement("div");r.id=ud;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Xt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Xt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},U_=(t,e,o)=>{let r=[`<option value="" ${o===vd?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Xt(a)}" ${o===a?"selected":""}>${Xt(a)}</option>`)].join("");return`<select data-assign="${Xt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${_.sm};
    font-family: ${b.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},j_=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,os=async t=>{document.getElementById(bd)?.remove();let e=t||K(),o=document.createElement("div");o.id=bd,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",v=>{v.target===o&&o.remove()}),!e){let v=r.querySelector("#ws-pa-body");v&&(v.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${F_}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(v){p.error("[phone-assignments] GET failed",v);let u=r.querySelector("#ws-pa-body");u&&(u.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Xt(v.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:N_,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=v=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${v} found.</div>`,c=i.length?i.map(v=>`<div style="${j_}">
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(v=>{v.addEventListener("change",()=>{let u=v.getAttribute("data-assign")||"",[g,...w]=u.split(":"),k=w.join(":");g==="num"&&(v.value?d[k]=v.value:delete d[k])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let v=h.querySelector("#ws-pa-err"),u=w=>{v&&(v.textContent=w)};u("");let g=h.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(z_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){u(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),q_("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(w){u(`Network error: ${w.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},W_=["ws-phone-assignments","phone-assignments"],G_=/\/custom-menu-link\//,es=!1,hd=()=>{if(es||!G_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return W_.some(i=>s.includes(i))});if(r){es=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{os(s),es=!1},50);return}t<10&&setTimeout(e,150)};e()},_d=!1,yd=()=>{if(_d)return;_d=!0,_t(()=>setTimeout(hd,50)),hd();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&os()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void os(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var gd="powerDialerApp",K_=".dialer",V_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Y_=".dial-item.dial-btn.dial-btn-enabled",Ue=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},J_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},rs=()=>{try{let e=window[gd]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},je=()=>document.querySelector(K_),tn=()=>rs()!==null||je()!==null?!0:!!window[gd],en=(t,e)=>{let o=rs();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},fd=()=>{if(je())return;let t=document.querySelector(V_);t?Ue(t):p.warn("[dialer-bridge] Voice Calling button not found")},Q_=()=>{let t=document.querySelector(".number-list-container")||je();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},ns=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?J_(t.innerText):null},xd=(t,e)=>{if(ns()===t)return!0;let o=rs();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Ue(r);let a=Q_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Ue(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},wd=t=>{let e=t.replace(/[^\d*#+]/g,"");if(en("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Ue(a)}},kd=()=>{let t=je();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(Y_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Ue(e),!0):en("makeCall",{provider:"twilio"})};var as=()=>{let t=je();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Ue(e.closest("button")||e):en("closeCallBox")},Ed=()=>{en("closeCallBox")},$d=t=>{let e=!1,o=()=>{let s=je()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var Z_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",X_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Td=["acq","dispo","tc"],Uo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},qo=null,Cd=null,tv=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&qo&&Cd===o)return qo;try{let a=await(await fetch(`${Z_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return qo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},Cd=o,qo}catch(r){return p.warn("[silo] config load failed",r),qo??e}},ve=null,Ld=null,ss=async(t=!1)=>{let e=K(),o=B();if(!e||!o)return[];if(!t&&ve&&Ld===e)return ve;try{let s=(await(await fetch(X_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];ve=Td.filter(d=>i.includes(d))}else Ee()?ve=[...Td]:ve=[];return Ld=e,ve}catch(r){return p.warn("[silo] roster load failed",r),ve??[]}},Ad=()=>`ws-pd-calling-as:${B()||"anon"}`,Id=t=>{try{localStorage.setItem(Ad(),t)}catch{}},is=async()=>{let t=await ss();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(Ad())}catch{}return e&&t.includes(e)?e:t[0]},Sd=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},ev=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),Md=async t=>{let e=await is();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await tv(),a=ev(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=Sd(t),i=s?a.find(m=>Sd(m)===s):void 0,d=i||a[0];if(!xd(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Uo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=ns();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var ov="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",Pd="data-ws-pd",Od="ws-crm-pd-panel",Bd="ws-crm-pd-session",te=t=>new Promise(e=>setTimeout(e,t)),jo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),rv=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},nv=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},av=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},sv=async t=>{let e=rv(t);if(!e)return[];let o=nv(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await te(550)}return o.scrollTop=0,av(e)},iv=async(t,e)=>{try{let r=await(await fetch(ov,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},lv=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`,ds=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(Od)?.remove();let r=document.createElement("div");r.id=Od,r.style.cssText=lv;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((w,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{as()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{as()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await iv(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await te(1200);continue}let h=l._phone||m?.phone||"",v=m?.name||l.name;if(!h){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await te(1400);continue}if(await Md(h),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(u){p.debug("[bulk-dialer] screen-follow nav failed",u)}i(`Calling ${h}\u2026`,d,v);try{fd(),await te(250),wd(h),await te(250),kd()}catch(u){p.error("[bulk-dialer] dial failed",u)}if(await new Promise(u=>{let g=!1,w=()=>{g||(g=!0,window.clearInterval(y),k(),u())},k=$d(w),y=window.setInterval(()=>{(a.stopped||a.skip)&&w()},300)}),a.stopped)break;try{Ed()}catch{}if(d<e.length-1)if(o)for(let u=5;u>0&&!a.stopped&&!a.advance;u--){for(i(`Next call in ${u}s\u2026`,d,v);a.paused&&!a.stopped&&!a.advance;)await te(200);if(a.advance||a.stopped)break;await te(1e3)}else for(i("Ready \u2014 press Call Next",d,v);!a.advance&&!a.stopped;)await te(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},cs='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ps=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},dv=()=>{if(ke()!=="opportunity-list"||!ps()||!tn())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${Pd}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(Pd,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${_.pill};cursor:pointer;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${cs}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await sv(e);ds(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},We=null,ls,Rd=!1,Dd=()=>{if(Rd)return;Rd=!0,window.WS_CRM_PD_TEST=e=>void Hd("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{ls!==void 0&&window.clearTimeout(ls),ls=window.setTimeout(dv,400)};_t(e=>{e==="opportunity-list"?(t(),We||(We=new MutationObserver(t),We.observe(document.body,{childList:!0,subtree:!0}))):We&&(We.disconnect(),We=null)})};var Fd="ws-crm-pd-contacts-btn",cv=t=>new Promise(e=>setTimeout(e,t)),pv=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},mv=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,ms=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=pv(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},bv=async t=>{let e=new Map;if(t)return ms(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(ms(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(ms(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await cv(220);return o.scrollTop=0,[...e.values()]},uv=()=>{if(ke()!=="contact-list"||!ps()||!tn()||document.getElementById(Fd))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=Fd,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${_.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${b.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${cs}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=mv(),l=await bv(d);ds(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},Ge=null,bs,zd=!1,Nd=()=>{if(zd)return;zd=!0;let t=()=>{bs!==void 0&&window.clearTimeout(bs),bs=window.setTimeout(uv,400)};_t(e=>{e==="contact-list"?(t(),Ge||(Ge=new MutationObserver(t),Ge.observe(document.body,{childList:!0,subtree:!0}))):Ge&&(Ge.disconnect(),Ge=null)})};var hv="ws-calling-as-chip",_v=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},us=!1,ye=null,qd,jd=0,vv=3e4,yv=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},hs=()=>{if(!ye||ye.isConnected)return;let t=yv();t&&t.parent.insertBefore(ye,t.before)},Ud=async()=>{if(!(us||ye)&&_v()){us=!0;try{let t=await ss();if(!t.length)return;let e=await is()??t[0],o=t.length>1,r=document.createElement("div");r.id=hv,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${_.pill};color:${n.bone};font-family:${b.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${b.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Uo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Uo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${b.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Uo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",h=>{h.stopPropagation(),e=l,Id(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}ye=r,hs(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{us=!1,jd=Date.now()}}},Wd=()=>{ye?hs():Ud(),qd===void 0&&(qd=window.setInterval(()=>{ye?hs():Date.now()-jd>=vv&&Ud()},1500))};var gv="#12161D",fv="#EDEEF0",Gd=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},Kd=t=>{t.style.setProperty("background-color",gv,"important"),t.style.setProperty("color",fv,"important")},xv=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},wv=t=>{Gd(t)&&Kd(t);for(let e of Array.from(t.querySelectorAll("*")))Gd(e)&&Kd(e)},_s=null,Wo=null,Yd=()=>{Wo&&(Wo.disconnect(),Wo=null),_s=null},kv=t=>{if(_s===t)return;Yd(),_s=t;let e=!1,o=()=>{e=!1;try{wv(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Wo=new MutationObserver(r),Wo.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},Vd=!1,on=()=>{if(Vd)return;Vd=!0;let t=()=>{let o=xv();o?kv(o):Yd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var Ev="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",$v="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Tv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Zd="tc_closing_agent",Cv="tc_closing_office",$t="ws-crm-closing-agent-picker-button",Xd="ws-crm-closing-agent-picker-modal",Lv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Sv=/\/v2\/location\/([A-Za-z0-9]+)/,Vo=()=>{let t=window.location.pathname,e=t.match(Lv);if(!e)return null;let o=t.match(Sv);return{oppId:e[1],locationId:o?o[1]:null}},ws=async t=>{let e=await fetch(Ev,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Jd=async t=>{let e=await fetch($v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Av=async(t,e)=>{try{let o=await fetch(Tv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Zd}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await ws({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},ge=null,Iv=60*60*1e3,ks=t=>`ws-crm-to-cache:${t}`,tc=t=>{try{let e=window.localStorage.getItem(ks(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Iv||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},ec=(t,e,o)=>{try{window.localStorage.setItem(ks(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},Mv=t=>{try{window.localStorage.removeItem(ks(t))}catch{}},ys="ws-crm-closing-agent-field-link",Pv=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${ys}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},vs=!1,Es=async t=>{if(vs)return;let e=oc();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){vs=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await ws({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),gs(a.id,a.name,t);let s=document.getElementById($t);if(s){ee(s,{status:"linked",contactName:a.name});let i=Vo();i&&ec(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{vs=!1}}},Ov=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,oc=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();Ov.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let h=l.getAttribute(m);h&&/Title\s+Officer/i.test(h)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:h})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},gs=(t,e,o)=>{let r=oc();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${ys}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=ys,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},rn=()=>{document.getElementById(Xd)?.remove()},Bv=t=>{rn();let e=document.createElement("div");e.id=Xd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&rn()}),s?.addEventListener("click",rn);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await ws({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};ee(o,r);let a=tc(t);return a&&(r={status:"linked",contactName:a.contactName},ee(o,r),ge={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await Av(t,e);i?(r={status:"linked",contactName:i.name},ee(o,r),ge={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},gs(i.id,i.name,e)):a||(r={status:"empty"},ee(o,r),ge?.oppId===t&&(ge=null),Pv(),Mv(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Bv({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},ee(o,r);try{let d=await Jd({tenantId:e,oppId:t,fieldKey:Zd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await Jd({tenantId:e,oppId:t,fieldKey:Cv,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},ee(o,r),ge={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},ec(t,i.id,i.name),gs(i.id,i.name,e),Fl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},ee(o,r)}}})}),o},Hv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Dv=async()=>{for(let t of Hv)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Go=!1,sn=async()=>{if(!Go){Go=!0;try{await Fv()}finally{Go=!1}}},Fv=async()=>{let t=Vo();if(!t||!t.locationId){document.getElementById($t)?.remove(),document.getElementById(`${$t}-wrap`)?.remove(),an();return}let e=document.getElementById($t);if(e&&e.dataset.oppId===t.oppId){let l=F();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${$t}-wrap`)?.remove(),an());return}e&&(e.remove(),document.getElementById(`${$t}-wrap`)?.remove());let o=F();if(o!==null&&o!=="Transaction Coordination")return;let r=await Dv();if(!r||!(tc(t.oppId)!==null||ge!==null&&ge.oppId===t.oppId)&&await X()!=="Transaction Coordination")return;let s=Vo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=Rv(t.oppId,s.locationId),d=document.createElement("span");d.id=`${$t}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Y(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),zv(t.oppId),Es(s.locationId)},Ko=null,fs=null,xs=null,an=()=>{Ko?.disconnect(),Ko=null,fs=null,xs=null},zv=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ko&&fs===t&&xs===e||(an(),fs=t,xs=e,Ko=new MutationObserver(()=>{let o=Vo();if(!o||o.oppId!==t||!o.locationId){an();return}document.getElementById($t)||sn(),Es(o.locationId)}),Ko.observe(e,{childList:!0,subtree:!0})))},Nv=()=>{V("closing-agent-picker",Z,()=>{!document.getElementById($t)&&!Go&&sn()})},Qd,qv=()=>{Qd===void 0&&(Qd=window.setInterval(()=>{let t=Vo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById($t)&&!Go&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),sn()),Es(t.locationId)},2e3))},rc=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Nv(),qv(),sn()};var Uv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Nt="ws-crm-manage-team-cta",ac="ws-crm-manage-team-modal",jv=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,sc={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},Wv={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},ic=()=>{let t=window.location.pathname.match(jv);return t?{tenantId:t[1]}:null},dn=async t=>{let e=await fetch(Uv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},gt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),oe=t=>gt(t),$s="ws-crm-manage-team-toast",Ls=(t,e="info",o=4e3)=>{document.getElementById($s)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=$s,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById($s)===a&&a.remove()},o)},Ts=()=>{document.getElementById(ac)?.remove()},Gv=(t,e)=>{let o=Wv[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${gt(e)}</span>
  `},Kv=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>Gv(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>Kv(r,e)).join(""),cn=async t=>{Ts();let e=document.createElement("div");e.id=ac,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${b.sans};
  `,e.addEventListener("click",l=>{l.target===e&&Ts()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",Ts);let r;try{r=await dn({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+Vv(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{Yv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Jv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Qv(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},Yv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${gt(sc[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{cn(t)}),ln(e),setTimeout(()=>ln(e),200),setTimeout(()=>ln(e),800),sy(),e},nc=!1,sy=()=>{nc||(nc=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Nt);t instanceof HTMLButtonElement&&ln(t)}))},Cs=!1,iy=()=>{if(!Cs){Cs=!0;try{let t=ic();if(!t){document.getElementById(Nt)?.remove(),document.getElementById(`${Nt}-floater`)?.remove();return}let e=document.getElementById(Nt);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Nt}-floater`)?.remove();let o=document.createElement("div");o.id=`${Nt}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=ay(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{Cs=!1}}},lc=()=>{if(!ic()){document.getElementById(Nt)?.remove(),document.getElementById(`${Nt}-floater`)?.remove();return}iy()};var ly="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Is="ws-crm-prepare-contract-button",dc="ws-crm-prepare-contract-menu",Ot="ws-crm-prepare-contract-modal",cc="ws-crm-modal-date-style",qt="https://services.leadconnectorhq.com",_c=()=>{if(document.getElementById(cc))return;let t=document.createElement("style");t.id=cc,t.textContent=`
  ...
  `,document.head.appendChild(t)},Ms="__WS_CRM_CAPTURED_AUTH",dy=50*60*1e3,Zo=()=>{try{let t=localStorage.getItem(Ms);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>dy?(localStorage.removeItem(Ms),null):e:null}catch{return null}},cy=t=>{try{localStorage.setItem(Ms,JSON.stringify(t))}catch{}},Ve=()=>{let t=Zo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},pc=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Zo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),Ke=async(t,e={},o=2)=>{let r=Zo()?.capturedAt??0,a;try{a={...Ve(),...e.headers??{}}}catch(i){if(o>0&&await pc(r,4e3))return Ke(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await pc(r,4e3)?Ke(t,e,o-1):s},mc=!1,py=()=>{if(mc)return;mc=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=Zo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let h=c.authorization||c.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let v=c["token-id"]||c["Token-Id"]||void 0,u=Zo()?.authorization;cy({authorization:h,tokenId:v,capturedAt:Date.now()}),u!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let h=m.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let v={};if(h instanceof Headers)h.forEach((u,g)=>v[g.toLowerCase()]=u);else if(Array.isArray(h))h.forEach(([u,g])=>v[u.toLowerCase()]=g);else if(h&&typeof h=="object")for(let u of Object.keys(h))v[u.toLowerCase()]=h[u];o(c,v,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},vc=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},my=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:vc()},by=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},yc="__WS_CRM_TEMPLATES_CACHE_V1",uy=24*60*60*1e3,bc=t=>{try{let e=window.localStorage.getItem(yc);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>uy?null:o.templates}catch{return null}},hy=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(yc,JSON.stringify(o))}catch{}},_y=async t=>{let e=`${qt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await Ke(e,{method:"GET"})}catch(i){let d=bc(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=bc(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:by(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&hy(t,s),s},vy=async(t,e)=>{let o=await Ke(`${qt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await Ke(`${qt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},yy=async(t,e)=>{let o=await Ke(`${qt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${qt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Ve()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},gy=async t=>{let e=await fetch(ly,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},fy=async(t,e,o)=>{let r=`${qt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Ve()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},xy=async(t,e)=>{let o=await fetch(`${qt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Ve()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},gc=async t=>{let e=await fetch(`${qt}/contacts/${t}`,{method:"GET",headers:Ve()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},wy=async(t,e,o,r)=>{let a;try{a=await xy(t,e)}catch(u){return{ok:!1,body:`fetchProposalDocument: ${u.message}`}}let s;try{s=await gc(o)}catch(u){return{ok:!1,body:`fetchContactBasics: ${u.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(u=>u?.entityName!=="contacts"),d],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},v=await fetch(`${qt}/proposals/document/${e}`,{method:"PUT",headers:{...Ve(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!v.ok){let u=await v.text().catch(()=>"");return{ok:!1,status:v.status,body:u}}return{ok:!0}},ky=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},mn="__WS_CRM_PENDING_INSTRUCTIONS",Ey=60*1e3,$y=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ty=t=>{let e=(t||"").toLowerCase();for(let o of $y)if(e.includes(o.matches.toLowerCase()))return o;return null},Cy=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(mn,JSON.stringify(r))}catch{}},Ly=()=>{try{let t=localStorage.getItem(mn);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Ey?(localStorage.removeItem(mn),null):e}catch{return null}},Sy=()=>{try{localStorage.removeItem(mn)}catch{}},Ay=(t,e)=>{document.getElementById(Ot)?.remove();let o=document.createElement("div");o.id=Ot,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Iy=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,My=()=>{let t=window.location.pathname.match(Iy);if(!t)return;let e=t[1],o=Ly();o&&o.proposalId===e&&(Sy(),window.setTimeout(()=>{Ay(o.title,o.bodyHtml)},600))},uc="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(uc)?.remove();let r=document.createElement("div");r.id=uc;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},hc=(t,e)=>new Promise(o=>{document.getElementById(Ot)?.remove();let r=document.createElement("div");r.id=Ot,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await _y(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=B();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await yy(e.tenantId,e.contactId)}catch(f){nt(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await hc(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}m=f,p.info(`[prepare-contract] picked MT opp ${m}`)}}let h=y=>{let f=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),C=String(y.getDate()).padStart(2,"0");return`${f}-${$}-${C}`},v=y=>{let f=new Date;return f.setDate(f.getDate()+y),h(f)},u=v(45),g=v(7);nt("Reading contract data\u2026","info",2500);let w;try{w=await bn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:u,buyerEarnestDueDate:g,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||w.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}Oy({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:w,userId:c,defaultClosingDate:u,defaultEMDDueDate:g})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await vy(e.tenantId,e.contactId)}catch(u){nt(`Failed to load ACQ opps: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",u);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(m.length===1)h=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let u=await hc(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!u){p.info("[prepare-contract] ACQ opp picker cancelled");return}h=u,p.info(`[prepare-contract] picked ACQ opp ${h}`)}nt("Reading contract data\u2026","info",2500);let v;try{v=await bn({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:h,userId:c})}catch(u){nt(`Failed to prepare contract: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",u);return}Py({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:v})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await Bs(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},fc=()=>{let t=document.createElement("button");return t.id=Is,t.type="button",t.style.cssText=`${O} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),By(t)}),t},Ry="ws-crm-contact-actions-bar",Hy=async()=>{let t=vc();if(!t){document.getElementById(Is)?.remove();return}let e=null;try{e=await A(`#${Ry}`,{timeoutMs:se+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(Is);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=fc();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},fe="ws-crm-prepare-contract-button-opp",Yo=`${fe}-wrap`,Dy=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Fy=/\/v2\/location\/([A-Za-z0-9]+)/,zy=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Ps=()=>{let t=window.location.pathname,e=t.match(Dy);if(!e)return null;let o=t.match(Fy);return o?{oppId:e[1],tenantId:o[1]}:null},Ny=async()=>{for(let t of zy)try{let e=await A(t,{timeoutMs:2e3});if(e)return e}catch{}return null},pn=!1,Jo=null,Os=null,Ss=null,As,Qo=()=>{Jo?.disconnect(),Jo=null,Os=null},qy=t=>{if(Jo&&Os===t)return;Qo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Os=t,Jo=new MutationObserver(()=>{let o=Ps();if(!o||o.oppId!==t){Qo();return}let r=F();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(fe)?.remove(),document.getElementById(Yo)?.remove(),Qo();return}document.getElementById(fe)||xc()}),Jo.observe(e,{childList:!0,subtree:!0}))},Uy=()=>{Ss||(Ss=new MutationObserver(()=>{As===void 0&&(As=window.setTimeout(()=>{As=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(fe);t&&!e&&!pn&&xc()},300))}),Ss.observe(document.body,{childList:!0,subtree:!0}))},xc=async()=>{if(!pn){pn=!0;try{let t=Ps();if(!t){document.getElementById(fe)?.remove(),document.getElementById(Yo)?.remove(),Qo();return}let e=document.getElementById(fe);if(e&&e.dataset.oppId===t.oppId){let d=F();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(Yo)?.remove(),Qo());return}e&&(e.remove(),document.getElementById(Yo)?.remove());let o=await Ny();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await X();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=Ps();if(!a||a.oppId!==t.oppId)return;let s=fc();s.id=fe,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=Yo,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),qy(t.oppId)}finally{pn=!1}}},wc=()=>{My(),Hy()};py();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Pt(t){return bt(t)}var jy="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",xe="ws-crm-compute-offer-button",Ds="ws-crm-compute-offer-popover",Ac="ws-crm-offer-modal",kc="ws-crm-contact-actions-bar",Wy=[".central-panel","[class*='central-panel']"],re=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",Rs=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},Gy=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Ec=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${Gy[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},$c=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;outline:none;`,Hs=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(jy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Ye=()=>{document.getElementById(Ds)?.remove(),document.removeEventListener("mousedown",Ic,!0)};function Ic(t){let e=document.getElementById(Ds),o=document.getElementById(xe),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Ye()}var Mc=(t,e)=>{Ye();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=Ds;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${_.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${b.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Ic,!0),0)},un=(t,e)=>{Mc(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},Ky=(t,e,o)=>{Mc(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{Ye(),o(a.property_record_id)}),r.appendChild(s)})})},_n=()=>{document.getElementById(Ac)?.remove(),document.removeEventListener("keydown",Pc,!0)};function Pc(t){t.key==="Escape"&&_n()}var Tc=(t,e,o)=>{_n(),Ye();let r=o,a=!1,s="",i=document.createElement("div");i.id=Ac,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${b.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&_n()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,h,v)=>{a||(a=!0,s="",c(),Hs({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:h,repairOverride:v}).then(u=>{u&&u.ok?r={...u,current_offer:u.current_offer??r.current_offer,current_offer_date:u.current_offer_date??r.current_offer_date}:s=u&&u.error||"Request failed."}).catch(u=>{p.error("[compute-offer] worksheet request failed:",u),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,h=!!m.has_comps;d.innerHTML="";let v=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),u=q("div","");u.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),u.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let g=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");g.type="button",g.addEventListener("click",_n),v.append(u,g),d.appendChild(v);let w=q("div","padding:14px 18px 18px;");d.appendChild(w);let k=q("select",$c());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",$c());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let f=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");f.appendChild(q("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${Ec(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${_.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${b.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),f.append($),w.appendChild(f),m.low_confidence&&h&&w.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let C=m.current_offer!=null;w.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${_.sm};background:${n.slate};border:1px solid ${n.steel};color:${C?n.bone:n.ash};`,C?`Last offer made: ${re(m.current_offer)}${m.current_offer_date?` \xB7 ${Ec(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),x=q("div","");x.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),x.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(x,E),w.appendChild(T);let S=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),H=(U,W,N)=>{let jt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),Wt=q("div","");Wt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&Wt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);jt.append(Wt,pt),S.appendChild(jt)};if(h&&m.imv!=null){H("Investor Market Value (IMV)",re(m.imv)),m.arv!=null&&H("After Repair Value (ARV)",re(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?H(`Repairs (${N})`,"Included",{color:n.ash,sub:`${re(m.repair_total)} in repairs included at IMV`}):H(`Repairs (${N})`,Rs(W),{color:W<0?n.crimson:n.emerald,sub:`${re(m.repair_total)} total, ${re(m.baseline_repairs)} included at IMV`}),H("Min. Profit Target",Rs(-(m.profit_target??0)),{color:n.ash}),H("Maximum Cash Offer (MAO)",re(m.mao),{strong:!0,color:n.blue}),H("Target Profit",Rs(-(m.ico_delta??0)),{color:n.ash}),H("Initial Cash Offer (ICO)",re(m.ico),{strong:!0,color:n.blue})}else S.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));w.appendChild(S);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(h?"Saved to the Property.":""),w.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",Pc,!0)},Cc=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=xe,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){Ky(o,i.properties,d=>{a(!0),Hs({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Tc(e,l.property_record_id,l):un(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),un(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Tc(e,i.property_record_id,i):un(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await Hs({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),un(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Vy=async()=>{for(let t of Wy)try{let e=await A(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Lc=async(t,e)=>{let o=e.querySelector(`#${kc}`);if(!o)try{o=await A(`#${kc}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Sc=()=>{let t=document.querySelectorAll(`#${xe}`);for(let e=1;e<t.length;e++)t[e].remove()},Yy=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(xe)?.remove(),Ye();return}let e=t.locationId,o=document.getElementById(xe);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Ye();let r="seller";try{r=Lt(await Ct(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(xe)?.remove();return}let a=await Vy();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Cc(t.contactId,e);if(!await Lc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}Sc(),p.debug(`[compute-offer] mounted for ${t.contactId}`),hn?.disconnect(),hn=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){hn?.disconnect();return}if(!document.getElementById(xe)){let d=Cc(t.contactId,e);Lc(d,a).then(()=>Sc())}}),hn.observe(a,{childList:!0})},hn=null,Xo=null,Oc=()=>{let t=D()?.contactId??null;if(Xo&&Xo.id===t)return;let e=Yy().finally(()=>{Xo?.promise===e&&(Xo=null)});Xo={id:t,promise:e}};var wn="reos-theme-stylesheet",tp="reos-theme-fonts",Xe=!1,Jy=()=>{let t=document.getElementById(tp);t&&t.remove()},Qy=`
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var lp=new Set(["ej0SqnTYIprechAMAPrd"]),to="contact-select-trigger",dp="ws-crm-reply-from-warning",cp="contact-select-menu",op="ws-crm-rf-thread-opt",Ws="",Gs=!1,or=null,$n=null,rp=!1,rr="",np,ne=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Ks=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Bt=t=>(t||"").replace(/\D/g,"").slice(-10),ap=t=>{let e=Bt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Cg=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Lg=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await Hn(`${Bn}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return ne("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Sg=async()=>{let t=await Lg();if(!t)return null;let e=await Hn(`${Bn}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return ne("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Cg(a);if(Bt(s).length===10)return s}return null},eo=()=>document.getElementById(dp)?.remove(),pp=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Ag=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),mp=(t,e,o)=>{eo();let r=document.getElementById(to);if(!r)return;let a=pp(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=dp,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Ag(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${ap(t)}</span>${i}. You're set to reply from ${ap(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Ig=t=>{or?.disconnect();let e=document.getElementById(to);if(!e)return;let o=pp(e)||e,r=Bt(Ks(e));or=new MutationObserver(()=>{let a=Ks(document.getElementById(to)),s=Bt(a);!s||s===r||(r=s,s===Bt(t)?eo():mp(t,"",a))}),or.observe(o,{childList:!0,subtree:!0,characterData:!0})},sp=()=>{let t=document.getElementById(cp);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(rr&&(r=e.find(d=>Bt(o(d))===Bt(rr))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),ne("decorateMenu: cache=",rr,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(op);s&&s!==r&&s.removeAttribute("id"),r.id=op;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},Mg=()=>{if(!lp.has(K()||""))return;$n?.disconnect();let t=0,e=()=>{let o=document.getElementById(cp);if(o){sp(),$n=new MutationObserver(()=>sp()),$n.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Pg=t=>{let e=t.target;e&&e.closest&&e.closest("#"+to)&&(ne("From trigger clicked -> waiting for menu"),Mg())},Og=async()=>{if(!Gs){Gs=!0;try{let t=document.getElementById(to);if(!t)return;let e=Ks(t),o=await Sg();if(rr=o||"",ne("check: from=",e,"thread=",o),!o){eo();return}Bt(e)&&Bt(e)!==Bt(o)?(ne("MISMATCH -> banner"),mp(o,"",e)):(ne("match -> no banner"),eo()),Ig(o)}finally{Gs=!1}}},ip=()=>{if(!lp.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){Ws="",rr="",or?.disconnect(),$n?.disconnect(),eo();return}let e=!!document.getElementById(to),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==Ws){if(Ws=r,!e){or?.disconnect(),eo();return}ne("composer expanded on",o),Og()}},bp=()=>{np===void 0&&(np=window.setInterval(ip,500)),rp||(document.addEventListener("click",Pg,!0),rp=!0),ip()};var Bg="#1A1F28",Rg="#EDEEF0",Vs="#9098A3",Hg=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},Dg=t=>.2126*t.r+.7152*t.g+.0722*t.b,Fg=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},up=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},zg=t=>{let e=Hg(getComputedStyle(t).backgroundColor);if(!e||Dg(e)<120)return;let o=Fg(e);t.style.setProperty("background-color",Bg,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),up(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Rg),up(t,"#note-date-added-text, [class*='475467']",Vs)},Ng=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",Vs,"important"),e.style.setProperty("-webkit-text-fill-color",Vs,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},hp=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)zg(t[e]),Ng(t[e])},_p,vp=()=>{_p===void 0&&(_p=window.setInterval(hp,700)),hp()};var qg='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',yp=()=>{document.querySelectorAll(qg).forEach(t=>{t.setAttribute("autocomplete","off")})},gp,fp=()=>{gp===void 0&&(gp=window.setInterval(yp,1e3)),yp()};console.log("[ws-crm-customizer] bundle-loaded");var L=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},xp=()=>{p.info(`Loaded v${ir} (built ${lr})`),Sn()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",er),L("mountDialerThemeFix",on)):(L("mountVersionBadge (initial)",En),L("mountFavicon",Qi),L("mountThemeStylesheet",er),L("mountHideLaunchpad",Pa),L("mountHideNavItems",Oa),L("mountRelabelNav",Ba),L("mountHideTopmenuTabs",Ha),L("mountContractsSection",Ra)),L("installOppIdCapture",oi),L("initPageRouter",Zs),p.info("[main] registering onPageChange subscriber"),_t(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),Sn()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),L("mountThemeStylesheet",er),L("runThemeFastPass",js),L("mountDialerThemeFix",on),L("unmountContactMapLinks",Tl);return}L("mountThemeStylesheet",er),L("runThemeFastPass",js),L("mountVersionBadge",En),L("mountHideLaunchpad",Pa),L("mountHideNavItems",Oa),L("mountRelabelNav",Ba),L("mountHideTopmenuTabs",Ha),L("mountContractsSection",Ra),L("mountAnalyticsDashboard",hi),L("mountClaimReleaseToggle",Hi),L("mountContactActionsBar",Yi),L("mountActiveFollowUpButton",di),L("mountMtOfferMadeButton",el),L("mountNotInterestedButton",ol),L("mountScheduleWalkthroughButton",rl),L("mountResendDealLinkButton",al),L("mountAddReferralBuyer",cl),L("mountReducePriceButton",ml),L("mountEditLandingPageButton",bl),L("mountPublishButton",vl),L("mountContactMapLinks",$l),L("mountSendToClosingOfficeButton",zl),L("mountOppActionBar",od),L("mountClosingAgentPickerButton",rc),L("mountPrepareContractButton",wc),L("mountComputeOfferButton",Oc),L("mountManageTeam",lc),L("mountBuyBoxWidget",xi),L("mountSellerContactFlag",Pi),L("mountPropertiesWidget",Ii),L("mountSupportNavItem",md),L("mountPhoneAssignmentsWidget",yd),L("mountBulkPowerDialer",Dd),L("mountBulkPowerDialerContacts",Nd),L("mountCallingAsChip",Wd),L("mountDialerThemeFix",on),L("mountReplyFromWarning",bp),L("mountNoteCanon",vp),L("mountSuppressAutofill",fp)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",xp):xp();})();
