...
`;var Vo=/^[A-Za-z0-9]{15,30}$/,J=o=>typeof o=="string"&&Vo.test(o),qo=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},zo=()=>{let o=window.WS_CRM_USER_ID;return J(o)?o:null},Wo=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(J(t))return t;return null},jo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=qo(e);if(!t)return null;let r=t.uid;if(J(r))return r;let n=t.claims;if(n&&J(n.user_id))return n.user_id}catch{}return null},Ko=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(J(n))return n}catch{}}}catch{}return null},L=()=>zo()||Wo()||jo()||Ko()||null;var Nt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Yo=`${Nt}/active-follow-up-get`,Xo=`${Nt}/active-follow-up-set`,V="ws-crm-active-follow-up-button",Je={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},Jo=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Zo=async o=>{let e=await fetch(Yo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},Qo=async(o,e)=>{let t=await fetch(Xo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},q=(o,e)=>{let t=Je[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},Ot=o=>{let e=document.createElement("button");return e.type="button",e.id=V,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,P(t,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let v=await fn(o,e);if(!v){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(v.rate_limited){u=Date.now()+h,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(v.checks)||v.checks.length===0){n={status:"error",message:v.error||"Check failed \u2014 click to retry"},P(t,n),b.warn("[stc] dry_run returned no checks:",v);return}let _=v.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(z)?.remove(),document.getElementById(X)?.remove(),N(),le();return}let y=v.checks;if(n.checks&&n.checks.length===v.checks.length){let T=new Set;y=v.checks.map((w,F)=>n.checks[F]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:y.every(T=>T.filled)?"ready":"incomplete",checks:y,previouslySentAt:v.previously_sent_at??null},gn(o,{checks:y,previously_sent_at:v.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(Fe)&&Le(y,v.previously_sent_at,t)},s=async()=>{let v=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),N();try{let _=await wn(o,e,v);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&Le(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":s();break;case"incomplete":{document.getElementById(Fe)?N():n.checks&&Le(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,p=Date.now(),m=1e4,h=5*60*1e3,u=0,g=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,p=Date.now();try{await i()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let v=new MutationObserver(()=>{if(d!==void 0||c)return;let y=Date.now()-p,E=Math.max(1500,m-y);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},E)});v.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(v.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},Tn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Sn=async()=>{for(let o of Tn)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ae=!1,_t=async()=>{if(Ae){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Ae=!0;try{await Cn()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{Ae=!1}},Cn=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=mt();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(z)?.remove(),document.getElementById(X)?.remove(),N();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(z);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let s=A();s!==null&&s!=="Transaction Coordination"&&(e.remove(),document.getElementById(X)?.remove(),N(),le());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(X)?.remove(),N()),b.debug("[stc] mount:04 calling findMountTarget");let t=await Sn();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=A();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=mt();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=En(o.oppId,n.locationId),i=document.createElement("span");i.id=X,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),In(o.oppId)},se=null,ut=null,le=()=>{se?.disconnect(),se=null,ut=null},In=o=>{if(se&&ut===o)return;le();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ut=o,se=new MutationObserver(()=>{let t=mt();if(!t||t.oppId!==o){le();return}let r=A();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(z)?.remove(),document.getElementById(X)?.remove(),N(),le();return}document.getElementById(z)||_t()}),se.observe(e,{childList:!0,subtree:!0}))},ht=null,pt,Ln=()=>{ht||(ht=new MutationObserver(()=>{pt===void 0&&(pt=window.setTimeout(()=>{pt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(z);o&&!e&&!Ae&&_t()},300))}),ht.observe(document.body,{childList:!0,subtree:!0}))},bo=()=>{Ln(),_t()};var An="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",Fn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Mn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",po="ldtyB2UXKi9vOp8nLUH7",Dn="WVD2gb9swLsgcdBEtDVq",B="ws-crm-title-officer-picker-button",mo="ws-crm-title-officer-picker-modal",On=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Hn=/\/v2\/location\/([A-Za-z0-9]+)/,ft=()=>{let o=window.location.pathname,e=o.match(On);if(!e)return null;let t=o.match(Hn);return{oppId:e[1],locationId:t?t[1]:null}},Et=async o=>{let e=await fetch(An,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},ho=async o=>{let e=await fetch(Fn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Pn=async(o,e)=>{try{let t=await fetch(Mn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:po}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await Et({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(t){return b.warn("[title-officer] fetchCurrent failed:",t),null}},Me=null,wt="ws-crm-title-officer-field-link",Nn=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${wt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-title-officer-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsTitleOfficerDecorated}))},vt=!1,uo=async o=>{if(vt)return;let e=_o();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[title-officer] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[title-officer] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsTitleOfficerDecorated!==t){vt=!0;try{b.info(`[title-officer] tryDecorate: looking up ${t}`);let r=await Et({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[title-officer] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[title-officer] tryDecorate: applying ${n.name} (${n.id})`),xt(n.id,n.name,o);let a=document.getElementById(B);a&&W(a,{status:"linked",contactName:n.name})}catch(r){b.warn("[title-officer] tryDecorate lookup failed:",r)}finally{vt=!1}}},Bn=/^TC\s*[-‐–—]\s*Title\s+Officer$/i,_o=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();Bn.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let p of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(p);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:p,value:m})}}if(b.info(`[title-officer] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[title-officer] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[title-officer] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=t[0].parentElement,s=0;for(;i&&s<8;){let d=i.querySelector("input");if(d)return b.info(`[title-officer] findInput: located input ${s} levels up from label`),d;i=i.parentElement,s+=1}return b.warn("[title-officer] findInput: label found but no <input> within 8 ancestors"),null},xt=(o,e,t)=>{let r=_o();if(!r)return;let n=r.dataset.wsTitleOfficerDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${wt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsTitleOfficerDecorated=o,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let s=document.createElement("a");s.className=wt,s.href=`/v2/location/${t}/contacts/detail/${o}`,s.textContent=e,s.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&De()}),a?.addEventListener("click",De);let i,s="",d=async c=>{if(n&&c!==s){if(s=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
      ...
      <div style="padding: 16px; color: ${l.ash}; font-size: 13px; text-align: center;">
        ...
        `,h.addEventListener("mouseenter",()=>{h.style.background=l.slate}),h.addEventListener("mouseleave",()=>{h.style.background="transparent"}),h.addEventListener("click",()=>{De(),o.onPick(m)}),n.appendChild(h)})}catch(p){b.error("Title Officer picker search failed",p),n&&(n.innerHTML=`
          ...
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(c)},250)})},Oe=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),W=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Title Officer",a=l.amber,i=l.bone,s="transparent",d=l.steel,c="pointer";switch(e.status){case"loading":n="Loading Title Officer\u2026",a=l.coolGray,i=l.ash,c="wait";break;case"empty":n="Link Title Officer",a=l.amber;break;case"linked":n=e.contactName?`Title Officer: ${e.contactName}`:"Title Officer: \u2713",a=l.emerald,s=l.emeraldGlow,d=l.emeraldBorder,i=l.emeraldBright;break;case"saving":n="Linking\u2026",a=l.coolGray,i=l.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=s,o.style.borderColor=d,o.style.color=i,o.style.cursor=c},$n=(o,e)=>{let t=document.createElement("button");t.id=B,t.type="button",t.dataset.oppId=o,t.style.cssText=I,t.title="Pick the Title Officer contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};return W(t,r),(async()=>{let a=await Pn(o,e);a?(r={status:"linked",contactName:a.name},W(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e)):(r={status:"empty"},W(t,r),Me?.oppId===o&&(Me=null),Nn())})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Rn({oppId:o,locationId:e,onPick:async a=>{r={status:"saving"},W(t,r);try{let i=[ho({tenantId:e,oppId:o,fieldId:po,value:a.id})];a.companyName&&a.companyName.trim()&&i.push(ho({tenantId:e,oppId:o,fieldId:Dn,value:a.companyName.trim()}));let d=(await Promise.all(i))[0];if(!d.ok)throw new Error(d.error??"Save failed");r={status:"linked",contactName:a.name},W(t,r),Me={oppId:o,contactId:a.id,contactName:a.name,tenantId:e},xt(a.id,a.name,e),b.info(`Title Officer linked: ${a.name} (${a.id})${a.companyName?` \u2014 Company: ${a.companyName}`:""}`)}catch(i){b.error("Title Officer link failed",i),r={status:"empty"},W(t,r)}}})}),t},Gn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Un=async()=>{for(let o of Gn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},He=!1,Tt=async()=>{if(!He){He=!0;try{await Vn()}finally{He=!1}}},Vn=async()=>{let o=ft();if(!o||!o.locationId){document.getElementById(B)?.remove(),document.getElementById(`${B}-wrap`)?.remove(),Pe();return}let e=document.getElementById(B);if(e&&e.dataset.oppId===o.oppId){let d=A();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove(),Pe());return}e&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove());let t=A();if(t!==null&&t!=="Transaction Coordination")return;let r=await Un();if(!r||await U()!=="Transaction Coordination")return;let a=ft();if(!a||a.oppId!==o.oppId||!a.locationId)return;let i=$n(o.oppId,a.locationId),s=document.createElement("span");s.id=`${B}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),s.appendChild(i),r.appendChild(s),b.debug(`Mounted Title Officer picker on opp ${o.oppId}`),qn(o.oppId),uo(a.locationId)},de=null,kt=null,Pe=()=>{de?.disconnect(),de=null,kt=null},qn=o=>{if(de&&kt===o)return;Pe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(kt=o,de=new MutationObserver(()=>{let t=ft();if(!t||t.oppId!==o||!t.locationId){Pe();return}document.getElementById(B)||Tt(),uo(t.locationId)}),de.observe(e,{childList:!0,subtree:!0}))},yt=null,gt,zn=()=>{yt||(yt=new MutationObserver(()=>{gt===void 0&&(gt=window.setTimeout(()=>{gt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(B);o&&!e&&!He&&Tt()},300))}),yt.observe(document.body,{childList:!0,subtree:!0}))},vo=()=>{zn(),Tt()};var Ue="reos-theme-stylesheet",Ho="reos-theme-fonts",Wn=()=>{let o=document.getElementById(Ho);o&&o.remove()},jn=`
/* ============================================
