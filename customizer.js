/* Wholesaling CRM Customizer v0.15.1 — built 2026-05-30T18:52:34.150Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Ae="[wholesaling-crm-customizer]",Lr="__WS_CRM_DEBUG",Mr=()=>!!window[Lr],b={info(...o){console.log(Ae,...o)},warn(...o){console.warn(Ae,...o)},error(...o){console.error(Ae,...o)},debug(...o){Mr()&&console.log(Ae,"[debug]",...o)}};var lo=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,bt=/\/v2\/location\/([A-Za-z0-9]+)/,Dr=o=>{let e=o.match(lo);if(!e)return null;let t=o.match(bt);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},Fr=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(lo);if(!n)continue;let a=r.match(bt)||window.location.pathname.match(bt);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=Dr(window.location.pathname);return o||Fr()};var co=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},Me="",ht=null,se="other",pt=new Set,Le=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==Me)&&!(o!==ht))){Me=window.location.pathname,ht=o,se=co(),b.debug("Page/context changed:",se,Me,"contact:",o);for(let r of pt)try{r(se)}catch(n){b.error("Subscriber threw:",n)}}},bo=o=>(pt.add(o),setTimeout(()=>o(se),0),()=>{pt.delete(o)}),ho=()=>{se=co(),Me=window.location.pathname,ht=S()?.contactId??null,b.debug("Router init, current page:",se);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),Le()},history.replaceState=function(t,r,n){e(t,r,n),Le()},window.addEventListener("popstate",Le),setInterval(Le,1e3)};var De="0.15.1",Fe="2026-05-30T18:52:34.151Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,i)=>{let l=n.querySelector(o);if(l){a(l);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),i(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var s={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},w={sm:"4px",md:"6px",lg:"10px",pill:"999px"},_={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},mt={purple:"#8B5CF6",green:s.emerald,orange:s.amber,red:s.crimson},po=o=>{let e=o==="emerald"?s.emeraldGlow:o==="amber"?s.amberGlow:s.slate,t=o==="emerald"?s.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":s.steel,r=o==="emerald"?s.emerald:o==="amber"?s.amber:s.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,L=`
  ...
  flex-shrink: 0;
`;var $r=/^[A-Za-z0-9]{15,30}$/,de=o=>typeof o=="string"&&$r.test(o),Pr=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},Or=()=>{let o=window.WS_CRM_USER_ID;return de(o)?o:null},Hr=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(de(t))return t;return null},Nr=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=Pr(e);if(!t)return null;let r=t.uid;if(de(r))return r;let n=t.claims;if(n&&de(n.user_id))return n.user_id}catch{}return null},Br=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(de(n))return n}catch{}}}catch{}return null},A=()=>Or()||Hr()||Nr()||Br()||null;var vo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",Rr=`${vo}/active-follow-up-get`,Gr=`${vo}/active-follow-up-set`,ee="ws-crm-active-follow-up-button",_t={amber:{label:"Add to Active Follow Up",bg:s.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:s.amber,clickable:!0,dotColor:s.amber},blue:{label:"In Active Follow Up",bg:s.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:s.blue,clickable:!1,dotColor:s.blue},gray:{label:"Not in Follow Up",bg:s.slate,border:s.steel,color:s.coolGray,clickable:!1,dotColor:s.coolGray},loading:{label:"Active Follow Up\u2026",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.ash},error:{label:"Follow Up status unavailable",bg:s.slate,border:s.steel,color:s.ash,clickable:!1,dotColor:s.crimson}},zr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Ur=async o=>{let e=await fetch(Rr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},qr=async(o,e)=>{let t=await fetch(Gr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},te=(o,e)=>{let t=_t[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},mo=o=>{let e=document.createElement("button");return e.type="button",e.id=ee,e.dataset.contactId=o,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,te(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=zr();if(!(!r||r.contactId!==o)){te(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await qr(r,A()),a=n&&n.state&&n.state in _t?n.state:"blue";te(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),te(e,"error"),setTimeout(()=>void $e(e,r),4e3)}}}),e},$e=async(o,e)=>{te(o,"loading");try{let t=await Ur(e),r=t&&t.state&&t.state in _t?t.state:"gray",n=document.getElementById(ee);if(!n||n.dataset.contactId!==e.contactId)return;te(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),te(o,"error")}},Vr=[".central-panel","[class*='central-panel']"],ut="ws-crm-contact-actions-bar",Wr=async()=>{for(let o of Vr)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},jr=async(o,e)=>{let t=e.querySelector(`#${ut}`);if(!t)try{t=await C(`#${ut}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let a=e.querySelector(`#${ut}`);a&&a.parentElement===e?e.insertBefore(n,a.nextSibling):e.insertBefore(n,e.firstChild)}return n.appendChild(o),{container:n,placement:"fallback"}},Kr=()=>{let o=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!o)return null;let e=o;for(let t=0;t<8&&!(!e||!e.parentElement);t++){let r=e.parentElement,n=(r.className||"").toString();if(n.includes("justify-between")&&n.includes("border-b")){let a=r.children[1];return a instanceof HTMLElement?a:r}e=r}return null},Yr=(o,e)=>{o.style.marginRight="4px",e.insertBefore(o,e.firstChild)},Xr=async o=>{if(o==="url"){let t=await Wr();return t?{kind:"contact-detail",target:t}:null}let e=Kr();return e?{kind:"conversations",target:e}:null},uo=async(o,e)=>{if(e.kind==="contact-detail"){let{placement:t}=await jr(o,e.target);return t}return Yr(o,e.target),"conversations-header"},Jr=async()=>{let o=S();if(!o||!o.locationId){document.getElementById(ee)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:o.contactId,tenantId:o.locationId},t=document.getElementById(ee);if(t&&t.dataset.contactId===e.contactId){$e(t,e);return}t&&t.remove();let r=await Xr(o.source);if(!r){b.warn(`Active Follow Up: no mount target on ${o.source}-source page`);return}let n=S();if(!n||n.contactId!==e.contactId)return;let a=mo(e.contactId),i=await uo(a,r);b.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),_o();let l=document.getElementById(ee)??a;$e(l,e);let d=new MutationObserver(()=>{let c=document.getElementById(ee);if(!(S()?.contactId===e.contactId)){d.disconnect();return}if(!c){let m=mo(e.contactId);uo(m,r).then(()=>{_o(),$e(m,e)}),b.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}});d.observe(r.target,{childList:!0})},ce=null,yo=()=>{let o=S()?.contactId??null;if(ce&&ce.contactId===o)return;let e=Jr().finally(()=>{ce?.promise===e&&(ce=null)});ce={contactId:o,promise:e}},_o=()=>{let o=document.querySelectorAll(`#${ee}`);if(!(o.length<=1)){b.debug(`Active Follow Up: found ${o.length} duplicate buttons, keeping first, removing ${o.length-1}`);for(let e=1;e<o.length;e++)o[e].remove()}};var Y="ws-crm-claim-release-pill",Qr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Zr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",en=async o=>{let e=await fetch(Qr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},tn=async o=>{let e=await fetch(Zr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,contact_id:o.contactId,triggered_by_user_id:o.userId,action:o.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},wo=o=>{let e=Array.from(o.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let n=r.className?.toString()??"";return n.includes("flex")&&n.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},ie=(o,e)=>{let t=e==="claim"?"emerald":"amber",r=e==="claim"?s.emerald:s.amber;o.dataset.mode=e,o.style.cssText=po(t),o.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",o.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},on=({contactId:o,mode:e})=>{let t=document.createElement("button");return t.id=Y,t.type="button",t.dataset.contactId=o,ie(t,e),t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",async()=>{let r=t.dataset.mode??"claim",n=S();if(!n||!n.locationId||n.contactId!==o)return;let a=A();if(!a){b.warn("Claim/Release click: no user ID detected (login session not exposing it)");let l=t.querySelector(".ws-cr-label");l&&(l.textContent="Sign-in needed"),setTimeout(()=>ie(t,r),2500);return}b.info(`Claim/Release click \u2014 contact=${o} mode=${r} user=${a}`);let i=r==="claim"?"release":"claim";ie(t,i),t.disabled=!0,t.style.opacity="0.8";try{let l=await tn({contactId:o,locationId:n.locationId,userId:a,action:r}),d=l?.mode==="claim"||l?.mode==="release"?l.mode:i;ie(t,d),b.info(`Claim/Release done \u2192 new mode: ${d}`)}catch(l){b.error("Claim/Release Set webhook failed",l),ie(t,r);let d=t.querySelector(".ws-cr-label");if(d){let c=d.textContent??"";d.textContent="Try again",setTimeout(()=>{d.textContent==="Try again"&&(d.textContent=c)},2500)}}finally{t.disabled=!1,t.style.opacity="1"}}),t},go=async(o,e)=>{try{let t=await en({contactId:e.contactId,locationId:e.locationId,userId:A()}),r=document.getElementById(Y);if(!r||r.dataset.contactId!==e.contactId)return;let n=t?.mode==="release"?"release":"claim";ie(r,n)}catch(t){b.warn("Claim/Release Get failed; pill stays in default 'claim' mode",t)}},rn=async(o,e=1e4)=>{let t=Date.now();for(;Date.now()-t<e;){let r=wo(o);if(r)return r;await new Promise(n=>setTimeout(n,150))}return null},fo=(o,e)=>{let t=on({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${Y}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(t),o.appendChild(r)},nn=async()=>{let o=S();if(!o){document.getElementById(Y)?.remove();return}let e=document.getElementById(Y);if(!(e&&e.dataset.contactId===o.contactId)){e&&e.remove();try{let t=await C("#record-details-lhs",{timeoutMs:1e4}),r=await rn(t),n=S();if(!n||n.contactId!==o.contactId)return;if(!r){b.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}fo(r,o.contactId),b.debug(`Mounted Claim/Release pill next to name for ${o.contactId}`);let a=document.getElementById(Y);a&&o.locationId&&go(a,{contactId:o.contactId,locationId:o.locationId});let i=null;i=new MutationObserver(async()=>{if(!(S()?.contactId===o.contactId)){i?.disconnect();return}if(document.getElementById(Y))return;let d=wo(t);if(d){fo(d,o.contactId);let c=document.getElementById(Y);c&&o.locationId&&go(c,{contactId:o.contactId,locationId:o.locationId}),b.debug("Re-mounted Claim/Release pill after React wipe")}}),i.observe(t,{childList:!0,subtree:!0})}catch(t){b.warn("Could not mount Claim/Release pill:",t)}}},xo=()=>{nn()};var an="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",be=new Map,ko=async(o,e)=>{if(!o)return null;if(be.has(o))return be.get(o)??null;if(!e)return b.warn(`Cannot fetch Contact Type for ${o} \u2014 tenant_id missing from URL context`),null;let t=new AbortController,r=setTimeout(()=>t.abort(),1500);try{let n=`${an}?contact_id=${encodeURIComponent(o)}&tenant_id=${encodeURIComponent(e)}`,a=await fetch(n,{method:"GET",headers:{Accept:"application/json"},signal:t.signal});if(clearTimeout(r),!a.ok)return b.warn(`Contact Type fetch returned ${a.status} for ${o}`),be.set(o,null),null;let l=((await a.json()).contact_type||"").toLowerCase().trim()||null;return be.set(o,l),b.debug(`Resolved Contact Type for ${o}: ${l??"(unset)"}`),l}catch(n){return clearTimeout(r),b.warn(`Contact Type fetch failed for ${o}:`,n),be.set(o,null),null}};var Eo=o=>o==="buyer"?"buyer":o==="seller"?"seller":o==="agent"||o==="closing_agent"||o==="closing_office"||o==="vendor"?"other":"seller";var Lo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",sn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set";var ln="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",dn=async({contactId:o,locationId:e,status:t,userId:r,deadReason:n,webhookUrl:a,kind:i})=>{let l=a||Lo,d;if(i==="buyer"){let h=Mo.find(p=>p.label===t),m=h?h.value:t.toLowerCase().replace(/\s+/g,"-");d={tenant_id:e,contact_id:o,new_status:m,triggered_by_user_id:r??""}}else{let h={call_status:t,triggered_by_user_id:r??""};n&&(h.dead_reason=n),d={contact_id:o,location:{id:e},customData:h}}let c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},cn=async({contactId:o,tenantId:e})=>{let t=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:o}),credentials:"omit"});if(!t.ok)throw new Error(`Sanity check returned ${t.status} ${t.statusText}`);return await t.json()};var le="ws-crm-contact-actions-bar",bn="ws-crm-call-status-dropdown",To="ws-crm-offer-made-modal",hn=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Mo=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],pn=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],mn=async()=>{for(let o of pn)try{let e=await C(o,{timeoutMs:2e3});if(e)return b.debug(`[actions-bar] mount target found via selector: ${o}`),e}catch{}try{let o=await C("#contact-conversation-panel",{timeoutMs:2e3});if(o.parentElement)return b.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),o.parentElement}catch{}for(let o of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[actions-bar] mount target via fallback: ${o}`),e.parentElement??e}catch{}return b.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},un=({contactId:o,kind:e})=>{let t=e==="buyer"?Mo:hn,r=e==="buyer"?sn:Lo,n=e==="buyer"?"Buyer Call Status":"Seller Call Status",a=document.createElement("div");a.id=bn,a.style.cssText="position: relative; flex-shrink: 0;";let i=document.createElement("button");i.type="button",i.style.cssText=L,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
  ...
  `,t.forEach(d=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${mt[d.color]};
        flex-shrink: 0;
      "></span>
      <span>${d.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=s.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{b.info(`Call Status set to "${d.label}" (${d.value}, ${d.color}) for contact ${o}`);let h=i.firstElementChild,m=i.children[1],p=i.children[2];h&&(h.style.background=mt[d.color]),m&&(m.textContent=d.label),l.style.display="none";let f=S()?.locationId,k=A();if(!f){b.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),m&&(m.textContent=`${d.label} (no tenant!)`),m&&(m.style.color=s.amber);return}if(e==="seller"&&d.color==="green"&&!k){b.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),m&&(m.textContent=`${d.label} (no user!)`),m&&(m.style.color=s.amber);return}let y=p?.textContent??"\u25BE",v=async g=>{p&&(p.textContent="\u2026"),i.style.opacity="0.75";try{await dn({contactId:o,locationId:f,status:d.label,userId:k,deadReason:g,webhookUrl:r,kind:e}),p&&(p.textContent="\u2713"),setTimeout(()=>{p&&(p.textContent=y),i.style.opacity="1"},900)}catch(E){b.warn("Call Status webhook failed:",E),p&&(p.textContent="\u2717"),m&&(m.style.color=s.amber),i.style.opacity="1",setTimeout(()=>{p&&(p.textContent=y),m&&(m.style.color=s.bone)},1800)}};if(e==="seller"&&d.value==="dead-deal"){let g=m?.textContent??"";gn(E=>{v(E)},()=>{m&&(m.textContent=g)});return}if(e==="seller"&&d.value==="appointment-booked"){let g=m?.textContent??"";try{(await cn({contactId:o,tenantId:f})).ok?await v():fn(()=>{v()},()=>{m&&(m.textContent=g)})}catch(E){b.warn("Appointment sanity check failed; firing anyway:",E),await v()}return}await v()}),l.appendChild(c)}),i.addEventListener("click",d=>{d.stopPropagation(),l.style.display=l.style.display==="none"?"block":"none"}),document.addEventListener("click",d=>{a.contains(d.target)||(l.style.display="none")}),a.appendChild(i),a.appendChild(l),a},_n="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",vn=async o=>{let e=await fetch(_n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,kind:o.kind,amount:o.amount,expires_at:o.expiresAt,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},yn=(o,e="seller")=>{document.getElementById(To)?.remove();let t=e==="seller",r=t?"Record Your Offer":"Record Buyer's Offer",n=t?"Attributes the offer to you for KPI tracking. Updates the ACQ opportunity's offer fields.":"Logs the buyer's offer on their Marketing Tracker card. Advances them to 'Made an Offer'.",a=t?s.emerald:s.amber,i=document.createElement("div");i.id=To,i.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let d=new Date,c=new Date(d.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),h=t?`
    <label style="
      display: block;
      font-family: ${_.mono};
      font-size: 10px;
    ...
    <div style="
      ...
      margin-bottom: 16px;
    ">
      <span style="color: ${s.ash}; font-family: ${_.mono}; font-size: 14px;">$</span>
  ...
  `,i.appendChild(l),document.body.appendChild(i);let m=()=>i.remove();i.addEventListener("click",k=>{k.target===i&&m()});let p=l.querySelector("#ws-offer-error"),u=l.querySelector("#ws-offer-cancel"),f=l.querySelector("#ws-offer-submit");u?.addEventListener("click",m),f?.addEventListener("click",async()=>{let k=(l.querySelector("#ws-offer-amount")?.value??"").trim(),y=t?l.querySelector("#ws-offer-expires")?.value??"":"";if(!k||Number(k)<=0){p&&(p.textContent="Enter a positive offer amount."),b.warn("Offer Made submit blocked \u2014 invalid amount");return}let v=Number(k);if(v<100){p&&(p.textContent=`That looks low \u2014 did you mean $${(v*1e3).toLocaleString("en-US")}?`);return}let E=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),T=E?E[1]:null;if(!T){p&&(p.textContent="Couldn't resolve tenant from URL. Refresh and try again.");return}p&&(p.textContent=""),f&&(f.disabled=!0,f.textContent="Recording\u2026",f.style.opacity="0.7"),u&&(u.disabled=!0);try{let x=await vn({tenantId:T,contactId:o,kind:e,amount:v,expiresAt:y||null,userId:A()});if(!x.ok){p&&(p.textContent=x.error??"Something went wrong."),f&&(f.disabled=!1,f.textContent="Record Offer",f.style.opacity="1"),u&&(u.disabled=!1);return}b.info(`Offer Made (${e}) recorded for contact ${o}: $${v} on ${x.opp_pipeline} opp (stage: ${x.opp_stage_name??"?"})`),m()}catch(x){b.error("Offer Made webhook failed",x),p&&(p.textContent=x instanceof Error?x.message:"Network error \u2014 try again."),f&&(f.disabled=!1,f.textContent="Record Offer",f.style.opacity="1"),u&&(u.disabled=!1)}}),setTimeout(()=>{l.querySelector("#ws-offer-amount")?.focus()},0)},So="ws-crm-dead-deal-modal",gn=(o,e)=>{document.getElementById(So)?.remove();let t=document.createElement("div");t.id=So,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,t.appendChild(r),document.body.appendChild(t);let n=()=>t.remove(),a=()=>{n(),e()};t.addEventListener("click",l=>{l.target===t&&a()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",a),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{n(),o()});let i=l=>{l.key==="Escape"&&(document.removeEventListener("keydown",i),a())};document.addEventListener("keydown",i)},Io=(o,e)=>{let t=document.createElement("div");if(t.id=le,t.dataset.contactId=o,t.dataset.contactKind=e,t.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${s.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=q,r.textContent="Offer Made",r.addEventListener("click",()=>yn(o,e)),t.appendChild(r),t.appendChild(un({contactId:o,kind:e}))}return t},vt=!1,wn=()=>{document.querySelectorAll(`[id="${le}"]`).forEach(o=>o.remove())},Do=async()=>{if(b.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),vt){b.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}vt=!0;try{await xn()}finally{vt=!1}},xn=async()=>{let o=S();if(!o){b.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),wn();return}b.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${o.contactId} locationId=${o.locationId??"(null)"} source=${o.source}`);let e="seller";try{let c=await ko(o.contactId,o.locationId),h=Eo(c);h==="buyer"?e="buyer":h==="other"&&(e="other"),b.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${c??"(null)"})`)}catch(c){b.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",c)}let t=S();if(!t||t.contactId!==o.contactId){b.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${le}"]`));if(r.length===1&&r[0].dataset.contactId===o.contactId&&r[0].dataset.contactKind===e){b.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${o.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(b.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(c=>c.remove()));let n=await mn();if(!n){b.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}b.debug(`[actions-bar:06] mount target found \u2014 tagName=${n.tagName} class="${n.className}"`);let a=S();if(!a||a.contactId!==o.contactId){b.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=Io(o.contactId,e)}catch(c){b.error("[actions-bar:08-FAIL] buildBar threw:",c);return}i.dataset.mountTarget=n.className||"central-panel";try{n.insertBefore(i,n.firstChild)}catch(c){b.error("[actions-bar:09-FAIL] insertBefore threw:",c);return}if(!document.getElementById(le)){b.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}b.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${o.contactId} kind=${e}`);let d=null;d=new MutationObserver(()=>{if(!(S()?.contactId===o.contactId)){d?.disconnect();return}let h=document.querySelectorAll(`[id="${le}"]`);if(h.length>1){for(let m=1;m<h.length;m++)h[m].remove();b.debug(`[actions-bar:WATCHDOG] trimmed ${h.length-1} duplicate bar(s)`);return}if(h.length===0){let m=document.querySelector(".central-panel")||n,p=Io(o.contactId,e);p.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(p,m.firstChild),b.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${o.contactId}`)}catch(u){b.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",u)}}}),d.observe(n,{childList:!0})},Ao=null,kn=()=>{Ao===null&&(Ao=window.setInterval(()=>{let o=S();o&&(document.getElementById(le)||(b.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",o.contactId),Do()))},3e3))},Fo=()=>{kn(),Do()};var Pe="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",En=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),he="data-ws-crm-favicon",yt=o=>o.hasAttribute(he),$o=o=>{if(o.tagName!=="LINK")return!1;let e=(o.getAttribute("rel")??"").toLowerCase();return En.has(e)},Oe=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{$o(r)&&!yt(r)&&r.remove()});let e=document.head.querySelector(`link[${he}="1"]`);e?e.href!==Pe&&(e.href=Pe):(e=document.createElement("link"),e.setAttribute(he,"1"),e.rel="icon",e.type="image/png",e.href=Pe,document.head.appendChild(e),b.debug("Favicon installed"));let t=document.head.querySelector(`link[${he}="apple"]`);t||(t=document.createElement("link"),t.setAttribute(he,"apple"),t.rel="apple-touch-icon",t.href=Pe,document.head.appendChild(t))},Po=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)Oe();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),Oe())},50)}new MutationObserver(r=>{let n=!1;for(let a of r)a.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&$o(i)&&!yt(i)&&(n=!0)}),a.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&yt(i)&&(n=!0)});n&&Oe()}).observe(document.head,{childList:!0,subtree:!1});let e=0,t=window.setInterval(()=>{e+=1,Oe(),e>=5&&window.clearInterval(t)},1e3)};var Tn=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Sn=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,Cn=".hr-card.hr-modal.crm-opportunities-modal",M=()=>{let o=document.querySelector(Cn);if(!o)return null;let e=o.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let t of e){let r=t.textContent?.trim()??"";if(!r)continue;let n=r.match(Sn);if(n){let a=n[1];if(Tn.includes(a))return a}}return null},X=async(o=2500)=>{let e=Date.now();for(;Date.now()-e<o;){let t=M();if(t!==null)return t;await new Promise(r=>setTimeout(r,100))}return null};var In="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",H="ws-crm-mt-offer-made-button",Oo="ws-crm-mt-offer-made-modal",An=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ln=/\/v2\/location\/([A-Za-z0-9]+)/,Be=()=>{let o=window.location.pathname,e=o.match(An);if(!e)return null;let t=o.match(Ln);return{oppId:e[1],locationId:t?t[1]:null}},Mn=async o=>{let e=await fetch(In,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,kind:"buyer",amount:o.amount,triggered_by_user_id:o.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},He=()=>{document.getElementById(Oo)?.remove()},Dn=o=>{He();let e=document.createElement("div");e.id=Oo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-mt-offer-amount"),n=t.querySelector("#ws-mt-offer-error"),a=t.querySelector("#ws-mt-offer-cancel"),i=t.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&He()}),a?.addEventListener("click",()=>He()),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d||Number(d)<=0){n.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(d);if(c<100){n.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{let h=await Mn({oppId:o.oppId,locationId:o.locationId,amount:c,userId:A()});if(!h.ok){n.textContent=h.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1);return}He(),o.onSuccess()}catch(h){b.error("MT Offer Made webhook failed",h),n.textContent=h instanceof Error?h.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",a&&(a.disabled=!1)}})},Fn=o=>{let e=document.createElement("button");return e.id=H,e.type="button",e.dataset.oppId=o,e.style.cssText=L,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let t=Be();!t||!t.locationId||t.oppId!==o||Dn({oppId:t.oppId,locationId:t.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=s.emeraldGlow,e.style.color=s.emeraldBright,e.style.borderColor=s.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=L)},4e3)}})}),e},$n=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Pn=async()=>{for(let o of $n)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ne=!1,xt=async()=>{if(!Ne){Ne=!0;try{await On()}finally{Ne=!1}}},On=async()=>{let o=Be();if(!o||!o.locationId){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}let e=document.getElementById(H);if(e&&e.dataset.oppId===o.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove(),me());return}e&&(e.remove(),document.getElementById(`${H}-wrap`)?.remove());let t=await Pn();if(!t){b.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Be();if(!n||n.oppId!==o.oppId)return;let a=Fn(o.oppId),i=document.createElement("span");i.id=`${H}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted MT Offer Made button on opp ${o.oppId}`),Hn(o.oppId)},pe=null,wt=null,me=()=>{pe?.disconnect(),pe=null,wt=null},Hn=o=>{if(pe&&wt===o)return;me();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(wt=o,pe=new MutationObserver(()=>{let t=Be();if(!t||t.oppId!==o){me();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(H)?.remove(),document.getElementById(`${H}-wrap`)?.remove(),me();return}document.getElementById(H)||xt()}),pe.observe(e,{childList:!0,subtree:!0}))},gt=null,ft,Nn=()=>{gt||(gt=new MutationObserver(()=>{ft===void 0&&(ft=window.setTimeout(()=>{ft=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(H);o&&!e&&!Ne&&xt()},300))}),gt.observe(document.body,{childList:!0,subtree:!0}))},Ho=()=>{Nn(),xt()};var Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",N="ws-crm-not-interested-button",Rn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gn=/\/v2\/location\/([A-Za-z0-9]+)/,Ge=()=>{let o=window.location.pathname,e=o.match(Rn);if(!e)return null;let t=o.match(Gn);return{oppId:e[1],locationId:t?t[1]:null}},zn=async o=>{let e=await fetch(Bn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,mt_opp_id:o.oppId,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},Un=o=>{let e=document.createElement("button");return e.id=N,e.type="button",e.dataset.oppId=o,e.style.cssText=L,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=Ge();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await zn({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=s.crimsonGlow,e.style.color=s.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},qn=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Vn=async()=>{for(let o of qn)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Re=!1,St=async()=>{if(!Re){Re=!0;try{await Wn()}finally{Re=!1}}},Wn=async()=>{let o=Ge();if(!o||!o.locationId){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e();return}let e=document.getElementById(N);if(e&&e.dataset.oppId===o.oppId){let l=M();l!==null&&l!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e());return}e&&(e.remove(),document.getElementById(`${N}-wrap`)?.remove());let t=await Vn();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=Ge();if(!n||n.oppId!==o.oppId)return;let a=Un(o.oppId),i=document.createElement("span");i.id=`${N}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),jn(o.oppId)},ue=null,Tt=null,_e=()=>{ue?.disconnect(),ue=null,Tt=null},jn=o=>{if(ue&&Tt===o)return;_e();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Tt=o,ue=new MutationObserver(()=>{let t=Ge();if(!t||t.oppId!==o){_e();return}let r=M();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(N)?.remove(),document.getElementById(`${N}-wrap`)?.remove(),_e();return}document.getElementById(N)||St()}),ue.observe(e,{childList:!0,subtree:!0}))},kt=null,Et,Kn=()=>{kt||(kt=new MutationObserver(()=>{Et===void 0&&(Et=window.setTimeout(()=>{Et=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(N);o&&!e&&!Re&&St()},300))}),kt.observe(document.body,{childList:!0,subtree:!0}))},No=()=>{Kn(),St()};var Yn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",B="ws-crm-reduce-price-button",Bo="ws-crm-reduce-price-modal",Xn=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Jn=/\/v2\/location\/([A-Za-z0-9]+)/,qe=()=>{let o=window.location.pathname,e=o.match(Xn);if(!e)return null;let t=o.match(Jn);return{oppId:e[1],locationId:t?t[1]:null}},Qn=async o=>{let e=await fetch(Yn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ze=()=>{document.getElementById(Bo)?.remove()},Zn=o=>{ze();let e=document.createElement("div");e.id=Bo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),i=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let l=d=>{d.key==="Enter"?(d.preventDefault(),i?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",l),e.addEventListener("click",d=>{d.target===e&&ze()}),a?.addEventListener("click",()=>{ze()}),i?.addEventListener("click",async()=>{if(!r||!n||!i)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",a&&(a.disabled=!0);try{await Qn({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:A()}),ze(),o.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",a&&(a.disabled=!1)}})},ea=(o,e)=>{let t=document.createElement("button");return t.id=B,t.type="button",t.dataset.oppId=o,t.style.cssText=L,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=qe();!r||!r.locationId||r.oppId!==o||Zn({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=s.emeraldGlow,t.style.color=s.emeraldBright,t.style.borderColor=s.emeraldBorder,a&&(a.style.background=s.emerald,a.style.boxShadow=`0 0 6px ${s.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=L,a&&(a.style.background=s.amber,a.style.boxShadow=`0 0 6px ${s.amber}`))},4e3)}})}),t},ta=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],oa=async()=>{for(let o of ta)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},Ue=!1,Lt=async()=>{if(!Ue){Ue=!0;try{await ra()}finally{Ue=!1}}},ra=async()=>{let o=qe();if(!o||!o.locationId){document.getElementById(B)?.remove(),document.getElementById(`${B}-wrap`)?.remove(),ye();return}let e=document.getElementById(B);if(e&&e.dataset.oppId===o.oppId){let l=M();l!==null&&l!=="Disposition"&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove(),ye());return}e&&(e.remove(),document.getElementById(`${B}-wrap`)?.remove());let t=await oa();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await X();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=qe();if(!n||n.oppId!==o.oppId)return;let a=ea(o.oppId,o.locationId),i=document.createElement("span");i.id=`${B}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),na(o.oppId)},ve=null,At=null,ye=()=>{ve?.disconnect(),ve=null,At=null},na=o=>{if(ve&&At===o)return;ye();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(At=o,ve=new MutationObserver(()=>{let t=qe();if(!t||t.oppId!==o){ye();return}let r=M();if(r!==null&&r!=="Disposition"){document.getElementById(B)?.remove(),document.getElementById(`${B}-wrap`)?.remove(),ye();return}document.getElementById(B)||Lt()}),ve.observe(e,{childList:!0,subtree:!0}))},Ct=null,It,aa=()=>{Ct||(Ct=new MutationObserver(()=>{It===void 0&&(It=window.setTimeout(()=>{It=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(B);o&&!e&&!Ue&&Lt()},300))}),Ct.observe(document.body,{childList:!0,subtree:!0}))},Ro=()=>{aa(),Lt()};var Uo="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",J="ws-crm-send-to-closing-office-button",oe="ws-crm-send-to-title-co-wrap",je="ws-crm-stc-dropdown",sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ia=/\/v2\/location\/([A-Za-z0-9]+)/,Ke=()=>{let o=window.location.pathname,e=o.match(sa);if(!e)return null;let t=o.match(ia);return{oppId:e[1],locationId:t?t[1]:null}},la=5*60*1e3,qo=o=>`ws-crm-stc-cache:${o}`,da=o=>{try{let e=window.localStorage.getItem(qo(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>la||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},ca=(o,e)=>{try{window.localStorage.setItem(qo(o),JSON.stringify(e))}catch{}},ba=async(o,e)=>{try{let t=await fetch(Uo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},ha=async(o,e,t)=>{let r=await fetch(Uo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},pa=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},Go=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${s.emerald}, 0 0 18px ${s.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},ma=(o,e)=>{if(e&&pa(e)){window.setTimeout(()=>Go(o),300);return}Go(o)},R=()=>{document.getElementById(je)?.remove()},Ve=(o,e,t)=>{R();let r=document.createElement("div");r.id=je;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${_.sans};
  `;let a=o.length,i=o.filter(u=>u.filled).length,l=i===a,d=document.createElement("div");d.innerHTML=`
    <div style="
      font-family: ${_.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(u=>{h[u.group]||(h[u.group]=[]),h[u.group].push(u)});let m=[...c.filter(u=>h[u]),...Object.keys(h).filter(u=>!c.includes(u))];for(let u of m){let f=h[u],k=document.createElement("div");k.style.cssText="margin-top: 12px;";let y=document.createElement("div");y.style.cssText=`
      font-family: ${_.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${s.steel};
    `,y.textContent=u,k.appendChild(y),f.forEach(v=>{let g=document.createElement("div"),E=!v.filled&&v.navigable&&v.field_id;g.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
        border-radius: ${w.sm};
        font-size: 12px;
        color: ${v.filled?s.bone:s.ash};
        ${E?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,E&&(g.addEventListener("mouseenter",()=>{g.style.background=s.slate}),g.addEventListener("mouseleave",()=>{g.style.background="transparent"}),g.addEventListener("click",I=>{I.stopPropagation(),v.field_id&&(ma(v.field_id,v.folder),R())}));let T=v.filled?`<span style="color: ${s.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${s.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,x=E?`<span style="margin-left: auto; color: ${s.ash}; font-size: 11px;">\u2192</span>`:"";g.innerHTML=`${T}<span style="flex: 1;">${v.label}</span>${x}`,k.appendChild(g)}),r.appendChild(k)}document.body.appendChild(r);let p=u=>{let f=u.target;!r.contains(f)&&!t.contains(f)&&(R(),document.removeEventListener("click",p))};window.setTimeout(()=>document.addEventListener("click",p),0)},z=(o,e)=>{let t=o.querySelector(".ws-stc-label"),r=o.querySelector(".ws-stc-dot"),n=o.querySelector(".ws-stc-chevron"),a,i,l=s.bone,d,c="Send to Closing Office",h="",m="pointer",p="1";switch(e.status){case"checking":a="transparent",i=s.steel,l=s.ash,d=s.coolGray,c="Checking\u2026",m="wait",p="0.8";break;case"ready":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(k=>k.filled).length??0,f=e.checks?.length??0;a="transparent",i=s.amber,l=s.amber,d=s.amber,c=`${u} of ${f} fields ready`,h="\u25BE";break}case"sending":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",c="Sending\u2026",m="wait",p="0.8";break;case"sent":a=s.emerald,i=s.emerald,l="#0a0e14",d="#0a0e14",c="Sent \u2713";break;case"error":a="transparent",i=s.amber,l=s.amber,d=s.amber,c=e.message??"Try again";break}o.style.background=a,o.style.borderColor=i,o.style.color=l,o.style.cursor=m,o.style.opacity=p,r&&(r.style.background=d,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${d}`:""),t&&(t.textContent=c),n&&(n.textContent=h)},ua=(o,e)=>{let t=document.createElement("button");t.id=J,t.type="button",t.dataset.oppId=o;let r=da(o),n=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};t.style.cssText=`
    ${q}
    background: transparent;
    border: 1px solid ${s.steel};
    color: ${s.ash};
  ...
  `,z(t,n);let a=new Set,i=async()=>{if(n.status==="sending")return;let y=await ba(o,e);if(!y){n={status:"error",message:"Check failed \u2014 click to retry"},z(t,n);return}if(y.rate_limited){u=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},z(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){n={status:"error",message:y.error||"Check failed \u2014 click to retry"},z(t,n),b.warn("[stc] dry_run returned no checks:",y);return}let v=y.pipeline_name;if(v&&v!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${v}" (not TC) \u2014 retracting button + caching`),Ye.add(o),document.getElementById(J)?.remove(),document.getElementById(oe)?.remove(),R(),fe();return}let g=y.checks;if(n.checks&&n.checks.length===y.checks.length){let T=new Set;g=y.checks.map((x,I)=>n.checks[I]?.filled&&!x.filled?a.has(x.label)?x:(T.add(x.label),{...x,filled:!0}):x),a=T}else a=new Set;n={status:g.every(T=>T.filled)?"ready":"incomplete",checks:g,previouslySentAt:y.previously_sent_at??null},ca(o,{checks:g,previously_sent_at:y.previously_sent_at??null,pipeline_name:v,ts:Date.now()}),z(t,n),document.getElementById(je)&&Ve(g,y.previously_sent_at,t)},l=async()=>{let y=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},z(t,n),R();try{let v=await ha(o,e,y);if(v.needs_confirm){n={status:"ready",checks:v.checks,previouslySentAt:v.previously_sent_at},z(t,n),v.checks&&Ve(v.checks,v.previously_sent_at,t);return}if(v.ok){n={status:"sent",checks:v.checks,previouslySentAt:new Date().toISOString()},z(t,n),window.setTimeout(()=>{f()},3500);return}n={status:"error",checks:v.checks,message:v.error||"Validation failed"},z(t,n),v.checks&&Ve(v.checks,v.previously_sent_at,t)}catch(v){b.error("[stc] send failed:",v),n={status:"error",message:"Network error \u2014 click to retry"},z(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":l();break;case"incomplete":{document.getElementById(je)?R():n.checks&&Ve(n.checks,n.previouslySentAt,t);break}case"error":case"sent":f();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,u=0,f=async()=>{if(!c){if(Date.now()<u){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await i()}finally{c=!1}}};f();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(d!==void 0||c)return;let g=Date.now()-h,E=Math.max(1500,m-g);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&f()},E)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let v=window.setInterval(()=>{document.body.contains(t)||(y.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(v))},5e3)}return t},_a=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],va=async()=>{for(let o of _a)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Ye=new Set,zo=null,ya=o=>{o&&o!==zo&&(Ye.clear(),zo=o)},We=!1,$t=async()=>{if(We){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}We=!0;try{await ga()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{We=!1}},ga=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=Ke();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(J)?.remove(),document.getElementById(oe)?.remove(),R();return}if(b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`),ya(o.oppId),Ye.has(o.oppId)){b.debug(`[stc] mount:02-BAIL opp ${o.oppId} previously confirmed non-TC this session`),document.getElementById(J)?.remove(),document.getElementById(oe)?.remove(),R();return}let e=document.getElementById(J);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let l=M();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(oe)?.remove(),R(),fe());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(oe)?.remove(),R()),b.debug("[stc] mount:04 calling findMountTarget");let t=await va();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=M();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Ke();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=ua(o.oppId,n.locationId),i=document.createElement("span");i.id=oe,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),i.appendChild(a),t.appendChild(i),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),fa(o.oppId)},ge=null,Ft=null,fe=()=>{ge?.disconnect(),ge=null,Ft=null},fa=o=>{if(ge&&Ft===o)return;fe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ft=o,ge=new MutationObserver(()=>{let t=Ke();if(!t||t.oppId!==o){fe();return}let r=M();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(J)?.remove(),document.getElementById(oe)?.remove(),R(),fe();return}document.getElementById(J)||$t()}),ge.observe(e,{childList:!0,subtree:!0}))},Mt=null,Dt,wa=()=>{Mt||(Mt=new MutationObserver(()=>{Dt===void 0&&(Dt=window.setTimeout(()=>{Dt=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(J);if(o&&!e&&!We){let t=Ke();if(t&&Ye.has(t.oppId))return;$t()}},300))}),Mt.observe(document.body,{childList:!0,subtree:!0}))},Vo=()=>{wa(),$t()};var xa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",ka="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",Ea="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ko="ldtyB2UXKi9vOp8nLUH7",Ta="WVD2gb9swLsgcdBEtDVq",G="ws-crm-closing-agent-picker-button",Yo="ws-crm-closing-agent-picker-modal",Sa=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ca=/\/v2\/location\/([A-Za-z0-9]+)/,ke=()=>{let o=window.location.pathname,e=o.match(Sa);if(!e)return null;let t=o.match(Ca);return{oppId:e[1],locationId:t?t[1]:null}},zt=async o=>{let e=await fetch(xa,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,query:o.query??"",contact_id:o.contactId??null,contact_type:o.contactType??null,limit:o.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Wo=async o=>{let e=await fetch(ka,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,opp_id:o.oppId,field_id:o.fieldId,value:o.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Ia=async(o,e)=>{try{let t=await fetch(Ea,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:o,field_id:Ko}),credentials:"omit"});if(!t.ok)return null;let r=await t.json(),n=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!n||!/^[A-Za-z0-9]{16,}$/.test(n))return null;let a=await zt({tenantId:e,contactId:n,limit:1});if(!a.ok||!a.results.length)return null;let i=a.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(t){return b.warn("[closing-agent] fetchCurrent failed:",t),null}},re=null,Aa=60*60*1e3,Ut=o=>`ws-crm-to-cache:${o}`,Xo=o=>{try{let e=window.localStorage.getItem(Ut(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>Aa||typeof t.contactId!="string"||!t.contactId||typeof t.contactName!="string"||!t.contactName?null:t}catch{return null}},Jo=(o,e,t)=>{try{window.localStorage.setItem(Ut(o),JSON.stringify({contactId:e,contactName:t,ts:Date.now()}))}catch{}},La=o=>{try{window.localStorage.removeItem(Ut(o))}catch{}},Nt="ws-crm-closing-agent-field-link",Ma=()=>{let o=document.querySelector(".crm-opportunities-modal");o&&(o.querySelectorAll(`.${Nt}`).forEach(e=>e.remove()),o.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Pt=!1,qt=async o=>{if(Pt)return;let e=Qo();if(!e)return;let t=(e.value||"").trim();if(!t){b.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(t)){b.info(`[closing-agent] tryDecorate: value '${t}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==t){Pt=!0;try{b.info(`[closing-agent] tryDecorate: looking up ${t}`);let r=await zt({tenantId:o,contactId:t,limit:1});if(!r.ok||!r.results.length){b.warn(`[closing-agent] tryDecorate: contact ${t} not found`);return}let n=r.results[0];b.info(`[closing-agent] tryDecorate: applying ${n.name} (${n.id})`),Bt(n.id,n.name,o);let a=document.getElementById(G);if(a){Q(a,{status:"linked",contactName:n.name});let i=ke();i&&Jo(i.oppId,n.id,n.name)}}catch(r){b.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Pt=!1}}},Da=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Qo=()=>{let e=document.querySelectorAll("*"),t=[],r=[],n=[];for(let d of e){let c=(d.textContent||"").trim();Da.test(c)?t.push(d):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let h of["aria-label","placeholder","data-label","title","name","data-test"]){let m=d.getAttribute(h);m&&/Title\s+Officer/i.test(m)&&n.push({tag:d.tagName.toLowerCase(),attr:h,value:m})}}if(b.info(`[closing-agent] findInput: ${t.length} regex-matched, ${r.length} near-text matches, ${n.length} attribute matches`),r.length&&b.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),n.length&&b.warn("[closing-agent] attribute matches:",n.slice(0,8)),t.length===0)return null;t.sort((d,c)=>d.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=t[0].parentElement,l=0;for(;i&&l<8;){let d=i.querySelector("input");if(d)return b.info(`[closing-agent] findInput: located input ${l} levels up from label`),d;i=i.parentElement,l+=1}return b.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Bt=(o,e,t)=>{let r=Qo();if(!r)return;let n=r.dataset.wsClosingAgentDecorated;if(n!==o){n&&r.parentElement?.querySelectorAll(`.${Nt}`).forEach(i=>i.remove());{let a=r.parentElement;if(!a)return;r.dataset.wsClosingAgentDecorated=o,r.style.visibility="hidden",window.getComputedStyle(a).position==="static"&&(a.style.position="relative");let l=document.createElement("a");l.className=Nt,l.href=`/v2/location/${t}/contacts/detail/${o}`,l.textContent=e,l.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${w.sm};
      z-index: 2;
    `,l.addEventListener("mouseenter",()=>{l.style.textDecoration="underline"}),l.addEventListener("mouseleave",()=>{l.style.textDecoration="none"}),l.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),window.location.href=l.href}),a.appendChild(l)}}},Xe=()=>{document.getElementById(Yo)?.remove()},Fa=o=>{Xe();let e=document.createElement("div");e.id=Yo,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-top-search"),n=t.querySelector("#ws-top-results"),a=t.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Xe()}),a?.addEventListener("click",Xe);let i,l="",d=async c=>{if(n&&c!==l){if(l=c,!c.trim()){n.innerHTML=`
        <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}n.innerHTML=`
      <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let h=await zt({tenantId:o.locationId,query:c,contactType:"closing_agent",limit:20});if(!h.ok||!Array.isArray(h.results)||h.results.length===0){n.innerHTML=`
          <div style="padding: 16px; color: ${s.ash}; font-size: 13px; text-align: center;">
            No results.
        ...
        `,p.addEventListener("mouseenter",()=>{p.style.background=s.slate}),p.addEventListener("mouseleave",()=>{p.style.background="transparent"}),p.addEventListener("click",()=>{Xe(),o.onPick(m)}),n.appendChild(p)})}catch(h){b.error("Closing Agent picker search failed",h),n&&(n.innerHTML=`
          <div style="padding: 16px; color: ${s.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{d(c)},250)})},Je=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Q=(o,e)=>{let t=o.querySelector(".ws-top-label"),r=o.querySelector(".ws-top-dot"),n="Link Closing Agent",a=s.amber,i=s.bone,l="transparent",d=s.steel,c="pointer";switch(e.status){case"loading":n="Loading Closing Agent\u2026",a=s.coolGray,i=s.ash,c="wait";break;case"empty":n="Link Closing Agent",a=s.amber;break;case"linked":n=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",a=s.emerald,l=s.emeraldGlow,d=s.emeraldBorder,i=s.emeraldBright;break;case"saving":n="Linking\u2026",a=s.coolGray,i=s.ash,c="wait";break}t&&(t.textContent=n),r&&(r.style.background=a,r.style.boxShadow=`0 0 6px ${a}`),o.style.background=l,o.style.borderColor=d,o.style.color=i,o.style.cursor=c},$a=(o,e)=>{let t=document.createElement("button");t.id=G,t.type="button",t.dataset.oppId=o,t.style.cssText=L,t.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",t.innerHTML=`
  ...
  `;let r={status:"loading"};Q(t,r);let n=Xo(o);return n&&(r={status:"linked",contactName:n.contactName},Q(t,r),re={oppId:o,contactId:n.contactId,contactName:n.contactName,tenantId:e}),(async()=>{let i=await Ia(o,e);i?(r={status:"linked",contactName:i.name},Q(t,r),re={oppId:o,contactId:i.id,contactName:i.name,tenantId:e},Bt(i.id,i.name,e)):n||(r={status:"empty"},Q(t,r),re?.oppId===o&&(re=null),Ma(),La(o))})(),t.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(t.style.transform="translateY(-1px)")}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||Fa({oppId:o,locationId:e,onPick:async i=>{r={status:"saving"},Q(t,r);try{let l=[Wo({tenantId:e,oppId:o,fieldId:Ko,value:i.id})];i.companyName&&i.companyName.trim()&&l.push(Wo({tenantId:e,oppId:o,fieldId:Ta,value:i.companyName.trim()}));let c=(await Promise.all(l))[0];if(!c.ok)throw new Error(c.error??"Save failed");r={status:"linked",contactName:i.name},Q(t,r),re={oppId:o,contactId:i.id,contactName:i.name,tenantId:e},Jo(o,i.id,i.name),Bt(i.id,i.name,e),b.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(l){b.error("Closing Agent link failed",l),r={status:"empty"},Q(t,r)}}})}),t},Pa=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Oa=async()=>{for(let o of Pa)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},we=!1,Ze=async()=>{if(!we){we=!0;try{await Ha()}finally{we=!1}}},Ha=async()=>{let o=ke();if(!o||!o.locationId){document.getElementById(G)?.remove(),document.getElementById(`${G}-wrap`)?.remove(),Qe();return}let e=document.getElementById(G);if(e&&e.dataset.oppId===o.oppId){let d=M();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${G}-wrap`)?.remove(),Qe());return}e&&(e.remove(),document.getElementById(`${G}-wrap`)?.remove());let t=M();if(t!==null&&t!=="Transaction Coordination")return;let r=await Oa();if(!r||!(Xo(o.oppId)!==null||re!==null&&re.oppId===o.oppId)&&await X()!=="Transaction Coordination")return;let a=ke();if(!a||a.oppId!==o.oppId||!a.locationId)return;let i=$a(o.oppId,a.locationId),l=document.createElement("span");l.id=`${G}-wrap`,l.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,r.classList.contains("description")&&(r.style.display="flex",r.style.alignItems="center",r.style.gap="16px",r.style.flexWrap="wrap"),l.appendChild(i),r.appendChild(l),b.debug(`Mounted Closing Agent picker on opp ${o.oppId}`),Na(o.oppId),qt(a.locationId)},xe=null,Rt=null,Gt=null,Qe=()=>{xe?.disconnect(),xe=null,Rt=null,Gt=null},Na=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(xe&&Rt===o&&Gt===e||(Qe(),Rt=o,Gt=e,xe=new MutationObserver(()=>{let t=ke();if(!t||t.oppId!==o||!t.locationId){Qe();return}document.getElementById(G)||Ze(),qt(t.locationId)}),xe.observe(e,{childList:!0,subtree:!0})))},Ot=null,Ht,Ba=()=>{Ot||(Ot=new MutationObserver(()=>{Ht===void 0&&(Ht=window.setTimeout(()=>{Ht=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(G);o&&!e&&!we&&Ze()},300))}),Ot.observe(document.body,{childList:!0,subtree:!0}))},jo,Ra=()=>{jo===void 0&&(jo=window.setInterval(()=>{let o=ke();if(!o||!o.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(G)&&!we&&(b.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Ze()),qt(o.locationId)},2e3))},Zo=()=>{b.info("[closing-agent] mountClosingAgentPickerButton invoked"),Ba(),Ra(),Ze()};var Ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",Vt="ws-crm-prepare-contract-button",er="ws-crm-prepare-contract-menu",Z="ws-crm-prepare-contract-modal",V="https://services.leadconnectorhq.com",Wt="__WS_CRM_CAPTURED_AUTH",za=50*60*1e3,rr=()=>{try{let o=localStorage.getItem(Wt);if(!o)return null;let e=JSON.parse(o);return e?.authorization?Date.now()-(e.capturedAt||0)>za?(localStorage.removeItem(Wt),null):e:null}catch{return null}},Ua=o=>{try{localStorage.setItem(Wt,JSON.stringify(o))}catch{}},W=()=>{let o=rr(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,o?`present (captured ${Date.now()-o.capturedAt}ms ago, ${o.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!o)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let t={Authorization:o.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return o.tokenId&&(t["token-id"]=o.tokenId),t},tr=!1,qa=()=>{if(tr)return;tr=!0;let o=window;o.__WS_CRM_DIAG=o.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=(l,d,c)=>{o.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:d,source:c};let h=d.authorization||d.Authorization;if(!h){o.__WS_CRM_DIAG.fetchCalls+o.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${c} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(d)});return}c==="fetch"?o.__WS_CRM_DIAG.fetchAuthSeen++:o.__WS_CRM_DIAG.xhrAuthSeen++;let m=d["token-id"]||d["Token-Id"]||void 0,p=rr()?.authorization;Ua({authorization:h,tokenId:m,capturedAt:Date.now()}),p!==h&&(o.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${c}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},t=window.fetch;window.fetch=async function(...l){let d=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,c=l[1]||{};if(d&&d.includes("services.leadconnectorhq.com")){o.__WS_CRM_DIAG.fetchCalls++;let h=c.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let m={};if(h instanceof Headers)h.forEach((p,u)=>m[u.toLowerCase()]=p);else if(Array.isArray(h))h.forEach(([p,u])=>m[p.toLowerCase()]=u);else if(h&&typeof h=="object")for(let p of Object.keys(h))m[p.toLowerCase()]=h[p];e(d,m,"fetch")}return t.apply(this,l)};let r=XMLHttpRequest.prototype,n=r.open,a=r.setRequestHeader,i=r.send;r.open=function(l,d,...c){return this.__wsCrmUrl=d,this.__wsCrmHeaders={},n.call(this,l,d,...c)},r.setRequestHeader=function(l,d){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=d),a.call(this,l,d)},r.send=function(l){let d=this.__wsCrmUrl,c=this.__wsCrmHeaders;return d&&d.includes("services.leadconnectorhq.com")&&c&&(o.__WS_CRM_DIAG.xhrCalls++,e(d,c,"xhr")),i.call(this,l)},b.debug("[prepare-contract] interceptors installed (fetch + XHR)")},nr=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},Va=o=>{let e=(o||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},Wa=async o=>{let e=`${V}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(o)}&skip=0&limit=10`,t=await fetch(e,{method:"GET",headers:W()});if(!t.ok){let a="";try{a=await t.text()}catch{}let i=a?` \u2014 ${a.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${t.status} ${t.statusText}${i}`)}let r=await t.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let n=[];return Array.isArray(r)?n=r:Array.isArray(r?.templates)?n=r.templates:Array.isArray(r?.items)?n=r.items:Array.isArray(r?.data)?n=r.data:Array.isArray(r?.results)?n=r.results:Array.isArray(r?.docs)?n=r.docs:r?.data&&Array.isArray(r.data.templates)?n=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(n=r.data.items),n.map(a=>({id:(a._id??a.id??a.templateId)||"",name:a.name||a.title||"(unnamed template)",type:Va(a.name||a.title||"")})).filter(a=>!!a.id)},ja=async(o,e)=>{let t=await fetch(`${V}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:W()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(l=>/acquisition/i.test(l.name));if(!n)throw new Error("No Acquisition pipeline found on tenant");let a=await fetch(`${V}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:W()});if(!a.ok)throw new Error(`ACQ opp search ${a.status}`);return((await a.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,d)=>{let c=l.updatedAt?Date.parse(l.updatedAt):0;return(d.updatedAt?Date.parse(d.updatedAt):0)-c})},Ka=async(o,e)=>{let t=await fetch(`${V}/opportunities/pipelines?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:W()});if(!t.ok)throw new Error(`Pipelines fetch ${t.status}`);let n=((await t.json()).pipelines||[]).find(d=>/marketing\s*tracker/i.test(d.name));if(!n)throw new Error("No Marketing Tracker pipeline found on tenant");let a=await fetch(`${V}/opportunities/search?location_id=${encodeURIComponent(o)}&pipeline_id=${encodeURIComponent(n.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:W()});if(!a.ok)throw new Error(`MT opp search ${a.status}`);return((await a.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,c)=>{let h=d.updatedAt?Date.parse(d.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-h})},Ya=async o=>{let e=await fetch(Ga,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,template_id:o.templateId,template_type:o.templateType,opp_id:o.oppId,closing_date:o.closingDate,buyer_earnest_due_date:o.buyerEarnestDueDate,lender_source:o.lenderSource,triggered_by_user_id:o.userId,overrides:o.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Xa=async(o,e,t)=>{let r=`${V}/proposals/templates/to-proposal/${o}/${e}?locale=en-US&contactId=${encodeURIComponent(t)}`,n=await fetch(r,{method:"POST",headers:W()});if(!n.ok)throw new Error(`to-proposal HTTP ${n.status} ${n.statusText}`);let a=await n.json(),i=a._id||a.id||a.proposal?._id||a.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Ja=async(o,e)=>{let t=await fetch(`${V}/proposals/document/${e}?locationId=${encodeURIComponent(o)}`,{method:"GET",headers:W()});if(!t.ok){let a=await t.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${t.status} ${a.slice(0,200)}`)}let r=await t.json(),n=r?.document||r?.proposal||r;if(!n||typeof n!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return n},Qa=async o=>{let e=await fetch(`${V}/contacts/${o}`,{method:"GET",headers:W()});if(!e.ok){let n=await e.text().catch(()=>"");throw new Error(`GET contact ${o} HTTP ${e.status} ${n.slice(0,200)}`)}let t=await e.json(),r=t?.contact||t;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Za=async(o,e,t,r)=>{let n;try{n=await Ja(o,e)}catch(u){return{ok:!1,body:`fetchProposalDocument: ${u.message}`}}let a;try{a=await Qa(t)}catch(u){return{ok:!1,body:`fetchContactBasics: ${u.message}`}}let i=`${a.firstName} ${a.lastName}`.trim()||a.email||t,l={id:t,firstName:a.firstName,lastName:a.lastName,email:a.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},h=[...(Array.isArray(n.recipients)?n.recipients:[]).filter(u=>u?.entityName!=="contacts"),l],m={name:r||n.name,locationId:n.locationId||o,pages:n.pages||[],variables:n.variables||[],fillableFields:n.fillableFields||[],timezone:n.timezone||{},recipients:h,grandTotal:n.grandTotal},p=await fetch(`${V}/proposals/document/${e}`,{method:"PUT",headers:{...W(),"Content-Type":"application/json"},body:JSON.stringify(m)});if(!p.ok){let u=await p.text().catch(()=>"");return{ok:!1,status:p.status,body:u}}return{ok:!0}},es=(o,e)=>{let t=`/v2/location/${o}/payments/proposals-estimates/edit/${e}`;window.location.href=t},et="__WS_CRM_PENDING_INSTRUCTIONS",ts=60*1e3,os=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],rs=o=>{let e=(o||"").toLowerCase();for(let t of os)if(e.includes(t.matches.toLowerCase()))return t;return null},ns=(o,e,t)=>{try{let r={proposalId:o,title:e,bodyHtml:t,ts:Date.now()};localStorage.setItem(et,JSON.stringify(r))}catch{}},as=()=>{try{let o=localStorage.getItem(et);if(!o)return null;let e=JSON.parse(o);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>ts?(localStorage.removeItem(et),null):e}catch{return null}},ss=()=>{try{localStorage.removeItem(et)}catch{}},is=(o,e)=>{document.getElementById(Z)?.remove();let t=document.createElement("div");t.id=Z,t.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `,t.appendChild(r),document.body.appendChild(t),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>t.remove())},ls=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,ds=()=>{let o=window.location.pathname.match(ls);if(!o)return;let e=o[1],t=as();t&&t.proposalId===e&&(ss(),window.setTimeout(()=>{is(t.title,t.bodyHtml)},600))},or="ws-crm-prepare-contract-toast",U=(o,e="info",t=4e3)=>{document.getElementById(or)?.remove();let r=document.createElement("div");r.id=or;let n=e==="error"?s.crimson:s.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=o,document.body.appendChild(r),window.setTimeout(()=>r.remove(),t)},cs=o=>new Promise(e=>{document.getElementById(Z)?.remove();let t=document.createElement("div");t.id=Z,t.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
    ...
    `;let r=document.createElement("div");r.style.cssText=`
      ...
      color: ${s.bone};
      box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
    `;let n=l=>{if(!l)return"";try{return new Date(l).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}catch{return l}},a=o.map(l=>`
        <button type="button" class="ws-pc-acq-opp" data-opp-id="${ne(l.id)}" style="
          ...
          font-family: ${_.sans};
        ">
          <div style="font-size: 14px; font-weight: 500; line-height: 1.3;">${$(l.propertyAddress||l.name)}</div>
          ${l.updatedAt?`<div style="font-size: 11px; color: ${s.ash}; margin-top: 4px;">Last updated ${$(n(l.updatedAt))}</div>`:""}
        </button>
      `).join("");r.innerHTML=`
      <div style="
        font-family: ${_.mono};
      ...
      <div style="
        ...
        font-weight: 500;
        margin-bottom: 4px;
      ">This seller has ${o.length} open deals</div>
      <div style="
        font-size: 12px;
        color: ${s.ash};
        margin-bottom: 16px;
    ...
    `,t.appendChild(r),document.body.appendChild(t);let i=l=>{t.remove(),e(l)};t.addEventListener("click",l=>{l.target===t&&i(null)}),r.querySelector("#ws-pc-cancel")?.addEventListener("click",()=>i(null)),r.querySelectorAll(".ws-pc-acq-opp").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.borderColor=s.emerald,l.style.background=s.graphite}),l.addEventListener("mouseleave",()=>{l.style.borderColor=s.steel,l.style.background=s.slate}),l.addEventListener("click",d=>{d.stopPropagation(),d.preventDefault();let c=l.dataset.oppId||"";c&&i(c)})})}),bs=({tenantId:o,contactId:e,template:t,staged:r})=>{document.getElementById(Z)?.remove();let n=r.debug||{},a=typeof n.propertyAddress=="string"?n.propertyAddress:"",i=typeof n.sellerName=="string"?n.sellerName:"",l=typeof n.purchasePrice=="number"?n.purchasePrice:0,d=typeof n.emd=="number"?n.emd:0,c=typeof n.cashAtClose=="number"?n.cashAtClose:l-d,h=n.daysToClose===void 0||n.daysToClose===null||n.daysToClose===""?"":String(n.daysToClose),m=n.inspectionDays===void 0||n.inspectionDays===null||n.inspectionDays===""?"":String(n.inspectionDays),p=typeof n.additionalTerms=="string"?n.additionalTerms:"",u=typeof n.currentOccupancy=="string"?n.currentOccupancy:"",f=typeof n.occupancyAtClose=="string"?n.occupancyAtClose:"",k=Array.isArray(n.occupancyOptions)&&n.occupancyOptions.length>0?n.occupancyOptions:["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],y=document.createElement("div");y.id=Z,y.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,F=`
    ...
    padding-right: 28px;
  `,ae=O=>['<option value="">(unset)</option>'].concat(k.map(K=>`<option value="${ne(K)}"${K===O?" selected":""}>${$(K)}</option>`)).join("");v.innerHTML=`
    <div style="
      font-family: ${_.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      <div style="${x}">
        ...
        <div style="${T}">${$(a||"(set on Property record)")}</div>
      </div>
      <div style="${x}">
        <div style="${g}">Seller Name</div>
        <input id="ws-pc-seller-name" type="text" value="${ne(i)}" placeholder="Seller name" style="${E}" />
      </div>
      <div style="${x}">
      ...
      <div style="${x}">
        ...
        <input id="ws-pc-days-to-close" type="number" min="0" step="1" value="${ne(h)}" placeholder="e.g. 30" style="${E}" />
      </div>
      <div style="${x}">
      ...
      <div style="${x}">
        ...
        <select id="ws-pc-current-occupancy" style="${F}">${ae(u)}</select>
      </div>
      <div style="${x}">
        <div style="${g}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${F}">${ae(f)}</select>
      </div>
      <div style="${x} align-items: flex-start;">
        <div style="${g}">Additional Terms</div>
        <textarea id="ws-pc-additional-terms" rows="3" placeholder="Any extra clauses, contingencies, or notes for the contract" style="${E} text-align: left; resize: vertical; min-height: 60px; font-family: ${_.sans};">${$(p)}</textarea>
      </div>
    </div>
    <div style="
      font-size: 11px;
  ...
  `,y.appendChild(v),document.body.appendChild(y);let dt=v.querySelector("#ws-pc-purchase-price"),ct=v.querySelector("#ws-pc-emd"),Ce=v.querySelector("#ws-pc-cash-at-close"),Qt=!1;Ce?.addEventListener("input",()=>{Qt=!0});let Zt=()=>{if(Qt)return;let O=Number(dt?.value||0),K=Number(ct?.value||0);Ce&&(Ce.value=String(Math.max(0,O-K)))};dt?.addEventListener("input",Zt),ct?.addEventListener("input",Zt);let eo=()=>y.remove();y.addEventListener("click",O=>{O.target===y&&eo()}),v.querySelector("#ws-pc-cancel")?.addEventListener("click",eo);let j=v.querySelector("#ws-pc-submit"),Ie=v.querySelector("#ws-pc-error");j?.addEventListener("click",async()=>{if(j){Ie&&(Ie.textContent=""),j.disabled=!0,j.textContent="Opening\u2026";try{let O=(v.querySelector("#ws-pc-seller-name")?.value||"").trim(),K=Number(dt?.value||0),to=Number(ct?.value||0),oo=Number(Ce?.value||0),ro=(v.querySelector("#ws-pc-days-to-close")?.value??"").trim(),no=(v.querySelector("#ws-pc-inspection-days")?.value??"").trim(),ao=(v.querySelector("#ws-pc-additional-terms")?.value??"").trim(),so=(v.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),io=(v.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),P={};if(O!==i&&(P.sellerName=O),K!==l&&(P.purchasePrice=K),to!==d&&(P.emd=to),oo!==c&&(P.cashAtClose=oo),ro!==h&&(P.daysToClose=ro),no!==m&&(P.inspectionDays=no),ao!==p&&(P.additionalTerms=ao),so!==u&&(P.currentOccupancy=so),io!==f&&(P.occupancyAtClose=io),Object.keys(P).length>0){b.info("[prepare-contract] PA modal submit with overrides:",P),j.textContent="Saving\u2026";let Ir=A(),Ar=await jt({tenantId:o,contactId:e,template:t,userId:Ir,overrides:P});b.info("[prepare-contract] re-stage with overrides ok:",Ar),j.textContent="Opening\u2026"}else b.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let Cr=a?`${a} - Purchase Agreement`:void 0;await Kt(o,e,t,Cr)}catch(O){j.disabled=!1,j.textContent="Open Contract",Ie&&(Ie.textContent=O.message||"Failed to open contract."),b.warn("[prepare-contract] PA confirm submit failed:",O)}}})},hs=({tenantId:o,contactId:e,template:t,mtOpps:r,userId:n})=>{document.getElementById(Z)?.remove();let a=document.createElement("div");a.id=Z,a.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `;let i=document.createElement("div");i.style.cssText=`
    ...
    color: ${s.bone};
    box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
  `;let l=y=>y.toISOString().slice(0,10),d=new Date,c=l(new Date(d.getTime()+45*24*60*60*1e3)),h=l(new Date(d.getTime()+7*24*60*60*1e3)),m=(()=>{if(r.length===0)return`
        <div style="
        ...
        <div style="
          ...
          font-size: 13px;
          color: ${s.bone};
        ">${$(r[0].propertyAddress||r[0].name)}</div>
        <input type="hidden" id="ws-pc-opp-id" value="${ne(r[0].id)}" />
      `;let y=r.map(v=>`<option value="${ne(v.id)}">${$(v.propertyAddress||v.name)}</option>`).join("");return`
      <label style="
        display: block;
        font-family: ${_.mono};
        font-size: 10px;
  ...
  `,a.appendChild(i),document.body.appendChild(a);let u=()=>a.remove();if(a.addEventListener("click",y=>{y.target===a&&u()}),i.querySelector("#ws-pc-cancel")?.addEventListener("click",u),p)return;let f=i.querySelector("#ws-pc-submit"),k=i.querySelector("#ws-pc-error");f?.addEventListener("click",async()=>{if(!f)return;let y=i.querySelector("#ws-pc-opp-id"),v=(i.querySelector("#ws-pc-closing-date")?.value??"").trim(),g=(i.querySelector("#ws-pc-emd-due-date")?.value??"").trim(),E=(i.querySelector("#ws-pc-lender-source")?.value??"").trim(),T=(y?.value||"").trim();if(!T){k&&(k.textContent="Pick a subject property.");return}if(!v){k&&(k.textContent="Closing Date is required.");return}k&&(k.textContent=""),f.disabled=!0,f.textContent="Preparing\u2026";try{let I=(await jt({tenantId:o,contactId:e,template:t,oppId:T,closingDate:v,buyerEarnestDueDate:g,lenderSource:E,userId:n}))?.debug?.propertyAddress,F=typeof I=="string"&&I?`${I} - Assignment Agreement`:void 0;await Kt(o,e,t,F),u()}catch(x){f.disabled=!1,f.textContent="Stage & Open Contract",k&&(k.textContent=x.message||"Failed to prepare contract."),b.warn("[prepare-contract] AA submit failed:",x)}})},jt=async o=>{b.info(`[prepare-contract] staging \u2014 template "${o.template.name}" (${o.template.type})`);let e=await Ya({tenantId:o.tenantId,contactId:o.contactId,templateId:o.template.id,templateType:o.template.type,oppId:o.oppId,closingDate:o.closingDate,buyerEarnestDueDate:o.buyerEarnestDueDate,lenderSource:o.lenderSource,userId:o.userId,overrides:o.overrides});if(b.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},Kt=async(o,e,t,r)=>{b.info(`[prepare-contract] creating proposal from template ${t.id} for contact ${e}`);let n=await Xa(o,t.id,e);b.info(`[prepare-contract] proposal created: ${n}`),b.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let a=await Za(o,n,e,r);a.ok?b.info(`[prepare-contract] contact attached to proposal ${n}`):(b.warn(`[prepare-contract] attach failed (status=${a.status??"n/a"}): ${a.body?.slice(0,300)??"no body"}`),U(`Proposal created but couldn't auto-attach contact (HTTP ${a.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",a.body));let i=rs(t.name);i&&(b.info(`[prepare-contract] stashing post-redirect instructions for "${t.name}"`),ns(n,i.title,i.bodyHtml)),es(o,n)},ps=async o=>{let e=nr();if(!e){U("Could not resolve contact context.","error");return}document.getElementById(er)?.remove();let t=document.createElement("div");t.id=er,t.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,t.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,o.appendChild(t);let r=a=>{!t.contains(a.target)&&a.target!==o&&(t.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let n;try{n=await Wa(e.tenantId)}catch(a){t.innerHTML=`
      <div style="padding: 12px 14px; color: ${s.crimson}; font-size: 12px;">
        Failed to load templates: ${$(a.message)}
      </div>`;return}if(n.length===0){t.innerHTML=`
      <div style="padding: 12px 14px; color: ${s.ash}; font-size: 12px;">
        No proposal templates found on this tenant.
      </div>`;return}n.sort((a,i)=>{let l={PA:0,AA:1,passthrough:2};return l[a.type]!==l[i.type]?l[a.type]-l[i.type]:a.name.localeCompare(i.name)}),t.innerHTML="";for(let a of n){let i=document.createElement("button");i.type="button",i.style.cssText=`
      display: block;
      width: 100%;
      background: transparent;
      border: none;
    ...
    `;let l=a.type==="PA"?s.emerald:a.type==="AA"?s.blue:s.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=s.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async d=>{d.stopPropagation(),d.preventDefault(),b.info(`[prepare-contract] template picked: ${a.name} (type=${a.type})`),t.remove(),document.removeEventListener("click",r,!0);let c=A();try{if(a.type==="AA"){let h;try{h=await Ka(e.tenantId,e.contactId)}catch(m){U(`Failed to load buyer's MT opps: ${m.message}`,"error");return}hs({tenantId:e.tenantId,contactId:e.contactId,template:a,mtOpps:h,userId:c})}else if(a.type==="PA"){let h;try{h=await ja(e.tenantId,e.contactId)}catch(u){U(`Failed to load ACQ opps: ${u.message}`,"error",6e3),b.warn("[prepare-contract] PA fetch opps failed:",u);return}if(h.length===0){U("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let m;if(h.length===1)m=h[0].id,b.info(`[prepare-contract] auto-selected ACQ opp ${m} (only one)`);else{b.info(`[prepare-contract] showing ACQ opp picker (${h.length} opps)`);let u=await cs(h);if(!u){b.info("[prepare-contract] ACQ opp picker cancelled");return}m=u,b.info(`[prepare-contract] picked ACQ opp ${m}`)}U("Reading contract data\u2026","info",2500);let p;try{p=await jt({tenantId:e.tenantId,contactId:e.contactId,template:a,oppId:m,userId:c})}catch(u){U(`Failed to prepare contract: ${u.message}`,"error",6e3),b.warn("[prepare-contract] PA stage failed:",u);return}bs({tenantId:e.tenantId,contactId:e.contactId,template:a,staged:p})}else{U(`Opening ${a.name}\u2026`,"info",2500);try{await Kt(e.tenantId,e.contactId,a)}catch(h){U(`Failed to open contract: ${h.message}`,"error",6e3),b.warn("[prepare-contract] passthrough failed:",h)}}}catch(h){b.warn("[prepare-contract] picker click handler failed:",h),U(`Unexpected error: ${h.message}`,"error",6e3)}}),t.appendChild(i)}},ms=()=>{let o=document.createElement("button");return o.id=Vt,o.type="button",o.style.cssText=`
    position: relative;
    background: ${s.slate};
    border: 1px solid ${s.steel};
    border-radius: ${w.sm};
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.borderColor=s.emerald}),o.addEventListener("mouseleave",()=>{o.style.borderColor=s.steel}),o.addEventListener("click",e=>{e.stopPropagation(),ps(o)}),o},us="ws-crm-contact-actions-bar",_s=async()=>{let o=nr();if(!o){document.getElementById(Vt)?.remove();return}let e=null;try{e=await C(`#${us}`,{timeoutMs:3e3})}catch{b.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let t=document.getElementById(Vt);if(t){if(t.dataset.contactId===o.contactId)return;t.remove()}let r=ms();r.dataset.contactId=o.contactId,e.appendChild(r),b.debug(`[prepare-contract] mounted for contact ${o.contactId}`)},ar=()=>{ds(),_s()};qa();function $(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ne(o){return $(o)}var st="reos-theme-stylesheet",kr="reos-theme-fonts",vs=()=>{let o=document.getElementById(kr);o&&o.remove()},ys=`
/* ============================================
...
`,gs=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}}],fs=o=>{if(!o||o[0]!=="#")return o;let e=o.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return o;let t=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);if(isNaN(t)||isNaN(r)||isNaN(n))return o;if(e.length===8){let a=parseInt(e.slice(6,8),16)/255;return`rgba(${t}, ${r}, ${n}, ${a})`}return`rgb(${t}, ${r}, ${n})`},ws=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),xs=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],Yt=new WeakSet,sr=()=>{try{if(!document.body)return;document.body.querySelectorAll("*").forEach(e=>{try{if(Yt.has(e)&&e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest(".hl_header, header.hl_header, header.app-header"))return;let t=e.tagName;if(t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||t==="SCRIPT"||t==="STYLE"||t==="SVG"||t==="PATH"||t==="IMG")return;let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!a)return;let i=+a[1],l=+a[2],d=+a[3];if((a[4]!==void 0?+a[4]:1)<.5||i<230||l<230||d<230)return;if(e.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"){Yt.add(e);return}e.style.setProperty("background-color","rgb(18, 22, 29)","important"),e.style.setProperty("color","rgb(237, 238, 240)","important"),Yt.add(e)}catch{}})}catch{}},ir=new WeakSet,Ee=()=>{document.querySelectorAll(xs.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.querySelectorAll("*");[e,...Array.from(t)].forEach(r=>{if(ir.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH")return;let a=window.getComputedStyle(r).backgroundColor;if(!a||a==="rgba(0, 0, 0, 0)"||a==="transparent")return;let i=a.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=+i[1],d=+i[2],c=+i[3];l<230||d<230||c<230||(r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),ir.add(r))})})},lr=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color: rgb(26, 31, 40)")||t.includes("background-color: #1A1F28")||t.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},tt=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let t=e.parentElement,r=0;for(;t&&r<6&&t!==document.body;){if(r+=1,t.id?.startsWith("ws-crm-")||t.classList.contains("hl_header")||t.classList.contains("app-header")||t.tagName==="MAIN"||t.tagName==="BODY")return;let i=window.getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let l=+i[1],d=+i[2],c=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&l>=180&&d>=180&&c>=180&&l+d+c>=600&&t.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(t.style.setProperty("background-color","rgb(18, 22, 29)","important"),t.style.setProperty("color","rgb(237, 238, 240)","important"))}t=t.parentElement}})},dr=()=>{let o="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']"))return;(t.getAttribute("style")||"").includes(o)&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"))})},Te=()=>{for(let o of gs){let e;try{e=document.querySelectorAll(o.selector)}catch{continue}e.forEach(t=>{for(let[r,n]of Object.entries(o.styles)){let a=t.style.getPropertyPriority(r),i=t.style.getPropertyValue(r),l=ws.has(r)?fs(n):n;a==="important"&&i===l||t.style.setProperty(r,n,"important")}})}},it="#1A1F28",ks=26,Es=31,Ts=40,cr=new Set,br=new Set,ot=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.children.length>0||(e.textContent||"").trim()!=="--")return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width>800)return;e.style.setProperty("display","none","important");let n=e.className?.toString()||"<no class>";!br.has(n)&&n!=="<no class>"&&(br.add(n),b.debug(`Hid empty "--" leaf: "${n}"`))})},Ss=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],Cs=["trash","Trash","TRASH","delete","Delete","DELETE"],Is=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let t=e.querySelector("svg");if(!t)return;let r=!1,n=(t.getAttribute("class")||"")+" "+(t.getAttribute("data-icon")||"");if(Cs.some(a=>n.includes(a))&&(r=!0),r||t.querySelectorAll("path").forEach(i=>{if(r)return;let l=i.getAttribute("d")||"";Ss.some(d=>l.includes(d))&&(r=!0)}),!r){let a=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),l=(e.getAttribute("title")||"").toLowerCase();(a.includes("delete")||a.includes("remove")||a.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||l.includes("delete")||l.includes("remove")||l.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},As=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),Ls=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.textContent||"").trim();t.length===0||t.length>40||As.has(t)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},hr=new Set,pr=new WeakSet,Ms=()=>{document.body.querySelectorAll("*").forEach(e=>{if(pr.has(e)&&e.style.getPropertyValue("color")==="rgb(237, 238, 240)"||e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("ai-button")||t.includes("ask-ai")||t.includes("bg-clip-text")||t.includes("text-transparent")||e.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let r=e.tagName.toLowerCase();if(r==="svg"||r==="path"||r==="circle"||r==="rect"||r==="polygon"||r==="polyline"||r==="line"||r==="g")return;let n=!1;for(let m of Array.from(e.childNodes))if(m.nodeType===Node.TEXT_NODE&&(m.textContent||"").trim()){n=!0;break}if(!n)return;let a=Array.from(e.children);if(a.length>0&&a.every(m=>{let p=m.tagName.toLowerCase();return p==="svg"||p==="img"})&&!n)return;let d=window.getComputedStyle(e).color;if(!(d==="rgb(255, 255, 255)"||d==="rgba(255, 255, 255, 1)"||d==="#ffffff"||d==="white"))return;e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),pr.add(e);let h=e.className?.toString()||"<no class>";!hr.has(h)&&h!=="<no class>"&&(hr.add(h),b.debug(`Remapped pure-white text -> bone: "${h}"`))})},mr=new Set,Ds=()=>{let o=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let n=r.getAttribute("style")||"";(n.includes(e)||n.includes("#12161D")||n.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),o.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(a=>{if(a.closest("[id^='ws-crm-']"))return;let i=(a.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let l=window.getComputedStyle(a),d=l.backgroundColor,c=l.backgroundImage||"",h=!1;if(c!=="none"&&c.includes("gradient"))h=!0;else if(d&&d!=="rgba(0, 0, 0, 0)"&&d!=="transparent"){let T=d.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(T&&parseFloat(T[1])<.6)return;let x=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(x){let I=parseInt(x[1],10),F=parseInt(x[2],10),ae=parseInt(x[3],10);(I>=60||F>=60||ae>=60)&&(I>230&&F>230&&ae>230||(I>=80||F>=80||ae>=80)&&(h=!0))}}if(!h)return;let p=(a.textContent||"").trim(),u=i,f=Array.from(a.querySelectorAll("*")).map(T=>(T.className?.toString()||"").toLowerCase()).join(" "),k=p.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),y=u.includes("bg-clip-text")||u.includes("text-transparent")||f.includes("bg-clip-text")||f.includes("text-transparent"),v=Array.from(a.querySelectorAll("*")).some(T=>{let x=window.getComputedStyle(T),I=x.getPropertyValue("-webkit-background-clip")||"",F=x.getPropertyValue("background-clip")||"";return I.includes("text")||F.includes("text")});if(k||y||v){let T=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],x=I=>{T.forEach(F=>I.style.removeProperty(F))};x(a),a.querySelectorAll("*").forEach(x);return}let g="#12161D";a.style.setProperty("color",g,"important"),a.querySelectorAll("*").forEach(T=>{let x=T.tagName.toLowerCase();x==="svg"||x==="path"||x==="circle"||x==="rect"||x==="polygon"||x==="polyline"||x==="line"||x==="g"?(T.style.setProperty("fill",g,"important"),T.style.setProperty("stroke",g,"important"),T.style.setProperty("color",g,"important")):(T.style.setProperty("color",g,"important"),T.style.setProperty("-webkit-text-fill-color",g,"important"))});let E=a.className?.toString()||"<no class>";!mr.has(E)&&E!=="<no class>"&&(mr.add(E),b.debug(`Darkened SVG icons on colored button: "${E}"`))})})},ur=new Set,Fs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(d=>{(d.getAttribute("style")||"").includes("translateY(11px)")&&d.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let n=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(d=>{let c=d;if(c.closest("[id^='ws-crm-']"))return;let h=d.getBoundingClientRect();if(h.width===0||h.width>28||h.height>28)return;let m=h.left<r.right&&h.right>r.left,p=h.top<r.bottom&&h.bottom>r.top;if(!(m&&p)||h.top+h.height/2<n)return;let f=h.width*h.height/(r.width*r.height);if(f>.55)return;let k=c,y=c.parentElement,v=0;for(;y&&y!==e&&v<3;){let E=y.getBoundingClientRect();if(E.width>0&&E.width<=30&&E.height<=30)k=y;else break;y=y.parentElement,v++}k.style.setProperty("transform","translateY(11px)","important");let g=(k.className?.toString()||"")+" "+k.tagName;ur.has(g)||(ur.add(g),b.debug(`Dropped activity badge 11px (${h.width.toFixed(0)}x${h.height.toFixed(0)} icon, ratio ${f.toFixed(2)}): "${g}"`))})})},$s="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",Ps=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();t.includes("active")||t.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(n=>{n.style.setProperty("filter",$s,"important")}),e.querySelectorAll("svg").forEach(n=>{n.style.setProperty("color","#0FB57E","important"),n.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(n=>{let a=n.style.color;(a==="rgb(18, 22, 29)"||a==="#12161D"||a==="#0FB57E"||a==="rgb(15, 181, 126)")&&(n.style.removeProperty("color"),n.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(n=>{n.style.filter&&n.style.filter.includes("hue-rotate(122")&&n.style.removeProperty("filter")}))})},_r=new Set,Os=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let n=r.getBoundingClientRect();if(n.width===0||n.height===0||n.width>56||n.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let l=parseInt(i[1],10),d=parseInt(i[2],10),c=parseInt(i[3],10);if(!(l>200&&d>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let h=r.className?.toString()||"<no class>";!_r.has(h)&&h!=="<no class>"&&(_r.add(h),b.debug(`Stripped dialog icon circle (${n.width.toFixed(0)}x${n.height.toFixed(0)}, rgb(${l},${d},${c})): "${h}"`))})})},vr=new Set,Hs=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.parentElement,r=0;for(;t&&r<3&&!t.closest("[id^='ws-crm-']");){let n=(t.className?.toString()||"").toLowerCase();if(!(n.includes("ai-button")||n.includes("ask-ai")||n.includes("askai"))){let i=t.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){t.style.setProperty("background-color","#12161D","important"),t.style.setProperty("background-image","none","important");let l=t.className?.toString()||"<no class>";!vr.has(l)&&l!=="<no class>"&&(vr.add(l),b.debug(`Painted Ask AI wrapper graphite: "${l}"`))}}t=t.parentElement,r++}})},yr=new Set,Ns=()=>{let o=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),t=[];e.forEach(n=>{if(n.id?.startsWith("ws-crm-")||n.closest("[id^='ws-crm-']"))return;let a=window.getComputedStyle(n);if(a.position!=="fixed"&&a.position!=="absolute")return;let i=parseInt(a.zIndex,10);if(!isFinite(i)||i<50)return;let l=n.getBoundingClientRect();l.width<240||l.height<120||l.width>1500||l.height>900||t.push(n)}),[...o,...t].forEach(n=>{n.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let l=(i.className?.toString()||"").toLowerCase();if(l.includes("avatar")||l.includes("notification-dot")||l.includes("indicator"))return;if(l.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let y=i.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("tabulator")||l.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(l.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let y=i.getAttribute("style")||"";(y.includes("background-color")||y.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(l.includes("ai-button")||l.includes("ask-ai")||l.includes("bg-clip-text")||l.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let d=window.getComputedStyle(i).backgroundColor;if(!d||d==="rgba(0, 0, 0, 0)"||d==="transparent")return;let c=d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let h=parseInt(c[1],10),m=parseInt(c[2],10),p=parseInt(c[3],10);if(!(h>200&&m>200&&p>200))return;let f=i.getBoundingClientRect();if(f.width<24||f.height<16||f.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let k=i.className?.toString()||"<no class>";!yr.has(k)&&k!=="<no class>"&&(yr.add(k),b.debug(`Coerced light bg (${f.width.toFixed(0)}x${f.height.toFixed(0)}, rgb(${h},${m},${p})): "${k}"`))})})},gr=new Set,Bs=()=>{let o="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";document.body.querySelectorAll("*").forEach(t=>{if(t.id?.startsWith("ws-crm-")||t.closest("[id^='ws-crm-']")||t.children.length>0)return;let r=(t.textContent||"").trim();if(r.length===0||r.length>80||r==="--"||t.closest(o)||t.closest("[class*='avatar'], [class*='hr-avatar']")||t.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||t.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(t.matches("[role='heading']")||t.closest("[role='heading']")||t.matches("h1, h2, h3")||t.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){t.matches("h1, h2, h3")&&(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let g=t.getAttribute("style")||"";(g.includes("color")||g.includes("background"))&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"),t.style.removeProperty("background-color"));return}if(t.closest("#SettingTexasSmsBlock")||t.matches("p.ui-text-sm-medium")&&t.parentElement?.classList?.contains("flex")&&t.parentElement?.classList?.contains("items-center")&&t.parentElement?.children?.length===1){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".hr-button, .n-button")||t.matches(".hr-button__content, .n-button__content")||t.closest(".hr-button__content, .n-button__content")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}if(t.closest(".bg-primary-50, [class*='bg-primary-50']")){(t.getAttribute("style")||"").includes("color")&&(t.style.removeProperty("color"),t.style.removeProperty("-webkit-text-fill-color"));return}let n=t,a=null;for(let g=0;g<4&&n;g++){let E=n.nextElementSibling;if(E&&(E.matches(o)||E.querySelector(o)!==null)){a=E;break}n=n.parentElement}if(!a)return;let i=t.getBoundingClientRect();if(i.width===0||i.height===0||i.width>400||i.height>60)return;t.style.setProperty("color","#9098A3","important"),t.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=a,d=l.getBoundingClientRect(),c=l.className?.toString()||"",h=c.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,m=c.includes("hl-form-item")||c.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,p=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",u=(c.includes("hr-form-item-blank")||c.includes("hr-form-item")||l.matches(p))&&(l.matches(p)||l.querySelector(p)!==null);u&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=c.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=c.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=c.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!m&&!u&&!f&&!k&&!y&&d.width>0&&d.width<=800&&d.height>0&&d.height<=100&&(l.style.setProperty("background-color",it,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let v=t.className?.toString()||"<no class>";!gr.has(v)&&v!=="<no class>"&&(gr.add(v),b.debug(`Colored field label "${r.slice(0,30)}": "${v}"`))})},fr=new Set,Rs=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=(e.className?.toString()||"").toLowerCase();if(t.includes("dropdown")||t.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let a=(e.textContent||"").trim();if(a.length===0||a.length>4)return;let i=Math.min(r.width,r.height),l=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${l}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${l}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let d=e.className?.toString()||"<no class>";!fr.has(d)&&d!=="<no class>"&&(fr.add(d),b.debug(`Resized avatar text to ${l}px (circle ${i.toFixed(0)}px): "${d}"`))})},wr=new Set,Gs=new Set(["Enter Dashboard Name"]),zs=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let t=e.getBoundingClientRect();if(t.width===0||t.height===0)return;let r=e.placeholder||"";if(Gs.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",it,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let n=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");n&&(n.style.setProperty("background-color",it,"important"),n.style.setProperty("border-color","#252C36","important"));let a=e.className?.toString()||"<no class>";!wr.has(a)&&a!=="<no class>"&&(wr.add(a),b.debug(`Forced input slate bg: "${a}"`))})},rt=()=>{document.body.querySelectorAll("*").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||e.id==="chat-filter"||e.id==="phone-calls"||e.id==="archive-conversation"||e.id==="star-toggle"||e.id==="read-toggle"||e.id==="delete-conversation")return;if(e.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}let t=e.className?.toString()||"";if(t.includes("bg-inherit")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.closest(".pipeline-ribbon")&&t.split(" ").includes("count")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.split(" ").includes("tabulator-page")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(p=>t.includes(p))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("schedule-ui-form-weekly-schedule-checkbox")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("border-color")||p.includes("border-style")||p.includes("border-width"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"));return}if(t.includes("n-button")&&t.includes("icon-only")&&!t.includes("quaternary")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-button--tertiary-type")||t.includes("n-button--tertiary-type")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"));return}if(t.includes("hr-data-table-td")||t.includes("hr-data-table-tr")||t.includes("hr-data-table__body-cell")||t.includes("hr-data-table__cell")||t.includes("hr-data-table__header-cell")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-data-table-td--fixed-right")||t.includes("n-data-table-td--last-col")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(e.classList.contains("hr-tabs")||t.includes("hr-tabs-tab-wrapper")||t.includes("hr-tabs-nav")||t.includes("hr-tabs-nav-scroll-content")||t.includes("hr-tabs-content")||t.includes("hr-tabs-pane")||t.includes("hr-tabs-rail")||t.includes("hr-tabs-wrapper")||t.includes("hr-tabs-pane-wrapper")||t.includes("hr-tab-pane")){let p=e.getAttribute("style")||"";(p.includes("background-color: rgb(26, 31, 40)")||p.includes("background-color: #1A1F28")||p.includes("background-color: #1a1f28"))&&e.style.removeProperty("background-color");return}if(t.includes("hr-date-panel")||t.includes("n-date-panel")||e.closest(".hr-date-panel, .n-date-panel")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-tag")&&t.includes("ui-default")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if((t.includes("bg-purple-50")||t.includes("bg-purple-100"))&&(t.includes("rounded-lg")||t.includes("rounded-md")||t.includes("rounded-full"))){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("n-alert")||e.closest(".n-alert")||t.includes("hl-warning")||t.includes("hl-error")||t.includes("hl-info")||t.includes("hl-success")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-card")||e.closest(".hr-card")||e.id&&e.id.startsWith("opportunity-")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("bg-gray-50")||t.includes("bg-gray-100")||t.includes("bg-gray-200")||t.includes("bg-white")||t.includes("bg-blue-50")||t.includes("bg-blue-100")||t.includes("bg-sky-50")||t.includes("bg-indigo-50")||t.includes("bg-slate-50")||t.includes("bg-neutral-50")||t.includes("bg-zinc-50")||t.includes("bg-stone-50")||t.includes("F7F9FD")||t.includes("F9FAFB")||t.includes("ECEEF2")||t.includes("eceef2")||t.includes("EFF4FF")||t.includes("eff4ff")){(e.getAttribute("style")||"").includes("background-color")&&e.style.removeProperty("background-color");return}if(t.includes("hr-collapse-item")||t.includes("hr-collapse hr-accordion")||t.includes("hr-accordion"))return;if(t.includes("sidebar-option-button")||e.closest(".sidebar-option-button")||e.closest("nav[class*='w-13']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}if(e.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let p=e.getAttribute("style")||"";(p.includes("background-color")||p.includes("color"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("color"));return}let n=window.getComputedStyle(e).backgroundColor;if(!n||n==="rgba(0, 0, 0, 0)"||n==="transparent")return;let a=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return;let i=parseInt(a[1],10),l=parseInt(a[2],10),d=parseInt(a[3],10);if(!(i<ks&&l<Es&&d<Ts))return;let h=e.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;e.style.setProperty("background-color",it,"important");let m=e.className?.toString()||"<no class>";!cr.has(m)&&m!=="<no class>"&&(cr.add(m),b.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${i},${l},${d})): "${m}"`))})},nt=()=>{let o="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],t="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(a=>{a.setAttribute("data-reos-recolored","1"),a.setAttribute("data-reos-recolored-v2","1"),a.setAttribute("data-reos-recolored-v3","1");let l=(a.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!l)return;let d;try{d=atob(l[1])}catch{return}let c=d,h=!1;if(e.forEach(u=>{c.includes(u)&&(c=c.split(u).join(o),h=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{c.includes(u)&&(c=c.split(u).join("transparent"),h=!0)}),a.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(f=>{c.includes(f)&&(c=c.split(f).join("#EDEEF0"),h=!0)}),!!h)try{let u=btoa(c);a.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(a=>{let i=a.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;a.setAttribute("data-reos-masked","1");let l=`url("${i}")`;a.style.setProperty("-webkit-mask-image",l,"important"),a.style.setProperty("-webkit-mask-size","contain","important"),a.style.setProperty("-webkit-mask-repeat","no-repeat","important"),a.style.setProperty("-webkit-mask-position","center","important"),a.style.setProperty("mask-image",l,"important"),a.style.setProperty("mask-size","contain","important"),a.style.setProperty("mask-repeat","no-repeat","important"),a.style.setProperty("mask-position","center","important"),a.style.setProperty("background-color","var(--reos-blue)","important"),a.setAttribute("src",t)})},at=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(t=>{if(t.startsWith("n-date-panel")){let r="hr-date-panel"+t.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},Us=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let t=e.getAttribute("style")||"";(t.includes("background-color")||t.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},Se=()=>{let o=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(n=>{o(n),n.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let l=window.getComputedStyle(i).backgroundColor;l==="rgba(0, 0, 0, 0)"||l==="transparent"||!l||o(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{o(r);let n=r.querySelector(".ui-upload-icon");n&&(n.style.setProperty("background-color","transparent","important"),n.style.setProperty("background","transparent","important"));let a="rgb(150, 162, 173)",i="rgb(0, 191, 124)",l=c=>{let h=r.querySelector(".ui-upload-icon svg");h&&(h.style.setProperty("color",c,"important"),h.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(m=>{m.style.setProperty("stroke",c,"important")})},d=!1;try{d=r.matches(":hover")}catch{}l(d?i:a),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>l(i)),r.addEventListener("mouseleave",()=>l(a)))})},Xt=new WeakSet,qs=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!Xt.has(e))try{let t=e.contentDocument||e.contentWindow?.document;if(!t||!t.head)return;if(t.querySelector("style[data-ws-crm-email-fix]")){Xt.add(e);return}let r=t.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
        html, body {
          background-color: #FFFFFF !important;
          color: #101828 !important;
        }
        body { padding: 16px !important; }
      `,t.head.appendChild(r),e.style.background="#FFFFFF",e.style.borderRadius="6px",Xt.add(e)}catch{}})},xr=()=>{let o,t=()=>{o===void 0&&(o=window.setTimeout(()=>{o=void 0,at(),Te(),zs(),rt(),ot(),Bs(),qs(),Ns(),Hs(),Os(),Ps(),Ds(),Rs(),Fs(),Ms(),nt(),Ls(),Is(),Se(),Ee(),sr(),lr(),dr(),tt(),Us(),Se()},800))};at(),Te(),rt(),ot(),nt(),Se(),Ee(),sr(),lr(),dr(),tt(),window.setTimeout(()=>{at(),Te(),rt(),ot(),nt(),Se(),Ee(),tt()},500),window.setTimeout(()=>{at(),Te(),rt(),ot(),nt(),Se(),Ee(),tt()},1500),typeof requestAnimationFrame=="function"&&requestAnimationFrame(()=>{Ee(),Te()}),new MutationObserver(()=>{t()}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})},Jt,Vs=()=>{let o=()=>{let t=document.getElementById(st);!t||!document.head||document.head.lastElementChild===t||document.head.appendChild(t)};new MutationObserver(t=>{let r=!1;for(let n of t){for(let a of Array.from(n.addedNodes)){if(!(a instanceof Element))continue;let i=a.tagName.toLowerCase();if(i==="style"||i==="link"){if(a.id===st||a.id===kr)continue;r=!0;break}}if(r)break}r&&Jt===void 0&&(Jt=window.setTimeout(()=>{Jt=void 0,o()},150))}).observe(document.head,{childList:!0}),o()},Er=()=>{if(vs(),!document.getElementById(st)){let o=document.createElement("style");o.id=st,o.textContent=ys,document.head.appendChild(o),b.info("REInvest OS theme stylesheet mounted")}window.__reosForceInstalled||(window.__reosForceInstalled=!0,document.body?xr():window.addEventListener("DOMContentLoaded",xr)),window.__reosCascadeInstalled||(window.__reosCascadeInstalled=!0,Vs())};var Tr="ws-crm-customizer-version-badge",lt=()=>{if(!document.body){document.addEventListener("DOMContentLoaded",lt,{once:!0});return}if(document.getElementById(Tr))return;let o=document.createElement("div");o.id=Tr,o.style.cssText=`
    position: fixed;
    bottom: 12px;
    right: 12px;
    z-index: 999999;
  ...
  `,o.textContent=`Customizer v${De}`,o.title=`Built ${Fe}
Click to dismiss for this session`,o.addEventListener("mouseenter",()=>{o.style.transform="scale(1.05)"}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)"}),o.addEventListener("click",()=>{o.style.opacity="0",setTimeout(()=>o.remove(),200)}),document.body.appendChild(o)};console.log("[ws-crm-customizer] bundle-loaded");var D=(o,e)=>{try{b.info(`[main] calling ${o}`),e(),b.info(`[main] ${o} OK`)}catch(t){b.error(`[main:FAIL] ${o} threw:`,t)}},Sr=()=>{b.info(`Loaded v${De} (built ${Fe})`),D("mountVersionBadge (initial)",lt),D("mountFavicon",Po),D("mountThemeStylesheet",Er),D("initPageRouter",ho),b.info("[main] registering onPageChange subscriber"),bo(o=>{b.info(`[main] onPageChange callback fired for page=${o}`),D("mountVersionBadge",lt),D("mountClaimReleaseToggle",xo),D("mountContactActionsBar",Fo),D("mountActiveFollowUpButton",yo),D("mountMtOfferMadeButton",Ho),D("mountNotInterestedButton",No),D("mountReducePriceButton",Ro),D("mountSendToClosingOfficeButton",Vo),D("mountClosingAgentPickerButton",Zo),D("mountPrepareContractButton",ar)}),b.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Sr):Sr();})();
