/* Wholesaling CRM Customizer v0.49.2 — built 2026-07-06T19:51:36.529Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Vo="[wholesaling-crm-customizer]",Gc="__WS_CRM_DEBUG",Kc=()=>!!window[Gc],p={info(...t){console.log(Vo,...t)},warn(...t){console.warn(Vo,...t)},error(...t){console.error(Vo,...t)},debug(...t){Kc()&&console.log(Vo,"[debug]",...t)}};var Vc=/\/v2\/location\/([A-Za-z0-9]+)/,Yc=new Set(["8ntUQzMflUkR0YvrRgVk"]),Q=()=>{let t=window.location.pathname.match(Vc);return t?t[1]:null},un=()=>{let t=Q();return t!==null&&Yc.has(t)};var Ts=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,_n=/\/v2\/location\/([A-Za-z0-9]+)/,Jc=t=>{let e=t.match(Ts);if(!e)return null;let o=t.match(_n);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},Qc=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ts);if(!a)continue;let s=r.match(_n)||window.location.pathname.match(_n);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=Jc(window.location.pathname);return t||Qc()};var Cs=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Jo="",vn=null,oe="other",yn=new Set,Yo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Jo)&&!(t!==vn))){Jo=window.location.pathname,vn=t,oe=Cs(),p.debug("Page/context changed:",oe,Jo,"contact:",t);for(let r of yn)try{r(oe)}catch(a){p.error("Subscriber threw:",a)}}},Et=t=>(yn.add(t),setTimeout(()=>t(oe),0),()=>{yn.delete(t)}),As=()=>{oe=Cs(),Jo=window.location.pathname,vn=D()?.contactId??null,p.debug("Router init, current page:",oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Yo()},history.replaceState=function(o,r,a){e(o,r,a),Yo()},window.addEventListener("popstate",Yo),setInterval(Yo,1e3)},ue=()=>oe;var Zc=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Is=null,Ls=!1,Ss=t=>{let e=t.match(Zc);e&&(Is=e[1])},Ms=()=>{if(!Ls){Ls=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Ss(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Ss(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},qt=()=>Is;var Qo="0.49.2",Zo="2026-07-06T19:51:36.530Z";var Xc="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",Xo=new Map,gn=new Map,tp=3e4,Ze=4e3,ep=Ze,$t=async(t,e)=>{if(!t)return null;let o=Xo.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<tp)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=gn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),ep);try{let l=`${Xc}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),Xo.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let h=(m.contact_type||"").toLowerCase().trim()||null;return Xo.set(t,{type:h}),p.debug(`Resolved Contact Type for ${t}: ${h??"(unset)"}`),h}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),Xo.set(t,{type:null,failedAt:Date.now()}),null}})();gn.set(t,s);try{return await s}finally{gn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var M=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let h=a.querySelector(t);h&&(m(),s(h))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},_={sm:"4px",md:"6px",lg:"10px",pill:"999px"},b={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},fn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Ps=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,R=`
  ...
  flex-shrink: 0;
`;var op=/^[A-Za-z0-9]{15,30}$/,Xe=t=>typeof t=="string"&&op.test(t),Os=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},rp=()=>{let t=window.WS_CRM_USER_ID;return Xe(t)?t:null},np=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(Xe(o))return o;return null},ap=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Os(e);if(!o)return null;let r=o.uid;if(Xe(r))return r;let a=o.claims;if(a&&Xe(a.user_id))return a.user_id}catch{}return null},sp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(Xe(a))return a}catch{}}}catch{}return null},H=()=>rp()||ap()||np()||sp()||null,ip=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Os(e);return o?o.claims??o:null}catch{return null}},_e=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:ip()?.type==="agency"};var Ds="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",lp=`${Ds}/active-follow-up-get`,dp=`${Ds}/active-follow-up-set`,re="ws-crm-active-follow-up-button",wn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"In Active Follow Up",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"Not in Follow Up",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},cp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},pp=async t=>{let e=await fetch(lp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},mp=async(t,e)=>{let o=await fetch(dp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ne=(t,e)=>{let o=wn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Bs=t=>{let e=document.createElement("button");return e.type="button",e.id=re,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ne(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=cp();if(!(!r||r.contactId!==t)){ne(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await mp(r,H()),s=a&&a.state&&a.state in wn?a.state:"blue";ne(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ne(e,"error"),setTimeout(()=>void er(e,r),4e3)}}}),e},bp=3e4,er=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),ne(t,"loading");try{let o=await pp(e),r=o&&o.state&&o.state in wn?o.state:"gray",a=document.getElementById(re);if(!a||a.dataset.contactId!==e.contactId)return;ne(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,ne(t,"error")}},hp=[".central-panel","[class*='central-panel']"],xn="ws-crm-contact-actions-bar",up=async()=>{for(let t of hp)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await M("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},_p=async(t,e)=>{let o=e.querySelector(`#${xn}`);if(!o)try{o=await M(`#${xn}`,{timeoutMs:Ze+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${xn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},vp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},yp=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},gp=async t=>{if(t==="url"){let o=await up();return o?{kind:"contact-detail",target:o}:null}let e=vp();return e?{kind:"conversations",target:e}:null},Rs=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await _p(t,e.target);return o}return yp(t,e.target),"conversations-header"},fp=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(re);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=bp&&er(o,e);return}o&&o.remove();let r=await gp(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=Bs(e.contactId),i=await Rs(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),Hs();let d=document.getElementById(re)??s;er(d,e),tr?.disconnect(),tr=new MutationObserver(()=>{let l=document.getElementById(re);if(!(D()?.contactId===e.contactId)){tr?.disconnect();return}if(!l){let m=Bs(e.contactId);Rs(m,r).then(()=>{Hs(),er(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),tr.observe(r.target,{childList:!0})},tr=null,to=null,Fs=()=>{let t=D()?.contactId??null;if(to&&to.contactId===t)return;let e=fp().finally(()=>{to?.promise===e&&(to=null)});to={contactId:t,promise:e}},Hs=()=>{let t=document.querySelectorAll(`#${re}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var xp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",zs="ws-crm-analytics-launcher",or="ws-crm-analytics-overlay",wp=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],kp=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],P={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},K=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},O=t=>(Number(t)||0).toLocaleString("en-US"),kn=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},oo=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},Ep=()=>`${P.range}|${P.customStart}|${P.customEnd}`,ve=async(t=!1)=>{let e=Ep();if(!t&&P.cache.has(e)){P.data=P.cache.get(e),P.error=null,ae();return}let o=Q();if(!o){P.error="Could not resolve the sub-account id from the URL.",ae();return}P.loading=!0,P.error=null,ae();try{let r={tenant_id:o,range:P.range,tz_offset_minutes:new Date().getTimezoneOffset()};P.range==="custom"&&(r.start=P.customStart,r.end=P.customEnd);let a=await fetch(xp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);P.data=s,P.cache.set(e,s)}catch(r){P.error=r instanceof Error?r.message:String(r)}finally{P.loading=!1,ae()}},L=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},rt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),no=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${_.lg};padding:16px 18px;min-width:0;`,En=`font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=L("div",no+"flex:1;min-width:150px;");return r.appendChild(L("div",En+"margin-bottom:8px;",rt(t))),r.appendChild(L("div",`font-family:${b.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,rt(e))),o&&r.appendChild(L("div",`font-family:${b.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,rt(o))),r},V=(t,e)=>{let o=L("div",no);if(o.appendChild(L("div",En,rt(t))),!e.length)return o.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=L("div","margin:0 0 10px;"),i=L("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(L("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,rt(a.label)));let d=L("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,rt(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${rt(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=L("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(L("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(L("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},rr=(t,e,o)=>{let r=L("div",no+"overflow-x:auto;");if(r.appendChild(L("div",En,rt(t))),!o.length)return r.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${rt(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${rt(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(L("div","",i)),r},Z=(t,e)=>{let o=L("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},ro=t=>{let e=L("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Ot=t=>(t||[]).map(e=>({label:e.label,primary:O(e.count),barVal:e.count})),$p=t=>(t||[]).map(e=>({label:e.label,primary:K(e.sum),secondary:`\xB7 ${O(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),Ns=(t,e)=>{let o=t.calls||{};if(!o.available)return[L("div",`${no}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${rt(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=e==="acq"?"Seller":"Buyer",a=o[e]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${O(c.connects)} connected \xB7 ${O(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:oo(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${oo(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[V(`${r} calls per rep (dials)`,s),V(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(V("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${oo(c.talk_seconds)} talk`,barVal:c.dials})))),d},Tp=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(ro([dt("Closed revenue \u2014 365d",K(o.closed_revenue_365),`${O(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",K(o.avg_deal_size_365)),dt("Left to close this month",K(r.sum),`${O(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${O(r.missing_est_close)} missing est. close date`:"")),dt("New leads",O(o.total_leads),"in selected range")])),e.appendChild(ro([dt("Contracts",`${O((o.contracts||{}).count)}`,K((o.contracts||{}).sum)+" projected"),dt("Assignments",`${O((o.assignments||{}).count)}`,K((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${O((o.closed||{}).count)}`,K((o.closed||{}).sum)+" closed")])),e.appendChild(Z("1fr 1fr 1fr",[V("New leads by source",Ot(o.new_leads_by_source)),V("Contacts per closer (all time)",Ot(o.contacts_per_closer)),V("Dispo deals per rep (all time)",Ot(o.dispo_deals_per_rep))]))},Cp=(t,e)=>{let o=t.acq||{};e.appendChild(Z("1fr 1fr",[V("Offers made per rep",Ot(o.offers_per_rep)),V("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${K(a.sum)} projected`,barVal:a.count})))])),e.appendChild(Z("1fr 1fr",[V("Projected revenue per closer (open escrows)",$p(o.projected_per_closer)),V("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:K(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${K(a.avg)}`,barVal:a.sum})))]));let r=Ns(t,"acq");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Ap=(t,e)=>{let o=t.dispo||{};e.appendChild(Z("1fr 1fr",[V("Buyers qualified per dispo rep",Ot(o.buyers_qualified_per_rep)),V("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${K(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(Z("1fr",[V("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:K(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${K(a.avg)}`,barVal:a.sum})))]));let r=Ns(t,"dispo");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Lp=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(ro([dt("Open leads",O(r.open)),dt("Won (under contract+)",O(r.won)),dt("Lost / dead",O(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${K(i.assigned_sum)}`,`${O(i.closed_count)} / ${K(i.closed_sum)}`,K(i.avg_deal)]);e.appendChild(Z("1fr",[rr("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${K(i.assigned_sum)}`,`${O(i.closed_count)} / ${K(i.closed_sum)}`,K(i.avg_deal)]);e.appendChild(Z("1fr",[rr("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(Z("1fr 1fr",[V("Dead leads by channel",Ot(o.dead_by_channel)),V("Dead leads by city",Ot(o.dead_by_city))]))},Sp=(t,e)=>{let o=t.tc||{};e.appendChild(ro([dt("Contracted",O(o.contracted),"in selected range"),dt("Closed",O(o.closed)),dt("Lost in escrow",O(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(Z("1fr 1fr",[V("Deals per TC (contracted in range)",Ot(o.per_tc)),V("Open escrows by stage",Ot(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,K(a.value),kn(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(Z("1fr",[rr("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Ip=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(ro([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${O(r.offers)} offers \xB7 ${O(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${O(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(Z("1fr 1fr",[V("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),V("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,O(d.leads),O(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(Z("1fr",[rr("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${oo(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${oo(l.talk_seconds)} total \xB7 ${O(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(Z("1fr",[V("Talk time per contract per rep",d)]))}else e.appendChild(L("div",`${no}border-left:3px solid ${n.amber};border-radius:0 ${_.lg} ${_.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${rt(i.note||"")}`))},eo=t=>`padding:5px 12px;border-radius:${_.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${b.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,ae=()=>{let t=document.getElementById(or);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=L("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let m of wp){let h=L("button",eo(P.range===m.key),rt(m.label));h.onclick=()=>{P.range=m.key,m.key!=="custom"?ve():ae()},r.appendChild(h)}if(P.range==="custom"){let m=`background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,h=L("input",m);h.type="date",h.value=P.customStart;let v=L("input",m);v.type="date",v.value=P.customEnd;let u=L("button",eo(!0),"Apply");u.onclick=()=>{P.customStart=h.value,P.customEnd=v.value,P.customStart&&P.customEnd&&ve()},r.appendChild(h),r.appendChild(v),r.appendChild(u)}let a=L("button",eo(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ve(!0),r.appendChild(a),o.appendChild(r);let s=L("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let m of kp){let h=L("button",eo(P.tab===m.key),rt(m.label));h.onclick=()=>{P.tab=m.key,ae()},s.appendChild(h)}if(o.appendChild(s),e.innerHTML="",P.loading){e.appendChild(L("div",`padding:60px;text-align:center;color:${n.ash};font-family:${b.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(P.error){let m=L("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${b.sans};font-size:13px;`,`Couldn't load analytics: ${rt(P.error)}`),h=L("button",eo(!0)+"margin:14px auto 0;display:inline-block;","Retry");h.onclick=()=>void ve(!0);let v=L("div","text-align:center;");v.appendChild(m),v.appendChild(h),e.appendChild(v);return}let i=P.data;if(!i){ve();return}let d=i.range||{};e.appendChild(L("div",`font-family:${b.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${rt(d.label||"")} \xB7 ${kn(d.start)} \u2192 ${kn(d.end)} \xB7 ${O((i.meta||{}).opps)} opps \xB7 ${O((i.meta||{}).contacts)} contacts`));let l=i.insights||[];if(l.length){let m=L("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let h of l.slice(0,6)){let v=h.level==="warn";m.appendChild(L("div",`padding:8px 12px;border-left:3px solid ${v?n.amber:n.blue};background:${v?n.amberGlow:n.blueGlow};border-radius:0 ${_.sm} ${_.sm} 0;font-family:${b.sans};font-size:12px;color:${n.bone};`,rt(h.text)))}e.appendChild(m)}let c=L("div","");P.tab==="company"?Tp(i,c):P.tab==="acq"?Cp(i,c):P.tab==="dispo"?Ap(i,c):P.tab==="marketing"?Lp(i,c):P.tab==="tc"?Sp(i,c):Ip(i,c),e.appendChild(c)},Mp=()=>{if(document.getElementById(or))return;P.open=!0;let t=L("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${b.sans};`);t.id=or;let e=L("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=L("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(L("div",`font-family:${b.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=L("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${_.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=Us,o.appendChild(r),e.appendChild(o),e.appendChild(L("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=L("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",qs),ae(),P.data||ve()},qs=t=>{t.key==="Escape"&&Us()},Us=()=>{P.open=!1,document.getElementById(or)?.remove(),document.removeEventListener("keydown",qs)},js=()=>{let t=window.location.pathname.includes("/dashboard"),e=document.getElementById(zs);if(!t){e?.remove();return}if(e)return;let o=L("button",`position:fixed;bottom:52px;right:16px;z-index:99990;display:inline-flex;align-items:center;gap:8px;padding:9px 16px;background:${n.emerald};color:${n.obsidian};border:none;border-radius:${_.pill};font-family:${b.mono};font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;cursor:pointer;box-shadow:0 8px 24px rgba(15,181,126,0.35);`,"\u25A6 Analytics");o.id=zs,o.onclick=Mp,document.body.appendChild(o),p.debug("[analytics] launcher mounted")};var Ks="ws-buybox-nav-icon",Cn="ws-buybox-panel",Ws="ws-buybox-modal",Pp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",An="https://mcclivetim.github.io/reinvest-os-cdn/geo",nr=null,ao=null,so=null,Tn=async()=>{if(nr)return nr;try{let t=await fetch(`${An}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return nr=await t.json(),nr}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},Op=async t=>{if(!ao)try{let e=await fetch(`${An}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);ao=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return ao?.[t]??[]},Bp=async t=>{if(!so)try{let e=await fetch(`${An}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);so=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return so?.[t]??[]},Ln=async t=>await(await fetch(Pp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Rp=(t,e)=>Ln({tenant_id:t,action:"list",buyer_contact_id:e}),Hp=(t,e,o,r)=>Ln({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Dp=(t,e)=>Ln({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Fp=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},zp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Np='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',qp="nav.w-13, nav[class*='w-13']",Up=".flex-1.h-full.relative.overflow-hidden.rounded-lg",jp=async()=>{try{return await M(qp,{timeoutMs:2500})}catch{return null}},Wp=async()=>{try{return await M(Up,{timeoutMs:2500})}catch{return null}},Gp=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,Kp=(t,e)=>{let o=document.createElement("div");return o.id=Cn,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{Qp(t,e,()=>Sn(t,e))}),o},Sn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Rp(t,e),Tn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}Vp(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},Vp=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let h=l.key==="state"?Fp(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Dp(r,c).then(h=>{if(!h.ok){alert(`Failed to remove: ${h.error||"unknown error"}`),l.disabled=!1;return}Sn(r,a)}).catch(h=>{alert(`Network error: ${h.message}`),l.disabled=!1}))})})},ar=!1,Vs=(t,e)=>{ar=e;let o=Gp(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=Yp,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Sn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Ys,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Ys="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",Yp="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",Jp=t=>{let e=document.createElement("button");return e.id=Ks,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Ys,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${zp.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!ar;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Vs(r,a)}),e},Qp=(t,e,o)=>{let r=document.getElementById(Ws);r&&r.remove();let a=document.createElement("div");a.id=Ws,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await Tn();s.innerHTML=h(w),v(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=g(),$();else if(i.granularity==="state"){let w=await Tn();s.innerHTML=x(w),f(w)}else i.granularity==="county"?(s.innerHTML=u(i.stateCode||""),await Op(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=u(i.stateCode||""),await Bp(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,x=w=>{let E=w.find(S=>S.code===i.stateCode);return`
    ...
    `},f=w=>{s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=2,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>T(i.stateCode||""))},k=w=>{let E=i.granularity==="county"?ao?.[i.stateCode||""]??[]:so?.[i.stateCode||""]??[];return`
    ...
    `},y=()=>{let w=i.granularity==="county"?ao?.[i.stateCode||""]??[]:so?.[i.stateCode||""]??[],E=s.querySelector("#ws-buybox-value-search"),S=s.querySelector("#ws-buybox-value-list");if(!E||!S)return;let B=j=>{let U=j.toLowerCase().trim();if(!U){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">Start typing to filter.</div>`;return}let W=w.filter(N=>N.toLowerCase().includes(U)).slice(0,50);if(W.length===0){S.innerHTML=`<div style="padding: 12px; color: ${n.ash}; font-size: 12px;">No matches in ${G(i.stateCode||"")}.</div>`;return}S.innerHTML=W.map(N=>`
  ...
  `,$=()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),w.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),A())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>w.focus(),0))},A=async()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),S=(w?.value||"").trim();if(!/^\d{5}$/.test(S)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(S)},T=async w=>{if(!i.granularity||!w)return;let E=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),E&&(E.textContent="");try{let B=await Hp(t,e,i.granularity,w);if(!B.ok){E&&(E.textContent=B.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(B){E&&(E.textContent=`Network error: ${B.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},$n=!1,ye=null,io=null,Gs=()=>{document.getElementById(Ks)?.remove(),document.getElementById(Cn)?.remove(),io&&ye&&ye.nav.removeEventListener("click",io,!0),io=null,ye=null,ar=!1},Js=()=>{Zp()},Zp=async()=>{if(!$n){$n=!0;try{let t=D();if(!t){Gs();return}let e=document.getElementById(Cn);if(e&&e.dataset.buyerContactId===t.contactId&&ye)return;Gs();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(h){p.warn("[buy-box] Contact Type fetch failed",h);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([jp(),Wp()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=Kp(t.locationId,t.contactId),l=Jp(()=>ye),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};ye=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),io=h=>{let v=h.target;if(!v||c.iconBtn.contains(v))return;v.closest("button.sidebar-option-button")&&ar&&Vs(c,!1)},a.addEventListener("click",io,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{$n=!1}}};var Xs="ws-properties-nav-icon",On="ws-properties-panel",Qs="ws-properties-modal",Bn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",Xp=`${Bn}/list-for-contact`,tm=`${Bn}/create-with-opp`,em=`${Bn}/add-contact`,om=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),rm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,ti=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},sr=t=>{let e=ti(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},In=t=>{let e=ti(t);return e===null?"&mdash;":e.toLocaleString()},ei={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},nm=t=>{let e=(t||"").toString().trim();return e?mt(ei[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},am=t=>{let e=(t||"").toString().trim();return e?ei[e]||e:""},sm={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},im=t=>{let e=(t||"").toString().trim();return e?sm[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Ut=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,lm=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Ut("Baths",In(t.baths))}
    ${Ut("Sq Ft",In(t.sqft))}
    ${Ut("Rehab",nm(t.rehab_level),am(t.rehab_level))}
    ${Ut("ARV",sr(t.arv))}
    ${Ut("IMV",sr(t.imv))}
    ${Ut("MAO",sr(t.mao))}
    ${Ut("Ask",sr(t.asking_price))}
  </div>`,oi=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},dm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',cm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',pm="nav.w-13, nav[class*='w-13']",mm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ri="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",bm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",hm=async()=>{try{return await M(pm,{timeoutMs:2500})}catch{return null}},um=async()=>{try{return await M(mm,{timeoutMs:2500})}catch{return null}},Rn=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),Ct=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:13px;outline:none;margin-bottom:10px;`,At=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,Hn=`background:${n.emerald};color:${n.bone};border:none;border-radius:${_.sm};padding:8px 18px;cursor:pointer;font-family:${b.sans};font-size:13px;font-weight:600;`,ni=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 16px;cursor:pointer;font-family:${b.sans};font-size:13px;`,_m=(t,e)=>{let o=document.createElement("div");return o.id=On,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${Hn}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{ym(t,e,()=>Dn(t,e))}),o},Dn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Rn(Xp,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}vm(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},vm=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${_.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${_.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${mt(c||"")}${a.property_type?" &middot; "+mt(im(a.property_type)):""}</div>
        ${lm(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${mt(a.property_record_id)}" data-addr="${mt(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${_.sm};padding:4px 10px;cursor:pointer;font-family:${b.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${cm} Add person</button>
        </div>
      </div>
    `}).join(""),t.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{gm(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>Dn(o,r))})}),t.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(rm(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},ai=()=>{document.getElementById(Qs)?.remove();let t=document.createElement("div");t.id=Qs,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let e=document.createElement("div");return e.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,t.appendChild(e),document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()}),{overlay:t,card:e}},ym=(t,e,o)=>{let{overlay:r,card:a}=ai();a.innerHTML=`
    ...
    <select id="wp-type" style="${Ct}">
      ...
      ${om.map(i=>`<option value="${mt(i)}">${mt(i)}</option>`).join("")}
    </select>
    <div id="wp-err" style="color:${n.crimson};font-size:12px;min-height:16px;margin-bottom:6px;"></div>
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wp-cancel" type="button" style="${ni}">Cancel</button>
      <button id="wp-save" type="button" style="${Hn}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=u=>(a.querySelector(u)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),h=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let v=a.querySelector("#wp-save");v&&(v.disabled=!0,v.textContent="Creating\u2026"),s&&(s.textContent="");try{let u=await Rn(tm,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:h||void 0});if(!u.ok){s&&(s.textContent=u.error||"Failed to create property."),v&&(v.disabled=!1,v.textContent="Create property + deal");return}r.remove(),oi("Property + deal created \u2713"),o()}catch(u){s&&(s.textContent=`Network error: ${u.message}`),v&&(v.disabled=!1,v.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},gm=(t,e,o,r)=>{let{overlay:a,card:s}=ai();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      <button id="wpp-cancel" type="button" style="${ni}">Cancel</button>
      <button id="wpp-save" type="button" style="${Hn}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=x=>(s.querySelector(x)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),h=l("#wpp-phone"),v=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let u=s.querySelector("#wpp-save");u&&(u.disabled=!0,u.textContent="Adding\u2026"),i&&(i.textContent="");try{let x=await Rn(em,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:h||void 0,email:v||void 0}});if(!x.ok){i&&(i.textContent=x.error||"Failed to add person."),u&&(u.disabled=!1,u.textContent="Add person");return}a.remove(),oi("Person added \u2713"),r()}catch(x){i&&(i.textContent=`Network error: ${x.message}`),u&&(u.disabled=!1,u.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},ir=!1,ut=null,Mn=!1,lo=null,fm=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},xm=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},Pn=(t,e)=>{ir=e,e?(t.iconBtn.className=bm,t.iconBtn.dataset.active="true",xm(),fm(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",Dn(t.tenantId,t.contactId)):(t.iconBtn.className=ri,delete t.iconBtn.dataset.active,t.panel.style.display="none")},wm=()=>{let t=document.createElement("button");return t.id=Xs,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=ri,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${dm.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ut&&Pn(ut,!ir)}),t},Zs=()=>{document.getElementById(Xs)?.remove(),document.getElementById(On)?.remove(),lo&&ut&&ut.nav.removeEventListener("click",lo,!0),lo=null,ut=null,ir=!1},si=()=>{km()},km=async()=>{if(!Mn){Mn=!0;try{let t=D();if(!t||!t.locationId){Zs();return}let e=document.getElementById(On);if(e&&e.dataset.contactId===t.contactId&&ut)return;Zs();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Tt(o)!=="seller")return;let[a,s]=await Promise.all([hm(),um()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=_m(t.locationId,t.contactId),l=wm();ut={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ut&&Pn(ut,!1)}),lo=m=>{let h=m.target;!h||ut&&ut.iconBtn.contains(h)||h.closest("button.sidebar-option-button")&&ir&&ut&&Pn(ut,!1)},a.addEventListener("click",lo,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{Mn=!1}}};var ii="ws-non-seller-contact",li=()=>{Em()},Em=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(ii);return}let e="seller";try{e=Tt(await $t(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(ii,e!=="seller")};var jt="ws-crm-claim-release-pill",$m="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Tm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Cm=async t=>{let e=await fetch($m,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Am=async t=>{let e=await fetch(Tm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},pi=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},fe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Ps(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Lm=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=jt,o.type="button",o.dataset.contactId=t,fe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=H();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>fe(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";fe(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await Am({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;fe(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),fe(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},di=async t=>{try{let e=await Cm({contactId:t.contactId,locationId:t.locationId,userId:H()}),o=document.getElementById(jt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";fe(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},Sm=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=pi(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},ci=(t,e)=>{let o=Lm({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${jt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},ge=null,Im=async()=>{let t=D();if(!t){ge?.disconnect(),ge=null,document.getElementById(jt)?.remove();return}let e=document.getElementById(jt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await M("#record-details-lhs",{timeoutMs:1e4}),r=await Sm(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}ci(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(jt)&&t.locationId&&di({contactId:t.contactId,locationId:t.locationId}),ge?.disconnect(),ge=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){ge?.disconnect();return}if(document.getElementById(jt))return;let d=pi(o);d&&(ci(d,t.contactId),document.getElementById(jt)&&t.locationId&&di({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),ge.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},mi=()=>{Im()};var gi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Mm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",Pm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Om=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||gi,l;if(i==="buyer"){let m=wi.find(v=>v.label===o),h=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:h,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},Bm=async({contactId:t,tenantId:e})=>{let o=await fetch(Pm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},xe="ws-crm-contact-actions-bar",fi="ws-crm-call-status-dropdown",xi="ws-crm-call-status-menu",dr="ws-crm-offer-made-modal",bi=!1,Rm=()=>{bi||(bi=!0,document.addEventListener("click",t=>{let e=document.getElementById(xi);if(!e||e.style.display==="none")return;let o=document.getElementById(fi);o&&!o.contains(t.target)&&(e.style.display="none")}))},Hm=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],wi=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Dm=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Fm=async()=>{for(let t of Dm)try{let e=await M(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await M("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},zm=({contactId:t,kind:e})=>{let o=e==="buyer"?wi:Hm,r=e==="buyer"?Mm:gi,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=fi,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=R,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=xi,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      <span style="
        ...
        height: 8px;
        border-radius: 50%;
        background: ${fn[l.color]};
        flex-shrink: 0;
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,h=i.children[1],v=i.children[2];m&&(m.style.background=fn[l.color]),h&&(h.textContent=l.label),d.style.display="none";let x=D()?.locationId,f=H();if(!x){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),h&&(h.textContent=`${l.label} (no tenant!)`),h&&(h.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!f){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),h&&(h.textContent=`${l.label} (no user!)`),h&&(h.style.color=n.amber);return}let k=v?.textContent??"\u25BE",y=async g=>{v&&(v.textContent="\u2026"),i.style.opacity="0.75";try{await Om({contactId:t,locationId:x,status:l.label,userId:f,deadReason:g,webhookUrl:r,kind:e}),v&&(v.textContent="\u2713"),setTimeout(()=>{v&&(v.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),v&&(v.textContent="\u2717"),h&&(h.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{v&&(v.textContent=k),h&&(h.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let g=h?.textContent??"";Gm($=>{y($)},()=>{h&&(h.textContent=g)});return}if(e==="seller"&&l.value==="appointment-booked"){let g=h?.textContent??"";try{(await Bm({contactId:t,tenantId:x})).ok?await y():Km(()=>{y()},()=>{h&&(h.textContent=g)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Rm(),s.appendChild(i),s.appendChild(d),s},Nm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",qm=async t=>{let e=await fetch(Nm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Um="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",zn=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),jm=async(t,e)=>{let o=await fetch(Um,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},Wm=t=>new Promise(e=>{document.getElementById(dr)?.remove();let o=document.createElement("div");o.id=dr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${b.sans};">
        <div style="font-size:14px;font-weight:500;">${zn(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${zn(i.dealStage)}</div>`:""}
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),h=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",v=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${zn(o.address)}</strong></div>`:"",u=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",x=r&&o&&o.propertyRecordId?`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},_i=(t,e)=>{let o=document.createElement("div");if(o.id=xe,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
    ...
    border-bottom: 1px solid ${n.steel};
    flex-shrink: 0;
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=R,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){co(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){co(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await jm(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),co(t,e);return}if(d(),l.length<=1){co(t,e,l[0]);return}let c=await Wm(l);c&&co(t,e,c)}),o.appendChild(r),o.appendChild(zm({contactId:t,kind:e}))}return o},Fn=!1,vi=()=>{document.querySelectorAll(`[id="${xe}"]`).forEach(t=>t.remove())},ki=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),Fn){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}Fn=!0;try{await Vm()}finally{Fn=!1}},Vm=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),vi();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),vi();return}let e="seller";try{let l=await $t(t.contactId,t.locationId),c=Tt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${xe}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Fm();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=_i(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(xe)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),lr?.disconnect(),lr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){lr?.disconnect();return}let c=document.querySelectorAll(`[id="${xe}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,h=_i(t.contactId,e);h.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(h,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(v){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",v)}}}),lr.observe(a,{childList:!0})},lr=null,yi=null,Ym=()=>{yi===null&&(yi=window.setInterval(()=>{let t=D();t&&(document.getElementById(xe)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),ki()))},3e3))},Ei=()=>{Ym(),ki()};var cr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",Jm=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),po="data-ws-crm-favicon",Nn=t=>t.hasAttribute(po),$i=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return Jm.has(e)},pr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{$i(r)&&!Nn(r)&&r.remove()});let e=document.head.querySelector(`link[${po}="1"]`);e?e.href!==cr&&(e.href=cr):(e=document.createElement("link"),e.setAttribute(po,"1"),e.rel="icon",e.type="image/png",e.href=cr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${po}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(po,"apple"),o.rel="apple-touch-icon",o.href=cr,document.head.appendChild(o))},Ti=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)pr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),pr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&$i(i)&&!Nn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Nn(i)&&(a=!0)});a&&pr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,pr(),e>=5&&window.clearInterval(o)},1e3)};var tt=".crm-opportunities-modal .ui-modal-heading .description",Ci=new Map,qn=null,Un,Qm=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Ci){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},Y=(t,e,o)=>{Ci.set(t,{selector:e,cb:o}),!qn&&(qn=new MutationObserver(()=>{Un===void 0&&(Un=window.setTimeout(()=>{Un=void 0,Qm()},300))}),qn.observe(document.body,{childList:!0,subtree:!0}))};var Zm=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],Xm=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,tb=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let t=document.querySelector(tb);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(Xm);if(a){let s=a[1];if(Zm.includes(s))return s}}return null},et=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Ai="ws-crm-dispo-action-row",J=t=>{let e=document.getElementById(Ai);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Ai,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var eb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",yt="ws-crm-mt-offer-made-button",Li="ws-crm-mt-offer-made-modal",ob=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,rb=/\/v2\/location\/([A-Za-z0-9]+)/,hr=()=>{let t=window.location.pathname,e=t.match(ob),o=e?e[1]:qt();if(!o)return null;let r=t.match(rb);return{oppId:o,locationId:r?r[1]:null}},nb=async t=>{let e=await fetch(eb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},mr=()=>{document.getElementById(Li)?.remove()},ab=t=>{mr();let e=document.createElement("div");e.id=Li,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-mt-offer-amount"),a=o.querySelector("#ws-mt-offer-error"),s=o.querySelector("#ws-mt-offer-cancel"),i=o.querySelector("#ws-mt-offer-submit");setTimeout(()=>r?.focus(),50);let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&mr()}),s?.addEventListener("click",()=>mr()),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l||Number(l)<=0){a.textContent="Enter a positive offer amount.",r.focus();return}let c=Number(l);if(c<100){a.textContent=`That looks low \u2014 did you mean $${(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Recording\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{let m=await nb({oppId:t.oppId,locationId:t.locationId,amount:c,userId:H()});if(!m.ok){a.textContent=m.error??"Something went wrong.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1);return}mr(),t.onSuccess()}catch(m){p.error("MT Offer Made webhook failed",m),a.textContent=m instanceof Error?m.message:"Network error \u2014 try again.",i.disabled=!1,i.textContent="Record Offer",i.style.opacity="1",s&&(s.disabled=!1)}})},sb=t=>{let e=document.createElement("button");return e.id=yt,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Record this buyer's offer on the property and advance to 'Made an Offer'",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=hr();!o||!o.locationId||o.oppId!==t||ab({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=R)},4e3)}})}),e},ib=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],lb=async()=>{for(let t of ib)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},br=!1,Wn=async()=>{if(!br){br=!0;try{await db()}finally{br=!1}}},db=async()=>{let t=hr();if(!t||!t.locationId){document.getElementById(yt)?.remove(),document.getElementById(`${yt}-wrap`)?.remove(),bo();return}let e=document.getElementById(yt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${yt}-wrap`)?.remove(),bo());return}e&&(e.remove(),document.getElementById(`${yt}-wrap`)?.remove());let o=await lb();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=hr();if(!a||a.oppId!==t.oppId)return;let s=sb(t.oppId),i=document.createElement("span");i.id=`${yt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),cb(t.oppId)},mo=null,jn=null,we,bo=()=>{mo?.disconnect(),mo=null,jn=null,we!==void 0&&(window.clearTimeout(we),we=void 0)},cb=t=>{if(mo&&jn===t)return;bo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(jn=t,mo=new MutationObserver(()=>{we===void 0&&(we=window.setTimeout(()=>{we=void 0;let o=hr();if(!o||o.oppId!==t){bo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(yt)?.remove(),document.getElementById(`${yt}-wrap`)?.remove(),bo();return}document.getElementById(yt)||Wn()},250))}),mo.observe(e,{childList:!0,subtree:!0}))},pb=()=>{Y("mt-offer-made",tt,()=>{!document.getElementById(yt)&&!br&&Wn()})},Si=()=>{pb(),Wn()};var mb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",gt="ws-crm-not-interested-button",bb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,hb=/\/v2\/location\/([A-Za-z0-9]+)/,_r=()=>{let t=window.location.pathname,e=t.match(bb),o=e?e[1]:qt();if(!o)return null;let r=t.match(hb);return{oppId:o,locationId:r?r[1]:null}},ub=async t=>{let e=await fetch(mb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},_b=t=>{let e=document.createElement("button");return e.id=gt,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=_r();if(!o||!o.locationId||o.oppId!==t)return;let r=H(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await ub({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},vb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],yb=async()=>{for(let t of vb)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},ur=!1,Kn=async()=>{if(!ur){ur=!0;try{await gb()}finally{ur=!1}}},gb=async()=>{let t=_r();if(!t||!t.locationId){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}let e=document.getElementById(gt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo());return}e&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove());let o=await yb();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=_r();if(!a||a.oppId!==t.oppId)return;let s=_b(t.oppId),i=document.createElement("span");i.id=`${gt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),fb(t.oppId)},ho=null,Gn=null,uo=()=>{ho?.disconnect(),ho=null,Gn=null},fb=t=>{if(ho&&Gn===t)return;uo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Gn=t,ho=new MutationObserver(()=>{let o=_r();if(!o||o.oppId!==t){uo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),uo();return}document.getElementById(gt)||Kn()}),ho.observe(e,{childList:!0,subtree:!0}))},xb=()=>{Y("not-interested",tt,()=>{!document.getElementById(gt)&&!ur&&Kn()})},Ii=()=>{xb(),Kn()};var wb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",_t="ws-crm-schedule-walkthrough-button",Vn="ws-crm-schedule-walkthrough-modal",kb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Eb=/\/v2\/location\/([A-Za-z0-9]+)/,gr=()=>{let t=window.location.pathname,e=t.match(kb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Eb);return{oppId:o,locationId:r?r[1]:null}},vr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},$b=(t,e)=>{document.getElementById(Vn)?.remove();let o=document.createElement("div");o.id=Vn,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
    <style>#${Vn} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let i=()=>o.remove();o.addEventListener("click",l=>{l.target===o&&i()}),document.getElementById("wsw-cancel")?.addEventListener("click",i);let d=document.getElementById("wsw-submit");d?.addEventListener("click",async()=>{let l=document.getElementById("wsw-dt")?.value||"",c=document.getElementById("wsw-dur")?.value||"30";if(!l){vr("Pick a date and time.","err");return}let m=new Date(l).toISOString();d.disabled=!0,d.textContent="Scheduling\u2026";try{if((await fetch(wb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,start_time:m,duration_min:Number(c)}),credentials:"omit"})).ok){i(),vr("Walkthrough scheduled \u2713");let v=document.querySelector(`#${_t} .ws-sw-label`);v&&(v.textContent="Walkthrough Scheduled")}else d.disabled=!1,d.textContent="Schedule",vr("Scheduling failed \u2014 try again.","err")}catch(h){p.warn("[schedule-walkthrough] failed:",h),d.disabled=!1,d.textContent="Schedule",vr("Couldn't reach the scheduler. Try again.","err")}})},Tb=t=>{let e=document.createElement("button");return e.id=_t,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Schedule this buyer's property walkthrough",e.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=gr();!o||!o.locationId||o.oppId!==t||$b(o.oppId,o.locationId)}),e},Cb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Ab=async()=>{for(let t of Cb)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},yr=!1,Jn=async()=>{if(!yr){yr=!0;try{await Lb()}finally{yr=!1}}},Lb=async()=>{let t=gr();if(!t||!t.locationId){document.getElementById(_t)?.remove(),document.getElementById(`${_t}-wrap`)?.remove(),vo();return}let e=document.getElementById(_t);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${_t}-wrap`)?.remove(),vo());return}e&&(e.remove(),document.getElementById(`${_t}-wrap`)?.remove());let o=await Ab();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=gr();if(!a||a.oppId!==t.oppId)return;let s=Tb(t.oppId),i=document.createElement("span");i.id=`${_t}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Sb(t.oppId)},_o=null,Yn=null,ke,vo=()=>{_o?.disconnect(),_o=null,Yn=null,ke!==void 0&&(window.clearTimeout(ke),ke=void 0)},Sb=t=>{if(_o&&Yn===t)return;vo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Yn=t,_o=new MutationObserver(()=>{ke===void 0&&(ke=window.setTimeout(()=>{ke=void 0;let o=gr();if(!o||o.oppId!==t){vo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(_t)?.remove(),document.getElementById(`${_t}-wrap`)?.remove(),vo();return}document.getElementById(_t)||Jn()},250))}),_o.observe(e,{childList:!0,subtree:!0}))},Ib=()=>{Y("schedule-walkthrough",tt,()=>{!document.getElementById(_t)&&!yr&&Jn()})},Mi=()=>{Ib(),Jn()};var Mb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",Ee="ws-crm-resend-deal-link-wrap",Pb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ob=/\/v2\/location\/([A-Za-z0-9]+)/,xr=()=>{let t=window.location.pathname,e=t.match(Pb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Ob);return{oppId:o,locationId:r?r[1]:null}},Bb=async t=>{let e=await fetch(Mb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Rb=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Pi=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,Zn=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=R,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Pi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>Hb(t,e)),t.appendChild(o)},Hb=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Db(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>Zn(t,e)),o.appendChild(i),t.appendChild(o)},Db=async(t,e,o,r)=>{let a=xr();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await Bb({oppId:a.oppId,locationId:a.locationId,channel:o,userId:H()});if(s?.ok)r.innerHTML=`${Pi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Rb(i)}</span>`}window.setTimeout(()=>Zn(t,e),3500)}},Fb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],zb=async()=>{for(let t of Fb)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},fr=!1,Xn=async()=>{if(!fr){fr=!0;try{await Nb()}finally{fr=!1}}},Nb=async()=>{let t=xr();if(!t||!t.locationId){document.getElementById(Ee)?.remove(),go();return}let e=document.getElementById(Ee);if(e&&e.dataset.oppId===t.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(e.remove(),go());return}e&&e.remove();let o=await zb();if(!o)return;let r=await et();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=xr();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=Ee,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",J(o).appendChild(s),Zn(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),qb(t.oppId)},yo=null,Qn=null,go=()=>{yo?.disconnect(),yo=null,Qn=null},qb=t=>{if(yo&&Qn===t)return;go();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Qn=t,yo=new MutationObserver(()=>{let o=xr();if(!o||o.oppId!==t){go();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(Ee)?.remove(),go();return}document.getElementById(Ee)||Xn()}),yo.observe(e,{childList:!0,subtree:!0}))},Ub=()=>{Y("resend-deal-link",tt,()=>{!document.getElementById(Ee)&&!fr&&Xn()})},Oi=()=>{Ub(),Xn()};var jb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",ft="ws-crm-reduce-price-button",Bi="ws-crm-reduce-price-modal",Wb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Gb=/\/v2\/location\/([A-Za-z0-9]+)/,Er=()=>{let t=window.location.pathname,e=t.match(Wb);if(!e)return null;let o=t.match(Gb);return{oppId:e[1],locationId:o?o[1]:null}},Kb=async t=>{let e=await fetch(jb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},wr=()=>{document.getElementById(Bi)?.remove()},Vb=t=>{wr();let e=document.createElement("div");e.id=Bi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-reduce-price-input"),a=o.querySelector("#ws-reduce-error"),s=o.querySelector("#ws-reduce-cancel"),i=o.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let d=l=>{l.key==="Enter"?(l.preventDefault(),i?.click()):l.key==="Escape"&&(l.preventDefault(),s?.click())};o.addEventListener("keydown",d),e.addEventListener("click",l=>{l.target===e&&wr()}),s?.addEventListener("click",()=>{wr()}),i?.addEventListener("click",async()=>{if(!r||!a||!i)return;let l=r.value.trim();if(!l){a.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(l);if(!Number.isFinite(c)||c<=0){a.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){a.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}a.textContent="",i.disabled=!0,i.textContent="Reducing\u2026",i.style.opacity="0.7",s&&(s.disabled=!0);try{await Kb({oppId:t.oppId,locationId:t.locationId,newPrice:c,userId:H()}),wr(),t.onSuccess()}catch(m){p.error("Reduce Price webhook failed",m),a.textContent=m instanceof Error?m.message:"Something went wrong. Try again.",i.disabled=!1,i.textContent="Reduce Price",i.style.opacity="1",s&&(s.disabled=!1)}})},Yb=(t,e)=>{let o=document.createElement("button");return o.id=ft,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Set a new listing price and notify active + previously-withdrew buyers",o.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Er();!r||!r.locationId||r.oppId!==t||Vb({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=R,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},Jb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Qb=async()=>{for(let t of Jb)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},kr=!1,ea=async()=>{if(!kr){kr=!0;try{await Zb()}finally{kr=!1}}},Zb=async()=>{let t=Er();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await Qb();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=Er();if(!a||a.oppId!==t.oppId)return;let s=Yb(t.oppId,t.locationId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),Xb(t.oppId)},fo=null,ta=null,$e,xo=()=>{fo?.disconnect(),fo=null,ta=null,$e!==void 0&&(window.clearTimeout($e),$e=void 0)},Xb=t=>{if(fo&&ta===t)return;xo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ta=t,fo=new MutationObserver(()=>{$e===void 0&&($e=window.setTimeout(()=>{$e=void 0;let o=Er();if(!o||o.oppId!==t){xo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),xo();return}document.getElementById(ft)||ea()},250))}),fo.observe(e,{childList:!0,subtree:!0}))},th=()=>{Y("reduce-price",tt,()=>{!document.getElementById(ft)&&!kr&&ea()})},Ri=()=>{th(),ea()};var Te="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",$r="deals.reinvestos.com";var xt="ws-crm-edit-landing-button",eh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,oh=/\/v2\/location\/([A-Za-z0-9]+)/,Cr=()=>{let t=window.location.pathname,e=t.match(eh);if(!e)return null;let o=t.match(oh);return{oppId:e[1],locationId:o?o[1]:null}},rh=(t,e)=>{let o=new URL(`https://${$r}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Te);let r=H();return r&&o.searchParams.set("user",r),o.toString()},nh=(t,e)=>{let o=document.createElement("button");return o.id=xt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Cr();if(!r||!r.locationId||r.oppId!==t)return;if(!Te){p.warn("[edit-landing] editor session key not configured in this build");return}let a=rh(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},ah=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],sh=async()=>{for(let t of ah)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Tr=!1,ra=async()=>{if(!Tr){Tr=!0;try{await ih()}finally{Tr=!1}}},ih=async()=>{let t=Cr();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await sh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Cr();if(!a||a.oppId!==t.oppId)return;let s=nh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),lh(t.oppId)},wo=null,oa=null,Ce,ko=()=>{wo?.disconnect(),wo=null,oa=null,Ce!==void 0&&(window.clearTimeout(Ce),Ce=void 0)},lh=t=>{if(wo&&oa===t)return;ko();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(oa=t,wo=new MutationObserver(()=>{Ce===void 0&&(Ce=window.setTimeout(()=>{Ce=void 0;let o=Cr();if(!o||o.oppId!==t){ko();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),ko();return}document.getElementById(xt)||ra()},250))}),wo.observe(e,{childList:!0,subtree:!0}))},dh=()=>{Y("edit-landing-page",tt,()=>{!document.getElementById(xt)&&!Tr&&ra()})},Hi=()=>{dh(),ra()};var zi="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Le="ws-crm-publish-button",Eo="ws-crm-publish-wrap",Lr="ws-crm-publish-dropdown",ch=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,ph=/\/v2\/location\/([A-Za-z0-9]+)/,na=()=>{let t=window.location.pathname,e=t.match(ch);if(!e)return null;let o=t.match(ph);return{oppId:e[1],locationId:o?o[1]:null}},Di=async(t,e)=>{try{let o=await fetch(zi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:H()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},mh=async(t,e)=>{let o=await fetch(zi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:H()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},bh=(t,e)=>{if(!Te){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${$r}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Te);let r=H();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Lr)?.remove()},Fi=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Lr;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
    ...
    padding: 14px 16px;
    font-family: ${b.sans};
  `;let d=t.length,l=t.filter(f=>f.filled).length,c=l===d,m=document.createElement("div");m.innerHTML=`
    <div style="
  ...
  `;let r={status:"checking"};Wt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let u=await Di(t,e);if(!u||!Array.isArray(u.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Wt(o,r);return}r={status:u.published?"published":u.ready?"ready":"incomplete",checks:u.checks},Wt(o,r),document.getElementById(Lr)&&r.checks&&Fi(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Wt(o,r),Bt();try{if((await Di(t,e))?.published){r={status:"published"},Wt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let x=await mh(t,e);if(x.ok&&x.published)r={status:"published"},Wt(o,r),p.info(`[publish] published opp ${t}`);else if(x.missing&&x.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Wt(o,r);else throw new Error(x.error||"Publish failed")}catch(u){let x=u instanceof Error?u.message:"Publish failed";p.error("[publish] publish failed",u),r={status:"error",message:x.length>28?"Error \u2014 try again":x},Wt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Lr)?Bt():r.checks&&Fi(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),h=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",h);let v=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",h),window.clearInterval(v))},5e3);return o},uh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_h=async()=>{for(let t of uh)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ar=!1,sa=async()=>{if(!Ar){Ar=!0;try{await vh()}finally{Ar=!1}}},vh=async()=>{let t=na();if(!t||!t.locationId){document.getElementById(Le)?.remove(),document.getElementById(Eo)?.remove(),Bt(),To();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(Eo)?.remove(),Bt(),To());return}e&&(e.remove(),document.getElementById(Eo)?.remove(),Bt());let o=await _h();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=na();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=hh(t.oppId,a.locationId),i=document.createElement("span");i.id=Eo,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),J(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),yh(t.oppId)},$o=null,aa=null,Ae,To=()=>{$o?.disconnect(),$o=null,aa=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},yh=t=>{if($o&&aa===t)return;To();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(aa=t,$o=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=na();if(!o||o.oppId!==t){To();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Le)?.remove(),document.getElementById(Eo)?.remove(),Bt(),To();return}document.getElementById(Le)||sa()},250))}),$o.observe(e,{childList:!0,subtree:!0}))},gh=()=>{Y("publish-button",tt,()=>{!document.getElementById(Le)&&!Ar&&sa()})},Ni=()=>{gh(),sa()};var qi="data:image/png;base64,",Ui="data:image/png;base64,";var fh=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],ji=t=>`ws-crm-map-links-${t}`,Wi=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),Sr=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},Gi=(t,e=Wi())=>{let o=Sr(e,t.addr),r=Sr(e,t.city),a=Sr(e,t.state),s=Sr(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},xh=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,wh=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,kh=(t,e)=>{let{full:o,hasAny:r}=Gi(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Eh=t=>{let e=document.createElement("span");e.id=ji(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),kh(t,i)}),d};return e.appendChild(r(qi,"Open in Google Maps",xh)),e.appendChild(r(Ui,"Search on Zillow",wh)),e},$h=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Ki=()=>{let t=Wi();if(t.length)for(let e of fh){if(document.getElementById(ji(e.key)))continue;let{hasAny:o}=Gi(e,t);if(!o)continue;let r=$h(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Eh(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},Se=null,Ie,Th=()=>{let t=ue();return t==="contact-detail"||t==="other"},Ch=()=>{Se||(Se=new MutationObserver(()=>{Ie===void 0&&(Ie=window.setTimeout(()=>{Ie=void 0;try{Ki()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Se.observe(document.body,{childList:!0,subtree:!0}))},Vi=()=>{Se&&(Se.disconnect(),Se=null),Ie!==void 0&&(window.clearTimeout(Ie),Ie=void 0)},Yi=()=>{if(!Th()){Vi();return}Ch(),Ki()},Ji=()=>{Vi()};var Qi="ws-crm-hide-launchpad",ia=/\/launchpad\/?$/,la=()=>{if(!_e()){if(!document.getElementById(Qi)){let t=document.createElement("style");t.id=Qi,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ia.test(location.pathname)){let t=location.pathname.replace(ia,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!ia.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Ah=[{label:"Buy-Box Entries"},{label:"Memberships"}],Zi=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},da=()=>{let t=_e(),e=new Set(Ah.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){Zi(e);for(let o of[150,500,1200,2500])setTimeout(()=>Zi(e),o)}};var Lh=[{from:"Payments",to:"Contracts"}],Sh=".nav-title, .topmenu-navtitle",Xi=()=>{document.querySelectorAll(Sh).forEach(t=>{let e=(t.textContent||"").trim(),o=Lh.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},ca=()=>{Xi();for(let t of[150,500,1200,2500])setTimeout(Xi,t)};var tl="/payments/proposals-estimates",Ih=/\/payments\/invoices\/?$/,Mh=/\/payments\//,Ph='#sb_payments, a[meta="payments"]',ol=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(tl)&&!(t>3&&!Mh.test(e))){if(Ih.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(tl));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>ol(t+1),120)}},el=!1,Oh=()=>{el||(el=!0,document.addEventListener("click",t=>{t.target?.closest?.(Ph)&&setTimeout(()=>ol(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},pa=()=>{Oh()};var rl=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],nl="ws-crm-hide-topmenu-tabs",ma=()=>{if(document.getElementById(nl))return;let t=rl.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=nl,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${rl.length} top tabs`)};var il="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Gt="ws-crm-send-to-closing-office-button",se="ws-crm-send-to-title-co-wrap",Pr="ws-crm-stc-dropdown",Bh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Rh=/\/v2\/location\/([A-Za-z0-9]+)/,Lo=()=>{let t=window.location.pathname,e=t.match(Bh);if(!e)return null;let o=t.match(Rh);return{oppId:e[1],locationId:o?o[1]:null}},Hh=5*60*1e3,ua=t=>`ws-crm-stc-cache:${t}`,Dh=t=>{try{let e=window.localStorage.getItem(ua(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>Hh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Fh=(t,e)=>{try{window.localStorage.setItem(ua(t),JSON.stringify(e))}catch{}},ll=t=>{try{window.localStorage.removeItem(ua(t))}catch{}},ba="ws-crm:opp-fields-updated",dl=t=>{if(t){ll(t);try{window.dispatchEvent(new CustomEvent(ba,{detail:{oppId:t}}))}catch{}}},zh=async(t,e)=>{try{let o=await fetch(il,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Nh=async(t,e,o)=>{let r=await fetch(il,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},qh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},al=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Uh=(t,e)=>{if(e&&qh(e)){window.setTimeout(()=>al(t),300);return}al(t)},wt=()=>{document.getElementById(Pr)?.remove()},Ir=(t,e,o)=>{wt();let r=document.createElement("div");r.id=Pr;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,r.appendChild(l);let c=["TC","ACQ","MT","DISPO","Property"],m={};t.forEach(u=>{m[u.group]||(m[u.group]=[]),m[u.group].push(u)});let h=[...c.filter(u=>m[u]),...Object.keys(m).filter(u=>!c.includes(u))];for(let u of h){let x=m[u],f=document.createElement("div");f.style.cssText="margin-top: 12px;";let k=document.createElement("div");k.style.cssText=`
      font-family: ${b.mono};
      font-size: 9px;
    ...
    `,k.textContent=u,f.appendChild(k),x.forEach(y=>{let g=document.createElement("div"),$=!y.filled&&y.navigable&&y.field_id;g.style.cssText=`
        ...
        ${$?"cursor: pointer;":""}
        transition: background 0.1s ease;
      `,$&&(g.addEventListener("mouseenter",()=>{g.style.background=n.slate}),g.addEventListener("mouseleave",()=>{g.style.background="transparent"}),g.addEventListener("click",w=>{w.stopPropagation(),y.field_id&&(Uh(y.field_id,y.folder),wt())}));let A=y.filled?`<span style="color: ${n.emerald}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u2713</span>`:`<span style="color: ${n.amber}; font-size: 14px; line-height: 1; flex-shrink: 0;">\u25CB</span>`,T=$?`<span style="margin-left: auto; color: ${n.ash}; font-size: 11px;">\u2192</span>`:"";g.innerHTML=`${A}<span style="flex: 1;">${y.label}</span>${T}`,f.appendChild(g)}),r.appendChild(f)}document.body.appendChild(r);let v=u=>{let x=u.target;!r.contains(x)&&!o.contains(x)&&(wt(),document.removeEventListener("click",v))};window.setTimeout(()=>document.addEventListener("click",v),0)},Lt=(t,e)=>{let o=t.querySelector(".ws-stc-label"),r=t.querySelector(".ws-stc-dot"),a=t.querySelector(".ws-stc-chevron"),s,i,d=n.bone,l,c="Send to Closing Office",m="",h="pointer",v="1";switch(e.status){case"checking":s="transparent",i=n.steel,d=n.ash,l=n.coolGray,c="Checking\u2026",h="wait",v="0.8";break;case"ready":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c=e.previouslySentAt?"Re-send to Closing Office":"Send to Closing Office";break;case"incomplete":{let u=e.checks?.filter(f=>f.filled).length??0,x=e.checks?.length??0;s="transparent",i=n.amber,d=n.amber,l=n.amber,c=`${u} of ${x} Fields Ready`;break}case"sending":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sending\u2026",h="wait",v="0.8";break;case"sent":s=n.emerald,i=n.emerald,d="#0a0e14",l="#0a0e14",c="Sent \u2713";break;case"error":s="transparent",i=n.amber,d=n.amber,l=n.amber,c=e.message??"Try again";break}t.style.background=s,t.style.borderColor=i,t.style.color=d,t.style.cursor=h,t.style.opacity=v,r&&(r.style.background=l,r.style.boxShadow=e.status==="ready"||e.status==="sent"?`0 0 6px ${l}`:""),o&&(o.textContent=c),a&&(a.textContent=m)},jh=(t,e)=>{let o=document.createElement("button");o.id=Gt,o.type="button",o.dataset.oppId=t;let r=Dh(t),a=r?{status:r.checks.every(y=>y.filled)?"ready":"incomplete",checks:r.checks,previouslySentAt:r.previously_sent_at}:{status:"checking"};o.style.cssText=`
    ${R}
    background: transparent;
    border: 1px solid ${n.steel};
    color: ${n.ash};
  ...
  `,Lt(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await zh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},Lt(o,a);return}if(y.rate_limited){u=Date.now()+v,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},Lt(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(u).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},Lt(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let g=y.pipeline_name;if(g&&g!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${g}" (not TC) \u2014 retracting button + caching`),Or.add(t),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt(),Ao();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Fh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:g,ts:Date.now()}),Lt(o,a),document.getElementById(Pr)&&Ir($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},Lt(o,a),wt();try{let g=await Nh(t,e,y);if(g.needs_confirm){a={status:"ready",checks:g.checks,previouslySentAt:g.previously_sent_at},Lt(o,a),g.checks&&Ir(g.checks,g.previously_sent_at,o);return}if(g.ok){a={status:"sent",checks:g.checks,previouslySentAt:new Date().toISOString()},Lt(o,a),window.setTimeout(()=>{f()},3500);return}a={status:"error",checks:g.checks,message:g.error||"Validation failed"},Lt(o,a),g.checks&&Ir(g.checks,g.previously_sent_at,o)}catch(g){p.error("[stc] send failed:",g),a={status:"error",message:"Network error \u2014 click to retry"},Lt(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Pr)?wt():a.checks&&Ir(a.checks,a.previouslySentAt,o);break}case"error":case"sent":f();break}});let l,c=!1,m=Date.now(),h=1e4,v=5*60*1e3,u=0,x=!1,f=async()=>{if(o.isConnected&&(x=!0),x&&!o.isConnected)return;let y=Lo();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<u){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(u).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};f();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let A=Date.now()-m,T=Math.max(1500,h-A);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&f()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let g=A=>{let T=A.detail;if(!T||T.oppId!==t)return;ll(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}f()};E()};window.addEventListener(ba,g);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(ba,g),window.clearInterval($))},5e3)}return o},Wh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Gh=async()=>{for(let t of Wh)try{let e=await M(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Or=new Set,sl=null,Kh=t=>{t&&t!==sl&&(Or.clear(),sl=t)},Mr=!1,_a=async()=>{if(Mr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Mr=!0;try{await Vh()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Mr=!1}},Vh=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Lo();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),Kh(t.oppId),Or.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt();return}let e=document.getElementById(Gt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(se)?.remove(),wt(),Ao());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(se)?.remove(),wt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Gh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Lo();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=jh(t.oppId,a.locationId),i=document.createElement("span");i.id=se,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),J(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),Yh(t.oppId)},Co=null,ha=null,Ao=()=>{Co?.disconnect(),Co=null,ha=null},Yh=t=>{if(Co&&ha===t)return;Ao();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ha=t,Co=new MutationObserver(()=>{let o=Lo();if(!o||o.oppId!==t){Ao();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Gt)?.remove(),document.getElementById(se)?.remove(),wt(),Ao();return}document.getElementById(Gt)||_a()}),Co.observe(e,{childList:!0,subtree:!0}))},Jh=()=>{Y("send-to-closing",tt,()=>{if(document.getElementById(Gt)||Mr)return;let t=Lo();t&&Or.has(t.oppId)||_a()})},cl=()=>{Jh(),_a()};var ga="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",Qh=`${ga}/tc/welcome-call-prefill`,Zh=`${ga}/tc/welcome-call-save`,Xh=`${ga}/tc/order-lockbox`,So="ws-crm-welcome-call-overlay",tu=["Regular Contract","Subject To","Seller Finance","Novation"],eu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],ou=["Gas","Electric","Propane","Oil"],ru=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],nu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Kt=["Yes","No"],au=["Yes","No","Unknown"],su=["Professional Photographer","Seller","Tenant"],iu=["Month-to-Month","Annual"],pl=["Current","Behind"],lu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],St=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Rr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;margin-top:4px;`,hl="margin-bottom:12px;",ul=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,du=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,ml=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=ml(o);return`<select id="${t}" style="${Rr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&ml(a)===r?"selected":""}>${St(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${St(e)}" placeholder="${St(o)}" style="${Rr}">`,cu=(t,e)=>`<textarea id="${t}" rows="3" style="${Rr}resize:vertical;">${St(e)}</textarea>`,pu=(t,e)=>`<input id="${t}" type="date" value="${St(e)}" style="${Rr}">`,F=(t,e)=>`<div style="${hl}"><label style="${ul}">${St(t)}</label>${e}</div>`,va=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${lu.map(r=>`<label style="${du}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${b.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${St(t)}</div>`,Me=()=>{document.getElementById(So)?.remove()},ie=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${_.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${b.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},mu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    ...
    ${Rt("Contract")}
    ${F("Type of Contract",ot("wc-contract_type",tu,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",ot("wc-property_type",ru,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",ot("wc-utilities",eu,t.utilities))}
    ${F("Heat Source",ot("wc-heat_source",ou,t.heat_source))}

    ${Rt("Liens & Permits")}
    ${F("Is there a mortgage?",ot("wc-has_mortgage",Kt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",ot("wc-mortgage_payment_status",pl,t.mortgage_payment_status))}</div>
    ${F("Any other liens? (back taxes, code violations, HELOC, etc.)",ot("wc-has_other_liens",Kt,t.has_other_liens))}
    ${F("Any open or expired permits?",ot("wc-has_permit_issues",Kt,t.has_permit_issues))}
    ${F("Is the property in probate?",ot("wc-in_probate",Kt,t.in_probate))}

    ${Rt("Occupancy")}
    ${F("Property occupancy",ot("wc-occupancy",nu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",ot("wc-tenant_lease_type",iu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",ot("wc-tenant_rent_status",pl,e.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",pu("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Lease on hand?",ot("wc-tenant_lease_on_hand",Kt,e.lease_on_hand))}</div>
        <div style="flex:1;">${F("Security deposit",ct("wc-tenant_security_deposit",e.security_deposit))}</div>
      </div>
      ${F("Selling with tenant in place?",ot("wc-selling_with_tenant",Kt,t.selling_with_tenant))}
    </div>

    ${Rt("HOA")}
    ${F("Part of an HOA?",ot("wc-in_hoa",Kt,t.in_hoa))}
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",ot("wc-hoa_rental_restriction",au,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",ot("wc-photos_provided_by",su,t.photos_provided_by))}
    <div style="${hl}">
      <label style="${ul}">Seller availability for the shoot <span style="color:${n.coolGray};text-transform:none;letter-spacing:0;">(daylight hours \u2014 TC confirms the exact time with the vendor)</span></label>
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${va("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${va("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${va("photos_avail_evenings",t.photos_avail_evenings)}
    </div>

    ${Rt("Lockbox")}
    ${F("Lockbox needed?",ot("wc-lockbox_needed",Kt,t.lockbox_needed))}
    ...
    <div id="wc-lockbox-detail" style="display:none;">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:2px;">
        <button type="button" id="wc-order-lockbox" style="background:transparent;border:1px solid ${n.steel};color:${n.bone};border-radius:${_.sm};padding:8px 14px;font-size:12px;font-weight:500;font-family:${b.sans};cursor:pointer;flex-shrink:0;">${Br(t).on?"Re-order Lockbox":"Order Lockbox"}</button>
        <span id="wc-lockbox-status" style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:${Br(t).on?n.emerald:n.ash};"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${Br(t).on?n.emerald:n.amber};flex-shrink:0;"></span>${Br(t).text}</span>
      </div>
    </div>

    ${Rt("Notes")}
    ${F("Welcome call notes (lien/permit specifics, HOA contact + docs, probate/deed status, anything else)",cu("wc-welcome_call_notes",t.welcome_call_notes))}
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},ya=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),bl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},Br=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?St(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},bu=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:ya("photos_avail_mornings"),photos_avail_afternoons:ya("photos_avail_afternoons"),photos_avail_evenings:ya("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),hu=t=>{Me();let e=document.createElement("div");e.id=So,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${b.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    <style>#${So} input[type="date"]::-webkit-calendar-picker-indicator,#${So} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
    ...
    <div style="padding:8px 20px 16px;">${mu(t)}</div>
  ...
  `,e.appendChild(o),document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&Me()}),document.getElementById("wc-close")?.addEventListener("click",Me),document.getElementById("wc-cancel")?.addEventListener("click",Me),["wc-has_mortgage","wc-in_hoa","wc-lockbox_needed","wc-occupancy"].forEach(s=>{document.getElementById(s)?.addEventListener("change",bl)}),bl();let r=document.getElementById("wc-save");r?.addEventListener("click",async()=>{if(!I("wc-occupancy")){ie("Set the property occupancy before completing.","err");return}r.textContent="Saving\u2026",r.style.opacity="0.8",r.disabled=!0;try{(await fetch(Zh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(bu(t)),credentials:"omit"})).ok?(Me(),ie("Welcome call saved \u2014 deal advanced to Scheduling Photos \u2713")):(r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,ie("Save failed \u2014 try again.","err"))}catch(s){p.warn("[welcome-call] save failed:",s),r.textContent="Complete Welcome Call",r.style.opacity="1",r.disabled=!1,ie("Couldn't reach the save handler. Try again.","err")}});let a=document.getElementById("wc-order-lockbox");a?.addEventListener("click",async()=>{if(!window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed."))return;let s=document.getElementById("wc-lockbox-status");a.disabled=!0,a.textContent="Ordering\u2026";try{(await fetch(Xh,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,ship_to:I("wc-lockbox_mailing_address")||t.deal_address||"",recipient_name:I("wc-lockbox_recipient_name"),recipient_phone:I("wc-lockbox_recipient_phone"),source:"welcome-call"}),credentials:"omit"})).ok?(a.textContent="Re-order Lockbox",a.disabled=!1,s&&(s.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>\u2713 Ordered just now`,s.style.color=n.emerald),ie("Lockbox order sent to ops \u2713")):(a.textContent="Order Lockbox",a.disabled=!1,ie("Lockbox order failed \u2014 try again.","err"))}catch(i){p.warn("[welcome-call] order lockbox failed:",i),a.textContent="Order Lockbox",a.disabled=!1,ie("Couldn't reach the lockbox handler. Try again.","err")}})},_l=async(t,e)=>{Me();let o=document.createElement("div");o.id=So,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;color:${n.ash};font-family:${b.sans};font-size:14px;`,o.textContent="Loading welcome call\u2026",document.body.appendChild(o);let r={ok:!0,opp_id:t,tenant_id:e};try{let a=await fetch(`${Qh}?tc_opp_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,{method:"GET",headers:{Accept:"application/json"},credentials:"omit"});if(a.ok){let s=await a.json();r={...s,opp_id:s.opp_id||t,tenant_id:e}}else p.warn(`[welcome-call] prefill returned ${a.status} \u2014 opening blank`)}catch(a){p.warn("[welcome-call] prefill fetch failed \u2014 opening blank:",a)}r.tenant_id=e,hu(r)};var $a="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",uu=`${$a}/tc/confirm-photo-appointment`,_u=`${$a}/tc/order-lockbox`,vu=`${$a}/tc/welcome-call-prefill`,wa="ws-crm-opp-action-bar",yl="ws-crm-opp-overflow",gl="ws-crm-opp-action-menu",ka="ws-crm-opp-action-popover",fl="ws-crm-reorder-lockbox-modal",xl=".hr-card.hr-modal.crm-opportunities-modal",yu=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,gu=/\/v2\/location\/([A-Za-z0-9]+)/,wl="Welcome Call Needed",Ta="Scheduling Photos",kl="Photos Scheduled",fu=[wl,Ta,kl,"Photos Received","Marketing Deal","Assigned","EMD Received","Clear to Close","Funded","Lost"],El=()=>{let t=window.location.pathname,e=t.match(yu);if(!e)return null;let o=t.match(gu);return o?{oppId:e[1],locationId:o[1]}:null},xu=()=>{let t=document.querySelector(xl);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(fu.includes(r))return r}return null},Yt=()=>{document.getElementById(gl)?.remove(),document.getElementById(ka)?.remove(),document.getElementById(fl)?.remove()},fa=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Vt=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},wu=t=>{_l(t.oppId,t.locationId)},ku=async(t,e,o)=>(await fetch(_u,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Eu=(t,e)=>{Yt();let o=document.createElement("div");o.id=fl,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${b.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${_.sm};color:${n.bone};font-family:${b.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${fa(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${fa(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${fa(i)}</textarea>
  ...
  `,o.appendChild(r),document.body.appendChild(o);let d=()=>o.remove();o.addEventListener("click",c=>{c.target===o&&d()}),document.getElementById("wsrl-cancel")?.addEventListener("click",d);let l=document.getElementById("wsrl-submit");l?.addEventListener("click",async()=>{let c=document.getElementById("wsrl-name")?.value.trim()||"",m=document.getElementById("wsrl-phone")?.value.trim()||"",h=document.getElementById("wsrl-address")?.value.trim()||"";if(!c||!h){Vt("Add a recipient name and shipping address.","err");return}if(window.confirm("Order a lockbox for this deal now? The lockbox will be charged to the default credit card on file. This cannot be reversed.")){l.disabled=!0,l.textContent="Ordering\u2026";try{await ku(t,e,{recipient_name:c,recipient_phone:m,ship_to:h})?(d(),Vt("Lockbox re-order sent to ops \u2713")):(l.disabled=!1,l.textContent="Order Lockbox",Vt("Re-order failed \u2014 try again.","err"))}catch(v){p.warn("[action-bar] reorder lockbox failed:",v),l.disabled=!1,l.textContent="Order Lockbox",Vt("Couldn't reach the lockbox handler. Try again.","err")}}})},$l=async t=>{Yt();let e={};try{e=await fetch(`${vu}?tc_opp_id=${encodeURIComponent(t.oppId)}&tenant_id=${encodeURIComponent(t.locationId)}`,{credentials:"omit"}).then(o=>o.json())}catch{}Eu(t,e)},$u=(t,e)=>{Yt();let o=document.createElement("div");o.id=ka;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    font-family: ${b.sans};
  `,o.innerHTML=`
    <style>#${ka} input[type="datetime-local"]::-webkit-calendar-picker-indicator{filter:invert(48%) sepia(99%) saturate(1200%) hue-rotate(190deg);cursor:pointer;opacity:1}</style>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Vt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(uu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Yt(),Vt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Vt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Vt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Yt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},Tu=(t,e)=>{Yt();let o=document.createElement("div");o.id=gl;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${_.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${b.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${_.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Yt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Dr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=R,o.textContent=t,o},Cu=()=>{let t=Dr("\u22EE","ghost");return t.style.lineHeight="1",t},Au=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===wl){let r=Dr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>wu(t)),o.appendChild(r),o}if(e===Ta){let r=Dr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>$u(t,r)),o.appendChild(r),o}if(e===kl){let r=Dr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void $l(t)),o.appendChild(r),o}return null},Lu=(t,e)=>{let o=[];if(e===Ta&&(o=[{label:"Re-order Lockbox",onClick:()=>void $l(t)}]),!o.length)return null;let r=document.createElement("span");r.id=yl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Cu();return a.addEventListener("click",s=>{s.stopPropagation(),Tu(o,a)}),r.appendChild(a),r},Su=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Iu=async()=>{for(let t of Su)try{let e=await M(t,{timeoutMs:1200});if(e)return e}catch{}return null},Hr=()=>{document.getElementById(wa)?.remove(),document.getElementById(yl)?.remove(),Yt()},Fr=!1,Ca=async()=>{if(!Fr){Fr=!0;try{let t=El();if(!t){Hr();return}let e=z();if(e===null)return;if(e!=="Transaction Coordination"){Hr();return}let o=xu(),r=document.getElementById(wa);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Au(t,o);if(!a){Hr();return}let s=await Iu();if(!s)return;Hr();let i=J(s),d=document.createElement("span");d.id=wa,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Lu(t,o);l&&i.appendChild(l),Mu(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{Fr=!1}}},Io=null,Ea=null,xa,vl=()=>{Io?.disconnect(),Io=null,Ea=null},Mu=t=>{if(Io&&Ea===t)return;vl();let e=document.querySelector(xl);e&&(Ea=t,Io=new MutationObserver(()=>{let o=El();if(!o||o.oppId!==t){vl();return}xa===void 0&&(xa=window.setTimeout(()=>{xa=void 0,Ca()},250))}),Io.observe(e,{childList:!0,subtree:!0}))},Pu=()=>{Y("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{Fr||Ca()})},Tl=()=>{Pu(),Ca()};var Cl="ws-support-modal",Al="ws-support-toast",Ou="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Ll="ws-support-submitter-name",Sl="ws-support-submitter-email",Il="ws-support-submitter-role",Bu=["Bug","Feature Request","Question","Billing","Onboarding Help"],le=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ru=(t,e="success",o)=>{let r=document.getElementById(Al);r&&r.remove();let a=document.createElement("div");a.id=Al;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},Hu=()=>{document.getElementById(Cl)?.remove();let t=(localStorage.getItem(Ll)??"").trim(),e=(localStorage.getItem(Sl)??"").trim(),o=(localStorage.getItem(Il)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Cl,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${b.sans};
  ...
  `;s.innerHTML=`
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
      <div>
        ...
        <input id="ws-support-name" type="text" value="${le(t)}" placeholder="Your full name" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
      </div>
      <div>
        <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Email</div>
        <input id="ws-support-email" type="email" value="${le(e)}" placeholder="you@company.com" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
      </div>
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Your Role (optional)</div>
      <input id="ws-support-role" type="text" value="${le(o)}" placeholder="ACQ Rep / Manager / Owner / etc" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
    </div>

    <div style="margin-bottom: 12px;">
      <div style="font-size: 12px; font-weight: 500; color: ${n.bone}; margin-bottom: 6px;">Title</div>
      <input id="ws-support-title" type="text" placeholder="Short summary" style="width: 100%; box-sizing: border-box; padding: 8px 12px; background: ${n.obsidian}; color: ${n.bone}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; font-family: ${b.sans}; font-size: 13px;">
    </div>
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=h=>{d&&(d.textContent=h)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=Q();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Ll,r.submitterName),localStorage.setItem(Sl,r.submitterEmail),r.submitterRole&&localStorage.setItem(Il,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let v=await(await fetch(Ou,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:H()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!v.ok){l(v.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let u=v.ticket_short_id||"submitted";Ru(`Ticket ${u} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(h){l(`Network error: ${h.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Du=["/support-ticket","ws-support-modal","ws-support"],Fu=/\/custom-menu-link\//,Aa=!1,Ml=()=>{if(Aa||!Fu.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Du.some(i=>s.includes(i))});if(r){Aa=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{Hu(),Aa=!1},50);return}t<10&&setTimeout(e,150)};e()},Pl=!1,Ol=()=>{Pl||(Pl=!0,Et(()=>setTimeout(Ml,50)),Ml(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Bl="ws-phone-assignments-modal",Rl="ws-phone-assignments-toast",zu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Nu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",qu=["ACQ","DISPO","TC"],Fl="",Jt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Uu=(t,e="success",o)=>{document.getElementById(Rl)?.remove();let r=document.createElement("div");r.id=Rl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Jt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Jt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},ju=(t,e,o)=>{let r=[`<option value="" ${o===Fl?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Jt(a)}" ${o===a?"selected":""}>${Jt(a)}</option>`)].join("");return`<select data-assign="${Jt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${_.sm};
    font-family: ${b.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Wu=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Sa=async t=>{document.getElementById(Bl)?.remove();let e=t||Q(),o=document.createElement("div");o.id=Bl,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",v=>{v.target===o&&o.remove()}),!e){let v=r.querySelector("#ws-pa-body");v&&(v.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${zu}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(v){p.error("[phone-assignments] GET failed",v);let u=r.querySelector("#ws-pa-body");u&&(u.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Jt(v.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:qu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=v=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${v} found.</div>`,c=i.length?i.map(v=>`<div style="${Wu}">
            <div style="min-width:0;">
              <div style="color:${n.bone};font-size:13px;font-weight:500;">${Jt(v.label||v.e164)}</div>
              <div style="color:${n.coolGray};font-size:11px;font-family:${b.mono};">${Jt(v.e164)}</div>
            </div>
            ${ju(`num:${v.e164}`,s,d[v.e164]??Fl)}
    ...
    </div>`,h.querySelectorAll("select[data-assign]").forEach(v=>{v.addEventListener("change",()=>{let u=v.getAttribute("data-assign")||"",[x,...f]=u.split(":"),k=f.join(":");x==="num"&&(v.value?d[k]=v.value:delete d[k])})}),h.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),h.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let v=h.querySelector("#ws-pa-err"),u=f=>{v&&(v.textContent=f)};u("");let x=h.querySelector("#ws-pa-save");x&&(x.disabled=!0,x.textContent="Saving\u2026",x.style.opacity="0.7");try{let k=await(await fetch(Nu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){u(k.error||"Save failed."),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1");return}o.remove(),Uu("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(f){u(`Network error: ${f.message}`),x&&(x.disabled=!1,x.textContent="Save",x.style.opacity="1")}}))},Gu=["ws-phone-assignments","phone-assignments"],Ku=/\/custom-menu-link\//,La=!1,Hl=()=>{if(La||!Ku.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Gu.some(i=>s.includes(i))});if(r){La=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Sa(s),La=!1},50);return}t<10&&setTimeout(e,150)};e()},Dl=!1,zl=()=>{if(Dl)return;Dl=!0,Et(()=>setTimeout(Hl,50)),Hl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Sa()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Sa(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Nl="powerDialerApp",Vu=".dialer",Yu='button[aria-label="Voice Calling"], button[title="Voice Calling"]',Ju=".dial-item.dial-btn.dial-btn-enabled",Pe=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},Qu=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},Ia=()=>{try{let e=window[Nl]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},Oe=()=>document.querySelector(Vu),zr=()=>Ia()!==null||Oe()!==null?!0:!!window[Nl],Nr=(t,e)=>{let o=Ia();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},ql=()=>{if(Oe())return;let t=document.querySelector(Yu);t?Pe(t):p.warn("[dialer-bridge] Voice Calling button not found")},Zu=()=>{let t=document.querySelector(".number-list-container")||Oe();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Ma=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?Qu(t.innerText):null},Ul=(t,e)=>{if(Ma()===t)return!0;let o=Ia();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Pe(r);let a=Zu(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Pe(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},jl=t=>{let e=t.replace(/[^\d*#+]/g,"");if(Nr("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Pe(a)}},Wl=()=>{let t=Oe();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(Ju)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Pe(e),!0):Nr("makeCall",{provider:"twilio"})};var Pa=()=>{let t=Oe();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Pe(e.closest("button")||e):Nr("closeCallBox")},Gl=()=>{Nr("closeCallBox")},Kl=t=>{let e=!1,o=()=>{let s=Oe()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var Xu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",t_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Vl=["acq","dispo","tc"],Po={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Mo=null,Yl=null,e_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=Q();if(!o)return e;if(!t&&Mo&&Yl===o)return Mo;try{let a=await(await fetch(`${Xu}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Mo={numberTeam:a?.config?.numberTeam??{},numberLabel:s},Yl=o,Mo}catch(r){return p.warn("[silo] config load failed",r),Mo??e}},de=null,Jl=null,Oa=async(t=!1)=>{let e=Q(),o=H();if(!e||!o)return[];if(!t&&de&&Jl===e)return de;try{let s=(await(await fetch(t_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];de=Vl.filter(d=>i.includes(d))}else _e()?de=[...Vl]:de=[];return Jl=e,de}catch(r){return p.warn("[silo] roster load failed",r),de??[]}},Zl=()=>`ws-pd-calling-as:${H()||"anon"}`,Xl=t=>{try{localStorage.setItem(Zl(),t)}catch{}},Ba=async()=>{let t=await Oa();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(Zl())}catch{}return e&&t.includes(e)?e:t[0]},Ql=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},o_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),td=async t=>{let e=await Ba();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await e_(),a=o_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=Ql(t),i=s?a.find(m=>Ql(m)===s):void 0,d=i||a[0];if(!Ul(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Po[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Ma();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var r_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ed="data-ws-pd",od="ws-crm-pd-panel",rd="ws-crm-pd-session",Qt=t=>new Promise(e=>setTimeout(e,t)),Oo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),n_=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},a_=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},s_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},i_=async t=>{let e=n_(t);if(!e)return[];let o=a_(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Qt(550)}return o.scrollTop=0,s_(e)},l_=async(t,e)=>{try{let r=await(await fetch(r_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},d_=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${b.sans};`,Ha=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(od)?.remove();let r=document.createElement("div");r.id=od,r.style.cssText=d_;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((f,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
        <input type="checkbox" class="ws-pd-cb" data-i="${k}" checked style="width:15px;height:15px;accent-color:${n.emerald};" />
        <span style="font-size:13px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Oo(f.name||f.contactId)}</span>
    ...
    <div style="font-size:14px;font-weight:600;margin:2px 0 2px;">${Oo(t)}</div>
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      <div style="font-size:12px;color:${n.ash};margin:4px 0;">${Oo(t)} \xB7 ${l+1} of ${e.length}</div>
      <div style="font-size:14px;font-weight:600;margin-bottom:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${Oo(c)}</div>
      <div style="font-size:12px;color:${n.ash};min-height:16px;margin-bottom:8px;">${Oo(d)}</div>
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Pa()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Pa()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await l_(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Qt(1200);continue}let h=l._phone||m?.phone||"",v=m?.name||l.name;if(!h){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Qt(1400);continue}if(await td(h),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let x=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==x&&(history.pushState({},"",x),window.dispatchEvent(new PopStateEvent("popstate")))}catch(u){p.debug("[bulk-dialer] screen-follow nav failed",u)}i(`Calling ${h}\u2026`,d,v);try{ql(),await Qt(250),jl(h),await Qt(250),Wl()}catch(u){p.error("[bulk-dialer] dial failed",u)}if(await new Promise(u=>{let x=!1,f=()=>{x||(x=!0,window.clearInterval(y),k(),u())},k=Kl(f),y=window.setInterval(()=>{(a.stopped||a.skip)&&f()},300)}),a.stopped)break;try{Gl()}catch{}if(d<e.length-1)if(o)for(let u=5;u>0&&!a.stopped&&!a.advance;u--){for(i(`Next call in ${u}s\u2026`,d,v);a.paused&&!a.stopped&&!a.advance;)await Qt(200);if(a.advance||a.stopped)break;await Qt(1e3)}else for(i("Ready \u2014 press Call Next",d,v);!a.advance&&!a.stopped;)await Qt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Da='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Fa=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},c_=()=>{if(ue()!=="opportunity-list"||!Fa()||!zr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${ed}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(ed,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${_.pill};cursor:pointer;font-family:${b.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Da}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await i_(e);Ha(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},Be=null,Ra,nd=!1,sd=()=>{if(nd)return;nd=!0,window.WS_CRM_PD_TEST=e=>void ad("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Ra!==void 0&&window.clearTimeout(Ra),Ra=window.setTimeout(c_,400)};Et(e=>{e==="opportunity-list"?(t(),Be||(Be=new MutationObserver(t),Be.observe(document.body,{childList:!0,subtree:!0}))):Be&&(Be.disconnect(),Be=null)})};var id="ws-crm-pd-contacts-btn",p_=t=>new Promise(e=>setTimeout(e,t)),m_=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},b_=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,za=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=m_(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},h_=async t=>{let e=new Map;if(t)return za(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(za(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(za(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await p_(220);return o.scrollTop=0,[...e.values()]},u_=()=>{if(ue()!=="contact-list"||!Fa()||!zr()||document.getElementById(id))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=id,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${_.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${b.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${Da}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=b_(),l=await h_(d);Ha(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},Re=null,Na,ld=!1,dd=()=>{if(ld)return;ld=!0;let t=()=>{Na!==void 0&&window.clearTimeout(Na),Na=window.setTimeout(u_,400)};Et(e=>{e==="contact-list"?(t(),Re||(Re=new MutationObserver(t),Re.observe(document.body,{childList:!0,subtree:!0}))):Re&&(Re.disconnect(),Re=null)})};var __="ws-calling-as-chip",v_=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},qa=!1,ce=null,cd,md=0,y_=3e4,g_=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},Ua=()=>{if(!ce||ce.isConnected)return;let t=g_();t&&t.parent.insertBefore(ce,t.before)},pd=async()=>{if(!(qa||ce)&&v_()){qa=!0;try{let t=await Oa();if(!t.length)return;let e=await Ba()??t[0],o=t.length>1,r=document.createElement("div");r.id=__,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${_.pill};color:${n.bone};font-family:${b.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${b.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Po[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Po[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${b.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Po[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",h=>{h.stopPropagation(),e=l,Xl(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}ce=r,Ua(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{qa=!1,md=Date.now()}}},bd=()=>{ce?Ua():pd(),cd===void 0&&(cd=window.setInterval(()=>{ce?Ua():Date.now()-md>=y_&&pd()},1500))};var f_="#12161D",x_="#EDEEF0",hd=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},ud=t=>{t.style.setProperty("background-color",f_,"important"),t.style.setProperty("color",x_,"important")},w_=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},k_=t=>{hd(t)&&ud(t);for(let e of Array.from(t.querySelectorAll("*")))hd(e)&&ud(e)},ja=null,Bo=null,vd=()=>{Bo&&(Bo.disconnect(),Bo=null),ja=null},E_=t=>{if(ja===t)return;vd(),ja=t;let e=!1,o=()=>{e=!1;try{k_(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Bo=new MutationObserver(r),Bo.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},_d=!1,qr=()=>{if(_d)return;_d=!0;let t=()=>{let o=w_();o?E_(o):vd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var $_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",T_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",C_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",fd="tc_closing_agent",A_="tc_closing_office",kt="ws-crm-closing-agent-picker-button",xd="ws-crm-closing-agent-picker-modal",L_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,S_=/\/v2\/location\/([A-Za-z0-9]+)/,Do=()=>{let t=window.location.pathname,e=t.match(L_);if(!e)return null;let o=t.match(S_);return{oppId:e[1],locationId:o?o[1]:null}},Ja=async t=>{let e=await fetch($_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},yd=async t=>{let e=await fetch(T_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},I_=async(t,e)=>{try{let o=await fetch(C_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:fd}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await Ja({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},pe=null,M_=60*60*1e3,Qa=t=>`ws-crm-to-cache:${t}`,wd=t=>{try{let e=window.localStorage.getItem(Qa(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>M_||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},kd=(t,e,o)=>{try{window.localStorage.setItem(Qa(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},P_=t=>{try{window.localStorage.removeItem(Qa(t))}catch{}},Ga="ws-crm-closing-agent-field-link",O_=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ga}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Wa=!1,Za=async t=>{if(Wa)return;let e=Ed();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Wa=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Ja({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Ka(a.id,a.name,t);let s=document.getElementById(kt);if(s){Zt(s,{status:"linked",contactName:a.name});let i=Do();i&&kd(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Wa=!1}}},B_=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ed=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();B_.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let h=l.getAttribute(m);h&&/Title\s+Officer/i.test(h)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:h})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Ka=(t,e,o)=>{let r=Ed();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Ga}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=Ga,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${_.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},Ur=()=>{document.getElementById(xd)?.remove()},R_=t=>{Ur();let e=document.createElement("div");e.id=xd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&Ur()}),s?.addEventListener("click",Ur);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
        <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
          Start typing to search.
        </div>`;return}a.innerHTML=`
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await Ja({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
          ...
          transition: background 0.1s ease;
        `,v.innerHTML=`
          <div style="font-weight: 500;">${jr(h.name)}</div>
          <div style="color: ${n.ash}; font-size: 11px; margin-top: 2px;">
            ${jr(h.email||"(no email)")} \xB7 ${jr(h.phone||"no phone")}
            ${h.companyName?` \xB7 ${jr(h.companyName)}`:""}
          </div>
        `,v.addEventListener("mouseenter",()=>{v.style.background=n.slate}),v.addEventListener("mouseleave",()=>{v.style.background="transparent"}),v.addEventListener("click",()=>{Ur(),t.onPick(h)}),a.appendChild(v)})}catch(m){p.error("Closing Agent picker search failed",m),a&&(a.innerHTML=`
          <div style="padding: 16px; color: ${n.crimson}; font-size: 13px; text-align: center;">
            Search failed. Try again.
          </div>`)}}};r?.addEventListener("input",()=>{let c=r.value;i!==void 0&&clearTimeout(i),i=window.setTimeout(()=>{l(c)},250)})},jr=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Zt=(t,e)=>{let o=t.querySelector(".ws-top-label"),r=t.querySelector(".ws-top-dot"),a="Link Closing Agent",s=n.amber,i=n.bone,d="transparent",l=n.steel,c="pointer";switch(e.status){case"loading":a="Loading Closing Agent\u2026",s=n.coolGray,i=n.ash,c="wait";break;case"empty":a="Link Closing Agent",s=n.amber;break;case"linked":a=e.contactName?`Closing Agent: ${e.contactName}`:"Closing Agent: \u2713",s=n.emerald,d=n.emeraldGlow,l=n.emeraldBorder,i=n.emeraldBright;break;case"saving":a="Linking\u2026",s=n.coolGray,i=n.ash,c="wait";break}o&&(o.textContent=a),r&&(r.style.background=s,r.style.boxShadow=`0 0 6px ${s}`),t.style.background=d,t.style.borderColor=l,t.style.color=i,t.style.cursor=c},H_=(t,e)=>{let o=document.createElement("button");o.id=kt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Pick the Closing Agent contact for this deal. Their email + phone will flow into the title-co handoff email.",o.innerHTML=`
  ...
  `;let r={status:"loading"};Zt(o,r);let a=wd(t);return a&&(r={status:"linked",contactName:a.contactName},Zt(o,r),pe={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await I_(t,e);i?(r={status:"linked",contactName:i.name},Zt(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ka(i.id,i.name,e)):a||(r={status:"empty"},Zt(o,r),pe?.oppId===t&&(pe=null),O_(),P_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||R_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Zt(o,r);try{let d=await yd({tenantId:e,oppId:t,fieldKey:fd,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await yd({tenantId:e,oppId:t,fieldKey:A_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Zt(o,r),pe={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},kd(t,i.id,i.name),Ka(i.id,i.name,e),dl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Zt(o,r)}}})}),o},D_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],F_=async()=>{for(let t of D_)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ro=!1,Gr=async()=>{if(!Ro){Ro=!0;try{await z_()}finally{Ro=!1}}},z_=async()=>{let t=Do();if(!t||!t.locationId){document.getElementById(kt)?.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Wr();return}let e=document.getElementById(kt);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove(),Wr());return}e&&(e.remove(),document.getElementById(`${kt}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await F_();if(!r||!(wd(t.oppId)!==null||pe!==null&&pe.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=Do();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=H_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${kt}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),J(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),N_(t.oppId),Za(s.locationId)},Ho=null,Va=null,Ya=null,Wr=()=>{Ho?.disconnect(),Ho=null,Va=null,Ya=null},N_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ho&&Va===t&&Ya===e||(Wr(),Va=t,Ya=e,Ho=new MutationObserver(()=>{let o=Do();if(!o||o.oppId!==t||!o.locationId){Wr();return}document.getElementById(kt)||Gr(),Za(o.locationId)}),Ho.observe(e,{childList:!0,subtree:!0})))},q_=()=>{Y("closing-agent-picker",tt,()=>{!document.getElementById(kt)&&!Ro&&Gr()})},gd,U_=()=>{gd===void 0&&(gd=window.setInterval(()=>{let t=Do();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(kt)&&!Ro&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Gr()),Za(t.locationId)},2e3))},$d=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),q_(),U_(),Gr()};var j_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ht="ws-crm-manage-team-cta",Cd="ws-crm-manage-team-modal",W_=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Ad={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},G_={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Ld=()=>{let t=window.location.pathname.match(W_);return t?{tenantId:t[1]}:null},Vr=async t=>{let e=await fetch(j_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},vt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Xt=t=>vt(t),Xa="ws-crm-manage-team-toast",os=(t,e="info",o=4e3)=>{document.getElementById(Xa)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=Xa,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(Xa)===a&&a.remove()},o)},ts=()=>{document.getElementById(Cd)?.remove()},K_=(t,e)=>{let o=G_[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${vt(e)}</span>
  `},V_=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>K_(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
    ...
    ">
      ...
      <div style="display: flex; gap: 8px; justify-content: flex-end; ${a}" ${s}>
        <button class="ws-team-edit" data-email="${Xt(t.email)}" data-user-id="${Xt(t.id)}" data-name="${Xt(o)}" data-current-roles="${Xt(t.role_keys.join(","))}" style="${R} font-size: 11px; padding: 5px 10px;">Edit Roles</button>
        <button class="ws-team-remove" data-email="${Xt(t.email)}" data-name="${Xt(o)}" data-role-count="${Xt(String(t.role_keys.length))}" style="${R} font-size: 11px; padding: 5px 10px; border-color: ${n.crimson}; color: ${n.crimson};">Remove</button>
      </div>
    </div>
  `},Y_=(t,e)=>t.length===0?`
  ...
  `+t.map(r=>V_(r,e)).join(""),Yr=async t=>{ts();let e=document.createElement("div");e.id=Cd,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",ts);let r;try{r=await Vr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+Y_(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{J_(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Q_(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;Z_(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},J_=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${_.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${vt(Ad[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,r.appendChild(a),document.body.appendChild(r),a.querySelector("#ws-team-remove-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#ws-team-remove-submit")?.addEventListener("click",async()=>{let s=a.querySelector("#ws-team-remove-error"),i=a.querySelector("#ws-team-remove-submit");i&&(i.disabled=!0,i.textContent="Removing\u2026",i.style.opacity="0.7"),s&&(s.textContent="");try{let d=await Vr({tenant_id:t,action:"remove",email:e.email,triggered_by_user_id:H()});if(!d.ok){s&&(s.textContent=d.error||"Failed to remove"),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1");return}r.remove(),os(`Removed ${e.name} from the team.`,"success"),await Yr(t)}catch(d){s&&(s.textContent=d.message),i&&(i.disabled=!1,i.textContent="Remove from Team",i.style.opacity="1")}})},X_=89,tv=93,ev=310,ov=34,rv=14,nv=14,av=3,Kr=t=>{let e=document.querySelector('iframe[name="settings-app"]');if(!e){t.style.right="24px";return}let o=e.getBoundingClientRect(),r=window.innerWidth-o.right+X_;t.style.right=`${Math.max(r,16)}px`},sv=t=>{let e=document.createElement("button");return e.id=Ht,e.type="button",e.style.cssText=`
    position: fixed;
    top: ${tv}px;
    right: 24px;
    width: ${ev}px;
  ...
  `,e.addEventListener("click",()=>{Yr(t)}),Kr(e),setTimeout(()=>Kr(e),200),setTimeout(()=>Kr(e),800),iv(),e},Td=!1,iv=()=>{Td||(Td=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Ht);t instanceof HTMLButtonElement&&Kr(t)}))},es=!1,lv=()=>{if(!es){es=!0;try{let t=Ld();if(!t){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}let e=document.getElementById(Ht);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ht}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ht}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=sv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{es=!1}}},Sd=()=>{if(!Ld()){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}lv()};var dv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",as="ws-crm-prepare-contract-button",Id="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",Md="ws-crm-modal-date-style",Dt="https://services.leadconnectorhq.com",Dd=()=>{if(document.getElementById(Md))return;let t=document.createElement("style");t.id=Md,t.textContent=`
  ...
  `,document.head.appendChild(t)},ss="__WS_CRM_CAPTURED_AUTH",cv=50*60*1e3,qo=()=>{try{let t=localStorage.getItem(ss);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>cv?(localStorage.removeItem(ss),null):e:null}catch{return null}},pv=t=>{try{localStorage.setItem(ss,JSON.stringify(t))}catch{}},De=()=>{let t=qo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Pd=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((qo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),He=async(t,e={},o=2)=>{let r=qo()?.capturedAt??0,a;try{a={...De(),...e.headers??{}}}catch(i){if(o>0&&await Pd(r,4e3))return He(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await Pd(r,4e3)?He(t,e,o-1):s},Od=!1,mv=()=>{if(Od)return;Od=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=qo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let h=c.authorization||c.Authorization;if(!h){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let v=c["token-id"]||c["Token-Id"]||void 0,u=qo()?.authorization;pv({authorization:h,tokenId:v,capturedAt:Date.now()}),u!==h&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${h.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let h=m.headers;!h&&l[0]instanceof Request&&(h=l[0].headers);let v={};if(h instanceof Headers)h.forEach((u,x)=>v[x.toLowerCase()]=u);else if(Array.isArray(h))h.forEach(([u,x])=>v[u.toLowerCase()]=x);else if(h&&typeof h=="object")for(let u of Object.keys(h))v[u.toLowerCase()]=h[u];o(c,v,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Fd=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},bv=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Fd()},hv=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},zd="__WS_CRM_TEMPLATES_CACHE_V1",uv=24*60*60*1e3,Bd=t=>{try{let e=window.localStorage.getItem(zd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>uv?null:o.templates}catch{return null}},_v=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(zd,JSON.stringify(o))}catch{}},vv=async t=>{let e=`${Dt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await He(e,{method:"GET"})}catch(i){let d=Bd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=Bd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:hv(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&_v(t,s),s},yv=async(t,e)=>{let o=await He(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await He(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},gv=async(t,e)=>{let o=await He(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:De()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},fv=async t=>{let e=await fetch(dv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},xv=async(t,e,o)=>{let r=`${Dt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:De()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},wv=async(t,e)=>{let o=await fetch(`${Dt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:De()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Nd=async t=>{let e=await fetch(`${Dt}/contacts/${t}`,{method:"GET",headers:De()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},kv=async(t,e,o,r)=>{let a;try{a=await wv(t,e)}catch(u){return{ok:!1,body:`fetchProposalDocument: ${u.message}`}}let s;try{s=await Nd(o)}catch(u){return{ok:!1,body:`fetchContactBasics: ${u.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(u=>u?.entityName!=="contacts"),d],h={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},v=await fetch(`${Dt}/proposals/document/${e}`,{method:"PUT",headers:{...De(),"Content-Type":"application/json"},body:JSON.stringify(h)});if(!v.ok){let u=await v.text().catch(()=>"");return{ok:!1,status:v.status,body:u}}return{ok:!0}},Ev=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Qr="__WS_CRM_PENDING_INSTRUCTIONS",$v=60*1e3,Tv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Cv=t=>{let e=(t||"").toLowerCase();for(let o of Tv)if(e.includes(o.matches.toLowerCase()))return o;return null},Av=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Qr,JSON.stringify(r))}catch{}},Lv=()=>{try{let t=localStorage.getItem(Qr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>$v?(localStorage.removeItem(Qr),null):e}catch{return null}},Sv=()=>{try{localStorage.removeItem(Qr)}catch{}},Iv=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Mv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,Pv=()=>{let t=window.location.pathname.match(Mv);if(!t)return;let e=t[1],o=Lv();o&&o.proposalId===e&&(Sv(),window.setTimeout(()=>{Iv(o.title,o.bodyHtml)},600))},Rd="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(Rd)?.remove();let r=document.createElement("div");r.id=Rd;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Hd=(t,e)=>new Promise(o=>{document.getElementById(Mt)?.remove();let r=document.createElement("div");r.id=Mt,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,S=`
    ...
    padding-right: 28px;
  `,B=X=>['<option value="">(unset)</option>'].concat(f.map(st=>`<option value="${It(st)}"${st===X?" selected":""}>${bt(st)}</option>`)).join("");y.innerHTML=`
    <div style="
      font-family: ${b.mono};
      font-size: 10px;
      letter-spacing: 0.14em;
    ...
    <div style="margin-bottom: 12px;">
      ...
      <div style="${w}">
        ...
        <div style="${E}">
          <span style="color: ${n.ash}; font-size: 13px;">$</span>
          <input id="ws-pc-cash-at-close" type="number" min="0" step="0.01" value="${c}" style="${A}" />
        </div>
      </div>
      <div style="${w}">
      ...
      <div style="${w}">
        ...
        <select id="ws-pc-current-occupancy" style="${S}">${B(u)}</select>
      </div>
      <div style="${w}">
        <div style="${g}">Occupancy at Close</div>
        <select id="ws-pc-occupancy-at-close" style="${S}">${B(x)}</select>
      </div>
  ...
  `,k.appendChild(y),document.body.appendChild(k);let j=y.querySelector("#ws-pc-purchase-price"),U=y.querySelector("#ws-pc-emd"),W=y.querySelector("#ws-pc-cash-at-close"),N=!1;W?.addEventListener("input",()=>{N=!0});let zt=()=>{if(N)return;let X=Number(j?.value||0),st=Number(U?.value||0);W&&(W.value=String(Math.max(0,X-st)))};j?.addEventListener("input",zt),U?.addEventListener("input",zt);let Nt=()=>k.remove();k.addEventListener("click",X=>{X.target===k&&Nt()}),y.querySelector("#ws-pc-cancel")?.addEventListener("click",Nt);let pt=y.querySelector("#ws-pc-submit"),ht=y.querySelector("#ws-pc-error");pt?.addEventListener("click",async()=>{if(pt){ht&&(ht.textContent=""),pt.disabled=!0,pt.textContent="Opening\u2026";try{let X=(y.querySelector("#ws-pc-seller-name")?.value||"").trim(),st=Number(j?.value||0),Ge=Number(U?.value||0),Ke=Number(W?.value||0),Ve=(y.querySelector("#ws-pc-days-to-close")?.value??"").trim(),Ye=(y.querySelector("#ws-pc-inspection-days")?.value??"").trim(),Je=(y.querySelector("#ws-pc-additional-terms")?.value??"").trim(),he=(y.querySelector("#ws-pc-current-occupancy")?.value??"").trim(),Qe=(y.querySelector("#ws-pc-occupancy-at-close")?.value??"").trim(),it={};if(X!==i&&(it.sellerName=X),st!==d&&(it.purchasePrice=st),Ge!==l&&(it.emd=Ge),Ke!==c&&(it.cashAtClose=Ke),Ve!==m&&(it.daysToClose=Ve),Ye!==h&&(it.inspectionDays=Ye),Je!==v&&(it.additionalTerms=Je),he!==u&&(it.currentOccupancy=he),Qe!==x&&(it.occupancyAtClose=Qe),Object.keys(it).length>0){p.info("[prepare-contract] PA modal submit with overrides:",it),pt.textContent="Saving\u2026";let mn=H(),bn=await Zr({tenantId:t,contactId:e,template:o,userId:mn,overrides:it});p.info("[prepare-contract] re-stage with overrides ok:",bn),pt.textContent="Opening\u2026"}else p.info("[prepare-contract] PA modal submit \u2014 no edits, skipping re-stage");let lt=s?`${s} - Purchase Agreement`:void 0;await ds(t,e,o,lt)}catch(X){pt.disabled=!1,pt.textContent="Open Contract",ht&&(ht.textContent=X.message||"Failed to open contract."),p.warn("[prepare-contract] PA confirm submit failed:",X)}}})},Bv=({tenantId:t,contactId:e,template:o,oppId:r,staged:a,userId:s,defaultClosingDate:i,defaultEMDDueDate:d})=>{document.getElementById(Mt)?.remove(),Dd();let l=a.debug||{},c=typeof l.propertyAddress=="string"?l.propertyAddress:"",m=typeof l.sellerDisplay=="string"?l.sellerDisplay:"",h=typeof l.assignmentPrice=="number"?l.assignmentPrice:0,v=typeof l.buyerEMD=="number"?l.buyerEMD:0,u=typeof l.assignmentFee=="number"?l.assignmentFee:0,x=typeof l.acqPurchasePrice=="number"?l.acqPurchasePrice:0,f=typeof l.closingOffice=="string"?l.closingOffice:"",k=typeof l.buyerCompanyName=="string"?l.buyerCompanyName:"",y=i,g=d,$="",A=document.createElement("div");A.id=Mt,A.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,A.appendChild(T),document.body.appendChild(A);let W=T.querySelector("#ws-pc-assignment-price"),N=T.querySelector("#ws-pc-assignment-fee"),zt=!1;N?.addEventListener("input",()=>{zt=!0});let Nt=()=>{if(zt)return;let st=Number(W?.value||0);N&&(N.value=String(Math.max(0,st-x)))};W?.addEventListener("input",Nt);let pt=()=>A.remove();A.addEventListener("click",st=>{st.target===A&&pt()}),T.querySelector("#ws-pc-cancel")?.addEventListener("click",pt);let ht=T.querySelector("#ws-pc-submit"),X=T.querySelector("#ws-pc-error");ht?.addEventListener("click",async()=>{if(!ht)return;X&&(X.textContent="");let st=(T.querySelector("#ws-pc-seller-name")?.value||"").trim(),Ge=Number(W?.value||0),Ke=Number(T.querySelector("#ws-pc-buyer-emd")?.value||0),Ve=Number(N?.value||0),Ye=(T.querySelector("#ws-pc-closing-office")?.value||"").trim(),Je=(T.querySelector("#ws-pc-buyer-llc")?.value||"").trim(),he=(T.querySelector("#ws-pc-closing-date")?.value||"").trim(),Qe=(T.querySelector("#ws-pc-emd-due-date")?.value||"").trim(),it=(T.querySelector("#ws-pc-lender-source")?.value||"").trim();if(!he){X&&(X.textContent="Closing Date is required.");return}ht.disabled=!0,ht.textContent="Opening\u2026";try{let lt={};st!==m&&(lt.sellerName=st),Ge!==h&&(lt.assignmentPrice=Ge),Ke!==v&&(lt.buyerEMD=Ke),Ve!==u&&(lt.assignmentFee=Ve),Ye!==f&&(lt.closingOffice=Ye),Je!==k&&(lt.buyerCompanyName=Je);let mn=he!==y||Qe!==g||it!==$,bn=Object.keys(lt).length>0||mn,hn=a;bn?(p.info("[prepare-contract] AA modal submit, re-staging with overrides:",lt),ht.textContent="Saving\u2026",hn=await Zr({tenantId:t,contactId:e,template:o,oppId:r,closingDate:he,buyerEarnestDueDate:Qe,lenderSource:it,userId:s,overrides:Object.keys(lt).length>0?lt:void 0}),p.info("[prepare-contract] AA re-stage ok:",hn),ht.textContent="Opening\u2026"):p.info("[prepare-contract] AA modal submit \u2014 no edits, skipping re-stage");let $s=hn?.debug?.propertyAddress||c,Wc=$s?`${$s} - Assignment Agreement`:void 0;await ds(t,e,o,Wc),pt()}catch(lt){ht.disabled=!1,ht.textContent="Open Contract",X&&(X.textContent=lt.message||"Failed to prepare contract."),p.warn("[prepare-contract] AA submit failed:",lt)}})},Zr=async t=>{p.info(`[prepare-contract] staging \u2014 template "${t.template.name}" (${t.template.type})`);let e=await fv({tenantId:t.tenantId,contactId:t.contactId,templateId:t.template.id,templateType:t.template.type,oppId:t.oppId,closingDate:t.closingDate,buyerEarnestDueDate:t.buyerEarnestDueDate,lenderSource:t.lenderSource,userId:t.userId,overrides:t.overrides});if(p.info(`[prepare-contract] stage response: ok=${e.ok}`,e),!e.ok)throw new Error(e.error||"Contract.Stage returned not ok");return e},ds=async(t,e,o,r)=>{let a=null;try{a=(await Nd(e)).email||""}catch(l){p.warn("[prepare-contract] email pre-check fetch failed, proceeding:",l),a=null}if(a!==null&&!a.trim()){nt("This contact has no email. A contract is sent to the recipient for signing, so GHL needs an email to populate it. Add an email to the contact, then prepare the contract again.","error",9e3),p.warn(`[prepare-contract] aborting \u2014 contact ${e} has no email; not creating an empty proposal`);return}p.info(`[prepare-contract] creating proposal from template ${o.id} for contact ${e}`);let s=await xv(t,o.id,e);p.info(`[prepare-contract] proposal created: ${s}`),p.info(`[prepare-contract] attaching contact ${e} as primary signer${r?`, renaming to "${r}"`:""}`);let i=await kv(t,s,e,r);i.ok?p.info(`[prepare-contract] contact attached to proposal ${s}`):(p.warn(`[prepare-contract] attach failed (status=${i.status??"n/a"}): ${i.body?.slice(0,300)??"no body"}`),nt(`Proposal created but couldn't auto-attach contact (HTTP ${i.status??"?"}). You'll need to pick the recipient manually.`,"error",8e3),console.warn("[ws-crm-customizer] attach-recipient GHL response:",i.body));let d=Cv(o.name);d&&(p.info(`[prepare-contract] stashing post-redirect instructions for "${o.name}"`),Av(s,d.title,d.bodyHtml)),Ev(t,s)},Rv=async t=>{let e=bv(t);if(!e){nt("Could not resolve contact context.","error");return}document.getElementById(Id)?.remove();let o=document.createElement("div");o.id=Id,o.style.cssText=`
    position: absolute;
    top: calc(100% + 6px);
    right: 0;
    z-index: 999998;
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await vv(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=H();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await gv(e.tenantId,e.contactId)}catch(g){nt(`Failed to load buyer's MT opps: ${g.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",g);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let g=await Hd(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!g){p.info("[prepare-contract] MT opp picker cancelled");return}m=g,p.info(`[prepare-contract] picked MT opp ${m}`)}}let h=y=>{let g=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${g}-${$}-${A}`},v=y=>{let g=new Date;return g.setDate(g.getDate()+y),h(g)},u=v(45),x=v(7);nt("Reading contract data\u2026","info",2500);let f;try{f=await Zr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:u,buyerEarnestDueDate:x,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||f.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}Bv({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:f,userId:c,defaultClosingDate:u,defaultEMDDueDate:x})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await yv(e.tenantId,e.contactId)}catch(u){nt(`Failed to load ACQ opps: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",u);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let h;if(m.length===1)h=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${h} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let u=await Hd(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!u){p.info("[prepare-contract] ACQ opp picker cancelled");return}h=u,p.info(`[prepare-contract] picked ACQ opp ${h}`)}nt("Reading contract data\u2026","info",2500);let v;try{v=await Zr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:h,userId:c})}catch(u){nt(`Failed to prepare contract: ${u.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",u);return}Ov({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:v})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await ds(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},qd=()=>{let t=document.createElement("button");return t.id=as,t.type="button",t.style.cssText=`${R} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Rv(t)}),t},Hv="ws-crm-contact-actions-bar",Dv=async()=>{let t=Fd();if(!t){document.getElementById(as)?.remove();return}let e=null;try{e=await M(`#${Hv}`,{timeoutMs:Ze+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(as);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=qd();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},me="ws-crm-prepare-contract-button-opp",Fo=`${me}-wrap`,Fv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,zv=/\/v2\/location\/([A-Za-z0-9]+)/,Nv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],is=()=>{let t=window.location.pathname,e=t.match(Fv);if(!e)return null;let o=t.match(zv);return o?{oppId:e[1],tenantId:o[1]}:null},qv=async()=>{for(let t of Nv)try{let e=await M(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Jr=!1,zo=null,ls=null,rs=null,ns,No=()=>{zo?.disconnect(),zo=null,ls=null},Uv=t=>{if(zo&&ls===t)return;No();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ls=t,zo=new MutationObserver(()=>{let o=is();if(!o||o.oppId!==t){No();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(me)?.remove(),document.getElementById(Fo)?.remove(),No();return}document.getElementById(me)||Ud()}),zo.observe(e,{childList:!0,subtree:!0}))},jv=()=>{rs||(rs=new MutationObserver(()=>{ns===void 0&&(ns=window.setTimeout(()=>{ns=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(me);t&&!e&&!Jr&&Ud()},300))}),rs.observe(document.body,{childList:!0,subtree:!0}))},Ud=async()=>{if(!Jr){Jr=!0;try{let t=is();if(!t){document.getElementById(me)?.remove(),document.getElementById(Fo)?.remove(),No();return}let e=document.getElementById(me);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(Fo)?.remove(),No());return}e&&(e.remove(),document.getElementById(Fo)?.remove());let o=await qv();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=is();if(!a||a.oppId!==t.oppId)return;let s=qd();s.id=me,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=Fo,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Uv(t.oppId)}finally{Jr=!1}}},jd=()=>{Pv(),Dv()};mv();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function It(t){return bt(t)}var Wv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",be="ws-crm-compute-offer-button",ms="ws-crm-compute-offer-popover",Zd="ws-crm-offer-modal",Wd="ws-crm-contact-actions-bar",Gv=[".central-panel","[class*='central-panel']"],te=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",cs=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},Kv=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Gd=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${Kv[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Kd=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;outline:none;`,ps=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(Wv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},Fe=()=>{document.getElementById(ms)?.remove(),document.removeEventListener("mousedown",Xd,!0)};function Xd(t){let e=document.getElementById(ms),o=document.getElementById(be),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&Fe()}var tc=(t,e)=>{Fe();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=ms;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${_.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${b.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",Xd,!0),0)},Xr=(t,e)=>{tc(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},Vv=(t,e,o)=>{tc(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${_.sm};font-family:${b.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{Fe(),o(a.property_record_id)}),r.appendChild(s)})})},en=()=>{document.getElementById(Zd)?.remove(),document.removeEventListener("keydown",ec,!0)};function ec(t){t.key==="Escape"&&en()}var Vd=(t,e,o)=>{en(),Fe();let r=o,a=!1,s="",i=document.createElement("div");i.id=Zd,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${b.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&en()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${_.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,h,v)=>{a||(a=!0,s="",c(),ps({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:h,repairOverride:v}).then(u=>{u&&u.ok?r={...u,current_offer:u.current_offer??r.current_offer,current_offer_date:u.current_offer_date??r.current_offer_date}:s=u&&u.error||"Request failed."}).catch(u=>{p.error("[compute-offer] worksheet request failed:",u),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,h=!!m.has_comps;d.innerHTML="";let v=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),u=q("div","");u.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),u.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let x=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");x.type="button",x.addEventListener("click",en),v.append(u,x),d.appendChild(v);let f=q("div","padding:14px 18px 18px;");d.appendChild(f);let k=q("select",Kd());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",Kd());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let g=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");g.appendChild(q("div",`font-size:12px;color:${h?n.bone:n.amber};`,h?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${Gd(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${_.sm};border:1px solid ${n.blue};background:${h?"transparent":n.blue};color:${h?n.blue:"#fff"};font-family:${b.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":h?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),g.append($),f.appendChild(g),m.low_confidence&&h&&f.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let A=m.current_offer!=null;f.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${_.sm};background:${n.slate};border:1px solid ${n.steel};color:${A?n.bone:n.ash};`,A?`Last offer made: ${te(m.current_offer)}${m.current_offer_date?` \xB7 ${Gd(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=q("div","");w.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(w,E),f.appendChild(T);let S=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),B=(U,W,N)=>{let zt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),Nt=q("div","");Nt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&Nt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);zt.append(Nt,pt),S.appendChild(zt)};if(h&&m.imv!=null){B("Investor Market Value (IMV)",te(m.imv)),m.arv!=null&&B("After Repair Value (ARV)",te(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?B(`Repairs (${N})`,"Included",{color:n.ash,sub:`${te(m.repair_total)} in repairs included at IMV`}):B(`Repairs (${N})`,cs(W),{color:W<0?n.crimson:n.emerald,sub:`${te(m.repair_total)} total, ${te(m.baseline_repairs)} included at IMV`}),B("Min. Profit Target",cs(-(m.profit_target??0)),{color:n.ash}),B("Maximum Cash Offer (MAO)",te(m.mao),{strong:!0,color:n.blue}),B("Target Profit",cs(-(m.ico_delta??0)),{color:n.ash}),B("Initial Cash Offer (ICO)",te(m.ico),{strong:!0,color:n.blue})}else S.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));f.appendChild(S);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(h?"Saved to the Property.":""),f.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",ec,!0)},Yd=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=be,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){Vv(o,i.properties,d=>{a(!0),ps({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Vd(e,l.property_record_id,l):Xr(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),Xr(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Vd(e,i.property_record_id,i):Xr(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await ps({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),Xr(o,"Request failed. Try again.")}finally{a(!1)}}}),o},Yv=async()=>{for(let t of Gv)try{let e=await M(t,{timeoutMs:3e3});if(e)return e}catch{}return null},Jd=async(t,e)=>{let o=e.querySelector(`#${Wd}`);if(!o)try{o=await M(`#${Wd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},Qd=()=>{let t=document.querySelectorAll(`#${be}`);for(let e=1;e<t.length;e++)t[e].remove()},Jv=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(be)?.remove(),Fe();return}let e=t.locationId,o=document.getElementById(be);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),Fe();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(be)?.remove();return}let a=await Yv();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Yd(t.contactId,e);if(!await Jd(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}Qd(),p.debug(`[compute-offer] mounted for ${t.contactId}`),tn?.disconnect(),tn=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){tn?.disconnect();return}if(!document.getElementById(be)){let d=Yd(t.contactId,e);Jd(d,a).then(()=>Qd())}}),tn.observe(a,{childList:!0})},tn=null,Uo=null,oc=()=>{let t=D()?.contactId??null;if(Uo&&Uo.id===t)return;let e=Jv().finally(()=>{Uo?.promise===e&&(Uo=null)});Uo={id:t,promise:e}};var ln="reos-theme-stylesheet",wc="reos-theme-fonts",Ue=!1,Qv=()=>{let t=document.getElementById(wc);t&&t.remove()},Zv=`
...
`,Xv=[{selector:".hr-input__input-el, .hr-input__textarea-el, [class*='hr-input'] input, [class*='hr-input'] textarea",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-data-table-wrapper, .hr-data-table-wrapper-responsive, .hr-data-table-wrapper-header, .hr-data-table-wrapper-footer, .hr-data-table, .hr-data-table__body, .hr-table-freezer-wrapper, [class*='hr-data-table-wrapper'], [class*='hr-table-freezer']",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-data-table-tr, tr.n-data-table-tr",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".back-to-sites, .n-tabs-nav, .n-tabs-nav-scroll-content, .n-tabs-nav-scroll-wrapper, .n-tabs-wrapper, .n-tabs-tab-wrapper, .n-tabs-tab-pad",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:"#setup-guide-button, .setup-guide-button-container",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".default-avatar, .n-avatar.default-avatar",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:"#steps-sidebar, .steps-sidebar",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".search-box",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".my-table.tabulator, .tabulator, .tabulator-tableholder, .tabulator-table, .tabulator-header, .tabulator-headers, .tabulator-footer, .tabulator-row, .table-container, .cardWrapper, .quick-filter-bar, #skeleton-loader, .skeleton-loader",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".tabulator-col, .tabulator-frozen, .tabulator-frozen-left, .tabulator-frozen-right",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".mb-2\\.5.bg-white, div.bg-white, .bg-white.px-3, .mx-auto > .bg-white",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-data-table__header, .hr-data-table__cell-header, thead.hr-data-table__header",styles:{"background-color":"#1A1F28",color:"#EDEEF0"}},{selector:".hr-wrapper-container, .platform-ui__highrise, .full-screen.platform-ui__highrise, [class*='platform-ui__highrise'], .hl_topbar-tabs, .hl_wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-collapse-item__header, .hr-collapse-item__header-main, .hr-collapse-item__title",styles:{color:"#EDEEF0","background-color":"#12161D"}},{selector:".hr-collapse-item__content, .hr-collapse-item__content-inner, .hr-collapse-item__content-wrap",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs, .hr-tabs-nav, .hr-tabs-nav-scroll-content, .hr-tabs-content, .hr-tabs-pane, .hr-tabs-rail, .hr-tabs-tab-wrapper",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".hr-tabs-capsule",styles:{"background-color":"transparent",background:"transparent",border:"none"}},{selector:".hr-avatar:not(.default-avatar), .hr-avatar:not(.default-avatar) .hr-avatar__text, .hr-avatar:not(.default-avatar) .hr-avatar__text p, .hr-avatar:not(.default-avatar) p, .hr-avatar:not(.default-avatar) span, .hr-avatar:not(.default-avatar) div, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar), [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) span, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) p, [class*='avatar']:not([class*='dropdown']):not([class*='option-avatar']):not([class*='option']):not([class*='select']):not(.default-avatar) div",styles:{color:"#0A0D12","-webkit-text-fill-color":"#0A0D12","font-weight":"600"}},{selector:".default-avatar, .default-avatar *",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0",stroke:"#EDEEF0","font-weight":"600"}},{selector:".hr-button--tertiary",styles:{"background-color":"#1A1F28",color:"#0FB57E"}},{selector:".hr-text:not([role='button']):not(.cursor-pointer)",styles:{color:"#EDEEF0"}},{selector:"[class*='field-value'], [class*='field-display'], [class*='empty-value'], [class*='field-empty'], [class*='value-display'], [class*='display-value']",styles:{color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hr-select__value, .hr-select__display, .hr-select-trigger, .hr-select-trigger__value, .hr-base-select__value, .hr-base-select__display, [class*='select__value'], [class*='select__display'], [class*='select-trigger']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".hr-select, .hr-select__input, .hr-select__inner, .hr-select-trigger, .hr-base-select, .hr-base-select__inner, .el-select, .el-select__wrapper, .el-input__wrapper, .el-input__inner, [role='combobox'], [aria-haspopup='listbox']",styles:{"background-color":"#1A1F28","border-color":"#252C36"}},{selector:"input[type='date'], input[type='datetime-local'], input[type='time'], input[type='month'], input[type='week'], .hr-date-picker, .hr-date-input, .hr-datepicker, .hr-time-picker, [class*='date-picker'], [class*='datepicker'], [class*='date-input'], [class*='time-picker'], [class*='time-input']",styles:{"background-color":"#1A1F28","border-color":"#252C36",color:"#EDEEF0"}},{selector:"[class*='F7F9FD'], [class*='F7F9FB'], [class*='F9FAFB'], [class*='eff4ff'], [class*='EFF4FF'], [class*='ECEEF2'], [class*='eceef2']",styles:{"background-color":"#12161D"}},{selector:"[style*='background-color: white'], [style*='background-color:white'], [style*='background-color: #fff'], [style*='background-color:#fff'], [style*='background-color: #FFF'], [style*='background-color:#FFF'], [style*='background-color: #ffffff'], [style*='background-color:#ffffff'], [style*='background-color: #FFFFFF'], [style*='background-color:#FFFFFF'], [style*='background-color: rgb(255, 255, 255)'], [style*='background-color:rgb(255, 255, 255)'], [style*='background-color: rgb(255,255,255)'], [style*='background-color:rgb(255,255,255)']",styles:{"background-color":"#12161D"}},{selector:".chart-container.hl-card, [class*='chart-container'][class*='hl-card'], .dashboard-widget-type-custom .hl-card, .dashboard-widget-module-custom .hl-card",styles:{"background-color":"#12161D"}},{selector:".bg-gray-50, .bg-white, .bg-gray-100",styles:{"background-color":"#12161D",color:"#EDEEF0"}},{selector:".n-base-select-menu, .n-popselect-menu, .n-popover, .n-dropdown, .n-dropdown-menu, .hr-base-select-menu, .hr-popselect-menu, .hr-popover, .hr-dropdown, .hr-dropdown-menu",styles:{"background-color":"#12161D",color:"#EDEEF0","border-color":"#252C36","--n-option-color":"transparent","--n-option-color-hover":"#1A1F28","--n-option-color-active":"rgba(15, 181, 126, 0.12)","--n-option-color-active-hover":"rgba(15, 181, 126, 0.12)","--n-option-text-color":"#EDEEF0","--n-option-text-color-hover":"#EDEEF0","--n-option-text-color-active":"#0FB57E","--n-option-text-color-disabled":"#9098A3","--n-color":"transparent","--n-color-hover":"#1A1F28","--n-color-active":"rgba(15, 181, 126, 0.12)","--n-text-color":"#EDEEF0","--n-text-color-hover":"#EDEEF0","--n-text-color-active":"#0FB57E","--n-text-color-disabled":"#9098A3"}},{selector:".n-dropdown-option--disabled, .n-dropdown-option--disabled .n-dropdown-option-body, .n-dropdown-option--disabled .n-dropdown-option-body__label, .n-dropdown-option--disabled .n-dropdown-option-body__prefix, .n-dropdown-option--disabled .n-dropdown-option-body__suffix, .n-dropdown-option[aria-disabled='true'], .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__label, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__prefix, .n-dropdown-option[aria-disabled='true'] .n-dropdown-option-body__suffix, .n-base-select-option--disabled, .n-base-select-option--disabled *, .n-base-select-option[aria-disabled='true'], .n-base-select-option[aria-disabled='true'] *, .hr-dropdown-option--disabled, .hr-dropdown-option--disabled *, .hr-dropdown-option[aria-disabled='true'], .hr-dropdown-option[aria-disabled='true'] *, .hr-base-select-option--disabled, .hr-base-select-option--disabled *, .hr-base-select-option[aria-disabled='true'], .hr-base-select-option[aria-disabled='true'] *",styles:{"background-color":"transparent",color:"#9098A3","-webkit-text-fill-color":"#9098A3"}},{selector:".hl-card-header [role='heading'], .hl-card-header p[role='heading'], [class*='hl-card-header'] [role='heading']",styles:{color:"#EDEEF0","-webkit-text-fill-color":"#EDEEF0"}},{selector:".n-button:not(.n-button--primary-type):not(.n-button--error-type):not(.n-button--warning-type):not(.n-button--success-type):not(.n-button--info-type)",styles:{"background-color":"#1A1F28"}},{selector:".hl_header--controls .platform-ui__highrise, .hl_header--controls .hr-wrapper-container, a.hl_header--avatar, .hl_header--avatar.dropdown-toggle",styles:{"background-color":"transparent",background:"transparent"}}],ty=t=>{if(!t||t[0]!=="#")return t;let e=t.slice(1);if(e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6&&e.length!==8)return t;let o=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);if(isNaN(o)||isNaN(r)||isNaN(a))return t;if(e.length===8){let s=parseInt(e.slice(6,8),16)/255;return`rgba(${o}, ${r}, ${a}, ${s})`}return`rgb(${o}, ${r}, ${a})`},ey=new Set(["color","background-color","background","border-color","border-top-color","border-right-color","border-bottom-color","border-left-color","fill","stroke","-webkit-text-fill-color","caret-color","outline-color"]),oy=["#inventory-table","#inventory","[id^='collections-']","[id^='products-']","[id^='reviews-']",".sites-container","[data-testid='wordpress-app-dashboard']","[data-testid$='-app-dashboard']","[data-testid$='-dashboard']:not([data-testid*='widget']):not([data-testid*='card'])","#wordpress-management-app","[id$='-management-app']"],on=new WeakSet,rc=t=>{try{if(!document.body)return;(t??document.body.querySelectorAll("*")).forEach(o=>{try{if(o.classList&&(o.classList.contains("hr-drawer-container")||o.classList.contains("hr-detached-container"))){(o.getAttribute("style")||"").includes("background")&&(o.style.removeProperty("background-color"),o.style.removeProperty("background-image"));return}if(on.has(o)&&o.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest(".hl_header, header.hl_header, header.app-header")||o.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let r=o.tagName;if(r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||r==="SCRIPT"||r==="STYLE"||r==="SVG"||r==="PATH"||r==="IMG")return;let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if((i[4]!==void 0?+i[4]:1)<.5||d<230||l<230||c<230)return;let h=o.style.getPropertyValue("background-color");if(h==="rgb(18, 22, 29)"){on.add(o);return}if(o.closest(".hr-button")&&!(o.classList&&o.classList.contains("hr-button"))){h!=="transparent"&&(o.style.setProperty("background-color","transparent","important"),o.style.setProperty("background-image","none","important")),on.add(o);return}o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"),on.add(o)}catch{}})}catch{}},bs=new WeakSet,ze=()=>{document.querySelectorAll(oy.join(", ")).forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.querySelectorAll("*");[e,...Array.from(o)].forEach(r=>{if(r.classList&&(r.classList.contains("hr-drawer-container")||r.classList.contains("hr-detached-container"))){(r.getAttribute("style")||"").includes("background")&&(r.style.removeProperty("background-color"),r.style.removeProperty("background-image"));return}if(bs.has(r)&&r.style.getPropertyValue("background-color")==="rgb(18, 22, 29)"||r.id?.startsWith("ws-crm-")||r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.tagName==="SELECT"||r.tagName==="SCRIPT"||r.tagName==="STYLE"||r.tagName==="SVG"||r.tagName==="PATH"||r.closest(".hr-avatar, .avatar, [id^='avatar-']"))return;let s=window.getComputedStyle(r).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=+i[1],l=+i[2],c=+i[3];if(!(d<230||l<230||c<230)){if(r.closest(".hr-button")&&!(r.classList&&r.classList.contains("hr-button"))){r.style.getPropertyValue("background-color")!=="transparent"&&(r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background-image","none","important")),bs.add(r);return}r.style.setProperty("background-color","#12161D","important"),r.style.setProperty("color","#EDEEF0","important"),bs.add(r)}})})},nc=()=>{document.querySelectorAll(".hr-button .hr-button__content, .hr-button .hr-icon-inner, .hr-button .hr-text, .hr-button .hr-button__label").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.classList&&e.classList.contains("hr-button"))return;let o=e.style.getPropertyValue("background-color");o&&o!=="transparent"&&o!=="rgba(0, 0, 0, 0)"&&(e.style.setProperty("background-color","transparent","important"),e.style.setProperty("background-image","none","important"))})},ac=()=>{document.querySelectorAll(".hl_header--controls .bg-primary-50 .bg-primary-600").forEach(t=>{t.style.setProperty("background-color","#252C36","important"),t.style.setProperty("background-image","none","important"),t.style.setProperty("color","#EDEEF0","important")})},sc=()=>{document.querySelectorAll(".hr-header-lite-left, .hr-header-lite-right, .hr-header-lite-content, .hr-header-lite-icon-item, [class*='hr-header-lite']:not([class*='container']):not([class*='wrapper']), .hr-breadcrumb, .hr-breadcrumb-item, .hr-breadcrumb-item__link, .hr-breadcrumb-item__separator").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color: rgb(26, 31, 40)")||o.includes("background-color: #1A1F28")||o.includes("background-color: #1a1f28"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"),e.style.removeProperty("border-style"),e.style.removeProperty("border-width"),e.style.removeProperty("border-radius"))})},rn=()=>{document.querySelectorAll(".hr-header-lite-container-v2, [id^='hr-header-lite-v-']").forEach(e=>{let o=e.parentElement,r=0;for(;o&&r<6&&o!==document.body;){if(r+=1,o.id?.startsWith("ws-crm-")||o.classList.contains("hl_header")||o.classList.contains("app-header")||o.tagName==="MAIN"||o.tagName==="BODY")return;let i=window.getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(i){let d=+i[1],l=+i[2],c=+i[3];(i[4]!==void 0?+i[4]:1)>=.5&&d>=180&&l>=180&&c>=180&&d+l+c>=600&&o.style.getPropertyValue("background-color")!=="rgb(18, 22, 29)"&&(o.style.setProperty("background-color","rgb(18, 22, 29)","important"),o.style.setProperty("color","rgb(237, 238, 240)","important"))}o=o.parentElement}})},ic=()=>{let t="rgb(144, 152, 163)";document.querySelectorAll(".primary-property-name, .primary-property-name *, .folder-name, .folder-name *, .hr-form-item-label__asterisk, span.hr-form-item-label__asterisk").forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;(o.getAttribute("style")||"").includes(t)&&(o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"))})},Ne=()=>{if(!Ue)for(let t of Xv){let e;try{e=document.querySelectorAll(t.selector)}catch{continue}e.forEach(o=>{for(let[r,a]of Object.entries(t.styles)){let s=o.style.getPropertyPriority(r),i=o.style.getPropertyValue(r),d=ey.has(r)?ty(a):a;s==="important"&&i===d||o.style.setProperty(r,a,"important")}})}},dn="#1A1F28",ry=26,ny=31,ay=40,lc=new Set,dc=new Set,nn=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.children.length>0||(o.textContent||"").trim()!=="--")return;let a=o.getBoundingClientRect();if(a.width===0||a.height===0||a.width>800)return;o.style.setProperty("display","none","important");let s=o.className?.toString()||"<no class>";!dc.has(s)&&s!=="<no class>"&&(dc.add(s),p.debug(`Hid empty "--" leaf: "${s}"`))})},sy=["M3 6","M5 6","M2 6","M6 6","M9 3h6","M16 6v","M19 6v","M5 6V","M16.5 4","48.816","2.991","14.74 9","9.26 9","2.244","M19 4h-","M19 7l-"],iy=["trash","Trash","TRASH","delete","Delete","DELETE"],ly=()=>{document.querySelectorAll("button.hr-button, button.n-button, button.icon-only, .hr-button.icon-only, .n-button.icon-only").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']")||e.getAttribute("data-reos-trash")==="true")return;let o=e.querySelector("svg");if(!o)return;let r=!1,a=(o.getAttribute("class")||"")+" "+(o.getAttribute("data-icon")||"");if(iy.some(s=>a.includes(s))&&(r=!0),r||o.querySelectorAll("path").forEach(i=>{if(r)return;let d=i.getAttribute("d")||"";sy.some(l=>d.includes(l))&&(r=!0)}),!r){let s=(e.id||"").toLowerCase(),i=(e.getAttribute("aria-label")||"").toLowerCase(),d=(e.getAttribute("title")||"").toLowerCase();(s.includes("delete")||s.includes("remove")||s.includes("trash")||i.includes("delete")||i.includes("remove")||i.includes("trash")||d.includes("delete")||d.includes("remove")||d.includes("trash"))&&(r=!0)}r&&e.setAttribute("data-reos-trash","true")})},dy=new Set(["Delete Reminder","Delete","Remove","Trash","Edit","Copy","Duplicate","Add another reminder","Add","Close","Dismiss"]),cy=()=>{document.querySelectorAll(".hr-tooltip, .hr-popover-shared, [role='tooltip']").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=(e.textContent||"").trim();o.length===0||o.length>40||dy.has(o)&&e.style.display!=="none"&&(e.style.setProperty("display","none","important"),e.style.setProperty("visibility","hidden","important"),e.style.setProperty("opacity","0","important"),e.style.setProperty("pointer-events","none","important"))})},cc=new Set,pc=new WeakSet,py=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(pc.has(o)&&o.style.getPropertyValue("color")==="rgb(237, 238, 240)"||o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']"))return;let r=(o.className?.toString()||"").toLowerCase();if(r.includes("ai-button")||r.includes("ask-ai")||r.includes("bg-clip-text")||r.includes("text-transparent")||o.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let a=o.tagName.toLowerCase();if(a==="svg"||a==="path"||a==="circle"||a==="rect"||a==="polygon"||a==="polyline"||a==="line"||a==="g")return;let s=!1;for(let v of Array.from(o.childNodes))if(v.nodeType===Node.TEXT_NODE&&(v.textContent||"").trim()){s=!0;break}if(!s)return;let i=Array.from(o.children);if(i.length>0&&i.every(v=>{let u=v.tagName.toLowerCase();return u==="svg"||u==="img"})&&!s)return;let c=window.getComputedStyle(o).color;if(!(c==="rgb(255, 255, 255)"||c==="rgba(255, 255, 255, 1)"||c==="#ffffff"||c==="white"))return;o.style.setProperty("color","#EDEEF0","important"),o.style.setProperty("-webkit-text-fill-color","#EDEEF0","important"),pc.add(o);let h=o.className?.toString()||"<no class>";!cc.has(h)&&h!=="<no class>"&&(cc.add(h),p.debug(`Remapped pure-white text -> bone: "${h}"`))})},mc=new Set,my=()=>{let t=document.querySelectorAll(".hl_header, header.hl_header, header.app-header, .hl_header--controls, .top-bar, .topbar"),e="rgb(18, 22, 29)";document.querySelectorAll(".hr-content-switcher svg, .hr-content-switcher svg *, .hr-content-switcher i, .hr-radio-button svg, .hr-radio-button svg *, .hr-radio-button i, [class*='hr-content-switcher'] svg, [class*='hr-content-switcher'] svg *, [class*='hr-content-switcher'] i").forEach(r=>{if(r.closest(".hl_header"))return;let a=r.getAttribute("style")||"";(a.includes(e)||a.includes("#12161D")||a.includes("#12161d"))&&(r.style.removeProperty("fill"),r.style.removeProperty("stroke"),r.style.removeProperty("color"))}),t.forEach(r=>{r.querySelectorAll("button, a, [role='button'], [class*='rounded-full'], [class*='rounded-md'], [class*='rounded-xl'], [class*='pill'], span[class*='rounded'], div[class*='rounded']").forEach(s=>{if(s.closest("[id^='ws-crm-']"))return;let i=(s.className?.toString()||"").toLowerCase();if(i.includes("avatar"))return;let d=window.getComputedStyle(s),l=d.backgroundColor,c=d.backgroundImage||"",m=!1;if(c!=="none"&&c.includes("gradient"))m=!0;else if(l&&l!=="rgba(0, 0, 0, 0)"&&l!=="transparent"){let A=l.match(/rgba?\(\d+,\s*\d+,\s*\d+,\s*([\d.]+)\)/);if(A&&parseFloat(A[1])<.6)return;let T=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(T){let w=parseInt(T[1],10),E=parseInt(T[2],10),S=parseInt(T[3],10);(w>=60||E>=60||S>=60)&&(w>230&&E>230&&S>230||(w>=80||E>=80||S>=80)&&(m=!0))}}if(!m)return;let v=(s.textContent||"").trim(),u=i,x=Array.from(s.querySelectorAll("*")).map(A=>(A.className?.toString()||"").toLowerCase()).join(" "),f=v.toLowerCase()==="ask ai"||u.includes("ai-button")||u.includes("ask-ai")||u.includes("askai"),k=u.includes("bg-clip-text")||u.includes("text-transparent")||x.includes("bg-clip-text")||x.includes("text-transparent"),y=Array.from(s.querySelectorAll("*")).some(A=>{let T=window.getComputedStyle(A),w=T.getPropertyValue("-webkit-background-clip")||"",E=T.getPropertyValue("background-clip")||"";return w.includes("text")||E.includes("text")});if(f||k||y){let A=["color","-webkit-text-fill-color","fill","stroke","background","background-color","background-image","background-clip","-webkit-background-clip","text-shadow"],T=w=>{A.forEach(E=>w.style.removeProperty(E))};T(s),s.querySelectorAll("*").forEach(T);return}let g="#12161D";s.style.setProperty("color",g,"important"),s.querySelectorAll("*").forEach(A=>{let T=A.tagName.toLowerCase();T==="svg"||T==="path"||T==="circle"||T==="rect"||T==="polygon"||T==="polyline"||T==="line"||T==="g"?(A.style.setProperty("fill",g,"important"),A.style.setProperty("stroke",g,"important"),A.style.setProperty("color",g,"important")):(A.style.setProperty("color",g,"important"),A.style.setProperty("-webkit-text-fill-color",g,"important"))});let $=s.className?.toString()||"<no class>";!mc.has($)&&$!=="<no class>"&&(mc.add($),p.debug(`Darkened SVG icons on colored button: "${$}"`))})})},bc=new Set,by=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;if((e.className?.toString()||"").toLowerCase().includes("default-avatar")){e.querySelectorAll(".n-avatar__text, [class*='avatar__text']").forEach(l=>{(l.getAttribute("style")||"").includes("translateY(11px)")&&l.style.removeProperty("transform")});return}let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.width<20||r.width>64||r.height<20||r.height>64)return;let a=r.top+r.height/2;(e.parentElement||e).querySelectorAll("svg, img").forEach(l=>{let c=l;if(c.closest("[id^='ws-crm-']"))return;let m=l.getBoundingClientRect();if(m.width===0||m.width>28||m.height>28)return;let h=m.left<r.right&&m.right>r.left,v=m.top<r.bottom&&m.bottom>r.top;if(!(h&&v)||m.top+m.height/2<a)return;let x=m.width*m.height/(r.width*r.height);if(x>.55)return;let f=c,k=c.parentElement,y=0;for(;k&&k!==e&&y<3;){let $=k.getBoundingClientRect();if($.width>0&&$.width<=30&&$.height<=30)f=k;else break;k=k.parentElement,y++}f.style.setProperty("transform","translateY(11px)","important");let g=(f.className?.toString()||"")+" "+f.tagName;bc.has(g)||(bc.add(g),p.debug(`Dropped activity badge 11px (${m.width.toFixed(0)}x${m.height.toFixed(0)} icon, ratio ${x.toFixed(2)}): "${g}"`))})})},hy="brightness(0) saturate(100%) invert(54%) sepia(78%) saturate(442%) hue-rotate(122deg) brightness(96%) contrast(89%)",uy=()=>{document.querySelectorAll("aside.default-bg-color a, [class*='sidebar'] a").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();o.includes("active")||o.includes("router-link-active")?(e.style.setProperty("color","#0FB57E","important"),e.style.setProperty("-webkit-text-fill-color","#0FB57E","important"),e.style.setProperty("opacity","1","important"),e.querySelectorAll("span, p, div").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("-webkit-text-fill-color","#0FB57E","important")}),e.querySelectorAll("img").forEach(a=>{a.style.setProperty("filter",hy,"important")}),e.querySelectorAll("svg").forEach(a=>{a.style.setProperty("color","#0FB57E","important"),a.style.setProperty("stroke","#0FB57E","important")})):((e.style.color==="rgb(18, 22, 29)"||e.style.color==="#12161D"||e.style.color==="#0FB57E"||e.style.color==="rgb(15, 181, 126)")&&(e.style.removeProperty("color"),e.style.removeProperty("-webkit-text-fill-color")),e.querySelectorAll("span, p, div").forEach(a=>{let s=a.style.color;(s==="rgb(18, 22, 29)"||s==="#12161D"||s==="#0FB57E"||s==="rgb(15, 181, 126)")&&(a.style.removeProperty("color"),a.style.removeProperty("-webkit-text-fill-color"))}),e.querySelectorAll("img").forEach(a=>{a.style.filter&&a.style.filter.includes("hue-rotate(122")&&a.style.removeProperty("filter")}))})},hc=new Set,_y=()=>{document.querySelectorAll(".n-dialog, [class*='n-dialog'], [class*='dialog'], [role='dialog']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;e.querySelectorAll("div, span, i").forEach(r=>{if(r.closest("[id^='ws-crm-']"))return;let a=r.getBoundingClientRect();if(a.width===0||a.height===0||a.width>56||a.height>56||!r.querySelector("svg"))return;let i=window.getComputedStyle(r).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d>200&&l>200&&c>200))return;r.style.setProperty("background-color","transparent","important"),r.style.setProperty("background","transparent","important"),r.style.setProperty("box-shadow","none","important"),r.style.setProperty("border","none","important");let m=r.className?.toString()||"<no class>";!hc.has(m)&&m!=="<no class>"&&(hc.add(m),p.debug(`Stripped dialog icon circle (${a.width.toFixed(0)}x${a.height.toFixed(0)}, rgb(${d},${l},${c})): "${m}"`))})})},uc=new Set,vy=()=>{document.querySelectorAll("[class*='ai-button'], [class*='ask-ai'], [class*='askai']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.parentElement,r=0;for(;o&&r<3&&!o.closest("[id^='ws-crm-']");){let a=(o.className?.toString()||"").toLowerCase();if(!(a.includes("ai-button")||a.includes("ask-ai")||a.includes("askai"))){let i=o.getBoundingClientRect();if(i.width>0&&i.height>0&&i.width<=400&&i.height<=80){o.style.setProperty("background-color","#12161D","important"),o.style.setProperty("background-image","none","important");let d=o.className?.toString()||"<no class>";!uc.has(d)&&d!=="<no class>"&&(uc.add(d),p.debug(`Painted Ask AI wrapper graphite: "${d}"`))}}o=o.parentElement,r++}})},_c=new Set,yy=()=>{let t=Array.from(document.querySelectorAll("#contact-conversation-panel, [class*='conversation-panel'], [class*='message-list'], [class*='activity-log'], .hl_header, header.hl_header, [class*='topbar'], [class*='top-bar'], header.app-header, .modal, .modal-content, [class*='modal'], [class*='dialog'], [role='dialog'], [class*='popover'], [class*='popup'], [class*='dropdown-menu'], [class*='select-menu'], [class*='popselect'], [class*='base-select'], .n-base-select-menu, .n-popselect, .n-popover")),e=document.querySelectorAll("div, section, aside"),o=[];e.forEach(a=>{if(a.id?.startsWith("ws-crm-")||a.closest("[id^='ws-crm-']"))return;let s=window.getComputedStyle(a);if(s.position!=="fixed"&&s.position!=="absolute")return;let i=parseInt(s.zIndex,10);if(!isFinite(i)||i<50)return;let d=a.getBoundingClientRect();d.width<240||d.height<120||d.width>1500||d.height>900||o.push(a)}),[...t,...o].forEach(a=>{a.querySelectorAll("*").forEach(i=>{if(i.id?.startsWith("ws-crm-")||i.closest("[id^='ws-crm-']"))return;let d=(i.className?.toString()||"").toLowerCase();if(d.includes("avatar")||d.includes("notification-dot")||d.includes("indicator"))return;if(d.includes("sidebar-option-button")||i.closest(".sidebar-option-button")||i.closest("nav[class*='w-13']")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("tabulator")||d.includes("tabulator-page")||i.closest("[class*='tabulator']")){(i.getAttribute("style")||"").includes("background-color")&&i.style.removeProperty("background-color");return}if(d.includes("hr-card")||i.closest(".hr-card")||i.id&&i.id.startsWith("opportunity-")){let k=i.getAttribute("style")||"";(k.includes("background-color")||k.includes("color"))&&(i.style.removeProperty("background-color"),i.style.removeProperty("color"));return}if(d.includes("ai-button")||d.includes("ask-ai")||d.includes("bg-clip-text")||d.includes("text-transparent")||i.closest("[class*='ai-button'], [class*='ask-ai'], [class*='bg-clip-text'], [class*='text-transparent']"))return;let l=window.getComputedStyle(i).backgroundColor;if(!l||l==="rgba(0, 0, 0, 0)"||l==="transparent")return;let c=l.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!c)return;let m=parseInt(c[1],10),h=parseInt(c[2],10),v=parseInt(c[3],10);if(!(m>200&&h>200&&v>200))return;let x=i.getBoundingClientRect();if(x.width<24||x.height<16||x.width>1400)return;i.style.setProperty("background-color","#12161D","important"),i.style.setProperty("color","#EDEEF0","important");let f=i.className?.toString()||"<no class>";!_c.has(f)&&f!=="<no class>"&&(_c.add(f),p.debug(`Coerced light bg (${x.width.toFixed(0)}x${x.height.toFixed(0)}, rgb(${m},${h},${v})): "${f}"`))})})},vc=new Set,gy=t=>{let e="input, select, textarea, [class*='hr-input'], [class*='hr-select'], [class*='hr-base-select'], [class*='hr-date-picker'], [class*='hr-datepicker']";(t??document.body.querySelectorAll("*")).forEach(r=>{if(r.id?.startsWith("ws-crm-")||r.closest("[id^='ws-crm-']")||r.children.length>0)return;let a=(r.textContent||"").trim();if(a.length===0||a.length>80||a==="--"||r.closest(e)||r.closest("[class*='avatar'], [class*='hr-avatar']")||r.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||r.closest("[class*='hr-tabs-tab'], [class*='tab-label'], [class*='tabs-nav'], [role='tab']"))return;if(r.matches("[role='heading']")||r.closest("[role='heading']")||r.matches("h1, h2, h3")||r.closest(".hl-card-header, [class*='hl-card-header'], [class*='card-header']")){r.matches("h1, h2, h3")&&(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-alert, .hr-alert-body, [class*='hr-alert']")){let $=r.getAttribute("style")||"";($.includes("color")||$.includes("background"))&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"),r.style.removeProperty("background-color"));return}if(r.closest("#SettingTexasSmsBlock")||r.matches("p.ui-text-sm-medium")&&r.parentElement?.classList?.contains("flex")&&r.parentElement?.classList?.contains("items-center")&&r.parentElement?.children?.length===1){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".hr-button, .n-button")||r.matches(".hr-button__content, .n-button__content")||r.closest(".hr-button__content, .n-button__content")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}if(r.closest(".bg-primary-50, [class*='bg-primary-50']")){(r.getAttribute("style")||"").includes("color")&&(r.style.removeProperty("color"),r.style.removeProperty("-webkit-text-fill-color"));return}let s=r,i=null;for(let $=0;$<4&&s;$++){let A=s.nextElementSibling;if(A&&(A.matches(e)||A.querySelector(e)!==null)){i=A;break}s=s.parentElement}if(!i)return;let d=r.getBoundingClientRect();if(d.width===0||d.height===0||d.width>400||d.height>60)return;r.style.setProperty("color","#9098A3","important"),r.style.setProperty("-webkit-text-fill-color","#9098A3","important");let l=i,c=l.getBoundingClientRect(),m=l.className?.toString()||"",h=m.includes("schedule-ui-form-weekly-schedule-checkbox")||l.closest(".schedule-ui-form-weekly-schedule-checkbox")!==null,v=m.includes("hl-form-item")||m.includes("n-form-item--top-labelled")||l.closest(".hl-form-item")!==null,u=".hr-input, .hr-input-number, .hr-base-select, .hr-select, .hr-date-picker, .hr-datepicker",x=(m.includes("hr-form-item-blank")||m.includes("hr-form-item")||l.matches(u))&&(l.matches(u)||l.querySelector(u)!==null);x&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let f=m.includes("hr-radio")||l.closest(".hr-radio, [class*='hr-radio']")!==null;f&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let k=m.includes("hr-breadcrumb")||l.closest(".hr-breadcrumb, [class*='hr-breadcrumb']")!==null;k&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius"));let y=m.includes("hr-header-lite")||l.closest("[class*='hr-header-lite']")!==null;y&&(l.getAttribute("style")||"").includes("background-color")&&(l.style.removeProperty("background-color"),l.style.removeProperty("border-color"),l.style.removeProperty("border-style"),l.style.removeProperty("border-width"),l.style.removeProperty("border-radius")),!h&&!v&&!x&&!f&&!k&&!y&&c.width>0&&c.width<=800&&c.height>0&&c.height<=100&&(l.style.setProperty("background-color",dn,"important"),l.style.setProperty("border-color","#252C36","important"),l.style.setProperty("border-style","solid","important"),l.style.setProperty("border-width","1px","important"),l.style.setProperty("border-radius","4px","important"));let g=r.className?.toString()||"<no class>";!vc.has(g)&&g!=="<no class>"&&(vc.add(g),p.debug(`Colored field label "${a.slice(0,30)}": "${g}"`))})},yc=new Set,fy=()=>{document.querySelectorAll("[class*='avatar']").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=(e.className?.toString()||"").toLowerCase();if(o.includes("dropdown")||o.includes("option-avatar"))return;let r=e.getBoundingClientRect();if(r.width===0||r.height===0||r.height>80||e.querySelector("svg, img")!==null)return;let s=(e.textContent||"").trim();if(s.length===0||s.length>4)return;let i=Math.min(r.width,r.height),d=Math.max(16,Math.min(24,Math.round(i*.6)));e.style.setProperty("font-size",`${d}px`,"important"),e.style.setProperty("line-height","1","important"),e.style.setProperty("display","flex","important"),e.style.setProperty("align-items","center","important"),e.style.setProperty("justify-content","center","important"),e.style.setProperty("text-align","center","important"),e.querySelectorAll("*").forEach(c=>{c.tagName==="svg"||c.tagName==="SVG"||c.tagName!=="IMG"&&(c.style.setProperty("font-size",`${d}px`,"important"),c.style.setProperty("line-height","1","important"),c.style.setProperty("text-align","center","important"))});let l=e.className?.toString()||"<no class>";!yc.has(l)&&l!=="<no class>"&&(yc.add(l),p.debug(`Resized avatar text to ${d}px (circle ${i.toFixed(0)}px): "${l}"`))})},gc=new Set,xy=new Set(["Enter Dashboard Name"]),wy=()=>{document.querySelectorAll("input:not([type='checkbox']):not([type='radio']):not([type='button']):not([type='submit']):not([type='reset']):not([type='hidden']):not([type='file']), textarea, select").forEach(e=>{if(e.closest("[id^='ws-crm-']"))return;let o=e.getBoundingClientRect();if(o.width===0||o.height===0)return;let r=e.placeholder||"";if(xy.has(r)){(e.getAttribute("style")||"").includes("background-color")&&(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"));return}e.style.setProperty("background-color",dn,"important"),e.style.setProperty("border-color","#252C36","important"),e.style.setProperty("color","#EDEEF0","important"),e.style.setProperty("-webkit-text-fill-color","#EDEEF0","important");let a=e.closest(".hr-input-wrapper, .hr-input, .hr-input__input");a&&(a.style.setProperty("background-color",dn,"important"),a.style.setProperty("border-color","#252C36","important"));let s=e.className?.toString()||"<no class>";!gc.has(s)&&s!=="<no class>"&&(gc.add(s),p.debug(`Forced input slate bg: "${s}"`))})},an=t=>{(t??document.body.querySelectorAll("*")).forEach(o=>{if(o.id?.startsWith("ws-crm-")||o.closest("[id^='ws-crm-']")||o.closest("[class*='collapse-item__header'], [class*='hr-collapse-item__header'], [class*='collapse-header'], [class*='folder-header']")||o.id==="chat-filter"||o.id==="phone-calls"||o.id==="archive-conversation"||o.id==="star-toggle"||o.id==="read-toggle"||o.id==="delete-conversation")return;if(o.closest(".hr-tooltip, .hr-popover-shared, .hr-popover, [class*='hr-tooltip'], [class*='hr-popover']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".hr-base-select-menu, .hr-select-menu, .hr-select__menu-container, .hr-dropdown-menu, [class*='hr-base-select-menu']")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}let r=o.className?.toString()||"";if(r.includes("bg-inherit")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.closest(".pipeline-ribbon")&&r.split(" ").includes("count")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.split(" ").includes("tabulator-page")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(["tabulator-cell","tabulator-row","tabulator-col","tabulator-header","tabulator-tableholder","tabulator-table"].some(u=>r.includes(u))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("schedule-ui-form-weekly-schedule-checkbox")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("border-color")||u.includes("border-style")||u.includes("border-width"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"));return}if(r.includes("n-button")&&r.includes("icon-only")&&!r.includes("quaternary")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-button--tertiary-type")||r.includes("n-button--tertiary-type")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"),o.style.removeProperty("-webkit-text-fill-color"),o.style.removeProperty("border-color"),o.style.removeProperty("border-style"),o.style.removeProperty("border-width"),o.style.removeProperty("border-radius"));return}if(r.includes("hr-data-table-td")||r.includes("hr-data-table-tr")||r.includes("hr-data-table__body-cell")||r.includes("hr-data-table__cell")||r.includes("hr-data-table__header-cell")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-data-table-td--fixed-right")||r.includes("n-data-table-td--last-col")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(o.classList.contains("hr-tabs")||r.includes("hr-tabs-tab-wrapper")||r.includes("hr-tabs-nav")||r.includes("hr-tabs-nav-scroll-content")||r.includes("hr-tabs-content")||r.includes("hr-tabs-pane")||r.includes("hr-tabs-rail")||r.includes("hr-tabs-wrapper")||r.includes("hr-tabs-pane-wrapper")||r.includes("hr-tab-pane")){let u=o.getAttribute("style")||"";(u.includes("background-color: rgb(26, 31, 40)")||u.includes("background-color: #1A1F28")||u.includes("background-color: #1a1f28"))&&o.style.removeProperty("background-color");return}if(r.includes("hr-date-panel")||r.includes("n-date-panel")||o.closest(".hr-date-panel, .n-date-panel")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-tag")&&r.includes("ui-default")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if((r.includes("bg-purple-50")||r.includes("bg-purple-100"))&&(r.includes("rounded-lg")||r.includes("rounded-md")||r.includes("rounded-full"))){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("n-alert")||o.closest(".n-alert")||r.includes("hl-warning")||r.includes("hl-error")||r.includes("hl-info")||r.includes("hl-success")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-card")||o.closest(".hr-card")||o.id&&o.id.startsWith("opportunity-")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("bg-gray-50")||r.includes("bg-gray-100")||r.includes("bg-gray-200")||r.includes("bg-white")||r.includes("bg-blue-50")||r.includes("bg-blue-100")||r.includes("bg-sky-50")||r.includes("bg-indigo-50")||r.includes("bg-slate-50")||r.includes("bg-neutral-50")||r.includes("bg-zinc-50")||r.includes("bg-stone-50")||r.includes("F7F9FD")||r.includes("F9FAFB")||r.includes("ECEEF2")||r.includes("eceef2")||r.includes("EFF4FF")||r.includes("eff4ff")){(o.getAttribute("style")||"").includes("background-color")&&o.style.removeProperty("background-color");return}if(r.includes("hr-collapse-item")||r.includes("hr-collapse hr-accordion")||r.includes("hr-accordion"))return;if(r.includes("sidebar-option-button")||o.closest(".sidebar-option-button")||o.closest("nav[class*='w-13']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}if(o.closest(".inbox-panel, .conversation-list-container, [class*='conversation-list-container']")){let u=o.getAttribute("style")||"";(u.includes("background-color")||u.includes("color"))&&(o.style.removeProperty("background-color"),o.style.removeProperty("color"));return}let s=window.getComputedStyle(o).backgroundColor;if(!s||s==="rgba(0, 0, 0, 0)"||s==="transparent")return;let i=s.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!i)return;let d=parseInt(i[1],10),l=parseInt(i[2],10),c=parseInt(i[3],10);if(!(d<ry&&l<ny&&c<ay))return;let h=o.getBoundingClientRect();if(h.width===0||h.height===0||h.width>800||h.height>200)return;o.style.setProperty("background-color",dn,"important");let v=o.className?.toString()||"<no class>";!lc.has(v)&&v!=="<no class>"&&(lc.add(v),p.debug(`Coerced dark bg to slate (${h.width.toFixed(0)}x${h.height.toFixed(0)}, rgb(${d},${l},${c})): "${v}"`))})},sn=()=>{let t="#4B8BF5",e=["#155EEF","#155eef","#004EEB","#004eeb","#175CD3","#175cd3"],o="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";document.querySelectorAll("img[src^='data:image/svg+xml;base64,']:not([data-reos-recolored-v3])").forEach(s=>{s.setAttribute("data-reos-recolored","1"),s.setAttribute("data-reos-recolored-v2","1"),s.setAttribute("data-reos-recolored-v3","1");let d=(s.getAttribute("src")||"").match(/^data:image\/svg\+xml;base64,(.+)$/);if(!d)return;let l;try{l=atob(d[1])}catch{return}let c=l,m=!1;if(e.forEach(u=>{c.includes(u)&&(c=c.split(u).join(t),m=!0)}),["#F8F9FC","#f8f9fc","#F9FAFB","#f9fafb","#F2F4F7","#f2f4f7"].forEach(u=>{c.includes(u)&&(c=c.split(u).join("transparent"),m=!0)}),s.closest(".toolbar_button, .editor-toolbar, [class*='toolbar']")!==null&&["#000000","#000","#040E13","#040e13","#111827","#111","#101828","#101"].forEach(x=>{c.includes(x)&&(c=c.split(x).join("#EDEEF0"),m=!0)}),!!m)try{let u=btoa(c);s.setAttribute("src",`data:image/svg+xml;base64,${u}`)}catch{}}),document.querySelectorAll(".hl-checkbox-group-item img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-icon img:not([data-reos-masked]):not([data-reos-recolored]), .hl-checkbox-group-item-container img:not([data-reos-masked]):not([data-reos-recolored])").forEach(s=>{let i=s.getAttribute("src")||"";if(!i||i.startsWith("data:")||!/\.svg(?:[?#]|$)/i.test(i))return;s.setAttribute("data-reos-masked","1");let d=`url("${i}")`;s.style.setProperty("-webkit-mask-image",d,"important"),s.style.setProperty("-webkit-mask-size","contain","important"),s.style.setProperty("-webkit-mask-repeat","no-repeat","important"),s.style.setProperty("-webkit-mask-position","center","important"),s.style.setProperty("mask-image",d,"important"),s.style.setProperty("mask-size","contain","important"),s.style.setProperty("mask-repeat","no-repeat","important"),s.style.setProperty("mask-position","center","important"),s.style.setProperty("background-color","var(--reos-blue)","important"),s.setAttribute("src",o)})},jo=()=>{document.querySelectorAll("[class*='n-date-panel']").forEach(e=>{[...e.classList].forEach(o=>{if(o.startsWith("n-date-panel")){let r="hr-date-panel"+o.slice(12);e.classList.contains(r)||e.classList.add(r)}})})},ky=()=>{document.querySelectorAll("button.hr-button.hr-button--3xs:not(.hr-button--primary-type), button.hr-button.hr-button--xs:not(.hr-button--primary-type), #manage-association-btn").forEach(e=>{if(e.id?.startsWith("ws-crm-")||e.closest("[id^='ws-crm-']"))return;let o=e.getAttribute("style")||"";(o.includes("background-color")||o.includes("background:"))&&(e.style.removeProperty("background-color"),e.style.removeProperty("background"))})},qe=()=>{let t=r=>{r.style.getPropertyValue("background-color")!=="rgb(26, 31, 40)"&&r.style.setProperty("background-color","rgb(26, 31, 40)","important")},e=document.querySelector(".crm-opportunities-modal");e&&e.querySelectorAll(".hr-base-selection").forEach(a=>{t(a),a.querySelectorAll("div, span").forEach(i=>{if(i.id?.startsWith("ws-crm-"))return;let d=window.getComputedStyle(i).backgroundColor;d==="rgba(0, 0, 0, 0)"||d==="transparent"||!d||t(i)})}),document.querySelectorAll(".hr-upload-dragger").forEach(r=>{t(r);let a=r.querySelector(".ui-upload-icon");a&&(a.style.setProperty("background-color","transparent","important"),a.style.setProperty("background","transparent","important"));let s="rgb(150, 162, 173)",i="rgb(0, 191, 124)",d=c=>{let m=r.querySelector(".ui-upload-icon svg");m&&(m.style.setProperty("color",c,"important"),m.style.setProperty("stroke",c,"important")),r.querySelectorAll(".ui-upload-icon svg path").forEach(h=>{h.style.setProperty("stroke",c,"important")})},l=!1;try{l=r.matches(":hover")}catch{}d(l?i:s),r.dataset.hoverBound!=="1"&&(r.dataset.hoverBound="1",r.addEventListener("mouseenter",()=>d(i)),r.addEventListener("mouseleave",()=>d(s)))})},hs=new WeakSet,Ey=()=>{document.querySelectorAll('iframe[title="Email"]').forEach(e=>{if(!hs.has(e))try{let o=e.contentDocument||e.contentWindow?.document;if(!o||!o.head)return;if(o.querySelector("style[data-ws-crm-email-fix]")){hs.add(e);return}let r=o.createElement("style");r.setAttribute("data-ws-crm-email-fix","1"),r.textContent=`
  ...
  `,t.textContent=`Customizer v${Qo}`,t.title=`Built ${Zo}
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var gs="https://services.leadconnectorhq.com",Ec="__WS_CRM_CAPTURED_AUTH";var Ay=()=>{try{let t=localStorage.getItem(Ec);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(Ec),null):e:null}catch{return null}},Ly=()=>{let t=Ay();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},fs=async(t,e={})=>{let o=Ly();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Ic=new Set(["ej0SqnTYIprechAMAPrd"]),je="contact-select-trigger",Mc="ws-crm-reply-from-warning",Pc="contact-select-menu",$c="ws-crm-rf-thread-opt",xs="",ws=!1,Go=null,pn=null,Tc=!1,Ko="",Cc,ee=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},ks=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Pt=t=>(t||"").replace(/\D/g,"").slice(-10),Ac=t=>{let e=Pt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Sy=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Iy=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=Q();if(!r)return null;let a=await fs(`${gs}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return ee("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},My=async()=>{let t=await Iy();if(!t)return null;let e=await fs(`${gs}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return ee("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Sy(a);if(Pt(s).length===10)return s}return null},We=()=>document.getElementById(Mc)?.remove(),Oc=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},Py=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),Bc=(t,e,o)=>{We();let r=document.getElementById(je);if(!r)return;let a=Oc(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Mc,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${Py(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${Ac(t)}</span>${i}. You're set to reply from ${Ac(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Oy=t=>{Go?.disconnect();let e=document.getElementById(je);if(!e)return;let o=Oc(e)||e,r=Pt(ks(e));Go=new MutationObserver(()=>{let a=ks(document.getElementById(je)),s=Pt(a);!s||s===r||(r=s,s===Pt(t)?We():Bc(t,"",a))}),Go.observe(o,{childList:!0,subtree:!0,characterData:!0})},Lc=()=>{let t=document.getElementById(Pc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Ko&&(r=e.find(d=>Pt(o(d))===Pt(Ko))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),ee("decorateMenu: cache=",Ko,"target=",r?a:"NONE"),!r)return;let s=document.getElementById($c);s&&s!==r&&s.removeAttribute("id"),r.id=$c;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},By=()=>{if(!Ic.has(Q()||""))return;pn?.disconnect();let t=0,e=()=>{let o=document.getElementById(Pc);if(o){Lc(),pn=new MutationObserver(()=>Lc()),pn.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Ry=t=>{let e=t.target;e&&e.closest&&e.closest("#"+je)&&(ee("From trigger clicked -> waiting for menu"),By())},Hy=async()=>{if(!ws){ws=!0;try{let t=document.getElementById(je);if(!t)return;let e=ks(t),o=await My();if(Ko=o||"",ee("check: from=",e,"thread=",o),!o){We();return}Pt(e)&&Pt(e)!==Pt(o)?(ee("MISMATCH -> banner"),Bc(o,"",e)):(ee("match -> no banner"),We()),Oy(o)}finally{ws=!1}}},Sc=()=>{if(!Ic.has(Q()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){xs="",Ko="",Go?.disconnect(),pn?.disconnect(),We();return}let e=!!document.getElementById(je),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==xs){if(xs=r,!e){Go?.disconnect(),We();return}ee("composer expanded on",o),Hy()}},Rc=()=>{Cc===void 0&&(Cc=window.setInterval(Sc,500)),Tc||(document.addEventListener("click",Ry,!0),Tc=!0),Sc()};var Dy="#1A1F28",Fy="#EDEEF0",Es="#9098A3",zy=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},Ny=t=>.2126*t.r+.7152*t.g+.0722*t.b,qy=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},Hc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},Uy=t=>{let e=zy(getComputedStyle(t).backgroundColor);if(!e||Ny(e)<120)return;let o=qy(e);t.style.setProperty("background-color",Dy,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),Hc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Fy),Hc(t,"#note-date-added-text, [class*='475467']",Es)},jy=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",Es,"important"),e.style.setProperty("-webkit-text-fill-color",Es,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},Dc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)Uy(t[e]),jy(t[e])},Fc,zc=()=>{Fc===void 0&&(Fc=window.setInterval(Dc,700)),Dc()};var Wy='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',Nc=()=>{document.querySelectorAll(Wy).forEach(t=>{t.setAttribute("autocomplete","off")})},qc,Uc=()=>{qc===void 0&&(qc=window.setInterval(Nc,1e3)),Nc()};console.log("[ws-crm-customizer] bundle-loaded");var C=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},jc=()=>{p.info(`Loaded v${Qo} (built ${Zo})`),un()?(p.info(`[main] excluded location ${Q()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Wo),C("mountDialerThemeFix",qr)):(C("mountVersionBadge (initial)",cn),C("mountFavicon",Ti),C("mountThemeStylesheet",Wo),C("mountHideLaunchpad",la),C("mountHideNavItems",da),C("mountRelabelNav",ca),C("mountHideTopmenuTabs",ma),C("mountContractsSection",pa)),C("installOppIdCapture",Ms),C("initPageRouter",As),p.info("[main] registering onPageChange subscriber"),Et(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),un()){p.info(`[main] page change into excluded location ${Q()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Wo),C("runThemeFastPass",ys),C("mountDialerThemeFix",qr),C("unmountContactMapLinks",Ji);return}C("mountThemeStylesheet",Wo),C("runThemeFastPass",ys),C("mountVersionBadge",cn),C("mountHideLaunchpad",la),C("mountHideNavItems",da),C("mountRelabelNav",ca),C("mountHideTopmenuTabs",ma),C("mountContractsSection",pa),C("mountAnalyticsDashboard",js),C("mountClaimReleaseToggle",mi),C("mountContactActionsBar",Ei),C("mountActiveFollowUpButton",Fs),C("mountMtOfferMadeButton",Si),C("mountNotInterestedButton",Ii),C("mountScheduleWalkthroughButton",Mi),C("mountResendDealLinkButton",Oi),C("mountReducePriceButton",Ri),C("mountEditLandingPageButton",Hi),C("mountPublishButton",Ni),C("mountContactMapLinks",Yi),C("mountSendToClosingOfficeButton",cl),C("mountOppActionBar",Tl),C("mountClosingAgentPickerButton",$d),C("mountPrepareContractButton",jd),C("mountComputeOfferButton",oc),C("mountManageTeam",Sd),C("mountBuyBoxWidget",Js),C("mountSellerContactFlag",li),C("mountPropertiesWidget",si),C("mountSupportNavItem",Ol),C("mountPhoneAssignmentsWidget",zl),C("mountBulkPowerDialer",sd),C("mountBulkPowerDialerContacts",dd),C("mountCallingAsChip",bd),C("mountDialerThemeFix",qr),C("mountReplyFromWarning",Rc),C("mountNoteCanon",zc),C("mountSuppressAutofill",Uc)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",jc):jc();})();
