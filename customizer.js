/* Wholesaling CRM Customizer v0.51.1 — built 2026-07-08T23:37:59.298Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var Yo="[wholesaling-crm-customizer]",Jc="__WS_CRM_DEBUG",Qc=()=>!!window[Jc],p={info(...t){console.log(Yo,...t)},warn(...t){console.warn(Yo,...t)},error(...t){console.error(Yo,...t)},debug(...t){Qc()&&console.log(Yo,"[debug]",...t)}};var Zc=/\/v2\/location\/([A-Za-z0-9]+)/,Xc=new Set(["8ntUQzMflUkR0YvrRgVk"]),K=()=>{let t=window.location.pathname.match(Zc);return t?t[1]:null},_n=()=>{let t=K();return t!==null&&Xc.has(t)};var Ss=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,vn=/\/v2\/location\/([A-Za-z0-9]+)/,tp=t=>{let e=t.match(Ss);if(!e)return null;let o=t.match(vn);return{contactId:e[1],locationId:o?o[1]:null,source:"url"}},ep=()=>{let t=["#central-panel-conversations-mount a[href*='/contacts/detail/']","#record-details-lhs a[href*='/contacts/detail/']","#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of t){let o=document.querySelector(e);if(!o)continue;let r=o.getAttribute("href")||o.href||"",a=r.match(Ss);if(!a)continue;let s=r.match(vn)||window.location.pathname.match(vn);return{contactId:a[1],locationId:s?s[1]:null,source:"dom"}}return null},D=()=>{let t=tp(window.location.pathname);return t||ep()};var Ls=()=>{let t=window.location.pathname;return t.includes("/contacts/detail/")?"contact-detail":t.includes("/contacts/smart-list")||t.includes("/contacts/")?"contact-list":t.includes("/opportunities/detail/")?"opportunity-detail":t.includes("/opportunities")?"opportunity-list":t.includes("/calendars/")?"calendar":t.includes("/dashboard")?"dashboard":t.includes("/conversations")?"conversations":t.includes("/settings")?"settings":"other"},Qo="",yn=null,oe="other",gn=new Set,Jo=()=>{let t=D()?.contactId??null;if(!(!(window.location.pathname!==Qo)&&!(t!==yn))){Qo=window.location.pathname,yn=t,oe=Ls(),p.debug("Page/context changed:",oe,Qo,"contact:",t);for(let r of gn)try{r(oe)}catch(a){p.error("Subscriber threw:",a)}}},_t=t=>(gn.add(t),setTimeout(()=>t(oe),0),()=>{gn.delete(t)}),Is=()=>{oe=Ls(),Qo=window.location.pathname,yn=D()?.contactId??null,p.debug("Router init, current page:",oe);let t=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(o,r,a){t(o,r,a),Jo()},history.replaceState=function(o,r,a){e(o,r,a),Jo()},window.addEventListener("popstate",Jo),setInterval(Jo,1e3)},ve=()=>oe;var op=/\/opportunities\/([A-Za-z0-9]{16,24})(?:[/?]|$)/,Os=null,Ms=!1,Ps=t=>{let e=t.match(op);e&&(Os=e[1])},Bs=()=>{if(!Ms){Ms=!0;try{let t=window.fetch.bind(window);window.fetch=(o,r)=>{try{let a=typeof o=="string"?o:o instanceof URL?o.href:o.url;a&&Ps(a)}catch{}return t(o,r)};let e=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(o,r,...a){try{Ps(typeof r=="string"?r:r.href)}catch{}return e.call(this,o,r,...a)},p.debug("[opp-id-capture] installed")}catch(t){p.warn("[opp-id-capture] install failed",t)}}},qt=()=>Os;var Zo="0.51.1",Xo="2026-07-08T23:37:59.298Z";var rp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/type",tr=new Map,fn=new Map,np=3e4,Xe=4e3,ap=Xe,$t=async(t,e)=>{if(!t)return null;let o=tr.get(t);if(o){if(o.failedAt===void 0)return o.type;if(Date.now()-o.failedAt<np)return null}if(!e)return p.warn(`Cannot fetch Contact Type for ${t} \u2014 tenant_id missing from URL context`),null;let r=fn.get(t);if(r)return r;let s=(async()=>{let i=new AbortController,d=setTimeout(()=>i.abort(),ap);try{let l=`${rp}?contact_id=${encodeURIComponent(t)}&tenant_id=${encodeURIComponent(e)}`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json"},signal:i.signal});if(!c.ok)return clearTimeout(d),p.warn(`Contact Type fetch returned ${c.status} for ${t}`),tr.set(t,{type:null,failedAt:Date.now()}),null;let m=await c.json();clearTimeout(d);let u=(m.contact_type||"").toLowerCase().trim()||null;return tr.set(t,{type:u}),p.debug(`Resolved Contact Type for ${t}: ${u??"(unset)"}`),u}catch(l){return clearTimeout(d),p.warn(`Contact Type fetch failed for ${t}:`,l),tr.set(t,{type:null,failedAt:Date.now()}),null}})();fn.set(t,s);try{return await s}finally{fn.delete(t)}},Tt=t=>t==="buyer"?"buyer":t==="seller"?"seller":t==="agent"||t==="closing_agent"||t==="closing_office"||t==="vendor"||t==="tenant"?"other":"seller";var P=(t,e={})=>{let{timeoutMs:o=8e3,pollMs:r=100,root:a=document}=e;return new Promise((s,i)=>{let d=a.querySelector(t);if(d){s(d);return}let l,c,m=()=>{l!==void 0&&window.clearTimeout(l),c!==void 0&&window.clearInterval(c)};c=window.setInterval(()=>{let u=a.querySelector(t);u&&(m(),s(u))},r),l=window.setTimeout(()=>{m(),p.warn(`waitForElement timed out for selector: ${t}`),i(new Error(`Selector not found within ${o}ms: ${t}`))},o)})};var n={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},v={sm:"4px",md:"6px",lg:"10px",pill:"999px"},h={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},xn={purple:"#8B5CF6",green:n.emerald,orange:n.amber,red:n.crimson},Rs=t=>{let e=t==="emerald"?n.emeraldGlow:t==="amber"?n.amberGlow:n.slate,o=t==="emerald"?n.emeraldBorder:t==="amber"?"rgba(232, 163, 60, 0.3)":n.steel,r=t==="emerald"?n.emerald:t==="amber"?n.amber:n.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,R=`
  ...
  flex-shrink: 0;
`;var sp=/^[A-Za-z0-9]{15,30}$/,to=t=>typeof t=="string"&&sp.test(t),Hs=t=>{try{let e=t.split(".");if(e.length!==3)return null;let o=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=o+"=".repeat((4-o.length%4)%4);return JSON.parse(atob(r))}catch{return null}},ip=()=>{let t=window.WS_CRM_USER_ID;return to(t)?t:null},lp=()=>{let t=window,e=[t.appState?.user?.id,t.user?.id,t.currentUser?.id,t.LCUser?.id,t.HL?.user?.id];for(let o of e)if(to(o))return o;return null},dp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Hs(e);if(!o)return null;let r=o.uid;if(to(r))return r;let a=o.claims;if(a&&to(a.user_id))return a.user_id}catch{}return null},cp=()=>{try{let t=["user","tokenUser","currentUser","ghl_user"];for(let e of t){let o=localStorage.getItem(e);if(o)try{let r=JSON.parse(o),a=r.id??r._id;if(to(a))return a}catch{}}}catch{}return null},H=()=>ip()||dp()||lp()||cp()||null,pp=()=>{try{let t=localStorage.getItem("refreshedToken");if(!t)return null;let e=t.startsWith('"')?t.slice(1,-1):t,o=Hs(e);return o?o.claims??o:null}catch{return null}},ye=()=>{let t=window.WS_CRM_FORCE_AGENCY;return typeof t=="boolean"?t:pp()?.type==="agency"};var Ns="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",mp=`${Ns}/active-follow-up-get`,bp=`${Ns}/active-follow-up-set`,re="ws-crm-active-follow-up-button",kn={amber:{label:"Add to Active Follow Up",bg:n.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:n.amber,clickable:!0,dotColor:n.amber},blue:{label:"SMS Drip Active",bg:n.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:n.blue,clickable:!1,dotColor:n.blue},gray:{label:"No Active SMS Drip",bg:n.slate,border:n.steel,color:n.coolGray,clickable:!1,dotColor:n.coolGray},loading:{label:"Active Follow Up\u2026",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.ash},error:{label:"Follow Up status unavailable",bg:n.slate,border:n.steel,color:n.ash,clickable:!1,dotColor:n.crimson}},hp=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},up=async t=>{let e=await fetch(mp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},_p=async(t,e)=>{let o=await fetch(bp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!o.ok)throw new Error(`Set webhook returned ${o.status} ${o.statusText}`);return await o.json()},ne=(t,e)=>{let o=kn[e];t.dataset.state=e,t.disabled=!o.clickable,t.style.cursor=o.clickable?"pointer":"default",t.style.background=o.bg,t.style.borderColor=o.border,t.style.color=o.color;let r=t.querySelector(".ws-afu-dot");r&&(r.style.background=o.dotColor);let a=t.querySelector(".ws-afu-label");a&&(a.textContent=o.label)},Ds=t=>{let e=document.createElement("button");return e.type="button",e.id=re,e.dataset.contactId=t,e.style.cssText=`
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 6px 12px;
  ...
  `,ne(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=hp();if(!(!r||r.contactId!==t)){ne(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let a=await _p(r,H()),s=a&&a.state&&a.state in kn?a.state:"blue";ne(e,s),p.info(`Active Follow Up set for ${t} \u2192 ${s}`)}catch(a){p.error("Active Follow Up Set webhook failed",a),ne(e,"error"),setTimeout(()=>void or(e,r),4e3)}}}),e},vp=3e4,or=async(t,e)=>{t.dataset.lastRefreshAt=String(Date.now()),ne(t,"loading");try{let o=await up(e),r=o&&o.state&&o.state in kn?o.state:"gray",a=document.getElementById(re);if(!a||a.dataset.contactId!==e.contactId)return;ne(a,r)}catch(o){p.warn("Active Follow Up Get webhook failed",o),delete t.dataset.lastRefreshAt,ne(t,"error")}},yp=[".central-panel","[class*='central-panel']"],wn="ws-crm-contact-actions-bar",gp=async()=>{for(let t of yp)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}try{return(await P("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},fp=async(t,e)=>{let o=e.querySelector(`#${wn}`);if(!o)try{o=await P(`#${wn}`,{timeoutMs:Xe+2e3,root:e})}catch{o=null}if(o){let s=e.querySelector("#ws-crm-afu-wrap");return s&&s.remove(),t.style.order="2",o.appendChild(t),{container:o,placement:"actions-bar"}}let r="ws-crm-afu-wrap",a=e.querySelector(`#${r}`);if(!a){a=document.createElement("div"),a.id=r,a.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
      ...
      flex-shrink: 0;
    `;let s=e.querySelector(`#${wn}`);s&&s.parentElement===e?e.insertBefore(a,s.nextSibling):e.insertBefore(a,e.firstChild)}return a.appendChild(t),{container:a,placement:"fallback"}},xp=()=>{let t=document.querySelector("[data-testid='CENTRALPANEL_NAME']");if(!t)return null;let e=t;for(let o=0;o<8&&!(!e||!e.parentElement);o++){let r=e.parentElement,a=(r.className||"").toString();if(a.includes("justify-between")&&a.includes("border-b")){let s=r.children[1];return s instanceof HTMLElement?s:r}e=r}return null},wp=(t,e)=>{t.style.marginRight="4px",e.insertBefore(t,e.firstChild)},kp=async t=>{if(t==="url"){let o=await gp();return o?{kind:"contact-detail",target:o}:null}let e=xp();return e?{kind:"conversations",target:e}:null},Fs=async(t,e)=>{if(e.kind==="contact-detail"){let{placement:o}=await fp(t,e.target);return o}return wp(t,e.target),"conversations-header"},Ep=async()=>{let t=D();if(!t||!t.locationId){document.getElementById(re)?.remove(),document.getElementById("ws-crm-afu-wrap")?.remove();return}let e={contactId:t.contactId,tenantId:t.locationId},o=document.getElementById(re);if(o&&o.dataset.contactId===e.contactId){let l=Number(o.dataset.lastRefreshAt||0);Date.now()-l>=vp&&or(o,e);return}o&&o.remove();let r=await kp(t.source);if(!r){p.warn(`Active Follow Up: no mount target on ${t.source}-source page`);return}let a=D();if(!a||a.contactId!==e.contactId)return;let s=Ds(e.contactId),i=await Fs(s,r);p.debug(`Active Follow Up mounted (${r.kind}/${i}) for ${e.contactId}`),zs();let d=document.getElementById(re)??s;or(d,e),er?.disconnect(),er=new MutationObserver(()=>{let l=document.getElementById(re);if(!(D()?.contactId===e.contactId)){er?.disconnect();return}if(!l){let m=Ds(e.contactId);Fs(m,r).then(()=>{zs(),or(m,e)}),p.debug(`Active Follow Up re-mounted after wipe for ${e.contactId}`)}}),er.observe(r.target,{childList:!0})},er=null,eo=null,qs=()=>{let t=D()?.contactId??null;if(eo&&eo.contactId===t)return;let e=Ep().finally(()=>{eo?.promise===e&&(eo=null)});eo={contactId:t,promise:e}},zs=()=>{let t=document.querySelectorAll(`#${re}`);if(!(t.length<=1)){p.debug(`Active Follow Up: found ${t.length} duplicate buttons, keeping first, removing ${t.length-1}`);for(let e=1;e<t.length;e++)t[e].remove()}};var $p="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/analytics/compute",Tp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/callstats/sweep-run",rr="ws-crm-analytics-overlay",Cp=[{key:"today",label:"Today"},{key:"yesterday",label:"Yesterday"},{key:"this_week",label:"This week"},{key:"last_week",label:"Last week"},{key:"this_month",label:"This month"},{key:"last_month",label:"Last month"},{key:"last_365",label:"Last 365 days"},{key:"all_time",label:"All time"},{key:"custom",label:"Custom"}],Ap=[{key:"company",label:"Company"},{key:"acq",label:"Acquisitions"},{key:"dispo",label:"Disposition"},{key:"marketing",label:"Marketing"},{key:"tc",label:"Transactions"},{key:"velocity",label:"Velocity"}],M={open:!1,range:"this_month",customStart:"",customEnd:"",tab:"company",loading:!1,error:null,data:null,cache:new Map},V=t=>{let e=Number(t)||0;return"$"+Math.round(e).toLocaleString("en-US")},O=t=>(Number(t)||0).toLocaleString("en-US"),$n=t=>{let e=Number(t);return!Number.isFinite(e)||e<=0?"\u2014":new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},ro=t=>{let e=Math.round(Number(t)||0);if(e<60)return`${e}s`;let o=Math.floor(e/3600),r=Math.round(e%3600/60);return o>0?`${o}h ${r}m`:`${r}m`},Sp=()=>`${M.range}|${M.customStart}|${M.customEnd}`,ae=async(t=!1)=>{let e=Sp();if(!t&&M.cache.has(e)){M.data=M.cache.get(e),M.error=null,se();return}let o=K();if(!o){M.error="Could not resolve the sub-account id from the URL.",se();return}M.loading=!0,M.error=null,se();try{let r={tenant_id:o,range:M.range,tz_offset_minutes:new Date().getTimezoneOffset()};M.range==="custom"&&(r.start=M.customStart,r.end=M.customEnd);let a=await fetch($p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),s=await a.json();if(!s||s.ok===!1)throw new Error(s&&s.error||`HTTP ${a.status}`);M.data=s,M.cache.set(e,s)}catch(r){M.error=r instanceof Error?r.message:String(r)}finally{M.loading=!1,se()}},L=(t,e,o)=>{let r=document.createElement(t);return r.style.cssText=e,o!==void 0&&(r.innerHTML=o),r},rt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),ao=`background:${n.graphite};border:1px solid ${n.slate};border-radius:${v.lg};padding:16px 18px;min-width:0;`,Cn=`font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:${n.ash};margin:0 0 12px;`,dt=(t,e,o)=>{let r=L("div",ao+"flex:1;min-width:150px;");return r.appendChild(L("div",Cn+"margin-bottom:8px;",rt(t))),r.appendChild(L("div",`font-family:${h.sans};font-size:24px;font-weight:600;color:${n.bone};line-height:1.1;`,rt(e))),o&&r.appendChild(L("div",`font-family:${h.sans};font-size:11px;color:${n.coolGray};margin-top:6px;`,rt(o))),r},Y=(t,e)=>{let o=L("div",ao);if(o.appendChild(L("div",Cn,rt(t))),!e.length)return o.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),o;let r=Math.max(...e.map(a=>a.barVal),1);for(let a of e.slice(0,12)){let s=L("div","margin:0 0 10px;"),i=L("div","display:flex;justify-content:space-between;gap:12px;margin-bottom:4px;");i.appendChild(L("span",`font-size:12px;color:${n.bone};overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`,rt(a.label)));let d=L("span",`font-size:12px;color:${n.bone};font-weight:600;white-space:nowrap;`,rt(a.primary)+(a.secondary?` <span style="color:${n.coolGray};font-weight:400;">${rt(a.secondary)}</span>`:""));i.appendChild(d),s.appendChild(i);let l=L("div",`height:6px;background:${n.slate};border-radius:3px;overflow:hidden;`);l.appendChild(L("div",`height:100%;width:${Math.max(2,Math.round(a.barVal/r*100))}%;background:${n.emerald};border-radius:3px;`)),s.appendChild(l),o.appendChild(s)}return e.length>12&&o.appendChild(L("div",`font-size:11px;color:${n.coolGray};`,`+${e.length-12} more`)),o},nr=(t,e,o)=>{let r=L("div",ao+"overflow-x:auto;");if(r.appendChild(L("div",Cn,rt(t))),!o.length)return r.appendChild(L("div",`font-size:12px;color:${n.coolGray};`,"No data in this range")),r;let a=`text-align:left;padding:6px 10px;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${n.ash};border-bottom:1px solid ${n.slate};white-space:nowrap;`,s=`padding:7px 10px;font-size:12px;color:${n.bone};border-bottom:1px solid ${n.slate};white-space:nowrap;`,i=`<table style="border-collapse:collapse;width:100%;min-width:480px;">
    <thead><tr>${e.map(d=>`<th style="${a}">${rt(d)}</th>`).join("")}</tr></thead>
    <tbody>${o.map(d=>`<tr>${d.map(l=>`<td style="${s}">${rt(l)}</td>`).join("")}</tr>`).join("")}</tbody>
  </table>`;return r.appendChild(L("div","",i)),r},Z=(t,e)=>{let o=L("div",`display:grid;grid-template-columns:${t};gap:14px;margin-bottom:14px;`);for(let r of e)o.appendChild(r);return o},no=t=>{let e=L("div","display:flex;flex-wrap:wrap;gap:14px;margin-bottom:14px;");for(let o of t)e.appendChild(o);return e},Ot=t=>(t||[]).map(e=>({label:e.label,primary:O(e.count),barVal:e.count})),Lp=t=>(t||[]).map(e=>({label:e.label,primary:V(e.sum),secondary:`\xB7 ${O(e.count)} deal${e.count===1?"":"s"}`,barVal:e.sum})),Ws=(t,e)=>{let o=t.calls||{};if(!o.available)return[L("div",`${ao}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Call metrics unavailable.</strong> ${rt(o.note||"CallStats.Sweep runs every 30 minutes \u2014 check back shortly.")}`)];let r=e==="acq"?"Seller":"Buyer",a=o[e]||[],s=a.filter(c=>c.dials>0||c.connects>0||c.inbound>0).map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${O(c.connects)} connected \xB7 ${O(c.inbound)} inbound`,barVal:c.dials})),i=a.filter(c=>c.talk_seconds>0).map(c=>({label:c.label,primary:ro(c.talk_seconds),secondary:c.talk_per_contract_seconds!=null?`\xB7 ${ro(c.talk_per_contract_seconds)} per contract`:"",barVal:c.talk_seconds})),d=[Y(`${r} calls per rep (dials)`,s),Y(`${r} talk time per rep`,i)],l=(o.other||[]).filter(c=>c.dials>0||c.talk_seconds>0);return l.length&&d.push(Y("Unclassified calls per rep (contact is neither seller nor buyer)",l.map(c=>({label:c.label,primary:`${O(c.dials)} dials`,secondary:`\xB7 ${ro(c.talk_seconds)} talk`,barVal:c.dials})))),d},Ip=(t,e)=>{let o=t.company||{},r=o.left_to_close_this_month||{};e.appendChild(no([dt("Closed revenue \u2014 365d",V(o.closed_revenue_365),`${O(o.closed_count_365)} closings`),dt("Avg deal size \u2014 365d",V(o.avg_deal_size_365)),dt("Left to close this month",V(r.sum),`${O(r.count)} deal(s)`+(r.missing_est_close?` \xB7 ${O(r.missing_est_close)} missing est. close date`:"")),dt("New leads",O(o.total_leads),"in selected range")])),e.appendChild(no([dt("Contracts",`${O((o.contracts||{}).count)}`,V((o.contracts||{}).sum)+" projected"),dt("Assignments",`${O((o.assignments||{}).count)}`,V((o.assignments||{}).sum)+" assigned"),dt("Deals closed",`${O((o.closed||{}).count)}`,V((o.closed||{}).sum)+" closed")])),e.appendChild(Z("1fr 1fr 1fr",[Y("New leads by source",Ot(o.new_leads_by_source)),Y("Contacts per closer (all time)",Ot(o.contacts_per_closer)),Y("Dispo deals per rep (all time)",Ot(o.dispo_deals_per_rep))]))},Mp=(t,e)=>{let o=t.acq||{};e.appendChild(Z("1fr 1fr",[Y("Offers made per rep",Ot(o.offers_per_rep)),Y("Contracts acquired per closer",(o.contracts_per_closer||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} projected`,barVal:a.count})))])),e.appendChild(Z("1fr 1fr",[Y("Projected revenue per closer (open escrows)",Lp(o.projected_per_closer)),Y("Closed revenue per closer",(o.closed_per_closer||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=Ws(t,"acq");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Pp=(t,e)=>{let o=t.dispo||{};e.appendChild(Z("1fr 1fr",[Y("Buyers qualified per dispo rep",Ot(o.buyers_qualified_per_rep)),Y("Assignments per dispo rep",(o.assignments_per_rep||[]).map(a=>({label:a.label,primary:O(a.count),secondary:`\xB7 ${V(a.sum)} assigned`,barVal:a.count})))])),e.appendChild(Z("1fr",[Y("Closed revenue per dispo rep",(o.closed_per_dispo||[]).map(a=>({label:a.label,primary:V(a.sum),secondary:`\xB7 ${O(a.count)} closings \xB7 avg ${V(a.avg)}`,barVal:a.sum})))]));let r=Ws(t,"dispo");e.appendChild(r.length>=2?Z("1fr 1fr",r.slice(0,2)):Z("1fr",r)),r.length>2&&e.appendChild(Z("1fr",r.slice(2)))},Op=(t,e)=>{let o=t.marketing||{},r=o.lead_quality||{};e.appendChild(no([dt("Open leads",O(r.open)),dt("Won (under contract+)",O(r.won)),dt("Lost / dead",O(r.lost))]));let a=(o.per_channel||[]).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[nr("Per marketing channel",["Channel","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],a)]));let s=(o.per_city||[]).slice(0,15).map(i=>[i.label,O(i.leads),O(i.offers),O(i.contracts),`${O(i.assigned_count)} / ${V(i.assigned_sum)}`,`${O(i.closed_count)} / ${V(i.closed_sum)}`,V(i.avg_deal)]);e.appendChild(Z("1fr",[nr("Per city (top 15 by leads)",["City","Leads","Offers","Contracts","Assigned (# / $)","Closed (# / $)","Avg deal"],s)])),e.appendChild(Z("1fr 1fr",[Y("Dead leads by channel",Ot(o.dead_by_channel)),Y("Dead leads by city",Ot(o.dead_by_city))]))},Bp=(t,e)=>{let o=t.tc||{};e.appendChild(no([dt("Contracted",O(o.contracted),"in selected range"),dt("Closed",O(o.closed)),dt("Lost in escrow",O(o.lost_in_escrow)),dt("Fall-out rate",o.fallout_rate_pct==null?"\u2014":`${o.fallout_rate_pct}%`,"lost \xF7 (closed + lost)")])),e.appendChild(Z("1fr 1fr",[Y("Deals per TC (contracted in range)",Ot(o.per_tc)),Y("Open escrows by stage",Ot(o.open_by_stage))]));let r=(o.board||[]).map(a=>[a.name,a.stage,a.owner,V(a.value),$n(a.est_close),a.acq_closer,a.dispo_rep]);e.appendChild(Z("1fr",[nr("TC deal board (open escrows)",["Deal","Stage","TC","Value","Est. close","Closer","Dispo"],r)]))},Rp=(t,e)=>{let o=t.velocity||{},r=o.offers_per_contract||{};e.appendChild(no([dt("Offers per contract",r.ratio==null?"\u2014":String(r.ratio),`${O(r.offers)} offers \xB7 ${O(r.contracts)} contracts`)]));let a=d=>(d||[]).map(l=>({label:l.label,primary:`${l.avg_days} days`,secondary:`\xB7 ${O(l.n)} deal${l.n===1?"":"s"}`,barVal:l.avg_days}));e.appendChild(Z("1fr 1fr",[Y("Days lead \u2192 contract, by source",a(o.days_to_contract_by_source)),Y("Days contract \u2192 close, by source",a(o.days_contract_to_close_by_source))]));let s=(o.leads_per_contract_by_source||[]).map(d=>[d.label,O(d.leads),O(d.contracts),d.ratio==null?"\u2014":`${d.ratio} : 1`]);e.appendChild(Z("1fr",[nr("Leads per contract, by source",["Source","Leads","Contracts","Leads : contract"],s)]));let i=o.talk_time||{};if(i.available){let d=(i.per_rep||[]).filter(l=>l.talk_seconds>0).map(l=>({label:l.label,primary:l.talk_per_contract_seconds!=null?`${ro(l.talk_per_contract_seconds)} / contract`:"\u2014",secondary:`\xB7 ${ro(l.talk_seconds)} total \xB7 ${O(l.contracts)} contract${l.contracts===1?"":"s"}`,barVal:l.talk_per_contract_seconds!=null?l.talk_per_contract_seconds:0}));e.appendChild(Z("1fr",[Y("Talk time per contract per rep",d)]))}else e.appendChild(L("div",`${ao}border-left:3px solid ${n.amber};border-radius:0 ${v.lg} ${v.lg} 0;font-size:12px;color:${n.ash};`,`<strong style="color:${n.bone};">Talk time per contract per rep \u2014 pending first sweep.</strong> ${rt(i.note||"")}`))},oo=t=>`padding:5px 12px;border-radius:${v.pill};border:1px solid ${t?n.emeraldBorder:n.steel};background:${t?n.emeraldGlow:"transparent"};color:${t?n.emerald:n.ash};font-family:${h.sans};font-size:12px;font-weight:500;cursor:pointer;white-space:nowrap;`,se=()=>{let t=document.getElementById(rr);if(!t)return;let e=t.querySelector("[data-ws-analytics-body]"),o=t.querySelector("[data-ws-analytics-controls]");if(!e||!o)return;o.innerHTML="";let r=L("div","display:flex;flex-wrap:wrap;gap:6px;align-items:center;");for(let _ of Cp){let b=L("button",oo(M.range===_.key),rt(_.label));b.onclick=()=>{M.range=_.key,_.key!=="custom"?ae():se()},r.appendChild(b)}if(M.range==="custom"){let _=`background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:12px;padding:4px 8px;color-scheme:dark;`,b=L("input",_);b.type="date",b.value=M.customStart;let g=L("input",_);g.type="date",g.value=M.customEnd;let x=L("button",oo(!0),"Apply");x.onclick=()=>{M.customStart=b.value,M.customEnd=g.value,M.customStart&&M.customEnd&&ae()},r.appendChild(b),r.appendChild(g),r.appendChild(x)}let a=L("button",oo(!1)+"margin-left:auto;","\u21BB Refresh");a.onclick=()=>void ae(!0),r.appendChild(a),o.appendChild(r);let s=L("div","display:flex;flex-wrap:wrap;gap:6px;margin-top:10px;");for(let _ of Ap){let b=L("button",oo(M.tab===_.key),rt(_.label));b.onclick=()=>{M.tab=_.key,se()},s.appendChild(b)}if(o.appendChild(s),e.innerHTML="",M.loading){e.appendChild(L("div",`padding:60px;text-align:center;color:${n.ash};font-family:${h.sans};font-size:13px;`,"Computing analytics\u2026"));return}if(M.error){let _=L("div",`padding:40px;text-align:center;color:${n.crimson};font-family:${h.sans};font-size:13px;`,`Couldn't load analytics: ${rt(M.error)}`),b=L("button",oo(!0)+"margin:14px auto 0;display:inline-block;","Retry");b.onclick=()=>void ae(!0);let g=L("div","text-align:center;");g.appendChild(_),g.appendChild(b),e.appendChild(g);return}let i=M.data;if(!i){ae();return}let d=i.range||{},l=Number((i.calls||{}).last_swept)||0,c=l>0?` \xB7 calls as of ${new Date(l).toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})} (syncing)`:"";e.appendChild(L("div",`font-family:${h.mono};font-size:10px;letter-spacing:0.06em;text-transform:uppercase;color:${n.coolGray};margin:0 0 12px;`,`${rt(d.label||"")} \xB7 ${$n(d.start)} \u2192 ${$n(d.end)} \xB7 ${O((i.meta||{}).opps)} opps \xB7 ${O((i.meta||{}).contacts)} contacts${c}`));let m=i.insights||[];if(m.length){let _=L("div","display:flex;flex-direction:column;gap:6px;margin:0 0 16px;");for(let b of m.slice(0,6)){let g=b.level==="warn";_.appendChild(L("div",`padding:8px 12px;border-left:3px solid ${g?n.amber:n.blue};background:${g?n.amberGlow:n.blueGlow};border-radius:0 ${v.sm} ${v.sm} 0;font-family:${h.sans};font-size:12px;color:${n.bone};`,rt(b.text)))}e.appendChild(_)}let u=L("div","");M.tab==="company"?Ip(i,u):M.tab==="acq"?Mp(i,u):M.tab==="dispo"?Pp(i,u):M.tab==="marketing"?Op(i,u):M.tab==="tc"?Bp(i,u):Rp(i,u),e.appendChild(u)},ie=null,Hp=()=>{let t=K();if(t){try{fetch(Tp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({mode:"sync",tenant_id:t})}).catch(()=>{})}catch{}ie&&window.clearTimeout(ie),ie=window.setTimeout(()=>{ie=null,M.open&&(M.cache.clear(),ae(!0))},9e4)}},Tn=()=>{if(document.getElementById(rr))return;M.open=!0,Hp();let t=L("div",`position:fixed;inset:0;z-index:100000;background:${n.obsidian};display:flex;flex-direction:column;font-family:${h.sans};`);t.id=rr;let e=L("div",`padding:18px 24px 14px;border-bottom:1px solid ${n.slate};flex-shrink:0;`),o=L("div","display:flex;align-items:center;gap:12px;margin-bottom:12px;");o.appendChild(L("div",`font-family:${h.mono};font-size:13px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:${n.bone};`,`Analytics <span style="color:${n.emerald};">\xB7</span> <span style="color:${n.ash};">REInvest OS</span>`));let r=L("button",`margin-left:auto;background:transparent;border:1px solid ${n.steel};border-radius:${v.sm};color:${n.ash};font-size:14px;line-height:1;padding:6px 10px;cursor:pointer;`,"\u2715");r.onclick=Ks,o.appendChild(r),e.appendChild(o),e.appendChild(L("div","","")).setAttribute("data-ws-analytics-controls","1"),t.appendChild(e);let a=L("div","flex:1;overflow-y:auto;padding:20px 24px 40px;");a.setAttribute("data-ws-analytics-body","1"),t.appendChild(a),document.body.appendChild(t),document.addEventListener("keydown",Gs),se(),M.data||ae()},Gs=t=>{t.key==="Escape"&&Ks()},Ks=()=>{M.open=!1,ie&&(window.clearTimeout(ie),ie=null),document.getElementById(rr)?.remove(),document.removeEventListener("keydown",Gs)},Dp=["/kpis","ws-kpis","ws-analytics"],Fp=/\/custom-menu-link\//,En=!1,Us=()=>{if(En||!Fp.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Dp.some(i=>s.includes(i))});if(r){En=!0,p.info(`[analytics] custom-menu-link route detected (src=${r.src}) \u2014 opening overlay`);try{history.back()}catch{}setTimeout(()=>{Tn(),En=!1},50);return}t<10&&setTimeout(e,150)};e()},js=!1,Vs=()=>{if(js)return;js=!0,_t(()=>setTimeout(Us,50)),Us();let t=()=>{let e=window.location.hash.replace("#","");(e==="ws-analytics"||e==="ws-kpis")&&Tn()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_ANALYTICS=()=>Tn(),p.info("[analytics] mounted (menu-link route + hash + window trigger)")};var Qs="ws-buybox-nav-icon",Ln="ws-buybox-panel",Ys="ws-buybox-modal",zp="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buy-box/manage",In="https://mcclivetim.github.io/reinvest-os-cdn/geo",ar=null,so=null,io=null,Sn=async()=>{if(ar)return ar;try{let t=await fetch(`${In}/states.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);return ar=await t.json(),ar}catch(t){return p.error("[buy-box] failed to fetch states.json",t),[]}},Np=async t=>{if(!so)try{let e=await fetch(`${In}/counties.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);so=await e.json()}catch(e){return p.error("[buy-box] failed to fetch counties.json",e),[]}return so?.[t]??[]},qp=async t=>{if(!io)try{let e=await fetch(`${In}/cities.json`);if(!e.ok)throw new Error(`HTTP ${e.status}`);io=await e.json()}catch(e){return p.error("[buy-box] failed to fetch cities.json",e),[]}return io?.[t]??[]},Mn=async t=>await(await fetch(zp,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),Up=(t,e)=>Mn({tenant_id:t,action:"list",buyer_contact_id:e}),jp=(t,e,o,r)=>Mn({tenant_id:t,action:"add",buyer_contact_id:e,geo_level:o,geo_value:r}),Wp=(t,e)=>Mn({tenant_id:t,action:"remove",entry_id:e}),G=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Gp=(t,e)=>{let o=e.find(r=>r.code===t);return o?`${o.name} (${t})`:t},Kp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg>',Vp='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="16" height="16"><path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-9 4h12l-1 13a2 2 0 01-2 2H9a2 2 0 01-2-2L6 7zM4 7h16M10 11v6M14 11v6" /></svg>',Yp="nav.w-13, nav[class*='w-13']",Jp=".flex-1.h-full.relative.overflow-hidden.rounded-lg",Qp=async()=>{try{return await P(Yp,{timeoutMs:2500})}catch{return null}},Zp=async()=>{try{return await P(Jp,{timeoutMs:2500})}catch{return null}},Xp=t=>t.querySelector("div[class*='bg-contacts-panel']")??null,tm=(t,e)=>{let o=document.createElement("div");return o.id=Ln,o.dataset.buyerContactId=e,o.style.cssText=`
  ...
  `,o.querySelector("#ws-buybox-add")?.addEventListener("click",()=>{nm(t,e,()=>Pn(t,e))}),o},Pn=async(t,e)=>{let o=document.querySelector("#ws-buybox-body");if(o)try{let[r,a]=await Promise.all([Up(t,e),Sn()]);if(!r.ok){o.innerHTML=`<div style="color: ${n.crimson};">${G(r.error||"Failed to load buy-box entries")}</div>`;return}em(o,r.grouped||{state:[],county:[],city:[],zip:[]},a,t,e)}catch(r){o.innerHTML=`<div style="color: ${n.crimson};">Network error: ${G(r.message)}</div>`}},em=(t,e,o,r,a)=>{if(e.state.length+e.county.length+e.city.length+e.zip.length===0){t.innerHTML=`
    ...
    `;return}let d=[{key:"state",label:"States"},{key:"county",label:"Counties"},{key:"city",label:"Cities"},{key:"zip",label:"Zip Codes"}].filter(l=>e[l.key].length>0).map(l=>{let c=e[l.key].map(m=>{let u=l.key==="state"?Gp(m.geo_value,o):m.geo_value;return`
      ...
      `}).join("");t.innerHTML=d,t.querySelectorAll(".ws-buybox-remove").forEach(l=>{l.addEventListener("mouseenter",()=>{l.style.color=n.crimson}),l.addEventListener("mouseleave",()=>{l.style.color=n.ash}),l.addEventListener("click",()=>{let c=l.dataset.entryId||"",m=l.dataset.entryLabel||"this area";confirm(`Remove "${m}" from this buyer's buy-box?`)&&(l.disabled=!0,Wp(r,c).then(u=>{if(!u.ok){alert(`Failed to remove: ${u.error||"unknown error"}`),l.disabled=!1;return}Pn(r,a)}).catch(u=>{alert(`Network error: ${u.message}`),l.disabled=!1}))})})},sr=!1,Zs=(t,e)=>{sr=e;let o=Xp(t.panelArea);console.log(`[buy-box] setActive(${e}) \u2014 nativePanel=${!!o} panel=${!!t.panel} iconBtn=${!!t.iconBtn}`),e?(t.iconBtn.className=om,t.iconBtn.dataset.active="true",o&&(t.nativePanelOriginalDisplay=o.style.display||"",o.style.display="none"),t.panel.style.display="flex",Pn(t.tenantId,t.buyerContactId)):(t.iconBtn.className=Xs,delete t.iconBtn.dataset.active,t.panel.style.display="none",o&&(o.style.display=t.nativePanelOriginalDisplay||""))},Xs="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",om="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",rm=t=>{let e=document.createElement("button");return e.id=Qs,e.type="button",e.title="Buy-Box",e.setAttribute("aria-label","Buy-Box"),e.className=Xs,e.innerHTML=`<span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; line-height: 0; pointer-events: none;">${Kp.replace("<svg ",'<svg style="pointer-events: none;" ')}</span>`,e.addEventListener("click",o=>{o.stopPropagation();let r=t();if(!r){console.warn("[buy-box] icon clicked but currentState is null");return}let a=!sr;console.log(`[buy-box] icon clicked \u2192 turningOn=${a}`),Zs(r,a)}),e},nm=(t,e,o)=>{let r=document.getElementById(Ys);r&&r.remove();let a=document.createElement("div");a.id=Ys,a.style.cssText=`
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",w=>{w.target===a&&a.remove()});let i={step:1,granularity:null,stateCode:null,value:null},d=async()=>{if(i.step===1)s.innerHTML=l(),c();else if(i.step===2){s.innerHTML=m();let w=await Sn();s.innerHTML=u(w),_(w)}else if(i.step===3)if(i.granularity==="zip")s.innerHTML=f(),$();else if(i.granularity==="state"){let w=await Sn();s.innerHTML=g(w),x(w)}else i.granularity==="county"?(s.innerHTML=b(i.stateCode||""),await Np(i.stateCode||""),s.innerHTML=k("County"),y()):i.granularity==="city"&&(s.innerHTML=b(i.stateCode||""),await qp(i.stateCode||""),s.innerHTML=k("City"),y())},l=()=>`
  ...
  `,$=()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err");w&&(w.addEventListener("input",()=>{w.value=w.value.replace(/\D/g,"").slice(0,5),E&&(E.textContent="")}),w.addEventListener("keydown",S=>{S.key==="Enter"&&(S.preventDefault(),A())}),s.querySelector("#ws-buybox-back")?.addEventListener("click",()=>{i.step=1,d()}),s.querySelector("#ws-buybox-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-buybox-save")?.addEventListener("click",()=>void A()),setTimeout(()=>w.focus(),0))},A=async()=>{let w=s.querySelector("#ws-buybox-zip"),E=s.querySelector("#ws-buybox-err"),S=(w?.value||"").trim();if(!/^\d{5}$/.test(S)){E&&(E.textContent="Zip must be exactly 5 digits.");return}await T(S)},T=async w=>{if(!i.granularity||!w)return;let E=s.querySelector("#ws-buybox-err"),S=s.querySelector("#ws-buybox-save");S&&(S.disabled=!0,S.textContent="Adding\u2026"),E&&(E.textContent="");try{let B=await jp(t,e,i.granularity,w);if(!B.ok){E&&(E.textContent=B.error||"Failed to add entry."),S&&(S.disabled=!1,S.textContent="Add");return}o(),s.innerHTML=`
      ...
      `,setTimeout(()=>{i.step=1,i.granularity=null,i.stateCode=null,i.value=null,d()},900)}catch(B){E&&(E.textContent=`Network error: ${B.message}`),S&&(S.disabled=!1,S.textContent="Add")}};d()},An=!1,ge=null,lo=null,Js=()=>{document.getElementById(Qs)?.remove(),document.getElementById(Ln)?.remove(),lo&&ge&&ge.nav.removeEventListener("click",lo,!0),lo=null,ge=null,sr=!1},ti=()=>{am()},am=async()=>{if(!An){An=!0;try{let t=D();if(!t){Js();return}let e=document.getElementById(Ln);if(e&&e.dataset.buyerContactId===t.contactId&&ge)return;Js();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(u){p.warn("[buy-box] Contact Type fetch failed",u);return}if(Tt(o)!=="buyer")return;if(!t.locationId){p.warn("[buy-box] no locationId in context; can't mount widget");return}let[a,s]=await Promise.all([Qp(),Zp()]);if(!a||!s){p.warn("[buy-box] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=tm(t.locationId,t.contactId),l=rm(()=>ge),c={buyerContactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d,nativePanelOriginalDisplay:""};ge=c;let m=a.querySelector(".flex.flex-col.items-center.gap-2");m?m.appendChild(l):a.appendChild(l),s.appendChild(d),lo=u=>{let _=u.target;if(!_||c.iconBtn.contains(_))return;_.closest("button.sidebar-option-button")&&sr&&Zs(c,!1)},a.addEventListener("click",lo,!0),p.info(`[buy-box] right-rail mount complete for buyer ${t.contactId}`)}finally{An=!1}}};var ri="ws-properties-nav-icon",Hn="ws-properties-panel",ei="ws-properties-modal",Dn="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property",sm=`${Dn}/list-for-contact`,im=`${Dn}/create-with-opp`,lm=`${Dn}/add-contact`,dm=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],mt=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),cm=(t,e)=>`/v2/location/${t}/objects/property/list?recordId=${e}`,ni=t=>{if(t==null||t==="")return null;let e=Number(String(t).replace(/[^0-9.\-]/g,""));return Number.isFinite(e)&&e!==0?e:null},ir=t=>{let e=ni(t);if(e===null)return"&mdash;";let o=Math.abs(e);return o>=1e6?`$${(e/1e6).toFixed(e%1e6?1:0)}M`:o>=1e3?`$${Math.round(e/1e3)}k`:`$${Math.round(e)}`},On=t=>{let e=ni(t);return e===null?"&mdash;":e.toLocaleString()},ai={easy:"Paint & Flooring",minor_rehab:"Kitchen & Bath",full_cosmetic:"Full Cosmetic",major_repairs:"Roof & Systems"},pm=t=>{let e=(t||"").toString().trim();return e?mt(ai[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase())):"&mdash;"},mm=t=>{let e=(t||"").toString().trim();return e?ai[e]||e:""},bm={single_family_residence_sfr:"Single Family Residence (SFR)",multifamily_24_units:"Multi-Family 2-4 Units",multifamily_5_units:"Multi-Family 5+ Units",land:"Land",commercial:"Commercial",mobile_home:"Mobile Home"},hm=t=>{let e=(t||"").toString().trim();return e?bm[e]||e.replace(/_/g," ").replace(/\b\w/g,o=>o.toUpperCase()):""},Ut=(t,e,o)=>`<div style="min-width:0;"><div style="font-size:9px;color:${n.ash};text-transform:uppercase;letter-spacing:.4px;">${t}</div><div title="${mt(o||"")}" style="font-size:12px;color:${n.bone};font-weight:500;line-height:1.25;word-break:break-word;">${e}</div></div>`,um=t=>`
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px;padding-top:10px;border-top:1px solid ${n.steel};">
    ...
    ${Ut("Baths",On(t.baths))}
    ${Ut("Sq Ft",On(t.sqft))}
    ${Ut("Rehab",pm(t.rehab_level),mm(t.rehab_level))}
    ${Ut("ARV",ir(t.arv))}
    ${Ut("IMV",ir(t.imv))}
    ${Ut("MAO",ir(t.mao))}
    ${Ut("Ask",ir(t.asking_price))}
  </div>`,si=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4e3)},_m='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>',vm='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" width="15" height="15"><path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>',ym="nav.w-13, nav[class*='w-13']",gm=".flex-1.h-full.relative.overflow-hidden.rounded-lg",ii="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-gray-900 hover:text-blue-600",fm="relative w-8 h-8 rounded-lg flex items-center justify-center sidebar-option-button text-blue-600 bg-white",xm=async()=>{try{return await P(ym,{timeoutMs:2500})}catch{return null}},wm=async()=>{try{return await P(gm,{timeoutMs:2500})}catch{return null}},Fn=async(t,e)=>await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"})).json(),Ct=`width:100%;box-sizing:border-box;padding:8px 10px;background:${n.obsidian};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:13px;outline:none;margin-bottom:10px;`,At=`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,zn=`background:${n.emerald};color:${n.bone};border:none;border-radius:${v.sm};padding:8px 18px;cursor:pointer;font-family:${h.sans};font-size:13px;font-weight:600;`,li=`background:transparent;color:${n.ash};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 16px;cursor:pointer;font-family:${h.sans};font-size:13px;`,km=(t,e)=>{let o=document.createElement("div");return o.id=Hn,o.dataset.contactId=e,o.style.cssText=`
  ...
  `,o.innerHTML=`
    <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px 10px 16px;border-bottom:1px solid ${n.steel};">
      ...
      <div style="display:flex;align-items:center;gap:8px;">
        <button id="ws-prop-add" type="button" style="${zn}">+ Add Property</button>
  ...
  `,o.querySelector("#ws-prop-add")?.addEventListener("click",()=>{$m(t,e,()=>Nn(t,e))}),o},Nn=async(t,e)=>{let o=document.querySelector("#ws-prop-body");if(o)try{let r=await Fn(sm,{tenant_id:t,contact_id:e});if(!r.ok){o.innerHTML=`<div style="color:${n.crimson};">${mt(r.error||"Failed to load properties")}</div>`;return}Em(o,r.properties||[],t,e)}catch(r){o.innerHTML=`<div style="color:${n.crimson};">Network error: ${mt(r.message)}</div>`}},Em=(t,e,o,r)=>{if(!e.length){t.innerHTML=`<div style="text-align:center;padding:32px 0;color:${n.ash};">No properties yet.<br><span style="font-size:12px;">Click "+ Add Property" to create one (a deal is created automatically).</span></div>`;return}t.innerHTML=e.map(a=>{let s=/lost|abandon/i.test(a.deal_stage||""),i=s?n.crimson:n.emeraldBright,d=s?n.steel:n.emeraldBorder,l=a.has_acq_opp?`<span title="Deal stage" style="font-size:10px;color:${i};border:1px solid ${d};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">${mt(a.deal_stage||"Deal")}</span>`:`<span title="No ACQ deal yet" style="font-size:10px;color:${n.amber};border:1px solid ${n.steel};border-radius:${v.sm};padding:1px 7px;white-space:nowrap;flex:0 0 auto;">No deal</span>`,c=(a.roles||[]).map(m=>m==="seller_1"?"Seller 1":m==="seller_2"?"Seller 2":m==="tenant_contact"?"Tenant":m).join(", ");return`
      <div style="border:1px solid ${n.steel};border-radius:${v.md};padding:10px 12px;margin-bottom:10px;">
        ...
        <div style="font-size:11px;color:${n.ash};margin-top:3px;">${mt(c||"")}${a.property_type?" &middot; "+mt(hm(a.property_type)):""}</div>
        ${um(a)}
        <div style="margin-top:10px;">
          <button type="button" class="ws-prop-addperson" data-prop="${mt(a.property_record_id)}" data-addr="${mt(a.address)}" style="background:transparent;border:1px solid ${n.steel};color:${n.ash};border-radius:${v.sm};padding:4px 10px;cursor:pointer;font-family:${h.sans};font-size:12px;display:inline-flex;align-items:center;gap:5px;">${vm} Add person</button>
        </div>
      </div>
    `}).join(""),t.querySelectorAll(".ws-prop-addperson").forEach(a=>{a.addEventListener("click",()=>{Tm(o,a.dataset.prop||"",a.dataset.addr||"this property",()=>Nn(o,r))})}),t.querySelectorAll(".ws-prop-open").forEach(a=>{a.addEventListener("click",()=>{let s=a.dataset.prop||"";s&&window.open(cm(o,s),"_blank","noopener")}),a.addEventListener("mouseenter",()=>{a.style.color=n.emeraldBright}),a.addEventListener("mouseleave",()=>{a.style.color=n.bone})})},di=()=>{document.getElementById(ei)?.remove();let t=document.createElement("div");t.id=ei,t.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let e=document.createElement("div");return e.style.cssText=`width:min(440px,92vw);background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`,t.appendChild(e),document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&t.remove()}),{overlay:t,card:e}},$m=(t,e,o)=>{let{overlay:r,card:a}=di();a.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wp-save" type="button" style="${zn}">Create property + deal</button>
    </div>
  `;let s=a.querySelector("#wp-err");a.querySelector("#wp-cancel")?.addEventListener("click",()=>r.remove()),a.querySelector("#wp-save")?.addEventListener("click",async()=>{let i=b=>(a.querySelector(b)?.value||"").trim(),d=i("#wp-address"),l=i("#wp-city"),c=i("#wp-state"),m=i("#wp-zip"),u=(a.querySelector("#wp-type")?.value||"").trim();if(!d&&!l&&!m){s&&(s.textContent="Enter at least a street address.");return}let _=a.querySelector("#wp-save");_&&(_.disabled=!0,_.textContent="Creating\u2026"),s&&(s.textContent="");try{let b=await Fn(im,{tenant_id:t,contact_id:e,address:d,city:l,state:c,zip:m,property_type:u||void 0});if(!b.ok){s&&(s.textContent=b.error||"Failed to create property."),_&&(_.disabled=!1,_.textContent="Create property + deal");return}r.remove(),si("Property + deal created \u2713"),o()}catch(b){s&&(s.textContent=`Network error: ${b.message}`),_&&(_.disabled=!1,_.textContent="Create property + deal")}}),setTimeout(()=>a.querySelector("#wp-address")?.focus(),0)},Tm=(t,e,o,r)=>{let{overlay:a,card:s}=di();s.innerHTML=`
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;">
      ...
      <button id="wpp-save" type="button" style="${zn}">Add person</button>
    </div>
  `;let i=s.querySelector("#wpp-err");s.querySelector("#wpp-cancel")?.addEventListener("click",()=>a.remove()),s.querySelector("#wpp-save")?.addEventListener("click",async()=>{let d=s.querySelector("#wpp-role")?.value||"seller_2",l=g=>(s.querySelector(g)?.value||"").trim(),c=l("#wpp-first"),m=l("#wpp-last"),u=l("#wpp-phone"),_=l("#wpp-email");if(!c&&!m){i&&(i.textContent="Enter at least a first or last name.");return}let b=s.querySelector("#wpp-save");b&&(b.disabled=!0,b.textContent="Adding\u2026"),i&&(i.textContent="");try{let g=await Fn(lm,{tenant_id:t,property_record_id:e,role:d,new_contact:{firstName:c,lastName:m,phone:u||void 0,email:_||void 0}});if(!g.ok){i&&(i.textContent=g.error||"Failed to add person."),b&&(b.disabled=!1,b.textContent="Add person");return}a.remove(),si("Person added \u2713"),r()}catch(g){i&&(i.textContent=`Network error: ${g.message}`),b&&(b.disabled=!1,b.textContent="Add person")}}),setTimeout(()=>s.querySelector("#wpp-first")?.focus(),0)},lr=!1,ut=null,Bn=!1,co=null,Cm=(t,e,o)=>{let r=e.getBoundingClientRect(),a=null;try{a=o?o.getBoundingClientRect():null}catch{a=null}let s=!!(a&&a.height>40&&a.width>=280&&a.width<=520&&a.left>=r.left-560),i=s&&a?Math.round(a.width):400,d=Math.round(s&&a?a.top:r.top),l=Math.round(s&&a?a.height:r.height),c=6;t.style.top=`${d}px`,t.style.height=`${l}px`,t.style.width=`${i}px`,t.style.left=`${Math.round(r.left-i-c)}px`,t.style.right="auto",t.style.bottom="auto"},Am=()=>{try{let t=new URL(window.location.href);t.searchParams.get("view")!=="activities"&&(t.searchParams.set("view","activities"),history.replaceState(history.state,"",t.toString()))}catch{}},Rn=(t,e)=>{lr=e,e?(t.iconBtn.className=fm,t.iconBtn.dataset.active="true",Am(),Cm(t.panel,t.nav,t.panelArea),t.panel.style.display="flex",Nn(t.tenantId,t.contactId)):(t.iconBtn.className=ii,delete t.iconBtn.dataset.active,t.panel.style.display="none")},Sm=()=>{let t=document.createElement("button");return t.id=ri,t.type="button",t.title="Properties",t.setAttribute("aria-label","Properties"),t.className=ii,t.innerHTML=`<span style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:block;line-height:0;pointer-events:none;">${_m.replace("<svg ",'<svg style="pointer-events:none;" ')}</span>`,t.addEventListener("click",e=>{e.stopPropagation(),ut&&Rn(ut,!lr)}),t},oi=()=>{document.getElementById(ri)?.remove(),document.getElementById(Hn)?.remove(),co&&ut&&ut.nav.removeEventListener("click",co,!0),co=null,ut=null,lr=!1},ci=()=>{Lm()},Lm=async()=>{if(!Bn){Bn=!0;try{let t=D();if(!t||!t.locationId){oi();return}let e=document.getElementById(Hn);if(e&&e.dataset.contactId===t.contactId&&ut)return;oi();let o=null;try{o=await $t(t.contactId,t.locationId)}catch(m){p.warn("[properties] Contact Type fetch failed",m);return}if(Tt(o)!=="seller")return;let[a,s]=await Promise.all([xm(),wm()]);if(!a||!s){p.warn("[properties] right-rail nav or panel area not found");return}let i=D();if(!i||i.contactId!==t.contactId)return;let d=km(t.locationId,t.contactId),l=Sm();ut={contactId:t.contactId,tenantId:t.locationId,nav:a,panelArea:s,iconBtn:l,panel:d},(a.querySelector(".flex.flex-col.items-center.gap-2")||a).appendChild(l),document.body.appendChild(d),d.querySelector("#ws-prop-close")?.addEventListener("click",()=>{ut&&Rn(ut,!1)}),co=m=>{let u=m.target;!u||ut&&ut.iconBtn.contains(u)||u.closest("button.sidebar-option-button")&&lr&&ut&&Rn(ut,!1)},a.addEventListener("click",co,!0),p.info(`[properties] right-rail mount complete for seller ${t.contactId}`)}finally{Bn=!1}}};var pi="ws-non-seller-contact",mi=()=>{Im()},Im=async()=>{let t=D();if(!t||!t.contactId||!t.locationId){document.documentElement.classList.remove(pi);return}let e="seller";try{e=Tt(await $t(t.contactId,t.locationId))}catch(o){p.warn("[seller-flag] contact-type resolve failed",o)}document.documentElement.classList.toggle(pi,e!=="seller")};var jt="ws-crm-claim-release-pill",Mm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-get",Pm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/claim-release-set",Om=async t=>{let e=await fetch(Mm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Get returned ${e.status} ${e.statusText}`);return await e.json()},Bm=async t=>{let e=await fetch(Pm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,contact_id:t.contactId,triggered_by_user_id:t.userId,action:t.action}),credentials:"omit"});if(!e.ok)throw new Error(`Claim/Release Set returned ${e.status} ${e.statusText}`);return await e.json()},ui=t=>{let e=Array.from(t.children).find(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.className?.toString()??"";return a.includes("flex")&&a.includes("flex-col")});return e?e.querySelector(".flex.items-center, [class~='flex'][class~='items-center']")??null:null},xe=(t,e)=>{let o=e==="claim"?"emerald":"amber",r=e==="claim"?n.emerald:n.amber;t.dataset.mode=e,t.style.cssText=Rs(o),t.title=e==="claim"?"Take ownership of this lead":"Return this lead to the pool",t.innerHTML=`
    <span style="
      width: 6px;
      height: 6px;
      border-radius: 50%;
  ...
  `},Rm=({contactId:t,mode:e})=>{let o=document.createElement("button");return o.id=jt,o.type="button",o.dataset.contactId=t,xe(o,e),o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",async()=>{let r=o.dataset.mode??"claim",a=D();if(!a||!a.locationId||a.contactId!==t)return;let s=H();if(!s){p.warn("Claim/Release click: no user ID detected (login session not exposing it)");let d=o.querySelector(".ws-cr-label");d&&(d.textContent="Sign-in needed"),setTimeout(()=>xe(o,r),2500);return}p.info(`Claim/Release click \u2014 contact=${t} mode=${r} user=${s}`);let i=r==="claim"?"release":"claim";xe(o,i),o.disabled=!0,o.style.opacity="0.8";try{let d=await Bm({contactId:t,locationId:a.locationId,userId:s,action:r}),l=d?.mode==="claim"||d?.mode==="release"?d.mode:i;xe(o,l),p.info(`Claim/Release done \u2192 new mode: ${l}`)}catch(d){p.error("Claim/Release Set webhook failed",d),xe(o,r);let l=o.querySelector(".ws-cr-label");if(l){let c=l.textContent??"";l.textContent="Try again",setTimeout(()=>{l.textContent==="Try again"&&(l.textContent=c)},2500)}}finally{o.disabled=!1,o.style.opacity="1"}}),o},bi=async t=>{try{let e=await Om({contactId:t.contactId,locationId:t.locationId,userId:H()}),o=document.getElementById(jt);if(!o||o.dataset.contactId!==t.contactId)return;let r=e?.mode==="release"?"release":"claim";xe(o,r)}catch(e){p.warn("Claim/Release Get failed; pill stays in default 'claim' mode",e)}},Hm=async(t,e=1e4)=>{let o=Date.now();for(;Date.now()-o<e;){let r=ui(t);if(r)return r;await new Promise(a=>setTimeout(a,150))}return null},hi=(t,e)=>{let o=Rm({contactId:e,mode:"claim"}),r=document.createElement("span");r.id=`${jt}-wrap`,r.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 12px;
    vertical-align: middle;
  `,r.appendChild(o),t.appendChild(r)},fe=null,Dm=async()=>{let t=D();if(!t){fe?.disconnect(),fe=null,document.getElementById(jt)?.remove();return}let e=document.getElementById(jt);if(!(e&&e.dataset.contactId===t.contactId)){e&&e.remove();try{let o=await P("#record-details-lhs",{timeoutMs:1e4}),r=await Hm(o),a=D();if(!a||a.contactId!==t.contactId)return;if(!r){p.warn("Claim/Release pill \u2014 name row not found within timeout; skipping mount");return}hi(r,t.contactId),p.debug(`Mounted Claim/Release pill next to name for ${t.contactId}`),document.getElementById(jt)&&t.locationId&&bi({contactId:t.contactId,locationId:t.locationId}),fe?.disconnect(),fe=new MutationObserver(async()=>{if(!(D()?.contactId===t.contactId)){fe?.disconnect();return}if(document.getElementById(jt))return;let d=ui(o);d&&(hi(d,t.contactId),document.getElementById(jt)&&t.locationId&&bi({contactId:t.contactId,locationId:t.locationId}),p.debug("Re-mounted Claim/Release pill after React wipe"))}),fe.observe(o,{childList:!0,subtree:!0})}catch(o){p.warn("Could not mount Claim/Release pill:",o)}}},_i=()=>{Dm()};var ki="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/call-status-set",Fm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/buyer-call-status/set",zm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/appointment-status",Nm=async({contactId:t,locationId:e,status:o,userId:r,deadReason:a,webhookUrl:s,kind:i})=>{let d=s||ki,l;if(i==="buyer"){let m=Ti.find(_=>_.label===o),u=m?m.value:o.toLowerCase().replace(/\s+/g,"-");l={tenant_id:e,contact_id:t,new_status:u,triggered_by_user_id:r??""}}else{let m={call_status:o,triggered_by_user_id:r??""};a&&(m.dead_reason=a),l={contact_id:t,location:{id:e},customData:m}}let c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l),credentials:"omit"});if(!c.ok)throw new Error(`Webhook returned ${c.status} ${c.statusText}`)},qm=async({contactId:t,tenantId:e})=>{let o=await fetch(zm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,contact_id:t}),credentials:"omit"});if(!o.ok)throw new Error(`Sanity check returned ${o.status} ${o.statusText}`);return await o.json()},we="ws-crm-contact-actions-bar",Ei="ws-crm-call-status-dropdown",$i="ws-crm-call-status-menu",cr="ws-crm-offer-made-modal",vi=!1,Um=()=>{vi||(vi=!0,document.addEventListener("click",t=>{let e=document.getElementById($i);if(!e||e.style.display==="none")return;let o=document.getElementById(Ei);o&&!o.contains(t.target)&&(e.style.display="none")}))},jm=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"needs-offer",label:"Needs Offer",color:"green"},{value:"appointment-booked",label:"Appointment Booked",color:"green"},{value:"no-show",label:"No Show",color:"orange"},{value:"negotiating",label:"Negotiating",color:"green"},{value:"under-contract",label:"Under Contract",color:"green"},{value:"offer-rejected",label:"Offer Rejected",color:"orange"},{value:"not-ready",label:"Not Ready",color:"orange"},{value:"wants-retail",label:"Wants Retail",color:"orange"},{value:"already-listed",label:"Already Listed",color:"orange"},{value:"working-with-a-buyer",label:"Working with a Buyer",color:"orange"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"sold-on-market",label:"Sold on Market",color:"red"},{value:"sold-off-market",label:"Sold off Market",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"dead-deal",label:"Dead Deal",color:"red"}],Ti=[{value:"not-contacted",label:"Not Contacted",color:"purple"},{value:"vm-left",label:"VM Left",color:"purple"},{value:"qualified-buyer",label:"Qualified Buyer",color:"green"},{value:"upgrade-to-vip",label:"Upgrade to VIP",color:"green"},{value:"walkthrough-scheduled",label:"Walkthrough Scheduled",color:"green"},{value:"made-an-offer",label:"Made an Offer",color:"green"},{value:"not-interested",label:"Not Interested",color:"orange"},{value:"wrong-market",label:"Wrong Market",color:"orange"},{value:"no-longer-buying",label:"No Longer Buying",color:"red"},{value:"wrong-number",label:"Wrong Number",color:"red"},{value:"blacklisted",label:"Blacklisted",color:"red"}],Wm=[".central-panel","[class*='central-panel']","[data-testid='central-panel']","[data-test='central-panel']",".contact-detail-page .central-panel",".contact-detail-page [class*='central']"],Gm=async()=>{for(let t of Wm)try{let e=await P(t,{timeoutMs:2e3});if(e)return p.debug(`[actions-bar] mount target found via selector: ${t}`),e}catch{}try{let t=await P("#contact-conversation-panel",{timeoutMs:2e3});if(t.parentElement)return p.debug("[actions-bar] mount target found via #contact-conversation-panel.parentElement"),t.parentElement}catch{}for(let t of["[id*='conversation-panel']","[class*='conversation-panel']","[class*='contact-detail'] [class*='panel']","main [class*='central']","main [class*='panel']:not([class*='sidebar']):not([class*='nav'])"])try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[actions-bar] mount target via fallback: ${t}`),e.parentElement??e}catch{}return p.warn("[actions-bar] no mount target found via any selector \u2014 URL:",window.location.pathname),null},Km=({contactId:t,kind:e})=>{let o=e==="buyer"?Ti:jm,r=e==="buyer"?Fm:ki,a=e==="buyer"?"Buyer Call Status":"Seller Call Status",s=document.createElement("div");s.id=Ei,s.style.cssText="position: relative; flex-shrink: 0; order: 1;";let i=document.createElement("button");i.type="button",i.style.cssText=R,i.innerHTML=`
    <span style="
      display: inline-flex;
      width: 8px;
      height: 8px;
    ...
    "></span>
    <span>${a}</span>
  `;let d=document.createElement("div");return d.id=$i,d.style.cssText=`
    position: absolute;
    top: calc(100% + 4px);
    left: 0;
    z-index: 999998;
  ...
  `,o.forEach(l=>{let c=document.createElement("button");c.type="button",c.style.cssText=`
    ...
    `,c.innerHTML=`
      ...
      "></span>
      <span>${l.label}</span>
    `,c.addEventListener("mouseenter",()=>{c.style.background=n.slate}),c.addEventListener("mouseleave",()=>{c.style.background="transparent"}),c.addEventListener("click",async()=>{p.info(`Call Status set to "${l.label}" (${l.value}, ${l.color}) for contact ${t}`);let m=i.firstElementChild,u=i.children[1],_=i.children[2];m&&(m.style.background=xn[l.color]),u&&(u.textContent=l.label),d.style.display="none";let g=D()?.locationId,x=H();if(!g){p.warn("Cannot fire Call Status webhook \u2014 locationId missing from URL context"),u&&(u.textContent=`${l.label} (no tenant!)`),u&&(u.style.color=n.amber);return}if(e==="seller"&&l.color==="green"&&!x){p.warn("Green Call Status clicked but no user ID found \u2014 n8n Green handler will throw. Set window.WS_CRM_USER_ID = '<your-ghl-user-id>' as a temporary workaround."),u&&(u.textContent=`${l.label} (no user!)`),u&&(u.style.color=n.amber);return}let k=_?.textContent??"\u25BE",y=async f=>{_&&(_.textContent="\u2026"),i.style.opacity="0.75";try{await Nm({contactId:t,locationId:g,status:l.label,userId:x,deadReason:f,webhookUrl:r,kind:e}),_&&(_.textContent="\u2713"),setTimeout(()=>{_&&(_.textContent=k),i.style.opacity="1"},900)}catch($){p.warn("Call Status webhook failed:",$),_&&(_.textContent="\u2717"),u&&(u.style.color=n.amber),i.style.opacity="1",setTimeout(()=>{_&&(_.textContent=k),u&&(u.style.color=n.bone)},1800)}};if(e==="seller"&&l.value==="dead-deal"){let f=u?.textContent??"";Xm($=>{y($)},()=>{u&&(u.textContent=f)});return}if(e==="seller"&&l.value==="appointment-booked"){let f=u?.textContent??"";try{(await qm({contactId:t,tenantId:g})).ok?await y():tb(()=>{y()},()=>{u&&(u.textContent=f)})}catch($){p.warn("Appointment sanity check failed; firing anyway:",$),await y()}return}await y()}),d.appendChild(c)}),i.addEventListener("click",l=>{l.stopPropagation(),d.style.display=d.style.display==="none"?"block":"none"}),Um(),s.appendChild(i),s.appendChild(d),s},Vm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",Ym=async t=>{let e=await fetch(Vm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,kind:t.kind,amount:t.amount,expires_at:t.expiresAt,triggered_by_user_id:t.userId,opp_id:t.oppId??void 0,property_record_id:t.propertyRecordId??void 0,asking_price:t.askingPrice??void 0}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},Jm="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/list-for-contact",Un=t=>(t||"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Qm=async(t,e)=>{let o=await fetch(Jm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t,contact_id:e}),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);let r=await o.json();return(Array.isArray(r.properties)?r.properties:[]).filter(s=>s.has_acq_opp&&s.opp_id).map(s=>({oppId:String(s.opp_id),propertyRecordId:String(s.property_record_id||""),address:String(s.address||"(no address)"),dealStage:s.deal_stage||null,askingPrice:s.asking_price??null}))},Zm=t=>new Promise(e=>{document.getElementById(cr)?.remove();let o=document.createElement("div");o.id=cr,o.style.cssText=`position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:min(460px,92vw);max-height:80vh;overflow-y:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 12px 32px rgba(0,0,0,0.5);`;let a=t.map((i,d)=>`
      <button type="button" class="ws-deal-pick" data-i="${d}" style="display:block;width:100%;text-align:left;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:12px 14px;margin-bottom:8px;cursor:pointer;color:${n.bone};font-family:${h.sans};">
        <div style="font-size:14px;font-weight:500;">${Un(i.address)}</div>
        ${i.dealStage?`<div style="font-size:11px;color:${n.ash};margin-top:3px;">${Un(i.dealStage)}</div>`:""}
  ...
  `;let c=new Date,m=new Date(c.getTime()+5*24*60*60*1e3).toISOString().slice(0,10),u=r?`
    ...
    <input id="ws-offer-expires" type="date" value="${m}"
      ...
      " />`:"",_=r&&o&&o.address?`<div style="font-size:12px;color:${n.bone};background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};padding:8px 10px;margin-bottom:16px;">Offer for: <strong>${Un(o.address)}</strong></div>`:"",b=o&&o.askingPrice!=null&&Number(o.askingPrice)>0?String(Number(o.askingPrice)):"",g=r&&o&&o.propertyRecordId?`
  ...
  `,o.appendChild(r),document.body.appendChild(o);let a=()=>{document.removeEventListener("keydown",i),o.remove()},s=()=>{a(),e()};o.addEventListener("click",d=>{d.target===o&&s()}),r.querySelector("#ws-appt-sanity-cancel")?.addEventListener("click",s),r.querySelector("#ws-appt-sanity-mark")?.addEventListener("click",()=>{a(),t()});let i=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",i)},fi=(t,e)=>{let o=document.createElement("div");if(o.id=we,o.dataset.contactId=t,o.dataset.contactKind=e,o.style.cssText=`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
  ...
  `,e==="seller"||e==="buyer"){let r=document.createElement("button");r.type="button",r.style.cssText=R,r.style.order="4",r.innerHTML=`
    ...
    `,r.addEventListener("mouseenter",()=>{r.style.borderColor=n.emerald}),r.addEventListener("mouseleave",()=>{r.style.borderColor=n.steel}),r.addEventListener("click",async()=>{if(e!=="seller"){po(t,e);return}let a=window.location.pathname.match(/\/v2\/location\/([A-Za-z0-9]+)/),s=a?a[1]:null;if(!s){po(t,e);return}let i=r.innerHTML;r.disabled=!0,r.style.opacity="0.7",r.innerHTML="<span>Loading\u2026</span>";let d=()=>{r.innerHTML=i,r.disabled=!1,r.style.opacity="1"},l=[];try{l=await Qm(s,t)}catch(m){p.warn("[offer-made] deal lookup failed, using legacy path",m),d(),po(t,e);return}if(d(),l.length<=1){po(t,e,l[0]);return}let c=await Zm(l);c&&po(t,e,c)}),o.appendChild(r),o.appendChild(Km({contactId:t,kind:e}))}return o},qn=!1,xi=()=>{document.querySelectorAll(`[id="${we}"]`).forEach(t=>t.remove())},Ci=async()=>{if(p.debug("[actions-bar:01] ensureMounted called; url:",window.location.pathname),qn){p.debug("[actions-bar:00-LOCKED] ensureMounted already in-flight \u2014 skip");return}qn=!0;try{await eb()}finally{qn=!1}},eb=async()=>{let t=D();if(!t){p.debug("[actions-bar:02-BAIL] no contact context (URL didn't match patterns AND no in-page contact link). URL:",window.location.pathname),xi();return}if(p.debug(`[actions-bar:02] ctx resolved \u2014 contactId=${t.contactId} locationId=${t.locationId??"(null)"} source=${t.source}`),t.source!=="url"){p.debug("[actions-bar:02-DOM] non-URL (Conversations) source \u2014 actions bar is contact-detail only; skipping"),xi();return}let e="seller";try{let l=await $t(t.contactId,t.locationId),c=Tt(l);c==="buyer"?e="buyer":c==="other"&&(e="other"),p.debug(`[actions-bar:03] kind resolved \u2014 kind=${e} (raw type=${l??"(null)"})`)}catch(l){p.warn("[actions-bar:03-FAIL] Contact Type resolution threw \u2014 defaulting to seller:",l)}let o=D();if(!o||o.contactId!==t.contactId){p.debug("[actions-bar:04-BAIL] context changed during Contact Type fetch \u2014 aborting mount");return}let r=Array.from(document.querySelectorAll(`[id="${we}"]`));if(r.length===1&&r[0].dataset.contactId===t.contactId&&r[0].dataset.contactKind===e){p.debug(`[actions-bar:05-SKIP] bar already mounted for contact=${t.contactId} kind=${e} \u2014 no-op`);return}r.length>0&&(p.debug(`[actions-bar:05] removing ${r.length} stale bar(s) before remount`),r.forEach(l=>l.remove()));let a=await Gm();if(!a){p.warn("[actions-bar:06-FAIL] findMountTarget returned null \u2014 no .central-panel or fallback selector matched within timeout. URL:",window.location.pathname);return}p.debug(`[actions-bar:06] mount target found \u2014 tagName=${a.tagName} class="${a.className}"`);let s=D();if(!s||s.contactId!==t.contactId){p.debug("[actions-bar:07-BAIL] context changed during findMountTarget wait \u2014 aborting mount");return}let i;try{i=fi(t.contactId,e)}catch(l){p.error("[actions-bar:08-FAIL] buildBar threw:",l);return}i.dataset.mountTarget=a.className||"central-panel";try{a.insertBefore(i,a.firstChild)}catch(l){p.error("[actions-bar:09-FAIL] insertBefore threw:",l);return}if(!document.getElementById(we)){p.warn("[actions-bar:10-DETACHED] bar inserted but not in document tree \u2014 target was likely re-rendered by Vue. Will retry next page-change.");return}p.debug(`[actions-bar:10-OK] bar mounted + verified in document for contact=${t.contactId} kind=${e}`),dr?.disconnect(),dr=new MutationObserver(()=>{if(!(D()?.contactId===t.contactId)){dr?.disconnect();return}let c=document.querySelectorAll(`[id="${we}"]`);if(c.length>1){for(let m=1;m<c.length;m++)c[m].remove();p.debug(`[actions-bar:WATCHDOG] trimmed ${c.length-1} duplicate bar(s)`);return}if(c.length===0){let m=document.querySelector(".central-panel")||a,u=fi(t.contactId,e);u.dataset.mountTarget=i.dataset.mountTarget??"";try{m.insertBefore(u,m.firstChild),p.debug(`[actions-bar:WATCHDOG] re-mounted after wipe for ${t.contactId}`)}catch(_){p.warn("[actions-bar:WATCHDOG-FAIL] re-mount threw:",_)}}}),dr.observe(a,{childList:!0})},dr=null,wi=null,ob=()=>{wi===null&&(wi=window.setInterval(()=>{let t=D();t&&(document.getElementById(we)||(p.debug("[actions-bar:HEALER] no bar on contact page \u2014 re-triggering mount for",t.contactId),Ci()))},3e3))},Ai=()=>{ob(),Ci()};var pr="https://assets.cdn.filesafe.space/ZqGLfSMNKm26UQP7ENj1/media/6a08c6430a69f1e766a71d54.png",rb=new Set(["icon","shortcut icon","apple-touch-icon","apple-touch-icon-precomposed","mask-icon"]),mo="data-ws-crm-favicon",jn=t=>t.hasAttribute(mo),Si=t=>{if(t.tagName!=="LINK")return!1;let e=(t.getAttribute("rel")??"").toLowerCase();return rb.has(e)},mr=()=>{document.head.querySelectorAll("link[rel]").forEach(r=>{Si(r)&&!jn(r)&&r.remove()});let e=document.head.querySelector(`link[${mo}="1"]`);e?e.href!==pr&&(e.href=pr):(e=document.createElement("link"),e.setAttribute(mo,"1"),e.rel="icon",e.type="image/png",e.href=pr,document.head.appendChild(e),p.debug("Favicon installed"));let o=document.head.querySelector(`link[${mo}="apple"]`);o||(o=document.createElement("link"),o.setAttribute(mo,"apple"),o.rel="apple-touch-icon",o.href=pr,document.head.appendChild(o))},Li=()=>{if(window.__reosFaviconInstalled)return;if(window.__reosFaviconInstalled=!0,document.head)mr();else{let r=window.setInterval(()=>{document.head&&(window.clearInterval(r),mr())},50)}new MutationObserver(r=>{let a=!1;for(let s of r)s.addedNodes.forEach(i=>{i instanceof HTMLLinkElement&&Si(i)&&!jn(i)&&(a=!0)}),s.removedNodes.forEach(i=>{i instanceof HTMLLinkElement&&jn(i)&&(a=!0)});a&&mr()}).observe(document.head,{childList:!0,subtree:!1});let e=0,o=window.setInterval(()=>{e+=1,mr(),e>=5&&window.clearInterval(o)},1e3)};var tt=".crm-opportunities-modal .ui-modal-heading .description",Ii=new Map,Wn=null,Gn,nb=()=>{let t=new Map;for(let[e,{selector:o,cb:r}]of Ii){let a=t.get(o);if(a===void 0&&(a=!!document.querySelector(o),t.set(o,a)),!!a)try{r()}catch(s){p.error(`[arrival-watcher] callback "${e}" threw`,s)}}},J=(t,e,o)=>{Ii.set(t,{selector:e,cb:o}),!Wn&&(Wn=new MutationObserver(()=>{Gn===void 0&&(Gn=window.setTimeout(()=>{Gn=void 0,nb()},300))}),Wn.observe(document.body,{childList:!0,subtree:!0}))};var ab=["Acquisitions","Transaction Coordination","Disposition","Marketing Tracker"],sb=/^(?:\d+\)\s*)?(Acquisitions|Transaction Coordination|Disposition|Marketing Tracker)\s*$/,ib=".hr-card.hr-modal.crm-opportunities-modal",z=()=>{let t=document.querySelector(ib);if(!t)return null;let e=t.querySelectorAll(".hr-base-selection-overlay__wrapper, .hr-base-selection");for(let o of e){let r=o.textContent?.trim()??"";if(!r)continue;let a=r.match(sb);if(a){let s=a[1];if(ab.includes(s))return s}}return null},et=async(t=2500)=>{let e=Date.now();for(;Date.now()-e<t;){let o=z();if(o!==null)return o;await new Promise(r=>setTimeout(r,100))}return null};var Mi="ws-crm-dispo-action-row",Q=t=>{let e=document.getElementById(Mi);if(e)return e;t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="12px",t.style.flexWrap="wrap");let o=document.createElement("span");return o.id=Mi,o.style.cssText="display: inline-flex; align-items: center; gap: 8px; margin-left: auto; flex-wrap: nowrap; flex-shrink: 0; vertical-align: middle;",t.appendChild(o),o};var lb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/offer-made/set",gt="ws-crm-mt-offer-made-button",Pi="ws-crm-mt-offer-made-modal",db=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cb=/\/v2\/location\/([A-Za-z0-9]+)/,ur=()=>{let t=window.location.pathname,e=t.match(db),o=e?e[1]:qt();if(!o)return null;let r=t.match(cb);return{oppId:o,locationId:r?r[1]:null}},pb=async t=>{let e=await fetch(lb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,kind:"buyer",amount:t.amount,triggered_by_user_id:t.userId}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},br=()=>{document.getElementById(Pi)?.remove()},mb=t=>{br();let e=document.createElement("div");e.id=Pi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=ur();!o||!o.locationId||o.oppId!==t||mb({oppId:o.oppId,locationId:o.locationId,onSuccess:()=>{let r=e.querySelector(".ws-mt-om-label");r&&(r.textContent="Offer Recorded"),e.style.background=n.emeraldGlow,e.style.color=n.emeraldBright,e.style.borderColor=n.emeraldBorder,setTimeout(()=>{r&&r.textContent==="Offer Recorded"&&(r.textContent="Mark Offer Made",e.style.cssText=R)},4e3)}})}),e},hb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],ub=async()=>{for(let t of hb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},hr=!1,Vn=async()=>{if(!hr){hr=!0;try{await _b()}finally{hr=!1}}},_b=async()=>{let t=ur();if(!t||!t.locationId){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),ho();return}let e=document.getElementById(gt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove(),ho());return}e&&(e.remove(),document.getElementById(`${gt}-wrap`)?.remove());let o=await ub();if(!o){p.warn("MT Offer Made: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[mt-offer] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=ur();if(!a||a.oppId!==t.oppId)return;let s=bb(t.oppId),i=document.createElement("span");i.id=`${gt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 1;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted MT Offer Made button on opp ${t.oppId}`),vb(t.oppId)},bo=null,Kn=null,ke,ho=()=>{bo?.disconnect(),bo=null,Kn=null,ke!==void 0&&(window.clearTimeout(ke),ke=void 0)},vb=t=>{if(bo&&Kn===t)return;ho();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Kn=t,bo=new MutationObserver(()=>{ke===void 0&&(ke=window.setTimeout(()=>{ke=void 0;let o=ur();if(!o||o.oppId!==t){ho();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(gt)?.remove(),document.getElementById(`${gt}-wrap`)?.remove(),ho();return}document.getElementById(gt)||Vn()},250))}),bo.observe(e,{childList:!0,subtree:!0}))},yb=()=>{J("mt-offer-made",tt,()=>{!document.getElementById(gt)&&!hr&&Vn()})},Oi=()=>{yb(),Vn()};var gb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/not-interested",ft="ws-crm-not-interested-button",fb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,xb=/\/v2\/location\/([A-Za-z0-9]+)/,vr=()=>{let t=window.location.pathname,e=t.match(fb),o=e?e[1]:qt();if(!o)return null;let r=t.match(xb);return{oppId:o,locationId:r?r[1]:null}},wb=async t=>{let e=await fetch(gb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Not Interested webhook returned ${e.status} ${e.statusText}`);return await e.json()},kb=t=>{let e=document.createElement("button");return e.id=ft,e.type="button",e.dataset.oppId=t,e.style.cssText=R,e.title="Close this Marketing Tracker opp as Not Interested for THIS property only",e.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let o=vr();if(!o||!o.locationId||o.oppId!==t)return;let r=H(),a=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",a&&(a.textContent="Closing\u2026");try{let s=await wb({oppId:o.oppId,locationId:o.locationId,userId:r});if(s?.ok)a&&(a.textContent="Marked Not Interested"),e.style.background=n.crimsonGlow,e.style.color=n.crimson,p.info(`Not Interested set for opp ${t} \u2192 ${s.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(s){p.error("Not Interested webhook failed",s),a&&(a.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{a&&a.textContent==="Try again"&&(a.textContent="Mark Not Interested")},3e3)}}),e},Eb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],$b=async()=>{for(let t of Eb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},_r=!1,Jn=async()=>{if(!_r){_r=!0;try{await Tb()}finally{_r=!1}}},Tb=async()=>{let t=vr();if(!t||!t.locationId){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),_o();return}let e=document.getElementById(ft);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove(),_o());return}e&&(e.remove(),document.getElementById(`${ft}-wrap`)?.remove());let o=await $b();if(!o){p.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=vr();if(!a||a.oppId!==t.oppId)return;let s=kb(t.oppId),i=document.createElement("span");i.id=`${ft}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Not Interested button on opp ${t.oppId}`),Cb(t.oppId)},uo=null,Yn=null,_o=()=>{uo?.disconnect(),uo=null,Yn=null},Cb=t=>{if(uo&&Yn===t)return;_o();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Yn=t,uo=new MutationObserver(()=>{let o=vr();if(!o||o.oppId!==t){_o();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(ft)?.remove(),document.getElementById(`${ft}-wrap`)?.remove(),_o();return}document.getElementById(ft)||Jn()}),uo.observe(e,{childList:!0,subtree:!0}))},Ab=()=>{J("not-interested",tt,()=>{!document.getElementById(ft)&&!_r&&Jn()})},Bi=()=>{Ab(),Jn()};var Sb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/walkthrough/rep-schedule",vt="ws-crm-schedule-walkthrough-button",Qn="ws-crm-schedule-walkthrough-modal",Lb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Ib=/\/v2\/location\/([A-Za-z0-9]+)/,fr=()=>{let t=window.location.pathname,e=t.match(Lb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Ib);return{oppId:o,locationId:r?r[1]:null}},yr=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Mb=(t,e)=>{document.getElementById(Qn)?.remove();let o=document.createElement("div");o.id=Qn,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:420px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`;r.innerHTML=`
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",()=>{let o=fr();!o||!o.locationId||o.oppId!==t||Mb(o.oppId,o.locationId)}),e},Ob=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Bb=async()=>{for(let t of Ob)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},gr=!1,Xn=async()=>{if(!gr){gr=!0;try{await Rb()}finally{gr=!1}}},Rb=async()=>{let t=fr();if(!t||!t.locationId){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),yo();return}let e=document.getElementById(vt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove(),yo());return}e&&(e.remove(),document.getElementById(`${vt}-wrap`)?.remove());let o=await Bb();if(!o){p.warn("Schedule Walkthrough: no opp-header mount target found \u2014 skipping mount");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[schedule-walkthrough] gated off \u2014 pipeline="${r}"`);return}let a=fr();if(!a||a.oppId!==t.oppId)return;let s=Pb(t.oppId),i=document.createElement("span");i.id=`${vt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 0;
    flex-shrink: 0;
    vertical-align: middle;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Schedule Walkthrough button on opp ${t.oppId}`),Hb(t.oppId)},vo=null,Zn=null,Ee,yo=()=>{vo?.disconnect(),vo=null,Zn=null,Ee!==void 0&&(window.clearTimeout(Ee),Ee=void 0)},Hb=t=>{if(vo&&Zn===t)return;yo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Zn=t,vo=new MutationObserver(()=>{Ee===void 0&&(Ee=window.setTimeout(()=>{Ee=void 0;let o=fr();if(!o||o.oppId!==t){yo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(vt)?.remove(),document.getElementById(`${vt}-wrap`)?.remove(),yo();return}document.getElementById(vt)||Xn()},250))}),vo.observe(e,{childList:!0,subtree:!0}))},Db=()=>{J("schedule-walkthrough",tt,()=>{!document.getElementById(vt)&&!gr&&Xn()})},Ri=()=>{Db(),Xn()};var Fb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/mt/resend-deal-link",$e="ws-crm-resend-deal-link-wrap",zb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Nb=/\/v2\/location\/([A-Za-z0-9]+)/,wr=()=>{let t=window.location.pathname,e=t.match(zb),o=e?e[1]:qt();if(!o)return null;let r=t.match(Nb);return{oppId:o,locationId:r?r[1]:null}},qb=async t=>{let e=await fetch(Fb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,mt_opp_id:t.oppId,channel:t.channel,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Resend webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);return Array.isArray(r)?r[0]:r}catch{return{}}},Ub=t=>t.replace(/[<>&]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[e]||e),Hi=t=>`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t};box-shadow:0 0 6px ${t};flex-shrink:0;"></span>`,ea=(t,e)=>{t.innerHTML="";let o=document.createElement("button");o.type="button",o.style.cssText=R,o.title="Resend this property's deal-page link to the buyer via text or email",o.innerHTML=`${Hi(n.emerald)}<span>Resend Deal Link</span>`,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>jb(t,e)),t.appendChild(o)},jb=(t,e)=>{t.innerHTML="";let o=document.createElement("span");o.style.cssText="display:inline-flex;align-items:center;gap:8px;";let r=document.createElement("span");r.textContent="Resend via:",r.style.cssText=`color:${n.ash};font-size:13px;`,o.appendChild(r);let a=`display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-family:inherit;font-size:13px;font-weight:600;padding:6px 12px;border-radius:6px;background:${n.emeraldGlow};border:1px solid ${n.emeraldBorder};color:${n.emerald};`,s=(d,l)=>{let c=document.createElement("button");return c.type="button",c.textContent=d,c.style.cssText=a,c.addEventListener("click",()=>void Wb(t,e,l,o)),c};o.appendChild(s("Text","sms")),o.appendChild(s("Email","email"));let i=document.createElement("button");i.type="button",i.textContent="\u2715",i.title="Cancel",i.style.cssText=`cursor:pointer;background:transparent;border:none;color:${n.ash};font-size:14px;padding:4px;`,i.addEventListener("click",()=>ea(t,e)),o.appendChild(i),t.appendChild(o)},Wb=async(t,e,o,r)=>{let a=wr();if(!(!a||!a.locationId||a.oppId!==e)){r.innerHTML=`<span style="color:${n.ash};font-size:13px;">Sending ${o==="sms"?"text":"email"}\u2026</span>`;try{let s=await qb({oppId:a.oppId,locationId:a.locationId,channel:o,userId:H()});if(s?.ok)r.innerHTML=`${Hi(n.emerald)}<span style="color:${n.emerald};font-size:13px;font-weight:600;">${o==="sms"?"Text":"Email"} sent</span>`,p.info(`Resend deal link (${o}) for opp ${e}`);else throw new Error(s?.error||"Send failed")}catch(s){let i=s instanceof Error?s.message:"Send failed";p.error("Resend deal link failed",s),r.innerHTML=`<span style="color:${n.crimson};font-size:13px;">${Ub(i)}</span>`}window.setTimeout(()=>ea(t,e),3500)}},Gb=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Kb=async()=>{for(let t of Gb)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},xr=!1,oa=async()=>{if(!xr){xr=!0;try{await Vb()}finally{xr=!1}}},Vb=async()=>{let t=wr();if(!t||!t.locationId){document.getElementById($e)?.remove(),fo();return}let e=document.getElementById($e);if(e&&e.dataset.oppId===t.oppId){let i=z();i!==null&&i!=="Marketing Tracker"&&(e.remove(),fo());return}e&&e.remove();let o=await Kb();if(!o)return;let r=await et();if(r!=="Marketing Tracker"){p.debug(`[resend-deal] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=wr();if(!a||a.oppId!==t.oppId)return;let s=document.createElement("span");s.id=$e,s.dataset.oppId=t.oppId,s.style.cssText="display:inline-flex;align-items:center;order:2;flex-shrink:0;vertical-align:middle;",Q(o).appendChild(s),ea(s,t.oppId),p.debug(`Mounted Resend Deal Link button on opp ${t.oppId}`),Yb(t.oppId)},go=null,ta=null,fo=()=>{go?.disconnect(),go=null,ta=null},Yb=t=>{if(go&&ta===t)return;fo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ta=t,go=new MutationObserver(()=>{let o=wr();if(!o||o.oppId!==t){fo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById($e)?.remove(),fo();return}document.getElementById($e)||oa()}),go.observe(e,{childList:!0,subtree:!0}))},Jb=()=>{J("resend-deal-link",tt,()=>{!document.getElementById($e)&&!xr&&oa()})},Di=()=>{Jb(),oa()};var Qb="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",xt="ws-crm-reduce-price-button",Fi="ws-crm-reduce-price-modal",Zb=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Xb=/\/v2\/location\/([A-Za-z0-9]+)/,$r=()=>{let t=window.location.pathname,e=t.match(Zb);if(!e)return null;let o=t.match(Xb);return{oppId:e[1],locationId:o?o[1]:null}},th=async t=>{let e=await fetch(Qb,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,dispo_opp_id:t.oppId,new_price:t.newPrice,triggered_by_user_id:t.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let o=await e.text();try{let r=JSON.parse(o);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},kr=()=>{document.getElementById(Fi)?.remove()},eh=t=>{kr();let e=document.createElement("div");e.id=Fi,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=$r();!r||!r.locationId||r.oppId!==t||eh({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let a=o.querySelector(".ws-rp-label"),s=o.querySelector(":scope > span:first-child");a&&(a.textContent="Price Reduced \u2014 Buyers Alerted"),o.style.background=n.emeraldGlow,o.style.color=n.emeraldBright,o.style.borderColor=n.emeraldBorder,s&&(s.style.background=n.emerald,s.style.boxShadow=`0 0 6px ${n.emerald}`),setTimeout(()=>{a&&a.textContent==="Price Reduced \u2014 Buyers Alerted"&&(a.textContent="Reduce Price and Alert Buyers",o.style.cssText=R,s&&(s.style.background=n.amber,s.style.boxShadow=`0 0 6px ${n.amber}`))},4e3)}})}),o},rh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],nh=async()=>{for(let t of rh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Er=!1,na=async()=>{if(!Er){Er=!0;try{await ah()}finally{Er=!1}}},ah=async()=>{let t=$r();if(!t||!t.locationId){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo();return}let e=document.getElementById(xt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo());return}e&&(e.remove(),document.getElementById(`${xt}-wrap`)?.remove());let o=await nh();if(!o){p.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await et();if(r!=="Disposition"){p.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let a=$r();if(!a||a.oppId!==t.oppId)return;let s=oh(t.oppId,t.locationId),i=document.createElement("span");i.id=`${xt}-wrap`,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    order: 3;
    flex-shrink: 0;
    vertical-align: middle;
  `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Reduce Price button on opp ${t.oppId}`),sh(t.oppId)},xo=null,ra=null,Te,wo=()=>{xo?.disconnect(),xo=null,ra=null,Te!==void 0&&(window.clearTimeout(Te),Te=void 0)},sh=t=>{if(xo&&ra===t)return;wo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ra=t,xo=new MutationObserver(()=>{Te===void 0&&(Te=window.setTimeout(()=>{Te=void 0;let o=$r();if(!o||o.oppId!==t){wo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(xt)?.remove(),document.getElementById(`${xt}-wrap`)?.remove(),wo();return}document.getElementById(xt)||na()},250))}),xo.observe(e,{childList:!0,subtree:!0}))},ih=()=>{J("reduce-price",tt,()=>{!document.getElementById(xt)&&!Er&&na()})},zi=()=>{ih(),na()};var Ce="b7d6ebff40fd11dcee371883f0f2670eeace5693cbc0bd5d",Tr="deals.reinvestos.com";var wt="ws-crm-edit-landing-button",lh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,dh=/\/v2\/location\/([A-Za-z0-9]+)/,Ar=()=>{let t=window.location.pathname,e=t.match(lh);if(!e)return null;let o=t.match(dh);return{oppId:e[1],locationId:o?o[1]:null}},ch=(t,e)=>{let o=new URL(`https://${Tr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ce);let r=H();return r&&o.searchParams.set("user",r),o.toString()},ph=(t,e)=>{let o=document.createElement("button");return o.id=wt,o.type="button",o.dataset.oppId=t,o.style.cssText=R,o.title="Open the deal-page editor for this property (photos, price, details, live preview)",o.innerHTML=`
    <span style="
      display: inline-block; width: 8px; height: 8px; border-radius: 50%;
      background: ${n.blue}; box-shadow: 0 0 6px ${n.blue}; flex-shrink: 0;
    "></span>
    <span class="ws-elp-label">Edit Landing Page</span>
  `,o.addEventListener("mouseenter",()=>{o.style.transform="translateY(-1px)"}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{let r=Ar();if(!r||!r.locationId||r.oppId!==t)return;if(!Ce){p.warn("[edit-landing] editor session key not configured in this build");return}let a=ch(r.oppId,r.locationId);window.open(a,"_blank","noopener,noreferrer");let s=o.querySelector(".ws-elp-label");if(s){let i=s.textContent;s.textContent="Opening editor\u2026",setTimeout(()=>{s.textContent==="Opening editor\u2026"&&(s.textContent=i)},2500)}}),o},mh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],bh=async()=>{for(let t of mh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Cr=!1,sa=async()=>{if(!Cr){Cr=!0;try{await hh()}finally{Cr=!1}}},hh=async()=>{let t=Ar();if(!t||!t.locationId){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Eo();return}let e=document.getElementById(wt);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Eo());return}e&&(e.remove(),document.getElementById(`${wt}-wrap`)?.remove());let o=await bh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[edit-landing] gated off \u2014 pipeline="${r}"`);return}let a=Ar();if(!a||a.oppId!==t.oppId)return;let s=ph(t.oppId,t.locationId),i=document.createElement("span");i.id=`${wt}-wrap`,i.style.cssText="display: inline-flex; align-items: center; order: 2; flex-shrink: 0; vertical-align: middle;",o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="12px",o.style.flexWrap="wrap"),i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Edit Landing Page button on opp ${t.oppId}`),uh(t.oppId)},ko=null,aa=null,Ae,Eo=()=>{ko?.disconnect(),ko=null,aa=null,Ae!==void 0&&(window.clearTimeout(Ae),Ae=void 0)},uh=t=>{if(ko&&aa===t)return;Eo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(aa=t,ko=new MutationObserver(()=>{Ae===void 0&&(Ae=window.setTimeout(()=>{Ae=void 0;let o=Ar();if(!o||o.oppId!==t){Eo();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(wt)?.remove(),document.getElementById(`${wt}-wrap`)?.remove(),Eo();return}document.getElementById(wt)||sa()},250))}),ko.observe(e,{childList:!0,subtree:!0}))},_h=()=>{J("edit-landing-page",tt,()=>{!document.getElementById(wt)&&!Cr&&sa()})},Ni=()=>{_h(),sa()};var ji="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/dispo/publish",Le="ws-crm-publish-button",$o="ws-crm-publish-wrap",Lr="ws-crm-publish-dropdown",vh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,yh=/\/v2\/location\/([A-Za-z0-9]+)/,ia=()=>{let t=window.location.pathname,e=t.match(vh);if(!e)return null;let o=t.match(yh);return{oppId:e[1],locationId:o?o[1]:null}},qi=async(t,e)=>{try{let o=await fetch(ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,dry_run:!0,triggered_by_user_id:H()??null}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[publish] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[publish] dry_run fetch failed:",o),null}},gh=async(t,e)=>{let o=await fetch(ji,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,triggered_by_user_id:H()??null}),credentials:"omit"});if(!o.ok&&o.status!==200)throw new Error(`HTTP ${o.status}`);return await o.json()},fh=(t,e)=>{if(!Ce){p.warn("[publish] editor session key not configured in this build");return}let o=new URL(`https://${Tr}/editor`);o.searchParams.set("loc",e),o.searchParams.set("opp",t),o.searchParams.set("k",Ce);let r=H();r&&o.searchParams.set("user",r),window.open(o.toString(),"_blank","noopener,noreferrer")},Bt=()=>{document.getElementById(Lr)?.remove()},Ui=(t,e,o,r,a)=>{Bt();let s=document.createElement("div");s.id=Lr;let i=e.getBoundingClientRect();s.style.cssText=`
    position: fixed;
    top: ${i.bottom+6}px;
  ...
  `;let r={status:"checking"};Wt(o,r);let a=!1,s=async()=>{if(!(r.status==="publishing"||r.status==="published")&&!a){a=!0;try{let b=await qi(t,e);if(!b||!Array.isArray(b.checks)){r={status:"error",message:"Check failed \u2014 click to retry"},Wt(o,r);return}r={status:b.published?"published":b.ready?"ready":"incomplete",checks:b.checks},Wt(o,r),document.getElementById(Lr)&&r.checks&&Ui(r.checks,o,t,e,()=>void s())}finally{a=!1}}},i=async()=>{r={status:"publishing",checks:r.checks},Wt(o,r),Bt();try{if((await qi(t,e))?.published){r={status:"published"},Wt(o,r),p.info(`[publish] pre-publish check: opp ${t} already published \u2014 skipping`);return}let g=await gh(t,e);if(g.ok&&g.published)r={status:"published"},Wt(o,r),p.info(`[publish] published opp ${t}`);else if(g.missing&&g.missing.length)r={status:"error",message:"Not ready \u2014 re-check"},Wt(o,r);else throw new Error(g.error||"Publish failed")}catch(b){let g=b instanceof Error?b.message:"Publish failed";p.error("[publish] publish failed",b),r={status:"error",message:g.length>28?"Error \u2014 try again":g},Wt(o,r)}};o.addEventListener("mouseenter",()=>{r.status==="ready"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{switch(r.status){case"ready":i();break;case"incomplete":{document.getElementById(Lr)?Bt():r.checks&&Ui(r.checks,o,t,e,()=>void s());break}case"error":s();break}}),s();let d=Date.now(),l=8e3,c=()=>{o.isConnected&&(a||r.status==="publishing"||r.status==="published"||Date.now()-d<l||(d=Date.now(),s()))},m=()=>c(),u=()=>{document.visibilityState==="visible"&&c()};window.addEventListener("focus",m),document.addEventListener("visibilitychange",u);let _=window.setInterval(()=>{document.body.contains(o)||(window.removeEventListener("focus",m),document.removeEventListener("visibilitychange",u),window.clearInterval(_))},5e3);return o},wh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],kh=async()=>{for(let t of wh)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Sr=!1,da=async()=>{if(!Sr){Sr=!0;try{await Eh()}finally{Sr=!1}}},Eh=async()=>{let t=ia();if(!t||!t.locationId){document.getElementById(Le)?.remove(),document.getElementById($o)?.remove(),Bt(),Co();return}let e=document.getElementById(Le);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Disposition"&&(e.remove(),document.getElementById($o)?.remove(),Bt(),Co());return}e&&(e.remove(),document.getElementById($o)?.remove(),Bt());let o=await kh();if(!o)return;let r=await et();if(r!=="Disposition"){p.debug(`[publish] gated off \u2014 pipeline="${r}"`);return}let a=ia();if(!a||a.oppId!==t.oppId||!a.locationId)return;let s=xh(t.oppId,a.locationId),i=document.createElement("span");i.id=$o,i.style.cssText="display: inline-flex; align-items: center; order: 1; flex-shrink: 0; vertical-align: middle;",i.appendChild(s),Q(o).appendChild(i),p.debug(`Mounted Publish button on opp ${t.oppId}`),$h(t.oppId)},To=null,la=null,Se,Co=()=>{To?.disconnect(),To=null,la=null,Se!==void 0&&(window.clearTimeout(Se),Se=void 0)},$h=t=>{if(To&&la===t)return;Co();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(la=t,To=new MutationObserver(()=>{Se===void 0&&(Se=window.setTimeout(()=>{Se=void 0;let o=ia();if(!o||o.oppId!==t){Co();return}let r=z();if(r!==null&&r!=="Disposition"){document.getElementById(Le)?.remove(),document.getElementById($o)?.remove(),Bt(),Co();return}document.getElementById(Le)||da()},250))}),To.observe(e,{childList:!0,subtree:!0}))},Th=()=>{J("publish-button",tt,()=>{!document.getElementById(Le)&&!Sr&&da()})},Wi=()=>{Th(),da()};var Gi="data:image/png;base64,",Ki="data:image/png;base64,";var Ch=[{key:"contact",addr:"Street address",city:"City",state:"State",zip:"Postal code"},{key:"property",addr:"Property Address",city:"Property City",state:"Property State",zip:"Property Zip"}],Vi=t=>`ws-crm-map-links-${t}`,Yi=()=>Array.from(document.querySelectorAll(".hr-form-item-label__text, [class*='label__text']")),Ir=(t,e)=>{let o=e.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o){let a=r.closest(".hr-form-item");if(!a)continue;let s=a.querySelector("input, textarea");if(s&&(s.value||"").trim())return s.value.trim()}return""},Ji=(t,e=Yi())=>{let o=Ir(e,t.addr),r=Ir(e,t.city),a=Ir(e,t.state),s=Ir(e,t.zip),i;return r&&o&&o.toLowerCase().includes(r.toLowerCase())?i=o:i=[o,r,a,s].filter(Boolean).join(", "),{full:i,hasAny:i.length>0}},Ah=t=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(t)}`,Sh=t=>`https://www.zillow.com/homes/${t.replace(/\s+/g,"-")}_rb`,Lh=(t,e)=>{let{full:o,hasAny:r}=Ji(t);r&&window.open(e(o),"_blank","noopener,noreferrer")},Ih=t=>{let e=document.createElement("span");e.id=Vi(t.key),e.style.cssText="display:inline-flex;align-items:center;gap:6px;margin-left:auto;font-weight:400;flex-shrink:0;";let o=document.createElement("span");o.textContent="View maps:",o.style.cssText="font-size:11px;color:#9098A3;white-space:nowrap;",e.appendChild(o);let r=(a,s,i)=>{let d=document.createElement("img");return d.src=a,d.title=s,d.style.cssText="width:18px;height:18px;cursor:pointer;border-radius:3px;display:inline-block;transition:transform 0.1s ease;",d.addEventListener("mouseenter",()=>{d.style.transform="scale(1.12)"}),d.addEventListener("mouseleave",()=>{d.style.transform="scale(1)"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),Lh(t,i)}),d};return e.appendChild(r(Gi,"Open in Google Maps",Ah)),e.appendChild(r(Ki,"Search on Zillow",Sh)),e},Mh=(t,e)=>{let o=e.addr.toLowerCase();for(let r of t)if((r.textContent||"").trim().toLowerCase()===o)return r.closest(".hr-form-item")?.querySelector(".hr-form-item-label")||r.parentElement;return null},Qi=()=>{let t=Yi();if(t.length)for(let e of Ch){if(document.getElementById(Vi(e.key)))continue;let{hasAny:o}=Ji(e,t);if(!o)continue;let r=Mh(t,e);r&&(r.style.display="flex",r.style.alignItems="center",r.style.width="100%",r.appendChild(Ih(e)),p.debug(`[map-links] injected on "${e.addr}"`))}},Ie=null,Me,Ph=()=>{let t=ve();return t==="contact-detail"||t==="other"},Oh=()=>{Ie||(Ie=new MutationObserver(()=>{Me===void 0&&(Me=window.setTimeout(()=>{Me=void 0;try{Qi()}catch(t){p.warn("[map-links] ensureInjected failed",t)}},300))}),Ie.observe(document.body,{childList:!0,subtree:!0}))},Zi=()=>{Ie&&(Ie.disconnect(),Ie=null),Me!==void 0&&(window.clearTimeout(Me),Me=void 0)},Xi=()=>{if(!Ph()){Zi();return}Oh(),Qi()},tl=()=>{Zi()};var el="ws-crm-hide-launchpad",ca=/\/launchpad\/?$/,pa=()=>{if(!ye()){if(!document.getElementById(el)){let t=document.createElement("style");t.id=el,t.textContent='a[href*="/location/"][href$="/launchpad"]{display:none !important;}',(document.head||document.documentElement).appendChild(t),p.info("[hide-launchpad] Launchpad nav hidden for tenant user")}if(ca.test(location.pathname)){let t=location.pathname.replace(ca,"/dashboard")+location.search;p.info(`[hide-launchpad] redirecting tenant user off Launchpad -> ${t}`);try{history.replaceState({},"",t),window.dispatchEvent(new PopStateEvent("popstate")),window.setTimeout(()=>{(!!document.getElementById("launchpad-main")||!!document.querySelector('[class*="launchpad-container"]'))&&!ca.test(location.pathname)&&(p.warn("[hide-launchpad] SPA redirect ignored by router \u2014 hard nav fallback"),location.replace(t))},2e3)}catch(e){p.warn("[hide-launchpad] SPA redirect failed, falling back to hard nav",e),location.replace(t)}}}};var Bh=[{label:"Buy-Box Entries"},{label:"Memberships"}],ol=t=>{t.size!==0&&document.querySelectorAll(".nav-title").forEach(e=>{let o=(e.textContent||"").trim().toLowerCase();if(!t.has(o))return;let r=e.closest("a")||e.closest("li")||e.parentElement;r&&r.style.display!=="none"&&(r.style.setProperty("display","none","important"),p.info(`[hide-nav-items] hid "${e.textContent?.trim()}"`))})},ma=()=>{let t=ye(),e=new Set(Bh.filter(o=>o.agencyToo||!t).map(o=>o.label.trim().toLowerCase()));if(e.size!==0){ol(e);for(let o of[150,500,1200,2500])setTimeout(()=>ol(e),o)}};var Rh=[{from:"Payments",to:"Contracts"}],Hh=".nav-title, .topmenu-navtitle",rl=()=>{document.querySelectorAll(Hh).forEach(t=>{let e=(t.textContent||"").trim(),o=Rh.find(r=>r.from===e);o&&(t.textContent=o.to,p.info(`[relabel-nav] "${o.from}" -> "${o.to}"`))})},ba=()=>{rl();for(let t of[150,500,1200,2500])setTimeout(rl,t)};var nl="/payments/proposals-estimates",Dh=/\/payments\/invoices\/?$/,Fh=/\/payments\//,zh='#sb_payments, a[meta="payments"]',sl=(t=0)=>{if(t>25)return;let e=location.pathname;if(!e.includes(nl)&&!(t>3&&!Fh.test(e))){if(Dh.test(e)){let o=[...document.querySelectorAll(".topmenu-nav a")].find(r=>(r.getAttribute("href")||"").includes(nl));if(o){p.info("[contracts-section] section entry -> proposals-estimates"),o.click();return}}setTimeout(()=>sl(t+1),120)}},al=!1,Nh=()=>{al||(al=!0,document.addEventListener("click",t=>{t.target?.closest?.(zh)&&setTimeout(()=>sl(),80)},!0),p.info("[contracts-section] section-entry redirect armed"))},ha=()=>{Nh()};var il=["/payments/v2/orders","/payments/v2/subscriptions","/payments/v2/paymentlinks","/payments/v2/transactions","/payments/products","/payments/coupons","/payments/gift-cards","/payments/settings","/payments/integrations","/funnels-websites/client-portal"],ll="ws-crm-hide-topmenu-tabs",ua=()=>{if(document.getElementById(ll))return;let t=il.map(o=>`.topmenu-nav a[href*="${o}"]`).join(","),e=document.createElement("style");e.id=ll,e.textContent=`${t}{display:none !important;}`,(document.head||document.documentElement).appendChild(e),p.info(`[hide-topmenu-tabs] hid ${il.length} top tabs`)};var pl="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",Gt="ws-crm-send-to-closing-office-button",le="ws-crm-send-to-title-co-wrap",Or="ws-crm-stc-dropdown",qh=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Uh=/\/v2\/location\/([A-Za-z0-9]+)/,Lo=()=>{let t=window.location.pathname,e=t.match(qh);if(!e)return null;let o=t.match(Uh);return{oppId:e[1],locationId:o?o[1]:null}},jh=5*60*1e3,ya=t=>`ws-crm-stc-cache:${t}`,Wh=t=>{try{let e=window.localStorage.getItem(ya(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>jh||!Array.isArray(o.checks)||o.checks.length===0?null:o}catch{return null}},Gh=(t,e)=>{try{window.localStorage.setItem(ya(t),JSON.stringify(e))}catch{}},ml=t=>{try{window.localStorage.removeItem(ya(t))}catch{}},_a="ws-crm:opp-fields-updated",bl=t=>{if(t){ml(t);try{window.dispatchEvent(new CustomEvent(_a,{detail:{oppId:t}}))}catch{}}},Kh=async(t,e)=>{try{let o=await fetch(pl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,dry_run:!0}),credentials:"omit"});return o.ok?await o.json():(p.warn(`[stc] dry_run returned HTTP ${o.status}`),null)}catch(o){return p.warn("[stc] dry_run fetch failed:",o),null}},Vh=async(t,e,o)=>{let r=await fetch(pl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:t,triggered_by_user_id:H()??null,confirm_resend:o}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Yh=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let o=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let a of o)if((a.textContent?.trim()??"")===t)return a.click(),!0;let r=e.querySelectorAll("*");for(let a of r){if(a.children.length>1)continue;if((a.textContent?.trim()??"")===t)return(a.closest("a, button, li, [role='tab']")||a.parentElement||a).click(),!0}return p.warn(`[stc] folder tab not found for "${t}"`),!1},dl=t=>{let e=document.getElementById(t);if(!e){p.warn(`[stc] field ${t} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let o=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${n.emerald}, 0 0 18px ${n.emerald}`,window.setTimeout(()=>{e.style.boxShadow=o,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Jh=(t,e)=>{if(e&&Yh(e)){window.setTimeout(()=>dl(t),300);return}dl(t)},kt=()=>{document.getElementById(Or)?.remove()},Mr=(t,e,o)=>{kt();let r=document.createElement("div");r.id=Or;let a=o.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${a.bottom+6}px;
  ...
  `,St(o,a);let s=new Set,i=async()=>{if(a.status==="sending")return;let y=await Kh(t,e);if(!y){a={status:"error",message:"Check failed \u2014 click to retry"},St(o,a);return}if(y.rate_limited){b=Date.now()+_,a={status:"error",checks:a.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},St(o,a),p.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(b).toLocaleTimeString()}`);return}if(!Array.isArray(y.checks)||y.checks.length===0){a={status:"error",message:y.error||"Check failed \u2014 click to retry"},St(o,a),p.warn("[stc] dry_run returned no checks:",y);return}let f=y.pipeline_name;if(f&&f!=="Transaction Coordination"){p.debug(`[stc] dry_run reports pipeline="${f}" (not TC) \u2014 retracting button + caching`),Br.add(t),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt(),So();return}let $=y.checks;if(a.checks&&a.checks.length===y.checks.length){let T=new Set;$=y.checks.map((w,E)=>a.checks[E]?.filled&&!w.filled?s.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),s=T}else s=new Set;a={status:$.every(T=>T.filled)?"ready":"incomplete",checks:$,previouslySentAt:y.previously_sent_at??null},Gh(t,{checks:$,previously_sent_at:y.previously_sent_at??null,pipeline_name:f,ts:Date.now()}),St(o,a),document.getElementById(Or)&&Mr($,y.previously_sent_at,o)},d=async()=>{let y=!!a.previouslySentAt;a={status:"sending",checks:a.checks,previouslySentAt:a.previouslySentAt},St(o,a),kt();try{let f=await Vh(t,e,y);if(f.needs_confirm){a={status:"ready",checks:f.checks,previouslySentAt:f.previously_sent_at},St(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o);return}if(f.ok){a={status:"sent",checks:f.checks,previouslySentAt:new Date().toISOString()},St(o,a),window.setTimeout(()=>{x()},3500);return}a={status:"error",checks:f.checks,message:f.error||"Validation failed"},St(o,a),f.checks&&Mr(f.checks,f.previously_sent_at,o)}catch(f){p.error("[stc] send failed:",f),a={status:"error",message:"Network error \u2014 click to retry"},St(o,a)}};o.addEventListener("click",()=>{switch(a.status){case"ready":d();break;case"incomplete":{document.getElementById(Or)?kt():a.checks&&Mr(a.checks,a.previouslySentAt,o);break}case"error":case"sent":x();break}});let l,c=!1,m=Date.now(),u=1e4,_=5*60*1e3,b=0,g=!1,x=async()=>{if(o.isConnected&&(g=!0),g&&!o.isConnected)return;let y=Lo();if(!(!y||y.oppId!==t)&&!c){if(Date.now()<b){p.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(b).toLocaleTimeString()}`);return}c=!0,m=Date.now();try{await i()}finally{c=!1}}};x();let k=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(k){let y=new MutationObserver(()=>{if(l!==void 0||c)return;let A=Date.now()-m,T=Math.max(1500,u-A);l=window.setTimeout(()=>{l=void 0,a.status!=="sending"&&x()},T)});y.observe(k,{childList:!0,subtree:!0,characterData:!0}),o.dataset.observerActive="1";let f=A=>{let T=A.detail;if(!T||T.oppId!==t)return;ml(t);let w=0,E=()=>{if(c&&w<8){w+=1,window.setTimeout(E,500);return}x()};E()};window.addEventListener(_a,f);let $=window.setInterval(()=>{document.body.contains(o)||(y.disconnect(),l!==void 0&&window.clearTimeout(l),window.removeEventListener(_a,f),window.clearInterval($))},5e3)}return o},Zh=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Xh=async()=>{for(let t of Zh)try{let e=await P(t,{timeoutMs:1500});if(e)return p.debug(`[send-to-title-co] mount target: ${t}`),e}catch{}return p.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},Br=new Set,cl=null,tu=t=>{t&&t!==cl&&(Br.clear(),cl=t)},Pr=!1,ga=async()=>{if(Pr){p.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}Pr=!0;try{await eu()}catch(t){p.error("[stc] ensureMountedImpl threw:",t)}finally{Pr=!1}},eu=async()=>{p.debug("[stc] mount:01 ensureMountedImpl entered");let t=Lo();if(!t||!t.locationId){p.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(t)}`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt();return}if(p.debug(`[stc] mount:02 ctx ok \u2014 oppId=${t.oppId} locId=${t.locationId}`),tu(t.oppId),Br.has(t.oppId)){p.debug(`[stc] mount:02-BAIL opp ${t.oppId} previously confirmed non-TC this session`),document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt();return}let e=document.getElementById(Gt);if(e&&e.dataset.oppId===t.oppId){p.debug("[stc] mount:03-SKIP existing button for same opp");let d=z();d!==null&&d!=="Transaction Coordination"&&(e.remove(),document.getElementById(le)?.remove(),kt(),So());return}e&&(p.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(le)?.remove(),kt()),p.debug("[stc] mount:04 calling findMountTarget");let o=await Xh();if(!o){p.debug("[stc] mount:04-BAIL findMountTarget returned null");return}p.debug(`[stc] mount:04 target found tag=${o.tagName} class="${o.className}"`);let r=z();if(r!==null&&r!=="Transaction Coordination"){p.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let a=Lo();if(!a||a.oppId!==t.oppId||!a.locationId){p.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${t.oppId} now=${a?.oppId}`);return}p.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let s=Qh(t.oppId,a.locationId),i=document.createElement("span");i.id=le,i.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 3;
  `,i.appendChild(s),Q(o).appendChild(i),p.debug(`[stc] mount:07-OK Mounted on opp ${t.oppId}, inDoc=${document.body.contains(s)}`),ou(t.oppId)},Ao=null,va=null,So=()=>{Ao?.disconnect(),Ao=null,va=null},ou=t=>{if(Ao&&va===t)return;So();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(va=t,Ao=new MutationObserver(()=>{let o=Lo();if(!o||o.oppId!==t){So();return}let r=z();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(Gt)?.remove(),document.getElementById(le)?.remove(),kt(),So();return}document.getElementById(Gt)||ga()}),Ao.observe(e,{childList:!0,subtree:!0}))},ru=()=>{J("send-to-closing",tt,()=>{if(document.getElementById(Gt)||Pr)return;let t=Lo();t&&Br.has(t.oppId)||ga()})},hl=()=>{ru(),ga()};var wa="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os",nu=`${wa}/tc/welcome-call-prefill`,au=`${wa}/tc/welcome-call-save`,su=`${wa}/tc/order-lockbox`,Io="ws-crm-welcome-call-overlay",iu=["Regular Contract","Subject To","Seller Finance","Novation"],lu=["City Water & Sewer","City Water & Septic","Well & Septic","Water Tank & Septic"],du=["Gas","Electric","Propane","Oil"],cu=["Single Family Residence (SFR)","Multi-Family 2-4 Units","Multi-Family 5+ Units","Land","Commercial","Mobile Home"],pu=["Vacant","Owner Occupied","Tenant Occupied","Squatter Occupied"],Kt=["Yes","No"],mu=["Yes","No","Unknown"],bu=["Professional Photographer","Seller","Tenant"],hu=["Month-to-Month","Annual"],ul=["Current","Behind"],uu=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Lt=t=>(t==null?"":String(t)).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),Hr=`width:100%;box-sizing:border-box;padding:8px 9px;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;margin-top:4px;`,yl="margin-bottom:12px;",gl=`display:block;font-size:11px;color:${n.ash};text-transform:uppercase;letter-spacing:0.04em;`,_u=`display:inline-flex;align-items:center;gap:5px;font-size:12px;color:${n.bone};margin-right:10px;`,_l=t=>String(t??"").toLowerCase().replace(/[^a-z0-9]/g,""),ot=(t,e,o)=>{let r=_l(o);return`<select id="${t}" style="${Hr}"><option value=""></option>${e.map(a=>`<option ${r!==""&&_l(a)===r?"selected":""}>${Lt(a)}</option>`).join("")}</select>`},ct=(t,e,o="")=>`<input id="${t}" type="text" value="${Lt(e)}" placeholder="${Lt(o)}" style="${Hr}">`,vu=(t,e)=>`<textarea id="${t}" rows="3" style="${Hr}resize:vertical;">${Lt(e)}</textarea>`,yu=(t,e)=>`<input id="${t}" type="date" value="${Lt(e)}" style="${Hr}">`,F=(t,e)=>`<div style="${yl}"><label style="${gl}">${Lt(t)}</label>${e}</div>`,fa=(t,e)=>{let o=Array.isArray(e)?e:[];return`<div style="margin-top:4px;">${uu.map(r=>`<label style="${_u}"><input type="checkbox" data-grp="${t}" value="${r}" ${o.includes(r)?"checked":""}>${r}</label>`).join("")}</div>`},Rt=t=>`<div style="font-family:${h.mono};font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:${n.emerald};margin:22px 0 10px;padding-bottom:6px;border-bottom:1px solid ${n.steel};">${Lt(t)}</div>`,Pe=()=>{document.getElementById(Io)?.remove()},de=(t,e="ok")=>{let o=document.createElement("div");o.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);z-index:1000001;padding:10px 16px;border-radius:${v.md};background:${n.graphite};border:1px solid ${e==="ok"?n.emeraldBorder:"rgba(212,63,74,0.4)"};color:${e==="ok"?n.emerald:n.crimson};font-family:${h.sans};font-size:13px;font-weight:500;box-shadow:0 12px 32px rgba(0,0,0,0.5);`,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},gu=t=>{let e=t.tenant||{};return`
    ${Rt("Identifiers")}
    <div style="font-size:13px;color:${n.bone};margin-bottom:4px;"><b>${Lt(t.seller_name)||"(seller)"}</b></div>
    <div style="font-size:12px;color:${n.ash};margin-bottom:6px;">${Lt(t.deal_address)||"(no address on file)"}</div>

    ${Rt("Contract")}
    ${F("Type of Contract",ot("wc-contract_type",iu,t.contract_type))}

    ${Rt("Property")}
    ${F("Property Type",ot("wc-property_type",cu,t.property_type))}
    <div style="display:flex;gap:10px;">
    ...
    ${F("Utilities",ot("wc-utilities",lu,t.utilities))}
    ${F("Heat Source",ot("wc-heat_source",du,t.heat_source))}

    ${Rt("Liens & Permits")}
    ${F("Is there a mortgage?",ot("wc-has_mortgage",Kt,t.has_mortgage))}
    <div id="wc-mortgage-detail" style="display:none;">${F("Mortgage payment status",ot("wc-mortgage_payment_status",ul,t.mortgage_payment_status))}</div>
    ...
    ${Rt("Occupancy")}
    ${F("Property occupancy",ot("wc-occupancy",pu,t.occupancy))}
    <div id="wc-tenant-block" style="display:none;border-left:2px solid ${n.steel};padding-left:12px;margin:4px 0 8px;">
      ...
      ${F("Lease type",ot("wc-tenant_lease_type",hu,e.lease_type))}
      <div style="display:flex;gap:10px;">
      ...
      <div style="display:flex;gap:10px;">
        <div style="flex:1;">${F("Rent status",ot("wc-tenant_rent_status",ul,e.rent_status))}</div>
        <div style="flex:1;">${F("Last rent paid",yu("wc-tenant_last_rent_paid",e.last_rent_paid))}</div>
      </div>
      <div style="display:flex;gap:10px;">
    ...
    <div id="wc-hoa-detail" style="display:none;">${F("HOA monthly fee",ct("wc-hoa_monthly_fee",t.hoa_monthly_fee))}${F("HOA rental restriction?",ot("wc-hoa_rental_restriction",mu,t.hoa_rental_restriction))}</div>

    ${Rt("Photos & Access")}
    ${F("Who is providing photos?",ot("wc-photos_provided_by",bu,t.photos_provided_by))}
    <div style="${yl}">
      ...
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Mornings</div>${fa("photos_avail_mornings",t.photos_avail_mornings)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Afternoons</div>${fa("photos_avail_afternoons",t.photos_avail_afternoons)}
      <div style="font-size:11px;color:${n.ash};margin-top:8px;">Evenings</div>${fa("photos_avail_evenings",t.photos_avail_evenings)}
    </div>
  ...
  `},I=t=>{let e=document.getElementById(t);return e?(e.value||"").trim():""},xa=t=>Array.from(document.querySelectorAll(`input[data-grp="${t}"]:checked`)).map(e=>e.value),vl=()=>{let t=(e,o)=>{let r=document.getElementById(e);r&&(r.style.display=o?"block":"none")};t("wc-mortgage-detail",I("wc-has_mortgage")==="Yes"),t("wc-hoa-detail",I("wc-in_hoa")==="Yes"),t("wc-lockbox-detail",I("wc-lockbox_needed")==="Yes"),t("wc-tenant-block",I("wc-occupancy")==="Tenant Occupied")},Rr=t=>{let e=t,o=String(e.lockbox_order_status??"").toLowerCase(),r=o==="ordered"||o==="shipped"||o==="delivered"||o==="queued",a=e.lockbox_order_date?Lt(e.lockbox_order_date):"";return{on:r,text:r?`\u2713 Ordered${a?" "+a:""}`:"Not ordered yet"}},fu=t=>({tenant_id:t.tenant_id,opp_id:t.opp_id,contact_id:t.contact_id,property_record_id:t.property_record_id,deal_address:t.deal_address,contract_type:I("wc-contract_type"),property_type:I("wc-property_type"),beds:I("wc-beds"),baths:I("wc-baths"),sqft:I("wc-sqft"),utilities:I("wc-utilities"),heat_source:I("wc-heat_source"),has_mortgage:I("wc-has_mortgage"),mortgage_payment_status:I("wc-mortgage_payment_status"),has_other_liens:I("wc-has_other_liens"),has_permit_issues:I("wc-has_permit_issues"),in_probate:I("wc-in_probate"),occupancy:I("wc-occupancy"),selling_with_tenant:I("wc-selling_with_tenant"),in_hoa:I("wc-in_hoa"),hoa_rental_restriction:I("wc-hoa_rental_restriction"),hoa_monthly_fee:I("wc-hoa_monthly_fee"),photos_provided_by:I("wc-photos_provided_by"),photos_avail_mornings:xa("photos_avail_mornings"),photos_avail_afternoons:xa("photos_avail_afternoons"),photos_avail_evenings:xa("photos_avail_evenings"),lockbox_needed:I("wc-lockbox_needed"),lockbox_code:I("wc-lockbox_code"),lockbox_recipient_name:I("wc-lockbox_recipient_name"),lockbox_recipient_phone:I("wc-lockbox_recipient_phone"),lockbox_mailing_address:I("wc-lockbox_mailing_address"),welcome_call_notes:I("wc-welcome_call_notes"),tenant:I("wc-occupancy")==="Tenant Occupied"?{first_name:I("wc-tenant_first_name"),last_name:I("wc-tenant_last_name"),phone:I("wc-tenant_phone"),email:I("wc-tenant_email"),lease_type:I("wc-tenant_lease_type"),monthly_rent:I("wc-tenant_monthly_rent"),rent_due_day:I("wc-tenant_rent_due_day"),rent_status:I("wc-tenant_rent_status"),last_rent_paid:I("wc-tenant_last_rent_paid"),lease_on_hand:I("wc-tenant_lease_on_hand"),security_deposit:I("wc-tenant_security_deposit")}:void 0}),xu=t=>{Pe();let e=document.createElement("div");e.id=Io,e.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;overflow-y:auto;font-family:${h.sans};`;let o=document.createElement("div");o.style.cssText=`width:100%;max-width:680px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);`,o.innerHTML=`
    ...
    <div style="padding:8px 20px 16px;">${gu(t)}</div>
  ...
  `,o.textContent=t,document.body.appendChild(o),window.setTimeout(()=>o.remove(),4200)},Su=t=>{fl(t.oppId,t.locationId)},Lu=async(t,e,o)=>(await fetch(ku,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,contact_id:e.contact_id||"",property_record_id:e.property_record_id||"",deal_address:e.deal_address||"",ship_to:o.ship_to,recipient_name:o.recipient_name,recipient_phone:o.recipient_phone,source:"tc-reorder"}),credentials:"omit"})).ok,Iu=(t,e)=>{Yt();let o=document.createElement("div");o.id=El,o.style.cssText=`position:fixed;inset:0;z-index:1000000;background:rgba(5,7,10,0.72);display:flex;align-items:center;justify-content:center;padding:24px;font-family:${h.sans};`;let r=document.createElement("div");r.style.cssText=`width:100%;max-width:440px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};box-shadow:0 24px 60px rgba(0,0,0,0.6);padding:22px 24px;`;let a=`width:100%;box-sizing:border-box;background:${n.slate};border:1px solid ${n.steel};border-radius:${v.sm};color:${n.bone};font-family:${h.sans};font-size:13px;padding:9px 11px;outline:none;margin-bottom:12px;`,s=`display:block;font-size:11px;letter-spacing:0.04em;text-transform:uppercase;color:${n.ash};margin-bottom:4px;`,i=e.lockbox_mailing_address||e.deal_address||"";r.innerHTML=`
    ...
    <input id="wsrl-name" type="text" style="${a}" value="${ka(e.lockbox_recipient_name)}" />
    <label style="${s}">Recipient phone</label>
    <input id="wsrl-phone" type="text" style="${a}" value="${ka(e.lockbox_recipient_phone)}" />
    <label style="${s}">Shipping address</label>
    <textarea id="wsrl-address" rows="2" style="${a}resize:vertical;">${ka(i)}</textarea>
  ...
  `,document.body.appendChild(o);let a=o.querySelector("#wsap-dt"),s=o.querySelector("#wsap-vendor"),i=o.querySelector("#wsap-confirm");i?.addEventListener("click",async()=>{if(!a?.value){Vt("Pick the booked date and time first.","err");return}i.textContent="Booking\u2026",i.style.opacity="0.8";try{(await fetch(wu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.locationId,opp_id:t.oppId,photo_datetime:new Date(a.value).toISOString(),photo_vendor:s?.value?.trim()||null}),credentials:"omit"})).ok?(Yt(),Vt("Photo shoot booked \u2014 deal advanced to Photos Scheduled \u2713")):(i.textContent="Confirm & advance",i.style.opacity="1",Vt("Booking failed \u2014 try again.","err"))}catch(l){p.warn("[action-bar] confirm photo failed:",l),i.textContent="Confirm & advance",i.style.opacity="1",Vt("Couldn't reach the booking handler. Try again.","err")}});let d=l=>{let c=l.target;!o.contains(c)&&!e.contains(c)&&(Yt(),document.removeEventListener("click",d))};window.setTimeout(()=>document.addEventListener("click",d),0)},Pu=(t,e)=>{Yt();let o=document.createElement("div");o.id=kl;let r=e.getBoundingClientRect();o.style.cssText=`
    ...
    border-radius: ${v.md}; box-shadow: 0 14px 34px rgba(0,0,0,0.55);
    font-family: ${h.sans};
  `;for(let s of t){let i=document.createElement("div");i.textContent=s.label,i.style.cssText=`padding:9px 11px;font-size:12.5px;color:${n.bone};border-radius:${v.sm};cursor:pointer;`,i.addEventListener("mouseenter",()=>i.style.background=n.steel),i.addEventListener("mouseleave",()=>i.style.background="transparent"),i.addEventListener("click",d=>{d.stopPropagation(),s.onClick()}),o.appendChild(i)}document.body.appendChild(o);let a=s=>{let i=s.target;!o.contains(i)&&!e.contains(i)&&(Yt(),document.removeEventListener("click",a))};window.setTimeout(()=>document.addEventListener("click",a),0)},Fr=(t,e)=>{let o=document.createElement("button");return o.type="button",e==="primary"?o.style.cssText=at:o.style.cssText=R,o.textContent=t,o},Ou=()=>{let t=Fr("\u22EE","ghost");return t.style.lineHeight="1",t},Bu=(t,e)=>{let o=document.createElement("span");if(o.style.cssText="display:inline-flex;align-items:center;gap:8px;",e===Tl){let r=Fr("Start Welcome Call","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Start Welcome Call</span>`,r.addEventListener("click",()=>Su(t)),o.appendChild(r),o}if(e===Sa){let r=Fr("Confirm Photos","ghost");return r.innerHTML=`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${n.amber};box-shadow:0 0 6px ${n.amber};flex-shrink:0;"></span><span>Confirm Photos</span>`,r.addEventListener("click",()=>Mu(t,r)),o.appendChild(r),o}if(e===Cl){let r=Fr("Re-order Lockbox","ghost");return r.addEventListener("click",()=>void Sl(t)),o.appendChild(r),o}return null},Ru=(t,e)=>{let o=[];if(e===Sa&&(o=[{label:"Re-order Lockbox",onClick:()=>void Sl(t)}]),!o.length)return null;let r=document.createElement("span");r.id=wl,r.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:4;";let a=Ou();return a.addEventListener("click",s=>{s.stopPropagation(),Pu(o,a)}),r.appendChild(a),r},Hu=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],Du=async()=>{for(let t of Hu)try{let e=await P(t,{timeoutMs:1200});if(e)return e}catch{}return null},Dr=()=>{document.getElementById($a)?.remove(),document.getElementById(wl)?.remove(),Yt()},zr=!1,La=async()=>{if(!zr){zr=!0;try{let t=Al();if(!t){Dr();return}let e=z();if(e===null)return;if(e!=="Transaction Coordination"){Dr();return}let o=Au(),r=document.getElementById($a);if(r&&r.dataset.oppId===t.oppId&&r.dataset.stage===(o??""))return;let a=Bu(t,o);if(!a){Dr();return}let s=await Du();if(!s)return;Dr();let i=Q(s),d=document.createElement("span");d.id=$a,d.dataset.oppId=t.oppId,d.dataset.stage=o??"",d.style.cssText="display:inline-flex;align-items:center;flex-shrink:0;vertical-align:middle;order:1;",d.appendChild(a),i.appendChild(d);let l=Ru(t,o);l&&i.appendChild(l),Fu(t.oppId)}catch(t){p.error("[action-bar] ensureBar threw:",t)}finally{zr=!1}}},Mo=null,Ca=null,Ea,xl=()=>{Mo?.disconnect(),Mo=null,Ca=null},Fu=t=>{if(Mo&&Ca===t)return;xl();let e=document.querySelector($l);e&&(Ca=t,Mo=new MutationObserver(()=>{let o=Al();if(!o||o.oppId!==t){xl();return}Ea===void 0&&(Ea=window.setTimeout(()=>{Ea=void 0,La()},250))}),Mo.observe(e,{childList:!0,subtree:!0}))},zu=()=>{J("opp-action-bar",".crm-opportunities-modal .ui-modal-heading",()=>{zr||La()})},Ll=()=>{zu(),La()};var Il="ws-support-modal",Ml="ws-support-toast",Nu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/support/submit",Pl="ws-support-submitter-name",Ol="ws-support-submitter-email",Bl="ws-support-submitter-role",qu=["Bug","Feature Request","Question","Billing","Onboarding Help"],ce=t=>t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Uu=(t,e="success",o)=>{let r=document.getElementById(Ml);r&&r.remove();let a=document.createElement("div");a.id=Ml;let s=e==="success"?n.emerald:n.crimson;a.style.cssText=`
  ...
  `,document.body.appendChild(a),setTimeout(()=>{a.style.transition="opacity 0.3s, transform 0.3s",a.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>a.remove(),300)},6e3)},ju=()=>{document.getElementById(Il)?.remove();let t=(localStorage.getItem(Pl)??"").trim(),e=(localStorage.getItem(Ol)??"").trim(),o=(localStorage.getItem(Bl)??"").trim(),r={category:null,title:"",description:"",submitterName:t,submitterEmail:e,submitterRole:o},a=document.createElement("div");a.id=Il,a.style.cssText=`
    position: fixed; inset: 0; z-index: 99999;
    background: rgba(10, 13, 18, 0.75);
    display: flex; align-items: center; justify-content: center;
    font-family: ${h.sans};
  ...
  `,a.appendChild(s),document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&a.remove()}),s.querySelectorAll(".ws-support-tile").forEach(d=>{d.addEventListener("mouseenter",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.emerald,d.style.background=n.emeraldGlow)}),d.addEventListener("mouseleave",()=>{d.dataset.selected!=="true"&&(d.style.borderColor=n.steel,d.style.background=n.steel)}),d.addEventListener("click",()=>{r.category=d.dataset.category||null,s.querySelectorAll(".ws-support-tile").forEach(l=>{l===d?(l.dataset.selected="true",l.style.borderColor=n.emerald,l.style.background=n.emeraldGlow,l.style.color=n.emeraldBright):(l.dataset.selected="false",l.style.borderColor=n.steel,l.style.background=n.steel,l.style.color=n.bone)})})}),s.querySelector("#ws-support-close")?.addEventListener("click",()=>a.remove()),s.querySelector("#ws-support-submit")?.addEventListener("click",async()=>{let d=s.querySelector("#ws-support-err"),l=u=>{d&&(d.textContent=u)};if(l(""),r.title=(s.querySelector("#ws-support-title")?.value||"").trim(),r.description=(s.querySelector("#ws-support-description")?.value||"").trim(),r.submitterName=(s.querySelector("#ws-support-name")?.value||"").trim(),r.submitterEmail=(s.querySelector("#ws-support-email")?.value||"").trim(),r.submitterRole=(s.querySelector("#ws-support-role")?.value||"").trim(),!r.category){l("Pick a category at the top.");return}if(!r.title){l("Add a title \u2014 a short summary.");return}if(!r.description){l("Add a description so we know what you're seeing.");return}if(!r.submitterName){l("Tell us who you are (Your Name).");return}if(!r.submitterEmail||!/.+@.+\..+/.test(r.submitterEmail)){l("Add a valid email so we can reply.");return}let c=K();if(!c){l("Couldn't detect which tenant you're in. Refresh the page and try again.");return}try{localStorage.setItem(Pl,r.submitterName),localStorage.setItem(Ol,r.submitterEmail),r.submitterRole&&localStorage.setItem(Bl,r.submitterRole)}catch{}let m=s.querySelector("#ws-support-submit");m&&(m.disabled=!0,m.textContent="Submitting\u2026",m.style.opacity="0.7");try{let _=await(await fetch(Nu,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:c,category:r.category,title:r.title,description:r.description,submitter_user_id:H()||"",submitter_name:r.submitterName,submitter_email:r.submitterEmail,submitter_role:r.submitterRole||"",url:window.location.href,browser_info:(navigator.userAgent||"").slice(0,500)})})).json();if(!_.ok){l(_.error||"Failed to submit ticket."),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1");return}a.remove();let b=_.ticket_short_id||"submitted";Uu(`Ticket ${b} submitted`,"success","We'll respond as fast as we can. Thanks for the heads up.")}catch(u){l(`Network error: ${u.message}`),m&&(m.disabled=!1,m.textContent="Submit Ticket",m.style.opacity="1")}})},Wu=["/support-ticket","ws-support-modal","ws-support"],Gu=/\/custom-menu-link\//,Ia=!1,Rl=()=>{if(Ia||!Gu.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Wu.some(i=>s.includes(i))});if(r){Ia=!0,p.info(`[support-nav] detected custom-menu-link route + matching iframe (src=${r.src}) \u2014 opening modal + navigating back`);try{history.back()}catch{}setTimeout(()=>{ju(),Ia=!1},50);return}t<10&&setTimeout(e,150)};e()},Hl=!1,Dl=()=>{Hl||(Hl=!0,_t(()=>setTimeout(Rl,50)),Rl(),p.info("[support-nav] URL + iframe watcher installed (page-router subscription)"))};var Fl="ws-phone-assignments-modal",zl="ws-phone-assignments-toast",Ku="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",Vu="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/save",Yu=["ACQ","DISPO","TC"],Ul="",Jt=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),Ju=(t,e="success",o)=>{document.getElementById(zl)?.remove();let r=document.createElement("div");r.id=zl;let a=e==="success"?n.emerald:n.crimson;r.style.cssText=`
    ...
    font-size: 14px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); max-width: 340px;`,r.innerHTML=`<div style="font-weight:500;">${Jt(t)}</div>${o?`<div style="font-size:12px;color:${n.ash};margin-top:4px;">${Jt(o)}</div>`:""}`,document.body.appendChild(r),setTimeout(()=>{r.style.transition="opacity 0.3s, transform 0.3s",r.style.opacity="0",r.style.transform="translateY(20px)",setTimeout(()=>r.remove(),300)},5e3)},Qu=(t,e,o)=>{let r=[`<option value="" ${o===Ul?"selected":""}>\u2014 Unassigned \u2014</option>`,...e.map(a=>`<option value="${Jt(a)}" ${o===a?"selected":""}>${Jt(a)}</option>`)].join("");return`<select data-assign="${Jt(t)}" style="
    padding: 6px 10px; background: ${n.obsidian}; color: ${n.bone};
    border: 1px solid ${n.steel}; border-radius: ${v.sm};
    font-family: ${h.sans}; font-size: 12px; min-width: 130px;">${r}</select>`},Zu=`display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 10px;border-bottom:1px solid ${n.steel};`,Pa=async t=>{document.getElementById(Fl)?.remove();let e=t||K(),o=document.createElement("div");o.id=Fl,o.style.cssText=`position: fixed; inset: 0; z-index: 100000;
    ...
    <div id="ws-pa-body" style="font-size:13px;color:${n.ash};">Loading\u2026</div>`,o.appendChild(r),document.body.appendChild(o),o.addEventListener("click",_=>{_.target===o&&o.remove()}),!e){let _=r.querySelector("#ws-pa-body");_&&(_.textContent="Couldn't detect which tenant you're in. Refresh and try again.");return}let a={};try{a=await(await fetch(`${Ku}?tenant_id=${encodeURIComponent(e)}`,{method:"GET",credentials:"omit"})).json()}catch(_){p.error("[phone-assignments] GET failed",_);let b=r.querySelector("#ws-pa-body");b&&(b.innerHTML=`<span style="color:${n.crimson};">Couldn't load assignments (${Jt(_.message)}). The backend may not be wired yet.</span>`);return}let s=a.teams&&a.teams.length?a.teams:Yu,i=a.numbers??[],d={...a.config?.numberTeam??{}},l=_=>`<div style="padding:8px 10px;color:${n.coolGray};font-size:12px;">No ${_} found.</div>`,c=i.length?i.map(_=>`<div style="${Zu}">
    ...
    </div>`,u.querySelectorAll("select[data-assign]").forEach(_=>{_.addEventListener("change",()=>{let b=_.getAttribute("data-assign")||"",[g,...x]=b.split(":"),k=x.join(":");g==="num"&&(_.value?d[k]=_.value:delete d[k])})}),u.querySelector("#ws-pa-close")?.addEventListener("click",()=>o.remove()),u.querySelector("#ws-pa-save")?.addEventListener("click",async()=>{let _=u.querySelector("#ws-pa-err"),b=x=>{_&&(_.textContent=x)};b("");let g=u.querySelector("#ws-pa-save");g&&(g.disabled=!0,g.textContent="Saving\u2026",g.style.opacity="0.7");try{let k=await(await fetch(Vu,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,numberTeam:d})})).json();if(!k.ok){b(k.error||"Save failed."),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1");return}o.remove(),Ju("Phone assignments saved","success","Local-presence dialing will use these team pools.")}catch(x){b(`Network error: ${x.message}`),g&&(g.disabled=!1,g.textContent="Save",g.style.opacity="1")}}))},Xu=["ws-phone-assignments","phone-assignments"],t_=/\/custom-menu-link\//,Ma=!1,Nl=()=>{if(Ma||!t_.test(window.location.pathname))return;let t=0,e=()=>{t++;let r=Array.from(document.querySelectorAll("iframe")).find(a=>{let s=a.src||a.getAttribute("src")||"";return Xu.some(i=>s.includes(i))});if(r){Ma=!0;let a=window.location.pathname.match(/\/location\/([A-Za-z0-9]+)/),s=a?a[1]:void 0;p.info(`[phone-assignments] custom-menu-link route detected (src=${r.src}) \u2014 opening modal (loc=${s})`);try{history.back()}catch{}setTimeout(()=>{Pa(s),Ma=!1},50);return}t<10&&setTimeout(e,150)};e()},ql=!1,jl=()=>{if(ql)return;ql=!0,_t(()=>setTimeout(Nl,50)),Nl();let t=()=>{window.location.hash.replace("#","")==="ws-phone-assignments"&&Pa()};window.addEventListener("hashchange",t),t(),window.WS_CRM_OPEN_PHONE_ASSIGNMENTS=()=>void Pa(),p.info("[phone-assignments] mounted (route + hash + window trigger)")};var Wl="powerDialerApp",e_=".dialer",o_='button[aria-label="Voice Calling"], button[title="Voice Calling"]',r_=".dial-item.dial-btn.dial-btn-enabled",Oe=t=>{for(let e of["pointerdown","mousedown","pointerup","mouseup","click"])try{t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window}))}catch{}},n_=t=>{let e=(t||"").match(/\+\d{10,15}/);return e?e[0]:null},Oa=()=>{try{let e=window[Wl]?._context?.provides?.emitter;if(e&&typeof e.emit=="function")return e}catch(t){p.debug("[dialer-bridge] getEmitter failed",t)}return null},Be=()=>document.querySelector(e_),Nr=()=>Oa()!==null||Be()!==null?!0:!!window[Wl],qr=(t,e)=>{let o=Oa();if(!o)return p.warn(`[dialer-bridge] no emitter; cannot emit ${t}`),!1;try{return o.emit(t,e),!0}catch(r){return p.error(`[dialer-bridge] emit ${t} threw`,r),!1}},Gl=()=>{if(Be())return;let t=document.querySelector(o_);t?Oe(t):p.warn("[dialer-bridge] Voice Calling button not found")},a_=()=>{let t=document.querySelector(".number-list-container")||Be();if(!t)return[];let e=[];for(let o of t.querySelectorAll(".number")){let r=(o.innerText||"").replace(/\s+/g," ").trim();!r||/closest to the contact/i.test(r)||e.push({label:r,el:o})}return e},Ba=()=>{let t=document.querySelector(".number-config, .dialer-config");return t?n_(t.innerText):null},Kl=(t,e)=>{if(Ba()===t)return!0;let o=Oa();if(o)try{return o.emit("selectNumber",{phoneNumber:t,friendlyName:e||t}),!0}catch(r){p.warn("[dialer-bridge] selectNumber emit failed",r)}if(e){let r=document.querySelector(".number-config, .dialer-config");r&&Oe(r);let a=a_(),s=a.find(i=>i.label===e)||a.find(i=>i.label.includes(e));if(s)return Oe(s.el),!0}return p.warn(`[dialer-bridge] could not select Calling From ${t} (${e||""})`),!1},Vl=t=>{let e=t.replace(/[^\d*#+]/g,"");if(qr("sendDigitToDial",{value:e,fromInput:!0}))return;let o=[...document.querySelectorAll(".dial-item")];for(let r of e){let a=o.find(s=>s.querySelector(".dial-number")?.textContent?.trim()===r);a&&Oe(a)}},Yl=()=>{let t=Be();if(!t)return p.warn("[dialer-bridge] no dialer present to place call"),!1;let e=t.querySelector(r_)||[...t.querySelectorAll(".dial-item.dial-btn, button")].find(o=>{let a=getComputedStyle(o).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;let s=+a[1],i=+a[2],d=+a[3];return i>120&&i>s+40&&i>d+40&&o.offsetWidth>=40&&o.offsetWidth<=95&&o.querySelector("svg")!==null});return e?(Oe(e),!0):qr("makeCall",{provider:"twilio"})};var Ra=()=>{let t=Be();if(!t)return;let e=[...t.querySelectorAll("button, div, span")].find(o=>/^.{0,4}end call.{0,4}$/i.test((o.textContent||"").replace(/\s+/g," ").trim())&&(o.textContent||"").length<24);e?Oe(e.closest("button")||e):qr("closeCallBox")},Jl=()=>{qr("closeCallBox")},Ql=t=>{let e=!1,o=()=>{let s=Be()?.innerText||"",i=/Outgoing Call|Connected|\d{1,2}:\d{2}/.test(s)&&!/Call Summary|Call Ended/.test(s),d=/Call Summary|Call Ended/.test(s);if(i&&(e=!0),e&&d){e=!1;try{t()}catch(l){p.error("[dialer-bridge] onCallEnded cb threw",l)}}},r=new MutationObserver(o);r.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let a=window.setInterval(o,500);return()=>{r.disconnect(),window.clearInterval(a)}};var s_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/phone-assignments/get",i_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Zl=["acq","dispo","tc"],Oo={acq:"Acquisition Team",dispo:"Disposition Team",tc:"Transaction Coordination"},Po=null,Xl=null,l_=async(t=!1)=>{let e={numberTeam:{},numberLabel:{}},o=K();if(!o)return e;if(!t&&Po&&Xl===o)return Po;try{let a=await(await fetch(`${s_}?tenant_id=${encodeURIComponent(o)}`,{method:"GET",credentials:"omit"})).json(),s={};for(let i of a?.numbers??[])i?.e164&&(s[i.e164]=(i.label||"").trim());return Po={numberTeam:a?.config?.numberTeam??{},numberLabel:s},Xl=o,Po}catch(r){return p.warn("[silo] config load failed",r),Po??e}},pe=null,td=null,Ha=async(t=!1)=>{let e=K(),o=H();if(!e||!o)return[];if(!t&&pe&&td===e)return pe;try{let s=(await(await fetch(i_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:e,action:"list"})})).json())?.roster?.find(i=>i.id===o);if(s){let i=s.role_keys??[];pe=Zl.filter(d=>i.includes(d))}else ye()?pe=[...Zl]:pe=[];return td=e,pe}catch(r){return p.warn("[silo] roster load failed",r),pe??[]}},od=()=>`ws-pd-calling-as:${H()||"anon"}`,rd=t=>{try{localStorage.setItem(od(),t)}catch{}},Da=async()=>{let t=await Ha();if(t.length===0)return null;if(t.length===1)return t[0];let e=null;try{e=localStorage.getItem(od())}catch{}return e&&t.includes(e)?e:t[0]},ed=t=>{let e=(t||"").replace(/\D/g,"");return e.length===11&&e[0]==="1"?e.slice(1,4):e.length===10?e.slice(0,3):null},d_=(t,e)=>Object.entries(t).filter(([,o])=>o===e).map(([o])=>o),nd=async t=>{let e=await Da();if(!e)return p.debug("[silo] no active team for current rep; leaving GHL default"),null;let{numberTeam:o,numberLabel:r}=await l_(),a=d_(o,e);if(!a.length)return p.debug(`[silo] ${e} has no numbers; leaving GHL default`),null;let s=ed(t),i=s?a.find(m=>ed(m)===s):void 0,d=i||a[0];if(!Kl(d,r[d]||void 0))return p.warn(`[silo] could not issue Calling-From ${d} (dialer not ready?)`),null;p.info(`[silo] ${Oo[e]}: calling ${t} from ${d}${i?" (local match)":" (pool default)"}`),await new Promise(m=>setTimeout(m,150));let c=Ba();return c&&c!==d&&p.warn(`[silo] caller-ID did not stick: wanted ${d} but header shows ${c} \u2014 GHL dialer DOM/event may have changed`),d};var c_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/bulk-call/resolve-contact",ad="data-ws-pd",sd="ws-crm-pd-panel",id="ws-crm-pd-session",Qt=t=>new Promise(e=>setTimeout(e,t)),Bo=t=>String(t).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e),p_=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector(".crm-opportunities-card-wrapper"))return e;e=e.parentElement}return null},m_=t=>{let e=[t,...Array.from(t.querySelectorAll("*"))];for(let o of e)if(o.scrollHeight>o.clientHeight+40&&/auto|scroll/.test(getComputedStyle(o).overflowY))return o;return t},b_=t=>{let e=[],o=new Set;for(let r of Array.from(t.querySelectorAll(".crm-opportunities-card-wrapper"))){let a=r.querySelector('a[href*="/detail/"]'),s=(a?.getAttribute("href")||"").split("/detail/")[1]?.split(/[/?#]/)[0]||"";if(!s||o.has(s))continue;let i=Array.from(r.querySelectorAll("[id]")).find(d=>/^[A-Za-z0-9]{18,22}$/.test(d.id));o.add(s),e.push({oppId:i?.id||"",contactId:s,name:(a?.textContent||r.textContent||"").replace(/\s+/g," ").trim().slice(0,60)})}return e},h_=async t=>{let e=p_(t);if(!e)return[];let o=m_(e),r=-1;for(let a=0;a<60;a++){let s=e.querySelectorAll(".crm-opportunities-card-wrapper").length;if(s===r)break;r=s,o.scrollTop=o.scrollHeight,await Qt(550)}return o.scrollTop=0,b_(e)},u_=async(t,e)=>{try{let r=await(await fetch(c_,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"omit",body:JSON.stringify({tenant_id:t,contact_id:e})})).json();return r?.ok?{name:r.name||"",phone:r.phone||"",skip:!!r.skip}:null}catch(o){return p.warn("[bulk-dialer] resolvePhone failed",o),null}},__=`position:fixed;inset:0;z-index:100000;background:rgba(10,13,18,0.75);display:flex;align-items:center;justify-content:center;font-family:${h.sans};`,za=(t,e,o={one:"opportunity",many:"opportunities"})=>{document.getElementById(sd)?.remove();let r=document.createElement("div");r.id=sd,r.style.cssText=__;let a=document.createElement("div");a.style.cssText=`width:min(560px,94vw);max-height:88vh;display:flex;flex-direction:column;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.lg};padding:24px 28px;color:${n.bone};box-shadow:0 16px 40px rgba(0,0,0,0.5);`;let s=e.map((x,k)=>`<label data-row="${k}" style="display:flex;align-items:center;gap:10px;padding:7px 8px;border-bottom:1px solid ${n.steel};cursor:pointer;">
    ...
    <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:14px;">
      ...
      </div>`,s.querySelector("#ws-pd-end")?.addEventListener("click",()=>{a.stopped=!0;try{Ra()}catch{}s.remove()}),s.querySelector("#ws-pd-skip")?.addEventListener("click",()=>{a.skip=!0;try{Ra()}catch{}}),s.querySelector("#ws-pd-pause")?.addEventListener("click",()=>{a.paused=!a.paused}),s.querySelector("#ws-pd-next")?.addEventListener("click",()=>{a.advance=!0})};for(let d=0;d<e.length&&!a.stopped;d++){let l=e[d];a.skip=!1,a.advance=!1,i("Resolving number\u2026",d,l.name);let m=!l.contactId||l.contactId==="__test__"?null:await u_(r,l.contactId);if(a.stopped)break;if(m?.skip){i("Called in last 2h \u2014 skipping",d,m.name||l.name),await Qt(1200);continue}let u=l._phone||m?.phone||"",_=m?.name||l.name;if(!u){i("No phone on file \u2014 skipping",d,l.name||m?.name||l.contactId),await Qt(1400);continue}if(await nd(u),a.stopped)break;if(l.contactId&&l.contactId!=="__test__")try{let g=`/v2/location/${(window.location.pathname.match(/\/v2\/location\/([^/]+)/)||[])[1]||r}/contacts/detail/${l.contactId}`;window.location.pathname!==g&&(history.pushState({},"",g),window.dispatchEvent(new PopStateEvent("popstate")))}catch(b){p.debug("[bulk-dialer] screen-follow nav failed",b)}i(`Calling ${u}\u2026`,d,_);try{Gl(),await Qt(250),Vl(u),await Qt(250),Yl()}catch(b){p.error("[bulk-dialer] dial failed",b)}if(await new Promise(b=>{let g=!1,x=()=>{g||(g=!0,window.clearInterval(y),k(),b())},k=Ql(x),y=window.setInterval(()=>{(a.stopped||a.skip)&&x()},300)}),a.stopped)break;try{Jl()}catch{}if(d<e.length-1)if(o)for(let b=5;b>0&&!a.stopped&&!a.advance;b--){for(i(`Next call in ${b}s\u2026`,d,_);a.paused&&!a.stopped&&!a.advance;)await Qt(200);if(a.advance||a.stopped)break;await Qt(1e3)}else for(i("Ready \u2014 press Call Next",d,_);!a.advance&&!a.stopped;)await Qt(200)}a.stopped||(s.innerHTML=`<div style="font-size:13px;color:${n.bone};">Call session complete.</div><div style="font-size:12px;color:${n.ash};margin-top:4px;">${e.length} contact${e.length===1?"":"s"} dialed.</div>`,setTimeout(()=>s.remove(),5e3))},Na='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',qa=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},v_=()=>{if(ve()!=="opportunity-list"||!qa()||!Nr())return;document.querySelectorAll('[class*="stageHeaderBg"]').forEach(e=>{if(e.querySelector(`[${ad}]`))return;let o=e.querySelector('[id^="data-stage-name-"]');if(!o)return;let r=(o.textContent||"Stage").trim(),a=document.createElement("button");a.setAttribute(ad,"1"),a.title=`Power Dialer \u2014 call through ${r}`,a.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:8px;padding:3px 8px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emeraldBorder};border-radius:${v.pill};cursor:pointer;font-family:${h.mono};font-size:10px;font-weight:600;letter-spacing:0.06em;flex-shrink:0;`,a.innerHTML=`${Na}<span>DIAL</span>`,a.addEventListener("click",async s=>{s.stopPropagation(),s.preventDefault();let i=a.querySelector("span"),d=i?.textContent||"DIAL";i&&(i.textContent="Loading\u2026"),a.style.opacity="0.7";try{let l=await h_(e);za(r,l)}catch(l){p.error("[bulk-dialer] harvest failed",l)}finally{i&&(i.textContent=d),a.style.opacity="1"}}),o.parentElement?.appendChild(a)})},Re=null,Fa,ld=!1,cd=()=>{if(ld)return;ld=!0,window.WS_CRM_PD_TEST=e=>void dd("Verification",[{oppId:"",contactId:"__test__",name:`Test ${e}`,_phone:e}],!1);let t=()=>{Fa!==void 0&&window.clearTimeout(Fa),Fa=window.setTimeout(v_,400)};_t(e=>{e==="opportunity-list"?(t(),Re||(Re=new MutationObserver(t),Re.observe(document.body,{childList:!0,subtree:!0}))):Re&&(Re.disconnect(),Re=null)})};var pd="ws-crm-pd-contacts-btn",y_=t=>new Promise(e=>setTimeout(e,t)),g_=t=>{let e=t.match(/(?:\+?1[\s.\-]?)?\(?(\d{3})\)?[\s.\-]?(\d{3})[\s.\-]?(\d{4})/);return e?`+1${e[1]}${e[2]}${e[3]}`:""},f_=()=>document.querySelectorAll(".tabulator-row.tabulator-selected, .tabulator-row input[type=checkbox]:checked").length>0,Ua=(t,e)=>{document.querySelectorAll(".tabulator-row").forEach(o=>{if(e){let l=o.querySelector('input[type="checkbox"]');if(!(o.classList.contains("tabulator-selected")||!!(l&&l.checked)))return}let r=o.querySelector('a[href*="/contacts/detail/"]'),a=(r?.getAttribute("href")||"").split("/contacts/detail/")[1]?.split(/[/?#]/)[0]||"";if(!a||t.has(a))return;let s=(r?.textContent||"").replace(/\s+/g," ").trim(),i=g_(o.textContent||""),d=s&&s!=="-"?s:i||a;t.set(a,{oppId:"",contactId:a,name:d,_phone:i||void 0})})},x_=async t=>{let e=new Map;if(t)return Ua(e,!0),[...e.values()];let o=document.querySelector(".tabulator-tableholder");if(Ua(e,!1),!o)return[...e.values()];let r=-1,a=-1,s=0;for(let i=0;i<200&&(Ua(e,!1),e.size===a?s++:(s=0,a=e.size),!(i>0&&o.scrollTop===r&&s>=2));i++)r=o.scrollTop,o.scrollTop=r+Math.max(120,o.clientHeight*.85),await y_(220);return o.scrollTop=0,[...e.values()]},w_=()=>{if(ve()!=="contact-list"||!qa()||!Nr()||document.getElementById(pd))return;let t=document.querySelector("#views-bar .bar");if(!t)return;let e=document.createElement("button");e.id=pd,e.type="button",e.title="Power Dialer: call through this list, or the rows you've checked",e.style.cssText=`display:inline-flex;align-items:center;justify-content:center;gap:5px;margin-left:auto;margin-right:4px;align-self:center;padding:5px 12px;background:${n.emeraldGlow};color:${n.emerald};border:1px solid ${n.emerald};border-radius:${v.pill};box-shadow:0 0 0 1px rgba(15,181,126,0.35),0 0 10px 1px rgba(15,181,126,0.5);cursor:pointer;font-family:${h.mono};font-size:11px;font-weight:600;letter-spacing:0.04em;flex-shrink:0;`,e.innerHTML=`${Na}<span>Power Dialer</span>`;let o=e.querySelector("span");o&&(o.style.setProperty("color",n.emerald,"important"),o.style.setProperty("-webkit-text-fill-color",n.emerald,"important"));let r=e.querySelector("svg");r&&(r.style.setProperty("color",n.emerald,"important"),r.style.setProperty("stroke",n.emerald,"important")),e.style.setProperty("border-color",n.emerald,"important"),e.addEventListener("click",async a=>{a.stopPropagation(),a.preventDefault();let s=e.querySelector("span"),i=s?.textContent||"Power Dialer";s&&(s.textContent="Loading\u2026"),e.style.opacity="0.7";try{let d=f_(),l=await x_(d);za(d?"Selected contacts":"Smart list",l,{one:"contact",many:"contacts"})}catch(d){p.error("[bulk-dialer-contacts] harvest failed",d)}finally{s&&(s.textContent=i),e.style.opacity="1"}}),t.appendChild(e)},He=null,ja,md=!1,bd=()=>{if(md)return;md=!0;let t=()=>{ja!==void 0&&window.clearTimeout(ja),ja=window.setTimeout(w_,400)};_t(e=>{e==="contact-list"?(t(),He||(He=new MutationObserver(t),He.observe(document.body,{childList:!0,subtree:!0}))):He&&(He.disconnect(),He=null)})};var k_="ws-calling-as-chip",E_=()=>{try{let t=localStorage.getItem("ws-pd");if(t==="1")return!0;if(t==="0")return!1}catch{}return!0},Wa=!1,me=null,hd,_d=0,$_=3e4,T_=()=>{let t=document.querySelector(".hl_header--controls");if(!t)return null;let e=t.querySelector('button[aria-label*="Voice Calling" i], button[aria-label*="call" i]');if(!e)return null;let o=e;for(;o&&o.parentElement!==t;)o=o.parentElement;return o?{parent:t,before:o}:null},Ga=()=>{if(!me||me.isConnected)return;let t=T_();t&&t.parent.insertBefore(me,t.before)},ud=async()=>{if(!(Wa||me)&&E_()){Wa=!0;try{let t=await Ha();if(!t.length)return;let e=await Da()??t[0],o=t.length>1,r=document.createElement("div");r.id=k_,r.style.cssText="position:relative;display:inline-flex;align-items:center;margin:0 6px;";let a=document.createElement("button");a.type="button",a.style.cssText=`display:inline-flex;align-items:center;gap:7px;padding:5px 11px;background:${n.graphite};border:1px solid ${n.steel};border-left:3px solid ${n.emerald};border-radius:${v.pill};color:${n.bone};font-family:${h.sans};font-size:11px;white-space:nowrap;cursor:${o?"pointer":"default"};`,a.innerHTML=`<span style="font-family:${h.mono};font-size:9px;letter-spacing:0.12em;text-transform:uppercase;color:${n.ash};">Calling as</span><span class="ws-ca-team" style="font-weight:600;">${Oo[e]}</span>${o?`<span style="color:${n.ash};">\u25BE</span>`:""}`,r.appendChild(a);let s=i=>{let d=a.querySelector(".ws-ca-team");d&&(d.textContent=Oo[i])};if(o){let i=document.createElement("div");i.style.cssText=`position:fixed;min-width:200px;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 8px 24px rgba(0,0,0,0.45);overflow:hidden;display:none;z-index:99999;`;let d=()=>{i.innerHTML="",t.forEach(l=>{let c=document.createElement("div"),m=l===e;c.style.cssText=`padding:9px 14px;font-family:${h.sans};font-size:13px;color:${m?n.emeraldBright:n.bone};cursor:pointer;background:${m?n.emeraldGlow:"transparent"};`,c.textContent=Oo[l],c.addEventListener("mouseenter",()=>{l!==e&&(c.style.background=n.steel)}),c.addEventListener("mouseleave",()=>{l!==e&&(c.style.background="transparent")}),c.addEventListener("click",u=>{u.stopPropagation(),e=l,rd(l),s(l),d(),i.style.display="none"}),i.appendChild(c)})};d(),document.body.appendChild(i),a.addEventListener("click",l=>{if(l.stopPropagation(),i.style.display==="block"){i.style.display="none";return}let c=a.getBoundingClientRect();i.style.top=`${Math.round(c.bottom+6)}px`,i.style.left=`${Math.round(c.left)}px`,i.style.display="block"}),document.addEventListener("click",()=>{i.style.display="none"})}me=r,Ga(),p.info(`[calling-as] chip mounted in header (roles=${t.join(",")}, active=${e}, multi=${o})`)}catch(t){p.error("[calling-as] build failed",t)}finally{Wa=!1,_d=Date.now()}}},vd=()=>{me?Ga():ud(),hd===void 0&&(hd=window.setInterval(()=>{me?Ga():Date.now()-_d>=$_&&ud()},1500))};var C_="#12161D",A_="#EDEEF0",yd=t=>{let o=getComputedStyle(t).backgroundColor.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?/);if(!o)return!1;let r=+o[1],a=+o[2],s=+o[3];return(o[4]!==void 0?+o[4]:1)>.1&&r>=230&&a>=230&&s>=230},gd=t=>{t.style.setProperty("background-color",C_,"important"),t.style.setProperty("color",A_,"important")},S_=()=>{for(let t of Array.from(document.body.children)){if(t.tagName!=="DIV")continue;let e=t;if(!(e.id||e.className)&&getComputedStyle(e).position==="fixed")return e}return null},L_=t=>{yd(t)&&gd(t);for(let e of Array.from(t.querySelectorAll("*")))yd(e)&&gd(e)},Ka=null,Ro=null,xd=()=>{Ro&&(Ro.disconnect(),Ro=null),Ka=null},I_=t=>{if(Ka===t)return;xd(),Ka=t;let e=!1,o=()=>{e=!1;try{L_(t)}catch(a){p.debug("[dialer-theme] paint failed",a)}},r=()=>{e||(e=!0,requestAnimationFrame(o))};Ro=new MutationObserver(r),Ro.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),r(),p.info("[dialer-theme] fast white-flash guard attached to teleported softphone panel")},fd=!1,Ur=()=>{if(fd)return;fd=!0;let t=()=>{let o=S_();o?I_(o):xd()};t(),new MutationObserver(t).observe(document.body,{childList:!0})};var M_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact/search",P_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/set-field",O_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/opp/get-field",Ed="tc_closing_agent",B_="tc_closing_office",Et="ws-crm-closing-agent-picker-button",$d="ws-crm-closing-agent-picker-modal",R_=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,H_=/\/v2\/location\/([A-Za-z0-9]+)/,Fo=()=>{let t=window.location.pathname,e=t.match(R_);if(!e)return null;let o=t.match(H_);return{oppId:e[1],locationId:o?o[1]:null}},Xa=async t=>{let e=await fetch(M_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,query:t.query??"",contact_id:t.contactId??null,contact_type:t.contactType??null,limit:t.limit??20}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},wd=async t=>{let e=await fetch(P_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,opp_id:t.oppId,field_key:t.fieldKey,value:t.value}),credentials:"omit"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()},D_=async(t,e)=>{try{let o=await fetch(O_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,opp_id:t,field_key:Ed}),credentials:"omit"});if(!o.ok)return null;let r=await o.json(),a=typeof r.value=="string"&&r.value.trim()?r.value.trim():null;if(!a||!/^[A-Za-z0-9]{16,}$/.test(a))return null;let s=await Xa({tenantId:e,contactId:a,limit:1});if(!s.ok||!s.results.length)return null;let i=s.results[0];return{id:i.id,name:i.name,companyName:i.companyName??""}}catch(o){return p.warn("[closing-agent] fetchCurrent failed:",o),null}},be=null,F_=60*60*1e3,ts=t=>`ws-crm-to-cache:${t}`,Td=t=>{try{let e=window.localStorage.getItem(ts(t));if(!e)return null;let o=JSON.parse(e);return!o.ts||Date.now()-o.ts>F_||typeof o.contactId!="string"||!o.contactId||typeof o.contactName!="string"||!o.contactName?null:o}catch{return null}},Cd=(t,e,o)=>{try{window.localStorage.setItem(ts(t),JSON.stringify({contactId:e,contactName:o,ts:Date.now()}))}catch{}},z_=t=>{try{window.localStorage.removeItem(ts(t))}catch{}},Ya="ws-crm-closing-agent-field-link",N_=()=>{let t=document.querySelector(".crm-opportunities-modal");t&&(t.querySelectorAll(`.${Ya}`).forEach(e=>e.remove()),t.querySelectorAll("input[data-ws-closing-agent-decorated]").forEach(e=>{e.style.removeProperty("color"),e.style.removeProperty("caret-color"),e.style.removeProperty("visibility"),delete e.dataset.wsClosingAgentDecorated}))},Va=!1,es=async t=>{if(Va)return;let e=Ad();if(!e)return;let o=(e.value||"").trim();if(!o){p.info("[closing-agent] tryDecorate: input has empty value");return}if(!/^[A-Za-z0-9]{16,}$/.test(o)){p.info(`[closing-agent] tryDecorate: value '${o}' doesn't match contact-ID pattern (expecting 16+ alphanumeric)`);return}if(e.dataset.wsClosingAgentDecorated!==o){Va=!0;try{p.info(`[closing-agent] tryDecorate: looking up ${o}`);let r=await Xa({tenantId:t,contactId:o,limit:1});if(!r.ok||!r.results.length){p.warn(`[closing-agent] tryDecorate: contact ${o} not found`);return}let a=r.results[0];p.info(`[closing-agent] tryDecorate: applying ${a.name} (${a.id})`),Ja(a.id,a.name,t);let s=document.getElementById(Et);if(s){Zt(s,{status:"linked",contactName:a.name});let i=Fo();i&&Cd(i.oppId,a.id,a.name)}}catch(r){p.warn("[closing-agent] tryDecorate lookup failed:",r)}finally{Va=!1}}},q_=/^TC\s*[-‐–—]\s*Closing\s+Agent$/i,Ad=()=>{let e=document.querySelectorAll("*"),o=[],r=[],a=[];for(let l of e){let c=(l.textContent||"").trim();q_.test(c)?o.push(l):c.length<80&&/Title\s+Officer/i.test(c)&&r.push(c);for(let m of["aria-label","placeholder","data-label","title","name","data-test"]){let u=l.getAttribute(m);u&&/Title\s+Officer/i.test(u)&&a.push({tag:l.tagName.toLowerCase(),attr:m,value:u})}}if(p.info(`[closing-agent] findInput: ${o.length} regex-matched, ${r.length} near-text matches, ${a.length} attribute matches`),r.length&&p.warn("[closing-agent] near-text samples:",[...new Set(r)].slice(0,8)),a.length&&p.warn("[closing-agent] attribute matches:",a.slice(0,8)),o.length===0)return null;o.sort((l,c)=>l.querySelectorAll("*").length-c.querySelectorAll("*").length);let i=o[0].parentElement,d=0;for(;i&&d<8;){let l=i.querySelector("input");if(l)return p.info(`[closing-agent] findInput: located input ${d} levels up from label`),l;i=i.parentElement,d+=1}return p.warn("[closing-agent] findInput: label found but no <input> within 8 ancestors"),null},Ja=(t,e,o)=>{let r=Ad();if(!r)return;let a=r.dataset.wsClosingAgentDecorated;if(a!==t){a&&r.parentElement?.querySelectorAll(`.${Ya}`).forEach(i=>i.remove());{let s=r.parentElement;if(!s)return;r.dataset.wsClosingAgentDecorated=t,r.style.visibility="hidden",window.getComputedStyle(s).position==="static"&&(s.style.position="relative");let d=document.createElement("a");d.className=Ya,d.href=`/v2/location/${o}/contacts/detail/${t}`,d.textContent=e,d.style.cssText=`
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
      ...
      border-radius: ${v.sm};
      z-index: 2;
    `,d.addEventListener("mouseenter",()=>{d.style.textDecoration="underline"}),d.addEventListener("mouseleave",()=>{d.style.textDecoration="none"}),d.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),window.location.href=d.href}),s.appendChild(d)}}},jr=()=>{document.getElementById($d)?.remove()},U_=t=>{jr();let e=document.createElement("div");e.id=$d,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(o),document.body.appendChild(e);let r=o.querySelector("#ws-top-search"),a=o.querySelector("#ws-top-results"),s=o.querySelector("#ws-top-cancel");setTimeout(()=>r?.focus(),50),e.addEventListener("click",c=>{c.target===e&&jr()}),s?.addEventListener("click",jr);let i,d="",l=async c=>{if(a&&c!==d){if(d=c,!c.trim()){a.innerHTML=`
      ...
      <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
        Searching\u2026
      </div>`;try{let m=await Xa({tenantId:t.locationId,query:c,contactType:"closing_agent",limit:20});if(!m.ok||!Array.isArray(m.results)||m.results.length===0){a.innerHTML=`
          <div style="padding: 16px; color: ${n.ash}; font-size: 13px; text-align: center;">
            No results.
  ...
  `;let r={status:"loading"};Zt(o,r);let a=Td(t);return a&&(r={status:"linked",contactName:a.contactName},Zt(o,r),be={oppId:t,contactId:a.contactId,contactName:a.contactName,tenantId:e}),(async()=>{let i=await D_(t,e);i?(r={status:"linked",contactName:i.name},Zt(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Ja(i.id,i.name,e)):a||(r={status:"empty"},Zt(o,r),be?.oppId===t&&(be=null),N_(),z_(t))})(),o.addEventListener("mouseenter",()=>{r.status!=="loading"&&r.status!=="saving"&&(o.style.transform="translateY(-1px)")}),o.addEventListener("mouseleave",()=>{o.style.transform="translateY(0)"}),o.addEventListener("click",()=>{r.status==="loading"||r.status==="saving"||U_({oppId:t,locationId:e,onPick:async i=>{r={status:"saving"},Zt(o,r);try{let d=await wd({tenantId:e,oppId:t,fieldKey:Ed,value:i.id});if(!d.ok)throw new Error(d.error??"Save failed");i.companyName&&i.companyName.trim()&&await wd({tenantId:e,oppId:t,fieldKey:B_,value:i.companyName.trim()}),r={status:"linked",contactName:i.name},Zt(o,r),be={oppId:t,contactId:i.id,contactName:i.name,tenantId:e},Cd(t,i.id,i.name),Ja(i.id,i.name,e),bl(t),p.info(`Closing Agent linked: ${i.name} (${i.id})${i.companyName?` \u2014 Company: ${i.companyName}`:""}`)}catch(d){p.error("Closing Agent link failed",d),r={status:"empty"},Zt(o,r)}}})}),o},W_=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading"],G_=async()=>{for(let t of W_)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Ho=!1,Kr=async()=>{if(!Ho){Ho=!0;try{await K_()}finally{Ho=!1}}},K_=async()=>{let t=Fo();if(!t||!t.locationId){document.getElementById(Et)?.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Gr();return}let e=document.getElementById(Et);if(e&&e.dataset.oppId===t.oppId){let l=z();l!==null&&l!=="Transaction Coordination"&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove(),Gr());return}e&&(e.remove(),document.getElementById(`${Et}-wrap`)?.remove());let o=z();if(o!==null&&o!=="Transaction Coordination")return;let r=await G_();if(!r||!(Td(t.oppId)!==null||be!==null&&be.oppId===t.oppId)&&await et()!=="Transaction Coordination")return;let s=Fo();if(!s||s.oppId!==t.oppId||!s.locationId)return;let i=j_(t.oppId,s.locationId),d=document.createElement("span");d.id=`${Et}-wrap`,d.style.cssText=`
    display: inline-flex;
    align-items: center;
    flex-shrink: 0;
    vertical-align: middle;
    order: 2;
  `,d.appendChild(i),Q(r).appendChild(d),p.debug(`Mounted Closing Agent picker on opp ${t.oppId}`),V_(t.oppId),es(s.locationId)},Do=null,Qa=null,Za=null,Gr=()=>{Do?.disconnect(),Do=null,Qa=null,Za=null},V_=t=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Do&&Qa===t&&Za===e||(Gr(),Qa=t,Za=e,Do=new MutationObserver(()=>{let o=Fo();if(!o||o.oppId!==t||!o.locationId){Gr();return}document.getElementById(Et)||Kr(),es(o.locationId)}),Do.observe(e,{childList:!0,subtree:!0})))},Y_=()=>{J("closing-agent-picker",tt,()=>{!document.getElementById(Et)&&!Ho&&Kr()})},kd,J_=()=>{kd===void 0&&(kd=window.setInterval(()=>{let t=Fo();if(!t||!t.locationId||!!!document.querySelector(".crm-opportunities-modal"))return;!!!document.getElementById(Et)&&!Ho&&(p.info("[closing-agent] safety-net: button missing on opp page \u2014 remounting"),Kr()),es(t.locationId)},2e3))},Sd=()=>{p.info("[closing-agent] mountClosingAgentPickerButton invoked"),Y_(),J_(),Kr()};var Q_="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/team/manage",Ht="ws-crm-manage-team-cta",Id="ws-crm-manage-team-modal",Z_=/\/v2\/location\/([A-Za-z0-9]+)\/settings\/staff\/team/,Md={manager:"Owner",acq:"Acquisitions Rep",dispo:"Disposition Rep",tc:"Transaction Coordinator",acq_manager:"ACQ Manager",dispo_manager:"Dispo Manager",tc_manager:"TC Manager"},X_={manager:{bg:"rgba(75, 139, 245, 0.15)",fg:n.blue},acq:{bg:n.emeraldGlow,fg:n.emerald},dispo:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson},acq_manager:{bg:n.emeraldGlow,fg:n.emerald},dispo_manager:{bg:"rgba(232, 163, 60, 0.15)",fg:n.amber},tc_manager:{bg:"rgba(212, 63, 74, 0.15)",fg:n.crimson}},Pd=()=>{let t=window.location.pathname.match(Z_);return t?{tenantId:t[1]}:null},Yr=async t=>{let e=await fetch(Q_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit"});if(!e.ok){let o="";try{o=await e.text()}catch{}throw new Error(`Team.Manage HTTP ${e.status}${o?` \u2014 ${o.slice(0,200)}`:""}`)}return await e.json()},yt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Xt=t=>yt(t),os="ws-crm-manage-team-toast",as=(t,e="info",o=4e3)=>{document.getElementById(os)?.remove();let r=e==="success"?n.emerald:e==="error"?n.crimson:n.ash,a=document.createElement("div");a.id=os,a.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 9999999;
  ...
  `,a.textContent=t,document.body.appendChild(a),o>0&&window.setTimeout(()=>{document.getElementById(os)===a&&a.remove()},o)},rs=()=>{document.getElementById(Id)?.remove()},tv=(t,e)=>{let o=X_[t]||{bg:n.slate,fg:n.ash};return`
    <span style="
      display: inline-block;
      background: ${o.bg};
      color: ${o.fg};
      ...
      margin-bottom: 4px;
    ">${yt(e)}</span>
  `},ev=(t,e)=>{let o=[t.first_name,t.last_name].filter(Boolean).join(" ")||"(no name)",r=t.roles.map(i=>tv(i.key,i.display)).join(""),a=e?"":"opacity: 0.45; pointer-events: none; cursor: not-allowed;",s=e?"":'title="Owner-only action"';return`
  ...
  `+t.map(r=>ev(r,e)).join(""),Jr=async t=>{rs();let e=document.createElement("div");e.id=Id,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999998;
    background: rgba(0, 0, 0, 0.6);
    ...
    justify-content: center;
    font-family: ${h.sans};
  `,e.addEventListener("click",l=>{l.target===e&&rs()});let o=document.createElement("div");o.style.cssText=`
  ...
  `,e.appendChild(o),document.body.appendChild(e),o.querySelector("#ws-team-close")?.addEventListener("click",rs);let r;try{r=await Yr({tenant_id:t,action:"list"})}catch(l){let c=o.querySelector("#ws-team-content");c&&(c.innerHTML=`
    ...
    `:"",d=o.querySelector("#ws-team-content");if(d&&(d.innerHTML=i+ov(r.roster,s)),s)o.querySelector("#ws-team-add")?.addEventListener("click",()=>{rv(t)}),o.querySelectorAll(".ws-team-edit").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;nv(t,{email:m.dataset.email||"",name:m.dataset.name||"",currentRoles:(m.dataset.currentRoles||"").split(",").filter(Boolean)})})}),o.querySelectorAll(".ws-team-remove").forEach(l=>{l.addEventListener("click",c=>{let m=c.currentTarget;av(t,{email:m.dataset.email||"",name:m.dataset.name||"",roleCount:parseInt(m.dataset.roleCount||"0",10)})})});else{let l=o.querySelector("#ws-team-actions");l&&(l.innerHTML=`
      ...
      `)}},rv=t=>{let e="ws-crm-manage-team-add-modal";document.getElementById(e)?.remove();let o=document.createElement("div");o.id=e,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
  ...
  `;let s=i=>{let d=e.currentRoles.includes(i)?"checked":"";return`
      <label style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: ${n.slate}; border: 1px solid ${n.steel}; border-radius: ${v.sm}; cursor: pointer; margin-bottom: 6px;">
        ...
        <span style="font-size: 13px;">${yt(Md[i])}</span>
      </label>
    `};a.innerHTML=`
  ...
  `,e.addEventListener("click",()=>{Jr(t)}),Vr(e),setTimeout(()=>Vr(e),200),setTimeout(()=>Vr(e),800),hv(),e},Ld=!1,hv=()=>{Ld||(Ld=!0,window.addEventListener("resize",()=>{let t=document.getElementById(Ht);t instanceof HTMLButtonElement&&Vr(t)}))},ns=!1,uv=()=>{if(!ns){ns=!0;try{let t=Pd();if(!t){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}let e=document.getElementById(Ht);if(e&&e.dataset.tenantId===t.tenantId)return;document.getElementById(`${Ht}-floater`)?.remove();let o=document.createElement("div");o.id=`${Ht}-floater`,o.style.cssText=`
      position: fixed;
      top: 88px;
      right: 32px;
      z-index: 99999;
    `;let r=bv(t.tenantId);r.dataset.tenantId=t.tenantId,o.appendChild(r),document.body.appendChild(o),p.debug(`[manage-team] mounted (floater) for tenant ${t.tenantId}`)}finally{ns=!1}}},Od=()=>{if(!Pd()){document.getElementById(Ht)?.remove(),document.getElementById(`${Ht}-floater`)?.remove();return}uv()};var _v="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contract/stage",ls="ws-crm-prepare-contract-button",Bd="ws-crm-prepare-contract-menu",Mt="ws-crm-prepare-contract-modal",Rd="ws-crm-modal-date-style",Dt="https://services.leadconnectorhq.com",qd=()=>{if(document.getElementById(Rd))return;let t=document.createElement("style");t.id=Rd,t.textContent=`
  ...
  `,document.head.appendChild(t)},ds="__WS_CRM_CAPTURED_AUTH",vv=50*60*1e3,Uo=()=>{try{let t=localStorage.getItem(ds);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>vv?(localStorage.removeItem(ds),null):e:null}catch{return null}},yv=t=>{try{localStorage.setItem(ds,JSON.stringify(t))}catch{}},Fe=()=>{let t=Uo(),e=window;if(e.__WS_CRM_DIAG=e.__WS_CRM_DIAG||{},e.__WS_CRM_DIAG.authChecks=(e.__WS_CRM_DIAG.authChecks||0)+1,console.log(`[ws-crm-customizer] [auth-check #${e.__WS_CRM_DIAG.authChecks}]`,t?`present (captured ${Date.now()-t.capturedAt}ms ago, ${t.authorization.slice(0,20)}\u2026)`:"NULL \u2014 interceptor has not captured a token yet"),!t)throw new Error("GHL auth not yet captured. Try clicking around the page (refresh, open a contact) to trigger a GHL API call, then retry.");let o={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(o["token-id"]=t.tokenId),o},Hd=(t,e)=>new Promise(o=>{let r=Date.now(),a=()=>{if((Uo()?.capturedAt??0)>t)return o(!0);if(Date.now()-r>e)return o(!1);window.setTimeout(a,250)};a()}),De=async(t,e={},o=2)=>{let r=Uo()?.capturedAt??0,a;try{a={...Fe(),...e.headers??{}}}catch(i){if(o>0&&await Hd(r,4e3))return De(t,e,o-1);throw i}let s=await fetch(t,{...e,headers:a});return s.status!==401||o<=0?s:await Hd(r,4e3)?De(t,e,o-1):s},Dd=!1,gv=()=>{if(Dd)return;Dd=!0;let t=window;t.__WS_CRM_DIAG=t.__WS_CRM_DIAG||{fetchCalls:0,xhrCalls:0,fetchAuthSeen:0,xhrAuthSeen:0,captured:0,lastSeenHeaders:null};let e=()=>{let l=Uo();return!!(l&&l.authorization&&Date.now()-(l.capturedAt||0)<3e5)},o=(l,c,m)=>{t.__WS_CRM_DIAG.lastSeenHeaders={url:l,headers:c,source:m};let u=c.authorization||c.Authorization;if(!u){t.__WS_CRM_DIAG.fetchCalls+t.__WS_CRM_DIAG.xhrCalls<=3&&console.log(`[ws-crm-customizer] [intercept:${m} no-auth]`,{url:l.split("?")[0],headerKeys:Object.keys(c)});return}m==="fetch"?t.__WS_CRM_DIAG.fetchAuthSeen++:t.__WS_CRM_DIAG.xhrAuthSeen++;let _=c["token-id"]||c["Token-Id"]||void 0,b=Uo()?.authorization;yv({authorization:u,tokenId:_,capturedAt:Date.now()}),b!==u&&(t.__WS_CRM_DIAG.captured++,console.log(`[ws-crm-customizer] [intercept:${m}] captured GHL auth from ${l.split("?")[0]} (${u.slice(0,24)}\u2026)`))},r=window.fetch;window.fetch=async function(...l){let c=typeof l[0]=="string"?l[0]:l[0]instanceof URL?l[0].toString():l[0].url,m=l[1]||{};if(c&&c.includes("services.leadconnectorhq.com")&&!e()){t.__WS_CRM_DIAG.fetchCalls++;let u=m.headers;!u&&l[0]instanceof Request&&(u=l[0].headers);let _={};if(u instanceof Headers)u.forEach((b,g)=>_[g.toLowerCase()]=b);else if(Array.isArray(u))u.forEach(([b,g])=>_[b.toLowerCase()]=g);else if(u&&typeof u=="object")for(let b of Object.keys(u))_[b.toLowerCase()]=u[b];o(c,_,"fetch")}return r.apply(this,l)};let a=XMLHttpRequest.prototype,s=a.open,i=a.setRequestHeader,d=a.send;a.open=function(l,c,...m){return this.__wsCrmUrl=c,this.__wsCrmHeaders={},s.call(this,l,c,...m)},a.setRequestHeader=function(l,c){return this.__wsCrmHeaders&&typeof l=="string"&&(this.__wsCrmHeaders[l.toLowerCase()]=c),i.call(this,l,c)},a.send=function(l){let c=this.__wsCrmUrl,m=this.__wsCrmHeaders;return c&&c.includes("services.leadconnectorhq.com")&&m&&!e()&&(t.__WS_CRM_DIAG.xhrCalls++,o(c,m,"xhr")),d.call(this,l)},p.debug("[prepare-contract] interceptors installed (fetch + XHR)")},Ud=()=>{let t=D();return!t||!t.locationId?null:{contactId:t.contactId,tenantId:t.locationId}},fv=t=>{let e=t.dataset;return e.tenantId&&e.contactId?{tenantId:e.tenantId,contactId:e.contactId,oppId:e.oppId||void 0}:e.tenantId&&e.oppId?{tenantId:e.tenantId,contactId:"",oppId:e.oppId}:Ud()},xv=t=>{let e=(t||"").trim().toLowerCase();return/^\[?\s*aa\s*\]?\s*[-\s]/i.test(e)||/assignment.*(contract|agreement)/i.test(e)?"AA":/^\[?\s*pa\s*\]?\s*[-\s]/i.test(e)||/purchase.*(contract|agreement)/i.test(e)?"PA":"passthrough"},jd="__WS_CRM_TEMPLATES_CACHE_V1",wv=24*60*60*1e3,Fd=t=>{try{let e=window.localStorage.getItem(jd);if(!e)return null;let o=JSON.parse(e);return o.tenantId!==t||Date.now()-o.cachedAt>wv?null:o.templates}catch{return null}},kv=(t,e)=>{try{let o={tenantId:t,templates:e,cachedAt:Date.now()};window.localStorage.setItem(jd,JSON.stringify(o))}catch{}},Ev=async t=>{let e=`${Dt}/proposals/templates/bulk?type.in%5B%5D=proposal&type.in%5B%5D=estimate&locationId.eq=${encodeURIComponent(t)}&skip=0&limit=10`,o;try{o=await De(e,{method:"GET"})}catch(i){let d=Fd(t);if(d)return p.info(`[prepare-contract] templates network failure, using cache (${d.length} items)`),d;throw i}if(!o.ok){let i=Fd(t);if(i)return p.info(`[prepare-contract] templates fetch ${o.status}, using cache (${i.length} items)`),i;let d="";try{d=await o.text()}catch{}let l=d?` \u2014 ${d.slice(0,200)}`:"";throw new Error(`Templates fetch returned ${o.status} ${o.statusText}${l}`)}let r=await o.json();console.log("[ws-crm-customizer] [templates response]",Array.isArray(r)?`array of ${r.length}`:`keys: ${Object.keys(r||{}).join(", ")}`,r);let a=[];Array.isArray(r)?a=r:Array.isArray(r?.templates)?a=r.templates:Array.isArray(r?.items)?a=r.items:Array.isArray(r?.data)?a=r.data:Array.isArray(r?.results)?a=r.results:Array.isArray(r?.docs)?a=r.docs:r?.data&&Array.isArray(r.data.templates)?a=r.data.templates:r?.data&&Array.isArray(r.data.items)&&(a=r.data.items);let s=a.map(i=>({id:(i._id??i.id??i.templateId)||"",name:i.name||i.title||"(unnamed template)",type:xv(i.name||i.title||"")})).filter(i=>!!i.id);return s.length>0&&kv(t,s),s},$v=async(t,e)=>{let o=await De(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(d=>/acquisition/i.test(d.name));if(!a)throw new Error("No Acquisition pipeline found on tenant");let s=await De(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET"});if(!s.ok)throw new Error(`ACQ opp search ${s.status}`);return((await s.json()).opportunities||[]).map(d=>({id:d.id,name:d.name||"(unnamed opp)",propertyAddress:d.name||"",updatedAt:d.updatedAt||null})).sort((d,l)=>{let c=d.updatedAt?Date.parse(d.updatedAt):0;return(l.updatedAt?Date.parse(l.updatedAt):0)-c})},Tv=async(t,e)=>{let o=await De(`${Dt}/opportunities/pipelines?locationId=${encodeURIComponent(t)}`,{method:"GET"});if(!o.ok)throw new Error(`Pipelines fetch ${o.status}`);let a=((await o.json()).pipelines||[]).find(l=>/marketing\s*tracker/i.test(l.name));if(!a)throw new Error("No Marketing Tracker pipeline found on tenant");let s=await fetch(`${Dt}/opportunities/search?location_id=${encodeURIComponent(t)}&pipeline_id=${encodeURIComponent(a.id)}&contact_id=${encodeURIComponent(e)}&status=open&limit=20`,{method:"GET",headers:Fe()});if(!s.ok)throw new Error(`MT opp search ${s.status}`);return((await s.json()).opportunities||[]).map(l=>({id:l.id,name:l.name||"(unnamed opp)",propertyAddress:l.name||"",updatedAt:l.updatedAt||null})).sort((l,c)=>{let m=l.updatedAt?Date.parse(l.updatedAt):0;return(c.updatedAt?Date.parse(c.updatedAt):0)-m})},Cv=async t=>{let e=await fetch(_v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:t.tenantId,contact_id:t.contactId,template_id:t.templateId,template_type:t.templateType,opp_id:t.oppId,closing_date:t.closingDate,buyer_earnest_due_date:t.buyerEarnestDueDate,lender_source:t.lenderSource,triggered_by_user_id:t.userId,overrides:t.overrides}),credentials:"omit"});if(!e.ok)throw new Error(`Contract.Stage HTTP ${e.status}`);return await e.json()},Av=async(t,e,o)=>{let r=`${Dt}/proposals/templates/to-proposal/${t}/${e}?locale=en-US&contactId=${encodeURIComponent(o)}`,a=await fetch(r,{method:"POST",headers:Fe()});if(!a.ok)throw new Error(`to-proposal HTTP ${a.status} ${a.statusText}`);let s=await a.json(),i=s._id||s.id||s.proposal?._id||s.proposal?.id;if(!i)throw new Error("to-proposal returned no proposal id");return i},Sv=async(t,e)=>{let o=await fetch(`${Dt}/proposals/document/${e}?locationId=${encodeURIComponent(t)}`,{method:"GET",headers:Fe()});if(!o.ok){let s=await o.text().catch(()=>"");throw new Error(`GET proposal ${e} HTTP ${o.status} ${s.slice(0,200)}`)}let r=await o.json(),a=r?.document||r?.proposal||r;if(!a||typeof a!="object")throw new Error(`GET proposal returned unexpected shape: ${JSON.stringify(r).slice(0,200)}`);return a},Wd=async t=>{let e=await fetch(`${Dt}/contacts/${t}`,{method:"GET",headers:Fe()});if(!e.ok){let a=await e.text().catch(()=>"");throw new Error(`GET contact ${t} HTTP ${e.status} ${a.slice(0,200)}`)}let o=await e.json(),r=o?.contact||o;return{firstName:r?.firstName||"",lastName:r?.lastName||"",email:r?.email||""}},Lv=async(t,e,o,r)=>{let a;try{a=await Sv(t,e)}catch(b){return{ok:!1,body:`fetchProposalDocument: ${b.message}`}}let s;try{s=await Wd(o)}catch(b){return{ok:!1,body:`fetchContactBasics: ${b.message}`}}let i=`${s.firstName} ${s.lastName}`.trim()||s.email||o,d={id:o,firstName:s.firstName,lastName:s.lastName,email:s.email,contactName:i,isPrimary:!0,hasCompleted:!1,imgUrl:"",entityName:"contacts",role:"signer"},m=[...(Array.isArray(a.recipients)?a.recipients:[]).filter(b=>b?.entityName!=="contacts"),d],u={name:r||a.name,locationId:a.locationId||t,pages:a.pages||[],variables:a.variables||[],fillableFields:a.fillableFields||[],timezone:a.timezone||{},recipients:m,grandTotal:a.grandTotal},_=await fetch(`${Dt}/proposals/document/${e}`,{method:"PUT",headers:{...Fe(),"Content-Type":"application/json"},body:JSON.stringify(u)});if(!_.ok){let b=await _.text().catch(()=>"");return{ok:!1,status:_.status,body:b}}return{ok:!0}},Iv=(t,e)=>{let o=`/v2/location/${t}/payments/proposals-estimates/edit/${e}`;window.location.href=o},Zr="__WS_CRM_PENDING_INSTRUCTIONS",Mv=60*1e3,Pv=[{matches:"2 signers",title:"Special Instructions for 2-Signer Agreement",bodyHtml:`
    ...
    `}],Ov=t=>{let e=(t||"").toLowerCase();for(let o of Pv)if(e.includes(o.matches.toLowerCase()))return o;return null},Bv=(t,e,o)=>{try{let r={proposalId:t,title:e,bodyHtml:o,ts:Date.now()};localStorage.setItem(Zr,JSON.stringify(r))}catch{}},Rv=()=>{try{let t=localStorage.getItem(Zr);if(!t)return null;let e=JSON.parse(t);return!e?.proposalId||!e?.title||!e?.bodyHtml||Date.now()-(e.ts||0)>Mv?(localStorage.removeItem(Zr),null):e}catch{return null}},Hv=()=>{try{localStorage.removeItem(Zr)}catch{}},Dv=(t,e)=>{document.getElementById(Mt)?.remove();let o=document.createElement("div");o.id=Mt,o.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.7);
  ...
  `,o.appendChild(r),document.body.appendChild(o),r.querySelector("#ws-pc-instructions-ack")?.addEventListener("click",()=>o.remove())},Fv=/\/v2\/location\/[^/]+\/payments\/proposals-estimates\/edit\/([a-zA-Z0-9]+)/,zv=()=>{let t=window.location.pathname.match(Fv);if(!t)return;let e=t[1],o=Rv();o&&o.proposalId===e&&(Hv(),window.setTimeout(()=>{Dv(o.title,o.bodyHtml)},600))},zd="ws-crm-prepare-contract-toast",nt=(t,e="info",o=4e3)=>{document.getElementById(zd)?.remove();let r=document.createElement("div");r.id=zd;let a=e==="error"?n.crimson:n.emerald;r.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
    z-index: 999999;
  ...
  `,r.textContent=t,document.body.appendChild(r),window.setTimeout(()=>r.remove(),o)},Nd=(t,e)=>new Promise(o=>{document.getElementById(Mt)?.remove();let r=document.createElement("div");r.id=Mt,r.style.cssText=`
      position: fixed;
      inset: 0;
      z-index: 999999;
      background: rgba(0, 0, 0, 0.6);
  ...
  `,o.innerHTML=`
    ...
    ">Loading templates\u2026</div>`,t.appendChild(o);let r=s=>{!o.contains(s.target)&&s.target!==t&&(o.remove(),document.removeEventListener("click",r,!0))};window.setTimeout(()=>document.addEventListener("click",r,!0),0);let a;try{a=await Ev(e.tenantId)}catch(s){o.innerHTML=`
    ...
    `;let d=s.type==="PA"?n.emerald:s.type==="AA"?n.blue:n.coolGray;i.innerHTML=`
      ...
      </div>`,i.addEventListener("mouseenter",()=>{i.style.background=n.slate}),i.addEventListener("mouseleave",()=>{i.style.background="transparent"}),i.addEventListener("click",async l=>{l.stopPropagation(),l.preventDefault(),p.info(`[prepare-contract] template picked: ${s.name} (type=${s.type})`),o.remove(),document.removeEventListener("click",r,!0);let c=H();try{if(s.type==="AA"){let m;if(e.oppId)m=e.oppId,p.info(`[prepare-contract] AA from MT opp page \u2014 using opp ${m} directly`);else{let y;try{y=await Tv(e.tenantId,e.contactId)}catch(f){nt(`Failed to load buyer's MT opps: ${f.message}`,"error",6e3),p.warn("[prepare-contract] AA fetch opps failed:",f);return}if(y.length===0){nt("No open MT deal found for this buyer. Create an MT opp first.","error",6e3);return}if(y.length===1)m=y[0].id,p.info(`[prepare-contract] auto-selected MT opp ${m} (only one)`);else{p.info(`[prepare-contract] showing MT opp picker (${y.length} opps)`);let f=await Nd(y,{perspective:"buyer",agreementLabel:"Assignment Agreement"});if(!f){p.info("[prepare-contract] MT opp picker cancelled");return}m=f,p.info(`[prepare-contract] picked MT opp ${m}`)}}let u=y=>{let f=y.getFullYear(),$=String(y.getMonth()+1).padStart(2,"0"),A=String(y.getDate()).padStart(2,"0");return`${f}-${$}-${A}`},_=y=>{let f=new Date;return f.setDate(f.getDate()+y),u(f)},b=_(45),g=_(7);nt("Reading contract data\u2026","info",2500);let x;try{x=await Xr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:m,closingDate:b,buyerEarnestDueDate:g,userId:c})}catch(y){nt(`Failed to prepare contract: ${y.message}`,"error",6e3),p.warn("[prepare-contract] AA stage failed:",y);return}let k=e.contactId||x.contact_id||"";if(!k){nt("Could not resolve buyer contact for this opp.","error",6e3);return}qv({tenantId:e.tenantId,contactId:k,template:s,oppId:m,staged:x,userId:c,defaultClosingDate:b,defaultEMDDueDate:g})}else if(s.type==="PA"){if(!e.contactId){nt("Purchase Agreements need to be started from the seller's contact page.","error",6e3);return}let m;try{m=await $v(e.tenantId,e.contactId)}catch(b){nt(`Failed to load ACQ opps: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA fetch opps failed:",b);return}if(m.length===0){nt("No open ACQ deal found for this contact. Create an ACQ opp first.","error",6e3);return}let u;if(m.length===1)u=m[0].id,p.info(`[prepare-contract] auto-selected ACQ opp ${u} (only one)`);else{p.info(`[prepare-contract] showing ACQ opp picker (${m.length} opps)`);let b=await Nd(m,{perspective:"seller",agreementLabel:"Purchase Agreement"});if(!b){p.info("[prepare-contract] ACQ opp picker cancelled");return}u=b,p.info(`[prepare-contract] picked ACQ opp ${u}`)}nt("Reading contract data\u2026","info",2500);let _;try{_=await Xr({tenantId:e.tenantId,contactId:e.contactId,template:s,oppId:u,userId:c})}catch(b){nt(`Failed to prepare contract: ${b.message}`,"error",6e3),p.warn("[prepare-contract] PA stage failed:",b);return}Nv({tenantId:e.tenantId,contactId:e.contactId,template:s,staged:_})}else{if(!e.contactId){nt("This template needs to be started from a contact page.","error",6e3);return}nt(`Opening ${s.name}\u2026`,"info",2500);try{await ms(e.tenantId,e.contactId,s)}catch(m){nt(`Failed to open contract: ${m.message}`,"error",6e3),p.warn("[prepare-contract] passthrough failed:",m)}}}catch(m){p.warn("[prepare-contract] picker click handler failed:",m),nt(`Unexpected error: ${m.message}`,"error",6e3)}}),o.appendChild(i)}},Gd=()=>{let t=document.createElement("button");return t.id=ls,t.type="button",t.style.cssText=`${R} position: relative; order: 5;`,t.innerHTML=`
    <span style="display:inline-flex;width:8px;height:8px;border-radius:50%;background:${n.emerald};flex-shrink:0;"></span>
    <span>Prepare Contract</span>
  `,t.addEventListener("mouseenter",()=>{t.style.borderColor=n.emerald}),t.addEventListener("mouseleave",()=>{t.style.borderColor=n.steel}),t.addEventListener("click",e=>{e.stopPropagation(),Uv(t)}),t},jv="ws-crm-contact-actions-bar",Wv=async()=>{let t=Ud();if(!t){document.getElementById(ls)?.remove();return}let e=null;try{e=await P(`#${jv}`,{timeoutMs:Xe+2e3})}catch{p.debug("[prepare-contract] actions bar not found within timeout");return}if(!e)return;let o=document.getElementById(ls);if(o){if(o.dataset.contactId===t.contactId)return;o.remove()}let r=Gd();r.dataset.contactId=t.contactId,r.dataset.tenantId=t.tenantId,e.appendChild(r),p.debug(`[prepare-contract] mounted for contact ${t.contactId}`)},he="ws-crm-prepare-contract-button-opp",zo=`${he}-wrap`,Gv=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,Kv=/\/v2\/location\/([A-Za-z0-9]+)/,Vv=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],cs=()=>{let t=window.location.pathname,e=t.match(Gv);if(!e)return null;let o=t.match(Kv);return o?{oppId:e[1],tenantId:o[1]}:null},Yv=async()=>{for(let t of Vv)try{let e=await P(t,{timeoutMs:2e3});if(e)return e}catch{}return null},Qr=!1,No=null,ps=null,ss=null,is,qo=()=>{No?.disconnect(),No=null,ps=null},Jv=t=>{if(No&&ps===t)return;qo();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(ps=t,No=new MutationObserver(()=>{let o=cs();if(!o||o.oppId!==t){qo();return}let r=z();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(he)?.remove(),document.getElementById(zo)?.remove(),qo();return}document.getElementById(he)||Kd()}),No.observe(e,{childList:!0,subtree:!0}))},Qv=()=>{ss||(ss=new MutationObserver(()=>{is===void 0&&(is=window.setTimeout(()=>{is=void 0;let t=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(he);t&&!e&&!Qr&&Kd()},300))}),ss.observe(document.body,{childList:!0,subtree:!0}))},Kd=async()=>{if(!Qr){Qr=!0;try{let t=cs();if(!t){document.getElementById(he)?.remove(),document.getElementById(zo)?.remove(),qo();return}let e=document.getElementById(he);if(e&&e.dataset.oppId===t.oppId){let d=z();d!==null&&d!=="Marketing Tracker"&&(e.remove(),document.getElementById(zo)?.remove(),qo());return}e&&(e.remove(),document.getElementById(zo)?.remove());let o=await Yv();if(!o){p.debug("[prepare-contract] opp mount target not found");return}let r=await et();if(r!=="Marketing Tracker"){p.debug(`[prepare-contract] opp mount gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let a=cs();if(!a||a.oppId!==t.oppId)return;let s=Gd();s.id=he,s.dataset.oppId=t.oppId,s.dataset.tenantId=t.tenantId;let i=document.createElement("span");i.id=zo,i.style.cssText=`
      display: inline-flex;
      align-items: center;
      flex-shrink: 0;
      vertical-align: middle;
      margin-left: 12px;
    `,o.classList.contains("description")&&(o.style.display="flex",o.style.alignItems="center",o.style.gap="16px",o.style.flexWrap="wrap"),i.appendChild(s),o.appendChild(i),p.debug(`[prepare-contract] mounted on MT opp ${t.oppId} (contactId deferred to click)`),Jv(t.oppId)}finally{Qr=!1}}},Vd=()=>{zv(),Wv()};gv();function bt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function It(t){return bt(t)}var Zv="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/acq/compute-offer",ue="ws-crm-compute-offer-button",us="ws-crm-compute-offer-popover",oc="ws-crm-offer-modal",Yd="ws-crm-contact-actions-bar",Xv=[".central-panel","[class*='central-panel']"],te=t=>typeof t=="number"?`$${Math.round(t).toLocaleString("en-US")}`:"-",bs=t=>{if(typeof t!="number"||Math.round(t)===0)return"$0";let e=`$${Math.abs(Math.round(t)).toLocaleString("en-US")}`;return t<0?`\u2212${e}`:`+${e}`},ty=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Jd=t=>{if(!t)return"";let e=String(t).split("-");return e.length!==3?String(t):`${ty[Number(e[1])-1]||""} ${Number(e[2])}`.trim()},q=(t,e,o)=>{let r=document.createElement(t);return e&&(r.style.cssText=e),o!=null&&(r.textContent=o),r},Qd=()=>`width:100%;box-sizing:border-box;padding:7px 9px;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;outline:none;`,hs=async t=>{let e={tenant_id:t.tenantId,mode:t.mode};t.propertyRecordId?e.property_record_id=t.propertyRecordId:t.contactId&&(e.contact_id=t.contactId),t.mode!=="get"&&(t.propertyCondition!=null&&(e.property_condition=t.propertyCondition),t.repairOverride!==void 0&&(e.repair_override=t.repairOverride));let o=await fetch(Zv,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()},ze=()=>{document.getElementById(us)?.remove(),document.removeEventListener("mousedown",rc,!0)};function rc(t){let e=document.getElementById(us),o=document.getElementById(ue),r=t.target;e&&!e.contains(r)&&o&&!o.contains(r)&&ze()}var nc=(t,e)=>{ze();let o=t.getBoundingClientRect(),r=document.createElement("div");r.id=us;let a=Math.max(8,Math.min(o.left,window.innerWidth-348));r.style.cssText=`position:fixed;top:${o.bottom+6}px;left:${a}px;z-index:1000002;min-width:240px;max-width:340px;padding:11px 13px;border-radius:${v.md};background:${n.graphite};border:1px solid ${n.steel};box-shadow:0 14px 36px rgba(0,0,0,0.55);font-family:${h.sans};color:${n.bone};font-size:13px;line-height:1.35;`,e(r),document.body.appendChild(r),setTimeout(()=>document.addEventListener("mousedown",rc,!0),0)},tn=(t,e)=>{nc(t,o=>{o.style.borderColor="rgba(212,63,74,0.55)",o.appendChild(q("div",`font-weight:600;margin-bottom:5px;color:${n.crimson};`,"Couldn't open worksheet")),o.appendChild(q("div",`color:${n.bone};font-size:12px;`,e))})},ey=(t,e,o)=>{nc(t,r=>{r.appendChild(q("div",`font-weight:600;margin-bottom:7px;color:${n.bone};font-size:12px;`,"This seller has multiple properties. Which one?")),e.forEach(a=>{let s=q("button",`display:block;width:100%;text-align:left;padding:8px 10px;margin:4px 0;background:${n.slate};color:${n.bone};border:1px solid ${n.steel};border-radius:${v.sm};font-family:${h.sans};font-size:12px;cursor:pointer;transition:border-color 0.12s ease;`,a.address||a.property_record_id);s.type="button",s.addEventListener("mouseenter",()=>s.style.borderColor=n.blue),s.addEventListener("mouseleave",()=>s.style.borderColor=n.steel),s.addEventListener("click",()=>{ze(),o(a.property_record_id)}),r.appendChild(s)})})},on=()=>{document.getElementById(oc)?.remove(),document.removeEventListener("keydown",ac,!0)};function ac(t){t.key==="Escape"&&on()}var Zd=(t,e,o)=>{on(),ze();let r=o,a=!1,s="",i=document.createElement("div");i.id=oc,i.style.cssText=`position:fixed;inset:0;z-index:1000003;display:flex;align-items:flex-start;justify-content:center;padding-top:8vh;background:rgba(8,10,14,0.62);backdrop-filter:blur(2px);font-family:${h.sans};`,i.addEventListener("mousedown",m=>{m.target===i&&on()});let d=q("div",`width:460px;max-width:calc(100vw - 32px);max-height:84vh;overflow:auto;background:${n.graphite};border:1px solid ${n.steel};border-radius:${v.md};box-shadow:0 24px 64px rgba(0,0,0,0.6);color:${n.bone};`);i.appendChild(d);let l=(m,u,_)=>{a||(a=!0,s="",c(),hs({tenantId:t,propertyRecordId:e,mode:m,propertyCondition:u,repairOverride:_}).then(b=>{b&&b.ok?r={...b,current_offer:b.current_offer??r.current_offer,current_offer_date:b.current_offer_date??r.current_offer_date}:s=b&&b.error||"Request failed."}).catch(b=>{p.error("[compute-offer] worksheet request failed:",b),s="Request failed. Try again."}).finally(()=>{a=!1,c()}))};function c(){let m=r,u=!!m.has_comps;d.innerHTML="";let _=q("div",`display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:16px 18px 12px;border-bottom:1px solid ${n.steel};`),b=q("div","");b.appendChild(q("div",`font-weight:700;font-size:15px;color:${n.bone};`,"Offer Worksheet")),b.appendChild(q("div",`font-size:12px;color:${n.ash};margin-top:2px;`,m.address||"-"));let g=q("button",`background:transparent;border:none;color:${n.ash};font-size:22px;line-height:1;cursor:pointer;padding:0 2px;`,"\xD7");g.type="button",g.addEventListener("click",on),_.append(b,g),d.appendChild(_);let x=q("div","padding:14px 18px 18px;");d.appendChild(x);let k=q("select",Qd());(m.rehab_levels||[]).forEach(U=>{let W=document.createElement("option");W.value=U.key,W.textContent=U.label,U.key===(m.tier||m.property_condition)&&(W.selected=!0),k.appendChild(W)}),k.disabled=a,k.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let y=q("input",Qd());y.type="number",y.placeholder="uses the level",y.value=m.repair_override!=null?String(m.repair_override):"",y.disabled=a,y.addEventListener("keydown",U=>{U.key==="Enter"&&y.blur()}),y.addEventListener("change",()=>l("recompute",k.value,y.value.trim()));let f=q("div","display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;");f.appendChild(q("div",`font-size:12px;color:${u?n.bone:n.amber};`,u?`Investor comps: $${m.comp_price_per_sqft}/sqft \xB7 ${m.comp_count} comps${m.comp_pull_at?` \xB7 pulled ${Jd(m.comp_pull_at)}`:""}`:"No comps pulled yet."));let $=q("button",`flex-shrink:0;padding:6px 12px;border-radius:${v.sm};border:1px solid ${n.blue};background:${u?"transparent":n.blue};color:${u?n.blue:"#fff"};font-family:${h.sans};font-size:12px;font-weight:600;cursor:${a?"default":"pointer"};`,a?"Working\u2026":u?"Re-pull Comps":"Pull Comps");$.type="button",$.disabled=a,$.addEventListener("click",()=>l("pull",k.value,y.value.trim())),f.append($),x.appendChild(f),m.low_confidence&&u&&x.appendChild(q("div",`font-size:11px;color:${n.amber};margin:-6px 0 10px;`,`\u26A0 Low confidence: only ${m.comp_count??0} comps in window.`));let A=m.current_offer!=null;x.appendChild(q("div",`font-size:12px;margin:0 0 12px;padding:7px 10px;border-radius:${v.sm};background:${n.slate};border:1px solid ${n.steel};color:${A?n.bone:n.ash};`,A?`Last offer made: ${te(m.current_offer)}${m.current_offer_date?` \xB7 ${Jd(m.current_offer_date)}`:""}`:"No offer made yet."));let T=q("div","display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"),w=q("div","");w.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Rehab Level")),w.appendChild(k);let E=q("div","");E.appendChild(q("label",`display:block;font-size:11px;color:${n.ash};margin-bottom:4px;`,"Repair Override ($)")),E.appendChild(y),T.append(w,E),x.appendChild(T);let S=q("div",`border-top:1px solid ${n.steel};padding-top:12px;`),B=(U,W,N)=>{let zt=q("div",`display:flex;align-items:baseline;justify-content:space-between;gap:14px;padding:4px 0;${N?.strong?"font-weight:700;":""}`),Nt=q("div","");Nt.appendChild(q("div",`font-size:${N?.strong?"13":"12"}px;color:${n.bone};`,U)),N?.sub&&Nt.appendChild(q("div",`font-size:10px;color:${n.ash};font-weight:400;margin-top:1px;`,N.sub));let pt=q("div",`font-size:${N?.strong?"15":"12"}px;color:${N?.color||n.bone};white-space:nowrap;`,W);zt.append(Nt,pt),S.appendChild(zt)};if(u&&m.imv!=null){B("Investor Market Value (IMV)",te(m.imv)),m.arv!=null&&B("After Repair Value (ARV)",te(m.arv),{color:n.ash});let U=m.repair_adjustment??0,W=-U,N=m.repair_override?"Repair override":m.property_condition_label||"Repairs";U===0?B(`Repairs (${N})`,"Included",{color:n.ash,sub:`${te(m.repair_total)} in repairs included at IMV`}):B(`Repairs (${N})`,bs(W),{color:W<0?n.crimson:n.emerald,sub:`${te(m.repair_total)} total, ${te(m.baseline_repairs)} included at IMV`}),B("Min. Profit Target",bs(-(m.profit_target??0)),{color:n.ash}),B("Maximum Cash Offer (MAO)",te(m.mao),{strong:!0,color:n.blue}),B("Target Profit",bs(-(m.ico_delta??0)),{color:n.ash}),B("Initial Cash Offer (ICO)",te(m.ico),{strong:!0,color:n.blue})}else S.appendChild(q("div",`font-size:12px;color:${n.ash};padding:6px 0;line-height:1.45;`,"Pull comps to compute the offer. You can set the rehab level and override first."));x.appendChild(S);let j=q("div",`margin-top:12px;font-size:11px;min-height:14px;color:${s?n.crimson:n.ash};`);j.textContent=a?"Saving\u2026":s||(u?"Saved to the Property.":""),x.appendChild(j)}c(),document.body.appendChild(i),document.addEventListener("keydown",ac,!0)},Xd=(t,e)=>{let o=document.createElement("button");o.type="button",o.id=ue,o.dataset.contactId=t,o.style.cssText=`
  ...
  `,o.addEventListener("mouseenter",()=>{o.disabled||(o.style.borderColor=n.blue)}),o.addEventListener("mouseleave",()=>{o.style.borderColor=n.steel});let r=()=>o.querySelector(".ws-co-label"),a=i=>{o.disabled=i,o.style.cursor=i?"default":"pointer";let d=r();d&&(d.textContent=i?"Opening\u2026":"Offer Worksheet")},s=i=>{if(i.needs_property_selection&&i.properties&&i.properties.length){ey(o,i.properties,d=>{a(!0),hs({tenantId:e,propertyRecordId:d,mode:"get"}).then(l=>{l.ok&&l.property_record_id?Zd(e,l.property_record_id,l):tn(o,l.error||"Couldn't load that property.")}).catch(l=>{p.error("[compute-offer] get failed:",l),tn(o,"Request failed. Try again.")}).finally(()=>a(!1))});return}i.ok&&i.property_record_id?Zd(e,i.property_record_id,i):tn(o,i.error||"No property linked to this contact.")};return o.addEventListener("click",async()=>{if(!o.disabled){a(!0);try{s(await hs({tenantId:e,contactId:t,mode:"get"}))}catch(i){p.error("[compute-offer] webhook failed:",i),tn(o,"Request failed. Try again.")}finally{a(!1)}}}),o},oy=async()=>{for(let t of Xv)try{let e=await P(t,{timeoutMs:3e3});if(e)return e}catch{}return null},tc=async(t,e)=>{let o=e.querySelector(`#${Yd}`);if(!o)try{o=await P(`#${Yd}`,{timeoutMs:3e3,root:e})}catch{o=null}return o?(t.style.order="3",o.appendChild(t),!0):!1},ec=()=>{let t=document.querySelectorAll(`#${ue}`);for(let e=1;e<t.length;e++)t[e].remove()},ry=async()=>{let t=D();if(!t||!t.locationId||t.source!=="url"){document.getElementById(ue)?.remove(),ze();return}let e=t.locationId,o=document.getElementById(ue);if(o&&o.dataset.contactId===t.contactId)return;o&&o.remove(),ze();let r="seller";try{r=Tt(await $t(t.contactId,e))}catch(d){p.warn("[compute-offer] contact-type fetch threw - defaulting seller:",d)}if(r!=="seller"){p.debug(`[compute-offer] gated off - kind=${r}`),document.getElementById(ue)?.remove();return}let a=await oy();if(!a){p.warn("[compute-offer] no central panel found");return}let s=D();if(!s||s.contactId!==t.contactId)return;let i=Xd(t.contactId,e);if(!await tc(i,a)){p.warn("[compute-offer] actions bar not found after waiting");return}ec(),p.debug(`[compute-offer] mounted for ${t.contactId}`),en?.disconnect(),en=new MutationObserver(()=>{if(D()?.contactId!==t.contactId){en?.disconnect();return}if(!document.getElementById(ue)){let d=Xd(t.contactId,e);tc(d,a).then(()=>ec())}}),en.observe(a,{childList:!0})},en=null,jo=null,sc=()=>{let t=D()?.contactId??null;if(jo&&jo.id===t)return;let e=ry().finally(()=>{jo?.promise===e&&(jo=null)});jo={id:t,promise:e}};var dn="reos-theme-stylesheet",Tc="reos-theme-fonts",je=!1,ny=()=>{let t=document.getElementById(Tc);t&&t.remove()},ay=`
...
Click to dismiss for this session`,t.addEventListener("mouseenter",()=>{t.style.transform="scale(1.05)"}),t.addEventListener("mouseleave",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)}),document.body.appendChild(t)};var ws="https://services.leadconnectorhq.com",Ac="__WS_CRM_CAPTURED_AUTH";var By=()=>{try{let t=localStorage.getItem(Ac);if(!t)return null;let e=JSON.parse(t);return e?.authorization?Date.now()-(e.capturedAt||0)>3e6?(localStorage.removeItem(Ac),null):e:null}catch{return null}},Ry=()=>{let t=By();if(!t)return null;let e={Authorization:t.authorization,Version:"2021-07-28",Channel:"APP",Source:"WEB_USER"};return t.tokenId&&(e["token-id"]=t.tokenId),e},ks=async(t,e={})=>{let o=Ry();if(!o)return null;try{return await fetch(t,{...e,headers:{...o,...e.headers??{}}})}catch{return null}};var Bc=new Set(["ej0SqnTYIprechAMAPrd"]),We="contact-select-trigger",Rc="ws-crm-reply-from-warning",Hc="contact-select-menu",Sc="ws-crm-rf-thread-opt",Es="",$s=!1,Ko=null,mn=null,Lc=!1,Vo="",Ic,ee=(...t)=>{try{console.log("[reply-from]",...t)}catch{}},Ts=t=>{let e=(t?.textContent||"").match(/\+?1?\d{10}\b/);return e?e[0]:""},Pt=t=>(t||"").replace(/\D/g,"").slice(-10),Mc=t=>{let e=Pt(t);return e.length===10?`+1 ${e.slice(0,3)}-${e.slice(3,6)}-${e.slice(6)}`:t},Hy=t=>{let e=t.meta||{};return(t.direction||"").toLowerCase()==="inbound"?e.to||"":e.from||""},Dy=async()=>{let t=window.location.pathname,e=t.match(/\/contacts\/detail\/([A-Za-z0-9]{15,})/);if(e){let r=K();if(!r)return null;let a=await ks(`${ws}/conversations/search?locationId=${encodeURIComponent(r)}&contactId=${encodeURIComponent(e[1])}`);if(!a||!a.ok)return ee("getConversationId: search miss",a?a.status:"null"),null;try{return(await a.json())?.conversations?.[0]?.id||null}catch{return null}}let o=t.split("/").filter(Boolean).pop()||"";return/^[A-Za-z0-9]{15,}$/.test(o)?o:null},Fy=async()=>{let t=await Dy();if(!t)return null;let e=await ks(`${ws}/conversations/${t}/messages?limit=20`);if(!e||!e.ok)return ee("getThreadNumber: fetch miss",e?e.status:"null"),null;let o;try{o=await e.json()}catch{return null}let r=o?.messages?.messages||[];for(let a of r){if(a.type!==2&&a.messageType!=="TYPE_SMS")continue;let s=Hy(a);if(Pt(s).length===10)return s}return null},Ge=()=>document.getElementById(Rc)?.remove(),Dc=t=>{let e=t;for(let o=0;o<8&&e;o++){if(e.querySelector("#conv-composer-textarea-input, textarea[placeholder]"))return e;e=e.parentElement}return null},zy=t=>t.replace(/[&<>"]/g,e=>e==="&"?"&amp;":e==="<"?"&lt;":e===">"?"&gt;":"&quot;"),Fc=(t,e,o)=>{Ge();let r=document.getElementById(We);if(!r)return;let a=Dc(r);if(!a||!a.parentElement)return;let s=document.createElement("div");s.id=Rc,s.style.cssText="display:flex;align-items:flex-start;gap:9px;padding:10px 12px;margin:0 0 6px;background:rgba(232,163,60,0.14);border-left:3px solid var(--reos-amber,#E8A33C);border-radius:0;font-size:12.5px;line-height:1.5;color:var(--reos-bone,#EDEEF0);font-family:inherit;";let i=e?` (${zy(e)})`:"";s.innerHTML=`<span style="color:var(--reos-amber,#E8A33C)!important;font-size:16px;line-height:1;margin-top:1px;flex-shrink:0;" aria-hidden="true">&#9888;</span><div>This thread is on <span style="color:var(--reos-amber,#E8A33C)!important;font-weight:500;">${Mc(t)}</span>${i}. You're set to reply from ${Mc(o)}. <span style="color:var(--reos-amber,#E8A33C)!important;">Switch the From before sending.</span></div>`,a.parentElement.insertBefore(s,a)},Ny=t=>{Ko?.disconnect();let e=document.getElementById(We);if(!e)return;let o=Dc(e)||e,r=Pt(Ts(e));Ko=new MutationObserver(()=>{let a=Ts(document.getElementById(We)),s=Pt(a);!s||s===r||(r=s,s===Pt(t)?Ge():Fc(t,"",a))}),Ko.observe(o,{childList:!0,subtree:!0,characterData:!0})},Pc=()=>{let t=document.getElementById(Hc);if(!t)return;let e=Array.from(t.children).filter(d=>d.id!=="hr-dropdown-option-__search__"),o=d=>{let l=(d.textContent||"").match(/\+?1?\d{10}/);return l?l[0]:""},r=null,a="";if(Vo&&(r=e.find(d=>Pt(o(d))===Pt(Vo))||null,a="thread line"),r||(r=e.find(d=>/Last Used/i.test(d.textContent||""))||null,a="last used"),ee("decorateMenu: cache=",Vo,"target=",r?a:"NONE"),!r)return;let s=document.getElementById(Sc);s&&s!==r&&s.removeAttribute("id"),r.id=Sc;let i=d=>{d.style.setProperty("color","var(--reos-emerald,#0FB57E)","important"),d.style.setProperty("-webkit-text-fill-color","var(--reos-emerald,#0FB57E)","important")};i(r),r.querySelectorAll("*").forEach(d=>{i(d),d.style.setProperty("background-color","transparent","important")})},qy=()=>{if(!Bc.has(K()||""))return;mn?.disconnect();let t=0,e=()=>{let o=document.getElementById(Hc);if(o){Pc(),mn=new MutationObserver(()=>Pc()),mn.observe(o,{childList:!0,subtree:!0});return}++t<20&&window.setTimeout(e,50)};e()},Uy=t=>{let e=t.target;e&&e.closest&&e.closest("#"+We)&&(ee("From trigger clicked -> waiting for menu"),qy())},jy=async()=>{if(!$s){$s=!0;try{let t=document.getElementById(We);if(!t)return;let e=Ts(t),o=await Fy();if(Vo=o||"",ee("check: from=",e,"thread=",o),!o){Ge();return}Pt(e)&&Pt(e)!==Pt(o)?(ee("MISMATCH -> banner"),Fc(o,"",e)):(ee("match -> no banner"),Ge()),Ny(o)}finally{$s=!1}}},Oc=()=>{if(!Bc.has(K()||""))return;let t=window.location.pathname;if(!t.includes("/conversations")&&!t.includes("/contacts/detail/")){Es="",Vo="",Ko?.disconnect(),mn?.disconnect(),Ge();return}let e=!!document.getElementById(We),o=t.split("/").filter(Boolean).pop()||"",r=(e?"T":"F")+"|"+o;if(r!==Es){if(Es=r,!e){Ko?.disconnect(),Ge();return}ee("composer expanded on",o),jy()}},zc=()=>{Ic===void 0&&(Ic=window.setInterval(Oc,500)),Lc||(document.addEventListener("click",Uy,!0),Lc=!0),Oc()};var Wy="#1A1F28",Gy="#EDEEF0",Cs="#9098A3",Ky=t=>{let e=(t||"").match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?{r:+e[1],g:+e[2],b:+e[3]}:null},Vy=t=>.2126*t.r+.7152*t.g+.0722*t.b,Yy=t=>{let e=t.r/255,o=t.g/255,r=t.b/255,a=Math.max(e,o,r),s=Math.min(e,o,r),i=(a+s)/2,d=a-s,l=0,c=0;return d!==0&&(c=d/(1-Math.abs(2*i-1)),a===e?l=(o-r)/d%6:a===o?l=(r-e)/d+2:l=(e-o)/d+4,l=l*60,l<0&&(l+=360)),`hsl(${Math.round(l)}, ${Math.round(Math.max(.62,c)*100)}%, 60%)`},Nc=(t,e,o)=>{t.querySelectorAll(e).forEach(r=>{r.style.setProperty("color",o,"important"),r.style.setProperty("-webkit-text-fill-color",o,"important")})},Jy=t=>{let e=Ky(getComputedStyle(t).backgroundColor);if(!e||Vy(e)<120)return;let o=Yy(e);t.style.setProperty("background-color",Wy,"important"),t.style.setProperty("box-shadow",`inset 3px 0 0 0 ${o}`,"important"),Nc(t,".note-content, .note-content *, [class*='text-gray-9'], [class*='text-gray-7']",Gy),Nc(t,"#note-date-added-text, [class*='475467']",Cs)},Qy=t=>{t.querySelectorAll("[class*='hr-tag__count']").forEach(e=>{e.style.setProperty("background-color","transparent","important")}),t.querySelectorAll(".hr-tag, .hr-tag *").forEach(e=>{e.style.setProperty("color",Cs,"important"),e.style.setProperty("-webkit-text-fill-color",Cs,"important")}),t.querySelectorAll("button.hr-button, .hr-button__border, .hr-button__state-border").forEach(e=>{e.style.setProperty("border","none","important"),e.style.setProperty("box-shadow","none","important")})},qc=()=>{let t=document.querySelectorAll(".note-card-accent");for(let e=0;e<t.length;e++)Jy(t[e]),Qy(t[e])},Uc,jc=()=>{Uc===void 0&&(Uc=window.setInterval(qc,700)),qc()};var Zy='input:not([autocomplete]):not([type="password"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]):not([type="file"]):not([type="submit"]):not([type="button"]):not([type="range"]):not([type="color"]),textarea:not([autocomplete])',Wc=()=>{document.querySelectorAll(Zy).forEach(t=>{t.setAttribute("autocomplete","off")})},Gc,Kc=()=>{Gc===void 0&&(Gc=window.setInterval(Wc,1e3)),Wc()};console.log("[ws-crm-customizer] bundle-loaded");var C=(t,e)=>{try{p.debug(`[main] calling ${t}`),e(),p.debug(`[main] ${t} OK`)}catch(o){p.error(`[main:FAIL] ${t} threw:`,o)}},Vc=()=>{p.info(`Loaded v${Zo} (built ${Xo})`),_n()?(p.info(`[main] excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Go),C("mountDialerThemeFix",Ur)):(C("mountVersionBadge (initial)",pn),C("mountFavicon",Li),C("mountThemeStylesheet",Go),C("mountHideLaunchpad",pa),C("mountHideNavItems",ma),C("mountRelabelNav",ba),C("mountHideTopmenuTabs",ua),C("mountContractsSection",ha)),C("installOppIdCapture",Bs),C("initPageRouter",Is),p.info("[main] registering onPageChange subscriber"),_t(e=>{if(p.debug(`[main] onPageChange callback fired for page=${e}`),_n()){p.info(`[main] page change into excluded location ${K()} \u2014 theme only, skipping feature mounts`),C("mountThemeStylesheet",Go),C("runThemeFastPass",xs),C("mountDialerThemeFix",Ur),C("unmountContactMapLinks",tl);return}C("mountThemeStylesheet",Go),C("runThemeFastPass",xs),C("mountVersionBadge",pn),C("mountHideLaunchpad",pa),C("mountHideNavItems",ma),C("mountRelabelNav",ba),C("mountHideTopmenuTabs",ua),C("mountContractsSection",ha),C("mountAnalyticsDashboard",Vs),C("mountClaimReleaseToggle",_i),C("mountContactActionsBar",Ai),C("mountActiveFollowUpButton",qs),C("mountMtOfferMadeButton",Oi),C("mountNotInterestedButton",Bi),C("mountScheduleWalkthroughButton",Ri),C("mountResendDealLinkButton",Di),C("mountReducePriceButton",zi),C("mountEditLandingPageButton",Ni),C("mountPublishButton",Wi),C("mountContactMapLinks",Xi),C("mountSendToClosingOfficeButton",hl),C("mountOppActionBar",Ll),C("mountClosingAgentPickerButton",Sd),C("mountPrepareContractButton",Vd),C("mountComputeOfferButton",sc),C("mountManageTeam",Od),C("mountBuyBoxWidget",ti),C("mountSellerContactFlag",mi),C("mountPropertiesWidget",ci),C("mountSupportNavItem",Dl),C("mountPhoneAssignmentsWidget",jl),C("mountBulkPowerDialer",cd),C("mountBulkPowerDialerContacts",bd),C("mountCallingAsChip",vd),C("mountDialerThemeFix",Ur),C("mountReplyFromWarning",zc),C("mountNoteCanon",jc),C("mountSuppressAutofill",Kc)}),p.info("[main] onPageChange registered; main() complete")};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Vc):Vc();})();
