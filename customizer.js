/* Wholesaling CRM Customizer v0.13.67 — built 2026-05-27T15:58:59.675Z */
"use strict";var WholesalingCRMCustomizer=(()=>{var se="[wholesaling-crm-customizer]",oo="__WS_CRM_DEBUG",ro=()=>!!window[oo],b={info(...o){console.log(se,...o)},warn(...o){console.warn(se,...o)},error(...o){console.error(se,...o)},debug(...o){ro()&&console.log(se,"[debug]",...o)}};var tt=/(?:\/contacts\/detail\/|\/contacts\/|\/objects\/contact\/detail\/|\/objects\/contact\/)([A-Za-z0-9]{16,})(?:[/?#]|$)/,De=/\/v2\/location\/([A-Za-z0-9]+)/,no=o=>{let e=o.match(tt);if(!e)return null;let t=o.match(De);return{contactId:e[1],locationId:t?t[1]:null,source:"url"}},ao=()=>{let o=["#contact-conversation-panel a[href*='/contacts/detail/']",".central-panel a[href*='/contacts/detail/']"];for(let e of o){let t=document.querySelector(e);if(!t)continue;let r=t.getAttribute("href")||t.href||"",n=r.match(tt);if(!n)continue;let a=r.match(De)||window.location.pathname.match(De);return{contactId:n[1],locationId:a?a[1]:null,source:"dom"}}return null},S=()=>{let o=no(window.location.pathname);return o||ao()};var ot=()=>{let o=window.location.pathname;return o.includes("/contacts/detail/")?"contact-detail":o.includes("/contacts/smart-list")||o.includes("/contacts/")?"contact-list":o.includes("/opportunities/detail/")?"opportunity-detail":o.includes("/opportunities/")?"opportunity-list":o.includes("/calendars/")?"calendar":o.includes("/dashboard")?"dashboard":o.includes("/conversations")?"conversations":o.includes("/settings")?"settings":"other"},le="",Me=null,U="other",He=new Set,ie=()=>{let o=S()?.contactId??null;if(!(!(window.location.pathname!==le)&&!(o!==Me))){le=window.location.pathname,Me=o,U=ot(),b.debug("Page/context changed:",U,le,"contact:",o);for(let r of He)try{r(U)}catch(n){b.error("Subscriber threw:",n)}}},rt=o=>(He.add(o),setTimeout(()=>o(U),0),()=>{He.delete(o)}),nt=()=>{U=ot(),le=window.location.pathname,Me=S()?.contactId??null,b.debug("Router init, current page:",U);let o=history.pushState.bind(history),e=history.replaceState.bind(history);history.pushState=function(t,r,n){o(t,r,n),ie()},history.replaceState=function(t,r,n){e(t,r,n),ie()},window.addEventListener("popstate",ie),setInterval(ie,1e3)};var de="0.13.67",ce="2026-05-27T15:58:59.676Z";var C=(o,e={})=>{let{timeoutMs:t=8e3,pollMs:r=100,root:n=document}=e;return new Promise((a,s)=>{let i=n.querySelector(o);if(i){a(i);return}let d,c,h=()=>{m&&m.disconnect(),d!==void 0&&window.clearTimeout(d),c!==void 0&&window.clearInterval(c)},m=new MutationObserver(()=>{let p=n.querySelector(o);p&&(h(),a(p))});m.observe(document.body,{childList:!0,subtree:!0}),c=window.setInterval(()=>{let p=n.querySelector(o);p&&(h(),a(p))},r),d=window.setTimeout(()=>{h(),b.warn(`waitForElement timed out for selector: ${o}`),s(new Error(`Selector not found within ${t}ms: ${o}`))},t)})};var l={obsidian:"#0A0D12",graphite:"#12161D",slate:"#1A1F28",steel:"#252C36",bone:"#EDEEF0",ash:"#9098A3",coolGray:"#5A6470",emerald:"#0FB57E",emeraldBright:"#14C98B",blue:"#4B8BF5",amber:"#E8A33C",crimson:"#D43F4A",emeraldGlow:"rgba(15, 181, 126, 0.12)",emeraldBorder:"rgba(15, 181, 126, 0.3)",blueGlow:"rgba(75, 139, 245, 0.12)",amberGlow:"rgba(232, 163, 60, 0.12)",crimsonGlow:"rgba(212, 63, 74, 0.12)"},E={sm:"4px",md:"6px",lg:"10px",pill:"999px"},f={sans:"'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",mono:"'Geist Mono', ui-monospace, SFMono-Regular, Menlo, monospace"},Pe={purple:"#8B5CF6",green:l.emerald,orange:l.amber,red:l.crimson},at=o=>{let e=o==="emerald"?l.emeraldGlow:o==="amber"?l.amberGlow:l.slate,t=o==="emerald"?l.emeraldBorder:o==="amber"?"rgba(232, 163, 60, 0.3)":l.steel,r=o==="emerald"?l.emerald:o==="amber"?l.amber:l.bone;return`
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`;var so=/^[A-Za-z0-9]{15,30}$/,j=o=>typeof o=="string"&&so.test(o),io=o=>{try{let e=o.split(".");if(e.length!==3)return null;let t=e[1].replace(/-/g,"+").replace(/_/g,"/"),r=t+"=".repeat((4-t.length%4)%4);return JSON.parse(atob(r))}catch{return null}},lo=()=>{let o=window.WS_CRM_USER_ID;return j(o)?o:null},co=()=>{let o=window,e=[o.appState?.user?.id,o.user?.id,o.currentUser?.id,o.LCUser?.id,o.HL?.user?.id];for(let t of e)if(j(t))return t;return null},bo=()=>{try{let o=localStorage.getItem("refreshedToken");if(!o)return null;let e=o.startsWith('"')?o.slice(1,-1):o,t=io(e);if(!t)return null;let r=t.uid;if(j(r))return r;let n=t.claims;if(n&&j(n.user_id))return n.user_id}catch{}return null},ho=()=>{try{let o=["user","tokenUser","currentUser","ghl_user"];for(let e of o){let t=localStorage.getItem(e);if(t)try{let r=JSON.parse(t),n=r.id??r._id;if(j(n))return n}catch{}}}catch{}return null},A=()=>lo()||co()||bo()||ho()||null;var dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/contact",po=`${dt}/active-follow-up-get`,mo=`${dt}/active-follow-up-set`,G="ws-crm-active-follow-up-button",Oe={amber:{label:"Add to Active Follow Up",bg:l.amberGlow,border:"rgba(232, 163, 60, 0.45)",color:l.amber,clickable:!0,dotColor:l.amber},blue:{label:"In Active Follow Up",bg:l.blueGlow,border:"rgba(75, 139, 245, 0.45)",color:l.blue,clickable:!1,dotColor:l.blue},gray:{label:"Not in Follow Up",bg:l.slate,border:l.steel,color:l.coolGray,clickable:!1,dotColor:l.coolGray},loading:{label:"Active Follow Up\u2026",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.ash},error:{label:"Follow Up status unavailable",bg:l.slate,border:l.steel,color:l.ash,clickable:!1,dotColor:l.crimson}},_o=()=>{let o=S();return!o||!o.locationId?null:{contactId:o.contactId,tenantId:o.locationId}},uo=async o=>{let e=await fetch(po,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId}),credentials:"omit"});if(!e.ok)throw new Error(`Get webhook returned ${e.status} ${e.statusText}`);return await e.json()},vo=async(o,e)=>{let t=await fetch(mo,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.tenantId,contact_id:o.contactId,triggered_by_user_id:e??null}),credentials:"omit"});if(!t.ok)throw new Error(`Set webhook returned ${t.status} ${t.statusText}`);return await t.json()},$=(o,e)=>{let t=Oe[e];o.dataset.state=e,o.disabled=!t.clickable,o.style.cursor=t.clickable?"pointer":"default",o.style.background=t.bg,o.style.borderColor=t.border,o.style.color=t.color;let r=o.querySelector(".ws-afu-dot");r&&(r.style.background=t.dotColor);let n=o.querySelector(".ws-afu-label");n&&(n.textContent=t.label)},st=o=>{let e=document.createElement("button");return e.type="button",e.id=G,e.dataset.contactId=o,e.style.cssText=`
  ...
  `,$(e,"loading"),e.addEventListener("click",async()=>{if(e.dataset.state!=="amber")return;let r=_o();if(!(!r||r.contactId!==o)){$(e,"blue"),e.style.transform="scale(0.97)",setTimeout(()=>e.style.transform="",120);try{let n=await vo(r,A()),a=n&&n.state&&n.state in Oe?n.state:"blue";$(e,a),b.info(`Active Follow Up set for ${o} \u2192 ${a}`)}catch(n){b.error("Active Follow Up Set webhook failed",n),$(e,"error"),setTimeout(()=>void be(e,r),4e3)}}}),e},be=async(o,e)=>{$(o,"loading");try{let t=await uo(e),r=t&&t.state&&t.state in Oe?t.state:"gray",n=document.getElementById(G);if(!n||n.dataset.contactId!==e.contactId)return;$(n,r)}catch(t){b.warn("Active Follow Up Get webhook failed",t),$(o,"error")}},yo=[".central-panel","[class*='central-panel']"],Ne="ws-crm-contact-actions-bar",go=async()=>{for(let o of yo)try{let e=await C(o,{timeoutMs:3e3});if(e)return e}catch{}try{return(await C("#contact-conversation-panel",{timeoutMs:3e3})).parentElement??null}catch{return null}},fo=async(o,e)=>{let t=e.querySelector(`#${Ne}`);if(!t)try{t=await C(`#${Ne}`,{timeoutMs:3e3,root:e})}catch{t=null}if(t){let a=e.querySelector("#ws-crm-afu-wrap");return a&&a.remove(),t.appendChild(o),{container:t,placement:"actions-bar"}}let r="ws-crm-afu-wrap",n=e.querySelector(`#${r}`);if(!n){n=document.createElement("div"),n.id=r,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 8px;
      padding: 6px 12px;
  ...
  `,e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-1px)"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"}),e.addEventListener("click",async()=>{let t=ue();if(!t||!t.locationId||t.oppId!==o)return;let r=A(),n=e.querySelector(".ws-ni-label");e.disabled=!0,e.style.opacity="0.7",n&&(n.textContent="Closing\u2026");try{let a=await tr({oppId:t.oppId,locationId:t.locationId,userId:r});if(a?.ok)n&&(n.textContent="Marked Not Interested"),e.style.background=l.crimsonGlow,e.style.color=l.crimson,b.info(`Not Interested set for opp ${o} \u2192 ${a.new_stage}`);else throw new Error("Webhook returned ok=false")}catch(a){b.error("Not Interested webhook failed",a),n&&(n.textContent="Try again"),e.disabled=!1,e.style.opacity="1",setTimeout(()=>{n&&n.textContent==="Try again"&&(n.textContent="Mark Not Interested")},3e3)}}),e},rr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],nr=async()=>{for(let o of rr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},_e=!1,Ue=async()=>{if(!_e){_e=!0;try{await ar()}finally{_e=!1}}},ar=async()=>{let o=ue();if(!o||!o.locationId){document.getElementById(F)?.remove(),document.getElementById(`${F}-wrap`)?.remove(),Q();return}let e=document.getElementById(F);if(e&&e.dataset.oppId===o.oppId){let i=L();i!==null&&i!=="Marketing Tracker"&&(e.remove(),document.getElementById(`${F}-wrap`)?.remove(),Q());return}e&&(e.remove(),document.getElementById(`${F}-wrap`)?.remove());let t=await nr();if(!t){b.warn("Not Interested: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await me();if(r!=="Marketing Tracker"){b.debug(`[not-interested] gated off \u2014 pipeline="${r}" (expected Marketing Tracker)`);return}let n=ue();if(!n||n.oppId!==o.oppId)return;let a=or(o.oppId),s=document.createElement("span");s.id=`${F}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Not Interested button on opp ${o.oppId}`),sr(o.oppId)},J=null,Ve=null,Q=()=>{J?.disconnect(),J=null,Ve=null},sr=o=>{if(J&&Ve===o)return;Q();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Ve=o,J=new MutationObserver(()=>{let t=ue();if(!t||t.oppId!==o){Q();return}let r=L();if(r!==null&&r!=="Marketing Tracker"){document.getElementById(F)?.remove(),document.getElementById(`${F}-wrap`)?.remove(),Q();return}document.getElementById(F)||Ue()}),J.observe(e,{childList:!0,subtree:!0}))},Ge=null,$e,ir=()=>{Ge||(Ge=new MutationObserver(()=>{$e===void 0&&($e=window.setTimeout(()=>{$e=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(F);o&&!e&&!_e&&Ue()},300))}),Ge.observe(document.body,{childList:!0,subtree:!0}))},At=()=>{ir(),Ue()};var lr="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/property/listing-price-changed",D="ws-crm-reduce-price-button",It="ws-crm-reduce-price-modal",dr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,cr=/\/v2\/location\/([A-Za-z0-9]+)/,ge=()=>{let o=window.location.pathname,e=o.match(dr);if(!e)return null;let t=o.match(cr);return{oppId:e[1],locationId:t?t[1]:null}},br=async o=>{let e=await fetch(lr,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:o.locationId,dispo_opp_id:o.oppId,new_price:o.newPrice,triggered_by_user_id:o.userId??null}),credentials:"omit"});if(!e.ok)throw new Error(`Reduce Price webhook returned ${e.status} ${e.statusText}`);let t=await e.text();try{let r=JSON.parse(t);if(r?.ok===!1&&r?.error)throw new Error(r.error);return r}catch(r){if(r instanceof Error&&/returned/.test(r.message))throw r;return{}}},ve=()=>{document.getElementById(It)?.remove()},hr=o=>{ve();let e=document.createElement("div");e.id=It,e.style.cssText=`
    position: fixed;
    inset: 0;
    z-index: 999999;
    background: rgba(0, 0, 0, 0.6);
  ...
  `,e.appendChild(t),document.body.appendChild(e);let r=t.querySelector("#ws-reduce-price-input"),n=t.querySelector("#ws-reduce-error"),a=t.querySelector("#ws-reduce-cancel"),s=t.querySelector("#ws-reduce-submit");setTimeout(()=>r?.focus(),50),r?.addEventListener("input",()=>{let c=r.value.replace(/[^0-9.]/g,"").split(".");r.value=c[0]+(c.length>1?"."+c.slice(1).join(""):"")});let i=d=>{d.key==="Enter"?(d.preventDefault(),s?.click()):d.key==="Escape"&&(d.preventDefault(),a?.click())};t.addEventListener("keydown",i),e.addEventListener("click",d=>{d.target===e&&ve()}),a?.addEventListener("click",()=>{ve()}),s?.addEventListener("click",async()=>{if(!r||!n||!s)return;let d=r.value.trim();if(!d){n.textContent="Enter a new listing price.",r.focus();return}let c=parseFloat(d);if(!Number.isFinite(c)||c<=0){n.textContent="Price must be a positive number.",r.focus();return}if(c<1e3){n.textContent=`That looks low \u2014 did you mean $${Math.round(c*1e3).toLocaleString("en-US")}?`,r.focus();return}n.textContent="",s.disabled=!0,s.textContent="Reducing\u2026",s.style.opacity="0.7",a&&(a.disabled=!0);try{await br({oppId:o.oppId,locationId:o.locationId,newPrice:c,userId:A()}),ve(),o.onSuccess()}catch(h){b.error("Reduce Price webhook failed",h),n.textContent=h instanceof Error?h.message:"Something went wrong. Try again.",s.disabled=!1,s.textContent="Reduce Price",s.style.opacity="1",a&&(a.disabled=!1)}})},pr=(o,e)=>{let t=document.createElement("button");return t.id=D,t.type="button",t.dataset.oppId=o,t.style.cssText=H,t.title="Set a new listing price and notify active + previously-withdrew buyers",t.innerHTML=`
    <span style="
      display: inline-block;
      width: 8px;
      height: 8px;
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-1px)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)"}),t.addEventListener("click",()=>{let r=ge();!r||!r.locationId||r.oppId!==o||hr({oppId:r.oppId,locationId:r.locationId,onSuccess:()=>{let n=t.querySelector(".ws-rp-label"),a=t.querySelector(":scope > span:first-child");n&&(n.textContent="Price Reduced \u2014 Buyers Alerted"),t.style.background=l.emeraldGlow,t.style.color=l.emeraldBright,t.style.borderColor=l.emeraldBorder,a&&(a.style.background=l.emerald,a.style.boxShadow=`0 0 6px ${l.emerald}`),setTimeout(()=>{n&&n.textContent==="Price Reduced \u2014 Buyers Alerted"&&(n.textContent="Reduce Price and Alert Buyers",t.style.cssText=H,a&&(a.style.background=l.amber,a.style.boxShadow=`0 0 6px ${l.amber}`))},4e3)}})}),t},mr=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],_r=async()=>{for(let o of mr)try{let e=await C(o,{timeoutMs:2e3});if(e)return e}catch{}return null},ye=!1,je=async()=>{if(!ye){ye=!0;try{await ur()}finally{ye=!1}}},ur=async()=>{let o=ge();if(!o||!o.locationId){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ee();return}let e=document.getElementById(D);if(e&&e.dataset.oppId===o.oppId){let i=L();i!==null&&i!=="Disposition"&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove(),ee());return}e&&(e.remove(),document.getElementById(`${D}-wrap`)?.remove());let t=await _r();if(!t){b.warn("Reduce Price: no opp-header mount target found within timeout \u2014 skipping mount");return}let r=await me();if(r!=="Disposition"){b.debug(`[reduce-price] gated off \u2014 pipeline="${r}" (expected Disposition)`);return}let n=ge();if(!n||n.oppId!==o.oppId)return;let a=pr(o.oppId,o.locationId),s=document.createElement("span");s.id=`${D}-wrap`,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: 8px;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`Mounted Reduce Price button on opp ${o.oppId}`),vr(o.oppId)},Z=null,We=null,ee=()=>{Z?.disconnect(),Z=null,We=null},vr=o=>{if(Z&&We===o)return;ee();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(We=o,Z=new MutationObserver(()=>{let t=ge();if(!t||t.oppId!==o){ee();return}let r=L();if(r!==null&&r!=="Disposition"){document.getElementById(D)?.remove(),document.getElementById(`${D}-wrap`)?.remove(),ee();return}document.getElementById(D)||je()}),Z.observe(e,{childList:!0,subtree:!0}))},qe=null,ze,yr=()=>{qe||(qe=new MutationObserver(()=>{ze===void 0&&(ze=window.setTimeout(()=>{ze=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(D);o&&!e&&!ye&&je()},300))}),qe.observe(document.body,{childList:!0,subtree:!0}))},Lt=()=>{yr(),je()};var Dt="https://n8n.srv942822.hstgr.cloud/webhook/reinvest-os/tc/send-to-title-co",V="ws-crm-send-to-title-co-button",W="ws-crm-send-to-title-co-wrap",xe="ws-crm-stc-dropdown",gr=/\/opportunities\/(?:detail\/)?([A-Za-z0-9]{16,})(?:[/?#]|$)/,fr=/\/v2\/location\/([A-Za-z0-9]+)/,Xe=()=>{let o=window.location.pathname,e=o.match(gr);if(!e)return null;let t=o.match(fr);return{oppId:e[1],locationId:t?t[1]:null}},wr=5*60*1e3,Mt=o=>`ws-crm-stc-cache:${o}`,xr=o=>{try{let e=window.localStorage.getItem(Mt(o));if(!e)return null;let t=JSON.parse(e);return!t.ts||Date.now()-t.ts>wr||!Array.isArray(t.checks)||t.checks.length===0?null:t}catch{return null}},kr=(o,e)=>{try{window.localStorage.setItem(Mt(o),JSON.stringify(e))}catch{}},Er=async(o,e)=>{try{let t=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,dry_run:!0}),credentials:"omit"});return t.ok?await t.json():(b.warn(`[stc] dry_run returned HTTP ${t.status}`),null)}catch(t){return b.warn("[stc] dry_run fetch failed:",t),null}},Tr=async(o,e,t)=>{let r=await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({tenant_id:e,tc_opp_id:o,triggered_by_user_id:A()??null,confirm_resend:t}),credentials:"omit"});if(!r.ok&&r.status!==200)throw new Error(`HTTP ${r.status}`);return await r.json()},Sr=o=>{let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(!e)return!1;let t=e.querySelectorAll("a, button, li, [role='tab'], [role='menuitem'], .crm-opportunities-modal-content [class*='tab']");for(let n of t)if((n.textContent?.trim()??"")===o)return n.click(),!0;let r=e.querySelectorAll("*");for(let n of r){if(n.children.length>1)continue;if((n.textContent?.trim()??"")===o)return(n.closest("a, button, li, [role='tab']")||n.parentElement||n).click(),!0}return b.warn(`[stc] folder tab not found for "${o}"`),!1},Ft=o=>{let e=document.getElementById(o);if(!e){b.warn(`[stc] field ${o} not found in DOM \u2014 can't scroll to it`);return}e.scrollIntoView({behavior:"smooth",block:"center"});let t=e.style.boxShadow,r=e.style.transition;e.style.transition="box-shadow 0.3s ease, background-color 0.3s ease",e.style.boxShadow=`0 0 0 3px ${l.emerald}, 0 0 18px ${l.emerald}`,window.setTimeout(()=>{e.style.boxShadow=t,window.setTimeout(()=>{e.style.transition=r},400)},2800)},Cr=(o,e)=>{if(e&&Sr(e)){window.setTimeout(()=>Ft(o),300);return}Ft(o)},N=()=>{document.getElementById(xe)?.remove()},fe=(o,e,t)=>{N();let r=document.createElement("div");r.id=xe;let n=t.getBoundingClientRect();r.style.cssText=`
    position: fixed;
    top: ${n.bottom+6}px;
  ...
  `,r.appendChild(d);let c=["TC","ACQ","MT","DISPO","Property"],h={};o.forEach(y=>{h[y.group]||(h[y.group]=[]),h[y.group].push(y)});let m=[...c.filter(y=>h[y]),...Object.keys(h).filter(y=>!c.includes(y))];for(let y of m){let g=h[y],x=document.createElement("div");x.style.cssText="margin-top: 12px;";let u=document.createElement("div");u.style.cssText=`
      font-family: ${f.mono};
      font-size: 9px;
      ...
      padding-bottom: 4px;
      border-bottom: 1px solid ${l.steel};
    `,u.textContent=y,x.appendChild(u),g.forEach(_=>{let v=document.createElement("div"),k=!_.filled&&_.navigable&&_.field_id;v.style.cssText=`
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 6px 8px;
  ...
  `,P(t,n);let a=new Set,s=async()=>{if(n.status==="sending")return;let u=await Er(o,e);if(!u){n={status:"error",message:"Check failed \u2014 click to retry"},P(t,n);return}if(u.rate_limited){y=Date.now()+p,n={status:"error",checks:n.checks,message:"Rate-limited by GHL \u2014 will retry in 5m"},P(t,n),b.warn(`[stc] dry_run rate-limited \u2014 cooling down until ${new Date(y).toLocaleTimeString()}`);return}if(!Array.isArray(u.checks)||u.checks.length===0){n={status:"error",message:u.error||"Check failed \u2014 click to retry"},P(t,n),b.warn("[stc] dry_run returned no checks:",u);return}let _=u.pipeline_name;if(_&&_!=="Transaction Coordination"){b.debug(`[stc] dry_run reports pipeline="${_}" (not TC) \u2014 retracting button`),document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),N(),oe();return}let v=u.checks;if(n.checks&&n.checks.length===u.checks.length){let T=new Set;v=u.checks.map((w,I)=>n.checks[I]?.filled&&!w.filled?a.has(w.label)?w:(T.add(w.label),{...w,filled:!0}):w),a=T}else a=new Set;n={status:v.every(T=>T.filled)?"ready":"incomplete",checks:v,previouslySentAt:u.previously_sent_at??null},kr(o,{checks:v,previously_sent_at:u.previously_sent_at??null,pipeline_name:_,ts:Date.now()}),P(t,n),document.getElementById(xe)&&fe(v,u.previously_sent_at,t)},i=async()=>{let u=!!n.previouslySentAt;n={status:"sending",checks:n.checks,previouslySentAt:n.previouslySentAt},P(t,n),N();try{let _=await Tr(o,e,u);if(_.needs_confirm){n={status:"ready",checks:_.checks,previouslySentAt:_.previously_sent_at},P(t,n),_.checks&&fe(_.checks,_.previously_sent_at,t);return}if(_.ok){n={status:"sent",checks:_.checks,previouslySentAt:new Date().toISOString()},P(t,n),window.setTimeout(()=>{g()},3500);return}n={status:"error",checks:_.checks,message:_.error||"Validation failed"},P(t,n),_.checks&&fe(_.checks,_.previously_sent_at,t)}catch(_){b.error("[stc] send failed:",_),n={status:"error",message:"Network error \u2014 click to retry"},P(t,n)}};t.addEventListener("click",()=>{switch(n.status){case"ready":i();break;case"incomplete":{document.getElementById(xe)?N():n.checks&&fe(n.checks,n.previouslySentAt,t);break}case"error":case"sent":g();break}});let d,c=!1,h=Date.now(),m=1e4,p=5*60*1e3,y=0,g=async()=>{if(!c){if(Date.now()<y){b.debug(`[stc] dry_run suppressed \u2014 rate-limit cooldown until ${new Date(y).toLocaleTimeString()}`);return}c=!0,h=Date.now();try{await s()}finally{c=!1}}};g();let x=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");if(x){let u=new MutationObserver(()=>{if(d!==void 0||c)return;let v=Date.now()-h,k=Math.max(1500,m-v);d=window.setTimeout(()=>{d=void 0,n.status!=="sending"&&g()},k)});u.observe(x,{childList:!0,subtree:!0,characterData:!0}),t.dataset.observerActive="1";let _=window.setInterval(()=>{document.body.contains(t)||(u.disconnect(),d!==void 0&&window.clearTimeout(d),window.clearInterval(_))},5e3)}return t},Ir=[".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading .description",".crm-opportunities-modal .ui-modal-heading .description",".hr-card.hr-modal.crm-opportunities-modal .ui-modal-heading",".crm-opportunities-modal .ui-modal-heading",".hr-card.hr-modal.crm-opportunities-modal .hr-card-header__main",".crm-opportunities-modal .hr-card-header__main"],Lr=async()=>{for(let o of Ir)try{let e=await C(o,{timeoutMs:1500});if(e)return b.debug(`[send-to-title-co] mount target: ${o}`),e}catch{}return b.warn(`[send-to-title-co] no mount target found. URL: ${window.location.pathname}`),null},we=!1,Qe=async()=>{if(we){b.debug("[stc] mount:00-LOCKED ensureMounted already in-flight \u2014 skip");return}we=!0;try{await Fr()}catch(o){b.error("[stc] ensureMountedImpl threw:",o)}finally{we=!1}},Fr=async()=>{b.debug("[stc] mount:01 ensureMountedImpl entered");let o=Xe();if(!o||!o.locationId){b.debug(`[stc] mount:02-BAIL no ctx or no locationId. ctx=${JSON.stringify(o)}`),document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),N();return}b.debug(`[stc] mount:02 ctx ok \u2014 oppId=${o.oppId} locId=${o.locationId}`);let e=document.getElementById(V);if(e&&e.dataset.oppId===o.oppId){b.debug("[stc] mount:03-SKIP existing button for same opp");let i=L();i!==null&&i!=="Transaction Coordination"&&(e.remove(),document.getElementById(W)?.remove(),N(),oe());return}e&&(b.debug("[stc] mount:03 removing stale existing button"),e.remove(),document.getElementById(W)?.remove(),N()),b.debug("[stc] mount:04 calling findMountTarget");let t=await Lr();if(!t){b.debug("[stc] mount:04-BAIL findMountTarget returned null");return}b.debug(`[stc] mount:04 target found tag=${t.tagName} class="${t.className}"`);let r=L();if(r!==null&&r!=="Transaction Coordination"){b.debug(`[stc] mount:05-GATED DOM pipeline="${r}" \u2014 skipping mount`);return}let n=Xe();if(!n||n.oppId!==o.oppId||!n.locationId){b.debug(`[stc] mount:06-BAIL ctx changed during awaits. was=${o.oppId} now=${n?.oppId}`);return}b.debug("[stc] mount:06 building button (pipeline gate will run via dry_run)");let a=Ar(o.oppId,n.locationId),s=document.createElement("span");s.id=W,s.style.cssText=`
    display: inline-flex;
    align-items: center;
    margin-left: auto;
    flex-shrink: 0;
    vertical-align: middle;
  `,t.classList.contains("description")&&(t.style.display="flex",t.style.alignItems="center",t.style.gap="16px",t.style.flexWrap="wrap"),s.appendChild(a),t.appendChild(s),b.debug(`[stc] mount:07-OK Mounted on opp ${o.oppId}, inDoc=${document.body.contains(a)}`),Dr(o.oppId)},te=null,Je=null,oe=()=>{te?.disconnect(),te=null,Je=null},Dr=o=>{if(te&&Je===o)return;oe();let e=document.querySelector(".hr-card.hr-modal.crm-opportunities-modal");e&&(Je=o,te=new MutationObserver(()=>{let t=Xe();if(!t||t.oppId!==o){oe();return}let r=L();if(r!==null&&r!=="Transaction Coordination"){document.getElementById(V)?.remove(),document.getElementById(W)?.remove(),N(),oe();return}document.getElementById(V)||Qe()}),te.observe(e,{childList:!0,subtree:!0}))},Ke=null,Ye,Mr=()=>{Ke||(Ke=new MutationObserver(()=>{Ye===void 0&&(Ye=window.setTimeout(()=>{Ye=void 0;let o=!!document.querySelector(".crm-opportunities-modal .ui-modal-heading .description"),e=!!document.getElementById(V);o&&!e&&!we&&Qe()},300))}),Ke.observe(document.body,{childList:!0,subtree:!0}))},Ht=()=>{Mr(),Qe()};var Ae="reos-theme-stylesheet",Qt="reos-theme-fonts",Hr=()=>{let o=document.getElementById(Qt);o&&o.remove()},Pr=`
/* ============================================
